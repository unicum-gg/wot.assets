...
!(function (e, t) {
    ...
    function Bs(e, t) {
        ...
        return (
            t &&
                at(it(t), (e) => {
                    (st.und(e.keys) && (e = Ts(e)), st.obj(e.to) || (e = { ...e, to: void 0 }), Us(n, e, (e) => $s(e)));
                }),
            Fs(e, n),
            n
        );
            ...
            children: [
                e.jsxs(ca.Header, {
                    ...
                    children: [
                        ...
                        e.jsx('div', { className: A(Wa.tail, u?.tail), children: void 0 !== c && e.jsx(Ha, { ...c }) }),
                    ],
                }),
    ...
    const bo = 'Delta_eb295acb',
                    ...
                    children: [
                        ...
                        !l &&
                            e.jsx(To, {
                                ...
                                className: A(n?.doneComplete, Co.complete, r.progressCompleted && Co.complete__visible),
                                repeat: 'repeat',
                                position: 'left top',
                                style: { width: d.width.to((e) => `${e}%`) },
                            }),
        ...
        So = s.memo(function ({ filledPattern: t, classNames: n, className: r, animationConfig: a, ...o }) {
            const i = po(),
                c = go(),
                l = gr(),
    ...
    function oc({ value: t, questType: n, className: s }) {
        return t
            ? e.jsx('div', {
                  className: A(oi.iconImage, oi.iconImage__regular, n === ac.PREMIUM && oi.iconImage__gold, s),
    ...
    var vc = ((e) => ((e.Done = 'done'), (e.Locked = 'notAvailable'), (e.Active = ''), e))(vc || {});
    function wc(e) {
        ...
        const s = {
            ...
            condition: {
                icon:
                    ((r = e.iconKey),
                    {
                        default: { path: Tc.readOrEmpty(`userMissions.missionIcons.c_32.${r}_silver`) },
                        large: { path: Tc.readOrEmpty(`userMissions.missionIcons.c_80.${r}_silver`) },
                    }),
                title: e.titleData,
    ...
    const [Ac, Sc] = (
                        ...
                        le(t.quests.get(), (e) => {
                            ...
                            return {
                                ...
                                groups: {
                                    ...
                                    separate: 'none',
                                    groups: de([
                                        e.postBattleCondition.items.length > 0 && Ic(e.postBattleCondition, t),
                                        e.bonusCondition.items.length > 0 && Ic(e.bonusCondition, t),
                                    ]),
                                },
        ...
        kc = 'ProgressionQuests_divider_5040669c',
        Nc = 'ProgressionQuests_headerBackground_78383aa5',
        Mc = 'ProgressionQuests_head_20b48055',
        jc = f.resolve('aliases'),
        Oc = f.resolve('strings'),
        Dc = { rootId: jc.read((e) => e.comp7_light.shared.BattleResultsProgressionQuests('resId')) },
        Bc = i.observer(function ({ animation: t, immediateAnimation: n }) {
            const { model: r, controls: a } = Sc(),
                o = Se(),
                i = () => {
                    const e = r.quests();
                    if (e.length > 0) {
            ...
            return e.jsx(bc, {
                title: Oc.readOrEmpty('comp7_light.battleResult.missionsProgress.progression.title'),
                onButtonAction: i,
                onClick: (e) => {
                    (o.play('click', { original: e, target: 'progression-quests:mission-card' }), i());
                },
                classNames: { header: { background: Nc }, head: Mc },
                animation: t,
                immediateAnimation: n,
                actionTooltipParams: { body: Oc.readOrEmpty('battle_results.progression.linkBtn.info') },
                children: e.jsx('div', {
                            ...
                            s.Fragment,
                            {
                                children: [
                                    e.jsx(bc.Groups, {
                                        ...
                                        questId: t.id,
                                        completed: t.completed,
                                        rewardsTooltipResId: Dc.rootId,
                                    }),
                                    r.length - 1 !== n && e.jsx(Ce, { classNames: { base: kc } }),
                                ],
                            },
                            t.id,
                        ),
            ...
            return {
                async init() {
                    ...
                    try {
                        ...
                        const r = X(Dc, { name: 'ProgressionQuestsProgressDataLayer' }),
                            a =
                                ...
                                (function (e, t) {
                                    ...
                                    return !1;
                                })(r.readByPath('commonQuests'), (e) => e.status === vc.Done));
                        return {
                            animated: !0,
                            component: Fc,
                            notifications: a
