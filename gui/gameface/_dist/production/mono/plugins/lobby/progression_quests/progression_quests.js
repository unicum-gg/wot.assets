...
!(function (e, t) {
    ...
    function fe(e, t, n) {
        return 'function' == typeof t ? me(0, e, t) : (pe(void 0 !== n, 'fn must be defined'), me(e, t, n));
    }
    function me(e, t, n) {
    ...
    s.forwardRef(function (t, n) {
        ...
        const { repeat: s, fit: r, position: a, width: o, height: i, unknownStyle: l, unselectable: c, ...u } = t;
        return e.jsx('div', {
            ...u,
            ref: n,
            style: {
    ...
    we(
        s.forwardRef(function (t, n) {
            const { width: s, height: r, src: a, unselectable: o, unknown: i, unknownStyle: l = xe, ...c } = t;
            return t.unknown
                ? e.jsx('div', { ...c, style: { width: t.width, height: t.height, ...l } })
                : e.jsx('img', { ...c, ref: n, src: a, width: s, height: r });
        }),
    );
    ...
    function Ze() {
        ...
        (t && (Je(ze.splice(0, t), (e) => e.handler()), (He -= t)),
            He
                ? ($e.flush(), De.flush(e ? Math.min(64, Ge - e) : 16.667), Ue.flush(), Fe.flush(), Le.flush())
                : (Ge = -1));
    }
    function Ke() {
        let e = new Set(),
    ...
    var At = new RegExp('rgb' + It(Pt, Pt, Pt)),
        St = new RegExp('rgba' + It(Pt, Pt, Pt, Pt)),
        kt = new RegExp('hsl' + It(Pt, Tt, Tt)),
        Nt = new RegExp('hsla' + It(Pt, Tt, Tt, Pt)),
    ...
    var Vt = (e, t, n) => {
        ...
        return (e) => {
            ...
            return (function (e, t, n, s, r, a, o, i, l) {
                ...
                ((c = a(c)), s === -1 / 0 ? (c = -c) : r === 1 / 0 ? (c += s) : (c = c * (r - s) + s));
                return c;
    ...
    var nn,
        ...
        fn = (e) => {
            ...
            const t = e.output.map((e) => Yt(e).replace(cn, un).replace(an, qt).replace(nn, qt)),
            ...
            return (e) => {
                ...
                let s = 0;
                return t[0].replace(rn, () => `${r[s++](e)}${n || ''}`).replace(ln, pn);
            };
        },
        mn = 'react-spring: ',
        hn = (e) => {
    ...
    function bn(e) {
        return st.str(e) && ('#' == e[0] || /\d/.test(e) || (!pt() && cn.test(e)) || e in (ft || {}));
    }
        ...
        Nn = class extends In {
            ...
            getValue(e) {
                ...
                return (
                    ot(this.source, (n, s) => {
                        var r;
                        (r = n) && r[En] === r ? (t[s] = n.getValue(e)) : Wt(n) ? (t[s] = Yt(n)) : e || (t[s] = n);
                    }),
                    t
                );
            }
            ...
            return s.forwardRef((r, a) => {
                ...
                (yn(
                    () => (
                        ...
                        at(c, (e) => en(e, f)),
                        () => {
                            m.current && (at(m.current.deps, (e) => tn(e, m.current)), Be.cancel(m.current.update));
                        }
                    ),
                ),
                    s.useEffect(d, []),
        ...
        return new Promise((o, i) => {
            ...
            function p() {
                l > 0 && !tt.skipAnimation
                    ? ((r.delayed = !0), (c = Be.setTimeout(f, l)), r.pauseQueue.add(d), r.timeouts.add(c))
                    : f();
            }
            function f() {
        ...
        return a || e !== i || t.reset
            ? (n.promise = (async () => {
                  ...
                  const p = new Promise((e, t) => ((u = e), (d = t))),
                      ...
                      m = (e, t) => {
                          const a = new ps(),
                              o = new fs();
                          return (async () => {
                              if (tt.skipAnimation) throw (ds(n), (o.result = ls(s, !1)), d(o), o);
                              f(a);
                  ...
                  try {
                      ...
                      r == n.asyncId && ((n.asyncId = a), (n.asyncTo = a ? i : void 0), (n.promise = a ? l : void 0));
                  }
                  return (
                      st.fun(o) &&
                          Be.batchedUpdates(() => {
    ...
    var ps = class extends Error {
        ...
        _s = class extends Kt {
            ...
            interpolate(...e) {
                return (_n(`${mn}The "interpolate" function is deprecated in v9 (use "to" instead)`), tt.to(this, e));
            }
            toJSON() {
                return this.get();
            }
        ...
        Rs = class extends _s {
            ...
            advance(e) {
                ...
                (!o && Wt(s.to) && (r = it(Yt(s.to))),
                    s.values.forEach((i, l) => {
                        if (i.done) return;
                        const c = i.constructor == Sn ? 1 : o ? o[l].lastPosition : r[l];
                        let u = s.immediate,
                            d = c;
                        if (!u) {
                            ...
                            if (st.und(a.duration))
                                if (a.decay) {
                                    ...
                                    for (
                                        let e = 0;
                                        e < g && ((m = Math.abs(o) > t), m || ((u = Math.abs(c - d) <= p), !u));
                                        ++e
                                    ) {
                                        l && ((h = d == c || d > c == f), h && ((o = -o * s), (d = c)));
                                        ((o += ((1e-6 * -a.tension * (d - c) + 0.001 * -a.friction * o) / a.mass) * _),
                                            (d += o * _));
                                    }
                                }
                            else {
                        ...
                        (o && !o[l].done && (u = !1), u ? (i.done = !0) : (t = !1), i.setValue(d, a.round) && (n = !0));
                    }));
                const i = Cn(this),
                    l = i.getValue();
                if (t) {
                    ...
                    actions: {
                        pause: () => {
                            vs(this) ||
                                (xs(this, !0),
                                dt(a.pauseQueue),
                                ks(this, 'onPause', ls(this, Es(this, this.animation.to)), this));
                        },
                        resume: () => {
                            vs(this) &&
                                (xs(this, !1),
                                ...
                                dt(a.resumeQueue),
                                ks(this, 'onResume', ls(this, Es(this, this.animation.to)), this));
                        },
            ...
            _merge(e, t, n) {
                ...
                if (
                    (P && ys(this) && (i.changed && !y ? (C = !0) : C || this._stop(l)),
                    !m &&
                        ((C || Wt(l)) &&
            ...
            _set(e, t = !0) {
                ...
                if (!st.und(n)) {
                    ...
                    if (!e || !rt(n, e.getValue())) {
                        const s = On(n);
                        (e && e.constructor == s ? e.setValue(n) : Pn(this, s.create(n)),
                            e &&
                                Be.batchedUpdates(() => {
                                    this._onChange(n, t);
                                }));
            ...
            _onStart() {
                ...
                e.changed || ((e.changed = !0), ks(this, 'onStart', ls(this, Es(this, e.to)), this));
            }
            _onChange(e, t) {
            ...
            _stop(e, t) {
                if (ys(this)) {
                    ...
                    const s = t ? cs(this.get()) : ls(this.get(), Es(this, e ?? n.to));
    ...
    function Ps(e) {
        const { to: t, from: n } = (e = Wn(e)),
            s = new Set();
        return (st.obj(t) && Is(t, s), st.obj(n) && Is(n, s), (e.keys = s.size ? Array.from(s) : null), e);
    }
    function Ts(e) {
        const t = Ps(e);
    ...
    async function Ds(e, t, n) {
            ...
            p.push(
                as(++e._lastAsyncId, {
                    ...
                    actions: {
                        ...
                        resume: nt,
                        start(t, n) {
                            f ? (ds(d, e._lastAsyncId), n(cs(e))) : ((t.onRest = i), n(us(u, t, d, e)));
                        },
                    },
                }),
            ),
        ...
        return (l && Be.batchedUpdates(() => l(m, e, e.item)), m);
    }
    function Bs(e, t) {
        const n = { ...e.springs };
        return (
            t &&
                at(it(t), (e) => {
                    (st.und(e.keys) && (e = Ps(e)), st.obj(e.to) || (e = { ...e, to: void 0 }), Us(n, e, (e) => $s(e)));
                }),
            Fs(e, n),
            n
        );
    ...
    function Qs(e, t) {
        const n = st.fun(e),
            [[r], a] = (function (e, t, n) {
                ...
                const f = c.current.map((e, t) => Bs(e, u[t])),
                    m = s.useContext(Vs),
                    h = Rn(m),
                    _ = m !== h && Xn(m);
                (yn(() => {
    ...
    function Xs(e, t, n) {
        ...
        if (
            ...
            at(h, (e, t) => {
                _[t] || ((_[t] = { key: y[t], item: e, phase: 'mount', ctrl: new js() }), (_[t].ctrl.item = e));
            }),
            w.length)
        ) {
            let e = -1;
        ...
        (yn(() => {
            ...
            yn(
                () => {
                    at(P.current.size ? P.current : C, ({ phase: e, payload: t }, n) => {
                        const { ctrl: s } = n;
                        ((n.phase = e),
                            m?.add(s),
    ...
    var Ks = class extends _s {
        ...
        _attach() {
            let e = 1;
            (at(it(this.source), (t) => {
                (Wt(t) && en(t, this), ms(t) && (t.idle || this._active.add(t), (e = Math.max(e, t.priority + 1))));
            }),
                (this.priority = e),
                this._start());
        }
        ...
        eventObserved(e) {
            'change' == e.type
                ...
                : 'idle' == e.type
                  ? this._active.delete(e.parent)
                  : 'priority' == e.type &&
                    (this.priority = it(this.source).reduce((e, t) => Math.max(e, (ms(t) ? t.priority : 0) + 1), 0));
        }
    };
    function Js(e) {
        return !1 !== e.idle;
        ...
        const i = s.useRef({ status: vr, resId: e, timeoutId: 0 }),
            [l, c] = s.useMemo(() => {
                ...
                const d = {
                    ...
                    show: c,
                    rerun: function () {
                        i.current.status !== vr && (r ? d.hide() : l());
                    },
                };
                return [
                    d,
    ...
    function jr(e, t, s) {
        ...
        const a = (a, o, i = Mr) => {
                const l = n.observable.box(a(s(o)), i);
    ...
    const Dr = 'TruncateText_dcb41d92',
        Br = s.forwardRef(function ({ text: t, tooltipParams: n, className: r, ...a }, o) {
            ...
            return (
                ...
                e.jsx('div', { ...a, ref: ke([o, l]), className: A(Dr, r), ...(c ? i : {}), children: t })
            );
        }),
        ...
        Ur = (e, t) => (n) => {
            ...
            return $r(e, o, l, null == n ? void 0 : n.class, null == n ? void 0 : n.className);
        };
    function Lr(t, n, r) {
        ...
        Hr = s.forwardRef(function (
            ...
            return e.jsx(Gr, {
                ...
                onMouseEnter: function (e) {
                    (a || o || c.play('mouse-enter', { target: r || 'Button', original: e }), s?.(e));
                },
                onClick: function (e) {
                    a || (o || c.play('click', { target: r || 'Button', original: e }), n?.(e));
                },
                children: t,
            });
        }),
        ...
        Wr = s.forwardRef(function (
            ...
            return e.jsxs(Hr, {
                ...
                children: [
                    ...
                    e.jsx('div', { className: A(Qr.content, o && Qr.content__fontAligned, i?.content), children: t }),
                ],
            });
        });
    ...
    const Yr = 'Action_6c7b0c76',
        ...
        Zr = s.forwardRef(function ({ className: t, theme: n = Wr.themes.secondary, tooltipParams: s, ...r }, a) {
            ...
            return e.jsx(Wr, {
                ...
                theme: n,
                className: A(Yr, t),
                children: e.jsx(Re, { width: 10, height: 20, path: 'post_battle.progression.arrow', className: Xr }),
            });
        }),
        ...
        la = s.forwardRef(function (t, n) {
            return e.jsx(oa, { ...t, ref: n, children: t.children });
        });
    ((la.Header = na), (la.Content = ia), (la.Action = Zr), (la.Title = ra));
    const ca = 1,
        ua = 2,
        da = 3;
    function pa(e, t) {
        ...
        for (let l = 0; l < e.length; l++) {
            ...
            if (c === t.start[0] && e.slice(l, l + t.start.length) === t.start) {
                if (r) {
                    if (s.length > 0) {
                        s[s.length - 1].node.children.push({ type: ca, value: r });
                    } else n.push({ type: ca, value: r });
                    r = '';
                }
    ...
    function Ta(t, n, r = {}, a = !0) {
        ...
        for (const l of t)
            if (l.type === ca) i(l.value);
            else if (l.type === da)
                null === r[l.name] || Pa.includes(typeof r[l.name])
                    ? i(r[l.name] ?? `{{${l.name}}}`)
                    : o.push(e.jsx(s.Fragment, { children: r[l.name] }, `var-${l.name}-${l.instanceId}`));
            else if (l.type === ua) {
                const e = Ta(l.children, n, r, !1),
                    t = xa(Ca(l.attrs, r), e, n);
                o.push(t);
            }
        return o;
    }
    ...
    function $a({ value: t, transition: n, children: r, className: a, classNames: o }) {
        ...
        return e.jsx('div', {
            ...
            children: l((n, s) => {
                ...
                return e.jsx(hr.div, {
                    className: A(Da, `js-animated-value-${i}-${t === s ? 'enter' : 'leave'}`, o?.animatedValue),
    ...
    function Ya({
        ...
        return e.jsxs(la, {
            className: A(Wa.card, s && Wa.card__disabled, c),
            ...d,
            children: [
                e.jsxs(la.Header, {
                    onClick: a,
                    ...
                    children: [
                        ...
                        e.jsx('div', { className: A(Wa.tail, u?.tail), children: void 0 !== l && e.jsx(Ha, { ...l }) }),
                    ],
                }),
                void 0 !== i && e.jsx(la.Content, { className: A(Wa.content, u?.content), children: i }),
        ...
        s.useEffect(() => {
            ...
            function r() {
                ...
                if (a === r) E(!1);
                    ...
                    for (s.style.visibility = '', s.style.left = `${r.x}px`, s.style.top = `${r.y}px`; a >= 0; a--) {
    ...
    function to({
        ...
        return {
            from: { width: e },
            to: { width: t },
            config: a ?? { duration: (n === ro.simple && s) || (!s && r) ? 0 : no, easing: Gt.easeInOutCubic },
        };
    }
    const no = 600,
            ...
            e.jsx('div', {
                ...
                children: e.jsx(Re, {
                    className: A(
                        ...
                        0 === s.percentage ? mo.backgroundPattern__noProgress : mo[`backgroundPattern__${s.size}`],
                    ),
                    repeat: 'repeat',
                    position: 'left top',
                    path:
    ...
    const bo = 'Delta_eb295acb',
        ...
        Po = hr(Re),
        To = s.memo(function ({ donePattern: t, donePatternComplete: n, animationConfig: r, classNames: a }) {
            const o = po(),
                { activeComponents: i } = po(),
                l = 100 * o.percentage,
                c = 100 * (o.previous?.percentage ?? 0),
                u = void 0 === o.previous ? l : c,
                d = o.status === oo.doneStatic,
                p = gr(),
                [f, m] = Qs(() => ({ width: u }));
            return (
                s.useEffect(() => {
                ...
                }, [l, m, u, o.animationType, r, i, p]),
                e.jsxs(e.Fragment, {
                    children: [
                        e.jsx(Po, {
                            path: t || `ui.progressbar.bg_pattern_base_done_${o.size}`,
                            className: A(
                                a?.done,
                                Co.done,
                                !o.progressCompleted && Co.done__hidden,
                                o.progressCompleted && (d ? Co.done__doneStatic : Co.done__visible),
                            ),
                            repeat: 'repeat',
                            position: 'left top',
                            style: { width: f.width.to((e) => `${e}%`) },
                        ...
                        !d &&
                            e.jsx(Po, {
                                path: n || `ui.progressbar.bg_pattern_base_done_complete_${o.size}`,
                                className: A(a?.doneComplete, Co.complete, o.progressCompleted && Co.complete__visible),
                                repeat: 'repeat',
                                position: 'left top',
                                style: { width: f.width.to((e) => `${e}%`) },
                            }),
        ...
        So = s.memo(function ({
            ...
            const c = po(),
                u = go(),
                d = gr(),
                { activeComponents: p } = po(),
                f = 100 * c.percentage,
                m = 100 * (c.previous?.percentage ?? 0),
                h = void 0 === c.previous ? f : m;
            (fo('fill'),
                s.useEffect(() => {
            ...
            return (
                ...
                }, [i, g, h, c.animationType, p, f, u, d]),
                e.jsxs('div', {
                    className: A(Co.base, o),
                    children: [
                        e.jsx(hr.div, { className: a?.fill, style: { width: _.width.to((e) => `${e}%`) } }),
                        l.children ??
                            e.jsxs(e.Fragment, {
                                children: [
                                    e.jsx(Ao, { filledPattern: t, className: a?.filledPattern, animationConfig: i }),
                                    e.jsx(To, {
                                        classNames: a,
                                        animationConfig: i,
                                        donePattern: n,
                        ...
                        e.jsx(hr.div, {
                            className: A(
                                a?.edge,
                                Co.edge,
                                0 === c.percentage && Co.edge__noProgress,
                                !p.has('previewDelta') && !c.progressCompleted && Co.edge__visible,
                                c.status && Co[`edge__${c.status}`],
                            ),
    ...
    const qo = {
        ...
        Vo = Lr('ProgressBar', qo.base, { variants: { size: { medium: qo.base__medium, large: qo.base__large } } }),
        Go = function ({ size: t = ao.medium, backgroundPattern: n, status: s, className: r, classNames: a, ...o }) {
            return e.jsx(zo, {
                size: t,
                status: s,
                ...o,
    ...
    const Ho = 'ProgressBar_wrapper_a944db13',
        ...
        ei = s.forwardRef(({ value: t, className: n, total: r, transition: a, target: o, ...i }, l) => {
            const c = Se(),
                u = s.useMemo(
                    () => ({
                        value: t,
    ...
    const oi = {
        ...
        ii = ['win', 'isAlive'],
        li = S.cubicBezier(0.33, 0, 0.25, 1);
    const ci = {
        ...
        Root: function ({ condition: t, ...n }) {
            return e.jsx(ni.Provider, {
                value: t,
                children: e.jsx('div', { ...n, className: A(oi.content, t.completed && oi.content__completed) }),
            });
        },
        ...
        Title: function ({ questsAmount: t }) {
            const { title: n, icon: s, completed: r, progression: a } = si(),
                { completed: o } = ai();
            if (!s && !n) return null;
                ...
                children: [
                    void 0 !== i &&
                        e.jsx('div', {
                            ...
                            className: A(oi.titleIcon, i.default.isGold && oi.titleIcon__gold),
                        }),
                    ...
                    return {
                        ...
                        delta: i
                            ...
                            : {
                                  from: u,
                                  steps: u === d ? [] : [io, lo],
                                  growAnimationConfig: { duration: 600, easing: li },
                                  shrinkAnimationConfig: { duration: 600, easing: li },
                                  onState(e) {
                                      e === co &&
                                          d === a.current &&
                                          a.earned > 0 &&
                        ...
                        fill: { animationConfig: { duration: i ? 0 : 600, easing: li } },
                    };
            }, [i, u, d, a, t, l, c, r]);
            return a
                ? (pe.log(
                ...
                children: [
                    e.jsxs(e.Fragment, {
                        children: [
                            ...
                            y &&
                                e.jsx('div', {
                                    className: wi(Si.info, Si[`info__${t}`], l === pi.MULTI && Si.info__multi, p?.info),
                                    children: y,
                                }),
                            c && e.jsx('div', { className: Si.title, children: c }),
                        ],
                    }),
        ...
        Li = s.memo(function ({
            ...
            const p = f.resolve('strings'),
                ...
                _ =
                    ...
                    (function (e, t = {}) {
                        const n = pa(e, Na);
                        return String(Ta(n, ji, t));
                    })(ka(p.readOrEmpty('tooltips.quests.awards.additional.bottom')), { count: t.length - (a || 0) });
            return e.jsx('div', {
    ...
    function zi({ bonuses: t, size: n, resId: r, boxRewardTooltipArgs: a, maxRewardsCount: o, questId: i, ...l }) {
        const c = s.useMemo(
                () =>
                    ce(t, (e) => {
                        return {
    ...
    const qi = 'AnimatedRewards_glowContainer_82630782',
            ...
            return (
                ...
                e.jsxs('div', {
                    ...
                    children: [
                        e.jsx(hr.div, {
                            style: f,
                            className: A(Gi, l?.rewardsWrapper),
                            children: e.jsx(zi, { ...c, maxRewardsCount: r, bonuses: a, boxRewardTooltipArgs: o }),
                        }),
                        e.jsx('div', {
                            className: A(qi, l?.glowContainer),
        ...
        Zi = f.resolve('views');
    function Ki({ limit: e, rewardsTooltipResId: t, boxRewardTooltipContentId: n, ...s }) {
        return {
    ...
    function Ji({
        ...
        return t
            ...
            : e.jsx(zi, { ...m, classMix: p });
    }
    const el = 'CompletedMark_fc4eee08',
        tl = 'CompletedMark_glow_33775180',
        nl = S.cubicBezier(1, 0, 0.95, 1),
        sl = S.cubicBezier(0.45, 0, 0.52, 1),
        rl = s.forwardRef(function (
            {
                target: t,
                animationRef: n,
                className: a,
            ...
            const _ = s.useRef(u),
                ...
                [w] = Qs(() => ({
                    ...
                    onRest: () => {
                        v.start({
                            to: [
                                { opacity: 0.6, config: { duration: 160, easing: sl } },
                                { opacity: 0, config: { duration: 160, easing: sl } },
                            ],
                            onRest: f,
                        });
                    },
    ...
    function ol({ value: t, questType: n, className: s }) {
        return t
            ? e.jsx('div', {
                  className: A(oi.iconImage, oi.iconImage__regular, n === al.PREMIUM && oi.iconImage__gold, s),
            ...
            : 'union' === t.type
              ...
              : 'or' === t.type
                ? e.jsxs('div', {
                      ...
                      children: [
                          e.jsx(il, { width: 16, height: 16, className: oi.invertedArrow }),
                          ll.readOrEmpty('battle_results.conditions.type.or'),
                          e.jsx(il, { width: 16, height: 16, className: oi.arrow }),
                      ],
                  })
                : e.jsx('div', {
                      className: A(oi.separator, oi.separator__and, t.className),
                      children: ll.readOrEmpty('battle_results.conditions.type.and'),
                  });
    }
    function ul(t) {
        ...
        return e.jsx(e.Fragment, {
            children: ue(
                n,
                (e) => null != e,
                (n, r) => e.jsxs(s.Fragment, { children: [r > 0 && e.jsx(cl, { ...t }), n] }, r),
            ),
        });
    }
    const dl = { 1: 5, 2: 5, 3: 3 };
    function pl(e) {
        return 'item' === e.type ? 1 : e.groups.reduce((e, t) => e + pl(t), 0);
    }
    function fl(e) {
    ...
    const hl = 'R.images.gui.maps.icons.post_battle.general_quest',
        _l = { default: { path: `${hl}_32` }, medium: { path: hl } },
        gl = s.memo(function (t) {
            const n = Ys(),
                ...
                { icon: l, questsAmount: c } = s.useMemo(() => {
                    const e = pl(t.value);
                    return { icon: e > 1 ? (t.generalIcon ?? _l) : (fl(t.value) ?? _l), questsAmount: e };
                }, [t.generalIcon, t.value]),
                u = r.useAdaptive(l.default, l),
                d = dl[c] ?? 0,
                p = c > 3 ? 'groups__manyQuests' : 3 === c ? 'groups__threeQuests' : 'groups__twoQuests';
            return e.jsxs('div', {
                className: A(oi.groups, c > 4 && oi.groups__overflow, c > 1 && oi[p]),
                children: [
                    e.jsx('div', {
    ...
    function bl({ completed: t, progress: n, animation: r, immediateAnimation: a, target: o, ...i }) {
        const l = Se(),
            c = s.useMemo(() => ({ completed: t, animation: r, immediateAnimation: a }), [t, r, a]);
        return e.jsx(ri.Provider, {
            ...
            children: e.jsx(Ya, {
                ...
                onMouseEnter: (e) => {
                    (i.onMouseEnter?.(e),
                        !0 !== i.disabled &&
                            l.play('mouse-enter', { target: o || 'mission-progress:mission-card', original: e }));
                },
    ...
    ((bl.Content = ci), (bl.Groups = gl), (bl.Separators = ul));
    const yl = {
    ...
    var vl = ((e) => ((e.Done = 'done'), (e.Locked = 'notAvailable'), (e.Active = ''), e))(vl || {});
    function wl(e) {
    ...
    function Il(e, t) {
        ...
        const s = {
            ...
            condition: {
                icon:
                    ((r = e.iconKey),
                    {
                        default: { path: Pl.readOrEmpty(`userMissions.missionIcons.c_32.${r}_silver`) },
                        large: { path: Pl.readOrEmpty(`userMissions.missionIcons.c_80.${r}_silver`) },
                    }),
                title: e.titleData,
        ...
        var r;
        return (e.total > 0 && (s.condition.progression = { current: e.current, total: e.total, earned: e.earned }), s);
    }
    const [Al, Sl] = (
            (t = 'DataLayerProvider') =>
            (n, r, a) => {
                ...
                function i(i) {
                        ...
                        g = je((e, s, o) => {
                            const l =
                                    'real' !== e && o
                                        ...
                                        : X(s, { name: t }),
                                c = (t) => ('mocks' === e ? o?.getter(t, s) : l.readByPath(t)),
                                ...
                                p = n({
                                    ...
                                    requires: _,
                                    externalModel: l,
                                    observableModel: jr(l, e, c),
                                    cleanup: u,
                                }),
                                f = { ...d, mode: e, model: p, externalModel: l, cleanup: u, requires: _ },
                    ...
                    const [w, x] = s.useState(() => g(y, c, m));
                    return (
                        s.useEffect(() => {
                            b.current ? x(g(y, c, m)) : (b.current = !0);
                        }, [g, m, y, c?.context, c?.initializer, c?.getRoot, c?.rootId]),
                        s.useEffect(
                            () => () => {
                        ...
                        ce(t.quests.get(), (e) => {
                            ...
                            return {
                                ...
                                groups: {
                                    ...
                                    separate: 'none',
                                    groups: de([
                                        e.postBattleCondition.items.length > 0 && Il(e.postBattleCondition, t),
                                        e.bonusCondition.items.length > 0 && Il(e.bonusCondition, t),
                                    ]),
                                },
        ...
        kl = 'ProgressionQuests_divider_5040669c',
        Nl = 'ProgressionQuests_headerBackground_78383aa5',
        Ml = 'ProgressionQuests_head_20b48055',
        jl = f.resolve('aliases'),
        Ol = f.resolve('strings'),
        Dl = { rootId: jl.read((e) => e.comp7_light.shared.BattleResultsProgressionQuests('resId')) },
        Bl = i.observer(function ({ animation: t, immediateAnimation: n }) {
            const { model: r, controls: a } = Sl(),
                o = Se(),
                i = () => {
                    const e = r.quests();
                    if (e.length > 0) {
            ...
            return e.jsx(bl, {
                title: Ol.readOrEmpty('comp7_light.battleResult.missionsProgress.progression.title'),
                onButtonAction: i,
                onClick: (e) => {
                    (o.play('click', { original: e, target: 'progression-quests:mission-card' }), i());
                },
                classNames: { header: { background: Nl }, head: Ml },
                animation: t,
                immediateAnimation: n,
                actionTooltipParams: { body: Ol.readOrEmpty('battle_results.progression.linkBtn.info') },
                children: e.jsx('div', {
                    children: ce(r.quests(), (t, n, r) =>
                        e.jsxs(
                            s.Fragment,
                            {
                                children: [
                                    e.jsx(bl.Groups, {
                                        ...
                                        questId: t.id,
                                        completed: t.completed,
                                        rewardsTooltipResId: Dl.rootId,
                                    }),
                                    r.length - 1 !== n && e.jsx(Ce, { classNames: { base: kl } }),
                                ],
                            },
                            t.id,
                        ),
            ...
            children: e.jsx(Cl, {
                soundsOverrides:
                    ...
                    Object.entries(n).reduce(
                        (e, [t, n]) => (
                            (e[t] = (e) => {
                                e && e.target in n ? $.sound(n[e.target]) : Pe[t]?.(e);
                            }),
                            e
                        ),
                        {},
            ...
            return {
                async init() {
                    ...
                    try {
                        ...
                        const r = X(Dl, { name: 'ProgressionQuestsProgressDataLayer' }),
                            a =
                                ...
                                (function (e, t) {
                                    ...
                                    return !1;
                                })(r.readByPath('commonQuests'), (e) => e.status === vl.Done));
                        return {
                            animated: !0,
                            component: Fl,
                            notifications: a
