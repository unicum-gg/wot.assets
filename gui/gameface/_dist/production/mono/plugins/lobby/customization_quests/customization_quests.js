...
!(function (e, t) {
...
})(this, function (jsxRuntime, awilix, mobx, React, media_wrapper, reactDom, mobxUtils, mobxReactLite) {
    'use strict';
        ...
        __callDispose = (e, t, s) => {
            var n =
                    'function' == typeof SuppressedError
                        ? SuppressedError
                        : function (e, t, s, n) {
                              return (((n = Error(s)).name = 'SuppressedError'), (n.error = e), (n.suppressed = t), n);
                          },
    ...
    class ImagesRClassProvider {
        ...
        readOr(e, t, s = 'silent') {
            ...
            return void 0 === a ? ('silent' !== s && logBySeverity$1(`Resource not found: ${n}`, s), t()) : a;
        }
    ...
    class StringsRClassProvider {
        ...
        pluralOr(e, t, s, n = 'silent') {
            ...
            return void 0 === r ? ('silent' !== n && logBySeverity$1(`Resource not found: ${a}`, n), s()) : r;
        }
    ...
    class VideosRClassProvider {
        ...
        readOr(e, t, s = 'silent') {
            ...
            return void 0 === a ? ('silent' !== s && logBySeverity$1(`Resource not found: ${e}`, s), t()) : a;
        }
        readOrEmpty(e, t = 'warn') {
            return this.readOr(e, () => '', t);
        }
    ...
    resources.register({
        ...
        images: awilix.asFunction(() => new ImagesRClassProvider(window.R.images.gui.maps.icons)).singleton(),
    ...
    const easings$1 = {
        ...
        bezier: (e, t, s, n) => (a) =>
            (1 - a) * (1 - a) * (1 - a) * e + 3 * (1 - a) * (1 - a) * a * t + 3 * (1 - a) * a * a * s + a * a * a * n,
    ...
    const createViewEventArguments$2 = (e) => {
        ...
        sendViewEvent$1 = (e, t) => {
            ...
            if (void 0 !== t) {
                const { args: n, ...a } = t;
                return void 0 !== n
                    ? viewEnv.handleViewEvent({ __Type: s, type: e, ...a, arguments: createViewEventArguments$2(n) })
    ...
    function create(
        { initializer: e = !0, rootId: t = 0, getRoot: s = getRootDefault, context: n = 'model' } = {},
        { name: a = 'DataLayer' } = {},
    ) {
        const r = new Map(),
    ...
    function promiseWithResolvers() {
        ...
        return { then: s.then.bind(s), catch: s.catch.bind(s), finally: s.finally.bind(s), reject: e, resolve: t };
    }
        ...
        (function () {
            ...
            function u(e, t) {
                ...
                if (
                    ...
                    (this.method = ((n = t.method || 'GET'), (a = n.toUpperCase()), s.indexOf(a) > -1 ? a : n)),
    ...
    React.forwardRef(function (e, t) {
        ...
        const { repeat: s, fit: n, position: a, width: r, height: i, unknownStyle: o, unselectable: l, ...c } = e;
        return jsxRuntime.jsx('div', {
            ...c,
            ref: t,
            style: {
    ...
    var defineHidden = (e, t, s) => Object.defineProperty(e, t, { value: s, writable: !0, configurable: !0 }),
        is = {
            arr: Array.isArray,
            ...
            : (t = hex6.exec(e))
              ...
              : colors && void 0 !== colors[e]
                ...
                : (t = rgb.exec(e))
                  ...
                  : (t = rgba.exec(e))
                    ? ((parse255(t[1]) << 24) | (parse255(t[2]) << 16) | (parse255(t[3]) << 8) | parse1(t[4])) >>> 0
                    : (t = hex3.exec(e))
                      ...
                      : (t = hex8.exec(e))
                        ...
                        : (t = hex4.exec(e))
                          ...
                          : (t = hsl.exec(e))
                            ? (255 | hslToRgb(parse360(t[1]), parsePercentage(t[2]), parsePercentage(t[3]))) >>> 0
                            : (t = hsla.exec(e))
    ...
    var setHidden = (e, t, s) => Object.defineProperty(e, t, { value: s, writable: !0, configurable: !0 }),
        ...
        namedColorRegex,
        rgbaRound = (e, t, s, n, a) => `rgba(${Math.round(t)}, ${Math.round(s)}, ${Math.round(n)}, ${a})`,
        createStringInterpolator2 = (e) => {
            ...
            return (e) => {
                const s = !unitRegex.test(t[0]) && t.find((e) => unitRegex.test(e))?.replace(numberRegex, '');
                let a = 0;
                return t[0].replace(numberRegex, () => `${n[a++](e)}${s || ''}`).replace(rgbaRegex, rgbaRound);
            };
        },
        prefix = 'react-spring: ',
        once = (e) => {
    ...
    function isAnimatedString(e) {
        return (
            is.str(e) && ('#' == e[0] || /\d/.test(e) || (!isSSR() && cssVariableRegex.test(e)) || e in (colors || {}))
        );
    }
    ...
    function getAnimatedType(e) {
        ...
        return t ? t.constructor : is.arr(e) ? AnimatedArray : isAnimatedString(e) ? AnimatedString : AnimatedValue$1;
    }
    ...
    function mergeConfig(e, t, s) {
        (s && (sanitizeConfig((s = { ...s }), t), (t = { ...s, ...t })), sanitizeConfig(e, t), Object.assign(e, t));
        ...
        return r || e !== o || t.reset
            ? (s.promise = (async () => {
                  ...
                  try {
                      ...
                      a == s.asyncId && ((s.asyncId = r), (s.asyncTo = r ? o : void 0), (s.promise = r ? l : void 0));
                  }
                  return (
                      is.fun(i) &&
                          raf.batchedUpdates(() => {
    ...
    var BailSignal = class extends Error {
        ...
        SpringValue = class extends FrameValue {
                    ...
                    n.values.forEach((o, l) => {
                        ...
                        if (!d) {
                            ...
                            const s = n.fromValues[l],
                                a = null != o.v0 ? o.v0 : (o.v0 = is.arr(r.velocity) ? r.velocity[l] : r.velocity);
                            let i;
                            ...
                            if (is.und(r.duration))
                                if (r.decay) {
                                    ...
                                    for (
                                        ...
                                        ((i += ((1e-6 * -r.tension * (u - c) + 0.001 * -r.friction * i) / r.mass) * h),
                                            (u += i * h));
                                    }
                                }
                            else {
                        ...
                        (i && !i[l].done && (d = !1), d ? (o.done = !0) : (t = !1), o.setValue(u, r.round) && (s = !0));
                    }));
            ...
            start(e, t) {
                let s;
                return (
                    is.und(e) ? ((s = this.queue || []), (this.queue = [])) : (s = [is.obj(e) ? e : { ...t, to: e }]),
            ...
            _focus(e) {
                ...
                e !== t.to &&
                    (getFluidObservers(this) && this._detach(), (t.to = e), getFluidObservers(this) && this._attach());
            }
            _attach() {
                let e = 0;
                const { to: t } = this.animation;
    ...
    var Interpolation = class extends FrameValue {
        ...
        _get() {
            const e = is.arr(this.source) ? this.source.map(getFluidValue) : toArray(getFluidValue(this.source));
            return this.calc(...e);
        }
        _start() {
            this.idle &&
    ...
    function applyAnimatedValues(e, t) {
        ...
        const s = 'filter' === e.nodeName || (e.parentNode && 'filter' === e.parentNode.nodeName),
            ...
            u = Object.keys(c).map((t) =>
                s || e.hasAttribute(t)
                    ? t
                    : attributeCache[t] || (attributeCache[t] = t.replace(/([A-Z])/g, (e) => '-' + e.toLowerCase())),
            );
    ...
    var domTransforms = /^(matrix|translate|scale|rotate|skew)/,
        ...
        AnimatedStyle = class extends AnimatedObject {
            constructor({ x: e, y: t, z: s, ...n }) {
                ...
                ((e || t || s) &&
                    (a.push([e || 0, t || 0, s || 0]),
                    r.push((e) => [`translate3d(${e.map((e) => addUnit(e, 'px')).join(',')})`, isValueIdentity(e, 0)])),
                    eachProp(n, (e, t) => {
        ...
        FluidTransform = class extends FluidValue {
            ...
            observerAdded(e) {
                1 == e && each(this.inputs, (e) => each(e, (e) => hasFluidValue(e) && addFluidObserver(e, this)));
            }
            observerRemoved(e) {
                0 == e && each(this.inputs, (e) => each(e, (e) => hasFluidValue(e) && removeFluidObserver(e, this)));
            }
            eventObserved(e) {
    ...
    function useSimpleTooltip({ alert: e, body: t, header: s, note: n, hasHtmlContent: a, disabled: r }) {
    ...
    class DLDict {
        constructor(e, t = DEFAULT_OPTIONS) {
            ...
            ((this._keys = mobx.observable.set(new Set(n))), (this._data = mobx.observable.box(s, MOBX_OPTIONS)));
        }
        _data;
        _keys;
        get keys() {
            ...
            for (let n = 0; n < t.length; n++) {
                ...
                a in s
                    ? null === r
                        ...
                        : s[a].set(r)
                    : null !== r && ((s[a] = mobx.observable.box(r, MOBX_OPTIONS)), this._keys.add(a), this.set(s));
            }
        }
        entries() {
            ...
            (t, s, n) => {
                ...
                function r(r) {
                    const { mode: i, options: o, children: l, mocks: c } = r,
                        ...
                        g = n?.useRequires?.(),
                        f = useEvent((a, i, o) => {
                            const l = 'real' !== a && o ? createMockInstance(o.getter, i) : create(i, { name: e }),
    ...
    const base$l = 'TruncateText_dcb41d92',
        ...
        TruncatedText = React.forwardRef(function ({ text: e, tooltipParams: t, className: s, ...n }, a) {
            const r = useSimpleTooltip({ header: t?.header, body: t?.body || e }),
                i = React.useRef(null),
                [o, l] = React.useState(!1),
                c = React.useCallback(() => {
                    i.current && l(i.current.scrollWidth - Math.ceil(i.current.getBoundingClientRect().width) > 0);
                }, []);
            return (
                React.useEffect(() => {
                    o || r.onMouseLeave();
                    ...
                    null == t || null === (n = t.compoundVariants) || void 0 === n
                        ...
                        : n.reduce((e, t) => {
                              ...
                              return Object.entries(a).every((e) => {
                                  let [t, s] = e;
                                  return Array.isArray(s) ? s.includes({ ...r, ...o }[t]) : { ...r, ...o }[t] === s;
                              })
                                  ? [...e, s, n]
                                  : e;
                          }, []);
    ...
    function defineStyledComponent(e, t, s) {
        ...
        const r = cva(t, s),
            i = React.forwardRef(function (t, s) {
                return jsxRuntime.jsx('div', { 'data-name': e, ...cleanProps(a, t), ref: s, className: r(t) });
            });
    ...
    const themes = { primary: 'primary', secondary: 'secondary', custom: 'custom' },
        ...
        HeadlessButtonBase = defineStyledComponent('Button', { element: 'button', className: styles$p.base }),
        HeadlessButton = React.forwardRef(function (
            { children: e, onClick: t, onMouseEnter: s, soundTarget: n, disabled: a = !1, silent: r = !1, ...i },
            o,
        ) {
            const l = useSounds();
    ...
    const base$i = 'Action_6c7b0c76',
        ...
        Action = React.forwardRef(function (
            ...
            const r = useSimpleTooltip({ alert: s?.alert, header: s?.header, body: s?.body, note: s?.note });
    ...
    ((Card.Header = Header), (Card.Content = Content$1), (Card.Action = Action), (Card.Title = Title$1));
    ...
    function splitString(e) {
        ...
        return addSpaceAndMap(splitLocale(e, t), t, (e, t) => e && jsxRuntime.jsx('span', { children: e }, `${e}${t}`));
    }
        ...
        for (const i of e)
            if (i.type === NodeTypes.Text) r(i.value);
                ...
                null === s[i.name] || primitives.includes(typeof s[i.name])
                    ? r(s[i.name] ?? `{{${i.name}}}`)
                    : a.push(jsxRuntime.jsx(React.Fragment, { children: s[i.name] }, `var-${i.name}-${i.instanceId}`));
    ...
    const defaultBrackets = { start: '{{', end: '}}' },
        FormatText = React.memo(function (e) {
            const {
                ...
                d = React.useMemo(() => (e.upgradeLegacy ? upgradeLegacy(e.text) : e.text), [e.text, e.upgradeLegacy]),
                u = React.useMemo(
    ...
    function FormatString({ path: e, ...t }) {
        return jsxRuntime.jsx(FormatText, { text: resources.resolve('strings').readOrEmpty(e), ...t });
    }
    ...
    function ProgressCount({ current: e, total: t, withLabel: s, withoutLimit: n, className: a, classNames: r }) {
    ...
    function RandomCard({
        ...
        return jsxRuntime.jsxs(Card, {
            ...
            children: [
                ...
                void 0 !== i &&
                    jsxRuntime.jsx(Card.Content, { className: clsx(styles$g.content, c?.content), children: i }),
    ...
    function useProgressBarSounds(e = 0) {
        ...
        return useEvent(({ step: e } = {}) => {
            if (!t.silent)
                return t.activeComponents.has('delta') ? a(e) : t.activeComponents.has('fill') ? r() : void 0;
        });
    }
        ...
        Delta = React.memo(
            React.forwardRef(function (
                ...
                return (
                    React.useEffect(() => {
                        const e = c.current;
                        if (!e || 0 === x) return (g.set({ width: 0 }), m.set({ width: 0 }), w('done'), void v([]));
                    ...
                    jsxRuntime.jsxs(animated.div, {
                        ...
                        children: [
                            jsxRuntime.jsxs(animated.div, {
                                ...
                                className: clsx(n?.outside, styles$d.outside, x > 0 && styles$d.outside__increase),
                                children: [
                                    jsxRuntime.jsx(animated.div, {
                                        style: { width: u.width.to((e) => `${e}%`) },
                                        className: clsx(n?.inside, styles$d.inside, x > 0 && styles$d.inside__increase),
                                    }),
                                    o.children,
                                ],
                            }),
    ...
    function Step({ position: e, value: t, children: s, className: n, classNames: a }) {
        ...
        return jsxRuntime.jsxs('div', {
            ...
            children: [
                e === positions.below && jsxRuntime.jsx('div', { className: clsx(styles$b.indicator, a?.indicator) }),
                void 0 !== s && jsxRuntime.jsx('div', { className: clsx(styles$b.label, a?.label), children: s }),
                e === positions.above && jsxRuntime.jsx('div', { className: clsx(styles$b.indicator, a?.indicator) }),
            ],
        });
    }
            ...
            return jsxRuntime.jsxs('div', {
                ...
                children: [
                    jsxRuntime.jsx('div', {
                        ...
                        className: clsx(t?.negative, styles$a.negative, 'negative' === i && styles$a.negative__visible),
                    }),
                    jsxRuntime.jsx('div', {
                        style: { left: `${c}%`, width: `${d}%`, ...s.style },
                        className: clsx(t?.positive, styles$a.positive, 'positive' === i && styles$a.positive__visible),
                    }),
                ],
            });
        });
    function ProgressBarProvider(e) {
        ...
        const p = React.useMemo(() => {
            ...
            g = React.useMemo(
                ...
                [t, n, l, e.animationType, e.size, e.status, e.soundTarget, e.silent, e.maxValueAchieved, m, p, c],
            );
        ...
        ProgressBar$1 = function ({
            ...
            return jsxRuntime.jsx(ProgressBarProvider, {
                ...
                children: jsxRuntime.jsxs(Base, {
                    size: e,
                    className: clsx(n, r.value === r.maxValue && s !== statuses.doneInactive && styles$9.base__done),
                    children: [
                        jsxRuntime.jsx('div', {
                        ...
                        jsxRuntime.jsx(BackgroundPattern, { backgroundPattern: t, className: a?.backgroundPattern }),
                        r.children,
                    ],
                }),
            });
    ...
    const wrapper = 'ProgressBar_wrapper_a944db13',
        ...
        ProgressBar = React.memo(function ({ progressBar: e, fill: t, delta: s, wrapperSpringProps: n }) {
                ...
                return {
                    ...
                    delta: r
                        ...
                        : {
                              ...
                              growAnimationConfig: { duration: PROGRESS_BAR_DURATION, easing: progressBarCubicBezier },
                    ...
                    fill: {
                        animationConfig: { duration: r ? 0 : PROGRESS_BAR_DURATION, easing: progressBarCubicBezier },
                    },
                };
        }, [r, l, c, n, e, i, o, s]);
        return n
            ? (assert.log(
              ...
              jsxRuntime.jsxs('div', {
                  ...
                  children: [
                      void 0 !== u &&
                          jsxRuntime.jsx(ProgressBar, { progressBar: u.progress, delta: u.delta, fill: u.fill }),
                      jsxRuntime.jsxs('div', {
    ...
    function Title({ questsAmount: e }) {
        const { title: t, icon: s, completed: n, progression: a } = useCondition(),
            { completed: r } = useMissionCard();
        if (!s && !t) return null;
        const i = getIcon$1({ icon: s, questCompleted: r, questsAmount: e, conditionCompleted: n });
        return jsxRuntime.jsxs('div', {
            ...
            children: [
                void 0 !== i &&
                    jsxRuntime.jsx('div', {
                        ...
                        className: clsx(styles$6.titleIcon, i.default.isGold && styles$6.titleIcon__gold),
                    }),
            ...
            jsxRuntime.jsx(Content.Root, {
                ...
                children: jsxRuntime.jsxs(Content.Body, {
                    children: [
                        ...
                        jsxRuntime.jsx(Content.Description, { guiDisabledDescription: e.guiDisabledDescription }),
                        !t &&
        ...
        getDogTypeImage = (e, t, s) => {
            ...
            if (n) {
                const a = R.images.gui.maps.icons.dogtags.$dyn(t).$dyn(n),
                    r = a.$dyn(s);
                return !r && DOG_TAG_DEFAULT_ICON_NAME[e] ? `${a.$dyn(DOG_TAG_DEFAULT_ICON_NAME[e])}` : `${r}`;
            }
            return (
    ...
    function Rewards({ bonuses: e, size: t, resId: s, boxRewardTooltipArgs: n, maxRewardsCount: a, questId: r, ...i }) {
                    ...
                    map(e, (e) => ({
                        ...
                        tooltipArgs: {
                            ...getRewardTooltipConfig(
                                { tooltipId: r ? `${r}:${e.tooltipId}` : e.tooltipId },
    ...
    React.forwardRef(function ({ path: e, width: t, height: s, ...n }, a) {
        ...
        return jsxRuntime.jsx(Image, { ...n, ref: a, width: t ?? r.size, height: s ?? r.size, path: e ?? r.path });
    });
    ...
    function Separator(e) {
        return 'none' === e.type
            ? jsxRuntime.jsx('div', { className: clsx(styles$6.separator, styles$6.separator__none, e.className) })
            : 'union' === e.type
              ? jsxRuntime.jsx('div', { className: clsx(styles$6.separator, styles$6.separator__union, e.className) })
              : 'or' === e.type
                ? jsxRuntime.jsxs('div', {
                      className: clsx(styles$6.separator, styles$6.separator__or, e.className),
                      children: [
                          jsxRuntime.jsx(SvgArrowRight, { width: 16, height: 16, className: styles$6.invertedArrow }),
                          strings.readOrEmpty('battle_results.conditions.type.or'),
                          jsxRuntime.jsx(SvgArrowRight, { width: 16, height: 16, className: styles$6.arrow }),
                      ],
                  })
                : jsxRuntime.jsx('div', {
    ...
    function Separators(e) {
        ...
        return jsxRuntime.jsx(jsxRuntime.Fragment, {
            children: filterMap(
                ...
                (e) => null != e,
                (t, s) =>
                    jsxRuntime.jsxs(React.Fragment, { children: [s > 0 && jsxRuntime.jsx(Separator, { ...e }), t] }, s),
            ),
        });
    }
    ...
    const MIDDLE_QUESTS_COUNT = 3,
        ...
        DEFAULT_ICON = { default: { path: `${DEFAULT_GENERAL_ICON}_32` }, medium: { path: DEFAULT_GENERAL_ICON } },
        Groups = React.memo(function (e) {
            const t = useSpringRef(),
                ...
                { icon: r, questsAmount: i } = React.useMemo(() => {
                    ...
                    return {
                        icon: t > 1 ? (e.generalIcon ?? DEFAULT_ICON) : (findFirstIcon(e.value) ?? DEFAULT_ICON),
                        questsAmount: t,
                    };
    ...
    function MissionCard({ completed: e, progress: t, animation: s, immediateAnimation: n, target: a, ...r }) {
        const i = useSounds(),
        ...
        return jsxRuntime.jsx(missionCardContext.Provider, {
            ...
            children: jsxRuntime.jsx(RandomCard, {
                ...
                onMouseEnter: (e) => {
                    (r.onMouseEnter?.(e),
                        !0 !== r.disabled &&
                            i.play('mouse-enter', { target: a || 'mission-progress:mission-card', original: e }));
                },
    ...
    ((MissionCard.Content = Content), (MissionCard.Groups = Groups), (MissionCard.Separators = Separators));
    ...
    const children = Object.freeze(
        ...
        sendViewEvent = (e, t) => {
            ...
            if (void 0 !== t) {
                const { args: n, ...a } = t;
                return void 0 !== n
                    ? viewEnv.handleViewEvent({ __Type: s, type: e, ...a, arguments: createViewEventArguments$1(n) })
                    : viewEnv.handleViewEvent({ __Type: s, type: e, ...a });
            }
            return viewEnv.handleViewEvent({ __Type: s, type: e });
        },
    ...
    function dumpViewModel(e) {
        ...
        for (const s in e)
            if (Object.prototype.hasOwnProperty.call(e, s)) {
                ...
                } else n.startsWith('[object class BW::WULF::ViewModel') ? (t[s] = dumpViewModel(e[s])) : (t[s] = e[s]);
            }
        return t;
    }
    const SystemLocale = {
    ...
    const makeGlobalBoundingBox = (e) => ({
        ...
        handleViewEvent$1 = (e, t) => {
            ...
            if (void 0 !== t) {
                const { args: n, ...a } = t;
                void 0 !== n
                    ? viewEnv.handleViewEvent({ __Type: s, type: e, ...a, arguments: createViewEventArguments(n) })
                    : viewEnv.handleViewEvent({ __Type: s, type: e, ...a });
    ...
    const handleViewEvent = (e, t, s = {}, n = 0) => {
        ...
        Tooltip = ({
            ...
            const f = React.useRef({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                      ...
                      onMouseEnter:
                          ...
                          (e) => {
                              (e.clientX === window.innerWidth && e.clientY === window.innerHeight) ||
                                  ...
                                  (f.current.timeoutId = window.setTimeout(_, o ? SHOW_DELAY_MIN : SHOW_DELAY_DEFAULT)),
                                  n && n(e),
                                  v && v(e));
                          }),
                      onMouseLeave: ((e) => (t) => {
    ...
    const QuestCard = mobxReactLite.observer(function ({ quest: e, animation: t, immediateAnimation: s }) {
            const n = useSpringRef(),
                a = useSpringRef(),
                { customizationId: r, progressionLevel: i, customizationIconKey: o, value: l, completed: c } = e,
            ...
            return jsxRuntime.jsxs('div', {
                ...
                children: [
                    jsxRuntime.jsx('div', {
                        ...
                        children: c
                            ? jsxRuntime.jsx(AnimatedCompletedMark, { animationRef: a, springProps: { immediate: s } })
                    ...
                    jsxRuntime.jsx('div', {
                        ...
                        children: jsxRuntime.jsx(BackportTooltip, {
                            args: { tooltipId: 'techCustomizationItem', customizationId: r, progressionLevel: i },
                            children: jsxRuntime.jsx('div', {
        ...
        rewardsTooltipResId = aliases$1.read((e) => e.comp7.shared.BattleResultsCustomizationQuests('resId'));
    function getIcons(e) {
        ...
        return {
            iconPath:
                t && 'string' == typeof t ? t : 'R.images.gui.maps.icons.userMissions.missionIcons.c_32.folder_silver',
            largeIconPath:
                s && 'string' == typeof s ? s : 'R.images.gui.maps.icons.userMissions.missionIcons.c_80.folder_silver',
        };
    }
    const [CustomizationQuestsProgressProvider, useCustomizationQuestsProgress] = initializeModelWithContext()(
            ({ observableModel: e }) => {
        ...
        CustomizationQuests = mobxReactLite.observer(function ({ animation: e, immediateAnimation: t }) {
