...
!(function (e, t) {
    ...
    const Yi = 'Delta_eb295acb',
                    ...
                    children: [
                        e.jsx(sa, {
                            ...
                            className: S(
                                n?.done,
                                na.done,
                                !r.progressCompleted && na.done__hidden,
                                r.progressCompleted && (c ? na.done__doneStatic : na.done__visible),
                            ),
                            repeat: 'repeat',
                            position: 'left top',
                        ...
                        !c &&
                            e.jsx(sa, {
                                ...
                                className: S(n?.doneComplete, na.complete, r.progressCompleted && na.complete__visible),
                                repeat: 'repeat',
                                position: 'left top',
                                style: { width: d.width.to((e) => `${e}%`) },
                            }),
        ...
        aa = s.memo(function ({ filledPattern: t, classNames: n, className: r, animationConfig: o, ...i }) {
            const a = qi(),
                l = Wi(),
                c = ir(),
            ...
            return (
                ...
                e.jsxs('div', {
                    className: S(na.base, r),
                    children: [
                        e.jsx(rr.div, { className: n?.fill, style: { width: f.width.to((e) => `${e}%`) } }),
                        i.children ??
                            e.jsxs(e.Fragment, {
                                children: [
                                    e.jsx(ia, { filledPattern: t, className: n?.filledPattern, animationConfig: o }),
                                    e.jsx(ra, { classNames: n, animationConfig: o }),
                                ],
                            }),
                        e.jsx(rr.div, {
                            className: S(
                                n?.edge,
                                na.edge,
                                0 === a.percentage && na.edge__noProgress,
                                !u.has('previewDelta') && !a.progressCompleted && na.edge__visible,
                                a.status && na[`edge__${a.status}`],
                            ),
    ...
    const Ka = Qa(Za),
        ...
        ul = ({
            ...
            const g = cl.has(o) ? cl.get(o) : o,
                ...
                v = dr({ contentId: f?.contentId ?? 0, args: f?.args, resId: f?.resId, decoratorId: f?.decoratorId }),
