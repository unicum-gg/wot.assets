...
!(function (e, t) {
    ...
    const ea = 'Delta_eb295acb',
                    ...
                    children: [
                        ...
                        !c &&
                            e.jsx(la, {
                                ...
                                className: S(n?.doneComplete, aa.complete, r.progressCompleted && aa.complete__visible),
                                repeat: 'repeat',
                                position: 'left top',
                                style: { width: d.width.to((e) => `${e}%`) },
                            }),
        ...
        pa = s.memo(function ({ filledPattern: t, classNames: n, className: r, animationConfig: o, ...i }) {
            const a = Wi(),
                l = Ji(),
                c = ar(),
