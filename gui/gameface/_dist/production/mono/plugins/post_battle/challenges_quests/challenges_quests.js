...
!(function (e, t) {
    ...
    function fe(e, t, n) {
        return 'function' == typeof t ? he(0, e, t) : (pe(void 0 !== n, 'fn must be defined'), he(e, t, n));
    }
    function he(e, t, n) {
    ...
    Ne.setTimeout = (e, t) => {
        const n = Ne.now() + t,
            s = () => {
                ...
                (~e && je.splice(e, 1), ($e -= ~e ? 1 : 0));
            },
            r = { time: n, handler: e, cancel: s };
        return (je.splice(De(n), 0, r), ($e += 1), Ue(), r);
    };
    ...
    function qe() {
        ...
        Be = Ne.now();
        const t = De(Be);
        (t && (Ge(je.splice(0, t), (e) => e.handler()), ($e -= t)),
            $e
    ...
    function Ht(e, t) {
        if (e[$t]) {
            let n = e[Ft];
            (n || Yt(e, Ft, (n = new Set())), n.has(t) || (n.add(t), e.observerAdded && e.observerAdded(n.size, t)));
        }
        return t;
    }
    function Qt(e, t) {
    ...
    var Mn = (e, t) => !0 === e || !!(t && e && (Ye.fun(e) ? e(t) : Je(e).includes(t))),
        ...
        $n = ['config', 'onProps', 'onStart', 'onChange', 'onPause', 'onResume', 'onRest'],
        Fn = {
            config: 1,
            from: 1,
            to: 1,
    ...
    var rs = class extends Error {
        ...
        hs = class extends ls {
            ...
            _merge(e, t, n) {
                ...
                if (
                    (T && ds(this) && (i.changed && !y ? (C = !0) : C || this._stop(l)),
                    !f &&
                        ((C || Lt(l)) &&
        ...
        Ts = class {
            ...
            start(e) {
                ...
                return (
                    ...
                    this._flush ? this._flush(this, t) : (Ms(this, t), Ps(this, t))
                );
            }
            stop(e, t) {
                if ((e !== !!e && (t = e), t)) {
    ...
    function Fs(e, t) {
        const n = Ye.fun(e),
            [[r], o] = (function (e, t, n) {
                ...
                function m(e, n) {
                    for (let s = e; s < n; s++) {
                        const e = c.current[s] || (c.current[s] = new Ts(null, l.flush)),
                            n = r ? r(s, e) : t[s];
                        n && (u[s] = ys(n));
                    }
                }
    ...
    function zs(e, t, n) {
        const r = Ye.fun(t) && t,
            ...
            f = s.useMemo(() => (r || 3 == arguments.length ? $s() : void 0), []),
            h = Je(e),
            g = [],
            _ = s.useRef(null),
            b = o ? null : _.current;
        ...
        if (
            ...
            Ze(h, (e, t) => {
                g[t] || ((g[t] = { key: y[t], item: e, phase: 'mount', ctrl: new Ts() }), (g[t].ctrl.item = e));
            }),
            w.length)
        ) {
            let e = -1;
        ...
        (dn(() => {
            ...
            dn(
                () => {
                    Ze(T.current.size ? T.current : C, ({ phase: e, payload: t }, n) => {
                        const { ctrl: s } = n;
                        ((n.phase = e),
                            f?.add(s),
    ...
    const ur = new WeakMap(),
        ...
        mr = 'idle',
        pr = 'display';
    function fr({ resId: e = 0, contentId: t, decoratorId: n, disabled: r, args: o, showDelay: a = 400 }) {
        const i = s.useRef({ status: mr, resId: e, timeoutId: 0 }),
            [l, c] = s.useMemo(() => {
                let s = null;
                function l() {
                    r ||
                        ('display' === i.current.status && (Q.tooltip.hide(e, t, n), (i.current.status = mr)),
                        (i.current.status = dr),
                        window.clearTimeout(i.current.timeoutId),
                        (i.current.timeoutId = window.setTimeout(c, a)));
                }
                function c() {
                    ((i.current.status = pr), Q.tooltip.open(e, t, n, o), s && ur.set(s, d));
                }
                function u() {
                    if (
                        (window.clearTimeout(i.current.timeoutId),
                        i.current.status === pr && Q.tooltip.hide(e, t, n),
                        (i.current.status = mr),
                        s)
                    ) {
                        ur.delete(s);
                ...
                const d = {
                    ...
                    show: c,
                    rerun: function () {
                        i.current.status !== mr && (r ? d.hide() : l());
                    },
                };
                return [
                    d,
    ...
    function hr({ alert: e, body: t, header: n, note: r, hasHtmlContent: o, disabled: a }) {
    ...
    const gr = {
        click: _r('play'),
        'hot-key': _r('play'),
        'mouse-enter': _r('highlight'),
        increaseAmount: _r('cons_ammo_single_plus'),
        decreaseAmount: _r('cons_ammo_single_minus'),
        increaseAmountRoll: _r('cons_ammo_roll_plus'),
        decreaseAmountRoll: _r('cons_ammo_roll_minus'),
        close: _r('cancelcloseno'),
        'show-context-menu': _r('tabb'),
        progressSimple: _r('gui_hangar_progressbar_simple'),
        increaseDelta: _r('gui_hangar_progressbar_delta_increase'),
        decreaseDelta: _r('gui_hangar_progressbar_delta_decrease'),
        increaseDeltaMax: _r('gui_hangar_progressbar_delta_max'),
        pointerGrab: _r('gui_hangar_progressbar_pointer_grab'),
        pointerDrag: _r('gui_hangar_progressbar_pointer_drag'),
    };
    function _r(e) {
        return () => {
            F.sound(e);
    ...
    function yr({ severity: t = 'warn', overrides: n, silent: r = !1, children: o }) {
        ...
        return e.jsx(br.Provider, { value: i, children: o });
    }
    function vr() {
        const e = s.useContext(br);
        if (!e) throw new Error('hook useSounds must be used within SoundsProvider');
        return e;
    }
    const wr = new Set(['number', 'string', 'boolean', 'bigint', 'undefined', 'function']),
        xr = new Set(['number', 'string', 'boolean', 'bigint']),
        Er = new Set(['Dict']);
    function Rr(e, { shallow: t = !0, depth: n = 0, maxDepth: s = 32 } = {}) {
        const r = e,
            o = typeof e;
        if (n > s) throw new Error(`Too deeply nested to copy. Max is ${s}.`);
        if (wr.has(o)) return r;
        if (null === r) return r;
        const a = { depth: n + 1, maxDepth: s };
        if (Array.isArray(r)) return r.map((e) => Rr(e, a));
        if ('object' === o) {
            const s = r.constructor?.name ?? 'UNKNOWN';
            if (Array.isArray(e)) return e.map((e) => Rr(e, a));
            if ('CoherentArrayProxy' === s) return e.map((e) => Rr(e.value, a));
            if ('Dict' === s) return;
            if ('UNKNOWN' === s) return;
            ...
            const o = {};
            for (const e of Object.keys(r)) o[e] = Rr(r[e], a);
            return o;
        }
        return (console.error('Incorrect value to clone model', r), r);
    }
    const Cr = { deep: !1, equals: ee },
        Tr = { cloneItem: !0 },
        Pr = { shallow: !1 };
    class Sr {
        constructor(e, t = Tr) {
            ...
            for (let o = 0; o < r.length; o++) {
                const t = r[o];
                s[t] = n.observable.box(this.takeItem(e, t), Cr);
            }
            ((this._keys = n.observable.set(new Set(r))), (this._data = n.observable.box(s, Cr)));
        }
        _data;
        _keys;
        get keys() {
            ...
            for (let r = 0; r < t.length; r++) {
                ...
                o in s
                    ? null === a
                        ...
                        : s[o].set(a)
                    : null !== a && ((s[o] = n.observable.box(a, Cr)), this._keys.add(o), this.set(s));
            }
        }
        entries() {
    ...
    function Ir(e, t, s) {
        ...
        const o = (o, a, i = Ar) => {
            ...
            i = (o, a) => {
                const i = n.observable.box(s(o) ?? a, Ar);
    ...
    o.computedFn;
    const Mr = (e, t) => o.computedFn(e, { equals: n.comparer.structural, ...t }),
        jr = (e) => (t) => {
            e.forEach((e) =>
                ((e, t) => {
    ...
    function $r(e, t) {
        ...
        for (let l = 0; l < e.length; l++) {
            ...
            if (c === t.start[0] && e.slice(l, l + t.start.length) === t.start) {
                if (r) {
                    if (s.length > 0) {
                        s[s.length - 1].node.children.push({ type: Dr, value: r });
                    } else n.push({ type: Dr, value: r });
                    r = '';
                }
                ...
                if (e.startsWith('@')) {
                    const t = e.slice(1).trim(),
                        r = { type: Or, attrs: t.split('|'), instanceId: ++i, children: [] };
                    if (s.length > 0) {
                    ...
                    const t = { type: Br, instanceId: ++i, name: e };
                    if (s.length > 0) {
        ...
        return Array.isArray(t)
            ? (function (t) {
                  ...
                  for (let r = 0; r < t.length; r++) {
                      const o = t[r],
                          a = t[r + 1];
                      if ('string' != typeof a || !qr.test(a)) {
                          n.push(Gr(o));
                          continue;
                      }
                      const i = Vr(a.slice(1));
                      (n.push(
                          e.jsxs(
                              s.Fragment,
                              { children: [e.jsxs('span', { className: Fr.nowrap, children: [Gr(o), a[0]] }), i] },
                              zr(),
                          ),
                      ),
                          (r += 1));
            ...
            : 'string' == typeof t
              ? e.jsx(s.Fragment, { children: Vr(t) }, zr())
              : t;
    }
    const Hr = {
        class: function (t, ...n) {
    ...
    function Xr(e, t) {
        for (let n = 0; n < e.length; n++) {
            if ('$' === e[n]) {
                let s = n + 1;
                for (; s < e.length && !Yr(e[s]);) s++;
                const r = e.slice(n + 1, s),
                    o = t[r];
                if (o) return Xr(e.replace(`$${r}`, String(o)), t);
            }
        }
        return e;
    }
    function Zr(e, t) {
        const n = [];
        for (let s = 0; s < e.length; s++) n[s] = Xr(e[s], t);
        return n;
    }
    const Kr = ['number', 'string', 'undefined'];
    function Jr(t, n, r = {}, o = !0) {
        o && (Ur = 0);
        const a = [];
        function i(e) {
            if (Kr.includes(typeof e)) {
                const t = a.at(-1);
        ...
        for (const l of t)
            if (l.type === Dr) i(l.value);
            else if (l.type === Br)
                null === r[l.name] || Kr.includes(typeof r[l.name])
                    ? i(r[l.name] ?? `{{${l.name}}}`)
                    : a.push(e.jsx(s.Fragment, { children: r[l.name] }, `var-${l.name}-${l.instanceId}`));
            else if (l.type === Or) {
                const e = Jr(l.children, n, r, !1),
                    t = Wr(Zr(l.attrs, r), e, n);
                a.push(t);
            }
        return a;
    }
    ...
    const ro = { start: '{{', end: '}}' },
        oo = s.memo(function (t) {
            const {
                ...
                m = s.useMemo(() => (t.upgradeLegacy ? so(t.text) : t.text), [t.text, t.upgradeLegacy]),
                p = s.useMemo(() => (t.formatters ? { ...Hr, ...t.formatters } : Hr), [t.formatters]),
                f = s.useMemo(() => $r(u ? `{{@ split}}${m}{{/}}` : m, n), [n, m, u]),
                h = s.useMemo(() => Jr(f, p, t.params), [f, p, t.params]),
                g = N(Fr.base, i && Fr.base__fullSize, d.className);
            return t.inline
                ? (console.warn(
    ...
    function ao({ path: t, ...n }) {
        return e.jsx(oo, { text: p.resolve('strings').readOrEmpty(t), ...n });
    }
    function io(t) {
    ...
    function co(t) {
        ...
        return s.forwardRef(function (t, s) {
            const r = t,
                ...
                u = { ...l, ref: s };
            {
                const t = i ? c.readOr(i, lo, 'warn') : void 0;
    ...
    co(
        s.forwardRef(function (t, n) {
            const { width: s, height: r, src: o, unselectable: a, unknown: i, unknownStyle: l = uo, ...c } = t;
            return t.unknown
    ...
    const po = 'TruncateText_dcb41d92',
        fo = s.forwardRef(function ({ text: t, tooltipParams: n, className: r, ...o }, a) {
            const i = hr({ header: n?.header, body: n?.body || t }),
                l = s.useRef(null),
                [c, u] = s.useState(!1),
                d = s.useCallback(() => {
            ...
            return (
                ...
                e.jsx('div', { ...o, ref: jr([a, l]), className: N(po, r), ...(c ? i : {}), children: t })
            );
        }),
        ho = (e) => ('boolean' == typeof e ? `${e}` : 0 === e ? '0' : e),
        go = N,
        _o = (e, t) => (n) => {
            var s;
            if (null == (null == t ? void 0 : t.variants))
                return go(e, null == n ? void 0 : n.class, null == n ? void 0 : n.className);
            ...
            return go(e, a, l, null == n ? void 0 : n.class, null == n ? void 0 : n.className);
        };
    function bo(t, n, r) {
        ...
        if ('object' == typeof n) {
            const e = n,
                r = _o(e.className, e.cva),
                o = e.element,
                i = s.forwardRef(function (e, t) {
                    return s.createElement(o, { ...('function' == typeof o ? e : yo(a, e)), ref: t, className: r(e) });
                });
            return ((i.displayName = t), e.cva && (i.cva = e.cva), i);
        }
        const i = _o(n, r),
            l = s.forwardRef(function (n, s) {
                return e.jsx('div', { 'data-name': t, ...yo(a, n), ref: s, className: i(n) });
            });
    ...
    const vo = { primary: 'primary', secondary: 'secondary', custom: 'custom' },
        wo = { extraSmall: 'extraSmall', small: 'small', medium: 'medium', large: 'large' },
        xo = bo('Button', { element: 'button', className: 'HeadlessButton_df8536fc' }),
        ...
        Co = s.forwardRef(function (
            ...
            return e.jsxs(Eo, {
                ...
                className: N(
                    ...
                    Ro[`base__size-${n}`],
                    Ro[`base__theme-${s}`],
                    r ? Ro.base__disabled : Ro.base__enabled,
                    l,
                    i?.base,
                ),
                onClick: function (e) {
                ...
                children: [
                    e.jsx('div', { className: N(Ro.background, i?.background) }),
                    e.jsx('div', { className: N(Ro.border, i?.border) }),
                    e.jsx('div', { className: N(Ro.overlay, i?.overlay) }),
                    e.jsx('div', { className: N(Ro.content, a && Ro.content__fontAligned, i?.content), children: t }),
                ],
            });
        });
    ((Co.themes = vo), (Co.sizes = wo));
    const To = 'Action_6c7b0c76',
        Po = 'Action_icon_7d5aed3b',
        So = s.forwardRef(function ({ className: t, theme: n = Co.themes.secondary, tooltipParams: s, ...r }, o) {
            const a = hr({ alert: s?.alert, header: s?.header, body: s?.body, note: s?.note });
            return e.jsx(Co, {
                ...r,
                ref: o,
                onClick: (e) => {
                ...
                theme: n,
                className: N(To, t),
                children: e.jsx(mo, { width: 10, height: 20, path: 'post_battle.progression.arrow', className: Po }),
            });
        }),
        No = 'Header_background_91826dd5',
        ko = 'Header_mask_afb9c38d',
        Ao = 'Header_border_c6b1d37f',
        Io = bo('CardHeader', 'Header_1c2ee301'),
        Mo = s.forwardRef(function ({ classNames: t, className: n, ...s }, r) {
            return e.jsxs(Io, {
                ...s,
                className: N(t?.base, n),
                ref: r,
                children: [
                    e.jsx('div', { className: N(No, t?.background) }),
                    e.jsx('div', { className: N(ko, t?.mask) }),
                    e.jsx('div', { className: N(Ao, t?.border) }),
                    s.children,
                ],
            });
        }),
        jo = bo('CardTitle', 'Title_e5ecf295'),
        Do = s.forwardRef(function (t, n) {
            return e.jsx(jo, { ...t, ref: n, children: t.children });
        }),
        Oo = 'Card_content_f7ddaa4a',
        Bo = bo('Card', 'Card_3f55e450'),
        $o = bo('CardContent', Oo),
        Fo = s.forwardRef(function (t, n) {
            return e.jsx(Bo, { ...t, ref: n, children: t.children });
        });
    ((Fo.Header = Mo), (Fo.Content = $o), (Fo.Action = So), (Fo.Title = Do));
    const Lo = 'AnimatedValue_d9f4b2f0',
        Uo = 'AnimatedValue_animatedValue_4c490d83',
        zo = k.cubicBezier(0.33, 0, 0.25, 1);
    function qo(e) {
        return {
    ...
    function Vo({ value: t, transition: n, children: r, className: o, classNames: a }) {
        const i = s.useMemo(ve, []),
            l = zs(t, {
                ...n,
                ...
                enter: () => ({
                    ...
                    y: '0rem',
                    delay: 330,
                    config: { easing: zo, duration: 330 },
                    onStart: () => {
                        const { enterElements: e, leftElements: t } = qo(i);
                        (e.forEach((e) => {
                ...
                leave: () => ({
                    ...
                    onStart: () => {
                        let e = 0;
                        const { enterElements: t, leftElements: n } = qo(i);
                        (n.forEach((t) => {
        ...
        return e.jsx('div', {
            ...
            children: l((n, s) => {
                ...
                return e.jsx(ir.div, {
                    className: N(Uo, `js-animated-value-${i}-${t === s ? 'enter' : 'leave'}`, a?.animatedValue),
    ...
    const Go = 'ProgressCount_3c6daa70',
        Ho = 'ProgressCount_label_d15406bd',
        Qo = 'ProgressCount_total_4f222a62',
        Wo = 'ProgressCount_divider_487d7768',
        Yo = p.resolve('intl');
    function Xo({ withLabel: e, withoutLimit: t }) {
        return t
    ...
    function Zo({ current: t, total: n, withLabel: s, withoutLimit: r, className: o, classNames: a }) {
        return e.jsx(ao, {
            path: Xo({ withLabel: s, withoutLimit: r }),
            className: N(Go, o),
            params: {
                completed: Yo.formatNumber('integral', t),
                total: Yo.formatNumber('integral', n),
                totalClass: N(Qo, a?.total),
                labelClass: s && N(Ho, a?.label),
            },
        });
    }
    function Ko({
            ...
            e.jsx(ao, {
                ...
                params: {
                    completed: e.jsx(Vo, {
                        ...
                        value: Yo.formatNumber('integral', t),
                        transition: {
                            ...i,
                            enter: {
                                ...i.enter,
                    ...
                    total: e.jsx(Vo, {
                        ...
                        value: Yo.formatNumber('integral', n),
                        transition: {
                            ...l,
                            enter: {
                                ...l?.enter,
    ...
    function ea({
        ...
        return e.jsxs(Fo, {
            className: N(Jo.card, s && Jo.card__disabled, c),
            ...d,
            children: [
                e.jsxs(Fo.Header, {
                    onClick: o,
                    className: N(Jo.cardHeader, u?.header?.base),
                    classNames: {
                        ...u?.header,
                        background: N(Jo.cardHeaderBackground, u?.header?.background),
                        border: N(Jo.cardHeaderBorder, u?.header?.border),
                    },
                    children: [
                        e.jsxs('div', {
                            className: N(Jo.head, u?.head),
                            children: [
                                e.jsxs('div', {
                                    className: Jo.titleContainer,
                                    children: [
                                        void 0 !== n && e.jsx(mo, { ...n }),
                                        e.jsx(Fo.Title, {
                                            className: N(Jo.title, u?.title),
                                            children: e.jsx(fo, { text: t }),
                                        }),
                                    ],
                                }),
                                void 0 !== a &&
                                    e.jsx(Fo.Action, {
                                        ...
                                        className: N(Jo.action, u?.action),
                                        tooltipParams: r,
                                    }),
                            ],
                        }),
                        e.jsx('div', { className: N(Jo.tail, u?.tail), children: void 0 !== l && e.jsx(Zo, { ...l }) }),
                    ],
                }),
                void 0 !== i && e.jsx(Fo.Content, { className: N(Jo.content, u?.content), children: i }),
                e.jsx('div', { className: Jo.divider }),
            ],
        });
    }
    function ta(e) {
        return (
            ...
            (!s.isValidElement(e) && !!Array.isArray(e) && e.every(ta))
        );
    }
    const na = 'MultilineOverflow_ec9f8e47',
        sa = 'MultilineOverflow_content_b539970d';
    function ra(e) {
    ...
    const oa = s.forwardRef(function (
        {
            text: t,
            brackets: n,
            params: r,
        ...
        s.useEffect(() => {
            ...
            function r() {
                ...
                (s.remove(),
                    (s.className = N(sa, e.children[0].className)),
                    (s.innerHTML = ''),
                ...
                if (o === r) R(!1);
                    ...
                    R(!0);
                    const r =
                        ((a = e.getBoundingClientRect()), { x: (i = t.getBoundingClientRect()).x - a.x, y: i.y - a.y });
        ...
        const C = (function (e) {
                return !e || Object.values(e).every(ta);
            })(r),
            T = (function (e, t, n) {
                return fr({
                    ...n,
    ...
    function aa({
        ...
        return {
            from: { width: e },
            to: { width: t },
            config: o ?? { duration: (n === ca.simple && s) || (!s && r) ? 0 : ia, easing: Bt.easeInOutCubic },
        };
    }
    const ia = 600,
        la = { duration: ia, easing: Bt.easeInOutCubic },
        ca = { simple: 'simple', grow: 'grow', growFreeze: 'growFreeze' },
        ua = { medium: 'medium', large: 'large' },
        da = { disabled: 'disabled', doneInactive: 'doneInactive', doneStatic: 'doneStatic' },
        ma = 'growing',
        pa = 'shrinking',
        fa = 'done',
        ha = s.createContext(void 0);
    function ga() {
        const e = s.useContext(ha);
        if (!e) throw new Error('ProgressBar must be used within a ProgressBar');
        return e;
    }
    function _a(e) {
        const { activeComponents: t } = ga();
        s.useEffect(
            () => (
                t.add(e),
                () => {
    ...
    const ya = s.memo(function ({ className: t, backgroundPattern: n }) {
        const s = ga();
        return (
            _a('backgroundPattern'),
            e.jsx('div', {
                className: ba.base,
                children: e.jsx(mo, {
                    className: N(
                        t,
                        ba.backgroundPattern,
                        0 === s.percentage ? ba.backgroundPattern__noProgress : ba[`backgroundPattern__${s.size}`],
                    ),
                    repeat: 'repeat',
                    position: 'left top',
                    path:
    ...
    function wa(e = 0) {
        const t = ga(),
            ...
            r = va(e, n),
            o = Te(() => {
                t.status !== da.doneInactive && t.progressCompleted
    ...
    const xa = 'Delta_eb295acb',
        Ea = 'Delta_delta__increase_e6e76b0b',
        Ra = 'Delta_outside_b28c01e5',
        Ca = 'Delta_outside__increase_91391b24',
        Ta = 'Delta_inside_b1b3a5c5',
        Pa = 'Delta_inside__increase_fcd871c4',
        Sa = s.memo(
            s.forwardRef(function (
                ...
                return (
                    ...
                    }, [b, m.percentage, C, n, f, S, g, T, r, E]),
                    e.jsxs(ir.div, {
                        ...c,
                        ref: jr([u, d]),
                        className: N(a, xa),
                        ...
                        children: [
                            e.jsxs(ir.div, {
                                ...
                                className: N(o?.outside, Ra, C > 0 && Ca),
                                children: [
                                    e.jsx(ir.div, {
                                        style: { width: p.width.to((e) => `${e}%`) },
                                        className: N(o?.inside, Ta, C > 0 && Pa),
                                    }),
                                    c.children,
                                ],
                            }),
        ...
        ka = ir(mo),
        Aa = s.memo(function ({ donePattern: t, donePatternComplete: n, animationConfig: r, classNames: o }) {
            const a = ga(),
                { activeComponents: i } = ga(),
                l = 100 * a.percentage,
                c = 100 * (a.previous?.percentage ?? 0),
                u = void 0 === a.previous ? l : c,
                d = a.status === da.doneStatic,
                m = cr(),
                [p, f] = Fs(() => ({ width: u }));
            return (
                s.useEffect(() => {
                    ...
                    children: [
                        e.jsx(ka, {
                            ...
                            className: N(
                                o?.done,
                                Na.done,
                                !a.progressCompleted && Na.done__hidden,
                                a.progressCompleted && (d ? Na.done__doneStatic : Na.done__visible),
                            ),
                            repeat: 'repeat',
                            position: 'left top',
                            style: { width: p.width.to((e) => `${e}%`) },
                        ...
                        !d &&
                            e.jsx(ka, {
                                ...
                                className: N(o?.doneComplete, Na.complete, a.progressCompleted && Na.complete__visible),
                                repeat: 'repeat',
                                position: 'left top',
                                style: { width: p.width.to((e) => `${e}%`) },
                            }),
        ...
        Ia = ir(mo),
        Ma = s.memo(function ({ filledPattern: t, animationConfig: n, className: r }) {
            const o = ga(),
                { activeComponents: a } = ga(),
                i = cr(),
                l = 100 * o.percentage,
        ...
        ja = s.memo(function ({
            ...
            const c = ga(),
                u = wa(),
                d = cr(),
                { activeComponents: m } = ga(),
                p = 100 * c.percentage,
                f = 100 * (c.previous?.percentage ?? 0),
                h = void 0 === c.previous ? p : f;
            (_a('fill'),
                s.useEffect(() => {
                    ...
                    d.run(() =>
                        _.start({
                            ...aa({
                                ...
                                deltaVisible: m.has('delta'),
                                preViewDeltaVisible: m.has('previewDelta'),
                                animationConfig: i,
                            }),
                            onStart: () => u(),
                        }),
                    );
                }, [i, _, h, c.animationType, m, p, u, d]),
                e.jsxs('div', {
                    className: N(Na.base, a),
                    children: [
                        e.jsx(ir.div, { className: o?.fill, style: { width: g.width.to((e) => `${e}%`) } }),
                        l.children ??
                            e.jsxs(e.Fragment, {
                                children: [
                                    e.jsx(Ma, { filledPattern: t, className: o?.filledPattern, animationConfig: i }),
                                    e.jsx(Aa, {
                                        classNames: o,
                                        animationConfig: i,
                                        donePattern: n,
                        ...
                        e.jsx(ir.div, {
                            className: N(
                                ...
                                !m.has('previewDelta') && !c.progressCompleted && Na.edge__visible,
    ...
    function Ba({ position: t, value: n, children: s, className: r, classNames: o }) {
        const a = ga();
        return e.jsxs('div', {
            className: N(Oa.step, Oa[`step__${t}`], r),
            style: { left: (n / a.maxValue) * 100 + '%' },
            children: [
                t === Da.below && e.jsx('div', { className: N(Oa.indicator, o?.indicator) }),
                void 0 !== s && e.jsx('div', { className: N(Oa.label, o?.label), children: s }),
                t === Da.above && e.jsx('div', { className: N(Oa.indicator, o?.indicator) }),
            ],
        });
    }
    const $a = bo('Indicators', Oa.base),
        Fa = function (t) {
            const n = ga();
            return (
                _a('stepIndicators'),
    ...
    ((Fa.Step = Ba), (Fa.positions = Da));
    const La = 'PreviewDelta_86b01c3e',
        Ua = 'PreviewDelta_negative_1c375892',
        za = 'PreviewDelta_positive_be83fc48',
        qa = 'PreviewDelta_negative__visible_19dda1c5',
        Va = 'PreviewDelta_positive__visible_19dda1c5',
        Ga = s.forwardRef(function ({ value: t, classNames: n, ...s }, r) {
            const o = ga();
            _a('previewDelta');
            const a = t - o.value,
            ...
            return e.jsxs('div', {
                ...
                ref: r,
                className: N(La, s.className),
                children: [
                    e.jsx('div', {
                        style: { left: `${u}%`, width: `${d}%`, ...s.style },
                        className: N(n?.negative, Ua, 'negative' === i && qa),
                    }),
                    e.jsx('div', {
                        style: { left: `${u}%`, width: `${d}%`, ...s.style },
                        className: N(n?.positive, za, 'positive' === i && Va),
                    }),
                ],
            });
        });
    function Ha(t) {
        const [n, r] = s.useState(Math.min(t.value, t.maxValue)),
            ...
            l = Re(o),
            c = s.useRef(new Set()),
            u = Te((e) => r(Math.min(e, t.maxValue))),
            d = Te((e) => c.current.has(e));
        (s.useLayoutEffect(() => {
            u(t.value);
        }, [t.value, u]),
            s.useLayoutEffect(() => {
        ...
        const m = Te((e) => t.onValueChange?.(e));
        s.useEffect(() => {
            m(n);
        }, [m, n]);
        const p = Te((e) => t.onMaxValueChange?.(e));
        s.useEffect(() => {
            p(o);
        }, [p, o]);
        const f = s.useMemo(() => {
        ...
        const h = s.useMemo(() => {
                const e = n / o === 1 && t.status !== da.doneInactive;
                return t.animationType === ca.growFreeze ? e && t.maxValueAchieved : e;
            ...
            g = s.useMemo(
                () => ({
                    ...
                    setValue: u,
                    setMaxValue: a,
                    animationType: t.animationType ?? ca.simple,
                    size: t.size,
                    status: t.status,
                    previous: f,
        ...
        return e.jsx(ha.Provider, { value: g, children: t.children });
    }
    const Qa = {
        ...
        Wa = bo('ProgressBar', Qa.base, { variants: { size: { medium: Qa.base__medium, large: Qa.base__large } } }),
        Ya = function ({ size: t = ua.medium, backgroundPattern: n, status: s, className: r, classNames: o, ...a }) {
            return e.jsx(Ha, {
                size: t,
                status: s,
                ...a,
                children: e.jsxs(Wa, {
                    size: t,
                    className: N(r, a.value === a.maxValue && s !== da.doneInactive && Qa.base__done),
                    children: [
                        e.jsx('div', { className: N(Qa.border, Qa[`border__${t}`], o?.border) }),
                        e.jsx('div', { className: N(Qa.background, o?.background) }),
                        e.jsx(ya, { backgroundPattern: n, className: o?.backgroundPattern }),
                        a.children,
                    ],
                }),
            });
    ...
    ((Ya.Fill = ja),
        (Ya.Delta = Sa),
        (Ya.PreviewDelta = Ga),
        (Ya.NumberIndicators = Fa),
        (Ya.sizes = ua),
        (Ya.statuses = da),
        (Ya.animations = ca));
    const Xa = 'ProgressBar_wrapper_a944db13',
        Za = [ma, pa],
        Ka = s.memo(function ({ progressBar: t, fill: n, delta: s, wrapperSpringProps: r }) {
            const o = Fs({ from: { opacity: 1 }, ...r });
            return e.jsx(Ya, {
                ...t,
                children: e.jsxs(ir.div, {
                    ...
                    children: [
                        e.jsx(Ya.Fill, { ...n }),
                        void 0 !== s && e.jsx(Ya.Delta, { ...s, steps: s?.steps ?? Za }),
                    ],
                }),
            });
        }),
        Ja = 'ProgressStats_label_6e975df0',
        ei = 'ProgressStats_receivedInBattle_d3abd2fe',
        ti = bo('ProgressStatsLabel', Ja),
        ni = s.forwardRef(({ className: t, text: n, transitionProps: s, ...r }, o) =>
            e.jsx('div', {
                ...r,
                className: N(Ja, t),
                ref: o,
                children: e.jsx(Vo, { value: n, transition: s, children: J }),
            }),
        ),
        si = s.forwardRef(({ value: t, className: n, total: s, ...r }, o) =>
            e.jsx('div', {
                ...r,
                ref: o,
                className: N(ei, n),
        ...
        ri = s.forwardRef(({ value: t, className: n, total: r, transition: o, target: a, ...i }, l) => {
            const c = vr(),
                u = s.useMemo(
                    () => ({
                        value: t,
            ...
            return (
                ...
                e.jsx('div', {
                    ...
                    children: e.jsx(Vo, {
                        ...
                        children: (t) => e.jsx(ao, { path: t.textPath, params: { value: t.value } }),
                    }),
                })
            );
        }),
        oi = bo('ProgressStats');
    ((oi.Label = ti), (oi.ReceivedValue = si), (oi.AnimatedReceivedValue = ri), (oi.AnimatedLabel = ni));
    const ai = s.createContext(void 0);
    function ii() {
        const e = s.useContext(ai);
        return (pe(void 0 !== e, 'useCondition must be used under conditionContext.Provider'), e);
    }
    const li = s.createContext(void 0);
    function ci() {
    ...
    const ui = {
        ...
        di = ['win', 'isAlive'],
        mi = k.cubicBezier(0.33, 0, 0.25, 1);
    const pi = {
        Condition: function (t) {
            ...
            return (
                ...
                e.jsx(pi.Root, {
                    condition: t.value,
                    children: e.jsxs(pi.Body, {
                        children: [
                            e.jsx(pi.Title, { questsAmount: t.questsAmount }),
                            e.jsx(pi.Description, { guiDisabledDescription: t.guiDisabledDescription }),
                            !n &&
                                e.jsx(pi.Progression, {
        ...
        Root: function ({ condition: t, ...n }) {
            return e.jsx(ai.Provider, {
                value: t,
                children: e.jsx('div', { ...n, className: N(ui.content, t.completed && ui.content__completed) }),
            });
        },
        Description: function ({ guiDisabledDescription: t }) {
            const { description: n, conditionType: s } = ii();
            return s && di.includes(s)
                ? null
                : e.jsx('div', {
                      className: ui.description,
                      children: e.jsx(oa, { text: M(t ?? n), className: ui.multiline }),
                  });
        },
        Title: function ({ questsAmount: t }) {
            const { title: n, icon: s, completed: r, progression: o } = ii(),
                { completed: a } = ci();
            if (!s && !n) return null;
                ...
                children: [
                    void 0 !== i &&
                        e.jsx('div', {
                            ...
                            className: N(ui.titleIcon, i.default.isGold && ui.titleIcon__gold),
                        }),
                    o ? E.formatNumber('integral', o.total) : n?.trim(),
                ],
            });
        },
        Body: bo('MissionCardBody', ui.body),
        Progression: function ({ completed: t, rewardsGlowRef: n, completedMarkRef: r }) {
            const { progression: o } = ii(),
                { animation: a, immediateAnimation: i } = ci(),
                l = Us(),
                c = Us(),
                [[u, d], m] = s.useState(() => {
                    if (!o) return [0, 0];
                ...
                if (void 0 !== o)
                    return {
                        progress: {
                            value: d,
                            silent: i,
                            animationType: ca.grow,
                            status: da.doneStatic,
                            maxValue: o.total,
                        ...
                        delta: i
                            ...
                            : {
                                  from: u,
                                  steps: u === d ? [] : [ma, pa],
                                  growAnimationConfig: { duration: 600, easing: mi },
                                  shrinkAnimationConfig: { duration: 600, easing: mi },
                                  onState(e) {
                                      e === fa &&
                                          d === o.current &&
                                          o.earned > 0 &&
                        ...
                        fill: { animationConfig: { duration: i ? 0 : 600, easing: mi } },
                    };
            }, [i, u, d, o, t, l, c, r]);
            return o
                ? (pe.log(
                  ...
                  e.jsxs('div', {
                      className: ui.progression,
                      children: [
                          void 0 !== p && e.jsx(Ka, { progressBar: p.progress, delta: p.delta, fill: p.fill }),
                          e.jsxs('div', {
                              className: ui.numberStats,
                              children: [
                                  e.jsx(Ko, {
                                      current: i ? o.current : d,
                                      total: o.total,
                                      className: ui.progressionCounter,
                                      transitionCurrent: { ref: l, immediate: i },
                                      transitionTotal: { immediate: i },
                                  }),
                                  e.jsx(oi.AnimatedReceivedValue, {
    ...
    var fi = ((e) => (
        ...
        bi = ((e) => ((e.BATTLE_BOOSTER = 'battleBooster'), e))(bi || {}),
        yi = ((e) => (
            (e.ATTACHMENT_RARE = 'rare'),
            (e.ATTACHMENT_EPIC = 'epic'),
            (e.ATTACHMENT_LEGENDARY = 'legendary'),
    ...
    const Ci = vi(Ri),
        Ti = [
            ...
            fi.BattlePassSelectToken,
            fi.BattlaPassFinalAchievement,
            fi.BattleBadge,
            fi.BonusX5,
            fi.CrewBonusX3,
            fi.EpicSelectToken,
            fi.Comp7TokenWeeklyReward,
            fi.DeluxeGift,
            fi.BattleBoosterGift,
            fi.OptionalDevice,
            fi.TmanToken,
        ],
        Pi = [fi.Gold, fi.Credits, fi.Crystal, fi.FreeXp],
        Si = [fi.BattlePassPoints, fi.EquipCoin],
        Ni = [fi.PremiumPlus, fi.Premium],
        ki = ['engravings', 'backgrounds'],
        Ai = ['engraving', 'background'],
        Ii = (e, t = hi.Small) => {
            const { name: n, type: s, value: r, icon: o, item: a, dogTagType: i } = e,
                l = t === hi.S24x24 ? hi.Small : t,
                c = ((e) => {
                    switch (e) {
                        case hi.S600x450:
                            return 'c_600x450';
        ...
        Bi = ({
            ...
            const g = Oi.has(o) ? Oi.get(o) : o,
                _ = ((e, t) => {
                    if (void 0 === t || !Mi.includes(e)) return null;
                    switch (t) {
                        case _i.BATTLE_BOOSTER:
                        case _i.BATTLE_BOOSTER_REPLACE:
                            return bi.BATTLE_BOOSTER;
                    }
                })(o, a),
                b = ((e) => {
                    ...
                    switch (e) {
                        case _i.BATTLE_BOOSTER:
                            return yi.BATTLE_BOOSTER;
                        case _i.BATTLE_BOOSTER_REPLACE:
                            return yi.BATTLE_BOOSTER_REPLACE;
                        case _i.BUILT_IN_EQUIPMENT:
                            return yi.BUILT_IN_EQUIPMENT;
                        case _i.EQUIPMENT_PLUS:
                            return yi.EQUIPMENT_PLUS;
                        case _i.EQUIPMENT_TROPHY_BASIC:
                            return yi.EQUIPMENT_TROPHY_BASIC;
                        case _i.EQUIPMENT_TROPHY_UPGRADED:
                            return yi.EQUIPMENT_TROPHY_UPGRADED;
                        case _i.EQUIPMENT_MODERNIZED_UPGRADED_1:
                            return yi.EQUIPMENT_MODERNIZED_UPGRADED_1;
                        case _i.EQUIPMENT_MODERNIZED_UPGRADED_2:
                            return yi.EQUIPMENT_MODERNIZED_UPGRADED_2;
                        case _i.EQUIPMENT_MODERNIZED_UPGRADED_3:
                            return yi.EQUIPMENT_MODERNIZED_UPGRADED_3;
                        case _i.PROGRESSION_STYLE_UPGRADED_1:
                            return yi.PROGRESSION_STYLE_UPGRADED_1;
                        case _i.PROGRESSION_STYLE_UPGRADED_2:
                            return yi.PROGRESSION_STYLE_UPGRADED_2;
                        case _i.PROGRESSION_STYLE_UPGRADED_3:
                            return yi.PROGRESSION_STYLE_UPGRADED_3;
                        case _i.PROGRESSION_STYLE_UPGRADED_4:
                            return yi.PROGRESSION_STYLE_UPGRADED_4;
                        case _i.PROGRESSION_STYLE_UPGRADED_5:
                            return yi.PROGRESSION_STYLE_UPGRADED_5;
                        case _i.PROGRESSION_STYLE_UPGRADED_6:
                            return yi.PROGRESSION_STYLE_UPGRADED_6;
                        case _i.ATTACHMENT_RARE:
                            return yi.ATTACHMENT_RARE;
                        case _i.ATTACHMENT_EPIC:
                            return yi.ATTACHMENT_EPIC;
                        case _i.ATTACHMENT_LEGENDARY:
                            return yi.ATTACHMENT_LEGENDARY;
                    }
                })(a),
                y = ((e, t) => {
                ...
                w = hr({ header: h?.header, body: h?.body });
            return e.jsxs('div', {
                className: Ci(ji.base, ji[`base__${o}`], !r && ji.base__dynamicBox, d),
                style: u,
                ...v,
                children: [
                    e.jsxs(e.Fragment, {
                        children: [
                            e.jsxs('div', {
                                className: Ci(ji.image, r ? ji.image__fixedBox : ji[`image__${o}`], m?.image),
                                children: [
                                    _ &&
                                        e.jsx('div', {
                                            className: Ci(ji.highlight, m?.highlight),
                                            style: {
                                                backgroundImage: `url(${Di.readOrEmpty(`quests.bonuses.${g}.${_}_highlight`)})`,
                                            },
                                        }),
                                    n &&
                                        e.jsx('div', {
                                            className: Ci(ji.icon, m?.rewardIcon),
                                            style: { backgroundImage: `url(${n})` },
                                        }),
                                    b &&
                                        e.jsx('div', {
                                            className: Ci(ji.overlay, m?.overlay),
                                            style: {
                                                backgroundImage: `url(${Di.readOrEmpty(`quests.bonuses.${g}.${b}_overlay`)})`,
                                            },
                                        }),
                                ],
                            }),
                            y &&
                                e.jsx('div', {
                                    className: Ci(ji.info, ji[`info__${t}`], l === gi.MULTI && ji.info__multi, m?.info),
                                    children: y,
                                }),
                            c && e.jsx('div', { className: ji.title, children: c }),
                        ],
                    }),
                    s && e.jsx('div', { className: Ci(ji.timer, m?.periodicIcon), ...w }),
                ],
            });
        },
        $i = Object.fromEntries(Object.entries(Hr).map(([e]) => [e, (e) => e]));
    const Fi = 'RewardsList_b956755b',
        Li = 'RewardsList_base__vertical_59db3c9f',
        Ui = 'RewardsList_reward_fc200613',
        zi = 'RewardsList_reward__vertical_5f09c6e0',
        qi = 'RewardsList_boxRewardClassName_882c908d',
        Vi = { [hi.S24x24]: hi.Small, [hi.S48x48]: hi.Small },
        Gi = s.memo(function ({
            data: t,
            isFixedBoxSize: n,
            size: s = hi.Big,
            ...
            const m = p.resolve('strings'),
                ...
                h =
                    'number' == typeof o && o < t.length
                        ? `${f.readOrEmpty(`quests.bonuses.${Vi[s] ?? s}.default`)}`
                        : void 0,
                g =
                    c ||
                    (function (e, t = {}) {
                        const n = $r(e, ro);
                        return String(Jr(n, $i, t));
                    })(so(m.readOrEmpty('tooltips.quests.awards.additional.bottom')), { count: t.length - (o || 0) });
            return e.jsx('div', {
                className: Ci(Fi, r && Li, a),
                children:
                    void 0 !== h
                        ? e.jsxs(e.Fragment, {
                              children: [
                                  t
                                      ...
                                      .map((t, o) =>
                                          e.jsx(
                                              'div',
                                              {
                                                  className: Ci(Ui, r && zi, i),
                                                  children: e.jsx(Bi, { size: s, isFixedBoxSize: n, ...t }),
                                              },
                                              o,
                                          ),
                                      ),
    ...
    function Hi({ bonuses: t, size: n, resId: r, boxRewardTooltipArgs: o, maxRewardsCount: a, questId: i, ...l }) {
        const c = s.useMemo(
                () =>
                    ue(t, (e) => {
                        return {
        ...
        return e.jsx(Gi, { ...l, data: c, count: u, boxRewardTooltip: d, size: n });
    }
    const Qi = 'AnimatedRewards_glowContainer_82630782',
        Wi = 'AnimatedRewards_c981a355',
        Yi = 'AnimatedRewards_rewardsWrapper_11b576b3',
        Xi = 'AnimatedRewards_glow_3a2cd010',
        Zi = 'AnimatedRewards_glowImage_4ecce597',
        Ki = k.cubicBezier(0.33, 0, 0.67, 1),
        Ji = k.cubicBezier(0.23, 0, 0.57, 1),
        el = s.forwardRef(function (
            ...
            const d = Us(),
                [m] = Fs(() => ({
                    ...
                    to: async (e) => {
                        (await e({ opacity: 1, scale: 0.8, config: { duration: 330, easing: Ki } }),
                            d.start(),
                            await e({ opacity: 0, scale: 1, config: { duration: 330, easing: Ki } }));
                    },
                })),
                [p] = Fs(() => ({
                    ref: d,
                    immediate: n,
                    from: { opacity: 1 },
                    to: { opacity: 0.4, config: { duration: 330, easing: Ji } },
                }));
            return (
                s.useEffect(() => {
                ...
                e.jsxs('div', {
                    ...
                    children: [
                        e.jsx(ir.div, {
                            style: p,
                            className: N(Yi, l?.rewardsWrapper),
                            children: e.jsx(Hi, { ...c, maxRewardsCount: r, bonuses: o, boxRewardTooltipArgs: a }),
                        }),
                        e.jsx('div', {
                            className: N(Qi, l?.glowContainer),
        ...
        tl = p.resolve('views');
    function nl({ limit: e, rewardsTooltipResId: t, boxRewardTooltipContentId: n, ...s }) {
        return {
            contentId: n ?? tl.read((e) => e.lobby.tooltips.AdditionalRewardsTooltip('resId')),
    ...
    function sl({
        ...
        return t
            ...
            : e.jsx(Hi, { ...f, classMix: m });
    }
    const rl = 'CompletedMark_fc4eee08',
        ol = 'CompletedMark_glow_33775180',
        al = k.cubicBezier(1, 0, 0.95, 1),
        il = k.cubicBezier(0.45, 0, 0.52, 1),
            ...
            const g = s.useRef(u),
                ...
                [w] = Fs(() => ({
                    ...
                    onRest: () => {
                        v.start({
                            to: [
                                { opacity: 0.6, config: { duration: 160, easing: il } },
                                { opacity: 0, config: { duration: 160, easing: il } },
                            ],
                            onRest: p,
                        });
                    },
    ...
    function ul({ value: t, questType: n, className: s }) {
        return t
            ? e.jsx('div', {
                  className: N(ui.iconImage, ui.iconImage__regular, n === cl.PREMIUM && ui.iconImage__gold, s),
    ...
    const dl = (e) =>
        ...
        ml = p.resolve('strings');
    function pl(t) {
        return 'none' === t.type
            ? e.jsx('div', { className: N(ui.separator, ui.separator__none, t.className) })
            : 'union' === t.type
              ? e.jsx('div', { className: N(ui.separator, ui.separator__union, t.className) })
              : 'or' === t.type
                ? e.jsxs('div', {
                      className: N(ui.separator, ui.separator__or, t.className),
                      children: [
                          e.jsx(dl, { width: 16, height: 16, className: ui.invertedArrow }),
                          ml.readOrEmpty('battle_results.conditions.type.or'),
                          e.jsx(dl, { width: 16, height: 16, className: ui.arrow }),
                      ],
                  })
                : e.jsx('div', {
                      className: N(ui.separator, ui.separator__and, t.className),
                      children: ml.readOrEmpty('battle_results.conditions.type.and'),
                  });
    }
    function fl(t) {
        ...
        return e.jsx(e.Fragment, {
            children: de(
                n,
                (e) => null != e,
                (n, r) => e.jsxs(s.Fragment, { children: [r > 0 && e.jsx(pl, { ...t }), n] }, r),
            ),
        });
    }
    const hl = { 1: 5, 2: 5, 3: 3 };
    function gl(e) {
        return 'item' === e.type ? 1 : e.groups.reduce((e, t) => e + gl(t), 0);
    }
    function _l(e) {
    ...
    const yl = 'R.images.gui.maps.icons.post_battle.general_quest',
        vl = { default: { path: `${yl}_32` }, medium: { path: yl } },
        wl = s.memo(function (t) {
            const n = Us(),
                r = Us(),
                { animation: o, immediateAnimation: i } = ci(),
                { icon: l, questsAmount: c } = s.useMemo(() => {
                    const e = gl(t.value);
                    return { icon: e > 1 ? (t.generalIcon ?? vl) : (_l(t.value) ?? vl), questsAmount: e };
                }, [t.generalIcon, t.value]),
                u = a.useAdaptive(l.default, l),
                d = hl[c] ?? 0,
                m = c > 3 ? 'groups__manyQuests' : 3 === c ? 'groups__threeQuests' : 'groups__twoQuests';
            return e.jsxs('div', {
                className: N(ui.groups, c > 4 && ui.groups__overflow, c > 1 && ui[m]),
                children: [
                    e.jsx('div', {
                        className: ui.iconContainer,
                        children: t.completed
                            ? e.jsx(ll, {
                                  animationRef: n,
                                  className: ui.completedMark,
                                  classNames: { icon: ui.completedMarkIcon },
                                  springProps: { immediate: i, delay: 170 },
                              })
                            : e.jsx(ul, { value: u.path, questType: t.questType, className: t.iconClassName }),
                    }),
                    e.jsx('div', {
                        className: ui.questsWithRewards,
                        children: e.jsxs(fl, {
                            type: t.separate ?? 'none',
                            children: [
                                e.jsx('div', {
                                    className: ui.questsContainer,
                                    children: e.jsx(bl, {
                                        value: t.value,
                                        completed: t.completed,
                                        questsAmount: c,
                                        ...
                                        children: [
                                            ...
                                            e.jsx('div', {
                                                ...
                                                children: e.jsx(sl, {
                                                    ...
                                                    questId: t.questId,
                                                    className: ui.rewards,
                                                    rewardItemClassName: ui.reward,
                                                }),
                                            }),
                                        ],
                                    }),
    ...
    function xl({ completed: t, progress: n, animation: r, immediateAnimation: o, target: a, ...i }) {
        const l = vr(),
        ...
        return e.jsx(li.Provider, {
            ...
            children: e.jsx(ea, {
                ...
                className: N(ui.base, t && ui.base__completed, i.className),
                classNames: { content: ui.cardContent, ...i.classNames },
            }),
        });
    }
    ((xl.Content = pi), (xl.Groups = wl), (xl.Separators = fl));
    class El {
        index = 0;
        next() {
            return this.index++;
    ...
    function Rl({ model: e, indexer: t, resolveIcon: n, commonIcon: s, guiDisabled: r }) {
        if ('items' in e)
            return {
                type: 'items',
                separate:
                ...
                groups: ue(e.items, (e) => Rl({ model: e, indexer: t, resolveIcon: n, commonIcon: s, guiDisabled: r })),
            };
        var o;
        const a = {
            type: 'item',
        ...
        return (e.total > 0 && (a.condition.progression = { current: e.current, total: e.total, earned: e.earned }), a);
    }
    const Cl = p.resolve('images'),
        Tl = p.resolve('aliases'),
        Pl = p.resolve('strings'),
        Sl = Tl.read((e) => e.battle_results.progression.Challenges('resId')),
        Nl = { rootId: Sl },
        kl = {
            default: { path: Cl.readOrEmpty('userMissions.challenges.icons.shields.loseShield_32') },
            large: { path: Cl.readOrEmpty('userMissions.challenges.icons.shields.loseShield_80') },
        };
    const [Al, Il] = (
            (t = 'DataLayerProvider') =>
            (n, r, o) => {
        ...
        )('ChallengesMissionsProgressModelProvider')(
            ({ externalModel: e }) => ({
                quest: Mr(() => {
                    ...
                    const n = !0 === t.isCompleted,
                        ...
                        r = (() => {
                            if (t.postBattleCondition) {
                                const e = le(t.postBattleCondition.items, 0);
                                return e?.items || [];
                            }
                        })();
                    return {
                        questId: t.id,
                        challengeName: `${Pl.readOrEmpty('challenges.postbattle.name')}${t.challengeName}`,
                        completed: n,
                        navigationEnabled: t.navigationEnabled,
                        bonuses: t.bonuses,
                        rewardsTooltipResId: Sl,
                        generalIcon: kl,
                        progress:
                            t.totalProgress > 0
                                ? {
        ...
        Ml = 'ChallengesQuests_content_4f523b72',
        jl = 'ChallengesQuests_customIcon_9154ce6c',
        Dl = p.resolve('strings'),
        Ol = i.observer(function ({ animation: t, immediateAnimation: n }) {
            const { model: r, controls: o } = Il(),
                a = r.quest(),
                i = s.useCallback(() => {
                    a?.navigationEnabled && o.navigate();
                }, [o, a?.navigationEnabled]);
            return a
                ? e.jsx(xl, {
                      animation: t,
                      immediateAnimation: n,
                      target: 'mission-progress:challenges-quests:mission-card',
                      disabled: !a.navigationEnabled,
                      title: a.challengeName,
                      completed: a.completed,
                      progress: a.progress,
                      onButtonAction: i,
                      onClick: i,
                      actionTooltipParams: { body: Dl.readOrEmpty('battle_results.progression.linkBtn.info') },
                      children: e.jsx('div', {
                          className: Ml,
                          children: e.jsx(xl.Groups, { ...a, iconClassName: jl }),
                      }),
                  })
                : null;
        });
    var Bl = ((e) => ((e.Done = 'done'), (e.Locked = 'notAvailable'), (e.Active = ''), e))(Bl || {});
    const $l = {
            icon: '',
            index: 0,
            name: '',
        ...
        Fl = {
            challengeQuest: {
                ...
                isCompleted: !0,
                bonuses: [
                    { ...$l, index: 0, name: 'credits', label: 'Кредиты', value: '500000' },
                    { ...$l, index: 1, name: 'freeXP', label: 'Свободный опыт', value: '2500' },
                    { ...$l, index: 2, name: 'gold', label: 'Золото', value: '100' },
                    { ...$l, index: 3, name: 'equipCoin', label: 'Боны', value: '1000' },
                    { ...$l, index: 4, name: 'xp', label: 'Опыт', value: '5000' },
                    { ...$l, index: 5, name: 'crystal', label: 'Бонды', value: '50' },
                    { ...$l, index: 6, name: 'premium', label: 'Премиум аккаунт', value: '3' },
                ],
                postBattleCondition: {
                    conditionType: 'or',
                    items: [
        ...
        Ll = { getter: kr(Fl) };
    kr({ ...Fl, challengeQuest: { ...Fl.challengeQuest, status: Bl.Done, isCompleted: !0, currentProgress: 5 } });
    const Ul = new (class {
        items = [];
        add(e) {
        ...
        .addWithProps(Al, { options: Nl, mode: 'real', mocks: Ll })
        .addWithProps(
            function (t) {
                return e.jsx(io, {
                    children: e.jsx(yr, {
            ...
            },
            {
                soundsOverrides:
                    ...
                    Object.entries(zl).reduce(
                        (e, [t, n]) => (
                            (e[t] = (e) => {
                                e && e.target in n ? F.sound(n[e.target]) : gr[t]?.(e);
                            }),
                            e
                        ),
                        {},
                    ...
                    try {
                        const s = Ee(
                            `${(function (e, t = '/') {
                                ...
                                return e;
                            })(t)}/challenges_quests.css`,
                        );
                        (n.add(s.cleanup), await s.promise.catch(console.error));
                        const r = X(Nl, { name: 'ChallengesMissionsProgressDataLayer' }),
                            o = (u(d, ((c = r.dispose), { [Symbol.dispose]: c })), r.readByPath('challengeQuest')),
                            a = !0 === o?.isCompleted;
                        return {
                            animated: !0,
                            component: Vl,
