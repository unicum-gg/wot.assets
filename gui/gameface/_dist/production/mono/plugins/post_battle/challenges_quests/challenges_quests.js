...
!(function (e, t) {
    ...
    const xa = 'Delta_eb295acb',
                    ...
                    children: [
                        ...
                        !c &&
                            e.jsx(ka, {
                                ...
                                className: N(n?.doneComplete, Na.complete, r.progressCompleted && Na.complete__visible),
                                repeat: 'repeat',
                                position: 'left top',
                                style: { width: d.width.to((e) => `${e}%`) },
                            }),
        ...
        ja = s.memo(function ({ filledPattern: t, classNames: n, className: r, animationConfig: o, ...a }) {
            const i = ga(),
                l = wa(),
                c = cr(),
                { activeComponents: u } = ga(),
                d = 100 * i.percentage,
            ...
            return (
                ...
                e.jsxs('div', {
                    className: N(Na.base, r),
                    children: [
                        e.jsx(ir.div, { className: n?.fill, style: { width: f.width.to((e) => `${e}%`) } }),
                        a.children ??
                            e.jsxs(e.Fragment, {
                                children: [
                                    e.jsx(Ma, { filledPattern: t, className: n?.filledPattern, animationConfig: o }),
                                    e.jsx(Aa, { classNames: n, animationConfig: o }),
                                ],
                            }),
                        e.jsx(ir.div, {
                            className: N(
                                n?.edge,
                                Na.edge,
                                0 === i.percentage && Na.edge__noProgress,
                                !u.has('previewDelta') && !i.progressCompleted && Na.edge__visible,
                                i.status && Na[`edge__${i.status}`],
                            ),
    ...
    const Ci = vi(Ri),
        ...
        Bi = ({
            ...
            const g = Oi.has(o) ? Oi.get(o) : o,
                ...
                v = fr({ contentId: f?.contentId ?? 0, args: f?.args, resId: f?.resId, decoratorId: f?.decoratorId }),
