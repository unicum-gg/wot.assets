...
const [F, H] = m()(
        ({ observableModel: e }) => {
            const s = e.object().get().eventName,
                t = { root: e.object(), style: o.box(S(s, P.EntryPoint)), resources: o.box(G(L, s)) },
                a = n(() => {
...
const K = a(function () {
    const t = d.resolve('sounds'),
        ...
        A = g === M.Empty ? v.iconEmpty : v.iconGold;
    return e.jsx('div', {
        className: s(J.base, !p && J.base__disabled),
        children: e.jsx('div', {
            className: J.content,
            ...a,
            children: e.jsxs('div', {
                ...
                children: [
                    g === M.Boxes
                        ? e.jsxs(e.Fragment, {
                              children: [
                                  p && e.jsx(h, { loop: !0, autoplay: !0, className: J.glow, src: I.glow, style: $ }),
                                  e.jsx(U, {
                                      className: J.count,
                    ...
                    e.jsx(q, { disabled: !p, image: A, brightness: R, className: J.icon }),
                    !p &&
                        e.jsx(f, {
