import { j as e, f as t, d as s, o, g as n, D as a, r } from './vendor.js';
import {
    dF as i,
    dG as c,
    dH as l,
...
const [M, z] = m()(
        ({ observableModel: e }) => {
            const t = e.object().get().eventName,
                s = { root: e.object(), style: o.box(S(t, O.EntryPoint)), resources: o.box(F(H, t)) },
                a = n(() => {
...
function J({ count: s, text: o, maxText: n, className: a }) {
    return e.jsx('div', {
        className: t(X, a),
        children: s < 1e3 ? e.jsx(b, { text: o, params: { count: s }, upgradeLegacy: !0 }) : n,
    });
}
const Z = 'Icon_1d8e6c37';
function q({ image: s, brightness: o, disabled: n, className: a, ...r }) {
    return e.jsx('div', {
        ...r,
        className: t(Z, a),
...
const Q = a(function () {
    const s = d.resolve('sounds'),
        ...
        j = { opacity: E.shine.opacity, filter: `brightness(${R})` },
        $ = E.hover.enabled && i && p,
            ...
            children: e.jsxs('div', {
                ...
                children: [
                    g === L.Boxes
                        ? e.jsxs(e.Fragment, {
                              children: [
                                  p && e.jsx(h, { loop: !0, autoplay: !0, className: K.glow, src: I.glow, style: j }),
                                  e.jsx(J, {
                                      className: K.count,
                                  ...
                                  p && b && e.jsx(U, { mask: f.blinkMask, className: K.blink }),
                                  $ &&
                                      e.jsx('div', {
                    ...
                    e.jsx(q, { disabled: !p, image: A, brightness: R, className: K.icon }),
                    !p &&
