import { r as e, E as t, j as a, f as s, m as r, D as n, l as o, s as i } from '../../../chunks/vendor.js';
import {
    i as l,
    c,
    n as d,
...
const [pe] = l('HeaderStateModel')((e) => ({ features: e.observableModel.dict('features') })),
    ...
    [Me, We] = l('BattleStartProvider')(({ observableModel: e }) => ({ ...e.primitives(['tooltip']) }), d);
const Oe = 'active',
    we = 'ready',
    Re = 'notReady',
    De = 'disabled';
                ...
                a.jsx(r.div, {
                    ...
                    children: a.jsx(
                        b,
                        {
                            ...
                            className: s(He.backgroundEffect, He[`backgroundEffect__${t}`]),
                        },
                        t,
                    ),
                }),
        ...
        return a.jsx('div', {
            ...
            children: a.jsx(
                b,
                {
                    ...
                    loop: !0,
                    onPlay: t,
                    src: r.readOrEmpty(`header_footer.battle_button.foreground_${n.value}`),
                    className: ze,
                },
...
function Ge({ buttonState: e, buttonText: t, animationActive: s, onAnimationEnded: n }) {
    const i = o({
        opacity: s ? 0.9 : 0,
    ...
    return e === Oe
        ? a.jsx(r.div, { className: Fe.textGlow, style: i, children: t })
        : e === we
          ? a.jsx('div', { className: Fe.textGlow, children: t })
          : null;
}
const Qe = n(function ({ actionType: e, buttonState: t, animationActive: r, onAnimationEnded: n, className: o }) {
        const i = Ae(),
            l = m.resolve('strings'),
            c = v.toUpperCase(
                l.readOrEmpty(
        ...
        return a.jsxs('div', {
            className: s(Fe.base, Fe[`base__${t}`], o),
            children: [
                a.jsx(f, {
                    classNames: { base: Fe.textWrapper, text: Fe.text, textOverlay: Fe.textOverlay },
                    children: c,
                }),
                a.jsx(Ge, { buttonState: t, buttonText: c, animationActive: r, onAnimationEnded: n }),
            ],
        });
    }),
    qe = {
    ...
    Je = n(function ({
        ...
        const l = We(),
            ...
            u = (function (e) {
                ...
                return _({ header: t, body: a, alert: r, note: s, hasHtmlContent: !0, disabled: 0 === e.length });
            })(d),
            m = e === De;
        const b = r && Ye.includes(r) && Ye.includes(e);
        return a.jsx('div', {
            ...(m && d && u),
            className: i,
            children: a.jsxs(h, {
                ...
                className: s(qe.button, qe[`button__${e}`]),
                classNames: {
                    background: s(qe.background, qe[`background__${e}`], t && !b && qe.background__appear),
                    content: qe.content,
                    border: qe.border,
                    overlay: qe.overlay,
                },
                ...
                children: [
                    t &&
                        !b &&
                        a.jsx('div', { className: s(qe.background, qe.background__dissapear, qe[`background__${r}`]) }),
                    o,
                ],
            }),
        });
    ...
    tt = n(function ({ classNames: t }) {
        const r = Ae(),
            ...
            p = x(),
            v = r.model.queueType.get() === Ie,
            f = 'TRAINING' === r.model.currentMode.get(),
            g =
                (!r.model.states.get('playerCreator') && !f && r.model.states.get('readinessAvailable')) || v
                    ? 'readyAction'
                    : Be,
            h = (function (e, t, a) {
                return t ? De : e === Be ? Oe : a ? Re : we;
            })(g, !r.model.states.get('actionEnabled'), r.model.states.get(Ne)),
            y = N(h),
            j = h === De;
        return (
            e.useEffect(
            ...
            a.jsxs(et, {
                ...
                id: 'fight-button',
                children: [
                    a.jsx(Le, { buttonState: h, className: s(Ke.backgroundEffects, t?.effect) }),
                    a.jsxs(Je, {
                        actionType: g,
                        buttonState: h,
                        transitionActive: l,
                        ...
                        className: t?.content,
                        children: [
                            !j && a.jsx('div', { className: s(Ke.reflector, Ke[`reflector__${h}`]) }),
                            h === Oe && a.jsx(Ue, { className: Ke.buttonEffects, onAnimationStarted: () => o(!0) }),
                            a.jsx('div', { className: Ke.hoverOverlay }),
                            a.jsx('div', { className: s(Ke.desaturation, !j && Ke.desaturation__hidden) }),
                            a.jsx(Qe, {
                                actionType: g,
                                buttonState: h,
                                animationActive: n,
...
function st() {
    const e = j().paramsStruct.routeType;
    return 'string' == typeof e ? e : be.Default;
}
var rt = ((e) => ((e.Personal = 'personal'), (e.Clan = 'clan'), (e.Event = 'event'), e))(rt || {}),
...
const ot = 'alert',
    ...
    lt = 'x32x32',
    ct = 'x96x96',
    dt = { [rt.Personal]: 0, [rt.Clan]: 1, [rt.Event]: 2 };
function ut(e) {
    return dt[e] ?? 0;
}
function _t(e) {
    return Math.max(0, Math.floor(e - Date.now() / E));
}
const [mt, bt] = l()(
        ({ observableModel: e }) => {
            const t = {
                ...
                s = c.shallow(() => {
                    ...
                    return P(e, (e, t) => ut(e.reserveType) - ut(t.reserveType));
                }),
    ...
    pt = 'Activate_d05a6105',
    vt = 'Activate_base__disabled_77f76d6c',
    ft = 'Activate_wrapper_ea72f87a',
    gt = 'Activate_iconWrapper_b884eeb8',
    ht = 'Activate_icon_bfced9a9',
    yt = 'Activate_icon__glow_6978c825',
    xt = 'Activate_amount_262c55ed',
    Nt = 'Activate_text_6ca62bb4',
    Bt = 'Activate_text__limited_cd94941e',
    jt = 'Activate_textOverlay_a5c8a675',
    Et = 'Activate_textOverlay__limited_6c5cb381',
    It = 'Activate_hint_68b56ff6',
    Ct = 'Activate_hint__glow_24eef452',
    At = 'Activate_glow_d01917a6',
    kt = 'Activate_glow__limited_5e88d41',
    Pt = 'Activate_glow__alert_8001ed30',
    Tt = 'Activate_sparks_718002e7',
    St = 'Activate_sparks__visible_842edf80',
    Mt = n(function () {
        const { model: e } = bt(),
            t = m.resolve('strings'),
            r = m.resolve('intl'),
            ...
            : a.jsxs('div', {
                  ...
                  children: [
                      a.jsxs('div', {
                          className: ft,
                          children: [
                              a.jsx('div', { className: s(Tt, l && St) }),
                              a.jsx('div', { className: s(At, i && kt, l && Pt) }),
                              a.jsx('div', { className: gt, children: a.jsx('div', { className: s(ht, i && yt) }) }),
                              a.jsx(f, {
                                  classNames: { base: xt, text: s(Nt, i && Bt), textOverlay: s(jt, i && Et) },
                                  children: r.formatNumber('integral', o),
                              }),
                          ],
                      }),
                      !c &&
    ...
    Ot = n(function ({ type: t, timeLeft: r, timeTotal: n, icon: o, className: i }) {
        const { model: l } = bt(),
            { minutesLeft: c, percentLeft: d } = (function (t, a) {
                const [s, r] = e.useState(_t(t));
                (e.useEffect(() => {
                    r(_t(t));
                }, [t]),
                    e.useEffect(() => {
                ...
                const n = k(s),
                    o = Math.ceil(C(n));
                return { minutesLeft: o, percentLeft: Math.max(0, Math.min(100, (o / (a / I)) * 100)) };
            })(r, n),
            u = l.computes.disabled(),
            _ = c <= 9,
            m = c <= 2,
            b = p({ size: it }, { large: { size: lt } }),
            v = T(b.size, ct),
            f = o.includes('premium');
        return r <= 0
            ? null
            : a.jsxs('div', {
                  className: s(Wt.base, u && Wt.base__disabled, i),
                  style: { '--fill_percentage': `${d}%` },
                  children: [
                      a.jsx('div', { className: s(Wt.background, Wt[`background__${_ ? ot : t}`]) }),
                      a.jsx(S, { className: Wt.icon, path: `personal_reserves.common.cards.${v}.${o}` }),
                      a.jsx(S, {
    ...
    wt = 'List_background_dc475fe4',
    Rt = 'List_border_59b5e8fe',
    Dt = 'List_borderShadow_776a55b9',
    Ht = 'List_e706f6ab',
    Vt = 'List_base__disabled_8303c2c1',
    Lt = 'List_cards_efba95c2',
    zt = 'List_card_d0063856',
    $t = n(function () {
        const { model: e } = bt(),
        ...
        return r
            ? a.jsxs('div', {
                  className: s(Ht, n && Vt),
                  children: [
                      a.jsx('div', { className: wt }),
                      a.jsx('div', { className: Rt }),
                      a.jsx('div', { className: Dt }),
                      a.jsx('div', {
                          className: Lt,
                          children: W(
                              t,
    ...
    Ut = 'Reserves_43f2a7a7',
    Ft = 'Reserves_base__disabled_58e2c36d',
    Gt = n(function () {
        ...
        return a.jsxs('div', {
            ...
            className: s(Ut, o && Ft),
            onClick: function (e) {
                (r.onClick(), o || (n.play('click', { target: 'reserves', original: e }), t.openBooster()));
            },
            onMouseEnter: function (e) {
                (r.onMouseEnter(e), o || n.play('mouse-enter', { target: 'reserves', original: e }));
            },
            'data-test-id': 'reservesButton',
            children: [a.jsx($t, {}), a.jsx(Mt, {})],
        });
    }),
    Qt = e.memo(({ options: e, ...t }) => a.jsx(mt, { options: e, children: a.jsx(Gt, { ...t }) })),
    [qt, Yt] = l('WalletModel')(
        ({ observableModel: e }) => {
    ...
    Jt = 'Hint_e53dd99e',
    Kt = 'Hint_discountBackground_d56ce0a3',
    Xt = 'Hint_discount_94b7b9ff',
    Zt = 'Hint_onlyDiscount_8b648a0a',
    ea = 'Hint_discountWithHintText_381cf018',
    ta = 'Hint_onlyHintText_751386e1',
    aa = 'Hint_discountValue_b1f389fc',
    sa = 'Hint_discountHintTitle_939c55ad',
    ra = 'Hint_hintText_6f3fa83f',
    na = 'Hint_hintTitle_135a3ed',
    oa = 'Hint_discountValue__withHint_e7bbe38f';
function ia({ classNames: e }) {
    const t = m.resolve('strings');
    return a.jsxs('div', {
        className: s(Zt, e?.onlyDiscount),
        children: [
            a.jsx('div', { className: s(Kt, e?.discountBackground) }),
            a.jsx(w.Root, {
                children: a.jsx(w.Value, {
                    value: t.readOrEmpty('common.common.percent'),
                    classNames: { valueContainer: s(Xt, e?.discount), value: s(aa, e?.discountValue) },
                }),
            }),
        ],
    });
}
function la({ type: e, classNames: t }) {
    const r = m.resolve('intl'),
        n = m.resolve('strings');
    return a.jsx('div', {
        className: s(ra, ta, t?.hintText, t?.onlyHintText),
        children: a.jsx(f, {
            classNames: t?.textGradient,
            children: a.jsx('div', {
                className: s(na, t?.hintTitle),
                children: r.toUpperCase(n.readOrEmpty(`menu.headerButtons.btnLabel.${e}`)),
            }),
        }),
    });
}
function ca({ classNames: e, type: t }) {
    const r = m.resolve('intl'),
        n = m.resolve('strings');
    return a.jsxs('div', {
        className: s(ea, e?.discountWithHintText),
        children: [
            a.jsx('div', { className: s(Kt, e?.discountBackground) }),
            a.jsx('div', {
                className: s(sa, e?.discountHintTitle),
                children: r.toUpperCase(n.readOrEmpty(`menu.headerButtons.btnLabel.${t}`)),
            }),
            a.jsx(w.Root, {
                children: a.jsx(w.Value, {
                    value: n.readOrEmpty('common.common.percent'),
                    classNames: { valueContainer: s(Xt, e?.discount), value: s(aa, oa, e?.discountValue) },
                }),
            }),
        ],
    });
}
function da({ classNames: e, type: t }) {
    return a.jsxs('div', {
        className: s(Jt, e?.base),
        children: [
            a.jsx(ia, {
                classNames: {
            ...
            a.jsx(la, {
                type: t,
                classNames: { hintText: e?.hintText, textGradient: e?.textGradient, onlyHintText: e?.onlyHintText },
            }),
            a.jsx(ca, { classNames: e, type: t }),
        ],
    });
}
const ua = {
    ...
    _a = 1e6,
    ma = 1e5;
function ba({ wgMoneyAvailable: t, value: r, type: n, classNames: o }) {
    const i = e.useRef(null),
        ...
        d = p(
            {
                displayValue: () =>
                    r >= _a ? { abbreviated: !0, value: D(r, ma) / _a } : { abbreviated: !1, value: r },
            },
            {
                medium: {
                    displayValue: () =>
                        r >= 1e7 ? { abbreviated: !0, value: D(r, ma) / _a } : { abbreviated: !1, value: r },
                },
                large: {
                    displayValue: () =>
                        r >= 1e8 ? { abbreviated: !0, value: D(r, ma) / _a } : { value: r, abbreviated: !1 },
                },
            },
        );
    if (!1 === t)
        return a.jsxs('div', {
            className: s(ua.value, ua.value__unavailable, o?.value),
            children: [
                a.jsx('div', { className: ua.dash, children: c.readOrEmpty('common.common.semi_dash') }),
                a.jsx('div', { className: ua.dash, children: c.readOrEmpty('common.common.semi_dash') }),
            ],
        });
    ...
    return a.jsx('div', {
        ref: i,
        className: s(ua.value, o?.base),
        children: u.abbreviated
            ? a.jsx(M, {
                  path: 'menu.hangar_header.million',
                  params: { value: u.value },
                  brackets: { start: '%(', end: ')s' },
                  className: s(ua.formattedValue, o?.formattedValue),
              })
            : l.formatNumber(n === H.gold ? 'gold' : 'integral', u.value),
    });
}
const pa = n(function ({ currency: t, type: r, className: n, classNames: o }) {
        const { controls: i } = Yt(),
            l = O(),
            ...
            d = (function (t, a, s, r) {
                ...
                return !1 === a ? o : l;
            })(r, c, t.tooltipType, t.value),
            u = p({ size: V.extraSmall }, { large: { size: V.small }, extraLarge: { size: V.medium } }),
            b = T(u.size, V.small);
        return a.jsxs('div', {
            ...d,
            className: s(
                ua.base,
                c ? ua.base__interactive : ua.base__nonInteractive,
                t.discount > 0 && ua.base__discount,
                n,
            ),
            onMouseEnter: function (e) {
            ...
            onClick: function (e) {
                (d?.onClick(), c && (l.play('click', { target: 'WalletCurrency', original: e }), i.currencyAction(r)));
            },
            children: [
                a.jsx('div', {
                    className: s(ua.currencyWrapper, o?.currencyWrapper),
                    children: a.jsx(L, {
                        reverse: !0,
                        classNames: { ...o?.currency, icon: s(ua.currencyIcon, o?.currency?.icon) },
                        type: r,
                        size: b,
                        'data-test-id': r,
                        children: a.jsx(ba, {
                ...
                c &&
                    a.jsx('div', {
                        className: s(ua.hintWrapper, o?.hintWrapper),
                        children: a.jsx(da, {
                            type: r,
                            classNames: {
                                ...o?.hint,
                                discountWithHintText: s(ua.discountWithHintText, o?.hint?.discountWithHintText),
                                onlyDiscount: s(ua.onlyDiscount, o?.hint?.onlyDiscount),
                                onlyHintText: s(ua.onlyHintText, o?.hint?.onlyHintText),
                                base: s(ua.hint, o?.hint?.base),
                                textGradient: { text: ua.text, textOverlay: s(ua.text, ua.text__overlay) },
                            },
                        }),
                    }),
            ],
    ...
    va = n(function (e) {
        const t = Yt().model.currencies.get(e.type);
        return t
            ? a.jsx(pa, { ...e, currency: t })
            : (console.error(`Currency with type ${e.type} is not defined`), null);
    }),
    fa = 'Wallet_fc600169',
    ga = [H.crystal, H.gold, H.credits],
    ha = n(function ({ className: e, classNames: t, currenciesOrder: r = ga }) {
        const { model: n } = Yt(),
            o = n.list(r);
        return a.jsx('div', {
            'data-name': 'Wallet',
            className: s(fa, e),
            children: o.map((e) => a.jsx(va, { type: e, classNames: t }, e)),
        });
    }),
    ya = e.memo(({ className: e, classNames: t, currenciesOrder: s, ...r }) =>
        a.jsx(qt, { ...r, children: a.jsx(ha, { className: e, classNames: t, currenciesOrder: s }) }),
    ),
    xa = 'RightSide_3c6c89c0',
    Na = 'RightSide_separator_fea82003',
    Ba = m.resolve('aliases'),
    ja = Ba.read((e) => e.lobby_header.default.ReservesEntryPoint('resId')),
    Ea = Ba.read((e) => e.lobby_header.default.Wallet('resId')),
    Ia = function () {
        const e = $(ja),
            t = $(Ea);
        return a.jsx('div', {
            ...
            children: a.jsxs(le, {
                className: Na,
                children: [e && a.jsx(Qt, { options: { rootId: ja } }), t && a.jsx(ya, { options: { rootId: Ea } })],
            }),
        });
    },
    Ca = {
    ...
    Aa = { small: 'small', medium: 'medium' },
    ka = { [Aa.small]: 16, [Aa.medium]: 24 },
    Pa = e.forwardRef(function (
        { size: e, infoType: t, label: r, tooltipHeader: n, tooltipBody: o, classNames: i = {}, ...l },
        c,
    ) {
        const d = n || o,
            u = _({ header: n, body: o }),
        ...
        return a.jsxs(h, {
            ...
            autoAlignContent: !1,
            className: s(Ca.base, Ca[`base__${e}Size`], l.className),
            classNames: { ...i, content: s(Ca.content, i?.content) },
            children: [
                a.jsx('div', { className: Ca.border }),
                a.jsx(S, {
                    className: Ca.icon,
                ...
                r && a.jsx('div', { className: Ca.label, children: r }),
            ],
        });
    });
Pa.sizes = Aa;
const Ta = 'NavigationBar_425ae997',
    Sa = 'NavigationBar_button_c5ece62',
    Ma = 'NavigationBar_button__backNavigation_7dc54008',
    Wa = 'NavigationBar_label_4840a20f',
    Oa = 'NavigationBar_icon_95c9bdbb',
    wa = 'NavigationBar_iconImage_e695cd8e',
    Ra = 'NavigationBar_iconImage__default_dfd5b7a7',
    Da = 'NavigationBar_iconImage__hover_c132ba6f',
    Ha = 'NavigationBar_iconImage__active_fbf5db52',
    Va = 'NavigationBar_button__garageNavigation_69a10af0',
    La = 'NavigationBar_divider_7592acb0',
    za = 'NavigationBar_pageTitle_5847696c',
    $a = 'NavigationBar_hiddenLabel_1fa48c6e',
    Ua = 'NavigationBar_base__ready_69a10af0',
    Fa = 'NavigationBar_base__animating_69a10af0',
    Ga = 'NavigationBar_hiddenLabelInner_8490d7c',
    Qa = 'NavigationBar_infoButton_8aaee3f9',
    qa = 'NavigationBar_infoButton__last_efa963fb';
function Ya({ classNames: e = {} }) {
    return a.jsxs('div', {
        className: s(Oa, e.icon),
        children: [
            a.jsx('div', { className: s(wa, Ra, e.iconImage, e.iconImage__default) }),
            a.jsx('div', { className: s(wa, Da, e.iconImage, e.iconImage__hover) }),
            a.jsx('div', { className: s(wa, Ha, e.iconImage, e.iconImage__active) }),
        ],
    });
}
const Ja = n(function ({ classNames: t = {}, className: r, garageNavigationAllowed: n, battleButtonVisible: o }) {
    ...
    const h = F(),
        ...
        [I, C] = e.useState(!1);
    G(() => {
        (E(!0), B(x.current?.offsetWidth ? x.current?.offsetWidth + 1 : 0));
        const e = Q(() => C(!0));
        return () => {
            (E(!1), B(0), C(!1), e());
        };
    }, [h.screenWidthRem, h.breakpoint.name, n, o, _, b, u]);
    const A = p({ value: Pa.sizes.small }, { extraLarge: { value: Pa.sizes.medium } });
    return a.jsxs('div', {
        className: s(Ta, j && Ua, I && Fa, r, t.base),
        children: [
            a.jsxs(le, {
                className: s(La, t.divider),
                children: [
                    n &&
                        a.jsxs('div', {
                            className: s(Sa, Va, t.button, t.button__garageNavigation),
                            ...
                            onMouseEnter: f,
                            children: [
                                a.jsx(Ya, { classNames: t }),
                                a.jsx('div', {
                                    className: s(Wa, t.label),
                    ...
                    _ &&
                        a.jsx(a.Fragment, {
                            children: a.jsxs('div', {
                                className: s(Sa, Ma, t.button, t.button__backNavigation),
                                onClick: function (e) {
                                ...
                                children: [
                                    ...
                                    b &&
                                        a.jsx('div', {
                                            ref: x,
                                            className: s($a, t.hiddenLabel),
                                            style: { '--width': `${N}px` },
                                            children: a.jsx(Y, { className: Ga, text: y.toUpperCase(b) }),
                                        }),
                                ],
                            }),
                        }),
                    u &&
                        a.jsx(a.Fragment, {
                            children: a.jsx('div', {
                                className: s(za, t.title),
                                children: a.jsx(Y, { text: y.toUpperCase(u) }),
                            }),
                        }),
                ],
            }),
            v.length > 0 &&
                q(v, (e, r) =>
                    a.jsx(
                        'div',
                        {
                            className: s(Qa, r === v.length - 1 && qa, t?.infoButton),
                            children: a.jsx(Pa, {
                                size: A.value,
                                onClick: g(r),
                                infoType: e.type,
...
const Xa = 'PlayersProfile_b15b3eb3',
    Za = 'PlayersProfile_playerInfo_89f70778',
    es = 'PlayersProfile_playerInfoWrapper_2ed6c121',
    ts = 'PlayersProfile_badgeWrapper_910cac78',
    as = 'PlayersProfile_suffixBadgeWrapper_a4096e4e',
    ss = 'PlayersProfile_badge_4050c3e9',
    rs = 'PlayersProfile_text_99417432',
    ns = 'PlayersProfile_text__name_2ed6c121',
    os = 'PlayersProfile_text__teamKiller_8bf5e412',
    is = 'PlayersProfile_base__alertVisible_9b40d452',
    ls = 'PlayersProfile_anonymizerIcon_8632eb46',
    cs = 'PlayersProfile_alertIcon_b8de5d15',
    ds = m.resolve('strings'),
    us = y('PlayersProfile', Xa, { variants: { alertVisible: { true: is } } }),
    _s = new Set([Ka.ADD_NEEDED, Ka.ADDED]),
    ms = { width: '48rem', height: '48rem', marginLeft: '-35rem' },
    bs = n(function () {
        const t = O(),
            r = _({
            ...
            h = b && _s.has(p);
        const y = T(K.Badge.sizes.x48x48, K.Badge.sizes.x80x80),
            x = T(K.Stripe.sizes.medium, K.Stripe.sizes.big);
        return a.jsxs(us, {
            alertVisible: h,
            children: [
                a.jsxs(K, {
                    ...
                    onMouseEnter: function (e) {
                        (t.play('mouse-enter', { target: 'player-info', original: e }), r.onMouseEnter(e));
                    },
                    children: [
                        l > 0 &&
                            a.jsx('div', {
                                className: ts,
                                children: a.jsx(K.Badge, {
                                    badgeId: String(l),
                                    width: 48,
                                    height: 48,
                                    size: y,
                        ...
                        a.jsxs(K.Wrapper, {
                            className: es,
                            children: [
                                a.jsx(K.Name, { className: s(rs, ns, m && os), children: a.jsx(Y, { text: i }) }),
                                c &&
                                    a.jsx(K.ClanTag, {
                                        className: rs,
                                        children: a.jsx(M, {
                        ...
                        u > 0 &&
                            a.jsx('div', {
                                className: as,
                                children: a.jsx(K.Stripe, {
                                    badgeId: String(u),
                                    size: x,
                                    stripeIcon: K.Stripe.icons.stripe.medium,
                                    stipeBadgeIcon: K.Stripe.icons.badge.medium,
                                    style: ms,
                                }),
                            }),
                        v && a.jsx('div', { className: ls }),
                    ],
                }),
                h && a.jsx('div', { ...g, className: cs }),
            ],
        });
    }),
    ps = e.memo(({ options: e, ...t }) => a.jsx(ue, { options: e, children: a.jsx(bs, { ...t }) })),
    vs = 'Premiums_e458a55f',
    fs = 'Premiums_subscription_5299180c',
    gs = 'Premiums_subscription__unavailable_86efdd6c',
    hs = 'Premiums_text_82711911',
    ys = 'Premiums_text__premShop_a067f33c',
    xs = 'Premiums_divider_268fb4cd',
    Ns = 'Premiums_wotPlusImg_195105fb',
    Bs = 'Premiums_wotPlusImg__disabled_8e8e6ceb',
    js = 'Premiums_wotPlusImg__pro_798bc63',
    Es = 'Premiums_alertIcon_da4f2f9b',
    Is = 'Premiums_premiumImg_d5d73467',
    Cs = 'Premiums_premiumImg__disabled_12a94c05',
    As = 'Premiums_premiumShopImg_99a91f62',
    ks = y('PremiumShop', s(vs, 'Premiums_base__clickable_dd8e69b8')),
    Ps = m.resolve('strings');
function Ts() {
    const { model: e, controls: t } = Pe(),
        r = O(),
        n = _({
            header: Ps.readOrEmpty('tooltips.header.premShop.header'),
            body: Ps.readOrEmpty('tooltips.header.premShop.body'),
        });
    if (e.premiumShopEnabled.get())
        return a.jsxs(ks, {
            ...n,
            onClick: function (e) {
                (n.onClick(), r.play('click', { target: 'premium-shop', original: e }), t.openPremiumShop());
            },
            onMouseEnter: function (e) {
                (n.onMouseEnter(e), r.play('mouse-enter', { target: 'premium-shop', original: e }));
            },
            children: [
                a.jsx('div', { className: As }),
                a.jsx('div', {
                    className: s(hs, ys),
                    children: Ps.readOrEmpty('menu.headerButtons.btnLabel.premShop'),
                }),
            ],
        });
}
var Ss = ((e) => ((e.Inactive = 'Inactive'), (e.Active = 'Active'), (e.Cancelled = 'Cancelled'), e))(Ss || {});
const Ms = y('Premiums', vs),
    Ws = m.resolve('strings'),
    Os = m.resolve('aliases'),
    ws = m.resolve('views');
const Rs = n(function ({ className: t }) {
        const r = O(),
            n = A({
                resId: Os.read((e) => e.lobby_header.default.UserAccount('resId')),
                contentId: Os.read((e) => e.common.tooltip.Backport('resId')),
            ...
            x = X(
                ...
                e.useMemo(
                    () => ({
                        ...
                        isCnRegion: m,
                        tooltipVariant: b,
                        resId: ws.read((e) => e.mono.hangar.tooltips('resId')),
                    }),
                    [l, c, d, u, m, b],
                ),
                { showDelay: 50 },
            ),
            N = _({ body: Ws.readOrEmpty('subscription.headerButton.tooltip.unavailable') });
                ...
                a.jsxs('div', {
                    ...
                    onClick: g
                        ? function (e) {
                              ((y.current = !0),
                                  x.onClick(),
                                  r.play('click', { target: 'premiums:wot-plus', original: e }),
                    ...
                    onMouseEnter: function (e) {
                        y.current ||
                            ...
                            r.play('mouse-enter', { target: 'premiums:wot-plus', original: e }));
                    },
                    children: [
                        a.jsx('div', { className: s(Ns, !B && Bs, v === me.Pro && B && js) }),
                        a.jsx('div', {
                            className: hs,
                            children: Ws.readOrEmpty(
                                f === _e.Active || f === _e.Cancelled
                                    ? 'subscription.headerButton.state.active'
                                    : 'subscription.headerButton.state.available',
                            ),
                        }),
                        f === _e.Cancelled && a.jsx(S, { path: 'subscription.alert_icon', className: Es }),
                    ],
                }),
                a.jsx(ce, { className: xs }),
                a.jsxs('div', {
                    ...n,
                    className: fs,
                    ...
                    onClick: function (e) {
                        (n.onClick(),
                            r.play('click', { target: 'premiums:premium', original: e }),
                            i.openPremiumSubscriptionPage());
                    },
                    onMouseEnter: function (e) {
                        (n.onMouseEnter(e), r.play('mouse-enter', { target: 'premiums:premium', original: e }));
                    },
                    children: [
                        a.jsx('div', { className: s(Is, h === Ss.Inactive && Cs) }),
                        a.jsx('div', {
                            className: hs,
                            children:
                                h === Ss.Active && p
                                    ...
                                    : a.jsx('span', { children: Ws.readOrEmpty('menu.common.premiumBuy') }),
                        }),
                    ],
                }),
            ],
    ...
    Ds = e.memo(({ options: e, ...t }) => a.jsx(ue, { options: e, children: a.jsx(Rs, { ...t }) })),
    Hs = 'UserProfile_2146e52',
    Vs = 'UserProfile_divider_4a395a41',
    Ls = m.resolve('aliases'),
    zs = Ls.read((e) => e.lobby_header.default.UserAccount('resId')),
    $s = Ls.read((e) => e.lobby_header.default.PremShop('resId'));
function Us({ className: e }) {
    ...
    return a.jsx('div', {
        ...
        children: a.jsxs(le, {
            className: Vs,
            children: [
                t && a.jsx(ps, { options: { rootId: zs } }),
                t && a.jsx(Ds, { options: { rootId: zs } }),
                $s && a.jsx(Ts, {}),
            ],
        }),
    });
}
const Fs = n(function ({ garageNavigationAllowed: e, battleButtonVisible: t, classNames: s }) {
        return st() === be.Hangar
            ? a.jsx(Us, { className: s?.userProfile })
            : a.jsx(Ja, { classNames: s?.navigationBar, garageNavigationAllowed: e, battleButtonVisible: t });
    }),
...
const Ys = {
    ...
    Js = n(function ({ className: e }) {
        ...
        if (void 0 !== c)
            return i
                ? a.jsx(M, {
                      className: s(Ys.base, Ys[`base__${o}`], e),
...
const ar = n(function () {
        const t = te(0, 250),
            ...
            _ = st(),
            m = Boolean(ae(r.location, { paths: ['/:hangar/allVehicles', '/:eventName/:hangar/allVehicles'] })),
            b = r.location.includes('/postBattleResults'),
            p = $(Zs),
            v = o.model.currentModeId.get();
        return (
            e.useEffect(() => {
                p ? (b && tr.has(v) ? l(!1) : d ? l(!0) : er.has(c) ? l(!1) : l(_ === be.Hangar || m || b)) : l(!1);
            }, [d, c, _, m, b, p, v]),
            a.jsxs(Xs, {
                ref: t,
                ...
                children: [
                    ...
                    a.jsx('div', {
                        className: s(Ks.rightSide, i && Ks.rightSide__battleButtonVisible),
                        children:
                            !o.model.computes.isSearchingBattle() && !o.model.computes.isBattleReady() && a.jsx(Ia, {}),
                    }),
                ],
            })
        );
...
ie(
    new re()
        ...
        .addWithProps(ke, { options: { rootId: sr.read((e) => e.lobby_header.default.PremShop('resId')) } })
        .addWithProps(Ce, { options: { rootId: sr.read((e) => e.lobby_header.default.Prebattle('resId')) } })
        .addWithProps(ge, { options: { rootId: sr.read((e) => e.lobby_header.default.CurrentVehicle('resId')) } })
        .addWithProps(pe, { options: { rootId: sr.read((e) => e.lobby_header.default.HeaderState('resId')) } })
        .addWithProps(ve, { options: { rootId: sr.read((e) => e.lobby_header.default.NavigationBar('resId')) } })
        .render(a.jsx(ar, {})),
);
