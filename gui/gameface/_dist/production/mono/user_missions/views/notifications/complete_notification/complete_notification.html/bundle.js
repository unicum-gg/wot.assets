...
const [j, u] = l()(
    ...
    x = 'App_9e9b93b',
    N = 'App_base__popup_a2438b5f',
    f = 'App_wrapper_ffdbb6e9',
    A = 'App_acceptIconContainer_ce6da395',
    ...
    z = s(function () {
        const { model: s, controls: l } = u(),
            { challengeName: _, anyMissionsLeft: h, isPopUp: j } = s.root.get(),
            z = s.bonuses.get(),
            L = c(z);
        return e.jsxs(n, {
            className: a(x, j && N),
                ...
                e.jsxs('div', {
                    ...
                    children: [
                        ...
                        e.jsx(i, {
                            ...
                            children: h ? I.button() : I.affirmative(),
                        }),
                    ],
                }),
                j && e.jsx(t, { size: d.small, onClose: m, className: M }),
            ],
        });
    });
_(e.jsx(j, { children: e.jsx(h, { children: e.jsx(z, {}) }) }));
