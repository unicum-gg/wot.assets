...
const [u, g] = l()(
    ...
    z = s(function () {
        const { model: s, controls: l } = g(),
            { challengeName: _, anyMissionsLeft: h, isPopUp: u } = s.root.get(),
            z = s.bonuses.get(),
            L = n(z);
        return e.jsxs(c, {
            className: a(f, u && x),
            children: [
                ...
                u && e.jsx(t, { size: d.small, onClose: m, className: M }),
            ],
        });
    });
_(e.jsx(u, { children: e.jsx(h, { children: e.jsx(z, {}) }) }));
