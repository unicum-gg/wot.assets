...
import { i as r, n as t, r as a, L as c, O as n, c as i, U as d, E as o } from '../../../../chunks/lib.js';
/* empty css                       */ const [p, l] = r()(({ observableModel: s }) => ({ ...{ root: s.object() } }), t),
    m = 'App_8ee77ed',
    _ = 'App_title_f53d8db4',
    j = 'App_description_c94a25d1',
    x = 'App_footer_6954e057',
    u = 'App_icon_efac1a20',
    ...
    g = s(function () {
        const { model: s } = l(),
            { freeRestarts: r, usedFreeRestarts: t, restartCost: a, currency: i } = s.root.get();
        return e.jsxs('div', {
            className: m,
            children: [
                e.jsx('div', { className: _, children: y.readOrEmpty(`${A}.title`) }),
                e.jsx('div', { className: j, children: e.jsx(c, { text: y.readOrEmpty(`${A}.description`) }) }),
                e.jsxs('div', {
                    className: x,
                    children: [
...
i(
    e.jsx(d, {
        children: e.jsx(p, { children: e.jsx(o, { children: e.jsx(o.Decorator, { children: e.jsx(g, {}) }) }) }),
    }),
);
