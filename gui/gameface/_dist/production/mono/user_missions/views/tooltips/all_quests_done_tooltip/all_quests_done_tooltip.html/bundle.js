...
import { i as e, n as o, r as i, c as t } from '../../../../chunks/lib.js';
...
const [n, d] = e()(({ observableModel: s }) => ({ ...s.primitives(['countdown']) }), o),
    ...
    m = () => {
        const { model: e } = d();
        return s.jsx(r, {
            header: l.read('user_missions.tooltip.daily_quests.completed'),
            description: l.read('user_missions.tooltip.daily_quests.all_quest_completed'),
            invertedColors: !0,
            timerTimeLeft: e.countdown.get(),
            timerPath: 'user_missions.tooltip.daily_quests.new_daily_missions',
        });
    };
t(s.jsx(n, { children: s.jsx(m, {}) }));
