import { t as s, r as e, j as t, v as o, w as r, e as n, s as a } from '../../../../chunks/vendor.js';
import {
    i,
    R as l,
    n as c,
...
const A = 'Index_62decda',
    D = 'Index_header_805f33ff',
    P = 'Index_description_21b8299a',
    $ = 'Index_timerBlock_6d6f592',
    E = 'Index_divider_835afce3',
    z = s({ rerollCooldown: o(), rerollAvailableTimestamp: o() }),
    R = M(g(z)),
...
const J = Object.freeze(
        Object.defineProperty(
            {
                ...
                default: function () {
                    const { rerollCooldown: s, rerollAvailableTimestamp: o } = R(),
                        [r, n, a] = d(p(s), ['D', 'h', 'm']),
                        i = u(e.useMemo(() => ({ until: j(o), tick: p(1) }), [o])),
                        l = e.useMemo(() => _(j(o), (s) => h(s, f()), x), [o]);
                    return t.jsx(b, {
                        children: t.jsx(b.Decorator, {
                            children: t.jsxs('div', {
                                className: A,
                                children: [
                                    t.jsx(v, { path: 'user_missions.tooltip.daily_reroll.header', className: D }),
                                    t.jsx('div', {
                                        className: P,
    ...
    L = 'Index_d037ad5c',
    U = s({ specConditions: r(O) }),
    V = M(g(U));
const W = Object.freeze(
        Object.defineProperty(
            {
                __proto__: null,
                SpecConditionsTooltipParamsSchema: U,
                default: function () {
                    const { specConditions: s } = V();
                    return t.jsx(b, {
                        children: t.jsx(b.Decorator, {
                            children: t.jsx('div', { className: L, children: t.jsx(w, { specConditions: s }) }),
                        }),
                    });
                },
            },
    ...
    X = 'App_text_13feac86',
    Y = 'App_text__bold_f88f7b4e';
function Z({ type: s }) {
    return t.jsxs('div', {
        className: X,
        children: [
            'Unknown tooltip type:',
            t.jsx('span', { className: n(X, Y), children: s.length > 0 ? s : '<empty>' }),
        ],
    });
}
const q = Object.fromEntries(
    Object.entries(Object.assign({ './reroll/index.tsx': J, './spec_conditions/index.tsx': W })).map(([s, e]) => [
        s.split('/').at(-2),
        { Component: e.default },
    ]),
);
const G = a(function () {
    const { model: s } = T(),
        e = s.type.get(),
        o = q[e]?.Component;
    return t.jsx(b, { children: o ? t.jsx(o, {}) : t.jsx(Z, { type: e }) });
});
S(new k().add(I).render(t.jsx(G, {})));
