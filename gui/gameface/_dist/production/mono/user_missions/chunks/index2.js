import { y as e, r as s, m as a, o as t, D as n, E as i, f as r, j as l, e as c, s as o, n as d } from './vendor.js';
import {
    i as m,
    m as _,
    b as u,
...
const he = { tension: 800, friction: 40 },
    ...
    xe = 'new',
    ve = 'normal',
    ye = ['gold', 'credits', 'freeXP', 'crystal', 'equipCoin', 'bptaler'],
    je = 'style_2d',
    Ne = 'crew_member',
    we = 'vehicle',
    Ie = 'attachments_set',
    Ce = 'improved_equipment',
    ke = 'currencies',
    Re = 'gui_vehicle_menu_open',
    Se = 'minimize',
    Te = 'bp_unlock_big',
    De = 'dt_locked_reset_button',
    Ee = 'activate',
    Pe = 'restart';
var $e = ((e) => (
    (e.INACTIVE = 'inactive'),
...
const Me = 'to_active_challenge',
    [Be, Ae] = m()(
        ({ observableModel: e }) => {
            const s = {
                    ...
                    viewedChallenges: t.set([]),
                    scrollTargetID: t.box(null),
                    shouldScrollToActive: t.box(!1),
                },
                a = n(() => {
            ...
            i(
                ...
                r((e) => {
                    s.shouldScrollToActive.get() && e && (s.scrollTargetID.set(e), s.shouldScrollToActive.set(!1));
                }),
            );
            const c = (e) => l.get().get(e),
                o = r((e) => {
            ...
            return {
                ...
                computes: {
                    ...
                    getChallengesByComplexity: (e) =>
                        n(() => {
                            const s = a.get();
                            return s.find((s) => s.complexity === e)?.challenges || [];
                        }),
                    getChallengeByID: c,
                    getCardStatus: (e) =>
                        n(() => {
                            const s = c(e);
                            if (s) return s.state === $e.ACTIVE ? fe : s.isNew ? xe : ve;
                        }),
                    getMissionState: (e, a) =>
                        n(() => {
                            const t = c(e),
                                n = a === t?.completedMissions,
                                i = n && s.root.get().activeChallengeID === s.selectedChallengeID.get();
                            return a < t?.completedMissions
                                ? 'done'
                                : n && t?.remainingAttempts < 1
                                  ? 'failed'
                                  : i
                                    ? 'active'
                                    : 'locked';
        ...
        ({ externalModel: e, model: s }) => {
            const a = e.createCallback(
                    r((e) => (s.viewedChallenges.add(e), { selectedChallengeID: e })),
                    'onSelectChallenge',
                ),
            ...
            return {
                ...
                handleAction: (e, n = 0) => {
                    ...
                    return e === Pe || e === Ee ? (s.enableScrollToActive(), t(e, n > 0)) : t(e);
                },
                openPreview: e.createCallback((e) => e, 'openPreview'),
            };
        },
    ),
    Oe = (e, s = 0, t) => a({ from: be.from, to: e ? be.to : be.from, config: he, delay: e ? s : 0, onRest: t }),
    Le = (e, s, a, t) => {
    ...
    ze = { tension: 400, friction: 60, duration: 1e3 },
    He = 'ActiveLabel_e577414e',
    Ve = u.resolve('strings'),
    We = ({ className: e }) =>
        l.jsx('div', {
            className: c(He, e),
    ...
    Ge = ({ kingReward: e, openPreview: s, labelKey: a, className: t, classNames: n }) => {
        const i = Ue.readOrEmpty(`user_missions.hub.challenge_missions.reward.${a}`);
        return l.jsxs('div', {
            className: c(Fe, t),
            children: [
                l.jsx(g, {
                    ...
                    size: 'normal',
                    onClick: () => {
                        s({ bonusType: e.bonusType, bonusId: e.id, styleID: e.styleID, attachmentsToken: e.value });
                    },
                    className: Xe,
                    classNames: { icon: Ye },
                }),
    ...
    os = ({ kingReward: e, classNames: s, vehicleTypeIconSize: a = v.x48x48 }) => {
        const { isInHangar: t, vehicleShortName: n, type: i, level: r, isElite: c } = e;
        return l.jsx('div', {
            className: s?.base,
            children: l.jsxs(f, {
                children: [
                    l.jsx(f.Level, { className: s?.level, value: r, numberType: x.numberTypes.roman }),
                    l.jsx(f.Type, { className: s?.typeIcon, type: cs(i), premium: c, size: a }),
                    l.jsx(f.Name, { className: s?.name, children: n }),
                    t && l.jsx('div', { className: s?.vehicleInHangar }),
                ],
            }),
        });
    },
    ...
    gs = 'VehicleDescription_vehicleInHangar_37261f1',
    hs = 'VehicleDescription_iconPosition_460dc8ce',
    ...
    fs = {
        [Ne]: ({ kingReward: e }) => {
            ...
            return l.jsxs('div', {
                className: ns,
                children: [
                    l.jsx('div', { className: is, children: s }),
                    l.jsx('div', { className: rs, children: ls.tankmanTitle() }),
                ],
            });
        },
        [we]: ({ kingReward: e, openPreview: s }) =>
            l.jsxs('div', {
                ...
                children: [
                    ...
                    l.jsx(os, { kingReward: e, classNames: { base: ms, name: _s, level: _s, vehicleInHangar: gs } }),
                    l.jsx('div', { className: us, children: ps.vehicleTitle() }),
                ],
            }),
        [je]: ({ kingReward: e, openPreview: s }) =>
            l.jsx(Ge, { kingReward: e, openPreview: s, labelKey: 'style2DTitle' }),
        [Ie]: ({ kingReward: e, openPreview: s }) =>
            l.jsx(Ge, { kingReward: e, openPreview: s, labelKey: 'attachmentsTitle', classNames: { name: Je } }),
        [Ce]: ({ kingReward: e }) => {
            const { label: s } = e;
            return l.jsxs('div', {
                className: es,
                children: [
                    l.jsx(b, { className: ss, text: s }),
                    l.jsx('div', { className: as, children: ts.improvedEquipment() }),
                ],
            });
        },
        [ke]: ({ kingReward: e }) => {
            ...
            return l.jsxs('div', {
                className: Qe.base,
                children: [
                    l.jsx(b, { className: c(Qe.count, Qe[`count__${s}`]), text: p.formatNumber('integral', a) }),
    ...
    xs = ({ kingRewardType: e, kingReward: s, openPreview: a }) => {
        const t = ye.includes(e) ? ke : e,
            n = fs[t];
        return n ? l.jsx(n, { kingReward: s, openPreview: a }) : (console.warn('Unknown king reward type:', e), null);
    },
    vs = u.resolve('images'),
    ys = u.resolve('aliases'),
    js = 'KingReward_ad0db18a',
    ...
    Ts = o(function ({ kingRewardType: e, kingReward: s, missionId: a, className: t }) {
        const { model: n, controls: i } = Ae(),
            { selectedChallengeID: r } = n.root.get(),
            { bg: o } = ((e) => {
                const s = `userMissions.challenges.kingReward.c_${e}`;
                return {
                    bg: vs.readOrEmpty(s, 'silent') || vs.readOrEmpty('userMissions.challenges.kingReward.default'),
                };
            })(r),
            { rewardImage: d, overlayImage: m } = ((e) => ({
                rewardImage: _e(e, ue.S600x450),
                overlayImage: e.overlayType ? ge({ size: ue.S400x300, name: e.name, special: e.overlayType }) : null,
            }))(s),
            _ = ((e, s) =>
                j({
                    resId: ys.read((e) => e.user_missions.hub.challengeMissions.MainView('resId')),
        ...
        return l.jsxs('div', {
            className: c(js, t),
            children: [
                l.jsx('div', { className: Ns, style: { backgroundImage: `url(${o})` } }),
                l.jsxs('div', {
                    className: ws,
                    children: [
                        l.jsx('div', {
                            ...
                            ..._,
                            children: m && l.jsx('div', { className: ks, style: { backgroundImage: `url(${m})` } }),
                        }),
                        l.jsx('div', {
                            className: Cs,
                            children: l.jsx(xs, { kingRewardType: e, kingReward: s, openPreview: i.openPreview }),
                        }),
                        u > 1 && l.jsx(b, { text: Ss.multi(), className: Rs, params: { count: u } }),
                    ],
                }),
            ],
        });
    ...
    $s = 'ConditionItem_conditionText_2f989dc8',
    Ms = 'ConditionItem_conditionTitle_a283e646',
    Bs = 'ConditionItem_conditionDescription_500fc72a',
    As = 'ConditionItem_multiline_6e29776a',
    Os = u.resolve('images'),
    Ls = ({ condition: e }) => {
        const { iconKey: s, titleData: a, descrData: t } = e,
            { breakpoint: n } = N(),
            i = n.weight >= w.large.weight,
            r = `userMissions.challenges.missionIcons.${i ? 'c_128' : 'c_80'}.${s}`,
            c = `userMissions.challenges.missionIcons.${i ? 'c_128' : 'c_80'}.folder`,
            o = Os.readOrEmpty(r, 'silent') || Os.readOrEmpty(c);
        return l.jsxs('div', {
            className: Ds,
            children: [
                l.jsx('div', {
                    className: Es,
                    children: l.jsx('div', { className: Ps, style: { backgroundImage: `url(${o})` } }),
                }),
                l.jsxs('div', {
                    className: $s,
                    children: [
                        l.jsx('div', { className: Ms, children: a }),
                        l.jsx(I, { text: `${t}`, classNames: { base: As, text: Bs }, upgradeLegacy: !0 }),
                    ],
                }),
            ],
        });
    ...
    Ws = u.resolve('strings'),
    Fs = () =>
        l.jsxs('div', {
            className: zs,
            children: [
                l.jsx('div', { className: c(Hs, Vs) }),
                l.jsx('span', { children: Ws.readOrEmpty('user_missions.hub.challenge_missions.card.or') }),
...
((ea.Image = function ({ showCounter: e, count: s, image: a, className: t = '' }) {
    ...
    (ea.Overlay = function ({ size: e, special: s, className: a }) {
        return l.jsx('div', {
            className: c(Xs, a),
            style: { backgroundImage: `url(${Ys.readOrEmpty(`quests.bonuses.${e}.${C(s)}_overlay`)})` },
        });
    }));
const sa = {
...
function aa({ reward: e, missionId: s, className: a = '', disabledRewardTooltip: t = !1 }) {
    const n = e.count ?? 0,
        i = ye.includes(e.name ?? ''),
        r = n > 1 && !i,
        o = e.overlayType,
        d = S({ size: ue.Small }, { large: { size: ue.Big } });
    return l.jsx('div', {
        className: c(sa.base, a),
        children: l.jsxs(ea, {
            reward: e,
            missionId: s,
            ...
            children: [
                l.jsxs('div', {
                    ...
                    children: [
                        l.jsx(ea.Image, { showCounter: r, count: n, image: _e(e, ue.Big) }),
                        o &&
                            l.jsx(ea.Overlay, {
                                special: o,
                                size: d.size,
                                className: c(sa.overlay, sa[`overlay__${d.size}`]),
                            }),
                    ],
                }),
                i && l.jsx(ea.Name, { reward: e, className: c(sa.label, sa[`label__${e.name}`]) }),
            ],
        }),
    });
}
const ta = 'RewardsList_bd99d393',
    ...
    ra = ({ sortedRewards: e, missionId: s, disabledRewardTooltip: a = !1 }) =>
        l.jsxs('div', {
            className: ta,
            children: [
                e.length > 0 && l.jsx('div', { className: na }),
                l.jsx('div', {
                    className: ia,
                    children: _(e, (e, t) =>
                        l.jsx(aa, { reward: e, missionId: s, disabledRewardTooltip: a }, `${t}_${e.id}`),
                    ),
                }),
            ],
        }),
...
function ca({ mission: e, state: s, isLastCard: a, mainRewardType: t, disabledRewardTooltip: n = !1 }) {
    const i = e.bonuses,
        r = e.id,
        o = T(i, (e) => '' !== t && e.bonusType === t),
        d = D(a && o ? E(i, (e) => e.bonusType !== t) : i);
    return l.jsxs('div', {
        className: c(la.base, la[`base__${s}`]),
        children: [
            'active' === s && l.jsx(We, { className: la.activeLabel }),
            l.jsxs('div', {
                ...
                children: [
                    ...
                    o &&
                        ...
                        l.jsx('div', {
                            ...
                            children: l.jsx(Ts, { kingRewardType: t, kingReward: o, missionId: r }),
                        }),
                ],
            }),
        ],
...
const oa = 'MissionNumber_2f758a67',
    da = 'MissionNumber_missionNumber_560428d8',
    ma = 'MissionNumber_missionNumber__active_10840043',
    _a = ({ number: e, active: s, className: a = '' }) =>
        l.jsx('div', { className: c(oa, a), children: l.jsx('div', { className: c(da, s && ma), children: e }) }),
    ua = 'Content_fa80e432',
    ga = 'Content_base__selected_da09528a';
function ha({ children: e, selected: s }) {
    return l.jsx('div', { className: c(ua, s && ga), children: e });
}
const ba = {
...
function pa({ children: e, state: s, className: a, ...t }) {
    ...
    return l.jsx('div', {
        ...t,
        className: c(ba.base, ba[`base__${s}`], a),
        children: l.jsxs('div', {
            className: ba.content,
            children: [
                ('locked' === s || 'failed' === s) && l.jsx('div', { className: ba.disabled }),
                n && l.jsx('div', { className: c(ba.selected, ba.selected__border) }),
                l.jsx('div', { className: ba.selected }),
                l.jsx(ha, { selected: n, children: e }),
            ],
        }),
    });
}
const fa = {
    ...
    xa = 'done',
    va = 'locked',
    ya = ({ type: e, tooltipBodyText: s, disabled: a, className: t }) => {
        const n = P({ body: s });
        return l.jsxs('div', {
            className: c(fa.base, fa[`base__${e}`], t),
            children: [
                l.jsx('div', { className: fa.glowBig }),
                l.jsx('div', { className: fa.line }),
                l.jsx('div', { className: fa.shadow }),
                l.jsx('div', { className: fa.glowInner }),
                l.jsx('svg', {
                    width: '42',
                    height: '42',
                    viewBox: '0 0 42 42',
                ...
                l.jsx('div', { className: c(fa.icon, a && fa.icon__disabled), ...n }),
            ],
        });
    },
    ja = {
...
function Ia({
    ...
    const _ = e.bonuses,
        ...
        g = s.useRef(n),
        h = ((e) =>
            'done' === e ? Na.readOrEmpty(`${wa}.completed`) : 'locked' === e ? Na.readOrEmpty(`${wa}.disabled`) : '')(
            n,
        ),
        b = ((e) => ('done' === e ? xa : 'active' !== e ? va : void 0))(n),
        p = ((e) => 'active' === e || 'failed' === e)(n),
        f = ((e) => 'done' === e || 'locked' === e)(n);
    s.useEffect(() => {
        const e = g.current;
        ('active' === n && 'active' !== e && $.sound(Te),
            'failed' === n && 'failed' !== e && $.sound(De),
            (g.current = n));
    }, [n]);
    const x = T(_, (e) => '' !== i && e.bonusType === i);
    return l.jsx('div', {
        className: c(ja.base, ja[`base__${n}`], o),
        children: l.jsxs(pa, {
            state: n,
            className: c(ja.slot, x && r && ja.slot__wideCard),
            children: [
                'active' === n &&
                    l.jsx('div', {
                        className: ja.shimmerContainer,
                        children: l.jsx(d.div, { style: u, className: ja.shimmer }),
                    }),
                l.jsx(_a, { number: t, active: p, className: ja.missionNumber }),
                l.jsx(ca, { mission: e, state: n, isLastCard: r, mainRewardType: i, disabledRewardTooltip: m }),
                b &&
                    l.jsx('div', {
                        className: ja.status,
                        children: l.jsx(ya, { type: b, disabled: !f || m, tooltipBodyText: h }),
                    }),
            ],
        }),
    });
}
const Ca = 'ReplayBlock_4b4cbc0b',
    ...
    Pa = u.resolve('strings'),
    $a = 'user_missions.hub.challenge_missions';
function Ma({ selectedChallenge: e, className: s = '' }) {
        ...
        children: l.jsxs('div', {
            ...
            children: [
                l.jsx('div', {
                    className: Ra,
                    children: l.jsx(h, {
                        text: Pa.readOrEmpty(`${$a}.header.numberTemplate`),
                        binding: {
                            currentNumber: l.jsx('span', { className: c(Sa, a === t && Ta), children: t }),
                            commonNumber: l.jsx('span', { children: a }),
                        },
                    }),
                }),
                l.jsx('div', { className: Da, children: Pa.readOrEmpty(`${$a}.replay.completed`) }),
                l.jsx('div', { className: Ea }),
            ],
        }),
    });
}
const Ba = 'CardsList_cardsWrapper_6c2823cb',
    Aa = 'CardsList_cardsWrapper__inactive_87faefde',
            ...
            children: [
                _(t, (s, o, d) =>
                    l.jsx(
                        Ia,
                        {
                            disabledRewardTooltip: e || m,
                            missionNumber: o + 1,
                            mission: s,
                            className: c(Oa, o === t.length - 1 && La),
                            state: Le(a, o, n, i),
                            mainRewardType: r,
                            isLastCard: o === d.length - 1,
                        },
                        `${s.id}_${o}`,
                    ),
                ),
                l.jsx('div', {
                    ref: d,
                    children:
                        a.allowedCompletions > 1
                            ? l.jsx(Ma, { selectedChallenge: a })
                            : l.jsx('div', { className: za }),
                }),
            ],
        });
    },
    ...
    Wa = ({ state: e, kingRewardRef: s, kingReward: a, mainRewardType: t, missionId: n }) =>
        l.jsxs('div', {
            className: c(Va.kingReward, Va[`kingReward__${e}`]),
            ref: s,
            children: [
                l.jsx('div', { className: Va.lip }),
                l.jsx(Ts, { kingRewardType: t, kingReward: a, missionId: n }),
            ],
        }),
    Fa = 'left',
    Ka = 'right',
    ...
    Ua = o(function ({ selectedChallenge: e, enableAnimation: t = !1 }) {
        const { model: n } = Ae(),
            i = s.useRef(null),
            r = s.useRef(null),
            o = s.useRef(null),
            ...
            [g, h] = s.useState(!1),
            { api: b } = M(),
            { animationScroll: p, applyScroll: f } = b,
            { activeChallengeID: x } = n.root.get(),
            v = e?.challengeID,
            y = e?.missions,
            j = e?.mainRewardType ?? '',
            N = y ? B(y, y.length - 1) : void 0,
            w = N?.bonuses ? T(N.bonuses, (e) => '' !== j && e.bonusType === j) : void 0,
            [I, C] = a(() => ({ maskStop: 100, isSticky: 0, config: { precision: 0.1 } })),
            k = A(b, V.horizontal, void 0, { gapBeforeStart: 5 }),
            [R, S] = O(b),
            D = s.useCallback(() => {
                if (!o.current || !e) return 0;
                const s = e.completedMissions,
                    a = o.current.children[s] || i.current;
            ...
            P = s.useCallback(() => {
                const e = r.current,
                    s = m.current;
                if (!e) return;
                if (!s) return void C.start({ maskStop: e.offsetWidth, isSticky: 1, immediate: !0 });
                ...
                if (a < d - c) {
                    const e = n - l;
                    C.start({ maskStop: e, isSticky: 1, immediate: !0 });
                } else C.start({ maskStop: n, isSticky: 0, immediate: !0 });
            }, [p.scrollPosition, C, b]),
            $ = s.useCallback(() => {
                (h(!0), P());
            }, [P]),
            W = s.useCallback(() => {
                (P(), g && p.scrollPosition.idle && h(!1));
            }, [p.scrollPosition, P, g]);
        if (
            (s.useEffect(
                () => (
                    L(() => {
                    ...
                    b.events.on('mouseWheel', $),
                    b.events.on('change', W),
                    b.events.on('resizeHandled', P),
                    () => {
                        (b.events.off('mouseWheel', $), b.events.off('change', W), b.events.off('resizeHandled', P));
                    }
                ),
                [b, $, W, C, P],
            ),
            s.useEffect(() => {
                L(() => {
                    'idle' === k.type && p.scrollPosition.idle && (h(!1), f(p.scrollPosition.get()));
                });
            }, [p.scrollPosition, f, k.type]),
            s.useEffect(() => u('dragging' === k.type), [k.type]),
            s.useEffect(
                () => (
                    x === v && f(D()),
                    b.events.on('resizeHandled', () => f(D())),
                    () => {
                        b.events.off('resizeHandled', () => f(D()));
                    }
                ),
                [b, x, f, D, v],
            ),
        ...
        return l.jsxs(d.div, {
            ...
            children: [
                l.jsx('div', {
                    className: c(Ya.mask, Ya[`mask__${((K = R), (q = S), K || q ? (K ? (q ? Xa : Ka) : Fa) : qa)}`]),
                    ref: r,
                    children: l.jsx(d.div, {
                        className: Ya.maskReward,
                        style: {
                            maskImage: I.maskStop.to(
                                (e) => `linear-gradient(to right, #000 ${e}px, transparent ${e}px)`,
                            ),
                        },
                        children: l.jsx(z, {
                            classNames: { wrapper: Ya.scrollWrapper },
                            children:
                                y &&
                                v &&
                                l.jsx(Ha, {
                ...
                w &&
                    ...
                    y &&
                    l.jsx(d.div, {
                        className: c(Ya.kingReward, 'done' === Le(e, y.length - 1, x, v) && Ya.kingReward__done),
                        style: { visibility: I.isSticky.to((e) => (1 === e ? 'visible' : 'hidden')) },
                        children: l.jsx(Wa, {
                            state: Le(e, y.length - 1, x, v),
                            kingRewardRef: m,
                            kingReward: w,
                            mainRewardType: j,
                            missionId: N.id,
    ...
    ct = s.memo(function ({ challengeName: e, completed: s, formattedCount: a, remainingAttempts: t }) {
        const n = t > 0;
        return l.jsxs(l.Fragment, {
            children: [
                ...
                l.jsx('div', {
                    ...
                    children: s
                        ? l.jsxs('div', {
                              className: rt,
                              children: [
                                  l.jsx('span', { className: lt }),
                                  l.jsx(F, { path: 'user_missions.hub.challenge_missions.missionsCompleted' }),
                              ],
                          })
                        : l.jsxs(l.Fragment, {
                              children: [
                                  l.jsx('div', { children: a }),
                                  l.jsx('div', { className: at }),
                                  l.jsxs('div', {
                                      className: c(tt, !n && nt),
                                      children: [t, l.jsx('span', { className: it })],
                                  }),
                              ],
                          }),
                }),
    ...
    mt = o(function ({ challengeID: e, complexity: s, selected: a }) {
        const { model: t } = Ae(),
            { breakpoint: n } = N(),
            i = t.computes.getChallengeByID(e),
            r = t.computes.getCardStatus(e).get(),
            o = i?.completedMissions ?? 0,
            d = i?.totalMissions ?? 0,
            m = i?.type ?? '',
            _ = i?.expireTime ?? 0,
            u = i?.challengeName ?? '',
            g = i?.state,
            h = i?.remainingAttempts ?? 0,
            b = l.jsx(F, {
                path: 'user_missions.hub.challenge_missions.missionsCount',
                params: { currentMissions: l.jsx('span', { className: ot.accent, children: o }), totalMissions: d },
            }),
            p = 'special' === m ? dt.additional.$dyn(`c_${e}`) : dt.basic();
        return l.jsxs('div', {
            className: ot.base,
            children: [
                r && l.jsx(Za, { status: r }),
                l.jsx('div', {
                    className: c(ot.background, a && ot.background__selected),
                    style: { backgroundImage: `url(${p})` },
                }),
                l.jsx('div', { className: c(ot.pattern, m && ot[`pattern__${s}`]) }),
                i &&
                    l.jsxs('div', {
...
function gt({ challengeID: e, isSelected: s, onSelect: a, complexity: t, className: n, ...i }) {
    return l.jsx('div', {
        ...
        children: l.jsx(Q, {
            ...
            active: s,
            onClick: () => a(e),
            children: l.jsx(mt, { challengeID: e, complexity: t, selected: s }),
        }),
    });
}
const ht = {
    ...
    bt = u.resolve('strings');
function pt({ complexity: e, className: s }) {
    const a = P({ body: bt.readOrEmpty('user_missions.hub.challenge_missions.complexity.tooltip.body') });
    return l.jsx('div', {
        className: c(ht.base, s),
        children: l.jsxs('div', {
            className: ht.content,
            ...a,
            children: [
                l.jsx('div', { className: c(ht.complexityIcon, ht[`complexityIcon__${e}`]) }),
                l.jsx(F, { path: `user_missions.hub.challenge_missions.complexity.${e}` }),
            ],
        }),
    });
}
const ft = 'Complexity_card__selected_cd2a2f69',
    xt = o(function ({ complexity: e }) {
        const { model: a, controls: t } = Ae(),
            { api: n } = Z(),
            i = a.selectedChallengeID.get(),
            r = a.computes.getChallengesByComplexity(e).get(),
            o = s.useCallback(
                (e) => {
                    t.selectChallenge(e);
                    const s = document.querySelector(`[data-challenge-id="${e}"]`);
                    if (!s) return;
                    const [a, i] = n.getBounds(),
                        r = n.animationScroll.scrollPosition.get(),
                        l = n.getWrapperSize() ?? 0,
                        c = ((e, s, a, t, n, i) => {
                            const r = 0.03 * t,
                                l = e + s,
                                c = a + r;
                            return e >= c && l <= a + t - r
                                ...
                                : e < c
                                  ? Math.max(n, e - r)
                                  : Math.min(i, l - t + r);
                        })(s.offsetTop, s.offsetHeight, r, l, a, i);
                    null !== c && n.animationScroll.scrollPosition.start(c);
                },
                [n, t],
            );
        return l.jsxs(l.Fragment, {
            children: [
                l.jsx(pt, { complexity: e }),
                _(r, (s) => {
    ...
    yt = 'ChallengeList_verticalBar_9881b2c2',
    jt = o(function () {
        const { model: e } = Ae(),
            a = e.computes.challenges.get(),
            { api: t } = Z();
        ee(t);
        const n = e.scrollTargetID.get();
        return (
            s.useEffect(() => {
                if (!n) return;
                const s = document.querySelector(`[data-challenge-id="${n}"]`);
                if (s) {
                    const [e, a] = t.getBounds(),
                        n = t.animationScroll.scrollPosition.get(),
                        i = t.getWrapperSize() ?? 0,
                        r = ((e, s, a, t, n, i) => {
                            if (e >= a && e + s <= a + t) return null;
                            const r = e - t / 2 + s / 2;
                            return Math.max(n, Math.min(i, r));
                        })(s.offsetTop, s.offsetHeight, n, i, e, a);
                    null !== r && t.animationScroll.scrollPosition.start(r, { immediate: !0 });
                }
            ...
            l.jsxs(l.Fragment, {
                children: [
                    l.jsx(se, {
                        children: _(a, (e) =>
                            e.challenges?.length
                                ? l.jsx(xt, { complexity: e.complexity }, `challenge__${e.complexity}`)
                                : null,
                        ),
                    }),
                    l.jsx(ae, { classNames: { base: yt } }),
                ],
            })
        );
    });
function Nt({ isAnimating: e = !1 }) {
    return l.jsx('div', {
        ...
        children: l.jsx(te, { children: l.jsx(jt, {}) }),
    });
}
const wt = {
...
function St({ attempts: e, remainingAttempts: s, isFailed: a, isCompleted: t, className: n = '' }) {
    const i = j({ resId: kt, contentId: Rt });
    return l.jsxs('div', {
        className: c(wt.base, n),
        children: [
            l.jsx('div', {
                className: c(wt.shields, t && wt.shields__dimmed),
                    ...
                    l.jsxs(
                        'div',
                        {
                            ...
                            children: [
                                l.jsx('div', {
                                    ...i,
                                    className: c(wt.shieldIcon, (a || n > s - 1) && wt.shieldIcon__fault),
                                }),
                                n !== e - 1 && l.jsx('div', { className: wt.dashIcon }),
                            ],
                        },
                        n,
                    ),
            ...
            !t &&
                l.jsxs('div', {
                    ...
                    children: [
                        l.jsx(h, {
                            text: Nn.readOrEmpty(`${wn}.numberTemplate`),
                            binding: {
                                currentNumber: l.jsx('span', { className: wt.currentNumber, children: s }),
                                commonNumber: l.jsx('span', { className: wt.commonNumber, children: e }),
                            },
                        }),
                        l.jsx(h, { text: Nn.readOrEmpty(`${wn}.remaining`), classMix: wt.remaining }),
                    ],
                }),
        ],
    });
}
const Tt = 'RestartPrice_33839785',
    Dt = 'RestartPrice_multiplier_a8d3f008',
    Et = 'RestartPrice_multiplier__opacity_2c4332c7',
    Pt = 'RestartPrice_restartIcon_5bfca1dc',
    $t = 'RestartPrice_restartIcon__opacity_83950c61',
    Mt = 'RestartPrice_currency_4cba0a13',
    Bt = 'RestartPrice_currencyIcon_8a20d0ca',
    At = u.resolve('aliases'),
    Ot = u.resolve('views'),
    Lt = At.read((e) => e.user_missions.hub.challengeMissions.MainView('resId')),
...
function Ht({ challengeData: e, hasOpacity: s = !1 }) {
    const a = e.restartCost,
        t = e.currencyType,
        n = e.isEnoughMoney,
        i = e.remainingFreeRestarts,
        r = i > 0,
        o = j({ resId: Lt, contentId: zt }),
        { breakpoint: d } = N(),
        m = d.weight >= w.large.weight ? ne.medium : ne.small;
    return l.jsxs('div', {
        className: Tt,
        ...o,
        children: [
            l.jsx('div', { className: c(Pt, s && $t) }),
            r
                ? l.jsx(h, {
...
function Jt({ challengeData: e, onAction: s, hasButton: a }) {
    const t = e.remainingFreeRestarts,
        ...
        { breakpoint: r } = N(),
        c = j({ resId: Ut, contentId: Gt }),
        o = r.weight >= w.large.weight ? le.large : le.small,
        d = t > 0;
    return l.jsxs('div', {
        className: Vt,
        children: [
            l.jsx(Ht, { challengeData: e, hasOpacity: !a }),
            a
                ? l.jsx(ce, {
                      disabled: i && !n,
                      onClick: () => s(Pe),
...
function rn({ challengeData: e }) {
    ...
    return l.jsxs('div', {
        ...
        children: [
            ...
            a && l.jsx(h, { text: Nn.readOrEmpty(`${wn}.restart.text`), binding: { count: s }, classMix: Zt }),
            l.jsx('div', { className: en }),
        ],
    });
}
const ln = 'RestartBlock_7a915f27';
function cn(e) {
...
const on = 'StatusInfo_162c825c',
    ...
    gn = 'StatusInfo_divider_31e9fdd7',
    hn = 'StatusInfo_timerUnavailableText_baa0a877',
...
function yn({ expireTime: e, isLocked: s, isAnotherActive: a, onAction: t, buttonSize: n, className: i = '' }) {
    return l.jsxs('div', {
        className: c(on, i),
        children: [
            l.jsx(h, {
            ...
            s &&
                l.jsxs('div', {
                    className: un,
                    children: [
                        l.jsx('div', { className: gn }),
                        l.jsx(h, {
                            text: Nn.readOrEmpty(`${wn}.unavailable`),
                            binding: {
                                lockIcon: l.jsx('div', { className: c(pn, a && fn) }),
                                text: l.jsx('span', {
                                    className: xn,
                                    children: a
                                        ? Nn.readOrEmpty(`${wn}.restriction`)
                                        : Nn.readOrEmpty(`${wn}.vehicleRestriction`),
                                }),
                            },
                            classMix: c(hn, a && bn),
                        }),
                        a &&
                            l.jsx(ce, {
                                ...
                                className: vn,
                                size: n,
                                children: Nn.readOrEmpty(`${wn}.buttons.toChallenge`),
                            }),
                    ],
                }),
        ],
...
const jn = {
    ...
    Nn = u.resolve('strings'),
    wn = 'user_missions.hub.challenge_missions.header',
    In = o(function ({ selectedChallenge: e, className: s = '', enableAnimation: t = !1 }) {
        const { model: n, controls: i } = Ae(),
            { activeChallengeID: r, isSuitableVehicles: o, selectedChallengeExpireTime: m } = n.root.get(),
            _ = e.state,
            u = e.challengeName,
            g = m,
            b = e.attempts,
            p = e.remainingAttempts,
            f = e.challengeID,
            x = e.remainingFreeRestarts,
            v = S({ buttonSize: le.small }, { large: { buttonSize: le.medium }, extraLarge: { buttonSize: le.large } }),
            { breakpoint: y } = N(),
            j = y.weight >= w.large.weight ? le.medium : le.extraSmall,
            I = _ === $e.COMPLETED,
            C = _ === $e.FAILED,
            k = _ === $e.ACTIVE,
            R = _ === $e.INACTIVE,
        ...
        return l.jsxs(d.div, {
            style: $,
            className: c(jn.base, s, jn[`state_${_.toLowerCase()}`]),
            children: [
                !I && l.jsx(yn, { expireTime: g, isLocked: D, isAnotherActive: T, onAction: B, buttonSize: j }),
                I &&
                    l.jsx('div', {
                        className: jn.completeText,
                        children: l.jsx(h, {
                            text: Nn.readOrEmpty(`${wn}.complete`),
                            binding: { completeIcon: l.jsx('div', { className: jn.completeIcon }) },
                        }),
                    }),
                l.jsxs('div', {
                    className: jn.controls,
                    children: [
                        l.jsx('div', { className: c(jn.name, E && jn.name__disabled), children: u }),
                        (k || R) &&
                            !D &&
                            l.jsxs('div', {
                                ...
                                children: [
                                    l.jsx(ce, {
                                        ...
                                        className: jn.button,
                                        size: v.buttonSize,
                                        theme: k ? oe.secondary : oe.primary,
                                        disabled: D,
                                        children: k
                                            ? Nn.readOrEmpty(`${wn}.buttons.surrender`)
                                            : Nn.readOrEmpty(`${wn}.buttons.activate`),
                                    }),
                                    R && !D && l.jsx(d.div, { style: M, className: jn.shimmer }),
                                ],
                            }),
                    ],
                }),
                l.jsxs('div', {
                    className: c(jn.attemptsSection, E && jn.attemptsSection__disabled),
                    children: [
                        l.jsx(St, { attempts: b, remainingAttempts: p, isFailed: C, isCompleted: I }),
                        !I &&
                            l.jsxs('div', {
                                className: c(jn.restartSection, E && jn.restartSection__disabled),
                                children: [
                                    l.jsx('div', { className: jn.restartDivider }),
                                    l.jsx(cn, {
                                        challengeData: e,
                                        hasButton: !D,
                                        isActive: k,
                                        onAction: B,
                                        className: jn.restartBlock,
                                    }),
                                ],
                            }),
                    ],
    ...
    Tn = o(function () {
        const { model: a } = Ae(),
            { selectedChallengeID: t } = a.root.get(),
            n = a.computes.getChallengeByID(t),
            [i, r] = s.useState(!1),
            [c, o] = s.useState(!1),
            [m, _] = s.useState(!1),
            u = s.useRef(!1);
        (s.useEffect(() => {
            !u.current && t && (a.setScrollTarget(t), (u.current = !0));
        }, [t, a]),
            s.useEffect(() => {
                (o(!1), _(!0));
            }, [t]));
        ...
        return l.jsxs('div', {
            className: Cn,
            children: [
                l.jsx(d.div, { style: g, children: l.jsx(Nt, { isAnimating: m }) }),
                l.jsx(d.div, {
                    className: kn,
                    style: {
                        transform: h.transform,
                        pointerEvents: m ? 'none' : 'auto',
                        cursor: m ? 'default' : 'auto',
                    },
                    children: b((e, s) => {
                        if (!s) return null;
                        const a = s,
                        ...
                        return l.jsx(d.div, {
                            ...
                            children:
                                ...
                                l.jsxs(l.Fragment, {
                                    children: [
                                        l.jsx(In, { selectedChallenge: a, enableAnimation: !0 }),
                                        l.jsx('div', {
                                            className: Sn,
                                            children: l.jsx(de, {
                                                children: l.jsx(Ua, { selectedChallenge: a, enableAnimation: !0 }),
                                            }),
                                        }),
                                    ],
                                }),
...
function Mn() {
    return l.jsxs('div', {
        ...
        children: [
            ...
            l.jsx('div', {
                className: Pn,
                children: $n.readOrEmpty('user_missions.hub.challenge_missions.challenges_empty.title'),
            }),
        ],
    });
}
const Bn = 'ChallengeMissions_f1737fb7',
    An = 'ChallengeMissions_empty_6a671d3b',
    On = o(function () {
        const { model: e } = Ae(),
            s = e.enabled.get();
        return l.jsx('div', {
            className: Bn,
            children: s ? l.jsx(Tn, {}) : l.jsx('div', { className: An, children: l.jsx(Mn, {}) }),
        });
    }),
    Ln = { rootId: R.aliases.user_missions.hub.challengeMissions.MainView('resId') };
function zn() {
    return l.jsx(Be, { options: Ln, children: l.jsx(On, {}) });
}
