import { y as e, r as s, l as a, o as t, D as n, E as i, f as r, j as l, e as c, s as o, m as d } from './vendor.js';
import {
    i as m,
    m as _,
    r as u,
...
const he = { tension: 800, friction: 40 },
    ...
    xe = 'new',
    ve = 'normal',
    je = ['gold', 'credits', 'freeXP', 'crystal', 'equipCoin', 'bptaler'],
    ye = 'style_2d',
    Ne = 'crew_member',
    we = 'vehicle',
    Ie = 'attachments_set',
...
function Ia({
    ...
    return l.jsx('div', {
        className: c(ya.base, ya[`base__${n}`], o),
        children: l.jsxs(pa, {
            state: n,
            className: c(ya.slot, x && r && ya.slot__wideCard),
            children: [
                'active' === n &&
                    l.jsx('div', {
                        className: ya.shimmerContainer,
                        children: l.jsx(d.div, { style: u, className: ya.shimmer }),
                    }),
                l.jsx(_a, { number: t, active: p, className: ya.missionNumber }),
                l.jsx(ca, { mission: e, state: n, isLastCard: r, mainRewardType: i, disabledRewardTooltip: m }),
                b &&
                    l.jsx('div', {
                        className: ya.status,
                        children: l.jsx(ja, { type: b, disabled: !f || m, tooltipBodyText: h }),
                    }),
            ],
        }),
    });
...
const Ba = 'CardsList_cardsWrapper_6c2823cb',
    ...
    Ua = o(function ({ selectedChallenge: e, enableAnimation: t = !1 }) {
        const { model: n } = Ae(),
            ...
            j = e?.missions,
            y = e?.mainRewardType ?? '',
            N = j ? B(j, j.length - 1) : void 0,
            w = N?.bonuses ? T(N.bonuses, (e) => '' !== y && e.bonusType === y) : void 0,
        ...
        return l.jsxs(d.div, {
            ...
            children: [
                ...
                w &&
                    ...
                    j &&
                    l.jsx(d.div, {
                        className: c(Ya.kingReward, 'done' === Le(e, j.length - 1, x, v) && Ya.kingReward__done),
                        style: { visibility: I.isSticky.to((e) => (1 === e ? 'visible' : 'hidden')) },
                        children: l.jsx(Wa, {
                            state: Le(e, j.length - 1, x, v),
                            kingRewardRef: m,
                            kingReward: w,
                            mainRewardType: y,
                            missionId: N.id,
...
function Nt({ isAnimating: e = !1 }) {
    return l.jsx('div', {
        ...
        children: l.jsx(ee, { children: l.jsx(yt, {}) }),
    });
}
const wt = {
...
function St({ attempts: e, remainingAttempts: s, isFailed: a, isCompleted: t, className: n = '' }) {
    const i = y({ resId: kt, contentId: Rt });
    return l.jsxs('div', {
...
function Jt({ challengeData: e, onAction: s, hasButton: a }) {
    const t = e.remainingFreeRestarts,
        n = e.isEnoughMoney,
        i = e.currencyType === ce.crystal,
        { breakpoint: r } = N(),
        c = y({ resId: Ut, contentId: Gt }),
        o = r.weight >= w.large.weight ? re.large : re.small,
        d = t > 0;
    return l.jsxs('div', {
        className: Vt,
        children: [
...
function jn({ expireTime: e, isLocked: s, isAnotherActive: a, onAction: t, buttonSize: n, className: i = '' }) {
    return l.jsxs('div', {
        className: c(on, i),
        children: [
            l.jsx(h, {
...
const yn = {
    ...
    In = o(function ({ selectedChallenge: e, className: s = '', enableAnimation: t = !1 }) {
        const { model: n, controls: i } = Ae(),
            ...
            v = S({ buttonSize: re.small }, { large: { buttonSize: re.medium }, extraLarge: { buttonSize: re.large } }),
            { breakpoint: j } = N(),
            y = j.weight >= w.large.weight ? re.medium : re.extraSmall,
            I = _ === $e.COMPLETED,
            C = _ === $e.FAILED,
            k = _ === $e.ACTIVE,
            R = _ === $e.INACTIVE,
        ...
        return l.jsxs(d.div, {
            style: $,
            className: c(yn.base, s, yn[`state_${_.toLowerCase()}`]),
            children: [
                !I && l.jsx(jn, { expireTime: g, isLocked: D, isAnotherActive: T, onAction: B, buttonSize: y }),
                I &&
                    l.jsx('div', {
                        className: yn.completeText,
                        children: l.jsx(h, {
                            text: Nn.readOrEmpty(`${wn}.complete`),
                            binding: { completeIcon: l.jsx('div', { className: yn.completeIcon }) },
                        }),
                    }),
                l.jsxs('div', {
                    className: yn.controls,
                    children: [
                        l.jsx('div', { className: c(yn.name, E && yn.name__disabled), children: u }),
                        (k || R) &&
                            !D &&
                            l.jsxs('div', {
                                ...
                                children: [
                                    ...
                                    R && !D && l.jsx(d.div, { style: M, className: yn.shimmer }),
                                ],
                            }),
                    ],
                }),
                l.jsxs('div', {
                    className: c(yn.attemptsSection, E && yn.attemptsSection__disabled),
                    children: [
                        l.jsx(St, { attempts: b, remainingAttempts: p, isFailed: C, isCompleted: I }),
                        !I &&
                            l.jsxs('div', {
                                className: c(yn.restartSection, E && yn.restartSection__disabled),
                                children: [
                                    l.jsx('div', { className: yn.restartDivider }),
                                    l.jsx(cn, {
                                        challengeData: e,
                                        hasButton: !D,
                                        isActive: k,
