    ...
    (!(function ({ missions: e, bonusMission: s }) {
        ...
        K(() => {
            ...
            (e.forEach((e) => {
                ...
                F(o) || i({ complexId: et.MISSION_COMPLETE, complexCfg: o, soundCfg: Ce.umg_hub_quest_complete }));
        });
        ...
        (function ({ missions: e, bonusMission: s, isFirstRender: i }) {
            ...
            jo(i, () => {
                ...
                (e.forEach((e, s) => {
                    ...
                    Mo(i, s, n),
                    F(i) || o({ complexId: et.MISSION_COMPLETE, complexCfg: i, soundCfg: Ce.umg_hub_quest_complete }));
            });
        ...
        (function ({ missions: e, bonusMission: s, timeToNextReRoll: i, isFirstRender: o }) {
            ...
            jo(o, () => {
                ...
                (e.forEach((e, s) => {
                    const i = r[s];
                    Ho(o, e, i) || (l[e.id] = Go.hideReRollComponent);
                }),
                    s.isAvailable && Ho(o, s, a),
        ...
        (function ({ missions: e, timeToNextReRoll: s, isFirstRender: i }) {
            ...
            (jo(i, () => {
                if (0 == s && n > 0) {
                    const s = qo(e, Fo.showReRollButton);
                    o({
                ...
                X(t, et.RE_ROLL, () => {
                    if (0 == s) {
                        const s = qo(e, Fo.stopRotation),
                            i = qo(e, Fo.showReRollButton);
                        return (
                            o({
                                complexId: et.SHOW_REROLL_COMPONENT,
                                complexCfg: s,
                    ...
                    const i = qo(e, Fo.showReRollTimer);
...
function Ft() {
    return e.jsx(Pi, { options: Ht, children: e.jsx(Si, { children: e.jsx(Gt, {}) }) });
}
const [qt, Vt] = u()(
        ({ observableModel: e }) => {
...
const [Fn, qn] = u()(({ observableModel: e }) => e.primitives(['progressType']), U);
...
const Gr = i(function ({ classNames: s }) {
    ...
    Hr = 'WinBackProgress_bg_8a178cd6',
    Fr = 'WinBackProgress_7746c27',
...
function ma() {
    return e.jsx(Fn, { options: da, children: e.jsx(fe, { children: e.jsx(ca, {}) }) });
}
        ...
        return e.jsxs('div', {
            ...
            children: [
                ...
                e.jsxs(xe, {
                    ...
                    border: 'contour',
                    children: [
                        e.jsx(bi, { content: e.jsx(Ft, {}), className: ga, ...i }),
                        e.jsx(bi, {
                            content: e.jsx(Hn, {}),
