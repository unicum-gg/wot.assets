import {
    ...
    m as useSpring,
    n as animated,
    p as loadDefaultJapaneseParser,
    q as parse$1,
    C as Controller,
} from './vendor.js';
...
function readFromR$2(e, t) {
    ...
    if (window.R && window.R.images) {
        ...
        if (!t) return;
        const u = s.slice(0, -1).reduce((e, t) => {
...
class ImagesRClassProvider {
    ...
    readOr(e, t, s = 'silent') {
        const u = e.startsWith('R.images') ? e : concatWithPath(this.prefix, e),
            r = readFromR$2(e.startsWith('R.images') ? window : this.root, u);
        return void 0 === r ? ('silent' !== s && logBySeverity$1(`Resource not found: ${u}`, s), t()) : r;
    }
...
function readFromR$1(e, t, s) {
    ...
    return n && 'function' == typeof n[r] ? (t ? n[r](t) : n[r]()) : void 0;
}
class StringsRClassProvider {
    ...
    readOr(e, t, s = 'silent') {
        const u = e.startsWith('R.strings') ? e : concatWithPath(this.prefix, e),
            r = readFromR$1(u, void 0, e.startsWith('R.strings') ? window : this.root);
        return void 0 === r ? ('silent' !== s && logBySeverity$1(`Resource not found: ${u}`, s), t()) : r;
    }
    readOrEmpty(e, t = 'warn') {
        return this.readOr(e, () => '', t);
    ...
    pluralOr(e, t, s, u = 'silent') {
        const r = e.startsWith('R.strings') ? e : concatWithPath(this.prefix, e),
            n = readFromR$1(r, t, e.startsWith('R.strings') ? window : this.root);
        return void 0 === n ? ('silent' !== u && logBySeverity$1(`Resource not found: ${r}`, u), s()) : n;
    }
...
class VideosRClassProvider {
    ...
    readOr(e, t, s = 'silent') {
        const u = e.startsWith('R.videos') ? e : concatWithPath(this.prefix, e),
            r = readFromR(e.startsWith('R.videos') ? window : this.root, u);
            ...
            (t, s) => (
                (t[s] = (function (t) {
                    return (s) => {
                        e.listeners += 1;
                        const r = `mouse${t}`,
                            n = internalMouse$1[t]((e) => s([e, 'outside']));
                        function a(e) {
                            s([e, 'inside']);
                        }
                        return (
                            ...
                            u(),
                            () => {
                                (n(), window.removeEventListener(r, a), (e.listeners -= 1), u());
                            }
                        );
                    };
                })(s)),
...
const createViewEventArguments$2 = (e) => {
    ...
    sendViewEvent$1 = (e, t) => {
        ...
        if (void 0 !== t) {
            const { args: u, ...r } = t;
            return void 0 !== u
                ? viewEnv.handleViewEvent({ __Type: s, type: e, ...r, arguments: createViewEventArguments$2(u) })
...
function initExternalPaddings$1(e) {
    function t() {
        const { top: t, right: s, bottom: u, left: r } = viewEnv.getExternalPaddingsRem();
...
function pipe(e, t, s, u, r, n, a, o, i) {
    switch (arguments.length) {
        case 1:
            return e;
        case 2:
        ...
        case 6:
            return n(r(u(s(t(e)))));
        case 7:
            return a(n(r(u(s(t(e))))));
        case 8:
            return o(a(n(r(u(s(t(e)))))));
        case 9:
            return i(o(a(n(r(u(s(t(e))))))));
        default: {
            let e = arguments[0];
...
function create(
    { initializer: e = !0, rootId: t = 0, getRoot: s = getRootDefault, context: u = 'model' } = {},
    { name: r = 'DataLayer' } = {},
) {
    const n = new Map(),
    ...
    function i() {
        try {
            ...
            throw new Error(`Failure get root of ${r}. Root id: ${t}. Context: ${u}`);
        }
    }
    const l = (e) => {
        const s = i();
        ...
        try {
            ...
            throw new Error(`Failure readByPath in ${r}. Root id: ${t}. Context: ${u}:\n${n}\n`);
        }
    };
    function c(e) {
        viewEnv.removeDataChangedCallback(e, t) ? n.delete(e) : console.error("Can't remove callback by id:", e);
    }
    return {
        subscribe: (s, r) => {
            const a = addModelObserver$1('string' == typeof r ? `${u}.${r}` : u, t, !0);
            return (n.set(a, s), e && s(l(r), []), a);
        },
        readByPath: l,
        readSafeByPath: (e) => {
            const t = i();
...
function addEventListener(e, t, s, u) {
    return (e.addEventListener(t, s, u), () => e.removeEventListener(t, s, u));
}
    ...
    (function () {
                                ...
                                if (4 === n.readyState) {
                                    ...
                                    if (e < 100 || e > 599) s(new TypeError('Network request failed'));
                                        ...
                                        var u = {
                                            ...
                                            r = 'response' in n ? n.response : n.responseText;
                                        t(new _(r, u));
                                    }
                                }
                            }
                            ('cors' === r.credentials && (n.withCredentials = !0),
        ...
        function d(e, t) {
            ...
            if (
                ...
                (this.method = ((u = t.method || 'GET'), (r = u.toUpperCase()), s.indexOf(r) > -1 ? r : u)),
                    ...
                    .forEach(function (e) {
                        if (e) {
                            var s = e.split('='),
                                u = s.shift().replace(/\+/g, ' '),
                                r = s.join('=').replace(/\+/g, ' ');
                            t.append(decodeURIComponent(u), decodeURIComponent(r));
                        }
                    }),
                t
            );
...
function map(e, t) {
    return Array.isArray(e) ? e.map(t) : e.map((e, s, u) => t(e?.value, s, u));
}
function toArray(e) {
...
function arabicToRoman(e) {
    ...
    for (let s = ARABIC$1.length - 1; s >= 0; s--) {
        let u = ARABIC$1[s];
        for (; void 0 !== u && e >= u;) ((t += ROMAN$1[s]), (e -= u));
    }
    return t;
}
...
function addSpaceAndMap(e, t, s) {
    return langsWithoutSpace.has(t)
        ? e.map(s)
        : e.map((e, t, u) => (t === u.length - 1 ? s(e, t, u) : s(`${e} `, t, u)));
}
...
function generateMediaClasses(e, t) {
    const s = t['width' === e ? 'height' : 'width'],
        ...
        r = new Set(s.classes.filter((e) => !(!e.endsWith('Width') && !e.endsWith('Height')) || u.has(e)));
    return Array.from(new Set([...u, ...r])).join(' ');
}
function calculateMedia(e, t, s) {
    const u = BREAKPOINTS.reduce(
            (s, u) => (
                u.width <= e &&
                    (s.width.classes.push(u.className, `${u.className}Width`),
                    s.width.names.push(u.name),
                    (s.width.weight += 1)),
                u.height <= t &&
                    (s.height.classes.push(u.className, `${u.className}Height`),
                    s.height.names.push(u.name),
                    (s.height.weight += 1)),
                s
            ),
            { width: { classes: [], names: [], weight: 0 }, height: { classes: [], names: [], weight: 0 } },
        ),
        r = u.width.weight <= u.height.weight ? 'width' : 'height',
        n = u[r],
    ...
    return {
        mediaClass: generateMediaClasses(r, u),
        breakpoint: o,
        screenWidthRem: e,
        screenHeightRem: t,
        breaks: n.names,
...
function MediaWrapperElement({ children: e, className: t, ...s }) {
    const { mediaClass: u, upscale: r } = useMedia();
    return jsxRuntimeExports.jsx('div', {
        className: clsx(t, 'media-wrapper', u, r && 'media-upscale'),
        ...s,
        children: e,
    });
}
...
function throttle(e, t, s, u) {
    ...
    return (
        'boolean' != typeof t && ((u = s), (s = t), (t = void 0)),
        (i.cancel = function () {
            (o(), (n = !0));
        }),
        i
...
function useEmitter() {
    return reactExports.useMemo(() => {
        ...
        return {
            on: (e, u) => (t(e).add(u), () => s(e, u)),
            off: s,
            trigger: (e, ...s) => {
                for (const u of t(e).values()) u(...s);
            },
        };
    }, []);
}
...
const createApi = () => {
        ...
        return {
            ...
            register: function (e, u) {
                ...
                const r = t(e);
                return (r.includes(u) || r.push(u), () => s(e, u));
            },
            unregister: s,
...
function useHandleKey(e, t, s, u = !1) {
    const r = normalizeKeyCode(e),
        n = useEvent((e) => {
            isEventHandled$1() || (s(e), setEventHandled$1(), u && e.stopPropagation());
        }),
        a = useApi$2(),
        o = reactExports.useMemo(() => a[t].register(r, n), [a, t, r, n]);
...
function useRepeatCallback(e, t, s = []) {
    ...
    return [
        reactExports.useCallback((s) => {
            (0 !== u.current && r(), (u.current = window.setInterval(() => e(s, !0), t)), e(s, !1));
        }, n),
        r,
    ];
}
function useResize$1(e, t) {
    reactExports.useEffect(
...
function useThrottle(e, t, s) {
    const u = reactExports.useMemo(() => throttle(s, e), t);
    return (reactExports.useEffect(() => u.cancel, [u]), u);
}
function useTicker(e) {
    const { type: t, tick: s, limit: u } = e,
        r = e.autostart ?? !1,
        n = e.start ?? zero,
        [a, o] = reactExports.useState({ current: n, running: r }),
    ...
    reactExports.useEffect(
        () => (
            (i.current = window.setInterval(() => {
                a.running
                    ? o((e) => {
                          const r = 'countdown' === t ? subtract(e.current, s) : add(e.current, s),
                              n = { ...e, current: r };
                          return (
                              isDuration(u) &&
                                  ('countdown' === t
                                      ? lt(subtract(r, s), u) && ((n.current = u), (n.running = !1))
                                      : gt(add(r, s), u) && ((n.current = u), (n.running = !1))),
                              n
                          );
                      })
...
function useUntilTimer(e) {
    const { start: t, until: s, tick: u } = reactExports.useMemo(() => ({ ...e, start: e.start ?? now() }), [e]),
        [r, n] = reactExports.useState({ remaining: subtract(s, t), until: s, done: !1 });
    return (
        reactExports.useEffect(() => {
            let e = 0;
            const t = () => {
                const r = subtract(s, now()),
                    a = compare(r, u) <= 0;
                if ((n({ remaining: r, done: a, until: s }), a)) return;
                const o = toMillis(r);
                e = window.setTimeout(t, Math.min(toMillis(u), o));
            };
            return (
                t(),
                () => {
...
function useTooltip({
    ...
    return (
        ...
        useUnmount$1(useEvent(o.hide)),
        i
    );
}
function useSimpleTooltip({ alert: e, body: t, header: s, note: u, hasHtmlContent: r, disabled: n }) {
    ...
    return useTooltip({
        ...
        args: reactExports.useMemo(() => ({ body: t, header: s, note: u, alert: e }), [e, t, s, u]),
    });
}
...
function SoundsProvider({ severity: e = 'warn', overrides: t, silent: s = !1, children: u }) {
...
function cloneModel(e, { shallow: t = !0, depth: s = 0, maxDepth: u = 32 } = {}) {
    const r = e,
        n = typeof e;
    if (s > u) throw new Error(`Too deeply nested to copy. Max is ${u}.`);
    if (nonConvertingTypes.has(n)) return r;
    if (null === r) return r;
    const a = { depth: s + 1, maxDepth: u };
    if (Array.isArray(r)) return r.map((e) => cloneModel(e, a));
    if ('object' === n) {
        const u = r.constructor?.name ?? 'UNKNOWN';
        ...
        if (u.includes(':ViewModel:') || 'Object' === u) {
            ...
            }
            {
                ...
                for (const t in r) {
                    const s = r[t],
                        u = r?.constructor?.name ?? 'UNKNOWN';
                    bindingsForbidden.has(u) || (e[t] = cloneModel(s, a));
                }
                return e;
            }
        }
        const n = {};
        for (const e of Object.keys(r)) n[e] = cloneModel(r[e], a);
        return n;
    }
...
class DLDict {
    constructor(e, t = DEFAULT_OPTIONS) {
        ...
        ((this._keys = observable.set(new Set(u))), (this._data = observable.box(s, MOBX_OPTIONS)));
    }
    _data;
    _keys;
    get keys() {
        ...
        for (let u = 0; u < t.length; u++) {
            ...
            r in s
                ? null === n
                    ...
                    : s[r].set(n)
                : null !== n && ((s[r] = observable.box(n, MOBX_OPTIONS)), this._keys.add(r), this.set(s));
        }
    }
    entries() {
    ...
    map(e) {
        const t = [],
            s = this._data.get();
        for (const u of this.keys.values()) t.push(e(s[u].get(), u));
        return t;
    }
    reduce(e, t) {
        let s = t;
        const u = this._data.get();
        for (const r of this.keys.values()) s = e(s, u[r].get(), r);
        return s;
    }
    takeItem(e, t) {
        const s = e.get(t);
...
function createObservableModel(e, t, s) {
    ...
    const r = (r, n, a = DEFAULT_BOX_CONFIG) => {
            const o = observable.box(r(s(n)), a);
            return ('real' === t && e.subscribe((e) => u.push(() => o.set(r(e))), n), o);
        },
        n = (r, n) => {
            const a = new DLDict(s(r), n);
            return ('real' === t && e.subscribe((e, t) => u.push(() => a.update(e, t)), r), a);
        },
        a = (r, n) => {
            const a = observable.box(s(r) ?? n, DEFAULT_BOX_CONFIG);
            return ('real' === t && e.subscribe((e) => u.push(() => a.set(e)), r), a);
        };
    return {
        dict: n,
        ...
        primitives: (r, n) => {
            ...
            }
            {
                const s = r,
                    o = Object.entries(s),
                    i = o.reduce((e, [t, s]) => ((e[s] = observable.box(a[t], {})), e), {});
                return (
                    'real' === t &&
                        e.subscribe((e) => {
                            u.push(() =>
        ...
        (t, s, u) => {
            ...
            function n(n) {
                const { mode: a, options: o, children: i, mocks: l } = n,
                    ...
                    _ = u?.useRequires?.(),
                    p = useEvent((r, a, o) => {
                        const i = 'real' !== r && o ? createMockInstance(o.getter, a) : create(a, { name: e }),
                            l = (e) => ('mocks' === r ? o?.getter(e, a) : i.readByPath(e)),
                            ...
                            m = t({
                                ...
                                requires: _,
                                externalModel: i,
                                observableModel: createObservableModel(i, r, l),
                                cleanup: c,
                            }),
                            p = { ...d, mode: r, model: m, externalModel: i, cleanup: c, requires: _ },
                            x = 'mocks' === r && o?.controls ? o.controls(p) : {};
                        return {
                            model: m,
                            controls: { ...s?.(p), ...x },
                            externalModel: i,
                    ...
                    [f, h] = reactExports.useState(d);
                reactExports.useEffect(() => {
                    h(d);
                }, [d]);
                const [g, A] = reactExports.useState(() => p(f, o, m));
                return (
                    reactExports.useEffect(() => {
                        x.current ? A(p(f, o, m)) : (x.current = !0);
                    }, [p, m, f, o?.context, o?.initializer, o?.getRoot, o?.rootId]),
                    reactExports.useEffect(
                        () => () => {
                    ...
                    jsxRuntimeExports.jsx(r.Provider, { value: g, children: i })
                );
            }
            return (
                (n.displayName = e),
...
class JSXBuilder {
    ...
    render(e) {
        return jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {
            children: this.items.reduceRight((e, [t, s], u) => reactExports.createElement(t, { ...s, key: u }, e), e),
        });
    }
}
function injectShowModel() {
    const e = (t = window.model, { depth: s = 16, convertArrays: u = !0 } = {}) => {
        if (s < 0)
            return (
                console.warn(
        ...
        switch (typeof t) {
            ...
            case 'function':
                return 'function';
            case 'object': {
                const r = { depth: s - 1, convertArrays: u },
                    n = t.constructor?.name ?? 'UNKNOWN';
                switch (!0) {
                    case n.includes('CoherentArrayProxy'):
                        return [...t.values()].map((t) => e(r.convertArrays ? t.value : t, r));
                    case 'Dict' === n:
                        return [...t.entries()].reduce((t, [s, u]) => ((t[s] = e(u, r)), t), { $$type: 'Dict' });
                    case 'UNKNOWN' === n:
                        return 'UNKNOWN_TYPE';
                    case n.includes('ViewModel'):
                    default: {
                        const s = {};
                        for (const u in t) Object.prototype.hasOwnProperty.call(t, u) && (s[u] = e(t[u], r));
                        return s;
                    }
                }
            }
...
async function runView(
    e,
    { root: t = document.getElementById('root'), withMedia: s = !0, fullScreen: u = !1, immediateLayout: r = !0 } = {},
) {
    injectShowModel();
    const n = s ? MediaWrapper : React.Fragment,
...
function defineStyledComponent(e, t, s) {
    const u = 'object' == typeof t && 'cva' in t ? t.cva?.variants : s?.variants,
        r = u ? Object.keys(u) : [];
    if ('object' == typeof t) {
        const s = t,
            u = cva(s.className, s.cva),
            n = s.element,
            a = reactExports.forwardRef(function (e, t) {
                return reactExports.createElement(n, {
                    ...('function' == typeof n ? e : cleanProps(r, e)),
                    ref: t,
                    className: u(e),
                });
            });
    ...
    const n = cva(t, s),
        a = reactExports.forwardRef(function (t, s) {
            return jsxRuntimeExports.jsx('div', { 'data-name': e, ...cleanProps(r, t), ref: s, className: n(t) });
        });
...
const themes$1 = { primary: 'primary', custom: 'custom' },
    ...
    base$w = 'HorizontalTabs_69e3c6f3',
    ...
    Base$9 = defineStyledComponent('Tabs', styles$A.base, {
        variants: {
            size: {
                [sizes$7.large]: styles$A['base__size-large'],
                [sizes$7.medium]: styles$A['base__size-medium'],
                [sizes$7.small]: styles$A['base__size-small'],
            },
            theme: { [themes$1.primary]: styles$A['base__theme-primary'], [themes$1.custom]: void 0 },
        },
    }),
    Switcher = reactExports.forwardRef(function ({ children: e, classNames: t, ...s }, u) {
        ...
        return jsxRuntimeExports.jsx(Base$9, {
            ...
            children: jsxRuntimeExports.jsxs('div', {
                className: clsx(styles$A.outerBorder, t?.outerBorder),
                children: [
                    jsxRuntimeExports.jsx('div', { className: clsx(styles$A.outerBorderImage, t?.outerBorderImage) }),
                    jsxRuntimeExports.jsxs('div', {
                        className: clsx(styles$A.mainBorder, t?.mainBorder),
                        children: [
                            jsxRuntimeExports.jsx('div', {
                                className: clsx(styles$A.mainBorderImage, t?.mainBorderImage),
                            }),
                            jsxRuntimeExports.jsx('div', {
                                className: clsx(styles$A.content, t?.content),
                                children: e,
                            }),
                        ],
                    }),
    ...
    Base$8 = defineStyledComponent('Tab', styles$z.base, {
        variants: {
            size: {
                [sizes$7.large]: styles$z['base__size-large'],
                [sizes$7.medium]: styles$z['base__size-medium'],
                [sizes$7.small]: styles$z['base__size-small'],
            },
            theme: { [themes$1.primary]: styles$z['base__theme-primary'], [themes$1.custom]: void 0 },
            state: { active: styles$z.base__active, inactive: styles$z.base__inactive },
        },
        defaultVariants: { size: sizes$7.medium, theme: themes$1.primary },
    }),
    HeadlessTab = reactExports.forwardRef(function (
        { theme: e, size: t, tabId: s, active: u, children: r, onClick: n, onMouseEnter: a, ...o },
        i,
    ) {
        const l = useSounds();
        return jsxRuntimeExports.jsx(Base$8, {
            ...
            theme: e,
            size: t,
            state: u === s ? 'active' : 'inactive',
            onMouseEnter: function (e) {
                (u !== s && l.play('mouse-enter', { target: Base$8.displayName, original: e }), a?.(e));
            },
            onClick: function (e) {
                (u !== s && l.play('click', { target: Base$8.displayName, original: e }), n?.(e));
            },
            children: r,
        });
    });
function Tab({ tabId: e, classNames: t, className: s, children: u, ...r }) {
    ...
    return jsxRuntimeExports.jsxs(HeadlessTab, {
        ...
        onClick: (t) => {
            (r.onClick?.(t), n.change(e));
        },
        children: [
            jsxRuntimeExports.jsx('div', { className: clsx(styles$z.background, t?.background) }),
            jsxRuntimeExports.jsx('div', { className: clsx(styles$z.backgroundPattern, t?.backgroundPattern) }),
            jsxRuntimeExports.jsx('div', { className: clsx(styles$z.border, t?.border) }),
            jsxRuntimeExports.jsx('div', { className: clsx(styles$z.innerBorderImage, t?.borderImage) }),
            jsxRuntimeExports.jsx('div', { className: clsx(styles$z.content, t?.content), children: u }),
        ],
    });
}
function Tabs({ active: e, theme: t, size: s, children: u, onActiveChange: r }) {
    const [n, a] = reactExports.useState(e),
        o = reactExports.useRef(e),
        i = reactExports.useMemo(() => ({ active: n, theme: t, size: s, change: a }), [n, s, t]);
    return (
        reactExports.useLayoutEffect(() => {
            a(e);
        }, [e]),
        reactExports.useEffect(() => {
            o.current !== n && ((o.current = n), r?.(n));
        }, [n, r]),
        jsxRuntimeExports.jsx(TabsContext.Provider, { value: i, children: u })
    );
}
((Tabs.Switcher = Switcher), (Tabs.Tab = Tab), (Tabs.Content = Content));
const base$u = 'CloseButton_7488a1b8',
    ...
    upscaleImageSizes = { [sizes$6.medium]: 'x96x96', [sizes$6.small]: sizes$6.medium, [sizes$6.extraSmall]: 'x32x32' };
function CloseButton({
    ...
    const a = useUpscale(styles$y[`base__${e}`], styles$y[`base__${upscaleImageSizes[e]}`]);
    return jsxRuntimeExports.jsx('div', {
        className: cx(styles$y.base, a, u),
        onMouseEnter: () => {
            (play.sound(t), r?.());
        },
        onClick: () => {
    ...
    createApiHook = ({
        ...
        return (o = {}) => {
            const { settings: i = defaultSettings } = o,
                ...
                E = reactExports.useRef({ wrapper: 0, container: 0 }),
                _ = useEmitter(),
                p = useThrottle(
                    () => {
                ...
                h = reactExports.useCallback(
                    (e, t, s) => {
                        const u = x.scrollPosition.get(),
                            r = (x.scrollPosition.goal ?? 0) - u;
                        return a(e, t * s + r + u);
                    },
                    [x.scrollPosition],
                ),
                g = reactExports.useCallback(
                    function (e, { immediate: t = !1, reset: s = !0 } = {}) {
                        ...
                        if (!u) return;
                        const r = a(u, e);
                        x.scrollPosition.goal !== r &&
                            f.start({
                                scrollPosition: r,
                                immediate: t,
                                reset: s,
                                config: i.animationConfig,
                                from: { scrollPosition: a(u, x.scrollPosition.get()) },
                                onChange: () => {
                                    n && p();
                                },
                            });
                    },
                    [x.scrollPosition, f, i.animationConfig, p],
                ),
                ...
                b = reactExports.useCallback(
                    ...
                    [x.scrollPosition, A, _, l],
                ),
                F = reactExports.useCallback(
                    function () {
                        const e = d.current;
                        e && (g(a(e, x.scrollPosition.goal), { immediate: !0 }), _.trigger('resizeHandled'));
                    },
                    [g, x.scrollPosition.goal, _],
                );
            useRefResizeObserver(m, (e) => {
                const t = e.target;
                if (!(t instanceof HTMLElement)) return;
                const s = r(t);
                E.current.wrapper !== s && F();
            });
            const C = useEvent(function () {
                    const t = d.current;
                    if (!t) return;
                    const s = e(t),
                        u = m.current ? r(m.current) : 0;
                    if (E.current.container !== s || E.current.wrapper !== u) {
                        const e = a(t, x.scrollPosition.goal);
                        (e !== x.scrollPosition.goal && g(e, { immediate: !0 }),
                            (E.current.container = s),
                            (E.current.wrapper = u),
                            _.trigger('recalculateContent'));
                    }
                }),
                D = useSkipFrame$1();
            reactExports.useEffect(() => addEventListener(window, 'resize', () => D.run(F)), [F, D]);
            return reactExports.useMemo(
                () => ({
...
function useScrollBounding(e, [t, s] = IGNORE_DEFAULT) {
    const [u, r] = reactExports.useState(!0),
    ...
    return (
        reactExports.useEffect(() => {
            ...
            return new DisposeBuilder()
                .add(createLayoutReadyInEffect(u))
                .add(e.events.on('resizeHandled', u))
                .add(e.events.on('recalculateContent', u))
                .add(e.events.on('change', u)).dispose;
        }, [e, t, s]),
        [u, n]
    );
}
...
function Thumb(e) {
    const t = reactExports.useRef(null),
        ...
        r = useEvent(function () {
            ...
            return ((s.style[o] = `${e.calculateSize(u, a)}px`), (s.style.display = 'flex'), a);
        }),
        [n, a] = useSpring(() => ({
    ...
    reactExports.useEffect(() => {
        s || e.dragging
            ? a.start({
                  to: e.styles.opened,
                  onRest() {
                      t.current?.classList.add(styles$x.base__active);
                  },
              })
            : a.start({
                  to: e.styles.closed,
                  delay: 500,
                  onRest() {
                      t.current?.classList.remove(styles$x.base__active);
                  },
              });
    ...
    const o = useEvent(function () {
            ...
            if (!(o && s && u && r && n && i)) return;
            const l = e.api.animationScroll.scrollPosition.get(),
                c = Math.min(1, o / i),
                d = i !== o ? clamp(0, 1, l / (i - o)) : 0,
                m = e.calculateSize(s, c),
                E = (('horizontal' === e.direction ? s.offsetWidth : s.offsetHeight) - m) * d || 0,
                _ = Math.round((2 * d - 1) * BOUNCING_OFFSET);
            (u.style.setProperty('--thumbOffset', `${E}px`),
                e.onUpdate?.({ thumbSize: m, thumbOffset: E, newBouncingCorrection: _ }));
            const p = 0 === E || e.isBoundThumb(E) ? 0 : _;
            return (
                a.start({
    ...
    return (
        ...
        jsxRuntimeExports.jsxs(animated.div, {
            ...
            className: clsx(styles$x.base, styles$x[`base__${e.direction}`], e.className),
            style: n,
            onMouseEnter: () => u(!0),
            onMouseLeave: () => u(!1),
            children: [
                jsxRuntimeExports.jsx('div', { className: styles$x.background }),
                jsxRuntimeExports.jsx('div', { className: styles$x.border }),
                jsxRuntimeExports.jsx('div', { className: styles$x.innerBorder }),
                jsxRuntimeExports.jsx('div', { className: styles$x.icon }),
            ],
        })
    );
}
const initBarDraggingState = { pending: !1, offset: 0 };
function useBarDragging(e, t, s, u, r) {
    const [n, a] = reactExports.useState(initBarDraggingState),
        o = useEvent(t),
        i = reactExports.useCallback(
            (t) => {
                (a(t), e.current && o({ type: t.pending ? 'dragStart' : 'dragEnd', dragElement: e.current }));
            },
            [o, e],
        );
    return (
        reactExports.useEffect(() => {
            ...
            const t = mouse.move(function ([t]) {
                    ...
                    const i = u.current,
                        l = e.current;
                    if (!a || !i || !l) return;
                    const c = r(t, n, { parent: i, thumb: l }),
        ...
        }, [s, n.offset, n.pending, o, i, e, u, n, r]),
        i
    );
}
...
function getElementCoordinates(e, t) {
    const s = e.getBoundingClientRect(),
        u = t === scrollOrientations.horizontal ? s.x : s.y;
    return { start: u, end: t === scrollOrientations.horizontal ? u + s.width : u + s.height };
}
function getCoordinate(e, t, s, u, r, n) {
    return {
...
function useBarHandlers(e, t, s, u, r, n, a) {
    const o = useSounds(),
        i = r.stepTimeout || CLAMPED_ARROW_STEP_TIMEOUT_DEFAULT,
        [l, c] = useRepeatCallback((e) => r.applyStepTo(e), i, [r]);
    reactExports.useEffect(
        ...
        E = reactExports.useCallback(
            (i) => {
                const l = e.current,
                    ...
                    E = s.current,
                    _ = u.current;
                if (!(l && c && E && _ && i.button === MOUSE_BUTTON_LEFT)) return;
                const p = getCoordinate(i, l, c, E, _, a),
                    x = p.thumb.start <= p.occurredEvent && p.occurredEvent <= p.thumb.end,
                    f =
                ...
                if (x) n({ pending: !0, offset: p.occurredEvent - p.thumb.start });
                else if (f) {
                    ((p.occurredEvent > p.thumb.start ? Direction.Prev : Direction.Next) === Direction.Next ? d : m)(i);
                } else {
                    const e = p.occurredEvent - p.bar.start,
                        t = p.thumb.end - p.thumb.start,
                        s = p.bar.end - p.bar.start,
                        u = r.getContainerSize();
                    if ('number' != typeof u || Number.isNaN(u)) return console.error('Incorrect container size');
                    const n = ((e - t / 2) / s) * u;
                    r.applyScroll(n);
                }
                o.play('click', { target: 'Scroll:' + (x ? 'thumb' : f ? 'button' : ''), original: i });
            },
            [e, t, s, u, o, a, n, d, m, r],
        ),
...
const rail$1 = 'HorizontalBar_rail_37858d8f',
    ...
    Bar$1 = reactExports.memo(function ({ classNames: e = {}, onDrag: t = noop }) {
        ...
        const m = useEvent(
            ...
            E = useEvent((e) => e - (n.current.offsetWidth - a.current.offsetWidth) >= -0.5),
            _ = reactExports.useCallback(
                (e) => ('dragStart' === e.type ? c(!0) : 'dragEnd' === e.type && c(!1), t(e)),
                [t],
            ),
            p = useBarDragging(a, _, d, n, m),
            x = useEvent(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: s }) => {
                ...
                ((r.style.width = `${t - l + s}px`), (a.style.width = u.offsetWidth - e - t - l - s + 'px'));
            }),
        ...
        return jsxRuntimeExports.jsxs('div', {
            ...
            children: [
                jsxRuntimeExports.jsx('div', {
                    ref: u,
                    className: clsx(styles$w.button, styles$w.button__left, e.leftButton),
                }),
                jsxRuntimeExports.jsxs('div', {
                    ref: n,
                    ...
                    children: [
                        jsxRuntimeExports.jsx('div', {
                            ref: o,
                            className: clsx(styles$w.rail, styles$w.rail__left, e.leftRail),
                        }),
                        ...
                        jsxRuntimeExports.jsx('div', {
                            ref: i,
                            className: clsx(styles$w.rail, styles$w.rail__right, e.rightRail),
                        }),
                    ],
                }),
                jsxRuntimeExports.jsx('div', {
                    ref: r,
                    className: clsx(styles$w.button, styles$w.button__right, e.rightButton),
                }),
            ],
        });
    }),
    ...
    styles$v = { base: base$r, wrapper: wrapper$1, defaultScrollArea: defaultScrollArea },
    DefaultScroll$1 = ({
        children: e,
        className: t,
        barClassNames: s,
        ...
        return jsxRuntimeExports.jsxs('div', {
            ...
            children: [
                jsxRuntimeExports.jsx('div', {
                    className: clsx(styles$v.defaultScrollArea, u),
...
function Area$1({ className: e, classNames: t, children: s }) {
    ...
    return jsxRuntimeExports.jsx('div', {
        className: clsx(styles$v.base, e),
        children: jsxRuntimeExports.jsx('div', {
            className: clsx(styles$v.wrapper, t?.wrapper),
...
function useScrollByDragElements(e, t, s, u) {
    const {
            contentRef: r,
            wrapperRef: n,
            scrollPosition: a,
        ...
        f = useEvent(() => {
            x.run(() => {
                const t = e.contentRef.current,
                    s = e.getWrapperSize(),
                    u = e.getContainerSize();
                t && s && u && !c && (t.style.cursor = u <= s ? 'auto' : 'dragging' === d.type ? 'move' : 'grab');
            });
        });
    return (
        reactExports.useEffect(() => {
        ...
        reactExports.useEffect(() => {
            ...
            const u = mouse.move(([e]) => {
                    const s = getScreenCoordinate(e, t);
                    (void 0 === p || Math.abs(E - s) > p) &&
                        m({ type: 'dragging', positionFrom: s, previousScrollPosition: i.scrollPosition.get() });
                }),
                a = mouse.up(() => m({ type: 'scrollComplete' }));
            return () => {
                (u(), a());
            };
        }, [i.scrollPosition, r, E, t, d, p, n]),
        reactExports.useEffect(() => {
            if ('dragging' !== d.type) return;
            const e = mouse.move(([e, u]) => {
                const l = r.current,
                    c = n.current;
                if ('outside' === u) return void m({ type: 'scrollComplete' });
                const E = getEventCoordinate(e, t);
                if (null === l || null === c || ('inside' === u && E < 0)) return;
                const _ = 'vertical' === t ? c.offsetTop : c.offsetLeft,
                    p = 'inside' === u ? E : E - _,
                    x = d.positionFrom - p,
                    f = d.previousScrollPosition + x;
                a.start({ scrollPosition: o(l, f), from: { scrollPosition: i.scrollPosition.get() }, ...s });
            });
            const u = mouse.up(function () {
                m({ type: 'scrollComplete' });
            });
            return () => {
                (e(), u());
            };
        }, [i.scrollPosition, o, r, d, a, n, s, t]),
        reactExports.useEffect(() => {
        ...
        }, [i.scrollPosition, r, c, t, p]),
        d
    );
}
function Base$7({ settings: e, children: t }) {
    const s = useApi$1({ settings: e }),
        u = reactExports.useMemo(() => ({ api: s }), [s]);
    return jsxRuntimeExports.jsx(Context$2.Provider, { value: u, children: t });
}
...
const DEFAULT_VERTICAL_API_CONFIG = {
    ...
    Bar = reactExports.memo(function ({ classNames: e = {}, onDrag: t = noop }) {
        ...
        useUpdateStatesBar({ baseRef: s, api: d });
        const m = useEvent((e) => e - (n.current.offsetHeight - a.current.offsetHeight) >= -0.5),
            E = useEvent(
            ...
            x = useEvent(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: s }) => {
                ...
                ((r.style.height = `${t - l + s}px`), (a.style.height = u.offsetHeight - e - t - l - s + 'px'));
            }),
            { handleMouseEnter: f, handleMouseDownTrack: h } = useBarHandlers(
                s,
                a,
        ...
        return jsxRuntimeExports.jsxs('div', {
            ...
            children: [
                jsxRuntimeExports.jsx('div', {
                    ref: u,
                    className: clsx(styles$u.button, styles$u.button__top, e.topButton),
                }),
                jsxRuntimeExports.jsxs('div', {
                    ref: n,
                    className: clsx(styles$u.track, e.track),
                    children: [
                        jsxRuntimeExports.jsx('div', {
                            ref: o,
                            className: clsx(styles$u.rail, styles$u.rail__top, e.topRail),
                        }),
                        jsxRuntimeExports.jsx(Thumb, {
                            dragging: l,
                            api: d,
                        ...
                        jsxRuntimeExports.jsx('div', {
                            ref: i,
                            className: clsx(styles$u.rail, styles$u.rail__bottom, e.bottomRail),
                        }),
                    ],
                }),
                jsxRuntimeExports.jsx('div', {
                    ref: r,
                    className: clsx(styles$u.button, styles$u.button__bottom, e.bottomButton),
                }),
            ],
        });
    }),
    ...
    DefaultScroll = ({
        ...
        const { api: o } = useVerticalScroll(),
            i = reactExports.useMemo(() => {
                const e = s || {};
                return { ...e, base: clsx(styles$t.base, e.base) };
            }, [s]);
        return jsxRuntimeExports.jsxs('div', {
            className: clsx(styles$t.defaultScroll, t),
            onWheel: o.handleMouseWheel,
            children: [
                jsxRuntimeExports.jsx('div', {
                    className: clsx(styles$t.area, u),
    ...
    Area = ({ className: e, classNames: t, children: s, ...u }) => {
        ...
        return (
            ...
            jsxRuntimeExports.jsx('div', {
                className: clsx(styles$t.base, t?.wrapper, e),
                ref: r.wrapperRef,
                onWheel: r.handleMouseWheel,
                children: jsxRuntimeExports.jsx('div', {
                    ...u,
                    className: clsx(styles$t.content, t?.content),
                    ref: r.contentRef,
                    children: s,
                }),
            })
...
function MaskArea({ classNames: e, ...t }) {
    const { api: s } = useVerticalScroll(),
        [u, r] = useScrollBounding(s);
    return jsxRuntimeExports.jsx(Area, {
        ...t,
        classNames: { ...e, content: clsx(styles$t[`content__${getMaskDirection(u, r)}`], e?.content) },
    });
}
...
function parse(e, t) {
    ...
    for (let i = 0; i < e.length; i++) {
        ...
        if (l === t.start[0] && e.slice(i, i + t.start.length) === t.start) {
            if (r) {
                if (u.length > 0) {
                    u[u.length - 1].node.children.push({ type: NodeTypes.Text, value: r });
            ...
            if (e.startsWith('@')) {
                const t = e.slice(1).trim(),
                    r = { type: NodeTypes.Tag, attrs: t.split('|'), instanceId: ++o, children: [] };
                if (u.length > 0) {
                    u[u.length - 1].node.children.push(r);
                } else s.push(r);
                u.push({ node: r, startIndex: s.length });
...
const COLORS =
    ...
    styles$s = { COLORS: COLORS, base: base$p, base__fullSize: base__fullSize, nowrap: nowrap },
    legacyColors = new Set(styles$s.COLORS?.split(', ') ?? []);
let keyId = 0;
function takeKey() {
    return ++keyId;
}
    ...
    for (let s = 0; s < e.length; s++) {
        ...
        (t.push(
            jsxRuntimeExports.jsxs(
                ...
                {
                    children: [
                        jsxRuntimeExports.jsxs('span', { className: styles$s.nowrap, children: [split(u), r[0]] }),
                        n,
                    ],
                },
                takeKey(),
    ...
    return jsxRuntimeExports.jsx(
        'span',
        {
            style: t.reduce((s, u) => {
                ...
                return (console.warn(`Invalid argument ${u} in ${e}: ${t}`), s);
            }, {}),
            children: e,
        },
        takeKey(),
...
function applyFunction(e, t, s, u) {
    const r = s.map((t) => {
            if ('string' != typeof t) return t;
            const s = t.trim();
            if (s.startsWith('(') && s.endsWith(')')) {
                const [t, ...r] = s.slice(1, -1).split(' ');
                return t ? applyFunction(e, t, r, u) : e;
            }
...
function applyFunctions(e, t, s) {
    return e.reduce((e, t) => {
        const [u, ...r] = parseArguments(t.trim());
        return u ? applyFunction(e, u, r, s) : e;
    }, t);
}
function isEnd(e) {
...
function resolveAttrsParams(e, t) {
    const s = [];
    for (let u = 0; u < e.length; u++) s[u] = resolveAttrParams(e[u], t);
    return s;
}
const primitives = ['number', 'string', 'undefined'];
function render(e, t, s = {}, u = !0) {
    u && (keyId = 0);
    const r = [];
    function n(e) {
    ...
    for (const a of e)
        if (a.type === NodeTypes.Text) n(a.value);
            ...
            const e = render(a.children, t, s, !1),
                u = applyFunctions(resolveAttrsParams(a.attrs, s), e, t);
            r.push(u);
        }
    return r;
}
...
const defaultBrackets = { start: '{{', end: '}}' },
    FormatText$1 = reactExports.memo(function (e) {
        const {
            ...
            E = reactExports.useMemo(() => render(m, d, e.params), [m, d, e.params]),
            _ = clsx(styles$s.base, n && styles$s.base__fullSize, l.className);
        return e.inline
            ? (console.warn(
            ...
            : jsxRuntimeExports.jsx('span', { ...l, className: _, children: E });
    });
...
reactExports.forwardRef(function (e, t) {
    ...
    const { repeat: s, fit: u, position: r, width: n, height: a, unknownStyle: o, unselectable: i, ...l } = e;
    return jsxRuntimeExports.jsx('div', {
        ...l,
        ref: t,
        style: {
...
withResolvePath(
    reactExports.forwardRef(function (e, t) {
        ...
        return e.unknown
            ...
            : jsxRuntimeExports.jsx('img', { ...i, ref: t, src: r, width: s, height: u });
    }),
);
const themes = { primary: 'primary', secondary: 'secondary', custom: 'custom' },
    ...
    HeadlessButtonBase = defineStyledComponent('Button', { element: 'button', className: styles$r.base }),
    HeadlessButton = reactExports.forwardRef(function (
        { children: e, onClick: t, onMouseEnter: s, soundTarget: u, disabled: r = !1, silent: n = !1, ...a },
        o,
    ) {
        const i = useSounds();
        return jsxRuntimeExports.jsx(HeadlessButtonBase, {
            ...
            ref: o,
            onMouseEnter: function (e) {
                (r || n || i.play('mouse-enter', { target: u || 'Button', original: e }), s?.(e));
            },
            onClick: function (e) {
                r || (n || i.play('click', { target: u || 'Button', original: e }), t?.(e));
            },
            children: e,
        });
    }),
    ...
    Button = reactExports.forwardRef(function (
        ...
        return jsxRuntimeExports.jsxs(HeadlessButton, {
            ...
            className: clsx(
                styles$q.base,
                styles$q[`base__size-${t}`],
                styles$q[`base__theme-${s}`],
                u ? styles$q.base__disabled : styles$q.base__enabled,
                o,
                a?.base,
            ),
            onClick: function (e) {
            ...
            children: [
                jsxRuntimeExports.jsx('div', { className: clsx(styles$q.background, a?.background) }),
                jsxRuntimeExports.jsx('div', { className: clsx(styles$q.border, a?.border) }),
                jsxRuntimeExports.jsx('div', { className: clsx(styles$q.overlay, a?.overlay) }),
                jsxRuntimeExports.jsx('div', {
                    className: clsx(styles$q.content, n && styles$q.content__fontAligned, a?.content),
                    children: e,
                }),
            ],
        });
...
const multiValueTypes = [
    ...
    getDogTypeImage = (e, t, s) => {
        ...
        if (u) {
            const r = R.images.gui.maps.icons.dogtags.$dyn(t).$dyn(u),
                n = r.$dyn(s);
            return !n && DOG_TAG_DEFAULT_ICON_NAME[e] ? `${r.$dyn(DOG_TAG_DEFAULT_ICON_NAME[e])}` : `${n}`;
        }
        return (
    ...
    getRewardImage = (e, t = ImageSize.Small) => {
        const { name: s, type: u, value: r, icon: n, item: a, dogTagType: o } = e,
            i = t === ImageSize.S24x24 ? ImageSize.Small : t,
            l = getSizeFolder(i);
        switch (s) {
            case 'basic':
            case 'plus':
                return `R.images.gui.maps.icons.quests.bonuses.${i}.${u}_${r}`;
            case 'premium':
            case 'premium_plus':
                return `R.images.gui.maps.icons.quests.bonuses.${i}.${s}_${r}`;
            case 'items':
                return `R.images.gui.maps.icons.quests.bonuses.${i}.${a}`;
            case 'blueprints':
            case 'blueprintsAny':
            case 'finalBlueprints':
                return `R.images.gui.maps.icons.blueprints.fragment.${i}.${n}`;
            case 'tokens':
            case 'lootBox':
            case 'battleToken':
            ...
            case 'battlePassSelectToken':
                return `R.images.gui.maps.icons.quests.bonuses.${i}.${n}`;
            case 'crewBooks':
                return `R.images.gui.maps.icons.crewBooks.books.${i}.${n}`;
            case 'dogTagComponents':
                return getDogTypeImage(o, i, n);
            case 'dossier_badge':
    ...
    base$m = 'NotificationWrapper_6fe65b7',
    ...
    NotificationWrapper = ({ children: e, ref: t, className: s }) => {
        const u = reactExports.useRef(null),
            r = NOTIFICATION_WIDTH * getScale$2(),
            n = NOTIFICATION_MAX_HEIGHT * getScale$2();
        return (
            useMount(() => {
                resize$1(r, NOTIFICATION_MIN_HEIGHT);
            }),
            useLayoutReady(() => {
                if (!u.current) return;
                const e = u.current.scrollHeight;
                e > n ? (console.warn(`maximum height exceeded ${e}`), resize$1(r, n)) : resize$1(r, e);
            }, []),
            jsxRuntimeExports.jsx('div', {
...
const base$l = 'MultilineOverflow_ec9f8e47',
    content$2 = 'MultilineOverflow_content_b539970d',
    styles$o = { base: base$l, content: content$2 };
...
const MultilineOverflow$1 = reactExports.forwardRef(function (
    {
        text: e,
        brackets: t,
        params: s,
    ...
    reactExports.useEffect(() => {
        ...
        function r() {
            ...
            (u.remove(),
                (u.className = clsx(styles$o.content, t.children[0].className)),
                (u.innerHTML = ''),
            ...
            if (n === r) b(!1);
                ...
                b(!0);
                const r = relativeOffset(t.getBoundingClientRect(), e.getBoundingClientRect());
                for (u.style.visibility = '', u.style.left = `${r.x}px`, u.style.top = `${r.y}px`; n >= 0; n--) {
                ...
                for (let t = 0; t <= n; t++) {
                    ...
                    const r = cloneNode(s);
                    r ? u.appendChild(r) : console.warn('Unexpected type of target node', s);
                }
                const a = s.cloneNode(!0);
                (a.removeAttribute('style'), u.appendChild(a), t.appendChild(u));
            }
        }
    ...
    const F = isSerializableParams(s),
        C = useParamTooltip(
            'format_text',
            reactExports.useMemo(
                () => ({
    ...
    return jsxRuntimeExports.jsxs('div', {
        ...x,
        onMouseEnter: function (e) {
            (a?.(e), A && !l && D.onMouseEnter(e));
        },
        onClick: function (e) {
            (i?.(e), l || D.onClick());
        },
        onMouseLeave: function (e) {
            (o?.(e), l || D.onMouseLeave());
        },
        ref: assignRefs([f, h]),
        className: clsx(styles$o.base, d, m?.base),
        style: { ...E, ..._ },
        children: [
            jsxRuntimeExports.jsx(FormatText$1, {
                ...
                formatters: u,
                className: m?.text,
                style: { ...p, visibility: A ? 'hidden' : void 0 },
            }),
            jsxRuntimeExports.jsx('div', {
                ref: g,
...
function ExtendedText(e) {
    ...
    const t = e.isTruncationAvailable || e.truncateIdentify ? MultilineOverflow$1 : FormatTextSplited;
...
const formats = { superCompact: 'superCompact', compact: 'compact', default: 'default', detailed: 'detailed' },
    sizes$4 = { x16x16: 'x16x16', x24x24: 'x24x24', x32x32: 'x32x32', x48x48: 'x48x48', x80x80: 'x80x80' },
...
function defaultFormatter(e, t) {
    ...
    const u = e.length - 1,
        r = FORMAT_PARTS[t],
        n = { separator: !1, items: [] };
    for (; s < u && !(Number(e[s]) > 0); ++s);
    return (
        r[s] === MINUTES_FORMAT && 0 === Number(e[s])
            ? (n.items = [LOCALE_FORMATTERS[MINUTES_FORMAT]?.(DEFAULT_MIN_VALUE)])
            : (n.items = [s, s + 1].map((t) => LOCALE_FORMATTERS[r[t]]?.(e[t]))),
        n
    );
}
function compactFormatter(e, t) {
    const s = e.length,
        u = FORMAT_PARTS[t],
        r = { separator: !1, items: [] };
    for (let n = 0; n < s; ++n) if (Number(e[n]) > 0) return ((r.items = [LOCALE_FORMATTERS[u[n]]?.(e[n])]), r);
...
const formatValue = (e, t) => FORMATTER[t]?.(format$2(e, FORMAT_PARTS[t]), t),
    base$k = 'Timer_dac0a0aa',
    icon$7 = 'Timer_icon_a61415df',
...
function Timer({
    ...
    limit: t = 0,
    tick: s = 1,
    size: u = sizes$4.x24x24,
    type: r = types$2.accent,
    ...
    return jsxRuntimeExports.jsxs('div', {
        className: cx(styles$m.base, o),
        children: [
            jsxRuntimeExports.jsx('div', {
                className: cx(styles$m.icon, styles$m[`icon__${u}`], styles$m[`icon__${r}`], i?.icon),
            }),
            n !== formats.superCompact &&
                jsxRuntimeExports.jsx('div', {
                    className: cx(styles$m.label, styles$m[`label__${u}`], styles$m[`label__${r}`], i?.label),
                    children: jsxRuntimeExports.jsx(FormattedValue, { size: u, preFormatted: formatValue(l, n) }),
                }),
        ],
    });
}
((Timer.format = formats), (Timer.size = sizes$4), (Timer.type = types$2));
const base$j = 'Tooltip_6d997cee',
    decorator = 'Tooltip_decorator_b3486d4e',
    styles$l = { base: base$j, decorator: decorator },
    Base$5 = defineStyledComponent('Base', styles$l.base),
    Decorator = defineStyledComponent('Decorator', styles$l.decorator),
    Tooltip$1 = reactExports.forwardRef(function ({ children: e, ...t }, s) {
        const u = reactExports.useRef(null);
        return (
            useRefResizeObserver(u, (e) => {
                const t = e.target;
                if (!(t instanceof HTMLElement)) return;
            ...
            jsxRuntimeExports.jsx(Base$5, {
                ...t,
                ref: function (e) {
                    ((u.current = e), 'function' == typeof s ? s(e) : s && (s.current = e));
                },
                children: e,
            })
        );
...
const getFromCallStack = (e = 1) => {
    ...
    return (
        t &&
            ...
            window.__feature && window.__feature !== s && window.subViews[s] && (u = window.subViews[s].id)),
        { callerUrl: r, caller: s, stack: t, resId: u }
    );
};
let ClickOutsideManager$1 = class e {
    ...
    unregister(e, t) {
        const s = e,
            u = t;
        ((this.entries = this.entries.filter(({ container: e, callback: t }) => e !== s || t !== u)),
                ...
                (t[s] = (function (t) {
                    return (s) => {
                        ...
                        return (
                            ...
                            u(),
                            () => {
                                r && (a(), window.removeEventListener(n, o), (e.listeners -= 1), u(), (r = !1));
                            }
                        );
                    };
                })(s)),
...
const children = Object.freeze(
    ...
    sendViewEvent = (e, t) => {
        ...
        if (void 0 !== t) {
            const { args: u, ...r } = t;
            return void 0 !== u
                ? viewEnv.handleViewEvent({ __Type: s, type: e, ...r, arguments: createViewEventArguments$1(u) })
                : viewEnv.handleViewEvent({ __Type: s, type: e, ...r });
        }
        return viewEnv.handleViewEvent({ __Type: s, type: e });
    },
...
function getBrowserTexturePath(e, t, s, u = 1) {
    return viewEnv.getWebBrowserTexturePath(e, t, s, u);
}
...
class DataTracker {
    ...
    addCallback(e, t, s = 0, u = !0) {
        void 0 === this._updateHandler &&
            (this._updateHandler = engine.on('viewEnv.onDataChanged', this._emmitDataChanged, this));
        const r = env.view.addModelObserver(e, s, u);
        return (
            r > 0
                ? ((this._callbacks[r] = t),
...
function dumpViewModel(e) {
    ...
    for (const s in e)
        if (Object.prototype.hasOwnProperty.call(e, s)) {
            const u = Object.prototype.toString.call(e[s]);
            if (u.startsWith('[object CoherentArrayProxy]')) {
                const u = e[s];
                t[s] = [];
                for (let e = 0; e < u.length; e++) t[s].push({ value: dumpViewModel(u[e].value) });
            } else u.startsWith('[object class BW::WULF::ViewModel') ? (t[s] = dumpViewModel(e[s])) : (t[s] = e[s]);
        }
    return t;
}
const SystemLocale = {
...
const makeGlobalBoundingBox = (e) => ({ __Type: 'GFBoundingBox', x: e.x, y: e.y, width: e.width, height: e.height }),
    ...
    handleViewEvent$1 = (e, t) => {
        ...
        if (void 0 !== t) {
            const { args: u, ...r } = t;
            void 0 !== u
                ? viewEnv.handleViewEvent({ __Type: s, type: e, ...r, arguments: createViewEventArguments(u) })
                : viewEnv.handleViewEvent({ __Type: s, type: e, ...r });
    ...
    sendShowPopOverEvent = (e, t, s, u, r = R.invalid('resId'), n) => {
...
const handleViewEvent = (e, t, s = {}, u = 0) => {
    ...
    Tooltip = ({
            ...
            g = reactExports.useCallback((e) => {
                p.current.isVisible &&
                    ...
                    (p.current.hideTimerId = window.setTimeout(() => {
                        ...
                        t && !t.isSameNode(p.current.prevTarget) && h();
                    }, 200)));
            }, []);
        (reactExports.useEffect(() => {
        ...
        return c
            ? reactExports.cloneElement(e, {
                  onMouseEnter:
                      ((A = e.props.onMouseEnter),
                      (e) => {
                          (e.clientX === window.innerWidth && e.clientY === window.innerHeight) ||
                              (clearTimeout(p.current.timeoutId),
                              (p.current.timeoutId = window.setTimeout(f, o ? SHOW_DELAY_MIN : SHOW_DELAY_DEFAULT)),
                              u && u(e),
                              A && A(e));
                      }),
                  onMouseLeave: ((e) => (t) => {
    ...
    SimpleTooltip = ({ children: e, body: t, header: s, note: u, alert: r, args: n, ...a }) => {
        const o = reactExports.useMemo(() => {
            const e = { ...n, body: t, header: s, note: u, alert: r };
...
const convertNbsp = (e) => e.replace(/&nbsp;/g, ' '),
    ...
    splitEuropean = (e, t = 0) => {
        ...
        const u = new RegExp(
            ...
            r = convertNbsp(e);
        return (splitAndFormat(r, /( )/, t).forEach((e) => (s = s.concat(splitAndFormat(e, u, 0)))), s);
    },
    splitChinese = (() => {
        const e = new RegExp(
            [
    ...
    getTextWidth = (e, t, s) => {
        ...
        if (!u) return 0;
        u.font = makeCanvasFont(t);
        return u.measureText(e).width;
    },
    getElementWidth = (e) => e.getBoundingClientRect().width,
    getElementHeight = (e) => e.getBoundingClientRect().height,
    calculateFitLength = (e) => {
        if (e.start >= e.end - 1) return e.start;
        const t = Math.floor((e.start + e.end) / 2),
            s = e.words.slice(0, t).join(' '),
            u = Math.ceil(getTextWidth(s, e.element, e.canvas) / getElementWidth(e.element));
        return calculateFitLength(u <= 1 ? { ...e, start: t } : { ...e, end: t });
    },
    base$i = 'Multilineoverflow_c23f658d',
    ...
    MultilineOverflow = reactExports.forwardRef(function (
        { text: e, lines: t, className: s, classNames: u, onChange: r, alignment: n = Alignment$1.left, ...a },
        o,
    ) {
        const i = reactExports.useRef(null),
            l = reactExports.useRef(null),
            [c, d] = reactExports.useState(!1),
            [m, E] = reactExports.useState([]),
            [_, p] = reactExports.useState(0),
            x = useSkipFrame(),
            f = reactExports.useMemo(() => document.createElement('canvas'), []),
            h = reactExports.useCallback(() => (l.current ? getElementHeight(l.current) : 0), []),
            g = reactExports.useCallback(
                (e) => {
                    const t = h();
            ...
            A = reactExports.useCallback(() => {
                if (g(i.current) <= t) return d(!1);
                d(!0);
                const s = splitWords(e, n) || [],
                    u = Array.from(new Array(t)).reduce((e, u, r) => {
                        if (!i.current) return e;
                        const n = e.reduce((e, t) => e + t.length, 0),
                            a = s.slice(n);
                        if (r === t - 1) return (e.push(a), e);
                        const o = calculateFitLength({
                            start: 0,
                            end: a.length,
                            words: a,
                            element: i.current,
        ...
        return (
            ...
            jsxRuntimeExports.jsxs('div', {
                ...a,
                ref: o,
                className: cx(styles$k.base, s, c && styles$k.base__truncated),
                children: [
                    jsxRuntimeExports.jsx('div', {
                        ref: i,
                        className: styles$k.text,
                        style: { maxHeight: `${_}rem` },
                        children: e,
                    }),
                    jsxRuntimeExports.jsx('div', {
                        className: styles$k.truncatedContent,
                        children: m.map((e, t) =>
                            jsxRuntimeExports.jsx(
                                'div',
                                { className: cx(styles$k.line, u?.line), children: e.join(' ') },
                                t,
                            ),
                        ),
                    }),
                    jsxRuntimeExports.jsx('div', {
                        ref: l,
                        className: styles$k.singleLine,
                        children: R.strings.common.common.dot(),
                    }),
                ],
            })
        );
    }),
    MultilineOverflowWithTooltip = reactExports.forwardRef(function (e, t) {
        const [s, u] = reactExports.useState(!1);
        return jsxRuntimeExports.jsx(SimpleTooltip, {
            isEnabled: s,
            body: e.text,
            children: jsxRuntimeExports.jsx(MultilineOverflow, { ...e, ref: t, onChange: u }),
        });
    }),
    base$h = 'Formattext_bb80854d',
    styles$j = { base: base$h },
    FormatText = ({
        binding: e,
        text: t = '',
        classMix: s,
        alignment: u = Alignment$1.left,
                ...
                .map((t, r) =>
                    jsxRuntimeExports.jsx(
                        'div',
                        {
                            ...
                            children: formatString(t, u, e).map((e, t) =>
...
(sizes$3.extraSmall, sizes$3.small, sizes$3.medium, sizes$3.large, sizes$3.extraLarge, sizes$3.xxl);
const base$g = 'Currency_72d4be39',
    ...
    Base$4 = defineStyledComponent('Currency', styles$i.base, {
...
function Currency({
    ...
    classNames: u,
    imagePath: r,
    size: n = sizes$3.small,
    enough: a = !0,
    ...o
}) {
    const i = imageSizes[n],
        l = `${t}_${i}x${i}`,
        c = upscaledImageSizes[n],
        d = `${t}_${c}x${c}`,
        m = r || currencyTypes.includes(t),
        E = useUpscale(`library.currency.${l}`, `library.currency.${d}`);
    return jsxRuntimeExports.jsxs(Base$4, {
        ...o,
        className: clsx(u?.base, a ? styles$i[`base__${t}`] : styles$i.base__notEnough, s),
        children: [
            m && jsxRuntimeExports.jsx(Image, { width: i, height: i, path: r ?? E, className: u?.icon }),
            formatCurrencyValue(e, t),
        ],
    });
}
((Currency.sizes = sizes$3), (Currency.types = types$1));
const base__s24x24 = 'Reward_base__s24x24_954b5cee',
    ...
    Reward = ({
        ...
        const _ = SIZE_MAP.has(r) ? SIZE_MAP.get(r) : r,
            p = getBottomHighlight(r, n),
            x = getOverlay(n),
            f = getFormattedValue(a, o),
            h = useTooltip({
            ...
            g = useSimpleTooltip({ header: E?.header, body: E?.body });
        return jsxRuntimeExports.jsxs('div', {
            className: cx(styles$h.base, styles$h[`base__${r}`], !u && styles$h.base__dynamicBox, c),
            style: l,
            ...h,
            children: [
                jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                    children: [
                        jsxRuntimeExports.jsxs('div', {
                            className: cx(
                                styles$h.image,
                                u ? styles$h.image__fixedBox : styles$h[`image__${r}`],
                                d?.image,
                            ),
                            children: [
                                p &&
                                    jsxRuntimeExports.jsx('div', {
                                        className: cx(styles$h.highlight, d?.highlight),
                                        style: {
                                            backgroundImage: `url(${images.readOrEmpty(`quests.bonuses.${_}.${p}_highlight`)})`,
                                        },
                                    }),
                                t &&
                                    jsxRuntimeExports.jsx('div', {
                                        className: cx(styles$h.icon, d?.rewardIcon),
                                        style: { backgroundImage: `url(${t})` },
                                    }),
                                x &&
                                    jsxRuntimeExports.jsx('div', {
                                        className: cx(styles$h.overlay, d?.overlay),
                                        style: {
                                            backgroundImage: `url(${images.readOrEmpty(`quests.bonuses.${_}.${x}_overlay`)})`,
                                        },
                                    }),
                            ],
                        }),
                        f &&
                            jsxRuntimeExports.jsx('div', {
                                className: cx(
                                    styles$h.info,
                                    styles$h[`info__${e}`],
                                    o === ValueTypes.MULTI && styles$h.info__multi,
                                    d?.info,
                                ),
                                children: f,
                            }),
                        i && jsxRuntimeExports.jsx('div', { className: styles$h.title, children: i }),
                    ],
                }),
                s && jsxRuntimeExports.jsx('div', { className: cx(styles$h.timer, d?.periodicIcon), ...g }),
            ],
        });
    },
...
const base$e = 'RewardsList_b956755b',
    ...
    Rewards = reactExports.memo(function ({
        ...
        return jsxRuntimeExports.jsx('div', {
            className: cx(styles$g.base, u && styles$g.base__vertical, n),
            children:
                void 0 !== E
                    ? jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                          children: [
                              e
                                  ...
                                  .map((e, r) =>
                                      jsxRuntimeExports.jsx(
                                          'div',
                                          {
                                              className: cx(styles$g.reward, u && styles$g.reward__vertical, a),
...
const fill = 'Filled_fill_32930ca9',
    ...
    Filled = reactExports.forwardRef(function ({ className: e, classNames: t, ...s }, u) {
...
function ProgressBarProvider(e) {
    const [t, s] = reactExports.useState(Math.min(e.value, e.maxValue)),
        [u, r] = reactExports.useState(e.maxValue),
        n = usePrevious(t),
        a = usePrevious(u),
    ...
    const d = reactExports.useMemo(
        ...
        [t, u, o, r, c, e.size, e.animationEnabled],
    );
...
const background = 'ProgressBar_background_b40cdfdf',
    ...
    Base$3 = defineStyledComponent('ProgressBar', styles$e.base, {
        variants: { size: { small: styles$e.base__small, medium: styles$e.base__medium, full: styles$e.base__full } },
    });
    ...
    return jsxRuntimeExports.jsx(ProgressBarProvider, {
        ...
        children: jsxRuntimeExports.jsxs(Base$3, {
            ...
            children: [
                ...
                jsxRuntimeExports.jsx('div', { className: clsx(styles$e.backgroundPattern, s?.backgroundPattern) }),
                jsxRuntimeExports.jsx(Filled, { className: u, classNames: r }),
                n.children,
            ],
        }),
    });
...
const delta = 'Delta_5c8185db',
    ...
    styles$d = { delta: delta, delta__increase: delta__increase, glow: glow },
    Delta = reactExports.memo(
        reactExports.forwardRef(function (
            { initValue: e, initMaxValue: t, animationEnabled: s = !0, animationProps: u, classNames: r, ...n },
            a,
        ) {
            ...
            return (
                reactExports.useEffect(() => {
                    const e = o.current,
                        t = i.current;
                    if (!e || !d || !t) return;
                    const r = l.percentage - d.percentage;
                    if (
                        ((e.style.left = 100 * Math.max(0, l.percentage - Math.max(0, r)) + '%'),
                        (e.style.width = 100 * Math.abs(r) + '%'),
                        e.classList.toggle(styles$d.delta__increase, r > 0),
                        (t.style.width = '100%'),
                        s && 0 != r)
                    ) {
                        const e = new Controller({
                            ...u,
                            from: { ...u?.from, width: 100 },
                            to: { ...u?.to, width: 0 },
                            onChange: (e, ...s) => {
                                ((t.style.width = `${e.value.width}%`),
                                    'function' == typeof u?.onChange && u?.onChange?.(e, ...s));
                            },
                        });
                        return (
                            e.start(),
                ...
                jsxRuntimeExports.jsxs('div', {
                    ...n,
                    ref: assignRefs([a, o]),
                    className: clsx(n.className, styles$d.delta),
                    children: [
                        d && jsxRuntimeExports.jsx('div', { className: clsx(styles$d.glow, r?.glow), ref: i }),
                        n.children,
                    ],
                })
            );
...
function CardContextProvider({ selected: e, hover: t, disabled: s, multiple: u, status: r, children: n }) {
    const a = reactExports.useMemo(
        () => ({ selected: e, hover: t, disabled: s, multiple: u, status: r }),
        [s, t, u, e, r],
    );
    return jsxRuntimeExports.jsx(CardContext.Provider, { value: a, children: n });
}
...
const CardsWrapperContextProvider = CardsWrapperContext.Provider,
    ...
    Base$2 = defineStyledComponent('Content', styles$c.base, {
        variants: {
    ...
    MainContainer = ({ children: e, classNames: t }) => {
        ...
        return (
                    ...
                    return createLayoutReadyInEffect(() => {
                        if (s.current) {
                            const e = s.current.getBoundingClientRect(),
                                ...
                                u = Math.round((MULTIPLE_CORNER_SIZE / e.height) * 100);
                            (s.current.style.setProperty('--corner-width', `${t}%`),
                                s.current.style.setProperty('--corner-height', `${u}%`));
                        }
                    });
            }),
            jsxRuntimeExports.jsxs(Base$2, {
                ...
                disabled: u.disabled,
                children: [
                    u.multiple && jsxRuntimeExports.jsx('div', { className: styles$c.multipleCorner }),
                    jsxRuntimeExports.jsxs('div', {
                        ref: s,
                        className: clsx(styles$c.content, t?.mainContainerContent),
                        children: [
                            u.disabled && jsxRuntimeExports.jsx('div', { className: styles$c.disabledOverlay }),
                            e,
                        ],
                    }),
                ],
...
defineStyledComponent('Status', styles$b.base, {
    variants: { status: { done: styles$b.base__done, alert: styles$b.base__alert, locked: styles$b.base__locked } },
});
const SMALL_SIZE_BREAKPOINT = 100,
    tooltipEnabled = ({ header: e, body: t }) => Boolean(e && t),
    Status = ({ reason: e, classNames: t }) => {
        const s = reactExports.useRef(null),
            [u, r] = React.useState(!1),
            n = `base__${useCardContext().status}${u ? 'Small' : ''}`,
            a = React.useCallback(() => {
                const e = s.current?.getBoundingClientRect();
        ...
        return jsxRuntimeExports.jsxs('div', {
            className: clsx(styles$b.base, styles$b[n], t?.wrapper),
            ref: s,
            children: [
                ...
                jsxRuntimeExports.jsx('div', { ...(tooltipEnabled(o) && i), className: clsx(styles$b.icon, t?.icon) }),
            ],
        });
    },
    ...
    Card = reactExports.forwardRef(function (
        ...
        const [E, _] = reactExports.useState(!1),
            p = useSounds(),
            ...
            children: jsxRuntimeExports.jsxs(CardContextProvider, {
                ...
                children: [
                    jsxRuntimeExports.jsx('div', {
                        ...
                        onClick: function (e) {
                            f || p.play('click', { target: o || 'react-ui:card', original: e });
                        },
                        onMouseEnter: function (e) {
                            f || p.play('mouse-enter', { target: o || 'react-ui:card', original: e });
                        },
                    ...
                    s && jsxRuntimeExports.jsx(Status, { reason: u, classNames: c?.status }),
                ],
            }),
        });
    }),
...
function getRectangleEdges(e) {
    let { x: t, y: s, width: u, height: r } = e;
    const n = Point(t, s),
        a = Point(t + u, s),
        o = Point(t + u, s + r),
        i = Point(t, s + r);
...
function buildContourPath(e) {
    ...
    for (e.splice(0, 1); e.length > 0;) {
        ...
        const s = e[t],
            l = r;
        (r.x <= a.x ? (i = PADDING) : (i === PADDING && (n.y -= 2 * PADDING), (i = -PADDING)),
            r.y >= a.y ? (o = PADDING) : (o === PADDING && (n.x -= 2 * PADDING), (o = -PADDING)),
            (r = { x: r.x + o, y: r.y + i }),
            u.push(r),
            (a = l),
            (n = r),
    ...
    return (i === PADDING && o === PADDING && (n = { ...n, x: n.x - 2 * PADDING }), u.push(s), u);
}
...
class LinesOptimizer {
    ...
    addLine(e, t, s, u, r) {
        ...
        const a = { x: e - this.containerRect.x, y: t - this.containerRect.y, width: s, height: u, className: r };
        this.lines.get(n)?.push(a);
    }
    run() {
        const e = [];
        return (
            this.lines.forEach((t, s) => {
                const u = s.at(0) === HORIZONTAL,
                    r = t.sort((e, t) => (u ? e.x - t.x : e.y - t.y));
                let n = null;
                (r.forEach((t) => {
                    if (n)
                        if (u) {
                            const s = n.x + n.width,
                                u = t.x + t.width;
                            t.x >= n.x && t.x <= s ? (n = { ...n, width: Math.max(u, s) - n.x }) : (e.push(n), (n = t));
                        } else {
                            const s = n.y + n.height,
                                u = t.y + t.height;
                            t.y >= n.y && t.y <= s
                                ? (n = { ...n, height: Math.max(u, s) - n.y })
                                : (e.push(n), (n = t));
                        }
                    else n = t;
                }),
...
function buildLines(e, t, s) {
    ...
    for (let n = 0; n < e.length; n++) {
        ...
        (s !== borderTypes.none && u.push({ x: a.x, y: a.y, width: a.width, height: a.height }),
            r.addLine(a.x, a.y, a.width, LINE_THICKNESS, styles$a.lineInner),
            r.addLine(a.x, a.y + a.height, a.width, LINE_THICKNESS, styles$a.lineInner),
            r.addLine(a.x, a.y, LINE_THICKNESS, a.height, styles$a.lineInner),
            r.addLine(a.x + a.width, a.y, LINE_THICKNESS, a.height + OFFSET, styles$a.lineInner));
    }
    if (s !== borderTypes.none) {
        const e = buildContour(u);
        let t = null;
        e.forEach((e) => {
            if (t) {
                const s = t.y === e.y,
                ...
                r.addLine(
                    Math.min(u.x, n.x),
                    Math.min(u.y, n.y),
                    s ? Math.abs(n.x - u.x) : LINE_THICKNESS,
                    s ? LINE_THICKNESS : Math.abs(n.y - u.y) + OFFSET,
                    styles$a.lineOuter,
                );
            }
            t = e;
...
const Lines = reactExports.memo(({ containerRef: e, generation: t, border: s, cardSelector: u }) => {
        const [r, n] = reactExports.useState([]),
            a = useEvent(() => {
                const t = e.current;
                if (!t) return;
                const r = t.getBoundingClientRect(),
                    a = buildLines(t.querySelectorAll(`.${u || cardStyles.card}`), r, s);
                n(a ?? []);
            });
        return (
    ...
    Base = defineStyledComponent('CardsWrapper', styles$9.base),
    CardsWrapper = reactExports.forwardRef(function (
        {
            children: e,
            className: t,
            threshold: s,
            border: u = borderTypes.contour,
            enabled: r = !0,
            cardSelector: n,
            ...a
        },
            ...
            (e) => {
                ...
                if (s.length > 0) {
                    const u = t.getBoundingClientRect(),
                        r = s.length;
                    r !== i.current.length && (i.current = Array.from(s));
                    const n = `${Math.round(u.width)}x${Math.round(u.height)}-${r}|${e}`;
                    d(n);
                } else d('');
            },
            [n],
        ...
        const E = reactExports.useMemo(() => ({ recalculate: m, enabled: r }), [m, r]);
        return jsxRuntimeExports.jsx(Base, {
            ...
            children: jsxRuntimeExports.jsxs('div', {
                className: t,
                children: [
                    jsxRuntimeExports.jsx(CardsWrapperContextProvider, { value: E, children: e }),
    ...
    CardSingle = reactExports.forwardRef(({ className: e, classNames: t, ...s }, u) =>
        jsxRuntimeExports.jsxs('div', {
...
const VideoForwarded = reactExports.forwardRef(function (
        ...
        return (
                ...
                return events$1.onDisplayChanged((t, s) => {
                    ...
                    u &&
                        (s === displayStatus$1.hidden
                            ? ((e = u.paused), u.pause())
                            : e || s !== displayStatus$1.shown || u.play());
                });
            }),
            useMount(() => {
                let e = !1;
            ...
            reactExports.useEffect(
                () =>
                    createLayoutReadyInEffect(() => {
                        const e = d.current;
                        if (!c || !e || !n) return void (e?.cohFastSeek && (e.cohFastSeek = !1));
            ...
            reactExports.useEffect(() => {
                if (c && d.current) {
                    const e = { changeTimeHandlers: [], changeKeyframeHandlers: [], changeTimeLoop: noop },
                        t = () => {
                            let t = 0;
                            const [s, u] = createLoop(() => {
                                if (d.current) {
                                    const { currentTime: s, duration: u } = d.current;
                                    if (
                                        (t !== s &&
                                            (e.changeTimeHandlers.forEach((e) => e({ currentTime: s, duration: u })),
                                            (t = s)),
                                        d.current.paused || !c || !n)
                                    )
                                        return;
                                    ...
                                    r.forEach((t, u) => {
                                        void 0 !== r[u] &&
                                            ...
                                            e.changeKeyframeHandlers.forEach((e) => {
                                                const s = Object.keys(a ?? {})[u];
                                                return e({
                                                    time: t,
                                                    name: `${a ? s : `${DEFAULT_NAME_KEYFRAME}_${u}`}`,
                                                });
                                            });
                                    });
                                }
                    ...
                    const s = (t) => (
                        ...
                        _ = () => (d.current?.cohGetKeyframeTimestamps ? d.current.cohGetKeyframeTimestamps() : []),
                        p = (e) => {
                            (i(e), l());
                        },
                        x = (e) => {
                        ...
                        h = (e, t) => (d.current?.addEventListener(e, t), () => d.current?.removeEventListener(e, t)),
                        g = (e, t) => (
            ...
            jsxRuntimeExports.jsx('video', { src: e, className: t, style: u, loop: r, ref: d, onClick: o, ...i })
        );
    }),
    Video = reactExports.memo(VideoForwarded),
    base$8 = 'VehicleLevel_3c938122',
...
const VehicleLevel = reactExports.forwardRef(function ({ value: e, numberType: t, ...s }, u) {
    const r = getLevelType(t, useRomanForbidden()) === numberTypes.roman ? arabicToRoman(e) : e;
    return jsxRuntimeExports.jsx('div', {
        ...s,
        'data-name': 'VehicleLevel',
        className: clsx(styles$8.base, s.className),
        ref: u,
        children: r,
    });
});
...
const base$7 = 'Iconbutton_4670fff1',
    ...
    IconButton = ({
        ...
        const [f, h] = reactExports.useState(!1),
            [g, A] = reactExports.useState(!1),
            b = reactExports.useRef(null),
            F = () => !1 === r,
            C = (e) => F() && ((e) => e.button === MOUSE_BUTTON_CODES.LEFT)(e),
            D = makeOptionalCaller(F, (e) => {
                l?.(e);
            }),
            y = makeOptionalCaller(C, (e) => {
                (h(!0), m?.(e), o && playSound(o));
            }),
            v = makeOptionalCaller(C, (e) => {
                (h(!1), E?.(e));
            }),
            B = makeOptionalCaller(F, (e) => {
                (A(!0), c?.(e), a && playSound(a));
            }),
            w = makeOptionalCaller(F, (e) => {
                _?.(e);
            }),
            S = makeOptionalCaller(F, (e) => {
                p?.(e);
            });
        return jsxRuntimeExports.jsxs('div', {
            ref: b,
            className: cx(
                styles$7.base,
                r && styles$7.base__disabled,
                n && styles$7.base__visibleLabel,
                !r && f && styles$7.base__mouseDown,
                !r && g && styles$7.base__hovered,
                s,
            ),
            onClick: D,
            onMouseEnter: B,
            ...
            children: [
                jsxRuntimeExports.jsx('div', {
                    className: cx(styles$7.icon, styles$7[`icon__${i}`], styles$7[`icon__${e}`], u?.icon),
                }),
                t &&
                    jsxRuntimeExports.jsx('div', {
                        className: cx(styles$7.label, styles$7[`label__${i}`], u?.label),
                        children: t,
                    }),
            ],
        });
    ...
    SPG = 'SPG',
    AT_SPG = 'AT-SPG',
    types = { lightTank: LIGHT_TANK, mediumTank: MEDIUM_TANK, heavyTank: HEAVY_TANK, SPG: SPG, 'AT-SPG': AT_SPG };
Object.values(types);
const MIN_LEVEL = 1,
    ...
    base$6 = 'VehiclePrestigeLevel_a750cce',
...
function PrestigeLevel({ level: e, grade: t, type: s, direction: u, classNames: r, ...n }) {
    return e < MIN_LEVEL || 'undefined' === s
        ? null
        : jsxRuntimeExports.jsxs('div', {
              ...n,
              className: clsx(styles$6.base, styles$6[`base__${s}`], styles$6[`base__${u}`], n.className, r?.base),
              children: [
                  jsxRuntimeExports.jsx(Image, {
                      path: `prestige.tab.${icon$3(e, s, t)}`,
                      className: clsx(styles$6.icon, r?.icon),
                  }),
                  s !== TYPE_PRESTIGE &&
                      jsxRuntimeExports.jsx('div', {
                          className: clsx(styles$6.level, styles$6[`level__${iconLength(e)}`], r?.level),
                          children: e,
                      }),
              ],
          });
...
const roles = {
    ...
    icon$1 = 'VehicleRole_icon_7f7f6256',
    styles$5 = {
        base: base$5,
    ...
    VehicleRole = reactExports.forwardRef(function ({ roleKey: e, size: t = sizes$2.x24x24, classNames: s, ...u }, r) {
        const n = ROLE_TO_COMPONENT[`${e}_${t}`];
        if (n)
            return jsxRuntimeExports.jsx('div', {
                ...u,
                ref: r,
                className: clsx(styles$5.base, styles$5[`base__${t}`], s?.base),
                children: jsxRuntimeExports.jsx(n, { className: clsx(styles$5.icon, s?.icon) }),
            });
...
const sizes$1 = { x24x24: 'x24x24', x48x48: 'x48x48', x64x64: 'x64x64', x96x96: 'x96x96' },
    ...
    mapTypes = {
        ...
        [types.mediumTank]: 'medium_tank',
        [types.heavyTank]: 'heavy_tank',
        [types.SPG]: 'spg',
        [types['AT-SPG']]: 'tank_destroyer',
    },
    base$4 = 'VehicleType_30b4aab0',
    ...
    VehicleType = reactExports.forwardRef(function (
        { type: e, size: t = sizes$1.x48x48, premium: s = !1, fit: u = 'contain', ...r },
        n,
    ) {
        ...
        return jsxRuntimeExports.jsx(Image, {
            ...
            ref: n,
            fit: u,
            className: clsx(styles$4.base, s ? styles$4[`base__premium__${t}`] : styles$4[`base__${t}`], r.className),
            path: `ui_kit.vehicle_type.${a}.${s ? 'premium_' : ''}${normalizeResource(mapTypes[e])}_${a}`,
        });
    });
((VehicleType.types = types), (VehicleType.sizes = sizes$1));
const base$3 = 'VehicleInfo_1732f1f0',
    name = 'VehicleInfo_name_3989ca04',
    name__premium = 'VehicleInfo_name__premium_258b3b93',
    styles$3 = { base: base$3, name: name, name__premium: name__premium },
    VehicleName = defineStyledComponent('VehicleName', styles$3.name, {
        variants: { premium: { true: styles$3.name__premium } },
    }),
    VehicleInfo = reactExports.forwardRef(function (e, t) {
        return jsxRuntimeExports.jsx('div', { ...e, ref: t, className: clsx(styles$3.base, e.className) });
    });
...
function Value({ classNames: e, size: t = sizes.small, value: s, maxValue: u = DEFAULT_MAX_VALUE }) {
    return jsxRuntimeExports.jsx('div', {
        className: clsx(
            styles$2.base,
            styles$2[`base__${t}`],
            'string' == typeof s && styles$2.base__text,
            e?.valueContainer,
        ),
        children: jsxRuntimeExports.jsx('div', {
            className: clsx(styles$2.value, styles$2[`value__${t}`], e?.value),
            children: getValue(s, u),
        }),
    });
}
const base$1 = 'Bubble_df22310d',
    base__hidden = 'Bubble_base__hidden_1700314d',
    styles$1 = { base: base$1, base__hidden: base__hidden },
    Bubble = {
        Root: defineStyledComponent('Bubble', styles$1.base, { variants: { hidden: { true: styles$1.base__hidden } } }),
        Value: Value,
    },
    base = 'TruncateText_dcb41d92',
    styles = { base: base },
    TruncatedText = reactExports.forwardRef(function ({ text: e, tooltipParams: t, className: s, ...u }, r) {
        const n = useSimpleTooltip({ header: t?.header, body: t?.body || e }),
            a = reactExports.useRef(null),
            [o, i] = reactExports.useState(!1),
            l = reactExports.useCallback(() => {
                a.current && i(a.current.scrollWidth - Math.ceil(a.current.getBoundingClientRect().width) > 0);
            }, []);
        return (
            reactExports.useEffect(() => {
                o || n.onMouseLeave();
...
export {
    ...
    FormatText$1 as F,
    concatWithPath as G,
    logBySeverity$1 as H,
    Image as I,
    JSXBuilder as J,
    ImagesRClassProvider as K,
    FormatText as L,
    MultilineOverflowWithTooltip as M,
    NotificationWrapper as N,
    Currency as O,
    capitalize as P,
    ImageSize as Q,
    computeds as R,
    SoundsRClassProvider as S,
    Tabs as T,
    UIProvider as U,
    useUntilTimer as V,
    millis as W,
    ...
    useParamTooltip as a8,
    Delta as a9,
    useSkipFrame$1 as aA,
    useCallbackOnce as aB,
    Area$1 as aC,
    Bar$1 as aD,
    Base$7 as aE,
    CardsWrapper as aF,
    ...
    sizes$1 as aK,
    types as aL,
    MultilineOverflow$1 as aM,
    sendEvent$1 as aN,
    filter as aO,
    play as aP,
    useScrollByDragElements as aQ,
    ...
    ONE_DAY as aW,
    CardSingle as aX,
    useVerticalScroll as aY,
    useVerticalDrag as aZ,
    MaskArea as a_,
    Card as aa,
    cloneModel as ab,
    add as ac,
    ...
    isEmptyObject as ak,
    useEmitter as al,
    useSoundsOptional as am,
    find as an,
    remToPx$1 as ao,
    usePrevious as ap,
    useMount as aq,
    useEmitterSubscribe as ar,
    Video as as,
    useIsFirstRender as at,
    getRewardTooltipConfig as au,
    VehicleLevel as av,
    normalizeResource as aw,
    Reward as ax,
    mapNonNullable as ay,
    useHorizontalScroll as az,
    resources as b,
    types$1 as b0,
