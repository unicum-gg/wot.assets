...
const initializeModelWithContext =
        ...
        (t, s, u) => {
            ...
            function n(n) {
                ...
                const [g, b] = reactExports.useState(() => p(f, o, m));
                return (
                    reactExports.useEffect(() => {
                        x.current ? b(p(f, o, m)) : (x.current = !0);
...
const base$w = 'CloseButton_7488a1b8',
    ...
    upscaleImageSizes = { [sizes$7.medium]: 'x96x96', [sizes$7.small]: sizes$7.medium, [sizes$7.extraSmall]: 'x32x32' };
function CloseButton({
    ...
    const a = useUpscale(styles$A[`base__${e}`], styles$A[`base__${upscaleImageSizes[e]}`]);
    return jsxRuntimeExports.jsx('div', {
        className: cx(styles$A.base, a, u),
        onMouseEnter: () => {
            (play.sound(t), r?.());
        },
        onClick: () => {
...
const rail$1 = 'HorizontalBar_rail_37858d8f',
    ...
    base$t = 'HorizontalScroll_5b201d2b',
    wrapper$1 = 'HorizontalScroll_wrapper_2fb60496',
    defaultScrollArea = 'HorizontalScroll_defaultScrollArea_a5c0f45',
    styles$x = { base: base$t, wrapper: wrapper$1, defaultScrollArea: defaultScrollArea },
    DefaultScroll$1 = ({
        children: e,
        className: t,
        barClassNames: s,
        ...
        return jsxRuntimeExports.jsxs('div', {
            ...
            children: [
                jsxRuntimeExports.jsx('div', {
                    className: clsx(styles$x.defaultScrollArea, u),
...
const DEFAULT_VERTICAL_API_CONFIG = {
    ...
    DefaultScroll = ({
        ...
        return jsxRuntimeExports.jsxs('div', {
            ...
            children: [
                jsxRuntimeExports.jsx('div', {
                    className: clsx(styles$v.area, u),
...
function MaskArea({ classNames: e, ...t }) {
    ...
    return jsxRuntimeExports.jsx(Area, {
        ...t,
        classNames: { ...e, content: clsx(styles$v[`content__${getMaskDirection(u, r)}`], e?.content) },
    });
}
function Base$8({ children: e }) {
    const t = useApi(),
...
const COLORS =
    ...
    styles$u = { COLORS: COLORS, base: base$r, base__fullSize: base__fullSize, nowrap: nowrap },
    ...
    for (let s = 0; s < e.length; s++) {
        ...
        (t.push(
            jsxRuntimeExports.jsxs(
                ...
                {
                    children: [
                        jsxRuntimeExports.jsxs('span', { className: styles$u.nowrap, children: [split(u), r[0]] }),
                        n,
                    ],
                },
                takeKey(),
...
const defaultBrackets = { start: '{{', end: '}}' },
    FormatText$1 = reactExports.memo(function (e) {
        const {
            ...
            _ = clsx(styles$u.base, n && styles$u.base__fullSize, l.className);
        return e.inline
            ? (console.warn(
...
const themes$1 = { primary: 'primary', custom: 'custom' },
    ...
    base$q = 'HorizontalTabs_69e3c6f3',
    ...
    Base$7 = defineStyledComponent('Tabs', styles$t.base, {
        variants: {
            size: {
                [sizes$6.large]: styles$t['base__size-large'],
                [sizes$6.medium]: styles$t['base__size-medium'],
                [sizes$6.small]: styles$t['base__size-small'],
            },
            theme: { [themes$1.primary]: styles$t['base__theme-primary'], [themes$1.custom]: void 0 },
        },
    }),
    Switcher = reactExports.forwardRef(function ({ children: e, classNames: t, ...s }, u) {
        ...
        return jsxRuntimeExports.jsx(Base$7, {
            ...
            children: jsxRuntimeExports.jsxs('div', {
                className: clsx(styles$t.outerBorder, t?.outerBorder),
                children: [
                    jsxRuntimeExports.jsx('div', { className: clsx(styles$t.outerBorderImage, t?.outerBorderImage) }),
                    jsxRuntimeExports.jsxs('div', {
                        className: clsx(styles$t.mainBorder, t?.mainBorder),
                        children: [
                            jsxRuntimeExports.jsx('div', {
                                className: clsx(styles$t.mainBorderImage, t?.mainBorderImage),
                            }),
                            jsxRuntimeExports.jsx('div', {
    ...
    Base$6 = defineStyledComponent('Tab', styles$s.base, {
        variants: {
            size: {
                [sizes$6.large]: styles$s['base__size-large'],
                [sizes$6.medium]: styles$s['base__size-medium'],
                [sizes$6.small]: styles$s['base__size-small'],
            },
            theme: { [themes$1.primary]: styles$s['base__theme-primary'], [themes$1.custom]: void 0 },
            state: { active: styles$s.base__active, inactive: styles$s.base__inactive },
        },
    ...
    HeadlessTab = reactExports.forwardRef(function (
        ...
        return jsxRuntimeExports.jsx(Base$6, {
            ...
            onMouseEnter: function (e) {
                (u !== s && l.play('mouse-enter', { target: Base$6.displayName, original: e }), a?.(e));
            },
            onClick: function (e) {
                (u !== s && l.play('click', { target: Base$6.displayName, original: e }), n?.(e));
            },
            children: r,
        });
    });
function Tab({ tabId: e, classNames: t, className: s, children: u, ...r }) {
    ...
    return jsxRuntimeExports.jsxs(HeadlessTab, {
        ...
        children: [
            jsxRuntimeExports.jsx('div', { className: clsx(styles$s.background, t?.background) }),
            jsxRuntimeExports.jsx('div', { className: clsx(styles$s.backgroundPattern, t?.backgroundPattern) }),
            jsxRuntimeExports.jsx('div', { className: clsx(styles$s.border, t?.border) }),
            jsxRuntimeExports.jsx('div', { className: clsx(styles$s.innerBorderImage, t?.borderImage) }),
            jsxRuntimeExports.jsx('div', { className: clsx(styles$s.content, t?.content), children: u }),
        ],
    });
}
...
const multiValueTypes = [
    ...
    base$o = 'NotificationWrapper_6fe65b7',
    ...
    NotificationWrapper = ({ children: e, ref: t, className: s }) => {
        ...
        return (
            ...
            jsxRuntimeExports.jsx('div', {
                ...
                className: clsx(styles$r.base, s),
                children: e,
            })
        );
    },
    ...
    base$n = 'HeadlessButton_df8536fc',
    styles$q = { base: base$n },
    HeadlessButtonBase = defineStyledComponent('Button', { element: 'button', className: styles$q.base }),
    ...
    Button = reactExports.forwardRef(function (
        ...
        return jsxRuntimeExports.jsxs(HeadlessButton, {
            ...
            className: clsx(
                ...
                u ? styles$p.base__disabled : styles$p.base__enabled,
                o,
                a?.base,
            ),
            onClick: function (e) {
            ...
            children: [
                ...
                jsxRuntimeExports.jsx('div', { className: clsx(styles$p.overlay, a?.overlay) }),
                jsxRuntimeExports.jsx('div', {
                    className: clsx(styles$p.content, n && styles$p.content__fontAligned, a?.content),
                    children: e,
                }),
            ],
        });
    ...
    return jsxRuntimeExports.jsxs('div', {
        ...
        children: [
            jsxRuntimeExports.jsx(FormatText$1, {
                ...
                formatters: u,
                className: m?.text,
                style: { ...p, visibility: b ? 'hidden' : void 0 },
            }),
            jsxRuntimeExports.jsx('div', {
                ref: g,
...
export {
    ...
    types$1 as b0,
    runView as c,
    createSoundPlay as d,
    createLayoutReadyInEffect as e,
    format$2 as f,
    useAdaptive as g,
    sizes$6 as h,
