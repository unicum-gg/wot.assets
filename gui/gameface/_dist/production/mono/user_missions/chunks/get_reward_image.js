import { a2 as s, b as e, D as a } from './lib.js';
var i = ((s) => (
    (s.Big = 'big'),
    (s.Small = 'small'),
    (s.Mini = 'mini'),
...
const u = 'vehicles',
    ...
    G = (s, a = 's180x135') => {
        const { name: i, isRent: G, icon: M, id: W, value: H } = s;
        switch (i) {
            case u:
                return G
            ...
            case A:
            case N:
                return e.resolve('images').has(`R.images.gui.maps.icons.quests.bonuses.${a}.${M}_${H}`)
