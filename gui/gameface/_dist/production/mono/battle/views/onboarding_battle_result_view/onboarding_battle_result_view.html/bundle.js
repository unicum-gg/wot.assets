...
import { b as t, B as a, i, a as n, u as o, k as r, J as l, U as d, r as c } from '../../../chunks/lib.js';
    ...
    e.weight >= t.extraLarge.weight
        ...
        : e.weight >= t.large.weight
          ...
          : e.weight >= t.medium.weight
            ? a.sizes.small
            : a.sizes.extraSmall;
['ja', 'ko', 'zh_tw', 'zh_sg', 'zh_cn', 'vi', 'th'].includes(R.strings.settings.LANGUAGE_CODE().toLowerCase());
const [u, b] = i()(
        ...
        return (
            ...
            s.jsxs('div', {
                ...
                children: [
                    ...
                    s.jsx('div', { className: _, children: R.strings.sm_lobby.onboardingBattleResult.titleText() }),
