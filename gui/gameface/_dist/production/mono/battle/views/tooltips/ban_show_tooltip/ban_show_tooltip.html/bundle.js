...
import { H as i, i as c, I as a, q as n, r, U as t } from '../../../../chunks/lib.js';
import { N as l } from '../../../../chunks/constants.js';
/* empty css                        */ const d = 'TooltipDecorator_decorator_81525906',
    p = 'TooltipDecorator_decoratorInner_5b7cf9de';
...
const [_, h] = c()((e) => ({ ...{ root: e.observableModel.object() } }), a),
    ...
    N = (e) => (e === l ? R.strings.comp7_ext.banView.tooltip.noAction() : R.strings.comp7_ext.banView.withoutBan()),
    A = (e, s) =>
        e === l
    ...
    y = o(() => {
        const { model: s } = h(),
            { confirmedChoice: o, type: i, isPremium: c, longName: a, vehicleCD: r, roleKey: t } = s.root.get(),
            l = n(i),
            d = c ? `${l}_elite` : l,
