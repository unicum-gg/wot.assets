import { j as e, q as a, o as s, s as t, f as l, r as n, e as o, p as r } from '../../../chunks/vendor.js';
import {
    p as i,
    i as c,
    d,
...
const $ = {
    ...
    L = 'vehicle',
    M = 'damage';
function V({ onClick: s, className: t, isSelected: l, isEnabled: n, sortDirection: o, column: r, children: c }) {
    return e.jsxs('div', {
        ...
        children: [c, l && n && e.jsx('div', { className: $.arrow }), l && e.jsx('div', { className: $.line })],
    });
}
const W = [b, u, m, h, v];
...
const [F, z] = c()(
    ...
    ({ externalModel: e, model: a }) => ({
        setSortBy: l((e) => {
            (e === a.sortBy.get() ? a.sortDirection.set(-1 * a.sortDirection.get()) : a.sortDirection.set(1),
                a.sortBy.set(e));
        }),
        ...
        sendPlatoonInvitation: e.createCallback((e, a) => ({ playerId: e, userName: a }), 'onSendPlatoonInvitation'),
        removeFromBlacklist: e.createCallback((e, a) => ({ playerId: e, userName: a }), 'onRemoveFromBlacklist'),
    }),
);
...
const se = n.memo(function ({ icon: s, className: t, isHighlighted: l = !1, isHoverEnabled: n = !1 }) {
        return e.jsx('div', {
            className: a(ee.base, l && ee.base__highlighted, n && ee.base__hoverEnabled, ee[`base__${s}`], t),
            children: e.jsx('div', {
                className: ee.icon,
                style: { backgroundImage: `url('${R.images.last_stand.gui.maps.icons.common.stats.c_32x32.$dyn(s)}')` },
            }),
        });
    }),
    te = {
    ...
    je = r(function ({
        ...
        const {
            ...
            f = ((e, a, s) => (e ? 'blacklisted' : a ? 'requestSent' : s ? 'friend' : 'default'))(d, _, t),
            p = ((e, a, s) =>
                s ? 'platoonSent' : e && !a ? 'platoonCanMade' : a ? 'platoonDone' : 'platoonUnavailable')(b, u, m),
            j = n.useCallback(
                (e) => {
                ...
                e.jsx(x, {
                    ...
                    children: e.jsx('div', {
                        ...
                        children: ge[f].isButton
                            ...
                            : e.jsx('div', { className: xe, children: e.jsx('div', { className: a(de, ge[f].icon) }) }),
                    }),
                }),
                e.jsx(x, {
                    ...I,
                    children: e.jsx('div', {
                        ...
                        children: Ne[p].isButton
                            ...
                            : e.jsx('div', { className: xe, children: e.jsx('div', { className: a(de, Ne[p].icon) }) }),
                    }),
                }),
                e.jsx(x, {
...
var Ie = ((e) => ((e.NotBanned = 'notBanned'), (e.Warned = 'warned'), (e.Banned = 'banned'), e))(Ie || {});
const we = {
...
function De({ user: s, squadNum: t, isOwnSquad: l = !1, banType: o, isCurrentPlayer: r }) {
    const i = n.useContext(O),
        ...
        _ = t > 0;
    return e.jsxs('div', {
        className: a(we.base, we[`base__${i}`], r && we.base__currentPlayer, s.badge.badgeID && we.base__withBadge),
        children: [
            _ &&
                e.jsx('div', {
...
const Re = {
    ...
    Be = n.memo(function ({ current: s, isMax: t, column: l, tableType: n, isCrowned: o, isCurrentPlayer: r }) {
        const i = C(s, 1);
        return e.jsxs('div', {
            ...
            children: [
                o &&
                    e.jsx('div', {
                        className: a(Re.crown, n === G.LeaderBoard && l === H.Place && Re[`crown__${Pe[s - 1]}`]),
                    }),
...
n.memo(function ({ type: s, color: t, className: l, size: n = 'c_24x24' }) {
    return e.jsx('div', {
        ...
        style: { backgroundImage: `url('R.images.last_stand.gui.maps.icons.vehicleTypes.flat.${t}.${n}.${I(s)}')` },
    });
});
        ...
        return e.jsxs(Ce, {
            ...
            children: [
                e.jsx(J, {
                    cellStyle: U.Player,
                    isCurrentPlayer: t,
                    children: e.jsx(De, { user: o, squadNum: n, isOwnSquad: l, banType: i, isCurrentPlayer: t }),
                }),
                e.jsx(J, {
                    cellStyle: U.Actions,
                    isCurrentPlayer: t,
        ...
        return e.jsxs('div', {
            ...
            children: [
                e.jsxs('div', {
                    className: a(aa, sa),
                    children: [
                        e.jsx('div', { className: ta, children: R.strings.last_stand_battle.eventStats.eventName() }),
                        e.jsx(D, {
                            classMix: la,
                ...
                e.jsxs('div', {
                    ...
                    children: [
                        ...
                        e.jsx('div', { className: la, children: R.strings.last_stand_battle.eventStats.globalTask() }),
                    ],
                }),
            ],
        });
            ...
            children: [
                ...
                e.jsxs('div', {
                    ...
                    children: [
                        ...
                        e.jsx(Ze, { className: _a, text: R.strings.last_stand_battle.eventStats.tableCaption() }),
                        e.jsx(Oe, { resId: R.aliases.last_stand.shared.TeamStats('resId'), tableType: G.TabWindow }),
                    ],
                }),
            ],
        });
