...
function readFromR$2(e, u) {
    ...
    if (window.R && window.R.images) {
        ...
        if (!u) return;
        const s = t.slice(0, -1).reduce((e, u) => {
            if ('object' == typeof (null == e ? void 0 : e[u])) return e[u];
        }, e);
        if (!s) return;
        return 'function' == typeof s[u] ? s[u]() : void 0;
    }
...
class ImagesRClassProvider {
    ...
    readOr(e, u, t = 'silent') {
        ...
        return void 0 === n ? ('silent' !== t && logBySeverity$1(`Resource not found: ${s}`, t), u()) : n;
    }
...
function readFromR$1(e, u, t) {
    const s = e.split('.');
    if (window.R && window.R.strings) {
        const e = s[s.length - 1];
        if (!e) return;
        const n = s.slice(0, -1).reduce((e, u) => {
            if ('object' == typeof (null == e ? void 0 : e[u])) return e[u];
        }, t);
        if (!n) return;
        return 'function' == typeof n[e] ? (u ? n[e](u) : n[e]()) : void 0;
    }
...
class StringsRClassProvider {
    ...
    readOrThrow(e) {
        const u = e.startsWith('R.strings') ? e : concatWithPath(this.prefix, e),
            t = readFromR$1(u, void 0, e.startsWith('R.strings') ? window : this.root);
    ...
    pluralOr(e, u, t, s = 'silent') {
        const n = e.startsWith('R.strings') ? e : concatWithPath(this.prefix, e),
            r = readFromR$1(n, u, e.startsWith('R.strings') ? window : this.root);
        return void 0 === r ? ('silent' !== s && logBySeverity$1(`Resource not found: ${n}`, s), t()) : r;
    }
...
class VideosRClassProvider {
    ...
    readOr(e, u, t = 'silent') {
        ...
        return void 0 === n ? ('silent' !== t && logBySeverity$1(`Resource not found: ${e}`, t), u()) : n;
    }
    readOrEmpty(e, u = 'warn') {
        return this.readOr(e, () => '', u);
    }
            ...
            (u, t) => (
                (u[t] = (function (u) {
                    return (t) => {
                        e.listeners += 1;
                        const n = `mouse${u}`,
                            r = internalMouse$1[u]((e) => t([e, 'outside']));
                        function a(e) {
                            t([e, 'inside']);
                        }
                        return (
                            ...
                            s(),
                            () => {
                                (r(), window.removeEventListener(n, a), (e.listeners -= 1), s());
                            }
                        );
                    };
                })(t)),
...
const sounds$1 = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
    plays$1 = Object.keys(sounds$1).reduce((e, u) => ((e[u] = () => playSound$1(sounds$1[u])), e), {}),
...
const createViewEventArguments$2 = (e) => {
    ...
    sendViewEvent$1 = (e, u) => {
        ...
        if (void 0 !== u) {
            const { args: s, ...n } = u;
            return void 0 !== s
                ? viewEnv.handleViewEvent({ __Type: t, type: e, ...n, arguments: createViewEventArguments$2(s) })
                : viewEnv.handleViewEvent({ __Type: t, type: e, ...n });
        }
...
function initExternalPaddings$1(e) {
    function u() {
        const { top: u, right: t, bottom: s, left: n } = viewEnv.getExternalPaddingsRem();
...
function pipe(e, u, t, s, n, r, a, o, i) {
    switch (arguments.length) {
        ...
        case 6:
            return r(n(s(t(u(e)))));
        case 7:
            return a(r(n(s(t(u(e))))));
        case 8:
            return o(a(r(n(s(t(u(e)))))));
        case 9:
            return i(o(a(r(n(s(t(u(e))))))));
        default: {
            let e = arguments[0];
...
function create(
    { initializer: e = !0, rootId: u = 0, getRoot: t = getRootDefault, context: s = 'model' } = {},
    { name: n = 'DataLayer' } = {},
) {
    const r = new Map(),
    ...
    function i() {
        try {
            const e = t(u);
            return s.split('.').reduce((e, u) => e[u], e);
        } catch (e) {
            throw new Error(`Failure get root of ${n}. Root id: ${u}. Context: ${s}`);
        }
    }
    const l = (e) => {
        const t = i();
        ...
        try {
            ...
            throw new Error(`Failure readByPath in ${n}. Root id: ${u}. Context: ${s}:\n${r}\n`);
        }
    };
    function c(e) {
        viewEnv.removeDataChangedCallback(e, u) ? r.delete(e) : console.error("Can't remove callback by id:", e);
    }
    return {
        subscribe: (t, n) => {
            const a = addModelObserver$1('string' == typeof n ? `${s}.${n}` : s, u, !0);
            return (r.set(a, t), e && t(l(n), []), a);
        },
        readByPath: l,
        readSafeByPath: (e) => {
            const u = i();
        ...
        dispose: function () {
            if (0 === u || ids().includes(u)) for (const e of r.keys()) c(e);
            o.then((e) => e());
        },
        unsubscribe: c,
        events: a,
...
function createMockInstance(e, u) {
    return {
        ...
        readByPath: e,
        createCallback: (t, s) => {
            const n = e(resolvePath(s, u));
            return (...e) => {
                n(t(...e));
            };
        },
        createCallbackNoArgs: (t) => {
            const s = e(resolvePath(t, u));
            return () => {
                s();
            };
        },
...
const clamp = (e, u, t) => (t < e ? e : t > u ? u : t);
function noop() {}
function constFalse() {
    return !1;
}
...
function addEventListener(e, u, t, s) {
    return (e.addEventListener(u, t, s), () => e.removeEventListener(u, t, s));
}
('symbol' != typeof Symbol.dispose && Object.defineProperty(Symbol, 'dispose', { value: Symbol.for('dispose') }),
    ...
    (function () {
        if (!self.fetch) {
            ((a.prototype.append = function (e, u) {
                ((e = n(e)), (u = r(u)));
                var t = this.map[e];
            ...
            (c.call(d.prototype),
                ...
                (self.fetch = function (u, t) {
                    var n;
                    return (
                        (n = d.prototype.isPrototypeOf(u) && !t ? u : new d(u, t)),
                        new fetch.Promise(function (u, t) {
                            ...
                            ('cors' === n.credentials && (r.withCredentials = !0),
                                ...
                                n.headers.forEach(function (e, u) {
                    ...
                    ? ((this.blob = function () {
                      ...
                      (this.text = function () {
                          var e,
                              ...
                              t = o(this);
                          if (t) return t;
                          if (this._bodyBlob) return ((e = this._bodyBlob), (u = new FileReader()).readAsText(e), i(u));
        ...
        function d(e, u) {
            ...
            if (
                ...
                (this.headers = new a(u.headers)),
                (this.method = ((s = u.method || 'GET'), (n = s.toUpperCase()), t.indexOf(n) > -1 ? n : s)),
                    ...
                    .forEach(function (e) {
                        if (e) {
                            var t = e.split('='),
                                s = t.shift().replace(/\+/g, ' '),
                                n = t.join('=').replace(/\+/g, ' ');
                            u.append(decodeURIComponent(s), decodeURIComponent(n));
                        }
                    }),
                u
            );
        ...
        function m(e, u) {
            (u || (u = {}),
                ...
                (this.headers = u.headers instanceof a ? u.headers : new a(u.headers)),
                (this.url = u.url || ''));
        }
    })());
const keyCodes = { ENTER: 13, ESCAPE: 27, TAB: 9 };
function makeMapWithPrefix(e, u) {
    return e.reduce((e, t) => ({ ...e, [`${u}_${t}`.toUpperCase()]: `${u}${t}` }), {});
}
function makeMap(e) {
    return e.reduce((e, u) => ({ ...e, [`${u}`.toUpperCase()]: u }), {});
}
...
const unsafeGet = get;
function map(e, u) {
    return Array.isArray(e) ? e.map(u) : e.map((e, t, s) => u(null == e ? void 0 : e.value, t, s));
}
function forEach(e, u) {
...
function addSpaceAndMap(e, u, t) {
    return langsWithoutSpace.has(u)
        ? e.map(t)
        : e.map((e, u, s) => (u === s.length - 1 ? t(e, u, s) : t(`${e} `, u, s)));
}
function splitLocale(e, u) {
    return (splitters[u] ?? defaultSplit)(e);
}
...
function generateMediaClasses(e, u) {
    const t = u['width' === e ? 'height' : 'width'],
        s = new Set(u[e].classes),
        n = new Set(t.classes.filter((e) => !(!e.endsWith('Width') && !e.endsWith('Height')) || s.has(e)));
...
function calculateMedia(e, u, t) {
    const s = BREAKPOINTS.reduce(
            (t, s) => (
                s.width <= e &&
                    (t.width.classes.push(s.className, `${s.className}Width`),
                    t.width.names.push(s.name),
                    (t.width.weight += 1)),
                s.height <= u &&
                    (t.height.classes.push(s.className, `${s.className}Height`),
                    t.height.names.push(s.name),
                    (t.height.weight += 1)),
                t
            ),
        ...
        r = s[n],
        a = r.names[r.names.length - 1] ?? breakpoints.extraSmall,
...
function MediaWrapperElement({ children: e, className: u, ...t }) {
    ...
    return jsxRuntimeExports.jsx('div', {
        className: cx(u, 'media-wrapper', s, n && 'media-upscale'),
        ...t,
        children: e,
    });
}
...
function accumulate(e, u, t) {
    return t ? e.breaks.reduce((e, u) => (t[u] ? { ...e, ...t[u] } : e), u) : u;
}
function useAdaptive(e, u) {
    return accumulate(useMedia(), e, u);
}
const UPSCALE = 'upscale';
function useUpscale(e, u) {
    return useMedia().upscale ? u : e;
}
const usePrevious = (e) => {
...
function throttle(e, u, t, s) {
    ...
    return (
        'boolean' != typeof u && ((s = t), (t = u), (u = void 0)),
        (i.cancel = function () {
            (o(), (r = !0));
        }),
        i
...
function useEmitter() {
    return reactExports.useMemo(() => {
        ...
        return {
            on: (e, s) => (u(e).add(s), () => t(e, s)),
            off: t,
            trigger: (e, ...t) => {
                for (const s of u(e).values()) s(...t);
            },
        };
    }, []);
}
...
const createApi = () => {
        ...
        return {
            ...
            register: function (e, s) {
                ...
                const n = u(e);
                return (n.includes(s) || n.push(s), () => t(e, s));
            },
            unregister: t,
...
function Provider$1(e) {
    ...
    return jsxRuntimeExports.jsx(Context$3.Provider, { value: s, children: e.children });
}
const defaultCallback = (e) => {
    console.error(e.type + ': useKeydownListener hook :: Callback is not defined');
};
function useKeydownListener(e = keyStringCodes.ESCAPE, u = defaultCallback, t = !1) {
    ...
    reactExports.useEffect(() => {
        ...
        function e(e) {
            e.code !== s || isEventHandled$1() || (u(e), setEventHandled$1(), t && e.stopPropagation());
        }
    }, [u, s, t]);
}
function useRepeatCallback(e, u, t = []) {
    ...
    const r = (t ?? []).concat([u]);
    return [
        reactExports.useCallback((t) => {
            (0 !== s.current && n(), (s.current = window.setInterval(() => e(t, !0), u)), e(t, !1));
        }, r),
        n,
    ];
}
const useRefResizeObserver = (e, u, t = !0) => {
        const s = useEvent((e) => {
            const t = e[0];
            t && u(t);
        });
        reactExports.useEffect(() => {
            ...
            const u = new ResizeObserver((e) => s(e));
            return (
                u.observe(e.current),
                () => {
                    u.disconnect();
    ...
    useScaleState = () => {
        const [e, u] = reactExports.useState(getScale$2());
        return (
            reactExports.useEffect(() => {
                const e = () => {
                    u(getScale$2());
...
function useThrottle(e, u, t) {
    const s = reactExports.useMemo(() => throttle(t, e), u);
        ...
        [o, i] = reactExports.useMemo(() => {
            ...
            function l() {
                ((a.current.status = statuses.display),
                    sendEvent$1.tooltip.open(e, u, t, n),
                    o && displayedTooltips.set(o, d));
            }
            function c() {
                if (
                    (window.clearTimeout(a.current.timeoutId),
                    a.current.status === statuses.display && sendEvent$1.tooltip.hide(e, u, t),
...
function useSimpleTooltip({ alert: e, body: u, header: t, note: s, hasHtmlContent: n, disabled: r }) {
    ...
    return useTooltip({
        ...
        args: reactExports.useMemo(() => ({ body: u, header: t, note: s, alert: e }), [e, u, t, s]),
    });
}
const soundConfig = {
...
function SoundsProvider({ severity: e = 'warn', overrides: u, silent: t = !1, children: s }) {
    const n = reactExports.useMemo(() => ({ ...soundConfig, ...u }), [u]),
        r = reactExports.useMemo(
            () => ({
                play: function (u, s) {
                    if (t) return;
                    const r = n[u];
                    r ? r(s) : logBySeverity(`There is no sound for event: ${u}`, e);
                },
                settings: { plays: n, severity: e, silent: t },
            }),
            [n, e, t],
        );
    return jsxRuntimeExports.jsx(Context$2.Provider, { value: r, children: s });
}
function useSounds() {
...
function cloneModel(e, { shallow: u = !0, depth: t = 0, maxDepth: s = 32 } = {}) {
    var n, r;
    const a = e,
        o = typeof e;
    if (t > s) throw new Error(`Too deeply nested to copy. Max is ${s}.`);
    if (nonConvertingTypes.has(o)) return a;
    if (null === a) return a;
    const i = { depth: t + 1, maxDepth: s };
    ...
    if ('object' === o) {
        ...
        if (s.includes(':ViewModel:') || 'Object' === s) {
            if (u && 0 === t) {
                ...
                for (const u in a) {
                    const t = a[u];
                    primitives$1.has(typeof t) && (e[u] = t);
                }
                return e;
            }
            {
                ...
                for (const u in a) {
                    const t = a[u],
                        s = (null == (r = null == a ? void 0 : a.constructor) ? void 0 : r.name) ?? 'UNKNOWN';
                    bindingsForbidden.has(s) || (e[u] = cloneModel(t, i));
                }
                return e;
            }
        }
...
class DLDict {
    constructor(e, u = DEFAULT_OPTIONS) {
        ...
        ((this._keys = observable.set(new Set(s))), (this._data = observable.box(t, MOBX_OPTIONS)));
    }
    get keys() {
        return this._keys;
    }
    ...
    update(e, u) {
        ...
        for (let s = 0; s < u.length; s++) {
            ...
            n in t
                ? null === r
                    ? (delete t[n], this._keys.delete(n), this.set(t))
                    : t[n].set(r)
                : null !== r && ((t[n] = observable.box(r, MOBX_OPTIONS)), this._keys.add(n), this.set(t));
        }
    }
    entries() {
    ...
    map(e) {
        const u = [],
            t = this._data.get();
        for (const s of this.keys.values()) u.push(e(t[s].get(), s));
        return u;
    }
    reduce(e, u) {
        let t = u;
        const s = this._data.get();
        for (const n of this.keys.values()) t = e(t, s[n].get(), n);
        return t;
    }
    takeItem(e, u) {
        const t = e.get(u);
...
function createObservableModel(e, u, t) {
    ...
    const n = (n, r, a = DEFAULT_BOX_CONFIG) => {
            const o = observable.box(n(t(r)), a);
            return ('real' === u && e.subscribe((e) => s.push(() => o.set(n(e))), r), o);
        },
        r = (n, r) => {
            const a = new DLDict(t(n), r);
            return ('real' === u && e.subscribe((e, u) => s.push(() => a.update(e, u)), n), a);
        },
        a = (n, r) => {
            const a = observable.box(t(n) ?? r, DEFAULT_BOX_CONFIG);
            return ('real' === u && e.subscribe((e) => s.push(() => a.set(e)), n), a);
        };
    return {
        dict: r,
        dictRef: (e, u) => r(e, { cloneItem: !1, ...u }),
        ...
        primitives: (n, r) => {
            const a = t(r);
            if (Array.isArray(n)) {
                const t = n.reduce((e, u) => ((e[u] = observable.box(a[u], {})), e), {});
                return (
                    'real' === u &&
                        e.subscribe((e) => {
                            s.push(() =>
            ...
            }
            {
                const t = n,
                    o = Object.entries(t),
                    i = o.reduce((e, [u, t]) => ((e[t] = observable.box(a[u], {})), e), {});
                return (
                    'real' === u &&
                        e.subscribe((e) => {
                            s.push(() =>
...
const initializeModelWithContext =
        ...
        (u, t, s) => {
            ...
            function r(r) {
                var a;
                const { mode: o, options: i, children: l, mocks: c } = r,
                    d = useMockContext(),
                    E = o ?? d.mode,
                    p = c ?? d.mocks,
                    ...
                    A = useEvent((n, a, o) => {
                        ...
                        const l = 'real' !== n && o ? createMockInstance(o.getter, a) : create(a, { name: e }),
                            ...
                            E = 'initial' in r && {
                                initial: null == (i = null == s ? void 0 : s.initial) ? void 0 : i.call(s, r.initial),
                            },
                            p = u({
                                ...E,
                                mode: n,
                            ...
                            A = { ...E, mode: n, model: p, externalModel: l, cleanup: d, requires: _ },
                            F = 'mocks' === n && (null == o ? void 0 : o.controls) ? o.controls(A) : {};
                        return {
                            model: p,
                    ...
                    [g, f] = reactExports.useState(E);
                reactExports.useEffect(() => {
                    f(E);
                }, [E]);
                const [D, h] = reactExports.useState(() => A(g, i, p));
                return (
                    reactExports.useEffect(() => {
                        F.current ? h(A(g, i, p)) : (F.current = !0);
                    }, [
                        A,
                        p,
                        g,
                    ...
                    jsxRuntimeExports.jsx(n.Provider, { value: D, children: l })
                );
            }
            return (
                (r.displayName = e),
    ...
    computeds = {
        model: (e, u) => computedFn(e, { equals: constFalse, ...u }),
        primitive: computedFn,
        shallow: (e, u) => computedFn(e, { equals: comparer.shallow, ...u }),
        structural: (e, u) => computedFn(e, { equals: comparer.structural, ...u }),
    },
    assignRef = (e, u) => {
...
class JSXBuilder {
    ...
    render(e) {
        return jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {
            children: this.items.reduceRight((e, [u, t], s) => reactExports.createElement(u, { ...t, key: s }, e), e),
        });
    }
}
function injectShowModel() {
    const e = (u = window.model, { depth: t = 16, convertArrays: s = !0 } = {}) => {
        var n;
        if (t < 0)
            return (
                console.warn(
        ...
        switch (typeof u) {
            ...
            case 'function':
                return 'function';
            case 'object': {
                const r = { depth: t - 1, convertArrays: s },
                    a = (null == (n = u.constructor) ? void 0 : n.name) ?? 'UNKNOWN';
                switch (!0) {
                    case a.includes('CoherentArrayProxy'):
                        return [...u.values()].map((u) => e(r.convertArrays ? u.value : u, r));
                    case 'Dict' === a:
                        return [...u.entries()].reduce((u, [t, s]) => ((u[t] = e(s, r)), u), { $$type: 'Dict' });
                    case 'UNKNOWN' === a:
                        return 'UNKNOWN_TYPE';
                    case a.includes('ViewModel'):
                    default: {
                        const t = {};
                        for (const s in u) Object.prototype.hasOwnProperty.call(u, s) && (t[s] = e(u[s], r));
                        return t;
                    }
                }
            }
...
async function runView(
    e,
    { root: u = document.getElementById('root'), withMedia: t = !0, fullScreen: s = !1, immediateLayout: n = !0 } = {},
) {
    var r;
    injectShowModel();
    const a = t ? MediaWrapper : React.Fragment,
        o = (null == (r = null == window ? void 0 : window.engine) ? void 0 : r.whenReady) ?? Promise.resolve();
    (n && engine.enableImmediateLayout(!0),
        ...
        s && (initExternalPaddings$1(u), enableFullScreenModeSupported$1()));
}
...
const base$c = 'SceneWrapper_52fcfc1e',
    base__down = 'SceneWrapper_base__down_4ece5089',
    base__moveSpaceDisabled = 'SceneWrapper_base__moveSpaceDisabled_1b1cd939',
    styles$e = { base: base$c, base__down: base__down, base__moveSpaceDisabled: base__moveSpaceDisabled },
...
function SceneWrapper({
    ...
    const [o, i] = reactExports.useState(!1),
        ...
        [d, E] = reactExports.useState({ x: 0, y: 0 }),
    ...
    const m = useEvent((e) => (null == s ? void 0 : s(e)));
    function _(e) {
        if (!p.current) return;
        const { left: u, right: t, top: s, bottom: n } = p.current.getBoundingClientRect();
        return !(e.clientX < u || e.clientY < s || e.clientX > t || e.clientY > n);
    }
    function A(e) {
    ...
    return (
        ...
        jsxRuntimeExports.jsx('div', {
            ...a,
            ref: p,
            className: cx(styles$e.base, o && styles$e.base__down, !n && styles$e.base__moveSpaceDisabled, r),
            onMouseDown: function (e) {
                (e.preventDefault(), A(e) && (i(!0), c(!0), E({ x: e.clientX, y: e.clientY })));
            },
            onMouseMove: function (e) {
                if ((e.preventDefault(), o && l)) {
                    ...
                    (E({ x: e.clientX, y: e.clientY }), u({ dx: t, dy: s, dz: 0 }));
                }
            },
            onMouseUp: function () {
                i(!1);
            ...
            onWheel: function (e) {
                ...
                const t = e.deltaY < 0;
                u({ dx: 0, dy: 0, dz: t ? -DELTA_Z : DELTA_Z });
            },
            onMouseOver: function (e) {
                (t({ isOver3dScene: !0 }), A(e) && (i(!0), E({ x: e.clientX, y: e.clientY })));
            },
            onMouseOut: function () {
                (t({ isOver3dScene: !1 }), i(!1));
            },
            children: e,
        })
    );
...
function parse(e, u) {
    ...
    for (let i = 0; i < e.length; i++) {
        const l = e[i];
        if (l === u.start[0] && e.slice(i, i + u.start.length) === u.start) {
            if (n) {
                if (s.length > 0) {
                    s[s.length - 1].node.children.push({ type: NodeTypes.Text, value: n });
                } else t.push({ type: NodeTypes.Text, value: n });
                n = '';
            }
            ((r = !0), (i += u.start.length - 1));
        } else if (l === u.end[0] && e.slice(i, i + u.end.length) === u.end) {
            ((r = !1), (i += u.end.length - 1));
            const e = a.trim();
            if (e.startsWith('@')) {
                const u = e.slice(1).trim(),
                    n = { type: NodeTypes.Tag, attrs: u.split('|'), instanceId: ++o, children: [] };
                if (s.length > 0) {
                    s[s.length - 1].node.children.push(n);
                } else t.push(n);
                s.push({ node: n, startIndex: t.length });
            } else if ('/' === e) s.length > 0 && s.pop();
            else {
                const u = { type: NodeTypes.Var, instanceId: ++o, name: e };
                if (s.length > 0) {
                    s[s.length - 1].node.children.push(u);
                } else t.push(u);
            }
            a = '';
        } else r ? (a += l) : (n += l);
...
function splitString(e) {
    const u = resources.resolve('langCode');
    return addSpaceAndMap(
        splitLocale(e, u),
        u,
        (e, u) => e && jsxRuntimeExports.jsx('span', { children: e }, `${e}${u}`),
    );
}
function splitArray(e) {
    ...
    for (let t = 0; t < e.length; t++) {
        ...
        const r = splitString(n.slice(1));
        (u.push(
            jsxRuntimeExports.jsxs(
                reactExports.Fragment,
                {
                    children: [
                        jsxRuntimeExports.jsxs('span', { className: styles$d.nowrap, children: [split(s), n[0]] }),
                        r,
                    ],
                },
                takeKey(),
    ...
    return jsxRuntimeExports.jsx(
        'span',
        {
            style: u.reduce((t, s) => {
                ...
                return (console.warn(`Invalid argument ${s} in ${e}: ${u}`), t);
            }, {}),
            children: e,
        },
        takeKey(),
...
const color = (e, u) => ['color', u],
    fontSize = (e, u) => ['fontSize', u],
    fontWeight = (e, u) => ['fontWeight', u],
    textDecoration = (e, u) => ['textDecoration', u],
    bold = (e) => ['fontWeight', 'bold'];
function colorLegacy(e, u) {
    const t = takeKey();
    return legacyColors.has(String(u))
        ? jsxRuntimeExports.jsx('span', { className: `FormatText_colorLegacy__${u}`, children: e }, t)
        : jsxRuntimeExports.jsx('span', { style: { color: `#${u}` }, children: e }, t);
}
...
function applyFunction(e, u, t, s) {
    const n = t.map((u) => {
            if ('string' != typeof u) return u;
            const t = u.trim();
            if (t.startsWith('(') && t.endsWith(')')) {
                const [u, ...n] = t.slice(1, -1).split(' ');
                return u ? applyFunction(e, u, n, s) : e;
            }
            return t.startsWith("'") && t.endsWith("'") ? t.slice(1, -1) : t;
        }),
        r = s[u];
    return r ? r(e, ...n) : (console.error(`Function ${u} is not registered`), e);
}
function applyFunctions(e, u, t) {
    return e.reduce((e, u) => {
        const [s, ...n] = parseArguments(u.trim());
        return s ? applyFunction(e, s, n, t) : e;
    }, u);
}
function isEnd(e) {
    return !((e >= 'a' && e <= 'z') || (e >= 'A' && e <= 'Z') || (e >= '0' && e <= '9') || '_' === e);
}
function resolveAttrParams(e, u) {
    for (let t = 0; t < e.length; t++) {
        if ('$' === e[t]) {
            let s = t + 1;
...
function resolveAttrsParams(e, u) {
    const t = [];
    for (let s = 0; s < e.length; s++) t[s] = resolveAttrParams(e[s], u);
    return t;
}
const primitives = ['number', 'string', 'undefined'];
function render(e, u, t = {}, s = !0) {
    s && (keyId = 0);
    const n = [];
    function r(e) {
        if (primitives.includes(typeof e)) {
            const u = n.at(-1);
            if ('string' == typeof u) return void (n[n.length - 1] = u + e);
        }
        n.push(e);
    }
    for (const a of e)
        if (a.type === NodeTypes.Text) r(a.value);
        else if (a.type === NodeTypes.Var)
            null === t[a.name] || primitives.includes(typeof t[a.name])
                ? r(t[a.name] ?? `{{${a.name}}}`)
                : n.push(
            ...
            const e = render(a.children, u, t, !1),
                s = applyFunctions(resolveAttrsParams(a.attrs, t), e, u);
            n.push(s);
        }
    return n;
}
...
const defaultBrackets = { start: '{{', end: '}}' },
    FormatText$1 = reactExports.memo(function (e) {
        const {
            ...
            E = reactExports.useMemo(() => parse(i ? `{{@ split}}${c}{{/}}` : c, u), [u, c, i]),
            p = reactExports.useMemo(() => render(E, d, e.params), [E, d, e.params]),
            m = cx(styles$d.base, r && styles$d.base__fullSize, l.className);
        return e.inline
            ? (console.warn(
...
const multiValueTypes = [
    ...
    getDogTypeImage = (e, u, t) => {
        const s = DOG_TAG_FOLDER_NAMES[e];
        if (s) {
            const n = R.images.gui.maps.icons.dogtags.$dyn(u).$dyn(s),
                r = n.$dyn(t);
            return !r && DOG_TAG_DEFAULT_ICON_NAME[e] ? `${n.$dyn(DOG_TAG_DEFAULT_ICON_NAME[e])}` : `${r}`;
        }
        return (
    ...
    getRewardImage = (e, u = ImageSize.Small) => {
        const { name: t, type: s, value: n, icon: r, item: a, dogTagType: o } = e,
            i = u === ImageSize.S24x24 ? ImageSize.Small : u,
            l = getSizeFolder(i);
        switch (t) {
            case 'basic':
            case 'plus':
            ...
            case 'premium':
            case 'premium_plus':
                return `R.images.gui.maps.icons.quests.bonuses.${i}.${t}_${n}`;
            case 'items':
                return `R.images.gui.maps.icons.quests.bonuses.${i}.${a}`;
            case 'blueprints':
            case 'blueprintsAny':
            case 'finalBlueprints':
                return `R.images.gui.maps.icons.blueprints.fragment.${i}.${r}`;
            case 'tokens':
            case 'lootBox':
            case 'battleToken':
                return 'big' === u ? e.iconBig.replace('..', 'img://gui') : e.iconSmall.replace('..', 'img://gui');
            case 'customizations':
            case 'styleProgress':
            case 'crewSkins':
            case 'goodies':
            ...
            case 'battlePassSelectToken':
                return `R.images.gui.maps.icons.quests.bonuses.${i}.${r}`;
            case 'crewBooks':
                return `R.images.gui.maps.icons.crewBooks.books.${i}.${r}`;
            case 'dogTagComponents':
                return getDogTypeImage(o, i, r);
            case 'dossier_badge':
            ...
            default:
                return `R.images.gui.maps.icons.quests.bonuses.${i}.${t}`;
        }
    },
    getRewardTooltipConfig = (e, u) => ({ args: e, contentId: u }),
    SIZES_WITH_BOTTOM_HIGHLIGHT = [ImageSize.Small, ImageSize.Big],
    getBottomHighlight = (e, u) => {
        if (void 0 === u || !SIZES_WITH_BOTTOM_HIGHLIGHT.includes(e)) return null;
        switch (u) {
    ...
    getFormattedValue = (e, u) => {
        const t = resources.resolve('intl');
        if (void 0 === e) return null;
        switch (u) {
...
function renderString(e, u = {}) {
    const t = parse(e, defaultBrackets);
    return String(render(t, formatters, u));
}
const root$4 = 'Reward_root_21f091ec',
    base$a = 'Reward_d65e1e12',
    ...
    Reward = ({
        ...
        const m = SIZE_MAP.has(n) ? SIZE_MAP.get(n) : n,
            _ = getBottomHighlight(n, r),
            A = getOverlay(r),
            F = getFormattedValue(a, o),
            g = useTooltip({
                contentId: (null == E ? void 0 : E.contentId) ?? 0,
                args: null == E ? void 0 : E.args,
                resId: null == E ? void 0 : E.resId,
                decoratorId: null == E ? void 0 : E.decoratorId,
            }),
            f = useSimpleTooltip({ header: null == p ? void 0 : p.header, body: null == p ? void 0 : p.body });
        return jsxRuntimeExports.jsxs('div', {
            className: cx(styles$c.base, styles$c[`base__${n}`], !s && styles$c.base__dynamicBox, c),
            style: l,
            ...g,
            children: [
                jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                    children: [
                        jsxRuntimeExports.jsxs('div', {
                            className: cx(
                                styles$c.image,
                                s ? styles$c.image__fixedBox : styles$c[`image__${n}`],
                                null == d ? void 0 : d.image,
                            ),
                            children: [
                                _ &&
                                    jsxRuntimeExports.jsx('div', {
                                        className: cx(styles$c.highlight, null == d ? void 0 : d.highlight),
                                        style: {
                                            backgroundImage: `url(${images.readOrEmpty(`quests.bonuses.${m}.${_}_highlight`)})`,
                                        },
                                    }),
                                u &&
                                    jsxRuntimeExports.jsx('div', {
                                        className: cx(styles$c.icon, null == d ? void 0 : d.rewardIcon),
                                        style: { backgroundImage: `url(${u})` },
                                    }),
                                A &&
                                    jsxRuntimeExports.jsx('div', {
                                        className: cx(styles$c.overlay, null == d ? void 0 : d.overlay),
                                        style: {
                                            backgroundImage: `url(${images.readOrEmpty(`quests.bonuses.${m}.${A}_overlay`)})`,
                                        },
                                    }),
                            ],
                        }),
                        ...
                        i && jsxRuntimeExports.jsx('div', { className: styles$c.title, children: i }),
                    ],
                }),
                t &&
                    jsxRuntimeExports.jsx('div', {
                        className: cx(styles$c.timer, null == d ? void 0 : d.periodicIcon),
                        ...f,
                    }),
            ],
        });
    },
    base$9 = 'RewardsList_b956755b',
    ...
    Rewards = reactExports.memo(function ({
        ...
        const d = resources.resolve('strings'),
            E = resources.resolve('images'),
            p =
                'number' == typeof n && n < e.length
                    ? `${E.readOrEmpty(`quests.bonuses.${sizeToDefault[t] ?? t}.default`)}`
                    : void 0,
            m =
                i ||
        ...
        return jsxRuntimeExports.jsx('div', {
            className: cx(styles$b.base, s && styles$b.base__vertical, r),
            children:
                void 0 !== p
                    ? jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                          children: [
                              e
                                  ...
                                  .map((e, n) =>
                                      jsxRuntimeExports.jsx(
                                          'div',
                                          {
                                              className: cx(styles$b.reward, s && styles$b.reward__vertical, a),
                              ...
                              jsxRuntimeExports.jsx('div', {
                                  ...
                                  children: jsxRuntimeExports.jsx(Reward, {
                                      ...
                                      value: m,
                                      tooltipArgs: o,
                                      className: cx(styles$b.boxRewardClassName, l),
                                      classNames: c,
                                  }),
                              }),
                          ],
                    ...
                    : e.map((e, n) =>
                          jsxRuntimeExports.jsx(
                              ...
                              {
                                  className: cx(styles$b.reward, s && styles$b.reward__vertical, a),
                                  children: jsxRuntimeExports.jsx(Reward, { size: t, isFixedBoxSize: u, ...e }),
                              },
                              n,
                          ),
                      ),
...
let ClickOutsideManager$1 =
    ((_b = class {
        ...
        unregister(e, u) {
            const t = e,
                s = u;
            ((this.entries = this.entries.filter(({ container: e, callback: u }) => e !== t || u !== s)),
            ...
            (u, t) => (
                (u[t] = (function (u) {
                    return (t) => {
                        ...
                        let n = !0;
                        const r = `mouse${u}`,
                            a = internalMouse[u]((e) => t([e, 'outside']));
                        function o(e) {
                            t([e, 'inside']);
                        }
                        return (
                            ...
                            s(),
                            () => {
                                n && (a(), window.removeEventListener(r, o), (e.listeners -= 1), s(), (n = !1));
                            }
                        );
                    };
                })(t)),
...
const sounds = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
    plays = Object.keys(sounds).reduce((e, u) => ((e[u] = () => playSound(sounds[u])), e), {}),
...
const children = Object.freeze(
    ...
    sendViewEvent = (e, u) => {
        ...
        if (void 0 !== u) {
            const { args: s, ...n } = u;
            return void 0 !== s
                ? viewEnv.handleViewEvent({ __Type: t, type: e, ...n, arguments: createViewEventArguments$1(s) })
                : viewEnv.handleViewEvent({ __Type: t, type: e, ...n });
        }
        return viewEnv.handleViewEvent({ __Type: t, type: e });
    },
...
function getBrowserTexturePath(e, u, t, s = 1) {
    return viewEnv.getWebBrowserTexturePath(e, u, t, s);
}
...
const view = Object.freeze(
    ...
    _DataTracker = class e {
        ...
        addCallback(e, u, t = 0, s = !0) {
            ...
            const n = env.view.addModelObserver(e, t, s);
            return (
                n > 0
                    ? ((this._callbacks[n] = u),
...
function dumpViewModel(e) {
    ...
    for (const t in e)
        if (Object.prototype.hasOwnProperty.call(e, t)) {
            const s = Object.prototype.toString.call(e[t]);
            if (s.startsWith('[object CoherentArrayProxy]')) {
                const s = e[t];
                u[t] = [];
                for (let e = 0; e < s.length; e++) u[t].push({ value: dumpViewModel(s[e].value) });
            } else s.startsWith('[object class BW::WULF::ViewModel') ? (u[t] = dumpViewModel(e[t])) : (u[t] = e[t]);
        }
    return u;
}
const SystemLocale = {
...
const makeGlobalBoundingBox = (e) => ({ __Type: 'GFBoundingBox', x: e.x, y: e.y, width: e.width, height: e.height }),
    ...
    handleViewEvent$1 = (e, u) => {
        ...
        if (void 0 !== u) {
            const { args: s, ...n } = u;
            void 0 !== s
                ? viewEnv.handleViewEvent({ __Type: t, type: e, ...n, arguments: createViewEventArguments(s) })
                : viewEnv.handleViewEvent({ __Type: t, type: e, ...n });
    ...
    sendShowPopOverEvent = (e, u, t, s, n = R.invalid('resId'), r) => {
        const a = env.view.getViewGlobalPosition(),
            { x: o, y: i, width: l, height: c } = t.getBoundingClientRect(),
            d = {
...
const handleViewEvent = (e, u, t = {}, s = 0) => {
        ...
        const _ = reactExports.useRef({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
            ...
            F = reactExports.useCallback(() => {
                (_.current.isVisible && _.current.timeoutId) ||
                    (handleViewEvent(u, l, { isMouseEvent: !0, on: !0, arguments: getViewEventArguments(t) }, A),
                    E && E(),
            ...
            f = reactExports.useCallback((e) => {
                _.current.isVisible &&
                    ...
                    (_.current.hideTimerId = window.setTimeout(() => {
                        ...
                        u && !u.isSameNode(_.current.prevTarget) && g();
                    }, 200)));
            }, []);
        (reactExports.useEffect(() => {
                  ...
                  onMouseEnter:
                      ...
                      (e) => {
                          (e.clientX === window.innerWidth && e.clientY === window.innerHeight) ||
                              ...
                              (_.current.timeoutId = window.setTimeout(F, o ? SHOW_DELAY_MIN : SHOW_DELAY_DEFAULT)),
                              s && s(e),
                              D && D(e));
                      }),
                  onMouseLeave: ((e) => (u) => {
                      (g(), null == n || n(u), null == e || e(u));
                  })(e.props.onMouseLeave),
                  onClick: ((e) => (u) => {
                      (!1 === i && g(), null == a || a(u), null == e || e(u));
                  })(e.props.onClick),
                  onMouseDown: ((e) => (u) => {
                      (!1 === i && g(), null == r || r(u), null == e || e(u));
                  })(e.props.onMouseDown),
                  ...m,
              })
            : e;
...
function withResolvePath(e) {
    ...
    return reactExports.forwardRef(function (e, t) {
            ...
            o = { ...r, ref: t };
        {
            ...
            return e ? jsxRuntimeExports.jsx(u, { ...o, src: e }) : jsxRuntimeExports.jsx(u, { ...o, unknown: !0 });
        }
    });
}
...
withResolvePath(
    reactExports.forwardRef(function (e, u) {
        ...
        return e.unknown
            ...
            : jsxRuntimeExports.jsx('img', { ...i, ref: u, src: n, width: t, height: s });
    }),
);
...
function defineStyledComponent(e, u, t) {
    var s;
    const n =
            'object' == typeof u && 'cva' in u
                ? null == (s = u.cva)
                    ? void 0
                    : s.variants
                : null == t
    ...
    if ('object' == typeof u) {
        const t = u,
            s = cva(t.className, t.cva),
            n = t.element,
            a = reactExports.forwardRef(function (e, u) {
        ...
        return ((a.displayName = e), t.cva && (a.cva = t.cva), a);
    }
    const a = cva(u, t),
        o = reactExports.forwardRef(function (u, t) {
            return jsxRuntimeExports.jsx('div', { 'data-name': e, ...cleanProps(r, u), ref: t, className: a(u) });
        });
    return ((o.displayName = e), t && (o.cva = t), o);
}
function cleanProps(e, u) {
...
const base$8 = 'HeadlessButton_df8536fc',
    ...
    HeadlessButton = reactExports.forwardRef(function (
        { children: e, onClick: u, onMouseEnter: t, soundTarget: s, disabled: n = !1, silent: r = !1, ...a },
        o,
    ) {
        const i = useSounds();
        return jsxRuntimeExports.jsx(HeadlessButtonBase, {
            ...
            onMouseEnter: function (e) {
                (n || r || i.play('mouse-enter', { target: s || 'Button', original: e }), null == t || t(e));
            },
            onClick: function (e) {
                n || (r || i.play('click', { target: s || 'Button', original: e }), null == u || u(e));
            },
            children: e,
        });
    }),
    ...
    Button = reactExports.forwardRef(function (
        ...
        return jsxRuntimeExports.jsxs(HeadlessButton, {
            ...
            className: cx(
                styles$9.base,
                styles$9[`base__size-${u}`],
                styles$9[`base__theme-${t}`],
                s ? styles$9.base__disabled : styles$9.base__enabled,
                o,
                null == a ? void 0 : a.base,
            ),
            onClick: function (e) {
                var u;
                s || null == (u = i.onClick) || u.call(i, e);
            },
            children: [
                jsxRuntimeExports.jsx('div', { className: cx(styles$9.background, null == a ? void 0 : a.background) }),
                jsxRuntimeExports.jsx('div', { className: cx(styles$9.border, null == a ? void 0 : a.border) }),
                jsxRuntimeExports.jsx('div', { className: cx(styles$9.overlay, null == a ? void 0 : a.overlay) }),
                jsxRuntimeExports.jsx('div', {
                    className: cx(styles$9.content, r && styles$9.content__fontAligned, null == a ? void 0 : a.content),
                    children: e,
                }),
            ],
        });
...
function useInputInstance({ value: e, size: u, type: t, state: s, disabled: n }) {
    const r = reactExports.useRef(null),
        ...
        i = useEvent((e) => {
            ...
            if (!r.current) return;
            const t =
                null == (u = Object.getOwnPropertyDescriptor(HTMLInputElement.prototype, 'value')) ? void 0 : u.set;
            if (t) {
                t.call(r.current, e);
    ...
    return (
        ...
        reactExports.useLayoutEffect(() => {
            ...
            a
                ...
                : null == (u = r.current) || u.blur();
        }, [a]),
        reactExports.useMemo(
            () => ({
                value: e,
                size: u ?? defaultConfig.size,
                type: t ?? defaultConfig.type,
                state: s ?? defaultConfig.state,
                disabled: l,
                focused: a,
                setFocused: o,
                inputRef: r,
...
const root$2 = 'Input_root_494bd5d6',
    disabledOverlay = 'Input_disabledOverlay_3e980046',
    ...
    ClearButton = reactExports.forwardRef(function ({ className: e, children: u, ...t }, s) {
        const n = useSounds(),
            { value: r, clear: a, size: o, disabled: i, focus: l } = useInput(),
            c = useUpscale(void 0, styles$8.clearButton__upscale);
        return jsxRuntimeExports.jsx('button', {
            ...t,
            type: 'button',
            ref: s,
            className: cx(
                styles$8.clearButton,
                r && !i && styles$8.clearButton__visible,
                styles$8[`clearButton__${o}Size`],
                c,
                e,
            ),
            onMouseEnter: function (e) {
                ...
                (n.play('mouse-enter', { target: soundPlayEventTarget$1, original: e }),
                    null == (u = t.onMouseEnter) || u.call(t, e));
            },
            onClick: function (e) {
                var u;
                (n.play('close', { target: soundPlayEventTarget$1, original: e }),
                    ...
                    r && a(),
                    l(),
                    null == (u = t.onClick) || u.call(t, e));
            },
            children: u,
        });
    }),
    soundPlayEventTarget = 'Input:Decoration',
    Decoration = reactExports.forwardRef(function ({ className: e, children: u, ...t }, s) {
        const n = useSounds(),
            { state: r, disabled: a, focused: o, focus: i } = useInput();
        return jsxRuntimeExports.jsxs('div', {
            ...t,
            ref: s,
            className: cx(
                styles$8.decoration,
                styles$8[`decoration__${r}State`],
                a && styles$8.decoration__disabled,
                o && styles$8.decoration__focused,
                e,
            ),
            onMouseEnter: function (e) {
                var u;
            ...
            children: [jsxRuntimeExports.jsx('div', { className: styles$8.disabledOverlay }), u],
        });
    }),
...
function findFirstSeparatorIndex(e) {
    for (let u = 0; u < e.length; u++) {
        const t = e[u];
        if (allowSeparators.has(t)) return u;
    }
}
function cleanInputNumber(e) {
    const u = e.replace(/[^0-9,.]/g, '');
    if ('0' === u) return u;
    const t = u.replace(/^0+(?!\b)/, '').replace(/(,|\.){2,}/g, '$1'),
        s = findFirstSeparatorIndex(t);
...
const Placeholder = reactExports.forwardRef(function (
        { visibility: e = placeholderVisibility.focusedOrValue, className: u, children: t, ...s },
        n,
    ) {
        const { focused: r, value: a, size: o, disabled: i } = useInput();
        if (!{ focusedOrValue: r || a, value: a }[e])
            return jsxRuntimeExports.jsx('div', {
                ...s,
                ref: n,
                className: cx(
                    styles$8.placeholder,
                    i && styles$8.placeholder__disabled,
                    styles$8[`placeholder__${o}Size`],
                    u,
                ),
                children: t,
            });
    ...
    Field = reactExports.forwardRef(function (
        { className: e, classNames: u, wrapperRef: t, placeholderRef: s, placeholderVisibility: n, children: r, ...a },
        o,
    ) {
        const { type: i, value: l, disabled: c, size: d, inputRef: E, focused: p, setFocused: m } = useInput();
        return jsxRuntimeExports.jsxs('div', {
            className: cx(styles$8.fieldWrapper, null == u ? void 0 : u.wrapper),
            ref: t,
            children: [
                jsxRuntimeExports.jsx('input', {
                    ...
                    className: cx(
                        styles$8.field,
                        styles$8[`field__${d}Size`],
                        p && styles$8.field__focused,
                        c && styles$8.field__disabled,
                        e,
                    ),
                    onChange: function (e) {
                        var u, t;
                        if (c) return (e.preventDefault(), void (null == (u = E.current) || u.blur()));
                        const { value: s } = e.target;
                        (i === types.number
                            ? (e.target.value = cleanInputNumber(s))
                            : i === types.integer && (e.target.value = cleanInputInteger(s)),
                            null == (t = a.onChange) || t.call(a, e));
                    },
                    onFocus: function (e) {
                        var u;
                        (m(!0), null == (u = a.onFocus) || u.call(a, e));
                    },
                    onBlur: function (e) {
                        var u;
                        (m(!1), null == (u = a.onBlur) || u.call(a, e));
                    },
                    onDoubleClick: function (e) {
                        var u, t;
                        (null == (u = E.current) || u.select(), null == (t = a.onDoubleClick) || t.call(a, e));
                    },
                }),
                'string' == typeof r || 'number' == typeof r
                    ? jsxRuntimeExports.jsx(Placeholder, {
                          className: null == u ? void 0 : u.placeholder,
                          ref: s,
                          visibility: n,
                          children: r,
                      })
    ...
    Icon = reactExports.forwardRef(function ({ className: e, icon: u, children: t, ...s }, n) {
        const { size: r, focused: a } = useInput(),
            o = useUpscale(void 0, styles$8.icon__upscale);
        return jsxRuntimeExports.jsx('div', {
            ...s,
            ref: n,
            className: cx(
                styles$8.icon,
                styles$8[`icon__${r}Size`],
                a && styles$8.icon__focused,
                u && iconsSet.has(u) && styles$8[`icon__${u}Icon`],
                o,
                e,
            ),
            style: u && !iconsSet.has(u) ? { '--background-image': `url(${u})` } : void 0,
            children: t,
        });
    }),
    Message = reactExports.forwardRef(function (
        { className: e, type: u = messageTypes.alert, visible: t = !0, children: s, ...n },
        r,
    ) {
        ...
        return jsxRuntimeExports.jsx('div', {
            ...
            className: cx(
                styles$8.message,
                t && styles$8.message__visible,
                styles$8[`message__${u}Type`],
                styles$8[`message__${a}Size`],
                e,
            ),
            children: s,
        });
    });
function Provider({ children: e, ...u }) {
    return jsxRuntimeExports.jsx(contextInstance.Provider, { value: useInputInstance(u), children: e });
}
const Input = reactExports.forwardRef(function ({ value: e, state: u, disabled: t, type: s, size: n, ...r }, a) {
    return jsxRuntimeExports.jsx(Provider, {
        ...
        state: u,
        disabled: t,
        children: jsxRuntimeExports.jsx(Decoration, { children: jsxRuntimeExports.jsx(Field, { ...r, ref: a }) }),
    });
});
((Input.types = types),
    ...
    createApiHook = ({
        ...
        return (o = {}) => {
            const { settings: i = defaultSettings } = o,
                ...
                g = reactExports.useCallback(
                    (e, u, t) => {
                        const s = A.scrollPosition.get(),
                            n = (A.scrollPosition.goal ?? 0) - s;
                        return a(e, u * t + n + s);
                    },
                    [A.scrollPosition],
                ),
                f = reactExports.useCallback(
                    function (e, { immediate: u = !1, reset: t = !0 } = {}) {
                        ...
                        if (!s) return;
                        const n = a(s, e);
                        A.scrollPosition.goal !== n &&
                            F.start({
                                scrollPosition: n,
                                immediate: u,
                                reset: t,
                                config: i.animationConfig,
                                from: { scrollPosition: a(s, A.scrollPosition.get()) },
                                onChange: () => {
                                    r && _();
                                },
                            });
                    },
                    [A.scrollPosition, F, i.animationConfig, _],
                ),
                ...
                h = reactExports.useCallback(
                    function (e) {
                        l ||
                            (0 !== e.deltaY && D(s(e)),
                            d.current && m.trigger('mouseWheel', e, A.scrollPosition, u(d.current)));
                    },
                    [A.scrollPosition, D, m, l],
                ),
                B = reactExports.useCallback(
                    function () {
                        const e = d.current;
                        e && (f(a(e, A.scrollPosition.goal), { immediate: !0 }), m.trigger('resizeHandled'));
                    },
                    [f, A.scrollPosition.goal, m],
                );
            useRefResizeObserver(E, (e) => {
                const u = e.target;
                if (!(u instanceof HTMLElement)) return;
                const t = n(u);
                p.current.wrapper !== t && B();
            });
            const b = useEvent(function () {
                    const u = d.current;
                    if (!u) return;
                    const t = e(u),
                        s = E.current ? n(E.current) : 0;
                    if (p.current.container !== t || p.current.wrapper !== s) {
                        const e = a(u, A.scrollPosition.goal);
                        (e !== A.scrollPosition.goal && f(e, { immediate: !0 }),
                            (p.current.container = t),
                            (p.current.wrapper = s),
                            m.trigger('recalculateContent'));
                    }
                }),
                C = useSkipFrame();
            reactExports.useEffect(() => addEventListener(window, 'resize', () => C.run(B)), [B, C]);
            return reactExports.useMemo(
                () => ({
                    getWrapperSize: () => (E.current ? n(E.current) : void 0),
                    getContainerSize: () => (d.current ? e(d.current) : void 0),
                    getBounds: () =>
                        d.current ? u(d.current) : (console.warn('getBounds: contentRef.current is null'), [0, 0]),
                ...
                [i, h, f, D, F, A, b, l, c, m.on, m.off],
            );
        };
    },
    IGNORE_DEFAULT = [2, 2];
function useScrollBounding(e, [u, t] = IGNORE_DEFAULT) {
    const [s, n] = reactExports.useState(!0),
        [r, a] = reactExports.useState(!0);
    return (
        reactExports.useEffect(() => {
            function s() {
...
function updateDisabledStates(e, u) {
    if (!e.trackRef.current || !e.thumbRef.current) return;
    const t = e.trackRef.current.parentNode;
    if (t instanceof HTMLElement) {
        if (0 === u) return (t.classList.add(BACKWARD_DISABLED), void t.classList.remove(FORWARD_DISABLED));
        if (e.isBoundThumb(u)) return (t.classList.remove(BACKWARD_DISABLED), void t.classList.add(FORWARD_DISABLED));
        (t.classList.remove(BACKWARD_DISABLED), t.classList.remove(FORWARD_DISABLED));
    }
}
function Thumb(e) {
    const u = reactExports.useRef(null),
        [t, s] = reactExports.useState(!1),
        n = useEvent(function () {
            const t = u.current,
                s = e.trackRef.current,
                n = e.api.getWrapperSize(),
                r = e.api.getContainerSize();
            if (!(n && r && t && s)) return;
            const a = Math.min(1, n / r),
                o = 'horizontal' === e.direction ? 'width' : 'height';
            return ((t.style[o] = `${e.calculateSize(s, a)}px`), (t.style.display = 'flex'), a);
        }),
        [r, a] = useSpring(() => ({
    ...
    reactExports.useEffect(() => {
        t || e.dragging
            ? a.start({
                  ...
                  onRest() {
                      var e;
                      null == (e = u.current) || e.classList.add(styles$7.base__active);
                  },
              })
            : a.start({
                  to: e.styles.closed,
                  ...
                  onRest() {
                      var e;
                      null == (e = u.current) || e.classList.remove(styles$7.base__active);
                  },
              });
    }, [t, e.dragging, e.styles.closed, e.styles.opened, a]);
    const o = useEvent(function () {
            ...
            const c = e.api.animationScroll.scrollPosition.get(),
                ...
                m = (('horizontal' === e.direction ? s.offsetWidth : s.offsetHeight) - p) * E || 0,
                _ = Math.round((2 * E - 1) * BOUNCING_OFFSET);
            (n.style.setProperty('--thumbOffset', `${m}px`),
                null == (t = e.onUpdate) || t.call(e, { thumbSize: p, thumbOffset: m, newBouncingCorrection: _ }));
            const A = 0 === m || e.isBoundThumb(m) ? 0 : _;
            return (
                a.start({
        ...
        l = useEvent(function () {
            n();
            const u = o();
            'number' == typeof u && updateDisabledStates(e, u);
        });
    ...
    return (
        ...
        jsxRuntimeExports.jsxs(animated.div, {
            ref: assignRefs([u, e.thumbRef]),
            className: cx(styles$7.base, styles$7[`base__${e.direction}`], e.className),
            style: r,
            onMouseEnter: () => s(!0),
            onMouseLeave: () => s(!1),
            children: [
...
function useBarDragging(e, u, t, s, n) {
    const [r, a] = reactExports.useState(initBarDraggingState),
        o = useEvent(u),
        i = reactExports.useCallback(
            (u) => {
                (a(u), e.current && o({ type: u.pending ? 'dragStart' : 'dragEnd', dragElement: e.current }));
            },
            [o, e],
        );
    return (
        reactExports.useEffect(() => {
            if (!r.pending) return;
            const u = mouse.move(function ([u]) {
                    const a = t.contentRef.current;
                    if (!a) return;
                    const i = s.current,
                        l = e.current;
                    if (!a || !i || !l) return;
                    const c = n(u, r, { parent: i, thumb: l }),
                        d = c * (t.getContainerSize() ?? 0);
                    (t.scrollPosition.start({
                        scrollPosition: t.clampPosition(a, d),
                        reset: !0,
                        immediate: !0,
        ...
        }, [t, r.offset, r.pending, o, i, e, s, r, n]),
        i
    );
}
const DISABLE_CLASS = 'disable',
    ACTIVE_CLASS = 'scroll-active';
function useUpdateStatesBar({ api: e, baseRef: u }) {
    const t = useSkipFrame(),
        s = useEvent(function () {
            const t = e.getWrapperSize(),
                s = e.getContainerSize();
            if (null === u.current || void 0 === s || void 0 === t) return;
            1 === Math.min(1, t / s || 1)
                ? u.current.classList.remove(ACTIVE_CLASS)
                : u.current.classList.add(ACTIVE_CLASS);
        });
    (reactExports.useEffect(() => t.run(s)),
        reactExports.useEffect(() => {
            function u() {
                t.run(s);
            }
...
function getElementCoordinates(e, u) {
    const t = e.getBoundingClientRect(),
        s = u === scrollOrientations.horizontal ? t.x : t.y;
    return { start: s, end: u === scrollOrientations.horizontal ? s + t.width : s + t.height };
}
function getCoordinate(e, u, t, s, n, r) {
    return {
        occurredEvent: r === scrollOrientations.horizontal ? e.screenX : e.screenY,
        bar: getElementCoordinates(u, r),
        thumb: getElementCoordinates(t, r),
        backButton: getElementCoordinates(s, r),
        forwardButton: getElementCoordinates(n, r),
    };
}
function useBarHandlers(e, u, t, s, n, r, a) {
    const o = useSounds(),
    ...
    const d = reactExports.useCallback(
        ...
        p = reactExports.useCallback(
            (i) => {
                ...
                const _ = getCoordinate(i, l, c, p, m, a),
                    A = _.thumb.start <= _.occurredEvent && _.occurredEvent <= _.thumb.end,
                    F =
                ...
                if (A) r({ pending: !0, offset: _.occurredEvent - _.thumb.start });
                else if (F) {
                    ((_.occurredEvent > _.thumb.start ? Direction.Prev : Direction.Next) === Direction.Next ? d : E)(i);
                } else {
                    const e = _.occurredEvent - _.bar.start,
                        u = _.thumb.end - _.thumb.start,
                        t = _.bar.end - _.bar.start,
                        s = n.getContainerSize();
                    if ('number' != typeof s || Number.isNaN(s)) return console.error('Incorrect container size');
                    const r = ((e - u / 2) / t) * s;
                    n.applyScroll(r);
                }
                o.play('click', { target: 'Scroll:' + (A ? 'thumb' : F ? 'button' : ''), original: i });
            },
            [e, u, t, s, o, a, r, d, E, n],
        ),
...
const rail$1 = 'HorizontalBar_rail_37858d8f',
    ...
    calculateThumbSize$1 = (e, u) => Math.max(remToPx$1(MIN_THUMB_SIZE), e.offsetWidth * u);
reactExports.memo(function ({ classNames: e = {}, onDrag: u = noop }) {
    const t = reactExports.useRef(null),
    ...
    useUpdateStatesBar({ baseRef: t, api: d });
    const E = useEvent((e, u, { parent: t }) => (e.screenX - u.offset - t.getBoundingClientRect().x) / t.offsetWidth),
        p = useEvent((e) => e - (r.current.offsetWidth - a.current.offsetWidth) >= -0.5),
        m = reactExports.useCallback(
            (e) => ('dragStart' === e.type ? c(!0) : 'dragEnd' === e.type && c(!1), u(e)),
            [u],
        ),
        _ = useBarDragging(a, m, d, r, E),
        A = useEvent(({ thumbSize: e, thumbOffset: u, newBouncingCorrection: t }) => {
            const s = r.current,
                n = o.current,
                a = i.current;
            if (!s || !n || !a) return;
            const l = remToPx$1(THUMB_TO_RAIL_OFFSET$1);
            ((n.style.width = `${u - l + t}px`), (a.style.width = s.offsetWidth - e - u - l - t + 'px'));
        }),
    ...
    return jsxRuntimeExports.jsxs('div', {
        className: cx(styles$6.base, e.base),
        ref: t,
        ...
        children: [
            jsxRuntimeExports.jsx('div', {
                ref: s,
                className: cx(styles$6.button, styles$6.button__left, e.leftButton),
            }),
            jsxRuntimeExports.jsxs('div', {
                ref: r,
                className: cx(styles$6.track, e.track),
                children: [
                    jsxRuntimeExports.jsx('div', {
                        ref: o,
                        className: cx(styles$6.rail, styles$6.rail__left, e.leftRail),
                    }),
                    ...
                    jsxRuntimeExports.jsx('div', {
                        ref: i,
                        className: cx(styles$6.rail, styles$6.rail__right, e.rightRail),
                    }),
                ],
            }),
            jsxRuntimeExports.jsx('div', {
                ref: n,
                className: cx(styles$6.button, styles$6.button__right, e.rightButton),
            }),
        ],
    });
});
...
const DEFAULT_VERTICAL_API_CONFIG = {
    ...
    calculateThumbSize = (e, u) => Math.max(remToPx$1(MIN_THUMB_SIZE), e.offsetHeight * u),
    Bar = reactExports.memo(function ({ classNames: e = {}, onDrag: u = noop }) {
        const t = reactExports.useRef(null),
            s = reactExports.useRef(null),
            n = reactExports.useRef(null),
            r = reactExports.useRef(null),
        ...
        useUpdateStatesBar({ baseRef: t, api: d });
        const E = useEvent((e) => e - (r.current.offsetHeight - a.current.offsetHeight) >= -0.5),
            p = useEvent(
                (e, u, { parent: t }) => (e.screenY - u.offset - t.getBoundingClientRect().y) / t.offsetHeight,
            ),
            m = reactExports.useCallback(
                (e) => ('dragStart' === e.type ? c(!0) : 'dragEnd' === e.type && c(!1), u(e)),
                [u],
            ),
            _ = useBarDragging(a, m, d, r, p),
            A = useEvent(({ thumbSize: e, thumbOffset: u, newBouncingCorrection: t }) => {
                const s = r.current,
                    n = o.current,
                    a = i.current;
                ...
                ((n.style.height = `${u - l + t}px`), (a.style.height = s.offsetHeight - e - u - l - t + 'px'));
            }),
            { handleMouseEnter: F, handleMouseDownTrack: g } = useBarHandlers(
                t,
                a,
        ...
        return jsxRuntimeExports.jsxs('div', {
            className: cx(styles$5.base, e.base),
            ref: t,
            onWheel: d.handleMouseWheel,
            onMouseDown: g,
            onMouseEnter: F,
            children: [
                jsxRuntimeExports.jsx('div', {
                    ref: s,
                    className: cx(styles$5.button, styles$5.button__top, e.topButton),
                }),
                jsxRuntimeExports.jsxs('div', {
                    ref: r,
                    className: cx(styles$5.track, e.track),
                    children: [
                        jsxRuntimeExports.jsx('div', {
                            ref: o,
                            className: cx(styles$5.rail, styles$5.rail__top, e.topRail),
                        }),
                        jsxRuntimeExports.jsx(Thumb, {
                            dragging: l,
                            api: d,
                        ...
                        jsxRuntimeExports.jsx('div', {
                            ref: i,
                            className: cx(styles$5.rail, styles$5.rail__bottom, e.bottomRail),
                        }),
                    ],
                }),
                jsxRuntimeExports.jsx('div', {
                    ref: n,
                    className: cx(styles$5.button, styles$5.button__bottom, e.bottomButton),
                }),
            ],
        });
    }),
    ...
    DefaultScroll = ({
        ...
        return jsxRuntimeExports.jsxs('div', {
            ...
            children: [
                jsxRuntimeExports.jsx('div', {
                    className: cx(styles$4.area, s),
                    children: jsxRuntimeExports.jsx(Area, { className: n, classNames: r, children: e }),
                }),
                jsxRuntimeExports.jsx(Bar, { onDrag: a, classNames: i }),
            ],
        });
    },
    Area = ({ className: e, classNames: u, children: t, ...s }) => {
        ...
        return (
            ...
            jsxRuntimeExports.jsx('div', {
                className: cx(styles$4.base, null == u ? void 0 : u.wrapper, e),
                ref: n.wrapperRef,
                onWheel: n.handleMouseWheel,
                children: jsxRuntimeExports.jsx('div', {
                    ...s,
                    className: cx(styles$4.content, null == u ? void 0 : u.content),
                    ref: n.contentRef,
                    children: t,
                }),
            })
...
function Base$2({ children: e }) {
    const u = useApi(),
        t = reactExports.useMemo(() => ({ api: u }), [u]);
    return jsxRuntimeExports.jsx(Context.Provider, { value: t, children: e });
}
...
const toggleThemes = { primary: 'primary', custom: 'custom' },
    ...
    Base$1 = defineStyledComponent('Toggle', styles$3.base, {
        variants: {
            theme: { [toggleThemes.primary]: styles$3['base__theme-primary'], [toggleThemes.custom]: void 0 },
            size: {
                [toggleSizes.extraSmall]: styles$3['base__size-extraSmall'],
                [toggleSizes.small]: styles$3['base__size-small'],
                [toggleSizes.medium]: styles$3['base__size-medium'],
            },
            activated: { true: styles$3.base__activated },
            disabled: { true: styles$3.base__disabled },
        },
        defaultVariants: { theme: toggleThemes.primary, size: toggleSizes.extraSmall },
    }),
    ToggleBase = reactExports.forwardRef(function (e, u) {
        const t = useSounds();
        return jsxRuntimeExports.jsx(Base$1, {
            ...
            onMouseEnter: function (u) {
                var s;
                (t.play('mouse-enter', { target: Base$1.displayName, original: u }),
                    null == (s = e.onMouseEnter) || s.call(e, u));
            },
            onClick: function (u) {
                var s;
                (t.play('click', { target: Base$1.displayName, original: u }), null == (s = e.onClick) || s.call(e, u));
            },
            children: e.children,
        });
    }),
    Toggle = reactExports.forwardRef(function (
        {
            children: e,
            size: u = toggleSizes.extraSmall,
            theme: t = toggleThemes.primary,
            fullSizeContent: s,
            classNames: n,
            className: r,
            ...a
        ...
        return jsxRuntimeExports.jsxs(ToggleBase, {
            ...
            size: u,
            theme: t,
            className: cx(r, s && styles$3.base__fullSizeContent, null == n ? void 0 : n.base),
            children: [
                jsxRuntimeExports.jsx('div', { className: cx(styles$3.border, null == n ? void 0 : n.border) }),
                jsxRuntimeExports.jsx('div', { className: cx(styles$3.background, null == n ? void 0 : n.background) }),
                jsxRuntimeExports.jsx('div', { className: cx(styles$3.bulb, null == n ? void 0 : n.bulb) }),
                jsxRuntimeExports.jsx('div', { className: cx(styles$3.overlay, null == n ? void 0 : n.overlay) }),
                jsxRuntimeExports.jsx('div', {
                    className: cx(styles$3.content, null == n ? void 0 : n.content),
                    children: e,
                }),
            ],
        });
...
const convertNbsp = (e) => e.replace(/&nbsp;/g, ' '),
    ...
    splitEuropean = (e, u = 0) => {
        ...
        const s = new RegExp(
            ...
            n = convertNbsp(e);
        return (splitAndFormat(n, /( )/, u).forEach((e) => (t = t.concat(splitAndFormat(e, s, 0)))), t);
    },
    splitChinese = (() => {
        const e = new RegExp(
            [
...
export {
    ...
    onRescale as b,
    computeds as c,
    createLayoutReadyInEffect as d,
    useMedia as e,
    breakpointsByType as f,
    getSize$1 as g,
    get as h,
    ...
    forEach as l,
    map as m,
    getRewardTooltipConfig as n,
    onResize as o,
    play as p,
    getRewardValueType as q,
    resources as r,
    getRewardImage as s,
    toUpperCase as t,
    useScaleState as u,
