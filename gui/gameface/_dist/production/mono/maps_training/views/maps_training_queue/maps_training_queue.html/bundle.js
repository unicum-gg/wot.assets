...
const x = 'Tips_79909a0',
    ...
    h = 'Tips_title_657eae53',
    g = 'Tips_description_96025015',
    N = 'Tips_arrowBlock_9c396b21',
    f = 'Tips_arrow_cf9aa58a',
    ...
    return e.jsxs('div', {
        ...
        children: [
            ...
            e.jsxs('div', {
                ...
                children: [
                    e.jsx('div', {
                        className: s(f, b, c === D.PrevTip && S),
                        onClick: function () {
                            (t.click(), i());
                        },
                        onMouseOver: t.highlight,
                    }),
                    e.jsx('div', {
                        className: s(f, j, c === D.NextTip && S),
                        onClick: function () {
                            (t.click(), n());
                        },
                        onMouseOver: t.highlight,
...
const [k, y] = c()(
        ({ observableModel: e }) => ({ ...e.primitives(['time', 'descrTip', 'isDelay', 'delayStatus']) }),
        ({ externalModel: e }) => ({
    ...
    W = n.resolve('strings');
var D = ((e) => ((e[(e.Exit = 0)] = 'Exit'), (e[(e.PrevTip = 1)] = 'PrevTip'), (e[(e.NextTip = 2)] = 'NextTip'), e))(
    D || {},
);
const I = a(function () {
    const { model: a, controls: n } = y(),
        r = a.delayStatus.get(),
        t = a.time.get(),
        c = i.useMemo(
            function () {
        ...
        m =
            'long' === r
                ? W.readOrEmpty('maps_training.queue.longTime')
                : 'normal' === r
                  ? W.readOrEmpty('maps_training.queue.delayTime')
                  : '';
    o(l.ESCAPE, n.menu);
    const [_, T] = i.useState(-1);
    return (
        o(l.TAB, function () {
            T((_ + 1) % 3);
        }),
        o(l.ENTER, function () {
            0 === _ ? n.quit() : 1 === _ ? n.showPrevTip() : 2 === _ && n.showNextTip();
        }),
        e.jsxs('div', {
            className: O,
            children: [
                e.jsx('div', {
                    className: E,
                    children: e.jsx(p, {
                        moveSpace: n.sceneWrapper.moveSpace,
                        onMouseOver3dScene: n.sceneWrapper.mouseOver3dScene,
                    }),
                }),
                e.jsxs('div', {
                    className: P,
                    children: [
                        ...
                        e.jsx(d, {
                            ...
                            size: d.sizes.small,
                            onClick: n.quit,
                            children: W.readOrEmpty('maps_training.queue.quitButton'),
                        }),
...
m(e.jsx(_, { children: e.jsx(k, { children: e.jsx(I, {}) }) }), { fullScreen: !0 }).then(() =>
