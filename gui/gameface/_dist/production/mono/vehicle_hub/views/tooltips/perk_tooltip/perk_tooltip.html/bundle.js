import { j as e, y as a, z as l, r as s, e as t, x as i } from '../../../../chunks/vendor.js';
import {
    r,
    I as o,
    aG as n,
        ...
        C.accessor(A, {
            cell: (a) => {
                ...
                return e.jsx('div', {
                    ...
                    children: l ? D.formatReal('woZeroDigits', a.getValue()) : '',
                });
            },
            meta: {
...
const te = (e, a, l, s) =>
    ...
    pe = i(function () {
        const { model: a } = oe(),
            ...
            g = de.read(`veh_skill_tree.tooltips.description.${l}`),
            x = s.useCallback(() => {
                const e = p.current;
                if (!e) return;
        ...
        if (
            ...
            return e.jsxs(le, {
                ...
                ref: p,
                children: [
                    g && e.jsx(se, { className: ce, text: g, tagColors: he, binding: h }),
