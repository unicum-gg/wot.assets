...
import { i as o, O as n, cd as c, J as l, U as i, d } from '../../../../chunks/lib.js';
...
const [_, x] = o()(({ observableModel: e }) => {
    ...
    O = 'Content_d9cfcd3f',
    T = 'Content_base__noDescription_b474774a',
    y = 'Content_title_22d0441e',
    ...
    Y = t(() => {
        ...
        return e.jsxs('div', {
            className: a(O, t && !c && !n && T),
            children: [
                e.jsx('div', { className: y, children: L.completed.title() }),
