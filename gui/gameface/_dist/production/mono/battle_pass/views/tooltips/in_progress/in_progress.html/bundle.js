...
const [O, L] = o()(
    ...
    D = t.memo(({ header: a, points: t, columnClassMix: o, hasAdditionalPoints: r }) =>
        e.jsxs('div', {
        ...
        return e.jsxs(e.Fragment, {
            children: [
                e.jsx(B, {
                    columnWidth: 140,
                    header: F.solo(),
                    headerClassMix: U.header,
                    labels: o,
                    labelClassMix: U.label,
                }),
                e.jsx(D, {
                    points: r,
                    columnClassMix: U.pointsColumn1,
                    hasAdditionalPoints: a,
                    header: e.jsx('div', { className: U.pointsIcon }),
                }),
                e.jsx(B, {
                    columnWidth: 140,
                    header: F.squad(),
                ...
                e.jsx(D, {
                    columnClassMix: U.pointsColumn2,
                    points: i,
                    hasAdditionalPoints: a,
                    header: e.jsx('div', { className: U.pointsIcon }),
                }),
                ...
                t &&
                    e.jsxs('div', {
                        ...
                        children: [
                            ...
                            e.jsx('div', { className: z.footer_text, children: X.inProgress.wotPlusProFooter() }),
                        ],
                    }),
            ],
        });
    ...
    qe = ({ className: a = '' }) =>
        e.jsxs('div', {
            className: s(Ue, a),
            children: [e.jsx('div', { className: Fe, children: Ye.header() }), e.jsx(he, {}), e.jsx(Re, {})],
        }),
    Ve = {
    ...
    Xe = ({ rewards: { items: a }, className: t = '' }) => {
        const o = a.length < 3 ? h.S180x135 : h.Big;
        return e.jsxs('div', {
    ...
    os = a(() => {
        ...
        return e.jsxs('div', {
            ...
            children: [
                ...
                e.jsx(Xe, { rewards: a.rewardsCommon.get(), className: Ze }),
                e.jsx(se, {}),
                (r || !t) && e.jsx(v, {}),
                e.jsxs('div', {
                    className: Qe,
    ...
    rs = a(() => {
        const { model: s } = L(),
            ...
            t = a === S.POST_PROGRESSION ? e.jsx(os, {}) : e.jsx(De, {});
