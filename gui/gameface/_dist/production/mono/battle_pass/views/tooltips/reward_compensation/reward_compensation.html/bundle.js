...
const O = {
    ...
    C = (e) => {
        ...
        if (
            ...
            return a.jsx(v, { ...e, vehicleTypeIconSize: c.x24x24, classNames: s });
        }
        if (n === d.Customizations) return a.jsx('span', { className: O.label, children: t });
        const i = _(r, f(n));
        return a.jsx('span', { className: s(O.label, O[`label__${n}`]), children: 'string' == typeof i ? i : r });
    };
function E({ reward: e }) {
...
j(a.jsx(h, { children: a.jsx(u, { children: a.jsx(u.Decorator, { children: a.jsx(Q, {}) }) }) }));
