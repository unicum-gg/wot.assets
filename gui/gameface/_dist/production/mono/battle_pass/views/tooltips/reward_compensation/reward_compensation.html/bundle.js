...
const A = {
    ...
    C = (e) => {
        ...
        if (
            ...
            const s = { base: A.label, name: A.tankName, level: A.tankLevel };
            return a.jsx(j, { ...e, vehicleTypeIconSize: c.x24x24, classNames: s });
        }
        if (n === d.Customizations) return a.jsx('span', { className: A.label, children: t });
        const i = _(r, f(n));
        return a.jsx('span', { className: s(A.label, A[`label__${n}`]), children: 'string' == typeof i ? i : r });
    };
function E({ reward: e }) {
    const { value: s, tooltipArgs: n, ...r } = x(e);
    return a.jsxs('div', { className: A.base, children: [a.jsx(l, { ...r }), C(e)] });
}
const S = 'Content_c10787ee',
    $ = 'Content_highlight_209aac4a',
    F = 'Content_arrow_e7a821c';
function L({ initialReward: e, compensationReward: s }) {
    return a.jsxs('div', {
        className: S,
        children: [
            a.jsx('div', { className: $ }),
...
const U = 'Footer_9d3d3a12',
    W = 'Footer_compensation_b57b9f53',
    T = m.resolve('images'),
    q = m.resolve('strings');
function z() {
    const e = b(
    ...
    return a.jsxs('div', {
        className: U,
        children: [
            a.jsx('div', { className: W, style: { backgroundImage: `url(${e})` } }),
...
const V = 'App_fc800ea3',
    B = n(() => {
        ...
        return a.jsxs('div', {
            className: V,
            children: [
                a.jsx(M, { rewardName: n.name }),
                a.jsx(L, { initialReward: s, compensationReward: n }),
                a.jsx(z, {}),
            ],
        });
    });
u(a.jsx(h, { children: a.jsx(v, { children: a.jsx(v.Decorator, { children: a.jsx(B, {}) }) }) }));
