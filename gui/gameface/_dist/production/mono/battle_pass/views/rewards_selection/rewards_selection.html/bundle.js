...
/* empty css                    */ var D = ((e) => ((e.None = 'none'), (e.Accepting = 'accepting'), e))(D || {});
const [P, q] = l()(
    ({ observableModel: s }) => {
        const t = {
                root: s.object(),
        ...
        return n.jsxs('div', {
            ...
            children: [
                ...
                n.jsx('div', {
                    ...
                    children: n.jsx(g, { text: X(r.type, h), binding: { equipmentType: x } }),
                }),
                n.jsx(f, {
                    args: { type: r.type },
                    children: n.jsxs('div', {
                        ...
                        children: [
                            n.jsx('div', {
                                className: ee.image,
                                style: { backgroundImage: `url(${Q(r.type, w, h)})` },
                            }),
...
const le = ({ type: e = 'plus', isEnabled: a = !0, onClick: s }) =>
    ...
    de = t(({ index: e }) => {
        const { model: a, controls: s } = q(),
            ...
            x = V(l);
        return n.jsxs('div', {
            className: i(ce.base, m && ce.base__selected, g && ce.base__accepting, ce[`base__${O(r)}`]),
            onClick: () => {
            ...
            children: [
                ...
                n.jsx(f, {
                    ...
                    children: n.jsxs('div', {
                        className: ce.reward,
                        children: [
                            n.jsx('div', { className: ce.image, style: { backgroundImage: `url(${Z(l)})` } }),
                            x !== H.None &&
                                n.jsx('div', {
                                    className: ce.optDeviceType,
                                    style: { backgroundImage: `url(${K(l, x)})` },
                                }),
                            !m &&
                                r !== te &&
                                n.jsx('div', { className: ce.disabled, style: { maskImage: `url(${Z(l)})` } }),
                            _ > 1 &&
                                n.jsx('div', {
                ...
                n.jsx('div', { className: ce.label, children: Y(l) }),
                m || r === te
                    ? n.jsxs(n.Fragment, {
                          children: [
...
const ue = ({ position: e, visible: a }) =>
    ...
    Ne = 'Footer_buttons_877c593c',
    Re = 'Footer_cButton_8406526',
                ...
                n.jsxs('div', {
                    ...
                    children: [
                        n.jsx(I, {
                            ...
                            mixClass: d,
                            onClick: () => {
                                (t.setAnimationState(D.Accepting), _.run(t.submit, 600));
                            },
    ...
    Ue = ({ title: e, subTitle: a, modelProviderContext: s }) =>
        n.jsx(P, { options: { context: s }, children: n.jsx(Oe, { title: e, subTitle: a }) }),
    [Fe, De] = l()(
    ...
    Qe = 'App_close_f9a2b686',
    Xe = R.strings.battle_pass.rewardChoice,
    Ye = t(() => {
...
M(new L().add(W).addWithProps(Fe, {}).render(n.jsx(Ye, {})));
