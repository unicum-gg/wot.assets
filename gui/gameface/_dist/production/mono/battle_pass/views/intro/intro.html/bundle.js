...
const W = {
    ...
    I = 'DescriptioBlock_title_62eb5c5',
    L = 'DescriptioBlock_description_2e359fe8',
    M = ({ icon: s, title: a, descr: n }) => {
        ...
        return e.jsxs('div', {
            ...
            children: [
                ...
                e.jsx('div', { className: I, children: a }),
                e.jsx('div', { className: L, children: n && i(n) }),
            ],
        });
    },
    P = {
