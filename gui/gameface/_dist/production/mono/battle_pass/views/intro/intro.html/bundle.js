...
const W = {
    ...
    G = n(() => {
        ...
        return (g(() => f.close()), e.jsx(q, { slides: t, onClose: f.close }));
    });
y(new k().add(N).addWithProps(F, {}).render(e.jsx(G, {})));
