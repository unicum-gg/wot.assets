...
import { g as Gt, a as qt } from '../../../chunks/filename.js';
import { g as Xt, o as Zt, v as Kt, e as Yt, m as Qt, R as Jt, a as es, b as as } from '../../../chunks/utils.js';
import { r as ts, T as ss } from '../../../chunks/tankmen_screen.js';
import { T as rs } from '../../../chunks/tank_name.js';
import { N as ns, T as is } from '../../../chunks/constants.js';
/* empty css                    */ var os = ((e) => (
        (e.Active = 'active'),
        (e.Paused = 'paused'),
...
function ds() {
    const a = e.useContext(cs);
    if (!a) throw new Error('use useBPProgressBar must be used within a ProgressBar');
    return a;
}
function _s({ children: t, levelsCount: s, levelPrice: r, levelsPassed: n }) {
    ...
    return a.jsx(cs.Provider, { value: g, children: t });
}
const us = 'BuyButtons_ce6c20b6',
    ms = 'BuyButtons_button_8a617f11',
    ps = k.resolve('strings'),
    hs = ({ isWalletAvailable: e, onAccept: s, onCancel: r, className: n }) => {
        const i = I({ buttonSize: P.medium }, { large: { buttonSize: P.large } }),
            { maxValueAchieved: o, setMaxValueAchieved: l, levelsToBuy: c } = ds();
        return a.jsxs('div', {
            className: t(us, n),
            children: [
                a.jsx(B, {
                    ...
                    disabled: !e,
                    children: ps.readOrEmpty('battle_pass.battlePassBuyView.confirm.btnBuy'),
                }),
                a.jsx(B, {
                    theme: A.secondary,
                    size: i.buttonSize,
                    className: ms,
                    onClick: r,
                    children: ps.readOrEmpty('battle_pass.battlePassBuyView.btnCancel'),
                }),
            ],
        });
    },
    ...
    fs = k.resolve('strings'),
    gs = ({ chapter: e, subTitle: s, className: r, type: n = 'default' }) =>
        a.jsxs('div', {
            className: t(bs.base, bs[`base__${n}`], r),
            children: [
                a.jsx('span', {
                    className: bs.chapter,
                    children: a.jsx(E, {
                        text: fs.readOrEmpty('battle_pass.battlePassBuyLevels.chapter'),
                        binding: { name: fs.readOrEmpty(`battle_pass.chapter.fullName.c_${e}`) },
                    }),
                }),
                a.jsx('span', { className: bs.subTitle, children: s }),
            ],
        }),
    [vs, xs] = D()(
        ({ observableModel: e }) => {
            const a = { root: e.object(), rewards: e.arrayClone('rewards.items') },
                t = s(() => O(a.rewards.get(), M), { equals: W });
...
const ws = 'Delta_7e5549',
    Cs = 'Delta_outside_b28c01e5',
    ys = 'Delta_outside__increase_91391b24',
    js = 'Delta_inside_b1b3a5c5',
    Ns = 'Delta_inside__increase_fcd871c4',
    Ss = e.memo(
        e.forwardRef(function (
            ...
            return (
                e.useEffect(() => {
                    if ((E(), 0 === P)) return (g.set({ width: 100 }), x.set({ width: 100 }), I('done'), void S([]));
                }, [P, E, g, x]),
                e.useEffect(() => {
                    ('growing' === k &&
                        (x.set({ width: 100 }),
                ...
                a.jsxs(n.div, {
                    ...
                    ref: q([p, h]),
                    className: t(d, ws),
                    style: { transform: w.x.to((e) => `translateX(${e}px)`), width: w.width.to((e) => `${e}px`) },
                    children: [
                        a.jsxs(n.div, {
                            style: { width: v.width.to((e) => `${e}%`) },
                            className: t(null == c ? void 0 : c.outside, Cs, P > 0 && ys),
                            children: [
                                a.jsx(n.div, {
                                    style: { width: f.width.to((e) => `${e}%`) },
                                    className: t(null == c ? void 0 : c.inside, js, P > 0 && Ns),
                                }),
                                m.children,
                            ],
                        }),
...
const ks = 'Pointer_45abb891',
    Is = 'Pointer_9fe9949c',
    Ps = 'Pointer_pointer__down_925b0a0d',
    Rs = { top: 'top', down: 'down' },
    Bs = function ({
        position: s = Rs.down,
        maxValueAchieved: r,
        silent: n = !1,
        ...
        const d = e.useRef(!1),
            ...
            b = e.useRef(null),
            f = e.useRef(null),
            { percentage: g, maxValue: v, setValue: x, value: w, status: C } = z(),
            {
                setCurrentValue: y,
                setPrevValue: j,
                setHasMoved: N,
        ...
        e.useEffect(() => {
            const e = A.current,
                a = Math.max(0, P - e);
            let t;
            if (null === b.current) t = L + E;
            else {
                const e = b.current - a * E,
                    s = Math.max(e, E);
                ((b.current = s), (t = L + s));
            }
            return (
        ...
        const M = $((e) => {
            ...
            const a = p.current.getBoundingClientRect(),
                ...
                r = Math.round(s / E) * E,
                n = Math.max(r, D);
            (f.current !== n && (n !== L && B({ event: 'drag' }), (f.current = n)), x(n), y(n), (b.current = n - L));
        });
        function V() {
        ...
        (e.useEffect(() => {
            ...
            e.useEffect(() => {
                if (u)
                    return new Z().add(K(window, 'mousemove', (e) => M(e))).add(
                        K(window, 'mouseup', (e) => {
                            (M(e), O());
                        }),
                    ).dispose;
            ...
            'disabled' === C
                ...
                : a.jsxs('div', {
                      ...
                      children: [
                          a.jsx('div', {
                              ref: h,
                              className: t(Is, s === Rs.down && Ps, null == c ? void 0 : c.pointer),
                              onMouseDown: (e) => {
                                  (e.stopPropagation(), B({ event: 'grab' }), V());
                              },
                              onMouseEnter: function () {
                                  u || B({ event: 'hover' });
                              },
                          }),
                          !r && a.jsx(Ss, { from: L, steps: ['growing'], step: E }),
                      ],
                  })
        );
    };
Bs.positions = Rs;
const As = 'LevelSlider_dbac30ca',
    Es = 'LevelSlider_step_fb995ce2',
    Ts = 'LevelSlider_completed_5226098c',
    Ls = 'LevelSlider_label_aecacc79',
    Ds = 'LevelSlider_labelDynamic_a0abcf78',
    Ws = 'LevelSlider_hidden_2d711256',
    Os = 100,
    Ms = () => {
        const s = e.useRef([]),
            {
        ...
        return a.jsx('div', {
            ...
            children: a.jsxs(Q, {
                ...
                children: [
                    a.jsx(Q.Fill, {}),
                    a.jsx(Bs, { maxValueAchieved: l, setMaxValueAchieved: c }),
                    a.jsx(Q.DynamicIndicator, {
                        className: t(n === Os && Ws, Ds),
                    ...
                    a.jsx(Q.NumberIndicators, {
                        position: ee.above,
                        count: _,
                        classNames: { step: Es, completed: Ts, stepClassNames: { label: Ls } },
                        children: (e) => (e % 5 == 0 || (e === u && !l) || (u === m && e === m + 1) ? e : void 0),
                    }),
                ],
            }),
        });
    ...
    Vs = 'RewardsList_61e5d0fd',
    zs = 'RewardsList_reward_110a9a1e',
    Fs = 'RewardsList_rewardInfo_b223a75b',
    Hs = i(() => {
        const { model: t } = xs(),
                ...
                children: O(s, (e, t) =>
                    a.jsx(
                        'div',
                        {
                            ...
                            children: a.jsx(se, { ...Xt(e, re.S180x135), classNames: { info: Fs } }),
                        },
            ...
            a.jsxs('div', {
                ...
                children: [
                    ...
                    a.jsxs('div', {
                        ...
                        children: [
                            a.jsx('div', {
                                className: t($s.mask, $s[`mask__${le(i, o)}`]),
                                children: a.jsx(oe, { children: a.jsx(Hs, {}) }),
                            }),
                            a.jsx(ce, { classNames: { base: $s.scrollBar } }),
                        ],
                    }),
                ],
            })
    ...
    Xs = 'Footer_footerLabel_e28c9ab3',
    Zs = 'Footer_currencyIcon_cfcb6dcf',
    Ks = k.resolve('strings'),
    Ys = () => {
        const {
                currentValue: t,
                prevValue: s,
            ...
            c = I({ currencySize: de.medium }, { large: { currencySize: de.large } });
        return (
            e.useEffect(() => {
            ...
            a.jsxs('div', {
                ...
                children: [
                    a.jsx(_e, {
                        text: Ks.pluralOrEmpty('battle_pass.battlePassBuyLevels.levelsSelected', o),
                        upgradeLegacy: !0,
                        params: { count: o },
                        className: Xs,
                    }),
                    a.jsx(ue, {
                        classNames: { base: qs, icon: Zs },
                        type: me.gold,
                        size: c.currencySize,
                        reverse: !0,
                        children: o * r,
    ...
    Qs = 'App_848b5de0',
    Js = 'App_background_d5285348',
    er = 'App_shadow_b96f6299',
    ar = 'App_content_3a6c6ebb',
    tr = 'App_contentContainer_dc3584c8',
    sr = 'App_footer_7b1985',
    rr = 'App_bottomLip_64987100',
    nr = 'App_title_536f5f20',
    ir = k.resolve('strings'),
    or = i(() => {
        const { model: t, controls: s } = xs(),
            { isWalletAvailable: r, levelsPassed: n, levelsTotal: i, chapterID: o, levelPrice: l } = t.root.get(),
            c = pe();
        (((a) => {
            ...
            he(c.goBack),
            be(Y.SPACE, c.goBack));
        const d = { backgroundImage: `url(${Gt(R.images.gui.maps.icons.battlePass.backgrounds.chapter_general, o)})` };
        return a.jsx(_s, {
            levelsCount: i,
            levelPrice: l,
            levelsPassed: n,
            children: a.jsxs('div', {
                className: Qs,
                children: [
                    a.jsx('div', { style: d, className: Js }),
                    a.jsx('div', { className: er }),
                    a.jsxs('div', {
                        className: ar,
                        children: [
                            a.jsx(gs, {
                                chapter: o,
                                subTitle: ir.readOrEmpty('battle_pass.battlePassBuyView.descr'),
                                className: nr,
                            }),
                            a.jsx('div', { className: tr, children: a.jsx(fe, { children: a.jsx(Us, {}) }) }),
                            a.jsxs('div', {
                                className: sr,
                                children: [
                                    a.jsx('div', { className: rr }),
                                    a.jsx(Ys, {}),
                                    a.jsx(hs, { onAccept: s.buy, onCancel: c.goBack, isWalletAvailable: r }),
                                ],
                            }),
                        ],
                    }),
    ...
    lr = () => a.jsx(vs, { options: { rootId: R.aliases.battle_pass.BuyLevels('resId') }, children: a.jsx(or, {}) }),
    [cr, dr] = D()(({ observableModel: e }) => {
        const a = {
                levels: e.object(),
    ...
    _r = 'ChapterBackground_69fd488d',
    ur = 'ChapterBackground_base__current_fdadf34',
    mr = ({ chapter: e, isCurrent: s, customBackgroundStyle: r }) =>
        a.jsx('div', { className: t(_r, s && ur), style: r || qt(e) }),
    pr = {
...
var hr = ((e) => ((e.now = 'now'), (e.future = 'future'), e))(hr || {});
const br = ({ description: e, type: s, steps: r = '', className: n = '', title: i = '' }) =>
        a.jsxs('div', {
            className: t(pr.base, pr[`base__${s}`], n),
            children: [
                a.jsx('div', { className: pr.iconShadow }),
                a.jsxs('div', {
                    className: pr.title,
                    children: [
                        a.jsx('div', { className: pr.icon }),
                        a.jsx('div', { className: pr.titleText, children: i }),
                    ],
                }),
                a.jsx(E, {
                    classMix: pr.descriptionText,
                    text: e,
                    binding: { steps: a.jsx('span', { className: pr.steps, children: r }, r) },
                }),
            ],
        }),
    fr = 'GroupRewards_46776305',
    gr = 'GroupRewards_item_662b83cb',
    vr = ({ rewards: e, className: s }) => {
        const { breakpoint: r } = ge(),
            n = r.weight < ve.medium.weight ? xe.Small : xe.Big;
        return a.jsx('div', {
            className: t(fr, s),
            children: O(e, (e, t) =>
                a.jsx('div', { className: gr, children: a.jsx(we, { ...Xt(e, n, !0) }) }, `reward_${t}_${e.name}`),
            ),
        });
    },
    xr = 'RewardsBlock_479e00eb',
    wr = 'RewardsBlock_groupTitle_f9f5fbdd',
    Cr = 'RewardsBlock_groupRewards_2893db92',
    yr = 'RewardsBlock_groupRewards__future_d962e74b',
    jr = ({ description: e, iconType: s, steps: r = '', rewards: n, className: i = '', title: o = '' }) =>
        a.jsxs('div', {
            className: t(xr, i),
            children: [
                a.jsx(br, { description: e, type: s, steps: r, className: wr, title: o }),
                a.jsx(vr, { rewards: n, className: t(Cr, s === hr.future && yr) }),
            ],
        });
var Nr = ((e) => (
    (e[(e.Idle = 0)] = 'Idle'),
...
const Sr = { type: 'idle' };
const kr = 'ScrollWithLips_b466eb6f',
    Ir = 'ScrollWithLips_lip_b541dfde',
    Pr = 'ScrollWithLips_lip__top_4610f987',
    Rr = 'ScrollWithLips_lip__bottom_1755a6e5',
    Br = 'ScrollWithLips_scroll_35d7ef3c',
    Ar = 'ScrollWithLips_scroll__loaded_76bcfcc5',
    Er = 'ScrollWithLips_topButton_9c4da3a2',
    Tr = 'ScrollWithLips_bottomButton_810d617c',
    Lr = 'ScrollWithLips_track_a8bacc80',
    Dr = ({ className: s, children: r, setVisibleScroll: n }) => {
        const i = ye();
        !(function (a, t) {
            const {
                    contentRef: s,
        ...
        const o = ((a) => {
                const [t, s] = e.useState(0),
                    { animationScroll: r, getContainerSize: n, getWrapperSize: i, events: o } = a,
                    l = e.useCallback(() => {
        ...
        return (
            ...
            a.jsxs('div', {
                className: t(kr, s),
                children: [
                    o !== Nr.Start && o !== Nr.Idle && a.jsx('div', { className: t(Ir, Pr) }),
                    o !== Nr.End && o !== Nr.Idle && a.jsx('div', { className: t(Ir, Rr) }),
                    a.jsx(je.Vertical.Default, {
                        api: i,
                        barClassNames: { base: t(Br, l && Ar), topButton: Er, bottomButton: Tr, track: Lr },
                        children: r,
                    }),
                ],
            })
    ...
    Wr = 'Content_d0e2f711',
    Or = 'Content_mainContent_3c1770a6',
    Mr = 'Content_base__noScroll_da09528a',
    Vr = R.strings.battle_pass.battlePassBuyView.reward,
    zr = i(() => {
        const { model: s } = dr(),
            { fromLevel: r, toLevel: n, isPurchaseWithLevels: i } = s.levels.get(),
            o = s.computes.nowRewards(),
            l = s.computes.futureRewards(),
            { description: c, completedSteps: d } = ((e, a, t) =>
                t
                    ? { description: Vr.descriptionNowRewardsCheckbox() }
                    : e < a
                      ? { description: Vr.descriptionNowRewards(), completedSteps: `${e} - ${a}` }
                      : { description: Vr.descriptionNowRewardsSingle(), completedSteps: `${a}` })(r, n, i),
            [_, u] = e.useState(!1);
        return a.jsx(Dr, {
            className: t(Wr, !_ && Mr),
            setVisibleScroll: u,
                ...
                children: [
                    o.length > 0 &&
                        a.jsx(jr, {
                            ...
                            rewards: o,
                            steps: d,
                            title: Vr.titleNowRewards(),
                        }),
                    l.length > 0 &&
                        a.jsx(jr, {
                            description: Vr.descriptionFutureRewards(),
                            iconType: hr.future,
                            rewards: l,
                            title: Vr.titleFutureRewards(),
                        }),
                ],
            }),
        });
    }),
    Fr = 'MoreRewards_c02e454c',
    Hr = 'MoreRewards_content_16a0f9d5',
    $r = 'MoreRewards_background_c0223b52',
    Ur = 'MoreRewards_shadow_8f93a270',
    Gr = i(() => {
        const { model: t } = dr(),
            { chapterID: s } = t.levels.get(),
            [r, n] = e.useState(!1),
            i = pe();
        (be(L.ESCAPE, () => i.goBack()),
            e.useEffect(() => {
                (async () => {
                    (await Zt(), n(!0));
                })();
            }, []));
        const o = { backgroundImage: `url(${Gt(R.images.gui.maps.icons.battlePass.backgrounds.chapter_general, s)})` };
        return a.jsxs('div', {
            className: Fr,
            children: [
                a.jsx('div', {
                    className: $r,
                    children: a.jsx(mr, { chapter: s, isCurrent: !0, customBackgroundStyle: o }),
                }),
                a.jsx('div', { className: Ur }),
                r && a.jsx('div', { className: Hr, children: a.jsx(zr, {}) }),
            ],
        });
    }),
    qr = {
    ...
    bn = 'x320x320',
    fn = k.resolve('images'),
    gn = function ({ iconSize: e, shieldSize: s, containerSize: r, chapterID: n, bpPurchased: i, className: o = '' }) {
        const l = i ? 'purchased' : 'basic',
            c = String(n).slice(-1),
            d = s === Jr ? en : s === en ? tn : s === an ? rn : s === tn || s === sn ? nn : on,
            _ = e === ln ? dn : e === cn ? un : e === dn ? mn : e === _n ? pn : e === un || e === mn ? hn : bn,
            u =
                fn.readOrEmpty(`battlePass.emblem.shield.c_${n}.${l}.${Ne(s, d)}`, 'silent') ||
                fn.readOrEmpty(`battlePass.emblem.shield.default.${l}.${s}`),
            m =
                fn.readOrEmpty(`battlePass.emblem.icon.c_${n}.${l}.${Ne(e, _)}`, 'silent') ||
                fn.readOrEmpty(`battlePass.emblem.icon.default_${c}.${l}.${e}`);
        return a.jsxs('div', {
            className: t(qr.base, qr[`base__${r}`], o),
            children: [
                a.jsx('div', { className: t(qr.shield, qr[`shield__${s}`]), style: { backgroundImage: `url(${u})` } }),
                a.jsx('div', {
                    className: t(qr.icon, qr[`icon__${e}`]),
                    style: {
                        backgroundImage: `url(${n > 0 ? m : fn.readOrEmpty(`battlePass.emblem.icon.not_chosen.${Ne(e, dn)}`)})`,
                    },
                }),
            ],
        });
            ...
            const a = {
                ...
                l = s(() => {
                    ...
                    return {
                        ...
                        amount: Se(t, ({ hasStarterPack: e }) => e).length,
                    };
                }),
                c = s((e) => {
                    var t;
                    return null == (t = Ie(a.chapters.get(), ({ hasStarterPack: a, chapterID: t }) => a && t === e))
                        ? void 0
                        : t.hasStarterPack;
                }),
                d = s(() => Se(a.chapters.get(), ({ isExtra: e }) => !e));
            return {
                ...a,
                computes: {
    ...
    wn = 'PurchaseBlock_fa4dd8be',
    Cn = 'PurchaseBlock_button_3b8b9877',
    yn = 'PurchaseBlock_previousPrice_1e77a9b2',
    jn = 'PurchaseBlock_currentPrice_c4a7499d',
    Nn = 'PurchaseBlock_currency_a51b98a4',
    Sn = 'PurchaseBlock_actionLip_63994768',
    kn = k.resolve('strings'),
    In = i(function ({ isPriceUpdateAnimation: e }) {
        const { model: t, controls: s } = xn(),
            { isWalletAvailable: r } = t.root.get(),
            { price: n, prevPrice: i } = t.package.get(),
            o = I(
                { currencySize: de.medium, buttonSize: P.small },
                { medium: { currencySize: de.extraLarge, buttonSize: P.large } },
            );
        return a.jsxs('div', {
            className: wn,
            children: [
                a.jsx('div', { className: Sn }),
                e
                    ? a.jsx('div', {
                          className: yn,
                          children: a.jsx(ue, {
                ...
                a.jsx(B, {
                    ...
                    children: kn.readOrEmpty('battle_pass.battlePassBuyView.confirm.btnBuy'),
                }),
            ],
        });
    }),
    Pn = 'DiscountIcon_932f671c',
    Rn = 'DiscountIcon_icon_655d7c11',
    Bn = 'DiscountIcon_highlight_75d6adf';
function An({ className: e = '' }) {
    return a.jsxs('div', {
        className: t(Pn, e),
        children: [a.jsx('div', { className: Rn }), a.jsx('div', { className: Bn })],
    });
}
const En = 'Logos_1ed97e35',
    Tn = 'Logos_logoWrapper_826e9a4f',
    Ln = 'Logos_logo_ada5f291',
    Dn = 'Logos_starterPack_f4dabb81',
    Wn = k.resolve('images'),
    On = (e) => {
        const a = String(e).slice(-1);
        return (
            Wn.readOrEmpty(`battlePass.emblem.icon.c_${e}.purchased.${pn}`, 'silent') ||
            Wn.readOrEmpty(`battlePass.emblem.icon.default_${a}.purchased.${pn}`)
        );
    },
    Mn = R.strings.battle_pass.battlePassBuyView.confirm.shopOfferBlock;
const Vn = i(function ({ className: e = '' }) {
        const {
                model: { computes: s },
            } = xn(),
                ...
                r.map((e, t) =>
                    a.jsx(
                        'div',
                        {
                            ...
                            children: a.jsx('div', { className: Ln, style: { backgroundImage: `url(${On(e)})` } }),
                        },
                        e,
                    ),
                ),
                Boolean(n) && a.jsx(E, { classMix: Dn, text: Mn.packsAmount(), binding: { amount: n } }),
            ],
        });
    }),
    zn = 'ShopOfferBlock_5d538f0f',
    Fn = 'ShopOfferBlock_logos_c4a5c492',
    Hn = 'ShopOfferBlock_headline_333a5398',
    $n = 'ShopOfferBlock_text_83d7e7fc',
    Un = 'ShopOfferBlock_discount_c7eeef37',
    Gn = 'ShopOfferBlock_title_7245add2',
    qn = 'ShopOfferBlock_description_ef059d17',
    Xn = 'ShopOfferBlock_button_4790b6d6',
    Zn = R.strings.battle_pass.battlePassBuyView.confirm.shopOfferBlock;
const Kn = i(function ({ className: e = '' }) {
        const { model: s, controls: r } = xn(),
            n = s.computes.regularChapters(),
            i = $(() => {
                r.shopOffer();
            }),
            o = I({ buttonSize: P.small }, { medium: { buttonSize: P.large } });
        return a.jsxs('div', {
            className: t(zn, e),
            children: [
                Boolean(n.length) && a.jsx(Vn, { className: Fn }),
                a.jsxs('div', {
                    className: Hn,
                    children: [
                        a.jsx(_e, {
                        ...
                        a.jsx(An, { className: Un }),
                    ],
                }),
                a.jsx(_e, { upgradeLegacy: !0, className: Gn, text: Zn.title() }),
                a.jsx(_e, { upgradeLegacy: !0, className: qn, text: Zn.description() }),
                a.jsx(B, { size: o.buttonSize, onClick: i, className: Xn, children: Zn.buy() }),
            ],
        });
    }),
    Yn = 'AnimatedReward_1789d927',
    Qn = ({ children: e, animationConfig: s, className: i }) => {
        const o = r(s);
        return a.jsx(n.div, { style: o, className: t(Yn, i), children: e });
    },
    Jn = {
    ...
    ai = k.resolve('strings'),
    ti = i(({ isCheckboxAnimationActive: s, isPrevious: i = !1, className: o }) => {
        const { model: l } = xn(),
            ...
            h = _ > 0,
            b = () => {
                Pe.sound(R.sounds.bp_reward());
            },
            { breakpoint: f } = ge(),
            g = f.weight < ve.medium.weight ? xe.Small : xe.Big,
            v = r(ei(6, b)),
            x = pe();
        return a.jsxs('div', {
            className: t(Jn.base, o),
            children: [
                a.jsx('div', {
                    className: Jn.descriptionText,
                    children:
                        i !== d
                            ? ai.readOrEmpty('battle_pass.battlePassBuyView.confirm.descriptionCheckboxChecked')
                            : ai.readOrEmpty('battle_pass.battlePassBuyView.confirm.description'),
                }),
                a.jsxs('div', {
                    className: Jn.rewardsWrapper,
                    children: [
                        a.jsx('div', {
                            className: t(Jn.priorityRewards, h && Jn.priorityRewards__rewardsButtonVisible),
                            children: O(p, (t, s) =>
                                i
                                    ? e.createElement(we, { ...Xt(t, g), key: `${t.name}_${s}` })
                                    : a.jsx(
                                          Qn,
                                          { animationConfig: ei(s, b), children: a.jsx(we, { ...Xt(t, g) }) },
                                          `${t.name}_${s}`,
                                      ),
                            ),
                        }),
                        h &&
                            a.jsx(n.div, {
                                style: v,
                                children: a.jsx('div', {
                                    className: Jn.buttonWrapper,
                                    children: a.jsx(B, {
                                        theme: A.secondary,
                                        size: P.large,
                                        className: t(Jn.rewardBtn, s && Jn.rewardBtn__currentRewardsAnimation),
                                        classNames: { content: Jn.buttonContent },
                                        onClick: () => x.push(ts.battlePass.buyPassRewards, { packageID: c }),
                                        children: a.jsx(E, {
                                            text: ai.readOrEmpty('battle_pass.battlePassBuyView.btnRewards'),
                                            binding: { count: _ },
                                            classMix: Jn.text,
                                        }),
                                    }),
    ...
    ri = k.resolve('strings'),
    ni = 'x36x36',
    ii = 'x52x52',
    oi = i(function ({ starterPackRewards: e, presentSize: s, rewardSize: r, classNames: n }) {
        return a.jsxs('div', {
            className: si.base,
            children: [
                a.jsx('div', {
                    className: t(si.presentLogo, si[`presentLogo__${s}`], null == n ? void 0 : n.presentLogo),
                }),
                a.jsx('div', {
                    className: t(si.equalLogo, null == n ? void 0 : n.equalLogo),
                    children: ri.readOrEmpty('battle_pass.progression.footer.starter_pack.equal'),
                }),
                a.jsx('div', {
                    className: si.rewardsWrapper,
                    children: a.jsx('div', {
                        className: si.rewards,
                        children: O(e, (e, t) =>
                            a.jsx(
                                we,
                                { ...Xt(e, r), className: null == n ? void 0 : n.reward },
                                `reward_${e.name}_${t}`,
                            ),
                        ),
                    }),
    ...
    li = 'StarterPack_packDescription_e09c33a3',
    ci = 'StarterPack_purchaseText_67051b2',
    di = 'StarterPack_presentLogo_f1509f42',
    _i = 'StarterPack_equalLogo_4d2bea9f',
    ui = k.resolve('strings'),
    mi = i(function () {
        const { model: e } = xn(),
            t = e.computes.starterPackRewards(),
            { breakpoint: s } = ge(),
            r = s.weight < ve.medium.weight ? xe.Small : xe.Big;
        return a.jsxs(a.Fragment, {
            children: [
                a.jsx(_e, {
                    text: ui.readOrEmpty('battle_pass.battlePassBuyView.confirm.starterPack.description'),
                    upgradeLegacy: !0,
                    params: {
                        purchaseText: a.jsx('span', {
                            className: ci,
                            children: ui.readOrEmpty('battle_pass.battlePassBuyView.confirm.starterPack.purchaseText'),
                        }),
                    },
                    className: li,
                }),
                a.jsx(oi, {
                    ...
                    presentSize: ii,
                    rewardSize: r,
                    classNames: { presentLogo: di, equalLogo: _i },
                }),
            ],
        });
    }),
    ...
    bi = k.resolve('images'),
        ...
        const h = I(
            { iconSize: un, shieldSize: tn, containerSize: Kr },
            {
                medium: { iconSize: mn, shieldSize: sn, containerSize: Yr },
                large: { iconSize: pn, shieldSize: rn, containerSize: Qr },
            },
        );
        return a.jsxs('div', {
            className: pi.base,
            ...
            children: [
                a.jsx('div', {
                    className: t(
                        pi.contentWrapper,
                        !u && pi.contentWrapper__noShopOffer,
                        s && pi.contentWrapper__rewardsUpdateAnimation,
                    ),
                    children: a.jsxs('div', {
                        ...
                        children: [
                            ...
                            a.jsxs('div', {
                                className: pi.chapterInfo,
                                children: [
                                    a.jsx('div', {
                                        className: pi.chapterName,
                                        children: hi.readOrEmpty(`battle_pass.chapter.fullName.c_${l}`),
                                    }),
                                    c > 0 &&
                                        a.jsx('div', {
                                    ...
                                    s
                                        ? a.jsx(ti, {
                                              ...
                                              className: pi.previousRewards,
                                              isPrevious: !0,
                                          })
                                        : a.jsx(ti, { isCheckboxAnimationActive: s, className: pi.currentRewards }),
                                    a.jsx('div', { className: pi.starterPack, children: _ && a.jsx(mi, {}) }),
                                    a.jsx(In, { isPriceUpdateAnimation: s }),
                                ],
                            }),
                        ],
                    }),
                ...
                u &&
                    a.jsxs(a.Fragment, {
                        children: [
                            a.jsx('div', { className: pi.offerBack }),
                            a.jsx('div', {
                                className: pi.offerWrapper,
                                children: a.jsx('div', { className: pi.offer, children: a.jsx(Kn, {}) }),
                            }),
                        ],
                    }),
            ],
    ...
    gi = { context: 'model.rewards', rootId: R.aliases.battle_pass.BuyPass('resId') },
    vi = i(() => {
        const { model: e } = xn();
        switch (e.main.state.get()) {
            ...
            default:
                return a.jsx(fi, {});
            case 'rewardsState':
                return a.jsx(cr, { options: gi, children: a.jsx(Gr, {}) });
        }
    }),
    xi = () => a.jsx(vn, { options: { rootId: R.aliases.battle_pass.BuyPass('resId') }, children: a.jsx(vi, {}) }),
    wi = [
    ...
    Ci = (e = 0, a = 30, t = 200) => ({
        ...
        config: { duration: t, easing: Be.easeInOutCubic },
        delay: e,
    }),
    yi = k.resolve('images'),
    ji = k.resolve('videos'),
    [Ni, Si] = D()(
        ({ observableModel: e }) => {
            const a = e.array('chapters'),
                ...
                r = s(() => Ae(a.get(), ({ isExtra: e }) => e)),
                n = s(() => Ae(a.get(), ({ chapterState: e }) => e === os.Active)),
                i = s(() => Ee(a.get(), ({ chapterState: e }) => e === os.Completed)),
                l = s((e) => Ie(a.get(), (a) => a.chapterID === e), { equals: W }),
                c = s((e) => {
                    const t = Ie(a.get(), (a) => a.chapterID === e);
                    return {
                        levelProgression: (null == t ? void 0 : t.levelProgression) || 0,
                        currentLevel: (null == t ? void 0 : t.currentLevel) || 0,
                    };
                }),
                d = s(() => Se(t.chapters.get(), (e) => !e.isExtra), { equals: W }),
                _ = s(() => Se(t.chapters.get(), (e) => !e.isExtra && !e.isPostProgression), { equals: W }),
                u = s(() => Se(d(), (e) => e.chapterState === os.Completed).length, { equals: W }),
                m = s(() => Se(t.chapters.get(), (e) => e.isExtra)),
                p = s(() => Se(t.chapters.get(), (e) => e.isPostProgression)),
                h = [2],
                b = s(
                    () => {
                        const e = Ie(t.chapters.get(), ({ chapterID: e }) => e === t.selectedChapterID.get());
                        return e || Te(t.chapters.get(), t.prevChapterIndex.get());
                    },
                    { equals: W },
                ),
                f = s(
                    () => {
                        ...
                        return a ? Le(e).days < 3 : Le(e).days < 20;
                    },
                    { equals: W },
                ),
                g = s(() => [...(r() ? m() : []), ..._(), ...p()]),
                    ...
                    () => {
                        ...
                        return (
                            O(g(), (a) => {
                                ...
                                e.push({
                                    chapter: a.chapterID,
                                    mainBg: yi.readOrEmpty(s, 'silent') || yi.readOrEmpty(r),
                                    idleBg: ji.readOrEmpty(n, 'silent') || '',
                                });
                            }),
                            e
                        );
    ...
    ki = 'LoopVideo_cfc6c5cb';
function Ii({ src: t, style: s }) {
    ...
    return (
        ...
        a.jsx(Oe, { src: t, style: s, className: ki, ref: r, autoplay: !0, loop: !0 })
    );
}
const Pi = 'Background_d1f724bf',
    Ri = 'Background_mainBg_b8b64d56',
    Bi = 'Background_idleBg_30e8ffa',
    Ai = i(function ({ style: e, i: s, index: r, classNames: i = {} }) {
        const { model: o } = Si(),
        ...
        return a.jsxs('div', {
            ...
            children: [
                a.jsx(n.div, {
                    className: t(Ri, null == i ? void 0 : i.main),
                    style: {
                        ...e,
                ...
                s === r &&
                    _ &&
                    a.jsx('div', {
                        className: t(Bi, null == i ? void 0 : i.idle),
                        children: a.jsx(Ii, { src: _, style: h }),
                    }),
            ],
        });
    });
(ze.lightTank, ze.mediumTank, ze.heavyTank, ze['AT-SPG'], ze.SPG, Fe(1, 12, M));
const Ei = 'vehicle_types',
    Ti = 'nations',
    Li = 'levels',
    Di = { heavy_tank: Ge, medium_tank: Ue, light_tank: $e, at_spg: He };
function Wi(e, a) {
    return 'isCommonProgression' === e && a.status !== Ze.UNSUITABLE_TO_QUEUE && a.bpProgress < a.maxBpScore;
}
function Oi(e, a, t, s) {
    switch (a) {
        case 'elite':
...
const Mi = {
    [Li]: (e, a) => !e.levels || e.levels.includes(`level_${a.level}`),
    [Ti]: (e, a) => !e.nations || e.nations.includes(Xe(a.nationId)),
    [Ei]: (e, a) => !e.vehicle_types || e.vehicle_types.includes(a.type),
};
function Vi(e, a, t) {
    let s = !1;
    const r = e.specials ?? [];
    for (const n of r)
        if ('rented' !== n) {
            if (!Oi(r, n, a, t)) return !1;
        } else s = !0;
    if (!s && qe(a) && !(null == t ? void 0 : t.fromWotPlus)) return !1;
    if (t && e.battle_pass && e.battle_pass.length > 0) for (const n of e.battle_pass) if (!Wi(n, t)) return !1;
    for (const n of Object.keys(e)) if (n in Mi && !Mi[n](e, a)) return !1;
    return ((e, a) => {
        const t = Ke(a.role);
        let s = !1;
        for (const r of Object.keys(Di)) if (r in e && ((s = !0), e[r].some((e) => e.includes(t)))) return !0;
        return !s;
    })(e, a);
}
function zi(e, { shortName: a, fullName: t }) {
...
function Hi(e, a) {
    return 'regular' === a.type
        ? Fi(e, a.field, a.value)
        : Object.keys(Di).reduce((e, t) => {
              const s = Di[t].find((e) => e.includes(a.role));
              return s
                  ? Fi(e, t, ((n = s), 'at_spg' === (r = t) ? `role_ATSPG_${n}` : `role_${r[0].toUpperCase()}T_${n}`))
                  : e;
              var r, n;
          }, e);
}
...
const [Ui, Gi] = D('FilterVehiclesProvider')(
        ({ observableModel: e, readByPath: a }) => {
            ...
            const { text_search: s, ...r } = t(a('filters')),
                ...
                i = Ye.structural(() => t(n.defaultFilters.get())),
                l = {
            ...
            return {
                ...l,
                computes: {
                    hasFilters: Ye.primitive(
                        () => !Qe.structural(i(), l.filters.get()) || l.searchName.get().length > 0,
                    ),
                    nations: () => l.nations.get(),
                    nationToIndex: Ye.shallow(() => l.nations.get().reduce((e, a, t) => ((e[a] = t), e), {})),
                    default: i,
                },
            };
        },
        ({ cleanup: e, model: a, externalModel: t }) => {
            ...
            return (
                ...
                ),
                {
                    ...
                    change: l((e) => {
                        a.filters.set(Hi(a.filters.get(), e));
                    }),
    ...
    qi = 'disabled',
    Xi = [ze.lightTank, ze.mediumTank, ze.heavyTank, ze['AT-SPG'], ze.SPG].reduce((e, a, t) => ((e[a] = t), e), {}),
    [Zi, Ki] = D('VehicleStatisticsProvider')(({ observableModel: e }) => {
        const a = e.dict('statistics'),
            t = Ye.structural((e) => a.get(e));
        return { ids: Ye.primitive(() => a.keys), get: t };
    }),
    [Yi, Qi] = D('VehiclesProvider')(
        ({ observableModel: e }) => {
            ...
            return {
                get: Ye.structural((e) => {
                    ...
                    return { ...s, imageKey: Je(s.name) };
                }),
                has: Ye.primitive((e) => Boolean(a.vehicles.get(e))),
                ids: Ye.shallow(() => [...a.vehicles.keys.values()]),
                amount: Ye.primitive(() => a.vehicles.length),
                list: Ye.shallow(() => {
                    let e = [];
        ...
        U,
        { useRequires: () => ({ statistics: Ki() }) },
    ),
    [Ji, eo] = D('MyVehiclesProvider')(
        (e) => {
            ...
            return { get: t, getAll: s, amount: Ye.primitive(() => s().length), ids: a };
        },
        U,
        { useRequires: () => ({ vehicles: Qi(), statistic: Ki() }) },
    ),
    ao = k.resolve('strings'),
    to = ea(ta + sa),
    so = () => `${Date.now().toString(16)}_${to(3)}`;
function ro(e, a, t = 1) {
    const s = aa(a, { count: t });
    return e.has(s) ? ro(e, a, t + 1) : s;
}
function no(e = '', a = []) {
    return {
        title: '' !== e ? e : ao.readOrEmpty('playlists.defaultName'),
        createdAt: Date.now(),
        modifiedAt: Date.now(),
        list: a,
    };
...
const lo = 'delete',
    co = 'import',
    _o = _({ title: p(), createdAt: u(f(), b(), h(0)), modifiedAt: u(f(), b(), h(0)), list: m(u(f(), b())) }),
    uo = u(
        p(),
        g((e) => (e.length > 0 ? e : void 0)),
    ),
    [mo, po, { Context: ho }] = D('PlaylistsProvider')(
        ({ requires: e, observableModel: a }) => {
            const t = a.dict('storage'),
                ...
                i = Ye.shallow(() => t.keys),
                l = Ye.primitive(() => v(uo, s.selectedID.get())),
                c = Ye.structural((e) => {
                    try {
                        const a = t.get(e);
                        if (!a) return io(void 0);
                        const s = v(_o, JSON.parse(a)),
                            r = new Set();
                        for (const e of s.list)
                            if (ra[e]) {
                                const a = ra[e].find((e) => Boolean(n.myVehicles.get(e.toString())));
                                r.add(a ?? e);
                            } else r.add(e);
                ...
                h = Ye.shallow(() => {
                    ...
                    return ia(e.myVehicles.model.getAll(), (e, t) => $i(a, Xi, e, t));
                }),
                b = Ye.primitive((e) => {
                    var a;
                    const t = u(e),
                    ...
                    for (let n = 0; n < s.length; n += 1) {
                        ...
                        if (oa(e) && r.has(e)) return n;
                    }
                }),
                f = Ye.primitive(() => !1 === Qe.structural(r(), n.filters.get()) || n.searchName.get().length > 0),
                g = Ye.shallow(() => {
        ...
        ({ model: e, externalModel: a }) => {
            ...
            return {
                filters: la({
                    update: (a) => {
                        e.filters.set(Hi(e.filters.get(), a));
                    },
                    reset: () => {
                ...
                create: l((a) => {
                    const { id: s = so(), vehicleIds: r = [], skipRedirect: n = !1 } = a ?? {};
                    t({ id: s, initial: no(ro(e.titles(), 'playlists.defaultName'), r), skipRedirect: n });
                }),
                edit: {
                ...
                openImport: a.createCallback(
                    l(() => ({ type: co, params: JSON.stringify({ titles: Array.from(e.titles().values()) }) })),
                    'openImportConfirm',
                ),
                openDeleteConfirm: a.createCallback(
                    (e, a) => ({ id: e, type: lo, params: JSON.stringify({ title: a }) }),
                    'openDeleteConfirm',
                ),
            };
        },
        { useRequires: () => ({ vehicles: Qi(), myVehicles: eo(), filters: Gi(), statistic: Ki() }) },
    ),
    bo = 'pending',
    fo = 'readyToSelect',
    go = qi,
    [vo, xo] = D('VehiclesInventoryProvider')(
        (e) => {
            const a = e.observableModel.primitives([
                ...
                l = Ye.primitive(() => -1 !== s.intCD.get()),
                c = Ye.shallow((e) => ca(e, (e) => _.get(String(e)))),
                _ = e.requires.myVehicles.model,
                u = Ye.structural(() => e.requires.vehicles.model.list().filter((e) => e.rent.isRented)),
                m = Ye.primitive(() =>
                ...
                p = Ye.primitive(() => {
                    ...
                    return (a.sort((e, a) => $i(t, Xi, e, a)), a);
                });
            return (
                e.cleanup(
                    d(() => {
                        ...
                        const s = e.requires.filters.model.filters.get(),
                            ...
                            o = (n ? c(n.list) : p()).filter(
                                (a) =>
                                    !1 !== i.has(a.id) && !!Vi(s, a, e.requires.statistic.model.get(a.id)) && zi(r, a),
                            );
                        x(() => t.set(o));
                    }),
                ),
                {
                    ...
                    current: {
                        ...
                        amount: Ye.primitive(() => t.get().length),
                        list: () => t.get(),
                        ids: Ye.shallow(() => t.get().map((e) => e.id)),
        ...
        }),
        {
            useRequires: () => ({
                ...
                statistic: Ki(),
                filters: Gi(),
                playlists: e.useContext(ho),
            }),
        },
    ),
    wo = -1,
    [Co, yo, { Context: jo }] = D('ManageableVehiclePlaylistsModel')(
        (e) => {
            const a = {
                    ...e.observableModel.primitives({ intCD: 'vehicleId' }),
                    displayedVehicleId: o.box(wo),
            ...
            return (
                ...
                ),
                {
                    ...
                    computeds: {
                        ...
                        empty: Ye.primitive(() => a.vehicleId.get() === wo),
                        sortedPlaylists: t,
                        hasChanges: Ye.primitive(() => a.changesInPlaylistSelection.size > 0),
                        enabled: Ye.primitive(() => e.requires.playlists.model.enabled.get()),
                    },
                }
            );
        },
        (e) => ({
            ...
            save: l(() => {
                ...
                for (const s of e.model.changesInPlaylistSelection) {
                    const t = oo(e.requires.playlists.model.byId(s));
        ...
        { useRequires: () => ({ vehicles: Qi(), playlists: po(), vehicleStatistics: Ki() }) },
    ),
    No = () => e.useContext(jo),
    So = (a) =>
        e.createElement(
            ...
            e.createElement(
                ...
                e.createElement(
                    ...
                    e.createElement('use', { xlinkHref: '#image0_111851_505980', transform: 'scale(0.0208333)' }),
                ),
                e.createElement(
                    'pattern',
    ...
    ko = 'Buttons_937965ba',
    Io = 'Buttons_right_268130b5',
    Po = 'Buttons_button_aeef4019',
    Ro = 'Buttons_button__create_61690fd8',
    Bo = 'Buttons_icon_378ba619',
    Ao = k.resolve('strings'),
    Eo = w(function () {
        const { model: e, controls: s } = yo();
        return a.jsxs('div', {
            className: t(ko),
            children: [
                a.jsx(da, {
                    body: Ao.readOrEmpty('playlists.managaeble_playlists.buttons.create.tooltipBody'),
                    children: a.jsx(B, {
                        className: t(Po, Ro),
                        ...
                        children: a.jsx(So, { className: Bo }),
                    }),
                }),
                a.jsxs('div', {
                    className: Io,
                    children: [
                        a.jsx(B, {
                            ...
                            children: a.jsx(_a, {
                                text: Ao.readOrEmpty('playlists.managaeble_playlists.buttons.cancel.title'),
                            }),
                        }),
                        a.jsx(B, {
                            className: Po,
                            ...
                            children: a.jsx(_a, {
                                text: Ao.readOrEmpty('playlists.managaeble_playlists.buttons.save.title'),
                            }),
                        }),
                    ],
                }),
    ...
    To = 'Item_itemBackground_f5007fc6',
    Lo = 'Item_c5163bf',
    Do = 'Item_checkbox_cfffba80',
    Wo = 'Item_item__checked_5f6fcc69',
    Oo = 'Item_check_a68580c8',
    Mo = 'Item_checkboxLabel_885d0061',
    Vo = w(function ({ id: e, title: s, checked: r }) {
        const { controls: n } = yo();
        return a.jsxs('div', {
            className: t(Lo, r && Wo),
            children: [
                a.jsx('div', { className: To }),
                a.jsx(Re, {
                    checked: r,
                    onCheckedChange: () => n.togglePlaylist(e),
                    size: ua.small,
                    className: Do,
                    classNames: { label: Mo, check: Oo },
                    children: a.jsx(_a, { text: s }),
                }),
            ],
        });
    }),
    zo = 'List_152fbdf4',
    Fo = 'List_scrollWrapper_e69e8089',
    ...
    Uo = w(function () {
        ...
        return a.jsxs('div', {
            ...
            children: [
                a.jsx(ma, {
                    classNames: { wrapper: Fo, content: Ho },
                    children: O(t, ({ id: e, title: t, selected: s }) => a.jsx(Vo, { id: e, title: t, checked: s }, e)),
                }),
                a.jsx(ce, { classNames: { base: $o } }),
            ],
        });
    }),
    Go = 'Vehicle_name_f5f779f6',
    qo = 'Vehicle_level_c03ad304',
    Xo = 'Vehicle_type_9905a21f',
    Zo = w(function () {
        const { model: e } = yo(),
        ...
        return a.jsxs(pa, {
            children: [
                a.jsx(pa.Level, { value: t.level, className: qo }),
                ha(t.type) &&
                    a.jsx(pa.Type, { size: pa.Type.sizes.x24x24, className: Xo, type: t.type, premium: t.elite }),
                a.jsx(_a, { text: t.fullName, className: Go }),
                s !== ba && a.jsx(pa.Role, { size: pa.Role.sizes.x16x16, roleKey: s }),
            ],
        });
    }),
    Ko = 'Styles_display_f2930fa3',
    Yo = 'Styles_header_dcb2494f',
    Qo = 'Styles_body_504cd01f',
    Jo = 'Styles_title_ece3f15e',
    el = k.resolve('strings');
function al({ className: e }) {
    return a.jsxs(fa.Header, {
        className: t(Yo, e),
        children: [
            a.jsx(fa.Title, {
                className: Jo,
                children: a.jsx(_a, { text: el.readOrEmpty('playlists.managaeble_playlists.header.title') }),
            }),
            a.jsx(Zo, {}),
        ],
    });
...
function tl({ className: e }) {
    return a.jsxs(fa.Body, {
        className: t(Qo, e),
        children: [a.jsx(fa.Divider, {}), a.jsx(fe, { children: a.jsx(Uo, {}) }), a.jsx(fa.Divider, {}), a.jsx(Eo, {})],
    });
}
const sl = e.memo(function ({ vehicleId: e, tipSize: s, className: r, children: n, ...i }) {
        return a.jsxs(fa.Display, {
            ...i,
            className: t(Ko, r),
            children: [a.jsx(fa.Tip, { size: s }), a.jsx(fa.Close, {}), n],
        });
    }),
    rl = w(({ children: a }) => {
        const t = ga(),
            ...
            r = xa(),
            n = wa(),
            { model: i, controls: o } = yo(),
            l = i.vehicleId.get(),
            c = i.displayedVehicleId.get(),
            [d, _] = e.useState(!1),
            [u, m] = e.useState(!1),
            p = $(() => {
                (m(!0), t.open(), r.run(() => m(!1), Ca));
            }),
            h = $(() => {
                (m(!0),
                    t.close(),
    ...
    il = w(function ({ children: t, position: s, freeSpaceRem: r, tipSize: n }) {
        const { model: i, controls: o } = yo(),
            l = i.displayedVehicleId.get(),
            c = ja('rem'),
            d = $((e, { callerBounding: a }) => {
                const t = e.trigger.bounding.get();
                if (t && !Na(t, a)) return (e.close(), !1);
            }),
            _ = i.vehicleId.get(),
        ...
        return (
            e.useEffect(() => {
                u && m === wo && _ !== wo && (o.goToCreatePlaylist([_]), o.reset());
            }, [m, _, u, o]),
            u
                ? null
                : a.jsx(fa, {
                          ...
                          children: [
                              a.jsx(fa.Portal, {
                                  ...
                                  children:
                                      ...
                                      a.jsxs(
                                          sl,
                                          { vehicleId: l, tipSize: n, children: [a.jsx(al, {}), a.jsx(tl, {})] },
                                          l,
                                      ),
                              }),
                              t,
...
const ol = 'emptySlot',
    ...
    hl = (e, a) => (e || a ? (e ? (a ? _l : cl) : ll) : dl),
    bl = 'Content_7ccb81a0',
    fl = 'Content_disabledOverlay_a8908196',
    gl = 'Content_base__disabled_da09528a',
    vl = 'Content_base__selected_da09528a',
    xl = 'Content_base__empty_da09528a';
function wl({ children: e, selected: s, disabled: r, empty: n }) {
    return a.jsxs('div', {
        'data-name': 'Content',
        className: t(bl, n && xl, s && vl, r && gl),
        children: [e, r && a.jsx('div', { className: fl })],
    });
}
const Cl = 'Slot_977dd8f1',
    yl = 'Slot_base__wrapper_ae3081b5',
    jl = 'Slot_base__disabled_334cc10f',
    Nl = 'Slot_base__empty_d386066c',
    Sl = 'Slot_content_1a27c8cf',
    kl = 'Slot_base__active_71f19f5c',
    Il = 'Slot_base__selected_71f19f5c',
    Pl = 'Slot_selected_6e9f21df',
    Rl = 'Slot_selected__border_e2a17304',
    Bl = e.memo(function ({ children: e, selected: s = !1, disabled: r = !1, active: n, className: i, ...o }) {
        const l = r || void 0 === o.onClick;
        return a.jsx('div', {
            ...o,
            'data-name': 'Slot',
            className: t(Cl, n && kl, s && Il, r && jl, l && Nl, yl, i),
            children: a.jsxs('div', {
                className: Sl,
                children: [
                    a.jsx(wl, { selected: s, disabled: r, empty: l, children: e }),
                    s && a.jsx('div', { className: t(Pl, Rl) }),
                    a.jsx('div', { className: Pl }),
                ],
            }),
        });
    }),
    Al = { buySlot: 'buySlot', buyTank: 'buyTank', restoreTank: 'restoreTank', rentTank: 'rentTank' },
    El = {
        [Al.buySlot]: 'buy_slot',
        [Al.buyTank]: 'buy_vehicle_new',
        [Al.restoreTank]: 'restore_vehicle',
        [Al.rentTank]: 'wot_plus_slot',
    },
    Tl = 'ActionCards_wrapper_690d669a',
    Ll = 'ActionCards_text_cdbc926',
    Dl = 'ActionCards_wrapper__double_70640c01',
    Wl = 'ActionCards_content_a46de8cf',
    Ol = 'ActionCards_content__buySlot_a70e9708',
    Ml = 'ActionCards_icon_f8219d70',
    Vl = 'ActionCards_contentIcon_166df330',
    zl = 'ActionCards_currency_ac7c654f',
    Fl = 'ActionCards_discount_967a7825',
    Hl = { [bo]: 'menu.tankCarousel.wotPlusSelectionPending', [fo]: 'menu.tankCarousel.wotPlusSelectionAvailable' },
    $l = w(function ({ type: e }) {
        const s = xo(),
            ...
            return a.jsx('div', {
                ...
                children: a.jsx(ka, {
                    ...
                    children: a.jsx(ue, {
                        ...
                        size: de.extraSmall,
                        reverse: !0,
                        classNames: { base: t(Wl, Ol), icon: Vl },
                        children: n,
                    }),
                }),
            });
        if (e === Al.rentTank) {
            const e = Hl[c];
            return e ? a.jsx(Pa, { className: Ll, upgradeLegacy: !0, path: e }) : null;
        }
        return a.jsxs('div', {
            className: Wl,
            children: [
...
function Ul({ type: s, width: r, height: n, doubleRow: i, className: o }) {
    const l = xo(),
        c = X(),
    ...
    const m = k.resolve('strings'),
        p = Ne(`hangar.carousel.actionCards.x48x48.${s}`, `hangar.carousel.actionCards.x96x96.${s}`),
        h = Ra({
            header: m.readOrEmpty(`tooltips.tanks_carousel.${El[s]}.header`),
            body: m.readOrEmpty(`tooltips.tanks_carousel.${El[s]}.body`),
        }),
        b = Ba(
            'actionSlotPrice',
            e.useMemo(() => [[d], [_]], [d, _]),
    ...
    return a.jsx(Bl, {
        ...
        onClick: function (e) {
            ...
            const a = {
                [Al.buySlot]: l.controls.buySlot,
                [Al.buyTank]: l.controls.goBuyVehicle,
                [Al.restoreTank]: l.controls.goRecoverVehicle,
                [Al.rentTank]: l.controls.selectTelecomRentalVehicle,
            }[s];
            if ('function' != typeof a) return console.error(`Unknown action type ${s} in ${Ul.name} handleClick`);
            a();
        },
        ...
        children: a.jsxs('div', {
            ...
            children: [
                ...
                a.jsx('div', { className: Ll, children: a.jsx(Pa, { path: `menu.tankCarousel.vehicleStates.${s}` }) }),
                a.jsx($l, { type: s }),
            ],
        }),
    });
...
const Gl = 'undamaged',
    ...
    Zl = '56833',
    Kl = '51201',
    Yl = { [ql]: 'alpha', [Xl]: 'alpha', [Kl]: 'super', [Zl]: 'super' },
    Ql = 'ammoNotFull',
    Jl = 'crewNotFull',
    ec = 'exploded',
    ac = 'destroyed',
    ...
    nc = 'rentalIsOver',
    ic = 'tooHeavy',
    oc = 'unsuitableToQueue',
    lc = 'unsuitableToUnit',
    cc = 'inPrebattle',
    dc = 'battle',
    _c = 'wot_plus_exclusive_vehicle_disabled',
    uc = {
        [Ql]: 'ammo',
        [Jl]: 'crew',
        [ec]: 'repair',
...
function mc(e, a, t) {
    return !(!e || a === qi || !t) && t.status !== oc && t.maxBpScore > 0;
}
const [pc, hc, bc] = D()(({ observableModel: e }) => ({
        ...e.primitives(['isCrystalEarnEnabled', 'isDailyMultipliedXpEnabled', 'isInfiniteAmmo']),
    })),
    fc = () => e.useContext(bc.Context),
    gc = {
    ...
    vc = {
        inactive: gc.base__inactive,
        activating: gc.base__activating,
        active: gc.base__active,
        deactivating: gc.base__deactivating,
    };
function xc({ className: e, doubleRow: s, state: r = 'inactive', isCornerHidden: n = !1 }) {
    return 'inactive' === r
        ? null
        : a.jsxs('div', {
              className: t(gc.base, r && vc[r], s && gc.base__double, e),
              children: [
                  a.jsx('div', { className: gc.glow }),
                  !n && a.jsx('div', { className: gc.corner }),
                  a.jsx('div', { className: gc.arrow }),
                  [gc.triangle__1, gc.triangle__2, gc.triangle__3].map((e) =>
                      a.jsx('div', { className: t(gc.triangle, e) }, e),
                  ),
              ],
          });
}
const wc = 'Background_1089bc1c',
    Cc = 'Background_wotPlus_3cf6035a',
    yc = 'Background_crystal_6112fa42',
    jc = 'Background_bpBonus_86685469',
    Nc = 'Background_flag_beb58b8',
    Sc = 'Background_base__double_26effab7',
    kc = 'Background_flag__active_de322c1b',
    Ic = 'Background_vehicle_23ef6e2b',
    Pc = 'Background_vehicle__dimmed_7f14a6c7',
    Rc = 'Background_crystal__limit_61072361',
    Bc = Ea('Favorite', 'Background_favorite_d98f92cc', {
        variants: { active: { true: 'Background_favorite__active_7f14a6c7' } },
    });
function Ac({ nationId: e, selected: s, active: r, className: n }) {
    return a.jsx(Aa, {
        className: t(Nc, s || (r && kc), n),
        path: `hangar.carousel.cards.flags.x400x300.${Xe(e)}`,
        position: 'top left',
    });
}
const Ec = w(function ({ vehicle: s, statistic: r, validBP: n, doubleRow: i, classNames: o }) {
    var l;
    const c = (null == (l = fc()) ? void 0 : l.model.isCrystalEarnEnabled.get()) ?? !0,
        d =
            (Te((null == r ? void 0 : r.numberOfCrystalEarned) ?? [], 1) ?? 0) <=
            (Te((null == r ? void 0 : r.numberOfCrystalEarned) ?? [], 0) ?? 0),
        _ = null == r ? void 0 : r.proBoostActive,
        u = null == r ? void 0 : r.fromWotPlus,
        m = c && s.crystalEarning && !u,
        p = Sa(_),
        h = e.useMemo(() => (_ ? (!1 === p ? 'activating' : 'active') : p ? 'deactivating' : 'inactive'), [_, p]);
    return a.jsxs(a.Fragment, {
        children: [
            u && a.jsx('div', { className: t(Cc, null == o ? void 0 : o.wotPlus) }),
            a.jsx(xc, { state: h, className: null == o ? void 0 : o.proBoostIcon, doubleRow: i, isCornerHidden: m }),
            m && a.jsx('div', { className: t(yc, d && Rc, null == o ? void 0 : o.crystal) }),
            (null == r ? void 0 : r.bpSpecial) &&
                n &&
                a.jsx('div', { className: t(jc, null == o ? void 0 : o.bpBonus) }),
        ],
    });
});
function Tc({ vehicle: e, validBP: s, dimmed: r, active: n, statistic: i, selected: o, doubleRow: l, ...c }) {
    return a.jsxs('div', {
        ...c,
        className: t(wc, l && Sc, c.className),
        children: [
            a.jsx(Ac, { nationId: e.nationId, active: n, selected: o }),
            a.jsx(Ta, {
                className: t(Ic, (((null == i ? void 0 : i.status) && i.status !== Gl) || r) && Pc),
                name: e.name,
            }),
            a.jsx(Ec, { vehicle: e, statistic: i, validBP: s, doubleRow: l }),
            a.jsx(Bc, { active: e.favorite }),
        ],
    });
}
const Lc = 'Bonuses_8169b4b3',
    Dc = 'Bonuses_bonus_af8ebe7c',
    Wc = 'Bonuses_bonus__active_2364401e',
    Oc = 'Bonuses_bonusIcon_b65fb47f',
    Mc = 'Bonuses_bonusValue_322db074',
    Vc = 'Bonuses_rent_ea11a7e4',
    zc = 'Bonuses_base__double_ca1cd57b',
    Fc = 'Bonuses_icon_3991db74',
    Hc = 'Bonuses_text_a556857c',
    $c = k.resolve('strings');
function Uc({ bonusMultiplier: e, className: s, classNames: r }) {
    return a.jsxs('div', {
        className: t(Dc, -1 !== e && Wc, s),
        children: [
            a.jsx('div', { className: t(Oc, null == r ? void 0 : r.icon) }),
            a.jsx('div', {
                className: t(Mc, null == r ? void 0 : r.value),
                children: `${$c.readOrEmpty('common.multiplierSmall')}${e}`,
            }),
        ],
    });
}
const Gc = w(function ({ vehicle: e, statistic: s, doubleRow: r, ...n }) {
        var i;
        const o = (null == (i = fc()) ? void 0 : i.model.isDailyMultipliedXpEnabled.get()) ?? !0;
        return a.jsxs('div', {
            ...n,
            className: t(Lc, r && zc, n.className),
            children: [
                o && s && a.jsx(Uc, { bonusMultiplier: s.bonusMultiplier }),
                a.jsx(La.ShortCounter, {
                    time: e.rent.leftTime,
                    wins: e.rent.leftWins,
                    battles: e.rent.leftBattles,
                    classNames: { base: Vc, icon: Fc, text: Hc },
                }),
            ],
        });
    }),
    ...
    Xc = Ea('VehicleName', {
        element: (e) => a.jsx(pa.Name, { ...e }),
        className: qc.text,
        cva: { variants: { premium: { true: qc.text__premium } } },
    });
function Zc({ statistic: e, vehicle: s, className: r, status: n }) {
    const i = k.resolve('views'),
        o = k.resolve('aliases'),
        l = k.resolve('strings'),
        c = Da({
    ...
    return a.jsxs('div', {
        className: t(qc.battlePass, e.maxBpScore > 0 && qc.battlePass__active, e.bpSpecial && qc.battlePass__bonus, r),
        onMouseEnter: function (e) {
        ...
        children: [
            a.jsxs('div', {
                className: qc.bpPoints,
                children: [
                    a.jsx('div', { className: qc.points, children: Wa.formatNumber('integral', e.bpProgress) }),
                    a.jsx('div', {
                        className: t(qc.points, qc.points__slash),
                        children: l.readOrEmpty('common.common.slash'),
                    }),
                    a.jsx('div', { className: qc.points, children: Wa.formatNumber('integral', e.maxBpScore) }),
                    a.jsx('div', { className: qc.bpShadow }),
                ],
            }),
            a.jsx('div', { className: qc.bpIcon }),
        ],
    });
}
function Kc({ statistic: e, elite: s, vehicle: r, selected: n, classNames: i, className: o }) {
    return a.jsxs('div', {
        className: t(qc.details, o),
        children: [
            e &&
                a.jsx(pa.Prestige, {
                    ...
                    type: e.prestigeType,
                    direction: Oa.left,
                    className: t(qc.prestige, n && qc.prestige__active, null == i ? void 0 : i.prestige),
                }),
            a.jsx(pa.Level, { className: t(qc.text, qc.text__level, null == i ? void 0 : i.level), value: r.level }),
            ha(r.type) &&
                a.jsx(pa.Type, {
                    type: r.type,
                    premium: s || (null == e ? void 0 : e.elite),
                    size: pa.Type.sizes.x24x24,
                    className: null == i ? void 0 : i.type,
                }),
        ],
    });
}
function Yc({ vehicle: e, className: s, classNames: r }) {
    const n = Yl[e.id],
    ...
    return a.jsxs('div', {
        className: t(
            qc.identifier,
            qc[`identifier__${n}`],
            i && qc.identifier__changeNation,
            o && qc.identifier__rent,
            s,
        ),
        children: [
            a.jsx(Xc, {
                ...
                premium: e.premium,
                children: a.jsx(_a, { className: qc.truncatedText, text: e.shortName }),
            }),
            (n || i) &&
                a.jsx('div', {
                    className: t(
                        qc.identifierIcon,
                        qc[`identifierIcon__${n}`],
                        i && qc.identifierIcon__changeNation,
...
const Qc = w(function ({ vehicle: e, statistic: s, selected: r, doubleRow: n, ...i }) {
        const o = xo(),
            l = o.model.bpState.active.get(),
            c = o.model.bpState.status.get();
        return a.jsxs('div', {
            ...i,
            className: t(qc.base, n && qc.base__double, i.className),
            children: [
                s && mc(l, c, s) && a.jsx(Zc, { vehicle: e, statistic: s, status: c }),
                a.jsxs(pa, {
                    className: qc.info,
                    children: [a.jsx(Kc, { vehicle: e, statistic: s, selected: r }), a.jsx(Yc, { vehicle: e })],
                }),
            ],
        });
    }),
...
function ed({ status: e, classNames: s, className: r }) {
    const n = k.resolve('images'),
        i = Ne(`hangar.carousel.cards.alerts.${uc[e]}`, `hangar.carousel.cards.alerts.${uc[e]}_upscale`),
        o = Ne('hangar.carousel.cards.alerts.notSuitable', 'hangar.carousel.cards.alerts.notSuitable_upscale'),
        l = e === dc || e === cc;
    return a.jsxs('div', {
        className: t(Jc.alert, r),
        children: [
            a.jsx(Aa, { className: t(Jc.alertIcon, null == s ? void 0 : s.icon), path: n.has(i) ? i : o }),
            a.jsx(Pa, {
                upgradeLegacy: !0,
                className: t(Jc.alertText, l && Jc.alertText__light, null == s ? void 0 : s.text),
                path: `menu.tankCarousel.vehicleStates.${e}`,
                params: { icon: a.jsx(Aa, { path: 'library.premium_small', width: 34, height: 16 }) },
            }),
        ],
    });
}
function ad({ statistic: e, doubleRow: s, ...r }) {
    return e.status === Gl
        ? null
        : a.jsx('div', {
              ...r,
              className: t(Jc.base, s && Jc.base__double, r.className),
              children: a.jsx(ed, { status: e.status }),
          });
}
Ea('Disable', Jc.disable);
const td = 'Card_e79008fd',
    sd = 'Card_base__double_f8b7f334',
    rd = 'Card_content_a6141b08',
    nd = 'Card_border_e9cb9a85',
    id = k.resolve('views'),
    od = k.resolve('aliases'),
    ld = w(function ({ vehicleId: e, selected: s = !1, doubleRow: r, children: n, concurrent: i, ...o }) {
        const l = xo(),
            c = Qi().model.get(e),
            d = Ki().model.get(e),
            _ = X(),
        ...
        return a.jsxs(Bl, {
            ...
            children: [
                a.jsx(b, { vehicle: c, validBP: mc(p, h, d), dimmed: m, statistic: d, selected: s, doubleRow: r }),
                a.jsx(dd, {
                    concurrent: i,
                    statistic: d,
                    vehicle: c,
...
function dd({ vehicle: s, statistic: r, selected: n, doubleRow: i, concurrent: o, disableContextMenu: l }) {
    const [c, d] = e.useState(o),
        ...
        m = Da({
            ...
            contentId: id.read((e) => e.mono.hangar.vehicle_tooltip('resId')),
            args: C.useMemo(
                () => ({ inventoryId: null == s ? void 0 : s.inventoryId }),
                [null == s ? void 0 : s.inventoryId],
            ),
            ...
            : a.jsxs('div', {
                  ...
                  children: [
                      a.jsxs('div', {
                          className: rd,
                          children: [
                              a.jsx(Gc, { vehicle: s, statistic: r, doubleRow: i }),
                              a.jsx(Qc, { vehicle: s, selected: n, statistic: r, doubleRow: i }),
                          ],
                      }),
                      a.jsx(ad, { statistic: r, doubleRow: i }),
                  ],
              })
    );
}
...
function ud({ width: e, className: t }) {
    return a.jsx('div', {
        className: _d.empty,
        children: a.jsx(Bl, {
            className: t,
            style: { width: `${e}px` },
            children: a.jsx('div', { className: _d.vehicleSlot }),
        }),
    });
}
function md({ slotId: s, width: r, currentVehicleId: n, double: i, className: o }) {
    const l = (function (a) {
        const t = No(),
        ...
        return e.useMemo(() => {
            if (s && !r) return { 'data-popover-trigger-id': nl(a), onMouseDown: n };
        }, [r, s, n, a]);
    })(Number(s));
    return void 0 === s
        ? null
        : s in Al
          ? a.jsx(Ul, { className: t(nd, o), type: s, width: r, doubleRow: i })
          : 'emptySlot' === s
            ? a.jsx(ud, { className: t(nd, o), width: r })
            : a.jsx(ld, {
                  ...l,
                  vehicleId: s,
                  selected: s === n,
...
function pd({ chunkedSlots: e, classNames: s, ...r }) {
    return void 0 === e
        ? null
        : a.jsx('div', {
              className: _d.doubleSlots,
              children: e.map((e, n) =>
                  a.jsx(md, { ...r, slotId: e, className: t(_d.slot__double, null == s ? void 0 : s.slot) }, n),
              ),
          });
}
const hd = {
...
function bd({ direction: e, className: s, ...r }) {
    return a.jsx(B, {
        ...r,
        classNames: {
            base: t(hd.button, hd[`button__${e}`], s),
        ...
        children: a.jsx(Aa, { path: 'hangar.carousel.buttonArrow', className: hd.icon }),
    });
}
bd.direction = { right: 'right', left: 'left' };
const fd = {
...
function vd({ itemWidth: s, api: r, children: n }) {
    ...
    return a.jsxs('div', {
        className: fd.navButtonWrapper,
        children: [
            a.jsx(bd, {
                direction: bd.direction.left,
                onMouseDown: gd(() => b(-1)),
                onMouseUp: f,
                onMouseLeave: f,
                className: t(fd.navButton, fd.navButton__left, p && fd.navButton__hidden),
            }),
            a.jsx('div', { className: t(fd.mask, fd[`mask__${hl(u, m)}`]), children: n }),
            a.jsx(bd, {
                direction: bd.direction.right,
                onMouseDown: gd(() => b(1)),
                onMouseUp: f,
                onMouseLeave: f,
                className: t(fd.navButton, fd.navButton__right, h && fd.navButton__hidden),
            }),
        ],
    });
}
const xd = { base: 'CarouselScroll_3690a837', areaContent: 'CarouselScroll_areaContent_f5dd7772' },
    wd = 'dragging',
    Cd = 'idle';
function yd({
    api: s,
    ...
    const { animationScroll: d, applyScroll: _, setDisabled: u } = s,
        m = za(s, Ha.horizontal, void 0, { gapBeforeStart: 5 });
    return (
        e.useEffect(() => {
            null == c || c(m.type === wd);
        }, [m.type, c]),
        ...
        e.useEffect(
            () =>
                Ce(() => {
                    m.type === Cd && d.scrollPosition.idle && _(d.scrollPosition.get());
                }),
            [d.scrollPosition, m, _],
        ),
        a.jsx('div', {
            className: t(xd.base, n),
            children: a.jsxs(Fa, {
                className: null == i ? void 0 : i.base,
                classNames: {
                    wrapper: t(xd.areaWrapper, null == i ? void 0 : i.wrapper),
                    content: t(xd.areaContent, null == i ? void 0 : i.content),
                },
                children: [r, o],
            }),
        })
...
const jd = 'CarouselSkeleton_1ac002e3',
    Nd = 'CarouselSkeleton_content_b18f8dd7',
    Sd = 'CarouselSkeleton_scroll_badf82c7';
function kd(e) {
    return a.jsx('div', { ...e, className: t(Nd, e.className) });
}
function Id({
    api: e,
    widthElement: s,
    ...
    return a.jsx('div', {
        className: t(jd, null == l ? void 0 : l.base),
        children: a.jsx(vd, {
            api: e,
            itemWidth: s,
            children: a.jsx($a, {
                ...
                totalElements: r,
                wrappers: { Content: kd },
                className: t(Sd, null == l ? void 0 : l.scroll),
                renderScroll: (t) => a.jsx(yd, { ...t, api: e, disabled: n, onDraggingState: i, children: t.children }),
                renderElement: (e) => (o ? o(e) : a.jsx(ud, { className: null == l ? void 0 : l.element, width: s })),
            }),
        }),
    });
}
function Pd(a, t, s, r) {
    return e.useMemo(() => {
        ...
        const e = ((e, a) => ({
                left: [...(a != go ? [Al.rentTank] : [])],
                right: [Al.buyTank, ...(e > 0 ? [Al.restoreTank] : []), Al.buySlot],
            }))(s, r),
            n = a.length + e.right.length + e.left.length,
            i = Math.max(0, t - n);
        return { activeSlotsAmount: n, activeSlotsIds: [...e.left, ...a, ...e.right, ...Array(i).fill(ol)] };
    }, [s, a, t, r]);
}
function Rd({ api: a, carouselRows: t }) {
    const s = (function (e) {
            const a = I(pl.default, pl.breakpoints);
            return Va(2 === e ? a.double : a.single);
        })(t),
    ...
    return (
        e.useLayoutEffect(() => {
            ...
            e();
            return new Z().add(a.events.on('resizeHandled', e)).add(a.events.on('recalculateContent', e)).dispose;
        }, [a, s, t]),
        r
    );
}
const Bd = 'Carousel_draggingOverlay_2ac699b0',
    Ad = 'Carousel_9b3e04da',
    Ed = 'Carousel_base__visible_24d53d12',
    Td = 'Carousel_card_5449ec9a',
    Ld = 'Carousel_card__inactive_c59331d9';
w(function () {
    const s = No(),
        [r, n] = e.useState(!1),
        { api: i } = Ua(),
        o = xo(),
        l = Gi().model.carouselRowCount.get(),
        ...
        { carouselRows: g, cardWidth: v, visibleSlots: x } = Rd({ api: i, carouselRows: l }),
        { activeSlotsAmount: w, activeSlotsIds: C } = Pd(_, x, f, d),
        j =
            ((N = C),
            e.useMemo(() => {
                var e, a;
    ...
    (e.useEffect(() => {
        ...
        (function (a, t, s, r, n, i) {
            ...
            e.useLayoutEffect(() => {
                ...
                return (
                    e(),
                    new Z().add(a.events.on('resizeHandled', e)).add(a.events.on('recalculateContent', e)).dispose
                );
            }, [t, a, s, r, i, n]);
        ...
        (function (e, a, t, s, r) {
            ...
            const o = [
                { key: L.ARROW_DOWN, blockKey: !n || e % s === s - 1 || e === a.length - 1, action: () => i(1) },
                { key: L.ARROW_UP, blockKey: !n || e % s === 0, action: () => i(-1) },
                { key: L.ARROW_LEFT, blockKey: n ? e < s : 0 === e, action: () => i(-s) },
                { key: L.ARROW_RIGHT, blockKey: n ? e > a.length - (s + 1) : e === a.length - 1, action: () => i(s) },
                { key: L.HOME, blockKey: 0 === a.length, action: () => t(a[0].inventoryId) },
                { key: L.END, blockKey: 0 === a.length, action: () => t(a[a.length - 1].inventoryId) },
            ];
            for (const { key: l, blockKey: c, action: d } of o) {
                const e = r || c ? L.NONE : l;
                be(e, d);
            }
        ...
        a.jsxs(a.Fragment, {
            children: [
                a.jsx(Id, {
                    ...
                    disabled: x > w,
                    onDraggingState: n,
                    classNames: { base: t(Ad, S && Ed), element: t(Td, r && Ld) },
                    renderElement: (e) => {
                        const s = t(Td, r && Ld);
                        return 2 === g
                            ? a.jsx(Xa, {
                                  failure: () => a.jsx(ud, { className: s, width: v }),
                                  children: a.jsx(
                                      pd,
                                      {
                                          chunkedSlots: j[e],
                            ...
                            : a.jsx(Xa, {
                                  ...
                                  children: a.jsx(
                                      md,
                                      { slotId: C[e], currentVehicleId: p, width: v, className: s, double: !1 },
                                      C[e] ?? e,
                                  ),
                              });
                    },
                }),
                s && s.model.computeds.enabled() && a.jsx(il, { freeSpaceRem: 0, tipSize: '32rem' }),
                y.createPortal(r && a.jsx('div', { className: Bd }), document.body),
            ],
        })
    );
});
const Dd = 'ActiveCardHeader_235d362d',
    Wd = 'ActiveCardHeader_activeText_530ba0e9',
    Od = 'ActiveCardHeader_idleVideo_b2e26623',
    Md = function ({ text: e, videoSrc: s, className: r = '', classNames: n }) {
        return a.jsxs('div', {
            className: t(Dd, r),
            children: [
                a.jsx('div', { className: t(Wd, null == n ? void 0 : n.activeText), children: e }),
                a.jsx(Oe, { className: t(Od, null == n ? void 0 : n.idleVideo), src: s, autoplay: !0, loop: !0 }),
            ],
        });
    },
    Vd = 'Content_8ce13fac',
    zd = 'Content_base__disabled_da09528a',
    Fd = 'Content_base__selected_da09528a';
function Hd({ children: e, selected: s, disabled: r }) {
    return a.jsx('div', { className: t(Vd, s && Fd, r && zd), children: e });
}
const $d = 'Slot_750e4447',
    Ud = 'Slot_base__disabled_440d6866',
    Gd = 'Slot_content_27d2b58',
    qd = 'Slot_base__active_71f19f5c',
    Xd = 'Slot_base__selected_71f19f5c',
    Zd = 'Slot_selected_302eadc9',
    Kd = 'Slot_selected__border_e2a17304';
function Yd({ children: e, selected: s = !1, disabled: r = !1, active: n = !1, className: i, ...o }) {
    return a.jsx('div', {
        ...o,
        className: t($d, n && qd, s && Xd, r && Ud, i),
        children: a.jsxs('div', {
            className: Gd,
            children: [
                a.jsx(Hd, { selected: s, disabled: r, children: e }),
                s && a.jsx('div', { className: t(Zd, Kd) }),
                a.jsx('div', { className: Zd }),
            ],
        }),
    });
}
const Qd = 'regular',
    ...
    r_ = ({ type: e, className: s }) =>
        a.jsxs('div', {
            className: t(s_.base, s_[`base__${e}`], s),
            children: [
                a.jsx('div', { className: s_.glowBig }),
                a.jsx('div', { className: s_.line }),
                a.jsx('div', { className: s_.shadow }),
                a.jsx('div', { className: s_.glowInner }),
                a.jsx('svg', {
                    width: '42',
                    height: '42',
                    viewBox: '0 0 42 42',
                ...
                a.jsx('div', { className: t(s_.icon) }),
            ],
        }),
    n_ = 'UnlockedState_d8033d83',
    i_ = 'UnlockedState_stages_ef0d6acd',
    o_ = 'UnlockedState_mainStage_286ea378',
    l_ = 'UnlockedState_additionalStage_83045438',
    c_ = 'UnlockedState_cycleText_5b49e844',
    d_ = R.strings.battle_pass.chapterChoice,
    __ = function ({ currentLevel: e, cyclesCompletedCount: t, maxLevel: s }) {
        const r = (e - 1) % s;
        return a.jsxs('div', {
            className: n_,
            children: [
                a.jsx(E, { classMix: c_, text: d_.postprogression.unlocked.cycle(), binding: { cycle: t + 1 } }),
                a.jsxs('div', {
                    className: i_,
                    children: [
                        a.jsx('span', { className: o_, children: `${r}` }),
                        a.jsx(E, { classMix: l_, text: d_.stages.additional(), binding: { level: s } }),
                    ],
                }),
            ],
        });
    },
    u_ = 'PostprogressionInfo_f8fcfc44',
    m_ = 'PostprogressionInfo_lockedText_c823728d',
    p_ = R.strings.battle_pass.chapterChoice,
    h_ = i(function ({ chapterID: e }) {
        const { model: t } = Si(),
        ...
        return a.jsx('div', {
            ...
            children: o
                ? a.jsx(_e, {
                      className: m_,
                      text: p_.postprogression.locked(),
                      params: { count: t.computes.regularChapters().length - 1 },
                  })
                : a.jsx(__, { currentLevel: r, cyclesCompletedCount: n, maxLevel: i }),
        });
    }),
    b_ = 'CompletedState_completeText_f209b72f',
    f_ = 'CompletedState_completeText__bought_4533734f',
    g_ = R.strings.battle_pass.chapterChoice,
    v_ = function ({ isBought: e, chapterRewardsCount: s }) {
        return a.jsx(a.Fragment, {
            children: e
                ? a.jsx('div', { className: t(b_, f_), children: g_.stages.complete.improved() })
                : a.jsx(E, { classMix: b_, text: g_.stages.complete.unimproved(), binding: { count: s } }),
        });
    },
    x_ = 'UncompletedState_9e8c0393',
    w_ = 'UncompletedState_mainStage_5808557f',
    C_ = 'UncompletedState_additionalStage_ef80ee9c',
    y_ = R.strings.battle_pass.chapterChoice,
    j_ = function ({ currentLevel: e, maxStages: t }) {
        return a.jsxs('div', {
            className: x_,
            children: [
                a.jsx('span', { className: w_, children: '' + (e - 1) }),
                a.jsx(E, { classMix: C_, text: y_.stages.additional(), binding: { level: t } }),
            ],
        });
    },
    N_ = 'RegularInfo_46f7818d',
    S_ = 'RegularInfo_uncomplete_854e3542';
R.strings.battle_pass.chapterChoice;
const k_ = i(function ({ chapterID: e }) {
        const { model: t } = Si(),
            s = t.computes.getChapterById(e);
        if (!s) return;
        const { currentLevel: r, chapterState: n, isBought: i, chapterRewardsCount: o, maxLevel: l } = s;
        return a.jsx('div', {
            className: N_,
            children:
                n === os.Completed
                    ? a.jsx(v_, { isBought: i, chapterRewardsCount: o })
                    : a.jsx('div', { className: S_, children: a.jsx(j_, { currentLevel: r, maxStages: l }) }),
        });
    }),
    I_ = {
    ...
    P_ = k.resolve('images'),
    R_ = k.resolve('strings'),
    B_ = R.strings.battle_pass.chapterChoice,
    A_ = i(function ({ chapterID: e, className: s = '' }) {
        const { model: r } = Si(),
            { breakpoint: n } = ge(),
            i = r.computes.getChapterById(e),
            o = I({ iconSize: dn }, { large: { iconSize: _n }, extraLarge: { iconSize: mn } }),
            l = Ne(o.iconSize, pn);
        if (!i) return;
        const { isBought: c, isPostProgression: d, isExtra: _ } = i,
            ...
            m = (() => {
                const a = String(e).slice(-1);
                return (
                    P_.readOrEmpty(`battlePass.emblem.icon.c_${e}.${c ? 'purchased' : 'basic'}.${l}`, 'silent') ||
                    P_.readOrEmpty(`battlePass.emblem.icon.default_${a}.${c ? 'purchased' : 'basic'}.${l}`)
                );
            })();
        return a.jsxs('div', {
            className: t(I_.base, d && I_.base__postprogression),
            children: [
                a.jsx('div', {
                    className: t(I_.infoIcon, I_[`infoIcon__${o.iconSize}`]),
                    style: { backgroundImage: `url(${m})` },
                }),
                a.jsxs('div', {
                    className: I_.infoDescription,
                    style: { '--card-width': t_[u][n.name].cardWidth },
                    children: [
                        a.jsx('div', {
                            className: t(I_.chapterName, c && I_.chapterName__bought),
                            children: d
                                ? B_.postprogression.name()
                                : R_.readOrEmpty(`battle_pass.chapter.fullName.c_${e}`),
                        }),
                        d ? a.jsx(h_, { chapterID: e }) : a.jsx(k_, { chapterID: e }),
                    ],
                }),
            ],
        });
    ...
    T_ = k.resolve('images'),
    L_ = (e, a = !1) => (e === os.Completed ? Ka.done : a ? Ka.locked : void 0),
    D_ = i(function ({ chapterID: e, classNames: s = {} }) {
        const { model: r } = Si(),
            { breakpoint: n } = ge(),
            i = r.computes.getChapterById(e);
        if (!i) return;
        const { chapterState: o, isExtra: l, isPostProgression: c, currentLevel: d, maxLevel: _ } = i,
            ...
            p = r.computes.regularChapters().length - 1 !== r.computes.regularChaptersCompleteCount() && c,
            h = String(e).slice(-1),
            b =
                T_.readOrEmpty(`battlePass.chapter_choice.card_bg.c_${e}`, 'silent') ||
                T_.readOrEmpty(`battlePass.chapter_choice.card_bg.default_${h}`),
            f =
                T_.readOrEmpty(`battlePass.chapter_choice.tanks.c_${e}`, 'silent') ||
                T_.readOrEmpty(`battlePass.chapter_choice.tanks.default_${h}`);
        return a.jsxs('div', {
            className: t(E_.base, E_[`base__${o}`], m && E_.base__selected),
            children: [
                a.jsx('div', { className: E_.bg, style: { backgroundImage: `url(${b})` } }),
                a.jsx('div', {
                    className: t(E_.reward, s.reward),
                    style: {
                        backgroundImage: `url(${f})`,
                        width: t_[u][n.name].rewardWidth,
                        height: t_[u][n.name].rewardHeight,
                    },
                }),
                o !== os.Completed &&
                    !c &&
                    a.jsx(Za, {
                        ...
                        maxValue: _,
                        size: 'small',
                        className: t(E_.progressBar, o === os.Active && E_.progressBar__active),
                        classNames: { background: E_.progressBarBg },
                    }),
                a.jsx('div', { className: E_.info, children: a.jsx(A_, { chapterID: e }) }),
                L_(o, p) && a.jsx('div', { className: E_.status, children: a.jsx(r_, { type: L_(o, p) }) }),
            ],
        });
    }),
    W_ = {
    ...
    M_ = i(function ({ chapterID: e }) {
        const { model: s, controls: r } = Si(),
            { breakpoint: n } = ge(),
        ...
        const { chapterState: o, isPostProgression: l, isExtra: c } = i,
            ...
            m = a_(c, l);
        return a.jsxs('div', {
            className: t(W_.base, c && W_.base__extra),
            children: [
                o === os.Active &&
                    a.jsx(Md, {
                        text: l ? O_.activeChapter.postprogression.text() : O_.activeChapter.text(),
                        videoSrc: R.videos.battle_pass.chapter_choice.activeAnimation(),
                        className: W_.active,
                        classNames: { idleVideo: W_[`idleVideo__${l ? Jd : Qd}`] },
                    }),
                a.jsx(Yd, {
                    selected: d === e,
                    active: o === os.Active,
                    onClick: () => {
                        e !== d &&
                            ...
                            r.onChapterSelect(e),
                            Pe.sound(R.sounds.bp_select_chapter()));
                    },
                    onMouseEnter: () => {
                        Pe.sound(R.sounds.bp_highlight_02());
                    },
                    className: W_.slot,
                    style: { width: t_[m][n.name].cardWidth, height: t_[m][n.name].cardHeight },
                    'data-test-id': `chapterID-${e}`,
                    children: a.jsx(D_, { chapterID: e }),
                }),
            ],
        });
    }),
    ...
    z_ = i(function () {
        const { model: s, controls: r } = Si(),
            ...
            m = u.indexOf(_),
            p = za(o, Ha.horizontal, void 0, { gapBeforeStart: 5 }),
            [h, b] = ie(o);
        (e.useEffect(() => {
            ...
            e.useEffect(() => {
                const e = (e, a, t) => {
                    !1 === (Qa(a.get(), t) && Qa(a.goal, t)) && e.stopPropagation();
                };
                return (
        ...
        return (
            ...
            a.jsxs('div', {
                ...
                children: [
                    a.jsx('div', {
                        className: t(V_.mask, V_[`mask__${hl(h, b)}`]),
                        children: a.jsx(Fa, {
                            classNames: { wrapper: V_.scrollWrapper },
                            children: a.jsx('div', {
                                className: t(V_.cardsWrapper, n && V_.cardsWrapper__inactive),
                                children: O(u, (e, t) => a.jsx(M_, { chapterID: e.chapterID }, `${e.chapterID}_${t}`)),
                            }),
                        }),
                    }),
                    a.jsx(Ya, { classNames: { base: V_.scrollBar } }),
                ],
            })
        );
    }),
    F_ = 'ButtonsGroup_6fd5782',
    H_ = 'ButtonsGroup_button_17bae557',
    $_ = k.resolve('strings'),
    U_ = i(function () {
        const e = pe(),
            { model: t, controls: s } = Si(),
            r = t.computes.selectedChapter(),
            { breakpoint: n } = ge(),
            i = n.weight >= ve.large.weight ? P.large : P.medium;
        return (
            be(L.SPACE, () => {
                (null == r ? void 0 : r.isPostProgression)
                    ? e.push(ts.battlePass.postProgression, {})
                    : e.push(ts.battlePass.progression, { chapterID: null == r ? void 0 : r.chapterID });
            }),
            a.jsxs('div', {
                className: F_,
                children: [
                    (null == r ? void 0 : r.isPostProgression)
                        ? a.jsx(B, {
                              onClick: () => e.push(ts.battlePass.postProgression, {}),
                              className: H_,
                              size: i,
                              'data-test-id': 'toPostProgression',
                              children: $_.readOrEmpty(
                        ...
                        : a.jsx(B, {
                              ...
                              children: $_.readOrEmpty('battle_pass.chapterChoice.chapterInfo.buttons.toChapter'),
                          }),
                    0 !== (null == r ? void 0 : r.tankmenScreenID) &&
                        a.jsx(B, {
                            ...
                            children: $_.readOrEmpty('battle_pass.chapterChoice.chapterInfo.buttons.toCrewMembers'),
                        }),
                ],
            })
        );
    }),
    G_ = 'Deadline_d8216f12',
    q_ = 'Deadline_timerIcon_cda81cf2',
    X_ = 'Deadline_timerLabel_218217e0',
    Z_ = k.resolve('strings'),
    K_ = tt,
    Y_ = i(function () {
        const { model: e } = Si(),
        ...
        return a.jsx('div', {
            ...
            children: r
                ? a.jsx(E, {
                      text: Z_.readOrEmpty('battle_pass.chapterChoice.chapterInfo.deadline.time'),
                      binding: {
                          endTime: a.jsx(et, { start: s, size: at.x48x48, classNames: { icon: q_, label: X_ } }, s),
                      },
                  })
                : a.jsx(E, {
                      text: Z_.readOrEmpty('battle_pass.chapterChoice.chapterInfo.deadline.date'),
                      binding: { endDate: K_(t, st.DayMonthFull) },
                  }),
        });
    }),
    Q_ = {
    ...
    su = function ({
        ...
        const [d, _] = e.useState(!1),
            u = tu.readOrEmpty(`battlePass.icons.previewButton.${Ne(s, au)}`);
        return a.jsx('div', {
            className: t(Q_.base, d && Q_.base__hovered, Q_[`base__${s}`], c),
            onClick: (e) => {
                (null == r || r(e), l && Pe.sound(l));
            },
            onMouseEnter: () => {
                (_(!0), null == n || n(), o && Pe.sound(o));
            },
            onMouseLeave: () => {
                (_(!1), null == i || i());
            },
    ...
    lu = 'x80x80',
    cu = k.resolve('images'),
    du = function ({ iconSize: e, className: s = '' }) {
        const r = cu.readOrEmpty(`battlePass.icons.inGarage.${e}`);
        return a.jsx('div', { className: t(ru.base, ru[`base__${e}`], s), style: { backgroundImage: `url(${r})` } });
    },
    _u = {
                ...
                e === mu
                    ...
                    : e === pu
                      ? r >= ve.large.weight
                          ...
                          : nu
                      : iu,
            o = { level: _u.vehicleLevel, name: _u.vehicleName },
            l = { level: _u.styleLevel, name: _u.styleName };
        if (!s) return;
        const { styleName: c, vehicleInfo: d, finalRewardType: _, isVehicleInHangar: u } = s;
        return (() => {
            switch (_) {
                case ls.Vehicle:
                    return a.jsxs('div', {
                        className: _u.vehicleWrapper,
                        children: [
                            a.jsx(E, {
                                classMix: _u.vehicle,
                                text: uu.readOrEmpty('battle_pass.chapterChoice.vehicle.reward.subTitle'),
                                binding: {
                                    vehicleName: a.jsx(rs, { ...d, vehicleTypeIconSize: n(mu), classNames: o }),
                                },
                            }),
                            u && a.jsx(du, { iconSize: i(mu), className: t(_u.inGarage, _u.inGarage__vehicle) }),
                        ],
                    });
                case ls.VehicleStyle:
                    return a.jsx(E, {
                        classMix: _u.vehicleStyle,
                        text: uu.readOrEmpty('battle_pass.chapterChoice.vehicleStyle.reward.subTitle'),
                        binding: { styleName: c },
                    });
                case ls.Style:
                    return a.jsxs('div', {
                        className: _u.styleWrapper,
                        children: [
                            a.jsx(E, {
                                classMix: _u.style,
                                text: uu.readOrEmpty('battle_pass.chapterChoice.stylePreview.reward.subTitle'),
                                binding: {
                                    vehicleName: a.jsx(rs, { ...d, vehicleTypeIconSize: n(pu), classNames: l }),
                                },
                            }),
                            u && a.jsx(du, { iconSize: i(pu), className: t(_u.inGarage, _u.inGarage__style) }),
                        ],
                    });
                case ls.Tankman:
                    return a.jsx(E, {
                        classMix: _u.crew,
                        text: uu.readOrEmpty('battle_pass.chapterChoice.crewMember.reward.subTitle'),
                    });
                case ls.PostProgression:
                    return a.jsx(E, {
                        classMix: _u.postProgression,
                        text: uu.readOrEmpty('battle_pass.chapterChoice.eliteCircuit.reward.subTitle'),
                    });
                default:
                    return '';
            }
    ...
    bu = 'Title_vehicleStyleWrapper_5727057f',
    fu = 'Title_postProgression_2e63cf3',
    gu = 'Title_crew_ace25966',
    vu = 'Title_vehicle_c974ddd5',
    xu = 'Title_vehicleStyle_e7d39a46',
    wu = 'Title_style_2e63cf3',
    Cu = 'Title_level_2e63cf3',
    yu = 'Title_name_93838a06',
    ju = 'Title_inGarage_1c4370bb',
    Nu = k.resolve('strings'),
    Su = i(function () {
        const { model: e } = Si(),
            ...
            r = s < ve.large.weight ? rt.x64x64 : rt.x96x96,
            n = s >= ve.large.weight ? lu : s >= ve.medium.weight ? ou : iu,
            i = { level: Cu, name: yu };
        if (!t) return;
        const { styleName: o, vehicleInfo: l, finalRewardType: c, isVehicleInHangar: d, tankmanNames: _ } = t;
        return (function () {
            switch (c) {
                case ls.Vehicle:
                    return a.jsx(E, {
                        classMix: vu,
                        text: Nu.readOrEmpty('battle_pass.chapterChoice.vehicle.reward.title'),
                    });
                case ls.VehicleStyle:
                    return a.jsxs('div', {
                        className: bu,
                        children: [
                            a.jsx(E, {
                                classMix: xu,
                                text: Nu.readOrEmpty('battle_pass.chapterChoice.vehicleStyle.reward.title'),
                                binding: { vehicleName: a.jsx(rs, { ...l, vehicleTypeIconSize: r, classNames: i }) },
                            }),
                            d && a.jsx(du, { iconSize: n, className: ju }),
                        ],
                    });
                case ls.Style:
                    return a.jsx(E, {
                        classMix: wu,
                        text: Nu.readOrEmpty('battle_pass.chapterChoice.stylePreview.reward.title'),
                        binding: { styleName: o },
                    });
                case ls.Tankman:
                    return a.jsx(E, { classMix: gu, text: nt(_, Nu.readOrEmpty('battle_pass.common.comma')) });
                case ls.PostProgression:
                    return a.jsx(E, {
                        classMix: fu,
                        text: Nu.readOrEmpty('battle_pass.chapterChoice.eliteCircuit.reward.title'),
                    });
                default:
                    return '';
            }
    ...
    ku = 'FinalReward_96b2b9a7',
    Iu = 'FinalReward_rewardInfo_e61fb0c8',
    Pu = 'FinalReward_preview_68854b55',
    Ru = i(function () {
        const { model: t, controls: s } = Si(),
            r = I({ previewButton: J_ }, { medium: { previewButton: eu }, large: { previewButton: au } }),
            n = t.computes.selectedChapter();
        Ja(void 0 !== n);
        const i = e.useCallback(
                (e) => {
                    (s.openPreview(n.chapterID), e.stopPropagation());
                },
                [s, n.chapterID],
            ),
            o =
                n.finalRewardType === ls.Style ||
                n.finalRewardType === ls.Vehicle ||
                n.finalRewardType === ls.VehicleStyle;
        return a.jsxs('div', {
            className: ku,
            children: [
                o &&
                ...
                a.jsxs('div', { className: Iu, children: [a.jsx(Su, {}), a.jsx(hu, {})] }),
            ],
        });
    }),
    Bu = {
    ...
    Au = k.resolve('strings'),
    Eu = i(function () {
        const { model: e } = Si(),
            s = e.computes.selectedChapter(),
            r = I(
                { iconSize: _n, shieldSize: an, containerSize: Zr },
                {
                    medium: { iconSize: un, shieldSize: tn, containerSize: Kr },
                    large: { iconSize: mn, shieldSize: sn, containerSize: Yr },
                    extraLarge: { iconSize: pn, shieldSize: rn, containerSize: Qr },
                },
            ),
            i = j(
                wi.length,
            ...
            children: [
                ...
                a.jsxs('div', {
                    ...
                    children: [
                        a.jsx(n.div, {
                            style: o.deadline,
                            children: a.jsx('div', { className: Bu.deadline, children: a.jsx(Y_, {}) }),
                        }),
                        a.jsx(n.div, {
                            style: o.chapterName,
                            children: a.jsx(_a, {
                                className: t(Bu.chapterName, c && Bu.chapterName__bougth),
                                text: Au.readOrEmpty(`battle_pass.chapter.fullName.c_${l}`),
                            }),
                        }),
                        a.jsx(n.div, {
                            style: o.finalReward,
                            children: a.jsx('div', {
                                className: t(Bu.finalReward, Bu[`finalReward__${d}`]),
                                children: a.jsx(Ru, {}),
                            }),
                        }),
                        a.jsx(n.div, {
                            ...
                            children: a.jsx('div', {
                                className: t(Bu.buttonsGroup, Bu[`buttonsGroup__${d}`]),
                                children: a.jsx(U_, {}),
                            }),
                        }),
                    ],
    ...
    Tu = 'FreeBpPoints_13635b90',
    Lu = 'FreeBpPoints_pointsBlock_de8d94dc',
    Du = 'FreeBpPoints_points_cd1a8292',
    Wu = 'FreeBpPoints_icon_e6968e4a',
    Ou = 'FreeBpPoints_text_74f25e3',
    Mu = k.resolve('strings'),
    Vu = i(function () {
        const { model: e } = Si(),
            { freePoints: t } = e.root.get(),
            s = Ra({
                header: Mu.readOrEmpty('battle_pass.chapterChoice.freePoints.tooltip.header'),
                body: Mu.readOrEmpty('battle_pass.chapterChoice.freePoints.tooltip.body'),
            }),
            r = I({ iconSize: '' }, { medium: { iconSize: '_medium' }, large: { iconSize: '_large' } });
        return a.jsxs('div', {
            className: Tu,
            ...s,
            children: [
                a.jsxs('div', {
                    className: Lu,
                    children: [
                        a.jsx('div', { className: Du, children: a.jsx(it, { value: t }) }),
                        a.jsx(Aa, { className: Wu, path: `battlePass.chapter_choice.freePoints${r.iconSize}` }),
                    ],
                }),
                a.jsx('div', { className: Ou, children: Mu.readOrEmpty('battle_pass.chapterChoice.freePoints.text') }),
            ],
        });
    }),
    zu = 'App_772aceb',
    Fu = 'App_background_f46709aa',
    Hu = 'App_main_879c8615',
    $u = 'App_idle_e06fed7f',
    Uu = 'App_shadow_d2a46054',
    Gu = 'App_freeBpPoints_c3ec6dd0',
    qu = 'App_chapterInfo_ae823c83',
    Xu = 'App_cards_a8851e46',
    Zu = i(function () {
        const { model: t, controls: s } = Si(),
            { onViewLoaded: i } = s,
        ...
        const [h, b] = j(t.computes.backgrounds().length, (e) => ({
                x: 0,
                opacity: e === c ? 1 : 0,
                config: { duration: 400, easing: Be.easeOutQuint },
            })),
        ...
        const [v] = r(() => Ci(200, 60)),
            ...
            [w] = r(() =>
                ((e = 0) => ({
                    ...
                    config: { duration: 500, easing: Be.easeInOutCubic },
                    delay: e,
                }))(),
            );
        return a.jsx(a.Fragment, {
                    ...
                    children: [
                        a.jsx(n.div, {
                            ...
                            children: a.jsxs(a.Fragment, {
                                children: [
                                    h.map((e, t) =>
                                        a.jsx(Ai, { style: e, i: t, index: d, classNames: { idle: $u, main: Hu } }, t),
                                    ),
                                    a.jsx('div', { className: Uu }),
                                ],
                            }),
                        }),
                        t.root.get().freePoints > 0 &&
                            a.jsx(n.div, { className: Gu, style: x, children: a.jsx(Vu, {}) }),
                        a.jsx('div', { className: qu, children: a.jsx(Eu, {}) }, null == o ? void 0 : o.chapterID),
                        a.jsx(n.div, { className: Xu, style: v, children: a.jsx(ot, { children: a.jsx(z_, {}) }) }),
                    ],
                }),
        });
    }),
    Ku = () =>
        a.jsx(Ni, { options: { rootId: R.aliases.battle_pass.ChapterChoice('resId') }, children: a.jsx(Zu, {}) }),
    Yu = (e, a, t, s, r) => {
...
var Qu = ((e) => (
    ...
    Ju = ((e) => ((e.Small = 'small'), (e.Big = 'big'), e))(Ju || {}),
    em = ((e) => ((e.None = ''), (e.Small = 's'), (e.Medium = 'm'), e))(em || {}),
    am = ((e) => ((e.Border = 'border'), (e.Background = 'bg'), (e.Icon = 'icon'), (e.None = ''), e))(am || {}),
    tm = ((e) => ((e.Hover = 'Hover'), (e.Disabled = 'Disabled'), (e.Triggered = 'Triggered'), (e.None = ''), e))(
        tm || {},
    );
const sm = {
    ...
    rm = ({ size: e, isHover: s, disabled: r = !1, type: n = Qu.Coin }) => {
        const { breakpoint: i } = ge(),
            o = i.weight >= ve.medium.weight ? em.Medium : em.Small;
        return a.jsx('div', {
            className: t(sm.base, sm[`base__${e}`], sm[`base__${e}${n}`], s && sm.base__hovered),
            children: r
                ? a.jsx('div', {
                      className: sm.bgDisabled,
                      style: { backgroundImage: Yu(n, am.Background, tm.Disabled, e, o) },
                  })
                : a.jsxs(a.Fragment, {
                      children: [
                          a.jsx('div', {
                              className: sm.bg,
                              style: { backgroundImage: Yu(n, am.Background, tm.None, e, o) },
                          }),
                          a.jsx('div', {
                              className: sm.bgHover,
                              style: { backgroundImage: Yu(n, am.Background, tm.Hover, e, o) },
                          }),
                      ],
                  }),
        });
    ...
    im = ({ size: e, isHover: s, highlighted: r = !1, disabled: n = !1, type: i = Qu.Coin }) => {
        const { breakpoint: o } = ge(),
            l = o.weight >= ve.medium.weight ? em.Medium : em.Small;
        return a.jsx('div', {
            className: t(nm.base, nm[`base__${e}`], s && nm.base__hovered),
            children: n
                ? a.jsx('div', {
                      className: t(nm.borderDisabled, nm[`borderDisabled__${e}`]),
                      style: { backgroundImage: Yu(i, am.Border, tm.Disabled, e, l) },
                  })
                : a.jsxs(a.Fragment, {
                      children: [
                          a.jsx('div', {
                              className: nm.border,
                              style: { backgroundImage: Yu(r ? Qu.Collection : i, am.Border, tm.None, e, l) },
                          }),
                          a.jsx('div', {
                              className: nm.borderHover,
                              style: { backgroundImage: Yu(i, am.Border, tm.Hover, e, l) },
                          }),
                      ],
                  }),
        });
    ...
    lm = ({ state: e, count: s, size: r, maxCount: n = 0 }) => {
        switch (e) {
            case dm.InProgress:
                return a.jsx(E, { text: `${s || 0} / ${n}` });
            case dm.Completed:
                return a.jsx('div', { className: t(om.base, om[`base__${r}`]) });
            default:
                return a.jsx(it, { format: 'integral', value: s });
        }
    },
    cm = {
        base: 'Count_1153e9f8',
...
var dm = ((e) => ((e.Default = ''), (e.InProgress = 'InProgress'), (e.Completed = 'Completed'), e))(dm || {});
const _m = ({ size: e, count: s, maxCount: r, state: n = '', isLocked: i = !1, disabled: o = !1 }) =>
        a.jsx('div', {
            className: t(cm.base, cm[`base__${e}`], i && cm.base__locked, o && cm.base__disabled),
            children: a.jsx(lm, { state: n, size: e, count: s, maxCount: r }),
        }),
    um = {
        base: 'Icon_891882bd',
    ...
    pm = ({ size: e, isHover: s, isDark: r = !0, disabled: n = !1, type: i }) => {
        const { breakpoint: o } = ge(),
            l = o.weight >= ve.medium.weight ? em.Medium : em.Small;
        return a.jsx('div', {
            className: t(um.base, um[`base__${e}`], um[`base__${mm(s, r, n)}`]),
            style: { backgroundImage: Yu(i, am.Icon, tm.None, e, i === Qu.Collection ? em.None : l) },
        });
    },
    hm = {
        base: 'Label_e1274655',
    ...
    fm = ({ size: e, title: s, isHover: r, disabled: n = !1, isGold: i = !1 }) =>
        a.jsx('div', {
            className: t(hm.base, hm[`base__${e}`], hm[`base__${bm(n, r)}`], i && hm.base__gold),
            children: s,
        }),
    gm = {
    ...
    xm = ({ count: s, disabled: r = !1, onClick: n, size: i }) => {
        const [o, l] = e.useState(!1),
            c = 1 === s ? vm.title.awardSingle() : vm.title.awardMultiple(),
            d = r ? vm.description.awardDisabled() : vm.description.award(),
            _ = e.useCallback(() => {
                r || (Pe.click(), n());
            }, [r, n]);
        return a.jsx(da, {
            ...
            isEnabled: Boolean(d),
            children: a.jsxs('div', {
                className: t(gm.base, gm[`base__${i}`], r ? gm.base__disabled : gm.base__hasAppearAnimation),
                onMouseEnter: () => {
                    (Pe.sound(R.sounds.bp_highlight_02()), l(!0));
                },
                onMouseLeave: () => {
                    l(!1);
                },
                onClick: _,
                children: [
                    a.jsx(im, { size: i, isHover: o, type: Qu.Award, disabled: r }),
                    a.jsx(rm, { size: i, isHover: o, type: Qu.Award, disabled: r }),
                    a.jsx(pm, { size: i, isHover: o, type: Qu.Award, disabled: r, isDark: !1 }),
                    a.jsx(_m, { size: i, count: s, disabled: r }),
                    a.jsx(fm, { size: i, isHover: o, title: c, disabled: r, isGold: !0 }),
                    !r &&
                        a.jsxs(a.Fragment, {
                            children: [
                                a.jsx('div', { className: t(gm.shine, gm.shine__left) }),
                                a.jsx('div', { className: t(gm.shine, gm.shine__right) }),
                                a.jsx('div', { className: gm.arrow }),
                                a.jsx('div', {
                                    className: gm.blinkShape,
                                    children: a.jsx('div', { className: gm.blink }),
                                }),
                            ],
                        }),
                ],
    ...
    ym = ({ count: s, onClick: r, size: n }) => {
        const [i, o] = e.useState(!1);
        return a.jsx(da, {
            body: Cm.description.coin(),
            isEnabled: Boolean(Cm.description.coin()),
            children: a.jsxs('div', {
                className: t(wm.base, wm[`base__${n}`]),
                onMouseEnter: () => {
                    (Pe.sound(R.sounds.bp_highlight_02()), o(!0));
                },
                onMouseLeave: () => {
                    o(!1);
                },
                ...
                children: [
                    a.jsx(im, { size: n, isHover: i }),
                    a.jsx(rm, { size: n, isHover: i }),
                    a.jsx(pm, { size: n, isHover: i, type: Qu.Coin }),
                    a.jsx(_m, { size: n, count: s }),
                    a.jsx(fm, { size: n, isHover: i, title: Cm.title.coin() }),
                ],
            }),
        });
    },
    ...
    Sm = ({ count: s, maxCount: r, newItemsCount: n, hasTrigger: i, size: o, onClick: l }) => {
        const [c, d] = e.useState(!1),
            _ = r === s,
            u = o === Ju.Small && i,
            m = _ ? Nm.description.collectionCompleted() : Nm.description.collection(),
            p = $(() => {
                (Pe.click(), l());
            });
        return a.jsx(da, {
            ...
            isEnabled: Boolean(m),
            children: a.jsxs('div', {
                className: t(jm.base, jm[`base__${o}`]),
                onMouseEnter: () => {
                    (Pe.sound(R.sounds.bp_highlight_02()), d(!0));
                },
                onMouseLeave: () => {
                    d(!1);
                },
                onClick: p,
                children: [
                    a.jsx(im, { size: o, isHover: c, type: Qu.Coin, highlighted: u }),
                    a.jsx(rm, { size: o, isHover: c }),
                    a.jsx(pm, { size: o, isHover: c, type: Qu.Collection }),
                    a.jsx(_m, { size: o, count: s, maxCount: r, state: _ ? dm.Completed : dm.InProgress }),
                    a.jsx(fm, { size: o, isHover: c, title: Nm.title.collection() }),
                    n > 0 && a.jsx('div', { className: jm.bubble, children: a.jsx(lt, { size: 'small' }) }),
                ],
            }),
        });
    },
    ...
    Pm = ({ onClick: s, size: r, tankmenScreenID: n }) => {
        const [i, o] = e.useState(!1),
            l = Im.description.commander(),
            c =
        ...
        return a.jsx(da, {
            ...
            isEnabled: Boolean(l),
            children: a.jsxs('div', {
                className: t(km.base, km[`base__${r}`], i && km.base__hover),
                onMouseEnter: () => {
                    (Pe.sound(R.sounds.bp_highlight_02()), o(!0));
                },
                onMouseLeave: () => o(!1),
                ...
                children: [
                    a.jsx(im, { size: r, isHover: i }),
                    a.jsx(rm, { size: r, isHover: i }),
                    a.jsx(fm, { size: r, isHover: i, title: Im.title.commander() }),
                    a.jsx('div', { className: km.icon, style: { backgroundImage: `url(${c})` } }),
                ],
            }),
        });
    },
    ...
    Am = ({ count: s, onClick: r, size: n }) => {
        const [i, o] = e.useState(!1);
        return a.jsx(da, {
            body: Bm.description.taler(),
            children: a.jsxs('div', {
                className: t(Rm.base, Rm[`base__${n}`], i && Rm.base__hover),
                onMouseEnter: () => {
                    (Pe.sound(R.sounds.bp_highlight_02()), o(!0));
                },
                onMouseLeave: () => {
                ...
                children: [
                    a.jsx(im, { size: n, isHover: i }),
                    a.jsx(rm, { size: n, isHover: i }),
                    a.jsx(pm, { size: n, isHover: i, type: Qu.Taler }),
                    a.jsx(_m, { size: n, count: s }),
                    a.jsx(fm, { size: n, isHover: i, title: Bm.title.taler() }),
                ],
            }),
        });
    },
    ...
    Lm = ({ count: s, onClick: r, size: n }) => {
        const [i, o] = e.useState(!1),
            l = Boolean(s),
            c = l ? Qu.Ticket : void 0;
        return a.jsx(da, {
            body: Tm.description.ticket(),
            isEnabled: Boolean(Tm.description.ticket()),
            children: a.jsxs('div', {
                className: t(Em.base, Em[`base__${n}`], l && Em.base__hasAppearAnimation),
                onMouseEnter: () => {
                    (Pe.sound(R.sounds.bp_highlight_02()), o(!0));
                },
                onMouseLeave: () => {
                ...
                children: [
                    a.jsx(im, { size: n, isHover: i, type: c }),
                    a.jsx(rm, { size: n, isHover: i, type: c }),
                    a.jsx(pm, { size: n, isHover: i, type: Qu.Ticket, isDark: !l }),
                    a.jsx(_m, { size: n, count: s }),
                    a.jsx(fm, { size: n, isHover: i, title: Tm.title.ticket(), isGold: l }),
                    l &&
                        a.jsxs(a.Fragment, {
                            children: [
                                a.jsx('div', { className: t(Em.shine, Em.shine__left) }),
                                a.jsx('div', { className: t(Em.shine, Em.shine__right) }),
                                a.jsx('div', { className: Em.arrow }),
                                a.jsx('div', {
                                    className: Em.blinkShape,
                                    children: a.jsx('div', { className: Em.blink }),
                                }),
                            ],
                        }),
                ],
    ...
    Vm = i(({ size: e, classNames: s }) => {
        const { model: r } = Wm();
        return a.jsx('div', {
            className: t(Om.base, Om[`base__${e}`], null == s ? void 0 : s.base),
            children: O(
                ...
                (e) =>
                    ...
                    a.jsx(
                        'div',
                        { className: t(Om.award, null == s ? void 0 : s.award), children: Mm(e.type, e.props) },
                        e.type,
                    ),
            ),
        });
    }),
    zm = ({ rootId: e, size: t = Ju.Small, context: s = 'model', classNames: r }) =>
        a.jsx(Dm, { options: { context: s, rootId: e }, children: a.jsx(Vm, { size: t, classNames: r }) }),
    [Fm, Hm] = D()(
        ({ observableModel: e }) => {
    ...
    $m = 'selectableRewardsState',
    Um = 'finalState',
    Gm = 'FinalStateLabel_icon_2cf5ceb5',
    qm = 'FinalStateLabel_greenLight_7967eb2f',
    Xm = 'FinalStateLabel_text_f6f99450',
    Zm = () =>
        a.jsxs(a.Fragment, {
            children: [
                a.jsx('div', { className: Gm }),
                a.jsx('div', { className: qm }),
                a.jsx('div', { className: Xm, children: R.strings.battle_pass.holidayFinalScreen.finalState.label() }),
            ],
        }),
    Km = {
        base: 'Final_fe33f216',
    ...
    Ym = R.strings.battle_pass.holidayFinalScreen,
    Qm = i(() => {
        const { model: e, controls: s } = Hm(),
            { takeRewards: r, showHangar: n } = s,
            { state: i, finalRewardType: o } = e.root.get(),
            l = i === $m;
        return a.jsx('div', {
            className: t(Km.base, Km[`base__${i}`]),
            children: a.jsxs('div', {
                className: Km.controls,
                children: [
                    a.jsx('div', {
                        className: Km.label,
                        children: l
                            ? a.jsx('div', { className: Km.text, children: Ym.selectableRewardsState.label() })
                            : a.jsx(Zm, {}),
                    }),
                    a.jsx('div', {
                        className: Km.buttonWrapper,
                        children: a.jsx(ct, {
                            size: dt.medium,
                            mixClass: Km.button,
                            onClick: () => {
                            ...
                            children: (() => {
                                switch (i) {
                                    case $m:
                                        return Ym.selectableRewardsState.button();
                                    case Um:
                                        return o === ls.Vehicle
                                            ? Ym.finalState.button.showVehicle()
                                            : Ym.finalState.button.showHangar();
                                    default:
                                        return '';
                                }
                            })(),
    ...
    Jm = 'Divider_3683d6e2',
    ep = 'Divider_divider__right_24d5147b',
    ap = ({ isRight: e = !1 }) => a.jsx('div', { className: t(Jm, e && ep) }),
    tp = 'Title_ec301c01',
    sp = 'Title_text_65e6762b',
    rp = ({ text: e }) =>
        a.jsxs('div', {
            className: tp,
            children: [a.jsx(ap, {}), a.jsx('div', { className: sp, children: e }), a.jsx(ap, { isRight: !0 })],
        }),
    np = {
    ...
    ip = R.strings.battle_pass.holidayFinalScreen.buyState,
    op = (e) => ({
        from: { opacity: 0 },
        to: { opacity: 1 },
        delay: 400 + 100 * e,
    ...
    lp = i(() => {
        const { model: e, controls: t } = Hm(),
            ...
            u = _ <= ve.small.weight ? xe.Small : xe.Big,
            m = c.length > 9 ? [..._t(c, 0, 9)] : c,
            p = r(op(m.length)),
            h = c.length - m.length;
        return a.jsxs('div', {
            className: np.base,
            children: [
                d && a.jsx('div', { className: np.preview, children: a.jsx(ut, { type: 'preview', onClick: o }) }),
                a.jsxs('div', {
                    className: np.content,
                    children: [
                        a.jsx('div', { className: np.shadow }),
                        a.jsx('div', { className: np.title, children: a.jsx(rp, { text: ip.title() }) }),
                        a.jsx('div', { className: np.description, children: ip.description() }),
                        a.jsx('div', {
                            className: np.visibleRewards,
                            children: O(m, (e, t) =>
                                a.jsx(
                                    Qn,
                                    {
                                        animationConfig: op(t),
                                        children: a.jsx(we, { ...Xt(e, u), className: np.reward }),
                                    },
                                    `${e.item}_${t}`,
                                ),
                            ),
                        ...
                        h > 0 &&
                            a.jsx(n.div, {
                                ...
                                children: a.jsx(ct, {
                                    type: mt.ghost,
                                    size: dt.medium,
                                    mixClass: np.rewardButton,
                                    onClick: () => {
                                        l.push(ts.battlePass.buyPassRewards, { chapterID: s });
                                    },
                                    children: a.jsx(E, { text: ip.moreRewards(), binding: { count: h } }),
                                }),
                            }),
                    ],
                }),
    ...
    cp = 'Rewards_full_eea97d7',
    dp = { context: 'model.rewards' },
    _p = i(() => a.jsx(cr, { options: dp, children: a.jsx('div', { className: cp, children: a.jsx(Gr, {}) }) })),
    up = 'Tankmen_9641cad5',
    mp = 'Tankmen_image_208678b',
    pp = 'Tankmen_title_ebf30d50',
    hp = 'Tankmen_description_e7d7080c',
    bp = 'Tankmen_tankmenBtn_96878805',
    fp = 'Tankmen_button_e7e9840c',
    gp = 'Tankmen_blink_22bb5961',
    vp = R.strings.battle_pass.holidayFinalScreen.tankmenState,
    xp = i(() => {
        const { controls: e } = Hm(),
            { showTankmen: t } = e;
        return a.jsxs('div', {
            ...
            children: [
                ...
                a.jsx('div', { className: pp, children: a.jsx(rp, { text: vp.title() }) }),
                a.jsx('div', { className: hp, children: vp.description() }),
                a.jsx('div', {
                    className: bp,
                    children: a.jsxs(ct, {
                        type: mt.main,
                        ...
                        mixClass: fp,
                        onClick: t,
                        children: [a.jsx('div', { className: gp }), vp.tankmenButton()],
                    }),
                }),
            ],
        });
    ...
    Cp = 'Footer_5f98e398',
    yp = 'Footer_light_2fc739c7',
    jp = 'Footer_buttonWrapper_fbd12995',
    Np = 'Footer_button_9e4f9bc',
    Sp = 'Footer_blink_106ec98e',
    kp = R.strings.battle_pass.holidayFinalScreen.buyState,
    Ip = i(() => {
        const { model: e } = Hm(),
            ...
            children: [
                ...
                a.jsx('div', {
                    ...
                    children: a.jsxs(ct, {
                        ...
                        mixClass: Np,
                        onClick: () => {
                            r.push(ts.battlePass.buyPass, { chapterID: s });
                        },
                        children: [t && a.jsx('div', { className: Sp }), kp.buyButton()],
                    }),
                }),
            ],
        });
    ...
    Pp = 'Header_add5cf9d',
    Rp = 'Header_title_1435c6ee',
    Bp = 'Header_description_e959461d',
    Ap = ({ title: e, description: t }) =>
        a.jsxs('div', {
            className: Pp,
            children: [a.jsx('div', { className: Rp, children: e }), a.jsx('div', { className: Bp, children: t })],
        }),
    Ep = {
        base: 'App_ef84fef',
    ...
    Lp = i(() => {
        ...
        return (
            ...
            be(L.ESCAPE, () => l.goBack()),
            a.jsxs('div', {
                className: t(Ep.base, Ep[`base__${i}`]),
                children: [
                    a.jsx('div', { className: Ep.background }),
                    s &&
                        a.jsxs('div', {
                            className: Ep.additionalAnimation,
                            children: [
                                a.jsxs('div', {
                                    className: Ep.header,
                                    children: [
                                        a.jsx(Ap, {
                                            title: a.jsx(E, {
                                                text: Tp.holidayFinalScreen.chapter(),
                                                binding: { chapterName: Tp.chapter.fullNameUppercased.$num(o) },
                                            }),
                                            description: Tp.holidayFinalScreen.completed(),
                                        }),
                                        a.jsx('div', {
                                            className: Ep.awards,
                                            children: a.jsx(zm, {
                                ...
                                a.jsx(wp, {}),
                                a.jsx('div', { className: Ep.footer, children: a.jsx(Ip, {}) }),
                            ],
                        }),
                ],
            })
    ...
    Dp = () => a.jsx(Fm, { options: { rootId: R.aliases.battle_pass.HolidayFinal('resId') }, children: a.jsx(Lp, {}) }),
    Wp = 1e3,
    Op = {
        ...ht,
        withStack: !0,
    ...
    Mp = {
        ...bt,
        line: { ...bt.line, bgColorFinished: '#000000' },
        pattern: { ...bt.pattern, bgImageFinished: bt.bgImageBase },
    };
var Vp = ((e) => (
...
const zp = {
    fillProgressMax: { nextStep: 'runCycle', delay: Wp },
    runCycle: { nextStep: 'resetProgress', delay: 2200 },
    resetProgress: { nextStep: 'refillProgress', delay: Wp },
    refillProgress: { nextStep: 'idle', delay: Wp },
};
var Fp = ((e) => ((e.COMPLETED = 'completed'), (e.IN_PROGRESS = 'inProgress'), (e.NOT_STARTED = 'notStarted'), e))(
        Fp || {},
    ),
    Hp = ((e) => (
    ...
    $p = ((e) => ((e.left = 'left'), (e.right = 'right'), e))($p || {}),
    Up = ((e) => (
        (e[(e.Active = 0)] = 'Active'),
        (e[(e.Paused = 1)] = 'Paused'),
...
const qp = {
    ...
    Xp = (e, a = !1) =>
        a ? (e < ve.medium.weight ? 224 : 340) : e < ve.medium.weight ? 140 : e < ve.extraLarge.weight ? 220 : 276,
    [Zp, Kp] = D()(
        ({ observableModel: e }) => {
            const a = {
                    root: e.object(),
                ...
                n = s((e) => {
                    ...
                    if ([Vp.FillProgressMax, Vp.RunCycle].includes(o)) return e === n ? Fp.IN_PROGRESS : Fp.COMPLETED;
                ...
                i = s((e) => {
                    const { postProgressionStatus: t } = a.root.get(),
                        s = n(e);
                    return { cardStatus: s, isDisabled: t !== Gp.Unlocked && s === Fp.NOT_STARTED };
                }),
                l = s(
                    () =>
                        _()
                ...
                c = s(() => Se(a.chapters.get(), (e) => e.isRegular), { equals: W }),
                d = s(() => Se(a.chapters.get(), (e) => e.isRegular && e.chapterStatus === Up.Completed).length, {
                    equals: W,
                }),
                _ = s(() => d() === c().length),
                u = s(() => Ae(a.chapters.get(), (e) => !e.isBattlePassPurchased)),
                m = s(() => Se(a.chapters.get(), (e) => !e.isRegular)),
                p = s(() => Ae(m(), (e) => e.chapterStatus !== Up.Active)),
                h = s(() => Ae(m(), (e) => e.chapterStatus !== Up.Completed)),
                b = s(() => {
                    const { currentLevel: e, currentLevelPoints: t } = a.root.get(),
                        s = e - 1;
                    return De(a.levels.get(), (e, { levelPoints: a }, r) => (r < s ? e + a : r === s ? e + t : e), 0);
                }),
                f = s(() => De(a.levels.get(), (e, { levelPoints: a }) => e + a, 0)),
                g = s(() => {
                    const {
                        currentLevel: e,
                ...
                x = s((e) => {
                    const {
                        ...
                        g = !u && n < s;
                    return {
                        progressValue: [Vp.FillProgressMax, Vp.RunCycle].includes(l) ? b : f(s, r, c),
                        previousProgressValue: l === Vp.ResetProgress ? 0 : f(n, i, _, g),
                        maxProgressValue: b,
                    };
                }),
                w = s(() => {
                    const e = Se(
                        m(),
                        (e) =>
                            (e.chapterStatus === Up.Active || e.chapterStatus === Up.Completed) &&
                            !e.isBattlePassPurchased,
                    );
                    return e.length > 0 ? e : Se(a.chapters.get(), (e) => !e.isBattlePassPurchased);
                });
            return {
                ...a,
                computes: {
    ...
    Yp = 'Highlight_ec6e9d0b',
    Qp = 'Highlight_inner_fc05a4f9',
    Jp = 'Highlight_side_ffdc7ad0',
    eh = 'Highlight_side__left_48f019cc',
    ah = 'Highlight_side__right_7a86ef2a',
    th = e.memo(() =>
        a.jsxs('div', {
            className: Yp,
            children: [
                a.jsx('div', { className: t(Jp, eh) }),
                a.jsx('div', { className: Qp }),
                a.jsx('div', { className: t(Jp, ah) }),
            ],
        }),
    ),
    sh = 'Background_3985f66b',
    rh = 'Background_default_7c7472e5',
    nh = 'Background_base__first_26effab7',
    ih = 'Background_base__last_26effab7',
    oh = 'Background_disabled_aebb7525',
    lh = i(({ level: e }) => {
        const { model: s } = Kp(),
            { isFirstLevel: r, isLastLevel: n } = s.computes.levelInfo(e),
            { cardStatus: i, isDisabled: o } = s.computes.cardStates(e);
        return a.jsxs('div', {
            className: t(sh, r && nh, n && ih),
            children: [
                a.jsx('div', { className: rh }),
                o && a.jsx('div', { className: oh }),
                i === Fp.IN_PROGRESS && a.jsx(th, {}),
            ],
        });
    }),
    ch = {
    ...
    dh = s((e) => {
        ...
        return {
            name: a || t,
            smallImage: xt(e, xe.Big),
            bigImage: xt(e, xe.S180x135),
            special: r,
            value: s,
            valueType: vt(t),
            tooltipArgs: gt({ tooltipId: n }, Number(i), { ignoreShowDelay: !0 }),
        };
    }),
    _h = i(({ level: e, className: s }) => {
        const { model: r } = Kp(),
            ...
            l = o < ve.medium.weight,
            c = 1 === n.length,
            d = ((e, a) => (a ? (e ? xe.Big : xe.S180x135) : e ? xe.Small : xe.Big))(l, c),
            _ = (e) => (l || !c ? e.smallImage : e.bigImage);
        return a.jsx('div', {
            className: t(ch.base, ch[`base__${i}`], s),
            children: a.jsx('div', {
                className: t(ch.rewards, ch[`rewards__${n.length}`]),
                children: O(n, (e, s) => {
                    const r = dh(e);
                    return a.jsx(
                        'div',
                        { className: t(ch.reward), children: a.jsx(we, { size: d, image: _(r), ...r }) },
                        `reward__${r.name}${s}`,
                    );
                }),
            }),
    ...
    mh = ({ position: e }) =>
        a.jsx('div', { className: t(uh.base, uh[`base__${e}`]), children: a.jsx('div', { className: uh.inner }) }),
    ph = {
        base: 'Stage_2019a8bb',
    ...
    hh = i(({ level: s, className: i }) => {
        const { model: o } = Kp(),
            ...
            { stageOpacity: p } = r({
                ...
                to: { stageOpacity: 0 },
                delay: 0,
                onStart: () => Pe.sound(R.sounds.bp_current_phase()),
                config: { duration: 750, easing: Yt },
            }),
            { sparkOpacity: h } = r({
        ...
        return (
            ...
            a.jsx('div', {
                className: t(ph.base, ph[`base__${c}`], i),
                children: u
                    ? a.jsxs(a.Fragment, {
                          children: [
                              m &&
                                  a.jsxs(a.Fragment, {
                                      children: [
                                          a.jsx('div', { className: ph.glow }),
                                          a.jsx(n.div, { style: { opacity: h }, className: ph.animatedGlow }),
                                      ],
                                  }),
                              a.jsxs('div', {
                                  className: ph.numberInProgress,
                                  children: [
                                      s,
                                      a.jsx(n.div, {
                                          style: {
                    ...
                    : a.jsx('div', { className: ph.number, children: s }),
            })
        );
    }),
    bh = {
    ...
    fh = ({ shouldAppear: e }) =>
        a.jsxs('div', {
            className: t(bh.base, e ? bh.base__showAnimation : bh.base__hideAnimation),
            children: [
                a.jsx('div', { className: bh.iconGlow }),
                a.jsx(da, {
                    body: R.strings.battle_pass.tooltips.completed.got(),
                    children: a.jsx('div', { className: bh.icon }),
                }),
            ],
        }),
    gh = {
    ...
    vh = i(({ totalLevelPoints: e, shouldAppear: s, shouldDisappear: r, className: n }) => {
        const { model: i } = Kp(),
        ...
        return a.jsx(wt, {
            ...
            children: a.jsxs('div', {
                className: t(gh.base, s && gh.base__appear, r && gh.base__disappear, n),
                children: [
                    a.jsx('div', { className: t(gh.value, gh.value__current), children: r ? l : o }),
                    a.jsx('div', { className: gh.divider, children: '/' }),
                    a.jsx('div', { className: t(gh.value, gh.value__total), children: e }),
                    a.jsx('div', { className: gh.icon }),
                ],
            }),
        });
    }),
    xh = 'Status_41b476d1',
    wh = 'Status_pointsWrapper_6042cf48',
    Ch = i(({ level: s, className: r }) => {
        const { model: n } = Kp(),
        ...
        return (
            e.useEffect(() => {
                if (c === Vp.RunCycle) return void h(!1);
            ...
            a.jsxs('div', {
                className: t(xh, r),
                children: [
                    u && p && a.jsx(fh, { shouldAppear: p }),
                    m && a.jsx(vh, { className: wh, totalLevelPoints: l, shouldAppear: _, shouldDisappear: d }),
                ],
            })
        );
    }),
    ...
    jh = i(({ level: e }) => {
        const { model: s } = Kp(),
            ...
            l = !n && o === Fp.IN_PROGRESS,
            c = !i && s.computes.cardStates(e + 1).cardStatus !== Fp.IN_PROGRESS;
        return a.jsxs('div', {
            className: t(yh.base, yh[`base__${o}`]),
            style: qp,
            children: [
                a.jsx(lh, { level: e }),
                a.jsx(hh, { className: yh.stage, level: e }),
                a.jsx(_h, { className: yh.rewards, level: e }),
                a.jsx(Ch, { className: yh.status, level: e }),
                a.jsx('div', { className: yh.points, children: e * r }),
                n && a.jsx('div', { className: t(yh.points, yh.points__initial), children: 0 }),
                l && a.jsx(mh, { position: $p.left }),
                c && a.jsx(mh, { position: $p.right }),
            ],
        });
    }),
    Nh = 'Cards_afe60a85',
    Sh = i(() => {
        ...
        return a.jsx('div', {
            className: Nh,
            children: O(t, ({ level: e }, t) => a.jsx(jh, { level: e }, `${s}_${t}`)),
        });
    }),
    kh = 'ExtraChapter_51af81b2',
    Ih = 'ExtraChapter_wrapper_1111764a',
    Ph = 'ExtraChapter_border_1fc38ae',
    Rh = 'ExtraChapter_base__hover_d6a2f84c',
    Bh = 'ExtraChapter_bg_6bfbbfc5',
    Ah = 'ExtraChapter_widget_ba8b2337',
    Eh = 'ExtraChapter_title_4965d60',
    Th = 'ExtraChapter_description_1a9020c',
    Lh = 'ExtraChapter_content_7e770f3c',
    Dh = R.strings.battle_pass.postProgressionView.footer.extraChapter,
    Wh = i(() => {
        var s;
        const { model: r } = Kp(),
        ...
        return n
            ? a.jsxs('div', {
                  className: t(kh, i && Rh),
                  onMouseOver: (e) => {
                      (e.stopPropagation(), o(!0), Pe.sound(R.sounds.highlight()));
                  },
                  onMouseOut: () => {
                      o(!1);
                  },
                  onClick: () => {
                      (l.push(ts.battlePass.progression, { chapterID: n }), Pe.sound(R.sounds.play()));
                  },
                  children: [
                      a.jsxs('div', {
                          className: Ih,
                          children: [
                              a.jsx('div', { className: Bh }),
                              a.jsxs('div', {
                                  className: Lh,
                                  children: [
                                      a.jsx('div', { className: Eh, children: Dh.title.text() }),
                                      a.jsx('div', { className: Th, children: Dh.description.text() }),
                                  ],
                              }),
                          ],
                      }),
                      a.jsx('div', { className: Ah }),
                      a.jsx('div', { className: Ph }),
                  ],
              })
            : null;
    }),
    Oh = 'NotAvailable_e1e3731d',
    Mh = 'NotAvailable_background_a3edbc06',
    Vh = 'NotAvailable_content_94110074',
    zh = 'NotAvailable_button_149fb125',
    Fh = 'NotAvailable_description_6cafdd55',
    Hh = 'NotAvailable_completedCount_8450f150',
    $h = R.strings.battle_pass.postProgressionView.footer,
    Uh = i(() => {
        const { model: e } = Kp(),
            t = pe(),
                ...
                a.jsxs('div', {
                    ...
                    children: [
                        a.jsx(E, {
                            ...
                            binding: {
                                completedChapters: a.jsx('span', { className: Hh, children: s }),
                                chaptersAmount: r,
                            },
                        }),
                        a.jsx(ct, {
                            ...
                            size: dt.medium,
                            mixClass: zh,
                            onClick: () => t.push(ts.battlePass.chapterChoice),
                            children: $h.button.text(),
                        }),
                    ],
                }),
            ],
    ...
    Gh = 'PurchasingIp_349aa5c4',
    qh = 'PurchasingIp_wrapper_2ff2079e',
    Xh = 'PurchasingIp_border_78bb5b9b',
    Zh = 'PurchasingIp_base__hover_e6cc332b',
    Kh = 'PurchasingIp_bg_345ee932',
    Yh = 'PurchasingIp_blink_990fb4a0',
    Qh = 'PurchasingIp_text_4355bb8a',
    Jh = 'PurchasingIp_button_b213818',
    eb = 'PurchasingIp_content_b09e9d85',
    ab = R.strings.battle_pass.postProgressionView.footer.purchaseIP,
    tb = i(() => {
        const { model: s } = Kp(),
            r = pe(),
            [n, i] = e.useState(!1);
        return a.jsxs('div', {
            className: t(Gh, n && Zh),
            onMouseOver: (e) => {
                (e.stopPropagation(), i(!0), Pe.sound(R.sounds.highlight()));
            },
            onMouseOut: () => {
                i(!1);
            },
            onClick: () => {
                ...
                (Pe.sound(R.sounds.play()),
                    r.push(ts.battlePass.buyPass, { chapterID: null == (e = a[0]) ? void 0 : e.chapterID }));
            },
            children: [
                a.jsxs('div', {
                    className: qh,
                    children: [
                        ...
                        a.jsxs('div', {
                            ...
                            children: [
                                ...
                                a.jsx(ct, { type: mt.main, size: dt.medium, mixClass: Jh, children: ab.button.text() }),
                            ],
                        }),
                    ],
                }),
                a.jsx('div', { className: Xh }),
            ],
        });
    }),
    sb = 'Footer_447447a9',
    rb = i(({ className: e = '' }) => {
        ...
        return a.jsx('div', {
            ...
            children: (() => {
                switch (r) {
                    case Hp.NotAvailable:
                        return a.jsx(Uh, {});
                    case Hp.PurchasingIP:
                        return a.jsx(tb, {});
                    case Hp.ExtraChapter:
                        return a.jsx(Wh, {});
                    default:
                        return null;
                }
    ...
    nb = 'Header_8161ac6c',
    ib = 'Header_background_ca26eac9',
    ob = 'Header_headlineContainer_83fb95ed',
    lb = 'Header_headline_49f93202',
    cb = 'Header_divider_d589871a',
    db = 'Header_title_87287815',
    _b = 'Header_descriptionContainer_5475d6de',
    ub = 'Header_descriptionPaused_65f475ba',
    mb = 'Header_description_1d21a2e3',
    pb = 'Header_icon_c2a24f90',
    hb = 'Header_label_f1c2cd27',
    bb = R.strings.battle_pass.postProgressionView.header,
    fb = i(({ className: e }) => {
        const { postProgressionStatus: s, endDate: r } = Kp().model.root.get(),
            n = s === Gp.Locked,
            i = s === Gp.Paused,
            o = tt(r, st.DayMonthFull);
        return a.jsxs('div', {
            className: t(nb, e),
            children: [
                a.jsx('div', { className: ib }),
                a.jsxs('div', {
                    className: ob,
                    children: [
                        !n &&
                            a.jsxs(a.Fragment, {
                                children: [
                                    a.jsx('span', { className: lb, children: bb.headline.unlocked() }),
                                    a.jsx('div', { className: cb }),
                                ],
                            }),
                        a.jsx(E, { classMix: lb, text: bb.headline.deadline(), binding: { endDate: o } }),
                    ],
                }),
                a.jsx('span', { className: db, children: bb.title() }),
                a.jsx('div', {
                    className: _b,
                    children: i
                        ? a.jsxs(a.Fragment, {
                              children: [
                                  a.jsx('div', { className: pb }),
                                  a.jsx('span', { className: hb, children: bb.description.onPause.highlight() }),
                                  a.jsx('span', { className: ub, children: bb.description.onPause.regular() }),
                              ],
                          })
                        : a.jsx('span', { className: mb, children: bb.description.active() }),
                }),
            ],
        });
    }),
    gb = 'Counter_530269bb',
    vb = 'Counter_infinityIconContainer_1ffbc2e2',
    xb = 'Counter_infinityIcon_d060ec47',
    wb = 'Counter_label_3f062fe0',
    Cb = 'Counter_cyclesCompleted_98e1bb2c',
    yb = 'Counter_cyclesNumber_623ae487',
    jb = 'Counter_cyclesNumber__animated_78a25366',
    Nb = 'Counter_cyclesNumber__hidden_4c746c1c',
    Sb = R.strings.battle_pass.postProgressionView.progression,
    kb = i(({ className: e, labelRef: s, shouldRun: r }) => {
        const { model: n } = Kp(),
            { cyclesCompletedCount: i, previousCyclesCompletedCount: o } = n.root.get(),
            l = n.animationStep.get(),
            c = i !== o && [Vp.Idle, Vp.FillProgressMax].includes(l);
        return a.jsxs('div', {
            className: t(gb, e),
            ref: s,
            children: [
                a.jsx('div', { className: vb, children: a.jsx('div', { className: xb }) }),
                a.jsx('div', {
                    className: wb,
                    children: i
                        ? a.jsxs('div', {
                              className: Cb,
                              children: [
                                  a.jsx('span', { children: Sb.cyclesCompleted() }),
                                  a.jsx(
                                      'span',
                                      { className: t(yb, r && jb, c && Nb), children: i },
                                      `cyclesCompletedCount-${r}`,
                                  ),
                              ],
                          })
                        : Sb.cyclicalProgression(),
                }),
            ],
        });
    }),
    ...
    Bb = i(({ className: s, shouldRun: r }) => {
        ...
        return (
            Ct(() => {
                var e, a;
                const t = (null == (e = o.current) ? void 0 : e.getBoundingClientRect()) ?? Rb,
            ...
            a.jsxs('div', {
                className: t(Ib.base, s),
                style: _,
                children: [
                    a.jsx('div', { className: Ib.arrow }),
                    a.jsxs('div', {
                        className: t(Ib.contour, Ib[`contour__${d}x`]),
                        ref: o,
                        children: [
                            a.jsx('div', { className: t(Ib.border, Ib.border__vertical) }),
                            a.jsx('div', { className: t(Ib.border, Ib.border__horizontal) }),
                            r &&
                                Array(5)
                                    .fill(void 0)
                                    .map((e, s) =>
                                        a.jsx('div', { className: t(Ib.bar, Ib[`bar__state${s + 1}`]) }, `bar-${s}`),
                                    ),
                        ],
                    }),
                    a.jsx(kb, { className: Ib.labelContainer, labelRef: l, shouldRun: r }),
                ],
            })
        );
    }),
    Ab = 'ProgressBar_7a10c6f0',
    Eb = 'ProgressBar_progressBackground_ce66ede4',
    Tb = 'ProgressBar_progressBar_61381794',
    Lb = 'ProgressBar_progressBar__disabled_f37621b4',
    Db = 'ProgressBar_optimizedProgressBar_87a4af2b',
    Wb = 'ProgressBar_cycle_7886c8',
    Ob = i(() => {
        const { model: s, controls: r } = Kp(),
                ...
                a.jsx(wt, {
                    ...
                    children: a.jsx('div', {
                        ...
                        children: a.jsx(jt, {
                            ...
                            maxValue: p,
                            disabled: d,
                            animationSettings: Op,
                            theme: Mp,
                            className: Db,
                        }),
                    }),
                }),
                a.jsx(Bb, { className: Wb, shouldRun: o }),
            ],
        });
    }),
    Mb = 'Toolbar_infoButtons_dd878d8c',
    Vb = R.strings.battle_pass.postProgressionView.toolbar,
    zb = i(({ className: e }) => {
        const { openInfoPage: t, openPointsInfo: s } = Kp().controls;
        return a.jsx('div', {
            className: e,
            children: a.jsxs('div', {
                className: Mb,
                children: [
                    a.jsx(Nt, { caption: Vb.aboutBattlePass(), type: 'info', onClick: t }),
                    a.jsx(Nt, { caption: Vb.howToEarnPoints(), type: 'info', onClick: s }),
                ],
            }),
        });
    }),
    Fb = 'App_ad9a5024',
    Hb = 'App_toolbar_d16ffb0a',
    $b = 'App_awardsWidget_1186a317',
    Ub = 'App_award_70e8698f',
    Gb = 'App_content_b9a70459',
    qb = 'App_header_77cc1fba',
    Xb = 'App_progression_992167b9',
    Zb = 'App_footer_e6643cae',
    Kb = R.images.gui.maps.icons.battlePass.backgrounds.progression,
    Yb = i(() => {
        const { model: t, controls: s } = Kp(),
        ...
        (e.useEffect(() => {
            if (n !== Vp.Idle) {
                const { nextStep: e, delay: a } = zp[n];
                return ae(() => {
                    s.setAnimationStep(e);
                }, a);
            }
            i && s.setAnimationStep(Vp.FillProgressMax);
        }, [n, s, i]),
            be(L.ESCAPE, () => o.goBack()));
        const l = `url(${Gt(Kb, r)})`;
        return a.jsxs('div', {
            className: Fb,
            style: { backgroundImage: l },
            children: [
                a.jsx(zb, { className: Hb }),
                a.jsx(zm, {
                    rootId: R.aliases.battle_pass.PostProgression('resId'),
                    context: 'model.awardsWidget',
                    classNames: { base: $b, award: Ub },
                }),
                a.jsxs('div', {
                    className: Gb,
                    children: [
                        a.jsx(fb, { className: qb }),
                        a.jsxs('div', { className: Xb, children: [a.jsx(Sh, {}), a.jsx(Ob, {})] }),
                    ],
                }),
                a.jsx(rb, { className: Zb }),
            ],
        });
    }),
    Qb = () =>
        a.jsx(Zp, { options: { rootId: R.aliases.battle_pass.PostProgression('resId') }, children: a.jsx(Yb, {}) });
var Jb = ((e) => (
        (e.Active = 'active'),
        (e.Paused = 'paused'),
        (e.Completed = 'completed'),
    ...
    af = ((e) => ((e.COMMON = 'common'), (e.EXTRA = 'extra'), (e.HOLIDAY = 'holiday'), e))(af || {}),
    tf = ((e) => ((e.left = 'left'), (e.right = 'right'), e))(tf || {}),
    sf = ((e) => ((e.COMPLETED = 'completed'), (e.IN_PROGRESS = 'inProgress'), (e.NOT_STARTED = 'notStarted'), e))(
        sf || {},
    ),
    rf = ((e) => (
    ...
    nf = ((e) => ((e.back = 'back'), (e.forward = 'forward'), e))(nf || {}),
    of = ((e) => ((e.Default = 'default'), (e.Gray = 'gray'), e))(of || {});
const lf = [Jb.Active, Jb.Completed],
    [cf, df] = D()(
        ({ observableModel: e }) => {
            const a = {
                    root: e.object(),
                ...
                t = s(() => O(a.freeFinalRewards.get(), M), { equals: W }),
                r = s(() => O(a.paidFinalRewards.get(), M), { equals: W }),
                n = s(() => O(a.starterPackRewards.get(), M), { equals: W }),
                i = s(() => a.root.get().chapterType === af.HOLIDAY),
                o = s(() => ({ freeFinalRewards: Qt(t()), ...(r().length && { paidFinalRewards: Qt(r()) }) })),
                l = s(() => {
                    const { freeFinalRewards: e, paidFinalRewards: a } = o();
                    return !(!a && e.mainReward === Jt.progressiveStyle);
                }),
                c = s(() => a.root.get().chapterType === af.EXTRA),
                d = s(() => !(i() || c()), { equals: W }),
                ...
                f = s(() => {
                    var e;
                    return null == (e = St(a.levels.get(), (e) => 'number' == typeof e.levelPoints))
                        ? void 0
                        : e.levelPoints;
                }),
                g = s((e, a) => {
                ...
                v = s((e, t) => {
                    ...
                    return {
                        ...
                        isRare: n.isRare && i !== sf.IN_PROGRESS,
                        isDisabled: (t && !s) || (r !== Jb.Active && i === sf.NOT_STARTED),
                    };
                });
            return {
                ...a,
    ...
    Nf = 'StyleDescription_vehicleInHangar_f82728b9',
    Sf = 'StyleDescription_remark_bf754841',
    kf = 'StyleDescription_lockIcon_6a873423',
    If = 'StyleDescription_baseClass_cf456a8f',
    ...
    Ef = i(({ additionalReward: e, isPaidReward: s }) => {
        const {
            ...
            m = { base: If, level: Rf, name: Pf, typeIcon: Bf };
        return a.jsxs(a.Fragment, {
            children: [
                a.jsx(ut, { type: 'preview', size: 'normal', onClick: l.openPreview }),
                a.jsx('div', { className: t(vf, !u && xf), children: u ? Af.style3DTitle() : Af.styleTitle() }),
                a.jsx(E, { classMix: t(wf, !u && Cf), text: Af.styleName(), binding: { styleName: d } }),
                !u &&
                    a.jsxs('div', {
                        className: yf,
                        children: [
                            a.jsx(E, {
                                ...
                                text: Af.forLabel(),
                                binding: {
                                    vehicleName: a.jsx(rs, {
                                        ...n.get(),
                                        classNames: m,
                                        vehicleTypeIconSize: rt.x24x24,
                                    }),
                                },
                            }),
                            _ && a.jsx(da, { body: Af.inHangarTooltip(), children: a.jsx('div', { className: Nf }) }),
                        ],
                    }),
                e && a.jsx(gf, { additionalReward: e }),
                s &&
                    !c &&
                    a.jsx(wt, {
                        ...
                        children: a.jsxs('div', {
                            className: Sf,
                            children: [a.jsx('div', { className: kf }), a.jsx('div', { children: Af.styleRemark() })],
                        }),
                    }),
            ],
        });
    ...
    Of = 'Skills_zeroSkillIcon_f9fb247',
    Mf = 'Skills_skillIcon_2a4ffd3a',
    Vf = 'Skills_skillIcon__specificPerk_9fedba',
    zf = 'Skills_divider_5189f326',
    Ff = 'Skills_light_dc85d289',
    Hf = ({ skills: e, className: s = '' }) => {
        const r = It(e, (e) => e.isZero);
        return a.jsxs('div', {
            className: t(Tf, s),
            children: [
                O(e, (e, s) =>
                    a.jsxs(
                        'div',
                        {
                            ...
                            children: [
                                            ...
                                            e.isZero &&
                                                ...
                                                a.jsxs('div', {
                                                    ...
                                                    children: [
                                                        ...
                                                        a.jsx('div', { className: Of }),
                                                    ],
                                                }),
                                            a.jsx('div', {
                                                className: t(Mf, e.name !== ns && Vf),
                                                style: {
                                ...
                                r === s && a.jsx('div', { className: zf }),
                            ],
                        },
                        `${e.name}_${s}`,
                    ),
                ),
                a.jsx('div', { className: Ff }),
            ],
        });
    },
    $f = {
    ...
    qf = ({ groupName: s }) => {
        ...
        return (
            ...
            a.jsx(da, {
                ...
                children: a.jsxs('div', {
                    className: t($f.base, r && $f.base__animate),
                    onClick: i,
                    onMouseEnter: () => {
                        Pe.sound(R.sounds.bp_highlight());
                    },
                    style: {
                    ...
                    children: [
                        a.jsx('div', { className: t($f.icon, $f.icon__speaker) }),
                        a.jsx('div', { className: t($f.icon, $f.icon__wave0) }),
                        a.jsx('div', { className: t($f.icon, $f.icon__wave1) }),
                        a.jsx('div', { className: t($f.icon, $f.icon__wave2) }),
                    ],
                }),
            })
        );
    ...
    Kf = 'TankmanDescription_name_9f802b92',
    Yf = 'TankmanDescription_skills_8507fe1b',
    Qf = 'TankmanDescription_skill_2e650973',
    Jf = 'TankmanDescription_skill__paidReward_f372df77',
    ...
    og = i(({ isPaidReward: e }) => {
        const { model: s, controls: r } = df(),
            { tankmenScreenID: n, isBattlePassPurchased: i } = s.root.get(),
            { tankman: o, hasVoice: l, skills: c, groupName: d } = s.computes.getFinalRewardTankmanInfo(e),
            { freeFinalRewards: _, paidFinalRewards: u } = s.computes.getFinalRewardsDescription(),
            m = _.mainReward === Jt.tankman && (null == u ? void 0 : u.mainReward) === Jt.tankman;
        return a.jsxs(a.Fragment, {
            children: [
                l && a.jsx(qf, { groupName: d }),
                a.jsx('div', { className: t(Xf, !l && Zf), children: ng.tankman() }),
                a.jsx('div', { className: Kf, children: o }),
                c.length > 0 &&
                    a.jsx('div', { className: Yf, children: a.jsx(Hf, { skills: c, className: t(Qf, e && Jf) }) }),
                e &&
                    !i &&
                    a.jsx(wt, {
                        contentId: R.views.mono.battle_pass.tooltips.lock_icon('resId'),
                        children: a.jsxs('div', {
                            className: eg,
                            children: [
                                a.jsx('div', { className: ag }),
                                a.jsx('div', { className: tg, children: ng.labelWithBP() }),
                            ],
                        }),
                    }),
                Boolean(n) &&
    ...
    ug = ({ expireTime: e = 0 }) => {
        const t = Pt(e, 1),
            s = ((e) => {
                ...
                return `${e.days ? Rt(R.strings.common.duration.days(), { days: e.days }) : ''} ${a(e.hours)} : ${a(e.minutes)} : ${a(e.seconds)}`;
            })(Le(t));
        return a.jsx(da, {
            ...
            children: a.jsxs('div', {
                className: lg,
                children: [
                    a.jsx('div', { className: dg }),
                    a.jsx('div', { className: _g, children: s }),
                    a.jsx('div', { className: cg }),
                    a.jsx('div', { className: cg }),
                ],
            }),
        });
    ...
    hg = ({ vehicleLvl: e, vehicleName: s, vehicleType: r, isElite: n, classNames: i }) =>
        a.jsxs('div', {
            className: t(mg, null == i ? void 0 : i.base),
            children: [
                es(e),
                a.jsx('div', {
                    className: t(pg, null == i ? void 0 : i.type),
                    style: {
                        backgroundImage: `url(${R.images.gui.maps.icons.vehicleTypes.big.$dyn(`${Bt(r)}${n ? '_elite' : ''}`)})`,
                    },
                }),
                s,
            ],
    ...
    gg = i(({ additionalReward: e, isPaidReward: s }) => {
        const {
            ...
            v = p > ve.medium.weight ? 14 : 12,
            x = d.length > v ? _ : d,
            w = fg.tank.description.$num(b);
        return a.jsxs(a.Fragment, {
            children: [
                a.jsx('div', { className: t(bg.vehicleBg, !f && bg.vehicleBg__description), style: g }),
                a.jsx(ut, { type: 'preview', size: 'normal', onClick: o.openPreview }),
                a.jsx('div', { className: bg.vehicleCaption, children: fg.vehicleCaption() }),
                a.jsx(hg, {
                ...
                !f && w && a.jsx('div', { className: bg.description, children: a.jsx(E, { text: w }) }),
                e && a.jsx('div', { className: bg.rewardLabel, children: a.jsx(gf, { additionalReward: e }) }),
                s &&
                    !h &&
                    a.jsx(wt, {
                        contentId: R.views.mono.battle_pass.tooltips.lock_icon('resId'),
                        children: a.jsxs('div', {
                            ...
                            children: [
                                a.jsx('div', { className: bg.rewardLockIcon }),
                                a.jsx('div', { className: bg.rewardLockText, children: fg.labelWithBP() }),
                            ],
                        }),
                    }),
            ],
    ...
    wg = ({ classNames: e }) =>
        a.jsx('div', {
            className: t(vg, null == e ? void 0 : e.base),
            children: a.jsx('div', { className: t(xg, null == e ? void 0 : e.separatorBg) }),
        }),
    Cg = 'ExtraChapterWidget_3f5dd2c5',
    yg = 'ExtraChapterWidget_widgetWrapper_df1761bd',
    jg = 'ExtraChapterWidget_base__styleReward_3f5dd2c5',
    Ng = 'ExtraChapterWidget_glow_4388d699',
    Sg = 'ExtraChapterWidget_glow__styleReward_8dcf5d5f',
    kg = 'ExtraChapterWidget_content_7571cec7',
    Ig = 'ExtraChapterWidget_content__left_2a162beb',
    ...
    Ag = { [Jt.tankman]: og, [Jt.vehicle]: gg, [Jt.style]: Ef },
    Eg = ({ mainReward: e, additionalReward: t }, s) => {
        if (!e) return null;
        const r = Ag[e];
        return r ? a.jsx(r, { additionalReward: t, ...s }) : (console.warn('Unknown final reward type:', e), null);
    },
    Tg = i(() => {
        const {
        ...
        return a.jsxs('div', {
            ...
            children: [
                a.jsxs('div', {
                    className: yg,
                    children: [
                        a.jsx('div', { className: t(Ng, l && Sg) }),
                        a.jsx('div', { className: t(kg, !i && Pg), children: Eg(n, { isPaidReward: !1 }) }),
                        i &&
                            a.jsxs(a.Fragment, {
                                children: [
                                    a.jsx(wg, { classNames: { separatorBg: Rg } }),
                                    a.jsx('div', { className: t(kg, Ig), children: Eg(i, { isPaidReward: !0 }) }),
                                ],
                            }),
                    ],
                }),
                !o && a.jsx('div', { className: Bg, children: a.jsx(ug, { expireTime: r }) }),
            ],
        });
    }),
    Lg = {
    ...
    Og = i(() => {
        const { model: e, controls: s } = df(),
            ...
            f = _ === Jb.Paused,
            g = c - d,
            v = n === ef.ActivateChapter && g > 0,
            x = n !== ef.ActivateChapter && l,
            w = p
        ...
        return a.jsxs('div', {
            ...
            children: [
                !p &&
                    a.jsxs(a.Fragment, {
                        children: [
                            a.jsx('div', { className: t(Lg.light, Lg[`light__${k}`]) }),
                            a.jsxs('div', {
                                ...
                                children: [
                                    ...
                                    a.jsx('div', { className: Lg.label, children: R }),
                                    x && a.jsx('div', { className: Lg.days, children: B }),
                                    v &&
                                        a.jsxs(a.Fragment, {
                                            children: [
                                                a.jsx('div', { className: Lg.points, children: g }),
                                                a.jsx('div', {
                                                    className: Lg.info,
                                                    children: a.jsx(da, {
                                                        ...
                                                        children: a.jsx('div', { className: Lg.infoHover }),
                                                    }),
                                                }),
                                            ],
                                        }),
                        ...
                        ? a.jsxs('div', {
                              ...
                              children: [
                                  a.jsxs(a.Fragment, {
                                      children: [
                                          a.jsx('div', {
                                              className: t(Lg.label, Lg.label__buy),
                                              children: a.jsx(E, { text: R }),
                                          }),
                                          x && a.jsx('div', { className: Lg.days, children: B }),
                                      ],
                                  }),
                                  a.jsx(da, {
                                      ...
                                      children: a.jsxs(ct, {
                                          ...
                                          mixClass: Lg.button,
                                          onClick: T,
                                          children: [x && a.jsx('div', { className: Lg.blink }), C],
                                      }),
                                  }),
                                  a.jsx(oi, { starterPackRewards: A, presentSize: ni, rewardSize: xe.Small }),
                              ],
                          })
                        : a.jsx(da, {
                              body: y,
    ...
    Kg = 'Header_awards_f810fc3a',
    Yg = 'Header_emblem_c890a2dc',
    Qg = 'Header_emblem__isChapterNotChosen_8aa33950',
    Jg = R.strings.battle_pass,
    ev = i(() => {
        const { controls: e, model: s } = df(),
            {
                chapterID: r,
                chapterState: n,
                seasonNum: i,
            ...
            _ = [Jb.NotStarted, Jb.Paused],
            u =
                (m = n) === Jb.Paused
                    ? Jg.progression.header.paused()
                    : m === Jb.NotStarted
                      ? Jg.progression.header.inactive()
                      : void 0;
        var m;
        const p = d === af.EXTRA,
            h = d === af.HOLIDAY,
            b = Math.trunc(c / 86400),
            f = String(Jg.chapter.fullName.$num(r)),
            g = At(Jg.progression.seasonEndingTooltip(), { day: b }),
            v = At(Jg.progression.header.chapter.status(), { chapterName: f }),
            x = I(
                { iconSize: cn, shieldSize: en, containerSize: Xr },
                { medium: { iconSize: _n, shieldSize: an, containerSize: Zr } },
            ),
            w = _a;
        return a.jsxs('div', {
            className: Mg,
            children: [
                a.jsx('div', {
                    className: Zg,
                    children: a.jsx('div', {
                        className: t(Yg, _.includes(n) && Qg),
                        children: a.jsx(gn, {
                            iconSize: x.iconSize,
                        ...
                        children: [
                            a.jsx(da, {
                                ...
                                children: a.jsx('div', {
                                    ...
                                    children: p
                                        ? a.jsx(E, {
                                              text: Jg.progression.season.end.special(),
                                              binding: { endTime: tt(o, st.DayMonthFull) },
                                          })
                                        : h
                                          ? a.jsx(E, {
                                                text: Jg.progression.season.end.special(),
                                                binding: { endTime: tt(o, st.DayMonthFullTime) },
                                            })
                                          : a.jsx(E, {
                                                text: Jg.progression.season.end.normal(),
                                                binding: {
                                                    seasonNum: es(i),
                                                    seasonName: String(Jg.season.fullName.$num(i)),
                                                    endDate: tt(o, st.DayMonthFull),
                                                },
                                            }),
                                }),
                            }),
                            a.jsxs('div', {
                                ...
                                children: [
                                    a.jsx('div', {
                                        className: $g,
                                        children: a.jsx(w, { className: Hg, text: f, tooltipParams: { body: v } }),
                                    }),
                                    u && a.jsx('div', { className: Ug, children: u }),
                                ],
                            }),
                            a.jsxs('div', {
                                className: qg,
                                children: [
                                    a.jsx('div', {
                                        className: Xg,
                                        children: a.jsx(Nt, {
                                            caption: p || h ? Jg.progression.aboutExtra() : Jg.progression.about(),
                                            type: 'info',
                                            onClick: e.openAbout,
                                        }),
                                    }),
                                    a.jsx('div', {
                                        className: Xg,
                                        children: a.jsx(Nt, {
                                            caption: Jg.progression.howToEarnPoints.title(),
                                            type: 'info',
                                            onClick: e.openInfo,
                                        }),
                                    }),
...
var av = ((e) => ((e.Dragging = 'dragging'), (e.End = 'scrollingToEnd'), (e.Idle = 'idle'), e))(av || {});
const tv = { type: 'idle' };
var sv = ((e) => (
...
const rv = {
    ...
    nv = ({ onClick: s, direction: r, type: n = of.Default, className: i, tooltipBody: o }) => {
        const l = e.useCallback(() => {
                Pe.sound(R.sounds.highlight());
            }, []),
            c = e.useCallback(() => {
                (Pe.sound(R.sounds.bp_slide()), s());
            }, [s]);
        return a.jsx(da, {
            body: o,
            children: a.jsx('div', {
                className: t(rv.base, rv[`base__${n}`], i),
                onClick: c,
                onMouseEnter: l,
                children: a.jsx('div', { className: t(rv.icon, rv[`icon__${r}`], 2 === Et() && rv.icon__4k) }),
            }),
        });
    },
    ...
    wv = ({ isWide: e, isDecorated: s }) =>
        a.jsxs('div', {
            className: t(uv, hv, e && bv),
            children: [
                s && a.jsx('div', { className: vv }),
                a.jsx('div', { className: gv, children: R.strings.battle_pass.progression.postProgressionDescr() }),
                s && a.jsx('div', { className: xv }),
            ],
        }),
    Cv = e.forwardRef(
        (
            { isWide: s = !1, isDisappeared: r = !1, tooltipBody: n, tooltipTitle: i, chapterStep: o, mixClass: l },
            c,
        ) => {
                ...
                children: a.jsx('div', {
                    ...
                    children: s
                        ? a.jsx(da, {
                              ...
                              children: a.jsx('div', {
                                  className: _v,
                                  children: a.jsx(wv, { isWide: s, isDecorated: !0 }),
                              }),
                          })
                        : a.jsxs(a.Fragment, {
                              children: [
    ...
    Nv = 'LoupeButton_iconHover_22ab079c',
    Sv = 'LoupeButton_hoverArea_fa5a9428',
    kv = ({ onClick: s, hoverAreaClasses: r }) => {
        const n = e.useCallback(() => Pe.sound(R.sounds.highlight()), []),
            i = e.useCallback(() => {
                (Pe.sound(R.sounds.play()), s());
            }, [s]),
            o = t(Sv, r);
        return a.jsxs('div', {
            className: yv,
    ...
    Av = e.memo(({ vehicleLvl: t, vehicleName: s, vehicleType: r, isElite: n }) => {
        ...
        return a.jsxs('div', {
            className: Iv,
            children: [
                a.jsx('div', { className: Pv, children: Bv.forVehicle() }),
                es(t),
                a.jsx('div', { className: Rv, style: i }),
                s,
            ],
        });
    }),
    ...
    Vv = 'Widget3dStyle_box__hovered_9577883c',
    zv = 'Widget3dStyle_footer_ff3bf09e',
    Fv = 'Widget3dStyle_caption_cc553073',
    Hv = R.strings.battle_pass.progression.widget3dStyle,
    $v = i(({ widget3dStyleRef: s, level: r, isShowTitle: n }) => {
        const [i, o] = e.useState(!1),
            { controls: l, model: c } = df(),
            { chapterState: d, isStyleTaken: _ } = c.root.get(),
            { styleName: u, styleId: m } = c.widget3dStyle.get(),
            {
                breakpoint: { weight: p },
            } = ge(),
            h = ((e, a) => (2 !== a ? (e <= ve.small.weight ? '_small' : '_medium') : ''))(p, viewEnv.getScale()),
            b = as(r, m, h),
            f = a.jsx(E, { text: Hv.currentStyle(), binding: { name: u } }),
            g = e.useCallback(() => {
                l.open3dStylePreview(r);
            }, [l, r]);
        return a.jsxs('div', {
            className: t(Ev, d === Jb.Completed && Lv),
            ref: s,
            children: [
                !_ && n && a.jsx('div', { className: Tv, children: Hv.titleNoChapterSelected() }),
                a.jsxs('div', {
                    className: t(Dv, i && Vv),
                    onMouseEnter: () => o(!0),
                    onMouseLeave: () => o(!1),
                    children: [
                        !_ && r === Pw && a.jsx('div', { className: Wv }),
                        a.jsx('div', { className: Ov, style: b }),
                        a.jsx('div', { className: Mv, children: a.jsx(kv, { onClick: g }) }),
                    ],
                }),
                a.jsxs('div', {
                    className: zv,
                    children: [
                        a.jsx('div', { className: Fv, children: f }),
                        a.jsx(Av, { ...c.widget3dStyleVehicleInfo.get() }),
                    ],
                }),
            ],
        });
        ...
        ({
            ...
            e.useEffect(() => {
                ...
                const a = x.current !== _,
                    ...
                    h = null == (e = Te(f, m)) ? void 0 : e.levelPoints;
                if (!h) return;
                const g = Uv({
                        level: i,
                        levelWidth: r,
            ...
            return (
                ...
                a.jsx(jt, { animationSettings: N, deltaFrom: w, value: y, maxValue: C || void 0, api: t, theme: u }, g)
            );
        },
    ),
    Xv = {
    ...
    Kv = i(({ progressApi: e, freePointsApi: s, levelWidth: r, currentLevelWidth: n, progressChange: i }) => {
        const { model: o } = df(),
            {
                chapterState: l,
                currentLevel: c,
            ...
            w = o.levels.get(),
            C = Ve(),
            y = (l === Jb.NotStarted || l === Jb.Paused) && b - m > 0,
            j = o.computes.getTotalLevelPoints();
        if (!j) return;
        const N = o.computes.getCurrentWidth(r, n, C, j),
            S = m >= w.length * j,
            k = {
                '--progress-line-base': bt.line.bgColorBase,
                '--progress-line-disabled': bt.line.bgColorDisabled,
                '--progress-line-finished': bt.line.bgColorFinished,
            };
        return a.jsxs('div', {
            ...
            children: [
                ...
                a.jsx('div', {
                    className: t(Xv.progressBackground, S && Xv.progressBackground__finished),
                    style: { width: `${N}rem`, ...k },
                }),
                a.jsx(wt, {
                    contentId: R.views.mono.battle_pass.tooltips.bp_points('resId'),
                    children: a.jsx('div', {
                        className: t(Xv.progress, y && Xv.progress__inactive),
                        children: a.jsx(qv, {
                            api: e,
                            levelWidth: r,
                            currentLevelWidth: n,
    ...
    Yv = 'Background_3985f66b',
    Qv = 'Background_default_6d3ad0aa',
    Jv = 'Background_base__premium_26effab7',
    ...
    hx = i(({ level: e, isPremium: s = !1 }) => {
        ...
        return a.jsxs('div', {
            className: t(Yv, s && Jv),
            children: [
                a.jsx('div', { className: Qv }),
                o && a.jsx('div', { className: lx }),
                n.current === sf.IN_PROGRESS &&
                    a.jsxs('div', {
                        className: cx,
                        children: [
                            a.jsx('div', { className: t(_x, ux) }),
                            !s && a.jsx('div', { className: dx }),
                            a.jsx('div', { className: t(_x, mx) }),
                        ],
                    }),
                i &&
                    a.jsxs('div', {
                        ...
                        children: [
                            a.jsx('div', {
                                className: t(tx, sx, l && nx, n.current === sf.COMPLETED && ox),
                                style: { backgroundImage: px('left') },
                            }),
                            a.jsx('div', {
                                className: t(tx, rx, !l && ix, n.current === sf.COMPLETED && ox),
                                style: { backgroundImage: px('right') },
                            }),
                            n.current === sf.NOT_STARTED && a.jsx('div', { className: ax }),
                        ],
                    }),
            ],
        });
    ...
    gx = i(({ stepNumber: s, stageAnimationDelay: i, isRewardAnimationActive: o }) => {
        const { model: l, controls: c } = df(),
            ...
            f = p.current === sf.IN_PROGRESS,
            g = d === Jb.NotStarted || d === Jb.Paused,
            v = p.current === sf.COMPLETED && !h && !o,
            { stageOpacity: x } = r({
            ...
            { sparkOpacity: w } = r({
                ...
                delay: 1100,
                onRest: () => m(!1),
                config: { duration: 1500, easing: Yt },
            });
        return (
            e.useEffect(() => {
                if (_ && f)
            ...
            a.jsxs('div', {
                className: t(bx.base, bx[`base__${p.current}`], v && bx.base__rewardTaken),
                children: [
                    f &&
                        !g &&
                        a.jsxs(a.Fragment, {
                            children: [
                                a.jsx('div', { className: bx.glow }),
                                a.jsx(n.div, { style: { opacity: w }, className: bx.animatedGlow }),
                            ],
                        }),
                    b && a.jsx('div', { className: bx.iconFinal }),
                    f
                        ? a.jsxs(a.Fragment, {
                              children: [
                                  a.jsxs('div', {
                                  ...
                                  a.jsx('div', {
                                      className: bx.title,
                                      children: g ? fx.pausedStep() : fx.currentStep(),
                                  }),
                              ],
                          })
                        : a.jsx('div', { className: bx.number, children: s }),
                ],
            })
        );
    }),
    ...
    Nx = 'ClosedStatus_icon__exitDone_694aab32',
    Sx = 'ClosedStatus_title_9c1acbb0',
    kx = 'ClosedStatus_title__exit_29b67eb8',
    Ix = 'ClosedStatus_title__exitActive_3d936f93',
    Px = 'ClosedStatus_title__exitDone_694aab32',
    Rx = i(({ level: s, playUnlockAnimation: r = !1, handleUnlockAnimationExited: n, baseUnlockProps: i }) => {
        const o = e.useRef(null),
            l = e.useRef(null),
            { model: c } = df(),
            { isBattlePassPurchased: d } = c.root.get(),
            { cardStatus: _ } = c.computes.cardStates(s, !0),
            u = _.current === sf.IN_PROGRESS,
            m = { exit: Cx, exitActive: u ? jx : yx, exitDone: Nx },
            p = { exit: kx, exitActive: Ix, exitDone: Px },
            h = !d || r,
            b = u && h;
        return a.jsxs('div', {
            className: vx,
            children: [
                h &&
                    a.jsx(N, {
                        ...
                        classNames: m,
                        onExited: n,
                        children: a.jsx('div', { ref: o, className: t(xx, u && wx) }),
                    }),
                b &&
                    a.jsx(N, {
                        ...i,
    ...
    Wx = ({ completedIn: s, handleCompleteGlowAnimationExited: r, children: n }) => {
        const i = e.useRef(null),
            o = { exit: Ex, exitActive: Tx, exitDone: Lx };
        return a.jsxs('div', {
            className: t(Bx, s && Ax),
            children: [
                a.jsx(N, {
                ...
                a.jsx(da, { body: aw.tooltips.completed.got(), children: a.jsx('div', { className: Dx }) }),
            ],
        });
    },
    Ox = {
    ...
    Mx = i(() => {
        ...
        return a.jsx(wt, {
            ...
            children: a.jsxs('div', {
                className: Ox.base,
                children: [
                    a.jsx('div', { className: t(Ox.value, Ox.value__current), children: s }),
                    a.jsx('div', { className: Ox.divider, children: '/' }),
                    a.jsx('div', { className: t(Ox.value, Ox.value__total), children: r }),
                    a.jsx('div', { className: Ox.icon }),
                ],
            }),
        });
    }),
    Vx = 'Effects_glowWrapper_efa5ae0d',
    zx = 'Effects_glow_75ba9df8',
    Fx = 'Effects_glow__active_b9e151',
    Hx = 'Effects_dust_f4cf542',
    $x = 'Effects_dust__active_ece15182',
    Ux = ({ baseUnlockProps: t }) => {
        const s = e.useRef(null),
            r = e.useRef(null),
            n = { exit: zx, exitActive: Fx, exitDone: zx },
            i = { exit: Hx, exitActive: $x, exitDone: Hx };
        return a.jsxs('div', {
            children: [
                a.jsx(N, {
                    ...t,
                    nodeRef: s,
                    classNames: n,
                    children: a.jsx('div', { ref: s, className: Vx, children: a.jsx('div', { className: zx }) }),
                }),
                a.jsx(N, {
                    ...t,
                    nodeRef: r,
                    classNames: i,
                    children: a.jsx('div', { ref: r, className: Vx, children: a.jsx('div', { className: Hx }) }),
                }),
            ],
        });
    },
    ...
    Kx = 'Status_iconGlow_e61b8bfb',
    Yx = 'Status_iconGlow__completed_1ceaf83f',
    Qx = 'Status_iconGlow__hidden_5ce2d06a',
    Jx = 'Status_pointsWrapper_6042cf48',
    ew = 1500,
    ...
    sw = i(
        ({
            ...
            const { model: h } = df(),
                ...
                [y, j] = e.useState(!0),
                [N, S] = e.useState(!1),
                k = b.current === sf.COMPLETED && !g && !f,
                I = (f && s) || k || n,
                P = !s && b.current === sf.IN_PROGRESS && b.potential !== sf.COMPLETED,
                R = () => {
                    (d && Pe.sound(rf.IMPROVED_REWARD), x(!0));
                };
            (e.useEffect(
                () =>
                    n
                        ? ae(() => {
                              (j(!1),
                                  c &&
                                      !N &&
                                      (b.current === sf.IN_PROGRESS
                                          ? Pe.sound(rf.UNLOCK_BIG)
                                          : Pe.sound(rf.UNLOCK_SMALL)));
                          }, u + o)
                        : r
                          ? (C(!0),
                            ae(() => {
            ...
            const B = () => {
                ...
                A = { in: y, timeout: ew + l };
            return a.jsxs('div', {
                className: t(Gx, b.current === sf.IN_PROGRESS && qx),
                            ...
                            children: [
                                ((!r && k) || (v && !g)) &&
                                    a.jsx(Wx, {
                                        ...
                                        children: a.jsx('div', { className: t(Kx, Yx, w && Qx) }),
                                    }),
                                !r &&
                                    !n &&
                                    f &&
                                    ...
                                    a.jsx(wt, {
                                        ...
                                        children: a.jsxs('div', {
                                            ...
                                            children: [
                                                ...
                                                b.current === sf.IN_PROGRESS && a.jsx(Ux, { baseUnlockProps: A }),
                                            ],
                                        }),
                                    }),
                            ],
                        }),
                    P && a.jsx('div', { className: Jx, children: a.jsx(Mx, {}) }),
                ],
            });
        },
    ),
    ...
    nw = s((e) => {
        const { item: a, name: t, value: s, overlayType: r, tooltipId: n, tooltipContentId: i, id: o, icon: l } = e;
        return {
            id: o,
            icon: l,
            name: a || t,
    ...
    iw = i(({ isPremium: s, levelNum: r, hasAnimation: n }) => {
        const {
                breakpoint: { weight: i },
            } = ge(),
            { model: o, controls: l } = df(),
        ...
        return a.jsx('div', {
            className: t(
                rw.base,
                b && rw.base__inProgress,
                s && rw.base__reverse,
                n && rw.base__animated,
                1 === m.length && rw.base__single,
                2 === m.length && rw.base__column,
                3 === m.length && (b ? rw.base__tripleInProgress : rw.base__tripleDefault),
            ),
            children: O(p, (e, s) => {
                const r = nw(e),
                    o = r.name.includes(Lt.StyleProgressToken) || r.name.includes(Lt.BattlePassSelectToken),
                    c = (d && o) || n,
                    { size: _, image: u } = ((e) => {
                        const a = i < ve.medium.weight;
                        return m.length > 1
                            ? a
                ...
                return a.jsxs(
                    'div',
                    {
                        className: t(rw.reward, rw[`reward__${s}`]),
                        children: [
                            c && a.jsx('div', { className: rw.shine }),
                            n &&
                                a.jsxs(a.Fragment, {
                                    children: [
                                        a.jsx('div', { className: rw.staticShine }),
                                        a.jsx('div', { className: rw.explosion }),
                                    ],
                                }),
                            a.jsx(we, { size: _, image: u, className: rw.rewardInner, ...r }),
                            r.icon === Jt.style &&
                                a.jsx('div', {
    ...
    cw = i(({ levelNum: e, isRewardAnimationActive: s, isPremium: r = !1 }) => {
        const { model: n } = df(),
            { cardStatus: i, isDisabled: o } = n.computes.cardStates(e, r),
            l = n.computes.isRewardNeedTake(e, r),
            c = i.current === sf.COMPLETED && !l && !o && !s;
        return a.jsx('div', {
            className: t(ow, c && lw),
            children: a.jsx(iw, { levelNum: e, isPremium: r, hasAnimation: s }),
        });
    }),
    ...
    yw = i(
        ({
            ...
            const {
                ...
                w = v.current === sf.IN_PROGRESS,
                C = v.current === sf.COMPLETED,
                [y, j] = e.useState(!1),
                [N, S] = e.useState(!1),
                {
                    breakpoint: { weight: k },
                } = ge(),
                I = k <= ve.small.weight ? dt.extraSmall : dt.small,
                P = e.useRef(x),
                R = P.current;
            (e.useEffect(() => {
                P.current = x;
            ...
            const B = (() => {
                    ...
                    if (i && o) {
                        ...
                        (d && ((t = (r - l + 1) * xw), s && (t += xw)),
                            (b = Boolean(C && d)),
                            (c = a * xw + xw * Math.trunc(a / 2) + f),
                            o && (e = n));
                    }
                    return (
                        N && ((f = 0), (t = ww), (b = Boolean(C))),
                        r === m - 1 && (e = n),
                        {
                            baseTimeout: d,
            ...
            return a.jsxs('div', {
                ...
                children: [
                                            ...
                                            children: [
                                                ...
                                                a.jsx('div', {
                                                    ...
                                                    children: a.jsxs(ct, {
                                                        ...
                                                        mixClass: t(bw, T && fw),
                                                        children: [
                                                            !T && a.jsx('div', { className: gw }),
                                                            a.jsx('div', { className: vw, children: Cw.takeReward() }),
                                                        ],
                                                    }),
                                                }),
                                            ],
                    ...
                    a.jsx(cw, { levelNum: r, isPremium: s, isRewardAnimationActive: y }),
                    a.jsx('div', {
                        className: _w,
                        children: a.jsx(sw, { isPremium: Boolean(s), completedDuration: 500, level: r, ...B }),
                    }),
                ],
            });
        },
    ...
    Nw = ({ position: e, isPremium: s = !1, isRare: r = !1, status: n }) =>
        a.jsx('div', {
            className: t(jw.base, jw[`base__${n}`], jw[`base__${e}`], r && jw.base__rare, s && jw.base__premium),
            children: a.jsx('div', { className: jw.inner }),
        }),
    Sw = {
        base: 'Card_83a2cdb2',
    ...
    kw = i(
        ({
            ...
            const { model: _ } = df(),
                ...
                f = !s && (p.current === sf.COMPLETED || p.current === sf.IN_PROGRESS),
                g = 1 === r,
                v = r === n,
            ...
            const j =
                    !g &&
                    ((p.current === sf.NOT_STARTED && !h) ||
                        ((null == x ? void 0 : x.isRare) && p.current !== sf.IN_PROGRESS) ||
                        (null == x ? void 0 : x.cardStatus.current) === sf.IN_PROGRESS),
                N =
                    !v &&
                    ((p.current === sf.COMPLETED && !h) ||
                        ((null == w ? void 0 : w.isRare) && p.current !== sf.IN_PROGRESS) ||
                        (null == w ? void 0 : w.cardStatus.current) === sf.IN_PROGRESS),
                S = ((e, a, t, s) =>
                    e === sf.COMPLETED
                        ? 100
                        : e !== sf.IN_PROGRESS || (a !== Jb.NotStarted && a !== Jb.Paused)
                          ? 0
            ...
            return a.jsxs('div', {
                className: t(Sw.base, Sw[`base__${p.current}`], !s && Sw.base__nonPremium),
                ref: C,
                style: I,
                children: [
                    a.jsx(hx, { level: r, isPremium: s }),
                    a.jsx(yw, {
                        isPremium: s,
                        stepNumber: r,
                        maxVisibleCards: i,
                    ...
                    s &&
                        a.jsxs(a.Fragment, {
                            children: [
                                a.jsx('div', { className: t(Sw.totalPoints, Sw.totalPoints__default), children: y }),
                                v &&
                                    a.jsx('div', {
                                        className: t(Sw.totalPoints, Sw.totalPoints__final),
                                        children: n * b,
                                    }),
                            ],
                        }),
                    f && a.jsx('div', { className: Sw.progressShadow, style: k }),
                    !j && a.jsx(Nw, { position: tf.left, isPremium: s, isRare: h, status: p.current }),
                    !N && a.jsx(Nw, { position: tf.right, isPremium: s, isRare: h, status: p.current }),
                ],
            });
        },
    ),
    Iw = i(
        ({
            ...
            const { model: c } = df(),
                ...
                x = Boolean(l && p);
            return a.jsx('div', {
                className: t(Xv.row, !i && Xv.row__basic),
                children: O(h, (e, t) => {
                    return a.jsx(
                        kw,
                        {
    ...
    Rw = i(
        ({
            ...
            return (
                ...
                e.useEffect(() => {
                    m && Pe.sound(R.sounds.bp_progress_bar_start());
                }, [m]),
                e.useEffect(() => {
                    i && i();
                }, [_, u, i]),
                a.jsxs('div', {
                    ...
                    children: [
                        !p &&
                            a.jsxs(a.Fragment, {
                                children: [
                                    a.jsx($v, { widget3dStyleRef: o, level: Pw, isShowTitle: !0 }),
                                    a.jsx('div', {
                                        className: t(Xv.decor, Xv.decor__left),
                                        children: a.jsx('div', { className: Xv.decorBackground }),
                                    }),
                                    a.jsx('div', {
                                        className: Xv.bookmarkBackground,
                                        ref: l,
                                        children: a.jsx(Cv, { isDisappeared: !0, mixClass: Xv.bookmarkLeftResponsive }),
                                    }),
                                ],
                            }),
                        a.jsxs('div', {
                            ...
                            children: [
                                ...
                                a.jsx(Kv, { progressApi: b, freePointsApi: f, progressChange: i, ...g }),
                                a.jsx(Iw, {
    ...
    Tw = i(({ onHorizontalScroll: s }) => {
        const { model: r } = df(),
            ...
            D = (e) => {
                (T.type === av.Dragging && L({ type: av.End }), B(e));
            },
            W = e.useMemo(() => ({ ...k, handleMouseWheel: D }), []),
            O = e.useCallback(
                (e) => {
            ...
            H = (e) => {
                switch (e) {
                    case 'navToCurrentLevel':
                        return { type: of.Default, tooltipBody: Aw.backToCurrentStageArrow.descr() };
                    case 'navToPotentialLevel':
                        return { type: of.Gray, tooltipBody: Aw.backToPotentialStageArrow.descr() };
                }
            },
            $ = (e) => {
                (O(I.goal), V(), S(null == e ? void 0 : e.type));
            };
        return (
            e.useEffect(
                () =>
            ...
            e.useEffect(() => {
                if (((e = '') => Ew.includes(e))(N)) return void s('dragStart' === N);
                const e = () => {
                        N || O(I.goal);
                    },
                    a = () => {
            ...
            a.jsxs(a.Fragment, {
                children: [
                    a.jsx('div', {
                        className: t(Xv.bookmark, Xv.bookmark__start),
                        children: a.jsx(Cv, {
                            chapterStep: n.length,
                            mixClass: t(Xv.bookmarkLeftFixed, y && Xv.bookmarkLeftFixed__active),
                        }),
                    }),
                    a.jsx('div', {
                        ...
                        onMouseLeave: V,
                        onWheel: $,
                        children: a.jsx(je.Horizontal.Area.Default, {
                            api: W,
                    ...
                    a.jsx('div', {
                        className: t(
                            ...
                            'hidden' !== w && Xv.scrollToButton__visible,
                        ),
                        children: a.jsx(nv, {
                            onClick: () => F(w),
                            direction: nf.back,
                    ...
                    a.jsx('div', {
                        className: t(
                            ...
                            'hidden' !== v && Xv.scrollToButton__visible,
                        ),
                        children: a.jsx(nv, {
                            onClick: () => F(v),
                            direction: nf.forward,
                            className: Xv.arrowButton,
                            ...H(v),
                        }),
                    }),
    ...
    Lw = i(() => {
        const { model: s } = df(),
            ...
            [n, i] = e.useState(!1),
            o = t(Xv.additionalShadow, n && Xv.additionalShadow__active);
        return a.jsxs('div', {
            className: t(Xv.base, r && Xv.base__isLayoutWithExtraWidget),
            children: [
                a.jsx('div', { className: t(Xv.shadow, Xv.shadow__left), children: a.jsx('div', { className: o }) }),
                a.jsx('div', { className: t(Xv.shadow, Xv.shadow__right), children: a.jsx('div', { className: o }) }),
                a.jsx(Tw, {
    ...
    Dw = 'ProgressionContent_23d7382d',
    Ww = 'ProgressionContent_base__extra_58f1f12d',
    Ow = 'ProgressionContent_base__extraChapter_9b00a080',
    Mw = 'ProgressionContent_header_3c9de2e1',
    Vw = 'ProgressionContent_progression_ee26929',
    zw = 'ProgressionContent_progression__extraChapter_ed356b04',
    Fw = 'ProgressionContent_extraChapterWidget_6d130b1f',
    ...
    $w = i(() => {
        const {
            ...
            _ = t(Vw, l && zw);
        return a.jsxs('div', {
            className: t(Dw, l && Ww, c && Ow),
            style: qt(n),
            children: [
                !o && a.jsx('div', { className: _, children: a.jsx(Lw, {}) }),
                a.jsx('div', { className: Mw, children: a.jsx(ev, {}) }),
                a.jsx('div', { className: Hw, children: d && a.jsx(Og, {}) }),
                l && a.jsx('div', { className: Fw, children: a.jsx(Tg, {}) }),
            ],
        });
    }),
    Uw = 'App_7cf6cd46',
    Gw = i(() => {
        const { model: t, controls: s } = df(),
            { showReplaceRewardsAnimations: r } = t.root.get(),
            n = pe();
        return (
            be(L.ESCAPE, () => n.goBack()),
            e.useEffect(() => {
                const e = () => {
            ...
            e.useEffect(() => {
                r && Pe.sound(R.sounds.bp_pick_up_award());
            }, [r]),
            a.jsx('div', { className: Uw, children: a.jsx($w, {}) })
        );
    }),
    qw = () => a.jsx(cf, { options: { rootId: R.aliases.battle_pass.Progression('resId') }, children: a.jsx(Gw, {}) }),
    Xw = 'App_811b056b',
    ...
    Kw = i(() => {
        const { location: t } = pe(),
            s = S(t, {
                from: { opacity: 0 },
                enter: { opacity: 1, config: { duration: 150, easing: Be.easeInQuad }, delay: 150 },
            });
            ...
            children: a.jsx('div', {
                ...
                children: s((e, t) =>
                    a.jsx(n.div, {
                        ...
                        children: a.jsxs(Wt, {
                            children: [
                                a.jsx(Ot, { path: ts.battlePass.progression, component: qw }),
                                a.jsx(Ot, { path: ts.battlePass.chapterChoice, component: Ku }),
                                a.jsx(Ot, { path: ts.battlePass.postProgression, component: Qb }),
                                a.jsx(Ot, { path: ts.battlePass.buyPass, component: xi }),
                                a.jsx(Ot, { path: ts.battlePass.buyPassRewards, component: xi }),
                                a.jsx(Ot, { path: ts.battlePass.buyLevels, component: lr }),
                                a.jsx(Ot, { path: ts.battlePass.buyLevelsRewards, component: lr }),
                                a.jsx(Ot, { path: ts.battlePass.holidayFinal, component: Dp }),
                                a.jsx(Ot, { path: ts.battlePass.tankmenScreen, component: ss }),
                            ],
                        }),
                    }),
                ),
...
Ht(new Mt().add(Vt).add(zt).addWithProps(Ft, { context: 'model.router' }).render(a.jsx(Kw, {})))
