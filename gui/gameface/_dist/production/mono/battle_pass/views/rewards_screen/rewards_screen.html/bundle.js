...
const Be = 'ChapterLogo_aa1334cf',
    ...
    He = ({ reward: e, size: a, className: s }) => {
        const {
            ...
            m = t === k.Vehicles;
        return r.jsxs('div', {
            className: n(De.base, De[`base__${a}`], De[`base__${t}`], s),
            children: [
                r.jsx('div', {
                    className: De.title,
                    children:
                ...
                _ && r.jsx('div', { className: De.subtitle, children: Ge.common.collectionText() }),
            ],
        });
    },
    qe = {
...
const Xe = [k.BattlaPassFinalAchievement, k.TmanToken, k.Vehicles],
    ...
    Ze = t(({ reward: e, rewardListIndex: a }) => {
        const { model: s } = Q(),
            ...
            g = ((h = _), !Qe.includes(h) && Number(b) > 1);
        var h;
        const T = ((e) => Xe.includes(e))(_) || (m && m.length > 0),
                    ...
                    children: [
                        ...
                        r.jsxs('div', {
                            ...
                            children: [
                                r.jsx('div', {
                                    className: wa,
                                    children: r.jsx(D, { title: B.title, status: B.subtitle }),
                                }),
                                r.jsxs('div', {
                                    className: n(ga, H && ha),
                                    children: [
                        ...
                        F && r.jsx(ye, { button: z, className: n(ya, C && Sa, !I && La) }),
...
M(new F().add(O).addWithProps(X, {}).render(r.jsx(Ca, {})));
