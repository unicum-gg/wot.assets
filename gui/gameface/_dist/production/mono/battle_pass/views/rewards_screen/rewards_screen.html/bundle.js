...
import { u as D, H as z } from '../../../chunks/useKeyup.js';
...
const [Q, X] = c()(
        ({ observableModel: s }) => {
            const t = {
                ...
                R = [J.BUY_BATTLE_PASS_LEVELS, J.BUY_BATTLE_PASS_WITH_LEVELS, J.DEFAULT].includes(t.root.get().reason),
                f = a(() => {
    ...
    Z = 'AdditionalRewards_c7f66cac',
    ee = 'AdditionalRewards_title_3afa6e1a',
    ae = 'AdditionalRewards_title__updateAnimation_3afa6e1a',
    se = 'AdditionalRewards_reward_79ca4edb',
    te = 'AdditionalRewards_rewardsList_532db93b',
    ie = R.strings.battle_pass.battlePassAwardsView,
    re = t(({ rewards: e, pageNumber: a, className: s }) => {
        const { model: t } = X(),
        ...
        return r.jsxs('div', {
            className: n(Z, s),
            children: [
                r.jsx('div', { className: n(ee, l && ae), children: ie.additionalRewards.subText() }),
                r.jsx('div', {
                    className: te,
                    children: _((e, a) => {
                        const s = a.item || a.name,
                            ...
                            i = (() => {
                                ...
                                return 'universal' === e[0]
                                    ...
                                    : { value: a.value, valueType: A(a.name) };
                            })(),
                            n = f({ tooltipId: a.tooltipId }, Number(a.tooltipContentId), { ignoreShowDelay: !0 });
                        return r.jsx(o.div, {
                            className: se,
                            style: e,
                            children: r.jsx(x, {
    ...
    ne = 'Banner_d226745a',
    oe = 'Banner_content_b0220cfe',
    le = 'Banner_icon_5d6fa4df',
    de = 'Banner_description_ac932ff',
    ce = 'Banner_title_f8c86772',
    _e = 'Banner_text_6a6f5026',
    me = 'Banner_buttonContainer_9bae7c89',
    pe = 'Banner_buttonWrapper_4e9f1fa3',
    ue = 'Banner_buttonGlow_d6f79d6a',
    be = R.strings.battle_pass.battlePassAwardsView.footer,
    we = t(({ className: e, parentRef: a }) => {
        const { model: s, controls: t } = X(),
            { seasonStopped: i, currentLevel: o } = s.root.get();
        D({ [v.ENTER]: t.buy, [v.SPACE]: t.buy });
        ...
        return r.jsxs('div', {
            ...
            children: [
                r.jsxs('div', {
                    className: oe,
                    children: [
                        r.jsx('div', { className: le }),
                        r.jsxs('div', {
                            className: de,
                            children: [
                                r.jsx('div', { className: ce, children: be.bpTitle() }),
                                r.jsx('div', {
                                    className: _e,
                                    children: o >= 45 ? be.bpLastStagesTitle() : be.bpInProgressTitle(),
                                }),
                            ],
                        }),
                    ],
                ...
                r.jsxs('div', {
                    className: me,
                    children: [
                        r.jsx('div', { className: ue }),
                        r.jsx('div', {
                            className: pe,
                            children: r.jsx(P, {
                                disabled: i,
                                type: S.main,
                                size: d ? y.medium : y.small,
                                onClick: t.buy,
                                children: be.bpButtonTitle(),
                            }),
                        }),
                    ],
                }),
    ...
    ge = 'Footer_f09fca09',
    he = 'Footer_base__withPostProgressionPath_67ee05f9',
    Te = 'Footer_postProgressionInfo_90b6969f',
    Ae = 'Footer_lockImage_39ae8112',
    Re = 'Footer_title_d3857cd',
    fe = 'Footer_title__highlight_97414ca4',
    xe = 'Footer_buttonContainer_873ac017',
    ve = 'Footer_postProgressionButton_45a39895',
    Pe = R.strings.battle_pass.battlePassAwardsView,
    ye = t(({ button: e, className: a }) => {
        const { model: s, controls: t } = X(),
            { breakpoint: i } = u(),
                ...
                _
                    ? r.jsxs('div', {
                          ...
                          children: [
                              ...
                              r.jsx('div', { children: Pe.footer.postProgressionText() }),
                          ],
                      })
                    : Boolean(p) && r.jsx('div', { className: n(Re, m && fe), children: p }),
                r.jsxs('div', {
                    className: xe,
                    ...
                    children: [
                        ...
                        _ &&
                            ...
                            r.jsx(P, {
                                ...
                                mixClass: ve,
                                children: Pe.footer.postProgressionButton(),
                            }),
                    ],
                }),
            ],
...
var Le = ((e) => ((e.Season = 'season'), (e.Chapter = 'chapter'), e))(Le || {});
const Be = 'ChapterLogo_aa1334cf',
    je = t(() => {
        const { model: e } = X(),
            ...
            s = (() => {
                ...
                const s = { path: R.images.gui.maps.icons.battlePass.rewards.chapterLogo, name: Le.Chapter, id: a };
                return { backgroundImage: `url(${Se(s, { name: 'bp_icon' })})` };
            })();
        return r.jsx('div', { className: Be, style: s });
    }),
    Ne = 'Glow_ae7a850f',
    Ee = 'Glow_91b75819',
    ke = ({ className: e }) =>
        r.jsx('div', {
            className: n(Ne, e),
            children: r.jsx('img', { className: Ee, src: 'swf://gui/flash/animations/battlePass/rays.swf', alt: '' }),
        }),
    Ue = 'AttachmentOverlay_cb258ef',
    Ie = ({ overlayType: e, rewardSize: a, className: s }) =>
        r.jsx('div', {
            className: n(Ue, s),
            style: { backgroundImage: `url(R.images.gui.maps.icons.customization.rarity.glowWithSign.${a}.${e})` },
        }),
    Ce = 'Compensation_50897e74',
    Ve = B.resolve('images'),
    $e = ({ className: e }) => {
        const a = j(
            Ve.readOrEmpty('battlePass.icons.compensation'),
            Ve.readOrEmpty('battlePass.icons.compensation_large'),
        );
        return r.jsx('div', { className: n(Ce, e), style: { backgroundImage: `url(${a})` } });
    },
    We = { base: 'TankName_6f5fa973', base__wide: 'TankName_base__wide_bdc02313', type: 'TankName_type_be575ae0' },
    Ye = (e, a) => ({
        backgroundImage: `url(${`R.images.gui.maps.icons.vehicleTypes.big.${`${e.replace('-', '_')}${a ? '_elite' : ''}`}`})`,
    }),
    Fe = ({ isElite: e, vehicleName: a, vehicleType: s, vehicleLvl: t, isWide: i }) =>
        r.jsxs('div', {
            className: n(We.base, i && We.base__wide),
            children: [
                r.jsx('div', { className: We.level, children: N(t) }),
                r.jsx('div', { className: We.type, style: Ye(s, e) }),
                r.jsx('div', { className: We.name, children: a }),
            ],
        }),
    Oe = 'Text_textCenter_a832bab6',
    Me = R.strings.battle_pass,
    De = ({ type: e, value: a }) => {
        switch (e) {
            case k.BattlaPassFinalAchievement:
                return r.jsx(L, { text: Me.battlePassAwardsView.mainReward.reward(), binding: { name: a } });
            case k.TmanToken:
                return r.jsx(L, {
                    classMix: Oe,
                    text: Me.battlePassAwardsView.mainReward.commander(),
                    binding: { name: a },
                });
            case k.Gold:
            case k.Credits:
            case k.Crystal:
            case k.EquipCoin:
                return r.jsx(U, { format: 'integral', value: Number(a) });
            default:
                return r.jsx(r.Fragment, { children: E(a) });
        }
    },
    ze = {
        base: 'Title_ddf5c9be',
    ...
    He = ({ reward: e, size: a, className: s }) => {
        const {
                name: t,
                userName: i,
                vehicleLvl: o,
            ...
            m = t === k.Vehicles;
        return r.jsxs('div', {
            className: n(ze.base, ze[`base__${a}`], ze[`base__${t}`], s),
            children: [
                r.jsx('div', {
                    className: ze.title,
                    children:
                        m && o && l && d
                            ...
                            : r.jsx(De, { type: t, value: i }),
                }),
                _ && r.jsx('div', { className: ze.subtitle, children: Ge.common.collectionText() }),
            ],
        });
    },
    qe = {
...
const Qe = [k.BattlaPassFinalAchievement, k.TmanToken, k.Vehicles],
    Xe = [
        I.credits,
        I.gold,
        I.crystal,
    ...
    Ze = t(({ reward: e, rewardListIndex: a }) => {
        const { model: s } = X(),
            ...
            b = (() => {
                const e = p.split('_');
                return 'universal' === e[0] ? e[e.length - 1] : p;
            })(),
            g = ((h = _), !Xe.includes(h) && Number(b) > 1);
        var h;
        const T = ((e) => Qe.includes(e))(_) || (m && m.length > 0),
            A = i ? (1 === o || 1 === a ? 'wide' : 'small') : 'normal';
        return r.jsxs('div', {
            className: n(qe.base, qe[`base__${A}`], t && qe.base__updateAnimation),
            children: [
                r.jsx(C, {
                    ignoreShowDelay: !0,
                    contentId: Number(d),
                    ...
                    children: r.jsxs('div', {
                        ...
                        children: [
                            r.jsx('div', {
                                className: qe.image,
                                style: K(e),
                                children: u && r.jsx($e, { className: n(qe.compensation, qe[`compensation__${A}`]) }),
                            }),
                            q(_) && r.jsx(Ie, { overlayType: l, rewardSize: w.S600x450, className: qe.attachment }),
                            g &&
                                r.jsx('div', {
                                    className: qe.count,
                ...
                T && r.jsx(He, { reward: e, size: A, className: qe.title }),
            ],
        });
    }),
    ea = 'Rewards_1a8854f',
    aa = 'Rewards_base__updateSize_222a87fa',
    sa = t(() => {
        const { model: e } = X(),
        ...
        return r.jsx('div', {
            className: n(ea, a && aa),
            children: s.map((e, a) => r.jsx(Ze, { reward: e, rewardListIndex: a }, `reward-${a}`)),
        });
    }),
    ta = 'Ribbon_2234841',
    ia = 'Ribbon_base__indentWide_72bb1f1',
    ra = t(() => {
        const { model: e } = X(),
            ...
            c = (() => {
                const e = { path: R.images.gui.maps.icons.battlePass.logo.ribbon, name: Le.Chapter, id: s };
                return { backgroundImage: `url(${Se(e, { name: 'ribbon', postfix: `${d}${a ? '_with_bp' : ''}` })})` };
            })();
        return r.jsx('div', { className: n(ta, o && ia), style: c });
    }),
    na = 'MainRewards_c825d49e',
    oa = 'MainRewards_glow_31c8c598',
    la = 'MainRewards_rays_11ac61d3',
    da = t(({ className: e }) => {
        const { model: a } = X(),
        ...
        return r.jsxs('div', {
            className: n(na, e),
            children: [
                i && !s && r.jsx(ke, { className: oa }),
                r.jsx('div', { className: la }),
                r.jsx(ra, {}),
                t && !c
                    ? r.jsx(o.div, { style: { opacity: m.to({ output: [1, 0] }) }, children: r.jsx(je, {}) })
                    : r.jsx(sa, {}),
            ],
        });
    }),
    ca = 'App_1b1884ba',
    _a = 'App_overlay_ce1d3259',
    ma = 'App_overlay__common_f6f1f131',
    pa = 'App_main_20c49be8',
    ua = 'App_close_110976dc',
    ba = 'App_content_d2251eca',
    wa = 'App_header_c3dc2c23',
    ga = 'App_rewards_927ebd71',
    ha = 'App_rewards__additionalCentring_6f33396d',
    Ta = 'App_additionalRewards_2598f029',
    Aa = 'App_additionalRewards__slideTop_bc21615e',
    Ra = 'App_additionalRewards__animateSlide_9db8979b',
    fa = 'App_base__buyWithLevels_0',
    xa = 'App_mainRewards_de1e5f92',
    va = 'App_mainRewards__slideTop_bc21615e',
    Pa = 'App_mainRewards__animateSlide_7838291c',
    ya = 'App_footer_e0204304',
    Sa = 'App_footer__hide_642d4e09',
    La = 'App_footer__diffTop_8dc6cdec',
    Ba = 'App_banner_e0204304',
    ja = 'App_banner__showPreparation_ca795627',
    Na = R.strings.battle_pass,
    Ea = (e) =>
        e
            ? r.jsx(L, {
                  text: Na.battlePassAwardsView.header.bpTitle(),
                  binding: { chapter: Na.chapter.fullNameUppercased.$num(e) },
              })
    ...
    Ia = (e, a, s, t, i, n) => {
        const o = ((e, a, s) =>
            s
                ? Na.battlePassAwardsView.additionalRewards.seeMoreButtonText()
                : e
                  ? r.jsx(L, {
                        text: Na.battlePassAwardsView.additionalRewards.bpRemainLevelsAwardsText(),
                        binding: { remainingAwardsCount: a },
                    })
                  : Na.battlePassAwardsView.additionalRewards.button())(i, a > t * (s + 1) ? 10 : a - t * s, e);
    ...
    Ca = t(() => {
        const { model: e, controls: a } = X(),
            ...
            L = `${V(x)}rem`;
        $(a.close);
        const B = { title: ka(s, t), subtitle: Ua(s, i, o) },
            ...
            M = () => {
                Y(() => {
                    O && O.current && v(O.current.offsetHeight);
                });
            };
        (l.useEffect(() => {
            (M(), y(!1));
        ...
        const D = Ia(S, m, A, N, k, () => {
                S ? a.enableToOpenAdditionView() : k ? f(A + 1) : a.close();
            }),
            H = h && p,
            q = {
                backgroundImage: t
                    ? `url(${G(R.images.gui.maps.icons.battlePass.backgrounds.chapter_general, t)})`
                    : 'url(R.images.gui.maps.icons.battlePass.backgrounds.common)',
                '--banner-height': L,
            };
        return r.jsxs('div', {
            className: n(ca, b && c && fa),
            style: q,
            children: [
                r.jsx('div', { className: n(_a, !t && ma) }),
                r.jsxs('div', {
                    className: pa,
                    children: [
                        r.jsx('div', {
                        ...
                        r.jsxs('div', {
                            ...
                            children: [
                                r.jsx('div', {
                                    className: wa,
                                    children: r.jsx(z, { title: B.title, status: B.subtitle }),
                                }),
                                r.jsxs('div', {
                                    className: n(ga, H && ha),
                                    children: [
                                        r.jsx(da, { className: n(xa, C && va, C && !P && Pa) }),
                                        p &&
                                            r.jsx(re, {
                                                rewards: j,
                                                pageNumber: A,
                                                className: n(Ta, C && Aa, C && !P && Ra),
                                            }),
                                    ],
                                }),
                            ],
                        }),
                        F && r.jsx(ye, { button: D, className: n(ya, C && Sa, !I && La) }),
                        I && r.jsx(we, { className: n(Ba, U && ja), parentRef: O }),
                    ],
                }),
            ],
        });
    });
M(new F().add(O).addWithProps(Q, {}).render(r.jsx(Ca, {})));
