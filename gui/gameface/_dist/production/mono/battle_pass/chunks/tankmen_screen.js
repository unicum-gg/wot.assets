...
const C = {
    ...
    D = a(({ tankman: e, className: a }) => {
        const { controls: t } = T(),
            { state: i, progressionLevel: l, count: o, availableCount: _, groupName: c, chapterID: r } = e,
            d = b(),
    ...
    M = ({ isHovered: e, isPlayingSound: a, className: t }) =>
        n.jsxs('div', {
            className: s(z.base, e && z.base__hover, a && z.base__animate, t),
            style: { '--animation-duration': `${B.duration}ms`, '--animation-iteration-count': B.iterationCount },
            children: [
                n.jsx('div', { className: s(z.icon, z.icon__speaker) }),
                Array.from({ length: 3 }, (e, a) =>
                    n.jsx('div', { className: s(z.icon, z[`icon__wave${a}`]) }, `wave${a}`),
                ),
                n.jsx('div', { className: z.label, children: A.readOrEmpty('battle_pass.tankmenVoiceover.listen') }),
            ],
        }),
    W = {
    ...
    H = ({ tankman: e, activeTankman: a, setActiveTankman: t }) => {
        ...
        return (
            ...
            n.jsxs('div', {
                ...
                children: [
                    n.jsx('div', {
                        className: W.interactiveContainer,
                        onClick: () => {
                            u ||
                                r ||
                                !_ ||
                        ...
                        children: _ && n.jsx(M, { className: W.voice, isHovered: d, isPlayingSound: u }),
                    }),
                    n.jsx('div', {
                        className: W.image,
                        style: {
                            backgroundImage: `url(${F.readOrEmpty(`battlePass.tankman.persons.commander_${l}`)})`,
                        },
                    }),
                    n.jsxs('div', {
                        className: W.content,
                        children: [
                            c.length > 0 && n.jsx(U, { className: W.skills, skills: c }),
                            n.jsx('span', { className: W.name, children: o }),
                            n.jsx(D, { className: W.details, tankman: e }),
                        ],
                    }),
                ],
            })
