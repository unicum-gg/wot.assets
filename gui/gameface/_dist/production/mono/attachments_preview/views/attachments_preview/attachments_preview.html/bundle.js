...
const se = 'Container_6c2fdff0',
    te = a.forwardRef(function ({ attachment: t, template: i, tooltipDisabled: r = !1, className: n = '', ...l }, c) {
        const { width: o, height: m, padding: d } = J(i),
            { tooltipContentId: _, tooltipId: h } = t,
            x = a.useMemo(() => ({ contentId: Number(_), args: { tooltipId: h }, disabled: r }), [r, _, h]),
            p = y(x);
        return e.jsx('div', {
            ref: c,
            ...p,
...
((te.Highlight = function ({ size: a, special: t, className: i }) {
    ...
    return e.jsx('div', {
        className: s(K, i),
        style: { backgroundImage: `url(${X.readOrEmpty(`quests.bonuses.${a}.${r}_highlight`, 'silent')})` },
    });
}),
    (te.Image = function ({ template: a, image: s, className: t = '', ...i }) {
        const { assetWidth: r, assetHeight: n } = J(a);
        return e.jsx('div', { className: Z, style: { backgroundImage: `url(${s})`, width: r, height: n }, ...i });
    }),
        ...
        children: [
            e.jsxs(te, {
                ...
                children: [
                    ...
                    e.jsx(te.Image, { template: G.AttachmentPreview, image: Y(a, s), onMouseEnter: S.highlight }),
                    i && e.jsx(te.Overlay, { name: a.name, special: i, size: t, className: ne }),
                    ((r = i),
                    (r === p.ATTACHMENT_EPIC || r === p.ATTACHMENT_LEGENDARY) &&
                        e.jsx(f, { src: de.readOrEmpty(`rarity.cycle_${i}`), autoplay: !0, loop: !0, className: le })),
                ],
            }),
