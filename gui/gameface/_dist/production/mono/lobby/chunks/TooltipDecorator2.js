import { r as e, R as n, q as t } from './vendor.js';
var o = {
        d: (e, n) => {
...
o.d(i, { Y: () => le });
var r = {};
(o.r(r), o.d(r, { mouse: () => y, off: () => p, on: () => w, onResize: () => g, onScaleUpdated: () => m }));
var a = {};
(o.r(a),
    o.d(a, {
        events: () => r,
...
const Z = (() => {
    ...
    oe = { view: u },
    ie =
        ((re = { default: () => n, useEffect: () => e.useEffect, useMemo: () => e.useMemo, useRef: () => e.useRef }),
        (ae = {}),
        o.d(ae, re),
        ae);
var re, ae;
