import { r as e, j as t, f as l } from './vendor.js';
import { i as C, bZ as a } from './lib.js';
const n = -1,
    i = 'disabled',
    r = 'paused',
    o = 'readyToSelect',
    s = 'pending',
    [d, u, c] = C()(({ observableModel: e }) => ({
        ...e.primitives(['isCrystalEarnEnabled', 'isDailyMultipliedXpEnabled', 'isInfiniteAmmo']),
    })),
    m = () => e.useContext(c.Context),
    p = -1,
    h = 'undamaged',
    H = '54033',
    w = '50705',
    v = '56833',
    b = '51201',
    g = { [H]: 'alpha', [w]: 'alpha', [b]: 'super', [v]: 'super' },
    E = {
    ...
    L = {
        ...
        [E.damaged]: 'repair',
        [E.rentable]: 'rental',
        [E.rentableAgain]: 'rental',
        [E.rentalIsOver]: 'rental',
        [E.tooHeavy]: 'notSuitable',
        [E.unsuitableToQueue]: 'notSuitable',
        [E.unsuitableToUnit]: 'notSuitable',
        [E.inPrebattle]: 'inPlatoon',
        [E.battle]: 'inBattle',
        [E.wot_plus_exclusive_vehicle_disabled]: 'notSuitable',
    };
function V(e, t, l) {
    return !(!e || t === i || !l) && l.status !== E.unsuitableToQueue && l.maxBpScore > 0;
}
const _ = 'TankmanRole_3bb08c81',
    f = {
        [a.commander]: (t) =>
            e.createElement(
                'svg',
...
function x({ role: e = '', className: C }) {
    const a = f[e];
    if (a) return t.jsx(a, { className: l(_, C) });
