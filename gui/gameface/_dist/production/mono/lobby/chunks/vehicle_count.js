...
import { j as r, F as i } from './lib.js';
const t = 'VehicleCount_f16f129a',
    ...
    p = (p) => {
        const { vehicleCount: g, isVehicleCountAvailable: j, isSerial: C } = p.vehicleCounter,
            b = g < 20,
            w = j && g > 0,
            N = w && C ? V.remainTop : w && !C ? V.remain : j && 0 === g ? V.noRemains : j ? void 0 : V.noData,
            f = {
                counter: e.jsx('div', {
                    className: h,
                    children: e.jsx('span', { className: a(m, b && u), children: r.formatNumber('integral', g) }),
                }),
