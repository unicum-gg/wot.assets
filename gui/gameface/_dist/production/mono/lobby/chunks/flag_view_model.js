import { ah as e, x as i } from './lib.js';
import { w as s, y as t, Y as n, t as r, s as o } from './vendor.js';
const u = {
    overview: 'overview',
...
const I = {
    ...
    N = {
        ...
        [m.premiumBonus]: {
            define: ({ restriction: e }) => (e !== c.NoRestriction && e !== c.NotApplyingError ? I[e] : g.applyBonus),
        },
