...
import { d as H, T as z, e as U } from '../../../../chunks/tankman_role.js';
var W = ((e) => ((e.UNDEFINED = 'undefined'), (e.SILVER = 'silver'), (e.GOLD = 'gold'), e))(W || {});
const [X, F] = i('VehicleTooltipModelProvider')(({ observableModel: e }) => {
        const s = {
            ...
            children: x(i, (s) =>
                e.jsxs(
                    'div',
                    {
                        className: _e,
                        children: [
                            e.jsx(z, { role: v(s.roles, 0), className: xe }),
                            s.roles.length > 1 &&
...
const be = t(function () {
    ...
    ze = 'EliteSystem_leftColumn_6aa7810f',
    Ue = 'EliteSystem_c476a5a0',
    We = 'EliteSystem_eliteSystem_5a135969',
    Xe = 'EliteSystem_eliteSystem__prestige_2b06b89c',
    Fe = 'EliteSystem_values_c91f1a15',
    Qe = 'EliteSystem_currency_4591b107',
    ...
    Je = t(function ({ className: t }) {
        ...
        return e.jsxs(pe, {
            className: s(Ue, t),
            children: [
                e.jsx('div', { className: ze, children: e.jsx(w, { level: r, grade: l, type: c, size: O.xs }) }),
                e.jsxs('div', {
                    className: s(We, m && Xe),
                    children: [
                        e.jsxs('div', {
