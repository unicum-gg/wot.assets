...
import { i as l, c as i, n as o, E as d, m as n, J as p, U as r, H as _, r as c } from '../../../../chunks/lib.js';
...
const [m, f] = l()(({ observableModel: e }) => {
        const a = {
                ...
                infoList: e.array('infoList', []),
            },
            s = t(() => a.detailedStats.get(), { equals: i }),
            l = t(() => s().length),
            o = t(() => a.infoList.get(), { equals: i }),
            d = t(() => o().length);
        return {
            ...a,
            computes: { getDetailedStats: s, getDetailedStatsLength: l, getInfoList: o, getInfoListLength: d },
        };
    }, o),
    h = {
        root: 'BattleResultStatTooltipApp_root_85356241',
    ...
    g = e(() => {
        const { model: t } = f(),
            ...
            o = t.computes.getInfoListLength(),
            p = t.computes.getInfoList(),
            r = R.strings.sm_lobby.tooltips.battleResultStat.$dyn(e),
            _ = r.$dyn('info');
        return a.jsxs('div', {
            className: s(h.base, h[`base__${e}`]),
            children: [
                a.jsxs('div', {
                    className: h.header,
                    children: [
                        ...
                        a.jsx('div', { children: a.jsx('div', { className: h.heading, children: r.$dyn(x) }) }),
                    ],
                }),
                a.jsx(d, { classMix: h.info, text: _.$dyn(x) }),
                Boolean(o) &&
                    a.jsx('div', {
                        children: n(p, (t, e) =>
                            a.jsxs(
                                'div',
                                {
                                    ...
                                    children: [
                                        a.jsx('div', { className: s(h.info, h.info__bullet), children: '•' }),
                                        a.jsx(d, { classMix: h.info, text: t }),
                                    ],
                                },
                                `${e}_${t}`,
                            ),
                ...
                e == u.ARMOR_USE && a.jsx(d, { classMix: s(h.info, h.info__heHits), text: _.$dyn('heHits') }),
                Boolean(l) &&
                    a.jsxs('div', {
                        children: [
                            a.jsx('div', { className: h.divider }),
                            a.jsx('div', {
                                className: h.detailed,
                                children: n(i, ({ value: t, text: e }, s) =>
                                    a.jsxs(
                                        'div',
                                        {
                                            className: h.values,
                                            children: [
                                                a.jsx('div', { className: h.value, children: S(t) }),
                                                a.jsx(d, { text: e, classMix: h.detailedStat }),
                                            ],
                                        },
                                        `${s}_${t}`,
                                    ),
