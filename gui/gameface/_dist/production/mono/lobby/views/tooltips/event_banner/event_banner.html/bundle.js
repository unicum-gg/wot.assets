...
import { i as t, n as a, ac as r, F as o, a0 as n, j as c } from '../../../../chunks/lib.js';
        ...
        return e.jsx(r, {
            children: e.jsx(r.Decorator, {
                children: e.jsxs('div', {
                    className: l,
                    children: [
                        e.jsx(i, { image: c('tooltips.entry.background'), className: j }),
                        e.jsx(o, { className: x, text: p('bundle.name') }),
                        e.jsx(o, { className: b, text: p('tooltips.entry.description') }),
                        e.jsx(o, {
                            className: u,
                            split: !0,
                            text: p('tooltips.entry.timer'),
                            params: { timer: e.jsx(n, { start: t }) },
                        }),
                    ],
                }),
            }),
