import { y as e, j as s, w as t } from '../../../../chunks/vendor.js';
import { i as a, aC as p, q as o, n, aA as _ } from '../../../../chunks/lib.js';
import { T as i } from '../../../../chunks/tooltip_decorator.js';
import { t as r } from '../../../../chunks/tooltips.module.js';
/* empty css                        */ const [c, d] = a()(({ observableModel: e }) => ({ root: e.object() }), p),
    l = {
        base: 'App_eaae4c68',
        ...
        return s.jsxs('div', {
            ...
            children: [
                s.jsxs('div', {
                    className: l.header,
                    children: [
                        s.jsx(o, { text: R.strings.comp7_ext.seasonPointTooltip.header(), classMix: l.heading }),
                        !a &&
                            s.jsx(o, {
                ...
                s.jsxs('div', {
                    className: l.body,
                    children: [
                        s.jsx(o, { text: R.strings.comp7_ext.seasonPointTooltip.text.season(), classMix: l.text }),
                        s.jsx(o, { text: R.strings.comp7_ext.seasonPointTooltip.text.year(), classMix: l.text }),
                        s.jsx(n, {
