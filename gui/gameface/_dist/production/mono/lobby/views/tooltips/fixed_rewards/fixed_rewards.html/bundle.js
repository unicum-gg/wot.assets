...
import { i as n, m as p, n as r, F as c, H as o, a2 as l, j as d } from '../../../../chunks/lib.js';
...
function h({ step: e, info: t }) {
    return s.jsxs('div', {
        ...
        children: [
            ...
            s.jsx(o, { type: e.name || '', reverse: !0, className: j, classNames: { icon: f }, children: e.value }),
        ],
    });
}
            ...
            children: s.jsx(l.Decorator, {
                children: s.jsxs('div', {
                    ...
                    children: [
                        ...
                        s.jsx(c, { className: b, text: r('tooltips.steps.description'), params: { currency: o } }),
                        s.jsxs(s.Fragment, {
                            children: [
