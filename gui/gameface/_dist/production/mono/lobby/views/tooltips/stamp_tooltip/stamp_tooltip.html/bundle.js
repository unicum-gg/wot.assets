import { q as e, j as i } from '../../../../chunks/vendor.js';
import { I as t, a as s, al as p, z as a } from '../../../../chunks/lib.js';
...
/* empty css                                 */ const r = 'StampTooltipApp_bb28b309',
        ...
        return i.jsx('div', {
            ...
            children: i.jsxs('div', {
                ...
                children: [
                    ...
                    i.jsx('div', { className: c, children: s.readOrEmpty('white_tiger_lobby.stamp.description') }),
    ...
    [x, T] = s()(({ observableModel: e }) => ({ root: e.object() }), p);
