import { j as e, a3 as s, a1 as a } from '../../../../chunks/vendor.js';
import { i as o, n as t, cu as i, d2 as n, cD as c } from '../../../../chunks/lib.js';
...
/* empty css                        */ const [p, w] = o()(({ observableModel: e }) => ({ root: e.object() }), t),
    m = {
        base: 'Row_94492f2a',
        ...
        return e.jsxs('div', {
            ...
            children: [
                e.jsx(i, {
                    ...
                    binding: { winRate: e.jsx('div', { className: j, children: _({ value: o, isPercentage: !0 }) }) },
                    classMix: x,
                }),
                e.jsx(i, { text: R.strings.comp7_ext.winsIndicatorTooltip.winRate.description(), classMix: v }),
                e.jsxs('div', {
                    className: g,
                    children: [
