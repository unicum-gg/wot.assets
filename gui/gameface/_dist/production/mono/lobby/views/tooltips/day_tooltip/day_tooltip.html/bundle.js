import { j as a, J as n, I as e } from '../../../../chunks/vendor.js';
import { i, n as t, cR as s, cd as r, cP as _, cn as o } from '../../../../chunks/lib.js';
...
const [x, m] = i()(({ observableModel: a }) => ({ root: a.object() }), t),
    ...
    y = e(() => {
        ...
        return a.jsxs('div', {
            className: g.qualificationContainer,
            children: [
                a.jsx(l, { size: d.x22, seasonName: i }),
                a.jsx('div', {
                    className: n(g.heading, g.heading__qualification),
    ...
    u = {
            ...
            const { model: e } = m(),
                {
                    ...
                    division: o,
                    ratingPoints: p,
                    rankInactivityPenalty: l,
                } = e.root.get();
            return a.jsxs('div', {
                className: g.rankContent,
                children: [
                    a.jsxs('div', {
                        className: g.rankContainer,
                        children: [
                            a.jsx(c, { rank: _, size: d.x22, seasonName: i, division: o }),
                            a.jsx('div', {
                                className: n(g.heading, g[`heading__rank_${f[_]}`]),
                                children: a.jsx(s, { value: p }),
                            }),
                        ],
                    }),
                    0 === l
                        ...
                        : a.jsxs('div', {
                              className: g.penaltyContainer,
                              children: [
                                  a.jsx('div', { className: g.penaltyIcon }),
                                  a.jsx(r, {
                                      text: `${R.strings.comp7_ext.dayTooltip.rankInactivity()}`,
                                      binding: {
                                          penalty: a.jsx(r, {
                                              text: `${R.strings.comp7_ext.dayTooltip.rankInactivityPenalty(Math.abs(l))}`,
                                              binding: { pointsCount: l },
                                              classMix: g.penaltyText,
                                          }),
                                      },
                                      classMix: g.rankInactivityText,
                                  }),
                              ],
                          }),
                ],
        ...
        empty: () =>
            a.jsx('div', {
                className: n(g.heading, g.heading__empty),
                children: R.strings.comp7_ext.dayTooltip.noBattles(),
            }),
    };
function A({ index: a, currentDayIndex: n, hasBattles: e }) {
    const i = a === n;
    return a > n
...
const b = e(function () {
    const { model: e } = m(),
        { index: i, isQualification: t, rank: s, currentDayIndex: _, hasBattles: o } = e.root.get(),
    ...
    return d
        ? a.jsxs('div', {
              ...
              children: [
                  a.jsx(d, {}),
                  a.jsx(r, {
                      text: A({ index: i, currentDayIndex: _, hasBattles: o }),
                      binding: { index: i + 1 },
                      classMix: g.day,
                  }),
              ],
...
_(a.jsx(x, { children: a.jsx(o, { children: a.jsx(p, { children: a.jsx(b, {}) }) }) }));
