import { a1 as s, j as e, a3 as i } from '../../../../chunks/vendor.js';
import { i as o, n as t, cu as c, d2 as l } from '../../../../chunks/lib.js';
...
/* empty css                        */ const [p, r] = o()(({ observableModel: s }) => ({ root: s.object() }), t),
    ...
    j = 'App_section__bottom_df7c9a59',
    b = 'App_divider_31ebf907',
    ...
    N = s(() => {
        ...
        return e.jsxs('div', {
            ...
            children: [
                e.jsx('div', {
                    className: m,
                    children: e.jsx(c, { text: String(R.strings.comp7_ext.style3dTooltip.$num(o)), classMix: v }),
                }),
                e.jsx('div', {
                    className: _,
                    style: { backgroundImage: `url(${R.images.comp7.gui.maps.icons.rewards.$dyn(`style3d_${o}`)})` },
                }),
                e.jsxs('div', {
                    className: m,
                    children: [
