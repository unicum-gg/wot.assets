...
const [l, p] = o('FunRandomNoQuestsTooltipViewModel')(({ observableModel: s }) => ({ ...{ root: s.object() } }), t),
    u = s(() => {
        const { model: s } = p(),
            ...
            c = e.jsx(r, { text: a.progressionQuests.tooltip.noQuestsTitle(), params: { eventName: a.userName() } });
        return e.jsx(d, {
            header: c,
