import { S as e, j as a, w as s, x as n, R as i, Q as c, P as r } from '../../../chunks/vendor.js';
import {
    i as t,
    cM as _,
    aF as l,
...
const [$, U] = t()(
    ...
    W = 'BackgroundVideo_video_be61ad9f',
    z = 'BackgroundVideo_video__bg_277575c1',
    O = (e) => !!m.isHigh() && e,
    H = ({ className: e, classNames: n, animated: i = !0 }) =>
        a.jsx('div', {
            className: s(D, e),
            children: O(i)
                ? a.jsx(h, {
                      className: s(W, null == n ? void 0 : n.video),
                      src: String(R.videos.comp7.yearly_styles()),
                      autoplay: !0,
                      loop: !0,
                  })
                : a.jsx('div', { className: s(W, z, null == n ? void 0 : n.video) }),
        }),
...
const L = n(() => {
    ...
    J = 'Banner_date_1c1a4743',
    X = 'Banner_introDescription_d804cece',
    Y = 'Banner_seasonText_bf05f458',
    ...
    ce = () =>
        a.jsxs('div', {
            ...
            children: [
                ...
                a.jsx(A, { hasSeasonName: !1, className: J }),
                a.jsx(L, {}),
                a.jsx('div', {
                    className: Z,
                    children: a.jsxs('div', {
    ...
    Ce = n(() => {
        ...
        return a.jsx(u, {
            children: a.jsxs(f, {
                ...
                children: [
                    c === k.Third && a.jsx(H, { className: ke.videoContainer }),
                    a.jsxs('div', {
