...
const [o, n] = r()(
        ...
        ({ externalModel: e }) => ({ select: e.createCallback((e) => ({ upgradeState: e }), 'onSelectUpgrades') }),
    ),
    p = 'Upgrade_d729e0ca',
    ...
    S = e(function () {
        ...
        return s.jsxs('div', {
            ...
            children: [
                s.jsxs('div', {
                    className: N,
                    children: [O.readOrEmpty('veh_skill_tree.comparison.title'), s.jsx('div', { className: U, ...r })],
                }),
                s.jsx('div', { className: E, children: d(a, (e, r) => s.jsx(k, { ...e, doubled: a.length < 3 }, r)) }),
            ],
        });
    });
