...
const ta = 'xp',
    ...
    ot = new Set([Ta]),
    ct = new Set([Ea, za, Ha, Oa, Ga, $a, Fa, Wa, rt, nt, lt, La, Ma, st, qa, Ua, Za]),
    dt = {
        [ma]: Sa,
        [pa]: Ca,
        [lt]: lt,
    ...
    ut = [na, ia, oa, ca],
    ft = [Ea, za, Ha, Oa, Fa, Ga, Xa, Qa, $a, Wa, rt, nt, lt, La, Ma, st, Ya, at, qa, Ua, Za, Ja, tt, Ka, et],
    _t = new Set([ca, da, Ia, wa, Ba, Ea, Ma, Ya, at, qa, Ua, Za, Ja, tt, Ka, et]),
...
const Rt = { [da]: wt, [Ia]: wt, [wa]: wt, [Ba]: wt, [st]: It, [ja]: St, [ka]: St },
    Pt = {
        [Ea]: wt,
        [Ma]: wt,
        [Ya]: wt,
...
const Dt = { [Ya]: (e) => !1 === Ct(e), [Ja]: (e) => !1 === Ct(e), [Ka]: (e, a) => a },
    Tt = { [ta]: 'library.xp', [sa]: 'library.freeXp', [ra]: 'library.credits', [la]: 'library.gold' },
    At = [st, rt, lt, nt];
function Vt(e) {
...
function Wt(e) {
    return {
        ...
        detailedStatistics: y(e.detailedStatistics, $t),
...
const [ds, ms] = P()(
        (e) => {
            const { observableModel: a, cleanup: s } = e,
                ...
                l = {
                    ...
                    personalEfficiency: {
                        opened: t.box(!1),
                        achievements: a.transform((e) => Yt(y(e, Gt)), 'achievements'),
    ...
    fs = A.cubicBezier(0.33, 0, 0.25, 1),
    _s = 400,
...
const ws = 'Header_content_b9e0be90',
    ...
    Ds = 'playerRankXP',
    Ts = { ...dt, [Ds]: Ds },
    As = [da, Ia, Ds, ga, xa, Va, ya, Na, st, ja, ka, rt, nt, lt, wa, Ba];
function Vs(e, a) {
    return As.indexOf(e.paramName) - As.indexOf(a.paramName);
}
function ks(e, a) {
...
function $s(e, a) {
    const t = e.paramName;
    return (b(Xs(t), `No analogue for ${t} in free xp parameter names`), a.find((e) => Ts[t] === e.paramName));
}
const Ws = (e) => e in mt;
function Ls(e, a) {
    const t = e.paramName;
    return (b(Ws(t), `No analogue for ${t} in gold parameter names`), a.find((e) => mt[t] === e.paramName));
}
function Ms(e, a) {
    const t = (function (e, a) {
        return [
            ...
            ...y(e, (e) => (it.has(e.paramName) ? Fs({ xp: e }) : Fs({ xp: e, freeXp: $s(e, a) }))),
        ];
    })(e, a);
    return t
        .filter((e) => {
            ...
            children: [
                n.jsxs('div', {
                    ...
                    children: [
                        ...
                        n.jsx(k, { upgradeLegacy: !0, path: e, params: s }),
                    ],
                }),
                n.jsxs('div', { className: Qs, children: [n.jsx('div', { className: er }), a] }),
            ],
        });
    }),
...
const Nr = 'Header_cbd845ec',
            ...
            return n.jsx(Cs, {
                ...
                children: n.jsxs('div', {
                    ...
                    children: [
                        n.jsx('div', {
                            className: i(wr, !r && Ir),
                            children: n.jsx(k, { path: 'battle_results.common.details.noPremTitle' }),
                        }),
                        n.jsxs('div', {
                            ...
                            children: [
                                ...
                                n.jsx(k, { path: 'battle_results.getPremiumPopover.prem' }),
                            ],
                        }),
                    ],
                }),
    ...
    Tr = 'IncomeStatement_verticalBar_5fb90511',
    Ar = 'IncomeStatement_scrollWrapper_ce2dde41',
    Vr = 'IncomeStatement_scrollContent_72ffb2ee',
    kr = 'IncomeStatement_scrollContent__initialized_ce1144d0',
    Br = F('CreditsIncomeStatement'),
    Er = ({ children: e }) => {
        const a = M(),
            t = Cr(a.api);
        return n.jsx(K, { classNames: { wrapper: Ar, content: i(Vr, t && kr) }, children: e });
    },
    zr = r.forwardRef(({ children: e, className: a, scrollable: t, ...s }, r) =>
        n.jsx(Br, {
            ...
            ref: r,
            children: t
                ? n.jsxs(W, { children: [n.jsx(Er, { children: e }), n.jsx(L, { classNames: { base: Tr } })] })
                : e,
        }),
    ),
    Hr = 'Record_420804f3',
        ...
        return n.jsxs('div', {
            ...
            children: [
                n.jsxs('div', {
                    ...
                    children: [
                        c(t)
                            .with(bt, () => n.jsx(k, { path: 'common.multiplierSmall' }))
                            .with(ht, () => n.jsx(k, { path: 'common.multiplierSmall' }))
                            .with(vt, () => n.jsx(k, { path: 'common.multiplierSmall' }))
                            .with(xt, () => n.jsx(k, { path: 'common.plus' }))
                            .otherwise(() => null),
                        e(a, s),
                        t === gt && n.jsx(k, { path: 'common.common.percent' }),
                    ],
                }),
    ...
    $r = 'RecordGroup_base__inactive_5fd9f274',
    ...
    Yr = 'RecordGroup_value__gold_d7bd74ba';
function Jr({ paramName: e, wotPlusActive: a, value: t }) {
    switch (e) {
        case st:
            return !1;
        case Wa:
...
const Qr = ({ credits: e, gold: a, modifier: t, inactive: s = !1, total: r, paramName: l, wotPlusActive: o }) => {
        function c(e, a) {
        ...
        return n.jsxs('div', {
            ...
            children: [
                n.jsx('div', {
                    className: i(Wr, Mr, Jr({ paramName: l, wotPlusActive: o, value: e }) && Lr),
                    children: n.jsx(Gr, {
                        formatter: c,
                        value: e,
                        currency: ra,
                ...
                n.jsx('div', {
                    className: i(Wr, 0 === a && Lr),
                    children: n.jsx(Gr, {
                        value: a,
                        currency: la,
                        modifier: t,
                        classNames: { value: i(Ur, Yr, r && Zr) },
                        formatter: c,
                        iconPath: Bt(la, l),
                    }),
                }),
    ...
    rl = { [Wa]: 'subscription.wot_plus_32x32' },
...
function Tl({ paramName: e, wotPlusActive: a, value: t }) {
    switch (e) {
        case st:
            return !1;
        case ja:
...
const Al = ({ paramName: e, xp: a, freeXp: t, modifier: s, inactive: r, total: l, wotPlusActive: o }) => {
        function c(a) {
            switch (e) {
                case fa:
        ...
        return n.jsxs('div', {
            ...
            children: [
                n.jsx('div', {
                    className: i(Nl, wl, Tl({ wotPlusActive: o, paramName: e, value: a }) && jl),
                    children: n.jsx(Gr, {
                        value: a,
                        currency: ta,
                ...
                n.jsx('div', {
                    className: i(Nl, Tl({ wotPlusActive: o, paramName: e, value: t }) && jl),
                    children: n.jsx(Gr, {
                        value: t,
                        currency: sa,
    ...
    Bl = 'Item_label__highlighted_36e62867',
    ...
    Hl = { [ja]: 'subscription.wot_plus_32x32', [ka]: 'subscription.wot_plus_32x32' },
    Ol = new Set([ja, ka]),
    Fl = () =>
        n.jsx('span', { className: Bl, children: n.jsx(k, { path: 'battle_results.details.calculations.maximum' }) }),
    Gl = o(
        ({
            ...
            return n.jsx(lr, {
                ...
                classNames: { label: i(kl, Ol.has(e) && El) },
                children: n.jsxs('div', {
                    className: Vl,
                    children: [
                        n.jsx(Al, { ...t, paramName: e, modifier: s, inactive: d, total: l, wotPlusActive: m }),
                        n.jsx(Al, { ...a, paramName: e, modifier: s, inactive: !d, total: l, wotPlusActive: m }),
                    ],
                }),
            });
        },
    ...
    $l = 'IncomeStatement_base__scroll_fb9f1475',
    ...
    Ll = o(
        r.forwardRef(({ className: e, scrollable: a, ...t }, s) => {
            ...
            return n.jsx(zr, {
                ...t,
                ref: s,
                className: i(Xl, a && $l, e),
                scrollable: a,
                children: y(l.records, (e) => n.jsx(Gl, { record: e, className: Wl }, e.paramName)),
            });
        }),
    ),
    ...
    Yl = 'Experience_a014c8c',
    Jl = 'Experience_base__scroll_f75d07c6',
    Ql = F('Experience'),
    en = r.forwardRef(({ scrollable: e, className: a, ...t }, s) =>
        n.jsx(Ql, { ...t, ref: s, className: i(Yl, e && Jl, a) }),
    );
...
function Tn({ children: e, achievements: a, springsProps: t }) {
...
const An = {
    ...
    Vn = r.forwardRef(function ({ achievement: e, index: a, width: t, height: s, classNames: l }, o) {
        ...
        return n.jsx('div', {
            ...c,
            ref: o,
            className: i(An.base, An[`base__${as(a, m)}`], null == l ? void 0 : l.achievement),
                ...
                'rank' === e.groupID
                    ...
                    : n.jsx(
                          O,
                          {
                              ...
                              className: i(An.icon, null == l ? void 0 : l.icon),
                          },
                          e.iconName,
                      ),
        });
    ...
    Bn = 'GroupedAchievements_rankGroup_74be9c12',
...
const Un = r.memo(function ({ value: e, readyToAnimate: a, className: t, handleAnimationFinished: s, type: l }) {
    ...
    Yn = 'Currency_icon_4d923f64',
    Jn = 'Currency_icon__visible_9c676b12',
    Qn = 'Currency_value_54c8fc6b',
...
const Ni = 'TableHeader_row_a81d3e65',
    ...
    Vi = o(function ({ className: e }) {
        ...
        return (
            ...
            n.jsxs(Ai, {
                className: e,
                children: [
                    n.jsx('div', { className: i(Ti.background, v && Ti[`background__${v}`]) }),
                    n.jsx('div', { className: Ti.cornerShadow }),
                    n.jsx('div', { className: i(Ti.bottomGradient, v && Ti[`bottomGradient__${v}`]) }),
                    n.jsxs('div', {
                        className: i(Ti.info, 0 === o.length && Ti.info__withoutMedals),
                        children: [
                            n.jsx(ci, { status: v }),
                            n.jsx('div', {
                                className: Ti.statusWrapper,
                                children: n.jsx(m.div, {
                                    style: _,
                                    className: Ti.status,
                                    children: n.jsx('div', {
                                        className: Ti.statusText,
                                        'data-test-id': 'winStatus',
                                        children: z.toUpperCase(t.readOrEmpty(`battle_results.status.${v}`)),
                                    }),
                                }),
                            }),
                            n.jsx(Xn, { className: Ti.achievements }),
                            n.jsx(m.div, { style: p, className: Ti.currencies, children: n.jsx(ri, {}) }),
                        ],
                    }),
                    n.jsx(Di, {}),
                ],
    ...
    ki = o(function (e) {
        ...
        return n.jsx(Tn, { achievements: t, children: n.jsx(Vi, { ...e }) });
    }),
    Bi = 'Divider_80a19f4b',
    Ei = r.forwardRef(function ({ classNames: e, className: a, ...t }, s) {
        return n.jsx('div', {
            ...t,
            ref: s,
            className: i(Bi, null == e ? void 0 : e.base, a),
            children: n.jsx(O, {
                className: null == e ? void 0 : e.image,
                width: '100%',
                height: '100%',
...
const Oi = r.forwardRef(function (
    ...
    $i = r.forwardRef(function ({ labelKey: e, ...a }, t) {
...
const qi = F('StatisticsValue', Wi),
    ...
    Yi = 'Index_scrollAreaContent__initialized_b2629fde',
    Ji = 'Index_item_6b7cdfb0',
    Qi = 'Index_separator_add04e19',
    eo = F('Statistics', 'Index_statistics_638478ff'),
    ao = F('StatisticsItem', Ji),
    to = F('StatisticsItemSeparator', Qi);
        ...
        children: [
            n.jsx(K, {
                ...
                classNames: {
                    ...
                    content: i(Zi, l && Yi, null == (s = null == t ? void 0 : t.classNames) ? void 0 : s.content),
                },
                children: e,
            }),
            n.jsx(L, { ...a }),
...
const ro = r.forwardRef(function ({ scrollbarProps: e, scrollAreaProps: a, ...t }, s) {
    return n.jsx(eo, {
        ...t,
        ref: s,
        children: n.jsx(W, { children: n.jsx(so, { ...t, scrollbarProps: e, scrollAreaProps: a }) }),
    });
});
((ro.Item = ao), (ro.Value = Ui), (ro.Label = $i), (ro.Separator = to));
const lo = {
...
const mo = 'EfficiencyDetails_divider_85b11efd',
    ...
    To = 'AccountInfoCell_stripe_fefba7b2',
    Ao = o(function ({ account: e, team: a, platoon: t, className: s, classNames: r, ...l }) {
        const { model: o } = ms(),
...
function Bo({ achievements: e }) {
    const a = I.resolve('strings'),
        t = Ne({ body: y(Yt(e), (e) => a.readOrEmpty(`achievements.${e.name}`)).join('\n') }),
        s = e.length;
    return 0 === s
        ? null
        : n.jsxs('div', {
...
const Eo = { behaviour: fe.static, size: '32rem' },
    ...
    $o = { behaviour: fe.static, size: '60rem' },
    ...
    Yo = { behaviour: fe.static, size: '56rem' },
    Jo = { behaviour: fe.static, size: '40rem' },
    Qo = {
        ...
        [xo]: { [_e.extraSmall]: Xo, [_e.medium]: $o, [_e.large]: $o, [_e.extraLarge]: Wo },
        ...
        [jo]: { [_e.extraSmall]: Zo, [_e.medium]: Yo, [_e.large]: Yo, [_e.extraLarge]: Yo },
        [wo]: { [_e.extraSmall]: Jo, [_e.medium]: Jo, [_e.large]: Jo, [_e.extraLarge]: Jo },
    },
    ec = {
    ...
    Rc = ({ team: e, personalInfo: a, breakpointName: t }) => {
        ...
        return [
            ...
            Ic.accessor('account', {
                ...
                meta: { column: Qo[vo][r], className: bc },
            }),
            Ic.accessor('rank', {
                id: go,
            ...
            Ic.accessor('efficiencyValues', {
                ...
                meta: { column: Qo[xo][r], className: vc },
            }),
            Ic.accessor('efficiencyValues', {
                id: yo,
            ...
            Ic.accessor('efficiencyValues', {
                ...
                meta: { column: Qo[No][r], className: vc },
            }),
            ...
            Ic.accessor('achievements', {
                ...
                cell: (e) => n.jsx(Bo, { achievements: e.getValue() }),
                meta: { column: Qo[wo][r], className: bc },
            }),
        ];
    },
...
const Vc = 'SelectedRowTail_selectedRowTail_8abda9c8',
    ...
    Bc = 'SelectedRowTail_selectedRowVerticalLine_c502cc58',
    ...
    Wc = o(function ({ row: e, team: a, rowIndex: t, scrollbarVisible: s }) {
        const { model: r, controls: l } = ms(),
            ...
            u = (() => {
                ...
                return os(a, m.squadIndex, e.original.squadIndex) === ns ? Xc : $c;
            })(),
...
const Mc = F('TeamEfficiencyTable', hc, { variants: { team: { [rs]: uc, [ls]: fc } } }),
            ...
            n.jsx(ye, {
                ...
                children: n.jsx(Mc, {
                    ...
                    children: n.jsxs(
                        ...
                        {
                            className: gc,
                            children: [n.jsx(Ac, { className: _c }), n.jsx(W, { children: n.jsx(Lc, { team: e }) })],
                        },
                        d,
                    ),
                }),
    ...
    Yc = 'TeamEfficiency_table__hidden_e8864815',
    Jc = 'TeamEfficiency_details_f087bb8e',
    Qc = 'TeamEfficiency_details__visible_eaf91b76',
    ...
    ad = o(function ({ className: e }) {
        ...
        return n.jsx(ed, {
            ...
            children: n.jsxs('div', {
                className: Uc,
                children: [
                    n.jsx(ho, { team: ls, className: i(Jc, (null == r ? void 0 : r.team) === ls && Qc) }),
                    n.jsx(qc, { data: t, team: rs, className: i(Zc, (null == r ? void 0 : r.team) === ls && Yc) }),
                    n.jsx(ho, { team: rs, className: i(Jc, (null == r ? void 0 : r.team) === rs && Qc) }),
                    n.jsx(qc, { data: s, team: ls, className: i(Zc, (null == r ? void 0 : r.team) === rs && Yc) }),
                ],
            }),
        });
    }),
...
function ld() {
    ...
    return n.jsxs('div', {
        ...
        children: [
            n.jsx(ki, { className: i(td.tab, td.tab__overview) }),
...
Me(
    new $e()
        .add(ds)
        .addWithProps(We, { soundsOverrides: od })
