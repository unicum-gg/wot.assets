...
function k({ className: s, timerStartTime: a }) {
    const l = a ?? Date.now(),
...
const z = 'PrebattleQueueApp_dad90a27',
    ...
    K = 'PrebattleQueueApp_leaveBtn_701eb3a6',
    U = 'PrebattleQueueApp_tip_34008381',
    $ = a(function () {
            ...
            children: [
                ...
                t.jsxs('div', {
                    ...
                    children: [
                        ...
                        t.jsx(k, { className: C, timerStartTime: e.timerStartTime.get() }),
                        t.jsx('div', {
                            className: L,
                            children: t.jsx(P, {
                                className: I,
                        ...
                        t.jsx('div', { className: U, children: R.strings.last_stand_lobby.preBattle.tip() }),
...
b(t.jsx(Q, { children: t.jsx(f, { children: t.jsx($, {}) }) }))
