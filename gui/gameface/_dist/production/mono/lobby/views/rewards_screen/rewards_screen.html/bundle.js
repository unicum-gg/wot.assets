...
const de = [re.RankRewards, re.QualificationRewards],
    ...
    ke = {
        ...
        [be]: 'comp_7_rank_gold',
        [xe]: 'comp_7_rank_champion',
        [Se]: 'comp_7_rank_legend',
    },
    ye = {
    ...
    Te = new Set(),
    Be = a(({ playerRef: e, onKeyframesLoaded: a, onAnimationComplete: t, className: i, classNames: d }) => {
        const { model: o } = ce(),
            ...
            x = r.useRef(!1),
            S = r.useCallback(() => {
                (e.current?.goToAndStop(p.end), h(!0), t?.(), (x.current = !0));
            }, [t, e, p.end]),
            [k, y] = f(() => {
    ...
    Ze = a(({ className: e, mainButtonText: a = R.strings.comp7_ext.rewardsScreen.button(), onClick: r }) => {
        ...
        return s.jsxs('div', {
            className: n(Je, e),
            children: [
                s.jsx(S, { theme: S.themes.primary, size: o, onClick: r ?? i.close, className: Xe, children: a }),
    ...
    ra = ({ bgImage: e, isBlurred: a = !1, className: r, classNames: t }) =>
        s.jsx('div', {
            className: n(aa, r),
            children: s.jsx('div', { className: n(sa, a && na, t?.layer), style: { backgroundImage: `url(${e})` } }),
        }),
    ta = (e, a) => {
        const s = R.images.comp7.gui.maps.icons.backgrounds.$dyn(e)?.$dyn(O(a));
        return s ? `${s}` : (console.error(`no background was found for rank ${a}, season ${e}`), R.invalid());
    },
...
const ba = 'BattleItem_14e04a96',
    xa = 'BattleItem_item_b8e00cd3',
    Sa = a(({ index: e, className: a }) => {
        const { model: t } = ce(),
            { mediaSize: d } = x(),
            l = pa(),
            _ = 100 * e,
                ...
                children: [
                    ...
                    s.jsx('div', {
                        ...
                        children: N(e.qualificationBattles.get().length, (e) =>
                            s.jsx(Sa, { index: e, className: Na }, e),
                        ),
                    }),
        ...
        return s.jsxs(s.Fragment, {
            children: [
                s.jsx(Fe, {
                    ...
                    title: s.jsx(k, { text: Ke(a), binding: { rankUpperName: E(R.strings.comp7_ext.rankUpper, n) } }),
                    ...
                    s.jsx($a, {
                        ...
                        children: s.jsx('div', {
                            ...
                            children: s.jsx(L, {
                                ...
                                size: c,
                                value: T(R.strings.tooltips.quests.awards.additional.bottom(), { count: l - Ha + 1 }),
                                tooltipArgs: {
    ...
    Wa = { periodicIcon: qa.rewardTimer, info: qa.rewardInfo },
    ...
    os = a(() => {
        ...
        return (
            ...
            s.jsxs(qe, {
                children: [
                    s.jsx(ra, { bgImage: R.images.comp7.gui.maps.icons.backgrounds.yearly_rewards_screen_bg() }),
                    s.jsxs(ea, {
    ...
    xs = 'SeasonResult_animatedContainer_60dea867',
    Ss = 'SeasonResult_rank_558c76da',
        ...
        return s.jsxs('div', {
            ...
            children: [
                s.jsxs('div', {
                    ...
                    children: [
                        o
                            ? s.jsx(ee, { size: Is, seasonName: i, className: Ss })
                            : s.jsx(Y, { rank: t, size: Is, seasonName: i, className: Ss }),
                        s.jsxs('div', {
                            className: ks,
                            children: [
    ...
    Ks = { steps: [zs.ShowHeader, zs.ShowPoints, zs.ShowContent, zs.ShowCrew, zs.ShowButtons], autoStart: !1 },
    ...
    rn = a(() => {
        ...
        return (
            ...
            s.jsxs(qe, {
                ...
                classNames: { closeButton: qs.close },
                children: [
                    s.jsx('div', { className: qs.background, children: s.jsx(nn, { rank: o, playerRef: l }) }),
                    s.jsxs('div', {
                        className: qs.content,
                        children: [
                            s.jsx(gs, { className: qs.header }),
