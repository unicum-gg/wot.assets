...
const I = 500,
    ...
    Y = 'DifficultyCongratulationApp_reward_ccc9cf18',
    Z = 'DifficultyCongratulationApp_closeBtn_ec8e894',
...
const J = t.resolve('strings'),
    Q = s(function () {
        ...
        return a.jsxs('div', {
            ...
            children: [
                a.jsx(f, { className: Z, onClose: i.close }),
                a.jsxs('div', {
                    className: W,
                    children: [
                        a.jsx(j, {
                        ...
                        a.jsx(j, {
                            ...
                            children: a.jsx(m, {
                                ...
                                text: J.readOrEmpty(`R.strings.last_stand_lobby.difficultyWindow.header.level_${t}`),
                            }),
                        }),
                        a.jsx(j, {
                            ...k[S.DESCRIPTION],
