...
import { g as K, a as O, c as J, d as U, b as X, e as Y } from '../../../chunks/utils.js';
import { S as Z } from '../../../chunks/story_point.js';
const [q, G] = l('BundleCardProvider')(
...
const Ae = r(function () {
    ...
    Ie = r(function () {
        const { model: e } = te(),
            ...
            t = a?.cost,
            i = f({ size: Z.sizes.s16x16 }, { medium: { size: Z.sizes.s24x24 } }),
            ...
            children: e.computes.progressionCompleted()
                ...
                : s.jsx(y, {
                      ...
                      binding: {
                          ...
                          currentProgress: s.jsx('div', { className: Ne, children: Y(e.points.get(), t) }),
                          maxProgress: t,
                          icon: s.jsx('div', { ...o, className: we, children: s.jsx(Z, { size: i.size }) }),
                      },
                  }),
        });
    }),
...
function We(e) {
    ...
    return s.jsx(w, { id: a, children: s.jsx(q, { options: t, children: s.jsx(Le, { ...e }) }) });
}
const Ke = 'DailyQuestsCard_8452735',
    ...
    Ye = 'DailyQuestsCard_base__completed_2dd05187',
    Ze = 'DailyQuestsCard_progress_a181f69d',
    qe = 'DailyQuestsCard_currentProgress_a63d05d7',
    Ge = 'DailyQuestsCard_progressValue_59475865',
                              ...
                              s.jsxs('div', {
                                  ...
                                  children: [
                                      s.jsx(y, {
                                          ...
                                          binding: {
                                              value: s.jsx('div', { className: qe, children: z(c, 1) }),
                                              maxValue: z(d, 1),
                                          },
                                      }),
                                      s.jsx(x, {
...
M(
    new S()
        ...
        .add(ae)
        .addWithProps(q, { options: { rootId: R.aliases.last_stand.shared.BundleCard('resId') } })
