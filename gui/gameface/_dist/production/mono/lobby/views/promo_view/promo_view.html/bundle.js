...
const $ = 1e3,
    ...
    F = 'ContainerAnimation_base__started_448f44b3',
    G = (e) => (e < 0.5 ? 4 * e * e * e : (e - 1) * (2 * e - 2) * (2 * e - 2) + 1),
    I = (e, s, a, t) => (a ? t.width / e : t.height / s),
    K = e.memo(function ({
        isStarted: r,
        scaleCover: i,
        screenWidth: d,
            ...
            e.useEffect(() => {
                r &&
                    f.start({
                        to: [
                            {
                                transform: `scale(${I(d, l, h, { width: l * B * 0.6, height: (d / B) * 0.6 })})`,
                                x: 0,
                                y: 0,
                                opacity: 1,
                                config: { duration: 800 },
    ...
    Y = 'PromoApp_vignetteBg_3b32fdde',
