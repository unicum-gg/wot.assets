...
import { u as ta, S as ra } from '../../../chunks/schedule_model.js';
import { M as ia, R as na, S as oa, a as ca, b as da } from '../../../chunks/enums.js';
import { P as la } from '../../../chunks/consts.js';
import { g as _a } from '../../../chunks/get_button_size.js';
import { R as ma, a as ua, i as ha, g as ga } from '../../../chunks/rank_emblem.js';
import { g as pa, R as xa, a as ba, b as fa } from '../../../chunks/get_rank_name.js';
import { S as va, g as Sa } from '../../../chunks/schedule_subheading.js';
import { g as ja, a as wa } from '../../../chunks/get_division_name.js';
import { S as Na, g as Ca } from '../../../chunks/get_division_points_step.js';
import { D as ka } from '../../../chunks/divine_glow.js';
import { P as Pa } from '../../../chunks/index.js';
import { A as Ra } from '../../../chunks/arrow_button.js';
import { D as Ia } from '../../../chunks/diff.js';
import { F as ya } from '../../../chunks/formatted_statistic_value.js';
import { Q as Aa } from '../../../chunks/qualification_emblem.js';
import { g as Ba, N as Ta, f as Da } from '../../../chunks/get_statistic_value.js';
import { V as La, a as Ea } from '../../../chunks/vehicle_name.js';
import { Q as za } from '../../../chunks/qualification_battle_item.js';
import { g as Ma, m as Wa } from '../../../chunks/get_comp7_reward.js';
import { P as Va, a as Ha, Q as Qa } from '../../../chunks/quoted_locale.js';
import { Q as Ua, C as $a } from '../../../chunks/weekly_quests_model.js';
import { c as qa } from '../../../chunks/animation_api_factory.js';
import { S as Oa, a as Fa } from '../../../chunks/season_point.js';
import { S as Ya } from '../../../chunks/season_model.js';
import { L as Ga } from '../../../chunks/lace_divider.js';
...
const Xa = {
    ...
    Ka = ({ isHover: s, size: t, disabled: r = !1 }) =>
        e.jsx('div', {
            ...
            children: r
                ? e.jsx('div', { className: Xa.bgDisabled })
                : e.jsxs(e.Fragment, {
                      children: [e.jsx('div', { className: Xa.bg }), e.jsx('div', { className: Xa.bgHover })],
                  }),
        }),
    Ja = {
    ...
    Za = ({ isHover: s, size: t, disabled: r = !1 }) =>
        e.jsx('div', {
            className: a(Ja.base, Ja[`base__${t}`], s && Ja.base__hovered),
            children: r
                ? e.jsx('div', { className: Ja.borderDisabled })
                : e.jsxs(e.Fragment, {
                      children: [e.jsx('div', { className: Ja.border }), e.jsx('div', { className: Ja.borderHover })],
                  }),
        }),
    es = {
...
var as = ((e) => ((e.Small = 'small'), (e.Big = 'big'), e))(as || {});
const ss = ({ count: t, disabled: r = !1, size: i, onClick: n }) => {
        ...
        return e.jsx(p, {
            body: d,
            children: e.jsxs('div', {
                className: a(es.base, es[`base__${i}`], r ? es.base__disabled : es.base__hasAppearAnimation),
                onMouseEnter: () => {
                ...
                children: [
                    e.jsx(Za, { size: i, isHover: o, disabled: r }),
                    e.jsx(Ka, { size: i, isHover: o, disabled: r }),
                    e.jsx('div', { className: es.icon }),
                    e.jsx('div', { className: es.count, children: e.jsx(x, { format: 'integral', value: t }) }),
                    e.jsx('div', { className: es.label, children: R.strings.comp7_ext.awardsWidget.title(t) }),
                    !r &&
                        e.jsxs(e.Fragment, {
                            children: [
                                e.jsx('div', { className: a(es.shine, es.shine__left) }),
                                e.jsx('div', { className: a(es.shine, es.shine__right) }),
                                e.jsx('div', { className: es.arrow }),
                                e.jsx('div', {
                                    className: es.blinkShape,
                                    children: e.jsx('div', { className: es.blink }),
                                }),
                            ],
                        }),
                ],
    ...
    is = {
        [ia.Progression]: 'progression',
        [ia.RankRewards]: 'rankRewards',
        [ia.WeeklyQuests]: 'weeklyQuests',
        [ia.Leaderboard]: 'leaderboard',
        [ia.YearlyRewards]: 'yearlyRewards',
        [ia.Shop]: 'shop',
        [ia.YearlyStatistics]: 'yearlyStatistics',
    },
    ns = {
    ...
    [os, cs] = w()(
        ({ observableModel: e }) => {
            const a = { root: e.object(), claimRewardsModel: e.object('claimRewardsModel') },
                ...
                r = t(() => a.root.get().pageViewId === ia.Progression && s.get().isActive);
    ...
    ds = R.images.comp7.gui.maps.icons.metaTabs,
    ls = (e, a) => {
        const s = is[e];
        return a ? `${ds.$dyn(s)}` : `${ds.small.$dyn(s)}`;
    },
    [_s, ms] = w()(
        ({ observableModel: e }) => {
    ...
    us = R.strings.comp7_ext.sidebar.tabs.tooltip,
    hs = ({ children: a, id: s }) => {
        const t = is[s];
        return e.jsx(p, { header: `${us.header.$dyn(t)}`, body: `${us.body.$dyn(t)}`, children: a });
    },
    gs = 'Tabs_icon_8dfa0155',
    ps = 'Tabs_icon__medium_bec6a176',
    xs = r(({ pageView: t, className: r }) => {
        const { model: i, controls: n } = ms(),
            o = rs(),
        ...
        return e.jsx(k, {
            ...
            size: o.size,
            className: r,
            classNames: { icon: a(gs, o.isMedium && ps) },
            WrapperElement: hs,
        });
    });
var bs = ((e) => ((e[(e.Initial = 0)] = 'Initial'), (e[(e.Success = 1)] = 'Success'), (e[(e.Error = 2)] = 'Error'), e))(
    bs || {},
);
const fs = 'ErrorState_3a925db8',
    vs = 'ErrorState_gears_3117ef8b',
    Ss = 'ErrorState_title_438c797b',
    ...
    ws = ({
        ...
        e.jsxs('div', {
            className: a(fs, s),
            children: [
                e.jsx('div', { className: a(vs, t?.gears) }),
                e.jsx('div', { className: a(Ss, t?.title), children: r }),
                e.jsx('div', { className: a(js, t?.description), children: i }),
                n,
            ],
        }),
    [Ns, Cs] = w()(
    ...
    Ps = 'ErrorState_buttonWrapper_7130f1d1',
    Rs = 'ErrorState_button_3b8b6fd9',
    Is = r(({ className: s }) => {
        const { model: t, controls: r } = Cs(),
...
var As = ((e) => ((e.None = 'None'), (e.Active = 'Active'), e))(As || {});
const Bs = { None: 'none', Active: 'active' },
    Ts = r(({ state: s, height: t, onClick: r, className: i }) => {
        const { model: n } = Cs(),
            { personalPosition: o, personalBattlesCount: c, personalScore: d } = n.root.get();
        return e.jsxs('div', {
            className: a(ys.base, ys[`base__${Bs[s]}`], i),
            onClick: r,
            style: { '--height': t ? `${t}rem` : 'auto' },
            children: [
                e.jsx('div', { className: a(ys.screwIcon, ys.screwIcon__left) }),
                {
                    None: e.jsx('div', {
                        className: a(ys.cell),
                    ...
                    Active: e.jsxs(e.Fragment, {
                        children: [
                            e.jsx('div', { className: a(ys.cell, ys.cell__order), children: o + 1 }),
                            e.jsx('div', {
                                className: a(ys.cell, ys.cell__currentPosition),
                                children: R.strings.comp7_ext.leaderboard.currentPosition.body(),
                            }),
                            e.jsx('div', { className: a(ys.cell, ys.cell__battles), children: e.jsx(x, { value: c }) }),
                            e.jsx('div', { className: a(ys.cell, ys.cell__score), children: e.jsx(x, { value: d }) }),
                        ],
                    }),
                }[s],
                e.jsx('div', { className: a(ys.screwIcon, ys.screwIcon__right) }),
            ],
        });
    }),
    Ds = 'RowsDivider_5e67d3df',
    Ls = 'RowsDivider_rankText_d814efd9',
    Es = r(({ index: s, className: t, onClick: r }) => {
        const { model: i } = Cs(),
            { model: n } = ta(),
        ...
        return e.jsxs('div', {
            ...
            onClick: r,
            children: [
                e.jsx(ma, { seasonName: n.season.name.get(), rank: o, size: ua.x64 }),
                e.jsx('div', { className: Ls, children: pa(o) }),
            ],
        });
    }),
    zs = 'Header_4ab794c6',
    Ms = 'Header_separator_510e8c90',
    Ws = 'Header_cell_ae11a84e',
    Vs = 'Header_cell__order_8c3c2448',
    Hs = 'Header_cell__player_4feb9cb9',
    ...
    $s = ({ children: a, isEnabled: s, contextMenuArgs: t }) => (s ? e.jsx(y, { args: t, children: a }) : a),
    qs = {
        base: 'Row_c0c9eb7f',
    ...
    Os = { 0: 'first', 1: 'second', 2: 'third' },
    Fs = r(({ index: s, className: t }) => {
        const { model: r } = Cs(),
            {
                position: i,
                battlesCount: n,
        ...
        return e.jsxs('div', {
            ...
            children: [
                e.jsx(p, {
                    ...
                    body: R.strings.comp7_ext.leaderboard.table.tooltip.order.body(),
                    children: e.jsx('div', {
                        className: a(qs.order, u && qs[`order__${Os[i]}`]),
                        children: !u && i + 1,
                    }),
                }),
                e.jsx($s, {
    ...
    Gs = 'Leaderboard_content_22252fe0',
    Xs = 'Leaderboard_shadowsContainer_676cb358',
    Ks = 'Leaderboard_shadowsContainer__bottom_592c0d95',
    Js = 'Leaderboard_shadow_5e1e6caa',
    Zs = 'Leaderboard_shadow__left_e19dd6f3',
    et = 'Leaderboard_shadow__center_3661a2a7',
    at = 'Leaderboard_shadow__right_e3bc83fc',
    st = 'Leaderboard_area_ba84a652',
    tt = 'Leaderboard_row_4ed6f164',
    rt = 'Leaderboard_rowsDivider_32196381',
    it = r(({ limit: s, rowHeight: t = 0, rowsDividerHeight: r = 0 }) => {
        const { model: i } = Cs(),
                ...
                e.jsxs('div', {
                    ...
                    children: [
                        e.jsxs('div', {
                            className: Xs,
                            children: [
                                e.jsx('div', { className: a(Js, Zs) }),
                                e.jsx('div', { className: a(Js, et) }),
                                e.jsx('div', { className: a(Js, at) }),
                            ],
                        }),
                        e.jsx(B, {
                            className: st,
                            children: T(i.items.get().length, (a) =>
                                e.jsxs(
                                    ...
                                    {
                                        children: [
                                            o && a === c && e.jsx(Es, { index: a, className: rt }),
                                            e.jsx(Fs, { className: tt, index: a }),
                                        ],
                                    },
                                    a,
                                ),
    ...
    ot = Math.trunc(4),
    ct = ({ pagesAmount: s, activePage: t, className: r, onPageClick: i, onControlEvent: n }) => {
        const o = t > 1,
            c = t < s,
            d = s < 9 ? s : 9,
            l = (e) => () => {
        ...
        return e.jsxs('div', {
            className: a(nt.base, r),
            children: [
                e.jsx('div', {
                    className: a(nt.control, nt.control__prev, o && nt.control__active),
                ...
                T(d, (r) => {
                    ...
                    return e.jsx(
                        'div',
                        {
                            className: a(nt.pageButton, nt[`pageButton__${o}`]),
                            onClick:
                                'disabled' !== o && 'number' == typeof n
                                    ...
                                    : void 0,
                            children: e.jsx('div', { className: nt.pageValue, children: n }),
                        },
                        r,
                    );
                    var c;
                ...
                e.jsx('div', {
                    className: a(nt.control, nt.control__next, c && nt.control__active),
    ...
    dt = 'HasRecordsState_c43fe3c6',
    lt = 'HasRecordsState_base__withoutPagination_ff6833d8',
    _t = 'HasRecordsState_tableContainer_e5526099',
    mt = 'HasRecordsState_pagination_26230442',
    ut = { settings: { ...L, animationConfig: { ...L.animationConfig, round: 1 } } },
    ht = r(
        ({ limit: t, onCurrentRankTabChange: r, positionToScroll: i, onPositionToScrollChange: n, className: o }) => {
            const { model: c, controls: d } = Cs(),
                ...
                x = c.computes.isDefaultPersonalPosition() ? As.None : As.Active,
            ...
            const N = s.useCallback(() => {
                const e = v.first > _ ? na.Fifth : na.Sixth;
                r(e);
            }, [v.first, _, r]);
            (s.useEffect(() => {
                N();
                ...
                s.useEffect(() => {
                    const e = () => {
                        if (j && S > v.first) {
                            const [, e] = p(),
                                a = 0 !== e && u.goal === e && w >= e;
                            r(u.goal >= w || a ? na.Fifth : na.Sixth);
                        } else l >= v.first && l <= v.last ? r(l > _ ? na.Fifth : na.Sixth) : N();
                    };
                    return (g.on('change', e), () => g.off('change', e));
                }, [g, v.first, j, _, v.last, t, l, w, S, u.goal, r, N, p]));
            const C = s.useCallback(() => {
                    x !== As.None && (b.yes1(), d.getTableRecords(t, l - (l % t)), n({ type: 'personalPosition' }));
                }, [d, t, x, l, n]),
                k = s.useCallback(
                    (e) => {
            ...
            return e.jsxs('div', {
                className: a(dt, !f.hasPagination && lt, o),
                children: [
                    e.jsx('div', {
                        className: _t,
                        children: e.jsx(W, {
                            api: m,
                            children: e.jsx(it, { limit: t, rowHeight: 44, rowsDividerHeight: 70 }),
                        }),
                    }),
                    e.jsx(Ts, { state: x, onClick: C, height: 44 }),
                    f.hasPagination &&
                        e.jsx(ct, {
    ...
    gt = R.views.comp7.mono.lobby.tooltips,
    pt = ({ rank: a, divisions: s, from: t, to: r, topPercentage: i, children: n, className: o, ...c }) => {
        const d = (({ rank: e, topPercentage: a, from: s, to: t, divisions: r = '' }) => {
            switch (e) {
                case na.Sixth:
                    return { contentId: gt.sixth_rank_tooltip('resId'), args: { topPercentage: a } };
                case na.Fifth:
                    return { contentId: gt.fifth_rank_tooltip('resId'), args: { from: s } };
                default:
                    return {
                        contentId: gt.general_rank_tooltip('resId'),
...
var xt = ((e) => ((e.Active = 'active'), (e.Inactive = 'inactive'), (e.Disabled = 'disabled'), e))(xt || {});
const bt = {
    ...
    ft = ({ tabs: s, seasonName: t, className: r, onTabClick: i }) => {
        const n = (e) => () => {
            i?.(e);
        };
        return e.jsxs('div', {
            className: a(bt.base, r),
            children: [
                e.jsx('div', { className: bt.dividersDot }),
                e.jsx('div', { className: a(bt.line, bt.line__toRight) }),
                e.jsx('div', {
                    className: bt.ranksContainer,
                    children: s.map(({ rank: s, state: r, args: i = {} }) => {
                        const o = r !== xt.Disabled;
                        return e.jsxs(
                            'div',
                            {
                                className: a(bt.rank, bt[`rank__${r}`]),
                                children: [
                                    e.jsxs(pt, {
                                        rank: s,
                                        from: i?.from,
                                        topPercentage: i?.topPercentage,
                                        onClick: o ? n(s) : void 0,
                                        onMouseEnter: o ? b.highlight : void 0,
                                        children: [
                                            e.jsx('div', { className: bt.rankTabHighlight }),
                                            e.jsx(ma, {
                                                seasonName: t,
                                                rank: s,
                                                size: ua.x64,
                                                className: bt.rankEmblem,
                                            }),
                                        ],
                                    }),
                                    r !== xt.Disabled && e.jsx('div', { className: bt.label, children: pa(s) }),
                                ],
                            },
                            s,
                        );
                ...
                e.jsx('div', { className: a(bt.line, bt.line__toLeft) }),
            ],
        });
    },
    vt = ({ rank: e, lastBestUserPosition: a, currentRankTab: s, recordsCount: t }) =>
        (e === na.Sixth && -1 === a) || 0 === t ? xt.Disabled : e === s ? xt.Active : xt.Inactive,
    St = 'HasRecordsStateContainer_c67207b9',
    jt = 'HasRecordsStateContainer_content_6298db9',
    wt = [na.Sixth, na.Fifth],
    Nt = r(({ className: t }) => {
        const { model: r, controls: i } = Cs(),
            { model: n } = ta(),
            ...
            x = wt.map((e) => ({
                rank: e,
                state: vt({ rank: e, lastBestUserPosition: o, currentRankTab: u, recordsCount: c }),
                args: { from: d, topPercentage: l },
            })),
            f = s.useCallback(
                (e) => {
                    const a = e === na.Fifth && _ ? m - (m % 50) : 0;
        ...
        return e.jsxs('div', {
            className: a(St, t),
            children: [
                e.jsx(ft, { tabs: x, seasonName: n.season.name.get(), onTabClick: f }),
                e.jsx(ht, {
                    limit: 50,
                    positionToScroll: g,
    ...
    kt = r(({ className: s }) => {
        const { model: t } = Cs(),
            ...
            { model: i } = ta();
        return e.jsxs('div', {
            className: a(Ct.base, s),
            children: [
                e.jsx('div', {
                    className: Ct.imageContainer,
                    children: e.jsx('div', { className: a(Ct.image, Ct[`image__season_${i.season.name.get()}`]) }),
                }),
                e.jsx('div', { className: Ct.title, children: R.strings.comp7_ext.leaderboard.noRecords.title() }),
                e.jsx(H, {
                    text: R.strings.comp7_ext.leaderboard.noRecords.subtitle(),
                    binding: { pointsCount: e.jsx(x, { value: r }) },
                    classMix: Ct.subtitle,
                }),
            ],
        });
    }),
    Pt = Q(R.strings.comp7_ext.lastUpdateNote.lastBestUserPoints.description(), { count: 5 }),
    Rt = 'LastUpdateNote_6d3d7bea',
    It = 'LastUpdateNote_infoIcon_e0adf03b',
    yt = ({
        timestamp: s,
        className: t,
        classNames: r,
        ...
        e.jsxs('div', {
            ...
            children: [
                ...
                e.jsx(V, {
                    ...
                    args: { description: o },
                    ...c,
                    children: e.jsx('div', { className: a(It, r?.icon) }),
                }),
            ],
        }),
    At = 'SubheadingContainer_c1ac09ea',
    Bt = 'SubheadingContainer_updateInfo_d86a6c67',
    Tt = 'SubheadingContainer_updateInfoText_8739d0a',
    Dt = r(({ className: s }) => {
        const { model: t } = Cs(),
        ...
        return e.jsxs('div', {
            ...
            children: [
                ...
                i &&
                    e.jsx('div', {
                        className: Bt,
                        children: e.jsx(yt, { timestamp: r, className: Tt, tooltipDescription: n }),
                    }),
            ],
        });
    }),
    ...
    Et = { [bs.Initial]: 'initial', [bs.Success]: 'success', [bs.Error]: 'error' },
    zt = r(() => {
        const { model: s } = Cs(),
            { state: t, isLoading: r } = s.root.get(),
            i = o(la);
        return e.jsxs('div', {
            className: a(Lt.base, Lt[`base__${Et[t]}`], r && Lt.base__loading),
            'data-test-id': 'leaderboard-page',
            children: [
                e.jsx(Dt, { className: Lt.subHeading }),
                e.jsxs(c.div, {
                    className: Lt.animationContainer,
                    style: i,
                    children: [
                        e.jsx('div', {
                                ...
                                switch (t) {
                                    ...
                                    case bs.Success:
                                        return s.items.get().length > 0
                                            ? e.jsx(Nt, { className: Lt.hasRecords })
                                            : e.jsx(kt, { className: Lt.noRecords });
                                    case bs.Error:
                                        return e.jsx(Is, { className: Lt.error });
                                    default:
                                        console.error('Unreachable branch: add component for proper leaderboard state');
                                }
                            })(),
                        }),
                        r && e.jsx(O, { message: R.strings.comp7_ext.waitingSpinner.message(), className: Lt.spinner }),
                    ],
                }),
            ],
        });
    }),
    Mt = (e) => C(e, (e) => ja(e.name)).join(R.strings.comp7_ext.listSeparator()),
    Wt = -1;
var Vt = ((e) => ((e[(e.Initial = 0)] = 'Initial'), (e[(e.Success = 1)] = 'Success'), (e[(e.Error = 2)] = 'Error'), e))(
    Vt || {},
);
const [Ht, Qt] = w()(
        ({ observableModel: e }) => {
                ...
                n = t(
                    (e) => {
                        ...
                        return {
                            list: Mt(a),
                            count: a.length,
                            currentDivisionIndex: F(a, (e) => e.state === Na.Current),
                        };
                    },
                    { equals: i.shallow },
                ),
                o = t((e) => ({ division: Y(r(e), (e) => e.state === Na.Current)?.name, hasInfo: !ha(s(e).rank) }), {
                    equals: i.shallow,
                }),
                c = t(
                    (e) => {
            ...
            children: Ut.map((a, s) =>
                e.jsx(
                    c.div,
                    {
                        ...
                        children: 3 === s && e.jsx(c.div, { className: Ot, style: l }),
                    },
                    s,
                ),
            ),
    ...
    Jt = r(({ className: t }) => {
        ...
        return (
            ...
            e.jsx(c.div, { className: a(Xt, t), style: d, children: e.jsx(Gt, {}) })
        );
    }),
    Zt = {
        base: 'Bar_d3cdbf54',
...
const er = ({
        ...
        const d = a(
            Zt.base,
            t && Zt.base__fluid,
            !r && Zt.base__noBattles,
            n !== Wt && e !== n && Zt.base__muted,
            e === n && Zt.base__selected,
        );
        return o
            ? a(d, Zt.base__qualification, c)
            : e <= s && i > 0
              ? a(d, Zt.base__rank, Zt[`base__rank_${xa[i]}`], c)
              : a(d, Zt.base__noRank, c);
    },
    ar = r(function ({ index: s, heightRem: t, isSelected: r }) {
        const { model: i } = Qt(),
        ...
        return (
            ...
            e.jsxs(e.Fragment, {
                children: [
                    e.jsx(c.div, {
                        className: a(Zt.topShadow, r && Zt.topShadow__selected),
                        style: { bottom: g, ...b },
                    }),
                    e.jsx(c.div, { className: Zt.topLine, style: x }),
                    e.jsxs(
                        c.div,
                        {
                            className: Zt.barContainer,
                            style: p,
                            children: [
                                e.jsx('div', { className: Zt.bar }),
                                n
                                    ? e.jsxs(e.Fragment, {
                                          children: [
                                              e.jsx('div', { className: Zt.light }),
                                              e.jsx('div', { className: Zt.sharp }),
                                          ],
                                      })
                                    : e.jsx('div', { className: Zt.hatch }),
                            ],
                        },
                        `barContainer_${s}_${r}`,
                    ),
    ...
    sr = r(function ({ index: a }) {
        const { model: s } = Qt(),
            { hasBattles: t } = s.computes.dayStatistics(a);
        return e.jsxs(e.Fragment, {
            children: [
                t
                    ? e.jsx('div', { className: Zt.qualificationBg })
                    : e.jsx('div', { className: Zt.qualificationHatch }),
                e.jsx('div', { className: Zt.qualificationIcon }),
            ],
        });
    }),
    tr = r(function ({ index: a, heightRem: s, isInitialAnimation: t }) {
        const { model: r } = Qt(),
        ...
        return (
            u([d, n], t ? [0, 1] : [0, 0]),
            e.jsxs(c.div, {
                className: Zt.selectedFrame,
                style: l,
                children: [
                    e.jsx(c.div, { className: Zt.selectedLeftLine, style: m }),
                    e.jsx(c.div, { className: Zt.selectedRightLine, style: m }),
                    e.jsx('div', {
                        className: Zt.selectedTopLine,
                        style: !i && s > 5 ? { bottom: s - 1 + 'rem' } : { display: 'none' },
                    }),
                    e.jsx('div', { className: Zt.selectedBottomLine }),
                ],
            })
        );
    }),
                ...
                return e.jsx(V, {
                    ...
                    children: e.jsx('div', {
                        ...
                        children: e.jsxs('div', {
                            className: Zt.inner,
                            children: [
                                e.jsx('div', { className: Zt.holder }),
                                e.jsx('div', {
                                    className: Zt.layersContainer,
                                    children: u
                                        ? e.jsx(sr, { index: a })
                                        : e.jsx(ar, { index: a, heightRem: w, isSelected: N }),
                                }),
                                N && e.jsx(tr, { index: a, heightRem: w, isInitialAnimation: C }),
                            ],
                        }),
                    }),
                });
    ...
    ir = 'ChartScroll_10e4d55',
    nr = 'ChartScroll_areaWrapper_58c1069e',
    or = 'ChartScroll_areaContent_ccca9fa5';
function cr({ children: a, api: s, ...t }) {
    return e.jsx(ae, { api: s, children: e.jsx(dr, { ...t, children: a }) });
}
function dr({ itemsOffset: s = 0, children: t, className: r, areaClassNames: i, barClassNames: n, style: o }) {
    return e.jsxs('div', {
        className: a(ir, r),
        ...
        children: [
            e.jsx(se, {
                className: i?.base,
                classNames: { wrapper: a(nr, i?.wrapper), content: a(or, i?.content) },
                children: t,
            }),
...
const lr = 'Chart_8bf3ed9a',
    _r = 'Chart_base__hasScroll_b9b95413',
    mr = (e, a) => () => {
        e || (a(), b.sound('arrow'), b.sound('comp_7_gui_chart_select'));
    },
    ur = { wrapper: 'Chart_areaWrapper_1478348e', content: 'Chart_areaContent_2fe4c7ee' },
    hr = { base: 'Chart_bar_df3ebe0c' },
    gr = r(({ width: t, className: r }) => {
        const { model: i, controls: n } = Qt(),
        ...
        const j = s.useCallback(
            ...
            w = s.useCallback(() => {
                (n.selectDay(Wt), b.click());
            }, [n]),
            N = oe((e) => {
                const a = l.wrapperRef.current?.getBoundingClientRect(),
    ...
    pr = 'Separator_714453d5',
    xr = 'Separator_line_a7ffd056',
    br = 'Separator_venzel_5f6e04a2',
    fr = ({ className: a }) =>
        e.jsxs('div', {
            className: h(pr, a),
            children: [e.jsx('div', { className: xr }), e.jsx('div', { className: br })],
        }),
    vr = [];
function Sr(e) {
    const [a, t] = s.useState(!1),
        r = (function (e) {
            ...
            return (
                ...
                s.useCallback((...e) => (0, a.current)(...e), vr)
            );
        })(() => {
            (t(!0), e());
        });
...
const jr = 'LoadingSpinner_13d3cf96',
    wr = 'LoadingSpinner_base__loading_2e28c0b5',
    Nr = function ({ loading: a, className: s }) {
        return e.jsx('div', { className: h(jr, a && wr, s) });
    },
    Cr = 'ChartHeader_a57c6360',
    kr = 'ChartHeader_heading_44e48769',
    Pr = 'ChartHeader_generalStatistics_5111bfe9',
    Rr = 'ChartHeader_generalStatistics__clickable_c9c7aa1d',
    Ir = 'ChartHeader_generalStatisticsText_64eed80c',
    yr = 'ChartHeader_icon_9956b8a5',
    Ar = 'ChartHeader_separator_86596e18',
    Br = 'ChartHeader_dailyStatistic_cc6b42c9',
    Tr = 'ChartHeader_dailyStatistic__visible_259ce014',
    Dr = 'ChartHeader_update_90744a3e',
    Lr = 'ChartHeader_updateText_594e621b',
    Er = 'ChartHeader_infoIcon_84a3a650',
    zr = 'ChartHeader_infoIcon__daily_f5e8856e',
    Mr = 'ChartHeader_venzelSeparator_3a7df730',
    Wr = 'ChartHeader_spinner_5688475e',
    Vr = 'ChartHeader_button_53d907eb',
    Hr = r(function () {
        ...
        return e.jsxs('div', {
            ...
            children: [
                e.jsx(U, {
                    ...
                    binding: {
                        ...
                        info: e.jsx(p, {
                            ...
                            children: e.jsx('div', { className: Er }),
                        }),
                    },
                    classMix: Lr,
                }),
                e.jsx(I, {
                    ...
                    className: Vr,
                    children: e.jsx(Nr, { loading: r, className: Wr }),
                }),
            ],
        });
    }),
    Qr = r(function ({ className: s }) {
            ...
            children: [
                e.jsxs('div', {
                    ...
                    children: [
                        e.jsxs('div', {
                            className: a(Pr, c && Rr),
                            onClick: c ? () => r.selectDay(Wt) : void 0,
                            onMouseEnter: c ? b.highlight : void 0,
                            children: [
                                e.jsx('div', { className: yr }),
                                e.jsx('div', {
                                    className: Ir,
                                    children: String(
                        ...
                        e.jsxs('div', {
                            ...
                            children: [
                                ...
                                e.jsx(p, {
                                    ...
                                    children: e.jsx('div', { className: a(Er, zr) }),
                                }),
                            ],
                        }),
                        e.jsx(Hr, {}),
                ...
                e.jsx(fr, { className: Mr }),
            ],
        });
    }),
    Ur = 'LastUpdate_ea4456f',
    $r = 'LastUpdate_dataUpdate_4273867c',
    qr = ({ timestamp: s, className: t, isLastBestUserPointsValueLoading: r = !1 }) =>
        e.jsx('div', {
            className: a(Ur, t),
            children: r
                ? e.jsx(U, { text: R.strings.comp7_ext.lastUpdateNote.lastBestUserPoints.update(), classMix: $r })
                : e.jsx(yt, { timestamp: s }),
        }),
    Or = (e, a) => e > 0 || a,
    Fr = 'RankInfo_d0b952ed',
    Yr = 'RankInfo_highlight_23f2f1b1',
    Gr = 'RankInfo_formattedText_6a63affe',
    Xr = ({ rank: s, from: t, topPercentage: r, className: i, classNames: n }) =>
        e.jsxs('div', {
            className: a(Fr, i),
            children: [
                e.jsx('div', { className: Yr }),
                e.jsx(H, {
                    text: String(R.strings.comp7_ext.rankInfo.current.$dyn(ga(s))),
                    binding: { topPercentage: r, fromScore: e.jsx(x, { value: t }) },
                    classMix: a(Gr, n?.text),
                }),
            ],
        }),
    Kr = ({ rank: a, division: s, from: t, to: r, className: i, children: n }) =>
        e.jsx(V, {
    ...
    Jr = 'RankProgressDivisions_db142f88',
    Zr = 'RankProgressDivisions_divisionItem_5be72f57',
    ei = 'RankProgressDivisions_divisionItem__current_6ced0f10',
    ai = 'RankProgressDivisions_highlightContainer_70c42138',
    si = 'RankProgressDivisions_radialBack_57eba5b8',
    ti = 'RankProgressDivisions_mainBack_8fe6b2d0',
    ri = 'RankProgressDivisions_bottomLine_60e68b1c',
    ii = 'RankProgressDivisions_bottomLine__first_cd7ca41d',
    ni = 'RankProgressDivisions_bottomLine__second_787c2960',
    oi = 'RankProgressDivisions_bottomLine__third_b38a7c3b',
    ci = 'RankProgressDivisions_container_a9b2b1f0',
    di = 'RankProgressDivisions_divisionName_bce75f3f',
    li = 'RankProgressDivisions_note_5ffe2513',
    _i = r(({ itemIndex: s, rank: t, from: r, step: i }) => {
        const { model: n } = Qt(),
            o = n.computes.divisions(s);
        return e.jsx('div', {
            className: Jr,
            children: C(o, (s, n) => {
                const o = s.state === Na.Current;
                return e.jsxs(
                    Kr,
                    {
                        rank: t,
                        ...
                        children: [
                            o &&
                                e.jsxs('div', {
                                    className: ai,
                                    children: [
                                        e.jsx('div', { className: si }),
                                        e.jsx('div', { className: ti }),
                                        e.jsx('div', { className: a(ri, ii) }),
                                        e.jsx('div', { className: a(ri, ni) }),
                                        e.jsx('div', { className: a(ri, oi) }),
                                    ],
                                }),
                            e.jsxs('div', {
                                className: ci,
                                children: [
                                    o && e.jsx('div', { className: li, children: R.strings.comp7_ext.division.note() }),
                                    e.jsx('div', { className: di, children: ja(s.name) }),
                                ],
                            }),
                        ],
                    },
...
var ui = ((e) => ((e.Top = 'top'), (e.Bottom = 'bottom'), e))(ui || {});
const hi = (e, a) => {
        const s = a > 0 ? (100 / a) * e + '%' : '0%';
        return e === a ? { left: s, transform: `translateX(-${mi['--pointLineWidth']})` } : { left: s };
    },
    gi = ({ step: s, divisionsCount: t, from: r, currentDivisionIndex: i, direction: n = 'bottom', className: o }) =>
        e.jsx('div', {
            className: a(mi.base, mi[`base__${n}`], o),
            children: T(t + 1, (n) => {
                ...
                return e.jsxs(
                    'div',
                    {
                        ...
                        style: hi(n, t),
                        children: [
                            e.jsx('div', { className: mi.pointLine }),
                            void 0 !== r &&
                                e.jsx('div', {
                                    className: a(mi.pointValue, o && mi.pointValue__next),
                                    children: r + s * n,
                                }),
                        ],
                    },
    ...
    vi = r(({ rank: s, itemIndex: t, from: r, to: i, className: n }) => {
        const { model: o } = Qt(),
        ...
        return e.jsxs('div', {
            className: a(pi, n),
            children: [
                e.jsx(_i, { itemIndex: t, rank: s, from: r, step: _ }),
                e.jsx(gi, {
                    step: _,
                ...
                e.jsx('div', {
                    className: bi,
                    children: e.jsx(Pa, { maxValue: l, value: c - r, animationSettings: fi }),
                }),
                e.jsx(gi, {
                    step: _,
                    divisionsCount: d.count,
    ...
    Si = 'RankStatusDescription_9595d0d5',
    ji = ({ text: s, binding: t, className: r }) => {
        const i = ((a) =>
            'number' == typeof a?.pointsCount ? { ...a, pointsCount: e.jsx(x, { value: a.pointsCount }) } : a)(t);
        return e.jsx(H, { text: s, binding: i, classMix: a(Si, r) });
    },
    wi = (e) => {
        switch (!0) {
            case e >= S.ExtraLarge:
    ...
    Ni = 'CurrentProgressionItem_b8f697f9',
    Ci = 'CurrentProgressionItem_base__hasProgressBar_b62d9047',
    ki = 'CurrentProgressionItem_rankNameContainer_55288ef7',
    Pi = 'CurrentProgressionItem_rankName_1e1b1825',
    Ri = 'CurrentProgressionItem_rankEmblem_e2cd2db8',
    Ii = 'CurrentProgressionItem_rankDescription_d49d0f8f',
    yi = 'CurrentProgressionItem_rankEmblemContainer_8c8f8a5c',
    Ai = 'CurrentProgressionItem_glowContainer_ec20c1aa',
    Bi = 'CurrentProgressionItem_scoreContainer_17d6ab11',
    Ti = 'CurrentProgressionItem_score_f00041d6',
    Di = 'CurrentProgressionItem_rankInactivity_57ff2e5b',
    Li = 'CurrentProgressionItem_rankInactivityCount_3cc2bb4',
    Ei = 'CurrentProgressionItem_rankInactivity__red_3f79612b',
    zi = 'CurrentProgressionItem_rankInactivityIconContainer_74adfe0d',
    Mi = 'CurrentProgressionItem_rankInactivityIcon_ea8a1cf4',
    Wi = 'CurrentProgressionItem_rankInfo_48615e94',
    Vi = 'CurrentProgressionItem_rankProgress_1e9f9625',
    Hi = 'CurrentProgressionItem_status_d3c6050e',
    Qi = 'CurrentProgressionItem_centered_88354ddf',
    Ui = 'CurrentProgressionItem_lastUpdate_ef85f29f',
    $i = { glow: 'CurrentProgressionItem_glow_4cf800c7' },
    qi = r(() => {
        const { model: s } = Qt(),
            { model: t } = ta(),
            { mediaSize: r } = v(),
        ...
        return e.jsxs('div', {
            ...
            children: [
                e.jsxs('div', {
                    className: ki,
                    children: [
                        e.jsx('div', { className: Pi, children: pa(m.rank, { upperCase: !0 }) }),
                        e.jsx('div', { className: Ii, children: R.strings.comp7_ext.rank.current() }),
                    ],
                }),
                e.jsxs('div', {
                    className: yi,
                    children: [
                        e.jsx(ka, { className: Ai, classNames: $i }),
                        e.jsx(V, {
                ...
                e.jsxs('div', {
                    className: Bi,
                    children: [
                        e.jsx('div', { className: Ti, children: e.jsx(x, { value: o }) }),
                        m.hasRankInactivity &&
                            e.jsx(V, {
                                ignoreShowDelay: !0,
                                ...
                                children: e.jsxs('div', {
                                    className: a(Di, 0 === c && Ei),
                                    children: [
                                        e.jsx('div', { className: Li, children: c }),
                                        e.jsx('div', { className: zi, children: e.jsx('div', { className: Mi }) }),
                                    ],
                                }),
                            }),
                    ],
                ...
                h &&
                    e.jsx('div', {
                        className: Wi,
                        children: e.jsx(Xr, { rank: m.rank, from: m.from, topPercentage: n, classNames: { text: Qi } }),
                    }),
                g
                    ? e.jsx(vi, { rank: m.rank, itemIndex: i, from: m.from, to: m.to, className: Vi })
                    : e.jsxs('div', {
                          className: Hi,
                          children: [
                              e.jsx(ji, {
                                  text: Or(d, l)
                                      ? ba(R.strings.comp7_ext.rankItemStatus.current.extendedDescription, m.rank)
                                      : ba(R.strings.comp7_ext.rankItemStatus.current.description, m.rank),
                                  binding: { topPercentage: n, pointsCount: d },
                                  className: Qi,
                              }),
                              e.jsx(qr, { timestamp: _, isLastBestUserPointsValueLoading: l, className: Ui }),
                          ],
                      }),
            ],
        });
    ...
    Oi = 'Slide_f0a76533',
    Fi = 'Slide_icon_61f1d96d',
    Yi = 'Slide_progressionLevel_af90939f',
    Gi = 'Slide_description_209de83b',
    Xi = 'Slide_progress_c9912192',
    Ki = 'Slide_progressHeading_760b3b5d',
    Ji = 'Slide_current_aff8e83c',
    Zi = { ...me, delta: { delay: 1e3, duration: 500 } },
    en = { line: 'Slide_line_4b7a6b8d' };
function an(e) {
    const a = e.split('_')[0];
...
const tn = r(function ({ index: a, style: t }) {
        const { model: r, controls: i } = Qt(),
            {
                iconKey: n,
                description: o,
        ...
        return e.jsxs(c.div, {
            ...
            children: [
                e.jsx(he, {
                    ...
                    children: e.jsx('div', {
                        className: Fi,
                        style: { backgroundImage: `url(${an(n)})` },
                        children: u > 0 && e.jsx('div', { className: Yi, style: sn(u) }),
                    }),
                }),
                e.jsx(ge, { text: o, lines: 3, className: Gi, classNames: en }),
                l > 1 &&
                    e.jsxs('div', {
                        className: Xi,
                        children: [
                            e.jsx(U, {
                                ...
                                binding: {
                                    currentProgress: e.jsx('span', { className: Ji, children: d }),
                                    maxProgress: l,
                                },
                                classMix: Ki,
                            }),
    ...
    rn = 'Slider_671b7f6e',
    nn = 'Slider_arrow_cef005fb',
    on = 'Slider_arrow__left_2541745',
    cn = 'Slider_arrow__right_b3c063d2',
    dn = 'Slider_clippedContainer_2855c48e',
    ln = (e, a) => () => {
        e || (a(), b.sound('arrow'));
    },
    _n = r(function ({ className: s }) {
        const { model: t, controls: r } = Qt(),
            ...
            c = 0 === n,
            d = n === o.length - 1,
            l = ln(c, () => r.setCurrentSlideIndex(n - 1)),
            _ = ln(d, () => r.setCurrentSlideIndex(n + 1)),
            m = n < i,
            u = g(n, {
                initial: { opacity: 0 },
        ...
        return e.jsxs('div', {
            ...
            children: [
                e.jsx(
                    Ra,
                    { size: 'extraSmall', direction: 'left', disabled: c, className: a(nn, on), onClick: l },
                    `prev_${n}`,
                ),
                e.jsx(
                    Ra,
                    { size: 'extraSmall', direction: 'right', disabled: d, className: a(nn, cn), onClick: _ },
                    `next_${n}`,
                ),
                u((a, s) => e.jsx('div', { className: dn, children: e.jsx(tn, { index: s, style: a }) })),
            ],
        });
    }),
    mn = 'Customization_b5005863',
    un = 'Customization_header_d905d185',
    hn = 'Customization_heading_22abf2a8',
    gn = 'Customization_headingText_84ca034d',
    pn = 'Customization_separator_cff8fe1d',
    xn = 'Customization_noTasks_3d376941',
    bn = 'Customization_doneText_5ffca92b',
    fn = r(function ({ className: a }) {
    ...
    vn = r(function ({ classNames: a }) {
        const { mediaSize: s } = v(),
            { model: t, controls: r } = Qt(),
        ...
        return e.jsx(ws, {
            children: e.jsxs(I, {
                ...
                className: a?.button,
                children: [
                    e.jsx(Nr, { loading: i, className: a?.spinner }),
                    i
    ...
    wn = r(({ children: a }) => {
        const { mediaSize: t } = v(),
            { model: r } = ta(),
            i = ((e) => (e >= S.Medium ? ua.x64 : ua.x40))(t),
            { model: n } = Qt(),
        ...
        return e.jsx(Sn.Provider, { value: l, children: a });
    }),
    Nn = 'StatisticsIndicators_b51640da',
    Cn = 'StatisticsIndicators_blockContainer_3542f044',
    kn = 'StatisticsIndicators_blockContainer__rank_c1b1351b',
    Pn = 'StatisticsIndicators_blockContainer__qualification_7be14031',
    Rn = 'StatisticsIndicators_blockContainer__battles_c8cb4e5d',
    In = 'StatisticsIndicators_blockContainer__wins_37236dae',
    yn = 'StatisticsIndicators_blockContainer__damage_684733ae',
    An = 'StatisticsIndicators_noRankDescription_915e6fda',
    Bn = 'StatisticsIndicators_rankEmblem_b39dce8e',
    Tn = 'StatisticsIndicators_blockInfo_2f8fa787',
    Dn = 'StatisticsIndicators_indicatorValue_c9a4901d',
    Ln = 'StatisticsIndicators_indicatorValue__compact_a000cb0a',
    En = 'StatisticsIndicators_additionalInfo_417d1755',
    zn = 'StatisticsIndicators_diffDescription_9e134252',
    Mn = 'StatisticsIndicators_subIndicator_4a61a07c',
    Wn = 'StatisticsIndicators_subIndicator__victory_c1b1351b',
    Vn = 'StatisticsIndicators_subIndicatorValue_1431d50a',
    Hn = 'StatisticsIndicators_subIndicator__defeat_c1b1351b',
    Qn = 'StatisticsIndicators_subIndicator__draw_c1b1351b',
    Un = 'StatisticsIndicators_icon_cbe85555',
    $n = 'StatisticsIndicators_subIndicator__solo_c1b1351b',
    qn = 'StatisticsIndicators_subIndicator__platoon_c1b1351b',
    On = 'StatisticsIndicators_indicatorIcon_b82fc36a',
    Fn = 'StatisticsIndicators_blockContainer__prestigePoints_c1b1351b',
    Yn = 'StatisticsIndicators_link_3a7046ef',
    Gn = 'StatisticsIndicators_linkText_1efae1a9';
function Xn({ value: s, iconSlot: t = e.jsx('div', { className: On }), tooltipArgs: r, className: i, children: n }) {
    const { isCompact: o } = jn();
    return e.jsx(be, {
        tooltipArgs: r,
        children: e.jsxs('div', {
            className: a(Cn, i),
            children: [
                ...
                e.jsxs('div', {
                    ...
                    children: [
                        ...
                        e.jsx('div', { className: En, children: n }),
                    ],
                }),
            ],
        }),
...
function Kn({ value: s, className: t }) {
    return e.jsxs('div', {
        className: a(Mn, t),
        children: [e.jsx('div', { className: Un }), e.jsx('div', { className: Vn, children: e.jsx(ya, { value: s }) })],
    });
}
function Jn() {
    const { emblemSize: s, seasonName: t } = jn();
    return e.jsxs('div', {
        className: a(Cn, Pn),
        children: [
            e.jsx(Aa, { size: s, seasonName: t, className: Bn }),
            e.jsx('div', { className: An, children: R.strings.comp7_ext.rank.qualification() }),
        ],
    });
}
function Zn({ rank: a, value: t, tooltipArgs: r, children: i }) {
    const { emblemSize: n, seasonName: o, statisticsMode: c } = jn(),
        d = s.useMemo(
            () => ({
                ...
                args: {
                    ...
                    seasonName: o,
                    rank: a,
                    division: ha(a) ? r?.division : void 0,
                    ratingPoints: r?.ratingPoints,
                    diff: r?.diff,
                    maxAchievedRatingPoints: r?.maxAchievedRatingPoints,
                    dayOfMaxRatingIndex: r?.dayOfMaxRatingIndex,
                },
                ignoreShowDelay: !0,
            }),
            [r, a, o, c],
    ...
    return e.jsx(Xn, {
        className: kn,
        iconSlot: e.jsx(ma, { rank: a, size: n, seasonName: o, className: Bn }),
        value: t,
        tooltipArgs: d,
        children: i,
    });
}
function eo({ soloBattlesCount: a, superPlatoonBattlesCount: t }) {
    const { statisticsMode: r } = jn(),
        i = s.useMemo(
            () => ({
    ...
    return e.jsxs(Xn, {
        ...
        value: a + t,
        tooltipArgs: i,
        children: [e.jsx(Kn, { value: a, className: $n }), e.jsx(Kn, { value: t, className: qn })],
    });
}
function ao({ value: a, winsCount: t, lossCount: r, drawCount: i }) {
    const { statisticsMode: n } = jn(),
        o = s.useMemo(
            () => ({
    ...
    return e.jsxs(Xn, {
        className: In,
        value: Ba({ value: c, isPercentage: !0 }),
        tooltipArgs: o,
        children: [
            e.jsx(Kn, { value: t, className: Wn }),
            e.jsx(Kn, { value: r, className: Hn }),
            e.jsx(Kn, { value: i, className: Qn }),
        ],
    });
}
function so({ value: a, recordDamageDealt: t, recordDamageDealtVehicleName: r }) {
    const { statisticsMode: i } = jn(),
        n = s.useMemo(
            () => ({
...
function to({ value: a, recordPrestige: t, recordPrestigeVehicleName: r }) {
    const { statisticsMode: i } = jn(),
        n = s.useMemo(
            () => ({
...
const ro = r(({ index: a }) => {
                ...
                t
                    ...
                    : e.jsx(Zn, {
                          ...
                          children: e.jsx(U, {
                              ...
                              binding: { diff: e.jsx(Ia, { value: c }) },
                              classMix: zn,
                          }),
                      }),
                e.jsx(eo, { soloBattlesCount: d, superPlatoonBattlesCount: l }),
                e.jsx(ao, { value: _, winsCount: m, lossCount: u, drawCount: h }),
                e.jsx(so, { value: g, recordDamageDealt: x, recordDamageDealtVehicleName: b }),
                e.jsx(to, { value: p, recordPrestige: f, recordPrestigeVehicleName: v }),
            ],
        });
    }),
    io = r(() => {
        ...
        return e.jsxs(e.Fragment, {
            children: [
                ...
                e.jsx(eo, { soloBattlesCount: i, superPlatoonBattlesCount: n }),
                e.jsx(ao, { value: o, winsCount: c, lossCount: d, drawCount: l }),
                e.jsx(so, { value: _, recordDamageDealt: h, recordDamageDealtVehicleName: g }),
                e.jsx(to, { value: m, recordPrestige: p, recordPrestigeVehicleName: x }),
            ],
        });
    }),
    no = ({ className: s }) => {
        ...
        return e.jsx('div', {
            className: a(Nn, s),
            children: r === oa.Day && i !== Wt ? e.jsx(ro, { index: i }) : e.jsx(io, {}),
        });
    },
    oo = ['vehicles', 'battles', 'winSeries', 'damage', 'assist', 'prestigePoints', 'maxFrags', 'destruction'],
    co = {
    ...
    lo = function () {
        return e.jsx('div', {
            className: co.tableHeader,
            children: oo.map((a) =>
                e.jsx(
                    'div',
                    {
                        className: h(co.column, co[`column__${a}`]),
                        children: e.jsx(p, {
    ...
    _o = 'VehicleSlot_7c412eb1',
    mo = 'VehicleSlot_vehicleImage_bebb3f54',
    uo = 'VehicleSlot_name_b6b086dd',
    ho = 'VehicleSlot_text_7419b709',
    go = function ({ vehicle: a }) {
        ...
        return e.jsxs('div', {
            ...
            children: [
                ...
                a
                    ...
                    : e.jsx('div', { className: ho, children: R.strings.comp7_ext.dash() }),
            ],
        });
    },
    po = (e, a) => {
        ...
        const s = Number(a[e]);
        return Da(s, 'winSeries' === e, 2);
    },
    xo = r(function () {
        const { model: a } = Qt(),
            s = a.topVehiclesStatistics.get();
        return e.jsx('div', {
            className: co.tableContent,
            children: T(3, (a) => {
                const t = P(s, a);
                return e.jsx(
                    'div',
                    {
                        className: h(co.row, 1 !== a && co.row__highlighted),
                        children: oo.map((a, s) =>
                            e.jsx(
                                'div',
                                {
                                    className: h(co.column, co[`column__${a}`]),
                                    children: 'vehicles' === a ? e.jsx(go, { vehicle: t }) : po(a, t),
                                },
                                s,
                            ),
                        ),
    ...
    bo = r(function () {
        ...
        return (
            ...
            e.jsxs('div', {
                className: a(co.base, d && co.base__expanded),
                children: [
                    e.jsxs('div', {
                        className: co.header,
                        children: [
                            e.jsx('div', {
                                className: co.headerText,
                    ...
                    e.jsx(fr, {}),
                    e.jsxs('div', { className: co.table, children: [e.jsx(lo, {}), e.jsx(xo, {})] }),
                ],
            })
        );
    });
const fo = 'ProgressionLayout_b39a022a',
    vo = 'ProgressionLayout_leftPanel_29b1139',
    So = 'ProgressionLayout_rightPanel_42d86627',
    jo = 'ProgressionLayout_divider_7bed07ed',
    wo = 'ProgressionLayout_topContent_5774ce8',
    No = 'ProgressionLayout_indicators_a373d8ae',
    Co = 'ProgressionLayout_bottomContent_dafa55d',
    ko = 'ProgressionLayout_initialSpinner_9430136',
    Po = { button: 'ProgressionLayout_button_1eb45096', spinner: 'ProgressionLayout_spinner_97f4b1d9' },
    Ro = r(() => {
        const { model: a, controls: s } = Qt(),
        ...
        return e.jsxs('div', {
            className: fo,
            children: [
                e.jsx(c.div, { className: vo, style: n, children: e.jsx(qi, {}) }),
                ...
                e.jsx('div', {
                    ...
                    children: (() => {
                        switch (t) {
                            case Vt.Initial:
                                return r
                                    ? e.jsx(O, { message: R.strings.comp7_ext.waitingSpinner.message(), className: ko })
                                    : null;
                            case Vt.Success:
                                return e.jsxs(e.Fragment, {
                                    children: [
                                        e.jsxs('div', {
                                            ...
                                            children: [
                                                e.jsx(Qr, {}),
                                                e.jsx(gr, { width: d }),
                                                e.jsx(wn, { children: e.jsx(no, { className: No }) }),
                                            ],
                                        }),
                                        e.jsxs('div', { className: Co, children: [e.jsx(bo, {}), e.jsx(fn, {})] }),
                                    ],
                                });
                            case Vt.Error:
                                return e.jsx(vn, { classNames: Po });
                            default:
    ...
    Io = { hasHtmlContent: !0 },
    yo = ({ maxBattlesCount: a, children: s }) =>
        e.jsx(p, {
    ...
    Bo = 'BattlesCounter_battlesCount_73d2731e',
    To = 'BattlesCounter_battlesDivider_7dbb3a33',
    Do = ({ battlesCount: s, maxBattlesCount: t, className: r }) =>
        e.jsx(U, {
            text: R.strings.comp7_ext.qualification.counter(),
            binding: {
                battlesCount: e.jsx('div', { className: Bo, children: s }),
                divider: e.jsx('div', { className: To, children: '/' }),
                maxBattlesCount: t,
            },
            classMix: a(Ao, r),
        }),
    Lo = r(({ index: a, className: s }) => {
        const { model: t } = Qt(),
            { mediaSize: r } = v(),
            i = t.computes.qualificationBattle(a);
        return e.jsx(za, { state: i.state, className: s, size: r >= S.ExtraLarge ? 'x234' : 'x173' }, a);
    }),
    Eo = 'BattlesProgression_c0296cbd',
    zo = 'BattlesProgression_item_e40a305e',
    Mo = r(({ className: s }) => {
        const { model: t } = Qt();
        return e.jsx('div', {
            className: a(Eo, s),
            children: T(t.qualificationBattles.get().length, (a) => e.jsx(Lo, { index: a, className: zo }, a)),
        });
    }),
    Wo = (e) => {
        switch (!0) {
    ...
    Ho = 'Qualification_content_8a6d7d92',
    Qo = 'Qualification_footer_143b827d',
    Uo = 'Qualification_qualificationEmblemContainer_dbf79dc7',
    $o = 'Qualification_glowContainer_3a05eb3',
    qo = 'Qualification_glow_8e19a98c',
    Oo = 'Qualification_qualificationEmblem_a7436cbb',
    Fo = 'Qualification_battlesProgression_d6ca81d2',
    Yo = 'Qualification_counterDescription_7f2dd37b',
    Go = 'Qualification_ratingCalculationDescription_7d2ba061',
    Xo = 'Qualification_timerIcon_b77227aa',
    Ko = 'Qualification_conditionContainer_3d81a257',
    Jo = 'Qualification_condition_1f31ad6a',
    Zo = 'Qualification_rewardsDescription_1d74932c',
    ec = 'Qualification_infoIcon_139d9dc7',
    ac = 'Qualification_rewardsButton_7672a5e',
    sc = 'Qualification_buttonContent_9ef49ca6',
    tc = 'Qualification_waiting_8e273156';
function rc(e) {
    return e >= S.Large ? I.sizes.small : I.sizes.extraSmall;
}
const ic = r(({ className: s }) => {
        const { model: t, controls: r } = Qt(),
            { model: i } = ta(),
            { mediaSize: n } = v(),
            ...
            u = o({
                from: { opacity: 0 },
                to: ts() ? { opacity: m ? 1 : 0 } : { opacity: 1 },
                delay: 300,
                config: { duration: 300 },
            });
        return ts() && !m
            ? e.jsx('div', { className: tc, children: e.jsx(O, {}) })
            : e.jsxs(c.div, {
                  style: u,
                  className: a(Vo, s),
                  children: [
                      e.jsxs('div', {
                          ...
                          children: [
                              e.jsxs('div', {
                                  className: Uo,
                                  children: [
                                      e.jsx(ka, { className: $o, classNames: { glow: qo } }),
                                      e.jsx(Aa, { size: Wo(n), seasonName: i.season.name.get(), className: Oo }),
                                  ],
                              }),
                              e.jsx(Do, { battlesCount: d, maxBattlesCount: l }),
                              _
                                  ? e.jsx(p, {
                                        ...
                                        children: e.jsx('div', {
                                            children: e.jsx(U, {
                                                ...
                                                binding: { timerIcon: e.jsx('div', { className: Xo }) },
                                                classMix: Go,
                                            }),
                                        }),
                                    })
                          ...
                          children: [
                              e.jsxs('div', {
                                  ...
                                  children: [
                                      ...
                                      e.jsx(yo, { maxBattlesCount: l, children: e.jsx('div', { className: ec }) }),
                                  ],
                              }),
                              e.jsx(U, { text: R.strings.comp7_ext.qualification.rewardsDescription(), classMix: Zo }),
                              e.jsx(I, {
                                  classNames: { base: ac, content: sc },
                                  theme: I.themes.secondary,
                                  onMouseEnter: () => {
    ...
    nc = 'ProgressionPage_abde0f3e',
    oc = 'ProgressionPage_scheduleSubheading_f92469b5',
    cc = 'ProgressionPage_parallaxContainer_f5c5fb63',
    dc = 'ProgressionPage_contentWrapper_728d5d97',
    lc = 'ProgressionPage_contentInner_78229ad9',
    _c = 'ProgressionPage_content_f7a37594',
    mc = r(() => {
        const { model: a } = Qt(),
            [t, r] = s.useState(0),
            i = s.useRef(null),
            ...
            o = s.useCallback(() => {
                if (!i.current) return;
                const e = fe(Math.round(i.current?.getBoundingClientRect().height));
                r(e % 2 == 0 ? e : e - 1);
            }, [n]);
        return (
            le(() => o(), [o]),
            ...
            e.jsxs('div', {
                ...
                children: [
                    ts() && n && e.jsx(Jt, { className: cc }),
                    e.jsx(va, { className: oc }),
                    n
                        ? e.jsx('div', { className: dc, children: e.jsx(ic, { className: _c }) })
                        : e.jsx('div', {
                              className: dc,
                              ref: i,
                              children: e.jsx('div', {
    ...
    [uc, hc] = w()(
        ({ observableModel: e }) => {
            const a = { root: e.object(), qualification: e.primitives(['isActive'], 'qualificationModel') },
                ...
                u = t(() => {
                    const e = Y(o(0), (e) => 'customizations' === e.name && 'progressionStyle' === e.icon);
                    return e?.label ?? '';
                });
            return {
                ...a,
    ...
    gc = 'ProgressionScroll_21d7f49a',
    pc = 'ProgressionScroll_areaWrapper_c935b531',
    xc = 'ProgressionScroll_areaContent_d2de9b28',
    bc = ({
        stuckIndex: t,
        itemWidth: r,
        itemsOffset: i = 0,
        ...
        const m = M(r),
            ...
            f = s.useCallback(() => {
                o?.(Math.round(h.scrollPosition.goal / m));
        ...
        (s.useEffect(() => (g.on('rest', f), () => g.off('rest', f)), [g, f]),
            ...
            s.useEffect(
                () =>
                    z(() => {
                        if ('scrollComplete' === x.type) {
                            const e = Math.round(h.scrollPosition.goal / m);
                            p(e * m);
                        }
                    }),
                [h.scrollPosition, p, x, m, b],
            ));
        ...
        return e.jsxs('div', {
            ...
            children: [
                e.jsx(se, {
                    className: d?.base,
                    classNames: { wrapper: a(pc, d?.wrapper), content: a(xc, d?.content) },
                    children: n,
                }),
                _,
    ...
    fc = (e, a = 100) => ((fe(we('px').width) * a) / 100 - e) / 2;
function vc({ children: a, api: s, ...t }) {
    return e.jsx(ae, { api: s, children: e.jsx(bc, { ...t, children: a }) });
}
const Sc = (e, a) => (e > a ? a - 1 : void 0),
    jc = 'AdditionalRewards_reward_b14f8cf9',
    wc = 'AdditionalRewards_vehiclesRentBase_20861c60',
    Nc = 'AdditionalRewards_vehiclesRentLabel_bed51da4',
    Cc = Ne.Small,
    kc = r(({ rank: s, itemIndex: t, visibleRewardsCount: r, className: i }) => {
        const { model: n } = hc(),
            ...
            d = C(o, (e) => {
                ...
                return {
                    ...Ma({ reward: e, size: Cc, rank: s }),
                    className: a(t && wc),
                    classNames: { info: a(t && Nc) },
                };
            });
        return e.jsx(Ce, {
            data: d,
...
const Rc = {
        ...
        return e.jsxs('div', {
            ...
            children: [
                e.jsxs(pt, {
                    ...
                    topPercentage: n,
                    divisions: _,
                    className: Rc.rankEmblemContainer,
                    ignoreShowDelay: !0,
                    children: [
                        m &&
                            e.jsx(ke, {
                                className: Rc.godRays,
                        ...
                        e.jsx(ma, {
                            ...
                            size: t,
                            rank: o,
                            className: a(Rc.rankEmblem, !l && Rc.rankEmblem__inactive),
                        }),
                        !l && e.jsx('div', { className: Rc.lock }),
                    ],
                }),
                e.jsxs('div', {
                    className: Rc.description,
                    children: [
                        e.jsx('div', { className: Rc.rankName, children: pa(o) }),
                        m && e.jsx('div', { className: Rc.rankStatus, children: Ic(i.year.state.get()) }),
                    ],
                }),
            ],
        });
    }),
    Ac = (e) => 'styleProgress' === e.name,
    Bc = 'MainReward_de250efb',
    Tc = 'MainReward_imageContainer_20c097c',
    Dc = 'MainReward_glowContainer_570aee25',
    Lc = 'MainReward_glow_aa880e51',
    Ec = 'MainReward_preview_f2a964a3',
    zc = 'MainReward_info_dc048bbb',
    Mc = 'MainReward_title_7cbb5d41',
    Wc = 'MainReward_subTitle_247ccde3',
    Vc = r(({ index: s, rank: t, size: r, hasHighlight: i, onPreviewClick: n, className: o }) => {
        const { model: c } = hc(),
            d = c.computes.mainReward(s),
            l = c.computes.progressionStyleName();
        return e.jsxs('div', {
            className: a(Bc, o),
            children: [
                e.jsxs('div', {
                    className: Tc,
                    children: [
                        i && e.jsx(ka, { className: Dc, classNames: { glow: Lc } }),
                        e.jsx(Pe, { ...Ma({ reward: d, size: r, rank: t }) }),
                        Ac(d) &&
                            e.jsx('div', {
                                className: Ec,
                                children: e.jsx(Re, {
                ...
                e.jsxs('div', {
                    className: zc,
                    children: [
                        e.jsx('div', { className: Mc, children: d.label }),
                        e.jsx(Ie, {
                            text: String(R.strings.comp7_ext.rewards.subtitle.$dyn(d.name)),
                            params: { vehicleLevel: ye(10), progressionStyleName: l },
                            className: Wc,
                            upgradeLegacy: !0,
                            split: !0,
                        }),
    ...
    Hc = 'RankRewardsItem_97feb95e',
    Qc = 'RankRewardsItem_mainRewardContainer_85d98e1d',
    Uc = 'RankRewardsItem_rewardsContainer_aa9fb54',
    $c = 'RankRewardsItem_statusContainer_32c29dc9',
    qc = 'RankRewardsItem_statusContainer__hidden_1627e91e',
    Oc = 'RankRewardsItem_icon_c6768aea',
    Fc = r(
        ({
            itemIndex: s,
            itemWidth: t,
            ...
            return e.jsxs('div', {
                ...
                children: [
                    e.jsx(yc, { index: s, rankEmblemSize: o }),
                    e.jsx(Vc, { index: s, rank: l, size: r, hasHighlight: i, onPreviewClick: c, className: Qc }),
                    e.jsx('div', {
                        className: Uc,
                        children: e.jsx(kc, { itemIndex: s, visibleRewardsCount: n, rank: l }),
                    }),
                    e.jsxs('div', {
                        className: a($c, !_ && qc),
                        children: [e.jsx('div', { className: Oc }), R.strings.comp7_ext.rewards.status.achieved()],
                    }),
                ],
            });
        },
    ),
    Yc = (e) => (e >= S.Large ? ua.x110 : e >= S.Medium ? ua.x64 : ua.x48),
    Gc = (e) =>
        e >= S.ExtraLarge ? Ne.S600x450 : e >= S.Large ? Ne.S400x300 : e >= S.Medium ? Ne.S296x222 : Ne.S232x174,
    Xc = (e) => (e >= Ae.Medium ? 5 : 4),
    Kc = 'RankRewardsPage_966eba9d',
    Jc = 'RankRewardsPage_content_470e75a1',
    Zc = 'RankRewardsPage_scrollContainer_22b6e09b',
    ed = 'RankRewardsPage_areaContainer_ca7d8c25',
    ad = 'RankRewardsPage_areaWrapper_9e0580b',
    sd = 'RankRewardsPage_bar_4df7da7f',
    td = { duration: 700, easing: (e) => Math.pow(e, 4) },
    rd = r(() => {
        const { mediaSize: a, mediaWidth: t } = v(),
            { model: r, controls: i } = hc(),
                    ...
                    i = s.useMemo(
                        () => ({
                            settings: {
                                ...
                                animationConfig: { frequency: 0.8, ...t },
                            },
                        }),
                        [t, r, a],
                    );
            ...
            children: [
                ...
                e.jsx(c.div, {
                    ...
                    children: e.jsx(vc, {
                        ...
                        onStick: g,
                        className: Zc,
                        areaClassNames: { base: ed, wrapper: ad },
                        barClassNames: { base: sd },
                        children: T(d, (s) =>
                            e.jsx(
                                Fc,
                                {
                                    itemIndex: s,
                                    visibleRewardsCount: Xc(t),
                                    rankEmblemSize: Yc(a),
                                    mainRewardSize: Gc(a),
                                    itemWidth: p,
                                    hasHighlight: k(s),
...
var id = ((e) => ((e[(e.Initial = 0)] = 'Initial'), (e[(e.Success = 1)] = 'Success'), (e[(e.Error = 2)] = 'Error'), e))(
    id || {},
);
const nd = [Va.Locked, Va.ReadyToPurchase],
    od = [Ha.Vehicle, Ha.Style3d],
    [cd, dd] = w()(
        ({ observableModel: e, mode: a }) => {
            const s = e.array('rankDiscounts'),
                ...
                l = t(
                    (e) => {
                        ...
                        return {
                            ...
                            isEnough: !nd.includes(a.state) || a.price.isEnough,
                        };
                    },
                    { equals: i.shallow },
                ),
                ...
                u = t(() => n.root.get().shopState === id.Success && m().type !== Ha.Reward),
                h = t(() => {
                    const e = m();
                    return e.type === Ha.Vehicle && e.state !== Va.ReadyToRestore && e.description;
                }),
                g = t(() => m().type === Ha.Reward),
                p = t(
                    () => {
                        const e = m(),
                            a = e.type === Ha.Vehicle && e.state !== Va.Purchased;
                        return {
                            hasControls: od.includes(e.type),
                            hasAddToCompare: e.type === Ha.Vehicle,
                            hasPreview: a || e.type === Ha.Style3d,
                        };
                    },
                    { equals: i.shallow },
                ),
                x = t(() => C(s.get(), (e) => ({ ...e, divisions: Mt(C(e.divisions, (e) => ({ ...e }))) })), {
                    equals: N,
                }),
                b = t(
                    (e) => {
    ...
    _d = ({ className: t, classNames: r, children: i }) => {
        const { api: n } = Se(),
            {
                events: o,
                getBounds: c,
        ...
        return (
            ...
            e.jsxs('div', {
                className: a(ld.base, t),
                ref: u,
                children: [
                    e.jsx(se, {
                        classNames: {
                            wrapper: a(ld.areaWrapper, r?.areaWrapper, 'hidden' !== h && ld.areaWrapper__hasScroll),
                            content: a(ld.areaContent, r?.areaContent),
                        },
                        children: i,
                    }),
                    e.jsx(Ra, {
                        ...
                        className: a(ld.arrow, ld.arrow__prev, ld[`arrow__${h}`]),
                    ...
                    e.jsx(Ra, {
                        ...
                        className: a(ld.arrow, ld.arrow__next, ld[`arrow__${h}`]),
    ...
    md = 'ProductCardImage_e1f40b93',
    ud = R.images.comp7.gui.maps.icons.products,
    hd = r(({ index: s, className: t }) => {
        const { model: r } = dd(),
            i = r.computes.product(s);
        return e.jsx('div', { className: a(md, t), style: { backgroundImage: `url('${ud.$num(i.id)}')` } });
    }),
    gd = 'ProductCardName_ce866ed9',
    pd = 'ProductCardName_vehicleName_a1701a73',
    xd = 'ProductCardName_nation_e06370d7',
    bd = 'ProductCardName_style3dContainer_59247316',
    fd = 'ProductCardName_overflowedName_8c3f6093',
    vd = 'ProductCardName_style3dDescription_3f9b224',
    Sd = r(({ index: s, className: t }) => {
        const { model: r } = dd(),
            i = r.computes.product(s),
            { mediaSize: n } = v();
        switch (i.type) {
            case Ha.Vehicle: {
                ...
                return e.jsxs('div', {
                    ...
                    children: [
                        ...
                        e.jsx(La, { name: s, tier: r, type: n, isPremium: c, className: pd }),
                    ],
                });
            }
            case Ha.Style3d: {
                ...
                return e.jsxs('div', {
                    className: a(gd, bd, t),
                    children: [
                        e.jsx(ze, { classMix: fd, content: o }, n),
                        e.jsx(U, {
            ...
            case Ha.Reward:
                return e.jsx(U, { text: i.reward.label, classMix: a(gd, t) });
            default:
    ...
    wd = { base: jd.currencyValue },
    Nd = r(({ index: s, className: t }) => {
        const { model: r } = dd(),
            { price: i } = r.computes.product(s),
            n = r.computes.priceConfig(s).hasDiscount;
        return e.jsxs('div', {
            className: a(jd.base, t),
            children: [
                n &&
                    e.jsxs('div', {
                        className: a(jd.discount, jd[`discount__${i.name}`]),
                        children: [e.jsx(x, { value: i.value }), e.jsx('div', { className: jd.discountLine })],
                    }),
                e.jsx(Me, {
                    type: i.name,
                    reverse: !0,
    ...
    Cd = 'ProductCardPurchased_2961b484',
    kd = 'ProductCardPurchased_icon_8b2c6156',
    Pd = 'ProductCardPurchased_text_4c3e5e17',
    Rd = ({ className: s }) =>
        e.jsxs('div', {
            className: a(Cd, s),
            children: [
                e.jsx('div', { className: kd }),
                e.jsx('div', { className: Pd, children: R.strings.comp7_ext.products.purchased() }),
            ],
        }),
    Id = 'ProductCardReadyToRestore_f4520fe',
    yd = ({ className: s }) =>
        e.jsx('div', {
            className: a(Id, s),
    ...
    Bd = {
        [Ha.Vehicle]: 'comp_7_shop_carousel_click_tank',
        [Ha.Style3d]: 'comp_7_shop_carousel_click_style',
        [Ha.Reward]: 'comp_7_shop_carousel_click_module',
        [Ha.Base]: '',
    },
    Td = r(({ index: s, className: t, classNames: r }) => {
        const { model: i, controls: n } = dd(),
        ...
        return e.jsx(he, {
            ...
            ignoreShowDelay: !0,
            children: e.jsxs('div', {
                className: a(Ad.base, g && Ad.base__selected, Ad[`base__${c}`], t),
                onClick: () => {
                    g || (b.click(), b.sound(Bd[_]), n.selectProduct(o), n.markProductSeen(o));
                },
                children: [
                    e.jsx('div', {
                        className: a(Ad.background, r?.background),
                        style: {
                            backgroundImage: `url(${ba(R.images.comp7.gui.maps.icons.products.cardsBackgrounds, l)})`,
                        },
                    }),
                    e.jsxs('div', {
                        className: Ad.corners,
                        children: [
                            e.jsx('div', { className: a(Ad.corner, Ad.corner__top, Ad.corner__left, r?.corner) }),
                            e.jsx('div', { className: a(Ad.corner, Ad.corner__top, Ad.corner__right, r?.corner) }),
                            e.jsx('div', { className: a(Ad.corner, Ad.corner__bottom, Ad.corner__left, r?.corner) }),
                            e.jsx('div', { className: a(Ad.corner, Ad.corner__bottom, Ad.corner__right, r?.corner) }),
                        ],
                    }),
                    e.jsx('div', { className: a(Ad.stroke, r?.stroke) }),
                    e.jsx(hd, { index: s, className: a(Ad.imageContainer, r?.imageContainer) }),
                    e.jsx('div', { className: Ad.backgroundGradient }),
                    u && e.jsx('div', { className: Ad.discountBackground }),
                    e.jsx(We.Root, {
                        hidden: !d,
                        className: a(Ad.notification, r?.notification),
                        children: e.jsx(We.Value, { size: Ve.small, value: R.strings.comp7_ext.products.newLabel() }),
                    }),
                    e.jsxs('div', {
                        className: Ad.container,
                        children: [
                            e.jsx(Sd, { index: s, className: Ad.name }),
                            (() => {
                                switch (c) {
                                    case Va.ReadyToRestore:
                                        return e.jsx(yd, { className: a(Ad.bottomString, Ad.bottomString__withIcon) });
                                    case Va.Purchased:
                                        return e.jsx(Rd, { className: a(Ad.bottomString, Ad.bottomString__withIcon) });
                                    default:
                                        return e.jsx(Nd, { index: s, className: Ad.bottomString });
                                }
                            })(),
                        ],
                    }),
                    c === Va.Locked && e.jsx('div', { className: Ad.lock }),
                ],
            }),
        });
    }),
    Dd = 'RankSection_c990c598',
    Ld = 'RankSection_dividerContainer_811b1b79',
    Ed = 'RankSection_dividerContainer__right_551e2893',
    zd = 'RankSection_verticalDivider_3a6d642f',
    Md = 'RankSection_centralContainer_755b9082',
    Wd = 'RankSection_rankDescription_fb9e5f48',
    Vd = 'RankSection_rankImage_8c4cf71f',
    Hd = 'RankSection_rankString_514c111b',
    Qd = 'RankSection_horizontalDivider_95048bb6',
    Ud = 'RankSection_peak_9d148568',
    $d = 'RankSection_peak__right_551e2893',
    qd = 'RankSection_line_2a5d3241',
    Od = ({ rank: s, seasonName: t, className: r }) =>
        e.jsxs('div', {
            className: a(Dd, r),
            children: [
                e.jsxs('div', {
                    ...
                    children: [
                        ...
                        e.jsxs('div', {
                            className: Qd,
                            children: [
                                e.jsx('div', { className: Ud }),
                                e.jsx('div', { className: qd }),
                                e.jsx('div', { className: a(Ud, $d) }),
                            ],
                        }),
                    ],
                }),
                e.jsxs('div', {
                    className: Md,
                    children: [
                        e.jsx(ma, { rank: s, size: ua.x40, seasonName: t, className: Vd }),
                        e.jsx(U, {
                            classMix: Wd,
                            ...
                            binding: {
                                rank: e.jsx('div', {
                                    className: Hd,
                                    children: Q(R.strings.comp7_ext.quotesWrapper(), { name: fa(s) }),
                                }),
                            },
                        }),
                    ],
    ...
    Fd = 'Carousel_dividersSections_1b165bca',
    Yd = 'Carousel_areaContent_38720fd1',
    Gd = 'Carousel_areaWrapper_5e900854',
    Xd = 'Carousel_section_239ec09e',
    Kd = 'Carousel_scrollItem_75645375',
    Jd = 'Carousel_scrollItem__group_d0111639',
    Zd = 'Carousel_productCard_bca51e20',
    el = 'Carousel_selectedGlowContainer_d798cbe',
    al = 'Carousel_glow_17d85254',
    sl = 'Carousel_selectedGlowContainer__active_bca51e20',
    tl = { areaWrapper: Gd, areaContent: Yd },
    rl = { glow: al },
    il = r(({ className: t }) => {
        const { model: r } = dd(),
            { model: i } = ta(),
                        ...
                        children: [
                                ...
                                children: d.recordsArray.map(([a, s]) =>
                                    e.jsx(
                                        'div',
                                        {
                                            ...
                                            children: e.jsx(Od, { rank: a, seasonName: i.season.name.get() }),
                                        },
                                        a,
                                    ),
                                ),
                            ...
                            T(r.computes.productsLength(), (s) =>
                                e.jsxs(
                                    'div',
                                    {
                                        className: a(Kd, d.groupIndexesSet.has(s) && Jd),
                                        onMouseEnter: c === s ? void 0 : b.highlight,
                                        ref: c === s ? o : void 0,
                                        children: [
                                            e.jsx(ka, { className: a(el, s === c && sl), classNames: rl }),
                                            e.jsx(Td, { index: s, className: Zd }),
                                        ],
                                    },
                                    s,
                                ),
    ...
    nl = 'ProductControls_control_9de2450c',
    ol = { label: 'ProductControls_label_f6830376' },
    cl = r(() => {
        const { mediaSize: a } = v(),
            { model: s, controls: t } = dd(),
    ...
    dl = 'PeaksContainer_ac84c920',
    ll = 'PeaksContainer_venzel_8ceb268e',
    _l = 'PeaksContainer_venzel__right_786d2e11',
    ml = 'PeaksContainer_icon_938427c2',
    ul = 'PeaksContainer_line_c8c429d2',
    hl = 'PeaksContainer_content_fa8f58a4',
    gl = ({ className: t, classNames: r, children: i }) => {
        ...
        return e.jsxs('div', {
            ...
            children: [
                0 === n &&
                    e.jsxs('div', {
                        className: a(ll, r?.venzel),
                        children: [
                            e.jsx('div', { className: a(ml, r?.icon) }),
                            e.jsx('div', { className: a(ul, r?.line) }),
                        ],
                    }),
                n > 0 && e.jsx('div', { className: a(hl, r?.content), children: i }),
                e.jsxs('div', {
                    className: a(ll, r?.venzel, _l),
                    children: [
                        e.jsx('div', { className: a(ml, r?.icon) }),
                        e.jsx('div', { className: a(ul, r?.line) }),
                    ],
    ...
    pl = 'RankDiscount_9bb75367',
    xl = 'RankDiscount_godRays_4c25e606',
    bl = 'RankDiscount_rank_5f187f66',
    fl = 'RankDiscount_disabledRankEmblem_47ff911f',
    vl = 'RankDiscount_lock_c41f1a10',
    Sl = 'RankDiscount_footer_6f406c1d',
    jl = 'RankDiscount_rankAccessString_a1920cc8',
    wl = 'RankDiscount_footer__maxRank_88b30d74',
    Nl = 'RankDiscount_valueContainer_513d8a27',
    Cl = 'RankDiscount_discountBackground_9a06158d',
    kl = r(({ index: s }) => {
        const { model: t } = dd(),
    ...
    Pl = r(({ index: s, className: t }) => {
        ...
        return e.jsxs('div', {
            ...
            children: [
                ...
                l && e.jsx('div', { className: vl }),
                e.jsx('div', { className: a(Sl, d && wl), children: e.jsx(kl, { index: s }) }),
            ],
        });
    }),
    Rl = 'DiscountSection_9acad8ef',
    Il = 'DiscountSection_discounts_c60041bb',
    yl = 'DiscountSection_rankDiscount_21ec2bb9',
    Al = 'DiscountSection_discountDescription_20f9cc53',
    Bl = r(({ className: s }) => {
        const { model: t } = dd();
        return e.jsxs('div', {
            className: a(Rl, s),
            children: [
                e.jsx(gl, { children: R.strings.comp7_ext.products.discountSectionName() }),
                e.jsx('div', {
                    className: Il,
                    children: T(t.computes.rankDiscountsLength(), (a) => e.jsx(Pl, { index: a, className: yl }, a)),
                }),
                e.jsx(H, { text: R.strings.comp7_ext.products.discountDescription(), classMix: Al }),
            ],
        });
    }),
    Tl = 'InProgressSection_fefaeb32',
    Dl = 'InProgressSection_content_b04c3856',
    Ll = 'InProgressSection_background_a19a49db',
    El = 'InProgressSection_highlight_f936c9ac',
    zl = 'InProgressSection_state_2d79ab7d',
    Ml = 'InProgressSection_inProgressString_9cafd080',
    Wl = 'InProgressSection_inProgressStringIcon_a4a5b2ae',
    Vl = ({ className: s }) =>
        e.jsxs('div', {
            className: a(Tl, s),
            children: [
                ...
                e.jsxs('div', {
                    ...
                    children: [
                        ...
                        e.jsx('div', {
                            ...
                            children: e.jsxs('div', {
                                className: Ml,
                                children: [e.jsx('div', { className: Wl }), R.strings.comp7_ext.products.inProgress()],
                            }),
                        }),
                    ],
                }),
    ...
    Hl = 'NationFlag_42e58a02',
    Ql = 'NationFlag_nationFlag_2f0a2e52',
    Ul = R.images.gui.maps.icons.eventBoards.flagsOverlay,
    $l = ({ nation: s, className: t }) =>
        e.jsxs('div', {
            className: a(Hl, t),
            children: [
                e.jsx('div', { className: Ql, style: { backgroundImage: `url(${Ul.$dyn(s)})` } }),
                e.jsx('div', { className: Ql, style: { backgroundImage: `url(${Ul.$dyn(s)})` } }),
            ],
        }),
    ql = 'NameSection_be509601',
    Ol = 'NameSection_nationFlag_bc9f5727',
    Fl = 'NameSection_productName_ebab47bb',
    Yl = 'NameSection_style3dSubtitle_f11dae45',
    Gl = 'NameSection_style3dSubtitleVehicleText_6fb3b14',
    Xl = 'NameSection_vehicleDescription_71fefa0',
    Kl = (e) => (e >= S.Medium ? Ea.x64 : Ea.x48),
    Jl = (e) => (e >= S.Large ? Ea.x48 : Ea.x24),
    Zl = r(({ className: s }) => {
        const { model: t } = dd(),
            { mediaSize: r } = v(),
        ...
        switch (i.type) {
            case Ha.Vehicle: {
                ...
                return e.jsxs('div', {
                    ...
                    children: [
                        ...
                        t.computes.hasVehicleDescription() && e.jsx(U, { text: i.description, classMix: Xl }),
                    ],
                });
            }
            case Ha.Style3d: {
                        ...
                        e.jsx(he, {
                            ...
                            children: e.jsx('div', {
                                children: e.jsx(U, {
                                    ...
                                    binding: { name: e.jsx(Qa, { name: i.name }) },
                                    classMix: Fl,
                                }),
                            }),
                        }),
            ...
            case Ha.Reward:
                return e.jsx('div', {
                    ...
                    children: e.jsx(he, {
                        args: n,
                        children: e.jsx('div', { className: Fl, children: i.reward.label }),
                    }),
                });
            default:
    ...
    a_ = r(() => {
        ...
        switch (i.state) {
            case Va.Locked:
                return e.jsxs(e.Fragment, {
                    children: [
                        e.jsx('div', { className: e_.separator }),
                        e.jsxs('div', {
                            ...
                            children: [
                                e.jsx('div', {
                                    ...
                                    style: {
                                        backgroundImage: `url(${ba(R.images.comp7.gui.maps.icons.products.accessBackgrounds, i.rank)})`,
                                    },
                                }),
                                e.jsxs('div', {
                                    className: e_.accessBlock,
                                    children: [
                                        e.jsx('div', { className: e_.lock }),
                                        e.jsx(U, {
                                            text: R.strings.comp7_ext.products.message.rankAccess(),
                                            binding: {
                                                rank: e.jsx('span', { className: e_.rankString, children: pa(i.rank) }),
                                            },
    ...
    t_ = r(({ className: s }) => {
        ...
        return e.jsxs('div', {
            className: a(e_.base, s),
            children: [
                e.jsx(gl, { children: R.strings.comp7_ext.products.priceSectionName() }),
                e.jsxs('div', {
                            ...
                            children: [
                                e.jsxs('div', {
                                    ...
                                    children: [
                                        n &&
                                            e.jsxs('div', {
                                                className: a(e_.discount, e_[`discount__${r.price.name}`]),
                                                children: [
                                                    e.jsx(x, { value: r.price.value }),
                                                    e.jsx('div', { className: e_.discountLine }),
                                                ],
                                            }),
                                        e.jsx(Me, {
                                            type: r.price.name,
    ...
    r_ = 'PurchasedSection_6164cf64',
    i_ = 'PurchasedSection_content_d868988b',
    n_ = 'PurchasedSection_state_30f7765d',
    o_ = 'PurchasedSection_purchasedString_f2d4b10a',
    c_ = 'PurchasedSection_purchasedStringIcon_396eb88c',
    d_ = 'PurchasedSection_quantityOfferString_9c521da',
    l_ = 'PurchasedSection_background_7dd21da0',
    __ = 'PurchasedSection_highlight_8cd4f52',
    m_ = 'PurchasedSection_buttonContainer_f3e259c2',
    u_ = 'PurchasedSection_button_c980ad41',
    h_ = r(() => {
        const { model: a, controls: s } = dd(),
        ...
        return e.jsxs('div', {
            ...
            children: [
                ...
                e.jsxs('div', {
                    className: i_,
                    children: [
                        e.jsx('div', { className: l_ }),
                        e.jsx('div', { className: __ }),
                        e.jsxs('div', {
                            className: n_,
                            children: [
                                e.jsxs('div', {
    ...
    p_ = 'ReadyToRestoreSection_2e7dcd59',
    x_ = 'ReadyToRestoreSection_content_65d667a0',
    b_ = 'ReadyToRestoreSection_description_67d7fa6f',
    f_ = 'ReadyToRestoreSection_buttonContainer_37adf442',
    v_ = 'ReadyToRestoreSection_button_8778f905',
    S_ = r(({ className: s }) => {
        const { controls: t } = dd(),
            { mediaSize: r } = v();
        return e.jsxs('div', {
    ...
    j_ = 'ProductDetails_8c03fb32',
    w_ = 'ProductDetails_section_dcf92365',
    N_ = [Va.Locked, Va.ReadyToPurchase],
    C_ = r(({ className: s }) => {
        const { model: t } = dd(),
            r = t.computes.selectedProduct();
        return e.jsxs('div', {
            className: a(j_, s),
            children: [
                e.jsx(Zl, { className: w_ }),
                N_.includes(r.state) && e.jsx(Bl, { className: w_ }),
                (() => {
                    switch (r.state) {
                        case Va.Purchased:
                            return e.jsx(g_, { className: w_ });
                        case Va.InProgress:
                            return e.jsx(Vl, { className: w_ });
                        case Va.ReadyToRestore:
                            return e.jsx(S_, { className: w_ });
                        default:
                            return e.jsx(t_, { className: w_ });
                    }
                })(),
            ],
        });
    }),
    k_ = { from: { opacity: 0 }, to: { opacity: 1 }, config: { duration: 300 } },
    P_ = {
        from: { opacity: 0, transform: 'translate(-50%, -50%) scale(0.9)' },
        to: { opacity: 1, transform: 'translate(-50%, -50%) scale(1)' },
        config: { duration: 100 },
    },
    R_ = 'ShopPage_7caee38d',
    I_ = 'ShopPage_sceneWrapper_d44346fd',
    y_ = 'ShopPage_vignette_823cbd98',
    A_ = 'ShopPage_headersWrapper_3bd5a059',
    B_ = 'ShopPage_activeSeasonState_bb0c25d9',
    T_ = 'ShopPage_contentWrapper_d401697c',
    D_ = 'ShopPage_rewardContainer_99ec190d',
    L_ = 'ShopPage_rewardBase_bb0c25d9',
    E_ = 'ShopPage_rewardHighlight_c5563e7',
    z_ = 'ShopPage_controls_b6cdda75',
    M_ = 'ShopPage_mainContainer_f2e01656',
    W_ = 'ShopPage_details_189bbbd4',
    V_ = 'ShopPage_carousel_1cf76ba5',
    H_ = (e) => (e >= S.Large ? Ne.S600x450 : e >= S.Small ? Ne.S400x300 : Ne.S296x222),
    Q_ = r(() => {
        const { model: a } = dd(),
            { mediaSize: t } = v(),
            r = o(la),
        ...
        return (
            s.useLayoutEffect(() => {
                (m.set(P_.from), l.set(k_.from));
            }, [m, l, i.id, i.state]),
            s.useEffect(() => {
                (m.start({ ...P_, delay: 300 }), l.start({ ...k_, delay: 100 }));
            }, [m, l, i.id, i.state]),
            e.jsxs(e.Fragment, {
                children: [
                    i.type === Ha.Reward &&
                        e.jsxs('div', {
                            className: D_,
                            children: [
                                e.jsx('div', { className: E_ }),
                                e.jsx(c.div, {
                                    style: d,
                                    children: e.jsx(Pe, {
                                        ...Ma({ reward: i.reward, size: H_(t) }),
                                        tooltipArgs: He({ tooltipId: i.tooltipId, id: i.id }),
                                        className: L_,
                                    }),
                                }),
                            ],
                        }),
                    n && e.jsx(c.div, { style: _, className: z_, children: e.jsx(cl, {}, i.id) }),
                    e.jsx(c.div, { style: d, className: M_, children: e.jsx(C_, { className: W_ }) }),
                    e.jsx(c.div, { style: r, children: e.jsx(il, { className: V_ }) }),
                ],
            })
        );
    }),
    U_ = { activeSeasonState: B_ },
    $_ = { [id.Initial]: () => e.jsx('div', {}), [id.Success]: Q_, [id.Error]: ws },
    q_ = r(() => {
        const a = o(la),
            { model: s, controls: t } = dd(),
            ...
            ? e.jsxs('div', {
                  ...
                  children: [
                      i &&
                          e.jsx('div', {
                              className: I_,
                              children: e.jsx(Qe, { moveSpace: t.moveSpace, onMouseOver3dScene: t.mouseOver3dScene }),
                          }),
                      r !== id.Error && e.jsx('div', { className: y_ }),
                      e.jsx('div', { className: A_, children: e.jsx(va, { classNames: U_ }) }),
                      e.jsx(c.div, { className: T_, style: a, children: e.jsx(n, {}) }),
                  ],
              })
...
const F_ = [O_.LOCKED_BY_NO_X_VEHICLES, O_.LOCKED_BY_INACTIVE_SEASON, O_.LOCKED_BY_PREVIOUS_QUEST],
    [Y_, G_] = w()(
        ({ observableModel: e }) => {
            const a = {
                    root: e.object(),
                ...
                s = t(
                    (e) => {
                        const s = e * Ua,
                            t = [...ve(a.questCards.get(), s, s + Ua - 1)];
                        if (t.length !== Ua)
                            throw new Error(`Unexpected weekly list length: ${t.length} expected: ${Ua}`);
                        return t;
                    },
                    { equals: N },
                ),
                ...
                i = t(
                    (e, a, s) => {
                        ...
                        return Wa({ rewards: t, size: s });
                    },
                    { equals: N },
                ),
                n = t((e, a) => F_.includes(r(e, a).state));
            return {
                ...a,
    ...
    X_ = 'CountdownStatus_8bd2c608',
    K_ = 'CountdownStatus_content_ba867330',
    J_ = 'CountdownStatus_shine_11fd24ed',
    Z_ = 'CountdownStatus_text_23310da3',
    em = 'CountdownStatus_countDownWrapper_772ca654',
    am = 'CountdownStatus_countDownIcon_94b471ff',
    sm = 'CountdownStatus_timer_f5350620',
    tm = r(({ className: s }) => {
        const { model: t } = G_(),
            ...
            children: e.jsxs('div', {
                ...
                children: [
                    ...
                    -1 === r
                        ...
                        : e.jsx(U, {
                              text: R.strings.comp7_ext.weeklyQuests.CountdownStatus.active(Ua),
                              binding: {
                                  value: Ua,
                                  countdown: e.jsxs('div', {
                                      className: em,
                                      children: [
                                          e.jsx('div', { className: am }),
                                          e.jsx(Ue, { icon: $e.None, duration: r, classNames: { text: sm } }),
                                      ],
                                  }),
                              },
                              classMix: Z_,
    ...
    rm = 'Progress_868e8f6f',
    im = 'Progress_counter_28173a36',
    nm = 'Progress_current_89c6d7a7',
    om = 'Progress_progressBar_8570680b',
    cm = ({ current: s, total: t, isDisabled: r, className: i }) =>
        e.jsxs('div', {
            className: a(rm, i),
            children: [
                e.jsx(U, {
                    ...
                    binding: {
                        current: e.jsx('div', { className: nm, children: e.jsx(x, { value: s }) }),
                        total: e.jsx(x, { value: t }),
                    },
                }),
                e.jsx('div', {
                    className: om,
                    children: e.jsx(Pa, { size: pe.Small, value: s, maxValue: t, disabled: r }),
                }),
            ],
        }),
    dm = {
    ...
    lm = r(({ weeklyIndex: s, index: t, className: r }) => {
        const { model: i } = G_(),
        ...
        return e.jsx(p, {
            ...
            children: e.jsxs('div', {
                className: a(dm.base, o ? dm.base__locked : dm[`base__${n}`], r),
                children: [
                    e.jsx('div', { className: dm.icon }),
                    e.jsx('div', {
                        className: dm.text,
                        children: String(
                            o
    ...
    mm = (e) => (F_.includes(e) ? 'locked' : e),
    um = r(({ weeklyIndex: s, index: t }) => {
        const { model: r } = G_(),
            { state: i, currentProgress: n, totalProgress: o, description: c, iconKey: d } = r.computes.questCard(s, t),
            { mediaSize: l } = v(),
            _ = l > S.Large ? Ne.Big : Ne.Small;
        return e.jsxs('div', {
            className: a(_m.base, _m[`base__${mm(i)}`]),
            children: [
                i === O_.ACTIVE &&
                    e.jsxs(e.Fragment, {
                        children: [
                            e.jsx('div', {
                                className: _m.highlightContainer,
                                children: e.jsx('div', { className: _m.highlight }),
                            }),
                            e.jsx(ka, { className: _m.glowContainer, classNames: { glow: _m.glow } }),
                        ],
                    }),
                e.jsx('div', {
                    className: _m.icon,
                ...
                e.jsxs('div', {
                    ...
                    children: [
                        e.jsx(cm, { current: n, total: o, isDisabled: i !== O_.ACTIVE, className: _m.progress }),
                        e.jsx('div', { className: _m.description, children: c }),
                        e.jsx(Ce, { data: r.computes.questRewards(s, t, _), size: _, rewardItemClassMix: _m.reward }),
                    ],
                }),
                e.jsx(lm, { weeklyIndex: s, index: t, className: _m.status }),
            ],
        });
    }),
    hm = {
...
const pm = ({ type: s }) =>
        'sideLeft' === s || 'sideRight' === s
            ? e.jsx('div', {
                  className: hm.line,
                  children: e.jsx('div', { className: a(hm.shine, hm[`shine__${s}`]) }),
              })
            : e.jsxs('div', {
                  className: a(hm.base, hm[`base__${s}`]),
                  children: [
                      e.jsx('div', { className: a(hm.line, hm.line__top) }),
                      e.jsx('div', { className: hm.arrowContainer, children: e.jsx('div', { className: hm.arrow }) }),
                      e.jsx('div', { className: a(hm.line, hm.line__bottom) }),
                  ],
              }),
    xm = 'WeeklyList_6acdc358',
    bm = r(({ weeklyIndex: t, className: r }) => {
        const { model: i } = G_(),
            { computes: n } = i;
        return e.jsxs('div', {
            className: a(xm, r),
            children: [
                e.jsx(pm, { type: gm.SideLeft }),
                T(Ua, (a) =>
                    e.jsxs(
                        s.Fragment,
                        {
                            children: [
                                a > 0 && e.jsx(pm, { type: n.isQuestLocked(t, a) ? gm.Normal : gm.Highlighted }),
                                e.jsx(um, { weeklyIndex: t, index: a }),
                            ],
                        },
                        a,
                    ),
                ),
                e.jsx(pm, { type: gm.SideRight }),
            ],
        });
    }),
    fm = 'QuestsList_d9995b1a',
    vm = 'QuestsList_scrollWrapper_f3107796',
    Sm = 'QuestsList_weeklyList_832ee756',
    jm = 'QuestsList_countdownStatus_ea0d6a1d',
    wm = 'QuestsList_countdownStatus__show_80949577',
    Nm = { wrapper: 'QuestsList_contentWrapper_71c1145a', content: 'QuestsList_scrollContent_c8f7fb3d' },
    Cm = r(({ className: t }) => {
        const [r, i] = s.useState(!1),
            { model: n } = G_(),
            o = Math.floor(n.questCards.get().length / Ua),
            c = o > 1,
            { api: d } = Se();
        return (
            ...
            e.jsxs('div', {
                ...
                children: [
                    e.jsx(se, {
                        className: vm,
                        classNames: Nm,
                        children: T(o, (a) => e.jsx(bm, { weeklyIndex: a, className: Sm }, a)),
                    }),
                    e.jsx('div', { className: a(jm, (r || !c) && wm), children: e.jsx(tm, {}) }),
                ],
            })
        );
    }),
    km = 'ClaimRewardsButton_18e5447e',
    Pm = 'ClaimRewardsButton_light_be50b778',
    Rm = 'ClaimRewardsButton_inner_7b993d26',
    Im = 'ClaimRewardsButton_inner__disabled_d2c4d3fe',
    ym = 'ClaimRewardsButton_button_878a517b',
    Am = 'ClaimRewardsButton_button__disabled_47a644a1',
    Bm = 'ClaimRewardsButton_buttonBlink_32b5afcb',
    Tm = 'ClaimRewardsButton_buttonText_c765bc66',
    Dm = { from: { opacity: 0 }, to: { opacity: 0.6 }, delay: 500, config: { duration: 300 } },
    Lm = ({ isDisabled: s, onClick: t, children: r, className: i }) => {
        const n = o(Dm);
        return e.jsx(p, {
            isEnabled: s,
            ...
            children: e.jsxs('div', {
                className: a(km, i),
                children: [
                    !s && e.jsx(c.div, { className: Pm, style: n }),
                    e.jsx('div', {
                        className: a(Rm, s && Im),
                        children: e.jsxs(qe, {
                            type: Fe.ghost,
    ...
    Mm = ({ reward: s, onClick: t, isDisabled: r, className: i }) => {
        const n = o(zm);
        return e.jsxs('div', {
            className: a(Em.base, i),
            children: [
                e.jsx(c.div, { className: Em.shine, style: n }),
                e.jsx('div', { className: Em.claimRewardsButton, children: e.jsx(Lm, { isDisabled: r, onClick: t }) }),
                e.jsx(Pe, { ...s, className: Em.reward }),
            ],
        });
    },
    Wm = 'FinalRewards_9a8bf88c',
    Vm = 'FinalRewards_wrapper_170e19ff',
    Hm = 'FinalRewards_reward_21094ad5',
    Qm = 'FinalRewards_reward__achieved_4f37d4ba',
    Um = 'FinalRewards_check_e0f8cdc4',
    $m = r(({ rewards: s, className: t }) => {
        const { model: r, controls: i } = G_(),
                        ...
                        'div',
                        {
                            ...
                            children:
                                'deluxe_gift' === s.name && n === $a.Active
                                    ...
                                    : e.jsx(Pe, { ...s, className: a(Hm, n === $a.Claimed && Qm) }),
                        },
                        t,
                    ),
                ),
                n === $a.Claimed && e.jsx('div', { className: Um }),
            ],
        });
    }),
    qm = 'TokenPoint_b2c16526',
    Om = 'TokenPoint_tokenValue_9a7b3b15',
    Fm = 'TokenPoint_tokenValue__passed_90164b9e',
    Ym = 'TokenPoint_serif_397af316',
    Gm = 'TokenPoint_rewards_b91973cd',
    Xm = 'TokenPoint_rewards__passed_f41dfa43',
    Km = 'TokenPoint_reward_a1f93701',
    Jm = 'TokenPoint_check_df0c82c9',
    Zm = Ne.Small,
    eu = r(({ tokenValue: s, rewards: t }) => {
        const { model: r } = G_(),
        ...
        return e.jsxs('div', {
            className: qm,
            children: [
                e.jsx('div', { className: a(Om, n && Fm), children: s }),
                e.jsx('div', { className: Ym }),
                t &&
                    e.jsx(Ce, {
                        data: Wa({ rewards: t, size: Zm }),
                        size: Zm,
                        classMix: a(Gm, n && Xm),
                        rewardItemClassMix: Km,
                    }),
                n && 0 !== s && t && e.jsx('div', { className: Jm }),
            ],
        });
    }),
    au = 'TokenProgress_6a6dc31c',
    su = 'TokenProgress_header_13e02096',
    tu = 'TokenProgress_subheader_aafe2591',
    ru = 'TokenProgress_content_3fb4abff',
    iu = 'TokenProgress_progress_3b86b1ea',
    nu = 'TokenProgress_progressBar_8b59b672',
    ou = 'TokenProgress_points_984654f1',
    cu = 'TokenProgress_point_b0b7f70e',
    du = 'TokenProgress_finalRewards_9e9ca6b',
    lu = (e, a) => ({ left: (100 / e) * a + '%' }),
    _u = Ne.Big,
    mu = r(({ className: t }) => {
        const { model: r, controls: i } = G_(),
        ...
        return e.jsxs('div', {
            ...
            children: [
                ...
                e.jsx(U, {
                    text: R.strings.comp7_ext.weeklyQuests.TokenProgress.subheader(Ua),
                    binding: { value: Ua },
                    classMix: tu,
                }),
                e.jsxs('div', {
                    ...
                    children: [
                        e.jsxs('div', {
                            ...
                            children: [
                                ...
                                e.jsxs('div', {
                                    className: ou,
                                    children: [
                                        e.jsx('div', { className: cu, children: e.jsx(eu, { tokenValue: 0 }) }),
                                        C(c, (a, s) =>
                                            e.jsx(
                                                'div',
                                                {
                        ...
                        d && e.jsx($m, { rewards: Wa({ rewards: d.rewards, size: _u }), className: du }),
                    ],
                }),
            ],
        });
    }),
    uu = 'WeeklyQuestsPage_e1246e87',
    hu = 'WeeklyQuestsPage_content_968b1834',
    gu = 'WeeklyQuestsPage_questsList_d039410f',
    pu = 'WeeklyQuestsPage_progression_ad79fcdc',
    xu = () => {
        const a = o(la),
            s = ee();
        return e.jsxs('div', {
            ...
            children: [
                ...
                e.jsxs(c.div, {
                    ...
                    style: a,
                    children: [
                        e.jsx(ae, { api: s, children: e.jsx(Cm, { className: gu }) }),
                        e.jsx(mu, { className: pu }),
                    ],
                }),
            ],
        });
    ...
    fu = [bu.firstStage, bu.secondStage, bu.thirdStage, bu.fourthStage, bu.fifthStage, bu.sixthStage],
    vu = fu.map((e) => e.name),
    ...
    wu = qa({
        steps: [
            bu.inactiveProgression,
            bu.firstStageSeasonPoints,
            bu.firstStage,
            bu.secondStageSeasonPoints,
            bu.secondStage,
            bu.thirdStageSeasonPoints,
            bu.thirdStage,
            bu.fourthStageSeasonPoints,
            bu.fourthStage,
            bu.fifthStageSeasonPoints,
            bu.fifthStage,
            bu.sixthStageSeasonPoints,
            bu.sixthStage,
            bu.showLegend,
            bu.transitionToRealData,
            bu.realData,
        ],
    }),
    Nu = ({ children: a }) => {
        const s = wu();
        return e.jsx(Su.Provider, { value: s, children: a });
    };
var Cu = ((e) => (
...
const Pu = ['customizations', 'modernized_devices_t1_gift', 'modernized_devices_t2_gift', 'modernized_devices_t3_gift'],
    Ru = ['vehicles', 'premiumTank'],
    Iu = ['styleProgressToken'],
    yu = ['modernized_devices_t1_gift', 'modernized_devices_t2_gift', 'modernized_devices_t3_gift', 'deluxe_gift'];
const Au = (e) => Pu.includes(e.name),
    Bu = (e) => Ru.includes(e.name),
    Tu = (e) => yu.includes(e.name);
function Du(e) {
    return X(
        e,
        (e, a, s) => (
            void 0 === e.vehicleIndex && Bu(a)
                ? (e.vehicleIndex = s)
                : void 0 === e.style3dIndex && ((e) => Iu.includes(e.name))(a)
                  ? (e.style3dIndex = s)
                  : void 0 === e.claimableRewardIndex && Tu(a) && (e.claimableRewardIndex = s),
            e
        ),
        { vehicleIndex: void 0, style3dIndex: void 0, claimableRewardIndex: void 0 },
    );
}
function Lu({ reward: e, bannerState: a, cardIndex: s, maxAchievedCardIndex: t }) {
    return a === ku.RewardsSelectionAvailable && s <= t && Tu(e) && !e.claimed;
}
const [Eu, zu] = w()(
        ({ observableModel: e }) => {
            const a = {
                ...
                l = t((e) =>
                    X(
                        ...
                        (a, s) =>
                            a +
                            (function (e, a) {
                                return Ye(e, ({ season: e }) => e === a).length;
                            })(s.seasonPoints, e),
                        0,
                    ),
                ),
                _ = t(
                    () => {
                        const e = a.cards.get();
                        return {
                            possible: Ke(e, (e) => e.rewardsState === Cu.Possible),
                            guaranteed: Ke(e, (e) => e.rewardsState === Cu.Guaranteed),
                        };
                    },
                    { equals: i.shallow },
                ),
                ...
                u = t(
                    () => {
                        const e = Y(a.cards.get(), (e) => void 0 !== Y(e.rewards, Bu));
                        if (!e) throw new Error('no one card consists vehicle, please change config with rewards');
                        return { ...e.vehicle };
                    },
                    { equals: N },
                ...
                h = t(() => {
                    ...
                    return (function ({ maxIndex: e, possible: a, guaranteed: s }) {
                        return void 0 !== a ? Xe(0, e, a + 1) : void 0 !== s ? Xe(0, e, s + 1) : 0;
                    })({ maxIndex: a.cards.get().length - 1, possible: e, guaranteed: s });
                }),
                g = t(() => {
                    const e = a.cards.get();
                    return Ke(e, (e) => !Je(e.seasonPoints, (e) => e.state === ca.NotAchieved)) ?? -1;
                }),
                p = t((e) => Y(r(e), Au), { equals: N }),
                x = t((e) => {
                    const s = p(e);
                    if (!s) return !1;
                    const t = g(),
                        { bannerState: r } = a.root.get();
                    return Lu({ reward: s, bannerState: r, cardIndex: e, maxAchievedCardIndex: t });
                }),
                b = t((e) => {
                ...
                v = t((e) => {
                    const a = r(e),
                        s = F(a, Au);
                    return void 0 === s ? a : Ye(a, (e, a) => a !== s);
                }),
                S = t(
                    (e) => {
                        const s = v(e),
                            { vehicleIndex: t, style3dIndex: r, claimableRewardIndex: i } = Du(s);
                        return {
                            hasStyle3d: void 0 !== r,
                            showClaimableReward:
                                void 0 !== i &&
                ...
                j = t(() => {
                    ...
                    if (e !== ku.RewardsSelectionAvailable) return !1;
                    const s = g();
                    return Je(a.cards.get(), (a, t) =>
                        Je(a.rewards, (a) => Lu({ reward: a, bannerState: e, cardIndex: t, maxAchievedCardIndex: s })),
                    );
                }),
                w = t(() => {
    ...
    Wu = r(({ className: s }) => {
        const { model: t } = zu(),
            ...
            o = r.year.state.get() === Pc.Finished,
            c = t.computes.maxAchievedCardIndex(),
            d = t.cards.get().length - 1;
        return e.jsxs('div', {
            className: a(
                Mu.base,
                i && Mu.base__withIntro,
                Mu[`base__hoveredCardIndex_${n}`],
                o && Mu.base__finishedYear,
                s,
            ),
            children: [
                T(d, (s) =>
                    e.jsx(
                        'div',
                        { className: a(Mu.overlay, Mu[`overlay__${vu[s]}`], o && s === c && Mu.overlay__achieved) },
                        s,
                    ),
                ),
                e.jsx('div', { className: a(Mu.overlay, Mu.overlay__full, o && d === c && Mu.overlay__achieved) }),
            ],
        });
    }),
    Vu = { from: { opacity: 0 }, to: { opacity: 1 }, delay: 600, config: { duration: 300 } },
    Hu = la.delay + la.config.duration + 500,
    Qu = 'ActiveCardHighlight_dcbae8f8',
    Uu = 'ActiveCardHighlight_glow_bab58c6d',
    $u = ({ isAnimated: s, visible: t, hasDelay: r, className: i }) => {
        const n = o({ from: { opacity: 0 }, to: { opacity: t ? 1 : 0 }, delay: r ? Hu : 0, config: { duration: 300 } });
        return e.jsx(c.div, { className: a(Qu, i), style: n, children: e.jsx(ka, { className: Uu, animated: s }) });
    },
    qu = 'AdditionalRewards_rewardItem_ee31ff1d',
    Ou = 'AdditionalRewards_reward_3c5d7930',
    Fu = 'AdditionalRewards_reward__withPlus_309d3136',
    Yu = 'AdditionalRewards_reward__claimable_1ed2adc5',
    Gu = 'AdditionalRewards_info_42163f85',
    Xu = 'AdditionalRewards_rewardWithPlusImage_275019e0',
    Ku = 'AdditionalRewards_claimableReward_c7f66cac',
    Ju = 'AdditionalRewards_shine_982567ad',
    Zu = 'AdditionalRewards_claimRewardsButton_5eb60b4d',
    eh = ({ onClick: a, children: s }) => {
        const t = o(Vu);
        return e.jsxs('div', {
            className: Ku,
            children: [
                e.jsx(c.div, { className: Ju, style: t }),
                s,
                e.jsx('div', {
                    className: Zu,
                    children: e.jsx(Lm, {
    ...
    sh = Ou,
    th = { info: Gu },
    rh = r(({ cardIndex: t, visibleRewardsCount: r, className: i, rewardItemClassMix: n }) => {
        const { model: o, controls: c } = zu(),
            ...
            m = s.useMemo(
                () =>
                    C(d, (e, s) => {
                        ...
                        return {
                            ...Ma({ reward: e, size: ah, index: t }),
                            className: a(sh, n && Yu, i && Fu),
                            classNames: { ...th, ...(i && { image: Xu }) },
                            ...(n && { RewardWrapper: eh, rewardWrapperProps: { onClick: _(e.name, t) } }),
                        };
                    }),
        ...
        return e.jsx(Ce, {
            ...
            size: ah,
            count: Sc(d.length, r),
            rewardItemClassMix: a(qu, n),
            boxRewardTooltip: {
                contentId: R.views.lobby.tooltips.AdditionalRewardsTooltip('resId'),
                args: { fromIndex: r, index: t },
            },
            classMix: i,
            boxRewardClassName: sh,
            boxRewardClassNames: th,
        });
    }),
    ih = r(({ cardIndex: a, pointIndex: s, size: t, className: r, classNames: i }) => {
        const { model: n } = zu(),
        ...
        return e.jsx(V, {
            ...
            args: { state: o.state },
            ignoreShowDelay: !0,
            children: e.jsx('div', { className: r, children: e.jsx(Oa, { ...o, className: i?.point, size: t }) }),
        });
    }),
    nh = 'CardSeasonPoints_654279b7',
    oh = r(({ cardIndex: s, size: t, className: r, classNames: i }) => {
        const { model: n } = zu();
        return e.jsx('div', {
            className: a(nh, r),
            children: T(n.computes.seasonPointsLength(s), (a) =>
                e.jsx(
                    ih,
                    {
                        ...
                        pointIndex: a,
                        size: t,
                        className: i?.pointWrapper,
                        classNames: { point: i?.point },
                    },
                    a,
                ),
            ),
    ...
    ch = [
        [{ season: da.First }, { season: da.First }, { season: da.First }],
        [{ season: da.First }, { season: da.First }, { season: da.First }],
        [{ season: da.Second }, { season: da.Second }, { season: da.Second }],
        [{ season: da.Second }, { season: da.Second }, { season: da.Second }],
        [{ season: da.Third }, { season: da.Third }, { season: da.Third }],
        [{ season: da.Third }, { season: da.Third }, { season: da.Third }],
    ],
    dh = {
    ...
    lh = ['first', 'second', 'third'],
    _h = ({ cardIndex: s, size: t, className: r, classNames: i }) => {
        const n = ch[s];
        return e.jsxs('div', {
            className: a(dh.base, dh[`base__${vu[s]}`], r),
            children: [
                e.jsx('div', {
                    className: dh.notAchievedSeasonPoints,
                    children: n.map(({ season: s }, r) =>
                        e.jsx(
                            'div',
                            {
                                className: i?.pointWrapper,
                                children: e.jsx(Oa, {
                                    state: ca.NotAchieved,
                                    season: s,
                                    size: t,
                                    className: a(dh.notAchievedPoint, dh[`notAchievedPoint__${lh[r]}`], i?.point),
                                }),
                            },
                            r,
                        ),
                ...
                e.jsx('div', {
                    className: dh.achievedSeasonPoints,
                    children: n.map(({ season: s }, r) =>
                        e.jsx(
                            'div',
                            {
                                ...
                                children: e.jsx(Oa, {
                                    ...
                                    season: s,
                                    size: t,
                                    className: a(dh.achievedPoint, dh[`achievedPoint__${lh[r]}`], i?.point),
                                }),
                            },
                            r,
                        ),
    ...
    mh = r(({ cardIndex: a, size: s, className: t, classNames: r }) => {
        const { model: i } = zu(),
            n = i.computes.mainReward(a);
        if (!n) throw new Error(`no mainReward in card with index ${a}`);
        return e.jsx(Pe, {
            ...Ma({ reward: n, size: s, index: a }),
            className: t,
            classNames: { rewardIcon: r?.icon, image: r?.iconContainer },
        });
    }),
    uh = {
    ...
    hh = ({ seasonPointsCount: s, rewardsState: t, className: r }) =>
        e.jsx('div', {
            className: a(uh.base, uh[`base__${t}`], r),
            children: e.jsx(p, {
                body: `${R.strings.comp7_ext.yearlyRewards.rewardsState.tooltip.$dyn(t)}`,
                isEnabled: t !== Cu.Claimed,
                children: e.jsxs('div', {
                    className: uh.description,
                    children: [
                        t === Cu.NotAvailable && e.jsx('div', { className: uh.shadow }),
                        e.jsx('div', { className: uh.statusIcon }),
                        Q(`${R.strings.comp7_ext.yearlyRewards.rewardsState.$dyn(t)}`, { count: s }),
                    ],
                }),
            }),
        }),
    gh = r(({ index: a, className: s, classNames: t }) => {
        const { mediaSize: r } = v(),
            { model: i, controls: n } = zu(),
    ...
    xh = { preview: ph.preview, label: ph.previewLabel },
    bh = { pointWrapper: ph.seasonPointWrapper },
    fh = r(
        ({
            index: t,
            mainRewardSize: r,
            ...
            const { mediaSize: m } = v(),
                ...
                B = !x && p !== Pc.Finished && t === N;
            return (
                s.useEffect(() => {
                    t === k && b.sound('comp_7_annual_reward_column');
                }, [k, t]),
                e.jsxs('div', {
                    className: a(ph.base, A && 'grayscaledColumn', x && ph.base__withIntro, _),
                    onMouseEnter: () => h.setHoveredCardIndex(t),
                    onMouseLeave: () => h.setHoveredCardIndex(-1),
                    children: [
                        e.jsx('div', { className: a(ph.hoverArea, y && ph.hoverArea__last) }),
                        e.jsxs('div', {
                            className: ph.fakeSeasonPointsContainer,
                            children: [
                                e.jsx(_h, { cardIndex: t, size: i, classNames: bh }),
                                !y && e.jsx(gl, { className: a(ph.divider, t <= k && ph.divider__highlighted) }),
                            ],
                        }),
                        e.jsxs('div', {
                            className: ph.seasonPointsContainer,
                            children: [
                                e.jsx(oh, { cardIndex: t, size: i, classNames: bh }),
                                !y && e.jsx(gl, { className: a(ph.divider, t < N && ph.divider__highlighted) }),
                            ],
                        }),
                        e.jsxs('div', {
                            className: ph.mainRewardOuterContainer,
                            children: [
                                P && e.jsx(c.div, { className: ph.shine, style: I }),
                                e.jsx('div', {
                                    className: a(ph.mainRewardContainer, ph[`mainRewardContainer__${r}`]),
                                    children:
                                        j &&
                                        e.jsx(mh, {
                                            cardIndex: t,
                                            size: r,
                                            className: a(ph.mainReward, P && ph.mainReward__claimable),
                                        }),
                                }),
                                j &&
                                    P &&
                                    e.jsx('div', {
                                        className: ph.claimRewardsButton,
                                        children: e.jsx(Lm, {
                                            isDisabled: !1,
                        ...
                        e.jsx(gh, { index: t, className: ph.previewContainer, classNames: xh }),
                        e.jsx(hh, { seasonPointsCount: w, rewardsState: f, className: ph.rewardsStatus }),
                        e.jsx(rh, { cardIndex: t, visibleRewardsCount: n, className: ph.additionalRewards }),
                        e.jsxs('div', {
                            className: a(ph.description, B && ph.description__visible),
                            children: [
                                e.jsx($u, { hasDelay: d, visible: l, isAnimated: B, className: ph.glowContainer }),
    ...
    Sh = r(({ className: t }) => {
        const { mediaSize: r } = v(),
            ...
            g = ((e) => (e >= S.ExtraLarge ? Fa.x32 : Fa.x24))(r),
            p = o(la),
    ...
    Nh = r(({ index: s, size: t, seasonName: r, className: i }) => {
        const { model: n } = zu(),
        ...
        return e.jsx(
            'div',
            {
                className: i,
                children: e.jsxs('div', {
                    className: a(wh.rankWrapper, d && wh.rankWrapper__withIntro),
                    children: [
                        _.rank === o &&
                            e.jsx(ke, {
                                className: wh.highlight,
                                src: String(R.videos.comp7.godRaysNew_130x130()),
                                autoplay: !0,
                                loop: !0,
                            }),
                        e.jsx(pt, {
                            ...
                            className: wh.tooltipArea,
                            ignoreShowDelay: !0,
                            children: e.jsx(ma, {
                                seasonName: r,
                                rank: _.rank,
                                size: t,
                                className: a(wh.rankEmblem, l && wh.rankEmblem__active),
                            }),
                        }),
                    ],
                }),
    ...
    Ph = r(({ className: s }) => {
        const { mediaSize: t } = v(),
            ...
            u = ((e) => (e >= S.Large ? ua.x64 : ua.x48))(t);
        return e.jsxs('div', {
            className: a(wh.base, c && wh.base__withIntro, s),
            children: [
                e.jsxs('div', {
                    className: wh.status,
                    children: [
                                ...
                                children: [
                                    e.jsx(U, {
                                        ...
                                        binding: {
                                            rank: e.jsx('div', {
                                                className: wh.rank,
                                                children: Q(R.strings.comp7_ext.quotesWrapper(), { name: fa(n) }),
                                            }),
                                        },
                                        classMix: wh.secondaryText,
                                    }),
                                    e.jsx('div', { className: wh.verticalSeparator }),
                                ],
                            }),
                        e.jsx(U, {
                            text: m.description,
                ...
                e.jsxs('div', {
                    ...
                    children: [
                        T(r.ranks.get().length, (a) =>
                            e.jsx(Nh, { index: a, size: u, seasonName: d, className: wh.item }, a),
                        ),
                        e.jsx('div', { className: wh.arrowContainer, children: e.jsx('div', { className: wh.arrow }) }),
                        e.jsxs('div', {
                            className: wh.pointsCount,
                            children: [
                                e.jsxs('div', {
                                    className: wh.countContainer,
                                    children: [
                                        e.jsx('div', { className: wh.fakeCount, children: '0' }),
                                        e.jsx('div', { className: wh.count, children: _ }),
                                    ],
                                }),
                                e.jsx('div', {
                                    className: wh.seasonPoint,
                                    children: e.jsx(V, {
                                        contentId: R.views.comp7.mono.lobby.tooltips.season_point_tooltip('resId'),
                                        args: kh,
                                        ignoreShowDelay: !0,
                                        children: e.jsx('div', {
                                            children: e.jsx(Oa, { state: Ch, season: d, size: jh(t) }),
                                        }),
                                    }),
                                }),
                            ],
    ...
    Rh = 'StatusBanner_38fab065',
    Ih = 'StatusBanner_description_b2b220da',
    yh = r(({ className: s }) => {
        const { model: t } = zu(),
    ...
    Th = r(({ className: t }) => {
        const { model: r } = zu(),
            ...
            c = Z(),
            d = i.year.state.get() === Pc.Finished ? r.computes.maxAchievedCardIndex() : r.computes.activeCardIndex(),
            l = !n && Bh.includes(d) && -1 === o ? d : o;
        return (
            s.useEffect(() => {
                !c && Bh.includes(l) && b.sound('comp_7_annual_reward_tank_emergence_style');
            }, [c, l, n]),
            e.jsxs('div', {
                className: a(Ah.base, Ah[`base__selectedIndex_${l}`], t),
                children: [
                    e.jsx('div', { className: a(Ah.vehicleBg, Ah.vehicleBg__inactive) }),
                    Bh.map((s) => e.jsx('div', { className: a(Ah.vehicleBg, Ah[`vehicleBg__${s}`]) }, s)),
                ],
            })
        );
    }),
    Dh = 'VehicleInfo_a6ed28fa',
    Lh = 'VehicleInfo_background_29dc08d2',
    Eh = 'VehicleInfo_content_536b4958',
    zh = 'VehicleInfo_title_8c67bd16',
    Mh = (e) => (e >= S.Large ? Ea.x64 : Ea.x48),
    Wh = r(({ className: s, classNames: t }) => {
        const { mediaSize: r } = v(),
            { model: i } = zu(),
            ...
            children: [
                ...
                e.jsx('div', {
                    ...
                    children: e.jsx(U, {
                        ...
                        classMix: a(zh, t?.title),
                    }),
                }),
            ],
        });
    }),
    Vh = 'YearlyRewardsPage_b4fabdfc',
    Hh = 'YearlyRewardsPage_bgContainer_badeda9c',
    Qh = 'YearlyRewardsPage_error_481edb10',
    Uh = 'YearlyRewardsPage_contentWrapper_b226b3ee',
    $h = 'YearlyRewardsPage_vehicle_7cb1ad5e',
    qh = 'YearlyRewardsPage_columns_432bf53e',
    Oh = 'YearlyRewardsPage_schedule_8841c048',
    Fh = 'YearlyRewardsPage_legend_1c8fdbce',
    Yh = 'YearlyRewardsPage_status_9f92f1db',
    Gh = 'YearlyRewardsPage_contentWrapper__withIntro_9c60e274',
    Xh = 'YearlyRewardsPage_vehicleInfoContainer_7cb1ad5e',
    Kh = 'YearlyRewardsPage_vehicleInfo_5a7993f3',
    Jh = (e) => window.setTimeout(() => b.sound(R.sounds.comp_7_annual_reward_rank_points()), e),
    Zh = r(() => {
        const { model: t, controls: r } = zu(),
        ...
        return (
            ...
            s.useEffect(() => {
                ...
                const e = [],
                    a = (a) => {
                        switch ((fu.includes(a) && r.setHoveredCardIndex(fu.findIndex((e) => e === a)), a)) {
                            case bu.firstStageSeasonPoints:
                            case bu.secondStageSeasonPoints:
                            case bu.thirdStageSeasonPoints:
                            case bu.fourthStageSeasonPoints:
                            case bu.fifthStageSeasonPoints:
                            case bu.sixthStageSeasonPoints:
                                e.push(Jh(0), Jh(200), Jh(400));
                        }
                    };
                return (
            ...
            e.jsxs('div', {
                ...
                children: [
                    e.jsx('div', { className: Hh, children: e.jsx(Wu, {}) }),
                    !i &&
                        e.jsxs(e.Fragment, { children: [e.jsx(Th, { className: $h }), e.jsx(Sh, { className: qh })] }),
                    e.jsx(c.div, {
                        style: d,
                        className: a(Uh, n && Gh),
                        children: i
                            ? e.jsx(ws, { className: Qh })
                            : e.jsxs(e.Fragment, {
                                  children: [
                                      e.jsx('div', { className: Fh, children: e.jsx(Ph, {}) }),
                                      e.jsx('div', { className: Xh, children: e.jsx(Wh, { className: Kh }) }),
                                      e.jsx('div', { className: Yh, children: e.jsx(yh, {}) }),
                                  ],
                              }),
                    }),
                    e.jsx(va, { className: Oh }),
                ],
            })
        );
    }),
    eg = [Ya.JustStarted, Ya.Active, Ya.EndSoon],
    [ag, sg] = w()(
        ({ observableModel: e }) => {
            const a = { root: e.object(), seasonCards: e.array('seasonCards') },
                ...
                i = t((e) => r(e).state),
                n = t((e) => i(e) === Ya.NotStarted),
                o = t((e) => eg.includes(i(e))),
                c = t((e) => s(e).rank),
    ...
    tg = 'Background_37b3a646',
    rg = r(({ index: s, className: t }) => {
        const { model: r } = sg(),
            { name: i } = r.computes.seasonScheduleInfo(s),
            n = r.computes.hasRankReceived(s),
            o = R.images.comp7.gui.maps.icons.backgrounds.$dyn(i),
            c = n ? xa[r.computes.rank(s)] : 'qualification';
        return e.jsx('div', { className: a(tg, t), style: { backgroundImage: `url(${o.$dyn(c)})` } });
    }),
    ig = 'CardFooter_2e091ae9',
    ng = 'CardFooter_statisticsAvailability_cb0a44a8',
    og = 'CardFooter_generationOfStatistics_47c91b6a',
    cg = 'CardFooter_icon_dca570a2',
    dg = r(({ index: s, className: t }) => {
        const { model: r, controls: i } = sg(),
            ...
            children: n
                ? e.jsx('div', {
                      ...
                      children: e.jsx(U, {
                          ...
                          classMix: ng,
                          binding: { icon: e.jsx('div', { className: cg }) },
                      }),
                  })
                : e.jsx(U, { text: R.strings.comp7_ext.yearlyStatistics.generationOfStatistics(), classMix: og }),
        });
    }),
    lg = 'RankStatus_481bd341',
    _g = 'RankStatus_rank_b62f7c6',
    mg = 'RankStatus_division_36b5f382',
    ug = r(({ index: a }) => {
        const { model: s } = sg(),
            ...
            children: t
                ? e.jsxs(e.Fragment, {
                      children: [
                          ...
                          ha(r) && e.jsx(U, { classMix: mg, text: wa(i) }),
                      ],
                  })
                : e.jsx('div', {
                      className: _g,
                    ...
                    case Ya.NotStarted:
                        return e.jsx('div', {
                            children: o
                                ...
                                : e.jsx(U, { text: R.strings.comp7_ext.season.range(), binding: Sa(i, r) }),
                        });
                    case Ya.JustStarted:
                    case Ya.EndSoon:
                    case Ya.Active:
    ...
    pg = 'Row_4b92d9b1',
    xg = 'Row_base__percentage_dff07ba',
    bg = 'Row_dashes_6f0ebb88',
    fg = 'Row_value_4ffd89b6',
    vg = ({ text: s, value: t, className: r, isPercentage: i = !1 }) =>
        e.jsxs('div', {
            className: a(pg, r, i && xg),
            children: [
                s,
                e.jsx('div', { className: bg }),
                e.jsx('div', { className: fg, children: Ba({ value: t, isPercentage: i }) }),
            ],
        }),
    Sg = 'Table_4aebc05b',
    jg = 'Table_container_8ee049b2',
    wg = 'Table_row_aa1a4564',
    Ng = r(({ index: s }) => {
        const { model: t } = sg(),
            {
                rating: r,
        ...
        return e.jsxs('div', {
            ...
            children: [
                ...
                e.jsxs('div', {
                    className: jg,
                    children: [
                        e.jsx(vg, { text: R.strings.comp7_ext.yearlyStatistics.battles(), value: i, className: wg }),
                        e.jsx(vg, {
    ...
    kg = 'SeasonCard_fe6ac520',
    Pg = 'SeasonCard_name_f71e7711',
    Rg = 'SeasonCard_rankImage_4800d152',
    Ig = 'SeasonCard_cardFooter_596f8b9d',
    yg = 'SeasonCard_divider_8113e306',
    Ag = 'SeasonCard_divider__left_455077e5',
    Bg = 'SeasonCard_divider__right_a8eb920c',
    Tg = 'SeasonCard_laceBase_b36dec41',
    Dg = 'SeasonCard_laceContainer_2dd0d837',
    Lg = 'SeasonCard_laceContainer__active_af829f8a',
    Eg = r(({ index: s, className: t }) => {
        const { model: r } = sg(),
        ...
        return e.jsxs('div', {
            className: a(kg, t),
            children: [
                0 === s && e.jsx('div', { className: a(yg, Ag) }),
                e.jsx('div', {
                    className: Pg,
                ...
                e.jsx(gg, { index: s }),
                o
                    ? e.jsx(ma, { rank: i, size: Cg(_), seasonName: d, division: n, className: Rg })
                    : e.jsx(Aa, { size: Cg(_), seasonName: d, className: Rg }),
                e.jsx(ug, { index: s }),
                e.jsx(Ng, { index: s }),
                e.jsx(Ga, { className: Tg, classNames: { lace: a(Dg, l && Lg) } }),
                c === Ya.End && o && e.jsx(dg, { index: s, className: Ig }),
                e.jsx('div', { className: a(yg, Bg) }),
            ],
        });
    }),
    zg = {
    ...
    Mg = r(({ index: s, className: t }) => {
        ...
        return e.jsxs(
            'div',
            {
                className: a(zg.cardWrapper, 0 === s && zg.cardWrapper__left, s === n - 1 && zg.cardWrapper__right),
                children: [
                    e.jsx(rg, { index: s, className: a(zg.bg, i && zg.bg__disabled) }),
                    e.jsxs('div', {
                        className: a(zg.seasonCard, i && zg.seasonCard__disabled),
                        children: [o && e.jsx('div', { className: zg.glow }), e.jsx(Eg, { index: s })],
                    }),
                ],
            },
            s,
    ...
    Wg = r(() => {
        ...
        return e.jsxs('div', {
            ...
            children: [
                e.jsx('div', { className: zg.heading, children: e.jsx(va, {}) }),
                e.jsx(c.div, {
                    style: s,
                    className: zg.contentWrapper,
                    children: T(a.seasonCards.get().length, (a) => e.jsx(Mg, { index: a }, a)),
                }),
            ],
        });
    }),
    Vg = {
        [ia.Progression]: () => e.jsx(Ht, { options: ns.PROGRESSION_PAGE, children: e.jsx(mc, {}) }),
        [ia.RankRewards]: () => e.jsx(uc, { options: ns.RANK_REWARDS_PAGE, children: e.jsx(rd, {}) }),
        [ia.WeeklyQuests]: () => e.jsx(Y_, { options: ns.WEEKLY_QUESTS_PAGE, children: e.jsx(xu, {}) }),
        [ia.Leaderboard]: () => e.jsx(Ns, { options: ns.LEADERBOARD_PAGE, children: e.jsx(zt, {}) }),
        [ia.YearlyRewards]: () =>
            e.jsx(Eu, { options: ns.YEARLY_REWARDS_PAGE, children: e.jsx(Nu, { children: e.jsx(Zh, {}) }) }),
        [ia.Shop]: () => e.jsx(cd, { options: ns.SHOP_PAGE, children: e.jsx(q_, {}) }),
        [ia.YearlyStatistics]: () => e.jsx(ag, { options: ns.YEARLY_STATISTICS_PAGE, children: e.jsx(Wg, {}) }),
    },
    Hg = ({ pageView: a }) => {
        const s = Vg[a];
    ...
    Ug = r(() => {
        ...
        return e.jsxs('div', {
            className: a(
                Qg.base,
                l && !ts() && Qg.base__qualification,
                !l && Qg[`base__${is[n]}`],
                Qg[`season__${r.season.name.get()}`],
            ),
            children: [
                e.jsx('div', { className: Qg.viewContainer, children: e.jsx(Hg, { pageView: n }) }),
                e.jsx(_s, {
                    options: ns.TABS,
                    children: e.jsx(xs, { pageView: n, className: a(Qg.sidebar, i.isMedium && Qg.sidebar__medium) }),
                }),
                c > 0 &&
                    e.jsx('div', {
                        className: Qg.choiceAward,
                        children: e.jsx(ss, {
                            size: d >= S.Large ? as.Big : as.Small,
                            count: c,
                            disabled: o,
...
aa(e.jsx(sa, { children: e.jsx(os, { children: e.jsx(ra, { options: ns.SCHEDULE, children: e.jsx(Ug, {}) }) }) }), {
    fullScreen: !0,
});
