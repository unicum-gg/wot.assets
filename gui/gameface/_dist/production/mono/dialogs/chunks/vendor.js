...
function zl(e) {
    return { version: 1, vendor: 'valibot', validate: (t) => e['~run']({ value: t }, Tl()) };
}
function Ll(e, t) {
        ...
        '~run'(e, t) {
            ...
            if (n && 'object' == typeof n) {
                ...
                for (const r in this.entries) {
                    ...
                    } else if (void 0 !== a.fallback) e.value[r] = Ml(a);
                    else if (
...
function Fl(e, t) {
    return {
        ...
        '~run'(e, t) {
            return void 0 === e.value && (void 0 !== this.default && (e.value = Dl(this, e, t)), void 0 === e.value)
                ? ((e.typed = !0), e)
...
function $l(e) {
    return {
        ...
        '~run'(e, t) {
            return ('string' == typeof e.value ? (e.typed = !0) : jl(this, 'type', e, t), e);
        },
    };
}
function Bl(e, t, n) {
    const r = e['~run']({ value: t }, Tl(n));
    if (r.issues) throw new Rl(r.issues);
    return r.value;
}
const Hl = (e) => ('boolean' == typeof e ? `${e}` : 0 === e ? '0' : e),
    ql = de,
    Wl = (e, t) => (n) => {
        var r;
        if (null == (null == t ? void 0 : t.variants))
            return ql(e, null == n ? void 0 : n.class, null == n ? void 0 : n.className);
        ...
        return ql(e, o, u, null == n ? void 0 : n.class, null == n ? void 0 : n.className);
    };
export {
    K as R,
    O as a,
