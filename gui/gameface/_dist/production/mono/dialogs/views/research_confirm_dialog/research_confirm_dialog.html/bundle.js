    ...
    C = e(function () {
        ...
        return (
            ...
            s.jsxs('div', {
                className: j,
                children: [
                    s.jsx(r, { theme: t.primary, onClick: e.confirm, children: h.confirmUnlock.submit() }),
                    s.jsx(r, {
                        theme: t.secondary,
                        onClick: e.close,
                        classNames: { base: _ },
                        children: h.confirmUnlock.cancel(),
                    }),
                ],
            })
        );
...
const P = e(function () {
        const { model: e } = p(),
            { researchedItemsText: c, xp: n, freeXP: a } = e.root.get();
        return s.jsxs('div', {
            className: N,
            children: [
    ...
    X = 'App_8d610e80',
    y = 'App_container_969b2431',
    E = 'App_title_a4349c9',
    U = 'App_separator_5b3379fe';
function B() {
    const { controls: e } = p();
    return (
        m(a.SPACE, e.confirm),
        s.jsx('div', {
            ...
            children: s.jsxs('div', {
                className: y,
                children: [
                    s.jsx('div', { className: E, children: R.strings.dialogs.confirmUnlock.title() }),
...
d(s.jsx(x, { children: s.jsx(f, { children: s.jsx(B, {}) }) }));
