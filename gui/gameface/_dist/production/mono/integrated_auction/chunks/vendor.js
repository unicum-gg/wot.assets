...
var Bt,
    ...
    Ht = {
        ...
        array: function (e, t) {
            var n = jt(t);
            return (!1 === En.useProxies || !1 === n.proxy ? va : Lr)(e, Vt(n), n.name);
        },
        map: function (e, t) {
            var n = jt(t);
...
(Rr('at', Mr),
    ...
    Rr('reduce', Ir),
    Rr('reduceRight', Ir));
var Fr = je('ObservableArrayAdministration', zr);
function Vr(e) {
    return Ae(e) && Fr(e[tt]);
}
var Ur = {},
        ...
        return (
            ...
            (t.delete_ = function (e, t) {
                ...
                try {
                    ...
                    if (
                        (i && (this.values_.delete(e), i instanceof an && (o = i.value_), Ln(i)),
...
var ta = je('ObservableObjectAdministration', Jr);
function na(e) {
    return (
        Yr[e] ||
        (Yr[e] = {
...
var La = Ha();
Aa.onFinish = (e) => Va(e, La);
var ja = [];
Aa.setTimeout = (e, t) => {
    const n = Aa.now() + t,
        r = () => {
            const e = ja.findIndex((e) => e.cancel == r);
            (~e && ja.splice(e, 1), (Ia -= ~e ? 1 : 0));
        },
        a = { time: n, handler: e, cancel: r };
    return (ja.splice(Ra(n), 0, a), (Ia += 1), Ua(), a);
};
var Ra = (e) => ~(~ja.findIndex((t) => t.time > e) || ~ja.length);
((Aa.cancel = (e) => {
    (Na.delete(e), za.delete(e), La.delete(e), Ca.delete(e), Ta.delete(e));
}),
    (Aa.sync = (e) => {
...
function $a() {
    ...
    Da = Aa.now();
    const t = Ra(Da);
    (t && (qa(ja.splice(0, t), (e) => e.handler()), (Ia -= t)),
        Ia ? (Na.flush(), Ca.flush(e ? Math.min(64, Da - e) : 16.667), za.flush(), Ta.flush(), La.flush()) : (Da = -1));
}
function Ha() {
    let e = new Set(),
        t = e;
...
function Vi(e, t) {
    if (e[Li]) {
        let n = e[ji];
        (n || $i(e, ji, (n = new Set())), n.has(t) || (n.add(t), e.observerAdded && e.observerAdded(n.size, t)));
    }
    return t;
}
function Ui(e, t) {
...
function Ro(e, t) {
    return null == t || 'boolean' == typeof t || '' === t
        ? ''
        : 'number' != typeof t || 0 === t || jo.test(e) || (Do.hasOwnProperty(e) && Do[e])
          ? ('' + t).trim()
          : t + 'px';
}
var Mo = {};
...
(Ka.assign({
    batchedUpdates: Lo.unstable_batchedUpdates,
            ...
            applyAnimatedValues: function (e, t) {
                ...
                for (const d in a)
                    if (a.hasOwnProperty(d)) {
                        const t = Ro(d, a[d]);
                        jo.test(d) ? e.style.setProperty(d, t) : (e.style[d] = t);
                    }
                (f.forEach((t, n) => {
    ...
    _l =
        (pl ||
            ...
            (ml.exports = (function () {
                ...
                return ((gl.useSyncExternalStore = void 0 !== e.useSyncExternalStore ? e.useSyncExternalStore : l), gl);
            })())),
        ml.exports);
function wl(e) {
...
((Pl = Lo.unstable_batchedUpdates) || (Pl = cl), ir({ reactionScheduler: Pl }), vl.finalizeAllImmediately);
export {
    K as R,
    O as a,
    P as b,
