...
class T {
    ...
    pluralOr(e, t, n, r = 'silent') {
        const o = e.startsWith('R.strings') ? e : m(this.prefix, e),
            i = S(o, t, e.startsWith('R.strings') ? window : this.root);
        return void 0 === i ? ('silent' !== r && p(`Resource not found: ${o}`, r), n()) : i;
    }
...
const L = {
    ...
    $ = (e) => e / 1e3 / 60 / 60,
    A = (e) => e / 1e3 / 60 / 60 / 24,
    z = (e) => e / 1e3 / 60 / 60 / 24 / 7;
function V(e) {
    return (0, L[e.unit])(e.value);
}
const B = D(function (e, t) {
        return M(V(e) + V(t));
    }),
    U = D(function (e, t) {
        return M(V(e) - V(t));
    ...
    W = {
        DD: (e) => Math.floor(A(e)).toString().padStart(2, '0'),
        D: (e) => Math.floor(A(e)).toString(),
        WW: (e) => Math.floor(z(e)).toString().padStart(2, '0'),
        W: (e) => Math.floor(z(e)).toString(),
        hh: (e) =>
            Math.floor($(e) % 24)
                .toString()
                .padStart(2, '0'),
        ...
        ss: (e) =>
            Math.floor(F(e) % 60)
                .toString()
                .padStart(2, '0'),
        h: (e) => Math.floor($(e) % 24).toString(),
        m: (e) => Math.floor(j(e) % 60).toString(),
        s: (e) => Math.floor(F(e) % 60).toString(),
...
const K = X('clientResized'),
    Y = X('self.onScaleUpdated'),
    J = { down: X('mousedown'), up: X('mouseup'), move: X('mousemove') };
!(function () {
...
const Q = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
    ...
    ee = {
        onTextureFrozen: X('self.onTextureFrozen'),
        onTextureReady: X('self.onTextureReady'),
        onDomBuilt: X('self.onDomBuilt'),
        onLoaded: X('self.onLoaded'),
        onHitTest: (() => {
            const e = new Set(),
                t = (t, n) => {
        ...
        onDisplayChanged: X('self.onShowingStatusChanged'),
        onFocusUpdated: X('self.onFocusChanged'),
        onExternalPaddingsUpdated: X('self.onPaddingsUpdated'),
        children: {
            onAdded: X('children.onAdded'),
            onLoaded: X('children.onLoaded'),
            onRemoved: X('children.onRemoved'),
            onAttached: X('children.onAttached'),
            onTextureReady: X('children.onTextureReady'),
            onRequestPosition: X('children.requestPosition'),
        },
    };
...
function re(
    { initializer: e = !0, rootId: t = 0, getRoot: n = ne, context: r = 'model' } = {},
    { name: o = 'DataLayer' } = {},
) {
    const i = new Map(),
        s = { subscribersNotified: new te() },
...
const le = o.createContext(void 0);
const he = 'extraSmall',
    fe = {
        extraSmall: { weight: 0, name: he, className: 'mediaExtraSmall', width: 1280, height: 768 },
...
var me,
    ...
    we,
    ge =
        (((me = ge || {})[(me.Small = fe.small.width)] = 'Small'),
        (me[(me.Medium = fe.medium.width)] = 'Medium'),
        (me[(me.Large = fe.large.width)] = 'Large'),
        (me[(me.ExtraLarge = fe.extraLarge.width)] = 'ExtraLarge'),
        me),
    ve =
        (((pe = ve || {})[(pe.Small = fe.small.width)] = 'Small'),
        (pe[(pe.Medium = fe.medium.width)] = 'Medium'),
        (pe[(pe.Large = fe.large.width)] = 'Large'),
        (pe[(pe.ExtraLarge = fe.extraLarge.width)] = 'ExtraLarge'),
        pe),
    ye =
        (((we = ye || {})[(we.Small = fe.small.height)] = 'Small'),
        (we[(we.Medium = fe.medium.height)] = 'Medium'),
        (we[(we.Large = fe.large.height)] = 'Large'),
        (we[(we.ExtraLarge = fe.extraLarge.height)] = 'ExtraLarge'),
        we);
const be = Object.values(fe);
function _e(e, t) {
    ...
    Ee = () => {
        ...
        return (function (e, t, n) {
            const r = be.reduce(
                ...
                i = r[o],
                s = i.names[i.names.length - 1] ?? he,
                a = fe[s],
                u = r.width.names,
                d = r.height.names,
                c = u[u.length - 1] ?? he,
                l = d[d.length - 1] ?? he,
                h = { width: fe[c].width, height: fe[l].height };
            return {
                mediaClass: _e(o, r),
                breakpoint: a,
                screenWidthRem: e,
...
function Se({ children: e }) {
    ...
    return (
        ...
        i.jsx(le.Provider, { value: t, children: e })
    );
}
function Re() {
    return (function () {
...
function Te({ children: e, className: t, ...n }) {
    const { mediaClass: r, upscale: o } = Re();
    return i.jsx('div', { className: s(t, 'media-wrapper', r, o && 'media-upscale'), ...n, children: e });
}
function Pe({ children: e, ...t }) {
    return i.jsx(Se, { children: i.jsx(Te, { ...t, children: e }) });
}
const De = [];
const ke = () => {
        const e = new Map();
    ...
    Oe = o.createContext(void 0);
function Me(e) {
    const t = o.useMemo(ke, []),
        n = o.useMemo(ke, []);
    o.useEffect(() => {
        function e(e) {
    ...
    return i.jsx(Oe.Provider, { value: r, children: e.children });
}
...
function Fe(e, { shallow: t = !0, depth: n = 0, maxDepth: r = 32 } = {}) {
    ...
    if (Ne.has(i)) return o;
    if (null === o) return o;
    const s = { depth: n + 1, maxDepth: r };
    if (Array.isArray(o)) return o.map((e) => Fe(e, s));
    if ('object' === i) {
        const r = o.constructor?.name ?? 'UNKNOWN';
        if (Array.isArray(e)) return e.map((e) => Fe(e, s));
        if ('CoherentArrayProxy' === r) return e.map((e) => Fe(e.value, s));
        if ('Dict' === r) return;
        if ('UNKNOWN' === r) return;
        ...
        const i = {};
        for (const e of Object.keys(o)) i[e] = Fe(o[e], s);
        return i;
    }
    return (console.error('Incorrect value to clone model', o), o);
}
const je = { deep: !1, equals: se },
    $e = { cloneItem: !0 },
    Ae = { shallow: !1 };
class ze {
    constructor(e, t = $e) {
        ...
        for (let r = 0; r < t.length; r++) {
            ...
            o in n
                ? null === i
                    ...
                    : n[o].set(i)
                : null !== i && ((n[o] = a.box(i, je)), this._keys.add(o), this.set(n));
        }
    }
    entries() {
    ...
    takeItem(e, t) {
        const n = e.get(t);
        return this.options.cloneItem ? Fe(n, Ae) : n;
    }
    set = u((e) => {
        this._data.set(e);
    });
...
const Ve = o.createContext({ mode: 'real' }),
    Be = { equals: se, deep: !1 };
function Ue(e, t, n) {
    const r = [];
    ...
    const o = (o, i, s = Be) => {
            const u = a.box(o(n(i)), s);
            return ('real' === t && e.subscribe((e) => r.push(() => u.set(o(e))), i), u);
        },
        i = (o, i) => {
            const s = new ze(n(o), i);
            return ('real' === t && e.subscribe((e, t) => r.push(() => s.update(e, t)), o), s);
        },
        s = (o, i) => {
            const s = a.box(n(o) ?? i, Be);
    ...
    return {
        ...
        primitives: (o, i) => {
            const s = n(i);
            if (Array.isArray(o)) {
                const n = o.reduce((e, t) => ((e[t] = a.box(s[t], {})), e), {});
                return (
                    'real' === t &&
                        e.subscribe((e) => {
                            r.push(() =>
            ...
            }
            {
                const n = o,
                    u = Object.entries(n),
                    d = u.reduce((e, [t, n]) => ((e[n] = a.box(s[t], {})), e), {});
                return (
                    'real' === t &&
                        e.subscribe((e) => {
                            r.push(() =>
...
const Ie =
    ...
    (t, n, r) => {
        ...
        function a(a) {
            const { mode: u, options: d, children: c, mocks: l } = a,
                h = o.useContext(Ve),
                f = u ?? h.mode,
                m = l ?? h.mocks,
                p = o.useRef([]),
                ...
                g = (function (e) {
                    ...
                    return (
                        ...
                        o.useCallback((...e) => (0, t.current)(...e), De)
                    );
                })((o, i, s) => {
                    const u =
                            'real' !== o && s
                                ? (function (e, t) {
                                      return {
                                          ...
                                          dispose: () => {},
                                          unsubscribe: () => {},
                                          events: { subscribersNotified: new te() },
                                      };
                                  })(s.getter, i)
                                : re(i, { name: e }),
                        d = (e) => ('mocks' === o ? s?.getter(e, i) : u.readByPath(e)),
                        ...
                        h = t({
                            ...
                            requires: w,
                            externalModel: u,
                            observableModel: Ue(u, o, d),
                            cleanup: c,
                        }),
                        f = { ...l, mode: o, model: h, externalModel: u, cleanup: c, requires: w },
                        m = 'mocks' === o && s?.controls ? s.controls(f) : {};
                    return {
                        model: h,
                        controls: { ...n?.(f), ...m },
                        externalModel: u,
            ...
            const [_, x] = o.useState(() => g(y, d, m));
            return (
                o.useEffect(() => {
                    v.current ? x(g(y, d, m)) : (v.current = !0);
                }, [g, m, y, d?.context, d?.initializer, d?.getRoot, d?.rootId]),
                o.useEffect(
                    () => () => {
                ...
                i.jsx(s.Provider, { value: _, children: c })
            );
        }
        return (
            (a.displayName = e),
...
async function He(
    ...
    (o && engine.enableImmediateLayout(!0),
        ...
        l.createRoot(t).render(i.jsx(s, { children: i.jsx(Me, { children: e }) })),
        r &&
            (!(function (e) {
                function t() {
...
const Xe = { down: We('mousedown'), up: We('mouseup'), move: We('mousemove') };
!(function () {
    const e = { listeners: 0, enabled: !0, initialized: !1 };
    function t() {
        e.enabled && qe(!1);
...
const Ge = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
    Ke =
        (Object.keys(Ge).reduce(
            (e, t) => (
                (e[t] = () =>
                    (function (e) {
...
const Qe = Object.freeze(
    ...
    Ze = { showing: 0, shown: 1, hiding: 2, hidden: 3 },
    et = {
...
const ct = Object.keys(Ze).reduce((e, t) => ((e[t] = () => viewEnv.getShowingStatus() === Ze[t]), e), {}),
    ...
    ht = Promise.all([
        new Promise((e) => {
            window.isDomBuilt ? e() : et.onDomBuilt(e);
        }),
        engine.whenReady,
    ]);
const ft = {
            ...
            Object.defineProperty(
                {
                    ...
                    getViewGlobalPosition: function (e = 'rem') {
                        ...
                        return 'rem' === e ? t : { x: at(t.x), y: at(t.y) };
                    },
    ...
    pt = c.forwardRef(function ({ children: e, className: t, theme: n = 'default', ...r }, s) {
        ...
        return (
            ...
            i.jsx('div', {
                ...r,
                className: h(mt.base, mt[`base__theme-${n}`], t),
                ref: function (e) {
                    ((a.current = e), 'function' == typeof s ? s(e) : s && (s.current = e));
                },
                children: i.jsx('div', { className: mt.decorator, children: e }),
            })
        );
    }),
    wt = { superCompact: 'superCompact', compact: 'compact', default: 'default', detailed: 'detailed' },
    gt = { x16x16: 'x16x16', x24x24: 'x24x24', x32x32: 'x32x32', x48x48: 'x48x48', x80x80: 'x80x80' },
    vt = { accent: 'accent', cooldown: 'cooldown' },
    yt = {
...
function bt({ size: e, preFormatted: t }) {
    const n = [];
    for (let r = 0; r < t.items.length; ++r)
        (t.separator &&
            r > 0 &&
            n.push(i.jsx('span', { className: h(yt.detailedSeparator, yt[`detailedSeparator__${e}`]) }, 'separator')),
            n.push(
                i.jsx(
                    'span',
                    {
                        className: h(yt.item, yt[`item__${e}`]),
                        children: t.items[r]
                            ?.split(' ')
                            .map((t, n) =>
                                i.jsx('span', { className: h(yt.part, yt[`part__${e}`]), children: t }, `part_${n}`),
                            ),
                    },
                    `item_${r}`,
                ),
...
const _t = f.resolve('strings'),
    xt = 'D',
    Et = 'h',
    St = 'm',
    Rt = { [wt.compact]: [xt, Et, St], [wt.default]: [xt, Et, St], [wt.detailed]: [xt, 'hh', 'mm', 'ss'] },
    Tt = {
        [wt.compact]: function (e, t) {
            const n = e.length,
                r = Rt[t],
                o = { separator: !1, items: [] };
            for (let i = 0; i < n; ++i) if (Number(e[i]) > 0) return ((o.items = [Pt[r[i]]?.(e[i])]), o);
            return ((o.items = [Pt[St]?.(1)]), o);
        },
        [wt.default]: function (e, t) {
            let n = 0;
            const r = e.length - 1,
                o = Rt[t],
                i = { separator: !1, items: [] };
            ...
            o[n] === St && 0 === Number(e[n])
                ? (i.items = [Pt[St]?.(1)])
                : (i.items = [n, n + 1].map((t) => Pt[o[t]]?.(e[t])));
            return i;
        },
        [wt.detailed]: function (e) {
            const [t, ...n] = e,
                r = n.join(':');
            return { separator: !0, items: Number(t) > 0 ? [Pt[xt]?.(t), r] : [r] };
        },
    },
    Pt = {
        [xt]: (e) =>
            q(
                _t.readOr('common.timer.days', () => xt.toLowerCase()),
                { days: e },
            ),
        [Et]: (e) =>
            q(
                _t.readOr('common.timer.hours', () => Et),
                { hours: e },
            ),
        [St]: (e) =>
            q(
                _t.readOr('common.timer.minutes', () => St),
                { minutes: e },
            ),
    };
const Dt = (e, t) =>
...
function Ot({
    ...
    const [l] = (function (e) {
        const { type: t, tick: n, limit: r } = e,
            i = e.autostart ?? !1,
            s = e.start ?? N,
            [a, u] = o.useState({ current: s, running: i }),
            d = o.useRef(0);
        o.useEffect(
            () => (
                (d.current = window.setInterval(() => {
                    a.running
                        ? u((e) => {
                              const o = 'countdown' === t ? U(e.current, n) : B(e.current, n),
                                  i = { ...e, current: o };
                              return (
                                  O(r) &&
                                      ('countdown' === t
                                          ? H(U(o, n), r) && ((i.current = r), (i.running = !1))
                                          : I(B(o, n), r) && ((i.current = r), (i.running = !1))),
                                  i
                              );
                          })
    ...
    return i.jsxs('div', {
        className: h(kt.base, d),
        children: [
            i.jsx('div', { className: h(kt.icon, kt[`icon__${r}`], kt[`icon__${s}`], c?.icon) }),
            a !== wt.superCompact &&
                i.jsx('div', {
                    className: h(kt.label, kt[`label__${r}`], kt[`label__${s}`], c?.label),
                    children: i.jsx(bt, { size: r, preFormatted: Dt(l, a) }),
                }),
        ],
    });
}
((Ot.format = wt), (Ot.size = gt), (Ot.type = vt));
export { Ot as T, He as a, pt as b, Ie as i, ie as n, f as r };
