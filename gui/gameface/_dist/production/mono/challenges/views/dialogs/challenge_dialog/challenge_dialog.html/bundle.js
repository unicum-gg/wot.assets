...
var C = ((e) => ((e.Primary = 'primary'), (e.Secondary = 'secondary'), (e.Custom = 'custom'), e))(C || {});
const D = 'confirm',
    [S, w] = r()(
        ({ observableModel: s }) => {
            const a = { root: s.object(), balance: s.array('balance'), price: s.object('price') },
                ...
                i = e(() => [
                    ...
                    { action: 'cancel', label: t.cancel(), soundTarget: 'Button', isDisabled: !1, type: C.Secondary },
                ]),
                r = e(() => {
                    const e = a.root.get(),
    ...
    T = s(function () {
        ...
        return a.jsx('div', {
            onClick: function (e) {
                (r.play('close', { target: 'dialog:close_button', original: e }), s.close(), e.stopPropagation());
            },
    ...
    M = { medium: { size: o.sizes.medium }, large: { size: o.sizes.large }, extraLarge: { size: o.sizes.large } },
    V = s(function () {
        const e = c(A, M),
...
function ee({ wgMoneyAvailable: e, value: s, type: r, classNames: l }) {
    const n = i.useRef(null),
        ...
        c = b.resolve('strings'),
        d = v(
            { displayValue: () => (s >= Z ? { abbreviated: !0, value: p(s, $) / Z } : { abbreviated: !1, value: s }) },
            {
                medium: {
                    displayValue: () =>
