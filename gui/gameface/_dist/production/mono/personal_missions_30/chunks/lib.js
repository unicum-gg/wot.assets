...
const M = {
    ...
    formatNumber: function (e, t) {
        return window.formatters.getNumberFormat(t, S[e]);
    },
    numberFormats: L,
    ...
    formatReal: function (e, t, n = 2) {
        return window.formatters.getRealFormat(t, T[e], n);
    },
    realFormats: N,
...
const W = V('clientResized'),
    Z = V('self.onScaleUpdated'),
    q = V('clientMinimized'),
    Y = { down: V('mousedown'), up: V('mouseup'), move: V('mousemove') };
const X = (function () {
...
const J = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
    ...
    ne = {
        ...
        onExternalPaddingsUpdated: V('self.onPaddingsUpdated'),
        children: {
...
const ue = (e) => {
    ...
    he = {
        ...
        popover: {
            open({ contentID: e, decoratorID: t = 0, targetID: n, direction: r, boundingBox: s, args: a }) {
                var o;
                de(se, {
                    contentID: e,
                    decoratorID: t,
                    targetID: n,
                    direction: r,
                    bbox: ((o = s), { __Type: 'GFBoundingBox', x: o.x, y: o.y, width: o.width, height: o.height }),
                    on: !0,
                    isMouseEvent: !0,
                    args: a,
                });
        ...
        tooltip: {
            ...
            hide(e, t, n = 0) {
                (de(re, { contentID: t, decoratorID: n, targetID: e, on: !1 }), fe.delete(`${e}-${t}`));
            },
            hideAll() {
...
const Te = { ESCAPE: 27, ARROW_LEFT: 37, ARROW_RIGHT: 39 };
function Le(e, t) {
...
function He(e, t, n) {
    return 'function' == typeof t ? ze(0, e, t) : (je(void 0 !== n, 'fn must be defined'), ze(e, t, n));
}
function ze(e, t, n) {
...
const et = new Set(['zh_cn', 'zh_sg', 'zh_tw', 'ja', 'ko', 'th']);
const tt = a.createContext(void 0);
const nt = { extraSmall: 'extraSmall', small: 'small', medium: 'medium', large: 'large', extraLarge: 'extraLarge' },
    rt = {
        extraSmall: { weight: 0, name: nt.extraSmall, className: 'mediaExtraSmall', width: 1280, height: 768 },
        small: { weight: 1, name: nt.small, className: 'mediaSmall', width: 1366, height: 768 },
        medium: { weight: 2, name: nt.medium, className: 'mediaMedium', width: 1600, height: 900 },
        large: { weight: 3, name: nt.large, className: 'mediaLarge', width: 1920, height: 1080 },
        extraLarge: { weight: 4, name: nt.extraLarge, className: 'mediaExtraLarge', width: 2560, height: 1440 },
    };
var st,
    at,
    ot,
    it =
        (((st = it || {})[(st.Small = rt.small.width)] = 'Small'),
        (st[(st.Medium = rt.medium.width)] = 'Medium'),
        (st[(st.Large = rt.large.width)] = 'Large'),
        (st[(st.ExtraLarge = rt.extraLarge.width)] = 'ExtraLarge'),
        st),
    ct =
        (((at = ct || {})[(at.Small = rt.small.width)] = 'Small'),
        (at[(at.Medium = rt.medium.width)] = 'Medium'),
        (at[(at.Large = rt.large.width)] = 'Large'),
        (at[(at.ExtraLarge = rt.extraLarge.width)] = 'ExtraLarge'),
        at),
    lt =
        (((ot = lt || {})[(ot.Small = rt.small.height)] = 'Small'),
        (ot[(ot.Medium = rt.medium.height)] = 'Medium'),
        (ot[(ot.Large = rt.large.height)] = 'Large'),
        (ot[(ot.ExtraLarge = rt.extraLarge.height)] = 'ExtraLarge'),
        ot);
const ut = Object.values(rt);
function dt(e, t) {
...
const ft = () => {
    ...
    return (function (e, t, n) {
        const r = ut.reduce(
            ...
            a = r[s],
            o = a.names[a.names.length - 1] ?? nt.extraSmall,
            i = rt[o],
            c = r.width.names,
            l = r.height.names,
            u = c[c.length - 1] ?? nt.extraSmall,
            d = l[l.length - 1] ?? nt.extraSmall,
            f = { width: rt[u].width, height: rt[d].height };
        return {
            mediaClass: dt(s, r),
            breakpoint: i,
            screenWidthRem: e,
...
function mt({ children: e }) {
    ...
    return (
        ...
        o.jsx(tt.Provider, { value: t, children: e })
    );
}
function ht() {
    return (function () {
...
function vt(e) {
    ...
    return (
        ...
        a.useCallback((...e) => (0, t.current)(...e), wt)
    );
}
const xt = (e, t, n = !0) => {
    const r = vt((e) => {
...
function Lt(e, t, n = !1) {
    return Tt(Me(e), 'keydown', t, n);
}
function Nt(e) {
    const t = a.useMemo(Rt, []),
        n = a.useMemo(Rt, []);
    a.useEffect(() => {
        function e(e) {
...
function Mt(e, t) {
    a.useEffect(() => (window.addEventListener('resize', e), () => window.removeEventListener('resize', e)), t);
}
function Bt() {
    const e = a.useRef(0);
    return (
...
const At = new WeakMap(),
    ...
    It = 'idle',
    Ot = 'display';
function $t({ resId: e = 0, contentId: t, decoratorId: n, disabled: r, args: s, showDelay: o = 400 }) {
    const i = a.useRef({ status: It, resId: e, timeoutId: 0 }),
        [c, l] = a.useMemo(() => {
            let a = null;
            function c() {
                r ||
            ...
            const d = {
                ...
                show: l,
                rerun: function () {
                    i.current.status !== It && (r ? d.hide() : c());
                },
            };
            return [
                d,
...
function jt({ alert: e, body: t, header: n, note: r, hasHtmlContent: s, disabled: o }) {
...
function zt(e, t = Ht, n) {
    return $t({
        ...
        args: a.useMemo(() => ({ tooltipId: e, tooltipArgs: JSON.stringify(t), ...n?.args }), [t, e, n?.args]),
    });
}
function Ut(e, t, n) {
    return $t({
...
const Gt = {
    click: Wt('play'),
    'hot-key': Wt('play'),
    'mouse-enter': Wt('highlight'),
    increaseAmount: Wt('cons_ammo_single_plus'),
    decreaseAmount: Wt('cons_ammo_single_minus'),
    increaseAmountRoll: Wt('cons_ammo_roll_plus'),
    decreaseAmountRoll: Wt('cons_ammo_roll_minus'),
    close: Wt('cancelcloseno'),
    'show-context-menu': Wt('tabb'),
    progressSimple: Wt('gui_hangar_progressbar_simple'),
    increaseDelta: Wt('gui_hangar_progressbar_delta_increase'),
    decreaseDelta: Wt('gui_hangar_progressbar_delta_decrease'),
    increaseDeltaMax: Wt('gui_hangar_progressbar_delta_max'),
    pointerGrab: Wt('gui_hangar_progressbar_pointer_grab'),
    pointerDrag: Wt('gui_hangar_progressbar_pointer_drag'),
};
function Wt(e) {
    return () => {
        ee.sound(e);
...
function qt({ severity: e = 'warn', overrides: t, silent: n = !1, children: r }) {
    ...
    return o.jsx(Zt.Provider, { value: i, children: r });
}
function Yt() {
    const e = a.useContext(Zt);
    if (!e) throw new Error('hook useSounds must be used within SoundsProvider');
    return e;
}
const Xt = new Set(['number', 'string', 'boolean', 'bigint', 'undefined', 'function']),
    Qt = new Set(['number', 'string', 'boolean', 'bigint']),
    Kt = new Set(['Dict']);
function Jt(e, { shallow: t = !0, depth: n = 0, maxDepth: r = 32 } = {}) {
    const s = e,
        a = typeof e;
    if (n > r) throw new Error(`Too deeply nested to copy. Max is ${r}.`);
    if (Xt.has(a)) return s;
    if (null === s) return s;
    const o = { depth: n + 1, maxDepth: r };
    if (Array.isArray(s)) return s.map((e) => Jt(e, o));
    if ('object' === a) {
        const r = s.constructor?.name ?? 'UNKNOWN';
        if (Array.isArray(e)) return e.map((e) => Jt(e, o));
        if ('CoherentArrayProxy' === r) return e.map((e) => Jt(e.value, o));
        if ('Dict' === r) return;
        if ('UNKNOWN' === r) return;
        ...
        const a = {};
        for (const e of Object.keys(s)) a[e] = Jt(s[e], o);
        return a;
    }
    return (console.error('Incorrect value to clone model', s), s);
}
const en = { deep: !1, equals: Se },
    tn = { cloneItem: !0 },
    nn = { shallow: !1 };
class rn {
    constructor(e, t = tn) {
        ...
        for (let s = 0; s < r.length; s++) {
            const t = r[s];
            n[t] = c.box(this.takeItem(e, t), en);
        }
        ((this._keys = c.set(new Set(r))), (this._data = c.box(n, en)));
    }
    _data;
    _keys;
    get keys() {
        ...
        for (let r = 0; r < t.length; r++) {
            ...
            s in n
                ? null === a
                    ...
                    : n[s].set(a)
                : null !== a && ((n[s] = c.box(a, en)), this._keys.add(s), this.set(n));
        }
    }
    entries() {
    ...
    takeItem(e, t) {
        const n = e.get(t);
        return this.options.cloneItem ? Jt(n, nn) : n;
    }
    set = s((e) => {
        this._data.set(e);
    });
...
const sn = a.createContext({ mode: 'real' });
function an(e) {
    return (t, n) => {
        const r = Ee(t, n);
        return r
...
const ln =
        ...
        (t, n, r) => {
            ...
            function i(i) {
                    ...
                    p = vt((s, a, o) => {
                        const c =
                            ...
                            f = t({
                                ...
                                requires: g,
                                externalModel: c,
                                observableModel: cn(c, s, l),
                                cleanup: u,
                            }),
                            m = { ...d, mode: s, model: f, externalModel: c, cleanup: u, requires: g },
                ...
                const [x, y] = a.useState(() => p(w, l, h));
                return (
                    a.useEffect(() => {
                        b.current ? y(p(w, l, h)) : (b.current = !0);
                    }, [p, h, w, l?.context, l?.initializer, l?.getRoot, l?.rootId]),
                    a.useEffect(
                        () => () => {
...
async function mn(
    ...
    (s && engine.enableImmediateLayout(!0),
        ...
        m.createRoot(t).render(o.jsx(a, { children: o.jsx(Nt, { children: e }) })),
        r &&
            (!(function (e) {
                function t() {
...
const gn = a.forwardRef(function (
        ...
        return (
            ...
            a.useEffect(() => {
                if (f && m.current) {
                    ...
                    const n = (t) => (
                        ...
                        o = (e) => {
                            m.current && (m.current.currentTime = Ce(0, m.current.duration, e));
                        },
                        l = () => m.current?.play(),
                        u = () => m.current?.pause(),
                        d = () => {
            ...
            o.jsx('video', { src: e, className: t, style: r, loop: s, ref: m, onClick: l, ...u })
        );
    }),
    pn = a.memo(gn);
var bn = ((e) => ((e[(e.Next = -1)] = 'Next'), (e[(e.Prev = 1)] = 'Prev'), e))(bn || {});
const wn = {
    ...
    vn = ({
        ...
        return (c = {}) => {
            const { settings: l = wn } = c,
                [u, d] = a.useState(!1),
                f = a.useRef(null),
                m = a.useRef(null),
                _ = a.useRef({ wrapper: 0, container: 0 }),
                g = yt(),
                p = Dt(
                    () => {
                        pe();
                ...
                x = a.useCallback(
                    ...
                    [b.scrollPosition, w, l.animationConfig, p],
                ),
                y = a.useCallback(
                    function (e) {
                        const t = f.current,
                ...
                E = a.useCallback(
                    ...
                    [b.scrollPosition, y, g, u],
                ),
                C = a.useCallback(
                    function () {
                        const e = f.current;
                        e && (x(i(e, b.scrollPosition.goal), { immediate: !0 }), g.trigger('resizeHandled'));
                    },
                    [x, b.scrollPosition.goal, g],
                );
            xt(m, (e) => {
                const t = e.target;
                if (!(t instanceof HTMLElement)) return;
                const n = s(t);
                _.current.wrapper !== n && C();
            });
            const R = vt(function () {
                    const t = f.current;
                    if (!t) return;
...
function yn(e) {
    ...
    return a.forwardRef(function (e, n) {
        const r = pt(e, e.adaptive),
            { path: s, ...a } = r,
            i = r.images ?? v.resolve('images'),
            c = { ...a, ref: n };
        {
            const e = s ? i.readOr(s, xn, 'warn') : void 0;
...
a.forwardRef(function (e, t) {
    if (!e.src) {
        ...
        return o.jsx('div', { ...d, ref: t, style: { width: e.width, height: e.height, ...u, ...e.style } });
    }
    const { repeat: n, fit: r, position: s, width: a, height: i, unknownStyle: c, unselectable: l, ...u } = e;
    return o.jsx('div', {
        ...u,
        ref: t,
        style: {
...
const Cn = yn(
    a.forwardRef(function (e, t) {
        if (e.unknown) {
            ...
            return o.jsx('div', { ...f, ref: t, style: { width: e.width, height: e.height, ...d, ...e.style } });
        }
        const {
            repeat: n,
            fit: r,
...
yn(
    a.forwardRef(function (e, t) {
        const { width: n, height: r, src: s, unselectable: a, unknown: i, unknownStyle: c = En, ...l } = e;
        return e.unknown
...
function Dn(e) {
    ...
    return (function (e, t, n) {
        return et.has(t) ? e.map(n) : e.map((e, t, r) => (t === r.length - 1 ? n(e, t, r) : n(`${e} `, t, r)));
    })(
        (function (e, t) {
            return (Ke[t] ?? Je)(e);
        })(e, t),
    ...
    return Array.isArray(e)
        ? (function (e) {
              ...
              for (let n = 0; n < e.length; n++) {
                  ...
                  const i = Dn(s.slice(1));
                  (t.push(
                      o.jsxs(
                          a.Fragment,
                          { children: [o.jsxs('span', { className: Ln.nowrap, children: [kn(r), s[0]] }), i] },
                          Mn(),
                      ),
                  ),
                      (n += 1));
        ...
        : 'string' == typeof e
          ? o.jsx(a.Fragment, { children: Dn(e) }, Mn())
          : e;
}
const An = {
    class: function (e, ...t) {
...
const Hn = ['number', 'string', 'undefined'];
function zn(e, t, n = {}, r = !0) {
    r && (Pn = 0);
    const s = [];
    function i(e) {
        if (Hn.includes(typeof e)) {
            const t = s.at(-1);
        ...
        const {
            ...
            m = a.useMemo(
                () =>
                    e.upgradeLegacy
                        ? (function (e) {
                              return we(e, Gn, Un, Vn);
                          })(e.text)
                        : e.text,
                [e.text, e.upgradeLegacy],
            ),
            h = a.useMemo(() => (e.formatters ? { ...An, ...e.formatters } : An), [e.formatters]),
            _ = a.useMemo(
                () =>
                    (function (e, t) {
                        const n = [],
                        ...
                        for (let c = 0; c < e.length; c++) {
                            ...
                            if (l === t.start[0] && e.slice(c, c + t.start.length) === t.start)
                                (s &&
                                    (r.length > 0
                                        ? r[r.length - 1].node.children.push({ type: Rn, value: s })
                                        : n.push({ type: Rn, value: s }),
                                    (s = '')),
                                    (a = !0),
                                    (c += t.start.length - 1));
                                ...
                                if (e.startsWith('@')) {
                                    const t = e.slice(1).trim(),
                                        s = { type: Sn, attrs: t.split('|'), instanceId: ++i, children: [] };
            ...
            g = a.useMemo(() => zn(_, h, e.params), [_, h, e.params]),
            p = i(Ln.base, c && Ln.base__fullSize, f.className);
        return e.inline
            ? (console.warn(
            ...
            : o.jsx('span', { ...f, className: p, children: g });
    });
function qn({ path: e, ...t }) {
    return o.jsx(Zn, { text: v.resolve('strings').readOrEmpty(e), ...t });
}
const Yn = { primary: 'primary', secondary: 'secondary', custom: 'custom' },
    Xn = { extraSmall: 'extraSmall', small: 'small', medium: 'medium', large: 'large' };
function Qn(e, t, n) {
    ...
    if ('object' == typeof t) {
        const n = t,
            ...
            i = a.forwardRef(function (e, t) {
                return a.createElement(o, { ...('function' == typeof o ? e : Kn(s, e)), ref: t, className: r(e) });
            });
        return ((i.displayName = e), n.cva && (i.cva = n.cva), i);
    }
    const i = _(t, n),
        c = a.forwardRef(function (t, n) {
            return o.jsx('div', { 'data-name': e, ...Kn(s, t), ref: n, className: i(t) });
        });
...
const Jn = Qn('Button', { element: 'button', className: 'HeadlessButton_df8536fc' }),
    er = a.forwardRef(function (
        { children: e, onClick: t, onMouseEnter: n, soundTarget: r, disabled: s = !1, silent: a = !1, ...i },
        c,
    ) {
        const l = Yt();
        return o.jsx(Jn, {
    ...
    nr = a.forwardRef(function (
        ...
        return o.jsxs(er, {
            ...
            className: i(
                ...
                tr[`base__size-${t}`],
                tr[`base__theme-${n}`],
                r ? tr.base__disabled : tr.base__enabled,
                l,
                c?.base,
            ),
            onClick: function (e) {
            ...
            children: [
                o.jsx('div', { className: i(tr.background, c?.background) }),
                o.jsx('div', { className: i(tr.border, c?.border) }),
                o.jsx('div', { className: i(tr.overlay, c?.overlay) }),
                o.jsx('div', { className: i(tr.content, a && tr.content__fontAligned, c?.content), children: e }),
            ],
        });
    });
((nr.themes = Yn), (nr.sizes = Xn));
const rr = a.createContext(void 0);
function sr() {
...
const ar = vn({
        ...
        getDirection: (e) => (e.deltaY > 1 ? bn.Next : bn.Prev),
...
function dr(e) {
    ...
    a.useEffect(() => {
        n || e.dragging
            ? l.start({
                  to: e.styles.opened,
                  onRest() {
                      t.current?.classList.add(cr.base__active);
                  },
              })
            : l.start({
                  to: e.styles.closed,
                  delay: 500,
                  onRest() {
                      t.current?.classList.remove(cr.base__active);
                  },
              });
            ...
            'number' == typeof t &&
                (function (e, t) {
                    ...
                    if (n instanceof HTMLElement) {
                        if (0 === t) return (n.classList.add(ur), void n.classList.remove(lr));
                        if (e.isBoundThumb(t)) return (n.classList.remove(ur), void n.classList.add(lr));
                        (n.classList.remove(ur), n.classList.remove(lr));
                    }
                })(e, t);
        });
    a.useEffect(() => d.run(f));
    ...
    return (
        ...
        o.jsxs(g.div, {
            ref: dn([t, e.thumbRef]),
            className: i(cr.base, cr[`base__${e.direction}`], e.className),
            style: c,
            onMouseEnter: () => r(!0),
            onMouseLeave: () => r(!1),
            children: [
                o.jsx('div', { className: cr.background }),
                o.jsx('div', { className: cr.border }),
                o.jsx('div', { className: cr.innerBorder }),
                o.jsx('div', { className: cr.icon }),
            ],
        })
    );
}
const fr = { pending: !1, offset: 0 };
function mr(e, t, n, r, s) {
    const [o, i] = a.useState(fr),
        c = vt(t),
        l = a.useCallback(
            (t) => {
...
const hr = 'disable',
    _r = 'scroll-active';
function gr({ api: e, baseRef: t }) {
    const n = Bt(),
        r = vt(function () {
            const n = e.getWrapperSize(),
                r = e.getContainerSize();
            if (null === t.current || void 0 === r || void 0 === n) return;
            1 === Math.min(1, n / r || 1) ? t.current.classList.remove(_r) : t.current.classList.add(_r);
        });
    (a.useEffect(() => n.run(r)),
        a.useEffect(() => {
            function t() {
...
function pr(e, t) {
    const n = e.getBoundingClientRect(),
        r = t === or ? n.x : n.y;
    return { start: r, end: t === or ? r + n.width : r + n.height };
}
function br(e, t, n, r, s, o, i) {
    const c = Yt(),
        l = s.stepTimeout || 100,
        [u, d] = (function (e, t, n = []) {
            const r = a.useRef(0),
    ...
    const f = a.useCallback(
            (e) => {
                e.target.classList.contains(hr) ||
                    (c.play('click', { target: 'Scroll:Back', original: e }), u(bn.Next));
            },
            [u, c],
        ),
        m = a.useCallback(
            (e) => {
                e.target.classList.contains(hr) ||
                    (c.play('click', { target: 'Scroll:Forward', original: e }), u(bn.Prev));
            },
            [u, c],
        ),
        h = a.useCallback(
            (a) => {
                ...
                const _ = (function (e, t, n, r, s, a) {
                        return {
                            occurredEvent: a === or ? e.screenX : e.screenY,
                            bar: pr(t, a),
                            thumb: pr(n, a),
                            backButton: pr(r, a),
                            forwardButton: pr(s, a),
                        };
                    })(a, l, u, d, h, i),
                ...
                if (g) o({ pending: !0, offset: _.occurredEvent - _.thumb.start });
                    ...
                    ((_.occurredEvent > _.thumb.start ? bn.Prev : bn.Next) === bn.Next ? f : m)(a);
                } else {
                ...
                c.play('click', { target: 'Scroll:' + (g ? 'thumb' : p ? 'button' : ''), original: a });
            },
            [e, t, n, r, c, i, o, f, m, s],
        ),
        _ = a.useCallback(
            (e) => {
                e.target.classList.contains(hr) || c.play('mouse-enter', { target: 'Scroll:Bar', original: e });
            },
            [c],
        );
    return a.useMemo(
...
const wr = 'HorizontalBar_rail_37858d8f',
    vr = 'HorizontalBar_4df27ac3',
    xr = 'HorizontalBar_track_649dc296',
    yr = 'HorizontalBar_rail__left_1a906b4e',
    Er = 'HorizontalBar_rail__right_cd24364e',
    Cr = 'HorizontalBar_button__right_e8f0aa2d',
    Rr = 'HorizontalBar_button__left_da330e13',
    Sr = 'HorizontalBar_button_cbabd91',
    Tr = { closed: { height: '3rem', top: '4rem' }, opened: { height: '11rem', top: '0rem' } },
    Lr = (e, t) => Math.max(ge(13), e.offsetWidth * t),
    Nr = a.memo(function ({ classNames: e = {}, onDrag: t = Re }) {
        const n = a.useRef(null),
            r = a.useRef(null),
            s = a.useRef(null),
            c = a.useRef(null),
            ...
            { api: h } = sr();
        gr({ baseRef: n, api: h });
        const _ = vt((e, t, { parent: n }) => (e.screenX - t.offset - n.getBoundingClientRect().x) / n.offsetWidth),
            g = vt((e) => e - (c.current.offsetWidth - l.current.offsetWidth) >= -0.5),
            p = a.useCallback((e) => ('dragStart' === e.type ? m(!0) : 'dragEnd' === e.type && m(!1), t(e)), [t]),
            b = mr(l, p, h, c, _),
            w = vt(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: n }) => {
                const r = c.current,
                    s = u.current,
                    a = d.current;
                if (!r || !s || !a) return;
            ...
            { handleMouseEnter: v, handleMouseDownTrack: x } = br(n, l, s, r, h, b, or);
        return o.jsxs('div', {
            className: i(vr, e.base),
            ref: n,
            onWheel: h.handleMouseWheel,
            onMouseDown: x,
            onMouseEnter: v,
            children: [
                o.jsx('div', { ref: r, className: i(Sr, Rr, e.leftButton) }),
                o.jsxs('div', {
                    ref: c,
                    className: i(xr, e.track),
                    children: [
                        o.jsx('div', { ref: u, className: i(wr, yr, e.leftRail) }),
                        o.jsx(dr, {
                            dragging: f,
                            api: h,
                            calculateOffset: _,
                        ...
                        o.jsx('div', { ref: d, className: i(wr, Er, e.rightRail) }),
                    ],
                }),
                o.jsx('div', { ref: s, className: i(Sr, Cr, e.rightButton) }),
            ],
        });
    }),
    Pr = {
    ...
    Mr = ({
        ...
        const { api: u } = sr(),
            d = a.useMemo(() => {
                const e = n || {};
                return { ...e, base: i(Pr.base, e.base) };
            }, [n]);
        return o.jsxs('div', {
            className: i(Pr.defaultScroll, t),
            onWheel: u.handleMouseWheel,
            children: [
                o.jsx('div', {
                    className: i(Pr.defaultScrollArea, r),
                    children: o.jsx(Br, { className: c, classNames: s, children: e }),
                }),
                o.jsx(Nr, { onDrag: l, classNames: d }),
            ],
        });
    };
function Br({ className: e, classNames: t, children: n }) {
    const { api: r } = sr();
    return o.jsx('div', {
        className: i(Pr.base, e),
        children: o.jsx('div', {
            className: i(Pr.wrapper, t?.wrapper),
            onWheel: r.handleMouseWheel,
            ref: r.wrapperRef,
            children: o.jsx('div', { className: i(Pr.content, t?.content), ref: r.contentRef, children: n }),
        }),
    });
}
((Br.Bar = Nr), (Br.Default = Mr));
const Dr = { horizontal: 'horizontal', vertical: 'vertical' };
function kr(e, t) {
    switch (t) {
        case Dr.horizontal:
            return e.screenX;
        case Dr.vertical:
            return e.screenY;
        default:
            je(!1, `Such drag direction ${t} is not supported`);
    }
}
const Ar = { type: 'idle' };
function Fr(e, t, n, r) {
    ...
    return (
        ...
        a.useEffect(() => {
            ...
            const r = X.move(([e]) => {
                ...
                a = X.up(() => m({ type: 'scrollComplete' }));
            return () => {
                (r(), a());
            };
        }, [l.scrollPosition, s, h, t, f, g, o]),
        a.useEffect(() => {
            ...
            const e = X.move(([e, r]) => {
                ...
                i.start({ scrollPosition: c(a, p), from: { scrollPosition: l.scrollPosition.get() }, ...n });
            });
        ...
        }, [l.scrollPosition, c, s, f, i, o, n, t]),
        a.useEffect(() => {
        ...
        }, [l.scrollPosition, s, d, t, g]),
        f
    );
}
function Ir({ settings: e, children: t }) {
    const n = ar({ settings: e }),
        r = a.useMemo(() => ({ api: n }), [n]);
    return o.jsx(rr.Provider, { value: r, children: t });
}
const Or = a.createContext(void 0);
function $r() {
    const e = a.useContext(Or);
...
const jr = vn({
    ...
    Hr = 'VerticalBar_rail_3d663c9',
    zr = 'VerticalBar_7187fa00',
    Ur = 'VerticalBar_track_ff482708',
    Vr = 'VerticalBar_rail__top_ee531f43',
    Gr = 'VerticalBar_rail__bottom_3eaa33b1',
    Wr = 'VerticalBar_button__bottom_6880f123',
    Zr = 'VerticalBar_button__top_b8383775',
    qr = 'VerticalBar_button_7b0e4aca',
    Yr = { closed: { width: '3rem', left: '3rem' }, opened: { width: '9rem', left: '0rem' } },
    Xr = (e, t) => Math.max(ge(13), e.offsetHeight * t),
    Qr = a.memo(function ({ classNames: e = {}, onDrag: t = Re }) {
        const n = a.useRef(null),
            r = a.useRef(null),
            s = a.useRef(null),
            c = a.useRef(null),
            ...
            { api: h } = $r();
        gr({ baseRef: n, api: h });
        const _ = vt((e) => e - (c.current.offsetHeight - l.current.offsetHeight) >= -0.5),
            g = vt((e, t, { parent: n }) => (e.screenY - t.offset - n.getBoundingClientRect().y) / n.offsetHeight),
            p = a.useCallback((e) => ('dragStart' === e.type ? m(!0) : 'dragEnd' === e.type && m(!1), t(e)), [t]),
            b = mr(l, p, h, c, g),
            w = vt(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: n }) => {
                const r = c.current,
            ...
            { handleMouseEnter: v, handleMouseDownTrack: x } = br(n, l, r, s, h, b, ir);
        return o.jsxs('div', {
            className: i(zr, e.base),
            ref: n,
            onWheel: h.handleMouseWheel,
            onMouseDown: x,
            onMouseEnter: v,
            children: [
                o.jsx('div', { ref: r, className: i(qr, Zr, e.topButton) }),
                o.jsxs('div', {
                    ref: c,
                    className: i(Ur, e.track),
                    children: [
                        o.jsx('div', { ref: u, className: i(Hr, Vr, e.topRail) }),
                        o.jsx(dr, {
                            dragging: f,
                            api: h,
                            calculateOffset: g,
                        ...
                        o.jsx('div', { ref: d, className: i(Hr, Gr, e.bottomRail) }),
                    ],
                }),
                o.jsx('div', { ref: s, className: i(qr, Wr, e.bottomButton) }),
            ],
        });
    }),
    Kr = {
    ...
    Jr = ({
        ...
        const { api: u } = $r(),
            d = a.useMemo(() => {
                const e = n || {};
                return { ...e, base: i(Kr.base, e.base) };
            }, [n]);
        return o.jsxs('div', {
            className: i(Kr.defaultScroll, t),
            onWheel: u.handleMouseWheel,
            children: [
                o.jsx('div', {
                    className: i(Kr.area, r),
                    children: o.jsx(es, { className: s, classNames: c, children: e }),
                }),
                o.jsx(Qr, { onDrag: l, classNames: d }),
            ],
        });
    },
    es = ({ className: e, classNames: t, children: n, ...r }) => {
        const { api: s } = $r();
        return (
            a.useEffect(() => $e(() => $e(s.recalculateContent))),
            o.jsx('div', {
                className: i(Kr.base, t?.wrapper, e),
                ref: s.wrapperRef,
                onWheel: s.handleMouseWheel,
                children: o.jsx('div', { ...r, className: i(Kr.content, t?.content), ref: s.contentRef, children: n }),
            })
        );
    };
function ts({ children: e }) {
    const t = jr(),
        n = a.useMemo(() => ({ api: t }), [t]);
    return o.jsx(Or.Provider, { value: n, children: e });
}
es.Default = Jr;
var ns = ((e) => (
        (e.Items = 'items'),
    ...
    os = ((e) => ((e.BATTLE_BOOSTER = 'battleBooster'), e))(os || {}),
    is = ((e) => (
        (e.ATTACHMENT_RARE = 'rare'),
        (e.ATTACHMENT_EPIC = 'epic'),
        (e.ATTACHMENT_LEGENDARY = 'legendary'),
...
const cs = [
        ...
        ns.NaturalCover,
        ns.BpCoin,
        ns.BattlePassSelectToken,
        ns.BattlaPassFinalAchievement,
        ns.BattleBadge,
        ns.BonusX5,
        ns.CrewBonusX3,
        ns.EpicSelectToken,
        ns.Comp7TokenWeeklyReward,
        ns.DeluxeGift,
            ...
            : ls.includes(e)
              ...
              : us.includes(e)
                ...
                : ds.includes(e)
                  ? ss.PREMIUM_PLUS
                  : ss.STRING,
    ms = ['engravings', 'backgrounds'],
    hs = ['engraving', 'background'],
    _s = (e, t = rs.Small) => {
        const { name: n, type: r, value: s, icon: a, item: o, dogTagType: i } = e,
            c = t === rs.S24x24 ? rs.Small : t,
            l = ((e) => {
                switch (e) {
                    case rs.S600x450:
                        return 'c_600x450';
    ...
    xs = 'SPG',
    ys = 'AT-SPG',
    Es = a.createContext(null);
function Cs() {
    const e = a.useContext(Es);
    return (je(null !== e, 'You can use tabs hooks only with Tabs component'), e);
}
const Rs = { primary: 'primary', custom: 'custom' },
    Ss = { large: 'large', medium: 'medium', small: 'small' },
    Ts = 'HorizontalTabs_outerBorderImage_8085e49e',
    Ls = 'HorizontalTabs_mainBorderImage_558d1c3f',
    Ns = 'HorizontalTabs_base__size-small_75fae891',
    Ps = 'HorizontalTabs_base__size-medium_afc0934f',
    Ms = 'HorizontalTabs_base__size-large_12c75e24',
    Bs = 'HorizontalTabs_outerBorder_3255d0c5',
    Ds = 'HorizontalTabs_base__theme-primary_5e3af03e',
    ks = 'HorizontalTabs_mainBorder_61e34c2c',
    As = 'HorizontalTabs_content_1ae3c4bd',
    Fs = Qn('Tabs', 'HorizontalTabs_69e3c6f3', {
        variants: {
            size: { [Ss.large]: Ms, [Ss.medium]: Ps, [Ss.small]: Ns },
            theme: { [Rs.primary]: Ds, [Rs.custom]: void 0 },
        },
    }),
    Is = a.forwardRef(function ({ children: e, classNames: t, ...n }, r) {
        const s = Cs();
        return o.jsx(Fs, {
            ...n,
            ref: r,
            ...
            theme: s.theme,
            children: o.jsxs('div', {
                className: i(Bs, t?.outerBorder),
                children: [
                    o.jsx('div', { className: i(Ts, t?.outerBorderImage) }),
                    o.jsxs('div', {
                        className: i(ks, t?.mainBorder),
                        children: [
                            o.jsx('div', { className: i(Ls, t?.mainBorderImage) }),
                            o.jsx('div', { className: i(As, t?.content), children: e }),
                        ],
                    }),
                ],
            }),
    ...
    Os = 'Tab_border_a63aeb3f',
    $s = 'Tab_background_4c9b3eb9',
    js = 'Tab_backgroundPattern_417be4b5',
    Hs = 'Tab_innerBorderImage_adadda5f',
    zs = 'Tab_base__theme-primary_90fd5ee',
    Us = 'Tab_content_b3f6c22b',
    Vs = 'Tab_base__size-small_0',
    Gs = 'Tab_base__size-medium_0',
    Ws = 'Tab_base__size-large_0',
    Zs = 'Tab_base__active_0',
    qs = 'Tab_base__inactive_0',
    Ys = Qn('Tab', 'Tab_f59c2b00', {
        variants: {
            size: { [Ss.large]: Ws, [Ss.medium]: Gs, [Ss.small]: Vs },
            theme: { [Rs.primary]: zs, [Rs.custom]: void 0 },
            state: { active: Zs, inactive: qs },
        },
        defaultVariants: { size: Ss.medium, theme: Rs.primary },
    }),
    Xs = a.forwardRef(function (
        ...
        return o.jsx(Ys, {
            ...
            onMouseEnter: function (e) {
                (r !== n && u.play('mouse-enter', { target: Ys.displayName, original: e }), i?.(e));
            },
            onClick: function (e) {
                (r !== n && u.play('click', { target: Ys.displayName, original: e }), a?.(e));
            },
            children: s,
        });
    });
function Qs({ active: e, theme: t, size: n, children: r, onActiveChange: s }) {
    ...
    return (
        ...
        o.jsx(Es.Provider, { value: u, children: r })
    );
}
((Qs.Switcher = Is),
    (Qs.Tab = function ({ tabId: e, classNames: t, className: n, children: r, ...s }) {
        const a = Cs();
        return o.jsxs(Xs, {
            'data-test-id': `${e}Tab`,
            ...s,
            ...
            children: [
                o.jsx('div', { className: i($s, t?.background) }),
                o.jsx('div', { className: i(js, t?.backgroundPattern) }),
                o.jsx('div', { className: i(Os, t?.border) }),
                o.jsx('div', { className: i(Hs, t?.borderImage) }),
                o.jsx('div', { className: i(Us, t?.content), children: r }),
            ],
        });
    }),
    (Qs.Content = function ({ children: e, keyOverride: t }) {
        const n = Cs();
        return o.jsx(a.Fragment, { children: e(n.active) }, t ?? n.active);
    }));
const Ks = a.createContext(void 0);
function Js() {
    const e = a.useContext(Ks);
    if (!e) throw new Error('Card context must be used only within its provider');
    return e;
}
function ea({ selected: e, hover: t, disabled: n, multiple: r, status: s, children: i }) {
    const c = a.useMemo(() => ({ selected: e, hover: t, disabled: n, multiple: r, status: s }), [n, t, r, e, s]);
    return o.jsx(Ks.Provider, { value: c, children: i });
}
const ta = a.createContext(null);
const na = ta.Provider,
    ra = 'Content_ab8563af',
    sa = 'Content_disabledOverlay_af87c441',
    aa = 'Content_multipleCorner_151c26ee',
    oa = Qn('Content', 'Content_8eaaf71a', {
        variants: {
    ...
    ia = ({ children: e, classNames: t }) => {
        ...
        return (
            ...
            o.jsxs(oa, {
                ...
                disabled: r.disabled,
                children: [
                    r.multiple && o.jsx('div', { className: aa }),
                    o.jsxs('div', {
                        ref: n,
                        className: i(ra, t?.mainContainerContent),
                        children: [r.disabled && o.jsx('div', { className: sa }), e],
                    }),
                ],
            })
        );
    ...
    la = v.resolve('strings');
Qn('Status', ca.base, {
    variants: { status: { done: ca.base__done, alert: ca.base__alert, locked: ca.base__locked } },
});
const ua = ({ header: e, body: t }) => Boolean(e && t),
    da = ({ reason: e, classNames: t }) => {
        const n = a.useRef(null),
            [r, s] = f.useState(!1),
            c = `base__${Js().status}${r ? 'Small' : ''}`,
            l = f.useCallback(() => {
                const e = n.current?.getBoundingClientRect();
                e && s(e.width <= 100);
            }, [n]);
        ...
        const u = e
                ? {
                      header: la.readOrEmpty(`tooltips.moduleFits.${e}.header`),
                      body: la.readOrEmpty(`tooltips.moduleFits.${e}.text`),
                  }
                : {},
            d = jt(u);
        return o.jsxs('div', {
            className: i(ca.base, ca[c], t?.wrapper),
            ref: n,
            children: [
                o.jsx('div', { className: ca.glowBig }),
                o.jsx('div', { className: ca.line }),
                o.jsx('div', { className: ca.shadow }),
                o.jsx('div', { className: ca.glowInner }),
                o.jsx('svg', {
                    width: '42',
                    height: '42',
                    viewBox: '0 0 42 42',
                ...
                o.jsx('div', { ...(ua(u) && d), className: i(ca.icon, t?.icon) }),
            ],
        });
    },
    fa = 'Card_base__wrapped_c6eb8737',
    ma = 'Card_f7ddaa4a',
    ha = 'Card_content_b6f6a22a',
    _a = 'Card_centerBorder_8a0f28ae',
    ga = Qn('Card', 'Card_f0963ece', {
        variants: {
            ...
            children: o.jsxs(ea, {
                ...
                children: [
                    o.jsx('div', {
                        ...
                        children: o.jsx(ia, { classNames: m, children: e }),
                    }),
                    o.jsx('div', { className: _a }),
                    n && o.jsx(da, { reason: r, classNames: m?.status }),
                ],
            }),
        });
    }),
...
const Ca = 'LinesBuilder_lineInner_a52dc157',
    Ra = 'LinesBuilder_lineOuter_c57514b2';
const Sa = a.memo(({ containerRef: e, generation: t, border: n, cardSelector: r }) => {
                ...
                const s = t.getBoundingClientRect(),
                    a = (function (e, t, n) {
                        ...
                        for (let a = 0; a < e.length; a++) {
                            ...
                            (n !== ba && r.push({ x: o.x, y: o.y, width: o.width, height: o.height }),
                                s.addLine(o.x, o.y, o.width, 1, Ca),
                                s.addLine(o.x, o.y + o.height, o.width, 1, Ca),
                                s.addLine(o.x, o.y, 1, o.height, Ca),
                                s.addLine(o.x + o.width, o.y, 1, o.height + 1, Ca));
                        }
                        if (n !== ba) {
                            const e = ya(r);
                            let t = null;
    ...
    Ta = 'CardsWrapper_3b6cc4f6',
    La = 'CardsWrapper_card_c7fc9ee7',
    Na = 'CardsWrapper_centerBorderCommon_b4b27a11',
    Pa = 'CardsWrapper_outerBorderCommon_f4887371',
    Ma = Qn('CardsWrapper', Ta);
a.forwardRef(function (
    { children: e, className: t, threshold: n, border: r = wa, enabled: s = !0, cardSelector: i, ...c },
    l,
) {
    const u = a.useRef([]),
        d = a.useRef(null),
    ...
    const h = a.useCallback(
        (e) => {
            const t = d.current;
            if (!t) return;
            const n = t.querySelectorAll(`.${i || ma}`);
            if (n.length > 0) {
    ...
    return o.jsx(Ma, {
        ...
        children: o.jsxs('div', {
            className: t,
            children: [
                o.jsx(na, { value: _, children: e }),
                o.jsx(Sa, { cardsRef: u, containerRef: d, border: r, generation: f, cardSelector: i }),
            ],
        }),
    });
});
const Ba = a.forwardRef(({ className: e, classNames: t, ...n }, r) =>
        o.jsxs('div', {
            className: i(Ta, t?.wrapper),
            children: [
                o.jsx('div', { className: Na }),
                o.jsx('div', { className: Pa }),
                o.jsx(pa, { className: i(La, e, t?.card), classNames: t, ...n, ref: r }),
            ],
        }),
    ),
    Da = { done: 'done', locked: 'locked' },
    ka = {
    ...
    Ia = ({
        ...
        const _ = Fa.has(s) ? Fa.get(s) : s,
            g = ((e, t) => {
                if (void 0 === t || !ps.includes(e)) return null;
                switch (t) {
                    case as.BATTLE_BOOSTER:
                    case as.BATTLE_BOOSTER_REPLACE:
                        return os.BATTLE_BOOSTER;
                }
            })(s, a),
            b = ((e) => {
                ...
                switch (e) {
                    case as.BATTLE_BOOSTER:
                        return is.BATTLE_BOOSTER;
                    case as.BATTLE_BOOSTER_REPLACE:
                        return is.BATTLE_BOOSTER_REPLACE;
                    case as.BUILT_IN_EQUIPMENT:
                        return is.BUILT_IN_EQUIPMENT;
                    case as.EQUIPMENT_PLUS:
                        return is.EQUIPMENT_PLUS;
                    case as.EQUIPMENT_TROPHY_BASIC:
                        return is.EQUIPMENT_TROPHY_BASIC;
                    case as.EQUIPMENT_TROPHY_UPGRADED:
                        return is.EQUIPMENT_TROPHY_UPGRADED;
                    case as.EQUIPMENT_MODERNIZED_UPGRADED_1:
                        return is.EQUIPMENT_MODERNIZED_UPGRADED_1;
                    case as.EQUIPMENT_MODERNIZED_UPGRADED_2:
                        return is.EQUIPMENT_MODERNIZED_UPGRADED_2;
                    case as.EQUIPMENT_MODERNIZED_UPGRADED_3:
                        return is.EQUIPMENT_MODERNIZED_UPGRADED_3;
                    case as.PROGRESSION_STYLE_UPGRADED_1:
                        return is.PROGRESSION_STYLE_UPGRADED_1;
                    case as.PROGRESSION_STYLE_UPGRADED_2:
                        return is.PROGRESSION_STYLE_UPGRADED_2;
                    case as.PROGRESSION_STYLE_UPGRADED_3:
                        return is.PROGRESSION_STYLE_UPGRADED_3;
                    case as.PROGRESSION_STYLE_UPGRADED_4:
                        return is.PROGRESSION_STYLE_UPGRADED_4;
                    case as.PROGRESSION_STYLE_UPGRADED_5:
                        return is.PROGRESSION_STYLE_UPGRADED_5;
                    case as.PROGRESSION_STYLE_UPGRADED_6:
                        return is.PROGRESSION_STYLE_UPGRADED_6;
                    case as.ATTACHMENT_RARE:
                        return is.ATTACHMENT_RARE;
                    case as.ATTACHMENT_EPIC:
                        return is.ATTACHMENT_EPIC;
                    case as.ATTACHMENT_LEGENDARY:
                        return is.ATTACHMENT_LEGENDARY;
                }
            })(a),
            w = ((e, t) => {
            ...
            y = jt({ header: h?.header, body: h?.body });
        return o.jsxs('div', {
            className: p(ka.base, ka[`base__${s}`], !r && ka.base__dynamicBox, d),
            style: u,
            ...x,
            children: [
                o.jsxs(o.Fragment, {
                    children: [
                        o.jsxs('div', {
                            className: p(ka.image, r ? ka.image__fixedBox : ka[`image__${s}`], f?.image),
                            children: [
                                g &&
                                    o.jsx('div', {
                                        className: p(ka.highlight, f?.highlight),
                                        style: {
                                            backgroundImage: `url(${Aa.readOrEmpty(`quests.bonuses.${_}.${g}_highlight`)})`,
                                        },
                                    }),
                                t &&
                                    o.jsx('div', {
                                        className: p(ka.icon, f?.rewardIcon),
                                        style: { backgroundImage: `url(${t})` },
                                    }),
                                b &&
                                    o.jsx('div', {
                                        className: p(ka.overlay, f?.overlay),
                                        style: {
                                            backgroundImage: `url(${Aa.readOrEmpty(`quests.bonuses.${_}.${b}_overlay`)})`,
                                        },
                                    }),
                            ],
                        }),
                        w &&
                            o.jsx('div', {
                                className: p(ka.info, ka[`info__${e}`], c === ss.MULTI && ka.info__multi, f?.info),
                                children: w,
                            }),
                        l && o.jsx('div', { className: ka.title, children: l }),
                    ],
                }),
                n && o.jsx('div', { className: p(ka.timer, f?.periodicIcon), ...y }),
            ],
        });
    },
    Oa = 'SceneWrapper_52fcfc1e',
    $a = 'SceneWrapper_base__down_4ece5089',
    ja = 'SceneWrapper_base__moveSpaceDisabled_1b1cd939';
function Ha({
    children: e,
    moveSpace: t,
    ...
    return (
        ...
        o.jsx('div', {
            ...l,
            ref: g,
            className: i(Oa, u && $a, !s && ja, c),
            onMouseDown: function (e) {
                (e.preventDefault(), w(e) && (d(!0), m(!0), _({ x: e.clientX, y: e.clientY })));
            },
            onMouseMove: function (e) {
                if ((e.preventDefault(), u && f)) {
                    if (!b(e)) return;
...
const za = a.createContext(void 0);
function Ua() {
    const e = a.useContext(za);
...
const Va = {
    ...
    Ga = a.forwardRef(function ({ className: e, classNames: t, ...n }, r) {
        const s = Ua();
        return o.jsx('div', {
            ...n,
            ref: r,
            className: i(Va.filled, Va[`filled__${s.size}`], e),
            children: o.jsxs('div', {
                className: i(Va.wrapper, t?.wrapper),
                children: [
                    o.jsx('div', { className: i(Va.fill, t?.fill), style: { width: 100 * s.percentage + '%' } }),
                    o.jsx('div', { className: i(Va.pattern, t?.pattern), style: { width: 100 * s.percentage + '%' } }),
                ],
            }),
        });
    });
function Wa(e) {
    const [t, n] = a.useState(Math.min(e.value, e.maxValue)),
        ...
        i = bt(t),
        c = bt(r),
        l = vt((t) => n(Math.min(t, e.maxValue)));
    (a.useLayoutEffect(() => {
        l(e.value);
    }, [e.value, l]),
        a.useLayoutEffect(() => {
    ...
    const u = vt((t) => e.onValueChange?.(t));
    a.useEffect(() => {
        u(t);
    }, [u, t]);
    const d = vt((t) => e.onMaxValueChange?.(t));
    a.useEffect(() => {
        d(r);
    }, [d, r]);
    const f = a.useMemo(() => {
    ...
    je(r > 0, 'ProgressBar: maxValue must be greater than 0');
    const m = a.useMemo(
        () => ({
            value: t,
            maxValue: r,
        ...
        [t, r, l, s, f, e.size, e.animationEnabled],
    );
    return o.jsx(za.Provider, { value: m, children: e.children });
}
const Za = 'ProgressBar_background_b40cdfdf',
    qa = 'ProgressBar_backgroundPattern_7e932276',
    Ya = Qn('ProgressBar', 'ProgressBar_27c2305c', {
        variants: {
            size: {
...
function Xa({ size: e = 'medium', className: t, classNames: n, filledClassName: r, filledClassNames: s, ...a }) {
    return o.jsx(Wa, {
        size: e,
        ...a,
        children: o.jsxs(Ya, {
            ...
            className: t,
            children: [
                o.jsx('div', { className: i(Za, n?.background) }),
                o.jsx('div', { className: i(qa, n?.backgroundPattern) }),
                o.jsx(Ga, { className: r, classNames: s }),
                a.children,
            ],
        }),
    });
...
const Qa = 'Delta_5c8185db',
    Ka = 'Delta_delta__increase_e6e76b0b',
    Ja = 'Delta_glow_8e83fd7a',
    eo = a.memo(
        a.forwardRef(function (
            { initValue: e, initMaxValue: t, animationEnabled: n = !0, animationProps: r, classNames: s, ...c },
            l,
        ) {
            const u = a.useRef(null),
                ...
                m = a.useMemo(() => {
                    ...
                    je(t > 0, 'initMaxValue must be greater than 0');
            ...
            return (
                ...
                o.jsxs('div', {
                    ...c,
                    ref: dn([l, u]),
                    className: i(c.className, Qa),
                    children: [h && o.jsx('div', { className: i(Ja, s?.glow), ref: d }), c.children],
                })
            );
        }),
    ),
    to = { lightTank: bs, mediumTank: ws, heavyTank: vs, SPG: 'SPG', 'AT-SPG': ys },
    no = Object.values(to),
    ro = (e) => no.includes(e),
    so = 'assault',
    ao = 'sniper',
    ...
    co = 'break',
    lo = 'wheeled',
    uo = 'VehicleLevel_3c938122',
    fo = { arabic: 'arabic', roman: 'roman' };
const mo = a.forwardRef(function ({ value: e, numberType: t, ...n }, r) {
    const s = (function (e, t) {
            return e || (t ? fo.arabic : fo.roman);
        })(
            t,
            (function () {
                const e = v.resolve('strings');
                return Vt.includes(e.readOrEmpty('settings.LANGUAGE_CODE'));
            })(),
        ),
        a = s === fo.roman ? We(e) : e;
    return o.jsx('div', { ...n, 'data-name': 'VehicleLevel', className: i(uo, n.className), ref: r, children: a });
});
mo.numberTypes = fo;
const ho = 'prestige',
    _o = 'short',
    go = 'medium',
    po = 'long',
    bo = (e) => (e < 10 ? _o : e < 100 ? go : po),
    wo = (e, t, n) => (t === ho ? ho : `${t}.${bo(e)}.c_${n}`),
    vo = {
...
function xo({ level: e, grade: t, type: n, direction: r, classNames: s, ...a }) {
    return e < 1 || 'undefined' === n
        ...
        : o.jsxs('div', {
              ...a,
              className: i(vo.base, vo[`base__${n}`], vo[`base__${r}`], a.className, s?.base),
              children: [
                  o.jsx(Cn, { path: `prestige.tab.${wo(e, n, t)}`, className: i(vo.icon, s?.icon) }),
                  n !== ho && o.jsx('div', { className: i(vo.level, vo[`level__${bo(e)}`], s?.level), children: e }),
              ],
          });
}
xo.direction = { left: 'left', right: 'right' };
const yo = {
        [`${so}_x16x16`]: (e) =>
            a.createElement(
                'svg',
    ...
    Co = { x16x16: 'x16x16', x24x24: 'x24x24', x32x32: 'x32x32', x48x48: 'x48x48' },
    Ro = a.forwardRef(function ({ roleKey: e, size: t = Co.x24x24, classNames: n, ...r }, s) {
        const a = yo[`${e}_${t}`];
        if (a)
            return o.jsx('div', {
                ...r,
                ref: s,
                className: i(Eo.base, Eo[`base__${t}`], n?.base),
                children: o.jsx(a, { className: i(Eo.icon, n?.icon) }),
            });
        console.error(`Unknown vehicle role type ${e} with size ${t}`);
    });
Ro.sizes = Co;
const So = { x24x24: 'x24x24', x48x48: 'x48x48', x64x64: 'x64x64', x96x96: 'x96x96' },
    To = { x24x24: 'x64x64', x48x48: 'x96x96', x64x64: 'x96x96', x96x96: 'x96x96' },
    Lo = {
        [to.lightTank]: 'light_tank',
        [to.mediumTank]: 'medium_tank',
        [to.heavyTank]: 'heavy_tank',
        [to.SPG]: 'spg',
        [to['AT-SPG']]: 'tank_destroyer',
    },
    No = {
    ...
    Po = a.forwardRef(function ({ type: e, size: t = So.x48x48, premium: n = !1, fit: r = 'contain', ...s }, a) {
        const c = ((l = So[t]), (u = To[t]), ht().upscale ? u : l);
        var l, u;
        return o.jsx(Cn, {
            ...s,
            ref: a,
            fit: r,
            className: i(No.base, n ? No[`base__premium__${t}`] : No[`base__${t}`], s.className),
            path: `ui_kit.vehicle_type.${c}.${n ? 'premium_' : ''}${U(Lo[e])}_${c}`,
        });
    });
((Po.types = to), (Po.sizes = So));
const Mo = 'VehicleInfo_1732f1f0',
    Bo = Qn('VehicleName', 'VehicleInfo_name_3989ca04', {
        variants: { premium: { true: 'VehicleInfo_name__premium_258b3b93' } },
    }),
    Do = a.forwardRef(function (e, t) {
        return o.jsx('div', { ...e, ref: t, className: i(Mo, e.className) });
    });
((Do.Prestige = xo), (Do.Level = mo), (Do.Type = Po), (Do.Name = Bo), (Do.Role = Ro));
const ko = 'Tooltip_decorator_b3486d4e',
    Ao = Qn('Base', 'Tooltip_6d997cee'),
    Fo = Qn('Decorator', ko),
    Io = a.forwardRef(function ({ children: e, ...t }, n) {
