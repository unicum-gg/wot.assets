...
const O = Object.freeze(
    ...
    z = ({ className: s, children: o }) => {
        const t = m.resolve('strings');
        return e.jsxs('div', {
            className: n(P, s),
            children: [
                e.jsx('div', { className: T, children: t.readOrEmpty('common.common.bullet') }),
                e.jsx('div', { className: S, children: o }),
            ],
        });
    },
...
function q() {
    return e.jsxs('div', {
        className: D,
        children: [
            e.jsx(x, { path: 'personal_missions_30.tooltip.personalMissionsPoints.innerBlock.title', className: w }),
            e.jsx(x, {
                path: 'personal_missions_30.tooltip.personalMissionsPoints.innerBlock.description',
                className: A,
            }),
            e.jsx(x, { path: 'personal_missions_30.tooltip.personalMissionsPoints.innerBlock.subTitle', className: E }),
            e.jsxs('div', {
                className: L,
                children: [
                    e.jsx(z, {
    ...
    return e.jsxs('div', {
        ...
        children: [
            ...
            e.jsxs('div', {
                className: K,
                children: [
                    e.jsx(x, { path: 'personal_missions_30.tooltip.progression.innerBlock.title', className: Q }),
                    e.jsxs('div', {
                        className: R,
                        children: [
                            e.jsx(z, {
                ...
                default: function () {
                    return e.jsx(p.Decorator, {
                        children: e.jsxs('div', {
                            className: W,
                            children: [
                                e.jsx(x, { path: 'personal_missions_30.tooltip.progression.title', className: X }),
                                e.jsx(x, {
                                    path: 'personal_missions_30.tooltip.progression.description',
                                    className: Y,
                                }),
                                e.jsx(h, { children: e.jsx(V, {}) }),
                                e.jsx(x, { path: 'personal_missions_30.tooltip.progression.footer', className: Z }),
                            ],
                        }),
                    });
                },
...
function ns({ type: s }) {
    return e.jsxs('div', {
        ...
        children: [
            ...
            e.jsx('span', { className: n(ss, es), children: s.length > 0 ? s : '<empty>' }),
        ],
    });
}
const os = Object.fromEntries(
    Object.entries(
        Object.assign({ './custom_simple/index.tsx': O, './pm3_points/index.tsx': H, './progression/index.tsx': $ }),
...
const ts = l(function () {
    const { model: s } = I(),
        n = s.type.get(),
        o = os[n]?.Component;
    return e.jsx(p, { children: o ? e.jsx(o, {}) : e.jsx(ns, { type: n }) });
});
b(new u().add(f).render(e.jsx(ts, {})));
