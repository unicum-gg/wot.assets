    ...
    ts = s(
        e({
            ...
            states: {
                ...
                [We]: { on: { LEAVE_PROGRESSION_DONE: { target: Ue } } },
                    ...
                    children: [
                        ...
                        _.jsx(V, {
                            ...
                            params: {
                                ...
                                universal: _.jsx(ea, { item: Us, type: Ys }),
                                sniper: _.jsx(ea, { item: Ws, type: Ys }),
                                support: _.jsx(ea, { item: qs, type: Ys }),
                            },
        ...
        const y = r.useCallback(() => {
                ...
                const a = e.split(' '),
                    t = Array.from(new Array(s)).reduce((e, t, i) => {
                        ...
                        const r = Ca({ start: 0, end: o.length, words: o, element: d.current, canvas: v });
            ...
            _.jsxs('div', {
                ...
                children: [
                    _.jsx('div', {
                        ref: d,
                        className: Aa,
                        style: { maxHeight: `${J(b)}rem` },
                        children: _.jsx(A, { text: e, split: i }),
                    }),
                    _.jsx('div', {
                        className: Ma,
                        children: f.map((e, s) => _.jsx('div', { className: Ta, children: e.join(' ') }, s)),
                    }),
                    _.jsx('div', { ref: m, className: Da, children: R.strings.common.common.dot() }),
                ],
            })
        );
    }),
        ...
        children: [
            ...
            _.jsxs('div', {
                ...
                children: [
                    ...
                    _.jsx(La, { split: !0, text: s, className: Ha.quest, simpleTooltipParams: m, lines: Ba(!n, i, c) }),
                ],
            }),
        ],
    });
...
function Wa({ className: e }) {
    return _.jsxs('div', {
        ...
        children: [
            ...
            _.jsx(V, { className: Qa.text, path: 'personal_missions_30.main.mission.mission.quest.separator' }),
            _.jsx(w, {
                className: Qa.arrow,
...
function Ua({ cardType: e, mission: { allQuestsRequired: s, quests: a }, className: t }) {
    return _.jsx('div', {
        ...
        children: a.map((t, i) =>
            _.jsxs(
                ...
                {
                    children: [
                        !s && i > 0 && _.jsx(Wa, { className: qa.questSeparator }),
                        _.jsx($a, {
                            quest: t,
                            cardType: e,
...
function Ya({ rewards: e, imageSize: s = se.Small, className: a }) {
    return _.jsx('div', {
        className: u(Fa.base, Fa[`base__${s}`], a),
        children: e.map((e, a) => _.jsx('div', { className: Fa.reward, children: _.jsx(ee, { ...ke(e, s) }) }, a)),
    });
}
const za = {
                                ...
                                switch (s.missionStatus) {
                                    ...
                                    case ia.LOCKED:
                                        return _.jsxs('div', {
                                            ...
                                            children: [
                                                _.jsx(Ua, { mission: s, className: Ka.quests, cardType: is.missions }),
                                                _.jsxs('div', {
                                                    className: Ka.footer,
                                                    children: [
...
function et() {
    const e = X();
    return (ne(() => e.run(oe)), _.jsx('div', { className: Ja }));
}
const st = {
    ...
    tt = l(function ({ currentAnimationState: e }) {
        const { model: s } = gs(),
            ...
            f = X(),
            h = ce(),
            b = de(p, me.horizontal, void 0, { gapBeforeStart: 5 }),
            I = r.useCallback(
                function (e) {
        ...
        return (
            ...
            _.jsxs(m.div, {
                ...
                children: [
                    ...
                    _.jsx(m.div, {
                        style: b,
                        children: _.jsx(ge, { settings: us, children: _.jsx(tt, { currentAnimationState: n }) }),
                    }),
                ],
            })
        );
...
const Ut = 'InProgress_status_a90e1754',
...
function oi({ reward: { completedTasks: e, items: s, rewardsType: a, tasksNumber: t }, index: i }) {
    ...
    return _.jsxs('div', {
        ...
        children: [
            _.jsx(V, { ...l, className: ni.title, path: `personal_missions_30.main.progression.reward.title.${a}` }),
            _.jsx('div', {
                className: ni.items,
                children: s.map((e, s) =>
                    _.jsx('div', { className: ni.reward, children: _.jsx(ee, { ...ke(e, se.Big) }) }, s),
                ),
            }),
            _.jsx('div', {
                className: ni.status,
...
const ri = 'MainReward_fc423f8a',
        ...
        return _.jsxs('div', {
            ...
            children: [
                ...
                _.jsxs(xe, {
                    className: ci,
                    children: [
                        _.jsx(xe.Level, { className: di, value: l, numberType: 'roman' }),
                        Ee(c) && _.jsx(xe.Type, { type: c, premium: r }),
                        _.jsx(xe.Name, { className: di, children: d }),
                    ],
                }),
            ],
        });
    ...
    vi = l(function ({ className: e }) {
        const s = r.useRef(null),
            ...
            h = de(t, me.horizontal, void 0, { gapBeforeStart: 5 }),
            { model: b } = gs(),
...
const ki = 'Menu_f1a51291',
    ...
    Xi = l(function ({ className: e }) {
        const s = O.resolve('strings'),
            ...
            { breakpoint: c } = Y(),
            d = Re(c.weight, z.large) ? Ce.small : Ce.medium,
        ...
        return _.jsxs(m.div, {
            ...
            children: [
                ...
                _.jsx('div', { className: Ui, children: s.readOrEmpty('personal_missions_30.main.complete.title') }),
                _.jsx(V, {
                    className: Fi,
                                    ...
                                    switch (o.missionStatus) {
                                        ...
                                        case ia.LOCKED:
                                            return _.jsxs('div', {
                                                className: fn,
                                                children: [
                                                    _.jsx(Ua, { mission: o, className: bn, cardType: is.default }),
                                                    _.jsxs('div', {
                                                        className: hn,
                                                        children: [
                    ...
                    _.jsxs('div', {
                        ...
                        children: [
                            ...
                            _.jsx(m.div, {
                                ...
                                children: _.jsx(ge, { settings: us, children: _.jsx(vi, {}) }),
                            }),
                        ],
                    }),
                ],
