import { r as e, o as a, e as s, q as r, j as t, k as n, m as i, f as o } from '../../../chunks/vendor.js';
import {
    ak as l,
    al as d,
    C as c,
...
import { A as U, R as K, s as F } from '../../../chunks/helpers.js';
/* empty css                    */ const Y = (a) => () => {
    ...
    [ee, ae] = w()(
        ({ observableModel: e }) => {
            const s = {
                    ...
                    rewards: e.transform((e) => f(e, J), 'rewards'),
                },
                r = a.box(!1),
                t = v.model(() => {
                    const e = s.root.get().type;
                    return e === K.OPERATION || e === K.VEHICLE_PART ? [] : R(s.rewards.get(), (e, a) => a < 4);
                }),
                n = v.model(() =>
                    s.root.get().type === K.OPERATION ? s.rewards.get() : R(s.rewards.get(), (e, a) => a >= 4),
                );
    ...
    ie = 'showRibbon',
    oe = 'showMainRewards',
    le = 'showMainRewardsLabels',
    de = 'showAdditionalTitle',
    ce = 'showNextOperation',
    _e = 'showAdditionalRewards',
    me = 'showButtons',
    ue = [ie, oe, le],
    pe = [de, _e],
    he = e.createContext(null);
function be() {
    const a = e.useContext(he);
    if (null === a)
...
const ge = Y({
        steps: [
            ...
            { name: le, delay: 200 },
            { name: de, delay: 100 },
            { name: _e, delay: 200, stopNextSteps: !0 },
            { name: me, delay: 0 },
        ],
    }),
    we = r(function ({ children: e }) {
        const a = ge();
        return t.jsx(he.Provider, { value: a, children: e });
    }),
    fe = Y({
        steps: [
            { name: se, delay: 0 },
    ...
    ye = r(function ({ children: e }) {
        ...
        switch (s) {
            case K.OPERATION:
                return t.jsx(Ne, { children: e });
            case K.OPERATION_WITH_HONORS:
                return t.jsx(ve, { children: e });
            default:
                return t.jsx(we, { children: e });
        }
    });
const xe = r(function ({ reward: a, onAnimationStart: s, onAnimationEnd: r, index: o, className: l }) {
        const { model: d } = ae(),
            { type: c } = d.root.get(),
            _ = N(),
            { breakpoint: m } = y(),
            u = (function (e, a) {
                return e === K.OPERATION ? b.Big : F(a, T.medium) ? b.Small : b.Big;
            })(c, m.weight),
            [p, h] = n(() => ({
    ...
    Oe = 'AdditionalRewards_ffae6df',
    Te = 'AdditionalRewards_title_2d8eb236',
    je = 'AdditionalRewards_list_81a45598',
    Ie = 'AdditionalRewards_reward_ed90708c',
    Se = r(function (e) {
        const { model: a } = ae(),
            s = be();
        return t.jsxs('div', {
            className: o(Oe, e.className),
            children: [
                t.jsx(j, { path: 'personal_missions_30.rewards.additional', className: Te }),
                t.jsx('div', {
                    className: je,
    ...
    Ae = { base: 'Buttons_82277d53', button: 'Buttons_button_2eb74e89', text: 'Buttons_text_981ee64f' },
    Pe = { base: Ae.button, content: Ae.text },
    Ee = new Set([K.VEHICLE_PART, K.OPERATION_WITH_HONORS, K.OPERATION]),
    He = r(function (e) {
        const { model: a, controls: s } = ae(),
            { type: r } = a.root.get(),
            { breakpoint: n } = y(),
            i = F(n.weight, T.medium) ? I.small : I.medium,
            l = N(),
            d = p.resolve('strings');
        function c() {
        ...
        return t.jsxs('div', {
            className: o(Ae.base, Ae[`base__${r}`], e.className),
            children: [
                (() => {
                    switch (r) {
                        case K.VEHICLE_PART:
    ...
    We = e.memo(function ({ name: e, tier: a, type: s, size: r = ke, isPremium: n = !1, className: i }) {
        const l = `${A(s)}${n ? '_elite' : ''}`;
        return t.jsxs('div', {
            className: o(Ce.base, Ce[`base__${r}`], i),
            children: [
                t.jsx('div', { children: P(a) }),
                t.jsx('div', {
                    className: Ce.vehicleTypeContainer,
                    children: t.jsx(E, { path: `${Be(r)}.${l}`, className: Ce.vehicleType }),
                }),
    ...
    ze = new Set([K.OPERATION_WITH_HONORS, K.CAMPAIGN_WITH_HONORS]),
    De = new Set([K.VEHICLE_PART, K.OPERATION_WITH_HONORS, K.CAMPAIGN_WITH_HONORS]),
    qe = r(function (a) {
        const { model: s } = ae(),
        ...
        return (
            e.useEffect(() => {
                const e = (e) => {
                    e.name === te && _.play('gui_hangar_simple_execution_screen', { target: 'Main reward' });
                };
            ...
            t.jsxs('div', {
                ...
                children: [
                    ze.has(r) &&
                        t.jsx(E, { path: 'personal_missions_30.rewards.honors_title_back', className: Le.honorsBack }),
                    De.has(r) &&
                        t.jsx(j, {
                            path: `personal_missions_30.rewards.subTitle.${r}`,
                            params: { name: r === K.CAMPAIGN_WITH_HONORS ? i : n },
...
const Ue = new Set([H.BattleBadge, H.PremiumPlus, H.Customizations, 'attachment']);
function Ke({ reward: e }) {
    ...
    return t.jsxs('div', {
        ...
        children: [
            ...
            Ue.has(e.name) && t.jsx('div', { className: Ge.label, children: e.label }),
        ],
    });
}
const Fe = 'VehiclePart_15b78928',
    Ye = 'VehiclePart_image_f33361cd',
    Je = 'VehiclePart_label_5cfdac0';
function Qe(e) {
    ...
    return t.jsxs('div', {
        ...
        children: [
            ...
            t.jsx('div', { className: Je, children: a.readOrEmpty(`personal_missions_30.detail.name.${e.id}`) }),
        ],
    });
}
const Xe = {
    ...
    Ze = [K.OPERATION_WITH_HONORS, K.CAMPAIGN_WITH_HONORS],
    ea = r(function (a) {
        const { model: s } = ae(),
            { type: r, vehicleDetailName: n } = s.root.get(),
            i = N(),
            l = be(),
            d = Ze.includes(r) ? 'ribbon_gold' : 'ribbon';
        return (
            e.useEffect(() => {
                const e = (e) => {
                    e.name === oe && i.play('gui_random_reward_appear', { target: 'Main reward' });
                };
                return (l.events.on('change', e), () => l.events.off('change', e));
            }, [l.events, i]),
            t.jsxs('div', {
                className: o(Xe.base, a.className, Xe[`base__${r}`]),
                children: [
                    t.jsx('div', {
                    ...
                    t.jsxs('div', {
                        className: Xe.list,
                        children: [
                            t.jsx('div', { className: Xe.rays }),
                            n
                                ? t.jsx(Qe, { id: n })
                                : f(s.computes.mainRegularRewards(), (e, a) => t.jsx(Ke, { reward: e }, a)),
                        ],
                    }),
                ],
            })
    ...
    aa = 'VehicleVideo_210aecbb',
    sa = 'VehicleVideo_fading_d689de26',
    ra = 'VehicleVideo_video_6832c75d',
    ta = { 8: 40, 9: 40, 10: 36 },
    na = { 8: 12, 9: 13, 10: 12 },
    ia = p.resolve('videos'),
    oa = r(function () {
        const { model: a, controls: s } = ae(),
            ...
            [l, c] = e.useState([]),
            m = be(),
            { screenWidthRem: u, screenHeightRem: p } = y(),
            [h, b] = W(() => {
        ...
        return (
                ...
                e.useEffect(() => {
                    ...
                    const e = C((e) => {
                        ...
                        d = t.current.onKeyframes((e) => {
                            if (e.time >= s) {
                                const e = k(Date.now() - r - i.current, M, V),
                                    a = Math.ceil(e);
                                c.run(
                                    () => {
            ...
            })({ enabled: l.length > 0, playerRef: o, soundStartedTimestamp: g, syncFrame: na[r] }),
            t.jsxs('div', {
                className: aa,
                children: [
                    t.jsx('div', { className: sa }),
                    t.jsx(L, {
                        ref: o,
                        src: ia.readOrEmpty(`personal_missions_30.rewards_screen.operation_${r}`),
                        autoplay: !0,
                        isPrebufferKeyframes: Boolean(l.length),
                        style: X(u, p),
                        onPlay: () => {
                            void 0 === g && (w(Date.now()), i.play(`vid_pm_o${r.toString().padStart(2, '0')}_s15`));
                        },
                        onEnded: () => {
                            (n && (m.start(), s.setIntroVideoPlaying(!1), s.disableVideoOverlaySound()),
                                o.current?.goToAndPlay(ta[r] ?? 0));
                        },
                        className: ra,
                    }),
                ],
    ...
    da = r(function () {
        ...
        const _ = be();
        e.useEffect(() => {
            (l || _.stepsToSkip.current.push(...ue), d || _.stepsToSkip.current.push(...pe));
        }, [_.stepsToSkip, d, l]);
        return t.jsxs('div', {
            ref: _.rootRef,
            className: o(la.base, la[`base__${r}`]),
            children: [
                r === K.OPERATION
                    ? t.jsx(oa, {})
                    : t.jsx(E, {
                          path:
                              ...
                              (r === K.VEHICLE_PART ? 'vehiclePart' : 'withHonors'),
                          fit: 'cover',
                          className: la.background,
                      }),
                t.jsx('div', {
                    className: la.closeButtonWrapper,
                    children: t.jsx('div', {
                        onClick: (e) => {
                            (c.play('click', { target: 'CloseButton', original: e }), c.play('stopIntro'), s.close());
                        },
                        onMouseEnter: (e) => {
                ...
                d && t.jsx(Se, { className: la.additional }),
                r === K.OPERATION_WITH_HONORS &&
                    t.jsx(j, {
                        path: 'personal_missions_30.rewards.operationUnlocked',
                        params: { name: i },
                        className: la.nextOperation,
                    }),
                t.jsx('div', { className: la.divider }),
                t.jsx(He, { className: la.buttons }),
            ],
        });
    });
