...
import { r as e, o as t, n as s, f as r, j as o, p as n } from '../../../chunks/vendor.js';
import { J as l, z as a, i as c, k as i, m as u, r as d, S as m } from '../../../chunks/lib.js';
/* empty css                    */ var p = ((e) => (
    (e[(e.HOME = 0)] = 'HOME'),
...
const E = [p.MULTIPLE_BOXES_REWARDS, p.SINGLE_BOX_REWARDS],
    f = [...E],
    _ = (e) => f.includes(e),
    h = (e) => a(e, (e) => _(e)),
    v = (e) => E.includes(e),
    ...
    y = e.lazy(() =>
        b(() => import('../../../chunks/index.js'), __vite__mapDeps([0, 1, 2, 3, 4, 5, 6, 7, 8]), import.meta.url),
    ),
    D = e.lazy(() =>
        b(
            () => import('../../../chunks/index2.js'),
            __vite__mapDeps([0, 1, 2, 3, 5, 9, 10, 11, 12, 13]),
            import.meta.url,
        ),
    ),
    I = e.lazy(() =>
        b(
            ...
            __vite__mapDeps([0, 1, 2, 3, 5, 9, 10, 14, 12, 15]),
            import.meta.url,
        ),
    ),
    O = { [p.HOME]: y, [p.SINGLE_BOX_REWARDS]: D, [p.MULTIPLE_BOXES_REWARDS]: I };
function w({ viewID: t }) {
    const s = O[t];
    return s
...
const x = 'App_7cf6cd46',
    A = 'App_overlay_cc29bca1';
const k = n(function () {
    const { model: t, controls: s } = S(),
        r = t.subViewIDs.get();
    return (
        ((t, s) => {
            const r = l(t);
        ...
        })(h(r), s.setOverlayState),
        e.useEffect(() => i(() => s.onResourcesLoadCompleted())),
        o.jsx('div', {
            className: x,
            children: u(r, (e) =>
                _(e)
                    ? o.jsx('div', { className: A, children: o.jsx(w, { viewID: e }) }, e)
                    : o.jsx(w, { viewID: e }, e),
            ),
        })
    );
});
d(o.jsx(R, { children: o.jsx(m, { children: o.jsx(k, {}) }) }));
export { h, S as u };
