import { o as e, p as s, j as t, e as o } from '../../../../chunks/vendor.js';
import { i as r, o as i, K as a, w as n, T as c, L as l, U as d, r as m } from '../../../../chunks/lib.js';
...
const g = s(function () {
        ...
        return t.jsxs('div', {
            className: u,
            children: [t.jsx('div', { className: h, children: o.timerText }), t.jsx(a, { className: b, start: s })],
        });
    }),
...
const T = s(function () {
    ...
    N = 'small';
function w({ icon: e, hasShadow: s = !1, size: r = N, className: i }) {
    return t.jsxs('div', {
        className: o(v.base, v[`base__${r}`], i),
        children: [
            s && t.jsx('div', { className: v.shadow }),
            t.jsx('div', { className: v.icon, style: { backgroundImage: `url(${e})` } }),
        ],
    });
}
const I = 'ErrorTooltip_1a899ce5',
    E = 'ErrorTooltip_alertIcon_5a74f389',
    k = 'ErrorTooltip_title_1e223726',
    y = 'ErrorTooltip_text_fd3d5167',
    A = 'ErrorTooltip_description_ad6fcc31';
const P = s(function () {
        const { model: e } = j(),
        ...
        return t.jsxs('div', {
            ...
            children: [
                t.jsxs('div', {
                    className: k,
                    children: [
                        t.jsx(w, { className: E, icon: s.alert }),
                        t.jsx('div', { className: y, children: t.jsx(n, { text: o.warningTitle }) }),
                    ],
                }),
                t.jsx('div', { className: A, children: o.warningDescription }),
            ],
        });
    }),
    D = 'App_70d855b6';
const B = s(function () {
    ...
    return t.jsx(c, {
        children: t.jsx(c.Decorator, {
            children: t.jsx('div', { className: D, children: s ? t.jsx(T, {}) : t.jsx(P, {}) }),
        }),
    });
});
