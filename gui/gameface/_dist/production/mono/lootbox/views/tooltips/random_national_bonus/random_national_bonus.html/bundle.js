...
import { i as a, A as t, k as i, I as r, F as d, r as o, E as l } from '../../../../chunks/lib.js';
import { g as n } from '../../../../chunks/getRewardImage.js';
const [m, p] = a()(({ observableModel: s }) => ({ root: s.object() }), t),
    c = 'App_fed01ed5',
    h = 'App_icon_370a809b',
    g = 'App_title_7de7d87e',
    x = 'App_highlighted_33d456ed',
    j = 'App_description_843bb261',
    b = s(function () {
        const { model: s } = p(),
            a = s.root.get(),
            t = i.resolve('strings');
...
o(e.jsx(m, { children: e.jsx(l, { children: e.jsx(b, {}) }) }));
