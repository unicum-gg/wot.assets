...
import {
    ...
    h as useSpring,
    i as animated,
    k as loadDefaultJapaneseParser$1,
} from './vendor.js';
...
class VideosRClassProvider {
    ...
    readOr(e, t, u = 'silent') {
        ...
        return void 0 === n ? ('silent' !== u && logBySeverity$1(`Resource not found: ${e}`, u), t()) : n;
    }
    readOrEmpty(e, t = 'warn') {
        return this.readOr(e, () => '', t);
    }
...
const keyCodes = { NONE: -1, ESCAPE: 27, SPACE: 32 };
function get(e, t) {
    var u;
...
function useHandleKey(e, t, u, n) {
    const r = useEvent$1((e) => {
            isEventHandled$1() || (u(e), setEventHandled$1());
        }),
        o = useApi$1(),
        s = reactExports.useMemo(() => o[t].register(e, r), [o, t, e, r]);
    ...
    reactExports.useEffect(() => {
        ...
        function n(n) {
            if (n.keyCode === e) {
                ...
                (t(n), setEventHandled$1(), u && n.stopPropagation());
            }
        }
    }, [t, e, u]);
}
...
function useTooltip({ resId: e = 0, contentId: t, decoratorId: u, disabled: n, args: r, showDelay: o = 400 }) {
    const s = useTimeout(),
        a = reactExports.useRef({ display: !1, resId: e }),
        [{ hide: i, getCurrentState: l }, c] = reactExports.useMemo(() => {
            function i() {
                n || ((a.current.display = !0), sendEvent$1.tooltip.open(e, t, u, r));
            }
            function l() {
                (s.clear(), sendEvent$1.tooltip.hide(e, t, u), (a.current.display = !1));
            }
            return [
                { hide: l, show: i, getCurrentState: () => a.current },
                {
                    onMouseEnter: () => {
                        s.run(i, o);
                    },
        ...
        (t, u, n) => {
            ...
            function o(o) {
                ...
                const { mode: a, options: i, children: l, mocks: c } = o,
                    ...
                    [_, D] = reactExports.useState(E);
                reactExports.useEffect(() => {
                    D(E);
                }, [E]);
                const [g, h] = reactExports.useState(() => F(_, i, p));
                return (
                    reactExports.useEffect(() => {
                        f.current ? h(F(_, i, p)) : (f.current = !0);
                    }, [
                        F,
                        p,
                        _,
...
async function runView(e, { root: t = document.getElementById('root'), withMedia: u = !0, fullScreen: n = !1 } = {}) {
    var r;
    injectShowModel();
...
const COLORS =
    ...
    styles$d = { COLORS: COLORS, base: base$b, base__fullSize: base__fullSize },
        ...
        return (a = {}) => {
            const { settings: i = defaultSettings$1 } = a,
                ...
                b = reactExports.useCallback(
                    function () {
                        return C.run(() => {
                            const e = d.current;
                            e && (D(s(e, F.scrollPosition.goal), { immediate: !0 }), m.trigger('resizeHandled'));
                        });
                    },
                    [C, D, F.scrollPosition.goal, m],
                );
            useRefResizeObserver(E, (e) => {
                const t = e.target;
                if (!(t instanceof HTMLElement)) return;
                const u = r(t);
                p.current.wrapper !== u && b();
            });
            const B = useEvent$1(function () {
                ...
                if (p.current.container !== u || p.current.wrapper !== n) {
                    ...
                    (e !== F.scrollPosition.goal && D(e, { immediate: !0 }),
...
reactExports.memo(function ({ classNames: e = {}, onDrag: t = noop$2 }) {
    ...
    const E = useEvent$1((e, t, { parent: u }) => (e.screenX - t.offset - u.getBoundingClientRect().x) / u.offsetWidth),
        ...
        { handleMouseEnter: f, handleMouseDownTrack: _ } = useBarHandlers(
            u,
            s,
            r,
            n,
...
const FormatNumber = ({ value: e, format: t = 'integral' }) => {
    ...
    multiValueTypes = [
        ...
        RewardType$1.Stamp,
        RewardType$1.WtEventLootbox,
        RewardType$1.WtEventTicket,
    ],
    ...
    createApiHook = ({
        ...
        return (a = {}) => {
            ...
            return reactExports.useMemo(
                ...
                [m.scrollPosition, f, _, E.off, E.on, h, D, A, i.step.clampedArrowStepTimeout],
            );
        };
    },
    ...
    Tooltip = ({
        ...
        return c
            ? reactExports.cloneElement(e, {
                  ...
                  onMouseLeave: ((e) => (t) => {
                      (_(), null == r || r(t), null == e || e(t));
                  })(e.props.onMouseLeave),
                  onClick: ((e) => (t) => {
                      (!1 === i && _(), null == s || s(t), null == e || e(t));
                  })(e.props.onClick),
                  onMouseDown: ((e) => (t) => {
                      (!1 === i && _(), null == o || o(t), null == e || e(t));
                  })(e.props.onMouseDown),
                  ...m,
              })
            : e;
...
const root$1 = 'Checkbox_root_9586ffe2',
    ...
    Checkbox = ({
        ...
        const [h, C] = reactExports.useState(!1),
        ...
        return jsxRuntimeExports.jsxs('div', {
            ...
            className: cx(styles$1.base, styles$1[`base__${r}`], styles$1[`base__${o}`], {
                ...
                [styles$1.base__mouseDown]: h,
                [styles$1.base__alert]: n,
                [styles$1.base__center]: D === Alignments.Center,
                [styles$1.base__bottom]: D === Alignments.Bottom,
            }),
            onClick: y,
            onMouseEnter: w,
            onMouseLeave: T,
...
export {
    ...
    convertNbsp$1 as M,
    getSize$2 as N,
    graphicsQuality$1 as O,
    useThrottle$1 as P,
    useKeydownListener as Q,
    RewardType$1 as R,
    SoundsProvider as S,
    TextButton as T,
    ToggleButton$1 as U,
    ...
    keyCodes as W,
    useMedia as X,
    createTimeoutInEffect as Y,
    CheckboxSize as Z,
    breakpointsByType as _,
    getRewardValueType as a,
    easings as a0,
    DynamicTooltipWrapper as a1,
    SimpleTooltip as a2,
    ClickOutsideManager as a3,
    useLoop as a4,
    Video as a5,
    Base as a6,
    useVerticalScroll as a7,
    useEvent$1 as a8,
    Area$1 as a9,
    Bar$1 as aa,
    toRoman as ab,
    ...
    runView as r,
    set as s,
    DateTimeFormatsEnum as t,
    useTooltip as u,
    useVerticalScrollApi as v,
    Scroll as w,
    usePrevious as x,
    createLayoutReadyInEffect$1 as y,
    noop$2 as z,
};
