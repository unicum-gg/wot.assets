...
import { a as S, g as D } from './getRewardImage.js';
import { a as $, g as W, B as G, c as L } from './resources.js';
import { a as H, f as X, h as z, b as M, i as q } from './utils.js';
import {
    i as F,
    c as U,
    h as Y,
...
import { S as oe } from './sounds.js';
import { D as ce } from './divider2.js';
import { L as le } from './loupe_button.js';
import './shield.js';
import './vehicle_info.js';
const de = {
        multiRewardAppear: oe.multiRewardAppear,
        compensationAppear: oe.compensationAppear,
        rareAnimation: oe.rareAnimation,
        epicAnimation: oe.epicAnimation,
        open: oe.open,
        openRare: oe.openRare,
    },
    me = {
        images: {
    ...
    [ue, _e] = F()(
        ({ observableModel: s }) => {
            const i = {
                ...
                r = a(() => $(me, i.info.eventName.get()), { equals: U }),
                n = a(() => W(pe, i.info.eventName.get()), { equals: U }),
                t = a(() => i.bonuses.get(), { equals: U }),
                o = a(() => Y(t(), (e) => Y(e, (e) => H(e))), { equals: U }),
                c = a(() => {
                    const { boxCategory: e } = i.root.get(),
                        a = `${e}_${G.Common}`,
                        s = `${e}_${G.Rare}`,
                        t = n().dynamicImages.boxesOpening.dynOpt(a, G.Common),
                        o = n().dynamicVideos.boxesOpening.dynOpt(a, G.Common),
                        c = n().dynamicImages.boxesOpening.dynOpt(s, G.Rare),
                        l = n().dynamicVideos.boxesOpening.dynOpt(s, G.Rare),
                        m = r().sounds,
                        p = L(S(R.sounds, `${de.open}_${i.info.eventName.get()}_${e}`), m.open, de.open),
                        u = L(S(R.sounds, `${de.openRare}_${i.info.eventName.get()}_${e}`), m.openRare, de.openRare);
                    return { [d.common]: { video: o, image: t, sound: p }, [d.rare]: { video: l, image: c, sound: u } };
                });
            return {
                ...i,
                computes: {
    ...
    Ne = {
        ...
        [ye]: { duration: 2e3 },
        [xe]: { duration: 1e3, delay: 50 },
        [Re]: { name: Re, duration: 0, delay: 100 },
    },
    je = (e, a, s) => {
        switch (e) {
            case we:
        ...
        return (
            Z(
                ...
                (e, s, i) => (
                    ...
                    J(s, (s, r) => {
                        const n = H(s),
                            t = p(a, s.specialAwardName);
                        (n
                            ? (t ? e.push(Ce(he, i, r)) : e.push(Ce(ve, i, r)), e.push(Ce(be, i, r)))
                            : 0 !== r && e.push(Ce(be, i, r)),
                            s.isCompensation && (e.push(Ce(ye, i, r)), e.push(Ce(xe, i, r))));
                    }),
                    e
                ),
                s,
    ...
    Ie = r(function ({ children: e }) {
        const { model: a } = _e(),
            ...
            i = u({ steps: Ae(a.computes.rewardsListByBoxes(), s), autoStart: !1 })();
        return n.jsx(fe.Provider, { value: i, children: e });
    }),
    Oe = 'Ordinal_c2d1e05',
    Pe = 'Ordinal_number_dae68cd8',
    Te = 'Ordinal_divider_7beeb965';
const ke = 'Rewards_881b1493',
    Ve = 'Rewards_divider_44d40928';
function Be({ children: e, className: a, ...s }) {
    return n.jsx('div', { ...s, className: t(ke, a), children: e });
}
((Be.Ordinal = function ({ children: e, src: a, className: s }) {
    return n.jsxs('div', {
        className: t(Oe, s),
        children: [
            n.jsx('div', { className: Pe, children: e }),
            n.jsx(ce, { src: a, orientation: ce.orientation.vertical, className: Te }),
        ],
    });
}),
    (Be.Divider = ({ className: e, ...a }) => n.jsx(ce, { ...a, className: t(Ve, e) })));
const Ee = 'Compensation_22c7fec0';
const Se = 'Content_8f2fef40';
const De = 'Glow_86ec1932';
const $e = 'PreviewButton_fdc3bedf',
    We = 'PreviewButton_loupeButton_3b872270';
const Ge = {
    base: 'Title_4a8f0758',
...
const Le = 'VehicleTitle_cc85cff9';
const He = 'RewardCard_447f9fb1';
function Xe({ children: e, className: a, ...s }) {
    return n.jsx('div', { className: t(He, a), ...s, children: e });
}
((Xe.Content = function ({ children: e, className: a }) {
    ...
    (Xe.Glow = function ({ className: e, src: a }) {
        ...
        return (_(s), n.jsx(K, { className: t(De, e), src: a, autoplay: !0, loop: !0, ref: s }));
    }),
    (Xe.VehicleTitle = function ({ vehicleName: e, className: a = '' }) {
        return n.jsx('div', { className: t(Le, a), children: e });
    }),
    (Xe.Title = function ({ type: e, plural: a, text: s, className: i = '' }) {
        return n.jsxs('div', {
            className: t(Ge.base, Ge[`base__${e}`], i),
            children: [
                n.jsx('div', { className: Ge.value, children: n.jsx(Q, { text: X(s) }) }),
                a && n.jsx('span', { className: Ge.plural, children: a }),
            ],
        });
    }),
    (Xe.Preview = function ({ image: e, onClick: a, className: s }) {
        return n.jsx('div', {
            className: t($e, s),
            children: n.jsx(le, { className: We, icon: { img: e }, onClick: a }),
        });
    }),
    (Xe.Compensation = function ({ children: e, className: a }) {
        return n.jsx('div', { className: t(Ee, a), children: e });
    }));
const ze = { opacity: 1, transform: 'translateX(0rem)', filter: 'brightness(1)' },
    Me = { opacity: 1, transform: 'scale(1)', filter: 'brightness(1)' },
    qe = { opacity: 0, transform: 'scale(1)', filter: 'brightness(1)' },
    Fe = () => ({ from: { opacity: 0, transform: 'translateX(-10rem)', filter: 'brightness(1)' } }),
    Ue = () => ({
        to: [
        ...
        config: { duration: 30, easing: ee.easeOutCubic },
    }),
    Ye = () => ({ from: { opacity: 0, transform: 'scale(1.4)', filter: 'brightness(3)' } }),
    Ze = (e = 400) => ({
        to: [{ opacity: 1, transform: 'scale(1.4)', filter: 'brightness(3)' }, Me],
        config: { duration: e, easing: ee.easeOutCubic },
    }),
    Je = () => ({ from: { opacity: 1, filter: 'brightness(1)', transform: 'scale(1)' } }),
    Ke = () => ({ to: qe, config: { duration: 0, easing: ee.linear } }),
    Qe = () => ({ from: { opacity: 0 } }),
    ea = () => ({
    ...
    sa = r(function ({ reward: e, rowIndex: a, rewardIndex: s, size: r, className: l = '' }) {
        const { model: d } = _e(),
            { images: m, sounds: p, videos: u } = d.computes.resources(),
            { dynamicTexts: _ } = d.computes.dynamicResources(),
            { name: b, value: h } = e.compensation,
            v = i.useRef(null),
            x = b === ae.PremiumPlus ? _.rewardsPremiumDay.plural('premiumDay', Number(h.split(' ').at(-1))) : '',
            [y, R] = o(Ye),
            N = f(fe),
            j = w(v);
        return (
                ...
                const e = (e) => {
                    switch (e.name) {
                        case Ce(ye, a, s).name:
                            ...
                            break;
                        case Ce(xe, a, s).name:
                            (re.sound(p.compensationAppear), R.start(Ze()));
                    }
                };
                return (
            ...
            n.jsxs(Xe.Compensation, {
                className: t(aa.base, l),
                children: [
                    n.jsx(se, { ref: v, className: aa.particles, src: u.compensationParticles, onEnded: j }),
                    n.jsx(c.div, {
                        style: { ...y },
                        children: n.jsx(
                            g,
                            {
                                icon: D(e, ie.Big, e.isCompensation),
                    ...
                    h.length > 0 &&
                        n.jsx(c.div, {
                            style: { opacity: y.opacity },
                            children: n.jsx(Xe.Title, { type: b, text: h, plural: x }),
                        }),
                ],
            })
        );
    ...
    na = 'Card_compensation_46864467',
    ta = 'Card_title_43ce242d',
    oa = 'Card_vehicleTitle_a2262475',
    ca = 'Card_loupeWrapper_e3dd749b',
    la = 'Card_video_30ee6c3b',
    da = [ae.Vehicles, ae.TmanToken],
    ma = {
        rewardHeight: '80rem',
        rewardWidth: '80rem',
        countHeight: '18rem',
    ...
    _a = { to: ua, config: { duration: 500, easing: ee.easeOutCubic } },
    fa = r(function ({ reward: e, rewardIndex: a, rowIndex: s }) {
        const { model: r, controls: t } = _e(),
            { images: d, texts: m, videos: u, sounds: _ } = r.computes.resources(),
            { dynamicTexts: w } = r.computes.dynamicResources(),
            g = r.info.eventName.get(),
            [y, R] = i.useState(!1),
            ...
            V = ne({
                contentId: Number(N),
                args: { tooltipId: j, boxCategory: e.icon, eventName: g },
                disabled: C !== b.initial,
            }),
            B =
                e.name === ae.PremiumPlus
                    ? w.rewardsPremiumDay.plural('premiumDay', Number(e.value.split(' ').at(-1)))
                    : '',
            E = f(fe);
        (i.useEffect(() => {
            const i = (i) => {
                switch (i.name) {
                    case Ce(ge, s).name:
                        H(e) || 0 !== a || (I.start(Ue()), re.sound(_.multiRewardAppear));
                        break;
                    case Ce(be, s, a).name:
                        (I.start(H(e) ? Ue() : ea()), re.sound(_.multiRewardAppear));
                        break;
                    case Ce(ve, s, a).name:
                        R(!0);
                        break;
        ...
        }, [E.events, s, a, e, I, t, P, _]),
            i.useEffect(() => {
                const a = () => {
                    (I.start(H(e) ? ea() : { to: ze, config: { duration: 0, easing: ee.easeOutCubic } }),
                        e.isCompensation && P.start(Ke()));
                };
                return (
        ...
        const S = z(e.rarity) ? u.rareGlow : M(e.rarity) ? u.commonGlow : '';
        return n.jsxs(Xe, {
            ...V,
            className: ia,
            children: [
                    ...
                    children: n.jsxs(Xe.Content, {
                        children: [
                            ...
                            n.jsxs(c.div, {
                                ...
                                children: [
                                    e.name === ae.Vehicles &&
                                        n.jsx(Xe.VehicleTitle, { vehicleName: e.vehicleShortName, className: oa }),
                                    !da.includes(e.name) && n.jsx(Xe.Title, { type: e.name, text: e.value, plural: B }),
                                ],
                            }),
                            q(e) &&
                                !e.isCompensation &&
                            ...
                            e.isCompensation &&
                                n.jsx(sa, { reward: e, size: ma, rowIndex: s, rewardIndex: a, className: na }),
                        ],
                    }),
                }),
                H(e) &&
                    !p(g, e.specialAwardName) &&
                    y &&
                    n.jsx(v, {
                        className: la,
                        sound: e.rarity === G.Rare ? _.rareAnimation : _.epicAnimation,
                        src: u[e.rarity],
                        show: y,
                        onEnded: function () {
                            E.resume();
    ...
    ga = r(function ({ order: e, rewards: a, isLast: s }) {
        ...
        return n.jsxs(Be, {
            className: wa.base,
            children: [
                n.jsx(Be.Ordinal, { src: o.divider, className: t(wa.ordinal, wa['ordinal__' + (e - 1)]), children: e }),
                J(a, (a, s) =>
                    n.jsx(
                        fa,
                ...
                !s && n.jsx(Be.Divider, { src: o.divider, className: t(wa.divider, wa['divider__' + (e - 1)]) }),
            ],
        });
    }),
    ba = 'Layout_1c0c8eb5',
    ha = 'Layout_base__ready_73e4204f',
    va = 'Layout_rewards_82ba0c21',
    ...
    ya = r(function () {
        ...
        return n.jsxs(j, {
            className: t(ba, R === b.initial && ha),
            children: [
                Boolean(_ && p(u, _?.specialAwardName)) &&
                    n.jsx(j.Overlay, {
                        className: xa,
                        children: n.jsx(C, {
                            res: A(u, _?.specialAwardName, _?.isWheeled),
                            rareBonus: _,
                            texts: h,
                            controls: {
                                onClose: () => {
                                    (a.setActiveRareReward(null), T.resume());
                                },
                ...
                n.jsx(j.Header, { text: h.headerTitle, className: k }),
                n.jsx(j.Body, {
                    children: n.jsx('div', {
                        className: va,
                        children: J(v, (e, a) =>
                ...
                n.jsx(I, {
                    ...
                    actions: {
                        ...a,
                        openNext: () => {
                            (a.incSessionalNumberOpenings(), x.send({ type: P.toPreparation }));
                        },
                    },
    ...
    Ca = r(function () {
        ...
        (i.useEffect(() => {
            const e = (e) => {
                e.name === Re && x.send({ type: P.toPage });
            };
            return (
            ...
            i.useEffect(() => {
                x.send({ type: P.setAnimationActive, isAnimationActive: o });
            }, [o]),
            T(u, m, w));
        const { loadingStyle: h, contentStyle: v } = k(w, a.openNext);
        return n.jsxs(V, {
            className: Ra,
            ref: g.rootRef,
            children: [
                ...
                N(w) !== E && n.jsx(c.div, { style: v, children: n.jsx(V.Content, { children: n.jsx(ya, {}) }) }),
                w === b.waiting &&
                    n.jsx(c.div, {
                        style: h,
                        className: ja,
                        children: n.jsx(V.Waiting, { text: r.loader, image: s.loader }),
                    }),
            ],
        });
    }),
    Aa = () => n.jsx(ue, { options: m.MULTIPLE_REWARD, children: n.jsx(Ie, { children: n.jsx(Ca, {}) }) });
