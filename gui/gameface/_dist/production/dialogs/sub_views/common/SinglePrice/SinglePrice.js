(() => {
    ...
    var __webpack_modules__ = {
            ...
            364: (u, e, A) => {
                A.d(e, { Sw: () => t.Z, B3: () => o, Z5: () => n, B0: () => D, ry: () => d });
                class F {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
                ...
                function c(u, e, A, F, E, t, n) {
                    ...
                    r.done ? e(D) : Promise.resolve(D).then(F, E);
                }
            ...
            819: (u, e, A) => {
                ...
                const s = {
                    ...
                    _ = ({
                        ...
                        discountValue: r,
                        showPlus: o,
                        stockBackgroundName: B = a.Red,
                    }) => {
                        const _ = D()(s.value, s[`value__${F}`], !t && s.value__notEnough),
                            c = D()(s.icon, s[`icon__${F}-${A}`]),
                            l = D()(s.stock, r && s.stock__indent, e && s.stock__interactive),
                            d = o && n > 0 && '+',
                            m = D()(s.base, s[`base__${A}`]);
                        return E().createElement(
                            ...
                            E().createElement(
                                ...
                                { className: _ },
                                d,
                                E().createElement(C, { value: n, format: F === i.gold ? 'gold' : 'integral' }),
                            ),
                            E().createElement('span', { className: c }),
                            u &&
                                E().createElement(
                                    'span',
                                    { className: l },
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((f.current.timeoutId = window.setTimeout(y, i ? 100 : 400)),
                                                      t && t(u),
                                                      k && k(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const p = (u, e, A) => {
                    ...
                    b = (u, e, A = w.left) => u.split(e).reduce(A === w.left ? p : h, []),
                    f = (() => {
                        const u = new RegExp(
                        ...
                        return T.includes(A)
                            ...
                            : ((u, e = w.left) => {
                                  ...
                                  const F =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return b(E, /( )/, e).forEach((u) => (A = A.concat(b(u, F, w.left)))), A;
                              })(u, e);
                    };
                let x;
                !(function (u) {
                ...
                Date.now();
                A(67);
                const O = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    k = (u) => {
                    ...
                    L = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, A) => {
                                const F = O(`${u}.${A}`, window);
                                return P(F) ? e(u, A, F) : `${u}.${A}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    S = (u) => {
                        const e = ((u) => {
                                const e = l(),
                                ...
                                return { modelPrefix: E, modelPath: M(E, u || ''), resId: F };
                            })(),
                            A = e.modelPrefix,
                            F = u.split('.');
                        if (F.length > 0) {
                            ...
                            return (
                                F.reduce((e, F) => {
                                    const E = O(M(A, `${e}.${F}`), window);
                                    return P(E) ? (u.push(E.id), `${e}.${F}.value`) : (u.push(F), `${e}.${F}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const U = (u = 'model', e = I.Deep) => {
                            ...
                            k(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        F = S(u);
                                    B.current = N.addCallback(F, A, r, e === I.Deep);
                                }
                            }),
                            (0, F.useEffect)(() => {
                                if (e !== I.None)
                                    return () => {
                                        N.removeCallback(B.current, r);
                                    };
                            }, [r, e]),
                            i
                        );
                    },
                    W = (B.Sw.instance, 'FormatText_base_d0'),
                    V = ({ binding: u, text: e = '', classMix: A, alignment: t = w.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, n) =>
                                      E().createElement(
                                          'div',
                                          { className: D()(W, A), key: `${e}-${n}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : y(u, e))))(e, t, u).map((u, e) =>
                    ...
                    K = (0, F.memo)(({ text: u, binding: e, classMix: A }) => {
                                ...
                                (D = D.replace(A, `%(${r})`)),
                                    (n[r] = q[u]
                                        ? E().createElement(
                                              'span',
                                              { className: q[u] },
                                              E().createElement(V, { text: a, binding: e }),
                                          )
                                        : E().createElement(
                                              'span',
                                              { style: t(u) },
                        ...
                        return E().createElement(V, { text: D, classMix: A, binding: n });
                    });
                let j;
                !(function (u) {
                ...
                const Y = (u, e) => ({
                    ...
                    $ = {
                        ...
                        currency__discount: 'SinglePriceApp_currency__discount_14',
                    },
                    X = () => {
                        const u = U().text,
                            e = U('model.cost'),
                            A = U('model.tooltip'),
                            F = Y(A.type, void 0),
                            t = D()($.currency, $[`currency__${e.size}`], e.isDiscount && $.currency__discount);
                        return E().createElement(
                            'div',
                            { className: $.base },
                            E().createElement('div', { className: $.text }, E().createElement(K, { text: u })),
                            E().createElement(
                                v,
                                F,
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.O = (u, e, A, F) => {
            if (!e) {
                ...
                for (D = 0; D < deferred.length; D++) {
                    for (var [e, A, F] = deferred[D], t = !0, n = 0; n < e.length; n++)
                        (!1 & F || E >= F) &&
        ...
        (() => {
            ...
            var e = (e, A) => {
                    ...
                    for (e && e(A); D < t.length; D++)
                        (E = t[D]), __webpack_require__.o(u, E) && u[E] && u[E][0](), (u[E] = 0);
                    return __webpack_require__.O(o);
                },
                A = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            A.forEach(e.bind(null, 0)), (A.push = e.bind(null, A.push.bind(A)));
        })();
    var __webpack_exports__ = __webpack_require__.O(void 0, [573], () => __webpack_require__(819));
