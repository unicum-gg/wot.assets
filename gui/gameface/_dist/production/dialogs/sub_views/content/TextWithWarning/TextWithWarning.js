(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, A) => {
                A.d(e, { O: () => G });
                var F = {};
                A.r(F), A.d(F, { mouse: () => o, onResize: () => n });
                var E = {};
                A.r(E),
                    A.d(E, {
                        events: () => F,
            ...
            364: (u, e, A) => {
                ...
                function c(u, e, A, F, E, D, t) {
                    ...
                    B.done ? e(C) : Promise.resolve(C).then(F, E);
                }
                ...
                const p = E.instance,
                    g = {
                        ...
                        sendMoveEvent: (u) => w(C.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: v,
                        sendClosePopOverEvent: () => w(C.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            w(C.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
            ...
            513: (u, e, A) => {
                ...
                const C = (u, e, A) => {
                    ...
                    r = (u, e, A = B.left) => u.split(e).reduce(A === B.left ? C : n, []),
                    o = (() => {
                        const u = new RegExp(
                        ...
                        d(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    F = m(u);
                                i.current = p.addCallback(F, A, B, e === g.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== g.None)
                ...
                const O = 'FormatText_base_d0',
                    x = ({ binding: u, text: e = '', classMix: A, alignment: D = B.left }) =>
                        null === e
                    ...
                    S = ({ text: u, binding: e, classMix: A }) => {
                                ...
                                (C = C.replace(A, `%(${B})`)),
                                    (t[B] = y[u]
                                        ? E().createElement(
                                              'span',
                                              { className: y[u] },
                                              E().createElement(x, { text: r, binding: e }),
                                          )
                                        : E().createElement(
                                              'span',
                                              { style: D(u) },
                        ...
                        return E().createElement(x, { text: C, classMix: A, binding: t });
                    },
                    L = 'App_base_db',
                    N = 'App_warning_d5',
                    U = 'App_alertImage_c8',
                    W = 'App_warningText_d7',
                    I = 'App_mainText_8b',
                    V = () => {
                        const u = T(),
                            e = u.mainText,
                        ...
                        return E().createElement(
                            ...
                            A &&
                                E().createElement(
                                    'div',
                                    { className: N },
                                    E().createElement('div', { className: U }),
                                    E().createElement(S, { classMix: W, text: A }),
                                ),
                            E().createElement(S, { classMix: I, text: e }),
                        );
                    };
        ...
        (__webpack_require__.O = (u, e, A, F) => {
            if (!e) {
                ...
                for (C = 0; C < deferred.length; C++) {
                    for (var [e, A, F] = deferred[C], D = !0, t = 0; t < e.length; t++)
                        (!1 & F || E >= F) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [573], () => __webpack_require__(513));
