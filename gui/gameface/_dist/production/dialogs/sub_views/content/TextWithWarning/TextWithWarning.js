(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, F) => {
                (F.r(e),
                    F.d(e, { mouse: () => C, off: () => B, on: () => n, onResize: () => D, onScaleUpdated: () => t }));
                var A = F(472),
                    E = F(176);
            ...
            138: (u, e, F) => {
                ...
                var A = F(959),
                    E = F(514);
                const D = { view: F(641), client: A, sound: E.ZP };
            },
            514: (u, e, F) => {
                F.d(e, { ZP: () => t });
                var A = F(959);
            ...
            641: (u, e, F) => {
                ...
                const f = (() => {
                    ...
                    T = A.cg,
                    x = Object.keys(D.W).reduce(
                        (u, e) => ((u[e] = () => viewEnv.getShowingStatus() === D.W[e]), u),
                        {},
                    ),
                    O = {
                        set: (u, e) => {
            ...
            690: (u, e, F) => {
                ...
                function D(u) {
                    let e = '';
                    for (let F = E.length - 1; F >= 0; F--) for (; u >= E[F]; ) ((e += A[F]), (u -= E[F]));
                    return e;
                }
            ...
            195: (u, e, F) => {
                    ...
                    l = (u, e = B.left) => {
                        ...
                        return ((u, e = B.left) => {
                            ...
                            const A =
                                ...
                                E = C(u);
                            return (a(E, /( )/, e).forEach((u) => (F = F.concat(a(u, A, B.left)))), F);
                        })(u, e);
                    };
                var _ = F(916),
                    d = F(613);
                ...
                const w = (u = 1) => {
                        ...
                        var D;
                        e &&
                            ((E = (null == (D = e.match(/(coui:\/\/[^\s]+\.js)/)) ? void 0 : D[0]) || ''),
                    ...
                    b = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: E, modelPath: g(E, u || ''), resId: A };
                            })(),
                            F = e.modelPrefix,
                            A = u.split('.');
                        if (A.length > 0) {
                        ...
                        h(() => {
                            if (
                                ...
                                const F = (u) => {
                                    ...
                                    A = b(u);
                                a.current = T.addCallback(A, F, B, e === x.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== x.None)
                ...
                const P = 'FormatText_base_d0',
                    S = ({ binding: u, text: e = '', classMix: F, alignment: D = B.left, formatWithBrackets: t }) => {
                    ...
                    U = ({ text: u, binding: e, classMix: F }) => {
                                ...
                                ((B = B.replace(F, `%(${n})`)),
                                    (t[n] = M[u]
                                        ? E().createElement(
                                              'span',
                                              { className: M[u] },
                                              E().createElement(S, { text: C, binding: e }),
                                          )
                                        : E().createElement(
                                              'span',
                                              { style: D(u) },
                        ...
                        return E().createElement(S, { text: B, classMix: F, binding: t });
                    },
                    I = 'App_base_db',
                    V = 'App_warning_d5',
                    j = 'App_alertImage_c8',
                        ...
                        return E().createElement(
                            ...
                            F &&
                                E().createElement(
                                    ...
                                    E().createElement(U, { classMix: z, text: F }),
                                ),
                            E().createElement(U, { classMix: G, text: e }),
                        );
                    };
                engine.whenReady.then(() => {
                    t().render(E().createElement(q, null), document.getElementById('root'));
                });
            },
            363: (u) => {
                u.exports = React;
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.O = (u, e, F, A) => {
            if (!e) {
                ...
                for (B = 0; B < deferred.length; B++) {
                    for (var [e, F, A] = deferred[B], D = !0, t = 0; t < e.length; t++)
                        (!1 & A || E >= A) &&
        ...
        (() => {
            ...
            var e = (e, F) => {
                    ...
                    for (e && e(F); B < D.length; B++)
                        ((E = D[B]), __webpack_require__.o(u, E) && u[E] && u[E][0](), (u[E] = 0));
