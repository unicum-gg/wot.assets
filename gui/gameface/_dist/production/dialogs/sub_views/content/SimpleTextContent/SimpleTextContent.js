    ...
    var __webpack_modules__ = {
                    ...
                    g = {
                        ...
                        sendShowPopOverEvent: (u, e, A, F, E = R.invalid('resId'), D) => {
                            const t = s.O.view.getViewGlobalPosition(),
                                ...
                                i = B.height,
                                a = {
                                    x: s.O.view.pxToRem(C) + t.x,
                                    y: s.O.view.pxToRem(r) + t.y,
            ...
            678: (u, e, A) => {
                ...
                const n = (u, e, A) => {
                    ...
                    r = (u, e, A = B.left) => u.split(e).reduce(A === B.left ? n : C, []),
                    o = (() => {
                        const u = new RegExp(
                        ...
                        return i.includes(A)
                            ...
                            : ((u, e = B.left) => {
                                  ...
                                  const F =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return r(E, /( )/, e).forEach((u) => (A = A.concat(r(u, F, B.left)))), A;
                              })(u, e);
                    };
                let s;
                !(function (u) {
                ...
                const l = (u = 1) => {
                    ...
                    p = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: E, modelPath: v(E, u || ''), resId: F };
                            })(),
                            A = e.modelPrefix,
                            F = u.split('.');
                        if (F.length > 0) {
                        ...
                        w(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    F = p(u);
                                i.current = g.addCallback(F, A, B, e === T.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== T.None)
                                return () => {
                                    g.removeCallback(i.current, B);
                                };
                        }, [B, e]),
                        r
                    );
                ...
                var f = A(483),
                    O = A.n(f);
                const x = 'FormatText_base_d0',
                    y = ({ binding: u, text: e = '', classMix: A, alignment: D = B.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, t) =>
                                      E().createElement(
                                          'div',
                                          { className: O()(x, A), key: `${e}-${t}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : a(u, e))))(e, D, u).map((u, e) =>
                    ...
                    k = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    S = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    L = (0, F.memo)(({ text: u, binding: e, classMix: A }) => {
                        const D = (0, F.useCallback)((u) => ({ color: `#${u}` }), []),
                            t = (0, F.useMemo)(() => e || {}, [e]);
                        let B = P.exec(u),
                            n = u,
                            C = 0;
                                ...
                                (n = n.replace(A, `%(${B})`)),
                                    (t[B] = M[u]
                                        ? E().createElement(
                                              'span',
                                              { className: M[u] },
                                              E().createElement(y, { text: o, binding: e }),
                                          )
                                        : E().createElement(
                                              'span',
                                              { style: D(u) },
                        ...
                        return E().createElement(y, { text: n, classMix: A, binding: t });
                    }),
                    N = 'Icon_base_67',
                    U = (0, F.memo)(({ src: u, classMix: e, style: A }) => {
                        const D = (0, F.useState)(0),
                            ...
                            r = n[1],
                            o = (0, F.useCallback)((u) => {
                                B(u.currentTarget.height), r(u.currentTarget.width);
                            }, []),
                            i = (() => {
                                const u = (0, F.useState)(c.O.view.getScale()),
                                    e = u[0],
                                    A = u[1];
                                return (
                                    (0, F.useEffect)(() => {
                            ...
                            a = (0, F.useMemo)(
                                () => Object.assign({ width: `${C}rem`, height: `${t}rem` }, A),
                                [t, C, A],
                            ),
                            s = O()(N, e);
                        return E().createElement(
                            'div',
                            { className: s, style: a },
                            E().createElement('img', { alt: 'icon', src: u, style: i, onLoad: o }),
                        );
                    }),
                    W = 'SimpleTextApp_base_bd',
                    I = 'SimpleTextApp_formatText_fa',
                    V = () => {
                        const u = b(),
                            e = u.text,
                            A = u.imageSubstitutions,
                            D = (0, F.useMemo)(
                                () =>
                                    A.map(({ value: u }) => ({
                            ...
                            t = (0, F.useMemo)(
                                () =>
                                    A.reduce(
                                        (u, { value: e }, A) => (
                                            e.path &&
                                                (u[e.placeholder] = E().createElement(U, { src: e.path, style: D[A] })),
                                            u
                                        ),
                                        {},
                                    ),
                        ...
                        return E().createElement(
                            'div',
                            { className: W },
                            E().createElement(L, { classMix: I, text: e, binding: t }),
                        );
                    };
