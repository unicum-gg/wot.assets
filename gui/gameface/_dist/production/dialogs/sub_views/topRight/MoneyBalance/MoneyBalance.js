(() => {
    ...
    var __webpack_modules__ = {
            ...
            364: (u, e, t) => {
                t.d(e, { Sw: () => i.Z, B3: () => E, Z5: () => a, B0: () => F, ry: () => _ });
                class r {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
                ...
                function c(u, e, t, r, n, i, a) {
                    ...
                    A.done ? e(F) : Promise.resolve(F).then(r, n);
                }
            ...
            647: (u, e, t) => {
                    ...
                    h = (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(c),
                            ...
                            A = (0, r.useCallback)((u, e) => {
                                ...
                                a(Object.assign({ width: t, height: r }, s(t, r, E)));
                            }, []);
                        m(() => {
                ...
                const p = (u = 1) => {
                    ...
                    T = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const r = b(`${u}.${t}`, window);
                                return f(r) ? e(u, t, r) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    y = (u) => {
                        const e = ((u) => {
                                const e = p(),
                                ...
                                return { modelPrefix: n, modelPath: x(n, u || ''), resId: r };
                            })(),
                            t = e.modelPrefix,
                            r = u.split('.');
                        if (r.length > 0) {
                            ...
                            return (
                                r.reduce((e, r) => {
                                    const n = b(x(t, `${e}.${r}`), window);
                                    return f(n) ? (u.push(n.id), `${e}.${r}.value`) : (u.push(r), `${e}.${r}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        m(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    r = y(u);
                                l.current = O.addCallback(r, t, A, e === M.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (e !== M.None)
                                return () => {
                                    O.removeCallback(l.current, A);
                                };
                        }, [A, e]),
                        o
                    );
                ...
                const U = (u, e, t = {}, r = 0) => {
                    ...
                    V = (u) => {
                        ...
                        const w = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            v = (0, r.useMemo)(() => _ || p().resId, [_]),
                            b = (0, r.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (U(t, B, { isMouseEvent: !0, on: !0, arguments: H(n) }, v),
                                    m && m(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((w.current.timeoutId = window.setTimeout(b, o ? 100 : 400)),
                                                      i && i(u),
                                                      T && T(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const Z = {
                    ...
                    uu = () => {
                        const u = L(),
                            ...
                            a = u.equipCoin,
                            A = u.isWGMAvailable,
                            F = L('model.crystalsTooltip'),
                            E = L('model.goldTooltip'),
                            o = L('model.creditsTooltip'),
                            s = L('model.freeExpTooltip'),
        ...
        (__webpack_require__.O = (u, e, t, r) => {
            if (!e) {
                ...
                for (F = 0; F < deferred.length; F++) {
                    for (var [e, t, r] = deferred[F], i = !0, a = 0; a < e.length; a++)
                        (!1 & r || n >= r) &&
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); F < i.length; F++)
                        (n = i[F]), __webpack_require__.o(u, n) && u[n] && u[n][0](), (u[n] = 0);
                    return __webpack_require__.O(E);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t)));
        })();
    var __webpack_exports__ = __webpack_require__.O(void 0, [573], () => __webpack_require__(647));
