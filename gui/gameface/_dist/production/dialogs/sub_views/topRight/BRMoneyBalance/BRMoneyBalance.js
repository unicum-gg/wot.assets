(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var F = {};
                t.r(F), t.d(F, { getBgUrl: () => l, getTextureUrl: () => C });
                var E = {};
                function r(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            358: (u, e, t) => {
                ...
                class A {
                    ...
                    addCallback(u, e, t = 0, A = !0) {
                        ...
                        const F = n.O.view.addModelObserver(u, t, A);
                        return (
                            F > 0
                                ? ((this._callbacks[F] = e),
            ...
            364: (u, e, t) => {
                t.d(e, { Sw: () => F.Z, B3: () => i, Z5: () => E, B0: () => o, ry: () => d });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
                    ...
                    h = {
                        ...
                        sendShowPopOverEvent: (u, e, t, n, A = R.invalid('resId'), F) => {
                            const E = c.O.view.getViewGlobalPosition(),
                                ...
                                s = r.height,
                                B = {
                                    x: c.O.view.pxToRem(i) + E.x,
                                    y: c.O.view.pxToRem(a) + E.y,
            ...
            875: (u, e, t) => {
                        ...
                        C(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = v(u);
                                s.current = w.addCallback(n, t, r, e === m.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== m.None)
                                return () => {
                                    w.removeCallback(s.current, r);
                                };
                        }, [r, e]),
                        a
                    );
                ...
                const f = (u, e, t = {}, n = 0) => {
                    ...
                    T = (u) => {
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            T = (0, n.useMemo)(() => v || B().resId, [v]),
                            y = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (f(t, C, { isMouseEvent: !0, on: !0, arguments: g(A) }, T),
                                    w && w(),
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onMouseLeave: ((u) => (e) => {
                                              O(), null == E || E(e), null == u || u(e);
                                          })(e.props.onMouseLeave),
                                          onClick: ((u) => (e) => {
                                              !1 === s && O(), null == o || o(e), null == u || u(e);
                                          })(e.props.onClick),
                                          onMouseDown: ((u) => (e) => {
                                              !1 === s && O(), null == r || r(e), null == u || u(e);
                                          })(e.props.onMouseDown),
                                      },
                                      p,
                                  ),
                ...
                const I = (u, e) => ({
                    ...
                    V = ({ value: u, currencyType: e, isWGMAvailable: t, tooltip: n }) => {
                        const F = e === o.gold ? 'gold' : 'integral',
                            E = I(n.type, { currency: e });
                        return A().createElement(
                            T,
                            E,
                            A().createElement(
                                'span',
                                { className: O()(U.base, U[`base__${e}`]) },
                                A().createElement('div', { className: U.icon }),
                                t ? A().createElement(b, { value: u, format: F }) : A().createElement(N, null),
                            ),
                        );
                    },
                    W = 'CurrencyItemResolver_base_51',
                    G = 'CurrencyItemResolver_icon_da';
                let H;
                !(function (u) {
                    u.brcoin = 'brcoin';
                })(H || (H = {}));
                const K = (0, n.memo)(({ value: u, currencyType: e, isWGMAvailable: t, tooltip: F }) => {
                        const E = (0, n.useMemo)(() => I(F.type, { currency: e }), [F.type, e]);
                        return e !== H.brcoin
                            ? A().createElement(V, { value: u, currencyType: e, isWGMAvailable: t, tooltip: F })
                            : A().createElement(
                                  T,
                                  E,
                                  A().createElement(
                                      ...
                                      A().createElement(b, { value: u, format: 'integral' }),
                                  ),
                              );
                    }),
                    q = 'App_base_b3',
                ...
                engine.whenReady.then(() => {
                    E().render(A().createElement(j, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (o = 0; o < deferred.length; o++) {
                    for (var [e, t, n] = deferred[o], F = !0, E = 0; E < e.length; E++)
                        (!1 & n || A >= n) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [573], () => __webpack_require__(875));
