(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => a, off: () => i, on: () => F, onResize: () => E, onScaleUpdated: () => o }));
                var n = t(472),
                    r = t(176);
            ...
            916: (u, e, t) => {
                t.d(e, { Sw: () => E.Z, B3: () => i, Z5: () => o.Z5, B0: () => F, ry: () => d });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            529: (u, e, t) => {
                        ...
                        l(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = v(u);
                                d.current = w.addCallback(n, t, i, e === p.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== p.None)
                ...
                const y = (u, e, t = {}, n = 0) => {
                    ...
                    T = (u) => {
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            g = (0, n.useMemo)(() => v || c().resId, [v]),
                            T = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (y(t, l, { isMouseEvent: !0, on: !0, arguments: f(r) }, g),
                                    m && m(),
                ...
                const P = 'Waiting_waiting_51',
                    ...
                    I = (0, n.memo)(() =>
                        r().createElement(
                            ...
                            r().createElement('span', { className: M }),
                        ),
                    );
                let N;
                !(function (u) {
                ...
                const V = (u, e) => ({
                    ...
                    W = ({ value: u, currencyType: e, isWGMAvailable: t, tooltip: n }) => {
                        const E = e === i.gold ? 'gold' : 'integral',
                            o = V(n.type, { currency: e });
                        return r().createElement(
                            T,
                            o,
                            r().createElement(
                                'span',
                                { className: k()(U.base, U[`base__${e}`]) },
                                r().createElement('div', { className: U.icon }),
                                t ? r().createElement(g, { value: u, format: E }) : r().createElement(I, null),
                            ),
                        );
                    },
                ...
                const K = (0, n.memo)(({ value: u, currencyType: e, isWGMAvailable: t, tooltip: E }) => {
                        const o = (0, n.useMemo)(() => V(E.type, { currency: e }), [E.type, e]);
                        return e !== q.brcoin
                            ? r().createElement(W, { value: u, currencyType: e, isWGMAvailable: t, tooltip: E })
                            : r().createElement(
                                  T,
                                  o,
                                  r().createElement(
                                      ...
                                      r().createElement(g, { value: u, format: 'integral' }),
                                  ),
                              );
                    }),
                    z = 'App_base_b3',
                    H = () => {
                        const u = b(),
                            ...
                            t = u.brcoins,
                            n = u.isWGMAvailable,
                            E = b('model.creditsTooltip'),
                            o = b('model.brcoinsTooltip');
                        return r().createElement(
                            'div',
                            { className: z },
                            r().createElement(K, {
                ...
                engine.whenReady.then(() => {
                    o().render(r().createElement(H, null), document.getElementById('root'));
                });
            },
            363: (u) => {
                u.exports = React;
