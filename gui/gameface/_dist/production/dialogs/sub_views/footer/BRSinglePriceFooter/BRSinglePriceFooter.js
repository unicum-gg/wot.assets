(() => {
    ...
    var __webpack_modules__ = {
            ...
            138: (u, e, n) => {
                ...
                var t = n(959),
                    r = n(698),
                    o = n(514);
                const i = { view: n(641), client: t, sound: o.ZP, intl: r.N };
            },
            698: (u, e, n) => {
                n.d(e, { N: () => t });
                const t = {
            ...
            916: (u, e, n) => {
                n.d(e, { Sw: () => o.Z, B3: () => E, Z5: () => i.Z5, B0: () => a, ry: () => B });
                class t {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            40: (u, e, n) => {
                ...
                const F = (u = 1) => {
                    ...
                    return { callerUrl: r, caller: n, stack: e, resId: t };
                };
                var A = n(916);
                const s = [
                    'children',
                        ...
                        const y = (0, t.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            k = (0, t.useCallback)(() => {
                                (y.current.isVisible && y.current.timeoutId) ||
                                    (_(n, d, { isMouseEvent: !0, on: !0, arguments: c(r) }, f),
                                    p && p(),
                        ...
                        d(() => {
                            if (
                                ...
                                const n = (u) => {
                                    ...
                                    t = w(u);
                                l.current = b.addCallback(t, n, E, e === h.Deep);
                            }
                        }),
                        (0, t.useEffect)(() => {
                            if (e !== h.None)
                                return () => {
                                    b.removeCallback(l.current, E);
                                };
                        }, [E, e]),
                        c
                    );
                ...
                const L = (0, t.memo)(
                        ({
                            ...
                            showPlus: a,
                            isEnough: F = !0,
                            stockBackgroundName: A = x.Red,
                            className: s,
                            classNames: c,
                        }) =>
                            r().createElement(
                                'span',
                                { className: E()(P.base, P[`base__${n}`], s) },
                                r().createElement(
                                    'span',
                                    {
                                        className: E()(
                                            P.value,
                                            P[`value__${t}`],
                                            !F && P.value__notEnough,
                                            null == c ? void 0 : c.value,
                                        ),
                                    },
                                    a && o > 0 && '+',
                                    r().createElement(k, { value: o, format: t === T.gold ? 'gold' : 'integral' }),
                                ),
                                r().createElement('span', {
                                    className: E()(P.icon, P[`icon__${t}-${n}`], null == c ? void 0 : c.icon),
                                }),
                                u &&
                                    r().createElement(
                                        'span',
                    ...
                    S = ({
                        ...
                        const A = E()(M.value, M[`value__${n}`], !o && M.value__notEnough),
                            s = E()(M.icon, M[`icon__${n}`]),
                            c = E()(
                                M.stock,
                                a && M.stock__indent,
                                n === O.big && M.stock__sizeBig,
                                n === O.large && M.stock__sizeLarge,
                                e && M.stock__interactive,
                            ),
                            _ = F && i > 0 && '+';
                        return t in T
                            ? r().createElement(L, {
                            ...
                            : r().createElement(
                                  ...
                                  u &&
                                      r().createElement(
                                          'span',
                                          { className: c },
                                          r().createElement('span', { className: M.stockBackground }),
                                          Boolean(a) && a,
                                      ),
                              );
                    };
                    ...
                    return r().createElement(
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: i },
                                r().createElement(N, V({ typeCurrency: e.type }, e)),
                            ),
                        ),
                    );
                };
                engine.whenReady.then(() => {
                    i().render(r().createElement(U, null), document.getElementById('root'));
                });
            },
            363: (u) => {
                u.exports = React;
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [573], () => __webpack_require__(40));
