(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, n) => {
                n.d(e, { O: () => G });
                var t = {};
                n.r(t), n.d(t, { mouse: () => _, onResize: () => F });
                var r = {};
                n.r(r),
                    n.d(r, {
                        events: () => t,
                ...
                var o = {};
                n.r(o), n.d(o, { getBgUrl: () => B, getTextureUrl: () => l });
                var i = {};
                function A(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            364: (u, e, n) => {
                n.d(e, { Sw: () => o.Z, B3: () => F, Z5: () => i, B0: () => E, ry: () => d });
                class t {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
                ...
                const p = r.instance,
                    b = {
                        ...
                        sendShowContextMenuEvent: (u, e, n = 0) => {
                            v(E.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: n, args: e });
                        },
                        ...
                        const y = (0, t.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            k = (0, t.useCallback)(() => {
                                (y.current.isVisible && y.current.timeoutId) ||
                                    (c(n, d, { isMouseEvent: !0, on: !0, arguments: s(r) }, f),
                                    p && p(),
                ...
                const C = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    ...
                    w = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: r, modelPath: m(r, u || ''), resId: t };
                            })(),
                            n = e.modelPrefix,
                            t = u.split('.');
                        if (t.length > 0) {
