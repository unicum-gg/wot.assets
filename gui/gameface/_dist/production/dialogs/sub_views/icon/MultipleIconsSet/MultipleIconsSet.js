(() => {
    ...
    var __webpack_modules__ = {
                ...
                const v = F.instance,
                    g = {
                        ...
                        sendShowContextMenuEvent: (u, e, E = 0) => {
                            d(n.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: E, args: e });
                        },
                        sendShowPopOverEvent: (u, e, E, A, F = R.invalid('resId'), t) => {
                            const D = i.O.view.getViewGlobalPosition(),
                                ...
                                C = r.height,
                                s = {
                                    x: i.O.view.pxToRem(B) + D.x,
                                    y: i.O.view.pxToRem(o) + D.y,
                                    width: i.O.view.pxToRem(a),
                                    height: i.O.view.pxToRem(C),
                                };
                            d(n.POP_OVER, {
                                isMouseEvent: !0,
                                contentID: u,
            ...
            169: (u, e, E) => {
                ...
                const a = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    s = (u, e, E = B.left) => u.split(e).reduce(E === B.left ? C : i, []),
                    c = (() => {
                        const u = new RegExp(
                ...
                const w = (u = 1) => {
                    ...
                    T = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: F, modelPath: b(F, u || ''), resId: A };
                            })(),
                            E = e.modelPrefix,
                            A = u.split('.');
                        if (A.length > 0) {
                        ...
                        g(() => {
                            if (
                                ...
                                const E = (u) => {
                                    ...
                                    A = T(u);
                                i.current = x.addCallback(A, E, r, e === O.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== O.None)
                                return () => {
                                    x.removeCallback(i.current, r);
                                };
                        }, [r, e]),
                        a
                    );
                ...
                const M = 'FormatText_base_d0',
                    ...
                    I = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    U = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    V = (0, A.memo)(({ text: u, binding: e, classMix: E }) => {
                        const t = (0, A.useCallback)((u) => ({ color: `#${u}` }), []),
                            D = (0, A.useMemo)(() => e || {}, [e]);
                        let n = W.exec(u),
                            r = u,
                            B = 0;
                                ...
                                ((r = r.replace(E, `%(${n})`)),
                                    (D[n] = N[u]
                                        ? F().createElement(
                                              'span',
                                              { className: N[u] },
                                              F().createElement(L, { text: a, binding: e }),
                                          )
                                        : F().createElement(
                                              'span',
                                              { style: t(u) },
                        ...
                        return F().createElement(L, { text: r, classMix: E, binding: D });
                    }),
                    $ = () => {
                        const u = (0, A.useState)(h.O.view.getScale()),
                            e = u[0],
                            E = u[1];
                        return (
                            (0, A.useEffect)(() => {
                            ...
                            (0, A.useMemo)(() => ({ transform: `scale(${e})` }), [e])
                        );
                    },
                    j = 'Icon_base_67',
                    z = (0, A.memo)(({ src: u, classMix: e, style: E }) => {
                        ...
                        return F().createElement(
                            'div',
                            { className: s, style: i },
                            F().createElement('img', { alt: 'icon', src: u, style: C, onLoad: a }),
                        );
                    }),
                    G = 'SimpleTextApp_base_bd',
                    q = 'SimpleTextApp_formatText_fa',
                    K = (u) => u,
                    H = ({ path: u, modelAdapter: e = K }) => {
                            ...
                            r = (0, A.useMemo)(
                                () =>
                                    D.reduce(
                                        (u, { value: e }, E) => (
                                            e.path &&
                                                (u[e.placeholder] = F().createElement(z, { src: e.path, style: n[E] })),
                                            u
                                        ),
                                        {},
                                    ),
                        ...
                        return F().createElement(
                            'div',
                            { className: G },
                            F().createElement(V, { classMix: q, text: t, binding: r }),
                        );
                    },
                    Y = 'MultipleIconsSetApp_base_ef',
                    Z = 'MultipleIconsSetApp_mainIcon_73',
                    X = 'MultipleIconsSetApp_iconContainer_6e',
                    Q = 'MultipleIconsSetApp_iconLabel_bb',
                    J = 'MultipleIconsSetApp_container_20',
                    uu = 'MultipleIconsSetApp_icon_49',
                    ...
                    Eu = () => {
                        const u = k(),
                            ...
                            i = a[1],
                            s = (0, A.useMemo)(() => {
                                if (0 === B) return { height: 0 };
                                const u = ((u) => Math.max(u, 135))(B);
                                switch (D) {
                            ...
                            c = (0, A.useCallback)((u) => {
                                (o(u.currentTarget.height), i(u.currentTarget.width));
                            }, []),
                            l = $();
                        return F().createElement(
                            'div',
                                ...
                                e.map(
                                    ({ value: u }) =>
                                        ...
                                        F().createElement(
                                            ...
                                            F().createElement('img', { alt: 'bg icon', src: u.path, style: l }),
                                        ),
                                ),
                                F().createElement(
                                    'div',
                                        ...
                                        ({ value: u }, e) =>
                                            ...
                                            F().createElement(
                                                ...
                                                F().createElement('img', {
                                                    alt: '',
                                                    src: u.path,
                                                    style: { width: `${C}rem`, height: `${B}rem` },
                                                    onLoad: c,
                                                }),
                                                u.iconLabel &&
                                                    F().createElement(
                                ...
                                E.map(
                                    ({ value: u }) =>
                                        ...
                                        F().createElement(
                                            'div',
                                            { key: u.path, className: uu },
                                            F().createElement('img', { alt: 'overlay icon', src: u.path, style: l }),
                                        ),
                                ),
                            ),
                        );
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [573], () => __webpack_require__(169));
