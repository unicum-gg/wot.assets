(() => {
    ...
    var __webpack_modules__ = {
            ...
            3314: (u, e, t) => {
                    ...
                    f = () => {
                        const u = h(),
                            ...
                            C = (0, n.useMemo)(
                                () => ({
                                    height: `${a}rem`,
                                    marginBottom: F || 0 === a ? '0' : `-${Math.round((a - 135) / 2)}rem`,
                                }),
                                [a, F],
                            ),
                            c = (0, n.useCallback)((u) => {
                                ...
                                E.path &&
                                    A().createElement(
                                        ...
                                        A().createElement(
                                            ...
                                            A().createElement('img', { alt: 'icon', src: E.path, style: l, onLoad: c }),
                                        ),
                                    ),
                                t.map(
                                    ({ value: u }) =>
                ...
                engine.whenReady.then(() => {
                    F().render(A().createElement(f, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(3314));
