(() => {
    ...
    var __webpack_modules__ = {
            ...
            7443: (u, e, t) => {
                ...
                const a = (u, e, t = {}, n = 0) => {
                    ...
                    s = (u) => {
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            O = (0, n.useMemo)(() => h || r().resId, [h]),
                            T = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (a(t, _, { isMouseEvent: !0, on: !0, arguments: D(A) }, O),
                                    p && p(),
                    ...
                    return (
                        ((u) => {
                            ...
                            if (
                                ...
                                B.current = w.addCallback(n, t, o, e === m.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== m.None)
                                return () => {
                                    w.removeCallback(B.current, o);
                                };
                        }, [o, e]),
                        a
                    );
                ...
                var b;
                (o.Sw.instance,
                    ((b = p || (p = {})).backport = 'backport'),
                    (b.unbound = 'unbound'),
                    (b.normal = 'normal'),
                    (b.absent = 'absent'));
                const g = 'IconWithBlinkingApp_icon_19',
                    f = () => {
                        const u = h(),
                            e = u.backgrounds,
                            t = u.overlays,
                            F = u.icon,
                            E = u.isBottomPushingDown,
                            r = u.blinkingIcons,
                            o = h('model.tooltip'),
                            i = (0, n.useMemo)(() => {
                                return (
                            ...
                            C = (0, n.useMemo)(
                                () => ({
                                    height: `${a}rem`,
                                    marginBottom: E || 0 === a ? '0' : `-${Math.round((a - 135) / 2)}rem`,
                                }),
                                [a, E],
                            ),
                            c = (0, n.useCallback)((u) => {
                        ...
                        return A().createElement(
                            'div',
                            { className: 'IconWithBlinkingApp_base_c3', style: C },
                            A().createElement(
                                'div',
                                { className: 'IconWithBlinkingApp_container_98' },
                                e.map(
                                    ({ value: u }) =>
                                        u.path &&
                                        A().createElement(
                                ...
                                F.path &&
                                    A().createElement(
                                        ...
                                        A().createElement(
                                            'div',
                                            { className: 'IconWithBlinkingApp_mainIcon_7c' },
                                            A().createElement('img', { alt: 'icon', src: F.path, style: l, onLoad: c }),
                                        ),
                                    ),
                                t.map(
                                    ({ value: u }) =>
                                ...
                                r.map(
                                    ({ value: u }) =>
                                        ...
                                        A().createElement(
                                            ...
                                            A().createElement(
                                                'div',
                                                { className: 'IconWithBlinkingApp_blink_c2' },
                                                A().createElement('img', {
                                                    alt: 'overlay icon',
                                                    src: u.path,
                                                    style: l,
                ...
                engine.whenReady.then(() => {
                    E().render(A().createElement(f, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(7443));
