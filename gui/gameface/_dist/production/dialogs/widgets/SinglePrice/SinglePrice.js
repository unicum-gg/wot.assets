    ...
    var __webpack_modules__ = {
            ...
            362: (u, e, t) => {
                ...
                const p = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    w = (u, e, t = v.left) => u.split(e).reduce(t === v.left ? b : h, []),
                    f = (() => {
                        const u = new RegExp(
                    ...
                    T = (u, e = v.left) => {
                        ...
                        return ((u, e = v.left) => {
                            ...
                            const n =
                                ...
                                E = p(u);
                            return (w(E, /( )/, e).forEach((u) => (t = t.concat(w(u, n, v.left)))), t);
                        })(u, e);
                    },
                ...
                const z = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: F, children: A, mocks: o }) {
                                ...
                                return (
                                    (0, n.useEffect)(() => {
                                        a.current ? _(D(B, F, o)) : (a.current = !0);
                                    }, [o, B, F]),
                                    (0, n.useEffect)(() => {
                                        s(r);
                                    }, [r]),
                ...
                const $ = (0, d.Pi)(function ({ tooltipRootId: u }) {
                    ...
                    return E().createElement(
                        ...
                        E().createElement(
                            _,
                            Y({}, t, { targetId: u }),
                            E().createElement('div', { className: o }, E().createElement(B, A)),
                        ),
                    );
                });
                E().memo(function ({ rootId: u = R.views.dialogs.widgets.SinglePrice('resId') }) {
                    return E().createElement(X, { options: { rootId: u } }, E().createElement($, { tooltipRootId: u }));
                });
            },
            363: (u) => {
                u.exports = React;
