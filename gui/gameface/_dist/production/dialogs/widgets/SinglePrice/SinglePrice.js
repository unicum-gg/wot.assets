(() => {
            ...
            437: (u, e, t) => {
                ...
                const B = {
                    ...
                    C = ({
                        ...
                        discountValue: i,
                        showPlus: C,
                        stockBackgroundName: s = D.Red,
                    }) => {
                        const c = n()(B.value, B[`value__${A}`], !E && B.value__notEnough),
                            _ = n()(B.icon, B[`icon__${A}-${t}`]),
                            l = n()(B.stock, i && B.stock__indent, e && B.stock__interactive),
                            d = C && r > 0 && '+',
                            v = n()(B.base, B[`base__${t}`]);
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                { className: c },
                                d,
                                F().createElement(a, { value: r, format: A === o.gold ? 'gold' : 'integral' }),
                            ),
                            F().createElement('span', { className: _ }),
                            u &&
                                F().createElement(
                                    'span',
                                    { className: l },
                        ...
                        const h = (0, A.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, A.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (l(t, s, { isMouseEvent: !0, on: !0, arguments: _(F) }, f),
                                    p && p(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((h.current.timeoutId = window.setTimeout(y, i ? 100 : 400)),
                                                      E && E(u),
                                                      O && O(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const m = (u, e, t) => {
                    ...
                    b = (u, e, t = g.left) => u.split(e).reduce(t === g.left ? m : p, []),
                    w = (() => {
                        const u = new RegExp(
                        ...
                        return h.includes(t)
                            ...
                            : ((u, e = g.left) => {
                                  ...
                                  const A =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return b(F, /( )/, e).forEach((u) => (t = t.concat(b(u, A, g.left)))), t;
                              })(u, e);
                    },
                    y = 'FormatText_base_d0',
                    T = ({ binding: u, text: e = '', classMix: t, alignment: E = g.left }) =>
                        null === e
                            ...
                            : F().createElement(
                                  ...
                                  e.split('\n').map((e, r) =>
                                      F().createElement(
                                          'div',
                                          { className: n()(y, t), key: `${e}-${r}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : f(u, e))))(e, E, u).map((u, e) =>
                    ...
                    k = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    P = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    M = (0, A.memo)(({ text: u, binding: e, classMix: t }) => {
                        const E = (0, A.useCallback)((u) => ({ color: `#${u}` }), []),
                            n = (0, A.useMemo)(() => e || {}, [e]);
                        let r = O.exec(u),
                            o = u,
                            D = 0;
                                ...
                                (o = o.replace(t, `%(${r})`)),
                                    (n[r] = x[u]
                                        ? F().createElement(
                                              'span',
                                              { className: x[u] },
                                              F().createElement(T, { text: a, binding: e }),
                                          )
                                        : F().createElement(
                                              'span',
                                              { style: E(u) },
                        ...
                        return F().createElement(T, { text: o, classMix: t, binding: n });
                    });
                let L;
                !(function (u) {
                ...
                const S = (u, e) => ({
                    isEnabled: u !== L.absent,
                    args: e,
                    contentId: R.views.dialogs.common.DialogTemplateGenericTooltip('resId'),
                    decoratorId:
                        u === L.unbound ? R.views.common.tooltip_window.tooltip_window.TooltipWindow('resId') : void 0,
                    ignoreShowDelay: u === L.backport,
                    ignoreMouseClick: !0,
                });
                function N() {}
                function I() {
                        ...
                        return [
                            function ({ mode: E = 'real', options: n, children: r, mocks: o }) {
                                const D = (0, A.useRef)([]),
                                    i = (t, A, F) => {
                                        ...
                                        const n = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = V(F.keys()); !(u = t()).done; ) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(A),
                                            ...
                                            B = { mode: t, model: a, externalModel: r, cleanup: i };
                                        return {
                                            model: a,
                                            controls: 'mocks' === t && F ? F.controls(B) : e(B),
                                            externalModel: r,
                                            mode: t,
                                        };
                                    },
                                    ...
                                    C = B[0],
                                    s = B[1],
                                    c = (0, A.useState)(() => i(E, n, o)),
                                    _ = c[0],
                                    l = c[1];
                                return (
                                    (0, A.useEffect)(() => {
                                        a.current ? l(i(C, n, o)) : (a.current = !0);
                                    }, [o, C, n]),
                                    (0, A.useEffect)(() => {
                                        s(E);
                                    }, [E]),
                                    ...
                                    F().createElement(t.Provider, { value: _ }, r)
                                );
                            },
                            () => (0, A.useContext)(t),
                        ];
                ...
                const X = (0, v.Pi)(function ({ tooltipRootId: u }) {
                    const e = K().model,
                        t = S(e.tooltip.get().type, void 0),
                        A = e.cost.get(),
                        E = n()(H.currency, H[`currency__${A.size}`]);
                    return F().createElement(
                        'div',
                        { className: H.base },
                        F().createElement('div', { className: H.text }, F().createElement(M, { text: e.text.get() })),
                        F().createElement(
                            d,
                            Y({}, t, { targetId: u }),
                            F().createElement('div', { className: E }, F().createElement(s, A)),
                        ),
                    );
                });
                F().memo(function ({ rootId: u = R.views.dialogs.widgets.SinglePrice('resId') }) {
                    return F().createElement(G, { options: { rootId: u } }, F().createElement(X, { tooltipRootId: u }));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [573], () => __webpack_require__(437));
