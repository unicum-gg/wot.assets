    ...
    var __webpack_modules__ = {
            ...
            1501: (u, e, t) => {
                ...
                const D = E.O.client.getSize('rem'),
                    o = D.width,
                    s = D.height,
                    l = Object.assign({ width: o, height: s }, F(o, s, i)),
                ...
                const I = (u, e, t) => {
                    ...
                    G = (u, e, t = k.left) => u.split(e).reduce(t === k.left ? I : W, []),
                    U = (() => {
                        const u = new RegExp(
                ...
                const J = (u = 'model', e = Z.Deep) => {
                    ...
                    eu = ({ isDisable: u, onMoveSpace: e, onOverSpace: t, onCursorChange: n }) => {
                        const E = (0, r.useState)(!1),
                            ...
                            l = (0, r.useCallback)(
                                (u) => {
                                    if ((u.preventDefault(), !i || !s(u))) return;
                                    const t = u.clientX,
                                        r = u.clientY,
                            ...
                            _ = (0, r.useCallback)(
                                (u) => {
                                    if ((u.preventDefault(), !s(u))) return;
                                    const t = u.deltaY < 0;
                        ...
                        const c = (0, r.useCallback)(
                                (u) => {
                                    (u.preventDefault(),
                                        0 === u.button &&
                                            s(u) &&
                                            (A(!0), n && n(!0), (F.current = u.clientX), (D.current = u.clientY)));
                                },
                                [s, n],
                            ),
                            m = (0, r.useCallback)(() => {
                ...
                const iu = (0, r.memo)(Eu),
                    Au = ({ binding: u, text: e = '', classMix: t, alignment: n = k.left }) =>
                        null === e
                ...
                function ou(u = Fu.n.NONE, e = Du, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Fu.n.NONE)
                            return (
                ...
                const su = R.strings.hb_lobby,
                    lu = () => {
                        ...
                        const A = (0, r.useMemo)(
                            ...
                            F = h()(Boolean(E) && 'BattleTimer_button__large_9d');
                        return a().createElement(
                            'div',
                            ...
                            a().createElement(
                                ...
                                a().createElement(Au, {
                                    ...
                                    text: su.preBattle.timer(),
                                    binding: A,
                                }),
                            ),
                            a().createElement(
                                iu,
                                { type: au.primary, size: nu.medium, onClick: i, disabled: n, mixClass: F },
                                su.preBattle.exitButton(),
                            ),
                        );
                    };
                var _u = t(9887),
                ...
                const cu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    mu = (u) => u.includes('_') && ((u) => cu.includes(u))(u.split('_').at(-1)),
                    Cu = [v.ExtraLarge, v.Large, v.Medium, v.Small, v.ExtraSmall],
                    du = (u, e) =>
                ...
                const bu = {
                    ...
                    fu = hu((u) => {
                        let e = u.className,
                            ...
                            x =
                                void 0 === w
                                    ...
                                    : w,
                            f = u.alignItems,
                            M = void 0 === f ? (d ? 'flex-start' : g && 'center') || (p && 'flex-end') || void 0 : f,
                            S = u.alignSelf,
                            L = u.wrap,
                            T = u.flexWrap,
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, n, A, D, s, _, N, P, S, C, O, x, M]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return a().createElement('div', vu({ className: h()(gu.base, ...U, e), style: G }, I), k);
                    });
                var Mu = t(3532),
                    Su = t.n(Mu);
                const Lu = {
                ...
                const Ru = Object.keys(Su()),
                    ...
                    Iu = hu((u) => {
                        ...
                        return a().createElement(
                            ...
                            Ou(
                                {
                                    className: h()(Lu.base, t && Lu[t], p, n),
                                    style: g,
                                    mt: !0 === F ? Nu[t || 'paragraph-P16'].mt : F,
                                    mr: !0 === o ? Nu[t || 'paragraph-P16'].mr : o,
                                    mb: !0 === l ? Nu[t || 'paragraph-P16'].mb : l,
                                    ml: !0 === B ? Nu[t || 'paragraph-P16'].ml : B,
                                },
                                C,
                            ),
                ...
                const Uu = (u, e, t = {}, r = 0) => {
                    ...
                    $u = (0, r.memo)(({ count: u, type: e, mixClass: t }) => {
                        const n = h()(ju.base, Boolean(u) && ju.base__active, t),
                            E = h()(ju.icon, ju[`icon__${e}`]),
                            i = R.strings.hb_lobby.preBattle.orders,
                            A = (0, r.useMemo)(
                                () => ({
                                    contentId: R.views.historical_battles.lobby.tooltips.OrderTooltip('resId'),
                                    args: { orderType: e, showStatus: !0 },
                                }),
                                [e],
                            );
                        return a().createElement(
                ...
                const Vu = () => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(Iu, {
                                text: R.strings.hb_lobby.preBattle.orders.applyOrderHint(),
                    ...
                    zu = ({ mixClass: u }) => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(Iu, {
                                text: t,
                                className: h()('DivisionName_text_b4', e && 'DivisionName_text__scaled_b1'),
                            }),
                        );
                    },
                    Yu = ({ mixClass: u }) => {
                        const e = h()(u, 'OrderWarning_base_ac');
                        return a().createElement(
                            'div',
                            { className: e },
                            a().createElement(Iu, {
                                text: R.strings.hb_lobby.preBattle.orders.orderWarning(),
                                className: 'OrderWarning_text_67',
                            }),
                        );
                    },
                    qu = (0, r.memo)(() => {
                        const u = J('model.orders'),
                            ...
                            A = (0, r.useCallback)((u) => E({ isOver3dScene: u }), [E]);
                        return a().createElement(
                            'div',
                            ...
                            a().createElement(
                                ...
                                a().createElement(zu, { mixClass: 'PreBattleQueueApp_header_title_e8' }),
                                a().createElement(lu, null),
                                !e && a().createElement(Yu, { mixClass: 'PreBattleQueueApp_warning_20' }),
                                a().createElement('div', { className: 'PreBattleQueueApp_header_shadow_71' }),
                            ),
                            a().createElement(
                                'div',
                ...
                engine.whenReady.then(() => {
                    N().render(
                        a().createElement(H, null, a().createElement(qu, null)),
