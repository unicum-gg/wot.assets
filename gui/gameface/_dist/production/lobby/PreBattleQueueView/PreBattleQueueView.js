(() => {
    var __webpack_modules__ = {
            ...
            2163: (u, e, t) => {
                ...
                const D = E.O.client.getSize('rem'),
                    s = D.width,
                    l = D.height,
                    o = Object.assign({ width: s, height: l }, F(s, l, A)),
                    B = (0, r.createContext)(o),
                    C = ['children'],
                    c = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.mediumWidth && o) return n(e, t, w);
                ...
                const L = {
                    ...
                    O = (u) => {
                        ...
                        const E = (() => {
                            ...
                            i = E.mediaHeight,
                            F = E.mediaSize;
                        return a().createElement('div', x({ className: h()(t, L[A], S[i], M[F]) }, n), e);
                    },
                    T = ['children'],
                    y = (u) => {
                        let e = u.children,
                        ...
                        return (
                            d(() => {
                                if (
                                                    ...
                                                    const e = Y(),
                                                        ...
                                                        a =
                                                            window.__feature && window.__feature !== t && t
                                                                ? `subViews.${t}`
                                                                : '';
                                                    return { modelPrefix: a, modelPath: Z(a, ''), resId: r };
                                                })(),
                                                t = e.modelPrefix,
                                                r = u.split('.');
                                            if (r.length > 0) {
                                    ...
                                    l.current = Q.addCallback(r, t, A, e === J.Deep);
                                }
                            }),
                            (0, r.useEffect)(() => {
                                if (e !== J.None)
                                    return () => {
                                        Q.removeCallback(l.current, A);
                                    };
                            }, [A, e]),
                            D
                        );
                    },
                    eu = (j.Sw.instance, 'SceneWrapper_base_a5'),
                        ...
                        const E = (0, r.useState)(!1),
                            ...
                            o = (0, r.useCallback)(
                                (u) => {
                                    ...
                                    const t = u.clientX,
                                        r = u.clientY,
                                        a = t !== F.current ? t - F.current : 0,
                                        n = r !== D.current ? r - D.current : 0;
                                    ((F.current = t), (D.current = r), e({ dx: a, dy: n, dz: 0 }));
                                },
                                [l, A, F, D, e],
                            ),
                            B = (0, r.useCallback)(
                        ...
                        const c = (0, r.useCallback)(
                                (u) => {
                                    (u.preventDefault(),
                                        0 === u.button &&
                                            l(u) &&
                                            (i(!0), n && n(!0), (F.current = u.clientX), (D.current = u.clientY)));
                                },
                                [l, n],
                            ),
                            d = (0, r.useCallback)(() => {
                            ...
                            m = h()('SceneWrapper_grab_58', A && 'SceneWrapper_grab__down_ce');
                ...
                const Eu = ({
                    ...
                    const c = (0, r.useRef)(null),
                        ...
                        f = b[1],
                        x = (0, r.useCallback)(() => {
                            E || (c.current && (c.current.focus(), m(!0)));
                        }, [E]),
                        L = (0, r.useCallback)(
                            (u) => {
                        ...
                        H = h()(
                            ...
                            ru[`base__${n}`],
                            {
                                ...
                                [ru.base__firstHover]: p,
                            },
                            A,
                        ),
                        N = h()(ru.state, ru.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                ...
                Eu.defaultProps = { type: au.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Au = (0, r.memo)(Eu),
                    iu = ({ binding: u, text: e = '', classMix: t, alignment: n = N.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, E) =>
                                      a().createElement(
                                          'div',
                                          { className: h()('FormatText_base_d0', t), key: `${e}-${E}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                ...
                function su(u = Fu.n.NONE, e = Du, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Fu.n.NONE)
                            return (
                ...
                const lu = 'StatusWarning_border_99',
                    ou = 'StatusWarning_horizontalBorder_5e',
                    Bu = (0, r.memo)(({ children: u, classMix: e, isBanWarning: t }) => {
                        const r = h()(
                                'StatusWarning_base_bb',
                                t ? 'StatusWarning_base__banned_05' : 'StatusWarning_base__regular_cb',
                                e,
                            ),
                            n = h()(ou, 'StatusWarning_horizontalBorder__left_14');
                        return a().createElement(
                            'div',
                            { className: r },
                            !t && a().createElement('div', { className: lu }),
                            a().createElement(
                                'div',
                                { className: 'StatusWarning_contentWrapper_16' },
                                a().createElement('div', { className: n }),
                                a().createElement('div', { className: 'StatusWarning_content_c4' }, u),
                    ...
                    Cu = () => {
                        const u = uu('model'),
                            ...
                            t = u.selectedOrderId,
                            n = u.onExitBattle,
                            E = u.isQuitButtonDisabled,
                            A = (0, r.useContext)(B),
                            i = (0, r.useCallback)(() => n(), [n]);
                        su(Fu.n.ESCAPE, i);
                        const F = (0, r.useMemo)(
                                () => ({
                                    time: a().createElement('div', { className: 'BattleTimer_timerTime_f2' }, e),
                                }),
                                [e],
                            ),
                            D = Boolean(t);
                        return a().createElement(
                            'div',
                            { className: 'BattleTimer_base_19' },
                            a().createElement(
                                'div',
                                { className: 'BattleTimer_timer_76' },
                                a().createElement(iu, {
                                    classMix: 'BattleTimer_timerLabel_52',
                                    text: R.strings.hb_lobby.preBattle.timer(),
                                    binding: F,
                                }),
                            ),
                            a().createElement(
                                Au,
                                {
                                    type: au.primary,
                                    size: nu.medium,
                                    mixClass: 'BattleTimer_button_eb',
                                    onClick: i,
                                    disabled: E,
                                },
                                R.strings.hb_lobby.preBattle.exitButton(),
                            ),
                            !D &&
                                a().createElement(
                                    Bu,
                ...
                const _u = (u, e, t = {}, r = 0) => {
                    ...
                    mu = (u) => {
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            w = (0, r.useMemo)(() => _ || Y().resId, [_]),
                            b = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (_u(t, B, { isMouseEvent: !0, on: !0, arguments: du(a) }, w),
                                    m && m(),
                    ...
                    hu = {
                        base: 'Order_base_d2',
                        content: 'Order_content_21',
                        base__active: 'Order_base__active_7b',
                        ...
                        text: 'Order_text_0a',
                        checkIcon: 'Order_checkIcon_88',
                        spark: 'Order_spark_98',
                    },
                    gu = (0, r.memo)(({ count: u, type: e, isActive: t }) => {
                        const n = h()(hu.base, t && hu.base__active),
                            E = h()(hu.icon, hu[`icon__${e}`]),
                            A = (0, r.useMemo)(
                                () => ({
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: hu.count },
                                        P(R.strings.hb_lobby.hangar.itemCount(), { count: u }),
                                    ),
                                    a().createElement(
                                        'div',
                                        { className: hu.text },
                                        R.strings.hb_lobby.preBattle.orders.$dyn(e),
                                    ),
                                    t &&
                                        a().createElement(
                                            a().Fragment,
                                            null,
                                            a().createElement('div', { className: hu.checkIcon }),
                                            a().createElement('div', { className: hu.spark }),
                                        ),
                                ),
                            ),
                            t &&
                                a().createElement(
                                    'div',
                                    { className: hu.activated },
                                    R.strings.hb_lobby.preBattle.orders.autoActivate(),
                                ),
                        );
                    });
                function vu() {
                ...
                const wu = () => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: 'OrderPanel_header_a9' },
                                R.strings.hb_lobby.preBattle.orders.earnMoreHint(),
                            ),
                            a().createElement(
                                'div',
                                { className: 'OrderPanel_orders_3e' },
                                u.map(({ value: u }) => a().createElement(gu, vu({ key: u.id }, u))),
                            ),
                        );
                    },
                    bu = () => {
                        const u = uu('model', J.None),
                            e = u.selectedFrontmanRole,
                            t = u.selectedVehicleName,
                            n = (0, r.useMemo)(
                                () =>
                                    P(
                                        R.strings.hb_lobby.battleResults.playerInfo.$dyn(
                                            e ? 'roleAndVehicle' : 'vehicle',
                                        ),
                                        { vehicleName: t, role: R.strings.hb_lobby.role.$dyn(e) },
                                    ),
                                [e, t],
                            );
                        return a().createElement(
                            'div',
                            { className: 'RoleAndVehicleName_base_06' },
                            a().createElement('div', { className: 'RoleAndVehicleName_text_96' }, n),
                        );
                    },
                    pu = (0, r.memo)(() => {
                        const u = uu('model', J.None),
                            e = u.onMoveSpace,
                            t = u.onOverScene,
                            n = (0, r.useCallback)((u) => e(u), [e]),
                            E = (0, r.useCallback)((u) => t({ isOver3dScene: u }), [t]);
                        return a().createElement(
                            'div',
                            { className: 'PreBattleQueueApp_base_c3' },
                            a().createElement('div', { className: 'PreBattleQueueApp_vignette_f5' }),
                            a().createElement(
                                'div',
                                { className: 'PreBattleQueueApp_sceneWrapper_21' },
                                a().createElement(tu, { onMoveSpace: n, onOverSpace: E }),
                            ),
                            a().createElement(
                                'div',
                                { className: 'PreBattleQueueApp_header_f4' },
                ...
                engine.whenReady.then(() => {
                    H().render(
                        a().createElement(y, null, a().createElement(pu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(2163));
