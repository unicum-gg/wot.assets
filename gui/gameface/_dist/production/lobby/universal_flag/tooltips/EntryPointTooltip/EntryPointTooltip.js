(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, A) => {
                ...
                var t = {};
                A.r(t), A.d(t, { getBgUrl: () => l, getTextureUrl: () => c });
                var n = {};
                function D(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            358: (u, e, A) => {
                ...
                class F {
                    ...
                    addCallback(u, e, A = 0, F = !0) {
                        ...
                        const t = E.O.view.addModelObserver(u, A, F);
                        return (
                            t > 0
                                ? ((this._callbacks[t] = e),
                                  A > 0 && (this._views[A] ? this._views[A].push(t) : (this._views[A] = [t])))
            ...
            596: (u, e, A) => {
                ...
                function d(u, e, A, E, F, t, n) {
                    ...
                    D.done ? e(r) : Promise.resolve(r).then(E, F);
                }
                ...
                const g = F.instance,
                    f = {
                        ...
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            v(r.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
                        sendShowPopOverEvent: (u, e, A, E, F = R.invalid('resId'), t) => {
            ...
            694: (u, e, A) => {
                ...
                function i(u, e) {
                    ...
                    if (
                        ...
                        (A = (function (u, e) {
                            ...
                            if ('Arguments' === A || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(A)) return a(u, e);
                        })(u)) ||
                ...
                const s = ((u, e) => {
                        ...
                        return [
                            function ({ mode: t = 'real', options: n, children: D, mocks: a }) {
                                const s = (0, E.useRef)([]),
                                    c = (A, E, F) => {
                                        var t;
                                        const n = (function ({
                                                ...
                                                return {
                                                    subscribe: (A, t) => {
                                                        const D = 'string' == typeof t ? `${E}.${t}` : E,
                                                            r = B.O.view.addModelObserver(D, e, !0);
                                                        return F.set(r, A), u && A(n(t)), r;
                                                    },
                                                    readByPath: n,
                                                    createCallback: (u, e) => {
                                                        const A = n(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = i(F.keys()); !(u = A()).done; ) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(E),
                                            ...
                                            a = (u) =>
                                                'mocks' === A ? (null == F ? void 0 : F.getter(u)) : D.readByPath(u),
                                            ...
                                            d = { mode: A, model: l, externalModel: D, cleanup: c };
                                        return {
                                            model: l,
                                            controls: 'mocks' === A && F ? F.controls(d) : e(d),
                                            externalModel: D,
                                            mode: A,
                                        };
                                    },
                                    ...
                                    _ = d[0],
                                    m = d[1],
                                    v = (0, E.useState)(() => c(t, n, a)),
                                    w = v[0],
                                    h = v[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        l.current ? h(c(_, n, a)) : (l.current = !0);
                                    }, [a, _, n]),
                                    (0, E.useEffect)(() => {
                                        m(t);
                                    }, [t]),
                                    (0, E.useEffect)(
                                        () => () => {
                                            w.externalModel.dispose(), s.current.forEach((u) => u());
                                        },
                                        [w],
                                    ),
                                    F().createElement(A.Provider, { value: w }, D)
                                );
                            },
                            () => (0, E.useContext)(A),
                        ];
                    ...
                    l = s[1];
                var d = A(515);
                const _ = 'Content_base_78';
                var m = A(483),
                    v = A.n(m);
                const w = 'Separator_base_81',
                    h = () => F().createElement('div', { className: w }),
                    p = 'Header_base_6f',
                    g = 'Header_bg_30',
                    f = 'Header_title_0b',
                    b = 'Header_timerBlock_64',
                    y = 'Header_timerText_23',
                    O = 'Header_timerIcon_11',
                    T = 'Header_timerIcon__clock_7b',
                    M = 'Header_timerIcon__flag_12';
                let P;
                function x(u, e) {
                ...
                const k = (u, e, A) => {
                    ...
                    N = (u, e, A = P.left) => u.split(e).reduce(A === P.left ? k : S, []),
                    L = (() => {
                        const u = new RegExp(
                        ...
                        return U.includes(A)
                            ...
                            : ((u, e = P.left) => {
                                  ...
                                  const E =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return N(F, /( )/, e).forEach((u) => (A = A.concat(N(u, E, P.left)))), A;
                              })(u, e);
                    };
                let H;
                !(function (u) {
                                    ...
                                    const E = Date.now(),
                                        t = setInterval(
                                            () => {
                                                ...
                                                null !== A && e <= A ? (D(A), F && F(), clearInterval(t)) : D(e);
                                            },
                                            1e3 * (e || (u > 120 ? z : 1)),
                                        );
                                    return () => {
                ...
                const uu = 'FormatText_base_d0',
                    eu = ({ binding: u, text: e = '', classMix: A, alignment: t = P.left }) =>
                        null === e
                            ...
                            : F().createElement(
                                  ...
                                  e.split('\n').map((e, n) =>
                                      F().createElement(
                                          'div',
                                          { className: v()(uu, A), key: `${e}-${n}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : I(u, e))))(e, t, u).map((u, e) =>
                                              F().createElement(E.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              ),
                    Au = (u) => u.toString().padStart(2, '0'),
                    Eu = (u, e) => {
                        switch (e) {
                            case J.Description:
                                return ((u, e = !0) =>
                                    u.days > 7 && e
                                        ...
                                        : u.days >= 1
                                          ...
                                          : u.hours >= 1
                                            ...
                                            : x(R.strings.common.duration.minutes(), { minutes: u.minutes || 1 }))(u);
                            case J.Short:
                                return `${Au(u.minutes)}:${Au(u.seconds)}`;
                            case J.Long:
                                return `${Au(u.hours)}:${Au(u.minutes)}:${Au(u.seconds)}`;
                            case J.Extended:
                                return `${x(R.strings.common.duration.days(), { days: u.days })} | ${Au(u.hours)}:${Au(u.minutes)}:${Au(u.seconds)}`;
                        }
                    },
                    Fu = R.images.gui.maps.icons.components.countdown,
                    tu = (u, e) => {
                        const A = 2 === e ? Fu.big : Fu;
                        switch (u) {
                            case Q.Timer:
                                return A.clock();
                            case Q.Countdown:
                    ...
                    nu = (0, E.memo)(
                        ({
                            duration: u,
                            icon: e = Q.Timer,
                            style: A = J.Description,
                            onTimeReached: t,
                            className: n = '',
                            classNames: D = {},
                            labelFormat: r = '',
                        }) => {
                            const o = A !== J.Description ? 1 : void 0,
                                i = Y(u, o),
                                a = (() => {
                                    const u = (0, E.useState)(B.O.view.getScale()),
                                        e = u[0],
                                        A = u[1];
                                    return (
                                        (0, E.useEffect)(() => {
                            ...
                            const C = Eu(
                                (function (u = 0) {
                                    ...
                                    e -= A * K;
                                    const E = Math.trunc(e / j);
                                    e -= E * j;
                                    const F = Math.trunc(e / z);
                                    return (e -= F * z), { days: A, hours: E, minutes: F, seconds: e };
                                })(i),
                                A,
                            );
                            return F().createElement(
                                ...
                                e !== Q.None &&
                                    F().createElement('div', {
                                        className: v()(Z, D.icon),
                                        style: { backgroundImage: `url('${tu(e, a)}')` },
                                    }),
                                r
                                    ? F().createElement(
                                          'div',
                                          { className: v()(X, D.text) },
                                          F().createElement(eu, { text: r, binding: { timerText: C } }),
                                      )
                                    : F().createElement('div', { className: v()(X, D.text) }, C),
                            );
                        },
                    );
                let Du;
                !(function (u) {
                    (u.Clock = 'clock'), (u.Flag = 'flag'), (u.None = 'none');
                })(Du || (Du = {}));
                const ru = new Map([
                        [Du.Clock, T],
                        [Du.Flag, M],
                    ...
                    ou = R.strings.event.universalFlag,
                    Bu = ({
                        caption: u,
                        timerIconType: e,
                        timerText: A,
                        ...
                        const D = E - t,
                            r = ru.get(e),
                            o = R.images.gui.maps.icons.universalFlag.tooltip_header_bg(),
                            B = { '--tooltipBackground': n ? `url(${n})` : `url(${o})` };
                        return F().createElement(
                            F().Fragment,
                            null,
                            F().createElement(
                                'div',
                                { className: p },
                                F().createElement('div', { className: g, style: B }),
                                F().createElement(
                                    'div',
                                    null,
                                    F().createElement('div', { className: f }, u),
                                    F().createElement(
                                        'div',
                                        { className: b },
                                        e !== Du.None && F().createElement('div', { className: v()(O, r) }),
                                        0 !== E &&
                                            F().createElement(nu, {
                                                duration: D,
                                                labelFormat:
                            ...
                            F().createElement(h, null),
                        );
                        var i, a;
                    },
                    iu = 'Description_base_67',
                    au = ({ description: u }) => F().createElement('p', { className: iu }, u),
                    Cu = (0, d.Pi)(() => {
                        ...
                        return F().createElement(
                            ...
                            F().createElement(au, { description: E }),
                        );
                    });
                function su() {
                ...
                const _u = F().forwardRef(function (u, e) {
                        let A = u.children,
                            t = u.className,
                            n = u.theme,
                        ...
                        return (
                            ...
                            F().createElement(
                                'div',
                                du({}, r, {
                                    className: v()(cu.base, cu[`base__theme-${D}`], t),
                                    ref: function (u) {
                                        (i.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                    },
                                }),
                                F().createElement('div', { className: cu.decorator }, A),
                            )
                        );
                    }),
                    mu = () => F().createElement(_u, null, F().createElement(Cu, null));
                engine.whenReady.then(() => {
                    n().render(
                        F().createElement(c, null, F().createElement(mu, null)),
        ...
        (__webpack_require__.O = (u, e, A, E) => {
            if (!e) {
                ...
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, A, E] = deferred[r], t = !0, n = 0; n < e.length; n++)
                        (!1 & E || F >= E) &&
        ...
        (() => {
            ...
            var e = (e, A) => {
                    ...
                    for (e && e(A); r < t.length; r++)
                        (F = t[r]), __webpack_require__.o(u, F) && u[F] && u[F][0](), (u[F] = 0);
                    return __webpack_require__.O(o);
                },
                A = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            A.forEach(e.bind(null, 0)), (A.push = e.bind(null, A.push.bind(A)));
        })();
    var __webpack_exports__ = __webpack_require__.O(void 0, [936], () => __webpack_require__(694));
