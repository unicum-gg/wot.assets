(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, A) => {
                ...
                var F = {};
                (A.r(F), A.d(F, { getBgUrl: () => l, getTextureUrl: () => c }));
                var n = {};
                function D(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            596: (u, e, A) => {
                ...
                function d(u, e, A, E, t, F, n) {
                    ...
                    D.done ? e(r) : Promise.resolve(r).then(E, t);
                }
            ...
            780: (u, e, A) => {
                ...
                const s = t().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        n = u.theme,
                    ...
                    return (
                        ...
                        t().createElement(
                            'div',
                            C({}, s, {
                                className: r()(i.base, i[`base__theme-${D}`], F),
                                ref: function (u) {
                                    ((l.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            t().createElement('div', { className: i.decorator }, A),
                        )
                    );
                });
                var c = A(515);
                ...
                function m(u, e) {
                    ...
                    if (
                        ...
                        (A = (function (u, e) {
                            ...
                            if ('Arguments' === A || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(A)) return v(u, e);
                        })(u)) ||
                ...
                const w = ((u, e) => {
                        ...
                        return [
                            function ({ mode: F = 'real', options: n, children: D, mocks: r }) {
                                const B = (0, E.useRef)([]),
                                    i = (A, E, t) => {
                                        var F;
                                        const n = (function ({
                                                ...
                                                return {
                                                    subscribe: (A, F) => {
                                                        const D = 'string' == typeof F ? `${E}.${F}` : E,
                                                            r = o.O.view.addModelObserver(D, e, !0);
                                                        return (t.set(r, A), u && A(n(F)), r);
                                                    },
                                                    readByPath: n,
                                                    createCallback: (u, e) => {
                                                        const A = n(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = m(t.keys()); !(u = A()).done; ) F(u.value, e);
                                                    },
                                                    unsubscribe: F,
                                                };
                                            })(E),
                                            ...
                                            r = (u) =>
                                                'mocks' === A ? (null == t ? void 0 : t.getter(u)) : D.readByPath(u),
                                            i = (u) => B.current.push(u),
                                            a = u({
                                                mode: A,
                                                readByPath: r,
                                                externalModel: D,
                                            ...
                                            C = { mode: A, model: a, externalModel: D, cleanup: i };
                                        return {
                                            model: a,
                                    ...
                                    s = C[0],
                                    c = C[1],
                                    l = (0, E.useState)(() => i(F, n, r)),
                                    v = l[0],
                                    w = l[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        a.current ? w(i(s, n, r)) : (a.current = !0);
                                    }, [r, s, n]),
                                    (0, E.useEffect)(() => {
                                        c(F);
                                    }, [F]),
                                    (0, E.useEffect)(
                                        () => () => {
                                            (v.externalModel.dispose(), B.current.forEach((u) => u()));
                                        },
                                        [v],
                                    ),
                                    t().createElement(A.Provider, { value: v }, D)
                                );
                            },
                            () => (0, E.useContext)(A),
                        ];
                    ...
                    b = ({ description: u }) => t().createElement('p', { className: f }, u);
                let y, O, T;
                function M(u, e) {
                ...
                const P = (u, e, A) => {
                    ...
                    k = (u, e, A = T.left) => u.split(e).reduce(A === T.left ? P : x, []),
                    S = (() => {
                        const u = new RegExp(
                        ...
                        return N.includes(A)
                            ...
                            : ((u, e = T.left) => {
                                  ...
                                  const E =
                                      ...
                                      t = u.replace(/&nbsp;/g, ' ');
                                  return (k(t, /( )/, e).forEach((u) => (A = A.concat(k(u, E, T.left)))), A);
                              })(u, e);
                    },
                    U = 'FormatText_base_d0',
                    I = ({ binding: u, text: e = '', classMix: A, alignment: F = T.left }) =>
                        null === e
                            ...
                            : t().createElement(
                                  ...
                                  e.split('\n').map((e, n) =>
                                      t().createElement(
                                          'div',
                                          { className: r()(U, A), key: `${e}-${n}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : L(u, e))))(e, F, u).map((u, e) =>
                                              t().createElement(E.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              );
                                    ...
                                    const E = Date.now(),
                                        F = setInterval(
                                            () => {
                                                ...
                                                null !== A && e <= A ? (D(A), t && t(), clearInterval(F)) : D(e);
                                            },
                                            1e3 * (e || (u > 120 ? z : 1)),
                                        );
                                    return () => {
                ...
                const Y = q,
                    ...
                    J = (u, e, A = !1) => {
                        switch (e) {
                                        ...
                                        : u.days >= 1
                                          ...
                                          : u.hours >= 1
                                            ? 0 === u.minutes
                                                ...
                                                : `${M(R.strings.common.duration.hours(), { hours: u.hours })} ${M(A ? R.strings.common.duration.shortMinutes() : R.strings.common.duration.minutes(), { minutes: u.minutes })}`
                            ...
                            case O.Short:
                                return `${Q(u.minutes)}:${Q(u.seconds)}`;
                            case O.Long:
                                return `${Q(u.hours)}:${Q(u.minutes)}:${Q(u.seconds)}`;
                            case O.Extended:
                                return `${M(R.strings.common.duration.days(), { days: u.days })} | ${Q(u.hours)}:${Q(u.minutes)}:${Q(u.seconds)}`;
                        }
                    },
                    uu = R.images.gui.maps.icons.components.countdown,
                    eu = (u, e) => {
                        const A = 2 === e ? uu.big : uu;
                        switch (u) {
                            case y.Timer:
                                return A.clock();
                            case y.Countdown:
                    ...
                    Au = (0, E.memo)(
                        ({
                            ...
                            icon: A = y.Timer,
                            style: F = O.Description,
                            onTimeReached: n,
                            className: D = '',
                            classNames: B = {},
                            labelFormat: i = '',
                        }) => {
                            const a = F !== O.Description ? 1 : void 0,
                                C = Y(u, a),
                                s = (() => {
                                    const u = (0, E.useState)(o.O.view.getScale()),
                                        e = u[0],
                                        A = u[1];
                                    return (
                                        (0, E.useEffect)(() => {
                            ...
                            const c = J(
                                (function (u = 0) {
                                    ...
                                    return ((e -= t * z), { days: A, hours: E, minutes: t, seconds: e });
                                })(C),
                                F,
                                e,
                            );
                            return t().createElement(
                                ...
                                A !== y.None &&
                                    t().createElement('div', {
                                        className: r()(Z, B.icon),
                                        style: { backgroundImage: `url('${eu(A, s)}')` },
                                    }),
                                i
                                    ? t().createElement(
                                          'div',
                                          { className: r()(X, B.text) },
                                          t().createElement(I, { text: i, binding: { timerText: c } }),
                                      )
                                    : t().createElement('div', { className: r()(X, B.text) }, c),
                            );
                        },
                    );
                let Eu;
                ...
                const tu = 'Separator_base_81',
                    Fu = () => t().createElement('div', { className: tu }),
                    nu = 'Header_base_6f',
                    Du = 'Header_bg_30',
                    ru = 'Header_title_0b',
                    ou = 'Header_timerBlock_64',
                    Bu = 'Header_timerText_23',
                    iu = 'Header_timerIcon_11',
                    au = 'Header_timerIcon__clock_7b',
                    Cu = 'Header_timerIcon__flag_12',
                    su = new Map([
                        [Eu.Clock, au],
                        [Eu.Flag, Cu],
                        [Eu.None, ''],
                    ]),
                    cu = R.strings.event.universalFlag,
                    lu = ({
                        caption: u,
                        timerIconType: e,
                        timerText: A,
                        ...
                        const D = E - F,
                            o = su.get(e),
                            B = R.images.gui.maps.icons.universalFlag.tooltip_header_bg(),
                            i = { '--tooltipBackground': n ? `url(${n})` : `url(${B})` };
                        return t().createElement(
                            t().Fragment,
                            null,
                            t().createElement(
                                'div',
                                { className: nu },
                                t().createElement('div', { className: Du, style: i }),
                                t().createElement(
                                    'div',
                                    null,
                                    t().createElement('div', { className: ru }, u),
                                    t().createElement(
                                        'div',
                                        { className: ou },
                                        e !== Eu.None && t().createElement('div', { className: r()(iu, o) }),
                                        0 !== E &&
                                            t().createElement(Au, {
                                                duration: D,
                                                labelFormat:
                    ...
                    _u = (0, c.Pi)(() => {
                        ...
                        return t().createElement(
                            ...
                            t().createElement(b, { description: E }),
                        );
                    }),
                    mu = () => t().createElement(s, null, t().createElement(_u, null));
                engine.whenReady.then(() => {
                    n().render(
                        t().createElement(p, null, t().createElement(mu, null)),
        ...
        (__webpack_require__.O = (u, e, A, E) => {
            if (!e) {
                ...
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, A, E] = deferred[r], F = !0, n = 0; n < e.length; n++)
                        (!1 & E || t >= E) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [936], () => __webpack_require__(780));
