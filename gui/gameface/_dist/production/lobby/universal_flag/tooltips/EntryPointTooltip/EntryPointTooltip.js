    ...
    var __webpack_modules__ = {
            ...
            694: (u, e, A) => {
                ...
                const s = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            ...
                            F().createElement('div', { className: i.decorator }, A),
                        )
                    );
                });
                var c = A(515);
                        ...
                        return [
                            function ({ mode: t = 'real', options: n, children: D, mocks: r }) {
                                const B = (0, E.useRef)([]),
                                    i = (A, E, F) => {
                                        ...
                                        const n = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = m(F.keys()); !(u = A()).done;) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(E),
                                    ...
                                    s = C[0],
                                    c = C[1],
                                    l = (0, E.useState)(() => i(t, n, r)),
                                    v = l[0],
                                    h = l[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        a.current ? h(i(s, n, r)) : (a.current = !0);
                                    }, [r, s, n]),
                                    (0, E.useEffect)(() => {
                                        c(t);
                                    }, [t]),
                                    ...
                                    F().createElement(A.Provider, { value: v }, D)
                                );
                            },
                            () => (0, E.useContext)(A),
                        ];
                        ...
                        return N.includes(A)
                            ...
                            : ((u, e = T.left) => {
                                  ...
                                  const E =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return (k(F, /( )/, e).forEach((u) => (A = A.concat(k(u, E, T.left)))), A);
                              })(u, e);
                    };
                let U;
                !(function (u) {
                ...
                const q = j,
                    ...
                    X = ({ binding: u, text: e = '', classMix: A, alignment: t = T.left }) =>
                        null === e
                            ...
                            : F().createElement(
                                  ...
                                  e.split('\n').map((e, n) =>
                                      F().createElement(
                                          'div',
                                          { className: r()(Z, A), key: `${e}-${n}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : L(u, e))))(e, t, u).map((u, e) =>
                                    ...
                                    u.days > 7 && e
                                        ...
                                        : u.days >= 1
                                          ...
                                          : u.hours >= 1
                                            ...
                                            : M(R.strings.common.duration.minutes(), { minutes: u.minutes || 1 }))(u);
                            case O.Short:
                    ...
                    Au = (0, E.memo)(
                        ({
                            ...
                            const i = A !== O.Description ? 1 : void 0,
                                a = q(u, i),
                                C = (() => {
                            ...
                            const s = J(
                                (function (u = 0) {
                                    ...
                                    return ((e -= F * H), { days: A, hours: E, minutes: F, seconds: e });
                                })(a),
                                A,
                            );
                            return F().createElement(
                                ...
                                B
                                    ? F().createElement(
                                          'div',
                                          { className: r()($, D.text) },
                                          F().createElement(X, { text: B, binding: { timerText: s } }),
                                      )
                                    : F().createElement('div', { className: r()($, D.text) }, s),
                            );
                        },
                    );
                let Eu;
                ...
                const Fu = 'Separator_base_81',
                    tu = () => F().createElement('div', { className: Fu }),
                    nu = 'Header_base_6f',
                    Du = 'Header_bg_30',
                    ru = 'Header_title_0b',
                    ...
                    lu = ({
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                'div',
                                { className: nu },
                                F().createElement('div', { className: Du, style: i }),
                                F().createElement(
                                    'div',
                                    null,
                                    F().createElement('div', { className: ru }, u),
                                    F().createElement(
                                        'div',
                                        { className: ou },
                                        e !== Eu.None && F().createElement('div', { className: r()(iu, o) }),
                                        0 !== E &&
                                            F().createElement(Au, {
                                                duration: D,
                                                labelFormat:
                ...
                engine.whenReady.then(() => {
                    n().render(
                        F().createElement(p, null, F().createElement(mu, null)),
