(() => {
    ...
    var __webpack_modules__ = {
            67: (e, t, n) => {
                ...
                var i = {};
                (n.r(i), n.d(i, { getBgUrl: () => m, getTextureUrl: () => b }));
                var a = {};
                function s(e) {
                    return (t) => (
                        engine.on(e, t),
                ...
                const M = o.instance,
                    T = {
                        ...
                        sendShowContextMenuEvent: (e, t, n = 0) => {
                            g(l.CONTEXT_MENU, { isMouseEvent: !0, contentID: e, on: !0, decoratorID: n, args: t });
                        },
            ...
            196: (e, t, n) => {
                ...
                const v = ((e, t) => {
                        ...
                        return [
                            function ({ mode: i = 'real', options: a, children: u, mocks: v }) {
                                const w = (0, r.useRef)([]),
                                    b = (n, r, o) => {
                                        var i;
                                        const a = (function ({
                                            ...
                                            m = e({
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : v(e),
                                                            o = l.LO.box(r, { equals: s });
                                                        return (
                                                            'real' === n &&
                                                                u.subscribe(
                                                                    (0, l.aD)((e) => o.set(e)),
                                            ...
                                            h = { mode: n, model: m, externalModel: u, cleanup: b };
                                        return {
                                            model: m,
                                    ...
                                    p = h[0],
                                    E = h[1],
                                    g = (0, r.useState)(() => b(i, a, v)),
                                    f = g[0],
                                    O = g[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        m.current ? O(b(p, a, v)) : (m.current = !0);
                                    }, [v, p, a]),
                                    (0, r.useEffect)(() => {
                                        E(i);
                                    }, [i]),
                                    (0, r.useEffect)(
                                        () => () => {
                                            (f.externalModel.dispose(), w.current.forEach((e) => e()));
                                        },
                                        [f],
                                    ),
                                    o().createElement(n.Provider, { value: f }, u)
                                );
                            },
                            () => (0, r.useContext)(n),
                        ];
                    })(
                        ({ observableModel: e }) => ({ root: e.object(), background: e.object('background') }),
                        ({ externalModel: e }) => ({ openEvent: e.createCallbackNoArgs('openEvent') }),
                    ),
                    w = v[0],
                    b = v[1];
                var m = n(483),
                        ...
                        const T = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            k = (0, r.useCallback)(() => {
                                (T.current.isVisible && T.current.timeoutId) ||
                                    (f(n, w, { isMouseEvent: !0, on: !0, arguments: g(o) }, P),
                                    O && O(),
                                  ...
                                  Object.assign(
                                      {
                                          onMouseEnter:
                                              ...
                                              (e) => {
                                                  (e.clientX === window.innerWidth &&
                                                      ...
                                                      ((T.current.timeoutId = window.setTimeout(k, d ? 100 : 400)),
                                                      i && i(e),
                                                      C && C(e));
                                              }),
                                          onMouseLeave: ((e) => (t) => {
                                          ...
                                          onClick: ((e) => (t) => {
                                              (!1 === _ && A(), null == l || l(t), null == e || e(t));
                                          })(t.props.onClick),
                                          onMouseDown: ((e) => (t) => {
                                              (!1 === _ && A(), null == s || s(t), null == e || e(t));
                                          })(t.props.onMouseDown),
                                      },
                                      M,
                                  ),
                            ...
                            M(
                                {
                                    contentId:
                                        ...
                                        u ? T.SimpleTooltipHtmlContent('resId') : T.SimpleTooltipContent('resId')),
                ...
                !(function (e) {
                    ((e.Hidden = 'hidden'), (e.Shown = 'shown'), (e.Maintenance = 'maintenance'));
                })(k || (k = {}));
                var S = n(515);
                const C = {
                        base: 'Flag_base_97',
                        base__maintenance: 'Flag_base__maintenance_11',
                        base__not_started: 'Flag_base__not_started_41',
                        hover: 'Flag_hover_6e',
                        error: 'Flag_error_f3',
                        progress: 'Flag_progress_f3',
                    },
                    L = ({
                        state: e,
                        className: t,
                        ...
                        return o().createElement(
                            'div',
                            { className: h()(C.base, C[`base__${e}`], t), style: s },
                            o().createElement('div', { className: C.hover }),
                        );
                    },
                    D = {
                        base: 'App_base_11',
                        flag: 'App_flag_ab',
                        flag__hide: 'App_flag__hide_e6',
                        fadeOut: 'App_fadeOut_93',
                        flag__hideDelay: 'App_flag__hideDelay_f7',
                        fadeIn: 'App_fadeIn_eb',
                        fadeInWithScale: 'App_fadeInWithScale_de',
                        slideUp: 'App_slideUp_d8',
                        slideUpCenter: 'App_slideUpCenter_07',
                        blink: 'App_blink_a6',
                    },
                    I = R.strings.event.universalFlag,
                    N = (0, S.Pi)(() => {
                        const e = b(),
                            t = e.model,
                            n = e.controls,
                        ...
                        return (
                            ...
                            (m = o().createElement(
                                'div',
                                {
                                    className: D.base,
                                    onClick: () => {
                                        i !== k.Maintenance && i !== k.Hidden && (A('play'), n.openEvent());
                                    },
                                    onMouseEnter: () => {
                                        i !== k.Maintenance && i !== k.Hidden && A('highlight');
                                    },
                                },
                                o().createElement(L, {
                                    state: i,
                                    ...
                                    activeHoverImage: u,
                                    disabledImage: _,
                                    disabledHoverImage: v,
                                }),
                                l &&
                                    o().createElement(L, {
                                        state: a,
                                        className: h()(D.flag, D[`flag__${c}`]),
                                        activeImage: d,
                                        activeHoverImage: u,
                                        disabledImage: _,
                                        disabledHoverImage: v,
                            ...
                            w === k.Maintenance
                                ? o().createElement(P, { header: I.unavalibleHeader(), body: I.unavalibleText() }, m)
                                : o().createElement(
                                      O,
                                      { contentId: R.views.lobby.universal_flag.tooltips.EntryPointTooltip('resId') },
                                      m,
                                  )
                        );
                        var w, m;
                ...
                engine.whenReady.then(() => {
                    a().render(o().createElement(w, null, o().createElement(N, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [936], () => __webpack_require__(196));
