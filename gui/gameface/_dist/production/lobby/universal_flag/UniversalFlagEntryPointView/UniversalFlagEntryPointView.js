(() => {
    ...
    var __webpack_modules__ = {
            67: (e, t, n) => {
                ...
                const q = Object.keys(h).reduce((e, t) => ((e[t] = () => viewEnv.getShowingStatus() === h[t]), e), {}),
                    z = {
                        set: (e, t) => {
                ...
                const v = ((e, t) => {
                        ...
                        return [
                            function ({ mode: i = 'real', options: a, children: u, mocks: v }) {
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        m.current ? O(b(E, a, v)) : (m.current = !0);
                                    }, [v, E, a]),
                                    (0, r.useEffect)(() => {
                                        p(i);
                                    }, [i]),
