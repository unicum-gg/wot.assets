(() => {
    var __webpack_modules__ = {
            ...
            7689: (e, u, t) => {
                ...
                const c = i.O.client.getSize('rem'),
                    ...
                    h = (e) => {
                        ...
                        const r = (0, n.useContext)(F),
                            ...
                            f = { extraLarge: m, large: B, medium: C, small: g, extraSmall: p };
                ...
                const x = {
                    ...
                    O = (e) => {
                        ...
                        const a = v(),
                            ...
                            o = a.mediaHeight,
                            s = a.mediaSize;
                        return r().createElement('div', y({ className: B()(t, x[i], T[o], L[s]) }, n), u);
                    },
                    k = ['children'],
                    S = (e) => {
                        let u = e.children,
                        ...
                        return r().createElement(D, null, r().createElement(O, t, u));
                    };
                var M = t(493),
                    I = t.n(M);
                const H = {
                ...
                var N = t(7030);
                const P = { x: 0, y: 0, opacity: 0, transform: 'scale(1) rotate(0deg)' },
                ...
                const G = {
                        [j.Linear]: H.linear,
                        [j.EaseIn]: H.easeInCubic,
                        [j.EaseOut]: H.easeOutCubic,
                        [j.EaseInOut]: H.easeInOutCubic,
                        [j.EaseOutBack]: H.easeOutBack,
                        [j.EaseOutQuint]: (e) => 1 - Math.pow(1 - e, 5),
                        [j.EaseOutExpo]: (e) => (1 === e ? 1 : 1 - Math.pow(2, -10 * e)),
                    },
                    U = ({
                        children: e,
                        from: u = P,
                        ...
                        return (
                            (0, n.useEffect)(() => {
                                C.start({
                                    ...
                                    delay: l,
                                    immediate: i,
                                    config: a ? Object.assign({}, a) : { duration: s, easing: D },
                                    cancel: i || o,
                                    reverse: h,
                                    onRest: (e) => {
                                        !0 === e.finished && d && d();
                            ...
                            }, [C, l, s, D, u, i, d, t, F, o, h, A, a]),
                            r().createElement(N.animated.div, { className: _, style: g }, e)
                        );
                    };
                var $ = t(9916);
                const z = [
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (q(t, F, { isMouseEvent: !0, on: !0, arguments: V(r) }, f),
                                    B && B(),
                ...
                const ne = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    const a = u.contentId;
                    return a ? r().createElement(K, te({}, u, { contentId: a }), n) : r().createElement(Q, u, n);
                };
                var re = t(8045);
                const ae = {
                ...
                const ce = { [le.NBSP]: oe.NoBreakSymbol, [le.ZWNBSP]: oe.NoBreakSymbol, [le.NEW_LINE]: oe.LineBreak },
                    ...
                    _e = ({ elementList: e, textBlock: u, key: t }) => {
                        ...
                        return n
                            ? de[n]
                                ? r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': u.blockType, className: B()(Ae, de[n]) },
                                      e,
                                  )
                                : r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': u.blockType, className: Ae, style: Fe(n) },
                                      e,
                                  )
                    ...
                    Ce = Ee
                        ...
                        : (e, u) => {
                              ...
                              let a = 0;
                              for (; n; ) {
                                  const i = u.justifyContent === se.FlexEnd ? n.index : t.lastIndex;
                    ...
                    ge = (e, u = '', t) => {
                        ...
                        return (
                            me(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (e) => {
                                    n.push({ blockType: oe.Word, colorTag: u, childList: Ce(e, t) });
                                },
                                (e) => {
                                    const t = e[0],
                                        r = ce[t.charAt(0)];
                    ...
                    fe = (e, u) => {
                        ...
                        if (e.blockType === oe.NoBreakWrapper) (e.childList.push(n), t.push(e));
                        else {
                            const u = Object.assign({}, e, { childList: e.childList.splice(-1) });
                            (e.childList.length > 0 && t.push(e),
                                t.push({ blockType: oe.NoBreakWrapper, colorTag: '', childList: [u, n] }));
                        }
                    ...
                    Te = r().memo(
                        ({
                            ...
                            const A = (0, n.useRef)(null),
                                ...
                                h = _[0],
                                D = _[1],
                                m = (0, n.useMemo)(() => be(e, a, { justifyContent: c }), [a, c, e]),
                                C = (0, n.useMemo)(() => {
                                    if (
                                        i &&
                                        h.isTruncated &&
                            ...
                            return (
                                ...
                                r().createElement(
                                    ...
                                    r().createElement('div', { className: ae.unTruncated, ref: A }, m),
                                    r().createElement(
                                        ne,
                                        {
                                            tooltipArgs: C,
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: B()(
                                                    ae.truncated,
                                                    !h.isTruncateFinished && o && ae.truncated__hide,
                                                ),
                                                style: p,
                                            },
                                            h.isTruncateFinished && o ? h.elementList : m,
                                        ),
                                    ),
                                )
                            );
                ...
                const ke = ['type', 'shadow', 'grunge', 'className'];
                function Se() {
                    return (
                        (Se = Object.assign
                            ? Object.assign.bind()
                ...
                const Me = (e) => {
                    ...
                    return r().createElement(
                        ...
                        r().createElement(Te, Se({ classMix: B()(Le.layer0, n && Le.layer0__shadow) }, s)),
                        (u === Oe.Heading || u === Oe.MetaHeading) &&
                            r().createElement(
                                r().Fragment,
                                null,
                                r().createElement(Te, Se({ classMix: Le.layer1 }, s)),
                                r().createElement(Te, Se({ classMix: Le.layer2 }, s)),
                            ),
                        r().createElement(Te, Se({ classMix: Le.layer3 }, s)),
                        i && r().createElement(Te, Se({ classMix: Le.layer4 }, s)),
                    );
                };
                function Re(e) {
                    engine.call('PlaySound', e).catch((u) => {
                ...
                const Pe = ({
                    ...
                    return (
                        (0, n.useEffect)(() => {
                            function e(e) {
                                m && null !== h.current && !h.current.contains(e.target) && C(!1);
                            }
                            return (
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                'span',
                                { className: B()(Ie.state, Ie.state__default) },
                ...
                class $e extends r().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            A = B()(je.base, je[`base__${i}`], je[`base__${a}`], null == o ? void 0 : o.base),
                            F = B()(je.icon, je[`icon__${i}`], je[`icon__${a}`], null == o ? void 0 : o.icon),
                            _ = B()(je.glow, null == o ? void 0 : o.glow),
                            h = B()(je.caption, je[`caption__${i}`], null == o ? void 0 : o.caption),
                            D = B()(je.goto, null == o ? void 0 : o.goto);
                        return r().createElement(
                            'div',
                            Ue(
                                {
                ...
                function qe(e = ze.n.NONE, u = Ve, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (e !== ze.n.NONE)
                            return (
                    ...
                    Je = ((e, u) => {
                        ...
                        return [
                            function ({ mode: e = 'real', options: a, children: o, mocks: s }) {
                                ...
                                return (
                                    (0, n.useEffect)(() => {
                                        E.current ? D(c(A, a, s)) : (E.current = !0);
                                    }, [s, A, a]),
                                    (0, n.useEffect)(() => {
                                        F(e);
                                    }, [e]),
                ...
                const nu = {
                    ...
                    [tu.HEADER]: { from: { y: -5, opacity: 0 }, to: { y: 0, opacity: 1 }, delay: 1200, duration: 500 },
                    [tu.DESCRIPTION]: {
                        from: { y: -5, transform: 'translate(-50%)', opacity: 0 },
                        to: { y: 0, transform: 'translate(-50%)', opacity: 1 },
                        delay: 1400,
                ...
                const au = R.strings.halloween_lobby.difficultyWindow,
                    iu = (0, Ke.Pi)(() => {
                        const e = uu(),
                            u = e.model,
                            t = e.controls,
                            ...
                            i = v().mediaSize;
                        var o;
                        ((o = t.close), qe(ze.n.ESCAPE, o), qe(ze.n.ENTER, t.close), qe(ze.n.SPACE, t.close));
                        ...
                        return r().createElement(
                            'div',
                            {
                                className: 'DifficultyWindowApp_base_94',
                                onClick: () => {
                                    c(!0);
                                },
                            },
                            r().createElement($e, {
                                classNames: { base: 'DifficultyWindowApp_closeBtn_97' },
                            ...
                            r().createElement(
                                'div',
                                { className: 'DifficultyWindowApp_container_5d' },
                                r().createElement(
                                    U,
                                    ru({}, nu[tu.ICON], { isCanceled: l }),
                                    r().createElement(
                                        'div',
                                        { className: 'DifficultyWindowApp_containerIcon_a5' },
                                        r().createElement('div', { className: 'DifficultyWindowApp_decorSmoke_ad' }),
                                        r().createElement('div', {
                                            className: 'DifficultyWindowApp_icon_b1',
                                            style: {
                                                backgroundImage: `url('R.images.halloween.gui.maps.icons.difficulties.c_256x256.diff_${a}')`,
                                            },
                                        }),
                                        r().createElement(
                                            U,
                                            ru({}, nu[tu.TITLE], {
                                                className: 'DifficultyWindowApp_title_bb',
                                                isCanceled: l,
                                            }),
                                            au.title(),
                                        ),
                                ...
                                r().createElement(
                                    U,
                                    ru({}, nu[tu.HEADER], { isCanceled: l }),
                                    r().createElement(Me, {
                                        type: Oe.Heading,
                                        text:
                                            i === p.ExtraSmall
                                                ? au.headerShort.$dyn(`level_${a}`)
                                                : au.header.$dyn(`level_${a}`),
                                        justifyContent: se.Center,
                                        className: 'DifficultyWindowApp_textContainer_3c',
                                        shadow: !0,
                                    }),
                                ),
                                r().createElement(
                                    U,
                                    ru({}, nu[tu.DESCRIPTION], {
                                        className: 'DifficultyWindowApp_descriptionContainer_db',
                                        isCanceled: l,
                                    }),
                                    r().createElement(Te, {
                                        justifyContent: se.Center,
                                        ...
                                        isTooltipEnable: !0,
                                        classMix: 'DifficultyWindowApp_description_55',
                                        text: au.description.$dyn(`level_${a}`),
                                    }),
                                ),
                            ),
                            r().createElement(
                                U,
                                ru({}, nu[tu.BUTTON], { className: 'DifficultyWindowApp_button_54', isCanceled: l }),
                                r().createElement(
                                    We,
                                    { type: He.primary, size: Ne.medium, isFocused: !0, onClick: t.close },
                ...
                engine.whenReady.then(() => {
                    I().render(
                        r().createElement(S, null, r().createElement(eu, null, r().createElement(iu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(7689));
