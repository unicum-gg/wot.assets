(() => {
    ...
    var __webpack_modules__ = {
            294: (u, e, t) => {
                ...
                var F = {};
                (t.r(F), t.d(F, { getBgUrl: () => O, getTextureUrl: () => y }));
                var A = {};
                function i(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const v = {
                    ...
                    g = { play: Object.assign({}, m, { sound: c }), setRTPC: l },
                ...
                const Du = { view: A, client: E, sound: g, intl: h };
            },
            358: (u, e, t) => {
                t.d(e, { Z: () => F });
                var n = t(294);
                ...
                const b = {
                    ...
                    y = (u) => {
                        const e = ((u) => {
                            ...
                            n = e.month;
                        return (
                            (E = R.strings.event.craftMachine.endDateText()),
                            (F = { day: t, month: R.strings.menu.dateTime.months.$num(n + 1) }),
                            E.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                    ...
                    T = () => {
                        const u = h(),
                            ...
                            D = (0, n.useState)(f.Big),
                            s = D[0],
                            B = D[1],
                            C = r()(p.base, p[`base__${s}`]);
                        return (
                            (0, n.useEffect)(() => {
                                const u = (u) => {
                                    const e = b[`${u.width}*${u.height}`];
                                    e && B(e);
                                };
                                return (
                            ...
                            E().createElement(
                                ...
                                E().createElement('div', { className: p.bg }),
                                !i && E().createElement('div', { className: p.highlight }),
                                E().createElement('div', { className: p.stroke }),
                                i && E().createElement('div', { className: p.hoverEffect }),
                                E().createElement(
                                    'div',
                                    { className: p.content },
                                    E().createElement('div', { className: p.title }, O),
                                    E().createElement('div', { className: p.subtitle }, P),
                                    E().createElement(
                                        'div',
                                        { className: p.endDate },
                                        E().createElement('div', { className: p.timerIcon }),
                                        F,
                                    ),
                                ),
                            )
                    ...
                    k = () => E().createElement(T, null);
                engine.whenReady.then(() => {
                    A().render(E().createElement(k, null), document.getElementById('root'));
                });
            },
        },
