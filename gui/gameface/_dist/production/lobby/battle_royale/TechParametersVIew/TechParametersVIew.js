(() => {
    var __webpack_modules__ = {
            ...
            768: (u, e, t) => {
                ...
                var r = {};
                t.r(r),
                    t.d(r, { mouse: () => B, off: () => l, on: () => o, onResize: () => F, onScaleUpdated: () => D });
                var n = {};
                t.r(n),
                    t.d(n, {
                        events: () => r,
                ...
                var E = {};
                t.r(E), t.d(E, { getBgUrl: () => f, getTextureUrl: () => w });
                var a = {};
                function A(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const h = {
                    ...
                    g = Object.keys(_).reduce((u, e) => ((u[e] = () => c(_[e])), u), {}),
            ...
            872: (u, e, t) => {
                ...
                const D = a.O.client.getSize('rem'),
                    o = D.width,
                    l = D.height,
                    s = Object.assign({ width: o, height: l }, F(o, l, A)),
                ...
                const C = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && o) return E(e, t, w);
                        if (t.largeWidth && l) return E(e, t, w);
                        if (t.mediumWidth && s) return E(e, t, w);
                        if (t.smallWidth && C) return E(e, t, w);
                        if (t.extraSmallWidth && d) return E(e, t, w);
                        if (
                ...
                const d = (u) => {
                    ...
                    m = ({ children: u }) => {
                        ...
                        d(() => {
                            a.O.client.events.on('clientResized', D), a.O.client.events.on('self.onScaleUpdated', o);
                        }),
                            (0, r.useEffect)(
                                () => () => {
                        ...
                        const l = (0, r.useMemo)(() => Object.assign({}, E), [E]);
                ...
                const S = {
                    ...
                    T = (u) => {
                        ...
                        const E = b(),
                            ...
                            A = E.mediaHeight,
                            i = E.mediaSize;
                        return n().createElement('div', L({ className: _()(t, S[a], y[A], O[i]) }, r), e);
                    },
                    M = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                const q = ((u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: A, children: i, mocks: F }) {
                                const D = (0, r.useRef)([]),
                                    o = (t, r, n) => {
                                        var E;
                                        const A = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const i = 'string' == typeof E ? `${r}.${E}` : r,
                                                            F = a.O.view.addModelObserver(i, e, !0);
                                                        return n.set(F, t), u && t(A(E)), F;
                                                    },
                                                    readByPath: A,
                                                    createCallback: (u, e) => {
                                                        const t = A(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = U(n.keys()); !(u = t()).done; ) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(r),
                                            ...
                                            s = { mode: t, model: l, externalModel: i, cleanup: o };
                                        return {
                                            model: l,
                                    ...
                                    B = s[0],
                                    c = s[1],
                                    C = (0, r.useState)(() => o(E, A, F)),
                                    d = C[0],
                                    m = C[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? m(o(B, A, F)) : (l.current = !0);
                                    }, [F, B, A]),
                                    (0, r.useEffect)(() => {
                                        c(E);
                                    }, [E]),
                    ...
                    J = (0, W.Pi)(() => {
                        ...
                        return n().createElement(
                            'div',
                            {
                                className: X,
                                onClick: () => {
                                    a.O.sound.play.click(), u.openTechTreeWindow();
                                },
                                onMouseEnter: () => {
                                    a.O.sound.play.highlight();
                                },
                            },
                    ...
                    nu = ({ filledSectionWidth: u }) => {
                        ...
                        return n().createElement(
                            ...
                            u > 0 &&
                                n().createElement('div', { className: _()(tu, e && ru), style: { width: `${u}%` } }),
                        );
                    },
                    Eu = 'Parameter_base_c0',
                    au = 'Parameter_paramType_40',
                    Au = 'Parameter_iconContainer_93',
                    iu = 'Parameter_wrapper_b9',
                    Fu = 'Parameter_type_20',
                    Du = 'Parameter_text_db',
                    ou = 'Parameter_paramValuesContainer_e5',
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement('div', { className: Du }, su.$dyn(e)),
                                ),
                            ),
                            n().createElement(
                                'div',
                ...
                const _u = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    wu = (u, e, t = mu.left) => u.split(e).reduce(t === mu.left ? gu : vu, []),
                    fu = (() => {
                        const u = new RegExp(
                    ...
                    bu = (u, e = mu.left) => {
                        ...
                        return ((u, e = mu.left) => {
                            ...
                            const r =
                                ...
                                n = _u(u);
                            return wu(n, /( )/, e).forEach((u) => (t = t.concat(wu(u, r, mu.left)))), t;
                        })(u, e);
                    },
                    xu = 'FormatText_base_d0',
                    Lu = ({ binding: u, text: e = '', classMix: t, alignment: E = mu.left, formatWithBrackets: a }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const A = a && u ? hu(e, u) : e;
                        return n().createElement(
                            r.Fragment,
                            null,
                            A.split('\n').map((e, a) =>
                ...
                const Ou = (u, e, t = {}, r = 0) => {
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (Ou(t, B, { isMouseEvent: !0, on: !0, arguments: yu(n) }, w),
                                    h && h(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((v.current.timeoutId = window.setTimeout(f, D ? 100 : 400)),
                                                      E && E(u),
                                                      x && x(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                    ...
                    Mu = 'ShamrockBlock_base_11',
                    ku = 'ShamrockBlock_wrapper_db',
                    Ru = 'ShamrockBlock_header_63',
                    Pu = 'ShamrockBlock_link_65',
                    Hu = 'ShamrockBlock_currency_b9',
                    Iu = 'ShamrockBlock_value_9c',
                    Wu = 'ShamrockBlock_icon_79',
                    Nu = 'ShamrockBlock_shopIcon_b8',
                    Gu = (0, W.Pi)(() => {
                        const u = Y(),
                            e = u.model,
                            t = u.controls,
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    {
                                        className: ku,
                                        onClick: () => {
                                            a.O.sound.play.click(), t.openShop();
                                        },
                                    },
                                    n().createElement(
                                        'div',
                                        ...
                                        n().createElement(
                                            'div',
                                            { className: Pu },
                                            n().createElement(Lu, { text: R.strings.battle_royale.proxyPanel.store() }),
                                        ),
                                        n().createElement(
                                            'div',
                                            { className: Hu },
                    ...
                    ju = (0, W.Pi)(() => {
                        ...
                        return (
                            (i = () => {
                                a.O.view.setSidePaddingsRem({ left: 50, right: 0, top: 0, bottom: 0 });
                            }),
                            (0, r.useEffect)(i, []),
                            n().useLayoutEffect(() => {
                                const e = () => {
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    E.computes
                                        .vehicleCombatParams()
                                        .map((u, e) => n().createElement(Bu, { parameter: u, key: e })),
                                ),
                ...
                engine.whenReady.then(() => {
                    H().render(
                        n().createElement(K, null, n().createElement(k, null, n().createElement(ju, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [695], () => __webpack_require__(872));
