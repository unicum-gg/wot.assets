(() => {
    var __webpack_modules__ = {
            ...
            67: (u, e, t) => {
                ...
                var i = {};
                t.r(i), t.d(i, { getBgUrl: () => c, getTextureUrl: () => B });
                var n = {};
                function E(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            446: (u, e, t) => {
                ...
                const c = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && l) return i(e, t, v);
                ...
                const b = {
                    ...
                    O = (u) => {
                        ...
                        const i = x(),
                            ...
                            E = i.mediaHeight,
                            A = i.mediaSize;
                        return a().createElement('div', S({ className: h()(t, b[n], M[E], T[A]) }, r), e);
                    },
                    y = ['children'];
                const H = (u) => {
                    let e = u.children,
                ...
                const Z = {
                    ...
                    eu = (0, r.memo)(({ onClickHandler: u, onMouseEnterHandler: e }) =>
                        a().createElement(
                            'div',
                            { className: Q, onClick: u, onMouseEnter: e },
                    ...
                    iu = (0, r.memo)(({ modelPath: u }) => {
                        ...
                        return a().createElement(
                            'div',
                            { className: tu },
                            a().createElement('div', { className: au, style: t }),
                    ...
                    Fu = (0, r.memo)(({ title: u, model: e, handleResize: t }) => {
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: nu },
                                a().createElement('div', { className: Eu }, u),
                                a().createElement(
                                    'div',
                                    { className: Au },
                                    r.map(
                                        ({ value: u, id: t }, r) =>
                                            u && a().createElement(iu, { key: t, modelPath: `${e}.${r}` }),
                                    ),
                                ),
                            )
                        );
                    ...
                    ou = 'App_base_e7',
                    lu = 'App_delimiter_b8',
                    su = 'App_btnModules_f9';
                function Du(u, e, t, r, a, i, n) {
                    try {
                        var E = u[i](n),
                            A = E.value;
                    } catch (u) {
                ...
                const Bu = () => {
                    const u = Y(),
                        ...
                        l = (0, r.useCallback)(
                            du(function* () {
                                ...
                                const u = E.current;
                                u && o(viewEnv.pxToRem(u.offsetHeight));
                            }),
                            [o],
                        );
                    var s;
                    return (
                        (s = () => {
                            n.O.view.setSidePaddingsRem({ left: 50, right: 0, top: 0, bottom: 0 });
                        }),
                        (0, r.useEffect)(s, []),
                        (0, r.useEffect)(
                            () => (
                        ...
                        a().createElement(
                            ...
                            { className: ou, ref: E },
                            a().createElement(Fu, {
                                title: R.strings.battle_royale.vehicleFeatures.subTitle.force(),
                                model: 'model.vehicleGoodSpec',
                                handleResize: l,
                            }),
                            a().createElement('div', { className: lu }),
                            a().createElement(Fu, {
                                title: R.strings.battle_royale.vehicleFeatures.subTitle.weak(),
                                model: 'model.vehicleBadSpec',
                                handleResize: l,
                            }),
                            a().createElement(
                                'div',
                ...
                engine.whenReady.then(() => {
                    k().render(
                        a().createElement(H, null, a().createElement(Bu, null)),
