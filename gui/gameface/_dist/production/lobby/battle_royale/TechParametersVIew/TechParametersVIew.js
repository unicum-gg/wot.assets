(() => {
    var __webpack_modules__ = {
            ...
            768: (u, e, t) => {
                ...
                var r = {};
                t.r(r),
                    t.d(r, { mouse: () => c, off: () => l, on: () => D, onResize: () => F, onScaleUpdated: () => o });
                var n = {};
                t.r(n),
                    t.d(n, {
                        events: () => r,
                ...
                const h = {
                    ...
                    _ = Object.keys(g).reduce((u, e) => ((u[e] = () => B(g[e])), u), {}),
                    v = { play: Object.assign({}, _, { sound: B }), setRTPC: C };
                function w(u, e, t = 1) {
            ...
            997: (u, e, t) => {
                ...
                const o = E.O.client.getSize('rem'),
                    D = o.width,
                    l = o.height,
                    s = Object.assign({ width: D, height: l }, F(D, l, i)),
                ...
                const C = (u) => {
                    ...
                    const n = (0, r.useContext)(c),
                        ...
                        w = { extraLarge: m, large: h, medium: g, small: _, extraSmall: v };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && D) return a(e, t, w);
                        if (t.largeWidth && l) return a(e, t, w);
                        if (t.mediumWidth && s) return a(e, t, w);
                ...
                const d = (u) => {
                    ...
                    m = ({ children: u }) => {
                        ...
                        d(() => {
                            E.O.client.events.on('clientResized', o), E.O.client.events.on('self.onScaleUpdated', D);
                        }),
                            (0, r.useEffect)(
                                () => () => {
                                    E.O.client.events.off('clientResized', o),
                                        E.O.client.events.off('self.onScaleUpdated', D);
                                },
                                [o, D],
                            );
                ...
                const S = {
                    ...
                    T = (u) => {
                        ...
                        const a = b(),
                            ...
                            i = a.mediaHeight,
                            A = a.mediaSize;
                        return n().createElement('div', L({ className: g()(t, S[E], y[i], O[A]) }, r), e);
                    },
                    M = ['children'];
                const k = (u) => {
                    let e = u.children,
                    ...
                    return n().createElement(m, null, n().createElement(T, t, e));
                };
                var P = t(533),
                    H = t.n(P);
                function I() {
                                ...
                                const o = (0, r.useRef)([]),
                                    D = (t, r, n) => {
                                        ...
                                        const i = (function ({
                                            ...
                                            s = { mode: t, model: l, externalModel: A, cleanup: D };
                                        return {
                                            model: l,
                                    ...
                                    c = s[0],
                                    B = s[1],
                                    C = (0, r.useState)(() => D(a, i, F)),
                                    d = C[0],
                                    m = C[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? m(D(c, i, F)) : (l.current = !0);
                                    }, [F, c, i]),
                                    (0, r.useEffect)(() => {
                                        B(a);
                                    }, [a]),
                        ...
                        ({ observableModel: u }) => {
                            const e = { root: u.object() },
                                t = (0, $.Om)(() => {
                                    ...
                                    return Object.entries(t).map(([u, e]) => {
                                        return {
                                            type: u,
                                            sectionValues:
                                                ((t = e),
                                                Array.from(
                                                    { length: 5 },
                                                    (u, e) => (Math.max(0, Math.min(20, t - 20 * e)) / 20) * 100,
                                                )),
                                        };
                                        var t;
                                    });
                                });
                            return Object.assign({}, e, { computes: { vehicleCombatParams: t } });
                        },
                        ({ externalModel: u }) => ({
                            openTechTreeWindow: u.createCallbackNoArgs('onClick'),
                            updateViewHeight: u.createCallback((u) => ({ height: u }), 'onResized'),
                            openShop: u.createCallbackNoArgs('onOpenShop'),
                        }),
                    ),
                    K = q[0],
                    Y = q[1],
                    ...
                    J = (0, W.Pi)(() => {
                        ...
                        return n().createElement(
                            'div',
                            {
                                className: X,
                                onClick: () => {
                                    E.O.sound.play.click(), u.openTechTreeWindow();
                                },
                                onMouseEnter: () => {
                                    E.O.sound.play.highlight();
                                },
                            },
                            n().createElement('div', { className: Z }),
                            n().createElement('div', { className: Q }, R.strings.battle_royale.button.modules()),
                        );
                    }),
                    uu = 'Section_base_bd',
                    eu = 'Section_defaultSection_8c',
                    tu = 'Section_filledSection_7e',
                    ru = 'Section_filledSection__fullSection_09',
                    nu = ({ filledSectionWidth: u }) => {
                        const e = u % 100 == 0;
                        return n().createElement(
                            'div',
                            { className: uu, style: { width: '20%' } },
                            n().createElement('div', { className: eu }),
                            u > 0 &&
                                n().createElement('div', { className: g()(tu, e && ru), style: { width: `${u}%` } }),
                        );
                    },
                    au = 'Parameter_base_c0',
                    Eu = 'Parameter_paramType_40',
                    iu = 'Parameter_iconContainer_93',
                    Au = 'Parameter_wrapper_b9',
                    Fu = 'Parameter_type_20',
                    ou = 'Parameter_text_db',
                    Du = 'Parameter_paramValuesContainer_e5',
                    lu = R.images.gui.maps.icons.battleRoyale.techParams,
                    su = R.strings.battle_royale.techParams.type,
                    cu = ({ parameter: u }) => {
                        const e = u.type,
                            t = u.sectionValues;
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement('div', { className: ou }, su.$dyn(e)),
                                ),
                            ),
                            n().createElement(
                                'div',
                                { className: Du },
                                t.map((u, e) => n().createElement(nu, { filledSectionWidth: u, key: e })),
                            ),
                        );
                    },
                    Bu = 33,
                        ...
                        return (
                            (0, r.useEffect)(() => {
                                ...
                                switch (d) {
                                                ...
                                                r = window.setInterval(() => {
                                                    ...
                                                    a
                                                        ? (null == i || i(n, a),
                                                          ...
                                                          n === s &&
                                                              (null == h || h(),
                                                              B || (null == m || m(), window.clearInterval(r))))
                                                        : console.error(
                                    ...
                                    case 'stop':
                                        return (function () {
                                            const u = 0 === D && g ? { path: g, x: 0, y: 0 } : a(D),
                                                e = new Image();
                                            e.src = u.path;
                                            const r = () => t(wu(u, e));
                                            return (
                            ...
                            n().createElement('canvas', gu({}, _, { width: e, height: t, ref: v }))
                        );
                    }),
                    vu = (u, e) => {
                        let t = u;
                ...
                const yu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Mu = (u, e, t = Lu.left) => u.split(e).reduce(t === Lu.left ? Ou : Tu, []),
                    ku = (() => {
                        const u = new RegExp(
                    ...
                    Pu = (u, e = Lu.left) => {
                        ...
                        return ((u, e = Lu.left) => {
                            ...
                            const r =
                                ...
                                n = yu(u);
                            return Mu(n, /( )/, e).forEach((u) => (t = t.concat(Mu(u, r, Lu.left)))), t;
                        })(u, e);
                    },
                    Hu = 'FormatText_base_d0',
                    Iu = ({ binding: u, text: e = '', classMix: t, alignment: a = Lu.left, formatWithBrackets: E }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const i = E && u ? Su(e, u) : e;
                        return n().createElement(
                            r.Fragment,
                            null,
                            i.split('\n').map((e, E) =>
                                n().createElement(
                                    'div',
                                    { className: g()(Hu, t), key: `${e}-${E}` },
                                    ((u, e, t) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : Pu(u, e))))(
                                        e,
                                        a,
                                        u,
                ...
                const Gu = (u, e, t = {}, r = 0) => {
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (Gu(t, c, { isMouseEvent: !0, on: !0, arguments: Nu(n) }, w),
                                    h && h(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((v.current.timeoutId = window.setTimeout(f, o ? 100 : 400)),
                                                      a && a(u),
                                                      x && x(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                    ...
                    Vu = 'ShamrockBlock_base_11',
                    ju = 'ShamrockBlock_wrapper_db',
                    $u = 'ShamrockBlock_header_63',
                    zu = 'ShamrockBlock_link_65',
                    qu = 'ShamrockBlock_currency_b9',
                    Ku = 'ShamrockBlock_value_9c',
                    Yu = 'ShamrockBlock_icon_79',
                    Xu = 'ShamrockBlock_shopIcon_b8',
                    Zu = 'ShamrockBlock_particles_d8',
                    Qu = {
                        width: 160,
                        height: 120,
                        frameCount: 191,
                        chunk: { count: 1, rows: 15, columns: 13 },
                        getChunkPath: () => 'R.images.gui.maps.icons.battleRoyale.banner.sparcles_sequence',
                    },
                    Ju = (function (u) {
                        const e = u.chunk,
                            t = e.rows * e.columns;
                        return (r) => {
                            const n = r % t,
                                ...
                                E = Math.trunc(n / e.columns) * u.height;
                            return { path: u.getChunkPath(Math.trunc(r / t)), x: a, y: E };
                        };
                    })(Qu),
                    ue = (0, W.Pi)(() => {
                        const u = Y(),
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                Uu,
                                {
                                    contentId: R.views.battle_royale.lobby.tooltips.ShopTooltipView('resId'),
                                    ignoreShowDelay: !0,
                                },
                                n().createElement(
                                    'div',
                                    {
                                        className: ju,
                                        onClick: () => {
                                            E.O.sound.play.click(), t.openShop();
                                        },
                                    },
                                    n().createElement(
                                        'div',
                                        ...
                                        n().createElement(
                                            'div',
                                            { className: zu },
                                            n().createElement(Iu, { text: R.strings.battle_royale.proxyPanel.store() }),
                                        ),
                                        n().createElement(
                                            'div',
                                            { className: qu },
                    ...
                    re = (0, W.Pi)(() => {
                        ...
                        return (
                            (A = () => {
                                E.O.view.setSidePaddingsRem({ left: 50, right: 0, top: 0, bottom: 0 });
                            }),
                            (0, r.useEffect)(A, []),
                            n().useLayoutEffect(() => {
                                const e = () => {
                                    i.run(() => {
                                        const e = u.current;
                                        e && t.updateViewHeight(viewEnv.pxToRem(e.offsetHeight));
                                    });
                                };
                                return (
                                    e(),
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    a.computes
                                        .vehicleCombatParams()
                                        .map((u, e) => n().createElement(cu, { parameter: u, key: e })),
                                ),
                ...
                engine.whenReady.then(() => {
                    H().render(
                        n().createElement(K, null, n().createElement(k, null, n().createElement(re, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [695], () => __webpack_require__(997));
