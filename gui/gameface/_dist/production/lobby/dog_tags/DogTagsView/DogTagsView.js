(() => {
    var __webpack_modules__ = {
            380: (e) => {
                        ...
                        (a.contains(e.scrollbarXRail) ||
                            ...
                            e.scrollbarXActive
                                ...
                                : (a.classList.remove(c.active('x')),
                                  ...
                                  (a.scrollLeft = 0)),
                            e.scrollbarYActive
                                ? (a.classList.add(c.active('y')), v(e, 'top', a.scrollTop - e.lastScrollTop, !0, t))
                ...
                function L(e, t, u) {
                    var n = u[0],
                        ...
                        F = null;
                    function b(u) {
                        ((g[l] = p(A + F * (u[a] - h))), E(e, d), C(e, !1, t), u.stopPropagation(), u.preventDefault());
                    }
                    function D() {
                        (_(e, d), e[m].classList.remove(c.clicking), e.event.unbind(e.ownerDocument, 'mousemove', b));
                    }
                ...
                function o(e) {
                    ...
                    for (const u in e)
                        if (Object.prototype.hasOwnProperty.call(e, u)) {
                            ...
                            } else n.startsWith('[object class BW::WULF::ViewModel') ? (t[u] = o(e[u])) : (t[u] = e[u]);
                        }
                    return t;
                }
                const i = {
                ...
                const B = r.instance,
                    w = {
                        ...
                        sendShowContextMenuEvent: (e, t, u = 0) => {
                            D(l.CONTEXT_MENU, { isMouseEvent: !0, contentID: e, on: !0, decoratorID: u, args: t });
                        },
            ...
            978: (e, t, u) => {
                ...
                d.defaultProps = { type: l.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const m = (0, o.memo)(d),
                    E = {
                ...
                const Se = R.images.gui.maps.icons.dogtags,
                    ...
                    xe = (0, o.memo)((e) => {
                        const t = e.selected,
                            ...
                            h = s.isNew;
                        let p = null;
                        d ? (p = t ? Se.icons.alert() : Se.icons.lock()) : u && (p = Se.icons.equipped_slot_icon());
                        const F = p ? ce(p) : {},
                            b = m,
                            D = q(l, c, A, b, 'small'),
                            v = D.image,
                        ...
                        return i().createElement(
                            ...
                            h && i().createElement('div', { className: we }, i().createElement(ie, { isEmpty: !0 })),
                        );
                    }),
                    Le = [
                        'children',
                ...
                const st = (e) => {
                    ...
                    lt = ({ children: e, component: t, props: u = {} }) => (t ? i().createElement(t, u, e) : e || null),
                    ct = 'Tab_base_dd',
                    ...
                    vt = 'Tab_counter_e1',
                    Ct = ['isActive', 'isFirst', 'isLast', 'isMedium', 'isNotified', 'children', 'wrapper', 'counter'];
                function ft() {
                    return (
                        (ft =
                            Object.assign ||
                ...
                const Bt = (0, o.memo)((e) => {
                    ...
                    It = (e, t) => {
                        ...
                        if (!(n in e))
                            return (
                                console.warn(`Key "${n}" was not found in reference "${JSON.stringify(e, null, 2)}".`),
                                !1
                            );
                        const r = u.slice(1);
                ...
                const pn = {
                    ...
                    Dn = _n((e) => {
                        let t = e.className,
                            ...
                            w =
                                void 0 === B
                                    ...
                                    : B,
                            y = e.alignItems,
                            S = void 0 === y ? (b ? 'flex-start' : D && 'center') || (v && 'flex-end') || void 0 : y,
                            k = e.alignSelf,
                            x = e.wrap,
                            L = e.flexWrap,
                        ...
                        return i().createElement('div', hn({ className: r()(gn.base, ...Y, t), style: X }, H), P);
                    });
                let vn;
                !(function (e) {
                ...
                const Nn = {
                    ...
                    Rn = ['text', 'variant', 'className', 'color', 'm', 'mt', 'mr', 'mb', 'ml', 'style', 'format'];
                function Mn() {
                    return (
                        (Mn =
                            Object.assign ||
                ...
                const tr = 'ProgressBarDeltaGrow_base_7e',
                    ur = 'ProgressBarDeltaGrow_base__withoutBounce_b5',
                    nr = 'ProgressBarDeltaGrow_glow_68',
                    rr = (e) => (e ? { left: 0 } : { right: 0 }),
                    ar = (e, t) => (e ? { right: 100 - t + '%' } : { left: `${t}%` }),
                    ...
                    ir = (0, o.memo)(
                        ({
                            ...
                            const C = (0, o.useMemo)(() => Object.assign({ width: '100%' }, or(e), rr(m)), [m, e]),
                                f = (0, o.useMemo)(() => Object.assign({ width: '0%' }, or(e), rr(m)), [m, e]),
                                B = (0, o.useMemo)(() => Object.assign({ width: '0%' }, ar(m, n), or(e)), [n, m, e]),
                                w = (0, o.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(s - n)}%` }, ar(m, n), or(e)),
                                    [n, m, s, e],
                                );
                            if (A) return null;
                            const y = r()(tr, d, m && 0 === s && ur);
                            return i().createElement(
                                'div',
                                { style: h ? B : w, className: y },
                                i().createElement(
                                    'div',
                                    { style: F ? f : C, className: nr },
                    ...
                    lr = 'ProgressBarDeltaSimple_base_6c',
                    cr = 'ProgressBarDeltaSimple_delta_99',
                    dr = (0, o.memo)(
                        ({
                            transitionDuration: e,
                            transitionDelay: t,
                            ...
                            return g
                                ...
                                : i().createElement(
                                      'div',
                                      { className: lr, style: b },
                                      i().createElement(
                                          'div',
                                          { style: A ? p : F, className: cr },
                ...
                const gr = (0, o.memo)((e) => {
                        ...
                        switch (n.animationSettings.type) {
                            case Un.Simple:
                                return i().createElement(mr, _r({}, n, { onEndAnimation: l, isComplete: a }));
                            case Un.Growing:
                                return i().createElement(sr, _r({}, n, { onEndAnimation: l, isComplete: a }));
                            default:
                                return null;
                        }
                    }),
                    Ar = ({ size: e, value: t, lineRef: u, disabled: n, onComplete: r }) => {
                        ...
                        return (
                            ...
                            i().createElement(Qn, { size: e, disabled: n, baseStyles: a, isComplete: s, lineRef: u })
                        );
                    },
                    hr = ['onEndAnimation'];
                function pr() {
                ...
                const Fr = (0, o.memo)((e) => {
                    ...
                    return (
                        (n.current.from = a),
                        i().createElement(gr, pr({}, u, { onEndAnimation: r, key: `${a}-${u.to}`, from: a }))
                    );
                });
                function br() {
                    return (
                ...
                const Dr = (0, o.memo)(
                        ({
                            ...
                            return a.withStack
                                ...
                                : i().createElement(gr, br({ key: `${r}-${t}` }, c));
                        },
                    ),
                    vr = (e) => ({
                    ...
                    Mr = (0, o.memo)(({ infoTitle: e, infoText: t, isLocked: u, unlockText: n, currentProgress: r }) =>
                        i().createElement(
                            'div',
                            { className: _u },
                            i().createElement(jn, { className: gu, text: e }),
                            i().createElement(jn, { className: Bu, text: t }),
                            i().createElement(jn, { className: Gu, text: ne(r) }),
                            u &&
                                i().createElement(
                                    i().Fragment,
                                    null,
