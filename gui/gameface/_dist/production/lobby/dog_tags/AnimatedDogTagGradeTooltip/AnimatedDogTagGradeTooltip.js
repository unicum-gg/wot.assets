        ...
        A = {
            9971: (u, A, F) => {
                ...
                const f = {
                    ...
                    w = { play: Object.assign({}, b, { sound: d }), setRTPC: g };
                function h(u, A, F = 1) {
                ...
                const au = nu().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        nu().createElement(
                            ...
                            nu().createElement('div', { className: ru.decorator }, F),
                        )
                    );
                });
                var su = F(493),
                ...
                const vu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    pu = (u, A, F = du.left) => u.split(A).reduce(F === du.left ? mu : fu, []),
                    bu = (() => {
                        const u = new RegExp(
                    ...
                    xu = ({ binding: u, text: A = '', classMix: F, alignment: E = du.left, formatWithBrackets: e }) => {
                        ...
                        return nu().createElement(
                            ...
                            D.split('\n').map((A, e) =>
                                nu().createElement(
                                    'div',
                                    { className: n()(yu, F), key: `${A}-${e}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : hu(u, A))))(
                                        A,
                                        E,
                                        u,
                                    ).map((u, A) => nu().createElement(Cu.Fragment, { key: `${A}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                ...
                const ku = ({ background: u, engraving: A, size: F = zu.Big, grade: E = 0, className: e }) => {
                ...
                const Gu = ((u, A) => {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            n = Bu.view.addModelObserver(C, A, !0);
                    ...
                    Ju = (0, _u.Pi)(() => {
                        ...
                        return nu().createElement(
                            'div',
                            { className: Hu },
                            nu().createElement('div', { className: Uu }, D.$dyn('title')),
                            nu().createElement(
                                'div',
                                { className: Wu },
                                R.strings.dogtags.animatedCustomization.subtitle(),
                            ),
                            nu().createElement(ku, { background: F, engraving: A, className: Qu }),
                            nu().createElement(xu, {
                ...
                engine.whenReady.then(() => {
                    cu().render(
                        nu().createElement(Vu, null, nu().createElement(au, null, nu().createElement(Ju, null))),
