        ...
        A = {
            238: (u, A, F) => {
                ...
                const o = t('clientResized'),
                    ...
                    c = { down: t('mousedown'), up: t('mouseup'), move: t('mousemove') };
                const l = (function () {
                ...
                const f = {
                    ...
                    h = { play: Object.assign({}, b, { sound: d }), setRTPC: g },
                ...
                const eu = (() => {
                    ...
                    Du = x,
                    Bu = Object.keys(P).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === P[A]), u), {}),
                    Cu = {
                        set: (u, A) => {
                ...
                const lu = ou().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                ...
                const pu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    wu = (u, A, F = mu.left) => u.split(A).reduce(F === mu.left ? bu : hu, []),
                    yu = (() => {
                        const u = new RegExp(
                    ...
                    _u = (u, A = mu.left) => {
                        ...
                        return ((u, A = mu.left) => {
                            ...
                            const E =
                                ...
                                e = pu(u);
                            return wu(e, /( )/, A).forEach((u) => (F = F.concat(wu(u, E, mu.left)))), F;
                        })(u, A);
                    },
                    Ru = 'FormatText_base_d0',
                    Tu = ({ binding: u, text: A = '', classMix: F, alignment: E = mu.left, formatWithBrackets: e }) => {
                ...
                var Pu = F(403);
                const Ou = 'DogTag_base_2b',
                    Su = 'DogTag_engraving_eb',
                ...
                const $u = ({ background: u, engraving: A, size: F = Mu.Big, grade: E = 0, className: e }) => {
                    const D = ju.includes(ku) ? `_${ku}` : '';
                    return ou().createElement(
                        'div',
                        { className: n()(Ou, e) },
                ...
                const qu = ((u, A) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: e, children: D, mocks: B }) {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            n = tu.view.addModelObserver(C, A, !0);
                                ...
                                return (
                                    (0, ru.useEffect)(() => {
                                        t.current ? c(n(o, e, B)) : (t.current = !0);
                                    }, [B, o, e]),
                                    (0, ru.useEffect)(() => {
                                        i(E);
                                    }, [E]),
                    ...
                    Yu = (0, Pu.Pi)(() => {
                        ...
                        return ou().createElement(
                            'div',
                            { className: Qu },
                            ou().createElement('div', { className: Xu }, D.$dyn('title')),
                            ou().createElement(
                                'div',
                                { className: Zu },
                                R.strings.dogtags.animatedCustomization.subtitle(),
                            ),
                            ou().createElement($u, { background: F, engraving: A, className: Ju }),
                            ou().createElement(Tu, {
                ...
                engine.whenReady.then(() => {
                    gu().render(
                        ou().createElement(Hu, null, ou().createElement(lu, null, ou().createElement(Yu, null))),
