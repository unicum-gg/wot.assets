            ...
            608: (u, e, t) => {
                ...
                const $ = (u) => {
                    ...
                    return a().createElement(
                        'div',
                        H({}, o, { style: Object.assign({ marginTop: `${n}rem`, marginBottom: `${i}rem` }, o.style) }),
                        e,
                    );
                };
                var W = t(41),
                ...
                const eu = ((u, e) => {
                    ...
                    ru = ['value', 'isEmpty', 'className', 'size', 'fadeInAnimation', 'hide', 'maximumNumber'];
                function iu() {
                    return (
                        (iu = Object.assign
                            ? Object.assign.bind()
                ...
                const Bu = ({ background: u, engraving: e, size: t = Cu.Big, grade: n = 0, className: r }) => {
                ...
                const wu = 'metrics',
                    ...
                    Su =
                        ...
                        () => {
                            ...
                            return (e) => {
                                u({ action: fu.Click, parentScreen: hu.AnimatedDogTag, item: vu.SliderItem, info: e });
                            };
                        }),
                    Tu = 'Card_base_d29ef',
                        ...
                        return (
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    (E || A) && a().createElement(Pu, { type: A ? Iu.Lock : Iu.Check, className: Mu }),
                                    m &&
                                        a().createElement(
                                            'div',
                                            { className: Ru },
                ...
                const xe = { duration: 500, easing: ju.easeOutBack },
                    ...
                    Se = { [we.ExtraSmall]: 'small', [we.Small]: 'big', [we.Medium]: 'big', [we.Large]: 's500x300' },
                    Te = {
                ...
                const et = (u, e) => window.getComputedStyle(u, null).getPropertyValue(e),
                    ...
                    nt = (u) => {
                        ...
                        return nt(n <= 1 ? Object.assign({}, u, { start: e }) : Object.assign({}, u, { end: e }));
                    },
                ...
                const Et = (0, n.forwardRef)(function (u, e) {
                    ...
                    const E = (0, n.useRef)(null),
                        ...
                        w = (0, n.useCallback)(() => (A.current ? A.current.getBoundingClientRect().height : 0), []),
                        x = (0, n.useCallback)(
                            (u) => {
                                const e = w();
                        ...
                        y = (0, n.useCallback)(() => {
                            ...
                            const u = Ju(t, l) || [],
                                e = Array.from(new Array(r)).reduce((e, t, n) => {
                                    ...
                                    const o = nt({ start: 0, end: i.length, words: i, element: E.current, canvas: p });
                    ...
                    return (
                        ...
                        a().createElement(
                            ...
                            a().createElement('div', { ref: E, className: it, style: { maxHeight: `${h}rem` } }, t),
                            a().createElement(
                                'div',
                                { className: ot },
                                C.map((u, e) =>
                    ...
                    yt = ({
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement(Ft, { className: Ct, text: xt(t, r, wt.$dyn(e)), lines: u ? 2 : 1 }),
                            ),
                            !u &&
                                a().createElement(
                                    'div',
                ...
                let jt = (function (u) {
                    return ((u.Equipped = 'equipped'), (u.Unequipped = 'unequipped'), (u.Locked = 'locked'), u);
                })({});
                ...
                const Sn = (u) => {
                    ...
                    return a().createElement(
                        ...
                        r && a().createElement('div', { className: F()(wn.goto, null == o ? void 0 : o.goto) }, r),
                    );
                };
                var Tn = (function (u) {
