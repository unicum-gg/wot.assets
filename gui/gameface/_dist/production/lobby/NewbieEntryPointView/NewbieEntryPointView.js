(() => {
                ...
                const c = i.O.client.getSize('rem'),
                    ...
                    h = (e) => {
                        ...
                        const r = (0, n.useContext)(F),
                            ...
                            b = { extraLarge: _, large: g, medium: B, small: C, extraSmall: p };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.smallWidth && h) return a(u, t, b);
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (ae(t, F, { isMouseEvent: !0, on: !0, arguments: re(r) }, b),
                                    g && g(),
                    ...
                    ve = ({ elementList: e, textBlock: u, key: t }) => {
                        ...
                        return n
                            ? be[n]
                                ? r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': u.blockType, className: g()(fe, be[n]) },
                                      e,
                                  )
                                : r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': u.blockType, className: fe, style: we(n) },
                                      e,
                                  )
                            : r().createElement('span', { key: t, 'data-block-type': u.blockType, className: fe }, e);
                    },
                    ye = {
                        [_e.Word]: ve,
                        [_e.NoBreakSymbol]: ve,
                                        ...
                                        0 !== o &&
                                            ...
                                            (f < J
                                                ? r().createElement(
                                                      ...
                                                      r().createElement('div', { className: q.dates }, b),
                                                  )
                                                : r().createElement(
                                                      'div',
                                                      { className: q.timer },
                ...
                const nu = (e) => (0 === e ? window : window.subViews.get(e)),
                                ...
                                const l = (0, n.useRef)([]),
                                    c = (e, t, n) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            E = (({ observableModel: e }) =>
                                                e.primitives(['isNew', 'title', 'subtitle', 'bgFolderName']))({
                                                mode: e,
                                                readByPath: s,
                                                externalModel: o,
                                                observableModel: {
                    ...
                    ou = (0, Je.Pi)(() => {
                        ...
                        return r().createElement(Qe, {
                            ...
                            isNew: t.isNew.get(),
                            onClick: u.click,
                            onHoverForSetTime: u.hoverForSetTime,
                            onLeaveAfterSetTime: u.leaveAfterSetTime,
                        });
                    });
                engine.whenReady.then(() => {
                    M().render(
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/NewbieEntryPointView/NewbieEntryPointView'),
        (() => {
            var e = { 'lobby/NewbieEntryPointView/NewbieEntryPointView': 0 };
