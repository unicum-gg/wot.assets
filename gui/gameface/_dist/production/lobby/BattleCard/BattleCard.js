    ...
    var __webpack_modules__ = {
            ...
            3138: (e, u, t) => {
                ...
                var a = t(5959),
                    r = t(7698),
                    _ = t(514);
                const n = { view: t(7641), client: a, sound: _.ZP, intl: r.N };
            },
            7698: (e, u, t) => {
                'use strict';
                t.d(u, { N: () => a });
            ...
            7641: (e, u, t) => {
                ...
                const k = Object.keys(_.W).reduce(
            ...
            7309: (e, u, t) => {
                ...
                (0, r.memo)((e) => {
                    ...
                    const a = (0, r.useContext)(c),
                        ...
                        p = { extraLarge: C, large: g, medium: D, small: B, extraSmall: h };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && m) return n(u, t, p);
                        if (t.largeWidth && E) return n(u, t, p);
                ...
                const f = {
                    ...
                    x = (e) => {
                        ...
                        const n = (() => {
                            ...
                            o = n.mediaHeight,
                            s = n.mediaSize;
                        return _().createElement('div', p({ className: b()(t, f[i], v[o], w[s]) }, a), u);
                    },
                    N = ['children'],
                    k = (e) => {
                        let u = e.children,
                        ...
                        return _().createElement(E, null, _().createElement(x, t, u));
                    };
                var L = t(7948);
                let y;
                !(function (e) {
                ...
                const T = (e) => e.replace(/&nbsp;/g, ' '),
                    ...
                    M = (e, u, t = y.left) => e.split(u).reduce(t === y.left ? S : O, []),
                    I = (() => {
                        const e = new RegExp(
                            [
                    ...
                    return (
                        ((e) => {
                            ...
                            if (
                                                ...
                                                const u = H(),
                                                    ...
                                                    r =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: r, modelPath: G(r, ''), resId: a };
                                            })(),
                                            t = u.modelPrefix,
                                            a = e.split('.');
                                        if (a.length > 0) {
                                ...
                                E.current = U.addCallback(a, t, s, u === V.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (u !== V.None)
                ...
                function q(e, u, t) {
                    const a = (0, r.useContext)(c);
                    let _ = Object.entries(a).filter(([e, u]) => !0 === u && e in s);
                    return (
                ...
                P.Sw.instance;
                const Y = ({ binding: e, text: u = '', classMix: t, alignment: a = y.left, formatWithBrackets: n }) => {
                    ...
                    Q = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    J = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    ee = ({ text: e, binding: u, classMix: t }) => {
                        ...
                        return _().createElement(Y, { text: o, classMix: t, binding: n });
                    },
                ...
                const re = (e, u = !1) => (u && 1 === e ? te.B0 : `b${Math.min(Math.max(Math.floor(e), 0), 6)}`),
                    _e = {},
                    ne = (...e) => {
                        let u = [];
                        for (var t = 0, a = e; t < a.length; t++) {
                            ...
                            if (e in _e) u = u.concat(_e[e]);
                                ...
                                const t = [e];
                                for (let u = 0; u <= 6; u++) t.push(`${e}__${re(u)}`);
                                ((_e[e] = t), (u = u.concat(_e[e])));
                            }
                        }
                        return u;
                    },
                    ...
                    le = ['value', 'isEmpty', 'className', 'size', 'fadeInAnimation', 'hide', 'maximumNumber'];
                function me() {
                    return (
                        (me =
                            Object.assign ||
                ...
                const ce = (e) => {
                        ...
                        return _().createElement(
                            ...
                            _().createElement(
                                'div',
                                { className: b()(se.value, A && se.value__text) },
                                F ? c : E,
                ...
                const Ae = (e, u, t = {}, a = 0) => {
                    ...
                    be = (e) => {
                        ...
                        const h = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            p = (0, r.useMemo)(() => C || H().resId, [C]),
                            f = (0, r.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Ae(t, E, { isMouseEvent: !0, on: !0, arguments: Ee(a) }, p),
                                    g && g(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (e) => {
                                                      (e.clientX === window.innerWidth &&
                                                          ...
                                                          (h.current.timeoutId = window.setTimeout(f, l ? 100 : 400)),
                                                          _ && _(e),
                                                          x && x(e));
                                                  }),
                                              onMouseLeave: ((e) => (u) => {
                            ...
                            Be(
                                {
                                    contentId:
                                        ...
                                        m ? he.SimpleTooltipHtmlContent('resId') : he.SimpleTooltipContent('resId')),
                ...
                const ve = {
                    ...
                    xe = ({
                        ...
                        return _().createElement(
                            ge,
                            { isEnabled: a, args: { index: e, modeName: A, tooltipId: 'disabledTooltip' } },
                            _().createElement(
                                'div',
                                null,
                                _().createElement(
                                    ...
                                    {
                                        id: E,
                                        className: b()(we.base, a && we.base__disabled, F && we.base__isNotStarted),
                                        onClick: () => {
                                            (m({ index: e, size: u, cardMediaSize: C }), ve.playClick());
                                        },
                                        onMouseEnter: p,
                                        onMouseLeave: f,
                                    },
                                    ...
                                    t &&
                                        _().createElement(
                                            ...
                                            _().createElement('div', {
                                                className: b()(we.animBg, u === te.B0 && we.animBg__wide),
                                            }),
                                            _().createElement('div', { className: v.checkBackground }),
                                            _().createElement('div', { className: v.check }),
                                        ),
                                    _().createElement('div', { className: b()(we.hover, B && !F && we.hover__anim) }),
                                    ...
                                    _().createElement('div', {
                                        className: b()(we.infoCorner, k && we.infoCorner__anim),
                                    }),
                                    _().createElement(
                                        pe,
                                        { body: R.strings.tooltips.mode_selector.info.body(), isEnabled: k },
                                        _().createElement('div', {
                                            className: b()(v.info, k && we.info__anim),
                                            onClick: g,
                                        }),
                                    ),
                ...
                const Te = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    if (u.header || u.body) return _().createElement(pe, u, a);
                    const r = u.contentId;
                    return r ? _().createElement(be, ye({}, u, { contentId: r }), a) : _().createElement(ge, u, a);
                };
                var Se = t(9050),
                    Oe = t.n(Se);
                const Re = {
                ...
                const Pe = { [We.NBSP]: Me.NoBreakSymbol, [We.ZWNBSP]: Me.NoBreakSymbol, [We.NEW_LINE]: Me.LineBreak },
                    $e = ['zh_cn', 'zh_sg', 'zh_tw', 'ja', 'th'].includes(
                    ...
                    ze = 'renderers_word_f3',
                    je = (e) => ({ color: `#${e}` }),
                    Ge = ({ elementList: e, textBlock: u, key: t }) => {
                        const a = u.colorTag;
                        return a
                            ? He[a]
                                ? _().createElement(
                                      'span',
                                      { key: t, 'data-block-type': u.blockType, className: b()(ze, He[a]) },
                                      e,
                                  )
                                : _().createElement(
                                      'span',
                                      { key: t, 'data-block-type': u.blockType, className: ze, style: je(a) },
                                      e,
                                  )
                            : _().createElement('span', { key: t, 'data-block-type': u.blockType, className: ze }, e);
                    },
                    Ue = {
                        [Me.Word]: Ge,
                        [Me.NoBreakSymbol]: Ge,
                    ...
                    Xe = (e, u = '', t) => {
                        ...
                        return (
                            Ke(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (e) => {
                                    a.push({ blockType: Me.Word, colorTag: u, childList: Ye(e, t) });
                                },
                                (e) => {
                                    const t = e[0],
                                        r = Pe[t.charAt(0)];
                            ...
                            Ke(
                                ...
                                (e) => {
                                    ...
                                    'string' == typeof n || 'number' == typeof n
                                        ? r.push(...Xe(String(n), t, a))
                                        : r.push({ blockType: Me.Binding, colorTag: t, childList: [n] });
                                },
                            ),
                            r
                        );
                    ...
                    Qe = (e, u) => {
                        ...
                        if (e.blockType === Me.NoBreakWrapper) (e.childList.push(a), t.push(e));
                        else {
                            const u = Object.assign({}, e, { childList: e.childList.splice(-1) });
                            (e.childList.length > 0 && t.push(e),
                                t.push({ blockType: Me.NoBreakWrapper, colorTag: '', childList: [u, a] }));
                        }
                            ...
                            return (
                                e.forEach((e) => {
                                    e.blockType === Me.NoBreakSymbol
                                        ? ((t = !0), u.push(...Qe(u.pop(), e)))
                                        : (t ? u.push(...Qe(u.pop(), e)) : u.push(e), (t = !1));
                                }),
                                u
                            );
                        })(
                            ((e, u, t) => {
                                ...
                                return (
                                    Ke(
                                        ...
                                        (e) => {
                                            a.push(...Ze(e[2] + e[3], u, e[1], t));
                                        },
                                    ),
                                    a
                                );
                            })(T(e).replace(/&zwnbsp;/g, '\ufeff'), u, t),
                        );
                        return ((e) => {
                            const u = [];
                            return (
                    ...
                    uu = (e, u) => e.offsetLeft + e.offsetWidth - u,
                    tu = (e, u, t) => {
                    ...
                    au = (e, u, t, a, r, n) => {
                        ...
                        for (let s = t; s >= 0; s--) {
                            ...
                            if (l === Me.LineBreak || l === Me.NewLine || l === Me.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const d = m.slice(0, m.length - c) + n,
                                    E = u[s];
                                ((o = _().cloneElement(E, E.props, d)), (i = s));
                                break;
                            }
                            {
                                const e = t.children,
                                    l = u[s],
                                    c = l.props.children,
                                    d = au(e, c, e.length - 1, a, r, n),
                                    E = d[0],
                                    A = d[1];
                                if (!(E < 0)) {
                                    const e = c.slice(0, E);
                                    ((o = _().cloneElement(l, l.props, e, A)), (i = s));
                                    break;
                                }
                                r -= m.length;
                            }
                    ...
                    ru = _().memo(
                        ({
                            ...
                            const d = (0, r.useRef)(null),
                                ...
                                F = A[0],
                                C = A[1],
                                g = (0, r.useMemo)(() => Je(e, a, { justifyContent: l }), [a, l, e]),
                                D = (0, r.useMemo)(() => {
                                    if (
                                        n &&
                                        F.isTruncated &&
                                ...
                                h = (0, r.useMemo)(() => ({ justifyContent: l, alignContent: m }), [m, l]);
                            return (
                                ((e, u, t = !0) => {
                                ...
                                _().createElement(
                                    ...
                                    _().createElement('div', { className: Re.unTruncated, ref: d }, g),
                                    _().createElement(
                                        Te,
                                        {
                                            tooltipArgs: D,
                                        ...
                                        _().createElement(
                                            'div',
                                            {
                                                className: b()(
                                                    Re.truncated,
                                                    !F.isTruncateFinished && i && Re.truncated__hide,
                                                ),
                                                style: h,
                                            },
                ...
                const nu = { [Ne.LowRisk]: Le.Normal, [Ne.MediumRisk]: Le.Alert, [Ne.HighRisk]: Le.Blocker },
                    iu = R.strings.mode_selector.mode,
                    ou = ({ size: e, performanceRisk: u = Ne.LowRisk, modeName: t, cut: a, textFolder: n }) => {
                        var i;
                        const o = n || iu.$dyn(t),
                            s = (0, r.useMemo)(() => {
                                if (o && o.performance) {
                                    ...
                                    if (e) {
                                        ...
                                        return {
                                            args: { header: t, body: r, headerType: a ? nu[u] : Le.Normal },
                                            contentId: _,
                                            decoratorId: n,
                                        };
                                    }
                        ...
                        if (u === Ne.LowRisk || !o || null == o || !o.performance) return null;
                        const l = (null == (i = o.performance) ? void 0 : i.$dyn(u)).headerIcon();
                        return _().createElement(
                            be,
                            _u({}, s, { isEnabled: Boolean(s) }),
                            a
                                ? _().createElement('div', { className: b()(ke.iconBig, ke[`iconBig__${u}`]) })
                                : _().createElement(
                                      'div',
                                      { className: b()(ke.base, ke[`base__${e}`], ke[`base__${u}`]) },
                                      _().createElement(ru, {
                                          classMix: ke.text,
                                          text: l,
                                          isTruncationAvailable: e === te.B2,
                                          binding: { icon: _().createElement('div', { className: ke.icon }) },
                                          justifyContent: Ie.Center,
                                      }),
                                  ),
                        );
                    },
                    su = ({ index: e, text: u, isSmall: t = !1, classMix: a, tooltipId: r, modeName: n = '' }) =>
                        _().createElement(
                            ge,
                            { args: r ? { tooltipId: r, modeName: n } : { tooltipId: 'calendarTooltip', index: e } },
                            _().createElement(
                                'div',
                ...
                const mu = {
                    ...
                    cu = ({ modeName: e, isDisabled: u, battlePassState: t }) => {
                        const a = q([...ne('bpIcon', 'bpAnim')], mu);
                        return (
                            (0, r.useEffect)(() => {
                                t !== lu.NEW || u || fe('ev_mode_selector_bp_points_icon_appear');
                            }, [t, u]),
                            t === lu.NONE || u
                                ? null
                                : _().createElement(
                                      ...
                                      t === lu.NEW && _().createElement('div', { className: a.bpAnim }),
                                  )
                        );
                    },
                    du = {
                    ...
                    bu = ['small', 'small-b0', 'small-b1', 'medium'],
                    Fu = [te.B0, te.B1],
                    Cu = ({
                        mediaSize: e,
                        cardSize: u,
                        ...
                        const m = `${e}${Fu.includes(u) ? `-${u}` : ''}`,
                            c = (0, r.useMemo)(() => {
                                const e = bu.includes(m) ? 'c_48x48' : 'c_64x64';
                        ...
                        return _().createElement(
                            ...
                            _().createElement(
                                'div',
                                { className: b()(du.base, du[`base__${m}`]) },
                                _().createElement(
                                    'div',
                                    { className: du.header },
                                    _().createElement('div', {
                                        ...
                                        style: s
                                            ? {
                                                  backgroundImage: `url(${Au.$dyn(`${((d = s), d.replace(/-/g, '_'))}${l ? '_elite' : ''}`)})`,
                                              }
                                            : void 0,
                                    }),
                                ...
                                a && _().createElement(Y, { text: a, classMix: du.name }),
                            ),
                        );
                        var d;
                    },
                ...
                const fu = [te.B4, te.B5, te.B6],
                    vu = [te.B0, te.B1, te.B2],
                    wu = {
                        [te.B0]: { [ae.Big]: pu.Huge, [ae.Medium]: pu.Huge, [ae.Small]: pu.Big },
                        [te.B1]: { [ae.Big]: pu.Huge, [ae.Medium]: pu.Huge, [ae.Small]: pu.Big },
                        [te.B2]: { [ae.Big]: pu.Huge, [ae.Medium]: pu.Huge, [ae.Small]: pu.Big },
                        [te.B3]: { [ae.Big]: pu.Huge, [ae.Medium]: pu.Big, [ae.Small]: pu.Big },
                        [te.B4]: { [ae.Big]: pu.Big, [ae.Medium]: pu.Big, [ae.Small]: pu.Medium },
                        [te.B5]: { [ae.Big]: pu.Medium, [ae.Medium]: pu.Medium, [ae.Small]: pu.Small },
                        [te.B6]: { [ae.Big]: pu.Medium, [ae.Medium]: pu.Small, [ae.Small]: pu.Small },
                    },
                    xu = [
                        'name',
                        'eventName',
                ...
                const ku = (e) => {
                        ...
                        let we = '';
                        de && n === fe ? i && (we = T(i)) : (ce && n === fe) || (we = T(n + D + i));
                        const Ne = b()(
                                hu.icon,
                                hu[`icon__${_e}`],
                                I[`icon__${z}`],
                                !me && hu.icon__animPrepare,
                                Ce && I[`icon__static__${z}`],
                                ge && I[`icon__anim__${z}`],
                            ),
                            ke = b()(hu.mask, I[`mask__${z}`], Ce && hu.mask__static, ge && hu.mask__anim),
                            Le = b()(
                                I.subtitle,
                                I[`subtitle__${z}`],
                                (t || !me) && hu.subtitle__normal,
                                !be && hu.subtitle__noReward,
                                C && me && hu.subtitle__statusActive,
                                C && le && hu.subtitle__staticPrepare,
                            ...
                            ye = b()(
                                ...
                                be && hu.statusDescription__color,
                            ),
                            Te = b()(I.footer, (J || j) && !G && Ae && hu.footer__anim, null == k ? void 0 : k.footer),
                            Se = b()(I.formatText, I[`formatText__${z}`]),
                            Oe = b()(hu.darken, G && hu.darken__show),
                            Re = b()(
                                hu.widgetOverlay,
                                !Fe && hu.widgetOverlay__hide,
                                null == k ? void 0 : k.widgetOverlay,
                            );
                        return _().createElement(
                            'div',
                            { className: b()(I.base, I[`base__${z}`]) },
                            _().createElement(
                                xe,
                                ...
                                he && _().createElement(Bu, { size: z, rewardsList: F }),
                                a &&
                                    _().createElement(
                                        'div',
                                        { className: b()(I.statusNotActive, I[`statusNotActive__${z}`]) },
                                        _().createElement(ee, { text: ve, classMix: Se }),
                                    ),
                                _().createElement('div', { className: Oe }),
                                c && _().createElement('div', { className: Re }, c),
                                o,
                                (!Fe || f) &&
                                    _().createElement(
                                        'div',
                                ...
                                _().createElement('div', { className: b()(hu.name, I.name, I[`name__${z}`]) }, u, h),
                                _().createElement(
                                    'div',
                                    { className: Le },
                                    !w && (!Ee || E) && _().createElement(ee, { classMix: Se, text: fe || '' }),
                                    we &&
                                        be &&
                                        !E &&
                                        (!Fe || be) &&
                                    ...
                                    _().createElement(
                                        'div',
                                        { className: b()(hu.belowStatus, null == k ? void 0 : k.belowStatus) },
                                        B,
                                    ),
                                ),
                                i &&
                                ...
                                A &&
                                    ...
                                    _().createElement(su, {
                                        ...
                                        text: A,
                                        isSmall: Be,
                                        classMix: b()(hu.timeLeft, Be && hu.timeLeft__small),
                                        tooltipId: m,
                                        modeName: Y,
                                    }),
                                _().createElement(cu, { modeName: Y, isDisabled: E, battlePassState: d }),
                                pe &&
                                    !be &&
                                    _().createElement(ou, {
                                        size: z,
                ...
                const Hu = (e) => (e ? { left: 0 } : { right: 0 }),
                    ...
                    Gu = (0, r.memo)(
                        ({
                            ...
                            const h = (0, r.useMemo)(() => Object.assign({ width: '100%' }, ju(e), Hu(m)), [m, e]),
                                p = (0, r.useMemo)(() => Object.assign({ width: '0%' }, ju(e), Hu(m)), [m, e]),
                                f = (0, r.useMemo)(() => Object.assign({ width: '0%' }, zu(m, a), ju(e)), [a, m, e]),
                                v = (0, r.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(i - a)}%` }, zu(m, a), ju(e)),
                                    [a, m, i, e],
                                );
                            if (A) return null;
                            const w = b()(
                        ...
                        ({
                            ...
                            return A
                                ...
                                : _().createElement(
                                      ...
                                      _().createElement(
                                          'div',
                                          { style: b ? C : g, className: 'ProgressBarDeltaSimple_delta_99' },
                                          _().createElement(Ru, { size: n }),
                                      ),
                                  );
                        },
                ...
                const Xu = (0, r.memo)((e) => {
                        ...
                        switch (a.animationSettings.type) {
                            case Tu.Simple:
                                return _().createElement(Ku, Yu({}, a, { onEndAnimation: s, isComplete: i }));
                            case Tu.Growing:
                                return _().createElement(Uu, Yu({}, a, { onEndAnimation: s, isComplete: i }));
                            default:
                                return null;
                        }
                    }),
                    Zu = ({ size: e, value: u, lineRef: t, disabled: a, onComplete: n }) => {
                        ...
                        return (
                            ...
                            _().createElement(Iu, { size: e, disabled: a, baseStyles: i, isComplete: o, lineRef: t })
                        );
                    },
                    Qu = ['onEndAnimation'];
                function Ju() {
                ...
                const tt = (0, r.memo)(
                        ({
                            ...
                            return i.withStack
                                ? _().createElement(et, m)
                                : _().createElement(Xu, ut({ key: `${r}-${u}-${n}` }, m));
                        },
                    ),
                    at = (e) => {
                    ...
                    nt = (e, u, t) => ('number' == typeof t ? (_t(0, u, t) / u) * 100 : e),
                    it = {
                        bgImageBase: 'R.images.gui.maps.icons.components.progress_bar.pattern_grey',
                    ...
                    st = (0, r.memo)(
                        ({
                            ...
                            return _().createElement(
                                'div',
                                { className: b()(Lu.base, A, Lu[`base__${t}`]), style: at(u) },
                                !i && _().createElement(Su, { size: t }),
                                _().createElement(tt, {
                                    size: t,
                                    lineRef: m,
                                    disabled: n,
                    ...
                    lt = {
                        base: 'Widget_base_57',
                        base__b1: 'Widget_base__b1_8c',
                        base__b2: 'Widget_base__b2_1a',
                        base__b3: 'Widget_base__b3_83',
                        emblem: 'Widget_emblem_58',
                        emblem__b1: 'Widget_emblem__b1_83',
                        emblem__b2: 'Widget_emblem__b2_7e',
                        emblem__b3: 'Widget_emblem__b3_81',
                        emblem__b4: 'Widget_emblem__b4_2a',
                        emblem__full: 'Widget_emblem__full_33',
                        progress: 'Widget_progress_05',
                        progress__b2: 'Widget_progress__b2_d1',
                        progress__b3: 'Widget_progress__b3_31',
                        collection: 'Widget_collection_fc',
                        currentAmount: 'Widget_currentAmount_64',
                        tickets: 'Widget_tickets_ea',
                        tickets__b2: 'Widget_tickets__b2_60',
                        tickets__b3: 'Widget_tickets__b3_3d',
                        ticketsCount: 'Widget_ticketsCount_25',
                        progressionWrapper: 'Widget_progressionWrapper_73',
                    },
                    mt = (0, r.memo)(({ totalCount: e, currentProgress: u, ticketCount: t, size: a }) => {
                        const n = a === te.B1 || a === te.B2 || a === te.B3,
                            i = q([...ne('emblem', 'base', 'progress', 'tickets')], lt),
                            o = u && e ? (100 * u) / e : 0,
                            s = (0, r.useMemo)(
                                () => ({
                                    current: _().createElement('span', { className: lt.currentAmount }, u),
                                    total: e,
                                }),
                                [u, e],
                            ),
                            l = (0, r.useMemo)(
                                () => ({ count: _().createElement('span', { className: lt.ticketsCount }, t) }),
                                [t],
                            ),
                            m = b()(i.base, i[`base__${a}`]),
                            c = b()(i.emblem, i[`emblem__${a}`], u === e && lt.emblem__full),
                            d = b()(i.progress, i[`progress__${a}`]),
                            E = b()(i.tickets, i[`tickets__${a}`]);
                        return _().createElement(
                            'div',
                            { className: m },
                            _().createElement(
                                be,
                                { contentId: R.views.white_tiger.lobby.tooltips.WidgetTooltipView('resId') },
                                _().createElement('div', { className: c }),
                            ),
                            n &&
                                _().createElement(
                                    _().Fragment,
                                    ...
                                    _().createElement(
                                        ...
                                        _().createElement(
                                            'div',
                                            { className: lt.progressionWrapper },
                                            _().createElement(Y, {
                                                classMix: lt.collection,
                                                text: R.strings.mode_selector.mode.whiteTiger.collection(),
                                                binding: s,
                                            }),
                                        ),
                                        _().createElement(st, { size: yu.Small, value: o, theme: rt }),
                                    ),
                                ),
                        );
                    }),
                    ct = ['size', 'showWidget', 'widget', 'rewardList'];
                function dt() {
                    return (
                        (dt =
                            Object.assign ||
                ...
                const Et = [te.B5, te.B6];
                var At, bt;
                ((At = R.views.white_tiger.lobby.BattleCard()),
                    (bt = (e) => {
                        let u = e.size,
                            t = e.showWidget,
                            a = e.widget,
                        ...
                        const i = a && a.isEnabled && _().createElement(mt, dt({ size: u }, a)),
                            o = t && u === te.B2 ? [] : r;
                        return _().createElement(
                            k,
                            null,
                    ...
                    a().set(At, bt),
                    document.dispatchEvent(new CustomEvent(At)));
            },
            7363: (e) => {
                'use strict';
                e.exports = React;
