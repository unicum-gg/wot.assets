    ...
    var __webpack_modules__ = {
            ...
            2751: (u, e, t) => {
                ...
                const o = (u, e, t = {}, E = 0) => {
                    ...
                    c = n().memo(({ icon: u, value: e, tooltipId: t, isSmall: E = !1 }) => {
                        const F = Number(e),
                            i = (0, a.useMemo)(() => ({ tooltipId: t }), [t]),
                            D = { backgroundImage: `url(${d.$dyn(u)})` };
                        return n().createElement(
                            ...
                            n().createElement(
                                'div',
                                { className: s },
                                n().createElement('div', { className: r()(l, E && C), style: D }),
                                F > 1 &&
                                    n().createElement(
                                        'div',
                                        { className: _ },
                                        n().createElement(A.ZP, { text: `&#215;${F}` }),
                                    ),
                            ),
                        );
                    });
            ...
            6439: (u, e, t) => {
                ...
                a().memo(({ rewards: u }) => {
                    ...
                    return a().createElement(
                        ...
                        { className: o },
                        u.map((u, t) => {
                            const E = u.icon || u.item || u.name;
                            return a().createElement(
                                'div',
                                { className: r()(B, e && s), style: C(t), key: t },
                                a().createElement(i.D, { icon: E, tooltipId: u.tooltipId, isSmall: e }),
