(() => {
    var __webpack_modules__ = {
                ...
                const s = {
                    ...
                    _ = (0, a.ZP)((u) => {
                        ...
                        const V = (0, n.useMemo)(() => {
                            ...
                            }, [t, E, a, m, c, g, U, j, y, x, k, O, P]),
                            K = V.computedStyle,
                            Y = V.computedClassNames;
                        return i().createElement('div', B({ className: r()(D.Z.base, ...Y, e), style: K }, X), Z);
                    });
            },
            280: (u, e, t) => {
                'use strict';
                ...
                var E = t(6179),
                    ...
                    a = t(3649),
                    n = t(5287);
                const i = ({ binding: u, text: e = '', classMix: t, alignment: A = a.v2.left }) =>
                    null === e
                        ...
                        : r().createElement(
                              ...
                              e.split('\n').map((e, i) =>
                                  r().createElement(
                                      'div',
                                      { className: F()(n.Z.base, t), key: `${e}-${i}` },
            ...
            3495: (u, e, t) => {
                ...
                const a = E.O.client.getSize('rem'),
                    n = a.width,
                    i = a.height,
                    D = Object.assign({ width: n, height: i }, (0, F.T)(n, i, A.j)),
                    o = (0, r.createContext)(D);
            },
            1039: (u, e, t) => {
                'use strict';
                var E = t(6179),
                ...
                (0, E.memo)(({ children: u }) => {
                    const e = (0, E.useContext)(F.Y),
                        ...
                        D = t[0],
                        o = t[1],
                        B = (0, E.useCallback)((u, e) => {
                            const t = i.O.view.pxToRem(u),
                                E = i.O.view.pxToRem(e);
                            o(Object.assign({ width: t, height: E }, (0, n.T)(t, E, a.j)));
                        }, []);
                    ((0, A.Z)(() => {
                        engine.on('clientResized', B);
                    }),
                        (0, E.useEffect)(() => () => engine.off('clientResized', B), [B]));
                    const s = (0, E.useMemo)(() => Object.assign({}, D), [D]);
                    return r().createElement(F.Y.Provider, { value: s }, u);
                });
            },
            6010: (u, e, t) => {
                'use strict';
                ...
                const a = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && s) return (0, r.H)(e, t, v);
                        if (t.largeWidth && l) return (0, r.H)(e, t, v);
                        if (t.mediumWidth && C) return (0, r.H)(e, t, v);
                        if (t.smallWidth && _) return (0, r.H)(e, t, v);
                ...
                const m = Object.keys(n()),
                    ...
                    p = (0, o.ZP)((u) => {
                        ...
                        return s().createElement(
                            ...
                            _(
                                {
                                    className: r()(l.Z.base, t && l.Z[t], M, E),
                                    style: S,
            ...
            3377: (u, e, t) => {
                ...
                const F = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    n = [E.cJ.ExtraLarge, E.cJ.Large, E.cJ.Medium, E.cJ.Small, E.cJ.ExtraSmall],
                    i = (u, e) =>
            ...
            5415: (u, e, t) => {
                ...
                const i = () => {
                    ...
                    return { mediaSize: A, mediaWidth: i, mediaHeight: D, remScreenWidth: e, remScreenHeight: t };
                };
            },
            5521: (u, e, t) => {
                'use strict';
            ...
            3649: (u, e, t) => {
                ...
                const r = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    a = (u, e, t = E.left) => u.split(e).reduce(t === E.left ? A : F, []),
                    n = (() => {
                        const u = new RegExp(
                        ...
                        return i.includes(t)
                            ...
                            : ((u, e = E.left) => {
                                  ...
                                  const A =
                                      ...
                                      F = r(u);
                                  return (a(F, /( )/, e).forEach((u) => (t = t.concat(a(u, A, E.left)))), t);
                              })(u, e);
                    },
                    o = (u, e, t) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : D(u, e)));
            },
            1358: (u, e, t) => {
                'use strict';
                t.d(e, { Z: () => A });
            ...
            2751: (u, e, t) => {
                ...
                const o = (u, e, t = {}, E = 0) => {
                        ...
                        const x = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, a.useCallback)(() => {
                                (x.current.isVisible && x.current.timeoutId) ||
                                    (o(t, m, { isMouseEvent: !0, on: !0, arguments: D(E) }, b),
                                    w && w(),
                    ...
                    h = n().memo(({ icon: u, name: e, value: t, tooltipId: E, isSmall: F = !1 }) => {
                        const i = Number(t),
                            D = (0, a.useMemo)(() => ({ tooltipId: E }), [E]),
                            o = { backgroundImage: `url(${('crewBooks' === e ? c : d).$dyn(u)})` };
                        return n().createElement(
                            ...
                            n().createElement(
                                'div',
                                { className: s },
                                n().createElement('div', { className: r()(l, F && C), style: o }),
                                i > 1 &&
                                    n().createElement(
                                        'div',
                                        { className: _ },
                                        n().createElement(A.ZP, { text: `&#215;${i}` }),
                                    ),
                            ),
                        );
                    });
            ...
            4944: (u, e, t) => {
                ...
                const i = 'BobRewardTitle_vehicle_52',
                    D = R.strings.bob,
                    o = F().memo(({ name: u, reward: e }) => {
                        switch (u) {
                            case n.Credits:
                            case n.Crystal:
                            case n.FreeXP:
                                return F().createElement(E.ZP, {
                                    color: 'WHITE_SPANISH',
                                    text: D.rewards.label.$dyn(e.name),
                                    format: { binding: { value: e.value } },
                                });
                            case n.Premium:
                                return F().createElement(E.ZP, {
                                    color: 'WHITE_SPANISH',
                                    text: e.userName ? (0, r.z4)(e.userName) : '',
                                });
                            case n.Vehicle:
                                return F().createElement(
                                    'div',
                                    { className: i },
                                    F().createElement(E.ZP, { color: 'WHITE_SPANISH', text: D.rewards.label.rent() }),
                                    F().createElement(E.ZP, { color: 'GOLD', text: e.label }),
                                );
                            default:
                                return F().createElement(E.ZP, {
                                    color: 'WHITE_SPANISH',
                                    text: (0, r.z4)(e.label || e.userName),
                                });
                        }
                    });
            },
            6439: (u, e, t) => {
                ...
                var F = t(6179),
                    ...
                    i = t(2751),
                    D = t(4944);
                const o = 'BobRewards_base_37',
                    B = 'BobRewards_rewardWrapper_d2',
                    s = 'BobRewards_rewardWrapper__extraSmall_bc',
                    l = (u) => 1 + 0.3 * u,
                    C = (u) => ({ animationDelay: `${l(u)}s` });
                a().memo(({ rewards: u }) => {
                    (0, F.useEffect)(() => {
                        const e = [];
                        return (
                    ...
                    return a().createElement(
                        ...
                        { className: o },
                        u.map((u, t) => {
                            const E = u.icon || u.bigIcon || u.item || u.name;
                            return a().createElement(
                                'div',
                                { className: r()(B, e && s), style: C(t), key: t },
                                a().createElement(i.D, { icon: E, tooltipId: u.tooltipId, isSmall: e, name: u.name }),
                                a().createElement(D.g, { name: u.name, reward: u }),
                            );
                        }),
                    );
                });
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 307),
        (() => {
            var u = { 307: 0, 928: 0, 262: 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [596], () => __webpack_require__(6439));
