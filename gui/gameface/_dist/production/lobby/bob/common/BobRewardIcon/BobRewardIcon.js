    ...
    var __webpack_modules__ = {
            ...
            280: (u, e, t) => {
                ...
                var E = t(6179),
                    ...
                    a = t(3649),
                    i = t(5287);
                const n = ({ binding: u, text: e = '', classMix: t, alignment: r = a.v2.left }) =>
                    null === e
                        ...
                        : A().createElement(
                              ...
                              e.split('\n').map((e, n) =>
                                  A().createElement(
                                      'div',
                                      { className: F()(i.Z.base, t), key: `${e}-${n}` },
            ...
            3495: (u, e, t) => {
                ...
                const a = E.O.client.getSize('rem'),
                    i = a.width,
                    n = a.height,
                    D = Object.assign({ width: i, height: n }, (0, F.T)(i, n, r.j)),
            ...
            1039: (u, e, t) => {
                ...
                (0, E.memo)(({ children: u }) => {
                    ...
                    const s = (0, E.useMemo)(() => Object.assign({}, D), [D]);
            ...
            5067: (u, e, t) => {
                ...
                t.d(e, { O: () => K });
                var E = {};
                (t.r(E), t.d(E, { mouse: () => B, onResize: () => n }));
                var A = {};
                (t.r(A),
                    t.d(A, {
                        events: () => E,
            ...
            5415: (u, e, t) => {
                ...
                const n = () => {
                    ...
                    return { mediaSize: r, mediaWidth: n, mediaHeight: D, remScreenWidth: e, remScreenHeight: t };
                };
            },
            5521: (u, e, t) => {
                'use strict';
            ...
            3649: (u, e, t) => {
                ...
                const A = (u, e, t) => {
                    ...
                    D = (u, e, t) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : n(u, e)));
            },
            1358: (u, e, t) => {
                'use strict';
                t.d(e, { Z: () => r });
            ...
            2751: (u, e, t) => {
                ...
                const B = (u, e, t = {}, E = 0) => {
                        ...
                        const x = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, a.useCallback)(() => {
                                (x.current.isVisible && x.current.timeoutId) ||
                                    (B(t, m, { isMouseEvent: !0, on: !0, arguments: D(E) }, b),
                                    w && w(),
                    ...
                    c = R.images.gui.maps.icons.crewBooks.books.s600x450;
                i().memo(({ icon: u, name: e, value: t, tooltipId: E, isSmall: F = !1 }) => {
                    const n = Number(t),
                        D = (0, a.useMemo)(() => ({ tooltipId: E }), [E]),
                        B = { backgroundImage: `url(${('crewBooks' === e ? c : d).$dyn(u)})` };
                    return i().createElement(
                        ...
                        i().createElement(
                            'div',
                            { className: s },
                            i().createElement('div', { className: A()(l, F && C), style: B }),
                            n > 1 &&
                                i().createElement(
                                    'div',
                                    { className: _ },
                                    i().createElement(r.ZP, { text: `&#215;${n}` }),
                                ),
                        ),
                    );
                });
