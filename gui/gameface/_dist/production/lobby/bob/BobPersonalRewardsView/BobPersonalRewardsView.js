(() => {
    var __webpack_modules__ = {
                ...
                const D = {
                    ...
                    B = (0, E.ZP)((u) => {
                        let e = u.className,
                            ...
                            v = u.row,
                            b = u.flexDirection,
                            w = void 0 === b ? (p ? 'column' : v && 'row') || void 0 : b,
                            f = u.flexStart,
                            x = u.center,
                            M = u.flexEnd,
                            S = u.spaceBetween,
                            ...
                            O =
                                void 0 === T
                                    ...
                                    : T,
                            y = u.alignItems,
                            R = void 0 === y ? (f ? 'flex-start' : x && 'center') || (M && 'flex-end') || void 0 : y,
                            H = u.alignSelf,
                            P = u.wrap,
                            k = u.flexWrap,
                        ...
                        const $ = (0, o.useMemo)(() => {
                            ...
                            }, [t, r, E, d, C, g, j, U, H, w, N, O, R]),
                            V = $.computedStyle,
                            K = $.computedClassNames;
                        return A().createElement('div', l({ className: n()(s.Z.base, ...K, e), style: V }, X), Z);
                    });
            },
            280: (u, e, t) => {
                'use strict';
            ...
            6010: (u, e, t) => {
                ...
                const E = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && D) return (0, n.H)(e, t, v);
                        if (t.largeWidth && _) return (0, n.H)(e, t, v);
                        if (t.mediumWidth && c) return (0, n.H)(e, t, v);
                        if (t.smallWidth && B) return (0, n.H)(e, t, v);
            ...
            185: (u, e, t) => {
                ...
                class w extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            _ = E()(p.base, p[`base__${i}`], p[`base__${n}`], null == o ? void 0 : o.base),
                            c = E()(p.icon, p[`icon__${i}`], p[`icon__${n}`], null == o ? void 0 : o.icon),
                            B = E()(p.glow, null == o ? void 0 : o.glow),
                            d = E()(p.caption, p[`caption__${i}`], null == o ? void 0 : o.caption),
                            m = E()(p.goto, null == o ? void 0 : o.goto);
                ...
                H.defaultProps = { type: O.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const P = (0, n.memo)(H);
                var k = t(7613),
                    N = t(3403),
                    I = t(6439);
                ...
                const V = ((u, e) => {
                        ...
                        ({ externalModel: u }) => ({ onOpenNext: u.createCallbackNoArgs('onOpenNext') }),
                    ),
                    K = V[0],
                    z = V[1],
                    Y = 'Content_base_60',
                    q = 'Content_content_8d',
                    J = 'Content_title_f1',
                    Q = 'Content_reward_1c',
                    uu = 'Content_ribbon_14',
                    eu = 'Content_rays_71',
                    tu = 'Content_glow_c8',
                    ru = 'Content_lightCont_5a',
                    nu = 'Content_light_1b',
                    au = 'Content_buttonWrapper_e4',
                    iu = 'Content_buttonWrapper__available_e4',
                    Eu = 'Content_buttonWrapper__repeat_30',
                    ou = R.strings.bob.rewardScreen.button,
                    Au = (0, N.Pi)(() => {
                        const u = z(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: q },
                                a().createElement('div', { className: J }, a().createElement(k.ZP, { text: i })),
                                a().createElement(
                                    'div',
                                    { className: Q },
                                    a().createElement('img', {
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: ru, key: `light_${o}` },
                                        a().createElement('div', { className: nu }),
                                    ),
                                    a().createElement('div', { className: uu }),
                                    a().createElement('div', { className: eu, key: `rays_${o}` }),
                                    a().createElement(I.j, { rewards: A }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: c },
                                    a().createElement(
                                        P,
                                        { type: O.primary, size: y.medium, onClick: F },
                                        o > 0
                                            ? a().createElement(k.ZP, {
                                                  text: ou.openNext(),
                                                  format: { binding: { count: o } },
                                              })
                                            : a().createElement(k.ZP, { text: ou.ok() }),
                                    ),
                                ),
                            ),
                        );
                ...
                const Du = {
                    ...
                    controls: () => {
                        const u = (function (u) {
                            ...
                            return e;
                        })({ onOpenNext: () => console.log('onOpenNext') });
            ...
            2751: (u, e, t) => {
                ...
                const F = (u, e, t = {}, r = 0) => {
                    ...
                    h = o().memo(({ icon: u, name: e, value: t, tooltipId: r, isSmall: i = !1 }) => {
                        const A = Number(t),
                            s = (0, E.useMemo)(() => ({ tooltipId: r }), [r]),
                            F = { backgroundImage: `url(${('crewBooks' === e ? C : m).$dyn(u)})` };
                        return o().createElement(
                            ...
                            o().createElement(
                                'div',
                                { className: D },
                                o().createElement('div', { className: n()(_, i && c), style: F }),
                                A > 1 &&
                                    o().createElement(
                                        'div',
                                        { className: B },
                                        o().createElement(a.ZP, { text: `&#215;${A}` }),
                                    ),
                            ),
                        );
                    });
                ...
                const F = 'BobRewards_base_37',
                    ...
                    B = E().memo(({ rewards: u }) => {
                        ...
                        return E().createElement(
                            ...
                            { className: F },
                            u.map((u, t) => {
                                const r = u.icon || u.bigIcon || u.item || u.name;
                                return E().createElement(
                                    'div',
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 238),
        (() => {
            var u = { 238: 0, 928: 0, 307: 0, 262: 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [596], () => __webpack_require__(185));
