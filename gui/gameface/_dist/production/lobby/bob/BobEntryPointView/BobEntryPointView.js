(() => {
    var __webpack_modules__ = {
            ...
            8022: (u, e, t) => {
                ...
                const _ = B.O.client.getSize('rem'),
                    m = _.width,
                    c = _.height,
                    d = Object.assign({ width: m, height: c }, C(m, c, l)),
                ...
                const p = (u) => {
                    ...
                    const E = (0, r.useContext)(h),
                        ...
                        v = { extraLarge: _, large: m, medium: c, small: d, extraSmall: p };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.largeWidth && B) return o(e, t, v);
                        if (t.mediumWidth && l) return o(e, t, v);
                ...
                (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(h),
                        ...
                        a = (0, r.useCallback)((u, e) => {
                            ...
                            F(Object.assign({ width: t, height: r }, C(t, r, l)));
                        }, []);
                    v(() => {
                ...
                const H = {
                    ...
                    I = T((u) => {
                        let e = u.className,
                            ...
                            I = u.shrink,
                            G = u.flex,
                            U = void 0 === G ? (R || I ? `${R ? 1 : 0} ${I ? 1 : 0} auto` : void 0) : G,
                            j = u.style,
                            X = u.children,
                            K = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const z = (0, r.useMemo)(() => {
                            ...
                            }, [t, A, i, o, l, C, j, U, M, d, T, w, S]),
                            Y = z.computedStyle,
                            V = z.computedClassNames;
                        return E().createElement('div', N({ className: n()(y.base, ...V, e), style: Y }, K), X);
                    });
                let G;
                !(function (u) {
                        ...
                        return z.includes(t)
                            ...
                            : ((u, e = G.left) => {
                                  ...
                                  const r =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return X(E, /( )/, e).forEach((u) => (t = t.concat(X(u, r, G.left)))), t;
                              })(u, e);
                    },
                        ...
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, F) =>
                                      E().createElement(
                                          'div',
                                          { className: n()(V, t), key: `${e}-${F}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : Y(u, e))))(e, A, u).map((u, e) =>
                            ...
                            uu(
                                {
                                    ...
                                    mr: !0 === B ? Fu[t || 'paragraph-P16'].mr : B,
                                    mb: !0 === s ? Fu[t || 'paragraph-P16'].mb : s,
                ...
                let iu;
                !(function (u) {
                    (u.BeforeEventStart = 'beforeEventStart'),
                        (u.Paused = 'paused'),
                        (u.RegistrationAfterEventStart = 'registrationAfterEventStart'),
                        (u.AvailablePrimeTime = 'availablePrimeTime'),
                        (u.NotAvailablePrimeTime = 'notAvailablePrimeTime'),
                        (u.EventFinish = 'eventFinish');
                })(iu || (iu = {}));
                let Du;
                !(function (u) {
                ...
                var _u = t(3403);
                const mu = R.images.gui.maps.icons.bob.hangar.entrypoint.grey;
                let cu;
                !(function (u) {
                    (u.Normal = 'normal'),
                        (u.Yellow = 'yellow'),
                ...
                const du = new Map([
                    [iu.BeforeEventStart, cu.Grey],
                    [iu.Paused, cu.Grey],
                    [iu.RegistrationAfterEventStart, cu.Yellow],
                    [iu.AvailablePrimeTime, cu.Yellow],
                    [iu.NotAvailablePrimeTime, cu.Normal],
                    [iu.EventFinish, cu.Orange],
                ]);
                function hu() {
                    return !1;
                }
                ...
                const xu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: A = 'real', options: F, children: a, mocks: n }) {
                                const i = (0, r.useRef)([]),
                                    D = (t, r, E) => {
                                        var A;
                                        const F = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, A) => {
                                                        const a = 'string' == typeof A ? `${r}.${A}` : r,
                                                            n = B.O.view.addModelObserver(a, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = pu(E.keys()); !(u = t()).done; ) A(u.value, e);
                                                    },
                                                    unsubscribe: A,
                                                };
                                            })(r),
                                    ...
                                    s = l[0],
                                    C = l[1],
                                    _ = (0, r.useState)(() => D(A, F, n)),
                                    m = _[0],
                                    c = _[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        o.current ? c(D(s, F, n)) : (o.current = !0);
                                    }, [n, s, F]),
                                    (0, r.useEffect)(() => {
                                        C(A);
                                    }, [A]),
                                    ...
                                    E().createElement(t.Provider, { value: m }, a)
                                );
                            },
                            () => (0, r.useContext)(t),
                        ];
                    ...
                    Tu = 'App_header_d6',
                    yu = 'App_body_a3',
                    Ru = 'App_body__large_25',
                    Pu = 'App_footer_bc',
                    Nu = 'App_footer__hasIcon_46',
                    Hu = 'App_footerLockIcon_7e',
                    ku = 'App_footerTimerIcon_24',
                    Wu = (0, _u.Pi)(() => {
                        var u, e;
                        const t = fu(),
                            A = t.model,
                            ...
                            C = l[1],
                            _ = Bu(),
                            m = [iu.NotAvailablePrimeTime].includes(B),
                            c = [iu.BeforeEventStart, iu.AvailablePrimeTime].includes(B),
                            d = ((h = _.width), (g = _.height), `c_${h - 2}x${g - 2}`);
                        var h, g;
                        const p = null != (u = du.get(B)) ? u : cu.Normal,
                            v = {
                                backgroundImage: `url('${(null != (e = R.images.gui.maps.icons.bob.hangar.entrypoint.$dyn(p)) ? e : mu).$dyn(d)}')`,
                            },
                            b = {
                                backgroundImage: `url('${R.images.gui.maps.icons.bob.hangar.entrypoint.bg.$dyn(d)}')`,
                            },
                            x = n()(Mu, s && Lu),
                            w = n()(Tu),
                            f = [iu.AvailablePrimeTime, iu.EventFinish].includes(B),
                            S = n()(yu, f && Ru),
                            M = n()(Pu, (m || c) && Nu);
                        return E().createElement(
                            'div',
                            {
                                ...
                                onClick: F.action,
                                onMouseEnter: () => {
                                    Cu.playHighlight(), C(!0);
                                },
                                onMouseLeave: () => {
                                    C(!1);
                                },
                            },
                            E().createElement('div', { className: x, style: b }),
                            E().createElement('div', { className: Ou, style: v }),
                            E().createElement(
                                'div',
                                { className: w },
                                E().createElement(nu, { text: i.toUpperCase() }),
                            ),
                            E().createElement(
                                'div',
                                { className: S },
                                E().createElement(nu, { text: D.toUpperCase() }),
                            ),
                            E().createElement(
                                'div',
                                { className: M },
                                m && E().createElement('div', { className: Hu }),
                                c && E().createElement('div', { className: ku }),
                                E().createElement(nu, { text: o }),
                            ),
                        );
                    });
                const Iu = {
                        header: '++ Header ++',
                        body: 'Бои временно недоступны',
                        footer: '++ Footer ++',
                        state: iu.RegistrationBeforeEventStart,
                    },
                    Gu = {
                        getter: ((Uu = Iu), (u) => (u ? u.split('.').reduce((u, e) => u[e], Uu) : Uu)),
                        controls: () =>
                            (function (u) {
                                const e = {};
                                for (const t in u)
                ...
                engine.whenReady.then(() => {
                    F().render(
                        E().createElement(wu, { mocks: Gu, mode: 'real' }, E().createElement(Wu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [596], () => __webpack_require__(8022));
