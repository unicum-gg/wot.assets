(() => {
    var __webpack_modules__ = {
            ...
            961: (u, e, t) => {
                ...
                const i = (u, e, t) => {
                    ...
                    D = (u, e, t = n.left) => u.split(e).reduce(t === n.left ? i : F, []),
                    o = (() => {
                        const u = new RegExp(
                        ...
                        return l.includes(t)
                            ...
                            : ((u, e = n.left) => {
                                  ...
                                  const r =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (D(E, /( )/, e).forEach((u) => (t = t.concat(D(u, r, n.left)))), t);
                              })(u, e);
                    };
                let B;
                !(function (u) {
                ...
                const m = (u = 1) => {
                    ...
                    p = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: E, modelPath: h(E, u || ''), resId: r };
                            })(),
                            t = e.modelPrefix,
                            r = u.split('.');
                        if (r.length > 0) {
                            ...
                            return (
                                r.reduce((e, r) => {
                                    const E = d(h(t, `${e}.${r}`), window);
                                    return g(E) ? (u.push(E.id), `${e}.${r}.value`) : (u.push(r), `${e}.${r}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        c(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    r = p(u);
                                l.current = b.addCallback(r, t, n, e === v.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (e !== v.None)
                                return () => {
                                    b.removeCallback(l.current, n);
                                };
                        }, [n, e]),
                        D
                    );
                ...
                const N = C.O.client.getSize('rem'),
                    H = N.width,
                    I = N.height,
                    W = Object.assign({ width: H, height: I }, k(H, I, P)),
                    V = (0, r.createContext)(W),
                    G = ['children'];
                const U = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    const E = (0, r.useContext)(V),
                        ...
                        g = { extraLarge: _, large: C, medium: m, small: d, extraSmall: c };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && D) return O(e, t, g);
                        if (t.largeWidth && o) return O(e, t, g);
                        if (t.mediumWidth && l) return O(e, t, g);
                        if (t.smallWidth && s) return O(e, t, g);
                        if (t.extraSmallWidth && B) return O(e, t, g);
                        if (
                    ...
                    (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(V),
                            ...
                            n = (0, r.useCallback)((u, e) => {
                                ...
                                a(Object.assign({ width: t, height: r }, k(t, r, P)));
                            }, []);
                        (c(() => {
                        ...
                        return E().createElement(V.Provider, { value: i }, u);
                    }));
                let j, X, K;
                (!(function (u) {
                ...
                const z = () => {
                    ...
                    Y = ['xl', 'lg', 'md', 'sm', 'xs'],
                    $ = (u) => u.includes('_') && ((u) => Y.includes(u))(u.split('_').at(-1)),
                    q = [j.ExtraLarge, j.Large, j.Medium, j.Small, j.ExtraSmall],
                    Z = (u, e) =>
                ...
                const tu = {
                    ...
                    Au = Q((u) => {
                        let e = u.className,
                            ...
                            v =
                                void 0 === b
                                    ...
                                    : b,
                            x = u.alignItems,
                            f = void 0 === x ? (c ? 'flex-start' : g && 'center') || (h && 'flex-end') || void 0 : x,
                            S = u.alignSelf,
                            L = u.wrap,
                            T = u.flexWrap,
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, A, i, D, l, B, N, k, S, d, O, v, f]),
                            V = W.computedStyle,
                            G = W.computedClassNames;
                        return E().createElement('div', eu({ className: M()(J.base, ...G, e), style: V }, I), H);
                    }),
                    au = 'FormatText_base_d0',
                    nu = ({ binding: u, text: e = '', classMix: t, alignment: A = n.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, a) =>
                                      E().createElement(
                                          'div',
                                          { className: M()(au, t), key: `${e}-${a}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : s(u, e))))(e, A, u).map((u, e) =>
                ...
                const su = Object.keys(Fu()),
                    ...
                    gu = Q((u) => {
                        ...
                        return E().createElement(
                            ...
                            lu(
                                {
                                    className: M()(Du.base, t && Du[t], h, A),
                                    style: g,
                                    mt: !0 === F ? du[t || 'paragraph-P16'].mt : F,
                                    mr: !0 === o ? du[t || 'paragraph-P16'].mr : o,
                                    mb: !0 === s ? du[t || 'paragraph-P16'].mb : s,
                                    ml: !0 === _ ? du[t || 'paragraph-P16'].ml : _,
                                },
                                d,
                            ),
                            void 0 !== m ? E().createElement(nu, lu({}, m, { text: e })) : e,
                        );
                    }),
                    hu = [
                        'children',
                ...
                const pu = (u, e, t = {}, r = 0) => {
                    ...
                    bu = (u) => {
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            b = (0, r.useMemo)(() => c || m().resId, [c]),
                            v = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (pu(t, B, { isMouseEvent: !0, on: !0, arguments: wu(E) }, b),
                                    g && g(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((p.current.timeoutId = window.setTimeout(v, D ? 100 : 400)),
                                                      A && A(u),
                                                      S && S(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                    ...
                    vu = {
                        base: 'ProgressionView_base_9a',
                        slideUp: 'ProgressionView_slideUp_e8',
                        slideDown: 'ProgressionView_slideDown_4a',
                        wrapper: 'ProgressionView_wrapper_89',
                        base__broken: 'ProgressionView_base__broken_07',
                        bg: 'ProgressionView_bg_68',
                        base__team1: 'ProgressionView_base__team1_b6',
                        base__team2: 'ProgressionView_base__team2_42',
                        base__team3: 'ProgressionView_base__team3_21',
                        base__team4: 'ProgressionView_base__team4_f1',
                        icon: 'ProgressionView_icon_a4',
                        separator: 'ProgressionView_separator_17',
                        teamName: 'ProgressionView_teamName_d8',
                        rank: 'ProgressionView_rank_cf',
                        base__hidden: 'ProgressionView_base__hidden_a1',
                        alertIcon: 'ProgressionView_alertIcon_ba',
                        fadeIn: 'ProgressionView_fadeIn_0f',
                        fadeOut: 'ProgressionView_fadeOut_c8',
                    },
                    xu = R.views.common.tooltip_window,
                    fu = R.images.gui.maps.icons.bob.hangar.widget,
                    Su = R.strings.bob.widget,
                    Mu = E().memo(({ onClick: u, onMouseEnter: e }) => {
                        const t = x('model'),
                            r = t.teamID,
                            A = t.rank,
                            a = t.rankState,
                            n = M()(vu.base, vu[`base__team${r}`], '' !== a && vu[`base__${a}`]),
                            i = { backgroundImage: `url(${fu.effects.$dyn(`h_line_${r}`)})` },
                            F = { backgroundImage: `url(${fu.bloggers.$dyn(`blogger_${r}`)})` },
                            D = { tooltipId: 'progressiveTooltip', teamID: r },
                            o = Su.$dyn(`blogger_${r}`);
                        return E().createElement(
                            bu,
                            {
                                ignoreShowDelay: !0,
                                contentId: xu.backport_tooltip_content.BackportTooltipContent('resId'),
                                decoratorId: xu.tooltip_window.TooltipWindow('resId'),
                                args: D,
                            },
                            E().createElement(
                                'div',
                                { className: n, onClick: u, onMouseEnter: e },
                                E().createElement(
                                    'div',
                                    { className: vu.wrapper },
                                    E().createElement('div', { className: vu.bg }),
                                    E().createElement('div', { className: vu.icon, style: F }),
                                    E().createElement(
                                        'div',
                                        { className: vu.rank },
                                        E().createElement(gu, { text: A.toString() }),
                                    ),
                                    E().createElement('div', { className: vu.separator, style: i }),
                                    E().createElement(
                                        'div',
                                        { className: vu.teamName },
                                        E().createElement(gu, { text: o }),
                                    ),
                                ),
                                E().createElement('div', { className: vu.alertIcon }),
                            ),
                        );
                    }),
                    Lu = 'SkillsView_base_b6',
                    Tu = 'SkillsView_wrapper_49',
                    Ou = 'SkillsView_base__inactive_e4',
                    Ru = 'SkillsView_icon_69',
                    Pu = 'SkillsView_label_62',
                    yu = 'SkillsView_time_db',
                    ku = 'SkillsView_timerIcon_d4',
                    Nu = 'SkillsView_count_df',
                    Hu = 'SkillsView_countIcon_7d',
                    Iu = R.views.common.tooltip_window,
                    Wu = R.images.gui.maps.icons.bob.hangar.widget.skill,
                    Vu = R.images.gui.maps.icons.bob.hangar.widget.inactive_icon(),
                    Gu = R.strings.bob.skill,
                    Uu = R.strings.bob.widget.skill.inactive(),
                    ju = E().memo(({ teamID: u, onClick: e, onMouseEnter: t }) => {
                        const r = x('model.skill'),
                            A = r.state,
                            a = r.skill,
                            n = r.timeLeft,
                            i = r.count,
                            F = 'inactive' === A,
                            D = F ? Uu : Gu.$dyn(a),
                            o = { tooltipId: 'skillTooltip', teamID: u },
                            l = { backgroundImage: `url(${F ? Vu : Wu.$dyn(a)})` },
                            s = M()(Lu, F && Ou);
                        return E().createElement(
                            bu,
                            {
                                ignoreShowDelay: !0,
                                contentId: Iu.backport_tooltip_content.BackportTooltipContent('resId'),
                                decoratorId: Iu.tooltip_window.TooltipWindow('resId'),
                                args: o,
                            },
                            E().createElement(
                                'div',
                                { className: s, onClick: e, onMouseEnter: t },
                                E().createElement(
                                    'div',
                                    { className: Tu },
                                    E().createElement('div', { className: Ru, style: l }),
                                    E().createElement('div', { className: Pu }, E().createElement(gu, { text: D })),
                                    E().createElement(
                                        'div',
                                        { className: yu },
                                        E().createElement('div', { className: ku }),
                                        E().createElement(gu, { text: n.toString() }),
                                    ),
                                ),
                                E().createElement(
                                    'div',
                                    ...
                                    E().createElement(gu, { text: i.toString() }),
                                ),
                            ),
                        );
                    }),
                    Xu = 'App_base_ba',
                    Ku = 'App_progression_59',
                    zu = 'App_skills_d4',
                    Yu = E().memo(() => {
                        const u = x('model'),
                            e = u.teamID,
                            t = u.onProgressionClick,
                            A = u.onSkillsClick,
                            a = (0, r.useCallback)(() => {
                                (f(R.sounds.gui_bb_bloggers_buttons_play()), t());
                            }, [t]),
                            n = (0, r.useCallback)(() => {
                                (f(R.sounds.gui_bb_bloggers_buttons_play()), A());
                            }, [A]),
                            i = (0, r.useCallback)(() => {
                                f(R.sounds.gui_bb_bloggers_highlight());
                            }, []);
                        return E().createElement(
                            'div',
                            { className: Xu },
                            E().createElement(
                                'div',
                                { className: Ku },
                                E().createElement(Mu, { onClick: a, onMouseEnter: i }),
                            ),
                            E().createElement(
                                'div',
                                { className: zu },
                                E().createElement(ju, { teamID: e, onClick: n, onMouseEnter: i }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    a().render(E().createElement(Yu, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [596], () => __webpack_require__(961));
