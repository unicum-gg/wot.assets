(() => {
    var __webpack_modules__ = {
            ...
            9062: (u, e, t) => {
                ...
                const C = o.O.client.getSize('rem'),
                    c = C.width,
                    m = C.height,
                    d = Object.assign({ width: c, height: m }, B(c, m, _)),
                    ...
                    b = (u) => {
                        ...
                        const a = (0, r.useContext)(g),
                            ...
                            p = { extraLarge: C, large: c, medium: m, small: d, extraSmall: b };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && D) return l(e, t, p);
                            if (t.largeWidth && o) return l(e, t, p);
                            if (t.mediumWidth && _) return l(e, t, p);
                            if (t.smallWidth && s) return l(e, t, p);
                ...
                ((b.defaultProps = {
                    ...
                    (0, r.memo)(b));
                const p = (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(g),
                        t = (0, r.useState)(e),
                        E = t[0],
                        A = t[1],
                        n = (0, r.useCallback)((u, e) => {
                            const t = o.O.view.pxToRem(u),
                                r = o.O.view.pxToRem(e);
                            A(Object.assign({ width: t, height: r }, B(t, r, _)));
                        }, []);
                    (((u) => {
                        ...
                        (0, r.useEffect)(() => () => engine.off('clientResized', n), [n]));
                    const F = (0, r.useMemo)(() => Object.assign({}, E), [E]);
                    return a().createElement(g.Provider, { value: F }, u);
                });
                let v, x, f;
                (!(function (u) {
                ...
                const w = () => {
                        ...
                        return { mediaSize: a, mediaWidth: E, mediaHeight: A, remScreenWidth: e, remScreenHeight: t };
                    },
                    L = ['xl', 'lg', 'md', 'sm', 'xs'],
                ...
                const N = {
                    ...
                    W = y((u) => {
                        let e = u.className,
                            ...
                            f =
                                void 0 === x
                                    ...
                                    : x,
                            w = u.alignItems,
                            L = void 0 === w ? (g ? 'flex-start' : h && 'center') || (b && 'flex-end') || void 0 : w,
                            S = u.alignSelf,
                            M = u.wrap,
                            O = u.flexWrap,
                        ...
                        const $ = (0, r.useMemo)(() => {
                            ...
                            }, [t, E, i, l, _, B, j, U, S, d, y, f, L]),
                            z = $.computedStyle,
                            V = $.computedClassNames;
                        return a().createElement('div', P({ className: F()(T.base, ...V, e), style: z }, K), X);
                    });
                let G;
                !(function (u) {
                        ...
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, A) =>
                                      a().createElement(
                                          'div',
                                          { className: F()('FormatText_base_d0', t), key: `${e}-${A}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                ...
                const J = Object.keys(q()),
                    ...
                    Eu = y((u) => {
                        ...
                        return a().createElement(
                            ...
                            void 0 !== m ? a().createElement(z, Q({}, m, { text: e })) : e,
                        );
                    });
                var Au = t(5521);
                t(4179);
                ...
                function Fu(u = Au.n.NONE, e = nu, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Au.n.NONE)
                            return (
                ...
                const Bu = (0, r.memo)(
                        ({
                            ...
                            const _ = (0, r.useState)(!1),
                                ...
                                g = F()(ou.bgOverlay, ou[`bgOverlay__${l}`], {
                                    [ou.bgOverlay__hover]: c,
                                    [ou.bgOverlay__active]: s,
                                    [ou.bgOverlay__disabled]: e,
                                }),
                                h = F()(ou.bgImage, ou[`bgImage__${l}`], {
                                    [ou.bgImage__hover]: c,
                                    [ou.bgImage__active]: s,
                                    [ou.bgImage__disabled]: e,
                                }),
                                b = F()(ou.content, ou[`content__${l}`], null == o ? void 0 : o.content),
                                p = F()(ou.bgLines, ou[`bgLines__${l}`], { [ou.bgLines__disabled]: e });
                            return a().createElement(
                                'div',
                                { className: E },
                                a().createElement(
                                    ...
                                    a().createElement(
                                        ...
                                        i &&
                                            a().createElement('div', {
                                                className: F()(ou.btnIcon, ou.btnIcon__left),
                                                style: { backgroundImage: `url(${i})` },
                                            }),
                                        a().createElement(Eu, { text: u }),
                                        A &&
                                            a().createElement('div', {
                                                className: F()(ou.btnIcon, ou.btnIcon__right),
                    ...
                    Cu = ({ onClick: u, text: e, classes: t }) => {
                        ...
                        return a().createElement(
                            'div',
                            { onClick: u, onMouseEnter: i, onMouseLeave: i, className: 'DefaultCloseButton_base_bf' },
                            a().createElement('div', { className: 'DefaultCloseButton_shine_e1' }),
                            a().createElement(Eu, {
                                className: F()('DefaultCloseButton_text_1d', null == t ? void 0 : t.text),
                                text: e,
                            }),
                            a().createElement(
                                'div',
                                { className: F()('DefaultCloseButton_icon_28', null == t ? void 0 : t.icon) },
                ...
                const gu = (u) => (0 === u ? window : window.subViews.get(u)),
                    hu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: A, mocks: n }) {
                                const F = (0, r.useRef)([]),
                                    i = (u, t, r) => {
                                        var a;
                                        const E = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const n = 'string' == typeof E ? `${r}.${E}` : r,
                                                            F = o.O.view.addModelObserver(n, e, !0);
                                                        return (a.set(F, t), u && t(A(E)), F);
                                                    },
                                                    readByPath: A,
                                                    createCallback: (u, e) => {
                                                        const t = A(e);
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : n(e),
                                                            a = mu.observable.box(r, { equals: cu });
                                                        return (
                                                            'real' === u &&
                                                                A.subscribe(
                                            ...
                                            l = { mode: u, model: D, externalModel: A, cleanup: i };
                                        return {
                                            model: D,
                                    ...
                                    _ = l[0],
                                    s = l[1],
                                    B = (0, r.useState)(() => i(u, E, n)),
                                    C = B[0],
                                    c = B[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        D.current ? c(i(_, E, n)) : (D.current = !0);
                                    }, [n, _, E]),
                                    (0, r.useEffect)(() => {
                                        s(u);
                                    }, [u]),
                        ...
                        onReset: u.createCallbackNoArgs('onReset'),
                    })),
                    bu = hu[0],
                    pu = hu[1],
                    vu = R.strings.portal_upgrade.upgrade,
                    xu = (0, lu.observer)(() => {
                        const u = pu().controls,
                            e = (0, r.useCallback)(() => {
                                u.onClose();
                            ...
                            t = (0, r.useCallback)(() => {
                                (u.onReset(), iu('ev_portal_gui_hangar_upgrade_reset_tree'));
                            }, [u]);
                        return (
                            (function ({
                                key: u = Au.n.ESCAPE,
                            ...
                            a().createElement(
                                'div',
                                { className: 'App_base_7c' },
                                a().createElement(
                                    'div',
                                    { className: 'App_close_72' },
                                    a().createElement(Cu, { onClick: e, text: vu.closeButton.default() }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: 'App_resetWrapper_ff' },
                                    a().createElement('div', { className: 'App_glow_d3' }),
                                    a().createElement('div', { className: 'App_img_aa' }),
                                    a().createElement(
                                        'div',
                                        { className: 'App_textWrapper_08' },
                                        a().createElement(Eu, {
                                            className: 'App_title_5f',
                                            text: vu.resetUpgrade.title(),
                                        }),
                                        a().createElement(Eu, {
                                            className: 'App_label_01',
                                            text: vu.resetUpgrade.label(),
                                        }),
                                    ),
                                    a().createElement(
                                        'div',
                                        { className: 'App_actionsWrapper_2e' },
                                        a().createElement(Bu, { title: vu.reset(), size: _u.Medium, onClick: t }),
                                        a().createElement(Bu, {
                                            title: vu.cancel(),
                                            size: _u.Medium,
                                            type: su.Secondary,
                ...
                const Mu = {
                    ...
                    Tu = (u) => {
                        ...
                        const E = w(),
                            ...
                            n = E.mediaHeight,
                            i = E.mediaSize;
                        return a().createElement('div', Su({ className: F()(t, Mu[A], Ou[n], yu[i]) }, r), e);
                    },
                    Ru = ['children'],
                    Hu = (u) => {
                        let e = u.children,
                        ...
                        return a().createElement(p, null, a().createElement(Tu, t, e));
                    };
                engine.whenReady.then(() => {
                    A().render(
                        a().createElement(bu, null, a().createElement(Hu, null, a().createElement(xu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(9062));
