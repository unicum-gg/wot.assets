(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                ...
                function d(u, e, t, E, r, A, F) {
                    ...
                    n.done ? e(i) : Promise.resolve(i).then(E, r);
                }
            ...
            7166: (u, e, t) => {
                ...
                const l = i.O.client.getSize('rem'),
                    B = l.width,
                    s = l.height,
                    C = Object.assign({ width: B, height: s }, o(B, s, a)),
                    c = (0, E.createContext)(C),
                    d = ['children'],
                    _ = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.smallWidth && s) return n(e, t, w);
                    ...
                    const e = (0, E.useContext)(c),
                        ...
                        n = (0, E.useCallback)((u, e) => {
                            const t = i.O.view.pxToRem(u),
                                E = i.O.view.pxToRem(e);
                            F(Object.assign({ width: t, height: E }, o(t, E, a)));
                        }, []);
                    ((u) => {
                ...
                const S = {
                    ...
                    O = (u) => {
                        ...
                        const F = (() => {
                            ...
                            i = F.mediaHeight,
                            a = F.mediaSize;
                        return r().createElement('div', L({ className: g()(t, S[n], M[i], T[a]) }, A), e);
                    },
                    y = ['children'],
                    k = (u) => {
                        let e = u.children,
                ...
                const W = (u) => (0 === u ? window : window.subViews.get(u)),
                    N = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: A, children: F, mocks: n }) {
                                const a = (0, E.useRef)([]),
                                    D = (u, t, E) => {
                                        var r;
                                        const A = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, A) => {
                                                        const n = 'string' == typeof A ? `${E}.${A}` : E,
                                                            a = i.O.view.addModelObserver(n, e, !0);
                                                        return r.set(a, t), u && t(F(A)), a;
                                                    },
                                                    readByPath: F,
                                                    createCallback: (u, e) => {
                                                        const t = F(e);
                                            ...
                                            n = (e) =>
                                                'mocks' === u ? (null == E ? void 0 : E.getter(e)) : F.readByPath(e),
                                            ...
                                            o = (({ observableModel: u }) => {
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const E = null != t ? t : n(e),
                                                            r = P.observable.box(E, { equals: H });
                                                        return (
                                                            'real' === u &&
                                                                F.subscribe(
                                                                    (0, P.action)((u) => r.set(u)),
                                                                    e,
                                                                ),
                                                            r
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const r = e.reduce(
                                                                (u, e) => ((u[e] = P.observable.box(E[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                                        ...
                                        return {
                                            model: o,
                                            controls: 'mocks' === u && E ? E.controls(l) : e(l),
                                            externalModel: F,
                                            mode: u,
                                        };
                                    },
                                    ...
                                    B = l[0],
                                    s = l[1],
                                    C = (0, E.useState)(() => D(u, A, n)),
                                    c = C[0],
                                    d = C[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        o.current ? d(D(B, A, n)) : (o.current = !0);
                                    }, [n, B, A]),
                                    (0, E.useEffect)(() => {
                                        s(u);
                                    }, [u]),
                ...
                const J = R.views.common.tooltip_window.simple_tooltip_content,
                    uu = (u) => {
                        ...
                        const D = (0, E.useMemo)(() => {
                            const u = Object.assign({}, i, { body: t, header: A, note: F, alert: n });
                        ...
                        return r().createElement(
                            ...
                            Q(
                                {
                                    contentId:
                                        ((o = null == i ? void 0 : i.hasHtmlContent),
                                        o ? J.SimpleTooltipHtmlContent('resId') : J.SimpleTooltipContent('resId')),
                ...
                const ru = {
                    base: 'App_base_fc',
                    banner: 'App_banner_9c',
                    title: 'App_title_1c',
                    background: 'App_background_61',
                    background__hover: 'App_background__hover_0a',
                    banner__offence: 'App_banner__offence_b1',
                    banner__defence: 'App_banner__defence_78',
                };
                let Au;
                !(function (u) {
                ...
                const Fu = (u, e, t) => {
                    ...
                    iu = (u, e, t = Au.left) => u.split(e).reduce(t === Au.left ? Fu : nu, []),
                    au = (() => {
                        const u = new RegExp(
                    ...
                    ou = ({ binding: u, text: e = '', classMix: t, alignment: A = Au.left }) =>
                        null === e
                            ...
                            : r().createElement(
                                  ...
                                  e.split('\n').map((e, F) =>
                                      r().createElement(
                                          'div',
                                          { className: g()('FormatText_base_d0', t), key: `${e}-${F}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                    ...
                    lu = R.strings.hb_lobby.shopWidget,
                    Bu = (0, j.observer)(() => {
                        const u = G(),
                            e = u.controls,
                            t = u.model.root.get().frontType,
                            A = g()(ru.banner, ru[`banner__${t}`]),
                            F = (0, E.useCallback)(() => {
                                z.playClick(), e.onClick();
                            }, [e]);
                        return r().createElement(
                            'div',
                            { className: ru.base },
                            r().createElement(
                                uu,
                                { header: lu.tooltip.header(), body: lu.tooltip.body() },
                                r().createElement(
                                    'div',
                                    {
                                        className: A,
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: ru.title },
                                        r().createElement(ou, { text: lu.title() }),
                                    ),
                                    r().createElement('div', { className: ru.background }),
                                    r().createElement('div', { className: g()(ru.background, ru.background__hover) }),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    F().render(
                        r().createElement(k, null, r().createElement(U, null, r().createElement(Bu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(7166));
