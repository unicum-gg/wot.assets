        ...
        F = {
                ...
                const t = ({
                    ...
                    return e().createElement(
                        ...
                        o.split('\n').map((F, t) =>
                            e().createElement(
                                'div',
                                { className: D()(r.Z.base, A), key: `${F}-${t}` },
                                (0, B.Uw)(F, E, u).map((u, F) =>
                                    e().createElement(C.Fragment, { key: `${F}-${u}` }, u),
                                ),
                            ),
                        ),
                    );
            ...
            3649: (u, F, A) => {
                ...
                const C = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    t = (u, F, A = D.left) => u.split(F).reduce(A === D.left ? e : r, []),
                    o = (() => {
                        const u = new RegExp(
                    ...
                    a = (u, F = D.left) => {
                        ...
                        return ((u, F = D.left) => {
                            ...
                            const E =
                                ...
                                B = C(u);
                            return t(B, /( )/, F).forEach((u) => (A = A.concat(t(u, E, D.left)))), A;
                        })(u, F);
                    },
                    l = (u, F, A) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : a(u, F)));
            },
            406: (u, F, A) => {
                var E = A(280),
                    D = A(6179),
                ...
                (0, D.memo)((u) => {
                    ...
                    const o = ((u, F) => {
                            ...
                            for (; t; ) {
                                ...
                                if (s && i) {
                                    const u = s[0],
                                        A = u + n++ + i[0].replaceAll(')', '') + u;
                                    (o = o.replace(l, `%(${A})`)),
                                        (r[A] = C[u]
                                            ? B().createElement(
                                                  'span',
                                                  { className: C[u] },
                                                  B().createElement(E.z, { text: c, binding: F }),
                                              )
                                            : B().createElement(
                                                  'span',
                                                  { style: ((a = u), { color: `#${a}` }) },
                        ...
                        n = o[0],
                        a = o[1];
                    return B().createElement(E.z, r({ text: n, classMix: D, binding: a }, t));
                });
            },
            5287: (u, F, A) => {
                A.d(F, { Z: () => E });
        ...
        (E.O = (F, A, D, B) => {
            if (!A) {
                ...
                for (o = 0; o < u.length; o++) {
                    for (var [A, D, B] = u[o], e = !0, r = 0; r < A.length; r++)
