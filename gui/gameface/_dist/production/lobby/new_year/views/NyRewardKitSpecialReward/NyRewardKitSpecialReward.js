(() => {
    var __webpack_modules__ = {
            ...
            4378: (u, e, t) => {
                ...
                const L = {
                    ...
                    M = (u) => {
                        ...
                        const r = b(),
                            ...
                            o = r.mediaHeight,
                            s = r.mediaSize;
                        return a().createElement('div', y({ className: h()(t, L[i], S[o], T[s]) }, n), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                const Q = () => {},
                    ...
                    uu = 'Video_video_e6',
                    eu = 'Video_video__visible_c9',
                    tu = () => (0, n.useRef)({ duration: void 0, onReady: Q }).current;
                let nu;
                !(function (u) {
                ...
                const au = a().memo(function ({
                    ...
                    const d = (0, n.useRef)(null),
                        _ = (0, n.useRef)(0),
                        D = (0, n.useState)(nu.Initial),
                        B = D[0],
                        m = D[1],
                        C = ((u) => {
                            const e = (0, n.useState)(J(u ? u.current : null)),
                                t = e[0],
                                a = e[1];
                            return (
                                (0, n.useEffect)(() => {
                        ...
                        L = (0, n.useCallback)(() => {
                            cancelAnimationFrame(_.current), i && i();
                        }, [i]),
                        S = (0, n.useCallback)(
                            (u) => {
                                d.current && l && !d.current.ended && (u ? d.current.pause() : d.current.play());
                            },
                            [l],
                        );
                    (0, n.useEffect)(() => {
                        ...
                        return (
                            u &&
                                (u.addEventListener('ended', p),
                                u.addEventListener('playing', y),
                                u.addEventListener('pause', L),
                                engine.on('clientMinimized', S)),
                            () => {
                                u &&
                                    (u.removeEventListener('ended', p),
                                    u.removeEventListener('playing', y),
                                    u.removeEventListener('pause', L),
                                    engine.off('clientMinimized', S));
                            }
                        );
                    }, [S, p, L, y, w]),
                        (0, n.useEffect)(() => {
                        ...
                        (0, n.useEffect)(() => {
                            const u = d.current;
                            u && A && ((u.currentTime = u.duration), u.pause(), m(nu.Ended));
                        }, [A]),
                        (0, n.useEffect)(() => {
                            const u = d.current;
                            C && u && !u.ended && (F ? u.pause() : u.paused && u.play());
                        }, [F, C]),
                        (0, n.useEffect)(() => () => cancelAnimationFrame(_.current), []);
                    ...
                    return a().createElement(
                        ...
                        E &&
                            a().createElement('div', {
                                className: h()(uu, B === nu.Ended && eu),
                                style: Object.assign({}, M, { backgroundImage: `url(${E})` }),
                            }),
                    );
                });
                function ru() {
                ...
                const Eu = ((u, e) => {
                        ...
                        ({ externalModel: u }) => ({
                            ...
                            onGoToReward: u.createCallbackNoArgs('onGoToReward'),
                ...
                const Bu = Du,
                    mu = 'TankName_base_c0',
                    Cu = 'TankName_type_3c',
                    hu = 'TankName_type__elite_c7',
                    gu = R.images.gui.maps.icons.vehicleTypes.big,
                    vu = ({
                        vehicleName: u,
                        vehicleImagePath: e,
                        vehicleLvl: t,
                        ...
                        const o = e || gu.$dyn(K(r));
                        return a().createElement(
                            'div',
                            { className: h()(mu, n && n.base) },
                            t,
                            a().createElement('div', {
                                className: h()(!e && Cu, !e && i && hu, n && n.icon),
                    ...
                    fu = 'Content_base_c9',
                    pu = 'Content_buttons_38',
                    wu = 'Content_button_da',
                    bu = 'Content_button__gap_86',
                    xu = 'Content_text_44',
                    yu = 'Content_tankName_4f',
                    Lu = 'Content_title_cd',
                    Su = 'Content_title__guaranteedReward_99',
                    Tu = 'Content_buttonText_dd',
                    Mu = R.strings.lootboxes.specialReward,
                    Ou = (0, Y.Pi)(() => {
                        const u = Au(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                i === V
                                    ? a().createElement(
                                          'div',
                                          { className: Lu },
                                          R.strings.lootboxes.specialReward.StyleLootBoxCongrats.title(),
                                      )
                                    : o &&
                                          a().createElement(
                                              'div',
                                              { className: h()(Lu, Su) },
                                              R.strings.lootboxes.specialReward.guaranteedReward(),
                                          ),
                                a().createElement(vu, {
                                    isElite: l,
                                    vehicleName: s,
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    Bu,
                                    { onClick: A, size: _u.medium, type: du.primary, mixClass: d },
                                    Mu.continueBtn(),
                                ),
                                a().createElement(
                                    Bu,
                                    { onClick: F, size: _u.medium, type: du.secondary, mixClass: wu },
                                    a().createElement('div', { className: Tu }, Mu.goToBtn.$dyn(i)),
                                ),
                            ),
                        );
                    }),
                    ...
                    Hu = 'App_vignette_1f',
                    Pu = 'App_content_00',
                    Nu = 'App_content__visible_36',
                    Wu = 'App_closeButton_ca',
                    Iu = 'App_closeButton__visible_d8',
                    Gu = 'App_label_a6',
                    Uu = 'App_label__hidden_52',
                    Vu = 'App_label__forceHidden_90';
                var $u;
                !(function (u) {
                    (u.Initial = 'initial'),
                        (u.Playing = 'playing'),
                ...
                const ju = R.strings.lootboxes.specialReward,
                    zu = R.videos.new_year,
                    qu = R.images.gui.maps.icons.newYear.loot_box,
                    Ku = (0, Y.Pi)(() => {
                        const u = Au(),
                            e = u.model,
                            t = u.controls,
                            ...
                            i = r.congratsType,
                            o = r.videoSource,
                            s = r.isViewAccessible,
                            l = r.isGuaranteedReward,
                            E = tu(),
                            c = (0, n.useRef)({ hideTime: 0 }),
                            A = i === V,
                            F = (0, n.useState)($u.Initial),
                            d = F[0],
                            _ = F[1],
                            D = (0, n.useState)(!1),
                            B = D[0],
                        ...
                        (0, n.useEffect)(() => {
                            E.onReady = () => {
                                const u = E.duration;
                                u && (c.current.hideTime = u - 1);
                            };
                        }, [E]);
                        const C = (0, n.useCallback)(() => {
                                d === $u.Playing ? (t.onVideoStopped(), _($u.Interrupted)) : t.onClose();
                            }, [t, d]),
                            g = (0, n.useCallback)(() => {
                                d === $u.Initial && t.onVideoStarted(), _($u.Playing);
                            }, [t, d]),
                            v = (0, n.useCallback)(() => {
                                _($u.Ended), t.onVideoStopped();
                            }, [t]);
                        z($.n.ESCAPE, C);
                        const f = d === $u.Ended || d === $u.Interrupted,
                            p = h()(Pu, f && Nu),
                            w = h()(Wu, f && Iu),
                            b = i === V ? zu.StyleLootBoxCongrats : zu.VehicleLootBoxCongrats,
                            x = qu[A ? 'style_congrats' : 'vehicle_congrats'],
                            y = K(o);
                        return a().createElement(
                            'div',
                            ...
                            a().createElement(au, {
                                api: E,
                                src: b.$dyn(y),
                                lastFrameSrc: x.$dyn(y),
                                className: ku,
                                autoPlay: !0,
                                forceToEnd: d === $u.Interrupted,
                                forceToPause: !s,
                                onVideoPlay: g,
                                onVideoEnd: v,
                                onVideoTimeUpdated: l
                                    ? (u) => {
                                          const e = c.current.hideTime;
                                          if (e && u >= e) return m(!0), !0;
                                      }
                                    : void 0,
                            }),
                            l &&
                                a().createElement(
                                    'div',
                                    { className: h()(Gu, B && Uu, d === $u.Interrupted && Vu) },
                                    ju.guaranteedRewardReceived(),
                                ),
                            ...
                            a().createElement('div', { className: p }, a().createElement(Ou, null)),
                        );
                    });
                engine.whenReady.then(() => {
                    P().render(
                        a().createElement(k, null, a().createElement(cu, null, a().createElement(Ku, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(4378));
