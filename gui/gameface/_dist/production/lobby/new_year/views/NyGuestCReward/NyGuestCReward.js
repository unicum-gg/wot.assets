(() => {
    var __webpack_modules__ = {
            ...
            850: (u, e, t) => {
                ...
                const l = i.O.client.getSize('rem'),
                    A = l.width,
                    c = l.height,
                    F = Object.assign({ width: A, height: c }, E(A, c, o)),
                ...
                const _ = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.largeWidth && c) return a(e, t, f);
                ...
                const S = {
                    ...
                    M = (u) => {
                        ...
                        const a = b(),
                            ...
                            o = a.mediaHeight,
                            s = a.mediaSize;
                        return r().createElement('div', L({ className: h()(t, S[i], y[o], T[s]) }, n), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                class U extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            F = h()(W.base, W[`base__${i}`], W[`base__${a}`], null == o ? void 0 : o.base),
                            d = h()(W.icon, W[`icon__${i}`], W[`icon__${a}`], null == o ? void 0 : o.icon),
                            D = h()(W.glow, null == o ? void 0 : o.glow),
                            _ = h()(W.caption, W[`caption__${i}`], null == o ? void 0 : o.caption),
                ...
                function $(u = V.n.NONE, e = j, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== V.n.NONE)
                            return (
                ...
                const Z = () => {},
                    ...
                    Q = 'Video_video_e6',
                    J = 'Video_video__visible_c9',
                    uu = () => (0, n.useRef)({ duration: void 0, onReady: Z }).current;
                let eu;
                !(function (u) {
                    ((u[(u.Initial = 0)] = 'Initial'), (u[(u.Ended = 1)] = 'Ended'));
                })(eu || (eu = {}));
                const tu = r().memo(function ({
                    ...
                    const d = (0, n.useRef)(null),
                        D = (0, n.useRef)(0),
                        _ = (0, n.useState)(eu.Initial),
                        B = _[0],
                        C = _[1],
                        m = ((u) => {
                            const e = (0, n.useState)(X(u ? u.current : null)),
                                t = e[0],
                                r = e[1];
                            return (
                                (0, n.useEffect)(() => {
                            ...
                            (cancelAnimationFrame(D.current),
                                d.current &&
                                    (A
                                        ...
                                        : (d.current.pause(), C(eu.Ended))),
                                !A && o && o());
                        }, [A, o]),
                        p = (0, n.useCallback)(() => {
                            const u = d.current;
                            return u && s && s(u.currentTime);
                        }, [s]),
                        x = (0, n.useCallback)(() => {
                            cancelAnimationFrame(D.current);
                            const u = () => {
                        ...
                        S = (0, n.useCallback)(() => {
                            (cancelAnimationFrame(D.current), i && i());
                        }, [i]),
                        y = (0, n.useCallback)(
                            (u) => {
                                d.current && E && !d.current.ended && (u ? d.current.pause() : d.current.play());
                            },
                            [E],
                        );
                    ((0, n.useEffect)(() => {
                        ...
                        return (
                            u &&
                                (u.addEventListener('ended', w),
                                u.addEventListener('playing', L),
                                u.addEventListener('pause', S),
                                engine.on('clientMinimized', y)),
                            () => {
                                u &&
                                    (u.removeEventListener('ended', w),
                                    u.removeEventListener('playing', L),
                                    u.removeEventListener('pause', S),
                                    engine.off('clientMinimized', y));
                            }
                        );
                    }, [y, w, S, L, p]),
                        (0, n.useEffect)(() => {
                            if (!m) return;
                            const u = d.current;
                            e && ((e.duration = null == u ? void 0 : u.duration), e.onReady());
                        }, [e, m]),
                        (0, n.useEffect)(() => {
                            const u = d.current;
                            u && c && ((u.currentTime = u.duration), u.pause(), C(eu.Ended));
                        }, [c]),
                        (0, n.useEffect)(() => {
                            const u = d.current;
                            m && u && !u.ended && (F ? u.pause() : u.paused && u.play());
                        }, [F, m]),
                        (0, n.useEffect)(() => () => cancelAnimationFrame(D.current), []));
                    const T = (0, n.useRef)({ width: 0, height: 0, inited: !1 });
                    (0, n.useEffect)(() => {
                        const u = d.current,
                            e = T.current;
                        u && ((e.width = u.videoWidth), (e.height = u.videoHeight), (e.inited = !0));
                    });
                    const M = (() => {
                        const u = T.current;
                        if (u.inited) {
                    ...
                    return r().createElement(
                        ...
                        l &&
                            r().createElement('div', {
                                className: h()(Q, B === eu.Ended && J),
                                style: Object.assign({}, M, { backgroundImage: `url(${l})` }),
                            }),
                    );
                });
                function nu() {
                ...
                const su = ((u, e) => {
                        ...
                        ({ externalModel: u }) => ({
                            onContinue: u.createCallbackNoArgs('onContinue'),
                            onGoQuests: u.createCallbackNoArgs('onGoQuests'),
                            onClose: u.createCallbackNoArgs('onClose'),
                            onVideoStarted: u.createCallbackNoArgs('onVideoStarted'),
                            onVideoStopped: u.createCallbackNoArgs('onVideoStopped'),
                        }),
                    ),
                    Eu = su[0],
                    lu = su[1],
                ...
                const Du = du,
                    _u = 'Content_base_56',
                    Bu = 'Content_buttons_fc',
                    Cu = 'Content_button_e6',
                    mu = 'Content_title_ca',
                    hu = 'Content_description_65',
                    gu = 'Content_buttonText_c8',
                    vu = R.strings.ny.guestRewardView,
                    fu = (0, z.Pi)(() => {
                        const u = lu().controls;
                        return r().createElement(
                            'div',
                            { className: _u },
                            r().createElement('div', { className: mu }, vu.title()),
                            r().createElement('div', { className: hu }, ' ', vu.description()),
                            r().createElement(
                                'div',
                                { className: Bu },
                                r().createElement(
                                    Du,
                                    { onClick: () => u.onGoQuests(), size: Fu.medium, type: cu.primary, mixClass: Cu },
                                    r().createElement('div', { className: gu }, vu.toQuestsBtn()),
                                ),
                            ),
                        );
                    }),
                    ...
                    pu = 'App_video_e4',
                    bu = 'App_vignette_42',
                    xu = 'App_vignette__visible_f8',
                    Lu = 'App_closeButton_5b',
                    Su = 'App_content_8b',
                    yu = 'App_content__visible_ca';
                let Tu;
                !(function (u) {
                    ((u[(u.Space = 32)] = 'Space'),
                        (u[(u.Enter = 13)] = 'Enter'),
                ...
                const ku = (0, z.Pi)(() => {
                    const u = lu(),
                        e = u.model,
                        t = u.controls,
                        a = e.root.get().isViewAccessible,
                        i = uu(),
                        o = (0, n.useRef)({ hideTime: 0 }),
                        s = (0, n.useState)(Ou.Initial),
                        E = s[0],
                        l = s[1];
                    (0, n.useEffect)(() => {
                        i.onReady = () => {
                            const u = i.duration;
                            u && (o.current.hideTime = u - 1);
                        };
                    }, [i]);
                    const A = (0, n.useCallback)(() => {
                            E === Ou.Playing ? (t.onVideoStopped(), l(Ou.Interrupted)) : t.onClose();
                        }, [t, E]),
                        c = (0, n.useCallback)(() => {
                            E === Ou.Playing && (t.onVideoStopped(), l(Ou.Interrupted));
                        }, [t, E]),
                        F = (0, n.useCallback)(() => {
                            (E === Ou.Initial && t.onVideoStarted(), l(Ou.Playing));
                        }, [t, E]),
                        d = (0, n.useCallback)(() => {
                            (l(Ou.Ended), t.onVideoStopped());
                        }, [t]);
                    ($(V.n.ESCAPE, A), Mu({ [V.n.SPACE]: c }));
                    const D = E === Ou.Ended || E === Ou.Interrupted,
                        _ = h()(Su, D && yu);
                    return r().createElement(
                        'div',
                        { className: wu, lang: R.strings.settings.LANGUAGE_CODE() },
                        r().createElement(tu, {
                            api: i,
                            src: R.videos.new_year.GuestRewardCongrats.guestC(),
                            lastFrameSrc: R.images.gui.maps.icons.newYear.video.guest_congrats.guest_c(),
                            className: pu,
                            autoPlay: !0,
                            forceToEnd: E === Ou.Interrupted,
                            forceToPause: !a,
                            onVideoPlay: F,
                            onVideoEnd: d,
                        }),
                        r().createElement('div', { className: h()(bu, D && xu) }),
                        r().createElement(
                            'div',
                            { className: Lu },
                            r().createElement(U, {
                        ...
                        r().createElement('div', { className: _ }, r().createElement(fu, null)),
                    );
                });
                engine.whenReady.then(() => {
                    P().render(
                        r().createElement(k, null, r().createElement(Eu, null, r().createElement(ku, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(850));
