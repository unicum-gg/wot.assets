(() => {
    var __webpack_modules__ = {
            ...
            996: (u, e, t) => {
                ...
                const o = E.O.client.getSize('rem'),
                    s = o.width,
                    l = o.height,
                    D = Object.assign({ width: s, height: l }, F(s, l, i)),
                ...
                const M = {
                    ...
                    T = (u) => {
                        ...
                        const n = x(),
                            ...
                            i = n.mediaHeight,
                            A = n.mediaSize;
                        return a().createElement('div', f({ className: d()(t, M[E], S[i], L[A]) }, r), e);
                    },
                    y = ['children'],
                    O = (u) => {
                        let e = u.children,
                    ...
                    U = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: n, children: i, mocks: A }) {
                                const F = (0, r.useRef)([]),
                                    o = (u, t, r) => {
                                        ...
                                        const n = (function ({
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : A(e),
                                                            a = W.observable.box(r, { equals: N });
                                                        return (
                                                            'real' === u &&
                                                                i.subscribe(
                                                                    (0, W.action)((u) => a.set(u)),
                                                                    e,
                                                                ),
                                                            a
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const a = e.reduce(
                                                                (u, e) => ((u[e] = W.observable.box(r[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                                            ...
                                            l = { mode: u, model: s, externalModel: i, cleanup: o };
                                        return {
                                            model: s,
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        s.current ? C(o(D, n, A)) : (s.current = !0);
                                    }, [A, D, n]),
                                    (0, r.useEffect)(() => {
                                        _(u);
                                    }, [u]),
                        ...
                        buyToy: u.createCallbackNoArgs('onBuy'),
                    })),
                    j = U[0],
                    X = U[1];
                function V(u) {
                    ...
                    const c = (0, r.useRef)(null),
                        ...
                        P = d()(
                            ...
                            K[`base__${n}`],
                            {
                                ...
                                [K.base__firstHover]: x,
                            },
                            i,
                        ),
                        k = d()(K.state, K.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                ...
                const iu = {
                    ...
                    ou = ru((u) => {
                        ...
                        const I = (0, r.useMemo)(() => {
                            ...
                            }, [t, n, A, o, l, _, k, P, S, m, y, w, M]),
                            G = I.computedStyle,
                            U = I.computedClassNames;
                        return a().createElement('div', Eu({ className: d()(au.base, ...U, e), style: G }, W), N);
                    });
                let su;
                !(function (u) {
                ...
                const lu = (u, e, t) => {
                    ...
                    _u = (u, e, t = su.left) => u.split(e).reduce(t === su.left ? lu : Du, []),
                    Bu = (() => {
                        const u = new RegExp(
                    ...
                    Cu = ({ binding: u, text: e = '', classMix: t, alignment: n = su.left }) =>
                        null === e
                ...
                const bu = Object.keys(du()),
                    ...
                    Su = ru((u) => {
                        ...
                        return a().createElement(
                            ...
                            pu(
                                {
                                    className: d()(hu.base, t && hu[t], p, n),
                                    style: g,
                            ...
                            void 0 !== C ? a().createElement(Cu, pu({}, C, { text: e })) : e,
                        );
                    });
                var Lu = t(5521),
                    Tu = t(4179);
                ...
                function Ou(u = Lu.n.NONE, e = yu, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Lu.n.NONE)
                            return (
                ...
                const Ru = {
                    ...
                    Nu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                        ...
                        return a().createElement(Cu, { text: A, classMix: t, binding: E });
                    });
                ...
                const Uu = (u, e, t = {}, r = 0) => {
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Uu(t, _, { isMouseEvent: !0, on: !0, arguments: Gu(a) }, b),
                                    d && d(),
                    ...
                    Xu = 'App_button_d3',
                    Vu = R.strings.ny.petBuyToy,
                    Ku = { header: Vu.tooltip.header(), description: Vu.tooltip.description() },
                    zu = (0, k.observer)(() => {
                        const u = X(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: 'App_base_28' },
                                a().createElement(
                                    'div',
                                    { className: 'App_coverWrapper_14' },
                                    a().createElement(
                                        'div',
                                        { className: 'App_cover_78' },
                                        a().createElement('div', {
                                            className: 'App_background_2f',
                                            style: {
                                                backgroundImage: `url(R.images.new_year.gui.maps.icons.newYear.toys.c_2026.${l}.${i})`,
                                            },
                                        }),
                                        a().createElement(
                                            'div',
                                            { className: 'App_textWrapper_a3' },
                                            a().createElement(Su, {
                                                text: Vu.title(),
                                                className: 'App_title_fd',
                                                format: { binding: { toyName: E } },
                                            }),
                                            a().createElement(Nu, {
                                                text: Vu.description(),
                                                classMix: 'App_description_d2',
                                            }),
                                        ),
                                    ),
                                ),
                                a().createElement(
                                    'div',
                                    { className: 'App_footer_a3' },
                                    a().createElement(
                                        'div',
                                        { className: 'App_footerTextWrapper_8f' },
                                        a().createElement(Su, { className: 'App_footerText_7c', text: Vu.cost() }),
                                        a().createElement(
                                            'div',
                                            { className: d()('App_cost_d7', F && 'App_cost__notEnough_0a') },
                                            a().createElement(Wu, { value: A, format: 'gold' }),
                                            a().createElement('div', { className: 'App_goldIcon_20' }),
                                        ),
                                    ),
                                    a().createElement(
                                        'div',
                                        { className: 'App_buttonHolder_d4' },
                                        a().createElement(
                                            ju,
                                            {
                                                contentId:
                                            ...
                                            a().createElement(
                                                ...
                                                a().createElement(
                                                    ...
                                                    a().createElement(Su, { text: Vu.buyBtn() }),
                                                ),
                                            ),
                                        ),
                                        a().createElement(
                                            Y,
                                            { type: z.secondary, size: $.medium, onClick: s, mixClass: Xu },
                                            a().createElement(Su, { text: Vu.cancelBtn() }),
                                        ),
                                    ),
                                ),
                            )
                ...
                engine.whenReady.then(() => {
                    P().render(
                        a().createElement(j, null, a().createElement(O, null, a().createElement(zu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(996));
