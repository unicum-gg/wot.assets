(() => {
    ...
    var __webpack_modules__ = {
                ...
                const i = ({
                    ...
                    return r().createElement(
                        ...
                        a.split('\n').map((e, i) =>
                            r().createElement(
                                'div',
                                { className: E()(o.Z.base, t), key: `${e}-${i}` },
            ...
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => a, off: () => o, on: () => r, onResize: () => A, onScaleUpdated: () => F }));
                var n = t(2472),
                    E = t(1176);
            ...
            3649: (u, e, t) => {
                ...
                const F = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    i = (u, e, t = E.left) => u.split(e).reduce(t === E.left ? r : o, []),
                    a = (() => {
                        const u = new RegExp(
            ...
            406: (u, e, t) => {
                ...
                const i = (0, E.memo)((u) => {
                    ...
                    const a = ((u, e) => {
                        ...
                        D = a[0],
                        s = a[1];
                    return A().createElement(n.z, o({ text: D, classMix: E, binding: s }, i));
                });
            },
            8649: (u, e, t) => {
                var n = t(6179),
                ...
                const C = ({
                    ...
                    return (
                        (0, n.useEffect)(() => {
                            function u(u) {
                                b && null !== p.current && !p.current.contains(u.target) && f(!1);
                            }
                            return (
                            ...
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    F ||
                                        (null !== B && i(B),
                                        c && c(u),
                                        t && (F || (p.current && (p.current.focus(), f(!0)))),
                                        w(!0));
                                },
                ...
                C.defaultProps = { type: s.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const l = C;
                var c = t(9916);
                const d = [
                    'children',
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (m(t, C, { isMouseEvent: !0, on: !0, arguments: _(E) }, w),
                                    b && b(),
                ...
                const f = R.views.common.tooltip_window.simple_tooltip_content,
                            ...
                            b(
                                {
                                    contentId:
                                        ...
                                        D ? f.SimpleTooltipHtmlContent('resId') : f.SimpleTooltipContent('resId')),
                    ...
                    g = 'TextOverflow_base_3b',
                    w = ['content', 'classMix', 'className'];
                function y() {
                    return (
                        (y = Object.assign
                            ? Object.assign.bind()
                    ...
                    return (
                        (0, n.useEffect)(() =>
                            ((u) => {
                                ...
                                const u = r.current;
                                u && u.offsetWidth >= u.scrollWidth && D(!1);
                            }),
                        ),
                        E().createElement(
                            h,
                            { isEnabled: a, body: e },
                            E().createElement('div', y({}, F, { ref: r, className: o()(g, A, t) }), e),
                        )
                    );
                };
                let T;
                !(function (u) {
                    ((u.Personal = 'Personal'), (u.Friends = 'Friends'), (u.findFriends = 'FindFriends'));
                })(T || (T = {}));
                var x = t(3403),
                    k = t(406);
                const P = 'Background_base_40',
                    M = 'Background_base__popUp_48',
                    S = 'Background_base__withoutBorder_11',
                    N = 'Background_image_33',
                    L = ({
                    ...
                    I = 'CloseButton_base_9f',
                    U = ({ classNames: u }) =>
                        E().createElement('div', {
                            className: o()(I, null == u ? void 0 : u.base),
                            onMouseEnter: a.playHighlight,
                            onClick: () => i(R.sounds.cancelcloseno()),
                        }),
                    W = 'NotificationDecorator_base_e0',
                    V = 'NotificationDecorator_base__popUp_9f',
                    j = 'NotificationDecorator_closeButton_21',
                    G = 'NotificationDecorator_content_dc',
                    z = 'NotificationDecorator_backgroundWrapper_0a',
                    H = 'NotificationDecorator_lipTop_9d',
                    q = 'NotificationDecorator_lipBottom_0b',
                    K = ({ children: u, isPopUp: e, background: t }) => {
                        var A;
                        return (
                            (A = () => {
                            ...
                            E().createElement(
                                'div',
                                { className: o()(W, e && V), lang: R.strings.settings.LANGUAGE_CODE() },
                                E().createElement('div', { className: G }, u),
                                e && E().createElement(U, { classNames: { base: j } }),
                                E().createElement('div', { className: z }, t || E().createElement(L, { isPopUp: e })),
                                !e &&
                                    E().createElement(
                                        E().Fragment,
                                        null,
                ...
                const uu = ((u, e) => {
                                ...
                                const i = (0, n.useRef)([]),
                                    a = (t, n, E) => {
                                        ...
                                        const F = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, A) => {
                                                        const r = 'string' == typeof A ? `${n}.${A}` : n,
                                                            o = Z.O.view.addModelObserver(r, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = X(E.keys()); !(u = t()).done;) A(u.value, e);
                                                    },
                                                    unsubscribe: A,
                                                };
                                            })(n),
                                            ...
                                            s = { mode: t, model: D, externalModel: r, cleanup: a };
                                        return {
                                            model: D,
                                    ...
                                    B = s[0],
                                    C = s[1],
                                    l = (0, n.useState)(() => a(A, F, o)),
                                    c = l[0],
                                    d = l[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        D.current ? d(a(B, F, o)) : (D.current = !0);
                                    }, [o, B, F]),
                                    (0, n.useEffect)(() => {
                                        C(A);
                                    }, [A]),
                    ...
                    nu = {
                        base: 'App_base_e9',
                        base__popUp: 'App_base__popUp_e5',
                        content: 'App_content_5b',
                        title: 'App_title_12',
                        base__FindFriends: 'App_base__FindFriends_15',
                        base__Friends: 'App_base__Friends_85',
                        friendName: 'App_friendName_dc',
                        titleWrapper: 'App_titleWrapper_80',
                        resources: 'App_resources_54',
                        base__extra: 'App_base__extra_27',
                        description: 'App_description_e9',
                        slideInFadeIn: 'App_slideInFadeIn_df',
                        fadeOut: 'App_fadeOut_27',
                        fadeIn: 'App_fadeIn_b2',
                        fadeInWithScale: 'App_fadeInWithScale_8d',
                        slideUp: 'App_slideUp_93',
                        scale: 'App_scale_e7',
                        spin: 'App_spin_e1',
                        blink: 'App_blink_16',
                        slideInNotification: 'App_slideInNotification_3f',
                    },
                    Eu = R.strings.ny.notification.resourcesReminder,
                    Au = (0, x.Pi)(() => {
                        const u = tu(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return E().createElement(
                            ...
                            E().createElement(
                                'div',
                                { className: o()(nu.base, nu[`base__${i}`], A && nu.base__popUp, c && nu.base__extra) },
                                E().createElement('div', { className: nu.resources }),
                                E().createElement(
                                    'div',
                                    { className: nu.titleWrapper },
                                    E().createElement(k.B, {
                                        text: Eu.title.$dyn(i),
                                        binding: {
                                            resourcesCount: r,
                                            friendName: E().createElement(O, { content: a, classMix: nu.friendName }),
                                        },
                                        className: nu.title,
                                    }),
                                ),
                                E().createElement(
                                    ...
                                    c &&
                                        E().createElement(
                                            'div',
                                            { className: o()(nu.description) },
                                            C ? Eu.description.FindFriends() : Eu.description.extraCollection(),
                                        ),
                                    E().createElement(
                                        l,
                                        { type: s.ghost, onClick: t.onClick, size: B.medium, disabled: D },
                                        Eu.button.$dyn(i),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    F().render(
                        E().createElement(eu, null, E().createElement(Au, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(8649));
