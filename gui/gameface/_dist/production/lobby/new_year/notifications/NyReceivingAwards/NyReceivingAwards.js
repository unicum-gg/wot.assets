(() => {
    ...
    var __webpack_modules__ = {
            ...
            2723: (u, e, t) => {
                var n = t(6179),
                    ...
                    r = t(493),
                    i = t.n(r);
                let o, s, l, c, E, d, _, A, m, F, D, C, B, g, p;
                (!(function (u) {
                    ((u.Items = 'items'),
                ...
                const P = [
                    ...
                    O = [o.Gold, o.Credits, o.Crystal, o.FreeXp],
                    N = [o.BattlePassPoints, o.EquipCoin],
                    k = [o.PremiumPlus, o.Premium],
                    I = ['engravings', 'backgrounds'],
                    L = ['engraving', 'background'],
                    M = (u, e = l.Small) => {
                        const t = u.name,
                            n = u.type,
                            a = u.value,
                    ...
                    G = (u, e) => {
                        ...
                        switch (e) {
                            ...
                            case c.CURRENCY:
                            case c.NUMBER:
                                return a().createElement(S, { format: 'integral', value: Number(u) });
                            case c.PREMIUM_PLUS: {
                                const e = Number(u);
                ...
                const K = j.O.client.getSize('rem'),
                    Q = K.width,
                    Z = K.height,
                    J = Object.assign(
                        { width: Q, height: Z },
                ...
                const tu = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && d) return Y(e, t, g);
                        if (t.smallWidth && _) return Y(e, t, g);
                        if (t.extraSmallWidth && A) return Y(e, t, g);
                        if (
                ...
                const su = (0, n.memo)((u) => {
                        ...
                        return (
                            ...
                            a().createElement('canvas', ou({}, B, { width: e, height: t, ref: g }))
                        );
                    }),
                    lu = {
                ...
                const Au = {
                    ...
                    Cu = ({
                        ...
                        classNames: r = {},
                        onAnimate: i = Fu,
                        animationSettings: o = Au,
                        getSrcByFrameTwirly: s = Du,
                        size: l = mu,
                        drawSize: c = mu,
                        isConvertationStart: E = !0,
                        initAnimationState: d = 'idle',
                    }) => {
                        const _ = V(o, d, E).step.state;
                        return (
                            (0, n.useEffect)(() => {
                                i(_);
                            }, [_, i]),
                            a().createElement(
                                'div',
                                {
                                    className: $()(lu.base, lu[`base__${_}`], t),
                                    style: {
                                ...
                                a().createElement(
                                    'div',
                                    { className: $()(lu.bumpStars, r.bumpStars) },
                                    a().createElement('div', { className: $()(lu.star, lu.star__one, r.star) }),
                                    a().createElement('div', { className: $()(lu.star, lu.star__second, r.star) }),
                                    a().createElement('div', { className: $()(lu.star, lu.star__third, r.star) }),
                                ),
                                a().createElement('div', { className: $()(lu.bump, r.bump) }),
                                a().createElement('div', { className: $()(lu.bumpRays, r.bumpRays) }),
                                a().createElement(
                                    'div',
                                    { className: $()(lu.reward, r.reward) },
                                    ('idle' === _ || 'start' === _) &&
                                        a().createElement('div', { className: $()(lu.rewardFrom, r.rewardFrom) }, u),
                                    ('end' === _ || 'bump' === _) &&
                                        a().createElement('div', { className: $()(lu.rewardTo, r.rewardTo) }, e),
                                ),
                                ('start' === _ || 'bump' === _) &&
                                    a().createElement(
                                        su,
                                        _u({}, c, {
                                            className: $()(lu.twirlyCanvas, r.twirlyCanvas),
                                            frameCount: 60,
                                            frameTime: 16,
                                            getSrcByFrame: s,
                                        }),
                                    ),
                                a().createElement('div', { className: $()(lu.bumpParticles, r.bumpParticles) }),
                            )
                        );
                    },
                    Bu =
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            h = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (pu(t, A, { isMouseEvent: !0, on: !0, arguments: gu(a) }, v),
                                    B && B(),
                ...
                const Su = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return a().createElement(xu, e, n);
                    const r = e.contentId;
                    return r ? a().createElement(bu, Tu({}, e, { contentId: r }), n) : a().createElement(wu, e, n);
                };
                let Pu, Ou, Nu, ku, Iu;
                (!(function (u) {
                    ((u.Small = 'small'),
                ...
                const Lu = {
                    ...
                    Uu = ({
                        ...
                        return a().createElement(
                            Su,
                            { tooltipArgs: A, className: $()(Lu.base, Lu[`base__${l}`], E && Lu.base__flex) },
                            a().createElement(
                                a().Fragment,
                                null,
                                a().createElement('div', {
                                    className: Lu.bonusIcon,
                                ...
                                r && a().createElement('div', { className: Lu.compensationIcon }),
                            ),
                        );
                    },
                    Gu = ['ko', 'no'],
                    ...
                    Wu = [
                        ku.Tman,
                        ku.GiftMachineToken,
                        ku.AddcEconomicBonuses,
                        ku.AchievementReward,
                        ku.Vehicles,
                        ku.EquipCoin,
                    ],
                    zu = [Iu.CelebrityAction, Iu.Story, Iu.Decoration],
                    $u = (Iu.CelebrityAction, Iu.Story, [ku.Vehicles, ku.AchievementReward]),
                    qu =
                        (ku.RandomBooklet,
                        ku.RandomGuide,
                        ku.RandomDecoration,
                        ku.RandomInstruction,
                        ku.RandomCrewInstruction,
                        o.Credits,
                        o.Gold,
                        o.FreeXp,
                        F.Iron,
                        ...
                        (u, e) => {
                            ...
                            return `${u === ku.AddcEconomicBonuses || u === o.EquipCoin ? `${t}.newYear.rewards` : u === ku.AchievementReward ? `${t}.achievement` : u === ku.Vehicles ? 'R.images.gui.maps.shop.vehicles' : u === o.CrewBooks ? 'R.images.gui.maps.icons.crewBooks.books' : `${t}.quests.bonuses`}.${(() => {
                                ...
                                switch (e) {
                                    ...
                                    case Pu.Big:
                                        return 'big';
                                    default:
                                        return ((t = u), $u.includes(t) ? e.replace('s', 'c_') : e);
                                }
                                var t;
                            })()}`;
                        }),
                    Vu = [Pu.S360x270, Pu.S400x300, Pu.S600x450],
                    Yu = (u, e, t) => {
                        const n = u.name,
                            a = Vu.includes(e) || ((u) => Wu.includes(u))(n);
                        if (a) {
                            const a = qu(n, e),
                        ...
                        return M(u, e.toString());
                    },
                    ju = (u) => {
                        switch (u) {
                            case ku.Tman:
                            case ku.GiftMachineToken:
                            case ku.AddcEconomicBonuses:
                            case ku.RandomBooklet:
                            case ku.RandomGuide:
                            case ku.RandomDecoration:
                            case ku.RandomInstruction:
                            case ku.RandomCrewInstruction:
                                return c.MULTI;
                            default:
                                return (
                                    (e = u),
                    ...
                    Xu = { width: 180, height: 180 },
                    Ku = Object.assign({}, Au, { idle: Object.assign({}, Au.idle, { timeout: 0 }) }),
                    Qu = (u, e) => ('vehicles' === u.name ? M(u, e.toString()) : Yu(u, e)),
                    Zu = ({
                        className: u,
                        bonusModel: e,
                        size: t,
                        ...
                        const l = ((u, e = []) => {
                                ...
                                'start' === u && H('gui_gift_system_newyear_reward_transform');
                            }, []),
                            c = e.compensatedItem,
                            E = i ? 'idle' : 'end';
                        return a().createElement(
                ...
                const ne = ['__left', '__right', '__top', '__bottom'],
                    ae =
                        ((0, n.forwardRef)(
                            ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: r = {} }, i) => {
                                const o = (0, n.useRef)(null),
                                    ...
                                    d = c[1],
                                    _ = (0, n.useCallback)(() => {
                                        (W.playClick(), j.O.view.sendEvent.close());
                                    }, []),
                                    A = (0, n.useCallback)(() => {
                                        W.playHighlight();
                                    }, []),
                                    m = $()(ue.arrow, ue[`arrow${ne[E]}`]);
                                Ju(
                                    () => (
                                        j.O.client.events.mouse.enableOutside(),
                                        j.O.client.events.mouse.down(([, u]) => {
                                            'outside' === u && (t ? t() : j.O.view.sendEvent.close('popover'));
                                        })
                                    ),
                                );
                                const F = (0, n.useCallback)(
                                        (u) => {
                                            ...
                                            if (void 0 !== window.decorator) {
                                                const u = j.O.client.getMouseGlobalPosition(),
                                            ...
                                            t ? t() : j.O.view.sendEvent.close('popover');
                                        },
                                        [o, l, t],
                                    ),
                                    D = ee(),
                                    C = (0, n.useCallback)(() => {
                                        ...
                                        if (u)
                                            return (
                                                j.O.view.freezeTextureBeforeResize(),
                                                D.run(() => {
                                                    const e = u.scrollWidth,
                                                        t = u.scrollHeight;
                                                    (j.O.view.resize(e, t), d(window.decorator.directionType));
                                                })
                                            );
                                    }, [D]);
                                return (
                                    ...
                                    Ju(() => {
                                        j.O.view.setInputPaddingsRem(58);
                                    }),
                                    (0, n.useEffect)(() => {
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: ue.base, ref: s },
                                        a().createElement(
                                            'div',
                                            { className: ue.decorator },
                                            a().createElement(
                                                'div',
                                                { className: ue.content, ref: o },
                                                u,
                                                window.decorator &&
                ...
                const ie = (u) => {
                        ...
                        const A = (0, n.useRef)(null),
                            m = (0, n.useCallback)(() => {
                                if ((0, T.wU)()) return (0, T.SW)();
                                A.current && (0, T.P3)(e, i, A.current, t, o, s);
                            }, [e, i, s, t, o]);
                        return a().createElement(
                            'div',
                            re(
                ...
                const le = (u) => {
                    ...
                    Ee = (0, n.memo)(
                        ({
                            ...
                            const l = u.level,
                                ...
                                A = _.disabled,
                                m = _.isPopoverOpened,
                                F = `${qu(ku.VariadicDiscount, t)}.${ku.VariadicDiscount}`,
                                D = Gu.includes(Hu) ? l : R.strings.roman_numerals.$dyn(`n_${l}`),
                                C = (0, n.useState)(!1),
                                B = C[0],
                                g = C[1],
                                p = (0, n.useState)(!1),
                                ...
                                v = p[1],
                                h = !E && !b,
                                w = { variadicID: d, discount: c, isCurrentProgressionCompleted: i },
                                y = { popoverId: 'NYSelectVehicleForDiscountPopover', variadicID: d },
                                x = {
                                    backgroundImage: `url('${E ? R.images.gui.maps.icons.vehicle.$dyn(((T = E), T.replace(/:|-/g, '_'))) : F}')`,
                                };
                            var T;
                            const S = (0, n.useCallback)(() => {
                                ...
                                P = (0, n.useCallback)(() => {
                                    h && i && !m && (H(R.sounds.hangar_newyear_slot_over()), g(!0));
                                }, [h, i, m]),
                                O = (0, n.useCallback)(() => {
                                    B && (H(R.sounds.hangar_newyear_slot_over_off()), g(!1));
                                }, [B]);
                            var N, k;
                            ((0, n.useEffect)(() => {
                                !h && B && (H(R.sounds.hangar_newyear_slot_over_off()), g(!1));
                            }, [h, B]),
                                (N = () => {
                                    !m && b && v(!1);
                                }),
                            ...
                            const I = $()(
                                ...
                                L = a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: I, onMouseEnter: P, onMouseLeave: O, onClick: S },
                                        a().createElement(
                                            'div',
                                            { className: ce.discountReward },
                                            a().createElement('div', { className: ce.icon, style: x }),
                                            a().createElement('div', { className: ce.vehicleLevel }, D),
                                            a().createElement(
                                                'div',
                                                { className: ce.discountAmount },
                                                o
                                                    ? R.strings.common.common.percent()
                                                    : (0, f.uF)(R.strings.ny.percentageValue.withMinus(), { value: c }),
                                            ),
                                        ),
                                    ),
                                );
                            return A || E || !i ? L : a().createElement(le, { args: y }, L);
                        },
                    ),
                    de = 'ActivityReward_base_50',
                    _e = 'ActivityReward_base__animated_b8',
                    Ae = 'ActivityReward_base__completed_02',
                    me = 'ActivityReward_base__flex_24',
                    Fe = 'ActivityReward_inner_39',
                    De = 'ActivityReward_icon_21',
                    Ce = 'ActivityReward_iconPlay_02',
                    Be = R.strings.ny.activityReward.tooltip,
                    ge = ({ name: u, icon: e, isClickable: t, isNew: n, isFlexable: r }) => {
                        const i = ((u) => {
                            switch (u) {
                        ...
                        return a().createElement(
                            xu,
                            { header: Be.header.$dyn(i), body: Be.body.$dyn(i) },
                            a().createElement(
                                'div',
                                { className: $()(de, t && Ae, t && n && _e, r && me) },
                                a().createElement(
                                    'div',
                                    { className: Fe },
                                    a().createElement('div', {
                                    ...
                                    u === Iu.CelebrityAction && a().createElement('div', { className: Ce }),
                                ),
                            ),
                        );
                    },
                    pe = { base: 'AttachmentReward_base_a0', glow: 'AttachmentReward_glow_5c' },
                    be = (u, e) =>
                    ...
                    Re = ({
                        ...
                        a().createElement(
                            'div',
                            { className: $()(fe.base, fe[`base__${o}`], s && fe.base__flex) },
                            a().createElement('div', {
                                className: fe.equipmentGlow,
                                style: {
                    ...
                    xe = R.strings.ny.lootBoxAutoOpen.reward.premiumPlus,
                    Te = xe.label(),
                    Se = xe.tooltip.header(),
                    Pe = xe.tooltip.body(),
                    Oe = ({ value: u, size: e = Pu.Big, isFlexable: t = !1, classNames: n }) => {
                        const r = (0, f.uF)(Te, { quantity: u }),
                            i = (0, f.uF)(Se, { quantity: u });
                        return a().createElement(
                            xu,
                            { header: i, body: Pe },
                            a().createElement(
                                'div',
                                {
                                    className: $()(ye.base, ye[`base__${e}`], t && ye.base__flex),
                                ...
                                Number(u) > 1 &&
                                    a().createElement(
                                        'div',
                                        { className: $()(ye.info, null == n ? void 0 : n.info) },
                                        r,
                                    ),
                            ),
                        );
                ...
                const Ie = R.views.lobby.new_year.tooltips,
                    Le = ({
                        image: u,
                        bigImage: e,
                        value: t,
                        ...
                        return a().createElement(
                            bu,
                            { ignoreShowDelay: !0, contentId: Ie.NyDecorationTooltip('resId'), args: { toyID: r } },
                            a().createElement(
                                'div',
                                {
                                    className: $()(Ne.base, i && Ne.base__flex, Ne[`base__${n}`]),
                                    lang: R.strings.settings.LANGUAGE_CODE(),
                                },
                                a().createElement(
                                    'div',
                                    {
                                        className: Ne.image,
                                        style: { backgroundImage: `url(${n === ke.Medium ? u : e})` },
                                    },
                                    s &&
                                        a().createElement(
                                            'div',
                                            { className: $()(Ne.counter, null == o ? void 0 : o.counter) },
                                            s,
                                        ),
                                ),
                            ),
                ...
                const qe = (u) => {
                    ...
                    const _ = e.vehicleLvl,
                        A = e.vehicleName,
                        m = e.vehicleType,
                        F = (c === $e.Light ? ze.white_elite : ze.blue_elite).$dyn(`${(0, f.BN)(m)}`),
                        D = n > 0 || i > 0;
                    return a().createElement(
                        'div',
                        {
                            className: $()(Ue.base, Ue[`base__${s}`], Ue[`base__${c}`], D && Ue.base__withRent),
                            lang: R.strings.settings.LANGUAGE_CODE(),
                        },
                        a().createElement(Uu, He({ size: s, isLabelHidden: !0 }, d)),
                        n > 0 &&
                            a().createElement(Me.z, {
                                text: We.rentDays(),
                                binding: { clockIcon: a().createElement('span', { className: Ue.clockIcon }), days: n },
                                classMix: $()(Ue.rent, null == E ? void 0 : E.rent),
                            }),
                        i > 0 &&
                            a().createElement(Me.z, {
                                text: We.rentBattles(),
                        ...
                        a().createElement(
                            'div',
                            { className: $()(Ue.vehicleInfo, null == E ? void 0 : E.info) },
                            w(_),
                            a().createElement(
                                'div',
                ...
                const Ye = ({
                    ...
                    return ((u) => 'item' in u && u.item && u.item.startsWith('modernized'))(u)
                        ? a().createElement(
                              Re,
                              Ve({}, u, { image: Yu(u, t, _), size: t, classNames: m, isFlexable: d }),
                          )
                        : 'ny25Toys' === u.name
                          ? a().createElement(
                                Le,
                          ...
                          : ((u) => 'variadicDiscount' === u.name)(u)
                            ...
                            : ((u) => 'premium_plus' === u.name)(u)
                              ? a().createElement(Oe, Ve({}, u, { size: t, isFlexable: d, classNames: m }))
                              : u.isCompensation
                                ? a().createElement(Zu, Ve({ bonusModel: u, size: t }, s))
                                : ((D = u.name),
                                  zu.includes(D)
                                      ? a().createElement(ge, Ve({}, u, l, { isFlexable: d }))
                                      : ((u) => u === o.Vehicles)(u.name)
                                        ? a().createElement(qe, Ve({ image: Yu(u, t, _), size: t }, u, c))
                                        : ((u) => u === o.Items)(u.name)
                                          ? a().createElement(we, {
                                                bonusModel: u,
                                                size: t,
                ...
                const Ze = { isPopoverOpened: !1, disabled: !0, animation: Ou.None },
                    Je = {
                    ...
                    ut = ({ rewardModel: u, withDescription: e = !1, hasLabel: t = !0 }) => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: $()(Je.rewardWrapper, n && Je.rewardWrapper__tman) },
                                a().createElement(Ye, {
                                    bonusModel: u,
                                    isFlexable: n,
                            ...
                            t &&
                                a().createElement(
                                    'div',
                                    { className: $()(Je.label, n && Je.label__tman, e && Je.label__withDescription) },
                                    ((u) => {
                                        if (u.rarity)
                                            return (0, f.uF)(R.strings.ny.notifications.challenge.label.attachment(), {
                ...
                const at = ({
                    ...
                    return (
                        ...
                        a().createElement(
                            ...
                            a().createElement(
                                'span',
                                { className: $()(et.state, et.state__default) },
                ...
                const rt = at,
                    ...
                    ct = ({
                        ...
                        a().createElement(
                            'div',
                            { className: $()(it, e && ot, Boolean(u) && st) },
                            a().createElement('div', {
                                className: lt,
                                style: {
                    ...
                    dt = ({ classNames: u }) =>
                        a().createElement('div', {
                            className: $()(Et, null == u ? void 0 : u.base),
                            onMouseEnter: W.playHighlight,
                            onClick: () => H(R.sounds.cancelcloseno()),
                        }),
                    ...
                    vt = 'RewardNotificationDecorator_shadow_2c',
                    ht = 'RewardNotificationDecorator_additionalRewards_50',
                    ...
                    Tt = ({
                        ...
                        Ju(() => {
                            i && H(R.sounds.hangar_newyear_notification());
                        }),
                        a().createElement(
                            'div',
                            {
                                className: $()(_t, i && At, null == d ? void 0 : d.base),
                                lang: R.strings.settings.LANGUAGE_CODE(),
                            },
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { className: $()(Dt, null == d ? void 0 : d.header) },
                                    a().createElement('div', { className: $()(Ct, null == d ? void 0 : d.title) }, u),
                                    E &&
                                        a().createElement(
                                            'div',
                                            { className: $()(Bt, null == d ? void 0 : d.subtitle) },
                                            E,
                                        ),
                                ),
                                a().createElement(
                                    'div',
                                    { className: gt },
                                    a().createElement('div', { className: $()(pt, s && bt) }, n),
                                    r
                                        ? a().createElement(
                                              'div',
                                              { className: ht },
                ...
                const Lt = ((u, e) => {
                                                ...
                                                return {
                                                    subscribe: (t, r) => {
                                                        const o = 'string' == typeof r ? `${n}.${r}` : n,
                                                            s = j.O.view.addModelObserver(o, e, !0);
                        ...
                        ({ observableModel: u }) => {
                            const e = {
                                ...
                                n = (0, It.Om)(() => t().slice(0, 3)),
                                a = (0, It.Om)(() => {
                                    return ((u = e.hugeRewards.get()), (t = (u) => u), Qe(u, je, t))[0];
                                    var u, t;
                                });
                            return Object.assign({}, e, {
                                computed: { getRewards: t, getHugeReward: a, getAdditionalRewards: n },
                            });
                        },
                        ({ externalModel: u }) => ({
                            onClick: u.createCallbackNoArgs('onClick'),
                            goToRewards: u.createCallbackNoArgs('onGoToRewards'),
                        }),
                    ),
                    Mt = Lt[0],
                    Ut = Lt[1],
                    Gt = 'App_reward_a5',
                    Ht = 'App_title_fa',
                    Wt = R.strings.ny.notifications.atmosphereLevelUp,
                    zt = R.strings.ny.levelUpView.actionButton,
                    $t = (0, y.Pi)(() => {
                        const u = Ut(),
                            e = u.model,
                            t = u.controls,
                            ...
                            s = n.level,
                            l = n.buttonAction,
                            c = e.computed.getHugeReward(),
                            E = (null == c ? void 0 : c.name) === o.TmanToken,
                            d = e.computed.getRewards().length > 3,
                            _ = e.computed.getRewards().length - 3,
                            A = d && l === p.ToRewards ? (0, f.uF)(Wt.button.more(), { amount: _ }) : zt.$dyn(l);
                        return a().createElement(Tt, {
                            isPopUp: r,
                            buttonAction: t.onClick,
                            buttonText: A,
                            title: a().createElement(x.B, {
                                text: Wt.title(),
                                binding: { level: w(s), maxLevel: w(10) },
                                className: Ht,
                            }),
                            rareReward:
                                c &&
                                a().createElement(ut, {
                                    rewardModel: c,
                                    withDescription: !e.computed.getAdditionalRewards().length,
                                }),
                            isTman: E,
                            isButtonDisabled: i,
                            additionalRewards:
                                ((m = e.computed.getAdditionalRewards()),
                                (F = (u, e) =>
                                    a().createElement(
                                        'div',
                                        { key: e, className: Gt },
                                        a().createElement(Ye, { isFlexable: !0, bonusModel: u }),
                                    )),
                                Array.isArray(m)
                                    ? m.map(F)
                                    : m.map((u, e, t) => F(null == u ? void 0 : u.value, e, t))),
                        });
                        var m, F;
                    });
                engine.whenReady.then(() => {
                    i().render(
                        a().createElement(Mt, null, a().createElement($t, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(2723));
