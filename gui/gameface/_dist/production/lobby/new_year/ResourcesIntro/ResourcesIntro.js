(() => {
            ...
            136: (e, t, n) => {
                ...
                const v = (e) => {
                    ...
                    const a = (0, r.useContext)(h),
                        ...
                        x = { extraLarge: f, large: w, medium: b, small: p, extraSmall: L };
                ...
                const k = {
                        [y.ExtraSmall]: '',
                        [y.Small]: L().SMALL_WIDTH,
                        [y.Medium]: `${L().SMALL_WIDTH} ${L().MEDIUM_WIDTH}`,
                        [y.Large]: `${L().SMALL_WIDTH} ${L().MEDIUM_WIDTH} ${L().LARGE_WIDTH}`,
                        [y.ExtraLarge]: `${L().SMALL_WIDTH} ${L().MEDIUM_WIDTH} ${L().LARGE_WIDTH} ${L().EXTRA_LARGE_WIDTH}`,
                    },
                    C = {
                        [S.ExtraSmall]: '',
                    ...
                    P = (e) => {
                        ...
                        const i = T(),
                            ...
                            s = i.mediaHeight,
                            l = i.mediaSize;
                        return a().createElement('div', O({ className: b()(n, k[o], C[s], H[l]) }, r), t);
                    },
                    A = ['children'];
                const I = (e) => {
                    let t = e.children,
                ...
                class z extends a().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            h = b()(j.icon, j[`icon__${o}`], j[`icon__${i}`], null == s ? void 0 : s.icon),
                            g = b()(j.glow, null == s ? void 0 : s.glow),
                            v = b()(j.caption, j[`caption__${o}`], null == s ? void 0 : s.caption),
                            E = b()(j.goto, null == s ? void 0 : s.goto);
                ...
                const ae = ((e, t) => {
                    ...
                    })(Q, ({ externalModel: e }) => ({ close: e.createCallbackNoArgs('onClose') })),
                    ie = ae[0],
                    oe = ae[1];
                var se = n(9916);
                const le = [
                        ...
                        const L = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, r.useCallback)(() => {
                                (L.current.isVisible && L.current.timeoutId) ||
                                    (ue(n, h, { isMouseEvent: !0, on: !0, arguments: ce(a) }, x),
                                    w && w(),
                ...
                const we = {
                        base: 'ResourcesList_base_9e',
                        item: 'ResourcesList_item_6c',
                        resource: 'ResourcesList_resource_31',
                        resourceIcon: 'ResourcesList_resourceIcon_cd',
                        resourceIcon__ny_crystal: 'ResourcesList_resourceIcon__ny_crystal_88',
                        resourceIcon__ny_iron: 'ResourcesList_resourceIcon__ny_iron_31',
                        resourceIcon__ny_emerald: 'ResourcesList_resourceIcon__ny_emerald_36',
                        resourceIcon__ny_amber: 'ResourcesList_resourceIcon__ny_amber_5b',
                        resourceLabel: 'ResourcesList_resourceLabel_7c',
                        info: 'ResourcesList_info_2e',
                        infoNumber: 'ResourcesList_infoNumber_f2',
                        infoText: 'ResourcesList_infoText_81',
                        slideInFadeIn: 'ResourcesList_slideInFadeIn_8e',
                        fadeOut: 'ResourcesList_fadeOut_f0',
                        fadeIn: 'ResourcesList_fadeIn_70',
                        fadeInWithScale: 'ResourcesList_fadeInWithScale_c2',
                        slideUp: 'ResourcesList_slideUp_80',
                        scale: 'ResourcesList_scale_2a',
                        spin: 'ResourcesList_spin_b1',
                        blink: 'ResourcesList_blink_e5',
                        slideInNotification: 'ResourcesList_slideInNotification_03',
                    },
                    be = R.strings.ny.resourceIntro,
                    pe = [me.Crystal, me.Iron, me.Emerald, me.Amber],
                    Le = () =>
                        a().createElement(
                            'div',
                            { className: we.base },
                            pe.map((e, t) =>
                                a().createElement(
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(
                                            'div',
                                            { className: we.resource },
                                            a().createElement('div', {
                                                className: b()(we.resourceIcon, we[`resourceIcon__${e}`]),
                                            }),
                                            a().createElement(
                                                'div',
                                                { className: we.resourceLabel },
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: we.info },
                                        a().createElement('div', { className: we.infoNumber }, t + 1),
                                        a().createElement('div', { className: we.infoText }, be.$dyn(`text${t + 1}`)),
                                    ),
                                ),
                            ),
                        ),
                    xe = 'App_base_b9',
                    ye = 'App_base__visible_7f',
                    Se = 'App_closeButton_d3',
                    Te = 'App_title_9c',
                    Me = 'App_content_13',
                    Oe = 'App_buttonBox_fd',
                    Re = 'App_button_04',
                    ke = R.strings.ny.resourceIntro,
                    Ce = (0, Z.Pi)(() => {
                        const e = oe().controls,
                            t = (0, r.useState)(!1),
                            n = t[0],
                        ...
                        var o, s;
                        return (
                            Y({ [X.n.ENTER]: e.close, [X.n.SPACE]: e.close, [X.n.ESCAPE]: e.close }),
                            (o = () => {
                                i(!0);
                            }),
                            (s = []),
                            ...
                            a().createElement(
                                'div',
                                { className: b()(xe, n && ye), lang: R.strings.settings.LANGUAGE_CODE() },
                                a().createElement(
                                    'div',
                                    { className: Se },
                                    a().createElement(z, {
                                        caption: ke.closeBtnLabel(),
                                        type: 'close',
                                        side: 'right',
                                        onClick: e.close,
                                    }),
                                ...
                                a().createElement('div', { className: Me }, a().createElement(Le, null)),
                                a().createElement(
                                    'div',
                                    { className: Oe },
                                    a().createElement(V, { mixClass: Re, onClick: e.close }, ke.buttonText()),
                                ),
                            )
                        );
                    });
                engine.whenReady.then(() => {
                    N().render(
                        a().createElement(ie, null, a().createElement(I, null, a().createElement(Ce, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(136));
