(() => {
    var __webpack_modules__ = {
            ...
            3582: (u, e, t) => {
                ...
                const T = {
                    ...
                    P = (u) => {
                        ...
                        const a = f(),
                            ...
                            s = a.mediaHeight,
                            o = a.mediaSize;
                        return n().createElement('div', S({ className: C()(t, T[i], M[s], y[o]) }, r), e);
                    },
                    L = ['children'],
                    O = (u) => {
                        let e = u.children,
                ...
                const ru = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    au = [h.ExtraLarge, h.Large, h.Medium, h.Small, h.ExtraSmall],
                    iu = (u, e) =>
                ...
                const cu = {
                    ...
                    mu = su((u) => {
                        let e = u.className,
                            ...
                            L = u.shrink,
                            O = u.flex,
                            k = void 0 === O ? (P || L ? `${P ? 1 : 0} ${L ? 1 : 0} auto` : void 0) : O,
                            N = u.style,
                            I = u.children,
                            H = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const U = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, o, E, A, m, N, k, T, B, y, f, S]),
                            G = U.computedStyle,
                            W = U.computedClassNames;
                        return n().createElement('div', Eu({ className: C()(ou.base, ...W, e), style: G }, H), I);
                    });
                let Fu;
                !(function (u) {
                ...
                const Du = (u, e, t) => {
                    ...
                    Bu = (u, e, t = Fu.left) => u.split(e).reduce(t === Fu.left ? Du : du, []),
                    Cu = (() => {
                        const u = new RegExp(
                    ...
                    pu = ({ binding: u, text: e = '', classMix: t, alignment: a = Fu.left }) =>
                        null === e
                ...
                const xu = Object.keys(bu()),
                    ...
                    Pu = su((u) => {
                        ...
                        return n().createElement(
                            ...
                            fu(
                                {
                                    className: C()(vu.base, t && vu[t], h, a),
                                    style: p,
                                    mt: !0 === l ? Mu[t || 'paragraph-P16'].mt : l,
                                    mr: !0 === c ? Mu[t || 'paragraph-P16'].mr : c,
                                    mb: !0 === _ ? Mu[t || 'paragraph-P16'].mb : _,
                                    ml: !0 === F ? Mu[t || 'paragraph-P16'].ml : F,
                                },
                                B,
                            ),
                            void 0 !== d ? n().createElement(pu, fu({}, d, { text: e })) : e,
                        );
                    }),
                    Lu = {
                ...
                class Nu extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            _ = C()(Lu.base, Lu[`base__${i}`], Lu[`base__${a}`], null == s ? void 0 : s.base),
                            m = C()(Lu.icon, Lu[`icon__${i}`], Lu[`icon__${a}`], null == s ? void 0 : s.icon),
                            F = C()(Lu.glow, null == s ? void 0 : s.glow),
                            D = C()(Lu.caption, Lu[`caption__${i}`], null == s ? void 0 : s.caption),
                            d = C()(Lu.goto, null == s ? void 0 : s.goto);
                        return n().createElement(
                            'div',
                            ku(
                                {
                            ...
                            n().createElement('div', { className: m }, n().createElement('div', { className: F })),
                ...
                function Gu(u = Iu.n.NONE, e = Uu, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Iu.n.NONE)
                            return (
                ...
                const ju = [
                    ...
                    Yu = [q.Gold, q.Credits, q.Crystal, q.FreeXp, q.NewYearToyFragments],
                    qu = [q.BattlePassPoints],
                    zu = [q.PremiumPlus, q.Premium];
                let Vu;
                !(function (u) {
                    ((u.s16 = '16'),
                        (u.s32 = '32'),
                ...
                const Ku = ['engravings', 'backgrounds'],
                    ...
                    ue = (u, e, t) => u.map((u) => Object.assign({}, u, { image: Ju(u, e ? t : V.Big) }));
                function ee() {
                    return !1;
                }
                console.log;
                    ...
                    ae = (u) => {
                        return null !== u && 'object' == typeof u
                            ? 'CoherentArrayProxy' === u.constructor.name
                                ? ((e = u),
                                  (t = (u) => ('object' == typeof u ? ae(u) : u)),
                                  Array.isArray(e) ? e.map(t) : e.map((u, e, r) => t(null == u ? void 0 : u.value)))
                                : Array.isArray(u)
                                  ? u.map((u) => ('object' == typeof u ? ae(u) : u))
                                  : Object.fromEntries(
                                        Object.entries(u).map(([u, e]) => [u, 'object' == typeof e ? ae(e) : e]),
                                    )
                            : u;
                        var e, t;
                    };
                ...
                const se = ((u, e) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            c = (({ observableModel: u }) => {
                                                const e = { root: u.object(), rewards: u.array('rewards.items', []) },
                                                    t = (0, ie.computedFn)(
                                                        () => {
                                                            return ((u = e.rewards.get()), ae(u)).map((u) => {
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : o(e),
                                                            n = te.observable.box(r, { equals: ee });
                                                        return (
                                                            'real' === u &&
                                                                s.subscribe(
                                                                    (0, te.action)((u) => n.set(u)),
                                                                    e,
                                                                ),
                                                            n
                                                        );
                        ...
                        goToMachine: u.createCallbackNoArgs('onGoToMachine'),
                        goToLootboxes: u.createCallbackNoArgs('onGoToLootbox'),
                        goToPet: u.createCallbackNoArgs('onGotoPet'),
                    })),
                    oe = se[0],
                    le = se[1],
                    Ee = [
                        ...
                        const h = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, r.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Ae(t, m, { isMouseEvent: !0, on: !0, arguments: ce(n) }, b),
                                    C && C(),
                ...
                const he = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return n().createElement(ge, e, r);
                        const a = e.contentId,
                            i = e.args,
                            s = null == i ? void 0 : i.contentId;
                        return a || s
                            ? n().createElement(_e, pe({}, e, { contentId: a || s }), r)
                            : n().createElement(De, e, r);
                    },
                    be = {
                        base: 'Reward_base_ea',
                ...
                var Oe, ke;
                (((ke = Oe || (Oe = {}))[(ke.Left = 0)] = 'Left'),
                    (ke[(ke.Right = 1)] = 'Right'),
                    (ke[(ke.Top = 2)] = 'Top'),
                    (ke[(ke.Bottom = 3)] = 'Bottom'));
                const Ne = ['__left', '__right', '__top', '__bottom'];
                (0, r.forwardRef)(
                    ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: a = {} }, s) => {
                ...
                const Ie =
                    ...
                    we.MACHINE,
                    {
                        base: 'AnimationRewards_base_df',
                        reward: 'AnimationRewards_reward_f1',
                        blink: 'AnimationRewards_blink_e7',
                        reward__main: 'AnimationRewards_reward__main_e1',
                        rewardInfo: 'AnimationRewards_rewardInfo_cf',
                        rewardInfo__multi: 'AnimationRewards_rewardInfo__multi_94',
                        rewardImage: 'AnimationRewards_rewardImage_b3',
                        description: 'AnimationRewards_description_fe',
                        description__s296x222: 'AnimationRewards_description__s296x222_1e',
                        description__s400x300: 'AnimationRewards_description__s400x300_83',
                        description__s600x450: 'AnimationRewards_description__s600x450_f5',
                        name: 'AnimationRewards_name_7e',
                        btnWrapper: 'AnimationRewards_btnWrapper_25',
                        btn: 'AnimationRewards_btn_d8',
                    });
                function He() {
                    return (
                        (He =
                ...
                const Ue = 150,
                    Ge = ['activity', 'food', 'fun'],
                    We = R.strings.ny.questGiverRewards,
                    $e = ({
                        items: u,
                        ...
                        const _ =
                            ...
                            m = _[0],
                            F = _[1],
                            D = m.length + Number(Boolean(F.length)),
                            d = {
                        ...
                        return (
                            (0, r.useEffect)(() => {
                                ...
                                const t = setTimeout(() => {
                                    ...
                                    u = window.setInterval(() => {
                                        (I(R.sounds.$dyn(a)), e++, e >= D && clearTimeout(u));
                                    }, Ue);
                                }, e - 300);
                                return () => {
                            ...
                            n().createElement(
                                ...
                                { className: Ie.base },
                                m.map((u, t) => {
                                    const r = 'nyGiftMachineToken' === u.icon,
                                        a = 'lootBoxToken' === u.name,
                                        _ = u.icon && Ge.includes(u.icon),
                                        m = r ? [We.button.toMachine(), l] : [We.button.toLootboxes(), o],
                                        F = m[0],
                                        D = m[1];
                                    return n().createElement(
                                        'div',
                                        ...
                                        s &&
                                            n().createElement(
                                                ...
                                                u.label && n().createElement(Pu, { className: Ie.name, text: u.label }),
                                                a &&
                                                    n().createElement(
                                                        'div',
                                                ...
                                                _ &&
                                                    n().createElement(
                                                        ...
                                                        n().createElement(
                                                            ...
                                                            n().createElement(Pu, { text: We.button.toPet() }),
                                                        ),
                                                    ),
                                            ),
                                    );
                                ...
                                F.length > 0 &&
                                    n().createElement(
                                        'div',
                                        { className: Ie.reward, style: { animationDelay: `${e + Ue * m.length}ms` } },
                                        n().createElement(ve, {
                                            name: 'more',
                    ...
                    Xe = R.strings.ny.questGiverRewards,
                    je = Xe.button,
                    Ye = (0, Wu.observer)(() => {
                        const u = le(),
                            e = u.model,
                            ...
                            s = e.root.get(),
                            o = s.isPetAvailable,
                            l = s.isMachineAvailable,
                            E = (0, r.useState)(!1),
                            c = E[0],
                            A = E[1],
                            _ = f().mediaSize,
                            m = ((u) => (u < h.Medium ? 's232x174' : u >= h.ExtraLarge ? 's400x300' : 's296x222'))(_),
                            F = ue(a.slice(0, 3), !0, m),
                            D = ue(a.slice(3), !1),
                            d = _ < h.Medium ? V.Small : V.Big,
                            B = D.length > 0,
                            g = 2100 + Ue * a.length;
                        ((0, r.useEffect)(() => {
                            ...
                            (0, r.useEffect)(
                                () =>
                                    ((u, e) => {
                                        let t;
                                        const r = setTimeout(() => {
                                            (I(R.sounds.gui_random_reward_end()), (t = void A(!0)));
                                        }, e);
                                        return () => {
                        ...
                        return (
                            ...
                            n().createElement(
                                'div',
                                { className: 'App_base_44' },
                                n().createElement('div', { className: 'App_bg_86' }),
                                n().createElement(
                                    'div',
                                    { className: 'App_close_e0' },
                                    n().createElement(Nu, {
                                ...
                                n().createElement(
                                    'div',
                                    { className: 'App_content_84' },
                                    n().createElement(
                                        'div',
                                        { className: 'App_tapeContent_cc', style: { animationDuration: '500ms' } },
                                        n().createElement(
                                            'div',
                                            { className: 'App_rewardsContainer_e3' },
                                            n().createElement(
                                                'div',
                                                { className: 'App_ribbonWrapper_fa' },
                                                n().createElement('div', { className: 'App_ribbon_4e' }),
                                                n().createElement('div', { className: 'App_frostFather_6d' }),
                                            ),
                                            F.length > 0 &&
                                                n().createElement(
                                                    'div',
                                                    {
                                                        className: C()(
                                                            'App_hugeRewards_93',
                                                            !B && 'App_hugeRewards__withoutRewards_a1',
                                                        ),
                                                    },
                                                    n().createElement($e, {
                                                        items: F,
                                                        ...
                                                        sound: $u.MAIN_APPEAR,
                                                        isMainRewards: !0,
                                                        goToMachine: t.goToMachine,
                                                        goToLootboxes: t.goToLootboxes,
                                                        goToPet: t.goToPet,
                                                        isPetAvailable: o,
                                                        isMachineAvailable: l,
                                                    }),
                                                ),
                                            B &&
                                                n().createElement(
                                                    'div',
                                                    { className: 'App_rewards_bc' },
                                                    n().createElement($e, {
                                                        items: D,
                                                        animationDelayStart: 1700,
                                                        maxLength: 9,
                                                        size: d,
                                                        sound: $u.OTHER_APPEAR,
                                                    }),
                                                ),
                                        ),
                                        n().createElement(
                                            'div',
                                            { className: C()('App_confirm_e7', c && 'App_confirm__visible_4f') },
                                            n().createElement(
                                                'div',
                                                {
                                                    className: C()(
                                                        'App_congratulations_20',
                                                        !B && 'App_congratulations__withoutRewards_b2',
                                                    ),
                                                },
                                                n().createElement(Pu, { text: Xe.title(), className: 'App_title_7e' }),
                                                n().createElement(Pu, {
                                                    text: Xe.subtitle(),
                                                    className: 'App_subtitle_cc',
                                                }),
                                            ),
                                            n().createElement(
                                                'div',
                                                {
                                                    className: C()(
                                                        'App_buttons_e4',
                                                        !B && 'App_buttons__withoutRewards_5e',
                                                    ),
                                                },
                                                n().createElement(
                                                    Y,
                                                    {
                                                        mixClass: 'App_confirmButton_39',
                                                        size: W.medium,
                                                        onClick: t.close,
                                                    },
                                                    n().createElement(Pu, { text: je.ok() }),
                                                ),
                                            ),
                                        ),
                                    ),
                ...
                engine.whenReady.then(() => {
                    N().render(
                        n().createElement(oe, null, n().createElement(O, null, n().createElement(Ye, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(3582));
