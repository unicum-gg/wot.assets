(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                'use strict';
                t.d(e, { B3: () => E, Z5: () => i, B0: () => s, ry: () => C, Eu: () => g });
                class r {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            4094: (u, e, t) => {
                ...
                const E = i.O.client.getSize('rem'),
                    c = E.width,
                    A = E.height,
                    _ = Object.assign({ width: c, height: A }, l(c, A, o)),
                ...
                const T = {
                    ...
                    y = (u) => {
                        ...
                        const a = f(),
                            ...
                            o = a.mediaHeight,
                            s = a.mediaSize;
                        return n().createElement('div', S({ className: C()(t, T[i], M[o], L[s]) }, r), e);
                    },
                    O = ['children'],
                    P = (u) => {
                        let e = u.children,
                ...
                class K extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            _ = C()(q.base, q[`base__${i}`], q[`base__${a}`], null == o ? void 0 : o.base),
                            m = C()(q.icon, q[`icon__${i}`], q[`icon__${a}`], null == o ? void 0 : o.icon),
                            F = C()(q.glow, null == o ? void 0 : o.glow),
                            D = C()(q.caption, q[`caption__${i}`], null == o ? void 0 : o.caption),
                ...
                const ou = {
                    ...
                    Eu = ru((u) => {
                        ...
                        const U = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, s, E, A, m, k, N, T, B, L, f, S]),
                            G = U.computedStyle,
                            W = U.computedClassNames;
                        return n().createElement('div', iu({ className: C()(nu.base, ...W, e), style: G }, H), I);
                    });
                let cu;
                !(function (u) {
                ...
                const Au = (u, e, t) => {
                    ...
                    mu = (u, e, t = cu.left) => u.split(e).reduce(t === cu.left ? Au : _u, []),
                    Fu = (() => {
                        const u = new RegExp(
                            ...
                            hu(
                                {
                                    ...
                                    ml: !0 === F ? xu[t || 'paragraph-P16'].ml : F,
                                },
                                B,
                            ),
                ...
                const Gu = [
                    ...
                    Wu = [yu.Gold, yu.Credits, yu.Crystal, yu.FreeXp, yu.NewYearToyFragments],
                    $u = [yu.BattlePassPoints],
                    Xu = [yu.PremiumPlus, yu.Premium],
                        ...
                        return [
                            function ({ mode: u = 'real', options: a, children: o, mocks: s }) {
                                const l = (0, r.useRef)([]),
                                    ...
                                    _ = A[0],
                                    m = A[1],
                                    F = (0, r.useState)(() => E(u, a, s)),
                                    D = F[0],
                                    d = F[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        c.current ? d(E(_, a, s)) : (c.current = !0);
                                    }, [s, _, a]),
                                    (0, r.useEffect)(() => {
                                        m(u);
                                    }, [u]),
                        ...
                        const h = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, r.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (ie(t, m, { isMouseEvent: !0, on: !0, arguments: ae(n) }, b),
                                    C && C(),
                            ...
                            Ae(
                                {
                                    contentId:
                                        ...
                                        c ? _e.SimpleTooltipHtmlContent('resId') : _e.SimpleTooltipContent('resId')),
                ...
                const De = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        return a || o
                            ? n().createElement(oe, Fe({}, e, { contentId: a || o }), r)
                            : n().createElement(Ee, e, r);
                    },
                    de = {
                        base: 'Reward_base_ea',
                    ...
                    Be = ({
                        ...
                        return n().createElement(
                            'div',
                            { className: C()(de.base, de[`base__${r}`], l), style: s },
                            n().createElement(
                                De,
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: C()(de.image, null == E ? void 0 : E.image) },
                                        _ &&
                                            n().createElement('div', {
                                                className: C()(de.highlight, null == E ? void 0 : E.highlight),
                                                style: {
                                        ...
                                        e &&
                                            n().createElement('div', {
                                                className: C()(de.icon, null == E ? void 0 : E.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        m &&
                                            n().createElement('div', {
                                                className: C()(de.overlay, null == E ? void 0 : E.overlay),
                                                style: {
                            ...
                            t &&
                                n().createElement(
                                    ...
                                    { tooltipArgs: A },
                                    n().createElement('div', {
                                        className: C()(de.timer, null == E ? void 0 : E.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                ((ge = Ce || (Ce = {})).Tiny = 'tiny'),
                    ...
                    ((xe = he || (he = {})).Small = 'small'),
                    (xe.Medium = 'medium'),
                    (xe.Big = 'big'),
                    (xe.ExtraBig = 'extraBig'),
                    (xe.Huge = 'huge'),
                    (function (u) {
                        (u.None = 'noAnimation'),
                    ...
                    ((fe = we || (we = {})).ExtraSlot = 'ny22:extraSlot'),
                    (fe.ToyFragments = 'ny22ToyFragments'),
                    (fe.Tman = 'tmanToken'),
                    (fe.AchievementReward = 'dossier_achievement'),
                    (fe.Customizations = 'customizations'),
                    (fe.VariadicDiscount = 'variadicDiscount'),
                    (fe.MarketplaceUnlock = 'ny25_marketplace_unlock'),
                    (fe.LootBoxToken = 'lootBoxToken');
                const Se = [
                    'width',
                    'height',
                    'getSrcByFrame',
                        ...
                        (0, r.useEffect)(() => {
                            ...
                            const l = ((u, e) => {
                                ...
                                _ = setInterval(() => {
                                    const u = c(),
                                        e = l[u];
                                    o(l[u]), s(u, e), u === r && (B(), m || clearInterval(_));
                                }, E);
                            return () => clearInterval(_);
                        }, [i, E, a, t, A, m, s, B, D, e]),
                        n().createElement('canvas', Te({}, C, { width: e, height: t, ref: g }))
                    );
                }),
                    (function (u) {
                ...
                var ye, Oe;
                ((Oe = ye || (ye = {}))[(Oe.Left = 0)] = 'Left'),
                    (Oe[(Oe.Right = 1)] = 'Right'),
                    (Oe[(Oe.Top = 2)] = 'Top'),
                    (Oe[(Oe.Bottom = 3)] = 'Bottom');
                const Pe = ['__left', '__right', '__top', '__bottom'];
                (0, r.forwardRef)(
                ...
                const He = () => {},
                    ...
                    Ge = (u, e, t) => {
                        ...
                        return (
                            (r = u),
                            (n = (u) => Object.assign({}, u, { image: Ue(u, e ? t : Pu.Big) })),
                            Array.isArray(r) ? r.map(n) : r.map(({ value: u }, e, t) => n(u))
                        );
                    },
                    We = {
                        ...
                        rewardInfo__currency: 'AnimationRewards_rewardInfo__currency_e4',
                ...
                const Xe = 150,
                    je = R.strings.ny.questGiverRewards,
                    Ye = ({
                        items: u,
                        ...
                        const E =
                            ...
                            c = E[0],
                            A = E[1],
                            _ = c.length + Number(Boolean(A.length)),
                            m = {
                        ...
                        return (
                            (0, r.useEffect)(() => {
                                ...
                                const t = setTimeout(() => {
                                    ...
                                    u = window.setInterval(() => {
                                        I(R.sounds.$dyn(a)), e++, e >= _ && clearTimeout(u);
                                    }, Xe);
                                }, e - 300);
                                return () => {
                            ...
                            n().createElement(
                                ...
                                { className: We.base },
                                c.map((u, t) => {
                                    const r = 'lootBoxToken' === u.name,
                                        a =
                                            'ny25Token' === u.icon
                                                ? [je.button.toMachine(), l]
                                                : [je.button.toLootboxes(), s],
                                        E = a[0],
                                        c = a[1];
                                    return n().createElement(
                                        'div',
                                        {
                                            className: C()(We.reward, o && We.reward__main),
                                            key: u.label,
                                            style: { animationDelay: `${e + Xe * t}ms` },
                                        },
                                        n().createElement(
                                            Be,
                                            $e({}, u, {
                                                size: i,
                                                classNames: {
                                                    info: o && C()(We.rewardInfo, We[`rewardInfo__${u.valueType}`]),
                                                    image: We.rewardImage,
                                                },
                                            }),
                                        ),
                                        o &&
                                            n().createElement(
                                                'div',
                                                { className: C()(We.description, We[`description__${i}`]) },
                                                n().createElement('div', { className: We.name }, u.label),
                                                r &&
                                                    n().createElement(
                                                        'div',
                                                        { className: We.btnWrapper },
                                                        n().createElement(
                                                            Y,
                                                            { type: G.ghost, mixClass: We.btn, onClick: c },
                                                            E,
                                                        ),
                                                    ),
                                            ),
                                ...
                                A.length > 0 &&
                                    n().createElement(
                                        'div',
                                        { className: We.reward, style: { animationDelay: `${e + Xe * c.length}ms` } },
                                        n().createElement(Be, {
                                            name: 'more',
                    ...
                    qe = 'App_confirmButton_39',
                    ze = R.strings.ny.questGiverRewards,
                    Ve = ze.button,
                    Ke = (0, Ru.Pi)(() => {
                        const u = ee(),
                            e = u.model,
                            ...
                            s = i[1],
                            l = f().mediaSize,
                            E = ((u) => (u < h.Medium ? 's296x222' : u >= h.ExtraLarge ? 's600x450' : 's400x300'))(l),
                            c = Ge(a.slice(0, 2), !0, E),
                            A = Ge(a.slice(2), !1),
                            _ = l < h.Medium ? Pu.Small : Pu.Big,
                            m = 2100 + Xe * a.length;
                        return (
                            (0, r.useEffect)(() => {
                            ...
                            (0, r.useEffect)(
                                () =>
                                    ((u, e) => {
                                        let t;
                                        const r = setTimeout(() => {
                                            I(R.sounds.gui_random_reward_end()), (t = void s(!0));
                                        }, e);
                                        return () => {
                            ...
                            n().createElement(
                                ...
                                n().createElement('div', { className: 'App_sunRays_5f' }),
                                n().createElement(
                                    'div',
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            'div',
                                            { className: 'App_header_6c' },
                                            n().createElement(Tu, { text: ze.title(), className: 'App_title_7e' }),
                                            n().createElement(Tu, {
                                                text: ze.subtitle(),
                                        ...
                                        n().createElement(
                                            ...
                                            n().createElement('div', { className: C()('App_ribbon_4e') }),
                                            c.length > 0 &&
                                                n().createElement(
                                                    'div',
                                                    { className: 'App_hugeRewards_93' },
                                                    n().createElement(Ye, {
                                                        items: c,
                                                        animationDelayStart: 1200,
                                                        maxLength: 2,
                                                        size: E,
                                                        sound: 'gui_gift_system_newyear_reward_appear_main',
                                                        isMainRewards: !0,
                                            ...
                                            A.length > 0 &&
                                                n().createElement(
                                                    ...
                                                    n().createElement(Ye, {
                                                        ...
                                                        maxLength: 4,
                                                        size: _,
                                                        sound: 'gui_gift_system_newyear_reward_appear_small',
                                                    }),
                                                ),
                                        ),
                                        n().createElement(
                                            'div',
                                            { className: C()('App_confirm_e7', o && 'App_confirm__visible_4f') },
                                            n().createElement(
                                                'div',
                                                { className: 'App_buttons_e4' },
                                                n().createElement(
                                                    Y,
                                                    { mixClass: qe, size: W.medium, onClick: t.close },
                                                    n().createElement(Tu, { text: Ve.ok() }),
                                                ),
                                                n().createElement(
                                                    Y,
                                                    {
                                                        ...
                                                        size: W.medium,
                                                        type: G.secondary,
                                                        onClick: t.goToQuests,
                                                    },
                                                    n().createElement(Tu, { text: Ve.back() }),
                                                ),
                                            ),
                                        ),
                                    ),
                                ...
                                n().createElement(
                                    'div',
                                    { className: 'App_imageWrapper_3a' },
                                    n().createElement('div', { className: 'App_snowgirl_6a' }),
                                ),
                            )
                        );
                    });
                engine.whenReady.then(() => {
                    k().render(
                        n().createElement(ue, null, n().createElement(P, null, n().createElement(Ke, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(4094));
