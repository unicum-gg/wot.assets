(() => {
    var __webpack_modules__ = {
            ...
            4836: (u, e, t) => {
                ...
                const o = n.O.client.getSize('rem'),
                    ...
                    c = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && D) return E(e, t, v);
                ...
                const M = {
                    ...
                    T = (u) => {
                        ...
                        const E = x(),
                            ...
                            A = E.mediaHeight,
                            i = E.mediaSize;
                        return a().createElement('div', w({ className: d()(t, M[n], L[A], S[i]) }, r), e);
                    },
                    O = ['children'],
                    y = (u) => {
                        let e = u.children,
                    ...
                    const c = (0, r.useRef)(null),
                        ...
                        k = d()(
                            ...
                            N[`base__${E}`],
                            {
                                ...
                                [N.base__firstHover]: x,
                            },
                            A,
                        ),
                        I = d()(N.state, N.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                ...
                const J = {
                    ...
                    tu = q((u) => {
                        ...
                        const I = (0, r.useMemo)(() => {
                            ...
                            }, [t, E, i, o, s, _, P, k, L, m, O, f, M]),
                            G = I.computedStyle,
                            U = I.computedClassNames;
                        return a().createElement('div', Q({ className: d()(Y.base, ...U, e), style: G }, W), N);
                    });
                let ru;
                !(function (u) {
                ...
                const au = (u, e, t) => {
                    ...
                    Fu = ({ binding: u, text: e = '', classMix: t, alignment: E = ru.left }) =>
                        null === e
                ...
                const Bu = Object.keys(Du()),
                    ...
                    gu = q((u) => {
                        ...
                        return a().createElement(
                            ...
                            _u(
                                {
                                    className: d()(su.base, t && su[t], p, E),
                                    style: g,
                                    mt: !0 === F ? du[t || 'paragraph-P16'].mt : F,
                                    mr: !0 === D ? du[t || 'paragraph-P16'].mr : D,
                                    mb: !0 === l ? du[t || 'paragraph-P16'].mb : l,
                                    ml: !0 === B ? du[t || 'paragraph-P16'].ml : B,
                                },
                                m,
                            ),
                            void 0 !== C ? a().createElement(Fu, _u({}, C, { text: e })) : e,
                        );
                    }),
                    pu = {
                ...
                class xu extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = d()(pu.base, pu[`base__${n}`], pu[`base__${E}`], null == A ? void 0 : A.base),
                            _ = d()(pu.icon, pu[`icon__${n}`], pu[`icon__${E}`], null == A ? void 0 : A.icon),
                            B = d()(pu.glow, null == A ? void 0 : A.glow),
                            c = d()(pu.caption, pu[`caption__${n}`], null == A ? void 0 : A.caption),
                            C = d()(pu.goto, null == A ? void 0 : A.goto);
                        return a().createElement(
                            'div',
                            bu(
                                {
                ...
                function Mu(u = fu.n.NONE, e = wu, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== fu.n.NONE)
                            return (
                ...
                const Ru = (u) => (0 === u ? window : window.subViews.get(u)),
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : i(e),
                                                            a = Tu.observable.box(r, { equals: Su });
                                                        return (
                                                            'real' === u &&
                                                                A.subscribe(
                                                                    (0, Tu.action)((u) => a.set(u)),
                                                                    e,
                                                                ),
                                                            a
                                                        );
                    ...
                    })(0, ({ externalModel: u }) => ({ close: u.createCallbackNoArgs('onClose') })),
                    Hu = yu[0],
                    ku = yu[1],
                    Pu = ['first', 'second', 'third'],
                    Nu = R.strings.ny.leaderboard.info,
                    Wu = R.images.new_year.gui.maps.icons.newYear.leaderboardInfoView,
                    Iu = (0, Lu.observer)(() => {
                        const u = ku().controls,
                            e = (0, r.useState)(!1),
                            t = e[0],
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: d()('App_base_b8', t && 'App_base__hide_44') },
                                a().createElement('div', { className: 'App_background_3d' }),
                                a().createElement(xu, {
                                    caption: Nu.close(),
                                    classNames: { base: 'App_close_f5' },
                                    type: 'close',
                                    side: 'right',
                                    onClick: i,
                                }),
                                a().createElement(
                                    'div',
                                    { className: 'App_header_7c' },
                                    a().createElement(gu, { text: Nu.title(), className: 'App_title_a9' }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: 'App_contentWrapper_81' },
                                    a().createElement(
                                        'div',
                                        { className: 'App_content_6a' },
                                        Pu.map((u) =>
                                            a().createElement(
                                                'div',
                                                { className: 'App_blockContainer_12', key: u },
                                                a().createElement('div', {
                                                    className: 'App_image_61',
                                                    style: { backgroundImage: `url(${Wu.$dyn(u)})` },
                                                }),
                                                a().createElement(gu, {
                                                    className: 'App_description_31',
                                                    text: Nu.description.$dyn(u),
                                                }),
                                            ),
                                        ),
                                    ),
                                ...
                                a().createElement(
                                    'div',
                                    { className: 'App_footer_af' },
                                    a().createElement(
                                        U,
                                        { type: W.primary, onClick: i, mixClass: 'App_button_c6' },
                                        a().createElement(gu, { text: Nu.submit() }),
                                    ),
                                ),
                            )
                        );
                ...
                engine.whenReady.then(() => {
                    k().render(
                        a().createElement(Hu, null, a().createElement(y, null, a().createElement(Iu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(4836));
