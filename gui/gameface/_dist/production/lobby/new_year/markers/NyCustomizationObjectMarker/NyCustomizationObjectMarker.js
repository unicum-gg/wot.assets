(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => E, off: () => l, on: () => o, onResize: () => a, onScaleUpdated: () => i });
                var r = t(2472),
                    n = t(1176);
            ...
            514: (u, e, t) => {
                ...
                const n = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    ...
                    i = Object.assign({}, a, { sound: r.playSound }),
            ...
            9814: (u, e, t) => {
                ...
                const m = (u) => {
                    ...
                    const n = (0, r.useContext)(d),
                        ...
                        v = { extraLarge: _, large: C, medium: h, small: g, extraSmall: f };
                ...
                const x = {
                    ...
                    k = (u) => {
                        ...
                        const a = b(),
                            ...
                            o = a.mediaHeight,
                            l = a.mediaSize;
                        return n().createElement('div', y({ className: h()(t, x[i], S[o], T[l]) }, r), e);
                    },
                    O = ['children'];
                const M = (u) => {
                    let e = u.children,
                ...
                const K = (0, r.forwardRef)(function (u, e) {
                        let t = u.src,
                            a = u.className,
                            o = u.autoplay,
                            l = void 0 !== o && o,
                        ...
                        return (
                            (_ = () =>
                                i.O.view.events.onDisplayChanged((u, e) => {
                                    var t, r;
                                    e === W.W.hidden && (null == (t = B.current) || t.pause()),
                                        e === W.W.shown && (null == (r = B.current) || r.play());
                                })),
                            (0, r.useEffect)(_, []),
                            (0, r.useEffect)(
                                () =>
                            ...
                            n().createElement(
                                'video',
                                $({ src: t, className: a, style: s, loop: A, ref: B, onClick: d }, D),
                            )
                        );
                    }),
                    j = (0, r.memo)(K);
                ...
                const su = {
                    ...
                    Eu = n().memo((u) => {
                        ...
                        return n().createElement(
                            'div',
                            { className: h()(su.base, u.className) },
                            e((u, { markerType: e, levelState: t, markerContent: r }) =>
                                n().createElement(
                                    lu.animated.div,
                                    { style: u, className: h()(su.content, su[`content__${e}`], su[`content__${t}`]) },
                                    r,
                                    n().createElement('div', { className: h()(su.gradient, su[`gradient__${e}`]) }, r),
                                ),
                            ),
                        );
                    });
                let Au;
                !(function (u) {
                    (u.ShowArrows = 'showArrows'), (u.ShowMarker = 'showMarker'), (u.UpdateToys = 'updateToys');
                })(Au || (Au = {}));
                const Fu = (u) => u.startTime + ((null == u ? void 0 : u.duration) || 0),
                    cu = { startTime: 0, duration: 800 },
                    du = { startTime: Fu(cu) - 300, duration: 1400 },
                    Du = { startTime: Fu(du) - 400 },
                    mu = { [Au.ShowArrows]: cu, [Au.ShowMarker]: du, [Au.UpdateToys]: Du };
                var Bu = t(9174);
                function _u(u, e) {
                ...
                const gu = ((u, e) => {
                                    ...
                                    A = (t, r, n) => {
                                        ...
                                        const o = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = _u(n.keys()); !(u = t()).done; ) a(u.value, e);
                                                    },
                                                    unsubscribe: a,
                                                };
                                            })(r),
                                            ...
                                            c = { mode: t, model: F, externalModel: l, cleanup: A };
                                        return {
                                            model: F,
                        ...
                        ({ externalModel: u }) => ({ onLevelUpdate: u.createCallbackNoArgs('onLevelUpdate') }),
                    ),
                    fu = gu[0],
                    vu = gu[1],
                    wu = {
                        base: 'App_base_0a',
                        base__hidden: 'App_base__hidden_ed',
                        base__maxLevel: 'App_base__maxLevel_f7',
                        inner: 'App_inner_ac',
                        icon: 'App_icon_fc',
                        bricksLevel: 'App_bricksLevel_d3',
                        effects: 'App_effects_6d',
                        rhombs: 'App_rhombs_fe',
                        'base__animation-idle': 'App_base__animation-idle_65',
                        slideInFadeIn: 'App_slideInFadeIn_9f',
                        fadeOut: 'App_fadeOut_b2',
                        fadeIn: 'App_fadeIn_cc',
                        fadeInWithScale: 'App_fadeInWithScale_b3',
                        slideUp: 'App_slideUp_8c',
                        scale: 'App_scale_20',
                        spin: 'App_spin_5d',
                        blink: 'App_blink_5b',
                        slideInNotification: 'App_slideInNotification_5f',
                    };
                var pu = t(9762);
                t(1281);
                let bu;
                ...
                var Lu = t(9916),
                    yu = t(8613);
                Date.now(), yu.Ew.getRegionalDateTime, yu.Ew.getFormattedDateTime;
                const xu = (u, e) => {
                    const t = (0, r.useRef)();
                    return (
                        (0, r.useEffect)(() => {
                ...
                const Tu = xu,
                    ku = {
                        base: 'BricksLevel_base_2c',
                        base__opening: 'BricksLevel_base__opening_90',
                        show: 'BricksLevel_show_3c',
                        base__hiding: 'BricksLevel_base__hiding_1d',
                        hiding: 'BricksLevel_hiding_c1',
                        base__hidden: 'BricksLevel_base__hidden_ac',
                        level: 'BricksLevel_level_03',
                        level__friend: 'BricksLevel_level__friend_70',
                        filledBrick: 'BricksLevel_filledBrick_63',
                        filledBrick__hidden: 'BricksLevel_filledBrick__hidden_18',
                        filledBrick__opening: 'BricksLevel_filledBrick__opening_7f',
                        filledBrick__hiding: 'BricksLevel_filledBrick__hiding_d9',
                    };
                let Ou;
                !(function (u) {
                    (u.Empty = 'empty'), (u.Filled = 'filled');
                })(Ou || (Ou = {}));
                const Mu = n().memo(function ({ state: u, markerType: e }) {
                    const t = Tu(u),
                        r = n().useMemo(() => {
                            return (
                                (e = u === Ou.Empty ? 'hidden' : 'default'),
                                (0, pu.C)({
                                    id: 'BricksLevel',
                                    initial: e,
                                    states: {
                                        default: { on: { HIDE: 'hiding' } },
                                        hiding: { after: { 700: { target: 'hidden' } } },
                                        hidden: { on: { SHOW: 'opening' } },
                                        opening: { after: { 700: { target: 'default' } } },
                                    },
                                })
                            );
                            var e;
                    ...
                    return (
                        n().useEffect(() => {
                            t === Ou.Empty && u === Ou.Filled && o('SHOW'),
                                t === Ou.Filled && u === Ou.Empty && o('HIDE');
                        }, [u, t, o]),
                        n().createElement(
                            'div',
                            { className: h()(ku.level, e === V.Friend && ku.level__friend) },
                            n().createElement('div', { className: h()(ku.filledBrick, ku[`filledBrick__${i.value}`]) }),
                        )
                    );
                });
                Mu.State = Ou;
                const Ru = 700,
                    Hu = (0, ou.Pi)(({ value: u, onAnimationEnd: e }) => {
                        const t = vu().model.root.get().markerType,
                            r = n().useState(u),
                            a = r[0],
                            i = r[1],
                            o = n().useMemo(() => {
                                return (
                                    (e = 0 === u ? 'hidden' : 'default'),
                                    (0, pu.C)({
                                        id: 'BricksLevel',
                                        initial: e,
                                        states: {
                                            default: { on: { HIDE: 'hiding' } },
                                            hiding: { after: { [Ru]: { target: 'hidden' } } },
                                            hidden: { on: { SHOW: 'opening' } },
                                            opening: { after: { [Ru]: { target: 'default' } } },
                                        },
                                    })
                                );
                                var e;
                        ...
                        return (
                            ...
                            n().useEffect(() => {
                                if ((s.matches('hidden') && (null == e || e()), s.matches('default')))
                                    return (
                                        i(u),
                                        uu(() => {
                                            null == e || e();
                            ...
                            n().createElement(
                                'div',
                                { className: h()(ku.base, ku[`base__${s.value}`]) },
                                ((u, e) => {
                                    const t = [];
                                    ...
                                    return n().createElement(Mu, {
                                        key: e,
                                        state: a >= e && 0 !== a ? Mu.State.Filled : Mu.State.Empty,
                                        markerType: t,
                                    });
                                }),
                            )
                ...
                const Iu = (0, ou.Pi)(() => {
                    const u = (0, r.useRef)(null),
                        ...
                        A = l.objectType,
                        F = l.isVisible,
                        c = l.isAbleForUpgrade,
                        d = l.isMaxLevelState,
                        D = ((u) => (0 === u ? Q.Zero : Q.Number))(E),
                        m = iu(E),
                        B = s === V.Friend;
                    (0, r.useEffect)(() => {
                        i.O.view.resize(190, 190, 'rem');
                    }, []);
                    const _ = n().useMemo(() => {
                            return (
                                (u = { levelState: D, markerContent: m, bricksLevel: E }),
                                (0, pu.C)({
                                    id: 'animationMachine',
                                    initial: 'idle',
                                    context: u,
                                    states: {
                                        idle: { on: { START: { target: 'level' } } },
                                        level: {
                                            on: {
                                                UPDATE_AND_NEXT: {
                                                    target: 'bumpRhomb',
                                                    actions: (0, Pu.f0)({
                                                        levelState: (u, e) => e.levelState,
                                                        markerContent: (u, e) => e.markerContent,
                                                    }),
                                                },
                                                BREAK: {
                                                    target: 'idle',
                                        ...
                                        bumpRhomb: {
                                            on: {
                                                UPDATE_BRICKS_LEVEL: {
                                                    target: 'showLvlBrick',
                                                    actions: (0, Pu.f0)({ bricksLevel: (u, e) => e.bricksLevel }),
                                                },
                                            },
                                        },
                                        showLvlBrick: { on: { END: 'idle' } },
                                    },
                                })
                            );
                            var u;
                    ...
                    n().useEffect(() => {
                        ...
                        n().useEffect(() => {
                            e.current
                                ...
                                : uu(() => {
                                      f({ type: 'START' });
                                  }, mu[Au.ShowMarker].startTime);
                        }, [w, f]),
                        n().useEffect(() => {
                            if ('level' === g.value) {
                                if (!c)
                                    return void f({ type: 'BREAK', levelState: D, markerContent: m, bricksLevel: E });
                                f({ type: 'UPDATE_AND_NEXT', levelState: D, markerContent: m });
                            }
                        }, [g.value, E, c, D, m, f]),
                        n().useEffect(() => {
                            const e = u.current;
                            if (e)
                                return g.matches('bumpRhomb')
                                    ? (e.stop(),
                                      e.play(),
                                      uu(() => {
                                          f({ type: 'UPDATE_BRICKS_LEVEL', bricksLevel: E }),
                                              o.onLevelUpdate(),
                                              eu.hY.sound(R.sounds.hangar_newyear_enter_custome());
                                      }, mu[Au.ShowMarker].duration))
                                    : void 0;
                        }, [g, o, E, u, f]);
                    const b = (function (u) {
                        ...
                        n().createElement(
                            ...
                            n().createElement(
                                'div',
                                {
                                    className: wu.icon,
                                    style: {
                                        backgroundImage: `url(${R.images.gui.maps.icons.newYear.markers.customization.$dyn(`body_${s}`)})`,
                                    },
                                },
                                n().createElement(Eu, {
                                    markerContent: B ? m : g.context.markerContent,
                                    levelState: B ? D : g.context.levelState,
                                    markerType: s,
                                }),
                                !B &&
                                    n().createElement(
                                        'div',
                                        { className: wu.bricksLevel },
                                        n().createElement(Hu, { value: g.context.bricksLevel, onAnimationEnd: b }),
                                    ),
                            ),
                            c &&
                                n().createElement(
                                    'div',
                                    { className: wu.effects },
                                    n().createElement(j, {
                                        className: wu.rhombs,
                                        src: R.videos.new_year.level.rhombs(),
                                        ref: u,
                                    }),
                                ),
                        ),
                ...
                engine.whenReady.then(() => {
                    P().render(
                        n().createElement(M, null, n().createElement(fu, null, n().createElement(Iu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(9814));
