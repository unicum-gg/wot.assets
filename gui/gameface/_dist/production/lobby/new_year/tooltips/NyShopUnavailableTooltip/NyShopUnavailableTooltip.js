            ...
            9201: (e, n, t) => {
                ...
                const ee = u().forwardRef(function (e, n) {
                    ...
                    ne = {
                        ...
                        icon: 'App_icon_f9',
                        title: 'App_title_82',
                        description: 'App_description_b4',
                    },
                    te = R.strings.ny,
                    re = () =>
                        u().createElement(
                            ...
                            u().createElement(
                                'div',
                                { className: ne.base },
                                u().createElement('div', { className: ne.icon }),
                                u().createElement(
                                    'div',
                                    ...
                                    u().createElement(
                                        'div',
                                        { className: ne.title },
                                        te.lootBoxesPopover.alert.header(),
                                    ),
                                    u().createElement(
                                        'div',
                                        { className: ne.description },
                                        te.lootBoxesPopover.alert.body(),
                                    ),
                                ),
                            ),
                        );
