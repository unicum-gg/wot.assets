    ...
    var u,
        e = {
            ...
            1887: (u, e, t) => {
                ...
                const U = Object.keys(p).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === p[e]), u), {}),
                    K = {
                        set: (u, e) => {
                ...
                const Su = {
                    ...
                    yu = pu((u) => {
                        ...
                        return a().createElement('div', bu({ className: C()(fu.base, ...X, e), style: I }, G), N);
                    });
                let Mu;
                !(function (u) {
                ...
                const Ru = (u, e, t) => {
                    ...
                    Hu = (u, e, t = Mu.left) => u.split(e).reduce(t === Mu.left ? Ru : Tu, []),
                    Ou = (() => {
                        const u = new RegExp(
                    ...
                    Wu = ({ binding: u, text: e = '', classMix: t, alignment: A = Mu.left }) =>
                        null === e
                ...
                const zu = Object.keys(Gu()),
                    ...
                    Yu = pu((u) => {
                        ...
                        return a().createElement(
                            ...
                            void 0 !== c ? a().createElement(Wu, Xu({}, c, { text: e })) : e,
                        );
                    });
                var qu = t(3282);
                function Qu() {
                ...
                const ue = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    Ae = ee[1],
                    Ee = (0, qu.observer)(() => {
                        const u = Ae().model.root.get().type;
                        return a().createElement(
                            'div',
                            { className: 'App_base_fc' },
                            a().createElement(Yu, {
                                text: R.strings.ny.petStepper.tooltip.description(),
                                format: {
                                    binding: {
                                        controlsImage: a().createElement('div', { className: 'App_controlsImage_2e' }),
                                        tokenImage: a().createElement('div', {
                                            className: 'App_tokenImage_23',
                                            style: {
                                                backgroundImage: `url(${R.images.new_year.gui.maps.icons.newYear.common.categoriesIcons.c_24x24.$dyn(u)})`,
                                            },
                                        }),
                                    },
                                },
                ...
                engine.whenReady.then(() => {
                    B().render(
                        a().createElement(te, null, a().createElement(tu, null, a().createElement(Ee, null))),
