(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                'use strict';
                t.d(e, { Sw: () => a.Z, B0: () => s, wU: () => b, ry: () => C, Eu: () => g, SW: () => v, P3: () => w });
                class r {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            129: (u, e, t) => {
                ...
                const w = E.O.client.getSize('rem'),
                    b = w.width,
                    f = w.height,
                    x = Object.assign({ width: b, height: f }, v(b, f, h)),
                    ...
                    O = (u) => {
                        ...
                        const n = (0, r.useContext)(y),
                            ...
                            h = { extraLarge: m, large: D, medium: _, small: B, extraSmall: C };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && l) return g(e, t, h);
                            if (t.largeWidth && c) return g(e, t, h);
                            if (t.mediumWidth && A) return g(e, t, h);
                            if (t.smallWidth && F) return g(e, t, h);
                            if (t.extraSmallWidth && d) return g(e, t, h);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                ((0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(y),
                        ...
                        o = (0, r.useCallback)((u, e) => {
                            ...
                            i(Object.assign({ width: t, height: r }, v(t, r, h)));
                        }, []);
                    (((u) => {
                    ...
                    (function (u) {
                        ((u[(u.ExtraSmall = h.extraSmall.width)] = 'ExtraSmall'),
                            (u[(u.Small = h.small.width)] = 'Small'),
                            (u[(u.Medium = h.medium.width)] = 'Medium'),
                            (u[(u.Large = h.large.width)] = 'Large'),
                            (u[(u.ExtraLarge = h.extraLarge.width)] = 'ExtraLarge'));
                    })(M || (M = {})),
                    (function (u) {
                        ((u[(u.ExtraSmall = h.extraSmall.width)] = 'ExtraSmall'),
                            (u[(u.Small = h.small.width)] = 'Small'),
                    ...
                    (function (u) {
                        ((u[(u.ExtraSmall = h.extraSmall.height)] = 'ExtraSmall'),
                            (u[(u.Small = h.small.height)] = 'Small'),
                            (u[(u.Medium = h.medium.height)] = 'Medium'),
                            (u[(u.Large = h.large.height)] = 'Large'),
                            (u[(u.ExtraLarge = h.extraLarge.height)] = 'ExtraLarge'));
                    })(L || (L = {})));
                ...
                const G = {
                    ...
                    X = H((u) => {
                        ...
                        const X = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, E, c, F, m, R, N, S, C, T, f, y]),
                            Y = X.computedStyle,
                            z = X.computedClassNames;
                        return n().createElement('div', U({ className: s()(W.base, ...z, e), style: Y }, H), k);
                    });
                let Y;
                function z(u, e) {
                ...
                const K = (u, e, t) => {
                    ...
                    J = ['zh_cn', 'zh_sg', 'zh_tw'],
                    uu = ({ binding: u, text: e = '', classMix: t, alignment: a = Y.left }) =>
                        null === e
                ...
                const iu = Object.keys(tu()),
                    ...
                    Au = H((u) => {
                        ...
                        return n().createElement(
                            ...
                            au(
                                {
                                    className: s()(ru.base, t && ru[t], p, a),
                                    style: h,
                                    mt: !0 === l ? lu[t || 'paragraph-P16'].mt : l,
                                    mr: !0 === A ? lu[t || 'paragraph-P16'].mr : A,
                                    mb: !0 === d ? lu[t || 'paragraph-P16'].mb : d,
                                    ml: !0 === D ? lu[t || 'paragraph-P16'].ml : D,
                                },
                                C,
                            ),
                ...
                (!(function (u) {
                    ...
                    ((_u = Du || (Du = {})).SHORT_DATE = 'short-date'),
                ...
                const hu = (u = 0, e, t = 0, n = Cu) => {
                    ...
                    pu = 'Countdown_description_32',
                    vu = (u) => u.toString().padStart(2, '0'),
                    wu = R.images.gui.maps.icons.components.countdown,
                    bu = (u, e) => {
                        const t = 2 === e ? wu.big : wu;
                        switch (u) {
                            case du.Timer:
                                return t.clock();
                            case du.Countdown:
                    ...
                    fu = (0, r.memo)(
                        ({
                            ...
                            icon: t = du.Timer,
                            style: a = mu.Description,
                            onTimeReached: i,
                            className: o = '',
                            classNames: l = {},
                            labelFormat: c = '',
                        }) => {
                            const A = a !== mu.Description ? 1 : void 0,
                                F = hu(u, A),
                                d = (() => {
                                                ...
                                                : u.days >= 1
                                                  ...
                                                  : u.hours >= 1
                                                    ? 0 === u.minutes
                                                        ...
                                                        : `${z(R.strings.common.duration.hours(), { hours: u.hours })} ${z(t ? R.strings.common.duration.shortMinutes() : R.strings.common.duration.minutes(), { minutes: u.minutes })}`
                                                    : z(R.strings.common.duration.minutes(), {
                                                          minutes: u.minutes || 1,
                                                      }))(u, !0, t);
                                    case mu.Short:
                                        return `${vu(u.minutes)}:${vu(u.seconds)}`;
                                    case mu.Long:
                                        return `${vu(u.hours)}:${vu(u.minutes)}:${vu(u.seconds)}`;
                                    case mu.Extended:
                                        return `${z(R.strings.common.duration.days(), { days: u.days })} | ${vu(u.hours)}:${vu(u.minutes)}:${vu(u.seconds)}`;
                                }
                            })(
                                (function (u = 0) {
                                    let e = u;
                            ...
                            return n().createElement(
                                ...
                                t !== du.None &&
                                    n().createElement('div', {
                                        className: s()('Countdown_icon_ff', l.icon),
                                        style: { backgroundImage: `url('${bu(t, d)}')` },
                                    }),
                                c
                                    ? n().createElement(
                                          'div',
                                          { className: s()(pu, l.text) },
                                          n().createElement(uu, { text: c, binding: { timerText: m } }),
                                      )
                                    : n().createElement('div', { className: s()(pu, l.text) }, m),
                            );
                        },
                    ),
                    xu = [
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Su(t, d, { isMouseEvent: !0, on: !0, arguments: yu(n) }, v),
                                    C && C(),
                ...
                const Hu = ['__left', '__right', '__top', '__bottom'],
                    Wu =
                        ((0, r.forwardRef)(
                            ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: a = {} }, i) => {
                                const o = (0, r.useRef)(null),
                                    c = (0, r.useRef)(null),
                                    A = (0, r.useRef)(null),
                                    F = (0, r.useState)(window.decorator && window.decorator.directionType),
                                    d = F[0],
                                    m = F[1],
                                    D = (0, r.useCallback)(() => {
                                        (Nu.playClick(), E.O.view.sendEvent.close());
                                    }, []),
                                    _ = (0, r.useCallback)(() => {
                                        Nu.playHighlight();
                                    }, []),
                                    B = s()(Ru.arrow, Ru[`arrow${Hu[d]}`]);
                                l(
                                    () => (
                                ...
                                return (
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: Ru.base, ref: c },
                                        n().createElement(
                                            'div',
                                            { className: Ru.decorator },
                                            n().createElement(
                                                'div',
                                                { className: Ru.content, ref: o },
                                                u,
                                                window.decorator &&
                ...
                const Uu = (u) => {
                    ...
                    const d = (0, r.useRef)(null),
                        m = (0, r.useCallback)(() => {
                            ...
                            d.current && (0, Bu.P3)(e, i, d.current, t, o, s);
                        }, [e, i, s, t, o]);
                    return n().createElement(
                        'div',
                        ju(
                ...
                const Zu = R.strings.ny.pet.onboarding,
                    Qu =
                        (Xu.NewStory,
                        Xu.Empty,
                        Xu.Leaderboard,
                        Zu.leaderboard.title(),
                        Zu.leaderboard.description(),
                        Zu.leaderboard.button(),
                        Ku.Third,
                        Xu.FunOpened,
                        Zu.funOpened.title(),
                        Zu.funOpened.description(),
                        Zu.funOpened.button(),
                        Ku.First,
                        Xu.ActivityOpened,
                        Zu.activityOpened.title(),
                        Zu.activityOpened.description(),
                        Zu.activityOpened.button(),
                        Ku.First,
                        Yu.Null,
                        qu.HeaderOpacity,
                        qu.Indicators,
                    ...
                    ee = (0, r.memo)(
                        ({
                            ...
                            onComplete: l,
                            wasOverflowed: A,
                            onResetWasOverflowed: F,
                            onProgressFillSound: d,
                        }) => {
                            ...
                            return n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    {
                                        ...
                                        onAnimationStart: () => {
                                            h || Iu(R.sounds.hangar_newyear_raccoon_max_resources());
                                        },
                ...
                const ne = R.strings.ny.pet.category,
                                    ...
                                    j = (0, r.useCallback)(
                                        (u) => {
                                            w ||
                                                b ||
                                                (u.stopPropagation(),
                                                (e !== Yu.Fifth && e !== Yu.Seventh) || m(!0),
                                                e === Yu.Fifth && Iu(R.sounds.ny_vo_terentiy_help_stop()),
                                                Nu.playClick(),
                                                E(D));
                                        },
                                        [m, b, w, e, E, D],
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            'div',
                                            {
                                                className: s()(
                                                    'Indicator_base_05',
                                                    w && 'Indicator_base__locked_82',
                                                    b && 'Indicator_base__loading_8f',
                                                ),
                                                onMouseEnter: () => {
                                                    w || b || (Nu.playHighlight(), O(!0));
                                                },
                                                onMouseLeave: () => {
                                                    w || b || O(!1);
                                                },
                                            ...
                                            n().createElement('div', {
                                                className: s()(
                                                    ...
                                                    (w || b) && 'Indicator_backgroundDisabled__visible_0f',
                                                ),
                                            }),
                                            n().createElement(
                                                'div',
                    ...
                    le = R.images.new_year.gui.maps.icons.newYear.mainView.petView,
                    ce = (0, r.memo)(({ activeBlink: u, type: e, progressState: t, isLocked: r = !1 }) => {
                        const a = { backgroundImage: `url(${le.common.slot_blink.$dyn(e)})` },
                            i = { backgroundImage: `url(${le.common.blinks.$dyn(e)})` };
                        return n().createElement(
                            'div',
                            { className: s()(Ee, r && 'SlotIndicators_base__locked_17') },
                            !r &&
                                t.map((r, o) =>
                                    n().createElement(
                                        'div',
                    ...
                    De = (u) => {
                        return null !== u && 'object' == typeof u
                            ? 'CoherentArrayProxy' === u.constructor.name
                                ? ((e = u),
                                  (t = (u) => ('object' == typeof u ? De(u) : u)),
                                  Array.isArray(e) ? e.map(t) : e.map((u, e, r) => t(null == u ? void 0 : u.value)))
                                : Array.isArray(u)
                                  ? u.map((u) => ('object' == typeof u ? De(u) : u))
                                  : Object.fromEntries(
                                        Object.entries(u).map(([u, e]) => [u, 'object' == typeof e ? De(e) : e]),
                                    )
                            : u;
                        var e, t;
                    };
                ...
                const Be = ((u, e) => {
                                ...
                                const o = (0, r.useRef)([]),
                                    s = (u, e, t) => {
                                        ...
                                        const n = (function ({
                                            ...
                                            l = (({ observableModel: u }) => {
                                                const e = { indicator: u.array('indicator') };
                                                return {
                                                    computes: {
                                                        getIndicator: (0, _e.computedFn)(
                                                            () => {
                                                                return ((u = e.indicator.get()), De(u))[0];
                                                                var u;
                                                            },
                                                            { equals: Ae },
                                                        ),
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : i(e),
                                                            n = Fe.observable.box(r, { equals: Ae });
                                                        return (
                                                            'real' === u &&
                                                                a.subscribe(
                                                                    (0, Fe.action)((u) => n.set(u)),
                                                                    e,
                                                                ),
                                                            n
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const n = e.reduce(
                                                                (u, e) => ((u[e] = Fe.observable.box(r[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                                            ...
                                            c = { mode: u, model: l, externalModel: a, cleanup: s };
                                        return {
                                            model: l,
                                    ...
                                    A = c[0],
                                    F = c[1],
                                    d = (0, r.useState)(() => s(u, e, i)),
                                    m = d[0],
                                    D = d[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? D(s(A, e, i)) : (l.current = !0);
                                    }, [i, A, e]),
                                    (0, r.useEffect)(() => {
                                        F(u);
                                    }, [u]),
                    ...
                    he = 'App_row_00',
                    pe = 'App_rowText_5a',
                    ve = 'App_roundedValue_d1',
                    we = 'App_timer_15',
                    be = 'App_timerIcon_09',
                    fe = R.images.new_year.gui.maps.icons.newYear,
                    xe = R.strings.ny.pet,
                    ye = R.strings.ny.petWidgetTooltips.petIndicator.main,
                    Se = (0, Fu.observer)(() => {
                        const u = ge().model.computes.getIndicator(),
                            e = u.curPoint,
                            t = u.potentialCurPoint,
                            a = u.maxPoint,
                            i = u.scaleLevels,
                            o = u.itemCount,
                            E = u.bonus,
                            l = u.type,
                            c = u.scaleDowngradeTime,
                            A = u.scaleEmptyTime,
                            F = (0, r.useMemo)(() => Qu(e, t, i, a, l), [e, a, t, i, l]),
                            d = (0, r.useMemo)(() => ({ text: 'App_downgradeTime_09' }), []);
                        return n().createElement(
                            'div',
                            { className: 'App_base_6e' },
                            n().createElement(
                                'div',
                                { className: 'App_header_0a' },
                                n().createElement('div', {
                                    className: 'App_icon_28',
                                    style: {
                                        backgroundImage: `url(${fe.common.categoriesIcons.c_24x24_large.$dyn(l)})`,
                                    },
                                }),
                                n().createElement(Au, { className: 'App_title_c0', text: ye.title.$dyn(l) }),
                            ),
                            n().createElement(
                                'div',
                                { className: 'App_rows_3e' },
                                n().createElement(
                                    'div',
                                    { className: he },
                                    n().createElement(Au, { className: pe, text: ye.inInventory.$dyn(l) }),
                                    n().createElement(
                                        'div',
                                        { className: ve },
                                        n().createElement('div', {
                                            className: 'App_itemsInInventoryIcon_67',
                                            style: {
                                                backgroundImage: `url(${fe.common.categoriesIcons.c_24x24.$dyn(l)})`,
                                            },
                                        }),
                                        n().createElement(Au, {
                                            className: 'App_itemsInInventoryText_03',
                                            text: xe.category.numOfItems(),
                                            format: { binding: { value: String(o) } },
                                        }),
                                    ),
                                ),
                                n().createElement(
                                    'div',
                                    { className: he },
                                    n().createElement(Au, { className: pe, text: ye.percentsToBonus() }),
                                    n().createElement(
                                        'div',
                                        { className: ve },
                                        n().createElement(Au, {
                                            className: s()('App_bonusValue_21', E > 0 && 'App_bonusValue__green_92'),
                                ...
                                n().createElement(
                                    ...
                                    { className: he },
                                    n().createElement(Au, {
                                        className: s()(pe, 'App_rowText__withIndicatorLights_38'),
                                        text: ye.stageDowngradeTime(),
                                        format: {
                                            binding: {
                                                lights: n().createElement(
                                                    'div',
                                                    { className: 'App_slotsIndicator_f4' },
                                                    n().createElement(ce, {
                                                        activeBlink: null,
                                                        progressState: F,
                                                        type: l,
                                ...
                                n().createElement(
                                    'div',
                                    { className: he },
                                    n().createElement(Au, { className: pe, text: ye.wholeDowngradeTime() }),
                                    n().createElement(
                                        'div',
                                        { className: we },
                                        n().createElement('div', { className: be }),
                            ...
                            n().createElement(
                                'div',
                                { className: 'App_bottom_0e' },
                                n().createElement(Au, { className: 'App_bottomTitle_16', text: ye.bottomTitle() }),
                                n().createElement(Au, {
                                    className: 'App_bottomDescription_87',
                                    text: ye.bottomDescription(),
                                }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    i().render(
                        n().createElement(Ce, null, n().createElement(_, null, n().createElement(Se, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(129));
