    ...
    var u,
        e = {
            2267: (u, e, F) => {
                var A = {};
                (F.r(A),
                    F.d(A, { mouse: () => m, off: () => v, on: () => d, onResize: () => l, onScaleUpdated: () => c }));
                var E = {};
                (F.r(E),
                    F.d(E, {
                        events: () => A,
                ...
                var t = {};
                (F.r(t), F.d(t, { getBgUrl: () => S, getTextureUrl: () => _ }));
                var n = {};
                (F.r(n),
                    F.d(n, {
                        addModelObserver: () => q,
                ...
                const h = {
                    ...
                    x = Object.keys(y).reduce((u, e) => ((u[e] = () => g(y[e])), u), {}),
                    P = { play: Object.assign({}, x, { sound: g }), setRTPC: p };
                function _(u, e, F = 1) {
                ...
                const lu = B().forwardRef(function (u, e) {
                    let F = u.children,
                        A = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        B().createElement(
                            'div',
                            su({}, n, {
                                className: i()(iu.base, iu[`base__theme-${t}`], A),
                                ref: function (u) {
                                    ((o.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            B().createElement('div', { className: iu.decorator }, F),
                        )
                    );
                });
                var cu = F(3403);
                                                ...
                                                return {
                                                    subscribe: (F, t) => {
                                                        const D = 'string' == typeof t ? `${A}.${t}` : A,
                                                            B = ou.view.addModelObserver(D, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = mu(E.keys()); !(u = F()).done; ) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(A),
                ...
                const xu = { title: 'Content_title_fa', description: 'Content_description_a2' },
                    Pu = R.strings.ny.resourceBox.tooltip.content,
                    _u = () => {
                        return B().createElement(
                            'div',
                            { className: xu.base },
                            B().createElement('div', { className: xu.title }, Pu.title()),
                            B().createElement(
                                'div',
                    ...
                    Ru = 'Footer_base_49',
                    Su = 'Footer_separator_5a',
                    Ou = 'Footer_label_e7',
                    Tu = () =>
                        B().createElement(
                            'div',
                            { className: Ru },
                            B().createElement('div', { className: Su }),
                            B().createElement(
                                'div',
                                { className: Ou },
                                R.strings.ny.resourceBox.tooltip.footer.label(),
                            ),
                        ),
                    zu = { title: 'Header_title_0b', description: 'Header_description_fb' },
                    ju = R.strings.ny.resourceBox.tooltip.header,
                    Mu = () =>
                        B().createElement(
                            'div',
                            { className: zu.base },
                            B().createElement('div', { className: zu.title }, ju.title()),
                            B().createElement('div', { className: zu.description }, ju.description()),
                        ),
                    ku = 'App_base_a8',
                    Nu = 'App_separator_30',
                    Lu = (0, cu.Pi)(() => {
                        ...
                        return B().createElement(
                            ...
                            B().createElement(
                                ...
                                B().createElement(
                                    'div',
                                    { className: ku },
                                    B().createElement(Mu, null),
                                    B().createElement('div', { className: Nu }),
                                    B().createElement(_u, null),
                                ),
                                u.root.get().isFriendsList && B().createElement(Tu, null),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    o().render(
                        B().createElement(wu, null, B().createElement(Lu, null)),
