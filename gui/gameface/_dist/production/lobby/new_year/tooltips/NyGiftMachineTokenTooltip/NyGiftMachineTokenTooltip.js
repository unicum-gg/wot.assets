        ...
        n = {
            6621: (e, n, t) => {
                ...
                const Pe = ((e, n) => {
                    ...
                    })(({ observableModel: e }) => ({ root: e.object() }), be),
                    Se = Pe[0],
                    Te = Pe[1],
                    Re = 'App_base_c1',
                    Oe = 'App_title_59',
                    ...
                    ze = 'App_info_29',
                    Ce = 'App_infoValue_90',
                    je = R.strings.ny.giftMachineToken.tooltip,
                    Me = (0, pe.Pi)(() => {
                        const e = Te().model.root.get().tokenCount;
                        return u().createElement(
                            ...
                            u().createElement(
                                'div',
                                { className: Re },
                                u().createElement('div', { className: Oe }, je.title()),
                                u().createElement('div', { className: _e }),
                                u().createElement('div', { className: Ae }, je.description()),
                                u().createElement(
                                    'div',
                                    { className: ze },
