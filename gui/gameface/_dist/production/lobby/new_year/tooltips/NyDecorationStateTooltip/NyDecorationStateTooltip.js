(() => {
    ...
    var __webpack_modules__ = {
            ...
            2410: (e, t, n) => {
                ...
                const v = i().forwardRef(function (e, t) {
                        ...
                        return (
                            ...
                            i().createElement(
                                'div',
                                u({}, v, {
                                    className: _()(d.base, d[`base__theme-${s}`], o),
                                    ref: function (e) {
                ...
                const g = (e = 'model', t = f.Deep) => {
                                                    ...
                                                    const t = w(),
                                                        ...
                                                        i =
                                                            window.__feature && window.__feature !== n && n
                                                                ? `subViews.${n}`
                                                                : '';
                                                    return { modelPrefix: i, modelPath: m(i, ''), resId: r };
                                                })(),
                                                n = t.modelPrefix,
                                                r = e.split('.');
                                            if (r.length > 0) {
                    ...
                    O = () => {
                        ...
                        return i().createElement(
                            ...
                            i().createElement(
                                'div',
                                { className: 'App_base_64' },
                                i().createElement(
                                    'div',
                                    { className: 'App_title_40' },
                                    R.strings.ny.atmosphereBonus.tooltip.title(),
                                ),
                                i().createElement('div', { className: 'App_description_d3' }, n),
                                i().createElement(
                                    'div',
                                    { className: 'App_bonus_fa' },
                                    i().createElement('div', { className: 'App_shine_6f' }),
                                    i().createElement(
                                        'div',
                                        { className: 'App_value_4c' },
                                        Boolean(t) && i().createElement('div', { className: 'App_plus_b6' }, '+'),
                                        t,
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    a().render(i().createElement(O, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(2410));
