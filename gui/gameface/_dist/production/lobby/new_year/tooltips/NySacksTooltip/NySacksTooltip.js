        ...
        e = {
            280: (u, e, A) => {
                ...
                const a = ({
                    ...
                    text: e = '',
                    classMix: A,
                    alignment: t = E.v2.left,
                    formatWithBrackets: a,
                }) => {
                    if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                    const B = a && u ? (0, E.WU)(e, u) : e;
                    return D().createElement(
                        ...
                        B.split('\n').map((e, a) =>
                            D().createElement(
                                'div',
                                { className: F()(n.Z.base, A), key: `${e}-${a}` },
                                (0, E.Uw)(e, t, u).map((u, e) =>
                                    D().createElement(r.Fragment, { key: `${e}-${u}` }, u),
                                ),
                            ),
                        ),
                    );
            ...
            3649: (u, e, A) => {
                ...
                const r = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    a = (u, e, A = F.left) => u.split(e).reduce(A === F.left ? D : n, []),
                    B = (() => {
                        const u = new RegExp(
                    ...
                    C = (u, e = F.left) => {
                        ...
                        return ((u, e = F.left) => {
                            ...
                            const t =
                                ...
                                E = r(u);
                            return (a(E, /( )/, e).forEach((u) => (A = A.concat(a(u, t, F.left)))), A);
                        })(u, e);
                    },
                    l = (u, e, A) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : C(u, e)));
            },
            406: (u, e, A) => {
                'use strict';
                A.d(e, { B: () => a });
                ...
                const a = (0, F.memo)((u) => {
                    ...
                    const B = ((u, e) => {
                            ...
                            for (; a;) {
                                ...
                                if (o && s) {
                                    const u = o[0],
                                        A = u + i++ + s[0].replaceAll(')', '') + u;
                                    ((B = B.replace(l, `%(${A})`)),
                                        (n[A] = r[u]
                                            ? E().createElement(
                                                  'span',
                                                  { className: r[u] },
                                                  E().createElement(t.z, { text: c, binding: e }),
                                              )
                                            : E().createElement(
                                                  'span',
                                                  { style: ((C = u), { color: `#${C}` }) },
                        ...
                        i = B[0],
                        C = B[1];
                    return E().createElement(t.z, n({ text: i, classMix: F, binding: C }, a));
                });
            },
            2881: (u, e, A) => {
                'use strict';
                ...
                var E = {};
                (A.r(E), A.d(E, { getBgUrl: () => S, getTextureUrl: () => b }));
                var r = {};
                (A.r(r),
                    A.d(r, {
                        addModelObserver: () => j,
                ...
                const iu = Du.client.getSize('rem'),
                    Cu = iu.width,
                    lu = iu.height,
                    ou = Object.assign({ width: Cu, height: lu }, Bu(Cu, lu, nu)),
                        ...
                        const e = (0, D.useContext)(su),
                            ...
                            E = (0, D.useCallback)((u, e) => {
                                const A = Du.view.pxToRem(u),
                                    t = Du.view.pxToRem(e);
                                F(Object.assign({ width: A, height: t }, Bu(A, t, nu)));
                            }, []),
                            r = (0, D.useCallback)(() => {
                ...
                const _u = {
                    ...
                    Hu = {
                        [bu.ExtraSmall]: '',
                        [bu.Small]: vu().SMALL_HEIGHT,
                        [bu.Medium]: `${vu().SMALL_HEIGHT} ${vu().MEDIUM_HEIGHT}`,
                        [bu.Large]: `${vu().SMALL_HEIGHT} ${vu().MEDIUM_HEIGHT} ${vu().LARGE_HEIGHT}`,
                        [bu.ExtraLarge]: `${vu().SMALL_HEIGHT} ${vu().MEDIUM_HEIGHT} ${vu().LARGE_HEIGHT} ${vu().EXTRA_LARGE_HEIGHT}`,
                    },
                    Tu = {
                        [wu.ExtraSmall]: '',
                        [wu.Small]: vu().SMALL,
                    ...
                    Mu = (u) => {
                        ...
                        const F = Su(),
                            ...
                            r = F.mediaHeight,
                            D = F.mediaSize;
                        return n().createElement('div', yu({ className: fu()(A, _u[E], Hu[r], Tu[D]) }, t), e);
                    },
                    Wu = ['children'];
                const Ru = (u) => {
                    let e = u.children,
                    ...
                    return n().createElement(gu, null, n().createElement(Mu, A, e));
                };
                var Ou = A(493),
                    Pu = A.n(Ou);
                function Iu() {
                ...
                const ju = n().forwardRef(function (u, e) {
                    let A = u.children,
                        t = u.className,
                        F = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            Gu({}, r, {
                                className: fu()($u.base, $u[`base__theme-${E}`], t),
                                ref: function (u) {
                                    ((B.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            n().createElement('div', { className: $u.decorator }, A),
                        )
                    );
                });
                var ku = A(3403),
                ...
                const Yu = ((u, e) => {
                                ...
                                const a = (0, D.useRef)([]),
                                    B = (A, t, F) => {
                                        ...
                                        const r = (function ({
                                            ...
                                            C = { mode: A, model: i, externalModel: D, cleanup: B };
                                        return {
                                            model: i,
                    ...
                    te = 'App_sacksIcon_81',
                    Fe = 'App_separator_d4',
                    Ee = 'App_description_e2',
                    re = R.strings.ny.sacksTooltip,
                    De = (0, ku.Pi)(() => {
                        const u = Ku().model.root.get().bundleType;
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement('div', {
                                        className: te,
                                        style: {
                                            backgroundImage: `url(${R.images.gui.maps.icons.newYear.tooltips.sacks.$dyn(u)})`,
                                        },
                                    }),
                                    n().createElement('div', { className: Ae }, re.title.$dyn(u)),
                                ),
                                n().createElement('div', { className: Fe }),
                                n().createElement(Uu.B, { className: Ee, text: re.description.$dyn(u) }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    Pu().render(
                        n().createElement(Ru, null, n().createElement(Ju, null, n().createElement(De, null))),
            ...
            5287: (u, e, A) => {
                'use strict';
                A.d(e, { Z: () => t });
                const t = { base: 'FormatText_base_d0' };
            },
        },
        A = {};
    function t(u) {
        ...
        (t.O = (e, A, F, E) => {
            if (!A) {
                ...
                for (B = 0; B < u.length; B++) {
                    for (var [A, F, E] = u[B], D = !0, n = 0; n < A.length; n++)
