(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                ...
                function c(u, e, t, r, E, a, n) {
                    ...
                    A.done ? e(F) : Promise.resolve(F).then(r, E);
                }
                    ...
                    x = {
                        ...
                        sendShowPopOverEvent: (u, e, t, r, E = R.invalid('resId'), a) => {
                            const n = _.O.view.getViewGlobalPosition(),
                                ...
                                s = A.height,
                                l = {
                                    x: _.O.view.pxToRem(i) + n.x,
                                    y: _.O.view.pxToRem(D) + n.y,
            ...
            450: (u, e, t) => {
                ...
                const l = E().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            E().createElement(
                                'div',
                                s({}, l, {
                                    className: F()(D.base, D[`base__theme-${A}`], a),
                                    ref: function (u) {
                    ...
                    _ = (0, r.memo)(({ children: u, tooltipDecoratorClassName: e }) =>
                        E().createElement(l, { theme: 'none', className: e }, E().createElement(B, null, u)),
                    );
                var C = t(9887),
                    c = t.n(C);
                const m = (u, e, t) =>
                ...
                const p = i.O.client.getSize('rem'),
                    v = p.width,
                    w = p.height,
                    x = Object.assign({ width: v, height: w }, g(v, w, d)),
                    b = (0, r.createContext)(x),
                    f = ['children'],
                    S = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        const E = (0, r.useContext)(b),
                            ...
                            l = E.smallWidth,
                            B = E.extraSmallWidth,
                            _ = E.extraLargeHeight,
                            C = E.largeHeight,
                            c = E.mediumHeight,
                            d = E.smallHeight,
                            h = E.extraSmallHeight,
                            g = { extraLarge: _, large: C, medium: c, small: d, extraSmall: h };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && D) return m(e, t, g);
                            if (t.largeWidth && o) return m(e, t, g);
                            if (t.mediumWidth && s) return m(e, t, g);
                            if (t.smallWidth && l) return m(e, t, g);
                            if (t.extraSmallWidth && B) return m(e, t, g);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                ...
                ((0, r.memo)(({ children: u }) => {
                    ...
                    return E().createElement(b.Provider, { value: F }, u);
                }),
                    (function (u) {
                ...
                const O = ['xl', 'lg', 'md', 'sm', 'xs'],
                    y = (u) => u.includes('_') && ((u) => O.includes(u))(u.split('_').at(-1)),
                ...
                const U = {
                    ...
                    X = H((u) => {
                        ...
                        const z = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, i, o, l, _, H, N, M, d, O, b, S]),
                            V = z.computedStyle,
                            q = z.computedClassNames;
                        return E().createElement('div', I({ className: F()(k.base, ...q, e), style: V }, K), X);
                    });
                let K;
                function z(u, e) {
                ...
                const V = (u, e, t) => {
                    ...
                    Y = (u, e, t = K.left) => u.split(e).reduce(t === K.left ? V : q, []),
                    $ = (() => {
                        const u = new RegExp(
                    ...
                    Z = ['zh_cn', 'zh_sg', 'zh_tw'],
                    Q = ({ binding: u, text: e = '', classMix: t, alignment: a = K.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, n) =>
                                      E().createElement(
                                          'div',
                                          { className: F()('FormatText_base_d0', t), key: `${e}-${n}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                ...
                const Eu = Object.keys(uu()),
                    ...
                    Du = H((u) => {
                        ...
                        return E().createElement(
                            ...
                            ru(
                                {
                                    className: F()(eu.base, t && eu[t], p, a),
                                    style: g,
                            ...
                            void 0 !== m ? E().createElement(Q, ru({}, m, { text: e })) : e,
                        );
                    });
                var ou = t(3282);
                const su = (0, r.memo)(({ className: u, text: e }) =>
                    E().createElement(
                        'div',
                        { className: F()('Bubble_base_f0', e && 'Bubble_base__withValue_be', u) },
                        e && E().createElement(Du, { className: 'Bubble_text_59', text: e }),
                    ),
                );
                let lu, Bu, _u;
                var Cu;
                (!(function (u) {
                    ...
                    ((Cu = _u || (_u = {})).SHORT_DATE = 'short-date'),
                ...
                const hu = (u = 0, e, t = 0, E = mu) => {
                                    ...
                                    const r = Date.now(),
                                        a = setInterval(
                                            () => {
                                                ...
                                                null !== t && e <= t ? (A(t), E && E(), clearInterval(a)) : A(e);
                                            },
                                            1e3 * (e || (u > 120 ? 60 : 1)),
                                        );
                                    return () => {
                    ...
                    gu = 'Countdown_description_32',
                    pu = (u) => u.toString().padStart(2, '0'),
                    vu = R.images.gui.maps.icons.components.countdown,
                    wu = (u, e) => {
                        const t = 2 === e ? vu.big : vu;
                        switch (u) {
                            case lu.Timer:
                                return t.clock();
                            case lu.Countdown:
                    ...
                    xu = (0, r.memo)(
                        ({
                            ...
                            icon: t = lu.Timer,
                            style: a = Bu.Description,
                            onTimeReached: n,
                            className: A = '',
                            classNames: D = {},
                            labelFormat: o = '',
                        }) => {
                            const s = a !== Bu.Description ? 1 : void 0,
                                l = hu(u, s),
                                B = (() => {
                            ...
                            const _ = ((u, e, t = !1) => {
                                switch (e) {
                                    ...
                                    case Bu.Short:
                                        return `${pu(u.minutes)}:${pu(u.seconds)}`;
                                    case Bu.Long:
                                        return `${pu(u.hours)}:${pu(u.minutes)}:${pu(u.seconds)}`;
                                    case Bu.Extended:
                                        return `${z(R.strings.common.duration.days(), { days: u.days })} | ${pu(u.hours)}:${pu(u.minutes)}:${pu(u.seconds)}`;
                                }
                            })(
                                (function (u = 0) {
                                    let e = u;
                                    ...
                                    e -= 3600 * r;
                                    const E = Math.trunc(e / 60);
                                    return ((e -= 60 * E), { days: t, hours: r, minutes: E, seconds: e });
                                })(l),
                                a,
                                e,
                            );
                            return E().createElement(
                                'div',
                                { className: F()('Countdown_base_2a', A) },
                                t !== lu.None &&
                                    E().createElement('div', {
                                        className: F()('Countdown_icon_ff', D.icon),
                                        style: { backgroundImage: `url('${wu(t, B)}')` },
                                    }),
                                o
                                    ? E().createElement(
                                          'div',
                                          { className: F()(gu, D.text) },
                                          E().createElement(Q, { text: o, binding: { timerText: _ } }),
                                      )
                                    : E().createElement('div', { className: F()(gu, D.text) }, _),
                            );
                        },
                    );
                function bu() {
                ...
                const Mu = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const A = (0, r.useRef)([]),
                                    F = (u, e, t) => {
                                        ...
                                        const E = (function ({
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : n(e),
                                                            E = fu.observable.box(r, { equals: bu });
                                                        return (
                                                            'real' === u &&
                                                                a.subscribe(
                                                                    (0, fu.action)((u) => E.set(u)),
                                                                    e,
                                                                ),
                                                            E
                                                        );
                                            ...
                                            o = { mode: u, model: D, externalModel: a, cleanup: F };
                                        return {
                                            model: D,
                                            controls: 'mocks' === u && t ? t.controls(o) : {},
                                            externalModel: a,
                                            mode: u,
                                        };
                                    },
                                    ...
                                    s = o[0],
                                    l = o[1],
                                    B = (0, r.useState)(() => F(u, e, n)),
                                    _ = B[0],
                                    C = B[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        D.current ? C(F(s, e, n)) : (D.current = !0);
                                    }, [n, s, e]),
                                    (0, r.useEffect)(() => {
                                        l(u);
                                    }, [u]),
                    ...
                    Tu = Lu[0],
                    Ou = Lu[1],
                    Ru = R.strings.ny.petWidgetTooltips.header.mails,
                    yu = (0, ou.observer)(() => {
                        const u = Ou().model.root.get(),
                            e = u.mailsAmount,
                            t = u.nextMailTime,
                            a = (0, r.useMemo)(() => ({ text: 'App_countDown_4a' }), []);
                        return E().createElement(
                            'div',
                            { className: 'App_base_04' },
                            E().createElement(Du, { className: 'App_header_41', text: Ru.header() }),
                            E().createElement(
                                'div',
                                { className: 'App_body_20' },
                                e > 0 &&
                                    E().createElement(
                                        'div',
                                        { className: 'App_mailsAmount_e2' },
                                        E().createElement(Du, {
                                            className: 'App_mailsAmountText_32',
                                            text: Ru.lettersAmount(),
                                        }),
                                        E().createElement(su, { text: String(e) }),
                                    ),
                                E().createElement(
                                    'div',
                                    { className: 'App_nextMail_18' },
                                    E().createElement(Du, { className: 'App_nextMailText_b3', text: Ru.nextLetter() }),
                                    E().createElement(xu, {
                                        classNames: a,
                                        style: Bu.Description,
                                        icon: lu.None,
                                        duration: t,
                                    }),
                                ),
                            ...
                            E().createElement(
                                'div',
                                { className: 'App_bottom_66' },
                                E().createElement(Du, { className: 'App_bottomTitle_cc', text: Ru.bottomTitle() }),
                                E().createElement(Du, {
                                    className: 'App_bottomDescription_5a',
                                    text: Ru.bottomDescription(),
                                }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    n().render(
                        E().createElement(Tu, null, E().createElement(_, null, E().createElement(yu, null))),
        ...
        (__webpack_require__.O = (u, e, t, r) => {
            if (!e) {
                ...
                for (F = 0; F < deferred.length; F++) {
                    for (var [e, t, r] = deferred[F], a = !0, n = 0; n < e.length; n++)
                        (!1 & r || E >= r) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(450));
