(() => {
    ...
    var __webpack_modules__ = {
                ...
                const B = ({
                    ...
                    return n().createElement(
                        ...
                        o.split('\n').map((e, B) =>
                            n().createElement(
                                'div',
                                { className: E()(r.Z.base, A), key: `${e}-${B}` },
            ...
            3649: (u, e, A) => {
                ...
                const n = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    o = (u, e, A = E.left) => u.split(e).reduce(A === E.left ? r : B, []),
                    C = (() => {
                        const u = new RegExp(
            ...
            406: (u, e, A) => {
                ...
                const B = (0, E.memo)((u) => {
                    ...
                    const o = ((u, e) => {
                        ...
                        C = o[0],
                        i = o[1];
                    return t().createElement(F.z, r({ text: C, classMix: E, binding: i }, B));
                });
            },
            3381: (u, e, A) => {
                var F = A(6179),
                ...
                const l = E().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            E().createElement(
                                'div',
                                c({}, r, {
                                    className: o()(a.base, a[`base__theme-${n}`], t),
                                    ref: function (u) {
                            ...
                            v(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        F = f(u);
                                    i.current = g.addCallback(F, A, n, e === b.Deep);
                                }
                            }),
                            (0, F.useEffect)(() => {
                                if (e !== b.None)
                                    return () => {
                                        g.removeCallback(i.current, n);
                                    };
                            }, [n, e]),
                            o
                        );
                ...
                const x = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    P = (u) =>
                        x
                            ? `${u}`
                            : (function (u) {
                ...
                const S = 'App_base_04',
                    M = 'App_title_db',
                    L = 'App_description_b0',
                    N = 'App_footer_6d',
                    I = R.strings.ny.newYear.challenge.variadicDiscount.tooltip;
                let V;
                !(function (u) {
                    (u.DiscountApplied = 'discountApplied'), (u.InProgress = 'inProgress'), (u.Completed = 'completed');
                })(V || (V = {}));
                const W = (u, e) => (u ? V.DiscountApplied : e ? V.Completed : V.InProgress),
                    U = () => {
                        const u = O('model'),
                            e = u.level,
                            A = u.discount,
                            F = u.selectedVehicle,
                            t = u.isCurrentProgressionCompleted,
                            D = '' !== F;
                        return E().createElement(
                            ...
                            E().createElement(
                                ...
                                { className: S },
                                E().createElement(k.B, {
                                    text: I.title.$dyn(W(D, t)),
                                    binding: {
                                        vehicle: F,
                                        discount: (0, r.uF)(R.strings.ny.percentageValue.default(), { value: A }),
                                        tier: P(e),
                                    },
                                    className: M,
                                }),
                                E().createElement(k.B, {
                                    text: I.description.$dyn(W(D, t)),
                                    binding: {
                                        level: P(e),
                                        discount: (0, r.uF)(R.strings.ny.percentageValue.default(), { value: A }),
                                    },
                                ...
                                E().createElement(n.z, { text: I.selectedVehicle(), classMix: N }),
                            ),
                        );
                    };
                window.addEventListener('load', () => {
                    D().render(E().createElement(U, null), document.getElementById('root'));
                });
            },
            5287: (u, e, A) => {
                A.d(e, { Z: () => F });
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(3381));
