(() => {
    ...
    var __webpack_modules__ = {
            ...
            3722: (u, e, A) => {
                ...
                A.r(e), A.d(e, { getBgUrl: () => t, getTextureUrl: () => F });
            },
            6112: (u, e, A) => {
                A.d(e, { W: () => F });
            ...
            7641: (u, e, A) => {
                ...
                const b = Object.keys(t.W).reduce(
            ...
            3979: (u, e, A) => {
                ...
                const s = t().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            t().createElement(
                                'div',
                                B({}, s, {
                                    className: i()(D.base, D[`base__theme-${r}`], E),
                                    ref: function (u) {
                                        (c.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                    },
                                }),
                                t().createElement('div', { className: D.decorator }, A),
                            )
                        );
                    }),
                    C = (u = 1) => {
                    ...
                    return (
                        ((u) => {
                            ...
                            if (
                                                ...
                                                const e = C(),
                                                    ...
                                                    t =
                                                        window.__feature && window.__feature !== A && A
                                                            ? `subViews.${A}`
                                                            : '';
                                                return { modelPrefix: t, modelPath: l(t, ''), resId: F };
                                            })(),
                                            A = e.modelPrefix,
                                            F = u.split('.');
                                        if (F.length > 0) {
                                            ...
                                            return (
                                                F.reduce((e, F) => {
                                                    const t = c(l(A, `${e}.${F}`), window);
                                                    return d(t)
                                                        ? (u.push(t.id), `${e}.${F}.value`)
                                                        : (u.push(F), `${e}.${F}`);
                                                }),
                                                u.reduce((u, e) => u + '.' + e)
                                            );
                                ...
                                B.current = v.addCallback(F, A, r, e === w.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== w.None)
                ...
                const f = R.strings.ny.newYear.celebrityChallenge.variadicDiscount,
                    b = R.strings.quests.bonuses.variadicDiscount.discountAmount(),
                    g = f.tooltip.description(),
                    O = f.tooltip.selectedVehicle(),
                    P = R.strings.roman_numerals,
                    y = () => {
                        const u = h('model'),
                            e = u.level,
                            A = u.discount,
                            ...
                            E = P.$dyn(`n_${e}`),
                            n = m(b, { amount: A }),
                            r = ((u, e) => ('' !== e ? m(O, { vehicle: e }) : m(g, { level: u })))(E, F);
                        return t().createElement(
                            s,
                            null,
                            t().createElement(
                                'div',
                                { className: 'App_base_f6' },
                                t().createElement('div', { className: 'App_discount_22' }, n),
                                t().createElement('div', { className: 'App_description_75' }, r),
                            ),
                        );
                    };
                window.addEventListener('load', () => {
                    n().render(t().createElement(y, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(3979));
