(() => {
    ...
    var __webpack_modules__ = {
                ...
                const o = ({
                    ...
                    return D().createElement(
                        ...
                        a.split('\n').map((e, o) =>
                            D().createElement(
                                'div',
                                { className: F()(r.Z.base, E), key: `${e}-${o}` },
            ...
            3649: (u, e, E) => {
                ...
                const n = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    o = (u, e, E = F.left) => u.split(e).reduce(E === F.left ? D : r, []),
                    a = (() => {
                        const u = new RegExp(
                    ...
                    i = (u, e = F.left) => {
                        ...
                        return ((u, e = F.left) => {
                            ...
                            const A =
                                ...
                                t = n(u);
                            return o(t, /( )/, e).forEach((u) => (E = E.concat(o(u, A, F.left)))), E;
                        })(u, e);
                    },
                    C = (u, e, E) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (E && u in E ? E[u] : i(u, e)));
            },
            1358: (u, e, E) => {
                E.d(e, { Z: () => t });
                var A = E(3138);
            ...
            9916: (u, e, E) => {
                E.d(e, { Sw: () => t.Z, B3: () => r, Z5: () => n.Z5, ry: () => _ });
                class A {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
                ...
                const o = (0, F.memo)((u) => {
                    ...
                    const a = ((u, e) => {
                            ...
                            for (; o; ) {
                                ...
                                if (s && c) {
                                    const u = s[0],
                                        E = u + B++ + c[0].replaceAll(')', '') + u;
                                    (a = a.replace(C, `%(${E})`)),
                                        (r[E] = n[u]
                                            ? t().createElement(
                                                  'span',
                                                  { className: n[u] },
                                                  t().createElement(A.z, { text: l, binding: e }),
                                              )
                                            : t().createElement(
                                                  'span',
                                                  { style: ((i = u), { color: `#${i}` }) },
                        ...
                        B = a[0],
                        i = a[1];
                    return t().createElement(A.z, r({ text: B, classMix: F, binding: i }, o));
                });
            },
            6257: (u, e, E) => {
                var A = E(6179),
                ...
                const l = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            c({}, o, {
                                className: r()(C.base, C[`base__theme-${D}`], t),
                                ref: function (u) {
                ...
                const b = (u = 1) => {
                    ...
                    x = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, E) => {
                                const A = g(`${u}.${E}`, window);
                                return T(A) ? e(u, E, A) : `${u}.${E}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    P = (u) => {
                        const e = ((u) => {
                                const e = b(),
                                ...
                                return { modelPrefix: F, modelPath: O(F, u || ''), resId: A };
                            })(),
                            E = e.modelPrefix,
                            A = u.split('.');
                        if (A.length > 0) {
                            ...
                            return (
                                A.reduce((e, A) => {
                                    const F = g(O(E, `${e}.${A}`), window);
                                    return T(F) ? (u.push(F.id), `${e}.${A}.value`) : (u.push(A), `${e}.${A}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        y(() => {
                            if (
                                ...
                                const E = (u) => {
                                    ...
                                    A = P(u);
                                i.current = k.addCallback(A, E, D, e === N.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== N.None)
                                return () => {
                                    k.removeCallback(i.current, D);
                                };
                        }, [D, e]),
                        a
                    );
                ...
                let W;
                !(function (u) {
                    (u.s24 = '24'), (u.s48 = '48'), (u.Default = '24');
                })(W || (W = {}));
                const I = ({ type: u, isReverse: e, classNames: E, size: A = W.Default }) =>
                    F().createElement(
                        'div',
                        {
                            className: r()(
                        ...
                        F().createElement('div', { className: r()(L.icon, null == E ? void 0 : E.icon) }),
                        F().createElement(
                            'div',
                            { className: r()(L.name, null == E ? void 0 : E.name) },
                            R.strings.ny.resource.type.$dyn(u),
                        ),
                    );
                var U = E(5677);
                const V = 'App_base_83',
                    G = 'App_base__withoutFooter_ac',
                    z = 'App_title_6d',
                    j = 'App_description_05',
                    q = 'App_subtitle_9b',
                    K = 'App_content_61',
                    $ = 'App_resourceListWrapper_be',
                    Y = 'App_resourceName_99',
                    H = 'App_footer_a3',
                    Z = R.strings.ny.randomResourceTooltip,
                    X = [d.Crystal, d.Emerald, d.Amber, d.Iron],
                    Q = () => {
                        const u = S(),
                            e = u.resourceValue,
                            E = u.isShownFromStore;
                        return F().createElement(
                            ...
                            F().createElement(
                                'div',
                                { className: r()(V, !E && G) },
                                F().createElement('div', { className: z }, Z.title()),
                                F().createElement('div', { className: j }, Z.description()),
                                F().createElement(
                                    U.v,
                                    null,
                                    F().createElement(
                                        ...
                                        F().createElement(M.B, {
                                            text: Z.subtitle(),
                                            binding: { value: F().createElement(a, { value: e }) },
                                            className: q,
                                        }),
                                        F().createElement(
                                            'div',
                                            { className: $ },
                                            X.map((u, e) =>
                                                F().createElement(I, { key: e, type: u, classNames: { base: Y } }),
                                            ),
                                        ),
                                    ),
                                ),
            ...
            5677: (u, e, E) => {
                ...
                var A = E(6483),
                    ...
                    t = E(6179),
                    n = E.n(t);
                const D = 'MenuInfo_base_30',
                    r = 'MenuInfo_background_e4',
                    o = 'MenuInfo_separator_6e',
                    a = ({ children: u, classNames: e }) =>
                        n().createElement(
                            'div',
                            { className: F()(D, null == e ? void 0 : e.base) },
                            n().createElement('div', { className: o }),
                            n().createElement('div', { className: r }, u),
                            n().createElement('div', { className: F()(o, null == e ? void 0 : e.bottomSeparator) }),
                        );
            },
            5287: (u, e, E) => {
                E.d(e, { Z: () => A });
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 9335),
        (() => {
            var u = { 9335: 0, 4840: 0, 4445: 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(6257));
