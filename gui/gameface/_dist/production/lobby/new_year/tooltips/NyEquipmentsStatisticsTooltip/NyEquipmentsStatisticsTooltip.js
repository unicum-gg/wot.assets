        ...
        e = {
            280: (u, e, A) => {
                ...
                const B = ({
                    ...
                    formatWithBrackets: B,
                }) => {
                    if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                    const C = B && u ? (0, t.WU)(e, u) : e;
                    return r().createElement(
                        ...
                        C.split('\n').map((e, B) =>
                            r().createElement(
                                'div',
                                { className: E()(n.Z.base, A), key: `${e}-${B}` },
            ...
            3649: (u, e, A) => {
                ...
                const D = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    B = (u, e, A = E.left) => u.split(e).reduce(A === E.left ? r : n, []),
                    C = (() => {
                        const u = new RegExp(
                    ...
                    o = (u, e, A) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : i(u, e)));
            },
            406: (u, e, A) => {
                A.d(e, { B: () => B });
                var F = A(280),
                ...
                const B = (0, E.memo)((u) => {
                    ...
                    const C = ((u, e) => {
                            ...
                            for (; B; ) {
                                ...
                                if (l && s) {
                                    const u = l[0],
                                        A = u + a++ + s[0].replaceAll(')', '') + u;
                                    ((C = C.replace(o, `%(${A})`)),
                                        (n[A] = D[u]
                                            ? t().createElement(
                                                  'span',
                                                  { className: D[u] },
                                                  t().createElement(F.z, { text: c, binding: e }),
                                              )
                                            : t().createElement(
                                                  'span',
                                                  { style: ((i = u), { color: `#${i}` }) },
                        ...
                        a = C[0],
                        i = C[1];
                    return t().createElement(F.z, n({ text: a, classMix: E, binding: i }, B));
                });
            },
            681: (u, e, A) => {
                var F = {};
                (A.r(F),
                    A.d(F, { mouse: () => h, off: () => m, on: () => d, onResize: () => s, onScaleUpdated: () => c }));
                var E = {};
                (A.r(E),
                    A.d(E, {
                        events: () => F,
                ...
                var t = {};
                (A.r(t), A.d(t, { getBgUrl: () => T, getTextureUrl: () => _ }));
                var D = {};
                (A.r(D),
                    A.d(D, {
                        addModelObserver: () => I,
                ...
                const s = o('clientResized'),
                    ...
                    g = { down: o('mousedown'), up: o('mouseup'), move: o('mousemove') };
                const h = (function () {
                ...
                const p = {
                    ...
                    y = Object.keys(b).reduce((u, e) => ((u[e] = () => f(b[e])), u), {}),
                    S = { play: Object.assign({}, y, { sound: f }), setRTPC: v };
                function _(u, e, A = 1) {
                ...
                const su = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            lu({}, D, {
                                className: i()(iu.base, iu[`base__theme-${t}`], F),
                                ref: function (u) {
                                    ((C.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            n().createElement('div', { className: iu.decorator }, A),
                        )
                    );
                });
                var cu = A(3403);
                ...
                const gu = Cu.client.getSize('rem'),
                    hu = gu.width,
                    fu = gu.height,
                    vu = Object.assign(
                        { width: hu, height: fu },
                ...
                const pu = (u) => {
                    ...
                    const F = (0, r.useContext)(xu),
                        ...
                        h = { extraLarge: s, large: c, medium: d, small: m, extraSmall: g };
                    if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
                        ...
                        if (A.extraLargeWidth && C) return du(e, A, h);
                        if (A.largeWidth && a) return du(e, A, h);
                        if (A.mediumWidth && i) return du(e, A, h);
                        if (A.smallWidth && o) return du(e, A, h);
                        if (A.extraSmallWidth && l) return du(e, A, h);
                        if (
                ...
                const Ru = ((u, e) => {
                        ...
                        return [
                            function ({ mode: F = 'real', options: E, children: t, mocks: D }) {
                                const B = (0, r.useRef)([]),
                                    C = (A, F, E) => {
                                        ...
                                        const D = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = Ou(E.keys()); !(u = A()).done; ) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(F),
                                            ...
                                            i = { mode: A, model: a, externalModel: r, cleanup: C };
                                        return {
                                            model: a,
                                    ...
                                    o = i[0],
                                    l = i[1],
                                    s = (0, r.useState)(() => C(F, E, D)),
                                    c = s[0],
                                    d = s[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        a.current ? d(C(o, E, D)) : (a.current = !0);
                                    }, [D, o, E]),
                                    (0, r.useEffect)(() => {
                                        l(F);
                                    }, [F]),
                        ...
                        const e = { equipments: u.array('equipments', []) };
                        return Object.assign({}, e);
                    }, _u),
                    Hu = Ru[0],
                    zu = Ru[1];
                var ju = A(406);
                const Mu = 'Equipment_base_dd',
                    qu = 'Equipment_icon_4e',
                    Nu = 'Equipment_equipmentEffect_ee',
                    ku = 'Equipment_count_a3',
                    $u = 'Equipment_name_a7',
                    Vu = R.strings.ny,
                    Iu = ({ equipment: u, className: e }) => {
                        const A = (0, bu.WU)(Vu.rewardKitStatistics.equipmentsTooltip.count(), { count: u.count });
                        return n().createElement(
                            ...
                            n().createElement(
                                'div',
                                {
                                    className: qu,
                                    style: {
                                        backgroundImage: `url(${R.images.gui.maps.icons.quests.bonuses.small.$dyn(u.equipmentName)})`,
                                    },
                                },
                                n().createElement('div', {
                                    className: Nu,
                                    style: {
                                        backgroundImage: `url(${R.images.gui.maps.icons.quests.bonuses.small.$dyn(`equipmentModernized_${u.tier}_overlay`)})`,
                                    },
                                }),
                                u.count > 1 && n().createElement('div', { className: ku }, A),
                            ),
                            n().createElement(ju.B, {
                                className: $u,
                                text: Vu.reward.label.equipment.$dyn(u.equipmentName),
                            }),
                        );
                    },
                    Uu = 'App_base_3d',
                    Gu = 'App_header_5f',
                    Qu = 'App_equipment_56',
                    Zu = R.strings.ny.rewardKitStatistics.equipmentsTooltip,
                    Ku = (0, cu.Pi)(() => {
                        const u = zu().model.equipments.get();
                        return n().createElement(
                            su,
                            null,
                            n().createElement(
                                'div',
                                { className: Uu },
                                n().createElement('div', { className: Gu }, Zu.header()),
                                ((e = u),
                                (A = (u) =>
                                    n().createElement(Iu, { key: u.equipmentName, equipment: u, className: Qu })),
                                Array.isArray(e)
                                    ? e.map(A)
                                    : e.map((u, e, F) => A(null == u ? void 0 : u.value, e, F))),
                            ),
                        );
                        var e, A;
                    });
                engine.whenReady.then(() => {
                    C().render(
                        n().createElement(Hu, null, n().createElement(Ku, null)),
        ...
        (F.O = (e, A, E, t) => {
            if (!A) {
                ...
                for (C = 0; C < u.length; C++) {
                    for (var [A, E, t] = u[C], r = !0, n = 0; n < A.length; n++)
