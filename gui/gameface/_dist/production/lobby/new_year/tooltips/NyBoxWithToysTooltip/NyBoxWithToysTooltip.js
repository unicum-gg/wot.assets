(() => {
    ...
    var u,
        e = {
            3485: (u, e, F) => {
                var A = {};
                (F.r(A), F.d(A, { mouse: () => d, onResize: () => l }));
                var E = {};
                (F.r(E),
                    F.d(E, {
                        events: () => A,
                ...
                const uu = B().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        B().createElement(
                            'div',
                            Y({}, t, {
                                className: i()(K.base, K[`base__theme-${n}`], A),
                                ref: function (u) {
                                    ((o.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            B().createElement('div', { className: K.decorator }, F),
                        )
                    );
                });
                function eu(u, e) {
                    return Array.isArray(u) ? u.map(e) : u.map((u, F, A) => e(null == u ? void 0 : u.value, F, A));
                }
                let Fu;
                (!(function (u) {
                ...
                const Du = (u) => (0 === u ? window : window.subViews.get(u)),
                    Bu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: A, children: E, mocks: n }) {
                                const t = (0, D.useRef)([]),
                                    r = (u, F, A) => {
                                        var E;
                                        const n = (function ({
                                                ...
                                                return {
                                                    subscribe: (F, n) => {
                                                        const D = 'string' == typeof n ? `${A}.${n}` : A,
                                                            B = J.view.addModelObserver(D, e, !0);
                                                        return (E.set(B, F), u && F(t(n)), B);
                                                    },
                                                    readByPath: t,
                                                    createCallback: (u, e) => {
                                                        const F = t(e);
                                            ...
                                            o = (({ observableModel: u }) => {
                                                const e = { root: u.object(), toys: u.array('toys', []) };
                                                return Object.assign({}, e);
                                            })({
                                                mode: u,
                                                readByPath: B,
                                            ...
                                            C = { mode: u, model: o, externalModel: D, cleanup: r };
                                        return {
                                            model: o,
                                    ...
                                    i = C[0],
                                    a = C[1],
                                    s = (0, D.useState)(() => r(u, A, n)),
                                    l = s[0],
                                    c = s[1];
                                return (
                                    (0, D.useEffect)(() => {
                                        o.current ? c(r(i, A, n)) : (o.current = !0);
                                    }, [n, i, A]),
                                    (0, D.useEffect)(() => {
                                        a(u);
                                    }, [u]),
                                    ...
                                    B().createElement(F.Provider, { value: l }, E)
                                );
                            },
                            () => (0, D.useContext)(F),
                        ];
                    ...
                    Cu = ({ icon: u, title: e }) =>
                        B().createElement(
                            'div',
                            { className: 'BonusToy_base_43' },
                            B().createElement('div', { className: 'BonusToy_separator_39' }),
                            B().createElement(
                                'div',
                                { className: 'BonusToy_content_46' },
                                B().createElement('div', {
                                    className: 'BonusToy_icon_d5',
                                    style: { backgroundImage: `url(${u})` },
                                }),
                                B().createElement('div', { className: 'BonusToy_title_93' }, e),
                            ),
                        ),
                    iu = ({ icon: u, value: e, title: F }) =>
                        B().createElement(
                            'div',
                            { className: 'MandarinsCompensation_base_52' },
                            B().createElement('div', { className: 'MandarinsCompensation_separator_10' }),
                            B().createElement(
                                'div',
                                { className: 'MandarinsCompensation_content_1f' },
                                B().createElement(
                                    'div',
                                    {
                                        className: 'MandarinsCompensation_icon_b2',
                                        style: { backgroundImage: `url(${u})` },
                                    },
                                    B().createElement('div', { className: 'MandarinsCompensation_compensation_5a' }),
                                    B().createElement('div', { className: 'MandarinsCompensation_value_c9' }, e),
                                ),
                                B().createElement('div', { className: 'MandarinsCompensation_title_f5' }, F),
                            ),
                        ),
                    au = R.strings.ny,
                    su = (0, Au.observer)(() => {
                        ...
                        return B().createElement(
                            ...
                            B().createElement(
                                ...
                                B().createElement('div', { className: 'App_header_79' }, au.boxWithToysTooltip.title()),
                                eu(e, ({ name: u, icon: e, label: F, value: A }, E) =>
                                    'nyMandarins' === u
                                        ? B().createElement(iu, { key: `toy-${E}`, icon: e, title: F, value: A })
                                        : B().createElement(Cu, { key: `toy-${E}`, icon: e, title: F }),
                                ),
                                F > 0 &&
                                    B().createElement(
                                        B().Fragment,
                                        null,
                                        B().createElement('div', { className: 'App_separator_93' }),
                                        B().createElement(
                                            'div',
                                            { className: 'App_footer_f8' },
                                            ((A = au.boxWithToysTooltip.more(F)),
                                            (E = { value: F }),
                                            A.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                ...
                engine.whenReady.then(() => {
                    o().render(
                        B().createElement(ru, null, B().createElement(su, null)),
        ...
        (A.O = (e, F, E, n) => {
            if (!F) {
                ...
                for (o = 0; o < u.length; o++) {
                    for (var [F, E, n] = u[o], D = !0, B = 0; B < F.length; B++)
