        ...
        e = {
            ...
            3649: (u, e, F) => {
                ...
                const B = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    C = (u, e, F = E.left) => u.split(e).reduce(F === E.left ? t : n, []),
                    r = (() => {
                        const u = new RegExp(
                ...
                const C = (0, E.memo)((u) => {
                    ...
                    const r = ((u, e) => {
                            ...
                            for (; C; ) {
                                ...
                                if (l && s) {
                                    const u = l[0],
                                        F = u + o++ + s[0].replaceAll(')', '') + u;
                                    (r = r.replace(a, `%(${F})`)),
                                        (n[F] = B[u]
                                            ? D().createElement(
                                                  'span',
                                                  { className: B[u] },
                                                  D().createElement(A.z, { text: c, binding: e }),
                                              )
                                            : D().createElement(
                                                  'span',
                                                  { style: ((i = u), { color: `#${i}` }) },
                        ...
                        o = r[0],
                        i = r[1];
                    return D().createElement(A.z, n({ text: o, classMix: E, binding: i }, C));
                });
            },
            398: (u, e, F) => {
                var A = {};
                F.r(A),
                    F.d(A, { mouse: () => f, off: () => v, on: () => d, onResize: () => s, onScaleUpdated: () => c });
                var E = {};
                F.r(E),
                    F.d(E, {
                        events: () => A,
                ...
                const w = {
                    ...
                    y = Object.keys(x).reduce((u, e) => ((u[e] = () => g(x[e])), u), {}),
                    _ = { play: Object.assign({}, y, { sound: g }), setRTPC: p };
                function T(u, e, F = 1) {
                ...
                const Bu = (() => {
                    ...
                    tu = Object.keys(P).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === P[e]), u), {}),
                    nu = {
                        set: (u, e) => {
                ...
                const su = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            lu({}, B, {
                                className: i()(iu.base, iu[`base__theme-${D}`], A),
                                ref: function (u) {
                ...
                let cu;
                !(function (u) {
                    (u.Normal = 'normal'), (u.LevelError = 'levelError'), (u.VehicleError = 'vehicleError');
                })(cu || (cu = {}));
                var du = F(3403);
                const vu = function () {};
                function mu() {
                ...
                const hu = ((u, e) => {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const t = 'string' == typeof D ? `${A}.${D}` : A,
                                                            n = ru.view.addModelObserver(t, e, !0);
                        ...
                        ({ observableModel: u }) => ({
                            root: { root: u.object(), resource: u.object('resource') }.root,
                        }),
                        vu,
                    ),
                    wu = hu[0],
                ...
                var Pu = F(406);
                const Su = 'Error_base_5e',
                    Ru = 'Error_title_5d',
                    zu = 'Error_errorIcon_46',
                    ju = 'Error_glow_57',
                    Nu = 'Error_disjunction_49',
                    Mu = 'Error_line_c9',
                    Lu = 'Error_disjunctionWrapper_ea',
                    ku = 'Error_description_ed',
                    Vu = R.strings.ny.widget.economicBonus.errorTooltip,
                    Wu = ({ errorType: u, level: e = 1 }) =>
                        n().createElement(
                            'div',
                            { className: Su },
                            ...
                            n().createElement(
                                'div',
                                { className: ku },
                                n().createElement(Pu.B, {
                                    text: u === cu.LevelError ? Vu.level.firstDescription() : Vu.vehicle.description(),
                                    binding: { level: Ou(e) },
                                }),
                            ),
                            u === cu.LevelError &&
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement('div', { className: Nu }, Vu.disjunction()),
                                        n().createElement('div', { className: Mu }),
                                    ),
                                    n().createElement(Pu.B, { text: Vu.level.secondDescription(), className: ku }),
                                ),
                        ),
                    Iu = 'Normal_base_8f',
                    $u = 'Normal_title_28',
                    Gu = 'Normal_separator_10',
                    Uu = 'Normal_description_0d',
                    Hu = R.strings.ny.widget.economicBonus.xpInfoTooltip,
                    qu = () =>
                        n().createElement(
                            'div',
                            { className: Iu },
                            n().createElement('div', { className: $u }, Hu.title()),
                            n().createElement('div', { className: Uu }, Hu.firstDescription()),
                            n().createElement('div', { className: Gu }),
                            n().createElement('div', { className: Uu }, Hu.secondDescription()),
                        ),
                    Zu = 'App_base_bf',
                    Qu = (0, du.Pi)(() => {
                        const u = xu().model.root.get(),
                            e = u.tooltipState,
                            F = u.level,
                            A = e === cu.VehicleError || e === cu.LevelError;
                        return n().createElement(
                            ...
                            n().createElement(
                                'div',
                                { className: Zu },
                                A ? n().createElement(Wu, { errorType: e, level: F }) : n().createElement(qu, null),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
            ...
            if (!F) {
                ...
                for (r = 0; r < u.length; r++) {
                    for (var [F, E, D] = u[r], t = !0, n = 0; n < F.length; n++)
                        (!1 & D || B >= D) && Object.keys(A.O).every((u) => A.O[u](F[n]))
                            ? F.splice(n--, 1)
                            : ((t = !1), D < B && (B = D));
                    if (t) {
                        u.splice(r--, 1);
