    ...
    var u,
        e = {
            1299: (u, e, A) => {
                var F = {};
                (A.r(F),
                    A.d(F, { mouse: () => O, off: () => T, on: () => _, onResize: () => S, onScaleUpdated: () => L }));
                var E = {};
                (A.r(E),
                    A.d(E, {
                        events: () => F,
                ...
                var t = {};
                (A.r(t), A.d(t, { getBgUrl: () => $, getTextureUrl: () => I }));
                var D = {};
                (A.r(D),
                    A.d(D, {
                        addModelObserver: () => Eu,
                ...
                const Su = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            yu({}, D, {
                                className: a()(pu.base, pu[`base__theme-${t}`], F),
                                ref: function (u) {
                ...
                var Lu = A(3403);
                const _u = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                ...
                const Pu = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    Nu = ({
                        ...
                        const D = e || zu.$dyn(c(E));
                        return r().createElement(
                            'div',
                            { className: a()(Ru, F && F.base) },
                            A,
                            r().createElement('div', {
                                className: a()(!e && Hu, !e && t && Wu, F && F.icon),
                                ...
                                const n = (0, B.useRef)([]),
                                    C = (A, F, E) => {
                                        ...
                                        const D = (function ({
                                                ...
                                                return {
                                                    subscribe: (A, t) => {
                                                        const B = 'string' == typeof t ? `${F}.${t}` : F,
                                                            r = wu.view.addModelObserver(B, e, !0);
                                                        return (E.set(r, A), u && A(D(t)), r);
                                                    },
                                                    readByPath: D,
                                                    createCallback: (u, e) => {
                                                        const A = D(e);
                                    ...
                                    l = a[0],
                                    o = a[1],
                                    s = (0, B.useState)(() => C(F, E, D)),
                                    c = s[0],
                                    d = s[1];
                                return (
                                    (0, B.useEffect)(() => {
                                        i.current ? d(C(l, E, D)) : (i.current = !0);
                                    }, [D, l, E]),
                                    (0, B.useEffect)(() => {
                                        o(F);
                                    }, [F]),
                                    ...
                                    r().createElement(A.Provider, { value: c }, t)
                                );
                            },
                            () => (0, B.useContext)(A),
                        ];
                    })(({ observableModel: u }) => {
                        const e = { customizations: u.array('customizations') };
                        return Object.assign({}, e);
                    }, Yu),
                    De = te[0],
                    Be = te[1],
                ...
                const oe = R.strings.ny.rewardKitStatistics.customizationsTooltip,
                    se = (0, Lu.Pi)(() => {
                        const u = Be().model.customizations.get();
                        return r().createElement(
                            Su,
                            null,
                            r().createElement(
                                'div',
                                { className: re },
                                r().createElement('div', { className: ne }, oe.header()),
                                ((e = u),
                                (A = (u, e) => {
                                    return r().createElement(
                                        'div',
                                        { className: Ce, key: e },
                                        r().createElement(p, {
                                            text: oe.customization(),
                                            classMix: ie,
                                            binding: {
                                                itemNumber: e + 1,
                                                customizationName:
                                                    ((A = R.strings.ny.messages.quotes()),
                                                    (F = { text: u.name }),
                                                    A.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                                                        const e = 0 === u.indexOf('%') ? 2 : 1;
                                                        return String(F[u.slice(e, -e)]);
                                                    })),
                                                vehicleName: r().createElement(Mu, le({}, u, { className: ae })),
                                            },
                                        }),
                                    );
                                    var A, F;
                ...
                engine.whenReady.then(() => {
                    C().render(
                        r().createElement(De, null, r().createElement(se, null)),
