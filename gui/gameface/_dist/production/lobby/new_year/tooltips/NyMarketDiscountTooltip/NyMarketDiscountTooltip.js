(() => {
    ...
    var __webpack_modules__ = {
            280: (u, e, A) => {
                ...
                const o = ({
                    ...
                    text: e = '',
                    classMix: A,
                    alignment: F = t.v2.left,
                    formatWithBrackets: o,
                }) => {
                    if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                    const B = o && u ? (0, t.WU)(e, u) : e;
                    return D().createElement(
                        ...
                        B.split('\n').map((e, o) =>
                            D().createElement(
                                'div',
                                { className: E()(r.Z.base, A), key: `${e}-${o}` },
                                (0, t.Uw)(e, F, u).map((u, e) =>
            ...
            527: (u, e, A) => {
                (A.r(e),
                    A.d(e, { mouse: () => B, off: () => r, on: () => D, onResize: () => t, onScaleUpdated: () => n }));
                var F = A(2472),
                    E = A(1176);
            ...
            3138: (u, e, A) => {
                ...
                var F = A(5959),
                    E = A(514);
                const t = { view: A(7641), client: F, sound: E.ZP };
            },
            514: (u, e, A) => {
                A.d(e, { ZP: () => n });
                var F = A(5959);
                const E = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    t = Object.keys(E).reduce((u, e) => ((u[e] = () => (0, F.playSound)(E[e])), u), {}),
                    n = { play: Object.assign({}, t, { sound: F.playSound }), setRTPC: F.setRTPC };
            },
            3722: (u, e, A) => {
                function F(u, e, A = 1) {
                        ...
                        if (void 0 !== e) {
                            ...
                            return void 0 !== t
                                ? viewEnv.handleViewEvent(
                                      Object.assign({ __Type: A, type: u }, n, {
                                          arguments:
                                              ((E = t),
                                ...
                                : viewEnv.handleViewEvent(Object.assign({ __Type: A, type: u }, n));
                        }
            ...
            3649: (u, e, A) => {
                ...
                const n = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    o = (u, e, A = E.left) => u.split(e).reduce(A === E.left ? D : r, []),
                    B = (() => {
                        const u = new RegExp(
                    ...
                    C = (u, e = E.left) => {
                        ...
                        return ((u, e = E.left) => {
                            ...
                            const F =
                                ...
                                t = n(u);
                            return (o(t, /( )/, e).forEach((u) => (A = A.concat(o(u, F, E.left)))), A);
                        })(u, e);
                    },
                ...
                const p = E.instance,
                    h = {
                        ...
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            _(D.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
                        sendShowPopOverEvent: (u, e, A, F, E = R.invalid('resId'), t) => {
                            const n = a.O.view.getViewGlobalPosition(),
                                ...
                                C = r.height,
                                s = {
                                    x: a.O.view.pxToRem(o) + n.x,
                                    y: a.O.view.pxToRem(B) + n.y,
                ...
                const o = (0, E.memo)((u) => {
                    ...
                    const B = ((u, e) => {
                            ...
                            for (; o;) {
                                ...
                                if (s && c) {
                                    const u = s[0],
                                        A = u + i++ + c[0].replaceAll(')', '') + u;
                                    ((B = B.replace(a, `%(${A})`)),
                                        (r[A] = n[u]
                                            ? t().createElement(
                                                  'span',
                                                  { className: n[u] },
                                                  t().createElement(F.z, { text: l, binding: e }),
                                              )
                                            : t().createElement(
                                                  'span',
                                                  { style: ((C = u), { color: `#${C}` }) },
                        ...
                        i = B[0],
                        C = B[1];
                    return t().createElement(F.z, r({ text: i, classMix: E, binding: C }, o));
                });
            },
            542: (u, e, A) => {
                var F = A(6179),
                ...
                const l = E().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        E().createElement(
                            'div',
                            c({}, r, {
                                className: B()(a.base, a[`base__theme-${D}`], t),
                                ref: function (u) {
                ...
                const O = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    x = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, A) => {
                                const F = g(`${u}.${A}`, window);
                                return O(F) ? e(u, A, F) : `${u}.${A}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    P = (u) => {
                        const e = ((u) => {
                                const e = f(),
                                ...
                                return { modelPrefix: E, modelPath: T(E, u || ''), resId: F };
                            })(),
                            A = e.modelPrefix,
                            F = u.split('.');
                        if (F.length > 0) {
                            ...
                            return (
                                F.reduce((e, F) => {
                                    const E = g(T(A, `${e}.${F}`), window);
                                    return O(E) ? (u.push(E.id), `${e}.${F}.value`) : (u.push(F), `${e}.${F}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        b(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    F = P(u);
                                C.current = k.addCallback(F, A, D, e === S.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== S.None)
                                return () => {
                                    k.removeCallback(C.current, D);
                                };
                        }, [D, e]),
                        B
                    );
                ...
                const N = 'App_base_f4',
                    W = 'App_discount_83',
                    U = 'App_description_06',
                    I = 'App_descriptionHighlight_0d',
                    V = R.strings.ny.marketplace.tooltips.discount,
                    G = () => {
                        const u = M('model', S.None),
                            e = u.discount,
                            A = u.collection,
                            F = u.year,
                            t = u.prevNYLevel,
                            n = u.currentToysCount,
                            o = u.totalToysCount,
                            B = V.collectionYear.$dyn(F),
                            i = {
                                totalAmount: o,
                                year: B,
                                level: E().createElement('div', { className: I }, t),
                                currentAmount: E().createElement('div', { className: I }, n),
                                percentValue: E().createElement(D.z, {
                                    classMix: I,
                            ...
                            C = (0, r.WU)(
                                ((u) => {
                                    switch (u) {
                                        ...
                                        case d.Cat:
                                        case d.Bro:
                                            return V.text.rewards();
                                        default:
                                            return V.text.default();
                                    }
                                })(A),
                                { collectionName: V.collectionName.$dyn(A), collectionYear: B },
                            );
                        return E().createElement(
                            ...
                            E().createElement(
                                'div',
                                { className: N },
                                E().createElement('div', { className: W }, `-${e}%`),
                                E().createElement(
                                    'div',
                                    { className: U },
                                    E().createElement(L.B, { text: C, binding: i }),
                                ),
                            ),
                        );
                    };
                window.addEventListener('load', () => {
                    n().render(E().createElement(G, null), document.getElementById('root'));
                });
            },
            5287: (u, e, A) => {
                A.d(e, { Z: () => F });
        ...
        (__webpack_require__.O = (u, e, A, F) => {
            if (!e) {
                ...
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, A, F] = deferred[r], t = !0, n = 0; n < e.length; n++)
                        (!1 & F || E >= F) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(542));
