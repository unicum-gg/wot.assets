        ...
        A = {
                ...
                const C = ({
                    ...
                    return t().createElement(
                        ...
                        r.split('\n').map((A, C) =>
                            t().createElement(
                                'div',
                                { className: E()(n.Z.base, F), key: `${A}-${C}` },
                                (0, D.Uw)(A, e, u).map((u, A) =>
                                    t().createElement(B.Fragment, { key: `${A}-${u}` }, u),
                                ),
                            ),
                        ),
                    );
            ...
            3649: (u, A, F) => {
                ...
                const B = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    C = (u, A, F = E.left) => u.split(A).reduce(F === E.left ? t : n, []),
                    r = (() => {
                        const u = new RegExp(
                    ...
                    i = (u, A = E.left) => {
                        ...
                        return ((u, A = E.left) => {
                            ...
                            const e =
                                ...
                                D = B(u);
                            return (C(D, /( )/, A).forEach((u) => (F = F.concat(C(u, e, E.left)))), F);
                        })(u, A);
                    },
                    a = (u, A, F) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : i(u, A)));
            },
            406: (u, A, F) => {
                F.d(A, { B: () => C });
                var e = F(280),
                ...
                const C = (0, E.memo)((u) => {
                    ...
                    const r = ((u, A) => {
                            ...
                            for (; C;) {
                                ...
                                if (s && l) {
                                    const u = s[0],
                                        F = u + o++ + l[0].replaceAll(')', '') + u;
                                    ((r = r.replace(a, `%(${F})`)),
                                        (n[F] = B[u]
                                            ? D().createElement(
                                                  'span',
                                                  { className: B[u] },
                                                  D().createElement(e.z, { text: c, binding: A }),
                                              )
                                            : D().createElement(
                                                  'span',
                                                  { style: ((i = u), { color: `#${i}` }) },
                        ...
                        o = r[0],
                        i = r[1];
                    return D().createElement(e.z, n({ text: o, classMix: E, binding: i }, C));
                });
            },
            1164: (u, A, F) => {
                var e = {};
                ...
                function Q(u = 'rem') {
                    ...
                    return 'rem' === u ? A : { x: X(A.x), y: X(A.y) };
                }
                function Y() {
                ...
                const lu = n().forwardRef(function (u, A) {
                    let F = u.children,
                        e = u.className,
                        E = u.theme,
                ...
                const hu = ((u, A) => {
                    ...
                    xu = 'App_base_da',
                    _u = 'App_header_32',
                    Tu = 'App_headerIcon_91',
                    Pu = 'App_headerText_d0',
                    Ou = 'App_headerTitle_46',
                    Su = 'App_headerSubtitle_e0',
                    Ru = 'App_image_39',
                    zu = 'App_info_52',
                    ju = 'App_paragraph_9d',
                    Mu = 'App_condition_98',
                    ku = R.strings.ny.rewards.tooltip,
                    $u = R.images.gui.maps.icons.newYear.tooltips.guests,
                    Nu = (0, cu.Pi)(() => {
                        const u = yu().model.root.get().guestType;
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement('div', {
                                        className: Tu,
                                        style: { backgroundImage: `url(${$u.icons.$dyn(u)})` },
                                    }),
                                    n().createElement(
                                        'div',
                                        { className: Pu },
                                        n().createElement('div', { className: Ou }, ku.title.$dyn(u)),
                                        n().createElement('div', { className: Su }, ku.subtitle.$dyn(u)),
                                    ),
                                ),
                                n().createElement('div', {
                                    className: Ru,
                                    style: { backgroundImage: `url(${$u.$dyn(u)})` },
                                }),
                                n().createElement(du.B, { className: Mu, text: ku.condition.$dyn(u) }),
                                n().createElement('div', { className: zu }, ku.info.$dyn(u)),
                                n().createElement(du.B, { className: ju, text: ku.description.$dyn(u) }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
