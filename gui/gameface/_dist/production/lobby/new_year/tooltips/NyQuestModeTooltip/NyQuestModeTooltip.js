            ...
            2215: (u, e, t) => {
                ...
                const bu = {
                    ...
                    Lu = xu((u) => {
                        ...
                        return a().createElement('div', vu({ className: C()(fu.base, ...I, e), style: X }, N), G);
                    });
                let Mu;
                !(function (u) {
                ...
                const Iu = Object.keys(Gu()),
                    ...
                    Ku = xu((u) => {
                        ...
                        return a().createElement(
                            ...
                            void 0 !== c ? a().createElement(Pu, Xu({}, c, { text: e })) : e,
                        );
                    }),
                ...
                const Fe = ((u, e) => {
                                ...
                                const r = (0, D.useRef)([]),
                                    n = (u, t, A) => {
                                        ...
                                        const F = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const D = 'string' == typeof F ? `${A}.${F}` : A,
                                                            a = Y.view.addModelObserver(D, e, !0);
                                            ...
                                            B = (({ observableModel: u }) => {
                                                const e = { root: u.object(), battleModes: u.array('battleModes') },
                                                    t = (0, Ee.Om)(
                                                        () => {
                                                            return (
                                                                (u = e.battleModes.get()),
                                                ...
                                                return Object.assign({}, e, { computes: { getBattleModes: t } });
                                            })({
                                                mode: u,
                                                readByPath: a,
                                                externalModel: D,
                    ...
                    De = Fe[1],
                    ae = R.strings.ny,
                    ne = ae.questGiver.tooltip.battleModes,
                    Be = (0, Ju.Pi)(() => {
                        const u = De().model,
                            e = u.root.get(),
                            t = e.minVehicleLevel,
                            A = e.maxVehicleLevel,
                            E = u.computes.getBattleModes(),
                            F = (0, D.useMemo)(
                                () => (u) =>
                                    u.map((u) => {
                                        return a().createElement(Ku, {
                                            key: u,
                                            text:
                                                ((e = ae.battleType.quoted()),
                                                (t = { battleType: ae.battleType.name.$dyn(u) }),
                                                e.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(Ku, { text: ne.title(), className: 'App_title_5d' }),
                            a().createElement(Ku, {
                                text: ne.description(),
                                format: {
                                    binding: {
                                        battleModes: a().createElement(
                                            'div',
                                            { className: 'App_battleModes_3f' },
                                            F(E),
                                        ),
                                        minVehicleLevel: Zu(t),
                                        maxVehicleLevel: Zu(A),
                                    },
                                },
                                className: 'App_description_f9',
                            }),
                        );
                    });
                engine.whenReady.then(() => {
                    B().render(
                        a().createElement(re, null, a().createElement(eu, null, a().createElement(Be, null))),
