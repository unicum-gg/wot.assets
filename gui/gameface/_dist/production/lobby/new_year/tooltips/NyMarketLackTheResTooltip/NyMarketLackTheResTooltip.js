(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, E) => {
                E.r(e),
                    E.d(e, { mouse: () => o, off: () => D, on: () => r, onResize: () => t, onScaleUpdated: () => n });
                var A = E(2472),
                    F = E(1176);
            ...
            9916: (u, e, E) => {
                E.d(e, { Sw: () => t.Z, B3: () => D, Z5: () => n.Z5, ry: () => l });
                class A {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
                ...
                function c(u, e, E, A, F, t, n) {
                    ...
                    r.done ? e(D) : Promise.resolve(D).then(A, F);
                }
            ...
            7896: (u, e, E) => {
                ...
                const s = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    c = (u, e, E = o.left) => u.split(e).reduce(E === o.left ? B : C, []),
                    _ = (() => {
                        const u = new RegExp(
                    ...
                    d = (u, e = o.left) => {
                        ...
                        return ((u, e = o.left) => {
                            ...
                            const A =
                                ...
                                F = s(u);
                            return c(F, /( )/, e).forEach((u) => (E = E.concat(c(u, A, o.left)))), E;
                        })(u, e);
                    },
                    v = 'FormatText_base_d0',
                    m = ({ binding: u, text: e = '', classMix: E, alignment: t = o.left, formatWithBrackets: n }) => {
                ...
                const g = F().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            F().createElement(
                                'div',
                                b({}, a, {
                                    className: D()(p.base, p[`base__theme-${r}`], t),
                                    ref: function (u) {
                                        (i.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                    },
                                }),
                                F().createElement('div', { className: p.decorator }, E),
                            )
                        );
                    }),
                    y = (u = 1) => {
                ...
                const k = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    N = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: F, modelPath: x(F, u || ''), resId: A };
                            })(),
                            E = e.modelPrefix,
                            A = u.split('.');
                        if (A.length > 0) {
                        ...
                        O(() => {
                            if (
                                ...
                                const E = (u) => {
                                    ...
                                    A = N(u);
                                s.current = L.addCallback(A, E, r, e === M.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== M.None)
                                return () => {
                                    L.removeCallback(s.current, r);
                                };
                        }, [r, e]),
                        o
                    );
                ...
                const Y = { gold: 'gold', integral: 'integral' },
                    K = { [Y.gold]: P.B3.GOLD, [Y.integral]: P.B3.INTEGRAL };
                function $(u, e = Y.integral) {
                    return P.Z5.getNumberFormat(u, K[e]);
                }
                $.type = Y;
                const H = { number: $ },
                    Z = {
                    ...
                    X = (u, e) => {
                        ...
                        return () => {
                            'function' == typeof E && E(), clearTimeout(A);
                        };
                    };
                var Q = E(8613);
                ...
                const J = (u, e) => {
                    ...
                    uu = (P.Sw.instance, J);
                var eu = E(7030);
                const Eu = { enter: 'translateY(100%)', reduce: 'translateY(-100%)', none: 'translateY(0%)' },
                    Au = { leave: 'translateY(0%)', reduce: 'translateY(0%)', none: 'translateY(-100%)' },
                    Fu = ({ value: u, enterType: e, exitType: E }) => {
                        const A = F().useState(H.number(u)),
                            t = A[0],
                            n = A[1];
                        F().useEffect(() => {
                            'none' !== E && n('');
                        }, [E]);
                        const r = F().useMemo(() => t.split('').map((u) => ({ char: u, key: Symbol() })), [t]),
                            a = (0, eu.useTransition)(r, {
                                from: { transform: Eu[e], opacity: 'none' === e ? 1 : 0 },
                                enter: { transform: 'translateY(0%)', opacity: 1 },
                                leave: { transform: Au[E], opacity: 0 },
                                keys: r.map((u) => u.key),
                                trail: 200,
                            });
                        return F().createElement(
                            ...
                            a((u, e) =>
                                F().createElement(
                                    eu.animated.div,
                                    { className: D()(Z.char, Z[`char__${E}`]), style: u },
                                    e.char,
                                ),
                            ),
                        );
                ...
                const nu = ({
                    ...
                    var r;
                    const a = F().useState(e),
                        o = a[0],
                        i = a[1],
                        s = F().useRef(null),
                        B = null != (r = uu(o)) ? r : o,
                        C = F().useMemo(() => Symbol(), [o]);
                    F().useEffect(() => {
                        const u = s.current;
                        if (u)
                            return (
                                u.classList.remove(Z.base__reduce),
                                u.classList.remove(Z.base__increase),
                                ((u) => {
                                    let e,
                                        E = null;
                                    return (
                                        ...
                                        () => {
                                            'function' == typeof e && e(), null !== E && cancelAnimationFrame(E);
                                        }
                                    );
                                })(() =>
                                    B > e
                                        ? (u.classList.add(Z.base__reduce),
                                          X(() => {
                                              i(e);
                                          }, 50))
                                        : B < e
                                          ? (u.classList.add(Z.base__increase),
                                            X(() => {
                                                i(e);
                                            }, 200))
                                          : void 0,
                    ...
                    const c = (0, eu.useTransition)(o, {
                        from: { opacity: o === B ? 1 : 0 },
                        enter: { opacity: 1 },
                        leave: { opacity: 0 },
                        keys: () => C,
                    ...
                    return F().createElement(
                        ...
                        F().createElement(
                            'div',
                            { className: D()(Z.icon, null == t ? void 0 : t.icon) },
                            F().createElement('div', { className: D()(Z.iconEffect, Z.iconEffect__reduce) }),
                            F().createElement('div', { className: D()(Z.iconEffect, Z.iconEffect__increase) }),
                            F().createElement('div', { className: D()(Z.increaseParticles) }),
                        ),
                        F().createElement(
                            'div',
                            { className: D()(Z.value, null == t ? void 0 : t.value) },
                            c((u, e, E) =>
                                F().createElement(
                                    eu.animated.div,
                                    { className: Z.valueWrapper, style: u },
                                    F().createElement(Fu, { value: e, enterType: Du(o, B), exitType: ru(o, e, E) }),
                                ),
                            ),
                            F().createElement('div', { className: Z.value__ghost }, H.number(o)),
                        ),
                    );
                };
                function ru(u, e, E) {
                    return u === e || 'mount' === E.phase ? 'none' : e > u ? 'reduce' : 'leave';
                }
                function Du(u, e) {
                    return u === e ? 'none' : e > u ? 'reduce' : 'enter';
                }
                const au = F().memo((u) => {
                        if (u.withAnimation) return F().createElement(nu, u);
                        const e = u.type,
                            E = u.size,
                            A = void 0 === E ? tu.Default : E,
                            t = u.isReverse,
                            n = u.isNotEnough,
                            r = u.classNames,
                            a = u.className,
                        ...
                        return F().createElement(
                            ...
                            F().createElement('div', { className: D()(Z.icon, null == r ? void 0 : r.icon) }),
                            void 0 !== o &&
                                F().createElement(
                                    'div',
                                    { className: D()(Z.value, n && Z.value__notEnough, null == r ? void 0 : r.value) },
                                    u.additionalValue,
                                    s ? R.strings.ny.common.dashes() : H.number(o),
                                ),
                        );
                    }),
                    ou = 'App_base_94',
                    ...
                    Bu = 'App_footer_a9',
                    Cu = 'App_notEnough_ae',
                    cu = R.strings.ny.marketplace.tooltips.lackTheResources,
                    _u = () => {
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                F().createElement(m, {
                                    classMix: iu,
                                    text: cu.header(),
                                    binding: { resource: R.strings.ny.resource.type.$dyn(e) },
                                }),
                                F().createElement('div', { className: su }, cu.text()),
                                F().createElement(
                                    'div',
                                    { className: Bu },
                                    cu.notEnough(),
                ...
                window.addEventListener('load', () => {
                    n().render(F().createElement(_u, null), document.getElementById('root'));
                });
            },
        },
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.O = (u, e, E, A) => {
            if (!e) {
                ...
                for (D = 0; D < deferred.length; D++) {
                    for (var [e, E, A] = deferred[D], t = !0, n = 0; n < e.length; n++)
                        (!1 & A || F >= A) &&
        ...
        (() => {
            ...
            var e = (e, E) => {
                    ...
                    for (e && e(E); D < t.length; D++)
                        (F = t[D]), __webpack_require__.o(u, F) && u[F] && u[F][0](), (u[F] = 0);
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(7896));
