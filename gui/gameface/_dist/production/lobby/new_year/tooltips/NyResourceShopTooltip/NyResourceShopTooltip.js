(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => A, off: () => i, on: () => E, onResize: () => a, onScaleUpdated: () => o });
                var n = t(2472),
                    r = t(1176);
            ...
            9916: (u, e, t) => {
                t.d(e, { Sw: () => a.Z, B3: () => i, Z5: () => o.Z5, ry: () => d });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            6134: (u, e, t) => {
                ...
                const _ = r().forwardRef(function (u, e) {
                    let t = u.children,
                        a = u.className,
                        o = u.theme,
                ...
                const M = (u = 'model', e = x.Deep) => {
                            ...
                            T(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = N(u);
                                    c.current = S.addCallback(n, t, E, e === x.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== x.None)
                                    return () => {
                                        S.removeCallback(c.current, E);
                                    };
                            }, [E, e]),
                            A
                        );
                    ...
                    L = (w.Sw.instance, h),
                    I = { gold: 'gold', integral: 'integral' },
                    V = { [I.gold]: w.B3.GOLD, [I.integral]: w.B3.INTEGRAL };
                function U(u, e = I.integral) {
                    return w.Z5.getNumberFormat(u, V[e]);
                }
                U.type = I;
                const W = { number: U },
                    G = {
                ...
                var z = t(7030);
                const Y = { enter: 'translateY(100%)', reduce: 'translateY(-100%)', none: 'translateY(0%)' },
                    j = { leave: 'translateY(0%)', reduce: 'translateY(0%)', none: 'translateY(-100%)' },
                    K = ({ value: u, enterType: e, exitType: t }) => {
                        const n = r().useState(W.number(u)),
                            a = n[0],
                            o = n[1];
                        r().useEffect(() => {
                            'none' !== t && o('');
                        }, [t]);
                        const E = r().useMemo(() => a.split('').map((u) => ({ char: u, key: Symbol() })), [a]),
                            F = (0, z.useTransition)(E, {
                                from: { transform: Y[e], opacity: 'none' === e ? 1 : 0 },
                                enter: { transform: 'translateY(0%)', opacity: 1 },
                                leave: { transform: j[t], opacity: 0 },
                                keys: E.map((u) => u.key),
                                trail: 200,
                            });
                        return r().createElement(
                            ...
                            F((u, e) =>
                                r().createElement(
                                    z.animated.div,
                                    { className: i()(G.char, G[`char__${t}`]), style: u },
                                    e.char,
                                ),
                            ),
                        );
                ...
                const H = ({
                    ...
                    var E;
                    const F = r().useState(e),
                        A = F[0],
                        s = F[1],
                        c = r().useRef(null),
                        D = null != (E = L(A)) ? E : A,
                        _ = r().useMemo(() => Symbol(), [A]);
                    r().useEffect(() => {
                        const u = c.current;
                        if (u)
                            return (
                                u.classList.remove(G.base__reduce),
                                u.classList.remove(G.base__increase),
                                ((u) => {
                                    let e,
                                        t = null;
                                    return (
                                    ...
                                    D > e
                                        ? (u.classList.add(G.base__reduce),
                                          q(() => {
                                              s(e);
                                          }, 50))
                                        : D < e
                                          ? (u.classList.add(G.base__increase),
                                            q(() => {
                                                s(e);
                                            }, 200))
                                          : void 0,
                    ...
                    const l = (0, z.useTransition)(A, {
                        from: { opacity: A === D ? 1 : 0 },
                        enter: { opacity: 1 },
                        leave: { opacity: 0 },
                        keys: () => _,
                    ...
                    return r().createElement(
                        ...
                        r().createElement(
                            'div',
                            { className: i()(G.icon, null == a ? void 0 : a.icon) },
                            r().createElement('div', { className: i()(G.iconEffect, G.iconEffect__reduce) }),
                            r().createElement('div', { className: i()(G.iconEffect, G.iconEffect__increase) }),
                            r().createElement('div', { className: i()(G.increaseParticles) }),
                        ),
                        r().createElement(
                            'div',
                            { className: i()(G.value, null == a ? void 0 : a.value) },
                            l((u, e, t) =>
                                r().createElement(
                                    z.animated.div,
                                    { className: G.valueWrapper, style: u },
                                    r().createElement(K, { value: e, enterType: X(A, D), exitType: Z(A, e, t) }),
                                ),
                            ),
                            r().createElement('div', { className: G.value__ghost }, W.number(A)),
                        ),
                    );
                };
                function Z(u, e, t) {
                ...
                const Q = r().memo((u) => {
                    if (u.withAnimation) return r().createElement(H, u);
                    const e = u.type,
                        t = u.size,
                    ...
                    return r().createElement(
                        ...
                        r().createElement('div', { className: i()(G.icon, null == E ? void 0 : E.icon) }),
                        void 0 !== A &&
                            r().createElement(
                                'div',
                                { className: i()(G.value, o && G.value__notEnough, null == E ? void 0 : E.value) },
                                u.additionalValue,
                                c ? R.strings.ny.common.dashes() : W.number(A),
                            ),
                    );
                });
                var J = t(5677);
                const uu = {
                        base: 'App_base_21',
                        bg: 'App_bg_41',
                        bg__orange: 'App_bg__orange_1e',
                        bg__purple: 'App_bg__purple_3b',
                        bg__blue: 'App_bg__blue_21',
                        bg__green: 'App_bg__green_4c',
                        title: 'App_title_98',
                        description: 'App_description_73',
                        info: 'App_info_31',
                        availability: 'App_availability_23',
                        value: 'App_value_23',
                        text: 'App_text_de',
                        footer: 'App_footer_cf',
                    },
                    eu = R.strings.ny.resourceTooltip,
                    tu = (u) => {
                        switch (u) {
                            case B.Amber:
                                return 'orange';
                    ...
                    nu = () => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: uu.base },
                                r().createElement('div', { className: i()(uu.bg, uu[`bg__${tu(e)}`]) }),
                                r().createElement('div', { className: uu.title }, R.strings.ny.resource.type.$dyn(e)),
                                r().createElement('div', { className: uu.description }, eu.forShop.description()),
                                r().createElement(
                                    'div',
                                    { className: uu.info },
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            'div',
                                            { className: uu.availability },
                                            r().createElement(Q, {
                                                type: e,
                                                value: t,
                                                size: $.s28,
                                                isReverse: !0,
                                                classNames: { value: uu.value },
                                            }),
                                            r().createElement('div', { className: uu.text }, eu.available()),
                                        ),
                                    ),
                                ),
                                r().createElement('div', { className: uu.footer }, eu.forShop.footer()),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    o().render(r().createElement(nu, null), document.getElementById('root'));
                });
            },
            5677: (u, e, t) => {
                t.d(e, { v: () => A });
                var n = t(6483),
                    ...
                    a = t(6179),
                    o = t.n(a);
                const E = 'MenuInfo_base_30',
                    i = 'MenuInfo_background_e4',
                    F = 'MenuInfo_separator_6e',
                    A = ({ children: u, classNames: e }) =>
                        o().createElement(
                            'div',
                            { className: r()(E, null == e ? void 0 : e.base) },
                            o().createElement('div', { className: F }),
                            o().createElement('div', { className: i }, u),
                            o().createElement('div', { className: r()(F, null == e ? void 0 : e.bottomSeparator) }),
                        );
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(6134));
