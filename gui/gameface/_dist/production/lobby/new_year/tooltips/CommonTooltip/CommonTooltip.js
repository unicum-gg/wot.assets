    ...
    var u,
        e = {
            ...
            4796: (u, e, t) => {
                ...
                var E = {};
                t.r(E), t.d(E, { getBgUrl: () => f, getTextureUrl: () => x });
                var r = {};
                t.r(r),
                    t.d(r, {
                        addModelObserver: () => T,
                ...
                const iu = Q.client.getSize('rem'),
                    Cu = iu.width,
                    lu = iu.height,
                    ou = Object.assign({ width: Cu, height: lu }, Bu(Cu, lu, au)),
                    ...
                    du = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.mediumWidth && C) return Du(e, t, _);
                ...
                const hu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    fu = [cu.ExtraLarge, cu.Large, cu.Medium, cu.Small, cu.ExtraSmall],
                    pu = (u, e) =>
                        ...
                        let e = u.className,
                            ...
                            v =
                                void 0 === p
                                    ...
                                    : p,
                            b = u.alignItems,
                            S = void 0 === b ? (g ? 'flex-start' : _ && 'center') || (h && 'flex-end') || void 0 : b,
                            w = u.alignSelf,
                            L = u.wrap,
                            M = u.flexWrap,
                        ...
                        const G = (0, D.useMemo)(() => {
                                const u = { mt: r, mr: B, mb: C, ml: o },
                                    e = ((u) =>
                                        Mu.reduce((e, t) => {
                                            const A = u[t];
                                            return A && 'number' != typeof A ? e.concat(Lu[!0 === A ? 'MD' : A][t]) : e;
                                        }, []))(u),
                                    F = ((u) =>
                                        Mu.reduce((e, t) => {
                                            const A = u[t];
                            ...
                            }, [t, A, r, B, C, o, P, O, w, c, y, v, S]),
                            j = G.computedStyle,
                            X = G.computedClassNames;
                        return a().createElement('div', wu({ className: Fu()(bu.base, ...X, e), style: j }, N), W);
                    });
                let Tu;
                !(function (u) {
                ...
                const Hu = (u, e, t) => {
                    ...
                    Pu = (u, e, t = Tu.left) => u.split(e).reduce(t === Tu.left ? Hu : Ou, []),
                    Wu = (() => {
                        const u = new RegExp(
                    ...
                    Gu = ({ binding: u, text: e = '', classMix: t, alignment: A = Tu.left }) =>
                        null === e
                ...
                const Vu = Object.keys(Xu()),
                    ...
                    Qu = vu((u) => {
                        ...
                        return a().createElement(
                            ...
                            ku(
                                {
                                    className: Fu()(Iu.base, t && Iu[t], h, A),
                                    style: _,
                            ...
                            void 0 !== d ? a().createElement(Gu, ku({}, d, { text: e })) : e,
                        );
                    }),
                    Zu = (0, i.Pi)(() => {
                        const u = tu().model.root.get(),
                            e = u.header,
                            t = u.description,
                            A = u.additionalDescription;
                        return a().createElement(
                            'div',
                            { className: 'App_base_3c' },
                            e && a().createElement(Qu, { text: e, className: 'App_header_f3' }),
                            t && a().createElement(Qu, { text: t, className: 'App_description_39' }),
                            A && a().createElement(Qu, { text: A, className: 'App_additionalDescription_85' }),
                        );
                    });
                const Ju = {
                ...
                const te = a().forwardRef(function (u, e) {
                        let t = u.children,
                            A = u.className,
                            F = u.theme,
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                ee({}, r, {
                                    className: Fu()(Ju.base, Ju[`base__theme-${E}`], A),
                                    ref: function (u) {
                                        (B.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                    },
                                }),
                                a().createElement('div', { className: Ju.decorator }, t),
                            )
                        );
                    }),
                    Ae = (0, D.memo)(({ children: u }) =>
                        a().createElement(
                            te,
                            { theme: 'none' },
                            a().createElement(
                ...
                engine.whenReady.then(() => {
                    B().render(
                        a().createElement(eu, null, a().createElement(Ae, null, a().createElement(Zu, null))),
