            ...
            1135: (u, e, t) => {
                ...
                const uu = a().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                J({}, r, {
                                    className: C()(Q.base, Q[`base__theme-${F}`], A),
                                    ref: function (u) {
                ...
                const Su = {
                    ...
                    Mu = pu((u) => {
                        ...
                        return a().createElement('div', bu({ className: C()(fu.base, ...I, e), style: X }, G), N);
                    });
                let yu;
                !(function (u) {
                ...
                const Ru = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Ou = (u, e, t = yu.left) => u.split(e).reduce(t === yu.left ? Tu : Hu, []),
                    Pu = (() => {
                        const u = new RegExp(
                    ...
                    Nu = ({ binding: u, text: e = '', classMix: t, alignment: A = yu.left }) =>
                        null === e
                ...
                const Xu = {
                    ...
                    Iu = ['text', 'variant', 'className', 'color', 'm', 'mt', 'mr', 'mb', 'ml', 'style', 'format'];
                function zu() {
                    return (
                        (zu =
                            Object.assign ||
                ...
                const ku = Object.keys(ju()),
                    ...
                    qu = pu((u) => {
                        ...
                        return a().createElement(
                            ...
                            zu(
                                {
                                    className: C()(Xu.base, t && Xu[t], x, A),
                                    style: h,
                                    mt: !0 === n ? Ku[t || 'paragraph-P16'].mt : n,
                                    mr: !0 === i ? Ku[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === o ? Ku[t || 'paragraph-P16'].mb : o,
                                    ml: !0 === s ? Ku[t || 'paragraph-P16'].ml : s,
                                },
                                g,
                            ),
                            void 0 !== c ? a().createElement(Nu, zu({}, c, { text: e })) : e,
                        );
                    });
                var Qu = t(3282);
                function Zu() {
                ...
                const ee = (u) => (0 === u ? window : window.subViews.get(u)),
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const A = null != t ? t : a(e),
                                                            E = Ju.observable.box(A, { equals: Zu });
                                                        return (
                                                            'real' === u &&
                                                                D.subscribe(
                                                                    (0, Ju.action)((u) => E.set(u)),
                                                                    e,
                                                                ),
                                                            E
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const E = e.reduce(
                                                                (u, e) => ((u[e] = Ju.observable.box(A[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                    ...
                    Fe = (0, Qu.observer)(() => {
                        const u = Ee().model.root.get(),
                            e = u.header,
                            t = u.description,
                            A = u.additionalDescription;
                        return a().createElement(
                            'div',
                            { className: C()('App_base_3c', t && !A && !e && 'App_base__onlyDescription_74') },
                            e && a().createElement(qu, { text: e, className: 'App_header_f3' }),
                            t && a().createElement(qu, { text: Ru(t), className: 'App_description_39' }),
                            A &&
                                a().createElement(
                                    'div',
                                    { className: 'App_additionalDescriptionWithBorder_9a' },
                                    (e || t) &&
                                        a().createElement(
                                            a().Fragment,
                                            null,
                                            a().createElement('div', { className: 'App_whiteLine_11' }),
                                            a().createElement('div', { className: 'App_darkLine_39' }),
                                        ),
                                    a().createElement(qu, { text: A, className: 'App_additionalDescription_85' }),
                                ),
                        );
                    });
                engine.whenReady.then(() => {
                    B().render(
                        a().createElement(Ae, null, a().createElement(tu, null, a().createElement(Fe, null))),
