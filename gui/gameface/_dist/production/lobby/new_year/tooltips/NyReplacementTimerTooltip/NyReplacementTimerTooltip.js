(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, E) => {
                (E.r(e),
                    E.d(e, { mouse: () => i, off: () => r, on: () => D, onResize: () => t, onScaleUpdated: () => n }));
                var A = E(2472),
                    F = E(1176);
            ...
            7288: (u, e, E) => {
                ...
                const a = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    c = (u, e, E = i.left) => u.split(e).reduce(E === i.left ? C : s, []),
                    l = (() => {
                        const u = new RegExp(
                    ...
                    _ = (u, e = i.left) => {
                        ...
                        return ((u, e = i.left) => {
                            ...
                            const A =
                                ...
                                F = a(u);
                            return (c(F, /( )/, e).forEach((u) => (E = E.concat(c(u, A, i.left)))), E);
                        })(u, e);
                    };
                var m = E(9916),
                    v = E(8613);
                                    ...
                                    const A = Date.now(),
                                        t = setInterval(
                                            () => {
                                                ...
                                                null !== E && e <= E ? (D(E), F && F(), clearInterval(t)) : D(e);
                                            },
                                            1e3 * (e || (u > 2 * h ? h : 1)),
                                        );
                                    return () => {
                ...
                const L = (u) => u.toString().padStart(2, '0'),
                    N = (u, e) => {
                        switch (e) {
                            case M.Description:
                                return ((u, e = !0) =>
                                    u.days > 7 && e
                                        ...
                                        : u.days >= 1
                                          ...
                                          : u.hours >= 1
                                            ...
                                            : B(R.strings.common.duration.minutes(), { minutes: u.minutes || 1 }))(u);
                            case M.Short:
                    ...
                    V = (0, A.memo)(
                        ({
                            duration: u,
                            icon: e = S.Timer,
                            style: E = M.Description,
                            onTimeReached: t,
                            className: n = '',
                            classNames: D = {},
                        }) => {
                            const o = E !== M.Description ? 1 : void 0,
                                i = T(u, o),
                                B = (() => {
                            ...
                            const a = N(
                                (function (u = 0) {
                                    let e = u;
                                    const E = Math.trunc(e / g);
                                    e -= E * g;
                                    const A = Math.trunc(e / p);
                                    e -= A * p;
                                    const F = Math.trunc(e / h);
                                    return ((e -= F * h), { days: E, hours: A, minutes: F, seconds: e });
                                })(i),
                                E,
                            );
                            return F().createElement(
                                ...
                                e !== S.None &&
                                    F().createElement('div', {
                                        className: r()(P, D.icon),
                                        style: { backgroundImage: `url('${U(e, B)}')` },
                                    }),
                                F().createElement('div', { className: r()(k, D.text) }, a),
                            );
                        },
                    ),
                    z = 'FormatText_base_d0',
                    j = ({ binding: u, text: e = '', classMix: E, alignment: t = i.left, formatWithBrackets: n }) => {
                        ...
                        return F().createElement(
                            ...
                            D.split('\n').map((e, n) =>
                                F().createElement(
                                    'div',
                                    { className: r()(z, E), key: `${e}-${n}` },
                                    ((u, e, E) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (E && u in E ? E[u] : _(u, e))))(
                                        e,
                                        t,
                                        u,
                ...
                const $ = F().forwardRef(function (u, e) {
                    let E = u.children,
                        t = u.className,
                        n = u.theme,
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            K({}, o, {
                                className: r()(W.base, W[`base__theme-${D}`], t),
                                ref: function (u) {
                                    ((B.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            F().createElement('div', { className: W.decorator }, E),
                        )
                    );
                });
                var H = E(3403);
                ...
                const eu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: t = 'real', options: n, children: D, mocks: r }) {
                                const o = (0, A.useRef)([]),
                                    i = (E, A, F) => {
                                        var t;
                                        const n = (function ({
                                                ...
                                                return {
                                                    subscribe: (E, t) => {
                                                        const D = 'string' == typeof t ? `${A}.${t}` : A,
                                                            r = y.O.view.addModelObserver(D, e, !0);
                                                        return (F.set(r, E), u && E(n(t)), r);
                                                    },
                                                    readByPath: n,
                                                    createCallback: (u, e) => {
                                                        const E = n(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, E = Q(F.keys()); !(u = E()).done;) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(A),
                                            ...
                                            r = (u) =>
                                                'mocks' === E ? (null == F ? void 0 : F.getter(u)) : D.readByPath(u),
                                            ...
                                            a = { mode: E, model: B, externalModel: D, cleanup: i };
                                        return {
                                            model: B,
                                            controls: 'mocks' === E && F ? F.controls(a) : e(a),
                                            externalModel: D,
                                            mode: E,
                                        };
                                    },
                                    ...
                                    C = a[0],
                                    s = a[1],
                                    c = (0, A.useState)(() => i(t, n, r)),
                                    l = c[0],
                                    d = c[1];
                                return (
                                    (0, A.useEffect)(() => {
                                        B.current ? d(i(C, n, r)) : (B.current = !0);
                                    }, [r, C, n]),
                                    (0, A.useEffect)(() => {
                                        s(t);
                                    }, [t]),
                                    ...
                                    F().createElement(E.Provider, { value: l }, D)
                                );
                            },
                            () => (0, A.useContext)(E),
                        ];
                    })(({ observableModel: u }) => ({ root: u.object() }), Y),
                    Eu = eu[0],
                    Au = eu[1],
                    Fu = 'App_base_8f',
                    tu = 'App_title_5f',
                    nu = 'App_text_5a',
                    Du = 'App_countdown_a0',
                    ru = 'App_countdownIcon_ad',
                    ou = R.strings.ny.newYear.challenge.card.replacementTooltip,
                    iu = (0, H.Pi)(() => {
                        const u = Au().model.root.get(),
                            e = u.timeTill,
                            E = u.isAvailable,
                            A = u.isFinished;
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                E
                                    ? F().createElement(
                                          F().Fragment,
                                          null,
                                          F().createElement('div', { className: tu }, ou.available.title()),
                                          F().createElement('div', { className: nu }, ou.available.description()),
                                          !A &&
                                              F().createElement(j, {
                                                  classMix: nu,
                                                  text: ou.available.timer(),
                                                  binding: {
                                                      timer: F().createElement(V, {
                                                          duration: e,
                                                          classNames: { icon: ru },
                                                          className: Du,
                                                      }),
                                    ...
                                    : F().createElement(j, {
                                          classMix: nu,
                                          text: A ? ou.finished.description() : ou.missing.description(),
                                          binding: A
                                              ? void 0
                                              : {
                                                    timer: F().createElement(V, {
                ...
                engine.whenReady.then(() => {
                    n().render(
                        F().createElement(Eu, null, F().createElement(iu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(7288));
