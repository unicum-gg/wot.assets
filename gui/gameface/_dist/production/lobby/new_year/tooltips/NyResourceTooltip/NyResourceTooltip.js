(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => A, off: () => E, on: () => i, onResize: () => a, onScaleUpdated: () => o });
                var n = t(2472),
                    r = t(1176);
            ...
            9916: (u, e, t) => {
                t.d(e, { Sw: () => a.Z, B3: () => E, Z5: () => o.Z5, ry: () => d });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            8581: (u, e, t) => {
                ...
                const B = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            _({}, s, {
                                className: E()(l.base, l[`base__theme-${i}`], a),
                                ref: function (u) {
                                    (B.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            r().createElement('div', { className: l.decorator }, t),
                        )
                    );
                });
                var d = t(3403);
                ...
                const w = { gold: 'gold', integral: 'integral' },
                    g = { [w.gold]: s.B3.GOLD, [w.integral]: s.B3.INTEGRAL };
                function y(u, e = w.integral) {
                    return s.Z5.getNumberFormat(u, g[e]);
                }
                y.type = w;
                const O = { number: y },
                    T = {
                ...
                const M = N;
                var L = t(7030);
                const I = { enter: 'translateY(100%)', reduce: 'translateY(-100%)', none: 'translateY(0%)' },
                    G = { leave: 'translateY(0%)', reduce: 'translateY(0%)', none: 'translateY(-100%)' },
                    U = ({ value: u, enterType: e, exitType: t }) => {
                        const n = r().useState(O.number(u)),
                            a = n[0],
                            o = n[1];
                        r().useEffect(() => {
                            'none' !== t && o('');
                        }, [t]);
                        const i = r().useMemo(() => a.split('').map((u) => ({ char: u, key: Symbol() })), [a]),
                            s = (0, L.useTransition)(i, {
                                from: { transform: I[e], opacity: 'none' === e ? 1 : 0 },
                                enter: { transform: 'translateY(0%)', opacity: 1 },
                                leave: { transform: G[t], opacity: 0 },
                                keys: i.map((u) => u.key),
                                trail: 200,
                            });
                        return r().createElement(
                            ...
                            s((u, e) =>
                                r().createElement(
                                    L.animated.div,
                                    { className: E()(T.char, T[`char__${t}`]), style: u },
                                    e.char,
                                ),
                            ),
                        );
                ...
                const V = ({
                    ...
                    const s = r().useState(e),
                        ...
                        c = r().useRef(null),
                        l = null != (i = M(A)) ? i : A,
                        D = r().useMemo(() => Symbol(), [A]);
                    r().useEffect(() => {
                        const u = c.current;
                        if (u)
                            return (
                                u.classList.remove(T.base__reduce),
                                u.classList.remove(T.base__increase),
                                ((u) => {
                                    let e,
                                        t = null;
                                    return (
                                    ...
                                    l > e
                                        ? (u.classList.add(T.base__reduce),
                                          P(() => {
                                              F(e);
                                          }, 50))
                                        : l < e
                                          ? (u.classList.add(T.base__increase),
                                            P(() => {
                                                F(e);
                                            }, 200))
                                          : void 0,
                    ...
                    const _ = (0, L.useTransition)(A, {
                        from: { opacity: A === l ? 1 : 0 },
                        enter: { opacity: 1 },
                        leave: { opacity: 0 },
                        keys: () => D,
                    ...
                    return r().createElement(
                        ...
                        r().createElement(
                            'div',
                            { className: E()(T.icon, null == a ? void 0 : a.icon) },
                            r().createElement('div', { className: E()(T.iconEffect, T.iconEffect__reduce) }),
                            r().createElement('div', { className: E()(T.iconEffect, T.iconEffect__increase) }),
                            r().createElement('div', { className: E()(T.increaseParticles) }),
                        ),
                        r().createElement(
                            'div',
                            { className: E()(T.value, null == a ? void 0 : a.value) },
                            _((u, e, t) =>
                                r().createElement(
                                    L.animated.div,
                                    { className: T.valueWrapper, style: u },
                                    r().createElement(U, { value: e, enterType: j(A, l), exitType: q(A, e, t) }),
                                ),
                            ),
                            r().createElement('div', { className: T.value__ghost }, O.number(A)),
                        ),
                    );
                };
                function q(u, e, t) {
                ...
                const z = r().memo((u) => {
                    if (u.withAnimation) return r().createElement(V, u);
                    const e = u.type,
                        t = u.size,
                        n = void 0 === t ? W.Default : t,
                        a = u.isReverse,
                        o = u.isNotEnough,
                        i = u.classNames,
                        s = u.className,
                    ...
                    return r().createElement(
                        ...
                        r().createElement('div', { className: E()(T.icon, null == i ? void 0 : i.icon) }),
                        void 0 !== A &&
                            r().createElement(
                                'div',
                                { className: E()(T.value, o && T.value__notEnough, null == i ? void 0 : i.value) },
                                u.additionalValue,
                                c ? R.strings.ny.common.dashes() : O.number(A),
                            ),
                    );
                });
                var Y = t(5677);
                ...
                const uu = ((u, e) => {
                                ...
                                const s = (0, n.useRef)([]),
                                    A = (t, n, r) => {
                                        ...
                                        const o = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, a) => {
                                                        const i = 'string' == typeof a ? `${n}.${a}` : n,
                                                            E = F.O.view.addModelObserver(i, e, !0);
                                            ...
                                            l = { mode: t, model: c, externalModel: i, cleanup: A };
                                        return {
                                            model: c,
                        ...
                        const e = { root: u.object(), resource: u.object('resource') },
                            t = (0, J.Om)(() => {
                                const u = e.resource.get();
                                return { type: u.type, value: u.value };
                            });
                        return { root: e.root, computes: { resource: t } };
                    }, K),
                    eu = uu[0],
                    tu = uu[1],
                    nu = {
                        base: 'App_base_56',
                        bg: 'App_bg_81',
                        bg__ny_amber: 'App_bg__ny_amber_26',
                        bg__ny_iron: 'App_bg__ny_iron_68',
                        bg__ny_crystal: 'App_bg__ny_crystal_7f',
                        bg__ny_emerald: 'App_bg__ny_emerald_0d',
                        title: 'App_title_2e',
                        row: 'App_row_32',
                        amount: 'App_amount_f9',
                        amountInner: 'App_amountInner_99',
                        iconExtra: 'App_iconExtra_05',
                        caption: 'App_caption_10',
                        info: 'App_info_d2',
                        availability: 'App_availability_9f',
                        price: 'App_price_c8',
                        count: 'App_count_5d',
                        text: 'App_text_9c',
                    },
                    ru = R.strings.ny.resourceTooltip,
                    au = (0, d.Pi)(() => {
                        const u = tu().model,
                            e = u.root,
                            t = u.computes,
                            n = e.get(),
                            a = n.firstCollectAmount,
                            o = n.secondCollectAmount,
                            i = t.resource(),
                            s = i.type,
                            F = i.value;
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: nu.base },
                                r().createElement('div', { className: E()(nu.bg, nu[`bg__${s}`]) }),
                                r().createElement('div', { className: nu.title }, R.strings.ny.resource.type.$dyn(s)),
                                r().createElement(
                                    'div',
                                    { className: nu.row },
                                    r().createElement(
                                        'div',
                                        { className: nu.amount },
                                        r().createElement(A, { value: a }),
                                    ),
                                    r().createElement('div', { className: nu.caption }, ru.description()),
                                ),
                                r().createElement(
                                    'div',
                                    { className: nu.row },
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            'div',
                                            { className: nu.amountInner },
                                            r().createElement('div', { className: nu.iconExtra }),
                                            r().createElement(A, { value: o }),
                                        ),
                                    ),
                                    r().createElement(
                                        'div',
                                        { className: nu.caption },
                                        ru.secondaryDescription.$dyn(s),
                                    ),
                                ),
                                r().createElement(
                                    'div',
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            'div',
                                            { className: nu.availability },
                                            r().createElement(z, {
                                                type: s,
                                                value: F,
                                                size: W.s24,
                                                isReverse: !0,
                                                classNames: { value: nu.price },
                                            }),
                                            r().createElement('div', { className: nu.text }, ru.available()),
                                        ),
                                    ),
                                ),
                                r().createElement('div', null, ru.footer.$dyn(s)),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    o().render(
                        r().createElement(eu, null, r().createElement(au, null)),
            ...
            5677: (u, e, t) => {
                ...
                var n = t(6483),
                    ...
                    a = t(6179),
                    o = t.n(a);
                const i = 'MenuInfo_base_30',
                    E = 'MenuInfo_background_e4',
                    s = 'MenuInfo_separator_6e',
                    A = ({ children: u, classNames: e }) =>
                        o().createElement(
                            'div',
                            { className: r()(i, null == e ? void 0 : e.base) },
                            o().createElement('div', { className: s }),
                            o().createElement('div', { className: E }, u),
                            o().createElement('div', { className: r()(s, null == e ? void 0 : e.bottomSeparator) }),
                        );
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(8581));
