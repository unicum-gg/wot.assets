(() => {
    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                ...
                function d(u, e, t, A, E, F, n) {
                    ...
                    r.done ? e(i) : Promise.resolve(i).then(A, E);
                }
                ...
                const b = E.instance,
                    f = {
                        ...
                        sendMoveEvent: (u) => w(i.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: m,
                        sendClosePopOverEvent: () => w(i.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, t = 0) => {
                            w(i.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                        },
            ...
            8680: (u, e, t) => {
                ...
                const r = {
                    base: 'Shards_base_47',
                    base__reverse: 'Shards_base__reverse_85',
                    value: 'Shards_value_c9',
                    value__notEnough: 'Shards_value__notEnough_73',
                    icon: 'Shards_icon_23',
                    icon__small: 'Shards_icon__small_cd',
                    icon__big: 'Shards_icon__big_07',
                    icon__large: 'Shards_icon__large_f1',
                    icon__notEnough: 'Shards_icon__notEnough_fb',
                };
                let i;
                !(function (u) {
                    (u.Small = 'small'), (u.Big = 'big'), (u.Large = 'large');
                })(i || (i = {}));
                const o = ({ size: u = i.Small, value: e, isEnough: t = !0, classMix: A, isReverse: F = !1 }) => {
                    const o = E()(r.base, F && r.base__reverse),
                        a = E()(r.value, A, !t && r.value__notEnough),
                        D = E()(r.icon, r[`icon__${u}`], !t && r.icon__notEnough);
                    return n().createElement(
                        'div',
                        { className: o },
                        n().createElement('span', { className: D }),
                        e && n().createElement('span', { className: a }, e),
                    );
                };
            },
            3577: (u, e, t) => {
                ...
                const C = E().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        E().createElement(
                            'div',
                            _({}, i, {
                                className: a()(s.base, s[`base__theme-${r}`], F),
                                ref: function (u) {
                    ...
                    return (
                        ((u) => {
                            ...
                            if (
                                                ...
                                                const e = v(),
                                                    ...
                                                    E =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: E, modelPath: h(E, ''), resId: A };
                                            })(),
                                            t = e.modelPrefix,
                                            A = u.split('.');
                                        if (A.length > 0) {
                                            ...
                                            return (
                                                A.reduce((e, A) => {
                                                    const E = w(h(t, `${e}.${A}`), window);
                                                    return m(E)
                                                        ? (u.push(E.id), `${e}.${A}.value`)
                                                        : (u.push(A), `${e}.${A}`);
                                                }),
                                                u.reduce((u, e) => u + '.' + e)
                                            );
                                ...
                                s.current = p.addCallback(A, t, r, e === b.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== b.None)
                                return () => {
                                    p.removeCallback(s.current, r);
                                };
                        }, [r, e]),
                        a
                    );
                ...
                var g = t(8680),
                    O = t(3661);
                const T = 'App_text_8f',
                    y = R.strings.ny.breakDecorations.tooltip,
                    P = R.strings.ny.getPartsBtn.tooltip,
                    M = () => {
                        const u = f().shardsCount;
                        return E().createElement(
                            C,
                            null,
                            E().createElement(
                                'div',
                                { className: 'App_base_33' },
                                E().createElement('div', { className: 'App_title_1e' }, y.title()),
                                E().createElement('div', { className: 'App_description_5a' }, y.description()),
                                E().createElement(
                                    'div',
                                    { className: 'App_info_03' },
                                    E().createElement(
                                        O.v,
                                        null,
                                        E().createElement(
                                            'div',
                                            { className: 'App_availability_48' },
                                            E().createElement(
                                                'div',
                                                { className: 'App_count_06' },
                                                E().createElement(i, { format: 'integral', value: Number(u) }),
                                            ),
                                            E().createElement(
                                                'div',
                                                { className: 'App_icon_bd' },
                                                E().createElement(g.J, null),
                                            ),
                                            E().createElement('div', { className: T }, P.available()),
                                        ),
                                    ),
                                ),
                                E().createElement('div', { className: T }, y.note()),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    n().render(E().createElement(M, null), document.getElementById('root'));
                });
            },
            3661: (u, e, t) => {
                t.d(e, { v: () => n });
                var A = t(6179),
                    E = t.n(A);
                const F = 'MenuInfo_separator_eb',
                    n = ({ children: u }) =>
                        E().createElement(
                            'div',
                            { className: 'MenuInfo_base_57' },
                            E().createElement('div', { className: F }),
                            E().createElement('div', { className: 'MenuInfo_background_1c' }, u),
                            E().createElement('div', { className: F }),
                        );
            },
        },
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.O = (u, e, t, A) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, t, A] = deferred[i], F = !0, n = 0; n < e.length; n++)
                        (!1 & A || E >= A) &&
        ...
        (__webpack_require__.j = 1968),
        (() => {
            var u = { 1968: 0, 7879: 0, 4445: 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(3577));
