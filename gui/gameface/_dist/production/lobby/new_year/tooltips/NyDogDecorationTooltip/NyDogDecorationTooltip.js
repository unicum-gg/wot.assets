(() => {
    ...
    var __webpack_modules__ = {
                ...
                const o = ({
                    ...
                    return r().createElement(
                        ...
                        a.split('\n').map((e, o) =>
                            r().createElement(
                                'div',
                                { className: A()(D.Z.base, t), key: `${e}-${o}` },
            ...
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => a, off: () => D, on: () => r, onResize: () => F, onScaleUpdated: () => n });
                var E = t(2472),
                    A = t(1176);
            ...
            3649: (u, e, t) => {
                ...
                const r = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    a = (u, e, t = A.left) => u.split(e).reduce(t === A.left ? D : o, []),
                    i = (() => {
                        const u = new RegExp(
                    ...
                    s = (u, e = A.left) => {
                        ...
                        return ((u, e = A.left) => {
                            ...
                            const E =
                                ...
                                F = r(u);
                            return a(F, /( )/, e).forEach((u) => (t = t.concat(a(u, E, A.left)))), t;
                        })(u, e);
                    },
            ...
            406: (u, e, t) => {
                ...
                const o = (0, A.memo)((u) => {
                    ...
                    const a = ((u, e) => {
                                    ...
                                    (a = a.replace(s, `%(${t})`)),
                                        (D[t] = n[u]
                                            ? F().createElement(
                                                  'span',
                                                  { className: n[u] },
                                                  F().createElement(E.z, { text: l, binding: e }),
                                              )
                                            : F().createElement(
                                                  'span',
                                                  { style: ((B = u), { color: `#${B}` }) },
                        ...
                        i = a[0],
                        B = a[1];
                    return F().createElement(E.z, D({ text: i, classMix: A, binding: B }, o));
                });
            },
            7132: (u, e, t) => {
                var E = t(6179),
                ...
                !(function (u) {
                    ...
                    (function (u) {
                        (u.Decoration = 'decoration'), (u.GuestD = 'guestD');
                    })(l || (l = {}));
                var d = t(3403);
                const _ = function () {};
                function m() {
                ...
                const w = ((u, e) => {
                        ...
                        return [
                            function ({ mode: F = 'real', options: n, children: r, mocks: D }) {
                                const a = (0, E.useRef)([]),
                                    i = (t, E, A) => {
                                        var F;
                                        const n = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const r = 'string' == typeof F ? `${E}.${F}` : E,
                                                            D = o.O.view.addModelObserver(r, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = p(A.keys()); !(u = t()).done; ) F(u.value, e);
                                                    },
                                                    unsubscribe: F,
                                                };
                                            })(E),
                                    ...
                                    C = s[0],
                                    c = s[1],
                                    l = (0, E.useState)(() => i(F, n, D)),
                                    d = l[0],
                                    _ = l[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        B.current ? _(i(C, n, D)) : (B.current = !0);
                                    }, [D, C, n]),
                                    (0, E.useEffect)(() => {
                                        c(F);
                                    }, [F]),
                        ...
                        const e = { root: u.object() },
                            t = (0, h.Om)(() => e.root.get().state);
                        return Object.assign({}, e, { computes: { currentState: t } });
                    }, _),
                    f = w[0],
                    y = w[1];
                var O = t(6508),
                ...
                const x = (u, e) =>
                        u
                            ? (0, T.uF)(R.strings.ny.decorations.tooltip.dogDecoration.subtitle(), {
                                  decorationType: R.strings.ny.decorationTypes.$dyn(e),
                                  setName: R.strings.ny.bundlePurchaseDialog.logo.subtitle.$dyn(`level${u}`),
                              })
                            : String(R.strings.ny.decorationTypes.$dyn(e)),
                    k = 'Locked_base_b5',
                    P = 'Locked_description_a2',
                    S = 'Locked_separator_ee',
                    L = 'Locked_imageWrapper_12',
                    M = 'Locked_image_7d',
                    N = R.strings.ny.decorations.tooltip.dogDecoration.locked,
                    W = () => {
                        const u = y().model.root.get(),
                            e = u.name,
                            t = u.type,
                            E = u.sackRequiredLevel;
                        return A().createElement(
                            'div',
                            { className: k },
                            A().createElement(O.l, {
                                icon: `url(${R.images.gui.maps.icons.newYear.decoration_types.craft_small.$dyn(t)})`,
                                title: e,
                                subTitle: x(E + 1, t),
                                size: O.u.Small,
                            }),
                            ...
                            A().createElement(
                                ...
                                A().createElement('div', {
                                    className: M,
                                    style: {
                                        backgroundImage: `url(${R.images.gui.maps.icons.newYear.tooltips.decorations.dog.$dyn(`sack_${E}`)})`,
                                    },
                                }),
                            ),
                            A().createElement('div', { className: P }, N.description.$dyn(`sack_${E}`)),
                        );
                    };
                var U = t(9916);
                class I extends A().PureComponent {
                    render() {
                        let u;
                        if ('gold' === this.props.format) u = U.B3.GOLD;
                        else u = U.B3.INTEGRAL;
                        const e = U.Z5.getNumberFormat(this.props.value, u);
                ...
                var K = t(406),
                    H = t(387);
                const $ = 'Rented_base_65',
                    Y = 'Rented_description_6e',
                    Z = 'Rented_rentDescription_d7',
                    X = 'Rented_separator_4f',
                    Q = () => {
                        const u = y().model,
                            e = u.root.get(),
                            t = e.name,
                            ...
                            n = e.type,
                            r = e.timeTill,
                            D = e.sackRequiredLevel,
                            o = u.computes.currentState() !== c.Disabled,
                            a = (function (u = 0) {
                                let e = u;
                                ...
                                e -= E * q;
                                const A = Math.trunc(e / V);
                                return (e -= A * V), { days: t, hours: E, minutes: A, seconds: e };
                            })(r),
                            i = a.days;
                        return A().createElement(
                            'div',
                            { className: $ },
                            A().createElement(O.l, {
                                icon: `url(${R.images.gui.maps.icons.newYear.decoration_types.craft_small.$dyn(n)})`,
                                title: t,
                                subTitle: x(D + 1, n),
                            }),
                            A().createElement(H.b, { icon: E, description: F, classNames: { description: Y } }),
                            A().createElement('div', { className: X }),
                            o &&
                                (i > 0
                                    ? A().createElement(K.B, {
                                          text: R.strings.ny.decorations.tooltip.dogDecoration.rented.description.$plural(
                                              'base',
                                              i,
                                          ),
                                          binding: { daysCount: A().createElement(I, { value: i }) },
                                          className: Z,
                                      })
                                    : A().createElement(K.B, {
                                          text: R.strings.ny.decorations.tooltip.dogDecoration.rented.description.lastDay(),
                                          className: Z,
                                      })),
                        );
                    },
                    J = (0, d.Pi)(() => {
                        const u = y().model.computes.currentState() === c.Locked;
                        return A().createElement(C, null, u ? A().createElement(W, null) : A().createElement(Q, null));
                    });
                engine.whenReady.then(() => {
                    n().render(A().createElement(f, null, A().createElement(J, null)), document.getElementById('root'));
                });
            },
            387: (u, e, t) => {
                t.d(e, { b: () => B });
                ...
                const r = 'DecorationContent_base_c1',
                    D = 'DecorationContent_image_3c',
                    o = 'DecorationContent_background_00',
                    a = 'DecorationContent_toy_b2',
                    i = 'DecorationContent_description_bc',
                    B = ({ icon: u, description: e = '', classNames: t, children: E }) => {
                        const F = Boolean(u);
                        return n().createElement(
                            'div',
                            { className: A()(r, null == t ? void 0 : t.className) },
                            F &&
                                n().createElement(
                                    'div',
                                    { className: D },
                                    n().createElement('div', { className: o }),
                                    n().createElement('div', { className: a, style: { backgroundImage: `url(${u})` } }),
                                ),
                            E,
                            n().createElement('div', { className: A()(i, null == t ? void 0 : t.description) }, e),
                        );
                    };
            },
            6508: (u, e, t) => {
                ...
                const o = ({ icon: u, title: e, subTitle: t, className: E, size: F = D.Default }) =>
                    n().createElement(
                        'div',
                        { className: A()(r.base, r[`base__${F}`], E) },
                        n().createElement('div', { className: r.icon, style: { backgroundImage: u } }),
                        n().createElement(
                            'div',
                            { className: r.title },
                            n().createElement('div', { className: r.name }, e),
                            n().createElement('div', { className: r.type }, t),
                        ),
                    );
            },
            5287: (u, e, t) => {
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 2224),
        (() => {
            var u = { 2224: 0, 4840: 0, 4303: 0, 3494: 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(7132));
