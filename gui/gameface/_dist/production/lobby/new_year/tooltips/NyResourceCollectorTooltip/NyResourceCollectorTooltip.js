(() => {
    ...
    var __webpack_modules__ = {
                ...
                const D = ({
                    ...
                    return r().createElement(
                        ...
                        a.split('\n').map((e, D) =>
                            r().createElement(
                                'div',
                                { className: A()(o.Z.base, t), key: `${e}-${D}` },
            ...
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => a, off: () => o, on: () => r, onResize: () => F, onScaleUpdated: () => n }));
                var E = t(2472),
                    A = t(1176);
            ...
            3649: (u, e, t) => {
                ...
                const n = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    D = (u, e, t = A.left) => u.split(e).reduce(t === A.left ? r : o, []),
                    a = (() => {
                        const u = new RegExp(
                    ...
                    s = (u, e, t) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : B(u, e)));
            },
            1358: (u, e, t) => {
                t.d(e, { Z: () => F });
                var E = t(3138);
            ...
            406: (u, e, t) => {
                ...
                const D = (0, A.memo)((u) => {
                    ...
                    const a = ((u, e) => {
                        ...
                        i = a[0],
                        B = a[1];
                    return F().createElement(E.z, o({ text: i, classMix: A, binding: B }, D));
                });
            },
            3549: (u, e, t) => {
                var E = t(6179),
                ...
                function _(u = 0) {
                    ...
                    e -= E * l;
                    const A = Math.trunc(e / c);
                    return ((e -= A * c), { days: t, hours: E, minutes: A, seconds: e });
                }
                const m = (u, e = !0) =>
                        u.days > 7 && e
                            ? (0, i.WU)(R.strings.common.duration.days(), { days: u.days })
                            : u.days >= 1
                              ? 0 === u.hours
                                  ? (0, i.WU)(R.strings.common.duration.days(), { days: u.days })
                                  : `${(0, i.WU)(R.strings.common.duration.days(), { days: u.days })} ${(0, i.WU)(R.strings.common.duration.hours(), { hours: u.hours })}`
                              : u.hours >= 1
                                ? 0 === u.minutes
                                    ? (0, i.WU)(R.strings.common.duration.hours(), { hours: u.hours })
                                    : `${(0, i.WU)(R.strings.common.duration.hours(), { hours: u.hours })} ${(0, i.WU)(R.strings.common.duration.minutes(), { minutes: u.minutes })}`
                                : (0, i.WU)(R.strings.common.duration.minutes(), { minutes: u.minutes || 1 }),
                    v = () => {},
                    h = (u = 0, e, t = 0, A = v) => {
                                    ...
                                    const E = Date.now(),
                                        F = setInterval(
                                            () => {
                                                ...
                                                null !== t && e <= t ? (r(t), A && A(), clearInterval(F)) : r(e);
                                            },
                                            1e3 * (e || (u > 2 * c ? c : 1)),
                                        );
                                    return () => {
                ...
                const g = h,
                    b = 'Countdown_base_fe',
                    f = 'Countdown_icon_8b',
                    y = 'Countdown_description_8d',
                    O = (u) => u.toString().padStart(2, '0'),
                    T = R.images.gui.maps.icons.components.countdown,
                    x = (u, e) => {
                        const t = 2 === e ? T.big : T;
                        switch (u) {
                            case D.Timer:
                    ...
                    P = (0, E.memo)(
                        ({
                            ...
                            const B = t !== a.Description ? 1 : void 0,
                                s = g(u, B),
                                C = (() => {
                            ...
                            const c = ((u, e) => {
                                switch (e) {
                                    ...
                                    case a.Extended:
                                        return `${(0, i.WU)(R.strings.common.duration.days(), { days: u.days })} | ${O(u.hours)}:${O(u.minutes)}:${O(u.seconds)}`;
                                }
                            })(_(s), t);
                            return A().createElement(
                                ...
                                e !== D.None &&
                                    A().createElement('div', {
                                        className: o()(f, r.icon),
                                        style: { backgroundImage: `url('${x(e, C)}')` },
                                    }),
                                A().createElement('div', { className: o()(y, r.text) }, c),
                            );
                        },
                    );
                function k() {
                ...
                const N = A().forwardRef(function (u, e) {
                    let t = u.children,
                        F = u.className,
                        n = u.theme,
                ...
                const $ = ((u, e) => {
                        ...
                        return [
                            function ({ mode: F = 'real', options: n, children: r, mocks: o }) {
                                const D = (0, E.useRef)([]),
                                    a = (t, E, A) => {
                                        var F;
                                        const n = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const r = 'string' == typeof F ? `${E}.${F}` : E,
                                                            o = w.O.view.addModelObserver(r, e, !0);
                                                        return (A.set(o, t), u && t(n(F)), o);
                                                    },
                                                    readByPath: n,
                                                    createCallback: (u, e) => {
                                                        const t = n(e);
                                            ...
                                            B = { mode: t, model: i, externalModel: r, cleanup: a };
                                        return {
                                            model: i,
                                    ...
                                    s = B[0],
                                    C = B[1],
                                    c = (0, E.useState)(() => a(F, n, o)),
                                    l = c[0],
                                    d = c[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        i.current ? d(a(s, n, o)) : (i.current = !0);
                                    }, [o, s, n]),
                                    (0, E.useEffect)(() => {
                                        C(F);
                                    }, [F]),
                        ...
                        return {
                            ...
                            computes: {
                                cooldown: (0, K.Om)(() => {
                                    return ((u = e.root.get().cooldown), m(_(u)));
                                    var u;
                                }),
                            },
                        };
                    ...
                    Z = {
                        base: 'App_base_5c',
                        bg: 'App_bg_f6',
                        base__collected: 'App_base__collected_a7',
                        header: 'App_header_01',
                        icon: 'App_icon_10',
                        base__available: 'App_base__available_f9',
                        base__finished: 'App_base__finished_d1',
                        base__availableExtra: 'App_base__availableExtra_0d',
                        title: 'App_title_9f',
                        text: 'App_text_df',
                        countdownTime: 'App_countdownTime_8a',
                    },
                    X = R.strings.ny.resourceCollectorTooltip,
                    Q = (0, W.Pi)(() => {
                        const u = Y().model.root.get(),
                            e = u.type,
                            t = u.cooldown,
                            E = u.baseCollectAmount,
                            F = u.extraCollectAmount;
                        return A().createElement(
                            N,
                            null,
                            A().createElement(
                                'div',
                                { className: o()(Z.base, Z[`base__${e}`]) },
                                ...
                                A().createElement(
                                    ...
                                    A().createElement(U.B, {
                                        text: X.title.$dyn(e),
                                        binding: {
                                            timer: A().createElement(P, {
                                                duration: t,
                                                icon: D.None,
                                                style: a.Description,
                                                classNames: { text: Z.countdownTime },
                                            }),
                                        },
                                        className: Z.title,
                                    }),
                                ...
                                A().createElement(U.B, {
                                    text: X.description.$dyn(e),
                                    binding: { collectAmount: E, collectAmountExtra: F },
                                    className: Z.text,
                                }),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    n().render(A().createElement(H, null, A().createElement(Q, null)), document.getElementById('root'));
                });
            },
            5287: (u, e, t) => {
                t.d(e, { Z: () => E });
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(3549));
