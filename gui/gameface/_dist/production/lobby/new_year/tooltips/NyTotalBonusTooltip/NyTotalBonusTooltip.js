    ...
    var u,
        e = {
            ...
            5841: (u, e, t) => {
                ...
                const su = q.client.getSize('rem'),
                    du = su.width,
                    cu = su.height,
                    gu = Object.assign({ width: du, height: cu }, mu(du, cu, lu)),
                    _u = (0, D.createContext)(gu),
                    hu = ['children'],
                    xu = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && B) return Cu(e, t, _);
                            if (t.largeWidth && i) return Cu(e, t, _);
                            if (t.mediumWidth && C) return Cu(e, t, _);
                            if (t.smallWidth && l) return Cu(e, t, _);
                            if (t.extraSmallWidth && o) return Cu(e, t, _);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                (0, D.memo)(({ children: u }) => {
                    const e = (0, D.useContext)(_u),
                        ...
                        F = (0, D.useCallback)((u, e) => {
                            const t = q.view.pxToRem(u),
                                A = q.view.pxToRem(e);
                            E(Object.assign({ width: t, height: A }, mu(t, A, lu)));
                        }, []);
                    ((u) => {
                    ...
                    return a().createElement(_u.Provider, { value: r }, u);
                }),
                    (function (u) {
                ...
                const bu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    wu = [fu.ExtraLarge, fu.Large, fu.Medium, fu.Small, fu.ExtraSmall],
                    Lu = (u, e) =>
                ...
                const Hu = {
                    ...
                    Wu = Mu((u) => {
                        ...
                        return a().createElement('div', Tu({ className: C()(yu.base, ...I, e), style: X }, G), N);
                    });
                let Nu;
                !(function (u) {
                ...
                const Gu = (u, e, t) => {
                    ...
                    ku = ({ binding: u, text: e = '', classMix: t, alignment: A = Nu.left }) =>
                        null === e
                ...
                const qu = Object.keys($u()),
                    ...
                    te = Mu((u) => {
                        ...
                        return a().createElement(
                            ...
                            Yu(
                                {
                                    className: C()(Uu.base, t && Uu[t], x, A),
                                    style: h,
                                    mt: !0 === n ? ue[t || 'paragraph-P16'].mt : n,
                                    mr: !0 === i ? ue[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === o ? ue[t || 'paragraph-P16'].mb : o,
                                    ml: !0 === s ? ue[t || 'paragraph-P16'].ml : s,
                                },
                                g,
                            ),
                            void 0 !== c ? a().createElement(ku, Yu({}, c, { text: e })) : e,
                        );
                    }),
                    Ae = R.strings.ny.totalBonusTooltip,
                    Ee = ['condition1', 'condition2'],
                    Fe = (0, tu.Pi)(() => {
                        const u = nu().model.root.get().currentBonus;
                        return a().createElement(
                            eu,
                            null,
                            a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(te, { text: Ae.title(), format: { binding: { value: u } } }),
                                ),
                                a().createElement(
                                    'div',
                                    ...
                                    Ee.map((u) =>
                                        a().createElement(
                                            ...
                                            a().createElement(te, { text: Ae.$dyn(u) }),
                                        ),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    B().render(
                        a().createElement(au, null, a().createElement(Fe, null)),
