    ...
    var e,
        n = {
            942: (e, n, t) => {
                var r = {};
                t.r(r),
                    t.d(r, { mouse: () => y, off: () => w, on: () => p, onResize: () => g, onScaleUpdated: () => b });
                var o = {};
                t.r(o),
                    t.d(o, {
                        events: () => r,
                ...
                var i = {};
                t.r(i), t.d(i, { getBgUrl: () => j, getTextureUrl: () => A });
                var a = {};
                t.r(a),
                    t.d(a, {
                        addModelObserver: () => q,
                ...
                const T = {
                    ...
                    z = { play: Object.assign({}, _, { sound: E }), setRTPC: x };
                function A(e, n, t = 1) {
                ...
                const Pe = ((e, n) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: o, children: i, mocks: a }) {
                                ...
                                return (
                                    (0, s.useEffect)(() => {
                                        d.current ? p(c(f, o, a)) : (d.current = !0);
                                    }, [a, f, o]),
                                    (0, s.useEffect)(() => {
                                        m(r);
                                    }, [r]),
                    ...
                    })(({ observableModel: e }) => ({ root: e.object() }), pe),
                    Re = Pe[0],
                    Se = Pe[1],
                    Te = {
                        base: 'App_base_27',
                        title: 'App_title_4c',
                        subtitle: 'App_subtitle_6d',
                        image: 'App_image_56',
                    },
                    Oe = R.strings.ny.randomReward,
                    _e = (0, be.Pi)(() => {
                        const e = Se().model.root.get().resourceType;
                        return u().createElement(
                            ...
                            u().createElement(
                                'div',
                                { className: Te.base },
                                u().createElement('div', { className: Te.title }, Oe.title.$dyn(e)),
                                u().createElement('div', { className: Te.subtitle }, Oe.subtitle.$dyn(e)),
                                u().createElement('div', {
                                    className: Te.image,
                                    style: {
                                        backgroundImage: `url(${R.images.gui.maps.icons.quests.bonuses.s296x222.$dyn(e)})`,
                                    },
                                }),
                                u().createElement('div', { className: Te.description }, Oe.description.$dyn(e)),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    c().render(
                        u().createElement(Re, null, u().createElement(_e, null)),
