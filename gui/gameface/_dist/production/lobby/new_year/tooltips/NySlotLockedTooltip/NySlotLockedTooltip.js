        ...
        A = {
                ...
                const n = ({
                    ...
                    return C().createElement(
                        ...
                        r.split('\n').map((A, n) =>
                            C().createElement(
                                'div',
                                { className: e()(t.Z.base, F), key: `${A}-${n}` },
                                (0, D.Uw)(A, E, u).map((u, A) =>
                                    C().createElement(B.Fragment, { key: `${A}-${u}` }, u),
                                ),
                            ),
                        ),
                    );
            ...
            3649: (u, A, F) => {
                ...
                const B = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    n = (u, A, F = e.left) => u.split(A).reduce(F === e.left ? C : t, []),
                    r = (() => {
                        const u = new RegExp(
                    ...
                    i = (u, A = e.left) => {
                        ...
                        return ((u, A = e.left) => {
                            ...
                            const E =
                                ...
                                D = B(u);
                            return n(D, /( )/, A).forEach((u) => (F = F.concat(n(u, E, e.left)))), F;
                        })(u, A);
                    },
            ...
            5888: (u, A, F) => {
                var E = {};
                F.r(E),
                    F.d(E, { mouse: () => g, off: () => f, on: () => d, onResize: () => l, onScaleUpdated: () => c });
                var e = {};
                F.r(e),
                    F.d(e, {
                        events: () => E,
                ...
                const w = {
                    ...
                    y = Object.keys(x).reduce((u, A) => ((u[A] = () => m(x[A])), u), {}),
                ...
                const Bu = (() => {
                    ...
                    Cu = Object.keys(P).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === P[A]), u), {}),
                    tu = {
                        set: (u, A) => {
                ...
                const Tu = ((u, A) => {
                    ...
                    Pu = 'App_base_aa',
                    Su = (0, gu.Pi)(() => {
                        const u = Ou().model.root.get().level;
                        return t().createElement(
                            ...
                            t().createElement(
                                'div',
                                { className: Pu },
                                t().createElement(mu.B, {
                                    text: R.strings.ny.slotLockedTooltip.caption(),
                                    binding: { level: vu(u) },
                                }),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    r().render(
                        t().createElement(_u, null, t().createElement(Su, null)),
