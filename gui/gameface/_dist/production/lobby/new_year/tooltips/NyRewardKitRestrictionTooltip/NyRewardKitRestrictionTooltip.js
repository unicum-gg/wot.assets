(() => {
    ...
    var __webpack_modules__ = {
            ...
            527: (u, e, E) => {
                (E.r(e),
                    E.d(e, { mouse: () => B, off: () => r, on: () => D, onResize: () => t, onScaleUpdated: () => n }));
                var A = E(2472),
                    F = E(1176);
            ...
            3649: (u, e, E) => {
                ...
                const D = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    B = (u, e, E = F.left) => u.split(e).reduce(E === F.left ? r : o, []),
                    a = (() => {
                        const u = new RegExp(
                    ...
                    C = (u, e = F.left) => {
                        ...
                        return ((u, e = F.left) => {
                            ...
                            const A =
                                ...
                                t = D(u);
                            return (B(t, /( )/, e).forEach((u) => (E = E.concat(B(u, A, F.left)))), E);
                        })(u, e);
                    },
                    s = (u, e, E) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (E && u in E ? E[u] : C(u, e)));
            },
            1358: (u, e, E) => {
                E.d(e, { Z: () => t });
                var A = E(3138);
            ...
            406: (u, e, E) => {
                ...
                const o = (0, F.memo)((u) => {
                    ...
                    const B = ((u, e) => {
                        ...
                        a = B[0],
                        i = B[1];
                    return t().createElement(A.z, r({ text: a, classMix: F, binding: i }, o));
                });
            },
            2852: (u, e, E) => {
                var A = E(6179),
                ...
                const s = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            C({}, s, {
                                className: r()(a.base, a[`base__theme-${D}`], t),
                                ref: function (u) {
                                    ((l.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            F().createElement('div', { className: a.decorator }, E),
                        )
                    );
                });
                var c = E(3649),
                        ...
                        return [
                            function ({ mode: t = 'real', options: n, children: D, mocks: r }) {
                                const B = (0, A.useRef)([]),
                                    a = (E, A, F) => {
                                        ...
                                        const n = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, E = f(F.keys()); !(u = E()).done; ) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(A),
                                            ...
                                            C = { mode: E, model: i, externalModel: D, cleanup: a };
                                        return {
                                            model: i,
                                    ...
                                    s = C[0],
                                    c = C[1],
                                    l = (0, A.useState)(() => a(t, n, r)),
                                    d = l[0],
                                    _ = l[1];
                                return (
                                    (0, A.useEffect)(() => {
                                        i.current ? _(a(s, n, r)) : (i.current = !0);
                                    }, [r, s, n]),
                                    (0, A.useEffect)(() => {
                                        c(t);
                                    }, [t]),
                                    ...
                                    F().createElement(E.Provider, { value: d }, D)
                                );
                            },
                            () => (0, A.useContext)(E),
                        ];
                    })(({ observableModel: u }) => ({ root: u.object() }), w),
                    T = O[0],
                    x = O[1];
                var P = E(406);
                const k = 'Content_content_b1',
                    S = 'Content_text_43',
                    M = 'Content_separator_ef',
                    L = 'Content_heading_d6',
                    N = 'Content_footer_81',
                    W = 'Content_label_08',
                    U = (0, h.Pi)(() => {
                        const u = x().model.root.get(),
                            e = u.count,
                            E = u.maxCount;
                        return F().createElement(
                            F().Fragment,
                            null,
                            F().createElement('div', { className: L }, R.strings.ny.shopOverlay.tooltip.title()),
                            F().createElement(
                                'div',
                                { className: k },
                                ...
                                F().createElement(P.B, {
                                    className: S,
                                    text: R.strings.ny.shopOverlay.tooltip.$plural('content', e),
                                    binding: { count: e },
                                }),
                                F().createElement('div', { className: M }),
                            ),
                            F().createElement(
                                ...
                                F().createElement(
                                    'div',
                                    { className: W },
                                    (0, c.uF)(R.strings.ny.shopOverlay.tooltip.footer(), { maxCount: E }),
                                ),
                            ),
                        );
                    }),
                    ...
                    j = (0, h.Pi)(() => {
                        const u = x().model.root.get(),
                            e = u.isLastDay,
                            E = u.countdownTimestamp,
                            A = u.maxCount,
                            t = u.count,
                            n = (function (u = 0) {
                                let e = u;
                                const E = Math.trunc(e / m);
                                e -= E * m;
                                const A = Math.trunc(e / v);
                                e -= A * v;
                                const F = Math.trunc(e / _);
                                return ((e -= F * _), { days: E, hours: A, minutes: F, seconds: e });
                            })(E),
                            D = n.hours,
                            r = n.minutes,
                            o = t < 1;
                            ...
                            F().createElement(
                                ...
                                o
                                    ? F().createElement(
                                          ...
                                          { className: V },
                                          e
                                              ? R.strings.ny.shopOverlay.tooltip.lastDay()
                                              : (0, c.uF)(R.strings.ny.shopOverlay.tooltip.lock(), {
                                                    maxCount: A,
                                                    hours: D,
                                                    minutes: r,
                                                }),
                                      )
                                    : F().createElement(U, null),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    n().render(F().createElement(T, null, F().createElement(j, null)), document.getElementById('root'));
                });
            },
            5287: (u, e, E) => {
                E.d(e, { Z: () => A });
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(2852));
