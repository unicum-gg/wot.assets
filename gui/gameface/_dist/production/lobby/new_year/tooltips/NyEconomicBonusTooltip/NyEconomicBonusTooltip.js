        ...
        e = {
            ...
            3649: (u, e, A) => {
                ...
                const r = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    C = (u, e, A = E.left) => u.split(e).reduce(A === E.left ? n : B, []),
                    a = (() => {
                        const u = new RegExp(
                    ...
                    o = (u, e = E.left) => {
                        ...
                        return ((u, e = E.left) => {
                            ...
                            const F =
                                ...
                                t = r(u);
                            return C(t, /( )/, e).forEach((u) => (A = A.concat(C(u, F, E.left)))), A;
                        })(u, e);
                    },
                    l = (u, e, A) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : o(u, e)));
            },
            406: (u, e, A) => {
                A.d(e, { B: () => B });
                var F = A(280),
            ...
            9780: (u, e, A) => {
                ...
                const Du = (() => {
                    ...
                    ru = Object.keys(O).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === O[e]), u), {}),
                    nu = {
                        set: (u, e) => {
                ...
                const hu = Cu.client.getSize('rem'),
                    fu = hu.width,
                    vu = hu.height,
                    xu = Object.assign(
                        { width: fu, height: vu },
                ...
                const bu = (u) => {
                    ...
                    if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
                        ...
                        if (A.extraLargeWidth && C) return mu(e, A, h);
                        if (A.largeWidth && a) return mu(e, A, h);
                ...
                const Hu = ((u, e) => {
                        ...
                        const e = { root: u.object(), economicBonuses: u.array('economicBonuses') };
                        return Object.assign({}, e);
                    }, Tu),
                    zu = Hu[0],
                    ju = Hu[1],
                    ...
                    Vu = 'App_list_99',
                    $u = 'App_item_1b',
                    Gu = 'App_bonusValue_3b',
                    Uu = 'App_icon_e7',
                    Iu = 'App_label_7c',
                    qu = 'App_info_b8',
                    Qu = 'App_divider_18',
                    Zu = 'App_text_5d',
                    Ku = ['creditsFactor', 'xpFactor', 'tankmenXPFactor', 'freeXPFactor'],
                    Xu = R.strings.ny.newYear.challenge.quests.tooltip,
                    Yu = R.strings.ny.percentageValue,
                    Ju = (0, du.Pi)(() => {
                        const u = ju().model,
                            e = u.root.get(),
                            A = e.isMaxBonus,
                            F = e.totalQuestsQuantity;
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    { className: Mu },
                                    A ? Xu.maxBonus.title() : Xu.economicBonus.title(),
                                ),
                                A
                                    ? n().createElement(
                                          'div',
                                          null,
                                          (0, cu.uF)(Xu.maxBonus.description(), { questsValue: F }),
                                      )
                                    : n().createElement('div', null, Xu.economicBonus.description()),
                                n().createElement(
                                    'div',
                                    { className: Vu },
                                    ((E = ((u) => {
                                        const e = Ku;
                                        return u.reduce((u, A) => {
                                            const F = e.indexOf(A.value.bonusName);
                                            return (u[-1 === F ? u.length : F] = A.value), u;
                                        }, []);
                                    })(u.economicBonuses.get())),
                                    (t = ({ bonusName: u, bonusValue: e }, A) => {
                                        const F = {
                                            backgroundImage: `url(R.images.gui.maps.icons.newYear.vehicles.bonuses.${u})`,
                                        };
                                        return n().createElement(
                                            'div',
                                            { key: A, className: $u },
                                            n().createElement(
                                                'div',
                                                { className: Gu },
                                                n().createElement('div', { className: Uu, style: F }),
                                                (0, cu.uF)(Yu.withPlus(), { value: e }),
                                            ),
                                            n().createElement('div', { className: Iu }, Xu.bonus.$dyn(u)),
                                        );
                                    }),
                                    Array.isArray(E)
                                        ? E.map(t)
                                        : E.map((u, e, A) => t(null == u ? void 0 : u.value, e, A))),
                                ),
                                A &&
                                    n().createElement(
                                        n().Fragment,
                                        ...
                                        n().createElement(
                                            ...
                                            n().createElement('div', { className: ku }, Xu.maxBonus.subTitle()),
                                            n().createElement(_u.B, { text: Xu.maxBonus.paragraph_1(), className: Zu }),
                                        ),
                                        n().createElement(
                                            'div',
                                            { className: qu },
                                            n().createElement('div', { className: Qu }),
                                            n().createElement('div', { className: Zu }, Xu.maxBonus.paragraph_2()),
                                        ),
                                    ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    C().render(
                        n().createElement(zu, null, n().createElement(Ju, null)),
