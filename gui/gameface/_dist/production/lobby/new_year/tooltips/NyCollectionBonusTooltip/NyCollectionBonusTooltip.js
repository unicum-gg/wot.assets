(() => {
    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                ...
                function _(u, e, t, A, E, F, n) {
                    ...
                    r.done ? e(o) : Promise.resolve(o).then(A, E);
                }
            ...
            5057: (u, e, t) => {
                ...
                const B = E().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        E().createElement(
                            'div',
                            s({}, B, {
                                className: o()(a.base, a[`base__theme-${r}`], F),
                                ref: function (u) {
                ...
                const b = (u = 'model', e = p.Deep) => {
                        ...
                        return (
                            ((u) => {
                                ...
                                if (
                                                    ...
                                                    const e = d(),
                                                        ...
                                                        E =
                                                            window.__feature && window.__feature !== t && t
                                                                ? `subViews.${t}`
                                                                : '';
                                                    return { modelPrefix: E, modelPath: m(E, ''), resId: A };
                                                })(),
                                                t = e.modelPrefix,
                                                A = u.split('.');
                                            if (A.length > 0) {
                                    ...
                                    s.current = h.addCallback(A, t, r, e === p.Deep);
                                }
                            }),
                            (0, A.useEffect)(() => {
                                if (e !== p.None)
                    ...
                    f = (_.Sw.instance, 'CollectionBonus_base_75'),
                    g = ({ value: u, isEnabled: e }) =>
                        E().createElement(
                            'div',
                            { className: o()(f, e && 'CollectionBonus_base__enabled_75') },
                            E().createElement(
                                'div',
                                { className: 'CollectionBonus_value_7a' },
                                e && E().createElement('div', { className: 'CollectionBonus_check_59' }),
                                u,
                                '%',
                            ),
                        );
                ...
                const y = ({ interval: u, isEnabled: e, collectionBonuses: t }) =>
                        E().createElement(
                            'div',
                            { className: 'CollectionRow_base_78' },
                            E().createElement(
                                'div',
                                {
                                    className: o()(
                                        'CollectionRow_bodyCell_a2',
                                        e && 'CollectionRow_bodyCell__enabled_53',
                                    ),
                                },
                                u,
                            ),
                            t.items.map(({ value: u }, e) => E().createElement(g, O({}, u, { key: e }))),
                        ),
                    T = 'CollectionTable_headCell_8e',
                    P = 'CollectionTable_headCell__icon_16',
                    M = 'CollectionTable_icon_77';
                function N() {
                    return (
                        (N =
                            Object.assign ||
                ...
                const k = () => {
                        const u = b('model.collectionsTable.items'),
                            e = b('model').selectedCollection,
                            t = (u) => {
                                const t = R.images.new_year.gui.maps.icons.newYear.tooltips.bonuses.collections,
                                    A = u === e ? '_active' : '';
                                return { backgroundImage: `url(${t.$dyn(u + A)})` };
                            };
                        return E().createElement(
                            'div',
                            { className: 'CollectionTable_base_43' },
                            E().createElement(
                                'div',
                                { className: 'CollectionTable_headRow_1d' },
                                E().createElement(
                                    'div',
                                    { className: T },
                                    R.strings.ny.collectionBonusTooltip.toysCount(),
                                ),
                                E().createElement(
                                    'div',
                                    { className: o()(T, P) },
                                    E().createElement('div', { className: M, style: t('NewYear') }),
                                ),
                                E().createElement(
                                    'div',
                                    { className: o()(T, P) },
                                    E().createElement('div', { className: M, style: t('Oriental') }),
                                ),
                                E().createElement(
                                    'div',
                                    { className: o()(T, P) },
                                    E().createElement('div', { className: M, style: t('Fairytale') }),
                                ),
                                E().createElement(
                                    'div',
                                    { className: o()(T, P) },
                                    E().createElement('div', { className: M, style: t('Christmas') }),
                                ),
                            ),
                            u.map(({ value: u }, e) => E().createElement(y, N({}, u, { key: e }))),
                        );
                    },
                    S = R.strings.ny.collectionBonusTooltip,
                    L = () =>
                        E().createElement(
                            B,
                            null,
                            E().createElement(
                                ...
                                E().createElement('div', { className: 'App_arrow_6d' }),
                                E().createElement('div', { className: 'App_title_fe' }, S.title()),
                                E().createElement('div', { className: 'App_description_bc' }, S.description()),
                                E().createElement('div', { className: 'App_table_48' }, E().createElement(k, null)),
                            ),
                        );
                engine.whenReady.then(() => {
                    n().render(E().createElement(L, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, t, A) => {
            if (!e) {
                ...
                for (o = 0; o < deferred.length; o++) {
                    for (var [e, t, A] = deferred[o], F = !0, n = 0; n < e.length; n++)
                        (!1 & A || E >= A) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(5057));
