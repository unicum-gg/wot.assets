        ...
        F = {
            5341: (u, F, A) => {
                ...
                const y = {
                    ...
                    x = Object.keys(b).reduce((u, F) => ((u[F] = () => m(b[F])), u), {}),
                    P = { play: Object.assign({}, x, { sound: m }), setRTPC: w };
                function T(u, F, A = 1) {
                ...
                const Bu = (() => {
                    ...
                    nu = Object.keys(_).reduce((u, F) => ((u[F] = () => viewEnv.getShowingStatus() === _[F]), u), {}),
                    tu = {
                        set: (u, F) => {
                ...
                const lu = t().forwardRef(function (u, F) {
                        ...
                        return (
                            ...
                            t().createElement(
                                'div',
                                su({}, B, {
                                    className: o()(ou.base, ou[`base__theme-${D}`], e),
                                    ref: function (u) {
                                        ((r.current = u), 'function' == typeof F ? F(u) : F && (F.current = u));
                                    },
                                }),
                                t().createElement('div', { className: ou.decorator }, A),
                            )
                        );
                    }),
                ...
                const mu = 'App_base_f7',
                    wu = 'App_header_e2',
                    pu = 'App_paragraph_af',
                    hu = 'App_separator_71',
                    yu = R.strings.ny.marketplaceToken.tooltip,
                    bu = () => {
                        return t().createElement(
                            ...
                            t().createElement(
                                'div',
                                { className: mu },
                                t().createElement('div', { className: wu }, yu.title()),
                                t().createElement('div', { className: pu }, yu.description()),
                                t().createElement('div', { className: hu }),
                                t().createElement(
                                    'div',
                                    { className: pu },
                                    ((u = yu.condition()),
        ...
        (e.O = (F, A, E, D) => {
            if (!A) {
                ...
                for (r = 0; r < u.length; r++) {
                    for (var [A, E, D] = u[r], n = !0, t = 0; t < A.length; t++)
