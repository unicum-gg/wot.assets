(() => {
    var __webpack_modules__ = {
            ...
            233: (u, e, t) => {
                ...
                const P = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    I = [T.ExtraLarge, T.Large, T.Medium, T.Small, T.ExtraSmall],
                    k = (u, e) =>
                ...
                const V = {
                    ...
                    X = H((u) => {
                        let e = u.className,
                            ...
                            O = u.wrap,
                            T = u.flexWrap,
                            M = void 0 === T ? (O ? 'wrap' : void 0) : T,
                            L = u.grow,
                            P = u.shrink,
                            N = u.flex,
                            I = void 0 === N ? (L || P ? `${L ? 1 : 0} ${P ? 1 : 0} auto` : void 0) : N,
                            R = u.style,
                            k = u.children,
                            H = (function (u, e) {
                                if (null == u) return {};
                            ...
                            return n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    {
                                        ...
                                        style: Object.assign({}, M, { width: `${P}%`, transitionDuration: `${f}s` }),
                                        onTransitionEnd: () => {
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement('div', {
                                            className: s()(
                                                ...
                                                I && 'Progress_cursorPointer__visible_f9',
                                            ),
                                        }),
                                    ),
                                ),
                    ...
                    le =
                        ((0, r.memo)(
                            ({
                                ...
                                const T = { backgroundImage: `url(${ae.c_24x24.$dyn(D)})` },
                                    M = { backgroundImage: `url(${ie.categories.mainIcon.$dyn(D)})` },
                                    L = { backgroundImage: `url(${ae.c_34x34.$dyn(D)})` },
                                    P = { backgroundImage: `url(${ie.categories.mainIcon.$dyn(D)})` },
                                    N = { backgroundImage: `url(${ie.categories.mainIcon.$dyn(`${D}_select`)})` },
                                    I = { backgroundImage: `url(${ie.categories.mainIcon.$dyn(`${D}_select_mask`)})` },
                                    ...
                                    j = (0, r.useCallback)(
                                        (u) => {
                                            b ||
                                                w ||
                                                (u.stopPropagation(),
                                                (e !== Nu.Fifth && e !== Nu.Seventh) || m(!0),
                                                e === Nu.Fifth && vu(R.sounds.ny_vo_terentiy_help_stop()),
                                                bu.playClick(),
                                                l(D));
                                        },
                                        [m, w, b, e, l, D],
                                ...
                                return n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            ...
                                            n().createElement(
                                                'div',
                                                { className: 'Indicator_mainIcon_ae', style: M },
                                                n().createElement('div', {
                                                    className: s()(
                ...
                const pe = ((u, e) => {
                    ...
                    he = pe[0],
                    ve = pe[1],
                    be = 'App_currentBonusValue_98',
                    we = 'App_currentBonusValuePrefix_d8',
                    fe = R.strings.ny.pet,
                    xe = R.strings.ny.petWidgetTooltips.header.bonus,
                    ye = (0, du.observer)(() => {
                        const u = ve().model,
                            e = u.root.get(),
                            t = e.currentBonus,
                            r = e.minBonus,
                            a = e.maxBonus,
                            i = u.computes.getPetIndicators(),
                            o = t > r + (a - r) / 2 && t < a,
                            l = t === a;
                        return n().createElement(
                            'div',
                            { className: 'App_base_38' },
                            n().createElement(Au, { className: 'App_title_0d', text: xe.title() }),
                            n().createElement(
                                'div',
                                { className: 'App_indicators_c3' },
                                i.map((u) =>
                                    n().createElement(
                                        'div',
                                        { key: u.type, className: 'App_indicator_05' },
                            ...
                            n().createElement(
                                'div',
                                { className: 'App_minBonus_8a' },
                                n().createElement(Au, { className: 'App_minBonusText_bb', text: xe.nonBraking() }),
                                n().createElement(Au, {
                                    className: 'App_minBonusValue_de',
                                    text: fe.header.currentBonus(),
                                    format: { binding: { prefix: '', value: r } },
                                }),
                            ),
                            n().createElement(
                                'div',
                                { className: 'App_currentBonus_59' },
                                n().createElement(
                                    'div',
                                    { className: 'App_currentBonusContent_9c' },
                                    n().createElement('div', { className: 'App_currentBonusImage_ba' }),
                                    n().createElement(Au, {
                                        className: 'App_currentBonusText_5e',
                                        text: xe.fullBonus(),
                                    }),
                                    n().createElement(
                                        'div',
                                        { className: 'App_currentBonusValueWrapper_88' },
                                        n().createElement(Au, {
                                            className: s()(
                                                be,
                                                o && 'App_currentBonusValue__med_ef',
                                                l && 'App_currentBonusValue__gold_8d',
                                            ),
                                            text: fe.header.currentBonus(),
                                            format: {
                                                binding: {
                                        ...
                                        l &&
                                            n().createElement(Au, {
                                                className: s()(be, 'App_currentBonusValue__copied_63'),
                                                text: fe.header.currentBonus(),
                                                format: {
                                                    binding: {
                                                        prefix: n().createElement(Au, {
                                    ...
                                    n().createElement(Au, {
                                        className: 'App_maxBonus_fb',
                                        text: fe.header.maxBonus(),
                            ...
                            n().createElement(
                                'div',
                                { className: 'App_bottom_b4' },
                                n().createElement(Au, {
                                    className: 'App_howToUpgradeTitle_2d',
                                    text: xe.howToUpgrade.title(),
                                }),
                                n().createElement(Au, {
                                    className: 'App_howToUpgradeDescription_a5',
                                    text: xe.howToUpgrade.description(),
                                }),
                                n().createElement(Au, {
                                    className: 'App_pointsToLeaderBoardTitle_8f',
                                    text: xe.pointsToLeaderBoard.title(),
                                }),
                                n().createElement(Au, {
                                    className: 'App_pointsToLeaderBoardDescription_26',
                                    text: xe.pointsToLeaderBoard.description(),
                                }),
                            ),
                        );
                    });
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(233));
