(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, A) => {
                ...
                const D = (0, E.E)('clientResized'),
                    t = { down: (0, E.E)('mousedown'), up: (0, E.E)('mouseup'), move: (0, E.E)('mousemove') },
                    n = (function () {
            ...
            6377: (u, e, A) => {
                ...
                const r = (u, e, A) => {
                    ...
                    s = ['zh_cn', 'zh_sg', 'zh_tw'],
                    c = ({ binding: u, text: e = '', classMix: A, alignment: D = C.left }) =>
                        null === e
                ...
                const w = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            v({}, C, {
                                className: B()(l.base, l[`base__theme-${n}`], D),
                                ref: function (u) {
                                    ((i.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            F().createElement('div', { className: l.decorator }, A),
                        )
                    );
                });
                let m;
                var p;
                (((p = m || (m = {})).SHORT_DATE = 'short-date'),
                        ...
                        C = (0, E.useState)(() =>
                            ((u) => {
                                ...
                                ((u) =>
                                    ((u, e) =>
                                        u.split('.').reduce((u, e) => {
                                            const A = b(`${u}.${e}`, window);
                                            return g(A) ? ((u, e) => `${u}.${e}.value`)(u, e) : `${u}.${e}`;
                                        }))(u))(B),
                            ),
                        ),
                        r = C[0],
                    ...
                    return (
                        ((u) => {
                            ...
                            if (
                                                ...
                                                const e = f(),
                                                    ...
                                                    F =
                                                        window.__feature && window.__feature !== A && A
                                                            ? `subViews.${A}`
                                                            : '';
                                                return { modelPrefix: F, modelPath: O(F, ''), resId: E };
                                            })(),
                                            A = e.modelPrefix,
                                            E = u.split('.');
                                        if (E.length > 0) {
                                ...
                                o.current = T.addCallback(E, A, n, e === y.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== y.None)
                                return () => {
                                    T.removeCallback(o.current, n);
                                };
                        }, [n, e]),
                        r
                    );
                ...
                h.Sw.instance;
                var M = A(3661);
                const k = 'App_description_7d',
                    N = R.strings.ny.collectionsBtn.tooltip,
                    x = () => {
                        const u = P(),
                            e = u.currentToysCount,
                            A = u.allToysCount,
                            D = (0, E.useMemo)(() => ({ current: e, all: A }), [e, A]);
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                F().createElement('div', { className: 'App_title_66' }, N.title()),
                                F().createElement('div', { className: k }, N.description()),
                                F().createElement(
                                    'div',
                                    { className: 'App_info_09' },
                                    F().createElement(
                                        M.v,
                                        null,
                                        F().createElement(
                                            'div',
                                            { className: 'App_availability_90' },
                                            F().createElement('div', { className: 'App_galleryIcon_72' }),
                                            F().createElement(
                                                'div',
                                                { className: 'App_count_d1' },
                                                F().createElement(c, { text: N.countInfo(), binding: D }),
                                            ),
                                        ),
                                    ),
                                ),
                                F().createElement('div', { className: k }, N.note()),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    t().render(F().createElement(x, null), document.getElementById('root'));
                });
            },
            3661: (u, e, A) => {
                A.d(e, { v: () => t });
                var E = A(6179),
                    F = A.n(E);
                const D = 'MenuInfo_separator_eb',
                    t = ({ children: u }) =>
                        F().createElement(
                            'div',
                            { className: 'MenuInfo_base_57' },
                            F().createElement('div', { className: D }),
                            F().createElement('div', { className: 'MenuInfo_background_1c' }, u),
                            F().createElement('div', { className: D }),
                        );
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(6377));
