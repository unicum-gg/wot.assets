(() => {
    var __webpack_modules__ = {
                ...
                const o = ({
                    ...
                    return i().createElement(
                        ...
                        F.split('\n').map((e, o) =>
                            i().createElement(
                                'div',
                                { className: n()(A.Z.base, t), key: `${e}-${o}` },
            ...
            527: (u, e, t) => {
                'use strict';
                (t.r(e),
                    t.d(e, { mouse: () => F, off: () => A, on: () => i, onResize: () => a, onScaleUpdated: () => E }));
                var r = t(2472),
                    n = t(1176);
                const a = (0, r.E)('clientResized'),
                    E = (0, r.E)('self.onScaleUpdated'),
                    i = (u, e) => engine.on(u, e),
            ...
            514: (u, e, t) => {
                ...
                const n = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    ...
                    E = { play: Object.assign({}, a, { sound: r.playSound }), setRTPC: r.setRTPC };
            },
            3722: (u, e, t) => {
                'use strict';
                function r(u, e, t = 1) {
            ...
            3649: (u, e, t) => {
                ...
                const E = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    o = (u, e, t = n.left) => u.split(e).reduce(t === n.left ? i : A, []),
                    F = (() => {
                        const u = new RegExp(
                    ...
                    D = (u, e, t) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : l(u, e)));
            },
            1358: (u, e, t) => {
                'use strict';
                t.d(e, { Z: () => a });
            ...
            8655: (u, e, t) => {
                ...
                const d = (u) => {
                    ...
                    _ = ({ children: u }) => {
                        ...
                        (d(() => {
                            (E.O.client.events.on('clientResized', F), E.O.client.events.on('self.onScaleUpdated', s));
                        }),
                            (0, r.useEffect)(
                                () => () => {
                                    (E.O.client.events.off('clientResized', F),
                ...
                const y = {
                    ...
                    O = (u) => {
                        ...
                        const a = b(),
                            ...
                            i = a.mediaHeight,
                            A = a.mediaSize;
                        return n().createElement('div', L({ className: h()(t, y[E], S[i], T[A]) }, r), e);
                    },
                    M = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                class U extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = h()(W.base, W[`base__${E}`], W[`base__${a}`], null == i ? void 0 : i.base),
                            B = h()(W.icon, W[`icon__${E}`], W[`icon__${a}`], null == i ? void 0 : i.icon),
                            c = h()(W.glow, null == i ? void 0 : i.glow),
                            C = h()(W.caption, W[`caption__${E}`], null == i ? void 0 : i.caption),
                        ...
                        return n().createElement(
                            ...
                            'info' !== E && n().createElement('div', { className: W.shine }),
                ...
                function K(u = j.n.NONE, e = V, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== j.n.NONE)
                            return (
                ...
                const tu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: i, children: A, mocks: o }) {
                                const F = (0, r.useRef)([]),
                                    ...
                                    B = D[0],
                                    c = D[1],
                                    C = (0, r.useState)(() => s(a, i, o)),
                                    d = C[0],
                                    _ = C[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? _(s(B, i, o)) : (l.current = !0);
                                    }, [o, B, i]),
                                    (0, r.useEffect)(() => {
                                        c(a);
                                    }, [a]),
                        ...
                        ({ externalModel: u }) => ({
                            ...
                            goToAttachments: u.createCallbackNoArgs('onGoToAttachments'),
                        }),
                    ),
                    ru = tu[0],
                    nu = tu[1],
                ...
                const ou = Au;
                var Fu = t(406);
                const su = 'Footer_base_c2',
                    lu = 'Footer_description_a1',
                    Du = 'Footer_icon_86',
                    Bu = 'Footer_buttons_0c',
                    cu = 'Footer_button_15',
                    Cu = R.strings.ny.surpriseGift,
                    du = (0, Z.Pi)(() => {
                        const u = nu().controls;
                        return n().createElement(
                            'div',
                            { className: su },
                            n().createElement(Fu.B, {
                                className: lu,
                                text: Cu.description(),
                                binding: { icon: n().createElement('div', { className: Du }) },
                            }),
                            n().createElement(
                                'div',
                                { className: Bu },
                                n().createElement(
                                    ou,
                                    { onClick: u.goToHangar, type: Eu.primary, mixClass: cu },
                                    Cu.primaryButton(),
                                ),
                                n().createElement(
                                    ou,
                                    { onClick: u.goToAttachments, type: Eu.secondary, mixClass: cu },
                                    Cu.secondaryButton(),
                                ),
                            ),
                        );
                    ...
                    _u = 'Header_base_6f',
                    mu = 'Header_title_0e',
                    hu = 'Header_subtitle_57',
                    gu = 'Header_textGradient_a2',
                    vu = (0, Z.Pi)(() => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                { className: mu },
                                t,
                                n().createElement('div', { className: gu }, t),
                            ),
                        );
                    }),
                    fu = 'Vignette_base_1b',
                    pu = 'Vignette_gradient_92',
                    wu = 'Vignette_gradient__top_d6',
                    bu = 'Vignette_gradient__right_f7',
                    xu = 'Vignette_gradient__bottom_ec',
                    Lu = 'Vignette_gradient__left_59',
                    yu = { top: 0, right: 0, bottom: 25, left: 0 },
                    Su = { top: 20, right: 20, bottom: 25, left: 20 },
                    Tu = { top: 20, right: 0, bottom: 25, left: 0 },
                    Ou = { top: 0, right: 20, bottom: 25, left: 20 },
                    Mu = ({ vignetteConfig: u = yu }) =>
                        n().createElement(
                            'div',
                            { className: fu },
                            n().createElement('div', {
                                className: h()(pu, wu),
                                style: { backgroundSize: `100% ${u.top}%` },
                            }),
                            n().createElement('div', {
                                className: h()(pu, bu),
                                style: { backgroundSize: `${u.right}% 100%` },
                            }),
                            n().createElement('div', {
                                className: h()(pu, xu),
                                style: { backgroundSize: `100% ${u.bottom}%` },
                            }),
                            n().createElement('div', {
                                className: h()(pu, Lu),
                                style: { backgroundSize: `${u.left}% 100%` },
                            }),
                        ),
                    ku = 'App_base_e8',
                    Hu = 'App_base__visible_03',
                    Ru = 'App_content_f6',
                    Pu = 'App_base__4k_ca',
                    Nu = 'App_wrapper_44',
                    Wu = 'App_bg_32',
                    ...
                    Vu = (0, Z.Pi)(() => {
                        const u = nu().controls,
                            ...
                            o = (0, z.getSize)(),
                            F = o.height,
                            s = o.width >= $u && F >= ju && z.graphicsQuality.isHigh() && 1 === (0, $.getScale)(),
                            l = ((u, e) => {
                                const t = (0, z.getSize)(),
                                    r = t.height,
                                    n = t.width;
                                return r > e && n > u ? Su : r > e ? Tu : n > u ? Ou : yu;
                            })(s ? $u : i, s ? ju : A);
                        var D;
                        return (
                            (D = () => u.goToHangar()),
                            ...
                            Y({
                                [j.n.SPACE]: (e) => {
                                    (e.stopPropagation(), u.goToHangar());
                                },
                            }),
                            ((u, e) => {
                                (0, r.useEffect)(() => {
                            ...
                            n().createElement(
                                'div',
                                { className: h()(ku, t && Hu, s && Pu), lang: R.strings.settings.LANGUAGE_CODE() },
                                n().createElement(
                                    'div',
                                    { className: zu },
                                    n().createElement(U, {
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(Mu, { vignetteConfig: l }),
                                    n().createElement(
                                        'div',
                                        { className: Ru },
                ...
                engine.whenReady.then(() => {
                    P().render(
                        n().createElement(ru, null, n().createElement(k, null, n().createElement(Vu, null))),
                ...
                const o = (0, n.memo)((u) => {
                    ...
                    const F = ((u, e) => {
                            ...
                            for (; o; ) {
                                ...
                                if (B && c) {
                                    const u = B[0],
                                        t = u + s++ + c[0].replaceAll(')', '') + u;
                                    ((F = F.replace(D, `%(${t})`)),
                                        (A[t] = E[u]
                                            ? a().createElement(
                                                  'span',
                                                  { className: E[u] },
                                                  a().createElement(r.z, { text: C, binding: e }),
                                              )
                                            : a().createElement(
                                                  'span',
                                                  { style: ((l = u), { color: `#${l}` }) },
                        ...
                        s = F[0],
                        l = F[1];
                    return a().createElement(r.z, A({ text: s, classMix: n, binding: l }, o));
                });
            },
            5287: (u, e, t) => {
                'use strict';
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(8655));
