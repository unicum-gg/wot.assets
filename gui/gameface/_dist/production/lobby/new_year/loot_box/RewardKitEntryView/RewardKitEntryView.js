(() => {
    ...
    var __webpack_modules__ = {
            ...
            2529: (u, e, t) => {
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (A(t, C, { isMouseEvent: !0, on: !0, arguments: F(r) }, g),
                                    h && h(),
                        ...
                        return (
                            (0, n.useEffect)(() => {
                                ...
                                switch (g) {
                                                ...
                                                n = window.setInterval(() => {
                                                    ...
                                                    i
                                                        ? (null == o || o(r, i),
                                                          ...
                                                          r === l &&
                                                              (null == O || O(),
                                                              d || (null == y || y(), window.clearInterval(n))))
                                                        : console.error(
                                    ...
                                    case 'stop':
                                        return (function () {
                                            const u = 0 === s && k ? { path: k, x: 0, y: 0 } : i(s),
                                                e = new Image();
                                            e.src = u.path;
                                            const n = () => t(p(u, e));
                                            return (
                            ...
                            r().createElement('canvas', w({}, R, { width: e, height: t, ref: T }))
                        );
                    }),
                    b = (u, e) => {
                        let t = u;
                ...
                let x, S;
                (!(function (u) {
                    ((u.Usual = 'usual'), (u.Premium = 'premium'), (u.Default = 'default'));
                })(x || (x = {})),
                    (function (u) {
                        u.MediumKit = 'mediumKit';
                    })(S || (S = {})));
                const M = ({ count: u = 0, type: e = x.Default, size: t, isHoverEnabled: n = !0, classNames: i }) =>
                        r().createElement(
                            'div',
                            {
                                className: d()(
                            ...
                            r().createElement(
                                ...
                                { className: P.content },
                                r().createElement('div', {
                                    className: d()(P.kit, P[`kit__${e}`], null == i ? void 0 : i.kit),
                                }),
                                n &&
                                    r().createElement(
                                        r().Fragment,
                                        null,
                                        r().createElement('div', {
                                            className: d()(P.kit, P[`kit__${e}`], P.kit__hoverState),
                                        }),
                                        r().createElement('div', {
                                            className: d()(P.kit, P[`kit__${e}`], P.kit__activeState),
                                        }),
                                    ),
                                u > 0 &&
                                    r().createElement(
                                        ...
                                        u > 999
                                            ? r().createElement(
                                                  'div',
                                                  { className: P.value },
                                                  r().createElement('div', null, 999),
                                                  r().createElement('div', { className: P.plus }, '+'),
                                              )
                                            : r().createElement('div', { className: P.value }, u),
                                    ),
                            ),
                        ),
                    L = 'RewardKitEntry_base_34',
                    I = 'RewardKitEntry_base__disabled_f4',
                    N = 'RewardKitEntry_shine_28',
                    K = 'RewardKitEntry_kit_14',
                    V = 'RewardKitEntry_premiumKitsCounter_1d',
                    U = 'RewardKitEntry_label_f4',
                    j = 'RewardKitEntry_label_text_3c',
                    q = 'RewardKitEntry_externalLinkIcon_5b',
                    W = 'RewardKitEntry_warning_f2',
                    G = 'RewardKitEntry_warning_mask_05',
                    z = 'RewardKitEntry_warning_mask__empty_fa',
                    H = 'RewardKitEntry_warning_back_17',
                    Y = 'RewardKitEntry_warning_icon_ed',
                    $ = 'RewardKitEntry_warning__hasKits_d0',
                    Z = R.strings.ny.rewardKit,
                    X = {
                        width: 250,
                        height: 250,
                        frameCount: 38,
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                {
                                    ...
                                    onMouseEnter: () => O(R.sounds.gui_lootbox_hangar_icon_rollover()),
                                    onMouseLeave: () => O(R.sounds.gui_lootbox_hangar_icon_rollout()),
                                },
                                u > 0
                                    ? r().createElement(
                                          'div',
                                          ...
                                          r().createElement(M, {
                                              type: x.Premium,
                                              count: u,
                                              classNames: { counter: V, base: A },
                                          }),
                                      )
                                    : r().createElement(
                                          'div',
                                          null,
                                          r().createElement(M, { type: o, classNames: { kit: A } }),
                                          r().createElement(
                                              'div',
                                              { className: U },
                                              r().createElement(
                                                  ...
                                                  { className: j },
                                                  E
                                                      ? R.strings.ny.rewardKitMain.entryView.buyLabelCn()
                                                      : Z.upper.toBoxes(),
                                                  n && r().createElement('div', { className: q }),
                                              ),
                                          ),
                                      ),
                            ),
                ...
                const iu = ((u, e) => {
                                ...
                                const F = (0, n.useRef)([]),
                                    A = (t, n, r) => {
                                        ...
                                        const a = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, i) => {
                                                        const o = 'string' == typeof i ? `${n}.${i}` : n,
                                                            E = c.O.view.addModelObserver(o, e, !0);
                                            ...
                                            l = { mode: t, model: s, externalModel: o, cleanup: A };
                                        return {
                                            model: s,
                                    ...
                                    D = l[0],
                                    d = l[1],
                                    B = (0, n.useState)(() => A(i, a, E)),
                                    C = B[0],
                                    _ = B[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        s.current ? _(A(D, a, E)) : (s.current = !0);
                                    }, [E, D, a]),
                                    (0, n.useEffect)(() => {
                                        d(i);
                                    }, [i]),
                        ...
                        ({ externalModel: u }) => ({ openKit: u.createCallbackNoArgs('onOpenKit') }),
                    ),
                    au = iu[0],
                    ou = iu[1],
                    Eu = 'App_base_c1',
                    Fu = { left: 105, right: 30, top: 120, bottom: 70 },
                    Au = (0, l.Pi)(() => {
                        const u = ou(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return (
                            (l = () => {
                                (c.O.view.resize(300, 300, 'rem'), c.O.view.setSidePaddingsRem(Fu));
                            }),
                            (0, n.useEffect)(l, []),
                            r().createElement(
                                s,
                                {
                                    contentId: R.views.lobby.new_year.tooltips.NyRewardKitsUnavailableTooltip('resId'),
                                    isEnabled: E,
                                },
                                r().createElement(
                                    'div',
                ...
                engine.whenReady.then(() => {
                    a().render(
                        r().createElement(au, null, r().createElement(Au, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(2529));
