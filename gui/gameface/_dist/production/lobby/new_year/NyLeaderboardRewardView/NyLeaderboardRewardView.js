(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                'use strict';
                t.d(e, { B3: () => E, Z5: () => i, B0: () => o, ry: () => C, Eu: () => g });
                class r {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            6624: (u, e, t) => {
                ...
                let h, b, v;
                var w;
                (((w = h || (h = {}))[(w.ExtraSmall = s.extraSmall.width)] = 'ExtraSmall'),
                    (w[(w.Small = s.small.width)] = 'Small'),
                    (w[(w.Medium = s.medium.width)] = 'Medium'),
                    (w[(w.Large = s.large.width)] = 'Large'),
                    (w[(w.ExtraLarge = s.extraLarge.width)] = 'ExtraLarge'),
                    (function (u) {
                ...
                const S = {
                    ...
                    L = (u) => {
                        ...
                        const n = f(),
                            ...
                            s = n.mediaHeight,
                            o = n.mediaSize;
                        return a().createElement('div', T({ className: C()(t, S[i], M[s], y[o]) }, r), e);
                    },
                    P = ['children'],
                    O = (u) => {
                        let e = u.children,
                        ...
                        return a().createElement(D, null, a().createElement(L, t, e));
                    };
                var N = t(493),
                    k = t.n(N);
                function I(u) {
                ...
                (((X = G || (G = {})).main = 'main'),
                    (X.primary = 'primary'),
                    (X.primaryGreen = 'primaryGreen'),
                    (X.primaryRed = 'primaryRed'),
                    (X.secondary = 'secondary'),
                    (X.ghost = 'ghost'),
                    (($ = W || (W = {})).extraSmall = 'extraSmall'),
                    ($.small = 'small'),
                    ($.medium = 'medium'));
                const j = ({
                    children: u,
                ...
                const nu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    su = [h.ExtraLarge, h.Large, h.Medium, h.Small, h.ExtraSmall],
                    ou = (u, e) =>
                ...
                const Au = {
                    ...
                    du = lu((u) => {
                        let e = u.className,
                            ...
                            f =
                                void 0 === w
                                    ...
                                    : w,
                            x = u.alignItems,
                            T = void 0 === x ? (g ? 'flex-start' : p && 'center') || (h && 'flex-end') || void 0 : x,
                            S = u.alignSelf,
                            R = u.wrap,
                            M = u.flexWrap,
                        ...
                        const U = (0, r.useMemo)(() => {
                            ...
                            }, [t, n, o, E, _, m, k, N, S, B, y, f, T]),
                            G = U.computedStyle,
                            W = U.computedClassNames;
                        return a().createElement('div', _u({ className: C()(Eu.base, ...W, e), style: G }, H), I);
                    });
                let Du;
                !(function (u) {
                ...
                const Bu = (u, e, t) => {
                    ...
                    gu = (u, e, t = Du.left) => u.split(e).reduce(t === Du.left ? Bu : Cu, []),
                    pu = (() => {
                        const u = new RegExp(
                    ...
                    bu = ({ binding: u, text: e = '', classMix: t, alignment: n = Du.left }) =>
                        null === e
                ...
                const Su = Object.keys(wu()),
                    ...
                    Ou = lu((u) => {
                        ...
                        return a().createElement(
                            ...
                            Tu(
                                {
                                    className: C()(fu.base, t && fu[t], h, n),
                                    style: p,
                                    mt: !0 === l ? Lu[t || 'paragraph-P16'].mt : l,
                                    mr: !0 === c ? Lu[t || 'paragraph-P16'].mr : c,
                                    mb: !0 === A ? Lu[t || 'paragraph-P16'].mb : A,
                                    ml: !0 === F ? Lu[t || 'paragraph-P16'].ml : F,
                                },
                                B,
                            ),
                            void 0 !== D ? a().createElement(bu, Tu({}, D, { text: e })) : e,
                        );
                    }),
                    Nu = {
                ...
                class Hu extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            A = C()(Nu.base, Nu[`base__${i}`], Nu[`base__${n}`], null == s ? void 0 : s.base),
                            m = C()(Nu.icon, Nu[`icon__${i}`], Nu[`icon__${n}`], null == s ? void 0 : s.icon),
                            F = C()(Nu.glow, null == s ? void 0 : s.glow),
                            d = C()(Nu.caption, Nu[`caption__${i}`], null == s ? void 0 : s.caption),
                            D = C()(Nu.goto, null == s ? void 0 : s.goto);
                        return a().createElement(
                            'div',
                            Iu(
                                {
                ...
                let Xu;
                !(function (u) {
                    ((u.MAIN_APPEAR = 'gui_gift_system_newyear_reward_appear_main'),
                        (u.OTHER_APPEAR = 'gui_gift_system_newyear_reward_appear_small'));
                })(Xu || (Xu = {}));
                const ju = [
                        V.Items,
                        V.Equipment,
                    ...
                    Yu = [V.Gold, V.Credits, V.Crystal, V.FreeXp, V.NewYearToyFragments],
                    qu = [V.BattlePassPoints],
                    zu = [V.PremiumPlus, V.Premium];
                let Vu;
                !(function (u) {
                    ((u.s16 = '16'),
                        (u.s32 = '32'),
                ...
                const Ku = ['engravings', 'backgrounds'],
                    ...
                    ue = (u, e, t, r) => u.map((u) => Object.assign({}, u, { image: Ju(u, e ? t : Q.Big, r) }));
                function ee() {
                    return !1;
                }
                console.log;
                    ...
                    ne = (u) => {
                        return null !== u && 'object' == typeof u
                            ? 'CoherentArrayProxy' === u.constructor.name
                                ? ((e = u),
                                  (t = (u) => ('object' == typeof u ? ne(u) : u)),
                                  Array.isArray(e) ? e.map(t) : e.map((u, e, r) => t(null == u ? void 0 : u.value)))
                                : Array.isArray(u)
                                  ? u.map((u) => ('object' == typeof u ? ne(u) : u))
                                  : Object.fromEntries(
                                        Object.entries(u).map(([u, e]) => [u, 'object' == typeof e ? ne(e) : e]),
                                    )
                            : u;
                        var e, t;
                    };
                ...
                const se = ((u, e) => {
                                        ...
                                        const n = (function ({
                                            ...
                                            c = (({ observableModel: u }) => {
                                                const e = { root: u.object(), rewards: u.array('rewards.items', []) },
                                                    t = (0, ie.computedFn)(
                                                        (u) => {
                                                            return ((t = e.rewards.get()), ne(t)).map((e) => {
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : o(e),
                                                            a = te.observable.box(r, { equals: ee });
                                                        return (
                                                            'real' === u &&
                                                                s.subscribe(
                                                                    (0, te.action)((u) => a.set(u)),
                                                                    e,
                                                                ),
                                                            a
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const a = e.reduce(
                                                                (u, e) => ((u[e] = te.observable.box(r[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                        ...
                        goToLootboxes: u.createCallbackNoArgs('onGoToLootbox'),
                    })),
                    oe = se[0],
                    le = se[1],
                    Ee = [
                        ...
                        const h = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, r.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (_e(t, m, { isMouseEvent: !0, on: !0, arguments: ce(a) }, b),
                                    C && C(),
                ...
                const he = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return a().createElement(ge, e, r);
                        const n = e.contentId,
                            i = e.args,
                            s = null == i ? void 0 : i.contentId;
                        return n || s
                            ? a().createElement(Ae, pe({}, e, { contentId: n || s }), r)
                            : a().createElement(de, e, r);
                    },
                    be = {
                        base: 'Reward_base_ea',
                    ...
                    ve = ({
                        ...
                        const A = ((u) => {
                            ...
                            F = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case Z.CURRENCY:
                                    case Z.NUMBER:
                                        return a().createElement(z, { format: 'integral', value: Number(u) });
                                    case Z.PREMIUM_PLUS: {
                                        const e = Number(u);
                        ...
                        return a().createElement(
                            'div',
                            { className: C()(be.base, be[`base__${r}`], l), style: o },
                            a().createElement(
                                he,
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: C()(be.image, null == E ? void 0 : E.image) },
                                        A &&
                                            a().createElement('div', {
                                                className: C()(be.highlight, null == E ? void 0 : E.highlight),
                                                style: {
                                        ...
                                        e &&
                                            a().createElement('div', {
                                                className: C()(be.icon, null == E ? void 0 : E.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        m &&
                                            a().createElement('div', {
                                                className: C()(be.overlay, null == E ? void 0 : E.overlay),
                                                style: {
                            ...
                            t &&
                                a().createElement(
                                    ...
                                    { tooltipArgs: _ },
                                    a().createElement('div', {
                                        className: C()(be.timer, null == E ? void 0 : E.periodicIcon),
                                    }),
                                ),
                        );
                    };
                let we, fe, xe, Te, Se, Re, Me;
                var ye;
                (!(function (u) {
                    ((u[(u.CITY = 0)] = 'CITY'),
                        (u[(u.PET = 1)] = 'PET'),
                        (u[(u.LEADERS = 2)] = 'LEADERS'),
                        (u[(u.MACHINE = 3)] = 'MACHINE'),
                        (u[(u.INFO = 4)] = 'INFO'));
                })(we || (we = {})),
                    (function (u) {
                        ((u[(u.DONE = 0)] = 'DONE'),
                    ...
                    ((ye = Me || (Me = {})).ExtraSlot = 'ny22:extraSlot'),
                    (ye.ToyFragments = 'ny22ToyFragments'),
                    (ye.Tman = 'tmanToken'),
                    (ye.AchievementReward = 'dossier_achievement'),
                    (ye.Customizations = 'customizations'),
                    (ye.VariadicDiscount = 'variadicDiscount'),
                    (ye.MarketplaceUnlock = 'ny26_marketplace_unlock'),
                    (ye.LootBoxToken = 'lootBoxToken'));
                const Le = (u) => {
                        (0, r.useEffect)(u, []);
                    },
                    Pe = {
                ...
                var Oe, Ne;
                (((Ne = Oe || (Oe = {}))[(Ne.Left = 0)] = 'Left'),
                    (Ne[(Ne.Right = 1)] = 'Right'),
                    (Ne[(Ne.Top = 2)] = 'Top'),
                    (Ne[(Ne.Bottom = 3)] = 'Bottom'));
                const ke = ['__left', '__right', '__top', '__bottom'];
                (0, r.forwardRef)(
                    ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: n = {} }, s) => {
                        const o = (0, r.useRef)(null),
                            ...
                            A = c[1],
                            m = (0, r.useCallback)(() => {
                                (H.playClick(), i.O.view.sendEvent.close());
                            }, []),
                            F = (0, r.useCallback)(() => {
                                H.playHighlight();
                            }, []),
                            d = C()(Pe.arrow, Pe[`arrow${ke[_]}`]);
                        Le(
                            () => (
                        ...
                        const D = (0, r.useCallback)(
                                (u) => {
                                    let e = u.target;
                                    do {
                                        if (e === o.current || e === E.current) return;
                                        e = e.parentNode;
                                    } while (e);
                        ...
                        return (
                            (0, r.useImperativeHandle)(s, () => ({ updateSize: B })),
                            Le(() => {
                ...
                const Ie =
                    ...
                    we.MACHINE,
                    {
                        base: 'AnimationRewards_base_3b',
                        reward: 'AnimationRewards_reward_51',
                        blink: 'AnimationRewards_blink_8d',
                        reward__main: 'AnimationRewards_reward__main_ac',
                        rewardInfo: 'AnimationRewards_rewardInfo_13',
                        rewardInfo__multi: 'AnimationRewards_rewardInfo__multi_dd',
                        rewardInfo__currency: 'AnimationRewards_rewardInfo__currency_bd',
                        rewardImage: 'AnimationRewards_rewardImage_ae',
                        description: 'AnimationRewards_description_01',
                        description__s296x222: 'AnimationRewards_description__s296x222_fc',
                        description__s400x300: 'AnimationRewards_description__s400x300_26',
                        description__s600x450: 'AnimationRewards_description__s600x450_8c',
                        name: 'AnimationRewards_name_51',
                        btnWrapper: 'AnimationRewards_btnWrapper_2c',
                        btn: 'AnimationRewards_btn_27',
                    });
                function He() {
                    return (
                        (He =
                ...
                const Ue = 150,
                    Ge = R.strings.ny.questGiverRewards,
                    We = ({
                        items: u,
                        animationDelayStart: e = 0,
                        maxLength: t = 0,
                        sound: n,
                        size: i = Q.Small,
                        isMainRewards: s = !1,
                        ...
                        const E =
                            ...
                            c = E[0],
                            _ = E[1],
                            A = c.length + Number(Boolean(_.length)),
                            m = {
                                contentId: R.views.lobby.tooltips.AdditionalRewardsTooltip('resId'),
                                args: { showedCount: t - 1, top: o },
                            };
                        return (
                            (0, r.useEffect)(() => {
                                if (!n) return;
                                ...
                                const t = setTimeout(() => {
                                    let e = 0;
                                    u = setInterval(() => {
                                        (I(R.sounds.$dyn(n)), e++, e >= A && (clearInterval(u), clearTimeout(t)));
                                    }, Ue);
                                }, e - 300);
                                return () => {
                            ...
                            a().createElement(
                                ...
                                c.map((u, t) =>
                                    a().createElement(
                                        'div',
                                        {
                                            className: C()(Ie.reward, s && Ie.reward__main),
                                            key: s ? t : 3 + t,
                                            style: { animationDelay: `${e + Ue * t}ms` },
                                        },
                                        a().createElement(
                                            ve,
                                            He({}, u, {
                                                size: i,
                                                classNames: {
                                                    info: s ? C()(Ie.rewardInfo, Ie[`rewardInfo__${u.valueType}`]) : '',
                                                    image: Ie.rewardImage,
                                                },
                                            }),
                                        ),
                                        s &&
                                            a().createElement(
                                                'div',
                                                { className: C()(Ie.description, Ie[`description__${i}`]) },
                                                u.label && a().createElement(Ou, { className: Ie.name, text: u.label }),
                                                'lootBoxToken' === u.name &&
                                                    a().createElement(
                                                        'div',
                                                        { className: Ie.btnWrapper },
                                                        a().createElement(
                                                            Y,
                                                            { type: G.ghost, mixClass: Ie.btn, onClick: l },
                                                            a().createElement(Ou, { text: Ge.button.toLootboxes() }),
                                                        ),
                                                    ),
                                            ),
                                    ),
                                ...
                                _.length > 0 &&
                                    a().createElement(
                                        'div',
                                        { className: Ie.reward, style: { animationDelay: `${e + Ue * c.length}ms` } },
                                        a().createElement(ve, {
                                            name: 'more',
                    ...
                    $e = {
                        ...
                        bg: 'App_bg_04',
                        close: 'App_close_da',
                        fadeIn: 'App_fadeIn_5b',
                        content: 'App_content_f8',
                        congratulations: 'App_congratulations_b5',
                        congratulations__withoutRewards: 'App_congratulations__withoutRewards_03',
                        header: 'App_header_f2',
                        header__visible: 'App_header__visible_76',
                        title: 'App_title_c3',
                        subtitle: 'App_subtitle_6c',
                        subheader: 'App_subheader_ea',
                        subheader__visible: 'App_subheader__visible_77',
                        gradientHeaderTitle: 'App_gradientHeaderTitle_56',
                        headerTitle: 'App_headerTitle_93',
                        headerTitle__position1: 'App_headerTitle__position1_01',
                        headerTitle__position2: 'App_headerTitle__position2_23',
                        headerTitle__position3: 'App_headerTitle__position3_38',
                        headerTitleEffects: 'App_headerTitleEffects_a8',
                        yourPosition: 'App_yourPosition_5b',
                        top: 'App_top_e4',
                        footerTitle: 'App_footerTitle_b5',
                        slideUp: 'App_slideUp_f8',
                        footerDescription: 'App_footerDescription_3c',
                        ribbonWrapper: 'App_ribbonWrapper_0a',
                        ribbon: 'App_ribbon_89',
                        tapeContent: 'App_tapeContent_c0',
                        slideBack: 'App_slideBack_67',
                        rewardsContainer: 'App_rewardsContainer_29',
                        hugeRewards: 'App_hugeRewards_6f',
                        hugeRewards__withoutRewards: 'App_hugeRewards__withoutRewards_44',
                        rewards: 'App_rewards_03',
                        confirm: 'App_confirm_ee',
                        confirm__visible: 'App_confirm__visible_60',
                        buttons: 'App_buttons_cd',
                        buttons__withoutRewards: 'App_buttons__withoutRewards_61',
                        confirmButton: 'App_confirmButton_96',
                    },
                    Xe = R.strings.ny.leaderboardGiverRewards,
                    je = Xe.button,
                    Ye = (0, $u.observer)(() => {
                        const u = le(),
                            e = u.model,
                            ...
                            o = n.position,
                            l = n.top,
                            E = e.computes.getRewards(l),
                            c = Boolean(l),
                            _ = (0, r.useState)(!1),
                            A = _[0],
                            m = _[1],
                            F = f().mediaSize,
                            d = ((u) => (u < h.Medium ? 's232x174' : u >= h.ExtraLarge ? 's400x300' : 's296x222'))(F),
                            D = ue(E.slice(0, 3), !0, d, l),
                            B = ue(E.slice(3), !1, Q.Small, l),
                            g = F < h.Medium ? Q.Small : Q.Big,
                            p = B.length > 0,
                            b = 2100 + Ue * E.length;
                        return (
                            (0, r.useEffect)(() => {
                                I(R.sounds.gui_random_reward_red_ribbon_appear());
                            }, []),
                            (0, r.useEffect)(
                                () =>
                                    ((u, e) => {
                                        let t;
                                        const r = setTimeout(() => {
                                            (I(R.sounds.gui_random_reward_end()), (t = void m(!0)));
                                        }, e);
                                        return () => {
                            ...
                            a().createElement(
                                'div',
                                { className: $e.base },
                                a().createElement('div', { className: $e.bg }),
                                a().createElement(
                                    'div',
                                    { className: $e.close },
                                    a().createElement(Hu, {
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: C()($e.header, A && $e.header__visible) },
                                        a().createElement(Ou, { className: $e.title, text: Xe.title() }),
                                        a().createElement(Ou, {
                                    ...
                                    0 !== o &&
                                        a().createElement(
                                            'div',
                                            { className: C()($e.subheader, A && $e.subheader__visible) },
                                            a().createElement(
                                                'div',
                                                { className: $e.gradientHeaderTitle },
                                                (o > 3 || !c) &&
                                                    a().createElement(
                                                        'div',
                                                        { className: $e.headerTitleEffects },
                                                        a().createElement(z, { value: o }),
                                                    ),
                                                a().createElement(
                                                    'div',
                                                    { className: C()($e.headerTitle, $e[`headerTitle__position${o}`]) },
                                                    a().createElement(z, { value: o }),
                                                ),
                                            ),
                                            a().createElement(Ou, {
                                                className: $e.yourPosition,
                                                text: Xe.yourPosition(),
                                            }),
                                            a().createElement(Ou, {
                                                className: $e.top,
                                                text: c ? Xe.top() : Xe.positioned(),
                                                format: { binding: { top: a().createElement(z, { value: l }) } },
                                            }),
                                        ),
                                    a().createElement(
                                        'div',
                                        ...
                                        a().createElement(
                                            'div',
                                            { className: $e.rewardsContainer },
                                            a().createElement(
                                                'div',
                                                { className: $e.ribbonWrapper },
                                                a().createElement('div', { className: $e.ribbon }),
                                            ),
                                            D.length > 0 &&
                                                a().createElement(
                                                    'div',
                                                    {
                                                        className: C()(
                                                            $e.hugeRewards,
                                                            !p && $e.hugeRewards__withoutRewards,
                                                        ),
                                                    },
                                                    a().createElement(We, {
                                                        items: D,
                                                        animationDelayStart: 1200,
                                                        maxLength: 3,
                                                        size: d,
                                                        sound: Xu.MAIN_APPEAR,
                                                        isMainRewards: !0,
                                                        goToLootboxes: t.goToLootboxes,
                                                        top: l,
                                                    }),
                                                ),
                                            p &&
                                                a().createElement(
                                                    ...
                                                    a().createElement(We, {
                                                        items: B,
                                                        animationDelayStart: 1700,
                                                        maxLength: 9,
                                                        size: g,
                                                        top: l,
                                                        sound: Xu.OTHER_APPEAR,
                                                    }),
                                                ),
                                        ),
                                        a().createElement(
                                            'div',
                                            { className: C()($e.confirm, A && $e.confirm__visible) },
                                            !i &&
                                                a().createElement(
                                                    'div',
                                                    {
                                                        className: C()(
                                                            $e.congratulations,
                                                            !p && $e.congratulations__withoutRewards,
                                                        ),
                                                    },
                                                    a().createElement(Ou, {
                                                        text: Xe.footer.title(),
                                                        className: $e.footerTitle,
                                                    }),
                                                    a().createElement(Ou, {
                                                        text: Xe.footer.description(),
                                                        className: $e.footerDescription,
                                                    }),
                                                ),
                                            a().createElement(
                                                'div',
                                                { className: C()($e.buttons, !p && $e.buttons__withoutRewards) },
                                                a().createElement(
                                                    Y,
                                                    { mixClass: $e.confirmButton, size: W.medium, onClick: t.close },
                                                    a().createElement(Ou, { text: je.ok() }),
                                                ),
                                            ),
                                        ),
                                    ),
                ...
                engine.whenReady.then(() => {
                    k().render(
                        a().createElement(oe, null, a().createElement(O, null, a().createElement(Ye, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(6624));
