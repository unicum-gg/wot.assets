(() => {
    var __webpack_modules__ = {
            ...
            8254: (u, e, t) => {
                ...
                const l = i.O.client.getSize('rem'),
                    F = l.width,
                    s = l.height,
                    _ = Object.assign({ width: F, height: s }, A(F, s, o)),
                ...
                const y = {
                    ...
                    M = (u) => {
                        ...
                        const n = f(),
                            ...
                            o = n.mediaHeight,
                            E = n.mediaSize;
                        return a().createElement('div', w({ className: d()(t, y[i], L[o], T[E]) }, r), e);
                    },
                    S = ['children'],
                    O = (u) => {
                        let e = u.children,
                ...
                const z = ['xl', 'lg', 'md', 'sm', 'xs'],
                    V = (u) => u.includes('_') && ((u) => z.includes(u))(u.split('_').at(-1)),
                ...
                const uu = {
                    ...
                    ru = Y((u) => {
                        let e = u.className,
                            ...
                            m = u.row,
                            B = u.flexDirection,
                            C = void 0 === B ? (c ? 'column' : m && 'row') || void 0 : B,
                            h = u.flexStart,
                            g = u.center,
                            p = u.flexEnd,
                            v = u.spaceBetween,
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, n, E, l, s, D, N, k, L, C, S, x, y]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return a().createElement('div', J({ className: d()(Z.base, ...U, e), style: G }, I), P);
                    });
                let au;
                !(function (u) {
                ...
                const mu = Object.keys(su()),
                    ...
                    pu = Y((u) => {
                        ...
                        return a().createElement(
                            ...
                            cu(
                                {
                                    className: d()(_u.base, t && _u[t], p, n),
                                    style: g,
                            ...
                            void 0 !== B ? a().createElement(lu, cu({}, B, { text: e })) : e,
                        );
                    });
                var vu = t(5521),
                    bu = t(4179);
                ...
                const wu = {
                    ...
                    Lu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Tu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Mu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((E = E.replace(t, `%(${o})`)),
                                    (i[o] = wu[u]
                                        ? a().createElement(
                                              'span',
                                              { className: wu[u] },
                                              a().createElement(lu, { text: F, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: n(u) },
                        ...
                        return a().createElement(lu, { text: E, classMix: t, binding: i });
                    });
                var Su = t(3403);
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (ku(t, D, { isMouseEvent: !0, on: !0, arguments: Hu(a) }, v),
                                    d && d(),
                            ...
                            Uu(
                                {
                                    contentId:
                                        ...
                                        F ? ju.SimpleTooltipHtmlContent('resId') : ju.SimpleTooltipContent('resId')),
                ...
                const zu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        return n || o
                            ? a().createElement(Nu, $u({}, e, { contentId: n || o }), r)
                ...
                const Qu = (u) => {
                    let e = u.children,
                        ...
                        i = Yu(u, Vu);
                    if (!i) return e;
                    const o = n && (i.isEnabled || void 0 === i.isEnabled) ? a().createElement('div', null, e) : e,
                        E = i.contentId,
                        A = Yu(i, Ku);
                    switch (t) {
                        case Zu.Base:
                            return (
                                ...
                                E ? a().createElement(Nu, qu({}, A, { contentId: E }), o) : o
                            );
                        case Zu.Simple:
                            return a().createElement(Xu, A, o);
                        case Zu.Backport:
                            return a().createElement(Wu, A, o);
                        default:
                            return a().createElement(zu, { tooltipArgs: i }, o);
                    }
                };
                let Ju;
                !(function (u) {
                    ...
                    ({
                        ...
                        const s = {
                            ...
                            _ = d()(
                                ...
                                ue[`value__${t}`],
                                ue[`value__${r}`],
                                !F && ue[`value__notAvailable__${t}`],
                                null == A ? void 0 : A.value,
                            ),
                            D = {
                                [re.Left]: a().createElement(
                                    a().Fragment,
                                    null,
                                    a().createElement('div', {
                                        className: d()(
                                    ...
                                    a().createElement(pu, {
                                        text: F
                                            ? a().createElement(Ou, { format: 'integral', value: Number(u) })
                                            : ee.currency.notAvailable(),
                                        className: _,
                                    }),
                                ),
                                [re.Right]: a().createElement(
                                    a().Fragment,
                                    null,
                                    a().createElement(pu, {
                                        text: F
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                {
                                    className: d()(ue.base, null == A ? void 0 : A.base),
                                    onClick: () => {
                                        (n && P.playClick(), o && o());
                                    },
                                    onMouseEnter: () => {
                                ...
                                a().createElement(
                                    'div',
                                    { className: d()(ue.container, null == A ? void 0 : A.container) },
                                    D[e],
                                ),
                            ),
                        );
                ...
                const Ee = (u) => (0 === u ? window : window.subViews.get(u)),
                    Ae = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: n, children: o, mocks: E }) {
                                const A = (0, r.useRef)([]),
                                    l = (u, t, r) => {
                                        var a;
                                        const n = (function ({
                                            ...
                                            s = { mode: u, model: F, externalModel: o, cleanup: l };
                                        return {
                                            model: F,
                                    ...
                                    _ = s[0],
                                    D = s[1],
                                    c = (0, r.useState)(() => l(u, n, E)),
                                    m = c[0],
                                    B = c[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        F.current ? B(l(_, n, E)) : (F.current = !0);
                                    }, [E, _, n]),
                                    (0, r.useEffect)(() => {
                                        D(u);
                                    }, [u]),
                    ...
                    De = R.strings.ny.customizationLevelUpView,
                    ce = (0, Su.Pi)(() => {
                        const u = Fe(),
                            e = u.model,
                            t = u.controls,
                            n = e.root.get(),
                            i = n.currencyCount,
                            o = n.customizationZone,
                            E = n.currencyType,
                            A = n.atmospherePoints,
                            l = (0, r.useCallback)(() => {
                                t.onClose();
                            }, [t]),
                            F = (0, r.useCallback)(() => {
                                (t.onLevelUp(), N(R.sounds.hangar_newyear_level_up()));
                            }, [t]);
                        var s, _;
                        return (
                            (s = () => l()),
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { className: se.coverWrapper },
                                    a().createElement(
                                        'div',
                                        { className: se.cover },
                                        a().createElement('div', { className: se.background }),
                                        a().createElement(
                                            'div',
                                            ...
                                            a().createElement(pu, {
                                                ...
                                                format: {
                                                    binding: {
                                                        customizationZone: De.customizationZone.$dyn(
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: se.footerTextWrapper },
                                        a().createElement(pu, { className: se.footerText, text: De.info() }),
                                        a().createElement(ae, {
                                            value: i,
                                            type: E.value,
                                            size: te.Medium,
                                            classNames: { base: se.currencyBlock },
                                            tooltipConfig:
                                                ((_ = E.value),
                                                { contentId: _e.NyCurrencyTooltip('resId'), args: { currency: _ } }),
                                            iconPosition: re.Right,
                                        }),
                                    ),
                                    a().createElement(
                                        'div',
                                        { className: se.buttonHolder },
                                        a().createElement(
                                            j,
                                            { type: W.primary, size: G.medium, onClick: F, mixClass: se.button },
                                            De.confirm(),
                                        ),
                                        a().createElement(
                                            j,
                                            { type: W.secondary, size: G.medium, onClick: l, mixClass: se.button },
                                            De.cancel(),
                                        ),
                                    ),
                                ),
                ...
                engine.whenReady.then(() => {
                    k().render(
                        a().createElement(le, null, a().createElement(O, null, a().createElement(ce, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(8254));
