(() => {
    var __webpack_modules__ = {
            ...
            4179: (e, u, t) => {
                'use strict';
                t.d(u, { B3: () => c, Z5: () => o, B0: () => l, ry: () => B, Eu: () => g });
                class r {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            107: (e, u, t) => {
                ...
                const S = {
                    ...
                    L = (e) => {
                        ...
                        const n = f(),
                            ...
                            i = n.mediaHeight,
                            l = n.mediaSize;
                        return a().createElement('div', y({ className: B()(t, S[o], T[i], M[l]) }, r), u);
                    },
                    k = ['children'],
                    N = (e) => {
                        let u = e.children,
                ...
                class z extends a().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            A = B()(U.base, U[`base__${o}`], U[`base__${n}`], null == i ? void 0 : i.base),
                            m = B()(U.icon, U[`icon__${o}`], U[`icon__${n}`], null == i ? void 0 : i.icon),
                        ...
                        let u = e.className,
                            ...
                            f =
                                void 0 === w
                                    ...
                                    : w,
                            x = e.alignItems,
                            y = void 0 === x ? (g ? 'flex-start' : v && 'center') || (p && 'flex-end') || void 0 : x,
                            S = e.alignSelf,
                            T = e.wrap,
                            M = e.flexWrap,
                ...
                const he = Object.keys(Be()),
                            ...
                            pe(
                                {
                                    ...
                                    style: v,
                                    mt: !0 === s ? xe[t || 'paragraph-P16'].mt : s,
                    ...
                    Me = (0, n.memo)(({ number: e, classNames: u }) => {
                        const t = (0, n.useState)(800),
                            ...
                            E = c[0],
                            _ = c[1],
                            A = B()('AnimatedNumberCounter_base_2c', null == u ? void 0 : u.base);
                        return (
                            Te(
                                () => {
                                    s(l <= e - 12 ? l + 2 : l + 1);
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Re(t, m, { isMouseEvent: !0, on: !0, arguments: Oe(r) }, h),
                                    B && B(),
                ...
                const Qe = (e) => {
                    ...
                    switch (t) {
                        ...
                        default:
                            return a().createElement(Ve, { tooltipArgs: o }, i);
                    }
                };
                let Je;
                !(function (e) {
                    ...
                    lu = ({
                        ...
                        const v = (0, n.useCallback)(
                            ...
                            p = (0, n.useCallback)(
                                (e) => {
                                    (e.preventDefault(),
                                        0 === e.button && v(e) && (D(!0), m({ x: e.clientX, y: e.clientY })));
                                },
                                [v, D],
                            ),
                            h = (0, n.useCallback)(
                                (e) => {
                                    if ((e.preventDefault(), F)) {
                                        if (!v(e)) return;
                                        const t = e.clientX !== A.x ? e.clientX - A.x : 0,
                                            r = e.clientY !== A.y ? e.clientY - A.y : 0;
                                        (m({ x: e.clientX, y: e.clientY }), u({ dx: t, dy: r, dz: 0 }));
                                    }
                                },
                                [v, F, A.x, A.y, u],
                            ),
                ...
                ((pu.defaultProps = { type: Cu.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' }),
                    ...
                    (Lu.NUMBER = 'number'),
                    (Lu.STRING = 'string'),
                    ((Mu = xu || (xu = {})).BATTLE_BOOSTER = 'battleBooster'),
                    ...
                    ((Tu = Su || (Su = {})).BATTLE_BOOSTER = 'battleBooster'),
                        ...
                        (0, n.useEffect)(() => {
                            ...
                            const s = ((e, u) => {
                                ...
                                A = setInterval(() => {
                                    const e = E(),
                                        u = s[e];
                                    (i(s[e]), l(e, u), e === n && (C(), m || clearInterval(A)));
                                }, c);
                ...
                var Yu, $u;
                ((($u = Yu || (Yu = {}))[($u.Left = 0)] = 'Left'),
                    ($u[($u.Right = 1)] = 'Right'),
                    ($u[($u.Top = 2)] = 'Top'),
                    ($u[($u.Bottom = 3)] = 'Bottom'));
                const qu = ['__left', '__right', '__top', '__bottom'];
                ((0, n.forwardRef)(
                        ...
                        ((e, u) => {
                            ...
                            return [
                                function ({ mode: e = 'real', options: o, children: i, mocks: l }) {
                                            ...
                                            const o = (function ({
                                                ...
                                                E = (({ observableModel: e }) => {
                                                    const u = Object.assign({}, e.primitives(['animationCurrency']), {
                                                        ...
                                                        r = (0, mu.Om)(() => t(u.currencyPanelItems.get()), {
                                                            equals: cu,
                                                        });
                                    ...
                                    return (
                                        (0, n.useEffect)(() => {
                                            E.current ? D(c(A, o, l)) : (E.current = !0);
                                        }, [l, A, o]),
                                        (0, n.useEffect)(() => {
                                            m(e);
                                        }, [e]),
                ...
                const lt = (0, n.memo)(({ size: e = it.Small }) =>
                        a().createElement(
                            'div',
                            { className: B()(ot.base, ot[`base__${e}`]) },
                            a().createElement('div', { className: B()(ot.arrow, ot.arrow__1) }),
                            a().createElement('div', { className: B()(ot.arrow, ot.arrow__2) }),
                            a().createElement('div', { className: B()(ot.arrow, ot.arrow__3) }),
                        ),
                    ),
                    st = [
                        'children',
                ...
                const Et = (e, u, t = {}, r = 0) => {
                    ...
                    _t = (e) => {
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Et(t, m, { isMouseEvent: !0, on: !0, arguments: ct(r) }, h),
                                    B && B(),
                                    (p.current.isVisible = !0));
                            }, [t, m, r, h, B]),
                            w = (0, n.useCallback)(() => {
                    ...
                    dt = (0, n.memo)(
                        ({
                            ...
                            const E = (0, n.useState)(!1),
                                _ = E[0],
                                A = E[1],
                                m = f().mediaSize >= p.Medium ? Zu.Big : Zu.Small,
                                d = m === Zu.Big ? it.Large : it.Medium,
                                F = e < 5 && t >= r,
                                D = l && F,
                                C = l || s,
                                g = (0, n.useCallback)(() => {
                                    (A(!0), I(R.sounds.highlight()));
                                }, []),
                                v = (0, n.useCallback)(() => A(!1), []),
                                h = (0, n.useCallback)(() => {
                                    (o({ customizationZone: u }), I(R.sounds.tabb()));
                                }, [u, o]);
                            return a().createElement(
                                'div',
                                { className: B()(At.base, C && At.base__hovered, c && At.base__onboarding) },
                                a().createElement(
                                    'div',
                                    { className: B()(At.arrowAnimation, At[`arrowAnimation__${d}`]) },
                                    F && a().createElement(lt, { size: d }),
                                ),
                                a().createElement(
                                    'div',
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: At.zoneNameHeaer },
                                        a().createElement(Se, {
                                            text: mt.customizationZones.name.$dyn(u),
                                            className: B()(At.zoneName, At[`zoneName__${m}`]),
                                        }),
                                        a().createElement('div', {
                                            className: B()(At.zoneNameShadow, At[`zoneNameShadow__${m}`]),
                                        }),
                                    ),
                                    C &&
                                        a().createElement('div', {
                                            className: B()(At.textShine, At[`textShine__${m}`]),
                                        }),
                                    a().createElement('div', { className: At.interactiveZone, onClick: i }),
                                    a().createElement('div', {
                                        className: B()(At.interactiveZone, At.interactiveZone__horizontal),
                                        onClick: i,
                                    }),
                                    D
                                        ? a().createElement(
                                              ...
                                              a().createElement(
                                                  ...
                                                  a().createElement(
                                                      ...
                                                      a().createElement(Se, {
                                                          text: mt.customizationZones.markerLevelUp(),
                                              ...
                                              a().createElement(
                                                  'div',
                                                  { className: At.currency },
                                                  a().createElement(nu, {
                                                      value: r,
                                                      classNames: {
                                                          value: B()(At.currencyValue, At[`currencyValue__${m}`]),
                                                          icon: At.currencyIcon,
                                                      },
                                                      size: tu.Small,
                                                      iconPosition: ru.Right,
                                                  }),
                                                  a().createElement('div', { className: At.currencyEllipse }),
                                              ),
                                          )
                                        : a().createElement(
                                              'div',
                                              { className: At.levelBlock },
                                              a().createElement(Se, {
                                                  text:
                                                      ((b = e),
                                                      0 === b
                                                          ? mt.customizationZones.minLevel()
                                                          : 5 === b
                                                            ? mt.customizationZones.maxLevel()
                                                            : mt.customizationZones.markerLevel()),
                                                  className: B()(At.zoneLevel, At[`zoneLevel__${m}`]),
                                                  format: { binding: { level: e } },
                                              }),
                                              a().createElement('div', {
                                                  className: B()(At.zoneLevelShadow, At[`zoneLevelShadow__${m}`]),
                                              }),
                                          ),
                                ),
                                D
                                    ? a().createElement(
                                          'div',
                                          { className: At.shineBlock },
                                          a().createElement('div', {
                                              className: B()(At.bgEllipse1, At[`bgEllipse1__${m}`]),
                                          }),
                                          a().createElement('div', {
                                              className: B()(At.bgEllipse2, At[`bgEllipse2__${m}`]),
                                          }),
                                      )
                                    : a().createElement('div', { className: At.markerArrow }),
                            );
                            var b;
                        },
                    ),
                    Ft = 'Marker',
                    Dt = 'firMarker',
                    Ct = R.strings.ny.onboardingView,
                    Bt = (0, q.Pi)(() => {
                        const e = tt(),
                            u = e.model,
                            t = e.controls,
                            ...
                            c = l.posy,
                            E = l.currentLevel,
                            _ = l.customizationZone,
                            A = l.currencyCount,
                            m = l.levelUpCurrencyNeed,
                            d = l.isZoneHovered,
                            F = (0, n.useCallback)(() => {
                                (t.onHoverOutMarker({ markerName: _.value }),
                                    t.onLevelUp(),
                        ...
                        return a().createElement(
                            ...
                            a().createElement(Se, {
                                text: Ct.atmosphereTitle(),
                                className: 'DefaultViewContent_title_04',
                            }),
                            a().createElement(
                                'div',
                                {
                                    style: { left: `${s}rem`, top: `${c}rem` },
                    ...
                    wt = R.strings.ny.customizationZones,
                    ft = (e, u) => (0 === e ? wt.minLevel() : e === u ? wt.maxLevel() : wt.level()),
                    xt = (0, n.memo)(({ title: e, level: u, maxLevel: t }) =>
                        a().createElement(
                            Pe,
                            {
                ...
                const yt = 'LevelUpWidget_container_f9',
                    St = 'LevelUpWidget_divider_32',
                    Tt = 'LevelUpWidget_currencyValue_2c',
                    Mt = 'LevelUpWidget_currencyIcon_f0',
                    Lt = R.strings.ny.levelUpWidget;
                let kt;
                !(function (e) {
                ...
                const Nt = (0, n.memo)(
                        ({
                            ...
                            const l = t >= r,
                                s = (0, n.useState)(() => (l ? kt.LevelUp : kt.NotEnough)),
                                c = s[0],
                                E = s[1],
                                _ = (0, n.useState)(!1),
                                A = _[0],
                                ...
                                L = T.clear,
                                k = g + 1,
                                N = f().mediaSize >= p.Medium ? it.ExtraLarge : it.Large;
                            (0, n.useEffect)(
                                () => (
                                    F && b === e
                                        ? (m(!0),
                                          M(() => {
                                              (E(l ? kt.LevelUp : kt.NotEnough), m(!1), v(u), S(r), L());
                                          }, 2400))
                                        : (E(l ? kt.LevelUp : kt.NotEnough), v(u), S(r), w(e)),
                                    () => D(!1)
                                ),
                                [L, u, l, r, e, M],
                            );
                            const O = {
                                [kt.LevelUp]: a().createElement(
                                    'div',
                                    { className: B()(yt, 'LevelUpWidget_container__normal_65') },
                                    ...
                                    a().createElement(
                                        'div',
                                        {
                                            ...
                                            onClick: A
                                                ? void 0
                                                : () => {
                                                      (H.playClick(), i({ customizationZone: e }), D(!0));
                                                  },
                                            onMouseEnter: () => {
                                                H.playHighlight();
                                            },
                                ...
                                [kt.NotEnough]: a().createElement(
                                    'div',
                                    { className: B()(yt, 'LevelUpWidget_container__notEnough_92') },
                                    ...
                                    a().createElement('div', { className: B()(St, 'LevelUpWidget_divider__large_34') }),
                                ),
                            };
                            return a().createElement(
                                Pe,
                    ...
                    Rt = R.strings.ny.onboardingView,
                    Pt = (0, q.Pi)(() => {
                        const e = tt(),
                            u = e.controls,
                            t = e.model,
                            ...
                            b = h[0],
                            w = h[1],
                            f = (0, n.useMemo)(() => (c ? [Rt.close(), u.close] : [Rt.back(), u.close]), [c, u.close]),
                            x = f[0],
                            y = f[1],
                            S = !v && _ && i !== nt.PANORAMA;
                        var T;
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(107));
