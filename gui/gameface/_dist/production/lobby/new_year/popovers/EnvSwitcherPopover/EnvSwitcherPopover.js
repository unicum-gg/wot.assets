(() => {
    var __webpack_modules__ = {
                        ...
                        const f = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            S = (0, a.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (E(t, B, { isMouseEvent: !0, on: !0, arguments: o(n) }, x),
                                    p && p(),
                            ...
                            L = (0, a.useCallback)((u) => {
                                f.current.isVisible &&
                                    ...
                                    (f.current.hideTimerId = window.setTimeout(() => {
                                        ...
                                        e && !e.isSameNode(f.current.prevTarget) && M();
                                    }, 200)));
                            }, []);
                        return (
                            (0, a.useEffect)(() => {
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((f.current.timeoutId = window.setTimeout(S, c ? 100 : 400)),
                                                          A && A(u),
                                                          y && y(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                                                  (M(), null == F || F(e), null == u || u(e));
                                              })(e.props.onMouseLeave),
                                              onClick: ((u) => (e) => {
                                                  (!1 === d && M(), null == s || s(e), null == u || u(e));
                                              })(e.props.onClick),
                                              onMouseDown: ((u) => (e) => {
                                                  (!1 === d && M(), null == l || l(e), null == u || u(e));
                                              })(e.props.onMouseDown),
                                          },
                                          b,
                                      ),
            ...
            4179: (u, e, t) => {
                ...
                const b = n.instance,
                    f = {
                        ...
                        sendMoveEvent: (u) => v(E.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: g,
                        sendClosePopOverEvent: () => v(E.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, t = 0) => {
                            v(E.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                        },
            ...
            3509: (u, e, t) => {
                ...
                const F = R.views.common.tooltip_window.simple_tooltip_content,
                    l = (u) => {
                        ...
                        const c = (0, i.useMemo)(() => {
                            const u = Object.assign({}, s, { body: t, header: r, note: n, alert: l });
                            ...
                            A(
                                {
                                    contentId:
                                        ...
                                        _ ? F.SimpleTooltipHtmlContent('resId') : F.SimpleTooltipContent('resId')),
                ...
                (0, i.forwardRef)(
                    ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: r = {} }, a) => {
                        const E = (0, i.useRef)(null),
                            A = (0, i.useRef)(null),
                            F = (0, i.useRef)(null),
                            C = (0, i.useState)(window.decorator && window.decorator.directionType),
                            v = C[0],
                            g = C[1],
                            p = (0, i.useCallback)(() => {
                                (d.$.playClick(), D.O.view.sendEvent.close());
                            }, []),
                            w = (0, i.useCallback)(() => {
                                d.$.playHighlight();
                            }, []),
                            b = n()(B.arrow, B[`arrow${h[v]}`]);
                        c(
                            () => (
                                D.O.client.events.mouse.enableOutside(),
                                D.O.client.events.mouse.down(([, u]) => {
                                    'outside' === u && (t ? t() : D.O.view.sendEvent.close('popover'));
                                })
                            ),
                        );
                        const f = (0, i.useCallback)(
                                (u) => {
                                    let e = u.target;
                                    do {
                                        if (e === E.current || e === F.current) return;
                                        e = e.parentNode;
                                    } while (e);
                                    const r = window.decorator;
                                    if (void 0 !== window.decorator) {
                                        const u = D.O.client.getMouseGlobalPosition(),
                                    ...
                                    t ? t() : D.O.view.sendEvent.close('popover');
                                },
                                [E, F, t],
                            ),
                            x = (0, i.useCallback)(
                                () => (
                                    ...
                                    s(() => {
                                        if (A.current) {
                                            const u = A.current.scrollWidth,
                                                e = A.current.scrollHeight;
                                            (D.O.view.resize(u, e), g(window.decorator.directionType));
                                        }
                                    })
                                ),
                                [],
                        ...
                        return (
                            (0, i.useImperativeHandle)(a, () => ({ updateSize: x })),
                            c(() => {
                            ...
                            o().createElement(
                                'div',
                                { className: B.base, ref: A },
                                o().createElement(
                                    'div',
                                    { className: B.decorator },
                                    o().createElement(
                                        'div',
                                        { className: B.content, ref: E },
                                        u,
                                        window.decorator &&
                                    ...
                                    o().createElement('div', { className: b, style: r.arrow }),
                                ),
                            )
                        );
                    },
                ...
                const p = (0, i.memo)(
                                ...
                                o().createElement(
                                    ...
                                    o().createElement('div', {
                                        className: n()(
                                            ...
                                            A && 'PopoverCloseButton_hover__visible_27',
                                        ),
                                    }),
                                    o().createElement('div', {
                                        className: n()(
                                            'PopoverCloseButton_pressed_7c',
                                            s && 'PopoverCloseButton_pressed__visible_18',
                                        ),
                                    }),
                                ),
                            );
                    ...
                    w = (0, i.memo)(({ children: u }) =>
                        o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement('div', { className: 'TooltipAndPopoverStyleWrapper_snowIcon_d7' }),
                            ),
                            o().createElement('div', { className: 'TooltipAndPopoverStyleWrapper_pattern_f6' }),
                            o().createElement('div', { className: 'TooltipAndPopoverStyleWrapper_content_8a' }, u),
                        ),
                    ),
                    b = {
                    ...
                    f = ['__left', '__right', '__top', '__bottom'],
                    x = (0, i.forwardRef)(
                        (
                            ...
                            const d = (0, i.useRef)(null),
                                B = (0, i.useRef)(null),
                                h = (0, i.useState)(window.decorator.directionType),
                                x = h[0],
                                S = h[1];
                            !(function ({
                                key: u = g.n.ESCAPE,
                                callback: e = () => D.O.view.sendEvent.close(),
                                preventPropagation: t = !0,
                            } = {}) {
                                (0, v.gd)(u, e, t);
                            })();
                            const M = n()(b.arrow, b[`arrow${f[x]}`], r.arrow),
                                L = {
                                    top: null != (E = t.top) ? E : 10,
                                    bottom: (null != (A = t.bottom) ? A : x === C.Top) ? 65 : 0,
                                    left: (null != (F = t.left) ? F : x === C.Right) ? 65 : 0,
                                    right: null != (l = t.right) ? l : 0,
                                },
                                y = (0, i.useCallback)(
                                    () => (
                                        D.O.view.freezeTextureBeforeResize(),
                                        s(() => {
                                            if (B.current) {
                                                ...
                                                (D.O.view.resize(u, e), S(window.decorator.directionType));
                                            }
                                        })
                                    ),
                                    [],
                                );
                            ((0, i.useImperativeHandle)(a, () => ({ updateSize: y })),
                                c(() => {
                                    D.O.view.setSidePaddingsRem(L);
                                }),
                                (0, i.useEffect)(() => {
                                    const u = _((0, m.Eu)());
                                    return (
                            ...
                            const T = {
                                '--offset-top': `${L.top}rem`,
                                '--offset-bottom': `${L.bottom}rem`,
                                '--offset-left': `${L.left}rem`,
                                '--offset-right': `${L.right}rem`,
                            };
                            return o().createElement(
                                'div',
                                { style: T, className: b.base, ref: B },
                                o().createElement(
                                    'div',
                                        ...
                                        o().createElement(
                                            ...
                                            window.decorator.isCloseBtnVisible &&
                                                o().createElement(
                                                    ...
                                                    o().createElement(p, {
                                                        onClick: () => {
                                                            D.O.view.sendEvent.close('popover');
                                                        },
                                                    }),
                                                ),
                                        ),
            ...
            8331: (u, e, t) => {
                ...
                const F = i.O.client.getSize('rem'),
                    l = F.width,
                    s = F.height,
                    D = Object.assign({ width: l, height: s }, A(l, s, o)),
                    ...
                    d = (u) => {
                        ...
                        const n = (0, r.useContext)(c),
                            ...
                            p = { extraLarge: B, large: C, medium: h, small: v, extraSmall: g };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && l) return a(e, t, p);
                            if (t.largeWidth && s) return a(e, t, p);
                            if (t.mediumWidth && D) return a(e, t, p);
                            if (t.smallWidth && d) return a(e, t, p);
                            if (t.extraSmallWidth && m) return a(e, t, p);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                ...
                const m = (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(c),
                        ...
                        F = (0, r.useCallback)((u, e) => {
                            ...
                            E(Object.assign({ width: t, height: r }, A(t, r, o)));
                        }, []);
                    (((u) => {
                ...
                const S = {
                    ...
                    L = {
                        [g.ExtraSmall]: '',
                        [g.Small]: v().SMALL,
                        [g.Medium]: `${v().SMALL} ${v().MEDIUM}`,
                        [g.Large]: `${v().SMALL} ${v().MEDIUM} ${v().LARGE}`,
                        [g.ExtraLarge]: `${v().SMALL} ${v().MEDIUM} ${v().LARGE} ${v().EXTRA_LARGE}`,
                    },
                    y = (u) => {
                        let e = u.children,
                            t = u.className,
                        ...
                        const a = b(),
                            ...
                            o = a.mediaHeight,
                            E = a.mediaSize;
                        return n().createElement('div', x({ className: C()(t, S[i], M[o], L[E]) }, r), e);
                    },
                    T = ['children'],
                    O = (u) => {
                        let e = u.children,
                ...
                const I = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    G = [g.ExtraLarge, g.Large, g.Medium, g.Small, g.ExtraSmall],
                    U = (u, e) =>
                ...
                const V = {
                    ...
                    Y = j((u) => {
                        let e = u.className,
                            ...
                            f =
                                void 0 === b
                                    ...
                                    : b,
                            x = u.alignItems,
                            S = void 0 === x ? (h ? 'flex-start' : v && 'center') || (g && 'flex-end') || void 0 : x,
                            M = u.alignSelf,
                            L = u.wrap,
                            y = u.flexWrap,
                            ...
                            R = u.shrink,
                            P = u.flex,
                            H = void 0 === P ? (O || R ? `${O ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : P,
                            N = u.style,
                            k = u.children,
                            I = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, E, F, s, c, N, H, M, B, T, f, S]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return n().createElement('div', z({ className: C()(X.base, ...U, e), style: G }, I), k);
                    });
                let Z;
                !(function (u) {
                ...
                const Q = (u, e, t) => {
                    ...
                    uu = (u, e, t = Z.left) => u.split(e).reduce(t === Z.left ? Q : J, []),
                    eu = (() => {
                        const u = new RegExp(
                    ...
                    ru = ({ binding: u, text: e = '', classMix: t, alignment: a = Z.left }) =>
                        null === e
                ...
                const Au = Object.keys(au()),
                    ...
                    _u = j((u) => {
                        ...
                        return n().createElement(
                            ...
                            Eu(
                                {
                                    className: C()(iu.base, t && iu[t], g, a),
                                    style: v,
                                    mt: !0 === A ? Du[t || 'paragraph-P16'].mt : A,
                                    mr: !0 === l ? Du[t || 'paragraph-P16'].mr : l,
                                    mb: !0 === D ? Du[t || 'paragraph-P16'].mb : D,
                                    ml: !0 === _ ? Du[t || 'paragraph-P16'].ml : _,
                                },
                                B,
                            ),
                            void 0 !== m ? n().createElement(ru, Eu({}, m, { text: e })) : e,
                        );
                    });
                var du = t(3282),
                    mu = t(3509),
                ...
                let Cu;
                !(function (u) {
                    ((u.Day = 'Day'), (u.Auto = 'Auto'), (u.Night = 'Night'));
                })(Cu || (Cu = {}));
                var hu = t(7727);
                const vu = {
                    ...
                    gu = R.strings.ny.environmentSwitcher,
                    pu = Object.values(Cu),
                    wu = (0, r.memo)(({ arrowDegree: u, state: e, mode: t, handleClick: a }) => {
                        const i = (0, r.useState)(null),
                            o = i[0],
                            E = i[1],
                            A = () => {
                                E(null);
                        ...
                        return n().createElement(
                            'div',
                            { className: C()(vu.base, vu[`base__${e}`]) },
                            n().createElement('div', {
                                className: C()(
                                    vu.activeBackground,
                                    vu.activeBackground__night,
                                    e === Cu.Night && vu.activeBackground__visible,
                                ),
                            }),
                            n().createElement('div', {
                                className: C()(
                                    vu.activeBackground,
                                    vu.activeBackground__day,
                                    e === Cu.Day && vu.activeBackground__visible,
                                ),
                            }),
                            n().createElement('div', {
                                className: C()(
                                    vu.activeBackground,
                                    vu.activeBackground__auto,
                                    e === Cu.Auto && vu.activeBackground__visible,
                                ),
                            }),
                            n().createElement('div', { className: vu.activeBackgroundMask }),
                            n().createElement(_u, { className: vu.title, text: gu.$dyn(e) }),
                            n().createElement('div', {
                                className: C()(
                                    vu.environmentIcon,
                                    vu.environmentIcon__Day,
                                    e === Cu.Auto && vu.environmentIcon__visible,
                                ),
                            }),
                            n().createElement('div', {
                                className: C()(
                                    vu.environmentCircle,
                                    vu.environmentCircle__Day,
                                    e === Cu.Auto && t === Cu.Day && vu.environmentCircle__visible,
                                ),
                            }),
                            n().createElement('div', {
                                className: C()(
                                    vu.environmentIcon,
                                    vu.environmentIcon__Night,
                                    e === Cu.Auto && vu.environmentIcon__visible,
                                ),
                            }),
                            n().createElement('div', {
                                className: C()(
                                    vu.environmentCircle,
                                    vu.environmentCircle__Night,
                                    e === Cu.Auto && t === Cu.Night && vu.environmentCircle__visible,
                                ),
                            }),
                            n().createElement('div', { className: vu.arrow, style: { transform: `rotateZ(${u}deg)` } }),
                            n().createElement(
                                'div',
                                ...
                                pu.map((u) =>
                                    n().createElement(
                                        'div',
                                        { key: u, className: C()(vu.button, vu[`button__${u}`]) },
                                        n().createElement('div', {
                                            className: C()(
                                                vu.buttonHover,
                                                o === u && u !== e && vu.buttonHover__visible,
                                            ),
                                        }),
                                        n().createElement('div', {
                                            className: C()(vu.buttonActive, u === e && vu.buttonActive__visible),
                                        }),
                                        n().createElement('div', { className: C()(vu.icon, vu[`icon__${u}`]) }),
                                        n().createElement(
                                            'div',
                                            { className: vu.activeZoneContainer },
                                            n().createElement(
                                                Bu.u,
                                                {
                                                    contentId:
                                                    ...
                                                    args: {
                                                        header: u === Cu.Auto ? gu.tooltip.title.auto() : '',
                                                        description: gu.tooltip.description.$dyn(u),
                                                    },
                                                },
                                                n().createElement('div', {
                                                    className: C()(vu.activeZone, u === t && vu.activeZone__selected),
                                                    onMouseEnter: () =>
                                                        ((u) => {
                                                            o !== u && (hu.$.playHighlight(), E(u));
                                                        })(u),
                                                    onMouseLeave: A,
                                                    onClick: () =>
                                                        ((u) => {
                                                            u !== e &&
                                                                (hu.$.playClick(),
                                                                u === Cu.Auto &&
                                                                    (0, hu.G)(R.sounds.hangar_newyear_auto_choice()),
                                                                a({ type: u }));
                                                        })(u),
                                                }),
                                            ),
                    ...
                    Mu = (u) => {
                        return null !== u && 'object' == typeof u
                            ? 'CoherentArrayProxy' === u.constructor.name
                                ? ((e = u),
                                  (t = (u) => ('object' == typeof u ? Mu(u) : u)),
                                  Array.isArray(e) ? e.map(t) : e.map((u, e, r) => t(null == u ? void 0 : u.value)))
                                : Array.isArray(u)
                                  ? u.map((u) => ('object' == typeof u ? Mu(u) : u))
                                  : Object.fromEntries(
                                        Object.entries(u).map(([u, e]) => [u, 'object' == typeof e ? Mu(e) : e]),
                                    )
                            : u;
                        var e, t;
                    };
                ...
                const yu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: a, children: o, mocks: E }) {
                                const A = (0, r.useRef)([]),
                                    F = (u, t, r) => {
                                        var n;
                                        const a = (function ({
                                            ...
                                            l = (({ observableModel: u }) => {
                                                const e = {
                                                        root: u.object(),
                                                        switcherComponent: u.object('switcherComponent'),
                                                    },
                                                    t = (0, Lu.computedFn)(
                                                        () => {
                                                            return ((u = e.switcherComponent.get()), Mu(u));
                                                            var u;
                                                        },
                                                        { equals: bu },
                                                    );
                                                return Object.assign({}, e, { computes: { getSwitcherComponent: t } });
                                            })({
                                                mode: u,
                                                readByPath: E,
                                                externalModel: o,
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : E(e),
                                                            n = fu.observable.box(r, { equals: bu });
                                                        return (
                                                            'real' === u &&
                                                                o.subscribe(
                                                                    (0, fu.action)((u) => n.set(u)),
                                                                    e,
                                                                ),
                                                            n
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const n = e.reduce(
                                                                (u, e) => ((u[e] = fu.observable.box(r[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                                            ...
                                            s = { mode: u, model: l, externalModel: o, cleanup: F };
                                        return {
                                            model: l,
                                    ...
                                    D = s[0],
                                    c = s[1],
                                    _ = (0, r.useState)(() => F(u, a, E)),
                                    d = _[0],
                                    m = _[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? m(F(D, a, E)) : (l.current = !0);
                                    }, [E, D, a]),
                                    (0, r.useEffect)(() => {
                                        c(u);
                                    }, [u]),
                        ...
                        onEnvironmentSwitch: u.createCallback(
                            ({ type: u }) => ({ type: u }),
                            'switcherComponent.onSwitch',
                        ),
                    })),
                    Tu = yu[0],
                    Ou = yu[1];
                ...
                const Pu = (0, du.observer)(() => {
                    const u = Ou(),
                        e = u.controls,
                        t = u.model,
                        r = t.computes.getSwitcherComponent(),
                        a = t.root.get().isInHangar;
                    return n().createElement(
                        mu.t,
                        { classNames: a ? {} : { arrow: 'App_popoverArrowClassname_13' } },
                        n().createElement(
                            'div',
                            { className: 'App_base_a5' },
                            n().createElement(
                                'div',
                                { className: 'App_header_c9' },
                                n().createElement(_u, {
                                    className: 'App_title_ad',
                                    text: R.strings.ny.environmentSwitcherPopover.title(),
                                }),
                            ),
                            n().createElement(
                                'div',
                                { className: 'App_body_80' },
                                n().createElement(wu, Ru({}, r, { handleClick: e.onEnvironmentSwitch })),
                            ),
                        ),
                    );
                });
                engine.whenReady.then(() => {
                    H().render(
                        n().createElement(Tu, null, n().createElement(O, null, n().createElement(Pu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(8331));
