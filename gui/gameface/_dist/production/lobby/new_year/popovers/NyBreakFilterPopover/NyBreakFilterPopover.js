(() => {
    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                t.d(e, { Sw: () => r.Z, B0: () => E, ry: () => m, Eu: () => v, Sy: () => p });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            4707: (u, e, t) => {
                ...
                const l = (u, e, t = {}, n = 0) => {
                    ...
                    D = (u) => {
                        ...
                        const y = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            f = (0, n.useMemo)(() => p || A().resId, [p]),
                            T = (0, n.useCallback)(() => {
                                (y.current.isVisible && y.current.timeoutId) ||
                                    (l(t, C, { isMouseEvent: !0, on: !0, arguments: c(o) }, f),
                                    b && b(),
                            ...
                            O = (0, n.useCallback)((u) => {
                                y.current.isVisible &&
                                    ...
                                    (y.current.hideTimerId = window.setTimeout(() => {
                                        ...
                                        e && !e.isSameNode(y.current.prevTarget) && k();
                                    }, 200)));
                            }, []);
                        return (
                            (0, n.useEffect)(() => {
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((y.current.timeoutId = window.setTimeout(T, D ? 100 : 400)),
                                                          r && r(u),
                                                          M && M(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                    ...
                    y = (0, n.forwardRef)(
                        ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: r = {} }, i) => {
                            const a = (0, n.useRef)(null),
                                ...
                                B = E()(b.arrow, b[`arrow${g[l]}`]);
                            v(
                                () => (
                                    m.O.client.events.mouse.enableOutside(),
                                    m.O.client.events.mouse.down(([, u]) => {
                                        'outside' === u && (t ? t() : m.O.view.sendEvent.close('popover'));
                                    })
                                ),
                            );
                            const w = (0, n.useCallback)(
                                    (u) => {
                                        ...
                                        if (void 0 !== window.decorator) {
                                            const u = m.O.client.getMouseGlobalPosition(),
                            ...
                            return (
                                (0, n.useImperativeHandle)(i, () => ({ updateSize: h })),
                                v(() => {
                    ...
                    return (
                        ((u) => {
                            ...
                            if (
                                                ...
                                                const e = A(),
                                                    ...
                                                    o =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: o, modelPath: L(o, ''), resId: n };
                                            })(),
                                            t = e.modelPrefix,
                                            n = u.split('.');
                                        if (n.length > 0) {
                                ...
                                l.current = x.addCallback(n, t, a, e === I.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== I.None)
                                return () => {
                                    x.removeCallback(l.current, a);
                                };
                        }, [a, e]),
                        s
                    );
                ...
                const K = () => {},
                    G = o().memo(
                        ({
                            ...
                            className: e,
                            children: t,
                            toggleType: r = j.Button,
                            toggleButtonType: i = V.secondary,
                            onClick: a,
                            disabled: A,
                            soundClick: F = 'play',
                            ...
                            const _ = (0, n.useCallback)(
                                ...
                                C = (0, n.useCallback)(
                                    (u) => {
                                        A || ((1 !== u.button && 2 !== u.button) || (null !== F && w(F)), l && l(u));
                                    },
                                    [l, A, F],
                                ),
                                m = E()(W.base, e, W[`base__${r}`], u && W.base__active, A && W.base__disabled);
                            return o().createElement(
                                'div',
                                {
                                    className: m,
                                ...
                                o().createElement('div', { className: W.content }, t),
                                r === j.Button &&
                                    o().createElement(
                                        o().Fragment,
                                        null,
                                        o().createElement('div', {
                                            className: E()(W.background, W[`background__${i}`]),
                                        }),
                                        o().createElement('div', { className: W.texture }),
                                    ),
                                o().createElement('div', { className: W.overlay }),
                                o().createElement('div', { className: W.indicator }),
                            );
                        },
                    ),
                    Y = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    q = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3],
                    z = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    $ = ({ iconUrl: u }) => {
                        const e = { backgroundImage: `url(${u})` };
                        return o().createElement('div', { className: 'ButtonIcon_base_74', style: e });
                    },
                    X = ({ label: u, isMini: e }) =>
                        o().createElement(
                            'div',
                            { className: E()('ButtonLabel_base_85', e && 'ButtonLabel_base__mini_f6') },
                            Boolean(Number(u)) && o().createElement('div', { className: 'ButtonLabel_plus_31' }, '+'),
                            u,
                        ),
                    Z = 'FilterButton_base_7f',
                    Q = (0, n.memo)(({ index: u, label: e, isSelected: t, sectionType: r, onClick: i }) => {
                        const a = (0, n.useCallback)(() => i(u), [i, u]);
                        switch (r) {
                            case uu.ToyRanks:
                                return o().createElement(
                                    G,
                                    { active: t, className: E()(Z, 'FilterButton_base__mini_8c'), onClick: a },
                                    o().createElement(X, {
                                        label:
                                            ((A = e),
                                            z
                            ...
                            case uu.Collections:
                                return o().createElement(
                                    C,
                                    { body: R.strings.ny.settings.$dyn(e) },
                                    o().createElement(
                                        G,
                                        { active: t, className: Z, onClick: a },
                                        o().createElement($, {
                                            iconUrl:
                                                R.images.new_year.gui.maps.icons.newYear.collection_types.filter.$dyn(
                                                    e,
                                                ),
                                        }),
                                    ),
                            ...
                            case uu.ToyTypes:
                                return o().createElement(
                                    C,
                                    { body: R.strings.ny.decorationTypes.$dyn(e) },
                                    o().createElement(
                                        G,
                                        { active: t, className: Z, onClick: a },
                                        o().createElement($, {
                                            iconUrl:
                                                R.images.new_year.gui.maps.icons.newYear.decoration_types.common.$dyn(
                                                    e,
                                                ),
                                        }),
                                    ),
                ...
                let uu;
                !(function (u) {
                    ((u.Collections = 'collections'), (u.ToyRanks = 'ranks'), (u.ToyTypes = 'types'));
                })(uu || (uu = {}));
                const eu = ({ type: u = uu.ToyTypes, items: e, handleItemClick: t }) =>
                        o().createElement(
                            'div',
                            { className: 'ToyFilterSection_base_d6' },
                            o().createElement(
                                'div',
                                { className: 'ToyFilterSection_buttons_78' },
                                e.length &&
                                    e.map(({ value: e, id: n }, r) =>
                                        o().createElement(
                                            'div',
                                            {
                                                key: n,
                                                className: E()(
                                                    'ToyFilterSection_item_db',
                                                    u === uu.ToyRanks && 'ToyFilterSection_item__mini_5a',
                                                ),
                                            },
                                            o().createElement(
                                                Q,
                    ...
                    tu = () => {
                        const u = U().onCollectionTypeSelected,
                            e = U('model.collectionTypes'),
                            t = (0, n.useCallback)(
                                (e) => {
                                    u({ index: e });
                                },
                        ...
                        return o().createElement(
                            'div',
                            { className: 'CollectionTypesSection_base_0f' },
                            o().createElement(
                                'div',
                                { className: 'CollectionTypesSection_title_2f' },
                                R.strings.ny.breakFilterPopover.collections(),
                            ),
                            o().createElement(eu, { type: uu.Collections, items: e, handleItemClick: t }),
                        );
                    },
                    nu = () => {
                        const u = U().onToyRankSelected,
                            e = U('model.toyRanks'),
                            t = (0, n.useCallback)(
                                (e) => {
                                    u({ index: e });
                        ...
                        return o().createElement(
                            'div',
                            { className: 'ToyRanksSection_base_7f' },
                            o().createElement(
                                'div',
                                { className: 'ToyRanksSection_title_0b' },
                                R.strings.ny.breakFilterPopover.rank(),
                            ),
                            o().createElement(eu, { type: uu.ToyRanks, items: e, handleItemClick: t }),
                        );
                    },
                    ou = () => {
                        const u = U().onToyTypeSelected,
                            e = U('model.toyTypes'),
                            t = (0, n.useCallback)(
                                (e) => {
                                    u({ index: e });
                        ...
                        return o().createElement(
                            'div',
                            { className: 'ToyTypesSection_base_01' },
                            o().createElement(
                                'div',
                                { className: 'ToyTypesSection_title_80' },
                                R.strings.ny.breakFilterPopover.type(),
                            ),
                            o().createElement(eu, { items: e, handleItemClick: t }),
                        );
                    },
                    ru = 'App_section_9d',
                    iu = () => (
                        (function (u = f.n.ESCAPE) {
                            k(u, F.Sy, !0);
                        })(f.n.ESCAPE),
                        o().createElement(
                            y,
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    'div',
                                    { className: 'App_title_66' },
                                    R.strings.ny.breakFilterPopover.title(),
                                ),
                                o().createElement('div', { className: ru }, o().createElement(tu, null)),
                                o().createElement('div', { className: ru }, o().createElement(nu, null)),
                                o().createElement('div', { className: ru }, o().createElement(ou, null)),
                            ),
                        )
                    );
                engine.whenReady.then(() => {
                    i().render(o().createElement(iu, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(4707));
