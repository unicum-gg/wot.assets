(() => {
    var __webpack_modules__ = {
            ...
            4179: (e, u, t) => {
                'use strict';
                t.d(u, { kH: () => m, B3: () => c, Z5: () => s, lf: () => _, cy: () => o, B0: () => i, ry: () => g });
                class r {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            5520: (e, u, t) => {
                ...
                var n = {};
                (t.r(n), t.d(n, { Area: () => iu, Bar: () => au, Default: () => ou, useVerticalScrollApi: () => Qe }));
                var a = t(6179),
                    s = t.n(a);
                const o = (e, u, t) =>
                ...
                const _ = i.O.client.getSize('rem'),
                    m = _.width,
                    A = _.height,
                    d = Object.assign({ width: m, height: A }, E(m, A, l)),
                    ...
                    B = (e) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.largeWidth && _) return o(u, t, f);
                            if (t.mediumWidth && m) return o(u, t, f);
                            if (t.smallWidth && A) return o(u, t, f);
                            if (t.extraSmallWidth && d) return o(u, t, f);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                const M = {
                    ...
                    P = (e) => {
                        ...
                        const n = S(),
                            ...
                            o = n.mediaHeight,
                            i = n.mediaSize;
                        return s().createElement('div', x({ className: p()(t, M[a], y[o], L[i]) }, r), u);
                    },
                    O = ['children'],
                    N = (e) => {
                        let u = e.children,
                        ...
                        return s().createElement(g, null, s().createElement(P, t, u));
                    };
                var k = t(493),
                    I = t.n(k);
                function H(e) {
                ...
                class X extends s().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            m = p()(U.base, U[`base__${a}`], U[`base__${n}`], null == o ? void 0 : o.base),
                            A = p()(U.icon, U[`icon__${a}`], U[`icon__${n}`], null == o ? void 0 : o.icon),
                            d = p()(U.glow, null == o ? void 0 : o.glow),
                            F = p()(U.caption, U[`caption__${a}`], null == o ? void 0 : o.caption),
                            D = p()(U.goto, null == o ? void 0 : o.goto);
                        return s().createElement(
                            ...
                            s().createElement('div', { className: A }, s().createElement('div', { className: d })),
                ...
                const ae = [
                        ...
                        Q.GoldenTicket,
                        Q.PostStamp,
                        Q.BlankPersonalMissions_1,
                        Q.BlankPersonalMissions_2,
                        Q.SACoin,
                        Q.PremiumPlusUniversal,
                        Q.NyPetGoodies,
                        Q.HiddenVehicle,
                    ],
                    se = [Q.Gold, Q.Credits, Q.Crystal, Q.FreeXp, Q.NewYearToyFragments],
                    oe = [Q.BattlePassPoints],
                    ie = [Q.PremiumPlus, Q.Premium];
                let le;
                !(function (e) {
                    ((e.s16 = '16'),
                        (e.s32 = '32'),
                ...
                const pe = (e, u, t) => {
                    ...
                    fe = (e, u, t = ge.left) => e.split(u).reduce(t === ge.left ? pe : he, []),
                    ve = (() => {
                        const e = new RegExp(
                    ...
                    we = (e, u = J.Small, t) => {
                        const r = (e.vehicleName || '').replace(/-/g, '_');
                        if (e.name === Q.Vehicles)
                            switch (u) {
                                case J.Mini:
                                case J.Small:
                                case J.S48x48:
                                ...
                                case J.S128x100:
                                case J.S180x135:
                                    return `R.images.gui.maps.shop.vehicles.c_180x135.${r}`;
                                case J.S232x174:
                                case J.S296x222:
                                    return `R.images.gui.maps.shop.vehicles.c_360x270.${r}`;
                                case J.S400x300:
                                case J.S600x450:
                                    return `R.images.gui.maps.shop.vehicles.c_600x450.${r}`;
                                default:
                                    return (
                    ...
                    Se = ((e, u) => {
                                ...
                                const l = (0, a.useRef)([]),
                                    c = (e, t, r) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            E = (({ observableModel: e }) => {
                                                const u = { root: e.object(), stages: e.array('stages') },
                                                    t = (0, Be.computedFn)(
                                                        () => {
                                                            return ((e = u.stages.get()), De(e));
                                                            var e;
                                                        },
                                                        { equals: me },
                                                    ),
                                                    r = (0, Be.computedFn)(
                                                        (e, u, r = J.S180x135) => {
                                                            var n;
                                                            return (
                                                                null == (n = t()[u].tops.find((u) => u.top === e))
                                                                    ? void 0
                                                                    : n.rewards.items
                                                            ).map((u) => {
                                                                return Object.assign({}, u, {
                                                                    image: we(
                                                                        u,
                                                                        u.name === Q.BattleBadge ? J.S232x174 : r,
                                                                        e,
                                                                    ),
                                                                    valueType:
                                                                        ((t = u.name),
                                                    ...
                                                    n = (0, Be.computedFn)((e) => t()[e].tops.map((e) => e.top), {
                                                        equals: me,
                                                    }),
                                                    a = (0, Be.computedFn)(
                                                        (e, u) => n(u).filter((u) => 0 !== u && u > 25 && u >= e),
                                                        { equals: me },
                                                    ),
                                                    s = (0, Be.computedFn)(
                                                        (e, u) =>
                                                ...
                                                observableModel: {
                                                    array: (u, t) => {
                                                        const r = null != t ? t : o(u),
                                                            n = Ae.observable.box(r, { equals: me });
                                                        return (
                                                            'real' === e &&
                                                                s.subscribe(
                                                                    (0, Ae.action)((e) => n.set(e)),
                                                                    u,
                                                                ),
                                                            n
                                                        );
                                                    ...
                                                    primitives: (u, t) => {
                                                        ...
                                                        if (Array.isArray(u)) {
                                                            const n = u.reduce(
                                                                (e, u) => ((e[u] = Ae.observable.box(r[u], {})), e),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === e &&
                        ...
                        goToInfo: e.createCallbackNoArgs('onInfoClick'),
                        previewClick: e.createCallback(({ vehicleCD: e }) => ({ vehicleCD: e }), 'onPreviewClick'),
                    })),
                    Te = Se[0],
                    xe = Se[1],
                    Re = (e) => {
                ...
                const Ie = {
                    ...
                    He = ({
                        ...
                        return (l = {}) => {
                            ...
                            return (0, a.useMemo)(
                                ...
                                [D.scrollPosition, C, p, b, A.off, A.on, v, h, B, E.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    Ge = He({
                    ...
                    ze = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Xe, onDrag: r = Ye }) => {
                                ...
                                ((t.style.transform = `translateX(${0 | _}px)`),
                                    ((e) => {
                                        if (o.current && i.current && l.current && c.current) {
                                            ...
                                            var u, t;
                                            (o.current.classList.remove(We), i.current.classList.remove(We));
                                        }
                                    })(_));
                            },
                            D = Le(() => {
                                ((() => {
                                    ...
                                    ((u.style.width = `${je(t, s)}px`),
                                        (u.style.display = 'flex'),
                                        n.current &&
                                            (1 === s ? n.current.classList.add(Ue) : n.current.classList.remove(Ue)));
                                })(),
                                    F());
                            });
                        ((0, a.useEffect)(() => Re(D)),
                            ...
                            (0, a.useEffect)(() => {
                                ...
                                const u = (u) => {
                                    ...
                                    t = () => {
                                        (window.removeEventListener('mousemove', u), d($e));
                                    };
                                return (
                        ...
                        const B = Pe((u) => e.applyStepTo(u), E, [e]),
                            g = B[0],
                            C = B[1];
                        (0, a.useEffect)(
                            () => (
                        ...
                        return s().createElement(
                            ...
                            s().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(We) || 0 !== e.button || (H('play'), g(ke.Next));
                                },
                                onMouseUp: C,
                                ref: o,
                                onMouseEnter: h,
                                        ...
                                        r &&
                                            ...
                                            u.target === r
                                                ...
                                                : ((u) => {
                                                  ...
                                                  })(u.screenX > r.getBoundingClientRect().x ? ke.Prev : ke.Next));
                                    },
                                    ref: l,
                                    onMouseEnter: h,
                                },
                                s().createElement('div', { ref: c, className: p()('HorizontalBar_thumb_fd', u.thumb) }),
                                s().createElement('div', { className: p()('HorizontalBar_rail_32', u.rail) }),
                            ),
                            s().createElement('div', {
                                className: p()('HorizontalBar_rightButton_03', u.rightButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(We) || 0 !== e.button || (H('play'), g(ke.Prev));
                                },
                                onMouseUp: C,
                                ref: i,
                                onMouseEnter: h,
                    ...
                    qe = ({
                        ...
                        const E = (0, a.useMemo)(() => {
                                const e = r || {};
                                return Object.assign({}, e, { base: p()(Ve.base, e.base) });
                            }, [r]),
                            _ = (0, a.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
                        return s().createElement(
                            'div',
                            { className: p()(Ve.defaultScroll, t), onWheel: u.handleMouseWheel },
                            s().createElement(
                                'div',
                                { className: p()(Ve.defaultScrollArea, n) },
                                s().createElement(Ke, { className: i, api: _, classNames: o }, e),
                            ),
                            s().createElement(ze, { getStepByRailClick: l, api: u, onDrag: c, classNames: E }),
                        );
                    },
                    Ke = ({ api: e, className: u, classNames: t, children: r, style: n }) => (
                        (0, a.useEffect)(() => Re(e.recalculateContent)),
                        s().createElement(
                            'div',
                            { className: p()(Ve.base, u), style: n },
                            s().createElement(
                                'div',
                                {
                                    className: p()(Ve.wrapper, null == t ? void 0 : t.wrapper),
                                    onWheel: e.handleMouseWheel,
                                    ref: e.wrapperRef,
                                },
                                s().createElement(
                                    'div',
                                    { className: p()(Ve.content, null == t ? void 0 : t.content), ref: e.contentRef },
                                    r,
                                ),
                            ),
                        )
                ...
                ((Ke.Bar = ze),
                    ...
                    (Ke.SeniorityAwards = ({ api: e, className: u, classNames: t, children: r }) => (
                        ...
                        s().createElement(
                            'div',
                            { className: p()(Ve.base, u) },
                            s().createElement(
                                'div',
                                { className: p()(Ve.wrapper, null == t ? void 0 : t.wrapper), ref: e.wrapperRef },
                                s().createElement(
                                    'div',
                                    { className: p()(Ve.content, null == t ? void 0 : t.content), ref: e.contentRef },
                                    r,
                ...
                const Qe = He({
                    ...
                    au = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = tu, onDrag: r = eu }) => {
                        const n = (0, a.useRef)(null),
                            o = (0, a.useRef)(null),
                            i = (0, a.useRef)(null),
                            l = (0, a.useRef)(null),
                            ...
                            F = Le(() => {
                                ...
                                return (
                                    ...
                                    n.current &&
                                        (1 === s ? n.current.classList.add(Ze) : n.current.classList.remove(Ze)),
                                    s
                                );
                            }),
                            D = Le(() => {
                                ...
                                const a = e.animationScroll.scrollPosition.get(),
                                    s = Math.min(1, r / n),
                                    E = Me(0, 1, a / (n - r)),
                                    _ = (u.offsetHeight - nu(u, s)) * E;
                                ((t.style.transform = `translateY(${0 | _}px)`),
                                    ((e) => {
                                        if (o.current && i.current && l.current && c.current) {
                                            if (0 === e)
                                                return (
                                                    o.current.classList.add(Je),
                        ...
                        const g = Pe((u) => e.applyStepTo(u), E, [e]),
                            C = g[0],
                            h = g[1];
                        (0, a.useEffect)(
                            () => (
                        ...
                        return s().createElement(
                            ...
                            s().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Je) || 0 !== e.button || (H('play'), C(ke.Next));
                                },
                                ref: o,
                                onMouseEnter: f,
                            }),
                            s().createElement(
                                    ...
                                    onMouseDown: (u) => {
                                        ...
                                        r &&
                                            ...
                                            u.target === r
                                                ...
                                                : ((n = u.screenY > r.getBoundingClientRect().y ? ke.Prev : ke.Next),
                                                  c.current &&
                                                      ru(e, (u) => {
                                                          if (!u) return;
                                                          const r = t(e),
                                ...
                                s().createElement('div', { className: p()('VerticalBar_rail_43', u.rail) }),
                            ),
                            s().createElement('div', {
                                className: p()('VerticalBar_bottomButton_06', u.bottomButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Je) || 0 !== e.button || (H('play'), C(ke.Prev));
                                },
                                onMouseUp: h,
                                ref: i,
                                onMouseEnter: f,
                    ...
                    ou = ({
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                'div',
                                { className: p()(su.area, n) },
                                s().createElement(iu, { className: o, classNames: i, api: _ }, e),
                            ),
                            s().createElement(au, { getStepByRailClick: l, api: u, onDrag: c, classNames: E }),
                        );
                    },
                    iu = ({ className: e, classNames: u, children: t, api: r }) => (
                        (0, a.useEffect)(() => Re(r.recalculateContent)),
                        s().createElement(
                            'div',
                            { className: p()(su.base, e), ref: r.wrapperRef, onWheel: r.handleMouseWheel },
                            s().createElement(
                                'div',
                                { className: p()(su.content, null == u ? void 0 : u.content), ref: r.contentRef },
                                t,
                            ),
                        )
                    );
                iu.Default = ou;
                const lu = { Vertical: n, Horizontal: r };
                var cu = t(9887),
                    Eu = t.n(cu);
                const _u = ['xl', 'lg', 'md', 'sm', 'xs'],
                    mu = (e) => e.includes('_') && ((e) => _u.includes(e))(e.split('_').at(-1)),
                    Au = [v.ExtraLarge, v.Large, v.Medium, v.Small, v.ExtraSmall],
                    du = (e, u) =>
                        Object.keys(e).reduce((t, r) => {
                            ...
                            return (
                                void 0 === n ||
                                    ((e, u) => _u.some((t) => void 0 !== u[`${e}_${t}`]))(r, e) ||
                                    (t[r] = n),
                                t
                            );
                        }, {}),
                ...
                const Cu = {
                    ...
                    fu = Fu((e) => {
                        let u = e.className,
                            ...
                            w =
                                void 0 === b
                                    ...
                                    : b,
                            S = e.alignItems,
                            T = void 0 === S ? (g ? 'flex-start' : C && 'center') || (h && 'flex-end') || void 0 : S,
                            x = e.alignSelf,
                            R = e.wrap,
                            M = e.flexWrap,
                        ...
                        const G = (0, a.useMemo)(() => {
                            ...
                            }, [t, r, i, c, _, A, k, N, x, B, y, w, T]),
                            U = G.computedStyle,
                            W = G.computedClassNames;
                        return s().createElement('div', gu({ className: p()(Du.base, ...W, u), style: U }, H), I);
                    }),
                    vu = ({ binding: e, text: u = '', classMix: t, alignment: r = ge.left }) =>
                        null === u
                ...
                Object.keys(Eu());
                const Ru = Object.keys(wu()),
                    Mu = { mt: 'MD', mr: 'SM', mb: 'SM', ml: 'SM' },
                    ...
                    Nu = Fu((e) => {
                        ...
                        return s().createElement(
                            ...
                            xu(
                                {
                                    className: p()(Su.base, t && Su[t], h, r),
                                    style: C,
                            ...
                            void 0 !== D ? s().createElement(vu, xu({}, D, { text: u })) : u,
                        );
                    });
                let ku;
                !(function (e) {
                ...
                const Hu = (e, u, t) => {
                        switch (u) {
                            case ku.SHORT_DATE:
                                return t
                                    ? j.Z5.getDateFormat(e, j.kH.SHORT_FORMAT)
                                    : j.cy.getTimeFormat('%d.%m.%y', e, !0);
                            case ku.SHORT_TIME:
                                return t
                                    ? j.Z5.getTimeFormat(e, j.lf.SHORT_FORMAT)
                                    : j.cy.getTimeFormat('%I:%M %p', e, !0);
                            case ku.SHORT_DATE_TIME:
                                return t
                                    ? `${j.Z5.getDateFormat(e, j.kH.SHORT_FORMAT)}, ${j.Z5.getTimeFormat(e, j.lf.SHORT_FORMAT)}`
                                    : j.cy.getTimeFormat('%d.%m.%y, %I:%M %p', e, !0);
                            case ku.FULL_DATE:
                                return t
                                    ? j.Z5.getDateFormat(e, j.kH.LONG_FORMAT)
                                    : j.cy.getTimeFormat('%B %d, %Y', e, !0);
                            case ku.FULL_DATE_TIME:
                                return t
                                    ? `${j.Z5.getDateFormat(e, j.kH.LONG_FORMAT)}, ${j.Z5.getTimeFormat(e, j.lf.SHORT_FORMAT)}`
                                    : j.cy.getTimeFormat('%B %d, %Y, %I:%M %p', e, !0);
                            case ku.MONTH:
                                return j.cy.getTimeFormat('%B', e, !0);
                            case ku.MONTH_DATE:
                                return j.cy.getTimeFormat('%B %e', e, !0);
                            case ku.DATE_MONTH:
                                return j.cy.getTimeFormat('%e %B', e, !0);
                            case ku.MONTH_YEAR:
                                return j.cy.getTimeFormat('%B %Y', e, !0);
                            case ku.WEEK_DAY:
                                return j.cy.getTimeFormat('%A', e, !0);
                            case ku.WEEK_DAY_TIME:
                                return t
                                    ? `${j.cy.getTimeFormat('%A', e, !0)} ${j.Z5.getTimeFormat(e, j.lf.SHORT_FORMAT)}`
                                    : j.cy.getTimeFormat('%A, %I:%M %p', e, !0);
                            case ku.YEAR:
                                return j.cy.getTimeFormat('%Y', e, !0);
                            case ku.DATE_YEAR:
                                return j.cy.getTimeFormat('%d, %Y', e, !0);
                        }
                    },
                    Gu = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    Uu = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3],
                    Wu = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    $u = (e) =>
                        Wu
                            ? `${e}`
                            : (function (e) {
                ...
                let Xu;
                !(function (e) {
                    ((e.Active = 'active'), (e.Finished = 'finished'), (e.NotStarted = 'notStarted'));
                })(Xu || (Xu = {}));
                const Yu = {
                ...
                const qu = (0, a.memo)((e) => {
                        ...
                        const v = (0, a.useState)(!1),
                            ...
                            L = (0, a.useRef)(null),
                            P = (0, a.useCallback)(() => {
                                L.current && (L.current.focus(), y(!0));
                            }, []),
                            O = (0, a.useCallback)(
                                (e) => {
                                    M && null !== L.current && !L.current.contains(e.target) && y(!1);
                                },
                                [M],
                            );
                        ((0, a.useEffect)(
                        ...
                        const N = (0, a.useCallback)(
                            ...
                            X = p()(
                                Yu.base,
                                r && Yu.base__visibleLabel,
                                b && Yu.base__mouseDown,
                                T && Yu.base__hovered,
                                M && Yu.base__focused,
                                null == A ? void 0 : A.base,
                            ),
                            Y = p()(Yu.icon, Yu[`icon__${m}`], null == A ? void 0 : A.icon),
                            j = p()(Yu.label, null == A ? void 0 : A.label);
                        return s().createElement(
                            'div',
                            zu(
                                {
                            ...
                            s().createElement('div', { className: j }, u),
                        );
                    }),
                    Ku = [
                        'children',
                        ...
                        const h = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, a.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Zu(t, A, { isMouseEvent: !0, on: !0, arguments: Qu(r) }, f),
                                    g && g(),
                ...
                const it = ({ children: e, tooltipArgs: u, className: t }) => {
                        ...
                        if (u.header || u.body) return s().createElement(st, u, r);
                        const n = u.contentId,
                            a = u.args,
                            o = null == a ? void 0 : a.contentId;
                        return n || o
                            ? s().createElement(Ju, ot({}, u, { contentId: n || o }), r)
                            : s().createElement(tt, u, r);
                    },
                    lt = {
                        base: 'Reward_base_ea',
                    ...
                    ct = ({
                        ...
                        return s().createElement(
                            'div',
                            { className: p()(lt.base, lt[`base__${r}`], l), style: i },
                            s().createElement(
                                it,
                                { tooltipArgs: E, className: lt.tooltipWrapper },
                                s().createElement(
                                    s().Fragment,
                                    null,
                                    s().createElement(
                                        'div',
                                        { className: p()(lt.image, null == c ? void 0 : c.image) },
                                        m &&
                                            s().createElement('div', {
                                                className: p()(lt.highlight, null == c ? void 0 : c.highlight),
                                                style: {
                                        ...
                                        u &&
                                            s().createElement('div', {
                                                className: p()(lt.icon, null == c ? void 0 : c.rewardIcon),
                                                style: { backgroundImage: `url(${u})` },
                                            }),
                                        A &&
                                            s().createElement('div', {
                                                className: p()(lt.overlay, null == c ? void 0 : c.overlay),
                                                style: {
                            ...
                            t &&
                                s().createElement(
                                    ...
                                    { tooltipArgs: _ },
                                    s().createElement('div', {
                                        className: p()(lt.timer, null == c ? void 0 : c.periodicIcon),
                                    }),
                                ),
                        );
                    },
                ...
                const mt = R.strings.ny.weeklyRewards;
                let At;
                !(function (e) {
                ...
                const dt = s().memo(
                        ({
                            ...
                            const i = S().mediaSize,
                                l = i >= v.Large ? At.Large : At.Medium,
                                c = i < v.Medium ? At.Small : l,
                                E = u.top,
                                _ = u.pointsToTop,
                                m = u.isRewarded,
                                A = Boolean(E),
                                ...
                                D =
                                    -1 !== a &&
                                    ((e <= 25 && 25 === E) || (a === E && e > 25 && e <= F) || (e > F && 0 === E)),
                                B = D && d,
                                g = r.length,
                                C = g > 3,
                                h = C ? r.slice(0, 2) : r,
                            ...
                            return s().createElement(
                                'div',
                                { className: 'Group_base_b3' },
                                s().createElement('div', {
                                    className: p()(
                                        'Group_badge_a2',
                                        b && 'Group_badge__grey_54',
                                        (B || m) && 'Group_badge__active_b4',
                                        !A && 'Group_badge__drawing_3b',
                                    ),
                                    style: {
                                        backgroundImage: `url(R.images.new_year.gui.maps.icons.newYear.weeklyRewardsView.cards.layer_4.${c}_${A ? E : F})`,
                                    },
                                }),
                                B && s().createElement('div', { className: 'Group_blink_b7' }),
                                !d && s().createElement('div', { className: 'Group_overlayDisabled_0c' }),
                                s().createElement(
                                    'div',
                                    { className: p()('Group_header_c9', B && 'Group_header__active_ca') },
                                    s().createElement(
                                        'div',
                                        { className: Et },
                                        A
                                            ? s().createElement(ne, { value: E })
                                            : s().createElement(Nu, {
                                                  className: p()(Et, 'Group_title__drawing_51'),
                                                  text: mt.group.title(),
                                              }),
                                    ),
                                    A &&
                                        s().createElement(Nu, {
                                            className: 'Group_subtitle_c0',
                                            text: mt.group.subtitle(),
                                        }),
                                ),
                                s().createElement(
                                    'div',
                                    { className: 'Group_info_64' },
                                    d &&
                                        !D &&
                                        Boolean(_) &&
                                        s().createElement(Nu, {
                                            text: mt.group.leftToScore(),
                                            format: {
                                                classMix: 'Group_leftToScore_0e',
                                                binding: {
                                                    top: E,
                                                    score: s().createElement(
                                                        'div',
                                                        { className: 'Group_leftToScoreValue_0d' },
                                                        s().createElement(ne, { value: _ }),
                                                    ),
                                                },
                                            },
                                        }),
                                    B &&
                                        s().createElement(Nu, {
                                            text: mt.group.place(),
                                            format: {
                                                classMix: 'Group_place_7f',
                                                binding: {
                                                    place: s().createElement(
                                                        'div',
                                                        { className: 'Group_placeValue_a3' },
                                                        s().createElement(ne, { value: e }),
                                                    ),
                                                },
                                            },
                                    ...
                                    m &&
                                        s().createElement(Nu, {
                                            text: mt.group.rewardsReceived(),
                                            format: {
                                                classMix: 'Group_rewardsReceived_6d',
                                                binding: {
                                                    doubleCheckIcon: s().createElement('div', {
                                                        className: 'Group_doubleCheckIcon_15',
                                                    }),
                                                },
                                            },
                                        }),
                                ...
                                s().createElement(
                                    ...
                                    h.map((e, u) =>
                                        s().createElement(
                                            'div',
                                            {
                                                className: p()(
                                                    'Group_reward_9d',
                                                    e.name === Q.BattleBadge && 'Group_reward__badge_92',
                                                ),
                                                key: u,
                                            },
                                            s().createElement(
                                                ...
                                                _t({}, e, {
                                                    classNames: {
                                                        image: p()(
                                                            'Group_rewardImage_6c',
                                                            b && 'Group_rewardImage__gray_bd',
                                                        ),
                                                        info: p()(
                                                            'Group_rewardInfo_a1',
                                                            b && 'Group_rewardInfo__gray_3b',
                                                            e.valueType === ee.MULTI && 'Group_rewardInfo__multi_1c',
                                                        ),
                                                    },
                                                    size: e.name === Q.BattleBadge ? J.S232x174 : J.S180x135,
                                                }),
                                            ),
                                            e.name === Q.Vehicles &&
                                                e.vehicleCD &&
                                    ...
                                    s().createElement(
                                        ...
                                        {
                                            className: p()(
                                                'Group_otherRewards_47',
                                                b && 'Group_otherRewards__gray_be',
                                                w && 'Group_otherRewards__four_13',
                                            ),
                                        },
                                        f.map((e, u) =>
                                            s().createElement(
                                                ...
                                                {
                                                    className: p()(
                                                        'Group_otherReward_54',
                                                        0 !== u && u % 2 == (w ? 1 : 0) && 'Group_otherReward__last_6c',
                                                    ),
                                                    key: g + u,
                                                },
                                                s().createElement(ct, _t({}, e, { size: J.S48x48 })),
                                            ),
                                        ),
                                    ),
                                ),
                    ...
                    Ft = {
                        base__enabled: 'ScrollDrag_base__enabled_4c',
                        base__grabbing: 'ScrollDrag_base__grabbing_c9',
                    },
                    Dt = ({ api: e, children: u, isSmall: t, updateProgressBarPosition: r }) => {
                        ...
                        return (
                            ...
                            s().createElement(
                                'div',
                                {
                                    className: p()(Ft.base, t && !m && Ft.base__enabled, m && Ft.base__grabbing),
                                    onMouseDown: (e) => {
                                        (A(t), E(e.clientX), r());
                                    },
                                    onMouseUp: () => {
                                    ...
                                    onMouseMove: (u) => {
                                        if (m) {
                                            const t = Me(-(e.getBounds()[1] || 0), 0, o + u.clientX - c);
                                            (e.applyScroll(-t, !0), E(u.clientX), i(t), r());
                                        }
                                    },
                                },
                                u,
                    ...
                    Bt = 'Content_line_ca',
                    gt = 'Content_lineStart_02',
                    Ct = R.strings.ny.weeklyRewards,
                    pt = i.O.view.remToPx(50),
                    ht = (0, K.observer)(
                        ({
                            selectedTabIndex: e,
                            isSmall: u,
                            onSetIsLeftVignetteShow: t,
                            onSetIsRightVignetteShow: r,
                            onSetHideView: n,
                        }) => {
                            const o = q(),
                                i = (0, a.useState)(Date.now()),
                                l = i[0],
                                c = i[1],
                                E = xe(),
                                _ = E.model,
                                m = E.controls,
                                A = _.computes.getStages()[e],
                                d = A.position,
                                F = A.tops,
                                D = A.startDate,
                                B = A.endDate,
                                g = A.state,
                                C = g === Xu.Finished,
                                h = _.computes.getTops(e),
                                f = Ge(),
                                v = f.animationScroll.scrollPosition,
                                b = f.events,
                                w = f.getBounds,
                                S = f.applyScroll,
                                T = (0, a.useCallback)(() => {
                                    const e = w()[1];
                                    (v.goal > pt ? t(!0) : t(!1), v.goal < e - pt ? r(!0) : r(!1));
                                }, [w, t, r, v.goal]),
                                x = (0, a.useCallback)(
                                    (e) => {
                                        S(e);
                            ...
                            (0, a.useEffect)(() => (b.on('change', T), () => b.off('change', T)), [b, T]);
                            const M = (0, a.useCallback)(
                                (e) => () => {
                                    (n(!0),
                                        o.run(() => {
                                            m.previewClick({ vehicleCD: e });
                                        }, 300));
                                },
                                [m, o, n],
                            );
                            ...
                            const y = `${Hu(D, ku.SHORT_DATE, !0)} - ${Hu(B, ku.SHORT_DATE, !0)}`,
                                L = C ? Ct.stage.subtitle() : y,
                                P = q(),
                                O = (0, a.useCallback)(() => {
                                    P.run(() => {
                                        (c(Date.now()), O());
                            ...
                            const N = Math.max(0, Math.floor((B * Iu - l) / Iu)),
                                k = (0, a.useMemo)(() => N < 86400 && N > 0, [N]),
                                I = (function (e = 0) {
                                    let u = e;
                                ...
                                H = I.hours,
                                G = I.minutes,
                                U = (e, u) => _.computes.getRewards(e, u),
                                W = _.computes.getNearestTop(d, e);
                            return s().createElement(
                                'div',
                                { className: 'Content_base_3f' },
                                s().createElement(
                                    'div',
                                    { className: 'Content_title_bd' },
                                    s().createElement(
                                        'div',
                                        { className: p()(Bt) },
                                    ...
                                    s().createElement(
                                        'div',
                                        { className: 'Content_titleText_e7' },
                                        s().createElement(Nu, {
                                            className: p()(
                                                'Content_stageName_38',
                                                g !== Xu.Active && 'Content_stageName__inactive_cc',
                                            ),
                                            text: Ct.stage.title(),
                                            format: { binding: { index: $u(e + 1) } },
                                        }),
                                        k
                                            ? s().createElement(Nu, {
                                                  text: Ct.stage.countdown(),
                                                  format: {
                                                      classMix: 'Content_countdown_25',
                                                      binding: {
                                                          timerIcon: s().createElement('div', {
                                                              className: 'Content_timerIcon_d8',
                                                          }),
                                                          hoursMinutes: s().createElement(Nu, {
                                                              className: 'Content_hoursMinutes_9d',
                                                              text: Ct.stage.hoursMinutes(),
                                                              format: { binding: { hours: H, minutes: G } },
                                                          }),
                                                      },
                                                  },
                                              })
                                            : s().createElement(Nu, {
                                                  className: p()(
                                                      'Content_stageDates_fe',
                                                      C && 'Content_stageDates__finished_e3',
                                                  ),
                                                  text: L,
                                              }),
                                    ),
                                    s().createElement(
                                        'div',
                                        { className: p()(Bt, 'Content_line__reversed_ad') },
                                        s().createElement('div', { className: gt }),
                                    ),
                                ),
                                s().createElement(
                                    lu.Horizontal.Area.Default,
                                    {
                                        api: f,
                                        classNames: {
                                            content: 'Content_scrollContent_30',
                                            wrapper: 'Content_scrollWrapper_6a',
                                        },
                                        barClassNames: { base: 'Content_scrollBar_c3' },
                                        className: 'Content_chaptersWrapper_ba',
                                        onDrag: R,
                                    },
                                    s().createElement(
                                        Dt,
                                        { isSmall: u, api: f, updateProgressBarPosition: R },
                                        s().createElement(
                                            'div',
                                            { className: 'Content_groups_0a' },
                                            F.map((u, t) =>
                                                s().createElement(dt, {
                                                    tops: h,
                                                    key: t,
                    ...
                    ft = R.strings.ny.weeklyRewards,
                    vt = { description: R.strings.ny.leaderboardView.tooltips.headerInfo.description() },
                    bt = s().memo(({ onGoToInfo: e }) => {
                        const u = (0, a.useState)(!1),
                            t = u[0],
                            r = u[1];
                        return s().createElement(
                            'div',
                            { className: 'Header_base_5b' },
                            s().createElement(Nu, { className: 'Header_title_a9', text: ft.title() }),
                            s().createElement(
                                Ju,
                                {
                                ...
                                s().createElement(
                                    ...
                                    s().createElement('div', {
                                        className: p()('Header_infoHover_92', t && 'Header_infoHover__hovered_39'),
                                    }),
                                ),
                            ),
                        );
                    }),
                    wt = R.strings.ny.weeklyRewards.stage,
                    St = s().memo(
                        ({ index: e, state: u, startDate: t, endDate: r, className: n, isSelected: o, onClick: i }) => {
                            const l = (0, a.useState)(!1),
                                ...
                                _ = p()(
                                    'Tab_base_10',
                                    n,
                                    c && 'Tab_base__hovered_e8',
                                    u === Xu.NotStarted && 'Tab_base__locked_4b',
                                    u === Xu.Finished && 'Tab_base__finished_31',
                                    o && 'Tab_base__selected_5c',
                                ),
                                m = Hu(t, ku.SHORT_DATE_TIME, !0),
                                A = Hu(r, ku.SHORT_DATE_TIME, !0),
                                d = {
                                    header: Ce(wt.title(), { index: $u(e + 1) }),
                                    description:
                                        u === Xu.Finished
                                            ? wt.tooltipBody.finished()
                                            : Ce(wt.tooltipBody.period(), {
                                                  index: wt.index.$dyn(`c_${e + 1}`),
                                                  startDate: m,
                                                  endDate: A,
                                              }),
                                };
                            return s().createElement(
                                Ju,
                                { contentId: R.views.new_year.lobby.new_year.tooltips.CommonTooltip('resId'), args: d },
                                s().createElement(
                                    'div',
                                    {
                                        onClick: () => {
                                    ...
                                    s().createElement('div', { className: 'Tab_background_72' }),
                                    s().createElement('div', { className: 'Tab_backgroundHover_ff' }),
                                    s().createElement('div', { className: 'Tab_border_ac' }),
                                    s().createElement(Nu, {
                                        className: 'Tab_title_75',
                                        text: wt.title(),
                                        format: { binding: { index: $u(e + 1) } },
                                    }),
                                    u === Xu.Finished &&
                                        s().createElement(Nu, { className: 'Tab_subtitle_9d', text: wt.subtitle() }),
                                    u === Xu.NotStarted && s().createElement('div', { className: 'Tab_lock_a7' }),
                                    u === Xu.NotStarted && s().createElement('div', { className: 'Tab_light_a0' }),
                                ),
                            );
                        },
                    );
                ...
                const xt = (0, K.observer)(({ selectedTabIndex: e, onTabSelect: u }) => {
                        const t = xe().model.computes.getStages();
                        return s().createElement(
                            'div',
                            { className: 'TabBar_base_25' },
                            s().createElement('div', { className: 'TabBar_background_bc' }),
                            s().createElement(
                                'div',
                                { className: 'TabBar_tabs_fd' },
                                t.map((t, r) =>
                                    s().createElement(
                                        St,
                                        Tt({ className: 'TabBar_tab_08', key: r }, t, {
                                            index: r,
                                            isSelected: r === e,
                                            onClick: () => u(r),
                                        }),
                    ...
                    Rt = 'App_vignette_89',
                    Mt = 'App_vignette__visible_7a',
                    yt = R.strings.ny.weeklyRewards.back,
                    Lt = (0, K.observer)(() => {
                        const e = (0, a.useState)(!1),
                            ...
                            m = _[0],
                            A = _[1],
                            d = S().mediaSize === v.ExtraSmall,
                            F = xe(),
                            D = F.model,
                            B = F.controls,
                            g = D.root.get().currentStage,
                            C = (0, a.useState)(g),
                            h = C[0],
                            f = C[1];
                        (0, a.useEffect)(() => {
                        ...
                        return s().createElement(
                            'div',
                            { className: p()('App_base_6b', n && 'App_base__hide_1b') },
                            s().createElement(
                                'div',
                                { className: 'App_back_3d' },
                                s().createElement(X, {
                                    caption: yt.label(),
                                    goto: yt.goto(),
                                    type: 'back',
                            ...
                            s().createElement(bt, { onGoToInfo: x }),
                            s().createElement(xt, { selectedTabIndex: h, onTabSelect: R }),
                            d && s().createElement('div', { className: p()(Rt, !u && c && Mt) }),
                            s().createElement(
                                'div',
                                { className: p()('App_content_36', u && 'App_content__hidden_31') },
                                s().createElement(ht, {
                                    selectedTabIndex: h,
                                    isSmall: d,
                                    onSetIsLeftVignetteShow: E,
                                    onSetIsRightVignetteShow: A,
                                    onSetHideView: o,
                                }),
                            ),
                            d &&
                                s().createElement('div', {
                                    className: p()(Rt, 'App_vignette__right_8c', !u && m && Mt),
                                }),
                        );
                    });
                engine.whenReady.then(() => {
                    I().render(
                        s().createElement(Te, null, s().createElement(N, null, s().createElement(Lt, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(5520));
