(() => {
    var __webpack_modules__ = {
            ...
            4884: (u, e, t) => {
                ...
                const d = (0, r.memo)(({ children: u }) => {
                    ...
                    return n().createElement(_.Provider, { value: s }, u);
                });
                var B = t(6483),
                    C = t.n(B),
                    g = t(926),
                ...
                const S = {
                    ...
                    T = (u) => {
                        ...
                        const a = b(),
                            ...
                            E = a.mediaHeight,
                            A = a.mediaSize;
                        return n().createElement('div', x({ className: C()(t, S[i], L[E], M[A]) }, r), e);
                    },
                    O = ['children'],
                    y = (u) => {
                        let e = u.children,
                        ...
                        return n().createElement(d, null, n().createElement(T, t, e));
                    };
                var P = t(493),
                    k = t.n(P),
                    H = t(4179);
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (W(t, _, { isMouseEvent: !0, on: !0, arguments: N(n) }, v),
                                    C && C(),
                                ...
                                const o = (0, r.useRef)([]),
                                    F = (u, t, r) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            s = (({ observableModel: u }) => {
                                                const e = { root: u.object(), eventState: u.object('eventState') };
                                    ...
                                    D = l[0],
                                    _ = l[1],
                                    c = (0, r.useState)(() => F(u, a, A)),
                                    m = c[0],
                                    d = c[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        s.current ? d(F(D, a, A)) : (s.current = !0);
                                    }, [A, D, a]),
                                    (0, r.useEffect)(() => {
                                        _(u);
                                    }, [u]),
                ...
                const ou = {
                    ...
                    lu = au((u) => {
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, A, F, l, _, H, k, L, B, O, f, S]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return n().createElement('div', Au({ className: C()(iu.base, ...U, e), style: G }, N), I);
                    });
                let Du;
                !(function (u) {
                ...
                const bu = Object.keys(hu()),
                    ...
                    Tu = au((u) => {
                        ...
                        return n().createElement(
                            ...
                            void 0 !== d ? n().createElement(Cu, wu({}, d, { text: e })) : e,
                        );
                    }),
                    Ou = {
                        base: 'Bonus_base_75',
                        content: 'Bonus_content_72',
                        credits: 'Bonus_credits_c8',
                        value: 'Bonus_value_e3',
                        plus: 'Bonus_plus_0e',
                    },
                    Ru = R.strings.ny,
                    yu = (0, r.memo)(({ bonusValue: u }) =>
                        n().createElement(
                            'div',
                            { className: Ou.base },
                            n().createElement(
                                ...
                                n().createElement('div', { className: Ou.credits }),
                                n().createElement(
                                    'div',
                                    { className: Ou.text },
                                    n().createElement(Tu, {
                                        className: Ou.value,
                                        text: Ru.bonusPercentage(),
                                        format: {
                                            binding: {
                                                value: u,
                                                operand: n().createElement('span', { className: Ou.plus }, Ru.plus()),
                                            },
                                        },
                                    }),
                                ),
                    ...
                    ku = ({ level: u, levelRoman: e, isEnabled: t, currentPoints: a, nextPoints: i }) => {
                        ...
                        return (
                            (0, r.useEffect)(
                                () =>
                                    U(() => {
                                        var u;
                                        F.current && o((null == (u = F.current) ? void 0 : u.offsetHeight) / 2);
                                    }),
                                [s],
                            ),
                            n().createElement(
                                'div',
                                { className: C()(Pu.base, l && Pu.base__final, !t && Pu.base__disabled) },
                                t &&
                                    n().createElement(
                                        'div',
                                        { className: Pu.snowAnimation },
                                        n().createElement('div', { className: C()(Pu.frame, Pu.frame__fast) }),
                                        n().createElement('div', { className: C()(Pu.frame, Pu.frame__slow) }),
                                    ),
                                n().createElement(Tu, { text: e, className: Pu.level }),
                                n().createElement(Tu, { text: e, className: Pu.levelGradient }),
                                n().createElement(
                                    'div',
                                    { className: Pu.progressWrapper, style: { maskSize: `100% ${(a / i) * 100}%` } },
                                    n().createElement('div', { className: Pu.progress, ref: F }),
                                    n().createElement('div', {
                                        className: Pu.progressShadow,
                                        style: { top: A * (a / i) - 12 + 'rem' },
                                    }),
                                ),
                                t &&
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            'div',
                                            { className: Pu.blinkInner },
                                            n().createElement('div', { className: Pu.blink }),
                                        ),
                                    ),
                            )
                        );
                        ...
                        return (
                            (0, r.useEffect)(() => {
                                ...
                                switch (d) {
                                                ...
                                                r = window.setInterval(() => {
                                                    ...
                                                    a
                                                        ? (null == E || E(n, a),
                                                          ...
                                                          n === D &&
                                                              (null == C || C(),
                                                              c || (null == B || B(), window.clearInterval(r))))
                                                        : console.error(
                                    ...
                                    case 'stop':
                                        return (function () {
                                            const u = 0 === s && g ? { path: g, x: 0, y: 0 } : a(s),
                                                e = new Image();
                                            e.src = u.path;
                                            const r = () => t(ju(u, e));
                                            return (
                            ...
                            n().createElement('canvas', Wu({}, h, { width: e, height: t, ref: p }))
                        );
                    }),
                    Uu = (u, e) => {
                        let t = u;
                ...
                const $u = {
                        ...
                        height: 144,
                        frameCount: 64,
                        chunk: { count: 1, rows: 8, columns: 8 },
                        getChunkPath: Iu(
                            'R.images.new_year.gui.maps.icons.newYear.main_widget_starting_state.box_destruct_big_',
                        ),
                    },
                    qu = {
                        width: 104,
                        ...
                        chunk: { count: 1, rows: 8, columns: 8 },
                        getChunkPath: Iu(
                            'R.images.new_year.gui.maps.icons.newYear.main_widget_starting_state.box_destruct_small_',
                        ),
                    },
                    Zu = ({ onDestructBoxDone: u }) => {
                        const e = b().mediaSize < p.Medium ? qu : $u,
                            t = Hu(e),
                            a = (0, r.useState)(zu.STOP),
                            i = a[0],
                            E = a[1];
                        (0, r.useEffect)(() => {
                            E(zu.PLAY), j(R.sounds.hangar_newyear_box_disintegration());
                        }, []);
                        ...
                        return n().createElement(
                            'div',
                            { className: 'WidgetOnboardingDoneState_base_52' },
                            n().createElement('div', {
                                className: C()(
                                    'WidgetOnboardingDoneState_background_4a',
                                    i === zu.PLAY && 'WidgetOnboardingDoneState_background__hidden_3d',
                                ),
                            }),
                            n().createElement(Gu, {
                                onAnimationDone: Y,
                                ...
                                loop: !1,
                                className: C()(
                                    'WidgetOnboardingDoneState_canvas_65',
                                    i === zu.PLAY && 'WidgetOnboardingDoneState_canvas__visible_58',
                                ),
                                onAnimationComplete: A,
                            }),
                        );
                    },
                    Qu = 'WidgetStartingState_canvas_70',
                    Ju = 'WidgetStartingState_canvas__visible_b4';
                const ue = {
                        width: 170,
                        height: 180,
                        frameCount: 56,
                        chunk: { count: 1, rows: 7, columns: 8 },
                        getChunkPath: Iu(
                            'R.images.new_year.gui.maps.icons.newYear.main_widget_starting_state.box_particles_big_',
                        ),
                    },
                    ee = {
                        width: 170,
                        ...
                        getChunkPath: Iu(
                            'R.images.new_year.gui.maps.icons.newYear.main_widget_starting_state.box_opening_big_',
                        ),
                    },
                    te = {
                        width: 170,
                        ...
                        chunk: { count: 1, rows: 1, columns: 8 },
                        getChunkPath: Iu(
                            'R.images.new_year.gui.maps.icons.newYear.main_widget_starting_state.box_closing_big_',
                        ),
                    },
                    re = {
                        width: 130,
                        ...
                        chunk: { count: 1, rows: 7, columns: 8 },
                        getChunkPath: Iu(
                            'R.images.new_year.gui.maps.icons.newYear.main_widget_starting_state.box_particles_small_',
                        ),
                    },
                    ne = {
                        width: 130,
                        ...
                        chunk: { count: 1, rows: 1, columns: 8 },
                        getChunkPath: Iu(
                            'R.images.new_year.gui.maps.icons.newYear.main_widget_starting_state.box_opening_small_',
                        ),
                    },
                    ae = {
                        width: 130,
                        ...
                        chunk: { count: 1, rows: 1, columns: 8 },
                        getChunkPath: Iu(
                            'R.images.new_year.gui.maps.icons.newYear.main_widget_starting_state.box_closing_small_',
                        ),
                    },
                    ie = ({ isEnabled: u }) => {
                        const e = b().mediaSize < p.Medium,
                            t = e ? ne : ee,
                            a = e ? ae : te,
                            i = e ? re : ue,
                            E = Hu(t),
                            ...
                            h = g[0],
                            v = g[1],
                            w = (0, r.useState)(zu.STOP),
                            f = w[0],
                            x = w[1],
                            S = (0, r.useState)(zu.STOP),
                            L = S[0],
                            M = S[1],
                            T = (0, r.useState)(zu.STOP),
                            O = T[0],
                            y = T[1];
                        (0, r.useEffect)(() => {
                            if (!s && u) {
                                const u = setInterval(() => {
                                    c(!0), j(R.sounds.hangar_newyear_box_jingling());
                                    const u = setTimeout(() => {
                                        c(!1);
                                    }, 600);
                        ...
                        const P = (0, r.useCallback)(() => {
                                v(!0),
                                    ...
                                    y(zu.STOP),
                                    M(zu.STOP),
                                    j(R.sounds.hangar_newyear_box_hover_on());
                            }, []),
                            k = (0, r.useCallback)(() => {
                                x(zu.STOP),
                                    y(zu.STOP),
                                    M(zu.STOP),
                                    B(!1),
                                    j(R.sounds.hangar_newyear_box_hover_off()),
                                    h && P();
                            }, [h, P]),
                            H = (function (u, e, t) {
                                const n = (0, r.useMemo)(
                            ...
                            N = (0, r.useCallback)(() => {
                                x(zu.STOP), y(zu.PLAY), M(zu.STOP);
                            }, []),
                            W = (0, r.useCallback)(() => {
                                (!d && s) || (x(zu.STOP), y(zu.STOP), M(zu.PLAY), B(!1), v(!1));
                            }, [d, s]),
                            G = (0, r.useCallback)(() => {
                                u && (B(!0), v(!1), l(!1));
                            }, [u]);
                        return n().createElement(
                            ...
                            {
                                className: C()(
                                    'WidgetStartingState_base_ed',
                                    s && 'WidgetStartingState_base__hovered_6b',
                                    _ && 'WidgetStartingState_base__animation_51',
                                    !u && 'WidgetStartingState_base__disabled_16',
                                ),
                                onMouseEnter: I,
                                onMouseLeave: G,
                            },
                            n().createElement('div', {
                                className: C()(
                                    'WidgetStartingState_background_a9',
                                    (f === zu.PLAY || L === zu.PLAY || O === zu.PLAY) &&
                                        'WidgetStartingState_background__hidden_5a',
                                ),
                            }),
                            u &&
                                n().createElement(
                ...
                const Ae = 'App_startingWidget_cb',
                    oe = R.views.new_year.lobby.new_year.tooltips,
                    Fe = (0, X.Pi)(() => {
                        const u = Q(),
                            e = u.model,
                            t = u.controls,
                            ...
                            o = a.currentPoints,
                            F = a.nextPoints,
                            s = a.isActiveWidgetTransitionShown,
                            l = a.isFirstEntrance,
                            D = e.eventState.get(),
                            _ = (0, r.useState)(s),
                            c = _[0],
                        ...
                        const x = (0, r.useCallback)(() => {
                            ...
                            S = (0, r.useCallback)(() => {
                                w &&
                                    (g(!0),
                                    j(R.sounds.hangar_newyear_enter_custome()),
                                    j(R.sounds.hangar_newyear_enter_custome_flight()),
                                    ((u, e) => {
                                        let t;
                                        setTimeout(() => {
                                            t = u();
                        ...
                        return n().createElement(
                            'div',
                            {
                                className: C()(
                                    'App_base_4d',
                                    l && 'App_base__starting_1c',
                                    v && 'App_base__final_55',
                                    !w && 'App_base__disabled_2f',
                                    B && 'App_base__disappear_36',
                                ),
                            },
                            n().createElement(
                                'div',
                                { className: 'App_widgetWrapper_0a' },
                                n().createElement('div', { className: 'App_hitArea_2d', ref: h }),
                                n().createElement(
                                    G,
                                    { contentId: oe.NyTotalBonusTooltip('resId') },
                                    n().createElement(
                                        'div',
                                        { className: 'App_bonus_d9' },
                                        n().createElement(yu, { bonusValue: i }),
                                    ),
                                ),
                                n().createElement(
                                    G,
                                    { contentId: oe.NyMainWidgetTooltip('resId') },
                                    n().createElement(
                                        'div',
                                        { className: 'App_widgetHolder_1a' },
                                        l
                                            ? n().createElement(
                                                  'div',
                                                  { className: Ae, onClick: S },
                                                  n().createElement(ie, { isEnabled: w }),
                                              )
                                            : n().createElement(
                                                  n().Fragment,
                                                  null,
                                                  f &&
                                                      n().createElement(
                                                          'div',
                                                          { className: Ae, onClick: S },
                                                          n().createElement(Zu, { onDestructBoxDone: x }),
                                                      ),
                                                  !l &&
                                                      !f &&
                                                      n().createElement(
                                                          'div',
                                                          { className: 'App_widget_fc', onClick: S },
                                                          n().createElement(
                                                              'div',
                                                              { className: 'App_widgetBg_f7' },
                                                              n().createElement(ku, {
                                                                  level: E,
                                                                  levelRoman: A,
                                                                  isEnabled: w,
                            ...
                            n().createElement('div', { className: 'App_disappearShadow_10' }),
                        );
                    });
                engine.whenReady.then(() => {
                    k().render(
                        n().createElement(Z, null, n().createElement(y, null, n().createElement(Fe, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(4884));
