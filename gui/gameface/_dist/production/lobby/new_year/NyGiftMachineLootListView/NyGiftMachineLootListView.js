                                ...
                                ((t.style.transform = `translateX(${0 | d}px)`),
                                    ((e) => {
                                        if (i.current && l.current && c.current && E.current) {
                                            if (0 === e)
                                                return (
                                                    i.current.classList.add(rn),
                                                    void l.current.classList.remove(rn)
                                                );
                                            if (
                                                ((u = c.current),
                                                (t = E.current),
                                                ...
                                                return (
                                                    i.current.classList.remove(rn),
                                                    void l.current.classList.add(rn)
                                                );
                                            var u, t;
                                ...
                                ((t.style.transform = `translateY(${0 | d}px)`),
                                    ((e) => {
                                        if (i.current && l.current && c.current && E.current) {
                                            if (0 === Math.round(e))
                                                return (
                                                    i.current.classList.add(fn),
                                                    void l.current.classList.remove(fn)
                                                );
                                            if (
                                                ((u = c.current),
                                                (t = E.current),
                                                ...
                                                return (
                                                    i.current.classList.remove(fn),
                                                    void l.current.classList.add(fn)
                                                );
                                            var u, t;
