    ...
    var u,
        e = {
            ...
            9724: (u, e, t) => {
                'use strict';
                var A = {};
                (t.r(A), t.d(A, { mouse: () => o, onResize: () => l }));
                var E = {};
                (t.r(E),
                    t.d(E, {
                        events: () => A,
                ...
                var F = {};
                (t.r(F), t.d(F, { getBgUrl: () => _, getTextureUrl: () => d }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        addModelObserver: () => L,
                ...
                const $ = Object.keys(g).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === g[e]), u), {}),
                    z = {
                        set: (u, e) => {
                ...
                const q = V.client.getSize('rem'),
                    Q = q.width,
                    J = q.height,
                    uu = Object.assign({ width: Q, height: J }, Z(Q, J, K)),
                    eu = (0, a.createContext)(uu),
                    tu = ['children'],
                    Au = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        const A = (0, a.useContext)(eu),
                            ...
                            h = { extraLarge: s, large: c, medium: d, small: _, extraSmall: g };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && B) return n(e, t, h);
                            if (t.largeWidth && l) return n(e, t, h);
                            if (t.mediumWidth && C) return n(e, t, h);
                            if (t.smallWidth && o) return n(e, t, h);
                            if (t.extraSmallWidth && m) return n(e, t, h);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                ((Au.defaultProps = {
                    ...
                    (0, a.memo)(Au));
                const Eu = (0, a.memo)(({ children: u }) => {
                    const e = (0, a.useContext)(eu),
                        t = (0, a.useState)(e),
                        A = t[0],
                        E = t[1],
                        F = (0, a.useCallback)((u, e) => {
                            const t = V.view.pxToRem(u),
                                A = V.view.pxToRem(e);
                            E(Object.assign({ width: t, height: A }, Z(t, A, K)));
                        }, []);
                    (((u) => {
                    ...
                    return D().createElement(eu.Provider, { value: r }, u);
                });
                var Fu = t(6483),
                    ru = t.n(Fu),
                    au = t(926),
                ...
                const mu = {
                        [iu.ExtraSmall]: '',
                        [iu.Small]: Du().SMALL_WIDTH,
                        [iu.Medium]: `${Du().SMALL_WIDTH} ${Du().MEDIUM_WIDTH}`,
                        [iu.Large]: `${Du().SMALL_WIDTH} ${Du().MEDIUM_WIDTH} ${Du().LARGE_WIDTH}`,
                        [iu.ExtraLarge]: `${Du().SMALL_WIDTH} ${Du().MEDIUM_WIDTH} ${Du().LARGE_WIDTH} ${Du().EXTRA_LARGE_WIDTH}`,
                    },
                    su = {
                        [Bu.ExtraSmall]: '',
                        [Bu.Small]: Du().SMALL_HEIGHT,
                        [Bu.Medium]: `${Du().SMALL_HEIGHT} ${Du().MEDIUM_HEIGHT}`,
                        [Bu.Large]: `${Du().SMALL_HEIGHT} ${Du().MEDIUM_HEIGHT} ${Du().LARGE_HEIGHT}`,
                        [Bu.ExtraLarge]: `${Du().SMALL_HEIGHT} ${Du().MEDIUM_HEIGHT} ${Du().LARGE_HEIGHT} ${Du().EXTRA_LARGE_HEIGHT}`,
                    },
                    cu = {
                        [nu.ExtraSmall]: '',
                        [nu.Small]: Du().SMALL,
                        [nu.Medium]: `${Du().SMALL} ${Du().MEDIUM}`,
                        [nu.Large]: `${Du().SMALL} ${Du().MEDIUM} ${Du().LARGE}`,
                        [nu.ExtraLarge]: `${Du().SMALL} ${Du().MEDIUM} ${Du().LARGE} ${Du().EXTRA_LARGE}`,
                    },
                    du = (u) => {
                        let e = u.children,
                            t = u.className,
                        ...
                        const E = lu(),
                            ...
                            r = E.mediaHeight,
                            a = E.mediaSize;
                        return D().createElement('div', ou({ className: ru()(t, mu[F], su[r], cu[a]) }, A), e);
                    },
                    _u = ['children'],
                    gu = (u) => {
                        let e = u.children,
                        ...
                        return D().createElement(Eu, null, D().createElement(du, t, e));
                    };
                var hu = t(493),
                    xu = t.n(hu),
                    pu = t(9174);
                const fu = {
                    getter:
                        ...
                        (u) => (u ? u.split('.').reduce((u, e) => u[e], bu) : bu)),
                    controls: () =>
                        (function (u) {
                            const e = {};
                            for (const t in u)
                ...
                const wu = ({
                    ...
                    const s = (0, a.useRef)(null),
                        ...
                        b = p[1],
                        v = (0, a.useCallback)(() => {
                            E || (s.current && (s.current.focus(), _(!0)));
                        }, [E]),
                        S = (0, a.useCallback)(
                            (u) => {
                                d && null !== s.current && !s.current.contains(u.target) && _(!1);
                            },
                            [d],
                        ),
                        L = (0, a.useCallback)(
                        ...
                        O = ru()(
                            ...
                            Su[`base__${A}`],
                            {
                                ...
                                [Su[`base__${e}`]]: e,
                                [Su.base__focus]: d,
                                [Su.base__highlightActive]: h,
                                [Su.base__firstHover]: f,
                            },
                            F,
                        ),
                        G = ru()(Su.state, Su.state__default);
                    return (
                        (0, a.useEffect)(
                            () => (
                        ...
                        D().createElement(
                            ...
                            A !== Lu.ghost &&
                                D().createElement(
                                    D().Fragment,
                                    null,
                                    D().createElement('div', { className: Su.back }),
                                    D().createElement('span', { className: Su.texture }),
                                ),
                            D().createElement(
                                'span',
                                { className: G },
                                D().createElement('span', { className: Su.stateDisabled }),
                                D().createElement('span', { className: Su.stateHighlightHover }),
                                D().createElement('span', { className: Su.stateHighlightActive }),
                            ),
                            D().createElement(
                                'span',
                ...
                wu.defaultProps = { type: Lu.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Hu = (0, a.memo)(wu),
                ...
                const Gu = (u, e, t) => {
                    ...
                    Iu = (u, e, t = Ou.left) => u.split(e).reduce(t === Ou.left ? Gu : Wu, []),
                    Pu = (() => {
                        const u = new RegExp(
                ...
                const $u = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const r = (0, a.useRef)([]),
                                    n = (u, t, A) => {
                                        ...
                                        const F = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const a = 'string' == typeof F ? `${A}.${F}` : A,
                                                            D = V.view.addModelObserver(a, e, !0);
                                            ...
                                            D = (e) =>
                                                'mocks' === u ? (null == A ? void 0 : A.getter(e)) : a.readByPath(e),
                                            ...
                                            B = { mode: u, model: i, externalModel: a, cleanup: n };
                                        return {
                                            model: i,
                                    ...
                                    l = B[0],
                                    C = B[1],
                                    o = (0, a.useState)(() => n(u, A, F)),
                                    m = o[0],
                                    s = o[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        i.current ? s(n(l, A, F)) : (i.current = !0);
                                    }, [F, l, A]),
                                    (0, a.useEffect)(() => {
                                        C(u);
                                    }, [u]),
                                    ...
                                    D().createElement(t.Provider, { value: m }, E)
                                );
                            },
                            () => (0, a.useContext)(t),
                        ];
                    ...
                    Ku = {
                        base: 'App_base_02',
                        footer: 'App_footer_56',
                        title: 'App_title_89',
                        type: 'App_type_ef',
                        buttons: 'App_buttons_44',
                        button: 'App_button_09',
                    };
                var Yu = t(9887),
                    Zu = t.n(Yu);
                const qu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Qu = (u) => u.includes('_') && ((u) => qu.includes(u))(u.split('_').at(-1)),
                    Ju = [nu.ExtraLarge, nu.Large, nu.Medium, nu.Small, nu.ExtraSmall],
                    ue = (u, e) =>
                    ...
                    ee = (u, e = ue) => {
                        const t = (
                            (u, e = ue) =>
                            (t) => {
                                const A = lu().mediaSize,
                                    E = (0, a.useMemo)(() => e(t, A), [t, A]);
                ...
                const Fe = {
                    ...
                    De = ee((u) => {
                        let e = u.className,
                            ...
                            s = u.row,
                            c = u.flexDirection,
                            d = void 0 === c ? (m ? 'column' : s && 'row') || void 0 : c,
                            _ = u.flexStart,
                            g = u.center,
                            h = u.flexEnd,
                            x = u.spaceBetween,
                            ...
                            b =
                                void 0 === f
                                    ...
                                    : f,
                            v = u.alignItems,
                            S = void 0 === v ? (_ ? 'flex-start' : g && 'center') || (h && 'flex-end') || void 0 : v,
                            L = u.alignSelf,
                            M = u.wrap,
                            w = u.flexWrap,
                            H = void 0 === w ? (M ? 'wrap' : void 0) : w,
                            y = u.grow,
                            R = u.shrink,
                            T = u.flex,
                            O = void 0 === T ? (y || R ? `${y ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : T,
                            G = u.style,
                            W = u.children,
                            I = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const P = (0, a.useMemo)(() => {
                                const u = { mt: r, mr: i, mb: l, ml: o },
                                    ...
                                    E = ((u) =>
                                        re.reduce((e, t) => {
                                            const A = u[t];
                                            return ('number' == typeof A && (e[ae[t]] = A + 'rem'), e);
                                        }, {}))(u);
                                return {
                            ...
                            }, [t, A, r, i, l, o, G, O, L, d, H, b, S]),
                            N = P.computedStyle,
                            k = P.computedClassNames;
                        return D().createElement('div', Ee({ className: ru()(te.base, ...k, e), style: N }, I), W);
                    }),
                    ne = ({ binding: u, text: e = '', classMix: t, alignment: A = Ou.left }) =>
                        null === e
                            ...
                            : D().createElement(
                                  ...
                                  e.split('\n').map((e, E) =>
                                      D().createElement(
                                          'div',
                                          { className: ru()('FormatText_base_d0', t), key: `${e}-${E}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                                              ...
                                              D().createElement(a.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              );
                ...
                const me = Object.keys(Be()),
                    ...
                    he = ee((u) => {
                        ...
                        return D().createElement(
                            ...
                            oe(
                                {
                                    className: ru()(le.base, t && le[t], h, A),
                                    style: g,
                                    mt: !0 === n ? _e[t || 'paragraph-P16'].mt : n,
                                    mr: !0 === B ? _e[t || 'paragraph-P16'].mr : B,
                                    mb: !0 === C ? _e[t || 'paragraph-P16'].mb : C,
                                    ml: !0 === m ? _e[t || 'paragraph-P16'].ml : m,
                                },
                                d,
                            ),
                            void 0 !== c ? D().createElement(ne, oe({}, c, { text: e })) : e,
                        );
                    }),
                    xe = R.strings.ny.videoRewardView,
                    pe = (0, ku.Pi)(() => {
                        const u = Vu(),
                            e = u.model,
                            t = u.controls,
                            ...
                            r = A.type,
                            a = A.isElite,
                            n = `${((i = r), i.replace(/-/g, '_'))}${a ? '_elite' : ''}`;
                        var i;
                        const B = R.images.gui.maps.icons.vehicleTypes.big.$dyn(n),
                            l = lu().mediaSize < nu.Medium ? Mu.small : Mu.medium;
                        return D().createElement(
                            'div',
                            { className: Ku.base },
                            D().createElement(
                                ...
                                D().createElement(
                                        ...
                                        D().createElement(he, {
                                            text:
                                                ...
                                                Tu
                                                    ...
                                                    : (function (u) {
                                                          let e = '';
                                                          for (let t = Ru.length - 1; t >= 0; t--)
                                                              for (; u >= Ru[t]; ) ((e += yu[t]), (u -= Ru[t]));
                                                          return e;
                                                      })(C)),
                                        }),
                                    ),
                                    ...
                                    D().createElement(he, { text: E }),
                                ),
                                D().createElement(
                                    'div',
                                    { className: Ku.buttons },
                                    D().createElement(
                                        Hu,
                                        { type: Lu.primary, size: l, mixClass: Ku.button, onClick: t.close },
                                        D().createElement(he, { text: xe.submit() }),
                                    ),
                                    D().createElement(
                                        Hu,
                                        { type: Lu.secondary, size: l, mixClass: Ku.button, onClick: t.showVehicle },
                                        D().createElement(he, { text: xe.toHangar() }),
                                    ),
                                ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    xu().render(
                        D().createElement(
                            Uu,
                            { mode: 'mocks', mocks: fu },
                            D().createElement(gu, null, D().createElement(pe, null)),
                        ),
