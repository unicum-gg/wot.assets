(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                'use strict';
                t.d(e, { Sw: () => a.Z, B3: () => l, Z5: () => o, B0: () => E, ry: () => C, Eu: () => h });
                class r {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
                ...
                function m(u, e, t, r, n, a, o) {
                    ...
                    i.done ? e(E) : Promise.resolve(E).then(r, n);
                }
                    ...
                    f = {
                        ...
                        sendShowPopOverEvent: (u, e, t, r, n = R.invalid('resId'), a) => {
                            const o = c.O.view.getViewGlobalPosition(),
                                ...
                                F = i.height,
                                D = {
                                    x: c.O.view.pxToRem(s) + o.x,
                                    y: c.O.view.pxToRem(l) + o.y,
            ...
            9671: (u, e, t) => {
                ...
                const F = E.O.client.getSize('rem'),
                    D = F.width,
                    _ = F.height,
                    c = Object.assign({ width: D, height: _ }, A(D, _, s)),
                    ...
                    d = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.largeWidth && F) return i(e, t, v);
                    ...
                    h = (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(B),
                            ...
                            i = (0, r.useCallback)((u, e) => {
                                ...
                                o(Object.assign({ width: t, height: r }, A(t, r, s)));
                            }, []);
                        C(() => {
                    ...
                    return (
                        C(() => {
                            if (
                                                ...
                                                const e = v(),
                                                    ...
                                                    n =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: n, modelPath: x(n, ''), resId: r };
                                            })(),
                                            t = e.modelPrefix,
                                            r = u.split('.');
                                        if (r.length > 0) {
                                ...
                                F.current = S.addCallback(r, t, i, e === T.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (e !== T.None)
                                return () => {
                                    S.removeCallback(F.current, i);
                                };
                        }, [i, e]),
                        l
                    );
                ...
                const P = (u, e, t) => {
                    ...
                    k = (u, e, t = L.left) => u.split(e).reduce(t === L.left ? P : y, []),
                    N = (() => {
                        const u = new RegExp(
                ...
                !(function (u) {
                    (u[(u.CITY = 0)] = 'CITY'),
                        (u[(u.TASKS = 1)] = 'TASKS'),
                        (u[(u.MACHINE = 2)] = 'MACHINE'),
                        (u[(u.REWARDS = 3)] = 'REWARDS'),
                        (u[(u.PET = 4)] = 'PET'),
                        (u[(u.INFO = 5)] = 'INFO');
                })(H || (H = {})),
                    (function (u) {
                        (u[(u.DONE = 0)] = 'DONE'),
                            ...
                            (u[(u.TO_GLADE_WITH_INTRO = 2)] = 'TO_GLADE_WITH_INTRO'),
                            (u[(u.WITH_SWITCHING_OBJS = 3)] = 'WITH_SWITCHING_OBJS');
                    })(U || (U = {}));
                const W = {
                        playHighlight() {
                            G('highlight');
                ...
                ((z = j || (j = {})).main = 'main'),
                    (z.primary = 'primary'),
                    (z.primaryGreen = 'primaryGreen'),
                    (z.primaryRed = 'primaryRed'),
                    (z.secondary = 'secondary'),
                    (z.ghost = 'ghost'),
                    ((V = Y || (Y = {})).extraSmall = 'extraSmall'),
                    (V.small = 'small'),
                    (V.medium = 'medium');
                const q = ({
                    children: u,
                    ...
                    const B = (0, r.useRef)(null),
                        ...
                        f = w[1],
                        x = (0, r.useCallback)(() => {
                            o || (B.current && (B.current.focus(), C(!0)));
                        }, [o]),
                        S = (0, r.useCallback)(
                            (u) => {
                                d && null !== B.current && !B.current.contains(u.target) && C(!1);
                            },
                            [d],
                        ),
                        T = (0, r.useCallback)(
                ...
                class Z extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = p()(K.base, K[`base__${o}`], K[`base__${a}`], null == i ? void 0 : i.base),
                            _ = p()(K.icon, K[`icon__${o}`], K[`icon__${a}`], null == i ? void 0 : i.icon),
                            c = p()(K.glow, null == i ? void 0 : i.glow),
                            B = p()(K.caption, K[`caption__${o}`], null == i ? void 0 : i.caption),
                            m = p()(K.goto, null == i ? void 0 : i.goto);
                ...
                let eu, tu, ru;
                var nu;
                ((nu = eu || (eu = {}))[(nu.ExtraSmall = s.extraSmall.width)] = 'ExtraSmall'),
                    (nu[(nu.Small = s.small.width)] = 'Small'),
                    (nu[(nu.Medium = s.medium.width)] = 'Medium'),
                    (nu[(nu.Large = s.large.width)] = 'Large'),
                    (nu[(nu.ExtraLarge = s.extraLarge.width)] = 'ExtraLarge'),
                    (function (u) {
                ...
                const au = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ou = (u) => u.includes('_') && ((u) => au.includes(u))(u.split('_').at(-1)),
                    iu = [eu.ExtraLarge, eu.Large, eu.Medium, eu.Small, eu.ExtraSmall],
                    Eu = (u, e) =>
                ...
                const Du = {
                    ...
                    Bu = su((u) => {
                        let e = u.className,
                            ...
                            B = u.row,
                            m = u.flexDirection,
                            d = void 0 === m ? (c ? 'column' : B && 'row') || void 0 : m,
                            C = u.flexStart,
                            h = u.center,
                            g = u.flexEnd,
                            v = u.spaceBetween,
                            ...
                            f =
                                void 0 === b
                                    ...
                                    : b,
                            x = u.alignItems,
                            S = void 0 === x ? (C ? 'flex-start' : h && 'center') || (g && 'flex-end') || void 0 : x,
                            T = u.alignSelf,
                            M = u.wrap,
                            L = u.flexWrap,
                            ...
                            P = u.shrink,
                            y = u.flex,
                            k = void 0 === y ? (O || P ? `${O ? 1 : 0} ${P ? 1 : 0} auto` : void 0) : y,
                            N = u.style,
                            I = u.children,
                            H = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const U = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, E, l, F, _, N, k, T, d, R, f, S]),
                            G = U.computedStyle,
                            W = U.computedClassNames;
                        return n().createElement('div', Fu({ className: p()(lu.base, ...W, e), style: G }, H), I);
                    }),
                    mu = ({ binding: u, text: e = '', classMix: t, alignment: a = L.left }) =>
                        null === e
                            ...
                            : n().createElement(
                                  ...
                                  e.split('\n').map((e, o) =>
                                      n().createElement(
                                          'div',
                                          { className: p()('FormatText_base_d0', t), key: `${e}-${o}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                ...
                su((u) => {
                    ...
                    return n().createElement(
                        ...
                        pu(
                            {
                                className: p()(hu.base, t && hu[t], g, a),
                                style: h,
                                mt: !0 === s ? xu[t || 'paragraph-P16'].mt : s,
                        ...
                        void 0 !== m ? n().createElement(mu, pu({}, m, { text: e })) : e,
                    );
                }),
                    ...
                    (Hu.S80x80 = 's80x80'),
                    (Hu.S48x48 = 's48x48'),
                    ((Iu = Ru || (Ru = {})).MULTI = 'multi'),
                    (Iu.CURRENCY = 'currency'),
                    (Iu.PREMIUM_PLUS = 'premium_plus'),
                    (Iu.NUMBER = 'number'),
                    (Iu.STRING = 'string'),
                    ((Nu = Ou || (Ou = {})).BATTLE_BOOSTER = 'battleBooster'),
                    ...
                    ((ku = yu || (yu = {})).BATTLE_BOOSTER = 'battleBooster'),
                    (ku.BATTLE_BOOSTER_REPLACE = 'battleBoosterReplace'),
                    (ku.BUILT_IN_EQUIPMENT = 'builtInEquipment'),
                    (ku.EQUIPMENT_PLUS = 'equipmentPlus'),
                    (ku.EQUIPMENT_TROPHY_BASIC = 'equipmentTrophyBasic'),
                    (ku.EQUIPMENT_TROPHY_UPGRADED = 'equipmentTrophyUpgraded'),
                    (ku.EQUIPMENT_MODERNIZED_UPGRADED_1 = 'equipmentModernized_1'),
                    (ku.EQUIPMENT_MODERNIZED_UPGRADED_2 = 'equipmentModernized_2'),
                    (ku.EQUIPMENT_MODERNIZED_UPGRADED_3 = 'equipmentModernized_3'),
                    (ku.PROGRESSION_STYLE_UPGRADED_1 = 'progressionStyleUpgraded_1'),
                    (ku.PROGRESSION_STYLE_UPGRADED_2 = 'progressionStyleUpgraded_2'),
                    (ku.PROGRESSION_STYLE_UPGRADED_3 = 'progressionStyleUpgraded_3'),
                    (ku.PROGRESSION_STYLE_UPGRADED_4 = 'progressionStyleUpgraded_4');
                const Uu = [
                    'children',
                    'contentId',
                    'args',
                ...
                const Wu = (u, e, t = {}, r = 0) => {
                    ...
                    Xu = (u) => {
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            w = (0, r.useMemo)(() => d || v().resId, [d]),
                            b = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Wu(t, _, { isMouseEvent: !0, on: !0, arguments: Gu(n) }, w),
                                    C && C(),
                ...
                const Vu = R.views.common.tooltip_window.simple_tooltip_content,
                    zu = (u) => {
                        ...
                        const l = (0, r.useMemo)(() => {
                            const u = Object.assign({}, E, { body: t, header: a, note: o, alert: i });
                            ...
                            Yu(
                                {
                                    contentId:
                                        ...
                                        A ? Vu.SimpleTooltipHtmlContent('resId') : Vu.SimpleTooltipContent('resId')),
                ...
                !(function (u) {
                    ...
                    ((re = Zu || (Zu = {})).Small = 'small'),
                    (re.Medium = 'medium'),
                    (re.Big = 'big'),
                    (re.ExtraBig = 'extraBig'),
                    (re.Huge = 'huge'),
                    (function (u) {
                        (u.None = 'noAnimation'),
                    ...
                    ((te = ee || (ee = {})).ExtraSlot = 'ny22:extraSlot'),
                    (te.ToyFragments = 'ny22ToyFragments'),
                    (te.Tman = 'tmanToken'),
                    (te.AchievementReward = 'dossier_achievement'),
                    (te.Customizations = 'customizations'),
                    (te.VariadicDiscount = 'variadicDiscount'),
                    (te.MarketplaceUnlock = 'ny25_marketplace_unlock'),
                    (te.LootBoxToken = 'lootBoxToken');
                const ne = [
                    'width',
                    'height',
                    'getSrcByFrame',
                    ...
                    return (
                        (0, r.useEffect)(() => {
                            ...
                            const r = o - 1,
                                n = u.getContext('2d'),
                                i = (r) => {
                                    n.clearRect(0, 0, u.width, u.height), n.drawImage(r, 0, 0, e, t);
                                };
                            if ('stop' === B) {
                                const u = a(0),
                                    e = new Image();
                            ...
                            const s = ((u, e) => {
                                ...
                                D = setInterval(() => {
                                    const u = A(),
                                        e = s[u];
                                    i(s[u]), E(u, e), u === r && (d(), _ || clearInterval(D));
                                }, l);
                            return () => clearInterval(D);
                        }, [o, l, a, t, F, _, E, d, B, e]),
                        n().createElement('canvas', ae({}, C, { width: e, height: t, ref: h }))
                    );
                }),
                    (function (u) {
                ...
                var se, le;
                ((le = se || (se = {}))[(le.Left = 0)] = 'Left'),
                    (le[(le.Right = 1)] = 'Right'),
                    (le[(le.Top = 2)] = 'Top'),
                    (le[(le.Bottom = 3)] = 'Bottom');
                ...
                (0, r.forwardRef)(
                    ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: a = {} }, o) => {
                        const i = (0, r.useRef)(null),
                            s = (0, r.useRef)(null),
                            l = (0, r.useRef)(null),
                            A = (0, r.useState)(window.decorator && window.decorator.directionType),
                            F = A[0],
                            D = A[1],
                            _ = (0, r.useCallback)(() => {
                                W.playClick(), E.O.view.sendEvent.close();
                            }, []),
                            c = (0, r.useCallback)(() => {
                                W.playHighlight();
                            }, []),
                            B = p()(Ee.arrow, Ee[`arrow${Ae[F]}`]);
                        ie(
                            () => (
                        ...
                        const m = (0, r.useCallback)(
                                (u) => {
                                    let e = u.target;
                                    do {
                                        if (e === i.current || e === l.current) return;
                                        e = e.parentNode;
                                    } while (e);
                        ...
                        return (
                            (0, r.useImperativeHandle)(o, () => ({ updateSize: d })),
                            ie(() => {
                            ...
                            n().createElement(
                                'div',
                                { className: Ee.base, ref: s },
                                n().createElement(
                                    'div',
                                    { className: Ee.decorator },
                                    n().createElement(
                                        'div',
                                        { className: Ee.content, ref: i },
                                        u,
                                        window.decorator &&
                ...
                const ce = ['', 'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X', 'XI'],
                    Be = (u) => ce[u] || '',
                    me = () => {},
                    de = (H.CITY, H.PET, H.MACHINE, H.TASKS, 'Illustration_base_b8'),
                    Ce = (0, r.memo)(({ startLevel: u, currentLevel: e, isRange: t }) => {
                        const r = O(R.strings.ny.dialogs.vehicleHint.range(), { fromLevel: u, toLevel: e });
                        return n().createElement(
                            'div',
                            { className: de },
                            n().createElement(
                                'div',
                                { className: 'Illustration_leftImage_c7' },
                                n().createElement('div', { className: 'Illustration_range_2d' }, t ? r : u),
                            ),
                            n().createElement('div', { className: 'Illustration_arrow_94' }),
                            n().createElement('div', { className: 'Illustration_rightImage_7a' }),
                        );
                    }),
                    he = {
                        base: 'App_base_55',
                        subtitle: 'App_subtitle_96',
                        base__tiny: 'App_base__tiny_3f',
                        base__small: 'App_base__small_d2',
                        illustration: 'App_illustration_79',
                        description: 'App_description_a1',
                    },
                    ge = R.strings.ny.dialogs.vehicleHint,
                    pe = () => {
                        const u = M('model'),
                            e = u.startLevel,
                            t = u.currentLevel,
                            a = (() => {
                                ...
                                switch (!0) {
                                    ...
                                    case u.extraLarge:
                                        return Ku.Huge;
                                    default:
                                        return console.error('Unreachable media context resolution'), Ku.Tiny;
                                }
                            })(),
                            o = Be(e),
                            i = Be(t),
                            E = O(ge.subtitle(), { fromLevel: o, toLevel: i }),
                            s = O(ge.description(), { fromLevel: o }),
                            l = p()(he.base, he[`base__${a}`]);
                        return n().createElement(
                            'div',
                            { className: l },
                            n().createElement('div', { className: he.subtitle }, E),
                            n().createElement(
                                'div',
                                { className: he.illustration },
                                n().createElement(Ce, { startLevel: o, currentLevel: i, isRange: e !== t }),
                            ),
                            n().createElement('div', { className: he.description }, s),
                        );
                    };
                engine.whenReady.then(() => {
                    o().render(
                        n().createElement(h, null, n().createElement(pe, null)),
        ...
        (__webpack_require__.O = (u, e, t, r) => {
            if (!e) {
                ...
                for (E = 0; E < deferred.length; E++) {
                    for (var [e, t, r] = deferred[E], a = !0, o = 0; o < e.length; o++)
                        (!1 & r || n >= r) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(9671));
