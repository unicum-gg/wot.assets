(() => {
            ...
            7449: (e, t, n) => {
                                ...
                                ((e) =>
                                    ((e, t) =>
                                        e.split('.').reduce((e, t) => {
                                            ...
                                            return u(n) ? ((e, t) => `${e}.${t}.value`)(e, t) : `${e}.${t}`;
                                        }))(e))(_),
                            ),
                        ),
                        h = l[0],
                    ...
                    return (
                        ((e) => {
                            ...
                            if (
                                                ...
                                                const t = c(),
                                                    ...
                                                    i =
                                                        window.__feature && window.__feature !== n && n
                                                            ? `subViews.${n}`
                                                            : '';
                                                return { modelPrefix: i, modelPath: v(i, ''), resId: r };
                                            })(),
                                            n = t.modelPrefix,
                                            r = e.split('.');
                                        if (r.length > 0) {
                                ...
                                m.current = w.addCallback(r, n, s, t === E.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (t !== E.None)
                                return () => {
                                    w.removeCallback(m.current, s);
                                };
                        }, [s, t]),
                        h
                    );
                ...
                const m = () => {
                    ...
                    return i().createElement(
                        ...
                        R.strings.ny.dialogs.buyCollectionItem.price(),
                        i().createElement(
                            'div',
                            { className: 'App_shards_bc' },
                            i().createElement(p.J, {
                                value: e,
                                size: p.$.Big,
                                classMix: _()('App_shardsValue_4e'),
                                isReverse: !0,
                            }),
                        ),
                    );
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(7449));
