(() => {
    var __webpack_modules__ = {
            ...
            9916: (u, e, t) => {
                'use strict';
                t.d(e, { Sw: () => a.Z, B3: () => s, Z5: () => i.Z5, B0: () => o, ry: () => C, Sy: () => m });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            3288: (u, e, t) => {
                ...
                const B = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.smallWidth && B) return a(e, t, f);
                        if (t.extraSmallWidth && C) return a(e, t, f);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                ...
                const L = {
                    ...
                    O = (u) => {
                        ...
                        const a = w(),
                            ...
                            o = a.mediaHeight,
                            s = a.mediaSize;
                        return r().createElement('div', x({ className: h()(t, L[i], T[o], S[s]) }, n), e);
                    },
                    M = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                function G(u = N.n.NONE, e = W, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== N.n.NONE)
                            return (
                ...
                class X extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = h()(K.base, K[`base__${i}`], K[`base__${a}`], null == o ? void 0 : o.base),
                            D = h()(K.icon, K[`icon__${i}`], K[`icon__${a}`], null == o ? void 0 : o.icon),
                            d = h()(K.glow, null == o ? void 0 : o.glow),
                            B = h()(K.caption, K[`caption__${i}`], null == o ? void 0 : o.caption),
                            C = h()(K.goto, null == o ? void 0 : o.goto);
                        ...
                        const v = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (J(t, D, { isMouseEvent: !0, on: !0, arguments: Q(r) }, f),
                                    m && m(),
                ...
                const su = { gold: 'gold', integral: 'integral' },
                    Eu = { [su.gold]: I.B3.GOLD, [su.integral]: I.B3.INTEGRAL };
                function lu(u, e = su.integral) {
                    return I.Z5.getNumberFormat(u, Eu[e]);
                }
                lu.type = su;
                const Au = { number: lu },
                    Fu = {
                ...
                const Cu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    hu = (u, e, t = du.left) => u.split(e).reduce(t === du.left ? _u : mu, []),
                    gu = (() => {
                        const u = new RegExp(
                    ...
                    fu = (u, e = du.left) => {
                        ...
                        return ((u, e = du.left) => {
                            ...
                            const n =
                                ...
                                r = Cu(u);
                            return (hu(r, /( )/, e).forEach((u) => (t = t.concat(hu(u, n, du.left)))), t);
                        })(u, e);
                    };
                var bu = t(8613);
                ...
                const yu = pu;
                var xu = t(7030);
                const Lu = { enter: 'translateY(100%)', reduce: 'translateY(-100%)', none: 'translateY(0%)' },
                    Tu = { leave: 'translateY(0%)', reduce: 'translateY(0%)', none: 'translateY(-100%)' },
                    Su = ({ value: u, enterType: e, exitType: t }) => {
                        const n = r().useState(Au.number(u)),
                            a = n[0],
                            i = n[1];
                        r().useEffect(() => {
                            'none' !== t && i('');
                        ...
                        const o = r().useMemo(() => a.split('').map((u) => ({ char: u, key: Symbol() })), [a]),
                            s = (0, xu.useTransition)(o, {
                                from: { transform: Lu[e], opacity: 'none' === e ? 1 : 0 },
                                enter: { transform: 'translateY(0%)', opacity: 1 },
                                leave: { transform: Tu[t], opacity: 0 },
                                keys: o.map((u) => u.key),
                                trail: 200,
                            });
                        return r().createElement(
                            ...
                            s((u, e) =>
                                r().createElement(
                                    xu.animated.div,
                                    { className: h()(Fu.char, Fu[`char__${t}`]), style: u },
                                    e.char,
                                ),
                            ),
                        );
                ...
                const Ou = ({
                    ...
                    const s = r().useState(e),
                        ...
                        A = r().useRef(null),
                        F = null != (o = yu(E)) ? o : E,
                        c = r().useMemo(() => Symbol(), [E]);
                    r().useEffect(() => {
                        const u = A.current;
                        if (u)
                            return (
                                u.classList.remove(Fu.base__reduce),
                                u.classList.remove(Fu.base__increase),
                                ((u) => {
                                    let e,
                                        t = null;
                                    return (
                                    ...
                                    F > e
                                        ? (u.classList.add(Fu.base__reduce),
                                          cu(() => {
                                              l(e);
                                          }, 50))
                                        : F < e
                                          ? (u.classList.add(Fu.base__increase),
                                            cu(() => {
                                                l(e);
                                            }, 200))
                                          : void 0,
                    ...
                    const D = (0, xu.useTransition)(E, {
                        from: { opacity: E === F ? 1 : 0 },
                        enter: { opacity: 1 },
                        leave: { opacity: 0 },
                        keys: () => c,
                    ...
                    return r().createElement(
                        ...
                        r().createElement(
                            'div',
                            { className: h()(Fu.icon, null == a ? void 0 : a.icon) },
                            r().createElement('div', { className: h()(Fu.iconEffect, Fu.iconEffect__reduce) }),
                            r().createElement('div', { className: h()(Fu.iconEffect, Fu.iconEffect__increase) }),
                            r().createElement('div', { className: h()(Fu.increaseParticles) }),
                        ),
                        r().createElement(
                            'div',
                            { className: h()(Fu.value, null == a ? void 0 : a.value) },
                            D((u, e, t) =>
                                r().createElement(
                                    xu.animated.div,
                                    { className: Fu.valueWrapper, style: u },
                                    r().createElement(Su, { value: e, enterType: ku(E, F), exitType: Mu(E, e, t) }),
                                ),
                            ),
                            r().createElement('div', { className: Fu.value__ghost }, Au.number(E)),
                        ),
                    );
                };
                function Mu(u, e, t) {
                ...
                const Pu = r().memo((u) => {
                        if (u.withAnimation) return r().createElement(Ou, u);
                        const e = u.type,
                            t = u.size,
                            n = void 0 === t ? Ru.Default : t,
                            a = u.isReverse,
                            i = u.isNotEnough,
                            o = u.classNames,
                            s = u.className,
                        ...
                        return r().createElement(
                            ...
                            r().createElement('div', { className: h()(Fu.icon, null == o ? void 0 : o.icon) }),
                            void 0 !== E &&
                                r().createElement(
                                    'div',
                                    {
                                        className: h()(
                                            Fu.value,
                                            i && Fu.value__notEnough,
                                            null == o ? void 0 : o.value,
                                        ),
                                    },
                                    u.additionalValue,
                                    A ? R.strings.ny.common.dashes() : Au.number(E),
                                ),
                        );
                    }),
                ...
                const Iu = R.views.common.tooltip_window.simple_tooltip_content,
                    ...
                    Gu = 'ResourcePanel_base_1e',
                    Uu = 'ResourcePanel_item_83',
                    ju = 'ResourcePanel_count_8d',
                    Vu = R.strings.ny.resourceTooltip.unavailable,
                    $u = ({ resources: u, isWalletAvailable: e = !0, hasAnimation: t = !1 }) =>
                        r().createElement(
                            Wu,
                            { header: Vu.header(), body: Vu.body(), isEnabled: !e },
                            r().createElement(
                                'div',
                                { className: Gu },
                    ...
                    zu = 'BaseWithResources_base_b2',
                    Ku = 'BaseWithResources_vignette_34',
                    Yu = 'BaseWithResources_closeButton_a6',
                    qu = 'BaseWithResources_resources_55',
                    Xu = 'BaseWithResources_content_7e',
                    Zu = ({ resources: u, hasCloseButton: e = !0, isWalletAvailable: t, children: n }) =>
                        r().createElement(
                            'div',
                            { className: zu, lang: R.strings.settings.LANGUAGE_CODE() },
                            ...
                            r().createElement(
                                'div',
                                { className: qu },
                                r().createElement($u, { resources: u, isWalletAvailable: t }),
                            ),
                            r().createElement('div', { className: Xu }, n),
                        );
                function Qu() {
                    return !1;
                }
                ...
                const re = ((u, e) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: o, children: s, mocks: E }) {
                                const l = (0, n.useRef)([]),
                                    ...
                                    D = c[0],
                                    d = c[1],
                                    B = (0, n.useState)(() => A(a, o, E)),
                                    C = B[0],
                                    _ = B[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        F.current ? _(A(D, o, E)) : (F.current = !0);
                                    }, [E, D, o]),
                                    (0, n.useEffect)(() => {
                                        d(a);
                                    }, [a]),
                        ...
                        ({ observableModel: u }) => {
                            const e = {
                                    ...
                                    resourceFrom: u.object('resourceFrom'),
                                    resourceTo: u.object('resourceTo'),
                                },
                                t = (0, ne.Om)(() => {
                                    return (
                                        (u = e.resources.get()),
                                ...
                                n = (0, ne.Om)(() => {
                                    const u = e.resourceFrom.get();
                                    return { type: u.type, value: u.value };
                                }),
                                r = (0, ne.Om)(() => {
                                    const u = e.resourceTo.get();
                                    return { type: u.type, value: u.value };
                                }),
                                a = (0, ne.Om)((u) => t().find((e) => e.type === u)),
                                i = (0, ne.Om)(() => {
                                    var u, e;
                                    const t = n(),
                                        r = t.type,
                                        i = t.value;
                                    return (null != (u = null == (e = a(r)) ? void 0 : e.value) ? u : 0) >= i;
                                }),
                                o = (0, ne.Om)(() => {
                                    const u = n();
                                    return { resourceType: u.type, price: u.value };
                                });
                            return {
                                root: e.root,
                                computes: {
                    ...
                    se = ({ binding: u, text: e = '', classMix: t, alignment: a = du.left, formatWithBrackets: i }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const o = i && u ? Bu(e, u) : e;
                        return r().createElement(
                            n.Fragment,
                            null,
                            o.split('\n').map((e, i) =>
                    ...
                    Ee = 'Separator_base_bd',
                    le = ({ classNames: u }) => r().createElement('div', { className: h()(Ee, u) }),
                    Ae = {
                ...
                const De = ({
                    ...
                    return (
                        (0, n.useEffect)(() => {
                            function u(u) {
                                _ && null !== B.current && !B.current.contains(u.target) && m(!1);
                            }
                            return (
                ...
                const he = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        const a = e.contentId;
                        return a ? r().createElement(uu, me({}, e, { contentId: a }), n) : r().createElement(_e, e, n);
                    },
                    ge = 'Footer_base_39',
                    ve = 'Footer_button_68',
                    fe = R.strings.ny.resourcesConvertDialog.button,
                    be = (u, e, t) =>
                        e
                            ? u
                                ? {
                                ...
                                : void 0
                            : { header: fe.disabledTooltip.header(), body: fe.disabledTooltip.body() },
                    pe = (0, $.Pi)(() => {
                        const u = ie(),
                            e = u.model,
                            t = u.controls,
                            n = e.root.get().isWalletAvailable,
                            a = e.computes,
                            i = a.getIsEnough,
                            o = a.getLackTheResTooltipArgs;
                        return r().createElement(
                            'div',
                            { className: ge },
                            r().createElement(
                                ...
                                r().createElement(
                                    he,
                                    { tooltipArgs: be(!i(), n, o()) },
                                    r().createElement(
                                        de,
                                        { size: ce.medium, onClick: t.accept, disabled: !n || !i() },
                                        fe.accept(),
                                    ),
                                ),
                            ),
                            r().createElement(
                                de,
                                { type: Fe.secondary, size: ce.medium, onClick: t.cancel, mixClass: ve },
                                fe.cancel(),
                            ),
                        );
                    }),
                    we = 'Content_base_de',
                    ye = 'Content_convertIcon_60',
                    xe = 'Content_titleBox_e8',
                    Le = 'Content_title_80',
                    Te = 'Content_count_c9',
                    Se = 'Content_count__notEnough_ac',
                    Re = 'Content_separator_75';
                function Oe() {
                    return (
                        (Oe = Object.assign
                            ? Object.assign.bind()
                ...
                const Me = R.strings.ny.resourcesConvertDialog,
                    ke = { size: Ru.s32, isReverse: !0 },
                    Pe = (0, $.Pi)(() => {
                        const u = ie().model.computes,
                            e = u.resourceFrom,
                            t = u.resourceTo,
                            n = u.getIsEnough;
                        return r().createElement(
                                ...
                                r().createElement(se, {
                                    ...
                                    binding: {
                                        from: r().createElement(
                                            Pu,
                                            Oe({}, ke, e(), { classNames: { value: h()(Te, !n() && Se) } }),
                                        ),
                                        to: r().createElement(Pu, Oe({}, ke, t(), { classNames: { value: Te } })),
                                    },
                                    classMix: Le,
                                }),
                            ),
                            r().createElement(le, { classNames: Re }),
                    ...
                    He = (0, $.Pi)(() => {
                        const u = ie(),
                            ...
                            t = u.controls.accept,
                            n = e.root.get().isWalletAvailable,
                            a = e.computes.getResources();
                        return (
                            V({ [N.n.ENTER]: t, [N.n.SPACE]: t }),
                            U(),
                            r().createElement(Zu, { resources: a, isWalletAvailable: n }, r().createElement(Pe, null))
                        );
                    });
                engine.whenReady.then(() => {
                    H().render(
                        r().createElement(k, null, r().createElement(ae, null, r().createElement(He, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(3288));
