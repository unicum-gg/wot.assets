(() => {
    var __webpack_modules__ = {
            ...
            3649: (u, e, t) => {
                ...
                const i = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    l = (u, e, t = r.left) => u.split(e).reduce(t === r.left ? o : s, []),
                    E = (() => {
                        const u = new RegExp(
            ...
            9916: (u, e, t) => {
                'use strict';
                t.d(e, { Sw: () => a.Z, B3: () => s, Z5: () => i.Z5, B0: () => o, ry: () => B, Sy: () => m });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
                ...
                const l = (0, r.memo)((u) => {
                    ...
                    const E = ((u, e) => {
                            ...
                            for (; l; ) {
                                ...
                                if (D && d) {
                                    const u = D[0],
                                        t = u + c++ + d[0].replaceAll(')', '') + u;
                                    ((E = E.replace(F, `%(${t})`)),
                                        (s[t] = i[u]
                                            ? a().createElement(
                                                  'span',
                                                  { className: i[u] },
                                                  a().createElement(n.z, { text: _, binding: e }),
                                              )
                                            : a().createElement(
                                                  'span',
                                                  { style: ((A = u), { color: `#${A}` }) },
                        ...
                        c = E[0],
                        A = E[1];
                    return a().createElement(n.z, s({ text: c, classMix: r, binding: A }, l));
                });
            },
            1421: (u, e, t) => {
                'use strict';
                ...
                const S = {
                    ...
                    M = (u) => {
                        ...
                        const a = w(),
                            ...
                            o = a.mediaHeight,
                            s = a.mediaSize;
                        return r().createElement('div', y({ className: h()(t, S[i], L[o], T[s]) }, n), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                function G(u = H.n.NONE, e = I, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== H.n.NONE)
                            return (
                ...
                class Y extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            F = h()(V.base, V[`base__${i}`], V[`base__${a}`], null == o ? void 0 : o.base),
                            D = h()(V.icon, V[`icon__${i}`], V[`icon__${a}`], null == o ? void 0 : o.icon),
                            d = h()(V.glow, null == o ? void 0 : o.glow),
                            _ = h()(V.caption, V[`caption__${i}`], null == o ? void 0 : o.caption),
                            B = h()(V.goto, null == o ? void 0 : o.goto);
                        ...
                        const v = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (Q(t, D, { isMouseEvent: !0, on: !0, arguments: X(r) }, f),
                                    m && m(),
                ...
                const ou = { gold: 'gold', integral: 'integral' },
                    su = { [ou.gold]: W.B3.GOLD, [ou.integral]: W.B3.INTEGRAL };
                function lu(u, e = ou.integral) {
                    return W.Z5.getNumberFormat(u, su[e]);
                }
                lu.type = ou;
                const Eu = { number: lu },
                    cu = {
                ...
                const _u = Du;
                var Bu = t(7030);
                const Cu = { enter: 'translateY(100%)', reduce: 'translateY(-100%)', none: 'translateY(0%)' },
                    mu = { leave: 'translateY(0%)', reduce: 'translateY(0%)', none: 'translateY(-100%)' },
                    hu = ({ value: u, enterType: e, exitType: t }) => {
                        ...
                        const o = r().useMemo(() => a.split('').map((u) => ({ char: u, key: Symbol() })), [a]),
                            s = (0, Bu.useTransition)(o, {
                                from: { transform: Cu[e], opacity: 'none' === e ? 1 : 0 },
                                enter: { transform: 'translateY(0%)', opacity: 1 },
                                leave: { transform: mu[t], opacity: 0 },
                                keys: o.map((u) => u.key),
                                trail: 200,
                            });
                        return r().createElement(
                            ...
                            s((u, e) =>
                                r().createElement(
                                    Bu.animated.div,
                                    { className: h()(cu.char, cu[`char__${t}`]), style: u },
                                    e.char,
                                ),
                            ),
                        );
                ...
                const vu = ({
                    ...
                    var o;
                    const s = r().useState(e),
                        l = s[0],
                        E = s[1],
                        c = r().useRef(null),
                        A = null != (o = _u(l)) ? o : l,
                        F = r().useMemo(() => Symbol(), [l]);
                    r().useEffect(() => {
                        const u = c.current;
                        if (u)
                            return (
                                u.classList.remove(cu.base__reduce),
                                u.classList.remove(cu.base__increase),
                                ((u) => {
                                    let e,
                                        t = null;
                                    return (
                                    ...
                                    A > e
                                        ? (u.classList.add(cu.base__reduce),
                                          Au(() => {
                                              E(e);
                                          }, 50))
                                        : A < e
                                          ? (u.classList.add(cu.base__increase),
                                            Au(() => {
                                                E(e);
                                            }, 200))
                                          : void 0,
                    ...
                    return r().createElement(
                        ...
                        r().createElement(
                            'div',
                            { className: h()(cu.icon, null == a ? void 0 : a.icon) },
                            r().createElement('div', { className: h()(cu.iconEffect, cu.iconEffect__reduce) }),
                            r().createElement('div', { className: h()(cu.iconEffect, cu.iconEffect__increase) }),
                            r().createElement('div', { className: h()(cu.increaseParticles) }),
                        ),
                        r().createElement(
                            'div',
                            { className: h()(cu.value, null == a ? void 0 : a.value) },
                            D((u, e, t) =>
                                r().createElement(
                                    Bu.animated.div,
                                    { className: cu.valueWrapper, style: u },
                                    r().createElement(hu, { value: e, enterType: bu(l, A), exitType: fu(l, e, t) }),
                                ),
                            ),
                            r().createElement('div', { className: cu.value__ghost }, Eu.number(l)),
                        ),
                    );
                };
                function fu(u, e, t) {
                ...
                const pu = r().memo((u) => {
                        if (u.withAnimation) return r().createElement(vu, u);
                        const e = u.type,
                            t = u.size,
                            n = void 0 === t ? gu.Default : t,
                            a = u.isReverse,
                            i = u.isNotEnough,
                            o = u.classNames,
                            s = u.className,
                        ...
                        return r().createElement(
                            ...
                            r().createElement('div', { className: h()(cu.icon, null == o ? void 0 : o.icon) }),
                            void 0 !== l &&
                                r().createElement(
                                    'div',
                                    {
                                        className: h()(
                                            cu.value,
                                            i && cu.value__notEnough,
                                            null == o ? void 0 : o.value,
                                        ),
                                    },
                                    u.additionalValue,
                                    c ? R.strings.ny.common.dashes() : Eu.number(l),
                                ),
                        );
                    }),
                ...
                const yu = R.views.common.tooltip_window.simple_tooltip_content,
                    ...
                    Lu = 'ResourcePanel_base_1e',
                    Tu = 'ResourcePanel_item_83',
                    Mu = 'ResourcePanel_count_8d',
                    Ru = R.strings.ny.resourceTooltip.unavailable,
                    Ou = ({ resources: u, isWalletAvailable: e = !0, hasAnimation: t = !1 }) =>
                        r().createElement(
                            Su,
                            { header: Ru.header(), body: Ru.body(), isEnabled: !e },
                            r().createElement(
                                'div',
                                { className: Lu },
                                u.map(({ type: u, value: n }) =>
                                    r().createElement(
                                        'div',
                                        { key: u, className: Tu },
                                        r().createElement(
                    ...
                    ku = 'BaseWithResources_base_b2',
                    Pu = 'BaseWithResources_vignette_34',
                    Nu = 'BaseWithResources_closeButton_a6',
                    Hu = 'BaseWithResources_resources_55',
                    Wu = 'BaseWithResources_content_7e',
                    Iu = ({ resources: u, hasCloseButton: e = !0, isWalletAvailable: t, children: n }) =>
                        r().createElement(
                            'div',
                            { className: ku, lang: R.strings.settings.LANGUAGE_CODE() },
                            ...
                            r().createElement(
                                'div',
                                { className: Hu },
                                r().createElement(Ou, { resources: u, isWalletAvailable: t }),
                            ),
                            r().createElement('div', { className: Wu }, n),
                        );
                let Gu;
                !(function (u) {
                    ((u.Default = 'default'), (u.Purchasing = 'purchasing'), (u.Error = 'error'));
                })(Gu || (Gu = {}));
                function Uu() {
                    return !1;
                }
                ...
                const qu = ((u, e) => {
                        ...
                        ({ observableModel: u }) => {
                            const e = {
                                ...
                                n = (0, Ku.Om)(() => {
                                    const u = e.price.get();
                                    return { type: u.type, value: u.value };
                                });
                            return { root: e.root, computes: { getResources: t, price: n } };
                        },
                        ({ externalModel: u }) => ({
                    ...
                    Yu = qu[0],
                    Zu = qu[1],
                    Xu = 'Separator_base_bd',
                    Qu = ({ classNames: u }) => r().createElement('div', { className: h()(Xu, u) });
                var Ju = t(406);
                let ue;
                !(function (u) {
                    ((u[(u.Ultra = 0)] = 'Ultra'),
                            ...
                            (0, n.useEffect)(() => {
                                ...
                                const l = ((u, e) => {
                                    ...
                                    F = setInterval(() => {
                                        const u = c(),
                                            e = l[u];
                                        (o(l[u]), s(u, e), u === n && (C(), D || clearInterval(F)));
                                    }, E);
                                return () => clearInterval(F);
                            }, [i, E, a, t, A, D, s, C, _, e]),
                            r().createElement('canvas', oe({}, m, { width: e, height: t, ref: h }))
                        );
                    }),
                    le = 'GodRays_base_26',
                    Ee = 'GodRays_expander_d0',
                    ce = 'GodRays_canvas_7d',
                    Ae = (u) =>
                        `R.images.gui.maps.icons.sequence.sun_shine_with_particles.reward_glow${u.toString().padStart(4, '0')}`,
                    Fe = r().memo(({ className: u, width: e = 400, height: t = 400 }) =>
                        r().createElement(
                            'div',
                            { className: le },
                            r().createElement('div', { className: h()(Ee, u) }),
                            r().createElement(se, {
                                width: e,
                                height: t,
                                frameCount: 49,
                ...
                const _e = (0, n.memo)(function ({ size: u, hasBlink: e, displayGodrays: t = !0, classNames: n }) {
                        return r().createElement(
                            'div',
                            { className: h()(De.base, De[`base__${u}`], null == n ? void 0 : n.base) },
                            r().createElement('div', { className: h()(De.icon, null == n ? void 0 : n.icon) }),
                            t &&
                                !1 === te() &&
                                r().createElement(
                                    'div',
                                    { className: h()(De.godRays, null == n ? void 0 : n.godRays) },
                                    r().createElement(Fe, null),
                                ),
                            e &&
                                r().createElement(
                                    'div',
                                    { className: De.blinkShape },
                                    r().createElement('div', { className: De.blink }),
                                ),
                        );
                    }),
                    Be = 'Error_base_bb',
                ...
                const be = ({
                    ...
                    return (
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                'span',
                                { className: h()(ge.state, ge.state__default) },
                ...
                be.defaultProps = { type: ve.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const pe = be;
                var we = t(280);
                const xe = 'Footer_base_2f',
                    ye = 'Footer_price_68',
                    Se = 'Footer_resource_e2',
                    Le = 'Footer_icon_50',
                    Te = 'Footer_buttons_0e',
                    Me = 'Footer_button_2a',
                    Re = 'Footer_button__purchasing_5c',
                    Oe = 'Footer_buttonText_f0',
                    ke = 'Footer_spinner_c9',
                    Pe = R.strings.ny.giftMachineTokenPurchaseDialog,
                    Ne = (0, z.Pi)(() => {
                        const u = Zu(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return r().createElement(
                            ...
                            r().createElement(we.z, {
                                text: Pe.price(),
                                binding: {
                                    price: r().createElement(pu, {
                                        type: s,
                                        isReverse: !0,
                                        value: l,
                                        size: gu.s32,
                                        classNames: { value: Se, icon: Le },
                                    }),
                                },
                                classMix: ye,
                            }),
                            r().createElement(
                                ...
                                r().createElement(
                                    Su,
                                    {
                                        header: Pe.button.disabledTooltip.title(),
                                        body: Pe.button.disabledTooltip.description(),
                                        isEnabled: !i,
                                    },
                                    r().createElement(
                                        'div',
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        pe,
                                        { type: ve.secondary, size: fe.medium, onClick: t.cancel, disabled: E },
                                        Pe.button.cancel(),
                                    ),
                                ),
                            ),
                    ...
                    He = 'Content_base_cc',
                    We = 'Content_godRays_dc',
                    Ie = 'Content_titleBox_b6',
                    Ge = 'Content_title_62',
                    Ue = 'Content_separator_d9',
                    je = 'Content_error_cd',
                    ze = R.strings.ny.giftMachineTokenPurchaseDialog,
                    $e = (0, z.Pi)(() => {
                        ...
                        return r().createElement(
                            'div',
                            { className: He },
                            r().createElement(_e, { size: de.S180x135, classNames: { godRays: We } }),
                            r().createElement(
                                'div',
                                { className: Ie },
                                r().createElement(Ju.B, {
                                    text: ze.$plural('title', t),
                                    className: Ge,
                                    binding: { amount: t },
                                }),
                            ),
                            e === Gu.Error && r().createElement(he, { message: ze.error(), classNames: je }),
                            r().createElement(Qu, { classNames: Ue }),
                    ...
                    Ve = (0, z.Pi)(() => {
                        const u = Zu(),
                            ...
                            t = u.controls.accept,
                            n = e.root.get(),
                            a = n.isWalletAvailable,
                            i = n.dialogState,
                            o = e.computes.getResources(),
                            s = i === Gu.Purchasing,
                            l = () => {
                                !s && a && t();
                            };
                        ...
                        return (
                            ...
                            r().createElement(
                                Iu,
                                { resources: o, hasCloseButton: !s, isWalletAvailable: a },
                ...
                engine.whenReady.then(() => {
                    N().render(
                        r().createElement(k, null, r().createElement(Yu, null, r().createElement(Ve, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(1421));
