(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => a, off: () => o, on: () => D, onResize: () => n, onScaleUpdated: () => F }));
                var E = t(2472),
                    A = t(1176);
            ...
            3138: (u, e, t) => {
                ...
                var E = t(5959),
                    A = t(514);
                const n = { view: t(7641), client: E, sound: A.ZP };
            },
            514: (u, e, t) => {
                t.d(e, { ZP: () => F });
                var E = t(5959);
                const A = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    n = Object.keys(A).reduce((u, e) => ((u[e] = () => (0, E.playSound)(A[e])), u), {}),
                    F = { play: Object.assign({}, n, { sound: E.playSound }), setRTPC: E.setRTPC };
            },
            3722: (u, e, t) => {
                function E(u, e, t = 1) {
            ...
            9916: (u, e, t) => {
                ...
                function c(u, e, t, E, A, n, F) {
                    ...
                    D.done ? e(o) : Promise.resolve(o).then(E, A);
                }
                ...
                const h = A.instance,
                    b = {
                        ...
                        sendShowContextMenuEvent: (u, e, t = 0) => {
                            d(D.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                        },
                        sendShowPopOverEvent: (u, e, t, E, A = R.invalid('resId'), n) => {
                            const F = s.O.view.getViewGlobalPosition(),
                                ...
                                B = o.height,
                                C = {
                                    x: s.O.view.pxToRem(r) + F.x,
                                    y: s.O.view.pxToRem(a) + F.y,
            ...
            1678: (u, e, t) => {
                ...
                const s = ({
                    ...
                    return (
                        ...
                        A().createElement(
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    F ||
                                        (null !== s && r(s),
                                        l && l(u),
                                        t && (F || (m.current && (m.current.focus(), b(!0)))),
                                        g(!0));
                                },
                            ...
                            A().createElement(
                                'span',
                                { className: o()(a.state, a.state__default) },
                ...
                s.defaultProps = { type: i.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const C = s;
                var c = t(1281);
                let l;
                function _(u, e) {
                ...
                const d = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    p = (u, e, t = l.left) => u.split(e).reduce(t === l.left ? v : m, []),
                    h = (() => {
                        const u = new RegExp(
                    ...
                    g = ({ binding: u, text: e = '', classMix: t, alignment: n = l.left, formatWithBrackets: F }) => {
                ...
                class S extends A().PureComponent {
                        ...
                        (super(...u),
                            ...
                            (this._onMouseEnter = (u) => (e) => {
                                (u && u(e),
                                    ...
                                    this.props.soundHover && r(this.props.soundHover));
                            }),
                            ...
                            (this._onMouseDown = (u) => (e) => {
                                (u && u(e),
                                    ...
                                    this.props.soundClick && r(this.props.soundClick));
                            }),
                            (this._onMouseUp = (u) => (e) => {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            C = o()(T.base, T[`base__${F}`], T[`base__${n}`], null == D ? void 0 : D.base),
                            c = o()(T.icon, T[`icon__${F}`], T[`icon__${n}`], null == D ? void 0 : D.icon),
                            l = o()(T.glow, null == D ? void 0 : D.glow),
                            _ = o()(T.caption, T[`caption__${F}`], null == D ? void 0 : D.caption),
                            d = o()(T.goto, null == D ? void 0 : D.goto);
                        return A().createElement(
                            'div',
                            P(
                                {
                            ...
                            'info' !== F && A().createElement('div', { className: T.shine }),
                ...
                function H(u = k.n.NONE, e = U, t = !1, A = !1) {
                    (0, E.useEffect)(() => {
                        if (u !== k.n.NONE)
                            return (
                        ...
                        function E(E) {
                            if (E.keyCode === u) {
                                ...
                                (L.O.view.setEventHandled(), e(E), t && E.stopPropagation());
                            }
                        }
                    }, [e, u, t, A]);
                }
                ...
                const X = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: F, children: D, mocks: o }) {
                                const r = (0, E.useRef)([]),
                                    a = (t, E, A) => {
                                        var n;
                                        const F = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, n) => {
                                                        const D = 'string' == typeof n ? `${E}.${n}` : E,
                                                            o = L.O.view.addModelObserver(D, e, !0);
                                                        return (A.set(o, t), u && t(F(n)), o);
                                                    },
                                                    readByPath: F,
                                                    createCallback: (u, e) => {
                                                        const t = F(e);
                                            ...
                                            B = { mode: t, model: i, externalModel: D, cleanup: a };
                                        return {
                                            model: i,
                                    ...
                                    s = B[0],
                                    C = B[1],
                                    c = (0, E.useState)(() => a(n, F, o)),
                                    l = c[0],
                                    _ = c[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        i.current ? _(a(s, F, o)) : (i.current = !0);
                                    }, [o, s, F]),
                                    (0, E.useEffect)(() => {
                                        C(n);
                                    }, [n]),
                                    ...
                                    A().createElement(t.Provider, { value: l }, D)
                                );
                            },
                            () => (0, E.useContext)(t),
                        ];
                    ...
                    Fu = 'App_buttons_0b',
                    Du = 'App_button_17',
                    ou = R.strings.ny.challenge.dialogs.replacement,
                    ru = (0, x.Pi)(() => {
                        const u = J(),
                            e = u.model,
                            t = u.controls,
                            E = e.root.get(),
                            n = E.taskSwitchType,
                            F = E.availableReplacements;
                        return (
                            O({ [k.n.ENTER]: t.accept, [k.n.SPACE]: t.accept }),
                            A().createElement(
                                K,
                                null,
                                A().createElement(
                                    ...
                                    A().createElement('div', { className: tu }, ou.title.$dyn(n)),
                                    A().createElement('div', { className: tu }, ou.description()),
                                    A().createElement('div', { className: Eu }),
                                    A().createElement(g, {
                                        text: ou.counter(),
                                        binding: { count: A().createElement('div', { className: nu }, F) },
                                        classMix: Au,
                                    }),
                                    A().createElement(
                                        'div',
                                        ...
                                        A().createElement(
                                            C,
                                            { size: B.medium, onClick: t.accept, mixClass: Du },
                                            ou.apply(),
                                        ),
                                        A().createElement(
                                            C,
                                            { type: i.secondary, size: B.medium, onClick: t.cancel, mixClass: Du },
                                            ou.reject(),
                                        ),
                                    ),
                                ),
                ...
                engine.whenReady.then(() => {
                    F().render(
                        A().createElement(Q, null, A().createElement(ru, null)),
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (o = 0; o < deferred.length; o++) {
                    for (var [e, t, E] = deferred[o], n = !0, F = 0; F < e.length; F++)
                        (!1 & E || A >= E) &&
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    if (n.some((e) => 0 !== u[e])) {
                        ...
                        if (D) var r = D(__webpack_require__);
                    }
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(1678));
