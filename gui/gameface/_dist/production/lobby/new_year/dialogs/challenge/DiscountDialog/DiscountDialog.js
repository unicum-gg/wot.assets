(() => {
    ...
    var __webpack_modules__ = {
                ...
                const D = ({
                    ...
                    return o().createElement(
                        ...
                        a.split('\n').map((e, D) =>
                            o().createElement(
                                'div',
                                { className: E()(r.Z.base, t), key: `${e}-${D}` },
                                (0, A.Uw)(e, n, u).map((u, e) =>
                                    o().createElement(F.Fragment, { key: `${e}-${u}` }, u),
                                ),
                            ),
                        ),
                    );
            ...
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => a, off: () => r, on: () => o, onResize: () => A, onScaleUpdated: () => F }));
                var n = t(2472),
                    E = t(1176);
            ...
            3649: (u, e, t) => {
                ...
                const o = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    a = (u, e, t = E.left) => u.split(e).reduce(t === E.left ? r : D, []),
                    i = (() => {
                        const u = new RegExp(
            ...
            9916: (u, e, t) => {
                ...
                function c(u, e, t, n, E, A, F) {
                    ...
                    o.done ? e(r) : Promise.resolve(r).then(n, E);
                }
                        ...
                        sendShowPopOverEvent: (u, e, t, n, E = R.invalid('resId'), A) => {
                            const F = B.O.view.getViewGlobalPosition(),
                                ...
                                C = {
                                    ...
                                    y: B.O.view.pxToRem(a) + F.y,
                                    width: B.O.view.pxToRem(i),
                ...
                const D = (0, E.memo)((u) => {
                    ...
                    const a = ((u, e) => {
                            ...
                            for (; D;) {
                                ...
                                if (C && c) {
                                    const u = C[0],
                                        t = u + i++ + c[0].replaceAll(')', '') + u;
                                    ((a = a.replace(B, `%(${t})`)),
                                        (r[t] = F[u]
                                            ? A().createElement(
                                                  'span',
                                                  { className: F[u] },
                                                  A().createElement(n.z, { text: l, binding: e }),
                                              )
                                            : A().createElement(
                                                  'span',
                                                  { style: ((s = u), { color: `#${s}` }) },
                        ...
                        i = a[0],
                        s = a[1];
                    return A().createElement(n.z, r({ text: i, classMix: E, binding: s }, D));
                });
            },
            8597: (u, e, t) => {
                var n = t(6179),
                ...
                B.defaultProps = { type: i.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const C = B;
                let c;
                !(function (u) {
                    ((u[(u.Space = 32)] = 'Space'),
                ...
                class f extends E().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            C = r()(h.base, h[`base__${F}`], h[`base__${A}`], null == o ? void 0 : o.base),
                            c = r()(h.icon, h[`icon__${F}`], h[`icon__${A}`], null == o ? void 0 : o.icon),
                            l = r()(h.glow, null == o ? void 0 : o.glow),
                            _ = r()(h.caption, h[`caption__${F}`], null == o ? void 0 : o.caption),
                            d = r()(h.goto, null == o ? void 0 : o.goto);
                        return E().createElement(
                            ...
                            E().createElement('div', { className: _ }, e),
                ...
                function x(u = _.n.NONE, e = y, t = !1, E = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== _.n.NONE)
                            return (
                        ...
                        function n(n) {
                            if (n.keyCode === u) {
                                if (!E && g.O.view.isEventHandled()) return;
                ...
                function O() {
                    !(function (u = _.n.ESCAPE) {
                        x(u, w.Sy, !0);
                    })(_.n.ESCAPE);
                }
                const T = 'Base_base_c5',
                    k = 'Base_vignette_25',
                    P = 'Base_closeButton_5f',
                    M = 'Base_content_db',
                    S = ({ children: u }) => (
                        O(),
                        E().createElement(
                            ...
                            E().createElement('div', { className: M }, u),
                        )
                    );
                function L() {
                    return !1;
                ...
                const j = ((u, e) => {
                        ...
                        return [
                            function ({ mode: A = 'real', options: F, children: o, mocks: r }) {
                                const D = (0, n.useRef)([]),
                                    a = (t, n, E) => {
                                        var A;
                                        const F = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, A) => {
                                                        const o = 'string' == typeof A ? `${n}.${A}` : n,
                                                            r = g.O.view.addModelObserver(o, e, !0);
                                                        return (E.set(r, t), u && t(F(A)), r);
                                                    },
                                                    readByPath: F,
                                                    createCallback: (u, e) => {
                                                        const t = F(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = U(E.keys()); !(u = t()).done;) A(u.value, e);
                                                    },
                                                    unsubscribe: A,
                                                };
                                            })(n),
                                            ...
                                            r = (u) =>
                                                'mocks' === t ? (null == E ? void 0 : E.getter(u)) : o.readByPath(u),
                                            ...
                                            i = u({
                                                ...
                                                observableModel: {
                                                    array: (u, e) => {
                                                        const n = null != e ? e : r(u),
                                                            E = N.LO.box(n, { equals: L });
                                                        return (
                                                            'real' === t &&
                                                                o.subscribe(
                                                                    (0, N.aD)((u) => E.set(u)),
                                            ...
                                            s = { mode: t, model: i, externalModel: o, cleanup: a };
                                        return {
                                            model: i,
                                    ...
                                    B = s[0],
                                    C = s[1],
                                    c = (0, n.useState)(() => a(A, F, r)),
                                    l = c[0],
                                    _ = c[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        i.current ? _(a(B, F, r)) : (i.current = !0);
                                    }, [r, B, F]),
                                    (0, n.useEffect)(() => {
                                        C(A);
                                    }, [A]),
                                    ...
                                    E().createElement(t.Provider, { value: l }, o)
                                );
                            },
                            () => (0, n.useContext)(t),
                        ];
                    ...
                    Z = 'App_buttons_02',
                    X = 'App_button_5f',
                    Q = R.strings.ny.challenge.dialogs.discount,
                    J = (0, v.Pi)(() => {
                        const u = z(),
                            e = u.model,
                            t = u.controls,
                            n = e.root.get().discountInPercent,
                            A = e.vehicleInfo.get(),
                            F = A.vehicleName,
                            o = A.vehicleType;
                        l({ [_.n.ENTER]: t.accept, [_.n.SPACE]: t.accept });
                        const r = {
                            backgroundImage: `url(${R.images.gui.maps.icons.vehicleTypes.white.c_36x36.$dyn((0, d.BN)(o))})`,
                        };
                        return E().createElement(
                            S,
                            null,
                            E().createElement(
                                ...
                                E().createElement(
                                    ...
                                    E().createElement(m.B, {
                                        ...
                                        binding: {
                                            percent: n,
                                            vehicleIcon: E().createElement('div', { className: $, style: r }),
                                            vehicleName: F,
                                        },
                                    }),
                                ),
                                E().createElement('div', { className: Y }),
                                E().createElement(
                                    'div',
                                    { className: Z },
                                    E().createElement(C, { size: s.medium, onClick: t.accept, mixClass: X }, Q.apply()),
                                    E().createElement(
                                        C,
                                        { type: i.secondary, size: s.medium, onClick: t.cancel, mixClass: X },
                                        Q.reject(),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    F().render(E().createElement(H, null, E().createElement(J, null)), document.getElementById('root'));
                });
            },
            5287: (u, e, t) => {
                t.d(e, { Z: () => n });
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, t, n] = deferred[r], A = !0, F = 0; F < e.length; F++)
                        (!1 & n || E >= n) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(8597));
