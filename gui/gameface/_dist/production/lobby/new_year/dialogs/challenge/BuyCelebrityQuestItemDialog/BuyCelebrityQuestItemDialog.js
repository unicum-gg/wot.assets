(() => {
    var __webpack_modules__ = {
            ...
            9916: (e, u, t) => {
                'use strict';
                t.d(u, { Sw: () => a.Z, B3: () => s, Z5: () => i.Z5, B0: () => o, ry: () => D, Sy: () => h });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            9127: (e, u, t) => {
                ...
                const m = (e) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && d) return a(u, t, f);
                ...
                const L = {
                    ...
                    M = (e) => {
                        ...
                        const a = w(),
                            ...
                            o = a.mediaHeight,
                            s = a.mediaSize;
                        return r().createElement('div', x({ className: C()(t, L[i], T[o], S[s]) }, n), u);
                    },
                    O = ['children'];
                const k = (e) => {
                    let u = e.children,
                    ...
                    return r().createElement(B, null, r().createElement(M, t, u));
                };
                var P = t(493),
                    N = t.n(P);
                var H = t(9916);
                        ...
                        const v = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (G(t, F, { isMouseEvent: !0, on: !0, arguments: I(r) }, f),
                                    h && h(),
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onClick: ((e) => (u) => {
                                              !1 === A && p(), null == s || s(u), null == e || e(u);
                                          })(u.props.onClick),
                                          onMouseDown: ((e) => (u) => {
                                              !1 === A && p(), null == o || o(u), null == e || e(u);
                                          })(u.props.onMouseDown),
                                      },
                                      g,
                                  ),
                ...
                const Z = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    if (u.header || u.body) return r().createElement(K, u, n);
                    const a = u.contentId;
                    return a ? r().createElement(U, X({}, u, { contentId: a }), n) : r().createElement($, u, n);
                };
                var Q = t(5521);
                const J = (e) => {
                ...
                const de = { gold: 'gold', integral: 'integral' },
                    Fe = { [de.gold]: H.B3.GOLD, [de.integral]: H.B3.INTEGRAL };
                function _e(e, u = de.integral) {
                    return H.Z5.getNumberFormat(e, Fe[u]);
                }
                _e.type = de;
                const me = { number: _e },
                    De = {
                ...
                const ve = Ce;
                var fe = t(7030);
                const be = { enter: 'translateY(100%)', reduce: 'translateY(-100%)', none: 'translateY(0%)' },
                    pe = { leave: 'translateY(0%)', reduce: 'translateY(0%)', none: 'translateY(-100%)' },
                    we = ({ value: e, enterType: u, exitType: t }) => {
                        const n = r().useState(me.number(e)),
                            a = n[0],
                            i = n[1];
                        r().useEffect(() => {
                            'none' !== t && i('');
                        }, [t]);
                        const o = r().useMemo(() => a.split('').map((e) => ({ char: e, key: Symbol() })), [a]),
                            s = (0, fe.useTransition)(o, {
                                from: { transform: be[u], opacity: 'none' === u ? 1 : 0 },
                                enter: { transform: 'translateY(0%)', opacity: 1 },
                                leave: { transform: pe[t], opacity: 0 },
                                keys: o.map((e) => e.key),
                                trail: 200,
                            });
                        return r().createElement(
                            ...
                            s((e, u) =>
                                r().createElement(
                                    fe.animated.div,
                                    { className: C()(De.char, De[`char__${t}`]), style: e },
                                    u.char,
                                ),
                            ),
                        );
                ...
                const xe = ({
                    ...
                    var o;
                    const s = r().useState(u),
                        l = s[0],
                        c = s[1],
                        E = r().useRef(null),
                        A = null != (o = ve(l)) ? o : l,
                        d = r().useMemo(() => Symbol(), [l]);
                    r().useEffect(() => {
                        const e = E.current;
                        if (e)
                            return (
                                e.classList.remove(De.base__reduce),
                                e.classList.remove(De.base__increase),
                                ((e) => {
                                    let u,
                                        t = null;
                                    return (
                                    ...
                                    A > u
                                        ? (e.classList.add(De.base__reduce),
                                          Be(() => {
                                              c(u);
                                          }, 50))
                                        : A < u
                                          ? (e.classList.add(De.base__increase),
                                            Be(() => {
                                                c(u);
                                            }, 200))
                                          : void 0,
                    ...
                    const F = (0, fe.useTransition)(l, {
                        from: { opacity: l === A ? 1 : 0 },
                        enter: { opacity: 1 },
                        leave: { opacity: 0 },
                        keys: () => d,
                    ...
                    return r().createElement(
                        ...
                        r().createElement(
                            'div',
                            { className: C()(De.icon, null == a ? void 0 : a.icon) },
                            r().createElement('div', { className: C()(De.iconEffect, De.iconEffect__reduce) }),
                            r().createElement('div', { className: C()(De.iconEffect, De.iconEffect__increase) }),
                            r().createElement('div', { className: C()(De.increaseParticles) }),
                        ),
                        r().createElement(
                            'div',
                            { className: C()(De.value, null == a ? void 0 : a.value) },
                            F((e, u, t) =>
                                r().createElement(
                                    fe.animated.div,
                                    { className: De.valueWrapper, style: e },
                                    r().createElement(we, { value: u, enterType: Te(l, A), exitType: Le(l, u, t) }),
                                ),
                            ),
                            r().createElement('div', { className: De.value__ghost }, me.number(l)),
                        ),
                    );
                };
                function Le(e, u, t) {
                ...
                const Se = r().memo((e) => {
                    if (e.withAnimation) return r().createElement(xe, e);
                    const u = e.type,
                        t = e.size,
                        n = void 0 === t ? ye.Default : t,
                        a = e.isReverse,
                        i = e.isNotEnough,
                        o = e.classNames,
                        s = e.className,
                    ...
                    return r().createElement(
                        ...
                        r().createElement('div', { className: C()(De.icon, null == o ? void 0 : o.icon) }),
                        void 0 !== l &&
                            r().createElement(
                                'div',
                                { className: C()(De.value, i && De.value__notEnough, null == o ? void 0 : o.value) },
                                e.additionalValue,
                                E ? R.strings.ny.common.dashes() : me.number(l),
                            ),
                    );
                });
                function Re(e) {
                ...
                class Pe extends r().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            d = C()(Me.base, Me[`base__${i}`], Me[`base__${a}`], null == o ? void 0 : o.base),
                            F = C()(Me.icon, Me[`icon__${i}`], Me[`icon__${a}`], null == o ? void 0 : o.icon),
                            _ = C()(Me.glow, null == o ? void 0 : o.glow),
                            m = C()(Me.caption, Me[`caption__${i}`], null == o ? void 0 : o.caption),
                            D = C()(Me.goto, null == o ? void 0 : o.goto);
                        return r().createElement(
                            'div',
                            ke(
                                {
                ...
                const Ne = 'ResourcePanel_base_1e',
                    He = 'ResourcePanel_item_83',
                    We = 'ResourcePanel_count_8d',
                    Ie = R.strings.ny.resourceTooltip.unavailable,
                    Ge = ({ resources: e, isWalletAvailable: u = !0, hasAnimation: t = !1 }) =>
                        r().createElement(
                            K,
                            { header: Ie.header(), body: Ie.body(), isEnabled: !u },
                            r().createElement(
                                'div',
                                { className: Ne },
                    ...
                    Ue = 'BaseWithResources_base_b2',
                    je = 'BaseWithResources_vignette_34',
                    Ve = 'BaseWithResources_closeButton_a6',
                    $e = 'BaseWithResources_resources_55',
                    ze = 'BaseWithResources_content_7e',
                    qe = ({ resources: e, hasCloseButton: u = !0, isWalletAvailable: t, children: n }) =>
                        r().createElement(
                            'div',
                            { className: Ue, lang: R.strings.settings.LANGUAGE_CODE() },
                            ...
                            r().createElement(
                                'div',
                                { className: $e },
                                r().createElement(Ge, { resources: e, isWalletAvailable: t }),
                            ),
                ...
                !(function (e) {
                    (e.Error = 'error'),
                        (e.NoWallet = 'noWallet'),
                        (e.NotEnoughMoney = 'notEnoughMoney'),
                        (e.Default = 'default');
                })(Ye || (Ye = {})),
                    (function (e) {
                        (e.Crystal = 'ny_crystal'),
                ...
                const tu = ((e, u) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: o, children: s, mocks: l }) {
                                ...
                                return (
                                    (0, n.useEffect)(() => {
                                        A.current ? B(E(F, o, l)) : (A.current = !0);
                                    }, [l, F, o]),
                                    (0, n.useEffect)(() => {
                                        _(a);
                                    }, [a]),
                        ...
                        ({ observableModel: e }) => {
                            const u = { root: e.object(), resources: e.array('resources', []) },
                                ...
                                n = (0, uu.Om)(() => {
                                    const e = u.root.get(),
                                        t = e.price;
                                    return { resourceType: e.resourceType, price: t };
                                });
                            return Object.assign({}, u, {
                                computes: {
                                    getResources: t,
                                    getLackTheResTooltipArgs: n,
                                    isWalletAvailable: () => u.root.get().dialogState !== Ye.NoWallet,
                                    isNotEnoughMoney: () => u.root.get().dialogState === Ye.NotEnoughMoney,
                                },
                            });
                        },
                        ({ externalModel: e }) => ({
                ...
                const su = ({
                    ...
                    return (
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                'span',
                                { className: C()(au.state, au.state__default) },
                ...
                su.defaultProps = { type: iu.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const lu = su,
                    cu = 'Buttons_base_c7',
                    Eu = 'Buttons_button_5c',
                    Au = R.strings.ny.celebrityGuestQuest.confirm,
                    du = (0, ae.Pi)(() => {
                        const e = ru(),
                            u = e.model,
                            t = e.controls,
                        ...
                        return r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        lu,
                                        {
                                            ...
                                            size: ou.medium,
                                            onClick: t.accept,
                                            disabled: !n.isWalletAvailable() || n.isNotEnoughMoney(),
                                        },
                                        Au.acceptButtonText(),
                                    ),
                                ),
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    lu,
                                    { type: iu.secondary, size: ou.medium, onClick: t.cancel },
                                    Au.cancelButtonText(),
                                ),
                            ),
                        );
                    ...
                    Bu = 'App_buttons_2b',
                    hu = 'App_priceText_7c',
                    Cu = 'App_innerPrice_a9',
                    gu = 'App_currentPrice_ed',
                    vu = 'App_icon_cb',
                    fu = R.strings.ny.celebrityGuestQuest.confirm,
                    bu = R.strings.ny.guestQuest.rewardItem,
                    pu = R.strings.ny.resourceTooltip.unavailable,
                    wu = (e) => ({
                        backgroundImage: `url(${R.images.gui.maps.icons.newYear.celebrity_challenge.rewardItem.$dyn(e)})`,
                    }),
                    yu = (e, u, t) =>
                        u
                            ? e
                    ...
                    xu = (0, ae.Pi)(() => {
                        const e = ru(),
                            ...
                            l = i.questId,
                            c = () => {
                                n.isWalletAvailable() && !n.isNotEnoughMoney() && t.accept();
                            };
                        return (
                            ne({ [Q.n.ENTER]: c, [Q.n.SPACE]: c }),
                            ue(),
                            r().createElement(
                                qe,
                                { resources: a, isWalletAvailable: n.isWalletAvailable() },
                                r().createElement(
                                    'div',
                                    { className: Fu },
                                    r().createElement('div', { className: vu, style: wu(l) }),
                                    r().createElement(
                                        'div',
                                        { className: _u },
                                        ((E = fu.content()),
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            'div',
                                            { className: Du },
                                            r().createElement('div', { className: hu }, fu.price()),
                                            r().createElement(Se, {
                                                value: o,
                                                type: s,
                                                size: ye.s32,
                                                isNotEnough: n.isNotEnoughMoney() || !n.isWalletAvailable(),
                                                className: Cu,
                                                classNames: { value: gu },
                                                isReverse: !0,
                                            }),
                                    ...
                                    r().createElement('div', { className: Bu }, r().createElement(du, null)),
                                ),
                            )
                        );
                        var E, A;
                ...
                engine.whenReady.then(() => {
                    N().render(
                        r().createElement(k, null, r().createElement(nu, null, r().createElement(xu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [8360], () => __webpack_require__(9127));
