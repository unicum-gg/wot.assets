(() => {
    var __webpack_modules__ = {
            ...
            2930: (u, e, t) => {
                                ...
                                const a = (0, r.useRef)([]),
                                    i = (u, t, r) => {
                                        ...
                                        const A = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, A) => {
                                                        const F = 'string' == typeof A ? `${r}.${A}` : r,
                                                            a = l.O.view.addModelObserver(F, e, !0);
                                            ...
                                            _ = { mode: u, model: C, externalModel: n, cleanup: i };
                                        return {
                                            model: C,
                                    ...
                                    c = _[0],
                                    m = _[1],
                                    d = (0, r.useState)(() => i(u, A, F)),
                                    h = d[0],
                                    g = d[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        C.current ? g(i(c, A, F)) : (C.current = !0);
                                    }, [F, c, A]),
                                    (0, r.useEffect)(() => {
                                        m(u);
                                    }, [u]),
                                    (0, r.useEffect)(
                                        () => () => {
                                            (h.externalModel.dispose(), a.current.forEach((u) => u()));
                                        },
                                        [h],
                                    ),
                ...
                const w = l.O.client.getSize('rem'),
                    b = w.width,
                    x = w.height,
                    f = Object.assign({ width: b, height: x }, p(b, x, g)),
                ...
                ((0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(S),
                        ...
                        F = (0, r.useCallback)((u, e) => {
                            ...
                            n(Object.assign({ width: t, height: r }, p(t, r, g)));
                        }, []);
                    (((u) => {
                ...
                const P = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    N = [O.ExtraLarge, O.Large, O.Medium, O.Small, O.ExtraSmall],
                    H = (u, e) =>
                ...
                const j = {
                    ...
                    K = I((u) => {
                        ...
                        const K = (0, r.useMemo)(() => {
                            ...
                            }, [t, A, i, o, B, C, N, k, M, d, T, x, S]),
                            z = K.computedStyle,
                            q = K.computedClassNames;
                        return E().createElement('div', U({ className: a()(W.base, ...q, e), style: z }, I), H);
                    });
                let z;
                !(function (u) {
                ...
                const Au = Object.keys(eu()),
                    ...
                    ou = I((u) => {
                        ...
                        return E().createElement(
                            ...
                            Eu(
                                {
                                    className: a()(tu.base, t && tu[t], v, A),
                                    style: g,
                ...
                const _u = (u, e, t = {}, r = 0) => {
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (_u(t, s, { isMouseEvent: !0, on: !0, arguments: Cu(E) }, p),
                                    d && d(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((v.current.timeoutId = window.setTimeout(w, D ? 100 : 400)),
                                                          A && A(u),
                                                          f && f(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                    ...
                    mu = (0, i.Pi)(() => {
                        ...
                        const o = a()('App_base_ca', F && 'App_base__hover_20');
                        return E().createElement(
                            'div',
                            { className: o },
                            E().createElement(
                                ...
                                {
                                    contentId:
                                        R.views.new_year.lobby.new_year.tooltips.NYQuestEntryPointTooltip('resId'),
                                },
                                E().createElement(
                                    'div',
                                    {
                                        className: 'App_flag_e4',
                                        onClick: () => {
                                            (lu(R.sounds.yes()), t.action());
                                        },
                                        onMouseEnter: () => {
                                            (i(!0), lu(R.sounds.highlight()));
                                        },
                                        onMouseLeave: () => {
                                            i(!1);
                                        },
                                    },
                                    E().createElement('div', { className: 'App_hoverShine_df' }),
                                    E().createElement('div', { className: 'App_flagBg_9c', ref: D }),
                                    E().createElement('div', { className: 'App_icon_1a' }),
                                    E().createElement(ou, { text: A, className: 'App_count_93' }),
                                    E().createElement(
                                        'div',
                                        { className: 'App_hoverBlink_21' },
                                        E().createElement(
                                            'div',
                                            { className: 'App_hoverBlinkInner_64' },
                                            E().createElement('div', { className: 'App_hoverBlinkBg_97' }),
                                        ),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    n().render(
                        E().createElement(_, null, E().createElement(mu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(2930));
