(() => {
            ...
            8181: (u, e, t) => {
                ...
                const L = {
                    ...
                    T = (u) => {
                        ...
                        const a = b(),
                            ...
                            i = a.mediaHeight,
                            A = a.mediaSize;
                        return n().createElement('div', w({ className: d()(t, L[E], M[i], S[A]) }, r), e);
                    },
                    y = ['children'],
                    O = (u) => {
                        let e = u.children,
                ...
                const G = ({
                    ...
                    const B = (0, r.useRef)(null),
                        ...
                        x = f[1],
                        w = (0, r.useCallback)(() => {
                            E || (B.current && (B.current.focus(), h(!0)));
                        }, [E]),
                        L = (0, r.useCallback)(
                            (u) => {
                ...
                const X = ['xl', 'lg', 'md', 'sm', 'xs'],
                    $ = (u) => u.includes('_') && ((u) => X.includes(u))(u.split('_').at(-1)),
                ...
                const J = {
                    ...
                    tu = q((u) => {
                        let e = u.className,
                            ...
                            x =
                                void 0 === b
                                    ...
                                    : b,
                            w = u.alignItems,
                            L = void 0 === w ? (h ? 'flex-start' : g && 'center') || (p && 'flex-end') || void 0 : w,
                            M = u.alignSelf,
                            S = u.wrap,
                            T = u.flexWrap,
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, A, F, l, _, P, k, M, C, y, x, L]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return n().createElement('div', Q({ className: d()(Y.base, ...U, e), style: G }, I), N);
                    });
                let ru;
                !(function (u) {
                ...
                const nu = (u, e, t) => {
                    ...
                    Eu = (u, e, t = ru.left) => u.split(e).reduce(t === ru.left ? nu : au, []),
                    iu = (() => {
                        const u = new RegExp(
                    ...
                    ou = ({ binding: u, text: e = '', classMix: t, alignment: a = ru.left }) =>
                        null === e
                ...
                const cu = Object.keys(su()),
                    ...
                    gu = q((u) => {
                        ...
                        return n().createElement(
                            ...
                            _u(
                                {
                                    className: d()(lu.base, t && lu[t], p, a),
                                    style: g,
                            ...
                            void 0 !== m ? n().createElement(ou, _u({}, m, { text: e })) : e,
                        );
                    }),
                    pu = {
                ...
                class bu extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = d()(pu.base, pu[`base__${E}`], pu[`base__${a}`], null == i ? void 0 : i.base),
                            _ = d()(pu.icon, pu[`icon__${E}`], pu[`icon__${a}`], null == i ? void 0 : i.icon),
                            c = d()(pu.glow, null == i ? void 0 : i.glow),
                            B = d()(pu.caption, pu[`caption__${E}`], null == i ? void 0 : i.caption),
                        ...
                        return n().createElement(
                            ...
                            'info' !== E && n().createElement('div', { className: pu.shine }),
                ...
                const Su = (0, r.forwardRef)(function (u, e) {
                        let t = u.src,
                            a = u.className,
                            E = u.autoplay,
                            i = void 0 !== E && E,
                        ...
                        return (
                            ...
                            (0, r.useEffect)(() => {
                                if (B && m.current) {
                                                                ...
                                                                if (m.current) {
                                                                    ...
                                                                    if (
                                                                        (e !== r &&
                                                                            ...
                                                                            (e = r)),
                                                                        m.current.paused || !B || !s)
                                                                    )
                                                                        return;
                                                                    const a = m.current.cohGetKeyframeTimestamps();
                                                                    a.forEach((e, t) => {
                                                                        r > a[t] - 0.02 &&
                                                                            r < a[t] &&
                                    ...
                                    const t = (e) => (
                                        ...
                                        n = () => {
                                            var u;
                                            return null == (u = m.current) ? void 0 : u.currentTime;
                                        },
                                        a = () => {
                                            var u;
                                            return null == (u = m.current) ? void 0 : u.duration;
                                        },
                                        E = (u) => {
                                            var e, t;
                                            m.current &&
                                                (m.current.currentTime =
                                                    (0, (e = m.current.duration), (t = u) < 0 ? 0 : t > e ? e : t));
                                        },
                                        i = () => {
                                            var u;
                                            return null == (u = m.current) ? void 0 : u.play();
                                        },
                                        A = () => {
                                            var u;
                                            return null == (u = m.current) ? void 0 : u.pause();
                                        },
                                        o = () => {
                                            (A(), E(0));
                                        },
                                        F = () => {
                                            var u, e;
                                            return null !=
                                                (u = null == (e = m.current) ? void 0 : e.cohGetKeyframeTimestamps())
                                                ? u
                                                : [];
                                        },
                                        D = (u) => {
                                        ...
                                        C = (u, e) => {
                                            var t;
                                            return (
                                                null == (t = m.current) || t.addEventListener(u, e),
                                                () => {
                                                    var t;
                                        ...
                                        d = (u, e) => {
                                            var t;
                                            return (
                                                null == (t = m.current) || t.removeEventListener(u, e),
                                                () => {
                                                    var t;
                                                    return null == (t = m.current)
                                                        ? void 0
                            ...
                            n().createElement(
                                'video',
                                Mu({ src: t, className: a, style: A, loop: F, ref: m, onClick: D, onError: _ }, c),
                            )
                        );
                    }),
                    Tu = (0, r.memo)(Su);
                ...
                function Ru(u = yu.n.NONE, e = Ou, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== yu.n.NONE)
                            return (
                ...
                const Nu = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const o = (0, r.useRef)([]),
                                    F = (u, t, r) => {
                                        ...
                                        const a = (function ({
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : A(e),
                                                            n = ku.observable.box(r, { equals: wu });
                                                        return (
                                                            'real' === u &&
                                                                i.subscribe(
                                            ...
                                            l = { mode: u, model: s, externalModel: i, cleanup: F };
                                        return {
                                            model: s,
                    ...
                    Wu = Iu[0],
                    Gu = Iu[1],
                    Uu = 'App_rewardDescription_8c',
                    ju = 'App_rewardLine_ff',
                    Ku = R.strings.ny.petReward,
                    Xu = R.images.new_year.gui.maps.icons.newYear.petRewardView,
                    $u = R.images.gui.maps.icons.tankmen.icons.big,
                    zu = (0, Hu.observer)(() => {
                        const u = Gu(),
                            e = u.controls,
                            t = u.model.root.get(),
                        ...
                        const D = (0, r.useCallback)(() => {
                            P(R.sounds.hangar_newyear_raccoon_letter());
                        }, []);
                        return o
                            ? n().createElement(
                                  'div',
                                  ...
                                  n().createElement(Tu, {
                                      src: R.videos.new_year.pet.letter(),
                                      autoplay: !0,
                                      onPlay: D,
                                      className: 'App_videoLetter_5a',
                                  }),
                                  n().createElement(bu, {
                                      classNames: { base: 'App_closeButton_7d' },
                                      caption: Ku.close(),
                                      type: 'close',
                                      side: 'right',
                                      onClick: e.onClose,
                                  ...
                                  n().createElement(
                                      'div',
                                      { className: 'App_letterContainer_b2' },
                                      n().createElement(
                                          'div',
                                          { className: 'App_letter_89' },
                                          n().createElement(
                                              'div',
                                              { className: 'App_leftCorner_6b' },
                                              n().createElement(gu, {
                                                  className: 'App_leftCornerTitle_5c',
                                                  text: Ku.leftCorner.title(),
                                              }),
                                              n().createElement(gu, {
                                                  className: 'App_leftCornerDescription_99',
                                                  text: Ku.leftCorner.description(A),
                                                  format: {
                                                      binding: {
                                                          value: n().createElement(gu, {
                                                              className: 'App_leftCornerDescriptionValue_10',
                                                              text: String(A),
                                                          }),
                                                      },
                                                  },
                                          ...
                                          n().createElement(
                                              'div',
                                              { className: 'App_rewards_5f' },
                                              l &&
                                                  n().createElement(
                                                      'div',
                                                      { className: 'App_tankman_14' },
                                                      n().createElement('div', {
                                                          className: 'App_tankmanImage_8b',
                                                          style: {
                                                              backgroundImage: `url('${Xu.$dyn(s) || $u.$dyn(s)}')`,
                                                          },
                                                      }),
                                                      n().createElement(gu, { className: Uu, text: F }),
                                                      n().createElement('div', { className: ju }),
                                                  ),
                                              a &&
                                                  n().createElement(
                                                      'div',
                                                      { className: 'App_token_6c' },
                                                      n().createElement(
                                                          'div',
                                                          { className: 'App_tokenIcon_ab' },
                                                          n().createElement(gu, {
                                                              className: 'App_tokenNumber_61',
                                                              text: Ku.number(),
                                                              format: { binding: { number: a } },
                                                          }),
                                                      ),
                                                      n().createElement(gu, {
                                                          className: Uu,
                                                          text: Ku.tokenDescription(),
                                                      }),
                                                      n().createElement('div', { className: ju }),
                                                  ),
                                          ),
                                          n().createElement('div', { className: 'App_textLines_26' }),
                                          n().createElement(gu, {
                                              className: 'App_text_d1',
                                              text: Ku.text.$dyn(`c_${i || 1}`),
                                          }),
                                      ),
                                      n().createElement(
                                          U,
                                          {
                                              mixClass: 'App_button_22',
                                              type: I.primary,
                                              size: W.medium,
                                              onClick: e.onClose,
                                          },
                                          n().createElement(gu, { text: Ku.button() }),
                                      ),
                                  ),
                              )
                ...
                engine.whenReady.then(() => {
                    k().render(
                        n().createElement(Wu, null, n().createElement(O, null, n().createElement(zu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [4503], () => __webpack_require__(8181));
