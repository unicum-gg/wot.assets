(() => {
    ...
    var __webpack_modules__ = {
            ...
            9916: (u, e, t) => {
                t.d(e, { Sw: () => o.Z, B3: () => l, Z5: () => s.Z5, B0: () => i, ry: () => m });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            3760: (u, e, t) => {
                ...
                const M = ({ children: u, tooltipArgs: e, className: t }) => {
                    if (!e) return u;
                    const n = i().createElement('div', { className: t }, u);
                    if (e.header || e.body) return i().createElement(L, e, n);
                    const r = e.contentId;
                    return r ? i().createElement(y, I({}, e, { contentId: r }), n) : i().createElement(S, e, n);
                };
                ...
                const G = [
                    ...
                    q = [F.Gold, F.Credits, F.Crystal, F.FreeXp],
                    j = [F.BattlePassPoints, F.EquipCoin],
                    Y = [F.PremiumPlus, F.Premium],
                    ...
                    H = ({
                        ...
                        const _ = ((u, e) => {
                            ...
                            b = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case B.CURRENCY:
                                    case B.NUMBER:
                                        return i().createElement(U, { format: 'integral', value: Number(u) });
                                    case B.PREMIUM_PLUS: {
                                        const e = Number(u);
                        ...
                        return i().createElement(
                            'div',
                            { className: r()(X.base, X[`base__${n}`], E), style: c },
                            i().createElement(
                                M,
                                ...
                                i().createElement(
                                    ...
                                    i().createElement(
                                        'div',
                                        { className: r()(X.image, null == A ? void 0 : A.image) },
                                        _ &&
                                            i().createElement('div', {
                                                className: r()(X.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            i().createElement('div', {
                                                className: r()(X.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        g &&
                                            i().createElement('div', {
                                                className: r()(X.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                                        ...
                                        i().createElement(
                                            'div',
                                            {
                                                className: r()(
                                                    X.info,
                                                    X[`info__${u}`],
                                                    a === B.MULTI && X.info__multi,
                                                    null == A ? void 0 : A.info,
                                                ),
                                            },
                                            b,
                                        ),
                                    l && i().createElement('div', { className: X.title }, l),
                                ),
                            ),
                            t &&
                                i().createElement(
                                    ...
                                    { tooltipArgs: F },
                                    i().createElement('div', {
                                        className: r()(X.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const Z = i().memo(
                    ({
                        ...
                        var _, B;
                        const m = r()('Rewards_base_26', t && 'Rewards_base__vertical_9f', o),
                            p = r()('Rewards_reward_7b', t && 'Rewards_reward__vertical_c6', a);
                        return i().createElement(
                            'div',
                            { className: m },
                            d
                ...
                const ou = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: n, children: r, mocks: a }) {
                                                ...
                                                return {
                                                    subscribe: (t, s) => {
                                                        const a = 'string' == typeof s ? `${n}.${s}` : n,
                                                            l = o.O.view.addModelObserver(a, e, !0);
                                                        return r.set(l, t), u && t(i(s)), l;
                                                    },
                                                    readByPath: i,
                                                    createCallback: (u, e) => {
                                                        const t = i(e);
                                ...
                                return (
                                    (0, s.useEffect)(() => {
                                        E.current ? p(c(d, n, a)) : (E.current = !0);
                                    }, [a, d, n]),
                                    (0, s.useEffect)(() => {
                                        F(u);
                                    }, [u]),
                ...
                const du = { [Au.NBSP]: cu.NoBreakSymbol, [Au.ZWNBSP]: cu.NoBreakSymbol, [Au.NEW_LINE]: cu.LineBreak },
                    ...
                    mu = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? _u[n]
                                ? i().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: r()(Du, _u[n]) },
                                      u,
                                  )
                                : i().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: Du, style: Bu(n) },
                                      u,
                                  )
                    ...
                    hu = Fu
                        ...
                        : (u, e) => {
                              ...
                              let o = 0;
                              for (; n; ) {
                                  const s = e.justifyContent === Eu.FlexEnd ? n.index : t.lastIndex;
                                  r.push(u.slice(o, s)), (o = s), (n = t.exec(u));
                              }
                    ...
                    vu = (u, e = '', t) => {
                        ...
                        return (
                            gu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    n.push({ blockType: cu.Word, colorTag: e, childList: hu(u, t) });
                                },
                                (u) => {
                                    const t = u[0],
                                        r = du[t.charAt(0)];
                    ...
                    fu = (u, e, t = '', n) => {
                        ...
                        return (
                            gu(
                                ...
                                (u) => {
                                    const o = u[1],
                                        s = void 0 === e[o] ? u[0] : e[o];
                                    'string' == typeof s || 'number' == typeof s
                                        ? r.push(...vu(String(s), t, n))
                                        : r.push({ blockType: cu.Binding, colorTag: t, childList: [s] });
                                },
                            ),
                            r
                        );
                    ...
                    wu = (u, e) => {
                        ...
                        if (u.blockType === cu.NoBreakWrapper) u.childList.push(n), t.push(u);
                        else {
                            const e = Object.assign({}, u, { childList: u.childList.splice(-1) });
                            u.childList.length > 0 && t.push(u),
                                t.push({ blockType: cu.NoBreakWrapper, colorTag: '', childList: [e, n] });
                        }
                        ...
                        for (let l = t; l >= 0; l--) {
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const d = E.slice(0, E.length - A) + o,
                                    F = e[l];
                                (a = i().cloneElement(F, F.props, d)), (s = l);
                                break;
                            }
                            {
                                const u = t.children,
                                    c = e[l],
                                    A = c.props.children,
                                    d = Ou(u, A, u.length - 1, n, r, o),
                                    F = d[0],
                                    _ = d[1];
                                if (!(F < 0)) {
                                    const u = A.slice(0, F);
                                    (a = i().cloneElement(c, c.props, u, _)), (s = l);
                                    break;
                                }
                                r -= E.length;
                            }
                    ...
                    Su = i().memo(
                        ({
                            ...
                            const F = (0, s.useRef)(null),
                                ...
                                B = D[0],
                                m = D[1],
                                p = (0, s.useMemo)(() => Tu(u, n, { justifyContent: E }), [n, E, u]),
                                C = (0, s.useMemo)(() => {
                                    if (
                                        o &&
                                        B.isTruncated &&
                                ...
                                b = (0, s.useMemo)(() => ({ justifyContent: E, alignContent: A }), [A, E]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                i().createElement(
                                    'div',
                                    {
                                        className: r()(
                                            lu.base,
                                            e,
                                            lu.base__zeroPadding,
                                            a && lu.base__isTruncationAvailable,
                                        ),
                                        style: b,
                                    },
                                    i().createElement('div', { className: lu.unTruncated, ref: F }, p),
                                    i().createElement(
                                        M,
                                        {
                                            tooltipArgs: C,
                                        ...
                                        i().createElement(
                                            'div',
                                            {
                                                className: r()(
                                                    lu.truncated,
                                                    !B.isTruncateFinished && a && lu.truncated__hide,
                                                ),
                                                style: b,
                                            },
                                            B.isTruncateFinished && a ? B.elementList : p,
                                        ),
                                    ),
                                )
                            );
                ...
                function Lu(u = 0) {
                    ...
                    e -= n * Nu;
                    const r = Math.trunc(e / xu);
                    return (e -= r * xu), { days: t, hours: n, minutes: r, seconds: e };
                }
                ...
                const Uu = (u = 0, e, t = 0, n = Iu) => {
                    ...
                    qu = R.strings.sm_lobby.tooltips.task,
                    ju = (0, Q.Pi)(() => {
                        const u = iu().model,
                            e = ((u, e = !1, t = !1) => {
                                const n = Uu(u, 1);
                                return { timeString: Gu(Lu(n), e, t), secondsLeft: n, isEndingSoon: n < 300 };
                        ...
                        return i().createElement(
                            ...
                            n && i().createElement('div', null, qu.completed()),
                            t === J.UNCOMPLETED && i().createElement('div', null, qu.active()),
                            o &&
                                i().createElement(Su, {
                                    text: qu.locked(),
                ...
                engine.whenReady.then(() => {
                    d().render(
                        i().createElement(su, null, i().createElement(E, null, i().createElement(Yu, null))),
