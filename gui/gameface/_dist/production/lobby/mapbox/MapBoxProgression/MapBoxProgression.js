            ...
            909: (e, u, t) => {
                ...
                const F = (e) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && m) return a(u, t, h);
                        ...
                        D(() => {
                            if (
                                ...
                                const t = (e) => {
                                    ...
                                    n = T(e);
                                _.current = S.addCallback(n, t, o, u === P.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (u !== P.None)
                ...
                const x = (e, u, t) => {
                    ...
                    I = (e, u, t = k.left) => e.split(u).reduce(t === k.left ? x : N, []),
                    L = (() => {
                        const e = new RegExp(
                        ...
                        return U.includes(t)
                            ...
                            : ((e, u = k.left) => {
                                  ...
                                  const n =
                                      ...
                                      r = e.replace(/&nbsp;/g, ' ');
                                  return (I(r, /( )/, u).forEach((e) => (t = t.concat(I(e, n, k.left)))), t);
                              })(e, u);
                    };
                function W(e, u, t) {
                    const r = (0, n.useContext)(d);
                ...
                X.defaultProps = { type: q.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const K = (0, n.memo)(X),
                    Z = {
                ...
                class ee extends r().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            m = O()(Z.base, Z[`base__${s}`], Z[`base__${a}`], null == o ? void 0 : o.base),
                            d = O()(Z.icon, Z[`icon__${s}`], Z[`icon__${a}`], null == o ? void 0 : o.icon),
                            A = O()(Z.glow, null == o ? void 0 : o.glow),
                            F = O()(Z.caption, Z[`caption__${s}`], null == o ? void 0 : o.caption),
                            D = O()(Z.goto, null == o ? void 0 : o.goto);
                        return r().createElement(
                            'div',
                            J(
                                {
                ...
                const me = {
                    ...
                    Ae = (({
                        ...
                        return (l = {}) => {
                            ...
                            return (0, n.useMemo)(
                                ...
                                [D.scrollPosition, g, p, v, d.off, d.on, f, b, B, E.step.clampedArrowStepTimeout],
                            );
                        };
                    })({
                        getBounds: (e) => {
                    ...
                    Se = (0, n.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = ve, onDrag: a = we }) => {
                                        ...
                                        if (o.current && i.current && l.current && c.current) {
                                            if (0 === e)
                                                return (
                                                    ...
                                                    void i.current.classList.remove(he)
                                                );
                                            if (
                                                ((u = l.current),
                                                (t = c.current),
                                                ...
                                                return (
                                                    ...
                                                    void i.current.classList.add(he)
                                                );
                                            var u, t;
                                            (o.current.classList.remove(he), i.current.classList.remove(he));
                                        }
                                    })(_));
                            },
                            D = oe(() => {
                        ...
                        ((0, n.useEffect)(() => re(D)),
                            ...
                            (0, n.useEffect)(() => {
                                ...
                                const u = (u) => {
                                    ...
                                    t = () => {
                                        (window.removeEventListener('mousemove', u), A(fe));
                                    };
                                return (
                        ...
                        const p = (e) => {
                            e.target.classList.contains(he) || Y('highlight');
                        };
                        return r().createElement(
                            'div',
                            { className: O()(Fe, u.base), ref: s, onWheel: e.handleMouseWheel },
                            r().createElement('div', {
                                className: O()(Be, u.leftButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(he) || 0 !== e.button || (Y('play'), C(_e.Next));
                                },
                                onMouseUp: g,
                                ref: o,
                                onMouseEnter: p,
                            ...
                            r().createElement(
                                ...
                                r().createElement('div', { ref: c, className: O()(pe, u.thumb) }),
                                r().createElement('div', { className: O()(be, u.rail) }),
                            ),
                            r().createElement('div', {
                                className: O()(Ce, u.rightButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(he) || 0 !== e.button || (Y('play'), C(_e.Prev));
                                },
                                onMouseUp: g,
                                ref: i,
                                onMouseEnter: p,
                    ...
                    Re = ({ api: e, className: u, classNames: t, children: a, style: s }) => (
                        ...
                        r().createElement(
                            'div',
                            { className: O()(Pe.base, u), style: s },
                            r().createElement(
                                'div',
                                {
                                    className: O()(Pe.wrapper, null == t ? void 0 : t.wrapper),
                                    onWheel: e.handleMouseWheel,
                                    ref: e.wrapperRef,
                                },
                                r().createElement(
                                    'div',
                                    { className: O()(Pe.content, null == t ? void 0 : t.content), ref: e.contentRef },
                                    a,
                                ),
                            ),
                        )
                ...
                ((Re.Bar = Se),
                    (Re.Default = ({
                        ...
                        const E = (0, n.useMemo)(() => {
                                const e = a || {};
                                return Object.assign({}, e, { base: O()(Pe.base, e.base) });
                            }, [a]),
                            _ = (0, n.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
                        return r().createElement(
                            'div',
                            { className: O()(Pe.defaultScroll, t), onWheel: u.handleMouseWheel },
                            r().createElement(
                                'div',
                                { className: O()(Pe.defaultScrollArea, s) },
                    ...
                    (Re.SeniorityAwards = ({ api: e, className: u, classNames: t, children: a }) => (
                        ...
                        r().createElement(
                            'div',
                            { className: O()(Pe.base, u) },
                            r().createElement(
                                'div',
                                { className: O()(Pe.wrapper, null == t ? void 0 : t.wrapper), ref: e.wrapperRef },
                                r().createElement(
                                    'div',
                                    { className: O()(Pe.content, null == t ? void 0 : t.content), ref: e.contentRef },
                                    a,
                ...
                const Oe = {
                    ...
                    xe = ({ binding: e, text: u = '', classMix: t, alignment: a = k.left }) =>
                        null === u
                            ...
                            : r().createElement(
                                  ...
                                  u.split('\n').map((u, s) =>
                                      r().createElement(
                                          'div',
                                          { className: O()(ke, t), key: `${u}-${s}` },
                                          ((e, u, t) =>
                                              e
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((e) => (t && e in t ? t[e] : H(e, u))))(u, a, e).map((e, u) =>
                ...
                const Le = (e, u, t = {}, n = 0) => {
                    ...
                    Ue = (e) => {
                        ...
                        const h = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            f = (0, n.useMemo)(() => B || p().resId, [B]),
                            v = (0, n.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Le(t, d, { isMouseEvent: !0, on: !0, arguments: Ie(r) }, f),
                                    C && C(),
                    ...
                    je = r().memo(
                        ({
                            ...
                            const m = 'all' === t,
                                ...
                                C = ((e, u) => (u ? Ye.changeAnswer() : e ? Ye.chooseBetter() : Ye.startInterview()))(
                                    m,
                                    s,
                                ),
                                g = ((e, u) =>
                                ...
                                p =
                                    ...
                                    (h = { rating: i }),
                                    b.replace(/\{\w+\}/g, (e) => String(h[e.slice(1, -1)])));
                            var b, h;
                            const f = (0, n.useMemo)(
                                    () => ({
                                ...
                                w = W(['base'], $e),
                                T = O()(w.base, s && $e.base__done, d && $e.base__ready, _ && $e.base__special),
                                S = !(E || (d && a));
                            return r().createElement(
                                'div',
                                { className: T, style: v, onMouseEnter: D },
                                _ &&
                                    r().createElement(
                                        'div',
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(xe, { classMix: $e.counter, text: Ye.counter(), binding: f }),
                                ),
                                r().createElement(
                                    'div',
                                    { className: $e.name },
                                    r().createElement(xe, { text: Ye.$dyn(`map_${t}`) }),
                                ),
                                r().createElement(
                                    ze,
                                    { body: g, isEnabled: S },
                ...
                const Je = { settings: Object.assign({}, me, { step: { type: 'proportional', factor: 1 } }) },
                    eu = (e) => {
                        const u = e - 1;
                        return u * u * u + 1;
                    },
                    ...
                    tu = ({ maps: e, onClick: u, onMouseEnter: t }) => {
                        ...
                        const b = { wrapper: O()(!F.current && !D.current && Oe.scrollWrapper) },
                            h = O()(Oe.arrow, Oe.arrow__left, i && Oe.arrow__disabled),
                            f = O()(Oe.arrow, Oe.arrow__right, E && Oe.arrow__disabled);
                        return r().createElement(
                            'div',
                            { className: a.base },
                            ...
                            r().createElement('div', { className: f, onClick: g }),
                        );
                    };
                let nu;
                !(function (e) {
                ...
                const ru = (0, n.memo)(({ datetime: e, format: u = nu.SHORT_DATE, localize: t = !0 }) =>
                        ((e, u, t) => {
                            switch (u) {
                                case nu.SHORT_DATE:
                                    return t
                                        ? h.Z5.getDateFormat(e, h.kH.SHORT_FORMAT)
                                        : h.cy.getTimeFormat('%d.%m.%y', e, !0);
                                case nu.SHORT_TIME:
                                    return t
                                        ? h.Z5.getTimeFormat(e, h.lf.SHORT_FORMAT)
                                        : h.cy.getTimeFormat('%I:%M %p', e, !0);
                                case nu.SHORT_DATE_TIME:
                                    return t
                                        ? `${h.Z5.getDateFormat(e, h.kH.SHORT_FORMAT)}, ${h.Z5.getTimeFormat(e, h.lf.SHORT_FORMAT)}`
                                        : h.cy.getTimeFormat('%d.%m.%y, %I:%M %p', e, !0);
                                case nu.FULL_DATE:
                                    return t
                                        ? h.Z5.getDateFormat(e, h.kH.LONG_FORMAT)
                                        : h.cy.getTimeFormat('%B %d, %Y', e, !0);
                                case nu.FULL_DATE_TIME:
                                    return t
                                        ? `${h.Z5.getDateFormat(e, h.kH.LONG_FORMAT)}, ${h.Z5.getTimeFormat(e, h.lf.SHORT_FORMAT)}`
                                        : h.cy.getTimeFormat('%B %d, %Y, %I:%M %p', e, !0);
                                case nu.MONTH:
                                    return h.cy.getTimeFormat('%B', e, !0);
                                case nu.MONTH_DATE:
                                    return h.cy.getTimeFormat('%B %e', e, !0);
                                case nu.DATE_MONTH:
                                    return h.cy.getTimeFormat('%e %B', e, !0);
                                case nu.MONTH_YEAR:
                                    return h.cy.getTimeFormat('%B %Y', e, !0);
                                case nu.WEEK_DAY:
                                    return h.cy.getTimeFormat('%A', e, !0);
                                case nu.WEEK_DAY_TIME:
                                    return t
                                        ? `${h.cy.getTimeFormat('%A', e, !0)} ${h.Z5.getTimeFormat(e, h.lf.SHORT_FORMAT)}`
                                        : h.cy.getTimeFormat('%A, %I:%M %p', e, !0);
                                case nu.YEAR:
                                    return h.cy.getTimeFormat('%Y', e, !0);
                                case nu.DATE_YEAR:
                                    return h.cy.getTimeFormat('%d, %Y', e, !0);
                            }
                        })(e, u, t),
                    ),
                    au = {
                    ...
                    su = ({ startEvent: e, endEvent: u }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement('div', { className: au.title }, R.strings.mapbox.progression.title()),
                            r().createElement(
                                'div',
                                { className: au.date },
                ...
                const cu = ({ size: e = iu.Default, classMix: u }) =>
                        r().createElement('div', { className: O()(ou.background, ou[`background__${e}`], u) }),
                    Eu = {
                ...
                const Du = 'ProgressBarDeltaGrow_base_7e',
                    ...
                    hu = (0, n.memo)(
                        ({
                            ...
                            const p = (0, n.useMemo)(() => Object.assign({ width: '100%' }, bu(e), gu(E)), [E, e]),
                                b = (0, n.useMemo)(() => Object.assign({ width: '0%' }, bu(e), gu(E)), [E, e]),
                                h = (0, n.useMemo)(() => Object.assign({ width: '0%' }, pu(E, a), bu(e)), [a, E, e]),
                                f = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - a)}%` }, pu(E, a), bu(e)),
                                    [a, E, o, e],
                                );
                            if (A) return null;
                            const v = O()(Du, c, E && 0 === o && Bu);
                            return r().createElement(
                                'div',
                                { style: F ? h : f, className: v },
                                r().createElement(
                                    'div',
                                    { style: B ? b : p, className: Cu },
                    ...
                    vu = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    Tu = (0, n.memo)(
                        ({
                            ...
                            return A
                                ...
                                : r().createElement(
                                      'div',
                                      { className: vu, style: g },
                                      r().createElement(
                                          'div',
                                          { style: F ? B : C, className: wu },
                                          r().createElement(_u, { size: s }),
                                      ),
                                  );
                        },
                ...
                const yu = (0, n.memo)((e) => {
                        ...
                        switch (a.animationSettings.type) {
                            case lu.Simple:
                                return r().createElement(Su, Ru({}, a, { onEndAnimation: l, isComplete: o }));
                            case lu.Growing:
                                return r().createElement(fu, Ru({}, a, { onEndAnimation: l, isComplete: o }));
                            default:
                                return null;
                        }
                    }),
                ...
                const xu = (0, n.memo)((e) => {
                    ...
                    return (
                        (a.current.from = o),
                        r().createElement(yu, ku({}, t, { onEndAnimation: s, key: `${o}-${t.to}`, from: o }))
                    );
                });
                function Nu() {
                    return (
                ...
                const Iu = (0, n.memo)(
                        ({
                            ...
                            return s.withStack
                                ...
                                : r().createElement(yu, Nu({ key: `${a}-${u}` }, c));
                        },
                    ),
                    Lu = (e) => ({
                    ...
                    Gu = (0, n.memo)(
                        ({
                            ...
                            return r().createElement(
                                'div',
                                { className: O()(ou.base, ou[`base__${t}`]), style: Lu(u) },
                ...
                const et = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    return a || o
                        ? r().createElement(Ue, Ju({}, u, { contentId: a || o }), n)
                        : r().createElement(Qu, u, n);
                };
                ...
                const nt = (e, u, t) => {
                    ...
                    at = ({
                        ...
                        const m = ((e) => {
                            ...
                            A = ((e, u) => {
                                ...
                                switch (u) {
                                    ...
                                    case ju.CURRENCY:
                                    case ju.NUMBER:
                                        return r().createElement(ut, { format: 'integral', value: Number(e) });
                        ...
                        return r().createElement(
                            'div',
                            { className: O()(rt.base, rt[`base__${n}`], l), style: i },
                            r().createElement(
                                et,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: O()(rt.image, null == c ? void 0 : c.image) },
                                        m &&
                                            r().createElement('div', {
                                                className: O()(rt.highlight, null == c ? void 0 : c.highlight),
                                                style: {
                                        ...
                                        u &&
                                            r().createElement('div', {
                                                className: O()(rt.icon, null == c ? void 0 : c.rewardIcon),
                                                style: { backgroundImage: `url(${u})` },
                                            }),
                                        d &&
                                            r().createElement('div', {
                                                className: O()(rt.overlay, null == c ? void 0 : c.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: _ },
                                    r().createElement('div', {
                                        className: O()(rt.timer, null == c ? void 0 : c.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const ot = [
                        ...
                        st.CrewBooks,
                        st.Customizations,
                        st.DossierAchievement,
                        st.Guide,
                        st.Brochure,
                        st.Items,
                    ],
                    it = (e) => (ot.includes(e) ? ju.MULTI : e === st.PremiumPlus ? ju.PREMIUM_PLUS : ju.STRING),
                    lt = {
                ...
                const _t = { margin: '5rem' },
                    mt = r().memo(({ onTakeReward: e, reward: u, requiredNumBattles: t, isReached: a }) => {
                        const s = u.isOpenable && a,
                            o = u.previousIcon && a ? Et.Changing : Et.Idle,
                            i = (0, n.useState)(o),
                            l = i[0],
                            c = i[1],
                            E = (0, n.useRef)(null),
                        ...
                        const d = (0, n.useMemo)(
                                () => ({
                                    ...
                                    value: u.value,
                                    valueType: it(u.name),
                                    tooltipArgs: nt({ tooltipId: u.tooltipId }, Number(u.tooltipContentId)),
                                }),
                                [u],
                            ),
                            A = (0, n.useMemo)(
                            ...
                            F = O()(lt.base, s && lt.base__button, l === Et.Changing && lt.base__animated);
                        return r().createElement(
                            'div',
                            { className: F },
                            s && r().createElement('div', { className: lt.shine }),
                            u.isSelected && r().createElement('div', { className: lt.passed }),
                            s &&
                                r().createElement(
                                    K,
                                    { onClick: _, size: V.small, type: q.main, mixClass: lt.button },
                                    R.strings.mapbox.progression.takeButton(),
                                ),
                            r().createElement(
                                'div',
                                { className: lt.rewardWrapper },
                                l === Et.Changing &&
                                    r().createElement(
                                        r().Fragment,
                                        null,
                                        r().createElement('div', {
                                            className: O()(lt.animationItem, lt.animationItem__godRays),
                                        }),
                                        r().createElement('div', {
                                            className: O()(lt.animationItem, lt.animationItem__staticShine),
                                            ref: E,
                                        }),
                                        r().createElement('div', {
                                            className: O()(lt.animationItem, lt.animationItem__explosion),
                                        }),
                                        r().createElement(
                                            'div',
                                            { className: lt.rewardPrevious },
                                            r().createElement(at, ct({ size: Yu.Small }, A, { style: _t })),
                                        ),
                                    ),
                                r().createElement(
                                    'div',
                                    { className: lt.rewardCurrent },
                                    r().createElement(
                                        at,
                                        ct({ size: Yu.Small }, d, {
                                            style: _t,
                                            special: u.name === st.Items ? qu.BATTLE_BOOSTER : void 0,
                                        }),
                                    ),
                                ),
                            ),
                    ...
                    dt = { base: 'Rewards_base_ba', items: 'Rewards_items_e4' },
                    At = r().memo(
                        ({ onTakeReward: e, progressRewards: u, requiredNumBattles: t, isReached: n, isLast: a }) => {
                            const s = W(['box', 'items'], dt),
                                o = O()(dt.base, a && dt.base__last);
                            return r().createElement(
                                'div',
                                { className: o },
                                r().createElement(
                    ...
                    Bt = ({
                        ...
                        const g = W(['base'], Ft),
                            p = O()(g.base, d && Ft.base__finally, A && Ft.base__reset);
                        return r().createElement(
                            'div',
                            { className: p },
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    t.map(({ value: e }) => {
                                        const u = B(e.numBattles),
                                            t = O()(
                                                Ft.bgSectionNumber,
                                                e.numBattles <= m && Ft.bgSectionNumber__passed,
                                            );
                                        return r().createElement(
                                            r().Fragment,
                                            { key: e.numBattles },
                    ...
                    gt = R.strings.mapbox.progression,
                    pt = () => {
                        const e = y(),
                            u = e.startEvent,
                            t = e.endEvent,
                        ...
                        ne(ue.n.ESCAPE, h);
                        const f = (0, n.useCallback)((e) => _({ mapName: e }), [_]),
                            v = (0, n.useCallback)(() => m(), [m]),
                            w = (0, n.useCallback)(() => D(), [D]),
                            T = (0, n.useCallback)(() => B(), [B]),
                            S = (0, n.useCallback)((e) => d({ mapName: e }), [d]),
                            P = (0, n.useCallback)(
                                (e, u, t) => {
                        ...
                        return r().createElement(
                            ...
                            !a &&
                                r().createElement(
                                    K,
                                    { onClick: v, size: V.small, type: q.ghost, mixClass: Ct.selectMode },
                                    r().createElement('div', { className: Ct.icon }),
                                    gt.redirect(),
                                ),
                            r().createElement(
                                'div',
                                ...
                                r().createElement(tu, { maps: C, onClick: f, onMouseEnter: S }),
                                r().createElement(
                                    'div',
                                    {
                                        className: O()(Ct.progression, p && Ct.progression__enabled),
                                        onAnimationEnd: () => b(!0),
                                    },
                                    r().createElement(Bt, {
                                        rewards: s,
                ...
                engine.whenReady.then(() => {
                    g().render(
                        r().createElement(B, null, r().createElement(bt, null)),
