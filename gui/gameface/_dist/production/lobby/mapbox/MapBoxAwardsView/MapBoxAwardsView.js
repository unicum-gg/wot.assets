(() => {
    ...
    var __webpack_modules__ = {
            ...
            364: (u, e, t) => {
                t.d(e, { Sw: () => r.Z, B3: () => l, Z5: () => i, B0: () => s, ry: () => m, Sy: () => h });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            858: (u, e, t) => {
                        ...
                        B(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = G(u);
                                F.current = Y.addCallback(n, t, o, e === V.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== V.None)
                                return () => {
                                    Y.removeCallback(F.current, o);
                                };
                        }, [o, e]),
                        E
                    );
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (Fu(t, c, { isMouseEvent: !0, on: !0, arguments: Au(a) }, v),
                                    C && C(),
                    ...
                    wu = () => {
                        ...
                        const u = q('model'),
                            ...
                            n =
                                ((r = vu.subTitle()),
                                (i = { number: e }),
                                r.replace(/\{\w+\}/g, (u) => String(i[u.slice(1, -1)])));
                        var r, i;
                        const o = e >= 50,
                            s = $(['base'], gu),
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement('div', { className: gu.blackout }),
                                a().createElement('div', { className: l }),
                                a().createElement('div', { className: gu.rays }),
                                a().createElement('div', { className: E }),
                                a().createElement(
                                    'div',
                                    { className: gu.header },
                                    a().createElement('div', { className: gu.title }, vu.title()),
                                    a().createElement('div', { className: gu.subTitle }, n),
                                ),
                                a().createElement(
                                    'div',
                                    { className: gu.close },
                ...
                engine.whenReady.then(() => {
                    h().render(
                        a().createElement(m, null, a().createElement(wu, null)),
