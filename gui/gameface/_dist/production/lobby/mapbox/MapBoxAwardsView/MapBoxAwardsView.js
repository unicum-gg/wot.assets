(() => {
    ...
    var __webpack_modules__ = {
            99: (u, e, t) => {
                ...
                var n = {};
                (t.r(n),
                    t.d(n, { mouse: () => F, off: () => A, on: () => c, onResize: () => E, onScaleUpdated: () => l }));
                var a = {};
                (t.r(a),
                    t.d(a, {
                        events: () => n,
                ...
                var r = {};
                (t.r(r), t.d(r, { getBgUrl: () => T, getTextureUrl: () => f }));
                var i = {};
                function s(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            916: (u, e, t) => {
                t.d(e, { Sw: () => r.Z, B3: () => o, Z5: () => i.Z5, B0: () => s, ry: () => B, Sy: () => C });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            929: (u, e, t) => {
                ...
                const l = i.O.client.getSize('rem'),
                    c = l.width,
                    A = l.height,
                    _ = Object.assign({ width: c, height: A }, E(c, A, s)),
                    F = (0, n.createContext)(_),
                    d = ['children'];
                const D = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                ...
                class x extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            _ = h()(P.base, P[`base__${i}`], P[`base__${r}`], null == s ? void 0 : s.base),
                            F = h()(P.icon, P[`icon__${i}`], P[`icon__${r}`], null == s ? void 0 : s.icon),
                            d = h()(P.glow, null == s ? void 0 : s.glow),
                            D = h()(P.caption, P[`caption__${i}`], null == s ? void 0 : s.caption),
                            B = h()(P.goto, null == s ? void 0 : s.goto);
                        ...
                        B(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = $(u);
                                _.current = Y.addCallback(n, t, o, e === z.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== z.None)
                ...
                function K(u = j.n.NONE, e = X, t = !1, a = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== j.n.NONE)
                            return (
                ...
                const ou = [
                    ...
                    lu = [J.BattlePassPoints, J.EquipCoin],
                    cu = [J.PremiumPlus, J.Premium],
                ...
                const Bu = (u, e, t = {}, n = 0) => {
                    ...
                    mu = (u) => {
                        ...
                        const h = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            v = (0, n.useMemo)(() => m || I().resId, [m]),
                            w = (0, n.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Bu(t, F, { isMouseEvent: !0, on: !0, arguments: Du(a) }, v),
                                    C && C(),
                ...
                const pu = (u) => {
                    ...
                    hu = {
                        base: 'Reward_base_2b',
                        base__third: 'Reward_base__third_01',
                        base__medium: 'Reward_base__medium_d6',
                        base__small: 'Reward_base__small_2a',
                        base__extraSmall: 'Reward_base__extraSmall_ef',
                        icon: 'Reward_icon_d4',
                        fadeInWithScale: 'Reward_fadeInWithScale_ff',
                        base__regular: 'Reward_base__regular_80',
                        overlay: 'Reward_overlay_45',
                        value: 'Reward_value_61',
                        value__multi: 'Reward_value__multi_a5',
                        value__credits: 'Reward_value__credits_40',
                        value__gold: 'Reward_value__gold_cd',
                        value__crystal: 'Reward_value__crystal_d5',
                        captionContainer: 'Reward_captionContainer_f1',
                        caption: 'Reward_caption_bd',
                        title: 'Reward_title_5b',
                        fadeIn: 'Reward_fadeIn_ab',
                        slideUp: 'Reward_slideUp_b2',
                        raysAppearance: 'Reward_raysAppearance_1c',
                        rotate: 'Reward_rotate_41',
                    },
                    vu = eu.S600x450,
                    wu = ({ data: u, hasThird: e, index: t }) => {
                                ...
                                'overlayType' in u
                                    ? ((u) => {
                                          ...
                                          switch (u) {
                                              ...
                                              case nu.ATTACHMENT_RARE:
                                                  return ru.ATTACHMENT_RARE;
                                              case nu.ATTACHMENT_EPIC:
                                                  return ru.ATTACHMENT_EPIC;
                                              case nu.ATTACHMENT_LEGENDARY:
                        ...
                        (0, n.useEffect)(
                            () =>
                                ...
                                })(() => v(R.sounds.bp_reward()), l),
                            [l],
                        );
                        const c = Z(['base'], hu),
                            A = (0, n.useMemo)(
                                () => ({ backgroundImage: `url(${Fu(u, vu)})`, animationDelay: `${l}ms` }),
                                [l, u],
                            ),
                            _ = h()(c.base, e ? hu.base__third : hu.base__regular),
                            F = h()(hu.icon, hu[`icon__${t}`]),
                            d = h()(hu.value, hu[`value__${u.name}`], hu[`value__${i}`]);
                        return a().createElement(
                            pu,
                            { args: r(u.tooltipId) },
                            a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    Boolean(E) &&
                                        a().createElement('div', {
                                            ...
                                            style: {
                                                backgroundImage: `url(R.images.gui.maps.icons.quests.bonuses.${vu}.${E}_overlay)`,
                                            },
                                        }),
                                    o && a().createElement('div', { className: d }, o),
                                ),
                                a().createElement(
                                    'div',
                                    { className: hu.captionContainer },
                                    a().createElement(
                                        'div',
                                        { className: hu.caption },
                                        u.label && a().createElement('div', { className: hu.title }, u.label),
                                    ),
                                ),
                            ),
                        );
                    ...
                    fu = ({ rewards: u }) => {
                        ...
                        return a().createElement(
                            'div',
                            { className: bu },
                            u.map((u, t) => a().createElement(wu, { key: t, index: t, data: u, hasThird: e })),
                        );
                    },
                    Tu = {
                        base: 'App_base_6f',
                        ...
                        close: 'App_close_25',
                        blackout: 'App_blackout_ff',
                        light: 'App_light_3d',
                        light__gold: 'App_light__gold_83',
                        rays: 'App_rays_68',
                        raysAppearance: 'App_raysAppearance_5b',
                        rotate: 'App_rotate_07',
                        ribbon: 'App_ribbon_98',
                        slideUp: 'App_slideUp_ae',
                        ribbon__gold: 'App_ribbon__gold_ab',
                        base__small: 'App_base__small_24',
                        base__extraSmall: 'App_base__extraSmall_46',
                        base__extraLarge: 'App_base__extraLarge_c4',
                        header: 'App_header_e5',
                        title: 'App_title_61',
                        subTitle: 'App_subTitle_70',
                        footer: 'App_footer_5b',
                        base__medium: 'App_base__medium_31',
                        button: 'App_button_21',
                        fadeIn: 'App_fadeIn_d6',
                    },
                    Ru = R.strings.mapbox.awardsView,
                    Su = () => {
                        Q();
                        const u = V('model'),
                            e = u.battlesNumber,
                            t = u.rewards.items.map(({ value: u }) => u),
                            n = M(Ru.subTitle(), { number: e }),
                            r = e >= 50,
                            i = Z(['base'], Tu),
                            s = h()(Tu.light, r && Tu.light__gold),
                            o = h()(Tu.ribbon, r && Tu.ribbon__gold);
                        return a().createElement(
                            'div',
                            { className: i.base },
                            a().createElement(
                                ...
                                a().createElement('div', { className: Tu.blackout }),
                                a().createElement('div', { className: s }),
                                a().createElement('div', { className: Tu.rays }),
                                a().createElement('div', { className: o }),
                                a().createElement(
                                    'div',
                                    { className: Tu.header },
                                    a().createElement('div', { className: Tu.title }, Ru.title()),
                                    a().createElement('div', { className: Tu.subTitle }, n),
                                ),
                                a().createElement(
                                    'div',
                                    { className: Tu.close },
                                ...
                                a().createElement(fu, { rewards: t }),
                                a().createElement(
                                    'div',
                                    { className: Tu.footer },
                                    a().createElement(
                                        S,
                                        { onClick: N.Sy, size: f.medium, type: b.primary, mixClass: Tu.button },
                                        Ru.button(),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    g().render(
                        a().createElement(m, null, a().createElement(Su, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [320], () => __webpack_require__(929));
