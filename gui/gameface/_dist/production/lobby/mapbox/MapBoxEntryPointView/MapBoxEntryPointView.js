(() => {
    var __webpack_modules__ = {
            ...
            129: (u, e, t) => {
                    ...
                    h = (0, a.memo)(({ children: u }) => {
                        const e = (0, a.useContext)(B),
                            ...
                            E = (0, a.useCallback)((u, e) => {
                                ...
                                i(Object.assign({ width: t, height: a }, l(t, a, F)));
                            }, []);
                        m(() => {
                ...
                const T = {
                    ...
                    P = (u) => {
                        ...
                        const n = S(),
                            ...
                            E = n.mediaHeight,
                            A = n.mediaSize;
                        return r().createElement('div', M({ className: w()(t, T[i], O[E], y[A]) }, a), e);
                    },
                    k = ['children'];
                const H = (u) => {
                        let e = u.children,
                        ...
                        return r().createElement(h, null, r().createElement(P, t, e));
                    },
                    I = 33,
                    N = 0,
                    W = !0,
                        ...
                        return (
                            (0, a.useEffect)(() => {
                                ...
                                switch (C) {
                                    ...
                                    case 'stop':
                                        return (function () {
                                            const u = 0 === l && h ? { path: h, x: 0, y: 0 } : n(l),
                                                e = new Image();
                                            e.src = u.path;
                                            const a = () => t(V(u, e));
                                            return (
                ...
                var X = t(364);
                const Z = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    uu = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: r, modelPath: Q(r, u || ''), resId: a };
                            })(),
                            t = e.modelPrefix,
                            a = u.split('.');
                        if (a.length > 0) {
                        ...
                        m(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    a = uu(u);
                                s.current = eu.addCallback(a, t, E, e === tu.Deep);
                            }
                        }),
                        (0, a.useEffect)(() => {
                            if (e !== tu.None)
                                return () => {
                                    eu.removeCallback(s.current, E);
                                };
                        }, [E, e]),
                        o
                    );
                ...
                const Eu = {
                    ...
                    endDate: 'Content_endDate_82',
                    timerIcon: 'Content_timerIcon_99',
                ...
                const ou = {
                    ...
                    lu = (u) => {
                        const e = ((u) => {
                            ...
                            a = e.month;
                        return (
                            (r = R.strings.mapbox.entryPoint.endDateText()),
                            (n = { day: t, month: R.strings.menu.dateTime.months.$num(a + 1) }),
                            r.replace(/\{\w+\}/g, (u) => String(n[u.slice(1, -1)]))
                        );
                        var r, n;
                    },
                    su = {
                    ...
                    du = () => {
                        const u = au(),
                            ...
                            n = (function (u = {}, e = []) {
                                var t, r, n, i;
                                const E = (0, a.useState)(null != (t = u.state) ? t : U),
                                    A = E[0],
                                    F = E[1],
                                    o = (0, a.useState)(null != (r = u.initialFrameIndex) ? r : N),
                                    l = o[0],
                                    s = o[1],
                            ...
                            E = (0, a.useState)(Fu.Big),
                            A = E[0],
                            F = E[1],
                            o = w()(Eu.base, Eu[`base__${A}`]),
                            l = R.strings.mapbox.entryPoint.title(),
                            s = (0, a.useMemo)(() => lu(e), [e]);
                        return (
                            (0, a.useEffect)(() => {
                                const u = (u) => {
                                    const e = ou[`${u.width}*${u.height}`];
                                    e && F(e);
                                };
                                return (
                            ...
                            r().createElement(
                                'div',
                                {
                                    ...
                                    onClick: i,
                                    onMouseEnter: () => {
                                        nu.playHighlight(), n.play();
                                    },
                                    onMouseLeave: () => {
                                        n.stop();
                                    },
                                    onMouseOver: nu.playHighlight,
                                },
                                r().createElement('div', { className: Eu.bg }),
                                r().createElement('div', { className: Eu.shadow }),
                                r().createElement('div', { className: Eu.highlight }),
                                r().createElement(
                                    j,
                                    Au({}, n.props, {
                                        width: su.width,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement('div', { className: Eu.title }, l),
                                    r().createElement(
                                        'div',
                                        { className: Eu.endDate },
                                        r().createElement('div', { className: Eu.timerIcon }),
                                        s,
                                    ),
                                ),
                            )
        ...
        (__webpack_require__.O = (u, e, t, a) => {
            if (!e) {
                ...
                for (A = 0; A < deferred.length; A++) {
                    for (var [e, t, a] = deferred[A], n = !0, i = 0; i < e.length; i++)
                        (!1 & a || r >= a) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [320], () => __webpack_require__(129));
