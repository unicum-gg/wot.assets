(() => {
    ...
    var u,
        A = {
            740: (u, A, F) => {
                var E = {};
                (F.r(E), F.d(E, { mouse: () => T, onResize: () => y }));
                var D = {};
                (F.r(D),
                    F.d(D, {
                        events: () => E,
                ...
                var B = {};
                (F.r(B), F.d(B, { getBgUrl: () => j, getTextureUrl: () => S }));
                var e = {};
                (F.r(e),
                    F.d(e, {
                        addModelObserver: () => W,
                ...
                const s = (u, A, F) => {
                    ...
                    c = (u, A, F = a.left) => u.split(A).reduce(F === a.left ? s : l, []),
                    d = (() => {
                        const u = new RegExp(
                        ...
                        return v.includes(F)
                            ...
                            : ((u, A = a.left) => {
                                  ...
                                  const E =
                                      ...
                                      D = u.replace(/&nbsp;/g, ' ');
                                  return (c(D, /( )/, A).forEach((u) => (F = F.concat(c(u, E, a.left)))), F);
                              })(u, A);
                    },
                            ...
                            const D = A.args,
                                B = (function (u, A) {
                                    ...
                                    var F,
                                        ...
                                        D = {},
                                        B = Object.keys(u);
                                    for (E = 0; E < B.length; E++) ((F = B[E]), A.indexOf(F) >= 0 || (D[F] = u[F]));
                                    return D;
                                })(A, V);
                            return void 0 !== D
                ...
                const ru = Object.keys(k).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === k[A]), u), {}),
                    iu = {
                        set: (u, A) => {
                ...
                const vu = t().forwardRef(function (u, A) {
                        let F = u.children,
                            E = u.className,
                            D = u.theme,
                        ...
                        return (
                            ...
                            t().createElement(
                                'div',
                                du({}, e, {
                                    className: o()(lu.base, lu[`base__theme-${B}`], E),
                                    ref: function (u) {
                    ...
                    mu = () => t().createElement(vu, null, t().createElement(x, null));
                engine.whenReady.then(() => {
                    r().render(t().createElement(mu, null), document.getElementById('root'));
                });
            },
        },
        F = {};
    function E(u) {
        ...
        var B = (F[u] = { exports: {} });
        return (A[u](B, B.exports, E), B.exports);
    }
    ((E.m = A),
        (u = []),
        (E.O = (A, F, D, B) => {
            if (!F) {
                ...
                for (r = 0; r < u.length; r++) {
                    for (var [F, D, B] = u[r], C = !0, t = 0; t < F.length; t++)
                        (!1 & B || e >= B) && Object.keys(E.O).every((u) => E.O[u](F[t]))
                            ? F.splice(t--, 1)
                            : ((C = !1), B < e && (e = B));
                    if (C) {
                        u.splice(r--, 1);
        ...
        (() => {
            ...
            var A = (A, F) => {
                    ...
                    for (A && A(F); n < e.length; n++) ((B = e[n]), E.o(u, B) && u[B] && u[B][0](), (u[B] = 0));
                    return E.O(r);
                },
