(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, E) => {
                E.r(e), E.d(e, { mouse: () => n, onResize: () => t });
                var A = E(2472),
                    F = E(1176);
            ...
            4179: (u, e, E) => {
                ...
                const g = F.instance,
                    h = {
                        ...
                        sendMoveEvent: (u) => p(r.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: m,
                        sendClosePopOverEvent: () => p(r.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, E = 0) => {
                            p(r.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: E, args: e });
                        },
            ...
            4121: (u, e, E) => {
                ...
                const C = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            s({}, C, {
                                className: r()(i.base, i[`base__theme-${n}`], t),
                                ref: function (u) {
                ...
                const d = (u, e, E) => {
                    ...
                    m = (u, e, E = l.left) => u.split(e).reduce(E === l.left ? d : p, []),
                    v = (() => {
                        const u = new RegExp(
                        ...
                        return w.includes(E)
                            ...
                            : ((u, e = l.left) => {
                                  ...
                                  const A =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return m(F, /( )/, e).forEach((u) => (E = E.concat(m(u, A, l.left)))), E;
                              })(u, e);
                    },
                    h = 'FormatText_base_d0',
                    b = ({ binding: u, text: e = '', classMix: E, alignment: t = l.left }) =>
                        null === e
                        ...
                        T(() => {
                            if (
                                ...
                                const E = (u) => {
                                    ...
                                    A = k(u);
                                a.current = x.addCallback(A, E, n, e === M.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== M.None)
                                return () => {
                                    x.removeCallback(a.current, n);
                                };
                        }, [n, e]),
                        B
                    );
                ...
                const z = {
                        ...
                        descriptionText__max: 'Content_descriptionText__max_d7',
                        description: 'Content_description_4c',
                        progress: 'Content_progress_f4',
                        progress__gold: 'Content_progress__gold_ee',
                        progress__credits: 'Content_progress__credits_dc',
                        maxValue: 'Content_maxValue_78',
                        separatorTopWrapper: 'Content_separatorTopWrapper_fb',
                        separator: 'Content_separator_c2',
                        progressWrapper: 'Content_progressWrapper_72',
                        icon: 'Content_icon_f2',
                    },
                    Y = R.strings.resource_well.tooltips.resourcesLoadingView.limitCounter,
                    H = () => {
                        const u = N('model', M.None),
                            e = u.currentValue,
                            E = u.maxValue,
                            A = u.resourceType,
                            t = r()(z.progress, z[`progress__${A}`]);
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                { className: z.content },
                                F().createElement(b, {
                                    classMix: z.descriptionText,
                                    binding: {
                                        maxAmount: F().createElement(
                                            'span',
                                            { className: z.descriptionText__max },
                                            F().createElement(_, { value: E }),
                                        ),
                                    },
                                    text: Y.header(),
                                }),
                                F().createElement('div', { className: z.description }, Y.body()),
                                F().createElement(
                                    'div',
                                    { className: z.separatorTopWrapper },
                                    F().createElement('div', { className: z.separator }),
                                ),
                                F().createElement(
                                    'div',
                                    { className: z.progressWrapper },
                                    F().createElement(b, {
                                        classMix: t,
                                        binding: {
                                            icon: F().createElement('span', {
                                                ...
                                                style:
                                                    ((D = A),
                                                    {
                                                        backgroundImage: `url(${R.images.gui.maps.icons.blueprints.fragment.special.$dyn(D) || R.images.gui.maps.icons.resourceWell.resourcesLoading.icons.$dyn(D)})`,
                                                    }),
                                            }),
                                            amount: F().createElement(_, { value: e }),
                                            maxAmount: F().createElement(
                                                'span',
                                                { className: z.maxValue },
                                                F().createElement(_, { value: E }),
                                            ),
                                        },
                                        text: Y.amount(),
                    ...
                    K = () => F().createElement(C, null, F().createElement(H, null));
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [52], () => __webpack_require__(4121));
