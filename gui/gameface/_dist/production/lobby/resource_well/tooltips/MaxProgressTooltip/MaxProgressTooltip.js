(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, E) => {
                E.r(e),
                    E.d(e, { mouse: () => C, off: () => r, on: () => n, onResize: () => t, onScaleUpdated: () => D });
                var A = E(2472),
                    F = E(1176);
            ...
            9916: (u, e, E) => {
                E.d(e, { Sw: () => t.Z, B3: () => r, Z5: () => D.Z5, ry: () => d });
                class A {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            6893: (u, e, E) => {
                ...
                const v = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    h = (u, e, E = _.left) => u.split(e).reduce(E === _.left ? w : m, []),
                    f = (() => {
                        const u = new RegExp(
                    ...
                    b = (u, e = _.left) => {
                        ...
                        return ((u, e = _.left) => {
                            ...
                            const A =
                                ...
                                F = v(u);
                            return h(F, /( )/, e).forEach((u) => (E = E.concat(h(u, A, _.left)))), E;
                        })(u, e);
                    },
                    O = 'FormatText_base_d0',
                    y = ({ binding: u, text: e = '', classMix: E, alignment: t = _.left, formatWithBrackets: D }) => {
                        ...
                        return F().createElement(
                            ...
                            n.split('\n').map((e, D) =>
                                F().createElement(
                                    'div',
                                    { className: r()(O, E), key: `${e}-${D}` },
                                    ((u, e, E) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (E && u in E ? E[u] : b(u, e))))(
                                        e,
                                        t,
                                        u,
                ...
                const I = (u = 'model', e = V.Deep) => {
                            ...
                            P(() => {
                                if (
                                    ...
                                    const E = (u) => {
                                        ...
                                        A = M(u);
                                    i.current = N.addCallback(A, E, n, e === V.Deep);
                                }
                            }),
                            (0, A.useEffect)(() => {
                                if (e !== V.None)
                                    return () => {
                                        N.removeCallback(i.current, n);
                                    };
                            }, [n, e]),
                            C
                        );
                    ...
                    q = () => {
                        const u = I('model', V.None),
                            e = u.currentValue,
                            E = u.maxValue,
                            A = u.resourceType,
                            t = r()(W.progress, W[`progress__${A}`]);
                        return F().createElement(
                            'div',
                            { className: W.base },
                            F().createElement(
                                ...
                                { className: W.content },
                                F().createElement(y, {
                                    classMix: W.descriptionText,
                                    binding: {
                                        maxAmount: F().createElement(
                                            'span',
                                            { className: W.descriptionText__max },
                                            F().createElement(l, { value: E }),
                                        ),
                                    },
                                    text: U.header(),
                                }),
                                F().createElement('div', { className: W.description }, U.body()),
                                F().createElement(
                                    'div',
                                    { className: W.separatorTopWrapper },
                                    F().createElement('div', { className: W.separator }),
                                ),
                                F().createElement(
                                    'div',
                    ...
                    z = () => F().createElement(s, null, F().createElement(q, null));
                engine.whenReady.then(() => {
                    D().render(F().createElement(z, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [52], () => __webpack_require__(6893));
