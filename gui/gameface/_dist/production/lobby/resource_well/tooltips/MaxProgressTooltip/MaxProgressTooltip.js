    ...
    var __webpack_modules__ = {
            ...
            4121: (u, e, E) => {
                        ...
                        T(() => {
                            if (
                                ...
                                const E = (u) => {
                                    ...
                                    A = k(u);
                                s.current = x.addCallback(A, E, n, e === M.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== M.None)
                                return () => {
                                    x.removeCallback(s.current, n);
                                };
                        }, [n, e]),
                        B
                    );
                ...
                const z = {
                    ...
                    H = () => F().createElement(C, null, F().createElement(K, null));
                engine.whenReady.then(() => {
                    D().render(F().createElement(H, null), document.getElementById('root'));
                });
            },
        },
