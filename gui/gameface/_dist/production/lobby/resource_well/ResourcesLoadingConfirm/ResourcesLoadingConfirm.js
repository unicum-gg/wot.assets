(() => {
    var __webpack_modules__ = {
                ...
                const o = ({
                    ...
                    return E().createElement(
                        ...
                        A.split('\n').map((e, o) =>
                            E().createElement(
                                'div',
                                { className: n()(s.Z.base, t), key: `${e}-${o}` },
            ...
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => A, off: () => s, on: () => E, onResize: () => a, onScaleUpdated: () => i });
                var r = t(2472),
                    n = t(1176);
            ...
            5360: (u, e, t) => {
                ...
                const l = (u = 'model', e = F.Deep) => {
                    const t = (0, s.useState)(0),
                        ...
                        B = l.resId,
                        C = (0, s.useMemo)(() => {
                            const e = (0, o.sI)(c.replace('.js', '.html'));
                        ...
                        (0, a.Z)(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    r = (0, E.U0)(u);
                                h.current = A.addCallback(r, t, B, e === F.Deep);
                            }
                        }),
                        (0, s.useEffect)(() => {
                            if (e !== F.None)
                                return () => {
                                    A.removeCallback(h.current, B);
                                };
                        }, [B, e]),
                        d
                    );
            ...
            3649: (u, e, t) => {
                ...
                const i = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    o = (u, e, t = n.left) => u.split(e).reduce(t === n.left ? E : s, []),
                    A = (() => {
                        const u = new RegExp(
                    ...
                    l = (u, e = n.left) => {
                        ...
                        return ((u, e = n.left) => {
                            ...
                            const r =
                                ...
                                a = i(u);
                            return o(a, /( )/, e).forEach((u) => (t = t.concat(o(u, r, n.left)))), t;
                        })(u, e);
                    },
                    c = (u, e, t) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : l(u, e)));
            },
            1358: (u, e, t) => {
                'use strict';
                t.d(e, { Z: () => a });
            ...
            9916: (u, e, t) => {
                'use strict';
                t.d(e, { Sw: () => a.Z, B3: () => s, Z5: () => i.Z5, ry: () => _ });
                class r {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
                ...
                const a = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    o = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: a, modelPath: E(a, u || ''), resId: n };
                            })(),
                            t = e.modelPrefix,
                            i = u.split('.');
                        if (i.length > 0) {
            ...
            1355: (u, e, t) => {
                ...
                const T = {
                    ...
                    M = (u) => {
                        ...
                        const a = b(),
                            ...
                            E = a.mediaHeight,
                            s = a.mediaSize;
                        return n().createElement('div', L({ className: h()(t, T[i], y[E], S[s]) }, r), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                function G(u = W.n.NONE, e = U, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== W.n.NONE)
                            return (
                ...
                class K extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = h()(V.base, V[`base__${i}`], V[`base__${a}`], null == E ? void 0 : E.base),
                            D = h()(V.icon, V[`icon__${i}`], V[`icon__${a}`], null == E ? void 0 : E.icon),
                            B = h()(V.glow, null == E ? void 0 : E.glow),
                            C = h()(V.caption, V[`caption__${i}`], null == E ? void 0 : E.caption),
                ...
                var q = t(8288);
                const Z = R.strings.resource_well.confirm,
                    Y = ({ operationType: u, mixClass: e }) =>
                        n().createElement(
                            'div',
                            { className: e },
                            u === I.Contribute ? Z.resourcesContribute.title() : Z.resourcesReturn.title(),
                        );
                var X = t(280);
                t(3649);
                const Q = 'DescriptionBlock_base_a8',
                    J = 'DescriptionBlock_text_fc',
                    uu = 'DescriptionBlock_percentText_1c',
                    eu = R.strings.resource_well.confirm,
                    tu = ({ operationType: u, progressDiff: e = 0, mixClass: t }) => {
                        const r = h()(Q, t);
                        return n().createElement(
                            'div',
                            { className: r },
                            n().createElement(
                                ...
                                u === I.Contribute
                                    ? n().createElement(X.z, {
                                          text: eu.resourcesContribute.description.text(),
                                          binding: { percent: n().createElement('div', { className: uu }, e, '%') },
                                      })
                                    : eu.resourcesReturn.description.text(),
                            ),
                        );
                    },
                    ru = {
                ...
                const Eu = iu,
                    su = 'ButtonsBlock_base_66',
                    ou = 'ButtonsBlock_button_bc',
                    Au = R.strings.resource_well.confirm,
                    Fu = ({ operationType: u, handleOnConfirm: e, handleOnCancel: t, mixClass: r }) => {
                        const a = h()(su, r);
                        return n().createElement(
                            'div',
                            { className: a },
                            u === I.Contribute
                                ? n().createElement(
                                      ...
                                      n().createElement(
                                          Eu,
                                          { type: nu.main, size: au.medium, onClick: e, mixClass: ou },
                                          Au.resourcesContribute.buttonConfirm.title(),
                                      ),
                                      n().createElement(
                                          Eu,
                                          { type: nu.primary, size: au.medium, onClick: t, mixClass: ou },
                                          Au.buttonCancel.title(),
                                      ),
                                  )
                                : n().createElement(
                                      n().Fragment,
                                      ...
                                      n().createElement(
                                          Eu,
                                          { type: nu.primary, size: au.medium, onClick: e, mixClass: ou },
                                          Au.resourcesReturn.buttonConfirm.title(),
                                      ),
                                      n().createElement(
                                          Eu,
                                          { type: nu.secondary, size: au.medium, onClick: t, mixClass: ou },
                                          Au.buttonCancel.title(),
                                      ),
                                  ),
                        );
                ...
                var lu = t(1693);
                const cu = 'App_base_7d',
                    Du = 'App_additionalBg_7a',
                    Bu = 'App_vehiclesCount_00',
                    Cu = 'App_close_b4',
                    _u = 'App_content_82',
                    du = 'App_title_1e',
                    ...
                    bu = () => {
                        const u = (0, N.t)('model', N.D.None),
                            ...
                            o = e === I.Contribute,
                            A = e === I.Return,
                            F = (0, r.useCallback)(() => i(), [i]),
                            l = (0, r.useCallback)(() => a(), [a]),
                            c = (0, r.useCallback)(() => t(), [t]);
                        var D;
                        (D = l), G(W.n.ESCAPE, D);
                        const B = h()(cu, o && pu, A && gu);
                        return n().createElement(
                            'div',
                            { className: B },
                            n().createElement('div', { className: Du }),
                            o && n().createElement('div', { className: Bu }, n().createElement(q.M, null)),
                            n().createElement(
                                'div',
                                { className: Cu },
                                n().createElement(K, {
                            ...
                            n().createElement(
                                'div',
                                { className: _u },
                                n().createElement(Y, { operationType: e, mixClass: du }),
                                n().createElement(
                                    'div',
                                    { className: mu },
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: wu },
                                        s.map((u, e) => n().createElement(lu._, { key: e, resource: u.value })),
                                    ),
                                    n().createElement('div', { className: hu }),
                                ),
                                n().createElement(tu, { progressDiff: E, operationType: e, mixClass: vu }),
                                n().createElement(Fu, {
                                    operationType: e,
                                    handleOnCancel: F,
                                    handleOnConfirm: c,
            ...
            1693: (u, e, t) => {
                ...
                const o = {
                    ...
                    A = ({ resource: { count: u, subType: e, type: t } }) => {
                        const r = i()(o.counter, 'currency' !== t && o.counter__noCurrency, o[`counter__${e}`]);
                        return n().createElement(
                            'div',
                            { className: o.base },
                            n().createElement('div', { className: i()(o.resourceIcon, o[`resourceIcon__${e}`]) }),
                            n().createElement(
                                'div',
                                { className: r },
                                n().createElement(
            ...
            8288: (u, e, t) => {
                ...
                const F = 'VehicleCount_base_05',
                    l = 'VehicleCount_text_91',
                    c = 'VehicleCount_text__alert_2f',
                    D = 'VehicleCount_text__finished_4c',
                    B = 'VehicleCount_textCounter_17',
                    ...
                    p = () => {
                        const u = (0, i.tT)('model.vehicleCounter', i.DA.Shallow),
                            e = u.vehicleCount,
                            ...
                            f = { enter: h, exit: g },
                            b = {
                                counter: s().createElement(
                                    'div',
                                    { className: _ },
                                    E && s().createElement('span', { className: m }),
                                    s().createElement('span', { className: B }, e),
                                ),
                                icon: s().createElement('span', { className: C }),
                            };
