    ...
    var __webpack_modules__ = {
            280: (u, e, t) => {
                ...
                var r = t(6179),
                    ...
                    i = t(3649),
                    A = t(5287);
                const s = ({ binding: u, text: e = '', classMix: t, alignment: a = i.v2.left }) =>
                    null === e
                        ...
                        (0, a.Z)(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    r = (0, i.U0)(u);
                                d.current = s.addCallback(r, t, l, e === o.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== o.None)
                                return () => {
                                    s.removeCallback(d.current, l);
                                };
                        }, [l, e]),
                        B
                    );
            ...
            3649: (u, e, t) => {
                ...
                const n = (u, e, t) => {
                    ...
                    E = (u, e, t = r.left) => u.split(e).reduce(t === r.left ? n : a, []),
                    i = (() => {
                        const u = new RegExp(
                ...
                const a = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    s = (u) => {
                        ...
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, r) => {
                                    const E = (0, n.M)(i(t, `${e}.${r}`), window);
                                    return a(E) ? (u.push(E.id), `${e}.${r}.value`) : (u.push(r), `${e}.${r}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
            ...
            1355: (u, e, t) => {
                ...
                const o = E.O.client.getSize('rem'),
                    F = o.width,
                    D = o.height,
                    l = Object.assign({ width: F, height: D }, s(F, D, i)),
                ...
                const B = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.smallWidth && B) return a(e, t, p);
                ...
                const d = (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(c),
                        ...
                        o = (0, r.useCallback)((u, e) => {
                            ...
                            A(Object.assign({ width: t, height: r }, s(t, r, i)));
                        }, []);
                    ((0, C.Z)(() => {
                ...
                const M = {
                    ...
                    y = (u) => {
                        ...
                        const a = b(),
                            ...
                            i = a.mediaHeight,
                            A = a.mediaSize;
                        return n().createElement('div', L({ className: h()(t, M[E], T[i], S[A]) }, r), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                class G extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()(I.base, I[`base__${E}`], I[`base__${a}`], null == i ? void 0 : i.base),
                            c = h()(I.icon, I[`icon__${E}`], I[`icon__${a}`], null == i ? void 0 : i.icon),
                            _ = h()(I.glow, null == i ? void 0 : i.glow),
                            B = h()(I.caption, I[`caption__${E}`], null == i ? void 0 : i.caption),
                            C = h()(I.goto, null == i ? void 0 : i.goto);
                        return n().createElement(
                            ...
                            n().createElement('div', { className: c }, n().createElement('div', { className: _ })),
                ...
                ((G.defaultProps = { side: 'left', type: 'back', soundHover: 'highlight', soundClick: 'play' }),
                    (function (u) {
                        ((u[(u.Return = 0)] = 'Return'), (u[(u.Contribute = 1)] = 'Contribute'));
                    })(V || (V = {})));
                var $ = t(5521);
                t(4179);
                const z = (u) => {
                    ...
                    const B = (0, r.useRef)(null),
                        ...
                        H = h()(
                            ...
                            Z[`base__${a}`],
                            {
                                ...
                                [Z.base__firstHover]: f,
                            },
                            i,
                        ),
                        N = h()(Z.state, Z.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                ...
                const uu = (0, r.memo)(J),
                    eu = 'ButtonsBlock_base_66',
                    tu = 'ButtonsBlock_button_bc',
                    ru = R.strings.resource_well.confirm,
                    nu = ({ operationType: u, handleOnConfirm: e, handleOnCancel: t, mixClass: r }) => {
                        const a = h()(eu, r);
                        return n().createElement(
                            'div',
                            { className: a },
                            u === V.Contribute
                                ? n().createElement(
                                      ...
                                      n().createElement(
                                          uu,
                                          { type: X.main, size: Q.medium, onClick: e, mixClass: tu },
                                          ru.resourcesContribute.buttonConfirm.title(),
                                      ),
                                      n().createElement(
                                          uu,
                                          { type: X.primary, size: Q.medium, onClick: t, mixClass: tu },
                                          ru.buttonCancel.title(),
                                      ),
                                  )
                                : n().createElement(
                                      n().Fragment,
                                      ...
                                      n().createElement(
                                          uu,
                                          { type: X.primary, size: Q.medium, onClick: e, mixClass: tu },
                                          ru.resourcesReturn.buttonConfirm.title(),
                                      ),
                                      n().createElement(
                                          uu,
                                          { type: X.secondary, size: Q.medium, onClick: t, mixClass: tu },
                                          ru.buttonCancel.title(),
                                      ),
                                  ),
                        );
                ...
                var au = t(280);
                t(3649);
                const Eu = 'DescriptionBlock_base_a8',
                    iu = 'DescriptionBlock_text_fc',
                    Au = 'DescriptionBlock_percentText_1c',
                    su = R.strings.resource_well.confirm,
                    ou = ({ operationType: u, progressDiff: e = 0, mixClass: t }) => {
                        const r = h()(Eu, t);
                        return n().createElement(
                            'div',
                            { className: r },
                            n().createElement(
                                ...
                                { className: iu },
                                u === V.Contribute
                                    ? n().createElement(au.z, {
                                          text: su.resourcesContribute.description.text(),
                                          binding: { percent: n().createElement('div', { className: Au }, e, '%') },
                                      })
                                    : su.resourcesReturn.description.text(),
                            ),
                        );
                    },
                    Fu = R.strings.resource_well.confirm,
                    Du = ({ operationType: u, mixClass: e }) =>
                        n().createElement(
                            'div',
                            { className: e },
                            u === V.Contribute ? Fu.resourcesContribute.title() : Fu.resourcesReturn.title(),
                        ),
                    lu = 'App_base_7d',
                    cu = 'App_additionalBg_7a',
                    _u = 'App_vehiclesCount_00',
                    Bu = 'App_close_b4',
                    Cu = 'App_content_82',
                    du = 'App_title_1e',
                    mu = 'App_resourcesBlock_9a',
                    hu = 'App_divider_7d',
                    gu = 'App_base__return_76',
                    vu = 'App_descriptionBlock_bb',
                    pu = 'App_base__contribute_eb',
                    wu = 'App_resources_93',
                    fu = 'App_buttonsBlock_c0',
                    bu = () => {
                        const u = (0, K.t)('model', K.D.None),
                            e = u.operationType,
                            t = u.confirm,
                            a = u.close,
                            E = u.cancel,
                            ...
                            l = (0, r.useCallback)(() => t(), [t]);
                        var c;
                        ((c = D), j($.n.ESCAPE, c));
                        const _ = h()(lu, s && pu, o && gu);
                        return n().createElement(
                            'div',
                            { className: _ },
                            n().createElement('div', { className: cu }),
                            s && n().createElement('div', { className: _u }, n().createElement(Y.M, null)),
                            n().createElement(
                                'div',
                                { className: Bu },
                                n().createElement(G, {
                            ...
                            n().createElement(
                                'div',
                                { className: Cu },
                                n().createElement(Du, { operationType: e, mixClass: du }),
                                n().createElement(
                                    'div',
                                    { className: mu },
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: wu },
                                        A.map((u, e) => n().createElement(q._, { key: e, resource: u.value })),
                                    ),
                                    n().createElement('div', { className: hu }),
                                ),
                                n().createElement(ou, { progressDiff: i, operationType: e, mixClass: vu }),
                                n().createElement(nu, {
                                    operationType: e,
                                    handleOnCancel: F,
                                    handleOnConfirm: l,
                ...
                engine.whenReady.then(() => {
                    N().render(
                        n().createElement(k, null, n().createElement(bu, null)),
            ...
            1693: (u, e, t) => {
                ...
                const s = {
                        base: 'Resource_base_7c',
                        resourceIcon: 'Resource_resourceIcon_d2',
                        resourceIcon__gold: 'Resource_resourceIcon__gold_ed',
                        resourceIcon__credits: 'Resource_resourceIcon__credits_34',
                        resourceIcon__freeXP: 'Resource_resourceIcon__freeXP_7d',
                        resourceIcon__crystal: 'Resource_resourceIcon__crystal_55',
                        resourceIcon__intelligence: 'Resource_resourceIcon__intelligence_5c',
                        resourceIcon__ussr: 'Resource_resourceIcon__ussr_80',
                        resourceIcon__germany: 'Resource_resourceIcon__germany_37',
                        resourceIcon__china: 'Resource_resourceIcon__china_70',
                        resourceIcon__czech: 'Resource_resourceIcon__czech_1a',
                        resourceIcon__france: 'Resource_resourceIcon__france_98',
                        resourceIcon__italy: 'Resource_resourceIcon__italy_e0',
                        resourceIcon__japan: 'Resource_resourceIcon__japan_1c',
                        resourceIcon__poland: 'Resource_resourceIcon__poland_f0',
                        resourceIcon__sweden: 'Resource_resourceIcon__sweden_37',
                        resourceIcon__uk: 'Resource_resourceIcon__uk_0a',
                        resourceIcon__usa: 'Resource_resourceIcon__usa_00',
                        resourceIcon__intunion: 'Resource_resourceIcon__intunion_ec',
                        resourceIcon__premium_plus: 'Resource_resourceIcon__premium_plus_46',
                        counter: 'Resource_counter_fe',
                        counter__noCurrency: 'Resource_counter__noCurrency_5e',
                        counter__crystal: 'Resource_counter__crystal_75',
                        counter__freeXP: 'Resource_counter__freeXP_68',
                        counter__gold: 'Resource_counter__gold_8e',
                        counter__credits: 'Resource_counter__credits_65',
                        count: 'Resource_count_7c',
                    },
                    o = ({ resource: { count: u, subType: e, type: t } }) => {
                        const r = E()(s.counter, 'currency' !== t && s.counter__noCurrency, s[`counter__${e}`]);
                        return n().createElement(
                            'div',
                            { className: s.base },
                            n().createElement('div', { className: E()(s.resourceIcon, s[`resourceIcon__${e}`]) }),
                            n().createElement(
                                'div',
                                { className: r },
                                n().createElement(
            ...
            8288: (u, e, t) => {
                ...
                var r = t(6483),
                    ...
                    s = t(9953),
                    o = t(4306);
                const F = 'VehicleCount_base_05',
                    D = 'VehicleCount_text_91',
                    l = 'VehicleCount_text__alert_2f',
                    c = 'VehicleCount_text__finished_4c',
                    _ = 'VehicleCount_textCounter_17',
                    B = 'VehicleCount_alertIcon_98',
                    C = 'VehicleCount_counterWrapper_1f',
                        ...
                        const u = (0, E.tT)('model.vehicleCounter', E.DA.Shallow),
                            ...
                            b = {
                                counter: A().createElement(
                                    ...
                                    A().createElement('span', { className: _ }, e),
                                ),
                                icon: A().createElement('span', { className: B }),
                            };
