(() => {
    var __webpack_modules__ = {
                        ...
                        return n.includes(t)
                            ...
                            : ((u, e = E.left) => {
                                  ...
                                  const A =
                                      ...
                                      a = u.replace(/&nbsp;/g, ' ');
                                  return F(a, /( )/, e).forEach((u) => (t = t.concat(F(u, A, E.left)))), t;
                              })(u, e);
                    },
                    s = (u, e, t) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : D(u, e)));
            },
            1358: (u, e, t) => {
                'use strict';
                t.d(e, { Z: () => a });
            ...
            4179: (u, e, t) => {
                ...
                function c(u, e, t, E, A, a, r) {
                    ...
                    F.done ? e(i) : Promise.resolve(i).then(E, A);
                }
            ...
            5321: (u, e, t) => {
                ...
                const D = r.O.client.getSize('rem'),
                    s = D.width,
                    l = D.height,
                    B = Object.assign({ width: s, height: l }, n(s, l, F)),
                    ...
                    _ = (0, E.memo)(({ children: u }) => {
                        const e = (0, E.useContext)(o),
                            ...
                            D = (0, E.useCallback)((u, e) => {
                                ...
                                i(Object.assign({ width: t, height: E }, n(t, E, F)));
                            }, []);
                        d(() => {
                ...
                const S = {
                    ...
                    O = (u) => {
                        ...
                        const a = b(),
                            ...
                            F = a.mediaHeight,
                            i = a.mediaSize;
                        return A().createElement('div', L({ className: h()(t, S[r], M[F], T[i]) }, E), e);
                    },
                    y = ['children'];
                const H = (u) => {
                    let e = u.children,
                        ...
                        d(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = eu(u);
                                l.current = tu.addCallback(E, t, F, e === Eu.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== Eu.None)
                                return () => {
                                    tu.removeCallback(l.current, F);
                                };
                        }, [F, e]),
                        D
                    );
                ...
                function Fu(u = au.n.NONE, e = ru, t = !1) {
                    (0, E.useEffect)(() => {
                        if (u !== au.n.NONE)
                            return (
                ...
                var iu = t(9356);
                const nu = 'VideoButton_base_d9',
                    Du = 'VideoButton_icon_a3',
                    su = 'VideoButton_text_ef',
                    lu = ({ onClick: u, className: e }) =>
                        A().createElement(
                            'div',
                            {
                                className: h()(nu, e),
                            ...
                            A().createElement(
                                'div',
                                { className: su },
                                R.strings.resource_well.introView.buttonVideo(),
                            ),
                        ),
                    Bu = 'App_base_ce',
                    ou = 'App_blackout_53',
                    Cu = 'App_content_d5',
                    cu = 'App_cell_05',
                    du = 'App_cell__alignRight_3a',
                    _u = 'App_img_d0',
                    mu = 'App_description_af',
                    hu = 'App_heading_d7',
                    gu = 'App_separator_84',
                    vu = 'App_details_96',
                    wu = 'App_title_9c',
                    pu = 'App_text_72',
                    fu = 'App_button_68',
                    bu = 'App_formatText_e2',
                    xu = 'App_videoButton_68',
                    Lu = R.strings.resource_well.introView,
                    Su = () => {
                        const u = Au('model', Eu.None),
                            e = u.onClose,
                            t = u.showVideo,
                            E = u.vehicleInfo,
                        ...
                        return (
                            ...
                            A().createElement(
                                    ...
                                    A().createElement(
                                        ...
                                        A().createElement(
                                            ...
                                            A().createElement(
                                                'div',
                                                { className: vu },
                                                A().createElement('div', { className: wu }, Lu.resTitle()),
                                                A().createElement('div', { className: pu }, Lu.resDescription()),
                                            ),
                                            A().createElement(
                                                'div',
                                                { className: vu },
                                                A().createElement(
                                                    ...
                                                    A().createElement(j, {
                                                        ...
                                                        text: Lu.vehTitle(),
                                                        binding: {
                                                            vehicleInfo: A().createElement(iu.e, {
                                                                vehicleInfo: E,
                                                                theme: iu.b.Intro,
                                                            }),
                                                        },
                                ...
                                A().createElement(lu, { onClick: t, className: xu }),
                            )
                        );
                    };
            ...
            9356: (u, e, t) => {
                ...
                const B = ({ vehicleInfo: u, theme: e, className: t }) => {
                    const E = u.vehicleLvl,
                        a = u.vehicleName,
                        r = u.vehicleType,
                        n = u.isElite;
                        ...
                        D().createElement(
                            ...
                            D().createElement('div', {
                                ...
                                style: (() => {
                                    const u = (0, i.BN)(r);
                                    return {
                                        backgroundImage: `url(${R.images.gui.maps.icons.vehicleTypes.big.$dyn(`${u}${n ? '_elite' : ''}`)})`,
                                    };
                                })(),
                            }),
                        ),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [52], () => __webpack_require__(5321));
