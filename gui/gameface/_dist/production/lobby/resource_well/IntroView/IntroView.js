(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                (t.r(e),
                    t.d(e, { mouse: () => D, off: () => i, on: () => n, onResize: () => r, onScaleUpdated: () => A }));
                var E = t(2472),
                    a = t(1176);
            ...
            514: (u, e, t) => {
                ...
                const a = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    ...
                    A = { play: Object.assign({}, r, { sound: E.playSound }), setRTPC: E.setRTPC };
            },
            3722: (u, e, t) => {
                'use strict';
                function E(u, e, t = 1) {
                    ...
                    l = (u, e = a.left) => {
                        ...
                        return ((u, e = a.left) => {
                            ...
                            const E =
                                ...
                                r = n(u);
                            return (D(r, /( )/, e).forEach((u) => (t = t.concat(D(u, E, a.left)))), t);
                        })(u, e);
                    },
            ...
            9916: (u, e, t) => {
                'use strict';
                t.d(e, { Sw: () => r.Z, B3: () => i, Z5: () => A.Z5, ry: () => d });
                class E {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            1459: (u, e, t) => {
                ...
                const D = A.O.client.getSize('rem'),
                    s = D.width,
                    o = D.height,
                    l = Object.assign({ width: s, height: o }, F(s, o, n)),
                ...
                const c = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && s) return r(e, t, w);
                ...
                const z = 'FormatText_base_d0',
                    j = ({
                        ...
                        text: e = '',
                        classMix: t,
                        alignment: r = V.v2.left,
                        formatWithBrackets: A,
                    }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const n = A && u ? (0, V.WU)(e, u) : e;
                        ...
                        d(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = eu(u);
                                l.current = Eu.addCallback(E, t, i, e === au.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== au.None)
                                return () => {
                                    Eu.removeCallback(l.current, i);
                                };
                        }, [i, e]),
                        s
                    );
                ...
                function iu(u = Au.n.NONE, e = nu, t = !1, a = !1) {
                    (0, E.useEffect)(() => {
                        if (u !== Au.n.NONE)
                            return (
                ...
                var Fu = t(9356);
                const Du = 'VideoButton_base_d9',
                    su = 'VideoButton_icon_a3',
                    ou = 'VideoButton_text_ef',
                    ...
                    cu = 'App_content_d5',
                    du = 'App_cell_05',
                    _u = 'App_cell__alignRight_3a',
                    mu = 'App_img_d0',
                    hu = 'App_description_af',
                    gu = 'App_heading_d7',
                    vu = 'App_separator_84',
                    wu = 'App_details_96',
                    pu = 'App_title_9c',
                    fu = 'App_text_72',
                    bu = 'App_button_68',
                    xu = 'App_formatText_e2',
                    Lu = 'App_videoButton_68',
                    Su = R.strings.resource_well.introView,
                    yu = () => {
                        const u = ru('model', au.None),
                            e = u.onClose,
                            t = u.showVideo,
                            E = u.vehicleInfo,
                            r = u.regularRewardVehiclesCount,
                            A = u.topRewardPlayersCount,
                            n = b().mediaSize;
                        var i;
                        return (
                            (i = e),
                            ...
                            a().createElement(
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(
                                            ...
                                            a().createElement(
                                                'div',
                                                { className: wu },
                                                a().createElement('div', { className: pu }, Su.resTitle()),
                                                a().createElement('div', { className: fu }, Su.resDescription()),
                                            ),
                                            a().createElement(
                                                'div',
                                                { className: wu },
                                                a().createElement(
                                                    ...
                                                    a().createElement(j, {
                                                        ...
                                                        text: Su.vehTitle(),
                                                        binding: {
                                                            vehicleInfo: a().createElement(Fu.e, {
                                                                vehicleInfo: E,
                                                                theme: Fu.b.Intro,
                                                            }),
                                                        },
                                ...
                                a().createElement(lu, { onClick: t, className: Lu }),
                            )
                        );
                    };
                engine.whenReady.then(() => {
                    P().render(
                        a().createElement(H, null, a().createElement(yu, null)),
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, t, E] = deferred[i], r = !0, A = 0; A < e.length; A++)
                        (!1 & E || a >= E) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [52], () => __webpack_require__(1459));
