    ...
    var __webpack_modules__ = {
            ...
            1624: (u, e, t) => {
                ...
                const D = F.O.client.getSize('rem'),
                    s = D.width,
                    l = D.height,
                    B = Object.assign({ width: s, height: l }, n(s, l, r)),
                        ...
                        d(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = eu(u);
                                l.current = tu.addCallback(E, t, r, e === Eu.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== Eu.None)
                                return () => {
                                    tu.removeCallback(l.current, r);
                                };
                        }, [r, e]),
                        D
                    );
