(() => {
    var __webpack_modules__ = {
                    ...
                    p = {
                        ...
                        sendShowPopOverEvent: (u, e, t, E, A = R.invalid('resId'), a) => {
                            const F = o.O.view.getViewGlobalPosition(),
                                ...
                                B = r.height,
                                l = {
                                    x: o.O.view.pxToRem(n) + F.x,
                                    y: o.O.view.pxToRem(D) + F.y,
            ...
            1624: (u, e, t) => {
                ...
                const D = F.O.client.getSize('rem'),
                    s = D.width,
                    B = D.height,
                    l = Object.assign({ width: s, height: B }, n(s, B, r)),
                    o = (0, E.createContext)(l),
                    C = ['children'];
                const c = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    _ = (0, E.memo)(({ children: u }) => {
                        const e = (0, E.useContext)(o),
                            ...
                            D = (0, E.useCallback)((u, e) => {
                                ...
                                i(Object.assign({ width: t, height: E }, n(t, E, r)));
                            }, []);
                        (d(() => {
                ...
                const S = {
                    ...
                    O = (u) => {
                        ...
                        const a = b(),
                            ...
                            r = a.mediaHeight,
                            i = a.mediaSize;
                        return A().createElement('div', L({ className: h()(t, S[F], M[r], T[i]) }, E), e);
                    },
                    y = ['children'];
                const H = (u) => {
                    let e = u.children,
                ...
                const G = ({
                    ...
                    const c = (0, E.useRef)(null),
                        ...
                        b = p[1],
                        x = (0, E.useCallback)(() => {
                            F || (c.current && (c.current.focus(), m(!0)));
                        }, [F]),
                        L = (0, E.useCallback)(
                            (u) => {
                        ...
                        d(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = eu(u);
                                B.current = tu.addCallback(E, t, r, e === Eu.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== Eu.None)
                                return () => {
                                    tu.removeCallback(B.current, r);
                                };
                        }, [r, e]),
                        D
                    );
                ...
                function ru(u = au.n.NONE, e = Fu, t = !1) {
                    (0, E.useEffect)(() => {
                        if (u !== au.n.NONE)
                            return (
                        ...
                        function E(E) {
                            if (E.keyCode === u) {
                                ...
                                (F.O.view.setEventHandled(), e(E), t && E.stopPropagation());
                            }
                        }
                    }, [e, u, t]);
                }
                var iu = t(9356);
                const nu = 'App_base_ce',
                    Du = 'App_blackout_53',
                    su = 'App_content_d5',
                    Bu = 'App_cell_05',
                    lu = 'App_cell__alignRight_3a',
                    ou = 'App_img_d0',
                    Cu = 'App_description_af',
                    cu = 'App_heading_d7',
                    du = 'App_separator_84',
                    _u = 'App_details_96',
                    mu = 'App_title_9c',
                    hu = 'App_text_72',
                    gu = 'App_button_68',
                    vu = 'App_formatText_e2',
                    wu = R.strings.resource_well.introView,
                    pu = () => {
                        const u = Au('model', Eu.None),
                            e = u.onClose,
                            t = u.vehicleInfo,
                            E = u.regularRewardVehiclesCount,
                                    ...
                                    A().createElement(
                                        ...
                                        A().createElement(
                                            ...
                                            A().createElement(
                                                'div',
                                                { className: _u },
                                                A().createElement('div', { className: mu }, wu.resTitle()),
                                                A().createElement('div', { className: hu }, wu.resDescription()),
                                            ),
                                            A().createElement(
                                                'div',
                                                { className: _u },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [52], () => __webpack_require__(1624));
