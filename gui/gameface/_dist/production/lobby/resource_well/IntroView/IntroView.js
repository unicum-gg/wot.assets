(() => {
    var __webpack_modules__ = {
            ...
            718: (u, e, t) => {
                        ...
                        d(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = eu(u);
                                o.current = tu.addCallback(E, t, n, e === Eu.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== Eu.None)
                                return () => {
                                    tu.removeCallback(o.current, n);
                                };
                        }, [n, e]),
                        D
                    );
                ...
                function nu(u = ru.n.NONE, e = Au, t = !1, a = !1) {
                    (0, E.useEffect)(() => {
                        if (u !== ru.n.NONE)
                            return (
                    ...
                    Su = () => {
                        ...
                        return (
                            ...
                            a().createElement(
                                        ...
                                        a().createElement(
                                            ...
                                            a().createElement(
                                                ...
                                                a().createElement(j, {
                                                    ...
                                                    binding: {
                                                        topPlayers: a().createElement(K, {
                                                            format: 'integral',
                                                            value: A,
                                                        }),
                                                        basePlayers: a().createElement(K, {
                                                            format: 'integral',
                                                            value: r,
                                                        }),
                                                    },
                                ...
                                a().createElement(ou, { onClick: t, className: xu }),
                            )
                        );
                    };
