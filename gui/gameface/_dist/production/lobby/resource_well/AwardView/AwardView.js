(() => {
    var __webpack_modules__ = {
                ...
                const A = (u, e, t = {}, a = 0) => {
                    ...
                    F = (u) => {
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            x = (0, n.useMemo)(() => w || (0, a.F)().resId, [w]),
                            L = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (A(t, _, { isMouseEvent: !0, on: !0, arguments: E(r) }, x),
                                    v && v(),
            ...
            9121: (u, e, t) => {
                ...
                const T = {
                    ...
                    y = (u) => {
                        ...
                        const n = f(),
                            ...
                            E = n.mediaHeight,
                            A = n.mediaSize;
                        return r().createElement('div', L({ className: h()(t, T[i], M[E], S[A]) }, a), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                class G extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = h()(P.base, P[`base__${i}`], P[`base__${n}`], null == E ? void 0 : E.base),
                            c = h()(P.icon, P[`icon__${i}`], P[`icon__${n}`], null == E ? void 0 : E.icon),
                ...
                const z = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    ...
                    X = (u) => {
                        ...
                        if (a.length > 0) {
                            ...
                            return (
                                a.reduce((e, a) => {
                                    const r = z(q(t, `${e}.${a}`), window);
                                    return K(r) ? (u.push(r.id), `${e}.${a}.value`) : (u.push(a), `${e}.${a}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                    ...
                    pu = () => {
                        ...
                        return (
                            ...
                            r().createElement(
                                'div',
                                { className: Au },
                                r().createElement(iu.h, {
                                    title: i,
                                    subTitle: vu.commonTexts.eventTitle(),
                                    classNames: { base: Fu, subTitle: lu, title: Du },
                                }),
                                r().createElement(
                                    'div',
                                    { className: ou },
                                    ...
                                    r().createElement(
                                        ...
                                        t && r().createElement(ru.O, { personalNumber: t, className: Bu }),
                                    ),
                                ),
                                r().createElement(nu.$, { onConfirmClick: n, className: su }),
                                r().createElement(
                                    'div',
                                    { className: wu },
                                    r().createElement(G, {
                ...
                engine.whenReady.then(() => {
                    H().render(
                        r().createElement(k, null, r().createElement(pu, null)),
            ...
            9356: (u, e, t) => {
                ...
                const D = ({ vehicleInfo: u, theme: e, className: t }) => {
                    ...
                    return s().createElement(
                        'div',
                        { className: r()(o.base, o[`base__${e}`], t) },
                        E(a),
                        s().createElement(
                            'div',
            ...
            9149: (u, e, t) => {
                ...
                const A = {
                    ...
                    s = ({ className: u, personalNumber: e }) => {
                        const t = e.padStart(3, '0').length;
                        return E().createElement(
                            'div',
                            { className: r()(A.base, u) },
                            E().createElement(
                                'div',
                                { className: A.info },
                                E().createElement(
                            ...
                            E().createElement(
                                'div',
                                { className: A.content },
                                E().createElement('div', { className: r()(A.shadow, A.shadow__top) }),
                                E().createElement('div', { className: r()(A.shadow, A.shadow__bottom) }),
                                ...
                                E().createElement('div', { className: r()(A.reward, A[`reward__digits${t}`]) }),
                                E().createElement(
                                    n.u,
                                    { contentId: F.SerialNumberTooltip('resId') },
                                ...
                                E().createElement(
                                    'div',
                                    { className: r()(A.number, A[`number__digits${t}`]) },
                                    e
                                        .padStart(3, '0')
                                        .split('')
                                        .map((u, e) =>
            ...
            984: (u, e, t) => {
                ...
                const o = ({
                    ...
                    const h = (0, i.useRef)(null),
                        ...
                        H = (0, i.useCallback)(
                            (u) => {
                                s || (null !== D && (0, n.G)(D), d && d(u), t && M(), f(!0));
                            },
                            [s, D, d, M, t],
                        ),
                        I = (0, i.useCallback)(
                ...
                const l = {
                    ...
                    c = ({ vehicleInfo: u, personalNumber: e, classNames: t }) =>
                        i().createElement(
                            ...
                            { className: l.base },
                            i().createElement('div', {
                                className: r()(l.img, null == t ? void 0 : t.img, null == t ? void 0 : t.style),
                            }),
                            i().createElement(
                                'div',
                                { className: r()(l.title, null == t ? void 0 : t.title) },
                                e
                                    ? i().createElement(
                                          i().Fragment,
                                          null,
                                          i().createElement(F, {
                                              ...
                                              binding: {
                                                  vehicleInfo: i().createElement(o.e, {
                                                      vehicleInfo: u,
                                                      theme: o.b.Award,
                                                  }),
                                              },
                                    ...
                                    : i().createElement(o.e, { vehicleInfo: u, theme: o.b.Award }),
                            ),
                        );
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [52], () => __webpack_require__(9121));
