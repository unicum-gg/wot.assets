(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                (t.r(e),
                    t.d(e, { mouse: () => s, off: () => A, on: () => E, onResize: () => r, onScaleUpdated: () => i }));
                var n = t(2472),
                    a = t(1176);
            ...
            3649: (u, e, t) => {
                ...
                const E = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    s = (u, e, t = a.left) => u.split(e).reduce(t === a.left ? A : o, []),
                    F = (() => {
                        const u = new RegExp(
            ...
            9916: (u, e, t) => {
                ...
                function B(u, e, t, n, a, r, i) {
                    ...
                    E.done ? e(A) : Promise.resolve(A).then(n, a);
                }
            ...
            1503: (u, e, t) => {
                ...
                const T = {
                    ...
                    y = (u) => {
                        ...
                        const r = b(),
                            ...
                            E = r.mediaHeight,
                            A = r.mediaSize;
                        return a().createElement('div', L({ className: h()(t, T[i], S[E], M[A]) }, n), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                        ...
                        C(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = X(u);
                                D.current = Q.addCallback(n, t, A, e === J.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== J.None)
                                return () => {
                                    Q.removeCallback(D.current, A);
                                };
                        }, [A, e]),
                        F
                    );
                ...
                function nu(u = eu.n.NONE, e = tu, t = !1, a = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== eu.n.NONE)
                            return (
                ...
                const Au = {
                    ...
                    ou = R.strings.resource_well.awardView,
                    su = R.strings.resource_well.commonTexts,
                    Fu = () => {
                        const u = uu('model', J.None),
                            e = u.vehicleInfo,
                            t = u.personalNumber,
                            n = u.onShowVehicle,
                            r = u.onAboutClick,
                            i = u.onClose,
                            E = t ? ou.vehicleNumberedTitle() : ou.vehicleTitle(),
                            A = () => {
                                i();
                            };
                        var o;
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: Au.base },
                                a().createElement('div', { className: Au.animatedBg }),
                                a().createElement(
                                    'div',
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: Au.bg },
                                        a().createElement('div', { className: h()(Au.tank, t && Au.tank__style) }),
                                    ),
                                    a().createElement(iu.h, {
                                        title: E,
                                        subTitle: ou.end(),
                                        classNames: { base: Au.header, subTitle: Au.subTitle, title: Au.title },
                                    }),
                                    a().createElement(
                                        'div',
                                        { className: Au.content },
                                        a().createElement('div', { className: Au.contentShadow }),
                                        a().createElement(
                                            'div',
                                            { className: Au.wrapper },
                                            a().createElement(Eu.Q, {
                                                vehicleInfo: e,
                                                personalNumber: t,
                                                classNames: { title: Au.rewardTitle },
                                            }),
                                            t &&
                                                a().createElement(au.O, {
                                                    personalNumber: t,
                                                    className: Au.additionalReward,
                                                }),
                                        ),
                                    ),
                                    a().createElement(ru.$, { onConfirmClick: n, className: Au.footer }),
                                    a().createElement(
                                        'div',
                                        { className: Au.about },
                                        a().createElement(G, {
                                            caption: su.aboutButton(),
                                            type: 'info',
                                            onClick: () => {
                                                r();
                                            },
                ...
                engine.whenReady.then(() => {
                    H().render(
                        a().createElement(k, null, a().createElement(Fu, null)),
            ...
            9356: (u, e, t) => {
                ...
                const D = ({ vehicleInfo: u, theme: e, className: t }) => {
                    ...
                    return s().createElement(
                        ...
                        s().createElement(
                            'div',
                            { className: F.type, lang: R.strings.settings.LANGUAGE_CODE() },
                            s().createElement('div', {
                                className: F.ico,
                                style: (() => {
                                    const u = (0, A.BN)(i);
            ...
            5791: (u, e, t) => {
                ...
                const F = (u, e, t = {}, n = 0) => {
                        ...
                        const b = (0, E.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            L = (0, E.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (F(t, _, { isMouseEvent: !0, on: !0, arguments: s(n) }, x),
                                    v && v(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((b.current.timeoutId = window.setTimeout(L, c ? 100 : 400)),
                                                      a && a(u),
                                                      M && M(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                    ...
                    f = 'AdditionalReward_texture_4c',
                    b = R.views.lobby.resource_well.tooltips,
                    x = ({ className: u, personalNumber: e }) =>
                        A().createElement(
                            ...
                            A().createElement(
                                ...
                                A().createElement(
                                    l,
                                    { contentId: b.SerialNumberTooltip('resId') },
                            ...
                            A().createElement(
                                'div',
                                { className: d },
                                A().createElement('div', { className: a()(C, _) }),
                                A().createElement('div', { className: a()(C, m) }),
            ...
            984: (u, e, t) => {
                            ...
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    s ||
                                        (null !== D && (0, r.G)(D),
                                        d && d(u),
                                        t && (s || (h.current && (h.current.focus(), v(!0)))),
                                        b(!0));
                                },
                ...
                F.defaultProps = { type: o.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const l = F,
                    D = 'Footer_base_62',
                    c = 'Footer_button_d3',
            ...
            3074: (u, e, t) => {
                ...
                const E = { base: 'Header_base_f9' },
                    A = ({ classNames: u, title: e, subTitle: t }) =>
                        i().createElement(
                            'div',
                            { className: a()(E.base, null == u ? void 0 : u.base) },
                            i().createElement(
                                'div',
                                { className: a()(E.subTitle, null == u ? void 0 : u.subTitle) },
                                t,
                            ),
                            i().createElement('div', { className: a()(E.title, null == u ? void 0 : u.title) }, e),
                        );
            },
            6626: (u, e, t) => {
                'use strict';
                ...
                const F = {
                    ...
                    l = ({ vehicleInfo: u, personalNumber: e, classNames: t }) =>
                        E().createElement(
                            ...
                            { className: F.base },
                            E().createElement('div', {
                                className: a()(F.img, null == t ? void 0 : t.img, null == t ? void 0 : t.style),
                            }),
                            E().createElement(
                                'div',
                                { className: a()(F.title, null == t ? void 0 : t.title) },
                                e
                                    ? E().createElement(o, {
                                          classMix: F.formatText,
                                          text: R.strings.resource_well.awardView.vehicleNumberTitle(),
                                          binding: {
                                              vehicleInfo: E().createElement(s.e, { vehicleInfo: u, theme: s.b.Award }),
                                          },
                                      })
                                    : E().createElement(s.e, { vehicleInfo: u, theme: s.b.Award }),
                            ),
                        );
            },
            7363: (u) => {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [52], () => __webpack_require__(1503));
