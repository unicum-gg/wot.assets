(() => {
    ...
    var __webpack_modules__ = {
            ...
            4139: (u, e, t) => {
                ...
                const D = (u, e, t = {}, n = 0) => {
                    ...
                    d = (u) => {
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            y = (0, n.useMemo)(() => b || E().resId, [b]),
                            P = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (D(t, C, { isMouseEvent: !0, on: !0, arguments: l(r) }, y),
                                    v && v(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((f.current.timeoutId = window.setTimeout(P, d ? 100 : 400)),
                                                      a && a(u),
                                                      k && k(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const M = ({ size: u = k.Default }) =>
                        r().createElement('div', { className: s()(S.background, S[`background__${u}`]) }),
                    N = {
                ...
                const V = 'ProgressBarDeltaGrow_base_7e',
                    ...
                    q = (0, n.memo)(
                        ({
                            ...
                            const b = (0, n.useMemo)(() => Object.assign({ width: '100%' }, K(u), G(l)), [l, u]),
                                v = (0, n.useMemo)(() => Object.assign({ width: '0%' }, K(u), G(l)), [l, u]),
                                w = (0, n.useMemo)(() => Object.assign({ width: '0%' }, H(l, a), K(u)), [a, l, u]),
                                h = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(i - a)}%` }, H(l, a), K(u)),
                                    [a, l, i, u],
                                );
                            if (c) return null;
                            const f = s()(V, F, l && 0 === i && j);
                            return r().createElement(
                                'div',
                                { style: B ? w : h, className: f },
                                r().createElement(
                                    'div',
                                    { style: m ? v : b, className: W },
                ...
                const tu = (0, n.memo)((u) => {
                        ...
                        switch (a.animationSettings.type) {
                            case T.Simple:
                                return r().createElement(J, eu({}, a, { onEndAnimation: E, isComplete: i }));
                            case T.Growing:
                                return r().createElement(Y, eu({}, a, { onEndAnimation: E, isComplete: i }));
                            default:
                                return null;
                        }
                    }),
                    nu = ({ size: u, value: e, lineRef: t, disabled: a, onComplete: o }) => {
                        ...
                        return (
                            ...
                            r().createElement(x, { size: u, disabled: a, baseStyles: i, isComplete: s, lineRef: t })
                        );
                    },
                    ru = ['onEndAnimation'];
                function au() {
                ...
                const ou = (0, n.memo)((u) => {
                    ...
                    return (
                        (a.current.from = i),
                        r().createElement(tu, au({}, t, { onEndAnimation: o, key: `${i}-${t.to}`, from: i }))
                    );
                });
                function iu() {
                    return (
                ...
                const su = (0, n.memo)(
                        ({
                            ...
                            return o.withStack
                                ...
                                : r().createElement(tu, iu({ key: `${a}-${e}` }, A));
                        },
                    ),
                    Eu = (u) => ({
                        ...
                        ({
                            ...
                            const _ = ((u, e, t) =>
                                (0, n.useMemo)(() => {
                                    ...
                                    return { value: n, deltaFrom: Fu(n, e, t) };
                                }, [t, e, u]))(E, u, A);
                            return r().createElement(
                                'div',
                                { className: s()(S.base, S[`base__${t}`]), style: Eu(e) },
                                !i && r().createElement(M, { size: t }),
                                r().createElement(su, {
                                    size: t,
                                    lineRef: F,
                                    disabled: o,
                    ...
                    _u = 'Progress_base_95',
                    cu = 'Progress_percent_33',
                    Bu = 'Progress_value_3e',
                    Cu = 'Progress_value__pre_c4',
                    mu = 'Progress_value__crt_c6',
                    pu = ({ value: u, deltaFrom: e, className: t, hasAnimation: n }) =>
                        r().createElement(
                            'div',
                            { className: s()(_u, t) },
                            r().createElement(du, { size: k.Small, value: u, deltaFrom: e }),
                            r().createElement(
                                'div',
                                { className: cu },
                                n
                                    ? r().createElement(
                                          r().Fragment,
                                          null,
                                          r().createElement('div', { className: s()(Bu, mu) }, u, '%'),
                                          r().createElement('div', { className: s()(Bu, Cu) }, e, '%'),
                                      )
                    ...
                    bu = ({
                        ...
                        r().createElement(
                            'div',
                            { className: s()(gu.base, gu[`base__${u}`], o) },
                            r().createElement('div', { className: gu.hover }),
                            r().createElement('div', { className: gu.emblem }),
                            u === P.Active
                                ? r().createElement(pu, {
                                      value: e,
                                      deltaFrom: t,
                                ...
                                : r().createElement('div', { className: s()(gu.state, a && gu.state__show) }),
                        ),
                    vu = {
                        base: 'App_base_29',
                        flag: 'App_flag_a9',
                ...
                engine.whenReady.then(() => {
                    o().render(r().createElement(wu, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [52], () => __webpack_require__(4139));
