(() => {
    var __webpack_modules__ = {
                ...
                const F = ({
                    ...
                    return i().createElement(
                        ...
                        s.split('\n').map((e, F) =>
                            i().createElement(
                                'div',
                                { className: a()(A.Z.base, t), key: `${e}-${F}` },
            ...
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => s, off: () => A, on: () => i, onResize: () => r, onScaleUpdated: () => E });
                var n = t(2472),
                    a = t(1176);
            ...
            5360: (u, e, t) => {
                ...
                const D = (u = 'model', e = o.Deep) => {
                    const t = (0, A.useState)(0),
                        ...
                        c = D.resId,
                        C = (0, A.useMemo)(() => {
                            const e = (0, F.sI)(l.replace('.js', '.html'));
                        ...
                        (0, r.Z)(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = (0, i.U0)(u);
                                h.current = s.addCallback(n, t, c, e === o.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== o.None)
                                return () => {
                                    s.removeCallback(h.current, c);
                                };
                        }, [c, e]),
                        _
                    );
            ...
            3649: (u, e, t) => {
                ...
                const E = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    F = (u, e, t = a.left) => u.split(e).reduce(t === a.left ? i : A, []),
                    s = (() => {
                        const u = new RegExp(
                    ...
                    D = (u, e = a.left) => {
                        ...
                        return ((u, e = a.left) => {
                            ...
                            const n =
                                ...
                                r = E(u);
                            return F(r, /( )/, e).forEach((u) => (t = t.concat(F(u, n, a.left)))), t;
                        })(u, e);
                    },
            ...
            7332: (u, e, t) => {
                'use strict';
                t.d(e, { Gd: () => A, U0: () => F, kJ: () => E, os: () => r });
                var n = t(7902),
                    a = t(8071);
                const r = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    E = (u) => u && 'CoherentArrayProxy' === u.__proto__.constructor.name,
                    ...
                    F = (u) => {
                        ...
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, n) => {
                                    const E = (0, a.M)(i(t, `${e}.${n}`), window);
                                    return r(E) ? (u.push(E.id), `${e}.${n}.value`) : (u.push(n), `${e}.${n}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
            ...
            7462: (u, e, t) => {
                ...
                const _ = ({ children: u }) => {
                    const e = (0, n.useContext)(B),
                        ...
                        s = (0, n.useCallback)((u, e) => {
                            ...
                            A(Object.assign({ width: t, height: n }, F(t, n, i)));
                        }, []),
                        o = (0, n.useCallback)(() => {
                    ...
                    (0, d.Z)(() => {
                        E.O.client.events.on('clientResized', s), E.O.client.events.on('self.onScaleUpdated', o);
                    }),
                        (0, n.useEffect)(
                            () => () => {
                                E.O.client.events.off('clientResized', s),
                ...
                const S = {
                    ...
                    y = (u) => {
                        ...
                        const r = x(),
                            ...
                            i = r.mediaHeight,
                            A = r.mediaSize;
                        return a().createElement('div', L({ className: h()(t, S[E], T[i], M[A]) }, n), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                            ...
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    E ||
                                        (null !== F && N(F),
                                        D && D(u),
                                        t && (E || (C.current && (C.current.focus(), m(!0)))),
                                        w(!0));
                                },
                ...
                class q extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()(z.base, z[`base__${E}`], z[`base__${r}`], null == i ? void 0 : i.base),
                            B = h()(z.icon, z[`icon__${E}`], z[`icon__${r}`], null == i ? void 0 : i.icon),
                            c = h()(z.glow, null == i ? void 0 : i.glow),
                            C = h()(z.caption, z[`caption__${E}`], null == i ? void 0 : i.caption),
                            d = h()(z.goto, null == i ? void 0 : i.goto);
                        return a().createElement(
                            ...
                            'info' !== E && a().createElement('div', { className: z.shine }),
                ...
                function Q(u = Z.n.NONE, e = X, t = !1, a = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== Z.n.NONE)
                            return (
                        ...
                        function n(n) {
                            if (n.keyCode === u) {
                                if (!a && E.O.view.isEventHandled()) return;
                ...
                const uu = 'App_base_57',
                    ...
                    tu = 'App_close_20',
                    nu = 'App_imageWrapper_0c',
                    au = 'App_image_21',
                    ru = 'App_imageGlow_df',
                    Eu = 'App_title_87',
                    iu = 'App_divider_ee',
                    Au = 'App_description_ad',
                    Fu = 'App_buttonsWrapper_92',
                    su = 'App_button_a3',
                    ou = R.strings.resource_well.confirm.NoSerialVehicles,
                    Du = () => {
                        const u = (0, Y.tT)('model', Y.DA.None),
                            ...
                            r = u.cancel,
                            E = u.close,
                            i = (0, n.useCallback)(() => t(), [t]),
                            A = (0, n.useCallback)(() => r(), [r]),
                            F = (0, n.useCallback)(() => E(), [E]);
                        var s;
                        return (
                            (s = A),
                            Q(Z.n.ESCAPE, s),
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { className: Eu },
                                    a().createElement($.z, { text: ou.title(), binding: { vehicleName: e } }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: Au },
                                    a().createElement($.z, { text: ou.description(), binding: { vehicleName: e } }),
                                ),
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        V,
                                        { type: I.main, size: U.medium, onClick: i, mixClass: su },
                                        ou.buttonConfirm.title(),
                                    ),
                                    a().createElement(
                                        V,
                                        { type: I.primary, size: U.medium, onClick: A, mixClass: su },
                                        ou.buttonCancel.title(),
                                    ),
                                ),
                            )
                        );
                ...
                engine.whenReady.then(() => {
                    P().render(
                        a().createElement(k, null, a().createElement(Du, null)),
            ...
            8288: (u, e, t) => {
                ...
                const o = 'VehicleCount_base_05',
                    ...
                    w = () => {
                        const u = (0, E.tT)('model.vehicleCounter', E.DA.Shallow),
                            e = u.vehicleCount,
                            ...
                            f = { enter: h, exit: g },
                            x = {
                                counter: A().createElement(
                                    'div',
                                    { className: d },
                                    i && A().createElement('span', { className: m }),
                                    A().createElement('span', { className: c }, e),
                                ),
                                icon: A().createElement('span', { className: C }),
                            };
                        return A().createElement(
                            'div',
                            { className: o },
