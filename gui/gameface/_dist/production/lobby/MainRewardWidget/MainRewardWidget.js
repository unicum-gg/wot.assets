(() => {
    var __webpack_modules__ = {
            ...
            6798: (u, e, t) => {
                ...
                const F = s.O.client.getSize('rem'),
                    D = F.width,
                    _ = F.height,
                    m = Object.assign({ width: D, height: _ }, l(D, _, E)),
                    ...
                    B = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && l) return o(e, t, b);
                            if (t.largeWidth && F) return o(e, t, b);
                            if (t.mediumWidth && D) return o(e, t, b);
                ...
                const C = (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(c),
                        ...
                        o = (0, r.useCallback)((u, e) => {
                            ...
                            i(Object.assign({ width: t, height: r }, l(t, r, E)));
                        }, []);
                    ((u) => {
                    ...
                    return a().createElement(c.Provider, { value: A }, u);
                });
                var g = t(6483),
                    h = t.n(g),
                    p = t(926),
                ...
                const M = {
                    ...
                    O = (u) => {
                        ...
                        const n = w(),
                            ...
                            o = n.mediaHeight,
                            s = n.mediaSize;
                        return a().createElement('div', L({ className: h()(t, M[i], T[o], y[s]) }, r), e);
                    },
                    P = ['children'],
                    k = (u) => {
                        let e = u.children,
                                ...
                                const E = (0, r.useRef)([]),
                                    A = (u, t, r) => {
                                        ...
                                        const n = (function ({
                                            ...
                                            l = (({ observableModel: u }) => {
                                                const e = { root: u.object(), stages: u.array('stages') },
                                                    t = (0, G.computedFn)(
                                                        () => {
                                                            return (
                                                                (u = e.stages.get()),
                                                ...
                                                return Object.assign({}, e, { computes: { getStages: t } });
                                            })({
                                                mode: u,
                                                readByPath: o,
                                                externalModel: i,
                                    ...
                                    D = F[0],
                                    _ = F[1],
                                    m = (0, r.useState)(() => A(u, n, o)),
                                    c = m[0],
                                    d = m[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? d(A(D, n, o)) : (l.current = !0);
                                    }, [o, D, n]),
                                    (0, r.useEffect)(() => {
                                        _(u);
                                    }, [u]),
                ...
                const V = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Y = (u) => u.includes('_') && ((u) => V.includes(u))(u.split('_').at(-1)),
                ...
                const tu = {
                    ...
                    nu = Q((u) => {
                        let e = u.className,
                            ...
                            O = u.shrink,
                            P = u.flex,
                            k = void 0 === P ? (R || O ? `${R ? 1 : 0} ${O ? 1 : 0} auto` : void 0) : P,
                            H = u.style,
                            N = u.children,
                            I = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, n, s, A, F, _, H, k, L, B, y, x, S]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return a().createElement('div', eu({ className: h()(J.base, ...U, e), style: G }, I), N);
                    });
                let iu;
                function ou(u, e) {
                ...
                const su = (u, e, t) => {
                    ...
                    Au = (u, e, t = iu.left) => u.split(e).reduce(t === iu.left ? su : Eu, []),
                    lu = (() => {
                        const u = new RegExp(
                    ...
                    Du = ({ binding: u, text: e = '', classMix: t, alignment: n = iu.left }) =>
                        null === e
                ...
                const Cu = Object.keys(mu()),
                    ...
                    vu = Q((u) => {
                        ...
                        return a().createElement(
                            ...
                            Bu(
                                {
                                    className: h()(cu.base, t && cu[t], p, n),
                                    style: g,
                                    mt: !0 === E ? bu[t || 'paragraph-P16'].mt : E,
                                    mr: !0 === l ? bu[t || 'paragraph-P16'].mr : l,
                                    mb: !0 === D ? bu[t || 'paragraph-P16'].mb : D,
                                    ml: !0 === m ? bu[t || 'paragraph-P16'].ml : m,
                                },
                                B,
                            ),
                            void 0 !== d ? a().createElement(Du, Bu({}, d, { text: e })) : e,
                        );
                    }),
                    xu = {
                ...
                const Lu = ({ size: u = wu.Default, classMix: e }) =>
                        a().createElement('div', { className: h()(xu.background, xu[`background__${u}`], e) }),
                    Mu = {
                    ...
                    Ru = (0, r.memo)(
                        ({ size: u, lineRef: e, disabled: t, baseStyles: r, isComplete: n, withoutBounce: i }) => {
                            ...
                            return a().createElement(
                                ...
                                s && a().createElement(Tu, { size: u }),
                            );
                        },
                    ),
                    Ou = ({ size: u, value: e, lineRef: t, disabled: n, onComplete: i }) => {
                        ...
                        return (
                            ...
                            a().createElement(Ru, { size: u, disabled: n, baseStyles: o, isComplete: s, lineRef: t })
                        );
                    },
                    Pu = (u, e) => {
                        let t;
                ...
                const Nu = (0, r.memo)(
                    ...
                    $u = (0, r.memo)(
                        ({
                            ...
                            const p = (0, r.useMemo)(() => Object.assign({ width: '100%' }, Uu(u), Wu(l)), [l, u]),
                                b = (0, r.useMemo)(() => Object.assign({ width: '0%' }, Uu(u), Wu(l)), [l, u]),
                                f = (0, r.useMemo)(() => Object.assign({ width: '0%' }, Gu(l, n), Uu(u)), [n, l, u]),
                                v = (0, r.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - n)}%` }, Gu(l, n), Uu(u)),
                                    [n, l, o, u],
                                );
                            if (m) return null;
                            const x = h()(
                                ...
                                A,
                                l && 0 === o && 'ProgressBarDeltaGrow_base__withoutBounce_b5',
                            );
                            return a().createElement(
                                'div',
                ...
                const Ku = (0, r.memo)((u) => {
                        ...
                        switch (n.animationSettings.type) {
                            case Su.Simple:
                                return a().createElement(Iu, Xu({}, n, { onEndAnimation: E, isComplete: o }));
                            case Su.Growing:
                                return a().createElement(ju, Xu({}, n, { onEndAnimation: E, isComplete: o }));
                            default:
                                return null;
                        }
                    }),
                ...
                const qu = (0, r.memo)((u) => {
                    ...
                    return (
                        (n.current.from = o),
                        a().createElement(Ku, Yu({}, t, { onEndAnimation: i, key: `${o}-${t.to}`, from: o }))
                    );
                });
                function Zu() {
                    return (
                ...
                const Qu = (0, r.memo)(
                        ({
                            ...
                            return i.withStack
                                ? a().createElement(qu, A)
                                : a().createElement(Ku, Zu({ key: `${n}-${e}` }, A));
                        },
                    ),
                    Ju = (u) => ({
                    ...
                    ee = (u, e, t) => ('number' == typeof t ? (ue(0, e, t) / e) * 100 : u),
                    te = {
                    ...
                    ae = (0, r.memo)(
                        ({
                            ...
                            const m = ((u, e, t) =>
                                (0, r.useMemo)(() => {
                                    const r = (ue(0, e, u) / e) * 100;
                                    return { value: r, deltaFrom: ee(r, e, t) };
                                }, [t, e, u]))(E, u, A);
                            return a().createElement(
                                'div',
                                { className: h()(xu.base, xu[`base__${t}`]), style: Ju(e) },
                                !o && a().createElement(Lu, { size: t, classMix: s }),
                                a().createElement(Qu, {
                                    size: t,
                                    lineRef: l,
                                    disabled: i,
                ...
                const se = {
                    ...
                    Ae = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    le = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Fe = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                (s = s.replace(t, `%(${o})`)),
                                    (i[o] = se[u]
                                        ? a().createElement(
                                              'span',
                                              { className: se[u] },
                                              a().createElement(Du, { text: l, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: n(u) },
                        ...
                        return a().createElement(Du, { text: s, classMix: t, binding: i });
                    });
                class De extends a().PureComponent {
                    render() {
                        let u;
                        u = 'gold' === this.props.format ? oe.B3.GOLD : oe.B3.INTEGRAL;
                        const e = oe.Z5.getNumberFormat(this.props.value, u);
                        return void 0 !== this.props.value && void 0 !== e ? e : null;
                    }
                }
                De.defaultProps = { format: 'integral' };
                const _e = {
                        base__completed: 'Progress_base__completed_39',
                        title: 'Progress_title_57',
                        title__disabled: 'Progress_title__disabled_7c',
                        title__locked: 'Progress_title__locked_e8',
                        base_header: 'Progress_base_header_36',
                        base_header__locked: 'Progress_base_header__locked_e7',
                        base_progress: 'Progress_base_progress_db',
                        lock: 'Progress_lock_89',
                        check: 'Progress_check_0b',
                        progress_background: 'Progress_progress_background_55',
                        progress_bar: 'Progress_progress_bar_0e',
                        timer: 'Progress_timer_27',
                        timer_countdown: 'Progress_timer_countdown_25',
                        timer_icon: 'Progress_timer_icon_4b',
                        subtitle: 'Progress_subtitle_64',
                        subtitle__completed: 'Progress_subtitle__completed_67',
                        subtitle__disabled: 'Progress_subtitle__disabled_5f',
                        counter: 'Progress_counter_90',
                    },
                    me = R.strings.hb_lobby.mainRewardWidget,
                    ce = ({
                        text: u,
                        date: e,
                        currentLevel: t,
                        totalLevel: n,
                        currentLevelProgress: i,
                        totalLevelProgress: o,
                        mixClass: s,
                    }) => {
                        const E = (0, r.useState)(e),
                            ...
                            l = E[1],
                            F = w().mediaSize,
                            D = ![f.ExtraLarge, f.Large].includes(F);
                        (0, r.useEffect)(() => {
                            l(e);
                        }, [e]),
                            (0, r.useEffect)(() => {
                                const u = setTimeout(() => {
                                    A <= 0 && (l(0), clearTimeout(u)), l(A - 1);
                                }, 1e3);
                                return () => clearTimeout(u);
                            }, [A]);
                        const _ = (0, r.useMemo)(() => t === n && i === o, [t, n, i, o]);
                        return a().createElement(
                            'div',
                            { className: h()(_e.base, _ && _e.base__completed, s) },
                            a().createElement(
                                'div',
                                { className: h()(_e.base_header, Boolean(e) && _e.base_header__locked) },
                                Boolean(e) && a().createElement('div', { className: _e.lock }),
                                a().createElement(vu, {
                                    text: u,
                                    className: h()(
                                        _e.title,
                                        (Boolean(e) || _) && _e.title__disabled,
                                        Boolean(e) && _e.title__locked,
                                    ),
                                }),
                            ),
                            a().createElement(
                                'div',
                                { className: _e.base_progress },
                                e
                                    ? a().createElement(
                                          'div',
                                          { className: _e.timer },
                                          a().createElement(vu, {
                                              text: me.rewards.notAvailable(),
                                              className: h()(_e.subtitle, Boolean(e) && _e.subtitle__disabled),
                                          }),
                                          a().createElement('div', { className: _e.timer_icon }),
                                          a().createElement(vu, {
                                              text: ((u, e = !0) =>
                                                  u.days > 7 && e
                                                  ...
                                                  (function (u = 0) {
                                                      ...
                                                      return (
                                                          (e -= 60 * a), { days: t, hours: r, minutes: a, seconds: e }
                                                      );
                                                  })(A),
                                              ),
                                              className: _e.timer_countdown,
                                          }),
                                      )
                                    : a().createElement(
                                          a().Fragment,
                                          null,
                                          _ && a().createElement('div', { className: _e.check }),
                                          a().createElement(vu, {
                                              text: _ ? me.rewards.stageCompleted() : me.rewards.currentStage.title(),
                                              className: h()(_e.subtitle, _ && _e.subtitle__completed),
                                          }),
                                      ),
                                !e &&
                                    !_ &&
                                    a().createElement(Fe, {
                                        text: me.rewards.currentStage.value(),
                                        binding: {
                                            current_level: a().createElement(De, { value: t }),
                                            max_level: a().createElement(De, { value: n }),
                                        },
                                        classMix: _e.counter,
                                    }),
                            ),
                            !_ &&
                                ...
                                a().createElement(
                                    'div',
                                    { className: _e.progress_bar },
                                    a().createElement(ae, {
                                        size: D ? wu.Medium : wu.Default,
                                        progressBarBackgroundClassMix: _e.progress_background,
                                        disabled: Boolean(e),
                                        maxValue: n,
                                        value: t - 1,
                                    }),
                ...
                const ge = {
                        base: 'App_base_a9',
                        stages_text: 'App_stages_text_56',
                        check: 'App_check_38',
                        lighting: 'App_lighting_14',
                        lighting__hover: 'App_lighting__hover_03',
                        stages: 'App_stages_8b',
                        base__completed: 'App_base__completed_ba',
                        stages_item: 'App_stages_item_76',
                        base__offence: 'App_base__offence_7d',
                        base__defence: 'App_base__defence_8c',
                        text: 'App_text_9a',
                        title: 'App_title_68',
                        info: 'App_info_40',
                        info_text: 'App_info_text_1c',
                        info_icon: 'App_info_icon_b0',
                        icon: 'App_icon_5b',
                        base__x2scaled: 'App_base__x2scaled_65',
                    },
                    he = R.strings.hb_lobby.mainRewardWidget,
                    pe = { checkIcon: a().createElement('div', { className: ge.check }) },
                    be = (0, z.observer)(() => {
                        const u = j(),
                            e = u.model,
                            t = u.controls,
                            ...
                            A = (0, r.useMemo)(
                                () =>
                                    o.sort((u, e) =>
                                        u.frontType === Be.Defence ? -1 : e.frontType === Be.Defence ? 1 : 0,
                                    ),
                                [o],
                            ),
                            l = i.get().currentFrontType,
                            F = (0, r.useMemo)(
                                () =>
                                    o.every(
                                        (u) =>
                                            u.currentLevel === u.totalLevel &&
                                            u.currentLevelProgress === u.totalLevelProgress,
                                    ),
                                [o],
                            ),
                            D = h()(ge.base, ge[`base__${l}`], E && ge.base__x2scaled, F && ge.base__completed);
                        return a().createElement(
                            'div',
                            {
                                className: D,
                                ...
                                onMouseEnter: () => {
                                    var u;
                                    (u = Ce.HIGHLIGHT), engine.call('PlaySound', u);
                                },
                            },
                            a().createElement('div', { className: ge.icon }),
                            a().createElement('div', { className: ge.lighting }),
                            a().createElement('div', { className: h()(ge.lighting, ge.lighting__hover) }),
                            a().createElement(
                                'div',
                                { className: ge.text },
                                a().createElement(vu, { text: he.title(), className: ge.title }),
                                a().createElement(
                                    'div',
                                    { className: ge.info },
                                    a().createElement(vu, { text: he.rewardInfo(), className: ge.info_text }),
                                    a().createElement('div', { className: ge.info_icon }),
                                ),
                            ),
                            a().createElement(
                                'div',
                                ...
                                F
                                    ? a().createElement(vu, {
                                          text: he.stagesCompleted(),
                                          format: { binding: pe, classMix: ge.stages_text },
                                      })
                                    : A.map((u) =>
                                          a().createElement(ce, {
                                              key: u.frontType,
                                              text: he.rewards.$dyn(u.frontType).$dyn('title'),
                                              totalLevel: u.totalLevel,
                                              currentLevel: u.currentLevel,
                                              currentLevelProgress: u.currentLevelProgress,
                                              totalLevelProgress: u.totalLevelProgress,
                                              date: u.date,
                                              mixClass: ge.stages_item,
                                          }),
                                      ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    i().render(
                        a().createElement(k, null, a().createElement($, null, a().createElement(be, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(6798));
