(() => {
    ...
    var __webpack_modules__ = {
            ...
            251: (u, e, A) => {
                let F;
                A.d(e, { B0: () => F, B3: () => E, Gr: () => D, kH: () => B, lf: () => t }),
                    (function (u) {
            ...
            72: (u, e, A) => {
                ...
                const n = (u) => ({ __Type: 'GFBoundingBox', x: u.x, y: u.y, width: u.width, height: u.height }),
                    C = (function () {
                        var u,
                            e =
                                ((u = function* () {
                        ...
                        v(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    F = p(u);
                                o.current = f.addCallback(F, A, B, e === b.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== b.None)
                                return () => {
                                    f.removeCallback(o.current, B);
                                };
                        }, [B, e]),
                        r
                    );
                ...
                const S = E().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            E().createElement(
                                'div',
                                k({}, n, {
                                    className: T()(P.base, P[`base__theme-${B}`], D),
                                    ref: function (u) {
                                        (r.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                    },
                                }),
                                E().createElement('div', { className: P.decorator }, A),
                            )
                        );
                    }),
                    ...
                    L = 'AlertTooltip_base_28',
                    U = 'AlertTooltip_header_15',
                    I = 'AlertTooltip_description_76',
                    V = 'AlertTooltip_dangerIcon_af',
                    K = () => {
                        const u = g(),
                            e = u.header,
                            A = u.body;
                        return E().createElement(
                            ...
                            E().createElement(
                                'div',
                                { className: L },
                                E().createElement('div', { className: U }, e),
                                E().createElement(
                                    'div',
                                    { className: I },
                                    E().createElement('span', { className: V }),
                                    E().createElement('div', null, E().createElement(N, { text: A })),
                                ),
                            ),
                        );
                    };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [720], () => __webpack_require__(358));
