(() => {
    ...
    var __webpack_modules__ = {
            768: (u, e, A) => {
                ...
                var D = {};
                A.r(D), A.d(D, { getBgUrl: () => f, getTextureUrl: () => h });
                var t = {};
                function n(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const w = {
                    ...
                    m = { play: Object.assign({}, p, { sound: c }), setRTPC: l };
                function h(u, e, A = 1) {
                ...
                const v = (u = 1) => {
                    ...
                    b = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: E, modelPath: f(E, u || ''), resId: F };
                            })(),
                            A = e.modelPrefix,
                            F = u.split('.');
                        if (F.length > 0) {
                        ...
                        m(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    F = b(u);
                                a.current = y.addCallback(F, A, B, e === T.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== T.None)
                                return () => {
                                    y.removeCallback(a.current, B);
                                };
                        }, [B, e]),
                        i
                    );
                ...
                const I = E().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            E().createElement(
                                'div',
                                N({}, B, {
                                    className: x()(M.base, M[`base__theme-${n}`], D),
                                    ref: function (u) {
                    ...
                    U = ({ binding: u, text: e = '', classMix: A, alignment: D = B.left, formatWithBrackets: t }) => {
                        ...
                        return E().createElement(
                            ...
                            E().createElement(
                                ...
                                E().createElement(
                                    ...
                                    E().createElement('div', null, E().createElement(U, { text: A })),
                                ),
                            ),
                        );
                    };
