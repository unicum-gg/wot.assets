(() => {
    var __webpack_modules__ = {
            528: (e, t, u) => {
                ...
                var o = {};
                (u.r(o), u.d(o, { getBgUrl: () => y, getTextureUrl: () => w }));
                var a = {};
                function s(e) {
                    return (t) => (
                        engine.on(e, t),
                ...
                const h = {
                    ...
                    B = { play: Object.assign({}, C, { sound: f }), setRTPC: v };
                var D = u(308);
                function w(e, t, u = 1) {
                ...
                const ce = { view: a, client: r, sound: B, intl: b };
            },
            20: (e, t, u) => {
                'use strict';
                u.d(t, { n: () => n });
            ...
            55: (e, t, u) => {
                ...
                var r = {};
                (u.r(r), u.d(r, { Area: () => le, Bar: () => ae, Default: () => ie, useVerticalScrollApi: () => q }));
                u(799);
                var o = u(849),
                    a = u.n(o);
                let s = (function (e) {
                            ...
                            c().createElement(
                                'div',
                                {
                                    ...
                                    onMouseDown: function (e) {
                                        ...
                                        (null !== h && t && i(h),
                                            E && E(e),
                                            v && (u || (b.current && (b.current.focus(), B(!0)))),
                                            t && y(!0));
                                    },
                ...
                const w = {
                        ...
                        return (s = {}) => {
                            const i = s.settings,
                                ...
                                v = (0, B.useSpring)(() => ({
                                    ...
                                    onChange: (e) => {
                                        const t = d.current;
                                        t && (u(t, e), _.trigger('change', e), o && E.current && f());
                                    },
                                ...
                                M = ((e, t = []) => {
                                    ...
                                    () =>
                                        F(() => {
                                            const e = d.current;
                                            e &&
                                                (D(a(e, p.scrollPosition.goal), { immediate: !0 }),
                            ...
                            return (0, l.useMemo)(
                                ...
                                [p.scrollPosition, D, y, _.off, _.on, O, S, h, c.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    S = y({
                        ...
                        getDirection: (e) => (e.deltaY > 1 ? D.Next : D.Prev),
                        forceTriggerMouseMove: v.O.view.forceTriggerMouseMove,
                    }),
                    M = 'HorizontalBar_base_fa517',
                    O = 'HorizontalBar_base__active_ad89b',
                    P = 'HorizontalBar_leftButton_eb8c3',
                    k = 'HorizontalBar_rightButton_f5116',
                    x = 'HorizontalBar_track_fd3af',
                    T = 'HorizontalBar_thumb_bb7e0',
                    L = 'HorizontalBar_rail_a3d9e',
                    N = 'disable',
                    ...
                    V = (0, l.memo)(({ api: e, classNames: t = {}, getStepByRailClick: u = z, onDrag: n = H }) => {
                        const r = (0, l.useRef)(null),
                            ...
                            C = () => {
                                ...
                                const a = e.animationScroll.scrollPosition.get(),
                                    i = Math.min(1, n / r),
                                    l = f(0, 1, a / (r - n)),
                                    c = (t.offsetWidth - W(t, i)) * l;
                                ((u.style.transform = `translateX(${0 | c}px)`),
                                    ((e) => {
                                        if (o.current && s.current && d.current && m.current) {
                                            if (0 === e)
                                                return (o.current.classList.add(N), void s.current.classList.remove(N));
                                            if (
                                                ((t = d.current),
                                                (u = m.current),
                                                e - (t.offsetWidth - u.offsetWidth) >= -0.5)
                                            )
                                                return (o.current.classList.remove(N), void s.current.classList.add(N));
                                            var t, u;
                                            (o.current.classList.remove(N), s.current.classList.remove(N));
                                        }
                                    })(c));
                            },
                            B = g(() => {
                        ...
                        ((0, l.useEffect)(() => F(B)),
                            ...
                            }, [e, p.offset, p.pending, n, A]));
                        const w = h((t) => e.applyStepTo(t), E, [e]),
                            y = w[0],
                            S = w[1];
                        (0, l.useEffect)(
                            () => (
                        ...
                        return c().createElement(
                            'div',
                            { className: a()(M, t.base), ref: r, onWheel: e.handleMouseWheel },
                            c().createElement('div', {
                                className: a()(P, t.leftButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(N) || 0 !== e.button || (i('play'), y(D.Next));
                                },
                                onMouseUp: S,
                                ref: o,
                                onMouseEnter: R,
                            ...
                            c().createElement(
                                'div',
                                {
                                    className: a()(x, t.track),
                                    onMouseDown: (t) => {
                                        const n = m.current;
                                        if (n && 0 === t.button)
                                            if ((i('play'), t.target === n))
                                                ...
                                                })(t.screenX > n.getBoundingClientRect().x ? D.Prev : D.Next);
                                            }
                                    },
                                    ref: d,
                                    onMouseEnter: R,
                                },
                                c().createElement('div', { ref: m, className: a()(T, t.thumb) }),
                                c().createElement('div', { className: a()(L, t.rail) }),
                            ),
                            c().createElement('div', {
                                className: a()(k, t.rightButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(N) || 0 !== e.button || (i('play'), y(D.Prev));
                                },
                                onMouseUp: S,
                                ref: s,
                                onMouseEnter: R,
                    ...
                    U = ({
                        ...
                        const m = (0, l.useMemo)(() => {
                            ...
                            E = (0, l.useMemo)(() => Object.assign({}, t, { handleMouseWheel: () => {} }), [t]);
                        return c().createElement(
                            'div',
                            ...
                            c().createElement(
                                ...
                                c().createElement(G, { className: s, api: E, classNames: o }, e),
                            ),
                ...
                const q = y({
                    ...
                    Y = 'VerticalBar_base_b5610',
                    K = 'VerticalBar_base__active_be260',
                    $ = 'VerticalBar_topButton_c2227',
                    X = 'VerticalBar_bottomButton_ef09b',
                    Z = 'VerticalBar_track_e3345',
                    Q = 'VerticalBar_thumb_a34e7',
                    J = 'VerticalBar_rail_ff232',
                    ee = 'disable',
                    te = () => {},
                    ...
                    ae = (0, l.memo)(({ api: e, classNames: t = {}, getStepByRailClick: u = ne, onDrag: n = te }) => {
                        const r = (0, l.useRef)(null),
                            o = (0, l.useRef)(null),
                            s = (0, l.useRef)(null),
                            d = (0, l.useRef)(null),
                            ...
                            C = g(() => {
                                ...
                                return (
                                    ...
                                    (t.style.display = 'flex'),
                                    r.current && (1 !== a ? r.current.classList.add(K) : r.current.classList.remove(K)),
                                    a
                                );
                            }),
                            B = g(() => {
                                        ...
                                        if (o.current && s.current && d.current && m.current) {
                                            if (0 === Math.round(e))
                                                return (
                                                    ...
                                                    void s.current.classList.remove(ee)
                                                );
                                            if (
                                                ((t = d.current),
                                                (u = m.current),
                                                ...
                                                return (
                                                    ...
                                                    void s.current.classList.add(ee)
                                                );
                                            var t, u;
                                            (o.current.classList.remove(ee), s.current.classList.remove(ee));
                                        }
                                    })(c));
                            }),
                            w = g(() => {
                        ...
                        const y = h((t) => e.applyStepTo(t), E, [e]),
                            S = y[0],
                            M = y[1];
                        (0, l.useEffect)(
                            () => (
                        ...
                        return c().createElement(
                            'div',
                            { className: a()(Y, t.base), ref: r, onWheel: e.handleMouseWheel },
                            c().createElement('div', {
                                className: a()($, t.topButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(ee) || 0 !== e.button || (i('play'), S(D.Next));
                                },
                                ref: o,
                                onMouseEnter: O,
                            }),
                                    ...
                                    onMouseDown: (t) => {
                                        ...
                                        if (n && 0 === t.button)
                                            if ((i('play'), t.target === n))
                                                ...
                                                })(t.screenY > n.getBoundingClientRect().y ? D.Prev : D.Next);
                                            }
                                    },
                                    ref: d,
                                    onMouseEnter: O,
                                },
                                c().createElement('div', { ref: m, className: a()(Q, t.thumb) }),
                                c().createElement('div', { className: a()(J, t.rail) }),
                            ),
                            c().createElement('div', {
                                className: a()(X, t.bottomButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(ee) || 0 !== e.button || (i('play'), S(D.Prev));
                                },
                                onMouseUp: M,
                                ref: s,
                                onMouseEnter: O,
                    ...
                    ie = ({
                        ...
                        return c().createElement(
                            ...
                            c().createElement(
                                ...
                                c().createElement(le, { className: o, classNames: s, api: E }, e),
                            ),
                            c().createElement(ae, { getStepByRailClick: i, api: t, onDrag: d, classNames: m }),
                        );
                    },
                    le = ({ className: e, classNames: t, children: u, api: n }) => (
                        (0, l.useEffect)(() => F(n.recalculateContent)),
                        c().createElement(
                            'div',
                ...
                const _e = (e, t, u = {}, n = 0) => {
                    ...
                    Fe = (e) => {
                        ...
                        const A = (0, l.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            C = (0, l.useMemo)(
                                () =>
                                    p ||
                                    ((e = 1) => {
                            ...
                            B = (0, l.useCallback)(() => {
                                (A.current.isVisible && A.current.timeoutId) ||
                                    (_e(u, _, { isMouseEvent: !0, on: !0, arguments: Ee(n) }, C),
                                    g && g(),
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onMouseLeave: ((e) => (t) => {
                                              (D(), null == o || o(t), null == e || e(t));
                                          })(t.props.onMouseLeave),
                                          onClick: ((e) => (t) => {
                                              (!1 === m && D(), null == s || s(t), null == e || e(t));
                                          })(t.props.onClick),
                                          onMouseDown: ((e) => (t) => {
                                              (!1 === m && D(), null == a || a(t), null == e || e(t));
                                          })(t.props.onMouseDown),
                                      },
                                      b,
                                  ),
                ...
                const Se = (e) => `#${e}`,
                    Me = 'Chat_base_aafeb',
                    Oe = 'Chat_content_a18f1',
                    Pe = 'Chat_channelNotification_ee35c',
                    Re = 'Chat_scrollContainer_b2253',
                    ke = 'Chat_messages_d9b13',
                    xe = 'Chat_messages__selectable_c882c',
                    Te = 'Chat_footer_e3e38',
                    Le = 'Chat_input_ce7df',
                    Ne = 'Chat_sendButtonContainer_e3491',
                    Ie = 'Chat_enterButtonContainer_f6c21',
                    ze = 'Chat_enterImage_ac2a8',
                    He = 'MessageText_emoji_ec54b';
                function We(e, t) {
                    var u = ('undefined' != typeof Symbol && e[Symbol.iterator]) || e['@@iterator'];
                    if (u) return (u = u.call(e)).next.bind(u);
                    if (
                ...
                var je = (function (e) {
                    return ((e[(e.text = 0)] = 'text'), (e[(e.element = 1)] = 'element'), e);
                })(je || {});
                const Ue = [
                        [':)', 'smiley_happy'],
                        ['=)', 'smiley_happy'],
                    ...
                    Ge = (e) => R.images.gui.maps.icons.emoji.$dyn(e),
                    qe = (e, [t, u]) =>
                        e.split(new RegExp(t.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, '\\$&'), 'g')).reduce((e, t, n, r) => {
                            var o;
                            return (
                                e.push({ type: je.text, content: t }),
                                r.length !== n + 1 &&
                                    e.push({
                                        type: je.element,
                                        content: c().createElement('div', {
                                            style: ((o = Ge(u)), { backgroundImage: `url('${o}')` }),
                                            className: He,
                                        }),
                                    }),
                                e
                    ...
                    Ye = (e, t, u) => (u % 2 ? (e[e.length - 1] += t) : e.push(t), e),
                    Ke = (e, t) => {
                        const u = [];
                        return (
                            e.forEach((e) =>
                                e.type === je.element
                                    ...
                                    : u.push(
                                          ...((e, t) => {
                                              ...
                                              return e
                                                  .split(
                                                      /([\0-@\[-`\{-\xA9\xAB-\xB4\xB6-\xB9\xBB-\xBF\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u036F\u0375\u0378\u0379\u037E\u0380-\u0385\u0387\u038B\u038D\u03A2\u03F6\u0482-\u0489\u0530\u0557\u0558\u055A-\u055F\u0589-\u05CF\u05EB-\u05EE\u05F3-\u061F\u064B-\u066D\u0670\u06D4\u06D6-\u06E4\u06E7-\u06ED\u06F0-\u06F9\u06FD\u06FE\u0700-\u070F\u0711\u0730-\u074C\u07A6-\u07B0\u07B2-\u07C9\u07EB-\u07F3\u07F6-\u07F9\u07FB-\u07FF\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\
7CC}-\u{1DEFF}\u{1DF1F}-\u{1DF24}\u{1DF2B}-\u{1E02F}\u{1E06E}-\u{1E0FF}\u{1E12D}-\u{1E136}\u{1E13E}-\u{1E14D}\u{1E14F}-\u{1E28F}\u{1E2AE}-\u{1E2BF}\u{1E2EC}-\u{1E4CF}\u{1E4EC}-\u{1E5CF}\u{1E5EE}\u{1E5EF}\u{1E5F1}-\u{1E6BF}\u{1E6DF}\u{1E6E3}\u{1E6E6}\u{1E6EE}\u{1E6EF}\u{1E6F5}-\u{1E6FD}\u{1E700}-\u{1E7DF}\u{1E7E7}\u{1E7EC}\u{1E7EF}\u{1E7FF}\u{1E8C5}-\u{1E8FF}\u{1E944}-\u{1E94A}\u{1E94C}-\u{1EDFF}\u{1EE04}\u{1EE20}\u{1EE23}\u{1EE25}\u{1EE26}\u{1EE28}\u{1EE33}\u{1EE38}\u{1EE3A}\u{1EE3C}-\u{1EE41}\u{1EE43}-\u{1EE46}\u{1EE48}\u{1EE4A}\u{1EE4C}\u{1EE50}\u{1EE53}\u{1EE55}\u{1EE56}\u{1EE58}\u{1EE5A}\u{1EE5C}\u{1EE5E}\u{1EE60}\u{1EE63}\u{1EE65}\u{1EE66}\u{1EE6B}\u{1EE73}\u{1EE78}\u{1EE7D}\u{1EE7F}\u{1EE8A}\u{1EE9C}-\u{1EEA0}\u{1EEA4}\u{1EEAA}\u{1EEBC}-\u{1FFFF}\u{2A6E0}-\u{2A6FF}\u{2B81E}\u{2B81F}\u{2CEAE}\u{2CEAF}\u{2EBE1}-\u{2EBEF}\u{2EE5E}-\u{2F7FF}\u{2FA1E}-\u{2FFFF}\u{3134B}-\u{3134F}\u{3347A}-\u{10FFFF}])/gu,
                                                  )
                                                  .reduce(Ye, [])
                                                  .map((e, t) => c().createElement('div', { style: u, key: t }, e));
                                          })(e.content, t),
                                      ),
                            ),
                            u
                    ...
                    $e = ({ text: e, color: t }) => {
                        const u = (0, l.useMemo)(
                            ...
                            n = (0, l.useMemo)(() => Ke(u, t), [t, u]);
                        return c().createElement(
                            c().Fragment,
                            null,
                            n.map((e, t) => c().createElement(l.Fragment, { key: t }, e)),
                        );
                    },
                    Xe = ({ part: e }) => {
                        const t = (0, l.useMemo)(() => ({ color: Se(e.color) }), [e]);
                        return c().createElement('div', { style: t }, e.text);
                    },
                    Ze = 'Message_base_e6460',
                    Qe = ({ playerName: e, timeStamp: t, text: u }) => {
                        const n = (0, l.useMemo)(() => Se(u.color), [u.color]);
                        return c().createElement(
                            'div',
                            { className: Ze },
                            c().createElement(Xe, { part: e }),
                            ' ',
                            c().createElement(Xe, { part: t }),
                            c().createElement($e, { text: u.text, color: n }),
                            '\n',
                        );
                    };
                function Je() {
                ...
                const et = ((e, t) => {
                        const u = (0, l.createContext)({});
                        return [
                            function ({ mode: n = 'real', options: r, children: o, mocks: a }) {
                                const s = (0, l.useRef)([]),
                                    i = (u, n, r) => {
                                        var o;
                                        const a = (function ({
                                                ...
                                                return {
                                                    subscribe: (u, o) => {
                                                        const s = 'string' == typeof o ? `${n}.${o}` : n,
                                                            i = v.O.view.addModelObserver(s, t, !0);
                                                        return (r.set(i, u), e && u(a(o)), i);
                                                    },
                                                    readByPath: a,
                                                    createCallback: (e, t) => {
                                                        const u = a(t);
                                            ...
                                            m = { mode: u, model: d, externalModel: i, cleanup: c };
                                        return {
                                            model: d,
                                    ...
                                    E = m[0],
                                    _ = m[1],
                                    F = (0, l.useState)(() => i(n, r, a)),
                                    f = F[0],
                                    p = F[1];
                                return (
                                    (0, l.useEffect)(() => {
                                        d.current ? p(i(E, r, a)) : (d.current = !0);
                                    }, [a, E, r]),
                                    (0, l.useEffect)(() => {
                                        _(n);
                                    }, [n]),
                                    ...
                                    c().createElement(u.Provider, { value: f }, o)
                                );
                            },
                            () => (0, l.useContext)(u),
                        ];
                        ...
                        (e) =>
                            Object.assign({}, e.observableModel.primitives(['canClearInput']), {
                                messages: e.observableModel.array('messages'),
                                headerExtraInfo: e.observableModel.object('headerExtraInfo'),
                            }),
                        (e) => ({
                            send: e.externalModel.createCallback((e) => ({ message: e }), 'onSend'),
                            clear: e.externalModel.createCallbackNoArgs('onInputCleared'),
                        }),
                    ),
                    tt = et[0],
                    ut = et[1],
                    nt = (0, De.Pi)(function () {
                        const e = ut(),
                            ...
                            u = t.send,
                            n = t.clear,
                            r = e.model.messages.get(),
                            o = e.model.headerExtraInfo.get(),
                            a = e.model.canClearInput.get(),
                            s = (0, l.useRef)(null),
                            i = (0, l.useRef)(null),
                            d = q(),
                            f = (0, l.useRef)(null),
                            ...
                            h = (0, l.useCallback)(() => {
                                ...
                                const e = i.current.scrollHeight,
                                    t = s.current.scrollHeight - e;
                                d.applyScroll(t);
                            }, [d]);
                        (0, l.useEffect)(() => F(() => F(h)), [r.length, h]);
                        const b = (0, l.useCallback)(() => {
                            f.current && '' !== f.current.value && a && ((f.current.value = ''), n(), g(''));
                        }, [a, n]);
                        (0, l.useEffect)(() => b(), [a, b]);
                                  ...
                                  c().createElement(
                                      ce.Vertical.Area.Default,
                                      {
                                          onDrag: function (e) {
                                              var t;
                                              'dragStart' === e.type &&
                                                  (null == (t = s.current) || t.classList.remove(xe));
                                          },
                                          api: d,
                                      },
                                      c().createElement(
                                          'div',
                                          {
                                              ...
                                              onMouseDown: function () {
                                                  var e;
                                                  null == (e = s.current) || e.classList.add(xe);
                                              },
                                          },
                                          r.map((e) => c().createElement(Qe, Je({}, e.value, { key: e.value.key }))),
                                      ),
                                  ),
                              )
                            : c().createElement(
                                  ...
                                  c().createElement(
                                      'div',
                                      { className: Pe },
                                      c().createElement($e, { text: o.text, color: Se(o.color) }),
                                  ),
                              );
                        return c().createElement(
                            'div',
                            { className: Me },
                            c().createElement('div', { className: Oe }, D),
                            c().createElement(
                                'div',
                                { className: Te },
                                ...
                                c().createElement(
                                    ...
                                    c().createElement(
                                        ...
                                        c().createElement(
                                            _,
                                            { size: E.small, type: m.secondary, onClick: A, mixClass: Ie },
                ...
                engine.whenReady.then(() => {
                    ye().render(
                        c().createElement(
                            tt,
                            { options: { rootId: R.views.lobby.platoon.subViews.Chat('resId') } },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [720], () => __webpack_require__(55));
