    ...
    var __webpack_modules__ = {
            ...
            72: (e, t, n) => {
                ...
                const c = (e) => ({ __Type: 'GFBoundingBox', x: e.x, y: e.y, width: e.width, height: e.height }),
                    ...
                    p = () => viewEnv.isWindowShownByViewEvent(i.B0.TOOLTIP),
            ...
            204: (e, t, n) => {
                            ...
                            d(() => {
                                if (
                                    ...
                                    const n = (e) => {
                                        ...
                                        o = h(e);
                                    E.current = p.addCallback(o, n, s, t === b.Deep);
                                }
                            }),
                            (0, o.useEffect)(() => {
                                if (t !== b.None)
                ...
                const P = {
                    ...
                    S = ({
                        ...
                        const p = (0, o.useRef)(null),
                            ...
                            S = C[1],
                            L = (0, o.useCallback)(() => {
                                a || (p.current && (p.current.focus(), E(!0)));
                            }, [a]),
                            N = (0, o.useCallback)(
                                (e) => {
                ...
                S.defaultProps = { type: k.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const L = (0, o.memo)(S),
                ...
                (0, o.memo)(({ id: e, fallback: t, onLoadCallback: n, mixClass: i }) => {
                    const a = (0, o.useState)(''),
                        ...
                        h = (0, o.useCallback)(
                            (e) => {
                                e.includes(d) &&
                                    (w(!0), engine.off(K, h), window.subViews.removeChildChangedCallback(d));
                            },
                            [d],
                        ),
                        p = (0, o.useCallback)((e) => {
                ...
                const ve = (e) => {
                    ...
                    he = 'SettingsButton_settingsButton_03',
                    pe = ['isPressed', 'hasPopover', 'onClick'];
                function be() {
                    return (
                        (be =
                            Object.assign ||
