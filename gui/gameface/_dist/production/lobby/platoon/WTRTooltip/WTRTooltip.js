(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var a = {};
                t.r(a), t.d(a, { getBgUrl: () => d, getTextureUrl: () => l });
                var A = {};
                function o(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const F = o('clientResized'),
                    i = { down: o('mousedown'), up: o('mouseup'), move: o('mousemove') };
                const s = (function () {
            ...
            251: (u, e, t) => {
                let n;
                t.d(e, { B0: () => n, B3: () => r, Gr: () => a, kH: () => o, lf: () => A }),
                    (function (u) {
            ...
            72: (u, e, t) => {
                ...
                const E = (u) => ({ __Type: 'GFBoundingBox', x: u.x, y: u.y, width: u.width, height: u.height }),
                    ...
                    D = (u) => s(a.B0.MOVE, { isMouseEvent: !0, on: u }),
                    c = () => s(a.B0.CLOSE),
                    B = () => s(a.B0.POP_OVER, { on: !1 }),
                    l = (u, e, t = 0) => {
                        s(a.B0.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                    },
                    d = (u, e, t, n, A = R.invalid('resId'), o) => {
                        const F = r.O.view.getViewGlobalPosition(),
                            ...
                            l = i.height,
                            d = {
                                x: r.O.view.pxToRem(D) + F.x,
                                y: r.O.view.pxToRem(c) + F.y,
                                width: r.O.view.pxToRem(B),
                                height: r.O.view.pxToRem(l),
                            };
                        s(a.B0.POP_OVER, {
                            isMouseEvent: !0,
                            contentID: u,
                    ...
                    C = () => viewEnv.isWindowShownByViewEvent(a.B0.CONTEXT_MENU),
            ...
            164: (u, e, t) => {
                        ...
                        c(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = _(u);
                                v.current = C.addCallback(n, t, o, e === m.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== m.None)
                ...
                const y = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            h({}, E, {
                                className: p()(f.base, f[`base__theme-${o}`], a),
                                ref: function (u) {
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            g = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (M(t, l, { isMouseEvent: !0, on: !0, arguments: k(r) }, f),
                                    v && v(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((b.current.timeoutId = window.setTimeout(g, i ? 100 : 400)),
                                                      a && a(u),
                                                      T && T(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const S = R.views.common.tooltip_window.simple_tooltip_content,
                    I = (u) => {
                        ...
                        const i = (0, n.useMemo)(() => {
                            const u = Object.assign({}, E, { body: t, header: a, note: A, alert: o });
                    ...
                    U = ({ content: u, classMix: e }) => {
                        ...
                        return (
                            ...
                            r().createElement(
                                I,
                                { isEnabled: A, body: u },
                                r().createElement('div', { ref: t, className: p()(L, e) }, u),
                            )
                        );
                    },
                    V = {
                    ...
                    W = { [T.default]: 'c_24x24', [T.x48]: 'c_48x48', [T.x80]: 'c_80x80', [T.x220]: 'c_220x220' },
                    H = ({ badgeID: u, size: e = T.default, className: t }) => {
                        const n = R.images.gui.maps.icons.library.badges.$dyn(W[e]);
                        return r().createElement('div', {
                            className: p()(V.base, V[`base__${e}`], t),
                ...
                const $ = { [T.default]: 'c_64x24', [T.x48]: 'c_68x28' },
                    q = { [T.default]: 'c_48x48', [T.x48]: 'c_48x48' },
                    G = ({
                        userName: u,
                        clanAbbrev: e = '',
                        igrType: t = 0,
                        ...
                        const B = R.images.gui.maps.icons.library.badges.strips.$dyn($[s]),
                            l = (0, n.useMemo)(
                                () => ({ backgroundImage: `url(${B.$dyn(`strip_${A.badgeID}`)})` }),
                                [A, B],
                            ),
                            d = R.images.gui.maps.icons.library.badges.$dyn(q[s]),
                            _ = (0, n.useMemo)(
                                () => ({ backgroundImage: `url(${d.$dyn(`badge_${A.badgeID}`)})` }),
                                [A, d],
                            ),
                            C = e ? `[${e}]` : '',
                            m = p()(j.base, j[`base__${s}`], o && j.base__inverted),
                            v = p()(j.userName, D),
                            w = p()(j.clanTag, c),
                            b = u !== i,
                            f = E ? `${i}${C}` : i,
                            ...
                            y = [
                                ...
                                [
                                    ...
                                    !E && Boolean(C) && r().createElement('div', { className: w, key: 'clanTag' }, C),
                                ],
                                0 !== t && r().createElement('div', { className: j.igrIcon, key: 'igrType' }),
                                Boolean(A.badgeID) &&
                                    r().createElement(
                                        'div',
                                        { className: j.suffixBadgeWrapper, key: 'suffixBadge' },
                    ...
                    Y = 'WTRInfo_wtr_5e',
                    Z = 'WTRInfo_wtrIcon_a9',
                    X = 'WTRInfo_wtrValue_80',
                    Q = ({ rating: u }) =>
                        r().createElement(
                            'div',
                            { className: Y },
                    ...
                    J = 'WTRTooltip_base_89',
                    uu = 'WTRTooltip_header_7c',
                    eu = 'WTRTooltip_iconGap_7c',
                    tu = 'WTRTooltip_clanTagGap_a0',
                    nu = 'WTRTooltip_description_83',
                    ru = () => {
                        const u = v(),
                            e = u.name,
                            t = u.rating,
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(G, {
                                        ...
                                        suffixBadge: E,
                                        clanAbbrev: a,
                                        userNameClassName: A && eu,
                                        clanTagClassName: tu,
                                    }),
                                ),
                                r().createElement('div', { className: nu }, r().createElement(Q, { rating: t })),
                            ),
                        );
                    };
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (E = 0; E < deferred.length; E++) {
                    for (var [e, t, n] = deferred[E], a = !0, A = 0; A < e.length; A++)
                        (!1 & n || r >= n) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [720], () => __webpack_require__(164));
