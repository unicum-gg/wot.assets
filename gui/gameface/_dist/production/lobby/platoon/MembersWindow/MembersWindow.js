(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var o = {};
                (t.r(o), t.d(o, { getBgUrl: () => m, getTextureUrl: () => D }));
                var r = {};
                function s(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            251: (u, e, t) => {
                let n;
                (t.d(e, { B0: () => n, B3: () => a, Gr: () => o, kH: () => s, lf: () => r }),
                    (function (u) {
            ...
            72: (u, e, t) => {
                ...
                const i = (u) => ({ __Type: 'GFBoundingBox', x: u.x, y: u.y, width: u.width, height: u.height }),
                    ...
                    _ = () => viewEnv.isWindowShownByViewEvent(o.B0.TOOLTIP),
            ...
            998: (u, e, t) => {
                ...
                const E = s().createContext(null),
                    c = (u) => {
                        ...
                        return s().createElement(E.Provider, { value: t }, e);
                    };
                function A(u) {
                        ...
                        s().createElement(
                            ...
                            n !== D.ghost &&
                                s().createElement(
                                    s().Fragment,
                                    null,
                                    s().createElement('div', { className: d.back }),
                                    s().createElement('span', { className: d.texture }),
                                ),
                            s().createElement(
                                'span',
                                { className: V },
                                s().createElement('span', { className: d.stateDisabled }),
                                s().createElement('span', { className: d.stateHighlightHover }),
                                s().createElement('span', { className: d.stateHighlightActive }),
                            ),
                            s().createElement(
                                'span',
                ...
                const b = ({ onClick: u, type: e }) => {
                        ...
                        return s().createElement('div', { className: o, onClick: u, onMouseEnter: t, onMouseDown: n });
                    },
                    v = (u = 1) => {
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onMouseLeave: ((u) => (e) => {
                                              (k(), null == o || o(e), null == u || u(e));
                                          })(e.props.onMouseLeave),
                                          onClick: ((u) => (e) => {
                                              (!1 === A && k(), null == i || i(e), null == u || u(e));
                                          })(e.props.onClick),
                                          onMouseDown: ((u) => (e) => {
                                              (!1 === A && k(), null == s || s(e), null == u || u(e));
                                          })(e.props.onMouseDown),
                                      },
                                      b,
                                  ),
                ...
                const T = R.views.common.tooltip_window.simple_tooltip_content,
                    M = (u) => {
                        ...
                        const E = (0, r.useMemo)(() => {
                            const u = Object.assign({}, i, { body: t, header: n, note: a, alert: o });
                    ...
                    S = ({ title: u, infoTooltipHeader: e, infoTooltipBody: t }) =>
                        s().createElement(
                            ...
                            { className: P },
                            u,
                            e && t && s().createElement(x, { tooltipHeader: e, tooltipBody: t }),
                        ),
                    I = 'Header_base_ff',
                    ...
                    U = ({
                        ...
                        return s().createElement(
                            ...
                            s().createElement(S, { title: u, infoTooltipBody: E, infoTooltipHeader: l }),
                            i &&
                                s().createElement(
                                    B,
                                    {
                                        mixClass: $,
                                        onClick: (u) => {
                                            (F.playClick(), null == i || i(u));
                                        },
                                    },
                                    s().createElement('div', { className: a()(H, V) }),
                                ),
                            e &&
                                s().createElement(b, {
                                    type: p.Minimize,
                        ...
                        (
                            ...
                            return (
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        'div',
                                        { className: a()(z, d), style: { '--outer-shadow-width': '13rem' }, ref: m },
                                        s().createElement('div', { className: a()(W, p && j) }),
                                        s().createElement(U, {
                                            title: u,
                                            infoTooltipHeader: A,
                                            infoTooltipBody: F,
                                        ...
                                        s().createElement(
                                            ...
                                            s().createElement('div', { className: K, ref: _ }, D),
                                        ),
                                    ),
                                )
                            );
                            ...
                            uu(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        a = au(u);
                                    A.current = ou.addCallback(a, t, s, e === ru.Deep);
                                }
                            }),
                            (0, r.useEffect)(() => {
                                if (e !== ru.None)
                                    return () => {
                                        ou.removeCallback(A.current, s);
                                    };
                            }, [s, e]),
                            E
                        );
                    ...
                    Bu = (0, r.memo)(({ id: u, fallback: e, onLoadCallback: t, mixClass: n }) => {
                        const o = (0, r.useState)(''),
                            ...
                            D = (0, r.useCallback)(
                                (u) => {
                                    u.includes(c) &&
                                        (d(!0), engine.off(mu, D), window.subViews.removeChildChangedCallback(c));
                                },
                                [c],
                            ),
                            m = (0, r.useCallback)((u) => {
                        ...
                        if (i) {
                            ...
                            return (
                                ...
                                t && t(u),
                                s().createElement('div', { className: _, dangerouslySetInnerHTML: E })
                            );
                        }
                        return e ? s().createElement('div', { className: _ }, s().createElement(e, null)) : null;
                    });
                var Cu = t(493),
                    pu = t.n(Cu);
                const bu = (u) => ({ backgroundImage: `url('${u}')` }),
                    ...
                    gu = () => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement('div', { className: vu, style: u }),
                        );
                    };
                function yu() {
                    return (
                        ...
                        ({
                            ...
                            return s().createElement(
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        B,
                                        yu({ type: D.primary, size: m.small, onClick: l, disabled: !e }, a),
                                        n || u,
                                    ),
                                ),
                            );
                ...
                const Mu = ({ position: u }) => {
                        ...
                        return s().createElement(
                            'div',
                            { className: n },
                            s().createElement('div', { className: ku, style: bu(e) }),
                        );
                    },
                ...
                const Hu = (u) => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                B,
                                Lu({}, i, { type: 'secondary', size: r }),
                                s().createElement('span', { className: xu }, n),
                            ),
                ...
                const Gu = () => {
                        const u = su().shouldShowFindPlayersButton,
                            e = su('model.btnInviteFriends'),
                            t = su('model.btnFindPlayers'),
                            n = (0, r.useCallback)(() => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement(fu, ju({}, e, { cButtonProps: a })),
                        );
                    },
                    qu = 'Footer_base_d0',
                    ...
                    Xu = () => {
                        const u = su('model.btnSwitchReady'),
                            e = u.onClick,
                            t = u.caption,
                            n = u.description,
                            o = u.tooltipHeader,
                            ...
                            _ = i ? D.primaryRed : D.primary;
                        return s().createElement(
                            'div',
                            { className: qu },
                            s().createElement('div', { className: F }, c),
                            s().createElement(
                                M,
                                { header: o, body: n },
                                s().createElement(B, { onClick: d, size: m.small, type: _, disabled: !l }, t),
                            ),
                        );
                    },
                    Zu = 'Bonus_base_96',
                    ...
                    ue = ({ currency: u, amount: e }) => {
                        ...
                        return s().createElement(
                            'div',
                            { className: Zu },
                            s().createElement('div', { className: Qu, style: n }),
                            s().createElement('span', { className: Ju }, `+${e}%`),
                        );
                    },
                    ee = 'Bonuses_base_6f',
                    te = () => {
                        const u = su('model.header.bonuses');
                        return 0 === u.length
                            ? null
                            : s().createElement(
                                  'div',
                ...
                const ce = 'FormatText_base_d0',
                                  ...
                                  e.split('\n').map((e, o) =>
                                      s().createElement(
                                          ...
                                          ((u, e, t) =>
                                              ...
                                              s().createElement(r.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              ),
                    ...
                    De = 'NoBonus_icon_69',
                    me = () => {
                        const u = su('model.header.noBonusPlaceholder'),
                            e = u.text,
                            t = u.icon,
                            n = t && bu(t);
                ...
                const ge = () => {
                    const u = su('model.header.btnLeavePlatoon'),
                        e = su('model.header.btnMuteAll'),
                        t = su('model.header'),
                        n = t.backgroundImage,
                    ...
                    return s().createElement(
                        'div',
                        { className: _e, style: bu(n) },
                        s().createElement(
                            'div',
                            { className: Be },
                            s().createElement(
                                fu,
                                ve({}, u, { onClick: i, cButtonProps: { type: D.secondary }, className: Ce }),
                            ),
                        ),
                        e.isVisible &&
                            s().createElement(
                        ...
                        a ? s().createElement(me, null) : s().createElement(te, null),
                        o && s().createElement(gu, null),
                    );
                };
                let ye;
                !(function (u) {
                        ...
                        return s().createElement(
                            ...
                            u.map(({ value: u }, t) =>
                                s().createElement(
                                    ...
                                    s().createElement(Ae, { text: u.content, classMix: Me }),
                                ),
                            ),
                        );
                    },
                ...
                const Pe = ({ text: u, type: e, slotLabelElements: t }) => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                'div',
                                { className: xe.footer },
                                t.length > 0 && s().createElement(Oe, { slotLabelElements: t }),
                            ),
                        );
                    },
                    Se = ({ estimatedTime: u }) =>
                        s().createElement(
                            s().Fragment,
                            null,
                            s().createElement('div', null, R.strings.platoon.members.card.searching()),
                    ...
                    $e = ({ rating: u }) =>
                        s().createElement(
                            ...
                            s().createElement('span', { className: Ve }, u),
                        ),
                    Ue = (u) => u.replace('-', '_'),
                    ze = (u, e) =>
                        String(
                ...
                const Ye = 'TextOverflow_base_3b',
                    Xe = ({ content: u, classMix: e }) => {
                        ...
                        return (
                            ...
                            s().createElement(
                                M,
                                { isEnabled: o, body: u },
                                s().createElement('div', { ref: t, className: a()(Ye, e) }, u),
                            )
                        );
                    },
                    Ze = {
                    ...
                    et = (0, r.memo)(({ tooltipHeaderName: u }) => {
                        ...
                        return s().createElement(
                            M,
                            { header: e, body: t },
                            s().createElement('div', { className: ut.anonymizedIcon }),
                        );
                    });
                function tt() {
                    return (
                ...
                const nt = { [Ke.default]: 'c_64x24', [Ke.x48]: 'c_68x28' },
                    ...
                    ot = ({
                        ...
                        const D = R.images.gui.maps.icons.library.badges.strips.$dyn(nt[A]),
                            ...
                            _ = R.images.gui.maps.icons.library.badges.$dyn(at[A]),
                            B = (0, r.useMemo)(
                                () => ({ backgroundImage: `url(${_.$dyn(`badge_${o.badgeID}`)})` }),
                                [o, _],
                            ),
                            C = e ? `[${e}]` : '',
                            p = a()(ut.base, ut[`base__${A}`], i && ut.base__inverted),
                            b = a()(ut.userName, F),
                            v = a()(ut.clanTag, d),
                            g = u !== c,
                            y = l ? `${c}${C}` : c,
                            f = Boolean(n.badgeID) && s().createElement(Je, tt({ size: A }, n, { key: 'badge' })),
                            h = Date.now(),
                            w = [
                                f,
                                [
                                    s().createElement(
                                        ...
                                        s().createElement(Xe, { content: u, key: h }),
                                    ),
                                    !l && Boolean(C) && s().createElement('div', { className: v, key: 'clanTag' }, C),
                                ],
                                0 !== t && s().createElement('div', { className: ut.igrIcon, key: 'igrType' }),
                                Boolean(o.badgeID) &&
                                    s().createElement(
                                        'div',
                                        { className: ut.suffixBadgeWrapper, key: 'suffixBadge' },
                                        s().createElement('div', { className: ut.suffixBadgeStripe, style: m }),
                                        s().createElement('div', { className: ut.suffixBadge, style: B }),
                                    ),
                                E && g && s().createElement(et, { tooltipHeaderName: y, key: 'anonymizer' }),
                            ];
                        return s().createElement('div', { className: p }, i ? w.reverse() : w);
                    },
                    rt = 'PlayerName_userName_c9',
                    st = { badgeID: '' },
                    it = ({ name: u, badgeID: e, clanTag: t, color: n }) => {
                ...
                const At = 'VehicleDescription_base_1b',
                    ...
                    Dt = ({ type: u, isPremium: e, name: t, tier: n, className: o, prebattleType: r }) =>
                        s().createElement(
                            'div',
                            { className: a()(At, o) },
                            r !== ke.BattleRoyal && ct(n),
                            s().createElement('div', { className: a()(Ft, e && dt), style: bu(ze(u, e)) }),
                            t,
                        ),
                    mt = (0, r.memo)(({ src: u, className: e, autoPlay: t = !1, loop: n = !1 }) => {
                        ...
                        return (
                            ...
                            s().createElement('video', { ref: a, className: e, src: u, autoPlay: t, loop: n })
                        );
                    });
                mt.displayName = 'Video';
                const _t = 'VoiceAnimation_talkingAnimation_c4',
                ...
                const wt = {
                    ...
                    Nt = (u) => wt[u],
                    kt = [ht.First, ht.Second, ht.Third, ht.Fourth],
                    Tt = (u) => kt.includes(u),
                ...
                const xt = ({ rank: u, size: e, division: t, className: n }) => {
                        ...
                        return s().createElement('div', { className: a()(Mt, n), style: o });
                    },
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                ...
                                s().createElement(
                                    'div',
                                    { className: Pt },
                                    s().createElement(xt, { rank: t, division: n, size: Ot.x22 }),
                                ),
                                s().createElement(pt, { value: o }),
                            ),
                        );
                    },
                ...
                const an = ({ slot: u, player: e, isInBattle: t, infoText: n, prebattleType: o }) => {
                    const i = a()(Jt, e.isReady && !t && un),
                        l = o === ke.BattleRoyal ? je : We,
                    ...
                    return s().createElement(
                        ...
                        s().createElement(
                            ...
                            e.isPrem && s().createElement('div', { className: Kt }),
                            s().createElement(Ct, { visible: e.voice.isSpeaking }),
                        ...
                        !t &&
                            ...
                            s().createElement(
                                s().Fragment,
                                null,
                                s().createElement('div', { className: tn, style: bu(c) }),
                                s().createElement('div', { className: en, style: bu(E) }),
                            ),
                        e.isIgnored &&
                            s().createElement('div', {
                                className: tn,
                        ...
                        s().createElement(
                            'div',
                            { className: Xt },
                            e.voice.isMutedByUser && s().createElement(qe, null),
                        ),
                        s().createElement('div', { className: Zt }, s().createElement(it, e.commonData)),
                        '' !== e.commonData.rating && s().createElement($e, { rating: e.commonData.rating }),
                        o === ke.Comp7 && s().createElement(Lt, { slot: u }),
                        o === ke.Ranked && s().createElement(Ut, { slot: u }),
                        s().createElement(
                            'div',
                            { className: Qt },
                            e.isReady && !t ? s().createElement(Dt, nn({}, e.vehicle, { prebattleType: o })) : n,
                        ),
                ...
                const rn = (u) => {
                                ...
                                u.isEmpty
                                    ? ((u) =>
                                          u.isDisabled
                                              ...
                                              : u.isSearching
                                                ? {
                                                      text: s().createElement(Se, { estimatedTime: u.estimatedTime }),
                                                      type: Re.spinner,
                                                      slotLabelElements: u.slotLabelElements,
                                                  }
                                                : {
                        ...
                        return (0, r.useMemo)(() => (u) => void 0 !== u.isInBattle, [])(e)
                            ? s().createElement(an, on({ slot: u }, e))
                    ...
                    sn = ({ slot: u }) =>
                        s().createElement(
                            s().Fragment,
                            null,
                            s().createElement(it, u.player.commonData),
                            s().createElement(Lt, { slot: u }),
                        ),
                ...
                const mn = ({ vehicle: u }) => {
                        ...
                        return s().createElement(
                            'div',
                            { className: An },
                            s().createElement(Dt, Dn({}, u, { className: dn })),
                            s().createElement('div', { className: Fn, style: bu(e) }),
                        );
                    },
                    _n = {
                    ...
                    Bn = (u) => {
                                    ...
                                    ((u) =>
                                        u.isSearching
                                            ...
                                            : u.isDisabled
                                              ...
                                              : u.isEmpty
                                                ? cn.empty()
                                                : u.prebattleType === ke.Comp7
                                                  ? s().createElement(sn, { slot: u })
                                                  : s().createElement(it, u.player.commonData))(u),
                                [u],
                            ),
                            i = (0, r.useMemo)(() => ({ slotId: u.slotId }), [u.slotId]),
                            l = !e.isReady || u.isInBattle ? u.infoText : s().createElement(mn, { vehicle: e.vehicle }),
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                ...
                                s().createElement(
                                    'div',
                                    { className: _n.mutedContainer },
                                    e.voice.isMutedByUser && s().createElement(qe, null),
                                ),
                                s().createElement(
                                    'div',
                                    { className: a()(_n.memberType, u.isDisabled && _n.isDisabled) },
                                    s().createElement(Ct, { visible: e.voice.isSpeaking }),
                                    s().createElement('div', {
                                        style: bu(n),
                                        className: a()(_n.icon, u.isSearching && _n.spinner),
                                    }),
                                ),
                                s().createElement(
                                    'div',
                                    { className: a()(_n.mainContent, u.isEmpty && _n.mainContent__isEmpty) },
                                    o,
                                ),
                                !u.isEmpty && s().createElement('div', { className: _n.detailsContainer }, l),
                                e.isReady &&
                                    !u.isInBattle &&
                                    s().createElement('div', {
                                        className: a()(_n.readiness, e.isReady && _n.readiness__isReady),
                                    }),
                            ),
                        );
                    },
                ...
                const bn = ({ slot: u, isHorizontal: e, isShort: t }) => {
                        const n = e ? rn : Bn,
                            ...
                            i = (0, r.useMemo)(() => ({ userName: o }), [o]),
                            l = s().createElement(
                                'div',
                                { className: a()(t && Cn) },
                                s().createElement(n, pn({ key: u.slotId }, u)),
                            );
                        return u.player.isCurrentUser || u.isEmpty
                            ? l
                            : s().createElement(Ne, { args: i, key: u.slotId }, l);
                    },
                    vn = 'Slots_base_7e',
                    ...
                    Nn = 'MembersWindow_base__isHorizontal__short_0c',
                    kn = 'MembersWindow_base__isVertical_44',
                    ...
                    Pn = () => {
                        ...
                        return (
                            ...
                            s().createElement(
                                ...
                                s().createElement(
                                    'div',
                                    { className: a()(hn, n ? [wn, i && Nn] : kn) },
                                    s().createElement(
                                        'div',
                                        { className: xn },
                                        s().createElement(ge, null),
                                        s().createElement(Mu, { position: Tu.top }),
                                        s().createElement('div', { className: Rn }, s().createElement(fn, null)),
                                        s().createElement(
                                            'div',
                                            { className: a()(Mn, !D && On) },
                                            t && s().createElement(Gu, null),
                                        ),
                                        s().createElement(Mu, { position: Tu.bottom }),
                                        s().createElement(Xu, null),
                                    ),
                                    s().createElement(Mu, { position: Tu.left }),
                                    s().createElement(Bu, {
                ...
                engine.whenReady.then(() => {
                    (pu().render(s().createElement(Pn, null), document.getElementById('root')),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [720], () => __webpack_require__(998));
