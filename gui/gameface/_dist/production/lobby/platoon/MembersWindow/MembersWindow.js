                                ...
                                ((t.style.transform = `translateX(${0 | E}px)`),
                                    ((e) => {
                                        if (a.current && l.current && c.current && d.current) {
                                            if (0 === e)
                                                return (
                                                    a.current.classList.add(At),
                                                    void l.current.classList.remove(At)
                                                );
                                            if (
                                                ((u = c.current),
                                                (t = d.current),
                                                ...
                                                return (
                                                    a.current.classList.remove(At),
                                                    void l.current.classList.add(At)
                                                );
                                            var u, t;
