(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e), t.d(e, { mouse: () => r, onResize: () => n }));
                var E = t(472),
                    A = t(176);
            ...
            376: (u, e, t) => {
                ...
                const C = ({
                    ...
                    const m = (0, E.useRef)(null),
                        ...
                        k = y[1],
                        M = (0, E.useCallback)(() => {
                            F || (m.current && (m.current.focus(), p(!0)));
                        }, [F]),
                        P = (0, E.useCallback)(
                            (u) => {
                                w && null !== m.current && !m.current.contains(u.target) && p(!1);
                            },
                            [w],
                        ),
                        T = (0, E.useCallback)(
                        ...
                        U = o()(
                            ...
                            a[`base__${n}`],
                            {
                                ...
                                [a[`base__${e}`]]: e,
                                [a.base__focus]: w,
                                [a.base__highlightActive]: f,
                                [a.base__firstHover]: O,
                            },
                            r,
                        ),
                        H = o()(a.state, a.state__default);
                    return (
                        (0, E.useEffect)(
                            () => (
                ...
                const d = (u, e, t) => {
                    ...
                    v = (u, e, t = l.left) => u.split(e).reduce(t === l.left ? d : _, []),
                    m = (() => {
                        const u = new RegExp(
                    ...
                    b = ['zh_cn', 'zh_sg', 'zh_tw'],
                    w = ({ binding: u, text: e = '', classMix: t, alignment: n = l.left }) =>
                        null === e
                            ...
                            : A().createElement(
                                  ...
                                  e.split('\n').map((e, F) =>
                                      A().createElement(
                                          'div',
                                          { className: o()('FormatText_base_d0', t), key: `${e}-${F}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                        ...
                        const w = (0, E.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, E.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (g(t, C, { isMouseEvent: !0, on: !0, arguments: f(A) }, p),
                                    v && v(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((w.current.timeoutId = window.setTimeout(y, i ? 100 : 400)),
                                                          n && n(u),
                                                          M && M(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                ...
                const M = R.views.common.tooltip_window.simple_tooltip_content,
                    P = (u) => {
                        ...
                        const i = (0, E.useMemo)(() => {
                            const u = Object.assign({}, o, { body: t, header: n, note: F, alert: r });
                ...
                const N = ['__left', '__right', '__top', '__bottom'],
                    I = (0, E.forwardRef)(
                        ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: n = {} }, F) => {
                            const r = (0, E.useRef)(null),
                                D = (0, E.useRef)(null),
                                a = (0, E.useRef)(null),
                                s = (0, E.useState)(window.decorator && window.decorator.directionType),
                                B = s[0],
                                C = s[1],
                                c = (0, E.useCallback)(() => {
                                    (i.playClick(), T.O.view.sendEvent.close());
                                }, []),
                                l = (0, E.useCallback)(() => {
                                    i.playHighlight();
                                }, []),
                                d = o()(S.arrow, S[`arrow${N[B]}`]);
                            x(
                                () => (
                                    T.O.client.events.mouse.enableOutside(),
                                    T.O.client.events.mouse.down(([, u]) => {
                                        'outside' === u && (t ? t() : T.O.view.sendEvent.close('popover'));
                                    })
                                ),
                            );
                            const _ = (0, E.useCallback)(
                                    (u) => {
                                        let e = u.target;
                                        do {
                                            if (e === r.current || e === a.current) return;
                                            e = e.parentNode;
                                        } while (e);
                                        const E = window.decorator;
                                        if (void 0 !== window.decorator) {
                                            const u = T.O.client.getMouseGlobalPosition(),
                                                e = ![E.boundX, E.boundY, E.boundWidth, E.boundHeight].includes(void 0),
                                                t =
                                                    u.x < E.boundX ||
                                                    u.x > E.boundX + E.boundWidth ||
                                                    u.y > E.boundY + E.boundHeight ||
                                                    u.y < E.boundY;
                                            if (e && !t) return;
                                        }
                                        t ? t() : T.O.view.sendEvent.close('popover');
                                    },
                                    [r, a, t],
                                ),
                                v = (0, E.useCallback)(
                                    () => (
                                        T.O.view.freezeTextureBeforeResize(),
                                        ((u) => {
                                            let e,
                                                t = null;
                                            return (
                            ...
                            return (
                                (0, E.useImperativeHandle)(F, () => ({ updateSize: v })),
                                x(() => {
                                    T.O.view.setInputPaddingsRem(58);
                                }),
                                (0, E.useEffect)(() => {
                                ...
                                A().createElement(
                                    'div',
                                    { className: S.base, ref: D },
                                    A().createElement(
                                        'div',
                                        { className: S.decorator },
                                        A().createElement(
                                            'div',
                                            { className: S.content, ref: r },
                                            u,
                                            window.decorator &&
                ...
                const W = (u) => (0 === u ? window : window.subViews.get(u)),
                    z = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: n, children: F, mocks: r }) {
                                const o = (0, E.useRef)([]),
                                    D = (u, t, E) => {
                                        var A;
                                        const n = (function ({
                                            ...
                                            i = (({ observableModel: u }) =>
                                                Object.assign({}, u.primitives(['battlesCount'])))({
                                                mode: u,
                                                readByPath: r,
                                                externalModel: F,
                                                observableModel: {
                                            ...
                                            a = { mode: u, model: i, externalModel: F, cleanup: D };
                                        return {
                                            model: i,
                                            controls: 'mocks' === u && E ? E.controls(a) : e(a),
                                            externalModel: F,
                                            mode: u,
                                        };
                                    },
                                    ...
                                    s = a[0],
                                    B = a[1],
                                    C = (0, E.useState)(() => D(u, n, r)),
                                    c = C[0],
                                    l = C[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        i.current ? l(D(s, n, r)) : (i.current = !0);
                                    }, [r, s, n]),
                                    (0, E.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                    ...
                    })(0, ({ externalModel: u }) => ({ close: u.createCallbackNoArgs('onClick') })),
                    G = z[0],
                    q = z[1],
                    K = R.strings.winback.winbackPopover,
                    Y = (0, U.Pi)(() => {
                        const u = q(),
                            e = u.model,
                            t = u.controls;
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                A().createElement(
                                    'div',
                                    { className: 'App_header_fa' },
                                    A().createElement(w, { classMix: 'App_title_f2', text: K.title() }),
                                    A().createElement(
                                        y,
                                        { contentId: R.views.lobby.winback.tooltips.ModeInfoTooltip('resId') },
                                        A().createElement('div', { className: 'App_info_39' }),
                                    ),
                                ),
                                A().createElement(w, { classMix: 'App_description_0f', text: K.description() }),
                                A().createElement(w, {
                                    classMix: 'App_battlesLeft_26',
                                    text: K.battlesCount(),
                                    binding: {
                                        battlesCount: A().createElement(
                                            'span',
                                            { className: 'App_battlesCount_da' },
                                            e.battlesCount.get(),
                                        ),
                                    },
                                }),
                                A().createElement(
                                    c,
                                    { mixClass: 'App_button_d1', onClick: t.close },
                                    A().createElement(w, { text: K.turnOff() }),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    F().render(A().createElement(G, null, A().createElement(Y, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(376));
