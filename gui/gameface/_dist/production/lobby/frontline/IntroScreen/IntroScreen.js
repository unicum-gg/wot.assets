(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                t.d(e, { O: () => q });
                var n = {};
                (t.r(n), t.d(n, { mouse: () => E, onResize: () => A }));
                var a = {};
                (t.r(a),
                    t.d(a, {
                        events: () => n,
            ...
            621: (u, e, t) => {
                ...
                const l = s.O.client.getSize('rem'),
                    _ = l.width,
                    c = l.height,
                    D = Object.assign({ width: _, height: c }, E(_, c, A)),
                ...
                const C = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && E) return o(e, t, w);
                    ...
                    h = (0, n.memo)(({ children: u }) => {
                        const e = (0, n.useContext)(d),
                            ...
                            o = (0, n.useCallback)((u, e) => {
                                ...
                                r(Object.assign({ width: t, height: n }, E(t, n, A)));
                            }, []);
                        (m(() => {
                    ...
                    const d = (0, n.useRef)(null),
                        ...
                        U = v()(
                            ...
                            b[`base__${i}`],
                            {
                                ...
                                [b.base__firstHover]: O,
                            },
                            o,
                        ),
                        W = v()(b.state, b.state__default);
                    return (
                        (0, n.useEffect)(
                            () => (
                ...
                class M extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            _ = v()(S.base, S[`base__${r}`], S[`base__${i}`], null == o ? void 0 : o.base),
                            c = v()(S.icon, S[`icon__${r}`], S[`icon__${i}`], null == o ? void 0 : o.icon),
                            D = v()(S.glow, null == o ? void 0 : o.glow),
                            d = v()(S.caption, S[`caption__${r}`], null == o ? void 0 : o.caption),
                            B = v()(S.goto, null == o ? void 0 : o.goto);
                            ...
                            m(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = z(u);
                                    l.current = G.addCallback(n, t, o, e === q.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== q.None)
                ...
                const X = ({ icon: u, title: e, desc: t }) => {
                        ...
                        let r = Z.None;
                        (i.extraSmall || i.small) && (r = Z.Small);
                        const o = U(['icon'], Y),
                            s = (0, n.useMemo)(
                                () => ({
                        ...
                        return a().createElement(
                            ...
                            a().createElement('span', { className: A.title }, e),
                    ...
                    J = () => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    O,
                                    { size: p.medium, type: f.primary, mixClass: Q.button, onClick: e },
                ...
                engine.whenReady.then(() => {
                    r().render(a().createElement(h, null, a().createElement(J, null)), document.getElementById('root'));
                });
            },
        },
