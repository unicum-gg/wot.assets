(() => {
    var __webpack_modules__ = {
            ...
            228: (u, e, t) => {
                ...
                const X = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    V = (u, e, t = $.left) => u.split(e).reduce(t === $.left ? Y : j, []),
                    q = (() => {
                        const u = new RegExp(
                        ...
                        return z.includes(t)
                            ...
                            : ((u, e = $.left) => {
                                  ...
                                  const a =
                                      ...
                                      r = X(u);
                                  return V(r, /( )/, e).forEach((u) => (t = t.concat(V(u, a, $.left)))), t;
                              })(u, e);
                    };
                let Q;
                !(function (u) {
                        ...
                        const h = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, a.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (qu(t, F, { isMouseEvent: !0, on: !0, arguments: Vu(r) }, w),
                                    C && C(),
                ...
                const Ie = Object.keys(Oe()),
                    ...
                    Ye = we((u) => {
                        ...
                        return r().createElement(
                            ...
                            void 0 !== m ? r().createElement(Le, Ne({}, m, { text: e })) : e,
                        );
                    }),
                    je = (u, e) =>
                        'items' === u.name
                    ...
                    qe = () => {
                        const u = su('model', iu.None).mainRewards,
                            ...
                            l = h()(Ve.base, t && Ve.base__large, a && Ve.base__medium, n && Ve.base__small);
                        return r().createElement(
                            'div',
                            { className: l },
                            u.items.map((u, e) => {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [678], () => __webpack_require__(228));
