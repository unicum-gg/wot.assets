(() => {
    var __webpack_modules__ = {
            ...
            67: (u, e, t) => {
                ...
                t.d(e, { O: () => V });
                var r = {};
                (t.r(r), t.d(r, { mouse: () => _, onResize: () => E }));
                var a = {};
                (t.r(a),
                    t.d(a, {
                        events: () => r,
                ...
                const Y = Object.keys(m).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === m[e]), u), {}),
                    j = {
                        set: (u, e) => {
            ...
            530: (u, e, t) => {
                    ...
                    g = (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(d),
                            ...
                            s = (0, r.useCallback)((u, e) => {
                                ...
                                i(Object.assign({ width: t, height: r }, _(t, r, E)));
                            }, []);
                        (C(() => {
                ...
                const L = {
                    ...
                    y = (u) => {
                        ...
                        const n = T(),
                            ...
                            s = n.mediaHeight,
                            o = n.mediaSize;
                        return a().createElement('div', M({ className: h()(t, L[i], P[s], O[o]) }, r), e);
                    },
                    k = ['children'];
                const N = (u) => {
                    let e = u.children,
                    ...
                    return a().createElement(g, null, a().createElement(y, t, e));
                };
                function I(u) {
                ...
                const J = (u = 1) => {
                    ...
                    ru = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const r = uu(`${u}.${t}`, window);
                                return eu(r) ? e(u, t, r) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    au = (u) => {
                        const e = ((u) => {
                                const e = J(),
                                ...
                                return { modelPrefix: a, modelPath: tu(a, u || ''), resId: r };
                            })(),
                            t = e.modelPrefix,
                            r = u.split('.');
                        if (r.length > 0) {
                            ...
                            return (
                                r.reduce((e, r) => {
                                    const a = uu(tu(t, `${e}.${r}`), window);
                                    return eu(a) ? (u.push(a.id), `${e}.${r}.value`) : (u.push(r), `${e}.${r}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        C(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    r = au(u);
                                A.current = nu.addCallback(r, t, s, e === iu.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (e !== iu.None)
                ...
                const mu = 'metrics',
                    Bu = ({ partnerID: u, item: e, parentScreen: t, itemState: r, info: a }) => ({
                        item: e,
                        partnerID: u || null,
                    ...
                    bu = ({ title: u, subtitle: e }) =>
                        a().createElement(
                            'div',
                            { className: pu },
                            a().createElement('div', { className: hu }, u),
                ...
                const Zu = (u, e, t = {}, r = 0) => {
                    ...
                    Ju = (u) => {
                        ...
                        const h = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            w = (0, r.useMemo)(() => B || J().resId, [B]),
                            b = (0, r.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Zu(t, F, { isMouseEvent: !0, on: !0, arguments: Qu(a) }, w),
                                    C && C(),
                ...
                const oe = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        return n || s
                            ? a().createElement(Ju, se({}, e, { contentId: n || s }), r)
                    ...
                    le = ({
                        ...
                        const c = ((u) => {
                            ...
                            D = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case Pu.CURRENCY:
                                    case Pu.NUMBER:
                                        return a().createElement(Hu, { format: 'integral', value: Number(u) });
                        ...
                        return a().createElement(
                            'div',
                            { className: h()(Ee.base, Ee[`base__${r}`], E), style: o },
                            a().createElement(
                                oe,
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: h()(Ee.image, null == l ? void 0 : l.image) },
                                        c &&
                                            a().createElement('div', {
                                                className: h()(Ee.highlight, null == l ? void 0 : l.highlight),
                                                style: {
                                        ...
                                        e &&
                                            a().createElement('div', {
                                                className: h()(Ee.icon, null == l ? void 0 : l.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        F &&
                                            a().createElement('div', {
                                                className: h()(Ee.overlay, null == l ? void 0 : l.overlay),
                                                style: {
                            ...
                            t &&
                                a().createElement(
                                    ...
                                    { tooltipArgs: A },
                                    a().createElement('div', {
                                        className: h()(Ee.timer, null == l ? void 0 : l.periodicIcon),
                                    }),
                                ),
                        );
                    };
                                            ...
                                            : Gu.includes(e)
                                              ...
                                              : Wu.includes(e)
                                                ...
                                                : $u.includes(e)
                                                  ? Pu.PREMIUM_PLUS
                                                  : Pu.STRING),
                                    tooltipArgs: Vu({ tooltipId: u.tooltipId }),
                                };
                                var e;
                            }),
                            A = (0, r.useCallback)((u) => ({ appear: 1600 + 100 * u, enter: 200 }), []),
                            c = h()(Ae.reward, !i && Ae.reward__big);
                        return a().createElement(
                            'div',
                            { className: Ae.base },
                            a().createElement(
                ...
                const De = (u = {}) => {
                    ...
                    de = 'Footer_base_72',
                    me = 'Footer_base__2x_f3',
                    Be = 'Footer_buttonContainer_93',
                    Ce = 'Footer_buttonWrapper_86',
                    ge = () => {
                        const u = T().mediaSize,
                            e = gu(_u),
                            t = (0, r.useCallback)(() => {
                ...
                const we = ['xl', 'lg', 'md', 'sm', 'xs'],
                    be = (u) => u.includes('_') && ((u) => we.includes(u))(u.split('_').at(-1)),
                    ...
                    Se = (u, e) =>
                        Object.keys(u).reduce((t, r) => {
                            ...
                            return (
                                void 0 === a ||
                                    ((u, e) => we.some((t) => void 0 !== e[`${u}_${t}`]))(r, u) ||
                                    (t[r] = a),
                                t
                            );
                        }, {}),
                ...
                const Me = {
                    ...
                    Oe = fe((u) => {
                        ...
                        return a().createElement('div', xe({ className: h()(Re.base, ...W, e), style: G }, H), I);
                    }),
                    ye = 'FormatText_base_d0',
                    ke = ({ binding: u, text: e = '', classMix: t, alignment: n = $.left }) =>
                        null === e
                ...
                const We = Object.keys(Ie()),
                    ...
                    Ze = () => {
                        const u = su('model', iu.None).mainRewards,
                            ...
                            l = h()(Qe.base, t && Qe.base__large, r && Qe.base__medium, n && Qe.base__small);
                        return a().createElement(
                            'div',
                            { className: l },
                            u.items.map((u, e) => {
                                ...
                                return a().createElement(
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(
                                            ...
                                            a().createElement('div', { className: c, style: Ke(u.value, E()) }),
                                            r &&
                                                '1' !== r &&
                                                F &&
                                                a().createElement(
                                    ...
                                    _ &&
                                        a().createElement(
                                            ...
                                            a().createElement('div', { className: Qe.title }, _),
                                        ),
                                );
                                var D, d;
                            }),
                    ...
                    Je = 'RewardScreen_base_e5',
                    ut = 'RewardScreen_content_43',
                    et = 'RewardScreen_reward_db',
                    tt = 'RewardScreen_ribbon_c2',
                    rt = () => {
                        const u = su(),
                            e = u.mainRewards,
                            t = u.additionalRewards,
                            r = Boolean(e.items && e.items.length),
                    ...
                    at = 'AwardsApp_base_c3',
                    nt = 'AwardsApp_close_95',
                    it = 'AwardsApp_header_72',
                    st = 'AwardsApp_content_b8',
                    ot = () => {
                        ...
                        return (
                            ...
                            a().createElement(
                                ...
                                a().createElement('div', { className: st }, a().createElement(rt, null)),
                            )
                        );
                    };
                engine.whenReady.then(() => {
                    i().render(
                        a().createElement(N, null, a().createElement(ot, null)),
