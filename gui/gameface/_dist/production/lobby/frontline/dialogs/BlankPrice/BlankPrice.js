(() => {
    ...
    var __webpack_modules__ = {
            294: (u, e, t) => {
                ...
                var E = {};
                (t.r(E), t.d(E, { getBgUrl: () => y, getTextureUrl: () => O }));
                var A = {};
                function o(u) {
                    return (e) => (
                        engine.on(u, e),
                            ...
                            const F = e.args,
                                E = (function (u, e) {
                                    ...
                                    var t,
                                        ...
                                        F = {},
                                        E = Object.keys(u);
                                    for (n = 0; n < E.length; n++) ((t = E[n]), e.indexOf(t) >= 0 || (F[t] = u[t]));
                                    return F;
                                })(e, P);
                            return void 0 !== F
                ...
                const Du = { view: A, client: F, sound: h, intl: w };
            },
            521: (u, e, t) => {
                let n, F;
                (t.d(e, { n: () => n }),
            ...
            862: (u, e, t) => {
                ...
                const D = (u, e, t = {}, n = 0) => {
                    ...
                    s = (u) => {
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            O = (0, n.useMemo)(() => p || o().resId, [p]),
                            y = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (D(t, _, { isMouseEvent: !0, on: !0, arguments: a(F) }, O),
                                    h && h(),
                ...
                const b = (u = 'model', e = g.Deep) => {
                            ...
                            l(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = m(u);
                                    C.current = h.addCallback(n, t, i, e === g.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== g.None)
                    ...
                    y = 'BlankPriceApp_blank_e9',
                    T = 'BlankPriceApp_icon_0c',
                    k = () => {
                        const u = b().count,
                            e = (0, n.useMemo)(() => {
                                return (
