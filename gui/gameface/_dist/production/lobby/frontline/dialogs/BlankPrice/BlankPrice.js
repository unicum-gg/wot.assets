(() => {
                ...
                const a = (u, e, t = {}, A = 0) => {
                    ...
                    s = (u) => {
                        ...
                        const g = (0, A.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            T = (0, A.useMemo)(() => h || o().resId, [h]),
                            O = (0, A.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (a(t, l, { isMouseEvent: !0, on: !0, arguments: D(F) }, T),
                                    p && p(),
                            ...
                            k = (0, A.useCallback)((u) => {
                                g.current.isVisible &&
                                    ...
                                    (g.current.hideTimerId = window.setTimeout(() => {
                                        ...
                                        e && !e.isSameNode(g.current.prevTarget) && M();
                                    }, 200)));
                            }, []);
                        ((0, A.useEffect)(() => {
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((g.current.timeoutId = window.setTimeout(O, C ? 100 : 400)),
                                                      n && n(u),
                                                      P && P(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                            ...
                            _(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        A = m(u);
                                    B.current = h.addCallback(A, t, r, e === p.Deep);
                                }
                            }),
                            (0, A.useEffect)(() => {
                                if (e !== p.None)
                                    return () => {
                                        h.removeCallback(B.current, r);
                                    };
                            }, [r, e]),
                            a
                        );
        ...
        (__webpack_require__.O = (u, e, t, A) => {
            if (!e) {
                ...
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, t, A] = deferred[r], n = !0, E = 0; E < e.length; E++)
                        (!1 & A || F >= A) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [678], () => __webpack_require__(963));
