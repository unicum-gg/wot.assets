(() => {
    ...
    var __webpack_modules__ = {
            99: (u, e, t) => {
                ...
                var n = {};
                (t.r(n),
                    t.d(n, { mouse: () => C, off: () => s, on: () => a, onResize: () => i, onScaleUpdated: () => D }));
                var F = {};
                (t.r(F),
                    t.d(F, {
                        events: () => n,
                ...
                var A = {};
                (t.r(A), t.d(A, { getBgUrl: () => O, getTextureUrl: () => f }));
                var E = {};
                function o(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            916: (u, e, t) => {
                ...
                function c(u, e, t, n, F, A, E) {
                    ...
                    o.done ? e(r) : Promise.resolve(r).then(n, F);
                }
            ...
            862: (u, e, t) => {
                ...
                const a = (u, e, t = {}, n = 0) => {
                    ...
                    s = (u) => {
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            O = (0, n.useMemo)(() => h || o().resId, [h]),
                            T = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (a(t, _, { isMouseEvent: !0, on: !0, arguments: D(F) }, O),
                                    p && p(),
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onMouseLeave: ((u) => (e) => {
                                              (k(), null == E || E(e), null == u || u(e));
                                          })(e.props.onMouseLeave),
                                          onClick: ((u) => (e) => {
                                              (!1 === d && k(), null == s || s(e), null == u || u(e));
                                          })(e.props.onClick),
                                          onMouseDown: ((u) => (e) => {
                                              (!1 === d && k(), null == r || r(e), null == u || u(e));
                                          })(e.props.onMouseDown),
                                      },
                                      g,
                                  ),
                ...
                const d = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    ...
                    m = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: F, modelPath: v(F, u || ''), resId: n };
                            })(),
                            t = e.modelPrefix,
                            n = u.split('.');
                        if (n.length > 0) {
                            ...
                            return (
                                n.reduce((e, n) => {
                                    const F = d(v(t, `${e}.${n}`), window);
                                    return _(F) ? (u.push(F.id), `${e}.${n}.value`) : (u.push(n), `${e}.${n}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const g = (u = 'model', e = b.Deep) => {
                            ...
                            l(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = m(u);
                                    C.current = p.addCallback(n, t, i, e === b.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== b.None)
                    ...
                    O = 'BlankPriceApp_text_9f',
                    T = 'BlankPriceApp_blank_e9',
                    k = 'BlankPriceApp_icon_0c',
                    y = () => {
                        const u = g().count,
                            e = (0, n.useMemo)(() => {
                                return (
                        ...
                        return F().createElement(
                            'div',
                            { className: f },
                            F().createElement('div', { className: O }, R.strings.dialogs.common.cost()),
                            F().createElement(
                                s,
                                e,
                                F().createElement(
                ...
                engine.whenReady.then(() => {
                    E().render(F().createElement(y, null), document.getElementById('root'));
                });
            },
            363: (u) => {
                u.exports = React;
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, t, n] = deferred[r], A = !0, E = 0; E < e.length; E++)
                        (!1 & n || F >= n) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [678], () => __webpack_require__(862));
