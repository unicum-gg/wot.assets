(() => {
    var __webpack_modules__ = {
            ...
            528: (e, t, r) => {
                ...
                var a = {};
                (r.r(a), r.d(a, { getBgUrl: () => O, getTextureUrl: () => k }));
                var o = {};
                function l(e) {
                    return (t) => (
                        engine.on(e, t),
                ...
                const b = {
                    ...
                    y = Object.keys(x).reduce((e, t) => ((e[t] = () => w(x[t])), e), {}),
                    S = { play: Object.assign({}, y, { sound: w }), setRTPC: v };
                var L = r(308);
                function k(e, t, r = 1) {
                ...
                const ue = { view: o, client: i, sound: S, intl: p };
            },
            20: (e, t, r) => {
                'use strict';
                r.d(t, { n: () => n });
            ...
            235: (e, t, r) => {
                ...
                (0, i.memo)((e) => {
                    ...
                    const n = (0, i.useContext)(g),
                        ...
                        y = { extraLarge: f, large: E, medium: b, small: p, extraSmall: x };
                    if (r.extraLarge || r.large || r.medium || r.small || r.extraSmall) {
                        ...
                        if (r.extraLargeWidth && u) return d(t, r, y);
                        if (r.largeWidth && _) return d(t, r, y);
                        if (r.mediumWidth && m) return d(t, r, y);
                        if (r.smallWidth && h) return d(t, r, y);
                        if (r.extraSmallWidth && v) return d(t, r, y);
                        if (!(
                            r.extraLargeWidth ||
                            r.largeWidth ||
                            r.mediumWidth ||
                ...
                const v = ({ children: e }) => {
                    ...
                    return (
                        ...
                        a().createElement(g.Provider, { value: r }, s && e)
                    );
                };
                var f = r(849),
                    E = r.n(f),
                ...
                const T = {
                        [y.ExtraSmall]: '',
                        [y.Small]: p().SMALL_WIDTH,
                        [y.Medium]: `${p().SMALL_WIDTH} ${p().MEDIUM_WIDTH}`,
                        [y.Large]: `${p().SMALL_WIDTH} ${p().MEDIUM_WIDTH} ${p().LARGE_WIDTH}`,
                        [y.ExtraLarge]: `${p().SMALL_WIDTH} ${p().MEDIUM_WIDTH} ${p().LARGE_WIDTH} ${p().EXTRA_LARGE_WIDTH}`,
                    },
                    M = {
                        [S.ExtraSmall]: '',
                    ...
                    I = (e) => {
                        ...
                        const i = L(),
                            ...
                            l = i.mediaHeight,
                            s = i.mediaSize;
                        return a().createElement('div', O({ className: E()(r, T[o], M[l], P[s]) }, n), t);
                    },
                    C = ['children'];
                const A = (e) => {
                    let t = e.children,
                        ...
                        const x = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            S = (0, i.useCallback)(() => {
                                (x.current.isVisible && x.current.timeoutId) ||
                                    (z(r, h, { isMouseEvent: !0, on: !0, arguments: U(n) }, y),
                                    E && E(),
                                  ...
                                  Object.assign(
                                      {
                                          onMouseEnter:
                                              ...
                                              (e) => {
                                                  (e.clientX === window.innerWidth &&
                                                      ...
                                                      (x.current.timeoutId = window.setTimeout(S, u ? 100 : 400)),
                                                      a && a(e),
                                                      O && O(e));
                                              }),
                                          onMouseLeave: ((e) => (t) => {
                                          ...
                                          onClick: ((e) => (t) => {
                                              (!1 === _ && L(), null == s || s(t), null == e || e(t));
                                          })(t.props.onClick),
                                          onMouseDown: ((e) => (t) => {
                                              (!1 === _ && L(), null == l || l(t), null == e || e(t));
                                          })(t.props.onMouseDown),
                                      },
                                      p,
                                  ),
                ...
                const J = a().memo(function ({ iconName: e, size: t = Q.c24x24, className: r }) {
                        var n;
                        const i = null == (n = R.images.gui.maps.icons.tankmen.skills.$dyn(t)) ? void 0 : n.$dyn(e);
                        return a().createElement('div', {
                            style: null !== i ? { backgroundImage: `url(${i})` } : void 0,
                            className: E()(Z.base, Z[`base__${t}`], r),
                        });
                    }),
                    ee = {
                        base: 'Skills_base_c9f43',
                        base__rows2: 'Skills_base__rows2_bd200',
                        base__rows3: 'Skills_base__rows3_ad53b',
                        base__rows4: 'Skills_base__rows4_cd1b3',
                        row: 'Skills_row_ab72b',
                        row__big: 'Skills_row__big_b959b',
                        hitBox: 'Skills_hitBox_c8a83',
                        hitBox__big: 'Skills_hitBox__big_b69d9',
                        skill: 'Skills_skill_e5c96',
                        skill__big: 'Skills_skill__big_df459',
                    },
                    te = ({ skills: e }) => {
                        const t = e.length,
                            r = Math.ceil(t / 10),
                        ...
                        return a().createElement(
                            'div',
                            { className: E()(ee.base, ee[`base__rows${r}`]) },
                            X(1, r, (i) => {
                                const o = 10 * (i - 1),
                                    l = Math.min(o + 10 - 1, t - 1);
                                return a().createElement(
                                    'div',
                                    { key: i, className: E()(ee.row, r < 3 && ee.row__big) },
                                    X(o, l, (t) => {
                                        const r = Y(e, t);
                                        if (!r) return;
                                        const i = r.iconName,
                                        ...
                                        return a().createElement(
                                            ...
                                            a().createElement(
                                                'div',
                                                { className: E()(ee.hitBox, n && ee.hitBox__big) },
                                                a().createElement(J, {
                                                    iconName: i,
                                                    size: Q.c52x52,
                                                    className: E()(ee.skill, n && ee.skill__big),
                                                }),
                                            ),
                                        );
                                    }),
                                    ...
                                    d = (r, i, a) => {
                                        ...
                                        const l = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var e, r = ae(a.keys()); !(e = r()).done;) o(e.value, t);
                                                    },
                                                    unsubscribe: o,
                                                };
                                            })(i),
                ...
                const he = R.views.common.tooltip_window.simple_tooltip_content,
                    ...
                    we = 'EmptyPanel_base_e0576',
                    ve = 'EmptyPanel_plus_ab12a',
                    fe = 'EmptyPanel_text_f304c',
                    Ee = R.strings.veh_compare.skillsConf,
                    be = a().memo(() =>
                        a().createElement(
                            ge,
                            { header: Ee.emptyTooltip.header(), body: Ee.emptyTooltip.body() },
                            a().createElement(
                                'div',
                                { className: we },
                                a().createElement('div', { className: ve }),
                                a().createElement('div', { className: fe }, Ee.empty()),
                            ),
                        ),
                    ),
                    pe = 'CompareSkillsPanelApp_base_c5b4a',
                    xe = 'CompareSkillsPanelApp_header_fea76',
                    ye = 'CompareSkillsPanelApp_infoIcon_f43c1',
                    Se = 'CompareSkillsPanelApp_content_b61c2',
                    Le = 'CompareSkillsPanelApp_hitBox_f833c',
                    ke = 'CompareSkillsPanelApp_closeButton_ff3b3',
                    Oe = (0, B.Pi)(({ sizerRef: e }) => {
                        const t = de(),
                            r = t.model,
                            n = t.controls,
                            o = (function () {
                        ...
                        return (
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: Le, onClick: n.click, onMouseEnter: j.playHighlight },
                                        s ? a().createElement(te, { skills: l }) : a().createElement(be, null),
                                    ),
                                    s &&
                                        a().createElement('div', {
                                            className: ke,
                    ...
                    D().render(
                        a().createElement(
                            ...
                            a().createElement(
                                A,
                                null,
                                a().createElement(u, { autoUpdate: !0 }, (e) => a().createElement(Oe, { sizerRef: e })),
                            ),
                        ),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [331], () => __webpack_require__(235));
