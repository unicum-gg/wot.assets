(() => {
    ...
    var __webpack_modules__ = {
            768: (u, e, t) => {
                ...
                var r = {};
                (t.r(r), t.d(r, { getBgUrl: () => b, getTextureUrl: () => w }));
                var i = {};
                function o(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            156: (u, e, t) => {
                ...
                const C = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && l) return r(e, t, p);
                ...
                const f = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    k = (u, e, t = w.left) => u.split(e).reduce(t === w.left ? y : x, []),
                    T = (() => {
                        const u = new RegExp(
                    ...
                    O = (u, e = w.left) => {
                        ...
                        return ((u, e = w.left) => {
                            ...
                            const n =
                                ...
                                a = f(u);
                            return (k(a, /( )/, e).forEach((u) => (t = t.concat(k(u, n, w.left)))), t);
                        })(u, e);
                    };
                var L = t(916),
                    M = t(613);
                        ...
                        d(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = j(u);
                                c.current = z.addCallback(n, t, E, e === U.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== U.None)
                                return () => {
                                    z.removeCallback(c.current, E);
                                };
                        }, [E, e]),
                        l
                    );
                ...
                class eu extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = K()(Q.base, Q[`base__${i}`], Q[`base__${r}`], null == o ? void 0 : o.base),
                            D = K()(Q.icon, Q[`icon__${i}`], Q[`icon__${r}`], null == o ? void 0 : o.icon),
                            B = K()(Q.glow, null == o ? void 0 : o.glow),
                            C = K()(Q.caption, Q[`caption__${i}`], null == o ? void 0 : o.caption),
                ...
                const _u = {
                    ...
                    mu = ({ value: u, currencyType: e, isWalletAvailable: t }) => {
                        const r = e === Du.gold ? 'gold' : 'integral',
                            i = (0, n.useMemo)(() => {
                                return (
                                    (u = Cu.backport),
                                    (t = { currency: e }),
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                t ? a().createElement(du, { value: u, format: r }) : R.strings.common.common.dashes(),
                            ),
                        );
                    },
                    gu = 'CurrencyBalance_base_97',
                    hu = ({ credits: u, golds: e, crystals: t, freexp: n, isWalletAvailable: r }) =>
                        a().createElement(
                            'div',
                            { className: gu },
                            a().createElement(mu, { value: t, currencyType: Du.crystal, isWalletAvailable: r }),
                            a().createElement(mu, { value: e, currencyType: Du.gold, isWalletAvailable: r }),
                            a().createElement(mu, { value: u, currencyType: Du.credits, isWalletAvailable: r }),
                            a().createElement(mu, { value: n, currencyType: Du.freeXP, isWalletAvailable: r }),
                        ),
                ...
                const Pu = ({
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement('div', { className: Su }, k, T),
                                a().createElement('div', { id: 'dialog-template-footer' }),
                            ),
                        );
                    },
                    Ru = 'FormatText_base_d0',
                    Nu = ({ binding: u, text: e = '', classMix: t, alignment: r = w.left, formatWithBrackets: i }) => {
                ...
                var Iu = t(690);
                const Hu = 'VehicleInfo_base_01',
                    Wu = 'VehicleInfo_base__small_2b',
                    ju = 'VehicleInfo_type_5a',
                    Vu = (u, e) => {
                    ...
                    zu = (0, n.memo)(
                        ({ vehicleLvl: u, vehicleName: e, vehicleType: t, isElite: r, isSmall: i = !1 }) => {
                            const o = K()(Hu, i && Wu),
                                E = (0, n.useMemo)(() => ({ backgroundImage: `url(${Vu(t, r)})` }), [t, r]);
                            return a().createElement(
                                'div',
                                { className: o },
                                (0, Iu.cg)(u),
                                a().createElement('div', { className: ju, style: E }),
                                e,
                            );
                        },
                    ),
                    Uu = 'Slot_base_70',
                    $u = 'Slot_icon_bb',
                    Gu = 'Slot_base__active_67',
                    Ku = 'Slot_specialization_ed',
                    qu = 'Slot_arrow_2d',
                    Yu = (0, n.memo)(({ specialization: u, isActive: e }) => {
                        const t = (0, n.useMemo)(() => {
                                if (!u) return {};
                                return {
                        ...
                        return a().createElement(
                            ...
                            u && a().createElement('div', { style: t, className: Ku }),
                            e && a().createElement('div', { className: qu }),
                        );
                    }),
                    Xu = 'Slots_base_3d',
                    Zu = 'Slots_slot_b9',
                ...
                const ee = (0, n.memo)(
                        ({ specialization: u, state: e = ue.Normal, isSelected: t, index: r, onClick: i }) => {
                            const o = (0, n.useState)(!1),
                                E = o[0],
                                s = o[1],
                                A = (0, n.useCallback)(() => {
                                    e === ue.Normal && (q('yes1'), i(r));
                                }, [r, i, e]),
                                l = (0, n.useCallback)(() => {
                                    (e === ue.Normal && q('highlight'), s(!0));
                                }, [e]),
                                F = (0, n.useCallback)(() => {
                                    s(!1);
                                }, []),
                                c = (0, n.useMemo)(() => {
                                    const t = (e === ue.Normal && E) || e === ue.Active ? 'on' : 'off',
                                        n = `extra_large_${u}_${t}`;
                                    return {
                                        backgroundImage: `url(${R.images.gui.maps.icons.specialization.$dyn(n)})`,
                                    };
                                }, [E, u, e]),
                                D = K()(Ju.base, Ju[`base__${e}`]);
                            return a().createElement(
                                'div',
                    ...
                    ne = 'Cards_card_c8',
                    ae = (u, e, t, n, a, r) =>
                        'notPossible' === t ? (n ? (a(r), ue.Active) : ue.Disabled) : u === e ? ue.Active : ue.Normal,
                    re = ({
                        availableSpecs: u,
                        activeCardIdx: e,
                        ...
                        a().createElement(
                            ...
                            u.map(({ value: u }, o) =>
                                a().createElement(
                                    'div',
                                    { key: u.id, className: ne },
                                    a().createElement(ee, {
                                        specialization: u.specialization,
                                        state: ae(o, e, r, !i && o === n, t, n),
                                        isSelected: !i && o === n,
                                        onClick: t,
                                        index: o,
                                    }),
                    ...
                    ie = 'DialogContent_base_c6',
                    oe = 'DialogContent_title_66',
                    Ee = 'DialogContent_base__small_e7',
                    se = 'DialogContent_slots_99',
                    Ae = 'DialogContent_cards_17';
                function le() {
                    return (
                        (le =
                            Object.assign ||
                ...
                const Fe = R.strings.veh_post_progression.selectSlotSpecDialog,
                    ce = ({ currentlySelectedSpecIdx: u, activeCardIdx: e, onActiveCardChange: t }) => {
                        const r = $('model').mainContent,
                            i = (0, n.useContext)(D),
                        ...
                        return a().createElement(
                            'div',
                            { className: E },
                            a().createElement(zu, le({}, r.vehicleInfo, { isSmall: o })),
                            a().createElement(Nu, { text: Fe.title.buyNotRequiredPanel(), classMix: oe }),
                            a().createElement(
                                'div',
                                { className: se },
                                a().createElement(Qu, {
                    ...
                    De = R.strings.veh_post_progression.selectSlotSpecDialog,
                    Be = () => {
                        ...
                        const o = (0, n.useCallback)((u) => {
                            ...
                            A = (0, n.useMemo)(() => ({ size: s, type: h.primary, disabled: e.current === r }), [r, s]),
                            l = (0, n.useMemo)(() => ({ size: s, type: h.secondary }), [s]);
                        return a().createElement(Pu, {
                            parentId: 'select-slot-spec',
                            buttonAccept: A,
                            buttonAcceptText: De.acceptButton.buyNotRequiredPanel(),
                            buttonCancel: l,
                            buttonCancelText: De.cancelButton(),
                            disabledAcceptTooltipText: null,
                            showPayInfo: !1,
                            content: a().createElement(ce, {
                ...
                engine.whenReady.then(() => {
                    g().render(
                        a().createElement(_, null, a().createElement(Be, null)),
