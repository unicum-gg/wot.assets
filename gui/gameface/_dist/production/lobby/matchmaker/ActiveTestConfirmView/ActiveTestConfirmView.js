(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                t.d(e, { O: () => j });
                var A = {};
                (t.r(A), t.d(A, { mouse: () => i, onResize: () => o }));
                var E = {};
                (t.r(E),
                    t.d(E, {
                        events: () => A,
                ...
                var F = {};
                (t.r(F), t.d(F, { getBgUrl: () => c, getTextureUrl: () => _ }));
                var n = {};
                function D(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            364: (u, e, t) => {
                t.d(e, { Sw: () => F.Z, kH: () => B, Z5: () => n, lf: () => i, cy: () => D, ry: () => d });
                class A {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
                ...
                function c(u, e, t, A, E, F, n) {
                    ...
                    D.done ? e(a) : Promise.resolve(a).then(A, E);
                }
            ...
            355: (u, e, t) => {
                ...
                const i = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    s = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const A = a(`${u}.${t}`, window);
                                return i(A) ? e(u, t, A) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    C = (u) => {
                        const e = ((u) => {
                                const e = D(),
                                ...
                                return { modelPrefix: E, modelPath: B(E, u || ''), resId: A };
                            })(),
                            t = e.modelPrefix,
                            A = u.split('.');
                        if (A.length > 0) {
                            ...
                            return (
                                A.reduce((e, A) => {
                                    const E = a(B(t, `${e}.${A}`), window);
                                    return i(E) ? (u.push(E.id), `${e}.${A}.value`) : (u.push(A), `${e}.${A}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        o(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    A = C(u);
                                v.current = _.addCallback(A, t, r, e === c.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== c.None)
                ...
                class b extends E().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            s = m()(h.base, h[`base__${n}`], h[`base__${F}`], null == D ? void 0 : D.base),
                            C = m()(h.icon, h[`icon__${n}`], h[`icon__${F}`], null == D ? void 0 : D.icon),
                            _ = m()(h.glow, null == D ? void 0 : D.glow),
                            c = m()(h.caption, h[`caption__${n}`], null == D ? void 0 : D.caption),
                            l = m()(h.goto, null == D ? void 0 : D.goto);
                        return E().createElement(
                            ...
                            w(
                                {
                                    ...
                                    onMouseDown: this._onMouseDown(r),
                            ...
                            'info' !== n && E().createElement('div', { className: h.shine }),
                            E().createElement('div', { className: C }, E().createElement('div', { className: _ })),
                            E().createElement('div', { className: c }, e),
                            A && E().createElement('div', { className: l }, A),
                        );
                    }
                }
                let g;
                ...
                const T = (u, e, t) => {
                    ...
                    y = (u, e, t = g.left) => u.split(e).reduce(t === g.left ? T : O, []),
                    k = (() => {
                        const u = new RegExp(
                        ...
                        return M.includes(t)
                            ...
                            : ((u, e = g.left) => {
                                  ...
                                  const A =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (y(E, /( )/, e).forEach((u) => (t = t.concat(y(u, A, g.left)))), t);
                              })(u, e);
                    },
                    x = 'FormatText_base_d0',
                    P = ({ binding: u, text: e = '', classMix: t, alignment: F = g.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, n) =>
                                      E().createElement(
                                          'div',
                                          { className: m()(x, t), key: `${e}-${n}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : N(u, e))))(e, F, u).map((u, e) =>
                ...
                const L = (u, e, t) => {
                        switch (e) {
                            case S.SHORT_DATE:
                                return t
                                    ? r.Z5.getDateFormat(u, r.kH.SHORT_FORMAT)
                                    : r.cy.getTimeFormat('%d.%m.%y', u, !0);
                            case S.SHORT_TIME:
                                return t
                                    ? r.Z5.getTimeFormat(u, r.lf.SHORT_FORMAT)
                                    : r.cy.getTimeFormat('%I:%M %p', u, !0);
                            case S.SHORT_DATE_TIME:
                                if (t) {
                                    return `${r.Z5.getDateFormat(u, r.kH.SHORT_FORMAT)}, ${r.Z5.getTimeFormat(u, r.lf.SHORT_FORMAT)}`;
                                }
                                return r.cy.getTimeFormat('%d.%m.%y, %I:%M %p', u, !0);
                            case S.FULL_DATE:
                                return t
                                    ? r.Z5.getDateFormat(u, r.kH.LONG_FORMAT)
                                    : r.cy.getTimeFormat('%B %d, %Y', u, !0);
                            case S.FULL_DATE_TIME:
                                if (t) {
                                    return `${r.Z5.getDateFormat(u, r.kH.LONG_FORMAT)}, ${r.Z5.getTimeFormat(u, r.lf.SHORT_FORMAT)}`;
                                }
                                return r.cy.getTimeFormat('%B %d, %Y, %I:%M %p', u, !0);
                            case S.MONTH:
                                return r.cy.getTimeFormat('%B', u, !0);
                            case S.MONTH_DATE:
                                return r.cy.getTimeFormat('%B %e', u, !0);
                            case S.DATE_MONTH:
                                return r.cy.getTimeFormat('%e %B', u, !0);
                            case S.MONTH_YEAR:
                                return r.cy.getTimeFormat('%B %Y', u, !0);
                            case S.WEEK_DAY:
                                return r.cy.getTimeFormat('%A', u, !0);
                            case S.WEEK_DAY_TIME:
                                if (t) {
                                    return `${r.cy.getTimeFormat('%A', u, !0)} ${r.Z5.getTimeFormat(u, r.lf.SHORT_FORMAT)}`;
                                }
                                return r.cy.getTimeFormat('%A, %I:%M %p', u, !0);
                            case S.YEAR:
                                return r.cy.getTimeFormat('%Y', u, !0);
                            case S.DATE_YEAR:
                                return r.cy.getTimeFormat('%d, %Y', u, !0);
                        }
                    },
                    H = {
                        paragraph: 'Content_paragraph_5c',
                        highlighted: 'Content_highlighted_ab',
                        link: 'Content_link_37',
                        linkIcon: 'Content_linkIcon_8d',
                    },
                    ...
                    K = (u, e) => ({
                        timerange: E().createElement(
                            ...
                            f(U.timerange(), {
                                rangeStart: L(u, S.SHORT_DATE_TIME, !1),
                                rangeEnd: L(e, S.SHORT_DATE_TIME, !1),
                            }),
                        ),
                    }),
                    ...
                    Y = () => {
                        const u = l('model'),
                            ...
                            t = u.timeRangeStart,
                            F = u.timeRangeEnd,
                            n = u.onOpenPortalClicked,
                            D = (0, A.useCallback)(() => n(), [n]);
                        return E().createElement(
                            'div',
                            { className: H.base },
                            E().createElement(
                                ...
                                E().createElement(P, {
                                    ...
                                    binding: {
                                        playersNumber: E().createElement(
                                            'div',
                                            { className: H.highlighted },
                                            f(U.playersNumber(), { number: 10 }),
                                        ),
                                        vehicleLevel: E().createElement(
                                            'div',
                                            { className: H.highlighted },
                                            U.vehicleLevel.$dyn('c_10'),
                                        ),
                                    },
                                }),
                            ),
                                    ...
                                    binding:
                                        ((a = D),
                                        {
                                            link: E().createElement(
                                                'div',
                                                { className: H.link, onClick: a },
                                                U.linkText(),
                                                E().createElement('div', { className: H.linkIcon }),
                                            ),
                                        }),
                                }),
                            ),
                    ...
                    const c = (0, A.useRef)(null),
                        ...
                        L = m()(
                            ...
                            j[`base__${F}`],
                            {
                                ...
                                [j[`base__${e}`]]: e,
                                [j.base__focus]: d,
                                [j.base__highlightActive]: w,
                                [j.base__firstHover]: f,
                            },
                            D,
                        ),
                        H = m()(j.state, j.state__default);
                    return (
                        (0, A.useEffect)(
                            () => (
                        ...
                        E().createElement(
                            ...
                            F !== q.ghost &&
                                E().createElement(
                                    E().Fragment,
                                    null,
                                    E().createElement('div', { className: j.back }),
                                    E().createElement('span', { className: j.texture }),
                                ),
                            E().createElement(
                                'span',
                                { className: H },
                                E().createElement('span', { className: j.stateDisabled }),
                                E().createElement('span', { className: j.stateHighlightHover }),
                                E().createElement('span', { className: j.stateHighlightActive }),
                            ),
                            E().createElement(
                                'span',
                ...
                const Q = (0, A.memo)(X),
                    J = 'Control_base_d7',
                    uu = 'Control_background_88',
                    eu = 'Control_border_d4',
                    tu = 'Control_border__bottom_a3',
                    Au = 'Control_button_0b',
                    Eu = R.strings.matchmaker.testConfirmation,
                    Fu = m()(eu, tu),
                    nu = () => {
                        const u = l('model'),
                            e = u.onAcceptClicked,
                        ...
                        return (
                            ...
                            E().createElement(
                                ...
                                E().createElement(
                                    Q,
                                    { mixClass: Au, type: q.main, size: Z.medium, onClick: F },
                                    Eu.applyButton(),
                                ),
                                E().createElement(
                                    Q,
                                    { mixClass: Au, type: q.primary, size: Z.medium, onClick: n },
                                    Eu.cancelButton(),
                                ),
                            )
                        );
                    ...
                    Du = 'App_base_48',
                    au = 'App_closeButton_e5',
                    ou = 'App_titleWrapper_9f',
                    ru = 'App_glow_40',
                    iu = 'App_level_d5',
                    Bu = 'App_title_2c',
                    su = 'App_content_da',
                    Cu = 'App_control_2f',
                    _u = R.strings.matchmaker.testConfirmation,
                    cu = () => {
                        const u = l('model').onCancelClicked,
                            e = (0, A.useCallback)(() => u(), [u]);
                        return E().createElement(
                            'div',
                            { className: Du },
                            E().createElement(
                ...
                engine.whenReady.then(() => {
                    n().render(E().createElement(cu, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, t, A) => {
            if (!e) {
                ...
                for (a = 0; a < deferred.length; a++) {
                    for (var [e, t, A] = deferred[a], F = !0, n = 0; n < e.length; n++)
                        (!1 & A || E >= A) &&
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); a < F.length; a++)
                        ((E = F[a]), __webpack_require__.o(u, E) && u[E] && u[E][0](), (u[E] = 0));
                    return __webpack_require__.O(o);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
        })());
    var __webpack_exports__ = __webpack_require__.O(void 0, [784], () => __webpack_require__(355));
