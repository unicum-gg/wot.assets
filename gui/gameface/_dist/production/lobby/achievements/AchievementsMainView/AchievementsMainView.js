(() => {
    var __webpack_modules__ = {
            3495: (e, t, r) => {
                ...
                const o = a.O.client.getSize('rem'),
                    l = o.width,
                    d = o.height,
                    c = Object.assign({ width: l, height: d }, (0, s.T)(l, d, n.j)),
                    u = (0, i.createContext)(c);
            },
            1039: (e, t, r) => {
                'use strict';
                r.d(t, { Z: () => c });
                    ...
                    const t = (0, a.useContext)(s.Y),
                        ...
                        _ = (0, a.useCallback)((e, t) => {
                            const r = d.O.view.pxToRem(e),
                                a = d.O.view.pxToRem(t);
                            u(Object.assign({ width: r, height: a }, (0, l.T)(r, a, o.j)));
                        }, []);
                    (0, n.Z)(() => {
                        engine.on('clientResized', _);
                    }),
                        (0, a.useEffect)(() => () => engine.off('clientResized', _), [_]);
                    const h = (0, a.useMemo)(() => Object.assign({}, c), [c]);
                    return i().createElement(s.Y.Provider, { value: h }, e);
                });
            },
            6010: (e, t, r) => {
                'use strict';
                ...
                const o = (e) => {
                    ...
                    if (r.extraLarge || r.large || r.medium || r.small || r.extraSmall) {
                        ...
                        if (r.smallWidth && E) return (0, i.H)(t, r, x);
                        if (r.extraSmallWidth && v) return (0, i.H)(t, r, x);
                        if (
            ...
            3215: (e, t, r) => {
                ...
                const l = () => (e, t) => {
                    ...
                    return [
                        function ({ mode: l = 'real', options: d, children: c, mocks: u }) {
                            const _ = (0, n.useRef)([]),
                                h = (r, n, s) => {
                                    var l;
                                    const d = o.U(n),
                                        ...
                                        u = (e) =>
                                            'mocks' === r ? (null == s ? void 0 : s.getter(e)) : c.readByPath(e),
                                        ...
                                        g = { mode: r, model: m, externalModel: c, cleanup: h };
                                    return {
                                        model: m,
                                ...
                                E = g[0],
                                v = g[1],
                                w = (0, n.useState)(() => h(l, d, u)),
                                f = w[0],
                                b = w[1];
                            return (
                                (0, n.useEffect)(() => {
                                    m.current ? b(h(E, d, u)) : (m.current = !0);
                                }, [u, E, d]),
                                (0, n.useEffect)(() => {
                                    v(l);
                                }, [l]),
                                ...
                                s().createElement(r.Provider, { value: f }, c)
                            );
                        },
                        () => (0, n.useContext)(r),
                    ];
            ...
            527: (e, t, r) => {
                'use strict';
                r.r(t), r.d(t, { mouse: () => o, onResize: () => n });
                var a = r(2472),
                    i = r(1176);
            ...
            5415: (e, t, r) => {
                ...
                const d = () => {
                    ...
                    return { mediaSize: n, mediaWidth: d, mediaHeight: c, remScreenWidth: t, remScreenHeight: r };
                };
            },
            5521: (e, t, r) => {
                'use strict';
            ...
            1988: (e, t, r) => {
                ...
                const f = {
                        [E.fd.ExtraSmall]: '',
                        [E.fd.Small]: g().SMALL_WIDTH,
                        [E.fd.Medium]: `${g().SMALL_WIDTH} ${g().MEDIUM_WIDTH}`,
                        [E.fd.Large]: `${g().SMALL_WIDTH} ${g().MEDIUM_WIDTH} ${g().LARGE_WIDTH}`,
                        [E.fd.ExtraLarge]:
                            `${g().SMALL_WIDTH} ${g().MEDIUM_WIDTH} ${g().LARGE_WIDTH} ${g().EXTRA_LARGE_WIDTH}`,
                    },
                    b = {
                        [E.Aq.ExtraSmall]: '',
                        [E.Aq.Small]: g().SMALL_HEIGHT,
                        [E.Aq.Medium]: `${g().SMALL_HEIGHT} ${g().MEDIUM_HEIGHT}`,
                        [E.Aq.Large]: `${g().SMALL_HEIGHT} ${g().MEDIUM_HEIGHT} ${g().LARGE_HEIGHT}`,
                        [E.Aq.ExtraLarge]:
                    ...
                    p = {
                        [E.cJ.ExtraSmall]: '',
                        [E.cJ.Small]: g().SMALL,
                        [E.cJ.Medium]: `${g().SMALL} ${g().MEDIUM}`,
                        [E.cJ.Large]: `${g().SMALL} ${g().MEDIUM} ${g().LARGE}`,
                        [E.cJ.ExtraLarge]: `${g().SMALL} ${g().MEDIUM} ${g().LARGE} ${g().EXTRA_LARGE}`,
                    },
                    L = (e) => {
                        let t = e.children,
                            r = e.className,
                ...
                const O = (0, a.lazy)(() => Promise.all([r.e(549), r.e(312)]).then(r.bind(r, 8312))),
                    T = { [y.SUMMARY]: O },
                    k = i().memo(({ viewType: e }) => {
                        const t = T[e];
                        return t
                ...
                const P = (0, r(3215).q)()(
                        ({ observableModel: e }) => {
                            const t = { root: e.object(), summaryModel: e.object('summaryModel') };
                    ...
                    C = (0, M.Pi)(() => {
                        ...
                        return (
                            ...
                            c(l.n.ESCAPE, o),
                            s
                                ? i().createElement('div', { className: A }, i().createElement(k, { viewType: n }))
                                : i().createElement(
                                      S,
                                      null,
                                      i().createElement('div', { className: A }, i().createElement(k, { viewType: n })),
                ...
                engine.whenReady.then(() => {
                    s().render(i().createElement(R, null, i().createElement(C, null)), document.getElementById('root'));
                });
            },
        },
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.u = (e) => {
            if (312 === e) return 'chunks/lobby/1bb93e5d5349133b6e1f.js';
        }),
        (__webpack_require__.miniCssF = (e) =>
            312 === e
                ? 'chunks/lobby/1bb93e5d5349133b6e1f.css'
        ...
        (__webpack_require__.l = (e, t, r, a) => {
            if (inProgress[e]) inProgress[e].push(t);
                ...
                var d = (t, r) => {
                    ...
                    c = setTimeout(d.bind(null, void 0, { type: 'timeout', target: i }), 12e4);
