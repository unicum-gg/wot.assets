    ...
    var u,
        e = {
            8095: (u, e, F) => {
                var A = {};
                (F.r(A),
                    F.d(A, { mouse: () => f, off: () => g, on: () => d, onResize: () => l, onScaleUpdated: () => c }));
                var E = {};
                (F.r(E),
                    F.d(E, {
                        events: () => A,
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => z, getTextureUrl: () => k }));
                var t = {};
                (F.r(t),
                    F.d(t, {
                        addModelObserver: () => Q,
                ...
                const b = {
                    ...
                    _ = Object.keys(y).reduce((u, e) => ((u[e] = () => v(y[e])), u), {}),
                    T = { play: Object.assign({}, _, { sound: v }), setRTPC: p },
                    S = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    P = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function O(u) {
                    let e = '';
                    for (let F = P.length - 1; F >= 0; F--) for (; u >= P[F]; ) ((e += S[F]), (u -= P[F]));
                    return e;
                }
                ...
                const iu = Object.keys(M).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === M[e]), u), {}),
                    au = {
                        set: (u, e) => {
                ...
                const du = { view: t, client: E, sound: T, intl: x };
                function gu() {
                ...
                const pu = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            ...
                            n().createElement('div', { className: mu.decorator }, F),
                        )
                    );
                });
                var hu = F(1281);
                ...
                const xu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Tu = (u, e, F = wu.left) => u.split(e).reduce(F === wu.left ? yu : _u, []),
                    Su = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Ou = (u, e = wu.left) => {
                        ...
                        return ((u, e = wu.left) => {
                            ...
                            const A =
                                ...
                                E = xu(u);
                            return (Tu(E, /( )/, e).forEach((u) => (F = F.concat(Tu(u, A, wu.left)))), F);
                        })(u, e);
                    },
                    Ru = 'FormatText_base_d0',
                    ku = ({ binding: u, text: e = '', classMix: F, alignment: A = wu.left, formatWithBrackets: E }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const D = E && u ? bu(e, u) : e;
                        return n().createElement(
                            ...
                            D.split('\n').map((e, E) =>
                                n().createElement(
                                    'div',
                                    { className: i()(Ru, F), key: `${e}-${E}` },
                                    ((u, e, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : Ou(u, e))))(
                                        e,
                                        A,
                                        u,
                    ...
                    Wu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    ju = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Lu = (0, B.memo)(({ text: u, binding: e, classMix: F }) => {
                                ...
                                ((t = t.replace(F, `%(${D})`)),
                                    (E[D] = zu[u]
                                        ? n().createElement(
                                              'span',
                                              { className: zu[u] },
                                              n().createElement(ku, { text: o, binding: e }),
                                          )
                                        : n().createElement(
                                              'span',
                                              { style: A(u) },
                        ...
                        return n().createElement(ku, { text: t, classMix: F, binding: E });
                    });
                const $u = function () {};
                function Vu() {
                    return !1;
                ...
                const Hu = ((u, e) => {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const B = 'string' == typeof D ? `${A}.${D}` : A,
                                                            n = du.view.addModelObserver(B, e, !0);
                    ...
                    })(({ observableModel: u }) => ({ root: u.object() }), $u),
                    qu = Hu[0],
                    Qu = Hu[1],
                    Xu = 'App_base_29',
                    Zu = 'App_section_66',
                    ...
                    Ku = 'App_divider_6e',
                    Yu = 'App_footer_0d',
                    ue = R.strings.achievements_page.tooltips.autoSetting,
                    ee = () => {
                        const u = Qu().model.root.get().isSwitchedOn;
                        return n().createElement(
                            pu,
                            null,
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    { className: Zu },
                                    n().createElement('div', { className: Ju }, ue.title()),
                                    n().createElement(Lu, { text: ue.description() }),
                                ),
                                ...
                                n().createElement(
                                    ...
                                    { className: Yu },
                                    u
                                        ? n().createElement(Lu, { text: ue.caption.isSwitchedOn() })
                                        : n().createElement(Lu, { text: ue.caption.isSwitchedOff() }),
                                ),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    r().render(
                        n().createElement(qu, null, n().createElement(ee, null)),
