    ...
    var u,
        F = {
            1627: (u, F, A) => {
                var e = {};
                A.r(e),
                    A.d(e, { mouse: () => v, off: () => m, on: () => d, onResize: () => l, onScaleUpdated: () => c });
                var E = {};
                A.r(E),
                    A.d(E, {
                        events: () => e,
                ...
                const b = {
                    ...
                    _ = { play: Object.assign({}, y, { sound: f }), setRTPC: p };
                function T(u, F, A = 1) {
                ...
                const Bu = (() => {
                    ...
                    tu = Object.keys(O).reduce((u, F) => ((u[F] = () => viewEnv.getShowingStatus() === O[F]), u), {}),
                    Cu = {
                        set: (u, F) => {
                ...
                const gu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    yu = ({ binding: u, text: F = '', classMix: A, alignment: e = du.left, formatWithBrackets: E }) => {
                        ...
                        return C().createElement(
                            ...
                            D.split('\n').map((F, E) =>
                                C().createElement(
                                    'div',
                                    { className: i()(xu, A), key: `${F}-${E}` },
                                    ((u, F, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : bu(u, F))))(
                                        F,
                                        e,
                                        u,
                                ...
                                (B = B.replace(A, `%(${D})`)),
                                    (E[D] = _u[u]
                                        ? C().createElement(
                                              'span',
                                              { className: _u[u] },
                                              C().createElement(yu, { text: o, binding: F }),
                                          )
                                        : C().createElement(
                                              'span',
                                              { style: e(u) },
                ...
                function Wu(u, F) {
                    ...
                    if (
                        ...
                        (A = (function (u, F) {
                            if (u) {
                                if ('string' == typeof u) return Mu(u, F);
                ...
                const Lu = ((u, F) => {
                    ...
                    Hu = 'App_divider_6e',
                    Uu = 'App_footer_0d',
                    qu = R.strings.achievements_page.tooltips.autoSetting,
                    Qu = () => {
                        const u = Vu().model.root.get().isSwitchedOn;
                        return C().createElement(
                            lu,
                            null,
                            C().createElement(
