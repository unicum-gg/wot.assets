    ...
    var u,
        e = {
            3525: (u, e, F) => {
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => M, getTextureUrl: () => k }));
                var t = {};
                (F.r(t),
                    F.d(t, {
                        addModelObserver: () => Z,
                ...
                const w = {
                    ...
                    T = Object.keys(_).reduce((u, e) => ((u[e] = () => p(_[e])), u), {}),
                    S = { play: Object.assign({}, T, { sound: p }), setRTPC: h },
                ...
                const su = Object.keys(W).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === W[e]), u), {}),
                    lu = {
                        set: (u, e) => {
                ...
                const fu = { view: t, client: E, sound: S, intl: y };
                const mu = {
                ...
                const hu = C().forwardRef(function (u, e) {
                    let F = u.children,
                        A = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        C().createElement(
                            'div',
                            pu({}, t, {
                                className: i()(mu.base, mu[`base__theme-${D}`], A),
                                ref: function (u) {
                                    ((n.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            C().createElement('div', { className: mu.decorator }, F),
                        )
                    );
                });
                var bu = F(8354);
                ...
                const yu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Su = (u, e, F = xu.left) => u.split(e).reduce(F === xu.left ? _u : Tu, []),
                    Pu = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Ru = (u, e = xu.left) => {
                        ...
                        return ((u, e = xu.left) => {
                            ...
                            const A =
                                ...
                                E = yu(u);
                            return (Su(E, /( )/, e).forEach((u) => (F = F.concat(Su(u, A, xu.left)))), F);
                        })(u, e);
                    },
                    zu = 'FormatText_base_f27a4',
                    ku = ({ binding: u, text: e = '', classMix: F, alignment: A = xu.left, formatWithBrackets: E }) => {
                        ...
                        return C().createElement(
                            ...
                            D.split('\n').map((e, E) =>
                                C().createElement(
                                    'div',
                                    { className: i()(zu, F), key: `${e}-${E}` },
                                    ((u, e, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : Ru(u, e))))(
                                        e,
                                        A,
                                        u,
                                    ).map((u, e) => C().createElement(B.Fragment, { key: `${e}-${u}` }, u)),
                                ),
                            ),
                        );
                    },
                    ...
                    ju = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Lu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    $u = (0, B.memo)(({ text: u, binding: e, classMix: F }) => {
                                ...
                                ((t = t.replace(F, `%(${D})`)),
                                    (E[D] = Mu[u]
                                        ? C().createElement(
                                              'span',
                                              { className: Mu[u] },
                                              C().createElement(ku, { text: o, binding: e }),
                                          )
                                        : C().createElement(
                                              'span',
                                              { style: A(u) },
                        ...
                        return C().createElement(ku, { text: t, classMix: F, binding: E });
                    });
                const Vu = function () {};
                function Nu() {
                    return !1;
                ...
                const qu = ((u, e) => {
                                        ...
                                        const t = (function ({
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const B = 'string' == typeof D ? `${A}.${D}` : A,
                                                            C = fu.view.addModelObserver(B, e, !0);
                                                        return (E.set(C, F), u && F(t(D)), C);
                                                    },
                                                    readByPath: t,
                                                    createCallback: (u, e) => {
                                                        const F = t(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = Iu(E.keys()); !(u = F()).done; ) D(u.value, e);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(A),
                                            ...
                                            o = u({
                                                ...
                                                observableModel: {
                                                    ...
                                                    array: (u, e) => {
                                                        const A = null != e ? e : C(u),
                                                            E = Gu.LO.box(A, { equals: Nu });
                                                        return (
                                                            'real' === F &&
                                                                B.subscribe(
                                                                    (0, Gu.aD)((u) => E.set(u)),
                                            ...
                                            i = { mode: F, model: o, externalModel: B, cleanup: r };
                                        return {
                                            model: o,
                    ...
                    Xu = qu[1],
                    Zu = 'App_base_ab398',
                    Ju = 'App_section_e71c3',
                    Ku = 'App_title_b2439',
                    Yu = 'App_divider_d2d7d',
                    ue = 'App_footer_fb4a9',
                    ee = R.strings.achievements_page.tooltips.autoSetting,
                    Fe = () => {
                        const u = Xu().model.root.get().isSwitchedOn;
                        return C().createElement(
                            hu,
                            null,
                            C().createElement(
                                ...
                                C().createElement(
                                    'div',
                                    { className: Ju },
                                    C().createElement('div', { className: Ku }, ee.title()),
                                    C().createElement($u, { text: ee.description() }),
                                ),
                                ...
                                C().createElement(
                                    ...
                                    { className: ue },
                                    u
                                        ? C().createElement($u, { text: ee.caption.isSwitchedOn() })
                                        : C().createElement($u, { text: ee.caption.isSwitchedOff() }),
                                ),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(Qu, null, C().createElement(Fe, null)),
        ...
        (A.O = (e, F, E, D) => {
            if (!F) {
                ...
                for (r = 0; r < u.length; r++) {
                    for (var [F, E, D] = u[r], B = !0, C = 0; C < F.length; C++)
                        (!1 & D || t >= D) && Object.keys(A.O).every((u) => A.O[u](F[C]))
                            ? F.splice(C--, 1)
                            : ((B = !1), D < t && (t = D));
                    if (B) {
                        u.splice(r--, 1);
