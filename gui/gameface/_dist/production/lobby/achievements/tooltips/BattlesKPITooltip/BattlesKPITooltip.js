    ...
    var u,
        A = {
            7082: (u, A, F) => {
                var e = {};
                (F.r(e),
                    F.d(e, { mouse: () => T, off: () => S, on: () => _, onResize: () => x, onScaleUpdated: () => P }));
                var E = {};
                (F.r(E),
                    F.d(E, {
                        events: () => e,
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => W, getTextureUrl: () => q }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => Bu,
                        ...
                        setSidePaddingsRem: () => tu,
                        whenTutorialReady: () => yu,
                    }));
                var t = F(7363),
                    n = F.n(t),
                    C = F(1533),
                ...
                const c = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    m = (u, A, F = s.left) => u.split(A).reduce(F === s.left ? d : v, []),
                    f = (() => {
                        const u = new RegExp(
                            [
                    ...
                    p = (u, A = s.left) => {
                        ...
                        return ((u, A = s.left) => {
                            ...
                            const e =
                                ...
                                E = c(u);
                            return (m(E, /( )/, A).forEach((u) => (F = F.concat(m(u, e, s.left)))), F);
                        })(u, A);
                    },
                ...
                const L = {
                    ...
                    $ = Object.keys(V).reduce((u, A) => ((u[A] = () => z(V[A])), u), {}),
                    G = { play: Object.assign({}, $, { sound: z }), setRTPC: j },
                    I = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    U = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function H(u) {
                    let A = '';
                    for (let F = U.length - 1; F >= 0; F--) for (; u >= U[F]; ) ((A += I[F]), (u -= U[F]));
                    return A;
                }
                ...
                const wu = Object.keys(Q).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === Q[A]), u), {}),
                    hu = {
                        set: (u, A) => {
                ...
                const _u = { view: B, client: E, sound: G, intl: N };
                function Ru() {
                ...
                const zu = n().forwardRef(function (u, A) {
                    let F = u.children,
                        e = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            ...
                            n().createElement('div', { className: Su.decorator }, F),
                        )
                    );
                });
                var ju = F(3403);
                ...
                const Gu = ((u, A) => {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const t = 'string' == typeof D ? `${e}.${D}` : e,
                                                            n = _u.view.addModelObserver(t, A, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = Nu(E.keys()); !(u = F()).done; ) D(u.value, A);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(e),
                    ...
                    })(({ observableModel: u }) => ({ root: u.object() }), Mu),
                    Iu = Gu[0],
                    Uu = Gu[1],
                    Hu = 'App_base_99',
                    qu = 'App_bottomBlock_5e',
                    Wu = 'App_topBlock_67',
                    Qu = 'App_divider_31',
                    Xu = 'App_titleBLock_f7',
                    Zu = 'App_amount_18',
                    Ku = 'App_description_3c',
                    Ju = 'App_stats_7e',
                    Yu = R.strings.achievements_page.tooltips.KPI.battles,
                    uA = (0, ju.Pi)(() => {
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(w, {
                                            text: Yu.title.top(),
                                            binding: { count: n().createElement('div', { className: Zu }, A) },
                                        }),
                                    ),
                                    n().createElement('div', { className: Ku }, Yu.description.top.base()),
                                    n().createElement(w, {
                                        classMix: Ju,
                                        text: Yu.description.top.stats(),
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        { className: Xu },
                                        n().createElement(w, {
                                            text: Yu.title.bottom(),
                                            binding: { percent: n().createElement('div', { className: Zu }, D) },
                                        }),
                                    ),
                                    n().createElement('div', { className: Ku }, Yu.description.bottom()),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        n().createElement(Iu, null, n().createElement(uA, null)),
