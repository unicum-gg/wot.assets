(() => {
    ...
    var u,
        A = {
            6977: (u, A, F) => {
                var E = {};
                (F.r(E), F.d(E, { mouse: () => x, onResize: () => w }));
                var e = {};
                (F.r(e),
                    F.d(e, {
                        events: () => E,
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => T, getTextureUrl: () => O }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => q,
                ...
                const s = (u, A, F) => {
                    ...
                    g = ({ binding: u, text: A = '', classMix: F, alignment: E = a.left }) =>
                        null === A
                            ...
                            : t().createElement(
                                  ...
                                  A.split('\n').map((A, e) =>
                                      t().createElement(
                                          'div',
                                          { className: i()(f, F), key: `${A}-${e}` },
                                          ((u, A, F) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (F && u in F ? F[u] : m(u, A))))(A, E, u).map((u, A) =>
                                              t().createElement(C.Fragment, { key: `${A}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              );
                ...
                const w = p('clientResized'),
                    h = { down: p('mousedown'), up: p('mouseup'), move: p('mousemove') };
                const x = (function () {
                ...
                const Cu = Object.keys(S).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === S[A]), u), {}),
                    tu = {
                        set: (u, A) => {
                ...
                const cu = t().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        t().createElement(
                            ...
                            t().createElement('div', { className: iu.decorator }, F),
                        )
                    );
                });
                var lu = F(3403);
                ...
                const bu = ((u, A) => {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            t = ru.view.addModelObserver(C, A, !0);
                    ...
                    hu = bu[1],
                    xu = 'App_base_99',
                    yu = 'App_bottomBlock_5e',
                    _u = 'App_topBlock_67',
                    Pu = 'App_divider_31',
                    Ou = 'App_titleBLock_f7',
                    Ru = 'App_amount_18',
                    Tu = 'App_description_3c',
                    Su = 'App_stats_7e',
                    zu = R.strings.achievements_page.tooltips.KPI.battles,
                    ju = (0, lu.Pi)(() => {
                            ...
                            t().createElement(
                                ...
                                t().createElement(
                                    ...
                                    t().createElement(
                                        ...
                                        t().createElement(g, {
                                            text: zu.title.top(),
                                            binding: { count: t().createElement('div', { className: Ru }, A) },
                                        }),
                                    ),
                                    t().createElement('div', { className: Tu }, zu.description.top.base()),
                                    t().createElement(g, {
                                        classMix: Su,
                                        text: zu.description.top.stats(),
                                ...
                                t().createElement(
                                    'div',
                                    { className: yu },
                                    t().createElement('div', { className: Pu }),
                                    t().createElement(
                                        'div',
                                        { className: Ou },
                                        t().createElement(g, {
                                            text: zu.title.bottom(),
                                            binding: { percent: t().createElement('div', { className: Ru }, D) },
                                        }),
                                    ),
                                    t().createElement('div', { className: Tu }, zu.description.bottom()),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        t().createElement(wu, null, t().createElement(ju, null)),
