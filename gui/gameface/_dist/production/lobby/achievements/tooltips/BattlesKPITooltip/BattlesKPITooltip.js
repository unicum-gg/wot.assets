    ...
    var u,
        A = {
            9818: (u, A, F) => {
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => Q, getTextureUrl: () => W }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => Cu,
                        ...
                        displayStatus: () => X,
                        displayStatusIs: () => yu,
                        enableFullScreenModeSupported: () => _u,
                        events: () => Z,
                        extraSize: () => xu,
                        forceTriggerMouseMove: () => gu,
                ...
                const c = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    f = (u, A, F = s.left) => u.split(A).reduce(F === s.left ? d : v, []),
                    m = (() => {
                        const u = new RegExp(
                            [
                    ...
                    p = (u, A = s.left) => {
                        ...
                        return ((u, A = s.left) => {
                            ...
                            const e =
                                ...
                                E = c(u);
                            return (f(E, /( )/, A).forEach((u) => (F = F.concat(f(u, e, s.left)))), F);
                        })(u, A);
                    },
                        ...
                        return C().createElement(
                            ...
                            D.split('\n').map((A, E) =>
                                C().createElement(
                                    ...
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : p(u, A))))(
                                        A,
                                        e,
                                        u,
                                    ).map((u, A) => C().createElement(t.Fragment, { key: `${A}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                ...
                const N = {
                    ...
                    $ = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    G = Object.keys($).reduce((u, A) => ((u[A] = () => M($[A])), u), {}),
                    I = { play: Object.assign({}, G, { sound: M }), setRTPC: j },
                    U = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    H = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function q(u) {
                    let A = '';
                    for (let F = H.length - 1; F >= 0; F--) for (; u >= H[F];) ((A += U[F]), (u -= H[F]));
                    return A;
                }
                ...
                const yu = Object.keys(X).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === X[A]), u), {}),
                    xu = {
                        set: (u, A) => {
                ...
                const Su = { view: B, client: E, sound: I, intl: V };
                const Ou = {
                ...
                const Mu = C().forwardRef(function (u, A) {
                    let F = u.children,
                        e = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        C().createElement(
                            'div',
                            zu({}, B, {
                                className: i()(Ou.base, Ou[`base__theme-${D}`], e),
                                ref: function (u) {
                                    ((n.current = u), 'function' == typeof A ? A(u) : A && (A.current = u));
                                },
                            }),
                            C().createElement('div', { className: Ou.decorator }, F),
                        )
                    );
                });
                var ju = F(2041);
                ...
                const Iu = ((u, A) => {
                        ...
                        return [
                            function ({ mode: e = 'real', options: E, children: D, mocks: B }) {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const t = 'string' == typeof D ? `${e}.${D}` : e,
                                                            C = Su.view.addModelObserver(t, A, !0);
                                ...
                                return (
                                    ...
                                    C().createElement(F.Provider, { value: c }, D)
                                );
                            },
                            () => (0, t.useContext)(F),
                        ];
                    ...
                    Hu = Iu[1],
                    qu = 'App_base_cf4ab',
                    Wu = 'App_bottomBlock_ab332',
                    Qu = 'App_topBlock_ebcb6',
                    Xu = 'App_divider_f2daf',
                    Zu = 'App_titleBLock_ed3ca',
                    Ku = 'App_amount_fd17f',
                    Ju = 'App_description_e0c3a',
                    Yu = 'App_stats_bafc0',
                    uA = R.strings.achievements_page.tooltips.KPI.battles,
                    AA = (0, ju.Pi)(() => {
                            ...
                            C().createElement(
                                ...
                                C().createElement(
                                    ...
                                    C().createElement(
                                        ...
                                        C().createElement(w, {
                                            text: uA.title.top(),
                                            binding: { count: C().createElement('div', { className: Ku }, A) },
                                        }),
                                    ),
                                    C().createElement('div', { className: Ju }, uA.description.top.base()),
                                    C().createElement(w, {
                                        classMix: Yu,
                                        text: uA.description.top.stats(),
                                        binding: { loses: F, draws: E, wins: e },
                                    }),
                                ),
                                C().createElement(
                                    'div',
                                    { className: Wu },
                                    C().createElement('div', { className: Xu }),
                                    C().createElement(
                                        'div',
                                        { className: Zu },
                                        C().createElement(w, {
                                            text: uA.title.bottom(),
                                            binding: { percent: C().createElement('div', { className: Ku }, D) },
                                        }),
                                    ),
                                    C().createElement('div', { className: Ju }, uA.description.bottom()),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(Uu, null, C().createElement(AA, null)),
        ...
        (e.O = (A, F, E, D) => {
            if (!F) {
                ...
                for (r = 0; r < u.length; r++) {
                    for (var [F, E, D] = u[r], t = !0, C = 0; C < F.length; C++)
                        (!1 & D || B >= D) && Object.keys(e.O).every((u) => e.O[u](F[C]))
                            ? F.splice(C--, 1)
                            : ((t = !1), D < B && (B = D));
                    if (t) {
                        u.splice(r--, 1);
