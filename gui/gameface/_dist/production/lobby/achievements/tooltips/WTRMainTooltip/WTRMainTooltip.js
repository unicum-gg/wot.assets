    ...
    var __webpack_modules__ = {
            5034: (u, e, t) => {
                ...
                const A = (0, E.E)('clientResized'),
                    n = (0, E.E)('self.onScaleUpdated'),
                    r = (0, E.E)('clientMinimized'),
                    a = (u, e) => engine.on(u, e),
                    D = (u, e) => engine.off(u, e),
                    o = { down: (0, E.E)('mousedown'), up: (0, E.E)('mouseup'), move: (0, E.E)('mousemove') };
                const i = (function () {
            ...
            7475: (u, e, t) => {
                ...
                var E = t(3157),
                    F = t(8133),
                    A = t(3925);
                const n = { view: t(7553), client: E, sound: A.ZP, intl: F.N };
            },
            8133: (u, e, t) => {
                t.d(e, { N: () => E });
                const E = {
            ...
            1308: (u, e, t) => {
                ...
                function A(u) {
                    let e = '';
                    for (let t = F.length - 1; t >= 0; t--) for (; u >= F[t]; ) ((e += E[t]), (u -= F[t]));
                    return e;
                }
            ...
            8973: (u, e, t) => {
                ...
                class F {
                    ...
                    addCallback(u, e, t = 0, F = !0) {
                        ...
                        const A = E.O.view.addModelObserver(u, t, F);
                        return (
                            A > 0
                                ? ((this._callbacks[A] = e),
            ...
            828: (u, e, t) => {
                ...
                function l(u, e, t, E, F, A, n) {
                    ...
                    r.done ? e(a) : Promise.resolve(a).then(E, F);
                }
                ...
                const g = F.instance,
                    b = {
                        ...
                        sendShowContextMenuEvent: (u, e, t = 0) => {
                            _(r.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                        },
                        sendShowPopOverEvent: (u, e, t, E, F = R.invalid('resId'), A) => {
                            const n = s.O.view.getViewGlobalPosition(),
                                ...
                                B = a.height,
                                C = {
                                    x: s.O.view.pxToRem(D) + n.x,
                                    y: s.O.view.pxToRem(o) + n.y,
                            ...
                            for (const E in e)
                                if (Object.prototype.hasOwnProperty.call(e, E)) {
                                    ...
                                    if (F.startsWith('[object CoherentArrayProxy]')) {
                                        const F = e[E];
                                        t[E] = [];
                                        for (let e = 0; e < F.length; e++) t[E].push({ value: u(F[e].value) });
                                    } else
            ...
            79: (u, e, t) => {
                ...
                const s = F().forwardRef(function (u, e) {
                    let t = u.children,
                        A = u.className,
                        n = u.theme,
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            B({}, s, {
                                className: a()(o.base, o[`base__theme-${r}`], A),
                                ref: function (u) {
                                    ((C.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            F().createElement('div', { className: o.decorator }, t),
                        )
                    );
                });
                var C = t(2041);
                ...
                const g = ((u, e) => {
                        ...
                        return [
                            function ({ mode: A = 'real', options: n, children: r, mocks: a }) {
                                const o = (0, E.useRef)([]),
                                    i = (t, E, F) => {
                                        var A;
                                        const n = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, A) => {
                                                        const r = 'string' == typeof A ? `${E}.${A}` : E,
                                                            a = D.O.view.addModelObserver(r, e, !0);
                                                        return (F.set(a, t), u && t(n(A)), a);
                                                    },
                                                    readByPath: n,
                                                    createCallback: (u, e) => {
                                                        const t = n(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = _(F.keys()); !(u = t()).done; ) A(u.value, e);
                                                    },
                                                    unsubscribe: A,
                                                };
                                            })(E),
                                            ...
                                            a = (u) =>
                                                'mocks' === t ? (null == F ? void 0 : F.getter(u)) : r.readByPath(u),
                                            i = (u) => o.current.push(u),
                                            B = u({
                                                mode: t,
                                                readByPath: a,
                                                externalModel: r,
                                            ...
                                            s = { mode: t, model: B, externalModel: r, cleanup: i };
                                        return {
                                            model: B,
                                            controls: 'mocks' === t && F ? F.controls(s) : e(s),
                                            externalModel: r,
                                            mode: t,
                                        };
                                    },
                                    ...
                                    C = s[0],
                                    l = s[1],
                                    v = (0, E.useState)(() => i(A, n, a)),
                                    p = v[0],
                                    g = v[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        B.current ? g(i(C, n, a)) : (B.current = !0);
                                    }, [a, C, n]),
                                    (0, E.useEffect)(() => {
                                        l(A);
                                    }, [A]),
                                    (0, E.useEffect)(
                                        () => () => {
                                            (p.externalModel.dispose(), o.current.forEach((u) => u()));
                                        },
                                        [p],
                                    ),
                                    F().createElement(t.Provider, { value: p }, r)
                                );
                            },
                            () => (0, E.useContext)(t),
                        ];
                    })(({ observableModel: u }) => {
                        const e = { root: u.object(), ranks: u.array('ranks') },
                            t = (0, p.Om)(
                                () => {
                                    return (
                                        (u = e.ranks.get()),
                                        (t = (u) => ({ rank: u.rank, subRank: u.subRank, points: u.countOfPoints })),
                                        Array.isArray(u)
                                            ? u.map(t)
                                            : u.map((u, e, E) => t(null == u ? void 0 : u.value, e, E))
                                    );
                                    var u, t;
                                },
                                { equals: c },
                            );
                        return Object.assign({}, e, { computes: { getRankList: t } });
                    }, l),
                    b = g[0],
                    h = g[1];
                var f = t(8354);
                ...
                const x = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    P = (u, e, t = w.left) => u.split(e).reduce(t === w.left ? k : O, []),
                    M = (() => {
                        const u = new RegExp(
                            [
                    ...
                    N = (u, e = w.left) => {
                        ...
                        return ((u, e = w.left) => {
                            ...
                            const E =
                                ...
                                F = x(u);
                            return (P(F, /( )/, e).forEach((u) => (t = t.concat(P(u, E, w.left)))), t);
                        })(u, e);
                    },
                    L = 'FormatText_base_f27a4',
                    W = ({ binding: u, text: e = '', classMix: t, alignment: A = w.left, formatWithBrackets: n }) => {
                        ...
                        return F().createElement(
                            ...
                            r.split('\n').map((e, n) =>
                                F().createElement(
                                    'div',
                                    { className: a()(L, t), key: `${e}-${n}` },
                                    ((u, e, t) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : N(u, e))))(
                                        e,
                                        A,
                                        u,
                ...
                const U = {
                    ...
                    V = /(?:%\(|{)\w*(?:_[Oo]pen|Start)(?:\)s|})?(.*?)(?:%\(|{)\w*(?:_[Cc]lose|End)(?:\)s|})?/g,
                    q = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    z = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    j = (0, E.memo)(({ text: u, binding: e, classMix: t }) => {
                        const A = (0, E.useCallback)((u) => ({ color: `#${u}` }), []),
                            n = (0, E.useMemo)(() => e || {}, [e]);
                        let r = V.exec(u),
                            a = u,
                            D = 0;
                                ...
                                ((a = a.replace(t, `%(${r})`)),
                                    (n[r] = U[u]
                                        ? F().createElement(
                                              'span',
                                              { className: U[u] },
                                              F().createElement(W, { text: i, binding: e }),
                                          )
                                        : F().createElement(
                                              'span',
                                              { style: A(u) },
                        ...
                        return F().createElement(W, { text: a, classMix: t, binding: n });
                    }),
                    G = 'Description_description_ba5ea',
                    $ = 'Description_requiredBattles_f8f92',
                    H = 'Description_remaining_d037f',
                    K = R.strings.achievements_page.tooltips.WTR.rating,
                    Y = ({
                        requiredNumberOfBattles: u,
                        nextRankItem: e,
                        points: t,
                        rank: E,
                        subRank: A,
                                ...
                                switch (!0) {
                                    case 5 === E && 3 === A:
                                        return F().createElement(
                                            ...
                                            F().createElement(W, {
                                                classMix: G,
                                                text: K.description.currentLevel(),
                                                binding: {
                                                    level: T(K.levels.$dyn(`level_${E}`), { level: (0, I.HG)(A) }),
                                                },
                                            }),
                                            F().createElement('div', { className: H }, K.description.maximum()),
                                        );
                                    case !n:
                                        return F().createElement(j, {
                                            classMix: G,
                                            text: K.description.base(),
                                            binding: { amount: F().createElement('div', { className: $ }, u) },
                                        });
                                    case void 0 !== e:
                                        return F().createElement(
                                            F().Fragment,
                    ...
                    Z = (u, e) => `level_${u}_${e}`;
                var X = t(828);
                const Q = ({ value: u, format: e = 'integral' }) => {
                        const t = (function (u) {
                                return 'gold' === u ? X.B3.GOLD : X.B3.INTEGRAL;
                            })(e),
                            E = X.Z5.getNumberFormat(u, t);
                        return void 0 !== u && void 0 !== E ? E : null;
                    },
                    J = {
                        base: 'Table_base_b67bf',
                        header: 'Table_header_dee61',
                        row: 'Table_row_bfc16',
                        checkmark: 'Table_checkmark_c860a',
                        rowBackground: 'Table_rowBackground_fc5ca',
                        headerCellWrapper: 'Table_headerCellWrapper_dc45c',
                        headerCellWrapper__level: 'Table_headerCellWrapper__level_b2dc1',
                        headerCellWrapper__points: 'Table_headerCellWrapper__points_a5a89',
                        tableCell: 'Table_tableCell_d0ae5',
                        tableCell__header: 'Table_tableCell__header_a069a',
                        tableCell__row: 'Table_tableCell__row_b9368',
                        row__active: 'Table_row__active_f4648',
                        levelCell: 'Table_levelCell_fe1af',
                        levelCellImage: 'Table_levelCellImage_c531b',
                        divider: 'Table_divider_cae23',
                    },
                    uu = R.strings.achievements_page.tooltips.WTR.rating,
                    eu = R.images.gui.maps.icons.achievements,
                    tu = ({ className: u, currentSubLevelType: e, list: t }) => {
                        const E = [
                                { key: 'level', title: uu.tableHeaders.level() },
                                { key: 'points', title: uu.tableHeaders.points() },
                            ],
                            A = t.map(({ points: u, rank: e, subRank: t }) => ({
                                type: Z(e, t),
                                rank: e,
                                subRank: t,
                                points: u,
                                level: T(uu.levels.$dyn(`level_${e}`), { level: (0, I.HG)(t) }),
                            }));
                        return F().createElement(
                            'div',
                            { className: a()(J.base, u) },
                            F().createElement(
                                'div',
                                { className: J.header },
                                null == E
                                    ...
                                    : E.map((u) =>
                                          F().createElement(
                                              'div',
                                              {
                                                  className: a()(J.headerCellWrapper, J[`headerCellWrapper__${u.key}`]),
                                                  key: String(u.key),
                                              },
                                              F().createElement(
                                                  'div',
                                                  { className: a()(J.tableCell, J.tableCell__header) },
                                                  u.title,
                                              ),
                                          ),
                                      ),
                            ...
                            null == A
                                ...
                                : A.map((u, t) => {
                                      ...
                                      return F().createElement(
                                          F().Fragment,
                                          { key: u.type },
                                          F().createElement('div', { className: J.divider }),
                                          F().createElement(
                                              'div',
                                              { className: a()(J.row, E && J.row__active) },
                                              E && F().createElement('div', { className: J.rowBackground }),
                                              F().createElement(
                                                  'div',
                                                  { className: a()(J.tableCell, J.tableCell__row) },
                                                  F().createElement(
                                                      'div',
                                                      { className: J.levelCell },
                                                      F().createElement('div', {
                                                          className: J.levelCellImage,
                                                          style: {
                                                              backgroundImage: `url(${eu.rating.c_24x24.$dyn(`rating_${u.rank}_${u.subRank}`)})`,
                                                          },
                                                      }),
                                                      F().createElement('div', null, u.level),
                                                  ),
                                              ),
                                              F().createElement(
                                                  'div',
                                                  { className: a()(J.tableCell, J.tableCell__row) },
                                                  F().createElement(Q, { value: u.points }),
                                              ),
                                              E && F().createElement('div', { className: J.checkmark }),
                                          ),
                                          t === A.length - 1 && F().createElement('div', { className: J.divider }),
                                      );
                                  }),
                        );
                    },
                    Eu = 'App_base_fb655',
                    Fu = 'App_topBlock_b1d46',
                    Au = 'App_texts_f624f',
                    nu = 'App_bottomBlock_af875',
                    ru = 'App_title_af8fd',
                    au = 'App_ratingImageWrapper_a969f',
                    Du = 'App_ratingImage_a9c74',
                    ou = R.strings.achievements_page.tooltips.WTR.rating,
                    iu = (0, C.Pi)(() => {
                        const u = h().model,
                            e = u.root.get(),
                            t = e.currentPoints,
                            E = e.rank,
                            A = e.requiredNumberOfBattles,
                            n = e.subRank,
                            r = u.computes.getRankList(),
                            a = 0 === A,
                            D = a ? E : 0,
                            o = a ? n : 0,
                            i = a ? Z(D, o) : void 0,
                            B = r.findIndex((u) => u.rank === D && u.subRank === o),
                            C = B !== r.length - 1 ? r[B + 1] : void 0;
                        return F().createElement(
                            s,
                            null,
                            F().createElement(
                                ...
                                F().createElement(
                                    ...
                                    F().createElement(
                                        ...
                                        F().createElement('div', {
                                            className: Du,
                                            style: {
                                                backgroundImage: `url(${R.images.gui.maps.icons.achievements.rating.c_80x80.$dyn(`rating_${D}_${o}`)})`,
                                            },
                                        }),
                                    ),
                                    F().createElement(
                                        'div',
                                        { className: Au },
                                        F().createElement('div', { className: ru }, ou.title()),
                                        F().createElement(Y, {
                                            requiredNumberOfBattles: A,
                                            nextRankItem: C,
                                            points: t,
                                            rank: D,
                                            subRank: o,
                                ...
                                F().createElement(
                                    'div',
                                    { className: nu },
                                    F().createElement(tu, { currentSubLevelType: i, list: r }),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    n().render(
                        F().createElement(b, null, F().createElement(iu, null)),
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (a = 0; a < deferred.length; a++) {
                    for (var [e, t, E] = deferred[a], A = !0, n = 0; n < e.length; n++)
                        (!1 & E || F >= E) &&
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); a < A.length; a++)
                        ((F = A[a]), __webpack_require__.o(u, F) && u[F] && u[F][0](), (u[F] = 0));
                    return __webpack_require__.O(D);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
        })());
    var __webpack_exports__ = __webpack_require__.O(void 0, [549], () => __webpack_require__(79));
