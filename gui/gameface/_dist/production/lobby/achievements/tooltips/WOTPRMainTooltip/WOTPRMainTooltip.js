                    ...
                    ce = () =>
                        u().createElement(
                            ...
                            u().createElement(
                                'div',
                                { className: ae },
                                u().createElement('div', { className: se }, de.title()),
                                de.firstDescription(),
                                u().createElement('div', { className: ue }, de.significantStats()),
                                de.secondDescription(),
                            ),
                        );
                engine.whenReady.then(() => {
                    c().render(u().createElement(ce, null), document.getElementById('root'));
                });
            },
        },
        t = {};
