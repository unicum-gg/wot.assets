            ...
            9551: (e, u, t) => {
                ...
                const A = (e) => {
                    ...
                    const n = (0, a.useContext)(m),
                        ...
                        C = { extraLarge: D, large: h, medium: B, small: v, extraSmall: p };
                ...
                const y = {
                    ...
                    O = (e) => {
                        ...
                        const r = x(),
                            ...
                            i = r.mediaHeight,
                            o = r.mediaSize;
                        return n().createElement('div', S({ className: B()(t, y[s], T[i], P[o]) }, a), u);
                    },
                    k = ['children'];
                const L = (e) => {
                    let u = e.children,
                    ...
                    return n().createElement(D, null, n().createElement(O, t, u));
                };
                var N = t(493),
                    M = t.n(N);
                function I(e) {
                ...
                const ae = [
                    ...
                    ne = [X.Gold, X.Credits, X.Crystal, X.FreeXp],
                    re = [X.BattlePassPoints, X.EquipCoin],
                    se = [X.PremiumPlus, X.Premium],
                        ...
                        n().createElement(
                            ...
                            r !== Oe.ghost &&
                                n().createElement(
                                    n().Fragment,
                                    null,
                                    n().createElement('div', { className: Pe.back }),
                                    n().createElement('span', { className: Pe.texture }),
                                ),
                            n().createElement(
                                'span',
                                { className: B()(Pe.state, Pe.state__default) },
                                n().createElement('span', { className: Pe.stateDisabled }),
                                n().createElement('span', { className: Pe.stateHighlightHover }),
                                n().createElement('span', { className: Pe.stateHighlightActive }),
                            ),
                            n().createElement(
                                'span',
                ...
                Le.defaultProps = { type: Oe.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Ne = Le;
                t(1281);
                let Me;
                function Ie(e, u) {
                ...
                const pu = R.images.gui.maps.icons.advanced_achievements,
                    Cu = {
                        [Bu.S100x100]: vu.s54x68,
                        [Bu.S128x128]: vu.s68x82,
                        [Bu.S180x180]: vu.s100x118,
                        [Bu.S280x280]: vu.s156x182,
                        [Bu.S360x360]: vu.s200x236,
                        [Bu.S420x420]: vu.s250x278,
                    },
                    bu = ({
                        keyName: e,
                        backgroundName: u,
                        ...
                        return (
                            (D = () =>
                                s.O.view.events.onDisplayChanged((e, u) => {
                                    var t, a;
                                    (u === Xu.W.hidden && (null == (t = F.current) || t.pause()),
                                        u === Xu.W.shown && (null == (a = F.current) || a.play()));
                                })),
                            (0, a.useEffect)(D, []),
                            (0, a.useEffect)(
                                () =>
                            ...
                            () =>
                                Ze(() => {
                                    switch (r) {
                                        ...
                                        case dt.AutoShowing:
                                            return (v.start({ to: { opacity: 1 }, immediate: !1 }), void f());
                                        case dt.Showing:
                                            return void f();
                                        case dt.Loop:
                                            return (
                ...
                const pt = (0, j.Pi)(({ index: e, delay: u, className: t }) => {
                    ...
                    $t = (0, j.Pi)(({ className: e }) => {
                        ...
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement(Ot, { className: Mt }),
                ...
                engine.whenReady.then(() => {
                    M().render(
                        n().createElement(we, null, n().createElement(L, null, n().createElement(Vt, null))),
