(() => {
    var __webpack_modules__ = {
            ...
            67: (u, e, t) => {
                ...
                var E = {};
                (t.r(E), t.d(E, { getBgUrl: () => C, getTextureUrl: () => _ }));
                var n = {};
                function a(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            816: (u, e, t) => {
                ...
                const g = E.O.client.getSize('rem'),
                    p = g.width,
                    S = g.height,
                    v = Object.assign({ width: p, height: S }, h(p, S, m)),
                    w = (0, n.createContext)(v),
                    T = ['children'];
                const x = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && B) return c(e, t, g);
                ...
                (0, n.memo)(({ children: u }) => {
                    ...
                    return a().createElement(w.Provider, { value: i }, u);
                });
                let b, L, O;
                (!(function (u) {
                ...
                const M = () => {
                    ...
                    N = [b.ExtraLarge, b.Large, b.Medium, b.Small, b.ExtraSmall],
                    H = (u, e) =>
                ...
                const U = {
                    ...
                    V = I((u) => {
                        let e = u.className,
                            ...
                            T =
                                void 0 === w
                                    ...
                                    : w,
                            x = u.alignItems,
                            f = void 0 === x ? (h ? 'flex-start' : g && 'center') || (p && 'flex-end') || void 0 : x,
                            b = u.alignSelf,
                            L = u.wrap,
                            O = u.flexWrap,
                        ...
                        const X = (0, n.useMemo)(() => {
                            ...
                            }, [t, r, i, o, s, _, H, N, b, d, M, T, f]),
                            z = X.computedStyle,
                            Y = X.computedClassNames;
                        return a().createElement('div', G({ className: A()(k.base, ...Y, e), style: z }, V), I);
                    });
                let X;
                function z(u, e) {
                ...
                const Y = (u, e, t) => {
                    ...
                    $ = (u, e, t = X.left) => u.split(e).reduce(t === X.left ? Y : q, []),
                    Z = (() => {
                        const u = new RegExp(
                        ...
                        return Q.includes(t)
                            ...
                            : ((u, e = X.left) => {
                                  ...
                                  const r =
                                      ...
                                      A = u.replace(/&nbsp;/g, ' ');
                                  return ($(A, /( )/, e).forEach((u) => (t = t.concat($(u, r, X.left)))), t);
                              })(u, e);
                    },
                    uu = 'FormatText_base_d0',
                    eu = ({ binding: u, text: e = '', classMix: t, alignment: r = X.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, E) =>
                                      a().createElement(
                                          'div',
                                          { className: A()(uu, t), key: `${e}-${E}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : J(u, e))))(e, r, u).map((u, e) =>
                ...
                const au = Object.keys(ru()),
                    ...
                    lu = I((u) => {
                        ...
                        return a().createElement(
                            ...
                            nu(
                                {
                                    className: A()(Au.base, t && Au[t], p, r),
                                    style: g,
                                    mt: !0 === D ? Bu[t || 'paragraph-P16'].mt : D,
                                    mr: !0 === B ? Bu[t || 'paragraph-P16'].mr : B,
                                    mb: !0 === l ? Bu[t || 'paragraph-P16'].mb : l,
                                    ml: !0 === C ? Bu[t || 'paragraph-P16'].ml : C,
                                },
                                d,
                            ),
                            void 0 !== m ? a().createElement(eu, nu({}, m, { text: e })) : e,
                        );
                    });
                let _u, Cu;
                (!(function (u) {
                ...
                function pu(u = 0) {
                    ...
                    e -= t * gu;
                    const r = Math.trunc(e / hu);
                    e -= r * hu;
                    const A = Math.trunc(e / du);
                    return ((e -= A * du), { days: t, hours: r, minutes: A, seconds: e });
                }
                const Su = () => {},
                    vu = (u = 0, e, t = 0, r = Su) => {
                            ...
                            (0, n.useEffect)(() => {
                                if (u > 0) {
                                    ...
                                    const A = Date.now(),
                                        E = setInterval(
                                            () => {
                                                const e = u - Math.floor((Date.now() - A) / mu);
                                                null !== t && e <= t ? (a(t), r && r(), clearInterval(E)) : a(e);
                                            },
                                            (e || (u > 120 ? du : 1)) * mu,
                                        );
                                    return () => {
                ...
                const fu = (u) =>
                    ...
                    bu =
                        ((0, n.memo)(({ duration: u }) => {
                            const e = u >= 0 ? fu(pu(u)) : R.strings.common.duration.unlimited();
                    ...
                    Lu = (u) =>
                        fu(
                            ((u) => {
                                const e = pu(Math.max(0, Math.ceil(u))),
                                    t = e.minutes > 0 || e.seconds > 0,
                                    r = e.hours > 0 || t;
                                return e.days > 0
                                    ? Object.assign({}, bu, { days: e.days + (r ? 1 : 0) })
                                    : e.hours > 0
                                      ? Object.assign({}, bu, { hours: e.hours + (t ? 1 : 0) })
                                      : e.minutes > 0
                                        ? Object.assign({}, bu, { minutes: e.minutes + (e.seconds > 0 ? 1 : 0) })
                                        : e.seconds > 0
                                          ? Object.assign({}, bu, { minutes: 1 })
                                          : bu;
                            })(u),
                        ),
                    Ou = (u) => Lu(u),
                ...
                const ku = ((u, e) => {
                                ...
                                const D = (0, n.useRef)([]),
                                    o = (t, r, A) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            s = { mode: t, model: B, externalModel: F, cleanup: o };
                                        return {
                                            model: B,
                                    ...
                                    l = s[0],
                                    _ = s[1],
                                    C = (0, n.useState)(() => o(r, A, i)),
                                    c = C[0],
                                    m = C[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        B.current ? m(o(l, A, i)) : (B.current = !0);
                                    }, [i, l, A]),
                                    (0, n.useEffect)(() => {
                                        _(r);
                                    }, [r]),
                    ...
                    Ku = 'App_header_ad',
                    ju = 'App_body_e6',
                    Vu = 'App_timerContainer_0e',
                    Xu = 'App_timerIcon_15',
                    zu = 'App_timerText_52',
                    Yu = 'App_timerDescription_05',
                    qu = R.strings.account_dashboard.excludedMaps,
                    $u = [
                        _u.MAPS_BLACKLIST_SLOT_STATE_ACTIVE_NO_HOVER,
                        _u.MAPS_BLACKLIST_SLOT_STATE_ACTIVE,
                        _u.MAPS_BLACKLIST_SLOT_STATE_CHANGE,
                        _u.MAPS_BLACKLIST_SLOT_STATE_COOLDOWN,
                        _u.MAPS_BLACKLIST_SLOT_STATE_SELECTED,
                    ],
                    Zu = {
                        [_u.MAPS_BLACKLIST_SLOT_STATE_ACTIVE_NO_HOVER]: qu.selectTooltipHeader(),
                        [_u.MAPS_BLACKLIST_SLOT_STATE_CHANGE]: qu.replaceTooltipHeader(),
                        [_u.MAPS_BLACKLIST_SLOT_STATE_COOLDOWN]: qu.cooldownTooltipHeader(),
                        [_u.MAPS_BLACKLIST_SLOT_STATE_SELECTED]: qu.replaceTooltipHeader(),
                        [_u.MAPS_BLACKLIST_SLOT_STATE_ACTIVE]: qu.selectTooltipHeader(),
                        [_u.MAPS_BLACKLIST_SLOT_STATE_DISABLED]: qu.disabledTooltipHeader(),
                    },
                    Qu = (0, xu.Pi)(() => {
                        const u = Gu().model.root.get(),
                            ...
                            A = (0, n.useMemo)(() => {
                                const u = Mu(r);
                                return { isInCooldown: u > 0, timeUntilCooldownEnd: u, timeUntilEventSlotEnd: Mu(t) };
                            }, [r, t]),
                            E = A.isInCooldown,
                            F = A.timeUntilCooldownEnd,
                            i = A.timeUntilEventSlotEnd,
                            D = Tu(E ? Math.max(0, F) : 0, du),
                            o = Tu(Math.max(0, i), du),
                            B = ((u, e) =>
                                u !== _u.MAPS_BLACKLIST_SLOT_STATE_COOLDOWN || e
                                    ? u
                                    : _u.MAPS_BLACKLIST_SLOT_STATE_CHANGE)(e, E && D > 0),
                            s = (0, n.useMemo)(() => Lu(o), [o]),
                            l = (0, n.useMemo)(
                                () =>
                                    ((u, e) => {
                                        switch (e) {
                                            case _u.MAPS_BLACKLIST_SLOT_STATE_CHANGE:
                                            case _u.MAPS_BLACKLIST_SLOT_STATE_SELECTED:
                                                return qu.replaceTooltipBody();
                                            case _u.MAPS_BLACKLIST_SLOT_STATE_ACTIVE:
                                            case _u.MAPS_BLACKLIST_SLOT_STATE_ACTIVE_NO_HOVER:
                                                return qu.selectTooltipBody();
                                            case _u.MAPS_BLACKLIST_SLOT_STATE_DISABLED:
                                                return qu.disabledTooltipBody.rewardsSlots();
                                            case _u.MAPS_BLACKLIST_SLOT_STATE_COOLDOWN:
                                                return z(qu.cooldownTooltipBody(), { cooldownStr: Ou(u) });
                                            default:
                                                return '';
                                        }
                                    })(D, B),
                        ...
                        return a().createElement(
                            'div',
                            { className: Uu },
                            a().createElement(lu, { className: Ku, text: Zu[B] }),
                            a().createElement(lu, { className: ju, text: l }),
                            _ &&
                                a().createElement(
                                    'div',
                                    { className: Vu },
                                    a().createElement(lu, { className: Yu, text: qu.timerTooltipDescription() }),
                                    a().createElement('div', { className: Xu }),
                                    a().createElement(lu, { className: zu, text: s }),
                                ),
                        );
                    });
                engine.whenReady.then(() => {
                    l().render(
                        a().createElement(Wu, null, a().createElement(B, null, a().createElement(Qu, null))),
