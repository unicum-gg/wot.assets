(() => {
    var __webpack_modules__ = {
            ...
            768: (u, e, t) => {
                ...
                var a = {};
                t.r(a),
                    t.d(a, { mouse: () => c, off: () => l, on: () => s, onResize: () => A, onScaleUpdated: () => F });
                var r = {};
                t.r(r),
                    t.d(r, {
                        events: () => a,
                ...
                var n = {};
                t.r(n), t.d(n, { getBgUrl: () => w, getTextureUrl: () => v });
                var i = {};
                function E(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const m = {
                    ...
                    p = { play: Object.assign({}, g, { sound: B }), setRTPC: C };
                function v(u, e, t = 1) {
            ...
            266: (u, e, t) => {
                ...
                const F = i.O.client.getSize('rem'),
                    s = F.width,
                    l = F.height,
                    D = Object.assign({ width: s, height: l }, A(s, l, E)),
                ...
                const C = (u) => {
                    ...
                    const r = (0, a.useContext)(c),
                        ...
                        v = { extraLarge: _, large: m, medium: h, small: g, extraSmall: p };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraSmallWidth && d) return n(e, t, v);
                        if (
                ...
                const T = {
                    ...
                    k = (u) => {
                        ...
                        const n = x(),
                            ...
                            E = n.mediaHeight,
                            o = n.mediaSize;
                        return r().createElement('div', y({ className: h()(t, T[i], L[E], S[o]) }, a), e);
                    },
                    M = ['children'];
                const P = (u) => {
                    let e = u.children,
                ...
                class G extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = h()(N.base, N[`base__${i}`], N[`base__${n}`], null == E ? void 0 : E.base),
                            c = h()(N.icon, N[`icon__${i}`], N[`icon__${n}`], null == E ? void 0 : E.icon),
                            B = h()(N.glow, null == E ? void 0 : E.glow),
                            C = h()(N.caption, N[`caption__${i}`], null == E ? void 0 : E.caption),
                            d = h()(N.goto, null == E ? void 0 : E.goto);
                        return r().createElement(
                            ...
                            'info' !== i && r().createElement('div', { className: N.shine }),
                ...
                function z(u = $.n.NONE, e = j, t = !1, r = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== $.n.NONE)
                            return (
                ...
                const Z = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    J = (u, e, t = q.left) => u.split(e).reduce(t === q.left ? X : Q, []),
                    uu = (() => {
                        const u = new RegExp(
                    ...
                    tu = (u, e = q.left) => {
                        ...
                        return ((u, e = q.left) => {
                            ...
                            const a =
                                ...
                                r = Z(u);
                            return J(r, /( )/, e).forEach((u) => (t = t.concat(J(u, a, q.left)))), t;
                        })(u, e);
                    },
                    au = 'FormatText_base_d0',
                    ru = ({ binding: u, text: e = '', classMix: t, alignment: n = q.left, formatWithBrackets: i }) => {
                    ...
                    Eu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    ou = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Au = (0, a.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                (o = o.replace(t, `%(${E})`)),
                                    (i[E] = nu[u]
                                        ? r().createElement(
                                              'span',
                                              { className: nu[u] },
                                              r().createElement(ru, { text: s, binding: e }),
                                          )
                                        : r().createElement(
                                              'span',
                                              { style: n(u) },
                        ...
                        return r().createElement(ru, { text: o, classMix: t, binding: i });
                    });
                function Fu() {
                    return !1;
                }
                ...
                const Bu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: E, children: o, mocks: A }) {
                                const F = (0, a.useRef)([]),
                                    s = (t, a, r) => {
                                        var n;
                                        const E = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = lu(r.keys()); !(u = t()).done; ) n(u.value, e);
                                                    },
                                                    unsubscribe: n,
                                                };
                                            })(a),
                                            ...
                                            D = { mode: t, model: l, externalModel: o, cleanup: s };
                                        return {
                                            model: l,
                                    ...
                                    c = D[0],
                                    B = D[1],
                                    C = (0, a.useState)(() => s(n, E, A)),
                                    d = C[0],
                                    _ = C[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        l.current ? _(s(c, E, A)) : (l.current = !0);
                                    }, [A, c, E]),
                                    (0, a.useEffect)(() => {
                                        B(n);
                                    }, [n]),
                ...
                const gu = ({
                    ...
                    return (
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                'span',
                                { className: h()(_u.state, _u.state__default) },
                ...
                const pu = gu,
                    vu = 'StateWidget_base_24',
                    wu = 'StateWidget_spacer_3e',
                    bu = 'StateWidget_left_group_1d',
                    xu = 'StateWidget_right_group_38',
                    fu = 'StateWidget_details_button_35',
                    yu = 'StateWidget_icon_29',
                    Tu = 'StateWidget_icon__wotPlus_0c',
                    Lu = 'StateWidget_icon__wotPremium_f4',
                    Su = 'StateWidget_check_icon_d6',
                    ku = 'StateWidget_check_icon__unlocked_24',
                    Mu = 'StateWidget_check_icon__locked_55',
                    Pu = 'StateWidget_heading_4d',
                    Ou = 'StateWidget_application_a5',
                    Wu = 'StateWidget_plus_sign_bf';
                let Ru;
                !(function (u) {
                    (u.WotPlus = 'WotPlus'), (u.WotPremium = 'WotPremium');
                })(Ru || (Ru = {}));
                const Hu = {
                        get wotPremiumLabel() {
                    ...
                    Nu = (0, V.Pi)(({ type: u }) => {
                        const e = du(),
                            t = e.model,
                            a = e.controls,
                            n = a.onWotPremiumUpgradeButtonClick,
                            i = a.onWotPlusSubscribeButtonClick,
                            E = a.onWotPremiumDetailsButtonClick,
                            o = a.onWotPlusDetailsButtonClick,
                            A = t.root.get(),
                            F = A.isWotPremium,
                            s = A.isWotPlus,
                            l = A.wotPremiumMaxApplications,
                            D = A.wotPlusMaxApplications,
                            c = { [Ru.WotPremium]: Hu.wotPremiumLabel, [Ru.WotPlus]: Hu.wotPlusLabel },
                            B = { [Ru.WotPremium]: Hu.wotPremiumApplications, [Ru.WotPlus]: Hu.wotPlusApplications },
                            C = c[u] || '',
                            d = { [Ru.WotPremium]: l, [Ru.WotPlus]: D },
                            _ = { [Ru.WotPremium]: F ? E : n, [Ru.WotPlus]: s ? o : i },
                            m = ((g = u), Object.keys(Ru).includes(g) ? _[u] : void 0);
                        var g;
                        const p = (({ isWotPremium: u, isWotPlus: e, type: t }) => {
                            let a = Hu.upgrade;
                            return (
                                e || t !== Ru.WotPlus
                                    ? ((t === Ru.WotPremium && u) || (t !== Ru.WotPremium && e)) && (a = Hu.details)
                                    : (a = Hu.subscribe),
                                { text: a, mixClass: fu, type: a === Hu.details ? mu.ghost : mu.primary }
                            );
                        })({ isWotPremium: F, isWotPlus: s, type: u });
                        return r().createElement(
                            'div',
                            { className: vu },
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: h()(yu, u === Ru.WotPremium && Lu, u === Ru.WotPlus && Tu) },
                                    r().createElement('div', {
                                        className: h()(Su, {
                                            [ku]: (u === Ru.WotPremium && F) || (u === Ru.WotPlus && s),
                                            [Mu]: !((u === Ru.WotPremium && F) || (u === Ru.WotPlus && s)),
                                        }),
                                    }),
                                ),
                                r().createElement('div', { className: Pu }, C),
                            ),
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(Au, {
                                        text: B[u],
                                        binding: {
                                            plusIcon: r().createElement('div', { className: Wu }),
                                            applications: d[u],
                                        },
                                    }),
                                ),
                                r().createElement(pu, { type: p.type, mixClass: p.mixClass, onClick: m }, p.text),
                            ),
                        );
                    }),
                    Iu = 'DailyExperienceApp_base_5c',
                    Uu = 'DailyExperienceApp_content_8d',
                    Gu = 'DailyExperienceApp_center_container_4f',
                    $u = 'DailyExperienceApp_multiplier_container_b1',
                    ju = 'DailyExperienceApp_backBtnWrapper_d5',
                    zu = 'DailyExperienceApp_multiplier_left_a0',
                    Vu = 'DailyExperienceApp_multiplier_left__standard_3a',
                    Ku = 'DailyExperienceApp_multiplier_left__wotPlus_12',
                    qu = 'DailyExperienceApp_multiplier_right_d0',
                    Yu = 'DailyExperienceApp_heading_eb',
                    Zu = 'DailyExperienceApp_description_1c',
                    Xu = 'DailyExperienceApp_daily_unlock_00',
                    Qu = 'DailyExperienceApp_daily_unlock_text_07',
                    Ju = 'DailyExperienceApp_gridSeparator_96',
                    ue = 'DailyExperienceApp_state_widget_5c',
                    ee = 'DailyExperienceApp_footer_a6',
                    te = 'DailyExperienceApp_dotted_divider_79',
                    ae = (0, V.Pi)(() => {
                        const u = du(),
                            e = u.model,
                            t = u.controls.onBackButtonClick,
                            a = e.root.get(),
                            n = a.isWotPlusBonusEnabled,
                            i = a.leftBonusCount,
                            E = a.totalBonusCount,
                            o = a.wotPremiumMaxApplications,
                            A = a.wotPlusMaxApplications;
                        var F;
                        return (
                            (F = t),
                            z($.n.ESCAPE, F),
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    { className: ju },
                                    r().createElement(G, {
                                        caption: R.strings.account_dashboard.dailyExperience.back(),
                                        type: 'back',
                                        side: 'left',
                                        onClick: t,
                                        goto: R.strings.account_dashboard.dailyExperience.toAccountStatus(),
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            'div',
                                            { className: $u },
                                            r().createElement('div', { className: h()(zu, n ? Ku : Vu) }),
                                            r().createElement(
                                                'div',
                                                { className: qu },
                                                r().createElement(Au, {
                                                ...
                                                r().createElement(
                                                    'div',
                                                    { className: ue },
                                                    o > 0 && r().createElement(Nu, { type: Ru.WotPremium }),
                                                    A > 0 && n && r().createElement('div', { className: te }),
                                                    A > 0 && n && r().createElement(Nu, { type: Ru.WotPlus }),
                                                ),
                                            ),
                                        ),
                                    ),
                ...
                engine.whenReady.then(() => {
                    W().render(
                        r().createElement(P, null, r().createElement(Cu, null, r().createElement(ae, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [507], () => __webpack_require__(266));
