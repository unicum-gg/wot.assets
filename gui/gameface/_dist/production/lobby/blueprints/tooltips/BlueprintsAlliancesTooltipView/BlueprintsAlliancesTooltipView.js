(() => {
    ...
    var __webpack_modules__ = {
            ...
            364: (u, e, A) => {
                ...
                function l(u, e, A, E, F, t, n) {
                    ...
                    D.done ? e(i) : Promise.resolve(i).then(E, F);
                }
                ...
                const h = F.instance,
                    g = {
                        ...
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            m(i.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
            ...
            951: (u, e, A) => {
                ...
                const s = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            C({}, s, {
                                className: i()(o.base, o[`base__theme-${D}`], t),
                                ref: function (u) {
                ...
                const l = (u, e, A) => {
                    ...
                    d = (u, e, A = c.left) => u.split(e).reduce(A === c.left ? l : _, []),
                    m = (() => {
                        const u = new RegExp(
                        ...
                        return v.includes(A)
                            ...
                            : ((u, e = c.left) => {
                                  ...
                                  const E =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return d(F, /( )/, e).forEach((u) => (A = A.concat(d(u, E, c.left)))), A;
                              })(u, e);
                    };
                let p;
                !(function (u) {
                ...
                const g = (u = 1) => {
                    ...
                    N = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: F, modelPath: O(F, u || ''), resId: E };
                            })(),
                            A = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                ...
                const P = (u = 'model', e = x.Deep) => {
                            ...
                            f(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        E = N(u);
                                    a.current = M.addCallback(E, A, D, e === x.Deep);
                                }
                            }),
                            (0, E.useEffect)(() => {
                                if (e !== x.None)
                    ...
                    k = (h.Sw.instance, 'FormatText_base_d0'),
                    S = ({ binding: u, text: e = '', classMix: A, alignment: t = c.left }) =>
                        null === e
                            ...
                            : F().createElement(
                                  ...
                                  e.split('\n').map((e, n) =>
                                      F().createElement(
                                          'div',
                                          { className: i()(k, A), key: `${e}-${n}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : w(u, e))))(e, t, u).map((u, e) =>
                                              F().createElement(E.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              ),
                    L = 'NationName_base_a2',
                    U = 'NationName_highlight_61',
                    I = 'NationName_highlightBold_3b',
                    V = ({ strResId: u, nationNameStr: e, value: A }) => {
                        const t = (0, E.useMemo)(
                            () => ({
                                nation: F().createElement(
                                    'span',
                                    { className: U },
                                    R.strings.blueprints.nations.$dyn(e),
                                ),
                                count: F().createElement('span', { className: I }, A),
                            }),
                            [e, A],
                        );
                    ...
                    K = () => {
                        ...
                        const D = Array.from(t),
                            r = D.findIndex((u) => u.value.nationName === A),
                            B = D.splice(r, 1)[0].value,
                            o = (0, E.useMemo)(
                                () => ({
        ...
        (__webpack_require__.O = (u, e, A, E) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, A, E] = deferred[i], t = !0, n = 0; n < e.length; n++)
                        (!1 & E || F >= E) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [589], () => __webpack_require__(951));
