(() => {
    ...
    var __webpack_modules__ = {
            99: (u, e, t) => {
                ...
                var F = {};
                t.r(F), t.d(F, { getBgUrl: () => T, getTextureUrl: () => b });
                var n = {};
                function D(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const m = {
                    ...
                    w = { play: Object.assign({}, p, { sound: c }), setRTPC: l },
                ...
                const tu = (() => {
                    ...
                    Eu = f,
                    Au = Object.keys(O).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === O[e]), u), {}),
                    Fu = {
                        set: (u, e) => {
            ...
            143: (u, e, t) => {
                ...
                const V = (u = 'model', e = L.Deep) => {
                            ...
                            y(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        E = P(u);
                                    C.current = S.addCallback(E, t, i, e === L.Deep);
                                }
                            }),
                            (0, E.useEffect)(() => {
                                if (e !== L.None)
                                    return () => {
                                        S.removeCallback(C.current, i);
                                    };
                            }, [i, e]),
                            a
                        );
                    ...
                    q = () => A().createElement(s, null, A().createElement(K, null)),
