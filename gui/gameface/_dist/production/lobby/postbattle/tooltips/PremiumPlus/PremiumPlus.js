(() => {
    ...
    var u,
        F = {
            9142: (u, F, e) => {
                var A = {};
                e.r(A), e.d(A, { mouse: () => d, onResize: () => l });
                var E = {};
                e.r(E),
                    e.d(E, {
                        events: () => A,
                ...
                var D = {};
                e.r(D), e.d(D, { getBgUrl: () => g, getTextureUrl: () => p });
                var B = {};
                e.r(B),
                    e.d(B, {
                        addModelObserver: () => S,
                ...
                function M(u = 'rem') {
                    ...
                    return 'rem' === u ? F : { x: H(F.x), y: H(F.y) };
                }
                function N() {
                ...
                const Q = Object.keys(w).reduce((u, F) => ((u[F] = () => viewEnv.getShowingStatus() === w[F]), u), {}),
                    $ = {
                        set: (u, F) => {
                ...
                const uu = n().forwardRef(function (u, F) {
                    let e = u.children,
                        A = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            X({}, B, {
                                className: i()(J.base, J[`base__theme-${D}`], A),
                                ref: function (u) {
                                    (r.current = u), 'function' == typeof F ? F(u) : F && (F.current = u);
                                },
                            }),
                            n().createElement('div', { className: J.decorator }, e),
                        )
                    );
                });
                let Fu;
                ...
                const eu = () => n().createElement('div', { className: 'Separator_base_53' }),
                    Au = {
                ...
                const Du = ({
                        holderStyle: u = Eu.DEFAULT,
                        separatorTop: F = !1,
                        separatorBottom: e = !1,
                        className: A,
                        children: E,
                    }) => {
                        const D = u === Eu.DEFAULT;
                        return n().createElement(
                            'div',
                            { className: i()(Au.base, !D && Au[`base__${u}`], A) },
                            F && n().createElement(eu, null),
                            n().createElement('div', { className: Au.content }, E),
                            e && n().createElement(eu, null),
                        );
                    },
                    Bu = R.strings.postbattle_screen.premiumBenefits;
                const tu = ({ premiumBenefits: u }) => {
                        const F = u.map(({ value: u }) =>
                            (function (u) {
                                const F = {};
                                return (
                                    u.value.map((u) => {
                                        const e = u.value;
                                        let A;
                                        (A = 'percent_value' === e.valueType ? Math.trunc(100 * e.value) : e.value),
                                            (F[e.substitutionID] = A);
                                    }),
                                    (e = u.stringID),
                                    (A = F),
                                    e.replace(/\{\w+\}/g, (u) => String(A[u.slice(1, -1)]))
                                );
                                var e, A;
                            })(u),
                        );
                        return n().createElement(
                            'div',
                            { className: 'TooltipContent_base_d2' },
                            n().createElement(
                                'div',
                                { className: 'TooltipContent_header_5b' },
                                n().createElement('div', { className: 'TooltipContent_icon_91' }),
                                n().createElement(
                                    Du,
                                    null,
                                    n().createElement('div', { className: 'TooltipContent_title_ef' }, Bu.title()),
                                ),
                            ),
                            n().createElement(
                                Du,
                                { holderStyle: Eu.PRIMARY, separatorTop: !0, separatorBottom: !0 },
                                n().createElement(
                                    'div',
                                    { className: 'TooltipContent_description_fa' },
                                    Bu.description(),
                                ),
                            ),
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    { className: 'TooltipContent_bonuses_fa' },
                                    n().createElement(
                                        'div',
                                        { className: 'TooltipContent_subtitle_b3' },
                                        Bu.bonusesTitle(),
                                    ),
                                    n().createElement('div', { className: 'TooltipContent_list_5d' }, F),
                                ),
                            ),
                        );
                    },
                ...
                function Cu() {
                    const u = n().createElement(
                        uu,
                        null,
                        n().createElement(tu, { premiumBenefits: window.model.premiumBenefits }),
                    );
                    r().render(u, nu);
                }
                (window.onload = () => document.body.appendChild(nu)),
                    engine._BindingsReady && engine._WindowLoaded ? Cu() : engine.on('Ready', Cu);
            },
        },
        e = {};
    function A(u) {
