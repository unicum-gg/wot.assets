(() => {
    ...
    var u,
        e = {
            3778: (u, e, F) => {
                var A = {};
                F.r(A), F.d(A, { mouse: () => d, onResize: () => c });
                var E = {};
                F.r(E),
                    F.d(E, {
                        events: () => A,
                ...
                const uu = B().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        B().createElement(
                            'div',
                            X({}, D, {
                                className: i()(J.base, J[`base__theme-${n}`], A),
                                ref: function (u) {
                                    (r.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            B().createElement('div', { className: J.decorator }, F),
                        )
                    );
                });
                let eu;
                ...
                const Au = () => B().createElement('div', { className: 'Separator_base_53' }),
                    Eu = {
                ...
                const Du = ({
                        holderStyle: u = nu.DEFAULT,
                        separatorTop: e = !1,
                        separatorBottom: F = !1,
                        className: A,
                        children: E,
                    }) => {
                        const n = u === nu.DEFAULT;
                        return B().createElement(
                            'div',
                            { className: i()(Eu.base, !n && Eu[`base__${u}`], A) },
                            e && B().createElement(Au, null),
                            B().createElement('div', { className: Eu.content }, E),
                            F && B().createElement(Au, null),
                        );
                    },
                    tu = {
                ...
                var Bu, ou, ru;
                function Cu(u, e, F) {
                    return i()(tu.icon, tu[`icon__${u}`], tu[`icon__${e}`], F && tu.icon__active);
                }
                !(function (u) {
                ...
                const iu = ({ maxSteps: u, currentStep: e, currentStepState: F }) => {
                        const A = [];
                        for (let E = 0; E < u; ++E) {
                            const n = E === u - 1 ? ru.BIG : ru.NORMAL;
                            let D,
                                t = !1,
                                o = '';
                            E < e
                                ...
                                : E > e
                                  ? (D = Bu.NOT_RECEIVED)
                                  : ((t = !0),
                                    (D = 'received' === F ? ou.OPENED : ou.NOT_OPENED),
                                    'prob_min' !== F && (o = tu[`bgGlow__${Fu(F)}`])),
                                A.push(
                                    B().createElement(
                                        'div',
                                        { className: tu.reward, key: E },
                                        B().createElement('div', { className: i()(tu.bgGlow, o) }),
                                        B().createElement('div', { className: Cu(n, D, t) }),
                                    ),
                                );
                        }
                        return B().createElement('div', { className: tu.base }, A);
                    },
                    au = {
                        base: 'TooltipContent_base_ad',
                        header: 'TooltipContent_header_a7',
                        container: 'TooltipContent_container_f7',
                        title: 'TooltipContent_title_15',
                        stage: 'TooltipContent_stage_8b',
                        lock: 'TooltipContent_lock_3c',
                        lock__probMin: 'TooltipContent_lock__probMin_3b',
                        lock__probMed: 'TooltipContent_lock__probMed_10',
                        lock__probMax: 'TooltipContent_lock__probMax_a4',
                        lock__received: 'TooltipContent_lock__received_cd',
                        progressionStatus: 'TooltipContent_progressionStatus_c1',
                        rewardReceived: 'TooltipContent_rewardReceived_c1',
                        description: 'TooltipContent_description_f7',
                    },
                    su = R.strings.tooltips.progressiveReward.widget,
                    cu = ({ currentStepState: u, currentStep: e, maxSteps: F }) => {
                        const A = i()(au.lock, au[`lock__${Fu(u)}`]);
                        return B().createElement(
                            'div',
                            { className: au.base },
                            B().createElement(
                                ...
                                B().createElement(
                                    ...
                                    B().createElement(
                                        ...
                                        B().createElement('div', { className: au.title }, su.header()),
                                        B().createElement(
                                            'div',
                                            { className: au.progressionStatus },
                                            B().createElement(iu, { currentStep: e, maxSteps: F, currentStepState: u }),
                                        ),
                                    ),
                                ),
                            ),
                            B().createElement(
                                Du,
                                { holderStyle: nu.PRIMARY },
                                B().createElement('div', { className: au.description }, su.body()),
                            ),
                        );
                    },
                    lu = document.createElement('div');
                function du() {
                    const u = B().createElement(uu, null, B().createElement(cu, window.model));
                    r().render(u, lu);
                }
                (window.onload = () => document.body.appendChild(lu)),
                    engine._BindingsReady && engine._WindowLoaded ? du() : engine.on('Ready', du);
            },
        },
        F = {};
    function A(u) {
        ...
        (A.O = (e, F, E, n) => {
            if (!F) {
                ...
                for (r = 0; r < u.length; r++) {
                    for (var [F, E, n] = u[r], t = !0, B = 0; B < F.length; B++)
                        (!1 & n || D >= n) && Object.keys(A.O).every((u) => A.O[u](F[B]))
                            ? F.splice(B--, 1)
                            : ((t = !1), n < D && (D = n));
                    if (t) {
                        u.splice(r--, 1);
