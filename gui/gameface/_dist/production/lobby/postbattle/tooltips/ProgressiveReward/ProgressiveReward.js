    ...
    var u,
        e = {
            525: (u, e, F) => {
                ...
                var n = {};
                (F.r(n), F.d(n, { getBgUrl: () => P, getTextureUrl: () => T }));
                var t = {};
                (F.r(t),
                    F.d(t, {
                        addModelObserver: () => $,
                ...
                const b = {
                    ...
                    y = Object.keys(h).reduce((u, e) => ((u[e] = () => g(h[e])), u), {}),
                    x = { play: Object.assign({}, y, { sound: g }), setRTPC: p };
                function T(u, e, F = 1) {
                ...
                const au = B().forwardRef(function (u, e) {
                    let F = u.children,
                        A = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        B().createElement(
                            'div',
                            iu({}, t, {
                                className: i()(ru.base, ru[`base__theme-${n}`], A),
                                ref: function (u) {
                                    ((r.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            B().createElement('div', { className: ru.decorator }, F),
                        )
                    );
                });
                F(281);
                ...
                const lu = 'Separator_base_22',
                    du = () => B().createElement('div', { className: lu }),
                    vu = {
                ...
                const mu = ({
                        holderStyle: u = _u.DEFAULT,
                        separatorTop: e = !1,
                        separatorBottom: F = !1,
                        className: A,
                        children: E,
                    }) => {
                        const n = u === _u.DEFAULT;
                        return B().createElement(
                            'div',
                            { className: i()(vu.base, !n && vu[`base__${u}`], A) },
                            e && B().createElement(du, null),
                            B().createElement('div', { className: vu.content }, E),
                            F && B().createElement(du, null),
                        );
                    },
                    gu = {
                ...
                var pu, fu, wu;
                function bu(u, e, F) {
                    return i()(gu.icon, gu[`icon__${u}`], gu[`icon__${e}`], F && gu.icon__active);
                }
                (!(function (u) {
                    ((u.RECEIVED = 'received'), (u.NOT_RECEIVED = 'notReceived'));
                })(pu || (pu = {})),
                    (function (u) {
                        ((u.OPENED = 'opened'), (u.NOT_OPENED = 'notOpened'));
                    })(fu || (fu = {})),
                    (function (u) {
                        ((u.NORMAL = 'normal'), (u.BIG = 'big'));
                    })(wu || (wu = {})));
                const hu = ({ maxSteps: u, currentStep: e, currentStepState: F }) => {
                        const A = [];
                        for (let E = 0; E < u; ++E) {
                            const n = E === u - 1 ? wu.BIG : wu.NORMAL;
                            let t,
                                D = !1,
                                o = '';
                            (E < e
                                ...
                                : E > e
                                  ? (t = pu.NOT_RECEIVED)
                                  : ((D = !0),
                                    (t = 'received' === F ? fu.OPENED : fu.NOT_OPENED),
                                    'prob_min' !== F && (o = gu[`bgGlow__${cu(F)}`])),
                                A.push(
                                    B().createElement(
                                        'div',
                                        { className: gu.reward, key: E },
                                        B().createElement('div', { className: i()(gu.bgGlow, o) }),
                                        B().createElement('div', { className: bu(n, t, D) }),
                                    ),
                                ));
                        }
                        return B().createElement('div', { className: gu.base }, A);
                    },
                    yu = {
                        base: 'TooltipContent_base_bd',
                        header: 'TooltipContent_header_58',
                        container: 'TooltipContent_container_f5',
                        title: 'TooltipContent_title_b6',
                        stage: 'TooltipContent_stage_c4',
                        lock: 'TooltipContent_lock_3d',
                        lock__probMin: 'TooltipContent_lock__probMin_29',
                        lock__probMed: 'TooltipContent_lock__probMed_73',
                        lock__probMax: 'TooltipContent_lock__probMax_d3',
                        lock__received: 'TooltipContent_lock__received_47',
                        progressionStatus: 'TooltipContent_progressionStatus_58',
                        rewardReceived: 'TooltipContent_rewardReceived_5b',
                        description: 'TooltipContent_description_ad',
                    },
                    xu = R.strings.tooltips.progressiveReward.widget,
                    Tu = ({ currentStepState: u, currentStep: e, maxSteps: F }) => {
                        const A = i()(yu.lock, yu[`lock__${cu(u)}`]);
                        return B().createElement(
                            'div',
                            { className: yu.base },
                            B().createElement(
                                'div',
                                { className: yu.header },
                                B().createElement('div', { className: A }),
                                B().createElement(
                                    mu,
                                    null,
                                    B().createElement(
                                        ...
                                        B().createElement('div', { className: yu.title }, xu.header()),
                                        B().createElement(
                                            'div',
                                            { className: yu.progressionStatus },
                                            B().createElement(hu, { currentStep: e, maxSteps: F, currentStepState: u }),
                                        ),
                                    ),
                                ),
                            ),
                            B().createElement(
                                mu,
                                { holderStyle: _u.PRIMARY },
                                B().createElement('div', { className: yu.description }, xu.body()),
                            ),
                        );
                    },
                    Pu = document.createElement('div');
                function Ru() {
                    const u = B().createElement(au, null, B().createElement(Tu, window.model));
                    r().render(u, Pu);
                }
                ((window.onload = () => document.body.appendChild(Pu)),
        ...
        (A.O = (e, F, E, n) => {
            if (!F) {
                ...
                for (r = 0; r < u.length; r++) {
                    for (var [F, E, n] = u[r], D = !0, B = 0; B < F.length; B++)
                        (!1 & n || t >= n) && Object.keys(A.O).every((u) => A.O[u](F[B]))
                            ? F.splice(B--, 1)
                            : ((D = !1), n < t && (t = n));
                    if (D) {
                        u.splice(r--, 1);
            ...
            n = n || 0;
            for (var r = u.length; r > 0 && u[r - 1][2] > n; r--) u[r] = u[r - 1];
            u[r] = [F, E, n];
        }),
        (A.n = (u) => {
