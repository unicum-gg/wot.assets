        ...
        e = {
            420: (u, e, A) => {
                ...
                const b = {
                    ...
                    y = Object.keys(h).reduce((u, e) => ((u[e] = () => f(h[e])), u), {}),
                    T = { play: Object.assign({}, y, { sound: f }), setRTPC: g };
                function x(u, e, A = 1) {
                ...
                const tu = Object.keys(S).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === S[e]), u), {}),
                    nu = {
                        set: (u, e) => {
                ...
                const cu = 'Separator_base_22',
                    du = () => B().createElement('div', { className: cu }),
                    mu = {
                ...
                const pu = ({
                        ...
                        const t = u === vu.DEFAULT;
                        return B().createElement(
                            'div',
                            { className: i()(mu.base, !t && mu[`base__${u}`], F) },
                            e && B().createElement(du, null),
                            B().createElement('div', { className: mu.content }, E),
                            A && B().createElement(du, null),
                        );
                    },
                    fu = 'ExpBonusProgressDot_base_8d',
                    gu = 'ExpBonusProgressDot_bonusCounter_0c',
                    _u = 'ExpBonusProgressDot_bonusCounterLight_e6',
                    wu = 'ExpBonusProgressDot_base__active_c8',
                    ...
                    hu = 'DiscreteProgressBar_base_e5',
                    yu = ({ fill: u, total: e, reverse: A = !1, children: F }) => {
                        const E = (0, D.useCallback)((u, e) => (0, D.cloneElement)(F(e, u), { key: u }), [F]),
                            t = A ? e - u : u,
                            n = [];
                        for (let u = 0; u < e; u++) n.push(E(u, Boolean(A) !== u < t));
                        return B().createElement('div', { className: hu }, n);
                    },
                    Tu = {
                        status: 'TooltipContentStatus_status_e3',
                        status__cannotApply: 'TooltipContentStatus_status__cannotApply_cd',
                        statusTitle: 'TooltipContentStatus_statusTitle_24',
                        statusTitle__applied: 'TooltipContentStatus_statusTitle__applied_25',
                        statusTitle__available: 'TooltipContentStatus_statusTitle__available_e1',
                        statusExtraInfo: 'TooltipContentStatus_statusExtraInfo_20',
                        info: 'TooltipContentStatus_info_0a',
                    },
                ...
                const Su = ({ restriction: u, bonusMultiplier: e, maxBonusCount: A, usedBonusCount: F }) => {
                        let E,
                            ...
                            n = null;
                        1 === u
                            ? ((E = xu.restriction.$num(u)), (t = Pu.APPLIED))
                            : A === F
                              ? ((E = xu.restriction.finished()), (t = Pu.AVAILABLE))
                              : u > 1
                                ? ((E = xu.restriction.cannotApply()),
                                  (t = Pu.CANNOT_APPLY),
                                  (n = B().createElement('div', { className: Tu.info }, xu.restriction.$num(u))))
                                : ((E = lu(xu.restriction.$num(u), { bonus: e })), (t = Pu.AVAILABLE));
                        const D = i()(Tu.status, Tu[`status__${t}`]),
                            o = i()(Tu.statusTitle, Tu[`statusTitle__${t}`]);
                        return B().createElement(
                            'div',
                            { className: D },
                            B().createElement('div', { className: o }, E),
                            Boolean(n) && B().createElement('div', { className: Tu.statusExtraInfo }, n),
                        );
                    },
                    Ru = {
                        base: 'TooltipContent_base_d3',
                        header: 'TooltipContent_header_7e',
                        container: 'TooltipContent_container_aa',
                        icon: 'TooltipContent_icon_18',
                        title: 'TooltipContent_title_42',
                        multiplier: 'TooltipContent_multiplier_74',
                        progressionStatus: 'TooltipContent_progressionStatus_2a',
                        indicator: 'TooltipContent_indicator_34',
                        usesCount: 'TooltipContent_usesCount_6d',
                        usesCountActual: 'TooltipContent_usesCountActual_15',
                    },
                    Nu = R.strings.postbattle_screen.ExpBonusTooltip,
                    Ou = ({ data: u }) => {
                        const e = u.bonusMultiplier,
                            ...
                            n = lu(Nu.description(), { count: A, bonus: e }),
                            D = t
                                ? B().createElement(
                                      B().Fragment,
                                      null,
                                      Nu.countLeft(),
                                      B().createElement('span', { className: Ru.usesCountActual }, t),
                                      E,
                                  )
                                : Nu.noUsagesRemaining();
                        return B().createElement(
                            'div',
                            { className: Ru.base },
                            B().createElement(
                                ...
                                B().createElement(
                                    'div',
                                    { className: Ru.icon },
                                    B().createElement('div', { className: Ru.multiplier }, F),
                                ),
                                B().createElement(
                                    pu,
                                    null,
                                    B().createElement(
                                        ...
                                        B().createElement('div', { className: Ru.title }, Nu.title()),
                                        B().createElement(
                                            'div',
                                            { className: Ru.progressionStatus },
                                            B().createElement(
                                                'div',
                                                { className: Ru.indicator },
                                                B().createElement(yu, { total: A, fill: t, reverse: !0 }, (u) =>
                                                    B().createElement(bu, { isActive: u }),
                                                ),
                                            ),
                                            B().createElement('div', { className: Ru.usesCount }, D),
                                        ),
                                    ),
                                ),
                            ),
                            B().createElement(
                                pu,
                                { holderStyle: vu.PRIMARY },
                                B().createElement('div', { className: Ru.description }, n),
                            ),
                            B().createElement(pu, null, B().createElement(Su, u)),
                        );
                    },
