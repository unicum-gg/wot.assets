    ...
    var __webpack_modules__ = {
            ...
            147: (u, e, t) => {
                ...
                const f = {
                    ...
                    M = (u) => {
                        ...
                        const n = v(),
                            ...
                            s = n.mediaHeight,
                            o = n.mediaSize;
                        return a().createElement('div', x({ className: C()(t, f[i], S[s], L[o]) }, r), e);
                    },
                    O = ['children'],
                    y = (u) => {
                        let e = u.children,
                ...
                class G extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            A = C()(k.base, k[`base__${i}`], k[`base__${n}`], null == s ? void 0 : s.base),
                            d = C()(k.icon, k[`icon__${i}`], k[`icon__${n}`], null == s ? void 0 : s.icon),
                            m = C()(k.glow, null == s ? void 0 : s.glow),
                            F = C()(k.caption, k[`caption__${i}`], null == s ? void 0 : s.caption),
                            D = C()(k.goto, null == s ? void 0 : s.goto);
                                            ...
                                            a = requestAnimationFrame(() => {
                                                (a = null),
                                                    (r = (() => {
                                                        ...
                                                        r.forEach(
                                                            (u) => (u.style.minWidth = `${i.O.view.pxToRem(a)}rem`),
                                                        );
                                                    })());
                                            });
                                        })),
                ...
                const Mu = (u, e, t) => {
                    ...
                    yu = (u, e, t = Su.left) => u.split(e).reduce(t === Su.left ? Mu : Ou, []),
                    Pu = (() => {
                        const u = new RegExp(
                    ...
                    Iu = ({ binding: u, text: e = '', classMix: t, alignment: n = Su.left }) =>
                        null === e
                ...
                const re = ({ format: u, value: e }) => {
                    ...
                    ae = [
                        ...
                        Ku.WtStamp,
                        Ku.WtTicket,
                        Ku.WtMainPrizeDiscount,
                        Ku.WtHunter,
                        Ku.WtHunterCollection,
                    ],
                    ne = [Ku.Gold, Ku.Credits, Ku.Crystal, Ku.FreeXp],
                    ie = [Ku.BattlePassPoints],
                    se = [Ku.PremiumPlus, Ku.Premium],
                ...
                const Be = R.strings.winback.winbackRewardView,
                    Ce = (0, z.Pi)(() => {
                        const u = su(),
                            e = u.model,
                            t = u.controls,
                            n = (0, r.useContext)(gt).secondRowRewardsShowed,
                            i = mu(`.${ou.base}`)[0],
                            s = e.progressionName.get(),
                        ...
                        return e.isFirstProgressionStep.get()
                            ? a().createElement(
                                  ...
                                  a().createElement(
                                      _u,
                                      De({ onClick: t.showQuests, type: lu.primary }, E),
                                      Be.buttons.showQuests(),
                                  ),
                              )
                            : o
                              ? a().createElement(
                                    'div',
                                    { className: C()(Au, du), ref: i },
                                    a().createElement(
                                        _u,
                                        De({ onClick: t.selectReward, type: lu.primary }, E),
                                        Be.buttons.selectReward(),
                                    ),
                                    a().createElement(
                                        _u,
                                        De({ onClick: t.close, type: lu.secondary }, E),
                                        Be.buttons.confirm(),
                                    ),
                                )
                              : e.computes.hasOnlyVehicleForGiftReward()
                                ? a().createElement(
                                      ...
                                      a().createElement(
                                          _u,
                                          De({ onClick: t.showVehicle, type: lu.primary }, E),
                                          Be.buttons.showVehicle(),
                                      ),
                                      a().createElement(
                                          _u,
                                          De({ onClick: t.close, type: lu.secondary }, E),
                                ...
                                : a().createElement(
                                      ...
                                      l !== q.PROGRESSION_STEP &&
                                          a().createElement(Yu, {
                                              ...
                                              text: Ae(Be.finalStage, s, 'complete'),
                                          }),
                                      a().createElement(
                                          _u,
                                          De({ type: lu.primary, onClick: t.close }, E),
                                          Be.buttons.confirm(),
                                      ),
                                  );
                    }),
                ...
                const Re = (u, e) => {
                        return {
                            ...
                            tooltipArgs: Ee({ [j]: u.tooltipId }, Number(u.tooltipContentId), { ignoreShowDelay: !0 }),
                        };
                        var t;
                    },
                    ve = (u) => Math.sqrt(1 - Math.pow(u - 1, 2)),
                    Te = ({ index: u = 0, delay: e = 0, onEnd: t, children: r }) => {
                        const n = (0, we.useSpring)({
                        ...
                        return a().createElement(we.animated.div, { className: 'AnimatedReward_base_6f', style: n }, r);
                    },
                    xe = {
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Le(t, d, { isMouseEvent: !0, on: !0, arguments: Se(a) }, b),
                                    C && C(),
                ...
                const Ge = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return a().createElement(He, e, r);
                        const n = e.contentId,
                            i = e.args,
                            s = null == i ? void 0 : i.contentId;
                        return n || s
                            ? a().createElement(Me, Ue({}, e, { contentId: n || s }), r)
                    ...
                    Ve = ({ size: u, bonus: e, className: t }) => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: C()(We.base, We[`base__size${u}`], t) },
                                a().createElement('div', {
                                    className: We.image,
                                ...
                                a().createElement(
                                    'div',
                                    { className: C()(We.value, We[`value__${i}`], We[`value__${l}`]) },
                                    _,
                                    i === Qu.PremiumPlus &&
                                        '14' === o &&
                                        a().createElement(Iu, {
                                            text: R.strings.winback.winbackRewardView.premiumPlus(),
                                            classMix: We.premiumPlusText,
                                        }),
                                ),
                            ),
                        );
                    ...
                    Qe = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Ze = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Je = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                        ...
                        return a().createElement(Iu, { text: o, classMix: t, binding: i });
                    }),
                    ut = {
                    ...
                    et = R.strings.winback.winbackRewardView.selectableReward,
                    tt = ({
                        tooltipId: u,
                        tooltipContentId: e,
                        vehicleLvl: t,
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: C()(ut.base, ut[`base__size${n}`], i) },
                                a().createElement(
                                    'div',
                                    { className: ut.image },
                                ...
                                l && 0 !== o && 0 !== s
                                    ? a().createElement(Iu, {
                                          ...
                                          binding: {
                                              level: E,
                                              expDiscount: a().createElement(Je, {
                                                  text: et.expDiscount(),
                                                  binding: { expDiscount: o },
                                                  classMix: ut.title__bold,
                                              }),
                                              priceDiscount: a().createElement(Je, {
                                                  text: et.priceDiscount(),
                                    ...
                                    : a().createElement(Iu, {
                                          text: l ? et.reserveDiscount() : et.gift(),
                                          binding: { level: E },
                                          classMix: ut.title,
                                      }),
                            ),
                    ...
                    at = { 180: '180x135', 360: '360x270', 600: '600x450' },
                    nt = R.strings.winback.winbackRewardView.vehicleReward,
                    it = ({
                        name: u,
                        tooltipId: e,
                        tooltipContentId: t,
                        ...
                        return a().createElement(
                            Ge,
                            { tooltipArgs: Ee({ [j]: e }, Number(t), { ignoreShowDelay: !0 }) },
                            a().createElement(
                                'div',
                                { className: C()(rt.base, rt[`base__size${E}`], _) },
                                a().createElement(
                                    'div',
                                    ...
                                    m && a().createElement('div', { className: rt.rentImage }),
                                    F && a().createElement('div', { className: rt.discountMark }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: rt.title },
                                ...
                                a().createElement(
                                    ...
                                    m &&
                                        a().createElement(
                                            ...
                                            a().createElement(Iu, { text: nt.rent(), binding: { days: c } }),
                                        ),
                                    F &&
                                        a().createElement(
                                            a().Fragment,
                                                ...
                                                a().createElement(Iu, {
                                                    ...
                                                    binding: {
                                                        expDiscount: a().createElement(Je, {
                                                            ...
                                                            classMix: rt.discountText__bold,
                                                        }),
                                                        priceDiscount: a().createElement(Je, {
                                                    ...
                                                    classMix: rt.discountText,
                                                }),
                                            p &&
                                                a().createElement(Iu, {
                                                    text: nt.exp.discount(),
                                                    binding: {
                                                        expDiscount: a().createElement(Je, {
                                                            text: nt.expDiscount(),
                                                            binding: { expDiscount: d },
                ...
                const ot = {
                    ...
                    Et = (0, z.Pi)(({ reward: u }) => {
                        ...
                        switch (u.name) {
                            ...
                            case Y.VEHICLE_FOR_RENT:
                                return a().createElement(it, st({}, u, { size: i }));
                            case Y.SELECTABLE_VEHICLE_FOR_GIFT:
                            case Y.SELECTABLE_VEHICLE_DISCOUNT:
                                return a().createElement(tt, st({}, u, { size: i }));
                            default:
                                return a().createElement(Ve, {
                                    bonus: u,
                                    size: s,
                                    className: C()(xe.reward, n && xe[`reward__offset${s}`]),
                                });
                        }
                    }),
                    ct = {
                    ...
                    _t = ({
                        ...
                        return a().createElement(
                            'div',
                            { className: C()(ct.base, ct[`base__${r}`], l), style: o },
                            a().createElement(
                                Ge,
                                { tooltipArgs: c, className: ct.tooltipWrapper },
                                a().createElement(
                                    a().Fragment,
                                    null,
                                    a().createElement(
                                        'div',
                                        { className: C()(ct.image, null == E ? void 0 : E.image) },
                                        A &&
                                            a().createElement('div', {
                                                className: C()(ct.highlight, null == E ? void 0 : E.highlight),
                                                style: {
                                        ...
                                        e &&
                                            a().createElement('div', {
                                                className: C()(ct.icon, null == E ? void 0 : E.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        d &&
                                            a().createElement('div', {
                                                className: C()(ct.overlay, null == E ? void 0 : E.overlay),
                                                style: {
                            ...
                            t &&
                                a().createElement(
                                    ...
                                    { tooltipArgs: _ },
                                    a().createElement('div', {
                                        className: C()(ct.timer, null == E ? void 0 : E.periodicIcon),
                                    }),
                                ),
                        );
                    },
                    At = 'SecondRowRewardsResolver_reward_2c',
                    dt = {
                    ...
                    mt = ({
                        ...
                        return a().createElement(
                            Ge,
                            { tooltipArgs: Ee({ [j]: t }, Number(r), { ignoreShowDelay: !0 }) },
                            a().createElement(
                                'div',
                                { className: C()(dt.base, dt[`base__${s}`], o) },
                                a().createElement(
                                    'div',
                                ...
                                a().createElement('div', { className: dt.name }, i),
                            ),
                        );
                    };
                function Ft() {
                ...
                const Dt = ({ reward: u }) => {
                    ...
                    Ct = (0, z.Pi)(() => {
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: C()(Bt.base, o.length && Bt.base__withSecondRow) },
                                a().createElement(
                                    'div',
                                    { className: Bt.firstRow },
                                    n && !A && a().createElement('div', { className: Bt.glow }),
                                    a().createElement(
                                        'div',
                                        { className: Bt.ribbonWrapper },
                                        a().createElement('div', { className: C()(Bt.ribbon, e && Bt.ribbon__gold) }),
                                    ),
                                    t && !A && a().createElement('div', { className: Bt.lines }),
                                    s.map((u, e) =>
                                        a().createElement(
                                            Te,
                                            {
                                ...
                                Boolean(o.length) &&
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: Bt.secondRow },
                                        a().createElement(
                                            'div',
                                            { className: Bt.secondRowTitle },
                                            R.strings.winback.winbackRewardView.secondRowTitle(),
                                        ),
                                        a().createElement(
                                            'div',
                                            { className: Bt.secondRowRewards },
                                            o.map((u, e) =>
                                                a().createElement(
                                                    Te,
                                                    {
                    ...
                    ht = (0, z.Pi)(() => {
                        ...
                        const F = Boolean(e.computes.getSecondRowRewards().length),
                            D = `R.images.winback.gui.maps.icons.rewardsView.bg_${e.progressionName.get()}${s ? '_dds' : ''}`;
                        return a().createElement(
                            gt.Provider,
                            { value: d },
                            a().createElement(
                                ...
                                a().createElement('div', { className: 'App_header_a0' }, a().createElement(be, null)),
                                a().createElement(
                                    'div',
                ...
                engine.whenReady.then(() => {
                    N().render(
                        a().createElement(iu, null, a().createElement(y, null, a().createElement(ht, null))),
