(() => {
    var __webpack_modules__ = {
            ...
            916: (e, u, t) => {
                ...
                const p = r.instance,
                    f = {
                        ...
                        sendMoveEvent: (e) => g(n.MOVE, { isMouseEvent: !0, on: e }),
                        sendCloseEvent: D,
                        sendClosePopOverEvent: () => g(n.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (e, u, t = 0) => {
                            g(n.CONTEXT_MENU, { isMouseEvent: !0, contentID: e, on: !0, decoratorID: t, args: u });
                        },
            ...
            152: (e, u, t) => {
                ...
                var N;
                function k(e = F.O.client.getSize('rem')) {
                    const u = e.width,
                        t = e.height;
                ...
                (0, A.memo)((e) => {
                    ...
                    const a = (0, A.useContext)(T),
                        ...
                        D = { extraLarge: E, large: b, medium: F, small: C, extraSmall: g };
                ...
                const J = (e) => {
                        ...
                        return b().createElement(
                            ...
                            b().createElement(
                                'div',
                                { className: r()(X.value, A && X.value__text) },
                                F ? c : E,
                        ...
                        return b().createElement(
                            ...
                            b().createElement(
                                ...
                                b().createElement(
                                    ...
                                    {
                                        id: d,
                                        className: r()(de.base, a && de.base__disabled, F && de.base__isNotStarted),
                                        onClick: () => {
                                            (s({ index: e, size: u, cardMediaSize: C }), ce.playClick());
                                        },
                                        onMouseEnter: p,
                                        onMouseLeave: f,
                                    },
                                    ...
                                    b().createElement('div', { className: r()(de.hover, B && !F && de.hover__anim) }),
                ...
                const ge = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    const r = u.contentId;
                    return r ? b().createElement(ae, Ce({}, u, { contentId: r }), a) : b().createElement(ie, u, a);
                };
                var De = t(45);
                const Be = {
                ...
                const xe = { [fe.NBSP]: he.NoBreakSymbol, [fe.ZWNBSP]: he.NoBreakSymbol, [fe.NEW_LINE]: he.LineBreak },
                    ...
                    ke = (e) => ({ color: `#${e}` }),
                    Le = ({ elementList: e, textBlock: u, key: t }) => {
                        const a = u.colorTag;
                        return a
                            ? we[a]
                                ? b().createElement(
                            ...
                            : b().createElement('span', { key: t, 'data-block-type': u.blockType, className: Ne }, e);
                    },
                    Te = {
                        [he.Word]: Le,
                        [he.NoBreakSymbol]: Le,
                    ...
                    We = ve
                        ...
                        : (e, u) => {
                              ...
                              let _ = 0;
                              for (; a; ) {
                                  const i = u.justifyContent === pe.FlexEnd ? a.index : t.lastIndex;
                    ...
                    Me = (e, u = '', t) => {
                        ...
                        return (
                            Se(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (e) => {
                                    a.push({ blockType: he.Word, colorTag: u, childList: We(e, t) });
                                },
                                (e) => {
                                    const t = e[0],
                                        r = xe[t.charAt(0)];
                            ...
                            Se(
                                ...
                                (e) => {
                                    ...
                                    'string' == typeof i || 'number' == typeof i
                                        ? r.push(...Me(String(i), t, a))
                                        : r.push({ blockType: he.Binding, colorTag: t, childList: [i] });
                                },
                            ),
                            r
                        );
                            ...
                            return (
                                e.forEach((e) => {
                                    e.blockType === he.NoBreakSymbol
                                        ? ((t = !0), u.push(...Ie(u.pop(), e)))
                                        : (t ? u.push(...Ie(u.pop(), e)) : u.push(e), (t = !1));
                                }),
                                u
                            );
                        })(
                    ...
                    je = (e, u, t, a, r, _) => {
                        ...
                        for (let o = t; o >= 0; o--) {
                            ...
                            if (l === he.LineBreak || l === he.NewLine || l === he.Binding) continue;
                    ...
                    Ge = b().memo(
                        ({
                            ...
                            const c = (0, A.useRef)(null),
                                ...
                                F = E[0],
                                C = E[1],
                                g = (0, A.useMemo)(() => Pe(e, a, { justifyContent: l }), [a, l, e]),
                                D = (0, A.useMemo)(() => {
                                    if (
                                        _ &&
                                        F.isTruncated &&
                                ...
                                b().createElement(
                                    'div',
                                    {
                                        className: r()(
                                            ...
                                            i && Be.base__isTruncationAvailable,
                                        ),
                                        style: h,
                                    },
                                    b().createElement('div', { className: Be.unTruncated, ref: c }, g),
                                    b().createElement(
                                        ge,
                                        {
                                            tooltipArgs: D,
                                        ...
                                        b().createElement(
                                            'div',
                                            {
                                                className: r()(
                                                    Be.truncated,
                                                    !F.isTruncateFinished && i && Be.truncated__hide,
                                                ),
                                                style: h,
                                            },
                ...
                const Ve = { [Ae.LowRisk]: Fe.Normal, [Ae.MediumRisk]: Fe.Alert, [Ae.HighRisk]: Fe.Blocker },
                    Ke = R.strings.mode_selector.mode,
                    qe = ({ size: e, performanceRisk: u = Ae.LowRisk, modeName: t, cut: a, textFolder: _ }) => {
                        var i;
                        const n = _ || Ke.$dyn(t),
                            o = (0, A.useMemo)(() => {
                                if (n && n.performance) {
                                    ...
                                    if (e) {
                                        ...
                                        return {
                                            args: { header: t, body: r, headerType: a ? Ve[u] : Fe.Normal },
                                            contentId: _,
                                            decoratorId: i,
                                        };
                                    }
                        ...
                        if (u === Ae.LowRisk || !n || null == n || !n.performance) return null;
                        const l = (null == (i = n.performance) ? void 0 : i.$dyn(u)).headerIcon();
                        return b().createElement(
                            ae,
                            Ue({}, o, { isEnabled: Boolean(o) }),
                            a
                                ? b().createElement('div', { className: r()(be.iconBig, be[`iconBig__${u}`]) })
                                : b().createElement(
                                      'div',
                                      { className: r()(be.base, be[`base__${e}`], be[`base__${u}`]) },
                                      b().createElement(Ge, {
                                          classMix: be.text,
                                          text: l,
                                          isTruncationAvailable: e === j.B2,
                                          binding: { icon: b().createElement('div', { className: be.icon }) },
                ...
                const Au = (e) => {
                    ...
                    const Ne = r()(
                        ...
                        ke = r()(ou.mask, $[`mask__${Q}`], ge && ou.mask__static, De && ou.mask__anim),
                        Le = r()(
                            $.subtitle,
                            $[`subtitle__${Q}`],
                            (t || !me) && ou.subtitle__normal,
                            !Fe && ou.subtitle__noReward,
                            g && me && ou.subtitle__statusActive,
                            g && se && ou.subtitle__staticPrepare,
                        ...
                        Te = r()(
                            ...
                            Fe && ou.statusDescription__color,
                        ),
                        ...
                        We = r()(ou.widgetOverlay, !Ce && ou.widgetOverlay__hide, null == y ? void 0 : y.widgetOverlay);
                    return b().createElement(
                        'div',
                        ...
                        b().createElement(
                            ...
                            pe && b().createElement(nu, { size: Q, rewardsList: C }),
                            a &&
                                b().createElement(
                                    'div',
                            ...
                            c && b().createElement('div', { className: We }, c),
                            o,
                            (!Ce || w) &&
                                b().createElement(
                                    'div',
                ...
                const pu = {
                        [gu.ExtraSmall]: '',
                        [gu.Small]: Fu().SMALL_WIDTH,
                        [gu.Medium]: `${Fu().SMALL_WIDTH} ${Fu().MEDIUM_WIDTH}`,
                        [gu.Large]: `${Fu().SMALL_WIDTH} ${Fu().MEDIUM_WIDTH} ${Fu().LARGE_WIDTH}`,
                        [gu.ExtraLarge]: `${Fu().SMALL_WIDTH} ${Fu().MEDIUM_WIDTH} ${Fu().LARGE_WIDTH} ${Fu().EXTRA_LARGE_WIDTH}`,
                    },
                    fu = {
                        [Du.ExtraSmall]: '',
                        [Du.Small]: Fu().SMALL_HEIGHT,
                        [Du.Medium]: `${Fu().SMALL_HEIGHT} ${Fu().MEDIUM_HEIGHT}`,
                        [Du.Large]: `${Fu().SMALL_HEIGHT} ${Fu().MEDIUM_HEIGHT} ${Fu().LARGE_HEIGHT}`,
                        [Du.ExtraLarge]: `${Fu().SMALL_HEIGHT} ${Fu().MEDIUM_HEIGHT} ${Fu().LARGE_HEIGHT} ${Fu().EXTRA_LARGE_HEIGHT}`,
                    },
                    xu = {
                        [Cu.ExtraSmall]: '',
                        [Cu.Small]: Fu().SMALL,
                        [Cu.Medium]: `${Fu().SMALL} ${Fu().MEDIUM}`,
                        [Cu.Large]: `${Fu().SMALL} ${Fu().MEDIUM} ${Fu().LARGE}`,
                        [Cu.ExtraLarge]: `${Fu().SMALL} ${Fu().MEDIUM} ${Fu().LARGE} ${Fu().EXTRA_LARGE}`,
                    },
                    vu = (e) => {
                        let u = e.children,
                            t = e.className,
                    ...
                    Ru = (0, A.memo)(
                        ({ size: e, lineRef: u, disabled: t, baseStyles: a, isComplete: _, withoutBounce: i }) => {
                            ...
                            return b().createElement(
                                ...
                                b().createElement('div', { className: Mu.pattern }),
                                b().createElement('div', { className: Mu.gradient }),
                                o && b().createElement(Wu, { size: e }),
                            );
                        },
                    ),
                    Iu = (e, u) => {
                ...
                const Xu = (0, A.memo)((e) => {
                    ...
                    Zu = ({ size: e, value: u, lineRef: t, disabled: a, onComplete: r }) => {
                        ...
                        return (
                            ...
                            b().createElement(Ru, { size: e, disabled: a, baseStyles: _, isComplete: i, lineRef: t })
                        );
                    },
                    Qu = ['onEndAnimation'];
                function Ju() {
                ...
                const tt = (0, A.memo)(
                    ...
                    at = (e) => {
                        var u, t, a, r, _, i, n, o, l, s, m, c, d, E, A, b, F, C, g, D;
                        return {
                    ...
                    _t = (e, u, t) => ('number' == typeof t ? (rt(0, u, t) / u) * 100 : e),
                    it = {
                    ...
                    ot = (0, A.memo)(
                        ({
                            ...
                            const F = (function (e, u, t) {
                                return (0, A.useMemo)(() => {
                                    const a = (rt(0, u, e) / u) * 100;
                                    return { value: a, deltaFrom: _t(a, u, t) };
                                }, [t, u, e]);
                            })(n, e, o);
                            return b().createElement(
                                'div',
                    ...
                    mt = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    ct = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    dt = (0, A.memo)(({ text: e, binding: u, classMix: t }) => {
                        const a = (0, A.useCallback)((e) => ({ color: `#${e}` }), []),
                            r = (0, A.useMemo)(() => u || {}, [u]);
                        let _ = st.exec(e),
                            i = e,
                    ...
                    Et = R.strings.mode_selector.mode.comp7Light,
                    At = {
                        freezed: !1,
                        withStack: !1,
                        type: yu.Growing,
                    ...
                    bt = ({ status: e = ku.ACTIVE, currentStage: u, stageCurrentPoints: t, stageMaximumPoints: a }) =>
                        b().createElement(
                            'div',
                                ...
                                t !== a &&
                                    ...
                                    b().createElement(
                                        ...
                                        b().createElement(
                                            ...
                                            b().createElement(dt, { text: Et.steps(), binding: { done: t, total: a } }),
                    ...
                    gt = ({ size: e, isCompletedProgression: u }) => {
                        const t = Y(),
                            a = O([...K('icon')], Ft),
                            _ = cu[e][t];
                        return b().createElement(
                ...
                var Bt, ht;
                ((Bt = R.views.comp7_light.lobby.Comp7LightBattleCard()),
                    (ht = (e) => {
                        const u = e.size,
                            t = e.widget,
                            a = e.showWidget,
                                ...
                                Dt(
                                    {
                                        ...
                                        belowStatusComponent: r && b().createElement(bt, t),
