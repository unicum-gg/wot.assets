    ...
    var __webpack_modules__ = {
            ...
            7952: (u, e, t) => {
                ...
                class k extends i().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = w()(f.base, f[`base__${r}`], f[`base__${a}`], null == E ? void 0 : E.base),
                            _ = w()(f.icon, f[`icon__${r}`], f[`icon__${a}`], null == E ? void 0 : E.icon),
                            B = w()(f.glow, null == E ? void 0 : E.glow),
                            C = w()(f.caption, f[`caption__${r}`], null == E ? void 0 : E.caption),
                            c = w()(f.goto, null == E ? void 0 : E.goto);
                ...
                const O = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    T = R.strings.veh_post_progression.slides,
                    L = R.images.gui.maps.icons.vehPostProgression.info.slides,
                    P = O ? '_arabic_numbers' : '',
                    N = [
                        {
                            title: T.fieldModernization.infoTitle(),
                            content: [{ image: L.$dyn(`c_1${P}`), text: T.fieldModernization.description() }],
                        },
                        {
                            title: T.modificationTree.infoTitle(),
                            content: [{ image: L.$num(2), text: T.modificationTree.description() }],
                        },
                        {
                            title: T.baseModifications.title(),
                            content: [{ image: L.$dyn(`c_3${P}`), text: T.baseModifications.description() }],
                        },
                        {
                            title: T.pairedModifications.title(),
                            content: [{ image: L.$dyn(`c_4${P}`), text: T.pairedModifications.description() }],
                        },
                        {
                            title: T.alternativeEquipment.title(),
                            content: [{ image: L.$num(6), text: T.alternativeEquipment.description() }],
                        },
                        {
                            title: T.requiredEquipment.title(),
                            content: [{ image: L.$dyn(`c_5${P}`), text: T.requiredEquipment.description() }],
                        },
                        {
                            title: T.additionalEquipment.title(),
                            content: [{ image: L.$dyn(`c_8${P}`), text: T.additionalEquipment.description() }],
                        },
                        {
                            title: T.extraModification.title(),
                            content: [{ image: L.$dyn(`c_7${P}`), text: T.extraModification.description() }],
                        },
                        {
                            title: T.roleInBattle.title(),
                            content: [{ image: L.$num(9), text: T.roleInBattle.description() }],
                        },
                    ],
                    H = 'App_base_93',
                    I = 'App_close_0f',
                        ...
                        return (
                            ...
                            i().createElement(
                                ...
                                i().createElement(
                                    ...
                                    i().createElement(y.i, {
                                        onSlideChange: a,
                                        slides: N.map((u, e) => i().createElement(M.M, { key: e, slide: u })),
