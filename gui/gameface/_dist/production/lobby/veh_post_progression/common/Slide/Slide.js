        ...
        A = {
            ...
            1039: (u, A, F) => {
                var e = F(6179),
                    ...
                    n = F(5067);
                (0, e.memo)(({ children: u }) => {
                    const A = (0, e.useContext)(B.Y),
                        F = (0, e.useState)(A),
                        i = F[0],
                        r = F[1],
                        a = (0, e.useCallback)((u, A) => {
                            const F = n.O.view.pxToRem(u),
                                e = n.O.view.pxToRem(A);
                            r(Object.assign({ width: F, height: e }, (0, C.T)(F, e, t.j)));
                        }, []);
                    ((0, D.Z)(() => {
                    ...
                    return E().createElement(B.Y.Provider, { value: l }, u);
                });
            },
            6010: (u, A, F) => {
                var e = F(6179),
                ...
                const t = (u) => {
                    ...
                    const t = (0, e.useContext)(D.Y),
                        ...
                        w = { extraLarge: g, large: c, medium: h, small: x, extraSmall: v };
                    if (F.extraLarge || F.large || F.medium || F.small || F.extraSmall) {
                        if (F.extraLarge && C) return A;
                        if (F.large && n) return A;
                        if (F.medium && i) return A;
                        if (F.small && r) return A;
                        ...
                        if (!(
                            ...
                            if (F.smallHeight && x) return A;
                            if (F.extraSmallHeight && v) return A;
                        }
                    }
                    return null;
                };
            ...
            7382: (u, A, F) => {
                F.d(A, { H: () => e });
                const e = (u, A, F) =>
                    A.extraLargeHeight || A.largeHeight || A.mediumHeight || A.smallHeight || A.extraSmallHeight
                        ? (A.extraLargeHeight && F.extraLarge) ||
                          (A.largeHeight && F.large) ||
                          (A.mediumHeight && F.medium) ||
                          (A.smallHeight && F.small) ||
                          (A.extraSmallHeight && F.extraSmall)
                            ? u
                            : null
                        : u;
            },
            ...
            5262: (u, A, F) => {
                var e;
                function E(u, A, F) {
                    const e = (function (u, A) {
                            switch (!0) {
                                case u >= A.extraLarge.width:
                                    return A.extraLarge.weight;
                                case u >= A.large.width && u < A.extraLarge.width:
                                    return A.large.weight;
                                case u >= A.medium.width && u < A.large.width:
                                    return A.medium.weight;
                                case u >= A.small.width && u < A.medium.width:
                                    return A.small.weight;
                                default:
                                    return A.extraSmall.weight;
                            }
                        })(u, F),
                        E = (function (u, A) {
                            switch (!0) {
                                case u >= A.extraLarge.height:
                                    return A.extraLarge.weight;
                                case u >= A.large.height && u < A.extraLarge.height:
                                    return A.large.weight;
                                case u >= A.medium.height && u < A.large.height:
                                    return A.medium.weight;
                                case u >= A.small.height && u < A.medium.height:
                                    return A.small.weight;
                                default:
                                    return A.extraSmall.weight;
                            }
                    ...
                    return {
                        ...
                        extraLargeWidth: e === F.extraLarge.weight,
                        largeWidth: e === F.large.weight,
                        mediumWidth: e === F.medium.weight,
                        smallWidth: e === F.small.weight,
                        extraSmallWidth: e === F.extraSmall.weight,
            ...
            5067: (u, A, F) => {
                ...
                function W(u = 'rem') {
                    ...
                    return 'rem' === u ? A : { x: P(A.x), y: P(A.y) };
                }
                function z() {
            ...
            9924: (u, A, F) => {
                ...
                function n(u, A, F) {
                    ...
                    let n = Object.entries(e).filter(([u, A]) => !0 === A && u in B.u);
                    return (
                        F && (n = n.filter((u) => F.includes(u[0]))),
                        u.reduce((u, F) => {
                            const e = n.map((u) =>
                                E()(A[((u, A) => u + '__' + A)(F, u[0])], A[((u, A) => u + (0, C.e)(A))(F, u[0])]),
                            );
                            return ((u[F] = E()(A[F], ...e)), u);
                        }, {})
                    );
                }
            },
            3649: (u, A, F) => {
                ...
                const D = (u, A, F) => {
                    ...
                    t = (u, A, F = e.left) => u.split(A).reduce(F === e.left ? D : B, []),
                    C = (() => {
                        const u = new RegExp(
                        ...
                        return n.includes(F)
                            ...
                            : ((u, A = e.left) => {
                                  ...
                                  const E =
                                      ...
                                      D = u.replace(/&nbsp;/g, ' ');
                                  return (t(D, /( )/, A).forEach((u) => (F = F.concat(t(u, E, e.left)))), F);
                              })(u, A);
                    },
            ...
            6565: (u, A, F) => {
                ...
                const C = 'FormatText_base_d0',
                    n = ({ binding: u, text: A = '', classMix: F, alignment: D = t.v2.left }) =>
                        null === A
            ...
            2861: (u, A, F) => {
                ...
                const r = { accent: n.descriptionTagAccent },
                    a = ({ content: u, size: A = i.BIG }) => {
                        const F = (0, t.Z)(['imageWrapper', 'description', 'base'], n),
                            D = (0, e.useMemo)(() => ({ backgroundImage: `url(${u.image})` }), [u.image]),
                            a = B()(F.base, n[`base__${A}`]);
            ...
            2132: (u, A, F) => {
                ...
                E().memo(({ slide: u }) => {
                    const A = (0, D.Z)(['title', 'content'], t);
                    return E().createElement(
                        'div',
                        { className: t.base },
                        E().createElement('div', { className: A.title }, u.title),
                        E().createElement(
                            'div',
                            { className: t.content },
                            u.content.map((A, F) =>
                ...
                const D = ({ text: u, className: A }) =>
                    E().createElement(
                        ...
                        String(u)
                            .split(' ')
                            .map((u, F, e) =>
                                E().createElement('div', { className: A, key: F }, e.length - 1 === F ? u : u + ' '),
                            ),
                    );
            },
        },
        ...
        (e.O = (A, F, E, D) => {
            if (!F) {
                ...
                for (i = 0; i < u.length; i++) {
                    for (var [F, E, D] = u[i], t = !0, C = 0; C < F.length; C++)
