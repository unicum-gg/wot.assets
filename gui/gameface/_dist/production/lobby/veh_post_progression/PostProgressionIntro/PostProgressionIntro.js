(() => {
    ...
    var __webpack_modules__ = {
            ...
            5191: (u, e, t) => {
                ...
                (0, n.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraSmallWidth && d) return (0, i.H)(e, t, p);
                        if (
            ...
            5528: (u, e, t) => {
                ...
                const g = {
                    ...
                    f = { play: Object.assign({}, p, { sound: _ }), setRTPC: d };
                var b = t(1308);
                function w(u, e, t = 1) {
            ...
            9713: (u, e, t) => {
                ...
                const c = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    ...
                    m = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: i, modelPath: d(i, u || ''), resId: n };
                            })(),
                            t = e.modelPrefix,
                            n = u.split('.');
                        if (n.length > 0) {
                        ...
                        B(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = m(u);
                                d.current = h.addCallback(n, t, E, e === v.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== v.None)
                                return () => {
                                    h.removeCallback(d.current, E);
                                };
                        }, [E, e]),
                        s
                    );
                ...
                const S = (u) => {
                    ...
                    const h = (0, n.useCallback)(
                            (u) => {
                                (null == o || o(u), E.O.sound.play.sound(d));
                            },
                            [o, d],
                        ),
                        v = (0, n.useCallback)(
                    ...
                    return i().createElement(
                        ...
                        y(
                            {
                                className: b()(w.base, w[`base__${B}`], w[`base__${D}`], null == r ? void 0 : r.base),
                                onMouseEnter: h,
                                onMouseLeave: v,
                                onMouseDown: p,
                                onMouseUp: f,
                        ...
                        'info' !== B && i().createElement('div', { className: w.shine }),
                        i().createElement(
                            'div',
                            { className: b()(w.icon, w[`icon__${B}`], w[`icon__${D}`], null == r ? void 0 : r.icon) },
                            i().createElement('div', { className: b()(w.glow, null == r ? void 0 : r.glow) }),
                        ),
                        i().createElement(
                            'div',
                            { className: b()(w.caption, w[`caption__${B}`], null == r ? void 0 : r.caption) },
                            e,
                        ),
                        a && i().createElement('div', { className: b()(w.goto, null == r ? void 0 : r.goto) }, a),
                    );
                };
                var k = t(1906),
                    T = t(7298);
                const O = {
                        base: 'Header_base_e6c6e',
                        base__large: 'Header_base__large_ec8c0',
                        base__extraLarge: 'Header_base__extraLarge_e8f1e',
                    },
                    M = () => {
                        const u = (0, T.Z)(['base'], O);
                        return i().createElement(
                            'div',
                            { className: u.base },
                            R.strings.veh_post_progression.postProgressionIntro.title(),
                        );
                    };
                var P = t(7012),
                    L = t(1308);
                const N = R.strings.veh_post_progression.slides,
                    H = R.images.gui.maps.icons.vehPostProgression.info.slides,
                    I = R.images.gui.maps.icons.vehPostProgression.intro.slides,
                    W = L.qP ? '_arabic_numbers' : '',
                    U = [
                        {
                            title: N.fieldModernization.title(),
                            content: [{ image: H.$dyn(`c_1${W}`), text: N.fieldModernization.description() }],
                        },
                        {
                            title: N.modificationTree.title(),
                            content: [{ image: H.$num(2), text: N.modificationTree.description() }],
                        },
                        {
                            title: N.specialModifications.title(),
                            content: [
                                { image: I.$dyn(`c_1${W}`), text: N.specialModifications.description.c_1.text() },
                                { image: I.$dyn(`c_2${W}`), text: N.specialModifications.description.c_2.text() },
                                { image: I.$dyn(`c_3${W}`), text: N.specialModifications.description.c_3.text() },
                            ],
                        },
                    ],
                    V = 'App_base_f3e1a',
                            ...
                            i().createElement(
                                ...
                                i().createElement(
                                    ...
                                    i().createElement(P.i, {
                                        onSlideChange: a,
                                        onConfirmClick: t,
                                        slides: U.map((u, e) => i().createElement(k.M, { key: e, slide: u })),
                                    }),
                                ),
                            )
                        );
                ...
                engine.whenReady.then(() => {
                    r().render(i().createElement(j, null), document.getElementById('root'));
                });
            },
            4652: (u, e, t) => {
                t.d(e, { d: () => B });
            ...
            7012: (u, e, t) => {
                        ...
                        i().createElement(
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    ...
                                    (null !== g && e && F(g),
                                        A && A(u),
                                        d && (t || (h.current && (h.current.focus(), f(!0)))),
                                        e && x(!0));
                                },
                ...
                const g = (u, e, t = {}, n = 0) => {
                    ...
                    b = 'PaginationRender_base__inaccessible_f4d4d',
                ...
                const M = ({ className: u, selectedStep: e, data: t, onChange: a }) => {
                    ...
                    L = ({
                        ...
                        const l = (0, A.Z)(['base', 'button', 'footer', 'pageCounter'], P),
                            ...
                            h = (0, n.useCallback)(() => {
                                m || (F('play'), e(_, _ + 1), d(_ + 1));
                            }, [_, m, e]),
                            v = (0, n.useCallback)(() => {
                                C || (F('play'), e(_, _ - 1), d(_ - 1));
                            }, [_, C, e]),
                            p = (0, n.useCallback)(
                                (u) => {
                                    (d(u), e(_, u));
                            ...
                            w = E()(l.button, P.button__back, C && P.button__disabled),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 959),
        (() => {
            var u = { 959: 0, 353: 0, 525: 0, 769: 0, 580: 0, 146: 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [428], () => __webpack_require__(9713));
