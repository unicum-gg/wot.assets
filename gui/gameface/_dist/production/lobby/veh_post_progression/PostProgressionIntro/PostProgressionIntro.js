(() => {
    ...
    var __webpack_modules__ = {
            ...
            70: (u, e, t) => {
                ...
                const m = {
                    ...
                    p = { play: Object.assign({}, v, { sound: B }), setRTPC: _ };
                var w = t(9690);
                function b(u, e, t = 1) {
                ...
                const Eu = { view: r, client: i, sound: p, intl: g };
            },
            7902: (u, e, t) => {
                t.d(e, { F: () => n });
                const n = (u = 1) => {
            ...
            7016: (u, e, t) => {
                        ...
                        B(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = m(u);
                                C.current = h.addCallback(n, t, E, e === v.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== v.None)
                ...
                engine.whenReady.then(() => {
                    r().render(i().createElement($, null), document.getElementById('root'));
                });
            },
            6565: (u, e, t) => {
                t.d(e, { d: () => B });
            ...
            4738: (u, e, t) => {
                ...
                const B = ({
                    ...
                    return (
                        (0, n.useEffect)(() => {
                            function u(u) {
                                p && null !== h.current && !h.current.contains(u.target) && w(!1);
                            }
                            return (
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [428], () => __webpack_require__(7016));
