(() => {
    ...
    var __webpack_modules__ = {
            3495: (u, e, t) => {
                ...
                const o = n.O.client.getSize('rem'),
                    E = o.width,
                    s = o.height,
                    A = Object.assign({ width: E, height: s }, (0, r.T)(E, s, a.j)),
                ...
                const A = ({ children: u }) => {
                    const e = (0, a.useContext)(o.Y),
                        ...
                        l = (0, a.useCallback)((u, e) => {
                            ...
                            F(Object.assign({ width: t, height: i }, (0, s.T)(t, i, E.j)));
                        }, []),
                        D = (0, a.useCallback)(() => {
                    ...
                    const c = (0, a.useMemo)(() => Object.assign({}, A), [A]);
            ...
            6010: (u, e, t) => {
                ...
                const o = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && _) return (0, i.H)(e, t, p);
            ...
            9768: (u, e, t) => {
                ...
                const m = {
                    ...
                    v = { play: Object.assign({}, h, { sound: _ }), setRTPC: B };
                var p = t(9690);
                function w(u, e, t = 1) {
            ...
            9924: (u, e, t) => {
                ...
                function s(u, e, t) {
                    ...
                    let s = Object.entries(n).filter(([u, e]) => !0 === e && u in r.u);
                    return (
            ...
            3649: (u, e, t) => {
                ...
                const o = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    A = (u, e, t = i.left) => u.split(e).reduce(t === i.left ? E : s, []),
                    F = (() => {
                        const u = new RegExp(
                    ...
                    D = (u, e = i.left) => {
                        ...
                        return ((u, e = i.left) => {
                            ...
                            const n =
                                ...
                                a = o(u);
                            return A(a, /( )/, e).forEach((u) => (t = t.concat(A(u, n, i.left)))), t;
                        })(u, e);
                    },
            ...
            7233: (u, e, t) => {
                ...
                function l(u = s.n.NONE, e = F, t = !1, i = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== s.n.NONE)
                            return (
                ...
                class k extends i().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = b()(x.base, x[`base__${r}`], x[`base__${a}`], null == o ? void 0 : o.base),
                            c = b()(x.icon, x[`icon__${r}`], x[`icon__${a}`], null == o ? void 0 : o.icon),
                            _ = b()(x.glow, null == o ? void 0 : o.glow),
                            B = b()(x.caption, x[`caption__${r}`], null == o ? void 0 : o.caption),
                            C = b()(x.goto, null == o ? void 0 : o.goto);
                        return i().createElement(
                            ...
                            'info' !== r && i().createElement('div', { className: x.shine }),
                ...
                var P = t(9922),
                    N = t(9690);
                const H = R.strings.veh_post_progression.slides,
                    W = R.images.gui.maps.icons.vehPostProgression.info.slides,
                    I = R.images.gui.maps.icons.vehPostProgression.intro.slides,
                    U = N.qP ? '_arabic_numbers' : '',
                    j = [
                        {
                            title: H.fieldModernization.title(),
                            content: [{ image: W.$dyn(`c_1${U}`), text: H.fieldModernization.description() }],
                        },
                        {
                            title: H.modificationTree.title(),
                            content: [{ image: W.$num(2), text: H.modificationTree.description() }],
                        },
                        {
                            title: H.specialModifications.title(),
                            content: [
                                { image: I.$dyn(`c_1${U}`), text: H.specialModifications.description.c_1.text() },
                                { image: I.$dyn(`c_2${U}`), text: H.specialModifications.description.c_2.text() },
                                { image: I.$dyn(`c_3${U}`), text: H.specialModifications.description.c_3.text() },
                            ],
                        },
                    ],
                    G = 'App_base_5b',
                            ...
                            i().createElement(
                                ...
                                i().createElement(
                                    ...
                                    i().createElement(P.i, {
                                        onSlideChange: a,
                                        onConfirmClick: t,
                                        slides: j.map((u, e) => i().createElement(O.M, { key: e, slide: u })),
                                    }),
                                ),
                            )
                        );
                                ...
                                () =>
                                    t.reduce((u, t, n) => {
                                        const a = ((u) => {
                                            ...
                                            o = `dummyTagBinding${n}`,
                                            E = e[a] || '';
                                        return (u[o] = i().createElement(A.B, { text: r, className: E })), u;
                                    }, {}),
                                [t, e],
                            );
                        return i().createElement(s, { binding: r, text: a, classMix: F });
                    };
            },
            2861: (u, e, t) => {
                t.d(e, { n: () => A, w: () => l });
                ...
                const F = { accent: s.descriptionTagAccent },
                    l = ({ content: u, size: e = A.BIG }) => {
                        const t = (0, o.Z)(['imageWrapper', 'description', 'base'], s),
                            a = (0, n.useMemo)(() => ({ backgroundImage: `url(${u.image})` }), [u.image]),
                            l = r()(t.base, s[`base__${e}`]);
                        return i().createElement(
                            'div',
                            { className: l },
                            i().createElement(
                                ...
                                i().createElement('div', { style: a, className: s.image }),
                            ),
                            i().createElement(
                                'div',
            ...
            9922: (u, e, t) => {
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((f.current.timeoutId = window.setTimeout(S, A ? 100 : 400)),
                                                      a && a(u),
                                                      O && O(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const M = ({ className: u, selectedStep: e, data: t, onChange: a }) => {
                    ...
                    P = ({
                        ...
                        const l = (0, s.Z)(['base', 'button', 'footer', 'pageCounter'], L),
                            c = (0, n.useState)(0),
                            B = c[0],
                            C = c[1],
                            d = (0, n.useMemo)(() => 0 === B, [B]),
                            ...
                            h = (0, n.useCallback)(() => {
                                m || ((0, A.G)('play'), e(B, B + 1), C(B + 1));
                            }, [B, m, e]),
                            v = (0, n.useCallback)(() => {
                                d || ((0, A.G)('play'), e(B, B - 1), C(B - 1));
                            }, [B, d, e]),
                            p = (0, n.useCallback)(
                                (u) => {
                                    C(u), e(B, u);
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [428], () => __webpack_require__(7233));
