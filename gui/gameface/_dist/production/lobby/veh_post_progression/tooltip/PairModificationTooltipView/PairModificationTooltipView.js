    ...
    var __webpack_modules__ = {
            ...
            9768: (u, e, t) => {
                ...
                const J = (() => {
                    ...
                    uu = b.cg,
                    eu = Object.keys(h).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === h[e]), u), {}),
                    tu = {
                        set: (u, e) => {
            ...
            878: (u, e, t) => {
                        ...
                        c(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = C(u);
                                g.current = d.addCallback(n, t, a, e === v.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== v.None)
                ...
                const P = 'Header_base_22',
                    ...
                    M = ({ modificationName: u, level: e }) => {
                        const t = (0, n.useMemo)(
                            () => ({ level: r().createElement('div', { className: x }, (0, y.HG)(e)) }),
                            [e],
                        );
                        return r().createElement(
                            'div',
                            { className: P },
                            r().createElement('div', { className: O }, u),
                            r().createElement(k.z, {
                                classMix: T,
                ...
                const vu = r().forwardRef(function (u, e) {
                        let t = u.children,
                            i = u.className,
                            E = u.theme,
                    ...
                    mu = () => r().createElement(vu, null, r().createElement(lu, null)),
                    pu = document.createElement('div');
                (window.onload = () => document.body.appendChild(pu)), E().render(r().createElement(mu, null), pu);
            },
            7024: (u, e, t) => {
                t.d(e, { f: () => A });
                var n = t(7363),
                        ...
                        return r().createElement(
                            ...
                            g.UI(u, (u, F) => {
                                ...
                                const C = null == (B = g.U2(e, F)) ? void 0 : B.value,
                                    _ = !(a || ((d = u.value), (v = C), void 0 === v || d === v));
                                var d, v;
                                return (
                                    (i || Boolean(u.value)) &&
                                    r().createElement(
                ...
                const k = 'PriceBlock_base_54',
                    ...
                    M = ({ price: u, moneyShortage: e, description: t }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(i.z, { text: t, binding: o, classMix: O }),
                        );
                    };
            },
            8899: (u, e, t) => {
