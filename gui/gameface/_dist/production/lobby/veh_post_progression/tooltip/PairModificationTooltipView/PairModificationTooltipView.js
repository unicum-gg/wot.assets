(() => {
    ...
    var __webpack_modules__ = {
            ...
            280: (u, e, t) => {
                ...
                var E = t(6179),
                    ...
                    r = t(3649),
                    i = t(5287);
                const a = ({ binding: u, text: e = '', classMix: t, alignment: n = r.v2.left }) =>
                    null === e
                        ...
                        : A().createElement(
                              ...
                              e.split('\n').map((e, a) =>
                                  A().createElement(
                                      'div',
                                      { className: F()(i.Z.base, t), key: `${e}-${a}` },
                            ...
                            const A = e.args,
                                n = (function (u, e) {
                                    ...
                                    var t,
                                        ...
                                        A = {},
                                        n = Object.keys(u);
                                    for (E = 0; E < n.length; E++) (t = n[E]), e.indexOf(t) >= 0 || (A[t] = u[t]);
                                    return A;
                                })(e, m);
                            return void 0 !== A
            ...
            3649: (u, e, t) => {
                ...
                const A = (u, e, t) => {
                    ...
                    F = (u, e, t = E.left) => u.split(e).reduce(t === E.left ? A : n, []),
                    r = (() => {
                        const u = new RegExp(
                        ...
                        return i.includes(t)
                            ...
                            : ((u, e = E.left) => {
                                  ...
                                  const A =
                                      ...
                                      n = u.replace(/&nbsp;/g, ' ');
                                  return F(n, /( )/, e).forEach((u) => (t = t.concat(F(u, A, E.left)))), t;
                              })(u, e);
                    },
            ...
            1358: (u, e, t) => {
                ...
                class A {
                    ...
                    addCallback(u, e, t = 0, A = !0) {
                        ...
                        const n = E.O.view.addModelObserver(u, t, A);
                        return (
                            n > 0
                                ? ((this._callbacks[n] = e),
            ...
            4179: (u, e, t) => {
                t.d(e, { Sw: () => n.Z, B3: () => a, Gr: () => D, Z5: () => F, ry: () => d });
                class E {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
                ...
                const b = A.instance,
                    h = {
                        ...
                        sendShowPopOverEvent: (u, e, t, E, A = R.invalid('resId'), n) => {
                    ...
                    a = ({
                        ...
                        const r = ((u) => {
                                const e = i(u),
                                    ...
                                    E = e.isPositive,
                                    A = e.valueKey;
                                return `${E ? '+' : ''}${n.Z5.getRealFormat(t, n.Gr.WO_ZERO_DIGITS)}${R.strings.tank_setup.kpi.bonus.valueTypes.$dyn(A) || '%'}`;
                            })(e),
                            a = ((u, e = !1) =>
                                e || i(u).isPositive
                        ...
                        return A().createElement(
                            'span',
                            { className: t.base },
                            u && A().createElement('span', { className: t.unit }, r),
                            u && E && ' ',
                            A().createElement('span', { className: t.text }, a),
                        );
                    };
            },
            3137: (u, e, t) => {
            ...
            6197: (u, e, t) => {
                ...
                const D = (u = 1) => {
                    ...
                    C = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const E = o(`${u}.${t}`, window);
                                return B(E) ? e(u, t, E) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    _ = (u) => {
                        const e = ((u) => {
                                const e = D(),
                                ...
                                return { modelPrefix: A, modelPath: c(A, u || ''), resId: E };
                            })(),
                            t = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const A = o(c(t, `${e}.${E}`), window);
                                    return B(A) ? (u.push(A.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        s(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = _(u);
                                v.current = l.addCallback(E, t, r, e === d.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== d.None)
                                return () => {
                                    l.removeCallback(v.current, r);
                                };
                        }, [r, e]),
                        c
                    );
                ...
                var O = t(5626);
                const M = 'Header_base_22',
                    N = 'Header_title_19',
                    T = 'Header_level_e2',
                    x = 'Header_levelLabel_a9',
                    S = ({ modificationName: u, level: e }) => {
                        const t = (0, E.useMemo)(
                            () => ({ level: A().createElement('div', { className: T }, P(e)) }),
                            [e],
                        );
                        return A().createElement(
                            'div',
                ...
                var L = t(6483),
                    U = t.n(L);
                const I = 'Modification_base_8d',
                    V = 'Modification_iconContainer_e2',
                    ...
                    G = ({ isReceived: u, isSelected: e, model: t }) => {
                        const n = U()(I, e && q),
                            F = (0, E.useMemo)(
                                () => ({
                                    backgroundImage: `url(${u ? W.$dyn(`${t.imageResName}`) : W.$dyn(`${t.imageResName}_disabled`)})`,
                                }),
                                [t, u],
                            );
                        return A().createElement(
                            ...
                            A().createElement(
                                'div',
                                { className: V },
                                A().createElement('div', { className: $, style: F }),
                                u &&
                                    A().createElement(
                                        'div',
                                        { className: z },
                ...
                const X = 'ModifiersBlock_base_88',
                    ...
                    Au = ({ modifiers: u }) => {
                        const e = (0, E.useCallback)((u) => ({ unit: U()(eu, u && tu), text: Eu }), []);
                        return A().createElement(
                            'div',
                            { className: X },
                    ...
                    Fu = (0, E.memo)(({ stepState: u, level: e }) => {
                        const t = U()(
                                nu.base,
                                u === p.UnavailableLocked && nu.base__locked,
                                u === p.Received && nu.base__bought,
                            ),
                            n = (0, E.useMemo)(
                                () => ({ level: A().createElement('span', { className: nu.level }, P(e)) }),
                                [e],
                            ),
                        ...
                        return A().createElement(
                            ...
                            { className: t },
                            A().createElement(h.Z, null),
                            u !== p.Received && A().createElement('div', { className: nu.title }, F.$dyn('title')),
                            A().createElement(
                                'div',
                    ...
                    Du = () =>
                        A().createElement(
                            'div',
                            { className: ru },
                            A().createElement('div', { className: iu }, A().createElement(h.Z, null)),
                            A().createElement(
                                'div',
                                { className: au },
                ...
                const _u = () => {
                    const u = m('model', d.None),
                        ...
                        D = a.stepState,
                        o = 0 === (0, g.b)(F).value,
                        s = !o && ![p.UnavailableLocked, p.Received].includes(D),
                        B = D === p.Received ? Cu.Demount : Cu.Mount,
                        c = D !== p.Received && !o ? cu.moneyShortage.$dyn(B) : cu.$dyn(B);
                    return A().createElement(
                        'div',
                        { className: ou },
                        A().createElement(S, { modificationName: e, level: t }),
                        A().createElement(Y, { model: a }),
                        A().createElement(Au, { modifiers: E }),
                        r &&
                            A().createElement(
                                'div',
                                { className: su },
                                A().createElement(w.R, { price: n, description: c, moneyShortage: F }),
                            ),
                        r && D !== p.AvailablePurchase && A().createElement(Fu, { stepState: D, level: t }),
                        s &&
                            A().createElement(
                                'div',
                                { className: Bu },
                                A().createElement(h.Z, null),
                                A().createElement(b.f, null),
                            ),
                        i && D !== p.Received && A().createElement(Du, null),
                    );
                };
                function lu() {
                ...
                const pu = A().forwardRef(function (u, e) {
                        let t = u.children,
                            n = u.className,
                            F = u.theme,
                        ...
                        return (
                            ...
                            A().createElement(
                                'div',
                                vu({}, i, {
                                    className: U()(du.base, du[`base__theme-${r}`], n),
                                    ref: function (u) {
                    ...
                    gu = () => A().createElement(pu, null, A().createElement(_u, null)),
                    bu = document.createElement('div');
                (window.onload = () => document.body.appendChild(bu)), F().render(A().createElement(gu, null), bu);
            },
            7024: (u, e, t) => {
                t.d(e, { f: () => a });
                var E = t(6179),
                    A = t.n(E);
                const n = 'NotEnoughCredits_base_5c',
                    ...
                    a = () =>
                        A().createElement(
                            'div',
                            { className: n },
                            A().createElement('div', { className: F }, i.title()),
                            A().createElement('div', { className: r }, i.description()),
                        );
            },
            1963: (u, e, t) => {
                t.d(e, { R: () => h });
                ...
                const o = {
                    ...
                    s = ({
                        ...
                        discountValue: a,
                        showPlus: s,
                        stockBackgroundName: B = i.we.Red,
                    }) => {
                        const c = r()(o.value, o[`value__${E}`], !n && o.value__notEnough),
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                { className: c },
                                l,
                                A().createElement(D, { value: F, format: E === i.V2.gold ? 'gold' : 'integral' }),
                            ),
                ...
                const m = 'PriceBlock_base_54',
                    ...
                    b = 'PriceBlock_notEnough_56',
                    h = ({ price: u, moneyShortage: e, description: t }) => {
                        const F = 0 === (0, d.b)(u).value,
                            r = (0, E.useMemo)(
                                () => ({
                        ...
                        return A().createElement(
                            ...
                            A().createElement(n.z, { text: t, binding: r, classMix: p }),
                        );
                    };
            },
            8899: (u, e, t) => {
                ...
                var E = t(6179),
                    A = t.n(E);
                const n = 'Separator_base_73',
                    F = () => A().createElement('div', { className: n });
            },
            1532: (u, e, t) => {
                t.d(e, { W: () => E });
                const E = 'mul';
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, t, E] = deferred[i], n = !0, F = 0; F < e.length; F++)
                        (!1 & E || A >= E) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [428], () => __webpack_require__(6197));
