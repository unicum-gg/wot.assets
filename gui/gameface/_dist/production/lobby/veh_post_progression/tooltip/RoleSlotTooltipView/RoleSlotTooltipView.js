(() => {
    ...
    var __webpack_modules__ = {
                ...
                const i = ({
                    ...
                    return F().createElement(
                        ...
                        a.split('\n').map((e, i) =>
                            F().createElement(
                                'div',
                                { className: r()(o.Z.base, t), key: `${e}-${i}` },
            ...
            70: (u, e, t) => {
                ...
                var n = {};
                (t.r(n),
                    t.d(n, { mouse: () => l, off: () => D, on: () => s, onResize: () => i, onScaleUpdated: () => a }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        events: () => n,
                ...
                var E = {};
                (t.r(E), t.d(E, { getBgUrl: () => f, getTextureUrl: () => b }));
                var A = {};
                function F(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const m = {
                    ...
                    p = Object.keys(g).reduce((u, e) => ((u[e] = () => B(g[e])), u), {}),
                    w = { play: Object.assign({}, p, { sound: B }), setRTPC: C };
                var h = t(9690);
                function b(u, e, t = 1) {
                ...
                const ou = { view: A, client: r, sound: w, intl: v };
            },
            7902: (u, e, t) => {
                t.d(e, { F: () => n });
                const n = (u = 1) => {
                    ...
                    D = (u, e = r.left) => {
                        ...
                        return ((u, e = r.left) => {
                            ...
                            const n =
                                ...
                                E = A(u);
                            return (i(E, /( )/, e).forEach((u) => (t = t.concat(i(u, n, r.left)))), t);
                        })(u, e);
                    },
            ...
            9916: (u, e, t) => {
                t.d(e, { Sw: () => E.Z, B3: () => o, Z5: () => A.Z5, B0: () => F, ry: () => _ });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
                ...
                function B(u, e, t, n, r, E, A) {
                    ...
                    F.done ? e(o) : Promise.resolve(o).then(n, r);
                }
            ...
            7524: (u, e, t) => {
                ...
                const l = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            c({}, l, {
                                className: o()(s.base, s[`base__theme-${F}`], E),
                                ref: function (u) {
                        ...
                        m(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = w(u);
                                c.current = b.addCallback(n, t, o, e === f.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== f.None)
                                return () => {
                                    b.removeCallback(c.current, o);
                                };
                        }, [o, e]),
                        s
                    );
                ...
                var j = t(280);
                const z = 'Roles_specializationText_e9',
                    q = R.strings.veh_post_progression.roleSlotTooltipView,
                    $ = R.strings.veh_post_progression.categories,
                    G = ({ availableRoles: u, chosenRole: e }) => {
                        const t = {
                            roles: (E = u).reduce(
                                (u, { value: e }, t) => (
                                    u.push(r().createElement('div', { key: t, className: z }, $.$dyn(e.role))),
                                    t !== E.length - 1 && u.push(q.separator()),
                                    u
                                ),
                                [],
                            ),
                        ...
                        var E;
                        const A = (0, n.useMemo)(
                            () => ({ roles: r().createElement('div', { className: z }, $.$dyn(e.role)) }),
                            [e.role],
                        );
                        return r().createElement(
                            'div',
                            null,
                            e.role && r().createElement(j.z, { binding: A, text: q.currentRole() }),
                            r().createElement(j.z, { binding: t, text: q.availableRoles() }),
                        );
                    };
                var W = t(3266),
                    X = t(7846),
                    ...
                    nu = () => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(G, { availableRoles: n, chosenRole: E }),
                            ),
                            r().createElement(H.Z, null),
                            r().createElement(
                                'div',
                                { className: uu },
                                r().createElement(P.R, { price: o, moneyShortage: i, description: tu(o, a) }),
                            ),
                            F &&
                                !a &&
                                r().createElement(
            ...
            3266: (u, e, t) => {
                ...
                const E = 'DisabledBlock_base_ce',
                    ...
                    o = R.strings.veh_post_progression.tooltips.feature.disabled,
                    i = () =>
                        r().createElement(
                            'div',
                            { className: E },
                            ...
                            r().createElement('div', null, o.description()),
                        );
            },
            7833: (u, e, t) => {
                t.d(e, { s: () => o });
            ...
            7846: (u, e, t) => {
                ...
                const F = 'Lock_base_f9',
                    ...
                    s = ({ level: u }) => {
                        const e = (0, n.useMemo)(
                            () => ({ level: r().createElement('div', { className: i }, (0, E.HG)(u)) }),
                            [u],
                        );
                        return r().createElement(
                            'div',
                            { className: F },
                            r().createElement('div', { className: o }, a.title()),
                ...
                const E = 'NotEnoughCredits_base_5c',
                    ...
                    i = () =>
                        r().createElement(
                            'div',
                            { className: E },
                            r().createElement('div', { className: A }, o.title()),
                            r().createElement('div', { className: F }, o.description()),
                        );
            },
            5476: (u, e, t) => {
                t.d(e, { R: () => L });
                var n = t(7363),
                    ...
                    F = t.n(A),
                    o = t(9916);
                const i = ({ value: u, format: e = 'integral' }) => {
                        const t = (function (u) {
                    ...
                    ({
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                ...
                                o && E > 0 && '+',
                                r().createElement(i, { value: E, format: n === s.V2.gold ? 'gold' : 'integral' }),
                            ),
                ...
                const w = 'Price_base_61',
                    ...
                    f = ({
                        ...
                        return r().createElement(
                            ...
                            p.UI(u, (u, a) => {
                                var B;
                                const C = null == (B = p.U2(e, a)) ? void 0 : B.value,
                                    _ = !(o || ((d = u.value), (m = C), void 0 === m || d === m));
                                var d, m;
                                return (
                                    (E || Boolean(u.value)) &&
                                    r().createElement(
                ...
                const k = 'PriceBlock_base_54',
                    ...
                    x = 'PriceBlock_freeLabel_45',
                    T = 'PriceBlock_notEnough_56',
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (o = 0; o < deferred.length; o++) {
                    for (var [e, t, n] = deferred[o], E = !0, A = 0; A < e.length; A++)
                        (!1 & n || r >= n) &&
