(() => {
    ...
    var __webpack_modules__ = {
            ...
            2616: (u, e, t) => {
                ...
                const o = ({
                    ...
                    text: e = '',
                    classMix: t,
                    alignment: n = E.v2.left,
                    formatWithBrackets: o,
                }) => {
                    if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                    const a = o && u ? (0, E.WU)(e, u) : e;
                    return F().createElement(
                        ...
                        a.split('\n').map((e, o) =>
                            F().createElement(
                                'div',
                                { className: r()(i.Z.base, t), key: `${e}-${o}` },
            ...
            5528: (u, e, t) => {
                ...
                var E = {};
                (t.r(E), t.d(E, { getBgUrl: () => y, getTextureUrl: () => h }));
                var A = {};
                function F(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const o = F('clientResized'),
                    ...
                    l = { down: F('mousedown'), up: F('mouseup'), move: F('mousemove') };
                const B = (function () {
                ...
                const m = {
                    ...
                    w = { play: Object.assign({}, b, { sound: C }), setRTPC: _ };
                var f = t(1308);
                function h(u, e, t = 1) {
                ...
                const Eu = Object.keys(k).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === k[e]), u), {}),
                    Au = {
                        set: (u, e) => {
                ...
                const au = { view: A, client: r, sound: w, intl: p };
            },
            3485: (u, e, t) => {
                t.d(e, { F: () => n });
                const n = (u = 1) => {
                    ...
                    var E;
                    e &&
                        ((r = (null == (E = e.match(/(coui:\/\/[^\s]+\.js)/)) ? void 0 : E[0]) || ''),
            ...
            6758: (u, e, t) => {
                ...
                const A = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    o = (u, e, t = r.left) => u.split(e).reduce(t === r.left ? F : i, []),
                    a = (() => {
                        const u = new RegExp(
                            [
                    ...
                    D = (u, e = r.left) => {
                        ...
                        return ((u, e = r.left) => {
                            ...
                            const n =
                                ...
                                E = A(u);
                            return (o(E, /( )/, e).forEach((u) => (t = t.concat(o(u, n, r.left)))), t);
                        })(u, e);
                    },
            ...
            828: (u, e, t) => {
                t.d(e, { Sw: () => E.Z, B3: () => i, Z5: () => A.Z5, B0: () => F, ry: () => _ });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
                ...
                function B(u, e, t, n, r, E, A) {
                    ...
                    F.done ? e(i) : Promise.resolve(i).then(n, r);
                }
            ...
            7764: (u, e, t) => {
                ...
                const c = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            D({}, c, {
                                className: i()(a.base, a[`base__theme-${F}`], E),
                                ref: function (u) {
                ...
                const _ = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    ...
                    g = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: r, modelPath: m(r, u || ''), resId: n };
                            })(),
                            t = e.modelPrefix,
                            n = u.split('.');
                        if (n.length > 0) {
                ...
                const b = () => (window.injected || (window.injected = new Map()), window.injected);
                const w = l.Sw.instance;
                let f = (function (u) {
                ...
                const h = (u = 'model', e = f.Deep) => {
                    const t = (0, n.useState)(0),
                        ...
                        o = (0, n.useMemo)(() => {
                            ...
                            return window.__feature && window.__feature !== F && !e ? `subViews.${F}.${u}` : u;
                        }, [A, F, u]),
                        a = (0, n.useState)(() =>
                            ((u) => {
                                const e = _(u, window);
                        ...
                        d(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = g(u);
                                c.current = w.addCallback(n, t, i, e === f.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== f.None)
                                return () => {
                                    w.removeCallback(c.current, i);
                                };
                        }, [i, e]),
                        s
                    );
                ...
                var y = t(8207),
                    k = t(6395),
                    P = t(7618);
                const x = 'Slots_base_f642b',
                    O = 'Slots_slots_b1ac2',
                    T = 'Slots_specializations_ed025',
                    N = 'Slots_icon_a37dd',
                    M = 'Slots_emptyIcon_fafbf',
                    L = 'Slots_emptyIconGlow_e54ff',
                    S = 'Slots_highlight_ee054',
                    I = (u, e) => {
                        const t = `medium_${u}_${e ? 'on' : 'off'}`,
                            n = R.images.gui.maps.icons.specialization.$dyn(t);
                    ...
                    V = ({ slots: u }) =>
                        r().createElement(
                            ...
                            r().createElement(
                                ...
                                u.map(({ value: u }, e) =>
                                    u.role || 1 !== e
                                        ? r().createElement('div', { key: e, style: I(u.role, 1 === e), className: N })
                                        : r().createElement(
                                              'div',
                                              { className: N, key: e },
                ...
                var U = t(2616);
                const z = 'Roles_specializationText_a0fc6',
                    $ = R.strings.veh_post_progression.roleSlotTooltipView,
                    j = R.strings.veh_post_progression.categories,
                    q = ({ availableRoles: u, chosenRole: e }) => {
                        const t = {
                            roles: (E = u).reduce(
                                (u, { value: e }, t) => (
                                    u.push(r().createElement('div', { key: t, className: z }, j.$dyn(e.role))),
                                    t !== E.length - 1 && u.push($.separator()),
                                    u
                                ),
                                [],
                            ),
                        ...
                        var E;
                        const A = (0, n.useMemo)(
                            () => ({ roles: r().createElement('div', { className: z }, j.$dyn(e.role)) }),
                            [e.role],
                        );
                        return r().createElement(
                            'div',
                            null,
                            e.role && r().createElement(U.z, { binding: A, text: $.currentRole() }),
                            r().createElement(U.z, { binding: t, text: $.availableRoles() }),
                        );
                    };
                var G = t(5803),
                    X = t(235),
                    W = t(9326),
                    H = t(5649);
                const K = 'Content_base_d6379',
                    Z = 'Content_title_d2cf7',
                    Y = 'Content_content_c49b9',
                    Q = 'Content_block_f062a',
                    J = 'Content_priceBlock_fce22',
                    uu = R.strings.veh_post_progression.roleSlotTooltipView,
                    eu = (u, e) =>
                        0 === (0, y.b)(u).value
                            ? uu.firstChoice()
                            : e
                              ? uu.appointment()
                              : uu.moneyShortage.appointment(),
                    tu = () => {
                        const u = h('model', f.None),
                            e = u.level,
                            t = u.slots,
                            n = u.availableRoles,
                            E = u.chosenRole,
                        ...
                        return r().createElement(
                            'div',
                            { className: K },
                            r().createElement('div', { className: Z }, uu.title()),
                            r().createElement(H.s, { level: e }),
                            r().createElement(V, { slots: t }),
                            r().createElement(W.Z, null),
                            r().createElement(
                                'div',
                                { className: Y },
                                uu.featureOpportunity(),
                                r().createElement(q, { availableRoles: n, chosenRole: E }),
                            ),
                            r().createElement(W.Z, null),
                            r().createElement(
                                'div',
                                { className: J },
                                r().createElement(P.R, { price: i, moneyShortage: o, description: eu(i, a) }),
                            ),
                            F &&
                                !a &&
                                r().createElement(
                            ...
                            A &&
                                r().createElement(
                                    ...
                                    { className: Q },
                                    r().createElement(W.Z, null),
                                    r().createElement(G.c, null),
                                ),
                        );
                    },
                    nu = () => r().createElement(c, null, r().createElement(tu, null));
                engine.whenReady.then(() => {
                    A().render(r().createElement(nu, null), document.getElementById('root'));
                });
            },
            5803: (u, e, t) => {
                t.d(e, { c: () => o });
                var n = t(7363),
                    r = t.n(n);
                const E = 'DisabledBlock_base_f4a90',
                    A = 'DisabledBlock_warningTitle_fc3a0',
                    F = 'DisabledBlock_warningIcon_cb907',
                    i = R.strings.veh_post_progression.tooltips.feature.disabled,
                    o = () =>
                        r().createElement(
                            'div',
                            { className: E },
                            ...
                            r().createElement('div', null, i.description()),
                        );
            },
            5649: (u, e, t) => {
                t.d(e, { s: () => i });
                var n = t(7363),
                    ...
                    E = t(1308),
                    A = t(2616);
                const F = 'FeatureLevelSubtitle_level_bd52c',
                    i = ({ level: u }) => {
                        const e = (0, n.useMemo)(
                            () => ({ level: r().createElement('div', { className: F }, (0, E.HG)(u)) }),
                            [u],
                        );
            ...
            235: (u, e, t) => {
                ...
                var n = t(7363),
                    ...
                    E = t(1308),
                    A = t(2616);
                const F = 'Lock_base_d629d',
                    i = 'Lock_title_a9aad',
                    o = 'Lock_level_dd37a',
                    a = R.strings.veh_post_progression.tooltips.pairModification.status.unavailableLocked,
                    s = ({ level: u }) => {
                        const e = (0, n.useMemo)(
                            () => ({ level: r().createElement('div', { className: o }, (0, E.HG)(u)) }),
                            [u],
                        );
                        return r().createElement(
                            'div',
                            { className: F },
                            r().createElement('div', { className: i }, a.title()),
                            r().createElement(A.z, { binding: e, text: a.description() }),
                        );
                    };
            },
            6395: (u, e, t) => {
                ...
                var n = t(7363),
                    r = t.n(n);
                const E = 'NotEnoughCredits_base_ff48c',
                    A = 'NotEnoughCredits_title_efff1',
                    F = 'NotEnoughCredits_description_b3b50',
                    i = R.strings.veh_post_progression.tooltips.notEnoughCredits,
                    o = () =>
                        r().createElement(
                            'div',
                            { className: E },
                            r().createElement('div', { className: A }, i.title()),
                            r().createElement('div', { className: F }, i.description()),
                        );
            },
            7618: (u, e, t) => {
                t.d(e, { R: () => N });
                ...
                const D = (0, n.memo)(
                    ({
                        ...
                        showPlus: i,
                        isEnough: D = !0,
                        stockBackgroundName: c = s.we.Red,
                        className: l,
                        classNames: B,
                    }) =>
                        r().createElement(
                            'span',
                            { className: F()(a.base, a[`base__${t}`], l) },
                            r().createElement(
                                'span',
                                {
                                    className: F()(
                                ...
                                i && E > 0 && '+',
                                r().createElement(o, { value: E, format: n === s.V2.gold ? 'gold' : 'integral' }),
                            ),
                            r().createElement('span', {
                                className: F()(a.icon, a[`icon__${n}-${t}`], null == B ? void 0 : B.icon),
                            }),
                            u &&
                                r().createElement(
                                    'span',
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      (h.current.timeoutId = window.setTimeout(k, a ? 100 : 400)),
                                                      E && E(u),
                                                      O && O(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const b = 'Price_base_eae94',
                    w = 'Price_currency_abc18',
                    f = 'Price_currency__discounted_a21df',
                    h = ({
                        price: u,
                        defPrice: e,
                        priceSeparator: t,
                        ...
                        const l = (0, n.useMemo)(
                            () => ({ stock: null == c ? void 0 : c.discount }),
                            [null == c ? void 0 : c.discount],
                        );
                        return r().createElement(
                            'div',
                            { className: F()(b, a) },
                            g.UI(u, (u, a) => {
                                var B;
                                const C = null == (B = g.U2(e, a)) ? void 0 : B.value,
                                    _ = !(i || ((d = u.value), (v = C), void 0 === v || d === v));
                                var d, v;
                                return (
                                    (E || Boolean(u.value)) &&
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            ...
                                            r().createElement(
                                                'div',
                                                { className: F()(w, _ && f, null == c ? void 0 : c.currency) },
                                                r().createElement(D, {
                                                    isDiscount: _,
                                                    size: A ? s.et.big : s.et.small,
                                                    type: u.name,
                                                    value: u.value,
                                                    isEnough: u.isEnough,
                                                    classNames: l,
                ...
                const k = 'PriceBlock_base_a9db2',
                    ...
                    N = ({ price: u, moneyShortage: e, description: t }) => {
                        const A = 0 === (0, y.b)(u).value,
                            F = (0, n.useMemo)(
                                () => ({
                        ...
                        return r().createElement(
                            ...
                            r().createElement(E.z, { text: t, binding: F, classMix: x }),
                        );
                    };
            },
            9326: (u, e, t) => {
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, t, n] = deferred[i], E = !0, A = 0; A < e.length; A++)
                        (!1 & n || r >= n) &&
        ...
        (__webpack_require__.j = 78),
        (() => {
            var u = { 78: 0, 760: 0, 640: 0, 233: 0, 547: 0, 779: 0, 797: 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [428], () => __webpack_require__(7764));
