(() => {
    ...
    var __webpack_modules__ = {
            ...
            280: (u, e, t) => {
                ...
                var E = t(6179),
                    ...
                    r = t(3649),
                    D = t(5287);
                const a = ({ binding: u, text: e = '', classMix: t, alignment: F = r.v2.left }) =>
                    null === e
                        ...
                        : A().createElement(
                              ...
                              e.split('\n').map((e, a) =>
                                  A().createElement(
                                      'div',
                                      { className: n()(D.Z.base, t), key: `${e}-${a}` },
                                      (0, r.Uw)(e, F, u).map((u, e) =>
            ...
            5067: (u, e, t) => {
                ...
                var F = {};
                t.r(F), t.d(F, { getBgUrl: () => _, getTextureUrl: () => c });
                var n = {};
                function r(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const a = r('clientResized'),
                    o = { down: r('mousedown'), up: r('mouseup'), move: r('mousemove') };
                const i = (function () {
            ...
            9690: (u, e, t) => {
                ...
                const F = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    n = (u) =>
                        F
                            ? `${u}`
                            : (function (u) {
            ...
            3649: (u, e, t) => {
                ...
                const A = (u, e, t) => {
                    ...
                    n = (u, e, t = E.left) => u.split(e).reduce(t === E.left ? A : F, []),
                    r = (() => {
                        const u = new RegExp(
                        ...
                        return D.includes(t)
                            ...
                            : ((u, e = E.left) => {
                                  ...
                                  const A =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return n(F, /( )/, e).forEach((u) => (t = t.concat(n(u, A, E.left)))), t;
                              })(u, e);
                    },
                    o = (u, e, t) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : a(u, e)));
            },
            1358: (u, e, t) => {
                t.d(e, { Z: () => F });
                var E = t(5067);
            ...
            6614: (u, e, t) => {
                ...
                const C = A().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        A().createElement(
                            'div',
                            B({}, C, {
                                className: D()(i.base, i[`base__theme-${r}`], F),
                                ref: function (u) {
                ...
                const l = (u = 1) => {
                    ...
                    g = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const E = d(`${u}.${t}`, window);
                                return v(E) ? e(u, t, E) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    w = (u) => {
                        const e = ((u) => {
                                const e = l(),
                        ...
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const A = d(p(t, `${e}.${E}`), window);
                                    return v(A) ? (u.push(A.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        m(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = w(u);
                                s.current = h.addCallback(E, t, r, e === b.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== b.None)
                ...
                const P = 'Slots_base_64',
                    T = 'Slots_slots_63',
                    N = 'Slots_specializations_24',
                    x = 'Slots_icon_9f',
                    M = 'Slots_emptyIcon_9b',
                    L = 'Slots_emptyIconGlow_38',
                    S = 'Slots_highlight_f2',
                    U = (u, e) => {
                        const t = `medium_${u}_${e ? 'on' : 'off'}`,
                            E = R.images.gui.maps.icons.specialization.$dyn(t);
                    ...
                    I = ({ slots: u }) =>
                        A().createElement(
                            ...
                            A().createElement(
                                ...
                                u.map(({ value: u }, e) =>
                                    u.role || 1 !== e
                                        ? A().createElement('div', { key: e, style: U(u.role, 1 === e), className: x })
                                        : A().createElement(
                                              'div',
                                              { className: x, key: e },
                ...
                const z = 'Roles_specializationText_e9',
                    ...
                    H = R.strings.veh_post_progression.categories,
                    G = ({ availableRoles: u, chosenRole: e }) => {
                        const t = {
                            roles: (F = u).reduce(
                                (u, { value: e }, t) => (
                                    u.push(A().createElement('div', { key: t, className: z }, H.$dyn(e.role))),
                                    t !== F.length - 1 && u.push(q.separator()),
                                    u
                                ),
                                [],
                            ),
                        ...
                        var F;
                        const n = (0, E.useMemo)(
                            () => ({ roles: A().createElement('div', { className: z }, H.$dyn(e.role)) }),
                            [e.role],
                        );
                        return A().createElement(
                            'div',
                            null,
                            e.role && A().createElement(V.z, { binding: n, text: q.currentRole() }),
                            A().createElement(V.z, { binding: t, text: q.availableRoles() }),
                        );
                    };
                var K = t(3266),
                    W = t(7846),
                ...
                const Y = 'Content_base_5a',
                    Z = 'Content_title_f0',
                    X = 'Content_content_62',
                    Q = 'Content_block_f8',
                    J = 'Content_priceBlock_ac',
                    ...
                    tu = () => {
                        ...
                        return A().createElement(
                            'div',
                            { className: Y },
                            A().createElement('div', { className: Z }, uu.title()),
                            A().createElement(j.s, { level: e }),
                            A().createElement(I, { slots: t }),
                            A().createElement($.Z, null),
                            A().createElement(
                                'div',
                                { className: X },
                                uu.featureOpportunity(),
                                A().createElement(G, { availableRoles: E, chosenRole: F }),
                            ),
                            A().createElement($.Z, null),
                            A().createElement(
                                'div',
                                { className: J },
                                A().createElement(k.R, { price: D, moneyShortage: a, description: eu(D, o) }),
                            ),
                            r &&
                                !o &&
                                A().createElement(
                            ...
                            n &&
                                A().createElement(
                                    ...
                                    { className: Q },
                                    A().createElement($.Z, null),
                                    A().createElement(K.c, null),
                                ),
                        );
                    },
                    Eu = () => A().createElement(C, null, A().createElement(tu, null));
                engine.whenReady.then(() => {
                    n().render(A().createElement(Eu, null), document.getElementById('root'));
                });
            },
            3266: (u, e, t) => {
                t.d(e, { c: () => a });
                var E = t(6179),
                    A = t.n(E);
                const F = 'DisabledBlock_base_ce',
                    n = 'DisabledBlock_warningTitle_e9',
                    r = 'DisabledBlock_warningIcon_54',
                    D = R.strings.veh_post_progression.tooltips.feature.disabled,
                    a = () =>
                        A().createElement(
                            'div',
                            { className: F },
                            ...
                            A().createElement('div', null, D.description()),
                        );
            },
            7833: (u, e, t) => {
                t.d(e, { s: () => D });
                var E = t(6179),
                    ...
                    F = t(9690),
                    n = t(280);
                const r = 'FeatureLevelSubtitle_level_83',
                    D = ({ level: u }) => {
                        const e = (0, E.useMemo)(
                            () => ({ level: A().createElement('div', { className: r }, (0, F.HG)(u)) }),
                            [u],
                        );
            ...
            7846: (u, e, t) => {
                ...
                var E = t(6179),
                    ...
                    F = t(9690),
                    n = t(280);
                const r = 'Lock_base_f9',
                    D = 'Lock_title_ca',
                    a = 'Lock_level_df',
                    o = R.strings.veh_post_progression.tooltips.pairModification.status.unavailableLocked,
                    i = ({ level: u }) => {
                        const e = (0, E.useMemo)(
                            () => ({ level: A().createElement('div', { className: a }, (0, F.HG)(u)) }),
                            [u],
                        );
                        return A().createElement(
                            'div',
                            { className: r },
                            A().createElement('div', { className: D }, o.title()),
                            A().createElement(n.z, { binding: e, text: o.description() }),
                        );
                    };
            },
            7024: (u, e, t) => {
                ...
                var E = t(6179),
                    A = t.n(E);
                const F = 'NotEnoughCredits_base_5c',
                    n = 'NotEnoughCredits_title_64',
                    r = 'NotEnoughCredits_description_0f',
                    D = R.strings.veh_post_progression.tooltips.notEnoughCredits,
                    a = () =>
                        A().createElement(
                            'div',
                            { className: F },
                            A().createElement('div', { className: n }, D.title()),
                            A().createElement('div', { className: r }, D.description()),
                        );
            },
            1963: (u, e, t) => {
                t.d(e, { R: () => h });
                ...
                const i = {
                    ...
                    s = ({
                        ...
                        discountValue: a,
                        showPlus: s,
                        stockBackgroundName: B = D.we.Red,
                    }) => {
                        const C = r()(i.value, i[`value__${E}`], !F && i.value__notEnough),
                            c = r()(i.icon, i[`icon__${E}-${t}`]),
                            _ = r()(i.stock, a && i.stock__indent, e && i.stock__interactive),
                            l = s && n > 0 && '+',
                            d = r()(i.base, i[`base__${t}`]);
                        return A().createElement(
                            'span',
                            { className: d },
                            A().createElement(
                                ...
                                { className: C },
                                l,
                                A().createElement(o, { value: n, format: E === D.V2.gold ? 'gold' : 'integral' }),
                            ),
                ...
                var d = t(3137);
                const m = 'PriceBlock_base_54',
                    v = 'PriceBlock_priceContainer_3f',
                    p = 'PriceBlock_description_29',
                    g = 'PriceBlock_freeLabel_45',
                    w = 'PriceBlock_notEnough_56',
                    h = ({ price: u, moneyShortage: e, description: t }) => {
                        const n = 0 === (0, d.b)(u).value,
                            r = (0, E.useMemo)(
                                () => ({
                        ...
                        return A().createElement(
                            ...
                            A().createElement(F.z, { text: t, binding: r, classMix: p }),
                        );
                    };
            },
            8899: (u, e, t) => {
                ...
                var E = t(6179),
                    A = t.n(E);
                const F = 'Separator_base_73',
                    n = () => A().createElement('div', { className: F });
            },
            5287: (u, e, t) => {
                t.d(e, { Z: () => E });
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [428], () => __webpack_require__(6614));
