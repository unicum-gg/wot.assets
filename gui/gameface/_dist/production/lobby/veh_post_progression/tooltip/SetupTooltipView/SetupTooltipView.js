(() => {
    ...
    var __webpack_modules__ = {
            280: (u, e, A) => {
                ...
                var F = A(6179),
                    ...
                    n = A(3649),
                    r = A(5287);
                const B = ({ binding: u, text: e = '', classMix: A, alignment: t = n.v2.left }) =>
                    null === e
                        ...
                        : E().createElement(
                              ...
                              e.split('\n').map((e, B) =>
                                  E().createElement(
                                      'div',
                                      { className: D()(r.Z.base, A), key: `${e}-${B}` },
                                      (0, n.Uw)(e, t, u).map((u, e) =>
                                          E().createElement(F.Fragment, { key: `${e}-${u}` }, u),
                                      ),
                                  ),
                              ),
                          );
            ...
            5067: (u, e, A) => {
                A.d(e, { O: () => $ });
                var F = {};
                (A.r(F), A.d(F, { mouse: () => a, onResize: () => B }));
                var E = {};
                (A.r(E),
                    A.d(E, {
                        events: () => F,
                ...
                const G = Object.keys(_).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === _[e]), u), {}),
                    q = {
                        set: (u, e) => {
            ...
            3649: (u, e, A) => {
                ...
                const t = (u, e, A) => {
                    ...
                    n = (u, e, A = F.left) => u.split(e).reduce(A === F.left ? t : D, []),
                    r = (() => {
                        const u = new RegExp(
                        ...
                        return B.includes(A)
                            ...
                            : ((u, e = F.left) => {
                                  ...
                                  const E =
                                      ...
                                      t = u.replace(/&nbsp;/g, ' ');
                                  return (n(t, /( )/, e).forEach((u) => (A = A.concat(n(u, E, F.left)))), A);
                              })(u, e);
                    },
                    a = (u, e, A) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : o(u, e)));
            },
            1358: (u, e, A) => {
                A.d(e, { Z: () => t });
                var F = A(5067);
                class E {
                    ...
                    addCallback(u, e, A = 0, E = !0) {
                        void 0 === this._updateHandler &&
                            (this._updateHandler = engine.on('viewEnv.onDataChanged', this._emmitDataChanged, this));
                        const t = F.O.view.addModelObserver(u, A, E);
                        return (
                            t > 0
                                ? ((this._callbacks[t] = e),
            ...
            4179: (u, e, A) => {
                ...
                class F {
                    ...
                    unregister(u, e) {
                        const A = u,
                            F = e;
                        ((this.entries = this.entries.filter(({ container: u, callback: e }) => u !== A || e !== F)),
                ...
                function l(u, e, A, F, E, t, D) {
                    ...
                    n.done ? e(r) : Promise.resolve(r).then(F, E);
                }
                ...
                const p = E.instance,
                    g = {
                        ...
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            m(r.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
                        sendShowPopOverEvent: (u, e, A, F, E = R.invalid('resId'), t) => {
                            const D = s.O.view.getViewGlobalPosition(),
                                ...
                                i = n.height,
                                C = {
                                    x: s.O.view.pxToRem(B) + D.x,
                                    y: s.O.view.pxToRem(o) + D.y,
                            ...
                            for (const F in e)
                                if (Object.prototype.hasOwnProperty.call(e, F)) {
                                    ...
                                    if (E.startsWith('[object CoherentArrayProxy]')) {
                                        const E = e[F];
                                        A[F] = [];
                                        for (let e = 0; e < E.length; e++) A[F].push({ value: u(E[e].value) });
                                    } else
            ...
            892: (u, e, A) => {
                ...
                const s = E().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        E().createElement(
                            'div',
                            C({}, s, {
                                className: r()(a.base, a[`base__theme-${n}`], t),
                                ref: function (u) {
                                    ((l.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            E().createElement('div', { className: a.decorator }, A),
                        )
                    );
                });
                var c = A(3649);
                ...
                const d = (u = 1) => {
                    ...
                    g = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: E, modelPath: h(E, u || ''), resId: F };
                            })(),
                            A = e.modelPrefix,
                            F = u.split('.');
                        if (F.length > 0) {
                        ...
                        v(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    F = g(u);
                                i.current = b.addCallback(F, A, n, e === f.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== f.None)
                                return () => {
                                    b.removeCallback(i.current, n);
                                };
                        }, [n, e]),
                        o
                    );
                ...
                const x = {
                    ...
                    k = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    M = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    P = (0, F.memo)(({ text: u, binding: e, classMix: A }) => {
                                ...
                                ((r = r.replace(A, `%(${n})`)),
                                    (D[n] = x[u]
                                        ? E().createElement(
                                              'span',
                                              { className: x[u] },
                                              E().createElement(O.z, { text: a, binding: e }),
                                          )
                                        : E().createElement(
                                              'span',
                                              { style: t(u) },
                        ...
                        return E().createElement(O.z, { text: r, classMix: A, binding: D });
                    });
                var N = A(3266),
                    S = A(7833),
                    L = A(7846),
                ...
                const I = 'Content_base_1f',
                    W = 'Content_title_7e',
                    V = 'Content_imageWrapper_16',
                    H = 'Content_image_48',
                    z = 'Content_disabledSeparator_32',
                    K = 'Content_content_79',
                    G = 'Content_description_a4',
                    q = R.strings.veh_post_progression.setupTooltipView,
                    j = R.images.gui.maps.icons.vehPostProgression.actionItems.modificationWithFeature.c_160x100,
                    $ = () => {
                        const u = T('model', f.None),
                            e = u.level,
                            A = u.type,
                            F = u.iconName,
                            t = u.isDisabled,
                        ...
                        return E().createElement(
                            'div',
                            { className: I },
                            E().createElement('div', { className: W }, (0, c.uF)(q.title(), { name: q.name.$dyn(A) })),
                            E().createElement(S.s, { level: e }),
                            E().createElement(
                                'div',
                                { className: V },
                                E().createElement('div', {
                                    style: { backgroundImage: `url(${j.$dyn(F)})` },
                                    className: H,
                                }),
                            ),
                            ...
                            E().createElement(
                                'div',
                                { className: K },
                                E().createElement(P, { text: String(q.description.$dyn(A)) }),
                                E().createElement('div', { className: G }, q.tip()),
                            ),
                            E().createElement(U.Z, null),
                            !D && E().createElement(L.H, { level: e }),
                            t &&
                                E().createElement(
                                    'div',
                                    null,
                                    !D && E().createElement('div', { className: z }, E().createElement(U.Z, null)),
                                    E().createElement(N.c, null),
                                ),
                        );
                    },
                    Y = () => E().createElement(s, null, E().createElement($, null));
                engine.whenReady.then(() => {
                    D().render(E().createElement(Y, null), document.getElementById('root'));
                });
            },
            3266: (u, e, A) => {
                A.d(e, { c: () => B });
                ...
                const t = 'DisabledBlock_base_ce',
                    D = 'DisabledBlock_warningTitle_e9',
                    n = 'DisabledBlock_warningIcon_54',
            ...
            7833: (u, e, A) => {
                ...
                var F = A(6179),
                    ...
                    t = A(9690),
                    D = A(280);
                const n = 'FeatureLevelSubtitle_level_83',
                    r = ({ level: u }) => {
                        const e = (0, F.useMemo)(
                            () => ({ level: E().createElement('div', { className: n }, (0, t.HG)(u)) }),
                            [u],
                        );
            ...
            7846: (u, e, A) => {
                ...
                var F = A(6179),
                    ...
                    t = A(9690),
                    D = A(280);
                const n = 'Lock_base_f9',
                    r = 'Lock_title_ca',
                    B = 'Lock_level_df',
                    o = R.strings.veh_post_progression.tooltips.pairModification.status.unavailableLocked,
                    a = ({ level: u }) => {
                        const e = (0, F.useMemo)(
                            () => ({ level: E().createElement('div', { className: B }, (0, t.HG)(u)) }),
                            [u],
                        );
                        return E().createElement(
                            'div',
                            { className: n },
                            E().createElement('div', { className: r }, o.title()),
                            E().createElement(D.z, { binding: e, text: o.description() }),
                        );
                    };
            },
            8899: (u, e, A) => {
                ...
                const t = 'Separator_base_73',
                    D = () => E().createElement('div', { className: t });
            },
            5287: (u, e, A) => {
                A.d(e, { Z: () => F });
    ...
    ((__webpack_require__.m = __webpack_modules__),
        (deferred = []),
        (__webpack_require__.O = (u, e, A, F) => {
            if (!e) {
                var E = 1 / 0;
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, A, F] = deferred[r], t = !0, D = 0; D < e.length; D++)
                        (!1 & F || E >= F) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [428], () => __webpack_require__(892));
