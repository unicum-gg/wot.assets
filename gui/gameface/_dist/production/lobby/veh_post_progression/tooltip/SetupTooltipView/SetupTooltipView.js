    ...
    var __webpack_modules__ = {
            280: (u, e, t) => {
                ...
                const o = ({
                    ...
                    text: e = '',
                    classMix: t,
                    alignment: F = A.v2.left,
                    formatWithBrackets: o,
                }) => {
                    if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                    const a = o && u ? (0, A.WU)(e, u) : e;
                    return D().createElement(
                        ...
                        a.split('\n').map((e, o) =>
                            D().createElement(
                                'div',
                                { className: E()(r.Z.base, t), key: `${e}-${o}` },
            ...
            70: (u, e, t) => {
                ...
                var F = {};
                (t.r(F),
                    t.d(F, { mouse: () => s, off: () => B, on: () => i, onResize: () => o, onScaleUpdated: () => a }));
                var E = {};
                (t.r(E),
                    t.d(E, {
                        events: () => F,
                ...
                (t.r(n),
                    t.d(n, {
                        ...
                        displayStatus: () => T,
                        displayStatusIs: () => Fu,
                        enableFullScreenModeSupported: () => nu,
                        events: () => y,
                        extraSize: () => Eu,
                            ...
                            const E = e.args,
                                A = (function (u, e) {
                                    ...
                                    var t,
                                        ...
                                        E = {},
                                        A = Object.keys(u);
                                    for (F = 0; F < A.length; F++) ((t = A[F]), e.indexOf(t) >= 0 || (E[t] = u[t]));
                                    return E;
                                })(e, x);
                            return void 0 !== E
                ...
                const ru = { view: n, client: E, sound: g, intl: v };
            },
            5521: (u, e, t) => {
                let F, E;
                (t.d(e, { n: () => F }),
            ...
            3649: (u, e, t) => {
                ...
                const D = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    a = (u, e, t = E.left) => u.split(e).reduce(t === E.left ? r : o, []),
                    i = (() => {
                        const u = new RegExp(
                            [
                    ...
                    C = (u, e = E.left) => {
                        ...
                        return ((u, e = E.left) => {
                            ...
                            const F =
                                ...
                                A = D(u);
                            return (a(A, /( )/, e).forEach((u) => (t = t.concat(a(u, F, E.left)))), t);
                        })(u, e);
                    },
                    s = (u, e, t) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : C(u, e)));
            },
            1358: (u, e, t) => {
                t.d(e, { Z: () => A });
                var F = t(70);
                class E {
                    ...
                    addCallback(u, e, t = 0, E = !0) {
                        ...
                        const A = F.O.view.addModelObserver(u, t, E);
                        return (
                            A > 0
                                ? ((this._callbacks[A] = e),
            ...
            9916: (u, e, t) => {
                ...
                function l(u, e, t, F, E, A, n) {
                    ...
                    D.done ? e(r) : Promise.resolve(r).then(F, E);
                }
                ...
                const p = E.instance,
                    g = {
                        ...
                        sendShowContextMenuEvent: (u, e, t = 0) => {
                            _(D.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                        },
                        sendShowPopOverEvent: (u, e, t, F, E = R.invalid('resId'), A) => {
                        ...
                        dumpViewModel: function u(e) {
                            ...
                            for (const F in e)
                                if (Object.prototype.hasOwnProperty.call(e, F)) {
                                    const E = Object.prototype.toString.call(e[F]);
                                    if (E.startsWith('[object CoherentArrayProxy]')) {
                                        const E = e[F];
                                        t[F] = [];
                                        for (let e = 0; e < E.length; e++) t[F].push({ value: u(E[e].value) });
                                    } else
            ...
            1569: (u, e, t) => {
                ...
                const s = E().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        E().createElement(
                            'div',
                            C({}, s, {
                                className: r()(i.base, i[`base__theme-${D}`], A),
                                ref: function (u) {
                ...
                const _ = (u = 1) => {
                        ...
                        e &&
                            ...
                            window.__feature &&
                                window.__feature !== t &&
                                window.subViews[t] &&
                                (F = window.subViews[t].id));
                        return { callerUrl: E, caller: t, stack: e, resId: F };
                    },
                    ...
                    g = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const F = m(`${u}.${t}`, window);
                                return w(F) ? e(u, t, F) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    h = (u) => {
                        const e = ((u) => {
                                const e = _(),
                                ...
                                return { modelPrefix: E, modelPath: p(E, u || ''), resId: F };
                            })(),
                            t = e.modelPrefix,
                            F = u.split('.');
                        if (F.length > 0) {
                ...
                const b = c.Sw.instance;
                let T;
                !(function (u) {
                    ((u.None = 'None'), (u.Shallow = 'Shallow'), (u.Deep = 'Deep'));
                })(T || (T = {}));
                const y = (u = 'model', e = T.Deep) => {
                        ...
                        v(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    F = h(u);
                                C.current = b.addCallback(F, t, r, e === T.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== T.None)
                ...
                const O = {
                    ...
                    P = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    S = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    M = (0, F.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((r = r.replace(t, `%(${D})`)),
                                    (n[D] = O[u]
                                        ? E().createElement(
                                              'span',
                                              { className: O[u] },
                                              E().createElement(x.z, { text: i, binding: e }),
                                          )
                                        : E().createElement(
                                              'span',
                                              { style: A(u) },
                        ...
                        return E().createElement(x.z, { text: r, classMix: t, binding: n });
                    });
                var L = t(3266),
                    N = t(7833),
                    W = t(7846),
                ...
                const U = 'Content_base_1f',
                    ...
                    z = 'Content_image_48',
                    $ = 'Content_disabledSeparator_32',
                    G = 'Content_content_79',
                    ...
                    Y = () => {
                        ...
                        return E().createElement(
                            'div',
                            { className: U },
                            E().createElement('div', { className: V }, (0, l.uF)(K.title(), { name: K.name.$dyn(t) })),
                            D && E().createElement(N.s, { level: e }),
                            E().createElement(
                                'div',
                                { className: j },
                                E().createElement('div', {
                                    style: { backgroundImage: `url(${H.$dyn(F)})` },
                                    className: z,
                                }),
                            ),
                            ...
                            E().createElement(
                                'div',
                                { className: G },
                                E().createElement(M, { text: String(K.description.$dyn(t)) }),
                                E().createElement('div', { className: q }, K.tip()),
                            ),
                            E().createElement(I.Z, null),
                            !n && E().createElement(W.H, { level: e }),
                            A &&
                                E().createElement(
                                    'div',
                                    null,
                                    !n && E().createElement('div', { className: $ }, E().createElement(I.Z, null)),
                                    E().createElement(L.c, null),
                                ),
                        );
                    },
                    Z = () => E().createElement(s, null, E().createElement(Y, null));
                engine.whenReady.then(() => {
                    n().render(E().createElement(Z, null), document.getElementById('root'));
                });
            },
            3266: (u, e, t) => {
                t.d(e, { c: () => o });
                ...
                const A = 'DisabledBlock_base_ce',
                    ...
                    o = () =>
                        E().createElement(
                            ...
                            E().createElement('div', null, r.description()),
                        );
            },
            7833: (u, e, t) => {
                t.d(e, { s: () => r });
                ...
                const D = 'FeatureLevelSubtitle_level_83',
                    r = ({ level: u }) => {
                        const e = (0, F.useMemo)(
                            () => ({ level: E().createElement('div', { className: D }, (0, A.HG)(u)) }),
                            [u],
                        );
            ...
            7846: (u, e, t) => {
                ...
                const D = 'Lock_base_f9',
                    ...
                    i = ({ level: u }) => {
                        const e = (0, F.useMemo)(
                            () => ({ level: E().createElement('div', { className: o }, (0, A.HG)(u)) }),
                            [u],
                        );
                        return E().createElement(
                            'div',
                            { className: D },
                            E().createElement('div', { className: r }, a.title()),
                            E().createElement(n.z, { binding: e, text: a.description() }),
                        );
                    };
            },
            8899: (u, e, t) => {
                ...
                const A = 'Separator_base_73',
                    n = () => E().createElement('div', { className: A });
            },
            5287: (u, e, t) => {
                t.d(e, { Z: () => F });
                const F = { base: 'FormatText_base_d0' };
            },
            7363: (u) => {
                u.exports = React;
            },
        ...
        (__webpack_require__.O = (u, e, t, F) => {
            if (!e) {
                ...
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, t, F] = deferred[r], A = !0, n = 0; n < e.length; n++)
                        (!1 & F || E >= F) &&
            ...
            F = F || 0;
            for (var r = deferred.length; r > 0 && deferred[r - 1][2] > F; r--) deferred[r] = deferred[r - 1];
            deferred[r] = [e, t, F];
        }),
        ...
        (() => {
            ...
            var e = (e, t) => {
                    var F,
                        ...
                        r = 0;
                    if (A.some((e) => 0 !== u[e])) {
                        for (F in n) __webpack_require__.o(n, F) && (__webpack_require__.m[F] = n[F]);
