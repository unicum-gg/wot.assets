(() => {
    ...
    var __webpack_modules__ = {
            ...
            5067: (u, e, A) => {
                ...
                var t = {};
                A.r(t), A.d(t, { getBgUrl: () => c, getTextureUrl: () => l });
                var D = {};
                function n(u) {
                    return (e) => (
                        engine.on(u, e),
                        ...
                        v(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    F = g(u);
                                C.current = b.addCallback(F, A, n, e === f.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== f.None)
                                return () => {
                                    b.removeCallback(C.current, n);
                                };
                        }, [n, e]),
                        o
                    );
                ...
                const I = 'Content_base_1f',
                    ...
                    $ = () => {
                        ...
                        return E().createElement(
                            'div',
                            { className: I },
                            E().createElement('div', { className: W }, (0, l.uF)(q.title(), { name: q.name.$dyn(A) })),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [428], () => __webpack_require__(6633));
