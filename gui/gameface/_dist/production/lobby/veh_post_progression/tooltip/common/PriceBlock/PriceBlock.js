(() => {
    ...
    var __webpack_modules__ = {
            ...
            5528: (u, e, n) => {
                ...
                var A = {};
                (n.r(A), n.d(A, { getBgUrl: () => f, getTextureUrl: () => y }));
                var E = {};
                function r(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const Au = Object.keys(P).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === P[e]), u), {}),
                    Eu = {
                        set: (u, e) => {
                ...
                const ou = { view: E, client: F, sound: m, intl: w };
            },
            4020: (u, e, n) => {
                n.d(e, { n: () => t });
                let t = (function (u) {
            ...
            1308: (u, e, n) => {
                ...
                function A(u) {
                    let e = '';
                    for (let n = F.length - 1; n >= 0; n--) for (; u >= F[n];) ((e += t[n]), (u -= F[n]));
                    return e;
                }
            ...
            8973: (u, e, n) => {
                ...
                class F {
                    ...
                    addCallback(u, e, n = 0, F = !0) {
                        void 0 === this._updateHandler &&
                            (this._updateHandler = engine.on('viewEnv.onDataChanged', this._emmitDataChanged, this));
                        const A = t.O.view.addModelObserver(u, n, F);
                        return (
                            A > 0
                                ? ((this._callbacks[A] = e),
            ...
            828: (u, e, n) => {
                ...
                function C(u, e, n, t, F, A, E) {
                    ...
                    r.done ? e(i) : Promise.resolve(i).then(t, F);
                }
                ...
                const b = F.instance,
                    p = {
                        ...
                        sendShowContextMenuEvent: (u, e, n = 0) => {
                            d(r.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: n, args: e });
                        },
                        sendShowPopOverEvent: (u, e, n, t, F = R.invalid('resId'), A) => {
                            ...
                            for (const t in e)
                                if (Object.prototype.hasOwnProperty.call(e, t)) {
                                    ...
                                    if (F.startsWith('[object CoherentArrayProxy]')) {
                                        const F = e[t];
                                        n[t] = [];
                                        for (let e = 0; e < F.length; e++) n[t].push({ value: u(F[e].value) });
                                    } else
            ...
            7618: (u, e, n) => {
                ...
                (0, t.memo)(
                    ({
                        ...
                        F().createElement(
                            'span',
                            { className: E()(a.base, a[`base__${n}`], s) },
                            F().createElement(
                                'span',
                                {
                                    className: E()(
                                ...
                                _ && A > 0 && '+',
                                F().createElement(i, { value: A, format: t === o.V2.gold ? 'gold' : 'integral' }),
                            ),
                            F().createElement('span', {
                                className: E()(a.icon, a[`icon__${t}-${n}`], null == C ? void 0 : C.icon),
                            }),
                            u &&
                                F().createElement(
                                    'span',
        ...
        (__webpack_require__.O = (u, e, n, t) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, n, t] = deferred[i], A = !0, E = 0; E < e.length; E++)
                        (!1 & t || F >= t) &&
        ...
        (() => {
            ...
            var e = (e, n) => {
                    var t,
                        ...
                        i = 0;
                    if (A.some((e) => 0 !== u[e])) {
                        for (t in E) __webpack_require__.o(E, t) && (__webpack_require__.m[t] = E[t]);
                        if (r) var a = r(__webpack_require__);
                    }
                    for (e && e(n); i < A.length; i++)
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [428], () => __webpack_require__(7618));
