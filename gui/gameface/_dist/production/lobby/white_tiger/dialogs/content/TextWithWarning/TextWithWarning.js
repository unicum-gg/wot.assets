(() => {
    ...
    var __webpack_modules__ = {
                ...
                const p = E.instance,
                    T = {
                        ...
                        sendShowPopOverEvent: (u, e, A, F, E = R.invalid('resId'), D) => {
                            const t = _.O.view.getViewGlobalPosition(),
                                ...
                                i = B.height,
                                a = {
                                    x: _.O.view.pxToRem(C) + t.x,
                                    y: _.O.view.pxToRem(r) + t.y,
                                    width: _.O.view.pxToRem(o),
                                    height: _.O.view.pxToRem(i),
                                };
                            m(n.POP_OVER, {
                                isMouseEvent: !0,
                                contentID: u,
            ...
            762: (u, e, A) => {
                ...
                const x = 'FormatText_base_d0',
                                ...
                                ((n = n.replace(A, `%(${B})`)),
                                    (t[B] = M[u]
                                        ? E().createElement(
                                              'span',
                                              { className: M[u] },
                                              E().createElement(y, { text: r, binding: e }),
                                          )
                                        : E().createElement(
                                              'span',
                                              { style: D(u) },
                    ...
                    W = 'App_base_86',
                    I = 'App_warningText_7b',
                    V = 'App_mainText_74',
                    z = 'App_punishmentText_a8',
                    H = () => {
                        const u = b(),
                            e = u.mainText,
                            A = u.warningText,
                            D = u.punishmentText,
                            t = u.warningImageSubstitution,
                            B = (0, F.useMemo)(
                                () => ({
                                    marginTop: `${t.marginTop}rem`,
                                    marginRight: `${t.marginRight}rem`,
                                    marginBottom: `${t.marginBottom}rem`,
                                    marginLeft: `${t.marginLeft}rem`,
                                }),
                                [t],
                            ),
                            n = (0, F.useMemo)(() => {
                                const u = {};
                                return (
                                    t.path && (u[t.placeholder] = E().createElement(U, { src: t.path, style: B })),
                                    u
                                );
                            }, [t, B]);
                        return E().createElement(
                            'div',
                            { className: W },
                            A && E().createElement(L, { classMix: I, text: A, binding: n }),
                            E().createElement(L, { classMix: V, text: e }),
                            D && E().createElement(L, { classMix: z, text: D }),
                        );
                    };
                engine.whenReady.then(() => {
                    t().render(E().createElement(H, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [549], () => __webpack_require__(762));
