    ...
    var __webpack_modules__ = {
                    ...
                    x = {
                        ...
                        sendShowPopOverEvent: (u, e, t, r, a = R.invalid('resId'), E) => {
                            const n = B.O.view.getViewGlobalPosition(),
                                ...
                                o = A.height,
                                _ = {
                                    x: B.O.view.pxToRem(F) + n.x,
                                    y: B.O.view.pxToRem(D) + n.y,
            ...
            1780: (u, e, t) => {
                ...
                const c = o.O.client.getSize('rem'),
                    m = c.width,
                    C = c.height,
                    d = Object.assign({ width: m, height: C }, B(m, C, _)),
                    g = (0, r.createContext)(d),
                    h = ['children'],
                    p = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        const a = (0, r.useContext)(g),
                            ...
                            b = { extraLarge: c, large: m, medium: C, small: d, extraSmall: p };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && D) return l(e, t, b);
                            if (t.largeWidth && o) return l(e, t, b);
                            if (t.mediumWidth && _) return l(e, t, b);
                            if (t.smallWidth && s) return l(e, t, b);
                            if (t.extraSmallWidth && B) return l(e, t, b);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                const b = (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(g),
                        ...
                        A = (0, r.useCallback)((u, e) => {
                            ...
                            n(Object.assign({ width: t, height: r }, B(t, r, _)));
                        }, []);
                    (((u) => {
                    ...
                    const i = (0, r.useMemo)(() => Object.assign({}, E), [E]);
                    return a().createElement(g.Provider, { value: i }, u);
                });
                let v, x, f;
                (!(function (u) {
                    ((u[(u.ExtraSmall = _.extraSmall.width)] = 'ExtraSmall'),
                        (u[(u.Small = _.small.width)] = 'Small'),
                        (u[(u.Medium = _.medium.width)] = 'Medium'),
                        (u[(u.Large = _.large.width)] = 'Large'),
                        (u[(u.ExtraLarge = _.extraLarge.width)] = 'ExtraLarge'));
                })(v || (v = {})),
                    (function (u) {
                        ((u[(u.ExtraSmall = _.extraSmall.width)] = 'ExtraSmall'),
                            (u[(u.Small = _.small.width)] = 'Small'),
                    ...
                    (function (u) {
                        ((u[(u.ExtraSmall = _.extraSmall.height)] = 'ExtraSmall'),
                            (u[(u.Small = _.small.height)] = 'Small'),
                            (u[(u.Medium = _.medium.height)] = 'Medium'),
                            (u[(u.Large = _.large.height)] = 'Large'),
                            (u[(u.ExtraLarge = _.extraLarge.height)] = 'ExtraLarge'));
                    })(f || (f = {})));
                const w = () => {
                    ...
                    M = [v.ExtraLarge, v.Large, v.Medium, v.Small, v.ExtraSmall],
                    y = (u, e) =>
                ...
                Object.keys(D());
                const N = {
                        XL: { mt: T.mt__XL, mr: T.mr__XL, mb: T.mb__XL, ml: T.ml__XL },
                        LG: { mt: T.mt__LG, mr: T.mr__LG, mb: T.mb__LG, ml: T.ml__LG },
                        MDp: { mt: T.mt__MDp, mr: T.mr__MDp, mb: T.mb__MDp, ml: T.ml__MDp },
                        MD: { mt: T.mt__MD, mr: T.mr__MD, mb: T.mb__MD, ml: T.ml__MD },
                        SMp: { mt: T.mt__SMp, mr: T.mr__SMp, mb: T.mb__SMp, ml: T.ml__SMp },
                        SM: { mt: T.mt__SM, mr: T.mr__SM, mb: T.mb__SM, ml: T.ml__SM },
                        XS: { mt: T.mt__XS, mr: T.mr__XS, mb: T.mb__XS, ml: T.ml__XS },
                    },
                    k = (Object.keys(N), ['mt', 'mr', 'mb', 'ml']),
                    ...
                    W = O((u) => {
                        let e = u.className,
                            ...
                            M = u.wrap,
                            y = u.flexWrap,
                            O = void 0 === y ? (M ? 'wrap' : void 0) : y,
                            R = u.grow,
                            W = u.shrink,
                            G = u.flex,
                            U = void 0 === G ? (R || W ? `${R ? 1 : 0} ${W ? 1 : 0} auto` : void 0) : G,
                            j = u.style,
                            X = u.children,
                            $ = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const K = (0, r.useMemo)(() => {
                            ...
                            }, [t, E, F, l, _, B, j, U, S, d, O, f, L]),
                            z = K.computedStyle,
                            V = K.computedClassNames;
                        return a().createElement('div', P({ className: i()(T.base, ...V, e), style: z }, $), X);
                    });
                let G;
                !(function (u) {
                ...
                const U = (u, e, t) => {
                    ...
                    X = (u, e, t = G.left) => u.split(e).reduce(t === G.left ? U : j, []),
                    $ = (() => {
                        const u = new RegExp(
                    ...
                    K = ['zh_cn', 'zh_sg', 'zh_tw'],
                    z = ({ binding: u, text: e = '', classMix: t, alignment: E = G.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, n) =>
                                      a().createElement(
                                          'div',
                                          { className: i()('FormatText_base_d0', t), key: `${e}-${n}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                ...
                const J = Object.keys(q()),
                    ...
                    Eu = O((u) => {
                        ...
                        return a().createElement(
                            ...
                            Q(
                                {
                                    className: i()(Y.base, t && Y[t], p, E),
                                    style: h,
                                    mt: !0 === D ? ru[t || 'paragraph-P16'].mt : D,
                                    mr: !0 === o ? ru[t || 'paragraph-P16'].mr : o,
                                    mb: !0 === s ? ru[t || 'paragraph-P16'].mb : s,
                                    ml: !0 === c ? ru[t || 'paragraph-P16'].ml : c,
                                },
                                d,
                            ),
                            void 0 !== C ? a().createElement(z, Q({}, C, { text: e })) : e,
                        );
                    });
                var nu = t(5521);
                t(4179);
                ...
                (!(function (u) {
                    ...
                    (function (u) {
                        ((u.Primary = 'primary'), (u.Secondary = 'secondary'), (u.Ghost = 'ghost'));
                    })(su || (su = {})));
                const Bu = (0, r.memo)(
                        ({
                            title: u,
                            ...
                            const _ = (0, r.useState)(!1),
                                ...
                                g = i()(ou.bgOverlay, ou[`bgOverlay__${l}`], {
                                    [ou.bgOverlay__hover]: m,
                                    [ou.bgOverlay__active]: s,
                                    [ou.bgOverlay__disabled]: e,
                                }),
                                h = i()(ou.bgImage, ou[`bgImage__${l}`], {
                                    [ou.bgImage__hover]: m,
                                    [ou.bgImage__active]: s,
                                    [ou.bgImage__disabled]: e,
                                }),
                                p = i()(ou.content, ou[`content__${l}`], null == o ? void 0 : o.content),
                                b = i()(ou.bgLines, ou[`bgLines__${l}`], { [ou.bgLines__disabled]: e });
                            return a().createElement(
                                'div',
                                { className: E },
                                a().createElement(
                                    ...
                                    A &&
                                        a().createElement(
                                            a().Fragment,
                                            null,
                                            a().createElement('div', { className: ou.pulseAnimatedBoxOne }),
                                            a().createElement('div', { className: ou.pulseAnimatedBoxTwo }),
                                            a().createElement('div', { className: ou.pulseAnimatedBoxThree }),
                                        ),
                                    a().createElement(
                                        'div',
                                        { className: p },
                                        F &&
                                            a().createElement('div', {
                                                className: i()(ou.btnIcon, ou.btnIcon__left),
                                                style: { backgroundImage: `url(${F})` },
                                            }),
                                        a().createElement(Eu, { text: u }),
                                        n &&
                                            a().createElement('div', {
                                                className: i()(ou.btnIcon, ou.btnIcon__right),
                    ...
                    cu = ({ onClick: u, text: e, classes: t }) => {
                        ...
                        return a().createElement(
                            'div',
                            { onClick: u, onMouseEnter: F, onMouseLeave: F, className: 'DefaultCloseButton_base_bf' },
                            a().createElement('div', { className: 'DefaultCloseButton_shine_e1' }),
                            a().createElement(Eu, {
                                className: i()('DefaultCloseButton_text_1d', null == t ? void 0 : t.text),
                                text: e,
                            }),
                            a().createElement(
                                'div',
                                { className: i()('DefaultCloseButton_icon_28', null == t ? void 0 : t.icon) },
                                a().createElement('div', { className: 'DefaultCloseButton_glow_54' }),
                            ),
                        );
                    };
                function mu() {
                ...
                const gu = (u) => (0 === u ? window : window.subViews.get(u)),
                    hu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: n, mocks: A }) {
                                const i = (0, r.useRef)([]),
                                    F = (u, t, r) => {
                                        var a;
                                        const E = (function ({
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : A(e),
                                                            a = Cu.observable.box(r, { equals: mu });
                                                        return (
                                                            'real' === u &&
                                                                n.subscribe(
                                                                    (0, Cu.action)((u) => a.set(u)),
                                                                    e,
                                                                ),
                                                            a
                                                        );
                                            ...
                                            l = { mode: u, model: D, externalModel: n, cleanup: F };
                                        return {
                                            model: D,
                                    ...
                                    _ = l[0],
                                    s = l[1],
                                    B = (0, r.useState)(() => F(u, E, A)),
                                    c = B[0],
                                    m = B[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        D.current ? m(F(_, E, A)) : (D.current = !0);
                                    }, [A, _, E]),
                                    (0, r.useEffect)(() => {
                                        s(u);
                                    }, [u]),
                                    ...
                                    a().createElement(t.Provider, { value: c }, n)
                                );
                            },
                            () => (0, r.useContext)(t),
                        ];
                    })(0, ({ externalModel: u }) => ({ approve: u.createCallbackNoArgs('onApprove') })),
                    pu = hu[0],
                    bu = hu[1];
                var vu;
                !(function (u) {
                    ((u.Big = 'big'), (u.Medium = 'medium'), (u.Small = 'small'));
                })(vu || (vu = {}));
                const xu = (0, Fu.observer)(() => {
                    const u = bu(),
                        e = u.controls,
                        t = u.model.root.get().complexity,
                        r = e.approve,
                        E = w().mediaSize,
                        n = ((u) => (u === v.ExtraLarge ? _u.ExtraLarge : _u.Large))(E),
                        A = (function ({
                            key: u = nu.n.ESCAPE,
                        ...
                        F = t >= 2 && t <= 5 ? R.strings.portal_complexity_unlock.complexity.$num(t) : '',
                        D = `url('R.images.portal.gui.maps.icons.complexity_unlock.lvl.${i}.c_${t}') no-repeat center / cover`;
                    return a().createElement(
                        'div',
                        { className: 'App_base_42' },
                        a().createElement('div', { className: 'App_bg_ae' }),
                        a().createElement('div', { className: 'App_texture_ad' }),
                        a().createElement('div', { className: 'App_portal_d5' }),
                        a().createElement('div', { className: 'App_ellipseSmall_b2' }),
                        a().createElement('div', { className: 'App_ellipseLarge_bc' }),
                        5 === t && a().createElement('div', { className: 'App_hardLvl_80' }),
                        a().createElement(
                            'div',
                            { className: 'App_buttonClose_f2' },
                            a().createElement(cu, {
                                onClick: A,
                                text: R.strings.portal_complexity_unlock.closeButton.default(),
                            }),
                        ),
                        a().createElement(
                            'div',
                            { className: 'App_complexity_97', style: { background: D } },
                            a().createElement('div', { className: 'App_leftDivider_35' }),
                            a().createElement('div', { className: 'App_rightDivider_ed' }),
                        ),
                        a().createElement(
                            'div',
                            { className: 'App_top_84' },
                            a().createElement(
                                'div',
                                { className: 'App_difficultyLvlAvailableWrapper_35' },
                                a().createElement(Eu, {
                                    text: R.strings.portal_complexity_unlock.difficulty_level_available(),
                                    className: 'App_difficultyLvlAvailable_fc',
                                }),
                            ),
                            a().createElement(Eu, { text: F, className: 'App_complexityName_d1' }),
                        ),
                        a().createElement(
                            'div',
                            { className: 'App_bottom_68' },
                            a().createElement(Eu, {
                                text: R.strings.portal_complexity_unlock.change_complexity_info(),
                                className: 'App_changeComplexityInfo_68',
                            }),
                            a().createElement(Bu, {
                                className: 'App_button_fd',
                                onClick: r,
                                title: R.strings.portal_complexity_unlock.button.approve(),
                                size: n,
                                classes: { content: 'App_buttonContent_ad' },
                            }),
                        ),
                    );
                });
                ...
                const Mu = {
                        [x.ExtraSmall]: '',
                        [x.Small]: wu().SMALL_WIDTH,
                        [x.Medium]: `${wu().SMALL_WIDTH} ${wu().MEDIUM_WIDTH}`,
                        [x.Large]: `${wu().SMALL_WIDTH} ${wu().MEDIUM_WIDTH} ${wu().LARGE_WIDTH}`,
                        [x.ExtraLarge]: `${wu().SMALL_WIDTH} ${wu().MEDIUM_WIDTH} ${wu().LARGE_WIDTH} ${wu().EXTRA_LARGE_WIDTH}`,
                    },
                    yu = {
                        [f.ExtraSmall]: '',
                        [f.Small]: wu().SMALL_HEIGHT,
                        [f.Medium]: `${wu().SMALL_HEIGHT} ${wu().MEDIUM_HEIGHT}`,
                        [f.Large]: `${wu().SMALL_HEIGHT} ${wu().MEDIUM_HEIGHT} ${wu().LARGE_HEIGHT}`,
                        [f.ExtraLarge]: `${wu().SMALL_HEIGHT} ${wu().MEDIUM_HEIGHT} ${wu().LARGE_HEIGHT} ${wu().EXTRA_LARGE_HEIGHT}`,
                    },
                    Ou = {
                        [v.ExtraSmall]: '',
                        [v.Small]: wu().SMALL,
                        [v.Medium]: `${wu().SMALL} ${wu().MEDIUM}`,
                        [v.Large]: `${wu().SMALL} ${wu().MEDIUM} ${wu().LARGE}`,
                        [v.ExtraLarge]: `${wu().SMALL} ${wu().MEDIUM} ${wu().LARGE} ${wu().EXTRA_LARGE}`,
                    },
                    Tu = (u) => {
                        let e = u.children,
                            t = u.className,
                        ...
                        const E = w(),
                            ...
                            A = E.mediaHeight,
                            F = E.mediaSize;
                        return a().createElement('div', Su({ className: i()(t, Mu[n], yu[A], Ou[F]) }, r), e);
                    },
                    Ru = ['children'],
                    Hu = (u) => {
                        let e = u.children,
                        ...
                        return a().createElement(b, null, a().createElement(Tu, t, e));
                    };
                engine.whenReady.then(() => {
                    n().render(
                        a().createElement(pu, null, a().createElement(Hu, null, a().createElement(xu, null))),
        ...
        (__webpack_require__.O = (u, e, t, r) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, t, r] = deferred[i], E = !0, n = 0; n < e.length; n++)
                        (!1 & r || a >= r) &&
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); i < E.length; i++)
                        ((a = E[i]), __webpack_require__.o(u, a) && u[a] && u[a][0](), (u[a] = 0));
                    return __webpack_require__.O(F);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
        })());
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1780));
