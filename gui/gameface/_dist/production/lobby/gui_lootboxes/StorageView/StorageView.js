(() => {
    var __webpack_modules__ = {
            ...
            4179: (e, u, t) => {
                'use strict';
                t.d(u, { kH: () => E, Z5: () => a, lf: () => m, cy: () => i, B0: () => s, ry: () => C });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            8861: (e, u, t) => {
                ...
                var r = {};
                t.r(r), t.d(r, { Area: () => Iu, Bar: () => Lu, Default: () => ku, useVerticalScrollApi: () => xu });
                var o = t(7739),
                    a = t(6179),
                    i = t.n(a),
                    s = t(6483),
                ...
                const H = (e, u, t) => {
                    ...
                    G = (e, u, t = I.left) => e.split(u).reduce(t === I.left ? H : P, []),
                    W = (() => {
                        const e = new RegExp(
                ...
                !(function (e) {
                    ...
                    Date.now();
                const z = (0, a.memo)(({ datetime: e, format: u = U.SHORT_DATE, localize: t = !0 }) =>
                        ((e, u, t) => {
                            switch (u) {
                                case U.SHORT_DATE:
                                    return t
                    ...
                    $ = ({ binding: e, text: u = '', classMix: t, alignment: n = I.left }) =>
                        null === u
                    ...
                    Y = R.images.gui.maps.icons.components.countdown.big.clock(),
                    q = i().memo(
                            ...
                            i().createElement(
                                ...
                                X.userName.$dyn(e) &&
                                    i().createElement(
                                        ...
                                        i().createElement($, { text: X.userName.$dyn(e), classMix: K.headerName }),
                                    ),
                                i().createElement(
                                    'div',
                                    { className: K.headerDescription },
                                    i().createElement('div', { className: l()(K.boxIcon, K[`boxIcon__tier${u}`]) }),
                                    V.tier.$dyn(`tier_${u}`) &&
                                        i().createElement($, { text: V.tier.$dyn(`tier_${u}`), classMix: K.infoBoxes }),
                                    t > 0 &&
                                        !o &&
                                        i().createElement(
                                            i().Fragment,
                                            null,
                                            i().createElement('div', { className: K.headerDescriptionDivider }),
                                            i().createElement($, {
                                ...
                                r > 0 &&
                                    i().createElement(
                                        ...
                                        i().createElement($, {
                                            text: X.autoOpenView.dateOpen(),
                                            binding: {
                                                date: i().createElement(z, { datetime: r, format: U.FULL_DATE_TIME }),
                                            },
                                            classMix: K.autoOpenText,
                                        }),
                                    ),
                                X.desctiptions.$dyn(n) &&
                                    i().createElement($, { text: X.desctiptions.$dyn(n), classMix: K.description }),
                            ),
                    ),
                    Z = {
                ...
                const ee = ({
                    ...
                    const D = (0, a.useRef)(null),
                        ...
                        M = (0, a.useCallback)(
                            (e) => {
                                r || (null !== c && (0, v.G)(c), E && E(e), t && y(), h(!0));
                            },
                            [r, c, E, y, t],
                        ),
                        k = (0, a.useCallback)(
                ...
                const ie = { keyID: 0, keyType: re.Simple, count: 1, iconName: '', userName: '', openProbability: 0 },
                    se = (e, u) => {
                        const t = {};
                        return (
                            e.forEach((e) => {
                        ...
                        const b = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            h = (0, a.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (me(t, _, { isMouseEvent: !0, on: !0, arguments: de(n) }, v),
                                    C && C(),
                ...
                const be = ({ children: e, tooltipArgs: u, className: t }) => {
                        ...
                        return r || a
                            ? i().createElement(Ee, ge({}, u, { contentId: r || a }), n)
                            : i().createElement(Fe, u, n);
                    },
                    ve = {
                ...
                const fe = i().memo(
                        ({
                            ...
                            if (u)
                                return i().createElement(
                                    ...
                                    i().createElement('div', { className: l()(ve.bg, ve.bg__disabled) }),
                                    i().createElement('div', { className: l()(ve.content, ve.content__disabled) }, e),
                                );
                            const o = t ? he.Checked : he.Normal;
                            return i().createElement(
                                'div',
                                { className: l()(ve.base, n), onClick: r },
                                i().createElement('div', { className: l()(ve.bg, ve[`bg__${o}`]) }),
                                i().createElement('div', { className: l()(ve.border, ve[`border__${o}`]) }),
                                o === he.Checked ? i().createElement('div', { className: ve.check }) : '',
                                i().createElement('div', { className: l()(ve.content) }, e),
                            );
                        },
                    ),
                    xe = {
                    ...
                    ye = ({
                        ...
                        return i().createElement(
                            'div',
                            { className: l()(xe.base, s) },
                            i().createElement('div', { className: xe.divider }),
                            i().createElement(
                                'div',
                            ...
                            i().createElement('div', { className: l()(xe.divider, xe.divider__second) }),
                            i().createElement(
                                'div',
                                ...
                                i().createElement(fe, {
                                    content:
                                        (null == (c = g[F]) ? void 0 : c.itemsCount) < g[F].itemsMaxCount
                                            ? i().createElement($, { text: we.optional.openCount.all() })
                                            : i().createElement($, {
                                                  text: we.optional.openCount.numberCount(),
                            ...
                            i().createElement(
                                ...
                                i().createElement($, { text: b ? we.optional.buyBox() : we.optional.openBox() }),
                            ),
                        );
                    },
                    Te = {
                        ...
                        ({
                            ...
                            return i().createElement(
                                ...
                                i().createElement(
                                    ...
                                    i().createElement(fe, {
                                        content: i().createElement($, {
                                            text: Se.optional.openCount.numberCount(),
                                            binding: { count: 1 },
                                        }),
                                        classNames: n,
                                        handleButtonClick: () => {
                                    ...
                                    i().createElement(fe, {
                                        content:
                                            e < 10
                                                ? i().createElement($, { text: Se.optional.openCount.all() })
                                                : i().createElement($, {
                                                      text: Se.optional.openCount.numberCount(),
                                                      binding: { count: 10 },
                                                  }),
                                ...
                                i().createElement(
                                    ...
                                    i().createElement($, { text: Se.optional.openBox() }),
                                ),
                            );
                        },
                    ),
                                ...
                                r
                                    ? i().createElement(
                                          ...
                                          i().createElement(
                                              ...
                                              Ne.entryPointWidget.disabledTooltip.body(),
                                          ),
                                      )
                                    : i().createElement(
                                          'div',
                                              ...
                                              ? ((e) =>
                                                    Object.keys(e).length
                                                        ...
                                                        : i().createElement(
                                                              ...
                                                              i().createElement($, { text: Ne.optional.buyBox() }),
                                                          ))(_)
                                              : i().createElement(
                                                    'div',
                                                    null,
                                                    m
                                                        ? i().createElement(
                                                              ue,
                                                              {
                                                                  mixClass: l()(ne, 'BoxRadioButtons_buyButton_a7'),
                                                                  size: Q.medium,
                                                                  type: J.main,
                                                                  onClick: C,
                                                                  disabled: !s,
                ...
                const Ze = ((e, u) => {
                        ...
                        return [
                            function ({ mode: e = 'real', options: n, children: r, mocks: o }) {
                                        ...
                                        const o = (function ({
                                            ...
                                            c = (({ observableModel: e }) => {
                                                const u = Object.assign({}, e.primitives(['isShowTriggerHint']), {
                                                    ...
                                                    t = (0, qe.Om)(
                                                        () =>
                                                            Ye(u.lootboxes.get(), (e) =>
                                                                Object.assign({}, e, {
                                                                    bonusGroups: Ye(e.bonusGroups, Ue),
                                                                }),
                                                            ),
                                                        { equals: ze },
                                                    ),
                                                    n = (0, qe.Om)(
                                                        () => {
                                                            ...
                                                            return e
                                                                ? Object.assign({}, e, {
                                                                      bonusGroups: Ye(e.bonusGroups, (u) => ({
                                                                          value: u,
                                                                          stage: u === Me ? e.progressionStage : 0,
                                                                      })),
                                                                      unlockKeyIDs: Ye(e.unlockKeyIDs, (e) => e),
                                                                  })
                                                                : void 0;
                                                        },
                                                        { equals: ze },
                                                ...
                                                return Object.assign({}, u, {
                                                    computes: {
                                                        getLootboxes: t,
                                                        getCurrentLootbox: n,
                                                        getLootboxKeys: () => Ye(u.lootboxKeys.get(), (e) => e),
                                                    },
                                                });
                                            })({
                                                mode: e,
                                ...
                                return (
                                    (0, a.useEffect)(() => {
                                        c.current ? F(l(m, n, o)) : (c.current = !0);
                                    }, [o, m, n]),
                                    (0, a.useEffect)(() => {
                                        E(e);
                                    }, [e]),
                    ...
                    tu = i().memo(({ bonusGroups: e, lootBoxID: u }) => {
                        ...
                        return i().createElement(
                            ...
                            i().createElement(
                                'div',
                                { className: je.possibleRewardsInfoWrapper },
                                i().createElement(
                                    'div',
                                    { className: je.frame },
                                    i().createElement('div', { className: l()(je.corner, je.corner__topLeft) }),
                                    i().createElement(
                                        'div',
                                        { className: je.frameContent },
                                        i().createElement(
                                            'div',
                                            { className: je.possibleRewardsHeader },
                                            eu.optional.possibleRewardsTitle(),
                                        ),
                                    ),
                                    i().createElement('div', { className: l()(je.corner, je.corner__topRight) }),
                                ),
                                i().createElement(
                                    'div',
                                    { className: je.possibleRewardsImagesWrapper },
                                    e.map(({ value: e, stage: t }, n) => {
                                        var r;
                                        return i().createElement(
                                            be,
                                            { key: `${e}_${n}`, tooltipArgs: Object.assign({}, uu(e, u)) },
                                            i().createElement(
                                                'div',
                                                { className: l()(je.reward, (n + 1) % 3 == 0 && je.noMarginRight) },
                                                i().createElement(
                                                    'div',
                                                    { className: l()(je.rewardIcon, je[`rewardIcon__${e}`]) },
                                                    t > 0 &&
                                                        i().createElement('div', {
                                                            className: l()(je.stage, je[`stage__${t}`]),
                                                        }),
                                                ),
                                                i().createElement($, {
                                                    text: null != (r = eu.possibleRewards.$dyn(e)) ? r : '',
                                                    classMix: je.rewardName,
                                                }),
                                            ),
                                        );
                                    }),
                                ...
                                i().createElement(
                                    'div',
                                    { className: l()(je.frame, je.frame__bottom) },
                                    i().createElement('div', { className: l()(je.corner, je.corner__bottomLeft) }),
                                    i().createElement(
                                        'div',
                                        { className: je.frameContent },
                                        i().createElement(
                                    ...
                                    i().createElement('div', { className: l()(je.corner, je.corner__bottomRight) }),
                                ),
                            ),
                        );
                    }),
                ...
                function su(e) {
                    ...
                    return (
                        ...
                        (0, a.useCallback)((...e) => (0, u.current)(...e), iu)
                    );
                }
                function lu(e, u, t = []) {
                ...
                const Eu = {
                        ...
                        return (s = {}) => {
                            const l = s.settings,
                                ...
                                A = (0, du.useSpring)(() => ({
                                    ...
                                    onChange: (e) => {
                                        const u = d.current;
                                        u && (t(u, e), E.trigger('change', e), o && _());
                                    },
                            ...
                            return (
                                ...
                                (0, a.useMemo)(
                                    ...
                                    [F.scrollPosition, C, p, E.off, E.on, v, g, D, c.step.clampedArrowStepTimeout],
                                )
                            );
                        };
                    },
                    ...
                    bu = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Cu, onDrag: n = pu }) => {
                        const r = (0, a.useRef)(null),
                            ...
                            D = () => {
                                ...
                                const a = e.animationScroll.scrollPosition.get(),
                                    i = Math.min(1, n / r),
                                    l = (0, au.u)(0, 1, a / (r - n)),
                                    m = (u.offsetWidth - gu(u, i)) * l;
                                (t.style.transform = `translateX(${0 | m}px)`),
                                    ((e) => {
                                        if (o.current && s.current && c.current && d.current) {
                                            if (0 === e)
                                                return o.current.classList.add(Du), void s.current.classList.remove(Du);
                                            if (
                                                ((u = c.current),
                                                (t = d.current),
                                                e - (u.offsetWidth - t.offsetWidth) >= -0.5)
                                            )
                                                return o.current.classList.remove(Du), void s.current.classList.add(Du);
                                            var u, t;
                        ...
                        (0, a.useEffect)(() => ou(B)),
                            ...
                            (0, a.useEffect)(() => {
                                ...
                                const u = (u) => {
                                    ...
                                    t = () => {
                                        window.removeEventListener('mousemove', u), F(Bu);
                                    };
                                return (
                        ...
                        const C = lu((u) => e.applyStepTo(u), m, [e]),
                            p = C[0],
                            g = C[1];
                        (0, a.useEffect)(
                            () => (
                        ...
                        const b = (e) => {
                            e.target.classList.contains(Du) || (0, v.G)('highlight');
                        };
                        return i().createElement(
                            'div',
                            ...
                            i().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Du) || 0 !== e.button || ((0, v.G)('play'), p(mu.Next));
                                },
                                onMouseUp: g,
                                ref: o,
                                onMouseEnter: b,
                            ...
                            i().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Du) || 0 !== e.button || ((0, v.G)('play'), p(mu.Prev));
                                },
                                onMouseUp: g,
                                ref: s,
                                onMouseEnter: b,
                    ...
                    hu = ({
                        ...
                        const m = (0, a.useMemo)(() => {
                                const e = n || {};
                                return Object.assign({}, e, { base: l()(vu.base, e.base) });
                            }, [n]),
                            E = (0, a.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
                        return i().createElement(
                            'div',
                            { className: l()(vu.defaultScroll, t), onWheel: u.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: l()(vu.defaultScrollArea, r) },
                                i().createElement(fu, { className: s, api: E, classNames: o }, e),
                            ),
                            i().createElement(bu, { getStepByRailClick: c, api: u, onDrag: d, classNames: m }),
                        );
                    },
                    fu = ({ api: e, className: u, classNames: t, children: n, style: r }) => (
                        (0, a.useEffect)(() => ou(e.recalculateContent)),
                        i().createElement(
                            'div',
                            { className: l()(vu.base, u), style: r },
                            i().createElement(
                                'div',
                                {
                                    className: l()(vu.wrapper, null == t ? void 0 : t.wrapper),
                                    onWheel: e.handleMouseWheel,
                                    ref: e.wrapperRef,
                                },
                                i().createElement(
                                    'div',
                                    { className: l()(vu.content, null == t ? void 0 : t.content), ref: e.contentRef },
                                    n,
                                ),
                            ),
                        )
                ...
                (fu.Bar = bu),
                    (fu.Default = hu),
                    (fu.SeniorityAwards = ({ api: e, className: u, classNames: t, children: n }) => (
                        (0, a.useEffect)(() => ou(e.recalculateContent)),
                        i().createElement(
                            'div',
                            { className: l()(vu.base, u) },
                            i().createElement(
                                'div',
                                { className: l()(vu.wrapper, null == t ? void 0 : t.wrapper), ref: e.wrapperRef },
                                i().createElement(
                                    'div',
                                    { className: l()(vu.content, null == t ? void 0 : t.content), ref: e.contentRef },
                                    n,
                ...
                const xu = _u({
                    ...
                    Lu = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Ru, onDrag: n = Tu }) => {
                        const r = (0, a.useRef)(null),
                            o = (0, a.useRef)(null),
                            s = (0, a.useRef)(null),
                            c = (0, a.useRef)(null),
                        ...
                        (0, a.useEffect)(() => ou(C)),
                            ...
                            (0, a.useEffect)(() => {
                                ...
                                const u = (u) => {
                                    ...
                                    t = () => {
                                        window.removeEventListener('mousemove', u), F(Su);
                                    };
                                return (
                                    window.addEventListener('mousemove', u),
                                    window.addEventListener('mouseup', t),
                        ...
                        const p = lu((u) => e.applyStepTo(u), m, [e]),
                            g = p[0],
                            b = p[1];
                        (0, a.useEffect)(
                            () => (
                        ...
                        const h = (e) => {
                            e.target.classList.contains(yu) || (0, v.G)('highlight');
                        };
                        return i().createElement(
                            'div',
                            ...
                            i().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(yu) || 0 !== e.button || ((0, v.G)('play'), g(mu.Next));
                                },
                                ref: o,
                                onMouseEnter: h,
                            }),
                                    ...
                                    onMouseDown: (u) => {
                                        ...
                                        n &&
                                            ...
                                            u.target === n
                                                ...
                                                : ((r = u.screenY > n.getBoundingClientRect().y ? mu.Prev : mu.Next),
                                                  d.current &&
                                                      Nu(e, (u) => {
                                                          if (!u) return;
                                                          const n = t(e),
                            ...
                            i().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(yu) || 0 !== e.button || ((0, v.G)('play'), g(mu.Prev));
                                },
                                onMouseUp: b,
                                ref: s,
                                onMouseEnter: h,
                    ...
                    ku = ({
                        ...
                        const m = (0, a.useMemo)(() => {
                                const e = n || {};
                                return Object.assign({}, e, { base: l()(Mu.base, e.base) });
                            }, [n]),
                            E = (0, a.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
                        return i().createElement(
                            'div',
                            { className: l()(Mu.defaultScroll, t), onWheel: u.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: l()(Mu.area, r) },
                                i().createElement(Iu, { className: o, classNames: s, api: E }, e),
                            ),
                            i().createElement(Lu, { getStepByRailClick: c, api: u, onDrag: d, classNames: m }),
                        );
                    },
                    Iu = ({ className: e, classNames: u, children: t, api: n }) => (
                        (0, a.useEffect)(() => ou(n.recalculateContent)),
                        i().createElement(
                            'div',
                            { className: l()(Mu.base, e), ref: n.wrapperRef, onWheel: n.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: l()(Mu.content, null == u ? void 0 : u.content), ref: n.contentRef },
                                t,
                            ),
                        )
                    );
                Iu.Default = ku;
                const Hu = { Vertical: r, Horizontal: n },
                    Pu = { type: 'idle' },
                    Gu = {
                    ...
                    Wu = ({ count: e, customFontSize: u, maximum: t }) => {
                    ...
                    ju = {
                        ...
                        icon__zero: 'LootboxCard_icon__zero_e1',
                        infinite: 'LootboxCard_infinite_85',
                        count: 'LootboxCard_count_f7',
                        count__zero: 'LootboxCard_count__zero_90',
                        text: 'LootboxCard_text_fc',
                        text__zero: 'LootboxCard_text__zero_48',
                    ...
                    $u = i().memo(
                        ({
                            ...
                            const E = (0, a.useState)(!1),
                                ...
                                B = F[1],
                                C = (0, m.GS)().mediaSize,
                                p = null != (d = zu.userName.$dyn(e)) ? d : zu.userName.default(),
                                g = l()(
                                    ju.base,
                                    o && ju.base__selected,
                                    !t && ju.base__disabled,
                                ...
                                b = C < m.cJ.Medium ? 'c_96x64' : 'c_160x106',
                                h = 0 === n && t,
                                f = (0, du.useTransition)(_, {
                                    key: _,
                                    from: { opacity: 0 },
                                    enter: { opacity: 1 },
                                    leave: { opacity: 0 },
                                ...
                                w = (0, a.useCallback)(
                                    (e, u) =>
                                        u
                                            ? i().createElement('div', { className: ju.infinite })
                                            : i().createElement(
                                                  'div',
                                                  { className: l()(ju.count, h && ju.count__zero) },
                                                  i().createElement(Wu, { count: e }),
                                              ),
                                    [h],
                                ),
                                y = (0, a.useCallback)(
                            ...
                            var T, S;
                            return (
                                (T = `R.images.gui_lootboxes.gui.maps.lootboxes.${b}.${u}`),
                                (S = y),
                                (0, a.useEffect)(() => {
                                    const e = () => S(!0),
                                        u = () => S(!1),
                                ...
                                i().createElement(
                                    ...
                                    (!t || h) &&
                                        i().createElement(
                                            'div',
                                            { className: ju.disabledOverlay },
                                            i().createElement('div', {
                                                className: l()(ju.disabledOverlay, ju.disabledOverlay__layout),
                                            }),
                                            i().createElement('div', {
                                                className: l()(ju.disabledOverlay, ju.disabledOverlay__img),
                                            }),
                                        ),
                                    i().createElement(
                                        be,
                                        ...
                                        i().createElement('div', {
                                            className: l()(ju.icon, h && ju.icon__zero),
                                            style: { background: D },
                                        }),
                                    ),
                                    w(n, s),
                                    i().createElement(
                                        'div',
                                        { className: l()(ju.text, h && ju.text__zero) },
                                        i().createElement($, { text: p, classMix: ju.innerText }),
                                    ),
                                    t &&
                                        !o &&
                                        f(
                                            (e, u) =>
                                                u &&
                                                i().createElement(du.animated.div, { className: ju.hover, style: e }),
                                        ),
                                    !t &&
                                        i().createElement(
                                            i().Fragment,
                                            null,
                                            i().createElement('div', { className: ju.hover }),
                                            i().createElement('div', { className: ju.disabled }),
                                        ),
                                    t &&
                                        o &&
                                        i().createElement(
                                            i().Fragment,
                                            null,
                                            i().createElement('div', { className: ju.check, style: x }),
                                            i().createElement('div', { className: ju.hover, style: x }),
                                        ),
                                )
                            );
                        },
                ...
                const Vu = (0, M.Pi)(({ disabled: e, onChange: u }) => {
                    const t = Au();
                    !(function (e, u) {
                    ...
                    const n = Qe().model,
                        ...
                        s = lu((e) => t.applyStepTo(e), t.stepTimeout, [t]),
                        c = s[0],
                        d = s[1],
                        m = (0, a.useCallback)(
                            (t) => {
                    ...
                    return (
                        ...
                        i().createElement(
                            ...
                            E &&
                                i().createElement('div', {
                                    className: l()(Gu.prev, !A && Gu.prev__disabled),
                                    onMouseDown: () => {
                                        A && c(mu.Next);
                                    },
                                    onMouseUp: d,
                            ...
                            i().createElement(
                                'div',
                                { className: Gu.carousel },
                                i().createElement(
                                    Hu.Horizontal.Area,
                                    {
                                        api: t,
                                        classNames: {
                                            content: Gu.horizontalContent,
                                            wrapper: E ? '' : Gu.horizontalWrapper,
                                        },
                                        className: Gu.scroll,
                                    },
                                    Ye(o, (e) =>
                                        i().createElement(
                                            'div',
                                            { key: e.boxID, className: Gu.lootboxCard },
                                            i().createElement(
                                                $u,
                                                Ku({}, e, { isSelected: e.boxID === r, onSelect: m }),
                                            ),
                                        ),
                                    ),
                                ),
                            ...
                            E &&
                                i().createElement('div', {
                                    className: l()(Gu.next, !B && Gu.next__disabled),
                                    onMouseDown: () => {
                                        B && c(mu.Prev);
                                    },
                                    onMouseUp: d,
                ...
                const qu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    Ju = [m.cJ.ExtraLarge, m.cJ.Large, m.cJ.Medium, m.cJ.Small, m.cJ.ExtraSmall],
                    Qu = (e, u) =>
                        Object.keys(e).reduce((t, n) => {
                            ...
                            return (
                                void 0 === r ||
                                    ((e, u) => qu.some((t) => void 0 !== u[`${e}_${t}`]))(n, e) ||
                                    (t[n] = r),
                                t
                            );
                        }, {}),
                        ...
                        const G = (0, a.useMemo)(() => {
                                const e = { mt: s, mr: d, mb: E, ml: A },
                                    u = ((e) =>
                                        ot.reduce((u, t) => {
                                            const n = e[t];
                                            return n && 'number' != typeof n ? u.concat(rt[!0 === n ? 'MD' : n][t]) : u;
                                        }, []))(e),
                                    r = ((e) =>
                                        ot.reduce((u, t) => {
                                            const n = e[t];
                                            return 'number' == typeof n && (u[at[t]] = n + 'rem'), u;
                                        }, {}))(e);
                                return {
                            ...
                            }, [t, n, s, d, E, A, I, k, T, C, N, x, y]),
                            W = G.computedStyle,
                            j = G.computedClassNames;
                        return i().createElement('div', nt({ className: l()(ut.base, ...j, u), style: W }, P), H);
                    });
                var st = t(3532),
                    lt = t.n(st);
                const ct = {
                    ...
                    dt = ['text', 'variant', 'className', 'color', 'm', 'mt', 'mr', 'mb', 'ml', 'style', 'format'];
                function mt() {
                    return (
                        (mt =
                            Object.assign ||
                ...
                const Et = Object.keys(lt()),
                    ...
                    Ct = et((e) => {
                        ...
                        return i().createElement(
                            ...
                            mt(
                                {
                                    className: l()(ct.base, t && ct[t], b, n),
                                    style: g,
                                    mt: !0 === c ? Dt[t || 'paragraph-P16'].mt : c,
                                    mr: !0 === m ? Dt[t || 'paragraph-P16'].mr : m,
                                    mb: !0 === _ ? Dt[t || 'paragraph-P16'].mb : _,
                                    ml: !0 === F ? Dt[t || 'paragraph-P16'].ml : F,
                                },
                                C,
                            ),
                            void 0 !== B ? i().createElement($, mt({}, B, { text: u })) : u,
                        );
                    });
                let pt;
                var gt;
                ((gt = pt || (pt = {})).Heavy = 'heavyTank'),
                    (gt.Medium = 'mediumTank'),
                    (gt.Light = 'lightTank'),
                    (gt.Spg = 'SPG'),
                    (gt.AtSpg = 'AT-SPG'),
                ...
                const bt = ['', 'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X'],
                    vt = (e) => {
                        const u = [...new Set(Ye(e, (e) => ((e) => bt[e] || '')(e)))];
                        return u.length > 1 ? `${u[0]}-${u[1]}` : `${u[0]}`;
                    },
                    ht = ({ value: e, className: u }) =>
                        i().createElement(
                            'div',
                    ...
                    xt = 'GuaranteedRewardCount_text_94',
                    wt = R.strings.gui_lootboxes.guaranteedReward.boxesLeft,
                    yt = ({ onInfoClick: e, boxesCount: u, levelsRange: t, vehiclesOnly: n }) =>
                        i().createElement(
                            'div',
                            ...
                            i().createElement(
                                ...
                                i().createElement(Ct, {
                                    text: wt.$dyn(n ? ke : Ie),
                                    format: { binding: { level: vt(t) } },
                                }),
                            ),
                            i().createElement(ht, { value: u }),
                            i().createElement(
                                'div',
                                { className: xt },
                                i().createElement(
                                    ...
                                    i().createElement(ft, { onClick: e }),
                                ),
                            ),
                        );
                var Tt = t(7568);
                const St = 'GuaranteedRewardNext_particles_6d',
                    Rt = (e) =>
                        `R.images.new_year.gui.maps.icons.newYear.sequence.blue_particles_small.atmosphere_big_idle_${e.toString().padStart(5, '0')}`,
                    Nt = (e) =>
                        `R.images.new_year.gui.maps.icons.newYear.sequence.blue_particles_small.atmosphere_big_idle_${((e + 75) % 120).toString().padStart(5, '0')}`,
                    Ot = (e) =>
                        `R.images.new_year.gui.maps.icons.newYear.sequence.blue_particles_small.atmosphere_big_idle_${((e + 50) % 120).toString().padStart(5, '0')}`,
                    Lt = R.strings.gui_lootboxes.guaranteedReward.next,
                    Mt = ({ levelsRange: e, vehiclesOnly: u, onInfoClick: t }) =>
                        i().createElement(
                            'div',
                            { className: 'GuaranteedRewardNext_base_da' },
                            i().createElement(Tt.At, {
                                width: 320,
                                height: 120,
                                frameCount: 120,
                                frameTime: 50,
                                getSrcByFrame: Rt,
                                className: l()(St, 'GuaranteedRewardNext_particles__left_b6'),
                            }),
                            i().createElement(Tt.At, {
                                width: 400,
                                height: 180,
                                frameCount: 120,
                                getSrcByFrame: Nt,
                                className: l()(St, 'GuaranteedRewardNext_particles__center_3a'),
                            }),
                            i().createElement(Tt.At, {
                                width: 320,
                                height: 120,
                                ...
                                frameTime: 50,
                                getSrcByFrame: Ot,
                                className: l()(St, 'GuaranteedRewardNext_particles__right_b7'),
                            }),
                            i().createElement(
                                'div',
                                ...
                                i().createElement(Ct, {
                                    text: Lt.$dyn(u ? ke : Ie),
                                    format: { binding: { level: vt(e) } },
                                }),
                                i().createElement(
                                    'div',
                                    { className: 'GuaranteedRewardNext_icon_23' },
                                    i().createElement(ft, { onClick: t }),
                                ),
                            ),
                        );
                let kt;
                ...
                const It = i().memo(function ({
                        ...
                        const o = e < 1 ? kt.Hidden : 1 === e ? kt.NextGuaranteed : kt.CountBeforeGuaranteed;
                        return i().createElement(
                            'div',
                            null,
                            o === kt.CountBeforeGuaranteed &&
                    ...
                    Ht = 'NoBoxes_noBoxSubText_2d',
                    Pt = R.strings.gui_lootboxes,
                    Gt = R.strings.lootboxes,
                    Wt = i().memo(
                        ({
                            hasCurrentLootbox: e,
                            isShopAvailable: u,
                            ...
                            const o = e
                                    ? Pt.openBoxScreen.noCurrentLootboxesMain()
                                    : Pt.openBoxScreen.noLootboxesMain(),
                                s = u
                                    ? Pt.openBoxScreen.noLootboxesShopSecondary()
                                    : Pt.openBoxScreen.noLootboxesSecondary(),
                                c = (0, a.useMemo)(() => {
                                    const u = Gt.noBoxes.$dyn(t) || Gt.noBoxes.default(),
                                        n = e ? u : s;
                                    return i().createElement(Ct, { text: n, className: Ht });
                                }, [t, s, e]),
                            ...
                            return i().createElement(
                                ...
                                i().createElement(
                                    'div',
                                    { className: d },
                                    i().createElement('div', { className: 'NoBoxes_noBoxHeader_e2' }, o),
                                    i().createElement('div', { className: Ht }, c),
                                    !e &&
                                        i().createElement(
                                            'div',
                                            null,
                ...
                const zt = {
                        StorageViewing: jt.STORAGE_VIEWING,
                        RequestToOpen: jt.REQUEST_TO_OPEN,
                        Opening: jt.OPENING,
                        OpeningError: jt.OPENING_ERROR,
                        UniqueRewarding: jt.UNIQUE_REWARDING,
                        Rewarding: jt.REWARDING,
                        LoseOpening: jt.LOSE_OPENING,
                    },
                    $t = 'open',
                    Kt = 'openStop',
                    Vt = 'hide',
                ...
                const en = ({
                        ...
                        const s = (0, Qt.nn)(),
                            c = s[0],
                            d = s[1],
                            m = (0, a.useRef)(Object.assign({}, He)),
                            E = (null == u ? void 0 : u.videoRes) || '';
                        (0, a.useEffect)(() => {
                            o === zt.Opening && (m.current = He), o === zt.LoseOpening && (m.current = Pe);
                        }, [o]),
                            (0, a.useEffect)(() => {
                                const e = c.current;
                                e &&
                    ...
                    un = 'App_imageBox_fd',
                    tn = 'App_imageBox__visible_fe',
                    nn = R.strings.menu,
                    rn = R.strings.gui_lootboxes.lootboxesWithKeys.about,
                    on = R.strings.gui_lootboxes.openBoxScreen,
                    an = (0, M.Pi)(() => {
                        var e;
                        const u = Qe(),
                            t = u.model,
                            ...
                            C = c !== zt.StorageViewing,
                            p = !(null != D && D.isOpenEnabled),
                            g = (null == D ? void 0 : D.bonusGroups) || [],
                            b = Boolean(null == D || null == (e = D.boxType) ? void 0 : e.includes('ny_2025')),
                            h = (0, a.useState)(),
                            f = h[0],
                            x = h[1],
                            T = (0, a.useState)(0),
                            ...
                            j = W[0],
                            U = W[1],
                            z = (0, a.useState)(Boolean(0 === (null == D ? void 0 : D.count))),
                            $ = z[0],
                            K = z[1],
                            V = (0, a.useState)(zt.Opening),
                            X = V[0],
                            Y = V[1],
                            Z = (0, a.useMemo)(() => {
                                if (D)
                        ...
                        (J = n.close),
                            L(S.n.ESCAPE, J),
                            (0, a.useEffect)(() => {
                                c !== zt.StorageViewing || (f && f !== Zt && s !== R) || (x(Xt), N(0), U(!1));
                            }, [s, c, f, R]),
                            (0, a.useEffect)(() => {
                                c === zt.Opening && (Y(c), x($t)), c === zt.LoseOpening && (Y(c), x($t));
                            }, [c]),
                            (0, a.useEffect)(
                                () =>
                                    (c !== zt.Opening && c !== zt.LoseOpening) || (P && x($t), P)
                                        ? c === zt.Rewarding || c === zt.UniqueRewarding
                                            ? y(() => {
                                                  x(Zt);
                                              }, 350)
                                            : void 0
                            ...
                            (0, a.useEffect)(() => {
                                c === zt.StorageViewing && D && P && (0, v.G)(Ge),
                                    (c === zt.Opening || c === zt.LoseOpening) && D && P && (0, v.G)(We[D.tier]);
                            }, [D, c, P]),
                            (0, a.useEffect)(() => {
                                f === qt && x(Yt), f === Kt && x($t);
                            }, [f, x]),
                            (0, a.useEffect)(() => {
                                I((null == D ? void 0 : D.boxID) || 0),
                                    K(Boolean(0 === (null == D ? void 0 : D.count))),
                                    (null != D && D.videoRes) ||
                                        (G(!1), n.changeAnimationEnabledSetting({ enabled: !1 }));
                            }, [n, D]);
                        const Q = (0, a.useCallback)(
                            ...
                            te = (0, a.useCallback)(
                                (e) => {
                                    e &&
                                        (e === Xt && x(Yt),
                                        e === Yt && x(c === zt.Opening || c === zt.LoseOpening ? Kt : qt),
                                        e === $t && n.openningFinished(),
                                        e === Vt && s !== R && (n.lootboxSelected({ lootBoxID: R }), I(R)));
                                },
                                [n, s, c, R],
                            ),
                            ne = (0, a.useCallback)(
                                (e) => {
                                    e !== s &&
                                        (P
                                            ? (x(Vt), e !== s && (n.lootboxSelected({ lootBoxID: e }), I(e)))
                                            : (n.lootboxSelected({ lootBoxID: e }), I(e)),
                                        N(e));
                                },
                                [s, P, n],
                            ),
                            ...
                            oe = rn.$dyn((null == D ? void 0 : D.userName) || ''),
                            ae = l()('App_bg_10', b && 'App_bg__event_01');
                        return i().createElement(
                            'div',
                            ...
                            i().createElement(
                                ...
                                i().createElement(w, {
                                    caption: nn.viewHeader.backBtn.label(),
                                    type: 'back',
                                    side: 'left',
                                    goto: on.backBtn.$num(_),
                                    onClick: n.close,
                                }),
                            ),
                            D
                                ? i().createElement(
                                      ...
                                      D.category &&
                                          i().createElement('div', { className: 'App_eventImage_77', style: Z }),
                                      i().createElement(
                                          'div',
                                          { className: 'App_possibleRewardsWrapper_6e' },
                                          i().createElement(tu, { bonusGroups: g, lootBoxID: s }),
                                      ),
                                      i().createElement(
                                          'div',
                                          ...
                                          i().createElement(It, {
                                              ...
                                              vehiclesOnly: D.guaranteedReward.vehiclesOnly,
                                              lootBoxID: s,
                                          }),
                                      ),
                                      i().createElement(
                                          ...
                                          i().createElement(Oe, {
                                              onOpenBox: Q,
                                              onOpenShopByBoxID: ee,
                                              onBuyBox: n.buyBox,
                                              count: D.count,
                                              disabled: p,
                                              isOpenBoxDisabled: c !== zt.StorageViewing || p,
                                              allKeys: F,
                                      ...
                                      B.length > 0 &&
                                          i().createElement(
                                              ...
                                              i().createElement(Vu, { onChange: ne, disabled: C }),
                                          ),
                                      i().createElement(k.E, {
                                          mixClass: 'App_animationControl_ba',
                                          isActiveAnimation: P,
                                          onClick: () => {
                                              G(!P), n.changeAnimationEnabledSetting({ enabled: !P });
                                          },
                                          disabled: c !== zt.StorageViewing && !(null != D && D.videoRes),
                                      }),
                                  )
                                : i().createElement(Wt, {
                                      hasCurrentLootbox: !1,
                    ...
                    sn = {
                        getter:
                            ((ln = {
                                ...
                                groupRewards: [],
                                currentState: zt.StorageViewing,
                                currentLootboxID: 230315,
                                isAnimationEnabled: !0,
                                isBuyAvailable: !0,
                            }),
                            (e) => (e ? e.split('.').reduce((e, u) => e[u], ln) : ln)),
                        controls: ({ model: e }) =>
                            (function (e) {
                                const u = {};
                                for (const t in e)
                ...
                engine.whenReady.then(() => {
                    b().render(
                        i().createElement(
                            Je,
                            { mocks: sn, mode: 'real' },
                            i().createElement(p, null, i().createElement(an, null)),
                        ),
                ...
                const l = () => {
                    ...
                    c = a().memo(function (e) {
                        ...
                        return (
                            ...
                            a().createElement(
                                'video',
                                s({ src: u, className: t, loop: d, ref: D, onClick: E, style: g }, F, {
                                    onError: F.onError,
                                }),
                            )
                        );
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (() => {
            var e = { 334: 0, 989: 0, 578: 0, 802: 0, 897: 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(8861));
