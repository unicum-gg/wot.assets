        ...
        e = {
            ...
            7071: (u, e, A) => {
                ...
                const Bu = K.client.getSize('rem'),
                    ...
                    mu = (u) => {
                        ...
                        if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
                            ...
                            if (A.extraLargeWidth && a) return Eu(e, A, _);
                            if (A.largeWidth && n) return Eu(e, A, _);
                            if (A.mediumWidth && i) return Eu(e, A, _);
                            if (A.smallWidth && C) return Eu(e, A, _);
                            if (A.extraSmallWidth && l) return Eu(e, A, _);
                            if (!(
                                A.extraLargeWidth ||
                                A.largeWidth ||
                                A.mediumWidth ||
                ...
                const gu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    cu = [ou.ExtraLarge, ou.Large, ou.Medium, ou.Small, ou.ExtraSmall],
                    hu = (u, e) =>
                        Object.keys(u).reduce((A, F) => {
                            ...
                            return (
                                void 0 === E ||
                                    ((u, e) => gu.some((A) => void 0 !== e[`${u}_${A}`]))(F, u) ||
                                    (A[F] = E),
                                A
                            );
                        }, {}),
                ...
                const Su = {
                    ...
                    Lu = xu((u) => {
                        ...
                        return Y().createElement('div', vu({ className: B()(pu.base, ...X, e), style: N }, W), P);
                    });
                let Mu;
                !(function (u) {
                ...
                const zu = Object.keys(Gu()),
                    ...
                    $u = xu((u) => {
                        ...
                        return Y().createElement(
                            ...
                            ju(
                                {
                                    className: B()(Nu.base, A && Nu[A], c, F),
                                    style: _,
                    ...
                    Yu = 'App_description_88',
                    qu = R.strings.gui_lootboxes.tooltips.probabilityStageButtons,
                    Qu = () =>
                        Y().createElement(
                            'div',
                            { className: 'App_base_c8' },
                            Y().createElement($u, { text: qu.title(), className: 'App_title_84' }),
                            Y().createElement(
                                'div',
                                { className: Yu },
                                Y().createElement($u, { text: qu.description1() }),
                            ),
                            Y().createElement(
                                'div',
                                { className: Yu },
                                Y().createElement($u, { text: qu.description2() }),
                            ),
                        );
