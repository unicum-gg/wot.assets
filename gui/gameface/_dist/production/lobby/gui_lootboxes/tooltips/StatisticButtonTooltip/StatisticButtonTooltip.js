    ...
    var u,
        e = {
            ...
            6888: (u, e, A) => {
                ...
                const Eu = uu.client.getSize('rem'),
                    tu = Eu.width,
                    Du = Eu.height,
                    ru = Object.assign({ width: tu, height: Du }, Fu(tu, Du, eu)),
                    Bu = (0, r.createContext)(ru),
                    au = ['children'],
                    nu = (u) => {
                        let e = u.children,
                            A = (function (u, e) {
                ...
                ((0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(Bu),
                        ...
                        t = (0, r.useCallback)((u, e) => {
                            const A = uu.view.pxToRem(u),
                                F = uu.view.pxToRem(e);
                            E(Object.assign({ width: A, height: F }, Fu(A, F, eu)));
                        }, []);
                    (((u) => {
                    ...
                    return B().createElement(Bu.Provider, { value: D }, u);
                }),
                    (function (u) {
                ...
                const mu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ou = (u) => u.includes('_') && ((u) => mu.includes(u))(u.split('_').at(-1)),
                    ...
                    du = (u, e) =>
                        Object.keys(u).reduce((A, F) => {
                            ...
                            return (
                                void 0 === E ||
                                    ((u, e) => mu.some((A) => void 0 !== e[`${u}_${A}`]))(F, u) ||
                                    (A[F] = E),
                                A
                            );
                        }, {}),
                ...
                const xu = {
                    ...
                    vu = gu((u) => {
                        ...
                        const X = (0, r.useMemo)(() => {
                                const u = { mt: D, mr: n, mb: l, ml: o },
                                    e = ((u) =>
                                        pu.reduce((e, A) => {
                                            const F = u[A];
                                            return F && 'number' != typeof F ? e.concat(xu[!0 === F ? 'MD' : F][A]) : e;
                                        }, []))(u),
                                    E = ((u) =>
                                        pu.reduce((e, A) => {
                                            const F = u[A];
                                            return ('number' == typeof F && (e[fu[A]] = F + 'rem'), e);
                                        }, {}))(u);
                                return {
                        ...
                        return B().createElement('div', hu({ className: C()(_u.base, ...z, e), style: j }, N), G);
                    });
                let Su;
                !(function (u) {
                ...
                const wu = (u, e, A) => {
                    ...
                    Lu = (u, e, A = Su.left) => u.split(e).reduce(A === Su.left ? wu : bu, []),
                    Mu = (() => {
                        const u = new RegExp(
                    ...
                    Hu = ({ binding: u, text: e = '', classMix: A, alignment: F = Su.left }) =>
                        null === e
                ...
                const Gu = Object.keys(yu()),
                    ...
                    ku = gu((u) => {
                        ...
                        return B().createElement(
                            ...
                            Wu(
                                {
                                    className: C()(Ou.base, A && Ou[A], x, F),
                                    style: h,
                                    mt: !0 === a ? zu[A || 'paragraph-P16'].mt : a,
                                    mr: !0 === i ? zu[A || 'paragraph-P16'].mr : i,
                                    mb: !0 === m ? zu[A || 'paragraph-P16'].mb : m,
                                    ml: !0 === s ? zu[A || 'paragraph-P16'].ml : s,
                                },
                                _,
                            ),
                            void 0 !== g ? B().createElement(Hu, Wu({}, g, { text: e })) : e,
                        );
                    }),
                    Vu = R.strings.gui_lootboxes.tooltips.statisticButton,
                    Uu = () =>
                        B().createElement(
                            'div',
                            { className: 'App_base_f4' },
                            B().createElement(ku, { text: Vu.title(), format: { classMix: 'App_title_cf' } }),
                            B().createElement(
                                'div',
                                { className: 'App_description_cf' },
                                B().createElement(ku, { text: Vu.description() }),
                            ),
                        );
                const Ku = {
                ...
                const qu = B().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        B().createElement(
                            'div',
                            Yu({}, D, {
                                className: C()(Ku.base, Ku[`base__theme-${t}`], F),
                                ref: function (u) {
                                    ((n.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            B().createElement('div', { className: Ku.decorator }, A),
                        )
                    );
                });
                engine.whenReady.then(() => {
                    n().render(
                        B().createElement(qu, null, B().createElement(Uu, null)),
