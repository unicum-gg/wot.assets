    ...
    var u,
        e = {
            ...
            6888: (u, e, A) => {
                'use strict';
                var F = {};
                (A.r(F), A.d(F, { mouse: () => c, onResize: () => g }));
                var E = {};
                (A.r(E),
                    A.d(E, {
                        events: () => F,
                ...
                var t = {};
                (A.r(t), A.d(t, { getBgUrl: () => v, getTextureUrl: () => f }));
                var D = {};
                (A.r(D),
                    A.d(D, {
                        addModelObserver: () => O,
                ...
                const q = Object.keys(S).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === S[e]), u), {}),
                    Q = {
                        set: (u, e) => {
                ...
                const Fu = J.client.getSize('rem'),
                    Eu = Fu.width,
                    tu = Fu.height,
                    Du = Object.assign({ width: Eu, height: tu }, Au(Eu, tu, uu)),
                    ru = (0, r.createContext)(Du),
                    Bu = ['children'],
                    au = (u) => {
                        let e = u.children,
                            A = (function (u, e) {
                        ...
                        const F = (0, r.useContext)(ru),
                            ...
                            l = F.smallWidth,
                            m = F.extraSmallWidth,
                            s = F.extraLargeHeight,
                            d = F.largeHeight,
                            g = F.mediumHeight,
                            _ = F.smallHeight,
                            c = F.extraSmallHeight,
                            h = { extraLarge: s, large: d, medium: g, small: _, extraSmall: c };
                        if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
                            ...
                            if (A.extraLargeWidth && n) return o(e, A, h);
                            if (A.largeWidth && i) return o(e, A, h);
                            if (A.mediumWidth && C) return o(e, A, h);
                            if (A.smallWidth && l) return o(e, A, h);
                            if (A.extraSmallWidth && m) return o(e, A, h);
                            if (!(
                                A.extraLargeWidth ||
                                A.largeWidth ||
                                A.mediumWidth ||
                ...
                ((0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(ru),
                        ...
                        t = (0, r.useCallback)((u, e) => {
                            const A = J.view.pxToRem(u),
                                F = J.view.pxToRem(e);
                            E(Object.assign({ width: A, height: F }, Au(A, F, uu)));
                        }, []);
                    (((u) => {
                        ...
                        (0, r.useEffect)(() => () => engine.off('clientResized', t), [t]));
                    const D = (0, r.useMemo)(() => Object.assign({}, F), [F]);
                    return B().createElement(ru.Provider, { value: D }, u);
                }),
                    (function (u) {
                ...
                const lu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    mu = (u) => u.includes('_') && ((u) => lu.includes(u))(u.split('_').at(-1)),
                    ou = [nu.ExtraLarge, nu.Large, nu.Medium, nu.Small, nu.ExtraSmall],
                    su = (u, e) =>
                        Object.keys(u).reduce((A, F) => {
                            ...
                            return (
                                void 0 === E ||
                                    ((u, e) => lu.some((A) => void 0 !== e[`${u}_${A}`]))(F, u) ||
                                    (A[F] = E),
                                A
                            );
                        }, {}),
                        ...
                        const A = (
                            ...
                            (A) => {
                                const F = (() => {
                                    ...
                                    E = (0, r.useMemo)(() => e(A, F), [A, F]);
                                return B().createElement(u, E);
                            }
                        )(u, e);
                        return B().memo((e) =>
                ...
                const hu = {
                    ...
                    fu = du((u) => {
                        let e = u.className,
                            ...
                            d = u.row,
                            g = u.flexDirection,
                            _ = void 0 === g ? (s ? 'column' : d && 'row') || void 0 : g,
                            c = u.flexStart,
                            h = u.center,
                            x = u.flexEnd,
                            p = u.spaceBetween,
                            ...
                            S =
                                void 0 === v
                                    ...
                                    : v,
                            w = u.alignItems,
                            b = void 0 === w ? (c ? 'flex-start' : h && 'center') || (x && 'flex-end') || void 0 : w,
                            L = u.alignSelf,
                            M = u.wrap,
                            R = u.flexWrap,
                            ...
                            y = u.shrink,
                            O = u.flex,
                            P = void 0 === O ? (T || y ? `${T ? 1 : 0} ${y ? 1 : 0} auto` : void 0) : O,
                            W = u.style,
                            G = u.children,
                            N = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const X = (0, r.useMemo)(() => {
                                const u = { mt: D, mr: n, mb: l, ml: o },
                                    ...
                                    E = ((u) =>
                                        xu.reduce((e, A) => {
                                            const F = u[A];
                                            return ('number' == typeof F && (e[pu[A]] = F + 'rem'), e);
                                        }, {}))(u);
                                return {
                            ...
                            }, [A, F, D, n, l, o, W, P, L, _, H, S, b]),
                            j = X.computedStyle,
                            z = X.computedClassNames;
                        return B().createElement('div', cu({ className: C()(gu.base, ...z, e), style: j }, N), G);
                    });
                let vu;
                !(function (u) {
                ...
                const Su = (u, e, A) => {
                    ...
                    bu = (u, e, A = vu.left) => u.split(e).reduce(A === vu.left ? Su : wu, []),
                    Lu = (() => {
                        const u = new RegExp(
                    ...
                    Ru = ({ binding: u, text: e = '', classMix: A, alignment: F = vu.left }) =>
                        null === e
                            ...
                            : B().createElement(
                                  ...
                                  e.split('\n').map((e, E) =>
                                      B().createElement(
                                          'div',
                                          { className: C()('FormatText_base_d0', A), key: `${e}-${E}` },
                                          ((u, e, A) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  A && u in A
                                                      ? A[u]
                                              ...
                                              B().createElement(r.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              );
                    ...
                    Iu = du((u) => {
                        ...
                        const c = (0, r.useMemo)(() => {
                                const u = zu(E),
                                    ...
                                    A = u.colorStyle,
                                    F = void 0 === A ? {} : A;
                                return { computedStyle: Object.assign({}, d, F), colorClassName: e };
                            }, [d, E]),
                            h = c.computedStyle,
                            x = c.colorClassName;
                        return B().createElement(
                            ...
                            Pu(
                                {
                                    className: C()(yu.base, A && yu[A], x, F),
                                    style: h,
                                    mt: !0 === a ? ju[A || 'paragraph-P16'].mt : a,
                                    mr: !0 === i ? ju[A || 'paragraph-P16'].mr : i,
                                    mb: !0 === m ? ju[A || 'paragraph-P16'].mb : m,
                                    ml: !0 === s ? ju[A || 'paragraph-P16'].ml : s,
                                },
                                _,
                            ),
                            void 0 !== g ? B().createElement(Ru, Pu({}, g, { text: e })) : e,
                        );
                    }),
                    ku = R.strings.gui_lootboxes.tooltips.statisticButton,
                    Vu = () =>
                        B().createElement(
                            'div',
                            { className: 'App_base_f4' },
                            B().createElement(Iu, { text: ku.title(), format: { classMix: 'App_title_cf' } }),
                            B().createElement(
                                'div',
                                { className: 'App_description_cf' },
                                B().createElement(Iu, { text: ku.description() }),
                            ),
                        );
                const Uu = {
                ...
                const Yu = B().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        B().createElement(
                            'div',
                            $u({}, D, {
                                className: C()(Uu.base, Uu[`base__theme-${t}`], F),
                                ref: function (u) {
                                    ((n.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            B().createElement('div', { className: Uu.decorator }, A),
                        )
                    );
                });
                engine.whenReady.then(() => {
                    n().render(
                        B().createElement(Yu, null, B().createElement(Vu, null)),
