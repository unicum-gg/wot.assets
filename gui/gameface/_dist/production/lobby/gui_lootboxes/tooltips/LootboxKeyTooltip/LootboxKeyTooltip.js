    ...
    var __webpack_modules__ = {
                    ...
                    w = {
                        ...
                        sendShowPopOverEvent: (u, e, t, E, A = R.invalid('resId'), F) => {
                            const r = l.O.view.getViewGlobalPosition(),
                                ...
                                s = n.height,
                                B = {
                                    x: l.O.view.pxToRem(D) + r.x,
                                    y: l.O.view.pxToRem(a) + r.y,
                                    width: l.O.view.pxToRem(i),
            ...
            6620: (u, e, t) => {
                ...
                (((_ = F || (F = {})).Items = 'items'),
                    ...
                    (_.BlueprintsAny = 'blueprintsAny'),
                    (_.Goodies = 'goodies'),
                    (_.Berths = 'berths'),
                    (_.Slots = 'slots'),
                    (_.Tokens = 'tokens'),
                    (_.CrewSkins = 'crewSkins'),
                    (_.CrewBooks = 'crewBooks'),
                    (_.Customizations = 'customizations'),
                    (_.CreditsFactor = 'creditsFactor'),
                    (_.Currency = 'currency'),
                    (_.TankmenXp = 'tankmenXP'),
                    (_.TankmenXpFactor = 'tankmenXPFactor'),
                    (_.FreeXpFactor = 'freeXPFactor'),
                    (_.BattleToken = 'battleToken'),
                    (_.PremiumUniversal = 'premium_universal'),
                    (_.Gold = 'gold'),
                    (_.Credits = 'credits'),
                    (_.Crystal = 'crystal'),
                    (_.FreeXp = 'freeXP'),
                    (_.Premium = 'premium'),
                    (_.PremiumPlus = 'premium_plus'),
                    (_.BattlePassPoints = 'battlePassPoints'),
                    (_.BattlePassSelectToken = 'battlePassSelectToken'),
                    (_.SelectableBonus = 'selectableBonus'),
                    (_.StyleProgressToken = 'styleProgressToken'),
                    (_.TmanToken = 'tmanToken'),
                    (_.NaturalCover = 'naturalCover'),
                    (_.BpCoin = 'bpcoin'),
                    (_.BattlaPassFinalAchievement = 'dossier_achievement'),
                    (_.BattleBadge = 'dossier_badge'),
                    (_.NewYearAlbumsAccess = 'newYearAlbumsAccess'),
                    (_.NewYearFillers = 'ny22Fillers'),
                    (_.NewYearInvoice = 'newYearInvoice'),
                    (_.NewYearToyFragments = 'ny22ToyFragments'),
                    (_.NewYearSlot = 'newYearSlot'),
                    (_.BonusX5 = 'battle_bonus_x5'),
                    (_.CrewBonusX3 = 'crew_bonus_x3'),
                    (_.Vehicles = 'vehicles'),
                    (_.EpicSelectToken = 'epicSelectToken'),
                    (_.CollectionItem = 'collectionItem'),
                    (_.Comp7TokenWeeklyReward = 'comp7TokenWeeklyReward'),
                    (_.Comp7TokenCouponReward = 'comp7TokenCouponReward'),
                    (_.BattleBoosterGift = 'battleBooster_gift'),
                    (_.CosmicLootboxSilver = 'lootBoxToken'),
                    (_.CosmicLootboxCommon = 'cosmic_2024_2'),
                    (_.Branch = 'branch'),
                    (_.VehicleSelect = 'vehicleSelect'),
                    (_.StyleProgress = 'styleProgress'),
                    (_.ParagonsUnlocks = 'paragonsUnlocks'),
                    (_.LootBoxToken = 'lootBoxToken'),
                    (_.GoldenTicket = 'birthday2025_golden_ticket'),
                    (_.PostStamp = 'giftsystem_4_stamp'),
                    (_.Quests = 'quests'),
                    (_.ArmoryCoin = 'armory_coin'),
                    (_.PremiumPlusUniversal = 'premium_plus_universal'),
                    (_.DogTagType = 'dogTagComponents'),
                    (function (u) {
                        ((u.Gold = 'gold'),
                            (u.Credits = 'credits'),
                            (u.Crystal = 'crystal'),
                    ...
                    ((l = o || (o = {})).MULTI = 'multi'),
                    (l.CURRENCY = 'currency'),
                    (l.PREMIUM_PLUS = 'premium_plus'),
                    (l.NUMBER = 'number'),
                    (l.STRING = 'string'),
                    ((C = D || (D = {})).BATTLE_BOOSTER = 'battleBooster'),
                    ...
                    ((a || (a = {})).BATTLE_BOOSTER = 'battleBooster'),
                    ((B = i || (i = {})).BATTLE_BOOSTER = 'battleBooster'),
                    (B.BATTLE_BOOSTER_REPLACE = 'battleBoosterReplace'),
                    (B.BUILT_IN_EQUIPMENT = 'builtInEquipment'),
                    (B.EQUIPMENT_PLUS = 'equipmentPlus'),
                    (B.EQUIPMENT_TROPHY_BASIC = 'equipmentTrophyBasic'),
                    (B.EQUIPMENT_TROPHY_UPGRADED = 'equipmentTrophyUpgraded'),
                    (B.EQUIPMENT_MODERNIZED_UPGRADED_1 = 'equipmentModernized_1'),
                    (B.EQUIPMENT_MODERNIZED_UPGRADED_2 = 'equipmentModernized_2'),
                    (B.EQUIPMENT_MODERNIZED_UPGRADED_3 = 'equipmentModernized_3'),
                    (B.PROGRESSION_STYLE_UPGRADED_1 = 'progressionStyleUpgraded_1'),
                    (B.PROGRESSION_STYLE_UPGRADED_2 = 'progressionStyleUpgraded_2'),
                    (B.PROGRESSION_STYLE_UPGRADED_3 = 'progressionStyleUpgraded_3'),
                    (B.PROGRESSION_STYLE_UPGRADED_4 = 'progressionStyleUpgraded_4'),
                    (function (u) {
                ...
                ((m.defaultProps = { format: 'integral' }),
                    ...
                    ((O = w || (w = {})).AwaitSeason = 'awaitSeason'),
                    (O.Bought = 'bought'),
                    (O.Free = 'free'),
                    (O.Completed = 'completed'),
                    (O.CompletedRightNow = 'completedRightNow'),
                    (O.SwitchedChapterRightNow = 'switchedChapterRightNow'),
                    (O.NoVehiclesBase = 'noVehiclesBase'),
                    (O.ChapterNotChosen = 'chapterNotChosen'),
                    (function (u) {
                        ((u.None = ''),
                            (u.ShowLevel = 'show'),
                            (u.HideLevel = 'hide'),
                ...
                const S = ({ icon: u, count: e }) =>
                    A().createElement(
                        ...
                        A().createElement(
                            ...
                            ((u = 0) => u.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ' '))(e),
                        ),
                    );
            },
            8132: (u, e, t) => {
                ...
                const i = n().forwardRef(function (u, e) {
                    let t = u.children,
                        E = u.className,
                        i = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            a({}, B, {
                                className: A()(o.base, o[`base__theme-${s}`], E),
                                ref: function (u) {
                ...
                const v = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: A, mocks: o }) {
                                const D = (0, r.useRef)([]),
                                    a = (u, t, E) => {
                                        var A;
                                        const r = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, r) => {
                                                        const o = 'string' == typeof r ? `${E}.${r}` : E,
                                                            D = F.O.view.addModelObserver(o, e, !0);
                                                        return (A.set(D, t), u && t(n(r)), D);
                                                    },
                                                    readByPath: n,
                                                    createCallback: (u, e) => {
                                                        const t = n(e);
                                            ...
                                            o = (e) =>
                                                'mocks' === u ? (null == E ? void 0 : E.getter(e)) : n.readByPath(e),
                                            a = (u) => D.current.push(u),
                                            i = (({ observableModel: u }) => {
                                                const e = {
                                                        root: u.object(),
                                                        lootboxKey: u.object('lootboxKey'),
                                                        lootboxNames: u.array('lootboxNames', []),
                                                    },
                                                    t = (0, p.computedFn)(
                                                        () => {
                                                            return (
                                                                (u = e.lootboxNames.get()),
                                                                (t = l),
                                                                Array.isArray(u)
                                                                    ? u.map(t)
                                                                    : u.map((u, e, E) =>
                                                                          t(null == u ? void 0 : u.value, e, E),
                                                                      )
                                                            );
                                                            var u, t;
                                                        },
                                                    ...
                                                    E = (0, p.computedFn)(() => t()[0], { equals: c });
                                                return Object.assign({}, e, {
                                                    computes: { getLootboxNames: t, getFirstLootboxName: E },
                                                });
                                            })({
                                                mode: u,
                                                readByPath: o,
                                            ...
                                            s = { mode: u, model: i, externalModel: n, cleanup: a };
                                        return {
                                            model: i,
                                            controls: 'mocks' === u && E ? E.controls(s) : e(s),
                                            externalModel: n,
                                            mode: u,
                                        };
                                    },
                                    ...
                                    B = s[0],
                                    C = s[1],
                                    v = (0, r.useState)(() => a(u, E, o)),
                                    h = v[0],
                                    g = v[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        i.current ? g(a(B, E, o)) : (i.current = !0);
                                    }, [o, B, E]),
                                    (0, r.useEffect)(() => {
                                        C(u);
                                    }, [u]),
                                    (0, r.useEffect)(
                                        () => () => {
                                            (h.externalModel.dispose(), D.current.forEach((u) => u()));
                                        },
                                        [h],
                                    ),
                                    n().createElement(t.Provider, { value: h }, A)
                                );
                            },
                            () => (0, r.useContext)(t),
                        ];
                ...
                const T = (u, e, t) => {
                    ...
                    P = (u, e, t = w.left) => u.split(e).reduce(t === w.left ? T : f, []),
                    y = (() => {
                        const u = new RegExp(
                ...
                const S = ({ binding: u, text: e = '', classMix: t, alignment: E = w.left }) =>
                    ...
                    N = /(?:%\(|{)\w*(?:_[Oo]pen|Start)(?:\)s|})?(.*?)(?:%\(|{)\w*(?:_[Cc]lose|End)(?:\)s|})?/g,
                    M = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    L = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    ...
                    q = (0, C.observer)(() => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement('div', { className: 'App_title_44' }, t ? c : I.title_v1.$dyn(D)),
                            n().createElement(
                                'div',
                                { className: b },
                                n().createElement(U, { text: l, binding: { lootboxName: C, count: o } }),
                            ),
                            n().createElement(
                                'div',
                                { className: b },
                                n().createElement(U, { text: I.descriptionPart2.$dyn(D) }),
                            ),
                            n().createElement(
                                'div',
                                { className: A()(b, 'App_description__list_cf') },
                                n().createElement(U, { text: I.descriptionPart3.$dyn(D) }),
                            ),
                            E &&
                                n().createElement(
                                    n().Fragment,
                                    null,
                                    n().createElement('div', { className: 'App_divider_94' }),
                                    n().createElement(
                                        'div',
                                        { className: 'App_footer_1b' },
                                        n().createElement(U, { text: I.footer.$dyn(D) }),
                                        n().createElement(
                                            'div',
                ...
                engine.whenReady.then(() => {
                    B().render(
                        n().createElement(h, null, n().createElement(i, null, n().createElement(q, null))),
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (o = 0; o < deferred.length; o++) {
                    for (var [e, t, E] = deferred[o], F = !0, r = 0; r < e.length; r++)
                        (!1 & E || A >= E) &&
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); o < F.length; o++)
                        ((A = F[o]), __webpack_require__.o(u, A) && u[A] && u[A][0](), (u[A] = 0));
                    return __webpack_require__.O(D);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
        })());
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(8132));
