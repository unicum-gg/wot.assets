    ...
    var __webpack_modules__ = {
            ...
            4016: (u, e, t) => {
                        ...
                        const w = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, r.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (C(t, D, { isMouseEvent: !0, on: !0, arguments: d(n) }, x),
                                    h && h(),
                ...
                const T = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return a || s
                        ? n().createElement(g, S({}, e, { contentId: a || s }), r)
                ...
                const O = [
                    ...
                    y = [s.Gold, s.Credits, s.Crystal, s.FreeXp, s.NewYearToyFragments],
                ...
                const k = ['engravings', 'backgrounds'],
                    ...
                    H = ({
                        ...
                        return n().createElement(
                            'div',
                            { className: _()(G.base, G[`base__${r}`], D), style: o },
                            n().createElement(
                                T,
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: _()(G.image, null == m ? void 0 : m.image) },
                                        C &&
                                            n().createElement('div', {
                                                className: _()(G.highlight, null == m ? void 0 : m.highlight),
                                                style: {
                                        ...
                                        e &&
                                            n().createElement('div', {
                                                className: _()(G.icon, null == m ? void 0 : m.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        g &&
                                            n().createElement('div', {
                                                className: _()(G.overlay, null == m ? void 0 : m.overlay),
                                                style: {
                            ...
                            t &&
                                n().createElement(
                                    ...
                                    { tooltipArgs: d },
                                    n().createElement('div', {
                                        className: _()(G.timer, null == m ? void 0 : m.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const z = j.O.client.getSize('rem'),
                    K = z.width,
                    Q = z.height,
                    Z = Object.assign({ width: K, height: Q }, V(K, Q, $)),
                ...
                ((0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(J),
                        ...
                        s = (0, r.useCallback)((u, e) => {
                            ...
                            i(Object.assign({ width: t, height: r }, V(t, r, $)));
                        }, []);
                    (((u) => {
                ...
                const cu = {
                    ...
                    mu = Eu((u) => {
                        ...
                        const G = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, o, l, F, D, k, N, T, C, O, x, S]),
                            H = G.computedStyle,
                            W = G.computedClassNames;
                        return n().createElement('div', Fu({ className: _()(lu.base, ...W, e), style: H }, U), I);
                    });
                let Bu;
                !(function (u) {
                ...
                const du = (u, e, t) => {
                    ...
                    bu = ({ binding: u, text: e = '', classMix: t, alignment: a = Bu.left }) =>
                        null === e
                ...
                const Tu = Object.keys(wu()),
                    ...
                    Lu = Eu((u) => {
                        ...
                        return n().createElement(
                            ...
                            Su(
                                {
                                    className: _()(xu.base, t && xu[t], h, a),
                                    style: p,
                            ...
                            void 0 !== d ? n().createElement(bu, Su({}, d, { text: e })) : e,
                        );
                    }),
                    Nu = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    ku = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3],
                    Iu = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    Uu = (u) =>
                        Iu
                            ? `${u}`
                            : (function (u) {
                ...
                const qu = ((u, e) => {
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : s(e),
                                                            n = Wu.observable.box(r, { equals: Hu });
                                                        return (
                                                            'real' === u &&
                                                                i.subscribe(
                    ...
                    Vu = qu[0],
                    zu = qu[1],
                    Ku = 'App_textHightlight_84',
                    Qu = 'App_probabilityTitleWrapper_7f',
                    Zu = 'App_probabilityTitle_01';
                function Ju() {
                    return (
                        (Ju =
                            Object.assign ||
                ...
                const ue = R.strings.lootboxes,
                    ee = (0, Gu.observer)(() => {
                        const u = zu().model,
                            ...
                            _ = A === o ? Uu(o) : `${Uu(o)}-${Uu(A)}`,
                            m = {
                                level: n().createElement(Lu, { text: _, className: 'App_hightlight_77' }),
                                probability: n().createElement(Lu, { text: `${c}%`, className: Ku }),
                                containersCount: n().createElement(Lu, {
                                    text: ue.lootboxExtendedTooltip.containersCount(),
                                    className: Ku,
                        ...
                        return n().createElement(
                            ...
                            n().createElement(Lu, { text: ue.userName.$dyn(t), className: 'App_title_7b' }),
                            n().createElement(Lu, { text: r, className: 'App_description_89' }),
                            n().createElement(Lu, {
                                text: ue.lootboxTooltip.slotTitle(),
                            ...
                            n().createElement(
                                ...
                                { className: Qu },
                                n().createElement(Lu, {
                                    text: ue.lootboxExtendedTooltip.specialSlot(),
                                    format: { binding: m, classMix: Zu },
                                }),
                            ),
                            n().createElement(
                                'div',
                                ...
                                n().createElement(Lu, { text: s.join(', '), className: 'App_vehicleNames_64' }),
                            ),
                            D.map(({ description: u, bonuses: e, probability: t }, r) => {
                                ...
                                return n().createElement(
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: Qu },
                                        n().createElement(Lu, { text: u, className: Zu }),
                                        n().createElement(Lu, {
                                    ...
                                    n().createElement(
                                        ...
                                        a.map((u, e) =>
                                            n().createElement(
                                                H,
                                                Ju({ size: E.Small, key: e, className: 'App_reward_1e' }, u),
                                            ),
                                        ),
                                        i &&
                                            n().createElement(Lu, {
                                                text: ue.lootboxExtendedTooltip.rewardExtraText(),
                            ...
                            n().createElement(
                                ...
                                n().createElement(Lu, {
                                    text: ue.lootboxTooltip.guaranteedCounter(a),
                ...
                const ae = n().forwardRef(function (u, e) {
                    let t = u.children,
                        a = u.className,
                        i = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            ne({}, o, {
                                className: _()(te.base, te[`base__theme-${s}`], a),
                                ref: function (u) {
                                    ((l.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            n().createElement('div', { className: te.decorator }, t),
                        )
                    );
                });
                engine.whenReady.then(() => {
                    i().render(
                        n().createElement(Vu, null, n().createElement(ae, null, n().createElement(ee, null))),
