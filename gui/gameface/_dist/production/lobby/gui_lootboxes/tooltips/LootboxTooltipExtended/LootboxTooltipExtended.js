(() => {
    var __webpack_modules__ = {
            ...
            4590: (u, e, t) => {
                ...
                const E = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    ...
                    l = (u) =>
                        A
                            ...
                            : (function (u) {
                                  let e = '';
                                  for (let t = s.length - 1; t >= 0; t--) for (; u >= s[t]; ) (e += E[t]), (u -= s[t]);
                                  return e;
                              })(u);
                var F = t(6483),
                    D = t.n(F),
                ...
                const p = B.O.client.getSize('rem'),
                    h = p.width,
                    b = p.height,
                ...
                (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(w),
                        ...
                        o = (0, r.useCallback)((u, e) => {
                            ...
                            i(Object.assign({ width: t, height: r }, g(t, r, d)));
                        }, []);
                    ((u) => {
                    ...
                    return n().createElement(w.Provider, { value: E }, u);
                }),
                    (function (u) {
                ...
                const O = ['xl', 'lg', 'md', 'sm', 'xs'],
                    M = (u) => u.includes('_') && ((u) => O.includes(u))(u.split('_').at(-1)),
                    L = [S.ExtraLarge, S.Large, S.Medium, S.Small, S.ExtraSmall],
                    y = (u, e) =>
                ...
                const H = {
                    ...
                    X = N((u) => {
                        ...
                        const q = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, E, A, F, _, X, N, R, C, O, f, S]),
                            $ = q.computedStyle,
                            V = q.computedClassNames;
                        return n().createElement('div', U({ className: D()(k.base, ...V, e), style: $ }, Y), j);
                    });
                let j;
                !(function (u) {
                ...
                const Y = (u, e, t) => {
                    ...
                    $ = (u, e, t = j.left) => u.split(e).reduce(t === j.left ? Y : q, []),
                    V = (() => {
                        const u = new RegExp(
                    ...
                    z = ['zh_cn', 'zh_sg', 'zh_tw'],
                    K = ({ binding: u, text: e = '', classMix: t, alignment: a = j.left }) =>
                        null === e
                ...
                const tu = Object.keys(Z()),
                    ...
                    Eu = N((u) => {
                        ...
                        return n().createElement(
                            ...
                            eu(
                                {
                                    className: D()(J.base, t && J[t], h, a),
                                    style: p,
                                    mt: !0 === s ? iu[t || 'paragraph-P16'].mt : s,
                                    mr: !0 === l ? iu[t || 'paragraph-P16'].mr : l,
                                    mb: !0 === c ? iu[t || 'paragraph-P16'].mb : c,
                                    ml: !0 === m ? iu[t || 'paragraph-P16'].ml : m,
                                },
                                C,
                            ),
                            void 0 !== d ? n().createElement(K, eu({}, d, { text: e })) : e,
                        );
                    });
                let su, Au, lu, Fu, Du, cu, _u;
                !(function (u) {
                    (u.Items = 'items'),
                        ...
                        const h = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, r.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Cu(t, c, { isMouseEvent: !0, on: !0, arguments: du(n) }, b),
                                    C && C(),
                            ...
                            wu(
                                {
                                    contentId:
                                        ...
                                        l ? fu.SimpleTooltipHtmlContent('resId') : fu.SimpleTooltipContent('resId')),
                ...
                const Ru = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return n().createElement(xu, e, r);
                    const a = e.contentId,
                        i = e.args,
                        o = null == i ? void 0 : i.contentId;
                    return a || o
                        ? n().createElement(gu, Su({}, e, { contentId: a || o }), r)
                ...
                const Pu = [
                    ...
                    Ou = [su.Gold, su.Credits, su.Crystal, su.FreeXp],
                    Mu = [su.BattlePassPoints],
                    Lu = [su.PremiumPlus, su.Premium],
                    ...
                    Uu = ({
                        ...
                        return n().createElement(
                            'div',
                            { className: D()(Iu.base, Iu[`base__${r}`], s), style: E },
                            n().createElement(
                                Ru,
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: D()(Iu.image, null == A ? void 0 : A.image) },
                                        c &&
                                            n().createElement('div', {
                                                className: D()(Iu.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            n().createElement('div', {
                                                className: D()(Iu.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        _ &&
                                            n().createElement('div', {
                                                className: D()(Iu.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                            ...
                            t &&
                                n().createElement(
                                    ...
                                    { tooltipArgs: F },
                                    n().createElement('div', {
                                        className: D()(Iu.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const qu = ((u, e) => {
                                                ...
                                                return {
                                                    subscribe: (t, a) => {
                                                        const o = 'string' == typeof a ? `${r}.${a}` : r,
                                                            E = B.O.view.addModelObserver(o, e, !0);
                                            ...
                                            A = (({ observableModel: u }) => {
                                                const e = {
                                                    ...
                                                    t = (0, Yu.Om)(() =>
                                                        ju(e.slots.get(), (u) =>
                                                            Object.assign({}, u, {
                                                                bonuses: ju(u.bonuses, (u) => Object.assign({}, u)),
                                                            }),
                                                        ),
                                                    ),
                                                    r = (0, Yu.Om)(() => {
                                                        ...
                                                        return Object.assign({}, u, {
                                                            vehicleNames: ju(u.vehicleNames, (u) => u),
                                                        });
                                                    });
                    ...
                    $u = qu[0],
                    Vu = qu[1],
                    zu = 'App_textHightlight_84',
                    Ku = 'App_probabilityTitleWrapper_7f',
                    Qu = 'App_probabilityTitle_01';
                function Zu() {
                    return (
                        (Zu =
                            Object.assign ||
                ...
                const Ju = R.strings.lootboxes,
                    ue = (0, o.Pi)(() => {
                        const u = Vu().model,
                            ...
                            A = i.garant,
                            F = i.probability,
                            D = u.computes.getLootbox(),
                            c = s === E ? l(E) : `${l(E)}-${l(s)}`,
                            _ = {
                                level: n().createElement(Eu, { text: c, className: 'App_hightlight_77' }),
                                probability: n().createElement(Eu, { text: `${F}%`, className: zu }),
                                containersCount: n().createElement(Eu, {
                                    text: Ju.lootboxExtendedTooltip.containersCount(),
                                    className: zu,
                                    format: { binding: { count: A } },
                                }),
                            };
                        return n().createElement(
                            'div',
                            { className: 'App_base_4a' },
                            n().createElement(Eu, { text: Ju.userName.$dyn(t), className: 'App_title_7b' }),
                            n().createElement(Eu, { text: r, className: 'App_description_89' }),
                            n().createElement(Eu, {
                                text: Ju.lootboxTooltip.slotTitle(),
                            ...
                            n().createElement(
                                ...
                                { className: Ku },
                                n().createElement(K, {
                                    text: Ju.lootboxExtendedTooltip.specialSlot(),
                                    binding: _,
                                    classMix: Qu,
                                }),
                            ),
                            n().createElement(
                                ...
                                n().createElement(Eu, { text: o.join(', '), className: 'App_vehicleNames_64' }),
                            ),
                            D.map(({ description: u, bonuses: e, probability: t }, r) => {
                                const a = e.map((u) => {
                                        return {
                                            name: u.name,
                                            image: ku(u, lu.Small),
                                ...
                                return n().createElement(
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: Ku },
                                        n().createElement(Eu, { text: u, className: Qu }),
                                        n().createElement(Eu, {
                                            text: R.strings.mapbox.survey.percentage(),
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: 'App_rewardsWrapper_a6' },
                                        a.map((u, e) =>
                                            n().createElement(
                                                Uu,
                                                Zu({ size: lu.Small, key: e, className: 'App_reward_1e' }, u),
                                            ),
                                        ),
                                        i &&
                                            n().createElement(Eu, {
                                                text: Ju.lootboxExtendedTooltip.rewardExtraText(),
                            ...
                            n().createElement(
                                'div',
                                { className: 'App_footer_58' },
                                n().createElement('div', { className: 'App_counterBg_32' }),
                                n().createElement(Eu, { text: a, className: 'App_guaranteedNumber_af' }),
                                n().createElement(Eu, {
                                    text: Ju.lootboxTooltip.guaranteedCounter(a),
                ...
                const ne = n().forwardRef(function (u, e) {
                    let t = u.children,
                        a = u.className,
                        i = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            re({}, E, {
                                className: D()(ee.base, ee[`base__theme-${o}`], a),
                                ref: function (u) {
                                    (A.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            n().createElement('div', { className: ee.decorator }, t),
                        )
                    );
                });
                engine.whenReady.then(() => {
                    i().render(
                        n().createElement($u, null, n().createElement(ne, null, n().createElement(ue, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4590));
