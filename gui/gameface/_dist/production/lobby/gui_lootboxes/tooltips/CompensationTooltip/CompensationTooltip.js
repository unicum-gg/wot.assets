    ...
    var __webpack_modules__ = {
            ...
            1204: (u, e, t) => {
                ...
                (x.defaultProps = { format: 'integral' }),
                    ...
                    v.PremiumPlus,
                    v.Premium;
                const O = ['engravings', 'backgrounds'],
                            ...
                            ((u, e = b.Small) => {
                                ...
                                return ((u, e = b.Small) => {
                                    ...
                                    switch (t) {
                                        ...
                                        case 'dossier_badge':
                                            return `R.images.gui.maps.icons.quests.bonuses.badges.${E}.${r}`;
                                        case 'dossier_achievement':
                                            return `R.images.gui.maps.icons.achievement.${E}.${r}`;
                                        case 'xp':
                                        case 'xpFactor':
                                        ...
                                        case 'collectionItem':
                                            return `R.images.gui.maps.icons.collectionItems.${E}.${r}`;
                                    }
                                })(u, e);
                            })(u, e),
                        value: u.value,
                        ...
                        return [
                            function ({ mode: u = 'real', options: e, children: n, mocks: s }) {
                                ...
                                return (
                                    ...
                                    i().createElement(t.Provider, { value: v }, n)
                                );
                            },
                            () => (0, o.useContext)(t),
                        ];
                ...
                const $ = ['', 'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X'],
                        ...
                        return i().createElement(
                            ...
                            u.name === v.Vehicles
                                ? i().createElement(
                                      'div',
                                      { className: z.vehicle },
                                      i().createElement('div', { className: z.vehicleTitle }),
                                      i().createElement('div', {
                                      ...
                                      i().createElement(
                                          ...
                                          i().createElement('div', { className: z.vehicleNameText }, u.label),
                                      ),
                                  )
                                : i().createElement(
                                      'div',
                            ...
                            i().createElement('div', { className: z.compensationArrow }),
                    ...
                    H = ({ rewardType: u }) =>
                        i().createElement(
                            'div',
                            { className: X.base },
                            i().createElement('div', { className: s()(X.icon, X[`icon__${u}`]) }),
                            i().createElement(
                                'div',
                                { className: X.text },
                    ...
                    W = R.strings.gui_lootboxes.compensationTooltip,
                    j = ({ title: u, subtitle: e }) =>
                        i().createElement(
                            'div',
                            { className: 'Header_base_e6' },
                            i().createElement('div', { className: 'Header_title_3b' }, W.title.$dyn(u)),
                            i().createElement('div', { className: 'Header_description_b1' }, W.description.$dyn(e)),
                        ),
                    K = (0, D.Pi)(() => {
                        const u = q().model,
                        ...
                        return i().createElement(
                            ...
                            i().createElement(Y, { itemAfter: e, itemBefore: t }),
                            i().createElement(H, { rewardType: t.name }),
                        );
                    });
                engine.whenReady.then(() => {
                    l().render(
