(() => {
    var __webpack_modules__ = {
            ...
            4941: (u, e, t) => {
                ...
                const D = i().forwardRef(function (u, e) {
                    let t = u.children,
                        r = u.className,
                        D = u.theme,
                    ...
                    return (
                        ...
                        i().createElement(
                            'div',
                            o({}, l, {
                                className: a()(A.base, A[`base__theme-${s}`], r),
                                ref: function (u) {
                        ...
                        const f = (0, E.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            x = (0, E.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (C(t, B, { isMouseEvent: !0, on: !0, arguments: d(r) }, w),
                                    p && p(),
                                      ...
                                      Object.assign(
                                          {
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((f.current.timeoutId = window.setTimeout(x, o ? 100 : 400)),
                                                          a && a(u),
                                                          M && M(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                                              ...
                                              onClick: ((u) => (e) => {
                                                  (!1 === s && y(), null == A || A(e), null == u || u(e));
                                              })(e.props.onClick),
                                              onMouseDown: ((u) => (e) => {
                                                  (!1 === s && y(), null == i || i(e), null == u || u(e));
                                              })(e.props.onMouseDown),
                                          },
                                          v,
                                      ),
                ...
                const p = R.views.common.tooltip_window.simple_tooltip_content,
                    b = (u) => {
                        ...
                        const o = (0, E.useMemo)(() => {
                            const u = Object.assign({}, A, { body: t, header: r, note: a, alert: n });
                    ...
                    v = ({ content: u, classMix: e }) => {
                        ...
                        return (
                            (0, E.useEffect)(() =>
                                ((u) => {
                                    ...
                                    return (
                                        ...
                                        () => {
                                            ('function' == typeof e && e(), null !== r && cancelAnimationFrame(r));
                                        }
                                    );
                                })(),
                            ),
                            i().createElement(
                                b,
                                { isEnabled: n, body: u },
                                i().createElement('div', { ref: t, className: a()('TextOverflow_base_3b', e) }, u),
                            )
                        );
                    },
                    f = {
                    ...
                    w = { [B.default]: 'c_24x24', [B.x48]: 'c_48x48', [B.x80]: 'c_80x80', [B.x220]: 'c_220x220' },
                    x = ({ badgeID: u, size: e = B.default, className: t }) => {
                        const r = R.images.gui.maps.icons.library.badges.$dyn(w[e]);
                        return i().createElement('div', {
                            className: a()(f.base, f[`base__${e}`], t),
                ...
                const S = (u, e, t) => {
                    ...
                    O = (u, e, t = y.left) => u.split(e).reduce(t === y.left ? S : M, []),
                    L = (() => {
                        const u = new RegExp(
                    ...
                    N = (0, E.memo)(({ tooltipHeaderName: u }) => {
                        const e = (0, E.useMemo)(() => {
                                return (
                        ...
                        return i().createElement(
                            b,
                            { header: e, body: t },
                            i().createElement('div', { className: P.anonymizedIcon }),
                        );
                    });
                function k() {
                    return (
                ...
                const H = { [B.default]: 'c_64x24', [B.x48]: 'c_68x28' },
                    I = { [B.default]: 'c_48x48', [B.x48]: 'c_48x48' },
                    W = ({
                        userName: u,
                        clanAbbrev: e = '',
                        igrType: t = 0,
                        ...
                        const _ = R.images.gui.maps.icons.library.badges.strips.$dyn(H[s]),
                            d = (0, E.useMemo)(
                                () => ({ backgroundImage: `url(${_.$dyn(`strip_${n.badgeID}`)})` }),
                                [n, _],
                            ),
                            C = R.images.gui.maps.icons.library.badges.$dyn(I[s]),
                            m = (0, E.useMemo)(
                                () => ({ backgroundImage: `url(${C.$dyn(`badge_${n.badgeID}`)})` }),
                                [n, C],
                            ),
                            g = e ? `[${e}]` : '',
                            h = a()(P.base, P[`base__${s}`], A && P.base__inverted),
                            p = a()(P.userName, l),
                            b = a()(P.clanTag, c),
                            f = u !== D,
                            w = F ? `${D}${g}` : D,
                            y = Boolean(r.badgeID) && i().createElement(x, k({ size: s }, r, { key: 'badge' })),
                            S = Date.now(),
                            M = [
                                y,
                                [
                                    i().createElement(
                                        ...
                                        i().createElement(v, { content: u, key: S }),
                                    ),
                                    !F && Boolean(g) && i().createElement('div', { className: b, key: 'clanTag' }, g),
                                ],
                                0 !== t && i().createElement('div', { className: P.igrIcon, key: 'igrType' }),
                                Boolean(n.badgeID) &&
                                    i().createElement(
                                        'div',
                                        { className: P.suffixBadgeWrapper, key: 'suffixBadge' },
                                        i().createElement('div', { className: P.suffixBadgeStripe, style: d }),
                                        i().createElement('div', { className: P.suffixBadge, style: m }),
                                    ),
                                o && f && i().createElement(N, { tooltipHeaderName: w, key: 'anonymizer' }),
                            ];
                        return i().createElement('div', { className: h }, A ? M.reverse() : M);
                    };
                var j = t(9887),
                    G = t.n(j);
                const U = (u, e, t) =>
                ...
                const K = n.O.client.getSize('rem'),
                    q = K.width,
                    Y = K.height,
                    $ = Object.assign({ width: q, height: Y }, z(q, Y, V)),
                    Z = (0, E.createContext)($),
                    Q = ['children'],
                    J = (u) => {
                        let e = u.children,
                        ...
                        const r = (0, E.useContext)(Z),
                            ...
                            g = { extraLarge: c, large: _, medium: d, small: C, extraSmall: m };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && o) return U(e, t, g);
                            if (t.largeWidth && D) return U(e, t, g);
                            if (t.mediumWidth && s) return U(e, t, g);
                            if (t.smallWidth && l) return U(e, t, g);
                            if (t.extraSmallWidth && B) return U(e, t, g);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                ...
                ((0, E.memo)(({ children: u }) => {
                    const e = (0, E.useContext)(Z),
                        ...
                        A = (0, E.useCallback)((u, e) => {
                            ...
                            a(Object.assign({ width: t, height: r }, z(t, r, V)));
                        }, []);
                    (((u) => {
                    ...
                    const F = (0, E.useMemo)(() => Object.assign({}, r), [r]);
                    return i().createElement(Z.Provider, { value: F }, u);
                }),
                    (function (u) {
                ...
                const ru = ['xl', 'lg', 'md', 'sm', 'xs'],
                    au = (u) => u.includes('_') && ((u) => ru.includes(u))(u.split('_').at(-1)),
                    nu = [uu.ExtraLarge, uu.Large, uu.Medium, uu.Small, uu.ExtraSmall],
                    Eu = (u, e) =>
                ...
                const Du = {
                    ...
                    Bu = iu((u) => {
                        let e = u.className,
                            ...
                            R = u.shrink,
                            P = u.flex,
                            N = void 0 === P ? (T || R ? `${T ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : P,
                            k = u.style,
                            H = u.children,
                            I = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const W = (0, E.useMemo)(() => {
                                const u = { mt: F, mr: D, mb: l, ml: c },
                                    ...
                                    a = ((u) =>
                                        su.reduce((e, t) => {
                                            const r = u[t];
                                            return ('number' == typeof r && (e[lu[t]] = r + 'rem'), e);
                                        }, {}))(u);
                                return {
                            ...
                            }, [t, r, F, D, l, c, k, N, S, m, L, w, y]),
                            j = W.computedStyle,
                            G = W.computedClassNames;
                        return i().createElement('div', ou({ className: a()(Au.base, ...G, e), style: j }, I), H);
                    }),
                    cu = ({ binding: u, text: e = '', classMix: t, alignment: r = y.left }) =>
                        null === e
                                  ...
                                  e.split('\n').map((e, n) =>
                                      i().createElement(
                                          ...
                                          ((u, e, t) =>
                                              ...
                                              i().createElement(E.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              );
                ...
                const hu = Object.keys(du()),
                    ...
                    xu = iu((u) => {
                        ...
                        return i().createElement(
                            ...
                            gu(
                                {
                                    className: a()(Cu.base, t && Cu[t], p, r),
                                    style: h,
                                    mt: !0 === o ? fu[t || 'paragraph-P16'].mt : o,
                                    mr: !0 === s ? fu[t || 'paragraph-P16'].mr : s,
                                    mb: !0 === B ? fu[t || 'paragraph-P16'].mb : B,
                                    ml: !0 === _ ? fu[t || 'paragraph-P16'].ml : _,
                                },
                                m,
                            ),
                            void 0 !== C ? i().createElement(cu, gu({}, C, { text: e })) : e,
                        );
                    });
                var yu = t(3282);
                const Su = (0, E.memo)(() =>
                    i().createElement(
                        ...
                        i().createElement('div', { className: 'Spinner_spinner_00' }),
                    ),
                );
                function Mu() {
                    return !1;
                    ...
                    Ru = (u) => {
                        return null !== u && 'object' == typeof u
                            ? 'CoherentArrayProxy' === u.constructor.name
                                ? ((e = u),
                                  (t = (u) => ('object' == typeof u ? Ru(u) : u)),
                                  Array.isArray(e) ? e.map(t) : e.map((u, e, r) => t(null == u ? void 0 : u.value)))
                                : Array.isArray(u)
                                  ? u.map((u) => ('object' == typeof u ? Ru(u) : u))
                                  : Object.fromEntries(
                                        Object.entries(u).map(([u, e]) => [u, 'object' == typeof e ? Ru(e) : e]),
                                    )
                            : u;
                        var e, t;
                    };
                ...
                const Nu = ((u, e) => {
                                ...
                                const F = (0, E.useRef)([]),
                                    o = (u, t, r) => {
                                        ...
                                        const E = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const A = 'string' == typeof E ? `${r}.${E}` : r,
                                                            F = n.O.view.addModelObserver(A, e, !0);
                                                        return (a.set(F, t), u && t(i(E)), F);
                                                    },
                                                    readByPath: i,
                                                    createCallback: (u, e) => {
                                                        const t = i(e);
                                            ...
                                            D = (({ observableModel: u }) => {
                                                const e = { root: u.object(), players: u.array('players') },
                                                    t = (0, Pu.O)(
                                                        () => {
                                                            return ((u = e.players.get()), Ru(u));
                                                            var u;
                                                        },
                                                        { equals: Mu },
                                                    ),
                                                    r = (0, Pu.O)(
                                                        () => Array.from(Array(e.root.get().playersCount).keys()),
                                                        { equals: Mu },
                                                    );
                                                return Object.assign({}, e, {
                                                    computes: { getPlayers: t, getPlayersList: r },
                                                });
                                            })({
                                                mode: u,
                                                readByPath: A,
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : A(e),
                                                            a = Ou.observable.box(r, { equals: Mu });
                                                        return (
                                                            'real' === u &&
                                                                i.subscribe(
                                            ...
                                            s = { mode: u, model: D, externalModel: i, cleanup: o };
                                        return {
                                            model: D,
                                    ...
                                    l = s[0],
                                    B = s[1],
                                    c = (0, E.useState)(() => o(u, r, A)),
                                    _ = c[0],
                                    d = c[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        D.current ? d(o(l, r, A)) : (D.current = !0);
                                    }, [A, l, r]),
                                    (0, E.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                                    (0, E.useEffect)(
                                        () => () => {
                                            (_.externalModel.dispose(), F.current.forEach((u) => u()));
                                        },
                                        [_],
                                    ),
                    ...
                    Hu = Nu[1],
                    Iu = 'App_listItem_b5',
                    Wu = R.strings.gui_lootboxes.rewards.gift.header.subTitle.moreSendersTooltip,
                    ju = (0, yu.observer)(() => {
                        const u = Hu().model,
                            e = u.computes.getPlayers(),
                            t = u.computes.getPlayersList(),
                            r = t.length - e.length,
                            a = 80 + 26 * e.length + 32 * r;
                        return i().createElement(
                            'div',
                            { className: 'App_base_5c', style: { height: `${a}rem` } },
                            i().createElement(xu, { text: Wu.title(), className: 'App_title_35' }),
                            t.map((u) =>
                                e[u]
                                    ? i().createElement(W, {
                                          key: `player_${u}`,
                                          userNameClassName: Iu,
                                          clanTagClassName: Iu,
                                          userName: e[u].playerName,
                                          clanAbbrev: e[u].playerClanTag,
                                      })
                                    : i().createElement(
                                          'div',
                                          { key: `player_${u}`, className: 'App_loading_31' },
                ...
                engine.whenReady.then(() => {
                    l().render(
                        i().createElement(ku, null, i().createElement(D, null, i().createElement(ju, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4941));
