(() => {
    var __webpack_modules__ = {
                ...
                const s = {
                    ...
                    l = (0, a.ZP)((u) => {
                        let e = u.className,
                            ...
                            p = u.row,
                            w = u.flexDirection,
                            b = void 0 === w ? (x ? 'column' : p && 'row') || void 0 : w,
                            v = u.flexStart,
                            S = u.center,
                            f = u.flexEnd,
                            L = u.spaceBetween,
                            ...
                            R =
                                void 0 === O
                                    ...
                                    : O,
                            T = u.alignItems,
                            P = void 0 === T ? (v ? 'flex-start' : S && 'center') || (f && 'flex-end') || void 0 : T,
                            y = u.alignSelf,
                            H = u.wrap,
                            N = u.flexWrap,
                            k = void 0 === N ? (H ? 'wrap' : void 0) : N,
                            W = u.grow,
                            G = u.shrink,
                            I = u.flex,
                            U = void 0 === I ? (W || G ? `${W ? 1 : 0} ${G ? 1 : 0} auto` : void 0) : I,
                            j = u.style,
                            Z = u.children,
                            X = (function (u, e) {
                                if (null == u) return {};
            ...
            280: (u, e, t) => {
                ...
                var E = t(6179),
                    ...
                    a = t(3649),
                    D = t(5287);
                const i = ({ binding: u, text: e = '', classMix: t, alignment: F = a.v2.left }) =>
                    null === e
                        ...
                        : A().createElement(
                              ...
                              e.split('\n').map((e, i) =>
                                  A().createElement(
                                      'div',
                                      { className: r()(D.Z.base, t), key: `${e}-${i}` },
            ...
            3495: (u, e, t) => {
                ...
                const a = E.O.client.getSize('rem'),
                    D = a.width,
                    i = a.height,
                    n = Object.assign({ width: D, height: i }, (0, r.T)(D, i, F.j)),
                ...
                (0, E.memo)(({ children: u }) => {
                    const e = (0, E.useContext)(r.Y),
                        ...
                        o = (0, E.useCallback)((u, e) => {
                            ...
                            B(Object.assign({ width: t, height: E }, (0, D.T)(t, E, a.j)));
                        }, []);
                    ((0, F.Z)(() => {
                    ...
                    return A().createElement(r.Y.Provider, { value: s }, u);
                });
            },
            6010: (u, e, t) => {
                'use strict';
                ...
                const r = ['children'],
                    a = (u) => {
                        ...
                        const a = (0, E.useContext)(F.Y),
                            ...
                            p = { extraLarge: m, large: c, medium: h, small: g, extraSmall: x };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            if (t.extraLarge && D) return e;
                ...
                (0, B.ZP)((u) => {
                    ...
                    const S = (0, o.useMemo)(() => {
                            const u = x(a),
                                ...
                                t = u.colorStyle,
                                E = void 0 === t ? {} : t;
                            return { computedStyle: Object.assign({}, w, E), colorClassName: e };
                        }, [w, a]),
                        f = S.computedStyle,
                        L = S.colorClassName;
                        ...
                        l(
                            {
                                ...
                                mb: !0 === c ? g[t || 'paragraph-P16'].mb : c,
                                ml: !0 === p ? g[t || 'paragraph-P16'].ml : p,
                            },
                            v,
                        ),
                        void 0 !== b ? s().createElement(r.z, l({}, b, { text: e })) : e,
                    );
                });
            },
            2056: (u, e, t) => {
            ...
            527: (u, e, t) => {
                'use strict';
                (t.r(e), t.d(e, { mouse: () => a, onResize: () => F }));
                var E = t(2472),
                    A = t(1176);
            ...
            3377: (u, e, t) => {
                ...
                const r = ['xl', 'lg', 'md', 'sm', 'xs'],
                    a = (u) => u.includes('_') && ((u) => r.includes(u))(u.split('_').at(-1)),
                    D = [E.cJ.ExtraLarge, E.cJ.Large, E.cJ.Medium, E.cJ.Small, E.cJ.ExtraSmall],
                    i = (u, e) =>
                        Object.keys(u).reduce((t, E) => {
                            ...
                            return (
                                void 0 === A ||
                                    ((u, e) => r.some((t) => void 0 !== e[`${u}_${t}`]))(E, u) ||
                                    (t[E] = A),
                                t
                            );
                        }, {}),
            ...
            5415: (u, e, t) => {
                ...
                const i = () => {
                    ...
                    return { mediaSize: F, mediaWidth: i, mediaHeight: n, remScreenWidth: e, remScreenHeight: t };
                };
            },
            5521: (u, e, t) => {
                'use strict';
            ...
            3649: (u, e, t) => {
                ...
                const A = (u, e, t) => {
                    ...
                    r = (u, e, t = E.left) => u.split(e).reduce(t === E.left ? A : F, []),
                    a = (() => {
                        const u = new RegExp(
                                      ...
                                      return D.includes(t)
                                          ...
                                          : ((u, e = E.left) => {
                                                ...
                                                const A =
                                                    ...
                                                    F = u.replace(/&nbsp;/g, ' ');
                                                return (
                                                    r(F, /( )/, e).forEach((u) => (t = t.concat(r(u, A, E.left)))),
                                                    t
                                                );
                                            })(u, e);
                                  })(u, e),
            ...
            4179: (u, e, t) => {
                ...
                function d(u, e, t, E, A, F, r) {
                    ...
                    a.done ? e(D) : Promise.resolve(D).then(E, A);
                }
                ...
                const w = A.instance,
                    b = {
                        ...
                        sendMoveEvent: (u) => h(D.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: g,
                        sendClosePopOverEvent: () => h(D.POP_OVER, { on: !1 }),
            ...
            3746: (u, e, t) => {
                'use strict';
                (t(7613), t(6179), t(2056), t(4891), R.strings.gui_lootboxes.shortStatistic.deadline);
            },
            4380: (u, e, t) => {
                'use strict';
                let E, A, F, r;
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (D = 0; D < deferred.length; D++) {
                    for (var [e, t, E] = deferred[D], F = !0, r = 0; r < e.length; r++)
                        (!1 & E || A >= E) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(3746));
