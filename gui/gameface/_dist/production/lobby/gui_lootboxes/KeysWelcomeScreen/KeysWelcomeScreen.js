(() => {
    var __webpack_modules__ = {
            ...
            5103: (u, e, t) => {
                ...
                const o = E.O.client.getSize('rem'),
                    ...
                    c = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && s) return n(e, t, b);
                            if (t.largeWidth && D) return n(e, t, b);
                            if (t.mediumWidth && l) return n(e, t, b);
                            if (t.smallWidth && c) return n(e, t, b);
                            if (t.extraSmallWidth && C) return n(e, t, b);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                const M = {
                    ...
                    T = (u) => {
                        ...
                        const n = x(),
                            ...
                            i = n.mediaHeight,
                            A = n.mediaSize;
                        return a().createElement('div', w({ className: d()(t, M[E], S[i], L[A]) }, r), e);
                    },
                    O = ['children'],
                    y = (u) => {
                        let e = u.children,
                ...
                class G extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = d()(N.base, N[`base__${E}`], N[`base__${n}`], null == i ? void 0 : i.base),
                            _ = d()(N.icon, N[`icon__${E}`], N[`icon__${n}`], null == i ? void 0 : i.icon),
                            B = d()(N.glow, null == i ? void 0 : i.glow),
                            c = d()(N.caption, N[`caption__${E}`], null == i ? void 0 : i.caption),
                            C = d()(N.goto, null == i ? void 0 : i.goto);
                        return a().createElement(
                            ...
                            'info' !== E && a().createElement('div', { className: N.shine }),
                ...
                const V = ['xl', 'lg', 'md', 'sm', 'xs'],
                    q = (u) => u.includes('_') && ((u) => V.includes(u))(u.split('_').at(-1)),
                        ...
                        let e = u.className,
                            ...
                            f =
                                void 0 === x
                                    ...
                                    : x,
                            w = u.alignItems,
                            M = void 0 === w ? (h ? 'flex-start' : g && 'center') || (p && 'flex-end') || void 0 : w,
                            S = u.alignSelf,
                            L = u.wrap,
                            T = u.flexWrap,
                ...
                const iu = (u, e, t) => {
                    ...
                    Fu = (u, e, t = Eu.left) => u.split(e).reduce(t === Eu.left ? iu : Au, []),
                    ou = (() => {
                        const u = new RegExp(
                    ...
                    Du = ({ binding: u, text: e = '', classMix: t, alignment: n = Eu.left }) =>
                        null === e
                ...
                const mu = Object.keys(_u()),
                    ...
                    vu = Q((u) => {
                        ...
                        return a().createElement(
                            ...
                            Cu(
                                {
                                    className: d()(Bu.base, t && Bu[t], p, n),
                                    style: g,
                                    mt: !0 === F ? pu[t || 'paragraph-P16'].mt : F,
                                    mr: !0 === s ? pu[t || 'paragraph-P16'].mr : s,
                                    mb: !0 === l ? pu[t || 'paragraph-P16'].mb : l,
                                    ml: !0 === B ? pu[t || 'paragraph-P16'].ml : B,
                                },
                                m,
                            ),
                            void 0 !== C ? a().createElement(Du, Cu({}, C, { text: e })) : e,
                        );
                    }),
                    xu = (0, r.memo)(({ title: u, description: e, image: t, imageSmall: r }) => {
                        const n = x().mediaSize;
                        return a().createElement(
                            'div',
                            { className: 'ContentItem_base_1a' },
                            a().createElement('div', {
                                className: 'ContentItem_image_3d',
                                style: { backgroundImage: `url(${n >= p.Medium ? t : r})` },
                            }),
                            a().createElement(vu, { text: u, format: { classMix: 'ContentItem_title_b0' } }),
                            a().createElement(vu, { text: e, format: { classMix: 'ContentItem_description_4b' } }),
                        );
                    });
                function fu() {
                    return (
                ...
                const wu = ({ welcomeItems: u }) =>
                        a().createElement(
                            'div',
                            { className: 'Content_base_e8' },
                            u.map((u) => a().createElement(xu, fu({ key: u.itemKey }, u))),
                        ),
                    Mu = {
                    ...
                    const c = (0, r.useRef)(null),
                        ...
                        P = d()(
                            ...
                            Mu[`base__${n}`],
                            {
                                ...
                                [Mu.base__firstHover]: x,
                            },
                            i,
                        ),
                        N = d()(Mu.state, Mu.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                        ...
                        a().createElement(
                            ...
                            n !== Su.ghost &&
                                a().createElement(
                                    a().Fragment,
                                    null,
                                    a().createElement('div', { className: Mu.back }),
                                    a().createElement('span', { className: Mu.texture }),
                                ),
                            a().createElement(
                                'span',
                                { className: N },
                                a().createElement('span', { className: Mu.stateDisabled }),
                                a().createElement('span', { className: Mu.stateHighlightHover }),
                                a().createElement('span', { className: Mu.stateHighlightActive }),
                            ),
                            a().createElement(
                                'span',
                ...
                const Ou = (0, r.memo)(Tu),
                    Ru = ({ text: u, onClose: e }) =>
                        a().createElement(
                            'div',
                            { className: 'Footer_base_36' },
                            a().createElement(
                                Ou,
                                { type: Su.primary, size: Lu.medium, onClick: e, mixClass: 'Footer_button_01' },
                                u,
                            ),
                        ),
                    yu = ({ mainText: u, secondText: e }) =>
                        a().createElement(
                            'div',
                            { className: 'Header_base_65' },
                            a().createElement(
                                'div',
                                { className: 'Header_headerContainer_26' },
                                a().createElement(vu, { text: u, format: { classMix: 'Header_mainHeaderText_7d' } }),
                                e &&
                                    a().createElement(vu, {
                                        text: e,
                                        format: { classMix: 'Header_secondHeaderText_c0' },
                                    }),
                            ),
                        );
                function Hu() {
                ...
                const Nu = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    Wu = Iu[0],
                    Gu = Iu[1],
                    Uu = R.strings.gui_lootboxes.keyWelcomeScreen,
                    ju = [
                        {
                            itemKey: 1,
                            title: Uu.content.first.title(),
                            description: Uu.content.first.description(),
                            image: 'R.images.gui_lootboxes.gui.maps.welcomeScreen.bonusFirst',
                            imageSmall: 'R.images.gui_lootboxes.gui.maps.welcomeScreen.bonusFirst_small',
                        },
                        {
                            itemKey: 2,
                            title: Uu.content.second.title(),
                            description: Uu.content.second.description(),
                            image: 'R.images.gui_lootboxes.gui.maps.welcomeScreen.bonusSecond',
                            imageSmall: 'R.images.gui_lootboxes.gui.maps.welcomeScreen.bonusSecond_small',
                        },
                        {
                            itemKey: 3,
                            title: Uu.content.third.title(),
                            description: Uu.content.third.description(),
                            image: 'R.images.gui_lootboxes.gui.maps.welcomeScreen.bonusThird',
                            imageSmall: 'R.images.gui_lootboxes.gui.maps.welcomeScreen.bonusThird_small',
                        },
                    ],
                    Xu = (0, K.Pi)(() => {
                        const u = Gu().controls,
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: 'App_base_a6' },
                                a().createElement('div', { className: 'App_vignette_7d' }),
                                a().createElement(
                                    'div',
                                ...
                                a().createElement(yu, { mainText: Uu.header.titleMain() }),
                                a().createElement(wu, { welcomeItems: ju }),
                                a().createElement(Ru, {
                                    text: R.strings.gui_lootboxes.welcomeScreen.button.acceptButton(),
                                    onClose: e,
                                }),
                            )
                        );
                ...
                engine.whenReady.then(() => {
                    P().render(
                        a().createElement(y, null, a().createElement(Wu, null, a().createElement(Xu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(5103));
