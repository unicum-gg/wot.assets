(() => {
    var __webpack_modules__ = {
                ...
                const i = ['children'],
                    o = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.mediumWidth && _) return (0, a.H)(e, t, v);
                                      ...
                                      return s.includes(t)
                                          ...
                                          : ((u, e = r.left) => {
                                                ...
                                                const a =
                                                    ...
                                                    n = u.replace(/&nbsp;/g, ' ');
                                                return (
                                                    o(n, /( )/, e).forEach((u) => (t = t.concat(o(u, a, r.left)))), t
                                                );
                                            })(u, e);
                                  })(u, e),
                        );
            ...
            5909: (u, e, t) => {
                ...
                const D = {
                    ...
                    c = (u) => {
                        ...
                        const a = (0, A.GS)(),
                            ...
                            E = a.mediaHeight,
                            s = a.mediaSize;
                        return n().createElement('div', F({ className: o()(t, D[i], d[E], _[s]) }, r), e);
                    },
                    B = ['children'],
                    m = (u) => {
                        let e = u.children,
                ...
                class y extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            d = o()(T.base, T[`base__${i}`], T[`base__${a}`], null == E ? void 0 : E.base),
                            _ = o()(T.icon, T[`icon__${i}`], T[`icon__${a}`], null == E ? void 0 : E.icon),
                            c = o()(T.glow, null == E ? void 0 : E.glow),
                            B = o()(T.caption, T[`caption__${i}`], null == E ? void 0 : E.caption),
                            m = o()(T.goto, null == E ? void 0 : E.goto);
                        return n().createElement(
                            ...
                            'info' !== i && n().createElement('div', { className: T.shine }),
                                ...
                                const E = (0, a.useRef)([]),
                                    s = (u, t, r) => {
                                        ...
                                        const n = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, n) => {
                                                        const o = 'string' == typeof n ? `${r}.${n}` : r,
                                                            E = O.O.view.addModelObserver(o, e, !0);
                                            ...
                                            A = (({ observableModel: u }) => {
                                                const e = { root: u.object(), reward: u.array('reward.items') },
                                                    t = (0, V.Om)(
                                                        () => {
                                                            return ((u = e.reward.get()),
                                                            (t = (u) => Object.assign({}, u)),
                                                            Array.isArray(u)
                                                                ? u.map(t)
                                                                : u.map((u, e, r) =>
                                    ...
                                    F = l[0],
                                    D = l[1],
                                    d = (0, a.useState)(() => s(u, r, o)),
                                    _ = d[0],
                                    c = d[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        A.current ? c(s(F, r, o)) : (A.current = !0);
                                    }, [o, F, r]),
                                    (0, a.useEffect)(() => {
                                        D(u);
                                    }, [u]),
                ...
                var z = t(2787);
                const $ = (0, a.memo)(
                        ({ videoResource: u, isWindowAccessible: e, onVideoEnded: t, onVideoStarted: r }) => {
                    ...
                    K = (0, a.memo)(({ videoRes: u, isWindowAccessible: e, onVideoEnded: t, onVideoStarted: r }) =>
                        n().createElement(
                            'div',
                            { className: 'CustomizationsVideoReward_base_b2' },
                            n().createElement($, {
                                videoResource: u,
                ...
                const eu = (0, a.memo)(uu);
                var tu = t(9887),
                    ru = t.n(tu);
                const au = ['xl', 'lg', 'md', 'sm', 'xs'],
                    nu = (u) => u.includes('_') && ((u) => au.includes(u))(u.split('_').at(-1)),
                    iu = [A.cJ.ExtraLarge, A.cJ.Large, A.cJ.Medium, A.cJ.Small, A.cJ.ExtraSmall],
                    ou = (u, e) =>
                ...
                const Fu = {
                    ...
                    _u = Eu((u) => {
                        ...
                        const G = (0, a.useMemo)(() => {
                            ...
                            }, [t, r, s, l, D, _, k, N, T, C, L, w, x]),
                            U = G.computedStyle,
                            W = G.computedClassNames;
                        return n().createElement('div', lu({ className: o()(su.base, ...W, e), style: U }, I), H);
                    });
                var cu = t(3649);
                const Bu = ({ binding: u, text: e = '', classMix: t, alignment: r = cu.v2.left }) =>
                    null === e
                ...
                const vu = Object.keys(Cu()),
                    ...
                    Tu = Eu((u) => {
                        ...
                        return n().createElement(
                            ...
                            pu(
                                {
                                    className: o()(hu.base, t && hu[t], p, r),
                                    style: g,
                            ...
                            void 0 !== m ? n().createElement(Bu, pu({}, m, { text: e })) : e,
                        );
                    }),
                    ...
                    yu = 'Footer_title_e7',
                    Ou = R.strings.gui_lootboxes.videoreward,
                    Pu = (0, a.memo)(({ reward: u, guaranteedRewardText: e, onFooterButtonClick: t }) => {
                        const r = (0, A.GS)().mediaSize < A.cJ.Medium ? J.small : J.medium;
                        return n().createElement(
                            'div',
                            ...
                            n().createElement(
                                ...
                                Boolean(e.length) &&
                                    n().createElement(Tu, { text: e, className: 'Footer_guaranteedTitle_29' }),
                                ((u) => {
                                    const e = u.label;
                                    if (u.name === g.Vehicles) {
                                        const r = u.isElite,
                                            a = u.vehicleType,
                                            i = u.vehicleLvl,
                                            o = `R.images.gui.maps.icons.vehicleTypes.big.${r ? (0, cu.BN)(a) + '_elite' : (0, cu.BN)(a)}`;
                                        return (
                                            u.name === g.Vehicles &&
                                            n().createElement(
                                                'div',
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        eu,
                                        { type: Q.primary, size: r, mixClass: 'Footer_button_4d', onClick: t },
                                        n().createElement(Tu, { text: Ou.button.title() }),
                                    ),
                                ),
                            ),
                        );
                    }),
                    Nu = (0, a.memo)(({ text: u, isLabelVisible: e }) => {
                        const t = o()('GuaranteedRewardLabel_base_55', !e && 'GuaranteedRewardLabel_base__hidden_3d');
                        return n().createElement(
                            'div',
                            { className: t },
                            n().createElement(Tu, { text: u, className: 'GuaranteedRewardLabel_title_c1' }),
                        );
                    }),
                    ku = R.strings.gui_lootboxes.videoreward,
                    Hu = (0, a.memo)(
                        ({
                            videoRes: u,
                            reward: e,
                            isWindowAccessible: t,
                            isGuaranteedReward: r,
                            onVideoStarted: i,
                            onApplyReward: E,
                        }) => {
                            ...
                            return (
                                ...
                                n().createElement(
                                    'div',
                                    { className: 'ExtraVehicleVideoReward_base_f9' },
                                    n().createElement($, {
                                        videoResource: u,
                                        isWindowAccessible: t,
                                        onVideoStarted: i,
                                    ...
                                    r &&
                                        n().createElement(Nu, {
                                            text: ku.description.vehicleText(),
                                            isLabelVisible: A,
                                        }),
                                    n().createElement(
                                        'div',
                                        {
                                            className: o()(
                                                'ExtraVehicleVideoReward_footer_7b',
                                                D && 'ExtraVehicleVideoReward_footer__visible_a6',
                                            ),
                                        },
                                        n().createElement(Pu, {
                                            reward: e,
                                            guaranteedRewardText: r ? ku.description.commonText() : '',
                                            onFooterButtonClick: () => {
                                                E(), d(!1);
                                            },
                                        }),
                    ...
                    Iu = 'DoubleVideoComponent_video_01',
                    Gu = (0, a.memo)(
                        ({
                            ...
                            onVideoEnded: i,
                            onVideoStarted: o,
                            onFirstVideoUpdated: E,
                            onSecondVideoUpdated: s,
                        }) => {
                            const A = (0, a.useState)(t),
                                l = A[0],
                                F = A[1],
                                D = (0, a.useState)(!1),
                                d = D[0],
                    ...
                    Uu = R.strings.gui_lootboxes.videoreward,
                    Wu = (0, a.memo)(
                        ({
                            firstVideoRes: u,
                            secondVideoRes: e,
                            ...
                            return n().createElement(
                                'div',
                                { className: 'LootBoxVideoReward_base_b7' },
                                n().createElement(Gu, {
                                    firstVideoRes: u,
                                    secondVideoRes: e,
                                    firstVideoDuration: t,
                                    ...
                                    onVideoEnded: o,
                                    onVideoStarted: E,
                                    onSecondVideoUpdated: D,
                                }),
                                i && n().createElement(Nu, { text: Uu.description.commonText(), isLabelVisible: A }),
                            );
                        },
                    ),
                    Vu = R.strings.gui_lootboxes.videoreward,
                    ju = (0, a.memo)(
                        ({
                            firstVideoRes: u,
                            secondVideoRes: e,
                            ...
                            return (
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(Gu, {
                                        ...
                                        isWindowAccessible: i,
                                        onVideoStarted: l,
                                        onSecondVideoUpdated: C,
                                    }),
                                    E &&
                                        n().createElement(Nu, {
                                            text: Vu.description.vehicleText(),
                                            isLabelVisible: D,
                                        }),
                                    n().createElement(
                                        'div',
                                        {
                                            className: o()(
                                                ...
                                                c && 'VehicleVideoReward_footer__visible_63',
                                            ),
                                        },
                                        n().createElement(Pu, {
                                            reward: s,
                                            guaranteedRewardText: E ? Vu.description.commonText() : '',
                                            onFooterButtonClick: () => {
                                                A();
                                            },
                                        }),
                    ...
                    Xu = {
                        firstVideo: { duration: 18, videoPath: R.videos.VehicleLootBoxCongrats.intro() },
                        secondVideo: { duration: 10, videoPath: (u) => R.videos.VehicleLootBoxCongrats.$dyn(u) },
                    },
                    Yu = [
                        'Cz14_Skoda_T_56',
                        'F116_Bat_Chatillon_Bourrasque',
                        'F106_Panhard_EBR_75_Mle1954',
                    ...
                    qu = (0, H.Pi)(() => {
                        const u = Y(),
                            ...
                            t = u.model,
                            r = t.root.get(),
                            i = r.isWindowAccessible,
                            o = r.videoRes,
                            E = r.isGuaranteedReward,
                            s = r.isElite,
                            A = r.vehicleType,
                            l = r.vehicleLvl,
                            F = t.computes.getReward(),
                            D = (0, a.useState)({ reward: F, videoRes: o }),
                            d = D[0],
                            _ = D[1];
                        var c;
                        (0, a.useEffect)(() => {
                            o && _({ reward: F, videoRes: o });
                        }, [o, F]),
                            (c = e.close),
                            k(P.n.ESCAPE, c);
                        const B = (0, a.useCallback)(
                                ...
                                switch (u.name) {
                                    case g.Vehicles:
                                        return Yu.includes(t)
                                            ? n().createElement(Hu, {
                                                  reward: Object.assign({}, u, {
                                                      isElite: s,
                                                      vehicleType: A,
                                                      vehicleLvl: l,
                                                  }),
                                                  videoRes: Xu.secondVideo.videoPath(t),
                                                  isWindowAccessible: i,
                                                  isGuaranteedReward: E,
                                                  onApplyReward: e.close,
                                                  onVideoStarted: e.videoStarted,
                                              })
                                            : n().createElement(ju, {
                                                  reward: Object.assign({}, u, {
                                                      isElite: s,
                                                  ...
                                                  firstVideoRes: Xu.firstVideo.videoPath,
                                                  firstVideoDuration: Xu.firstVideo.duration,
                                                  secondVideoDuration: Xu.secondVideo.duration,
                                                  secondVideoRes: Xu.secondVideo.videoPath(t),
                                                  isGuaranteedReward: E,
                                                  isWindowAccessible: i,
                                                  onApplyReward: e.close,
                                                  onVideoStarted: e.videoStarted,
                            ...
                            [e.close, e.videoStarted, s, E, i, l, A],
                        );
                        return n().createElement(
                            'div',
                            ...
                            d.videoRes && B(d.reward, d.videoRes),
                        );
                    });
                engine.whenReady.then(() => {
                    h().render(
                        n().createElement(X, null, n().createElement(m, null, n().createElement(qu, null))),
                ...
                const D = (u) => {
                    ...
                    d = i().memo(function ({
                        ...
                        const m = (0, n.useRef)(null),
                            C = ((u) => {
                                const e = (0, n.useState)(D(u ? u.current : null)),
                                    t = e[0],
                                    r = e[1];
                                return (
                                    (0, n.useEffect)(() => {
                            ...
                            w = (0, n.useCallback)(() => {
                                ...
                                u &&
                                    (o
                                        ? ((u.currentTime = u.duration - d), u.removeEventListener('play', f), u.play())
                                        : (u.pause(), c && c()));
                            }, [u, f, o, d, c]);
                        return (
                            (0, n.useEffect)(() => {
                                const u = m.current;
                                return (
                                    u && (u.addEventListener('play', f), u.addEventListener('ended', w)),
                                    () => {
                                        u && (u.removeEventListener('play', f), u.removeEventListener('ended', w));
                                    }
                                );
                            }, [u, w, f]),
                            (0, n.useEffect)(() => {
                                ...
                                u && (s ? u.pause() : u.play());
                                const e = setInterval(() => {
                                    u && B && B(A ? Math.round(u.currentTime) : u.currentTime);
                                }, 100);
                            ...
                            i().createElement(
                                ...
                                i().createElement('video', {
                                    ...
                                    ref: m,
                                    src: u,
                                    className: a()('Video_video_a8', C && 'Video_video__visible_e8'),
                                    loop: !1,
                                    style: b,
                                    autoPlay: E,
                                }),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(5909));
