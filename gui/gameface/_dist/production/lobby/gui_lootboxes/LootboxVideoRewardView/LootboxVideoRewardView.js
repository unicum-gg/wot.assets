(() => {
    var __webpack_modules__ = {
            ...
            9533: (u, e, t) => {
                ...
                const D = {
                    ...
                    c = (u) => {
                        ...
                        const a = (0, A.GS)(),
                            ...
                            E = a.mediaHeight,
                            s = a.mediaSize;
                        return n().createElement('div', F({ className: o()(t, D[i], _[E], d[s]) }, r), e);
                    },
                    B = ['children'],
                    m = (u) => {
                        let e = u.children,
                ...
                class O extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            _ = o()(T.base, T[`base__${i}`], T[`base__${a}`], null == E ? void 0 : E.base),
                            d = o()(T.icon, T[`icon__${i}`], T[`icon__${a}`], null == E ? void 0 : E.icon),
                    ...
                    (0, a.useEffect)(() => {
                        ...
                        function r(r) {
                            if (r.keyCode === u) {
                                ...
                                y.O.view.setEventHandled(), e(r), t && r.stopPropagation();
                            }
                        }
                    }, [e, u, t]);
                }
                                                ...
                                                return {
                                                    subscribe: (t, n) => {
                                                        const o = 'string' == typeof n ? `${r}.${n}` : r,
                                                            E = y.O.view.addModelObserver(o, e, !0);
                ...
                const $ = (0, a.memo)(
                    ...
                    Z = 'DoubleVideoComponent_video_01',
                    Q = (0, a.memo)(
                        ({
                ...
                const eu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    ru = [A.cJ.ExtraLarge, A.cJ.Large, A.cJ.Medium, A.cJ.Small, A.cJ.ExtraSmall],
                    au = (u, e) =>
                ...
                const su = {
                    ...
                    Fu = nu((u) => {
                        let e = u.className,
                            ...
                            S =
                                void 0 === f
                                    ...
                                    : f,
                            x = u.alignItems,
                            w = void 0 === x ? (h ? 'flex-start' : g && 'center') || (p && 'flex-end') || void 0 : x,
                            T = u.alignSelf,
                            M = u.wrap,
                            L = u.flexWrap,
                        ...
                        const U = (0, a.useMemo)(() => {
                            ...
                            }, [t, r, s, l, D, d, k, N, T, C, R, S, w]),
                            G = U.computedStyle,
                            W = U.computedClassNames;
                        return n().createElement('div', Eu({ className: o()(iu.base, ...W, e), style: G }, I), H);
                    });
                var Du = t(3649);
                const _u = ({ binding: u, text: e = '', classMix: t, alignment: r = Du.v2.left }) =>
                    null === e
                ...
                const hu = Object.keys(cu()),
                    ...
                    Su = nu((u) => {
                        ...
                        return n().createElement(
                            ...
                            Cu(
                                {
                                    className: o()(Bu.base, t && Bu[t], p, r),
                                    style: g,
                                    mt: !0 === A ? bu[t || 'paragraph-P16'].mt : A,
                            ...
                            void 0 !== m ? n().createElement(_u, Cu({}, m, { text: e })) : e,
                        );
                    }),
                    xu = (0, a.memo)(({ text: u, isLabelVisible: e }) => {
                        const t = o()('GuaranteedRewardLabel_base_55', !e && 'GuaranteedRewardLabel_base__hidden_3d');
                        return n().createElement(
                            'div',
                            { className: t },
                            n().createElement(Su, { text: u, className: 'GuaranteedRewardLabel_title_c1' }),
                        );
                    }),
                    wu = R.strings.gui_lootboxes.videoreward,
                    Tu = (0, a.memo)(
                        ({
                            firstVideoRes: u,
                            secondVideoRes: e,
                            ...
                            return n().createElement(
                                ...
                                i && n().createElement(xu, { text: wu.description.commonText(), isLabelVisible: A }),
                            );
                        },
                    ),
                    Mu = {
                ...
                const Ou = ({
                    ...
                    const B = (0, a.useRef)(null),
                        ...
                        H = o()(Mu.state, Mu.state__default);
                    return (
                        (0, a.useEffect)(
                            () => (
                ...
                Ou.defaultProps = { type: Lu.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const yu = (0, a.memo)(Ou),
                    ...
                    Hu = 'Footer_title_e7',
                    Iu = R.strings.gui_lootboxes.videoreward,
                    Uu = (0, a.memo)(({ reward: u, guaranteedRewardText: e, onFooterButtonClick: t }) => {
                        const r = (0, A.GS)().mediaSize < A.cJ.Medium ? Ru.small : Ru.medium;
                        return n().createElement(
                            'div',
                            ...
                            n().createElement(
                                ...
                                Boolean(e.length) &&
                                    n().createElement(Su, { text: e, className: 'Footer_guaranteedTitle_29' }),
                                ((u) => {
                                    const e = u.label;
                                    if (u.name === g.Vehicles) {
                                        const r = u.isElite,
                                            a = u.vehicleType,
                                            i = u.vehicleLvl,
                                            o = `R.images.gui.maps.icons.vehicleTypes.big.${r ? (0, Du.BN)(a) + '_elite' : (0, Du.BN)(a)}`;
                                        return (
                                            u.name === g.Vehicles &&
                                            n().createElement(
                                                'div',
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        yu,
                                        { type: Lu.primary, size: r, mixClass: 'Footer_button_4d', onClick: t },
                                        n().createElement(Su, { text: Iu.button.title() }),
                                    ),
                                ),
                            ),
                        );
                    }),
                    Gu = R.strings.gui_lootboxes.videoreward,
                    Wu = (0, a.memo)(
                        ({
                            firstVideoRes: u,
                            secondVideoRes: e,
                            ...
                            return n().createElement(
                                ...
                                E && n().createElement(xu, { text: Gu.description.vehicleText(), isLabelVisible: D }),
                                n().createElement(
                                    'div',
                                    {
                                        className: o()(
                                    ...
                                    n().createElement(Uu, {
                                        reward: s,
                                        guaranteedRewardText: E ? Gu.description.commonText() : '',
                                        onFooterButtonClick: A,
                                    }),
                                ),
                            );
                        },
                    ...
                    ju = (0, H.Pi)(() => {
                        ...
                        const h = (0, a.useCallback)(
                                ...
                                switch (u.name) {
                                    case g.Vehicles:
                                        return n().createElement(Wu, {
                                            reward: Object.assign({}, u, { isElite: s, vehicleType: A, vehicleLvl: l }),
                                            firstVideoRes: Vu.firstVideo.videoPath,
                                            firstVideoDuration: Vu.firstVideo.duration,
                                            secondVideoDuration: Vu.secondVideo.duration,
                                            secondVideoRes: Vu.secondVideo.videoPath(_),
                                            isGuaranteedReward: E,
                                            isWindowAccessible: i,
                                    ...
                                    default:
                                        return n().createElement(K, {
                                            videoRes: Vu.secondVideo.videoPath(_),
                                            isWindowAccessible: i,
                                            onVideoEnded: e.close,
                                            onVideoStarted: e.videoStarted,
                                        });
                            ...
                            [e.close, e.videoStarted, s, E, i, l, A, _],
                        );
                        return n().createElement(
                            'div',
                ...
                engine.whenReady.then(() => {
                    h().render(
                        n().createElement(X, null, n().createElement(m, null, n().createElement(ju, null))),
                    ...
                    _ = i().memo(function ({
                        ...
                        const m = (0, n.useRef)(null),
                            ...
                            S = (0, n.useCallback)(() => {
                                ...
                                u &&
                                    (o
                                        ? ((u.currentTime = u.duration - _), u.removeEventListener('play', f), u.play())
                                        : (u.pause(), c && c()));
                            }, [u, f, o, _, c]);
                        return (
                            (0, n.useEffect)(() => {
                                const u = m.current;
                                return (
                                    u && (u.addEventListener('play', f), u.addEventListener('ended', S)),
                                    () => {
                                        u && (u.removeEventListener('play', f), u.removeEventListener('ended', S));
                                    }
                                );
                            }, [u, S, f]),
                            (0, n.useEffect)(() => {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(9533));
