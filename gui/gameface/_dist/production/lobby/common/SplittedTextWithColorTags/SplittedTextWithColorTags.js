        ...
        F = {
            280: (u, F, A) => {
                ...
                var E = A(6179),
                    ...
                    e = A(3649),
                    t = A(5287);
                const r = ({ binding: u, text: F = '', classMix: A, alignment: B = e.v2.left }) =>
                    null === F
                        ...
                        : D().createElement(
                              ...
                              F.split('\n').map((F, r) =>
                                  D().createElement(
                                      'div',
                                      { className: C()(t.Z.base, A), key: `${F}-${r}` },
                                      (0, e.Uw)(F, B, u).map((u, F) =>
                                          D().createElement(E.Fragment, { key: `${F}-${u}` }, u),
                                      ),
                                  ),
                              ),
                          );
            ...
            3649: (u, F, A) => {
                ...
                const D = (u, F, A) => {
                    ...
                    C = (u, F, A = E.left) => u.split(F).reduce(A === E.left ? D : B, []),
                    e = (() => {
                        const u = new RegExp(
                                      ...
                                      return t.includes(A)
                                          ...
                                          : ((u, F = E.left) => {
                                                ...
                                                const D =
                                                    ...
                                                    B = u.replace(/&nbsp;/g, ' ');
                                                return (
                                                    C(B, /( )/, F).forEach((u) => (A = A.concat(C(u, D, E.left)))),
                                                    A
                                                );
                                            })(u, F);
                                  })(u, F),
            ...
            7075: (u, F, A) => {
                ...
                const C = {
                    ...
                    t = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    r = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/;
                (0, D.memo)(({ text: u, binding: F, classMix: A }) => {
                    const l = (0, D.useCallback)((u) => ({ color: `#${u}` }), []),
                        o = (0, D.useMemo)(() => F || {}, [F]);
                    let a = e.exec(u),
                        i = u,
                        n = 0;
                    ...
                    return B().createElement(E.z, { text: i, classMix: A, binding: o });
                });
            },
            5287: (u, F, A) => {
                A.d(F, { Z: () => E });
        ...
        (E.O = (F, A, D, B) => {
            if (!A) {
                ...
                for (l = 0; l < u.length; l++) {
                    for (var [A, D, B] = u[l], e = !0, t = 0; t < A.length; t++)
            ...
            B = B || 0;
            for (var l = u.length; l > 0 && u[l - 1][2] > B; l--) u[l] = u[l - 1];
            u[l] = [A, D, B];
        }),
        (E.n = (u) => {
