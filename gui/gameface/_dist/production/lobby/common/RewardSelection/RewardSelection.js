(() => {
    var __webpack_modules__ = {
            ...
            8427: (e, u, t) => {
                ...
                var n = {};
                t.r(n), t.d(n, { Area: () => Cu, Bar: () => gu, Default: () => Bu, useVerticalScrollApi: () => ru });
                var a = t(7363),
                    i = t.n(a);
                const s = (e, u, t) =>
                ...
                const L = {
                    ...
                    O = (e) => {
                        ...
                        const n = y(),
                            ...
                            s = n.mediaHeight,
                            o = n.mediaSize;
                        return i().createElement('div', x({ className: h()(t, L[a], P[s], M[o]) }, r), u);
                    },
                    k = ['children'];
                const N = (e) => {
                    let u = e.children,
                ...
                const K = ((e, u) => {
                        ...
                        ({ observableModel: e }) => {
                            const u = {
                                ...
                                t = (0, Y.Om)((e) => j(u.tabs.get(), e), { equals: W }),
                                r = (0, Y.Om)((e) => j(u.rewards.get(), e), { equals: W }),
                                n = (0, Y.Om)(() => q(u.tabs.get(), (e, u) => e + u.limit, 0));
                        ...
                        const h = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, a.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (le(t, _, { isMouseEvent: !0, on: !0, arguments: oe(r) }, f),
                                    B && B(),
                ...
                const fe = (e, u = 's180x135', t = 'R.images.gui.maps.icons.selectableReward.reward') =>
                    ...
                    we = (0, I.Pi)(({ index: e, className: u, classNames: t }) => {
                        const r = y().mediaSize,
                            n = Z(),
                            a = n.model,
                            s = n.controls,
                        ...
                        return i().createElement(
                            'div',
                            {
                                className: h()(
                                    ve.base,
                                    d && ve.base__completed,
                                    E ? ve.base__selected : c.count && ve[`base__${l}`],
                                    u,
                                ),
                                onClick: () => {
                                    o.O.sound.play.sound('bp_click'), s.openTab(c.type);
                                },
                                onMouseEnter: () => o.O.sound.play.sound('bp_highlight'),
                            },
                            i().createElement('div', { className: h()(ve.glow, E && ve.glow__show) }),
                            i().createElement(
                                'div',
                                { className: h()(ve.title, null == t ? void 0 : t.title) },
                                Ae(
                                    ((e, u) => {
                            ...
                            i().createElement(
                                ...
                                i().createElement(
                                    ...
                                    i().createElement('div', {
                                        className: ve.image,
                                        style: { backgroundImage: `url(${pe(c.type, m, _)})` },
                                    }),
                                    i().createElement('div', { className: ve.check }),
                                ),
                            ),
                            i().createElement(
                                'div',
                                { className: ve.counter },
                                Ae(be.counter(), { count: c.count, limit: c.limit }),
                            ),
                        );
                    }),
                    Se = (e) => {
                ...
                function Te(e) {
                    ...
                    return (
                        ...
                        (0, a.useCallback)((...e) => (0, u.current)(...e), Re)
                    );
                }
                function xe(e, u, t = []) {
                ...
                const Ie = {
                    ...
                    He = ({
                        ...
                        return (o = {}) => {
                            const l = o.settings,
                                ...
                                _ = (() => {
                                    const e = (0, a.useMemo)(() => ({}), []),
                                        ...
                                        n = (e, ...t) => {
                                            for (var r, n = Pe(u(e).values()); !(r = n()).done; ) (0, r.value)(...t);
                                        };
                            ...
                            return (0, a.useMemo)(
                                ...
                                [g.scrollPosition, C, p, _.off, _.on, v, h, D, c.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    We = He({
                    ...
                    Je = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Ke, onDrag: r = Ze }) => {
                        const n = (0, a.useRef)(null),
                            ...
                            g = () => {
                                ...
                                const a = e.animationScroll.scrollPosition.get(),
                                    i = Math.min(1, r / n),
                                    o = ye(0, 1, a / (n - r)),
                                    E = (u.offsetWidth - Qe(u, i)) * o;
                                (t.style.transform = `translateX(${0 | E}px)`),
                                    ((e) => {
                                        if (s.current && l.current && c.current && d.current) {
                                            if (0 === e)
                                                return s.current.classList.add(Ye), void l.current.classList.remove(Ye);
                                            if (
                                                ((u = c.current),
                                                (t = d.current),
                                                e - (u.offsetWidth - t.offsetWidth) >= -0.5)
                                            )
                                                return s.current.classList.remove(Ye), void l.current.classList.add(Ye);
                                            var u, t;
                            ...
                            D = Te(() => {
                                (() => {
                                    ...
                                    (u.style.width = `${Qe(t, i)}px`),
                                        ...
                                        n.current &&
                                            (1 === i ? n.current.classList.add(ze) : n.current.classList.remove(ze));
                                })(),
                                    g();
                            });
                        (0, a.useEffect)(() => Se(D)),
                        ...
                        const f = (e) => {
                            e.target.classList.contains(Ye) || Le('highlight');
                        };
                        return i().createElement(
                            'div',
                            { className: h()(Ue, u.base), ref: n, onWheel: e.handleMouseWheel },
                            i().createElement('div', {
                                className: h()(Ge, u.leftButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Ye) || 0 !== e.button || (Le('play'), C(Ne.Next));
                                },
                                onMouseUp: p,
                                ref: s,
                                onMouseEnter: f,
                            ...
                            i().createElement(
                                'div',
                                {
                                    className: h()(Ve, u.track),
                                    onMouseDown: (u) => {
                                        const r = d.current;
                                        if (r && 0 === u.button)
                                            if ((Le('play'), u.target === r))
                                                ...
                                                })(u.screenX > r.getBoundingClientRect().x ? Ne.Prev : Ne.Next);
                                            }
                                    },
                                    ref: c,
                                    onMouseEnter: f,
                                },
                                i().createElement('div', { ref: d, className: h()(je, u.thumb) }),
                                i().createElement('div', { className: h()(qe, u.rail) }),
                            ),
                            i().createElement('div', {
                                className: h()($e, u.rightButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Ye) || 0 !== e.button || (Le('play'), C(Ne.Prev));
                                },
                                onMouseUp: p,
                                ref: l,
                                onMouseEnter: f,
                    ...
                    uu = ({
                        ...
                        const d = (0, a.useMemo)(() => {
                                const e = r || {};
                                return Object.assign({}, e, { base: h()(eu.base, e.base) });
                            }, [r]),
                            E = (0, a.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
                        return i().createElement(
                            'div',
                            { className: h()(eu.defaultScroll, t), onWheel: u.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: h()(eu.defaultScrollArea, n) },
                                i().createElement(tu, { className: o, api: E, classNames: s }, e),
                            ),
                            i().createElement(Je, { getStepByRailClick: l, api: u, onDrag: c, classNames: d }),
                        );
                    },
                    tu = ({ api: e, className: u, classNames: t, children: r }) => (
                        (0, a.useEffect)(() => Se(e.recalculateContent)),
                        i().createElement(
                            'div',
                            { className: h()(eu.base, u) },
                            i().createElement(
                                'div',
                                {
                                ...
                                i().createElement(
                                    'div',
                                    { className: h()(eu.content, null == t ? void 0 : t.content), ref: e.contentRef },
                                    r,
                                ),
                            ),
                        )
                ...
                const ru = He({
                    ...
                    gu = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = _u, onDrag: r = Eu }) => {
                        const n = (0, a.useRef)(null),
                            s = (0, a.useRef)(null),
                            l = (0, a.useRef)(null),
                            c = (0, a.useRef)(null),
                            ...
                            D = Te(() => {
                                ...
                                const a = e.animationScroll.scrollPosition.get(),
                                    i = Math.min(1, r / n),
                                    o = ye(0, 1, a / (n - r)),
                                    E = (u.offsetHeight - Fu(u, i)) * o;
                                (t.style.transform = `translateY(${0 | E}px)`),
                                    ((e) => {
                                        if (s.current && l.current && c.current && d.current) {
                                            if (0 === Math.round(e))
                                                return s.current.classList.add(du), void l.current.classList.remove(du);
                                            if (
                                                ((u = c.current),
                                                (t = d.current),
                                                e - (u.offsetHeight - t.offsetHeight) >= -0.5)
                                            )
                                                return s.current.classList.remove(du), void l.current.classList.add(du);
                                            var u, t;
                                            s.current.classList.remove(du), l.current.classList.remove(du);
                                        }
                                    })(E);
                            }),
                            B = Te(() => {
                        ...
                        const C = xe((u) => e.applyStepTo(u), E, [e]),
                            p = C[0],
                            f = C[1];
                        (0, a.useEffect)(
                            () => (
                        ...
                        const v = (e) => {
                            e.target.classList.contains(du) || Le('highlight');
                        };
                        return i().createElement(
                            'div',
                            { className: h()(nu, u.base), ref: n, onWheel: e.handleMouseWheel },
                            i().createElement('div', {
                                className: h()(iu, u.topButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(du) || 0 !== e.button || (Le('play'), p(Ne.Next));
                                },
                                ref: s,
                                onMouseEnter: v,
                            }),
                                    ...
                                    onMouseDown: (u) => {
                                        ...
                                        if (r && 0 === u.button)
                                            if ((Le('play'), u.target === r))
                                                ...
                                                })(u.screenY > r.getBoundingClientRect().y ? Ne.Prev : Ne.Next);
                                            }
                                    },
                                    ref: c,
                                    onMouseEnter: v,
                                },
                                i().createElement('div', { ref: d, className: h()(lu, u.thumb) }),
                                i().createElement('div', { className: h()(cu, u.rail) }),
                            ),
                            i().createElement('div', {
                                className: h()(su, u.bottomButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(du) || 0 !== e.button || (Le('play'), p(Ne.Prev));
                                },
                                onMouseUp: f,
                                ref: l,
                                onMouseEnter: v,
                    ...
                    Bu = ({
                        ...
                        const d = (0, a.useMemo)(() => {
                                const e = r || {};
                                return Object.assign({}, e, { base: h()(Du.base, e.base) });
                            }, [r]),
                            E = (0, a.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
                        return i().createElement(
                            'div',
                            { className: h()(Du.defaultScroll, t), onWheel: u.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: h()(Du.area, n) },
                                i().createElement(Cu, { className: s, classNames: o, api: E }, e),
                            ),
                            i().createElement(gu, { getStepByRailClick: l, api: u, onDrag: c, classNames: d }),
                        );
                    },
                    Cu = ({ className: e, classNames: u, children: t, api: r }) => (
                        (0, a.useEffect)(() => Se(r.recalculateContent)),
                        i().createElement(
                            'div',
                            { className: h()(Du.base, e), ref: r.wrapperRef, onWheel: r.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: h()(Du.content, null == u ? void 0 : u.content), ref: r.contentRef },
                                t,
                            ),
                        )
                    );
                ...
                const xu = ({ type: e = Tu.Plus, isEnabled: u = !0, onClick: t }) =>
                        i().createElement('div', {
                            className: h()(Ru.base, Ru[`base__${e}`], !u && Ru.base__disabled),
                            onClick: (e) => {
                                e.stopPropagation(), u && t(e);
                            },
                        }),
                    Lu = R.strings.selectable_reward.reward,
                    Pu = (0, I.Pi)(({ index: e }) => {
                        const u = Z(),
                            t = u.model,
                            r = u.controls,
                        ...
                        return i().createElement(
                            'div',
                            {
                                className: h()(
                                    yu.base,
                                    A && yu.base__selected,
                                    F && yu.base__accepting,
                                    yu[`base__${((D = c), D.replace(/_\w/g, (e) => e[1].toUpperCase()))}`],
                                ),
                                onClick: () => {
                                    c === wu
                                        ? (o.O.sound.play.sound('bp_click'), m(s))
                                        : c === Su && o.O.sound.play.sound('bp_click_limit');
                                },
                                onMouseEnter: () => o.O.sound.play.sound('bp_highlight'),
                            },
                            i().createElement(
                                'div',
                                { className: h()(yu.storage, d <= 0 && yu.storage__hidden) },
                                i().createElement('div', { className: yu.storageIcon }),
                                d,
                            ),
                            i().createElement(
                                me,
                                ...
                                i().createElement(
                                    ...
                                    i().createElement('div', {
                                        className: yu.image,
                                        style: { backgroundImage: `url(${fe(s)})` },
                                    }),
                                    g !== De.None &&
                                        i().createElement('div', {
                                            className: yu.optDeviceType,
                                            style: { backgroundImage: `url(${he(s, g)})` },
                                        }),
                                    !A &&
                                        c !== wu &&
                                        i().createElement('div', {
                                            className: yu.disabled,
                                            style: { maskImage: `url(${fe(s)})` },
                                        }),
                                    E > 1 &&
                                        i().createElement(
                                            'div',
                                            { className: yu.packSize },
                                            Ae(Lu.packSizeCount(), { packSize: E }),
                                        ),
                                ),
                            ),
                            i().createElement(
                            ...
                            A || c === wu
                                ? i().createElement(
                                      i().Fragment,
                                      null,
                                      i().createElement('span', { className: yu.countText }, l),
                                      i().createElement(
                                          'div',
                                          { className: yu.select },
                                          i().createElement(xu, {
                                              ...
                                              isEnabled: A,
                                              onClick: () => {
                                                  o.O.sound.play.sound('bp_click_minus'), _(s);
                                              },
                                          }),
                                          i().createElement(xu, {
                                              type: Tu.Plus,
                                              isEnabled: c === wu,
                                              onClick: () => {
                                                  c === wu && (o.O.sound.play.sound('bp_click_plus'), m(s));
                                              },
                                          }),
                                      ),
                                  )
                                : i().createElement(
                                      ...
                                      c === Su && 0 === l
                                          ? {
                                                header: Lu.tooltip.state_limited.header(),
                                                body: Lu.tooltip.state_limited.body(),
                                            }
                                          : { isEnabled: !1 },
                                      i().createElement(
                                          'div',
                                          { className: yu.state },
                                          i().createElement('div', { className: yu.stateText }, Lu.$dyn(c)),
                                          i().createElement('div', { className: yu.stateIcon }),
                                      ),
                                  ),
                            i().createElement('div', { className: yu.glow }),
                        );
                        var D;
                    }),
                    Mu = 'ContentGrid_base_59',
                    Ou = 'ContentGrid_scrollArea_e0',
                    ku = 'ContentGrid_scrollAreaInner_ba',
                    Nu = 'ContentGrid_reward_68',
                    Iu = {
                        base: 'Lip_base_57',
                ...
                const Wu = ({ position: e, visible: u }) =>
                        i().createElement('div', { className: h()(Iu.base, Iu[`base__${e}`], u && Iu.base__show) }),
                    Uu = (0, I.Pi)(({ className: e }) => {
                        const u = Z().model,
                            ...
                            i().createElement(
                                ...
                                'hidden' !== o &&
                                    i().createElement(
                                        i().Fragment,
                                        null,
                                        i().createElement(Wu, { position: Hu.Top, visible: 'start' !== o }),
                                        i().createElement(Wu, { position: Hu.Bottom, visible: 'end' !== o }),
                                    ),
                            )
                        );
                    }),
                        ...
                        i().createElement(
                            ...
                            r !== Gu.ghost &&
                                i().createElement(
                                    i().Fragment,
                                    null,
                                    i().createElement('div', { className: zu.back }),
                                    i().createElement('span', { className: zu.texture }),
                                ),
                            i().createElement(
                                'span',
                                { className: h()(zu.state, zu.state__default) },
                                i().createElement('span', { className: zu.stateDisabled }),
                                i().createElement('span', { className: zu.stateHighlightHover }),
                                i().createElement('span', { className: zu.stateHighlightActive }),
                            ),
                            i().createElement(
                                'span',
                ...
                Vu.defaultProps = { type: Gu.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const ju = Vu;
                function qu() {
                ...
                const Yu = 'Footer_base_78',
                    Xu = 'Footer_description_7a',
                    Ku = 'Footer_selectRewards_b0',
                    Zu = 'Footer_rewardsSelected_06',
                    Qu = 'Footer_rewardsSelectedCount_af',
                    Ju = 'Footer_rewardsSelectedIcon_83',
                    et = 'Footer_buttons_10',
                    ut = 'Footer_cButton_fe',
                    tt = (0, I.Pi)(({ buttonsSize: e, classNames: u }) => {
                        const t = Z(),
                            r = t.model,
                            n = t.controls,
                            ...
                            s = a > 0,
                            o = y().mediaSize,
                            l = null != e ? e : ((e) => (e > b.Small ? $u.medium : $u.small))(o),
                            c = h()(ut, null == u ? void 0 : u.button),
                            d = qu(),
                        ...
                        return i().createElement(
                            ...
                            i().createElement(
                                ...
                                s
                                    ? i().createElement(
                                          ...
                                          i().createElement('span', { className: Qu }, a),
                                          i().createElement(
                                              ce,
                                              {
                                                  contentId:
                            ...
                            i().createElement(
                                ...
                                i().createElement(
                                    ju,
                                    { size: l, type: Gu.secondary, mixClass: c, onClick: n.close },
                    ...
                    nt = (0, I.Pi)(({ title: e, subTitle: u, classNames: t, buttonsSize: r }) => {
                        ...
                        return (
                            ...
                            i().createElement(
                                'div',
                                { className: h()(rt.base, rt[`base__${d}`]) },
                                i().createElement(
                                    'div',
                                    { className: h()(rt.heading, null == t ? void 0 : t.heading) },
                                    i().createElement(
                                        'div',
                                        { className: h()(rt.title, null == t ? void 0 : t.title) },
                                        e,
                                    ),
                                    i().createElement(
                                        'div',
                                        { className: h()(rt.subTitle, null == t ? void 0 : t.subTitle) },
                                        u,
                                    ),
                                ),
                                i().createElement(
                                    'div',
                                    { className: h()(rt.wrapper, s && rt.wrapper__shown) },
                                    i().createElement(
                                        'div',
                                        { className: rt.categories },
                                        H(c.length, (e) =>
                                            i().createElement(we, {
                                                key: e,
                                                index: e,
                                    ...
                                    i().createElement(Uu, { className: null == t ? void 0 : t.contentGrid }),
                                ),
                                i().createElement(
                                    'div',
                                    { className: h()(rt.footer, null == t ? void 0 : t.footer) },
                                    i().createElement(tt, {
                                        buttonsSize: r,
                    ...
                    it = 'Error_image_a8',
                    st = 'Error_title_49',
                    ot = 'Error_description_4f',
                    lt = 'Error_footer_2d',
                    ct = 'Error_button_4d',
                    dt = R.strings.selectable_reward.error,
                    Et = (0, I.Pi)(() => {
                        const e = Z().controls;
                        return i().createElement(
                            'div',
                            ...
                            i().createElement('div', { className: st }, dt.title()),
                            i().createElement('div', { className: ot }, dt.description()),
                            i().createElement(
                                'div',
                                { className: lt },
                                i().createElement(
                                    ju,
                                    { mixClass: ct, type: Gu.primary, size: $u.medium, onClick: e.close },
                                    dt.button(),
                                ),
                            ),
                        );
                    }),
                    mt = 'RewardSelection_base_0f';
                (0, I.Pi)(({ title: e, subTitle: u, classNames: t, buttonsSize: r }) => {
                    ...
                    return i().createElement(
                        ...
                        { className: mt },
                        n.length > 0
                            ? i().createElement(nt, { title: e, subTitle: u, classNames: t, buttonsSize: r })
