        ...
        e = {
                        ...
                        let e = u.className,
                            ...
                            H =
                                void 0 === R
                                    ...
                                    : R,
                            T = u.alignItems,
                            O = void 0 === T ? (S ? 'flex-start' : w && 'center') || (b && 'flex-end') || void 0 : T,
                            y = u.alignSelf,
                            P = u.wrap,
                            W = u.flexWrap,
                            ...
                            Z = u.shrink,
                            N = u.flex,
                            X = void 0 === N ? (j || Z ? `${j ? 1 : 0} ${Z ? 1 : 0} auto` : void 0) : N,
                            z = u.style,
                            I = u.children,
                            k = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const U = (0, r.useMemo)(() => {
                                const u = { mt: B, mr: d, mb: _, ml: h },
                                    e = ((u) =>
                                        m.reduce((e, A) => {
                                            const E = u[A];
                                            return E && 'number' != typeof E ? e.concat(l[!0 === E ? 'MD' : E][A]) : e;
                                        }, []))(u),
                                    F = ((u) =>
                                        m.reduce((e, A) => {
                                            const E = u[A];
                                            return ('number' == typeof E && (e[s[A]] = E + 'rem'), e);
                                        }, {}))(u);
                                return {
                                    computedStyle: Object.assign({}, z, F, {
                            ...
                            }, [A, E, B, d, _, h, z, X, y, p, G, H, O]),
                            Y = U.computedStyle,
                            K = U.computedClassNames;
                        return a().createElement('div', n({ className: F()(C.Z.base, ...K, e), style: Y }, k), I);
                    });
            },
            280: (u, e, A) => {
                'use strict';
                ...
                var E = A(6179),
                    ...
                    B = A(3649),
                    r = A(5287);
                const a = ({ binding: u, text: e = '', classMix: A, alignment: t = B.v2.left }) =>
                    null === e
                        ...
                        : F().createElement(
                              ...
                              e.split('\n').map((e, a) =>
                                  F().createElement(
                                      'div',
                                      { className: D()(r.Z.base, A), key: `${e}-${a}` },
                                      (0, B.Uw)(e, t, u).map((u, e) =>
            ...
            3495: (u, e, A) => {
                ...
                var E = A(3138),
                    ...
                    t = A(1043),
                    D = A(5262);
                const B = E.O.client.getSize('rem'),
                    r = B.width,
                    a = B.height,
                    C = Object.assign({ width: r, height: a }, (0, D.T)(r, a, t.j)),
                    i = (0, F.createContext)(C);
            },
            1039: (u, e, A) => {
                'use strict';
                var E = A(6179),
                    ...
                    a = A(3138);
                (0, E.memo)(({ children: u }) => {
                    const e = (0, E.useContext)(D.Y),
                        A = (0, E.useState)(e),
                        C = A[0],
                        i = A[1],
                        n = (0, E.useCallback)((u, e) => {
                            const A = a.O.view.pxToRem(u),
                                E = a.O.view.pxToRem(e);
                            i(Object.assign({ width: A, height: E }, (0, r.T)(A, E, B.j)));
                        }, []);
                    ((0, t.Z)(() => {
                        engine.on('clientResized', n);
                    }),
                        (0, E.useEffect)(() => () => engine.off('clientResized', n), [n]));
                    const l = (0, E.useMemo)(() => Object.assign({}, C), [C]);
                    return F().createElement(D.Y.Provider, { value: l }, u);
                });
            },
            6010: (u, e, A) => {
                'use strict';
                ...
                const D = ['children'],
                    B = (u) => {
                        ...
                        const B = (0, E.useContext)(t.Y),
                            ...
                            v = { extraLarge: g, large: _, medium: c, small: h, extraSmall: x };
                        if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
                            if (A.extraLarge && r) return e;
                            if (A.large && a) return e;
                            if (A.medium && C) return e;
                            ...
                            if (A.extraSmallWidth && d) return (0, F.H)(e, A, v);
                            if (!(
                                A.extraLargeWidth ||
                                A.largeWidth ||
                                A.mediumWidth ||
                    ...
                    v = (0, i.ZP)((u) => {
                        ...
                        const w = (0, n.useMemo)(() => {
                                const u = x(B),
                                    ...
                                    A = u.colorStyle,
                                    E = void 0 === A ? {} : A;
                                return { computedStyle: Object.assign({}, f, E), colorClassName: e };
                            }, [f, B]),
                            b = w.computedStyle,
                            L = w.colorClassName;
                        return l().createElement(
                            ...
                            o(
                                {
                                    className: F()(m.Z.base, A && m.Z[A], L, E),
                                    style: b,
                                    mt: !0 === C ? h[A || 'paragraph-P16'].mt : C,
                                    mr: !0 === d ? h[A || 'paragraph-P16'].mr : d,
                                    mb: !0 === _ ? h[A || 'paragraph-P16'].mb : _,
                                    ml: !0 === v ? h[A || 'paragraph-P16'].ml : v,
                                },
                                S,
                            ),
            ...
            527: (u, e, A) => {
                'use strict';
                (A.r(e), A.d(e, { mouse: () => B, onResize: () => t }));
                var E = A(2472),
                    F = A(1176);
            ...
            3377: (u, e, A) => {
                ...
                const D = ['xl', 'lg', 'md', 'sm', 'xs'],
                    B = (u) => u.includes('_') && ((u) => D.includes(u))(u.split('_').at(-1)),
                    r = [E.cJ.ExtraLarge, E.cJ.Large, E.cJ.Medium, E.cJ.Small, E.cJ.ExtraSmall],
                    a = (u, e) =>
                        Object.keys(u).reduce((A, E) => {
                            if (E in A) return A;
                            if (B(E)) {
                                const F = E.split('_').slice(0, -1).join('_');
                                if (F in A) return A;
                                const t = r.indexOf(e),
                                    B = (-1 !== t ? D.slice(t) : [])
                                        .map((u) => F + '_' + u)
                                        .find((e) => void 0 !== u[e]),
                                    a = B ? u[B] : void 0;
                                return ((A[F] = void 0 !== a ? a : u[F]), A);
                            }
                            const F = u[E];
                            return (
                                void 0 === F ||
                                    ((u, e) => D.some((A) => void 0 !== e[`${u}_${A}`]))(E, u) ||
                                    (A[E] = F),
                                A
                            );
                        }, {}),
                    C = (u, e = a) => {
                        const A = (
                            (u, e = a) =>
                            (A) => {
                                const D = (0, E.GS)().mediaSize,
                                    B = (0, F.useMemo)(() => e(A, D), [A, D]);
                                return t().createElement(u, B);
                            }
                        )(u, e);
                        return t().memo((e) =>
            ...
            5415: (u, e, A) => {
                ...
                let D, B, r;
                (!(function (u) {
                    ((u[(u.ExtraSmall = t.j.extraSmall.width)] = 'ExtraSmall'),
                        (u[(u.Small = t.j.small.width)] = 'Small'),
                        (u[(u.Medium = t.j.medium.width)] = 'Medium'),
                        (u[(u.Large = t.j.large.width)] = 'Large'),
                        (u[(u.ExtraLarge = t.j.extraLarge.width)] = 'ExtraLarge'));
                })(D || (D = {})),
                    (function (u) {
                        ((u[(u.ExtraSmall = t.j.extraSmall.width)] = 'ExtraSmall'),
                            (u[(u.Small = t.j.small.width)] = 'Small'),
                    ...
                    (function (u) {
                        ((u[(u.ExtraSmall = t.j.extraSmall.height)] = 'ExtraSmall'),
                            (u[(u.Small = t.j.small.height)] = 'Small'),
                            (u[(u.Medium = t.j.medium.height)] = 'Medium'),
                            (u[(u.Large = t.j.large.height)] = 'Large'),
                            (u[(u.ExtraLarge = t.j.extraLarge.height)] = 'ExtraLarge'));
                    })(r || (r = {})));
                const a = () => {
                    const u = (0, E.useContext)(F.YN),
                        e = u.width,
                        A = u.height,
                        t = ((u) => {
                            switch (!0) {
                    ...
                    return { mediaSize: t, mediaWidth: a, mediaHeight: C, remScreenWidth: e, remScreenHeight: A };
                };
            },
            3649: (u, e, A) => {
                'use strict';
                ...
                const F = (u, e, A) => {
                    ...
                    D = (u, e, A = E.left) => u.split(e).reduce(A === E.left ? F : t, []),
                    B = (() => {
                        const u = new RegExp(
                                      ...
                                      return r.includes(A)
                                          ...
                                          : ((u, e = E.left) => {
                                                ...
                                                const F =
                                                    ...
                                                    t = u.replace(/&nbsp;/g, ' ');
                                                return (
                                                    D(t, /( )/, e).forEach((u) => (A = A.concat(D(u, F, E.left)))),
                                                    A
                                                );
                                            })(u, e);
                                  })(u, e),
            ...
            4042: (u, e, A) => {
                ...
                var E = A(7613),
                    F = A(6179),
                    t = A.n(F);
                (0, F.memo)(({ title: u, subTitle: e }) =>
                    t().createElement(
                        'div',
                        { className: 'ErrorScreen_base_31' },
                        t().createElement('div', { className: 'ErrorScreen_icon_d1' }),
                        t().createElement(E.ZP, { text: u, format: { classMix: 'ErrorScreen_title_a3' } }),
                        t().createElement(E.ZP, { text: e, format: { classMix: 'ErrorScreen_subTitle_6d' } }),
                    ),
                );
            },
            5026: (u, e, A) => {
        ...
        (E.O = (e, A, F, t) => {
            if (!A) {
                ...
                for (C = 0; C < u.length; C++) {
                    for (var [A, F, t] = u[C], B = !0, r = 0; r < A.length; r++)
                        (!1 & t || D >= t) && Object.keys(E.O).every((u) => E.O[u](A[r]))
                            ? A.splice(r--, 1)
                            : ((B = !1), t < D && (D = t));
                    if (B) {
                        u.splice(C--, 1);
            ...
            t = t || 0;
            for (var C = u.length; C > 0 && u[C - 1][2] > t; C--) u[C] = u[C - 1];
            u[C] = [A, F, t];
        }),
        (E.n = (u) => {
        ...
        (() => {
            ...
            var e = (e, A) => {
                    var F,
                        ...
                        a = 0;
                    if (D.some((e) => 0 !== u[e])) {
                        for (F in B) E.o(B, F) && (E.m[F] = B[F]);
                        if (r) var C = r(E);
                    }
                    for (e && e(A); a < D.length; a++) ((t = D[a]), E.o(u, t) && u[t] && u[t][0](), (u[t] = 0));
                    return E.O(C);
                },
                A = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (A.forEach(e.bind(null, 0)), (A.push = e.bind(null, A.push.bind(A))));
        })());
    var F = E.O(void 0, [503], () => E(4042));
    F = E.O(F);
})();
