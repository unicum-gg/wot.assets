(() => {
    ...
    var __webpack_modules__ = {
            ...
            7475: (e, t, n) => {
                ...
                var a = n(3157),
                    o = n(8133),
                    r = n(3925);
                const i = { view: n(7553), client: a, sound: r.ZP, intl: o.N };
            },
            8133: (e, t, n) => {
                n.d(t, { N: () => a });
                const a = {
            ...
            3925: (e, t, n) => {
                ...
                const o = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    r = Object.keys(o).reduce((e, t) => ((e[t] = () => (0, a.playSound)(o[t])), e), {}),
            ...
            1308: (e, t, n) => {
                ...
                function r(e) {
                    let t = '';
                    for (let n = o.length - 1; n >= 0; n--) for (; e >= o[n];) ((t += a[n]), (e -= o[n]));
                    return t;
                }
            ...
            828: (e, t, n) => {
                ...
                const y = o.instance,
                    O = {
                        ...
                        sendShowPopOverEvent: (e, t, n, a, o = R.invalid('resId'), r) => {
            ...
            6855: (e, t, n) => {
                ...
                const v = () => (e, t) => {
                    ...
                    return [
                        function ({ mode: r = 'real', options: i, children: s, mocks: _ }) {
                            const v = (0, a.useRef)([]),
                                f = (n, a, o) => {
                                    var r;
                                    const i = (function ({
                                            ...
                                            return {
                                                ...
                                                dispose: function () {
                                                    for (var e, n = d(o.keys()); !(e = n()).done;) r(e.value, t);
                                                },
                                                unsubscribe: r,
                                            };
                                        })(a),
                                        ...
                                        b = { mode: n, model: g, externalModel: s, cleanup: f };
                                    return {
                                        model: g,
                                ...
                                E = b[0],
                                w = b[1],
                                p = (0, a.useState)(() => f(r, i, _)),
                                h = p[0],
                                y = p[1];
                            return (
                                (0, a.useEffect)(() => {
                                    g.current ? y(f(E, i, _)) : (g.current = !0);
                                }, [_, E, i]),
                                (0, a.useEffect)(() => {
                                    w(r);
                                }, [r]),
                ...
                let g = (function (e) {
                    ...
                    E = (function (e) {
                        return ((e.Initialization = 'initialization'), (e.Loaded = 'loaded'), (e.Failed = 'failed'), e);
                    })({}),
                    w = (function (e) {
                        return (
                            (e.Initialization = 'initialization'),
                ...
                (g.Initialization, b.Initialization);
                const p = (e) => e > 0,
                    h = (e) => !p(e);
                function y(e, t) {
                    var n;
                    if (h(e)) return void console.warn('Invalid id, should be greater than zero', e);
                    const a = 0 === t.scale ? 1e-5 : null != (n = t.scale) ? n : 1;
                    return u.O.view.getBrowserTexturePath(e, Math.max(t.width, 1), Math.max(t.height, 1), a);
                }
                const O = v()(
                        ({ observableModel: e }) => {
                            const t = e.object(),
                                    ...
                                    (function ({ pageState: e, browserState: t, texState: n }) {
                                        return t === g.Initialization
                                            ...
                                            : t === g.ForceLoading
                                              ...
                                              : t === g.Loading
                                                ? w.BrowserLoading
                                                : e === b.Loaded && t === g.Loaded && n === E.Loaded
                                                  ? w.Loaded
                                                  : n === E.Failed
                                                    ? w.TextureFailed
                                                    : e === b.Failed
                ...
                const P = 'BrowserView_base_bcae1',
                    N = 'BrowserView_texture_aa836';
                let S = (function (e) {
                    return (
                        (e[(e.LEFT = 0)] = 'LEFT'),
                        (e[(e.WHEEL = 1)] = 'WHEEL'),
                ...
                const I = ({
                        ...
                        return (
                            (0, a.useEffect)(() => {
                                function e(e) {
                                    E && null !== g.current && !g.current.contains(e.target) && w(!1);
                                }
                                return (
                            ...
                            o().createElement(
                                'div',
                                {
                                    ...
                                    onMouseDown: function (e) {
                                        ...
                                        (null !== f && t && B(f),
                                            c && c(e),
                                            _ && (n || (g.current && (g.current.focus(), w(!0)))),
                                            t && y(!0));
                                    },
                    ...
                    U = 'Error_base_ab572',
                    z = 'Error_alertIcon_adb9c',
                    H = 'Error_errorCaption_d44b3',
                    W = 'Error_button_cd728',
                    j = ({ errorBtnClickHandler: e, errorBtnLabel: t, errorMessage: n }) =>
                        o().createElement(
                            'div',
                            { className: U },
                            o().createElement('div', { className: z }),
                            o().createElement('div', { className: H }, n),
                            o().createElement(I, { size: D.medium, mixClass: W, onClick: e }, t),
                        ),
                    V = 'Spinner_base_c591d',
                    q = 'Spinner_caption_a27b6',
                    G = 'Spinner_gear_bc6f3',
                    K = 'Spinner_logo_a5cfa',
                    $ = ({ message: e, className: t, classNames: n }) =>
                        o().createElement(
                            'div',
                            { className: L()(V, t) },
                            e && o().createElement('div', { className: L()(q, null == n ? void 0 : n.caption) }, e),
                            o().createElement('div', { className: L()(G, null == n ? void 0 : n.gear) }),
                            o().createElement('div', { className: L()(K, null == n ? void 0 : n.logo) }),
                        ),
                    Y = 'Waiting_base_d3ab1',
                    Z = 'Waiting_blackOverlay_e2514',
                    X = ({
                        ...
                        return (
                            ...
                            o().createElement(
                                'div',
                                { className: Y },
                                o().createElement('div', { className: Z, ref: c }),
                                n
                                    ? o().createElement(j, {
                                          errorBtnLabel: i,
                                          errorMessage: r,
                    ...
                    ne = ({ waitingText: e, className: t }) =>
                        o().createElement(
                            'div',
                            { className: L()(Q, t) },
                            o().createElement(X, { errorBtnClickHandler: s, message: e }),
                        ),
                    ae = () =>
                        o().createElement(
                            'div',
                ...
                const se = ({ viewState: e, waitingText: t, waitingClassName: n }) => {
                        switch (ie(e)) {
                            ...
                            case w.PageLoading:
                            case w.ForceLoading:
                                return o().createElement(ne, { waitingText: t, className: n });
                            case w.PageFailed:
                                return o().createElement(ae, null);
                ...
                function ue(e) {
                    const t = (0, a.useState)(le(e.scale)),
                        n = t[0],
                        o = t[1],
                        r = (function (e) {
                    ...
                    return (
                        ...
                        (0, a.useEffect)(() => {
                            if (void 0 === r || 0 === u || 0 === d || r === s) return;
                            const e = () => {
                                c(r);
                            };
                ...
                const de = o().memo(function (e) {
                        ...
                        return o().createElement(
                            'div',
                            { className: L()(P, n), onMouseEnter: i, onMouseLeave: s },
                            E &&
                                o().createElement('div', {
                                    onWheel: c,
                                    onMouseMove: l,
                            ...
                            'function' == typeof _
                                ? _({ viewState: m, statusCode: v, waitingText: f, waitingClassName: r })
                                : o().createElement(se, {
                                      viewState: m,
                                      statusCode: v,
                                      waitingText: f,
                ...
                const he = (0, a.memo)(function (e) {
                        ...
                        return o().createElement(C, { options: t, mocks: n, mode: a }, o().createElement(we, r));
                    }),
                    ye = v()(
                        ({ observableModel: e }) => {
                            const t = e.object();
                ...
                const Le = (e) => {
                        ...
                        return o().createElement(
                            ...
                            'info' !== f && o().createElement('div', { className: Me.shine }),
                            o().createElement(
                                'div',
                                {
                                    className: L()(
                                ...
                                o().createElement('div', { className: L()(Me.glow, null == i ? void 0 : i.glow) }),
                            ),
                            o().createElement(
                                'div',
                                { className: L()(Me.caption, Me[`caption__${f}`], null == i ? void 0 : i.caption) },
                                t,
                            ),
                            r && o().createElement('div', { className: L()(Me.goto, null == i ? void 0 : i.goto) }, r),
                        );
                    },
                    xe = 'Closable_base_c4977',
                    Pe = 'Closable_button_b8a33',
                    Re = (0, T.Pi)(function ({ className: e, classNameButton: t, children: n }) {
                        const a = Ce(),
                            r = a.controls,
                            i = a.model;
                        return o().createElement(
                ...
                const Se = (e) => {
                    ...
                    return o().createElement(Oe, r, o().createElement(Re, { className: n, classNameButton: a }, t));
                };
                var Be = n(4020);
                n(828);
                const Fe = (e) => {
                ...
                function Ae(e = Be.n.NONE, t = Fe, n = !1, o = !1) {
                    (0, a.useEffect)(() => {
                        if (e !== Be.n.NONE)
                            return (
                ...
                const De = 'App_base_aac38',
                    Ie = 'App_closeButton_e904b',
                    Ue = v()(s, ({ externalModel: e }) => ({ close: e.createCallbackNoArgs('onClose') })),
                    ze = Ue[0],
                    He = Ue[1],
                    We = 'R.images.gui.maps.icons.common.gameface_pattern',
                    je = () => {
                        const e = He().controls;
                        return (
                            Ae(Be.n.ESCAPE, () => e.close()),
                            o().createElement(
                                'div',
                                {
                                    className: De,
                                ...
                                o().createElement(
                                    Se,
                                    { classNameButton: Ie },
                                    o().createElement(he, { isFullSize: !0, displayContentWhenLoading: !1 }),
                                ),
                            )
                        );
                        var t;
                    },
                    Ve = () => o().createElement(ze, null, o().createElement(je, null));
                engine.whenReady.then(() => {
                    i().render(o().createElement(Ve, null), document.getElementById('root'));
                });
            },
            7363: (e) => {
                e.exports = React;
        ...
        (__webpack_require__.O = (e, t, n, a) => {
            if (!t) {
                ...
                for (c = 0; c < deferred.length; c++) {
                    for (var [t, n, a] = deferred[c], r = !0, i = 0; i < t.length; i++)
                        (!1 & a || o >= a) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [127], () => __webpack_require__(6855));
