(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                const Y = Object.keys(_).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === _[e]), u), {}),
                    z = {
                        set: (u, e) => {
            ...
            93: (u, e, t) => {
                ...
                const r = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    i = (u, e, t = D.left) => u.split(e).reduce(t === D.left ? o : a, []),
                    B = (() => {
                        const u = new RegExp(
                        ...
                        return s.includes(t)
                            ...
                            : ((u, e = D.left) => {
                                  ...
                                  const E =
                                      ...
                                      A = r(u);
                                  return i(A, /( )/, e).forEach((u) => (t = t.concat(i(u, E, D.left)))), t;
                              })(u, e);
                    };
                let l;
                !(function (u) {
                        ...
                        p(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = g(u);
                                B.current = T.addCallback(E, t, D, e === b.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== b.None)
                                return () => {
                                    T.removeCallback(B.current, D);
                                };
                        }, [D, e]),
                        a
                    );
                ...
                const M = A().forwardRef(function (u, e) {
                    ...
                    U = ({ binding: u, text: e = '', classMix: t, alignment: F = D.left }) =>
                        null === e
                    ...
                    q = (0, E.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                (r = r.replace(t, `%(${D})`)),
                                    (n[D] = L[u]
                                        ? A().createElement(
                                              'span',
                                              { className: L[u] },
                                              A().createElement(U, { text: i, binding: e }),
                                          )
                                        : A().createElement(
                                              'span',
                                              { style: F(u) },
                        ...
                        return A().createElement(U, { text: r, classMix: t, binding: n });
                    });
                let V, Y, z, H, K, $, j;
                !(function (u) {
                    (u.Items = 'items'),
                    ...
                    Au = ({ type: u, rewards: e }) => {
                                ...
                                const u = {},
                                    t = e
                                        .map(({ value: e }, t) => {
                                            ...
                                            var D, o;
                                            return (
                                                (u[F] = A().createElement(U, { text: n, classMix: tu })), `${E}%(${F})s`
                                            );
                                        })
                                        .join(Eu.separator());
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                A().createElement('div', { className: eu }, A().createElement(U, F)),
                            ),
                        );
                    },
                    Fu = 'App_base_ba',
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [127], () => __webpack_require__(93));
