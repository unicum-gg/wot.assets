(() => {
    ...
    var __webpack_modules__ = {
            ...
            6333: (u, e, t) => {
                    ...
                    l = (u, e = D.left) => {
                        ...
                        return ((u, e = D.left) => {
                            ...
                            const E =
                                ...
                                A = i(u);
                            return s(A, /( )/, e).forEach((u) => (t = t.concat(s(u, E, D.left)))), t;
                        })(u, e);
                    };
                var _ = t(9916),
                    d = t(8613);
                        ...
                        v(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = f(u);
                                s.current = P.addCallback(E, t, D, e === y.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== y.None)
                ...
                const U = A().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            A().createElement(
                                'div',
                                L({}, D, {
                                    className: x()(M.base, M[`base__theme-${r}`], F),
                                    ref: function (u) {
                                        (i.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                    },
                                }),
                                A().createElement('div', { className: M.decorator }, t),
                            )
                        );
                    }),
                    I = 'FormatText_base_d0',
                    G = ({ binding: u, text: e = '', classMix: t, alignment: F = D.left, formatWithBrackets: n }) => {
                    ...
                    z = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    V = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    $ = (0, E.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                (D = D.replace(t, `%(${r})`)),
                                    (n[r] = W[u]
                                        ? A().createElement(
                                              'span',
                                              { className: W[u] },
                                              A().createElement(G, { text: a, binding: e }),
                                          )
                                        : A().createElement(
                                              'span',
                                              { style: F(u) },
                        ...
                        return A().createElement(G, { text: D, classMix: t, binding: n });
                    });
                let j, Y, X, K, H, Z, Q, J, uu;
                function eu(u) {
                    const e = u.match(/(?:_(?:t|tier))?(\d+)\b/);
                    return e ? parseInt(e[1], 10) : null;
                }
                function tu(u, e) {
                    return e && e !== uu.None ? e : u;
                }
                !(function (u) {
                    (u.Items = 'items'),
                ...
                const Eu = (u, e = X.Small, t) => {
                    if (t === uu.Modernized) {
                        const t = eu(u);
                        if (t) return `R.images.gui.maps.icons.quests.bonuses.${e}.modernized_devices_t${t}_gift`;
                    }
                    return `R.images.gui.maps.icons.quests.bonuses.${e}.${tu(u, t)}_gift`;
                };
                const Au = 'Category_base_e5',
                    Fu = 'Category_image_e5',
                    nu = 'Category_content_4f',
                    ru = 'Category_title_0e',
                    Du = 'Category_rewards_10',
                    ou = 'Category_counter_79',
                    iu = R.strings.selectable_reward.tooltips.selectedRewards.reward,
                    au = ({ type: u, rewards: e }) => {
                        const t = (0, E.useMemo)(() => ({ backgroundImage: `url(${Eu(u)})` }), [u]),
                            F = (0, E.useMemo)(() => {
                                const u = {},
                                    t = e
                                        .map(({ value: e }, t) => {
                                            ...
                                            var r, D;
                                            return (
                                                (u[F] = A().createElement(G, { text: n, classMix: ou })), `${E}%(${F})s`
                                            );
                                        })
                                        .join(iu.separator());
                        ...
                        return A().createElement(
                            'div',
                            { className: Au },
                            A().createElement('div', { className: Fu, style: t }),
                            A().createElement(
                                'div',
                                { className: nu },
                                A().createElement(
                                    ...
                                    ((u, e) => {
                                        ...
                                        return t
                                            ...
                                            : `${R.strings.selectable_reward.tabs.items.$dyn(tu(u, e))}`;
                                    })(u),
                                ),
                                A().createElement('div', { className: Du }, A().createElement(G, F)),
                            ),
                        );
                    },
                    Bu = 'App_base_ba',
                    su = 'App_title_43',
                    Cu = 'App_description_43',
                    cu = 'App_divider_36',
                    lu = 'App_category_c3',
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                A().createElement(
                                    'div',
                                    { className: su },
                                    A().createElement($, { text: _u.title(), binding: F }),
                                ),
                                A().createElement('div', { className: Cu }, _u.description()),
                                A().createElement('div', { className: cu }),
                                t.map(({ value: u }, e) =>
                                    A().createElement('div', { key: e, className: lu }, A().createElement(au, u)),
                                ),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    n().render(A().createElement(du, null), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
