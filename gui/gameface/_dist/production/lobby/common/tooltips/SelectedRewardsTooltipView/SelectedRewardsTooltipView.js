(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => i, off: () => D, on: () => r, onResize: () => A, onScaleUpdated: () => n });
                var E = t(2472),
                    F = t(1176);
            ...
            6333: (u, e, t) => {
                ...
                const i = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    s = (u, e, t = D.left) => u.split(e).reduce(t === D.left ? a : B, []),
                    C = (() => {
                        const u = new RegExp(
                    ...
                    c = (u, e = D.left) => {
                        ...
                        return ((u, e = D.left) => {
                            ...
                            const E =
                                ...
                                F = i(u);
                            return s(F, /( )/, e).forEach((u) => (t = t.concat(s(u, E, D.left)))), t;
                        })(u, e);
                    };
                var _ = t(9916),
                    d = t(8613);
                ...
                const p = (u = 1) => {
                    ...
                    f = (u) => {
                        ...
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const F = g(h(t, `${e}.${E}`), window);
                                    return v(F) ? (u.push(F.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        w(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = f(u);
                                s.current = P.addCallback(E, t, D, e === O.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== O.None)
                                return () => {
                                    P.removeCallback(s.current, D);
                                };
                        }, [D, e]),
                        a
                    );
                ...
                const U = F().forwardRef(function (u, e) {
                        let t = u.children,
                            A = u.className,
                            n = u.theme,
                        ...
                        return (
                            ...
                            F().createElement(
                                'div',
                                L({}, D, {
                                    className: x()(M.base, M[`base__theme-${r}`], A),
                                    ref: function (u) {
                    ...
                    G = ({ binding: u, text: e = '', classMix: t, alignment: A = D.left, formatWithBrackets: n }) => {
                    ...
                    j = (0, E.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                (D = D.replace(t, `%(${r})`)),
                                    (n[r] = W[u]
                                        ? F().createElement(
                                              'span',
                                              { className: W[u] },
                                              F().createElement(G, { text: a, binding: e }),
                                          )
                                        : F().createElement(
                                              'span',
                                              { style: A(u) },
                        ...
                        return F().createElement(G, { text: D, classMix: t, binding: n });
                    });
                let Y, $, K, X, H, Z, Q, J;
                !(function (u) {
                    (u.Items = 'items'),
                ...
                const uu = (u, e = K.Small) => `R.images.gui.maps.icons.quests.bonuses.${e}.${u}_gift`,
                    eu = 'Category_base_e5',
                    tu = 'Category_image_e5',
                    Eu = 'Category_content_4f',
                    Fu = 'Category_title_0e',
                    Au = 'Category_rewards_10',
                    nu = 'Category_counter_79',
                    ru = R.strings.selectable_reward.tooltips.selectedRewards.reward,
                    Du = ({ type: u, rewards: e }) => {
                        const t = (0, E.useMemo)(() => ({ backgroundImage: `url(${uu(u)})` }), [u]),
                            A = (0, E.useMemo)(() => {
                                const u = {},
                                    t = e
                                        .map(({ value: e }, t) => {
                                            const E = ((u) => {
                                                ...
                                                return (
                                                    E ||
                                                    (F ? i(F) : void console.error('title for reward is not provided'))
                                                );
                                            })(e.type);
                                            ...
                                            var r, D;
                                            return (
                                                (u[A] = F().createElement(G, { text: n, classMix: nu })), `${E}%(${A})s`
                                            );
                                        })
                                        .join(ru.separator());
                        ...
                        return F().createElement(
                            'div',
                            { className: eu },
                            F().createElement('div', { className: tu, style: t }),
                            F().createElement(
                                'div',
                                { className: Eu },
                                F().createElement(
                                ...
                                F().createElement('div', { className: Au }, F().createElement(G, A)),
                            ),
                        );
                    },
                    ou = 'App_base_ba',
                    iu = 'App_title_43',
                    au = 'App_description_43',
                    Bu = 'App_divider_36',
                    su = 'App_category_c3',
                    Cu = R.strings.selectable_reward.tooltips.selectedRewards,
                    lu = () => {
                        const u = y(),
                            e = u.totalSelected,
                            t = u.categories,
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                F().createElement(
                                    'div',
                                    { className: iu },
                                    F().createElement(j, { text: Cu.title(), binding: A }),
                                ),
                                F().createElement('div', { className: au }, Cu.description()),
                                F().createElement('div', { className: Bu }),
                                t.map(({ value: u }, e) =>
                                    F().createElement('div', { key: e, className: su }, F().createElement(Du, u)),
                                ),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    n().render(F().createElement(lu, null), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
