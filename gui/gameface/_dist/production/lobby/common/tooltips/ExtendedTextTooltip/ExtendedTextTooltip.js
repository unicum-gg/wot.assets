                            ...
                            b(
                                {
                                    contentId:
                                        ...
                                        F ? w.SimpleTooltipHtmlContent('resId') : w.SimpleTooltipContent('resId')),
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            }
                            {
                                const u = t.children,
                                    c = e[E],
                                    A = c.props.children,
                                    l = su(u, A, u.length - 1, n, r, o),
                                    d = l[0],
                                    D = l[1];
                                if (!(d < 0)) {
                                    const u = A.slice(0, d);
                                    ((a = s().cloneElement(c, c.props, u, D)), (i = E));
                                    break;
                                }
                                r -= F.length;
                            }
                    ...
                    Eu = s().memo(
                        ({
                            ...
                            const d = (0, i.useRef)(null),
                                ...
                                C = B[0],
                                _ = B[1],
                                p = (0, i.useMemo)(() => nu(u, n, { justifyContent: F }), [n, F, u]),
                                h = (0, i.useMemo)(() => {
                                    if (
                                        o &&
                                        C.isTruncated &&
                                ...
                                const c = (0, i.useRef)([]),
                                    F = (t, n, r) => {
                                        ...
                                        const s = (function ({
                                            ...
                                            l = { mode: t, model: A, externalModel: a, cleanup: F };
                                        return {
                                            model: A,
