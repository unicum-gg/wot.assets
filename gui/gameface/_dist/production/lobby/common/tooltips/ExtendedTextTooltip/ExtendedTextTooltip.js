    ...
    var __webpack_modules__ = {
            ...
            203: (u, e, t) => {
                        ...
                        const f = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, i.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (p(t, D, { isMouseEvent: !0, on: !0, arguments: _(n) }, g),
                                    m && m(),
                ...
                const T = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return r || i
                        ? a().createElement(h, k({}, e, { contentId: r || i }), n)
                        : a().createElement(w, e, n);
                };
                var O = t(45);
                const x = 'ExtendedText_base_71',
                    L = 'ExtendedText_base__zeroPadding_25',
                    M = 'ExtendedText_base__isTruncationAvailable_5b',
                    P = 'ExtendedText_truncated_97',
                    S = 'ExtendedText_truncated__hide_31',
                    N = 'ExtendedText_unTruncated_b8';
                let I;
                !(function (u) {
                ...
                const K = { [V.NBSP]: j.NoBreakSymbol, [V.ZWNBSP]: j.NoBreakSymbol, [V.NEW_LINE]: j.LineBreak },
                    q = {
                    ...
                    Z = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? q[n]
                                ...
                                : a().createElement('span', { key: t, 'data-block-type': e.blockType, style: Y(n) }, u)
                    ...
                    $ = {
                        ...
                        [j.LineBreak]: ({ key: u }) =>
                            a().createElement('span', { key: u, 'data-block-type': j.LineBreak, className: z }),
                        [j.NewLine]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': j.NewLine, className: G }, u),
                        [j.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': j.NoBreakWrapper, className: H }, u),
                    },
                    X = (u, e, t) => {
                        const n = [];
                        return (
                    ...
                    eu = (u, e = '') => {
                        ...
                        return (
                            J(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: j.Word, colorTag: e, childList: uu(u) });
                                },
                                (u) => {
                                    const n = u[0],
                                        r = K[n.charAt(0)];
                            ...
                            J(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof o || 'number' == typeof o
                                        ...
                                        : n.push({ blockType: j.Binding, colorTag: t, childList: [o] });
                                },
                            ),
                            n
                        );
                    ...
                    Au = a().memo(
                        ({
                            ...
                            targetId: E,
                            justifyContent: A = W.FlexStart,
                            alignContent: F = W.FlexStart,
                            truncateIdentify: c = '...',
                        }) => {
                            const l = (0, i.useRef)(null),
                                ...
                                v = (0, i.useMemo)(() => ({ justifyContent: A, alignContent: F }), [F, A]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                a().createElement(
                                    'div',
                                    { className: r()(x, e, L, s && M), style: v },
                                    a().createElement('div', { className: N, ref: l }, _),
                                    a().createElement(
                                        T,
                                        { tooltipArgs: p },
                                        a().createElement(
                                            'div',
                                            { className: r()(P, !B.isTruncateFinished && s && S), style: v },
                                            B.isTruncateFinished && s ? B.elementList : _,
                                        ),
                                    ),
                                )
                            );
                ...
                const _u = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: r, children: s, mocks: E }) {
                                ...
                                return (
                                    (0, i.useEffect)(() => {
                                        c.current ? _(F(D, r, E)) : (c.current = !0);
                                    }, [E, D, r]),
                                    (0, i.useEffect)(() => {
                                        d(n);
                                    }, [n]),
                    ...
                    pu = _u[0],
                    hu = _u[1],
                    vu = 'ExtendedTextTooltipApp_base_37',
                    mu = (0, d.Pi)(function () {
                        const u = hu().model;
                        return a().createElement(
                            'div',
                ...
                engine.whenReady.then(() => {
                    D().render(
                        a().createElement(c, null, a().createElement(pu, null, a().createElement(mu, null))),
