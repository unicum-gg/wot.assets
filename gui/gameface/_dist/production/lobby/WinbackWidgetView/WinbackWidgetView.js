(() => {
    var __webpack_modules__ = {
            ...
            794: (u, e, t) => {
                ...
                const D = n.O.client.getSize('rem'),
                    ...
                    C = (u) => {
                        ...
                        const E = (0, r.useContext)(B),
                            ...
                            p = { extraLarge: c, large: d, medium: h, small: g, extraSmall: v };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && o) return a(e, t, p);
                            if (t.largeWidth && l) return a(e, t, p);
                            if (t.mediumWidth && s) return a(e, t, p);
                            if (t.smallWidth && C) return a(e, t, p);
                ...
                const L = {
                    ...
                    T = (u) => {
                        ...
                        const a = w(),
                            ...
                            A = a.mediaHeight,
                            i = a.mediaSize;
                        return E().createElement('div', f({ className: d()(t, L[n], S[A], M[i]) }, r), e);
                    },
                    O = ['children'],
                    y = (u) => {
                        let e = u.children,
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (W(t, B, { isMouseEvent: !0, on: !0, arguments: N(E) }, p),
                                    d && d(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((v.current.timeoutId = window.setTimeout(b, D ? 100 : 400)),
                                                          a && a(u),
                                                          f && f(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                    ...
                    z = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: a, children: A, mocks: i }) {
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        o.current ? m(D(s, a, i)) : (o.current = !0);
                                    }, [i, s, a]),
                                    (0, r.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                ...
                const nu = {
                    ...
                    Fu = tu((u) => {
                        let e = u.className,
                            ...
                            x =
                                void 0 === w
                                    ...
                                    : w,
                            f = u.alignItems,
                            L = void 0 === f ? (h ? 'flex-start' : g && 'center') || (v && 'flex-end') || void 0 : f,
                            S = u.alignSelf,
                            M = u.wrap,
                            T = u.flexWrap,
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, i, D, l, B, k, P, S, c, O, x, L]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return E().createElement('div', au({ className: d()(ru.base, ...U, e), style: G }, N), I);
                    });
                let Du;
                !(function (u) {
                ...
                const ou = (u, e, t) => {
                    ...
                    su = (u, e, t = Du.left) => u.split(e).reduce(t === Du.left ? ou : lu, []),
                    Bu = (() => {
                        const u = new RegExp(
                    ...
                    Cu = ({ binding: u, text: e = '', classMix: t, alignment: a = Du.left }) =>
                        null === e
                ...
                const vu = Object.keys(cu()),
                    ...
                    Lu = tu((u) => {
                        ...
                        return E().createElement(
                            ...
                            gu(
                                {
                                    className: d()(du.base, t && du[t], v, a),
                                    style: g,
                                    mt: !0 === F ? xu[t || 'paragraph-P16'].mt : F,
                                    mr: !0 === o ? xu[t || 'paragraph-P16'].mr : o,
                                    mb: !0 === s ? xu[t || 'paragraph-P16'].mb : s,
                                    ml: !0 === _ ? xu[t || 'paragraph-P16'].ml : _,
                                },
                                c,
                            ),
                            void 0 !== m ? E().createElement(Cu, gu({}, m, { text: e })) : e,
                        );
                    });
                let Su;
                !(function (u) {
                    ((u.IN_PROGRESS = 'inProgress'),
                        (u.COMPLETE = 'complete'),
                        (u.DISABLE = 'disable'),
                        (u.LAST_STAGE = 'lastStage'));
                })(Su || (Su = {}));
                const Mu = {
                ...
                const Ru = (u) => {
                    ...
                    return E().createElement(
                        'div',
                        Ou({ className: s }, F),
                        E().createElement('div', { className: Mu.bg }),
                        E().createElement('div', { className: Mu.pattern }),
                        E().createElement(
                            'div',
                            { className: d()(Mu.value, o && Mu.value__text) },
                            l ? A : D,
                            l && E().createElement('span', { className: Mu.plus }, '+'),
                        ),
                    );
                };
                ...
                const yu = {
                    ...
                    Hu = (0, U.Pi)(() => {
                        const u = Y(),
                            ...
                            A = a.state,
                            i = a.level,
                            F = a.selectableRewardsCount,
                            D = a.progressionName,
                            o = A !== Su.DISABLE,
                            l = A === Su.IN_PROGRESS || A === Su.LAST_STAGE,
                            s = F > 0,
                            B = d()('Widget_icon_15', !o && 'Widget_icon__disable_30'),
                            _ = R.images.winback.gui.maps.icons.widget.$dyn(`${yu[A]}${D}`);
                        var C;
                        return (
                            (C = () => {
                                n.O.view.resize(150, 180, 'rem');
                            }),
                            (0, r.useEffect)(C, []),
                            E().createElement(
                                'div',
                                {
                                    className: d()('Widget_base_61', o && 'Widget_base__enabled_50'),
                                    onClick: o ? t.click : void 0,
                                },
                                s &&
                                    E().createElement(
                                        'div',
                                        { className: 'Widget_counter_85' },
                                        E().createElement(Ru, { value: F, size: 'normal' }),
                                    ),
                                E().createElement(
                                    'div',
                                    { className: B, style: { backgroundImage: `url(${_})` } },
                                    l &&
                                        E().createElement(Lu, {
                                            text: String(i),
                                            className: d()(
                                                'Widget_progressionLevel_62',
                                                !o && 'Widget_progressionLevel__disable_c3',
                                            ),
                                        }),
                                ),
                            )
                    ...
                    Pu = () =>
                        E().createElement(
                            G,
                            { contentId: R.views.winback.lobby.tooltips.WidgetTooltipView('resId') },
                            E().createElement('div', { className: 'App_base_60' }, E().createElement(Hu, null)),
                        );
                engine.whenReady.then(() => {
                    P().render(
                        E().createElement(y, null, E().createElement($, null, E().createElement(Pu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(794));
