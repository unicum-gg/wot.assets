    ...
    var __webpack_modules__ = {
                    ...
                    b = {
                        ...
                        sendShowPopOverEvent: (u, e, t, r, a = R.invalid('resId'), n) => {
                            const E = _.O.view.getViewGlobalPosition(),
                                ...
                                D = i.height,
                                l = {
                                    x: _.O.view.pxToRem(o) + E.x,
                                    y: _.O.view.pxToRem(F) + E.y,
            ...
            622: (u, e, t) => {
                ...
                const F = E.O.client.getSize('rem'),
                    s = F.width,
                    D = F.height,
                    l = Object.assign({ width: s, height: D }, o(s, D, i)),
                ...
                const m = (u) => {
                    ...
                    C = (0, r.memo)(({ children: u }) => {
                        ...
                        return a().createElement(_.Provider, { value: s }, u);
                    });
                var d = t(483),
                    h = t.n(d),
                    g = t(926),
                ...
                const S = {
                    ...
                    O = (u) => {
                        ...
                        const n = x(),
                            ...
                            i = n.mediaHeight,
                            A = n.mediaSize;
                        return a().createElement('div', M({ className: h()(t, S[E], L[i], T[A]) }, r), e);
                    },
                    y = ['children'];
                const H = (u) => {
                    let e = u.children,
                    ...
                    return a().createElement(C, null, a().createElement(O, t, e));
                };
                var P = t(493),
                    N = t.n(P),
                    k = t(887),
                ...
                const tu = ({
                    ...
                    const c = (0, r.useRef)(null),
                        ...
                        M = (0, r.useCallback)(
                            (u) => {
                                C && null !== c.current && !c.current.contains(u.target) && d(!1);
                            },
                            [C],
                        ),
                        S = (0, r.useCallback)(
                ...
                const ru = (0, r.memo)(tu),
                    ...
                    Fu = ({
                        ...
                        const s = u ? { backgroundImage: `url('${u}')` } : void 0;
                        return a().createElement(
                            'div',
                            { className: h()(au, i), style: s },
                            (n || E) &&
                                a().createElement(
                                    'div',
                                    { className: nu },
                                    n,
                                    E && a().createElement('div', { className: Eu }),
                                    E,
                                ),
                            e && a().createElement('div', { className: h()(iu, o) }, e),
                            t && a().createElement('div', { className: h()(Au, A) }, t),
                            r && a().createElement('div', { className: h()(ou, F) }, r),
                        );
                    };
                let su;
                !(function (u) {
                ...
                const Du = (u, e, t) => {
                    ...
                    _u = (u, e, t = su.left) => u.split(e).reduce(t === su.left ? Du : lu, []),
                    Bu = (() => {
                        const u = new RegExp(
                        ...
                        return cu.includes(t)
                            ...
                            : ((u, e = su.left) => {
                                  ...
                                  const r =
                                      ...
                                      a = u.replace(/&nbsp;/g, ' ');
                                  return (_u(a, /( )/, e).forEach((u) => (t = t.concat(_u(u, r, su.left)))), t);
                              })(u, e);
                    },
                    Cu = 'FormatText_base_d0',
                    du = ({ binding: u, text: e = '', classMix: t, alignment: n = su.left }) =>
                        null === e
                ...
                const fu = Object.keys(gu()),
                    ...
                    Ru = X((u) => {
                        ...
                        return a().createElement(
                            ...
                            bu(
                                {
                                    className: h()(pu.base, t && pu[t], p, n),
                                    style: g,
                                    mt: !0 === o ? Lu[t || 'paragraph-P16'].mt : o,
                                    mr: !0 === s ? Lu[t || 'paragraph-P16'].mr : s,
                                    mb: !0 === l ? Lu[t || 'paragraph-P16'].mb : l,
                                    ml: !0 === B ? Lu[t || 'paragraph-P16'].ml : B,
                                },
                                C,
                            ),
                            void 0 !== m ? a().createElement(du, bu({}, m, { text: e })) : e,
                        );
                    }),
                    Ou = {
                ...
                class Pu extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()(Ou.base, Ou[`base__${E}`], Ou[`base__${n}`], null == i ? void 0 : i.base),
                            _ = h()(Ou.icon, Ou[`icon__${E}`], Ou[`icon__${n}`], null == i ? void 0 : i.icon),
                            B = h()(Ou.glow, null == i ? void 0 : i.glow),
                            c = h()(Ou.caption, Ou[`caption__${E}`], null == i ? void 0 : i.caption),
                            m = h()(Ou.goto, null == i ? void 0 : i.goto);
                        return a().createElement(
                            'div',
                            Hu(
                                {
                            ...
                            'info' !== E && a().createElement('div', { className: Ou.shine }),
                ...
                function Iu(u = Nu.n.NONE, e = ku, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Nu.n.NONE)
                            return (
                ...
                const Ku = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: i, children: A, mocks: o }) {
                                const F = (0, r.useRef)([]),
                                    s = (t, r, a) => {
                                        var n;
                                        const i = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, n) => {
                                                        const A = 'string' == typeof n ? `${r}.${n}` : r,
                                                            o = E.O.view.addModelObserver(A, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = ju(a.keys()); !(u = t()).done; ) n(u.value, e);
                                                    },
                                                    unsubscribe: n,
                                                };
                                            })(r),
                                    ...
                                    _ = l[0],
                                    B = l[1],
                                    c = (0, r.useState)(() => s(n, i, o)),
                                    m = c[0],
                                    C = c[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        D.current ? C(s(_, i, o)) : (D.current = !0);
                                    }, [o, _, i]),
                                    (0, r.useEffect)(() => {
                                        B(n);
                                    }, [n]),
                    ...
                    Yu = 'WotPlusIntroViewApp_header_b4',
                    Zu = 'WotPlusIntroViewApp_illustration_00',
                    Qu = 'WotPlusIntroViewApp_informations_16',
                    Ju = 'WotPlusIntroViewApp_informationContent_0e',
                    ue = 'WotPlusIntroViewApp_textShadow_78',
                    ee = 'WotPlusIntroViewApp_wotPlusGeneralInfoIcon_e9',
                    te = 'WotPlusIntroViewApp_wotPlusCyclesInfoIcon_8e',
                    re = 'WotPlusIntroViewApp_wotPlusRewardsInfoIcon_49',
                    ae = 'WotPlusIntroViewApp_button_a9',
                    ne = (0, Wu.Pi)(() => {
                        const u = zu().controls,
                            e = u.onClose,
                            t = u.onAffirmative,
                            n = u.onInfo,
                            E = {
                                superHeading: R.strings.subscription.introView.superHeading(),
                                heading: R.strings.subscription.introView.heading(),
                                subHeading: R.strings.subscription.introView.subHeading(),
                                generalInformation: R.strings.subscription.introView.generalInformation(),
                                generalInformationContent: R.strings.subscription.introView.generalInformationContent(),
                                cyclesInformation: R.strings.subscription.introView.cyclesInformation(),
                                cyclesInformationContent: R.strings.subscription.introView.cyclesInformationContent(),
                                rewardsInformation: R.strings.subscription.introView.rewardsInformation(),
                                rewardsInformationContent: R.strings.subscription.introView.rewardsInformationContent(),
                                checkRewardsButton: R.strings.subscription.introView.checkRewardsButton(),
                                affirmative: R.strings.subscription.introView.affirmative(),
                        ...
                        return (
                            ...
                            a().createElement(
                                ...
                                { className: qu },
                                a().createElement(Fu, {
                                    navigationRightContent: a().createElement(Pu, {
                                        caption: E.close,
                                        onClick: i,
                                        side: 'right',
                                        type: 'close',
                                    ...
                                    header: a().createElement(
                                        Z,
                                        { className: Yu, column: !0, center: !0, mt_lg: 'LG' },
                                        a().createElement(Ru, {
                                            text: E.superHeading,
                                            variant: 'heading-H24',
                                            color: 'WHITE_REAL',
                                        ...
                                        a().createElement(
                                            ...
                                            a().createElement(
                                                ...
                                                a().createElement(
                                                    ...
                                                    { className: Ju },
                                                    a().createElement(Ru, {
                                                        text: E.generalInformation,
                                                        variant: 'heading-H18',
                                                        variant_md: 'heading-H24',
                                                        color: 'WHITE_SPANISH',
                                                        mb: 'XS',
                                                        className: ue,
                                                    }),
                                                    a().createElement(Ru, {
                                                        text: E.generalInformationContent,
                                            ...
                                            a().createElement(
                                                ...
                                                a().createElement(
                                                    ...
                                                    a().createElement(Ru, {
                                                        text: E.cyclesInformationContent,
                                                        variant: 'paragraph-P14',
                                                        variant_md: 'paragraph-P16',
                                                        color: '#b3b398',
                                                        className: ue,
                                            ...
                                            a().createElement(
                                                ...
                                                a().createElement(
                                                    Z,
                                                    { className: Ju, column: !0 },
                                                    a().createElement(Ru, {
                                                        text: E.rewardsInformation,
                                                        variant: 'heading-H18',
                                                        variant_md: 'heading-H24',
                                                        color: 'WHITE_SPANISH',
                                                        mb: 'XS',
                                                    ...
                                                    a().createElement(Ru, {
                                                        text: E.rewardsInformationContent,
                                                        variant: 'paragraph-P14',
                                                        variant_md: 'paragraph-P16',
                                                        color: '#b3b398',
                                                        className: ue,
                                                    ...
                                                    a().createElement(
                                                        ...
                                                        a().createElement(
                                                            ru,
                                                            { size: 'medium', onClick: n, type: 'ghost' },
                                                            E.checkRewardsButton,
                                                        ),
                                                    ),
                                                ),
                                            ),
                                    ...
                                    footer: a().createElement(
                                        ...
                                        a().createElement(
                                            ru,
                                            { size: 'medium', mixClass: ae, onClick: t },
                                            E.affirmative,
                                        ),
                                    ),
                                }),
                ...
                engine.whenReady.then(() => {
                    N().render(
                        a().createElement(H, null, a().createElement($u, null, a().createElement(ne, null))),
