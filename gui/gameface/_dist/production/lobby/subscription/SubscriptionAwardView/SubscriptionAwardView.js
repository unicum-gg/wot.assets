(() => {
    var __webpack_modules__ = {
            ...
            916: (u, e, t) => {
                'use strict';
                t.d(e, { B3: () => s, Z5: () => i.Z5, B0: () => o, ry: () => _, Sy: () => m });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            745: (u, e, t) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: o, children: s, mocks: E }) {
                                ...
                                return (
                                    ...
                                    r().createElement(t.Provider, { value: _ }, s)
                                );
                            },
                            () => (0, n.useContext)(t),
                        ];
                            ...
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    t ||
                                        (null !== B && $(B),
                                        s && s(u),
                                        c && (t || (_.current && (_.current.focus(), g(!0)))),
                                        v(!0));
                                },
                ...
                const Z = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    eu = (u, e, t = K.left) => u.split(e).reduce(t === K.left ? J : uu, []),
                    tu = (() => {
                        const u = new RegExp(
                            [
                    ...
                    ru = (u, e = K.left) => {
                        ...
                        return ((u, e = K.left) => {
                            ...
                            const n =
                                ...
                                r = Z(u);
                            return (eu(r, /( )/, e).forEach((u) => (t = t.concat(eu(u, n, K.left)))), t);
                        })(u, e);
                    };
                var au = t(916),
                    iu = t(613);
                Date.now();
                const ou = iu.Ew.getRegionalDateTime,
                    su = iu.Ew.getFormattedDateTime;
                const Eu = (0, n.memo)(({ datetime: u, format: e = Y.ShortDate, isConvertedToLocal: t = !0 }) =>
                        Object.values(Y).includes(e) ? ou(u, e, t) : su(u, e, t),
                    ),
                    lu = 'FormatText_base_d0',
                    Au = ({ binding: u, text: e = '', classMix: t, alignment: a = K.left, formatWithBrackets: i }) => {
                ...
                const gu = [cu.Attachment];
                const hu = ({ value: u, format: e = 'integral' }) => {
                        const t = (function (u) {
                                return 'gold' === u ? au.B3.GOLD : au.B3.INTEGRAL;
                            })(e),
                            n = au.Z5.getNumberFormat(u, t);
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Ru(t, D, { isMouseEvent: !0, on: !0, arguments: Su(r) }, v),
                                    m && m(),
                ...
                const Uu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        const a = e.contentId;
                        return a ? r().createElement(xu, Nu({}, e, { contentId: a }), n) : r().createElement(Ou, e, n);
                    },
                    Gu = {
                        base: 'Reward_base_ea',
                    ...
                    Hu = ({
                        ...
                        const D = ((u, e) => {
                            ...
                            B = ((u) => {
                                ...
                                switch (u) {
                                    ...
                                    case Bu.ATTACHMENT_RARE:
                                        return Cu.ATTACHMENT_RARE;
                                    case Bu.ATTACHMENT_EPIC:
                                        return Cu.ATTACHMENT_EPIC;
                                    case Bu.ATTACHMENT_LEGENDARY:
                        ...
                        return r().createElement(
                            'div',
                            {
                                className: d()(Gu.base, Gu[`base__${n}`], gu.includes(u) && Gu.base__normalize, l),
                                style: E,
                            },
                            r().createElement(
                                Uu,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: d()(Gu.image, null == A ? void 0 : A.image) },
                                        D &&
                                            r().createElement('div', {
                                                className: d()(Gu.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: d()(Gu.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        B &&
                                            r().createElement('div', {
                                                className: d()(Gu.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: d()(
                                                    Gu.info,
                                                    Gu[`info__${u}`],
                                                    o === du.MULTI && Gu.info__multi,
                                                    null == A ? void 0 : A.info,
                                                ),
                                            },
                                            _,
                                        ),
                                    s && r().createElement('div', { className: Gu.title }, s),
                                ),
                            ),
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: F },
                                    r().createElement('div', {
                                        className: d()(Gu.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    },
                ...
                const qu = (u) => {
                    ...
                    return r().createElement(
                        ...
                        'info' !== B && r().createElement('div', { className: Wu.shine }),
                        r().createElement(
                            'div',
                            {
                                className: d()(
                        ...
                        r().createElement(
                            'div',
                            { className: d()(Wu.caption, Wu[`caption__${B}`], null == o ? void 0 : o.caption) },
                            e,
                        ),
                ...
                function Yu(u = zu.n.NONE, e = ju, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== zu.n.NONE)
                            return (
                ...
                var Ku = t(515);
                const Qu = 'SubscriptionAwardViewApp_base_52',
                    Zu = 'SubscriptionAwardViewApp_closeButton_cf',
                    Ju = 'SubscriptionAwardViewApp_heading_7f',
                    ue = 'SubscriptionAwardViewApp_fadeInUp_b6',
                    ee = 'SubscriptionAwardViewApp_subheading_f8',
                    te = 'SubscriptionAwardViewApp_textAccent_69',
                    ne = 'SubscriptionAwardViewApp_bigLogo_container_95',
                    re = 'SubscriptionAwardViewApp_bigLogo_icon_f6',
                    ae = 'SubscriptionAwardViewApp_freeSpaceFill_2a',
                    ie = 'SubscriptionAwardViewApp_footer_68',
                    oe = 'SubscriptionAwardViewApp_unlockedFeatures_5a',
                    se = 'SubscriptionAwardViewApp_unlockedFeatures_label_80',
                    Ee = 'SubscriptionAwardViewApp_unlockedFeature_a7',
                    le = 'SubscriptionAwardViewApp_unlockedFeature_label_ad',
                    Ae = 'SubscriptionAwardViewApp_unlockedFeature_icon_9b',
                    ce = 'SubscriptionAwardViewApp_controls_06',
                    Fe = 'SubscriptionAwardViewApp_controls_button_e0';
                function De() {
                    return (
                        (De =
                            Object.assign ||
                ...
                const de = (0, Ku.Pi)(() => {
                    const u = {
                            heading: R.strings.subscription.awardView.heading(),
                            ...
                            nextCharge: R.strings.subscription.awardView.nextCharge(),
                            closeButton: R.strings.subscription.awardView.close(),
                        },
                        e = W(),
                        t = e.model,
                        a = e.controls,
                        i = t.root.get().nextCharge,
                        o = a.onInfoButtonClick,
                        s = a.onCloseButtonClick,
                        E = (0, n.useRef)(!1);
                    (Yu(zu.n.ALT, () => {
                        E.current = !0;
                    }),
                    ...
                    const l = (0, n.useMemo)(
                            () => ({
                                date: r().createElement(
                                    'span',
                                    { className: te },
                                    r().createElement(Eu, { datetime: i, format: Y.ShortDate }),
                                ),
                                time: r().createElement(
                                    'span',
                                    { className: te },
                                    r().createElement(Eu, { datetime: i, format: Y.ShortTime }),
                                ),
                            }),
                            [i],
                        ),
                        A = ((u) =>
                            ...
                            })))(t.computes.getRewards());
                    return r().createElement(
                        'div',
                        { className: Qu },
                        r().createElement(qu, {
                            caption: u.closeButton,
                            onClick: au.Sy,
                            side: 'right',
                            type: 'close',
                        ...
                        r().createElement('div', { className: Ju }, u.heading),
                        r().createElement(Au, { classMix: ee, binding: l, text: u.nextCharge }),
                        r().createElement(
                            'div',
                            { className: ae },
                            r().createElement(
                        ...
                        r().createElement(
                            'div',
                            { className: ie },
                            r().createElement('div', { className: se }, u.features),
                            r().createElement(
                                'div',
                                { className: oe },
                                A.map((u, e) =>
                                    r().createElement(
                                        Hu,
                                        De({ size: Du.Small, key: e }, u, {
                                            style: { animation: `${ue} 400ms ease-out ${100 * e + 1e3}ms both` },
                                            className: Ee,
                                            classNames: { image: Ae, info: le },
                                        }),
                                    ),
                                ),
                            ),
                            r().createElement(
                                ...
                                {
                                    className: ce,
                                    style: { animation: `${ue} 400ms ease-out ${100 * A.length + 1e3}ms both` },
                                },
                                r().createElement(
                                    j,
                                    { mixClass: Fe, onClick: s || au.Sy, size: z.medium, type: q.primary },
                                    u.affirmative,
                                ),
                                r().createElement(
                                    j,
                                    { mixClass: Fe, onClick: o || au.Sy, size: z.medium, type: q.secondary },
                                    u.details,
                                ),
                            ),
                        ),
                ...
                engine.whenReady.then(() => {
                    P().render(
                        r().createElement(x, null, r().createElement(H, null, r().createElement(de, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [174], () => __webpack_require__(745));
