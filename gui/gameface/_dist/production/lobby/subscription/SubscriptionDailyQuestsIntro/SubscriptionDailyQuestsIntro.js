(() => {
    ...
    var u,
        A = {
            991: (u, A, F) => {
                var E = {};
                (F.r(E), F.d(E, { mouse: () => z, onResize: () => O }));
                var e = {};
                (F.r(e),
                    F.d(e, {
                        events: () => E,
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => G, getTextureUrl: () => N }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => uu,
                ...
                const d = ({
                    ...
                    const b = (0, C.useRef)(null),
                        ...
                        S = y[1],
                        P = (0, C.useCallback)(() => {
                            e || (b.current && (b.current.focus(), _(!0)));
                        }, [e]),
                        k = (0, C.useCallback)(
                            (u) => {
                                g && null !== b.current && !b.current.contains(u.target) && _(!1);
                            },
                            [g],
                        ),
                        M = (0, C.useCallback)(
                        ...
                        t().createElement(
                            ...
                            E !== l.ghost &&
                                t().createElement(
                                    t().Fragment,
                                    null,
                                    t().createElement('div', { className: i.back }),
                                    t().createElement('span', { className: i.texture }),
                                ),
                            t().createElement(
                                'span',
                                { className: N },
                                t().createElement('span', { className: i.stateDisabled }),
                                t().createElement('span', { className: i.stateHighlightHover }),
                                t().createElement('span', { className: i.stateHighlightActive }),
                            ),
                            t().createElement(
                                'span',
                ...
                const b = (u, A, F) => {
                    ...
                    g = (u, A, F = v.left) => u.split(A).reduce(F === v.left ? b : f, []),
                    _ = (() => {
                        const u = new RegExp(
                        ...
                        return p.includes(F)
                            ...
                            : ((u, A = v.left) => {
                                  ...
                                  const E =
                                      ...
                                      e = u.replace(/&nbsp;/g, ' ');
                                  return (g(e, /( )/, A).forEach((u) => (F = F.concat(g(u, E, v.left)))), F);
                              })(u, A);
                    },
                    w = 'FormatText_base_d0',
                    y = ({ binding: u, text: A = '', classMix: F, alignment: E = v.left }) =>
                        null === A
                            ...
                            : t().createElement(
                                  ...
                                  A.split('\n').map((A, e) =>
                                      t().createElement(
                                          'div',
                                          { className: a()(w, F), key: `${A}-${e}` },
                                          ((u, A, F) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (F && u in F ? F[u] : h(u, A))))(A, E, u).map((u, A) =>
                ...
                const O = k('clientResized'),
                    T = { down: k('mousedown'), up: k('mouseup'), move: k('mousemove') };
                const z = (function () {
                ...
                const _u = ((u, A) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: e, children: D, mocks: B }) {
                                ...
                                return (
                                    (0, C.useEffect)(() => {
                                        o.current ? d(r(s, e, B)) : (o.current = !0);
                                    }, [B, s, e]),
                                    (0, C.useEffect)(() => {
                                        i(E);
                                    }, [E]),
                        ...
                        ({ observableModel: u }) => {
                            ...
                            return Object.assign({}, A, { computes: {} });
                        },
