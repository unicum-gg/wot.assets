(() => {
    ...
    var __webpack_modules__ = {
            ...
            4759: (u, e, t) => {
                                ...
                                const l = (0, i.useRef)([]),
                                    E = (u, t, r) => {
                                        ...
                                        const i = (function ({
                                            ...
                                            c = (({ observableModel: u }) => {
                                                const e = { root: u.object(), scorePoint: u.object('scorePoint') },
                                                    t = (0, C.Om)(() => _(e.scorePoint.get(), (u) => u));
                                                return Object.assign({}, e, { computes: { getScorePoint: t } });
                                            })({
                                                mode: u,
                                                readByPath: o,
                                                externalModel: s,
                                    ...
                                    F = A[0],
                                    g = A[1],
                                    p = (0, i.useState)(() => E(u, r, o)),
                                    h = p[0],
                                    b = p[1];
                                return (
                                    (0, i.useEffect)(() => {
                                        c.current ? b(E(F, r, o)) : (c.current = !0);
                                    }, [o, F, r]),
                                    (0, i.useEffect)(() => {
                                        g(u);
                                    }, [u]),
                ...
                const f = ({ size: u = w.Default }) =>
                        s().createElement('div', { className: n()(b.background, b[`background__${u}`]) }),
                    S = {
                    ...
                    P = (0, i.memo)(
                        ({ size: u, lineRef: e, disabled: t, baseStyles: r, isComplete: a, withoutBounce: i }) => {
                            const o = n()(
                                    ...
                                    t && T.base__disabled,
                                    a && T.base__finished,
                                    i && T.base__withoutBounce,
                                ),
                                l = !t && !a;
                            return s().createElement(
                                'div',
                                { className: o, style: r, ref: e },
                                s().createElement('div', { className: T.pattern }),
                                s().createElement('div', { className: T.gradient }),
                                l && s().createElement(x, { size: u }),
                            );
                        },
                    ),
                    y = ({ size: u, value: e, lineRef: t, disabled: r, onComplete: n }) => {
                        ...
                        return (
                            ...
                            s().createElement(P, { size: u, disabled: r, baseStyles: a, isComplete: o, lineRef: t })
                        );
                    },
                    O = (u, e) => {
                        let t;
                ...
                const N = (0, i.memo)(
                        ({
                            ...
                            return m
                                ...
                                : s().createElement(
                                      ...
                                      s().createElement(
                                          'div',
                                          { style: d ? _ : C, className: 'ProgressBarDeltaSimple_delta_99' },
                                          s().createElement(x, { size: n }),
                                      ),
                                  );
                        },
                    ),
                    ...
                    I = (u) => (u ? { left: 0 } : { right: 0 }),
                    U = (u, e) => (u ? { right: 100 - e + '%' } : { left: `${e}%` }),
                    W = (u) => ({ transitionDuration: `${u}ms` }),
                    $ = (0, i.memo)(
                        ({
                            transitionDuration: u,
                            transitionDelay: e,
                            ...
                            const h = (0, i.useMemo)(() => Object.assign({ width: '100%' }, W(u), I(A)), [A, u]),
                                b = (0, i.useMemo)(() => Object.assign({ width: '0%' }, W(u), I(A)), [A, u]),
                                w = (0, i.useMemo)(() => Object.assign({ width: '0%' }, U(A, r), W(u)), [r, A, u]),
                                v = (0, i.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - r)}%` }, U(A, r), W(u)),
                                    [r, A, o, u],
                                );
                            if (d) return null;
                            const f = n()(
                ...
                const j = (0, i.memo)((u) => {
                        ...
                        switch (r.animationSettings.type) {
                            case v.Simple:
                                return s().createElement(L, z({}, r, { onEndAnimation: l, isComplete: a }));
                            case v.Growing:
                                return s().createElement(G, z({}, r, { onEndAnimation: l, isComplete: a }));
                            default:
                                return null;
                        }
                    }),
                ...
                const V = (0, i.memo)((u) => {
                    ...
                    return (
                        (r.current.from = a),
                        s().createElement(j, Y({}, t, { onEndAnimation: n, key: `${a}-${t.to}`, from: a }))
                    );
                });
                function X() {
                    return (
                ...
                const K = (0, i.memo)(
                    ...
                    J = (u, e, t) => ('number' == typeof t ? (Z(0, e, t) / e) * 100 : u),
                    uu = {
                    ...
                    tu = (0, i.memo)(
                        ({
                            ...
                            const m = ((u, e, t) =>
                                (0, i.useMemo)(() => {
                                    const r = (Z(0, e, u) / e) * 100;
                                    return { value: r, deltaFrom: J(r, e, t) };
                                }, [t, e, u]))(l, u, E);
                            return s().createElement(
                                'div',
                                { className: n()(b.base, b[`base__${t}`]), style: Q(e) },
                                !o && s().createElement(f, { size: t }),
                                s().createElement(K, {
                                    size: t,
                                    lineRef: c,
                                    disabled: a,
                    ...
                    ru = R.strings.races.tooltip.progressionWidget,
                    nu = ({ progressionLevel: u, currentPoints: e, isProgressionFinished: t }) => {
                        const r = (0, i.useMemo)(() => {
                                const r = e - 1e4 * u;
                                return [r, t ? 100 : (r / 1e4) * 100];
                            }, [e, t, u]),
                            n = r[0],
                            a = r[1];
                        return s().createElement(
                            'div',
                            { className: 'CurrentStage_base_91' },
                            s().createElement(
                                'div',
                                { className: 'CurrentStage_currentStage_29' },
                                s().createElement('div', { className: 'CurrentStage_currentStage__number_da' }, u + 1),
                                s().createElement(
                                    'div',
                                    { className: 'CurrentStage_currentStage__text_4f' },
                                    ru.currentStage(),
                                ),
                            ),
                            s().createElement(tu, { value: a }),
                            s().createElement(
                                'div',
                                { className: 'CurrentStage_progress_79' },
                                t
                                    ? s().createElement(
                                          'div',
                                          { className: 'CurrentStage_finishedProgress_8f' },
                                          ru.max(),
                                      )
                                    : s().createElement(
                                          s().Fragment,
                                          ...
                                          s().createElement(
                                              'div',
                                              { className: 'CurrentStage_progress__current_12' },
                                              `${n} `,
                                          ),
                                          s().createElement(
                                              'div',
                                              { className: 'CurrentStage_progress__max_0c' },
                                              '/ 10000',
                                          ),
                                          s().createElement('div', { className: 'CurrentStage_progress__icon_39' }),
                                      ),
                            ),
                        );
                    },
                    au = 'App_divider_2c',
                    iu = 'RewardPoints_item_c0',
                    su = 'RewardPoints_title_86',
                    ou = R.strings.races.tooltip.progressionWidget.rewards,
                    lu = ({ scorePoints: u }) =>
                        s().createElement(
                            'div',
                            { className: 'RewardPoints_base_85' },
                            s().createElement(
                                'div',
                                { className: iu },
                                s().createElement('div', { className: su }, ou.place()),
                                s().createElement('div', { className: su }, ou.points()),
                            ),
                            u.map((u, e) =>
                                s().createElement(
                                    'div',
                                    ...
                                    s().createElement(
                                        ...
                                        s().createElement(
                                            'div',
                                            { className: 'RewardPoints_place_a0' },
                                            ou.$dyn(`place${e + 1}`),
                                        ),
                                        s().createElement(
                                            'div',
                                            { className: 'RewardPoints_points_d7' },
                                            s().createElement('div', null, u),
                                            s().createElement('div', { className: 'RewardPoints_icon_83' }),
                                        ),
                                    ),
                                ),
                            ),
                        );
                let Eu, cu, Au, Fu, Du, mu, du;
                (!(function (u) {
                    ((u.Items = 'items'),
                        ...
                        const h = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, i.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (gu(t, D, { isMouseEvent: !0, on: !0, arguments: Cu(r) }, b),
                                    C && C(),
                            ...
                            fu(
                                {
                                    contentId:
                                        ...
                                        c ? Su.SimpleTooltipHtmlContent('resId') : Su.SimpleTooltipContent('resId')),
                ...
                const Tu = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return s().createElement(xu, e, r);
                    const n = e.contentId,
                        a = e.args,
                        i = null == a ? void 0 : a.contentId;
                    return n || i
                        ? s().createElement(pu, Ru({}, e, { contentId: n || i }), r)
                        : s().createElement(wu, e, r);
                };
                class Pu extends s().PureComponent {
                    render() {
                        let u;
                        u = 'gold' === this.props.format ? Bu.B3.GOLD : Bu.B3.INTEGRAL;
                ...
                const yu = [
                    ...
                    ku = [Eu.BattlePassPoints, Eu.RacesPoint],
                    Mu = [Eu.PremiumPlus, Eu.Premium],
                    ...
                    $u = ({
                        ...
                        const D = ((u) => {
                                ...
                                switch (u) {
                                    case Du.BATTLE_BOOSTER:
                                    case Du.BATTLE_BOOSTER_REPLACE:
                            ...
                            m = ((u) => {
                                ...
                                switch (u) {
                                    ...
                                    case Du.BUILT_IN_EQUIPMENT:
                                        return du.BUILT_IN_EQUIPMENT;
                                    case Du.EQUIPMENT_PLUS:
                                        return du.EQUIPMENT_PLUS;
                                    case Du.EQUIPMENT_TROPHY_BASIC:
                                        return du.EQUIPMENT_TROPHY_BASIC;
                                    case Du.EQUIPMENT_TROPHY_UPGRADED:
                                        return du.EQUIPMENT_TROPHY_UPGRADED;
                                    case Du.EQUIPMENT_MODERNIZED_UPGRADED_1:
                                        return du.EQUIPMENT_MODERNIZED_UPGRADED_1;
                                    case Du.EQUIPMENT_MODERNIZED_UPGRADED_2:
                                        return du.EQUIPMENT_MODERNIZED_UPGRADED_2;
                                    case Du.EQUIPMENT_MODERNIZED_UPGRADED_3:
                                        return du.EQUIPMENT_MODERNIZED_UPGRADED_3;
                                    case Du.PROGRESSION_STYLE_UPGRADED_1:
                                        return du.PROGRESSION_STYLE_UPGRADED_1;
                                    case Du.PROGRESSION_STYLE_UPGRADED_2:
                                        return du.PROGRESSION_STYLE_UPGRADED_2;
                                    case Du.PROGRESSION_STYLE_UPGRADED_3:
                                        return du.PROGRESSION_STYLE_UPGRADED_3;
                                    case Du.PROGRESSION_STYLE_UPGRADED_4:
                            ...
                            d = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case Fu.CURRENCY:
                                    case Fu.NUMBER:
                                        return s().createElement(Pu, { format: 'integral', value: Number(u) });
                        ...
                        return s().createElement(
                            'div',
                            { className: n()(Wu.base, Wu[`base__${r}`], E), style: l },
                            s().createElement(
                                Tu,
                                { tooltipArgs: A, className: Wu.tooltipWrapper },
                                s().createElement(
                                    s().Fragment,
                                    null,
                                    s().createElement(
                                        'div',
                                        { className: n()(Wu.image, null == c ? void 0 : c.image) },
                                        D &&
                                            s().createElement('div', {
                                                className: n()(Wu.highlight, null == c ? void 0 : c.highlight),
                                                style: {
                                        ...
                                        e &&
                                            s().createElement('div', {
                                                className: n()(Wu.icon, null == c ? void 0 : c.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        m &&
                                            s().createElement('div', {
                                                className: n()(Wu.overlay, null == c ? void 0 : c.overlay),
                                                style: {
                            ...
                            t &&
                                s().createElement(
                                    ...
                                    { tooltipArgs: F },
                                    s().createElement('div', {
                                        className: n()(Wu.timer, null == c ? void 0 : c.periodicIcon),
                                    }),
                                ),
                        );
                    },
                ...
                const qu = a.O.client.getSize('rem'),
                    Yu = qu.width,
                    Vu = qu.height,
                    Xu = Object.assign({ width: Yu, height: Vu }, ju(Yu, Vu, Hu)),
                    Ku = (0, i.createContext)(Xu),
                    Qu = ['children'],
                    Zu = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        const r = (0, i.useContext)(Ku),
                            ...
                            g = { extraLarge: m, large: d, medium: B, small: _, extraSmall: C };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && E) return Gu(e, t, g);
                            if (t.largeWidth && c) return Gu(e, t, g);
                ...
                ((0, i.memo)(({ children: u }) => {
                    const e = (0, i.useContext)(Ku),
                        ...
                        o = (0, i.useCallback)((u, e) => {
                            ...
                            n(Object.assign({ width: t, height: r }, ju(t, r, Hu)));
                        }, []);
                    (((u) => {
                    ...
                    return s().createElement(Ku.Provider, { value: l }, u);
                }),
                    (function (u) {
                        ((u[(u.ExtraSmall = Hu.extraSmall.width)] = 'ExtraSmall'),
                            (u[(u.Small = Hu.small.width)] = 'Small'),
                            (u[(u.Medium = Hu.medium.width)] = 'Medium'),
                            (u[(u.Large = Hu.large.width)] = 'Large'),
                            (u[(u.ExtraLarge = Hu.extraLarge.width)] = 'ExtraLarge'));
                    })(Ju || (Ju = {})),
                    (function (u) {
                        ((u[(u.ExtraSmall = Hu.extraSmall.width)] = 'ExtraSmall'),
                            (u[(u.Small = Hu.small.width)] = 'Small'),
                    ...
                    (function (u) {
                        ((u[(u.ExtraSmall = Hu.extraSmall.height)] = 'ExtraSmall'),
                            (u[(u.Small = Hu.small.height)] = 'Small'),
                            (u[(u.Medium = Hu.medium.height)] = 'Medium'),
                            (u[(u.Large = Hu.large.height)] = 'Large'),
                            (u[(u.ExtraLarge = Hu.extraLarge.height)] = 'ExtraLarge'));
                    })(ee || (ee = {})));
                function te() {
                    return (
                        (te =
                ...
                const re = ['races_point'],
                    ne = (u) => ('overlayType' in u ? u.overlayType : void 0),
                    ae = (u, e) =>
                        re.includes(u.name) ? `R.images.races.gui.maps.icons.rewards.${e}.${u.name}` : Iu(u, e);
                let ie;
                !(function (u) {
                ...
                const se = (u, e, t) => {
                    ...
                    le = (u, e, t = ie.left) => u.split(e).reduce(t === ie.left ? se : oe, []),
                    Ee = (() => {
                        const u = new RegExp(
                    ...
                    Ae = (Eu.Vehicles, Eu.TmanToken, Eu.CollectionItem, 'R.images.gui.maps.icons.tankmen.icons'),
                    Fe = {
                        base: 'StageRewards_base_d7',
                        content: 'StageRewards_content_ef',
                        title: 'StageRewards_title_bf',
                        rewards: 'StageRewards_rewards_42',
                    };
                function De() {
                    return (
                        (De =
                ...
                const me = (u, e) =>
                        'tmanToken' === u.name
                            ? `${Ae}.${e}.${u.bigIcon}`
                            : ((u, e = Au.Small) => {
                                  const t = (u.vehicleName || '').replace(/-/g, '_');
                                  if (u.name === Eu.Vehicles)
                                      switch (e) {
                                          case Au.Mini:
                                          case Au.Small:
                                          case Au.S48x48:
                    ...
                    de = ({ rewards: u }) => {
                        const e = (function (u, e) {
                                const t = (() => {
                                        const u = (0, i.useContext)(Ku),
                                            e = u.width,
                                            t = u.height,
                                            r = ((u) => {
                                                switch (!0) {
                                                    case u.extraLarge:
                                                        return Ju.ExtraLarge;
                                                    case u.large:
                                                        return Ju.Large;
                                                    case u.medium:
                                                        return Ju.Medium;
                                    ...
                                    r = null != e ? e : t.mediaSize < Ju.Medium ? Au.Small : Au.Big;
                                return {
                                    parsedRewards: _(u, (u) => {
                                        let e = te({}, u);
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                ...
                                s().createElement(
                                    'div',
                                    { className: Fe.title },
                                    R.strings.races.tooltip.progressionWidget.stageRewards(),
                                ),
                                s().createElement(
                                    'div',
                                    ...
                                    t.map((u) =>
                                        s().createElement(
                                            $u,
                                            De({ key: u.name, className: Fe.reward }, u, { image: me(u, Au.Big) }),
                                        ),
                                    ),
                                ),
                            ),
                    ...
                    Be = ({ binding: u, text: e = '', classMix: t, alignment: r = ie.left }) =>
                        null === e
                    ...
                    ge = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    pe = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    he = (0, i.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((o = o.replace(t, `%(${a})`)),
                                    (n[a] = _e[u]
                                        ? s().createElement(
                                              'span',
                                              { className: _e[u] },
                                              s().createElement(Be, { text: c, binding: e }),
                                          )
                                        : s().createElement(
                                              'span',
                                              { style: r(u) },
                        ...
                        return s().createElement(Be, { text: o, classMix: t, binding: n });
                    }),
                    be = 'Footer_descriptionItem_6c',
                    we = R.strings.races.tooltip.progressionWidget,
                    ve = () =>
                        s().createElement(
                            'div',
                            { className: 'Footer_base_4a' },
                            s().createElement('div', { className: 'Footer_title_af' }, we.congrats()),
                            s().createElement(
                                'div',
                                { className: 'Footer_descriptionList_7e' },
                                s().createElement(
                                    'div',
                                    { className: be },
                                    s().createElement(he, { text: we.congrats1.description() }),
                                ),
                                s().createElement('div', { className: be }, we.congrats2()),
                            ),
                        ),
                    fe = R.strings.races.tooltip.progressionWidget,
                    Se = () => {
                        const u = h().model,
                            e = u.root.get(),
                            t = e.progressionLevel,
                            r = e.currentPoints,
                            n = e.isProgressionFinished,
                            a = e.currentLevelRewards,
                            i = u.computes.getScorePoint();
                        return s().createElement(
                            'div',
                            { className: 'App_base_1b' },
                            s().createElement('div', { className: 'App_title_c9' }, fe.header()),
                            s().createElement(nu, { progressionLevel: t, currentPoints: r, isProgressionFinished: n }),
                            n
                                ? s().createElement(
                                      s().Fragment,
                                      null,
                                ...
                                : s().createElement(
                                      s().Fragment,
                                      null,
                                      s().createElement(de, { rewards: a }),
                                      s().createElement(lu, { scorePoints: i }),
                                  ),
                        );
                    };
                engine.whenReady.then(() => {
                    F().render(
                        s().createElement(p, null, s().createElement(c, null, s().createElement(Se, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4759));
