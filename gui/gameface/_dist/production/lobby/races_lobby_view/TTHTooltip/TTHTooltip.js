(() => {
    ...
    var u,
        A = {
            99: (u, A, F) => {
                var E = {};
                (F.r(E), F.d(E, { mouse: () => a, onResize: () => o }));
                var e = {};
                (F.r(e),
                    F.d(e, {
                        events: () => E,
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => v, getTextureUrl: () => d }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => x,
                ...
                const o = n('clientResized'),
                    i = { down: n('mousedown'), up: n('mouseup'), move: n('mousemove') },
                    a = (function () {
                ...
                function O(u = 'rem') {
                    ...
                    return 'rem' === u ? A : { x: M(A.x), y: M(A.y) };
                }
                function S() {
                ...
                const X = W().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        W().createElement(
                            'div',
                            K({}, B, {
                                className: t()(Z.base, Z[`base__theme-${D}`], E),
                                ref: function (u) {
                                    ((n.current = u), 'function' == typeof A ? A(u) : A && (A.current = u));
                                },
                            }),
                            W().createElement('div', { className: Z.decorator }, F),
                        )
                    );
                });
                var Y = F(493),
                ...
                const Fu = (u, A, F) => {
                    ...
                    eu = (u, A, F = Au.left) => u.split(A).reduce(F === Au.left ? Fu : Eu, []),
                    Du = (() => {
                        const u = new RegExp(
                    ...
                    Cu = ({ binding: u, text: A = '', classMix: F, alignment: E = Au.left }) =>
                        null === A
                            ...
                            : W().createElement(
                                  ...
                                  A.split('\n').map((A, e) =>
                                      W().createElement(
                                          'div',
                                          { className: t()('FormatText_base_d0', F), key: `${A}-${e}` },
                                          ((u, A, F) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  F && u in F
                                                      ? F[u]
                                              ...
                                              W().createElement(Q.Fragment, { key: `${A}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              );
                ...
                const iu = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: e, mocks: D }) {
                                const B = (0, Q.useRef)([]),
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            t = U.view.addModelObserver(C, A, !0);
                                    ...
                                    r = n[0],
                                    o = n[1],
                                    i = (0, Q.useState)(() => C(u, E, D)),
                                    a = i[0],
                                    s = i[1];
                                return (
                                    (0, Q.useEffect)(() => {
                                        t.current ? s(C(r, E, D)) : (t.current = !0);
                                    }, [D, r, E]),
                                    (0, Q.useEffect)(() => {
                                        o(u);
                                    }, [u]),
                                    (0, Q.useEffect)(
                                        () => () => {
                                            (a.externalModel.dispose(), B.current.forEach((u) => u()));
                                        },
                                        [a],
                                    ),
                                    W().createElement(F.Provider, { value: a }, e)
                                );
                            },
                            () => (0, Q.useContext)(F),
                        ];
                    ...
                    cu = au[1],
                    lu = R.strings.races,
                    du = R.strings.races.lobby.views.vehiclesCarousel.tooltip,
                    vu = (0, tu.Pi)(() => {
                        ...
                        return W().createElement(
                            'div',
                            { className: 'App_base_a4' },
                            W().createElement(
                                'div',
                                { className: 'App_iconContainer_7a' },
                                W().createElement('div', {
                                    className: 'App_icon_60',
                                    style: {
                                        backgroundImage: `url(R.images.races.gui.maps.icons.hangar.TTH.tth${E}_large)`,
                                    },
                                }),
                            ),
                            W().createElement(
                                'div',
                                { className: 'App_description_dc' },
                                W().createElement('div', { className: 'App_title_88' }, du.$dyn(`tth${E}`)),
                                W().createElement(
                                    'div',
                                    { className: 'App_subTitle_66' },
                                    W().createElement(Cu, {
                                        text: lu.tooltip.subHeader.$dyn(`tth${E}`),
                                        binding: { value: E >= 4 ? lu.tth.characteristics.$dyn(`c_${F}`) : F },
                                    }),
                                ),
                                W().createElement(
                                    'div',
                                    { className: 'App_descriptionText_3a' },
                                    lu.tooltip.description.$dyn(`tth${E}`),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    uu().render(
                        W().createElement(su, null, W().createElement(X, null, W().createElement(vu, null))),
