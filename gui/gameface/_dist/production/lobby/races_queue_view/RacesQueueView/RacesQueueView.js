(() => {
    var __webpack_modules__ = {
            ...
            7813: (u, e, t) => {
                ...
                const l = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    D = (u, e, t = A.left) => u.split(e).reduce(t === A.left ? s : F, []),
                    c = (() => {
                        const u = new RegExp(
                ...
                const C = (u = 0, e = 1, t, n, a = !1) => {
                    ...
                    h = ({
                        ...
                        onFinish: E,
                        targetTime: o,
                        useTimeUpdateHook: A = C,
                        isCountUp: l = !1,
                    }) => {
                        const s = A(a, i, o, E, l),
                            F = Math.abs(s) < 3600 ? t : e;
                ...
                const L = f.O.client.getSize('rem'),
                    y = L.width,
                    T = L.height,
                    M = Object.assign({ width: y, height: T }, S(y, T, w)),
                    O = (0, r.createContext)(M),
                    k = ['children'],
                    N = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && l) return b(e, t, h);
                            if (t.largeWidth && s) return b(e, t, h);
                ...
                ((0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(O),
                        ...
                        E = (0, r.useCallback)((u, e) => {
                            ...
                            i(Object.assign({ width: t, height: r }, S(t, r, w)));
                        }, []);
                    (((u) => {
                    ...
                    return n().createElement(O.Provider, { value: o }, u);
                }),
                    (function (u) {
                ...
                const W = ['xl', 'lg', 'md', 'sm', 'xs'],
                    U = (u) => u.includes('_') && ((u) => W.includes(u))(u.split('_').at(-1)),
                    j = [P.ExtraLarge, P.Large, P.Medium, P.Small, P.ExtraSmall],
                    G = (u, e) =>
                ...
                const q = {
                    ...
                    Z = V((u) => {
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, A, s, D, B, P, N, L, C, M, w, S]),
                            U = W.computedStyle,
                            j = W.computedClassNames;
                        return n().createElement('div', z({ className: o()(X.base, ...j, e), style: U }, I), H);
                    }),
                    Q = ({ binding: u, text: e = '', classMix: t, alignment: a = A.left }) =>
                        null === e
                ...
                const nu = Object.keys(uu()),
                    ...
                    lu = V((u) => {
                        ...
                        return n().createElement(
                            ...
                            ru(
                                {
                                    className: o()(eu.base, t && eu[t], p, a),
                                    style: g,
                                    mt: !0 === l ? ou[t || 'paragraph-P16'].mt : l,
                                    mr: !0 === F ? ou[t || 'paragraph-P16'].mr : F,
                                    mb: !0 === c ? ou[t || 'paragraph-P16'].mb : c,
                                    ml: !0 === _ ? ou[t || 'paragraph-P16'].ml : _,
                                },
                                C,
                            ),
                            void 0 !== m ? n().createElement(Q, ru({}, m, { text: e })) : e,
                        );
                    });
                var su = t(5521);
                const Fu = (u) => {
                ...
                function Du(u = su.n.NONE, e = Fu, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== su.n.NONE)
                            return (
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (_u(t, c, { isMouseEvent: !0, on: !0, arguments: Bu(n) }, v),
                                    C && C(),
                            ...
                            pu(
                                {
                                    contentId:
                                        ...
                                        s ? vu.SimpleTooltipHtmlContent('resId') : vu.SimpleTooltipContent('resId')),
                ...
                const wu = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return n().createElement(bu, e, r);
                    const a = e.contentId,
                        i = e.args,
                        E = null == i ? void 0 : i.contentId;
                    return a || E
                        ? n().createElement(du, fu({}, e, { contentId: a || E }), r)
                        : n().createElement(hu, e, r);
                };
                var xu = t(8045);
                let Su, Lu, yu;
                (!(function (u) {
                ...
                const Tu = { [yu.NBSP]: Su.NoBreakSymbol, [yu.ZWNBSP]: Su.NoBreakSymbol, [yu.NEW_LINE]: Su.LineBreak },
                    Mu = {
                    ...
                    Iu = (u, e = '') => {
                        ...
                        return (
                            Pu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: Su.Word, colorTag: e, childList: Hu(u) });
                                },
                                (u) => {
                                    const r = u[0],
                                        n = Tu[r.charAt(0)];
                    ...
                    Ku = (u, e, t, r, a, i) => {
                        ...
                        for (let A = t; A >= 0; A--) {
                            const t = u[A],
                                l = Number(u[A].getAttribute('data-block-type'));
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const D = s.slice(0, s.length - F) + i,
                                    c = e[A];
                            ...
                            }
                            {
                                const u = t.children,
                                    l = e[A],
                                    F = l.props.children,
                                    D = Ku(u, F, u.length - 1, r, a, i),
                                    c = D[0],
                                    B = D[1];
                                if (!(c < 0)) {
                                    const u = F.slice(0, c);
                                    ((o = n().cloneElement(l, l.props, u, B)), (E = A));
                                    break;
                                }
                                a -= s.length;
                            }
                    ...
                    zu = n().memo(
                        ({
                            ...
                            targetId: A,
                            justifyContent: l = Lu.FlexStart,
                            alignContent: s = Lu.FlexStart,
                            truncateIdentify: F = '...',
                        }) => {
                            const D = (0, r.useRef)(null),
                                ...
                                g = (0, r.useMemo)(() => ({ justifyContent: l, alignContent: s }), [s, l]);
                            return (
                                ((u, e, t = !0) => {
                ...
                var $u = t(3403);
                const Zu = 'StatusWarning_horizontalBorder_e5',
                    Qu = 'StatusWarning_wideHorizontalBorder_ad',
                    Ju = (0, r.memo)(({ children: u, classMix: e }) => {
                        const t = o()('StatusWarning_base_ab', e),
                            r = o()(Zu, 'StatusWarning_horizontalBorder__left_75'),
                            a = o()(Qu, 'StatusWarning_wideHorizontalBorder__left_81');
                        return n().createElement(
                            'div',
                            { className: t },
                            ...
                            n().createElement(
                                'div',
                                { className: 'StatusWarning_contentWrapper_35' },
                                n().createElement('div', { className: r }),
                                n().createElement('div', { className: 'StatusWarning_content_cb' }, u),
                ...
                const re = (u) => (0 === u ? window : window.subViews.get(u)),
                    ne = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: a, children: i, mocks: E }) {
                                const o = (0, r.useRef)([]),
                                    A = (u, t, r) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            s = { mode: u, model: l, externalModel: i, cleanup: A };
                                        return {
                                            model: l,
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? _(A(F, a, E)) : (l.current = !0);
                                    }, [E, F, a]),
                                    (0, r.useEffect)(() => {
                                        D(u);
                                    }, [u]),
                    ...
                    ae = ne[0],
                    ie = ne[1],
                    Ee = 'App_smallerText_53',
                    oe = 'App_aligningTextsContainer_70',
                    Ae = R.strings.races_queue,
                    le = (u) => {
                        var e;
                        return null != (e = R.images.races.gui.maps.icons.queueView.$dyn(u))
                            ? e
                            : R.images.races.gui.maps.icons.queueView.common_tank_icon();
                    },
                    se = (0, $u.Pi)(() => {
                        ...
                        return (
                            ...
                            n().createElement(
                                'div',
                                { className: 'App_base_d4' },
                                n().createElement('div', { className: 'App_bg_c7' }),
                                n().createElement(
                                    'div',
                                    { className: 'App_container_be' },
                                    n().createElement(
                                        'div',
                                        { className: 'App_logoContainer_44' },
                                        n().createElement('div', { className: 'App_logoIcon_71' }),
                                        n().createElement(lu, {
                                            text: R.strings.races.headerButtons.battle.types.races(),
                                            className: 'App_logoLabel_e4',
                                        }),
                                    ),
                                    n().createElement(
                                        'div',
                                        { className: 'App_playersInQueueContainer_db' },
                                        n().createElement(lu, {
                                            text: Ae.racesQueue.playersInQueue(),
                                            className: 'App_playersInQueue_1b',
                                        }),
                                        n().createElement(
                                            'div',
                                            { className: 'App_playersInQueueValue_05' },
                                            n().createElement(g, { value: l }),
                                        ),
                                    ),
                                    n().createElement('div', {
                                        className: 'App_vehicleImage_60',
                                        style: { backgroundImage: `url(${le(A)})` },
                                    }),
                                    n().createElement(
                                        'div',
                                        { className: 'App_queueFunctionalContainer_a4' },
                                        n().createElement(
                                            'div',
                                            { className: oe },
                                            n().createElement(lu, { text: Ae.racesQueue.vehicle(), className: Ee }),
                                            n().createElement(lu, { text: A, className: 'App_vehicleNameValue_a4' }),
                                        ),
                                        n().createElement(
                                            'div',
                                            { className: 'App_waitingTimeContainer_04' },
                                            n().createElement(
                                                'div',
                                                { className: oe },
                                                n().createElement(lu, {
                                                    text: Ae.racesQueue.waitingTime(),
                                                    className: Ee,
                                                }),
                                                n().createElement(
                                                    'div',
                                                    { className: 'App_waitingTimeValue_8a' },
                                                    n().createElement(h, { isCountUp: !0 }),
                                                ),
                                            ),
                                            n().createElement(
                                                'div',
                                                {
                                                    className: o()(
                                                        'App_flexWrapper_06',
                                                        'App_leaveButton_container_1c',
                                                    ),
                                                },
                                                n().createElement('div', { className: 'App_texture_0d' }),
                                                n().createElement(
                                                    'button',
                                                    {
                                                        className: 'App_leaveButton_e3',
                                                        onMouseEnter: () => {
                                                            Yu.playHighlight();
                                                        },
                                                        onClick: s,
                                                    },
                                                    Ae.racesQueue.leaveBattleButton(),
                                                ),
                                            ),
                                        ),
                                    ),
                                    e &&
                                        n().createElement(
                                            ...
                                            null,
                                            n().createElement(zu, {
                                                text: Ae.racesQueue.longWaitingTime(),
                ...
                engine.whenReady.then(() => {
                    i().render(
                        n().createElement(ae, null, n().createElement(se, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(7813));
