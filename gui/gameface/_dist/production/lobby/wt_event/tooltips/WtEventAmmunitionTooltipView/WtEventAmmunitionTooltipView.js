(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, E) => {
                (E.r(e),
                    E.d(e, { mouse: () => C, off: () => B, on: () => n, onResize: () => D, onScaleUpdated: () => t }));
                var A = E(2472),
                    F = E(1176);
            ...
            3138: (u, e, E) => {
                ...
                var A = E(5959),
                    F = E(514);
                const D = { view: E(7641), client: A, sound: F.ZP };
            },
            514: (u, e, E) => {
                E.d(e, { ZP: () => t });
                var A = E(5959);
                const F = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    D = Object.keys(F).reduce((u, e) => ((u[e] = () => (0, A.playSound)(F[e])), u), {}),
                            ...
                            const D = e.args,
                                t = (function (u, e) {
                                    ...
                                    var E,
                                        ...
                                        F = {},
                                        D = Object.keys(u);
                                    for (A = 0; A < D.length; A++) ((E = D[A]), e.indexOf(E) >= 0 || (F[E] = u[E]));
                                    return F;
                                })(e, A);
                            return void 0 !== D
            ...
            1358: (u, e, E) => {
                ...
                class F {
                    ...
                    addCallback(u, e, E = 0, F = !0) {
                        ...
                        const D = A.O.view.addModelObserver(u, E, F);
                        return (
                            D > 0
                                ? ((this._callbacks[D] = e),
                                  E > 0 && (this._views[E] ? this._views[E].push(D) : (this._views[E] = [D])))
            ...
            4251: (u, e, E) => {
                let A;
                (E.d(e, { B0: () => A, B3: () => F, Gr: () => D, kH: () => n, lf: () => t }),
                    (function (u) {
                ...
                const F = Object.freeze({ INTEGRAL: 0, GOLD: 1 }),
                    ...
                    t = Object.freeze({ SHORT_FORMAT: 0, LONG_FORMAT: 1 }),
            ...
            8072: (u, e, E) => {
                ...
                const B = (u) => ({ __Type: 'GFBoundingBox', x: u.x, y: u.y, width: u.width, height: u.height }),
                    ...
                    c = (u, e, E = 0) => {
                        i(D.B0.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: E, args: e });
                    },
                    l = (u, e, E, A, t = R.invalid('resId'), n) => {
                    ...
                    _ = () => viewEnv.isWindowShownByViewEvent(D.B0.CONTEXT_MENU),
            ...
            8057: (u, e, E) => {
                ...
                const s = F().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            F().createElement(
                                'div',
                                a({}, s, {
                                    className: B()(i.base, i[`base__theme-${n}`], D),
                                    ref: function (u) {
                ...
                const T = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    I = ({ binding: u, text: e = '', classMix: E, alignment: D = y.left, formatWithBrackets: t }) => {
                    ...
                    U = 'Content_base_c8',
                    V = 'Content_base__hasAnimation_08',
                    W = 'Content_icon_42',
                    K = 'Content_title_12',
                    j = 'Content_description_17',
                    q = 'Content_animation_5d',
                    z = 'Content_textWrapper_89',
                    G = 'Content_textWrapper__hasGradient_f1',
                    $ = 'Content_additionalTextWrapper_a8',
                    H = 'Content_subtitle_91',
                    Y = 'Content_text_bc',
                    Z = R.strings.event.WtEventAmmunitionTooltipView,
                    X = B()(z, G),
                    Q = () => {
                        const u = g('model', f.None),
                            e = u.icon,
                            E = u.title,
                            D = u.description,
                            t = u.animation,
                            n = u.subtitle,
                            r = u.text,
                            C = u.additionalInfoText,
                            i = (0, A.useMemo)(() => ({ backgroundImage: `url(${e})` }), [e]),
                            o = B()(U, t && V);
                        return (
                            (0, A.useEffect)(() => {
                                t && swfPlayer.play(t);
                            ...
                            F().createElement(
                                'div',
                                { className: o },
                                F().createElement('div', { className: W, style: i }),
                                F().createElement('div', { className: K }, E),
                                F().createElement('div', { className: j }, D),
                                t
                                    ? F().createElement(
                                          F().Fragment,
                                          null,
                                          F().createElement('img', {
                                              className: q,
                                              src: `swf://gui/flash/${t}?name=${t}`,
                                          }),
                                          F().createElement(
                                              'div',
                                              { className: z },
                                              F().createElement('div', { className: H }, n),
                                              F().createElement(I, { text: r, classMix: Y }),
                                          ),
                                          F().createElement(
                                              'div',
                                              { className: $ },
                                              F().createElement('div', { className: H }, Z.additionalInfoTitle()),
                                              F().createElement(I, { text: C, classMix: Y }),
                                          ),
                                      )
                                    : F().createElement(
                                          'div',
                                          { className: X },
                                          F().createElement('div', { className: H }, n),
                                          F().createElement('div', { className: Y }, r),
                                      ),
                            )
                        );
                    },
                    J = () => F().createElement(s, null, F().createElement(Q, null));
                engine.whenReady.then(() => {
                    t().render(F().createElement(J, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, E, A) => {
            if (!e) {
                ...
                for (B = 0; B < deferred.length; B++) {
                    for (var [e, E, A] = deferred[B], D = !0, t = 0; t < e.length; t++)
                        (!1 & A || F >= A) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [107], () => __webpack_require__(8057));
