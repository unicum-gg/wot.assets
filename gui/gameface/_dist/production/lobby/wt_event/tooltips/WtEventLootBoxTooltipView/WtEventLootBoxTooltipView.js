(() => {
    ...
    var __webpack_modules__ = {
            ...
            8072: (u, e, E) => {
                ...
                const B = (u) => ({ __Type: 'GFBoundingBox', x: u.x, y: u.y, width: u.width, height: u.height }),
                    ...
                    i = (u) => o(D.B0.MOVE, { isMouseEvent: !0, on: u }),
                    a = () => o(D.B0.CLOSE),
                    s = () => o(D.B0.POP_OVER, { on: !1 }),
                    c = (u, e, E = 0) => {
                        o(D.B0.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: E, args: e });
                    },
            ...
            6526: (u, e, E) => {
                ...
                const s = F().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            F().createElement(
                                'div',
                                a({}, s, {
                                    className: B()(o.base, o[`base__theme-${n}`], D),
                                    ref: function (u) {
                        ...
                        d(() => {
                            if (
                                ...
                                const E = (u) => {
                                    ...
                                    A = h(u);
                                i.current = m.addCallback(A, E, n, e === f.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== f.None)
                ...
                const T = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    V = 'Content_title_78',
                    W = 'Content_icon_01',
                    G = 'Content_icon__hunter_ee',
                    K = 'Content_howItWorksWrapper_15',
                    j = 'Content_subtitle_0a',
                    q = 'Content_description_45',
                    z = R.strings.event.lootBoxTooltip,
                    H = (u, e) => (e ? u.hunter() : u.boss()),
                    $ = () => {
                        const u = g('model').isHunterLootBox,
                            e = B()(W, u && G);
                        return F().createElement(
                            'div',
                            { className: U },
                            F().createElement('div', { className: V }, H(z.title, u)),
                            F().createElement('div', { className: e }),
                            F().createElement(
                                'div',
                                { className: K },
                                F().createElement('div', { className: j }, z.howItWorks.title()),
                                F().createElement('div', { className: q }, H(z.howItWorks.description, u)),
                            ),
                            F().createElement('div', { className: j }, z.howToGet.title()),
                            F().createElement(I, { classMix: q, text: H(z.howToGet.description, u) }),
                        );
                    },
                    Y = () => F().createElement(s, null, F().createElement($, null));
                engine.whenReady.then(() => {
                    t().render(F().createElement(Y, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [107], () => __webpack_require__(6526));
