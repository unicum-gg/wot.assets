(() => {
    ...
    var __webpack_modules__ = {
            ...
            4251: (u, e, A) => {
                let E;
                (A.d(e, { B0: () => E, B3: () => F, Gr: () => D, kH: () => n, lf: () => t }),
                    (function (u) {
            ...
            8413: (u, e, A) => {
                ...
                const v = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    p = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, A) => {
                                const E = l(`${u}.${A}`, window);
                                return v(E) ? e(u, A, E) : `${u}.${A}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    m = (u) => {
                        const e = ((u) => {
                                const e = c(),
                                ...
                                return { modelPrefix: F, modelPath: w(F, u || ''), resId: E };
                            })(),
                            A = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                        ...
                        d(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    E = m(u);
                                o.current = h.addCallback(E, A, n, e === f.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== f.None)
                ...
                const T = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    x = (u, e, A = y.left) => u.split(e).reduce(A === y.left ? k : P, []),
                    S = (() => {
                        const u = new RegExp(
                    ...
                    L = (u, e = y.left) => {
                        ...
                        return ((u, e = y.left) => {
                            ...
                            const E =
                                ...
                                F = T(u);
                            return (x(F, /( )/, e).forEach((u) => (A = A.concat(x(u, E, y.left)))), A);
                        })(u, e);
                    },
                    N = 'FormatText_base_d0',
                    I = ({ binding: u, text: e = '', classMix: A, alignment: D = y.left, formatWithBrackets: t }) => {
                    ...
                    U = 'Content_base_00',
                    V = 'Content_content_62',
                    W = 'Content_title_3f',
                    K = 'Content_descriptionTitle_e9',
                    j = 'Content_description_c5',
                    q = 'Content_titleIcon_89',
                    z = () => {
                        const u = g('model', f.None),
                            ...
                            D = u.description,
                            t = u.icon,
                            n = (0, E.useMemo)(() => ({ backgroundImage: `url(${t})` }), [t]);
                        return F().createElement(
                            'div',
                            { className: U },
                            F().createElement(
                                'div',
                                { className: V },
                                F().createElement('div', { className: q, style: n }),
                                F().createElement('div', { className: W }, e),
                                F().createElement('div', { className: K }, A),
                                F().createElement('div', { className: j }, F().createElement(I, { text: D })),
                            ),
                        );
                    },
                    G = () => F().createElement(s, null, F().createElement(z, null));
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [107], () => __webpack_require__(8413));
