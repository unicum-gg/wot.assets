(() => {
    ...
    var __webpack_modules__ = {
            527: (e, t, n) => {
                (n.r(t),
                    n.d(t, { mouse: () => _, off: () => c, on: () => s, onResize: () => o, onScaleUpdated: () => a }));
                var r = n(2472),
                    i = n(1176);
                ...
                const c = (e) => ({ __Type: 'GFBoundingBox', x: e.x, y: e.y, width: e.width, height: e.height }),
                    ...
                    m = (e, t, n, r, a = R.invalid('resId'), s) => {
                        const d = i.O.view.getViewGlobalPosition(),
                            ...
                            E = _.height,
                            m = {
                                x: i.O.view.pxToRem(u) + d.x,
                                y: i.O.view.pxToRem(v) + d.y,
                    ...
                    h = () => viewEnv.isWindowShownByViewEvent(o.B0.TOOLTIP),
            ...
            6016: (e, t, n) => {
                ...
                const P = (e = 'model', t = T.Deep) => {
                    ...
                    k = 'Content_base_d7',
                    S = 'Content_content_a6',
                    C = 'Content_title_0f',
                    M = 'Content_description_01',
                    L = 'Content_descriptionTitle_a6',
                    N = 'Content_iconBig_d9',
                    x = 'Content_iconSmall_6d',
                    A = 'Content_divider_bc',
                    D = 'Content_divider__top_e1',
                    F = 'Content_divider__bottom_54',
                    B = 'Content_quantityWrapper_37',
                    U = 'Content_quantity_b8',
                    V = 'Content_receiveWrapper_5d',
                    I = R.strings.event.ticketTooltip,
                    W = () => {
                        const e = P('model').quantity,
                            t = void 0 === e ? 0 : e,
                            n = c()(A, D),
                            r = c()(A, F);
                        return i().createElement(
                            ...
                            i().createElement(
                                'div',
                                { className: S },
                                i().createElement('div', { className: C }, I.title()),
                                i().createElement('div', { className: N }),
                                i().createElement('div', { className: M }, I.description()),
                                i().createElement('div', { className: n }),
                                i().createElement(
                                    'div',
                                    { className: B },
                                    i().createElement('div', { className: U }, t),
                                    i().createElement('div', { className: x }),
                                    i().createElement('div', { className: U }, I.quantity()),
                                ),
                                i().createElement('div', { className: r }),
                                i().createElement(
                                    'div',
                                    { className: V },
                                    i().createElement('div', { className: L }, I.receiveTitle()),
                                    i().createElement('div', { className: M }, I.receiveText()),
                                    i().createElement('div', { className: M }, I.receiveAdditionalText()),
                                ),
                            ),
                        );
                    },
                    q = () => i().createElement(w, null, i().createElement(W, null));
                engine.whenReady.then(() => {
                    a().render(i().createElement(q, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [107], () => __webpack_require__(6016));
