(() => {
    ...
    var __webpack_modules__ = {
            ...
            7212: (e, t, n) => {
                ...
                const P = (e = 'model', t = T.Deep) => {
                    ...
                    k = 'Advantage_base_c4',
                    S = 'Advantage_icon_9f',
                    M = 'Advantage_content_a3',
                    C = 'Advantage_title_23',
                    L = 'Advantage_description_77',
                    A = () => {
                        const e = P('model'),
                            t = e.parameter,
                            n = e.icon,
                        ...
                        return i().createElement(
                            'span',
                            { className: k },
                            i().createElement('div', { className: S, style: a }),
                            i().createElement(
                                'div',
                                { className: M },
                                i().createElement('span', { className: C }, s),
                                i().createElement('span', { className: L }, o),
                            ),
                        );
                    },
                    x = 'Content_base_78',
                    N = () => i().createElement('div', { className: x }, i().createElement(A, null)),
                    D = () => i().createElement(w, null, i().createElement(N, null));
                engine.whenReady.then(() => {
                    a().render(i().createElement(D, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [107], () => __webpack_require__(7212));
