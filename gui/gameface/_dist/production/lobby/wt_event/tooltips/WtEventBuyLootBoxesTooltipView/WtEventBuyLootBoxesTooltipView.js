(() => {
    ...
    var __webpack_modules__ = {
            ...
            8574: (u, e, E) => {
                ...
                const T = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    U = ({ binding: u, text: e = '', classMix: E, alignment: D = y.left, formatWithBrackets: t }) => {
                    ...
                    V = 'Content_base_97',
                    I = 'Content_title_ca',
                    W = 'Content_description_87',
                    K = 'Content_icon_02',
                    j = 'Content_amountLeftWrapper_c4',
                    q = 'Content_amountLeft_a8',
                    z = 'Content_divider_aa',
                    G = 'Content_dividerBottom_4c',
                    H = 'Content_infoWrapper_ac',
                    $ = R.strings.event.WtEventBuyLootBoxesTooltipView,
                    Y = () => {
                        const u = g('model'),
                            e = u.amountLeft,
                            E = u.amountMax,
                            D = (0, A.useMemo)(() => ({ amountMax: E }), [E]);
                        return F().createElement(
                            'div',
                            { className: V },
                            F().createElement('div', { className: I }, $.title()),
                            F().createElement('div', { className: W }, $.description()),
                            F().createElement(
                                'div',
                                { className: j },
                                F().createElement('div', { className: q }, e),
                                F().createElement('div', { className: W }, $.amountLeft()),
                            ),
                            F().createElement(
                                'div',
                                { className: H },
                                ...
                                F().createElement(U, { binding: D, text: $.info() }),
                                F().createElement('div', { className: G }),
                            ),
                            F().createElement('div', { className: W }, $.additionalInfo()),
                        );
                    },
                    Z = () => F().createElement(s, null, F().createElement(Y, null));
                engine.whenReady.then(() => {
                    t().render(F().createElement(Z, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [107], () => __webpack_require__(8574));
