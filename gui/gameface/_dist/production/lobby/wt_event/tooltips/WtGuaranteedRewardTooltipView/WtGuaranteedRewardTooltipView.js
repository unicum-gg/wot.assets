(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, E) => {
                (E.r(e),
                    E.d(e, { mouse: () => C, off: () => B, on: () => n, onResize: () => t, onScaleUpdated: () => D }));
                var A = E(2472),
                    F = E(1176);
                const t = (0, A.E)('clientResized'),
                    D = (0, A.E)('self.onScaleUpdated'),
                    n = (u, e) => engine.on(u, e),
            ...
            3138: (u, e, E) => {
                ...
                var A = E(5959),
                    F = E(514);
                const t = { view: E(7641), client: A, sound: F.ZP };
            },
            514: (u, e, E) => {
                E.d(e, { ZP: () => D });
                var A = E(5959);
                const F = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    t = Object.keys(F).reduce((u, e) => ((u[e] = () => (0, A.playSound)(F[e])), u), {}),
                    D = { play: Object.assign({}, t, { sound: A.playSound }), setRTPC: A.setRTPC };
            },
            3722: (u, e, E) => {
                function A(u, e, E = 1) {
                ...
                (E.r(e), E.d(e, { getBgUrl: () => F, getTextureUrl: () => A }));
            },
            6112: (u, e, E) => {
                E.d(e, { W: () => A });
            ...
            7491: (u, e, E) => {
                ...
                const C = F.instance,
                    i = {
                        ...
                        ViewModel: r.Z,
                        ViewEventType: n.B0,
                        NumberFormatType: n.B3,
                        RealFormatType: n.Gr,
                        TimeFormatType: n.lf,
                        DateFormatType: n.kH,
                        makeGlobalBoundingBox: B.Kv,
                        sendMoveEvent: B.wv,
                        sendCloseEvent: B.Sy,
                        sendClosePopOverEvent: B.SW,
                        sendShowContextMenuEvent: B.uk,
                        sendShowPopOverEvent: B.P3,
                        addEscapeListener: B.VM,
                        closeOnEsc: B.SU,
                        handleViewEvent: B.c9,
                        onBindingsReady: B.ry,
                        onLayoutReady: B.Eu,
                        isTooltipShown: B.KE,
                        isContextMenuShown: B.uM,
                        isPopOverShown: B.wU,
            ...
            4251: (u, e, E) => {
                let A;
                (E.d(e, { B0: () => A, B3: () => F, Gr: () => t, kH: () => n, lf: () => D }),
                    (function (u) {
                ...
                const F = Object.freeze({ INTEGRAL: 0, GOLD: 1 }),
                    t = Object.freeze({ FRACTIONAL: 0, WO_ZERO_DIGITS: 1 }),
                    D = Object.freeze({ SHORT_FORMAT: 0, LONG_FORMAT: 1 }),
                    n = Object.freeze({ SHORT_FORMAT: 0, LONG_FORMAT: 1, YEAR_MONTH: 2 });
            },
            8072: (u, e, E) => {
                E.d(e, {
                    Eu: () => C,
                ...
                function n(u, e, E, A, F, t, D) {
                    ...
                    n.done ? e(B) : Promise.resolve(B).then(A, F);
                }
                const B = (u) => ({ __Type: 'GFBoundingBox', x: u.x, y: u.y, width: u.width, height: u.height }),
                    ...
                    o = (u) => i(t.B0.MOVE, { isMouseEvent: !0, on: u }),
                    a = () => i(t.B0.CLOSE),
                    s = () => i(t.B0.POP_OVER, { on: !1 }),
                    c = (u, e, E = 0) => {
                        i(t.B0.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: E, args: e });
                    },
                    l = (u, e, E, A, D = R.invalid('resId'), n) => {
                        const r = F.O.view.getViewGlobalPosition(),
                            ...
                            l = {
                                ...
                                y: F.O.view.pxToRem(a) + r.y,
                                width: F.O.view.pxToRem(s),
                    ...
                    d = () => viewEnv.isWindowShownByViewEvent(t.B0.TOOLTIP),
                    _ = () => viewEnv.isWindowShownByViewEvent(t.B0.CONTEXT_MENU),
                    v = () => viewEnv.isWindowShownByViewEvent(t.B0.POP_OVER),
                    w = (u, e) => {
            ...
            6063: (u, e, E) => {
                ...
                const s = F().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            F().createElement(
                                'div',
                                a({}, s, {
                                    className: B()(i.base, i[`base__theme-${n}`], t),
                                    ref: function (u) {
                                        ((l.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                    },
                                }),
                                F().createElement('div', { className: i.decorator }, E),
                            )
                        );
                    }),
                    c = (u = 1) => {
                ...
                const v = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    m = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, E) => {
                                const A = l(`${u}.${E}`, window);
                                return v(A) ? e(u, E, A) : `${u}.${E}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    p = (u) => {
                        const e = ((u) => {
                                const e = c(),
                        ...
                        d(() => {
                            if (
                                ...
                                const E = (u) => {
                                    ...
                                    A = p(u);
                                o.current = h.addCallback(A, E, n, e === f.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== f.None)
                                return () => {
                                    h.removeCallback(o.current, n);
                                };
                        }, [n, e]),
                        C
                    );
                ...
                const T = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    x = (u, e, E = y.left) => u.split(e).reduce(E === y.left ? k : P, []),
                    S = (() => {
                        const u = new RegExp(
                    ...
                    L = (u, e = y.left) => {
                        ...
                        return ((u, e = y.left) => {
                            ...
                            const A =
                                ...
                                F = T(u);
                            return (x(F, /( )/, e).forEach((u) => (E = E.concat(x(u, A, y.left)))), E);
                        })(u, e);
                    },
                    N = 'FormatText_base_d0',
                    I = ({ binding: u, text: e = '', classMix: E, alignment: t = y.left, formatWithBrackets: D }) => {
                        ...
                        return F().createElement(
                            ...
                            n.split('\n').map((e, D) =>
                                F().createElement(
                                    'div',
                                    { className: B()(N, E), key: `${e}-${D}` },
                                    ((u, e, E) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (E && u in E ? E[u] : L(u, e))))(
                                        e,
                                        t,
                                        u,
                    ...
                    U = 'Content_base_8e',
                    V = 'Content_title_3e',
                    W = 'Content_description_93',
                    K = 'Content_highlight_fa',
                    j = 'Content_portalRunsLeftWrapper_9b',
                    q = 'Content_divider_e7',
                    z = 'Content_dividerBottom_71',
                    G = 'Content_portalRunsLeft_3d',
                    H = 'Content_subtitle_9c',
                    $ = 'Content_tanks_49',
                    Y = 'Content_tank_b2',
                    Z = R.strings.event.WtGuaranteedRewardTooltipView,
                    X = () => {
                        const u = g('model'),
                            e = u.tanks,
                            E = u.guaranteedAward,
                            t = (0, A.useMemo)(
                                () => ({
                                    portalRuns: F().createElement(I, {
                                        text: Z.portalRuns(),
                                        binding: { count: E.guaranteedTankAttemptCount },
                                        classMix: K,
                                    }),
                                }),
                                [E.guaranteedTankAttemptCount],
                            );
                        return F().createElement(
                            'div',
                            { className: U },
                            F().createElement('div', { className: V }, Z.title()),
                            F().createElement(I, {
                                text: E.isIgnored ? Z.allCollected() : Z.description(),
                                binding: t,
                                classMix: W,
                            }),
                            !E.isIgnored &&
                                F().createElement(
                                    ...
                                    F().createElement('div', { className: K }, E.leftAttemptsCount),
                                    F().createElement('div', { className: G }, Z.portalRunsLeft()),
                                    F().createElement('div', { className: z }),
                                ),
                            F().createElement('div', { className: H }, Z.vehiclesTitle()),
                            F().createElement('div', { className: W }, Z.vehiclesDescription()),
                            F().createElement(
                                'div',
                                { className: $ },
                                e.items.map(({ value: { name: u } }, e) =>
                                    F().createElement('div', { key: e, className: Y }, u),
                                ),
                            ),
                        );
                    },
                    Q = () => F().createElement(s, null, F().createElement(X, null));
                engine.whenReady.then(() => {
                    D().render(F().createElement(Q, null), document.getElementById('root'));
                });
            },
        },
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.O = (u, e, E, A) => {
            if (!e) {
                ...
                for (B = 0; B < deferred.length; B++) {
                    for (var [e, E, A] = deferred[B], t = !0, D = 0; D < e.length; D++)
                        (!1 & A || F >= A) &&
            ...
            A = A || 0;
            for (var B = deferred.length; B > 0 && deferred[B - 1][2] > A; B--) deferred[B] = deferred[B - 1];
            deferred[B] = [e, E, A];
        }),
        ...
        (() => {
            ...
            var e = (e, E) => {
                    ...
                    for (e && e(E); B < t.length; B++)
                        ((F = t[B]), __webpack_require__.o(u, F) && u[F] && u[F][0](), (u[F] = 0));
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [107], () => __webpack_require__(6063));
