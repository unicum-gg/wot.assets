(() => {
    var __webpack_modules__ = {
            ...
            4251: (u, e, t) => {
                'use strict';
                let n;
                (t.d(e, { B0: () => n, B3: () => r, Gr: () => a, kH: () => o, lf: () => i }),
                    (function (u) {
            ...
            8072: (u, e, t) => {
                ...
                const s = (u) => ({ __Type: 'GFBoundingBox', x: u.x, y: u.y, width: u.width, height: u.height }),
                    ...
                    F = (u) => A(a.B0.MOVE, { isMouseEvent: !0, on: u }),
                    c = () => A(a.B0.CLOSE),
                    d = () => A(a.B0.POP_OVER, { on: !1 }),
                    m = (u, e, t = 0) => {
                        A(a.B0.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                    },
                    D = (u, e, t, n, i = R.invalid('resId'), o) => {
                        const l = r.O.view.getViewGlobalPosition(),
                            ...
                            m = E.height,
                            D = {
                                x: r.O.view.pxToRem(F) + l.x,
                                y: r.O.view.pxToRem(c) + l.y,
                    ...
                    h = () => viewEnv.isWindowShownByViewEvent(a.B0.POP_OVER),
                    C = (u, e) => {
            ...
            8224: (u, e, t) => {
                ...
                const F = s.O.client.getSize('rem'),
                    c = F.width,
                    d = F.height,
                    m = Object.assign({ width: c, height: d }, A(c, d, l)),
                ...
                const B = (u) => {
                    ...
                    const r = (0, n.useContext)(D),
                        ...
                        p = { extraLarge: B, large: h, medium: C, small: g, extraSmall: v };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && c) return o(e, t, p);
                ...
                const S = {
                    ...
                    k = (u) => {
                        ...
                        const a = y(),
                            ...
                            o = a.mediaHeight,
                            s = a.mediaSize;
                        return r().createElement('div', T({ className: v()(t, S[i], O[o], M[s]) }, n), e);
                    },
                    P = ['children'];
                const I = (u) => {
                    let e = u.children,
                        ...
                        return (
                            (0, n.useEffect)(() => {
                                ...
                                switch (_) {
                                    ...
                                    case 'stop':
                                        return (function () {
                                            const u = 0 === A && C ? { path: C, x: 0, y: 0 } : a(A),
                                                e = new Image();
                                            e.src = u.path;
                                            const n = () => t(uu(u, e));
                                            return (
                            ...
                            r().createElement('canvas', Z({}, g, { width: e, height: t, ref: v }))
                        );
                    }),
                    J = (u, e) => {
                        let t = u;
                ...
                const au = (u) => {
                    ...
                    return r().createElement(
                        'div',
                        ru({ className: c }, l),
                        r().createElement('div', { className: tu.bg }),
                        r().createElement('div', { className: tu.pattern }),
                        r().createElement(
                            'div',
                            { className: v()(tu.value, A && tu.value__text) },
                            F ? o : E,
                            F && r().createElement('span', { className: tu.plus }, '+'),
                        ),
                    );
                };
                        ...
                        const v = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, n.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (lu(t, d, { isMouseEvent: !0, on: !0, arguments: su(r) }, p),
                                    h && h(),
                ...
                const gu = (u, e) => {
                        const t = ((u) => {
                            ...
                            n = t.day,
                            r = t.month;
                        return Cu(u, { day: n, month: R.strings.menu.dateTime.months.$num(r + 1) });
                    },
                    vu = (u, e, t) => {
                        const n = ((u, e) => {
                        ...
                        return Cu(u, {
                            startDay: r,
                            endDay: i,
                            startMonth: R.strings.menu.dateTime.months.$num(a + 1),
                            endMonth: R.strings.menu.dateTime.months.$num(o + 1),
                        });
                    },
                    pu = (u, e, t) => {
                        const n = ((u) => {
                            ...
                            a = n.minutes,
                            i = n.totalDays;
                        if (u === Au.After) return gu(R.strings.event.WTEventsEntryPoint.after(), t);
                        if (u === Au.Active || u === Au.NotPrimeTime) {
                            const u = ((u, e) =>
                                u > 0
                                    ? R.strings.menu.Time.timeValueShort.days()
                                    : e > 0
                                      ? R.strings.menu.Time.timeValueShort.hours()
                                      : R.strings.menu.Time.timeValueShort.min())(i, r);
                            return Cu(u, { day: i, hour: r, min: a });
                        }
                        return '';
                    },
                    wu = {
                        base: 'App_base_d9',
                        base__notPrimeTime: 'App_base__notPrimeTime_0e',
                        base__base__before: 'App_base__base__before_a7',
                        bg: 'App_bg_02',
                        base__single: 'App_base__single_59',
                        base__active: 'App_base__active_c2',
                        base__disabled: 'App_base__disabled_96',
                        overlay: 'App_overlay_7a',
                        shadow: 'App_shadow_c1',
                        content: 'App_content_6d',
                        title: 'App_title_ce',
                        base__after: 'App_base__after_bd',
                        base__mini: 'App_base__mini_43',
                        base__after__mini: 'App_base__after__mini_67',
                        base__before: 'App_base__before_06',
                        subtitle: 'App_subtitle_6a',
                        highlight: 'App_highlight_33',
                        highlight__default: 'App_highlight__default_65',
                        highlight__mini: 'App_highlight__mini_89',
                        lootBoxCounts: 'App_lootBoxCounts_4a',
                        value: 'App_value_2d',
                        value__hunter: 'App_value__hunter_01',
                        performanceIcon: 'App_performanceIcon_a6',
                        newLabel: 'App_newLabel_92',
                        seasonDate: 'App_seasonDate_51',
                        seasonDateIcon: 'App_seasonDateIcon_0d',
                        seasonDateText: 'App_seasonDateText_4c',
                        base__before__mini: 'App_base__before__mini_65',
                        particles: 'App_particles_ee',
                        redLine: 'App_redLine_d8',
                        afterEventText: 'App_afterEventText_98',
                        'zoom-in': 'App_zoom-in_4d',
                        'zoom-out': 'App_zoom-out_2d',
                        'brightness-in': 'App_brightness-in_ae',
                        'brightness-out': 'App_brightness-out_2c',
                    };
                function bu() {
                    return (
                        (bu =
                ...
                const fu = {
                        [Au.Before]: wu.base__before,
                        [Au.Active]: wu.base__active,
                        [Au.NotPrimeTime]: wu.base__notPrimeTime,
                        [Au.After]: wu.base__after,
                    },
                    xu = {
                        [Au.Before]: wu.base__before__mini,
                        [Au.Active]: wu.base__active__mini,
                        [Au.NotPrimeTime]: wu.base__notPrimeTime__mini,
                        [Au.After]: wu.base__after__mini,
                    },
                    yu = {
                        width: 280,
                        height: 170,
                        ...
                        getChunkPath: () => R.images.gui.maps.icons.wtevent.entryPoint.particles_sequence(),
                    },
                    Lu = (function (u) {
                        const e = u.chunk,
                            t = e.rows * e.columns;
                    ...
                    Tu = ({ isDisabled: u, isNew: e, performanceRisk: t }) =>
                        u || !e
                            ? null
                            : r().createElement(
                                  'div',
                                  { className: wu.newLabel },
                                  e &&
                                      t === Fu.LowRisk &&
                                      r().createElement(au, {
                                          size: 'small',
                                          value: R.strings.event.WTEventsEntryPoint.new(),
                                      }),
                              ),
                    Su = ({ state: u, endDateText: e, seasonDateText: t, leftTime: n, endTime: a }) => {
                        const i = r().createElement(
                            r().Fragment,
                            null,
                            r().createElement('div', { className: wu.seasonDateIcon }),
                            r().createElement('div', { className: wu.seasonDateText }, pu(u, n, a)),
                        );
                        return (
                            {
                                [Au.After]: r().createElement('div', { className: wu.seasonDateText }, e),
                                [Au.Before]: r().createElement('div', { className: wu.seasonDateText }, t),
                                [Au.Active]: i,
                                [Au.NotPrimeTime]: i,
                            }[u] || null
                        );
                    },
                    Ou = ({ state: u, hunterLootBoxesCount: e, bossLootBoxesCount: t }) => {
                        if (u === Au.Before) return null;
                        const n = '1000+';
                        return r().createElement(
                            'div',
                            { className: wu.lootBoxCounts },
                            r().createElement(
                                Eu,
                                {
                                ...
                                r().createElement(
                                    'div',
                                    { className: v()(wu.value, wu.value__hunter) },
                                    e > Bu ? n : e,
                                ),
                            ),
                            r().createElement(
                                ...
                                r().createElement('div', { className: wu.value }, t > Bu ? n : t),
                            ),
                        );
                    },
                    Mu = (0, _u.Pi)(() => {
                        const u = z(),
                            ...
                            i = e.endTime,
                            o = e.startTime,
                            s = e.hunterLootBoxesCount,
                            l = e.bossLootBoxesCount,
                            E = e.performanceRisk,
                            A = e.isSingle,
                            F = e.isNew,
                            c = u.controls.onClick,
                            d = y().mediaSize,
                            m = (d === b.ExtraSmall || d === b.Small) && !A.get(),
                            D = t.get(),
                            _ = i.get(),
                            B = [Au.After, Au.Before].includes(D),
                            h = (0, n.useCallback)(() => {
                                (mu(R.sounds.yes1()), c());
                            }, [c]),
                            C = v()(
                                ...
                                fu[D],
                                B && wu.base__disabled,
                                A.get() && wu.base__single,
                                m && wu.base__mini,
                                m && xu[D],
                            ),
                            g = v()(wu.highlight, m ? wu.highlight__mini : wu.highlight__default),
                            p = (function (u = {}, e = []) {
                                var t, r, a, i;
                                const o = (0, n.useState)(null != (t = u.state) ? t : Y),
                                    s = o[0],
                                    l = o[1],
                                    E = (0, n.useState)(null != (r = u.initialFrameIndex) ? r : q),
                                    A = E[0],
                                    F = E[1],
                                    c = (0, n.useState)(null != (a = u.frameTime) ? a : $),
                                    d = c[0],
                                    m = c[1],
                                    D = (0, n.useState)(null != (i = u.loop) ? i : K),
                                    _ = D[0],
                                    B = D[1],
                                    h = (0, n.useRef)(A),
                                    C = (0, n.useCallback)((u) => {
                                    ...
                                    p = (0, n.useCallback)(() => l('play'), []),
                                    w = (0, n.useCallback)(() => {
                                        (F(h.current + 1), l('stop'));
                                    }, []);
                                return {
                                    props: {
                                        state: s,
                            ...
                            w = (0, n.useMemo)(
                                () => ((u, e) => vu(R.strings.event.WTEventsEntryPoint.before(), u, e))(o.get(), _),
                                [o, _],
                            ),
                            f = (0, n.useMemo)(
                                () =>
                                    ((u) => {
                                        const e = new Date(1e3 * u),
                                            t = e.getDate(),
                                            n = e.getMonth();
                                        return Cu(R.strings.event.WTEventsEntryPoint.after(), {
                                            day: t,
                        ...
                        return r().createElement(
                            'div',
                            { className: C, onClick: h, onMouseOver: Du.playHighlight },
                            r().createElement('div', { className: wu.bg }),
                            B && r().createElement('div', { className: wu.overlay }),
                            r().createElement('div', { className: wu.shadow }),
                            r().createElement(Ou, {
                                state: D,
                                bossLootBoxesCount: l.get(),
                                hunterLootBoxesCount: s.get(),
                            }),
                            D === Au.Active &&
                                r().createElement(
                                    r().Fragment,
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: wu.title },
                                    R.strings.event.WTEventsEntryPoint.title(),
                                ),
                                r().createElement(
                                    'div',
                                    { className: wu.subtitle },
                                    R.strings.event.WTEventsEntryPoint.subtitle(),
                                ),
                                D === Au.After &&
                                    r().createElement(
                                        'div',
                                        { className: wu.afterEventText },
                                        R.strings.event.WTEventsEntryPoint.afterDescription(),
                                    ),
                                r().createElement(
                                    'div',
                                    { className: wu.seasonDate },
                                    D === Au.NotPrimeTime && r().createElement('div', { className: wu.redLine }),
                                    r().createElement(Su, {
                                        state: D,
                                        seasonDateText: w,
                                        endDateText: f,
                            ...
                            r().createElement(Tu, { isDisabled: B, isNew: F.get(), performanceRisk: E.get() }),
                            E.get() !== Fu.LowRisk &&
                                r().createElement(
                                    Eu,
                                    {
                                        contentId:
                                            R.views.lobby.wt_event.tooltips.WtEventPerformanceTooltipView('resId'),
                                    },
                                    r().createElement('div', { className: wu.performanceIcon }),
                                ),
                        );
                    });
                engine.whenReady.then(() => {
                    i().render(
                        r().createElement(V, null, r().createElement(I, null, r().createElement(Mu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [107], () => __webpack_require__(8224));
