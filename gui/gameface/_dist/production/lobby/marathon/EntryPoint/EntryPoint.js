(() => {
    ...
    var __webpack_modules__ = {
            70: (u, e, t) => {
                ...
                const m = {
                    ...
                    p = Object.keys(h).reduce((u, e) => ((u[e] = () => _(h[e])), u), {}),
                    b = { play: Object.assign({}, p, { sound: _ }), setRTPC: B };
                var w = t(690);
                function v(u, e, t = 1) {
                ...
                const ou = { view: r, client: a, sound: b, intl: g };
            },
            521: (u, e, t) => {
                let n, a;
                (t.d(e, { n: () => n }),
            ...
            671: (u, e, t) => {
                ...
                var o;
                function E(u = r.O.client.getSize('rem')) {
                    const e = u.width,
                        t = u.height;
                ...
                (0, n.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && D) return i(e, t, b);
                ...
                const p = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    v = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: a, modelPath: b(a, u || ''), resId: n };
                            })(),
                            t = e.modelPrefix,
                            n = u.split('.');
                        if (n.length > 0) {
                        ...
                        g(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = v(u);
                                D.current = x.addCallback(n, t, o, e === S.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== S.None)
                ...
                const N = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    W = (u, e, t = k.left) => u.split(e).reduce(t === k.left ? M : I, []),
                    z = (() => {
                        const u = new RegExp(
                            [
                    ...
                    H = (u, e = k.left) => {
                        ...
                        return ((u, e = k.left) => {
                            ...
                            const n =
                                ...
                                a = N(u);
                            return (W(a, /( )/, e).forEach((u) => (t = t.concat(W(u, n, k.left)))), t);
                        })(u, e);
                    };
                    ...
                    X = (0, n.memo)(
                        ({ size: u, lineRef: e, disabled: t, baseStyles: n, isComplete: i, withoutBounce: r }) => {
                            ...
                            return a().createElement(
                                ...
                                a().createElement('div', { className: Z.gradient }),
                                o && a().createElement(Y, { size: u }),
                            );
                        },
                    ),
                    Q = (u, e) => {
                ...
                const eu = 'ProgressBarDeltaGrow_base_7e',
                    ...
                    su = (0, n.memo)(
                        ({
                            ...
                            const p = (0, n.useMemo)(() => Object.assign({ width: '100%' }, ru(u), au(A)), [A, u]),
                                b = (0, n.useMemo)(() => Object.assign({ width: '0%' }, ru(u), au(A)), [A, u]),
                                w = (0, n.useMemo)(() => Object.assign({ width: '0%' }, iu(A, i), ru(u)), [i, A, u]),
                                v = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(s - i)}%` }, iu(A, i), ru(u)),
                                    [i, A, s, u],
                                );
                            if (_) return null;
                            const f = d()(eu, l, A && 0 === s && tu);
                            return a().createElement(
                                'div',
                                { style: B ? w : v, className: f },
                                a().createElement(
                                    'div',
                                    { style: m ? b : p, className: nu },
                                    a().createElement(Y, { size: r }),
                                ),
                            );
                        },
                    ),
                    ...
                    Eu = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    Au = (0, n.memo)(
                        ({
                            ...
                            return _
                                ...
                                : a().createElement(
                                      'div',
                                      { className: Eu, style: g },
                                      a().createElement(
                                          'div',
                                          { style: B ? C : m, className: lu },
                                          a().createElement(Y, { size: r }),
                                      ),
                                  );
                        },
                ...
                const _u = (0, n.memo)((u) => {
                        ...
                        switch (i.animationSettings.type) {
                            case V.Simple:
                                return a().createElement(Fu, cu({}, i, { onEndAnimation: E, isComplete: s }));
                            case V.Growing:
                    ...
                    Bu = ({ size: u, value: e, lineRef: t, disabled: i, onComplete: r }) => {
                        ...
                        return (
                            ...
                            a().createElement(X, { size: u, disabled: i, baseStyles: s, isComplete: o, lineRef: t })
                        );
                    },
                    du = ['onEndAnimation'];
                function Cu() {
                ...
                const hu = (0, n.memo)(
                        ({
                            ...
                            return s.withStack
                                ? a().createElement(mu, A)
                                : a().createElement(_u, gu({ key: `${i}-${e}-${r}` }, A));
                        },
                    ),
                    pu = (u) => {
                        var e, t, n, a, i, r, s, o, E, l, A, F, D, c, _, B, d, C, m, g;
                        return {
                            ...
                            '--progress-line-filter': null != (i = u.line.filter) ? i : 'none',
                            ...
                            '--progress-pattern-size': null != (r = u.pattern.size) ? r : '3rem 10rem',
                            ...
                            '--progress-glow-small-width':
                                null != (_ = null == (B = u.glowSettings) ? void 0 : B.smallWidth) ? _ : '44rem',
                            '--progress-glow-small-height':
                                null != (d = null == (C = u.glowSettings) ? void 0 : C.smallHeight) ? d : '43rem',
                ...
                const vu = {
                        ...
                        ({
                            ...
                            const B = (function (u, e, t) {
                                return (0, n.useMemo)(() => {
                                    ...
                                    return { value: n, deltaFrom: wu(n, e, t) };
                                }, [t, e, u]);
                            })(o, u, E);
                            return a().createElement(
                                'div',
                                { className: d()(G.base, _, G[`base__${t}`]), style: pu(e) },
                                !s && a().createElement(K, { size: t }),
                                a().createElement(hu, {
                                    size: t,
                                    lineRef: A,
                                    disabled: r,
                    ...
                    Pu = (0, n.memo)(({ quest: u, size: e, isGrind: t, isQuestDone: n, isPostProgression: i = !1 }) => {
                        ...
                        (r && s
                            ...
                            : r
                              ...
                              : s && (F = s.value.iconKey),
                            'award' === F && (F = 'damage'));
                        const D = d()(Su.base, Su[`base__${e}`], i && Su.base__postProgression),
                            c = d()(Su.iconImg, Su[`iconImg__${F}`]),
                            _ = d()(Su.text, n && Su.text__done),
                            B = d()(Su.value, E > 0 && Su.value__active),
                            C = d()(Su.box, i && Su.box__post),
                            m = d()(Su.progress, i && Su.progress__postProgression);
                        return a().createElement(
                            'div',
                            { className: D },
                            a().createElement(
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(
                                            ...
                                            a().createElement(
                                                'span',
                                                { className: B },
                                                a().createElement(j, { value: n ? A : E }),
                                            ),
                                            ' / ',
                                            a().createElement(j, { value: A }),
                                        ),
                                    ),
                            ),
                            a().createElement(
                                'div',
                                { className: m },
                                a().createElement(xu, { value: n ? A : E, maxValue: A, size: U.Small }),
                            ),
                        );
                    }),
                    yu = {
                        ...
                        return a().createElement(
                            ...
                            n &&
                                a().createElement(
                                    ...
                                    a().createElement('span', { className: yu.icon }),
                                    a().createElement(
                                        'span',
                                        { className: yu.iconText },
                    ...
                    Ou = (0, n.memo)(({ size: u }) => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: ku.box },
                                n.items && n.items.length && a().createElement(Pu, { quest: n.items[0], size: u }),
                                a().createElement(
                                    'div',
                                ...
                                t.items &&
                                    t.items.length &&
                                    a().createElement(Pu, { quest: t.items[0], size: u, isGrind: !0, isQuestDone: !1 }),
                            ),
                        );
                    }),
                    Lu = 'FormatText_base_d0',
                    Ru = ({ binding: u, text: e = '', classMix: t, alignment: i = k.left, formatWithBrackets: r }) => {
                ...
                const Mu = {
                    ...
                    Iu = R.strings.marathon.entryPoint,
                    Wu = ({ isSmall: u, isAllPrizesInHangar: e, size: t }) => {
                        const i = P('model'),
                            r = i.state,
                            s = i.discount,
                            o = i.isPremShopURL,
                            ...
                            A = 1 === r,
                            F = 3 === r,
                            D = L(Iu.discountText(), { discount: s }),
                            c = E ? Iu.styleName() : Iu.vehicleName(),
                            _ = (0, n.useMemo)(() => new Date(), []),
                            B = (0, n.useMemo)(
                                () => ({
                                    day: a().createElement(
                                        'span',
                                        { className: d()(Mu.text__date, Mu.text__dateActive) },
                                        _.getDate(),
                                    ),
                                    month: a().createElement(
                                        'span',
                                        { className: Mu.text__date },
                                        R.strings.menu.dateTime.months.$num(_.getMonth() + 1),
                                    ),
                                }),
                                [_],
                            ),
                            C = (0, n.useMemo)(
                                () => ({
                                    chapter: a().createElement(
                                        'span',
                                        { className: d()(Mu.text, Mu.text__active) },
                                        (0, Nu.cg)(E ? 2 : 1),
                                    ),
                                    ...
                                    discount: a().createElement(
                                        'span',
                                        { className: d()(Mu.finishedText, Mu.finishedText__discount) },
                                        D,
                                    ),
                                    vehicleLabel: a().createElement('span', { className: Mu.label }),
                                    icon: o && a().createElement('div', { className: Mu.icon }),
                                    name: a().createElement('span', { className: d()(Mu.text, Mu.text__name) }, c),
                                    date: a().createElement(Ru, {
                                        classMix: Mu.text,
                        ...
                        E
                            ? ((m =
                                  0 === s
                                      ? Iu.postProgression.finalNoDiscountText()
                                      : Iu.postProgression.finalDiscountText()),
                              (g = Iu.chapterDateText()))
                            : ((m =
                                  0 === s
                                      ? Iu.finalNoDiscountText.long()
                                      : t === Gu.ThinExtraSmall
                                        ? Iu.finalDiscountText.short()
                                        : Iu.finalDiscountText.long()),
                              (g = Iu.chapterStageText()));
                        const h = d()(Mu.base, Mu[`base__${t}`], u && Mu.base__small, F && Mu.base__finished),
                            p = d()(Mu.stageWrapper, o && Mu.stageWrapper__indent);
                        return a().createElement(
                            'div',
                            { className: h },
                            A &&
                            ...
                            F &&
                                a().createElement(
                                    'div',
                                    { className: p },
                                    a().createElement(Ru, { classMix: Mu.text, text: m, binding: C }),
                                ),
                            a().createElement('div', { className: Mu.shadow }),
                        );
                    },
                    zu = {
                        ...
                        ({
                            ...
                            const E = (0, n.useMemo)(() => ({ time: a().createElement('span', null, e) }), [e]),
                                l = d()(
                                    ...
                                    !e && o && zu.base__hidden,
                                    r && zu.base__finished,
                                    s && zu.base__notStarted,
                                );
                            return a().createElement(
                                'div',
                                { className: l },
                                !i && a().createElement('div', { className: zu.shadow }),
                                a().createElement('div', { className: zu.icon }),
                                a().createElement(Ru, { classMix: zu.title, text: u, binding: E }),
                            );
                        },
                    ),
                    Hu = {
                ...
                const Uu = {
                    ...
                    Vu = () => {
                        const u = P('model'),
                            ...
                            l = u.isVehicleStyleInHangar,
                            A = u.isPostQuestDone,
                            F = u.onClick,
                            D = 0 === t,
                            c = 1 === t,
                            _ = c && Math.floor(i / 3600) < 24,
                            B = c && o && !A,
                            C = 3 === t,
                            m = c && e > 0,
                            g = E && l;
                        let h = r;
                        B && (h = s);
                        const p = (0, n.useState)(Gu.Big),
                            b = p[0],
                            w = p[1];
                        (0, n.useEffect)(() => {
                            const u = (u) => {
                                const e = Uu[`${u.width}*${u.height}`];
                                e && w(e);
                            };
                            return (
                        ...
                        const v = b === Gu.ThinSmall || b === Gu.ThinExtraSmall,
                            f = (0, n.useCallback)(() => {
                                (y(R.sounds.play()), F());
                            }, [F]);
                        let x = '';
                        ((_ || B) && (x = ju.untilEndText()),
                            C && (x = ju.finalSaleText()),
                            D && (x = ju.untilStartText()));
                        const S = L(ju.activeDiscountText(), { discount: e }),
                            T = d()(Hu.base, Hu[`base__${b}`], D && Hu.base__notStarted),
                            k = d()(Hu.bg, o && Hu.bg__post),
                            O = d()(
                                Hu.subTitleWrapper,
                                (_ || B) && Hu.subTitleWrapper__alert,
                                C && Hu.subTitleWrapper__finished,
                            ),
                            N = d()(Hu.title, _ && Hu.title__short),
                            M = a().createElement(
                                'div',
                                { className: O },
                                a().createElement($u, {
                            ...
                            I = a().createElement(Wu, { isSmall: v, size: b, isAllPrizesInHangar: g });
                        return a().createElement(
                            'div',
                            { className: T, onClick: f, onMouseEnter: () => y(R.sounds.highlight()) },
                            a().createElement(
                                'div',
                                { className: Hu.bgWrapper },
                                a().createElement('div', { className: k }),
                                a().createElement('div', { className: Hu.bgHighlight }),
                                m && a().createElement('div', { className: Hu.sparkles }),
                            ),
                            a().createElement('div', { className: Hu.stroke }),
                            C && a().createElement('div', { className: Hu.highlight }),
                            m &&
                                !g &&
                                a().createElement(
                                    'div',
                                    { className: Hu.discount },
                                    a().createElement('div', { className: Hu.discountText }, S),
                                    a().createElement('div', { className: Hu.discountLight }),
                                ),
                            a().createElement(
                                'div',
                                { className: Hu.mainTitleWrapper },
                                a().createElement(
                                    'div',
                                    { className: Hu.titleWrapper },
                                    a().createElement('div', { className: N }, ju.title()),
                                ),
                                !D && x && M,
                                c && I,
                            ),
                            D && x && M,
                            !c && I,
                            c && o && a().createElement(Tu, { size: b }),
                            c && !o && a().createElement(Ou, { size: b }),
                        );
                    };
                engine.whenReady.then(() => {
                    _().render(
                        a().createElement(D, null, a().createElement(Vu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [639], () => __webpack_require__(671));
