    ...
    var __webpack_modules__ = {
            ...
            671: (u, e, t) => {
                ...
                const z = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    j = (u, e, t = M.left) => u.split(e).reduce(t === M.left ? H : $, []),
                    G = (() => {
                        const u = new RegExp(
                    ...
                    V = (u, e = M.left) => {
                        ...
                        return ((u, e = M.left) => {
                            ...
                            const n =
                                ...
                                a = z(u);
                            return (j(a, /( )/, e).forEach((u) => (t = t.concat(j(u, n, M.left)))), t);
                        })(u, e);
                    };
                ...
                const wu = (0, n.memo)(
                    ...
                    Tu = (0, n.memo)(
                        ({
                            ...
                            return a().createElement(
                                'div',
                                { className: p()(q.base, q[`base__${t}`]), style: fu(e) },
                ...
                const Hu = {
                    ...
                    $u = R.strings.marathon.entryPoint,
                    ju = ({ isSmall: u, isAllPrizesInHangar: e, size: t }) => {
                        const i = O('model'),
                            r = i.state,
                            s = i.discount,
                            o = i.isPremShopURL,
                            ...
                            l = 1 === r,
                            F = 3 === r,
                            D = W($u.discountText(), { discount: s }),
                            _ = E ? $u.styleName() : $u.vehicleName(),
                            c = (0, n.useMemo)(() => new Date(), []),
                            B = (0, n.useMemo)(
                                () => ({
                                    day: a().createElement(
                                        'span',
                                        { className: p()(Hu.text__date, Hu.text__dateActive) },
                                        c.getDate(),
                                    ),
                                    month: a().createElement(
                                        'span',
                                        { className: Hu.text__date },
                            ...
                            d = (0, n.useMemo)(
                                () => ({
                                    chapter: a().createElement(
                                        'span',
                                        { className: p()(Hu.text, Hu.text__active) },
                                        (0, zu.cg)(E ? 2 : 1),
                                    ),
                                    ...
                                    discount: a().createElement(
                                        'span',
                                        { className: p()(Hu.finishedText, Hu.finishedText__discount) },
                                        D,
                                    ),
                                    vehicleLabel: a().createElement('span', { className: Hu.label }),
                                    icon: o && a().createElement('div', { className: Hu.icon }),
                                    name: a().createElement('span', { className: p()(Hu.text, Hu.text__name) }, _),
                        ...
                        E
                            ? ((C =
                                  0 === s
                                      ? $u.postProgression.finalNoDiscountText()
                                      : $u.postProgression.finalDiscountText()),
                              (m = $u.chapterDateText()))
                            : ((C =
                                  0 === s
                                      ? $u.finalNoDiscountText.long()
                                      : t === qu.ThinExtraSmall
                                        ? $u.finalDiscountText.short()
                                        : $u.finalDiscountText.long()),
                              (m = $u.chapterStageText()));
                        const g = p()(Hu.base, Hu[`base__${t}`], u && Hu.base__small, F && Hu.base__finished),
                            h = p()(Hu.stageWrapper, o && Hu.stageWrapper__indent);
                        return a().createElement(
                            'div',
                            { className: g },
                            l &&
                            ...
                            F &&
                                a().createElement(
                                    'div',
                                    { className: h },
                                    a().createElement(Wu, { classMix: Hu.text, text: C, binding: d }),
                                ),
                            a().createElement('div', { className: Hu.shadow }),
                        );
                    },
                    Gu = {
                        ...
                        ({
                            ...
                            const E = (0, n.useMemo)(() => ({ time: a().createElement('span', null, e) }), [e]),
                                A = p()(
                                    ...
                                    !e && o && Gu.base__hidden,
                                    r && Gu.base__finished,
                                    s && Gu.base__notStarted,
                                );
                            return a().createElement(
                                'div',
                                { className: A },
                                !i && a().createElement('div', { className: Gu.shadow }),
                                a().createElement('div', { className: Gu.icon }),
                                a().createElement(Wu, { classMix: Gu.title, text: u, binding: E }),
                            );
                        },
                    ),
                    Vu = {
                    ...
                    Ku = R.strings.marathon.entryPoint;
                let qu;
                !(function (u) {
                    ((u.Big = 'big'),
                ...
                const Yu = {
                    ...
                    Zu = () => {
                        ...
                        let g = r;
                        B && (g = s);
                        const h = (0, n.useState)(qu.Big),
                            b = h[0],
                            v = h[1];
                        (0, n.useEffect)(() => {
                            const u = (u) => {
                                const e = Yu[`${u.width}*${u.height}`];
                                e && v(e);
                            };
                            return (
                        ...
                        const w = b === qu.ThinSmall || b === qu.ThinExtraSmall,
                            f = (0, n.useCallback)(() => {
                                (L(R.sounds.play()), F());
                            }, [F]);
                        let x = '';
                        ((c || B) && (x = Ku.untilEndText()),
                            d && (x = Ku.finalSaleText()),
                            D && (x = Ku.untilStartText()));
                        const S = W(Ku.activeDiscountText(), { discount: e }),
                            P = p()(Vu.base, Vu[`base__${b}`], D && Vu.base__notStarted),
                            y = p()(Vu.bg, o && Vu.bg__post),
                            T = p()(
                                Vu.subTitleWrapper,
                                (c || B) && Vu.subTitleWrapper__alert,
                                d && Vu.subTitleWrapper__finished,
                            ),
                            k = p()(Vu.title, c && Vu.title__short),
                            N = a().createElement(
                                'div',
                                { className: T },
                                a().createElement(Uu, {
                            ...
                            M = a().createElement(ju, { isSmall: w, size: b, isAllPrizesInHangar: m });
                        return a().createElement(
                            'div',
                            { className: P, onClick: f, onMouseEnter: () => L(R.sounds.highlight()) },
                            a().createElement(
                                'div',
                                { className: Vu.bgWrapper },
                                a().createElement('div', { className: y }),
                                a().createElement('div', { className: Vu.bgHighlight }),
                                C && a().createElement('div', { className: Vu.sparkles }),
                            ),
                            a().createElement('div', { className: Vu.stroke }),
                            d && a().createElement('div', { className: Vu.highlight }),
                            C &&
                                !m &&
                                a().createElement(
                                    'div',
                                    { className: Vu.discount },
                                    a().createElement('div', { className: Vu.discountText }, S),
                                    a().createElement('div', { className: Vu.discountLight }),
                                ),
                            a().createElement(
                                'div',
                                { className: Vu.mainTitleWrapper },
                                a().createElement(
                                    'div',
                                    { className: Vu.titleWrapper },
                                    a().createElement('div', { className: k }, Ku.title()),
                                ),
                                !D && x && N,
                                _ && M,
                            ),
                ...
                engine.whenReady.then(() => {
                    g().render(
                        a().createElement(C, null, a().createElement(Zu, null)),
