            ...
            345: (u, e, t) => {
                ...
                const c = (u) => {
                    ...
                    const a = (0, n.useContext)(_),
                        ...
                        b = { extraLarge: d, large: m, medium: g, small: h, extraSmall: p };
                ...
                const f = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    S = (u) => {
                        ...
                        if (n.length > 0) {
                            ...
                            return (
                                n.reduce((e, n) => {
                                    const a = w(x(t, `${e}.${n}`), window);
                                    return f(a) ? (u.push(a.id), `${e}.${n}.value`) : (u.push(n), `${e}.${n}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        C(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = S(u);
                                l.current = T.addCallback(n, t, s, e === y.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== y.None)
                                return () => {
                                    T.removeCallback(l.current, s);
                                };
                        }, [s, e]),
                        A
                    );
                ...
                const L = (u, e, t) => {
                    ...
                    W = (u, e, t = N.left) => u.split(e).reduce(t === N.left ? L : I, []),
                    z = (() => {
                        const u = new RegExp(
                ...
                const K = ({ size: u = V.Default, classMix: e }) =>
                        a().createElement('div', { className: p()(G.background, G[`background__${u}`], e) }),
                    q = {
                ...
                const eu = 'ProgressBarDeltaGrow_base_7e',
                    ...
                    su = (0, n.memo)(
                        ({
                            ...
                            const h = (0, n.useMemo)(() => Object.assign({ width: '100%' }, ru(u), au(F)), [F, u]),
                                b = (0, n.useMemo)(() => Object.assign({ width: '0%' }, ru(u), au(F)), [F, u]),
                                w = (0, n.useMemo)(() => Object.assign({ width: '0%' }, iu(F, i), ru(u)), [i, F, u]),
                                v = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(s - i)}%` }, iu(F, i), ru(u)),
                                    [i, F, s, u],
                                );
                            if (B) return null;
                            const f = p()(eu, A, F && 0 === s && tu);
                            return a().createElement(
                                'div',
                                { style: c ? w : v, className: f },
                                a().createElement(
                                    'div',
                                    { style: d ? b : h, className: nu },
                ...
                const Bu = (0, n.memo)((u) => {
                        ...
                        switch (i.animationSettings.type) {
                            case j.Simple:
                                return a().createElement(lu, _u({}, i, { onEndAnimation: E, isComplete: s }));
                            case j.Growing:
                                return a().createElement(ou, _u({}, i, { onEndAnimation: E, isComplete: s }));
                            default:
                                return null;
                        }
                    }),
                    cu = ({ size: u, value: e, lineRef: t, disabled: i, onComplete: r }) => {
                ...
                const mu = (0, n.memo)((u) => {
                    ...
                    return (
                        (i.current.from = s),
                        a().createElement(Bu, du({}, t, { onEndAnimation: r, key: `${s}-${t.to}`, from: s }))
                    );
                });
                function gu() {
                    return (
                ...
                const hu = (0, n.memo)(
                        ({
                            ...
                            return r.withStack
                                ...
                                : a().createElement(Bu, gu({ key: `${i}-${e}` }, A));
                        },
                    ),
                    pu = (u) => ({
                    ...
                    xu = (0, n.memo)(
                        ({
                            ...
                            return a().createElement(
                                'div',
                                { className: p()(G.base, G[`base__${t}`]), style: pu(e) },
                                !s && a().createElement(K, { size: t, classMix: o }),
                                a().createElement(hu, {
                                    size: t,
                                    lineRef: F,
                                    disabled: r,
                    ...
                    Su = (0, n.memo)(({ quest: u, size: e, isGrind: t, isQuestDone: n, isPostProgression: i = !1 }) => {
                        ...
                        (r && s
                            ...
                            : r
                              ...
                              : s && (l = s.value.iconKey),
                            'award' === l && (l = 'damage'));
                        const D = p()(Pu.base, Pu[`base__${e}`], i && Pu.base__postProgression),
                            _ = p()(Pu.iconImg, Pu[`iconImg__${l}`]),
                            B = p()(Pu.text, n && Pu.text__done),
                            c = p()(Pu.value, E > 0 && Pu.value__active),
                            C = p()(Pu.box, i && Pu.box__post),
                            d = p()(Pu.progress, i && Pu.progress__postProgression);
                        return a().createElement(
                            'div',
                            { className: D },
                            a().createElement(
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(
                                            ...
                                            a().createElement(
                                                'span',
                                                { className: c },
                                                a().createElement($, { value: n ? F : E }),
                                            ),
                                            ' / ',
                                            a().createElement($, { value: F }),
                                        ),
                                    ),
                            ),
                            a().createElement(
                                'div',
                                { className: d },
                                a().createElement(xu, { value: n ? F : E, maxValue: F, size: V.Small }),
                            ),
                        );
                    }),
                    Tu = {
                    ...
                    yu = (0, n.memo)(({ size: u }) => {
                        ...
                        return a().createElement(
                            ...
                            n &&
                                a().createElement(
                                    'div',
                                    { className: Tu.iconWrapper },
                                    a().createElement('span', { className: Tu.icon }),
                                    a().createElement(
                                        'span',
                                        { className: Tu.iconText },
                    ...
                    Ou = (0, n.memo)(({ size: u }) => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: ku.box },
                                n.items && n.items.length && a().createElement(Su, { quest: n.items[0], size: u }),
                                a().createElement(
                                    'div',
                                ...
                                t.items &&
                                    t.items.length &&
                                    a().createElement(Su, { quest: t.items[0], size: u, isGrind: !0, isQuestDone: !1 }),
                            ),
                        );
                    }),
                    Nu = 'FormatText_base_d0',
                    Mu = ({ binding: u, text: e = '', classMix: t, alignment: i = N.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, r) =>
                                      a().createElement(
                                          'div',
                                          { className: p()(Nu, t), key: `${e}-${r}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : U(u, e))))(e, i, u).map((u, e) =>
                ...
                function Iu(u) {
                    let e = '';
                    for (let t = Ru.length - 1; t >= 0; t--) for (; u >= Ru[t]; ) ((e += Lu[t]), (u -= Ru[t]));
                    return e;
                }
                ...
                const Wu = {
                    ...
                    zu = R.strings.marathon.entryPoint,
                    Hu = ({ isSmall: u, isAllPrizesInHangar: e, size: t }) => {
                        const i = k('model'),
                            r = i.state,
                            s = i.discount,
                            o = i.isPremShopURL,
                            ...
                            F = 1 === r,
                            l = 3 === r,
                            D = M(zu.discountText(), { discount: s }),
                            _ = E ? zu.styleName() : zu.vehicleName(),
                            B = (0, n.useMemo)(() => new Date(), []),
                            c = (0, n.useMemo)(
                                () => ({
                                    day: a().createElement(
                                        'span',
                                        { className: p()(Wu.text__date, Wu.text__dateActive) },
                                        B.getDate(),
                                    ),
                                    month: a().createElement(
                                        'span',
                                        { className: Wu.text__date },
                            ...
                            C = (0, n.useMemo)(
                                () => ({
                                    chapter: a().createElement(
                                        'span',
                                        { className: p()(Wu.text, Wu.text__active) },
                                        Iu(E ? 2 : 1),
                                    ),
                                    ...
                                    discount: a().createElement(
                                        'span',
                                        { className: p()(Wu.finishedText, Wu.finishedText__discount) },
                                        D,
                                    ),
                                    vehicleLabel: a().createElement('span', { className: Wu.label }),
                                    icon: o && a().createElement('div', { className: Wu.icon }),
                                    name: a().createElement('span', { className: p()(Wu.text, Wu.text__name) }, _),
                                    date: a().createElement(Mu, {
                                        classMix: Wu.text,
                        ...
                        E
                            ? ((d =
                                  0 === s
                                      ? zu.postProgression.finalNoDiscountText()
                                      : zu.postProgression.finalDiscountText()),
                              (m = zu.chapterDateText()))
                            : ((d =
                                  0 === s
                                      ? zu.finalNoDiscountText.long()
                                      : t === ju.ThinExtraSmall
                                        ? zu.finalDiscountText.short()
                                        : zu.finalDiscountText.long()),
                              (m = zu.chapterStageText()));
                        const g = p()(Wu.base, Wu[`base__${t}`], u && Wu.base__small, l && Wu.base__finished),
                            h = p()(Wu.stageWrapper, o && Wu.stageWrapper__indent);
                        return a().createElement(
                            'div',
                            { className: g },
                            F &&
                            ...
                            l &&
                                a().createElement(
                                    'div',
                                    { className: h },
                                    a().createElement(Mu, { classMix: Wu.text, text: d, binding: C }),
                                ),
                            a().createElement('div', { className: Wu.shadow }),
                        );
                    },
                    Uu = {
                        ...
                        ({
                            ...
                            const E = (0, n.useMemo)(() => ({ time: a().createElement('span', null, e) }), [e]),
                                A = p()(
                                    ...
                                    !e && o && Uu.base__hidden,
                                    r && Uu.base__finished,
                                    s && Uu.base__notStarted,
                                );
                            return a().createElement(
                                'div',
                                { className: A },
                                !i && a().createElement('div', { className: Uu.shadow }),
                                a().createElement('div', { className: Uu.icon }),
                                a().createElement(Mu, { classMix: Uu.title, text: u, binding: E }),
                            );
                        },
                    ),
                    Gu = {
                    ...
                    Vu = R.strings.marathon.entryPoint;
                let ju;
                !(function (u) {
                    ((u.Big = 'big'),
                ...
                const Ku = {
                        '302*152': ju.Big,
                        '302*114': ju.WideSmall,
                        '222*114': ju.ThinSmall,
                        '162*114': ju.ThinExtraSmall,
                    },
                    qu = () => {
                        const u = k('model'),
                            e = u.discount,
                        ...
                        let g = r;
                        c && (g = s);
                        const h = (0, n.useState)(ju.Big),
                            b = h[0],
                            w = h[1];
                        (0, n.useEffect)(() => {
                            const u = (u) => {
                                const e = Ku[`${u.width}*${u.height}`];
                                e && w(e);
                            };
                            return (
                        ...
                        const v = b === ju.ThinSmall || b === ju.ThinExtraSmall,
                            f = (0, n.useCallback)(() => {
                                (O(R.sounds.play()), l());
                            }, [l]);
                        let x = '';
                        ((B || c) && (x = Vu.untilEndText()),
                            C && (x = Vu.finalSaleText()),
                            D && (x = Vu.untilStartText()));
                        const P = M(Vu.activeDiscountText(), { discount: e }),
                            S = p()(Gu.base, Gu[`base__${b}`], D && Gu.base__notStarted),
                            T = p()(Gu.bg, o && Gu.bg__post),
                            y = p()(
                                Gu.subTitleWrapper,
                                (B || c) && Gu.subTitleWrapper__alert,
                                C && Gu.subTitleWrapper__finished,
                            ),
                            N = p()(Gu.title, B && Gu.title__short),
                            L = a().createElement(
                                'div',
                                { className: y },
                                a().createElement($u, {
                            ...
                            I = a().createElement(Hu, { isSmall: v, size: b, isAllPrizesInHangar: m });
                        return a().createElement(
                            'div',
                            { className: S, onClick: f, onMouseEnter: () => O(R.sounds.highlight()) },
                            a().createElement(
                                'div',
                                { className: Gu.bgWrapper },
                                a().createElement('div', { className: T }),
                                a().createElement('div', { className: Gu.bgHighlight }),
                                d && a().createElement('div', { className: Gu.sparkles }),
                            ),
                            a().createElement('div', { className: Gu.stroke }),
                            C && a().createElement('div', { className: Gu.highlight }),
                            d &&
                                !m &&
                                a().createElement(
                                    'div',
                                    { className: Gu.discount },
                                    a().createElement('div', { className: Gu.discountText }, P),
                                    a().createElement('div', { className: Gu.discountLight }),
                                ),
                            a().createElement(
                                'div',
                                { className: Gu.mainTitleWrapper },
                                a().createElement(
                                    'div',
                                    { className: Gu.titleWrapper },
                                    a().createElement('div', { className: N }, Vu.title()),
                                ),
                                !D && x && L,
                                _ && I,
                            ),
                            D && x && L,
                            !_ && I,
                            _ && o && a().createElement(yu, { size: b }),
                            _ && !o && a().createElement(Ou, { size: b }),
                        );
                    };
                engine.whenReady.then(() => {
                    g().render(
                        a().createElement(d, null, a().createElement(qu, null)),
