            ...
            961: (u, e, t) => {
                ...
                const B = (u) => {
                    ...
                    const r = (0, n.useContext)(c),
                        ...
                        w = { extraLarge: C, large: m, medium: h, small: p, extraSmall: g };
                ...
                class Eu extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = g()(iu.base, iu[`base__${i}`], iu[`base__${a}`], null == o ? void 0 : o.base),
                            c = g()(iu.icon, iu[`icon__${i}`], iu[`icon__${a}`], null == o ? void 0 : o.icon),
                            _ = g()(iu.glow, null == o ? void 0 : o.glow),
                            B = g()(iu.caption, iu[`caption__${i}`], null == o ? void 0 : o.caption),
                            d = g()(iu.goto, null == o ? void 0 : o.goto);
                ...
                const Fu = (0, n.memo)(
                    ({
                        ...
                        const l = z(['leftBlock', 'rightBlock'], Au),
                            F = (0, n.useState)(A),
                            D = F[0],
                            c = F[1];
                        (0, n.useEffect)(() => c(!A), [A]);
                        const _ = (0, n.useMemo)(() => (u ? { backgroundImage: `url('${u}')` } : void 0), [u]),
                            B = g()(Au.container, D && Au.container__shown);
                        return r().createElement(
                            'div',
                ...
                const pu = [
                    ...
                    gu = [Du.Gold, Du.Credits, Du.Crystal, Du.FreeXp],
                ...
                const Iu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        return a || o
                            ? r().createElement(Pu, Lu({}, e, { contentId: a || o }), n)
                            : r().createElement(ku, e, n);
                    },
                    Uu = {
                        base: 'Reward_base_ea',
                    ...
                    Hu = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: g()(Uu.base, Uu[`base__${n}`], E), style: s },
                            r().createElement(
                                Iu,
                                { tooltipArgs: l, className: Uu.tooltipWrapper },
                                r().createElement(
                                    r().Fragment,
                                    null,
                                    r().createElement(
                                        'div',
                                        { className: g()(Uu.image, null == A ? void 0 : A.image) },
                                        D &&
                                            r().createElement('div', {
                                                className: g()(Uu.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: g()(Uu.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        c &&
                                            r().createElement('div', {
                                                className: g()(Uu.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: F },
                                    r().createElement('div', {
                                        className: g()(Uu.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    },
                    ...
                    zu = 'Rewards_reward__vertical_c6';
                function Yu() {
                    return (
                        (Yu =
                            Object.assign ||
                                          ...
                                          u
                                              ...
                                              .map((u, t) =>
                                                  r().createElement(
                                                      'div',
                                                      { key: t, className: D },
                                                      r().createElement(Hu, Yu({ size: e }, u)),
                                                  ),
                                              ),
                                          r().createElement(
                                              'div',
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: Qu.header },
                                    r().createElement('div', { className: Qu.supTitle }, x),
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(U, { classMix: Qu.name, text: a, binding: T }),
                                        r().createElement(
                                            'div',
                                            { className: Qu.prize, style: p },
                                            Boolean(o) &&
                                                r().createElement('div', { className: Qu.prizeReward, style: v }),
                                        ),
                                    ),
                ...
                engine.whenReady.then(() => {
                    h().render(
                        r().createElement(C, null, r().createElement(ue, null)),
