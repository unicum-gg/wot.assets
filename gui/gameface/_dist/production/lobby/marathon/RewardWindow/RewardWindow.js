            ...
            445: (u, e, t) => {
                ...
                const d = (u) => {
                    ...
                    C = (0, n.memo)(({ children: u }) => {
                        ...
                        return r().createElement(_.Provider, { value: l }, u);
                    });
                var m = t(493),
                    p = t.n(m),
                    g = t(483),
                ...
                const k = (u, e, t) => {
                    ...
                    O = (u, e, t = x.left) => u.split(e).reduce(t === x.left ? k : S, []),
                    N = (() => {
                        const u = new RegExp(
                        ...
                        return M.includes(t)
                            ...
                            : ((u, e = x.left) => {
                                  ...
                                  const n =
                                      ...
                                      r = u.replace(/&nbsp;/g, ' ');
                                  return O(r, /( )/, e).forEach((u) => (t = t.concat(O(u, n, x.left)))), t;
                              })(u, e);
                    },
                    I = 'FormatText_base_d0',
                    U = ({ binding: u, text: e = '', classMix: t, alignment: a = x.left }) =>
                        null === e
                                  ...
                                  e.split('\n').map((e, i) =>
                                      r().createElement(
                                          ...
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : L(u, e))))(e, a, u).map((u, e) =>
                ...
                const tu = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    au = ({ type: u, classMix: e }) => {
                        const t = h()(ru.base, e),
                            n = h()(ru.icon, ru[`icon__${u}`]);
                ...
                class Eu extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            _ = h()(iu.icon, iu[`icon__${i}`], iu[`icon__${a}`], null == o ? void 0 : o.icon),
                            c = h()(iu.glow, null == o ? void 0 : o.glow),
                ...
                const Fu = (0, n.memo)(
                    ({
                        ...
                        const l = V(['leftBlock', 'rightBlock'], Au),
                            ...
                            _ = F[1];
                        (0, n.useEffect)(() => _(!A), [A]);
                        const c = (0, n.useMemo)(() => (u ? { backgroundImage: `url('${u}')` } : void 0), [u]),
                            B = h()(Au.container, D && Au.container__shown);
                        return r().createElement(
                            'div',
                            { className: Au.base, style: c },
                            r().createElement(
                                'div',
                                { className: B },
                                Boolean(t) &&
                            ...
                            r().createElement('div', { className: Au.view }, a),
                        );
                    },
                );
                let Du, _u, cu, Bu, du, Cu, mu;
                !(function (u) {
                    (u.Items = 'items'),
                ...
                const gu = [
                    ...
                    fu = 'LootboxTransition_base_9c',
                    Tu = 'LootboxTransition_lootbox_62',
                    Ru = 'LootboxTransition_smoke_43',
                    Pu = (0, n.memo)(({ delay: u, isEnabled: e = !0, children: t }) =>
                        e
                            ? r().createElement(
                                  'div',
                                  { className: fu },
                        ...
                        const h = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, n.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (ku(t, _, { isMouseEvent: !0, on: !0, arguments: yu(r) }, w),
                                    m && m(),
                ...
                const Wu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        return a || o
                            ? r().createElement(Su, Hu({}, e, { contentId: a || o }), n)
                            : r().createElement(Mu, e, n);
                    },
                    zu = {
                        base: 'Reward_base_ea',
                    ...
                    Vu = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: h()(zu.base, zu[`base__${n}`], E), style: s },
                            r().createElement(
                                Wu,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: h()(zu.image, null == A ? void 0 : A.image) },
                                        D &&
                                            r().createElement('div', {
                                                className: h()(zu.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: h()(zu.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        _ &&
                                            r().createElement('div', {
                                                className: h()(zu.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: F },
                                    r().createElement('div', {
                                        className: h()(zu.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    },
                                          ...
                                          u
                                              ...
                                              .map((u, t) =>
                                                  r().createElement(
                                                      'div',
                                                      { key: t, className: c },
                                                      r().createElement(Vu, Xu({ size: e }, u)),
                                                  ),
                                              ),
                                          r().createElement(
                                              'div',
                    ...
                    ae = () => {
                        ...
                        const p = V(['base'], te),
                            ...
                            T = (0, n.useMemo)(
                                () => ({
                                    name: _,
                                    type: r().createElement(au, { type: B, classMix: te.nameType }),
                                    level: nu(c),
                                }),
                                [_, B, c],
                            ),
                            x = y(R.strings.marathon.reward.stage(), { stage: nu(s), text: t }),
                            k = h()(te.button, te[`button__lang_${re}`]),
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: te.header },
                                    r().createElement('div', { className: te.supTitle }, x),
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(U, { classMix: te.name, text: a, binding: T }),
                                        r().createElement(
                                            'div',
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        P,
                                        { type: b.primary, size: f.small, mixClass: k, onClick: C },
                                        S,
                                    ),
                                    !E &&
                                        r().createElement(
                                            P,
                                            { type: b.secondary, size: f.small, mixClass: k, onClick: m },
