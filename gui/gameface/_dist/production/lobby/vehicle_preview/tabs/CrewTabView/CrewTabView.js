(() => {
    var __webpack_modules__ = {
            ...
            527: (e, u, t) => {
                'use strict';
                (t.r(u),
                    t.d(u, { mouse: () => c, off: () => o, on: () => l, onResize: () => a, onScaleUpdated: () => i }));
                var n = t(472),
                    r = t(176);
            ...
            976: (e, u, t) => {
                'use strict';
                t.d(u, { Sw: () => a.Z, B3: () => o, Z5: () => i.Z5, B0: () => l, ry: () => h });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
                ...
                function F(e, u, t, n, r, a, i) {
                    ...
                    l.done ? u(o) : Promise.resolve(o).then(n, r);
                }
            ...
            502: (e, u, t) => {
                ...
                const c = (e) => {
                        ...
                        return a().createElement(s.Provider, { value: m }, e.children(u, _));
                    },
                    d = (e, u, t) =>
                ...
                const h = ({ children: e }) => {
                    ...
                    return (
                        ...
                        a().createElement(F.Provider, { value: t }, o && e)
                    );
                };
                var D = t(483),
                    f = t.n(D),
                ...
                const x = {
                    ...
                    T = (e) => {
                        ...
                        const r = w(),
                            ...
                            l = r.mediaHeight,
                            o = r.mediaSize;
                        return a().createElement('div', y({ className: f()(t, x[i], S[l], L[o]) }, n), u);
                    },
                    O = ['children'];
                const N = (e) => {
                    let u = e.children,
                ...
                const Z = ((e, u) => {
                        ...
                        return [
                            function ({ mode: i = 'real', options: l, children: o, mocks: s }) {
                                const c = (0, r.useRef)([]),
                                    d = (t, r, a) => {
                                        var i;
                                        const l = (function ({
                                    ...
                                    m = _[0],
                                    A = _[1],
                                    F = (0, r.useState)(() => d(i, l, s)),
                                    g = F[0],
                                    h = F[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        E.current ? h(d(m, l, s)) : (E.current = !0);
                                    }, [s, m, l]),
                                    (0, r.useEffect)(() => {
                                        A(i);
                                    }, [i]),
                        ...
                        for (let s = t; s >= 0; s--) {
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const _ = d.slice(0, d.length - E) + i,
                                    m = u[s];
                                ((o = a().cloneElement(m, m.props, _)), (l = s));
                                break;
                            }
                            {
                                const e = t.children,
                ...
                const _u = 'Dog_base_87',
                    ...
                    Fu = a().memo(function ({ nation: e }) {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: _u, onClick: () => su(du.RUDY) },
                ...
                const Du = a().memo(function ({ role: e, size: u = hu.c30x30, className: t }) {
                    ...
                    Bu = a().memo(function ({ roles: e, index: u }) {
                        ...
                        return a().createElement(
                            ie,
                            { ignoreMouseClick: !0, isEnabled: !0, args: { tooltipId: oe, index: u } },
                            a().createElement(
                                'div',
                                { className: fu },
                ...
                const $u = (e) => (e.level < se ? zu.Learning : zu.Learned),
                    Uu = (e) =>
                        (function (e, u) {
                                ...
                                (0, r.useEffect)(() => {
                                    ...
                                    const s = ((e, u, t) => {
                                        ...
                                        _ = setInterval(() => {
                                            const e = d(),
                                                u = s[e];
                                            (l(s[e]), o(e, u), e === r && (h(), m || clearInterval(_)));
                                        }, c);
                                    return () => clearInterval(_);
                                }, [i, c, n, t, E, m, o, h, F, u, f]),
                                a().createElement('canvas', st({}, p, { width: u, height: t, ref: b }))
                            );
                        }),
                ...
                const Nt = (e, u) => (e ? Ct.Scale : u ? Ct.FadeIn : Ct.None),
                    ...
                    zt = ({
                        ...
                        return !c ||
                            (c.level === se && 0 === d) ||
                            ((null == l ? void 0 : l.level) === se && t === ju.Bonus && d > 0 && !r)
                            ? null
                            : E || (d < 0 && 0 === e)
                              ...
                              : a().createElement(
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(jt, { skillLevel: c.level, isHighlighted: _, className: s }),
                                    ),
                                );
                    },
                    $t = {
                ...
                const Vt = ({
                        ...
                        const s = K(e),
                            c = Uu(e),
                            d = n !== Eu.Low && (null == s ? void 0 : s.level) !== se;
                        return a().createElement(
                            'div',
                            ...
                            d && s && a().createElement(jt, { skillLevel: s.level, className: $t.level }),
                            o &&
                                a().createElement(Nu, {
                                    classMix: $t.acceleratedTrainingIcon,
                ...
                const Yt = ({
                        ...
                        const F = e.majorSkills,
                            ...
                            L = ((e, u, t, n) => {
                                ...
                                return Pu.None;
                            })(i, w.length, B, p !== Eu.Low && void 0 !== k && k.level < se),
                            T = {
                                size: r,
                                efficiencyState: p,
                            ...
                            a().createElement(
                                ...
                                x
                                    ...
                                    : a().createElement(
                                          a().Fragment,
                                          null,
                                          a().createElement(Vt, Kt({ skills: F, isAcceleratedTrainingVisible: o }, T)),
                                          y &&
                                              a().createElement(
                                                  Vt,
                                                  Kt(
                ...
                const Jt = (0, r.memo)(function ({ name: e, size: u = Xt.c100x60, classMix: t, isSkin: n = !1 }) {
                    ...
                    _n = a().memo(({ icon: e, name: u, roles: t, skills: n, index: r }) =>
                        a().createElement(
                            ...
                            a().createElement(
                                ie,
                                { ignoreMouseClick: !0, isEnabled: !0, args: { tooltipId: oe, index: r } },
