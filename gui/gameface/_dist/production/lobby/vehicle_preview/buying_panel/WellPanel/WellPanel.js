(() => {
    var __webpack_modules__ = {
            ...
            290: (u, e, t) => {
                ...
                const n = r.O.client.getSize('rem'),
                    B = n.width,
                    s = n.height,
                    C = Object.assign({ width: B, height: s }, i(B, s, a)),
                    l = (0, E.createContext)(C),
                    o = ['children'];
                const d = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    _ = (0, E.memo)(({ children: u }) => {
                        const e = (0, E.useContext)(l),
                            ...
                            n = (0, E.useCallback)((u, e) => {
                                ...
                                D(Object.assign({ width: t, height: E }, i(t, E, a)));
                            }, []);
                        c(() => {
                        ...
                        return A().createElement(l.Provider, { value: B }, u);
                    });
                var m = t(483),
                    h = t.n(m),
                    g = t(926),
                ...
                const S = {
                    ...
                    O = (u) => {
                        ...
                        const F = b(),
                            ...
                            a = F.mediaHeight,
                            D = F.mediaSize;
                        return A().createElement('div', L({ className: h()(t, S[r], M[a], T[D]) }, E), e);
                    },
                    y = ['children'];
                const H = (u) => {
                    let e = u.children,
                ...
                const W = (u, e, t) => {
                    ...
                    U = (u, e, t = N.left) => u.split(e).reduce(t === N.left ? W : I, []),
                    G = (() => {
                        const u = new RegExp(
                        ...
                        return $.includes(t)
                            ...
                            : ((u, e = N.left) => {
                                  ...
                                  const E =
                                      ...
                                      A = u.replace(/&nbsp;/g, ' ');
                                  return U(A, /( )/, e).forEach((u) => (t = t.concat(U(u, E, N.left)))), t;
                              })(u, e);
                    };
                let V;
                !(function (u) {
                ...
                const q = (u = 1) => {
                    ...
                    J = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: A, modelPath: X(A, u || ''), resId: E };
                            })(),
                            t = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const A = Y(X(t, `${e}.${E}`), window);
                                    return Z(A) ? (u.push(A.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        c(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = J(u);
                                s.current = uu.addCallback(E, t, a, e === eu.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== eu.None)
                                return () => {
                                    uu.removeCallback(s.current, a);
                                };
                        }, [a, e]),
                        n
                    );
                ...
                const Au = 'FormatText_base_d0',
                    Fu = ({ binding: u, text: e = '', classMix: t, alignment: F = N.left }) =>
                        null === e
                            ...
                            : A().createElement(
                                  ...
                                  e.split('\n').map((e, r) =>
                                      A().createElement(
                                          'div',
                                          { className: h()(Au, t), key: `${e}-${r}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : z(u, e))))(e, F, u).map((u, e) =>
                ...
                const iu = ({
                    ...
                    const d = (0, E.useRef)(null),
                        ...
                        k = h()(ru.state, ru.state__default);
                    return (
                        (0, E.useEffect)(
                            () => (
                        ...
                        A().createElement(
                            ...
                            F !== au.ghost &&
                                A().createElement(
                                    A().Fragment,
                                    null,
                                    A().createElement('div', { className: ru.back }),
                                    A().createElement('span', { className: ru.texture }),
                                ),
                            A().createElement(
                                'span',
                                { className: k },
                                A().createElement('span', { className: ru.stateDisabled }),
                                A().createElement('span', { className: ru.stateHighlightHover }),
                                A().createElement('span', { className: ru.stateHighlightActive }),
                            ),
                            A().createElement(
                                'span',
                ...
                iu.defaultProps = { type: au.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const nu = (0, E.memo)(iu),
                    Bu = 'App_base_5d',
                    su = 'App_title_e7',
                    Cu = 'App_description_fb',
                    lu = 'App_button_af',
                    ou = R.strings.vehicle_preview.buyingPanel.style.description,
                    du = () => {
                                ...
                                A().createElement(
                                    ...
                                    A().createElement(
                                        ...
                                        A().createElement(Fu, {
                                            text: ou.text(),
                                            binding: {
                                                topPlayers: A().createElement(Eu, { format: 'integral', value: F }),
                                                basePlayers: A().createElement(Eu, { format: 'integral', value: t }),
                                            },
                                        }),
                                    ),
                                    A().createElement(
                                        nu,
                                        { type: au.main, size: Du.medium, onClick: D, mixClass: lu },
                                        ou.button.text(),
                                    ),
                                ),
                        );
                ...
                engine.whenReady.then(() => {
                    k().render(
                        A().createElement(H, null, A().createElement(du, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [294], () => __webpack_require__(290));
