(() => {
    var __webpack_modules__ = {
            ...
            8808: (u, e, t) => {
                        ...
                        const w = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            x = (0, r.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (D(t, d, { isMouseEvent: !0, on: !0, arguments: l(n) }, f),
                                    p && p(),
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onMouseLeave: ((u) => (e) => {
                                              (S(), null == E || E(e), null == u || u(e));
                                          })(e.props.onMouseLeave),
                                          onClick: ((u) => (e) => {
                                              (!1 === B && S(), null == o || o(e), null == u || u(e));
                                          })(e.props.onClick),
                                          onMouseDown: ((u) => (e) => {
                                              (!1 === B && S(), null == i || i(e), null == u || u(e));
                                          })(e.props.onMouseDown),
                                      },
                                      b,
                                  ),
                ...
                const _ = R.views.common.tooltip_window.simple_tooltip_content,
                    d = (u) => {
                        let e = u.children,
                            t = u.body,
                            a = u.header,
                            ...
                            B(
                                {
                                    contentId:
                                        ...
                                        l ? _.SimpleTooltipHtmlContent('resId') : _.SimpleTooltipContent('resId')),
                ...
                const b = ['__left', '__right', '__top', '__bottom'],
                    w = (0, r.forwardRef)(
                        ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: a = {} }, E) => {
                            const i = (0, r.useRef)(null),
                                ...
                                c = D[1],
                                B = (0, r.useCallback)(() => {
                                    (h.playClick(), C.O.view.sendEvent.close());
                                }, []),
                                _ = (0, r.useCallback)(() => {
                                    h.playHighlight();
                                }, []),
                                g = o()(p.arrow, p[`arrow${b[s]}`]);
                            m(
                                () => (
                                    ...
                                    () => (
                                        ...
                                        ((u) => {
                                            ...
                                            if (F.current) {
                                                ...
                                                (C.O.view.resize(u, e), c(window.decorator.directionType));
                                            }
                                        })
                                    ),
                                    [],
                            ...
                            return (
                                (0, r.useImperativeHandle)(E, () => ({ updateSize: w })),
                                m(() => {
                                ...
                                (0, r.useEffect)(() => {
                                    ...
                                    return (
                                        !e && u.promise.then(() => w()),
                                        () => {
                                            (u.cancel(), document.removeEventListener('mousedown', v));
                                        }
                                    );
                                }, [w, v, e]),
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement('div', { className: g, style: a.arrow }),
                                    ),
                                )
                            );
                        },
                ...
                const L = C.O.client.getSize('rem'),
                    O = L.width,
                    P = L.height,
                    k = Object.assign({ width: O, height: P }, y(O, P, M)),
                    N = (0, r.createContext)(k),
                    H = ['children'];
                const I = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    const n = (0, r.useContext)(N),
                        ...
                        g = { extraLarge: B, large: _, medium: d, small: C, extraSmall: m };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && F) return S(e, t, g);
                        if (t.largeWidth && l) return S(e, t, g);
                        if (t.mediumWidth && D) return S(e, t, g);
                        if (t.smallWidth && s) return S(e, t, g);
                        if (t.extraSmallWidth && c) return S(e, t, g);
                        if (
                ...
                (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(N),
                        ...
                        i = (0, r.useCallback)((u, e) => {
                            ...
                            E(Object.assign({ width: t, height: r }, y(t, r, M)));
                        }, []);
                    (W(() => {
                ...
                const X = () => {
                    ...
                    V = ['xl', 'lg', 'md', 'sm', 'xs'],
                    z = (u) => u.includes('_') && ((u) => V.includes(u))(u.split('_').at(-1)),
                    K = [G.ExtraLarge, G.Large, G.Medium, G.Small, G.ExtraSmall],
                    Y = (u, e) =>
                ...
                const J = {
                    ...
                    tu = q((u) => {
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, A, l, s, B, N, k, M, m, L, f, S]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return n().createElement('div', Q({ className: o()($.base, ...U, e), style: G }, I), H);
                    });
                let ru;
                function nu(u) {
                ...
                const au = (u, e, t) => {
                    ...
                    iu = (u, e, t = ru.left) => u.split(e).reduce(t === ru.left ? au : Eu, []),
                    ou = (() => {
                        const u = new RegExp(
                        ...
                        return Au.includes(t)
                            ...
                            : ((u, e = ru.left) => {
                                  ...
                                  const r =
                                      ...
                                      n = u.replace(/&nbsp;/g, ' ');
                                  return (iu(n, /( )/, e).forEach((u) => (t = t.concat(iu(u, r, ru.left)))), t);
                              })(u, e);
                    },
                    lu = 'FormatText_base_d0',
                    Du = ({ binding: u, text: e = '', classMix: t, alignment: a = ru.left }) =>
                        null === e
                ...
                const Cu = Object.keys(cu()),
                    ...
                    wu = q((u) => {
                        ...
                        return n().createElement(
                            ...
                            du(
                                {
                                    className: o()(Bu.base, t && Bu[t], p, a),
                                    style: h,
                                    mt: !0 === F ? vu[t || 'paragraph-P16'].mt : F,
                                    mr: !0 === D ? vu[t || 'paragraph-P16'].mr : D,
                                    mb: !0 === c ? vu[t || 'paragraph-P16'].mb : c,
                                    ml: !0 === _ ? vu[t || 'paragraph-P16'].ml : _,
                                },
                                m,
                            ),
                            void 0 !== C ? n().createElement(Du, du({}, C, { text: e })) : e,
                        );
                    });
                var fu = t(8515);
                function xu() {
                ...
                const Ru = ((u, e) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: E, children: i, mocks: o }) {
                                const A = (0, r.useRef)([]),
                                    F = (t, r, n) => {
                                        var a;
                                        const E = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, a) => {
                                                        const i = 'string' == typeof a ? `${r}.${a}` : r,
                                                            o = C.O.view.addModelObserver(i, e, !0);
                                                        return (n.set(o, t), u && t(E(a)), o);
                                                    },
                                                    readByPath: E,
                                                    createCallback: (u, e) => {
                                                        const t = E(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Mu(n.keys()); !(u = t()).done; ) a(u.value, e);
                                                    },
                                                    unsubscribe: a,
                                                };
                                            })(r),
                                    ...
                                    s = D[0],
                                    c = D[1],
                                    B = (0, r.useState)(() => F(a, E, o)),
                                    _ = B[0],
                                    d = B[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? d(F(s, E, o)) : (l.current = !0);
                                    }, [o, s, E]),
                                    (0, r.useEffect)(() => {
                                        c(a);
                                    }, [a]),
                        ...
                        ({ observableModel: u }) => {
                            ...
                            return {
                                computes: {
                                    getTypes: (0, Ou.Om)(() => Lu(e.types.get(), (u) => Object.assign({}, u))),
                                    getNations: (0, Ou.Om)(() => Lu(e.nations.get(), (u) => Object.assign({}, u))),
                                },
                            };
                        },
                        ({ externalModel: u }) => ({
                    ...
                    Gu = 'App_body_11',
                    Uu = 'App_section_2f',
                    ju = 'FilterSection_base_12',
                    Xu = 'FilterSection_title_92',
                    Vu = 'FilterSection_controls_ee',
                    zu = 'FilterSection_toggle_8f';
                let Ku, Yu;
                (!(function (u) {
                    ((u.main = 'main'),
                        (u.primary = 'primary'),
                ...
                const Zu = () => {},
                    Qu = n().memo(
                        ({
                            ...
                            className: e,
                            children: t,
                            toggleType: a = $u.Button,
                            toggleButtonType: E = Ku.secondary,
                            onClick: i,
                            disabled: A,
                            soundClick: F = 'play',
                            ...
                            const _ = (0, r.useCallback)(
                                ...
                                C = (0, r.useCallback)(
                                    (u) => {
                                        A || ((1 !== u.button && 2 !== u.button) || (null !== F && g(F)), s && s(u));
                                    },
                                    [s, A, F],
                                ),
                                m = o()(qu.base, e, qu[`base__${a}`], u && qu.base__active, A && qu.base__disabled);
                            return n().createElement(
                                'div',
                                {
                                    className: m,
                                ...
                                n().createElement('div', { className: qu.content }, t),
                                a === $u.Button &&
                                    n().createElement(
                                        n().Fragment,
                                        null,
                                        n().createElement('div', {
                                            className: o()(qu.background, qu[`background__${E}`]),
                                        }),
                                        n().createElement('div', { className: qu.texture }),
                                    ),
                                n().createElement('div', { className: qu.overlay }),
                                n().createElement('div', { className: qu.indicator }),
                            );
                        },
                    ),
                    Ju = 'Toggle_base_41',
                    ue = 'Toggle_icon_21',
                    ee = ({ name: u, isSelected: e, toggleIconResolver: t, onToggle: r }) =>
                        n().createElement(
                            'div',
                            { className: Ju },
                            n().createElement(
                                Qu,
                                { onClick: () => r(u), active: e },
                                n().createElement('div', { className: ue, style: { backgroundImage: `url(${t(u)})` } }),
                            ),
                        ),
                    te = ({ toggles: u, title: e, className: t, onToggle: r, toggleIconResolver: a }) =>
                        n().createElement(
                            'div',
                            { className: o()(ju, t) },
                            n().createElement(wu, { text: e, className: Xu }),
                            n().createElement(
                                'div',
                                { className: Vu },
                                u.map((u, e) =>
                                    n().createElement(
                                        ...
                                        n().createElement(ee, {
                                            ...
                                            onToggle: r,
                                            toggleIconResolver: a,
                                        }),
                                    ),
                                ),
                            ),
                        ),
                    re = R.strings.seniority_awards.vehicleSelector.selectScreen.popover,
                    ne = (u) => R.images.gui.maps.icons.vehicleTypes.$dyn(nu(u)),
                    ae = (u) => R.images.gui.maps.icons.filters.nations.$dyn(nu(u)),
                    Ee = (0, fu.Pi)(() => {
                        const u = ku(),
                            e = u.controls,
                            t = u.model,
                            a = X().mediaSize,
                            E = t.computes.getTypes(),
                            i = t.computes.getNations(),
                            o = (0, r.useMemo)(() => ({ arrow: { left: (a > G.ExtraSmall ? 50 : 58) + '%' } }), [a]);
                        return n().createElement(
                            'div',
                            { className: Nu },
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: Hu },
                                        n().createElement(wu, { text: re.title(), className: Iu }),
                                    ),
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(te, {
                                            toggles: E,
                                            toggleIconResolver: ne,
                                            title: re.vehicleTitle(),
                                            onToggle: e.toggleType,
                                            className: Uu,
                                        }),
                                        n().createElement(te, {
                                            toggles: i,
                                            toggleIconResolver: ae,
                                            title: re.nationTitle(),
                                            onToggle: e.toggleNation,
                                        }),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    E().render(
                        n().createElement(Pu, null, n().createElement(Ee, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [851], () => __webpack_require__(8808));
