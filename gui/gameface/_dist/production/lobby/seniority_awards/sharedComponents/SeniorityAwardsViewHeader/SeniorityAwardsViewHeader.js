(() => {
    ...
    var __webpack_modules__ = {
            ...
            527: (u, e, A) => {
                (A.r(e),
                    A.d(e, { mouse: () => i, off: () => n, on: () => B, onResize: () => D, onScaleUpdated: () => t }));
                var E = A(2472),
                    F = A(1176);
            ...
            3138: (u, e, A) => {
                ...
                var E = A(5959),
                    F = A(7698),
                    D = A(514);
                const t = { view: A(7641), client: E, sound: D.ZP, intl: F.N };
            },
            7698: (u, e, A) => {
                A.d(e, { N: () => E });
                const E = {
            ...
            7641: (u, e, A) => {
                ...
                const T = Object.keys(D.W).reduce(
            ...
            3649: (u, e, A) => {
                ...
                const t = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    C = (u, e, A = F.left) => u.split(e).reduce(A === F.left ? B : n, []),
                    i = (() => {
                        const u = new RegExp(
                            [
                    ...
                    o = (u, e = F.left) => {
                        ...
                        return ((u, e = F.left) => {
                            ...
                            const E =
                                ...
                                D = t(u);
                            return (C(D, /( )/, e).forEach((u) => (A = A.concat(C(u, E, F.left)))), A);
                        })(u, e);
                    },
            ...
            1736: (u, e, A) => {
                var E = A(6483),
                    ...
                    t = A(7363),
                    B = A.n(t);
                const n = 'FormatGradientText_gradientBox_c3',
                    C = 'FormatGradientText_gradientText_39',
                    i = 'FormatGradientText_gradientText__copied_f8',
                    r = '%(gradientStart)',
                    o = '%(gradientEnd)';
                (0, t.memo)(({ text: u, binding: e, className: A, classNames: E }) => {
                    ...
                    if (u) {
                        ...
                        c &&
                            ...
                            (t['%'] = B().createElement(
                                'div',
                                { className: n },
                                B().createElement('div', { className: F()(C, null == E ? void 0 : E.text) }, d),
                                B().createElement(
                                    'div',
                                    { className: F()(C, i, null == E ? void 0 : E.copiedText) },
                                    d,
                                ),
                            )));
                    }
                    return B().createElement(D.z, { classMix: A, text: a, binding: t });
                });
            },
            476: (u, e, A) => {
