(() => {
    ...
    var __webpack_modules__ = {
            6963: (u, e, A) => {
                ...
                const C = 'FormatText_base_d0',
                    n = ({
                        ...
                        text: e = '',
                        classMix: A,
                        alignment: F = D.v2.left,
                        formatWithBrackets: n,
                    }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const i = n && u ? (0, D.WU)(e, u) : e;
                        return t().createElement(
                            ...
                            i.split('\n').map((e, n) =>
                                t().createElement(
                                    'div',
                                    { className: E()(C, A), key: `${e}-${n}` },
                                    (0, D.Uw)(e, F, u).map((u, e) =>
                                        t().createElement(B.Fragment, { key: `${e}-${u}` }, u),
                                    ),
                                ),
                            ),
                        );
            ...
            527: (u, e, A) => {
                A.r(e),
                    A.d(e, { mouse: () => i, off: () => C, on: () => t, onResize: () => D, onScaleUpdated: () => B });
                var F = A(2472),
                    E = A(1176);
                const D = (0, F.E)('clientResized'),
                    B = (0, F.E)('self.onScaleUpdated'),
                    t = (u, e) => engine.on(u, e),
            ...
            3138: (u, e, A) => {
                ...
                var F = A(5959),
                    E = A(514);
                const D = { view: A(7641), client: F, sound: E.ZP };
            },
            514: (u, e, A) => {
                A.d(e, { ZP: () => B });
                var F = A(5959);
                const E = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    D = Object.keys(E).reduce((u, e) => ((u[e] = () => (0, F.playSound)(E[e])), u), {}),
                    B = { play: Object.assign({}, D, { sound: F.playSound }), setRTPC: F.setRTPC };
            },
            3722: (u, e, A) => {
                function F(u, e, A = 1) {
            ...
            3649: (u, e, A) => {
                ...
                const B = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    n = (u, e, A = E.left) => u.split(e).reduce(A === E.left ? t : C, []),
                    i = (() => {
                        const u = new RegExp(
                    ...
                    o = (u, e = E.left) => {
                        ...
                        return ((u, e = E.left) => {
                            ...
                            const F =
                                ...
                                D = B(u);
                            return n(D, /( )/, e).forEach((u) => (A = A.concat(n(u, F, E.left)))), A;
                        })(u, e);
                    },
                        ...
                        sendShowPopOverEvent: (u, e, A, F, E = R.invalid('resId'), D) => {
                            const B = s.O.view.getViewGlobalPosition(),
                                ...
                                a = {
                                    ...
                                    y: s.O.view.pxToRem(i) + B.y,
                                    width: s.O.view.pxToRem(r),
            ...
            1736: (u, e, A) => {
                ...
                const C = 'FormatGradientText_gradientBox_c3',
                    ...
                    i = 'FormatGradientText_gradientText__copied_f8',
                    r = '%(gradientStart)',
                    o = '%(gradientEnd)';
                (0, B.memo)(({ text: u, binding: e, className: A, classNames: F }) => {
                    const B = e ? Object.assign({}, e) : {};
                    let a = u;
                    if (u) {
                        const e = r.length,
                            A = o.length,
                        ...
                        c &&
                            ...
                            (B['%'] = t().createElement(
                                'div',
                                { className: C },
                                t().createElement('div', { className: E()(n, null == F ? void 0 : F.text) }, _),
                                t().createElement(
                                    'div',
                                    { className: E()(n, i, null == F ? void 0 : F.copiedText) },
                                    _,
                                ),
                            )));
                    }
                    return t().createElement(D.z, { classMix: A, text: a, binding: B });
                });
            },
            476: (u, e, A) => {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [851], () => __webpack_require__(476));
