(() => {
        ...
        e = {
            ...
            9867: (u, e, t) => {
                            ...
                            const A = e.args,
                                F = (function (u, e) {
                                    ...
                                    var t,
                                        ...
                                        A = {},
                                        F = Object.keys(u);
                                    for (r = 0; r < F.length; r++) ((t = F[r]), e.indexOf(t) >= 0 || (A[t] = u[t]));
                                    return A;
                                })(e, h);
                            return void 0 !== A
                ...
                const ru = Z().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        Z().createElement(
                            'div',
                            tu({}, E, {
                                className: D()(uu.base, uu[`base__theme-${F}`], r),
                                ref: function (u) {
                ...
                const ou = (u) => {
                    return null !== u && 'object' == typeof u
                        ? 'CoherentArrayProxy' === u.constructor.name
                            ? ((e = u),
                              (t = (u) => ('object' == typeof u ? ou(u) : u)),
                              Array.isArray(e) ? e.map(t) : e.map((u, e, r) => t(null == u ? void 0 : u.value, e, r)))
                            : Array.isArray(u)
                              ? u.map((u) => ('object' == typeof u ? ou(u) : u))
                              : Object.fromEntries(
                                    Object.entries(u).map(([u, e]) => [u, 'object' == typeof e ? ou(e) : e]),
                                )
                        : u;
                    var e, t;
                };
                ...
                const mu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: A, children: F, mocks: E }) {
                                const a = (0, Q.useRef)([]),
                                    D = (t, r, A) => {
                                        var F;
                                        const E = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const a = 'string' == typeof F ? `${r}.${F}` : r,
                                                            D = q.view.addModelObserver(a, e, !0);
                                                        return (A.set(D, t), u && t(E(F)), D);
                                                    },
                                                    readByPath: E,
                                                    createCallback: (u, e) => {
                                                        const t = E(e);
                                    ...
                                    B = i[0],
                                    l = i[1],
                                    o = (0, Q.useState)(() => D(r, A, E)),
                                    C = o[0],
                                    m = o[1];
                                return (
                                    (0, Q.useEffect)(() => {
                                        n.current ? m(D(B, A, E)) : (n.current = !0);
                                    }, [E, B, A]),
                                    (0, Q.useEffect)(() => {
                                        l(r);
                                    }, [r]),
                        ...
                        const e = { selectedRewards: u.array('selectedRewards', []) },
                            t = (0, Cu.Om)(
                                () => {
                                    return ((u = e.selectedRewards.get()), ou(u)).map((u) => Object.assign({}, u));
                                    var u;
                                },
                                { equals: Du },
                            ),
                            r = (0, Cu.Om)(() => t().length);
                        return Object.assign({}, e, { computes: { getSelectedRewards: t, selectedRewardsLength: r } });
                    }, au),
                    su = mu[0],
                    cu = mu[1],
                    du = { base: 'App_base_5f', header: 'App_header_24', divider: 'App_divider_76' };
                var gu = t(9887),
                    _u = t.n(gu);
                const hu = (u, e, t) =>
                ...
                const vu = q.client.getSize('rem'),
                    bu = vu.width,
                    wu = vu.height,
                    Su = Object.assign({ width: bu, height: wu }, pu(bu, wu, xu)),
                    Tu = (0, Q.createContext)(Su),
                    Lu = ['children'];
                const yu = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && n) return hu(e, t, g);
                        if (t.largeWidth && i) return hu(e, t, g);
                    ...
                    const e = (0, Q.useContext)(Tu),
                        ...
                        F = (0, Q.useCallback)((u, e) => {
                            const t = q.view.pxToRem(u),
                                r = q.view.pxToRem(e);
                            A(Object.assign({ width: t, height: r }, pu(t, r, xu)));
                        }, []);
                    (Ru(() => {
                        engine.on('clientResized', F);
                    }),
                        (0, Q.useEffect)(() => () => engine.off('clientResized', F), [F]));
                    const E = (0, Q.useMemo)(() => Object.assign({}, r), [r]);
                    return Z().createElement(Tu.Provider, { value: E }, u);
                });
                let Mu, Hu, Ou;
                (!(function (u) {
                    ((u[(u.ExtraSmall = xu.extraSmall.width)] = 'ExtraSmall'),
                        (u[(u.Small = xu.small.width)] = 'Small'),
                        (u[(u.Medium = xu.medium.width)] = 'Medium'),
                        (u[(u.Large = xu.large.width)] = 'Large'),
                        (u[(u.ExtraLarge = xu.extraLarge.width)] = 'ExtraLarge'));
                })(Mu || (Mu = {})),
                    (function (u) {
                        ((u[(u.ExtraSmall = xu.extraSmall.width)] = 'ExtraSmall'),
                            (u[(u.Small = xu.small.width)] = 'Small'),
                    ...
                    (function (u) {
                        ((u[(u.ExtraSmall = xu.extraSmall.height)] = 'ExtraSmall'),
                            (u[(u.Small = xu.small.height)] = 'Small'),
                            (u[(u.Medium = xu.medium.height)] = 'Medium'),
                            (u[(u.Large = xu.large.height)] = 'Large'),
                            (u[(u.ExtraLarge = xu.extraLarge.height)] = 'ExtraLarge'));
                    })(Ou || (Ou = {})));
                const Wu = () => {
                        const u = (0, Q.useContext)(Tu),
                            e = u.width,
                            t = u.height,
                            r = ((u) => {
                                switch (!0) {
                    ...
                    ju = [Mu.ExtraLarge, Mu.Large, Mu.Medium, Mu.Small, Mu.ExtraSmall],
                    Gu = (u, e) =>
                ...
                const Vu = {
                    ...
                    Ku = Xu((u) => {
                        ...
                        const N = (0, Q.useMemo)(() => {
                            ...
                            }, [t, r, E, n, B, o, O, H, w, c, L, p, b]),
                            j = N.computedStyle,
                            G = N.computedClassNames;
                        return Z().createElement('div', zu({ className: D()(Iu.base, ...G, e), style: j }, P), W);
                    });
                let Yu;
                !(function (u) {
                ...
                const qu = (u, e, t) => {
                    ...
                    Zu = (u, e, t = Yu.left) => u.split(e).reduce(t === Yu.left ? qu : Qu, []),
                    Ju = (() => {
                        const u = new RegExp(
                    ...
                    re = ({ binding: u, text: e = '', classMix: t, alignment: r = Yu.left }) =>
                        null === e
                ...
                const ne = Object.keys(Fe()),
                    ...
                    se = Xu((u) => {
                        ...
                        return Z().createElement(
                            ...
                            De(
                                {
                                    className: D()(Ee.base, t && Ee[t], _, r),
                                    style: g,
                                    mt: !0 === a ? Ce[t || 'paragraph-P16'].mt : a,
                                    mr: !0 === i ? Ce[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === l ? Ce[t || 'paragraph-P16'].mb : l,
                                    ml: !0 === C ? Ce[t || 'paragraph-P16'].ml : C,
                                },
                                c,
                            ),
                            void 0 !== s ? Z().createElement(re, De({}, s, { text: e })) : e,
                        );
                    }),
                    ce = 'Header_base_cf',
                    de = 'Header_title_84',
                    ge = 'Header_amountRewards_4b',
                    _e = 'Header_subtitle_6d',
                    he = R.strings.seniority_awards.vehicleSelector.selectScreen.tooltip.rewardDiscount,
                    xe = ({ className: u, rewardsAmount: e }) =>
                        Z().createElement(
                            'div',
                            { className: D()(ce, u) },
                            Z().createElement(se, {
                                ...
                                format: {
                                    binding: {
                                        amountRewards: Z().createElement(se, { text: String(e), className: ge }),
                                    },
                                    classMix: de,
                                },
                            }),
                            Z().createElement(se, { text: e ? he.subtitle() : he.subtitleEmpty(), className: _e }),
                        ),
                ...
                const ve = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    Se = /(?:%\(|{)\w*(?:_[Oo]pen|Start)(?:\)s|})?(.*?)(?:%\(|{)\w*(?:_[Cc]lose|End)(?:\)s|})?/g,
                    Te = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Le = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    ye = (0, Q.memo)(({ text: u, binding: e, classMix: t }) => {
                        const r = (0, Q.useCallback)((u) => ({ color: `#${u}` }), []),
                            A = (0, Q.useMemo)(() => e || {}, [e]);
                        let F = Se.exec(u),
                            E = u,
                            a = 0;
                                ...
                                ((E = E.replace(t, `%(${F})`)),
                                    (A[F] = we[u]
                                        ? Z().createElement(
                                              'span',
                                              { className: we[u] },
                                              Z().createElement(re, { text: i, binding: e }),
                                          )
                                        : Z().createElement(
                                              'span',
                                              { style: r(u) },
                        ...
                        return Z().createElement(re, { text: E, classMix: t, binding: A });
                    }),
                    Re = {
                        base: 'Reward_base_bc',
                        vehicleLevel: 'Reward_vehicleLevel_93',
                        text: 'Reward_text_78',
                        rewardTitle: 'Reward_rewardTitle_84',
                        rewardSubtitle: 'Reward_rewardSubtitle_5c',
                        discountReward: 'Reward_discountReward_f0',
                        vehicleIcon: 'Reward_vehicleIcon_76',
                    },
                    Me = R.strings.seniority_awards.vehicleSelector.selectScreen.tooltip.rewardDiscountVehicle,
                    He = ({ vehicleLvl: u, userName: e, className: t }) => {
                        const r = be(u);
                        return Z().createElement(
                            'div',
                            ...
                            Z().createElement(
                                'div',
                                { className: Re.imagesContainer },
                                Z().createElement(
                                    'div',
                                    { className: Re.vehicleIcon },
                                    Z().createElement(se, { text: r, className: Re.vehicleLevel }),
                                ),
                            ),
                            Z().createElement(
                                'div',
                                ...
                                Z().createElement(se, {
                                    ...
                                    className: Re.rewardTitle,
                                }),
                                Z().createElement(ye, {
                                    text: Me.subtitle(),
                                    binding: { name: e },
                                    classMix: Re.rewardSubtitle,
                                }),
                            ),
                        );
                    };
                ...
                const We = (0, Eu.Pi)(() => {
                    const u = cu().model,
                        ...
                        t = u.computes.getSelectedRewards();
                    return Z().createElement(
                        'div',
                        { className: du.base },
                        Z().createElement(xe, { rewardsAmount: e, className: du.header }),
                        t.map((u, t) =>
                            Z().createElement(
                                Z().Fragment,
                                null,
                                Z().createElement('div', { className: du.divider }),
                                Z().createElement(
                                    He,
                                    Oe({}, u, {
                                        key: t,
                                        className: D()(du.reward, t === e - 1 && du.reward__lastInColumn),
                                    }),
                                ),
                            ),
                        ),
                ...
                engine.whenReady.then(() => {
                    Fu().render(
                        Z().createElement(su, null, Z().createElement(ru, null, Z().createElement(We, null))),
    ...
    function r(u) {
        ...
        var F = (t[u] = { exports: {} });
        return (e[u](F, F.exports, r), F.exports);
    }
    ((r.m = e),
        (u = []),
        (r.O = (e, t, A, F) => {
            if (!t) {
                ...
                for (i = 0; i < u.length; i++) {
                    for (var [t, A, F] = u[i], a = !0, D = 0; D < t.length; D++)
                        (!1 & F || E >= F) && Object.keys(r.O).every((u) => r.O[u](t[D]))
                            ? t.splice(D--, 1)
                            : ((a = !1), F < E && (E = F));
                    if (a) {
                        u.splice(i--, 1);
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); n < E.length; n++) ((F = E[n]), r.o(u, F) && u[F] && u[F][0](), (u[F] = 0));
                    return r.O(i);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
        })());
    var A = r.O(void 0, [851], () => r(9867));
    A = r.O(A);
})();
