(() => {
    ...
    var __webpack_modules__ = {
            ...
            451: (u, e, t) => {
                        ...
                        if (n.length > 0) {
                            ...
                            return (
                                n.reduce((e, n) => {
                                    ...
                                    return _(r) ? (u.push(r.id), `${e}.${n}.value`) : (u.push(n), `${e}.${n}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        D(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = C(u);
                                B.current = m.addCallback(n, t, a, e === v.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== v.None)
                                return () => {
                                    m.removeCallback(B.current, a);
                                };
                        }, [a, e]),
                        A
                    );
                ...
                x.defaultProps = { type: M.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const S = (0, n.memo)(x),
                    N = {
                        base: 'Button_base_8d',
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (V(t, _, { isMouseEvent: !0, on: !0, arguments: U(r) }, h),
                                    v && v(),
                            ...
                            y = (0, n.useCallback)((u) => {
                                f.current.isVisible &&
                                    ...
                                    (f.current.hideTimerId = window.setTimeout(() => {
                                        ...
                                        e && !e.isSameNode(f.current.prevTarget) && g();
                                    }, 200)));
                            }, []);
                        ((0, n.useEffect)(() => {
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((f.current.timeoutId = window.setTimeout(b, A ? 100 : 400)),
                                                      o && o(u),
                                                      O && O(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const K = R.views.common.tooltip_window.simple_tooltip_content,
                    ...
                    Z = ({ title: u, infoTooltipHeader: e, infoTooltipBody: t }) =>
                        r().createElement(
                            ...
                            { className: Y },
                            u,
                            e && t && r().createElement(q, { tooltipHeader: e, tooltipBody: t }),
                        ),
                    X = 'Header_base_ff',
                    ...
                    tu = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: f()(X, F && Q), onMouseDown: c },
                            ...
                            i &&
                                r().createElement(
                                    ...
                                    r().createElement('div', { className: f()(J, uu) }),
                                ),
                            e &&
                                r().createElement(I, {
                                    type: L.Minimize,
                        ...
                        (
                            ...
                            return (
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: f()(nu, F), style: { '--outer-shadow-width': '13rem' }, ref: c },
                                        r().createElement('div', { className: f()(ru, d && ou) }),
                                        r().createElement(tu, {
                                            title: u,
                                            infoTooltipHeader: E,
                                            infoTooltipBody: A,
                ...
                function cu() {
                    ...
                    function t(u, n, r) {
                        ...
                        return (e.set(o, r || e.get(u)), _u(o, t.prototype));
                    }
                    function n(u, t) {
                        var n = e.get(t);
                ...
                const du = ({ text: u, align: e, classMix: t }) => {
                    const n = f()(lu.paragraph, lu[`paragraph__${e}`]),
                        o = u.split('\n');
                    return r().createElement(
                        'div',
                        { className: t },
                        o.map((u, e) => r().createElement('div', { key: e, className: n }, Bu(u))),
                    );
                };
                ...
                const Cu = 'OfferBannerContent_base_2c',
                    ...
                    Ou = () => {
                        ...
                        return r().createElement(
                            'div',
                            { className: Cu },
                            r().createElement('div', { className: wu }, R.strings.offers.banner.giftsAvailable()),
                            ...
                            t
                                ...
                                : r().createElement(du, { text: E, align: 'center', classMix: fu }),
