                ...
                class I extends o().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = S()(M.base, M[`base__${s}`], M[`base__${r}`], null == a ? void 0 : a.base),
                            F = S()(M.icon, M[`icon__${s}`], M[`icon__${r}`], null == a ? void 0 : a.icon),
