(() => {
    ...
    var __webpack_modules__ = {
            ...
            364: (u, e, t) => {
                t.d(e, { Sw: () => r.Z, B3: () => E, Z5: () => s, B0: () => a, ry: () => C });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            920: (u, e, t) => {
                ...
                const b = (u, e, t = {}, n = 0) => {
                    ...
                    w = (u) => {
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            T = (0, n.useMemo)(() => p || i().resId, [p]),
                            P = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (b(t, D, { isMouseEvent: !0, on: !0, arguments: g(o) }, T),
                                    m && m(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((f.current.timeoutId = window.setTimeout(P, A ? 100 : 400)),
                                                      r && r(u),
                                                      O && O(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                                              (R(), null == s || s(e), null == u || u(e));
                ...
                const P = R.views.common.tooltip_window.simple_tooltip_content,
                    y = (u) => {
                        ...
                        const l = (0, n.useMemo)(() => {
                            const u = Object.assign({}, a, { body: t, header: r, note: s, alert: i });
                            ...
                            T(
                                {
                                    contentId:
                                        ...
                                        A ? P.SimpleTooltipHtmlContent('resId') : P.SimpleTooltipContent('resId')),
                ...
                class I extends o().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = S()(M.base, M[`base__${s}`], M[`base__${r}`], null == i ? void 0 : i.base),
                            F = S()(M.icon, M[`icon__${s}`], M[`icon__${r}`], null == i ? void 0 : i.icon),
                            D = S()(M.glow, null == i ? void 0 : i.glow),
                            d = S()(M.caption, M[`caption__${s}`], null == i ? void 0 : i.caption),
                            B = S()(M.goto, null == i ? void 0 : i.goto);
                        return o().createElement(
                            'div',
                            x(
                                {
                            ...
                            'info' !== s && o().createElement('div', { className: M.shine }),
                ...
                const nu = [
                    ...
                    ou = [X.Gold, X.Credits, X.Crystal, X.FreeXp],
                    ru = [X.BattlePassPoints],
                ...
                const au = {
                    ...
                    Eu = ({
                        ...
                        return o().createElement(
                            'div',
                            { className: S()(au.base, au[`base__${n}`], E), style: a },
                            o().createElement(
                                z,
                                { tooltipArgs: A, className: au.tooltipWrapper },
                                o().createElement(
                                    o().Fragment,
                                    null,
                                    o().createElement(
                                        'div',
                                        { className: S()(au.image, null == l ? void 0 : l.image) },
                                        c &&
                                            o().createElement('div', {
                                                className: S()(au.highlight, null == l ? void 0 : l.highlight),
                                                style: {
                                        ...
                                        e &&
                                            o().createElement('div', {
                                                className: S()(au.icon, null == l ? void 0 : l.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        F &&
                                            o().createElement('div', {
                                                className: S()(au.overlay, null == l ? void 0 : l.overlay),
                                                style: {
                            ...
                            t &&
                                o().createElement(
                                    ...
                                    { tooltipArgs: _ },
                                    o().createElement('div', {
                                        className: S()(au.timer, null == l ? void 0 : l.periodicIcon),
                                    }),
                                ),
                        );
                    };
                        ...
                        (t.prototype[Symbol.replace] = function (t, o) {
                            ...
                            if ('function' == typeof o) {
                                ...
                                return u[Symbol.replace].call(this, t, function () {
                                    var u = arguments;
                                    return (
                                        'object' != typeof u[u.length - 1] && (u = [].slice.call(u)).push(n(u, s)),
                                        o.apply(this, u)
                                    );
                                });
                            }
                                ...
                                const i = n[2]
                                    ...
                                    .map(
                                        (u, e, r) => (
                                            ...
                                            o().createElement(
                                                'span',
                                                { key: `sub${t}-${s}-${e}`, className: _u[n[1]] },
                                                u,
                                            )
                                        ),
                                    );
                                for (; s < r.length;) (r.splice(s, 0, ...i), (s += i.length + 1));
                ...
                const Bu = ({ text: u, align: e, classMix: t }) => {
                    const n = S()(_u.paragraph, _u[`paragraph__${e}`]),
                        r = u.split('\n');
                    return o().createElement(
                        'div',
                        { className: t },
                ...
                const Cu = 'App_base_e1',
                    ...
                    Tu = () => {
                        ...
                        return o().createElement(
                            ...
                            o().createElement('span', { className: vu }, R.strings.offers.rewardWindow.title()),
                            o().createElement('span', { className: hu }, o().createElement(Bu, { text: e })),
                            o().createElement(
                                'div',
                                { className: gu },
                                o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    Y,
                                    { type: L.primary, size: G.medium, mixClass: fu, onClick: C },
                ...
                function Ru() {
                    s().render(o().createElement(Tu, null), Pu);
                }
                ((window.onload = () => {
