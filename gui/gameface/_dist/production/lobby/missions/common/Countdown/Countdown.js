(() => {
    ...
    var __webpack_modules__ = {
            ...
            70: (u, e, F) => {
                ...
                var A = {};
                (F.r(A),
                    F.d(A, { mouse: () => s, off: () => a, on: () => B, onResize: () => o, onScaleUpdated: () => r }));
                var E = {};
                (F.r(E),
                    F.d(E, {
                        events: () => A,
                ...
                var t = {};
                (F.r(t), F.d(t, { getBgUrl: () => f, getTextureUrl: () => b }));
                var n = {};
                function D(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const v = {
                    ...
                    g = { play: Object.assign({}, p, { sound: _ }), setRTPC: d };
                var m = F(9690);
                function b(u, e, F = 1) {
                ...
                const iu = { view: n, client: E, sound: g, intl: w };
            },
            6364: (u, e, F) => {
                (F(7044), F(7363));
                F(70);
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [45], () => __webpack_require__(2993));
