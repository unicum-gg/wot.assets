        ...
        n = {
            3252: (e, n, t) => {
                ...
                const oe = u().forwardRef(function (e, n) {
                    ...
                    de = 'App_subheader_b2',
                    ce = 'App_icon_ba',
                    le = 'App_description_cd',
                    ve = R.strings.subscription.dailyQuestsDisabledReward,
                    me = () =>
                        u().createElement(
                            oe,
                            null,
                            u().createElement(
                                ...
                                u().createElement(
                                    'div',
                                    { className: se },
                                    u().createElement('div', { className: ue }, ve.header()),
                                    u().createElement(
                                        'div',
                                        { className: de },
                                        u().createElement('div', { className: ce }),
                                        u().createElement('div', null, ve.subheader()),
                                    ),
                                    u().createElement('div', { className: le }, ve.description()),
                                ),
                            ),
                        );
                engine.whenReady.then(() => {
                    c().render(u().createElement(me, null), document.getElementById('root'));
                });
            },
        },
        t = {};
