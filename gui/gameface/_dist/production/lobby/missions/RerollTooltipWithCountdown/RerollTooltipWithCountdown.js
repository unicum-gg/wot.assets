(() => {
    ...
    var __webpack_modules__ = {
            ...
            70: (u, e, t) => {
                ...
                var n = {};
                (t.r(n),
                    t.d(n, { mouse: () => C, off: () => s, on: () => D, onResize: () => i, onScaleUpdated: () => a }));
                var F = {};
                (t.r(F),
                    t.d(F, {
                        events: () => n,
                ...
                const v = {
                    ...
                    h = Object.keys(w).reduce((u, e) => ((u[e] = () => l(w[e])), u), {}),
                    p = { play: Object.assign({}, h, { sound: l }), setRTPC: c };
                var g = t(9690);
                function b(u, e, t = 1) {
                ...
                const ou = { view: E, client: F, sound: p, intl: m };
            },
            6364: (u, e, t) => {
                t.d(e, { au: () => i });
                var n = t(7044),
                            ...
                            (0, F.useEffect)(() => {
                                if (u > 0) {
                                    ...
                                    const F = Date.now(),
                                        A = e || (u > 2 * n.yR ? n.yR : 1),
                                        r = setInterval(() => {
                                            const e = u - Math.floor((Date.now() - F) / n.s_);
                                            null !== t && e <= t ? (i(t), E && E(), clearInterval(r)) : i(e);
                                        }, A * n.s_);
                                    return () => {
                                        clearInterval(r);
                                    };
            ...
            9690: (u, e, t) => {
                ...
                function A(u) {
                    let e = '';
                    for (let t = F.length - 1; t >= 0; t--) for (; u >= F[t];) ((e += n[t]), (u -= F[t]));
                    return e;
                }
            ...
            1358: (u, e, t) => {
                ...
                class F {
                    ...
                    addCallback(u, e, t = 0, F = !0) {
                        ...
                        const A = n.O.view.addModelObserver(u, t, F);
                        return (
                            A > 0
                                ? ((this._callbacks[A] = e),
            ...
            9916: (u, e, t) => {
                ...
                const p = F.instance,
                    g = {
                        ...
                        sendShowPopOverEvent: (u, e, t, n, F = R.invalid('resId'), A) => {
            ...
            5017: (u, e, t) => {
                ...
                const l = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            C({}, o, {
                                className: i()(s.base, s[`base__theme-${r}`], A),
                                ref: function (u) {
                ...
                const c = (u, e, t) => {
                        const n = Math.floor(e / 3600).toString(),
                            F = Math.floor((e % 3600) / 60).toString(),
                            A = Math.floor(e % 60).toString();
                        return u
                            .replace('%HH', n.padStart(2, '0'))
                            .replace('%H', t && Number(F) >= 30 ? (Number(n) + 1).toString() : n)
                            .replace('%MM', F.padStart(2, '0'))
                            .replace('%M', F.toString())
                            .replace('%SS', A.padStart(2, '0'))
                            .replace('%S', A);
                    },
                    d = 'RerollTooltipContent_base_a9',
                    _ = 'RerollTooltipContent_header_77',
                    v = 'RerollTooltipContent_desc_42',
                    m = 'RerollTooltipContent_desc_timeLeft_2a',
                    w = 'RerollTooltipContent_available_63',
                    h = 'RerollTooltipContent_available_icon_cf',
                    p = 'RerollTooltipContent_available_timeLeft_13';
                var g = t(6364);
                const b = ({ model: u, showTimer: e }) => {
                    ...
                    const o = (0, n.useMemo)(() => {
                            return (u = E) < 60 ? 'timer_sec' : u < 3600 ? 'timer_min' : 'timer_hrs';
                            var u;
                        }, [E]),
                        i = (0, n.useMemo)(() => {
                            return (u = t) < 3600 ? 'desc_min_only' : u % 3600 > 0 ? 'desc_hrs_min' : 'desc_hrs';
                            var u;
                        }, [t]),
                        a = R.strings.quests.dailyQuests.missionSwitch.tooltip.body.desc(),
                        D = (0, n.useMemo)(
                            () => a.split(' ').map((u, e) => F().createElement('span', { key: e }, u)),
                            [a],
                        );
                    return F().createElement(
                        ...
                        F().createElement(
                            'div',
                            { className: _ },
                            R.strings.quests.dailyQuests.missionSwitch.tooltip.header(),
                        ),
                        e &&
                            F().createElement(
                                'div',
                                { className: w },
                                F().createElement('div', { className: h }),
                                F().createElement(
                                    'span',
                                    null,
                                    R.strings.quests.dailyQuests.missionSwitch.tooltip.body.available(),
                                ),
                                F().createElement(
                                    'span',
                                    { className: p },
                                    c(R.strings.quests.general.countdown[`${o}`](), E),
                                ),
                            ),
                        F().createElement(
                            'p',
                            ...
                            F().createElement(
                                'span',
                                { className: m },
                                c(R.strings.quests.dailyQuests.missionSwitch.tooltip.body[i](), t),
                            ),
                            D,
                        ),
                    );
                };
                b.defaultProps = { showTimer: !1 };
                class f extends F().Component {
                    constructor(u) {
                        (super(u),
                            (this.tracker = new r.Sw()),
                            (this.modelCallbackID = 0),
                            (this.state = { model: window.model }));
                    }
                    componentDidMount() {
                        const u = () => {
                            this.modelCallbackID = this.tracker.addCallback('model', (u) => {
                                this.setState({ model: u });
                            });
                        };
                        (engine._BindingsReady && engine._WindowLoaded ? u() : engine.on('Ready', u),
                            window.addEventListener('keydown', r.SU));
                    }
                    componentWillUnmount() {
                        (this.tracker.clear(),
                            this.modelCallbackID > 0 &&
                                (this.tracker.removeCallback(this.modelCallbackID), (this.modelCallbackID = 0)),
                            window.removeEventListener('keydown', r.SU));
                    }
                    render() {
                        return F().createElement(
                            l,
                            null,
                            F().createElement(b, { model: this.state.model, showTimer: !0 }),
                        );
                    }
                }
                const y = document.createElement('div');
                ((window.onload = () => document.body.appendChild(y)), E().render(F().createElement(f, null), y));
            },
            2993: (u, e, t) => {
                (t(7044), t(6364), t(7363), t(1272));
            },
            1272: (u, e, t) => {
                t(7363);
            },
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 315),
        (() => {
            var u = { 315: 0, 224: 0, 536: 0 };
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); o < A.length; o++)
                        ((F = A[o]), __webpack_require__.o(u, F) && u[F] && u[F][0](), (u[F] = 0));
                    return __webpack_require__.O(i);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
        })());
    var __webpack_exports__ = __webpack_require__.O(void 0, [45], () => __webpack_require__(5017));
