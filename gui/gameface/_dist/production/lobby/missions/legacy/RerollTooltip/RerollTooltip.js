(() => {
    ...
    var __webpack_modules__ = {
            ...
            67: (u, e, t) => {
                ...
                var E = {};
                t.r(E), t.d(E, { getBgUrl: () => _, getTextureUrl: () => c });
                var n = {};
                function r(u) {
                    return (e) => (
                        engine.on(u, e),
                            ...
                            (0, A.useEffect)(() => {
                                if (u > 0) {
                                    ...
                                    const A = Date.now(),
                                        E = e || (u > 2 * F.yR ? F.yR : 1),
                                        r = setInterval(() => {
                                            const e = u - Math.floor((Date.now() - A) / F.s_);
                                            null !== t && e <= t ? (i(t), n && n(), clearInterval(r)) : i(e);
                                        }, E * F.s_);
                                    return () => {
                                        clearInterval(r);
                                    };
            ...
            364: (u, e, t) => {
                ...
                function _(u, e, t, A, F, E, n) {
                    ...
                    r.done ? e(o) : Promise.resolve(o).then(A, F);
                }
            ...
            290: (u, e, t) => {
                ...
                const c = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            C({}, o, {
                                className: i()(s.base, s[`base__theme-${r}`], E),
                                ref: function (u) {
                ...
                t(411);
                const _ = (u, e, t) => {
                        const A = Math.floor(e / 3600).toString(),
                            F = Math.floor((e % 3600) / 60).toString(),
                            E = Math.floor(e % 60).toString();
                        return u
                            .replace('%HH', A.padStart(2, '0'))
                            .replace('%H', t && Number(F) >= 30 ? (Number(A) + 1).toString() : A)
                            .replace('%MM', F.padStart(2, '0'))
                            .replace('%M', F.toString())
                            .replace('%SS', E.padStart(2, '0'))
                            .replace('%S', E);
                    },
                    l = 'RerollTooltipContent_base_4d',
                    d = 'RerollTooltipContent_header_e2',
                    v = 'RerollTooltipContent_desc_11',
                    m = 'RerollTooltipContent_desc_timeLeft_4c',
                ...
                const f = ({ model: u, showTimer: e }) => {
                    ...
                    const o = (0, A.useMemo)(() => {
                            return (u = n) < 60 ? 'timer_sec' : u < 3600 ? 'timer_min' : 'timer_hrs';
                            var u;
                        }, [n]),
                        i = (0, A.useMemo)(() => {
                        ...
                        D = R.strings.quests.dailyQuests.missionSwitch.tooltip.body.desc(),
                        a = (0, A.useMemo)(
                            () => D.split(' ').map((u, e) => F().createElement('span', { key: e }, u)),
                            [D],
                        );
                        ...
                        e &&
                            F().createElement(
                                ...
                                F().createElement(
                                    'span',
                                    { className: p },
                                    _(R.strings.quests.general.countdown[`${o}`](), n),
                                ),
                            ),
                        F().createElement(
                            'p',
                            ...
                            F().createElement(
                                'span',
                                { className: m },
                                _(R.strings.quests.dailyQuests.missionSwitch.tooltip.body[i](), t),
                            ),
                            a,
                        ),
                    );
                ...
                class g extends F().Component {
                    ...
                    render() {
                        return F().createElement(c, null, F().createElement(f, { model: this.state.model }));
                    }
                }
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.O = (u, e, t, A) => {
            if (!e) {
                ...
                for (o = 0; o < deferred.length; o++) {
                    for (var [e, t, A] = deferred[o], E = !0, n = 0; n < e.length; n++)
                        (!1 & A || F >= A) &&
        ...
        (__webpack_require__.j = 654),
        (() => {
            var u = { 654: 0, 428: 0, 993: 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [45], () => __webpack_require__(290));
