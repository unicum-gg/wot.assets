(() => {
    var __webpack_modules__ = {
            875: (e, u, t) => {
                ...
                const F = 'ProgressBarDeltaGrow_base_7e',
                    D = 'ProgressBarDeltaGrow_base__withoutBounce_b5',
                    p = 'ProgressBarDeltaGrow_glow_68',
                    C = (e) => (e ? { left: 0 } : { right: 0 }),
                    B = (e, u) => (e ? { right: 100 - u + '%' } : { left: `${u}%` }),
                    ...
                    f = (0, r.memo)(
                        ({
                            ...
                            const x = (0, r.useMemo)(() => Object.assign({ width: '100%' }, b(e), C(E)), [E, e]),
                                N = (0, r.useMemo)(() => Object.assign({ width: '0%' }, b(e), C(E)), [E, e]),
                                P = (0, r.useMemo)(() => Object.assign({ width: '0%' }, B(E, n), b(e)), [n, E, e]),
                                k = (0, r.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - n)}%` }, B(E, n), b(e)),
                                    [n, E, o, e],
                                );
                            if (v) return null;
                            const M = a()(F, m, E && 0 === o && D);
                            return s().createElement(
                                'div',
                                { style: w ? P : k, className: M },
                                s().createElement(
                                    'div',
                                    { style: S ? N : x, className: p },
                ...
                const x = (0, r.memo)((e) => {
                        ...
                        switch (n.animationSettings.type) {
                            case o.r.Simple:
                                return s().createElement(S, R({}, n, { onEndAnimation: c, isComplete: i }));
                            case o.r.Growing:
                                return s().createElement(h, R({}, n, { onEndAnimation: c, isComplete: i }));
                            default:
                                return null;
                        }
                    }),
                    N = ({ size: e, value: u, lineRef: t, disabled: n, onComplete: a }) => {
                ...
                const M = (0, r.memo)((e) => {
                    ...
                    return (
                        (n.current.from = i),
                        s().createElement(x, k({}, t, { onEndAnimation: a, key: `${i}-${t.to}`, from: i }))
                    );
                });
                function I() {
                    return (
            ...
            22: (e, u, t) => {
                ...
                var a = {};
                (t.r(a), t.d(a, { Area: () => Ju, Bar: () => Xu, Default: () => Zu, useVerticalScrollApi: () => Iu }));
                var r = t(179),
                    s = t.n(r);
                const i = (e, u, t) =>
                ...
                const te = [
                        ...
                        j.GoldenTicket,
                        j.PostStamp,
                        j.BlankPersonalMissions_1,
                        j.BlankPersonalMissions_2,
                        j.SACoin,
                        j.PremiumPlusUniversal,
                        j.NyPetGoodies,
                        j.HiddenVehicle,
                    ],
                    ne = [j.Gold, j.Credits, j.Crystal, j.FreeXp, j.NewYearToyFragments],
                ...
                const ie = (e) =>
                    ...
                    ce = (e, u = X.Small, t) => {
                        ...
                        switch (n) {
                            ...
                            case 'premium':
                                return `R.images.gui.maps.icons.quests.bonuses.${u}.${n}_plus_${r}`;
                            case 'premium_plus':
                ...
                const ve = { [he.DailyQuests]: 'dailyQuests', [he.PremiumQuests]: 'premiumQuests' },
                    we = (e) => {
                        if (void 0 !== e)
                            return (
                                void 0 === ve[e] &&
                    ...
                    Se = (e, u, t) =>
                        Ae(e, (e) => ({
                            ...
                            value: e.value,
                            valueType: ie(e.name),
                            tooltipArgs: de({ [Be]: `${u}:${e.index}` }, Number(e.tooltipContentId), {
                                ignoreShowDelay: !0,
                            }),
                        })),
                    Te = (e, u) => (e.items.length >= 1 ? e : u.items.length >= 1 ? u : void 0),
                    Re = (e) =>
                        (function (e, u) {
                            ...
                            return t;
                        })(e, (e) => e.status === me.Done || e.status === me.UndoneSubscription).length,
                    xe = (e) => e.filter((e) => e.value).length,
                    Ne =
                        (Object.values(Z),
                        be.VEHICLE_FOR_GIFT,
                        be.VEHICLE_DISCOUNT,
                                    ...
                                    enter: Object.assign(
                                        {
                                            opacity: 1,
                                            pointerEvents: 'auto',
                                            config: { duration: 400, easing: Ne.easeInSine },
                                        },
                                        r,
                                    ),
                                    leave: Object.assign(
                                        {
                                            opacity: 0,
                                            pointerEvents: 'none',
                                            config: { duration: 400, easing: Ne.easeOutSine },
                                        },
                                        i,
                                    ),
                                    expires: !1,
                                    ...
                                    enter: Object.assign(
                                        {
                                            ...
                                            pointerEvents: 'auto',
                                            config: { duration: 200, easing: Ne.easeOutCirc },
                                        },
                                        s,
                                    ),
                                    leave: Object.assign(
                                        {
                                            ...
                                            pointerEvents: 'none',
                                            config: { duration: 300, easing: Ne.easeInCirc },
                                        },
                                        o,
                                    ),
                                    expires: !1,
                                    ...
                                    enter: Object.assign(
                                        {
                                            ...
                                            pointerEvents: 'auto',
                                            config: { duration: 300, easing: Ne.easeOutQuint },
                                        },
                                        s,
                                    ),
                                    leave: Object.assign(
                                        {
                                            ...
                                            pointerEvents: 'none',
                                            config: { duration: 300, easing: Ne.easeInCubic },
                                        },
                                        o,
                                    ),
                                    expires: !1,
                ...
                const ze = ((e, u) => {
                                    ...
                                    d = (t, n, a) => {
                                        ...
                                        const s = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var e, t = Oe(a.keys()); !(e = t()).done; ) r(e.value, u);
                                                    },
                                                    unsubscribe: r,
                                                };
                                            })(n),
                        ...
                        ({ observableModel: e }) => {
                            const u = {
                                ...
                                n = (0, $e.Om)(() =>
                                    [
                                        { tabIndex: he.DailyQuests, isEnabled: u.daily.get().isEnabled },
                                        { tabIndex: he.PremiumQuests, isEnabled: u.premium.get().isEnabled },
                                ...
                                s = (0, $e.Om)(() => u.dailyQuests.get().some((e) => e.value.isEnabledSubscription)),
                                i = (0, $e.Om)(() => u.dailyQuestsCompletedVisited.get(), { equals: Ie }),
                                o = (0, $e.Om)(() => u.premiumQuestsCompletedVisited.get(), { equals: Ie }),
                                l = (0, $e.Om)((e, u) => {
                                    switch (e) {
                                        case he.DailyQuests:
                                            return Ee(i(), u);
                                        ...
                                        ge(
                                            ...
                                            (e, t) => {
                                                ...
                                                return (
                                                    void 0 !== n &&
                                                    (e.id !== n.id ||
                                                        ((e.status === me.Done || e.status === me.UndoneSubscription) &&
                                                            n.status !== me.Done &&
                                                            n.status !== me.UndoneSubscription))
                                                );
                                            },
                                            (e) => e.id,
                                        ),
                ...
                class Ke extends s().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            E = b()(je.base, je[`base__${r}`], je[`base__${a}`], null == i ? void 0 : i.base),
                            _ = b()(je.icon, je[`icon__${r}`], je[`icon__${a}`], null == i ? void 0 : i.icon),
                            A = b()(je.glow, null == i ? void 0 : i.glow),
                            g = b()(je.caption, je[`caption__${r}`], null == i ? void 0 : i.caption),
                            F = b()(je.goto, null == i ? void 0 : i.goto);
                        return s().createElement(
                            'div',
                            Xe(
                                {
                        ...
                        const b = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            h = (0, r.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (eu(t, _, { isMouseEvent: !0, on: !0, arguments: Je(n) }, f),
                                    p && p(),
                ...
                const au = R.views.common.tooltip_window.simple_tooltip_content,
                    ...
                    su = R.strings.quests.infoPage,
                    iu = (0, q.Pi)(({ className: e }) => {
                        const u = Ge(),
                            t = u.model,
                            n = u.controls,
                            a = t.root.get(),
                        ...
                        return s().createElement(
                            ...
                            r
                                ? s().createElement(Ke, {
                                      type: 'back',
                                      caption: su.infoButton.back.title(),
                                      goto: o >= v.Small ? su.infoButton.back.goto() : void 0,
                                      onClick: n.infoToggle,
                                  })
                                : s().createElement(
                                      ru,
                                      {
                                          body: su.infoButtonTooltip.body(),
                                          header: su.infoButtonTooltip.header.$dyn(i),
                                      },
                                      s().createElement(Ke, {
                                          type: 'info',
                                          caption: su.infoButton.$dyn(i),
                                          onClick: n.infoToggle,
                                      }),
                                  ),
                        );
                ...
                function du(e) {
                    ...
                    return (
                        ...
                        (0, r.useCallback)((...e) => (0, u.current)(...e), cu)
                    );
                }
                function mu(e, u, t = []) {
                ...
                function Eu(e, u) {
                    ...
                    if (
                        ...
                        (t = (function (e, u) {
                            if (!e) return;
                            if ('string' == typeof e) return _u(e, u);
                            var t = Object.prototype.toString.call(e).slice(8, -1);
                            'Object' === t && e.constructor && (t = e.constructor.name);
                            if ('Map' === t || 'Set' === t) return Array.from(e);
                            if ('Arguments' === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))
                ...
                const Fu = {
                    ...
                    hu = 'HorizontalBar_track_0d',
                    vu = 'HorizontalBar_thumb_fd',
                    ...
                    Nu = (0, r.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Tu, onDrag: n = Ru }) => {
                        const a = (0, r.useRef)(null),
                            ...
                            g = () => {
                                ...
                                const r = e.animationScroll.scrollPosition.get(),
                                    s = Math.min(1, n / a),
                                    d = (0, lu.u)(0, 1, r / (a - n)),
                                    m = (u.offsetWidth - xu(u, s)) * d;
                                ((t.style.transform = `translateX(${0 | m}px)`),
                                    ((e) => {
                                        if (i.current && o.current && l.current && c.current) {
                                            if (0 === e)
                                                return (
                                                    i.current.classList.add(yu),
                                                    void o.current.classList.remove(yu)
                                                );
                                            if (
                                                ((u = l.current),
                                                (t = c.current),
                                                ...
                                                return (
                                                    i.current.classList.remove(yu),
                                                    void o.current.classList.add(yu)
                                                );
                                            var u, t;
                                            (i.current.classList.remove(yu), o.current.classList.remove(yu));
                                        }
                                    })(m));
                            },
                            F = du(() => {
                        ...
                        const D = mu((u) => e.applyStepTo(u), d, [e]),
                            p = D[0],
                            C = D[1];
                        (0, r.useEffect)(
                            () => (
                        ...
                        const B = (e) => {
                            e.target.classList.contains(yu) || qe('highlight');
                        };
                        return s().createElement(
                            'div',
                            ...
                            s().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(yu) || 0 !== e.button || (qe('play'), p(gu.Next));
                                },
                                onMouseUp: C,
                                ref: i,
                                onMouseEnter: B,
                                    ...
                                    onMouseDown: (u) => {
                                        ...
                                        if (n && 0 === u.button)
                                            if ((qe('play'), u.target === n))
                                                ...
                                                })(u.screenX > n.getBoundingClientRect().x ? gu.Prev : gu.Next);
                                            }
                                    },
                                    ref: l,
                                    onMouseEnter: B,
                                },
                                s().createElement('div', { ref: c, className: b()(vu, u.thumb) }),
                                s().createElement('div', { className: b()(wu, u.rail) }),
                            ),
                            s().createElement('div', {
                                className: b()(fu, u.rightButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(yu) || 0 !== e.button || (qe('play'), p(gu.Prev));
                                },
                                onMouseUp: C,
                                ref: o,
                                onMouseEnter: B,
                    ...
                    ku = ({
                        ...
                        const d = (0, r.useMemo)(() => {
                                const e = n || {};
                                return Object.assign({}, e, { base: b()(Pu.base, e.base) });
                            }, [n]),
                            m = (0, r.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
                        return s().createElement(
                            'div',
                            { className: b()(Pu.defaultScroll, t), onWheel: u.handleMouseWheel },
                            s().createElement(
                                'div',
                                { className: b()(Pu.defaultScrollArea, a) },
                                s().createElement(Mu, { className: o, api: m, classNames: i }, e),
                            ),
                            s().createElement(Nu, { getStepByRailClick: l, api: u, onDrag: c, classNames: d }),
                        );
                    },
                    Mu = ({ api: e, className: u, classNames: t, children: n, style: a }) => (
                        (0, r.useEffect)(() => ou(e.recalculateContent)),
                        s().createElement(
                            'div',
                            { className: b()(Pu.base, u), style: a },
                            s().createElement(
                                'div',
                                {
                                ...
                                s().createElement(
                                    'div',
                                    { className: b()(Pu.content, null == t ? void 0 : t.content), ref: e.contentRef },
                                    n,
                                ),
                            ),
                        )
                ...
                ((Mu.Bar = Nu),
                    ...
                    (Mu.SeniorityAwards = ({ api: e, className: u, classNames: t, children: n }) => (
                        ...
                        s().createElement(
                            'div',
                            { className: b()(Pu.base, u) },
                            s().createElement(
                                'div',
                                { className: b()(Pu.wrapper, null == t ? void 0 : t.wrapper), ref: e.wrapperRef },
                                s().createElement(
                                    'div',
                                    { className: b()(Pu.content, null == t ? void 0 : t.content), ref: e.contentRef },
                                    n,
                ...
                const Iu = Du({
                    ...
                    Xu = (0, r.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Vu, onDrag: n = Qu }) => {
                        const a = (0, r.useRef)(null),
                            i = (0, r.useRef)(null),
                            o = (0, r.useRef)(null),
                            l = (0, r.useRef)(null),
                            ...
                            F = du(() => {
                                ...
                                const r = e.animationScroll.scrollPosition.get(),
                                    s = Math.min(1, n / a),
                                    d = (0, lu.u)(0, 1, r / (a - n)),
                                    m = (u.offsetHeight - Yu(u, s)) * d;
                                ((t.style.transform = `translateY(${0 | m}px)`),
                                    ((e) => {
                                        if (i.current && o.current && l.current && c.current) {
                                            if (0 === e)
                                                return (
                                                    i.current.classList.add(Gu),
                                                    void o.current.classList.remove(Gu)
                                                );
                                            if (
                                                ((u = l.current),
                                                (t = c.current),
                                                ...
                                                return (
                                                    i.current.classList.remove(Gu),
                                                    void o.current.classList.add(Gu)
                                                );
                                            var u, t;
                                            (i.current.classList.remove(Gu), o.current.classList.remove(Gu));
                                        }
                                    })(m));
                            }),
                            D = du(() => {
                        ...
                        const p = mu((u) => e.applyStepTo(u), d, [e]),
                            C = p[0],
                            B = p[1];
                        (0, r.useEffect)(
                            () => (
                        ...
                        const f = (e) => {
                            e.target.classList.contains(Gu) || qe('highlight');
                        };
                        return s().createElement(
                            'div',
                            { className: b()(Lu, u.base), ref: a, onWheel: e.handleMouseWheel },
                            s().createElement('div', {
                                className: b()(Hu, u.topButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Gu) || 0 !== e.button || (qe('play'), C(gu.Next));
                                },
                                ref: i,
                                onMouseEnter: f,
                            }),
                                    ...
                                    onMouseDown: (u) => {
                                        ...
                                        if (n && 0 === u.button)
                                            if ((qe('play'), u.target === n))
                                                ...
                                                })(u.screenY > n.getBoundingClientRect().y ? gu.Prev : gu.Next);
                                            }
                                    },
                                    ref: l,
                                    onMouseEnter: f,
                            ...
                            s().createElement('div', {
                                className: b()(Uu, u.bottomButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Gu) || 0 !== e.button || (qe('play'), C(gu.Prev));
                                },
                                onMouseUp: B,
                                ref: o,
                                onMouseEnter: f,
                    ...
                    Zu = ({
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                'div',
                                { className: b()(Ku.area, a) },
                                s().createElement(Ju, { className: i, classNames: o, api: m }, e),
                            ),
                    ...
                    Ju = ({ className: e, classNames: u, children: t, api: n }) => (
                        ...
                        s().createElement(
                            'div',
                            { className: b()(Ku.base, e), ref: n.wrapperRef, onWheel: n.handleMouseWheel },
                            s().createElement(
                                'div',
                                { className: b()(Ku.content, null == u ? void 0 : u.content), ref: n.contentRef },
                                t,
                            ),
                        )
                    );
                Ju.Default = Zu;
                const et = { Vertical: a, Horizontal: n };
                var ut = t(411),
                    tt = t(982),
                    nt = t(649);
                const at = 'FormatText_base_d0',
                    rt = ({ binding: e, text: u = '', classMix: t, alignment: n = nt.v2.left }) =>
                        null === u
                            ...
                            : s().createElement(
                                  ...
                                  u.split('\n').map((u, a) =>
                                      s().createElement(
                                          'div',
                                          { className: b()(at, t), key: `${u}-${a}` },
                                          (0, nt.Uw)(u, n, e).map((e, u) =>
                ...
                const ot = ({ icon: e, title: u, paragraph: t, cardType: n = it.General }) =>
                        s().createElement(
                            'div',
                            { className: b()(st.base, st[`base__${n}`]) },
                            s().createElement('div', { className: st.image, style: { backgroundImage: `url(${e})` } }),
                            s().createElement(
                                'div',
                                { className: st.container },
                                s().createElement(rt, { text: u, classMix: st.title }),
                                s().createElement(rt, { text: t, classMix: st.content }),
                            ),
                        ),
                    lt = R.strings.quests.infoPage,
                    ct = R.images.gui.maps.icons.missions.icons,
                    dt = (...e) => e.filter((e) => e.length).join('\n'),
                    mt = 'InfoPage_base_dd',
                    Et = 'InfoPage_scrollContent_4d',
                    _t = 'InfoPage_scrollBar_f7',
                    At = 'InfoPage_content_24',
                    gt = 'InfoPage_missionsDescription_ba',
                    Ft = 'InfoPage_generalDescription_9b',
                    Dt = 'InfoPage_separator_44',
                ...
                const Bt = R.strings.quests.infoPage,
                    bt = (0, q.Pi)(() => {
                        const e = Ge().model,
                            ...
                            c =
                                t === U.Default
                                    ? ((e, u, t, n) => {
                                          const a = n >= v.Medium ? ct.big : ct,
                                              r = u ? lt.dailyMissions.subscription.default() : '';
                                          return {
                                              missionsDescription: [
                                                  {
                                                      cardType: it.HorizontalReversed,
                                                      icon: e ? a.daily_bp_active() : a.daily(),
                                                      title: lt.dailyMissionTitle(),
                                                      paragraph: dt(
                                                          e
                                                              ? lt.dailyMissions.battlePassDailyMissions.default()
                                                              : lt.dailyMissions.default(),
                                                          r,
                                                      ),
                                                  },
                                                  {
                                                      cardType: it.Horizontal,
                                                      icon: a.premium(),
                                                      title: lt.premiumMissionsTitle(),
                                                      paragraph: lt.premiumMissions.default(),
                                                  },
                                              ],
                                              generalDescription: [
                                                  {
                                                      icon: ct.pm_info_2(),
                                                      title: lt.conditionsTitle(),
                                                      paragraph: lt.conditions.default(),
                                                  },
                                                  {
                                                      icon: ct.dq_info_3(),
                                                      title: lt.bonusMissionTitle(),
                                                      paragraph: lt.bonusMission.default(),
                                                  },
                                                  {
                                                      icon: ct.pm_info_3(),
                                                      title: lt.epicRewardsTitle(),
                                                      paragraph: lt.epicRewards.default(),
                                                  },
                                                  {
                                                      icon: ct.dq_info_2(),
                                                      title: lt.missionSwitchTitle(),
                                                      paragraph: (0, tt.G)(
                                                          ((s = t),
                                                          s % 3600 > 0
                                                              ? lt.missionSwitch_min()
                                                              : lt.missionSwitch_hrs()),
                                                          t,
                                                      ),
                                                  },
                                              ],
                                    ...
                                    : ((e, u, t, n, a) => {
                                          const r = a >= v.Medium ? ct.big : ct,
                                              s = n ? lt.dailyMissions.subscription.default() : '';
                                          return {
                                              missionsDescription: [
                                                  {
                                                      cardType: it.HorizontalReversed,
                                                      ...
                                                      paragraph: dt(
                                                          t
                                                              ? lt.dailyMissions.battlePassDailyMissions.winback()
                                                              : lt.dailyMissions.winback(),
                                                          s,
                                                      ),
                                                  },
                                                  {
                                                      ...
                                                      title: lt.premiumMissionsTitle(),
                                                      paragraph: u
                                                          ? lt.premiumMissions.winback_comp7Active()
                                                          : lt.premiumMissions.winback(),
                                                  },
                                              ],
                                              generalDescription: [
                                                  {
                                                      ...
                                                      title: lt.conditionsTitle(),
                                                      paragraph: u
                                                          ? lt.conditions.winback_comp7Active()
                                                          : lt.conditions.winback(),
                                                  },
                                                  {
                                                      icon: ct.dq_info_3(),
                                                      title: lt.bonusMissionTitle(),
                                                      paragraph: lt.bonusMission.winback(),
                                                  },
                                                  {
                                                      icon: ct.pm_info_3(),
                                                      title: lt.epicRewardsTitle(),
                                                      paragraph: lt.epicRewards.winback(),
                                                  },
                                                  {
                                                      icon: ct.dq_info_2(),
                                                      title: lt.missionSwitchTitle(),
                                                      paragraph: lt.missionSwitch.winback(),
                                                  },
                                              ],
                                          };
                                      })(0, a, n, r, l);
                        return s().createElement(
                            ...
                            s().createElement(
                                ...
                                { api: o, scrollClassNames: { content: Et }, barClassNames: { base: _t } },
                                s().createElement(
                                    'div',
                                    null,
                    ...
                    ft = 'Disabled_base_13',
                    ht = 'Disabled_alert_f6',
                    vt = 'Disabled_icon_43',
                    wt = 'Disabled_info_e1',
                    yt = R.strings.menu.browser.dataUnavailable,
                    St = () =>
                        s().createElement(
                            'div',
                            { className: ft },
                            ...
                            s().createElement('div', { className: wt }, yt.description()),
                        ),
                    Tt = s().memo;
                const Rt = {
                    ...
                    xt = { mouseEnter: 'highlight', click: 'play' },
                    Nt = (e, { active: u, enableInteractiveActiveTab: t = !1 }) => !!t || e !== u,
                    Pt = Tt(function (e) {
                        const u = e.active,
                            t = e.tabs,
                            n = e.onClick,
                            ...
                            c = void 0 === l ? xt : l,
                            d = (u) => () => {
                                Nt(u, e) && (c.click && qe(c.click), null == n || n(u));
                            },
                            m = (u) => () => {
                                Nt(u, e) && (c.mouseEnter && qe(c.mouseEnter), null == a || a(u));
                            },
                            E = (u) => () => {
                                Nt(u, e) && (c.mouseLeave && qe(c.mouseLeave), null == r || r(u));
                            };
                        return s().createElement(
                            'div',
                            { className: b()(Rt.base, i) },
                            t.map(({ id: n, title: a, notification: r }, i) => {
                                ...
                                return s().createElement(
                                    'div',
                                    {
                                        className: b()(
                                            Rt.tab,
                                            n === u && b()(Rt.tab__active, null == o ? void 0 : o.activeTab),
                                            !Nt(n, e) && Rt.tab__nonInteractive,
                                            null == o ? void 0 : o.tab,
                                        ),
                                        key: n,
                                        onClick: d(n),
                                    ...
                                    ((e, u) => !((e, u) => e.length - 1 === u)(e, u))(t, i) &&
                                        s().createElement('div', {
                                            className: b()(Rt.divider, null == o ? void 0 : o.divider),
                                        }),
                                    s().createElement(
                                        'div',
                                        { className: b()(Rt.state, null == o ? void 0 : o.state) },
                                        s().createElement('div', {
                                            className: b()(Rt.highlight, null == o ? void 0 : o.highlight),
                                        }),
                                        s().createElement('div', {
                                            className: b()(
                                                Rt.border,
                                    ...
                                    void 0 !== r &&
                                        s().createElement(
                                            'div',
                                            {
                                                className: b()(
                                                    Rt.notification,
                                                    Rt[`notification__${r.type}`],
                                                    Rt[`notification__${null != (l = r.size) ? l : 'medium'}`],
                ...
                const It = {
                    ...
                    Ot = 'BonusCard_glow_f0',
                    Ht = 'BonusCard_wrapper_c4',
                    Ut = 'BonusCard_flag_6d',
                    $t = 'BonusCard_content_6f',
                    zt = 'LootboxTransition_base_9c',
                    Wt = 'LootboxTransition_lootbox_62',
                    Gt = 'LootboxTransition_smoke_43',
                    Qt = (0, r.memo)(({ delay: e, isEnabled: u = !0, children: t }) =>
                        u
                            ? s().createElement(
                                  'div',
                                  { className: zt },
                                  ...
                                  s().createElement(
                                      'div',
                                      { className: Wt, style: { animationDelay: `${e}ms, ${e + 500}ms` } },
                                      t,
                                  ),
                              )
                            : t,
                ...
                const Xt = ({ children: e, tooltipArgs: u, className: t }) => {
                        ...
                        if (u.header || u.body) return s().createElement(ru, u, n);
                        const a = u.contentId,
                            r = u.args,
                            i = null == r ? void 0 : r.contentId;
                        return a || i
                            ? s().createElement(uu, Yt({}, u, { contentId: a || i }), n)
                            : s().createElement(jt, u, n);
                    },
                    Kt = {
                        base: 'Reward_base_ea',
                    ...
                    Zt = ({
                        ...
                        return s().createElement(
                            'div',
                            { className: b()(Kt.base, Kt[`base__${n}`], l), style: o },
                            s().createElement(
                                Xt,
                    ...
                    Jt = 'Rewards_base_26',
                    en = 'Rewards_base__vertical_9f',
                    un = 'Rewards_reward_7b',
                    tn = 'Rewards_reward__vertical_c6';
                function nn() {
                    return (
                        (nn =
                            Object.assign ||
                    ...
                    rn = s().memo(
                        ({
                            ...
                            const m = (0, r.useMemo)(
                                ...
                                E =
                                    l ||
                                    (0, nt.uF)(R.strings.tooltips.quests.awards.additional.bottom(), {
                                        count: e.length - (n || 0),
                                    }),
                                _ = b()(Jt, t && en, a),
                                A = b()(un, t && tn, i);
                                          ...
                                          e
                                              ...
                                              .map((e, t) =>
                                                  s().createElement(
                                                      'div',
                                                      { key: t, className: A },
                                                      s().createElement(Zt, nn({ size: u }, e)),
                                                  ),
                                              ),
                                          s().createElement(
                                              'div',
                ...
                const on = {
                    ...
                    ln = (0, r.memo)(({ delay: e, isEnabled: u = !0, size: t = X.Small, children: n }) =>
                        u
                            ? s().createElement(
                                  'div',
                                  { className: on.base },
                                  s().createElement('div', {
                                      className: b()(on.lock, on[`lock__${t}`]),
                                      style: { animationDelay: `${e + 300}ms, ${e + 400}ms` },
                                  }),
                                  s().createElement('div', {
                                      className: b()(on.background, on[`background__${t}`]),
                                      style: { animationDelay: `${e + 400}ms` },
                                  }),
                                  s().createElement(
                                      'div',
                                      { className: on.component, style: { animationDelay: `${e + 400}ms` } },
                                      n,
                                  ),
                              )
                            : n,
                ...
                const mn = R.strings.subscription,
                    En = ({
                        data: e,
                        ...
                        const o = u
                            ? b()(
                                  cn.subscriptionRewardBackground,
                                  cn[`subscriptionRewardBackground__${t}`],
                                  i && cn.subscriptionRewardBackground__animated,
                              )
                            : b()(cn.lockedIcon, cn[`lockedIcon__${t}`]);
                        return s().createElement(
                            'div',
                            { className: cn.base },
                            e.map((e, r) =>
                                s().createElement(
                                    ...
                                    {
                                        isEnabled: n,
                                        header: mn.dailyQuestsLockedReward.header(),
                                        body: mn.dailyQuestsLockedReward.body(),
                                        key: r,
                                    },
                                    ((e, n) =>
                                        e
                                            ? s().createElement(
                                                  ...
                                                  s().createElement(
                                                      'div',
                                                      { className: u ? '' : cn.base__locked },
                                                      s().createElement(Zt, dn({ size: t }, n)),
                                                  ),
                                              )
                                            : s().createElement(
                                                  ln,
                    ...
                    _n = 'Content_base_b4',
                    An = 'Content_header_92',
                    gn = 'Content_title_39',
                    Fn = 'Content_countDownContainer_ec',
                    Dn = 'Content_timer_78',
                    pn = 'Content_countDown_ae',
                    Cn = 'Content_missionIcon_65',
                    Bn = 'Content_battleConditions_e0',
                    bn = 'Content_text_b9',
                    fn = 'Content_progressInfo_85',
                    hn = 'Content_progressBar_e8',
                    vn = 'Content_rewards_4a';
                let wn;
                !(function (e) {
                ...
                const yn = R.images.gui.maps.icons.missions.icons,
                    ...
                    Tn = (e) => (e >= v.Large ? wn.BIG : e >= v.Medium ? wn.MEDIUM : wn.SMALL),
                    Rn = (0, q.Pi)(() => {
                        const e = Ge().model,
                            u = e.root.get().countDown,
                            t = (0, r.useContext)(dr).isExiting,
                            n = S().mediaSize,
                            a = Ee(e.dailyQuests.get(), 3);
                        ...
                        const i = a.bonusCondition,
                            ...
                            C = Se(d, o, D),
                            B = ke(t, -10, {
                                leave: { opacity: 1, config: { duration: 400, easing: Ne.easeInCubic } },
                                delay: t ? 100 : 300,
                            });
                        return s().createElement(
                            'div',
                            ...
                            B(
                                (e, t) =>
                                    ...
                                    s().createElement(
                                        V.animated.div,
                                        { style: e, className: An },
                                        s().createElement('div', { className: gn }, Sn.bonusMissionTitle()),
                                        s().createElement(
                                            'div',
                                            { className: Fn },
                                            s().createElement('div', { className: Dn }),
                                            s().createElement(ut.Z, {
                                                startValue: u,
                            ...
                            s().createElement(
                                ...
                                s().createElement('div', {
                                    className: Cn,
                                    style: { backgroundImage: `url(${yn.$dyn(`c_${Tn(n)}_${_}_silver`)})` },
                                }),
                                void 0 !== F &&
                                    s().createElement(sn.L, {
                                        conditions: F,
                                        missionId: o,
                                        columns: !0,
                                        reverse: !0,
                                ...
                                E &&
                                    s().createElement(En, {
                                        ...
                                        isUnlockedQuestReward:
                                            (m && A !== me.UndoneSubscription) || (!m && A === me.Done),
                                        isClosedRewardOnCompletedQuest: A === me.UndoneSubscription,
                                        isAnimatedUnlock: g && A === me.Active && m,
                                    }),
                            ),
                        );
                        var b, f;
                    ...
                    xn = {
                        ...
                        enter: {
                            ...
                            config: { duration: 800, easing: Ne.easeOutQuint },
                        },
                        leave: {
                            opacity: 0,
                            transform: 'translateY(0rem) scaleX(1) scaleY(1)',
                            config: { duration: 100, easing: Ne.easeInCubic },
                            delay: 300,
                        },
                    },
                    Nn = ({ bonusQuestCompleted: e, isFirstAppearing: u }) => {
                        const t = (0, r.useContext)(dr).isExiting,
                            n = t || e,
                            a = Pe(n, {
                                enter: { pointerEvents: 'none', config: { duration: 400, easing: Ne.easeOutCirc } },
                                leave: { config: { duration: 300, easing: Ne.easeInCubic } },
                            ...
                            o = ke(
                                ...
                                Object.assign(
                                    {},
                                    u ? xn : { from: { transform: 'translateY(0rem)' }, delay: t ? 100 : 200 },
                                ),
                            ),
                            l = ke(
                                t,
                                ...
                                Object.assign(
                                    ...
                                    u
                                        ? {
                                              enter: { config: { duration: 800, easing: Ne.easeOutQuint } },
                                              leave: {
                                        ...
                                        : {
                                              ...
                                              enter: {
                                                  transform: 'translateY(0rem)',
                                                  config: { duration: 600, easing: Ne.easeOutCirc },
                                              },
                        ...
                        return s().createElement(
                            'div',
                            { className: Lt },
                            a((e, u) => !u && s().createElement(V.animated.div, { style: e, className: Ot })),
                            i(
                                (e, u) =>
                                    !u &&
                                    s().createElement(
                                        ...
                                        o(
                                            (e, u) =>
                                                !u && s().createElement(V.animated.div, { style: e, className: Ut }),
                                        ),
                                        l(
                                            (e, u) =>
                                                !u &&
                    ...
                    Pn = 'AllCompleteCountdown_base_ab',
                    kn = 'AllCompleteCountdown_title_90',
                    Mn = 'AllCompleteCountdown_subTitle_2b',
                    In = 'AllCompleteCountdown_timer_47',
                    Ln = 'AllCompleteCountdown_timerDecoration_7b',
                    On = 'AllCompleteCountdown_timerDecoration__left_4e',
                    Hn = 'AllCompleteCountdown_timerCountdown_2d',
                    Un = (0, q.Pi)(() => {
                        const e = Ge().model,
                            u = (0, r.useContext)(dr),
                        ...
                        return l(
                            (e, u) =>
                                ...
                                s().createElement(
                                    ...
                                    s().createElement('div', { className: kn }, o.$dyn('title')),
                                    s().createElement(
                                        'div',
                                        { className: In },
                                        c(
                                            (e, u) =>
                                                ...
                                                s().createElement(
                                                    V.animated.div,
                                                    { style: e },
                                                    s().createElement('div', { className: b()(Ln, On) }),
                                                ),
                                        ),
                                        s().createElement(ut.Z, { startValue: a, className: Hn }),
                                        d(
                                            (e, u) =>
                                                !u &&
                                                s().createElement(
                                    ...
                                    s().createElement('div', { className: Mn }, o.$dyn('remainingText')),
                                ),
                        );
                    }),
                    $n = {
                ...
                var zn = t(374),
                    Wn = t(229);
                const Gn = 'BattleCondition_base_b4',
                    Qn = 'BattleCondition_text_a6',
                    qn = 'BattleCondition_base__prem_e6',
                    Vn = 'BattleCondition_progressInfo_1a',
                    jn = 'BattleCondition_progressBar_b9',
                    Yn = (0, q.Pi)(({ quest: e, className: u, isPremium: t }) => {
                        const n = Te(e.bonusCondition, e.postBattleCondition);
                        return n
                            ? s().createElement(
                                  'div',
                                  { className: b()(Gn, t && qn, u) },
                                  s().createElement(sn.L, {
                                      conditions: n,
                                      inlineOperator: !0,
                                      columns: !0,
                                      ...
                                      swapProgress: !0,
                                      reverse: !0,
                                      classNames: { text: Qn, progressInfo: Vn, progressBar: jn },
                                  }),
                              )
                            : null;
                    }),
                    ...
                    Kn = 'RerollButton_base_22',
                    Zn = 'RerollButton_base__disabled_2c',
                    Jn = 'RerollButton_text_a3',
                    ea = 'RerollButton_icons_98',
                    ua = 'RerollButton_icon_2b',
                    ta = 'RerollButton_iconHover_5c',
                    na = 'RerollButton_iconDisabled_64',
                    aa = (0, q.Pi)(({ canReroll: e, questId: u, className: t }) => {
                        const n = Ge().controls,
                            a = (0, r.useContext)(dr).isExiting;
                        return s().createElement(
                            uu,
                            {
                                ignoreMouseClick: !e,
                    ...
                    ra = (e, u) => (e === me.Active && u ? 'prem' : e),
                    sa = R.strings.quests.premiumQuests.tooltips.locked,
                    ia = ({
                        quest: e,
                        isRerolling: u,
                        isRerollEnabled: t,
                        ...
                        const c = S().mediaSize,
                            d = (0, r.useContext)(dr).isExiting,
                            m = !i && t && e.status === me.Active,
                            E = 400 + 300 * (3 + l - 1),
                            _ = d || u;
                        return ke(_, 20, {
                            enter: { config: { duration: 300, easing: Ne.easeOutCirc } },
                            ...
                            (u, t) =>
                                ...
                                s().createElement(
                                    V.animated.div,
                                    { style: u, className: b()(Xn.base, o, Xn[`base__${ra(e.status, i)}`]) },
                                    s().createElement('div', { className: Xn.borderTop }),
                                    (e.status === me.Done || e.status === me.UndoneSubscription) &&
                                        !a &&
                                        s().createElement(
                                            s().Fragment,
                                            ...
                                            s().createElement(
                                                'div',
                                                { className: Xn.borderAnimationWrapper },
                                                s().createElement('div', { className: Xn.borderAnimation }),
                                            ),
                                            s().createElement('div', { className: b()(Xn.completedAnimationBg) }),
                                        ),
                                    s().createElement('div', { className: Xn.cardIcon, style: ye(c, e.icon, i) }),
                                    s().createElement(Yn, { className: Xn.condition, quest: e, isPremium: i }),
                                    s().createElement(
                                        'div',
                                        { className: Xn.rewardsWrapper },
                                        s().createElement(rn, { size: e.rewardSize, data: e.bonuses }),
                                        e.isEnabledSubscription &&
                                            ...
                                            s().createElement(En, {
                                                ...
                                                size: e.rewardSize,
                                                isUnlockedQuestReward:
                                                    (e.isActiveSubscription && e.status !== me.UndoneSubscription) ||
                                                    (!e.isActiveSubscription && e.status === me.Done),
                                                isClosedRewardOnCompletedQuest: e.status === me.UndoneSubscription,
                                                animationDelay: E,
                                                isAnimatedUnlock:
                                                    e.isFirstView && e.status === me.Active && e.isActiveSubscription,
                                            }),
                                    ),
                                    i &&
                                        e.status === me.Locked &&
                                        s().createElement(
                                            ...
                                            s().createElement('div', { className: Xn.premiumLock }),
                                        ),
                                    m &&
                                        s().createElement(aa, {
                                            className: Xn.rerollButton,
                                            canReroll: n,
                                            questId: e.id,
                                        }),
                                    (e.status === me.Done || e.status === me.UndoneSubscription) &&
                                        s().createElement('div', {
                                            className: b()(Xn.statusIcon, !a && Xn.statusIcon__animated),
                                        }),
                                    i &&
                                        2 !== l &&
                                        s().createElement('div', {
                                            className: b()(Xn.arrow, Xn[`arrow__${e.status}`]),
                                        }),
                                ),
                        );
                    },
                    oa = 'Cards_base_ee',
                    la = 'Cards_card_c2',
                    ca = { opacity: 1, transform: 'translateY(0rem)', pointerEvents: 'auto' },
                    da = (0, q.Pi)(({ isOutAnimation: e, delayOut: u }) => {
                        const t = S().mediaSize,
                            n = Ge().model,
                            a = n.computes.getRerolledCardsIds,
                            i = (0, r.useContext)(dr).previousTabIndex,
                        ...
                        return (
                            (0, r.useEffect)(() => {
                                ...
                                F.start(Object.assign({}, ca, { config: { duration: 200, easing: Ne.easeOutCirc } }));
                            }, [F, e, u]),
                            s().createElement(
                                V.animated.div,
                    ...
                    ma = 'AnimatedFlag_base_e5',
                    Ea = s().memo(({ baseQuestsCompleted: e }) => {
                        const u = S().mediaSize >= v.Medium,
                            t = (0, V.useSpring)({
                                ...
                                config: { duration: 1e3, easing: Ne.easeOutCubic },
                                delay: 2e3,
                            }),
                            n = t.x,
                            a = t.transform;
                    ...
                    _a = 'LockedBonusQuest_base_51',
                    Aa = 'LockedBonusQuest_flag_27',
                    ga = 'LockedBonusQuest_bonusMissionDescription_d0',
                    Fa = 'LockedBonusQuest_lockIcon_5e',
                    Da = 'LockedBonusQuest_text_aa',
                    pa = 'LockedBonusQuest_styleLine_b1',
                    Ca = 'LockedBonusQuest_styleLine__left_4b',
                    Ba = 'LockedBonusQuest_styleLine__right_22',
                    ba = R.strings.quests.dailyQuests,
                    fa = s().memo(({ baseQuestsCompleted: e }) => {
                        const u = (0, r.useContext)(dr).isExiting,
                            t = ke(u, 20, { delay: u ? 0 : 150 }),
                            n = (0, V.useSpring)({
                                from: { opacity: 1 },
                                to: { opacity: 0 },
                                cancel: !e,
                            ...
                            t(
                                (e, u) =>
                                    ...
                                    s().createElement(
                                        ...
                                        s().createElement('div', { className: b()(pa, Ca) }),
                                        s().createElement('div', { className: b()(pa, Ba) }),
                                    ),
                            ),
                        );
                    }),
                    ha = 'MainContent_base_67',
                    va = 'MainContent_lockedBonusQuest_89',
                    wa = 'MainContent_animatedFlag_d1',
                    ya = 'MainContent_countDownContainer_32',
                    Sa = 'MainContent_timer_72',
                    Ta = 'MainContent_countDown_3b',
                    Ra = (0, q.Pi)(({ baseQuestsCompleted: e }) => {
                        const u = Ge().model.daily.get().rerollCountDown,
                            t =
                                (n = u) < zn.yR
                        ...
                        var n;
                        const a = (0, r.useContext)(dr).isExiting,
                            i = Pe(e);
                        return s().createElement(
                            'div',
                            { className: ha },
                                ...
                                s().createElement(
                                    ...
                                    i(
                                        (e, n) =>
                                            ...
                                            s().createElement(
                                                V.animated.div,
                                                { style: e, className: ya },
                                                s().createElement('div', { className: Sa }),
                                                s().createElement('div', { className: Ta }, (0, tt.G)(t, u)),
                                            ),
                                    ),
                                ),
                            s().createElement(da, { isOutAnimation: e, delayOut: 1500 }),
                            s().createElement(
                                'div',
                                { className: va },
                                s().createElement(
                                    'div',
                                    { className: wa },
                                    s().createElement(Ea, { baseQuestsCompleted: e }),
                                ),
                    ...
                    xa = (0, q.Pi)(() => {
                        ...
                        const t = Ge().model,
                            ...
                            p = D[0],
                            C = D[1],
                            B = (0, r.useState)(m && null != (u = t.computes.isCardVisited(he.DailyQuests, 3)) && u),
                            f = B[0],
                            h = B[1];
                        return (
                            (0, r.useEffect)(() => {
                            ...
                            (0, r.useEffect)(() => {
                                void 0 !== d &&
                                    d >= 3 &&
                                    c < 3 &&
                                    (qe(R.sounds.dq_screen_switch()), F(!1), C(!1), h(!1));
                            }, [c, d]),
                            (0, r.useEffect)(() => {
                                if (m && !o[3].value)
                                    return (
                            ...
                            f
                                ...
                                : p && l.length > 3
                                  ? s().createElement(
                                        'div',
                                        { className: b()($n.bonusCard, $n[`bonusCard__${a}`]) },
                                        s().createElement(Nn, { bonusQuestCompleted: m, isFirstAppearing: !i }),
                                    )
                                  : s().createElement(
                                        'div',
                                        { className: b()(It.questsContainer, It[`questsContainer__${a}`]) },
                                        s().createElement(Ra, { baseQuestsCompleted: g }),
                                    )
                        );
                    }),
                    Na = {
                ...
                const Ma = ({
                    ...
                    const g = (0, r.useRef)(null),
                        ...
                        L = b()(Na.state, Na.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                ...
                Ma.defaultProps = { type: Pa.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Ia = (0, r.memo)(Ma),
                    La = 'NotPremiumAccount_base_31',
                    Oa = 'NotPremiumAccount_image_4a',
                    Ha = 'NotPremiumAccount_title_4f',
                    Ua = 'NotPremiumAccount_text_06',
                    $a = 'NotPremiumAccount_button_75',
                    za = R.strings.quests.premiumQuests.notPremiumAccount,
                    Wa = (0, q.Pi)(({ isPremiumChanging: e }) => {
                        const u = Ge().controls,
                            t = (0, r.useContext)(dr).isExiting;
                        return ke(t || e, 20, {
                            delay: 100,
                            ...
                            (e, t) =>
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(rt, { text: za.title(), classMix: Ha }),
                                    s().createElement(rt, { text: za.paragraph(), classMix: Ua }),
                                    s().createElement(
                                        Ia,
                                        { type: Pa.main, size: ka.medium, mixClass: $a, onClick: u.buyPremiumBtnClick },
                                        za.button(),
                                    ),
                                ),
                        );
                    ...
                    Ga = (0, q.Pi)(() => {
                        ...
                        return g
                            ? _
                                ...
                                : s().createElement(
                                      'div',
                                      { className: b()(It.questsContainer, It[`questsContainer__${u}`]) },
                                      s().createElement(da, { isOutAnimation: l || F, delayOut: F ? 0 : 2400 }),
                                  )
                            : s().createElement(Wa, { isPremiumChanging: F });
                    });
                var Qa = t(875);
                const qa = 'Progress_base_55',
                    Va = 'Progress_infoContainer_ca',
                    ja = 'Progress_missionsCompleted_73',
                    Ya = 'Progress_title_a4',
                    Xa = 'Progress_description_aa',
                    Ka = 'Progress_current_af',
                    Za = 'Progress_separator_7e',
                    Ja = 'Progress_checkIcon_9d',
                    er = 'Progress_rewardsWrapper_c7',
                    ur = 'Progress_progressWrapper_7c',
                    tr = 'Progress_footerSeparator_08',
                    nr = 'Progress_disabled_af',
                    ar = 'Progress_alertIcon_f5',
                    rr = 'Progress_alertText_63',
                    ...
                    or = (0, q.Pi)(() => {
                        ...
                        const m = (0, V.useSpring)({
                            ...
                            config: { duration: 600, easing: Ne.easeOutQuint },
                        });
                        return s().createElement(
                            V.animated.div,
                                ...
                                ? s().createElement(
                                      ...
                                      s().createElement(
                                          ...
                                          s().createElement(
                                              ...
                                              s().createElement('div', { className: Xa }, ir.paragraph()),
                                          ),
                                          s().createElement(rn, {
                                              data: Se(c, n, d),
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                ...
                                s().createElement(
                                    'div',
                                    { className: lr.header },
                                    s().createElement('div', { className: lr.title }, cr.dailyQuests.header.$dyn(n)),
                                    s().createElement(Pt, {
                                        tabs: i,
                                        active: a,
                                        onClick: (e) => {
                    ...
                    _r = /(?:%\(|{)\w*(?:_[Oo]pen|Start)(?:\)s|})?(.*?)(?:%\(|{)\w*(?:_[Cc]lose|End)(?:\)s|})?/g,
                    Ar = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    gr = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Fr = (0, r.memo)(({ text: e, binding: u, classMix: t }) => {
                                ...
                                ((o = o.replace(t, `%(${i})`)),
                                    (a[i] = Er[e]
                                        ? s().createElement(
                                              'span',
                                              { className: Er[e] },
                                              s().createElement(rt, { text: d, binding: u }),
                                          )
                                        : s().createElement(
                                              'span',
                                              { style: n(e) },
                        ...
                        return s().createElement(rt, { text: o, classMix: t, binding: a });
                    }),
                    Dr = R.strings.common.duration,
                    pr = {
                    ...
                    Cr = { [$.AVAILABLE]: 'active', [$.NO_OFFERS]: 'hidden', [$.DISABLED]: 'disabled' },
                    Br = R.strings.quests.dailyQuests.takeRewardsButton,
                    br = (0, q.Pi)(({ className: e }) => {
                        const u = Ge(),
                            t = u.model,
                            n = u.controls,
                            a = t.root.get(),
                            ...
                            l = ((e, u = !0) =>
                                e.days > 7 && u
                                    ? (0, nt.WU)(Dr.days(), { days: e.days })
                                    : e.days >= 1
                                      ? (0, nt.WU)(Dr.days(), { days: 0 === e.hours ? e.days : e.days + 1 })
                                      : e.hours >= 1
                                        ? (0, nt.WU)(Dr.hours(), { hours: 0 === e.minutes ? e.hours : e.hours + 1 })
                                        : (0, nt.WU)(Dr.minutes(), { minutes: e.minutes || 1 }))((0, zn.f8)(r), !1);
                        return s().createElement(
                            'div',
                            { className: b()(pr.base, e, pr[`base__${Cr[i]}`]) },
                            s().createElement(
                                ru,
                                { body: o ? Br.tooltipDisable() : Br.tooltip() },
                                s().createElement(
                                    'div',
                                    {
                                        className: pr.button,
                                        onClick: o
                                            ? void 0
                                            : () => {
                                                  (Ve.playClick(), n.claimRewards());
                                              },
                                        onMouseEnter: o ? void 0 : Ve.playHighlight,
                                    },
                                    !o &&
                                        s().createElement(
                                            s().Fragment,
                                            null,
                                            s().createElement('div', { className: pr.border }),
                                            s().createElement('div', { className: pr.glow }),
                                        ),
                                    s().createElement(
                                        'div',
                                        { className: pr.content },
                                        s().createElement('div', { className: pr.buttonIcon }),
                                        Br.text(),
                                    ),
                                    !o &&
                                        s().createElement(
                                            'div',
                                            { className: pr.hightlightWrapper },
                                            s().createElement('div', { className: pr.hightlight }),
                                        ),
                                ),
                            ),
                            !o &&
                                ...
                                s().createElement(
                                    'div',
                                    { className: pr.countdown },
                                    s().createElement('div', { className: pr.countdownIcon }),
                                    s().createElement(Fr, { text: Br.countdown(), binding: { leftTime: l } }),
                                ),
                        );
                    }),
                    fr = (0, q.Pi)(() => {
                        ...
                        const l = null != (e = we(t.computes.getCurrentTabIndex())) ? e : '',
                            ...
                            : s().createElement(
                                  ...
                                  r
                                      ...
                                      : s().createElement(
                                            ...
                                            i &&
                                                i !== $.NO_OFFERS &&
                                                s().createElement(br, { className: Qe.rewardsButton }),
                                        ),
                                  s().createElement(iu, { className: b()(Qe.infoButton, !r && Qe.infoButton__info) }),
                              );
                    });
                engine.whenReady.then(() => {
                    H().render(
                        s().createElement(L, null, s().createElement(We, null, s().createElement(fr, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [45], () => __webpack_require__(22));
