(() => {
    ...
    var __webpack_modules__ = {
            ...
            5335: (e, t, n) => {
                ...
                const m = (0, r.forwardRef)(function (e, t) {
                        let n = e.src,
                            i = e.className,
                            a = e.autoplay,
                            s = void 0 !== a && a,
                        ...
                        return (
                            ...
                            (0, r.useEffect)(() => {
                                if (b && p.current) {
                                    const e = { changeTimeHandlers: [], changeKeyframeHandlers: [], changeTimeLoop: _ },
                                        t = () => {
                                            let t = 0;
                                            const n = (function (n) {
                                                    let r = 0;
                                        ...
                                        a = (e) => {
                                            ...
                                            p.current &&
                                                (p.current.currentTime =
                                                    (0, (t = p.current.duration), (n = e) < 0 ? 0 : n > t ? t : n));
                                        },
                                        s = () => {
                                            var e;
                            ...
                            o().createElement(
                                'video',
                                h({ src: n, className: i, style: c, loop: u, ref: p, onClick: m, onError: f }, w),
                            )
                        );
                    }),
                    f = (0, r.memo)(m);
                ...
                const p = (e) => (0 === e ? window : window.subViews.get(e)),
                    g = ((e, t) => {
                                ...
                                const l = (0, r.useRef)([]),
                                    u = (e, n, r) => {
                                        ...
                                        const i = (function ({
                                                ...
                                                return {
                                                    subscribe: (n, i) => {
                                                        const s = 'string' == typeof i ? `${r}.${i}` : r,
                                                            l = c.O.view.addModelObserver(s, t, !0);
                                                ...
                                                observableModel: {
                                                    array: (t, n) => {
                                                        const r = null != n ? n : s(t),
                                                            o = w.observable.box(r, { equals: v });
                                                        return (
                                                            'real' === e &&
                                                                a.subscribe(
                                                                    (0, w.action)((e) => o.set(e)),
                                                                    t,
                                                                ),
                                                            o
                                                        );
                                                    ...
                                                    primitives: (t, n) => {
                                                        ...
                                                        if (Array.isArray(t)) {
                                                            const o = t.reduce(
                                                                (e, t) => ((e[t] = w.observable.box(r[t], {})), e),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === e &&
                                            ...
                                            _ = { mode: e, model: d, externalModel: a, cleanup: u };
                                        return {
                                            model: d,
                                    ...
                                    E = _[0],
                                    h = _[1],
                                    m = (0, r.useState)(() => u(e, i, s)),
                                    f = m[0],
                                    g = m[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        d.current ? g(u(E, i, s)) : (d.current = !0);
                                    }, [s, E, i]),
                                    (0, r.useEffect)(() => {
                                        h(e);
                                    }, [e]),
                        ...
                        videoStarted: e.createCallbackNoArgs('onVideoStarted'),
                    ...
                    P = (0, s.observer)(() => {
                        const e = O(),
                            ...
                            v = u.height,
                            E = (() => {
                                const e = (0, r.useState)(c.O.view.getScale()),
                                    t = e[0],
                                    n = e[1];
                                return (
                                    (0, r.useEffect)(() => {
                        ...
                        const b = (0, r.useCallback)(() => {
                            t.onError(`R.videos.wt_event.${a}`);
                        }, [t, a]);
                        return (
                            (0, r.useEffect)(() => {
                                const e = s.current;
                                i ? null == e || e.play() : null == e || e.pause();
                            }, [i, s]),
                            o().createElement(
                                'div',
                                { className: 'App_base_ed' },
                                a &&
                                    o().createElement(f, {
                                        ref: s,
                                        src: R.videos.wt_event.$dyn(a),
                                        className: 'App_video_f9',
                                        style: T(_, v, E),
                                        autoplay: !0,
                                        onPlay: m,
                                        onEnded: h,
                ...
                engine.whenReady.then(() => {
                    a().render(o().createElement(y, null, o().createElement(P, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(5335));
