    ...
    var __webpack_modules__ = {
                ...
                const _ = {
                    ...
                    l = (0, D.ZP)((u) => {
                        let e = u.className,
                            ...
                            v = u.row,
                            p = u.flexDirection,
                            w = void 0 === p ? (x ? 'column' : v && 'row') || void 0 : p,
                            b = u.flexStart,
                            S = u.center,
                            f = u.flexEnd,
                            L = u.spaceBetween,
                            ...
                            T =
                                void 0 === O
                                    ...
                                    : O,
                            R = u.alignItems,
                            P = void 0 === R ? (b ? 'flex-start' : S && 'center') || (f && 'flex-end') || void 0 : R,
                            y = u.alignSelf,
                            H = u.wrap,
                            N = u.flexWrap,
                            ...
                            G = u.shrink,
                            U = u.flex,
                            I = void 0 === U ? (W || G ? `${W ? 1 : 0} ${G ? 1 : 0} auto` : void 0) : U,
                            j = u.style,
                            Z = u.children,
                            X = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const K = (0, a.useMemo)(() => {
                                const u = { mt: D, mr: m, mb: c, ml: g },
                                    e = ((u) =>
                                        s.reduce((e, t) => {
                                            const E = u[t];
                                            return E && 'number' != typeof E ? e.concat(_[!0 === E ? 'MD' : E][t]) : e;
                                        }, []))(u),
                                    A = ((u) =>
                                        s.reduce((e, t) => {
                                            const E = u[t];
                                            return ('number' == typeof E && (e[o[t]] = E + 'rem'), e);
                                        }, {}))(u);
                                return {
                            ...
                            }, [t, E, D, m, c, g, j, I, y, w, k, T, P]),
                            z = K.computedStyle,
                            Y = K.computedClassNames;
                        return i().createElement('div', C({ className: A()(n.Z.base, ...Y, e), style: z }, X), Z);
                    });
            },
            280: (u, e, t) => {
                'use strict';
                ...
                var E = t(6179),
                    ...
                    D = t(3649),
                    a = t(5287);
                const i = ({ binding: u, text: e = '', classMix: t, alignment: F = D.v2.left }) =>
                    null === e
                        ...
                        : A().createElement(
                              ...
                              e.split('\n').map((e, i) =>
                                  A().createElement(
                                      'div',
                                      { className: r()(a.Z.base, t), key: `${e}-${i}` },
            ...
            3495: (u, e, t) => {
                ...
                const D = E.O.client.getSize('rem'),
                    a = D.width,
                    i = D.height,
                    n = Object.assign({ width: a, height: i }, (0, r.T)(a, i, F.j)),
            ...
            1039: (u, e, t) => {
                ...
                (0, E.memo)(({ children: u }) => {
                    const e = (0, E.useContext)(r.Y),
                        ...
                        n = t[0],
                        B = t[1],
                        C = (0, E.useCallback)((u, e) => {
                            const t = i.O.view.pxToRem(u),
                                E = i.O.view.pxToRem(e);
                            B(Object.assign({ width: t, height: E }, (0, a.T)(t, E, D.j)));
                        }, []);
                    ((0, F.Z)(() => {
                        engine.on('clientResized', C);
                    }),
                        (0, E.useEffect)(() => () => engine.off('clientResized', C), [C]));
                    const _ = (0, E.useMemo)(() => Object.assign({}, n), [n]);
                    return A().createElement(r.Y.Provider, { value: _ }, u);
                });
            },
            6010: (u, e, t) => {
                'use strict';
                ...
                const D = (u) => {
                    ...
                    const D = (0, E.useContext)(F.Y),
                        ...
                        v = { extraLarge: d, large: c, medium: h, small: g, extraSmall: x };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && _) return (0, A.H)(e, t, v);
                        if (t.largeWidth && s) return (0, A.H)(e, t, v);
                        if (t.mediumWidth && o) return (0, A.H)(e, t, v);
                        if (t.smallWidth && l) return (0, A.H)(e, t, v);
            ...
            7613: (u, e, t) => {
                ...
                (0, B.ZP)((u) => {
                    ...
                    return _().createElement(
                        ...
                        l(
                            {
                                className: A()(s.Z.base, t && s.Z[t], L, E),
                                style: f,
                                mt: !0 === n ? x[t || 'paragraph-P16'].mt : n,
                                mr: !0 === m ? x[t || 'paragraph-P16'].mr : m,
                                mb: !0 === c ? x[t || 'paragraph-P16'].mb : c,
                                ml: !0 === g ? x[t || 'paragraph-P16'].ml : g,
                            },
                            b,
                        ),
                        void 0 !== w ? _().createElement(r.z, l({}, w, { text: e })) : e,
                    );
                });
            },
            3532: (u) => {
            ...
            3377: (u, e, t) => {
                ...
                const r = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    a = [E.cJ.ExtraLarge, E.cJ.Large, E.cJ.Medium, E.cJ.Small, E.cJ.ExtraSmall],
                    i = (u, e) =>
                        ...
                        return a.includes(t)
                            ...
                            : ((u, e = E.left) => {
                                  ...
                                  const A =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return (r(F, /( )/, e).forEach((u) => (t = t.concat(r(u, A, E.left)))), t);
                              })(u, e);
                    },
                    n = (u, e, t) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : i(u, e)));
            },
            1358: (u, e, t) => {
                'use strict';
                t.d(e, { Z: () => F });
                    ...
                    p = {
                        ...
                        sendShowPopOverEvent: (u, e, t, E, A = R.invalid('resId'), F) => {
                            const r = s.O.view.getViewGlobalPosition(),
                                ...
                                C = D.height,
                                _ = {
                                    x: s.O.view.pxToRem(i) + r.x,
                                    y: s.O.view.pxToRem(n) + r.y,
            ...
            5096: (u, e, t) => {
                'use strict';
                (t(6483), t(7613), t(9056), t(6179), t(1922));
            },
            5026: (u, e, t) => {
                'use strict';
                t.d(e, { Z: () => E });
