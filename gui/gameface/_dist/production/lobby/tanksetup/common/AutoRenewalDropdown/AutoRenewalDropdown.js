    ...
    var __webpack_modules__ = {
                    ...
                    D = s().forwardRef((e, u) => {
                        const t = e.offsetLeft,
                            ...
                            I = (0, l.useCallback)(() => {
                                R &&
                                    b &&
                                    b({ x: R.scrollbarXActive, y: R.scrollbarYActive }, { x: R.reach.x, y: R.reach.y });
                            }, [b, R]),
                            ...
                            j = (0, l.useCallback)(
                                (e) => {
                                    R && (R.setScrollLeftImmediately(e), S && S(e, R.contentWidth - R.containerWidth));
                                },
                                [R, S],
                            ),
                            z = (0, l.useCallback)(
            ...
            8380: (e) => {
                ...
                var C = function (e, u, t, n, o, r) {
                    var i;
                    if ((void 0 === n && (n = !0), void 0 === o && (o = !1), void 0 === r && (r = !1), 'top' === u))
                        ...
                        (r.contains(e.scrollbarXRail) ||
                            ...
                            e.containerHeight + e.settings.scrollYMarginOffset < e.contentHeight
                                ? ((e.scrollbarYActive = !0),
                                  ...
                                  (e.scrollbarYHeight = B(e, b((e.railYHeight * e.containerHeight) / e.contentHeight))),
                                  (e.scrollbarYTop = b(
                            ...
                            e.scrollbarXActive
                                ...
                                : (r.classList.remove(c.active('x')),
                                  ...
                                  (r.scrollLeft = 0)),
                            e.scrollbarYActive
                                ? (r.classList.add(c.active('y')), C(e, 'top', r.scrollTop - e.lastScrollTop, !0, u))
                ...
                function k(e, u, t) {
                    var n = t[0],
                        ...
                        m = null;
                    function _(t) {
                        ((h[a] = b(D + m * (t[r] - v))), A(e, d), p(e, !1, u), t.stopPropagation(), t.preventDefault());
                    }
                    function f() {
                        (F(e, d), e[E].classList.remove(c.clicking), e.event.unbind(e.ownerDocument, 'mousemove', _));
                    }
                    ...
                    O = {
                                    ...
                                    (e.settings.suppressScrollX && 0 !== l) ||
                                        ...
                                        (function (u, n) {
                                            ...
                                            if (0 === n) {
                                                ...
                                                if (
                                                    (0 === r && u < 0) ||
                                                    (r >= e.contentWidth - e.containerWidth && u > 0)
                                                )
                                                    return !e.settings.wheelPropagation;
                                            }
                                            return !0;
                        ...
                        wheel: function (e, t) {
                            ...
                            function o(o) {
                                ...
                                if (
                                    !(function (e, t, o) {
                                        if (!m.isWebKit && n.querySelector('select')) return !0;
                                        ...
                                        (function (u, t) {
                                            ...
                                            if (l > i) {
                                                if (
                                                    ...
                                                    return 0 === window.scrollY && t > 0 && m.isChrome;
                                            } else if (
                                                i > l &&
                                                ((u < 0 && r === e.contentWidth - e.containerWidth) ||
                                                    (u > 0 && 0 === r))
                                            )
                                                return !0;
                                            return !0;
                ...
                ((R.prototype._getAnimationSettings = function (e, u, t, n) {
                    ...
                    return (
                        null !== this.element &&
                            (r = ['bottom', 'top'].includes(u) ? this.element.scrollTop : this.element.scrollLeft),
                        {
                ...
                const p = o.instance,
                    B = {
                        ...
                        sendShowContextMenuEvent: (e, u, t = 0) => {
                            m(s.CONTEXT_MENU, { isMouseEvent: !0, contentID: e, on: !0, decoratorID: t, args: u });
                        },
            ...
            9220: (e, u, t) => {
                ...
                const _ = (0, s.memo)(
                    ({
                        ...
                        const _ = (0, s.useState)(m.Out),
                            ...
                            y = w || u === E.Basic,
                            L = (0, s.useCallback)(() => {
                                w || (C(m.Over), d && (0, v.G)(d));
                            }, [w, d]),
                            S = (0, s.useCallback)(() => {
                                w || (C(m.Down), F && (0, v.G)(F));
                            }, [w, F]),
                            T = (0, s.useCallback)(() => {
                                (!w && C(m.Over), !y && g(!0));
                            }, [w, y]),
                            k = (0, s.useCallback)((e) => c && c(e), [c]),
                            M = (0, s.useCallback)(() => C(m.Out), []);
                        ((0, s.useEffect)(() => {
                            y || g(!1);
                        }, [u, y]),
                            (0, s.useEffect)(() => {
                        ...
                        const O = o()(b.base, n && b.base__open, b[`base__${f}`], (y || !B) && b[`base__${u}`], l);
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                f === m.Over && a().createElement('div', { className: b.gradient }),
                ...
                const g = (e) => {
                        ...
                        const y = !(!m.current || !m.current.scrollbar) && m.current.scrollbar.scrollbarYActive,
                            L = {
                        ...
                        return a().createElement(
                            'div',
                            { className: E, ref: b },
                            a().createElement(C.x, B({ ref: m, key: l, scrollAreaContainer: v.current }, A), S),
                        );
                    },
                    w = {
                ...
                const L = (0, s.memo)((e) => {
                        ...
                        const l = i.id,
                            ...
                            m = o()(w.base, u && w[`base__${u}`], c && w.base__selected, d && w.base__disabled, t);
                        return a().createElement(
                            'div',
                            { className: m, onMouseEnter: D, onMouseDown: b, onClick: h },
                            r ? r(i) : E,
                        );
                    }),
                ...
                const k = ({
                    ...
                    P = ({
                        ...
                        const _ = e ? `${e}_list` : void 0;
                        return a().createElement(
                            'div',
                            { id: _, className: o()(M.base, M[`base__${u}`], l) },
                            a().createElement(
                                g,
                    ...
                    ({
                        ...
                        return a().createElement(
                            'div',
                            {
                                id: e,
                                ref: I,
                                className: o()(x.base, x[`base__${h}`], m && m.base),
                                onMouseEnter: de,
                                onMouseUp: Ee,
                                onMouseDown: Ae,
                                onMouseLeave: Fe,
