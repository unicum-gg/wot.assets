(() => {
    ...
    var __webpack_modules__ = {
            3457: (e, u, t) => {
                ...
                c.defaultProps = { type: s.L.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const d = (0, i.memo)(c);
            },
            2106: (e, u, t) => {
                let n, r;
                    ...
                    A = a().forwardRef((e, u) => {
                        const t = e.offsetLeft,
                            ...
                            N = (0, l.useCallback)(() => {
                                T &&
                                    F &&
                                    F({ x: T.scrollbarXActive, y: T.scrollbarYActive }, { x: T.reach.x, y: T.reach.y });
                            }, [F, T]),
                            ...
                            q = (0, l.useCallback)(() => {
                                if (H && v && T) {
                                    const e = { scrollPosition: H.scrollLeft < 0 ? 0 : H.scrollLeft, reach: T.reach.x };
                                    v(e);
                                }
                            }, [v, H, T]),
                            G = (0, l.useCallback)(() => {
            ...
            8380: (e) => {
                        ...
                        (o.contains(e.scrollbarXRail) ||
                            ...
                            e.containerHeight + e.settings.scrollYMarginOffset < e.contentHeight
                                ? ((e.scrollbarYActive = !0),
                                  ...
                                  (e.scrollbarYHeight = p(e, F((e.railYHeight * e.containerHeight) / e.contentHeight))),
                                  (e.scrollbarYTop = F(
                            ...
                            e.scrollbarXActive
                                ...
                                : (o.classList.remove(c.active('x')),
                                  ...
                                  (o.scrollLeft = 0)),
                            e.scrollbarYActive
                                ? (o.classList.add(c.active('y')), D(e, 'top', o.scrollTop - e.lastScrollTop, !0, u))
                ...
                function x(e, u, t) {
                    var n = t[0],
                        ...
                        v = null;
                    function C(t) {
                        ((m[s] = F(A + v * (t[o] - b))), E(e, d), f(e, !1, u), t.stopPropagation(), t.preventDefault());
                    }
                    function g() {
                        (h(e, d), e[_].classList.remove(c.clicking), e.event.unbind(e.ownerDocument, 'mousemove', C));
                    }
            ...
            2344: (e, u, t) => {
                t.d(u, { D9: () => r });
                var n = t(2790);
                (t(3469), t(2133), t(3779), t(579), t(5360), t(9056));
                const r = n.Z;
            },
            6536: (e, u, t) => {
                t.d(u, { Z: () => r });
                ...
                const f = r.instance,
                    p = {
                        ...
                        sendShowContextMenuEvent: (e, u, t = 0) => {
                            v(a.CONTEXT_MENU, { isMouseEvent: !0, contentID: e, on: !0, decoratorID: t, args: u });
                        },
            ...
            9220: (e, u, t) => {
                ...
                const C = (0, a.memo)(
                    ({
                        ...
                        const T = r()(F.base, n && F.base__open, F[`base__${g}`], (y || !p) && F[`base__${u}`], l);
                ...
                const L = (0, a.memo)((e) => {
                        ...
                        const l = i.id,
                            ...
                            v = r()(w.base, u && w[`base__${u}`], c && w.base__selected, d && w.base__disabled, t);
                        return s().createElement(
                            'div',
            ...
            8982: (e, u, t) => {
                ...
                const a = 'ConfirmButton_base_75',
                    s = r().memo(({ applyBtnString: e, isDisabled: u, onConfirm: t, confirmButtonRef: i }) => {
                    ...
                    ({
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    o.u5,
                                    { size: o.qE.medium, type: o.L$.secondary, mixClass: d, disabled: !t, onClick: n },
                                    E.button.cancel(),
                                ),
                            ),
                        );
