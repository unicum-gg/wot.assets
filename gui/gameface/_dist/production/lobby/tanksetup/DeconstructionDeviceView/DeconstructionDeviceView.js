    ...
    var __webpack_modules__ = {
            ...
            827: (e, u, t) => {
                ...
                const A = c.O.client.getSize('rem'),
                    F = A.width,
                    m = A.height,
                    D = Object.assign({ width: F, height: m }, _(F, m, E)),
                ...
                const g = (e) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.largeWidth && d) return l(u, t, v);
                        if (t.mediumWidth && _) return l(u, t, v);
                ...
                const L = {
                    ...
                    P = (e) => {
                        ...
                        const r = T(),
                            ...
                            i = r.mediaHeight,
                            s = r.mediaSize;
                        return o().createElement('div', k({ className: f()(t, L[a], N[i], O[s]) }, n), u);
                    },
                    W = ['children'];
                const H = (e) => {
                    let u = e.children,
                ...
                class U extends o().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            _ = f()(z.base, z[`base__${a}`], z[`base__${r}`], null == i ? void 0 : i.base),
                ...
                function K(e = G.n.NONE, u = j, t = !1, n = !1) {
                    (0, a.useEffect)(() => {
                        if (e !== G.n.NONE)
                            return (
                ...
                const fe = {
                    ...
                    He = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Re, onDrag: n = Pe }) => {
                        const r = (0, a.useRef)(null),
                            ...
                            D = () => {
                                ...
                                const a = e.animationScroll.scrollPosition.get(),
                                    o = Math.min(1, n / r),
                                    c = X(0, 1, a / (r - n)),
                                    d = (u.offsetWidth - We(u, o)) * c;
                                (t.style.transform = `translateX(${0 | d}px)`),
                                    ((e) => {
                                        if (i.current && s.current && l.current && E.current) {
                                            if (0 === e)
                                                return i.current.classList.add(Ne), void s.current.classList.remove(Ne);
                                            if (
                                                ((u = l.current),
                                                (t = E.current),
                                                e - (u.offsetWidth - t.offsetWidth) >= -0.5)
                                            )
                                                return i.current.classList.remove(Ne), void s.current.classList.add(Ne);
                                            var u, t;
                                            i.current.classList.remove(Ne), s.current.classList.remove(Ne);
                                        }
                                    })(d);
                            },
                            C = De(() => {
                        ...
                        return o().createElement(
                            'div',
                            { className: f()(ye, u.base), ref: r, onWheel: e.handleMouseWheel },
                            o().createElement('div', {
                                className: f()(Se, u.leftButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Ne) || 0 !== e.button || (I('play'), g(ve.Next));
                                },
                                onMouseUp: h,
                                ref: i,
                                onMouseEnter: p,
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Ne) || 0 !== e.button || (I('play'), g(ve.Prev));
                                },
                                onMouseUp: h,
                                ref: s,
                                onMouseEnter: p,
                    ...
                    ze = ({
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement(Ve, { className: s, api: d, classNames: i }, e),
                            ),
                    ...
                    nu = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = eu, onDrag: n = Qe }) => {
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement('div', { ref: E, className: f()(Ze, u.thumb) }),
                ...
                var Tu = t(8401),
                    Mu = t(3934);
                const ku = 'Availability_base_51',
                    Lu = () => o().createElement('div', { className: ku }),
                    Nu = {
                        ...
                        ({ itemsInStorage: e, price: u, isMounted: t, possibleZeroCount: n, show: r = !0 }) => {
                            ...
                            return (
                                (a = t
                                    ...
                                    : e || (n && 0 === e)
                                      ? o().createElement(Mu.K, { itemsInStorage: e })
                ...
                const Pu = { calcValue: 0, isPositive: !0, valueKey: 'default' },
                    ...
                    $u = (0, Z.Pi)(({ slotIndex: e, bonusIndex: u, groupType: t }) => {
                        const n = ce().model,
                        ...
                        const i = a.valueType,
                            ...
                            E = 'mul' === i ? 100 * (s - 1) : s,
                            d = E > 0 ? '+' : '',
                            _ = $.Z5.getRealFormat(E, $.Gr.WO_ZERO_DIGITS),
                            A = Uu.$dyn(l),
                            F = `${_}${A ? ` ${A}` : Gu}`;
                        return o().createElement(
                            'div',
                            { className: f()(zu, c && Vu) },
                            o().createElement('span', null, o().createElement('span', { className: qu }), d + F),
                        );
                    }),
                    ...
                    dt = 'EquipmentSlot_vehicleName_bb',
                    _t = 'EquipmentSlot_price_ed',
                    At = 'EquipmentSlot_countText_a8',
                    Ft = 'EquipmentSlot_select_34',
                    mt = 'EquipmentSlot_glow_43',
                    Dt = (0, Z.Pi)(({ index: e, groupType: u, className: t }) => {
                        const n = ce(),
                            r = n.model,
                            a = n.controls,
                                ...
                                o().createElement(
                                    ...
                                    _ > 0 &&
                                        o().createElement(
                                            'div',
                                            { className: Et },
                                            o().createElement(Ou, { itemsInStorage: _, show: !0 }),
                                        ),
                                    Boolean(D) && o().createElement('div', { className: dt }, o().createElement(bu, F)),
                                    o().createElement(
                                        'div',
                                        { className: _t },
                                        o().createElement(su.F, { size: Ae.et.small, type: Ae.V2.equipCoin, value: d }),
                                    ),
                                ),
                            ),
                ...
                const vt = 'EquipmentHeader_base_ab',
                    ...
                    Tt = (0, Z.Pi)(({ text: e, value: u, isHidden: t, showVehicleInfo: n }) => {
                        const r = ce().model;
                        return o().createElement(
                            'div',
                            { className: f()(vt, t && ft) },
                    ...
                    Mt = 'CurrencyBlock_base_46',
                    kt = 'CurrencyBlock_currency_1c',
                    Lt = o().memo(function ({ text: e, value: u, currencyType: t, labelClassName: n }) {
                        return o().createElement(
                            'div',
                            { className: Mt },
                            o().createElement('div', { className: f()(kt, n) }, e),
                ...
                Kt.defaultProps = { type: Gt.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Zt = Kt;
                var Xt = t(280);
                const Yt = {
                    ...
                    un = ({ text: e, binding: u, classMix: t }) => {
                                ...
                                (s = s.replace(t, `%(${i})`)),
                                    (r[i] = Yt[e]
                                        ? o().createElement(
                                              'span',
                                              { className: Yt[e] },
                                              o().createElement(Xt.z, { text: c, binding: u }),
                                          )
                                        : o().createElement(
                                              'span',
                                              { style: n(e) },
                        ...
                        return o().createElement(Xt.z, { text: s, classMix: t, binding: r });
                    },
            ...
            5282: (e, u, t) => {
                ...
                const A = (e) =>
                    ...
                    F = ({ blocks: e, linesCount: u = 2, mediaSize: t }) => {
                        ...
                        return l().createElement('div', { ref: C, className: r()(E, m.height && d), style: h }, _);
                    };
            },
            6605: (e, u, t) => {
                'use strict';
