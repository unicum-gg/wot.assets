    ...
    var u,
        A = {
            1: (u, A, F) => {
                ...
                const _u = { view: B, client: e, sound: I, intl: V };
                const Ou = {
                ...
                const Iu = ((u, A) => {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const t = 'string' == typeof D ? `${E}.${D}` : E,
                                                            C = _u.view.addModelObserver(t, A, !0);
                    ...
                    })(({ observableModel: u }) => ({ root: u.object(), vehicleNames: u.array('vehicleNames') }), ku),
                    Uu = Iu[0],
                    Hu = Iu[1],
                    qu = 'App_base_d9b8a',
                    Wu = 'App_title_d751b',
                    Qu = 'App_description_bc16f',
                    Xu = 'App_vehicleNames_bffc0',
                    Zu = 'App_vehicleName_d462c',
                    Ju = R.strings.tank_setup.tooltip.deconstructConfirm,
                    Ku = (u) => {
                        return C().createElement(
                            'span',
                            { className: Xu },
                ...
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(Uu, null, C().createElement(Yu, null)),
