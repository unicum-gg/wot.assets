    ...
    var u,
        A = {
            1132: (u, A, F) => {
                        ...
                        return v.includes(F)
                            ...
                            : ((u, A = a.left) => {
                                  ...
                                  const E =
                                      ...
                                      e = u.replace(/&nbsp;/g, ' ');
                                  return (c(e, /( )/, A).forEach((u) => (F = F.concat(c(u, E, a.left)))), F);
                              })(u, A);
                    },
                ...
                const Bu = Object.keys(T).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === T[A]), u), {}),
                    Cu = {
                        set: (u, A) => {
                ...
                const pu = ((u, A) => {
                    ...
                    })(({ observableModel: u }) => ({ root: u.object(), vehicleNames: u.array('vehicleNames') }), cu),
                    bu = pu[0],
                    wu = pu[1],
                    hu = 'App_base_02',
                    yu = 'App_title_cb',
                    xu = 'App_description_8c',
                    _u = 'App_vehicleNames_31',
                    Pu = 'App_vehicleName_62',
                    Ru = R.strings.tank_setup.tooltip.deconstructConfirm,
                    Ou = (u) => {
                ...
                engine.whenReady.then(() => {
                    r().render(
                        t().createElement(bu, null, t().createElement(Su, null)),
