    ...
    var u,
        A = {
            1132: (u, A, F) => {
                ...
                const Cu = Object.keys(T).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === T[A]), u), {}),
                    tu = {
                        set: (u, A) => {
                ...
                const bu = ((u, A) => {
                    ...
                    })(({ observableModel: u }) => ({ root: u.object(), vehicleNames: u.array('vehicleNames') }), du),
                    wu = bu[0],
                    hu = bu[1],
                    yu = 'App_base_02',
                    xu = 'App_title_cb',
                    _u = 'App_description_8c',
                    Pu = 'App_vehicleNames_31',
                    Ru = 'App_vehicleName_62',
                    Ou = R.strings.tank_setup.tooltip.deconstructConfirm,
                    Su = (u) => {
                ...
                engine.whenReady.then(() => {
                    r().render(
                        t().createElement(wu, null, t().createElement(Tu, null)),
