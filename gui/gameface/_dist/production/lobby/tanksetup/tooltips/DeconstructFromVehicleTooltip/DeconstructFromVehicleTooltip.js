    ...
    var u,
        A = {
            243: (u, A, F) => {
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => W, getTextureUrl: () => H }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => Bu,
                ...
                const x = w('clientResized'),
                    ...
                    O = { down: w('mousedown'), up: w('mouseup'), move: w('mousemove') };
                const T = (function () {
                ...
                const hu = Object.keys(Q).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === Q[A]), u), {}),
                    wu = {
                        set: (u, A) => {
                ...
                const Ru = { view: B, client: E, sound: G, intl: N };
                function Su() {
                ...
                const zu = C().forwardRef(function (u, A) {
                    let F = u.children,
                        e = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        C().createElement(
                            'div',
                            Tu({}, B, {
                                className: i()(_u.base, _u[`base__theme-${D}`], e),
                                ref: function (u) {
                                    ((r.current = u), 'function' == typeof A ? A(u) : A && (A.current = u));
                                },
                            }),
                            C().createElement('div', { className: _u.decorator }, F),
                        )
                    );
                });
                var ju = F(3403);
                ...
                const Gu = ((u, A) => {
                    ...
                    })(({ observableModel: u }) => ({ root: u.object(), vehicleNames: u.array('vehicleNames') }), Mu),
                    Iu = Gu[0],
                    Uu = Gu[1],
                    qu = 'App_base_02',
                    Hu = 'App_title_cb',
                    Wu = 'App_description_8c',
                    Qu = 'App_vehicleNames_31',
                    Xu = 'App_vehicleName_62',
                    Zu = R.strings.tank_setup.tooltip.deconstructConfirm,
                    Ju = (u) => {
                        return C().createElement(
                            'span',
                            { className: Qu },
                            ...
                            (F = (A, F) =>
                                C().createElement(
                                    ...
                                    { key: F, className: Xu },
                                    A,
                                    F !== u.length - 1 && Zu.listSeparator(),
                                )),
                            Array.isArray(A) ? A.map(F) : A.map((u, A, e) => F(null == u ? void 0 : u.value, A, e))),
                        );
                        var A, F;
                    },
                    Ku = (0, ju.Pi)(() => {
                        const u = Uu().model,
                            A = u.root.get().equipmentName,
                            F = u.vehicleNames.get();
                        return C().createElement(
                            zu,
                            null,
                            C().createElement(
                                'div',
                                { className: qu },
                                C().createElement('div', { className: Hu }, A),
                                C().createElement(h, {
                                    classMix: Wu,
                                    text: R.strings.tank_setup.tooltip.deconstructConfirm.deconstructFromVehicle(),
                                    binding: { vehicleNames: Ju(F) },
                                }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(Iu, null, C().createElement(Ku, null)),
