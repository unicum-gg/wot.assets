    ...
    var u,
        A = {
            1033: (u, A, F) => {
                var E = {};
                F.r(E),
                    F.d(E, { mouse: () => g, off: () => f, on: () => v, onResize: () => c, onScaleUpdated: () => d });
                var e = {};
                F.r(e),
                    F.d(e, {
                        events: () => E,
                ...
                const y = {
                    ...
                    S = { play: Object.assign({}, P, { sound: p }), setRTPC: h };
                function _(u, A, F = 1) {
                ...
                function J(u = 'rem') {
                    ...
                    return 'rem' === u ? A : { x: uu(A.x), y: uu(A.y) };
                }
                function K() {
                ...
                const cu = n().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            lu({}, B, {
                                className: a()(au.base, au[`base__theme-${D}`], E),
                                ref: function (u) {
                ...
                const mu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    hu = (u, A, F = vu.left) => u.split(A).reduce(F === vu.left ? gu : pu, []),
                    bu = (() => {
                        const u = new RegExp(
                    ...
                    yu = (u, A = vu.left) => {
                        ...
                        return ((u, A = vu.left) => {
                            ...
                            const E =
                                ...
                                e = mu(u);
                            return hu(e, /( )/, A).forEach((u) => (F = F.concat(hu(u, E, vu.left)))), F;
                        })(u, A);
                    },
                    xu = 'FormatText_base_d0',
                    Pu = ({ binding: u, text: A = '', classMix: F, alignment: E = vu.left, formatWithBrackets: e }) => {
                        if (null === A) return console.error("FormatText was supplied with 'null'"), null;
                        const D = e && u ? fu(A, u) : A;
                        return n().createElement(
                            ...
                            D.split('\n').map((A, e) =>
                                n().createElement(
                                    'div',
                                    { className: a()(xu, F), key: `${A}-${e}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : yu(u, A))))(
                                        A,
                                        E,
                                        u,
                ...
                const Gu = ((u, A) => {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            n = ou.view.addModelObserver(C, A, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = Lu(e.keys()); !(u = F()).done; ) D(u.value, A);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(E),
                    ...
                    Hu = (0, o.Pi)(() => {
                        ...
                        return n().createElement(
                            cu,
                            null,
                            n().createElement(zu, { reason: u.reason.get(), isCritical: u.isCritical.get() }),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        n().createElement(Iu, null, n().createElement(Hu, null)),
