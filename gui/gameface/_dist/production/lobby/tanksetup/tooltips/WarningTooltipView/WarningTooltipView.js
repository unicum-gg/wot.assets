    ...
    var u,
        A = {
            1410: (u, A, F) => {
                ...
                const Bu = t().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        t().createElement(
                            ...
                            t().createElement('div', { className: Eu.decorator }, F),
                        )
                    );
                });
                var Cu = F(3403);
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            t = Au.view.addModelObserver(C, A, !0);
                ...
                const vu = (u, A, F) => {
                    ...
                    mu = (u, A, F = du.left) => u.split(A).reduce(F === du.left ? vu : fu, []),
                    gu = (() => {
                        const u = new RegExp(
                        ...
                        return pu.includes(F)
                            ...
                            : ((u, A = du.left) => {
                                  ...
                                  const E =
                                      ...
                                      e = u.replace(/&nbsp;/g, ' ');
                                  return (mu(e, /( )/, A).forEach((u) => (F = F.concat(mu(u, E, du.left)))), F);
                              })(u, A);
                    },
                    wu = 'FormatText_base_d0',
                    hu = ({ binding: u, text: A = '', classMix: F, alignment: E = du.left }) =>
                        null === A
                    ...
                    yu = 'Content_base_7d',
                    xu = 'Content_header_8e',
                    _u = 'Content_header__critical_93',
                    Pu = 'Content_description_66',
                    Ou = R.strings.tooltips.moduleFits,
                    Ru = t().memo(({ reason: u, isCritical: A, lockedByDevice: F }) => {
                        const E = (0, C.useMemo)(() => {
                            const A = Ou.$dyn(u);
                        ...
                        return t().createElement(
                            'div',
                            { className: yu },
                            E.header && t().createElement('div', { className: i()(xu, A && _u) }, E.header),
                            E.body &&
                                t().createElement(
                                    'div',
                                    { className: Pu },
                                    t().createElement(hu, { text: E.body, binding: { eqs: F } }),
                                ),
                        );
                    }),
                    Tu = (0, Cu.Pi)(() => {
                ...
                engine.whenReady.then(() => {
                    r().render(
                        t().createElement(cu, null, t().createElement(Tu, null)),
