    ...
    var u,
        A = {
            5734: (u, A, F) => {
                var E = {};
                (F.r(E),
                    F.d(E, { mouse: () => g, off: () => f, on: () => v, onResize: () => l, onScaleUpdated: () => d }));
                var e = {};
                (F.r(e),
                    F.d(e, {
                        events: () => E,
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => j, getTextureUrl: () => z }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => Q,
                ...
                const y = {
                    ...
                    P = Object.keys(x).reduce((u, A) => ((u[A] = () => p(x[A])), u), {}),
                    _ = { play: Object.assign({}, P, { sound: p }), setRTPC: h },
                    O = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    S = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function T(u) {
                    let A = '';
                    for (let F = S.length - 1; F >= 0; F--) for (; u >= S[F]; ) ((A += O[F]), (u -= S[F]));
                    return A;
                }
                ...
                function K(u = 'rem') {
                    ...
                    return 'rem' === u ? A : { x: Fu(A.x), y: Fu(A.y) };
                }
                function Y() {
                ...
                const nu = (() => {
                    ...
                    ru = T,
                    ou = Object.keys(M).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === M[A]), u), {}),
                    iu = {
                        set: (u, A) => {
                ...
                const fu = t().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        t().createElement(
                            'div',
                            vu({}, B, {
                                className: a()(lu.base, lu[`base__theme-${D}`], E),
                                ref: function (u) {
                                    ((r.current = u), 'function' == typeof A ? A(u) : A && (A.current = u));
                                },
                            }),
                            t().createElement('div', { className: lu.decorator }, F),
                        )
                    );
                });
                var mu = F(1281);
                ...
                const hu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    yu = (u, A, F = gu.left) => u.split(A).reduce(F === gu.left ? bu : wu, []),
                    xu = (() => {
                        const u = new RegExp(
                    ...
                    Ru = (u, A = gu.left) => {
                        ...
                        return ((u, A = gu.left) => {
                            ...
                            const E =
                                ...
                                e = hu(u);
                            return (yu(e, /( )/, A).forEach((u) => (F = F.concat(yu(u, E, gu.left)))), F);
                        })(u, A);
                    },
                    _u = 'FormatText_base_d0',
                    Ou = ({ binding: u, text: A = '', classMix: F, alignment: E = gu.left, formatWithBrackets: e }) => {
                        if (null === A) return (console.error("FormatText was supplied with 'null'"), null);
                        const D = e && u ? pu(A, u) : A;
                        return t().createElement(
                            ...
                            D.split('\n').map((A, e) =>
                                t().createElement(
                                    'div',
                                    { className: a()(_u, F), key: `${A}-${e}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : Ru(u, A))))(
                                        A,
                                        E,
                                        u,
                    ...
                    Su = 'Content_base_7d',
                    Tu = 'Content_header_8e',
                    zu = 'Content_header__critical_93',
                    ju = 'Content_description_66',
                    Mu = R.strings.tooltips.moduleFits,
                    ku = t().memo(({ reason: u, isCritical: A }) => {
                        const F = (0, C.useMemo)(() => {
                            const A = Mu.$dyn(u);
                        ...
                        return t().createElement(
                            'div',
                            { className: Su },
                            F.header && t().createElement('div', { className: a()(Tu, A && zu) }, F.header),
                            F.body &&
                                t().createElement('div', { className: ju }, t().createElement(Ou, { text: F.body })),
                        );
                    });
                function Lu() {}
                function Vu() {
                ...
                const Hu = ((u, A) => {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            t = su.view.addModelObserver(C, A, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = Gu(e.keys()); !(u = F()).done; ) D(u.value, A);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(E),
                    ...
                    })(({ observableModel: u }) => u.primitives({ reason: 'reason', isCritical: 'isCritical' }), Lu),
                    Uu = Hu[0],
                    qu = Hu[1],
                    Wu = (0, o.Pi)(() => {
                        const u = qu().model;
                        return t().createElement(
                            fu,
                            null,
                            t().createElement(ku, { reason: u.reason.get(), isCritical: u.isCritical.get() }),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        t().createElement(Uu, null, t().createElement(Wu, null)),
