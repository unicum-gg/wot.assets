    ...
    var u,
        A = {
            4689: (u, A, F) => {
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => L, getTextureUrl: () => j }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => J,
                        ...
                        displayStatus: () => k,
                        displayStatusIs: () => lu,
                        enableFullScreenModeSupported: () => vu,
                        events: () => $,
                        extraSize: () => cu,
                                ...
                                return (F) => {
                                    ...
                                    return (
                                        ...
                                        () => {
                                            e &&
                                                (B(),
                                                window.removeEventListener(D, C),
                                                (u.listeners -= 1),
                                                E(),
                                                (e = !1));
                                        }
                ...
                const x = {
                    ...
                    O = Object.keys(S).reduce((u, A) => ((u[A] = () => b(S[A])), u), {}),
                    _ = { play: Object.assign({}, O, { sound: b }), setRTPC: h },
                    T = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    z = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function M(u) {
                    let A = '';
                    for (let F = z.length - 1; F >= 0; F--) for (; u >= z[F];) ((A += T[F]), (u -= z[F]));
                    return A;
                }
                ...
                const lu = Object.keys(k).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === k[A]), u), {}),
                    cu = {
                        set: (u, A) => {
                ...
                const gu = { view: B, client: e, sound: _, intl: P };
                const mu = {
                ...
                const hu = t().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        t().createElement(
                            'div',
                            bu({}, B, {
                                className: a()(mu.base, mu[`base__theme-${D}`], E),
                                ref: function (u) {
                                    ((n.current = u), 'function' == typeof A ? A(u) : A && (A.current = u));
                                },
                            }),
                            t().createElement('div', { className: mu.decorator }, F),
                        )
                    );
                });
                var wu = F(8354);
                ...
                const Pu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Ou = (u, A, F = yu.left) => u.split(A).reduce(F === yu.left ? Ru : Su, []),
                    _u = (() => {
                        const u = new RegExp(
                            [
                    ...
                    zu = (u, A = yu.left) => {
                        ...
                        return ((u, A = yu.left) => {
                            ...
                            const E =
                                ...
                                e = Pu(u);
                            return (Ou(e, /( )/, A).forEach((u) => (F = F.concat(Ou(u, E, yu.left)))), F);
                        })(u, A);
                    },
                    Mu = 'FormatText_base_f27a4',
                    ju = ({ binding: u, text: A = '', classMix: F, alignment: E = yu.left, formatWithBrackets: e }) => {
                        if (null === A) return (console.error("FormatText was supplied with 'null'"), null);
                        const D = e && u ? xu(A, u) : A;
                        return t().createElement(
                            ...
                            D.split('\n').map((A, e) =>
                                t().createElement(
                                    'div',
                                    { className: a()(Mu, F), key: `${A}-${e}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : zu(u, A))))(
                                        A,
                                        E,
                                        u,
                                    ).map((u, A) => t().createElement(C.Fragment, { key: `${A}-${u}` }, u)),
                                ),
                            ),
                        );
                    },
                    Lu = 'Content_base_df7f3',
                    ku = 'Content_header_e43d9',
                    $u = 'Content_header__critical_cd1eb',
                    Vu = 'Content_description_f9618',
                    Gu = R.strings.tooltips.moduleFits,
                    Iu = t().memo(({ reason: u, isCritical: A }) => {
                        const F = (0, C.useMemo)(() => {
                            const A = Gu.$dyn(u);
                        ...
                        return t().createElement(
                            'div',
                            { className: Lu },
                            F.header && t().createElement('div', { className: a()(ku, A && $u) }, F.header),
                            F.body &&
                                t().createElement('div', { className: Vu }, t().createElement(ju, { text: F.body })),
                        );
                    });
                function Nu() {}
                function Uu() {
                ...
                function qu(u, A) {
                    ...
                    if (
                        ...
                        (F = (function (u, A) {
                            if (u) {
                                if ('string' == typeof u) return Wu(u, A);
                        ...
                        return [
                            function ({ mode: E = 'real', options: e, children: D, mocks: B }) {
                                        ...
                                        const B = (function ({
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            t = gu.view.addModelObserver(C, A, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = qu(e.keys()); !(u = F()).done;) D(u.value, A);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(E),
                                            ...
                                            o = u({
                                                ...
                                                observableModel: {
                                                    ...
                                                    array: (u, A) => {
                                                        const E = null != A ? A : t(u),
                                                            e = Hu.LO.box(E, { equals: Uu });
                                                        return (
                                                            'real' === F &&
                                                                C.subscribe(
                                                                    (0, Hu.aD)((u) => e.set(u)),
                                            ...
                                            i = { mode: F, model: o, externalModel: C, cleanup: r };
                                        return {
                                            model: o,
                                ...
                                return (
                                    ...
                                    t().createElement(F.Provider, { value: c }, D)
                                );
                            },
                            () => (0, C.useContext)(F),
                        ];
                    })(({ observableModel: u }) => u.primitives({ reason: 'reason', isCritical: 'isCritical' }), Nu),
                    Zu = Xu[0],
                    Ju = Xu[1],
                    Ku = (0, o.Pi)(() => {
                        const u = Ju().model;
                        return t().createElement(
                            hu,
                            null,
                            t().createElement(Iu, { reason: u.reason.get(), isCritical: u.isCritical.get() }),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        t().createElement(Zu, null, t().createElement(Ku, null)),
        ...
        (E.O = (A, F, e, D) => {
            if (!F) {
                ...
                for (r = 0; r < u.length; r++) {
                    for (var [F, e, D] = u[r], C = !0, t = 0; t < F.length; t++)
                        (!1 & D || B >= D) && Object.keys(E.O).every((u) => E.O[u](F[t]))
                            ? F.splice(t--, 1)
                            : ((C = !1), D < B && (B = D));
                    if (C) {
                        u.splice(r--, 1);
