    ...
    var u,
        A = {
            4913: (u, A, F) => {
                var e = {};
                (F.r(e),
                    F.d(e, { mouse: () => m, off: () => f, on: () => v, onResize: () => c, onScaleUpdated: () => d }));
                var E = {};
                (F.r(E),
                    F.d(E, {
                        events: () => e,
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => j, getTextureUrl: () => M }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => X,
                ...
                const y = {
                    ...
                    S = Object.keys(P).reduce((u, A) => ((u[A] = () => p(P[A])), u), {}),
                    O = { play: Object.assign({}, S, { sound: p }), setRTPC: b },
                    _ = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    T = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function z(u) {
                    let A = '';
                    for (let F = T.length - 1; F >= 0; F--) for (; u >= T[F]; ) ((A += _[F]), (u -= T[F]));
                    return A;
                }
                ...
                const au = Object.keys(k).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === k[A]), u), {}),
                    su = {
                        set: (u, A) => {
                ...
                const vu = { view: B, client: E, sound: O, intl: x };
                function fu() {
                ...
                const bu = C().forwardRef(function (u, A) {
                    ...
                    return (
                        ...
                        C().createElement(
                            'div',
                            pu({}, B, {
                                className: a()(gu.base, gu[`base__theme-${D}`], e),
                                ref: function (u) {
                                    ((r.current = u), 'function' == typeof A ? A(u) : A && (A.current = u));
                                },
                            }),
                            C().createElement('div', { className: gu.decorator }, F),
                        )
                    );
                });
                var wu = F(1281);
                ...
                const xu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Su = (u, A, F = hu.left) => u.split(A).reduce(F === hu.left ? Pu : Ru, []),
                    Ou = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Tu = (u, A = hu.left) => {
                        ...
                        return ((u, A = hu.left) => {
                            ...
                            const e =
                                ...
                                E = xu(u);
                            return (Su(E, /( )/, A).forEach((u) => (F = F.concat(Su(u, e, hu.left)))), F);
                        })(u, A);
                    },
                    zu = 'FormatText_base_d0',
                    Mu = ({ binding: u, text: A = '', classMix: F, alignment: e = hu.left, formatWithBrackets: E }) => {
                        ...
                        return C().createElement(
                            ...
                            D.split('\n').map((A, E) =>
                                C().createElement(
                                    'div',
                                    { className: a()(zu, F), key: `${A}-${E}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : Tu(u, A))))(
                                        A,
                                        e,
                                        u,
                    ...
                    ju = 'Content_base_7d',
                    ku = 'Content_header_8e',
                    Lu = 'Content_header__critical_93',
                    $u = 'Content_description_66',
                    Vu = R.strings.tooltips.moduleFits,
                    Gu = C().memo(({ reason: u, isCritical: A }) => {
                        const F = (0, t.useMemo)(() => {
                            const A = Vu.$dyn(u);
                        ...
                        return C().createElement(
                            'div',
                            { className: ju },
                            F.header && C().createElement('div', { className: a()(ku, A && Lu) }, F.header),
                            F.body &&
                                C().createElement('div', { className: $u }, C().createElement(Mu, { text: F.body })),
                        );
                    });
                function Iu() {}
                function Nu() {
                ...
                function Hu(u, A) {
                    ...
                    if (
                        ...
                        (F = (function (u, A) {
                            if (!u) return;
                            if ('string' == typeof u) return qu(u, A);
                ...
                const Qu = ((u, A) => {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const t = 'string' == typeof D ? `${e}.${D}` : e,
                                                            C = vu.view.addModelObserver(t, A, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = Hu(E.keys()); !(u = F()).done; ) D(u.value, A);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(e),
                    ...
                    })(({ observableModel: u }) => u.primitives({ reason: 'reason', isCritical: 'isCritical' }), Iu),
                    Xu = Qu[0],
                    Zu = Qu[1],
                    Ju = (0, o.Pi)(() => {
                        const u = Zu().model;
                        return C().createElement(
                            bu,
                            null,
                            C().createElement(Gu, { reason: u.reason.get(), isCritical: u.isCritical.get() }),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(Xu, null, C().createElement(Ju, null)),
