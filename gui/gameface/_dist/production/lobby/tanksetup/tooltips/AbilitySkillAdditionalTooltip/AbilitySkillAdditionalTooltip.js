        ...
        e = {
            ...
            7940: (u, e, t) => {
                ...
                const lu = Q.client.getSize('rem'),
                    mu = lu.width,
                    ou = lu.height,
                    su = Object.assign({ width: mu, height: ou }, Cu(mu, ou, Bu)),
                ...
                const gu = (u) => {
                    ...
                    const A = (0, Z.useContext)(cu),
                        ...
                        g = { extraLarge: m, large: o, medium: s, small: c, extraSmall: d };
                ...
                const pu = () => {
                    ...
                    wu = [_u.ExtraLarge, _u.Large, _u.Medium, _u.Small, _u.ExtraSmall],
                    bu = (u, e) =>
                ...
                const Mu = {
                    ...
                    Pu = Lu((u) => {
                        let e = u.className,
                            ...
                            o = u.row,
                            s = u.flexDirection,
                            c = void 0 === s ? (m ? 'column' : o && 'row') || void 0 : s,
                            d = u.flexStart,
                            g = u.center,
                            h = u.flexEnd,
                            _ = u.spaceBetween,
                            ...
                            b = u.wrap,
                            L = u.flexWrap,
                            y = void 0 === L ? (b ? 'wrap' : void 0) : L,
                            T = u.grow,
                            R = u.shrink,
                            M = u.flex,
                            H = void 0 === M ? (T || R ? `${T ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : M,
                            O = u.style,
                            P = u.children,
                            W = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const G = (0, Z.useMemo)(() => {
                            ...
                            }, [t, A, r, a, i, l, O, H, w, c, y, p, S]),
                            N = G.computedStyle,
                            j = G.computedClassNames;
                        return J().createElement('div', Ru({ className: n()(yu.base, ...j, e), style: N }, W), P);
                    });
                let Wu;
                !(function (u) {
                ...
                const Gu = (u, e, t) => {
                    ...
                    Ku = ({ binding: u, text: e = '', classMix: t, alignment: A = Wu.left }) =>
                        null === e
                    ...
                    Fe = Lu((u) => {
                        ...
                        const d = (0, Z.useMemo)(() => {
                                const u = Ae(F),
                                    ...
                                    t = u.colorStyle,
                                    A = void 0 === t ? {} : t;
                                return { computedStyle: Object.assign({}, o, A), colorClassName: e };
                            }, [o, F]),
                            g = d.computedStyle,
                            h = d.colorClassName;
                        return J().createElement(
                            ...
                            qu(
                                {
                                    className: n()($u.base, t && $u[t], h, A),
                                    style: g,
                                    mt: !0 === D ? te[t || 'paragraph-P16'].mt : D,
                                    mr: !0 === B ? te[t || 'paragraph-P16'].mr : B,
                                    mb: !0 === C ? te[t || 'paragraph-P16'].mb : C,
                                    ml: !0 === m ? te[t || 'paragraph-P16'].ml : m,
                                },
                                c,
                            ),
                            void 0 !== s ? J().createElement(Ku, qu({}, s, { text: e })) : e,
                        );
                    });
                function Ee() {}
                console.log;
                ...
                const ne = (0, Z.forwardRef)(function (u, e) {
                        let t = u.src,
                            A = u.className,
                            F = u.autoplay,
                            E = void 0 !== F && F,
                        ...
                        return (
                            ...
                            (0, Z.useEffect)(() => {
                                if (m && o.current) {
                                                    ...
                                                    if (o.current) {
                                                        ...
                                                        if (
                                                            (e !== A &&
                                                                ...
                                                                (e = A)),
                                                            o.current.paused || !m || !a)
                                                        )
                                                            return;
                                                        const E = o.current.cohGetKeyframeTimestamps();
                                                        E.forEach((e, t) => {
                                                            A > E[t] - 0.02 &&
                                                                A < E[t] &&
                                                                u.changeKeyframeHandlers.forEach((u) => {
                                                                    const A = Object.keys(null != B ? B : {})[t];
                                                                    return u({
                                                                        time: e,
                                                                        name: `${B ? A : `Point_${t}`}`,
                                                                    });
                                    ...
                                    const t = (e) => (
                                        ...
                                        F = () => {
                                            var u;
                                            return null == (u = o.current) ? void 0 : u.currentTime;
                                        },
                                        E = () => {
                                            var u;
                                            return null == (u = o.current) ? void 0 : u.duration;
                                        },
                                        r = (u) => {
                                            var e, t, A;
                                            o.current &&
                                                (o.current.currentTime =
                                                    ((e = 0),
                                                    (t = o.current.duration),
                                                    (A = u) < e ? e : A > t ? t : A));
                                        },
                                        D = () => {
                                            var u;
                                            return null == (u = o.current) ? void 0 : u.play();
                                        },
                                        n = () => {
                                            var u;
                                            return null == (u = o.current) ? void 0 : u.pause();
                                        },
                                        i = () => {
                                            (n(), r(0));
                                        },
                                        C = () => {
                                            var u, e;
                                            return null !=
                                                (u = null == (e = o.current) ? void 0 : e.cohGetKeyframeTimestamps())
                                                ? u
                                                : [];
                                        },
                                        l = (u) => {
                                        ...
                                        d = (u, e) => {
                                            var t;
                                            return (
                                                null == (t = o.current) || t.addEventListener(u, e),
                                                () => {
                                                    var t;
                                                    return null == (t = o.current)
                                                        ? void 0
                                        ...
                                        g = (u, e) => {
                                            var t;
                                            return (
                                                null == (t = o.current) || t.removeEventListener(u, e),
                                                () => {
                                                    var t;
                                                    return null == (t = o.current)
                                                        ? void 0
                            ...
                            J().createElement(
                                'video',
                                De({ src: t, className: A, style: r, loop: n, ref: o, onClick: i, onError: C }, l),
                            )
                        );
                    }),
                    ae = (0, Z.memo)(ne),
                    Be = 'App_base_8f',
                    ie = 'App_tooltipBlock_8f',
                    Ce = 'App_headerText_fb',
                    le = 'App_movie_f1',
                    me = 'App_descriptionText_b7',
                    oe = R.strings.tank_setup.tooltips.abilityAdditionalTooltip,
                    se = J().memo(() =>
                        J().createElement(
                            'div',
                            { className: Be },
                            J().createElement(
                                'div',
                                { className: ie },
                                J().createElement(Fe, { className: Ce, text: oe.title() }),
                            ),
                            J().createElement(ae, {
                                src: R.videos.animations.advancedHints.abilityPreview(),
                                className: le,
                                loop: !0,
                                autoplay: !0,
                            }),
                            J().createElement(
                                'div',
                                { className: ie },
                                J().createElement(Fe, { className: me, text: oe.description() }),
                            ),
                        ),
                    );
                engine.whenReady.then(() => {
                    ru().render(
                        J().createElement(Fu, null, J().createElement(se, null)),
