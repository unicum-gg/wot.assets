(() => {
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        ...
                                        s().createElement(
                                            ...
                                            P && s().createElement('div', { className: p.Z.plus }),
                                            S &&
                                                s().createElement(
                                                    'div',
                                                    { className: a()(p.Z.totalPrice, P && p.Z.totalPrice__mixed) },
                                                    s().createElement(A.M, {
                                                        parentId: 'deal-panel',
                                                        priceLabel: r,
                                                        isHideMessage: y && w,
            ...
            6774: (e, u, t) => {
                            ...
                            (0, Z.Z)(() => {
                                if (
                                    ...
                                    const t = (e) => {
                                        ...
                                        n = j(e);
                                    d.current = q.addCallback(n, t, s, u === X.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (u !== X.None)
                ...
                const Se = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    Ne = (0, E.Pi)(({ index: e, itemsType: u }) => {
                        ...
                        return a().createElement(
                            ...
                            i && l
                                ? a().createElement('div', { className: ke.postProgressionLevel }, Pe(i))
                                : Boolean(i) &&
                                      a().createElement('div', {
                                          style: {
                ...
                const je = 'ExchangeRate_base_76',
                    ...
                    Ye = ({
                        ...
                        let l;
                        r && r.isDiscountAvailable && (l = r.discountType === ze.Limited ? (i <= 5 ? Ke : void 0) : Xe);
                        const c = (0, n.useMemo)(
                            () => ({
                ...
                const Ru = (0, n.memo)((e) => {
                        ...
                        switch (r.animationSettings.type) {
                            ...
                            case cu.Growing:
                                return a().createElement(ku, Iu({}, r, { onEndAnimation: l, isComplete: s }));
                            default:
                                return null;
                        }
                    }),
                ...
                const Hu = (0, n.memo)(
                    ...
                    Yu = ({ value: e }) =>
                        a().createElement(
                            'div',
                            { className: Gu },
                            a().createElement('div', { className: ju }, Ku.durability()),
                            a().createElement(
                                'div',
                                { className: qu },
                    ...
                    it = (0, E.Pi)(
                        ({
                            ...
                            const l = be().model,
                                ...
                                A = P(E.notRequired.title(), { action: rt(i) });
                            return a().createElement(
                                'div',
                                { className: tt.base },
                            ...
                            i &&
                                a().createElement(
                                    ...
                                    a().createElement(y, {
                                        ...
                                        side: 'left',
                                        onClick: i,
                                        classNames: { base: St, icon: Pt, glow: kt },
                                    }),
                                ),
                        );
                    },
                ...
                engine.whenReady.then(() => {
                    i().render(
                        a().createElement(cn, null, a().createElement(Pn, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [727], () => __webpack_require__(6774));
