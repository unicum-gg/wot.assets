(() => {
            ...
            2270: (e, u, t) => {
                ...
                const w = (e) => {
                    ...
                    return a().createElement(
                        ...
                        y(
                            {
                                className: h()(v.base, v[`base__${A}`], v[`base__${d}`], null == i ? void 0 : i.base),
                                onMouseEnter: b,
                                onMouseLeave: B,
                                onMouseDown: w,
                                onMouseUp: x,
                        ...
                        a().createElement(
                            'div',
                            { className: h()(v.icon, v[`icon__${A}`], v[`icon__${d}`], null == i ? void 0 : i.icon) },
                ...
                const O = (e) => e.replace(/&nbsp;/g, ' '),
                    ...
                    V = (e, u, t = T.left) => e.split(u).reduce(t === T.left ? L : U, []),
                    H = (() => {
                        const e = new RegExp(
                            [
                    ...
                    j = (e, u = T.left) => {
                        ...
                        return ((e, u = T.left) => {
                            ...
                            const n =
                                ...
                                a = O(e);
                            return (V(a, /( )/, u).forEach((e) => (t = t.concat(V(e, n, T.left)))), t);
                        })(e, u);
                    };
                var z = t(8613);
                            ...
                            K(() => {
                                if (
                                    ...
                                    const t = (e) => {
                                        ...
                                        n = Q(e);
                                    d.current = ee.addCallback(n, t, s, u === ue.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (u !== ue.None)
                                    return () => {
                                        ee.removeCallback(d.current, s);
                                    };
                            }, [s, u]),
                            _
                        );
                ...
                var Ue = t(7405);
                const Ve = 'FormatText_base_d0',
                    He = ({ binding: e, text: u = '', classMix: t, alignment: r = T.left, formatWithBrackets: i }) => {
                ...
                const $u = (0, n.memo)((e) => {
                        ...
                        switch (r.animationSettings.type) {
                            case Du.Simple:
                                return a().createElement(Uu, Hu({}, r, { onEndAnimation: l, isComplete: o }));
                            case Du.Growing:
                                return a().createElement(Tu, Hu({}, r, { onEndAnimation: l, isComplete: o }));
                            default:
                                return null;
                        }
                    }),
                ...
                const Qu = {
                    ...
                    dt = R.strings.common.common,
                    Et = (e) => (e === Qe.Modification ? mt.modification() : mt.buy()),
                    At = (0, d.Pi)(
                        ({
                            title: e,
                            titleBinding: u,
                            ...
                            return a().createElement(
                                ...
                                a().createElement(He, {
                                    ...
                                    binding: Object.assign(
                                        {
                                            name: t && `${dt.open_quotes()}${O(t)}${dt.close_quotes()}`,
                ...
                const kt = 'CurrencyStepper_base_8f',
                    ...
                    Vt = 'CurrencyStepper_restrictionIconGlow_02',
                    Ht = ['label', 'limit', 'limitPosition', 'onLimitClick', 'onChange'];
                function $t() {
                    return (
                        ($t =
                            Object.assign ||
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(
                                            ...
                                            a().createElement(
                                                ...
                                                null,
                                                l
                                                    ? a().createElement(He, { text: jt.limitExceeded() })
                                                    : a().createElement(He, {
                                                          text: jt.limit(),
                                                          binding: { value: yt(t) },
                                                      }),
                            ...
                            i &&
                                a().createElement(
                                    ...
                                    a().createElement(w, {
                                        ...
                                        side: 'left',
                                        onClick: i,
                                        classNames: { base: Lt, icon: Ut, glow: Vt },
                                    }),
                                ),
                        );
                    },
                ...
                const _n = lu()(
                    ...
                    mn = _n[0],
                    dn = _n[1],
                    En = (0, d.Pi)(({ setGoldToChange: e, isSmall: u = !1 }) => {
                        gt(
                            () => (
                                pt(() => {
                                    (Ct(!1),
                ...
                (0, n.memo)((e) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && m) return pn(u, t, h);
                        if (t.smallWidth && d) return pn(u, t, h);
                ...
                const Mn = (e) => {
                        ...
                        return a().createElement(
                            ...
                            Tn(
                                {
                                    id: u,
                                    className: h()(In.base, In[`base__${_}`], In[`base__${d}`], {
                                        [In.base__checked]: r,
                                        [In.base__disabled]: o,
                    ...
                    Un = 'ConfirmButton_base_75',
                    Vn = a().memo(({ applyBtnString: e, isDisabled: u, onConfirm: t, confirmButtonRef: n }) =>
                        a().createElement(
                            'div',
                            { ref: n, className: Un, id: 'deal-panel-confirm' },
                            a().createElement(
                                B,
                ...
                const ta = R.strings.tank_setup.dealPanel,
                    ...
                    sa = (0, d.Pi)(({ goldToChange: e, setGoldToChange: u, exchangeType: t = la.Basic }) => {
                        const n = aa();
                        return a().createElement(
                            'div',
                            { className: ra },
                ...
                const ca = R.strings.tank_setup.dialogs,
                        ...
                        ({
                            ...
                            return (
                                ...
                                a().createElement(ye, {
                                    ...
                                    footer:
                                        C &&
                                        a().createElement(sa, { goldToChange: _, setGoldToChange: m, exchangeType: o }),
                                    showPayInfo: !0,
                    ...
                    ma = lu()(({ observableModel: e }) => {
                        const u = ((e) => {
                                const u = {
                                    ...
                                    t = (0, cn.Om)(
                                        (e) => {
                                            const t = An.U2(u.confirmedItems.get(), e);
                                            if (!t) throw Error(`No confirmed item found with index: ${e}`);
                                            return Object.assign({}, t);
                                        },
                                        { equals: ru },
                                    ),
                                    n = (0, cn.Om)(() => u.confirmedItems.get().length),
                                    a = (0, cn.Om)(() => u.lacksItem.get().length),
                                    r = (0, cn.Om)(
                                        () => {
                                            const e = t(0);
                                            return (e && An.U2(e.demountPrice.price, 0)) || null;
                                        },
                                        { equals: ru },
                                    );
                                return {
                    ...
                    da = ma[0],
                    Ea = ma[1],
                    Aa = R.strings.tank_setup.dialogs.exchangeToUpgrade,
                    pa = (0, d.Pi)(() => {
                        var e;
                        const u = Ea(),
                            t = u.model,
                        ...
                        return (
                            ...
                            a().createElement(
                                ...
                                { value: u },
                                a().createElement(_a, {
                                    title: n ? Aa.item.title() : Aa.items.title(),
                ...
                engine.whenReady.then(() => {
                    i().render(
                        a().createElement(da, null, a().createElement(pa, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [727], () => __webpack_require__(2270));
