    ...
    var __webpack_modules__ = {
            ...
            2449: (u, e, t) => {
                ...
                const f = o.O.client.getSize('rem'),
                    w = f.width,
                    S = f.height,
                    N = Object.assign({ width: w, height: S }, y(w, S, v)),
                    P = (0, n.createContext)(N),
                    T = ['children'];
                const x = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                ...
                const M = (u, e, t) => {
                    ...
                    L = (u, e, t = k.left) => u.split(e).reduce(t === k.left ? M : I, []),
                    U = (() => {
                        const u = new RegExp(
                        ...
                        return H.includes(t)
                            ...
                            : ((u, e = k.left) => {
                                  ...
                                  const n =
                                      ...
                                      r = u.replace(/&nbsp;/g, ' ');
                                  return L(r, /( )/, e).forEach((u) => (t = t.concat(L(u, n, k.left)))), t;
                              })(u, e);
                    };
                const W = {
                ...
                const Fu = (u) => {
                    ...
                    hu = ({
                        ...
                        const l = F()(pu.value, pu[`value__${n}`], !i && pu.value__notEnough),
                            _ = F()(pu.icon, pu[`icon__${n}-${t}`]),
                            E = F()(pu.stock, a && pu.stock__indent, e && pu.stock__interactive),
                            A = o && s > 0 && '+',
                            D = F()(pu.base, pu[`base__${t}`]);
                        return r().createElement(
                            'span',
                            { className: D },
                            r().createElement(
                ...
                const gu = r().memo(hu),
                    ...
                    bu = ({ binding: u, text: e = '', classMix: t, alignment: i = k.left }) =>
                        null === e
                    ...
                    Nu = ({
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: F()(fu, null == l ? void 0 : l.priceContainer) },
                                r().createElement('div', { className: wu }, n),
                                r().createElement(
                                    'div',
                                    { className: F()(Su, null == l ? void 0 : l.currency) },
                                    r().createElement(gu, { size: s, type: t, value: u, isEnough: e }),
                                ),
                                E &&
                                    r().createElement(bu, {
                                        text: i,
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (Lu(t, D, { isMouseEvent: !0, on: !0, arguments: Iu(r) }, v),
                                    C && C(),
