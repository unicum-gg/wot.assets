            ...
            2449: (u, e, t) => {
                ...
                class C extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            A = D()(m.base, m[`base__${a}`], m[`base__${i}`], null == s ? void 0 : s.base),
                            d = D()(m.icon, m[`icon__${a}`], m[`icon__${i}`], null == s ? void 0 : s.icon),
                            F = D()(m.glow, null == s ? void 0 : s.glow),
                            C = D()(m.caption, m[`caption__${a}`], null == s ? void 0 : s.caption),
                            h = D()(m.goto, null == s ? void 0 : s.goto);
                        return r().createElement(
                            ...
                            'info' !== a && r().createElement('div', { className: m.shine }),
                ...
                const N = (u) => {
                    ...
                    const r = (0, n.useContext)(S),
                        ...
                        C = { extraLarge: D, large: F, medium: m, small: B, extraSmall: p };
                    ...
                    V = (0, n.memo)(
                        ({
                            ...
                            const A = ((u, e) => Object.keys(e).reduce((e, t) => ((e[t] = u.includes(t)), e), {}))(
                                ...
                                f = D()(W.icon, d && W.icon__responsive, null == E ? void 0 : E.icon),
                                y = D()(W.title, d && W.title__responsive),
                                w = D()(W.closeBtn, F && W.closeBtn__responsive),
                                P = D()(
                                    W.divider,
                ...
                const Fu = (u) => {
                    ...
                    Bu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: i = 'real', options: a, children: s, mocks: c }) {
                                ...
                                return (
                                    (0, n.useEffect)(() => {
                                        E.current ? B(_(d, a, c)) : (E.current = !0);
                                    }, [c, d, a]),
                                    (0, n.useEffect)(() => {
                                        D(i);
                                    }, [i]),
                    ...
                    Pu = ({
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: D()(yu, null == l ? void 0 : l.priceContainer) },
                ...
                const ju = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        const i = e.contentId;
                        return i ? r().createElement(Uu, Yu({}, e, { contentId: i }), n) : r().createElement(Wu, e, n);
                    },
                    $u =
                        (eu.Items,
                        eu.Equipment,
                ...
                class Be extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = D()(me.currencyIcon, n && me[`currencyIcon__${n}-${t}`]),
                            l = D()(me.currency, n && me[`currency__${n}`], n && me[`currency__${n}-${t}`]);
                        return r().createElement(
                            'div',
                            {
                                className: i,
                ...
                const pe = {
                    ...
                    he = (0, A.Pi)(({ price: u, buttons: e, onDeconstructDevice: t, onCloseDialog: i }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: pe.priceBlock },
                                r().createElement(
                                    'div',
                                    { className: pe.stepper },
                                    r().createElement(Be, {
                                        value: 1,
                                        minimum: 1,
                                        maximum: _,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(Pu, {
                                        ...
                                        type: l,
                                        size: j.big,
                                        classNames: { currency: pe.currency, alert: pe.alert },
                                    }),
                                ),
                            ),
                    ...
                    Se = ({ title: u, deviceName: e, className: t, classNames: n }) =>
                        r().createElement(
                            ...
                            r().createElement(bu, {
                                text: u,
                                classMix: D()(ye, null == n ? void 0 : n.text),
                                binding: {
                ...
                engine.whenReady.then(() => {
                    a().render(
                        r().createElement(pu, null, r().createElement(Oe, null)),
