(() => {
    var __webpack_modules__ = {
                    ...
                    h = a().forwardRef((e, u) => {
                        const t = e.offsetLeft,
                            ...
                            W = (0, s.useCallback)(() => {
                                L &&
                                    D &&
                                    D({ x: L.scrollbarXActive, y: L.scrollbarYActive }, { x: L.reach.x, y: L.reach.y });
                            }, [D, L]),
                            X = (0, s.useCallback)(() => L, [L]),
                            Y = (0, s.useCallback)(() => {
                                L && L.update();
                            }, [L]),
                            U = (0, s.useCallback)(
                                (e, u, t) => {
                                    L && (L.setScrollLeft(e, u, t), k && k(e, L.contentWidth - L.containerWidth));
                                },
                                [L, k],
                            ),
                            z = (0, s.useCallback)(
                                (e) => {
                                    L && (L.setScrollLeftImmediately(e), k && k(e, L.contentWidth - L.containerWidth));
                                },
                                [L, k],
                            ),
                            $ = (0, s.useCallback)(
                                (e, u, t) => {
                                    L && L.setScrollTop(e, u, t);
                                },
                                [L],
                            ),
                            V = (0, s.useCallback)(
                            ...
                            Z = (0, s.useCallback)(
                                (e) => {
                                    ('function' == typeof u ? u(e) : null !== u && (u.current = e), O(e));
                                },
                                [u],
                            ),
                            Q = (0, s.useCallback)(() => {
                        ...
                        (0, s.useEffect)(() => {
                            if (L && I)
                                return (
                                    ...
                                    I.addEventListener('over-scroll-beginning', j),
                                    ...
                                    () => {
                                        (window.removeEventListener('resize', Q),
                                            ...
                                            I &&
                                                ...
                                                I.removeEventListener('over-scroll-beginning', j),
                                                I.removeEventListener('over-scroll-ending', K)));
                                    }
                                );
                        }, [J, q, j, K, Q, I, L, G]);
                        const ee = (0, s.useRef)(I || null);
                        ee.current = I || null;
                        const ue = (0, i.Z)(ee);
                        ((0, s.useEffect)(
                            () => (
                                !L && I && ue && R(new (c())(I, Object.assign({}, A))),
                                () => {
                                    L && (L.destroy(), R(void 0));
                                }
                            ),
                            [I, ue, A, L],
                        ),
                            ...
                            (0, s.useEffect)(() => {
                                y &&
                                    ((y.setScrollLeft = U),
                                    (y.setScrollTop = $),
                                    (y.setScrollLeftImmediately = z),
                                    (y.setScrollTopImmediately = V),
                                    (y.updateScrollArea = Y),
                                    (y.getScrollbar = X));
                            }, [y, U, z, $, V, Y, X]));
                        const te = r()(d, { [_]: v, [p]: !x, [m]: f, [E]: B }, S);
                        return a().createElement('div', { className: te, ref: Z }, w);
                    });
            },
            8380: (e) => {
                'use strict';
                ...
                ((A.prototype.eventElement = function (e) {
                    ...
                    (A.prototype.bind = function (e, u, t) {
                        this.eventElement(e).bind(u, t);
                    }),
                    (A.prototype.unbind = function (e, u, t) {
                    ...
                    (A.prototype.once = function (e, u, t) {
                        var n = this.eventElement(e);
                ...
                var g = function (e, u, t, n, r, o) {
                    ...
                    !(function (e, u, t, n, r, o) {
                        ...
                        var _ = e.element;
                        if (!e.reach) return;
                        ((e.reach[l] = null), _[a] < 1 && (e.reach[l] = 'start'));
                        _[a] > e[i] - e[s] - 1 && (e.reach[l] = 'end');
                        u &&
                            !r &&
                            (_.dispatchEvent(C('ps-scroll-' + l)),
                            u < 0
                                ? _.dispatchEvent(C('ps-scroll-' + c))
                                : u > 0 && _.dispatchEvent(C('ps-scroll-' + d)),
                            n &&
                                (function (e, u) {
                                    (m(e, u), E(e, u));
                                })(e, l));
                        e.reach[l] && (u || o) && _.dispatchEvent(C('ps-' + l + '-reach-' + e.reach[l]));
                    })(e, t, i, n, r, o);
                };
                var v = function (e, u, n, r) {
                    ...
                    if (o) {
                        ...
                        (o.contains(e.scrollbarXRail) ||
                            (s(o, l.rail('x')).forEach(function (e) {
                                return i(e);
                            }),
                            o.appendChild(e.scrollbarXRail)),
                            o.contains(e.scrollbarYRail) ||
                                (s(o, l.rail('y')).forEach(function (e) {
                                    return i(e);
                                }),
                            ...
                            e.scrollbarXActive
                                ? (o.classList.add(c.active('x')), g(e, 'left', _ - e.lastScrollLeft, !0, u))
                ...
                var B = {
                    ...
                    S = function (e) {
                        ...
                        h
                            ? ((_ = p ? 'scrollX' : 'scrollLeft'),
                              (E = p ? 'innerWidth' : 'width'),
                              (m = 'scrollWidth'))
                            : ((_ = p ? 'scrollY' : 'scrollTop'),
                        ...
                        var D = u[_],
                            b = (function (e) {
                                ...
                                } else u = (n[s] - n.getBoundingClientRect()[r]) | 0;
                                ...
                                var a = n - d,
                                    m = (function (e) {
                                        ...
                                        if (
                                            ...
                                            return y({ percentTimeElapsed: r, x1: t.x1, x2: t.x2, y1: t.y1, y2: t.y2 });
                                        throw new Error('Please enter a valid easing value');
                                    })({ easingPreset: s, cubicBezierPoints: i, runTime: a, duration: o });
                                if (!isNaN(m)) {
                                ...
                                o = function () {
                                    if (1 === n.buttons) {
                                        if (
                                            ...
                                            (k({ axis: u, cursorPositionOnRail: i, direction: s, i: e }) &&
                                                clearTimeout(r),
                                                v(e, !1, t));
                                        }
                                        n.stopPropagation();
                ...
                function x(e, u, t) {
                    var n = t[0],
                        ...
                        b = null;
                    function F(t) {
                        ((p[l] = D(h + b * (t[o] - A))), m(e, d), v(e, !1, u), t.stopPropagation(), t.preventDefault());
                    }
                    function C() {
                        (E(e, d), e[_].classList.remove(c.clicking), e.event.unbind(e.ownerDocument, 'mousemove', F));
                    }
                    ...
                    T = {
                        'click-rail': function (e, u) {
                            (e.event.bind(e.scrollbarY, 'mousedown', function (e) {
                                ...
                                e.event.bind(e.scrollbarYRail, 'mousedown', M(e, 'y', 0)),
                                e.event.bind(e.scrollbarX, 'mousedown', function (e) {
                                    return e.stopPropagation();
                                }),
                                e.event.bind(e.scrollbarXRail, 'mousedown', M(e, 'x', u)));
                        },
                            ...
                            function r(r) {
                                ...
                                if (
                                    !(function (e, t, r) {
                                        ...
                                        for (var o = e; o && o !== n; ) {
                                            if (o.classList.contains(l.consuming)) return !0;
                                            var i = u(o);
                                            if (
                                                ...
                                                if (
                                                    s > 0 &&
                                                    !((0 === o.scrollTop && r > 0) || (o.scrollTop === s && r < 0))
                                                )
                                                    return !0;
                                    ...
                                    (e.settings.useBothWheelAxes
                                        ? e.scrollbarYActive && !e.scrollbarXActive
                                            ? (s ? (n.scrollTop -= d) : (n.scrollTop += c), (a = !0))
                                            : e.scrollbarXActive &&
                                              !e.scrollbarYActive &&
                        ...
                        touch: function (e, t) {
                            ...
                            function a(u, r) {
                                ((n.scrollTop -= r), (n.scrollLeft -= u), v(e, !1, t));
                            }
                            function c(e) {
                        ...
                        'drag-move': function (e, u) {
                            ...
                            function p(r) {
                                if (e.scrollbarXActive) {
                                    ...
                                    if (((o = (a / (l - i)) * 1e3), (i = l), e.onScroll(), u > 0)) {
                            ...
                            function A(n) {
                                ...
                                if (t.scrollLeft < u) l(u - t.scrollLeft, P, d);
                                else if (t.scrollLeft > r) l(r - t.scrollLeft, P, d);
                                else {
                                    new Date().getTime() - i < 100 && l(o / 4, P, d, !0);
                                }
                                (E(e, 'x'),
                            ...
                            F().then(function () {
                                ...
                                ((o.scrollbarXBottom = parseInt(n.bottom, 10)),
                                    isNaN(o.scrollbarXBottom)
                                        ? ((o.isScrollbarXUsingBottom = !1), (o.scrollbarXTop = D(n.top)))
                                        : (o.isScrollbarXUsingBottom = !0),
                                    (o.railBorderXWidth = D(n.borderLeftWidth) + D(n.borderRightWidth)),
                                    t(o.scrollbarXRail, { display: 'block' }),
                                    (o.railXMarginWidth = D(n.marginLeft) + D(n.marginRight)),
                                ...
                                ((o.scrollbarYRight = parseInt(r.right, 10)),
                                    isNaN(o.scrollbarYRight)
                                        ? ((o.isScrollbarYUsingRight = !1), (o.scrollbarYLeft = D(r.left)))
                                    ...
                                    (o.scrollbarYOuterWidth = o.isRtl
                                        ...
                                        : null),
                                    (o.railBorderYWidth = D(r.borderTopWidth) + D(r.borderBottomWidth)),
                                    t(o.scrollbarYRail, { display: 'block' }),
                                    (o.railYMarginHeight = D(r.marginTop) + D(r.marginBottom)),
                                    t(o.scrollbarXRail, { display: '' }),
                                    ...
                                    o.settings.handlers.forEach(function (e) {
                                        return T[e](o, o.settings.overScrollWidth);
                                    }),
                                    ...
                                    v(o, !1, o.settings.overScrollWidth, !1));
                            }));
                    };
                ((L.prototype._getAnimationSettings = function (e, u, t, n) {
                    var r = this,
                        o = 0;
                    return (
                        null !== this.element &&
                            (o = ['bottom', 'top'].includes(u) ? this.element.scrollTop : this.element.scrollLeft),
                        {
                            ...
                            onRefUpdateCallback: function (e) {
                                (v(r, !0, r.settings.overScrollWidth, !1), t && t(e));
                            },
                    ...
                    (L.prototype.update = function () {
                        ...
                        this.isAlive &&
                            ...
                            (this.railXMarginWidth =
                                D(u(this.scrollbarXRail).marginLeft) + D(u(this.scrollbarXRail).marginRight)),
                            (this.railYMarginHeight =
                                D(u(this.scrollbarYRail).marginTop) + D(u(this.scrollbarYRail).marginBottom)),
                    ...
                    (L.prototype.setScrollLeft = function (e, u, t) {
                    ...
                    (L.prototype.setScrollTop = function (e, u, t) {
            ...
            3415: (e, u, t) => {
                ...
                const l = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    return l || d
                        ? r().createElement(s.u, a({}, u, { contentId: l || d }), n)
                            ...
                            s(
                                {
                                    contentId:
                                        ...
                                        p ? a.SimpleTooltipHtmlContent('resId') : a.SimpleTooltipContent('resId')),
                ...
                const a = (e, u, t = {}, n = 0) => {
                    ...
                    l = (e) => {
                        ...
                        const y = (0, o.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            w = (0, o.useMemo)(() => g || (0, n.F)().resId, [g]),
                            S = (0, o.useCallback)(() => {
                                (y.current.isVisible && y.current.timeoutId) ||
                                    (a(t, D, { isMouseEvent: !0, on: !0, arguments: s(r) }, w),
                                    v && v(),
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onClick: ((e) => (u) => {
                                              (!1 === h && k(), null == _ || _(u), null == e || e(u));
                                          })(u.props.onClick),
                                          onMouseDown: ((e) => (u) => {
                                              (!1 === h && k(), null == d || d(u), null == e || e(u));
                                          })(u.props.onMouseDown),
                                      },
                                      B,
                                  ),
                        ...
                        (0, o.Z)(() => {
                            if (
                                ...
                                const t = (e) => {
                                    ...
                                    n = (0, s.U0)(e);
                                D.current = l.addCallback(n, t, m, u === c.Deep);
                            }
                        }),
                        (0, a.useEffect)(() => {
                            if (u !== c.None)
                    ...
                    (document.addEventListener('mousedown', (t) => {
                        ...
                        document.addEventListener('dblclick', (e) => {
                            e.target.select &&
                                ...
                                t.setSelectionRange(o, i, 'forward'));
                        }));
                })(),
                    (function () {
                        let e = null;
            ...
            3649: (e, u, t) => {
                ...
                const o = (e) => e.replace(/&nbsp;/g, ' '),
                    ...
                    a = (e, u, t = n.left) => e.split(u).reduce(t === n.left ? i : s, []),
                    l = (() => {
                        const e = new RegExp(
                        ...
                        return c.includes(t)
                            ...
                            : ((e, u = n.left) => {
                                  ...
                                  const r =
                                      ...
                                      i = o(e);
                                  return (a(i, /( )/, u).forEach((e) => (t = t.concat(a(e, r, n.left)))), t);
                              })(e, u);
                    },
            ...
            4179: (e, u, t) => {
                'use strict';
                t.d(u, { c1: () => v, Sw: () => o.Z, B3: () => l, Z5: () => i, B0: () => a, ry: () => D, Sy: () => F });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
                        ...
                        if (i.length > 0) {
                            ...
                            return (
                                i.reduce((u, n) => {
                                    ...
                                    return o(i) ? (e.push(i.id), `${u}.${n}.value`) : (e.push(n), `${u}.${n}`);
                                }),
                                e.reduce((e, u) => e + '.' + u)
                            );
                        }
            ...
            9220: (e, u, t) => {
                ...
                var E = t(6373);
                const p = 'TextOverflow_base_3b',
                    h = ({ content: e, classMix: u }) => {
                        ...
                        return (
                            ...
                            l().createElement(
                                E.i,
                                { isEnabled: o, body: e },
                                l().createElement('div', { ref: t, className: r()(p, u) }, e),
                            )
                        );
                    };
                var A = t(7727);
                ...
                const F = (0, a.memo)(
                    ({
                        ...
                        const F = (0, a.useState)(b.Out),
                            ...
                            w = y || u === _.Basic,
                            S = (0, a.useCallback)(() => {
                                y || (g(b.Over), d && (0, A.G)(d));
                            }, [y, d]),
                            k = (0, a.useCallback)(() => {
                                y || (g(b.Down), E && (0, A.G)(E));
                            }, [y, E]),
                            M = (0, a.useCallback)(() => {
                                (!y && g(b.Over), !w && B(!0));
                            }, [y, w]),
                            x = (0, a.useCallback)((e) => c && c(e), [c]),
                            P = (0, a.useCallback)(() => g(b.Out), []);
                        ((0, a.useEffect)(() => {
                            w || B(!1);
                        }, [u, w]),
                            (0, a.useEffect)(() => {
                        ...
                        const T = r()(D.base, n && D.base__open, D[`base__${C}`], (w || !f) && D[`base__${u}`], s);
                        return l().createElement(
                            ...
                            !f && u === _.Alert && l().createElement('div', { className: D.alert }),
                            l().createElement(
                                'div',
                                { className: r()(D.label, D[`label__${t}`], !i && D.label__placeholder) },
                                p || l().createElement(h, { content: i || o }),
                            ),
                            l().createElement(
                                'div',
                                { className: r()(D.button, D[`button__${t}`]) },
                                l().createElement('div', { className: r()(D.arrow, D[`arrow__${t}`]) }),
                                C === b.Over && l().createElement('div', { className: D.gradient }),
                                y && l().createElement('div', { className: D.disabled }),
                            ),
                        );
                    },
                );
                        ...
                        const E = (0, a.useState)(!1),
                            ...
                            y = (0, a.useCallback)(() => {
                                ...
                                if (e && t && u) {
                                    ...
                                    t.setScrollTop(n, void 0, d ? C : void 0);
                                }
                            }, [C, d]);
                        (0, a.useEffect)(() => {
                            if (n && null !== r) return (0, i.v)(y);
                        }, [s, y, r, n]);
                        const w = !(!b.current || !b.current.scrollbar) && b.current.scrollbar.scrollbarYActive,
                            S = {
                            ...
                            k = (0, a.cloneElement)(u, S);
                        return l().createElement(
                            'div',
                            { className: _, ref: D },
                            l().createElement(g.x, f({ ref: b, key: s, scrollAreaContainer: A.current }, m), k),
                        );
                    },
                    y = {
                ...
                const S = (0, a.memo)((e) => {
                        ...
                        const s = i.id,
                            ...
                            b = r()(y.base, u && y[`base__${u}`], c && y.base__selected, d && y.base__disabled, t);
                        return l().createElement(
                            'div',
                            { className: b, onMouseEnter: h, onMouseDown: D, onClick: p },
                            o ? o(i) : _,
                        );
                    }),
                ...
                const x = ({
                        ...
                        l().createElement(
                            ...
                            u.map((u) => {
                                ...
                                return l().createElement(
                                    'div',
                                    { id: s ? r : void 0, key: r, ref: u.id === n ? o : null },
                                    l().createElement(
                                        S,
                                        M({ size: e, soundHover: a, soundClick: c, classMix: d, itemRenderer: _ }, u, {
                                            onClick: i,
                    ...
                    L = ({
                        ...
                        return l().createElement(
                            'div',
                            { id: F, className: r()(P.base, P[`base__${u}`], s) },
                            l().createElement(
                                B,
                                { selectedItemId: A, isEnabled: i, scrollSettings: T, classMix: P.scrollMix },
                                l().createElement(x, {
                                    parentId: e,
                                    items: t,
                                    size: u,
                    ...
                    I = (0, a.memo)(
                        ({
                            ...
                            const W = (0, a.useRef)(null),
                                X = (0, a.useRef)(null),
                                Y = (0, a.useRef)({ open: !1, listAbove: !1 }),
                                U = (0, a.useState)(!1),
                                z = U[0],
                                $ = U[1],
                                V = (0, a.useState)(!1),
                                q = V[0],
                                G = V[1],
                                j = (0, a.useState)(window.innerHeight),
                                K = j[0],
                                Z = j[1],
                                Q = ((e, u) => {
                            ...
                            const re = (0, a.useCallback)(() => {
                                Y.current.open && ((Y.current.open = !1), $(!1), w && w());
                            }, [w]);
                            (0, s.gd)(ue ? c.n.ESCAPE : c.n.NONE, re, ue);
                            const oe = (0, a.useCallback)(() => {
                                (k && k(), ee && ($(!1), (Y.current.open = !1), w && w()));
                            }, [k, w, ee]);
                            ((0, a.useEffect)(() => {
                                const e = W.current;
                                if (e && ue)
                            ...
                            (0, a.useEffect)(() => (0, i.v)(ie), [ie, p, t.length]);
                            const se = (0, a.useCallback)(
                                    (e) => {
                                        const u = Q.findIndex((u) => u === e) > -1;
                                        let t = [];
                                        ((t = h ? (u ? Q.filter((u) => u !== e) : [e, ...Q]) : u ? [] : [e]),
                                            B && B(t));
                                    },
                                    [h, B, Q],
                                ),
                                ...
                                de = (0, a.useCallback)((e) => M && M(e), [M]),
                                _e = (0, a.useCallback)((e) => P && P(e), [P]),
                                me = (0, a.useCallback)((e) => x && x(e), [x]),
                                Ee = (0, a.useCallback)((e) => T && T(e), [T]),
                                pe = (0, a.useMemo)(
                                    () =>
                                        t
                                ...
                                he = (0, a.useMemo)(() => t.filter((e) => Q.includes(e.id)), [t, Q]),
                                Ae = C ? C(he) : void 0;
                            return l().createElement(
                                'div',
                                {
                                    id: e,
                                    ref: W,
                                    className: r()(N.base, N[`base__${p}`], b && b.base),
                                    onMouseEnter: de,
                                    onMouseUp: _e,
                                    onMouseDown: me,
                                    onMouseLeave: Ee,
                                ...
                                l().createElement(
                                    'div',
                                    { className: r()(N.control, ue && N.control__down) },
                                    l().createElement(
                                        o.l,
                                        { tooltipArgs: f },
                                        l().createElement(F, {
            ...
            9257: (e, u, t) => {
                ...
                const D = {
                    ...
                    b = ({
                        ...
                        const F = (0, n.useRef)(null),
                            ...
                            k = w[1],
                            M = (0, n.useCallback)(() => {
                                i || (F.current && (F.current.focus(), v(!0)));
                            }, [i]),
                            x = (0, n.useCallback)(
                                (e) => {
                                    g && null !== F.current && !F.current.contains(e.target) && v(!1);
                                },
                                [g],
                            ),
                            P = (0, n.useCallback)(
                            ...
                            I = (0, n.useCallback)(
                                (e) => {
                                    i || (null !== l && (0, A.G)(l), _ && _(e), t && M(), y(!0));
                                },
                                [i, l, _, M, t],
                            ),
                            O = (0, n.useCallback)(
                            ...
                            H = h()(
                                ...
                                D[`base__${o}`],
                                {
                                    ...
                                    [D[`base__${u}`]]: u,
                                    [D.base__focus]: g,
                                    [D.base__highlightActive]: B,
                                    [D.base__firstHover]: S,
                                },
                                s,
                            ),
                            W = h()(D.state, D.state__default);
                        return (
                            (0, n.useEffect)(
                                () => (
                ...
                b.defaultProps = { type: m.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const F = (0, n.memo)(b),
                    C = {
                ...
                class f extends r().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            m = h()(C.base, C[`base__${i}`], C[`base__${o}`], null == s ? void 0 : s.base),
                            E = h()(C.icon, C[`icon__${i}`], C[`icon__${o}`], null == s ? void 0 : s.icon),
                            p = h()(C.glow, null == s ? void 0 : s.glow),
                            A = h()(C.caption, C[`caption__${i}`], null == s ? void 0 : s.caption),
                            D = h()(C.goto, null == s ? void 0 : s.goto);
                        return r().createElement(
                            'div',
                            v(
                                {
                ...
                const N = (e, u) => ({
                    ...
                    O = ({ value: e, currencyType: u, isWalletAvailable: t }) => {
                        const o = u === k.gold ? 'gold' : 'integral',
                            i = (0, n.useMemo)(() => N(L.backport, { currency: u }), [u]);
                        return r().createElement(
                            x.u,
                            i,
                            r().createElement(
                                'span',
                                { className: h()(I.currency, I[`currency__${u}`]) },
                                t ? r().createElement(T, { value: e, format: o }) : R.strings.common.common.dashes(),
                            ),
                        );
                    },
                    H = 'CurrencyBalance_base_97',
                    W = ({ credits: e, golds: u, crystals: t, freexp: n, isWalletAvailable: o }) =>
                        r().createElement(
                            'div',
                            { className: H },
                            r().createElement(O, { value: t, currencyType: k.crystal, isWalletAvailable: o }),
                            r().createElement(O, { value: u, currencyType: k.gold, isWalletAvailable: o }),
                            r().createElement(O, { value: e, currencyType: k.credits, isWalletAvailable: o }),
                            r().createElement(O, { value: n, currencyType: k.freeXP, isWalletAvailable: o }),
                        ),
                    X = 'DialogTemplate_base_bb',
                    Y = 'DialogTemplate_control_3e',
                    U = 'DialogTemplate_closeButton_2c',
                    z = 'DialogTemplate_view_78',
                    $ = 'DialogTemplate_view__show_51',
                    V = 'DialogTemplate_content_dc',
                    q = 'DialogTemplate_line_af',
                    G = 'DialogTemplate_divider_cb',
                    j = 'DialogTemplate_footer_2b',
                    K = 'DialogTemplate_buttons_f5',
                    Z = 'DialogTemplate_buttonWrapper_d9',
                    Q = 'DialogTemplate_button_f0';
                function J() {
                    return (
                        (J =
                            Object.assign ||
                ...
                const ee = ({
                        ...
                        const E = (0, l.tT)('model'),
                            ...
                            P = (0, n.useCallback)(
                                (e) => {
                                    (e.keyCode in w.n &&
                                        e.keyCode !== w.n.BACKSPACE &&
                                        e.keyCode !== w.n.DELETE &&
                                        (e.preventDefault(), y.O.view.setEventHandled()),
                                        e.keyCode !== w.n.ENTER ||
                                        e.altKey ||
                                        window.model.isAcceptDisabled ||
                                        i.disabled
                                            ? e.keyCode === w.n.ESCAPE && x()
                                            : k());
                                },
                                [i.disabled, k, x],
                            );
                            ...
                            N =
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(F, J({ onClick: k, mixClass: Q }, i), s),
                                    ),
                                ),
                            I =
                                a &&
                                r().createElement(
                                    ...
                                    r().createElement(F, J({ onClick: M, mixClass: Q }, a), c),
                                );
                        return r().createElement(
                            'div',
                            { className: X },
                            ...
                            r().createElement(
                                'div',
                                { className: h()(z, $) },
                                r().createElement('div', { className: V }, u),
                                r().createElement('div', { className: T }),
                                t && r().createElement('div', { className: j }, t),
                                r().createElement('div', { className: K }, N, I),
                            ),
                        );
                    },
                    ue = 'FormatText_base_d0',
                    te = ({ binding: e, text: u = '', classMix: t, alignment: o = s.v2.left }) =>
                        null === u
                    ...
                    re = ({
                        ...
                        discountValue: s,
                        showPlus: a,
                        stockBackgroundName: l = M.Red,
                    }) => {
                        const c = h()(ne.value, ne[`value__${n}`], !o && ne.value__notEnough),
                            d = h()(ne.icon, ne[`icon__${n}-${t}`]),
                            _ = h()(ne.stock, s && ne.stock__indent, u && ne.stock__interactive),
                            m = a && i > 0 && '+',
                            E = h()(ne.base, ne[`base__${t}`]);
                        return r().createElement(
                            'span',
                            { className: E },
                            r().createElement(
                                ...
                                { className: c },
                                m,
                                r().createElement(T, { value: i, format: n === k.gold ? 'gold' : 'integral' }),
                            ),
                ...
                const se = 'Alert_base_42',
                    ae = 'Alert_highlight_f2',
                    le = 'Alert_highlight__warning_13',
                    ce = ({ warning: e }) => {
                        const u = h()(ae, e && le);
                        return r().createElement('div', { className: se }, r().createElement('div', { className: u }));
                    },
                    de = {
                ...
                const Ee = ({ size: e = _e.Default, classMix: u }) =>
                        r().createElement('div', { className: h()(de.background, de[`background__${e}`], u) }),
                    pe = {
                    ...
                    De = (0, n.memo)(
                        ({ size: e, lineRef: u, disabled: t, baseStyles: n, isComplete: o, withoutBounce: i }) => {
                            ...
                            return r().createElement(
                                ...
                                a && r().createElement(he, { size: e }),
                            );
                        },
                    ),
                    be = ({ size: e, value: u, lineRef: t, disabled: o, onComplete: i }) => {
                        ...
                        return (
                            ...
                            r().createElement(De, { size: e, disabled: o, baseStyles: s, isComplete: a, lineRef: t })
                        );
                    },
                    Fe = (e, u) => {
                        let t;
                ...
                const ve = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    Be = (0, n.memo)(
                        ({
                            ...
                            return p
                                ...
                                : r().createElement(
                                      'div',
                                      { className: ve, style: F },
                                      r().createElement(
                                          'div',
                                          { style: h ? D : b, className: fe },
                                          r().createElement(he, { size: i }),
                                      ),
                                  );
                        },
                    ),
                    ...
                    ke = 'ProgressBarDeltaGrow_glow_68',
                    Me = (e) => (e ? { left: 0 } : { right: 0 }),
                    xe = (e, u) => (e ? { right: 100 - u + '%' } : { left: `${u}%` }),
                    ...
                    Te = (0, n.memo)(
                        ({
                            ...
                            const g = (0, n.useMemo)(() => Object.assign({ width: '100%' }, Pe(e), Me(d)), [d, e]),
                                v = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Pe(e), Me(d)), [d, e]),
                                f = (0, n.useMemo)(() => Object.assign({ width: '0%' }, xe(d, o), Pe(e)), [o, d, e]),
                                B = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(s - o)}%` }, xe(d, o), Pe(e)),
                                    [o, d, s, e],
                                );
                            if (p) return null;
                            const y = h()(we, c, d && 0 === s && Se);
                            return r().createElement(
                                'div',
                                { style: A ? f : B, className: y },
                                r().createElement(
                                    'div',
                                    { style: b ? v : g, className: ke },
                                    r().createElement(he, { size: i }),
                                ),
                            );
                        },
                ...
                const Ie = (0, n.memo)((e) => {
                        ...
                        switch (o.animationSettings.type) {
                            case me.Simple:
                                return r().createElement(ye, Ne({}, o, { onEndAnimation: l, isComplete: s }));
                            case me.Growing:
                                return r().createElement(Le, Ne({}, o, { onEndAnimation: l, isComplete: s }));
                            default:
                                return null;
                        }
                    }),
                ...
                const We = (0, n.memo)((e) => {
                    ...
                    return (
                        (o.current.from = s),
                        r().createElement(Ie, He({}, t, { onEndAnimation: i, key: `${s}-${t.to}`, from: s }))
                    );
                });
                function Xe() {
                    return (
                ...
                const Ye = (0, n.memo)(
                        ({
                            ...
                            return i.withStack
                                ...
                                : r().createElement(Ie, Xe({ key: `${o}-${u}` }, c));
                        },
                    ),
                    Ue = (e) => ({
                    ...
                    Ge = (0, n.memo)(
                        ({
                            ...
                            const p = ((e, u, t) =>
                                (0, n.useMemo)(() => {
                                    const n = (ze(0, u, e) / u) * 100;
                                    return { value: n, deltaFrom: $e(n, u, t) };
                                }, [t, u, e]))(l, e, c);
                            return r().createElement(
                                'div',
                                { className: h()(de.base, de[`base__${t}`]), style: Ue(u) },
                                !s && r().createElement(Ee, { size: t, classMix: a }),
                                r().createElement(Ye, {
                                    size: t,
                                    lineRef: d,
                                    disabled: i,
                    ...
                    je = 'Durability_base_8c',
                    Ke = 'Durability_label_02',
                    Ze = 'Durability_bar_73',
                    Qe = 'Durability_percentage_a7',
                    Je = ({ value: e }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: Ze },
                                r().createElement(Ge, { size: _e.Big, value: e }),
                            ),
                            r().createElement(te, {
                    ...
                    eu = 'RepairHeader_base_b4',
                    uu = 'RepairHeader_durability_e8',
                    tu = ({ isRepairRequired: e = !0 }) => {
                        const u = (0, c.m)('model.needRepairContent').repairPercentage;
                        return r().createElement(
                            'div',
                            { className: eu },
                            r().createElement(ce, { warning: e }),
                            e && r().createElement('div', { className: uu }, r().createElement(Je, { value: u })),
                        );
                    },
                    nu = ({ fromItem: e, toItem: u, exchangeRate: t }) => {
                        const o = (0, n.useMemo)(
                            () => ({
                                gold: r().createElement(oe, { key: e.name, size: S.small, type: k.gold, value: 1 }),
                                credits: r().createElement(oe, {
                                    key: u.name,
                                    size: S.small,
                                    type: k.credits,
                                    value: t.current,
                    ...
                    ou = R.strings.tank_setup.dialogs.goldExchange.notRequired.action,
                    iu = (e) => (e === ie.Modification ? ou.modification() : ou.buy()),
                    su = ({
                        title: e,
                        name: u,
                        lacksMoney: t,
                        ...
                        const E =
                            ...
                            C = (0, n.useMemo)(
                                () => ({
                                    name: u && `${p.open_quotes()}${(0, s.z4)(u)}${p.close_quotes()}`,
                                    credits: r().createElement(
                                        'div',
                                        { className: ru.titleCurrency },
                                        r().createElement(oe, {
                                            key: t.name,
                                            size: S.large,
                                            type: k.credits,
                            ...
                            g = (0, s.WU)(E.notRequired.title(), { action: iu(a) }),
                            v = (0, n.useMemo)(
                                () => ({
                                    gold: r().createElement(oe, { type: k.gold, size: S.small, value: D.value }),
                                }),
                                [D.value],
                            ),
                            f = (0, n.useMemo)(() => {
                                switch (o) {
                                    case d:
                                        return r().createElement(nu, { fromItem: D, toItem: b, exchangeRate: F });
                                    case 'notPossible':
                                        return r().createElement(te, { text: E.notPossible.status(), binding: v });
                                    case _:
                                        return E.notRequired.status();
                                }
                            }, [o, D, b, F, E, v]),
                            B = h()(ru.status, ru[`status__${o}`]);
                        return r().createElement(
                            'div',
                            { className: ru.base },
                            m === Tu.Repair && r().createElement(tu, null),
                            i && r().createElement('div', { className: ru.items }, i),
                            r().createElement(te, { text: o === _ ? g : e, binding: C, classMix: ru.title }),
                            l && r().createElement('div', { className: ru.description }, l),
                            r().createElement('div', { className: B }, f),
                        );
                    };
                t(3368);
                let au;
                ...
                class cu extends r().PureComponent {
                    constructor(...e) {
                        (super(...e),
                            ...
                            (this.formatValue = (e) =>
                                this.props.currencyType ? P.Z5.getNumberFormat(e, P.B3.GOLD) : e.toString()),
                            ...
                            (this.updateInput = (e = 0) => {
                                ...
                                const l = Number(i.trim().replace(/\D/g, '')),
                                    ...
                                    d = this.props.currencyType ? P.Z5.getNumberFormat(c, P.B3.GOLD) : c.toString(),
                            ...
                            (this.handleDelete = (e) => {
                                const u = e.keyCode === w.n.BACKSPACE,
                                    t = e.keyCode === w.n.DELETE,
                                    n = e.target,
                                    r = n.selectionStart,
                                    o = n.selectionEnd,
                                    i = n.value,
                                ...
                                let c = l;
                                const d = a.test(i[l]);
                                if (t && d) for (; a.test(i[c]) && c < i.length; ) c++;
                                if (u && d) for (; a.test(i[c]) && c > 0; ) c--;
                                if (c !== l || (u && d))
                            ...
                            (this.playHoverSound = () => {
                                this.props.isDisabled || (0, A.G)('highlight');
                            }),
                            (this.playClickSound = () => {
                                this.props.isDisabled || (0, A.G)('play');
                            }),
                            (this.stop = () => {
                    ...
                    get formattedValue() {
                        return this.props.currencyType
                            ? P.Z5.getNumberFormat(this.state.value, P.B3.GOLD)
                    ...
                    render() {
                        const e = this.props,
                            ...
                            o = h()(
                                lu.base,
                                lu[`base__${t}`],
                                n && lu[`base__withCurrency-${t}`],
                                u && lu.base__isDisabled,
                                this.state.isFocused && lu.base__isFocus,
                            ),
                            i = h()(
                                lu.buttonIncrement,
                                lu[`buttonIncrement__${t}`],
                                this.buttonIncrementIsDisabled && lu.buttonIncrement__isDisabled,
                                this.state.activeIncrement &&
                                    !this.buttonIncrementIsDisabled &&
                                    lu[`buttonIncrement__isActive-${this.props.size}`],
                            ),
                            s = h()(
                                lu.buttonDecrement,
                                lu[`buttonDecrement__${t}`],
                                this.buttonDecrementIsDisabled && lu.buttonDecrement__isDisabled,
                                this.state.activeDecrement &&
                                    !this.buttonDecrementIsDisabled &&
                                    lu[`buttonDecrement__isActive-${this.props.size}`],
                            ),
                            a = h()(
                                lu.input,
                                u && lu.input__disabled,
                                n && lu.input__withCurrency,
                                n && lu[`input__${n}-${t}`],
                                n && lu[`input__${n}`],
                                n && u && lu[`input__${n}-disabled`],
                            ),
                            l = h()(lu.currencyIcon, n && lu[`currencyIcon__${n}-${t}`]),
                            c = h()(lu.currency, n && lu[`currency__${n}`], n && lu[`currency__${n}-${t}`]);
                        return r().createElement(
                            'div',
                            {
                                className: o,
                            ...
                            r().createElement(
                                'div',
                                { className: lu.inputContainer },
                                n &&
                                    r().createElement(
                                        'div',
                                        { className: c },
                                        r().createElement('span', { className: lu.dummyValue }, this.formattedValue),
                ...
                const du = 'ExchangePanel_base_bd',
                    _u = 'ExchangePanel_arrow_62',
                    mu = 'ExchangePanel_arrow__small_30',
                    Eu = ({ goldToChange: e, setGoldToChange: u, isSmall: t = !1 }) => {
                        const o = (0, c.m)('model').golds,
                            i = (0, c.m)('model.exchangePanel', !1),
                            s = i.exchangeRate,
                            a = i.fromItem,
                            l = i.toItem,
                            d = (0, n.useState)(0),
                            ...
                            E = (0, n.useCallback)(
                                (e) => {
                                    ((a.value = e), (l.value = e * s.current), u(a.value));
                                },
                                [s, a.value, u, l.value],
                            ),
                            p = (0, n.useCallback)(
                                (e) => {
                                    ((a.value = e / s.current), (l.value = e), u(a.value));
                                },
                                [s, a.value, u, l.value],
                            ),
                            A = (0, n.useCallback)(
                ...
                const gu = (e) => {
                    let u = e.id,
                        ...
                        l = void 0 !== a && a,
                        c = e.size,
                        d = void 0 === c ? Au.medium : c,
                        _ = e.type,
                        m = void 0 === _ ? Du.primary : _,
                        E = e.soundHover,
                    ...
                    const T = (0, n.useState)(!1),
                        ...
                        $ = r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: h()(hu.labelContent, 's-labelContent'), style: k },
                                S || M,
                            ),
                        );
                    return r().createElement(
                        ...
                        Cu(
                            {
                                id: u,
                                className: h()(hu.base, hu[`base__${d}`], hu[`base__${m}`], {
                                    [hu.base__checked]: o,
                                    [hu.base__disabled]: s,
                                    [hu.base__mouseDown]: L,
                                    [hu.base__alert]: l,
                                    [hu.base__center]: x === bu.Center,
                                    [hu.base__bottom]: x === bu.Bottom,
                                }),
                                onClick: O,
                                onMouseEnter: X,
                                onMouseLeave: Y,
                        ...
                        r().createElement(
                            'div',
                            { className: hu.input },
                            r().createElement('div', { className: hu.alertOverlay }),
                            r().createElement('div', { className: hu.inputHoverOverlay }),
                            r().createElement('div', { className: hu.highlight }),
                        ),
                        r().createElement('div', { className: hu.checkmark }),
                        ((S || M) && $) || null,
                    );
                };
                let vu;
                ...
                var fu = t(9220);
                const Bu = 'AutoRenewal_dropdown_35',
                    yu = R.strings.tank_setup;
                let wu;
                !(function (e) {
                    ((e.General = 'general'),
                ...
                const Su = (0, n.memo)(
                        ({
                            modelPath: e,
                            label: u = yu.dealPanel.autoRenew(),
                            onValueChanged: t,
                            renewType: o = wu.General,
                        }) => {
                            const i = (0, c.m)(e),
                                s = i.isAutoRenewalEnabled,
                                a = i.onAutoRenewalChanged,
                                l = i.selectedAutoRenewalType,
                                d = (0, n.useCallback)(() => {
                                    const e = { type: l, value: !s };
                                    (a && a(e), t && t(e));
                                }, [t, a, s, l]),
                                _ = (0, n.useMemo)(() => {
                                    const e = yu.tooltip.autoRenewal;
                                    return {
                                        header: e.header.$dyn(o) || e.header.general(),
                                        body: o === wu.General ? '' : e.body.$dyn(o),
                                    };
                                }, [o]),
                                m = (0, n.useMemo)(() => {
                                    const e = yu.tooltip.autoRenewal;
                                    return { header: e.dropdown.header.$dyn(l), body: e.dropdown.body.$dyn(l) };
                                }, [l]),
                                E = (0, n.useCallback)(
                                    (e) => {
                                        if (!s) return;
                                        const u = { type: e, value: s };
                                        (a && a(u), t && t(u));
                                    },
                                    [t, a, s],
                                ),
                                p = (0, n.useMemo)(() => {
                                    const e = [vu.Soft, vu.Hard],
                                        u = [];
                                    for (let t = 0; t < e.length; t++) {
                                        const n = e[t],
                                            r = yu.dealPanel.autoRenewType.$dyn(n);
                                        u.push({ id: n, label: r });
                                    }
                                    return u;
                                }, []);
                            return r().createElement(
                                ...
                                o === wu.Boosters &&
                                    r().createElement(
                                        'div',
                                        { className: Bu },
                                        r().createElement(fu.v, {
                                            nameList: p,
                                            selectedAutoRenewalType: l,
                                            onChange: E,
                    ...
                    ku = 'ExchangeDialogFooter_base_ac',
                    Mu = 'ExchangeDialogFooter_exchange_60',
                    xu = 'ExchangeDialogFooter_renewal_7b',
                    Pu = ({ goldToChange: e, setGoldToChange: u, exchangeType: t = Tu.Basic }) =>
                        r().createElement(
                            'div',
                            { className: ku },
                            r().createElement(
                                'div',
                                { className: Mu },
                                r().createElement(Eu, { goldToChange: e, setGoldToChange: u }),
                            ),
                            t === Tu.Repair &&
                                r().createElement(
                                    'div',
                ...
                const Lu = R.strings.tank_setup.dialogs,
                    Ru = ({
                        title: e,
                        name: u,
                        items: t,
                        ...
                        const p = (0, n.useState)(0),
                            h = p[0],
                            A = p[1],
                            D = (0, c.m)('model'),
                            b = D.lacksMoney,
                            F = D.exchangeState,
                            C = (0, c.m)('model.exchangePanel'),
                            g = C.fromItem,
                            v = C.toItem,
                            f = F === d;
                        return (
                            ...
                            r().createElement(ee, {
                                ...
                                footer:
                                    f &&
                                    r().createElement(Pu, { goldToChange: h, setGoldToChange: A, exchangeType: s }),
                                showPayInfo: !0,
                                buttonAccept: { size: E.medium, type: m.main, disabled: !f || b.value > v.value },
                                buttonCancel: { size: E.medium, type: m.secondary },
                                buttonAcceptText:
                                    s === Tu.Upgrade ? Lu.exchangeToUpgrade.confirm() : Lu.goldExchange.confirm(),
                                buttonCancelText: a
                                    ? Lu.confirm.cancel.withRollback()
                ...
                const Ou = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    Xu = ({ item: e, itemsType: u }) => {
                        ...
                        return r().createElement(
                            'div',
                            { className: Wu.base },
                            r().createElement('div', { className: h()(Wu.highlight, Wu[`highlight__${t}`]) }),
                            r().createElement('div', {
                                className: h()(Wu.image, s && Wu.image__postProgression),
                                style: { backgroundImage: `url(${i})` },
                            }),
                            n && s
                                ? r().createElement('div', { className: Wu.postProgressionLevel }, Hu(n))
                                : Boolean(n) &&
                                      r().createElement('div', {
                                          style: {
                            ...
                            r().createElement('div', { className: h()(Wu.overlay, Wu[`overlay__${o}`]) }),
                        );
                    },
                    Yu = 'Items_base_b1',
                    Uu = ({ items: e, itemsType: u }) =>
                        r().createElement(
                            'div',
                            { className: Yu },
                            e.map(
                                ({ value: e }) =>
                                    e.imageSource && r().createElement(Xu, { key: e.name, item: e, itemsType: u }),
                            ),
                        ),
                    zu = 'Names_base_96',
                    $u = ({ items: e }) =>
                    ...
                    Vu = R.strings.tank_setup.dialogs.goldExchange,
                    qu = () => {
                        const e = (0, l.tT)('model.mainContent', l.DA.None),
                            u = e.confirmedItems,
                            t = e.itemsType;
                        (0, a.Pi)();
                        const n = Vu[1 === u.length ? 'item' : 'items'],
                            o = (0, s.WU)(n.title(), { action: Vu.action.buy(), type: n.$dyn(t) }),
                            i = u.length > 1 && r().createElement($u, { items: u }),
                            c = r().createElement(Uu, { items: u });
                        return r().createElement(Ru, { title: o, name: u[0].value.name, description: i, items: c });
                    },
                ...
                const ju = () => {
                    i().render(r().createElement(qu, null), Gu);
                };
                engine._BindingsReady && engine._WindowLoaded ? ju() : engine.on('Ready', ju);
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [727], () => __webpack_require__(9257));
