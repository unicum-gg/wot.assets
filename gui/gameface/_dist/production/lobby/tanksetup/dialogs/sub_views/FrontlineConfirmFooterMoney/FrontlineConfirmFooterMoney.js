(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, A) => {
                A.r(e), A.d(e, { mouse: () => t, onResize: () => D });
                var F = A(2472),
                    E = A(1176);
                        ...
                        if (void 0 !== e) {
                            ...
                            return void 0 !== D
                                ? viewEnv.handleViewEvent(
                                      Object.assign({ __Type: A, type: u }, B, {
                                          arguments:
                                              ((E = D),
                                ...
                                : viewEnv.handleViewEvent(Object.assign({ __Type: A, type: u }, B));
                        }
            ...
            4179: (u, e, A) => {
                ...
                function c(u, e, A, F, E, D, B) {
                    ...
                    t.done ? e(C) : Promise.resolve(C).then(F, E);
                }
                ...
                const m = E.instance,
                    b = {
                        ...
                        sendMoveEvent: (u) => v(C.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: w,
                        sendClosePopOverEvent: () => v(C.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            v(C.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
                        sendShowPopOverEvent: (u, e, A, F, E = R.invalid('resId'), D) => {
                            const B = s.O.view.getViewGlobalPosition(),
                                ...
                                o = t.height,
                                a = {
                                    x: s.O.view.pxToRem(n) + B.x,
                                    y: s.O.view.pxToRem(r) + B.y,
            ...
            1342: (u, e, A) => {
                ...
                const r = (u, e, A) => {
                    ...
                    o = (u, e, A = n.left) => u.split(e).reduce(A === n.left ? r : i, []),
                    a = (() => {
                        const u = new RegExp(
                        ...
                        return s.includes(A)
                            ...
                            : ((u, e = n.left) => {
                                  ...
                                  const F =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return o(E, /( )/, e).forEach((u) => (A = A.concat(o(u, F, n.left)))), A;
                              })(u, e);
                    },
                    c = 'FormatText_base_d0',
                    d = ({ binding: u, text: e = '', classMix: A, alignment: D = n.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, B) =>
                                      E().createElement(
                                          'div',
                                          { className: C()(c, A), key: `${e}-${B}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : _(u, e))))(e, D, u).map((u, e) =>
                ...
                const w = (u = 1) => {
                    ...
                    f = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, A) => {
                                const F = h(`${u}.${A}`, window);
                                return m(F) ? e(u, A, F) : `${u}.${A}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    g = (u) => {
                        const e = ((u) => {
                                const e = w(),
                                ...
                                return { modelPrefix: E, modelPath: b(E, u || ''), resId: F };
                            })(),
                            A = e.modelPrefix,
                            F = u.split('.');
                        if (F.length > 0) {
                            ...
                            return (
                                F.reduce((e, F) => {
                                    const E = h(b(A, `${e}.${F}`), window);
                                    return m(E) ? (u.push(E.id), `${e}.${F}.value`) : (u.push(F), `${e}.${F}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const y = (u = 'model', e = T.Deep) => {
                        const A = (0, F.useState)(0),
                            ...
                            t = D.resId,
                            C = (0, F.useMemo)(
                                () => (window.__feature && window.__feature !== B ? `subViews.${B}.${u}` : u),
                                [B, u],
                            ),
                            n = (0, F.useState)(() =>
                                ((u) => {
                            ...
                            p(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        F = g(u);
                                    o.current = O.addCallback(F, A, t, e === T.Deep);
                                }
                            }),
                            (0, F.useEffect)(() => {
                                if (e !== T.None)
                                    return () => {
                                        O.removeCallback(o.current, t);
                                    };
                            }, [t, e]),
                            r
                        );
                    },
                    M = (v.Sw.instance, 'FrontlineConfirmFooterMoneyApp_base_a2'),
                    P = 'FrontlineConfirmFooterMoneyApp_base__extended_22',
                    k = 'FrontlineConfirmFooterMoneyApp_label_2b',
                    x = 'FrontlineConfirmFooterMoneyApp_price_16',
                    S = 'FrontlineConfirmFooterMoneyApp_icon_7e',
                    L = () => {
                        const u = y('model', T.Shallow),
                            e = u.price,
                            A = u.isExtendedHeight;
                        return E().createElement(
                            'div',
                            { className: C()(M, A && P) },
                            E().createElement(d, {
                                classMix: k,
                                text: R.strings.fl_dialogs.confirm.price(),
                                binding: {
                                    price: E().createElement('div', { className: x }, e),
                                    icon: E().createElement('div', { className: S }),
                                },
                            }),
                        );
                    };
                engine.whenReady.then(() => {
                    B().render(E().createElement(L, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, A, F) => {
            if (!e) {
                ...
                for (C = 0; C < deferred.length; C++) {
                    for (var [e, A, F] = deferred[C], D = !0, B = 0; B < e.length; B++)
                        (!1 & F || E >= F) &&
                        Object.keys(__webpack_require__.O).every((u) => __webpack_require__.O[u](e[B]))
                            ? e.splice(B--, 1)
                            : ((D = !1), F < E && (E = F));
                    if (D) {
                        deferred.splice(C--, 1);
            ...
            F = F || 0;
            for (var C = deferred.length; C > 0 && deferred[C - 1][2] > F; C--) deferred[C] = deferred[C - 1];
            deferred[C] = [e, A, F];
        }),
        ...
        (() => {
            ...
            var e = (e, A) => {
                    var F,
                        ...
                        C = 0;
                    if (D.some((e) => 0 !== u[e])) {
                        for (F in B) __webpack_require__.o(B, F) && (__webpack_require__.m[F] = B[F]);
                        if (t) var n = t(__webpack_require__);
                    }
                    for (e && e(A); C < D.length; C++)
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [727], () => __webpack_require__(1342));
