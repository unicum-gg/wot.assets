(() => {
                ...
                const a = (u = 1) => {
                    ...
                    l = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: E, modelPath: d(E, u || ''), resId: F };
                            })(),
                            A = e.modelPrefix,
                            F = u.split('.');
                        if (F.length > 0) {
                            ...
                            C(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        F = l(u);
                                    d.current = v.addCallback(F, A, D, e === w.Deep);
                                }
                            }),
                            (0, F.useEffect)(() => {
                                if (e !== w.None)
                                    return () => {
                                        v.removeCallback(d.current, D);
                                    };
                            }, [D, e]),
                            o
                        );
                    },
                    m = (B.Sw.instance, 'FrontlineConfirmIconsApp_base_58'),
                    p = 'FrontlineConfirmIconsApp_base__extended_b0',
                    b = 'FrontlineConfirmIconsApp_icon_a9',
                    f = () => {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [727], () => __webpack_require__(7802));
