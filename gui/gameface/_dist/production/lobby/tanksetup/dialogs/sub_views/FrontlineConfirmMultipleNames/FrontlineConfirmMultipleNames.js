                            ...
                            a(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        F = d(u);
                                    w.current = c.addCallback(F, A, D, e === l.Deep);
                                }
                            }),
                            (0, F.useEffect)(() => {
                                if (e !== l.None)
                                    return () => {
                                        c.removeCallback(w.current, D);
                                    };
                            }, [D, e]),
                            s
                        );
                    },
                    w = (i.Sw.instance, 'FrontlineConfirmMultipleNamesApp_base_bb'),
                    h = () => {
        ...
        (() => {
            ...
            var e = (e, A) => {
                    ...
                    if (t.some((e) => 0 !== u[e])) {
                        ...
                        if (D) var i = D(__webpack_require__);
                    }
