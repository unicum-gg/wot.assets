(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, A) => {
                (A.r(e), A.d(e, { mouse: () => D, onResize: () => t }));
                var F = A(2472),
                    E = A(1176);
            ...
            4179: (u, e, A) => {
                ...
                function c(u, e, A, F, E, t, n) {
                    ...
                    D.done ? e(i) : Promise.resolve(i).then(F, E);
                }
                ...
                const o = (u = 1) => {
                    ...
                    c = (u) => {
                        ...
                        if (F.length > 0) {
                            ...
                            return (
                                F.reduce((e, F) => {
                                    const E = B(s(A, `${e}.${F}`), window);
                                    return C(E) ? (u.push(E.id), `${e}.${F}.value`) : (u.push(F), `${e}.${F}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                            ...
                            a(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        F = c(u);
                                    w.current = d.addCallback(F, A, D, e === l.Deep);
                                }
                            }),
                            (0, F.useEffect)(() => {
                                if (e !== l.None)
                                    return () => {
                                        d.removeCallback(w.current, D);
                                    };
                            }, [D, e]),
                            s
                        );
                    },
                    w = (r.Sw.instance, 'FrontlineConfirmMultipleNamesApp_base_bb'),
                    h = () => {
                        const u = v('model', l.Shallow).names;
                        return E().createElement('div', { className: w }, u.map(({ value: u }) => u).join(', '));
                    };
                engine.whenReady.then(() => {
                    n().render(E().createElement(h, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, A, F) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, A, F] = deferred[i], t = !0, n = 0; n < e.length; n++)
                        (!1 & F || E >= F) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [727], () => __webpack_require__(2912));
