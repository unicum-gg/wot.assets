(() => {
    var __webpack_modules__ = {
            ...
            6891: (u, e, t) => {
                ...
                fu.defaultProps = { type: hu.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const bu = fu,
                    wu = [
                        'children',
                        'contentId',
                ...
                const me = [Ae.Small, Ae.Big],
                    ...
                    ve = ({ binding: u, text: e = '', classMix: t, alignment: a = uu.left, formatWithBrackets: i }) => {
