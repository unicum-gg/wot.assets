    ...
    var __webpack_modules__ = {
            ...
            5713: (e, u, t) => {
                ...
                const Oe = (0, a.memo)(() => {
                        ...
                        return (
                            ...
                            o().createElement(
                                ...
                                { className: Ne },
                                r.map(({ value: u }, n) =>
                                    o().createElement(Le, ke({ key: u.buttonID, isFocused: n === t, onClick: e }, u)),
                                ),
                            )
                        );
                    }),
                ...
                const Lu = {
                    ...
                    Nu = ({
                        ...
                        return (l = {}) => {
                            ...
                            return (0, a.useMemo)(
                                ...
                                [m.scrollPosition, g, p, b, d.off, d.on, f, h, B, E.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    ku = Nu({
                    ...
                    Xu = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Vu, onDrag: n = Yu }) => {
                                ...
                                ((t.style.transform = `translateY(${0 | _}px)`),
                                    ((e) => {
                                        if (i.current && s.current && l.current && c.current) {
                                            if (0 === e)
                                                return (
                                                    i.current.classList.add(it),
                                                    void s.current.classList.remove(it)
                                                );
                                            if (
                                                ((u = l.current),
                                                (t = c.current),
                                                ...
                                                return (
                                                    i.current.classList.remove(it),
                                                    void s.current.classList.add(it)
                                                );
                                            var u, t;
                ...
                (Bt.Items,
                    ...
                    Bt.GoldenTicket,
                    Bt.PostStamp,
                    Bt.BlankPersonalMissions_1,
                    Bt.BlankPersonalMissions_2,
                    Bt.SACoin,
                ...
                engine.whenReady.then(() => {
                    U().render(
                        o().createElement(O, null, o().createElement(Bu, null, o().createElement(un, null))),
