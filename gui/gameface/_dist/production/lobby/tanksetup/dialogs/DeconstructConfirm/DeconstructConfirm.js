(() => {
    var __webpack_modules__ = {
            ...
            4179: (e, u, t) => {
                'use strict';
                t.d(u, { Sw: () => a.Z, B3: () => l, Z5: () => o, B0: () => s, ry: () => C });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            4720: (e, u, t) => {
                ...
                const re = (e = 1) => {
                    ...
                    ae = (e, u) => e.split('.').reduce((e, u) => e && e[u], u),
                    ...
                    le = (e) => {
                        ...
                        if (n.length > 0) {
                            ...
                            return (
                                n.reduce((u, n) => {
                                    const r = ae(ie(t, `${u}.${n}`), window);
                                    return oe(r) ? (e.push(r.id), `${u}.${n}.value`) : (e.push(n), `${u}.${n}`);
                                }),
                                e.reduce((e, u) => e + '.' + u)
                            );
                        }
                        ...
                        B(() => {
                            if (
                                ...
                                const t = (e) => {
                                    ...
                                    r = le(e);
                                _.current = ce.addCallback(r, t, i, u === Ee.Deep);
                            }
                        }),
                        (0, a.useEffect)(() => {
                            if (u !== Ee.None)
                                return () => {
                                    ce.removeCallback(_.current, i);
                                };
                        }, [i, u]),
                        c
                    );
                    ...
                    ku = ({
                        ...
                        return (l = {}) => {
                            ...
                            return (0, a.useMemo)(
                                ...
                                [m.scrollPosition, g, p, b, d.off, d.on, f, h, C, E.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    Ou = ku({
                    ...
                    Ku = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Yu, onDrag: n = ju }) => {
                                ...
                                ((t.style.transform = `translateX(${0 | _}px)`),
                                    ((e) => {
                                        if (i.current && s.current && l.current && c.current) {
                                            if (0 === e)
                                                return (
                                                    i.current.classList.add($u),
                                                    void s.current.classList.remove($u)
                                                );
                                            if (
                                                ((u = l.current),
                                                (t = c.current),
                                                ...
                                                return (
                                                    i.current.classList.remove($u),
                                                    void s.current.classList.add($u)
                                                );
                                            var u, t;
                        ...
                        return o().createElement(
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains($u) || 0 !== e.button || (Ae('play'), B(Lu.Next));
                                },
                                onMouseUp: g,
                                ref: i,
                                onMouseEnter: p,
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains($u) || 0 !== e.button || (Ae('play'), B(Lu.Prev));
                                },
                                onMouseUp: g,
                                ref: s,
                                onMouseEnter: p,
                    ...
                    dt = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Et, onDrag: n = lt }) => {
                                        ...
                                        if (i.current && s.current && l.current && c.current) {
                                            if (0 === e)
                                                return (
                                                    ...
                                                    void s.current.classList.remove(st)
                                                );
                                            if (
                                                ((u = l.current),
                                                (t = c.current),
                                                ...
                                                return (
                                                    ...
                                                    void s.current.classList.add(st)
                                                );
                                            var u, t;
                        ...
                        return o().createElement(
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(st) || 0 !== e.button || (Ae('play'), g(Lu.Next));
                                },
                                ref: i,
                                onMouseEnter: v,
                            }),
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(st) || 0 !== e.button || (Ae('play'), g(Lu.Prev));
                                },
                                onMouseUp: p,
                                ref: s,
                                onMouseEnter: v,
                ...
                engine.whenReady.then(() => {
                    U().render(
                        o().createElement(O, null, o().createElement(Bu, null, o().createElement(tn, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [727], () => __webpack_require__(4720));
