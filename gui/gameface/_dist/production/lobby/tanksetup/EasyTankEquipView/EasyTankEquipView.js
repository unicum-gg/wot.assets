                                ...
                                ((u.style.transform = `translateX(${0 | d}px)`),
                                    ((e) => {
                                        if (r.current && o.current && c.current && _.current) {
                                            if (0 === e)
                                                return (
                                                    r.current.classList.add(le),
                                                    void o.current.classList.remove(le)
                                                );
                                            if (
                                                ((t = c.current),
                                                (u = _.current),
                                                ...
                                                return (
                                                    r.current.classList.remove(le),
                                                    void o.current.classList.add(le)
                                                );
                                            var t, u;
