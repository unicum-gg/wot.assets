(() => {
    var __webpack_modules__ = {
            3457: (e, u, t) => {
                ...
                const c = ({
                    ...
                    return (
                        (0, i.useEffect)(() => {
                            function e(e) {
                                C && null !== b.current && !b.current.contains(e.target) && f(!1);
                            }
                            return (
                ...
                const i = ['children'],
                    s = (e) => {
                        ...
                        const s = (0, a.useContext)(r.Y),
                            ...
                            f = { extraLarge: D, large: B, medium: b, small: g, extraSmall: C };
            ...
            9300: (e, u, t) => {
                    ...
                    ee = (0, c.Pi)(
                        ({
                            ...
                            const A = y().controls,
                                ...
                                C = (0, n.useCallback)(
                                    (e) => {
                                        (K(e), b === J.PlatoonCanMade && D(t, a));
                                    },
                                    [D, b, t, a],
                                ),
                                f = (0, n.useMemo)(() => ({ body: Q[b].tooltipBody }), [b]),
                                p = (0, n.useMemo)(
                                    () => ({
                                        playerId: t,
                                        userName: a,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        X[B].isButton
                                            ? r().createElement(
                                                  $.u5,
                                                  { mixClass: Z, disabled: X[B].isDisabled, onClick: g },
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        Q[b].isButton
                                            ? r().createElement(
                                                  $.u5,
                                                  { mixClass: Z, disabled: Q[b].isDisabled, onClick: C },
                                                  r().createElement('div', { className: s()(z, Q[b].icon) }),
                                              )
                                            : r().createElement('div', { className: s()(z, Q[b].icon) }),
                                    ),
                                ),
                ...
                const me = { [ae.default]: 'c_64x24', [ae.x48]: 'c_68x28' },
                    ...
                    Fe = ({
                        ...
                        const A = R.images.gui.maps.icons.library.badges.strips.$dyn(me[_]),
                            ...
                            B = u ? `[${u}]` : '',
                            b = s()(de.base, de[`base__${_}`], o && de.base__inverted),
                            g = s()(de.userName, E),
                            C = s()(de.clanTag, m),
                            f = e !== d,
                            p = l ? `${d}${B}` : d,
                        ...
                        return r().createElement('div', { className: b }, o ? w.reverse() : w);
                    };
                var he = t(2683);
                const De = {
                ...
                const ge = { [x.N.TabWindow]: be.Default, [x.N.LeaderBoard]: be.Default },
                                ...
                                r().createElement(
                                    'div',
                                    {
                                        className: s()(
                                            De.squad,
                                            De[`squad__${l}`],
                                            t && l === be.Default && De.squad__defaultAlly,
                                        ),
                ...
                (0, n.memo)(function (e) {
                    ...
                    return r().createElement(a.z, null, r().createElement(v, { options: i }, r().createElement(Ie, t)));
                });
            },
            5042: (e, u, t) => {
                'use strict';
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(9300));
