(() => {
    ...
    var __webpack_modules__ = {
            ...
            3415: (u, e, t) => {
                ...
                const c = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const c = e.contentId;
                    return c ? r().createElement(i.u, s({}, e, { contentId: c }), n) : r().createElement(o.t, e, n);
                };
            },
            6373: (u, e, t) => {
                t.d(e, { i: () => c });
                ...
                const s = R.views.common.tooltip_window.simple_tooltip_content,
                    c = (u) => {
                        ...
                        const d = (0, r.useMemo)(() => {
                            const u = Object.assign({}, A, { body: t, header: c, note: E, alert: l });
            ...
            2056: (u, e, t) => {
                ...
                const s = (u, e, t = {}, n = 0) => {
                    ...
                    c = (u) => {
                        ...
                        const g = (0, o.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            y = (0, o.useMemo)(() => m || (0, n.F)().resId, [m]),
                            k = (0, o.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (s(t, C, { isMouseEvent: !0, on: !0, arguments: i(r) }, y),
                                    v && v(),
                                      ...
                                      Object.assign(
                                          {
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((g.current.timeoutId = window.setTimeout(k, d ? 100 : 400)),
                                                          c && c(u),
                                                          O && O(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                                              ...
                                              onClick: ((u) => (e) => {
                                                  (!1 === D && x(), null == A || A(e), null == u || u(e));
                                              })(e.props.onClick),
                                              onMouseDown: ((u) => (e) => {
                                                  (!1 === D && x(), null == l || l(e), null == u || u(e));
                                              })(e.props.onMouseDown),
                                          },
                                          f,
                                      ),
            ...
            8246: (u, e, t) => {
                ...
                function a({ initializer: u = !0, rootId: e = 0, getRoot: t = o, context: a = 'model' } = {}) {
                    const i = new Map();
                    function s(u, e = 0) {
            ...
            3215: (u, e, t) => {
                ...
                const s = () => (u, e) => {
                    ...
                    return [
                        function ({ mode: s = 'real', options: c, children: E, mocks: l }) {
                            const A = (0, o.useRef)([]),
                                F = (t, o, a) => {
                                    var s;
                                    const c = i.U(o),
                                        ...
                                        _ = { mode: t, model: d, externalModel: E, cleanup: F };
                                    return {
                                        model: d,
                                ...
                                D = _[0],
                                B = _[1],
                                C = (0, o.useState)(() => F(s, c, l)),
                                p = C[0],
                                b = C[1];
                            return (
                                (0, o.useEffect)(() => {
                                    d.current ? b(F(D, c, l)) : (d.current = !0);
                                }, [l, D, c]),
                                (0, o.useEffect)(() => {
                                    B(s);
                                }, [s]),
                                (0, o.useEffect)(
                                    () => () => {
                                        (p.externalModel.dispose(), A.current.forEach((u) => u()));
                                    },
                                    [p],
                                ),
                                a().createElement(t.Provider, { value: p }, E)
                            );
                        },
                        () => (0, o.useContext)(t),
                    ];
            ...
            3618: (u, e, t) => {
                ...
                const F = s().memo(
                    ({
                        ...
                        customTooltipArgs: _,
                        targetId: D,
                        justifyContent: B = A.v2.FlexStart,
                        alignContent: C = A.v2.FlexStart,
                        truncateIdentify: p = A.YA,
                    }) => {
                        const b = (0, i.useRef)(null),
                            h = (0, i.useRef)({ height: 0, width: 0 }),
                            m = (0, i.useState)({ elementList: [], isTruncated: !1, isTruncateFinished: !1 }),
                            v = m[0],
                            w = m[1],
                            f = (0, i.useMemo)(() => (0, E.s)(u, n, { justifyContent: B }), [n, B, u]),
                            g = (0, i.useMemo)(() => {
                                if (F && v.isTruncated && (!n || !Object.values(n).find((u) => 'object' == typeof u)))
                                    return {
                            ...
                            }, [n, F, D, u, _, v.isTruncated]),
                            y = (0, i.useCallback)(
                                (u) => {
                                    ((h.current.width = u.contentRect.width),
                                        (h.current.height = u.contentRect.height));
                                    const e = (0, l.T)(b, f, h.current, p),
                                        n = e[0],
                                        r = e[1];
                                    (w({ elementList: n, isTruncated: r, isTruncateFinished: !0 }), t && t(r));
                                },
                                [t, p, f],
                            ),
                            k = (0, i.useMemo)(() => ({ justifyContent: B, alignContent: C }), [C, B]);
                        return (
                            (0, a.y)(b, y, d),
                            s().createElement(
                                'div',
                                ...
                                s().createElement('div', { className: c.Z.unTruncated, ref: b }, f),
                                s().createElement(
                                    o.l,
                                    {
                                        tooltipArgs: g,
                                        className: r()(
                                            c.Z.tooltip,
                                            c.Z[`tooltip__justify-${B}`],
                                            c.Z[`tooltip__align-${C}`],
                                        ),
                                    },
                                    s().createElement(
                                        'div',
                                        {
                                            className: r()(
                                                c.Z.truncated,
                                                !v.isTruncateFinished && d && c.Z.truncated__hide,
                                            ),
                                            style: k,
                                        },
                                        v.isTruncateFinished && d ? v.elementList : f,
                                    ),
                                ),
                            )
                        );
                ...
                const i = new RegExp('[฀-๿][ัำ-ฺ็-๎]*', 'gu'),
                    s = a.u6
                        ...
                        : (u, e) => {
                              ...
                              let o = 0;
                              for (; n; ) {
                                  const i = e.justifyContent === a.v2.FlexEnd ? n.index : t.lastIndex;
                    ...
                    c = (u, e = '', t) => {
                        ...
                        return (
                            (0, o.Z)(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    n.push({ blockType: a.kH.Word, colorTag: e, childList: s(u, t) });
                                },
                                (u) => {
                                    const t = u[0],
                                        r = a.aF[t.charAt(0)];
                            ...
                            (0, o.Z)(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof i || 'number' == typeof i
                                        ...
                                        : r.push({ blockType: a.kH.Binding, colorTag: t, childList: [i] });
                                },
                            ),
                            r
                        );
                    ...
                    l = (u, e) => {
                        ...
                        if (u.blockType === a.kH.NoBreakWrapper) (u.childList.push(n), t.push(u));
                        else {
                            const e = Object.assign({}, u, { childList: u.childList.splice(-1) });
                            (u.childList.length > 0 && t.push(u),
                                t.push({ blockType: a.kH.NoBreakWrapper, colorTag: '', childList: [e, n] }));
                        }
                            ...
                            return (
                                u.forEach((u) => {
                                    u.blockType === a.kH.NoBreakSymbol
                                        ? ((t = !0), e.push(...l(e.pop(), u)))
                                        : (t ? e.push(...l(e.pop(), u)) : e.push(u), (t = !1));
                                }),
                                e
                            );
                        })(
                            ...
                            u.childList.forEach((i, s) => {
                                ...
                                if ((0, r.dz)(i)) {
                                    const u = i,
                                        ...
                                        r = o(u, t, c);
                                    a.push(...r);
                                } else a.push(e({ elementList: [i], textBlock: u, key: c }));
                            }),
                            a
                        );
                    },
                                ...
                                e.push(
                                    ...((u, e) => {
                                        const t = [],
                                            ...
                                            s = o(u, i, e);
                                        return (
                                            a === r.kH.NoBreakWrapper
                                                ? t.push(i({ elementList: s, textBlock: u, key: `${e}` }))
                                                : t.push(...s),
                                            t
                                        );
                                    })(u, t),
            ...
            131: (u, e, t) => {
                ...
                const a = (u, e) => !u || u.offsetTop + u.offsetHeight > e,
                    i = (u, e) => u.offsetLeft + u.offsetWidth - e,
                    s = (u, e, t) => {
                    ...
                    c = (u, e, t, n, a, i) => {
                        ...
                        for (let A = t; A >= 0; A--) {
                            const t = u[A],
                                F = Number(u[A].getAttribute(o.bF));
                            if (F === o.kH.LineBreak || F === o.kH.NewLine || F === o.kH.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const F = d.slice(0, d.length - c) + i,
                                    _ = e[A];
                                ((l = r().cloneElement(_, _.props, F)), (E = A));
                                break;
                            }
                            {
                                const u = t.children,
                                    o = e[A],
                                    s = o.props.children,
                                    F = c(u, s, u.length - 1, n, a, i),
                                    _ = F[0],
                                    D = F[1];
                                if (!(_ < 0)) {
                                    const u = s.slice(0, _);
                                    ((l = r().cloneElement(o, o.props, u, D)), (E = A));
                                    break;
                                }
                                a -= d.length;
                            }
                    ...
                    E = (u, e, t, n = o.YA) => {
                        ...
                        if (d < 0) return [r, !1];
                        const _ = c(F, r, d, l, n.length, n),
                            D = _[0],
                            B = _[1];
                        return (B && (r.splice(D, 1, B), r.splice(D + 1)), [r, !0]);
                    };
            },
            9053: (u, e, t) => {
                let n, r, o;
                ...
                const a = (u) => void 0 !== u.childList,
                    i = '...',
                    s = 'data-block-type',
                    c = { [o.NBSP]: n.NoBreakSymbol, [o.ZWNBSP]: n.NoBreakSymbol, [o.NEW_LINE]: n.LineBreak },
                    E = 'th',
                    l = ['zh_cn', 'zh_sg', 'zh_tw', 'ja', E].includes(R.strings.settings.LANGUAGE_CODE().toLowerCase());
            },
            597: (u, e, t) => {
                t.d(e, { IY: () => A });
                var n = t(6483),
                ...
                const E = (u) => ({ color: `#${u}` }),
                    l = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? s.Z[n]
                                ? a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: r()(c.Z.word, s.Z[n]) },
                                      u,
                                  )
                                : a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: c.Z.word, style: E(n) },
                                      u,
                                  )
                            : a().createElement(
                                  'span',
                    ...
                    A = {
                        [i.kH.Word]: l,
                        [i.kH.NoBreakSymbol]: l,
                        [i.kH.Binding]: ({ elementList: u, textBlock: e, key: t }) =>
                            a().createElement(
                                'span',
                                { key: t, 'data-block-type': e.blockType },
                                u.map((u) => a().createElement(a().Fragment, { key: t }, u)),
                            ),
                        [i.kH.LineBreak]: ({ key: u }) =>
                            a().createElement('span', {
                                key: u,
                                'data-block-type': i.kH.LineBreak,
                                className: c.Z.lineBreak,
                            }),
                        [i.kH.NewLine]: ({ elementList: u, key: e }) =>
                            a().createElement(
                                'span',
                                { key: e, 'data-block-type': i.kH.NewLine, className: c.Z.newLine },
                                u,
                            ),
                        [i.kH.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            a().createElement(
                                'span',
                                { key: e, 'data-block-type': i.kH.NoBreakWrapper, className: c.Z.noBreakWrapper },
                                u,
                            ),
                    };
            },
                ...
                const F = s().memo(function ({
                    ...
                    return s().createElement(
                        'div',
                        {
                            ...
                            onClick: () => {
                                !n && _ && (a.O.sound.play.click(), _());
                            },
                            onMouseEnter: () => {
                                !n && _ && (a.O.sound.play.highlight(), C(!0));
                            },
                            onMouseLeave: () => {
                                (C(!1), h(!1));
                            },
                        ...
                        s().createElement('div', { className: E.border }),
                        s().createElement('div', { className: E.shadow }),
                        F && s().createElement('div', { className: E.hintAnim }),
                        s().createElement(
                            'div',
                            ...
                            e === l.Secondary
                                ...
                                : s().createElement('div', { className: E.primaryCaption }, u),
                        ),
                    );
                });
            },
            7621: (u, e, t) => {
                ...
                const E = i().memo(function ({ size: u, gray: e = !1, isTooltipEnable: t = !1, className: n }) {
                    return i().createElement(
                        o.u,
                        { contentId: R.views.halloween.lobby.tooltips.KeyTooltip('resId'), isEnabled: t },
                        i().createElement('div', {
                            className: r()(s.Z.base, s.Z[`base__${u}`], e && s.Z.base__gray, n),
                        }),
                    );
                });
            },
            5508: (u, e, t) => {
                ...
                var n = t(6483),
                    ...
                    s = t(3149),
                    c = t(4892);
                const E = ['type', 'shadow', 'grunge', 'className'];
                function l() {
                    return (
                        (l = Object.assign
                            ? Object.assign.bind()
                ...
                const A = (u) => {
                    ...
                    return i().createElement(
                        'div',
                        { className: r()(s.Z.base, s.Z[`base__${e}`], F), lang: R.strings.settings.LANGUAGE_CODE() },
                        i().createElement(o.w, l({ classMix: r()(s.Z.layer0, n && s.Z.layer0__shadow) }, d)),
                        (e === c.y.Heading || e === c.y.MetaHeading) &&
                            i().createElement(
                                i().Fragment,
                                null,
                                i().createElement(o.w, l({ classMix: s.Z.layer1 }, d)),
                                i().createElement(o.w, l({ classMix: s.Z.layer2 }, d)),
                            ),
                        i().createElement(o.w, l({ classMix: s.Z.layer3 }, d)),
                        A && i().createElement(o.w, l({ classMix: s.Z.layer4 }, d)),
                    );
                };
            },
            4892: (u, e, t) => {
            ...
            6131: (u, e, t) => {
                ...
                const l = (u) => u,
                    A = (u, e) => {
                        ...
                        return e ? c.Z5.getNumberFormat(t, c.B3.INTEGRAL) : t;
                    },
                    F = (0, n.memo)(function ({
                        renderText: u = (u) => r().createElement(E.animated.div, null, u),
                        prefix: e = '',
                        currentNumber: t,
                        previousNumber: n = 0,
                        delay: o,
                        ...
                        return r().createElement(
                            'div',
                            { className: a()('NumberAnimation_base_9f', s) },
                            e,
                            c ? u(A(t, F)) : r().createElement(E.animated.div, null, u(D.val.to((u) => A(u, F)))),
                        );
                    });
                var d = t(2056),
                    _ = t(3138),
                ...
                const C = (0, t(3215).q)()(
                    ...
                    p = C[0],
                    b = C[1],
                    h = 'KeysViewApp_blink_22',
                    m = (0, D.Pi)(({ className: u }) => {
                        const e = b(),
                            t = e.model,
                            o = e.controls,
                            E = t.root.get(),
                            ...
                            g = l > 9999,
                            y = g
                                ? `${c.Z5.getNumberFormat(9999, c.B3.INTEGRAL)}+`
                                : c.Z5.getNumberFormat(l, c.B3.INTEGRAL);
                        return (
                            (0, n.useEffect)(() => {
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    {
                                        className: a()(
                                            'KeysViewApp_base_bb',
                                            C && 'KeysViewApp_base__hover_77',
                                            v && 'KeysViewApp_base__active_75',
                                            u,
                                        ),
                                        onClick: () => {
                                            A || (_.O.sound.play.click(), o.click());
                                        },
                                        onMouseEnter: () => {
                                            A || (_.O.sound.play.sound(B.HX), p(!0));
                                        },
                                        onMouseLeave: () => {
                                            (_.O.sound.play.sound(B.RZ), p(!1), w(!1));
                                        },
                                        onMouseDown: () => {
                                            A || w(!0);
                                        },
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: a()(h, !A && !v && !C && 'KeysViewApp_blink__anim_f2') },
                                        r().createElement(
                                            'div',
                                            {
                                                className: a()(
                ...
                r().memo(function (u) {
                    const e = (0, n.useMemo)(() => ({ rootId: R.views.halloween.lobby.widgets.KeysView('resId') }), []);
                    return r().createElement(p, { options: e }, r().createElement(m, u));
                });
            },
            824: (u, e, t) => {
                t.d(e, { Ar: () => o, HX: () => n, RZ: () => r });
                const n = 'ev_hw_hangar_ui_shop_keys_highlight_on',
                    r = 'ev_hw_hangar_ui_shop_keys_highlight_off',
                    o = 'ev_hw_hangar_ui_shop_keys_anim';
            },
            8055: (u, e, t) => {
                t.d(e, { Z: () => n });
                const n = {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(6131));
