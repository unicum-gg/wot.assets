(() => {
    var __webpack_modules__ = {
            ...
            7699: (u, e, t) => {
                ...
                const l = i.O.client.getSize('rem'),
                    _ = l.width,
                    s = l.height,
                    B = Object.assign({ width: _, height: s }, o(_, s, F)),
                    ...
                    C = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.smallWidth && s) return A(e, t, b);
                ...
                const d = (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(c),
                        ...
                        A = (0, r.useCallback)((u, e) => {
                            ...
                            n(Object.assign({ width: t, height: r }, o(t, r, F)));
                        }, []);
                    (((u) => {
                ...
                const M = {
                    ...
                    O = (u) => {
                        ...
                        const E = w(),
                            ...
                            A = E.mediaHeight,
                            i = E.mediaSize;
                        return a().createElement('div', L({ className: h()(t, M[n], T[A], y[i]) }, r), e);
                    },
                    H = ['children'],
                    P = (u) => {
                        let e = u.children,
                ...
                const I = (u, e, t) => {
                    ...
                    W = (u, e, t = N.left) => u.split(e).reduce(t === N.left ? I : k, []),
                    G = (() => {
                        const u = new RegExp(
                ...
                const $ = (u = 0, e = 1, t, a, E = !1) => {
                        ...
                        return (
                            ...
                            (0, r.useEffect)(() => {
                                const r = Date.now(),
                                    n = setInterval(() => {
                                        const e = u + (E ? 1 : -1) * Math.floor((Date.now() - r) / 1e3);
                                        void 0 !== t && (E ? e >= t : e <= t)
                                            ? (i(t), a && a(), clearInterval(n))
                                            : i(e);
                                    }, 1e3 * e);
                                return () => {
                                    clearInterval(n);
                    ...
                    K = ({
                        ...
                        return a().createElement(
                            ...
                            ((u, e, t) => {
                                const r = e < 0,
                                    a = Math.abs(e),
                                    E = Math.floor(a / 3600).toString(),
                                    n = Math.floor((a % 3600) / 60).toString(),
                                    A = Math.floor(a % 60).toString(),
                                    i = u
                                        .replace('%HH', E.padStart(2, '0'))
                                        .replace('%H', t && Number(n) >= 30 ? (Number(E) + 1).toString() : E)
                                        .replace('%MM', n.padStart(2, '0'))
                                        .replace('%M', n.toString())
                ...
                const Y = ['xl', 'lg', 'md', 'sm', 'xs'],
                    V = (u) => u.includes('_') && ((u) => Y.includes(u))(u.split('_').at(-1)),
                ...
                const ru = {
                    ...
                    nu = J((u) => {
                        let e = u.className,
                            ...
                            R = u.shrink,
                            H = u.flex,
                            P = void 0 === H ? (O || R ? `${O ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : H,
                            N = u.style,
                            I = u.children,
                            k = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, E, i, D, l, s, N, P, L, C, y, f, S]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return a().createElement('div', tu({ className: h()(uu.base, ...U, e), style: G }, k), I);
                    }),
                    Au = ({ binding: u, text: e = '', classMix: t, alignment: E = N.left }) =>
                        null === e
                ...
                const _u = Object.keys(Fu()),
                    ...
                    du = J((u) => {
                        ...
                        return a().createElement(
                            ...
                            lu(
                                {
                                    className: h()(Du.base, t && Du[t], p, E),
                                    style: g,
                                    mt: !0 === F ? mu[t || 'paragraph-P16'].mt : F,
                                    mr: !0 === o ? mu[t || 'paragraph-P16'].mr : o,
                ...
                function pu(u = gu.n.NONE, e = hu, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== gu.n.NONE)
                            return (
                ...
                const Mu = (0, r.memo)(
                    ({
                        ...
                        const l = (0, r.useState)(!1),
                            ...
                            d = h()(wu.bgOverlay, wu[`bgOverlay__${D}`], {
                                [wu.bgOverlay__hover]: c,
                                [wu.bgOverlay__active]: _,
                                [wu.bgOverlay__disabled]: e,
                            }),
                            g = h()(wu.bgImage, wu[`bgImage__${D}`], {
                                [wu.bgImage__hover]: c,
                                [wu.bgImage__active]: _,
                                [wu.bgImage__disabled]: e,
                            }),
                            p = h()(wu.content, wu[`content__${D}`], null == o ? void 0 : o.content),
                            b = h()(wu.bgLines, wu[`bgLines__${D}`], { [wu.bgLines__disabled]: e });
                        return a().createElement(
                            'div',
                            { className: E },
                            a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    i &&
                                        a().createElement('div', {
                                            className: h()(wu.btnIcon, wu.btnIcon__left),
                                            style: { backgroundImage: `url(${i})` },
                                        }),
                                    a().createElement(du, { text: u }),
                                    n &&
                                        a().createElement('div', {
                                            className: h()(wu.btnIcon, wu.btnIcon__right),
                ...
                const Ru = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: n, mocks: A }) {
                                const F = (0, r.useRef)([]),
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : A(e),
                                                            a = yu.observable.box(r, { equals: Tu });
                                                        return (
                                                            'real' === u &&
                                                                n.subscribe(
                                                                    (0, yu.action)((u) => a.set(u)),
                                                                    e,
                                                                ),
                                                            a
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const a = e.reduce(
                                                                (u, e) => ((u[e] = yu.observable.box(r[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                                    ...
                                    _ = l[0],
                                    s = l[1],
                                    B = (0, r.useState)(() => D(u, E, A)),
                                    c = B[0],
                                    m = B[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        o.current ? m(D(_, E, A)) : (o.current = !0);
                                    }, [A, _, E]),
                                    (0, r.useEffect)(() => {
                                        s(u);
                                    }, [u]),
                    ...
                    Pu = Hu[0],
                    Nu = Hu[1],
                    Iu = R.images.portal.gui.maps.icons,
                    ku = R.strings.portal_battle_queue,
                    Wu = R.strings.portal_lobby.complexity.level,
                    Gu = (0, bu.observer)(() => {
                        const u = Nu(),
                            e = u.model,
                            t = u.controls,
                            E = w().mediaSize,
                            n = e.root.get().complexity,
                            A = (0, r.useCallback)(() => {
                                t.onLeave();
                            }, [t]);
                        !(function ({
                        ...
                        const F = ((u) => {
                                switch (u) {
                                    case vu.MEDIUM:
                                        return { img: Iu.complexity.selected.c_2(), text: Wu.c_2() };
                                    case vu.HARD:
                                        return { img: Iu.complexity.selected.c_3(), text: Wu.c_3() };
                                    case vu.EXPERT:
                                        return { img: Iu.complexity.selected.c_4(), text: Wu.c_4() };
                                    case vu.MASTER:
                                        return { img: Iu.complexity.selected.c_5(), text: Wu.c_5() };
                                    default:
                                        return { img: Iu.complexity.selected.c_1(), text: Wu.c_1() };
                                }
                            })(n),
                            D = (0, r.useMemo)(() => (E < v.ExtraLarge ? Su.Medium : Su.Large), [E]);
                        return a().createElement(
                            'div',
                            { className: 'App_base_2b' },
                            a().createElement(
                                'div',
                                { className: 'App_complexityBlock_55' },
                                a().createElement(
                                    'div',
                                    { className: 'App_complexityIconBlock_86' },
                                    a().createElement('div', {
                                        className: 'App_complexityIcon_8c',
                                        style: { backgroundImage: `url(${F.img})` },
                                    }),
                                    a().createElement('div', {
                                        className: 'App_complexityIconSmoke_a5',
                                        style: { backgroundImage: `url(${Iu.complexity.difficultSmoke()})` },
                                    }),
                                ),
                                a().createElement(du, { className: 'App_complexityText_5d', text: F.text }),
                            ),
                            a().createElement(
                                'div',
                                { className: 'App_queueInfoBlock_46' },
                                a().createElement(
                                    'div',
                                    { className: 'App_timerBlock_ff' },
                                    a().createElement(du, { className: 'App_alliesText_98', text: ku.allies() }),
                                    a().createElement(K, { isCountUp: !0, className: 'App_timerText_d1' }),
                                ),
                                a().createElement(Mu, {
                                    onClick: A,
                                    className: 'App_buttonPadding_b6',
                                    title: ku.quitButton(),
                                    size: D,
                                }),
                                a().createElement(du, { className: 'App_longSearchText_54', text: ku.longSearch() }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    n().render(
                        a().createElement(Pu, null, a().createElement(P, null, a().createElement(Gu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(7699));
