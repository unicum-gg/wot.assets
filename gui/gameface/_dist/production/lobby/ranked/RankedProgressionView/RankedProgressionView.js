(() => {
    var __webpack_modules__ = {
            ...
            336: (e, u, t) => {
                ...
                const jn = ['engravings', 'backgrounds'],
                        ...
                        e.map((e, u) =>
                            s().createElement(
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        Ar,
                                        Dr({ size: t ? Ln.Small : Ln.Big, image: t ? e.smallImage : e.bigImage }, e),
                                    ),
                                ),
                            ),
                        ),
                ...
                const Cr = 'Stage_base_90',
                    ...
                    vr = (0, j.Pi)(({ className: e, totalCount: u, earnedCount: t }) => {
                        const n = ((e) => {
                                switch (!0) {
                                    case e < b.Medium:
                                        return gr.Small;
                    ...
                    br = (0, j.Pi)(({ className: e, rank: u, index: t }) => {
                        const n = oe(),
                            r = n.model,
                            i = n.controls,
                            o = r.root.get(),
                            ...
                            b = ((e) =>
                                e.map(({ value: e }) => {
                                    ...
                                    return {
                                        name: u || t,
                                        smallImage: Vn(e, Ln.Small),
                                        bigImage: Vn(e, Ln.Big),
                                        special: r,
                                        value: n,
                                        valueType:
                                            ((i = t),
                    ...
                    xr = (0, j.Pi)(function ({ className: e }) {
                        var u;
                        const t = oe().model,
                            ...
                            ((0, a.useEffect)(() => {
                                ...
                                (0, a.useEffect)(() => {
                                    ...
                                    const e = o.O.client.events.mouse.move(([e, t]) => {
                                            ...
                                            const c = 'inside' === t ? e.clientX : e.clientX - o.offsetLeft,
                                                E = d.positionFrom - c,
                                        ...
                                        t = o.O.client.events.mouse.up(function () {
                                            m({ type: 'scrollingToEnd' });
                                        });
                                    return () => {
                                        (e(), t());
                                    };
                                }, [l.scrollPosition, i, n, d, s, r, u]),
                                (0, a.useEffect)(() => {
                    ...
                    Mr = 'EfficiencyBlock_container_23',
                    yr = 'EfficiencyBlock_icon_a3',
                    Pr = 'EfficiencyBlock_efficiency_f2',
                    Lr = 'EfficiencyBlock_description_f7',
                    Nr = ({ type: e, value: u }) => {
                        const t = {
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                ...
                                s().createElement(
                                    'div',
                                    { className: Mr },
                                    s().createElement('div', { className: yr, style: t }),
                                    s().createElement(qe, {
                                        text: u,
                                        className: Pr,
                                        color: 'WHITE',
                    ...
                    Hr = (0, j.Pi)(({ isProgressionStateSelected: e, onHandleProgressionStateChange: u }) =>
                        s().createElement(
                            'div',
                            { className: Lt.base },
                            ...
                            e
                                ? s().createElement(Ir, { className: Lt.statistics })
                                : s().createElement(
                                      'div',
