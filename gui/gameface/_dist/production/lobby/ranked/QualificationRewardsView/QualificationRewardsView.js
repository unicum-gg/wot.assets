(() => {
    var __webpack_modules__ = {
            ...
            36: (e, u, t) => {
                ...
                const L = {
                    ...
                    M = (e) => {
                        ...
                        const a = T(),
                            ...
                            s = a.mediaHeight,
                            o = a.mediaSize;
                        return n().createElement('div', x({ className: p()(t, L[i], y[s], O[o]) }, r), u);
                    },
                    I = ['children'];
                const k = (e) => {
                    let u = e.children,
                ...
                const _e = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    De = (0, r.memo)(
                        ({
                            ...
                            return _
                                ...
                                : n().createElement(
                                      'div',
                                      { className: _e, style: C },
                                      n().createElement(
                                          'div',
                                          { style: F ? g : B, className: Fe },
                ...
                const Le = (0, r.memo)((e) => {
                    ...
                    return (
                        (a.current.from = s),
                        n().createElement(Pe, xe({}, t, { onEndAnimation: i, key: `${s}-${t.to}`, from: s }))
                    );
                });
                function ye() {
                    return (
                ...
                const Oe = (0, r.memo)(
                        ({
                            ...
                            return i.withStack
                                ...
                                : n().createElement(Pe, ye({ key: `${a}-${u}` }, E));
                        },
                    ),
                    Me = (e) => ({
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Bu(t, m, { isMouseEvent: !0, on: !0, arguments: gu(n) }, w),
                                    B && B(),
                ...
                const Pu = ({ children: e, tooltipArgs: u, className: t }) => {
                        ...
                        if (u.header || u.body) return n().createElement(Su, u, r);
                        const a = u.contentId,
                            i = u.args,
                            s = null == i ? void 0 : i.contentId;
                        return a || s
                            ? n().createElement(Cu, Tu({}, u, { contentId: a || s }), r)
                            : n().createElement(wu, u, r);
                    },
                    Ru = {
                        base: 'Reward_base_ea',
                    ...
                    xu = ({
                        ...
                        return n().createElement(
                            'div',
                            { className: p()(Ru.base, Ru[`base__${r}`], l), style: o },
                            n().createElement(
                                Pu,
                                { tooltipArgs: c, className: Ru.tooltipWrapper },
                                n().createElement(
                                    n().Fragment,
                                    null,
                                    n().createElement(
                                        'div',
                                        { className: p()(Ru.image, null == E ? void 0 : E.image) },
                                        A &&
                                            n().createElement('div', {
                                                className: p()(Ru.highlight, null == E ? void 0 : E.highlight),
                                                style: {
                                        ...
                                        u &&
                                            n().createElement('div', {
                                                className: p()(Ru.icon, null == E ? void 0 : E.rewardIcon),
                                                style: { backgroundImage: `url(${u})` },
                                            }),
                                        m &&
                                            n().createElement('div', {
                                                className: p()(Ru.overlay, null == E ? void 0 : E.overlay),
                                                style: {
                            ...
                            t &&
                                n().createElement(
                                    ...
                                    { tooltipArgs: d },
                                    n().createElement('div', {
                                        className: p()(Ru.timer, null == E ? void 0 : E.periodicIcon),
                                    }),
                                ),
                        );
                    },
                    ...
                    Ou = 'RewardsList_reward_71',
                    Mu = 'RewardsList_reward__disabled_21',
                    Iu = 'RewardsList_rewardIcon_14',
                    ku = 'RewardsList_rewardInfo_1b';
                function Nu() {
                    return (
                        (Nu =
                            Object.assign ||
                ...
                const Uu = ({ battleBonuses: e, isCurrent: u, isDisabled: t, style: r }) => {
                                    ...
                                    Nu(
                                        {
                                            ...
                                            className: i,
                                            classNames: { rewardIcon: Iu, info: ku },
                                        },
                                        e.value,
                                    ),
                                );
                        ...
                        return (
                            ...
                            n().createElement(
                                ...
                                l.map(({ value: e }, u) =>
                                    n().createElement(
                                        'div',
                                        { key: u, className: Gu, style: $u(t, e.battlesCount) },
                                        n().createElement(Uu, {
                    ...
                    Yu = 'App_content_a7',
                    ju = () => n().createElement('div', { className: Yu }, n().createElement(qu, null));
                engine.whenReady.then(() => {
                    i().render(
                        n().createElement(k, null, n().createElement(ju, null)),
