    ...
    var __webpack_modules__ = {
            ...
            254: (u, e, A) => {
                        ...
                        B(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    E = s(u);
                                v.current = c.addCallback(E, A, o, e === l.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== l.None)
                                return () => {
                                    c.removeCallback(v.current, o);
                                };
                        }, [o, e]),
                        _
                    );
                ...
                const h = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    b = (u, e, A = w.left) => u.split(e).reduce(A === w.left ? f : g, []),
                    y = (() => {
                        const u = new RegExp(
                    ...
                    T = (u, e = w.left) => {
                        ...
                        return ((u, e = w.left) => {
                            ...
                            const E =
                                ...
                                F = h(u);
                            return b(F, /( )/, e).forEach((u) => (A = A.concat(b(u, E, w.left)))), A;
                        })(u, e);
                    },
                    x = 'FormatText_base_d0',
                    k = ({ binding: u, text: e = '', classMix: A, alignment: t = w.left, formatWithBrackets: D }) => {
                        ...
                        return F().createElement(
                            ...
                            n.split('\n').map((e, D) =>
                                F().createElement(
                                    'div',
                                    { className: m()(x, A), key: `${e}-${D}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : T(u, e))))(
                                        e,
                                        t,
                                        u,
                    ...
                    P = 'RoleAction_base_25',
                    N = 'RoleAction_image_34',
                    M = 'RoleAction_description_53',
                    S = ({ image: u, description: e }) => {
                        const A = (0, E.useMemo)(() => ({ backgroundImage: `url(${u})` }), [u]);
                        return F().createElement(
                            'div',
                            { className: P },
                            F().createElement('div', { className: N, style: A }),
                            F().createElement('div', { className: M }, e),
                        );
                    },
                    L = 'Content_base_2d',
                    I = 'Content_title_09',
                    ...
                    Y = 'Content_roleDescriptionTitle_47',
                    Z = 'Content_roleDescriptionText_ef',
                    X = 'Content_footer_38',
                    Q = 'Content_footerImage_63',
                    J = 'Content_footerText_d2',
                    uu = () => {
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                F().createElement('div', { className: Z }, R.strings.menu.roleExp.roleDescr.$dyn(e)),
                            ),
                            D &&
                                0 !== t.items.length &&
                                F().createElement(
                                    ...
                                    F().createElement(
                                        'div',
                                        { className: X },
                                        F().createElement('div', { className: Q, style: B }),
                                        F().createElement(
                                            'div',
                                            { className: J },
                ...
                const Du = F().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            F().createElement(
                                'div',
                                tu({}, r, {
                                    className: m()(Eu.base, Eu[`base__theme-${n}`], t),
                                    ref: function (u) {
                                        (o.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                    },
                                }),
                                F().createElement('div', { className: Eu.decorator }, A),
                            )
                        );
                    }),
                    nu = () => F().createElement(Du, null, F().createElement(uu, null)),
