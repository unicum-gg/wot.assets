(() => {
    ...
    var __webpack_modules__ = {
            99: (u, e, A) => {
                ...
                var t = {};
                A.r(t), A.d(t, { getBgUrl: () => O, getTextureUrl: () => b });
                var D = {};
                function n(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                function f(u) {
                    let e = '';
                    for (let A = g.length - 1; A >= 0; A--) for (; u >= g[A]; ) (e += h[A]), (u -= g[A]);
                    return e;
                }
                ...
                const Au = (() => {
                    ...
                    Eu = f,
                    Fu = Object.keys(y).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === y[e]), u), {}),
                    tu = {
                        set: (u, e) => {
            ...
            10: (u, e, A) => {
                ...
                const n = (u = 1) => {
                        ...
                        return { callerUrl: F, caller: A, stack: e, resId: E };
                    },
                ...
                const C = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    a = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, A) => {
                                const E = r(`${u}.${A}`, window);
                                return C(E) ? e(u, A, E) : `${u}.${A}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    s = (u) => {
                        const e = ((u) => {
                                const e = n(),
                        ...
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const F = r(i(A, `${e}.${E}`), window);
                                    return C(F) ? (u.push(F.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        B(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    E = s(u);
                                p.current = l.addCallback(E, A, i, e === d.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== d.None)
                                return () => {
                                    l.removeCallback(p.current, i);
                                };
                        }, [i, e]),
                        v
                    );
                ...
                const g = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    O = (u, e, A = p.left) => u.split(e).reduce(A === p.left ? f : b, []),
                    y = (() => {
                        const u = new RegExp(
                    ...
                    x = (u, e = p.left) => {
                        ...
                        return ((u, e = p.left) => {
                            ...
                            const E =
                                ...
                                F = g(u);
                            return O(F, /( )/, e).forEach((u) => (A = A.concat(O(u, E, p.left)))), A;
                        })(u, e);
                    },
                    k = 'FormatText_base_d0',
                    P = ({ binding: u, text: e = '', classMix: A, alignment: t = p.left, formatWithBrackets: D }) => {
                        ...
                        return F().createElement(
                            ...
                            n.split('\n').map((e, D) =>
                                F().createElement(
                                    'div',
                                    { className: v()(k, A), key: `${e}-${D}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : x(u, e))))(
                                        e,
                                        t,
                                        u,
                    ...
                    N = 'RoleAction_base_25',
                    M = 'RoleAction_image_34',
                    ...
                    eu = () => {
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                'div',
                                { className: V, style: n },
                                F().createElement('div', { className: U, style: r }),
                                F().createElement(P, {
                ...
                const nu = F().forwardRef(function (u, e) {
                        let A = u.children,
                            t = u.className,
                            D = u.theme,
                        ...
                        return (
                            (C = () => {
                                B.run(() => {
                                    ...
                                    const e = u.scrollWidth,
                                        A = u.scrollHeight;
                                    Au.O.view.resize(e, A);
                                    const E = window.getComputedStyle(u);
                                    Au.O.view.setSidePaddingsRem({
                            ...
                            F().createElement(
                                'div',
                                Du({}, r, {
                                    className: v()(Fu.base, Fu[`base__theme-${n}`], t),
                                    ref: function (u) {
                                        (o.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                    },
                                }),
                                F().createElement('div', { className: Fu.decorator }, A),
                            )
                        );
                    }),
                    ru = () => F().createElement(nu, null, F().createElement(eu, null)),
                    Bu = document.createElement('div');
                (window.onload = () => document.body.appendChild(Bu)), D().render(F().createElement(ru, null), Bu);
            },
            363: (u) => {
                u.exports = React;
            },
