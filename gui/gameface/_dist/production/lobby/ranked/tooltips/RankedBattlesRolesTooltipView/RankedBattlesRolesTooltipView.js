(() => {
    ...
    var __webpack_modules__ = {
            ...
            364: (u, e, A) => {
                ...
                const h = F.instance,
                    g = {
                        ...
                        sendMoveEvent: (u) => m(B.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: v,
                        sendClosePopOverEvent: () => m(B.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            m(B.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
                        sendShowPopOverEvent: (u, e, A, E, F = R.invalid('resId'), t) => {
                            const D = s.O.view.getViewGlobalPosition(),
                                ...
                                i = n.height,
                                a = {
                                    x: s.O.view.pxToRem(r) + D.x,
                                    y: s.O.view.pxToRem(C) + D.y,
            ...
            254: (u, e, A) => {
                ...
                var C = A(364);
                const o = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    i = (u, e) => (u.length > 0 ? `${u}.${e}` : e),
                    a = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, A) => {
                                const E = B(`${u}.${A}`, window);
                                return o(E) ? e(u, A, E) : `${u}.${A}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    s = (u) => {
                        const e = ((u) => {
                                const e = n(),
                                ...
                                return { modelPrefix: F, modelPath: i(F, u || ''), resId: E };
                            })(),
                            A = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const F = B(i(A, `${e}.${E}`), window);
                                    return o(F) ? (u.push(F.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        r(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    E = s(u);
                                v.current = c.addCallback(E, A, C, e === l.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== l.None)
                                return () => {
                                    c.removeCallback(v.current, C);
                                };
                        }, [C, e]),
                        d
                    );
                ...
                const w = (u, e, A) => {
                    ...
                    h = (u, e, A = v.left) => u.split(e).reduce(A === v.left ? w : p, []),
                    g = (() => {
                        const u = new RegExp(
                        ...
                        return f.includes(A)
                            ...
                            : ((u, e = v.left) => {
                                  ...
                                  const E =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return (h(F, /( )/, e).forEach((u) => (A = A.concat(h(u, E, v.left)))), A);
                              })(u, e);
                    },
                    O = 'FormatText_base_d0',
                    y = ({ binding: u, text: e = '', classMix: A, alignment: t = v.left }) =>
                        null === e
                            ...
                            : F().createElement(
                                  ...
                                  e.split('\n').map((e, D) =>
                                      F().createElement(
                                          'div',
                                          { className: m()(O, A), key: `${e}-${D}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : b(u, e))))(e, t, u).map((u, e) =>
                                              F().createElement(E.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              ),
                    T = 'RoleAction_base_25',
                    P = 'RoleAction_image_34',
                    x = 'RoleAction_description_53',
                    M = ({ image: u, description: e }) => {
                        const A = (0, E.useMemo)(() => ({ backgroundImage: `url(${u})` }), [u]);
                        return F().createElement(
                            'div',
                            { className: T },
                            F().createElement('div', { className: P, style: A }),
                            F().createElement('div', { className: x }, e),
                        );
                    },
                    N = 'Content_base_2d',
                    k = 'Content_title_09',
                    S = 'Content_titleRoleIcon_19',
                    L = 'Content_titleRoleName_4d',
                    U = 'Content_titleRoleGroupName_aa',
                    I = 'Content_separator_e5',
                    V = 'Content_roleActions_d8',
                    z = 'Content_roleActionsTitle_b6',
                    K = 'Content_roleActionsContent_f1',
                    W = 'Content_roleActionsItem_a2',
                    q = 'Content_roleActionsDisabled_14',
                    j = 'Content_roleDescription_5f',
                    G = 'Content_roleDescriptionTitle_47',
                    H = 'Content_roleDescriptionText_ef',
                    $ = 'Content_footer_38',
                    Y = 'Content_footerImage_63',
                    Z = 'Content_footerText_d2',
                    X = () => {
                        const u = _('model', l.None),
                            ...
                            n = (0, E.useMemo)(() => ({ backgroundImage: `url(${A})` }), [A]),
                            B = (0, E.useMemo)(
                                () => ({
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                'div',
                                { className: k, style: n },
                                F().createElement('div', { className: S, style: B }),
                                F().createElement(y, {
                            ...
                            F().createElement('div', { className: I }),
                            F().createElement(
                                'div',
                                { className: j },
                                F().createElement(
                                ...
                                F().createElement('div', { className: H }, R.strings.menu.roleExp.roleDescr.$dyn(e)),
                            ),
                            D &&
                                0 !== t.items.length &&
                                F().createElement(
                                    ...
                                    F().createElement(
                                        'div',
                                        { className: $ },
                                        F().createElement('div', { className: Y, style: r }),
                                        F().createElement(
                                            'div',
                                            { className: Z },
                ...
                const Eu = F().forwardRef(function (u, e) {
                        let A = u.children,
                            t = u.className,
                            D = u.theme,
                        ...
                        return (
                            ...
                            F().createElement(
                                'div',
                                Au({}, B, {
                                    className: m()(uu.base, uu[`base__theme-${n}`], t),
                                    ref: function (u) {
                                        ((C.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                    },
                                }),
                                F().createElement('div', { className: uu.decorator }, A),
                            )
                        );
                    }),
                    Fu = () => F().createElement(Eu, null, F().createElement(X, null)),
                    tu = document.createElement('div');
                ((window.onload = () => document.body.appendChild(tu)), D().render(F().createElement(Fu, null), tu));
            },
        },
        ...
        (__webpack_require__.O = (u, e, A, E) => {
            if (!e) {
                ...
                for (B = 0; B < deferred.length; B++) {
                    for (var [e, A, E] = deferred[B], t = !0, D = 0; D < e.length; D++)
                        (!1 & E || F >= E) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [976], () => __webpack_require__(254));
