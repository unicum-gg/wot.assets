(() => {
    ...
    var __webpack_modules__ = {
            768: (u, e, A) => {
                ...
                var t = {};
                A.r(t), A.d(t, { getBgUrl: () => f, getTextureUrl: () => h });
                var D = {};
                function n(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            10: (u, e, A) => {
                ...
                const f = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    O = (u, e, A = p.left) => u.split(e).reduce(A === p.left ? g : b, []),
                    y = (() => {
                        const u = new RegExp(
                    ...
                    W = 'Content_separator_e5',
                    $ = 'Content_roleActions_d8',
                    q = 'Content_roleActionsTitle_b6',
                    G = 'Content_roleActionsContent_f1',
                    ...
                    eu = () => {
                        ...
                        return F().createElement(
                            ...
                            F().createElement('div', { className: W }),
                            F().createElement(
                                'div',
                                { className: Y },
                                F().createElement(
