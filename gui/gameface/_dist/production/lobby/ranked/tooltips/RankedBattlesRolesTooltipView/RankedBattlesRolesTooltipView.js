    ...
    var __webpack_modules__ = {
            ...
            254: (u, e, A) => {
                ...
                const C = (u, e, A) => {
                    ...
                    i = (u, e, A = r.left) => u.split(e).reduce(A === r.left ? C : o, []),
                    a = (() => {
                        const u = new RegExp(
                        ...
                        return s.includes(A)
                            ...
                            : ((u, e = r.left) => {
                                  ...
                                  const E =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return (i(F, /( )/, e).forEach((u) => (A = A.concat(i(u, E, r.left)))), A);
                              })(u, e);
                    },
                    l = 'FormatText_base_d0',
                    _ = ({ binding: u, text: e = '', classMix: A, alignment: t = r.left }) =>
                        null === e
                            ...
                            : F().createElement(
                                  ...
                                  e.split('\n').map((e, D) =>
                                      F().createElement(
                                          'div',
                                          { className: B()(l, A), key: `${e}-${D}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : c(u, e))))(e, t, u).map((u, e) =>
                ...
                const p = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    g = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, A) => {
                                const E = m(`${u}.${A}`, window);
                                return p(E) ? e(u, A, E) : `${u}.${A}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    f = (u) => {
                        const e = ((u) => {
                                const e = d(),
                                ...
                                return { modelPrefix: F, modelPath: h(F, u || ''), resId: E };
                            })(),
                            A = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const F = m(h(A, `${e}.${E}`), window);
                                    return p(F) ? (u.push(F.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const y = (u = 'model', e = O.Deep) => {
                            ...
                            v(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        E = f(u);
                                    i.current = b.addCallback(E, A, n, e === O.Deep);
                                }
                            }),
                            (0, E.useEffect)(() => {
                                if (e !== O.None)
                    ...
                    T = 'Content_base_2d',
                    P = 'Content_title_09',
                    x = 'Content_titleRoleIcon_19',
                    M = 'Content_titleRoleName_4d',
                    N = 'Content_titleRoleGroupName_aa',
                    k = 'Content_separator_e5',
                    S = 'Content_roleActions_d8',
                    L = 'Content_roleActionsTitle_b6',
                    U = 'Content_roleActionsContent_f1',
                    I = 'Content_roleActionsItem_a2',
                    V = 'Content_roleActionsDisabled_14',
                    z = 'Content_roleDescription_5f',
                    K = 'Content_roleDescriptionTitle_47',
                    W = 'Content_roleDescriptionText_ef',
                    q = 'Content_footer_38',
                    j = 'Content_footerImage_63',
                    G = 'Content_footerText_d2',
                    H = 'RoleAction_base_25',
                    $ = 'RoleAction_image_34',
                    Y = 'RoleAction_description_53',
                    Z = ({ image: u, description: e }) => {
                        const A = (0, E.useMemo)(() => ({ backgroundImage: `url(${u})` }), [u]);
                        return F().createElement(
                            'div',
                            { className: H },
                            F().createElement('div', { className: $, style: A }),
                            F().createElement('div', { className: Y }, e),
                        );
                    },
                    X = () => {
                        const u = y('model', O.None),
                            e = u.roleType,
                            A = u.roleBgImage,
                            t = u.roleActions,
                            ...
                            o = String(R.strings.menu.roleExp.roleName.$dyn(e));
                        return F().createElement(
                            'div',
                            { className: T },
                            F().createElement(
                                'div',
                                { className: P, style: n },
                                F().createElement('div', { className: x, style: B }),
                                F().createElement(_, { text: o, binding: C, classMix: M }),
                            ),
                            F().createElement('div', { className: k }),
                            F().createElement(
                                'div',
                                { className: z },
                                F().createElement(
                                ...
                                F().createElement('div', { className: W }, R.strings.menu.roleExp.roleDescr.$dyn(e)),
                            ),
                            D &&
                                0 !== t.items.length &&
                                F().createElement(
                                    ...
                                    F().createElement(
                                        'div',
                                        { className: q },
                                        F().createElement('div', { className: j, style: r }),
                                        F().createElement(
                                            'div',
                                            { className: G },
                ...
                const Eu = F().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            F().createElement(
                                'div',
                                Au({}, r, {
                                    className: B()(uu.base, uu[`base__theme-${n}`], t),
                                    ref: function (u) {
