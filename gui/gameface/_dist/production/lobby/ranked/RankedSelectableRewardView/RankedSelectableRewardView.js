(() => {
    var __webpack_modules__ = {
            ...
            767: (e, u, t) => {
                ...
                var r = {};
                (t.r(r), t.d(r, { Area: () => Pu, Bar: () => Mu, Default: () => ku, useVerticalScrollApi: () => Du }));
                var a = t(363),
                    i = t.n(a),
                    o = t(533),
                    s = t.n(o);
                ...
                const P = (e) => {
                        ...
                        const p = (0, a.useCallback)(
                                (e) => {
                                    (null == o || o(e), _.O.sound.play.sound(g));
                                },
                                [o, g],
                            ),
                            f = (0, a.useCallback)(
                            ...
                            h = (0, a.useCallback)(
                                (e) => {
                                    (null == l || l(e), _.O.sound.play.sound(C));
                                },
                                [l, C],
                            ),
                            v = (0, a.useCallback)(
                        ...
                        return i().createElement(
                            ...
                            i().createElement(
                                ...
                                i().createElement('div', { className: x()(M.glow, null == r ? void 0 : r.glow) }),
                            ),
                            i().createElement(
                                'div',
                                { className: x()(M.caption, M[`caption__${A}`], null == r ? void 0 : r.caption) },
                                u,
                            ),
                            n && i().createElement('div', { className: x()(M.goto, null == r ? void 0 : r.goto) }, n),
                        );
                    },
                    O = {
                ...
                const H = (e, u, t) =>
                    u.extraLargeHeight || u.largeHeight || u.mediumHeight || u.smallHeight || u.extraSmallHeight
                        ...
                        : e;
                var U;
                function W(e = _.O.client.getSize('rem')) {
                    const u = e.width,
                        t = e.height;
                ...
                const V = ({ children: e }) => {
                    ...
                    return (
                        (0, a.useLayoutEffect)(() => {
                            function e() {
                                n((e) => {
                                    const u = _.O.client.getSize('rem');
                                    return e.width === u.width && e.height === u.height ? e : W(u);
                                });
                            }
                            return (
                                e(),
                                s(!0),
                                _.O.client.events.on('clientResized', e),
                                _.O.client.events.on('self.onScaleUpdated', e),
                                () => {
                                    (_.O.client.events.off('clientResized', e),
                                        _.O.client.events.off('self.onScaleUpdated', e));
                                }
                            );
                        }, []),
                ...
                const Q = {
                    ...
                    J = {
                        [Y.ExtraSmall]: '',
                        [Y.Small]: I().SMALL_HEIGHT,
                        [Y.Medium]: `${I().SMALL_HEIGHT} ${I().MEDIUM_HEIGHT}`,
                        [Y.Large]: `${I().SMALL_HEIGHT} ${I().MEDIUM_HEIGHT} ${I().LARGE_HEIGHT}`,
                        [Y.ExtraLarge]: `${I().SMALL_HEIGHT} ${I().MEDIUM_HEIGHT} ${I().LARGE_HEIGHT} ${I().EXTRA_LARGE_HEIGHT}`,
                    },
                    ee = {
                        [j.ExtraSmall]: '',
                        [j.Small]: I().SMALL,
                        [j.Medium]: `${I().SMALL} ${I().MEDIUM}`,
                        [j.Large]: `${I().SMALL} ${I().MEDIUM} ${I().LARGE}`,
                        [j.ExtraLarge]: `${I().SMALL} ${I().MEDIUM} ${I().LARGE} ${I().EXTRA_LARGE}`,
                    },
                    ue = (e) => {
                        let u = e.children,
                            t = e.className,
                        ...
                        const r = X(),
                            ...
                            o = r.mediaHeight,
                            s = r.mediaSize;
                        return i().createElement('div', Z({ className: x()(t, Q[a], J[o], ee[s]) }, n), u);
                    },
                    te = ['children'];
                const ne = (e) => {
                    let u = e.children,
                    ...
                    return i().createElement(V, null, i().createElement(ue, t, u));
                };
                function re(e, u) {
                    var t;
                ...
                const oe = (0, a.createContext)('model');
                let se, le, ce, de, Ee, me, _e, Ae;
                (!(function (e) {
                    ((e.Items = 'items'),
                        ...
                        const h = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, a.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (De(t, _, { isMouseEvent: !0, on: !0, arguments: ge(n) }, v),
                                    B && B(),
                ...
                const ye = (e, u = ce.Small, t) => {
                    if (t === be.Modernized) {
                        const t = we(e);
                        if (t) return `R.images.gui.maps.icons.quests.bonuses.${u}.modernized_devices_t${t}_gift`;
                    }
                    return `R.images.gui.maps.icons.quests.bonuses.${u}.${Se(e, t)}_gift`;
                };
                function Te(e, u) {
                    if (u === be.Modernized) {
                        const u = we(e);
                ...
                const Re = (e, u = 's180x135', t = 'R.images.gui.maps.icons.selectableReward.reward') =>
                        `${t}.${u}.${e}`,
                    xe = 'Category_base_23',
                    ...
                    Ie = 'Category_base__completed_0d',
                    ...
                    ze = ({ type: e, count: u, limit: t, isSelected: n, onClick: r }) => {
                        ...
                        const p = x()(xe, _ && Me, l && Ie, n && ke, d && He);
                        return i().createElement(
                            'div',
                            ...
                            i().createElement(
                                ...
                                ((e, u) => {
                                    ...
                                    return t
                                        ...
                                        : `${R.strings.selectable_reward.tabs.items.$dyn(Se(e, u))}`;
                                })(e),
                            ),
                            i().createElement(
                                fe,
                ...
                const Je = {
                    ...
                    eu = ({
                        ...
                        return (s = {}) => {
                            ...
                            return (0, a.useMemo)(
                                ...
                                [g.scrollPosition, B, p, _.off, _.on, v, f, D, c.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    uu = eu({
                    ...
                    _u = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = du, onDrag: n = Eu }) => {
                        ...
                        const f = (e) => {
                            e.target.classList.contains(lu) || ve('highlight');
                        };
                        return i().createElement(
                            'div',
                            ...
                            i().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(lu) || 0 !== e.button || (ve('play'), B(Qe.Next));
                                },
                                onMouseUp: p,
                                ref: o,
                                onMouseEnter: f,
                            ...
                            i().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(lu) || 0 !== e.button || (ve('play'), B(Qe.Prev));
                                },
                                onMouseUp: p,
                                ref: s,
                                onMouseEnter: f,
                ...
                const Du = eu({
                    ...
                    Bu = 'VerticalBar_base__active_72',
                    ...
                    Mu = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Tu, onDrag: n = Su }) => {
                        const r = (0, a.useRef)(null),
                            o = (0, a.useRef)(null),
                            s = (0, a.useRef)(null),
                            l = (0, a.useRef)(null),
                        ...
                        const h = (e) => {
                            e.target.classList.contains(bu) || ve('highlight');
                        };
                        return i().createElement(
                            'div',
                            { className: x()(Cu, u.base), ref: r, onWheel: e.handleMouseWheel },
                            i().createElement('div', {
                                className: x()(pu, u.topButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(bu) || 0 !== e.button || (ve('play'), p(Qe.Next));
                                },
                                ref: o,
                                onMouseEnter: h,
                            }),
                            ...
                            i().createElement('div', {
                                className: x()(fu, u.bottomButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(bu) || 0 !== e.button || (ve('play'), p(Qe.Prev));
                                },
                                onMouseUp: f,
                                ref: s,
                                onMouseEnter: h,
                    ...
                    ku = ({
                        ...
                        const d = (0, a.useMemo)(() => {
                                const e = n || {};
                                return Object.assign({}, e, { base: x()(Lu.base, e.base) });
                            }, [n]),
                            E = (0, a.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
                        return i().createElement(
                            'div',
                            { className: x()(Lu.defaultScroll, t), onWheel: u.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: x()(Lu.area, r) },
                    ...
                    Pu = ({ className: e, classNames: u, children: t, api: n }) => (
                        (0, a.useEffect)(() => he(n.recalculateContent)),
                        i().createElement(
                            'div',
                            { className: x()(Lu.base, e), ref: n.wrapperRef, onWheel: n.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: x()(Lu.content, null == u ? void 0 : u.content), ref: n.contentRef },
                                t,
                            ),
                        )
                    );
                ...
                const Ft = ({ type: e, count: u, state: t, storageCount: n, packSize: r, onAdd: o, onReduce: s }) => {
                        const l = (0, a.useContext)(Kt),
                            ...
                            _ = (function (e) {
                                return e.includes('delux')
                                    ...
                                    : e.includes('modernized')
                                      ? _t.Modernized
                                      : e.includes(_t.Trophy)
                                        ? _t.Trophy
                                        : _t.None;
                            })(e),
                            A = (0, a.useCallback)(() => {
                                t === Wu ? (ve('bp_click'), o(e)) : t === Gu && ve('bp_click_limit');
                            }, [o, t, e]),
                            F = (0, a.useCallback)(() => {
                                t === Wu && (ve('bp_click_plus'), o(e));
                            }, [t, e, o]),
                            g = (0, a.useCallback)(() => {
                                (ve('bp_click_minus'), s(e));
                            }, [e, s]),
                            D = (0, a.useCallback)(() => {
                                ve('bp_highlight');
                            }, []),
                            C = (0, a.useMemo)(() => ({ backgroundImage: `url(${Re(e)})` }), [e]),
                            B = (0, a.useMemo)(() => ({ maskImage: `url(${Re(e)})` }), [e]),
                            p = (0, a.useMemo)(
                                () =>
                                    t === Gu && 0 === u
                                        ? {
                            ...
                            h = x()($u, E && Vu, m && Qu, t === Wu && ju, t === zu && Ku, t === Gu && Zu),
                            v = x()(tt, n <= 0 && nt);
                        return i().createElement(
                            'div',
                            { className: h, onClick: A, onMouseEnter: D },
                            i().createElement('div', { className: v }, i().createElement('div', { className: rt }), n),
                            _ !== _t.None &&
                                i().createElement('div', {
                                    className: qu,
                                    style: { backgroundImage: `url(${Te(e, _)})` },
                                }),
                            i().createElement(
                                'div',
                                { className: Yu },
                                ...
                                !E && t !== Wu && i().createElement('div', { className: Ju, style: B }),
                                r > 1 &&
                            ...
                            E || t === Wu
                                ? i().createElement(
                                      ...
                                      i().createElement(
                                          ...
                                          i().createElement(mt, { type: Et.Plus, isEnabled: t === Wu, onClick: F }),
                                      ),
                                  )
                                : i().createElement(
                                      Uu,
                    ...
                    Ct = 'ContentGrid_scrollAreaInner_32',
                ...
                const wt = () => {
                        ...
                        return (
                            ...
                            i().createElement(
                                ...
                                'hidden' !== l && 'start' !== l && i().createElement('div', { className: x()(pt, ft) }),
                                'hidden' !== l && 'end' !== l && i().createElement('div', { className: x()(pt, ht) }),
                            )
                        );
                    },
                    bt = {
                ...
                const Tt = ({
                    ...
                    Lt = 'Footer_rewardsSelected_19',
                    kt = 'Footer_rewardsSelectedCount_5b',
                    ...
                    It = ({
                        ...
                        const a = t > 0,
                            o = X().mediaSize > j.Small ? yt.medium : yt.small;
                        return i().createElement(
                            'div',
                            { className: Rt },
                            i().createElement(
                                ...
                                a
                                    ? i().createElement(
                                          ...
                                          i().createElement('span', { className: kt }, t),
                                          i().createElement(
                                              Ce,
                                              {
                                                  contentId:
                            ...
                            i().createElement(
                                ...
                                i().createElement(
                                    Tt,
                                    { size: o, type: St.primary, disabled: !a, mixClass: Nt, onClick: n },
                                    R.strings.selectable_reward.footer.okBtn.label(),
                                ),
                                i().createElement(
                                    Tt,
                                    { size: o, type: St.secondary, mixClass: Nt, onClick: r },
                ...
                const Kt = (0, a.createContext)(Xt.None),
                    Zt = ({ title: e, subTitle: u, isLargeWindowed: t }) => {
                        ...
                        const F = (0, a.useCallback)(() => {
                            ...
                            C = ie(c, (e, u) => e + u.limit, 0),
                            B = x()(Ht, r === Xt.Accepting && Ut, t && qt);
                        return i().createElement(
                            Kt.Provider,
                            { value: r },
                            i().createElement(
                    ...
                    an = () => {
                        ...
                        return i().createElement(
                            ...
                            i().createElement(
                                ...
                                i().createElement(
                                    Tt,
                                    { mixClass: nn, type: St.primary, size: yt.medium, onClick: t },
                                    rn.button(),
                                ),
                            ),
                        );
                ...
                const ln = ({ modelPath: e = 'model', title: u, subTitle: t }) => {
                        const n = w(e).tabs.length ? sn.Normal : sn.Error,
                            r = (() => {
                    ...
                    dn = 'App_fill_a2',
                    En = 'App_close_8a',
                    mn = 'model.selectableRewardModel',
                    _n = () => {
                        const e = w(mn).onCloseClick,
                            u = w().rewardType,
