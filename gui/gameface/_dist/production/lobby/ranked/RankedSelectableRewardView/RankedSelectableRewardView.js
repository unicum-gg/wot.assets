(() => {
    var __webpack_modules__ = {
            380: (e) => {
                ...
                function R(e, t, u) {
                    var n = u[0],
                        ...
                        b = null;
                    function p(u) {
                        (A[s] = g(_ + b * (u[o] - F))), m(e, d), f(e, !1, t), u.stopPropagation(), u.preventDefault();
                    }
                    function v() {
            ...
            570: (e, t, u) => {
                ...
                const I = b.O.client.getSize('rem'),
                    Y = I.width,
                    X = I.height,
                ...
                const $ = (e) => {
                    ...
                    if (u.extraLarge || u.large || u.medium || u.small || u.extraSmall) {
                        ...
                        if (u.extraLargeWidth && c) return H(t, u, p);
                        if (u.largeWidth && d) return H(t, u, p);
                        if (u.mediumWidth && E) return H(t, u, p);
                        if (u.smallWidth && m) return H(t, u, p);
                        if (u.extraSmallWidth && h) return H(t, u, p);
                        if (
                ...
                const ee = {
                    ...
                    ne = (e) => {
                        ...
                        const o = Q(),
                            ...
                            a = o.mediaHeight,
                            s = o.mediaSize;
                        return r().createElement('div', J({ className: l()(u, ee[i], te[a], ue[s]) }, n), t);
                    },
                    re = ['children'];
                const oe = (e) => {
                        let t = e.children,
                    ...
                    const g = (0, n.useRef)(null),
                        ...
                        H = l()(
                            ...
                            ae[`base__${o}`],
                            {
                                ...
                                [ae[`base__${t}`]]: t,
                                [ae.base__focus]: p,
                                [ae.base__highlightActive]: f,
                                [ae.base__firstHover]: w,
                            },
                            a,
                        ),
                        N = l()(ae.state, ae.state__default);
                    return (
                        (0, n.useEffect)(
                            () => (
                ...
                const he = (e, t, u = {}, n = 0) => {
                    ...
                    Ae = (e) => {
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            B = (0, n.useMemo)(() => g || p().resId, [g]),
                            C = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (he(u, h, { isMouseEvent: !0, on: !0, arguments: me(r) }, B),
                                    b && b(),
                    ...
                    pe = 'Footer_rewardsSelectedCount_5b',
                    ve = 'Footer_rewardsSelectedIcon_59',
                    De = 'Footer_buttons_12',
                    fe = 'Footer_cButton_f7',
                    Be = ({ rewardsSelectedCount: e, onOkClick: t, onCloseClick: u }) => {
                        const n = e > 0,
                            ...
                            r().createElement(
                                ...
                                n
                                    ? r().createElement(
                                          ...
                                          r().createElement('span', { className: pe }, e),
                                          r().createElement(
                                              Ae,
                                              {
                                                  contentId:
                        ...
                        (0, n.useEffect)(() => {
                            if (w && y)
                                return (
                                    ...
                                    y.addEventListener('ps-scroll-y', I),
                                    ...
                                    () => {
                                        window.removeEventListener('resize', G),
                                            ...
                                            y &&
                                                ...
                                                y.removeEventListener('ps-scroll-y', I),
                                                y.removeEventListener('over-scroll-beginning', Y),
                                                y.removeEventListener('over-scroll-ending', X));
                                    }
                                );
                        }, [z, W, Y, X, G, y, w, I]);
                        const $ = (0, n.useRef)(y || null);
                        $.current = y || null;
                        const j = Se($);
                        (0, n.useEffect)(
                            () => (
                                !w && y && j && S(new (ye())(y, Object.assign({}, s))),
                                () => {
                            ...
                            (0, n.useEffect)(() => {
                                g &&
                                    ...
                                    (g.updateScrollArea = M),
                                    (g.getScrollbar = k));
                            }, [g, P, O, H, N, M, k]);
                        const q = l()(Te, { [Re]: A, [Me]: !f, [xe]: _, [ke]: F }, p);
                ...
                const Bt = ({ type: e = ft.Plus, isEnabled: t = !0, onClick: u }) => {
                ...
                const St = ({ type: e, count: t, state: u, storageCount: o, packSize: i, onAdd: a, onReduce: c }) => {
                        const d = (0, n.useContext)(su),
                            ...
                            m = d === lu.Accepting && E,
                            h = (function (e) {
                                return e.startsWith(Ct.Trophy)
                                    ? Ct.Trophy
                                    : e.startsWith(Ct.Deluxe)
                                      ? Ct.Deluxe
                                      : Ct.None;
                            })(e),
                            F = (0, n.useCallback)(() => {
                                u === Ue ? (s('bp_click'), a(e)) : u === Ge && s('bp_click_limit');
                            }, [a, u, e]),
                            g = (0, n.useCallback)(() => {
                                u === Ue && (s('bp_click_plus'), a(e));
                            }, [u, e, a]),
                            b = (0, n.useCallback)(() => {
                            ...
                            D = (0, n.useMemo)(() => ({ backgroundImage: `url(${et(e)})` }), [e]),
                            f = (0, n.useMemo)(() => ({ maskImage: `url(${et(e)})` }), [e]),
                            B = (0, n.useMemo)(
                                () =>
                                    u === Ge && 0 === t
                                        ? {
                            ...
                            w = l()(tt, E && ut, m && st, u === Ue && nt, u === ze && at, u === Ge && lt),
                            S = l()(mt, o <= 0 && ht);
                        return r().createElement(
                            'div',
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    Ne,
                                    { args: C },
                                    r().createElement('div', { className: it, style: D }),
                                ),
                                !E && u !== Ue && r().createElement('div', { className: ct, style: f }),
                                i > 1 &&
                            ...
                            r().createElement(
                                ...
                                ((e) => {
                                    ...
                                    return n || (r ? _(r) : void console.error('title for reward is not provided'));
                                })(e),
                            ),
                            E || u === Ue
                                ? r().createElement(
                                      ...
                                      r().createElement(
                                          'div',
                                          { className: Ft },
                                          r().createElement(Bt, { type: ft.Minus, isEnabled: E, onClick: b }),
                                          r().createElement(Bt, { type: ft.Plus, isEnabled: u === Ue, onClick: g }),
                                      ),
                                  )
                                : r().createElement(
                                      Xe,
                                      ...
                                      r().createElement(
                                          'div',
                                          { className: gt },
                                          r().createElement('div', { className: bt }, wt.$dyn(u)),
                ...
                const Ht = { suppressScrollX: !0 },
                                        ...
                                        r().createElement(
                                            ...
                                            a.map(({ value: e }, t) =>
                                                r().createElement(
                                                    'div',
                                                    { key: t, className: Rt },
                                                    r().createElement(St, Pt({}, e, { key: t, onAdd: p, onReduce: v })),
                                                ),
                                            ),
                                        ),
                                ),
                                h && 'start' !== d && r().createElement('div', { className: l()(xt, kt) }),
                                h && 'end' !== d && r().createElement('div', { className: l()(xt, Mt) }),
                            )
                        );
                    },
                    Wt = 'Category_base_23',
                    ...
                    Qt = ({ type: e, count: t, limit: u, isSelected: o, onClick: i }) => {
                        const a = (0, n.useContext)(su),
                            c = Q().mediaSize,
                            d = t === u,
                            E = a === lu.Accepting && t > 0 && !o,
                            m = c >= q.Medium ? qe.Big : qe.Small,
                            h = (0, n.useState)(!1),
                            _ = h[0],
                            F = h[1],
                            g = (0, n.useMemo)(() => ({ backgroundImage: `url(${Je(e, m)})` }), [m, e]),
                            b = (0, n.useMemo)(() => A(Kt.counter(), { count: t, limit: u }), [t, u]),
                        ...
                        const f = l()(Wt, _ && It, d && $t, o && Xt, E && jt);
                        return r().createElement(
                            'div',
                            ...
                            r().createElement('div', { className: Vt }, b),
                        );
                    },
                    Zt = 'Content_base_32',
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: ou },
                                    r().createElement(Be, { rewardsSelectedCount: m, onOkClick: F, onCloseClick: g }),
                                ),
                            ),
                        );
                    },
                ...
                const vu = ({ modelPath: e = 'model', title: t, subTitle: u }) => {
                        const o = y(e).tabs.length ? pu.Normal : pu.Error,
                            i = (() => {
                                const e = b.O.view.getSize('rem'),
                            ...
                            a = i.width,
                            s = i.height,
                            c = s >= 1017 && s < M.large.height && a === M.large.width,
                            d = l()(bu, c && O().LARGE);
                        return r().createElement(
                            ie.Provider,
                            { value: e },
                            r().createElement(
                                oe,
                                { className: d },
                                o === pu.Normal && r().createElement(cu, { title: t, subTitle: u, isLargeWindowed: c }),
                                o === pu.Error && r().createElement(gu, null),
                            ),
                        );
                    },
                    Du = 'App_base_8d',
                    fu = 'App_fill_a2',
                    Bu = 'App_close_8a',
                    Cu = 'model.selectableRewardModel',
                    wu = () => {
                        const e = y(Cu).onCloseClick,
                            t = (0, n.useCallback)(() => {
                                e();
                            }, [e]);
                        return (
                            ...
                            r().createElement(
                                ...
                                r().createElement(vu, {
                                    modelPath: Cu,
                                    title: R.strings.ranked_battles.selectableReward.title(),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [976], () => __webpack_require__(570));
