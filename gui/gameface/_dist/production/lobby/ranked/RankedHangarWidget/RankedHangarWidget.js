(() => {
    var __webpack_modules__ = {
            ...
            153: (u, e, t) => {
                ...
                t.d(e, { O: () => W });
                var r = {};
                (t.r(r), t.d(r, { getBgUrl: () => E, getTextureUrl: () => i }));
                var a = {};
                (t.r(a),
                    t.d(a, {
                        addModelObserver: () => h,
                ...
                const P = Object.keys(o).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === o[e]), u), {}),
                    H = {
                        set: (u, e) => {
            ...
            364: (u, e, t) => {
                'use strict';
                t.d(e, { B3: () => A, Gr: () => F, Z5: () => i, B0: () => o, ry: () => m });
                class r {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            990: (u, e, t) => {
                ...
                const C = (u) => {
                    ...
                    m = (0, r.memo)(({ children: u }) => {
                        ...
                        return a().createElement(c.Provider, { value: s }, u);
                    });
                var _ = t(483),
                    g = t.n(_),
                    h = t(926),
                ...
                const T = {
                    ...
                    k = (u) => {
                        ...
                        const n = p(),
                            ...
                            E = n.mediaHeight,
                            o = n.mediaSize;
                        return a().createElement('div', L({ className: g()(t, T[i], S[E], M[o]) }, r), e);
                    },
                    y = ['children'];
                const O = (u) => {
                    let e = u.children,
                ...
                const V = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: E, children: o, mocks: A }) {
                                const F = (0, r.useRef)([]),
                                    ...
                                    c = D[0],
                                    B = D[1],
                                    d = (0, r.useState)(() => s(n, E, A)),
                                    C = d[0],
                                    m = d[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? m(s(c, E, A)) : (l.current = !0);
                                    }, [A, c, E]),
                                    (0, r.useEffect)(() => {
                                        B(n);
                                    }, [n]),
                        ...
                        ({ observableModel: u }) => {
                            const e = {
                                root: u.object(),
                                rankLeft: u.object('rankLeft'),
                                rankRight: u.object('rankRight'),
                            };
                ...
                (!(function (u) {
                    ...
                    (function (u) {
                        ((u.Large = 'large'), (u.Medium = 'medium'));
                    })(Z || (Z = {})));
                const X = {
                    base: 'App_base_bf',
                    wrapper: 'App_wrapper_06',
                    wrapperHover: 'App_wrapperHover_57',
                    wrapperHover_hover: 'App_wrapperHover_hover_57',
                    ranks: 'App_ranks_23',
                    ranks_showLeague: 'App_ranks_showLeague_1b',
                    bonus: 'App_bonus_bd',
                    bonus_showLeague: 'App_bonus_showLeague_17',
                };
                var Q = t(364);
                const J = [
                    'children',
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (eu(t, c, { isMouseEvent: !0, on: !0, arguments: uu(a) }, w),
                                    _ && _(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((v.current.timeoutId = window.setTimeout(f, F ? 100 : 400)),
                                                      n && n(u),
                                                      x && x(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const Eu = (u, e, t) => {
                    ...
                    Au = (u, e, t = iu.left) => u.split(e).reduce(t === iu.left ? Eu : ou, []),
                    Fu = (() => {
                        const u = new RegExp(
                        ...
                        return su.includes(t)
                            ...
                            : ((u, e = iu.left) => {
                                  ...
                                  const r =
                                      ...
                                      a = u.replace(/&nbsp;/g, ' ');
                                  return (Au(a, /( )/, e).forEach((u) => (t = t.concat(Au(u, r, iu.left)))), t);
                              })(u, e);
                    },
                    Du = 'FormatText_base_d0',
                    cu = ({ binding: u, text: e = '', classMix: t, alignment: n = iu.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, i) =>
                                      a().createElement(
                                          'div',
                                          { className: g()(Du, t), key: `${e}-${i}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : lu(u, e))))(e, n, u).map((u, e) =>
                    ...
                    Cu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    mu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    _u = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((o = o.replace(t, `%(${E})`)),
                                    (i[E] = Bu[u]
                                        ? a().createElement(
                                              'span',
                                              { className: Bu[u] },
                                              a().createElement(cu, { text: s, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: n(u) },
                        ...
                        return a().createElement(cu, { text: o, classMix: t, binding: i });
                    }),
                    gu = 'BonusBattles_base_c0',
                    hu = 'BonusBattles_light_65',
                    vu = 'BonusBattles_divider_89',
                    wu = 'BonusBattles_divider__right_47',
                    fu = 'BonusBattles_icon_b8',
                    bu = 'BonusBattles_amount_0f',
                    pu = { tooltipId: 'rankedBattlesBonus' },
                    xu = R.strings.ranked_battles,
                    Lu = (0, r.memo)((u) => {
                        const e = u.amount,
                            t = Q.Z5.getNumberFormat(e, Q.B3.INTEGRAL),
                            r = g()(vu, wu);
                        return a().createElement(
                            nu,
                            { args: pu },
                            a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    { className: bu },
                                    a().createElement(_u, {
                                        text: xu.rankedHangarWidget.bonusBattles(),
                                        binding: { battlesCount: t },
                                    }),
                                ),
                    ...
                    Su = 'Blink_blink_28',
                    Mu = 'Blink_widget_0f',
                    ku = (0, r.memo)(({ isWidget: u = !1 }) => {
                        const e = g()(Tu, { [Mu]: u });
                        return a().createElement('div', { className: e }, a().createElement('div', { className: Su }));
                    }),
                    yu = { [Z.Large]: '80x110', [Z.Medium]: '58x80' },
                    Ou = {
                        base: 'Rank_base_bc',
                        icon: 'Rank_icon_d8',
                        icon__next: 'Rank_icon__next_bb',
                        frame: 'Rank_frame_1b',
                        unburnable: 'Rank_unburnable_f1',
                        lock: 'Rank_lock_93',
                    },
                    Ru = (0, r.memo)((u) => {
                        const e = u.isInactive,
                            ...
                            c = (0, r.useMemo)(() => {
                                const u = R.images.gui.maps.icons.rankedBattles,
                                    e = yu[F];
                                return { backgroundImage: `url(${u.ranks.$dyn(`c_${e}`).$dyn(`rank${n}_${i}`)})` };
                            }, [n, i, F]),
                            B = (u) => [Ou[u], Ou[`${u}__${F}`]],
                            d = g()(Ou.icon, t && Ou.icon__next, ...B('icon')),
                            C = g()(...B('frame'), ...B('unburnable'));
                        return a().createElement(
                            nu,
                            { isEnabled: D, args: { rankID: E, tooltipId: 'rankedBattlesRank' } },
                            a().createElement(
                                'div',
                                { className: Ou.base },
                                a().createElement('div', { className: d, style: c }),
                                o && a().createElement('div', { className: C }),
                                !t && a().createElement(ku, { isWidget: !0 }),
                                l && a().createElement('div', { className: Ou.lock, 'data-emblem': 'lock' }),
                            ),
                        );
                    });
                let Iu, Pu;
                (!(function (u) {
                    ((u[(u.Medium = 14)] = 'Medium'), (u[(u.Large = 20)] = 'Large'));
                })(Iu || (Iu = {})),
                    (function (u) {
                        ((u[(u.Medium = 5)] = 'Medium'), (u[(u.Large = 7)] = 'Large'));
                    })(Pu || (Pu = {})));
                const Hu = 'rankedStep',
                    Nu = 'Stage_base_4c',
                    Wu = 'Stage_stage_fc',
                    Uu = 'Stage_firstStage_f7',
                    Gu = 'Stage_notReceived_15',
                    $u = { tooltipId: Hu },
                    ju = (0, N.Pi)(({ totalCount: u, earnedCount: e }) => {
                        const t = ((u, e) =>
                            1 == u < w.Medium
                                ? { '--itemWidth': (Iu.Medium - Pu.Medium) * e + 'rem' }
                                : { '--itemWidth': (Iu.Large - Pu.Large) * e + 'rem' })(p().mediaSize, u);
                        return a().createElement(
                            'div',
                            { className: Nu, style: t },
                            ((u, e) => {
                                const t = [];
                                ...
                                return a().createElement(
                                    nu,
                                    { args: $u, key: u },
                                    a().createElement('div', { className: g()(Wu, { [Gu]: t, [Uu]: !u }) }),
                                );
                            }),
                        );
                    }),
                    zu = { base: 'Division_base_6d' };
                function Vu() {
                    return (
                        (Vu =
                            Object.assign ||
                ...
                const Ku = { tooltipId: Hu },
                    qu = (u) => {
                        const e = u.rankLeft,
                            ...
                            c = void 0 !== t || D,
                            B = n.rankID > A,
                            d = (0, r.useMemo)(() => (Y.Medium === o ? Z.Medium : Z.Large), [o]);
                        return a().createElement(
                            'div',
                            { className: g()(zu.base, zu[`base__${o}`]), onClick: F, onMouseEnter: s, onMouseLeave: l },
                            t && a().createElement(Ru, Vu({}, t, { size: d })),
                            D &&
                                a().createElement(
                                    nu,
                                    { args: Ku },
                ...
                const ee = (0, r.memo)(function (u) {
                        ...
                        return (
                            (0, r.useEffect)(() => {
                                ...
                                switch (C) {
                                    ...
                                    case 'stop':
                                        return (function () {
                                            const u = 0 === s && g ? { path: g, x: 0, y: 0 } : n(s),
                                                e = new Image();
                                            e.src = u.path;
                                            const r = () => t(re(u, e));
                                            return (
                            ...
                            a().createElement('canvas', ue({}, h, { width: e, height: t, ref: v }))
                        );
                    }),
                    te = (u, e) => {
                        let t = u;
                    ...
                    ne = 'AnimatedBackground_base_ec',
                    ie = 'AnimatedBackground_widget_8b',
                    Ee = 'AnimatedBackground_rays_59',
                    oe = 'AnimatedBackground_sunShineCanvas_be',
                    Ae = 'AnimatedBackground_staticHighlight_1c',
                    Fe = 'AnimatedBackground_animation_fb',
                    se = {
                        width: 400,
                        height: 400,
                        frameCount: 50,
                        ...
                        getChunkPath:
                            ((le = 'R.images.gui.maps.icons.sequence.sun_shine_big_sprite.sprite_'),
                            (u) => `${le}${u}`),
                    };
                var le;
                const De = (function (u) {
                    ...
                    ce = ({ className: u, isAnimated: e, isWidget: t }) => {
                        const r = g()(u, ne, { [Fe]: e, [ie]: t });
                        return a().createElement(
                            'div',
                            { className: r },
                    ...
                    Be = {
                        base: 'RankedStat_base_3f',
                        icon: 'RankedStat_icon_35',
                        icon__efficiency: 'RankedStat_icon__efficiency_9c',
                        icon__position: 'RankedStat_icon__position_fd',
                        value: 'RankedStat_value_06',
                        delta: 'RankedStat_delta_2f',
                        delta__minus: 'RankedStat_delta__minus_ca',
                        arrow: 'RankedStat_arrow_4b',
                        arrow__minus: 'RankedStat_arrow__minus_a0',
                    };
                let de, Ce;
                (!(function (u) {
                ...
                const me = {
                        [de.Efficiency]: 'rankedBattlesEfficiency',
                        [de.Position]: 'RANKED_BATTLES_POSITION_TOOLTIP',
                    },
                    _e = (0, r.memo)(
                        ({
                            type: u,
                            ...
                            const E = (u) =>
                                    r
                                        ? '---'
                                        : n
                                          ? Q.Z5.getRealFormat(100 * u, Q.Gr.WO_ZERO_DIGITS) + '%'
                                          : Q.Z5.getRealFormat(u, Q.Gr.WO_ZERO_DIGITS),
                                o = E(e),
                                A = E(t);
                            return a().createElement(
                                nu,
                                ...
                                a().createElement(
                                    'div',
                                    { className: g()(Be.base, Be[`base__${i}`]) },
                                    a().createElement('div', {
                                        className: g()(Be.icon, Be[`icon__${u}`], Be[`icon__${u}__${i}`]),
                                    }),
                                    a().createElement('div', { className: g()(Be.value, Be[`value__${i}`]) }, o),
                                    0 !== t &&
                                        !r &&
                                        a().createElement(
                                            'div',
                                            { className: g()(Be.delta, Be[`delta__${i}`], t < 0 && Be.delta__minus) },
                                            a().createElement('div', {
                                                className: g()(Be.arrow, t < 0 && Be.arrow__minus),
                                            }),
                                            A,
                                        ),
                                ),
                ...
                const ve = R.views.common.tooltip_window.simple_tooltip_content,
                            ...
                            he(
                                {
                                    contentId:
                                        ...
                                        s ? ve.SimpleTooltipHtmlContent('resId') : ve.SimpleTooltipContent('resId')),
                    ...
                    Se = (0, r.memo)(({ value: u, isUnavailable: e = !1 }) => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement('div', { className: pe }, t),
                            ),
                        );
                    }),
                    Me =
                        ...
                        Z.Medium,
                        {
                            ...
                            base__tiny: 'League_base__tiny_53',
                            base__small: 'League_base__small_67',
                            base__smedium: 'League_base__smedium_31',
                            base__medium: 'League_base__medium_b9',
                            base__large: 'League_base__large_48',
                    ...
                    Oe = (0, r.memo)((u) => {
                        const e = u.leagueID,
                            t = u.efficiency,
                            n = u.efficiencyDiff,
                            i = u.isEfficiencyUnavailable,
                            E = void 0 !== i && i,
                            o = u.isBattlesUnavailable,
                            A = void 0 !== o && o,
                            F = u.size,
                            s = u.battlesTotal,
                            l = u.onClick,
                            ...
                            c = u.onMouseLeave,
                            B = (0, r.useMemo)(
                                () => ([Y.Medium, Y.Large, Y.ExtraLarge].includes(F) ? Z.Large : Z.Medium),
                                [F],
                            ),
                            d = (0, r.useMemo)(
                                () => ([Y.Medium, Y.ExtraLarge].includes(F) ? Ce.Large : Ce.Medium),
                                [F],
                            ),
                            C = (0, r.useMemo)(() => {
                    ...
                    Re = (0, N.Pi)(() => {
                        const u = q(),
                            ...
                            f = A > -1,
                            b = D > 0,
                            x = (0, r.useMemo)(() => (v === w.ExtraSmall || v === w.Small ? Y.Medium : Y.Large), [v]),
                            L = (0, r.useCallback)((u) => {
                                (h(u), u && H(R.sounds.highlight()));
                            }, []),
                            T = () => {
                                (H(R.sounds.play()), t.onClick());
                            };
                        return a().createElement(
                            'div',
                            { className: X.base },
                            a().createElement('div', { className: g()(X.wrapperHover, { [X.wrapperHover_hover]: _ }) }),
                            a().createElement(
                                'div',
                                { className: g()(X.wrapper, X[`wrapper_${x}`]) },
                                a().createElement(
                                    'div',
                                    ...
                                    f
                                        ? a().createElement(Oe, {
                                              ...
                                              efficiency: F,
                                              efficiencyDiff: s,
                                              isEfficiencyUnavailable: l,
                                              isBattlesUnavailable: !f,
                                              size: x,
                                              battlesTotal: B,
                                              onClick: T,
                                              onMouseEnter: () => L(!0),
                                ...
                                b &&
                                    a().createElement(
                                        'div',
                                        { className: g()(X.bonus, { [X.bonus_showLeague]: !f }) },
                                        a().createElement(Lu, { amount: D }),
                                    ),
                            ),
                        );
                    });
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [976], () => __webpack_require__(990));
