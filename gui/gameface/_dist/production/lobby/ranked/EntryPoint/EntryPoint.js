(() => {
    ...
    var __webpack_modules__ = {
            294: (u, e, t) => {
                ...
                var F = {};
                (t.r(F), t.d(F, { getBgUrl: () => P, getTextureUrl: () => y }));
                var A = {};
                function r(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const su = { view: A, client: E, sound: p, intl: w };
            },
            521: (u, e, t) => {
                let n, E;
                (t.d(e, { n: () => n }),
                        ...
                        s(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = c(u);
                                h.current = d.addCallback(n, t, i, e === v.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== v.None)
                                return () => {
                                    d.removeCallback(h.current, i);
                                };
                        }, [i, e]),
                        w
                    );
                    ...
                    O = () => {
                        ...
                        const D = 5 === e,
                            ...
                            C = ((u, e, t) => {
                                ...
                                return '';
                            })(e, F, a === b.Big || a === b.WideSmall),
                            l = i()(f.base, f[`base__${a}`], D && f.base__frozen),
                            c = (0, n.useCallback)(() => {
                                window.swfPlayer.play('entryPointParticlesSwf');
                            }, []);
                        return E().createElement(
                            'div',
                            { className: l, onClick: r, onMouseOver: g.playHighlight },
