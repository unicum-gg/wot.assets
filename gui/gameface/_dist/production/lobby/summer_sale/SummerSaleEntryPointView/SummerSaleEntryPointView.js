(() => {
    var __webpack_modules__ = {
                ...
                const v = r.instance,
                    b = {
                        ...
                        sendShowContextMenuEvent: (u, e, t = 0) => {
                            d(n.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                        },
            ...
            800: (u, e, t) => {
                ...
                const D = a.O.client.getSize('rem'),
                    o = D.width,
                    l = D.height,
                    s = Object.assign({ width: o, height: l }, i(o, l, F)),
                    B = (0, E.createContext)(s),
                    _ = ['children'];
                const C = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                ...
                const S = () => {
                    ...
                    O = [x.ExtraLarge, x.Large, x.Medium, x.Small, x.ExtraSmall],
                    T = (u, e) =>
                        Object.keys(u).reduce((t, E) => {
                            ...
                            return (
                                void 0 === r ||
                                    ((u, e) => M.some((t) => void 0 !== e[`${u}_${t}`]))(E, u) ||
                                    (t[E] = r),
                                t
                            );
                        }, {}),
                ...
                const k = {
                    ...
                    U = y((u) => {
                        let e = u.className,
                            ...
                            w =
                                void 0 === x
                                    ...
                                    : x,
                            f = u.alignItems,
                            S = void 0 === f ? (d ? 'flex-start' : h && 'center') || (g && 'flex-end') || void 0 : f,
                            M = u.alignSelf,
                            L = u.wrap,
                            O = u.flexWrap,
                            ...
                            R = u.shrink,
                            U = u.flex,
                            G = void 0 === U ? (y || R ? `${y ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : U,
                            j = u.style,
                            X = u.children,
                            K = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const z = (0, E.useMemo)(() => {
                                const u = { mt: n, mr: D, mb: l, ml: B },
                                    e = ((u) =>
                                        W.reduce((e, t) => {
                                            const E = u[t];
                                            return E && 'number' != typeof E ? e.concat(k[!0 === E ? 'MD' : E][t]) : e;
                                        }, []))(u),
                                    E = ((u) =>
                                        W.reduce((e, t) => {
                                            const E = u[t];
                                            return ('number' == typeof E && (e[I[t]] = E + 'rem'), e);
                                        }, {}))(u);
                                return {
                            ...
                            }, [t, A, n, D, l, B, j, G, M, c, T, w, S]),
                            V = z.computedStyle,
                            Y = z.computedClassNames;
                        return r().createElement('div', H({ className: p()(P.base, ...Y, e), style: V }, K), X);
                    });
                let G;
                function j(u, e) {
                ...
                const X = (u, e, t) => {
                    ...
                    z = (u, e, t = G.left) => u.split(e).reduce(t === G.left ? X : K, []),
                    V = (() => {
                        const u = new RegExp(
                        ...
                        return Y.includes(t)
                            ...
                            : ((u, e = G.left) => {
                                  ...
                                  const E =
                                      ...
                                      r = u.replace(/&nbsp;/g, ' ');
                                  return (z(r, /( )/, e).forEach((u) => (t = t.concat(z(u, E, G.left)))), t);
                              })(u, e);
                    },
                    $ = 'FormatText_base_d0',
                    Z = ({ binding: u, text: e = '', classMix: t, alignment: A = G.left }) =>
                        null === e
                            ...
                            : r().createElement(
                                  ...
                                  e.split('\n').map((e, a) =>
                                      r().createElement(
                                          'div',
                                          { className: p()($, t), key: `${e}-${a}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : q(u, e))))(e, A, u).map((u, e) =>
                ...
                const Eu = Object.keys(J()),
                    ...
                    Du = y((u) => {
                        ...
                        return r().createElement(
                            ...
                            tu(
                                {
                                    className: p()(uu.base, t && uu[t], g, A),
                                    style: h,
                                    mt: !0 === i ? nu[t || 'paragraph-P16'].mt : i,
                                    mr: !0 === o ? nu[t || 'paragraph-P16'].mr : o,
                                    mb: !0 === s ? nu[t || 'paragraph-P16'].mb : s,
                                    ml: !0 === _ ? nu[t || 'paragraph-P16'].ml : _,
                                },
                                c,
                            ),
                            void 0 !== m ? r().createElement(Z, tu({}, m, { text: e })) : e,
                        );
                    });
                let ou, lu;
                (!(function (u) {
                    ((u.Active = 'active'), (u.Ending = 'ending'), (u.Disable = 'disable'));
                })(ou || (ou = {})),
                    (function (u) {
                ...
                const Lu = ((u, e) => {
                                ...
                                const D = (0, E.useRef)([]),
                                    o = (t, E, r) => {
                                        ...
                                        const F = (function ({
                                            ...
                                            s = { mode: t, model: l, externalModel: n, cleanup: o };
                                        return {
                                            model: l,
                                    ...
                                    B = s[0],
                                    _ = s[1],
                                    C = (0, E.useState)(() => o(A, F, i)),
                                    m = C[0],
                                    c = C[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        l.current ? c(o(B, F, i)) : (l.current = !0);
                                    }, [i, B, F]),
                                    (0, E.useEffect)(() => {
                                        _(A);
                                    }, [A]),
                        ...
                        ({ externalModel: u }) => ({ toSummerSaleEvent: u.createCallbackNoArgs('toSummerSaleEvent') }),
                    ),
                    Ou = Lu[0],
                    Tu = Lu[1],
                    yu = {
                        base: 'App_base_7b',
                        base__small: 'App_base__small_46',
                        base__medium: 'App_base__medium_e5',
                        base__big: 'App_base__big_3d',
                        base__large: 'App_base__large_0e',
                        bg: 'App_bg_78',
                        base__hover: 'App_base__hover_aa',
                        highlight: 'App_highlight_1c',
                        shadow: 'App_shadow_7c',
                        content: 'App_content_09',
                        title: 'App_title_1a',
                        subTitle: 'App_subTitle_c3',
                        timeContent: 'App_timeContent_a2',
                        timeActive: 'App_timeActive_f3',
                        timeEnding: 'App_timeEnding_14',
                        blink: 'App_blink_3c',
                        show: 'App_show_a5',
                    },
                    Ru = (u) => (u < 0.5 ? 4 * u * u * u : (u - 1) * (2 * u - 2) * (2 * u - 2) + 1),
                    Pu = (u) => {
                        const e = ((u) => {
                            ...
                            t = e.day,
                            E = e.month;
                        return { day: t, month: R.strings.menu.dateTime.months.$num(E + 1) };
                    },
                    Nu = (0, E.memo)(
                        ({
                            children: u,
                            ...
                            (0, bu.useTransition)(e, {
                                key: e,
                                from: { opacity: A },
                                enter: { opacity: a },
                                leave: { opacity: F },
                                delay: t,
                                config: { duration: E, easing: Ru },
                            })((e, t) => t && r().createElement(bu.animated.div, { className: n, style: e }, u)),
                    );
                var Hu;
                !(function (u) {
                    ((u.Large = 'large'), (u.Big = 'big'), (u.Medium = 'medium'), (u.Small = 'small'));
                })(Hu || (Hu = {}));
                const ku = R.strings.event.summerSales,
                    Wu = (u) => {
                        const e = (function (u = 0) {
                                let e = u;
                                const t = Math.trunc(e / Cu);
                                e -= t * Cu;
                                const E = Math.trunc(e / _u);
                                e -= E * _u;
                                const r = Math.trunc(e / Bu);
                                return ((e -= r * Bu), { days: t, hours: E, minutes: r, seconds: e });
                            })(u),
                            t = e.days,
                            E = e.hours,
                            r = e.minutes,
                            A = R.strings.common.duration;
                        if (t) {
                            let u = ku.eventFinishFormat() + j(A.days(), { days: t });
                            return (E && (u += ' ' + j(A.hours(), { hours: E })), u);
                        }
                        if (E) {
                            let u = ku.eventFinishFormat() + j(A.hours(), { hours: E });
                            return (r && (u += ' ' + j(A.minutes(), { minutes: r })), u);
                        }
                        return r ? ku.eventFinishFormat() + j(A.minutes(), { minutes: r }) : ku.lessThanMinute();
                    },
                    Iu = (0, vu.Pi)(() => {
                        const u = Tu(),
                            e = u.controls,
                            ...
                            n = a.timer,
                            i = a.status,
                            D = a.isEnoughCurrency,
                            o = i === ou.Active,
                            l = i === ou.Ending,
                            s = hu(n - Math.floor(Date.now() / 1e3), Bu);
                        const B = (0, E.useMemo)(() => Wu(s), [s]),
                            _ = (0, E.useState)(!1),
                            C = _[0],
                            m = _[1],
                            c = (0, E.useMemo)(() => Pu(n), [n]),
                            d = c.day,
                            h = c.month,
                            g = (0, E.useMemo)(
                                () => (A >= x.Large ? Hu.Large : F ? Hu.Big : A === x.Medium ? Hu.Medium : Hu.Small),
                                [A, F],
                            ),
                            v = (0, bu.useSpring)({
                                from: { x: 0, opacity: 0 },
                                to: { x: 0, opacity: 1 },
                                delay: 0,
                                config: { duration: 800, easing: Ru },
                            });
                        return r().createElement(
                            bu.animated.div,
                            {
                                className: p()(yu.base, yu[`base__${g}`], C && yu.base__hover),
                                onMouseEnter: () => {
                                    (pu.playHighlight(), m(!0));
                                },
                                onMouseLeave: () => {
                                    m(!1);
                                },
                                onClick: () => {
                                    (pu.playClick(), e.toSummerSaleEvent());
                                },
                                style: v,
                            },
                            r().createElement('div', { className: yu.bg }),
                            r().createElement('div', { className: yu.shadow }),
                            r().createElement(Nu, { classMix: yu.highlight, isVisible: C }),
                            r().createElement(
                                'div',
                                { className: yu.content },
                                r().createElement(Du, { className: yu.title, text: ku.title() }),
                                D && r().createElement(Du, { className: yu.subTitle, text: ku.subTitle() }),
                            ),
                            r().createElement(
                                'div',
                                { className: yu.timeContent },
                                o &&
                                    r().createElement(Du, {
                                        className: yu.timeActive,
                                        text: ku.endDateText(),
                                        format: { binding: { day: d, month: h } },
                                    }),
                                l && r().createElement(Du, { className: yu.timeEnding, text: B }),
                            ),
                            D && r().createElement('div', { className: yu.blink }),
                        );
                    });
                engine.whenReady.then(() => {
                    h().render(
                        r().createElement(Ou, null, r().createElement(c, null, r().createElement(Iu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [228], () => __webpack_require__(800));
