(() => {
    var __webpack_modules__ = {
            ...
            657: (u, e, t) => {
                ...
                const L = {
                    ...
                    O = (u) => {
                        ...
                        const E = f(),
                            ...
                            A = E.mediaHeight,
                            i = E.mediaSize;
                        return a().createElement('div', M({ className: h()(t, L[n], S[A], T[i]) }, r), e);
                    },
                    y = ['children'];
                const H = (u) => {
                    let e = u.children,
                ...
                const Eu = (u, e, t) => {
                    ...
                    su = ({ binding: u, text: e = '', classMix: t, alignment: E = au.left }) =>
                        null === e
                ...
                const Wu = ((u, e) => {
                                    ...
                                    D = (t, r, a) => {
                                        ...
                                        const A = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Pu(a.keys()); !(u = t()).done;) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(r),
                    ...
                    Uu = 'App_base_76',
                    ju = 'App_vignette_7c',
                    Xu = 'App_closeButton_75',
                    $u = 'App_title_4c',
                    Ku = 'App_cardsContainer_22',
                    zu = 'App_arrow_ae',
                    Vu = 'App_arrow__second_f9',
                    qu = 'App_card_98',
                    Yu = 'App_cardImage_8a',
                    Zu = 'App_cardTitle_55',
                    Qu = 'App_cardDescription_89',
                    Ju = 'App_footer_27',
                    ue = 'App_footerButton_37',
                    ee = R.strings.event.summerSales.introView,
                    te = ['first', 'second', 'third'],
                    re = (0, Ru.Pi)(() => {
                        const u = Gu().controls,
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(Lu, {
                                        side: 'right',
                                        type: 'close',
                                        caption: ee.closeButton(),
                                        onClick: u.close,
                                    }),
                                ),
                                a().createElement(xu, { className: $u, text: ee.header.title() }),
                                a().createElement(
                                    'div',
                                    { className: Ku },
                                    ...
                                    te.map((u) =>
                                        a().createElement(
                                            ...
                                            a().createElement('div', {
                                                className: Yu,
                                                style: {
                                                    backgroundImage: `url(R.images.gui.maps.icons.event.summerSale.intro.Card_${u}${r})`,
                                                },
                                            }),
                                            a().createElement(xu, { className: Zu, text: String(ee.title.$dyn(u)) }),
                                            a().createElement(xu, {
                                                className: Qu,
                                                text: String(ee.description.$dyn(u)),
                                            }),
                                        ),
                                    ),
                                ),
                                a().createElement(
                                    ...
                                    a().createElement(
                                        j,
                                        { mixClass: ue, onClick: u.close, type: I.primary, size: t },
                                        a().createElement(xu, { text: ee.closeButtonText() }),
                                    ),
                                    a().createElement(
                                        j,
                                        { mixClass: ue, onClick: u.toFeature, type: I.secondary, size: t },
                                        a().createElement(xu, { text: ee.goToFeatureButton() }),
                                    ),
                                ),
                            )
                        );
                ...
                engine.whenReady.then(() => {
                    k().render(
                        a().createElement(Iu, null, a().createElement(H, null, a().createElement(re, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [228], () => __webpack_require__(657));
