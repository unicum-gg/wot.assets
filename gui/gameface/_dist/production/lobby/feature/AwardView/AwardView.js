    ...
    var __webpack_modules__ = {
            ...
            3649: (u, e, t) => {
                ...
                const E = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    A = (u, e, t = a.left) => u.split(e).reduce(t === a.left ? o : s, []),
                    l = (() => {
                        const u = new RegExp(
                                          ...
                                          : 'ja' === t
                                            ...
                                            : ((u, e = a.left) => {
                                                  ...
                                                  const r =
                                                      ...
                                                      n = E(u);
                                                  return (
                                                      A(n, /( )/, e).forEach((u) => (t = t.concat(A(u, r, a.left)))), t
                                                  );
                                              })(u, e);
                                  })(u, e),
                        );
            ...
            7919: (u, e, t) => {
                ...
                const x = {
                    ...
                    T = (u) => {
                        ...
                        const i = (() => {
                            ...
                            o = i.mediaHeight,
                            s = i.mediaSize;
                        return a().createElement('div', f({ className: m()(t, x[E], L[o], y[s]) }, n), e);
                    },
                    S = ['children'],
                    M = (u) => {
                        let e = u.children,
                ...
                class W extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = m()(N.base, N[`base__${i}`], N[`base__${n}`], null == E ? void 0 : E.base),
                            c = m()(N.icon, N[`icon__${i}`], N[`icon__${n}`], null == E ? void 0 : E.icon),
                            d = m()(N.glow, null == E ? void 0 : E.glow),
                            B = m()(N.caption, N[`caption__${i}`], null == E ? void 0 : E.caption),
                            C = m()(N.goto, null == E ? void 0 : E.goto);
                ...
                function U(u = G.n.NONE, e = V, t = !1, a = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== G.n.NONE)
                            return (
                        ...
                        return [
                            function ({ mode: u = 'real', options: n, children: E, mocks: o }) {
                                const s = (0, r.useRef)([]),
                                    ...
                                    D = F[0],
                                    c = F[1],
                                    d = (0, r.useState)(() => A(u, n, o)),
                                    B = d[0],
                                    C = d[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? C(A(D, n, o)) : (l.current = !0);
                                    }, [o, D, n]),
                                    (0, r.useEffect)(() => {
                                        c(u);
                                    }, [u]),
                ...
                var Q = t(3419),
                    ...
                    uu = t(8225),
                    eu = t(7631);
                const tu = R.strings.resource_well,
                    ru = (0, $.Pi)(() => {
                        const u = Z(),
                            e = u.model,
                            t = u.controls,
                            ...
                            i = n.personalNumber,
                            E = n.rewardIndex,
                            o = i ? tu.awardView.vehicleNumberedTitle() : tu.awardView.vehicleTitle(),
                            s = {
                        ...
                        return (
                            ...
                            U(G.n.ESCAPE, A),
                            (0, r.useEffect)(() => {
                                (0, H.G)('gui_hangar_award_screen'),
                                    ((u, e) => {
                                        let t;
                                        setTimeout(() => {
                                            t = (0, H.G)('gui_hangar_award_tank_01');
                                        }, 850);
                                    })();
                            }, []),
                            a().createElement(
                                ...
                                a().createElement(uu.h, {
                                    title: o,
                                    subTitle: tu.commonTexts.eventTitle(),
                                    classNames: {
                                        base: 'App_header_62',
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: 'App_rewards_7c', style: s },
                                ...
                                a().createElement(J.$, { onConfirmClick: t.showInHangar, className: 'App_footer_a3' }),
                                a().createElement(
                                    'div',
                                    { className: 'App_close_f3' },
                                    a().createElement(W, {
                                        caption: tu.commonTexts.closeBtn(),
                                        type: 'close',
                                        side: 'right',
                                        onClick: t.close,
                                    }),
                ...
                engine.whenReady.then(() => {
                    k().render(
                        a().createElement(X, null, a().createElement(M, null, a().createElement(ru, null))),
            ...
            5617: (u, e, t) => {
                ...
                const l = ({ vehicleInfo: u, theme: e, className: t }) => {
                    ...
                    return o().createElement(
                        'div',
                        { className: a()(s.base, s[`base__${e}`], t) },
                        (0, n.cg)(r),
                        o().createElement(
                            'div',
                        ...
                        const f = (0, E.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            L = (0, E.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (l(t, _, { isMouseEvent: !0, on: !0, arguments: A(r) }, x),
                                    w && w(),
