(() => {
                        ...
                        const u = j(),
                            t = ((e) => {
                                switch (`${e.width}x${e.height}`) {
                                    ...
                                    default:
                                        return (
                                            console.error(`[DoorSize] Unknown size! (${e.width}x${e.height})`), Cu.S1x1
                                        );
                                }
                            })(e),
                            a = Lu[t],
                                ...
                                return (
                                    ...
                                    (0, n.useEffect)(() => {
                                        t.current.clear(),
                                            u.reduce(
                                                (e, u) => (
                                                    Yu(t.current, u, e.frameOffset), (e.frameOffset += u.frameCount), e
                                                ),
                                                { frameOffset: 0 },
                                            );
                                    }, [u, e]),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1761));
