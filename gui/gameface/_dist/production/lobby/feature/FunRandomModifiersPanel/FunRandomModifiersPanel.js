    ...
    var __webpack_modules__ = {
            ...
            3605: (u, e, t) => {
                ...
                const l = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const B = (0, r.useRef)([]),
                                    s = (u, t, r) => {
                                        ...
                                        const A = (function ({
                                            ...
                                            _ = { mode: u, model: C, externalModel: n, cleanup: s };
                                        return {
                                            model: C,
                                    ...
                                    c = _[0],
                                    d = _[1],
                                    m = (0, r.useState)(() => s(u, A, F)),
                                    h = m[0],
                                    g = m[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        C.current ? g(s(c, A, F)) : (C.current = !0);
                                    }, [F, c, A]),
                                    (0, r.useEffect)(() => {
                                        d(u);
                                    }, [u]),
                                    (0, r.useEffect)(
                                        () => () => {
                                            (h.externalModel.dispose(), B.current.forEach((u) => u()));
                                        },
                                        [h],
                                    ),
                    ...
                    })(0, ({ externalModel: u }) => ({ onMapsViewOpen: u.createCallbackNoArgs('onWidgetClick') })),
                    s = B[0],
                    C = B[1];
                var _ = t(6483),
                    c = t.n(_),
                ...
                const w = D.O.client.getSize('rem'),
                    ...
                    L = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.smallWidth && B) return h(e, t, g);
                            if (t.extraSmallWidth && s) return h(e, t, g);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                const j = {
                    ...
                    K = W((u) => {
                        ...
                        const K = (0, r.useMemo)(() => {
                            ...
                            }, [t, A, a, D, l, s, H, k, M, m, T, x, S]),
                            z = K.computedStyle,
                            q = K.computedClassNames;
                        return E().createElement('div', U({ className: c()(I.base, ...q, e), style: z }, W), N);
                    });
                let z;
                !(function (u) {
                            ...
                            Eu(
                                {
                                    ...
                                    mb: !0 === B ? iu[t || 'paragraph-P16'].mb : B,
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Cu(t, s, { isMouseEvent: !0, on: !0, arguments: su(E) }, v),
                                    m && m(),
                ...
                engine.whenReady.then(() => {
                    n().render(
                        E().createElement(s, null, E().createElement(pu, null)),
