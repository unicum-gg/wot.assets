(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => r, off: () => a, on: () => o, onResize: () => F, onScaleUpdated: () => n });
                var E = t(2472),
                    A = t(1176);
            ...
            9916: (u, e, t) => {
                ...
                function c(u, e, t, E, A, F, n) {
                    ...
                    o.done ? e(a) : Promise.resolve(a).then(E, A);
                }
            ...
            223: (u, e, t) => {
                ...
                let o;
                !(function (u) {
                    (u.DOORS_AVAILABLE = 'doorsAvailable'),
                        (u.FIRST_ENTRY = 'firstEntry'),
                        (u.POST_EVENT = 'postEvent');
                })(o || (o = {}));
                var a = t(3403);
                function D() {
                    return !1;
                ...
                const s = (u) => (0 === u ? window : window.subViews.get(u)),
                    C = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: F, children: n, mocks: o }) {
                                const a = (0, E.useRef)([]),
                                    C = (u, t, E) => {
                                        var A;
                                        const F = (function ({
                                            ...
                                            c = { mode: u, model: l, externalModel: n, cleanup: C };
                                        return {
                                            model: l,
                                    ...
                                    _ = c[0],
                                    d = c[1],
                                    m = (0, E.useState)(() => C(u, F, o)),
                                    v = m[0],
                                    b = m[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        l.current ? b(C(_, F, o)) : (l.current = !0);
                                    }, [o, _, F]),
                                    (0, E.useEffect)(() => {
                                        d(u);
                                    }, [u]),
                                    (0, E.useEffect)(
                                        () => () => {
                                            v.externalModel.dispose(), a.current.forEach((u) => u());
                                        },
                                        [v],
                                    ),
                ...
                const p = ({
                    ...
                    return (
                        (0, E.useEffect)(() => {
                            function u(u) {
                                v && null !== c.current && !c.current.contains(u.target) && g(!1);
                            }
                            return (
                        ...
                        A().createElement(
                            ...
                            A().createElement(
                                'span',
                                { className: d()(b.state, b.state__default) },
                ...
                p.defaultProps = { type: h.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const f = p;
                var w = t(1281);
                let y;
                !(function (u) {
                ...
                const T = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    k = (u, e, t = y.left) => u.split(e).reduce(t === y.left ? O : x, []),
                    P = (() => {
                        const u = new RegExp(
                    ...
                    N = ['zh_cn', 'zh_sg', 'zh_tw'],
                    M = ({ binding: u, text: e = '', classMix: t, alignment: F = y.left, formatWithBrackets: n }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const o = n && u ? ((a = u), e.replace(/\{\w+\}/g, (u) => String(a[u.slice(1, -1)]))) : e;
                        var a;
                        return A().createElement(
                            ...
                            o.split('\n').map((e, n) =>
                                A().createElement(
                                    'div',
                                    { className: d()('FormatText_base_d0', t), key: `${e}-${n}` },
                                    ((u, e, t) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                            t && u in t
                                                ? t[u]
                    ...
                    L = ({ classNames: u }) =>
                        A().createElement('div', {
                            className: d()('CloseButton_base_9f', null == u ? void 0 : u.base),
                            onMouseEnter: v.playHighlight,
                            onClick: () => m(R.sounds.cancelcloseno()),
                        }),
                    U = ({ children: u, isPopUp: e, background: t }) => {
                        var F;
                        return (
                            (F = () => {
                                e && m(R.sounds.hangar_newyear_notification());
                            }),
                            (0, E.useEffect)(F, []),
                            A().createElement(
                                'div',
                                {
                                    className: d()(
                                        'NotificationDecorator_base_e0',
                                        e && 'NotificationDecorator_base__popUp_9f',
                                    ),
                                    lang: R.strings.settings.LANGUAGE_CODE(),
                                },
                                A().createElement('div', { className: 'NotificationDecorator_content_dc' }, u),
                                e &&
                                    A().createElement(L, {
                                        classNames: { base: 'NotificationDecorator_closeButton_21' },
                                    }),
                                A().createElement(
                                    'div',
                                    { className: 'NotificationDecorator_backgroundWrapper_0a' },
                                    t || A().createElement(S, { isPopUp: e }),
                                ),
                                !e &&
                                    A().createElement(
                                        A().Fragment,
                                        null,
                                        A().createElement('div', { className: 'NotificationDecorator_lipTop_9d' }),
                                        A().createElement('div', { className: 'NotificationDecorator_lipBottom_0b' }),
                                    ),
                            )
                        );
                    },
                    W = R.strings.advent_calendar.notification.adventCalendarDoorsAvailable.event,
                    I = (0, a.Pi)(() => {
                        const u = c(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                {
                                    className: d()(
                                        'EventNotification_base_76',
                                        n && 'EventNotification_base__popUp_13',
                                        D && 'EventNotification_base__withDescription_a5',
                                    ),
                                },
                                A().createElement(
                                    'div',
                                    { className: 'EventNotification_titleWrapper_c0' },
                                    A().createElement(M, { text: W.title(), classMix: 'EventNotification_title_d9' }),
                                ),
                                A().createElement('div', { className: 'EventNotification_rewardImage_da' }),
                                D &&
                                    A().createElement(M, {
                                        text: W.description(),
                                        classMix: 'EventNotification_description_e9',
                                    }),
                                A().createElement(
                                    'div',
                                    null,
                                    A().createElement(
                                        f,
                                        {
                                            ...
                                            onClick: t.onClick,
                                            size: g.medium,
                                            mixClass: 'EventNotification_button_b4',
                                            disabled: a,
                                        },
                                        W.action(),
                                    ),
                ...
                const z = (0, E.memo)((u) => {
                    ...
                    const n = ((u, e) => {
                            ...
                            for (; o; ) {
                                ...
                                if (B && s) {
                                    const u = B[0],
                                        t = u + D++ + s[0].replaceAll(')', '') + u;
                                    (a = a.replace(i, `%(${t})`)),
                                        (n[t] = G[u]
                                            ? A().createElement(
                                                  'span',
                                                  { className: G[u] },
                                                  A().createElement(M, { text: C, binding: e }),
                                              )
                                            : A().createElement(
                                                  'span',
                                                  { style: ((r = u), { color: `#${r}` }) },
                        ...
                        o = n[0],
                        a = n[1];
                    return A().createElement(M, j({ text: o, classMix: E, binding: a }, F));
                });
                let H;
                var q;
                ((q = H || (H = {})).DayMonthNumeric = 'dayMonthNumeric'),
                    (q.DayMonthFull = 'dayMonthFull'),
                    (q.DayMonthFullTime = 'dayMonthFullTime'),
                    (q.DayMonthAbbreviated = 'dayMonthAbbreviated'),
                    (q.DayMonthAbbreviatedTime = 'dayMonthAbbreviatedTime'),
                    (q.ShortDate = 'shortDate'),
                    (q.ShortTime = 'ShortTime'),
                    (q.ShortDateTime = 'ShortDateTime'),
                    (q.FullDate = 'fullDate'),
                    (q.FullTime = 'fullTime'),
                    (q.FullDateTime = 'fullDateTime'),
                    t(9916);
                var K = t(8613);
                Date.now();
                const Y = K.Ew.getRegionalDateTime;
                K.Ew.getFormattedDateTime;
                const $ = (u, e = !0) => Y(u, H.DayMonthFull, e),
                    Z = R.strings.advent_calendar.notification.adventCalendarDoorsAvailable.postEvent,
                    X = (0, a.Pi)(() => {
                        const u = c(),
                            e = u.model,
                            t = u.controls,
                            ...
                            F = E.isPopUp,
                            n = E.eventEndDate,
                            o = E.isButtonDisabled;
                        return A().createElement(
                            'div',
                            {
                                className: d()(
                                    'PostEventNotification_base_1d',
                                    F && 'PostEventNotification_base__popUp_c8',
                                ),
                            },
                            F && A().createElement('div', { className: 'PostEventNotification_background_04' }),
                            A().createElement(
                                'div',
                                { className: 'PostEventNotification_content_9f' },
                                A().createElement('div', { className: 'PostEventNotification_image_1d' }),
                                A().createElement('div', { className: 'PostEventNotification_title_d1' }, Z.title()),
                                A().createElement(
                                    'div',
                                    { className: 'PostEventNotification_descriptionWrapper_c4' },
                                    A().createElement(z, {
                                        text: Z.description(),
                                        binding: { date: $(n, !0) },
                                        className: 'PostEventNotification_description_bc',
                                    }),
                                ),
                                A().createElement(
                                    'div',
                                    { className: 'PostEventNotification_button_df' },
                                    A().createElement(
                                        f,
                                        { size: g.small, onClick: t.onClick, disabled: o },
                                        Z.action(),
                                    ),
                                ),
                            ),
                    ...
                    Q = (0, a.Pi)(() =>
                        c().model.root.get().state === o.POST_EVENT
                            ? A().createElement(X, null)
                            : A().createElement(I, null),
                    );
                engine.whenReady.then(() => {
                    n().render(A().createElement(l, null, A().createElement(Q, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(223));
