(() => {
    var __webpack_modules__ = {
            ...
            463: (u, e, t) => {
                ...
                (!(function (u) {
                    ...
                    (re.Small = 'small'),
                    (re.Mini = 'mini'),
                    (re.S600x450 = 's600x450'),
                    (re.S400x300 = 's400x300'),
                    (re.S296x222 = 's296x222'),
                    (re.S232x174 = 's232x174'),
                    (re.S180x135 = 's180x135'),
                    (re.S128x100 = 's128x100'),
                    (re.S80x80 = 's80x80'),
                    (re.S48x48 = 's48x48'),
                    ((te = Zu || (Zu = {})).MULTI = 'multi'),
                    (te.CURRENCY = 'currency'),
                    (te.PREMIUM_PLUS = 'premium_plus'),
                    (te.NUMBER = 'number'),
                    (te.STRING = 'string'),
                    (function (u) {
                ...
                ((ae.defaultProps = { format: 'integral' }),
                    ...
                    zu.GoldenTicket,
                    zu.PostStamp,
                    zu.BlankPersonalMissions_1,
                    zu.BlankPersonalMissions_2,
                    zu.SACoin,
                ...
                const me = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return n || i
                        ? a().createElement(qu, Fe({}, e, { contentId: n || i }), r)
                        ...
                        const A = ((u) => {
                            ...
                            m = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case Zu.CURRENCY:
                                    case Zu.NUMBER:
                                        return a().createElement(ae, { format: 'integral', value: Number(u) });
                ...
                (!(function (u) {
                    ...
                    (function (u) {
                        ((u.Disabled = 'disabled'), (u.Active = 'active'), (u.Completed = 'completed'));
                    })(rt || (rt = {})),
                    rt.Active,
                    rt.Disabled,
                    rt.Completed,
                ...
                const it = {
                    ...
                    ot = R.strings.armory_shop.shopBuyView.vehicleImage,
                    lt = ({
                        image: u,
                        size: e = at.C_360x270,
                        special: t,
                        ...
                        return a().createElement(
                            'div',
                            { className: C()(it.base, it[`base__${e}`], n), style: r },
                            a().createElement(
                                'div',
                                { className: C()(it.image, null == s ? void 0 : s.image) },
                                o &&
                                    a().createElement('div', {
                                        className: C()(it.highlight, null == s ? void 0 : s.highlight),
                                        style: {
                                ...
                                u &&
                                    a().createElement('div', {
                                        className: C()(it.icon, null == s ? void 0 : s.productIcon),
                                        style: { backgroundImage: `url(${u})` },
                                    }),
                                l &&
                                    a().createElement('div', {
                                        className: C()(it.overlay, null == s ? void 0 : s.overlay),
                                        style: {
                                ...
                                i &&
                                    a().createElement(
                                        ...
                                        a().createElement(Nu, { label: ot.preview(), onClick: i }),
                                    ),
                            ),
                        );
                    };
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : o(e),
                                                            a = _t.observable.box(r, { equals: Et });
                                                        return (
                                                            'real' === u &&
                                                                i.subscribe(
                                                                    (0, _t.action)((u) => a.set(u)),
                                                                    e,
                                                                ),
                                                            a
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const a = e.reduce(
                                                                (u, e) => ((u[e] = _t.observable.box(r[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                ...
                const Bt = (0, Mu.observer)(() => {
                    ...
                    const n = t.root.get(),
                        ...
                        o = n.icon,
                        l = n.description,
                        E = { image: o, special: n.itemType, size: at.C_360x270 };
                    return (
                        (0, r.useEffect)(() => {
                            I('shop_buy_prem');
                        }, []),
                        a().createElement(
                            ...
                            a().createElement('div', { className: 'App_image_d9' }, a().createElement(lt, E)),
                ...
                engine.whenReady.then(() => {
                    N().render(
                        a().createElement(mt, null, a().createElement(y, null, a().createElement(Bt, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(463));
