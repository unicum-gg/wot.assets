(() => {
    ...
    var e,
        t = {
            4577: (e, t, n) => {
                var r = {};
                (n.r(r),
                    n.d(r, { mouse: () => y, off: () => w, on: () => b, onResize: () => g, onScaleUpdated: () => p }));
                var o = {};
                (n.r(o),
                    n.d(o, {
                        events: () => r,
                ...
                var i = {};
                (n.r(i), n.d(i, { getBgUrl: () => A, getTextureUrl: () => M }));
                var a = {};
                (n.r(a),
                    n.d(a, {
                        addModelObserver: () => G,
                ...
                const C = {
                    ...
                    S = Object.keys(T).reduce((e, t) => ((e[t] = () => E(T[t])), e), {}),
                    O = { play: Object.assign({}, S, { sound: E }), setRTPC: _ },
                ...
                const re = (() => {
                    ...
                    ie = Object.keys(k).reduce((e, t) => ((e[t] = () => viewEnv.getShowingStatus() === k[t]), e), {}),
                    ae = {
                        set: (e, t) => {
                ...
                const ve = l().forwardRef(function (e, t) {
                    let n = e.children,
                        r = e.className,
                        o = e.theme,
                    ...
                    return (
                        ...
                        l().createElement(
                            'div',
                            de({}, a, {
                                className: v()(ce.base, ce[`base__theme-${i}`], r),
                                ref: function (e) {
                                    ((u.current = e), 'function' == typeof t ? t(e) : t && (t.current = e));
                                },
                            }),
                            l().createElement('div', { className: ce.decorator }, n),
                        )
                    );
                });
                var fe = n(3403);
                ...
                const be = (e) => (0 === e ? window : window.subViews.get(e)),
                        ...
                        return [
                            function ({ mode: e = 'real', options: r, children: o, mocks: i }) {
                                ...
                                return (
                                    ...
                                    l().createElement(n.Provider, { value: g }, o)
                                );
                            },
                            () => (0, s.useContext)(n),
                        ];
                    ...
                    he = we[0],
                    ye = we[1],
                    Ee = 'Content_separator_9c',
                    _e = R.strings.resource_well.tooltips.progressbar,
                    Pe = (0, fe.Pi)(() => {
                        const e = ye().model.root.get(),
                            t = e.currentProgress,
                            n = e.progressDiff,
                            r = e.needShowDiff;
                        return l().createElement(
                            'div',
                            { className: 'Content_base_4c' },
                            l().createElement(
                                'div',
                                { className: 'Content_content_ed' },
                                l().createElement('div', { className: 'Content_title_dd' }, _e.title()),
                                l().createElement(
                                    'div',
                                    { className: 'Content_descriptionBlock_f3' },
                                    _e.description(),
                                ),
                                l().createElement(
                                    'div',
                                    { className: 'Content_separatorTopWrapper_5b' },
                                ...
                                l().createElement(
                                    ...
                                    {
                                        className: v()(
                                            'Content_percentProgressWrapper_00',
                                            r && 'Content_percentProgressWrapper__resourcesLoading_db',
                                        ),
                                    },
                                    l().createElement(
                                        'div',
                                        { className: 'Content_currentProgress_dd' },
                                        l().createElement(
                                            'div',
                                            { className: 'Content_loadedText_01' },
                                            _e.resourcesLoaded.label(),
                                        ),
                                        l().createElement(
                                            'div',
                                            {
                                                className: v()(
                                                    'Content_currentPercent_c5',
                                                    0 === t && 'Content_currentPercent__null_98',
                                                ),
                                            },
                                            `${t}${0 === t ? '' : '%'}`,
                                        ),
                                    ...
                                    r &&
                                        l().createElement(
                                            'div',
                                            { className: 'Content_progressDiff_66' },
                                            l().createElement(
                                                'div',
                                                { className: 'Content_chosenText_84' },
                                                _e.resourcesChosen.label(),
                                            ),
                                            l().createElement(
                                                'div',
                                                {
                                                    className: v()(
                                                        'Content_diffPercent_d7',
                                                        0 === n && 'Content_diffPercent__null_35',
                                                    ),
                                                },
                                                0 === n ? n : `+${n}%`,
                                            ),
                                ...
                                l().createElement(
                                    'div',
                                    { className: 'Content_separatorBottomWrapper_7a' },
                                    l().createElement('div', { className: Ee }),
                                ),
                                l().createElement('div', { className: 'Content_moreInfo_7c' }, _e.moreInfo()),
                            ),
                        );
                    }),
                    xe = () => l().createElement(ve, null, l().createElement(Pe, null));
                engine.whenReady.then(() => {
                    u().render(
                        l().createElement(he, null, l().createElement(xe, null)),
    ...
    ((r.m = t),
        ...
        (r.j = 'lobby/feature/tooltips/ProgressTooltip/ProgressTooltip'),
        (() => {
            var e = { 'lobby/feature/tooltips/ProgressTooltip/ProgressTooltip': 0 };
            r.O.j = (t) => 0 === e[t];
            var t = (t, n) => {
                    var o,
                        i,
    ...
    var o = r.O(void 0, ['lib/resource_well.vendors'], () => r(4577));
    o = r.O(o);
})();
