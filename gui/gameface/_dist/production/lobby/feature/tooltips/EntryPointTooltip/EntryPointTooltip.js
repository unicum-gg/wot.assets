(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                (t.r(e),
                    t.d(e, { mouse: () => l, off: () => A, on: () => E, onResize: () => a, onScaleUpdated: () => i }));
                var r = t(2472),
                    n = t(1176);
            ...
            9916: (u, e, t) => {
                'use strict';
                t.d(e, { Sw: () => a.Z, B3: () => o, Z5: () => i.Z5, B0: () => E, ry: () => m });
                class r {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            3: (u, e, t) => {
                ...
                const l = i.O.client.getSize('rem'),
                    s = l.width,
                    F = l.height,
                    D = Object.assign({ width: s, height: F }, o(s, F, E)),
                ...
                const C = ({ children: u }) => {
                    ...
                    (((u) => {
                        ...
                        (i.O.client.events.on('clientResized', l), i.O.client.events.on('self.onScaleUpdated', s));
                    }),
                        (0, r.useEffect)(
                            () => () => {
                ...
                const S = {
                    ...
                    L = (u) => {
                        ...
                        const i = (() => {
                            ...
                            A = i.mediaHeight,
                            o = i.mediaSize;
                        return n().createElement('div', p({ className: _()(t, S[E], x[A], T[o]) }, a), e);
                    },
                    y = ['children'],
                    O = (u) => {
                        let e = u.children,
                ...
                const H = n().forwardRef(function (u, e) {
                    let t = u.children,
                        a = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            k({}, o, {
                                className: _()(I.base, I[`base__theme-${A}`], a),
                                ref: function (u) {
                                ...
                                const o = (0, r.useRef)([]),
                                    l = (u, t, r) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            F = { mode: u, model: s, externalModel: E, cleanup: l };
                                        return {
                                            model: s,
                                    ...
                                    D = F[0],
                                    c = F[1],
                                    d = (0, r.useState)(() => l(u, a, A)),
                                    B = d[0],
                                    C = d[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        s.current ? C(l(D, a, A)) : (s.current = !0);
                                    }, [A, D, a]),
                                    (0, r.useEffect)(() => {
                                        c(u);
                                    }, [u]),
                ...
                const au = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Au = (u, e, t = ru.left) => u.split(e).reduce(t === ru.left ? iu : Eu, []),
                    ou = (() => {
                        const u = new RegExp(
                    ...
                    su = ({ binding: u, text: e = '', classMix: t, alignment: a = ru.left, formatWithBrackets: i }) => {
                    ...
                    Fu = R.strings.resource_well.tooltips.entryPoint,
                    Du = {
                        [Y.NOT_STARTED]: 'notStarted',
                        [Y.PAUSED]: 'paused',
                        [Y.FORBIDDEN]: 'forbidden',
                        [Y.IN_PROGRESS]: 'inProgress',
                    },
                    cu = 'RewardsCounter_text_a1',
                    du = 'RewardsCounter_text__vertical_b1',
                    Bu = 'RewardsCounter_accent_49',
                    Cu = 'RewardsCounter_countBack_14',
                    mu = ({
                        label: u,
                        count: e = 0,
                        textSoldOut: t = '',
                        ...
                        n().createElement(
                            ...
                            {
                                className: _()(
                                    'RewardsCounter_base_af',
                                    a && 'RewardsCounter_base__vertical_3e',
                                    t && 'RewardsCounter_base__soldOut_bf',
                                    i,
                                ),
                            },
                            e > 0
                                ? n().createElement(
                                      'div',
                                      { className: _()(cu, a && du) },
                                      n().createElement('span', { className: 'RewardsCounter_label_56' }, u),
                                      n().createElement(
                                          'span',
                                          { className: Bu },
                                          n().createElement('span', { className: Cu }),
                                          (r || e <= 1e4) &&
                                              n().createElement('span', { className: 'RewardsCounter_countGlow_09' }),
                                          n().createElement(eu, { format: 'integral', value: e }),
                                      ),
                                  )
                                : n().createElement(su, {
                                      text: u,
                                      binding: {
                                          accentText: n().createElement(
                                              'div',
                                              { className: Bu },
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (hu(t, c, { isMouseEvent: !0, on: !0, arguments: gu(n) }, w),
                                    _ && _(),
                            ...
                            fu(
                                {
                                    contentId:
                                        ...
                                        s ? bu.SimpleTooltipHtmlContent('resId') : bu.SimpleTooltipContent('resId')),
                ...
                var xu = t(8613);
                const Tu = (Date.now(), xu.Ew.getRegionalDateTime);
                xu.Ew.getFormattedDateTime;
                const Lu = () => {};
                let yu;
                (uu.Sw.instance,
                    (function (u) {
                ...
                const Mu = 'TimerEntryPointTooltip_text_50',
                    Pu = R.strings.resource_well,
                    Iu = ({ isEventEndingSoon: u, leftTime: e, untilTime: t, beforeEventTime: r, startDate: a }) =>
                        n().createElement(
                            'div',
                            ...
                            u
                                ? n().createElement(
                                      ...
                                      n().createElement('div', { className: 'TimerEntryPointTooltip_leftTime_98' }, e),
                                  )
                                : n().createElement(
                                      n().Fragment,
                                      null,
                    ...
                    ku = ({ isEventEndingSoon: u, leftTime: e, untilTime: t, showShine: r = !0 }) => {
                        const a = _()(
                            'TimerMainScreen_content_2d',
                            u ? 'TimerMainScreen_content__endingSoon_bb' : 'TimerMainScreen_content__daysLeft_7f',
                        );
                        return n().createElement(
                            n().Fragment,
                            null,
                            r &&
                                n().createElement(
                                    ...
                                    n().createElement('div', { className: 'TimerMainScreen_shineBg_aa' }),
                                ),
                            n().createElement(
                                'div',
                                { className: a },
                                n().createElement(
                                    ...
                                    u ? Nu.mainView.timer.leftTime() : Nu.mainView.timer.lastUntil(),
                                ),
                                n().createElement('div', { className: 'TimerMainScreen_time_5b' }, u ? e : t),
                            ),
                        );
                    },
                    ...
                    Wu = (u) =>
                        ((u, e = !0) =>
                            u.days > 7 && e
                                ? nu(R.strings.common.duration.days(), { days: u.days })
                                : u.days >= 1
                                  ? 0 === u.hours
                                      ? nu(R.strings.common.duration.days(), { days: u.days })
                                      : nu(R.strings.common.duration.days(), { days: u.days + 1 })
                                  : u.hours >= 1
                                    ? 0 === u.minutes
                                        ? nu(R.strings.common.duration.hours(), { hours: u.hours })
                                        : nu(R.strings.common.duration.hours(), { hours: u.hours + 1 })
                                    : nu(R.strings.common.duration.minutes(), { minutes: u.minutes || 1 }))(
                            (function (u = 0) {
                                let e = u;
                    ...
                    Uu = ({
                        ...
                        const E = Ou(r),
                            ...
                            o = i,
                            l =
                                ((s = Hu.tooltips.mainView.timer.leftTime()),
                                (F = { leftTime: Wu(E) }),
                                s.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                u === Ru.entryPointTooltip
                                    ? n().createElement(Iu, {
                                          isEventEndingSoon: t,
                                          leftTime: Wu(E),
                                          untilTime: Tu(A, Su.DayMonthFullTime),
                                          beforeEventTime: Tu(o, Su.DayMonthFullTime),
                                          startDate: i,
                                      })
                                    : n().createElement(ku, {
                                          isEventEndingSoon: t,
                    ...
                    Gu = ({
                        ...
                        n().createElement(
                            'div',
                            { className: _()('EventTimer_base_d5', a) },
                            n().createElement(
                                'div',
                                { className: 'EventTimer_icon_2a' },
                                n().createElement('div', { className: 'EventTimer_image_d9' }),
                            ),
                            n().createElement(Uu, {
                                startDate: r,
                                endDate: u,
                                isEventEndingSoon: e,
                                timeLeft: t,
                                usagePlace: Ru.entryPointTooltip,
                            }),
                        ),
                    Vu = {
                        base: 'Message_base_b5',
                        base__centered: 'Message_base__centered_c4',
                        base__warning: 'Message_base__warning_b1',
                        icon: 'Message_icon_a4',
                        base__default: 'Message_base__default_bb',
                        base__completed: 'Message_base__completed_23',
                        text: 'Message_text_22',
                    },
                    ju = 'warning',
                    $u = 'completed',
                    zu = ({ text: u, type: e = 'default', centered: t }) =>
                        n().createElement(
                            'div',
                            { className: _()(Vu.base, Vu[`base__${e}`], t && Vu.base__centered) },
                            n().createElement('div', { className: Vu.icon }),
                            n().createElement('div', { className: Vu.text }, u),
                        ),
                    qu = 'Content_timer_f5',
                    Ku = 'Content_highlight_8a',
                    Yu = 'Content_textCompleted_55',
                    Xu = (0, W.Pi)(() => {
                        const u = q().model;
                        return n().createElement(
                            'div',
                            { className: 'Rewards_base_cc' },
                            ((e = u.rewards.get()),
                            (t = (u, e) => {
                                const t = u.vehicleName,
                                    r = u.rewardCount,
                                    a = u.rewardState,
                                    i = u.isSerial;
                                return n().createElement(
                                    'div',
                                    { className: 'Rewards_item_9f', key: `${e}${t}` },
                                    n().createElement('div', { className: 'Rewards_name_ee' }, t),
                                    (() => {
                                        switch (a) {
                                            case J.RECEIVED:
                                                return n().createElement(zu, {
                                                    text: Fu.rewardReceived.text(),
                                                    type: $u,
                                                });
                                            case J.IN_GARAGE:
                                                return n().createElement(zu, {
                                                    text: Fu.rewardInGarage.text(),
                                                    type: $u,
                                                });
                                            case J.SOLD_OUT:
                                                return n().createElement(zu, { text: Fu.rewardSoldOut.text() });
                                            default:
                                                return n().createElement(mu, {
                                                    label: Fu.rewardAvailableCount.text(),
                                                    count: r,
                                                    serial: i,
                                                });
                                        }
                    ...
                    Zu = (0, W.Pi)(() => {
                        const u = q().model,
                            e = u.rewards.get(),
                            t = Z(e, (u) => u.rewardState === J.SOLD_OUT),
                            r = Z(e, (u) => u.rewardState === J.RECEIVED || u.rewardState === J.IN_GARAGE);
                        return n().createElement(
                            n().Fragment,
                            null,
                            n().createElement(Gu, {
                                endDate: u.endDate.get(),
                                isEventEndingSoon: u.isEventEndingSoon.get(),
                                timeLeft: u.timeLeft.get(),
                                className: qu,
                            }),
                            (() => {
                                switch (!0) {
                                    case t:
                                        return n().createElement(mu, {
                                            label: Fu.rewardsSoldOut.text(),
                                            textSoldOut: Fu.rewardsSoldOut.accentText.text(),
                                            vertical: !0,
                                        });
                                    case r:
                                        return n().createElement(
                                    ...
                                    default:
                                        return n().createElement(
                                            n().Fragment,
                                            null,
                                            n().createElement('div', { className: 'Content_divider_df' }),
                    ...
                    ee = 'receivedSecond',
                    te = 'soldOut',
                    re = (u) => u === J.RECEIVED || u === J.IN_GARAGE,
                    ne = {
                        base: 'ProductImage_base_9a',
                        base__forbidden: 'ProductImage_base__forbidden_00',
                        base__paused: 'ProductImage_base__paused_17',
                        base__notStarted: 'ProductImage_base__notStarted_6f',
                        base__availableFirst: 'ProductImage_base__availableFirst_35',
                        base__availableSecond: 'ProductImage_base__availableSecond_51',
                        base__availableBoth: 'ProductImage_base__availableBoth_d4',
                        base__receivedFirst: 'ProductImage_base__receivedFirst_6c',
                        base__receivedSecond: 'ProductImage_base__receivedSecond_47',
                        base__receivedBoth: 'ProductImage_base__receivedBoth_12',
                        base__soldOut: 'ProductImage_base__soldOut_21',
                    },
                    ae = (u, e, t) => {
                        switch (u) {
                            case K.ONE_SERIAL_PRODUCT:
                                return ((u) => (re(u) ? ue : u === J.AVAILABLE ? Qu : te))(e);
                            case K.SEQUENTIAL_PRODUCT:
                                return ((u, e) =>
                                    re(u) ? ue : re(e) ? ee : u === J.AVAILABLE ? Qu : e === J.AVAILABLE ? Ju : te)(
                                    e,
                                    t,
                                );
                            case K.TWO_PARALLEL_PRODUCTS:
                                return ((u, e) =>
                                    u === J.AVAILABLE && e === J.AVAILABLE
                                        ? 'availableBoth'
                                        : u === J.AVAILABLE
                                          ? Qu
                                          : e === J.AVAILABLE
                    ...
                    ie = (0, W.Pi)(({ className: u }) => {
                        ...
                        return n().createElement('div', {
                            className: _()(
                                ne.base,
                                ne[
                                    `base__${o === Y.IN_PROGRESS ? ae(A.eventMode.get(), null != (e = null == (t = l[0]) || null == (r = t.value) ? void 0 : r.rewardState) ? e : J.SOLD_OUT, null != (a = null == (i = l[1]) || null == (E = i.value) ? void 0 : E.rewardState) ? a : J.SOLD_OUT) : Du[o]}`
                                ],
                                u,
                            ),
                        });
                    ...
                    Ee = (0, W.Pi)(() => {
                        const u = q().model,
                            e = u.rewards.get(),
                            t = Q(e, (u) => u.rewardState === J.RECEIVED),
                            r = Q(e, (u) => u.rewardState === J.AVAILABLE);
                        return n().createElement(
                            n().Fragment,
                            null,
                            n().createElement(Gu, {
                                ...
                                switch (!0) {
                                    ...
                                    case void 0 !== r:
                                        return n().createElement(mu, {
                                            label:
                                                null != r && r.isSerial
                                                    ? Fu.topAvailable.text()
                                                    : Fu.regularAvailable.text(),
                                            count: null != (u = null == r ? void 0 : r.rewardCount) ? u : 0,
                                            serial: null == r ? void 0 : r.isSerial,
                                            vertical: !0,
                                        });
                                    default:
                                        return n().createElement(mu, {
                    ...
                    Ae = 'NotStartedState_text_a0',
                    oe = 'NotStartedState_textAccent_53',
                    le = (0, W.Pi)(() => {
                        var u, e, t, r, a, i, E;
                        const A = q().model,
                            o = A.eventMode.get() === K.TWO_PARALLEL_PRODUCTS,
                            l = A.rewards.get();
                        return n().createElement(
                            n().Fragment,
                            null,
                            n().createElement(Gu, {
                                startDate: A.startDate.get(),
                                className: 'NotStartedState_timer_60',
                            }),
                            o
                                ? n().createElement(su, {
                                      classMix: Ae,
                                      text: Fu.notStartedEvent.parallelRewards.text(),
                                      binding: {
                                          rewardName1: n().createElement(
                                              'span',
                                              { className: oe },
                                              null == (u = l[0]) || null == (e = u.value) ? void 0 : e.vehicleName,
                                          ),
                                          rewardName2: n().createElement(
                                              'span',
                                              { className: oe },
                                              null == (t = l[1]) || null == (r = t.value) ? void 0 : r.vehicleName,
                                          ),
                                      },
                                  })
                                : n().createElement(su, {
                                      text: Fu.notStartedEvent.text(),
                                      classMix: Ae,
                                      binding: {
                                          ...
                                          uniqVehicleText: n().createElement(
                                              'span',
                                              { className: oe },
                                              Fu.notStartedEvent.vehicleString.text(),
                                          ),
                                      },
                                  }),
                        );
                    ...
                    se = (0, W.Pi)(() => {
                        const u = q().model,
                            e = u.eventState.get(),
                            t = u.eventMode.get() === K.TWO_PARALLEL_PRODUCTS;
                        return n().createElement(
                            'div',
                            { className: 'Content_base_1d' },
                            n().createElement(ie, { className: 'Content_productImage_f1' }),
                            n().createElement(
                                'div',
                                { className: 'Content_content_a6' },
                                n().createElement('div', { className: 'Content_title_52' }, Fu.mainTitle.text()),
                                (() => {
                                    switch (e) {
                                        case Y.FORBIDDEN:
                                            return n().createElement(zu, { text: Fu.forbidden.text(), type: ju });
                                        case Y.PAUSED:
                                            return n().createElement(zu, { text: Fu.paused.text(), type: ju });
                                        case Y.NOT_STARTED:
                                            return n().createElement(le, null);
                                        default:
                                            return t ? n().createElement(Zu, null) : n().createElement(Ee, null);
                                    }
                                })(),
                            ),
                        );
                    ...
                    Fe = (0, W.Pi)(() => {
                        const u = q().model;
                        return n().createElement(H, { key: u.eventState.get() }, n().createElement(se, null));
                    });
                engine.whenReady.then(() => {
                    P().render(
                        n().createElement(O, null, n().createElement(z, null, n().createElement(Fe, null))),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/feature/tooltips/EntryPointTooltip/EntryPointTooltip'),
        (() => {
            var u = { 'lobby/feature/tooltips/EntryPointTooltip/EntryPointTooltip': 0 };
