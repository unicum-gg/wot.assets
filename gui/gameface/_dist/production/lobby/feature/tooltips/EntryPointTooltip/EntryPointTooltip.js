            ...
            3: (u, e, t) => {
                ...
                const D = ({ children: u }) => {
                    ...
                    return (
                        ...
                        n().createElement(s.Provider, { value: t }, A && u)
                    );
                };
                var c = t(6483),
                    d = t.n(c),
                ...
                const w = {
                    ...
                    p = (u) => {
                        ...
                        const i = (() => {
                            ...
                            A = i.mediaHeight,
                            o = i.mediaSize;
                        return n().createElement('div', v({ className: d()(t, w[E], f[A], b[o]) }, a), e);
                    },
                    S = ['children'],
                    x = (u) => {
                        let e = u.children,
                ...
                const P = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            M({}, o, {
                                className: d()(y.base, y[`base__theme-${A}`], a),
                                ref: function (u) {
                                    ((s.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            n().createElement('div', { className: y.decorator }, t),
                        )
                    );
                });
                var I = t(3403);
                ...
                const eu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    nu = (u, e, t = J.left) => u.split(e).reduce(t === J.left ? tu : ru, []),
                    au = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Eu = ({ binding: u, text: e = '', classMix: t, alignment: a = J.left, formatWithBrackets: i }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const E = i && u ? uu(e, u) : e;
                    ...
                    Au = R.strings.resource_well.tooltips.entryPoint,
                    ou = {
                    ...
                    lu = 'RewardsCounter_text_a1',
                    su = 'RewardsCounter_text__vertical_b1',
                    Fu = 'RewardsCounter_accent_49',
                    Du = 'RewardsCounter_countBack_14',
                    cu = ({
                        label: u,
                        count: e = 0,
                        textSoldOut: t = '',
                            ...
                            e > 0
                                ? n().createElement(
                                      ...
                                      n().createElement(
                                          ...
                                          n().createElement(Z, { format: 'integral', value: e }),
                                      ),
                                  )
                                : n().createElement(Eu, {
                                      text: u,
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (Cu(t, c, { isMouseEvent: !0, on: !0, arguments: Bu(n) }, w),
                                    _ && _(),
                            ...
                            gu(
                                {
                                    contentId:
                                        ...
                                        s ? hu.SimpleTooltipHtmlContent('resId') : hu.SimpleTooltipContent('resId')),
                ...
                const Lu = 'TimerEntryPointTooltip_text_50',
                    yu = R.strings.resource_well,
                    Ou = ({ isEventEndingSoon: u, leftTime: e, untilTime: t, beforeEventTime: r, startDate: a }) =>
                        n().createElement(
                            'div',
                        ...
                        ((u, e = !0) =>
                            u.days > 7 && e
                                ...
                                : u.days >= 1
                                  ? 0 === u.hours
                                      ? uu(R.strings.common.duration.days(), { days: u.days })
                                      : uu(R.strings.common.duration.days(), { days: u.days + 1 })
                                  : u.hours >= 1
                                    ? 0 === u.minutes
                                        ? uu(R.strings.common.duration.hours(), { hours: u.hours })
                                        : uu(R.strings.common.duration.hours(), { hours: u.hours + 1 })
                                    : uu(R.strings.common.duration.minutes(), { minutes: u.minutes || 1 }))(
                            (function (u = 0) {
                                let e = u;
                            ...
                            n().createElement(
                                ...
                                u === Tu.entryPointTooltip
                                    ? n().createElement(Ou, {
                                          isEventEndingSoon: t,
                                          leftTime: Iu(E),
                                          untilTime: bu(A, wu.DayMonthFullTime),
                                          beforeEventTime: bu(o, wu.DayMonthFullTime),
                                          startDate: i,
                                      })
                                    : n().createElement(Mu, {
                                          isEventEndingSoon: t,
                    ...
                    ku = ({
                        ...
                        n().createElement(
                            'div',
                            { className: d()('EventTimer_base_d5', a) },
                            n().createElement(
                                'div',
                            ...
                            n().createElement(Nu, {
                                ...
                                isEventEndingSoon: e,
                                timeLeft: t,
                                usagePlace: Tu.entryPointTooltip,
                            }),
                        ),
                    Hu = {
                    ...
                    Wu = 'warning',
                    Uu = 'completed',
                    Gu = ({ text: u, type: e = 'default', centered: t }) =>
                        n().createElement(
                            'div',
                            { className: d()(Hu.base, Hu[`base__${e}`], t && Hu.base__centered) },
                            n().createElement('div', { className: Hu.icon }),
                            n().createElement('div', { className: Hu.text }, u),
                        ),
                    Vu = 'Content_timer_f5',
                    ju = 'Content_highlight_8a',
                    $u = 'Content_textCompleted_55',
                    zu = (0, I.Pi)(() => {
                        const u = V().model;
                        return n().createElement(
                            'div',
                                        ...
                                        switch (a) {
                                            case Y.RECEIVED:
                                                return n().createElement(Gu, {
                                                    text: Au.rewardReceived.text(),
                                                    type: Uu,
                                                });
                                            case Y.IN_GARAGE:
                                                return n().createElement(Gu, {
                                                    text: Au.rewardInGarage.text(),
                                                    type: Uu,
                                                });
                                            case Y.SOLD_OUT:
                                                return n().createElement(Gu, { text: Au.rewardSoldOut.text() });
                                            default:
                                                return n().createElement(cu, {
                                                    label: Au.rewardAvailableCount.text(),
                                                    count: r,
                                                    serial: i,
                                                });
                                        }
                    ...
                    qu = (0, I.Pi)(() => {
                        const u = V().model,
                            e = u.rewards.get(),
                            t = q(e, (u) => u.rewardState === Y.SOLD_OUT),
                            r = q(e, (u) => u.rewardState === Y.RECEIVED || u.rewardState === Y.IN_GARAGE);
                        return n().createElement(
                            n().Fragment,
                            null,
                            n().createElement(ku, {
                            ...
                            (() => {
                                switch (!0) {
                                    case t:
                                        return n().createElement(cu, {
                                            label: Au.rewardsSoldOut.text(),
                                            textSoldOut: Au.rewardsSoldOut.accentText.text(),
                                            vertical: !0,
                                        });
                                    case r:
                                        return n().createElement(
                    ...
                    Zu = 'receivedSecond',
                    Qu = 'soldOut',
                    Ju = (u) => u === Y.RECEIVED || u === Y.IN_GARAGE,
                    ue = {
                    ...
                    ee = (u, e, t) => {
                        switch (u) {
                            case j.ONE_SERIAL_PRODUCT:
                                return ((u) => (Ju(u) ? Xu : u === Y.AVAILABLE ? Ku : Qu))(e);
                            case j.SEQUENTIAL_PRODUCT:
                                return ((u, e) =>
                                    Ju(u) ? Xu : Ju(e) ? Zu : u === Y.AVAILABLE ? Ku : e === Y.AVAILABLE ? Yu : Qu)(
                                    e,
                                    t,
                                );
                            case j.TWO_PARALLEL_PRODUCTS:
                                return ((u, e) =>
                                    u === Y.AVAILABLE && e === Y.AVAILABLE
                                        ? 'availableBoth'
                                        : u === Y.AVAILABLE
                                          ? Ku
                                          : e === Y.AVAILABLE
                    ...
                    te = (0, I.Pi)(({ className: u }) => {
                        ...
                        return n().createElement('div', {
                            className: d()(
                                ue.base,
                                ue[
                                    `base__${o === $.IN_PROGRESS ? ee(A.eventMode.get(), null != (e = null == (t = l[0]) || null == (r = t.value) ? void 0 : r.rewardState) ? e : Y.SOLD_OUT, null != (a = null == (i = l[1]) || null == (E = i.value) ? void 0 : E.rewardState) ? a : Y.SOLD_OUT) : ou[o]}`
                                ],
                                u,
                            ),
                        });
                    ...
                    re = (0, I.Pi)(() => {
                        const u = V().model,
                            e = u.rewards.get(),
                            t = K(e, (u) => u.rewardState === Y.RECEIVED),
                            r = K(e, (u) => u.rewardState === Y.AVAILABLE);
                        return n().createElement(
                            n().Fragment,
                            null,
                            n().createElement(ku, {
                                ...
                                switch (!0) {
                                    ...
                                    case void 0 !== r:
                                        return n().createElement(cu, {
                                            label:
                                                null != r && r.isSerial
                                                    ? Au.topAvailable.text()
                                                    : Au.regularAvailable.text(),
                    ...
                    ne = 'NotStartedState_text_a0',
                    ae = 'NotStartedState_textAccent_53',
                    ie = (0, I.Pi)(() => {
                        var u, e, t, r, a, i, E;
                        const A = V().model,
                            o = A.eventMode.get() === j.TWO_PARALLEL_PRODUCTS,
                            l = A.rewards.get();
                        return n().createElement(
                            n().Fragment,
                            null,
                            ...
                            o
                                ? n().createElement(Eu, {
                                      classMix: ne,
                                      text: Au.notStartedEvent.parallelRewards.text(),
                                      binding: {
                                ...
                                : n().createElement(Eu, {
                                      ...
                                      binding: {
                                          ...
                                          uniqVehicleText: n().createElement(
                                              'span',
                                              { className: ae },
                                              Au.notStartedEvent.vehicleString.text(),
                                          ),
                                      },
                                  }),
                        );
                    ...
                    Ee = (0, I.Pi)(() => {
                        const u = V().model,
                            e = u.eventState.get(),
                            t = u.eventMode.get() === j.TWO_PARALLEL_PRODUCTS;
                        return n().createElement(
                            'div',
                            { className: 'Content_base_1d' },
                            n().createElement(te, { className: 'Content_productImage_f1' }),
                            n().createElement(
                                'div',
                                { className: 'Content_content_a6' },
                                n().createElement('div', { className: 'Content_title_52' }, Au.mainTitle.text()),
                                (() => {
                                    switch (e) {
                                        case $.FORBIDDEN:
                                            return n().createElement(Gu, { text: Au.forbidden.text(), type: Wu });
                                        case $.PAUSED:
                                            return n().createElement(Gu, { text: Au.paused.text(), type: Wu });
                                        case $.NOT_STARTED:
                                            return n().createElement(ie, null);
                                        default:
                                            return t ? n().createElement(qu, null) : n().createElement(re, null);
                                    }
                                })(),
                            ),
                        );
                    ...
                    Ae = (0, I.Pi)(() => {
                        const u = V().model;
                        return n().createElement(P, { key: u.eventState.get() }, n().createElement(Ee, null));
                    });
                engine.whenReady.then(() => {
                    L().render(
                        n().createElement(x, null, n().createElement(G, null, n().createElement(Ae, null))),
