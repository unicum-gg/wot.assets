        ...
        e = {
            ...
            5459: (u, e, t) => {
                ...
                const Z = K().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        K().createElement(
                            'div',
                            Q({}, r, {
                                className: n()(Y.base, Y[`base__theme-${F}`], A),
                                ref: function (u) {
                ...
                const Du = $.client.getSize('rem'),
                    nu = Du.width,
                    au = Du.height,
                    Bu = Object.assign({ width: nu, height: au }, ru(nu, au, Eu)),
                    ...
                    lu = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && a) return Au(e, t, g);
                ...
                const vu = {
                    ...
                    wu = hu((u) => {
                        ...
                        const N = (0, U.useMemo)(() => {
                            ...
                            }, [t, A, r, a, i, l, O, H, S, d, y, p, b]),
                            G = N.computedStyle,
                            j = N.computedClassNames;
                        return K().createElement('div', pu({ className: n()(xu.base, ...j, e), style: G }, W), P);
                    });
                let Lu;
                !(function (u) {
                        ...
                        null === e
                            ...
                            : K().createElement(
                                  ...
                                  e.split('\n').map((e, E) =>
                                      K().createElement(
                                          'div',
                                          { className: n()('FormatText_base_d0', t), key: `${e}-${E}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                ...
                const Zu = (u) => (0 === u ? window : window.subViews.get(u)),
                    Ju = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: A, children: E, mocks: F }) {
                                const r = (0, U.useRef)([]),
                                    D = (u, t, A) => {
                                        ...
                                        const F = (function ({
                                            ...
                                            i = { mode: u, model: B, externalModel: D, cleanup: a };
                                        return {
                                            model: B,
                                ...
                                return (
                                    (0, U.useEffect)(() => {
                                        n.current ? o(D(B, A, F)) : (n.current = !0);
                                    }, [F, B, A]),
                                    (0, U.useEffect)(() => {
                                        i(u);
                                    }, [u]),
                    ...
                    ee = Ju[1],
                    te = 'App_separator_a8',
                    Ae = R.strings.armory_yard.tooltip.mainView.rerollButton,
                    Ee = (0, U.memo)(({ text: u, isColored: e = !1 }) =>
                        K().createElement(
                            'div',
                            { className: n()('ConditionItem_base_59', e && 'ConditionItem_base__colored_3a') },
                            K().createElement(Uu, {
                                text: Ae.conditionListPoint(),
                                className: 'ConditionItem_conditionListPoint_4f',
                            }),
                            K().createElement(Uu, { text: u, className: 'ConditionItem_conditionText_78' }),
                        ),
                    ),
                    Fe = R.strings.armory_yard.tooltip.mainView.rerollButton,
                    re = ['condition_1', 'condition_2', 'condition_3', 'condition_4_colored'],
                    De = ['condition_5', 'condition_6', 'condition_7'],
                    ne = '_colored',
                    ae = (0, Ku.observer)(() => {
                        const u = ee().model.root.get().freeRerollCount;
                        return K().createElement(
                            'div',
                            { className: 'App_base_49' },
                            K().createElement(Uu, { className: 'App_title_33', text: Fe.title() }),
                            K().createElement(Uu, { className: 'App_description_68', text: Fe.description() }),
                            re.map((u) =>
                                K().createElement(Ee, {
                                    key: 'top_' + u,
                                    text: String(Fe.$dyn(u.split(ne)[0])),
                                    isColored: u.includes(ne),
                                }),
                            ),
                            K().createElement(
                                'div',
                                { className: 'App_rerollCountContainer_90' },
                                K().createElement('div', { className: te }),
                                K().createElement(Uu, {
                                    text: Fe.freeRerollCount(),
                                    format: {
                                        binding: {
                                            freeRerollCount: K().createElement(Uu, {
                                                text: String(u),
                                                className: 'App_freeRerollCount_a7',
                                            }),
                                        },
                                    },
                                    className: 'App_freeRerollText_7c',
                                }),
                                K().createElement('div', { className: te }),
                            ),
                            De.map((u) =>
                ...
                engine.whenReady.then(() => {
                    uu().render(
                        K().createElement(ue, null, K().createElement(Z, null, K().createElement(ae, null))),
        ...
        (A.O = (e, t, E, F) => {
            if (!t) {
                ...
                for (B = 0; B < u.length; B++) {
                    for (var [t, E, F] = u[B], D = !0, n = 0; n < t.length; n++)
