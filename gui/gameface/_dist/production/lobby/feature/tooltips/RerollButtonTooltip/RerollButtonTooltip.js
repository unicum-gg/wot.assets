    ...
    var u,
        e = {
            ...
            5459: (u, e, t) => {
                ...
                const J = Y().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        Y().createElement(
                            'div',
                            Z({}, r, {
                                className: n()(q.base, q[`base__theme-${F}`], A),
                                ref: function (u) {
                ...
                const nu = U.client.getSize('rem'),
                    au = nu.width,
                    Bu = nu.height,
                    iu = Object.assign({ width: au, height: Bu }, Du(au, Bu, Fu)),
                    Cu = (0, K.createContext)(iu),
                    lu = ['children'],
                    ou = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && a) return Eu(e, t, g);
                            if (t.largeWidth && B) return Eu(e, t, g);
                ...
                let mu, su, du;
                ((0, K.memo)(({ children: u }) => {
                    const e = (0, K.useContext)(Cu),
                        t = (0, K.useState)(e),
                        A = t[0],
                        E = t[1],
                        F = (0, K.useCallback)((u, e) => {
                    ...
                    (((u) => {
                        ...
                        (0, K.useEffect)(() => () => engine.off('clientResized', F), [F]));
                    const r = (0, K.useMemo)(() => Object.assign({}, A), [A]);
                    return Y().createElement(Cu.Provider, { value: r }, u);
                }),
                    (function (u) {
                ...
                const bu = {
                    ...
                    Lu = xu((u) => {
                        ...
                        return Y().createElement('div', vu({ className: n()(fu.base, ...j, e), style: G }, W), P);
                    });
                let yu;
                !(function (u) {
                ...
                const Iu = Object.keys(Nu()),
                    ...
                    Ku = xu((u) => {
                        ...
                        return Y().createElement(
                            ...
                            Xu(
                                {
                                    className: n()(Gu.base, t && Gu[t], _, A),
                                    style: g,
                ...
                const Ju = (u) => (0 === u ? window : window.subViews.get(u)),
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const D = 'string' == typeof F ? `${A}.${F}` : A,
                                                            n = U.view.addModelObserver(D, e, !0);
                    ...
                    te = ue[1],
                    Ae = 'App_separator_a8',
                    Ee = R.strings.armory_yard.tooltip.mainView.rerollButton,
                    Fe = (0, K.memo)(({ text: u, isColored: e = !1 }) =>
                        Y().createElement(
                            'div',
                            { className: n()('ConditionItem_base_59', e && 'ConditionItem_base__colored_3a') },
                            Y().createElement(Ku, {
                                text: Ee.conditionListPoint(),
                                className: 'ConditionItem_conditionListPoint_4f',
                            }),
                            Y().createElement(Ku, { text: u, className: 'ConditionItem_conditionText_78' }),
                        ),
                    ),
                    re = R.strings.armory_yard.tooltip.mainView.rerollButton,
                    De = ['condition_1', 'condition_2', 'condition_3', 'condition_4_colored'],
                    ne = ['condition_5', 'condition_6', 'condition_7'],
                    ae = '_colored',
                    Be = (0, Yu.observer)(() => {
                        const u = te().model.root.get().freeRerollCount;
                        return Y().createElement(
                            'div',
                            { className: 'App_base_49' },
                            Y().createElement(Ku, { className: 'App_title_33', text: re.title() }),
                            Y().createElement(Ku, { className: 'App_description_68', text: re.description() }),
                            De.map((u) =>
                                Y().createElement(Fe, {
                                    key: 'top_' + u,
                                    text: String(re.$dyn(u.split(ae)[0])),
                                    isColored: u.includes(ae),
                                }),
                            ),
                            Y().createElement(
                                'div',
                                { className: 'App_rerollCountContainer_90' },
                                Y().createElement('div', { className: Ae }),
                                Y().createElement(Ku, {
                                    text: re.freeRerollCount(),
                                    format: {
                                        binding: {
                                            freeRerollCount: Y().createElement(Ku, {
                                                text: String(u),
                ...
                engine.whenReady.then(() => {
                    eu().render(
                        Y().createElement(ee, null, Y().createElement(J, null, Y().createElement(Be, null))),
