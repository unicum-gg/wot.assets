        ...
        e = {
            ...
            2283: (u, e, t) => {
                ...
                const Xu = Object.keys(Wu()),
                    ...
                    Ku = R.strings.armory_yard.entryPoint.widget.tooltips.disabled,
                    Yu = K().memo(() =>
                        K().createElement(
                            'div',
                            { className: 'App_base_97' },
                            K().createElement('div', { className: 'App_bg_24' }),
                            K().createElement('div', { className: 'App_metal_a8' }),
                            K().createElement(
                                'div',
                                { className: 'App_content_be' },
                                K().createElement($u, { text: Ku.header(), className: 'App_header_7d' }),
                                K().createElement($u, { text: Ku.body(), className: 'App_body_32' }),
                                K().createElement('div', { className: 'App_separator_5d' }),
                                K().createElement(
                                    'div',
                                    { className: 'App_warningWrapper_8c' },
                                    K().createElement('div', { className: 'App_warningIcon_87' }),
                                    K().createElement($u, { text: Ku.warning(), className: 'App_warning_db' }),
                                ),
                            ),
                        ),
                    );
                        ...
                        return [
                            function ({ mode: u = 'real', options: e, children: A, mocks: E }) {
                                const F = (0, $.useRef)([]),
                                    ...
                                    n = a[0],
                                    B = a[1],
                                    i = (0, $.useState)(() => r(u, e, E)),
                                    C = i[0],
                                    l = i[1];
                                return (
                                    (0, $.useEffect)(() => {
                                        D.current ? l(r(n, e, E)) : (D.current = !0);
                                    }, [E, n, e]),
                                    (0, $.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                ...
                ue[1],
                    engine.whenReady.then(() => {
                        uu().render(
                            K().createElement(ee, null, K().createElement(Z, null, K().createElement(Yu, null))),
