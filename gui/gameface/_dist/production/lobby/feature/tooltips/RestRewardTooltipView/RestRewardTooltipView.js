    ...
    var __webpack_modules__ = {
            ...
            5865: (u, e, t) => {
                ...
                const v = [
                    ...
                    w = [c.Gold, c.Credits, c.Crystal, c.FreeXp],
                ...
                const T = ['engravings', 'backgrounds'],
                        ...
                        const p = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, i.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (L(t, c, { isMouseEvent: !0, on: !0, arguments: y(r) }, b),
                                    C && C(),
                ...
                const q = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return s().createElement(X, e, r);
                        const n = e.contentId,
                            a = e.args,
                            i = null == a ? void 0 : a.contentId;
                        return n || i
                            ? s().createElement(N, j({}, e, { contentId: n || i }), r)
                            : s().createElement(U, e, r);
                    },
                    Y = {
                        base: 'Reward_base_ea',
                    ...
                    $ = ({
                        ...
                        return s().createElement(
                            'div',
                            { className: n()(Y.base, Y[`base__${r}`], A), style: o },
                            s().createElement(
                                q,
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        'div',
                                        { className: n()(Y.image, null == l ? void 0 : l.image) },
                                        c &&
                                            s().createElement('div', {
                                                className: n()(Y.highlight, null == l ? void 0 : l.highlight),
                                                style: {
                                        ...
                                        e &&
                                            s().createElement('div', {
                                                className: n()(Y.icon, null == l ? void 0 : l.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        _ &&
                                            s().createElement('div', {
                                                className: n()(Y.overlay, null == l ? void 0 : l.overlay),
                                                style: {
                            ...
                            t &&
                                s().createElement(
                                    ...
                                    { tooltipArgs: D },
                                    s().createElement('div', {
                                        className: n()(Y.timer, null == l ? void 0 : l.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const uu = a.O.client.getSize('rem'),
                    eu = uu.width,
                    tu = uu.height,
                    ru = Object.assign({ width: eu, height: tu }, J(eu, tu, Q)),
                    nu = (0, i.createContext)(ru),
                    au = ['children'],
                    iu = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && A) return K(e, t, g);
                            if (t.largeWidth && l) return K(e, t, g);
                            if (t.mediumWidth && F) return K(e, t, g);
                            if (t.smallWidth && D) return K(e, t, g);
                            if (t.extraSmallWidth && c) return K(e, t, g);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                ...
                ((0, i.memo)(({ children: u }) => {
                    const e = (0, i.useContext)(nu),
                        ...
                        E = (0, i.useCallback)((u, e) => {
                            ...
                            n(Object.assign({ width: t, height: r }, J(t, r, Q)));
                        }, []);
                    (((u) => {
                    ...
                    return s().createElement(nu.Provider, { value: o }, u);
                }),
                    (function (u) {
                ...
                const Au = ['xl', 'lg', 'md', 'sm', 'xs'],
                    lu = (u) => u.includes('_') && ((u) => Au.includes(u))(u.split('_').at(-1)),
                    Fu = [su.ExtraLarge, su.Large, su.Medium, su.Small, su.ExtraSmall],
                    Du = (u, e) =>
                ...
                const du = {
                    ...
                    hu = cu((u) => {
                        ...
                        const H = (0, i.useMemo)(() => {
                            ...
                            }, [t, r, o, l, D, _, k, N, R, C, O, x, S]),
                            G = H.computedStyle,
                            W = H.computedClassNames;
                        return s().createElement('div', mu({ className: n()(_u.base, ...W, e), style: G }, U), I);
                    });
                let pu;
                !(function (u) {
                ...
                const bu = (u, e, t) => {
                    ...
                    wu = (u, e, t = pu.left) => u.split(e).reduce(t === pu.left ? bu : vu, []),
                    xu = (() => {
                        const u = new RegExp(
                ...
                const yu = Object.keys(Tu()),
                    ...
                    Hu = cu((u) => {
                        ...
                        return s().createElement(
                            ...
                            Mu(
                                {
                                    className: n()(Pu.base, t && Pu[t], p, r),
                                    style: h,
                                    mt: !0 === A ? Iu[t || 'paragraph-P16'].mt : A,
                                    mr: !0 === F ? Iu[t || 'paragraph-P16'].mr : F,
                                    mb: !0 === c ? Iu[t || 'paragraph-P16'].mb : c,
                                    ml: !0 === B ? Iu[t || 'paragraph-P16'].ml : B,
                                },
                                C,
                            ),
                            void 0 !== d ? s().createElement(Su, Mu({}, d, { text: e })) : e,
                        );
                    });
                var Gu = t(3282);
                function Wu() {
                                        ...
                                        const i = (function ({
                                            ...
                                            l = (({ observableModel: u }) => {
                                                const e = { root: u.object(), rewards: u.array('rewards', []) },
                                                    ...
                                                    r = (0, Yu.computedFn)(() => t().length, { equals: Wu });
                                ...
                                s().createElement(
                                    ...
                                    e.map((u) => {
                                        return s().createElement(
                                            ...
                                            s().createElement(Hu, { className: 'App_description_09', text: u.label }),
                                        );
                                        var e;
                                    }),
                                ),
                ...
                engine.whenReady.then(() => {
                    D().render(
                        s().createElement(Vu, null, s().createElement(l, null, s().createElement(Ku, null))),
