    ...
    var __webpack_modules__ = {
            ...
            5865: (u, e, t) => {
                ...
                const b = [
                    ...
                    w = [c.Gold, c.Credits, c.Crystal, c.FreeXp, c.NewYearToyFragments],
                    v = [c.BattlePassPoints],
                        ...
                        const p = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, i.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (M(t, c, { isMouseEvent: !0, on: !0, arguments: y(r) }, b),
                                    C && C(),
                ...
                const Y = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    q = ({
                        ...
                        return s().createElement(
                            'div',
                            { className: n()(j.base, j[`base__${r}`], A), style: E },
                            s().createElement(
                                Y,
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        'div',
                                        { className: n()(j.image, null == l ? void 0 : l.image) },
                                        c &&
                                            s().createElement('div', {
                                                className: n()(j.highlight, null == l ? void 0 : l.highlight),
                                                style: {
                                        ...
                                        e &&
                                            s().createElement('div', {
                                                className: n()(j.icon, null == l ? void 0 : l.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        _ &&
                                            s().createElement('div', {
                                                className: n()(j.overlay, null == l ? void 0 : l.overlay),
                                                style: {
                            ...
                            t &&
                                s().createElement(
                                    ...
                                    { tooltipArgs: D },
                                    s().createElement('div', {
                                        className: n()(j.timer, null == l ? void 0 : l.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const Bu = {
                    ...
                    gu = Du((u) => {
                        ...
                        return s().createElement('div', mu({ className: n()(cu.base, ...W, e), style: G }, U), I);
                    });
                let hu;
                !(function (u) {
                ...
                const pu = (u, e, t) => {
                    ...
                    wu = (u, e, t = hu.left) => u.split(e).reduce(t === hu.left ? pu : bu, []),
                    vu = (() => {
                        const u = new RegExp(
                ...
                const qu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: r, children: n, mocks: o }) {
                                        ...
                                        const i = (function ({
                                            ...
                                            l = (({ observableModel: u }) => {
                                                const e = { root: u.object(), rewards: u.array('rewards', []) },
                                                    ...
                                                    r = (0, ju.computedFn)(() => t().length, { equals: Gu });
                                ...
                                return (
                                    (0, i.useEffect)(() => {
                                        l.current ? B(A(D, r, o)) : (l.current = !0);
                                    }, [o, D, r]),
                                    (0, i.useEffect)(() => {
                                        c(u);
                                    }, [u]),
                                    ...
                                    s().createElement(t.Provider, { value: m }, n)
                                );
                            },
                            () => (0, i.useContext)(t),
                        ];
