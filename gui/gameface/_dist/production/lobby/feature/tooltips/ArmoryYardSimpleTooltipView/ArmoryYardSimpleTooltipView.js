        ...
        e = {
            ...
            129: (u, e, t) => {
                ...
                const J = Y().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        Y().createElement(
                            'div',
                            Z({}, r, {
                                className: a()(q.base, q[`base__theme-${E}`], A),
                                ref: function (u) {
                ...
                const au = U.client.getSize('rem'),
                    nu = au.width,
                    Bu = au.height,
                    iu = Object.assign({ width: nu, height: Bu }, Du(nu, Bu, Eu)),
                    ...
                    ou = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && n) return Fu(e, t, g);
                            if (t.largeWidth && B) return Fu(e, t, g);
                            if (t.mediumWidth && i) return Fu(e, t, g);
                            if (t.smallWidth && C) return Fu(e, t, g);
                            if (t.extraSmallWidth && l) return Fu(e, t, g);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                    ...
                    const e = (0, K.useContext)(Cu),
                        ...
                        E = (0, K.useCallback)((u, e) => {
                            const t = U.view.pxToRem(u),
                                A = U.view.pxToRem(e);
                            F(Object.assign({ width: t, height: A }, Du(t, A, Eu)));
                        }, []);
                    (((u) => {
                        ...
                        const t = (
                            ...
                            (t) => {
                                const A = (() => {
                                    ...
                                    F = (0, K.useMemo)(() => e(t, A), [t, A]);
                                return Y().createElement(u, F);
                            }
                        )(u, e);
                        return Y().memo((e) =>
                ...
                const vu = {
                    ...
                    Tu = xu((u) => {
                        ...
                        return Y().createElement('div', bu({ className: a()(pu.base, ...j, e), style: N }, P), W);
                    });
                let Lu;
                !(function (u) {
                ...
                const Mu = (u, e, t) => {
                    ...
                    Wu = ({ binding: u, text: e = '', classMix: t, alignment: A = Lu.left }) =>
                        null === e
                ...
                const ku = Object.keys(Gu()),
                    ...
                    Ku = xu((u) => {
                        ...
                        return Y().createElement(
                            ...
                            void 0 !== s ? Y().createElement(Wu, Xu({}, s, { text: e })) : e,
                        );
                    });
                var Yu = t(3282);
                const qu = {
                    ...
                    Zu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Ju = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    ue = (0, K.memo)(({ text: u, binding: e, classMix: t }) => {
                        const A = (0, K.useCallback)((u) => ({ color: `#${u}` }), []),
                            F = (0, K.useMemo)(() => e || {}, [e]);
                        let E = Qu.exec(u),
                            r = u,
                            D = 0;
                                ...
                                ((r = r.replace(t, `%(${E})`)),
                                    (F[E] = qu[u]
                                        ? Y().createElement(
                                              'span',
                                              { className: qu[u] },
                                              Y().createElement(Wu, { text: B, binding: e }),
                                          )
                                        : Y().createElement(
                                              'span',
                                              { style: A(u) },
                        ...
                        return Y().createElement(Wu, { text: r, classMix: t, binding: F });
                    });
                function ee() {
                    return !1;
                }
                ...
                const Fe = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: A, children: F, mocks: E }) {
                                const r = (0, K.useRef)([]),
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const A = null != t ? t : a(e),
                                                            F = te.observable.box(A, { equals: ee });
                                                        return (
                                                            'real' === u &&
                                                                D.subscribe(
                                                                    (0, te.action)((u) => F.set(u)),
                                                                    e,
                                                                ),
                                                            F
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const F = e.reduce(
                                                                (u, e) => ((u[e] = te.observable.box(A[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                                    ...
                                    B = n[0],
                                    i = n[1],
                                    C = (0, K.useState)(() => D(u, A, E)),
                                    l = C[0],
                                    o = C[1];
                                return (
                                    (0, K.useEffect)(() => {
                                        a.current ? o(D(B, A, E)) : (a.current = !0);
                                    }, [E, B, A]),
                                    (0, K.useEffect)(() => {
                                        i(u);
                                    }, [u]),
                                    ...
                                    Y().createElement(t.Provider, { value: l }, F)
                                );
                            },
                            () => (0, K.useContext)(t),
                        ];
                    ...
                    ae = (0, Yu.observer)(() => {
                        ...
                        return Y().createElement(
                            ...
                            Y().createElement('div', { className: 'App_bg_50' }),
                            Y().createElement(
                                'div',
                                { className: 'App_content_ea' },
                                Y().createElement(Ku, { className: 'App_header_7e', text: e }),
                                t && Y().createElement(Ku, { className: 'App_body_de', text: t }),
                                A &&
                                    Y().createElement(
                                        Y().Fragment,
                                        null,
                                        Y().createElement('div', { className: 'App_separator_14' }),
                                        Y().createElement(ue, { text: A }),
                                    ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    eu().render(
                        Y().createElement(re, null, Y().createElement(J, null, Y().createElement(ae, null))),
