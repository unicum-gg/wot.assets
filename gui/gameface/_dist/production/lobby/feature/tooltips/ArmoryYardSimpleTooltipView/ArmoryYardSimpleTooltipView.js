        ...
        e = {
            ...
            129: (u, e, t) => {
                ...
                const Z = K().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        K().createElement(
                            'div',
                            Q({}, r, {
                                className: a()(Y.base, Y[`base__theme-${E}`], A),
                                ref: function (u) {
                ...
                const Du = $.client.getSize('rem'),
                    au = Du.width,
                    nu = Du.height,
                    Bu = Object.assign({ width: au, height: nu }, ru(au, nu, Fu)),
                ...
                ((0, U.memo)(({ children: u }) => {
                    const e = (0, U.useContext)(iu),
                        ...
                        A = t[0],
                        F = t[1],
                        E = (0, U.useCallback)((u, e) => {
                            const t = $.view.pxToRem(u),
                                A = $.view.pxToRem(e);
                            F(Object.assign({ width: t, height: A }, ru(t, A, Fu)));
                        }, []);
                    (((u) => {
                        ...
                        (0, U.useEffect)(() => () => engine.off('clientResized', E), [E]));
                ...
                const Lu = (u, e, t) => {
                    ...
                    yu = (u, e, t = Tu.left) => u.split(e).reduce(t === Tu.left ? Lu : Mu, []),
                    Ru = (() => {
                        const u = new RegExp(
                    ...
                    Ou = ({ binding: u, text: e = '', classMix: t, alignment: A = Tu.left }) =>
                        null === e
                ...
                const Yu = {
                    ...
                    Qu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Zu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Ju = (0, U.memo)(({ text: u, binding: e, classMix: t }) => {
                        const A = (0, U.useCallback)((u) => ({ color: `#${u}` }), []),
                            F = (0, U.useMemo)(() => e || {}, [e]);
                        let E = qu.exec(u),
                            r = u,
                            D = 0;
                                ...
                                ((r = r.replace(t, `%(${E})`)),
                                    (F[E] = Yu[u]
                                        ? K().createElement(
                                              'span',
                                              { className: Yu[u] },
                                              K().createElement(Ou, { text: B, binding: e }),
                                          )
                                        : K().createElement(
                                              'span',
                                              { style: A(u) },
                        ...
                        return K().createElement(Ou, { text: r, classMix: t, binding: F });
                    });
                function ue() {
                    return !1;
                }
                ...
                const Ae = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: A, children: F, mocks: E }) {
                                ...
                                return (
                                    ...
                                    K().createElement(t.Provider, { value: l }, F)
                                );
                            },
                            () => (0, U.useContext)(t),
                        ];
                    ...
                    De = (0, Ku.observer)(() => {
                        ...
                        return K().createElement(
                            ...
                            K().createElement('div', { className: 'App_bg_50' }),
                            K().createElement(
                                'div',
                                { className: 'App_content_ea' },
                                K().createElement(Uu, { className: 'App_header_7e', text: e }),
                                t && K().createElement(Uu, { className: 'App_body_de', text: t }),
                                A &&
                                    K().createElement(
                                        K().Fragment,
                                        null,
                                        K().createElement('div', { className: 'App_separator_14' }),
                                        K().createElement(Ju, { text: A }),
                                    ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    uu().render(
                        K().createElement(Ee, null, K().createElement(Z, null, K().createElement(De, null))),
