        ...
        A = {
            9602: (u, A, F) => {
                ...
                const k = {
                    ...
                    j = Object.keys(M).reduce((u, A) => ((u[A] = () => P(M[A])), u), {}),
                    V = { play: Object.assign({}, j, { sound: P }), setRTPC: T };
                function L(u, A, F = 1) {
                ...
                const ou = (() => {
                    ...
                    iu = Object.keys(G).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === G[A]), u), {}),
                    au = {
                        set: (u, A) => {
                                ...
                                const B = (0, t.useRef)([]),
                                    n = (u, F, e) => {
                                        ...
                                        const D = (function ({
                                            ...
                                            r = (({ observableModel: u }) => ({ rewards: u.array('rewards') }))({
                                                mode: u,
                                                readByPath: C,
                                                externalModel: t,
                                                observableModel: {
                ...
                const zu = ({ section: u }) =>
                    ...
                    Mu = () => {
                        ...
                        return C().createElement(
                            ...
                            C().createElement(
                                'div',
                                { className: 'App_base_05' },
                                C().createElement(g, { classMix: 'App_title_61', text: ku.title() }),
                                C().createElement(g, { classMix: 'App_subTitle_b8', text: ku.subTitle() }),
                                fu(u.rewards.get(), (u, A) => C().createElement(zu, { key: A, section: u })),
                            ),
                        );
                    },
                    ju = {
                        rewards: [
                            { type: 'progressionRewards', value: ['tankman', 'epicAbilityPoint', 'blueprint_tube'] },
                            { type: 'customizations', value: ['style', 'recertificationForm', 'crewSkin3'] },
                            {
                                type: 'boosters',
                                value: ['booster_xp', 'booster_free_xp_and_crew_xp', 'booster_credits'],
                            },
                            {
                                type: 'crewBonusesOrX5',
                                value: ['brochure_gift', 'recertificationForm', 'battle_bonus_x5'],
                            },
                            { type: 'experimentalEquipmentAndComponents', value: ['expequipments_gift', 'equipCoin'] },
                            { type: 'currenciesAndPremium', value: ['credits', 'premium_plus_universal'] },
                        ],
                    },
                    Vu = { getter: (u) => ('rewards' === u ? ju.rewards : ju), controls: gu };
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(_u, { mode: 'real', mocks: Vu }, C().createElement(Mu, null)),
