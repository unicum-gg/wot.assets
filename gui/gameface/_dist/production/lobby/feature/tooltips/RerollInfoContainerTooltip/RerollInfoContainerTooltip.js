        ...
        e = {
            ...
            1713: (u, e, t) => {
                ...
                const Iu = Object.keys(Wu()),
                    ...
                    Yu = (0, U.memo)(({ text: u, isColored: e = !1 }) =>
                        K().createElement(
                            ...
                            K().createElement(Uu, { text: u, className: 'ConditionItem_conditionText_96' }),
                        ),
                    ),
                    qu = R.strings.armory_yard.tooltip.mainView.rerollInfoContainer,
                    Qu = R.strings.armory_yard.tooltip.mainView.rerollButton,
                    Zu = ['condition_5', 'condition_6', 'condition_7'],
                    Ju = (0, U.memo)(() =>
                        K().createElement(
                            'div',
                            { className: 'App_base_66' },
                            K().createElement(Uu, { className: 'App_title_a0', text: qu.title() }),
                            Zu.map((u) => K().createElement(Yu, { key: 'top_' + u, text: String(Qu.$dyn(u)) })),
                        ),
                    );
                function ue() {
                    return !1;
                ...
                (Fe[1],
                    engine.whenReady.then(() => {
                        uu().render(
                            K().createElement(Ee, null, K().createElement(Z, null, K().createElement(Ju, null))),
