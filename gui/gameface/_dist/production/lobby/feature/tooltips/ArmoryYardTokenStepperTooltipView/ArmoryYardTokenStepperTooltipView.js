        ...
        e = {
            ...
            7127: (u, e, t) => {
                ...
                const Xu = Object.keys(Wu()),
                    ...
                    Ku = 'App_text_e2',
                    Yu = R.strings.armory_yard.tooltip.tokenStepper,
                    qu = (0, $.memo)(() =>
                        K().createElement(
                            'div',
                            ...
                            K().createElement($u, { className: Ku, text: Yu.freedomTokens() }),
                            K().createElement('div', { className: 'App_token_d6' }),
                        ),
                    );
                function Qu() {
                    return !1;
                ...
                ee[1],
                    engine.whenReady.then(() => {
                        uu().render(
                            K().createElement(te, null, K().createElement(Z, null, K().createElement(qu, null))),
