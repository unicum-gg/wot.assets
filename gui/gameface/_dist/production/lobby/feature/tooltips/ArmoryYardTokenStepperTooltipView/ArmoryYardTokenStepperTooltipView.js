            ...
            7127: (u, e, t) => {
                ...
                const bu = {
                    ...
                    Lu = xu((u) => {
                        ...
                        return Y().createElement('div', vu({ className: a()(fu.base, ...j, e), style: N }, W), P);
                    });
                let Mu;
                !(function (u) {
                ...
                const Iu = Object.keys(Gu()),
                    ...
                    Yu = 'App_text_e2',
                    qu = R.strings.armory_yard.tooltip.tokenStepper,
                    Qu = (0, K.memo)(() =>
                        Y().createElement(
                            'div',
                            { className: 'App_base_b0' },
                            Y().createElement('div', { className: 'App_bg_61' }),
                            Y().createElement(Ku, { className: a()(Yu, 'App_text__button_5b'), text: qu.press() }),
                            Y().createElement('div', { className: 'App_button_04' }),
                            Y().createElement(Ku, { className: Yu, text: qu.main() }),
                            Y().createElement(Ku, { className: Yu, text: qu.freedomTokens() }),
                            Y().createElement('div', { className: 'App_token_d6' }),
                        ),
                    );
                function Zu() {
                    return !1;
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const A = null != t ? t : a(e),
                                                            F = Ju.observable.box(A, { equals: Zu });
                                                        return (
                                                            'real' === u &&
                                                                D.subscribe(
                                                                    (0, Ju.action)((u) => F.set(u)),
                                                                    e,
                                                                ),
                                                            F
                                                        );
                ...
                (te[1],
                    engine.whenReady.then(() => {
                        eu().render(
                            Y().createElement(Ae, null, Y().createElement(J, null, Y().createElement(Qu, null))),
