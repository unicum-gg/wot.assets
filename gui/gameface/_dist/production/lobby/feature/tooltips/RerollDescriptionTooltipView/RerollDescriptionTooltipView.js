        ...
        e = {
            ...
            8900: (u, e, t) => {
                ...
                const Z = K().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        K().createElement(
                            'div',
                            Q({}, r, {
                                className: n()(Y.base, Y[`base__theme-${E}`], A),
                                ref: function (u) {
                ...
                const Du = $.client.getSize('rem'),
                    nu = Du.width,
                    au = Du.height,
                    Bu = Object.assign({ width: nu, height: au }, ru(nu, au, Fu)),
                ...
                const vu = {
                    ...
                    Su = hu((u) => {
                        ...
                        return K().createElement('div', pu({ className: n()(xu.base, ...j, e), style: N }, W), P);
                    });
                let Lu;
                !(function (u) {
                ...
                const Xu = Object.keys(Wu()),
                    ...
                    Ku = R.strings.armory_yard.tooltip.mainView.rerollButton,
                    Yu = (0, U.memo)(({ text: u, isColored: e = !1 }) =>
                        K().createElement(
                            'div',
                            { className: n()('ConditionItem_base_af', e && 'ConditionItem_base__colored_93') },
                            K().createElement(Uu, {
                                text: Ku.conditionListPoint(),
                                className: 'ConditionItem_conditionListPoint_cb',
                            }),
                            K().createElement(Uu, { text: u, className: 'ConditionItem_conditionText_ee' }),
                        ),
                    ),
                    qu = R.strings.armory_yard.tooltip.rerollView.description,
                    Qu = ['bodyCondition_1', 'bodyCondition_2', 'bodyCondition_3'],
                    Zu = () =>
                        K().createElement(
                            'div',
                            { className: 'App_base_d3' },
                            K().createElement(Uu, { className: 'App_title_f5', text: qu.header() }),
                            Qu.map((u) => K().createElement(Yu, { key: 'body_' + u, text: String(qu.$dyn(u)) })),
                        );
                function Ju() {
                    return !1;
                }
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const A = null != t ? t : n(e),
                                                            F = ue.observable.box(A, { equals: Ju });
                                                        return (
                                                            'real' === u &&
                                                                D.subscribe(
                                                                    (0, ue.action)((u) => F.set(u)),
                                                                    e,
                                                                ),
                                                            F
                                                        );
                ...
                (Ae[1],
                    engine.whenReady.then(() => {
                        uu().render(
                            K().createElement(Fe, null, K().createElement(Z, null, K().createElement(Zu, null))),
