    ...
    var __webpack_modules__ = {
            ...
            5943: (u, e, E) => {
                ...
                const _ = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    h = ['zh_cn', 'zh_sg', 'zh_tw'],
                    g = ({ binding: u, text: e = '', classMix: E, alignment: t = d.left, formatWithBrackets: D }) => {
                ...
                engine.whenReady.then(() => {
                    D().render(F().createElement(L, null), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
