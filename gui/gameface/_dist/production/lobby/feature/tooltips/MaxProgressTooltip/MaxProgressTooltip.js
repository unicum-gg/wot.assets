(() => {
    ...
    var __webpack_modules__ = {
            ...
            3138: (u, e, E) => {
                ...
                var A = E(5959),
                    F = E(7698),
                    t = E(514);
                const D = { view: E(7641), client: A, sound: t.ZP, intl: F.N };
            },
            7698: (u, e, E) => {
                E.d(e, { N: () => A });
                const A = {
            ...
            9916: (u, e, E) => {
                E.d(e, { Sw: () => t.Z, B3: () => B, Z5: () => D.Z5, ry: () => _ });
                class A {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
                ...
                const g = F.instance,
                    h = {
                        ...
                        sendMoveEvent: (u) => p(n.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: v,
                        sendClosePopOverEvent: () => p(n.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, E = 0) => {
                            p(n.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: E, args: e });
                        },
            ...
            5943: (u, e, E) => {
                ...
                const a = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            i({}, a, {
                                className: r()(o.base, o[`base__theme-${n}`], t),
                                ref: function (u) {
                ...
                var s = E(9916);
                const c = ({ value: u, format: e = 'integral' }) => {
                    const E = (function (u) {
                            return 'gold' === u ? s.B3.GOLD : s.B3.INTEGRAL;
                        })(e),
                        A = s.Z5.getNumberFormat(u, E);
                ...
                const _ = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    w = (u, e, E = d.left) => u.split(e).reduce(E === d.left ? p : v, []),
                    m = (() => {
                        const u = new RegExp(
                            [
                    ...
                    g = ['zh_cn', 'zh_sg', 'zh_tw'],
                    h = ({ binding: u, text: e = '', classMix: E, alignment: t = d.left, formatWithBrackets: D }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const n = D && u ? ((B = u), e.replace(/\{\w+\}/g, (u) => String(B[u.slice(1, -1)]))) : e;
                        var B;
                        return F().createElement(
                            ...
                            n.split('\n').map((e, D) =>
                                F().createElement(
                                    'div',
                                    { className: r()('FormatText_base_d0', E), key: `${e}-${D}` },
                                    ((u, e, E) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                            E && u in E
                                                ? E[u]
                    ...
                    f = (u = 1) => {
                        ...
                        return (
                            ...
                            { callerUrl: F, caller: E, stack: e, resId: A }
                        );
                    },
                ...
                const P = (u = 'model', e = x.Deep) => {
                            ...
                            o = (0, A.useState)(() =>
                                ((u) => {
                                    ...
                                    ((u) =>
                                        ((u, e) =>
                                            u.split('.').reduce((u, e) => {
                                                const E = b(`${u}.${e}`, window);
                                                return y(E) ? ((u, e) => `${u}.${e}.value`)(u, e) : `${u}.${e}`;
                                            }))(u))(B),
                                ),
                            ),
                            C = o[0],
                        ...
                        return (
                            ((u) => {
                                ...
                                if (
                                                    ...
                                                    const e = f(),
                                                        ...
                                                        F =
                                                            window.__feature && window.__feature !== E && E
                                                                ? `subViews.${E}`
                                                                : '';
                                                    return { modelPrefix: F, modelPath: O(F, ''), resId: A };
                                                })(),
                                                E = e.modelPrefix,
                                                A = u.split('.');
                                            if (A.length > 0) {
                                    ...
                                    a.current = T.addCallback(A, E, r, e === x.Deep);
                                }
                            }),
                            (0, A.useEffect)(() => {
                                if (e !== x.None)
                    ...
                    k = {
                        ...
                        content: 'Content_content_77',
                        descriptionText: 'Content_descriptionText_5b',
                        descriptionText__max: 'Content_descriptionText__max_bb',
                        description: 'Content_description_ac',
                        progress: 'Content_progress_c1',
                        progress__gold: 'Content_progress__gold_cd',
                        progress__credits: 'Content_progress__credits_4e',
                        maxValue: 'Content_maxValue_9f',
                        separatorTopWrapper: 'Content_separatorTopWrapper_f0',
                        separator: 'Content_separator_70',
                        progressWrapper: 'Content_progressWrapper_da',
                        icon: 'Content_icon_38',
                    },
                    M = R.strings.resource_well.tooltips.resourcesLoadingView.limitCounter,
                    L = () => {
                        const u = P('model', x.None),
                            e = u.currentValue,
                            E = u.maxValue,
                            A = u.resourceType,
                                ...
                                F().createElement(h, {
                                    ...
                                    binding: {
                                        maxAmount: F().createElement(
                                            ...
                                            F().createElement(c, { value: E }),
                                        ),
                                    },
                                    text: M.header(),
                                }),
                                F().createElement('div', { className: k.description }, M.body()),
                                F().createElement(
                                    'div',
                                        ...
                                        binding: {
                                            icon: F().createElement('span', {
                                                ...
                                                style:
                                                    ((D = A),
                                                    {
                                                        backgroundImage: `url(${R.images.gui.maps.icons.blueprints.fragment.special.$dyn(D) || R.images.resource_well.gui.maps.icons.resourcesLoading.icons.$dyn(D)})`,
                                                    }),
                                            }),
                                            amount: F().createElement(c, { value: e }),
                                            maxAmount: F().createElement(
                                                'span',
                    ...
                    S = () => F().createElement(a, null, F().createElement(L, null));
                engine.whenReady.then(() => {
                    D().render(F().createElement(S, null), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/feature/tooltips/MaxProgressTooltip/MaxProgressTooltip'),
        (() => {
            var u = { 'lobby/feature/tooltips/MaxProgressTooltip/MaxProgressTooltip': 0 };
