(() => {
    var __webpack_modules__ = {
            ...
            2588: (u, e, t) => {
                ...
                var Y = t(3403),
                    V = t(7030);
                const q = (u) => Math.sqrt(1 - Math.pow(u - 1, 2)),
                    z = 400;
                var K = t(3946);
                function Q(u) {
                    return u;
                ...
                const cu = [
                    ...
                    Au = [au.Gold, au.Credits, au.Crystal, au.FreeXp, au.NewYearToyFragments],
