(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                (t.r(e),
                    t.d(e, { mouse: () => D, off: () => n, on: () => F, onResize: () => A, onScaleUpdated: () => a }));
                var E = t(2472),
                    r = t(1176);
            ...
            5365: (u, e, t) => {
                ...
                const D = a.O.client.getSize('rem'),
                    s = D.width,
                    o = D.height,
                    l = Object.assign({ width: s, height: o }, i(s, o, F)),
                ...
                const x = {
                    ...
                    O = (u) => {
                        ...
                        const a = (() => {
                            ...
                            n = a.mediaHeight,
                            i = a.mediaSize;
                        return r().createElement('div', p({ className: m()(t, x[F], L[n], S[i]) }, A), e);
                    },
                    y = ['children'],
                    T = (u) => {
                        let e = u.children,
                ...
                const N = ({
                    ...
                    return (
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                'span',
                                { className: m()(H.state, H.state__default) },
                ...
                N.defaultProps = { type: W.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const U = N;
                var G = t(9916);
                class j extends r().PureComponent {
                    render() {
                        let u;
                        u = 'gold' === this.props.format ? G.B3.GOLD : G.B3.INTEGRAL;
                ...
                const $ = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Y = (u, e, t = V.left) => u.split(e).reduce(t === V.left ? q : K, []),
                    Z = (() => {
                        const u = new RegExp(
                    ...
                    X = ['zh_cn', 'zh_sg', 'zh_tw'],
                    Q = ({ binding: u, text: e = '', classMix: t, alignment: A = V.left, formatWithBrackets: a }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const F = a && u ? ((n = u), e.replace(/\{\w+\}/g, (u) => String(n[u.slice(1, -1)]))) : e;
                        var n;
                ...
                const ru = (u) => (0 === u ? window : window.subViews.get(u)),
                    Au = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: A, children: F, mocks: n }) {
                                const i = (0, E.useRef)([]),
                                    D = (u, t, E) => {
                                        ...
                                        const A = (function ({
                                            ...
                                            o = { mode: u, model: s, externalModel: F, cleanup: D };
                                        return {
                                            model: s,
                                            controls: 'mocks' === u && E ? E.controls(o) : e(o),
                                            externalModel: F,
                                            mode: u,
                                        };
                                    },
                                ...
                                return (
                                    (0, E.useEffect)(() => {
                                        s.current ? d(D(l, A, n)) : (s.current = !0);
                                    }, [n, l, A]),
                                    (0, E.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                    ...
                    au = Au[0],
                    Fu = Au[1],
                    nu = R.strings.resource_well.tankPreview,
                    iu = {
                        [uu.ONE_SERIAL_PRODUCT]: nu.description.oneSerialProduct(),
                        [uu.SEQUENTIAL_PRODUCT]: nu.description.sequentialProduct(),
                        [uu.TWO_PARALLEL_PRODUCTS]: nu.description.twoParallelProducts(),
                    },
                    Du = (0, J.Pi)(() => {
                        const u = Fu(),
                            e = u.model,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(Q, {
                                            text: iu[i],
                                            binding: {
                                                topPlayers: r().createElement(j, { format: 'integral', value: n }),
                                                basePlayers: r().createElement(j, { format: 'integral', value: F }),
                                            },
                                        }),
                                    ),
                                    r().createElement(
                ...
                engine.whenReady.then(() => {
                    P().render(
                        r().createElement(au, null, r().createElement(T, null, r().createElement(Du, null))),
