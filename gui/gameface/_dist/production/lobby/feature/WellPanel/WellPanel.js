(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                (t.r(e),
                    t.d(e, { mouse: () => D, off: () => F, on: () => n, onResize: () => A, onScaleUpdated: () => a }));
                var E = t(2472),
                    r = t(1176);
            ...
            3138: (u, e, t) => {
                ...
                var E = t(5959),
                    r = t(7698),
                    A = t(514);
                const a = { view: t(7641), client: E, sound: A.ZP, intl: r.N };
            },
            7698: (u, e, t) => {
                'use strict';
                t.d(e, { N: () => E });
            ...
            9916: (u, e, t) => {
                ...
                function c(u, e, t, E, r, A, a) {
                    ...
                    n.done ? e(F) : Promise.resolve(F).then(E, r);
                }
                ...
                const w = r.instance,
                    f = {
                        ...
                        sendShowContextMenuEvent: (u, e, t = 0) => {
                            m(n.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                        },
            ...
            3862: (u, e, t) => {
                ...
                const w = {
                    ...
                    p = (u) => {
                        ...
                        const a = (() => {
                            ...
                            F = a.mediaHeight,
                            i = a.mediaSize;
                        return r().createElement('div', v({ className: C()(t, w[n], f[F], b[i]) }, A), e);
                    },
                    x = ['children'],
                    L = (u) => {
                        let e = u.children,
                        ...
                        return r().createElement(l, null, r().createElement(p, t, e));
                    };
                var S = t(1533),
                    y = t.n(S);
                function O(u) {
                            ...
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    t ||
                                        (null !== c && O(c),
                                        F && F(u),
                                        s && (t || (d.current && (d.current.focus(), h(!0)))),
                                        w(!0));
                                },
                ...
                const U = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    $ = (u, e, t = N.left) => u.split(e).reduce(t === N.left ? G : j, []),
                    z = (() => {
                        const u = new RegExp(
                            [
                    ...
                    V = ['zh_cn', 'zh_sg', 'zh_tw'],
                    q = ({ binding: u, text: e = '', classMix: t, alignment: A = N.left, formatWithBrackets: a }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const n = a && u ? ((F = u), e.replace(/\{\w+\}/g, (u) => String(F[u.slice(1, -1)]))) : e;
                        var F;
                ...
                (!(function (u) {
                    ((u.ONE_SERIAL_PRODUCT = 'ONE_SERIAL_PRODUCT'),
                        (u.SEQUENTIAL_PRODUCT = 'SEQUENTIAL_PRODUCT'),
                        (u.TWO_PARALLEL_PRODUCTS = 'TWO_PARALLEL_PRODUCTS'));
                })(Y || (Y = {})),
                    console.log);
                var X = t(9174);
                function Q(u, e) {
                ...
                const J = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const i = (0, E.useRef)([]),
                                    D = (u, t, E) => {
                                        ...
                                        const A = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, A) => {
                                                        const F = 'string' == typeof A ? `${E}.${A}` : E,
                                                            i = a.O.view.addModelObserver(F, e, !0);
                                                        return (r.set(i, t), u && t(n(A)), i);
                                                    },
                                                    readByPath: n,
                                                    createCallback: (u, e) => {
                                                        const t = n(e);
                                            ...
                                            s = { mode: u, model: o, externalModel: n, cleanup: D };
                                        return {
                                            model: o,
                                    ...
                                    l = s[0],
                                    B = s[1],
                                    C = (0, E.useState)(() => D(u, A, F)),
                                    c = C[0],
                                    d = C[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        o.current ? d(D(l, A, F)) : (o.current = !0);
                                    }, [F, l, A]),
                                    (0, E.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                    ...
                    })(0, ({ externalModel: u }) => ({ selectResources: u.createCallbackNoArgs('onAction') })),
                    eu = uu[0],
                    tu = uu[1],
                    Eu = R.strings.resource_well.tankPreview,
                    ru = {
                        [Y.ONE_SERIAL_PRODUCT]: Eu.description.oneSerialProduct(),
                        [Y.SEQUENTIAL_PRODUCT]: Eu.description.sequentialProduct(),
                        [Y.TWO_PARALLEL_PRODUCTS]: Eu.description.twoParallelProducts(),
                    },
                    Au = (0, K.Pi)(() => {
                        const u = tu(),
                            e = u.model,
                            ...
                            A = E.isVisible,
                            a = E.vehicleName,
                            n = E.regularRewardsCount,
                            F = E.topRewardsCount,
                            i = E.eventMode;
                        return r().createElement(
                            'div',
                            { className: 'App_base_45' },
                            A &&
                                r().createElement(
                                    r().Fragment,
                                    null,
                                    r().createElement(q, {
                                        classMix: 'App_title_97',
                                        text: Eu.title(),
                                        binding: { vehicleName: a },
                                    }),
                                    r().createElement(
                                        'div',
                                        { className: 'App_description_a4' },
                                        r().createElement(q, {
                                            text: ru[i],
                                            binding: {
                                                topPlayers: r().createElement(W, { format: 'integral', value: F }),
                                                basePlayers: r().createElement(W, { format: 'integral', value: n }),
                                            },
                                        }),
                                    ),
                                    r().createElement(
                ...
                engine.whenReady.then(() => {
                    y().render(
                        r().createElement(eu, null, r().createElement(L, null, r().createElement(Au, null))),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (F = 0; F < deferred.length; F++) {
                    for (var [e, t, E] = deferred[F], A = !0, a = 0; a < e.length; a++)
                        (!1 & E || r >= E) &&
        ...
        (__webpack_require__.j = 'lobby/feature/WellPanel/WellPanel'),
        (() => {
            var u = { 'lobby/feature/WellPanel/WellPanel': 0 };
