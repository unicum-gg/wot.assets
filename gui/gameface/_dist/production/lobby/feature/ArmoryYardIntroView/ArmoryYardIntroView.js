    ...
    var __webpack_modules__ = {
            ...
            1358: (u, e, t) => {
                ...
                class E {
                    ...
                    addCallback(u, e, t = 0, E = !0) {
                        ...
                        const r = a.O.view.addModelObserver(u, t, E);
                        return (
                            r > 0
                                ? ((this._callbacks[r] = e),
            ...
            4179: (u, e, t) => {
                ...
                function d(u, e, t, a, E, r, n) {
                    ...
                    A.done ? e(i) : Promise.resolve(i).then(a, E);
                }
                ...
                const p = E.instance,
                    b = {
                        ...
                        sendShowPopOverEvent: (u, e, t, a, E = R.invalid('resId'), r) => {
            ...
            971: (u, e, t) => {
                ...
                const s = n.O.client.getSize('rem'),
                    o = s.width,
                    D = s.height,
                    l = Object.assign({ width: o, height: D }, F(o, D, A)),
                    B = (0, a.createContext)(l),
                    C = ['children'],
                    c = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.largeWidth && D) return r(e, t, w);
                ...
                const d = (0, a.memo)(({ children: u }) => {
                    const e = (0, a.useContext)(B),
                        ...
                        s = (0, a.useCallback)((u, e) => {
                            ...
                            i(Object.assign({ width: t, height: a }, F(t, a, A)));
                        }, []);
                    ((u) => {
                ...
                const x = {
                        [w.ExtraSmall]: '',
                        [w.Small]: g().SMALL_WIDTH,
                        [w.Medium]: `${g().SMALL_WIDTH} ${g().MEDIUM_WIDTH}`,
                    ...
                    L = {
                        [p.ExtraSmall]: '',
                        [p.Small]: g().SMALL_HEIGHT,
                        [p.Medium]: `${g().SMALL_HEIGHT} ${g().MEDIUM_HEIGHT}`,
                        [p.Large]: `${g().SMALL_HEIGHT} ${g().MEDIUM_HEIGHT} ${g().LARGE_HEIGHT}`,
                        [p.ExtraLarge]: `${g().SMALL_HEIGHT} ${g().MEDIUM_HEIGHT} ${g().LARGE_HEIGHT} ${g().EXTRA_LARGE_HEIGHT}`,
                    },
                    M = {
                        [v.ExtraSmall]: '',
                        [v.Small]: g().SMALL,
                    ...
                    y = (u) => {
                        ...
                        const n = (() => {
                            ...
                            i = n.mediaHeight,
                            F = n.mediaSize;
                        return E().createElement('div', f({ className: m()(t, x[A], L[i], M[F]) }, r), e);
                    },
                    S = ['children'],
                    T = (u) => {
                        let e = u.children,
                        ...
                        return E().createElement(d, null, E().createElement(y, t, e));
                    };
                var O = t(493),
                    k = t.n(O);
                function H(u) {
                ...
                class U extends E().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = m()(P.base, P[`base__${n}`], P[`base__${r}`], null == A ? void 0 : A.base),
                            B = m()(P.icon, P[`icon__${n}`], P[`icon__${r}`], null == A ? void 0 : A.icon),
                            C = m()(P.glow, null == A ? void 0 : A.glow),
                            c = m()(P.caption, P[`caption__${n}`], null == A ? void 0 : A.caption),
                            d = m()(P.goto, null == A ? void 0 : A.goto);
                        return E().createElement(
                            ...
                            'info' !== n && E().createElement('div', { className: P.shine }),
                            E().createElement('div', { className: B }, E().createElement('div', { className: C })),
                            E().createElement('div', { className: c }, e),
                            a && E().createElement('div', { className: d }, a),
                        );
                    }
                }
                ...
                const Y = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const F = (0, a.useRef)([]),
                                    s = (u, t, a) => {
                                        ...
                                        const r = (function ({
                                            ...
                                            D = { mode: u, model: o, externalModel: A, cleanup: s };
                                        return {
                                            model: o,
                                    ...
                                    l = D[0],
                                    B = D[1],
                                    C = (0, a.useState)(() => s(u, r, i)),
                                    c = C[0],
                                    d = C[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        o.current ? d(s(l, r, i)) : (o.current = !0);
                                    }, [i, l, r]),
                                    (0, a.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                    ...
                    Z = X[0],
                    Q = X[1],
                    J = R.strings.armory_yard.introView,
                    uu = ({ onClick: u, className: e }) =>
                        E().createElement(
                            'div',
                            {
                                className: m()('BackButton_base_77', e),
                                onClick: () => {
                                    N.playYes(), u();
                                },
                                onMouseEnter: () => {
                            ...
                            E().createElement('div', { className: 'BackButton_icon_83' }),
                            E().createElement('span', { className: 'BackButton_label_ed' }, J.backButton()),
                            E().createElement('div', { className: 'BackButton_lines_c6' }),
                        ),
                    eu = 'Content_arrowToBottom_cd',
                    tu = 'Content_box_31',
                    au = 'Content_description_7d',
                    Eu = R.strings.armory_yard.introView,
                    ru = ({ className: u }) =>
                        E().createElement(
                            'div',
                            { className: m()('Content_base_5c', u) },
                            E().createElement('div', { className: 'Content_vignette_3c' }),
                            E().createElement(
                                'div',
                                ...
                                E().createElement(
                                    'div',
                                    { className: tu },
                                    E().createElement('div', { className: 'Content_ayInfo_73' }),
                                    E().createElement('span', { className: au }, Eu.quests.descr()),
                                ),
                                E().createElement(
                                    'div',
                                    { className: tu },
                                    E().createElement('div', { className: eu }),
                                    E().createElement('div', { className: 'Content_ayEngine_86' }),
                                    E().createElement('span', { className: au }, Eu.progress.descr()),
                                ),
                                E().createElement(
                                    'div',
                                    { className: tu },
                                    E().createElement('div', { className: eu }),
                                    E().createElement('div', { className: 'Content_ayTank_69' }),
                                    E().createElement('span', { className: au }, Eu.vehicle.descr()),
                                ),
                            ),
                        ),
                    nu = {
                    ...
                    const c = (0, a.useRef)(null),
                        ...
                        N = m()(
                            ...
                            nu[`base__${r}`],
                            {
                                ...
                                [nu.base__firstHover]: b,
                            },
                            A,
                        ),
                        P = m()(nu.state, nu.state__default);
                    return (
                        (0, a.useEffect)(
                            () => (
                        ...
                        E().createElement(
                            ...
                            r !== Au.ghost &&
                                E().createElement(
                                    E().Fragment,
                                    null,
                                    E().createElement('div', { className: nu.back }),
                                    E().createElement('span', { className: nu.texture }),
                                ),
                            E().createElement(
                                'span',
                                { className: P },
                                E().createElement('span', { className: nu.stateDisabled }),
                                E().createElement('span', { className: nu.stateHighlightHover }),
                                E().createElement('span', { className: nu.stateHighlightActive }),
                            ),
                            E().createElement(
                                'span',
                ...
                const su = (0, a.memo)(Fu),
                    ou = R.strings.armory_yard.introView,
                    Du = ({ onClick: u, className: e }) =>
                        E().createElement(
                            'div',
                            { className: m()('Footer_base_8e', e) },
                            E().createElement(
                                su,
                                { type: Au.primary, size: iu.medium, mixClass: 'Footer_button_c0', onClick: u },
                                E().createElement('span', { className: 'Footer_buttonText_fb' }, ou.continueButton()),
                            ),
                        );
                let lu;
                !(function (u) {
                ...
                const Bu = (u, e, t) => {
                    ...
                    cu = (u, e, t = lu.left) => u.split(e).reduce(t === lu.left ? Bu : Cu, []),
                    du = (() => {
                        const u = new RegExp(
                    ...
                    mu = ({ binding: u, text: e = '', classMix: t, alignment: r = lu.left }) =>
                        null === e
                ...
                let hu;
                var gu;
                ((gu = hu || (hu = {})).SHORT_DATE = 'short-date'),
                    ...
                    Date.now();
                const vu = R.strings.armory_yard.introView,
                    wu = R.strings.menu.dateTime.months,
                    pu = ({ startTimestamp: u, endTimestamp: e, className: t }) => {
                        const a = new Date(1e3 * u),
                            r = new Date(1e3 * e),
                            n = String(wu.$num(a.getMonth() + 1)).toUpperCase(),
                            A = String(wu.$num(r.getMonth() + 1)).toUpperCase();
                        return E().createElement(
                            'div',
                            { className: m()('Header_base_61', t) },
                            E().createElement(mu, {
                                text: vu.season(),
                                binding: { from: a.getDate() + ' ' + n, to: r.getDate() + ' ' + A },
                    ...
                    bu = (0, V.Pi)(() => {
                        ...
                        return (
                            ...
                            E().createElement(
                                ...
                                E().createElement(ru, { className: 'App_content_fb' }),
                                e.hasIntroVideoLink.get() &&
                                    E().createElement(uu, { className: 'App_backButton_b7', onClick: t.goBack }),
                                E().createElement(U, {
                                ...
                                E().createElement(Du, { className: 'App_footer_01', onClick: t.continue }),
                            )
                        );
                    });
                engine.whenReady.then(() => {
                    k().render(
                        E().createElement(Z, null, E().createElement(T, null, E().createElement(bu, null))),
        ...
        (__webpack_require__.O = (u, e, t, a) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, t, a] = deferred[i], r = !0, n = 0; n < e.length; n++)
                        (!1 & a || E >= a) &&
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); i < r.length; i++)
                        (E = r[i]), __webpack_require__.o(u, E) && u[E] && u[E][0](), (u[E] = 0);
                    return __webpack_require__.O(F);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t)));
        })();
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(971));
