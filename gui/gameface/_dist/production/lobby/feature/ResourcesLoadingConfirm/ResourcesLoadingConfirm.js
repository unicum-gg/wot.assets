    ...
    var __webpack_modules__ = {
                ...
                const A = ({
                    ...
                    return E().createElement(
                        ...
                        s.split('\n').map((e, A) =>
                            E().createElement(
                                'div',
                                { className: n()(o.Z.base, t), key: `${e}-${A}` },
            ...
            3649: (u, e, t) => {
                ...
                const i = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    A = (u, e, t = n.left) => u.split(e).reduce(t === n.left ? E : o, []),
                    s = (() => {
                        const u = new RegExp(
                            [
                                          ...
                                          : 'ja' === t
                                            ...
                                            : ((u, e = n.left) => {
                                                  ...
                                                  const r =
                                                      ...
                                                      a = i(u);
                                                  return (
                                                      A(a, /( )/, e).forEach((u) => (t = t.concat(A(u, r, n.left)))),
                                                      t
                                                  );
                                              })(u, e);
                                  })(u, e),
            ...
            604: (u, e, t) => {
                ...
                (0, r.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && B) return a(e, t, p);
                ...
                const p = {
                    ...
                    w = (u) => {
                        ...
                        const i = (() => {
                            ...
                            o = i.mediaHeight,
                            A = i.mediaSize;
                        return n().createElement('div', v({ className: B()(t, p[E], f[o], b[A]) }, a), e);
                    },
                    x = ['children'],
                    y = (u) => {
                        let e = u.children,
                        ...
                        return n().createElement(l, null, n().createElement(w, t, e));
                    };
                var L = t(1533),
                    S = t.n(L);
                const T = {
                ...
                const k = (u) => {
                    ...
                    const v = (0, r.useCallback)(
                            (u) => {
                                (null == o || o(u), i.O.sound.play.sound(d));
                            },
                            [o, d],
                        ),
                        p = (0, r.useCallback)(
                        ...
                        f = (0, r.useCallback)(
                            (u) => {
                                (null == s || s(u), i.O.sound.play.sound(h));
                            },
                            [s, h],
                        ),
                        b = (0, r.useCallback)(
                    ...
                    return n().createElement(
                        ...
                        M(
                            {
                                className: B()(T.base, T[`base__${C}`], T[`base__${l}`], null == E ? void 0 : E.base),
                                onMouseEnter: v,
                                onMouseLeave: p,
                                onMouseDown: f,
                                onMouseUp: b,
                        ...
                        'info' !== C && n().createElement('div', { className: T.shine }),
                        n().createElement(
                            'div',
                            { className: B()(T.icon, T[`icon__${C}`], T[`icon__${l}`], null == E ? void 0 : E.icon) },
                            n().createElement('div', { className: B()(T.glow, null == E ? void 0 : E.glow) }),
                        ),
                        n().createElement(
                            'div',
                            { className: B()(T.caption, T[`caption__${C}`], null == E ? void 0 : E.caption) },
                            e,
                        ),
                        a && n().createElement('div', { className: B()(T.goto, null == E ? void 0 : E.goto) }, a),
                    );
                };
                var P = t(5521);
                t(9916);
                ...
                function N(u = P.n.NONE, e = H, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== P.n.NONE)
                            return (
                    ...
                    $ = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: a, children: E, mocks: o }) {
                                const A = (0, r.useRef)([]),
                                    s = (u, t, r) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            c = { mode: u, model: F, externalModel: E, cleanup: s };
                                        return {
                                            model: F,
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        F.current ? _(s(l, a, o)) : (F.current = !0);
                                    }, [o, l, a]),
                                    (0, r.useEffect)(() => {
                                        D(u);
                                    }, [u]),
                ...
                const uu = ({
                        ...
                        return (
                            ...
                            n().createElement(
                                'div',
                                {
                                    ...
                                    onMouseDown: function (u) {
                                        t ||
                                            (null !== C && Z(C),
                                            o && o(u),
                                            c && (t || (_.current && (_.current.focus(), h(!0)))),
                                            p(!0));
                                    },
                                ...
                                n().createElement(
                                    'span',
                                    { className: B()(X.state, X.state__default) },
                    ...
                    eu = 'ButtonsBlock_button_7f',
                    tu = R.strings.resource_well.confirm,
                    ru = ({ operationType: u, handleOnConfirm: e, handleOnCancel: t, mixClass: r }) => {
                        const a = B()('ButtonsBlock_base_b7', r);
                        return n().createElement(
                            'div',
                            { className: a },
                            u === W.Contribute
                                ? n().createElement(
                                      ...
                                      n().createElement(
                                          uu,
                                          { type: Q.main, size: J.medium, onClick: e, mixClass: eu },
                                          tu.resourcesContribute.buttonConfirm.title(),
                                      ),
                                      n().createElement(
                                          uu,
                                          { type: Q.primary, size: J.medium, onClick: t, mixClass: eu },
                                          tu.buttonCancel.title(),
                                      ),
                                  )
                                : n().createElement(
                                      n().Fragment,
                                      ...
                                      n().createElement(
                                          uu,
                                          { type: Q.primary, size: J.medium, onClick: e, mixClass: eu },
                                          tu.resourcesReturn.buttonConfirm.title(),
                                      ),
                                      n().createElement(
                                          uu,
                                          { type: Q.secondary, size: J.medium, onClick: t, mixClass: eu },
                                          tu.buttonCancel.title(),
                                      ),
                                  ),
                        );
                ...
                const au = R.strings.resource_well.confirm,
                    iu = ({ operationType: u, progressDiff: e = 0, vehicleName: t, mixClass: r }) => {
                        const a = B()('DescriptionBlock_base_a7', r);
                        return n().createElement(
                            'div',
                            { className: a },
                            n().createElement(
                    ...
                    ou = ({ operationType: u, mixClass: e, vehicleName: t }) =>
                        n().createElement(
                            'div',
                            { className: e },
                            (() => {
                                switch (u) {
                                    case W.Contribute:
                                        return Eu.resourcesContribute.title();
                                    case W.Return:
                                        return Eu.resourcesReturn.title();
                                    case W.Switch:
                                        return n().createElement(nu.z, {
                                            text: Eu.resourcesReturnOnSwitch.title(),
                            ...
                            n().createElement(
                                ...
                                o &&
                                    n().createElement(
                                        ...
                                        n().createElement(Y.M, { vehicleCounter: e.vehicleCounter.get() }),
                                    ),
                                n().createElement(
                                    'div',
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            ...
                                            e.resources
                                                .get()
                                                .map((u, e) => n().createElement(K._, { key: e, resource: u.value })),
                                        ),
                                        n().createElement('div', { className: Au }),
                                    ),
                                    n().createElement(iu, {
                ...
                engine.whenReady.then(() => {
                    S().render(
                        n().createElement(j, null, n().createElement(y, null, n().createElement(su, null))),
            ...
            9625: (u, e, t) => {
                ...
                const A = {
                    ...
                    s = ({ resource: { count: u, subType: e, type: t } }) => {
                        const r = n()(A.counter, 'currency' !== t && A.counter__noCurrency, A[`counter__${e}`]);
                        return o().createElement(
                            'div',
                            { className: A.base },
                            o().createElement('div', { className: n()(A.resourceIcon, A[`resourceIcon__${e}`]) }),
                            o().createElement(
                                'div',
                                { className: r },
                                o().createElement(
                                            ...
                                            switch (D) {
                                                ...
                                                case F.noRemains:
                                                    return E().createElement(
                                                        ...
                                                        E().createElement(
                                                            'span',
                                                            { className: n()(s, 'VehicleCount_text__finished_5a') },
                                                            R.strings.resource_well.resourcesLoadingView.noVehiclesRemains(),
                                                        ),
                                                    );
                                                case F.noData:
                                                    return E().createElement(a.z, {
                                                        classMix: n()(s, 'VehicleCount_text__alert_d1'),
