    ...
    var __webpack_modules__ = {
            ...
            9060: (u, e, t) => {
                ...
                const B = {
                    ...
                    h = Object.keys(C).reduce((u, e) => ((u[e] = () => c(C[e])), u), {}),
                    g = { play: Object.assign({}, h, { sound: c }), setRTPC: d },
                    w = { view: t(2031), client: n, sound: g, intl: _ };
            },
            2031: (u, e, t) => {
                'use strict';
                (t.r(e),
                ...
                const M = Object.keys(o).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === o[e]), u), {}),
                    k = {
                        set: (u, e) => {
            ...
            1263: (u, e, t) => {
                ...
                (0, r.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraSmallWidth && B) return o(e, t, v);
                        if (
                ...
                const b = {
                    ...
                    y = (u) => {
                        ...
                        const a = (() => {
                            ...
                            s = a.mediaHeight,
                            E = a.mediaSize;
                        return n().createElement('div', f({ className: B()(t, b[o], p[s], x[E]) }, i), e);
                    },
                    L = ['children'],
                    S = (u) => {
                        let e = u.children,
                        ...
                        const w = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, r.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (eu(t, d, { isMouseEvent: !0, on: !0, arguments: uu(n) }, v),
                                    C && C(),
                ...
                function au(u) {
                    const e = nu(u),
                        t = e.day,
                        r = e.month;
                    return G(R.strings.fun_random.entryPoint.startDate(), {
                        day: t,
                ...
                function ou(u) {
                    const e = nu(u),
                        t = e.day,
                        r = e.month;
                    return G(R.strings.fun_random.entryPoint.endDate(), {
                        day: t,
                        month: R.strings.menu.dateTime.months.$num(r + 1),
                    });
                }
                        ...
                        const r = (function (u, e) {
                                switch (u) {
                                    case Y.Before:
                                        return [au(e.start), !1];
                                    case Y.Active:
                                        return e.left > z ? [ou(e.end), !1] : [iu(e.left), !0];
                                    case Y.NotPrimeTime:
                                        return [iu(e.left), !0];
                                    default:
                                        return ['', !1];
                            ...
                            i = r[0],
                            a = r[1],
                            o = [Y.NotPrimeTime, Y.After].includes(u);
                        return n().createElement(
                            'div',
                            { className: B()(ru[`base__${t}`], ru.endDate, a && !o && ru.glowText) },
                            a &&
                                n().createElement('div', { className: B()(ru.timerIcon, o && ru.timerIcon__disabled) }),
                            i,
                        );
                    },
                    Eu = {
                ...
                let Au, Fu;
                function cu(u, e) {
                    return u === Y.Active && e <= z;
                }
                function du(u, e) {
                    if (e === Fu.LowRisk) return;
                    const t = e === Fu.HighRisk ? Au.Blocker : Au.Alert;
                ...
                const Du = (0, K.Pi)(() => {
                    ...
                    const e = N(),
                        ...
                        l = t.performance.get(),
                        A = t.computes.time(),
                        F = [Y.NotPrimeTime, Y.After].includes(o),
                        c = o === Y.Active,
                        d = (() => {
                        ...
                        D = d.width,
                        m = d.height,
                        _ = null != (u = lu[`${D}x${m}`]) ? u : 'big',
                        C = (function (u, { poFileName: e, assetsPointer: t, isSubMode: r = !1 } = {}) {
                            ...
                            const i = r ? 'sub_modes' : 'modes',
                                a = n.$dyn(i),
                                o = (t ? (null == a ? void 0 : a.$dyn(t)) : n) || (null == a ? void 0 : a.$dyn(Z));
                            return u
                                ? { staticTexts: Q(n, u), dynamicTexts: Q(o, u) }
                        ...
                        g = (function (u, e) {
                            var t;
                            const r = X.$dyn('modes');
                            return null != (t = r.$dyn(u)) ? t : r.$dyn(Z);
                        })(E),
                        w = { backgroundImage: `url(${g.entry_point.$dyn(_)})` },
                        v = {
                            backgroundImage: `url(${R.images.fun_random.gui.maps.icons.feature.entry_point.hover.$dyn(`${_}_hover`)})`,
                        };
                    return n().createElement(
                        tu,
                        {
                            contentId: R.views.lobby.common.tooltips.SimpleIconTooltip('resId'),
                            args: du(h, l.performanceRisk),
                            isEnabled: l.showPerfRisk,
                        },
                        n().createElement(
                            'div',
                            {
                                className: B()(Eu.base, F && Eu.base__disabled, Eu[`base__${_}`]),
                                onClick: function () {
                                    (s.O.sound.play.yes1(), i.actionClick());
                                },
                                onMouseEnter: () => s.O.sound.play.highlight(),
                            },
                            n().createElement('div', { className: Eu.bg, style: w }),
                            n().createElement('div', { className: Eu.shadow }),
                            F && n().createElement('div', { className: Eu.overlay }),
                            c &&
                                n().createElement('div', {
                                    className: B()(Eu.hoverEffect, cu(o, A.left) && Eu.active),
                                    style: v,
                                }),
                            n().createElement('div', { className: Eu.header }, h.capsUserName()),
                            n().createElement(
                                'div',
                                { className: B()(Eu.subtitle, Eu[`base__${_}`]) },
                                (function (u) {
                                    switch (u) {
                                        case Y.NotPrimeTime:
                            ...
                            l.showPerfRisk &&
                                n().createElement('div', {
                                    className: B()(Eu.alertIcon, Eu[`alertIcon__${l.performanceRisk}`]),
                                }),
                            n().createElement(su, { state: o, time: A, currentSize: _ }),
                        ),
                    );
                });
                engine.whenReady.then(() => {
                    a().render(
                        n().createElement(W, null, n().createElement(S, null, n().createElement(Du, null))),
