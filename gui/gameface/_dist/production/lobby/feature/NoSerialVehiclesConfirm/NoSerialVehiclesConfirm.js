(() => {
    var __webpack_modules__ = {
                ...
                const F = ({
                    ...
                    return i().createElement(
                        ...
                        o.split('\n').map((e, F) =>
                            i().createElement(
                                'div',
                                { className: r()(A.Z.base, t), key: `${e}-${F}` },
            ...
            3138: (u, e, t) => {
                ...
                var n = t(5959),
                    r = t(7698),
                    a = t(514);
                const E = { view: t(7641), client: n, sound: a.ZP, intl: r.N };
            },
            7698: (u, e, t) => {
                'use strict';
                t.d(e, { N: () => n });
            ...
            3649: (u, e, t) => {
                ...
                const E = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    F = (u, e, t = r.left) => u.split(e).reduce(t === r.left ? i : A, []),
                    o = (() => {
                        const u = new RegExp(
                            [
                                          ...
                                          : 'ja' === t
                                            ...
                                            : ((u, e = r.left) => {
                                                  ...
                                                  const n =
                                                      ...
                                                      a = E(u);
                                                  return (
                                                      F(a, /( )/, e).forEach((u) => (t = t.concat(F(u, n, r.left)))),
                                                      t
                                                  );
                                              })(u, e);
                                  })(u, e),
            ...
            5359: (u, e, t) => {
                ...
                (0, n.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && B) return a(e, t, w);
                ...
                const w = {
                    ...
                    b = (u) => {
                        ...
                        const E = (() => {
                            ...
                            A = E.mediaHeight,
                            F = E.mediaSize;
                        return r().createElement('div', v({ className: B()(t, w[i], p[A], f[F]) }, a), e);
                    },
                    x = ['children'],
                    L = (u) => {
                        let e = u.children,
                ...
                const P = ({
                    ...
                    return (
                        (0, n.useEffect)(() => {
                            function u(u) {
                                m && null !== d.current && !d.current.contains(u.target) && h(!1);
                            }
                            return (
                            ...
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    t ||
                                        (null !== C && T(C),
                                        A && A(u),
                                        D && (t || (d.current && (d.current.focus(), h(!0)))),
                                        w(!0));
                                },
                ...
                const G = (u) => {
                    ...
                    const v = (0, n.useCallback)(
                        ...
                        p = (0, n.useCallback)(
                            (u) => {
                                (null == o || o(u), E.O.sound.play.sound(h));
                            },
                            [o, h],
                        ),
                        f = (0, n.useCallback)(
                    ...
                    return r().createElement(
                        ...
                        U(
                            {
                                className: B()(W.base, W[`base__${C}`], W[`base__${l}`], null == i ? void 0 : i.base),
                                onMouseEnter: v,
                                onMouseLeave: w,
                                onMouseDown: p,
                                onMouseUp: f,
                        ...
                        'info' !== C && r().createElement('div', { className: W.shine }),
                        r().createElement(
                            'div',
                            { className: B()(W.icon, W[`icon__${C}`], W[`icon__${l}`], null == i ? void 0 : i.icon) },
                            r().createElement('div', { className: B()(W.glow, null == i ? void 0 : i.glow) }),
                        ),
                        r().createElement(
                            'div',
                            { className: B()(W.caption, W[`caption__${C}`], null == i ? void 0 : i.caption) },
                            e,
                        ),
                        a && r().createElement('div', { className: B()(W.goto, null == i ? void 0 : i.goto) }, a),
                    );
                };
                var V = t(5521);
                t(9916);
                ...
                function j(u = V.n.NONE, e = $, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== V.n.NONE)
                            return (
                ...
                const Y = (u) => (0 === u ? window : window.subViews.get(u)),
                    Z = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: a, children: i, mocks: A }) {
                                const F = (0, n.useRef)([]),
                                    o = (u, t, n) => {
                                        var r;
                                        const a = (function ({
                                            ...
                                            s = (({ observableModel: u }) => ({
                                                root: u.object(),
                                                vehicleCounter: u.object('vehicleCounter'),
                                            }))({
                                                mode: u,
                                                readByPath: A,
                                                externalModel: i,
                                    ...
                                    l = D[0],
                                    c = D[1],
                                    B = (0, n.useState)(() => o(u, a, A)),
                                    C = B[0],
                                    d = B[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        s.current ? d(o(l, a, A)) : (s.current = !0);
                                    }, [A, l, a]),
                                    (0, n.useEffect)(() => {
                                        c(u);
                                    }, [u]),
                        ...
                        confirm: u.createCallbackNoArgs('confirm'),
                        cancel: u.createCallbackNoArgs('cancel'),
                        close: u.createCallbackNoArgs('close'),
                    })),
                    X = Z[0],
                    Q = Z[1];
                var J = t(7712);
                const uu = 'App_button_3f',
                    eu = R.strings.resource_well.confirm.NoSerialVehicles,
                    tu = (0, M.Pi)(() => {
                        const u = Q(),
                            e = u.model,
                            t = u.controls,
                            n = e.root.get().vehicleName;
                        var a;
                        return (
                            (a = t.cancel),
                            j(V.n.ESCAPE, a),
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: 'App_vehiclesCount_3f' },
                                    r().createElement(J.M, { vehicleCounter: e.vehicleCounter.get() }),
                                ),
                                r().createElement(
                                    'div',
                                    { className: 'App_close_64' },
                                    r().createElement(G, {
                                ...
                                r().createElement(
                                    'div',
                                    { className: 'App_imageWrapper_4e' },
                                    r().createElement('div', { className: 'App_imageGlow_31' }),
                                    r().createElement('div', { className: 'App_image_60' }),
                                ),
                                r().createElement(
                                    'div',
                                    { className: 'App_title_49' },
                                    r().createElement(N.z, { text: eu.title(), binding: { vehicleName: n } }),
                                ),
                                r().createElement(
                                    'div',
                                    { className: 'App_description_14' },
                                    r().createElement(N.z, { text: eu.description(), binding: { vehicleName: n } }),
                                ),
                                r().createElement('div', { className: 'App_divider_9b' }),
                                r().createElement(
                                    'div',
                                    { className: 'App_buttonsWrapper_4f' },
                                    r().createElement(
                                        P,
                                        { type: k.main, size: H.medium, onClick: t.confirm, mixClass: uu },
                                        eu.buttonConfirm.title(),
                                    ),
                                    r().createElement(
                                        P,
                                        { type: k.primary, size: H.medium, onClick: t.cancel, mixClass: uu },
                                        eu.buttonCancel.title(),
                                    ),
                                ),
                            )
                        );
                ...
                engine.whenReady.then(() => {
                    S().render(
                        r().createElement(X, null, r().createElement(L, null, r().createElement(tu, null))),
            ...
            7712: (u, e, t) => {
                ...
                var n = t(6483),
                    ...
                    A = t(9953),
                    F = t(4306);
                const o = 'VehicleCount_text_6f',
                    s = { remainTop: 'remainTop', remain: 'remain', noRemains: 'noRemains', noData: 'noData' },
                    D = (u) => {
                        const e = u.vehicleCounter,
                            t = e.vehicleCount,
                            n = e.isVehicleCountAvailable,
                            E = e.isSerial,
                            D = t < 20,
                            l = n && t > 0,
                            c =
                            ...
                            C = {
                                counter: i().createElement(
                                    ...
                                    D && i().createElement('span', { className: 'VehicleCount_counterGlow_a9' }),
                        ...
                        return i().createElement(
                            ...
                            i().createElement(
                                ...
                                i().createElement(
                                    F.Z,
                                    { key: `state-${s}-${t}`, timeout: 300, classNames: B },
                                    i().createElement(
                                        'div',
                                        null,
                                        (() => {
                                            switch (c) {
                                                ...
                                                case s.noRemains:
                                                    return i().createElement(
                                                        ...
                                                        i().createElement(
                                                            'span',
                                                            { className: r()(o, 'VehicleCount_text__finished_5a') },
                                                            R.strings.resource_well.resourcesLoadingView.noVehiclesRemains(),
                                                        ),
                                                    );
                                                case s.noData:
                                                    return i().createElement(a.z, {
                                                        classMix: r()(o, 'VehicleCount_text__alert_d1'),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/feature/NoSerialVehiclesConfirm/NoSerialVehiclesConfirm'),
        (() => {
            var u = {
                'lobby/feature/NoSerialVehiclesConfirm/NoSerialVehiclesConfirm': 0,
