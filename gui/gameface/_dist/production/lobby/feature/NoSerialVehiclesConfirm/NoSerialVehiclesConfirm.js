    ...
    var __webpack_modules__ = {
                                          ...
                                          : 'ja' === t
                                            ...
                                            : ((u, e = r.left) => {
                                                  ...
                                                  const n =
                                                      ...
                                                      a = E(u);
                                                  return (
                                                      F(a, /( )/, e).forEach((u) => (t = t.concat(F(u, n, r.left)))), t
                                                  );
                                              })(u, e);
                                  })(u, e),
                        );
            ...
            9465: (u, e, t) => {
                ...
                const o = E.O.client.getSize('rem'),
                    ...
                    C = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && s) return a(e, t, p);
                            if (t.largeWidth && D) return a(e, t, p);
                            if (t.mediumWidth && l) return a(e, t, p);
                            if (t.smallWidth && C) return a(e, t, p);
                            if (t.extraSmallWidth && d) return a(e, t, p);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                const d = ({ children: u }) => {
                    ...
                    return r().createElement(c.Provider, { value: D }, u);
                };
                var _ = t(6483),
                    m = t.n(_),
                    h = t(926),
                ...
                const x = {
                    ...
                    S = (u) => {
                        ...
                        const E = (() => {
                            ...
                            A = E.mediaHeight,
                            F = E.mediaSize;
                        return r().createElement('div', b({ className: m()(t, x[i], L[A], y[F]) }, a), e);
                    },
                    M = ['children'],
                    T = (u) => {
                        let e = u.children,
                ...
                const U = ({
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    E ||
                                        (null !== F && P(F),
                                        D && D(u),
                                        t && (E || (C.current && (C.current.focus(), h(!0)))),
                                        p(!0));
                                },
                            ...
                            r().createElement(
                                'span',
                                { className: m()(N.state, N.state__default) },
                ...
                class q extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = m()(j.base, j[`base__${E}`], j[`base__${a}`], null == i ? void 0 : i.base),
                            c = m()(j.icon, j[`icon__${E}`], j[`icon__${a}`], null == i ? void 0 : i.icon),
                            B = m()(j.glow, null == i ? void 0 : i.glow),
                            C = m()(j.caption, j[`caption__${E}`], null == i ? void 0 : i.caption),
                            d = m()(j.goto, null == i ? void 0 : i.goto);
                        return r().createElement(
                            ...
                            'info' !== E && r().createElement('div', { className: j.shine }),
                ...
                function Z(u = K.n.NONE, e = Y, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== K.n.NONE)
                            return (
                        ...
                        return (
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(ru.M, { vehicleCounter: e.vehicleCounter.get() }),
                                ),
                                r().createElement(
                                    'div',
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(V.z, { text: Eu.title(), binding: { vehicleName: n } }),
                                ),
                                r().createElement(
                                    'div',
                                    { className: 'App_description_14' },
                                    r().createElement(V.z, { text: Eu.description(), binding: { vehicleName: n } }),
                                ),
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        G,
                                        { type: W.main, size: I.medium, onClick: t.confirm, mixClass: au },
                                        Eu.buttonConfirm.title(),
                                    ),
                                    r().createElement(
                                        G,
                                        { type: W.primary, size: I.medium, onClick: t.cancel, mixClass: au },
                ...
                engine.whenReady.then(() => {
                    k().render(
                        r().createElement(tu, null, r().createElement(T, null, r().createElement(iu, null))),
