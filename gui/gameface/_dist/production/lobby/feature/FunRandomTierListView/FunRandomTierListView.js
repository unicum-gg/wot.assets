    ...
    var __webpack_modules__ = {
            ...
            2031: (u, e, t) => {
                ...
                const y = (() => {
                    ...
                    P = n.cg,
                    L = Object.keys(o).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === o[e]), u), {}),
                    O = {
                        set: (u, e) => {
            ...
            9982: (u, e, t) => {
                ...
                const x = {
                    ...
                    L = (u) => {
                        ...
                        const n = (() => {
                            ...
                            s = n.mediaHeight,
                            l = n.mediaSize;
                        return i().createElement('div', S({ className: p()(t, x[o], y[s], P[l]) }, r), e);
                    },
                    O = ['children'],
                    M = (u) => {
                        let e = u.children,
                        ...
                        return i().createElement(C, null, i().createElement(L, t, e));
                    };
                var k = t(1533),
                    N = t.n(k),
                    I = t(1281);
                ...
                const H = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    z = (u, e, t = U.left) => u.split(e).reduce(t === U.left ? G : W, []),
                    $ = (() => {
                        const u = new RegExp(
                    ...
                    j = ['zh_cn', 'zh_sg', 'zh_tw'],
                    V = ({ binding: u, text: e = '', classMix: t, alignment: r = U.left, formatWithBrackets: n }) => {
                ...
                const tu = {
                        ...
                        return (s = {}) => {
                            ...
                            return (
                                ...
                                (0, a.useMemo)(
                                    ...
                                    [m.scrollPosition, g, p, D.off, D.on, v, h, _, E.step.clampedArrowStepTimeout],
                                )
                            );
                        };
                    },
                    ...
                    cu = (0, a.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = su, onDrag: r = lu }) => {
                        ...
                        const C = Q((e) => u.applyStepTo(e), A, [u]),
                            g = C[0],
                            h = C[1];
                        (0, a.useEffect)(
                            () => (
                        ...
                        return i().createElement(
                            'div',
                            { className: p()('HorizontalBar_base_49', e.base), ref: n, onWheel: u.handleMouseWheel },
                            i().createElement('div', {
                                className: p()('HorizontalBar_leftButton_5f', e.leftButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(iu) || 0 !== u.button || (Z('play'), g(eu.Next));
                                },
                                onMouseUp: h,
                                ref: o,
                                onMouseEnter: f,
                            ...
                            i().createElement(
                                ...
                                i().createElement('div', { ref: c, className: p()('HorizontalBar_thumb_fd', e.thumb) }),
                                i().createElement('div', { className: p()('HorizontalBar_rail_32', e.rail) }),
                            ),
                            i().createElement('div', {
                                className: p()('HorizontalBar_rightButton_03', e.rightButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(iu) || 0 !== u.button || (Z('play'), g(eu.Prev));
                                },
                                onMouseUp: h,
                                ref: l,
                                onMouseEnter: f,
                ...
                class yu extends i().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            F = p()(Su.base, Su[`base__${a}`], Su[`base__${n}`], null == o ? void 0 : o.base),
                            D = p()(Su.icon, Su[`icon__${a}`], Su[`icon__${n}`], null == o ? void 0 : o.icon),
                            d = p()(Su.glow, null == o ? void 0 : o.glow),
                            B = p()(Su.caption, Su[`caption__${a}`], null == o ? void 0 : o.caption),
                            m = p()(Su.goto, null == o ? void 0 : o.goto);
                        return i().createElement(
                            'div',
                            xu(
                                {
                            ...
                            'info' !== a && i().createElement('div', { className: Su.shine }),
                ...
                function Mu(u = Pu.n.NONE, e = Ou, t = !1, r = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== Pu.n.NONE)
                            return (
                ...
                function Hu(u, e) {
                    ...
                    const r = e ? 'sub_modes' : 'modes',
                        n = Nu.$dyn(r);
                    return null != (t = n.$dyn(u)) ? t : n.$dyn(Iu);
                }
                function Gu() {
                    return !1;
                }
                        ...
                        const h = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, a.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (ie(t, D, { isMouseEvent: !0, on: !0, arguments: ae(r) }, f),
                                    C && C(),
                ...
                const Be = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return i().createElement(De, e, r);
                    const n = e.contentId;
                    return n ? i().createElement(oe, de({}, e, { contentId: n }), r) : i().createElement(Ee, e, r);
                };
                ...
                const _e = [
                    ...
                    Ce = [Xu.Gold, Xu.Credits, Xu.Crystal, Xu.FreeXp],
                    ge = [Xu.BattlePassPoints, Xu.EquipCoin],
                    pe = [Xu.PremiumPlus, Xu.Premium],
                    ...
                    Se = ({
                        ...
                        const D = ((u, e) => {
                                if (void 0 === e || !we.includes(u)) return null;
                                switch (e) {
                            ...
                            d = ((u) => {
                                ...
                                switch (u) {
                                    ...
                                    case Ju.ATTACHMENT_RARE:
                                        return ee.ATTACHMENT_RARE;
                                    case Ju.ATTACHMENT_EPIC:
                                        return ee.ATTACHMENT_EPIC;
                                    case Ju.ATTACHMENT_LEGENDARY:
                            ...
                            B = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case Zu.CURRENCY:
                                    case Zu.NUMBER:
                                        return i().createElement(me, { format: 'integral', value: Number(u) });
                        ...
                        return i().createElement(
                            'div',
                            {
                                className: p()(Te.base, Te[`base__${r}`], re.includes(u) && Te.base__normalize, E),
                                style: l,
                            },
                            i().createElement(
                                Be,
                                { tooltipArgs: A, className: Te.tooltipWrapper },
                                i().createElement(
                                    i().Fragment,
                                    null,
                                    i().createElement(
                                        'div',
                                        { className: p()(Te.image, null == c ? void 0 : c.image) },
                                        D &&
                                            i().createElement('div', {
                                                className: p()(Te.highlight, null == c ? void 0 : c.highlight),
                                                style: {
                                        ...
                                        e &&
                                            i().createElement('div', {
                                                className: p()(Te.icon, null == c ? void 0 : c.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        d &&
                                            i().createElement('div', {
                                                className: p()(Te.overlay, null == c ? void 0 : c.overlay),
                                                style: {
                                        ...
                                        i().createElement(
                                            'div',
                                            {
                                                className: p()(
                                                    Te.info,
                                                    Te[`info__${u}`],
                                                    o === Zu.MULTI && Te.info__multi,
                                                    null == c ? void 0 : c.info,
                                                ),
                                            },
                                            B,
                                        ),
                                    s && i().createElement('div', { className: Te.title }, s),
                                ),
                            ),
                            t &&
                                i().createElement(
                                    ...
                                    { tooltipArgs: F },
                                    i().createElement('div', {
                                        className: p()(Te.timer, null == c ? void 0 : c.periodicIcon),
                                    }),
                                ),
                        );
                    },
                ...
                const ye = (0, ku.Pi)(({ rewards: u, iconKey: e, label: t, showRewardsNames: r }) => {
                    const n = qu().model,
                                            ...
                                            : Ce.includes(t)
                                              ...
                                              : ge.includes(t)
                                                ...
                                                : pe.includes(t)
                                                  ? Zu.PREMIUM_PLUS
                                                  : Zu.STRING),
                                    tooltipArgs: be({ tooltipId: u.tooltipId }, Number(u.tooltipContentId)),
                                    label: u.label,
                                    probability: u.probability,
                                };
                                var t;
                            }))(u, o),
                        l = Hu(a).progression.bonuses.big;
                    return i().createElement(
                        'div',
                        { className: p()(Re.base, Re[`base__${o}`]) },
                        i().createElement(
                            'div',
                            { className: Re.box },
                            i().createElement('div', {
                                className: Re.boxIcon,
                                style: { backgroundImage: `url(${l.$dyn(e)})` },
                            }),
                            i().createElement('div', { className: Re.boxLabel }, t),
                        ),
                        i().createElement('div', { className: Re.divider }),
                        i().createElement(
                            'div',
                            { className: Re.items },
                            s.length > 0 &&
                                Yu(s, (u, e) => {
                                    return i().createElement(
                                        'div',
                                        { className: Re.item, key: e },
                                        i().createElement(Se, xe({}, u, { size: o })),
                                        r && u.label && i().createElement(V, { classMix: Re.label, text: u.label }),
                                        Boolean(u.probability) &&
                                            i().createElement(
                                                'div',
                                                { className: Re.percent },
                ...
                const Le = (0, ku.Pi)(() => {
                        const u = qu().model.lootBoxes.get();
                        return i().createElement(
                            'div',
                            { className: 'RewardList_base_6e' },
                            u.length > 0 && Yu(u, (u, e) => i().createElement(ye, Pe({}, u, { key: e }))),
                        );
                    }),
                    Oe = (0, ku.Pi)(() => {
                        const u = qu(),
                        ...
                        const o = (function (u, { poFileName: e, assetsPointer: t, isSubMode: r = !1 } = {}) {
                                ...
                                const a = r ? 'sub_modes' : 'modes',
                                    i = n.$dyn(a),
                                    o = (t ? (null == i ? void 0 : i.$dyn(t)) : n) || (null == i ? void 0 : i.$dyn(Iu));
                                return u
                                    ? { staticTexts: Uu(n, u), dynamicTexts: Uu(o, u) }
                        ...
                        return i().createElement(
                            ...
                            i().createElement('div', {
                                ...
                                style: { backgroundImage: `url('${Hu(r).library.tier_list_bg()}')` },
                            }),
                            i().createElement(
                                ...
                                i().createElement(
                                    ...
                                    i().createElement(
                                        ...
                                        i().createElement(
                                            ...
                                            i().createElement(V, { text: s.title() }),
                                        ),
                                        i().createElement(
                                            'div',
                                            { className: 'App_description_0e' },
                                            i().createElement(V, { text: s.description() }),
                                        ),
                                    ),
                ...
                engine.whenReady.then(() => {
                    N().render(
                        i().createElement(Vu, null, i().createElement(M, null, i().createElement(Oe, null))),
