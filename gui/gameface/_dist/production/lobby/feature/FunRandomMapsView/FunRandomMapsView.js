(() => {
    var __webpack_modules__ = {
            ...
            1996: (u, e, t) => {
                ...
                var n = {};
                (t.r(n), t.d(n, { Area: () => xe, Bar: () => we, Default: () => Se, useVerticalScrollApi: () => Be }));
                var a = t(6179),
                    o = t.n(a),
                    i = t(493),
                    s = t.n(i);
                ...
                const $ = (u) =>
                        (function (u, e) {
                            return Array.isArray(u) ? u.map(e) : u.map((u, t, r) => e(null == u ? void 0 : u.value));
                        })(u, (u) => Object.assign({}, u)),
                    z = ((u, e) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            E = (({ observableModel: u }) => {
                                                const e = {
                                                    ...
                                                    n = (0, V.Om)(() => $(e.selectedMap.get().modifiers), {
                                                        equals: W,
                                                    });
                ...
                const uu = (0, a.memo)(({ closeControl: u, showInfoControl: e, titleText: t, subTitleText: r }) =>
                        o().createElement(
                            'div',
                ...
                const Du = {
                    ...
                    gu = Fu((u) => {
                        let e = u.className,
                            ...
                            w =
                                void 0 === b
                                    ...
                                    : b,
                            M = u.alignItems,
                            S = void 0 === M ? (C ? 'flex-start' : g && 'center') || (p && 'flex-end') || void 0 : M,
                            x = u.alignSelf,
                            L = u.wrap,
                            y = u.flexWrap,
                        ...
                        return o().createElement('div', _u({ className: f()(mu.base, ...U, e), style: G }, I), H);
                    });
                let pu;
                function hu(u) {
                ...
                const $u = (u, e, t = {}, r = 0) => {
                    ...
                    Yu = (0, a.memo)(({ className: u, mapMods: e, mapPoints: t }) => {
                        const r =
                            ((n = e),
                            5,
                            Array.from({ length: Math.ceil(n.length / 5) }, (u, e) => n.slice(5 * e, 5 * (e + 1))));
                        var n;
                        const a = e.length > 0,
                            i = t.length > 0;
                        return o().createElement(
                ...
                const ae = {
                    ...
                    me = (0, a.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = Ee, onDrag: r = Ae }) => {
                        ...
                        return o().createElement(
                            'div',
                            { className: f()('HorizontalBar_base_49', e.base), ref: n, onWheel: u.handleMouseWheel },
                            o().createElement('div', {
                            ...
                            o().createElement(
                                ...
                                o().createElement('div', { ref: c, className: f()('HorizontalBar_thumb_fd', e.thumb) }),
                ...
                const Be = oe({
                    ...
                    we = (0, a.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = fe, onDrag: r = pe }) => {
                        const n = (0, a.useRef)(null),
                            i = (0, a.useRef)(null),
                            s = (0, a.useRef)(null),
                            l = (0, a.useRef)(null),
                        ...
                        return o().createElement(
                            'div',
                            { className: f()('VerticalBar_base_f3', e.base), ref: n, onWheel: u.handleMouseWheel },
                            o().createElement('div', {
                ...
                const Ve = R.strings.fun_random.mapsView.carousel.title,
                    $e = (0, a.memo)(
                        ({ isHover: u, mapList: e, handleSelectMap: t, nextMapControl: r, prevMapControl: n }) => {
                            const i = ie(),
                                s = (0, a.useState)(0),
                                l = s[0],
                                E = s[1],
                            ...
                            (!(function (u, e) {
                                ...
                                ((0, a.useEffect)(() => {
                                    ...
                                    (0, a.useEffect)(() => {
                                        ...
                                        const u = c.O.client.events.mouse.move(([u, a]) => {
                                                const s = t.current,
                                                    l = r.current;
                                                if (!s || !l) return;
                                                if ('inside' === a && u.clientX < 0) return;
                                                const c = 'inside' === a ? u.clientX : u.clientX - l.offsetLeft,
                                                    A = E.positionFrom - c,
                                                    F = E.previousScrollPosition + A;
                                                n.start(
                                                    Object.assign(
                                                        {
                                                            scrollPosition: o(s, F),
                                        ...
                                        o().createElement(
                                            ...
                                            e.map((u, r) =>
                                                o().createElement(We, {
                                                    ...
                                                    className:
                                                        !(r === e.length - 1) && 'MapsCarousel_mapCardPosition_7c',
                                                    mapData: u,
                                                    selectMapControl: t,
                                                }),
                                            ),
                ...
                const nt = (0, I.Pi)(() => {
                        ...
                        return (
                            ...
                            o().createElement(
                                ...
                                o().createElement(et, { nextView: tt.ProgressionView, onMapSwitch: t.onViewSwitch }),
                            )
                        );
                    }),
                    at = () => o().createElement('div', { className: 'App_base_24' }, o().createElement(nt, null));
                engine.whenReady.then(() => {
                    s().render(
