(() => {
    var __webpack_modules__ = {
            ...
            1217: (u, e, t) => {
                ...
                class z extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = m()(G.base, G[`base__${E}`], G[`base__${a}`], null == i ? void 0 : i.base),
                            B = m()(G.icon, G[`icon__${E}`], G[`icon__${a}`], null == i ? void 0 : i.icon),
                            c = m()(G.glow, null == i ? void 0 : i.glow),
                            C = m()(G.caption, G[`caption__${E}`], null == i ? void 0 : i.caption),
                            d = m()(G.goto, null == i ? void 0 : i.goto);
                        return r().createElement(
                            ...
                            'info' !== E && r().createElement('div', { className: G.shine }),
                ...
                function K(u = $.n.NONE, e = q, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== $.n.NONE)
                            return (
                ...
                const Q = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    eu = J[1];
                var tu = t(7712);
                const nu = R.strings.resource_well.confirm.NoVehicles,
                    ru = () => {
                        const u = eu(),
                            e = u.model,
                            t = u.controls;
                        ...
                        return (
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(tu.M, { vehicleCounter: e.vehicleCounter.get() }),
                                ),
                                r().createElement(
                                    'div',
                                ...
                                r().createElement('div', { className: 'App_title_a1' }, nu.title()),
                                r().createElement('div', { className: 'App_description_1e' }, nu.description()),
                ...
                engine.whenReady.then(() => {
                    k().render(
                        r().createElement(uu, null, r().createElement(T, null, r().createElement(ru, null))),
