(() => {
            ...
            9004: (u, e, t) => {
                ...
                const w = {
                    ...
                    b = (u) => {
                        ...
                        const E = (() => {
                            ...
                            A = E.mediaHeight,
                            F = E.mediaSize;
                        return r().createElement('div', v({ className: c()(t, w[i], f[A], p[F]) }, a), e);
                    },
                    x = ['children'],
                    L = (u) => {
                        let e = u.children,
                ...
                const I = (u) => {
                    ...
                    return r().createElement(
                        ...
                        W(
                            {
                                className: c()(P.base, P[`base__${C}`], P[`base__${l}`], null == i ? void 0 : i.base),
                                onMouseEnter: v,
                                onMouseLeave: w,
                                onMouseDown: f,
                                onMouseUp: p,
                        ...
                        'info' !== C && r().createElement('div', { className: P.shine }),
                        r().createElement(
                            'div',
                            { className: c()(P.icon, P[`icon__${C}`], P[`icon__${l}`], null == i ? void 0 : i.icon) },
                            r().createElement('div', { className: c()(P.glow, null == i ? void 0 : i.glow) }),
                        ),
                        r().createElement(
                            'div',
                            { className: c()(P.caption, P[`caption__${C}`], null == i ? void 0 : i.caption) },
                            e,
                        ),
                        a && r().createElement('div', { className: c()(P.goto, null == i ? void 0 : i.goto) }, a),
                    );
                };
                var U = t(5521);
                t(9916);
                ...
                function V(u = U.n.NONE, e = G, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== U.n.NONE)
                            return (
                ...
                const q = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    })(0, ({ externalModel: u }) => ({ showHangar: u.createCallbackNoArgs('showHangar') })),
                    Y = K[0],
                    Z = K[1];
                var X = t(7712);
                const Q = R.strings.resource_well.confirm.NoVehicles,
                    J = () => {
                        const u = Z(),
                            e = u.model,
                            t = u.controls;
                        ...
                        return (
                            ...
                            r().createElement(
                                'div',
                                { className: 'App_base_d5' },
                                r().createElement(
                                    'div',
                                    { className: 'App_vehiclesCount_75' },
                                    r().createElement(X.M, { vehicleCounter: e.vehicleCounter.get() }),
                                ),
                                r().createElement(
                                    'div',
                                    { className: 'App_close_32' },
                                    r().createElement(I, {
                                        caption: R.strings.resource_well.commonTexts.closeBtn(),
                                        type: 'close',
                                        side: 'right',
                                        onClick: t.showHangar,
                                    }),
                                ),
                                r().createElement('div', { className: 'App_title_a1' }, Q.title()),
                                r().createElement('div', { className: 'App_description_1e' }, Q.description()),
                                r().createElement('div', { className: 'App_divider_c7' }),
                                r().createElement(
                                    H,
                                    {
                                        type: O.primary,
                                        size: k.medium,
                                        onClick: t.showHangar,
                                        mixClass: 'App_button_8a',
                                    },
                                    Q.buttonCancel.title(),
                                ),
                            )
                        );
                    };
                engine.whenReady.then(() => {
                    S().render(
                        r().createElement(Y, null, r().createElement(L, null, r().createElement(J, null))),
                    ...
                    D = (u) => {
                        ...
                        return i().createElement(
                            ...
                            i().createElement(
                                ...
                                i().createElement(
                                    F.Z,
                                    { key: `state-${s}-${t}`, timeout: 300, classNames: c },
                                    i().createElement(
                                        'div',
                                        null,
                                        (() => {
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/feature/NoVehiclesConfirm/NoVehiclesConfirm'),
        (() => {
            var u = {
                'lobby/feature/NoVehiclesConfirm/NoVehiclesConfirm': 0,
