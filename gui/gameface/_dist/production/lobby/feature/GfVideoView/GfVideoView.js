(() => {
    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                ...
                function d(u, e, t, n, r, o, E) {
                    ...
                    A.done ? e(i) : Promise.resolve(i).then(n, r);
                }
            ...
            7471: (u, e, t) => {
                ...
                class D extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            d = i()(a.base, a[`base__${E}`], a[`base__${o}`], null == A ? void 0 : A.base),
                            _ = i()(a.icon, a[`icon__${E}`], a[`icon__${o}`], null == A ? void 0 : A.icon),
                            v = i()(a.glow, null == A ? void 0 : A.glow),
                            h = i()(a.caption, a[`caption__${E}`], null == A ? void 0 : A.caption),
                            f = i()(a.goto, null == A ? void 0 : A.goto);
                        return r().createElement(
                            ...
                            'info' !== E && r().createElement('div', { className: a.shine }),
                            r().createElement('div', { className: _ }, r().createElement('div', { className: v })),
                ...
                const _ = (0, n.forwardRef)(function (u, e) {
                        let t = u.src,
                            o = u.className,
                            E = u.autoplay,
                            A = void 0 !== E && E,
                        ...
                        return (
                            ...
                            (0, n.useEffect)(() => {
                                if (v && h.current) {
                                    const u = { changeTimeHandlers: [], changeKeyframeHandlers: [], changeTimeLoop: l },
                                        e = () => {
                                            let e = 0;
                                            const t = (function (t) {
                                                    let n = 0;
                                                                ...
                                                                if (h.current) {
                                                                    ...
                                                                    if (
                                                                        (e !== n &&
                                                                            ...
                                                                            (e = n)),
                                                                        h.current.paused || !v || !s)
                                                                    )
                                                                        return;
                                                                    const o = h.current.cohGetKeyframeTimestamps();
                                                                    o.forEach((e, t) => {
                                                                        n > o[t] - 0.02 &&
                                                                            n < o[t] &&
                            ...
                            r().createElement(
                                'video',
                                d({ src: t, className: o, style: i, loop: a, ref: h, onClick: D, onError: B }, _),
                            )
                        );
                    }),
                    v = (0, n.memo)(_);
                ...
                const P = (u) => (0 === u ? window : window.subViews.get(u)),
                    S = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: o, children: E, mocks: A }) {
                                const i = (0, n.useRef)([]),
                                    F = (u, t, n) => {
                                        var r;
                                        const o = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, o) => {
                                                        const A = 'string' == typeof o ? `${n}.${o}` : n,
                                                            i = w.O.view.addModelObserver(A, e, !0);
                                                        return (r.set(i, t), u && t(E(o)), i);
                                                    },
                                                    readByPath: E,
                                                    createCallback: (u, e) => {
                                                        const t = E(e);
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const n = null != t ? t : A(e),
                                                            r = k.observable.box(n, { equals: B });
                                                        return (
                                                            'real' === u &&
                                                                E.subscribe(
                                                                    (0, k.action)((u) => r.set(u)),
                                                                    e,
                                                                ),
                                                            r
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const r = e.reduce(
                                                                (u, e) => ((u[e] = k.observable.box(n[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                                            ...
                                            s = { mode: u, model: a, externalModel: E, cleanup: F };
                                        return {
                                            model: a,
                                    ...
                                    c = s[0],
                                    D = s[1],
                                    l = (0, n.useState)(() => F(u, o, A)),
                                    C = l[0],
                                    d = l[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        a.current ? d(F(c, o, A)) : (a.current = !0);
                                    }, [A, c, o]),
                                    (0, n.useEffect)(() => {
                                        D(u);
                                    }, [u]),
                    ...
                    N = (0, O.observer)(() => {
                        const u = (0, n.useState)(!0),
                            ...
                            F = A.root.get(),
                            a = F.videoSource,
                            s = F.isWindowAccessible,
                            c = F.isUIVisible;
                        a || E.onCloseBtnClick();
                        const l = (() => {
                                const u = w.O.view.getSize('rem'),
                            ...
                            _ = (0, n.useCallback)(() => {
                                (E.onLoadError(), E.onCloseBtnClick());
                            }, [E]);
                        return (
                            (function ({
                                key: u = g.n.ESCAPE,
                                callback: e = () => w.O.view.sendEvent.close(),
                                preventPropagation: t = !0,
                            } = {}) {
                                T(u, e, t);
                            })({ callback: E.onCloseBtnClick }),
                            (0, n.useEffect)(() => {
                                var u, e;
                                s ? null == (u = i.current) || u.play() : null == (e = i.current) || e.pause();
                            }, [s]),
                            r().createElement(
                                'div',
                                { className: 'App_base_41' },
                                c &&
                                    r().createElement(
                                        'div',
                                        { className: 'App_closeBtn_49' },
                                        r().createElement(D, {
                                ...
                                r().createElement(v, {
                                    ref: i,
                                    src: String(a),
                                    className: 'App_video_74',
                                    style: d,
                                    onEnded: E.onVideoStopped,
                                    onError: _,
                                    onPlay: () => {
                                        var u;
                                        (e && (t(!1), E.onVideoStarted()), null == (u = i.current) || u.play());
                                    },
                                }),
                            )
                        );
                ...
                engine.whenReady.then(() => {
                    E().render(r().createElement(x, null, r().createElement(N, null)), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, t, n] = deferred[i], o = !0, E = 0; E < e.length; E++)
                        (!1 & n || r >= n) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(7471));
