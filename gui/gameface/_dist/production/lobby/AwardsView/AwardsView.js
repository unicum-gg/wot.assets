(() => {
    ...
    var __webpack_modules__ = {
            ...
            2026: (u, e, t) => {
                ...
                const F = o.O.client.getSize('rem'),
                    D = F.width,
                    c = F.height,
                    _ = Object.assign({ width: D, height: c }, A(D, c, E)),
                    ...
                    C = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.largeWidth && F) return s(e, t, w);
                            if (t.mediumWidth && D) return s(e, t, w);
                            if (t.smallWidth && c) return s(e, t, w);
                            if (t.extraSmallWidth && _) return s(e, t, w);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                    ...
                    g = (0, a.memo)(({ children: u }) => {
                        const e = (0, a.useContext)(d),
                            ...
                            s = (0, a.useCallback)((u, e) => {
                                ...
                                i(Object.assign({ width: t, height: a }, A(t, a, E)));
                            }, []);
                        m(() => {
                    ...
                    return (
                        m(() => {
                            if (
                                                ...
                                                const e = S(),
                                                    ...
                                                    r =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: r, modelPath: T(r, ''), resId: a };
                                            })(),
                                            t = e.modelPrefix,
                                            a = u.split('.');
                                        if (a.length > 0) {
                                ...
                                F.current = O.addCallback(a, t, s, e === P.Deep);
                            }
                        }),
                        (0, a.useEffect)(() => {
                            if (e !== P.None)
                ...
                class U extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = p()(k.base, k[`base__${i}`], k[`base__${n}`], null == s ? void 0 : s.base),
                            c = p()(k.icon, k[`icon__${i}`], k[`icon__${n}`], null == s ? void 0 : s.icon),
                            _ = p()(k.glow, null == s ? void 0 : s.glow),
                            d = p()(k.caption, k[`caption__${i}`], null == s ? void 0 : s.caption),
                            B = p()(k.goto, null == s ? void 0 : s.goto);
                        return r().createElement(
                            ...
                            'info' !== i && r().createElement('div', { className: k.shine }),
                ...
                const H = ({ onClose: u }) =>
                    ...
                    G = ({ animationDelayStepsCount: u = 1, children: e }) =>
                        r().createElement(
                            'div',
                    ...
                    j = ({ title: u, status: e }) => {
                        const t = V(),
                            a = p()(z.base, z[`base__${t}`]);
                        return r().createElement(
                            'div',
                            { className: a },
                            r().createElement('div', { className: z.title }, u),
                            r().createElement('div', { className: z.status }, e),
                        );
                    };
                var Y = t(5659);
                const q = [
                ...
                const X = (u, e, t = {}, a = 0) => {
                    ...
                    K = (u) => {
                        ...
                        const p = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            w = (0, a.useMemo)(() => C || S().resId, [C]),
                            v = (0, a.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (X(t, c, { isMouseEvent: !0, on: !0, arguments: $(r) }, w),
                                    m && m(),
                ...
                const ou = (u) => (u.tooltipType, iu(u, ru)),
                    Eu = (u) => {
                        let e = u.children,
                            t = u.wrap,
                            a = iu(u, nu);
                        const n = t ? r().createElement('div', null, e) : e;
                        return a.tooltipType === su.Simple
                            ? r().createElement(uu, ou(a), n)
                            : a.tooltipType === su.Backport
                              ? r().createElement(au, ou(a), n)
                              : ((u) => u.tooltipType === su.Base)(a)
                                ? r().createElement(K, ou(a), n)
                                : e;
                    };
                let lu;
                !(function (u) {
                ...
                const Au = (u, e, t) => {
                    ...
                    Du = (u, e, t = lu.left) => u.split(e).reduce(t === lu.left ? Au : Fu, []),
                    cu = (() => {
                        const u = new RegExp(
                    ...
                    Bu = ({ value: u }) => {
                        const e = V(),
                            t = p()(du.base, du[`base__${e}`]),
                            a =
                                ((n = R.strings.event.award.value()),
                                (i = { count: u }),
                                n.replace(/\{\w+\}/g, (u) => String(i[u.slice(1, -1)])));
                        var n, i;
                ...
                const xu = {
                        [Cu.ExtraLarge]: wu.S400x300,
                        [Cu.Large]: wu.S400x300,
                        [Cu.Medium]: wu.S400x300,
                        [Cu.Small]: wu.S296x222,
                        [Cu.ExtraSmall]: wu.S232x174,
                    },
                    yu = {
                        [Cu.ExtraLarge]: wu.S600x450,
                        [Cu.Large]: wu.S600x450,
                        [Cu.Medium]: wu.S600x450,
                        [Cu.Small]: wu.S400x300,
                        [Cu.ExtraSmall]: wu.S400x300,
                    },
                    Ru = (u, e) => ({ backgroundImage: `url(R.images.white_tiger.gui.maps.icons.rewards.${e}.${u})` }),
                    Tu = ({ binding: u, text: e = '', classMix: t, alignment: n = lu.left }) =>
                        null === e
                ...
                const ku = ({
                        ...
                        const l = (0, a.useMemo)(() => {
                                return {
                                    backgroundImage: `url('R.images.gui.maps.icons.vehicleTypes.big.${((u = e), u.replace(/-/g, '_'))}_elite')`,
                                };
                                var u;
                            }, [e]),
                            A = p()(
                                'Vehicle_base_95',
                                E === Mu.Primary ? 'Vehicle_base__primary_47' : 'Vehicle_base__secondary_0e',
                                n && 'Vehicle_base__large_e9',
                                i && 'Vehicle_base__single_eb',
                                void 0 !== s && 'Vehicle_base__hasAnimation_56',
                            ),
                            F = (0, a.useMemo)(() => (void 0 !== s ? { animationDelay: 100 * s + 'ms' } : void 0), [s]);
                        return r().createElement(
                            'span',
                            { className: A, style: F },
                            o &&
                                r().createElement('span', {
                                    ...
                                    style: { backgroundImage: `url(R.images.gui.maps.icons.flags.c_60x40.${o})` },
                                }),
                            r().createElement(
                                'span',
                                ...
                                Lu
                                    ...
                                    : (function (u) {
                                          ...
                                          for (let t = Pu.length - 1; t >= 0; t--)
                                              for (; u >= Pu[t]; ) (e += Ou[t]), (u -= Pu[t]);
                                          return e;
                                      })(D)),
                            ),
                            r().createElement('span', { className: 'Vehicle_type_11', style: l }),
                            r().createElement('span', { className: 'Vehicle_name_63' }, t),
                        );
                        var D;
                    },
                    Nu = {
                        ...
                        count: 'Reward_count_bc',
                        rewardText: 'Reward_rewardText_73',
                        rewardText__big: 'Reward_rewardText__big_ed',
                        currency: 'Reward_currency_86',
                        rentWrapper: 'Reward_rentWrapper_0a',
                        mainRewardLabel: 'Reward_mainRewardLabel_fa',
                        mainRewardRent: 'Reward_mainRewardRent_e1',
                        icon: 'Reward_icon_b1',
                ...
                !(function (u) {
                    ...
                    (function (u) {
                        (u.PREMIUM_PLUS_1 = 'premium_plus_1'),
                            ...
                            (u.EMBLEM = 'emblem'),
                            (u.GOLD = 'gold'),
                            (u.MAIN_REWARD = 'wt_rental_tank_5');
                    })(Hu || (Hu = {}));
                const Wu = (u) => ({ appear: 1600 + 300 * u, enter: 600 }),
                    Gu = R.strings.event.WTEventAwardsView.mainReward,
                    Vu = ({
                        icon: u,
                        tooltipId: e,
                        value: t,
                        ...
                        const _ = V(),
                            B = o === Uu.Final,
                            C = p()(Nu.base, Nu[`base__${_}`], o && Nu[`base__${o}`]),
                            m = p()(Nu.rewardImage, o && Nu[`rewardImage__${o}`]),
                            g = p()(Nu.rewardText, o === Uu.Single && Nu.rewardText__big),
                            h = p()(Nu.rewardText, Nu.rewardText__big, Nu.mainRewardLabel),
                            w = (() => {
                                const u = (0, a.useContext)(d),
                                    e = u.width,
                                    t = u.height,
                                    r = ((u) => {
                                        switch (!0) {
                                            ...
                                            default:
                                                return (
                                                    console.error('Unreachable media context resolution'), Cu.ExtraSmall
                                                );
                                        }
                                    })(u),
                                    n = ((u) => {
                                        switch (!0) {
                                            ...
                                            default:
                                                return (
                                                    console.error('Unreachable media context resolution'), mu.ExtraSmall
                                                );
                                        }
                                    })(u),
                                    i = ((u) => {
                            ...
                            v =
                                s === su.Base
                                    ...
                                    : { tooltipType: su.Backport, args: { tooltipId: e } },
                            b = (0, a.useCallback)(() => {
                            ...
                            S = (0, a.useMemo)(
                                () =>
                                    ((u, e) => {
                                        ...
                                        switch (!0) {
                                            case u === Hu.PREMIUM_PLUS_1:
                                            case u === Hu.CRYSTAL:
                                            case u === Hu.CAMOUFLAGE:
                                            case u === Hu.CUSTOMIZATIONS:
                                            case u === Hu.GOLD:
                                                return t(u);
                                            case u === Hu.MAIN_REWARD:
                                                return Ru(u, yu[e]);
                                            case u.includes(Hu.CAMOUFLAGE):
                                                return t(Hu.CAMOUFLAGE);
                                            case u.includes(Hu.PROJECTION_DECAL):
                                                return t(Hu.PROJECTION_DECAL);
                                            case u.includes(Hu.INSCRIPTION):
                                                return t(Hu.INSCRIPTION);
                                            case u.includes(Hu.STYLE):
                                                return t(Hu.STYLE);
                                            case u.includes(Hu.EMBLEM):
                                                return t(Hu.EMBLEM);
                                            default:
                                                return Ru(u, xu[e]);
                                        }
                            ...
                            x = { text: Gu.rent(), binding: { count: A } };
                        return r().createElement(Y.uT, { in: !0, appear: !0, timeout: Wu(n), onEntered: b }, (u) =>
                            r().createElement(
                                Eu,
                                v,
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: m, style: S },
                                        i && r().createElement('span', { className: Nu.currency }, t),
                                        B
                                            ? r().createElement(
                                                  r().Fragment,
                                                  null,
                                                  ...
                                                  r().createElement(
                                                      'div',
                                                      { className: Nu.rentWrapper },
                                                      r().createElement('div', { className: Nu.icon }),
                                                      r().createElement(Tu, Iu({ classMix: Nu.mainRewardRent }, x)),
                                                  ),
                                              )
                                            : r().createElement(
                                                  r().Fragment,
                                                  null,
                                                  t > 1 && E && !i && r().createElement(Bu, { value: t }),
                ...
                const Yu = (u, e, t, a) => (e ? Uu.PostBattle : u && 1 === a ? Uu.Final : t ? Uu.Single : Uu.Default),
                    qu = () => {
                        const u = L('model'),
                            e = u.isFinalReward,
                            t = u.isPostBattle,
                            a = L('model.mainRewards.items'),
                            n = 1 === a.length,
                            i = V(),
                            s = p()(zu.base, zu[`base__${i}`]);
                        return r().createElement(
                            'div',
                            { className: s },
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: zu.rewards },
                                    r().createElement(
                                        'div',
                                        { className: zu.rewardsList },
                                        a.map(({ value: u }, a) =>
                                            r().createElement(
                                                Vu,
                                                ju(
                                                    ...
                                                    (({
                                                        ...
                                                        const l = 'wt_boss' === u ? 'base' : 'backport',
                                                            A = 'premium_plus' !== u;
                                                        return {
                                                            label: n,
                ...
                const Qu = (0, a.memo)(Zu),
                    Ju = 'RewardFooter_buttonHolder_26',
                    ue = R.strings.event.WTEventAwardsView.mainRewards,
                    ee = ({
                        onAwardOpen: u,
                        onClose: e,
                        isBoxReward: t = !1,
                        ...
                        return r().createElement(
                            ...
                            n &&
                                r().createElement(
                                    ...
                                    r().createElement(
                                        Qu,
                                        { type: Xu.main, size: Ku.medium, onClick: s },
                                        ue.back_portal(),
                                    ),
                                ),
                            r().createElement(
                                'div',
                                { className: Ju },
                                r().createElement(Qu, { type: Xu.primary, size: Ku.medium, onClick: e }, ue.button()),
                            ),
                            t &&
                                !n &&
                                r().createElement(
                                    ...
                                    r().createElement(
                                        Qu,
                                        { type: Xu.secondary, size: Ku.medium, disabled: !i, onClick: s },
                                        ue.back_portal(),
                                    ),
                                ),
                        );
                ...
                engine.whenReady.then(() => {
                    i().render(
                        r().createElement(g, null, r().createElement(te, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(2026));
