(() => {
    var __webpack_modules__ = {
            8380: (e) => {
                ...
                var p = function (e, u, t, n, r, a) {
                    ...
                    !(function (e, u, t, n, r, a) {
                        ...
                        var m = e.element;
                        if (!e.reach) return;
                        ((e.reach[s] = null), m[l] < 1 && (e.reach[s] = 'start'));
                        m[l] > e[o] - e[i] - 1 && (e.reach[s] = 'end');
                        u &&
                            !r &&
                            (m.dispatchEvent(b('ps-scroll-' + s)),
                            u < 0
                                ? m.dispatchEvent(b('ps-scroll-' + c))
                                : u > 0 && m.dispatchEvent(b('ps-scroll-' + d)),
                            n &&
                                (function (e, u) {
                                    (_(e, u), E(e, u));
                                })(e, s));
                        e.reach[s] && (u || a) && m.dispatchEvent(b('ps-' + s + '-reach-' + e.reach[s]));
                    })(e, t, o, n, r, a);
                };
                var B = function (e, u, n, r) {
                    ...
                    if (a) {
                        if (
                            ...
                            a.scrollLeft < n ? (a.scrollLeft = n) : a.scrollLeft > l && (a.scrollLeft = l);
                        }
                        ...
                        (a.contains(e.scrollbarXRail) ||
                            (i(a, s.rail('x')).forEach(function (e) {
                                return o(e);
                            }),
                            a.appendChild(e.scrollbarXRail)),
                            a.contains(e.scrollbarYRail) ||
                                (i(a, s.rail('y')).forEach(function (e) {
                                    return o(e);
                                }),
                            ...
                            e.containerWidth + e.settings.scrollXMarginOffset < e.contentWidth
                                ? ((e.scrollbarXActive = !0),
                                  ...
                                  (e.scrollbarXWidth = v(e, g((e.railXWidth * e.containerWidth) / e.contentWidth))),
                                  (e.scrollbarXLeft = g(
                            ...
                            e.containerHeight + e.settings.scrollYMarginOffset < e.contentHeight
                                ? ((e.scrollbarYActive = !0),
                                  ...
                                  (e.scrollbarYHeight = v(e, g((e.railYHeight * e.containerHeight) / e.contentHeight))),
                                  (e.scrollbarYTop = g(
                            ...
                            (function (e, u, n) {
                                ...
                                u.isScrollbarXUsingBottom
                                    ? (r.bottom = u.scrollbarXBottom - a)
                                    : (r.top = u.scrollbarXTop + a);
                                t(u.scrollbarXRail, r);
                                var o = { top: a, height: u.railYHeight };
                            ...
                            e.scrollbarXActive
                                ? (a.classList.add(c.active('x')), p(e, 'left', m - e.lastScrollLeft, !0, u))
                                : (a.classList.remove(c.active('x')),
                                  (e.scrollbarXWidth = 0),
                                  (e.scrollbarXLeft = 0),
                                  (a.scrollLeft = 0)),
                            e.scrollbarYActive
                                ? (a.classList.add(c.active('y')), p(e, 'top', a.scrollTop - e.lastScrollTop, !0, u))
                ...
                var f = {
                    ...
                    x = function (e) {
                        ...
                        A
                            ? ((m = h ? 'scrollX' : 'scrollLeft'),
                              (E = h ? 'innerWidth' : 'width'),
                              (_ = 'scrollWidth'))
                            : ((m = h ? 'scrollY' : 'scrollTop'),
                        ...
                        var g = u[m],
                            F = (function (e) {
                                ...
                                } else u = (n[i] - n.getBoundingClientRect()[r]) | 0;
                                return ['left', 'top'].includes(l) ? a : u - a;
                            })({
                                isWindow: h,
                                scrollableDomEle: u,
                                elementLengthProp: E,
                                ...
                                var l = n - d,
                                    _ = (function (e) {
                                        var u = e.easingPreset,
                                            ...
                                            n = e.duration,
                                            r = e.runTime / n;
                                        if (f.hasOwnProperty(u)) return f[u](r);
                                        if (
                                            t &&
                                            !isNaN(t.x1) &&
                                            !isNaN(t.y1) &&
                                    ...
                                    })({ easingPreset: i, cubicBezierPoints: o, runTime: l, duration: a });
                                if (!isNaN(_)) {
                                    var E = Math.round(_ * F),
                                        C = D ? E + g : F - E;
                                    if (
                                        (c.breakBounds &&
                                            (C < c.startBound
                                ...
                                a = function () {
                                    if (1 === n.buttons) {
                                        if (
                                            ...
                                            (k({ axis: u, cursorPositionOnRail: o, direction: i, i: e }) &&
                                                clearTimeout(r),
                                                B(e, !1, t));
                                        }
                                        n.stopPropagation();
                ...
                function L(e, u, t) {
                    var n = t[0],
                        ...
                        F = null;
                    function C(t) {
                        ((h[s] = g(A + F * (t[a] - D))), _(e, d), B(e, !1, u), t.stopPropagation(), t.preventDefault());
                    }
                    function b() {
                        (E(e, d), e[m].classList.remove(c.clicking), e.event.unbind(e.ownerDocument, 'mousemove', C));
                    }
                    e.event.bind(e[i], 'mousedown', function (u) {
                        1 === u.buttons &&
                            ((A = h[s]),
                            (D = u[a]),
                            (F = (e[r] - e[n]) / (e[o] - e[l])),
                ...
                var T = 1e3,
                                    ...
                                    (e.settings.suppressScrollX && 0 !== i) ||
                                        ...
                                        (function (u, n) {
                                            ...
                                            if (0 === n) {
                                                ...
                                                if (
                                                    (0 === a && u < 0) ||
                                                    (a >= e.contentWidth - e.containerWidth && u > 0)
                                                )
                                                    return !e.settings.wheelPropagation;
                                            }
                                            return !0;
                                ...
                                if (
                                    !(function (e, t, r) {
                                        ...
                                        for (var a = e; a && a !== n; ) {
                                            ...
                                            if (
                                                ...
                                                if (
                                                    l > 0 &&
                                                    !((0 === a.scrollLeft && t < 0) || (a.scrollLeft === l && t > 0))
                                                )
                                                    return !0;
                                            }
                                            a = a.parentNode;
                                    ...
                                    (e.settings.useBothWheelAxes
                                        ? e.scrollbarYActive && !e.scrollbarXActive
                                            ? (i ? (n.scrollTop -= d) : (n.scrollTop += c), (l = !0))
                                            : e.scrollbarXActive &&
                                              !e.scrollbarYActive &&
                                        ...
                                        (function (u, t) {
                                            ...
                                            if (i > o) {
                                                if (
                                                    ...
                                                    return 0 === window.scrollY && t > 0 && F.isChrome;
                                            } else if (
                                                o > i &&
                                                ((u < 0 && a === e.contentWidth - e.containerWidth) ||
                                                    (u > 0 && 0 === a))
                                            )
                                                return !0;
                                            return !0;
                        ...
                        'drag-move': function (e, u) {
                            ...
                            function h(r) {
                                if (e.scrollbarXActive) {
                                    ...
                                    if (((a = (l / (s - o)) * 1e3), (o = s), e.onScroll(), u > 0)) {
                            ...
                            function D(n) {
                                ...
                                if (t.scrollLeft < u) s(u - t.scrollLeft, T, d);
                                    ...
                                    new Date().getTime() - o < 100 && s(a / 4, T, d, !0);
                                }
                                (E(e, 'x'),
                    ...
                    R = function (e, r) {
                        ...
                        ((this.isRtl = 'rtl' === u(e).direction),
                            ...
                            C().then(function () {
                                var n = u(a.scrollbarXRail);
                                ((a.scrollbarXBottom = parseInt(n.bottom, 10)),
                                    isNaN(a.scrollbarXBottom)
                                        ? ((a.isScrollbarXUsingBottom = !1), (a.scrollbarXTop = g(n.top)))
                                        : (a.isScrollbarXUsingBottom = !0),
                                    (a.railBorderXWidth = g(n.borderLeftWidth) + g(n.borderRightWidth)),
                                    t(a.scrollbarXRail, { display: 'block' }),
                                    (a.railXMarginWidth = g(n.marginLeft) + g(n.marginRight)),
                                    t(a.scrollbarXRail, { display: '' }),
                                    (a.railXWidth = null),
                                    (a.railXRatio = null));
                                var r = u(a.scrollbarYRail);
                                ((a.scrollbarYRight = parseInt(r.right, 10)),
                                    isNaN(a.scrollbarYRight)
                                        ? ((a.isScrollbarYUsingRight = !1), (a.scrollbarYLeft = g(r.left)))
                                    ...
                                    (a.scrollbarYOuterWidth = a.isRtl
                                        ...
                                        : null),
                                    (a.railBorderYWidth = g(r.borderTopWidth) + g(r.borderBottomWidth)),
                                    t(a.scrollbarYRail, { display: 'block' }),
                                    (a.railYMarginHeight = g(r.marginTop) + g(r.marginBottom)),
                                    t(a.scrollbarXRail, { display: '' }),
                                    t(a.scrollbarYRail, { display: '' }),
                                    (a.railYHeight = null),
                                    (a.railYRatio = null),
                                    (a.reach = {
                                        x:
                                    ...
                                    a.settings.handlers.forEach(function (e) {
                                        return M[e](a, a.settings.overScrollWidth);
                                    }),
                                    ...
                                    B(a, !1, a.settings.overScrollWidth, !1));
                            }));
                    };
                ((R.prototype._getAnimationSettings = function (e, u, t, n) {
                    ...
                    return (
                        null !== this.element &&
                            (a = ['bottom', 'top'].includes(u) ? this.element.scrollTop : this.element.scrollLeft),
                        {
                    ...
                    (R.prototype.update = function () {
                        ...
                        this.isAlive &&
                            ...
                            (this.railXMarginWidth =
                                g(u(this.scrollbarXRail).marginLeft) + g(u(this.scrollbarXRail).marginRight)),
                            (this.railYMarginHeight =
                                g(u(this.scrollbarYRail).marginTop) + g(u(this.scrollbarYRail).marginBottom)),
                    ...
                    (R.prototype.setScrollLeft = function (e, u, t) {
                        x(this._getAnimationSettings(e, 'right', u, t));
                    }),
                    ...
                    (R.prototype.setScrollTop = function (e, u, t) {
                        x(this._getAnimationSettings(e, 'bottom', u, t));
                    }),
            ...
            4179: (e, u, t) => {
                'use strict';
                t.d(u, { c1: () => v, Sw: () => a.Z, B3: () => s, Z5: () => o, B0: () => l, ry: () => g, Eu: () => F });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
                ...
                function A(e, u, t, n, r, a, o) {
                    ...
                    i.done ? u(l) : Promise.resolve(l).then(n, r);
                }
            ...
            4234: (e, u, t) => {
                ...
                const c = o.O.client.getSize('rem'),
                    d = c.width,
                    m = c.height,
                    _ = Object.assign({ width: d, height: m }, s(d, m, i)),
                ...
                const A = (e) => {
                    ...
                    const r = (0, n.useContext)(E),
                        ...
                        B = { extraLarge: g, large: F, medium: C, small: b, extraSmall: p };
                ...
                const k = {
                    ...
                    T = (e) => {
                        ...
                        const a = w(),
                            ...
                            i = a.mediaHeight,
                            l = a.mediaSize;
                        return r().createElement('div', x({ className: C()(t, k[o], S[i], L[l]) }, n), u);
                    },
                    M = ['children'];
                const O = (e) => {
                    let u = e.children,
                    ...
                    return r().createElement(g, null, r().createElement(T, t, u));
                };
                var H = t(493),
                    N = t.n(H);
                function P(e) {
                ...
                class j extends r().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            _ = C()(W.base, W[`base__${o}`], W[`base__${a}`], null == i ? void 0 : i.base),
                            E = C()(W.icon, W[`icon__${o}`], W[`icon__${a}`], null == i ? void 0 : i.icon),
                            h = C()(W.glow, null == i ? void 0 : i.glow),
                            A = C()(W.caption, W[`caption__${o}`], null == i ? void 0 : i.caption),
                            D = C()(W.goto, null == i ? void 0 : i.goto);
                        return r().createElement(
                            ...
                            'info' !== o && r().createElement('div', { className: W.shine }),
                ...
                const z = /<link.*?>/g,
                    ...
                    J = () => {
                        for (
                            ...
                            const t = u[e];
                            if (!t.href.includes(Q)) return t.href;
                        }
                        return '';
                    },
                    ee = (e) => {
                    ...
                    re = (0, n.memo)(({ id: e, fallback: u, onLoadCallback: t, mixClass: a }) => {
                        const o = (0, n.useState)(''),
                            ...
                            E = (0, n.useCallback)(
                                (e) => {
                                    e.includes(c) &&
                                        (_(!0), engine.off(te, E), window.subViews.removeChildChangedCallback(c));
                                },
                                [c],
                            ),
                            h = (0, n.useCallback)((e) => {
                ...
                var ae = t(3403);
                const oe = '-1',
                    ie = { id: oe, label: R.strings.dialogs.recruitWindow.menuEmptyRow() },
                    le = 'nameID',
                    se = 'surnameID',
                    ce = (e, u) => {
                        if (e === u) return !0;
                        if ('object' != typeof e || null === e || 'object' != typeof u || null === u) return !1;
                        const t = Object.keys(e),
                            n = Object.keys(u);
                        if (t.length !== n.length) return !1;
                        for (var r = 0, a = t; r < a.length; r++) {
                            const t = a[r];
                            if (!(t in u) || !ce(e[t], u[t])) return !1;
                        }
                        return !0;
                    },
                    de = (e) => '' === e || e === ie.id;
                ...
                const Fe = ((e, u) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: i, children: l, mocks: s }) {
                                const c = (0, n.useRef)([]),
                                    d = (t, n, r) => {
                                        var a;
                                        const i = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, a) => {
                                                        const l = 'string' == typeof a ? `${n}.${a}` : n,
                                                            s = o.O.view.addModelObserver(l, u, !0);
                                            ...
                                            _ = { mode: t, model: m, externalModel: l, cleanup: d };
                                        return {
                                            model: m,
                                    ...
                                    E = _[0],
                                    h = _[1],
                                    A = (0, n.useState)(() => d(a, i, s)),
                                    D = A[0],
                                    g = A[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        m.current ? g(d(E, i, s)) : (m.current = !0);
                                    }, [s, E, i]),
                                    (0, n.useEffect)(() => {
                                        h(a);
                                    }, [a]),
                        ...
                        ({ observableModel: e }) => {
                            const u = {
                                    root: e.object(),
                                    currentTankman: e.object('currentTankman'),
                                    futureTankman: e.object('futureTankman'),
                                    nations: e.array('nations', []),
                                    vehTypes: e.array('vehTypes', []),
                                    names: e.array('names', []),
                                    surnames: e.array('surnames', []),
                                    vehicles: e.array('vehicles', []),
                                    retrainings: e.array('retrainings', []),
                                    specialties: e.array('specialties', []),
                                },
                                t = (0, ge.Om)(() => De(u.nations.get(), (e) => ({ id: e.id, label: e.value })), {
                                    equals: me,
                                }),
                                n = (0, ge.Om)(() => De(u.vehTypes.get(), (e) => ({ id: e.id, label: e.value })), {
                                    equals: me,
                                }),
                                r = (0, ge.Om)(() => De(u.names.get(), (e) => ({ id: e.id, label: e.value })), {
                                    equals: me,
                                }),
                                a = (0, ge.Om)(() => De(u.surnames.get(), (e) => ({ id: e.id, label: e.value })), {
                                    equals: me,
                                }),
                                o = (0, ge.Om)(() => De(u.retrainings.get(), (e) => ({ id: e.id, label: e.value })), {
                                    equals: me,
                                }),
                                i = (0, ge.Om)(() => De(u.specialties.get(), (e) => ({ id: e.id, label: e.value })), {
                                    equals: me,
                                }),
                                l = (0, ge.Om)(
                                    () =>
                                        Object.assign({}, u.futureTankman.get(), {
                                            retraining: u.root.get().retraining,
                                        }),
                                    { equals: me },
                                ),
                                s = (0, ge.Om)(
                                    () =>
                                        De(u.vehicles.get(), (e) => ({
                                            id: `${e.id}`,
                                            label: e.name,
                                            meta: { type: e.type, isElite: e.isElite, isIGR: e.isIGR },
                                        })),
                                    { equals: me },
                                );
                        ...
                        ({ externalModel: e }) => ({
                            ...
                            onTankmanPhotoChange: e.createCallbackNoArgs('onTankmanPhotoChange'),
                            onTankmanUpdate: e.createCallbackNoArgs('onTankmanUpdate'),
                            onRecruit: e.createCallbackNoArgs('onRecruit'),
                            onRetrainingChange: e.createCallbackNoArgs('onRetrainingChange'),
                            onNationChange: e.createCallback((e) => e || {}, 'onNationChange'),
                            onVehTypeChange: e.createCallback((e) => e || {}, 'onVehTypeChange'),
                            onVehChange: e.createCallback((e) => e || {}, 'onVehChange'),
                            onNameChange: e.createCallback((e) => e || {}, 'onNameChange'),
                            onSurnameChange: e.createCallback((e) => e || {}, 'onSurnameChange'),
                            onSpecialtyChange: e.createCallback((e) => e || {}, 'onSpecialtyChange'),
                            onSetInVehChange: e.createCallback((e) => e || {}, 'onSetInVehChange'),
                        }),
                    ),
                    Ce = Fe[0],
                    be = Fe[1],
                    ...
                    const A = (0, n.useRef)(null),
                        ...
                        H = C()(
                            ...
                            pe[`base__${a}`],
                            {
                                ...
                                [pe.base__firstHover]: f,
                            },
                            i,
                        ),
                        N = C()(pe.state, pe.state__default);
                    return (
                        (0, n.useEffect)(
                            () => (
                        ...
                        r().createElement(
                            ...
                            a !== Be.ghost &&
                                r().createElement(
                                    r().Fragment,
                                    null,
                                    r().createElement('div', { className: pe.back }),
                                    r().createElement('span', { className: pe.texture }),
                                ),
                            r().createElement(
                                'span',
                                { className: N },
                                r().createElement('span', { className: pe.stateDisabled }),
                                r().createElement('span', { className: pe.stateHighlightHover }),
                                r().createElement('span', { className: pe.stateHighlightActive }),
                            ),
                            r().createElement(
                                'span',
                ...
                fe.defaultProps = { type: Be.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const we = (0, n.memo)(fe);
                var ye = t(9887),
                    xe = t.n(ye);
                const ke = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Se = (e) => e.includes('_') && ((e) => ke.includes(e))(e.split('_').at(-1)),
                    Le = [B.ExtraLarge, B.Large, B.Medium, B.Small, B.ExtraSmall],
                    Te = (e, u) =>
                    ...
                    Me = (e, u = Te) => {
                        ...
                        return r().memo((u) =>
                            Object.keys(u).some((e) => Se(e) && void 0 !== u[e])
                                ? r().createElement(t, u)
                                : r().createElement(e, u),
                        );
                    },
                ...
                const Ne = {
                    ...
                    We = Me((e) => {
                        let u = e.className,
                            ...
                            A = e.row,
                            D = e.flexDirection,
                            g = void 0 === D ? (h ? 'column' : A && 'row') || void 0 : D,
                            F = e.flexStart,
                            b = e.center,
                            p = e.flexEnd,
                            B = e.spaceBetween,
                            ...
                            w =
                                void 0 === f
                                    ...
                                    : f,
                            y = e.alignItems,
                            x = void 0 === y ? (F ? 'flex-start' : b && 'center') || (p && 'flex-end') || void 0 : y,
                            k = e.alignSelf,
                            S = e.wrap,
                            L = e.flexWrap,
                            T = void 0 === L ? (S ? 'wrap' : void 0) : L,
                            M = e.grow,
                            R = e.shrink,
                            O = e.flex,
                            H = void 0 === O ? (M || R ? `${M ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : O,
                            N = e.style,
                            P = e.children,
                            I = (function (e, u) {
                                if (null == e) return {};
                        ...
                        const W = (0, n.useMemo)(() => {
                                const e = { mt: l, mr: c, mb: m, ml: E },
                                    u = ((e) =>
                                        Pe.reduce((u, t) => {
                                            const n = e[t];
                                            return n && 'number' != typeof n ? u.concat(Ne[!0 === n ? 'MD' : n][t]) : u;
                                        }, []))(e),
                                    n = ((e) =>
                                        Pe.reduce((u, t) => {
                                            const n = e[t];
                            ...
                            }, [t, a, l, c, m, E, N, H, k, g, T, w, x]),
                            X = W.computedStyle,
                            Y = W.computedClassNames;
                        return r().createElement('div', He({ className: C()(Re.base, ...Y, u), style: X }, I), P);
                    });
                let Xe;
                function Ye(e) {
                ...
                const je = (e, u, t) => {
                    ...
                    Ue = (e, u, t = Xe.left) => e.split(u).reduce(t === Xe.left ? je : Ge, []),
                    Ve = (() => {
                        const e = new RegExp(
                        ...
                        return $e.includes(t)
                            ...
                            : ((e, u = Xe.left) => {
                                  ...
                                  const n =
                                      ...
                                      r = e.replace(/&nbsp;/g, ' ');
                                  return (Ue(r, /( )/, u).forEach((e) => (t = t.concat(Ue(e, n, Xe.left)))), t);
                              })(e, u);
                    },
                    qe = 'FormatText_base_d0',
                    Ke = ({ binding: e, text: u = '', classMix: t, alignment: a = Xe.left }) =>
                        null === u
                            ...
                            : r().createElement(
                                  ...
                                  u.split('\n').map((u, o) =>
                                      r().createElement(
                                          'div',
                                          { className: C()(qe, t), key: `${u}-${o}` },
                                          ((e, u, t) =>
                                              e
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((e) => (t && e in t ? t[e] : ze(e, u))))(u, a, e).map((e, u) =>
                    ...
                    su = Me((e) => {
                        ...
                        const F = (0, n.useMemo)(() => {
                                const e = lu(o),
                                    ...
                                    t = e.colorStyle,
                                    n = void 0 === t ? {} : t;
                                return { computedStyle: Object.assign({}, A, n), colorClassName: u };
                            }, [A, o]),
                            b = F.computedStyle,
                            p = F.colorClassName;
                        return r().createElement(
                            ...
                            uu(
                                {
                                    className: C()(Je.base, t && Je[t], p, a),
                                    style: b,
                                    mt: !0 === s ? iu[t || 'paragraph-P16'].mt : s,
                                    mr: !0 === d ? iu[t || 'paragraph-P16'].mr : d,
                                    mb: !0 === _ ? iu[t || 'paragraph-P16'].mb : _,
                                    ml: !0 === h ? iu[t || 'paragraph-P16'].ml : h,
                                },
                                g,
                            ),
                            void 0 !== D ? r().createElement(Ke, uu({}, D, { text: u })) : u,
                        );
                    }),
                ...
                const Cu = ({ format: e, value: u }) => {
                        const t = ((e, u = 'integral') => {
                            let t;
                            t = 'gold' === u ? U.B3.GOLD : U.B3.INTEGRAL;
                            return void 0 === e ? '' : U.Z5.getNumberFormat(e, t);
                        })(u, e);
                    ...
                    pu = ({
                        ...
                        const c = C()(bu.value, bu[`value__${n}`], !a && bu.value__notEnough),
                            d = C()(bu.icon, bu[`icon__${n}-${t}`]),
                            m = C()(bu.stock, i && bu.stock__indent, u && bu.stock__interactive),
                            _ = l && o > 0 && '+',
                            E = C()(bu.base, bu[`base__${t}`]);
                        return r().createElement(
                            'span',
                            { className: E },
                            r().createElement(
                                ...
                                { className: c },
                                _,
                                r().createElement(Cu, { value: o, format: n === gu.gold ? 'gold' : 'integral' }),
                            ),
                ...
                const wu = (e, u, t = {}, n = 0) => {
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (wu(t, E, { isMouseEvent: !0, on: !0, arguments: fu(r) }, B),
                                    F && F(),
                    ...
                    xu = 'PriceBlock_base_ed',
                    ku = 'PriceBlock_priceBlockText_01',
                    Su = 'PriceBlock_value_af',
                    Lu = 'PriceBlock_plusIcon_c3',
                    Tu = (0, n.memo)(
                        ({
                            label: e,
                            goldValue: u,
                            ...
                            return r().createElement(
                                yu,
                                {
                                    contentId: R.views.lobby.crew.tooltips.TankmanChangePreviewTooltip('resId'),
                                    isEnabled: l,
                                },
                                r().createElement(
                                    'div',
                                    { className: C()(xu, o) },
                                    r().createElement(su, { className: ku, text: e }),
                                    l
                                        ? r().createElement(
                                              'div',
                                              { className: Su },
                                              ...
                                              i && r().createElement('div', { className: Lu }),
                                              t > 0 &&
                                                  r().createElement(Bu, {
                                                      value: t,
                                                      isEnough: n,
                                        ...
                                        : r().createElement(su, {
                                              className: ku,
                                              text: R.strings.crew.tankmanChangeAndRecruitView.TankmanChange.free(),
                                          }),
                                ),
                            );
                        },
                    ...
                    Mu = 'ListItem_base_d7',
                    Ru = 'ListItem_listIcon_6b',
                    Ou = 'ListItem_listText_a7',
                    Hu = (0, n.memo)(({ text: e, binding: u, classNames: t }) =>
                        r().createElement(
                            'div',
                            { className: C()(Mu, t) },
                    ...
                    Nu = {
                        base: 'TankmanPhoto_base_e6',
                        base__big: 'TankmanPhoto_base__big_8e',
                        base__big__withSwitch: 'TankmanPhoto_base__big__withSwitch_60',
                        tankmanPortrait: 'TankmanPhoto_tankmanPortrait_d6',
                        shadow: 'TankmanPhoto_shadow_bd',
                        switchWrapper: 'TankmanPhoto_switchWrapper_de',
                        switchIcon: 'TankmanPhoto_switchIcon_be',
                        switchText: 'TankmanPhoto_switchText_be',
                    };
                let Pu;
                !(function (e) {
                ...
                const Iu = (0, n.memo)(
                        ({ imageName: e, onChange: u, size: t = Pu.Big, withSwitch: n = !1, classNames: a }) =>
                            r().createElement(
                                'div',
                                {
                                    className: C()(Nu.base, Nu[`base__${t}`], n && Nu[`base__${t}__withSwitch`], a),
                                    onMouseEnter: () => {
                                        n && I.playHighlight();
                                    },
                                    onClick: () => {
                                ...
                                n &&
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            'div',
                                            { className: Nu.switchWrapper },
                                            r().createElement('div', { className: Nu.switchIcon }),
                                            r().createElement(su, {
                                                className: Nu.switchText,
                                                text: R.strings.crew.tankmanChangeAndRecruitView.switchButton(),
                                            }),
                                        ),
                                    ),
                            ),
                    ),
                    Wu = 'TankmanFolder_base_cd',
                    Xu = 'TankmanFolder_folderImage_d5',
                    Yu = 'TankmanFolder_photoImage_8c',
                    ju = 'TankmanFolder_nameBlock_80',
                    Gu = 'TankmanFolder_nameText_c3',
                    Uu = 'TankmanFolder_roleBlock_7c',
                    Vu = 'TankmanFolder_roleIcon_13',
                    $u = 'TankmanFolder_roleText_f4',
                    zu = 'TankmanFolder_tankImage_a7',
                    qu = R.strings.item_types.tankman.roles,
                    Ku = (0, n.memo)(({ tankmanData: e }) => {
                        const u = R.images.gui.maps.icons.library.qualifiers.c_42x42.$dyn(e.specialty),
                            t = e.isFemale ? qu.female.$dyn(e.specialty) : qu.$dyn(e.specialty);
                        return r().createElement(
                            'div',
                            { className: Wu },
                            ...
                            r().createElement(
                                'div',
                                { className: Yu },
                                r().createElement(Iu, { imageName: e.icon, size: Pu.Small }),
                            ),
                            r().createElement('div', {
                                className: zu,
                                style: { backgroundImage: `url('${e.vehicleIcon}')` },
                            }),
                            r().createElement(
                                'div',
                                { className: ju },
                                r().createElement(su, {
                                    className: Gu,
                                    text: R.strings.crew.tankmanChangeAndRecruitView.ConfirmBlock.fullName(),
                                    format: { binding: { name: e.nameText, surname: e.surnameText } },
                                }),
                                r().createElement(
                                    'div',
                                    { className: Uu },
                                    ...
                                    r().createElement(su, { className: $u, text: t }),
                                ),
                            ),
                        );
                    }),
                    Qu = 'ConfirmBlock_base_82',
                    Zu = 'ConfirmBlock_headerText_52',
                    Ju = 'ConfirmBlock_prevBlock_f9',
                    et = 'ConfirmBlock_folderWrapper_94',
                    ut = 'ConfirmBlock_prevArrow_7d',
                    tt = 'ConfirmBlock_attentionBlock_9d',
                    nt = 'ConfirmBlock_attentionIcon_33',
                    rt = 'ConfirmBlock_attentionText_f3',
                    at = 'ConfirmBlock_listBlock_75',
                    ot = 'ConfirmBlock_lightPrevText_b8',
                    it = 'ConfirmBlock_listItem_2d',
                    lt = 'ConfirmBlock_separator_a7',
                    st = 'ConfirmBlock_priceBlock_1a',
                    ct = 'ConfirmBlock_buttonBlock_4a',
                    dt = 'ConfirmBlock_button_0d',
                    mt = 'ConfirmBlock_button__withMargin_20',
                    _t = 'ConfirmBlock_icon_af',
                    Et = R.strings.crew.tankmanChangeAndRecruitView.ConfirmBlock,
                    ht = (e, u) =>
                        e
                            ? { backgroundImage: `url(${R.images.gui.maps.icons.vehicleTypes.elite.$dyn(Ye(u))})` }
                            : {
                                  backgroundImage: `url(${R.images.gui.maps.icons.vehicleTypes.c_24x24_flat.$dyn(Ye(u))})`,
                              },
                    At = (0, ae.Pi)(
                        ({ state: e, initialState: u, handleSwitchWindow: t, handleTankmanChangeApply: a }) => {
                            const o = be().model,
                                i = o.root.get(),
                                l = i.specialtyGold,
                                s = i.retrainingGold,
                                c = i.credits,
                                d = i.initialIcon,
                                m = o.currentTankman.get(),
                                _ = o.futureTankman.get(),
                                E = (0, n.useMemo)(() => l + s, [l, s]),
                                h = e.specialty !== u.specialty,
                                A = e.vehicleID !== u.vehicleID;
                            return r().createElement(
                                'div',
                                { className: Qu },
                                r().createElement(su, { className: Zu, text: Et.header() }),
                                r().createElement(
                                    'div',
                                    { className: Ju },
                                    r().createElement(
                                        'div',
                                        { className: et },
                                        r().createElement(Ku, { tankmanData: Object.assign({}, m, { icon: d }) }),
                                    ),
                                    r().createElement('div', { className: ut }),
                                    r().createElement(
                                        'div',
                                        { className: et },
                                        r().createElement(Ku, { tankmanData: _ }),
                                    ),
                                ),
                                r().createElement(
                                    'div',
                                    ...
                                    r().createElement(su, { className: rt, text: Et.attention() }),
                                ),
                                r().createElement(
                                    'div',
                                    { className: at },
                                    h &&
                                        r().createElement(Hu, {
                                            text: Et.listItem.role(),
                                            classNames: it,
                                            binding: {
                                                from: r().createElement(su, {
                                                    className: ot,
                                                    text: Au(m.specialty, m.isFemale, Eu.Objective),
                                                }),
                                                to: r().createElement(su, {
                                                    className: ot,
                                                    text: Au(_.specialty, _.isFemale, Eu.Objective),
                                                }),
                                            },
                                        }),
                                    A &&
                                        r().createElement(Hu, {
                                            text: Et.listItem.tech(),
                                            binding: {
                                                from: r().createElement(
                                                    r().Fragment,
                                                    null,
                                                    _u(m.vehicleLevel),
                                                    r().createElement('div', {
                                                        className: _t,
                                                        style: ht(m.isEliteVehicle, m.vehType),
                                                    }),
                                                    r().createElement(su, { className: ot, text: m.vehicleName }),
                                                ),
                                                to: r().createElement(
                                                    r().Fragment,
                                                    null,
                                                    ...
                                                    r().createElement('div', {
                                                        className: _t,
                                                        style: ht(_.isEliteVehicle, _.vehType),
                                                    }),
                                                    r().createElement(su, { className: ot, text: _.vehicleName }),
                                                ),
                                            },
                                        }),
                                ),
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        we,
                                        { mixClass: C()(dt, mt), type: Be.main, onClick: a },
                                        r().createElement(su, { text: Et.applyButton() }),
                                    ),
                                    r().createElement(
                                        we,
                                        { mixClass: dt, onClick: t },
                                        r().createElement(su, { text: Et.cancelButton() }),
                                    ),
                                ),
                            );
                        },
                ...
                const vt = (e) => {
                        let u = e.id,
                            ...
                            s = void 0 !== l && l,
                            c = e.size,
                            d = void 0 === c ? Ft.medium : c,
                            m = e.type,
                            _ = void 0 === m ? Ct.primary : m,
                            E = e.soundHover,
                            h = void 0 === E ? 'highlight' : E,
                            A = e.soundClick,
                            D = void 0 === A ? 'play' : A,
                            g = e.onMouseEnter,
                            F = e.onMouseLeave,
                        ...
                        const T = (0, n.useState)(!1),
                            ...
                            I = (0, n.useCallback)(
                                (e) => {
                                    const u = e.button === Dt.LEFT;
                                    i || (u && R(!0), u && p && p(e), D && P(D));
                                },
                                [i, p, D],
                            ),
                            W = (0, n.useCallback)(
                            ...
                            U = r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: C()(gt.labelContent, 's-labelContent'), style: x },
                                    y || k,
                                ),
                            );
                        return r().createElement(
                            ...
                            Bt(
                                {
                                    id: u,
                                    className: C()(gt.base, gt[`base__${d}`], gt[`base__${_}`], {
                                        [gt.base__checked]: a,
                                        [gt.base__disabled]: i,
                                        [gt.base__mouseDown]: M,
                                        [gt.base__alert]: s,
                                        [gt.base__center]: S === bt.Center,
                                        [gt.base__bottom]: S === bt.Bottom,
                                    }),
                                    onClick: N,
                                    onMouseEnter: X,
                                    onMouseLeave: Y,
                            ...
                            r().createElement(
                                'div',
                                { className: gt.input },
                                r().createElement('div', { className: gt.alertOverlay }),
                                r().createElement('div', { className: gt.inputHoverOverlay }),
                                r().createElement('div', { className: gt.highlight }),
                            ),
                            r().createElement('div', { className: gt.checkmark }),
                            ((y || k) && U) || null,
                        );
                    },
                    ft = ['children'];
                ...
                const St = R.views.common.tooltip_window.simple_tooltip_content,
                    Lt = (e) => {
                        ...
                        const c = (0, n.useMemo)(() => {
                            const e = Object.assign({}, l, { body: t, header: a, note: o, alert: i });
                ...
                const Mt = ({ children: e, tooltipArgs: u, className: t }) => {
                        ...
                        if (u.header || u.body) return r().createElement(Lt, u, n);
                        const a = u.contentId,
                            o = u.args,
                            i = null == o ? void 0 : o.contentId;
                        return a || i
                            ? r().createElement(yu, Tt({}, u, { contentId: a || i }), n)
                            : r().createElement(yt, u, n);
                    },
                    Rt = (e) => {
                        let u,
                            t = null;
                ...
                const Nt = 'TextOverflow_base_3b',
                    Pt = ({ content: e, classMix: u }) => {
                        ...
                        return (
                            ...
                            r().createElement(
                                Lt,
                                { isEnabled: o, body: e },
                                r().createElement('div', { ref: t, className: C()(Nt, u) }, e),
                            )
                        );
                    },
                    It = {
                ...
                const Xt = (0, n.memo)(
                        ({
                            ...
                            const _ = (0, n.useState)(Wt.Out),
                                ...
                                f = (0, n.useCallback)((e) => s && s(e), [s]),
                                w = (0, n.useCallback)(() => h(Wt.Out), []);
                            ((0, n.useEffect)(() => {
                                b || g(!1);
                            }, [u, b]),
                                (0, n.useEffect)(() => {
                            ...
                            return r().createElement(
                                ...
                                !D && u === Ot.Alert && r().createElement('div', { className: It.alert }),
                                r().createElement(
                                    'div',
                                    { className: C()(It.label, It[`label__${t}`], !i && It.label__placeholder) },
                                    m || r().createElement(Pt, { content: i || o }),
                                ),
                                r().createElement(
                                    'div',
                                    { className: C()(It.button, It[`button__${t}`]) },
                                    r().createElement('div', { className: C()(It.arrow, It[`arrow__${t}`]) }),
                                    E === Wt.Over && r().createElement('div', { className: It.gradient }),
                                    F && r().createElement('div', { className: It.disabled }),
                                ),
                            );
                        },
                    ),
                ...
                const Ut = Yt,
                    ...
                    $t = (e) => {
                        const u = (0, n.useState)(Vt(e ? e.current : null)),
                            t = u[0],
                            r = u[1];
                        return (
                            (0, n.useEffect)(() => {
                ...
                var zt = t(8380),
                    qt = t.n(zt);
                const Kt = 'ScrollArea_base_47',
                    Qt = 'ScrollArea_base__scrollIndent_1d',
                    Zt = 'ScrollArea_base__verticalScrollbarMargin_50',
                    Jt = 'ScrollArea_base__multiple_44',
                    en = 'ScrollArea_base__hidden_ec',
                    un = r().forwardRef((e, u) => {
                        const t = e.offsetLeft,
                            ...
                            I = (0, n.useCallback)(() => {
                                if (k && c && w) {
                                    const e = { scrollPosition: k.scrollLeft < 0 ? 0 : k.scrollLeft, reach: w.reach.x };
                                    c(e);
                                }
                            }, [c, k, w]),
                            W = (0, n.useCallback)(() => {
                        ...
                        (0, n.useEffect)(() => {
                            if (w && k)
                                return (
                                    ...
                                    k.addEventListener('ps-scroll-x', I),
                                    ...
                                    () => {
                                        (window.removeEventListener('resize', G),
                                            ...
                                            k &&
                                                (k.removeEventListener('ps-scroll-x', I),
                        ...
                        const V = (0, n.useRef)(k || null);
                        V.current = k || null;
                        const $ = $t(V);
                        ((0, n.useEffect)(
                            () => (
                                !w && k && $ && y(new (qt())(k, Object.assign({}, l))),
                                () => {
                            ...
                            (0, n.useEffect)(() => {
                                D &&
                                    ((D.setScrollLeft = O),
                                    (D.setScrollTop = N),
                                    (D.setScrollLeftImmediately = H),
                                    (D.setScrollTopImmediately = P),
                                    (D.updateScrollArea = R),
                                    (D.getScrollbar = M));
                            }, [D, O, H, N, P, R, M]));
                        const z = C()(Kt, { [Qt]: E, [en]: !B, [Zt]: h, [Jt]: A }, F);
                        return r().createElement('div', { className: z, ref: j }, g);
                    }),
                    tn = [
                        'children',
                        'isEnabled',
                ...
                const rn = (e) => {
                        ...
                        (0, n.useEffect)(() => {
                            if (a && null !== o) return Rt(p);
                        }, [l, p, o, a]);
                        const B = !(!g.current || !g.current.scrollbar) && g.current.scrollbar.scrollbarYActive,
                            v = {
                            ...
                            f = (0, n.cloneElement)(u, v);
                        return r().createElement(
                            'div',
                            { className: d, ref: D },
                            r().createElement(un, nn({ ref: g, key: l, scrollAreaContainer: A.current }, m), f),
                        );
                    },
                    an = {
                    ...
                    on = ['size', 'classMix', 'onClick', 'itemRenderer'];
                const ln = (0, n.memo)((e) => {
                        let u = e.size,
                            t = e.classMix,
                            a = e.onClick,
                        ...
                        const l = i.id,
                            ...
                            D = C()(an.base, u && an[`base__${u}`], s && an.base__selected, c && an.base__disabled, t);
                        return r().createElement(
                            'div',
                            { className: D, onMouseEnter: h, onMouseDown: A, onClick: E },
                            o ? o(i) : d,
                        );
                    }),
                    sn = { base__withScroll: 'DropDownItems_base__withScroll_19' };
                function cn() {
                    return (
                        (cn =
                            Object.assign ||
                ...
                const dn = ({
                        ...
                        r().createElement(
                            'div',
                            { className: C()(sn.base, m && sn.base__withScroll) },
                            u.map((u) => {
                                const m = `${i}_${u.id}`;
                                return r().createElement(
                                    'div',
                                    { id: i ? m : void 0, key: m, ref: u.id === n ? a : null },
                                    r().createElement(
                                        ln,
                                        cn({ size: e, soundHover: l, soundClick: s, classMix: c, itemRenderer: d }, u, {
                                            onClick: o,
                    ...
                    En = ({
                        ...
                        return r().createElement(
                            'div',
                            { id: g, className: C()(mn.base, mn[`base__${u}`], l) },
                            r().createElement(
                                rn,
                                { selectedItemId: h, isEnabled: i, scrollSettings: _n, classMix: mn.scrollMix },
                                r().createElement(dn, {
                                    parentId: e,
                                    items: t,
                                    size: u,
                    ...
                    An = (0, n.memo)(
                        ({
                            ...
                            const Q = (0, n.useCallback)(() => {
                                T.current.open && ((T.current.open = !1), O(!1), g && g());
                            }, [g]);
                            $(z ? G.n.ESCAPE : G.n.NONE, Q, z);
                            const Z = (0, n.useCallback)(() => {
                                (b && b(), V && (O(!1), (T.current.open = !1), g && g()));
                            }, [b, g, V]);
                            ((0, n.useEffect)(() => {
                                const e = S.current;
                                if (e && z)
                            ...
                            const J = (0, n.useCallback)(() => {
                                ...
                                const e = u && u.current,
                                    ...
                                    n =
                                        ...
                                        t;
                                n !== T.current.listAbove && ((T.current.listAbove = n), P(n));
                            }, [u, W]);
                            (0, n.useEffect)(() => Rt(J), [J, i, t.length]);
                            const ee = (0, n.useCallback)(
                                    (e) => {
                                        const u = Y.findIndex((u) => u === e) > -1;
                                        let t = [];
                                        ((t = l ? (u ? Y.filter((u) => u !== e) : [e, ...Y]) : u ? [] : [e]),
                                            A && A(t));
                                    },
                                    [l, A, Y],
                                ),
                                ...
                                re = (0, n.useCallback)((e) => p && p(e), [p]),
                                ae = (0, n.useCallback)((e) => v && v(e), [v]),
                                oe = (0, n.useCallback)((e) => B && B(e), [B]),
                                ie = (0, n.useCallback)((e) => f && f(e), [f]),
                                le = (0, n.useMemo)(
                                    () =>
                                        t
                            ...
                            return r().createElement(
                                'div',
                                {
                                    id: e,
                                    ref: S,
                                    className: C()(hn.base, hn[`base__${i}`], d && d.base),
                                    onMouseEnter: re,
                                    onMouseUp: ae,
                                    onMouseDown: oe,
                                    onMouseLeave: ie,
                                ...
                                r().createElement(
                                    'div',
                                    { className: C()(hn.control, z && hn.control__down) },
                                    r().createElement(
                                        Mt,
                                        { tooltipArgs: h },
                                        r().createElement(Xt, {
                                ...
                                r().createElement(
                                    'div',
                                    {
                                        ...
                                        className: C()(
                                            hn.list,
                                            z ? hn.list__down : hn.list__up,
                                            N ? hn.list__above : hn.list__under,
                                        ),
                                    },
                                    r().createElement(En, {
                                        parentId: e,
                    ...
                    Dn = 'DropDownBlock_base_95',
                    gn = 'DropDownBlock_dropDownHeader_f3';
                function Fn() {
                    return (
                        (Fn =
                            Object.assign ||
                ...
                const Cn = (0, n.memo)(
                        ({
                            ...
                            var m;
                            const _ = (0, n.useState)((null == (m = t[0]) ? void 0 : m.id) || oe),
                                E = _[0],
                                h = _[1],
                                A = o !== le && o !== se,
                                D = i || t.length < 2;
                            ...
                            const g = (0, n.useCallback)(
                                    (e) => {
                                        if (e) {
                                            const u = e[0];
                                            u && (h(u), d && d({ [o]: u }), c && c(o, u));
                                        }
                                    },
                                    [o, c, d],
                                ),
                                F = A
                                    ? { items: t, itemRenderer: s, selected: E, controlRenderer: l, onChanges: g }
                                    : { items: t, selected: E, onChanges: g };
                            return r().createElement(
                                'div',
                                { className: C()(Dn, e) },
                                r().createElement(su, { className: gn, text: u }),
                                r().createElement(An, Fn({}, F, { variant: D ? Ot.Disabled : Ot.Basic })),
                            );
                        },
                    ),
                    bn = 'NationDropDown_base_83',
                    pn = 'NationDropDown_base__disabled_42',
                    Bn = 'NationDropDown_icon_c2',
                    vn = 'NationDropDown_base__header_cc',
                    fn = 'NationDropDown_text_d5',
                    wn = (e) =>
                        yn(
                            0 === e.length
                                ? Object.assign({}, ie, { isHeader: !0 })
                                : Object.assign({}, e[0], { isHeader: !0 }),
                        ),
                    yn = ({ id: e, label: u, isDisabled: t, isHeader: n = !1 }) => {
                        if (e === oe)
                            return r().createElement(su, { text: R.strings.dialogs.recruitWindow.menuEmptyRow() });
                        const a = C()(bn, n && vn, t && pn);
                        return r().createElement(
                            'div',
                            { className: a },
                            r().createElement('div', {
                                className: Bn,
                                style: { backgroundImage: `url(${R.images.gui.maps.icons.filters.nations.$dyn(e)})` },
                            }),
                            r().createElement(
                                'div',
                                { className: fn },
                                n ? r().createElement(Pt, { content: u }) : r().createElement(su, { text: u }),
                            ),
                        );
                    },
                    xn = 'Retraining_base_87',
                    kn = 'Retraining_text_4e',
                    Sn = 'Retraining_text__empty_f2',
                    Ln = 'Retraining_icon_94',
                    Tn = (0, n.memo)(({ label: e }) =>
                        r().createElement(
                            'div',
                            { className: xn },
                            e
                                ? r().createElement(
                                      ...
                                      r().createElement('div', {
                                          className: Ln,
                                          style: {
                                              backgroundImage: `url(${R.images.gui.maps.icons.crew.retraining.$dyn(e)})`,
                                          },
                                      }),
                                      r().createElement(Pt, {
                                          classMix: kn,
                                          content:
                                              R.strings.crew.tankmanChangeAndRecruitView.TankmanChange.retraining.$dyn(
                                                  e,
                                              ),
                                      }),
                                  )
                                : r().createElement(Pt, {
                                      classMix: C()(kn, Sn),
                                      content: R.strings.dialogs.recruitWindow.menuEmptyRow(),
                                  }),
                        ),
                    ),
                    Mn = 'SpecializationDropDown_base_c1',
                    Rn = 'SpecializationDropDown_base__disabled_e9',
                    On = 'SpecializationDropDown_icon_d5',
                    Hn = 'SpecializationDropDown_base__header_77',
                    Nn = 'SpecializationDropDown_text_c6',
                    Pn = (e) =>
                        In(
                            0 === e.length
                                ? Object.assign({}, ie, { isHeader: !0 })
                    ...
                    In = ({ id: e, label: u, isDisabled: t, isHeader: n }) => {
                        if (e === oe)
                            return r().createElement(su, { text: R.strings.dialogs.recruitWindow.menuEmptyRow() });
                        const a = C()(Mn, n && Hn, t && Rn);
                        return r().createElement(
                            'div',
                            { className: a },
                            r().createElement('div', {
                            ...
                            r().createElement('div', { className: Nn }, r().createElement(su, { text: u })),
                        );
                    },
                    Wn = 'VehicleDropDown_base_e8',
                    Xn = 'VehicleDropDown_base__disabled_6c',
                    Yn = 'VehicleDropDown_icon_5d',
                    jn = 'VehicleDropDown_base__header_7c',
                    Gn = 'VehicleDropDown_text_17',
                    Un = 'VehicleDropDown_text__default_8b',
                    Vn = 'VehicleDropDown_igr_fa',
                    $n = (e) =>
                        zn(
                            0 === e.length
                                ? Object.assign({}, ie, { isHeader: !0 })
                    ...
                    zn = ({ meta: e, id: u, label: t, isDisabled: a, isHeader: o }) => {
                        const i = e ? e.type : '',
                            l = e && e.isElite,
                            s = e && e.isIGR,
                            c = u === oe,
                        ...
                        if (c) return r().createElement(su, { text: R.strings.dialogs.recruitWindow.menuEmptyRow() });
                        const m = C()(Gn, u === oe && Un),
                            _ = C()(Wn, o && jn, a && Xn);
                        return r().createElement(
                            'div',
                            { className: _ },
                            r().createElement('div', { className: Yn, style: d }),
                            s && r().createElement('div', { className: Vn }),
                            r().createElement(
                                'div',
                                { className: m },
                                o ? r().createElement(Pt, { content: t }) : r().createElement(su, { text: t }),
                            ),
                        );
                    },
                    qn = 'VehTypeDropDown_base_99',
                    Kn = 'VehTypeDropDown_base__disabled_ea',
                    Qn = 'VehTypeDropDown_text_59',
                    Zn = 'VehTypeDropDown_icon_89',
                    Jn = 'VehTypeDropDown_base__header_29',
                    er = (e) =>
                        ur(
                            0 === e.length
                                ? Object.assign({}, ie, { isHeader: !0 })
                    ...
                    ur = ({ id: e, label: u, isDisabled: t, isHeader: n }) => {
                        const a = e.toString().replace('-', '_');
                        if (e === oe)
                            return r().createElement(su, { text: R.strings.dialogs.recruitWindow.menuEmptyRow() });
                        const o = C()(qn, n && Jn, t && Kn);
                        return r().createElement(
                            'div',
                            { className: o },
                            r().createElement('div', {
                                className: Zn,
                                style: {
                                    backgroundImage: `url(${R.images.gui.maps.icons.vehicleTypes.c_24x24_flat.$dyn(a)})`,
                                },
                            }),
                            r().createElement('div', { className: Qn }, r().createElement(su, { text: u })),
                        );
                    },
                    tr = 'TankmanChange_base_8f',
                    nr = 'TankmanChange_header_78',
                    rr = 'TankmanChange_nameChanger_7d',
                    ar = 'TankmanChange_nameDropDown_86',
                    or = 'TankmanChange_specChanger_d3',
                    ir = 'TankmanChange_specChanger__big_62',
                    lr = 'TankmanChange_specBorder_a3',
                    sr = 'TankmanChange_specBorder__top_86',
                    cr = 'TankmanChange_specBorder__bottom_57',
                    dr = 'TankmanChange_specChangerHeader_69',
                    mr = 'TankmanChange_specChangerDropDrowns_34',
                    _r = 'TankmanChange_specDropDown_72',
                    Er = 'TankmanChange_specDropDown__recruit_4c',
                    hr = 'TankmanChange_specSeparator_ad',
                    Ar = 'TankmanChange_specSeparator__recruit_9d',
                    Dr = 'TankmanChange_retraining_1b',
                    gr = 'TankmanChange_retrainingHeader_48',
                    Fr = 'TankmanChange_attentionBlock_f2',
                    Cr = 'TankmanChange_attentionIcon_16',
                    br = 'TankmanChange_attentionText_49',
                    pr = 'TankmanChange_checkBox_72',
                    Br = 'TankmanChange_checkBox__visible_6a',
                    vr = 'TankmanChange_priceBlock_4d',
                    fr = 'TankmanChange_buttonBlock_85',
                    wr = 'TankmanChange_button_bf',
                    yr = 'TankmanChange_button__withMargin_3f',
                    xr = 'TankmanChange_button__retraining_b5',
                    kr = 'TankmanChange_photo_e7',
                    Sr = R.strings.crew.tankmanChangeAndRecruitView.TankmanChange,
                    Lr = (0, ae.Pi)(
                        ({
                            state: e,
                            initialState: u,
                            isStateChanged: t,
                            handleStateChange: a,
                            handleSwitchWindow: o,
                        }) => {
                            const i = be(),
                                l = i.controls,
                                s = i.model,
                                c = e.vehicleID !== u.vehicleID,
                                d = s.root.get(),
                                m = d.isRecruit,
                                _ = d.isNameCanBeChanged,
                                E = d.specialtyGold,
                                h = d.retrainingGold,
                                A = d.credits,
                                D = d.retraining,
                                ...
                                M = ((e, u, t) =>
                                    (0, n.useMemo)(
                                        () =>
                                            (!e && u.icon === t.icon) ||
                                            (u.vehType !== t.vehType && u.vehicleID === t.vehicleID) ||
                                            de(t.vehicleID) ||
                                            de(t.specialty),
                                        [e, u, t],
                                    ))(t, u, L),
                            ...
                            return r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        !m &&
                                            r().createElement(
                                                'div',
                                                { className: _r },
                                                r().createElement(su, { className: gr, text: Sr.retrainingText() }),
                                                r().createElement(
                                                    'div',
                                                    { className: Dr },
                                                    r().createElement(Tn, { label: D }),
                                                    r().createElement(
                                                        we,
                                                        {
                                                            mixClass: C()(wr, xr),
                                        ...
                                        r().createElement('div', { className: C()(hr, m && Ar) }),
                                        r().createElement(Cn, {
                                            className: C()(_r, m && Er),
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: Fr },
                                        r().createElement('div', { className: Cr }),
                                        r().createElement(su, { className: br, text: Sr.attention() }),
                                    ),
                                    r().createElement(
                                        'div',
                                        { className: C()(pr, H && Br) },
                                        r().createElement(vt, {
                                            ...
                                            isChecked: b,
                                            onChange: () => {
                                                l.onSetInVehChange({ isKeepInVeh: !b });
                                            },
                                        }),
                                    ),
                                ),
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        we,
                                        { mixClass: wr, onClick: l.onViewClose },
                                        r().createElement(su, { text: Sr.cancelButton() }),
                                    ),
                                ),
                            );
                        },
                    ...
                    Rr = 'App_bgShadow_1e',
                    Or = 'App_topRight_b6',
                    Hr = 'App_closeButton_45',
                    Nr = 'App_content_62',
                    Pr = (0, ae.Pi)(() => {
                        const e = be(),
                            u = e.controls,
                            t = e.model,
                            a = t.computes.getTankman(),
                            i = t.root.get().isEnoughGold,
                            l = ((e) => {
                        ...
                        !(function ({
                            key: e = G.n.ESCAPE,
                            callback: u = () => o.O.view.sendEvent.close(),
                            preventPropagation: t = !0,
                        } = {}) {
                            $(e, u, t);
                        })({ callback: u.onViewClose });
                        const D = (0, n.useCallback)(() => {
                                i ? A(!h) : u.onTankmanUpdate();
                            }, [u, i, h]),
                            g = (0, n.useCallback)(
                                (e, u) => {
                                    c(e, u);
                        ...
                        return r().createElement(
                            'div',
                            { className: Tr },
                            r().createElement('div', { className: Rr }),
                            a.nationName &&
                                r().createElement('div', {
                                    className: Mr,
                                    style: {
                                        backgroundImage: `url('${R.images.gui.maps.icons.crew.flags.$dyn(a.nationName)}')`,
                                    },
                                }),
                            r().createElement(
                                'div',
                                ...
                                h
                                    ? r().createElement(At, {
                                          state: s,
                                          initialState: _,
                                          handleSwitchWindow: D,
                                          handleTankmanChangeApply: u.onTankmanUpdate,
                                      })
                                    : r().createElement(Lr, {
                                          state: s,
                                          initialState: _,
                            ...
                            r().createElement(
                                'div',
                                { className: Or },
                                r().createElement(re, { id: R.views.dialogs.sub_views.topRight.MoneyBalance('resId') }),
                                r().createElement(
                                    'div',
                                    { className: Hr },
                                    r().createElement(j, {
                                        side: 'right',
                                        type: 'close',
                                        caption: R.strings.crew.tankmanChangeAndRecruitView.closeButton(),
                                        onClick: u.onViewClose,
                                    }),
                                ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    N().render(
                        r().createElement(Ce, null, r().createElement(O, null, r().createElement(Pr, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(4234));
