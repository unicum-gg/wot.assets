    ...
    var __webpack_modules__ = {
            3779: (e, u, t) => {
                ...
                const d = {
                    ...
                    F = (0, s.ZP)((e) => {
                        let u = e.className,
                            ...
                            L =
                                void 0 === T
                                    ...
                                    : T,
                            N = e.alignItems,
                            R = void 0 === N ? (w ? 'flex-start' : S && 'center') || (x && 'flex-end') || void 0 : N,
                            M = e.alignSelf,
                            O = e.wrap,
                            P = e.flexWrap,
                        ...
                        return l().createElement('div', m({ className: r()(c.Z.base, ...$, u), style: X }, G), z);
                    });
            },
            3457: (e, u, t) => {
                'use strict';
            ...
            2773: (e, u, t) => {
                ...
                const A = 'disable',
                    ...
                    C = (0, c.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = F, onDrag: n = D }) => {
            ...
            6225: (e, u, t) => {
                ...
                const A = 'disable',
                    ...
                    g = (0, c.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = D, onDrag: n = _ }) => {
                        ...
                        ((0, c.useEffect)(() => (0, i.v)(L)),
                            ...
                            (0, c.useEffect)(() => {
                                ...
                                const u = (u) => {
                                    ...
                                    t = () => {
                                        (window.removeEventListener('mousemove', u), e.handleIsThumbDragging(!1), y(F));
                                    };
                                return (
                                    window.addEventListener('mousemove', u),
                                    window.addEventListener('mouseup', t),
            ...
            1943: (e, u, t) => {
                ...
                const i = 'metrics',
                    ...
                    c = (e, u) => {
                        ...
                        return [(e) => i(e), (e, u, t, n) => m(e, u, t, n), () => o(), (e) => c(e), (e) => E(e)];
                    },
                    E = (e) => {
                        const u = c(e, i),
                            t = u[0],
                ...
                const c = R.images.gui.maps.icons.tankmen.icons,
                    E = (0, i.memo)(({ name: e, size: u = l.c100x60, className: t, isSkin: n = !1 }) => {
                        ...
                        return s().createElement(
                            'div',
                            { style: { backgroundImage: `url(${i})` }, className: r()(o.Z.base, o.Z[`base__${u}`], t) },
            ...
            894: (e, u, t) => {
                ...
                const y = ({ name: e, amount: u, block: t, isRare: n, size: a, className: i }) => {
                    const s =
                        a === x.Small ? R.images.gui.maps.icons.achievement : R.images.gui.maps.icons.achievement.big;
                    return r().createElement(
                        b.t,
                        {
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                ...
                                (0, l.UI)(u.computes.getAchievementsList(), (e, u) =>
                                    r().createElement(y, k({}, e, { size: n, key: `achievement_${u}`, className: v })),
                                ),
                            ),
                        ),
                    );
                ...
                r().memo(({ setTTCVisibility: e }) =>
                    r().createElement(A, { options: { rootId: ee } }, r().createElement(Q, { setTTCVisibility: e })),
                );
            },
            3961: (e, u, t) => {
                'use strict';
            ...
            3055: (e, u, t) => {
                ...
                const d = 'TankmanFolder_base_00',
                    ...
                    b = r().memo(function ({ name: e, className: u, isSkin: t = !1, isFolderLight: a, onClick: l }) {
                ...
                const xe = ({ isCrewLocked: e, nativeVehicle: u, className: t, setIsFolderLight: a }) => {
                    ...
                    He = (0, l.Pi)(({ className: e }) => {
                        ...
                        return r().createElement(
                            'div',
                            { className: i()(ye, e) },
                            r().createElement(b, { isFolderLight: g, name: m, isSkin: F, className: ke, onClick: p }),
                            r().createElement(
                                'div',
                                { className: Te },
