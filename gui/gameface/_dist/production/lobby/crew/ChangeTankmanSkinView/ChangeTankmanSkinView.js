(() => {
    var __webpack_modules__ = {
                        ...
                        let u = e.className,
                            ...
                            N =
                                void 0 === L
                                    ...
                                    : L,
                            T = e.alignItems,
                            R = void 0 === T ? (w ? 'flex-start' : x && 'center') || (S && 'flex-end') || void 0 : T,
                            k = e.alignSelf,
                            O = e.wrap,
                            P = e.flexWrap,
            ...
            2515: (e, u, t) => {
                ...
                var r = {};
                (t.r(r), t.d(r, { Area: () => uu, Bar: () => Je, Default: () => eu, useVerticalScrollApi: () => Ie }));
                var a = t(7739),
                    o = t(6179),
                    s = t.n(o),
                    i = t(6483),
                ...
                const ge = {
                    ...
                    Re = (0, o.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Le, onDrag: n = Ne }) => {
                                        ...
                                        if (a.current && i.current && c.current && d.current) {
                                            if (0 === e)
                                                return (
                                                    ...
                                                    void i.current.classList.remove(ye)
                                                );
                                            if (
                                                ((u = c.current),
                                                (t = d.current),
                                                ...
                                                return (
                                                    ...
                                                    void i.current.classList.add(ye)
                                                );
                                            var u, t;
                        ...
                        return s().createElement(
                            ...
                            s().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(ye) || 0 !== e.button || ((0, v.G)('play'), p(Ce.Next));
                                },
                                onMouseUp: B,
                                ref: a,
                                onMouseEnter: h,
                            ...
                            s().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(ye) || 0 !== e.button || ((0, v.G)('play'), p(Ce.Prev));
                                },
                                onMouseUp: B,
                                ref: i,
                                onMouseEnter: h,
                ...
                const Mu = 'InventoryInfo_base_08',
                    ...
                    Tu = (0, o.memo)(({ amount: e, className: u }) =>
                        s().createElement(
                            ...
                            s().createElement('div', { className: Nu }, s().createElement(X.ZP, { text: `${e}` })),
                        ),
                    ),
                ...
                const Me = {
                    ...
                    Le = (e) => {
                        ...
                        ((0, n.useEffect)(() => {
                            ...
                            (0, n.useEffect)(() => {
                                (H.current.isChangeHandled && d !== H.current.value && ((H.current.value = d), R(d)),
                                    (H.current.type = a));
                            }, [d, a]),
                            (0, n.useEffect)(() => {
                                P(D);
                        ...
                        return r().createElement(
                            'div',
                            { id: u, className: te, onMouseEnter: z, onMouseDown: X, onMouseUp: $, onMouseLeave: q },
                            r().createElement(
                                m.l,
                                { tooltipArgs: E },
                                r().createElement(
                    ...
                    Ne = ({ value: e, placeholder: u, tooltipHeader: t, onChange: n, className: a, tooltipBody: o }) =>
                        r().createElement(
                            c.i,
