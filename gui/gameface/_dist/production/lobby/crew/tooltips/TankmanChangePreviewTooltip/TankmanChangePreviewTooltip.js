(() => {
    var __webpack_modules__ = {
            ...
            6916: (u, e, t) => {
                ...
                const $ = {
                    ...
                    J = K((u) => {
                        ...
                        const I = (0, n.useMemo)(() => {
                            ...
                            }, [t, r, F, o, l, B, N, k, L, d, O, f, S]),
                            G = I.computedStyle,
                            U = I.computedClassNames;
                        return A().createElement('div', Y({ className: a()(z.base, ...U, e), style: G }, W), H);
                    });
                let uu;
                !(function (u) {
                ...
                const Lu = ((u, e) => {
                    ...
                    Mu = Lu[1],
                    Ou = 'App_base_eb',
                    Ru = 'App_headerText_d0',
                    Tu = 'App_priceText_db',
                    Pu = R.strings.crew.tankmanChangePreviewTooltip,
                    ku = (0, pu.Pi)(() => {
                        ...
                        return A().createElement(
                            'div',
                            { className: Ou },
                            A().createElement(hu, { className: Ru, text: Pu.header() }),
                            r > 0 &&
                                A().createElement(hu, {
                                    className: Tu,
                                    text: Pu.speciality(),
                                    format: {
                                        binding: {
                                            value: A().createElement(p, { value: r, size: B.small, type: c.gold }),
                                        },
                                    },
                                }),
                            (e > 0 || t > 0) &&
                                A().createElement(hu, {
                                    className: Tu,
                                    text: Pu.specialization(),
                                    format: {
                                        binding: {
                                            value: A().createElement(p, {
                                                value: e || t,
                                                size: B.small,
                                                type: e ? c.credits : c.gold,
                                            }),
                                        },
                                    },
                                }),
                ...
                engine.whenReady.then(() => {
                    s().render(
                        A().createElement(_, null, A().createElement(yu, null, A().createElement(ku, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(6916));
