    ...
    var u,
        e = {
            6757: (u, e, A) => {
                ...
                var D = {};
                (A.r(D), A.d(D, { getBgUrl: () => P, getTextureUrl: () => S }));
                var t = {};
                (A.r(t),
                    A.d(t, {
                        addModelObserver: () => H,
                ...
                const f = {
                    ...
                    _ = Object.keys(h).reduce((u, e) => ((u[e] = () => m(h[e])), u), {}),
                    w = { play: Object.assign({}, _, { sound: m }), setRTPC: g },
                ...
                const Cu = Object.keys(O).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === O[e]), u), {}),
                    ou = {
                        set: (u, e) => {
                ...
                const lu = { view: t, client: E, sound: w, intl: b };
                var cu = A(7363),
                    du = A.n(cu);
                const mu = {
                ...
                const vu = du().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        du().createElement(
                            'div',
                            pu({}, t, {
                                className: n()(mu.base, mu[`base__theme-${D}`], F),
                                ref: function (u) {
                                    ((B.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            du().createElement('div', { className: mu.decorator }, A),
                        )
                    );
                });
                var fu = A(1533),
                ...
                const yu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Su = (u, e, A = wu.left) => u.split(e).reduce(A === wu.left ? Tu : Ru, []),
                    Pu = (() => {
                        const u = new RegExp(
                            [
                    ...
                    ku = (u, e = wu.left) => {
                        ...
                        return ((u, e = wu.left) => {
                            ...
                            const F =
                                ...
                                E = yu(u);
                            return (Su(E, /( )/, e).forEach((u) => (A = A.concat(Su(u, F, wu.left)))), A);
                        })(u, e);
                    },
                    zu = 'FormatText_base_f27a4',
                    Nu = ({ binding: u, text: e = '', classMix: A, alignment: F = wu.left, formatWithBrackets: E }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const D = E && u ? xu(e, u) : e;
                        return du().createElement(
                            ...
                            D.split('\n').map((e, E) =>
                                du().createElement(
                                    'div',
                                    { className: n()(zu, A), key: `${e}-${E}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : ku(u, e))))(
                                        e,
                                        F,
                                        u,
                                    ).map((u, e) => du().createElement(cu.Fragment, { key: `${e}-${u}` }, u)),
                                ),
                            ),
                        );
                    },
                    ...
                    ju = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Lu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    $u = (0, cu.memo)(({ text: u, binding: e, classMix: A }) => {
                                ...
                                ((t = t.replace(A, `%(${D})`)),
                                    (E[D] = Wu[u]
                                        ? du().createElement(
                                              'span',
                                              { className: Wu[u] },
                                              du().createElement(Nu, { text: C, binding: e }),
                                          )
                                        : du().createElement(
                                              'span',
                                              { style: F(u) },
                        ...
                        return du().createElement(Nu, { text: t, classMix: A, binding: E });
                    });
                function Vu() {
                    return !1;
                }
                ...
                const qu = ((u, e) => {
                                ...
                                const B = (0, cu.useRef)([]),
                                    n = (A, F, E) => {
                                        ...
                                        const t = (function ({
                                                ...
                                                return {
                                                    subscribe: (A, D) => {
                                                        const B = 'string' == typeof D ? `${F}.${D}` : F,
                                                            n = lu.view.addModelObserver(B, e, !0);
                                            ...
                                            a = { mode: A, model: o, externalModel: n, cleanup: C };
                                        return {
                                            model: o,
                                            controls: 'mocks' === A && E ? E.controls(a) : e(a),
                                            externalModel: n,
                                            mode: A,
                                        };
                                    },
                                    ...
                                    o = C[0],
                                    a = C[1],
                                    i = (0, cu.useState)(() => n(F, E, t)),
                                    s = i[0],
                                    l = i[1];
                                return (
                                    (0, cu.useEffect)(() => {
                                        r.current ? l(n(o, E, t)) : (r.current = !0);
                                    }, [t, o, E]),
                                    (0, cu.useEffect)(() => {
                                        a(F);
                                    }, [F]),
                                    ...
                                    du().createElement(A.Provider, { value: s }, D)
                                );
                            },
                            () => (0, cu.useContext)(A),
                        ];
                        ...
                        ({ observableModel: u }) => {
                            const e = {
                                primitives: u.primitives(['showSortingSelectionWarning', 'isSortingDisabled']),
                            };
                    ...
                    Xu = qu[1],
                    Zu = 'App_base_dfbc4',
                    Ju = 'App_background_f3a03',
                    Ku = 'App_header_c4689',
                    Yu = 'App_header_mainTitle_adfcc',
                    ue = 'App_header_desc_c3711',
                    ee = 'App_headerWrapper_f03a0',
                    Ae = 'App_headerWrapper_icon_dab4b',
                    Fe = 'App_headerWrapper_title_a8548',
                    Ee = 'App_body_b04b4',
                    De = 'App_body_title_ca6a1',
                    te = 'App_body_commonlyUsed_ae1c4',
                    Be = 'App_body_legendary_c3dfa',
                    ne = 'App_body_commonlyUsed_icon_b5861',
                    re = 'App_body_legendary_icon_f4f9a',
                    Ce = 'App_body_commonlyUsed_desc_fc6a0',
                    oe = 'App_body_legendary_desc_dd851',
                    ae = 'App_noData_de0bc',
                    ie = 'App_noData_separator_b5443',
                    se = 'App_noData_icon_e71f1',
                    le = 'App_noData_header_eccbc',
                    ce = 'App_noData_desc_e3040',
                    de = (0, hu.Pi)(() => {
                        const u = Xu().model,
                            e = u.showSortingSelectionWarning.get(),
                            A = u.isSortingDisabled.get();
                        return du().createElement(
                            'div',
                            { className: Zu },
                            du().createElement('div', { className: Ju }),
                            du().createElement(
                                'div',
                                { className: Ku },
                                du().createElement(
                                    'div',
                                    { className: ee },
                                    du().createElement('div', { className: Ae }),
                                    du().createElement(
                                        'div',
                                        { className: Fe },
                                        R.strings.crew_perks.sorting.tooltip.header(),
                                    ),
                                ),
                                du().createElement(
                                    'div',
                                    { className: Yu },
                                    R.strings.crew_perks.sorting.tooltip.title(),
                                ),
                                du().createElement(
                                    'div',
                                    { className: ue },
                                    R.strings.crew_perks.sorting.tooltip.headerDescription(),
                                ),
                            ),
                            du().createElement(
                                'div',
                                ...
                                du().createElement(
                                    'div',
                                    { className: De },
                                    R.strings.crew_perks.sorting.tooltip.types(),
                                ),
                                du().createElement(
                                    'div',
                                    { className: te },
                                    du().createElement('div', { className: ne }),
                                    du().createElement($u, {
                                        classMix: Ce,
                                        text: R.strings.crew_perks.sorting.tooltip.common(),
                                    }),
                                ),
                                du().createElement(
                                    'div',
                                    { className: Be },
                                    du().createElement('div', { className: re }),
                                    du().createElement($u, {
                                        classMix: oe,
                                        text: R.strings.crew_perks.sorting.tooltip.legendary(),
                                    }),
                                ),
                            ),
                            e &&
                                du().createElement(
                                    'div',
                                    { className: ae },
                                    du().createElement('div', { className: ie }),
                                    du().createElement('div', { className: se }),
                                    du().createElement(
                                        'div',
                                        { className: le },
                                        R.strings.crew_perks.sorting.tooltip.warning(),
                                    ),
                                    du().createElement(
                                        'div',
                                        { className: ce },
                                        R.strings.crew_perks.sorting.tooltip.warningText(),
                                    ),
                                ),
                            A &&
                                !e &&
                                du().createElement(
                                    ...
                                    du().createElement(
                                        'div',
                                        { className: le },
                                        R.strings.crew_perks.sorting.tooltip.sortingDisabled(),
                                    ),
                                    du().createElement(
                                        'div',
                                        { className: ce },
                                        R.strings.crew_perks.sorting.tooltip.sortingDisabledText(),
                                    ),
                                ),
                        );
                    });
                engine.whenReady.then(() => {
                    bu().render(
                        du().createElement(vu, null, du().createElement(Qu, null, du().createElement(de, null))),
    ...
    ((F.m = e),
        ...
        (F.O = (e, A, E, D) => {
            if (!A) {
                ...
                for (C = 0; C < u.length; C++) {
                    for (var [A, E, D] = u[C], B = !0, n = 0; n < A.length; n++)
            ...
            D = D || 0;
            for (var C = u.length; C > 0 && u[C - 1][2] > D; C--) u[C] = u[C - 1];
            u[C] = [A, E, D];
        }),
        (F.n = (u) => {
        ...
        (() => {
            ...
            var e = (e, A) => {
                    ...
                    for (e && e(A); r < t.length; r++) ((D = t[r]), F.o(u, D) && u[D] && u[D][0](), (u[D] = 0));
                    return F.O(C);
                },
                A = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (A.forEach(e.bind(null, 0)), (A.push = e.bind(null, A.push.bind(A))));
        })());
    var E = F.O(void 0, [9056], () => F(6757));
    E = F.O(E);
})();
