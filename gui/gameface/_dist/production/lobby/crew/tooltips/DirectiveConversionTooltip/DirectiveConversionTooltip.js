    ...
    var __webpack_modules__ = {
                        ...
                        sendShowPopOverEvent: (u, e, t, n, r = R.invalid('resId'), o) => {
                            const i = l.O.view.getViewGlobalPosition(),
                                ...
                                d = {
                                    ...
                                    y: l.O.view.pxToRem(c) + i.y,
                                    width: l.O.view.pxToRem(A),
                                    height: l.O.view.pxToRem(F),
                                };
                            C(a.POP_OVER, {
                                isMouseEvent: !0,
                                contentID: u,
            ...
            8628: (u, e, t) => {
                ...
                const I = { [M.NBSP]: N.NoBreakSymbol, [M.ZWNBSP]: N.NoBreakSymbol, [M.NEW_LINE]: N.LineBreak },
                    ...
                    au = (u, e, t, n, r, o) => {
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            if (c === N.LineBreak || c === N.NewLine || c === N.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const l = A.slice(0, A.length - F) + o,
                                    d = e[E];
                    ...
                    su = (u, e, t, n = '...') => {
                        ...
                        if (c < 0) return [r, !1];
                        const A = au(E, r, c, a, n.length, n),
                            F = A[0],
                            l = A[1];
                        return l && (r.splice(F, 1, l), r.splice(F + 1)), [r, !0];
                    },
                    Eu = a().memo(
                        ({
                            text: u,
                            ...
                            const d = (0, i.useRef)(null),
                                ...
                                _ = B[0],
                                C = B[1],
                                p = (0, i.useMemo)(() => nu(u, n, { justifyContent: A }), [n, A, u]),
                                h = (0, i.useMemo)(() => {
                                    if (
                                        o &&
                                        _.isTruncated &&
                                ...
                                m = (0, i.useMemo)(() => ({ justifyContent: A, alignContent: F }), [F, A]);
                            return (
                                ((u, e, t = !0) => {
                ...
                const hu = ((u, e) => {
                                ...
                                const c = (0, i.useRef)([]),
                                    A = (t, n, r) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            l = { mode: t, model: F, externalModel: s, cleanup: A };
                                        return {
                                            model: F,
                                    ...
                                    d = l[0],
                                    D = l[1],
                                    B = (0, i.useState)(() => A(n, r, E)),
                                    _ = B[0],
                                    C = B[1];
                                return (
                                    (0, i.useEffect)(() => {
                                        F.current ? C(A(d, r, E)) : (F.current = !0);
                                    }, [E, d, r]),
                                    (0, i.useEffect)(() => {
                                        D(n);
                                    }, [n]),
                    ...
                    bu = 'DirectiveIcon_icon_6f',
                    gu = 'DirectiveIcon_highlight_5c',
                ...
                engine.whenReady.then(() => {
                    d().render(
                        a().createElement(F, null, a().createElement(vu, null, a().createElement(Pu, null))),
