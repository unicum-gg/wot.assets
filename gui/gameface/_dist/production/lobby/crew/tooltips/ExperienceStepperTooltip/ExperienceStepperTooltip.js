(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => F, off: () => a, on: () => s, onResize: () => o, onScaleUpdated: () => i }));
                var n = t(2472),
                    r = t(1176);
            ...
            3: (u, e, t) => {
                    ...
                    b = (u) => {
                        ...
                        return s().createElement(
                            ...
                            w(
                                {
                                    contentId:
                                        ((A = null == a ? void 0 : a.hasHtmlContent),
                ...
                const T = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const r = e.contentId;
                    return r ? s().createElement(p, y({}, e, { contentId: r }), n) : s().createElement(g, e, n);
                };
                var k = t(8045);
                const x = {
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const l = A.slice(0, A.length - c) + o,
                                    d = e[E];
                                ((a = s().cloneElement(d, d.props, l)), (i = E));
                                break;
                            }
                            {
                                const u = t.children,
                                ...
                                if (!(d < 0)) {
                                    const u = c.slice(0, d);
                                    ((a = s().cloneElement(F, F.props, u, D)), (i = E));
                                    break;
                                }
                                r -= A.length;
                            }
                    ...
                    au = s().memo(
                        ({
                            ...
                            const d = (0, i.useRef)(null),
                                ...
                                g = (0, i.useMemo)(() => ({ justifyContent: A, alignContent: c }), [c, A]);
                            return (
                                ((u, e, t = !0) => {
                                    ...
                                    s().createElement(
                                        ...
                                        s().createElement(
                                            'div',
                                            {
                                                className: r()(
                                                    x.truncated,
                                                    !_.isTruncateFinished && a && x.truncated__hide,
                                                ),
                                                style: g,
                                            },
                    ...
                    Fu = () =>
                        s().createElement(
                            ...
                            s().createElement(au, {
                                ...
                                binding: {
                                    controlsImg: s().createElement('div', { className: r()(Eu.img, Eu.controlsImg) }),
                                },
                                classMix: Eu.controlsText,
                            }),
                            s().createElement(au, {
                                text: R.strings.crew_books.tooltip.stepper.perkUpdate(),
                                binding: {
                                    pgupImg: s().createElement('div', { className: r()(Eu.img, Eu.pageUpImg) }),
                                    pgdownImg: s().createElement('div', { className: r()(Eu.img, Eu.pageDownImg) }),
                                },
                            }),
                        );
