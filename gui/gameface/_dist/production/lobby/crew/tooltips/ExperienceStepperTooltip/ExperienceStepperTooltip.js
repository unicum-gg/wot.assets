(() => {
    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                ...
                function d(u, e, t, n, r, o, i) {
                    ...
                    E.done ? e(F) : Promise.resolve(F).then(n, r);
                }
            ...
            3: (u, e, t) => {
                        ...
                        const b = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, i.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (_(t, D, { isMouseEvent: !0, on: !0, arguments: C(n) }, f),
                                    v && v(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((b.current.timeoutId = window.setTimeout(y, s ? 100 : 400)),
                                                      r && r(u),
                                                      O && O(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                    ...
                    f = (u) => {
                        ...
                        return E().createElement(
                            ...
                            g(
                                {
                                    contentId:
                                        ((a = null == F ? void 0 : F.hasHtmlContent),
                ...
                const k = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return E().createElement(f, e, n);
                    const r = e.contentId,
                        o = e.args,
                        i = null == o ? void 0 : o.contentId;
                    return r || i
                        ? E().createElement(p, y({}, e, { contentId: r || i }), n)
                        : E().createElement(v, e, n);
                };
                var T = t(8045);
                const O = 'ExtendedText_base_71',
                    x = 'ExtendedText_base__zeroPadding_25',
                    L = 'ExtendedText_base__isTruncationAvailable_5b',
                    P = 'ExtendedText_truncated_97',
                    M = 'ExtendedText_truncated__hide_31',
                    S = 'ExtendedText_unTruncated_b8';
                let N;
                !(function (u) {
                ...
                const j = { [V.NBSP]: U.NoBreakSymbol, [V.ZWNBSP]: U.NoBreakSymbol, [V.NEW_LINE]: U.LineBreak },
                    ...
                    Y = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ...
                            : E().createElement('span', { key: t, 'data-block-type': e.blockType }, u);
                    },
                    Z = {
                        [U.Word]: Y,
                        [U.NoBreakSymbol]: Y,
                    ...
                    uu = (u, e = '') => {
                        ...
                        return (
                            Q(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: U.Word, colorTag: e, childList: J(u) });
                                },
                                (u) => {
                                    const n = u[0],
                                        r = j[n.charAt(0)];
                            ...
                            Q(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof o || 'number' == typeof o
                                        ? n.push(...uu(String(o), t))
                                        : n.push({ blockType: U.Binding, colorTag: t, childList: [o] });
                                },
                            ),
                            n
                        );
                    ...
                    Eu = (u, e, t, n, r, o) => {
                        ...
                        for (let A = t; A >= 0; A--) {
                            ...
                            if (s === U.LineBreak || s === U.NewLine || s === U.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const l = a.slice(0, a.length - c) + o,
                                    D = e[A];
                                ((F = E().cloneElement(D, D.props, l)), (i = A));
                                break;
                            }
                            {
                                const u = t.children,
                                    s = e[A],
                                    c = s.props.children,
                                    l = Eu(u, c, u.length - 1, n, r, o),
                                    D = l[0],
                                    B = l[1];
                                if (!(D < 0)) {
                                    const u = c.slice(0, D);
                                    ((F = E().cloneElement(s, s.props, u, B)), (i = A));
                                    break;
                                }
                                r -= a.length;
                            }
                    ...
                    Au = E().memo(
                        ({
                            ...
                            const l = (0, i.useRef)(null),
                                ...
                                m = (0, i.useMemo)(() => ({ justifyContent: s, alignContent: a }), [a, s]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                E().createElement(
                                    'div',
                                    { className: r()(O, e, x, F && L), style: m },
                                    E().createElement('div', { className: S, ref: l }, _),
                                    E().createElement(
                                        k,
                                        { tooltipArgs: p },
                                        E().createElement(
                                            'div',
                                            { className: r()(P, !d.isTruncateFinished && F && M), style: m },
                                            d.isTruncateFinished && F ? d.elementList : _,
                                        ),
                                    ),
                                )
                            );
                    ...
                    au = () =>
                        E().createElement(
                            ...
                            E().createElement(Au, {
                                ...
                                binding: {
                                    controlsImg: E().createElement('div', { className: r()(su.img, su.controlsImg) }),
                                },
                                classMix: su.controlsText,
                            }),
                            E().createElement(Au, {
                                text: R.strings.crew_books.tooltip.stepper.perkUpdate(),
                                binding: {
                                    pgupImg: E().createElement('div', { className: r()(su.img, su.pageUpImg) }),
                                    pgdownImg: E().createElement('div', { className: r()(su.img, su.pageDownImg) }),
                                },
                            }),
                        );
                engine.whenReady.then(() => {
                    D().render(
                        E().createElement(c, null, E().createElement(au, null)),
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (F = 0; F < deferred.length; F++) {
                    for (var [e, t, n] = deferred[F], o = !0, i = 0; i < e.length; i++)
                        (!1 & n || r >= n) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(3));
