(() => {
    ...
    var __webpack_modules__ = {
            ...
            2161: (u, e, t) => {
                        ...
                        const w = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, i.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (_(t, d, { isMouseEvent: !0, on: !0, arguments: B(n) }, b),
                                    v && v(),
                ...
                const y = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const r = e.contentId;
                    return r ? a().createElement(C, b({}, e, { contentId: r }), n) : a().createElement(f, e, n);
                };
                var T = t(1311);
                const k = {
                ...
                const S = { [L.NBSP]: O.NoBreakSymbol, [L.ZWNBSP]: O.NoBreakSymbol, [L.NEW_LINE]: O.LineBreak },
                    ...
                    I = 'renderers_noBreakWrapper_d986b',
                    ...
                    z = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? N[n]
                                ? a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: r()(V, N[n]) },
                                      u,
                                  )
                                : a().createElement(
                                      'span',
                    ...
                    G = {
                        ...
                        [O.LineBreak]: ({ key: u }) =>
                            a().createElement('span', { key: u, 'data-block-type': O.LineBreak, className: j }),
                        [O.NewLine]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': O.NewLine, className: W }, u),
                        [O.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': O.NoBreakWrapper, className: I }, u),
                    },
                    q = (u, e, t) => {
                        const n = [];
                        return (
                    ...
                    $ = M
                        ...
                        : (u, e) => {
                              ...
                              let o = 0;
                              for (; n;) {
                                  const i = e.justifyContent === P.FlexEnd ? n.index : t.lastIndex;
                    ...
                    X = (u, e = '', t) => {
                        ...
                        return (
                            K(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    n.push({ blockType: O.Word, colorTag: e, childList: $(u, t) });
                                },
                                (u) => {
                                    const t = u[0],
                                        r = S[t.charAt(0)];
                            ...
                            K(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof i || 'number' == typeof i
                                        ? r.push(...X(String(i), t, n))
                                        : r.push({ blockType: O.Binding, colorTag: t, childList: [i] });
                                },
                            ),
                            r
                        );
                    ...
                    uu = (u, e = {}, t) => {
                        ...
                        const n = ((u) => {
                            ...
                            return (
                                u.forEach((u) => {
                                    u.blockType === O.NoBreakSymbol
                                        ? ((t = !0), e.push(...J(e.pop(), u)))
                                        : (t ? e.push(...J(e.pop(), u)) : e.push(u), (t = !1));
                                }),
                                e
                            );
                        })(
                            ...
                            })(x(u).replace(/&zwnbsp;/g, '\ufeff'), e, t),
                        );
                        return H(n);
                    },
                    eu = (u, e) => !u || u.offsetTop + u.offsetHeight > e,
                    ...
                    ru = (u, e, t, n, r, o) => {
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            if (F === O.LineBreak || F === O.NewLine || F === O.Binding) continue;
                            ...
                            }
                            {
                                const u = t.children,
                                    F = e[E],
                                    c = F.props.children,
                                    l = ru(u, c, u.length - 1, n, r, o),
                                    d = l[0],
                                    D = l[1];
                                if (!(d < 0)) {
                                    const u = c.slice(0, d);
                                    ((s = a().cloneElement(F, F.props, u, D)), (i = E));
                                    break;
                                }
                                r -= A.length;
                            }
                        ...
                        const E = o.children,
                            F = ((u, e) => {
                                ...
                                for (; n - t >= 0;) {
                                    ...
                                    eu(u[r], e) ? (n = r - 1) : (t = r + 1);
                                }
                                return t - 1;
                            })(E, i);
                        if (F < 0) return [r, !1];
                        const A = ru(E, r, F, a, n.length, n),
                            c = A[0],
                            l = A[1];
                    ...
                    iu = a().memo(
                        ({
                            ...
                            const d = (0, i.useRef)(null),
                                ...
                                _ = B[0],
                                C = B[1],
                                p = (0, i.useMemo)(() => uu(u, n, { justifyContent: A }), [n, A, u]),
                                h = (0, i.useMemo)(() => {
                                    if (
                                        o &&
                                        _.isTruncated &&
                    ...
                    au = {
                        base: 'ExperienceStepperTooltipApp_base_e96fb',
                        controlsText: 'ExperienceStepperTooltipApp_controlsText_defa3',
                        controlsImg: 'ExperienceStepperTooltipApp_controlsImg_ec88b',
                        pageUpImg: 'ExperienceStepperTooltipApp_pageUpImg_acfde',
                        pageDownImg: 'ExperienceStepperTooltipApp_pageDownImg_c1e48',
                    },
                    su = () =>
                        a().createElement(
                            'div',
                            ...
                            a().createElement(iu, {
                                ...
                                binding: {
                                    controlsImg: a().createElement('div', { className: r()(au.img, au.controlsImg) }),
                                },
                            ...
                            a().createElement(iu, {
                                ...
                                binding: {
                                    pgupImg: a().createElement('div', { className: r()(au.img, au.pageUpImg) }),
                                    pgdownImg: a().createElement('div', { className: r()(au.img, au.pageDownImg) }),
                                },
                            }),
                        );
                engine.whenReady.then(() => {
                    l().render(
                        a().createElement(A, null, a().createElement(su, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [9056], () => __webpack_require__(2161));
