(() => {
    ...
    var __webpack_modules__ = {
            ...
            7119: (u, e, t) => {
                ...
                const F = r().forwardRef(function (u, e) {
                    let t = u.children,
                        i = u.className,
                        o = u.theme,
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            A({}, F, {
                                className: s()(c.base, c[`base__theme-${a}`], i),
                                ref: function (u) {
                ...
                let _ = (function (u) {
                    ...
                    D = (function (u) {
                        return ((u.None = 'none'), (u.Ordinary = 'ordinary'), (u.Extra = 'extra'), u);
                    })({});
                const B = {
                ...
                const m = r().memo(function ({ iconName: u, size: e = C.c24x24, className: t }) {
                        var n;
                        const i = null == (n = R.images.gui.maps.icons.tankmen.skills.$dyn(e)) ? void 0 : n.$dyn(u);
                        return r().createElement('div', {
                            style: null !== i ? { backgroundImage: `url(${i})` } : void 0,
                            className: s()(B.base, B[`base__${e}`], t),
                        });
                    }),
                    p = 'Divided_base_ae250',
                    f = 'Divided_divider_f79f3',
                    v = (0, n.memo)(({ children: u, classNames: e }) =>
                        r().createElement(
                            'div',
                            { className: p },
                            u,
                            r().createElement('div', { className: s()(f, null == e ? void 0 : e.divider) }),
                        ),
                    ),
                    b = 'default_asterisk_d5cca',
                    h = 'default_zeroPerk_ef8d6',
                    g = 'HeaderSection_base_f7cc8',
                    w = 'HeaderSection_image_e105b',
                    y = 'HeaderSection_textContainer_a82a1',
                    k = 'HeaderSection_title_e81ed',
                    x = 'HeaderSection_subtitle_e0a84',
                    T = (0, n.memo)(({ userName: u, iconName: e, skillType: t, withAsterisk: n = !1 }) =>
                        r().createElement(
                            v,
                            null,
                            r().createElement(
                                'div',
                                { className: g },
                                e && r().createElement(m, { iconName: e, className: w, size: C.c52x52 }),
                                r().createElement(
                                    'div',
                                    { className: y },
                                    ...
                                    t &&
                                        r().createElement(
                                            ...
                                            t === _.Situational && n && r().createElement('div', { className: b }),
                                        ),
                                ),
                            ),
                        ),
                        ...
                        const v = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            h = (0, n.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (P(t, d, { isMouseEvent: !0, on: !0, arguments: N(r) }, b),
                                    m && m(),
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onClick: ((u) => (e) => {
                                              (!1 === A && g(), null == s || s(e), null == u || u(e));
                                          })(e.props.onClick),
                                          onMouseDown: ((u) => (e) => {
                                              (!1 === A && g(), null == a || a(e), null == u || u(e));
                                          })(e.props.onMouseDown),
                                      },
                                      f,
                                  ),
                ...
                const q = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return r().createElement(z, e, n);
                    const i = e.contentId;
                    return i ? r().createElement(L, G({}, e, { contentId: i }), n) : r().createElement(j, e, n);
                };
                var H = t(1311);
                const K = {
                    ...
                    Z =
                        ...
                        (u) => {
                            return (
                                ...
                                (t = { value: u }),
                                e.replace(/\{\w+\}/g, (u) => String(t[u.slice(1, -1)]))
                            );
                            var e, t;
                        });
                let Y = (function (u) {
                ...
                const J = { [Q.NBSP]: Y.NoBreakSymbol, [Q.ZWNBSP]: Y.NoBreakSymbol, [Q.NEW_LINE]: Y.LineBreak },
                    ...
                    tu = 'renderers_noBreakWrapper_d986b',
                    nu = 'renderers_lineBreak_f90ed',
                    ru = 'renderers_newLine_ee778',
                    iu = 'renderers_word_ac32d',
                    ou = (u) => ({ color: `#${u}` }),
                    au = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? eu[n]
                                ? r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: s()(iu, eu[n]) },
                                      u,
                                  )
                                : r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: iu, style: ou(n) },
                                      u,
                                  )
                            : r().createElement('span', { key: t, 'data-block-type': e.blockType, className: iu }, u);
                    },
                    su = {
                        [Y.Word]: au,
                        [Y.NoBreakSymbol]: au,
                        [Y.Binding]: ({ elementList: u, textBlock: e, key: t }) =>
                            r().createElement(
                                'span',
                        ...
                        [Y.LineBreak]: ({ key: u }) =>
                            r().createElement('span', { key: u, 'data-block-type': Y.LineBreak, className: nu }),
                        [Y.NewLine]: ({ elementList: u, key: e }) =>
                            r().createElement('span', { key: e, 'data-block-type': Y.NewLine, className: ru }, u),
                        [Y.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            r().createElement(
                                'span',
                                { key: e, 'data-block-type': Y.NoBreakWrapper, className: tu },
                                u,
                            ),
                    },
                    lu = (u, e, t) => {
                    ...
                    du = uu
                        ...
                        : (u, e) => {
                              ...
                              let i = 0;
                              for (; n; ) {
                                  const o = e.justifyContent === X.FlexEnd ? n.index : t.lastIndex;
                    ...
                    _u = (u, e = '', t) => {
                        ...
                        return (
                            Eu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    n.push({ blockType: Y.Word, colorTag: e, childList: du(u, t) });
                                },
                                (u) => {
                                    const t = u[0],
                                        r = J[t.charAt(0)];
                            ...
                            Eu(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof o || 'number' == typeof o
                                        ? r.push(..._u(String(o), t, n))
                                        : r.push({ blockType: Y.Binding, colorTag: t, childList: [o] });
                                },
                            ),
                            r
                        );
                    ...
                    Bu = (u, e) => {
                        ...
                        if (u.blockType === Y.NoBreakWrapper) (u.childList.push(n), t.push(u));
                        else {
                            const e = Object.assign({}, u, { childList: u.childList.splice(-1) });
                            (u.childList.length > 0 && t.push(u),
                                t.push({ blockType: Y.NoBreakWrapper, colorTag: '', childList: [e, n] }));
                        }
                    ...
                    mu = (u, e) => !u || u.offsetTop + u.offsetHeight > e,
                    ...
                    vu = (u, e, t, n, i, o) => {
                        ...
                        for (let l = t; l >= 0; l--) {
                            ...
                            if (c === Y.LineBreak || c === Y.NewLine || c === Y.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const F = E.slice(0, E.length - A) + o,
                                    d = e[l];
                                ((s = r().cloneElement(d, d.props, F)), (a = l));
                                break;
                            }
                            {
                                const u = t.children,
                        ...
                        const l = i.children,
                            c = ((u, e) => {
                                ...
                                for (; n - t >= 0; ) {
                                    ...
                                    mu(u[r], e) ? (n = r - 1) : (t = r + 1);
                                }
                                return t - 1;
                            })(l, o);
                        if (c < 0) return [r, !1];
                        const E = vu(l, r, c, a, n.length, n),
                            A = E[0],
                            F = E[1];
                    ...
                    hu = r().memo(
                        ({
                            ...
                            customTooltipArgs: l,
                            targetId: c,
                            justifyContent: E = X.FlexStart,
                            alignContent: A = X.FlexStart,
                            truncateIdentify: F = '...',
                        }) => {
                            const d = (0, n.useRef)(null),
                                ...
                                B = D[0],
                                C = D[1],
                                m = (0, n.useMemo)(() => Cu(u, i, { justifyContent: E }), [i, E, u]),
                                p = (0, n.useMemo)(() => {
                                    if (
                                        o &&
                                        B.isTruncated &&
                            ...
                            return (
                                ...
                                r().createElement(
                                    ...
                                    r().createElement('div', { className: K.unTruncated, ref: d }, m),
                                    r().createElement(
                                        q,
                                        {
                                            tooltipArgs: p,
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: s()(
                                                    K.truncated,
                                                    !B.isTruncateFinished && a && K.truncated__hide,
                                                ),
                                                style: v,
                                            },
                    ...
                    gu = 'TooltipAdvancedFooter_base_b214f',
                    wu = 'TooltipAdvancedFooter_altBtn_e7239',
                    yu = r().memo(function ({ classMix: u }) {
                        return r().createElement(
                            'div',
                            { className: s()(gu, u) },
                            r().createElement('div', { className: wu }),
                            r().createElement('div', null, R.strings.tooltips.advanced.info()),
                        );
                    });
                function ku() {}
                function xu(u) {
                ...
                const Mu = ((u, e) => {
                                ...
                                const c = (0, n.useRef)([]),
                                    E = (t, n, r) => {
                                        ...
                                        const o = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, i) => {
                                                        const a = 'string' == typeof i ? `${n}.${i}` : n,
                                                            s = l.O.view.addModelObserver(a, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Su(r.keys()); !(u = t()).done; ) i(u.value, e);
                                                    },
                                                    unsubscribe: i,
                                                };
                                            })(n),
                                            ...
                                            F = { mode: t, model: A, externalModel: a, cleanup: E };
                                        return {
                                            model: A,
                                    ...
                                    d = F[0],
                                    _ = F[1],
                                    D = (0, n.useState)(() => E(i, o, s)),
                                    B = D[0],
                                    C = D[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        A.current ? C(E(d, o, s)) : (A.current = !0);
                                    }, [s, d, o]),
                                    (0, n.useEffect)(() => {
                                        _(i);
                                    }, [i]),
                        ...
                        const e = Object.assign(
                                ...
                                u.primitives([
                                    ...
                                    'realLevel',
                                    'isGroupSkill',
                                    'isAdvancedTooltipEnable',
                                    'isZero',
                                    'isIrrelevant',
                                    'isAnyMemberWithLowEfficiency',
                                    'isAnyMemberUntrained',
                                    'description',
                                    'efficiency',
                                    'boosterType',
                                ]),
                            ...
                            t = (0, Ru.Om)(() => Lu(e.boosters.get(), xu), { equals: Tu }),
                            n = (0, Ru.Om)(() => -1 === e.efficiency.get() && e.boosterType.get() === D.None, {
                                equals: Tu,
                            }),
                            r = (0, Ru.Om)(() => -1 === e.efficiency.get(), { equals: Tu }),
                            i = (0, Ru.Om)(() => e.efficiency.get() < 1, { equals: Tu });
                    ...
                    Iu = Mu[0],
                    ju = Mu[1],
                    Vu = 'EfficiencyInfo_base_fa427',
                    Wu = 'EfficiencyInfo_container_ba56f',
                    Uu = 'EfficiencyInfo_icon_b66c0',
                    zu = 'EfficiencyInfo_percent_bde34',
                    Gu = (0, n.memo)(({ efficiencyValue: u, isUntrained: e }) =>
                        r().createElement(
                            v,
                            null,
                            r().createElement(
                                ...
                                e
                                    ? r().createElement(
                                          ...
                                          r().createElement(
                                              'div',
                                              null,
                                              R.strings.tooltips.perks.efficiency.untrained(),
                                          ),
                                      )
                                    : r().createElement(
                                          'div',
                                          null,
                                          r().createElement(hu, {
                                              text: R.strings.tooltips.perks.efficiency.reduced(),
                                              justifyContent: X.Center,
                                              binding: {
                                                  value: r().createElement(
                                                      'div',
                                                      { className: zu },
                                                      Z(O.Z5.getNumberFormat(100 * u, O.B3.INTEGRAL)),
                                                  ),
                                              },
                                          }),
                                      ),
                    ...
                    qu = 'ExtraInfo_base_cf712',
                    Hu = 'ExtraInfo_situationalBlock_d8c74',
                    Ku = 'ExtraInfo_asterisk_b56d3',
                    $u = 'ExtraInfo_situationalText_c5852',
                    Zu = 'ExtraInfo_zeroPerkBlock_e2293',
                    Yu = 'ExtraInfo_zeroPerkIcon_b48d3',
                    Xu = (0, n.memo)(({ skillType: u, isZeroPerk: e }) => {
                        const t = _.Situational === u;
                        return t || e
                            ? r().createElement(
                                  v,
                                  null,
                                  r().createElement(
                                      ...
                                      t &&
                                          r().createElement(
                                              'div',
                                              { className: Hu },
                                              r().createElement('div', { className: s()(b, Ku) }),
                                              r().createElement(
                                                  'div',
                                                  { className: $u },
                                                  R.strings.tooltips.perkType.info.situational(),
                                              ),
                                          ),
                                      e &&
                                          r().createElement(
                                              'div',
                                              { className: Zu },
                                              r().createElement('div', { className: s()(h, Yu) }),
                                              R.strings.tooltips.perks.zeroPerkInfo(),
                                          ),
                                  ),
                              )
                            : null;
                    }),
                    Qu = 'InstructionInfo_base_a4e75',
                    Ju = 'InstructionInfo_icon_ffe1a',
                    ue = 'InstructionInfo_text_f1ad9',
                    ee = (0, n.memo)(({ boosterType: u }) => {
                        const e = u === D.Extra,
                            t = e
                                ? R.strings.tooltips.perks.fullWithDirective()
                                : R.strings.tooltips.perks.notFullWithDirective(),
                            n = e
                                ? R.images.gui.maps.icons.tooltip.boosterIcon2()
                                : R.images.gui.maps.icons.tooltip.boosterIcon1();
                        return r().createElement(
                            v,
                            null,
                            r().createElement(
                                'div',
                                { className: Qu },
                                r().createElement('div', { className: Ju, style: { backgroundImage: `url(${n})` } }),
                                r().createElement('div', { className: ue }, t),
                            ),
                        );
                    }),
                    te = {
                        base: 'SkillsSection_base_b6674',
                        skillsList: 'SkillsSection_skillsList_d68e9',
                        skill: 'SkillsSection_skill_a8001',
                        skillValue: 'SkillsSection_skillValue_ad9c0',
                        skillValue__positive: 'SkillsSection_skillValue__positive_de5a6',
                        skillValue__neutral: 'SkillsSection_skillValue__neutral_cfaff',
                        skillText: 'SkillsSection_skillText_fb845',
                    },
                    ne = r().memo(
                        ({
                            skills: u,
                            ...
                            isLowEfficiency: t,
                            isGroupSkill: n,
                            isAnyMemberWithLowEfficiency: i,
                            isAnyMemberUntrained: o,
                        }) =>
                            r().createElement(
                                v,
                                null,
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: te.skillsList },
                                        Lu(u, ({ value: u, text: e, impact: t }, n) =>
                                            r().createElement(
                                                'div',
                                                { key: n, className: te.skill },
                                                r().createElement(
                                                    'div',
                                                    { className: s()(te.skillValue, te[`skillValue__${t}`]) },
                                                    $(u),
                                                ),
                                                r().createElement('div', { className: te.skillText }, e),
                                            ),
                                        ),
                                    ),
                                ),
                    ...
                    re = 'MainContentSection_description_b91ee',
                    ie = 'MainContentSection_irrelevant_e2259',
                    oe = (0, d.Pi)(() => {
                        const u = ju().model,
                            e = u.level.get(),
                            t = u.realLevel.get(),
                            n = u.skillType.get(),
                            i = u.boosterType.get(),
                            o = u.isIrrelevant.get(),
                            a = u.computes.isUntrained(),
                            s = u.computes.isLowEfficiency(),
                            l = i !== D.None,
                            c =
                                !(o || a) &&
                                !(t > 100 && s) &&
                                ((e > 0 && e < 100) ||
                                    ((s || u.isAnyMemberWithLowEfficiency.get() || u.isAnyMemberUntrained.get()) &&
                                        !l));
                        return r().createElement(
                            r().Fragment,
                            null,
                            r().createElement(
                                v,
                                null,
                                r().createElement(hu, { classMix: re, text: u.description.get() }),
                            ),
                            c &&
                                r().createElement(ne, {
                                    skills: u.computes.boosters(),
                                    level: e,
                                    isLowEfficiency: s,
                            ...
                            r().createElement(Xu, { skillType: n, isZeroPerk: u.isZero.get() }),
                            o &&
                                r().createElement(
                                    v,
                                    null,
                                    r().createElement('div', { className: ie }, R.strings.tooltips.perks.irrelevant()),
                                ),
                            s &&
                                !(l || o) &&
                                r().createElement(Gu, { isUntrained: a, efficiencyValue: u.efficiency.get() }),
                            l && r().createElement(ee, { boosterType: i }),
                            u.isAdvancedTooltipEnable.get() && r().createElement(yu, null),
                        );
                    }),
                    ae = 'ErrorBackground_base_ec893',
                    se = () => r().createElement('div', { className: ae }),
                    le = 'CrewPerksApp_base_ae965',
                    ce = (0, d.Pi)(function () {
                        const u = ju().model;
                        return r().createElement(
                            F,
                            ...
                            r().createElement(
                                'div',
                                { className: le },
                                u.computes.isDisabled() && !u.isIrrelevant.get() && r().createElement(se, null),
                                r().createElement(T, {
                                    userName: u.userName.get(),
                                    iconName: u.iconName.get(),
                                    skillType: u.skillType.get(),
                                    withAsterisk: !0,
                                }),
                ...
                engine.whenReady.then(() => {
                    o().render(
                        r().createElement(Iu, null, r().createElement(ce, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [9056], () => __webpack_require__(7119));
