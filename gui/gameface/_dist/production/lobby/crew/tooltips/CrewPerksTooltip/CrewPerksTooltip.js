(() => {
    var __webpack_modules__ = {
            ...
            1829: (u, e, t) => {
                ...
                const _ = 'Divided_base_06',
                    m = 'Divided_divider_64',
                    C = (0, r.memo)(({ children: u, classNames: e }) =>
                        n().createElement(
                            'div',
                            { className: _ },
                            u,
                            n().createElement('div', { className: E()(m, null == e ? void 0 : e.divider) }),
                        ),
                    ),
                    h = 'default_asterisk_d6',
                    g = 'default_zeroPerk_bb',
                    p = 'HeaderSection_base_f2',
                    f = 'HeaderSection_image_2d',
                    v = 'HeaderSection_textContainer_7d',
                    b = 'HeaderSection_title_b8',
                    w = 'HeaderSection_subtitle_a6',
                    x = (0, r.memo)(({ title: u, icon: e, skillType: t, withAsterisk: r = !1 }) =>
                        n().createElement(
                            C,
                            null,
                            n().createElement(
                                ...
                                { className: p },
                                e &&
                                    n().createElement('div', { className: f, style: { backgroundImage: `url(${e})` } }),
                                n().createElement(
                                    'div',
                                    { className: v },
                                    ...
                                    n().createElement(
                                        ...
                                        t === d.Situational && r && n().createElement('div', { className: h }),
                                    ),
                                ),
                            ),
                        ),
                ...
                const O = l.O.client.getSize('rem'),
                    N = O.width,
                    P = O.height,
                    H = Object.assign({ width: N, height: P }, M(N, P, L)),
                    I = (0, r.createContext)(H),
                    W = ['children'];
                const j = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    const n = (0, r.useContext)(I),
                        ...
                        h = { extraLarge: B, large: d, medium: _, small: m, extraSmall: C };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && s) return T(e, t, h);
                        if (t.largeWidth && A) return T(e, t, h);
                ...
                (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(I),
                        ...
                        o = (0, r.useCallback)((u, e) => {
                            ...
                            i(Object.assign({ width: t, height: r }, M(t, r, L)));
                        }, []);
                    G(() => {
                    ...
                    return n().createElement(I.Provider, { value: E }, u);
                });
                let U, V, X;
                !(function (u) {
                ...
                const eu = {
                    ...
                    nu = Z((u) => {
                        let e = u.className,
                            ...
                            _ = u.row,
                            m = u.flexDirection,
                            C = void 0 === m ? (d ? 'column' : _ && 'row') || void 0 : m,
                            h = u.flexStart,
                            g = u.center,
                            p = u.flexEnd,
                            f = u.spaceBetween,
                        ...
                        const W = (0, r.useMemo)(() => {
                                const u = { mt: l, mr: A, mb: c, ml: B },
                                    ...
                                    r = ((u) =>
                                        tu.reduce((e, t) => {
                                            const r = u[t];
                                            return 'number' == typeof r && (e[ru[t]] = r + 'rem'), e;
                                        }, {}))(u);
                                return {
                            ...
                            }, [t, a, l, A, c, B, P, N, y, C, k, w, S]),
                            j = W.computedStyle,
                            G = W.computedClassNames;
                        return n().createElement('div', uu({ className: E()(Q.base, ...G, e), style: j }, I), H);
                    });
                let au;
                !(function (u) {
                ...
                const iu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    lu = (u, e, t = au.left) => u.split(e).reduce(t === au.left ? ou : Eu, []),
                    su = (() => {
                        const u = new RegExp(
                        ...
                        return Au.includes(t)
                            ...
                            : ((u, e = au.left) => {
                                  ...
                                  const r =
                                      ...
                                      n = iu(u);
                                  return lu(n, /( )/, e).forEach((u) => (t = t.concat(lu(u, r, au.left)))), t;
                              })(u, e);
                    },
                    cu = 'FormatText_base_d0',
                    Du = ({ binding: u, text: e = '', classMix: t, alignment: a = au.left }) =>
                        null === e
                ...
                const hu = Object.keys(du()),
                    ...
                    xu = Z((u) => {
                        ...
                        return n().createElement(
                            ...
                            Cu(
                                {
                                    className: E()(_u.base, t && _u[t], p, a),
                                    style: g,
                            ...
                            void 0 !== m ? n().createElement(Du, Cu({}, m, { text: e })) : e,
                        );
                    });
                var Su = t(4179);
                const yu = [
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Lu(t, D, { isMouseEvent: !0, on: !0, arguments: Tu(n) }, f),
                                    C && C(),
                ...
                const ju = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return n().createElement(Iu, e, r);
                    const a = e.contentId,
                        i = e.args,
                        o = null == i ? void 0 : i.contentId;
                    return a || o
                        ? n().createElement(ku, Wu({}, e, { contentId: a || o }), r)
                        : n().createElement(Ru, e, r);
                };
                var Gu = t(8045);
                ...
                const Qu = { [Zu.NBSP]: Yu.NoBreakSymbol, [Zu.ZWNBSP]: Yu.NoBreakSymbol, [Zu.NEW_LINE]: Yu.LineBreak },
                    ...
                    ne = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return r
                            ? Ju[r]
                                ...
                                : n().createElement('span', { key: t, 'data-block-type': e.blockType, style: re(r) }, u)
                    ...
                    ae = {
                        ...
                        [Yu.LineBreak]: ({ key: u }) =>
                            n().createElement('span', { key: u, 'data-block-type': Yu.LineBreak, className: ee }),
                        [Yu.NewLine]: ({ elementList: u, key: e }) =>
                            n().createElement('span', { key: e, 'data-block-type': Yu.NewLine, className: te }, u),
                    ...
                    se = (u, e = '') => {
                        ...
                        return (
                            Ee(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: Yu.Word, colorTag: e, childList: le(u) });
                                },
                                (u) => {
                                    const r = u[0],
                                        n = Qu[r.charAt(0)];
                            ...
                            Ee(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof a || 'number' == typeof a
                                        ...
                                        : r.push({ blockType: Yu.Binding, colorTag: t, childList: [a] });
                                },
                            ),
                            r
                        );
                    ...
                    Fe = (u, e) => {
                        ...
                        if (u.blockType === Yu.NoBreakWrapper) u.childList.push(r), t.push(u);
                        else {
                            const e = Object.assign({}, u, { childList: u.childList.splice(-1) });
                            u.childList.length > 0 && t.push(u),
                                t.push({ blockType: Yu.NoBreakWrapper, colorTag: '', childList: [e, r] });
                        }
                    ...
                    ce = (u, e = {}) => {
                        ...
                        const t = ((u) => {
                            ...
                            })(iu(u).replace(/&zwnbsp;/g, '\ufeff'), e),
                        );
                        return oe(t);
                    },
                    De = (u, e) => !u || u.offsetTop + u.offsetHeight > e,
                    Be = (u, e) => u.offsetLeft + u.offsetWidth - e,
                    de = (u, e, t) => {
                    ...
                    _e = (u, e, t, r, a, i) => {
                        ...
                        for (let l = t; l >= 0; l--) {
                            const t = u[l],
                                s = Number(u[l].getAttribute('data-block-type'));
                            if (s === Yu.LineBreak || s === Yu.NewLine || s === Yu.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const c = A.slice(0, A.length - F) + i,
                                    D = e[l];
                                (E = n().cloneElement(D, D.props, c)), (o = l);
                                break;
                            }
                            {
                                const u = t.children,
                                    s = e[l],
                                    F = s.props.children,
                                    c = _e(u, F, u.length - 1, r, a, i),
                                    D = c[0],
                                    B = c[1];
                                if (!(D < 0)) {
                                    const u = F.slice(0, D);
                                    (E = n().cloneElement(s, s.props, u, B)), (o = l);
                                    break;
                                }
                                a -= A.length;
                            }
                    ...
                    Ce = n().memo(
                        ({
                            ...
                            targetId: l,
                            justifyContent: s = $u.FlexStart,
                            alignContent: A = $u.FlexStart,
                            truncateIdentify: F = '...',
                        }) => {
                            const c = (0, r.useRef)(null),
                                ...
                                }, [a, i, l, u, d.isTruncated]),
                                h = (0, r.useCallback)(
                                    (u) => {
                                        (D.current.width = u.contentRect.width),
                                            (D.current.height = u.contentRect.height);
                                        const e = me(c, m, D.current, F),
                                            r = e[0],
                                            n = e[1];
                                        _({ elementList: r, isTruncated: n, isTruncateFinished: !0 }), t && t(n);
                                    },
                                    [t, F, m],
                                ),
                                g = (0, r.useMemo)(() => ({ justifyContent: s, alignContent: A }), [A, s]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                n().createElement(
                                    'div',
                                    { className: E()(Uu, e, Vu, o && Xu), style: g },
                                    n().createElement('div', { className: qu, ref: c }, m),
                                    n().createElement(
                                        ju,
                                        { tooltipArgs: C },
                                        n().createElement(
                    ...
                    he = 'TooltipAdvancedFooter_base_d6',
                    ge = 'TooltipAdvancedFooter_altBtn_e0',
                    pe = n().memo(function ({ classMix: u }) {
                        return n().createElement(
                            'div',
                            { className: E()(he, u) },
                            n().createElement('div', { className: ge }),
                            n().createElement('div', null, R.strings.tooltips.advanced.info()),
                        );
                    });
                function fe() {}
                function ve(u) {
                ...
                const ke = ((u, e) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: i, children: o, mocks: E }) {
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        F.current ? m(A(D, i, E)) : (F.current = !0);
                                    }, [E, D, i]),
                                    (0, r.useEffect)(() => {
                                        B(a);
                                    }, [a]),
                        ...
                        const e = Object.assign(
                            ...
                            t = (0, Le.Om)(() => Te(e.boosters.get(), ve), { equals: be });
                        return Object.assign({}, e, { computes: { boosters: t } });
                    }, fe),
                    Me = ke[0],
                    Oe = ke[1],
                    Re = {
                        base: 'SkillsSection_base_d2',
                        skillsList: 'SkillsSection_skillsList_02',
                        skill: 'SkillsSection_skill_8c',
                        skillValue: 'SkillsSection_skillValue_42',
                        skillValue__positive: 'SkillsSection_skillValue__positive_24',
                        skillValue__neutral: 'SkillsSection_skillValue__neutral_97',
                        skillText: 'SkillsSection_skillText_7d',
                    },
                    Ne = n().memo(function ({ skillType: u, skills: e }) {
                        const t =
                            u === d.Common
                                ? R.strings.tooltips.perks.fullGroupSkillTitle()
                                : R.strings.tooltips.perks.fullSkillTitle();
                        return n().createElement(
                            C,
                            null,
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    { className: Re.skillsList },
                                    Te(e, ({ value: u, text: e, impact: t }, r) =>
                                        n().createElement(
                                            'div',
                                            { key: r, className: Re.skill },
                                            n().createElement(
                                                'div',
                                                { className: E()(Re.skillValue, Re[`skillValue__${t}`]) },
                                                iu(u),
                                            ),
                                            n().createElement('div', { className: Re.skillText }, e),
                                        ),
                                    ),
                                ),
                            ),
                    ...
                    Pe = 'TypeInfo_base_9e',
                    He = 'TypeInfo_asterisk_97',
                    Ie = 'TypeInfo_conditionalText_93',
                    We = 'TypeInfo_commonIcon_48',
                    je = 'TypeInfo_commonText_53',
                    Ge = ({ skillType: u, isCommonExtraAvailable: e }) => {
                        switch (!0) {
                            case d.Situational === u:
                                return n().createElement(
                                    'div',
                                    { className: Pe },
                                    n().createElement('div', { className: E()(h, He) }),
                                    n().createElement(
                                        'div',
                                        { className: Ie },
                            ...
                            case d.Common === u && e:
                                return n().createElement(
                                    ...
                                    n().createElement(Ce, {
                                        text: R.strings.tooltips.perkType.info.common(),
                                        classMix: je,
                                    }),
                                );
                            default:
                        ...
                        u === d.Situational || (u === d.Common && e) || t
                            ? n().createElement(
                                  ...
                                  n().createElement(
                                      'div',
                                      { className: Ue },
                                      n().createElement(Ge, { skillType: u, isCommonExtraAvailable: e }),
                                      t &&
                                          n().createElement(
                                              'div',
                                              { className: Ve },
                                              n().createElement('div', { className: E()(g, Xe) }),
                    ...
                    Ze = 'MainContentSection_alertDescriptionText_64',
                    Qe = 'MainContentSection_irrelevant_99',
                    Je = R.strings.tooltips.perks,
                    ut = (0, B.Pi)(() => {
                        const u = Oe().model,
                            e = u.level.get(),
                            t = u.skillType.get(),
                            r = u.alertDescription.get();
                        return n().createElement(
                            n().Fragment,
                            null,
                            n().createElement(
                            ...
                            r &&
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(xu, { text: Je.warning(), className: $e }),
                                    ),
                            ...
                            u.isIrrelevant.get() &&
                                n().createElement(
                                    C,
                                    null,
                                    n().createElement('div', { className: Qe }, Je.irrelevant()),
                                ),
                            u.isAdvancedTooltipEnable.get() && n().createElement(pe, null),
                        );
                    }),
                    et = 'CrewPerksApp_base_b3',
                    tt = (0, B.Pi)(function () {
                        const u = Oe().model;
                        return n().createElement(
                            D,
                ...
                engine.whenReady.then(() => {
                    i().render(
                        n().createElement(Me, null, n().createElement(tt, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(1829));
