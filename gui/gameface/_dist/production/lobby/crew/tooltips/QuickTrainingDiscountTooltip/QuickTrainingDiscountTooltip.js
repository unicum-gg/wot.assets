(() => {
    ...
    var __webpack_modules__ = {
            ...
            7654: (u, e, t) => {
                ...
                const I = 'ExtendedText_base_71',
                    ...
                    V = 'ExtendedText_base__isTruncationAvailable_5b',
                    W = 'ExtendedText_truncated_97',
                ...
                const Y = { [X.NBSP]: K.NoBreakSymbol, [X.ZWNBSP]: K.NoBreakSymbol, [X.NEW_LINE]: K.LineBreak },
                    Z = {
                ...
                const vu = ((u, e) => {
                    ...
                    bu = vu[0],
                    fu = vu[1],
                    wu = 'QuickTrainingDiscountTooltipApp_base_88',
                    yu = 'QuickTrainingDiscountTooltipApp_title_e8',
                    ku = 'QuickTrainingDiscountTooltipApp_label_d9',
                    Tu = (u, e, t) =>
                        a().createElement(Du, {
                            classMix: ku,
                            text: u,
                            binding: {
                                freeXp: a().createElement(m, { type: 'freeXP', size: 'small', value: e, isEnough: !0 }),
                                xp: a().createElement(m, { type: 'xp', size: 'small', value: t, isEnough: !0 }),
                            },
                        }),
                    Ou = () => {
                        const u = fu().model;
                        return a().createElement(
                            'div',
                            { className: wu },
                            a().createElement('div', { className: yu }, R.strings.crew_books.tooltip.sale.header()),
                            Tu(
                ...
                engine.whenReady.then(() => {
                    _().render(
                        a().createElement(A, null, a().createElement(bu, null, a().createElement(Ou, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(7654));
