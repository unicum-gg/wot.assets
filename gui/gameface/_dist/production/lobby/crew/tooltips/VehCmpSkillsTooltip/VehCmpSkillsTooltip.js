(() => {
    ...
    var __webpack_modules__ = {
            ...
            540: (u, e, t) => {
                ...
                const O = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return s().createElement(k, e, n);
                    const r = e.contentId,
                        o = e.args,
                        i = null == o ? void 0 : o.contentId;
                    return r || i
                        ? s().createElement(h, T({}, e, { contentId: r || i }), n)
                        : s().createElement(f, e, n);
                };
                var x = t(8045);
                const S = 'ExtendedText_base_71',
                    P = 'ExtendedText_base__zeroPadding_25',
                    L = 'ExtendedText_base__isTruncationAvailable_5b',
                    N = 'ExtendedText_truncated_97',
                    M = 'ExtendedText_truncated__hide_31',
                    I = 'ExtendedText_unTruncated_b8';
                let V;
                !(function (u) {
                ...
                const q = { [H.NBSP]: W.NoBreakSymbol, [H.ZWNBSP]: W.NoBreakSymbol, [H.NEW_LINE]: W.LineBreak },
                    ...
                    Z = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ...
                            : s().createElement('span', { key: t, 'data-block-type': e.blockType }, u);
                    },
                    X = {
                        [W.Word]: Z,
                        [W.NoBreakSymbol]: Z,
                        ...
                        [W.LineBreak]: ({ key: u }) =>
                            s().createElement('span', { key: u, 'data-block-type': W.LineBreak, className: G }),
                    ...
                    tu = (u, e = '') => {
                        ...
                        return (
                            uu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: W.Word, colorTag: e, childList: eu(u) });
                                },
                                (u) => {
                                    const n = u[0],
                                        r = q[n.charAt(0)];
                    ...
                    iu = (u, e) => !u || u.offsetTop + u.offsetHeight > e,
                    ...
                    Eu = (u, e, t, n, r, o) => {
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            if (A === W.LineBreak || A === W.NewLine || A === W.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const F = l.slice(0, l.length - c) + o,
                                    d = e[E];
                            ...
                            }
                            {
                                const u = t.children,
                                    A = e[E],
                                    c = A.props.children,
                                    F = Eu(u, c, u.length - 1, n, r, o),
                                    d = F[0],
                                    D = F[1];
                                if (!(d < 0)) {
                                    const u = c.slice(0, d);
                                    ((a = s().cloneElement(A, A.props, u, D)), (i = E));
                                    break;
                                }
                                r -= l.length;
                            }
                    ...
                    lu = s().memo(
                        ({
                            ...
                            const F = (0, i.useRef)(null),
                                ...
                                h = (0, i.useMemo)(() => ({ justifyContent: A, alignContent: l }), [l, A]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                s().createElement(
                                    'div',
                                    { className: r()(S, e, P, a && L), style: h },
                                    s().createElement('div', { className: I, ref: F }, C),
                                    s().createElement(
                                        O,
                                        { tooltipArgs: p },
                                        s().createElement(
                                            'div',
                                            { className: r()(N, !B.isTruncateFinished && a && M), style: h },
                ...
                const du = s().memo(function ({ iconName: u, size: e = Fu.c24x24, className: t }) {
                        var n;
                        return s().createElement('div', {
                            style: {
                                backgroundImage: `url(${null == (n = R.images.gui.maps.icons.tankmen.skills.$dyn(e)) ? void 0 : n.$dyn(u)})`,
                            },
                            className: r()(cu.base, cu[`base__${e}`], t),
                        });
                    }),
                    Du = R.strings.common.percentValue(),
                    Bu = (u) => {
                        return (
                            (e = { value: u }),
                            Du.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                ...
                const pu = 'Divided_base_06',
                    mu = 'Divided_divider_64',
                    hu = (0, i.memo)(({ children: u, classNames: e }) =>
                        s().createElement(
                            'div',
                            { className: pu },
                            u,
                            s().createElement('div', { className: r()(mu, null == e ? void 0 : e.divider) }),
                        ),
                    );
                function vu() {}
                function bu() {
                ...
                const ku = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: r, children: a, mocks: E }) {
                                const A = (0, i.useRef)([]),
                                    l = (t, n, r) => {
                                        ...
                                        const s = (function ({
                                            ...
                                            F = { mode: t, model: c, externalModel: a, cleanup: l };
                                        return {
                                            model: c,
                                ...
                                return (
                                    (0, i.useEffect)(() => {
                                        c.current ? C(l(d, r, E)) : (c.current = !0);
                                    }, [E, d, r]),
                                    (0, i.useEffect)(() => {
                                        D(n);
                                    }, [n]),
                    ...
                    })(({ observableModel: u }) => ({ skills: u.array('skills') }), vu),
                    Tu = ku[0],
                    Ou = ku[1],
                    xu = 'VehCmpSkillsTooltipApp_base_a2',
                    Su = 'VehCmpSkillsTooltipApp_header_56',
                    Pu = 'VehCmpSkillsTooltipApp_info_7b',
                    Lu = 'VehCmpSkillsTooltipApp_infoBg_99',
                    Nu = 'VehCmpSkillsTooltipApp_infoHeader_b0',
                    Mu = 'VehCmpSkillsTooltipApp_percentage_82',
                    Ru = 'VehCmpSkillsTooltipApp_bottom_b2',
                    Iu = 'VehCmpSkillsTooltipApp_column_03',
                    Vu = 'VehCmpSkillsTooltipApp_column__right_e8',
                    Uu = 'VehCmpSkillsTooltipApp_row_1f',
                    Wu = 'VehCmpSkillsTooltipApp_roleName_58',
                    ju = 'VehCmpSkillsTooltipApp_roleIcon_5d',
                    Hu = 'VehCmpSkillsTooltipApp_skillIcon_82',
                    qu = (0, B.Pi)(() => {
                        const u = Ou().model.skills.get();
                        return s().createElement(
                            'div',
                            { className: xu },
                            s().createElement(
                            ...
                            s().createElement(
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(lu, {
                                        text: R.strings.tooltips.vehCmpSkillsTooltip.info.text(),
                                        binding: { percentage: s().createElement('div', { className: Mu }, Bu(100)) },
                                    }),
                                ),
                            ),
                            s().createElement(
                                    ...
                                    D(u, ({ role: u }) =>
                                        s().createElement(
                                            ...
                                            s().createElement(
                                                'div',
                                                { className: Wu },
                                                R.strings.crew_perks.perkRole.$dyn(u),
                                            ),
                                        ),
                                    ),
                                ),
                ...
                engine.whenReady.then(() => {
                    d().render(
                        s().createElement(c, null, s().createElement(Tu, null, s().createElement(qu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(540));
