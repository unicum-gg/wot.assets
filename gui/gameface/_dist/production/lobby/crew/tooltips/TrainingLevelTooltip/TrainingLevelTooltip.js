(() => {
    ...
    var __webpack_modules__ = {
            ...
            7361: (u, e, t) => {
                ...
                const l = a().forwardRef(function (u, e) {
                    let t = u.children,
                        n = u.className,
                        l = u.theme,
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            F({}, D, {
                                className: r()(A.base, A[`base__theme-${c}`], n),
                                ref: function (u) {
                ...
                const m = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    v = (u, e, t = B.left) => u.split(e).reduce(t === B.left ? p : h, []),
                    f = (() => {
                        const u = new RegExp(
                        ...
                        return b.includes(t)
                            ...
                            : ((u, e = B.left) => {
                                  ...
                                  const n =
                                      ...
                                      r = m(u);
                                  return (v(r, /( )/, e).forEach((u) => (t = t.concat(v(u, n, B.left)))), t);
                              })(u, e);
                    },
                    w = 'FormatText_base_d0',
                    y = ({ binding: u, text: e = '', classMix: t, alignment: n = B.left }) =>
                        null === e
                                  ...
                                  e.split('\n').map((e, i) =>
                                      a().createElement(
                                          ...
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : g(u, e))))(e, n, u).map((u, e) =>
                                              a().createElement(o.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              ),
                    k = 'GradientDecorator_base_ee',
                    T = 'GradientDecorator_bg_21',
                    O = 'GradientDecorator_divider_13',
                    N = (0, o.memo)(({ className: u, children: e }) =>
                        a().createElement(
                            'div',
                            { className: r()(k, u) },
                            a().createElement(
                ...
                const U = ({ label: u, theme: e = V.Default, className: t, children: n }) =>
                        a().createElement(
                            'div',
                            { className: r()(I.base, I[`base__${e}`], t) },
                            a().createElement('div', { className: I.label }, u),
                            a().createElement('div', { className: I.content }, n),
                        ),
                    W = R.strings.common.percentValue(),
                    j = (u) => C(W, { value: u });
                let z;
                !(function (u) {
                ...
                const eu = (u) =>
                    ...
                    tu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: r, children: E, mocks: A }) {
                                const s = (0, o.useRef)([]),
                                    F = (t, n, r) => {
                                        var o;
                                        const a = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, o) => {
                                                        const E = 'string' == typeof o ? `${n}.${o}` : n,
                                                            A = i.O.view.addModelObserver(E, e, !0);
                                                        return (r.set(A, t), u && t(a(o)), A);
                                                    },
                                                    readByPath: a,
                                                    createCallback: (u, e) => {
                                                        const t = a(e);
                                            ...
                                            c = { mode: t, model: l, externalModel: E, cleanup: F };
                                        return {
                                            model: l,
                                    ...
                                    D = c[0],
                                    B = c[1],
                                    C = (0, o.useState)(() => F(n, r, A)),
                                    d = C[0],
                                    _ = C[1];
                                return (
                                    (0, o.useEffect)(() => {
                                        l.current ? _(F(D, r, A)) : (l.current = !0);
                                    }, [A, D, r]),
                                    (0, o.useEffect)(() => {
                                        B(n);
                                    }, [n]),
                                    ...
                                    a().createElement(t.Provider, { value: d }, E)
                                );
                            },
                            () => (0, o.useContext)(t),
                        ];
                    })(({ observableModel: u, readByPath: e }) => {
                        const t = Object.assign({}, u.primitives(['isFemale', 'nation']), {
                                roles: u.array('roles', []),
                                modifiers: u.array('modifiers', []),
                                currentVehicle: e('currentVehicle'),
                                nativeVehicle: e('nativeVehicle'),
                            }),
                            n = (0, uu.Om)(() => P(t.roles.get(), 0), { equals: $ }),
                            r = (0, uu.Om)(
                                () => {
                                    const u = L(t.roles.get(), K);
                                    return u.length <= 1 ? [] : u.slice(1);
                                },
                                { equals: $ },
                            ),
                            i = (0, uu.Om)(() => P(t.modifiers.get(), 0), { equals: $ }),
                            o = (0, uu.Om)(
                                () => M(t.modifiers.get(), (u) => Boolean(null == u ? void 0 : u.value), K).slice(1),
                                { equals: $ },
                            ),
                            a = (0, uu.Om)(
                                (u = 2) => {
                                    const e = (function (u, e, t) {
                                            if (Array.isArray(u)) return u.reduce(e, t);
                                            let n = t;
                                            for (let t = 0; t < u.length; t++) n = e(n, x(u, t), t, u);
                                            return n;
                                        })(t.modifiers.get(), (u, { value: e }) => u + e, 0),
                                        n = Math.pow(10, u);
                                    return J.Z5.getRealFormat(Math.round(e * n) / n, J.Gr.WO_ZERO_DIGITS);
                                },
                                { equals: $ },
                            ),
                            E = (0, uu.Om)(() => eu(t.nativeVehicle.tags), { equals: $ }),
                            A = (0, uu.Om)(() => eu(t.currentVehicle.tags), { equals: $ }),
                            s = (0, uu.Om)(() => Boolean(t.currentVehicle.vehicleName), { equals: $ }),
                            F = (0, uu.Om)(
                                () => Boolean(t.currentVehicle.vehicleName === t.nativeVehicle.vehicleName),
                                { equals: $ },
                            ),
                            l = (0, uu.Om)(
                                () => Boolean(t.currentVehicle.vehicleType === t.nativeVehicle.vehicleType),
                                { equals: $ },
                            ),
                            c = (0, uu.Om)(() => Boolean(!(F() || (l() && A())) && s()), { equals: $ });
                        return Object.assign({}, t, {
                            computes: {
                                ...
                                modifiers: o,
                                finalValue: a,
                                isPremiumVehicleSpecialization: E,
                                isOnPremiumVehicle: A,
                                isInVehicle: s,
                                isInNativeVehicle: F,
                                isInSameClassVehicle: l,
                                isUntrained: c,
                            },
                        });
                    }, H),
                    nu = tu[0],
                    ru = tu[1],
                    iu = 'AdditionalRoles_role_8a',
                    ou = 'AdditionalRoles_roleIcon_44',
                    au = 'AdditionalRoles_roleName_47',
                    Eu = (0, S.Pi)(({ className: u }) => {
                        const e = ru().model,
                            t = e.computes.additionalRoles();
                        return t.length
                            ? a().createElement(
                                  U,
                                  { className: u, label: R.strings.tooltips.trainingLevel.additionalQualification() },
                                  L(t, (u) =>
                                      a().createElement(
                                          'div',
                                          { className: iu, key: u },
                                          ...
                                          a().createElement('div', { className: au }, G(u, e.isFemale.get())),
                                      ),
                                  ),
                              )
                            : null;
                    ...
                    Au = 'MainRole_base_dd',
                    su = 'MainRole_roleIcon_c2',
                    Fu = 'MainRole_roleName_19',
                    lu = (0, S.Pi)(() => {
                        const u = ru().model,
                            e = u.computes.mainRole();
                        return e
                            ? a().createElement(
                                  'div',
                                  { className: Au },
                                  a().createElement('div', {
                                      className: su,
                                      style: {
                                          backgroundImage: `url(${R.images.gui.maps.icons.tankmen.roles.c_30x30.$dyn(e)})`,
                                      },
                                  }),
                                  a().createElement('div', { className: Fu }, G(e, u.isFemale.get())),
                              )
                            : null;
                    }),
                    cu = [
                        ...
                        const v = (0, o.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, o.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (Bu(t, D, { isMouseEvent: !0, on: !0, arguments: Du(n) }, f),
                                    m && m(),
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onClick: ((u) => (e) => {
                                              (!1 === l && g(), null == E || E(e), null == u || u(e));
                                          })(e.props.onClick),
                                          onMouseDown: ((u) => (e) => {
                                              (!1 === l && g(), null == a || a(e), null == u || u(e));
                                          })(e.props.onMouseDown),
                                      },
                                      h,
                                  ),
                ...
                const vu = R.views.common.tooltip_window.simple_tooltip_content,
                    fu = (u) => {
                        ...
                        const s = (0, o.useMemo)(() => {
                            const u = Object.assign({}, E, { body: t, header: n, note: r, alert: i });
                            ...
                            hu(
                                {
                                    contentId:
                                        ...
                                        F ? vu.SimpleTooltipHtmlContent('resId') : vu.SimpleTooltipContent('resId')),
                ...
                const gu = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return a().createElement(fu, e, n);
                    const r = e.contentId,
                        i = e.args,
                        o = null == i ? void 0 : i.contentId;
                    return r || o
                        ? a().createElement(Cu, bu({}, e, { contentId: r || o }), n)
                        : a().createElement(mu, e, n);
                };
                var wu = t(8045);
                const yu = 'ExtendedText_base_71',
                    ku = 'ExtendedText_base__zeroPadding_25',
                    Tu = 'ExtendedText_base__isTruncationAvailable_5b',
                    Ou = 'ExtendedText_truncated_97',
                    Nu = 'ExtendedText_truncated__hide_31',
                    Pu = 'ExtendedText_unTruncated_b8';
                let xu, Ru, Lu;
                (!(function (u) {
                    ((u[(u.Word = 0)] = 'Word'),
                ...
                const Mu = { [Lu.NBSP]: xu.NoBreakSymbol, [Lu.ZWNBSP]: xu.NoBreakSymbol, [Lu.NEW_LINE]: xu.LineBreak },
                    Su = {
                    ...
                    Vu = 'renderers_lineBreak_b5',
                    Uu = 'renderers_newLine_bd',
                    Wu = (u) => ({ color: `#${u}` }),
                    ju = ({ elementList: u, textBlock: e, key: t }) => {
                        const n = e.colorTag;
                        return n
                            ? Su[n]
                                ? a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: Su[n] },
                                      u,
                                  )
                                : a().createElement('span', { key: t, 'data-block-type': e.blockType, style: Wu(n) }, u)
                    ...
                    zu = {
                        ...
                        [xu.LineBreak]: ({ key: u }) =>
                            a().createElement('span', { key: u, 'data-block-type': xu.LineBreak, className: Vu }),
                        [xu.NewLine]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': xu.NewLine, className: Uu }, u),
                        [xu.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            a().createElement(
                                'span',
                                { key: e, 'data-block-type': xu.NoBreakWrapper, className: Iu },
                                u,
                            ),
                    },
                    qu = (u, e, t) => {
                    ...
                    $u = (u, e = '') => {
                        ...
                        return (
                            Hu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: xu.Word, colorTag: e, childList: Ku(u) });
                                },
                                (u) => {
                                    const n = u[0],
                                        r = Mu[n.charAt(0)];
                    ...
                    Zu = (u, e) => {
                        ...
                        if (u.blockType === xu.NoBreakWrapper) (u.childList.push(n), t.push(u));
                        else {
                            const e = Object.assign({}, u, { childList: u.childList.splice(-1) });
                            (u.childList.length > 0 && t.push(u),
                                t.push({ blockType: xu.NoBreakWrapper, colorTag: '', childList: [e, n] }));
                        }
                            ...
                            return (
                                u.forEach((u) => {
                                    u.blockType === xu.NoBreakSymbol
                                        ? ((t = !0), e.push(...Zu(e.pop(), u)))
                                        : (t ? e.push(...Zu(e.pop(), u)) : e.push(u), (t = !1));
                                }),
                                e
                            );
                        })(
                    ...
                    ee = (u, e, t, n, r, i) => {
                        ...
                        for (let A = t; A >= 0; A--) {
                            ...
                            if (s === xu.LineBreak || s === xu.NewLine || s === xu.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const c = F.slice(0, F.length - l) + i,
                                    D = e[A];
                                ((E = a().cloneElement(D, D.props, c)), (o = A));
                                break;
                            }
                            {
                                const u = t.children,
                                    s = e[A],
                                    l = s.props.children,
                                    c = ee(u, l, u.length - 1, n, r, i),
                                    D = c[0],
                                    B = c[1];
                                if (!(D < 0)) {
                                    const u = l.slice(0, D);
                                    ((E = a().cloneElement(s, s.props, u, B)), (o = A));
                                    break;
                                }
                                r -= F.length;
                            }
                    ...
                    te = (u, e, t, n = '...') => {
                        ...
                        if (s < 0) return [r, !1];
                        const F = ee(A, r, s, a, n.length, n),
                            l = F[0],
                            c = F[1];
                        return (c && (r.splice(l, 1, c), r.splice(l + 1)), [r, !0]);
                    },
                    ne = a().memo(
                        ({
                            text: u,
                            ...
                            const c = (0, o.useRef)(null),
                                ...
                                h = (0, o.useMemo)(() => ({ justifyContent: s, alignContent: F }), [F, s]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                a().createElement(
                                    'div',
                                    { className: r()(yu, e, ku, E && Tu), style: h },
                                    a().createElement('div', { className: Pu, ref: c }, _),
                                    a().createElement(
                                        gu,
                                        { tooltipArgs: m },
                                        a().createElement(
                                            'div',
                                            { className: r()(Ou, !C.isTruncateFinished && E && Nu), style: h },
                                            C.isTruncateFinished && E ? C.elementList : _,
                                        ),
                                    ),
                                )
                            );
                    ...
                    re = 'Modifiers_modifiers_b5',
                    ie = 'Modifiers_modifier_82',
                    oe = 'Modifiers_value_29',
                    ae = 'Modifiers_value__red_a1',
                    Ee = 'Modifiers_label_be',
                    Ae = 'Modifiers_final_f3',
                    se = 'Modifiers_finalLabel_e4',
                    Fe = 'Modifiers_finalValue_f9',
                    le = 'Modifiers_finalValue__red_2e',
                    ce = (0, S.Pi)(() => {
                        const u = ru().model,
                            e = u.computes.roleLevel();
                        return a().createElement(
                            U,
                            { label: R.strings.tooltips.trainingLevel.modifiers.label() },
                            a().createElement(
                                'div',
                                { className: re },
                                e &&
                                    a().createElement(
                                        ...
                                        a().createElement(
                                            'div',
                                            { className: r()(oe, u.computes.isUntrained() && ae) },
                                            j(e.value),
                                        ),
                                        a().createElement('div', { className: Ee }, e.reason),
                                    ),
                                L(u.computes.modifiers(), ({ value: u, reason: e }, t) =>
                                    a().createElement(
                                        'div',
                                        { className: ie, key: t },
                                        a().createElement(
                                            'div',
                                            { className: r()(oe, u < 0 && ae) },
                                            j(u > 0 ? '+' + u : u),
                                        ),
                                        a().createElement(ne, { text: e, classMix: Ee }),
                                    ),
                                ),
                            ),
                            u.computes.isInVehicle() &&
                                a().createElement(
                                    'div',
                                    { className: Ae },
                                    a().createElement(
                                        'div',
                                        { className: se },
                                        R.strings.tooltips.trainingLevel.finalValue(),
                                    ),
                                    a().createElement(
                                        'div',
                                        { className: r()(Fe, u.computes.isUntrained() && le) },
                                        j(u.computes.finalValue()),
                                    ),
                                ),
                        );
                    }),
                ...
                const Ce = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    de = (u) =>
                        Ce
                            ? `${u}`
                            : (function (u) {
                ...
                const he = ({
                        ...
                        tags: o,
                        isPremiumIGR: E,
                        size: A = me.extraSmall,
                        type: s = pe.colored,
                        className: F,
                        classNames: l,
                        isShortName: c = !1,
                    }) => {
                        const D = `${d(n)}${u ? '_elite' : ''}`,
                            B = R.images.gui.maps.icons.vehicleTypes.big.$dyn(D);
                        return a().createElement(
                            'div',
                            {
                                className: r()(
                                    ...
                                    _e[`base__size${_(A)}`],
                                    _e[`base__type${_(s)}`],
                                    o && L(o, (u) => _e[`base__tag${_(u)}`]),
                                    F,
                                ),
                            },
                            a().createElement('div', { className: r()(_e.level, null == l ? void 0 : l.level) }, de(i)),
                            a().createElement('div', {
                                className: r()(_e.type, u && _e.type__elite, null == l ? void 0 : l.typeIcon),
                                style: { backgroundImage: `url(${B})` },
                            }),
                            E && a().createElement('div', { className: _e.premiumIGR }),
                            a().createElement(
                                'div',
                                { className: r()(_e.name, null == l ? void 0 : l.name) },
                                c ? t : e,
                            ),
                        );
                    },
                    ve = 'PremiumSpecialization_base_a1',
                    fe = 'PremiumSpecialization_icon_bd',
                    be = 'PremiumSpecialization_label_ec',
                    ge = ({ vehicleType: u, nation: e, className: t }) =>
                        a().createElement(
                            'div',
                            { className: r()(ve, t) },
                            ...
                            a().createElement(
                                'div',
                                { className: be },
                                C(R.strings.tooltips.tankman.section.premiumSpecialization(), {
                                    vehicleType: R.strings.crew.premiumVehType.plural.lowerCase.$dyn(d(u)),
                                    nation: R.strings.menu.nations.$dyn(e),
                                }),
                            ),
                        ),
                    we = 'Specialization_tank_d3',
                    ye = 'Specialization_tankIcon_fd',
                    ke = 'Specialization_premiumVehicleName_ba';
                function Te() {
                    return (
                        (Te =
                            Object.assign ||
                ...
                const Oe = (0, S.Pi)(({ className: u }) => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                he,
                                Te({}, t, {
                                    type: pe.whiteSpanish,
                                    className: we,
                                    classNames: {
                                        typeIcon: ye,
                                        name: r()(e.computes.isPremiumVehicleSpecialization() && ke),
                                    },
                                    isShortName: !0,
                                }),
                            ),
                            a().createElement(ge, { vehicleType: t.vehicleType, nation: e.nation.get() }),
                        );
                    }),
                    Ne = 'TankmanLocation_tank_90',
                    Pe = 'TankmanLocation_tankIcon_13',
                    xe = 'TankmanLocation_premiumVehicleName_a6';
                function Re() {
                    return (
                        (Re =
                            Object.assign ||
                ...
                const Le = (0, S.Pi)(({ className: u }) => {
                        const e = ru().model,
                            t = e.computes.isInVehicle();
                        return a().createElement(
                            U,
                            {
                                label: t
                            ...
                            t &&
                                a().createElement(
                                    ...
                                    Re({}, e.currentVehicle, {
                                        type: pe.whiteSpanish,
                                        className: Ne,
                                        classNames: { name: r()(e.computes.isOnPremiumVehicle() && xe), typeIcon: Pe },
                                        isShortName: !0,
                                    }),
                                ),
                        );
                    }),
                    Me = 'TrainingLevelApp_base_f2',
                    Se = 'TrainingLevelApp_additionalRoles_f3',
                    Ie = 'TrainingLevelApp_specialization_9f',
                    Ve = 'TrainingLevelApp_modifiers_5b',
                    Ue = 'TrainingLevelApp_description_4a',
                    We = () =>
                        a().createElement(
                            'div',
                            { className: Me },
                            a().createElement(lu, null),
                            a().createElement(Eu, { className: Se }),
                            a().createElement(Oe, { className: Ie }),
                            a().createElement(
                                N,
                                { className: Ve },
                            ...
                            a().createElement(y, {
                                text: R.strings.tooltips.trainingLevel.description(),
                                classMix: Ue,
                            }),
                        );
                engine.whenReady.then(() => {
                    D().render(
                        a().createElement(l, null, a().createElement(nu, null, a().createElement(We, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(7361));
