(() => {
    ...
    var __webpack_modules__ = {
            ...
            2691: (u, e, t) => {
                    ...
                    ({
                        ...
                        a().createElement(
                            ...
                            a().createElement(
                                ...
                                s && o > 0 && '+',
                                a().createElement(_, { value: o, format: n === C.gold ? 'gold' : 'integral' }),
                            ),
                            a().createElement('span', {
                                className: r()(D.icon, D[`icon__${n}-${t}`], null == A ? void 0 : A.icon),
                            }),
                            u &&
                                a().createElement(
                                    'span',
                        ...
                        const h = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, i.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (v(t, d, { isMouseEvent: !0, on: !0, arguments: m(n) }, w),
                                    p && p(),
                ...
                const N = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const r = e.contentId;
                    return r ? a().createElement(h, L({}, e, { contentId: r }), n) : a().createElement(T, e, n);
                };
                var S = t(1311);
                const M = {
                ...
                const q = { [W.NBSP]: j.NoBreakSymbol, [W.ZWNBSP]: j.NoBreakSymbol, [W.NEW_LINE]: j.LineBreak },
                    ...
                    G = 'renderers_noBreakWrapper_d986b',
                    X = 'renderers_lineBreak_f90ed',
                    H = 'renderers_newLine_ee778',
                    K = 'renderers_word_ac32d',
                    $ = (u) => ({ color: `#${u}` }),
                    Y = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? z[n]
                                ? a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: r()(K, z[n]) },
                                      u,
                                  )
                                : a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: K, style: $(n) },
                                      u,
                                  )
                            : a().createElement('span', { key: t, 'data-block-type': e.blockType, className: K }, u);
                    },
                    Z = {
                        [j.Word]: Y,
                        [j.NoBreakSymbol]: Y,
                        ...
                        [j.LineBreak]: ({ key: u }) =>
                            a().createElement('span', { key: u, 'data-block-type': j.LineBreak, className: X }),
                        [j.NewLine]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': j.NewLine, className: H }, u),
                        [j.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': j.NoBreakWrapper, className: G }, u),
                    },
                    Q = (u, e, t) => {
                        const n = [];
                        return (
                    ...
                    ru = (u, e = '', t) => {
                        ...
                        return (
                            uu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    n.push({ blockType: j.Word, colorTag: e, childList: nu(u, t) });
                                },
                                (u) => {
                                    const t = u[0],
                                        r = q[t.charAt(0)];
                    ...
                    Eu = (u, e, t, n, r, o) => {
                        ...
                        for (let c = t; c >= 0; c--) {
                            ...
                            if (l === j.LineBreak || l === j.NewLine || l === j.Binding) continue;
                    ...
                    Fu = a().memo(
                        ({
                            ...
                            const d = (0, i.useRef)(null),
                                ...
                                B = D[0],
                                C = D[1],
                                p = (0, i.useMemo)(() => au(u, n, { justifyContent: E }), [n, E, u]),
                                g = (0, i.useMemo)(() => {
                                    if (
                                        o &&
                                        B.isTruncated &&
                            ...
                            return (
                                ...
                                a().createElement(
                                    ...
                                    a().createElement('div', { className: M.unTruncated, ref: d }, p),
                                    a().createElement(
                                        N,
                                        {
                                            tooltipArgs: g,
                    ...
                    du = 'GradientDecorator_base_d854f',
                    _u = 'GradientDecorator_bg_b0fba',
                    Du = 'GradientDecorator_divider_cbfcf',
                ...
                const vu = ((u, e) => {
                        ...
                        ({ observableModel: u }) =>
                            Object.assign(
                                {},
                                u.primitives(['freePeriod', 'paidPeriod', 'recoverPrice', 'membersBuffer']),
                            ),
                        Cu,
                    ),
                    hu = vu[0],
                    wu = vu[1],
                    yu = 'DismissedToggleTooltipApp_base_eb88d',
                    Tu = 'DismissedToggleTooltipApp_title_ef4b2',
                    xu = 'DismissedToggleTooltipApp_supTitle_c980b',
                    ku = 'DismissedToggleTooltipApp_description_c6243',
                    Ou = 'DismissedToggleTooltipApp_decorator_a9587',
                    Pu = 'DismissedToggleTooltipApp_freePeriod_cf598',
                    Lu = 'DismissedToggleTooltipApp_currency_cc39d',
                    Ru = (0, b.Pi)(() => {
                        const u = wu().model,
                            e = u.freePeriod.get() + u.paidPeriod.get();
                        return a().createElement(
                            'div',
                            { className: yu },
                            a().createElement('div', { className: Tu }, R.strings.tooltips.dismissedToggle.header()),
                            a().createElement('div', { className: xu }, R.strings.tooltips.dismissedToggle.subHeader()),
                            a().createElement('div', { className: ku }, R.strings.tooltips.dismissedToggle.body()),
                            a().createElement(Fu, {
                                text: R.strings.tooltips.dismissedToggle.recover.total(),
                                binding: { days: e.toString() },
                            }),
                            a().createElement(
                                Bu,
                                { className: Ou },
                                a().createElement(Fu, {
                                    text: R.strings.tooltips.dismissedToggle.recover.free(),
                                    binding: { days: u.freePeriod.get() },
                                    classMix: Pu,
                                }),
                                a().createElement(Fu, {
                                    text: R.strings.tooltips.dismissedToggle.recover.paid(),
                                    binding: {
                                        price: a().createElement(g, {
                                            value: u.recoverPrice.get(),
                                            type: C.credits,
                                            size: B.small,
                                            classNames: { icon: Lu },
                                        }),
                                        days: u.paidPeriod.get(),
                                    },
                                }),
                            ),
                            a().createElement('div', null, R.strings.tooltips.dismissedToggle.footer.header()),
                            a().createElement(Fu, {
                                text: R.strings.tooltips.dismissedToggle.footer.body(),
                                binding: { quantity: u.membersBuffer.get() },
                                classMix: xu,
                            }),
                        );
                    });
                engine.whenReady.then(() => {
                    F().render(
                        a().createElement(hu, null, a().createElement(E, null, a().createElement(Ru, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [9056], () => __webpack_require__(2691));
