(() => {
    ...
    var __webpack_modules__ = {
            ...
            2689: (u, e, t) => {
                        ...
                        const v = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, i.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (w(t, _, { isMouseEvent: !0, on: !0, arguments: f(n) }, h),
                                    p && p(),
                ...
                const S = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return r || i
                        ? a().createElement(y, N({}, e, { contentId: r || i }), n)
                        : a().createElement(O, e, n);
                };
                var I = t(8045);
                const U = 'ExtendedText_base_71',
                    W = 'ExtendedText_base__zeroPadding_25',
                    j = 'ExtendedText_base__isTruncationAvailable_5b',
                ...
                const Z = { [X.NBSP]: K.NoBreakSymbol, [X.ZWNBSP]: K.NoBreakSymbol, [X.NEW_LINE]: K.LineBreak },
                    ...
                    tu = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? $[n]
                                ? a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: $[n] },
                                      u,
                                  )
                    ...
                    Bu = a().memo(
                        ({
                            ...
                            const F = (0, i.useRef)(null),
                                ...
                                m = (0, i.useMemo)(() => ({ justifyContent: E, alignContent: l }), [l, E]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                a().createElement(
                                    'div',
                                    { className: r()(U, e, W, s && j), style: m },
                                    a().createElement('div', { className: H, ref: F }, C),
                                    a().createElement(
                                        S,
                                        { tooltipArgs: p },
                                        a().createElement(
                                            'div',
                                            { className: r()(V, !D.isTruncateFinished && s && q), style: m },
                    ...
                    pu = 'GradientDecorator_bg_21',
                    gu = 'GradientDecorator_divider_13',
                    mu = (0, i.memo)(({ className: u, children: e }) =>
                        a().createElement(
                            'div',
                            { className: r()(Cu, u) },
                            a().createElement(
                ...
                const ku = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: r, children: s, mocks: c }) {
                                const E = (0, i.useRef)([]),
                                    ...
                                    _ = F[0],
                                    d = F[1],
                                    D = (0, i.useState)(() => l(n, r, c)),
                                    B = D[0],
                                    C = D[1];
                                return (
                                    (0, i.useEffect)(() => {
                                        A.current ? C(l(_, r, c)) : (A.current = !0);
                                    }, [c, _, r]),
                                    (0, i.useEffect)(() => {
                                        d(n);
                                    }, [n]),
                    ...
                    Tu = ku[0],
                    Ou = ku[1],
                    xu = 'DismissedToggleTooltipApp_base_c2',
                    Pu = 'DismissedToggleTooltipApp_title_37',
                    Lu = 'DismissedToggleTooltipApp_supTitle_63',
                    Mu = 'DismissedToggleTooltipApp_description_a1',
                    Nu = 'DismissedToggleTooltipApp_decorator_88',
                    ...
                    Su = (0, h.Pi)(() => {
                        ...
                        return a().createElement(
                            'div',
                            { className: xu },
                            a().createElement('div', { className: Pu }, R.strings.tooltips.dismissedToggle.header()),
                            a().createElement('div', { className: Lu }, R.strings.tooltips.dismissedToggle.subHeader()),
                            a().createElement('div', { className: Mu }, R.strings.tooltips.dismissedToggle.body()),
                            a().createElement(Bu, {
                ...
                engine.whenReady.then(() => {
                    _().render(
                        a().createElement(Tu, null, a().createElement(A, null, a().createElement(Su, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(2689));
