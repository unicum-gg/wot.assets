(() => {
            ...
            4200: (u, e, t) => {
                ...
                const F = a().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            A({}, _, {
                                className: r()(c.base, c[`base__theme-${l}`], n),
                                ref: function (u) {
                ...
                const g = {
                    ...
                    h = ({
                        ...
                        const A = r()(g.value, g[`value__${n}`], !o && g.value__notEnough),
                            F = r()(g.icon, g[`icon__${n}-${t}`]),
                            l = r()(g.stock, s && g.stock__indent, e && g.stock__interactive),
                            _ = c && i > 0 && '+',
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                { className: A },
                                _,
                                a().createElement(p, { value: i, format: n === D.gold ? 'gold' : 'integral' }),
                            ),
                            a().createElement('span', { className: F }),
                            u &&
                                a().createElement(
                                    'span',
                                    { className: l },
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((m.current.timeoutId = window.setTimeout(y, E ? 100 : 400)),
                                                      r && r(u),
                                                      O && O(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const N = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return r || i
                        ? a().createElement(w, M({}, e, { contentId: r || i }), n)
                        : a().createElement(T, e, n);
                };
                var S = t(8045);
                const I = 'ExtendedText_base_71',
                    U = 'ExtendedText_base__zeroPadding_25',
                    W = 'ExtendedText_base__isTruncationAvailable_5b',
                    j = 'ExtendedText_truncated_97',
                    V = 'ExtendedText_truncated__hide_31',
                    q = 'ExtendedText_unTruncated_b8';
                let z;
                !(function (u) {
                ...
                const X = { [Y.NBSP]: H.NoBreakSymbol, [Y.ZWNBSP]: H.NoBreakSymbol, [Y.NEW_LINE]: H.LineBreak },
                    Z = {
                    ...
                    eu = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? Z[n]
                                ...
                                : a().createElement('span', { key: t, 'data-block-type': e.blockType, style: uu(n) }, u)
                            : a().createElement('span', { key: t, 'data-block-type': e.blockType }, u);
                    },
                    tu = {
                        [H.Word]: eu,
                        [H.NoBreakSymbol]: eu,
                        [H.Binding]: ({ elementList: u, textBlock: e, key: t }) =>
                            a().createElement(
                                'span',
                        ...
                        [H.LineBreak]: ({ key: u }) =>
                            a().createElement('span', { key: u, 'data-block-type': H.LineBreak, className: Q }),
                        [H.NewLine]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': H.NewLine, className: J }, u),
                        [H.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': H.NoBreakWrapper, className: $ }, u),
                    },
                    nu = (u, e, t) => {
                        const n = [];
                        return (
                    ...
                    au = (u, e = '') => {
                        ...
                        return (
                            ou(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: H.Word, colorTag: e, childList: iu(u) });
                                },
                                (u) => {
                                    const n = u[0],
                                        r = X[n.charAt(0)];
                            ...
                            ou(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof o || 'number' == typeof o
                                        ? n.push(...au(String(o), t))
                                        : n.push({ blockType: H.Binding, colorTag: t, childList: [o] });
                                },
                            ),
                            n
                        );
                    ...
                    cu = (u, e) => {
                        ...
                        if (u.blockType === H.NoBreakWrapper) (u.childList.push(n), t.push(u));
                        else {
                            const e = Object.assign({}, u, { childList: u.childList.splice(-1) });
                            (u.childList.length > 0 && t.push(u),
                                t.push({ blockType: H.NoBreakWrapper, colorTag: '', childList: [e, n] }));
                        }
                    ...
                    _u = (u, e, t, n, r, o) => {
                        ...
                        for (let c = t; c >= 0; c--) {
                            ...
                            if (E === H.LineBreak || E === H.NewLine || E === H.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const l = A.slice(0, A.length - F) + o,
                                    _ = e[c];
                                ((s = a().cloneElement(_, _.props, l)), (i = c));
                                break;
                            }
                            {
                                const u = t.children,
                    ...
                    Du = a().memo(
                        ({
                            ...
                            const l = (0, i.useRef)(null),
                                ...
                                h = (0, i.useMemo)(() => ({ justifyContent: E, alignContent: A }), [A, E]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                a().createElement(
                                    'div',
                                    { className: r()(I, e, U, s && W), style: h },
                                    a().createElement('div', { className: q, ref: l }, C),
                                    a().createElement(
                                        N,
                                        { tooltipArgs: p },
                                        a().createElement(
                                            'div',
                                            { className: r()(j, !D.isTruncateFinished && s && V), style: h },
                        ...
                        return [
                            function ({ mode: n = 'real', options: r, children: s, mocks: c }) {
                                const E = (0, i.useRef)([]),
                                    ...
                                    _ = l[0],
                                    d = l[1],
                                    D = (0, i.useState)(() => A(n, r, c)),
                                    B = D[0],
                                    C = D[1];
                                return (
                                    (0, i.useEffect)(() => {
                                        F.current ? C(A(_, r, c)) : (F.current = !0);
                                    }, [c, _, r]),
                                    (0, i.useEffect)(() => {
                                        d(n);
                                    }, [n]),
                ...
                engine.whenReady.then(() => {
                    _().render(
                        a().createElement(F, null, a().createElement(bu, null, a().createElement(ku, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(4200));
