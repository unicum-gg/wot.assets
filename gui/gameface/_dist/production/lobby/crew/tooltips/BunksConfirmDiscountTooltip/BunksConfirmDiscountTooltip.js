(() => {
    ...
    var __webpack_modules__ = {
            ...
            4200: (u, e, t) => {
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onClick: ((u) => (e) => {
                                              (!1 === l && k(), null == s || s(e), null == u || u(e));
                                          })(e.props.onClick),
                                          onMouseDown: ((u) => (e) => {
                                              (!1 === l && k(), null == a || a(e), null == u || u(e));
                                          })(e.props.onMouseDown),
                                      },
                                      h,
                                  ),
                ...
                const X = { [Y.NBSP]: H.NoBreakSymbol, [Y.ZWNBSP]: H.NoBreakSymbol, [Y.NEW_LINE]: H.LineBreak },
                        ...
                        for (let c = t; c >= 0; c--) {
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const F = A.slice(0, A.length - l) + o,
                                    _ = e[c];
                                ((s = a().cloneElement(_, _.props, F)), (i = c));
                                break;
                            }
                            {
                                const u = t.children,
                    ...
                    du = (u, e, t, n = '...') => {
                        ...
                        const A = _u(c, r, E, a, n.length, n),
                            l = A[0],
                            F = A[1];
                        return (F && (r.splice(l, 1, F), r.splice(l + 1)), [r, !0]);
                    },
                    Du = a().memo(
                        ({
                            text: u,
                ...
                const vu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: r, children: s, mocks: c }) {
                                const E = (0, i.useRef)([]),
                                    A = (t, n, r) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            F = { mode: t, model: l, externalModel: s, cleanup: A };
                                        return {
                                            model: l,
                                ...
                                return (
                                    (0, i.useEffect)(() => {
                                        l.current ? C(A(_, r, c)) : (l.current = !0);
                                    }, [c, _, r]),
                                    (0, i.useEffect)(() => {
                                        d(n);
                                    }, [n]),
                ...
                engine.whenReady.then(() => {
                    _().render(
                        a().createElement(l, null, a().createElement(bu, null, a().createElement(ku, null))),
