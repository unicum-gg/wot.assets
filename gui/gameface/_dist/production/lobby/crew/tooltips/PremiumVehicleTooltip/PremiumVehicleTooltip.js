(() => {
    ...
    var __webpack_modules__ = {
            ...
            4245: (u, e, t) => {
                ...
                const k = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return r || i
                        ? a().createElement(m, T({}, e, { contentId: r || i }), n)
                        : a().createElement(f, e, n);
                };
                var O = t(8045);
                const x = 'ExtendedText_base_71',
                    P = 'ExtendedText_base__zeroPadding_25',
                    L = 'ExtendedText_base__isTruncationAvailable_5b',
                    M = 'ExtendedText_truncated_97',
                    N = 'ExtendedText_truncated__hide_31',
                ...
                const q = { [j.NBSP]: U.NoBreakSymbol, [j.ZWNBSP]: U.NoBreakSymbol, [j.NEW_LINE]: U.LineBreak },
                    H = {
                    ...
                    $ = {
                        ...
                        [U.NewLine]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': U.NewLine, className: G }, u),
                        [U.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': U.NoBreakWrapper, className: K }, u),
                    },
                    X = (u, e, t) => {
                        const n = [];
                        return (
                    ...
                    eu = (u, e = '') => {
                        ...
                        return (
                            J(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: U.Word, colorTag: e, childList: uu(u) });
                                },
                                (u) => {
                                    const n = u[0],
                                        r = q[n.charAt(0)];
                    ...
                    su = (u, e, t, n, r, o) => {
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            if (A === U.LineBreak || A === U.NewLine || A === U.Binding) continue;
                    ...
                    Au = a().memo(
                        ({
                            ...
                            return (
                                ...
                                a().createElement(
                                    'div',
                                    { className: r()(x, e, P, s && L), style: h },
                                    a().createElement('div', { className: S, ref: l }, C),
                                    a().createElement(
                                        k,
                                        { tooltipArgs: p },
                                        a().createElement(
                                            'div',
                                            { className: r()(M, !B.isTruncateFinished && s && N), style: h },
                    ...
                    Fu = 'Divided_base_06',
                    cu = 'Divided_divider_64',
                    lu = (0, i.memo)(({ children: u, classNames: e }) =>
                        a().createElement(
                            'div',
                            { className: Fu },
                            u,
                            a().createElement('div', { className: r()(cu, null == e ? void 0 : e.divider) }),
                        ),
                    );
                function Du() {}
                function du() {
                ...
                const mu = ((u, e) => {
                    ...
                    })(({ observableModel: u }) => u.primitives(['vehTypeName', 'nationName']), Du),
                    hu = mu[0],
                    vu = mu[1],
                    fu = {
                        base: 'ContentItem_base_e7',
                        text: 'ContentItem_text_07',
                        icon: 'ContentItem_icon_78',
                        icon__experience: 'ContentItem_icon__experience_3d',
                        icon__credits: 'ContentItem_icon__credits_7a',
                        icon__transfer: 'ContentItem_icon__transfer_a1',
                    };
                let bu;
                !(function (u) {
                ...
                const wu = ({ itemType: u }) =>
                        a().createElement(
                            'div',
                            { className: fu.base },
                            a().createElement('div', { className: r()(fu.icon, fu[`icon__${u}`]) }),
                            a().createElement(
                                'div',
                                { className: fu.text },
                    ...
                    gu = 'PremiumVehicleTooltipApp_base_78',
                    yu = 'PremiumVehicleTooltipApp_flash_4a',
                    Tu = 'PremiumVehicleTooltipApp_header_9a',
                    ku = 'PremiumVehicleTooltipApp_caption_e7',
                    Ou = 'PremiumVehicleTooltipApp_contentHeader_77',
                    xu = 'PremiumVehicleTooltipApp_info_da',
                    Pu = 'PremiumVehicleTooltipApp_infoIcon_88',
                    Lu = 'PremiumVehicleTooltipApp_infoText_56',
                    Mu = 'PremiumVehicleTooltipApp_content_30',
                    Nu = (0, d.Pi)(() => {
                        const u = vu().model;
                        return a().createElement(
                            'div',
                            ...
                            a().createElement(
                                lu,
                                null,
                                a().createElement('div', { className: Tu }, R.strings.tooltips.premiumVehicle.header()),
                                a().createElement(Au, {
                                    classMix: ku,
                                    text: R.strings.tooltips.premiumVehicle.caption(),
                                    binding: { vehType: u.vehTypeName.get(), nation: u.nationName.get() },
                                }),
                            ),
                            a().createElement(
                                lu,
                                ...
                                a().createElement(
                                    'div',
                                    { className: Mu },
                                    a().createElement(wu, { itemType: bu.Experience }),
                                    a().createElement(wu, { itemType: bu.Credits }),
                                    a().createElement(wu, { itemType: bu.Transfer }),
                                ),
                            ),
                            a().createElement(
                                'div',
                                ...
                                a().createElement('div', { className: Lu }, R.strings.tooltips.premiumVehicle.info()),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    D().render(
                        a().createElement(c, null, a().createElement(hu, null, a().createElement(Nu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(4245));
