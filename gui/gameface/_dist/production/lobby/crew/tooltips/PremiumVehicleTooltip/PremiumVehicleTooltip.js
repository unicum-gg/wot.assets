(() => {
    ...
    var __webpack_modules__ = {
            ...
            5662: (u, e, t) => {
                ...
                const T = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const r = e.contentId;
                    return r ? a().createElement(p, y({}, e, { contentId: r }), n) : a().createElement(f, e, n);
                };
                var k = t(1311);
                const x = {
                ...
                const S = { [N.NBSP]: P.NoBreakSymbol, [N.ZWNBSP]: P.NoBreakSymbol, [N.NEW_LINE]: P.LineBreak },
                    ...
                    V = 'renderers_noBreakWrapper_d986b',
                    ...
                    q = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? I[n]
                                ? a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: r()(z, I[n]) },
                                      u,
                                  )
                                : a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: z, style: U(n) },
                                      u,
                                  )
                    ...
                    G = {
                        ...
                        [P.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': P.NoBreakWrapper, className: V }, u),
                    },
                    H = (u, e, t) => {
                        const n = [];
                        return (
                    ...
                    su = 'Divided_base_ae250',
                    cu = 'Divided_divider_f79f3',
                    Eu = (0, i.memo)(({ children: u, classNames: e }) =>
                        a().createElement(
                            'div',
                            { className: su },
                            u,
                ...
                const Fu = ({ itemType: u, isWotPlusSpecialization: e = !1 }) =>
                        a().createElement(
                            'div',
                            { className: lu.base },
                            a().createElement('div', { className: r()(lu.icon, lu[`icon__${u}`]) }),
                            a().createElement(
                                'div',
                                { className: lu.text },
                                e
                    ...
                    du = 'PremiumVehicleContent_base_eda6b',
                    Du = 'PremiumVehicleContent_header_f0257',
                    Bu = 'PremiumVehicleContent_content_e1bf2',
                    _u = ({ isWotPlusSpecialization: u = !1 }) =>
                        a().createElement(
                            'div',
                            { className: du },
                            a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: Bu },
                                a().createElement(Fu, { itemType: Au.Experience }),
                                a().createElement(Fu, { itemType: Au.Credits }),
                                a().createElement(Fu, { itemType: Au.Transfer, isWotPlusSpecialization: u }),
                            ),
                        );
                function Cu() {}
                function pu() {
                ...
                const bu = ((u, e) => {
                    ...
                    })(({ observableModel: u }) => u.primitives(['vehTypeName', 'nationName']), Cu),
                    gu = bu[0],
                    wu = bu[1],
                    yu = 'PremiumVehicleTooltipApp_base_f56d6',
                    Tu = 'PremiumVehicleTooltipApp_flash_aca23',
                    ku = 'PremiumVehicleTooltipApp_header_af2b6',
                    xu = 'PremiumVehicleTooltipApp_caption_dd5ff',
                    Ou = 'PremiumVehicleTooltipApp_info_b6388',
                    Pu = 'PremiumVehicleTooltipApp_infoIcon_e3098',
                    Ru = 'PremiumVehicleTooltipApp_infoText_b45b8',
                    Lu = (0, d.Pi)(() => {
                        const u = wu().model;
                        return a().createElement(
                            'div',
                            ...
                            a().createElement(
                                Eu,
                                null,
                                a().createElement('div', { className: ku }, R.strings.tooltips.premiumVehicle.header()),
                                a().createElement(au, {
                                    classMix: xu,
                            ...
                            a().createElement(Eu, null, a().createElement(_u, null)),
                            a().createElement(
                                'div',
                                { className: Ou },
                                a().createElement('div', { className: Pu }),
                                a().createElement('div', { className: Ru }, R.strings.tooltips.premiumVehicle.info()),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    F().render(
                        a().createElement(l, null, a().createElement(gu, null, a().createElement(Lu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [9056], () => __webpack_require__(5662));
