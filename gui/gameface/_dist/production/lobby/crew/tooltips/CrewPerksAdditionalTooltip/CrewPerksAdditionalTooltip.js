(() => {
    ...
    var __webpack_modules__ = {
            ...
            8181: (e, u, t) => {
                ...
                const p = r().memo(function ({ iconName: e, size: u = g.c24x24, className: t }) {
                    ...
                    P = (0, n.memo)(({ userName: e, iconName: u, skillType: t, withAsterisk: n = !1 }) =>
                        r().createElement(
                            v,
                            null,
                            r().createElement(
                                'div',
                                { className: w },
                                u && r().createElement(p, { iconName: u, className: y, size: g.c52x52 }),
                                r().createElement(
                                    'div',
                                    { className: k },
                    ...
                    S = 'ErrorBackground_base_33',
                    O = () => r().createElement('div', { className: S });
                function L() {}
                function N() {
                    return !1;
                }
                ...
                const U = (0, n.forwardRef)(function (e, u) {
                        let t = e.src,
                            o = e.className,
                            a = e.autoplay,
                            i = void 0 !== a && a,
                        ...
                        return (
                            c(() =>
                                l.O.view.events.onDisplayChanged((e, u) => {
                                    var t, n;
                                    u === q.W.hidden && (null == (t = C.current) || t.pause());
                                    u === q.W.shown && (null == (n = C.current) || n.play());
                                }),
                            ),
                            (0, n.useEffect)(
                                () =>
                            ...
                            (0, n.useEffect)(() => {
                                if (D && C.current) {
                                    ...
                                    const t = (u) => (
                                        ...
                                        a = (e) => {
                                            C.current && (C.current.currentTime = G(0, C.current.duration, e));
                                        },
                                        i = () => {
                                            var e;
                            ...
                            r().createElement(
                                'video',
                                H({ src: t, className: o, style: s, loop: d, ref: C, onClick: F }, m),
                            )
                        );
                    }),
                    X = (0, n.memo)(U);
                ...
                const te = (0, n.memo)(
                        ({
                            ...
                            r().createElement(
                                'span',
                                { className: s()(Q.base, Q[`base__${t}`], _) },
                                r().createElement(
                                    'span',
                                    {
                                        className: s()(
                                    ...
                                    i && o > 0 && '+',
                                    r().createElement(Z, { value: o, format: n === ee.gold ? 'gold' : 'integral' }),
                                ),
                                r().createElement('span', {
                                    className: s()(Q.icon, Q[`icon__${n}-${t}`], null == d ? void 0 : d.icon),
                                }),
                                e &&
                                    r().createElement(
                                        'span',
                ...
                const ce = { base: 'ProgressBarBlink_base_24', base__small: 'ProgressBarBlink_base__small_0f' },
                    _e = ({ size: e }) => {
                        const u = s()(ce.base, ce[`base__${e}`]);
                        return r().createElement('div', { className: u });
                    },
                    de = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    me = (0, n.memo)(
                        ({ size: e, lineRef: u, disabled: t, baseStyles: n, isComplete: o, withoutBounce: a }) => {
                            const i = s()(
                                    ...
                                    t && Fe.base__disabled,
                                    o && Fe.base__finished,
                                    a && Fe.base__withoutBounce,
                                ),
                                l = !t && !o;
                            return r().createElement(
                                'div',
                                { className: i, style: n, ref: u },
                                r().createElement('div', { className: Fe.pattern }),
                                r().createElement('div', { className: Fe.gradient }),
                    ...
                    Ce = 'ProgressBarDeltaGrow_base_7e',
                    ...
                    ve = (0, n.memo)(
                        ({
                            ...
                            const f = (0, n.useMemo)(() => Object.assign({ width: '100%' }, be(e), pe(d)), [d, e]),
                                b = (0, n.useMemo)(() => Object.assign({ width: '0%' }, be(e), pe(d)), [d, e]),
                                v = (0, n.useMemo)(() => Object.assign({ width: '0%' }, fe(d, o), be(e)), [o, d, e]),
                                h = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(i - o)}%` }, fe(d, o), be(e)),
                                    [o, d, i, e],
                                );
                            if (m) return null;
                            const w = s()(Ce, _, d && 0 === i && Be);
                            return r().createElement(
                                'div',
                                { style: D ? v : h, className: w },
                                r().createElement(
                                    'div',
                                    { style: B ? b : f, className: ge },
                                    r().createElement(_e, { size: a }),
                                ),
                            );
                        },
                ...
                const ke = (0, n.memo)((e) => {
                        ...
                        switch (o.animationSettings.type) {
                            case oe.Simple:
                                return r().createElement(De, ye({}, o, { onEndAnimation: l, isComplete: i }));
                            case oe.Growing:
                                return r().createElement(he, ye({}, o, { onEndAnimation: l, isComplete: i }));
                            default:
                                return null;
                        }
                    }),
                    xe = ({ size: e, value: u, lineRef: t, disabled: o, onComplete: a }) => {
                        ...
                        return (
                            ...
                            r().createElement(me, { size: e, disabled: o, baseStyles: i, isComplete: s, lineRef: t })
                        );
                    },
                    Te = ['onEndAnimation'];
                function Pe() {
                ...
                const Le = (0, n.memo)(
                        ({
                            ...
                            return i.withStack
                                ...
                                : r().createElement(ke, Oe({ key: `${o}-${u}-${a}` }, _));
                        },
                    ),
                    Ne = (e) => ({
                    ...
                    je = (0, n.memo)(
                        ({
                            ...
                            return r().createElement(
                                'div',
                                { className: s()(ne.base, ne[`base__${t}`]), style: Ne(u) },
                                !i && r().createElement(ae, { size: t }),
                                r().createElement(Le, {
                                    size: t,
                                    lineRef: d,
                                    disabled: a,
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (qe(t, A, { isMouseEvent: !0, on: !0, arguments: Ge(r) }, b),
                                    B && B(),
                ...
                const uu = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    if (u.header || u.body) return r().createElement(Je, u, n);
                    const o = u.contentId;
                    return o ? r().createElement(Ke, eu({}, u, { contentId: o }), n) : r().createElement(Xe, u, n);
                };
                var tu = t(8045);
                const nu = {
                ...
                const iu = { [au.NBSP]: ru.NoBreakSymbol, [au.ZWNBSP]: ru.NoBreakSymbol, [au.NEW_LINE]: ru.LineBreak },
                    ...
                    Fu = ({ elementList: e, textBlock: u, key: t }) => {
                        ...
                        return n
                            ? lu[n]
                                ? r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': u.blockType, className: s()(Eu, lu[n]) },
                                      e,
                                  )
                                : r().createElement(
                                      'span',
                    ...
                    mu = {
                        ...
                        [ru.LineBreak]: ({ key: e }) =>
                            r().createElement('span', { key: e, 'data-block-type': ru.LineBreak, className: _u }),
                        [ru.NewLine]: ({ elementList: e, key: u }) =>
                            r().createElement('span', { key: u, 'data-block-type': ru.NewLine, className: du }, e),
                    ...
                    bu = (e, u = '', t) => {
                        ...
                        return (
                            Bu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (e) => {
                                    n.push({ blockType: ru.Word, colorTag: u, childList: fu(e, t) });
                                },
                                (e) => {
                                    const t = e[0],
                                        r = iu[t.charAt(0)];
                    ...
                    Su = r().memo(
                        ({
                            ...
                            const A = (0, n.useRef)(null),
                                ...
                                D = m[0],
                                C = m[1],
                                B = (0, n.useMemo)(() => wu(e, o, { justifyContent: _ }), [o, _, e]),
                                g = (0, n.useMemo)(() => {
                                    if (
                                        a &&
                                        D.isTruncated &&
                                ...
                                r().createElement(
                                    'div',
                                    {
                                        className: s()(
                                            ...
                                            i && nu.base__isTruncationAvailable,
                                        ),
                                        style: f,
                                    },
                                    r().createElement('div', { className: nu.unTruncated, ref: A }, B),
                                    r().createElement(
                                        uu,
                                        {
                                            tooltipArgs: g,
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: s()(
                                                    nu.truncated,
                                                    !D.isTruncateFinished && i && nu.truncated__hide,
                                                ),
                                                style: f,
                                            },
                    ...
                    Nu = (0, n.memo)(
                        ({
                            ...
                            return r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: s()(Ou.progressSection, !a && Ou.progressSection__available) },
                                    r().createElement(
                                        'div',
                                        { className: Ou.progressValues },
                                        r().createElement(
                                            'div',
                                            { className: i ? Ou.percents__full : Ou.percents },
                                            $e(t),
                                        ),
                                        r().createElement(Su, {
                                            text: Lu.skills.counters(),
                                            binding: {
                                                currentCount: r().createElement(
                                                    'div',
                                                    { className: Ou.currentValue },
                                                    Y.Z5.getNumberFormat(e, Y.B3.INTEGRAL),
                                                ),
                                                totalCount: r().createElement(
                                                    'div',
                                                    { className: Ou.xpValues },
                                                    l &&
                                                        r().createElement(
                                                            'div',
                                                            { className: Ou.discountValue },
                                                            Y.Z5.getNumberFormat(u, Y.B3.INTEGRAL),
                                                            r().createElement('div', {
                                                                className: Ou.discountCrossLine,
                                                            }),
                                                        ),
                                                    r().createElement(te, {
                                                        type: ee.xp,
                                                        ...
                                                        value: l ? n : u,
                                                        classNames: {
                                                            value: s()(Ou.totalValue, l && Ou.totalValue__withDiscount),
                                                        },
                                                    }),
                                                ),
                                            },
                                ...
                                l &&
                                    r().createElement(
                                        'div',
                                        { className: Ou.discount },
                                        r().createElement('div', { className: Ou.infoIcon }),
                                        r().createElement(
                                            'div',
                                            { className: Ou.discountLabel },
                                            Lu.skillTooltip.main.available.discountLabel.$num(o),
                                        ),
                                    ),
                            );
                        },
                    ),
                    Ru = 'AltContentSection_movie_a9',
                    Iu = 'AltContentSection_description_25',
                    Mu = 'AltContentSection_info_41',
                    ju = 'AltContentSection_infoIcon_9c',
                    Vu = 'AltContentSection_infoText_68',
                    zu = 'AltContentSection_skillProgress_0d',
                    $u = 'AltContentSection_header_04',
                    Wu = (0, n.memo)(
                        ({
                            animationName: e,
                            altText: u,
                            ...
                            r().createElement(
                                ...
                                r().createElement(v, null, r().createElement('div', { className: Iu }, u)),
                                r().createElement(
                                    v,
                                    null,
                                    r().createElement(
                                ...
                                n &&
                                    r().createElement(
                                        ...
                                        r().createElement(Nu, o),
                                    ),
                            ),
                    ),
                    Gu = 'CrewPerksAdditionalApp_base_aa',
                    qu = (0, m.Pi)(function () {
                        const e = W().model;
                        return r().createElement(
                            F,
                ...
                engine.whenReady.then(() => {
                    a().render(
                        r().createElement($, null, r().createElement(qu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [9056], () => __webpack_require__(8181));
