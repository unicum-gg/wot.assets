(() => {
    var __webpack_modules__ = {
            ...
            3848: (u, e, t) => {
                        ...
                        (0, y.Z)(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    r = S(u);
                                _.current = M.addCallback(r, t, o, e === O.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (e !== O.None)
                ...
                const W = /<link.*?>/g,
                    ...
                    K = (0, r.memo)(({ id: u, fallback: e, onLoadCallback: t, mixClass: n }) => {
                ...
                const uu = ({
                    ...
                    const m = (0, r.useRef)(null),
                        ...
                        O = (0, r.useCallback)(
                            (u) => {
                                i || (null !== c && (0, v.G)(c), d && d(u), t && y(), p(!0));
                            },
                            [i, c, d, y, t],
                        ),
                        N = (0, r.useCallback)(
                ...
                const Au = (0, r.memo)(() => {
                        const u = N('model').onButtonClicked,
                            e = N('model.focus'),
                            t = e.focusedIndex,
                            n = e.onTabPressed,
                            i = N('model.buttons'),
                    ...
                    const B = (0, r.useCallback)((u) => {
                        ...
                        h = (0, r.useMemo)(
                            () =>
                                i.reduce(
                                    (u, { value: e }) => (
                                        (u[e.placeHolder] = a().createElement(K, {
                                            key: e.placeHolder,
                                            id: e.resourceID,
                                            mixClass: mu,
                                            onLoadCallback: B,
                ...
                const Wu = (u) => {
                    ...
                    const M = (0, r.useState)(!1),
                        ...
                        V = a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: o()(Pu.labelContent, 's-labelContent'), style: x },
                                y || T,
                            ),
                        );
                    return a().createElement(
                        ...
                        Iu(
                            {
                                ...
                                className: o()(Pu.base, Pu[`base__${_}`], Pu[`base__${A}`], {
                                    [Pu.base__checked]: n,
                                    [Pu.base__disabled]: s,
                                    [Pu.base__mouseDown]: O,
                                    [Pu.base__alert]: c,
                                    [Pu.base__center]: L === Ru.Center,
                                    [Pu.base__bottom]: L === Ru.Bottom,
                                }),
                                onClick: H,
                                onMouseEnter: j,
                                onMouseLeave: U,
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(3848));
