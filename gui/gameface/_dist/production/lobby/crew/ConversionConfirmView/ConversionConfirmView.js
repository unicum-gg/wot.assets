    ...
    var __webpack_modules__ = {
            ...
            6150: (u, e, t) => {
                ...
                const Be = 'MainReward_base_08',
                    ...
                    be = { [f.ExtraLarge]: Ju.S400x300, [f.Large]: Ju.S400x300, [f.Medium]: Ju.S296x222 },
                    ve = ({ rewards: u, className: e, withAnimations: t = !0, withScaledSingleReward: n = !0 }) => {
                        const a = w().mediaSize,
                            i = ((u, e, t) => (u > 1 || !t ? be[e] || Ju.S232x174 : fe[e] || Ju.S400x300))(
                                u.length,
                                a,
                                n,
                            );
                            ...
                            (s = (u, e) => {
                                return r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: me },
                                        r().createElement('div', { className: he }, V(u.label)),
                                    ),
                                );
                                var t;
                            }),
                    ...
                    Me = r().memo(function ({
                        ...
                        return r().createElement(
                            ...
                            u &&
                                ...
                                r().createElement(
                                    'div',
                                    { className: g()(Oe, null == o ? void 0 : o.leftButtons) },
                                    r().createElement(Se, { onClick: t, caption: u, type: 'back' }),
                                ),
                            r().createElement(
                                'div',
                                { className: g()(Pe, null == o ? void 0 : o.rightButtons) },
                ...
                const We = ((u, e) => {
                    ...
                    $e = We[0],
                    je = We[1],
                    ze = 'ConversionConfirmViewApp_base_ee',
                    qe = 'ConversionConfirmViewApp_closeButton_f4',
                    Ve = 'ConversionConfirmViewApp_title_38',
                    ...
                    nt = (0, iu.Pi)(() => {
                        ...
                        return (
                            ...
                            r().createElement(
                                'div',
                                { className: ze },
                                r().createElement(Me, { onCloseClick: t.close, className: qe }),
                                r().createElement('div', { className: Ve }, R.strings.crew.conversionConfirm.title()),
                                r().createElement(
                                    'div',
                                    { className: Ye },
                ...
                engine.whenReady.then(() => {
                    N().render(
                        r().createElement($e, null, r().createElement(P, null, r().createElement(nt, null))),
