(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => s, off: () => A, on: () => E, onResize: () => o, onScaleUpdated: () => i }));
                var n = t(2472),
                    r = t(1176);
            ...
            1735: (u, e, t) => {
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      (v.current.timeoutId = window.setTimeout(g, s ? 100 : 400)),
                                                      r && r(u),
                                                      y && y(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const Eu = { [iu.NBSP]: ru.NoBreakSymbol, [iu.ZWNBSP]: ru.NoBreakSymbol, [iu.NEW_LINE]: ru.LineBreak },
                    ...
                    su = 'renderers_noBreakWrapper_10',
                    ...
                    Cu = {
                        ...
                        [ru.LineBreak]: ({ key: u }) =>
                            E().createElement('span', { key: u, 'data-block-type': ru.LineBreak, className: Fu }),
                        ...
                        [ru.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            E().createElement(
                                'span',
                                { key: e, 'data-block-type': ru.NoBreakWrapper, className: su },
                                u,
                            ),
                    },
                    du = (u, e, t) => {
                    ...
                    xu = (u, e, t, n, r, o) => {
                        ...
                        for (let a = t; a >= 0; a--) {
                            ...
                            if (s === ru.LineBreak || s === ru.NewLine || s === ru.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const D = F.slice(0, F.length - l) + o,
                                    c = e[a];
                                ((A = E().cloneElement(c, c.props, D)), (i = a));
                                break;
                            }
                            {
                                const u = t.children,
                                    s = e[a],
                                    l = s.props.children,
                                    D = xu(u, l, u.length - 1, n, r, o),
                                    c = D[0],
                                    B = D[1];
                                if (!(c < 0)) {
                                    const u = l.slice(0, c);
                                    ((A = E().cloneElement(s, s.props, u, B)), (i = a));
                                    break;
                                }
                                r -= F.length;
                            }
                    ...
                    Ru = E().memo(
                        ({
                            ...
                            customTooltipArgs: a,
                            targetId: s,
                            justifyContent: F = ou.FlexStart,
                            alignContent: l = ou.FlexStart,
                            truncateIdentify: D = '...',
                        }) => {
                            const c = (0, i.useRef)(null),
                                ...
                                d = C[0],
                                _ = C[1],
                                p = (0, i.useMemo)(() => fu(u, n, { justifyContent: F }), [n, F, u]),
                                h = (0, i.useMemo)(() => {
                                    if (
                                        o &&
                                        d.isTruncated &&
                                ...
                                v = (0, i.useMemo)(() => ({ justifyContent: F, alignContent: l }), [l, F]);
                            return (
                                ((u, e, t = !0) => {
                    ...
                    Lu = 'CrewHeaderTooltipApp_bodyTexture_e9',
                    ...
                    $u = 'CrewHeaderTooltipApp_perFiveMinutes_fe',
                    ...
                    Ee = ({ IdleCrewBonus: u = H.Disabled, bonusXpPerFiveMinutes: e, vehicleName: t }) =>
                        E().createElement(
                            'div',
                            { className: Pu },
                            E().createElement('img', { src: ne.bodyTexture, alt: '', className: Lu }),
                            ...
                            E().createElement(
                                ...
                                E().createElement('div', { className: $u }, te.perFiveMinutes),
                            ),
                            E().createElement(
                                'div',
                                { className: Ku },
