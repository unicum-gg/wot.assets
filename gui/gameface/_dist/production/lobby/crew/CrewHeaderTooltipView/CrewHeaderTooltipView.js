    ...
    var __webpack_modules__ = {
            ...
            4282: (u, e, t) => {
                ...
                const C = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    f = ({ binding: u, text: e = '', classMix: t, alignment: n = B.left, formatWithBrackets: i }) => {
                ...
                const uu = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const r = e.contentId;
                    return r ? E().createElement($, J({}, e, { contentId: r }), n) : E().createElement(K, e, n);
                };
                var eu = t(1311);
                const tu = {
                ...
                const ou = { [iu.NBSP]: nu.NoBreakSymbol, [iu.ZWNBSP]: nu.NoBreakSymbol, [iu.NEW_LINE]: nu.LineBreak },
                    ...
                    Bu = {
                        ...
                        [nu.NewLine]: ({ elementList: u, key: e }) =>
                            E().createElement('span', { key: e, 'data-block-type': nu.NewLine, className: Fu }, u),
