(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                t.d(e, { O: () => G });
                var n = {};
                (t.r(n), t.d(n, { mouse: () => s, onResize: () => i }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        events: () => n,
                ...
                var o = {};
                (t.r(o), t.d(o, { getBgUrl: () => C, getTextureUrl: () => l }));
                var A = {};
                function E(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            420: (u, e, t) => {
                ...
                class D extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            d = F()(a.base, a[`base__${A}`], a[`base__${o}`], null == E ? void 0 : E.base),
                            _ = F()(a.icon, a[`icon__${A}`], a[`icon__${o}`], null == E ? void 0 : E.icon),
                            v = F()(a.glow, null == E ? void 0 : E.glow),
                            h = F()(a.caption, a[`caption__${A}`], null == E ? void 0 : E.caption),
                            f = F()(a.goto, null == E ? void 0 : E.goto);
                        return r().createElement(
                            ...
                            'info' !== A && r().createElement('div', { className: a.shine }),
                                                        ...
                                                        o.forEach((e, t) => {
                                                            n > o[t] - 0.02 &&
                                                                ...
                                                                u.changeKeyframeHandlers.forEach((u) => {
                                                                    const n = Object.keys(null != c ? c : {})[t];
                                                                    return u({
                                                                        time: e,
                                                                        name: `${c ? n : `Point_${t}`}`,
                                                                    });
                ...
                const x = ((u, e) => {
                                ...
                                const i = (0, n.useRef)([]),
                                    a = (t, n, r) => {
                                        ...
                                        const A = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, o) => {
                                                        const E = 'string' == typeof o ? `${n}.${o}` : n,
                                                            F = p.O.view.addModelObserver(E, e, !0);
                                                        return (r.set(F, t), u && t(A(o)), F);
                                                    },
                                                    readByPath: A,
                                                    createCallback: (u, e) => {
                                                        const t = A(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = M(r.keys()); !(u = t()).done; ) o(u.value, e);
                                                    },
                                                    unsubscribe: o,
                                                };
                                            })(n),
                                            ...
                                            c = { mode: t, model: s, externalModel: E, cleanup: a };
                                        return {
                                            model: s,
                                    ...
                                    D = c[0],
                                    B = c[1],
                                    C = (0, n.useState)(() => a(o, A, F)),
                                    d = C[0],
                                    _ = C[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        s.current ? _(a(D, A, F)) : (s.current = !0);
                                    }, [F, D, A]),
                                    (0, n.useEffect)(() => {
                                        B(o);
                                    }, [o]),
                    ...
                    j = (0, T.Pi)(() => {
                        ...
                        return (
                            (function ({
                                key: u = g.n.ESCAPE,
                                callback: e = () => p.O.view.sendEvent.close(),
                ...
                engine.whenReady.then(() => {
                    A().render(r().createElement(L, null, r().createElement(j, null)), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (F = 0; F < deferred.length; F++) {
                    for (var [e, t, n] = deferred[F], o = !0, A = 0; A < e.length; A++)
                        (!1 & n || r >= n) &&
