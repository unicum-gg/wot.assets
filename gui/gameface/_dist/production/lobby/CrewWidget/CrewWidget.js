    ...
    var __webpack_modules__ = {
            ...
            3400: (u, e, t) => {
                ...
                const S = {
                    ...
                    y = (u) => {
                        ...
                        const E = f(),
                            ...
                            A = E.mediaHeight,
                            i = E.mediaSize;
                        return n().createElement('div', L({ className: g()(t, S[a], T[A], O[i]) }, r), e);
                    },
                    H = ['children'],
                    P = (u) => {
                        let e = u.children,
                ...
                class Y extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = g()(K.base, K[`base__${a}`], K[`base__${E}`], null == A ? void 0 : A.base),
                            _ = g()(K.icon, K[`icon__${a}`], K[`icon__${E}`], null == A ? void 0 : A.icon),
                            B = g()(K.glow, null == A ? void 0 : A.glow),
                            c = g()(K.caption, K[`caption__${a}`], null == A ? void 0 : A.caption),
                            C = g()(K.goto, null == A ? void 0 : A.goto);
                        return n().createElement(
                            'div',
                            q(
                                {
                ...
                const Au = {
                    ...
                    ou = ru((u) => {
                        let e = u.className,
                            ...
                            x =
                                void 0 === w
                                    ...
                                    : w,
                            f = u.alignItems,
                            M = void 0 === f ? (d ? 'flex-start' : h && 'center') || (p && 'flex-end') || void 0 : f,
                            L = u.alignSelf,
                            S = u.wrap,
                            T = u.flexWrap,
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, E, i, o, s, _, k, P, L, m, O, x, M]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return n().createElement('div', au({ className: g()(nu.base, ...U, e), style: G }, N), I);
                    });
                let Du;
                !(function (u) {
                ...
                const Ru = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: a, mocks: A }) {
                                const F = (0, r.useRef)([]),
                                    ...
                                    l = s[0],
                                    _ = s[1],
                                    B = (0, r.useState)(() => o(u, E, A)),
                                    c = B[0],
                                    C = B[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        D.current ? C(o(l, E, A)) : (D.current = !0);
                                    }, [A, l, E]),
                                    (0, r.useEffect)(() => {
                                        _(u);
                                    }, [u]),
                    ...
                    })(0, ({ externalModel: u }) => ({ onAboutClicked: u.createCallbackNoArgs('onAboutClicked') })),
                    Hu = yu[0],
                    Pu = yu[1],
                    ku = {
                        base: 'App_base_a7',
                    ...
                    Nu = (0, k.observer)(() => {
                        const u = Pu(),
                            ...
                            i = E.tankmanID,
                            F = E.invID,
                            o = Iu.crewPanel.role.$dyn(i),
                            D = Iu.crewPanel.slogan.$dyn(i),
                            s = (0, r.useMemo)(() => ({ tooltipId: 'crewPerkGf', invID: F }), [F]),
                            l = g()(ku.member, ku[`member__${i}`]);
                        return n().createElement(
                            'div',
                            { className: ku.base },
                            n().createElement(
