    ...
    var u,
        e = {
            ...
            229: (u, e, t) => {
                ...
                var E = {};
                (t.r(E), t.d(E, { getBgUrl: () => x, getTextureUrl: () => _ }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        addModelObserver: () => P,
                ...
                const ru = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            Eu({}, r, {
                                className: C()(Au.base, Au[`base__theme-${E}`], A),
                                ref: function (u) {
                ...
                const ou = eu.client.getSize('rem'),
                    mu = ou.width,
                    su = ou.height,
                    du = Object.assign({ width: mu, height: su }, lu(mu, su, iu)),
                    cu = (0, D.createContext)(du),
                    gu = ['children'];
                const hu = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    const A = (0, D.useContext)(cu),
                        ...
                        h = { extraLarge: m, large: s, medium: d, small: c, extraSmall: g };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && B) return Bu(e, t, h);
                        if (t.largeWidth && i) return Bu(e, t, h);
                        if (t.mediumWidth && C) return Bu(e, t, h);
                        if (t.smallWidth && l) return Bu(e, t, h);
                        if (t.extraSmallWidth && o) return Bu(e, t, h);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                    ...
                    const e = (0, D.useContext)(cu),
                        ...
                        E = (0, D.useCallback)((u, e) => {
                            const t = eu.view.pxToRem(u),
                                A = eu.view.pxToRem(e);
                            F(Object.assign({ width: t, height: A }, lu(t, A, iu)));
                        }, []);
                    (_u(() => {
                ...
                const vu = () => {
                    ...
                    bu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    wu = (u) => u.includes('_') && ((u) => bu.includes(u))(u.split('_').at(-1)),
                    Su = [xu.ExtraLarge, xu.Large, xu.Medium, xu.Small, xu.ExtraSmall],
                    Lu = (u, e) =>
                ...
                const Hu = {
                    ...
                    Wu = Mu((u) => {
                        let e = u.className,
                            ...
                            b =
                                void 0 === v
                                    ...
                                    : v,
                            w = u.alignItems,
                            S = void 0 === w ? (h ? 'flex-start' : _ && 'center') || (x && 'flex-end') || void 0 : w,
                            L = u.alignSelf,
                            M = u.wrap,
                            R = u.flexWrap,
                        ...
                        const j = (0, D.useMemo)(() => {
                            ...
                            }, [t, A, r, B, l, m, W, P, L, g, y, b, S]),
                            X = j.computedStyle,
                            I = j.computedClassNames;
                        return n().createElement('div', Tu({ className: C()(Ru.base, ...I, e), style: X }, N), G);
                    });
                let Gu;
                !(function (u) {
                ...
                const Nu = (u, e, t) => {
                    ...
                    Xu = (u, e, t = Gu.left) => u.split(e).reduce(t === Gu.left ? Nu : ju, []),
                    Iu = (() => {
                        const u = new RegExp(
                        ...
                        return zu.includes(t)
                            ...
                            : ((u, e = Gu.left) => {
                                  ...
                                  const A =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return (Xu(F, /( )/, e).forEach((u) => (t = t.concat(Xu(u, A, Gu.left)))), t);
                              })(u, e);
                    },
                    Vu = 'FormatText_base_d0',
                    Uu = ({ binding: u, text: e = '', classMix: t, alignment: A = Gu.left }) =>
                        null === e
                ...
                const Zu = Object.keys(Ku()),
                    ...
                    Ee = Mu((u) => {
                        ...
                        return n().createElement(
                            ...
                            Qu(
                                {
                                    className: C()(Yu.base, t && Yu[t], x, A),
                                    style: _,
                            ...
                            void 0 !== c ? n().createElement(Uu, Qu({}, c, { text: e })) : e,
                        );
                    });
                function re() {}
                function De() {
                ...
                const Ce = ((u, e) => {
                        ...
                        return [
                            function ({ mode: A = 'real', options: F, children: E, mocks: r }) {
                                const a = (0, D.useRef)([]),
                                    ...
                                    l = C[0],
                                    o = C[1],
                                    m = (0, D.useState)(() => B(A, F, r)),
                                    s = m[0],
                                    d = m[1];
                                return (
                                    (0, D.useEffect)(() => {
                                        i.current ? d(B(l, F, r)) : (i.current = !0);
                                    }, [r, l, F]),
                                    (0, D.useEffect)(() => {
                                        o(A);
                                    }, [A]),
                                    ...
                                    n().createElement(t.Provider, { value: s }, E)
                                );
                            },
                            () => (0, D.useContext)(t),
                        ];
                        ...
                        const e = {
                            root: u.object(),
                            primitives: u.primitives(['minVehicleLevel', 'maxVehicleLevel', 'branchName']),
                        };
                        ...
                        he
                            ...
                            : (function (u) {
                                  ...
                                  for (let t = ge.length - 1; t >= 0; t--)
                                      for (; u >= ge[t];) ((e += ce[t]), (u -= ge[t]));
                                  return e;
                              })(u),
                    xe = R.strings.personal_missions_3.VehicleTabs.tooltip,
                    fe = (0, Du.Pi)(() => {
                        const u = oe().model,
                            e = _e(u.primitives.minVehicleLevel.get()),
                            t = _e(u.primitives.maxVehicleLevel.get()),
                            A = u.primitives.branchName.get();
                        return n().createElement(
                            ru,
                            null,
                            n().createElement(
                                ...
                                n().createElement(Ee, {
                                    className: se,
                                    format: { binding: { branchName: A } },
                                    text: xe.title(),
                                }),
                                n().createElement(Ee, {
                                    className: de,
                                    format: { binding: { minVehicleLevel: e, maxVehicleLevel: t } },
                                    text: xe.subtitle(),
                                }),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    B().render(
                        n().createElement(le, null, n().createElement(fe, null)),
    ...
    ((A.m = e),
        ...
        (A.O = (e, t, F, E) => {
            if (!t) {
                ...
                for (B = 0; B < u.length; B++) {
                    for (var [t, F, E] = u[B], D = !0, n = 0; n < t.length; n++)
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); a < r.length; a++) ((E = r[a]), A.o(u, E) && u[E] && u[E][0](), (u[E] = 0));
                    return A.O(B);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
        })());
    var F = A.O(void 0, [650], () => A(229));
    F = A.O(F);
})();
