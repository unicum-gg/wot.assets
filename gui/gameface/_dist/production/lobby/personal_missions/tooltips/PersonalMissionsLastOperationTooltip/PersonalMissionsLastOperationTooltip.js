        ...
        e = {
            ...
            143: (u, e, t) => {
                ...
                const ou = q.client.getSize('rem'),
                    lu = ou.width,
                    Cu = ou.height,
                    mu = Object.assign({ width: lu, height: Cu }, Bu(lu, Cu, Du)),
                ...
                const cu = (u) => {
                    ...
                    const r = (0, Q.useContext)(su),
                        ...
                        _ = { extraLarge: C, large: m, medium: s, small: d, extraSmall: c };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && D) return nu(e, t, _);
                        if (t.largeWidth && i) return nu(e, t, _);
                        if (t.mediumWidth && B) return nu(e, t, _);
                        if (t.smallWidth && o) return nu(e, t, _);
                        if (t.extraSmallWidth && l) return nu(e, t, _);
                        if (
                ...
                (0, Q.memo)(({ children: u }) => {
                    const e = (0, Q.useContext)(su),
                        ...
                        E = (0, Q.useCallback)((u, e) => {
                            const t = q.view.pxToRem(u),
                                r = q.view.pxToRem(e);
                            A(Object.assign({ width: t, height: r }, Bu(t, r, Du)));
                        }, []);
                    (_u(() => {
                    ...
                    return Z().createElement(su.Provider, { value: F }, u);
                });
                let gu, pu, hu;
                (!(function (u) {
                ...
                const xu = () => {
                    ...
                    bu = [gu.ExtraLarge, gu.Large, gu.Medium, gu.Small, gu.ExtraSmall],
                    wu = (u, e) =>
                ...
                const Mu = {
                    ...
                    Ou = Su((u) => {
                        let e = u.className,
                            ...
                            m = u.row,
                            s = u.flexDirection,
                            d = void 0 === s ? (C ? 'column' : m && 'row') || void 0 : s,
                            c = u.flexStart,
                            _ = u.center,
                            g = u.flexEnd,
                            p = u.spaceBetween,
                            ...
                            f =
                                void 0 === x
                                    ...
                                    : x,
                            v = u.alignItems,
                            b = void 0 === v ? (c ? 'flex-start' : _ && 'center') || (g && 'flex-end') || void 0 : v,
                            w = u.alignSelf,
                            S = u.wrap,
                            L = u.flexWrap,
                            ...
                            M = u.shrink,
                            R = u.flex,
                            H = void 0 === R ? (y || M ? `${y ? 1 : 0} ${M ? 1 : 0} auto` : void 0) : R,
                            O = u.style,
                            N = u.children,
                            P = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const W = (0, Q.useMemo)(() => {
                                const u = { mt: F, mr: D, mb: B, ml: l },
                                    e = ((u) =>
                                        Ru.reduce((e, t) => {
                                            const r = u[t];
                                            return r && 'number' != typeof r ? e.concat(Mu[!0 === r ? 'MD' : r][t]) : e;
                                        }, []))(u),
                                    A = ((u) =>
                                        Ru.reduce((e, t) => {
                                            const r = u[t];
                            ...
                            }, [t, r, F, D, B, l, O, H, w, d, T, f, b]),
                            G = W.computedStyle,
                            I = W.computedClassNames;
                        return Z().createElement('div', yu({ className: n()(Lu.base, ...I, e), style: G }, P), N);
                    });
                let Nu;
                function Pu(u, e) {
                ...
                const Wu = (u) => u.replace(/&zwnbsp;/g, '\ufeff'),
                    ...
                    ju = (u, e, t = Nu.left) => u.split(e).reduce(t === Nu.left ? Gu : Iu, []),
                    Xu = (() => {
                        const u = new RegExp(
                        ...
                        return zu.includes(t)
                            ...
                            : ((u, e = Nu.left) => {
                                  ...
                                  const r =
                                      ...
                                      A = u.replace(/&nbsp;/g, ' ');
                                  return (ju(A, /( )/, e).forEach((u) => (t = t.concat(ju(u, r, Nu.left)))), t);
                              })(u, e);
                    },
                        ...
                        null === e
                            ...
                            : Z().createElement(
                                  ...
                                  e.split('\n').map((e, A) =>
                                      Z().createElement(
                                          'div',
                                          { className: n()($u, t), key: `${e}-${A}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : ku(u, e))))(e, r, u).map((u, e) =>
                ...
                const Zu = Object.keys(Ku()),
                    ...
                    Ee = Su((u) => {
                        ...
                        return Z().createElement(
                            ...
                            Qu(
                                {
                                    className: n()(Yu.base, t && Yu[t], g, r),
                                    style: _,
                                    mt: !0 === a ? re[t || 'paragraph-P16'].mt : a,
                                    mr: !0 === i ? re[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === o ? re[t || 'paragraph-P16'].mb : o,
                                    ml: !0 === C ? re[t || 'paragraph-P16'].ml : C,
                                },
                                d,
                            ),
                            void 0 !== s ? Z().createElement(Vu, Qu({}, s, { text: e })) : e,
                        );
                    });
                let Fe;
                !(function (u) {
                    ((u.Development = 'development'), (u.Active = 'active'), (u.Completed = 'completed'));
                })(Fe || (Fe = {}));
                var ae = t(515);
                const ne = 'completed',
                    De = 'active',
                ...
                const ce = ((u, e) => {
                                    ...
                                    n = (t, r, A) => {
                                        ...
                                        const F = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Ce(A.keys()); !(u = t()).done; ) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(r),
                                            ...
                                            o = { mode: t, model: B, externalModel: n, cleanup: i };
                                        return {
                                            model: B,
                    ...
                    pe = {
                        base: 'App_base_98',
                        base__development: 'App_base__development_44',
                        base__completed: 'App_base__completed_a7',
                        bg: 'App_bg_7b',
                        content: 'App_content_08',
                        paddingContent: 'App_paddingContent_63',
                        header: 'App_header_d6',
                        subtitle: 'App_subtitle_4c',
                        subtitle__rewards: 'App_subtitle__rewards_7d',
                        description: 'App_description_53',
                        description__body: 'App_description__body_45',
                        developmentLabel: 'App_developmentLabel_c7',
                        labelText: 'App_labelText_a4',
                        counterWrapper: 'App_counterWrapper_b5',
                        counterBg: 'App_counterBg_0f',
                        operationText: 'App_operationText_52',
                        operationText__description: 'App_operationText__description_9a',
                        operationText__done: 'App_operationText__done_37',
                        operationText__divider: 'App_operationText__divider_63',
                        operationText__completed: 'App_operationText__completed_bf',
                        operationText__active: 'App_operationText__active_47',
                        operationText__empty: 'App_operationText__empty_9d',
                        rewardsSection: 'App_rewardsSection_e5',
                        rewardsWrapper: 'App_rewardsWrapper_17',
                        reward: 'App_reward_fa',
                        reward__lastInRow: 'App_reward__lastInRow_e6',
                        rewardIcon: 'App_rewardIcon_e3',
                        rewardText: 'App_rewardText_a8',
                        ribbon: 'App_ribbon_70',
                        operationStatus: 'App_operationStatus_1f',
                        divider: 'App_divider_0e',
                        footer: 'App_footer_ed',
                        footerLabel: 'App_footerLabel_91',
                        base__available: 'App_base__available_45',
                        base__disabled: 'App_base__disabled_37',
                        footerLabelIcon: 'App_footerLabelIcon_86',
                        footerLabelText: 'App_footerLabelText_2c',
                        footerBottomWrapper: 'App_footerBottomWrapper_07',
                        footerBottomText: 'App_footerBottomText_b0',
                        dCFooter: 'App_dCFooter_fb',
                        dCFooterIcon: 'App_dCFooterIcon_7a',
                        dCFooterText: 'App_dCFooterText_d7',
                    },
                    he = R.strings.personal_missions_3.tooltips.OperationsView.lastOperation,
                    xe = (0, ae.Pi)(() => {
                        const u = ge().model,
                            e = u.root.get(),
                            t = e.missionStatus,
                            ...
                            E = e.all,
                            F = e.vehicleName,
                            a = u.computes.getRewards(),
                            D = t === Fe.Completed,
                            i = t === Fe.Active,
                            B = t === Fe.Development,
                            o = ((u, e) => (u ? (u < e ? De : ne) : ie))(A, E),
                            l = B && o === ne,
                            C = D || l,
                            m = Z().createElement(
                                'div',
                                { className: pe.operationStatus },
                                    ...
                                    D &&
                                        Z().createElement(
                                            ...
                                            Z().createElement(Ee, {
                                                ...
                                                text: he.completed.footerSubtitle(),
                                            }),
                                        ),
                                ),
                            );
                        return Z().createElement(
                            'div',
                            { className: n()(pe.base, pe[`base__${t}`]) },
                            Z().createElement('div', { className: pe.bg }),
                            B &&
                                Z().createElement(
                                    'div',
                                    { className: pe.developmentLabel },
                                    Z().createElement(Ee, { className: pe.labelText, text: F }),
                                ),
                            Z().createElement(
                                'div',
                                ...
                                Z().createElement(
                                    'div',
                                    { className: pe.paddingContent },
                                    Z().createElement(Ee, {
                                        className: pe.header,
                                        text: B ? he.development.header() : he.header(),
                                        format: { binding: { name: r } },
                                    }),
                                    !D &&
                                        Z().createElement(
                                            Z().Fragment,
                                            ...
                                            i &&
                                                Z().createElement(Ee, {
                                                    ...
                                                    text: he.active.subtitle(),
                                                }),
                                            Z().createElement(Ee, {
                                                className: pe.description,
                                                text: Wu(Pu(String(he.$dyn(t).body()), { name: r })),
                                            }),
                                            B &&
                                                Z().createElement(Ee, {
                                                    className: pe.subtitle,
                                                    text: he.development.subtitle(),
                                                }),
                                            B && m,
                                            !D &&
                                                Z().createElement(
                                                    'div',
                                                    { className: pe.counterWrapper },
                                                    Z().createElement('div', { className: pe.counterBg }),
                                                    Z().createElement(Ee, {
                                                        className: n()(pe.operationText, pe.operationText__description),
                                                        text: he.active.completedText(),
                                                    }),
                                                    Z().createElement(Ee, {
                                                        className: n()(
                                                            pe.operationText__done,
                                                            pe[`operationText__${o}`],
                                                        ),
                                                        text: String(A),
                                                    }),
                                                    Z().createElement(Ee, {
                                                        className: n()(
                                                            ...
                                                            C && pe[`operationText__${o}`],
                                                        ),
                                                        text: R.strings.personal_missions_3.tooltips.OperationsView.operation.divider(),
                                                    }),
                                                    Z().createElement(Ee, {
                                                        className: n()(
                                                            pe.operationText,
                                            ...
                                            B &&
                                                Z().createElement(Ee, {
                                                    className: n()(pe.description, pe.description__body),
                                                    text: Wu(Pu(he.development.bodyDescription(), { name: r })),
                                                }),
                                            Z().createElement(
                                                'div',
                                                ...
                                                Z().createElement(Ee, {
                                                    className: n()(pe.subtitle, pe.subtitle__rewards),
                                                    text: String(he.$dyn(t).rewards()),
                                                }),
                                                Z().createElement(
                                                    'div',
                                                    { className: pe.rewardsWrapper },
                                                    a.map((u, e) => {
                                                        const t = e + 1 === a.length;
                                                        return Z().createElement(
                                                            'div',
                                                            {
                                                                key: u.icon,
                                                                className: n()(pe.reward, t && pe.reward__lastInRow),
                                                            },
                                                            Z().createElement('div', {
                                ...
                                l
                                    ? Z().createElement(
                                          'div',
                                          { className: pe.dCFooter },
                                          Z().createElement('div', { className: pe.dCFooterIcon }),
                                          Z().createElement(Ee, {
                                              text: he.developmentCompleted.footer(),
                                              className: pe.dCFooterText,
                                          }),
                                      )
                                    : !B && m,
                            ),
                ...
                engine.whenReady.then(() => {
                    Eu().render(
                        Z().createElement(_e, null, Z().createElement(ru, null, Z().createElement(xe, null))),
