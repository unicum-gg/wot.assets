            ...
            501: (u, e, t) => {
                ...
                const Eu = J().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        J().createElement(
                            'div',
                            Au({}, r, {
                                className: n()(eu.base, eu[`base__theme-${F}`], A),
                                ref: function (u) {
                ...
                const Ru = {
                    ...
                    Pu = Lu((u) => {
                        ...
                        return J().createElement('div', Tu({ className: n()(yu.base, ...j, e), style: G }, W), P);
                    });
                let Wu;
                !(function (u) {
                ...
                const ie = ((u, e) => {
                        ...
                        return [
                            function ({ mode: A = 'real', options: E, children: F, mocks: r }) {
                                const D = (0, Z.useRef)([]),
                                    ...
                                    i = B[0],
                                    C = B[1],
                                    l = (0, Z.useState)(() => n(A, E, r)),
                                    o = l[0],
                                    m = l[1];
                                return (
                                    (0, Z.useEffect)(() => {
                                        a.current ? m(n(i, E, r)) : (a.current = !0);
                                    }, [r, i, E]),
                                    (0, Z.useEffect)(() => {
                                        C(A);
                                    }, [A]),
                    ...
                    oe = {
                        base: 'App_base_a5',
                        title: 'App_title_60',
                        defaultText: 'App_defaultText_ef',
                        contentTitle: 'App_contentTitle_24',
                        conditionsTitle: 'App_conditionsTitle_d7',
                    },
                    me = R.strings.personal_missions_3.tooltips.QuestInfoTooltip,
                    se = (u, e) => {
                        const t = e ? me.mainCondition() : me.secondaryCondition();
                        return J().createElement(Ee, {
                            className: oe.defaultText,
                            text: u,
                            format: {
                                binding: {
                                    condition: J().createElement(Ee, { className: oe.conditionsTitle, text: t }),
                                },
                            },
                        });
                    },
                    de = (0, Fe.Pi)(() => {
                        const u = le().model.root.get().type,
                            e = me.firstText.$dyn(`type${u}`),
                            t = me.secondText.$dyn(`type${u}`),
                            A = me.thirdText.$dyn(`type${u}`),
                            E = me.firstBlock.title.$dyn(`type${u}`),
                            F = me.firstBlock.content.$dyn(`type${u}`),
                            r = me.secondBlock.title.$dyn(`type${u}`),
                            D = me.secondBlock.content.$dyn(`type${u}`),
                            n = me.firstCondition.$dyn(`type${u}`),
                            a = me.secondCondition.$dyn(`type${u}`);
                        return J().createElement(
                            'div',
                            { className: oe.base },
                            J().createElement(Ee, { className: oe.title, text: me.title() }),
                            J().createElement(Ee, { className: oe.defaultText, text: e }),
                            F &&
                                J().createElement(
                                    'div',
                                    { className: oe.contentBlock },
                                    J().createElement(Ee, { className: oe.contentTitle, text: E }),
                                    J().createElement(Ee, { className: oe.defaultText, text: F }),
                                ),
                            D &&
                                J().createElement(
                                    'div',
                                    { className: oe.contentBlock },
                                    J().createElement(Ee, { className: oe.contentTitle, text: r }),
                                    J().createElement(Ee, { className: oe.defaultText, text: D }),
                                ),
                            n && se(n, !0),
                            a && se(a, !1),
                            t && J().createElement(Ee, { className: oe.defaultText, text: t }),
                            A && J().createElement(Ee, { className: oe.defaultText, text: A }),
                        );
                    });
                engine.whenReady.then(() => {
                    ru().render(
                        J().createElement(Eu, null, J().createElement(Ce, null, J().createElement(de, null))),
