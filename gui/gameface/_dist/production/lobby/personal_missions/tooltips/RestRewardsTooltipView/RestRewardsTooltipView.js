(() => {
    var __webpack_modules__ = {
            ...
            471: (u, e, t) => {
                ...
                (0, i.memo)(({ children: u }) => {
                    const e = (0, i.useContext)(ru),
                        ...
                        o = (0, i.useCallback)((u, e) => {
                            ...
                            n(Object.assign({ width: t, height: r }, Z(t, r, K)));
                        }, []);
                    (iu(() => {
                    ...
                    return s().createElement(ru.Provider, { value: E }, u);
                });
                let su, ou, Eu;
                (!(function (u) {
                ...
                const Fu = (u) => ('overlayType' in u ? u.overlayType : void 0),
                    Du = (u, e) => {
                        const t = Au(),
                            r = e || (t.mediaSize < su.Medium ? x.Small : x.Big);
                        var n, a;
                        return {
                            parsedRewards:
                                ((n = u),
                        ...
                        const h = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, i.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Bu(t, c, { isMouseEvent: !0, on: !0, arguments: _u(r) }, b),
                                    C && C(),
                ...
                const Pu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Ou = (u) => u.includes('_') && ((u) => Pu.includes(u))(u.split('_').at(-1)),
                    Mu = [su.ExtraLarge, su.Large, su.Medium, su.Small, su.ExtraSmall],
                    yu = (u, e) =>
                ...
                const Uu = {
                    ...
                    Wu = Lu((u) => {
                        ...
                        return s().createElement('div', Iu({ className: n()(Nu.base, ...W, e), style: G }, U), I);
                    });
                let Xu;
                !(function (u) {
                ...
                const ju = (u, e, t) => {
                    ...
                    Yu = (u, e, t = Xu.left) => u.split(e).reduce(t === Xu.left ? ju : qu, []),
                    $u = (() => {
                        const u = new RegExp(
                        ...
                        return zu.includes(t)
                            ...
                            : ((u, e = Xu.left) => {
                                  ...
                                  const r =
                                      ...
                                      n = u.replace(/&nbsp;/g, ' ');
                                  return (Yu(n, /( )/, e).forEach((u) => (t = t.concat(Yu(u, r, Xu.left)))), t);
                              })(u, e);
                    },
                    Ku = 'FormatText_base_d0',
                    Qu = ({ binding: u, text: e = '', classMix: t, alignment: r = Xu.left }) =>
                        null === e
                            ...
                            : s().createElement(
                                  ...
                                  e.split('\n').map((e, a) =>
                                      s().createElement(
                                          'div',
                                          { className: n()(Ku, t), key: `${e}-${a}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : Vu(u, e))))(e, r, u).map((u, e) =>
                ...
                const re = Object.keys(Ju()),
                    ...
                    Ae = Lu((u) => {
                        ...
                        return s().createElement(
                            ...
                            te(
                                {
                                    className: n()(ue.base, t && ue[t], h, r),
                                    style: p,
                                    mt: !0 === A ? oe[t || 'paragraph-P16'].mt : A,
                                    mr: !0 === F ? oe[t || 'paragraph-P16'].mr : F,
                                    mb: !0 === c ? oe[t || 'paragraph-P16'].mb : c,
                                    ml: !0 === B ? oe[t || 'paragraph-P16'].ml : B,
                                },
                                C,
                            ),
                            void 0 !== d ? s().createElement(Qu, te({}, d, { text: e })) : e,
                        );
                    }),
                    le = 'App_base_56',
                    Fe = 'App_base__wide_26',
                    De = 'App_background_06',
                    ce = 'App_content_87',
                    _e = 'App_header_3a',
                    Be = 'App_rewards_9b',
                    me = 'App_reward_fa',
                    de = 'App_description_b2';
                function Ce() {
                    return (
                        (Ce =
                            Object.assign ||
                ...
                const ge = R.strings.personal_missions_3.tooltips.RestRewards,
                    pe = (0, _.Pi)(() => {
                        const u = w().model,
                            e = u.computes.getRewardsLength,
                            t = u.rewards.get(),
                            r = Du(t, x.Small).parsedRewards,
                            a = e() > 10;
                        return s().createElement(
                            'div',
                            { className: n()(le, a && Fe) },
                            ...
                            s().createElement(
                                'div',
                                { className: ce },
                                s().createElement(Ae, { className: _e, text: ge.header() }),
                                s().createElement(
                                    'div',
                                    { className: Be },
                                    r.map((u, e) =>
                                        s().createElement(
                                            'div',
                                            { className: me, key: `rewards-${e}` },
                                            s().createElement(xu, Ce({}, u, { valueType: X(u.name), image: Y(u) })),
                                            s().createElement(Ae, { className: de, text: u.label }),
                                        ),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    c().render(
                        s().createElement(v, null, s().createElement(F, null, s().createElement(pe, null))),
