(() => {
    var __webpack_modules__ = {
            ...
            471: (u, e, t) => {
                ...
                const F = s().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        s().createElement(
                            'div',
                            l({}, c, {
                                className: n()(E.base, E[`base__theme-${D}`], r),
                                ref: function (u) {
                ...
                const b = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: n, children: o, mocks: E }) {
                                const A = (0, i.useRef)([]),
                                    l = (t, r, n) => {
                                        var i;
                                        const s = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = C(n.keys()); !(u = t()).done; ) i(u.value, e);
                                                    },
                                                    unsubscribe: i,
                                                };
                                            })(r),
                                            ...
                                            D = { mode: t, model: F, externalModel: o, cleanup: l };
                                        return {
                                            model: F,
                                    ...
                                    c = D[0],
                                    _ = D[1],
                                    B = (0, i.useState)(() => l(r, n, E)),
                                    g = B[0],
                                    h = B[1];
                                return (
                                    (0, i.useEffect)(() => {
                                        F.current ? h(l(c, n, E)) : (F.current = !0);
                                    }, [E, c, n]),
                                    (0, i.useEffect)(() => {
                                        _(r);
                                    }, [r]),
                        ...
                        const e = { root: u.object(), rewards: u.array('rewards', []) },
                            t = (0, h.Om)(() => e.rewards.get().length);
                        return Object.assign({}, e, { computes: { getRewardsLength: t } });
                    }, B),
                    v = b[0],
                    w = b[1];
                let f, S, x, T, P, O, M;
                ...
                const N = [
                    ...
                    k = [f.Gold, f.Credits, f.Crystal, f.FreeXp],
                    I = [f.BattlePassPoints],
                    U = [f.PremiumPlus, f.Premium];
                let H;
                !(function (u) {
                    ((u.s16 = '16'),
                        (u.s32 = '32'),
                ...
                const K = a.O.client.getSize('rem'),
                    Q = K.width,
                    Z = K.height,
                    J = Object.assign({ width: Q, height: Z }, V(Q, Z, $)),
                    uu = (0, i.createContext)(J),
                    eu = ['children'];
                const tu = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    const r = (0, i.useContext)(uu),
                        ...
                        g = { extraLarge: _, large: B, medium: m, small: d, extraSmall: C };
                ...
                (0, i.memo)(({ children: u }) => {
                    const e = (0, i.useContext)(uu),
                        ...
                        o = (0, i.useCallback)((u, e) => {
                            ...
                            n(Object.assign({ width: t, height: r }, V(t, r, $)));
                        }, []);
                    (ru(() => {
                    ...
                    return s().createElement(uu.Provider, { value: E }, u);
                });
                let nu, au, iu;
                (!(function (u) {
                ...
                const su = () => {
                    ...
                    return { mediaSize: r, mediaWidth: n, mediaHeight: a, remScreenWidth: e, remScreenHeight: t };
                };
                function ou() {
                    return (
                        (ou =
                ...
                const Eu = (u) => ('overlayType' in u ? u.overlayType : void 0),
                    Au = (u, e) => {
                        const t = su(),
                            r = e || (t.mediaSize < nu.Medium ? x.Small : x.Big);
                        var n, a;
                        return {
                            parsedRewards:
                                ((n = u),
                        ...
                        const h = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, i.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Du(t, c, { isMouseEvent: !0, on: !0, arguments: Fu(r) }, b),
                                    C && C(),
                ...
                const bu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return s().createElement(pu, e, r);
                        const n = e.contentId,
                            a = e.args,
                            i = null == a ? void 0 : a.contentId;
                        return n || i
                            ? s().createElement(cu, hu({}, e, { contentId: n || i }), r)
                            : s().createElement(mu, e, r);
                    },
                    vu = {
                        base: 'Reward_base_ea',
                    ...
                    wu = ({
                        ...
                        const c = ((u) => {
                            ...
                            B = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case T.CURRENCY:
                                    case T.NUMBER:
                                        return s().createElement(L, { format: 'integral', value: Number(u) });
                                    case T.PREMIUM_PLUS: {
                                        const e = Number(u);
                        ...
                        return s().createElement(
                            'div',
                            { className: n()(vu.base, vu[`base__${r}`], A), style: E },
                            s().createElement(
                                bu,
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        'div',
                                        { className: n()(vu.image, null == l ? void 0 : l.image) },
                                        c &&
                                            s().createElement('div', {
                                                className: n()(vu.highlight, null == l ? void 0 : l.highlight),
                                                style: {
                                        ...
                                        e &&
                                            s().createElement('div', {
                                                className: n()(vu.icon, null == l ? void 0 : l.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        _ &&
                                            s().createElement('div', {
                                                className: n()(vu.overlay, null == l ? void 0 : l.overlay),
                                                style: {
                            ...
                            t &&
                                s().createElement(
                                    ...
                                    { tooltipArgs: D },
                                    s().createElement('div', {
                                        className: n()(vu.timer, null == l ? void 0 : l.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const xu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Ru = (u) => u.includes('_') && ((u) => xu.includes(u))(u.split('_').at(-1)),
                    Tu = [nu.ExtraLarge, nu.Large, nu.Medium, nu.Small, nu.ExtraSmall],
                    Pu = (u, e) =>
                ...
                const Nu = {
                    ...
                    Uu = Ou((u) => {
                        let e = u.className,
                            ...
                            y = u.shrink,
                            L = u.flex,
                            N = void 0 === L ? (M || y ? `${M ? 1 : 0} ${y ? 1 : 0} auto` : void 0) : L,
                            k = u.style,
                            I = u.children,
                            U = (function (u, e) {
                                if (null == u) return {};
                        ...
                        return s().createElement('div', Lu({ className: n()(Mu.base, ...W, e), style: G }, U), I);
                    });
                let Hu;
                !(function (u) {
                ...
                const Gu = (u, e, t) => {
                    ...
                    Xu = (u, e, t = Hu.left) => u.split(e).reduce(t === Hu.left ? Gu : Wu, []),
                    ju = (() => {
                        const u = new RegExp(
                        ...
                        return Yu.includes(t)
                            ...
                            : ((u, e = Hu.left) => {
                                  ...
                                  const r =
                                      ...
                                      n = u.replace(/&nbsp;/g, ' ');
                                  return (Xu(n, /( )/, e).forEach((u) => (t = t.concat(Xu(u, r, Hu.left)))), t);
                              })(u, e);
                    },
                    $u = 'FormatText_base_d0',
                    zu = ({ binding: u, text: e = '', classMix: t, alignment: r = Hu.left }) =>
                        null === e
                ...
                const ue = Object.keys(Ku()),
                    ...
                    se = Ou((u) => {
                        ...
                        return s().createElement(
                            ...
                            Ju(
                                {
                                    className: n()(Qu.base, t && Qu[t], h, r),
                                    style: p,
                                    mt: !0 === A ? ae[t || 'paragraph-P16'].mt : A,
                                    mr: !0 === F ? ae[t || 'paragraph-P16'].mr : F,
                                    mb: !0 === c ? ae[t || 'paragraph-P16'].mb : c,
                                    ml: !0 === B ? ae[t || 'paragraph-P16'].ml : B,
                                },
                                C,
                            ),
                            void 0 !== d ? s().createElement(zu, Ju({}, d, { text: e })) : e,
                        );
                    }),
                    oe = 'App_base_56',
                    Ee = 'App_base__wide_26',
                    Ae = 'App_background_06',
                    le = 'App_content_87',
                    Fe = 'App_header_3a',
                    De = 'App_rewards_9b',
                    ce = 'App_reward_fa',
                    _e = 'App_description_b2';
                function Be() {
                    return (
                        (Be =
                            Object.assign ||
                ...
                const me = R.strings.personal_missions_3.tooltips.RestRewards,
                    de = (0, _.Pi)(() => {
                        const u = w().model,
                            e = u.computes.getRewardsLength,
                            t = u.rewards.get(),
                            r = Au(t, x.Small).parsedRewards,
                            a = e() > 10;
                        return s().createElement(
                            'div',
                            { className: n()(oe, a && Ee) },
                            ...
                            s().createElement(
                                'div',
                                { className: le },
                                s().createElement(se, { className: Fe, text: me.header() }),
                                s().createElement(
                                    'div',
                                    { className: De },
                                    r.map((u, e) =>
                                        s().createElement(
                                            'div',
                                            { className: ce, key: `rewards-${e}` },
                                            s().createElement(wu, Be({}, u, { valueType: G(u.name), image: j(u) })),
                                            s().createElement(se, { className: _e, text: u.label }),
                                        ),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    c().render(
                        s().createElement(v, null, s().createElement(F, null, s().createElement(de, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [650], () => __webpack_require__(471));
