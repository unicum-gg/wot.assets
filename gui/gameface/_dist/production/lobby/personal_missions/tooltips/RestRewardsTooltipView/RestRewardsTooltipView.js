    ...
    var __webpack_modules__ = {
            ...
            471: (u, e, t) => {
                ...
                const k = [
                    ...
                    I = [f.Gold, f.Credits, f.Crystal, f.FreeXp],
                    U = [f.BattlePassPoints],
                    H = [f.PremiumPlus, f.Premium];
                let G;
                !(function (u) {
                    ((u.s16 = '16'),
                        (u.s32 = '32'),
                ...
                const Q = a.O.client.getSize('rem'),
                    Z = Q.width,
                    J = Q.height,
                    uu = Object.assign({ width: Z, height: J }, K(Z, J, z)),
                    eu = (0, i.createContext)(uu),
                    tu = ['children'];
                const ru = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && A) return $(e, t, g);
                        if (t.largeWidth && l) return $(e, t, g);
                        if (t.mediumWidth && F) return $(e, t, g);
                        if (t.smallWidth && D) return $(e, t, g);
                        if (t.extraSmallWidth && c) return $(e, t, g);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                ...
                (0, i.memo)(({ children: u }) => {
                    const e = (0, i.useContext)(eu),
                        ...
                        o = (0, i.useCallback)((u, e) => {
                            ...
                            n(Object.assign({ width: t, height: r }, K(t, r, z)));
                        }, []);
                    (nu(() => {
                    ...
                    return s().createElement(eu.Provider, { value: E }, u);
                });
                let au, iu, su;
                (!(function (u) {
                ...
                const Au = (u) => ('overlayType' in u ? u.overlayType : void 0),
                    lu = (u, e) => {
                        const t = ou(),
                            r = e || (t.mediaSize < au.Medium ? x.Small : x.Big);
                        var n, a;
                        return {
                            parsedRewards:
                                ((n = u),
                        ...
                        const h = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, i.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (cu(t, c, { isMouseEvent: !0, on: !0, arguments: Du(r) }, b),
                                    C && C(),
                ...
                const vu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return s().createElement(hu, e, r);
                        const n = e.contentId,
                            a = e.args,
                            i = null == a ? void 0 : a.contentId;
                        return n || i
                            ? s().createElement(_u, bu({}, e, { contentId: n || i }), r)
                            : s().createElement(du, e, r);
                    },
                    wu = {
                        base: 'Reward_base_ea',
                    ...
                    fu = ({
                        ...
                        const c = ((u) => {
                            ...
                            B = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case T.CURRENCY:
                                    case T.NUMBER:
                                        return s().createElement(N, { format: 'integral', value: Number(u) });
                                    case T.PREMIUM_PLUS: {
                                        const e = Number(u);
                        ...
                        return s().createElement(
                            'div',
                            { className: n()(wu.base, wu[`base__${r}`], A), style: E },
                            s().createElement(
                                vu,
                                { tooltipArgs: F, className: wu.tooltipWrapper },
                                s().createElement(
                                    s().Fragment,
                                    null,
                                    s().createElement(
                                        'div',
                                        { className: n()(wu.image, null == l ? void 0 : l.image) },
                                        c &&
                                            s().createElement('div', {
                                                className: n()(wu.highlight, null == l ? void 0 : l.highlight),
                                                style: {
                                        ...
                                        e &&
                                            s().createElement('div', {
                                                className: n()(wu.icon, null == l ? void 0 : l.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        _ &&
                                            s().createElement('div', {
                                                className: n()(wu.overlay, null == l ? void 0 : l.overlay),
                                                style: {
                            ...
                            t &&
                                s().createElement(
                                    ...
                                    { tooltipArgs: D },
                                    s().createElement('div', {
                                        className: n()(wu.timer, null == l ? void 0 : l.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const Ru = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Tu = (u) => u.includes('_') && ((u) => Ru.includes(u))(u.split('_').at(-1)),
                    Pu = [au.ExtraLarge, au.Large, au.Medium, au.Small, au.ExtraSmall],
                    Ou = (u, e) =>
                ...
                const ku = {
                    ...
                    Hu = Mu((u) => {
                        ...
                        return s().createElement('div', Nu({ className: n()(yu.base, ...W, e), style: G }, U), I);
                    });
                let Gu;
                !(function (u) {
                ...
                const Wu = (u, e, t) => {
                    ...
                    ju = (u, e, t = Gu.left) => u.split(e).reduce(t === Gu.left ? Wu : Xu, []),
                    Yu = (() => {
                        const u = new RegExp(
                        ...
                        return qu.includes(t)
                            ...
                            : ((u, e = Gu.left) => {
                                  ...
                                  const r =
                                      ...
                                      n = u.replace(/&nbsp;/g, ' ');
                                  return (ju(n, /( )/, e).forEach((u) => (t = t.concat(ju(u, r, Gu.left)))), t);
                              })(u, e);
                    },
                    zu = 'FormatText_base_d0',
                    Vu = ({ binding: u, text: e = '', classMix: t, alignment: r = Gu.left }) =>
                        null === e
                ...
                const ee = Object.keys(Qu()),
                    ...
                    oe = Mu((u) => {
                        ...
                        return s().createElement(
                            ...
                            ue(
                                {
                                    className: n()(Zu.base, t && Zu[t], h, r),
                                    style: p,
                                    mt: !0 === A ? ie[t || 'paragraph-P16'].mt : A,
                                    mr: !0 === F ? ie[t || 'paragraph-P16'].mr : F,
                                    mb: !0 === c ? ie[t || 'paragraph-P16'].mb : c,
                                    ml: !0 === B ? ie[t || 'paragraph-P16'].ml : B,
                                },
                                C,
                            ),
                            void 0 !== d ? s().createElement(Vu, ue({}, d, { text: e })) : e,
                        );
                    }),
                    Ee = 'App_base_56',
                    Ae = 'App_base__wide_26',
                    le = 'App_background_06',
                    Fe = 'App_content_87',
                    De = 'App_header_3a',
                    ce = 'App_rewards_9b',
                    _e = 'App_reward_fa',
                    Be = 'App_description_b2';
                function me() {
                    return (
                        (me =
                            Object.assign ||
                ...
                const de = R.strings.personal_missions_3.tooltips.RestRewards,
                    Ce = (0, _.Pi)(() => {
                        const u = w().model,
                            e = u.computes.getRewardsLength,
                            t = u.rewards.get(),
                            r = lu(t, x.Small).parsedRewards,
                            a = e() > 10;
                        return s().createElement(
                            'div',
                            { className: n()(Ee, a && Ae) },
                            ...
                            s().createElement(
                                'div',
                                { className: Fe },
                                s().createElement(oe, { className: De, text: de.header() }),
                                s().createElement(
                                    'div',
                                    { className: ce },
                                    r.map((u, e) =>
                                        s().createElement(
                                            'div',
                                            { className: _e, key: `rewards-${e}` },
                                            s().createElement(fu, me({}, u, { valueType: W(u.name), image: Y(u) })),
                                            s().createElement(oe, { className: Be, text: u.label }),
                                        ),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    c().render(
                        s().createElement(v, null, s().createElement(F, null, s().createElement(Ce, null))),
