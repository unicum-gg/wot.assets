            ...
            934: (u, e, t) => {
                ...
                const Tu = {
                    ...
                    Pu = Lu((u) => {
                        ...
                        return n().createElement('div', Ru({ className: C()(yu.base, ...I, e), style: X }, N), G);
                    });
                let Wu;
                !(function (u) {
                ...
                const Gu = (u, e, t) => {
                    ...
                    ju = (u, e, t = Wu.left) => u.split(e).reduce(t === Wu.left ? Gu : Nu, []),
                    Xu = (() => {
                        const u = new RegExp(
                        ...
                        return Iu.includes(t)
                            ...
                            : ((u, e = Wu.left) => {
                                  ...
                                  const A =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return (ju(F, /( )/, e).forEach((u) => (t = t.concat(ju(u, A, Wu.left)))), t);
                              })(u, e);
                    },
                    ku = 'FormatText_base_d0',
                    $u = ({ binding: u, text: e = '', classMix: t, alignment: A = Wu.left }) =>
                        null === e
                ...
                const Qu = Object.keys(Uu()),
                    ...
                    Fe = Lu((u) => {
                        ...
                        return n().createElement(
                            ...
                            void 0 !== c ? n().createElement($u, qu({}, c, { text: e })) : e,
                        );
                    });
                var Ee = t(515);
                function re() {
                ...
                const ie = ((u, e) => {
                    ...
                    se = 'App_title_68',
                    de = 'App_subtitle_e2',
                    ce = 'App_textWrapper_07',
                    ge = R.images.gui.maps.icons.personalMissions3.tooltips.QuestsTypeTooltip,
                    _e = R.strings.personal_missions_3.QuestsLine.tooltip,
                    he = (0, Ee.Pi)(() => {
                        const u = le().model.primitives.questType.get();
                        return n().createElement(
                            ru,
                            null,
                            n().createElement(
                                ...
                                n().createElement('div', {
                                    className: me,
                                    style: { backgroundImage: `url(${ge.$dyn(u)})` },
                                }),
                                n().createElement(
                                    'div',
                                    { className: ce },
                ...
                engine.whenReady.then(() => {
                    B().render(
                        n().createElement(Ce, null, n().createElement(he, null)),
