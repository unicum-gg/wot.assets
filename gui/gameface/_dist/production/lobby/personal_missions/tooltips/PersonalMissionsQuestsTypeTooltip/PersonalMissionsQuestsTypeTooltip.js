    ...
    var u,
        e = {
            ...
            934: (u, e, t) => {
                ...
                var E = {};
                t.r(E), t.d(E, { getBgUrl: () => x, getTextureUrl: () => h });
                var r = {};
                t.r(r),
                    t.d(r, {
                        addModelObserver: () => P,
                ...
                const Eu = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            Fu({}, r, {
                                className: C()(tu.base, tu[`base__theme-${E}`], A),
                                ref: function (u) {
                ...
                const Cu = uu.client.getSize('rem'),
                    lu = Cu.width,
                    ou = Cu.height,
                    mu = Object.assign({ width: lu, height: ou }, iu(lu, ou, au)),
                ...
                const cu = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && C) return nu(e, t, _);
                ...
                (0, D.memo)(({ children: u }) => {
                    const e = (0, D.useContext)(su),
                        ...
                        E = (0, D.useCallback)((u, e) => {
                            const t = uu.view.pxToRem(u),
                                A = uu.view.pxToRem(e);
                            F(Object.assign({ width: t, height: A }, iu(t, A, au)));
                        }, []);
                    gu(() => {
                    ...
                    return n().createElement(su.Provider, { value: r }, u);
                });
                let _u, hu, xu;
                !(function (u) {
                ...
                const Ru = {
                    ...
                    Ou = wu((u) => {
                        ...
                        return n().createElement('div', Mu({ className: C()(Lu.base, ...I, e), style: X }, N), G);
                    });
                let Pu;
                !(function (u) {
                ...
                const Wu = (u, e, t) => {
                    ...
                    Nu = (u, e, t = Pu.left) => u.split(e).reduce(t === Pu.left ? Wu : Gu, []),
                    ju = (() => {
                        const u = new RegExp(
                        ...
                        return Xu.includes(t)
                            ...
                            : ((u, e = Pu.left) => {
                                  ...
                                  const A =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return Nu(F, /( )/, e).forEach((u) => (t = t.concat(Nu(u, A, Pu.left)))), t;
                              })(u, e);
                    },
                ...
                const qu = Object.keys(Vu()),
                    ...
                    Ae = wu((u) => {
                        ...
                        return n().createElement(
                            ...
                            void 0 !== c ? n().createElement(ku, Yu({}, c, { text: e })) : e,
                        );
                    });
                var Fe = t(515);
                function Ee() {
                ...
                const Be = ((u, e) => {
                                    ...
                                    B = (t, A, F) => {
                                        ...
                                        const r = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = De(F.keys()); !(u = t()).done; ) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(A),
                        ...
                        ({ observableModel: u }) => {
                            const e = { root: u.object(), primitives: u.primitives(['questType']) };
                    ...
                    me = 'App_title_68',
                    se = 'App_subtitle_e2',
                    de = 'App_textWrapper_07',
                    ce = R.images.gui.maps.icons.personalMissions3.tooltips.QuestsTypeTooltip,
                    ge = R.strings.personal_missions_3.QuestsLine.tooltip,
                    _e = (0, Fe.Pi)(() => {
                        const u = Ce().model.primitives.questType.get();
                        return n().createElement(
                            Eu,
                            null,
                            n().createElement(
                                ...
                                n().createElement('div', {
                                    className: oe,
                                    style: { backgroundImage: `url(${ce.$dyn(u)})` },
                                }),
                                n().createElement(
                                    'div',
                                    { className: de },
                                    n().createElement(Ae, {
                                        className: me,
                                        format: { binding: { type: u } },
                                        text: ge.title.$dyn(u),
                                    }),
                                    n().createElement(Ae, {
                                        className: se,
                                        format: { binding: { type: u } },
                                        text: ge.subtitle.$dyn(u),
                                    }),
                                ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    B().render(
                        n().createElement(ie, null, n().createElement(_e, null)),
