(() => {
    var __webpack_modules__ = {
            ...
            641: (e, u, t) => {
                ...
                const v = Object.keys(s.W).reduce(
            ...
            364: (e, u, t) => {
                'use strict';
                t.d(u, { B3: () => l, Gr: () => _, Z5: () => n, B0: () => i, ry: () => p });
                class a {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
                ...
                function F(e, u, t, a, s, r, n) {
                    ...
                    o.done ? u(i) : Promise.resolve(i).then(a, s);
                }
            ...
            461: (e, u, t) => {
                ...
                const _ = n.O.client.getSize('rem'),
                    c = _.width,
                    d = _.height,
                    m = Object.assign({ width: c, height: d }, l(c, d, o)),
                ...
                const F = (e) => {
                    ...
                    const s = (0, a.useContext)(E),
                        ...
                        h = { extraLarge: p, large: g, medium: B, small: b, extraSmall: C };
                ...
                const T = {
                    ...
                    y = (e) => {
                        ...
                        const r = f(),
                            ...
                            o = r.mediaHeight,
                            i = r.mediaSize;
                        return s().createElement('div', x({ className: B()(t, T[n], L[o], P[i]) }, a), u);
                    },
                    N = ['children'];
                const O = (e) => {
                    let u = e.children,
                ...
                class V extends s().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            m = B()(H.base, H[`base__${n}`], H[`base__${r}`], null == o ? void 0 : o.base),
                            E = B()(H.icon, H[`icon__${n}`], H[`icon__${r}`], null == o ? void 0 : o.icon),
                            A = B()(H.glow, null == o ? void 0 : o.glow),
                            F = B()(H.caption, H[`caption__${n}`], null == o ? void 0 : o.caption),
                ...
                const ae = ((e, u) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: o, children: i, mocks: l }) {
                                ...
                                return (
                                    (0, a.useEffect)(() => {
                                        d.current ? p(c(E, o, l)) : (d.current = !0);
                                    }, [l, E, o]),
                                    (0, a.useEffect)(() => {
                                        A(r);
                                    }, [r]),
                        ...
                        ({ observableModel: e }) => {
                            const u = {
                                ...
                                o = (0, te.Om)(() => n(u.quest.get().questData.mainQuests), { equals: Y }),
                                i = (0, te.Om)(() => n(u.quest.get().questData.addQuests), { equals: Y }),
                                l = (0, te.Om)(
                                    (e) =>
                                        e.reduce(
                                            (e, u) =>
                ...
                ge.defaultProps = { type: De.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Be = (0, a.memo)(ge);
                var be = t(887),
                    Ce = t.n(be);
                const he = ['xl', 'lg', 'md', 'sm', 'xs'],
                    we = (e) => e.includes('_') && ((e) => he.includes(e))(e.split('_').at(-1)),
                    ve = [h.ExtraLarge, h.Large, h.Medium, h.Small, h.ExtraSmall],
                    fe = (e, u) =>
                        Object.keys(e).reduce((t, a) => {
                            ...
                            if (we(a)) {
                                ...
                                if (s in t) return t;
                                const r = ve.indexOf(u),
                                    n = (-1 !== r ? he.slice(r) : [])
                                        .map((e) => s + '_' + e)
                                        .find((u) => void 0 !== e[u]),
                                    o = n ? e[n] : void 0;
                                return (t[s] = void 0 !== o ? o : e[s]), t;
                            }
                            const s = e[a];
                            return (
                                void 0 === s ||
                ...
                const Re = {
                    ...
                    Ne = Se((e) => {
                        let u = e.className,
                            ...
                            f =
                                void 0 === v
                                    ...
                                    : v,
                            S = e.alignItems,
                            x = void 0 === S ? (g ? 'flex-start' : b && 'center') || (C && 'flex-end') || void 0 : S,
                            T = e.alignSelf,
                            L = e.wrap,
                            R = e.flexWrap,
                            ...
                            N = e.shrink,
                            O = e.flex,
                            I = void 0 === O ? (y || N ? `${y ? 1 : 0} ${N ? 1 : 0} auto` : void 0) : O,
                            M = e.style,
                            k = e.children,
                            H = (function (e, u) {
                                if (null == e) return {};
                        ...
                        const W = (0, a.useMemo)(() => {
                                const e = { mt: i, mr: _, mb: d, ml: E },
                                    u = ((e) =>
                                        Pe.reduce((u, t) => {
                                            const a = e[t];
                                            return a && 'number' != typeof a ? u.concat(Re[!0 === a ? 'MD' : a][t]) : u;
                                        }, []))(e),
                                    a = ((e) =>
                                        Pe.reduce((u, t) => {
                                            const a = e[t];
                                            return 'number' == typeof a && (u[ye[t]] = a + 'rem'), u;
                                        }, {}))(e);
                                return {
                            ...
                            }, [t, r, i, _, d, E, M, I, T, p, P, f, x]),
                            Q = W.computedStyle,
                            V = W.computedClassNames;
                        return s().createElement('div', Le({ className: B()(xe.base, ...V, u), style: Q }, H), k);
                    });
                let Oe;
                function Ie(e, u) {
                ...
                const Me = (e, u, t) => {
                    ...
                    He = (e, u, t = Oe.left) => e.split(u).reduce(t === Oe.left ? Me : ke, []),
                    We = (() => {
                        const e = new RegExp(
                        ...
                        return Qe.includes(t)
                            ...
                            : ((e, u = Oe.left) => {
                                  ...
                                  const a =
                                      ...
                                      s = e.replace(/&nbsp;/g, ' ');
                                  return He(s, /( )/, u).forEach((e) => (t = t.concat(He(e, a, Oe.left)))), t;
                              })(e, u);
                    },
                    Ue = 'FormatText_base_d0',
                    Ge = ({ binding: e, text: u = '', classMix: t, alignment: r = Oe.left }) =>
                        null === u
                ...
                const Ye = Object.keys($e()),
                    ...
                    au = Se((e) => {
                        ...
                        return s().createElement(
                            ...
                            ze(
                                {
                                    className: B()(je.base, t && je[t], C, r),
                                    style: b,
                            ...
                            void 0 !== D ? s().createElement(Ge, ze({}, D, { text: u })) : u,
                        );
                    }),
                    su = 'Footer_base_7f',
                    ru = 'Footer_bg_50',
                    nu = 'Footer_vignette_29',
                    ou = R.strings.personal_missions_3.QuestsView.footer,
                    iu = (0, a.memo)(({ onShowRewardClick: e, className: u }) =>
                        s().createElement(
                            'div',
                            { className: B()(su, u) },
                            ...
                            s().createElement(
                                ...
                                s().createElement(
                                    Be,
                                    { type: De.ghost, size: pe.medium, onClick: e },
                                    s().createElement(au, { text: ou.rewardBtn.text() }),
                                ),
                            ),
                        ),
                    ),
                    ...
                    Au = (0, a.memo)(
                        ({
                            ...
                            const n = {
                                ...
                                o = B()(mu.subtitle, mu[`subtitle__${e}`]),
                                i = B()(mu.iconSubtitle, mu[`iconSubtitle__${e}`]),
                            ...
                            return s().createElement(
                                ...
                                s().createElement(
                                    ...
                                    s().createElement('div', { className: i, style: { backgroundImage: l } }),
                                    s().createElement(au, {
                                        className: B()(o),
                        ...
                        const C = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, a.useCallback)(() => {
                                (C.current.isVisible && C.current.timeoutId) ||
                                    (pu(t, E, { isMouseEvent: !0, on: !0, arguments: Du(s) }, h),
                                    g && g(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (e) => {
                                                  (e.clientX === window.innerWidth &&
                                                      ...
                                                      ((C.current.timeoutId = window.setTimeout(w, _ ? 100 : 400)),
                                                      r && r(e),
                                                      S && S(e));
                                              }),
                                          onMouseLeave: ((e) => (u) => {
                ...
                const xu = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    return r || o
                        ? s().createElement(gu, Su({}, u, { contentId: r || o }), a)
                        : s().createElement(Cu, u, a);
                };
                let Tu;
                !(function (e) {
                    (e.Switch = 'switch'),
                ...
                const Lu = {
                    ...
                    Ru = (0, q.Pi)(
                        ({
                            ...
                            const _ = re().controls,
                                ...
                                m = c[1],
                                E = t !== Tu.Available,
                                A = u && (t === Tu.DoneP || t === Tu.Pause),
                                F = t !== Tu.Switch && t !== Tu.DoneS,
                                D = u && t === Tu.InProgressHonor,
                                p = t === Tu.Done || t === Tu.DoneH || D,
                                g = t === Tu.DoneH,
                                b = t === Tu.InProgressHonor,
                                C = t === Tu.InProgress,
                                h =
                                    !(
                                        t === Tu.Available ||
                            ...
                            (0, a.useEffect)(
                                () =>
                                    G(() => {
                                        S && (o(e), _.setIncrease(!0), x(!1));
                                    }, 500),
                                [S, o, _, e],
                            );
                            const T = B()(Lu.complete, g && Lu.complete__withHonor, b && Lu.complete__inProgressHonor);
                            return s().createElement(
                                'div',
                                {
                                    className: v,
                                    onMouseEnter: () => {
                                        F && (k(R.sounds.highlight()), m(!0));
                                    },
                                    onMouseLeave: () => {
                                        m(!1);
                                    },
                                    onClick: () => {
                                        r && !w && (k(R.sounds.play()), _.setHideQuests(!0), x(!0));
                                    },
                                },
                                s().createElement(
                                    'div',
                                    { className: Lu.contentWrapper },
                                    s().createElement(au, { className: Lu.questID, text: i }),
                                    E &&
                                        (A || !u) &&
                                        s().createElement(
                                            'div',
                                            { className: Lu.cardWrapper },
                                            s().createElement('div', { className: B()(Lu.cardIcon) }),
                                        ),
                                    u &&
                                        s().createElement(
                                            s().Fragment,
                                            ...
                                            h &&
                                                s().createElement(
                                                    'div',
                                                    { className: Lu.disableWrapper },
                                                    s().createElement('div', { className: Lu.disableIcon }),
                                                ),
                                            s().createElement(
                                                'div',
                                                { className: Lu.lastIconWrapper },
                                                p && s().createElement('div', { className: T }),
                                                C && s().createElement('div', { className: Lu.inProgress }),
                                            ),
                                        ),
                                ),
                            );
                    ...
                    Pu = 'QuestLine_base_29',
                    yu = 'QuestLine_questCard_3f';
                function Nu() {
                    return (
                        (Nu =
                            Object.assign ||
                ...
                const Ou = R.strings.personal_missions_3.tooltips.questCard,
                    Iu = (e, u) =>
                        e.type === Tu.Switch || e.type === Tu.DoneS
                            ? { header: Ie(Ou.header.switch(), { questName: e.questName }), body: Ou.body.switch() }
                            : {
                                  contentId: R.views.lobby.personal_missions.tooltips.QuestCardTooltip('resId'),
                                  args: { questId: u },
                              },
                    Mu = (0, a.memo)(({ cards: e, onQuestClicked: u }) =>
                        s().createElement(
                            'div',
                            { className: Pu },
                            e.map((t, a) => {
                    ...
                    ku = 'QuestType_base_52',
                    Hu = R.images.gui.maps.icons.personalMissions3.QuestsView.types,
                    Wu = (0, a.memo)(({ type: e, className: u }) => {
                        const t = `url(${Hu.$dyn(e)})`;
                        return s().createElement(
                            gu,
                            {
                                contentId:
                            ...
                            s().createElement('div', { className: B()(ku, u), style: { backgroundImage: t } }),
                        );
                    }),
                    Qu = 'Quests_base_3a',
                    Vu = 'Quests_questsContainer_3b',
                    Uu = 'Quests_questsLine_49',
                    Gu = 'Quests_questType_80',
                    qu = (0, a.memo)(({ className: e, questsLines: u, onQuestClicked: t }) =>
                        s().createElement(
                            'div',
                            { className: B()(Qu, e) },
                            u.map((e) =>
                                s().createElement(
                                    'div',
                                    { key: e.id, className: Vu },
                                    s().createElement(
                                        'div',
                                        { className: Uu },
                                        s().createElement(Wu, { key: e.id, type: e.type, className: Gu }),
                                        s().createElement(Mu, { cards: e.cards, onQuestClicked: t }),
                                    ),
                                ),
                            ),
                        ),
                    ...
                    ju = (0, a.memo)(({ state: e, className: u }) => {
                        const t = B()($u.standIcon, $u[`standIcon__${e}`]);
                        return s().createElement(
                            'div',
                            { className: B()($u.base, u) },
                ...
                const Ku = ({ size: e = zu.Default, classMix: u }) =>
                        s().createElement('div', { className: B()(Xu.background, Xu[`background__${e}`], u) }),
                    Zu = {
                    ...
                    ut = (0, a.memo)(
                        ({ size: e, lineRef: u, disabled: t, baseStyles: a, isComplete: r, withoutBounce: n }) => {
                            const o = B()(
                                    ...
                                    t && et.base__disabled,
                                    r && et.base__finished,
                                    n && et.base__withoutBounce,
                                ),
                                i = !t && !r;
                            return s().createElement(
                                'div',
                                { className: o, style: a, ref: u },
                                s().createElement('div', { className: et.pattern }),
                                s().createElement('div', { className: et.gradient }),
                                i && s().createElement(Ju, { size: e }),
                            );
                        },
                    ),
                    tt = ({ size: e, value: u, lineRef: t, disabled: r, onComplete: n }) => {
                        ...
                        return (
                            ...
                            s().createElement(ut, { size: e, disabled: r, baseStyles: o, isComplete: i, lineRef: t })
                        );
                    };
                let at, st;
                !(function (e) {
                ...
                const rt = 'ProgressBarDeltaSimple_base_6c',
                        ...
                        ({
                            ...
                            return A
                                ...
                                : s().createElement(
                                      ...
                                      s().createElement(
                                          'div',
                                          { style: F ? p : g, className: nt },
                                          s().createElement(Ju, { size: n }),
                                      ),
                                  );
                        },
                    ),
                    ...
                    _t = 'ProgressBarDeltaGrow_base__withoutBounce_b5',
                    ...
                    At = (0, a.memo)(
                        ({
                            ...
                            const C = (0, a.useMemo)(() => Object.assign({ width: '100%' }, Et(e), dt(c)), [c, e]),
                                h = (0, a.useMemo)(() => Object.assign({ width: '0%' }, Et(e), dt(c)), [c, e]),
                                w = (0, a.useMemo)(() => Object.assign({ width: '0%' }, mt(c, r), Et(e)), [r, c, e]),
                                v = (0, a.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - r)}%` }, mt(c, r), Et(e)),
                                    [r, c, o, e],
                                );
                            if (A) return null;
                            const f = B()(lt, _, c && 0 === o && _t);
                            return s().createElement(
                                'div',
                                { style: F ? w : v, className: f },
                                s().createElement(
                                    'div',
                                    { style: p ? h : C, className: ct },
                                    s().createElement(Ju, { size: n }),
                                ),
                            );
                        },
                ...
                const gt = (0, a.memo)((e) => {
                        ...
                        switch (r.animationSettings.type) {
                            case Yu.Simple:
                                return s().createElement(it, pt({}, r, { onEndAnimation: l, isComplete: o }));
                            case Yu.Growing:
                                return s().createElement(Ft, pt({}, r, { onEndAnimation: l, isComplete: o }));
                            default:
                                return null;
                        }
                    }),
                ...
                const Ct = (0, a.memo)((e) => {
                    ...
                    return (
                        (r.current.from = o),
                        s().createElement(gt, bt({}, t, { onEndAnimation: n, key: `${o}-${t.to}`, from: o }))
                    );
                });
                function ht() {
                    return (
                ...
                const wt = (0, a.memo)(
                        ({
                            ...
                            return n.withStack
                                ? s().createElement(Ct, _)
                                : s().createElement(gt, ht({ key: `${r}-${u}` }, _));
                        },
                    ),
                    vt = (e) => ({
                    ...
                    Lt = (0, a.memo)(
                        ({
                            ...
                            return s().createElement(
                                'div',
                                { className: B()(Xu.base, Xu[`base__${t}`]), style: vt(u) },
                                !o && s().createElement(Ku, { size: t, classMix: i }),
                                s().createElement(wt, {
                                    size: t,
                                    lineRef: c,
                                    disabled: n,
                ...
                const Pt = {
                    ...
                    yt = R.strings.personal_missions_3.QuestsView.tab,
                    Nt = (0, a.memo)(
                        ({
                            state: e,
                            value: u,
                            ...
                            const d = (0, a.useState)(!1),
                                m = d[0],
                                E = d[1],
                                A = B()(Pt.bg, Pt[`bg__${e}`], r && Pt.bg__selected, m && Pt.bg__hover),
                                F = e === Rt.Disabled,
                                D = e === Rt.Completed || e === Rt.CompleteWithHonor;
                            return s().createElement(
                                'div',
                                {
                                    className: Pt.base,
                                    ...
                                    onClick: () => {
                                        c || r || (k(R.sounds.play()), E(!1), l(!0), i(_));
                                    },
                                },
                                s().createElement(
                                    'div',
                                    ...
                                    s().createElement(
                                        'div',
                                        { className: Pt.textWrapper },
                                        s().createElement(au, {
                                            className: Pt.vehicleLevel,
                                            text: yt.progress(),
                                            format: { binding: { minVehicleLevel: du(n), maxVehicleLevel: du(o) } },
                                        }),
                                        D
                                            ? s().createElement('div', {
                                                  className: B()(
                                                      Pt.iconComplete,
                                                      e === Rt.CompleteWithHonor && Pt.iconComplete__withHonor,
                                                  ),
                                              })
                                            : s().createElement(
                                                  'div',
                                                  { className: Pt.questsCount },
                                                  s().createElement(au, {
                                                      className: Pt.currentQuests,
                                                      text: String(u),
                                                  }),
                                                  s().createElement(au, { className: Pt.divider, text: yt.divider() }),
                                                  s().createElement(au, { className: Pt.totalQuests, text: String(t) }),
                                              ),
                                    ),
                                    s().createElement(Lt, { disabled: F, size: zu.Small, value: u, maxValue: t }),
                                ),
                            );
                        },
                    ),
                    Ot = 'VehicleTabs_base_f4',
                    It = 'VehicleTabs_tab_6e';
                function Mt() {
                    return (
                        (Mt =
                            Object.assign ||
                ...
                const kt = R.strings.personal_missions_3.VehicleTabs.tooltip,
                    Ht = (0, a.memo)(({ className: e, tabs: u, onSelected: t, onTabClicked: a, isSwitched: r }) =>
                        s().createElement(
                            'div',
                            { className: B()(Ot, e) },
                            u.map((e) =>
                                s().createElement(
                                    ...
                                    s().createElement(
                                        ...
                                        s().createElement(
                                            Nt,
                                            Mt({}, e, { onTabClicked: a, onSelected: t, isSwitched: r }),
                                        ),
                                    ),
                                ),
                            ),
                    ...
                    Qt = (0, q.Pi)(() => {
                        const e = re(),
                            ...
                            D = t.tabId.get(),
                            p = t.computes.getTabs(),
                            g = o >= h.Small,
                            b = m === oe.Complete || m === oe.CompleteWithHonor,
                            C = m === oe.Locked,
                            w = `url(R.images.gui.maps.icons.personalMissions3.QuestsView.grid_${D})`,
                            v = (0, a.useState)(!0),
                            S = v[0],
                            x = v[1],
                            T = (0, a.useState)(!0),
                            L = T[0],
                            R = T[1],
                            P = p.filter((e) => e.selected)[0].id,
                            y = 2 === n.O.view.getScale();
                        me(u.close),
                            (0, a.useEffect)(() => {
                                u.setTabId(P);
                            }, [u, P]),
                        ...
                        const N = B()(Wt.base, F && Wt.base__hide, r && Wt.base__customLarge, y && Wt.base__scaled),
                            O = B()(Wt.light, r && Wt.light__customLarge),
                            I = B()(Wt.character, y && Wt.character__scaled),
                            M = B()(
                                Wt.content,
                                A && Wt.content__switched,
                                S && Wt.content__show,
                                y && Wt.content__scaled,
                            );
                        return s().createElement(
                            'div',
                            { className: N },
                            ...
                            s().createElement(
                                ...
                                s().createElement(
                                    'div',
                                    { className: Wt.lightWrapper },
                                    s().createElement('div', { className: O }),
                                    s().createElement('div', {
                                        className: B()(Wt.bottomLight, L && Wt.bottomLight__show),
                                    }),
                                    s().createElement('div', { className: Wt.grid, style: { backgroundImage: w } }),
                                    s().createElement(qu, {
                                        className: Wt.quests,
                            ...
                            g && !b && !C && s().createElement(Ae, { className: I, state: m }),
                            g && (C || b) && s().createElement(ju, { state: m, className: Wt.stand }),
                            s().createElement(iu, {
                                className: B()(Wt.footer, F && Wt.footer__hide),
                ...
                const qt = 'ProgressLine_base_48',
                    $t = 'ProgressLine_conditionProgress_db',
                    jt = 'ProgressLine_progressLineProgress_96',
                    Xt = 'ProgressLine_progressLineIcon_69',
                    zt = 'ProgressLine_progressLineText_1c',
                    Yt = 'ProgressLine_progressLineText__from_94',
                    Kt = 'ProgressLine_iconWrapper_25',
                    Zt = 'ProgressLine_icon_fd',
                    Jt = 'TimeoutProgressBar_base_1c',
                    ea = 'TimeoutProgressBar_lineWrapper_fa',
                    ua = 'TimeoutProgressBar_lineWrapper__red_fc',
                    ta = 'TimeoutProgressBar_stepIcon_58',
                    aa = 'TimeoutProgressBar_stepIcon__done_fb',
                    sa = (0, a.memo)(
                        ({
                            value: e = 0,
                            maxValue: u,
                            ...
                            return s().createElement(
                                ...
                                !r && n && s().createElement('div', { className: B()(ta, F && !i && aa) }),
                            );
                        },
                    ),
                    ra = R.strings.personal_missions_3.QuestView,
                    na = (0, a.memo)(({ repeatData: e = [], withSteps: u = !1 }) => {
                                    ...
                                    s().createElement(
                                        ...
                                        t.icon &&
                                            ...
                                            s().createElement(
                                                ...
                                                s().createElement(au, {
                                                    className: zt,
                                                    text: ra.conditionProgress.short(),
                                                    format: {
                                                        binding: {
                ...
                const da = R.strings.personal_missions_3.QuestView,
                    ma = (e) => _e.Z5.getRealFormat(e, _e.Gr.WO_ZERO_DIGITS),
                    Ea = (0, q.Pi)(
                        ({
                            name: e,
                            description: u,
                            ...
                            const l = re().model.computes.getDoneFailedCount(i || []),
                                _ = (0, a.useState)(0),
                                c = _[0],
                                d = _[1],
                                m = (0, a.useState)(ca.DEFAULT),
                                E = m[0],
                                A = m[1],
                            ...
                            return (
                                (0, a.useEffect)(() => {
                                    i &&
                                        ...
                                        (d(l.done),
                                        A(() => ca.DEFAULT),
                                        l.done === i.length && A(() => ca.DONE),
                                        l.failed === i.length && A(() => ca.FAILED));
                                }, [r, l, l.done, l.failed, i]),
                                s().createElement(
                                    'div',
                                    { className: _a.base },
                                    '' !== r
                                        ? s().createElement(
                                              'div',
                                              { className: _a.repeatCountWrapper },
                                              s().createElement(
                                                  'div',
                                                  { className: _a.repeatTitleWrapper },
                                                  s().createElement(au, { className: _a.conditionTitle, text: u }),
                                                  r !== oa.LIMITED &&
                                                      s().createElement(
                                                          fu,
                                                          { body: da.repeatTitle.tooltip.$dyn(r) },
                                                          s().createElement('div', { className: _a.repeatIcon }),
                                                      ),
                                              ),
                                              s().createElement(na, { repeatData: i, withSteps: r === oa.SERIES }),
                                              s().createElement(au, {
                                                  className: B()(_a.wholeProgressText, _a[`wholeProgressText__${E}`]),
                                                  text: da.repeatProgress.$dyn(E),
                                                  format: {
                                                      binding: {
                                                          from: s().createElement(au, {
                                                              className: _a.wholeProgressText__from,
                                                              text: ma(1 === i.length ? i[0].currentValue : c),
                                                          }),
                                                          to: ma(1 === i.length ? i[0].to : D),
                                                      },
                                                  },
                                              }),
                                          )
                                        : s().createElement(
                                              'div',
                                              { className: B()(_a.conditionWrapper, n && _a.conditionWrapper__last) },
                                              s().createElement('div', {
                                                  className: _a.conditionIcon,
                                              ...
                                              s().createElement(
                                                  ...
                                                  null,
                                                  s().createElement(au, {
                                                      className: _a.conditionTitle,
                                                      text: e || '',
                                                  }),
                                                  s().createElement(au, {
                                                      className: _a.conditionSubTitle,
                                                      text: u || '',
                                                  }),
                                                  i &&
                                                      i.length > 0 &&
                                                      s().createElement(
                                                          s().Fragment,
                                                          null,
                                                          s().createElement(na, { repeatData: i }),
                                                          1 === i.length &&
                                                              s().createElement(au, {
                                                                  className: B()(
                                                                      _a.wholeProgressText,
                                                                      i[0].currentValue === i[0].to &&
                                                                          _a.wholeProgressText__done,
                                                                  ),
                                                                  text: da.conditionProgress.full(),
                                                                  format: {
                                                                      binding: {
                                                                          from: s().createElement(au, {
                                                                              className: B()(
                                                                                  _a.wholeProgressText__from,
                                                                                  i[0].currentValue === i[0].to &&
                                                                                      _a.wholeProgressText__done,
                                                                              ),
                                                                              text: ma(i[0].currentValue),
                                                                          }),
                                                                          to: ma(i[0].to),
                                                                      },
                                                                  },
                    ...
                    Fa = (e) =>
                        e === Gt.Or
                            ? s().createElement(
                                  'div',
                                  { className: Aa.separatorOrWrapper },
                                  s().createElement(
                                      'div',
                                      { className: B()(Aa.separatorBlock, Aa.separatorBlock__left) },
                                      s().createElement('div', { className: Aa.separatorLine }),
                                  ),
                                  s().createElement('div', { className: Aa.separatorArrow }),
                                  s().createElement(
                                      'div',
                                      { className: B()(Aa.separatorBlock, Aa.separatorBlock__right) },
                                      s().createElement('div', { className: Aa.separatorLine }),
                                  ),
                              )
                            : s().createElement('div', { className: Aa.separatorSoloLine }),
                    Da = (0, a.memo)(({ quest: e }) =>
                        s().createElement(
                            'div',
                            { className: Aa.base },
                            e.relation.groups.map((u, t) => {
                                ...
                                return s().createElement(
                                    ...
                                    t !== e.relation.groups.length - 1 && Fa(e.relation.relationType),
                                );
                            }),
                        ),
                    );
                let pa, ga, Ba, ba, Ca, ha, wa;
                !(function (e) {
                    (e.Items = 'items'),
                ...
                va.defaultProps = { format: 'integral' };
                const fa = [
                        pa.Items,
                        pa.Equipment,
                        pa.Xp,
                        ...
                        pa.NaturalCover,
                        pa.BpCoin,
                        pa.BattlePassSelectToken,
                        pa.BattlaPassFinalAchievement,
                        pa.BattleBadge,
                        pa.BonusX5,
                        pa.CrewBonusX3,
                        pa.NewYearFillers,
                        pa.NewYearInvoice,
                        pa.EpicSelectToken,
                        pa.Comp7TokenWeeklyReward,
                        pa.Comp7TokenCouponReward,
                        pa.BattleBoosterGift,
                        pa.CosmicLootboxCommon,
                        pa.CosmicLootboxSilver,
                        pa.SelectableBonus,
                    ],
                    Sa = [pa.Gold, pa.Credits, pa.Crystal, pa.FreeXp],
                    xa = [pa.BattlePassPoints],
                    Ta = [pa.PremiumPlus, pa.Premium],
                    La = ['engravings', 'backgrounds'],
                    Ra = ['engraving', 'background'],
                    Pa = (e, u = Ba.Small) => {
                        const t = e.name,
                            a = e.type,
                            s = e.value,
                ...
                const Oa = (e) => ('overlayType' in e ? e.overlayType : void 0),
                    Ia = {
                        base: 'Reward_base_ea',
                    ...
                    Ma = ({
                        ...
                        const m = ((e) => {
                            ...
                            E = ((e) => {
                                ...
                                switch (e) {
                                    ...
                                    case Ca.BATTLE_BOOSTER_REPLACE:
                                        return wa.BATTLE_BOOSTER_REPLACE;
                                    case Ca.BUILT_IN_EQUIPMENT:
                                        return wa.BUILT_IN_EQUIPMENT;
                                    case Ca.EQUIPMENT_PLUS:
                                        return wa.EQUIPMENT_PLUS;
                                    case Ca.EQUIPMENT_TROPHY_BASIC:
                                        return wa.EQUIPMENT_TROPHY_BASIC;
                                    case Ca.EQUIPMENT_TROPHY_UPGRADED:
                                        return wa.EQUIPMENT_TROPHY_UPGRADED;
                                    case Ca.EQUIPMENT_MODERNIZED_UPGRADED_1:
                                        return wa.EQUIPMENT_MODERNIZED_UPGRADED_1;
                                    case Ca.EQUIPMENT_MODERNIZED_UPGRADED_2:
                                        return wa.EQUIPMENT_MODERNIZED_UPGRADED_2;
                                    case Ca.EQUIPMENT_MODERNIZED_UPGRADED_3:
                                        return wa.EQUIPMENT_MODERNIZED_UPGRADED_3;
                                    case Ca.PROGRESSION_STYLE_UPGRADED_1:
                                        return wa.PROGRESSION_STYLE_UPGRADED_1;
                                    case Ca.PROGRESSION_STYLE_UPGRADED_2:
                                        return wa.PROGRESSION_STYLE_UPGRADED_2;
                                    case Ca.PROGRESSION_STYLE_UPGRADED_3:
                                        return wa.PROGRESSION_STYLE_UPGRADED_3;
                                    case Ca.PROGRESSION_STYLE_UPGRADED_4:
                                        return wa.PROGRESSION_STYLE_UPGRADED_4;
                                }
                            })(r),
                            A = ((e, u) => {
                                if (void 0 === e) return null;
                                switch (u) {
                                    ...
                                    case ba.CURRENCY:
                                    case ba.NUMBER:
                                        return s().createElement(va, { format: 'integral', value: Number(e) });
                                    case ba.PREMIUM_PLUS: {
                                        const u = Number(e);
                        ...
                        return s().createElement(
                            'div',
                            { className: B()(Ia.base, Ia[`base__${a}`], l), style: i },
                            s().createElement(
                                xu,
                                { tooltipArgs: c, className: Ia.tooltipWrapper },
                                s().createElement(
                                    s().Fragment,
                                    null,
                                    s().createElement(
                                        'div',
                                        { className: B()(Ia.image, null == _ ? void 0 : _.image) },
                                        m &&
                                            s().createElement('div', {
                                                className: B()(Ia.highlight, null == _ ? void 0 : _.highlight),
                                                style: {
                                        ...
                                        u &&
                                            s().createElement('div', {
                                                className: B()(Ia.icon, null == _ ? void 0 : _.rewardIcon),
                                                style: { backgroundImage: `url(${u})` },
                                            }),
                                        E &&
                                            s().createElement('div', {
                                                className: B()(Ia.overlay, null == _ ? void 0 : _.overlay),
                                                style: {
                            ...
                            t &&
                                s().createElement(
                                    ...
                                    { tooltipArgs: d },
                                    s().createElement('div', {
                                        className: B()(Ia.timer, null == _ ? void 0 : _.periodicIcon),
                                    }),
                                ),
                        );
                    },
                ...
                const Wa = (0, a.memo)(({ reward: e, isWithOpacity: u = !1, state: t = !1, animationEnd: r }) => {
                        const n = e.isChooseReward && t;
                        return (
                            (0, a.useEffect)(() => {
                                if (e.isShowAnimation) return G(() => r(), 1e3);
                            }, [r, e.isShowAnimation]),
                            s().createElement(
                                'div',
                                { className: ka.base },
                                n && s().createElement('div', { className: ka.shine }),
                                s().createElement(
                                    Ma,
                                    Ha(
                                        {
                                            className: B()(
                                                ka.reward,
                                                u && ka.reward__opacity,
                                                e.isShowAnimation && ka.reward__animated,
                                            ),
                                            classNames: { info: ka.rewardText },
                                        },
                                        e,
                                        {
                                            image: e.icon
                    ...
                    Qa = 'ChooseRewardButton_base_aa',
                    Va = 'ChooseRewardButton_buttonHolder_45',
                    Ua = 'ChooseRewardButton_buttonInner_6e',
                    Ga = 'ChooseRewardButton_button_66',
                    qa = 'ChooseRewardButton_buttonBlink_a7',
                    $a = 'ChooseRewardButton_buttonText_52',
                    ja = R.strings.personal_missions_3.QuestView.content.btn,
                    Xa = (0, a.memo)(({ onClick: e, className: u }) =>
                        s().createElement(
                            'div',
                            { className: B()(Qa, u) },
                            s().createElement(
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        Be,
                                        { type: De.ghost, size: pe.extraSmall, disabled: !1, onClick: e, mixClass: Ga },
                                        s().createElement('div', { className: qa }),
                                        s().createElement(au, { className: $a, text: ja.chooseReward() }),
                                    ),
                                ),
                            ),
                        ),
                    ),
                    za = 'RewardList_base_2c',
                    Ya = 'RewardList_base__withButton_13',
                    Ka = 'RewardList_base__withChooseReward_79',
                    Za = 'RewardList_rewardWrapper_3e',
                    Ja = 'RewardList_rewardWrapper__withMargin_b2',
                    es = 'RewardList_chooseButton_e0',
                    us = (0, q.Pi)(({ rewardList: e, state: u, marginBlocker: t }) => {
                        const r = ((e, u) => {
                                const t = f(),
                                    a = u || (t.mediaSize < h.Medium ? Ba.Small : Ba.Big);
                                return {
                            ...
                            })(e, f().mediaSize < h.Large ? Ba.Small : Ba.Big),
                            n = r.parsedRewards,
                            o = re().controls,
                            i = (0, a.useCallback)(
                                (e) => () => {
                                    o.getSelectionBonus(e);
                                },
                                [o],
                            ),
                        ...
                        return s().createElement(
                            'div',
                            { className: B()(za, !t && Ya, (l || _) && Ka) },
                            n.map((e, t) =>
                                s().createElement(
                                    'div',
                                    { className: B()(Za, t !== n.length - 1 && Ja), key: `conditionReward_${t}` },
                                    s().createElement(Wa, {
                                        reward: e,
                                        isWithOpacity: u && !e.isChooseReward,
                                        state: u,
                                        animationEnd: o.updateRewards,
                                    }),
                                    e.isChooseReward && s().createElement(Xa, { className: es, onClick: i(e.id) }),
                                ),
                            ),
                        );
                    }),
                    ts = (0, a.memo)(us),
                    as = 'Content_base_51',
                    ss = 'Content_headerWrapper_14',
                    rs = 'Content_infoWrapper_40',
                    ns = 'Content_headerIcon_13',
                    os = 'Content_headerSeparator_ae',
                    is = 'Content_headerInfo_4f',
                    ls = 'Content_columnsSeparator_25',
                    _s = 'Content_conditionBlock_e4',
                    cs = 'Content_base__columns_52',
                    ds = 'Content_separatorText_ad',
                    ms = 'Content_separatorText__header_bf',
                    Es = 'Content_separatorText__done_e3',
                    As = ['561', '569'],
                    Fs = R.strings.personal_missions_3.QuestView,
                    Ds = (0, a.memo)(({ questData: e, classMix: u, questId: t, questState: a }) => {
                        const r = e[1].quests.length > 0;
                        return s().createElement(
                            'div',
                            { className: B()(as, r && cs, u) },
                            e.map((e, u) => {
                                if (e.quests.length < 1) return;
                                const n = r && 1 === u,
                                    o = n ? Fs.questTitle.honor : Fs.questTitle,
                                    i = e.isDone ? o.tooltip.body.done() : o.tooltip.body.available(),
                                    l = e.isDone ? o.done() : o.available(),
                                    _ = a === Vt.NAPrevious || a === Vt.NAPreviousAll || a === Vt.NATech;
                                return s().createElement(
                                    'div',
                                    { className: _s, key: `conditionBlock_${u}` },
                                    r &&
                                        s().createElement(
                                            s().Fragment,
                                            null,
                                            s().createElement(
                                                ...
                                                s().createElement(
                                                    fu,
                                                    { header: o.tooltip.header.available() || '', body: i || '' },
                                                    s().createElement(
                                                        'div',
                                                        { className: rs },
                                                        e.isDone && s().createElement('div', { className: ns }),
                                                        s().createElement(au, {
                                                            className: B()(ds, ms, e.isDone && Es),
                                                            text: l,
                                                        }),
                                                        s().createElement(
                                                            fu,
                                                            { body: Fs.questTitle.honor.info.tooltip.body() },
                                                            s().createElement(
                                                                'div',
                                                                null,
                                                                n &&
                                                                    !e.isDone &&
                                                                    s().createElement('div', { className: is }),
                                                            ),
                                                        ),
                                                    ),
                                                ),
                                                s().createElement('div', { className: os }),
                                            ),
                                            0 !== u && s().createElement('div', { className: ls }),
                                        ),
                                    s().createElement(Da, { quest: e }),
                                    s().createElement(ts, {
                                        state: e.isDone || _,
                                        rewardList: e.rewards,
                                        marginBlocker: -1 !== As.findIndex((e) => e === t),
                                    }),
                                );
                            }),
                        );
                ...
                const gs = 'Footer_base_d1',
                    Bs = 'Footer_button_a2',
                    bs = 'Footer_button__doneBasic_cb',
                    Cs = 'Footer_button__withInfo_37',
                    hs = 'Footer_infoWrapper_3e',
                    ws = 'Footer_infoIcon_c9',
                    vs = 'Footer_infoText_90',
                    fs = 'Footer_doneText_cd',
                    Ss = 'Footer_progressButtonWrapper_68',
                    xs = 'Footer_pauseResetButtons_f5',
                    Ts = 'Footer_pauseResetButtons__pause_61',
                    ...
                    Rs = (0, a.memo)(
                        ({
                            ...
                            const l = e === Vt.NAPrevious || e === Vt.NAPreviousAll || e === Vt.NATech,
                                _ = l || e === Vt.Available || e === Vt.DoneBasic,
                                c = (e === Vt.InProgress || e === Vt.InProgressHonor) && !r,
                                d = !c && !_ && !r,
                                m = e === Vt.Pause || e === Vt.DonePause ? la.RESUME : la.PAUSE,
                                E = B()(Bs, c && Cs, e === Vt.DoneBasic && bs);
                            return s().createElement(
                                'div',
                                { className: B()(gs, u) },
                                _ &&
                                    s().createElement(
                                        fu,
                                        {
                                            header: Ls.acceptButton.tooltip.header.$dyn(e),
                                            body: Ls.acceptButton.tooltip.body.$dyn(e),
                                        },
                                        s().createElement(
                                            'div',
                                            null,
                                            s().createElement(
                                                ...
                                                s().createElement(au, {
                                                    text: Ls.acceptButton.$dyn(e) || Ls.acceptButton.default(),
                                                }),
                                            ),
                                        ),
                                    ),
                                r &&
                                    s().createElement(
                                        ...
                                        s().createElement(
                                            fu,
                                            { body: Ls.pauseButton.tooltip.body.$dyn(m) },
                                            s().createElement(
                                                'div',
                                                null,
                                                s().createElement(
                                                    ...
                                                    s().createElement(au, { text: Ls.pauseButton.name.$dyn(m) }),
                                                ),
                                            ),
                                        ),
                                        n !== ps.Invisible &&
                                            s().createElement(
                                                fu,
                                                { body: Ls.resetButton.tooltip.body.$dyn(n) },
                                                s().createElement(
                                                    'div',
                                                    null,
                                                    s().createElement(
                                                        Be,
                                                        {
                                                            ...
                                                            mixClass: xs,
                                                            onClick: o,
                                                            disabled: n === ps.Disabled,
                                                        },
                                                        s().createElement(au, { text: Ls.resetButton.name() }),
                                                    ),
                                                ),
                                            ),
                                    ),
                                c &&
                                    s().createElement(
                                        ...
                                        s().createElement(au, {
                                            className: vs,
                                            text: Ls.infoText.default(),
                                            format: { binding: { value: a } },
                                        }),
                                    ),
                                d && s().createElement(au, { className: fs, text: Ls.infoText.done() }),
                            );
                        },
                    ),
                    Ps = {
                    ...
                    ys = R.strings.personal_missions_3.QuestView,
                    Ns = ({ questName: e, questId: u, questState: t, classMix: a, titleValue: r }) => {
                        const n = t === Vt.Pause || t === Vt.DonePause,
                            o = t !== Vt.Available && !n,
                            i = n ? Vt.Pause : t;
                        return s().createElement(
                            'div',
                            { className: B()(Ps.base, Ps[`base__${i}`]) },
                            s().createElement(
                                'div',
                                { className: B()(Ps.pageTitle, a) },
                                s().createElement(
                                    'div',
                                    { className: Ps.mainTitle },
                                    s().createElement(au, {
                                        className: Ps.mainTitleText,
                                        text: ys.title(),
                                    ...
                                    s().createElement(
                                        ...
                                        s().createElement('div', { className: Ps.infoIcon }),
                                    ),
                                ),
                                s().createElement(
                                    'div',
                                    { className: Ps.subTitle },
                                    o && s().createElement('div', { className: Ps.subTitleIcon }),
                                    s().createElement(au, {
                                        className: Ps.subTitleText,
                                        text: ys.subtitle.$dyn(i),
                ...
                const Ms = (0, q.Pi)(
                        ({
                            ...
                            const l = (0, a.useState)(!1),
                                ...
                                m = t !== Is.Switch && t !== Is.DoneS,
                                E = t === Is.DoneS || t === Is.Switch;
                            return s().createElement(
                                'div',
                                {
                                    className: d,
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(au, { className: Os.questID, text: du(u) }),
                                ),
                            );
                        },
                    ),
                    ks = 'QuestsLine_base_23',
                    Hs = 'QuestsLine_cardWrapper_0d',
                    Ws = 'QuestsLine_cardWrapper__withoutMargin_0b';
                function Qs() {
                    return (
                        (Qs =
                            Object.assign ||
                ...
                const Vs = R.strings.personal_missions_3.tooltips.questCard,
                    Us = (0, q.Pi)(({ questsList: e, isAnimated: u, setIsAnimated: t }) => {
                        const a = re().controls;
                        return s().createElement(
                            'div',
                            { className: ks },
                                ...
                                return s().createElement(
                                    xu,
                                    {
                                        ...
                                        tooltipArgs:
                                            ((o = r),
                                            (i = r.questId),
                                            o.state === Is.Switch || o.state === Is.DoneS
                                                ? {
                                                      header: Ie(Vs.header.switch(), { questName: o.questName }),
                                                      body: Vs.body.switch(),
                                                  }
                                                : {
                                                      contentId:
                                    ...
                                    s().createElement(
                                        'div',
                                        { className: B()(Hs, n === e.length - 1 && Ws) },
                                        s().createElement(
                                            Ms,
                                            Qs({}, r, {
                                                index: n + 1,
                    ...
                    $s = (0, q.Pi)(() => {
                        const e = re(),
                            ...
                            w = r.questData,
                            v = w.id,
                            f = v === Number(i[0].questId),
                            S = v === Number(i[i.length - 1].questId);
                        (0, a.useEffect)(
                            () => (
                        ...
                        const T = B()(
                                Gs.arrow,
                                Gs.arrow__left,
                                f ? Gs.arrow__disabled : Gs.arrow__enabled,
                                E || o ? Gs.arrow__fadeOut : Gs.arrow__fadeIn,
                            ),
                            L = B()(
                                Gs.arrow,
                                Gs.arrow__right,
                                S ? Gs.arrow__disabled : Gs.arrow__enabled,
                                E || o ? Gs.arrow__fadeOut : Gs.arrow__fadeIn,
                            ),
                            R = () => {
                                k('highlight');
                        ...
                        return s().createElement(
                            'div',
                            { className: B()(Gs.base, 2 === D && Gs.base__scaled, p && Gs.base__customLarge) },
                            s().createElement(
                                'div',
                                {
                                    className: B()(
                                        Gs.baseWrapper,
                                        E || o ? Gs.baseWrapper__fadeOut : Gs.baseWrapper__fadeIn,
                                    ),
                                },
                                s().createElement(
                                    'div',
                                    { className: B()(Gs.lightWrapper, !F && Gs.lightWrapper__lightOff) },
                                    s().createElement('div', { className: Gs.boardLight }),
                                    s().createElement('div', {
                                        className: B()(Gs.bottomLight, b && Gs.bottomLight__blinked),
                                    }),
                                ),
                                s().createElement(Ns, {
                                    classMix: B()(Gs.headerPosition, c && Gs.animated),
                                    questName: w.name,
                                    questId: String(v),
                                    questState: h,
                                ...
                                s().createElement(
                                    'div',
                                    { className: Gs.contentWrapper },
                                    s().createElement(Ds, {
                                        classMix: B()(c && Gs.animated),
                                        questData: l,
                                        questState: h,
                                        questId: String(v),
                                    }),
                                ...
                                s().createElement(Rs, {
                                    classMix: B()(
                                        Gs.footerPosition,
                                        p && Gs.footerPosition__customLarge,
                                        c && Gs.animated,
                                    ),
                                    state: h,
                                    handleApplyQuest: x,
                                    infoText: r.titleValue,
                                    resetButtonStatus: w.resetButtonStatus,
                                    isPauseButtonEnabled: w.isPauseButtonEnabled,
                                    handleResetQuest: () => u.resetQuest(v),
                                    handlePauseQuest: () => u.pauseQuest(v),
                                }),
                                s().createElement(
                                    'div',
                                    { className: Gs.questLineWrapper },
                                    s().createElement(Us, { questsList: i, isAnimated: c, setIsAnimated: d }),
                                ),
                            ),
                            s().createElement('div', {
                                className: T,
                ...
                const Xs = { [U.Quests]: Qt, [U.Quest]: $s },
                    zs = ({ viewType: e }) => {
                        const u = Xs[e];
                        return u
                            ? s().createElement(
                    ...
                    Ys = (0, q.Pi)(() => {
                        ...
                        const g = B()(
                            ...
                            b = B()(ne.board, m && ne.board__increase, E && ne.board__decrease, A && ne.board__quest),
                            C = B()(
                                ne.bg,
                            ...
                            w = R.strings.personal_missions_3.QuestView;
                        return s().createElement(
                            'div',
                            { className: g },
                            s().createElement(
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(V, {
                                        caption: A ? w.backButton.backText() : h.backButton.caption(),
                                        goto: A ? w.backButton.to() : h.backButton.to(),
                                        type: 'back',
                                        onClick: A
                                            ? () => {
                ...
                engine.whenReady.then(() => {
                    M().render(
                        s().createElement(se, null, s().createElement(O, null, s().createElement(Ys, null))),
        ...
        (__webpack_require__.O = (e, u, t, a) => {
            if (!u) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [u, t, a] = deferred[i], r = !0, n = 0; n < u.length; n++)
                        (!1 & a || s >= a) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [650], () => __webpack_require__(461));
