(() => {
            ...
            854: (u, e, t) => {
                ...
                const uu = {
                    ...
                    ru = Y((u) => {
                        let e = u.className,
                            ...
                            y = u.shrink,
                            H = u.flex,
                            N = void 0 === H ? (R || y ? `${R ? 1 : 0} ${y ? 1 : 0} auto` : void 0) : H,
                            P = u.style,
                            k = u.children,
                            I = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, n, i, o, s, _, P, N, L, m, O, f, M]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return a().createElement('div', J({ className: h()(Z.base, ...U, e), style: G }, I), k);
                    });
                let au;
                !(function (u) {
                ...
                const Iu = ((u, e) => {
                        ...
                        ({ externalModel: u }) => ({
                            ...
                            onVideoOpen: u.createCallbackNoArgs('onVideoOpen'),
                            onMoreInfo: u.createCallbackNoArgs('onMoreInfo'),
                        }),
                    ),
                    Wu = Iu[0],
                    Gu = Iu[1],
                    Uu = 'App_base_7c',
                    ju = 'App_vignette_6f',
                    Xu = 'App_videoButton_ed',
                    Ku = 'App_icon_9b',
                    $u = 'App_buttonText_62',
                    zu = 'App_closeButton_ea',
                    Vu = 'App_introContent_f2',
                    qu = 'App_header_df',
                    Yu = 'App_body_60',
                    Zu = 'App_bodyCard_e9',
                    Qu = 'App_bodyCard__last_02',
                    Ju = 'App_cardImage_9a',
                    ue = 'App_cardImage__first_b2',
                    ee = 'App_cardImage__second_03',
                    te = 'App_cardImage__third_5a',
                    re = 'App_cardText_48',
                    ae = 'App_footer_1e',
                    ne = 'App_acceptButton_e1',
                    Ee = 'App_infoButton_12',
                    Ae = R.strings.personal_missions_3.introView,
                    ie = (0, Ru.Pi)(() => {
                        const u = Gu().controls;
                        var e;
                        ((e = u.onClose), Ou(Su.n.ESCAPE, e));
                        return a().createElement(
                            'div',
                            { className: Uu },
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    null,
                                    a().createElement(xu, { className: $u, text: Ae.videoButton.buttonText() }),
                                    a().createElement(xu, { className: $u, text: Ae.videoButton.lbzName() }),
                                ),
                            ),
                            a().createElement(
                                'div',
                            ...
                            a().createElement(
                                'div',
                                { className: Vu },
                                a().createElement(xu, { className: qu, text: Ae.header() }),
                                a().createElement(
                                    'div',
                                    { className: Yu },
                                    a().createElement(
                                        'div',
                                        { className: Zu },
                                        a().createElement('div', { className: h()(Ju, ue) }),
                                        a().createElement(xu, { className: re, text: Ae.infoCard.first() }),
                                    ),
                                    a().createElement(
                                        'div',
                                        { className: Zu },
                                        a().createElement('div', { className: h()(Ju, ee) }),
                                        a().createElement(xu, { className: re, text: Ae.infoCard.second() }),
                                    ),
                                    a().createElement(
                                        'div',
                                        { className: h()(Zu, Qu) },
                                        a().createElement('div', { className: h()(Ju, te) }),
                                        a().createElement(xu, { className: re, text: Ae.infoCard.third() }),
                                    ),
                                ),
                            ),
                            a().createElement(
                                ...
                                a().createElement(
                                    j,
                                    { type: W.primary, size: G.small, mixClass: ne, onClick: u.onContinue },
                                    a().createElement(xu, { text: Ae.acceptButton() }),
                                ),
                                a().createElement(
                                    j,
                                    { type: W.secondary, size: G.small, mixClass: Ee, onClick: u.onMoreInfo },
                                    a().createElement(xu, { text: Ae.infoButton() }),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    P().render(
                        a().createElement(Wu, null, a().createElement(H, null, a().createElement(ie, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [650], () => __webpack_require__(854));
