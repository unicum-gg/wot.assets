(() => {
    var __webpack_modules__ = {
            ...
            661: (u, e, t) => {
                ...
                const M = {
                    ...
                    O = (u) => {
                        ...
                        const i = b(),
                            ...
                            o = i.mediaHeight,
                            E = i.mediaSize;
                        return n().createElement('div', L({ className: m()(t, M[a], S[o], T[E]) }, r), e);
                    },
                    y = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                class G extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = m()(N.base, N[`base__${a}`], N[`base__${i}`], null == o ? void 0 : o.base),
                            d = m()(N.icon, N[`icon__${a}`], N[`icon__${i}`], null == o ? void 0 : o.icon),
                            D = m()(N.glow, null == o ? void 0 : o.glow),
                            B = m()(N.caption, N[`caption__${a}`], null == o ? void 0 : o.caption),
                            _ = m()(N.goto, null == o ? void 0 : o.goto);
                        return n().createElement(
                            ...
                            'info' !== a && n().createElement('div', { className: N.shine }),
                    ...
                    Au = n().memo(function ({
                        ...
                        const c = (0, r.useRef)(null),
                            ...
                            v = (0, r.useCallback)(() => {
                                ...
                                u &&
                                    (E
                                        ? ((u.currentTime = u.duration - s), u.removeEventListener('play', g), u.play())
                                        : u.pause());
                            }, [g, E, s]);
                        return (
                            (0, r.useEffect)(() => {
                ...
                const Bu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: i = 'real', options: o, children: E, mocks: s }) {
                                const A = (0, r.useRef)([]),
                                    l = (t, r, n) => {
                                        var i;
                                        const o = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = cu(n.keys()); !(u = t()).done; ) i(u.value, e);
                                                    },
                                                    unsubscribe: i,
                                                };
                                            })(r),
                                            ...
                                            c = { mode: t, model: F, externalModel: E, cleanup: l };
                                        return {
                                            model: F,
                                    ...
                                    d = c[0],
                                    D = c[1],
                                    B = (0, r.useState)(() => l(i, o, s)),
                                    _ = B[0],
                                    C = B[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        F.current ? C(l(d, o, s)) : (F.current = !0);
                                    }, [s, d, o]),
                                    (0, r.useEffect)(() => {
                                        D(i);
                                    }, [i]),
                ...
                const bu = (0, eu.Pi)(() => {
                    ...
                    return n().createElement(
                        ...
                        n().createElement(
                            Z,
                            { body: R.strings.personal_missions_3.tooltips.IntroVideoView.body(), ignoreShowDelay: !0 },
                            n().createElement(G, {
                                classNames: { base: gu },
                                caption: '',
                                type: 'close',
                ...
                engine.whenReady.then(() => {
                    P().render(
                        n().createElement(_u, null, n().createElement(k, null, n().createElement(bu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [650], () => __webpack_require__(661));
