(() => {
    var __webpack_modules__ = {
            ...
            755: (u, e, t) => {
                ...
                const c = o.O.client.getSize('rem'),
                    F = c.width,
                    m = c.height,
                    D = Object.assign({ width: F, height: m }, A(F, m, l)),
                ...
                const C = (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(_),
                        ...
                        s = (0, r.useCallback)((u, e) => {
                            ...
                            i(Object.assign({ width: t, height: r }, A(t, r, l)));
                        }, []);
                    (((u) => {
                ...
                const M = {
                    ...
                    P = (u) => {
                        ...
                        const a = S(),
                            ...
                            s = a.mediaHeight,
                            o = a.mediaSize;
                        return n().createElement('div', T({ className: h()(t, M[i], y[s], L[o]) }, r), e);
                    },
                    O = ['children'],
                    k = (u) => {
                        let e = u.children,
                ...
                const X = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: a, children: i, mocks: s }) {
                                        ...
                                        const a = (function ({
                                            ...
                                            A = (({ observableModel: u }) => {
                                                const e = {
                                                        ...
                                                        finalQuest: u.object('finalQuest'),
                                                    },
                                                    t = (0, $.computedFn)(
                                                        () =>
                                                            W(e.quests.get()).filter(
                                                                (u) =>
                                                                    (u.isCompleted && Boolean(u.updateTime)) ||
                                                                    !u.isCompleted,
                                                            ),
                                                        { equals: I },
                                                    ),
                                                    r = (0, $.computedFn)(() => W(e.finalQuest.get()).bonuses[0], {
                                                        equals: I,
                                                    });
                                                return Object.assign({}, e, {
                                                    computes: { getQuests: t, getFinalQuestsReward: r },
                                                });
                                            })({
                                                mode: u,
                                                readByPath: s,
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        A.current ? d(E(F, a, s)) : (A.current = !0);
                                    }, [s, F, a]),
                                    (0, r.useEffect)(() => {
                                        m(u);
                                    }, [u]),
                ...
                const J = {
                    ...
                    uu = ({ size: u = K.Default, classMix: e }) =>
                        n().createElement('div', { className: h()(J.background, J[`background__${u}`], e) }),
                    eu = {
                    ...
                    nu = (0, r.memo)(
                        ({ size: u, lineRef: e, disabled: t, baseStyles: r, isComplete: a, withoutBounce: i }) => {
                            ...
                            return n().createElement(
                                ...
                                o && n().createElement(tu, { size: u }),
                            );
                        },
                    ),
                    au = ({ size: u, value: e, lineRef: t, disabled: a, onComplete: i }) => {
                        ...
                        return (
                            ...
                            n().createElement(nu, { size: u, disabled: a, baseStyles: s, isComplete: o, lineRef: t })
                        );
                    },
                    iu = (u, e) => {
                        let t;
                ...
                const lu = (0, r.memo)(
                    ...
                    mu = (0, r.memo)(
                        ({
                            ...
                            const p = (0, r.useMemo)(() => Object.assign({ width: '100%' }, Fu(u), Au(A)), [A, u]),
                                b = (0, r.useMemo)(() => Object.assign({ width: '0%' }, Fu(u), Au(A)), [A, u]),
                                f = (0, r.useMemo)(() => Object.assign({ width: '0%' }, cu(A, a), Fu(u)), [a, A, u]),
                                v = (0, r.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(s - a)}%` }, cu(A, a), Fu(u)),
                                    [a, A, s, u],
                                );
                            if (D) return null;
                            const w = h()(
                ...
                const Bu = (0, r.memo)((u) => {
                        ...
                        switch (a.animationSettings.type) {
                            case Z.Simple:
                                return n().createElement(Eu, du({}, a, { onEndAnimation: l, isComplete: s }));
                            case Z.Growing:
                                return n().createElement(Du, du({}, a, { onEndAnimation: l, isComplete: s }));
                            default:
                                return null;
                        }
                    }),
                ...
                const hu = (0, r.memo)((u) => {
                    ...
                    return (
                        (a.current.from = s),
                        n().createElement(Bu, gu({}, t, { onEndAnimation: i, key: `${s}-${t.to}`, from: s }))
                    );
                });
                function pu() {
                    return (
                ...
                const bu = (0, r.memo)(
                        ({
                            ...
                            return i.withStack
                                ...
                                : n().createElement(Bu, pu({ key: `${a}-${e}` }, E));
                        },
                    ),
                    fu = (u, e, t) => (t < u ? u : t > e ? e : t),
                    vu = (u, e, t) => ('number' == typeof t ? (fu(0, e, t) / e) * 100 : u),
                    wu = V,
                    Su = {
                        freezed: !1,
                        withStack: !1,
                    ...
                    xu = (0, r.memo)(
                        ({
                            ...
                            const D = ((u, e, t) =>
                                (0, r.useMemo)(() => {
                                    const r = (fu(0, e, u) / e) * 100;
                                    return { value: r, deltaFrom: vu(r, e, t) };
                                }, [t, e, u]))(l, u, E);
                            return n().createElement(
                                'div',
                                { className: h()(J.base, J[`base__${t}`]), style: Y(e) },
                                !s && n().createElement(uu, { size: t, classMix: o }),
                                n().createElement(bu, {
                                    size: t,
                                    lineRef: A,
                                    disabled: i,
                    ...
                    Tu = {
                        base: 'Quest_base_9a',
                        offence: 'Quest_offence_23',
                        defence: 'Quest_defence_96',
                        offence_hover: 'Quest_offence_hover_87',
                        offence_final_hover: 'Quest_offence_final_hover_ba',
                        offence_final_above_hover: 'Quest_offence_final_above_hover_23',
                        finalQuestGlow: 'Quest_finalQuestGlow_8f',
                        defence_hover: 'Quest_defence_hover_9b',
                        done: 'Quest_done_03',
                        finalQuestIcon: 'Quest_finalQuestIcon_af',
                        finalQuestSequence: 'Quest_finalQuestSequence_83',
                        finalQuest: 'Quest_finalQuest_47',
                        sequenceWrapper: 'Quest_sequenceWrapper_89',
                        doneBg: 'Quest_doneBg_3a',
                        header: 'Quest_header_9c',
                        division: 'Quest_division_63',
                        content: 'Quest_content_e6',
                        title: 'Quest_title_ff',
                        base__done: 'Quest_base__done_32',
                        progression: 'Quest_progression_8e',
                        progression_current: 'Quest_progression_current_10',
                        titleTypeWin: 'Quest_titleTypeWin_73',
                        titleFinalQuest: 'Quest_titleFinalQuest_f6',
                        progressBar: 'Quest_progressBar_25',
                        completed: 'Quest_completed_9f',
                    };
                let Mu, yu, Lu, Ru;
                (!(function (u) {
                ...
                const ku = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Iu = (u) => u.includes('_') && ((u) => ku.includes(u))(u.split('_').at(-1)),
                ...
                const Xu = {
                    ...
                    zu = Gu((u) => {
                        let e = u.className,
                            ...
                            P = u.shrink,
                            O = u.flex,
                            k = void 0 === O ? (R || P ? `${R ? 1 : 0} ${P ? 1 : 0} auto` : void 0) : O,
                            I = u.style,
                            N = u.children,
                            H = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const G = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, o, E, c, m, I, k, T, B, L, w, x]),
                            U = G.computedStyle,
                            W = G.computedClassNames;
                        return n().createElement('div', $u({ className: h()(Uu.base, ...W, e), style: U }, H), N);
                    });
                let Qu;
                !(function (u) {
                ...
                const Yu = (u, e, t) => {
                    ...
                    Ku = (u, e, t = Qu.left) => u.split(e).reduce(t === Qu.left ? Yu : Vu, []),
                    Zu = (() => {
                        const u = new RegExp(
                    ...
                    ue = ({ binding: u, text: e = '', classMix: t, alignment: a = Qu.left }) =>
                        null === e
                ...
                const ie = Object.keys(te()),
                    ...
                    ce = Gu((u) => {
                        ...
                        return n().createElement(
                            ...
                            ae(
                                {
                                    className: h()(re.base, t && re[t], p, a),
                                    style: g,
                                    mt: !0 === l ? Ee[t || 'paragraph-P16'].mt : l,
                                    mr: !0 === A ? Ee[t || 'paragraph-P16'].mr : A,
                                    mb: !0 === F ? Ee[t || 'paragraph-P16'].mb : F,
                                    ml: !0 === D ? Ee[t || 'paragraph-P16'].ml : D,
                                },
                                B,
                            ),
                            void 0 !== d ? n().createElement(ue, ae({}, d, { text: e })) : e,
                        );
                    }),
                    Fe = 'play',
                    me = [
                ...
                const _e = (0, r.memo)(function (u) {
                        ...
                        return (
                            ...
                            n().createElement('canvas', De({}, h, { width: e, height: t, ref: p }))
                        );
                    }),
                    de = (u, e) => {
                        let t = u;
                ...
                const he = {
                        ...
                        height: 172,
                        frameCount: 24,
                        chunk: { count: 1, rows: 6, columns: 4 },
                        getChunkPath: () =>
                            'R.images.historical_battles.gui.maps.icons.artefact.quests.sequence_large_nobadge',
                    },
                    pe = {
                        width: 122,
                        height: 122,
                        ...
                        chunk: { count: 1, rows: 6, columns: 4 },
                        getChunkPath: () =>
                            'R.images.historical_battles.gui.maps.icons.artefact.quests.sequence_medium_nobadge',
                    },
                    be = {
                        width: 60,
                        height: 60,
                        ...
                        chunk: { count: 1, rows: 6, columns: 4 },
                        getChunkPath: () =>
                            'R.images.historical_battles.gui.maps.icons.artefact.quests.sequence_small_nobadge',
                    };
                var fe = t(4179);
                class ve extends n().PureComponent {
                    render() {
                        let u;
                        u = 'gold' === this.props.format ? fe.B3.GOLD : fe.B3.INTEGRAL;
                        const e = fe.Z5.getNumberFormat(this.props.value, u);
                        return void 0 !== this.props.value && void 0 !== e ? e : null;
                    }
                }
                let we, Se, xe, Te, Me, ye, Le;
                var Re, Pe, Oe;
                let ke;
                ((ve.defaultProps = { format: 'integral' }),
                    ...
                    ((Oe = Te || (Te = {})).MULTI = 'multi'),
                    (Oe.CURRENCY = 'currency'),
                    (Oe.PREMIUM_PLUS = 'premium_plus'),
                    (Oe.NUMBER = 'number'),
                    (Oe.STRING = 'string'),
                    ((Pe = Me || (Me = {})).BATTLE_BOOSTER = 'battleBooster'),
                    (Pe.BATTLE_BOOSTER_REPLACE = 'battleBoosterReplace'),
                    (Pe.BUILT_IN_EQUIPMENT = 'builtInEquipment'),
                    (Pe.EQUIPMENT_PLUS = 'equipmentPlus'),
                    (Pe.EQUIPMENT_TROPHY_BASIC = 'equipmentTrophyBasic'),
                    (Pe.EQUIPMENT_TROPHY_UPGRADED = 'equipmentTrophyUpgraded'),
                    (Pe.EQUIPMENT_MODERNIZED_UPGRADED_1 = 'equipmentModernized_1'),
                    (Pe.EQUIPMENT_MODERNIZED_UPGRADED_2 = 'equipmentModernized_2'),
                    (Pe.EQUIPMENT_MODERNIZED_UPGRADED_3 = 'equipmentModernized_3'),
                    (Pe.PROGRESSION_STYLE_UPGRADED_1 = 'progressionStyleUpgraded_1'),
                    (Pe.PROGRESSION_STYLE_UPGRADED_2 = 'progressionStyleUpgraded_2'),
                    (Pe.PROGRESSION_STYLE_UPGRADED_3 = 'progressionStyleUpgraded_3'),
                    (Pe.PROGRESSION_STYLE_UPGRADED_4 = 'progressionStyleUpgraded_4'),
                    ((ye || (ye = {})).BATTLE_BOOSTER = 'battleBooster'),
                    ((Re = Le || (Le = {})).BATTLE_BOOSTER = 'battleBooster'),
                    (Re.BATTLE_BOOSTER_REPLACE = 'battleBoosterReplace'),
                    (Re.BUILT_IN_EQUIPMENT = 'builtInEquipment'),
                    (Re.EQUIPMENT_PLUS = 'equipmentPlus'),
                    (Re.EQUIPMENT_TROPHY_BASIC = 'equipmentTrophyBasic'),
                    (Re.EQUIPMENT_TROPHY_UPGRADED = 'equipmentTrophyUpgraded'),
                    (Re.EQUIPMENT_MODERNIZED_UPGRADED_1 = 'equipmentModernized_1'),
                    (Re.EQUIPMENT_MODERNIZED_UPGRADED_2 = 'equipmentModernized_2'),
                    (Re.EQUIPMENT_MODERNIZED_UPGRADED_3 = 'equipmentModernized_3'),
                    (Re.PROGRESSION_STYLE_UPGRADED_1 = 'progressionStyleUpgraded_1'),
                    (Re.PROGRESSION_STYLE_UPGRADED_2 = 'progressionStyleUpgraded_2'),
                    (Re.PROGRESSION_STYLE_UPGRADED_3 = 'progressionStyleUpgraded_3'),
                    (Re.PROGRESSION_STYLE_UPGRADED_4 = 'progressionStyleUpgraded_4'),
                    we.Items,
                    we.Equipment,
                    we.Xp,
                    we.XpFactor,
                ...
                const Ue = (0, r.memo)(
                        ({
                            ...
                            const A = S().mediaSize,
                                ...
                                F = i === Ru.Special,
                                m = i === Ru.Win,
                                D = null == E ? void 0 : E.icon,
                                _ = A < f.Medium ? xe.Big : xe.S232x174,
                                d =
                                    o && D
                                        ? ((u, e = xe.Small) => {
                                              const t = u.name,
                                        ...
                                        : R.images.historical_battles.gui.maps.icons.artefact.quests.icons.$dyn(i),
                                B = h()(
                                    Tu.base,
                                    u,
                                    l ? Tu.base__done : Tu.base__available,
                                    c ? Tu.offence : Tu.defence,
                                    o && Tu.finalQuest,
                                ),
                                C = o ? Tu.offence_final_hover : Tu.offence_hover,
                                g = h()(c ? C : Tu.defence_hover, l && Tu.done),
                                p = (function (u = {}, e = []) {
                                    var t, n, a, i;
                                    const s = (0, r.useState)(null != (t = u.state) ? t : Fe),
                                        o = s[0],
                                        l = s[1],
                                        E = (0, r.useState)(null != (n = u.initialFrameIndex) ? n : 0),
                                        A = E[0],
                                        c = E[1],
                                        F = (0, r.useState)(null != (a = u.frameTime) ? a : 33),
                                        m = F[0],
                                        D = F[1],
                                        _ = (0, r.useState)(null == (i = u.loop) || i),
                                        d = _[0],
                                        B = _[1],
                                        C = (0, r.useRef)(A),
                                        g = (0, r.useCallback)((u) => {
                                        ...
                                        b = (0, r.useCallback)(() => l('play'), []),
                                        f = (0, r.useCallback)(() => {
                                            (c(C.current + 1), l('stop'));
                                        }, []);
                                    return {
                                        props: {
                                            state: o,
                            ...
                            const w = (0, r.useMemo)(
                                    () =>
                                        ((u) =>
                                            u < f.Medium
                                                ...
                                                : u >= f.Medium && u < f.ExtraLarge
                                                  ? { width: pe.width, height: pe.height }
                                                  : u >= f.ExtraLarge
                                                    ? { width: he.width, height: he.height }
                                                    : { width: 0, height: 0 })(A),
                                    [A],
                                ),
                                x = w.width,
                                T = w.height,
                                M = (0, r.useMemo)(
                                    () => ((u) => (u >= f.ExtraLarge ? ge(he) : u >= f.Medium ? ge(pe) : ge(be)))(A),
                                    [A],
                                );
                            return n().createElement(
                                'div',
                                {
                                    className: B,
                                    onMouseEnter: () => {
                                        He('ev_secret_event_hangar_ui_highlight');
                                    },
                                    onClick: () => {
                                        He('play');
                                    },
                                ...
                                o &&
                                    n().createElement(
                                        n().Fragment,
                                        null,
                                        n().createElement('div', { className: Tu.offence_final_above_hover }),
                                        n().createElement('div', { className: Tu.finalQuestGlow }),
                                    ),
                                n().createElement(
                                    'div',
                                    {
                                        className: h()(Tu.header, o && Tu.finalQuestIcon),
                                        style: { backgroundImage: l ? '' : `url("${d}")` },
                                    },
                                    l && n().createElement('div', { className: Tu.doneBg }),
                                    o &&
                                        n().createElement(
                                            'div',
                                            { className: Tu.sequenceWrapper },
                                            n().createElement(
                                                _e,
                                                Ge({}, p.props, {
                                                    width: x,
                                                    ...
                                                    loop: !1,
                                                    onAnimationDone: v,
                                                    className: Tu.finalQuestSequence,
                                                }),
                                            ),
                                        ),
                                ),
                                !o && n().createElement('div', { className: Tu.division }),
                                n().createElement(
                                    'div',
                                    { className: Tu.content },
                                    n().createElement(ce, {
                                        className: h()(Tu.title, F && Tu.titleTypeWin, o && Tu.titleFinalQuest),
                                        text: e,
                                    }),
                                    !F &&
                                        !m &&
                                        n().createElement(
                                            ...
                                            n().createElement(
                                                'div',
                                                { className: h()(Tu.progressBar, l && Tu.completed) },
                                                n().createElement(xu, {
                                                    size: K.Small,
                                                    value: t,
                                                    maxValue: a,
                                            ...
                                            n().createElement(
                                                'div',
                                                { className: Tu.progression },
                                                n().createElement(
                                                    'span',
                                                    { className: Tu.progression_current },
                                                    n().createElement(ve, { value: t }),
                                                ),
                                                n().createElement(
                                                    'span',
                                                    { className: Tu.progression_separator },
                                                    ' ',
                                                    '  / ',
                                                ),
                                                n().createElement(ve, { value: a }),
                                            ),
                                        ),
                                ),
                            );
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Xe(t, m, { isMouseEvent: !0, on: !0, arguments: $e(n) }, b),
                                    C && C(),
                ...
                const ze = { contentId: R.views.historical_battles.lobby.tooltips.QuestsWidgetTooltip('resId') },
                    Qe = (0, z.observer)(() => {
                        const u = q(),
                            e = u.model,
                            t = u.controls.click,
                            ...
                            a = r.frontName,
                            i = r.finalQuest,
                            s = e.computes.getQuests(),
                            o = Boolean(null == i ? void 0 : i.desc) && a === yu.Offence && !i.isCompleted,
                            l = o ? e.computes.getFinalQuestsReward() : void 0;
                        return n().createElement(
                            'div',
                            { className: Q.base },
                            s.map((u) =>
                                n().createElement(
                                    je,
                                    qe({}, ze, { key: u.id, args: { questId: u.id } }),
                                    n().createElement(
                                        'div',
                                        { className: Q.missionWrapper, onClick: t },
                                        n().createElement(Ue, qe({ frontName: a }, u)),
                                    ),
                                ),
                            ),
                            o &&
                                n().createElement(
                                    je,
                                    qe({}, ze, { args: { questId: i.id } }),
                                    n().createElement(
                                        'div',
                                        { className: Q.missionWrapper, onClick: t },
                                        n().createElement(
                                            Ue,
                                            qe({ frontName: a, isFinalQuest: !0 }, i, { finalQuestsReward: l }),
                                        ),
                                    ),
                                ),
                        );
                ...
                engine.whenReady.then(() => {
                    i().render(
                        n().createElement(k, null, n().createElement(j, null, n().createElement(Qe, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(755));
