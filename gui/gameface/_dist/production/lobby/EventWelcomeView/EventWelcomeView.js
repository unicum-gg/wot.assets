    ...
    var __webpack_modules__ = {
            ...
            9048: (e, u, t) => {
                ...
                var W = t(9916),
                    I = t(8613);
                Date.now();
                const P = I.Ew.getRegionalDateTime,
                    j = I.Ew.getFormattedDateTime,
                    U = (0, n.memo)(({ datetime: e, format: u = N.ShortDate, isConvertedToLocal: t = !0 }) =>
                        Object.values(N).includes(u) ? P(e, u, t) : j(e, u, t),
                    ),
                    G = [
                        'children',
                        'contentId',
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    ($(t, F, { isMouseEvent: !0, on: !0, arguments: V(r) }, f),
                                    B && B(),
                ...
                const ue = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    if (u.header || u.body) return r().createElement(J, u, n);
                    const a = u.contentId;
                    return a ? r().createElement(z, ee({}, u, { contentId: a }), n) : r().createElement(Y, u, n);
                };
                var te = t(8045);
                const ne = {
                ...
                const oe = { [ie.NBSP]: re.NoBreakSymbol, [ie.ZWNBSP]: re.NoBreakSymbol, [ie.NEW_LINE]: re.LineBreak },
                    ...
                    ce = 'renderers_word_f3',
                    Ee = (e) => ({ color: `#${e}` }),
                    de = ({ elementList: e, textBlock: u, key: t }) => {
                        const n = u.colorTag;
                        return n
                            ? le[n]
                                ? r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': u.blockType, className: B()(ce, le[n]) },
                                      e,
                                  )
                                : r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': u.blockType, className: ce, style: Ee(n) },
                                      e,
                                  )
                            : r().createElement('span', { key: t, 'data-block-type': u.blockType, className: ce }, e);
                    },
                    Ae = {
                        [re.Word]: de,
                        [re.NoBreakSymbol]: de,
                    ...
                    De = se
                        ...
                        : (e, u) => {
                              ...
                              let a = 0;
                              for (; n; ) {
                                  const i = u.justifyContent === ae.FlexEnd ? n.index : t.lastIndex;
                    ...
                    he = (e, u = '', t) => {
                        ...
                        return (
                            _e(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (e) => {
                                    n.push({ blockType: re.Word, colorTag: u, childList: De(e, t) });
                                },
                                (e) => {
                                    const t = e[0],
                                        r = oe[t.charAt(0)];
                    ...
                    fe = (e, u) => e.offsetLeft + e.offsetWidth - u,
                    be = (e, u, t) => {
                    ...
                    we = r().memo(
                        ({
                            ...
                            const A = (0, n.useRef)(null),
                                ...
                                m = _[0],
                                D = _[1],
                                h = (0, n.useMemo)(() => ge(e, a, { justifyContent: c }), [a, c, e]),
                                C = (0, n.useMemo)(() => {
                                    if (
                                        i &&
                                        m.isTruncated &&
                            ...
                            return (
                                ...
                                r().createElement(
                                    ...
                                    r().createElement('div', { className: ne.unTruncated, ref: A }, h),
                                    r().createElement(
                                        ue,
                                        {
                                            tooltipArgs: C,
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: B()(
                                                    ne.truncated,
                                                    !m.isTruncateFinished && o && ne.truncated__hide,
                                                ),
                                                style: p,
                                            },
                ...
                var ye = t(3403),
                    xe = t(7030);
                const Le = { x: 0, y: 0, opacity: 0, transform: 'scale(1) rotate(0deg)' },
                    Te = { x: 0, y: 0, opacity: 1, transform: 'scale(1) rotate(0deg)' };
                let ke;
                !(function (e) {
                    ((e.Linear = 'linear'),
                        (e.EaseIn = 'easeIn'),
                ...
                const Oe = {
                        [ke.Linear]: (e) => e,
                        [ke.EaseIn]: (e) => e * e * e,
                        [ke.EaseOut]: (e) => --e * e * e + 1,
                        [ke.EaseInOut]: (e) => (e < 0.5 ? 4 * e * e * e : (e - 1) * (2 * e - 2) * (2 * e - 2) + 1),
                        [ke.EaseOutBack]: (e) => 1 + 2.70158 * Math.pow(e - 1, 3) + 1.70158 * Math.pow(e - 1, 2),
                        [ke.EaseOutQuint]: (e) => 1 - Math.pow(1 - e, 5),
                        [ke.EaseOutExpo]: (e) => (1 === e ? 1 : 1 - Math.pow(2, -10 * e)),
                    },
                    Se = (0, n.memo)(function ({
                        children: e,
                        from: u = Le,
                        to: t = Te,
                        config: a,
                        ...
                        return (
                            (0, n.useEffect)(() => {
                                p.start({
                                    ...
                                    delay: l,
                                    immediate: i,
                                    config: a ? Object.assign({}, a) : { duration: s, easing: B },
                                    cancel: i || o,
                                    reverse: m,
                                    onRest: (e) => {
                                        !0 === e.finished && (h && h(), d && d());
                                    },
                                    onStart: () => {
                                        (D && D(), A && A());
                                    },
                                });
                            }, [p, l, s, B, u, i, d, t, F, o, m, h, D, A, a]),
                            r().createElement(xe.animated.div, { className: _, style: f }, e)
                        );
                    });
                function Me(e) {
                    engine.call('PlaySound', e).catch((u) => {
                ...
                We.defaultProps = { type: Ne.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Ie = We,
                    Pe = {
                ...
                class Ge extends r().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            A = B()(Pe.base, Pe[`base__${i}`], Pe[`base__${a}`], null == o ? void 0 : o.base),
                            F = B()(Pe.icon, Pe[`icon__${i}`], Pe[`icon__${a}`], null == o ? void 0 : o.icon),
                            _ = B()(Pe.glow, null == o ? void 0 : o.glow),
                            m = B()(Pe.caption, Pe[`caption__${i}`], null == o ? void 0 : o.caption),
                            D = B()(Pe.goto, null == o ? void 0 : o.goto);
                        return r().createElement(
                            'div',
                            Ue(
                                {
                ...
                const Ye = 500,
                    Xe = {
                        [qe.HEADER]: { from: { y: -10, opacity: 0 }, to: Ke, delay: 0, duration: Ye },
                        [qe.BLOCK_1]: { from: { y: 5, opacity: 0 }, to: Ke, delay: 400, duration: Ye },
                        [qe.TITLE_1]: { from: { y: -15, opacity: 0 }, to: Ke, delay: 400, duration: Ye },
                        [qe.BLOCK_2]: { from: { y: 5, opacity: 0 }, to: Ke, delay: 600, duration: Ye },
                        [qe.TITLE_2]: { from: { y: -15, opacity: 0 }, to: Ke, delay: 600, duration: Ye },
                        [qe.BLOCK_3]: { from: { y: 5, opacity: 0 }, to: Ke, delay: 800, duration: Ye },
                        [qe.TITLE_3]: { from: { y: -15, opacity: 0 }, to: Ke, delay: 800, duration: Ye },
                        [qe.BUTTON]: { from: { y: -10, opacity: 0 }, to: Ke, delay: 1200, duration: Ye },
                    };
                function Ze() {
                    return (
                        (Ze =
                ...
                const Qe = (0, n.memo)(
                    ({ localePath: e, subheader: u, close: t, submit: a, classMix: o, classMixImage: s }) => {
                        const l = e.$dyn('column'),
                            ...
                            F = d[1];
                        var _;
                        ((_ = t), ze(Ve.n.ESCAPE, _), ze(Ve.n.ENTER, a), ze(Ve.n.SPACE, a));
                        const m = (0, n.useCallback)(() => {
                            i.O.sound.play.sound('bp_glide_01');
                        }, []);
                        return r().createElement(
                            'div',
                            { className: B()('WelcomeViewLayout_base_3e', o), onClick: () => F(!0) },
                            r().createElement(Ge, {
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    ((e, u) => {
                                        ...
                                        r().createElement(
                                            Se,
                                            Ze({ key: e, isCanceled: A }, Xe[qe[`BLOCK_${e + 1}`]], { onStart: m }),
                                            r().createElement(
                                                'div',
                                                { className: 'WelcomeViewLayout_infoBlock_00' },
                                                r().createElement('div', {
                                                    className: B()('WelcomeViewLayout_icon_f9', s[e]),
                                                }),
                                                r().createElement(
                                                    Se,
                                                    Ze({ isCanceled: A }, Xe[qe[`TITLE_${e + 1}`]]),
                                                    r().createElement(
                                                        'div',
                                ...
                                r().createElement(
                                    Se,
                                    Ze({ className: 'WelcomeViewLayout_bottomContainer_35' }, Xe[qe.BUTTON], {
                                        isCanceled: A,
                                    }),
                                    r().createElement(
                                        'div',
                                        ...
                                        r().createElement(
                                            Ie,
                                            { type: Ne.primary, size: He.medium, onClick: a },
                ...
                const tu = (e) => (0 === e ? window : window.subViews.get(e)),
                    ...
                    ou = (0, ye.Pi)(() => {
                        ...
                        return r().createElement(Qe, {
                            ...
                            subheader: r().createElement(we, {
                                text: R.strings.sm_lobby.eventWelcomeScreen.subheader(),
                                justifyContent: ae.Center,
                                binding: {
                                    startDate: r().createElement(U, {
                                        datetime: t.startDate.get(),
                                        format: N.DayMonthFull,
                                        isConvertedToLocal: !1,
                                    }),
                                    endDate: r().createElement(U, {
                ...
                engine.whenReady.then(() => {
                    M().render(
                        r().createElement(O, null, r().createElement(ru, null, r().createElement(ou, null))),
