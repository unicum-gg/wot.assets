        ...
        e = {
            3495: (u, e, F) => {
                ...
                var A = F(3138),
                    ...
                    t = F(1043),
                    B = F(5262);
                const D = (function (u = A.O.client.getSize('rem')) {
                        const e = u.width,
                            F = u.height;
                        return Object.assign({ width: e, height: F }, (0, B.T)(e, F, t.j));
                    })(),
                    i = (0, E.createContext)(D);
            },
            1039: (u, e, F) => {
                (F(3138), F(7363), F(3495));
            },
            6010: (u, e, F) => {
                var A = F(7363),
                    E = F(7382),
                ...
                (0, A.memo)((u) => {
                    ...
                    const D = (0, A.useContext)(t.Y),
                        ...
                        f = { extraLarge: m, large: h, medium: c, small: v, extraSmall: w };
                    if (F.extraLarge || F.large || F.medium || F.small || F.extraSmall) {
                        ...
                        if (F.smallWidth && g) return (0, E.H)(e, F, f);
                        if (F.extraSmallWidth && s) return (0, E.H)(e, F, f);
                        if (
            ...
            527: (u, e, F) => {
                (F.r(e),
                    F.d(e, { mouse: () => C, off: () => i, on: () => D, onResize: () => t, onScaleUpdated: () => B }));
                var A = F(2472),
                    E = F(1176);
                const t = (0, A.E)('clientResized'),
                    B = (0, A.E)('self.onScaleUpdated'),
                    D = (u, e) => engine.on(u, e),
            ...
            3138: (u, e, F) => {
                ...
                var A = F(5959),
                    E = F(7698),
                    t = F(514);
                const B = { view: F(7641), client: A, sound: t.ZP, intl: E.N };
            },
            7698: (u, e, F) => {
                F.d(e, { N: () => A });
                const A = {
            ...
            514: (u, e, F) => {
                ...
                const E = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    ...
                    B = { play: Object.assign({}, t, { sound: A.playSound }), setRTPC: A.setRTPC };
            },
            3722: (u, e, F) => {
                function A(u, e, F = 1) {
            ...
            7641: (u, e, F) => {
                ...
                const H = Object.keys(t.W).reduce(
        ...
        (A.O = (e, F, E, t) => {
            if (!F) {
                ...
                for (C = 0; C < u.length; C++) {
                    for (var [F, E, t] = u[C], D = !0, i = 0; i < F.length; i++)
