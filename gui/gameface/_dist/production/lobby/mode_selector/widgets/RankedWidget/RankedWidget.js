(() => {
    ...
    var __webpack_modules__ = {
            ...
            9294: (u, e, t) => {
                ...
                var n = {};
                (t.r(n),
                    t.d(n, { mouse: () => d, off: () => l, on: () => s, onResize: () => o, onScaleUpdated: () => A }));
                var a = {};
                (t.r(a),
                    t.d(a, {
                        events: () => n,
                ...
                var i = {};
                (t.r(i), t.d(i, { getBgUrl: () => k, getTextureUrl: () => x }));
                var r = {};
                function E(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const m = {
                    ...
                    w = { play: Object.assign({}, v, { sound: D }), setRTPC: c },
                ...
                const su = { view: r, client: a, sound: w, intl: g };
            },
            7902: (u, e, t) => {
                t.d(e, { F: () => n });
                const n = (u = 1) => {
