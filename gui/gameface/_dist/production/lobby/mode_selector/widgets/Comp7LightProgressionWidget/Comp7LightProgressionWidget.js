        ...
        e = {
            3495: (u, e, F) => {
                ...
                const t = A.O.client.getSize('rem'),
                    i = t.width,
                    C = t.height,
                    r = Object.assign({ width: i, height: C }, (0, D.T)(i, C, B.j)),
            ...
            527: (u, e, F) => {
                (F.r(e),
                    F.d(e, { mouse: () => r, off: () => i, on: () => t, onResize: () => B, onScaleUpdated: () => D }));
                var A = F(2472),
                    E = F(1176);
            ...
            3872: (u, e, F) => {
                (F(6483), F(9924), F(6179), F(8668), F(9930), F(3486));
                R.images.gui.maps.icons.comp7.widget;
            },
        },
        F = {};
    function A(u) {
