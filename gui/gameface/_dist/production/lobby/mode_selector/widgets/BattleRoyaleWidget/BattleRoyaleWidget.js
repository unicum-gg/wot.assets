    ...
    var u,
        e = {
            1661: (u, e, F) => {
                var A = {};
                (F.r(A),
                    F.d(A, { mouse: () => d, off: () => o, on: () => l, onResize: () => C, onScaleUpdated: () => a }));
                var E = {};
                (F.r(E),
                    F.d(E, {
                        events: () => A,
                ...
                var t = {};
                (F.r(t), F.d(t, { getBgUrl: () => L, getTextureUrl: () => H }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => $,
                ...
                const i = (u, e, F) =>
                    e.extraLargeHeight || e.largeHeight || e.mediumHeight || e.smallHeight || e.extraSmallHeight
                        ? (e.extraLargeHeight && F.extraLarge) ||
                          (e.largeHeight && F.large) ||
                          (e.mediumHeight && F.medium) ||
                          (e.smallHeight && F.small) ||
                          (e.extraSmallHeight && F.extraSmall)
                            ? u
                            : null
                        : u;
                function n(u) {
                ...
                const C = n('clientResized'),
                    ...
                    g = { down: n('mousedown'), up: n('mouseup'), move: n('mousemove') };
                const d = (function () {
                ...
                const v = {
                    ...
                    x = Object.keys(f).reduce((u, e) => ((u[e] = () => s(f[e])), u), {}),
                    p = { play: Object.assign({}, x, { sound: s }), setRTPC: m },
                    S = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    b = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function y(u) {
                    let e = '';
                    for (let F = b.length - 1; F >= 0; F--) for (; u >= b[F]; ) ((e += S[F]), (u -= b[F]));
                    return e;
                }
                ...
                const lu = { view: B, client: E, sound: p, intl: w };
                const ou = {
                ...
                const du = (function (u = lu.client.getSize('rem')) {
                        const e = u.width,
                            F = u.height;
                        return Object.assign(
                            ...
                            (function (u, e, F) {
                                const A = (function (u, e) {
                                    ...
                                    t = Math.min(A, E);
                                return {
                                    extraLarge: t === F.extraLarge.weight,
                                    large: t === F.large.weight,
                                    medium: t === F.medium.weight,
                                    small: t === F.small.weight,
                                    extraSmall: t === F.extraSmall.weight,
                                    extraLargeWidth: A === F.extraLarge.weight,
                                    largeWidth: A === F.large.weight,
                                    mediumWidth: A === F.medium.weight,
                                    smallWidth: A === F.small.weight,
                                    extraSmallWidth: A === F.extraSmall.weight,
                                    extraLargeHeight: E === F.extraLarge.weight,
                                    largeHeight: E === F.large.weight,
                                    mediumHeight: E === F.medium.weight,
                ...
                (0, D.memo)((u) => {
                    ...
                    const A = (0, D.useContext)(su),
                        ...
                        v = { extraLarge: d, large: s, medium: m, small: h, extraSmall: c };
                    if (F.extraLarge || F.large || F.medium || F.small || F.extraSmall) {
                        if (F.extraLarge && E) return e;
                        if (F.large && t) return e;
                        if (F.medium && B) return e;
                        if (F.small && n) return e;
                        if (F.extraSmall && r) return e;
                    } else {
                        if (F.extraLargeWidth && C) return i(e, F, v);
                        if (F.largeWidth && a) return i(e, F, v);
                        if (F.mediumWidth && l) return i(e, F, v);
                        if (F.smallWidth && o) return i(e, F, v);
                        if (F.extraSmallWidth && g) return i(e, F, v);
                        if (
                            !(F.extraLargeWidth || F.largeWidth || F.mediumWidth || F.smallWidth || F.extraSmallWidth)
                        ) {
                            if (F.extraLargeHeight && d) return e;
                            if (F.largeHeight && s) return e;
                            if (F.mediumHeight && m) return e;
                            if (F.smallHeight && h) return e;
                            if (F.extraSmallHeight && c) return e;
                        }
                    }
                    return null;
                });
        ...
        (A.O = (e, F, E, t) => {
            if (!F) {
                ...
                for (r = 0; r < u.length; r++) {
                    for (var [F, E, t] = u[r], D = !0, i = 0; i < F.length; i++)
                        (!1 & t || B >= t) && Object.keys(A.O).every((u) => A.O[u](F[i]))
                            ? F.splice(i--, 1)
                            : ((D = !1), t < B && (B = t));
                    if (D) {
                        u.splice(r--, 1);
