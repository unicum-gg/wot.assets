(() => {
    ...
    var u,
        e = {
            8962: (u, e, F) => {
                var A = {};
                (F.r(A), F.d(A, { mouse: () => g, onResize: () => a }));
                var E = {};
                (F.r(E),
                    F.d(E, {
                        events: () => A,
                ...
                var B = {};
                (F.r(B), F.d(B, { getBgUrl: () => h, getTextureUrl: () => s }));
                var D = {};
                (F.r(D),
                    F.d(D, {
                        addModelObserver: () => T,
                ...
                const Du = (u) => {
                    ...
                    if (F.extraLarge || F.large || F.medium || F.small || F.extraSmall) {
                        ...
                        if (F.small && i) return e;
                        if (F.extraSmall && r) return e;
                    } else {
                        if (F.extraLargeWidth && n) return C(e, F, v);
                        if (F.largeWidth && a) return C(e, F, v);
