(() => {
    ...
    var __webpack_modules__ = {
            ...
            3495: (u, e, t) => {
                ...
                const E = n.O.client.getSize('rem'),
                    A = E.width,
                    F = E.height,
                    s = Object.assign({ width: A, height: F }, (0, a.T)(A, F, i.j)),
            ...
            6010: (u, e, t) => {
                ...
                const E = (u) => {
                    ...
                    const E = (0, n.useContext)(i.Y),
                        ...
                        p = { extraLarge: m, large: c, medium: g, small: b, extraSmall: h };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && _) return (0, r.H)(e, t, p);
                        if (t.smallWidth && C) return (0, r.H)(e, t, p);
                        if (t.extraSmallWidth && d) return (0, r.H)(e, t, p);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
            ...
            7590: (u, e, t) => {
                ...
                const F = ({ size: u = A.$.Default }) => {
                    ...
                    D = (0, i.memo)(
                        ({ size: u, lineRef: e, disabled: t, baseStyles: n, isComplete: i, withoutBounce: E }) => {
                            const A = r()(
                                    l.base,
                                    l[`base__${u}`],
                                    t && l.base__disabled,
                                    i && l.base__finished,
                                    E && l.base__withoutBounce,
                                ),
                                F = !t && !i;
                            return a().createElement(
                                'div',
                                { className: A, style: n, ref: e },
                                a().createElement('div', { className: l.pattern }),
                                a().createElement('div', { className: l.gradient }),
                                F && a().createElement(o, { size: u }),
                            );
                        },
                    ),
                    B = ({ size: u, value: e, lineRef: t, disabled: n, onComplete: r }) => {
                        const E = (0, i.useMemo)(() => ({ width: `${e}%`, transitionProperty: 'none' }), [e]),
                            A = 100 === e;
                        return (
                            (0, i.useEffect)(() => {
                                A && r && r();
                            }, [A, r]),
                            a().createElement(D, { size: u, disabled: n, baseStyles: E, isComplete: A, lineRef: t })
                        );
                    },
                    _ = (u, e) => {
                        let t;
                ...
                const m = 'ProgressBarDeltaSimple_base_6c',
                        ...
                        ({
                            ...
                            return g
                                ...
                                : a().createElement(
                                      ...
                                      a().createElement(
                                          'div',
                                          { style: b ? p : w, className: c },
                                          a().createElement(o, { size: r }),
                                      ),
                                  );
                        },
                    ),
                    ...
                    T = (0, i.memo)(
                        ({
                            ...
                            const S = (0, i.useMemo)(() => Object.assign({ width: '100%' }, x(u), f(D)), [D, u]),
                                k = (0, i.useMemo)(() => Object.assign({ width: '0%' }, x(u), f(D)), [D, u]),
                                O = (0, i.useMemo)(() => Object.assign({ width: '0%' }, v(D, n), x(u)), [n, D, u]),
                                L = (0, i.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(A - n)}%` }, v(D, n), x(u)),
                                    [n, D, A, u],
                                );
                            if (c) return null;
                            const P = r()(h, l, D && 0 === A && p);
                            return a().createElement(
                                'div',
                                { style: g ? O : L, className: P },
                                a().createElement(
                                    'div',
                                    { style: T ? k : S, className: w },
                                    a().createElement(o, { size: E }),
                                ),
                            );
                        },
                    ),
                ...
                const k = (0, i.memo)((u) => {
                        ...
                        switch (n.animationSettings.type) {
                            case A.r.Simple:
                                return a().createElement(b, S({}, n, { onEndAnimation: s, isComplete: E }));
                            case A.r.Growing:
                                return a().createElement(W, S({}, n, { onEndAnimation: s, isComplete: E }));
                            default:
                                return null;
                        }
                    }),
                ...
                const P = (0, i.memo)((u) => {
                    ...
                    return (
                        (n.current.from = E),
                        a().createElement(k, L({}, t, { onEndAnimation: r, key: `${E}-${t.to}`, from: E }))
                    );
                });
                function R() {
                    return (
                ...
                const M = (0, i.memo)(
                    ({
                        ...
                        return i.withStack ? a().createElement(P, s) : a().createElement(k, R({ key: `${r}-${e}` }, s));
                    },
                );
                var I = t(156);
                const N = (u, e, t) => (t < u ? u : t > e ? e : t),
                    ...
                    $ = (0, i.memo)(
                        ({
                            ...
                            const m = ((u, e, t) =>
                                (0, i.useMemo)(() => {
                                    const n = (N(0, e, u) / e) * 100;
                                    return { value: n, deltaFrom: H(n, e, t) };
                                }, [t, e, u]))(l, u, D);
                            return a().createElement(
                                'div',
                                { className: r()(E.base, E[`base__${t}`]), style: (0, I.VQ)(e) },
                                !o && a().createElement(F, { size: t }),
                                a().createElement(M, {
                                    size: t,
                                    lineRef: B,
                                    disabled: s,
                ...
                const A = (u, e, t = {}, n = 0) => {
                    ...
                    F = (u) => {
                        ...
                        const v = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            x = (0, i.useMemo)(() => h || (0, n.F)().resId, [h]),
                            T = (0, i.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (A(t, m, { isMouseEvent: !0, on: !0, arguments: E(r) }, x),
                                    p && p(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((v.current.timeoutId = window.setTimeout(T, B ? 100 : 400)),
                                                      F && F(u),
                                                      S && S(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
            ...
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => s, off: () => A, on: () => E, onResize: () => i, onScaleUpdated: () => a }));
                var n = t(2472),
                    r = t(1176);
            ...
            9924: (u, e, t) => {
                ...
                var n = t(6483),
                    ...
                    A = t(3649);
                function F(u, e, t) {
                    const n = (0, E.useContext)(i.YN);
                    let F = Object.entries(n).filter(([u, e]) => !0 === e && u in a.u);
                    return (
                        t && (F = F.filter((u) => t.includes(u[0]))),
                        u.reduce((u, t) => {
                            const n = F.map((u) =>
                                r()(e[((u, e) => u + '__' + e)(t, u[0])], e[((u, e) => u + (0, A.e)(e))(t, u[0])]),
                            );
                            return ((u[t] = r()(e[t], ...n)), u);
                        }, {})
                    );
                }
            },
            ...
            3649: (u, e, t) => {
                ...
                const E = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    s = (u, e, t = r.left) => u.split(e).reduce(t === r.left ? A : F, []),
                    o = (() => {
                        const u = new RegExp(
                    ...
                    B = (u, e, t) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : D(u, e)));
            },
            1358: (u, e, t) => {
                t.d(e, { Z: () => i });
                var n = t(3138);
            ...
            3486: (u, e, t) => {
                ...
                const i = (u, e = !1) => (e && 1 === u ? n.B0 : `b${Math.min(Math.max(Math.floor(u), 0), 6)}`),
                    a = {},
                    E = (...u) => {
                        let e = [];
                        for (var t = 0, n = u; t < n.length; t++) {
                            const u = n[t];
                            if (u in a) e = e.concat(a[u]);
                            else {
                                const t = [u];
                                for (let e = 0; e <= 6; e++) t.push(`${u}__${i(e)}`);
                                ((a[u] = t), (e = e.concat(a[u])));
                            }
                        }
                        return e;
                    };
            ...
            7256: (u, e, t) => {
                ...
                (0, n.memo)(({ totalCount: u, currentProgress: e, ticketCount: t, size: i }) => {
                    const B = i === l.Id.B1 || i === l.Id.B2 || i === l.Id.B3,
                        _ = (0, A.Z)([...(0, l.Hp)('emblem', 'base', 'progress', 'tickets')], D),
                        C = e && u ? (100 * e) / u : 0,
                        d = (0, n.useMemo)(
                            () => ({ current: r().createElement('span', { className: D.currentAmount }, e), total: u }),
                            [e, u],
                        ),
                        m = (0, n.useMemo)(
                            () => ({ count: r().createElement('span', { className: D.ticketsCount }, t) }),
                            [t],
                        ),
                        c = a()(_.base, _[`base__${i}`]),
                        g = a()(_.emblem, _[`emblem__${i}`], e === u && D.emblem__full),
                        b = a()(_.progress, _[`progress__${i}`]),
                        h = a()(_.tickets, _[`tickets__${i}`]);
                        ...
                        B &&
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(E.ko, { size: E.$u.Small, value: C, theme: F.Yy }),
                                ),
                            ),
                    );
                });
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (A = 0; A < deferred.length; A++) {
                    for (var [e, t, n] = deferred[A], i = !0, a = 0; a < e.length; a++)
                        (!1 & n || r >= n) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [705], () => __webpack_require__(7256));
