(() => {
    ...
    var __webpack_modules__ = {
            ...
            3374: (u, e, t) => {
                    ...
                    const B = (0, n.useRef)(null),
                        ...
                        W = w()(
                            ...
                            p[`base__${i}`],
                            {
                                ...
                                [p[`base__${e}`]]: e,
                                [p.base__focus]: C,
                                [p.base__highlightActive]: g,
                                [p.base__firstHover]: T,
                            },
                            o,
                        ),
                        U = w()(p.state, p.state__default);
                    return (
                        (0, n.useEffect)(
                            () => (
                ...
                class y extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            _ = w()(S.base, S[`base__${r}`], S[`base__${i}`], null == o ? void 0 : o.base),
                            c = w()(S.icon, S[`icon__${r}`], S[`icon__${i}`], null == o ? void 0 : o.icon),
                            D = w()(S.glow, null == o ? void 0 : o.glow),
                            B = w()(S.caption, S[`caption__${r}`], null == o ? void 0 : o.caption),
                            d = w()(S.goto, null == o ? void 0 : o.goto);
                ...
                const N = (u = 1) => {
                    ...
                    V = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: a, modelPath: U(a, u || ''), resId: n };
                            })(),
                            t = e.modelPrefix,
                            n = u.split('.');
                        if (n.length > 0) {
                ...
                const Z = {
                    ...
                    X = ({ description: u, children: e, icon: t, title: n }) => {
                        const i = $(['base', 'title'], Z);
                        return a().createElement(
                            'div',
                            { className: i.base },
                            a().createElement('div', { className: Z.icon, style: { backgroundImage: `url(${t})` } }),
                            a().createElement(
                                'div',
                                { className: i.title },
                                a().createElement('div', { className: Z.titleText }, n),
                            ),
                            e,
                            a().createElement('div', { className: Z.description }, u),
                        );
                    },
                    Q = {
                        ...
                        closeButton: 'BattleSessionViewApp_closeButton_8a',
                    ...
                    eu = () => {
                        const u = z(),
                            ...
                            r = u.onTournamentsClicked,
                            o = u.isInClan,
                            s = u.clanName,
                            E = u.clanIcon,
                            A = u.isTournamentLinkIGB,
                            F = (0, n.useCallback)(() => {
                                e();
                            }, [e]),
                            l = (0, n.useCallback)(() => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement('div', { className: B.title }, J.title()),
                            a().createElement(
                                'div',
                                { className: Q.tournaments },
                                a().createElement(
                                    X,
                                    {
                                        icon: uu.c_136x136.neutral(),
                                        title: J.tournaments.title(),
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(
                                            'div',
                                            { className: Q.webButton },
                                            J.tournaments.button(),
                                            !A && a().createElement('div', { className: Q.gotoWebIcon }),
                                        ),
                                    ),
                                ),
                                a().createElement(
                                    X,
                                    {
                                        icon: uu.c_136x136.clan(),
                                        title: J.globalMap.title(),
                                        description: J.globalMap.description(),
                                    },
                                    a().createElement(
                                        'div',
                                        { className: Q.buttons },
                                        a().createElement(
                                            T,
                                            { size: f.medium, mixClass: Q.button, onClick: l },
                                            o
                                                ? a().createElement(
                                                      'div',
                                                      { className: Q.clanButton },
                                                      a().createElement('div', {
                                                          className: Q.clanIcon,
                                                ...
                                                : a().createElement(
                                                      'div',
                                                      { className: Q.enterClanButton },
                                                      J.globalMap.enterClan(),
                                                  ),
                                        ),
                                        a().createElement(
                                            T,
                                            ...
                                            a().createElement(
                                                ...
                                                { className: Q.webButton },
                                                J.globalMap.button(),
                                                a().createElement('div', { className: Q.gotoWebIcon }),
                                            ),
                                        ),
                                    ),
                                ),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [705], () => __webpack_require__(3374));
