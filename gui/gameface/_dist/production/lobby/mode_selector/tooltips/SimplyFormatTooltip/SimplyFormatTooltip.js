(() => {
    ...
    var __webpack_modules__ = {
            ...
            3138: (u, e, F) => {
                ...
                var E = F(5959),
                    A = F(7698),
                    t = F(514);
                const D = { view: F(7641), client: E, sound: t.ZP, intl: A.N };
            },
            7698: (u, e, F) => {
                F.d(e, { N: () => E });
                const E = {
            ...
            7641: (u, e, F) => {
                ...
                const x = Object.keys(t.W).reduce(
            ...
            4475: (u, e, F) => {
                ...
                const i = n().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            n().createElement(
                                'div',
                                C({}, s, {
                                    className: A()(B.base, B[`base__theme-${a}`], E),
                                    ref: function (u) {
                                        ((c.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                    },
                                }),
                                n().createElement('div', { className: B.decorator }, F),
                            )
                        );
                    }),
                    a = ReactDOM;
                ...
                const _ = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    p = (u, e, F = c.left) => u.split(e).reduce(F === c.left ? w : m, []),
                    h = (() => {
                        const u = new RegExp(
                            [
                    ...
                    g = (u, e = c.left) => {
                        ...
                        return ((u, e = c.left) => {
                            ...
                            const E =
                                ...
                                A = _(u);
                            return (p(A, /( )/, e).forEach((u) => (F = F.concat(p(u, E, c.left)))), F);
                        })(u, e);
                    };
                var f = F(9916),
                    b = F(8613);
                ...
                const T = (u = 1) => {
                    ...
                    P = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, F) => {
                                const E = y(`${u}.${F}`, window);
                                return O(E) ? e(u, F, E) : `${u}.${F}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    S = (u) => {
                        const e = ((u) => {
                                const e = T(),
                                ...
                                return { modelPrefix: A, modelPath: k(A, u || ''), resId: E };
                            })(),
                            F = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const A = y(k(F, `${e}.${E}`), window);
                                    return O(A) ? (u.push(A.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const W = (u = 'model', e = N.Deep) => {
                            ...
                            x(() => {
                                if (
                                    ...
                                    const F = (u) => {
                                        ...
                                        A = S(u);
                                    a.current = L.addCallback(A, F, r, e === N.Deep);
                                }
                            }),
                            (0, D.useEffect)(() => {
                                if (e !== N.None)
                                    return () => {
                                        L.removeCallback(a.current, r);
                                    };
                            }, [r, e]),
                            C
                        );
                    },
                    U = (f.Sw.instance, 'FormatText_base_d0'),
                    I = ({ binding: u, text: e = '', classMix: F, alignment: E = c.left, formatWithBrackets: t }) => {
                        ...
                        return n().createElement(
                            ...
                            r.split('\n').map((e, t) =>
                                n().createElement(
                                    'div',
                                    { className: A()(U, F), key: `${e}-${t}` },
                                    ((u, e, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : g(u, e))))(
                                        e,
                                        E,
                                        u,
                                    ).map((u, e) => n().createElement(D.Fragment, { key: `${e}-${u}` }, u)),
                                ),
                            ),
                        );
                    },
                    ...
                    q = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    z = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    G = ({ text: u, binding: e, classMix: F }) => {
                        const E = (0, D.useCallback)((u) => ({ color: `#${u}` }), []),
                            A = e || {};
                        let t = j.exec(u),
                            r = u;
                        for (; t; ) {
                                ...
                                ((r = r.replace(F, `%(${t})`)),
                                    (A[t] = V[u]
                                        ? n().createElement(
                                              'span',
                                              { className: V[u] },
                                              n().createElement(I, { text: o, binding: e }),
                                          )
                                        : n().createElement(
                                              'span',
                                              { style: E(u) },
                        ...
                        return n().createElement(I, { text: r, classMix: F, binding: A });
                    },
                    K = 'SimplyFormatTooltipApp_base_08',
                    $ = 'SimplyFormatTooltipApp_header_db',
                    H = 'SimplyFormatTooltipApp_header__withBody_6a',
                    Y = 'SimplyFormatTooltipApp_body_eb',
                    Z = () => {
                        const u = W('model'),
                            e = u.header,
                            F = u.body;
                        return F || e
                            ? n().createElement(
                                  'div',
                                  { className: K },
                                  e && n().createElement(G, { text: e, classMix: A()($, F && H) }),
                                  F && n().createElement(G, { text: F, classMix: Y }),
                              )
                            : null;
                    };
                engine.whenReady.then(() => {
                    s().render(n().createElement(i, null, n().createElement(Z, null)), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [705], () => __webpack_require__(4475));
