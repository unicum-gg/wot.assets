(() => {
    ...
    var __webpack_modules__ = {
                ...
                const p = E.instance,
                    g = {
                        ...
                        sendShowPopOverEvent: (u, e, A, F, E = R.invalid('resId'), D) => {
                            const t = s.O.view.getViewGlobalPosition(),
                                ...
                                i = n.height,
                                a = {
                                    x: s.O.view.pxToRem(r) + t.x,
                                    y: s.O.view.pxToRem(C) + t.y,
            ...
            4770: (u, e, A) => {
                ...
                const i = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            o({}, s, {
                                className: E()(r.base, r[`base__theme-${a}`], F),
                                ref: function (u) {
                ...
                const c = (u, e, A) => {
                    ...
                    d = (u, e, A = _.left) => u.split(e).reduce(A === _.left ? c : l, []),
                    w = (() => {
                        const u = new RegExp(
                        ...
                        return m.includes(A)
                            ...
                            : ((u, e = _.left) => {
                                  ...
                                  const F =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return d(E, /( )/, e).forEach((u) => (A = A.concat(d(u, F, _.left)))), A;
                              })(u, e);
                    };
                let v;
                !(function (u) {
                ...
                const g = (u = 1) => {
                    ...
                    y = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, A) => {
                                const F = b(`${u}.${A}`, window);
                                return T(F) ? e(u, A, F) : `${u}.${A}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    x = (u) => {
                        const e = ((u) => {
                                const e = g(),
                                ...
                                return { modelPrefix: E, modelPath: O(E, u || ''), resId: F };
                            })(),
                            A = e.modelPrefix,
                            F = u.split('.');
                        if (F.length > 0) {
                            ...
                            return (
                                F.reduce((e, F) => {
                                    const E = b(O(A, `${e}.${F}`), window);
                                    return T(E) ? (u.push(E.id), `${e}.${F}.value`) : (u.push(F), `${e}.${F}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const k = (u = 'model', e = M.Deep) => {
                        const A = (0, t.useState)(0),
                            F = (A[0], A[1]),
                            E = (0, t.useMemo)(() => g(), []),
                            D = E.caller,
                            n = E.resId,
                            ...
                            f(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        E = x(u);
                                    i.current = P.addCallback(E, A, n, e === M.Deep);
                                }
                            }),
                            (0, t.useEffect)(() => {
                                if (e !== M.None)
                                    return () => {
                                        P.removeCallback(i.current, n);
                                    };
                            }, [n, e]),
                            C
                        );
                    },
                    S = (p.Sw.instance, 'FormatText_base_d0'),
                    N = ({ binding: u, text: e = '', classMix: A, alignment: F = _.left }) =>
                        null === e
                            ...
                            : n().createElement(
                                  ...
                                  e.split('\n').map((e, D) =>
                                      n().createElement(
                                          'div',
                                          { className: E()(S, A), key: `${e}-${D}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : h(u, e))))(e, F, u).map((u, e) =>
                                              n().createElement(t.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              ),
                                ...
                                (B = B.replace(A, `%(${D})`)),
                                    (E[D] = L[u]
                                        ? n().createElement(
                                              'span',
                                              { className: L[u] },
                                              n().createElement(N, { text: C, binding: e }),
                                          )
                                        : n().createElement(
                                              'span',
                                              { style: F(u) },
                ...
                engine.whenReady.then(() => {
                    s().render(n().createElement(i, null, n().createElement(j, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [705], () => __webpack_require__(4770));
