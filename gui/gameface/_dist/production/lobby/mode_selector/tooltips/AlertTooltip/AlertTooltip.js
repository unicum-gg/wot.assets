(() => {
    ...
    var __webpack_modules__ = {
            7085: (u, e, A) => {
                ...
                var t = {};
                (A.r(t), A.d(t, { getBgUrl: () => T, getTextureUrl: () => O }));
                var D = {};
                function n(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const Bu = Object.keys(P).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === P[e]), u), {}),
                    ru = {
                        set: (u, e) => {
            ...
            5647: (u, e, A) => {
                ...
                const o = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    w = ({ binding: u, text: e = '', classMix: A, alignment: t = C.left, formatWithBrackets: D }) => {
                ...
                const g = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            f({}, r, {
                                className: B()(m.base, m[`base__theme-${n}`], t),
                                ref: function (u) {
                ...
                const O = (u = 1) => {
                    ...
                    S = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: F, modelPath: k(F, u || ''), resId: E };
                            })(),
                            A = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                            ...
                            P(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        E = S(u);
                                    a.current = N.addCallback(E, A, B, e === I.Deep);
                                }
                            }),
                            (0, E.useEffect)(() => {
                                if (e !== I.None)
                                    return () => {
                                        N.removeCallback(a.current, B);
                                    };
                            }, [B, e]),
                            i
                        );
                    },
                    V = (b.Sw.instance, 'AlertTooltipApp_base_eabb9'),
                    j = 'AlertTooltipApp_header_fb36c',
                    z = 'AlertTooltipApp_description_b8f97',
                    W = 'AlertTooltipApp_alertIcon_a8925',
                    q = 'AlertTooltipApp_alert_d7cd8',
                    G = () => {
                        const u = U(),
                            e = u.header,
                            A = u.body,
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                F().createElement('div', { className: z }, F().createElement(w, { text: A })),
                                E &&
                                    F().createElement(
                                        'div',
                                        { className: q },
                ...
                engine.whenReady.then(() => {
                    D().render(F().createElement(G, null), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [705], () => __webpack_require__(5647));
