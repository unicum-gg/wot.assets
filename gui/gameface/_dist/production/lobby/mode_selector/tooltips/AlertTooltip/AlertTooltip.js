(() => {
    ...
    var __webpack_modules__ = {
            ...
            3062: (u, e, A) => {
                        ...
                        return s.includes(A)
                            ...
                            : ((u, e = C.left) => {
                                  ...
                                  const E =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return o(F, /( )/, e).forEach((u) => (A = A.concat(o(u, E, C.left)))), A;
                              })(u, e);
                    },
                        ...
                        null === e
                            ...
                            : F().createElement(
                                  ...
                                  e.split('\n').map((e, t) =>
                                      F().createElement(
                                          'div',
                                          { className: n()(_, A), key: `${e}-${t}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : c(u, e))))(e, D, u).map((u, e) =>
                ...
                const h = F().forwardRef(function (u, e) {
                    let A = u.children,
                        D = u.className,
                        t = u.theme,
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            m({}, C, {
                                className: n()(w.base, w[`base__theme-${B}`], D),
                                ref: function (u) {
                                    (i.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            F().createElement('div', { className: w.decorator }, A),
                        )
                    );
                });
                let f;
                ...
                const g = (u = 1) => {
                    ...
                    M = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, A) => {
                                const E = O(`${u}.${A}`, window);
                                return y(E) ? e(u, A, E) : `${u}.${A}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    k = (u) => {
                        const e = ((u) => {
                                const e = g(),
                                ...
                                return { modelPrefix: F, modelPath: P(F, u || ''), resId: E };
                            })(),
                            A = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const F = O(P(A, `${e}.${E}`), window);
                                    return y(F) ? (u.push(F.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                            ...
                            T(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        E = k(u);
                                    o.current = x.addCallback(E, A, B, e === S.Deep);
                                }
                            }),
                            (0, E.useEffect)(() => {
                                if (e !== S.None)
                                    return () => {
                                        x.removeCallback(o.current, B);
                                    };
                            }, [B, e]),
                            r
                        );
                    },
                    L = (b.Sw.instance, 'AlertTooltipApp_base_a5'),
                    U = 'AlertTooltipApp_header_0e',
                    I = 'AlertTooltipApp_description_2e',
                    V = 'AlertTooltipApp_alertIcon_2c',
                    W = 'AlertTooltipApp_alert_af',
                    H = () => {
                        const u = N(),
                            e = u.header,
                            A = u.body,
                ...
                engine.whenReady.then(() => {
                    t().render(F().createElement(H, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [705], () => __webpack_require__(3062));
