(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => F, off: () => E, on: () => a, onResize: () => r, onScaleUpdated: () => i });
                var n = t(2472),
                    o = t(1176);
            ...
            9916: (u, e, t) => {
                t.d(e, { Sw: () => r.Z, B0: () => a, ry: () => C, Eu: () => _, Sy: () => m });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            2980: (u, e, t) => {
                ...
                const _ = (u) => {
                        ...
                        const H = (0, n.useState)(!1),
                            ...
                            Q = o().createElement(
                                ...
                                o().createElement(
                                    'div',
                                    { className: E()(d.labelContent, 's-labelContent'), style: L },
                                    S || N,
                                ),
                            );
                        return o().createElement(
                            ...
                            C(
                                {
                                    id: e,
                                    className: E()(d.base, d[`base__${m}`], d[`base__${b}`], {
                                        [d.base__checked]: r,
                                        [d.base__disabled]: a,
                                        [d.base__mouseDown]: U,
                                        [d.base__alert]: _,
                                        [d.base__center]: I === D.Center,
                                        [d.base__bottom]: I === D.Bottom,
                                    }),
                                    onClick: q,
                                    onMouseEnter: Y,
                                    onMouseLeave: $,
                ...
                const h = (u, e, t = {}, n = 0) => {
                    ...
                    p = (u) => {
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            y = (0, n.useMemo)(() => _ || v().resId, [_]),
                            k = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (h(t, D, { isMouseEvent: !0, on: !0, arguments: b(o) }, y),
                                    m && m(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((g.current.timeoutId = window.setTimeout(k, F ? 100 : 400)),
                                                      r && r(u),
                                                      P && P(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                                        ...
                                        return (
                                            ...
                                            v.run(() => {
                                                const e = u.scrollWidth,
                                                    t = u.scrollHeight;
                                                O.O.view.resize(e, t), D(window.decorator.directionType);
                                            })
                                        );
                                }, [v]);
                            return (
                                (0, n.useImperativeHandle)(i, () => ({ updateSize: w })),
                                T(() => {
                ...
                const V = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    H = (u) => {
                    ...
                    z = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: o, modelPath: j(o, u || ''), resId: n };
                            })(),
                            t = e.modelPrefix,
                            n = u.split('.');
                        if (n.length > 0) {
                            ...
                            return (
                                n.reduce((e, n) => {
                                    const o = V(j(t, `${e}.${n}`), window);
                                    return U(o) ? (u.push(o.id), `${e}.${n}.value`) : (u.push(n), `${e}.${n}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        H(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = z(u);
                                l.current = G.addCallback(n, t, E, e === K.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== K.None)
                ...
                function X(u = $.n.NONE, e = Z, t = !1, o = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== $.n.NONE)
                            return (
                        ...
                        function n(n) {
                            if (n.keyCode === u) {
                                if (!o && O.O.view.isEventHandled()) return;
                ...
                const J = 'DynamicCheckbox_content_bd',
                    uu = 'DynamicCheckbox_info_50',
                    eu = 'DynamicCheckbox_base_e0',
                    tu = 'DynamicCheckbox_info__disabled_fc',
                    nu = ['dataID', 'onChange', 'text'];
                function ou() {
                    return (
                        (ou = Object.assign
                            ? Object.assign.bind()
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    { className: J },
                                    r,
                                    o().createElement('div', { className: E()(uu, a && tu) }),
                                ),
                            ),
                        );
                    }),
                    iu = {
                        base: 'RandomBattlePopoverApp_base_cf',
                        header: 'RandomBattlePopoverApp_header_f6',
                        separator: 'RandomBattlePopoverApp_separator_d0',
                        checkbox: 'RandomBattlePopoverApp_checkbox_dd',
                    },
                    au = () => {
                        const u = Y('model', K.None).onItemChanged,
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    'div',
                                    { className: iu.header },
                                    R.strings.mode_selector.popover.header(),
                                ),
                                ...
                                o().createElement(
                                    ...
                                    e.map(({ value: u }, e) => {
                                        return o().createElement(
                                            ...
                                            {
                                                key: `item#${e}`,
                                                contentId: R.views.lobby.mode_selector.tooltips.AlertTooltip('resId'),
                                                args:
                                                    ((n = u.tooltipHeader),
                                                    (r = u.tooltipBody),
                                                    (i = u.tooltipAlert),
                                                    { header: n, body: r, alert: i }),
                                            },
                                            o().createElement(
                                                'div',
                ...
                engine.whenReady.then(() => {
                    i().render(o().createElement(au, null), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [705], () => __webpack_require__(2980));
