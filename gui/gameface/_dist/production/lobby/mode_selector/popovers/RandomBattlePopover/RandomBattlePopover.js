(() => {
    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                t.d(e, { Sw: () => r.Z, B0: () => a, ry: () => C, Eu: () => v, Sy: () => b });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            4171: (u, e, t) => {
                ...
                const C = (u) => {
                        ...
                        const H = (0, n.useState)(!1),
                            ...
                            Q = o().createElement(
                                ...
                                o().createElement(
                                    'div',
                                    { className: a()(c.labelContent, 's-labelContent'), style: S },
                                    L || N,
                                ),
                            );
                        return o().createElement(
                            ...
                            B(
                                {
                                    id: e,
                                    className: a()(c.base, c[`base__${m}`], c[`base__${w}`], {
                                        [c.base__checked]: r,
                                        [c.base__disabled]: E,
                                        [c.base__mouseDown]: V,
                                        [c.base__alert]: C,
                ...
                const h = (u, e, t = {}, n = 0) => {
                    ...
                    p = (u) => {
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            k = (0, n.useMemo)(() => C || v().resId, [C]),
                            y = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (h(t, l, { isMouseEvent: !0, on: !0, arguments: w(o) }, k),
                                    m && m(),
                ...
                const k = R.views.common.tooltip_window.simple_tooltip_content,
                    y = (u) => {
                        ...
                        const F = (0, n.useMemo)(() => {
                            const u = Object.assign({}, a, { body: t, header: r, note: i, alert: E });
                ...
                const x = ['__left', '__right', '__top', '__bottom'],
                    L = (0, n.forwardRef)(
                        ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: r = {} }, i) => {
                                    ...
                                    () => (
                                        ...
                                        ((u) => {
                                            ...
                                            if (A.current) {
                                                ...
                                                (O.O.view.resize(u, e), l(window.decorator.directionType));
                                            }
                                        })
                                    ),
                                    [],
                            ...
                            return (
                                (0, n.useImperativeHandle)(i, () => ({ updateSize: v })),
                                T(() => {
                                ...
                                o().createElement(
                                    'div',
                                    { className: P.base, ref: A },
                                    o().createElement(
                                        'div',
                                        { className: P.decorator },
                                        o().createElement(
                                            'div',
                                            { className: P.content, ref: E },
                                            u,
                                            window.decorator &&
                ...
                Date.now();
                const I = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    U = (u) => {
                    ...
                    j = (u) => {
                        ...
                        if (n.length > 0) {
                            ...
                            return (
                                n.reduce((e, n) => {
                                    const o = I(V(t, `${e}.${n}`), window);
                                    return H(o) ? (u.push(o.id), `${e}.${n}.value`) : (u.push(n), `${e}.${n}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        U(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = j(u);
                                c.current = K.addCallback(n, t, E, e === z.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== z.None)
                                return () => {
                                    K.removeCallback(c.current, E);
                                };
                        }, [E, e]),
                        F
                    );
                ...
                const Z = 'DynamicCheckbox_content_bd',
                    ...
                    J = 'DynamicCheckbox_base_e0',
                    uu = 'DynamicCheckbox_info__disabled_fc',
                    eu = ['dataID', 'onChange', 'text'];
                function tu() {
                    return (
                        (tu =
                            Object.assign ||
                ...
                const nu = (0, n.memo)((u) => {
                        ...
                        const E = i.isDisabled,
                            A = (0, n.useCallback)(() => t && t(e), [e, t]);
                        return o().createElement(
                            'div',
                            { className: J },
                            o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    { className: Z },
                                    r,
                                    o().createElement('div', { className: a()(Q, E && uu) }),
                                ),
                            ),
                        );
                    }),
                    ...
                    ru = () => {
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement('div', { className: ou.separator }),
                                o().createElement(
                                    'div',
                                    { className: ou.items },
                                    e.map(({ value: u }, e) => {
                ...
                engine.whenReady.then(() => {
                    i().render(o().createElement(ru, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [705], () => __webpack_require__(4171));
