        ...
        e = {
            ...
            470: (u, e, t) => {
                ...
                const l = n('clientResized'),
                    B = { down: n('mousedown'), up: n('mouseup'), move: n('mousemove') };
                const o = (function () {
                ...
                const ru = Z().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        Z().createElement(
                            'div',
                            tu({}, F, {
                                className: D()(uu.base, uu[`base__theme-${E}`], r),
                                ref: function (u) {
                ...
                const Bu = q.client.getSize('rem'),
                    ou = Bu.width,
                    Cu = Bu.height,
                    mu = Object.assign({ width: ou, height: Cu }, lu(ou, Cu, nu)),
                    ...
                    const e = (0, Q.useContext)(su),
                        ...
                        E = (0, Q.useCallback)((u, e) => {
                            const t = q.view.pxToRem(u),
                                r = q.view.pxToRem(e);
                            A(Object.assign({ width: t, height: r }, lu(t, r, nu)));
                        }, []);
                    _u(() => {
                ...
                const xu = () => {
                    ...
                    fu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    bu = (u) => u.includes('_') && ((u) => fu.includes(u))(u.split('_').at(-1)),
                    vu = [gu.ExtraLarge, gu.Large, gu.Medium, gu.Small, gu.ExtraSmall],
                    wu = (u, e) =>
                ...
                const Nu = (u, e, t) => {
                    ...
                    Iu = (u, e, t = Pu.left) => u.split(e).reduce(t === Pu.left ? Nu : Wu, []),
                    Gu = (() => {
                        const u = new RegExp(
                        ...
                        return ju.includes(t)
                            ...
                            : ((u, e = Pu.left) => {
                                  ...
                                  const r =
                                      ...
                                      A = u.replace(/&nbsp;/g, ' ');
                                  return Iu(A, /( )/, e).forEach((u) => (t = t.concat(Iu(u, r, Pu.left)))), t;
                              })(u, e);
                    },
                    ku = 'FormatText_base_d0',
                    zu = ({ binding: u, text: e = '', classMix: t, alignment: r = Pu.left }) =>
                        null === e
                            ...
                            : Z().createElement(
                                  ...
                                  e.split('\n').map((e, A) =>
                                      Z().createElement(
                                          'div',
                                          { className: D()(ku, t), key: `${e}-${A}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : Xu(u, e))))(e, r, u).map((u, e) =>
                ...
                const qu = Object.keys(Vu()),
                    ...
                    re = Su((u) => {
                        ...
                        return Z().createElement(
                            ...
                            Yu(
                                {
                                    className: D()(Uu.base, t && Uu[t], g, r),
                                    style: _,
                                    mt: !0 === a ? ee[t || 'paragraph-P16'].mt : a,
                                    mr: !0 === i ? ee[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === B ? ee[t || 'paragraph-P16'].mb : B,
                ...
                function oe(u, e) {
                    ...
                    if (
                        ...
                        (t = (function (u, e) {
                            if (!u) return;
                            if ('string' == typeof u) return Ce(u, e);
                ...
                const ce = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: A, children: E, mocks: F }) {
                                const a = (0, Q.useRef)([]),
                                    D = (t, r, A) => {
                                        ...
                                        const F = (function ({
                                            ...
                                            B = { mode: t, model: l, externalModel: D, cleanup: i };
                                        return {
                                            model: l,
                                ...
                                return (
                                    (0, Q.useEffect)(() => {
                                        n.current ? m(D(l, A, F)) : (n.current = !0);
                                    }, [F, l, A]),
                                    (0, Q.useEffect)(() => {
                                        B(r);
                                    }, [r]),
                        ...
                        const e = { root: u.object(), operations: u.array('operations'), rewards: u.array('rewards') },
                            t = (0, de.Om)(() => se(e.operations.get(), (u) => Object.assign({}, u)), { equals: le }),
                            r = (0, de.Om)(() => se(e.rewards.get(), (u) => Object.assign({}, u)), { equals: le });
                    ...
                    he = R.strings.pm_announce.oldTooltip,
                    xe = (0, Fe.Pi)(() => {
                        const u = ge().model,
                            ...
                            A = e === Ee.Active,
                            E = e === Ee.CompletedPerfect,
                            F = e === Ee.Disabled,
                            a = (0, Q.useMemo)(
                                () => (A ? he.complete() : E ? he.completedPerfect.header() : he.completed.header()),
                                [E, A],
                            );
                        return F
                            ? Z().createElement(
                                      ...
                                      !E &&
                                          Z().createElement(
                                              ...
                                              Z().createElement(re, {
                                                  ...
                                                  text: A ? he.subtitle() : he.subtitlePerfect(),
                                              }),
                                              Z().createElement(
                                                  'div',
                                                  ...
                                                  t.map((u, e) => {
                                                      const r =
                                                          ((A = u.completed), (E = u.all), A ? (A < E ? De : ae) : ne);
                                                      var A, E;
                                                      const F = r === De;
                                                      return Z().createElement(
                                                          Z().Fragment,
                                                          ...
                                                          Z().createElement(
                                                              'div',
                                                              {
                                                                  className: D()(
                                                                      pe.operation,
                                                                      e === t.length - 1 && pe.operation__last,
                                                                  ),
                                                              },
                                                          ...
                                                          e + 1 === 4 &&
                                                              Z().createElement('div', {
                                                                  className: D()(pe.divider, pe.divider__operations),
                                                              }),
                                                      );
                                                  }),
                                              ),
                                              A
                                                  ...
                                                  : Z().createElement(
                                                        'div',
                                                        { className: pe.rewardCollected },
                                                        Z().createElement('div', { className: pe.rewardCollectedBg }),
                                                        Z().createElement(
                                                            'div',
                                                            { className: pe.rewardCollectedLabel },
                                                            Z().createElement('div', {
                                                                className: pe.rewardCollectedLabelIcon,
                                                            }),
                                                            Z().createElement(re, {
                                                                className: pe.rewardCollectedLabelText,
                                                                text: he.collectVehicle(),
                                                            }),
                                                        ),
                                                    ),
                                          ),
                                      e !== Ee.Completed && Z().createElement('div', { className: pe.divider }),
                                      Z().createElement(
                                          'div',
                                          { className: pe.footer },
                                          Z().createElement(
                                              ...
                                              Z().createElement(re, { text: a, className: pe.footerLabelText }),
                                          ),
                                          !A &&
                                              Z().createElement(
                                                  'div',
                                                  ...
                                                  Z().createElement(re, {
                                                      ...
                                                      text: E ? he.completedPerfect.body() : he.completed.body(),
                                                  }),
                                              ),
                                      ),
                                  ),
