        ...
        e = {
            ...
            470: (u, e, t) => {
                ...
                const ou = Q.client.getSize('rem'),
                    Cu = ou.width,
                    mu = ou.height,
                    su = Object.assign({ width: Cu, height: mu }, Bu(Cu, mu, iu)),
                ...
                const _u = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.smallWidth && B) return Du(e, t, _);
                    ...
                    const e = (0, Z.useContext)(du),
                        ...
                        E = (0, Z.useCallback)((u, e) => {
                            const t = Q.view.pxToRem(u),
                                r = Q.view.pxToRem(e);
                            A(Object.assign({ width: t, height: r }, Bu(t, r, iu)));
                        }, []);
                    (gu(() => {
                ...
                const Ru = {
                    ...
                    Pu = Lu((u) => {
                        ...
                        const W = (0, Z.useMemo)(() => {
                            ...
                            }, [t, r, F, D, l, o, O, H, w, d, T, f, v]),
                            I = W.computedStyle,
                            G = W.computedClassNames;
                        return J().createElement('div', Mu({ className: n()(Tu.base, ...G, e), style: I }, N), P);
                    });
                let Nu;
                !(function (u) {
                ...
                const Qu = Object.keys(Uu()),
                    ...
                    Ae = Lu((u) => {
                        ...
                        return J().createElement(
                            ...
                            qu(
                                {
                                    className: n()(Ku.base, t && Ku[t], g, r),
                                    style: _,
                                    mt: !0 === a ? te[t || 'paragraph-P16'].mt : a,
                                    mr: !0 === i ? te[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === B ? te[t || 'paragraph-P16'].mb : B,
                ...
                const _e = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: A, children: E, mocks: F }) {
                                ...
                                return (
                                    (0, Z.useEffect)(() => {
                                        D.current ? m(n(l, A, F)) : (D.current = !0);
                                    }, [F, l, A]),
                                    (0, Z.useEffect)(() => {
                                        B(r);
                                    }, [r]),
                        ...
                        const e = { root: u.object(), operations: u.array('operations'), rewards: u.array('rewards') },
                            t = (0, ce.Om)(() => de(e.operations.get(), (u) => Object.assign({}, u)), { equals: Be }),
                            r = (0, ce.Om)(() => de(e.rewards.get(), (u) => Object.assign({}, u)), { equals: Be });
                    ...
                    xe = R.strings.pm_announce.oldTooltip,
                    fe = (0, ae.Pi)(() => {
                        const u = pe().model,
                            ...
                            A = e === Fe.Active,
                            E = e === Fe.CompletedPerfect,
                            F = e === Fe.Disabled,
                            a = (0, Z.useMemo)(
                                () => (A ? xe.complete() : E ? xe.completedPerfect.header() : xe.completed.header()),
                                [E, A],
                            );
                        return F
                            ? J().createElement(
                            ...
                            : J().createElement(
                                  'div',
                                  { className: n()(he.base, he[`base__${e}`]) },
                                      ...
                                      !E &&
                                          J().createElement(
                                              ...
                                              J().createElement(Ae, {
                                                  ...
                                                  text: A ? xe.subtitle() : xe.subtitlePerfect(),
                                              }),
                                              J().createElement(
                                                  'div',
                                                  ...
                                                  t.map((u, e) => {
                                                      const r =
                                                          ((A = u.completed), (E = u.all), A ? (A < E ? De : ne) : ie);
                                                      var A, E;
                                                      const F = r === De;
                                                      return J().createElement(
                                                          J().Fragment,
                                                          ...
                                                          J().createElement(
                                                              'div',
                                                              {
                                                                  className: n()(
                                                                      he.operation,
                                                                      e === t.length - 1 && he.operation__last,
                                                                  ),
                                                              },
                                                          ...
                                                          e + 1 === 4 &&
                                                              J().createElement('div', {
                                                                  className: n()(he.divider, he.divider__operations),
                                                              }),
                                                      );
                                                  }),
                                              ),
                                              A
                                                  ...
                                                  : J().createElement(
                                                        'div',
                                                        { className: he.rewardCollected },
                                                        J().createElement('div', { className: he.rewardCollectedBg }),
                                                        J().createElement(
                                                            'div',
                                                            { className: he.rewardCollectedLabel },
                                                            J().createElement('div', {
                                                                className: he.rewardCollectedLabelIcon,
                                                            }),
                                                            J().createElement(Ae, {
                                                                className: he.rewardCollectedLabelText,
                                                                text: xe.collectVehicle(),
                                                            }),
                                                        ),
                                                    ),
                                          ),
                                      e !== Fe.Completed && J().createElement('div', { className: he.divider }),
                                      J().createElement(
                                          'div',
                                          { className: he.footer },
                                          J().createElement(
                                              ...
                                              J().createElement(Ae, { text: a, className: he.footerLabelText }),
                                          ),
                                          !A &&
                                              J().createElement(
                                                  'div',
                                                  ...
                                                  J().createElement(Ae, {
                                                      ...
                                                      text: E ? xe.completedPerfect.body() : xe.completed.body(),
                                                  }),
                                              ),
                                      ),
                                  ),
