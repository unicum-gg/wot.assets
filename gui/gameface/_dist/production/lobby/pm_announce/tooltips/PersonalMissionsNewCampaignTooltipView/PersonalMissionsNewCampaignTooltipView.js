        ...
        e = {
            ...
            911: (u, e, t) => {
                ...
                const Au = J().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        J().createElement(
                            'div',
                            ru({}, F, {
                                className: D()(eu.base, eu[`base__theme-${E}`], r),
                                ref: function (u) {
                ...
                const ou = Q.client.getSize('rem'),
                    Cu = ou.width,
                    mu = ou.height,
                    su = Object.assign({ width: Cu, height: mu }, lu(Cu, mu, iu)),
                ...
                const _u = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && n) return nu(e, t, _);
                        if (t.largeWidth && i) return nu(e, t, _);
                        if (t.mediumWidth && B) return nu(e, t, _);
                        if (t.smallWidth && l) return nu(e, t, _);
                        if (t.extraSmallWidth && o) return nu(e, t, _);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                    ...
                    const e = (0, Z.useContext)(du),
                        ...
                        E = (0, Z.useCallback)((u, e) => {
                            const t = Q.view.pxToRem(u),
                                r = Q.view.pxToRem(e);
                            A(Object.assign({ width: t, height: r }, lu(t, r, iu)));
                        }, []);
                    (gu(() => {
                ...
                const fu = () => {
                    ...
                    bu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    vu = (u) => u.includes('_') && ((u) => bu.includes(u))(u.split('_').at(-1)),
                ...
                const Ru = {
                    ...
                    Pu = Lu((u) => {
                        let e = u.className,
                            ...
                            f =
                                void 0 === x
                                    ...
                                    : x,
                            b = u.alignItems,
                            v = void 0 === b ? (c ? 'flex-start' : _ && 'center') || (g && 'flex-end') || void 0 : b,
                            w = u.alignSelf,
                            S = u.wrap,
                            L = u.flexWrap,
                        ...
                        return J().createElement('div', Mu({ className: D()(Tu.base, ...G, e), style: I }, N), P);
                    });
                let Nu;
                !(function (u) {
                ...
                const Wu = (u, e, t) => {
                    ...
                    Gu = (u, e, t = Nu.left) => u.split(e).reduce(t === Nu.left ? Wu : Iu, []),
                    ju = (() => {
                        const u = new RegExp(
                        ...
                        return Xu.includes(t)
                            ...
                            : ((u, e = Nu.left) => {
                                  ...
                                  const r =
                                      ...
                                      A = u.replace(/&nbsp;/g, ' ');
                                  return (Gu(A, /( )/, e).forEach((u) => (t = t.concat(Gu(u, r, Nu.left)))), t);
                              })(u, e);
                    },
                    zu = 'FormatText_base_d0',
                    $u = ({ binding: u, text: e = '', classMix: t, alignment: r = Nu.left }) =>
                        null === e
                ...
                const Ku = {
                    ...
                    Yu = ['text', 'variant', 'className', 'color', 'm', 'mt', 'mr', 'mb', 'ml', 'style', 'format'];
                function qu() {
                    return (
                        (qu =
                            Object.assign ||
                ...
                const Qu = Object.keys(Uu()),
                    ...
                    Ae = Lu((u) => {
                        ...
                        return J().createElement(
                            ...
                            qu(
                                {
                                    className: D()(Ku.base, t && Ku[t], g, r),
                                    style: _,
                                    mt: !0 === a ? te[t || 'paragraph-P16'].mt : a,
                                    mr: !0 === i ? te[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === l ? te[t || 'paragraph-P16'].mb : l,
                                    ml: !0 === C ? te[t || 'paragraph-P16'].ml : C,
                                },
                                d,
                            ),
                            void 0 !== s ? J().createElement($u, qu({}, s, { text: e })) : e,
                        );
                    });
                let Ee, Fe;
                (!(function (u) {
                ...
                const _e = ((u, e) => {
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const a = 'string' == typeof E ? `${r}.${E}` : r,
                                                            D = Q.view.addModelObserver(a, e, !0);
                                                        return (A.set(D, t), u && t(F(E)), D);
                                                    },
                                                    readByPath: F,
                                                    createCallback: (u, e) => {
                                                        const t = F(e);
                        ...
                        const e = { root: u.object(), operations: u.array('operations'), rewards: u.array('rewards') },
                            t = (0, ce.Om)(() => de(e.operations.get(), (u) => Object.assign({}, u)), { equals: le }),
                            r = (0, ce.Om)(() => de(e.rewards.get(), (u) => Object.assign({}, u)), { equals: le });
                    ...
                    he = {
                        base: 'App_base_1a',
                        base__completed: 'App_base__completed_52',
                        base__completedPerfect: 'App_base__completedPerfect_27',
                        bg: 'App_bg_e3',
                        content: 'App_content_7d',
                        header: 'App_header_b5',
                        header__completedPerfect: 'App_header__completedPerfect_4c',
                        subTitle: 'App_subTitle_5d',
                        subTitle__rewards: 'App_subTitle__rewards_06',
                        operationsWrapper: 'App_operationsWrapper_c4',
                        operation: 'App_operation_03',
                        operationText: 'App_operationText_d7',
                        operationText__done: 'App_operationText__done_73',
                        operationText__divider: 'App_operationText__divider_0d',
                        operationText__name: 'App_operationText__name_ea',
                        operationText__completed: 'App_operationText__completed_a8',
                        operationText__active: 'App_operationText__active_99',
                        operationText__empty: 'App_operationText__empty_0b',
                        dot: 'App_dot_29',
                        rewardsSection: 'App_rewardsSection_1e',
                        rewardsWrapper: 'App_rewardsWrapper_de',
                        reward: 'App_reward_08',
                        reward__lastInRow: 'App_reward__lastInRow_e2',
                        reward__completed: 'App_reward__completed_5b',
                        rewardIcon: 'App_rewardIcon_54',
                        rewardName: 'App_rewardName_f7',
                        rewardText: 'App_rewardText_a1',
                        ribbon: 'App_ribbon_5b',
                        labelIcon: 'App_labelIcon_bf',
                        labelIcon__completed: 'App_labelIcon__completed_6b',
                        labelIcon__locked: 'App_labelIcon__locked_41',
                        divider: 'App_divider_60',
                        footer: 'App_footer_65',
                        footerLabel: 'App_footerLabel_e8',
                        footerLabelIcon: 'App_footerLabelIcon_20',
                    ...
                    xe = R.strings.pm_announce.newTooltip,
                    fe = (0, ae.Pi)(() => {
                        const u = pe().model,
                            e = u.root.get().missionStatus,
                            t = u.computes.getOperations(),
                            r = u.computes.getRewards(),
                            A = e === Ee.CompletedPerfect,
                            E = e === Ee.Active;
                        return e === Ee.Disabled
                            ? J().createElement(
                                  'div',
                                  { className: he.disabled },
                                  J().createElement(Ae, { className: he.disabledHeader, text: xe.header() }),
                                  J().createElement(Ae, { className: he.disabledBody, text: xe.disabled.subtitle() }),
                              )
                            : J().createElement(
                                  'div',
                                  { className: D()(he.base, he[`base__${e}`]) },
                                  J().createElement('div', { className: he.bg }),
                                  J().createElement(
                                      'div',
                                      { className: he.content },
                                      J().createElement(Ae, { className: he.header, text: xe.header() }),
                                      !A &&
                                          J().createElement(
                                              J().Fragment,
                                              null,
                                              J().createElement(Ae, {
                                                  ...
                                                  text: xe.$dyn(e).subtitle(),
                                              }),
                                              J().createElement(
                                                  'div',
                                                  { className: he.operationsWrapper },
                                                  t.map((u) => {
                                                      const e =
                                                          ((t = u.completed), (r = u.all), t ? (t < r ? ne : De) : ie);
                                                      var t, r;
                                                      const A = e === ne;
                                                      return J().createElement(
                                                          'div',
                                                          { key: u.name, className: he.operation },
                                                          J().createElement('div', { className: he.dot }),
                                                          J().createElement(Ae, {
                                                              className: D()(he.operationText, he.operationText__name),
                                                              text: xe.operation(),
                                              ...
                                              J().createElement(
                                                  ...
                                                  J().createElement(Ae, {
                                                      className: D()(he.subTitle, he.subTitle__rewards),
                                                      text: xe.rewardTitle(),
                                                  }),
                                                  J().createElement(
                                                      'div',
                                                      ...
                                                      r.map((u, e) => {
                                                          ...
                                                          return J().createElement(
                                                              ...
                                                              J().createElement(
                                                                  'div',
                                                                  { className: he.rewardName },
                                                                  u.status !== Fe.Available &&
                                                                      J().createElement('div', {
                                                                          className: D()(
                                                                              he.labelIcon,
                                                                              he[`labelIcon__${u.status}`],
                                                                          ),
                                                                      }),
                                                                  J().createElement(Ae, {
                                                                      text: u.name,
                                          ...
                                          !E &&
                                              J().createElement(
                                                  ...
                                                  J().createElement(Ae, {
                                                      ...
                                                      text: xe.$dyn(e).footerDescription(),
                                                  }),
                                              ),
                                      ),
                                  ),
    ...
    ((r.m = e),
        ...
        (r.O = (e, t, A, E) => {
            if (!t) {
                ...
                for (i = 0; i < u.length; i++) {
                    for (var [t, A, E] = u[i], a = !0, D = 0; D < t.length; D++)
                        (!1 & E || F >= E) && Object.keys(r.O).every((u) => r.O[u](t[D]))
                            ? t.splice(D--, 1)
                            : ((a = !1), E < F && (F = E));
                    if (a) {
                        u.splice(i--, 1);
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); n < F.length; n++) ((E = F[n]), r.o(u, E) && u[E] && u[E][0](), (u[E] = 0));
                    return r.O(i);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
        })());
    var A = r.O(void 0, [776], () => r(911));
    A = r.O(A);
})();
