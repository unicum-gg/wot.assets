(() => {
    var __webpack_modules__ = {
            ...
            9e3: (u, e, t) => {
                ...
                const F = i.O.client.getSize('rem'),
                    s = F.width,
                    l = F.height,
                    D = Object.assign({ width: s, height: l }, A(s, l, o)),
                ...
                const x = {
                    ...
                    L = (u) => {
                        ...
                        const i = (() => {
                            ...
                            E = i.mediaHeight,
                            A = i.mediaSize;
                        return n().createElement('div', b({ className: _()(t, x[o], T[E], S[A]) }, a), e);
                    },
                    y = ['children'],
                    M = (u) => {
                        let e = u.children,
                ...
                class I extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = _()(P.base, P[`base__${i}`], P[`base__${a}`], null == o ? void 0 : o.base),
                            c = _()(P.icon, P[`icon__${i}`], P[`icon__${a}`], null == o ? void 0 : o.icon),
                            B = _()(P.glow, null == o ? void 0 : o.glow),
                            C = _()(P.caption, P[`caption__${i}`], null == o ? void 0 : o.caption),
                            d = _()(P.goto, null == o ? void 0 : o.goto);
                ...
                function V(u = G.n.NONE, e = j, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== G.n.NONE)
                            return (
                ...
                const K = (u) => {
                    ...
                    return n().createElement('div', q({ className: _()('Heading_base_4b', t) }, r), e);
                };
                var Y = t(1281);
                let X;
                function Z(u, e) {
                ...
                const Q = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    eu = (u, e, t = X.left) => u.split(e).reduce(t === X.left ? J : uu, []),
                    tu = (() => {
                        const u = new RegExp(
                    ...
                    nu = ({ binding: u, text: e = '', classMix: t, alignment: a = X.left, formatWithBrackets: i }) => {
                    ...
                    ou = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Eu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Au = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                (E = E.replace(t, `%(${o})`)),
                                    (i[o] = au[u]
                                        ? n().createElement(
                                              'span',
                                              { className: au[u] },
                                              n().createElement(nu, { text: s, binding: e }),
                                          )
                                        : n().createElement(
                                              'span',
                                              { style: a(u) },
                        ...
                        return n().createElement(nu, { text: E, classMix: t, binding: i });
                    }),
                    Fu = R.strings.comp7_ext,
                    su = (u) => ((u, e) => String(u.$dyn(e)))(Fu.seasonName, u);
                var lu = t(3403);
                function Du() {
                    return !1;
                }
                ...
                const Cu = (u) => (0 === u ? window : window.subViews.get(u)),
                    du = () => (u, e) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: o, children: E, mocks: A }) {
                                const F = (0, r.useRef)([]),
                                    s = (t, r, n) => {
                                        var a;
                                        const o = (function ({
                                            ...
                                            D = { mode: t, model: l, externalModel: E, cleanup: s };
                                        return {
                                            model: l,
                                    ...
                                    c = D[0],
                                    B = D[1],
                                    C = (0, r.useState)(() => s(a, o, A)),
                                    d = C[0],
                                    m = C[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? m(s(c, o, A)) : (l.current = !0);
                                    }, [A, c, o]),
                                    (0, r.useEffect)(() => {
                                        B(a);
                                    }, [a]),
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            p = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (wu(t, c, { isMouseEvent: !0, on: !0, arguments: vu(n) }, w),
                                    _ && _(),
                ...
                var Su = t(8613);
                const Lu = (Date.now(), Su.Ew.getRegionalDateTime),
                    yu = Su.Ew.getFormattedDateTime,
                    Mu = (0, r.memo)(({ datetime: u, format: e = Tu.ShortDate, isConvertedToLocal: t = !0 }) =>
                        Object.values(Tu).includes(e) ? Lu(u, e, t) : yu(u, e, t),
                    ),
                    Ou = R.strings.comp7_ext.season,
                    ku = (u, e, t = Tu.ShortDate) => ({
                        startDate: n().createElement(Mu, { datetime: u, format: t }),
                        endDate: n().createElement(Mu, { datetime: e, format: t }),
                    }),
                    Ru = (u, e, t) => {
                        const r = e - t,
                            a = ((u, e) =>
                        ...
                        return r >= 604800
                            ? n().createElement(nu, { text: Ou.range(), binding: ku(u, e) })
                            : r >= 86400
                              ? n().createElement(nu, { text: Ou.daysLeft(), binding: a })
                              : r >= 3600
                                ? n().createElement(nu, { text: Ou.hoursLeft(), binding: a })
                                : r >= 60
                                  ? n().createElement(nu, { text: Ou.minutesLeft(), binding: a })
                                  : r >= 1
                                    ? n().createElement(nu, { text: Ou.secondsLeft(), binding: a })
                                    : void 0;
                    },
                    Hu = ({
                        startTimestamp: u,
                            ...
                            n().createElement(
                                ...
                                i &&
                                    n().createElement(
                                        ...
                                        null,
                                        su(r),
                                        n().createElement('div', { className: 'ActiveSeasonState_divider_db' }),
                                    ),
                                Ru(u, e, t),
                            ),
                        ),
                    Pu = (0, lu.Pi)(({ className: u, classNames: e, hasSeasonName: t = !0 }) => {
                        const a = hu(),
                            i = a.model,
                            o = a.controls,
                            E = i.season.startTimestamp.get(),
                            A = i.season.endTimestamp.get(),
                            F = i.season.serverTimestamp.get(),
                            s = i.season.name.get();
                        return (
                            (function (u, e, t) {
                                ((u, e) => {
                            ...
                            })(F, A, o.pollServerTime),
                            n().createElement(
                                'div',
                                { className: _()('ScheduleSubheading_base_a5', u) },
                                F < A
                                    ? n().createElement(
                                          'div',
                                          ...
                                          n().createElement(Hu, {
                                              ...
                                              hasSeasonName: t,
                                              classNames: null == e ? void 0 : e.scheduleClassNames,
                                          }),
                                      )
                                    : n().createElement(Au, {
                                          text: R.strings.comp7_ext.season.over(),
                                          binding: { seasonName: su(s) },
                                      }),
                            )
                        );
                    });
                var Wu = t(9690);
                const Nu = du()(
                        ({ observableModel: u }) => ({ root: u.object(), vehicleLevels: u.array('vehicleLevels') }),
                        ({ externalModel: u }) => ({ close: u.createCallbackNoArgs('onClose') }),
                    ),
                    Iu = Nu[0],
                    Gu = Nu[1],
                    Uu = R.strings.comp7_ext.noVehicles.howTo,
                    ju = R.images.comp7.gui.maps.icons.no_vehicles,
                    Vu = ['tasks', 'premium', 'reserves'],
                    $u = ({ levelsStr: u }) =>
                        n().createElement(
                            'div',
                            { className: 'HowToGetVehicles_base_84' },
                            n().createElement(
                                'div',
                                { className: 'HowToGetVehicles_heading_2d' },
                                Z(Uu.title(), { levels: u }),
                            ),
                            n().createElement(
                                'div',
                                { className: 'HowToGetVehicles_items_53' },
                                Vu.map((u) =>
                                    n().createElement(
                                        'div',
                                        { className: 'HowToGetVehicles_item_a1', key: u },
                                        n().createElement('div', {
                                            className: 'HowToGetVehicles_image_70',
                                            style: { backgroundImage: `url(${ju.$dyn(u)})` },
                                        }),
                                        n().createElement(
                                            'div',
                                            { className: 'HowToGetVehicles_title_89' },
                                            Uu.$dyn(u),
                                        ),
                                    ),
                                ),
                    ...
                    zu = R.strings.comp7_ext.noVehicles,
                    qu = { context: 'model.scheduleInfo' },
                    Ku = (0, lu.Pi)(() => {
                        const u = Gu(),
                            e = u.model,
                            t = u.controls,
                            ...
                            a =
                                ((i = e.vehicleLevels.get()),
                                (o = R.strings.comp7_ext.listSeparator()),
                                i.map((u) => (0, Wu.cg)(u.value)).join(o));
                        var i, o;
                        return n().createElement(
                            'div',
                            { className: 'App_base_bb' },
                            n().createElement($, { onClose: t.close }),
                            n().createElement(
                                'div',
                                { className: 'App_header_a4' },
                                n().createElement(
                                    K,
                                    { className: 'page_heading_9c' },
                                    R.strings.comp7_ext.featureName(),
                                ),
                                n().createElement(_u, { options: qu }, n().createElement(Pu, null)),
                            ),
                            n().createElement(
                                'div',
                                { className: 'App_content_93' },
                                n().createElement(
                                    'div',
                                    { className: 'App_iconContainer_7e' },
                                    n().createElement('div', { className: 'App_icon_14' }),
                                ),
                                n().createElement(
                                    'div',
                                    { className: 'App_text_bb' },
                                    Z(String(zu.text.$dyn(r)), { levels: a }),
                                ),
                            ),
                            n().createElement(
                                'div',
                                { className: 'App_footer_8e' },
                                n().createElement($u, { levelsStr: a }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    k().render(
                        n().createElement(M, null, n().createElement(Iu, null, n().createElement(Ku, null))),
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/NoVehiclesScreen/NoVehiclesScreen'),
        (() => {
            var u = { 'lobby/NoVehiclesScreen/NoVehiclesScreen': 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, ['lib/comp7.vendors'], () => __webpack_require__(9e3));
