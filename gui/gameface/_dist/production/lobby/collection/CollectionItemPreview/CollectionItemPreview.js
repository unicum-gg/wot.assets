(() => {
    var __webpack_modules__ = {
            ...
            527: (e, t, u) => {
                'use strict';
                (u.r(t),
                    u.d(t, { mouse: () => h, off: () => s, on: () => n, onResize: () => a, onScaleUpdated: () => o }));
                var i = u(472),
                    r = u(176);
            ...
            138: (e, t, u) => {
                ...
                var i = u(959),
                    r = u(514);
                const a = { view: u(641), client: i, sound: r.ZP };
            },
            514: (e, t, u) => {
                'use strict';
                u.d(t, { ZP: () => o });
            ...
            258: (e, t, u) => {
                ...
                var r = {};
                (u.r(r), u.d(r, { Area: () => qt, Bar: () => Gt, Default: () => $t, useVerticalScrollApi: () => bt }));
                var a = u(363),
                    o = u.n(a);
                const n = (e, t, u) =>
                ...
                const D = (e) => {
                    ...
                    p = ({ children: e }) => {
                        ...
                        (D(() => {
                            (s.O.client.events.on('clientResized', n), s.O.client.events.on('self.onScaleUpdated', h));
                        }),
                            (0, a.useEffect)(
                                () => () => {
                                    (s.O.client.events.off('clientResized', n),
                                        s.O.client.events.off('self.onScaleUpdated', h));
                                },
                                [n, h],
                            ));
                ...
                const T = {
                    ...
                    M = (e) => {
                        ...
                        const r = b(),
                            ...
                            n = r.mediaHeight,
                            s = r.mediaSize;
                        return o().createElement('div', y({ className: B()(u, T[a], P[n], O[s]) }, i), t);
                    },
                    k = ['children'];
                const U = (e) => {
                    let t = e.children,
                                ...
                                c = (u, i, r) => {
                                    ...
                                    const o = (function ({
                                            ...
                                            return {
                                                ...
                                                dispose: function () {
                                                    for (var e, u = ee(r.keys()); !(e = u()).done; ) a(e.value, t);
                                                },
                                                unsubscribe: a,
                                            };
                                        })(i),
                    ...
                    Ce = (e, t = de.left) => {
                        ...
                        return ((e, t = de.left) => {
                            ...
                            const i =
                                ...
                                r = Ae(e);
                            return (fe(r, /( )/, t).forEach((e) => (u = u.concat(fe(e, i, de.left)))), u);
                        })(e, t);
                    };
                var Be = u(946);
                ...
                const Pe = [
                    ...
                    Re = [_e.Gold, _e.Credits, _e.Crystal, _e.FreeXp],
                ...
                const Ge = (e, t) => {
                    ...
                    je = ie()(
                        ({ observableModel: e }) => {
                            const t = Object.assign({}, e.primitives(['currentCollection']), e.primitives(['page']), {
                                ...
                                s = (0, Be.Om)(() => r().pages[n()].pageItems, { equals: Q }),
                                l = (0, Be.Om)(() => {
                                    const e = t.root.get().currentCollection;
                                    return !$e[Ee(e)] || e === qe;
                                }),
                                ...
                                d = (0, Be.Om)((e) => le(t.rewardsInfo.get(), (t) => t.requiredItemsCount === e), {
                                    equals: Q,
                                }),
                                g = (0, Be.Om)(
                                    (e) => {
                        ...
                        ({ model: e, externalModel: t, cleanup: u }) => {
                            ...
                            const n = (0, J.aD)(() => a(e.computes.getPageNumber() + 1)),
                                s = (0, J.aD)(() => a(e.computes.getPageNumber() - 1)),
                    ...
                    Qe = ({ binding: e, text: t = '', classMix: u, alignment: i = de.left, formatWithBrackets: r }) => {
                        if (null === t) return (console.error("FormatText was supplied with 'null'"), null);
                        const n = r && e ? ge(t, e) : t;
                        return o().createElement(
                            a.Fragment,
                            null,
                            n.split('\n').map((t, r) =>
                                o().createElement(
                                    ...
                                    ((e, t, u) =>
                                        ...
                                        i,
                                        e,
                                    ).map((e, t) => o().createElement(a.Fragment, { key: `${t}-${e}` }, e)),
                                ),
                            ),
                        );
                    };
                ...
                function ut(e) {
                    ...
                    return (
                        ...
                        (0, a.useCallback)((...e) => (0, t.current)(...e), tt)
                    );
                }
                function it(e, t, u = []) {
                ...
                const lt = {
                            ...
                            const l = s.settings,
                                ...
                                E = (() => {
                                    const e = (0, a.useMemo)(() => ({}), []),
                                        ...
                                        r = (e, ...u) => {
                                            for (var i, r = rt(t(e).values()); !(i = r()).done; ) (0, i.value)(...u);
                                        };
                                ...
                                m = (0, nt.useSpring)(() => ({
                                    ...
                                    onChange: (e) => {
                                        const t = c.current;
                                        t && (u(t, e), E.trigger('change', e), o && g.current && A());
                                    },
                    ...
                    _t = (0, a.memo)(({ api: e, classNames: t = {}, getStepByRailClick: u = Ct, onDrag: i = Bt }) => {
                        const r = (0, a.useRef)(null),
                            ...
                            F = () => {
                                ...
                                const a = e.animationScroll.scrollPosition.get(),
                                    o = Math.min(1, i / r),
                                    s = ze(0, 1, a / (r - i)),
                                    d = (t.offsetWidth - wt(t, o)) * s;
                                ((u.style.transform = `translateX(${0 | d}px)`),
                                    ((e) => {
                                        if (n.current && l.current && h.current && c.current) {
                                            if (0 === e)
                                                return (
                                            ...
                                            var t, u;
                                            (n.current.classList.remove(Dt), l.current.classList.remove(Dt));
                                        }
                                    })(d));
                            },
                            f = ut(() => {
                                ((() => {
                                    ...
                                    ((t.style.width = `${wt(u, o)}px`),
                                        ...
                                        r.current &&
                                            (1 === o ? r.current.classList.add(gt) : r.current.classList.remove(gt)));
                                })(),
                                    F());
                            });
                        ((0, a.useEffect)(() => et(f)),
                            ...
                            (0, a.useEffect)(() => {
                                ...
                                const t = s.O.client.events.mouse.move(([t, u]) => {
                                        ...
                                        const l = t.clientX - E.offset - n.getBoundingClientRect().x,
                                            d = (l / n.offsetWidth) * (null != (r = e.getContainerSize()) ? r : 0);
                                        (e.scrollPosition.start({
                                            ...
                                            i({ type: 'dragging', thumb: s, thumbOffset: l, contentOffset: d }));
                                    }),
                        ...
                        return o().createElement(
                            'div',
                            { className: B()(dt, t.base), ref: r, onWheel: e.handleMouseWheel },
                            o().createElement('div', {
                                className: B()(Et, t.leftButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Dt) || 0 !== e.button || (H('play'), p(st.Next));
                                },
                                onMouseUp: C,
                                ref: n,
                                onMouseEnter: w,
                                    ...
                                    onMouseDown: (t) => {
                                        ...
                                        if (i && 0 === t.button)
                                            if ((H('play'), t.target === i))
                                                ...
                                                })(t.screenX > i.getBoundingClientRect().x ? st.Prev : st.Next);
                                            }
                                    },
                                    ref: h,
                                    onMouseEnter: w,
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Dt) || 0 !== e.button || (H('play'), p(st.Prev));
                                },
                                onMouseUp: C,
                                ref: l,
                                onMouseEnter: w,
                    ...
                    St = ({
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                'div',
                                { className: B()(vt.defaultScrollArea, r) },
                                o().createElement(xt, { className: s, api: d, classNames: n }, e),
                            ),
                            o().createElement(_t, { getStepByRailClick: l, api: t, onDrag: h, classNames: c }),
                        );
                    },
                ...
                const bt = ht({
                    ...
                    Gt = (0, a.memo)(({ api: e, classNames: t = {}, getStepByRailClick: u = It, onDrag: i = Ut }) => {
                        const r = (0, a.useRef)(null),
                            n = (0, a.useRef)(null),
                            l = (0, a.useRef)(null),
                            h = (0, a.useRef)(null),
                                ...
                                ((u.style.transform = `translateY(${0 | d}px)`),
                                    ((e) => {
                                        if (n.current && l.current && h.current && c.current) {
                                            ...
                                            var t, u;
                                            (n.current.classList.remove(kt), l.current.classList.remove(kt));
                                        }
                                    })(d));
                            }),
                            D = ut(() => {
                                ...
                                const t = s.O.client.events.mouse.up(() => {
                                    ...
                                    u = s.O.client.events.mouse.move(([t]) => {
                                        Ht(e, (u) => {
                                            ...
                                            if (!r || !a || !o) return;
                                            const n = t.screenY - E.offset - r.getBoundingClientRect().y,
                        ...
                        return o().createElement(
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(kt) || 0 !== e.button || (H('play'), C(st.Next));
                                },
                                ref: n,
                                onMouseEnter: _,
                            }),
                                    ...
                                    onMouseDown: (t) => {
                                        ...
                                        if (i && 0 === t.button)
                                            if ((H('play'), t.target === i))
                                                ...
                                                })(t.screenY > i.getBoundingClientRect().y ? st.Prev : st.Next);
                                            }
                                    },
                                    ref: h,
                                    onMouseEnter: _,
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(kt) || 0 !== e.button || (H('play'), C(st.Prev));
                                },
                                onMouseUp: w,
                                ref: l,
                                onMouseEnter: _,
                ...
                qt.Default = $t;
                const jt = { Vertical: r, Horizontal: i };
                ...
                const Vt = 'ElementDescription_base_af',
                ...
                const au = 'VehicleInfo_base_24',
                    ...
                    hu = (0, Y.Pi)(() => {
                        ...
                        return o().createElement(
                            ...
                            Boolean(a) &&
                                o().createElement(
                                    'div',
                                    { className: B()(lu.title, r === Je.Style3d && lu.title__style3d) },
                                    r === Je.Style3d
                                        ? o().createElement(Qe, {
                    ...
                    cu = (0, Y.Pi)(() => {
                        ...
                        return (
                            ...
                            o().createElement(
                                'div',
                                { className: B()(Ke.base, Ke[`base__${Z(r, a)}`]) },
                ...
                engine.whenReady.then(() => {
                    I().render(
                        o().createElement(Xe, null, o().createElement(U, null, o().createElement(cu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [314], () => __webpack_require__(258));
