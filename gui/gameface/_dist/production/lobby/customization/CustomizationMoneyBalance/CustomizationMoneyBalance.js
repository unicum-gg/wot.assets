(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var o = {};
                (t.r(o), t.d(o, { getBgUrl: () => C, getTextureUrl: () => B }));
                var A = {};
                function E(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            364: (u, e, t) => {
                t.d(e, { Sw: () => o.Z, B3: () => i, Z5: () => A, B0: () => F, ry: () => _ });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            478: (u, e, t) => {
                        ...
                        C(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = m(u);
                                D.current = w.addCallback(n, t, E, e === p.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== p.None)
                ...
                const T = (u, e, t = {}, n = 0) => {
                    ...
                    O = (u) => {
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            h = (0, n.useMemo)(() => v || l().resId, [v]),
                            f = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (T(t, B, { isMouseEvent: !0, on: !0, arguments: y(r) }, h),
                                    m && m(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((b.current.timeoutId = window.setTimeout(f, a ? 100 : 400)),
                                                      o && o(u),
                                                      P && P(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const P = 'Waiting_waiting_5a',
                    k = 'Waiting_alertIcon_10',
                    S = 'Waiting_frame1_6c',
                    x = 'Waiting_frame2_c5',
                    L = 'Waiting_frame3_df',
                    N = (0, n.memo)(() =>
                ...
                const U = {
                        ...
                        icon: 'CurrencyItem_icon_37',
                        base__crystal: 'CurrencyItem_base__crystal_a3',
                    ...
                    j = () => {
                        const u = b(),
                            ...
                            A = u.equipCoin,
                            E = u.isWGMAvailable,
                            i = b('model.crystalsTooltip'),
                            a = b('model.goldTooltip'),
                            s = b('model.creditsTooltip'),
                            D = b('model.freeExpTooltip'),
                ...
                const z = ((u, e) => {
                        ...
                        return [
                            function ({ mode: o = 'real', options: A, children: E, mocks: F }) {
                                const i = (0, n.useRef)([]),
                                    a = (t, n, r) => {
                                        ...
                                        const A = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, o) => {
                                                        const E = 'string' == typeof o ? `${n}.${o}` : n,
                                                            F = c.O.view.addModelObserver(E, e, !0);
                                            ...
                                            D = { mode: t, model: s, externalModel: E, cleanup: a };
                                        return {
                                            model: s,
                                ...
                                return (
                                    (0, n.useEffect)(() => {
                                        s.current ? _(a(l, A, F)) : (s.current = !0);
                                    }, [F, l, A]),
                                    (0, n.useEffect)(() => {
                                        B(o);
                                    }, [o]),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [858], () => __webpack_require__(478));
