(() => {
    var __webpack_modules__ = {
            ...
            869: (u, e, t) => {
                ...
                const L = {
                    ...
                    O = (u) => {
                        ...
                        const a = b(),
                            ...
                            E = a.mediaHeight,
                            A = a.mediaSize;
                        return r().createElement('div', y({ className: h()(t, L[i], S[E], T[A]) }, n), e);
                    },
                    M = ['children'];
                const k = (u) => {
                    let e = u.children,
                        ...
                        return (
                            (_ = () =>
                                i.O.view.events.onDisplayChanged((u, e) => {
                                    var t, n;
                                    e === K.W.hidden && (null == (t = d.current) || t.pause()),
                                        e === K.W.shown && (null == (n = d.current) || n.play());
                                })),
                            (0, n.useEffect)(_, []),
                            (0, n.useEffect)(
                                () =>
                            ...
                            (0, n.useEffect)(() => {
                                if (C && d.current) {
                                    const u = { changeTimeHandlers: [], changeKeyframeHandlers: [], changeTimeLoop: j },
                                        e = () => {
                                            let e = 0;
                                            const t = (function (u) {
                                                    let e = 0;
                            ...
                            r().createElement(
                                'video',
                                Y({ src: t, className: a, style: o, loop: s, ref: d, onClick: c }, B),
                            )
                        );
                    }),
                    X = (0, n.memo)(Z),
                ...
                class tu extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = h()(J.base, J[`base__${i}`], J[`base__${a}`], null == E ? void 0 : E.base),
                            c = h()(J.icon, J[`icon__${i}`], J[`icon__${a}`], null == E ? void 0 : E.icon),
                ...
                const Du = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Cu = (u, e, t = su.left) => u.split(e).reduce(t === su.left ? cu : Bu, []),
                    du = (() => {
                        const u = new RegExp(
                    ...
                    gu = ({ binding: u, text: e = '', classMix: t, alignment: a = su.left, formatWithBrackets: i }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const E = i && u ? lu(e, u) : e;
                        return r().createElement(
                            n.Fragment,
                            null,
                            E.split('\n').map((e, i) =>
                ...
                function wu(u = fu.n.NONE, e = pu, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== fu.n.NONE)
                            return (
                ...
                function bu() {
                    !(function (u = fu.n.ESCAPE) {
                        wu(u, vu.Sy, !0);
                    })(fu.n.ESCAPE);
                }
                const xu = R.strings.vehicle_customization.customization,
                    yu = {
                        [v.ExtraSmall]: 's400x300',
                        [v.Small]: 's400x300',
                        [v.Medium]: 's400x300',
                        [v.Large]: 's600x450',
                        [v.ExtraLarge]: 's900x675',
                    },
                    Lu = (0, W.Pi)(() => {
                        const u = ou(),
                            e = u.model,
                            ...
                            B = D[1];
                        bu();
                        const C = l <= v.Medium ? U.small : U.medium;
                        return r().createElement(
                            'div',
                            { className: Q.base },
                            r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: Q.animationWrapper },
                                    r().createElement('div', {
                                        className: Q.icon,
                                        style: {
                                            backgroundImage: `url('R.images.gui.maps.vehicles.attachments.${yu[l]}.${A}')`,
                                        },
                                    }),
                                    c &&
                                        r().createElement(X, {
                                    ...
                                    r().createElement(X, {
                                        className: h()(Q.animation, c && Q.animation__hidden),
                                ...
                                r().createElement(
                                    'div',
                                    { className: h()(Q.footer, Q[`footer__${F}`]) },
                                    r().createElement('div', { className: Q.title }, vu.Z5.toUpperCase(o)),
                                    r().createElement(gu, {
                                        text: xu.RarityRewardScreen.subtitle(),
                                        binding: { rarity: vu.Z5.toUpperCase(String(xu.rarity.$dyn(F))) },
                                        classMix: Q.subTitle,
                                    }),
                                    r().createElement(
                                        'div',
                                        ...
                                        r().createElement(
                                            ...
                                            E || !s
                                                ? xu.RarityRewardScreen.button.toGarage()
                                                : xu.RarityRewardScreen.button.toExterior(),
                                        ),
                                        r().createElement(
                                            z,
                                            {
                                            ...
                                            xu.RarityRewardScreen.button.close(),
                                        ),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    P().render(
                        r().createElement(k, null, r().createElement(Au, null, r().createElement(Lu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [858], () => __webpack_require__(869));
