(() => {
    var __webpack_modules__ = {
            ...
            259: (u, e, t) => {
                ...
                function iu(u = au.n.NONE, e = ru, t = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== au.n.NONE)
                            return (
                ...
                const nu = 'InfoBlock_base_3e',
                    ...
                    su = ({ icon: u, title: e, descr: t }) =>
                        r().createElement(
                            ...
                            r().createElement('div', { className: Fu }, t && $(t)),
                        ),
                    ou = 'App_base_42',
                    lu = 'App_title_a7',
                    Du = 'App_content_81',
                            ...
                            r().createElement(
                                ...
                                e
                                    ? r().createElement(
                                          ...
                                          r().createElement(
                                              V,
                                              { type: I.primary, mixClass: Bu, size: U.medium, onClick: E },
                                              R.strings.vehicle_customization.onboardingView.btnGoto(),
                                          ),
                                          r().createElement(
                                              V,
                                              { type: I.secondary, mixClass: Bu, size: U.medium, onClick: n },
                                              R.strings.vehicle_customization.onboardingView.btnSkip(),
                                          ),
                                      )
                                    : r().createElement(
                                          V,
                                          { type: I.primary, mixClass: Bu, size: U.medium, onClick: n },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [858], () => __webpack_require__(259));
