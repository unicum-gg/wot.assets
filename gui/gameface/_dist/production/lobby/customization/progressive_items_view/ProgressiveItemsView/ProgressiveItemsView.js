(() => {
            ...
            602: (u, e, t) => {
                ...
                const g = (u) => {
                    ...
                    const n = (0, o.useContext)(C),
                        ...
                        p = { extraLarge: D, large: _, medium: g, small: f, extraSmall: h };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && E) return c(e, t, p);
                        if (t.largeWidth && A) return c(e, t, p);
                        if (t.mediumWidth && F) return c(e, t, p);
                        if (t.smallWidth && m) return c(e, t, p);
                        if (t.extraSmallWidth && d) return c(e, t, p);
                        if (
                ...
                const iu = {
                    ...
                    lu = ({
                        ...
                        return (l = {}) => {
                            ...
                            return (0, o.useMemo)(
                                ...
                                [_.scrollPosition, g, f, w, m.off, m.on, v, h, C, E.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    cu = lu({
                    ...
                    pu = (0, o.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = gu, onDrag: n = fu }) => {
                    ...
                    wu = ({
                        ...
                        return s().createElement(
                            ...
                            s().createElement(pu, { getStepByRailClick: l, api: e, onDrag: c, classNames: E }),
                        );
                    },
                ...
                const ce = (u, e, t = {}, n = 0) => {
                    ...
                    Ee = (u) => {
                        ...
                        const h = (0, o.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            p = (0, o.useMemo)(() => C || y().resId, [C]),
                            v = (0, o.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (ce(t, m, { isMouseEvent: !0, on: !0, arguments: le(n) }, p),
                                    B && B(),
                ...
                const me = (u) => {
                    ...
                    pe = ({ className: u }) => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement('span', { className: he }, e),
                        );
                    },
                ...
                const We = 'ProgressBarDeltaGrow_base_7e',
                    ...
                    Ue = (u) => (u ? { left: 0 } : { right: 0 }),
                    $e = (u, e) => (u ? { right: 100 - e + '%' } : { left: `${e}%` }),
                    Ge = (u) => ({ transitionDuration: `${u}ms` }),
                    qe = (0, o.memo)(
                        ({
                            ...
                            const f = (0, o.useMemo)(() => Object.assign({ width: '100%' }, Ge(u), Ue(E)), [E, u]),
                                h = (0, o.useMemo)(() => Object.assign({ width: '0%' }, Ge(u), Ue(E)), [E, u]),
                                p = (0, o.useMemo)(() => Object.assign({ width: '0%' }, $e(E, n), Ge(u)), [n, E, u]),
                                v = (0, o.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(a - n)}%` }, $e(E, n), Ge(u)),
                                    [n, E, a, u],
                                );
                            if (d) return null;
                            const w = K()(We, c, E && 0 === a && Ve);
                            return s().createElement(
                                'div',
                                { style: D ? p : v, className: w },
                                s().createElement(
                                    'div',
                                    { style: C ? h : f, className: je },
                ...
                const et = (0, o.memo)((u) => {
                        ...
                        switch (n.animationSettings.type) {
                            case Pe.Simple:
                                return s().createElement(Qe, ut({}, n, { onEndAnimation: l, isComplete: a }));
                            case Pe.Growing:
                                return s().createElement(Ye, ut({}, n, { onEndAnimation: l, isComplete: a }));
                            default:
                                return null;
                        }
                    }),
                    tt = ({ size: u, value: e, lineRef: t, disabled: n, onComplete: r }) => {
                ...
                const at = (0, o.memo)((u) => {
                    ...
                    return (
                        (n.current.from = a),
                        s().createElement(et, rt({}, t, { onEndAnimation: r, key: `${a}-${t.to}`, from: a }))
                    );
                });
                function ot() {
                    return (
                ...
                const st = (0, o.memo)(
                        ({
                            ...
                            return a.withStack
                                ...
                                : s().createElement(et, ot({ key: `${r}-${e}` }, c));
                        },
                    ),
                    it = (u) => ({
                    ...
                    ft = 'Icon_base_d5',
                    ht = 'Icon_base__placeholder_9c',
                    pt = 'Icon_imageTemp_1f',
                        ...
                        return E
                            ? i
                                ? s().createElement(
                                      'div',
                                      { className: K()(r, ft) },
                                      i && s().createElement('div', { className: ht }),
                                      m,
                                  )
                                : m
                            : null;
                        ...
                        ({
                            ...
                            return s().createElement(
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        me,
                                        { args: p, isEnabled: -1 !== u },
                                        s().createElement(
                                            'div',
                                            { className: _, onMouseEnter: h },
                                            s().createElement(vt, { className: d, src: a || '', onClick: f }),
                                            n && s().createElement(pe, { className: zt }),
                                        ),
                                    ),
                ...
                const Bn = se('model', (u) => ({ name: u.tankName, level: u.tankLevel, type: u.tankType }))(Cn),
                    ...
                    hn = R.strings.menu.viewHeader.closeBtn.label(),
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        ...
                                        s().createElement(
                                            'div',
                                            { className: gn.header },
                                            s().createElement(Bn, { extraText: pn }),
                                        ),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [858], () => __webpack_require__(602));
