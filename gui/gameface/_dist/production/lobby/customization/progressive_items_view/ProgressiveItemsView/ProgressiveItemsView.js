(() => {
    ...
    var __webpack_modules__ = {
            ...
            817: (u, e, t) => {
                ...
                var r = {};
                (t.r(r), t.d(r, { Area: () => $u, Bar: () => Vu, Default: () => Uu, useVerticalScrollApi: () => Su }));
                var a = t(67),
                    o = t(179),
                    s = t.n(o),
                    i = t(493),
                ...
                const F = (u, e, t) => {
                    ...
                    d = (u, e, t = A.left) => u.split(e).reduce(t === A.left ? F : m, []),
                    D = (() => {
                        const u = new RegExp(
                        ...
                        f(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    r = w(u);
                                m.current = b.addCallback(r, t, s, e === y.Deep);
                            }
                        }),
                        (0, o.useEffect)(() => {
                            if (e !== y.None)
                                return () => {
                                    b.removeCallback(m.current, s);
                                };
                        }, [s, e]),
                        A
                    );
                        ...
                        return (
                            (a = r =
                                class extends s().Component {
                                    ...
                                    render() {
                                        return s().createElement(n, x({}, this.props, this.state));
                                    }
                                }),
                            (r.displayName = `InjectProps(${k(n)})`),
                            a
                        );
                    };
                }
                ...
                const L = a.O.client.getSize('rem'),
                    I = L.width,
                    H = L.height,
                    z = Object.assign({ width: I, height: H }, O(I, H, T)),
                    W = (0, o.createContext)(z),
                    V = ['children'];
                const j = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    const n = (0, o.useContext)(W),
                        ...
                        g = { extraLarge: d, large: D, medium: _, small: C, extraSmall: B };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && c) return P(e, t, g);
                        if (t.largeWidth && E) return P(e, t, g);
                        if (t.mediumWidth && A) return P(e, t, g);
                        if (t.smallWidth && F) return P(e, t, g);
                ...
                (0, o.memo)(j);
                const U = (0, o.memo)(({ children: u }) => {
                        const e = (0, o.useContext)(W),
                            t = (0, o.useState)(e),
                            n = t[0],
                            r = t[1],
                            i = (0, o.useCallback)((u, e) => {
                                ...
                                r(Object.assign({ width: t, height: n }, O(t, n, T)));
                            }, []);
                        (f(() => {
                        ...
                        return s().createElement(W.Provider, { value: l }, u);
                    }),
                    $ = 'App_base_aa',
                    G = 'App_contentWrapper_bf';
                function Y() {
                    return (
                        (Y =
                            Object.assign ||
                ...
                function uu(u) {
                    ...
                    return (
                        ...
                        (0, o.useCallback)((...u) => (0, e.current)(...u), J)
                    );
                }
                function eu(u, e, t = []) {
                ...
                const lu = {
                    ...
                    cu = ({
                        ...
                        return (l = {}) => {
                            const c = l.settings,
                                ...
                                m = (() => {
                                    const u = (0, o.useMemo)(() => ({}), []),
                                        ...
                                        r = (u, ...t) => {
                                            for (var n, r = ru(e(u).values()); !(n = r()).done;) (0, n.value)(...t);
                                        };
                            ...
                            const w = (0, o.useCallback)((u) => m.trigger('isThumbDraggingChanged', u), [m]);
                            return (0, o.useMemo)(
                                () => ({
                                ...
                                [_.scrollPosition, g, f, w, m.off, m.on, v, p, C, E.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    Eu = cu({
                    ...
                    pu = () => {},
                    hu = (u, e) => Math.max(20, u.offsetWidth * e),
                    vu = (0, o.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = fu, onDrag: n = pu }) => {
                                ...
                                ((t.style.transform = `translateX(${0 | A}px)`),
                                    ((u) => {
                                        if (a.current && i.current && l.current && c.current) {
                                            ...
                                            var e, t;
                                            (a.current.classList.remove(Bu), i.current.classList.remove(Bu));
                                        }
                                    })(A));
                            },
                            _ = uu(() => {
                                ((() => {
                                    ...
                                    ((e.style.width = `${hu(t, o)}px`),
                                        (e.style.display = 'flex'),
                                        r.current &&
                                            (1 === o ? r.current.classList.add(Fu) : r.current.classList.remove(Fu)));
                                })(),
                                    D());
                            });
                        ((0, o.useEffect)(() => Z(_)),
                            ...
                            (0, o.useEffect)(() => {
                                ...
                                const e = (e) => {
                                    ...
                                    t = () => {
                                        (window.removeEventListener('mousemove', e), d(gu));
                                    };
                                return (
                        ...
                        const C = eu((e) => u.applyStepTo(e), E, [u]),
                            B = C[0],
                            g = C[1];
                        (0, o.useEffect)(
                            () => (
                        ...
                        const f = (u) => {
                            u.target.classList.contains(Bu) || tu('highlight');
                        };
                        return s().createElement(
                            'div',
                            { className: X()(Au, e.base), ref: r, onWheel: u.handleMouseWheel },
                            s().createElement('div', {
                                className: X()(mu, e.leftButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(Bu) || 0 !== u.button || (tu('play'), B(iu.Next));
                                },
                                onMouseUp: g,
                                ref: a,
                                onMouseEnter: f,
                            ...
                            s().createElement(
                                ...
                                s().createElement('div', { ref: c, className: X()(_u, e.thumb) }),
                                s().createElement('div', { className: X()(Cu, e.rail) }),
                            ),
                            s().createElement('div', {
                                className: X()(du, e.rightButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(Bu) || 0 !== u.button || (tu('play'), B(iu.Prev));
                                },
                                onMouseUp: g,
                                ref: i,
                                onMouseEnter: f,
                    ...
                    bu = ({
                        ...
                        const E = (0, o.useMemo)(() => {
                                const u = n || {};
                                return Object.assign({}, u, { base: X()(wu.base, u.base) });
                            }, [n]),
                            A = (0, o.useMemo)(() => Object.assign({}, e, { handleMouseWheel: () => {} }), [e]);
                        return s().createElement(
                            'div',
                            { className: X()(wu.defaultScroll, t), onWheel: e.handleMouseWheel },
                            s().createElement(
                                'div',
                                { className: X()(wu.defaultScrollArea, r) },
                                s().createElement(yu, { className: i, api: A, classNames: a }, u),
                            ),
                            s().createElement(vu, { getStepByRailClick: l, api: e, onDrag: c, classNames: E }),
                        );
                    },
                    yu = ({ api: u, className: e, classNames: t, children: n, style: r }) => (
                        (0, o.useEffect)(() => Z(u.recalculateContent)),
                        s().createElement(
                            'div',
                            { className: X()(wu.base, e), style: r },
                            s().createElement(
                                'div',
                                {
                                    className: X()(wu.wrapper, null == t ? void 0 : t.wrapper),
                                    onWheel: u.handleMouseWheel,
                                    ref: u.wrapperRef,
                                },
                                s().createElement(
                                    'div',
                                    { className: X()(wu.content, null == t ? void 0 : t.content), ref: u.contentRef },
                                    n,
                                ),
                            ),
                        )
                ...
                ((yu.Bar = vu),
                    (yu.Default = bu),
                    (yu.SeniorityAwards = ({ api: u, className: e, classNames: t, children: n }) => (
                        (0, o.useEffect)(() => Z(u.recalculateContent)),
                        s().createElement(
                            'div',
                            { className: X()(wu.base, e) },
                            s().createElement(
                                'div',
                                { className: X()(wu.wrapper, null == t ? void 0 : t.wrapper), ref: u.wrapperRef },
                                s().createElement(
                                    'div',
                                    { className: X()(wu.content, null == t ? void 0 : t.content), ref: u.contentRef },
                                    n,
                ...
                const Su = cu({
                    ...
                    Vu = (0, o.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = Hu, onDrag: n = Ru }) => {
                        const r = (0, o.useRef)(null),
                            a = (0, o.useRef)(null),
                            i = (0, o.useRef)(null),
                            l = (0, o.useRef)(null),
                        ...
                        const B = eu((e) => u.applyStepTo(e), E, [u]),
                            g = B[0],
                            f = B[1];
                        (0, o.useEffect)(
                            () => (
                        ...
                        const p = (u) => {
                            u.target.classList.contains(Lu) || tu('highlight');
                        };
                        return s().createElement(
                            'div',
                            { className: X()(ku, e.base), ref: r, onWheel: u.handleMouseWheel },
                            s().createElement('div', {
                                className: X()(Nu, e.topButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(Lu) || 0 !== u.button || (tu('play'), g(iu.Next));
                                },
                                ref: a,
                                onMouseEnter: p,
                            }),
                            s().createElement(
                                ...
                                s().createElement('div', { className: X()(Ou, e.rail) }),
                            ),
                            s().createElement('div', {
                                className: X()(Pu, e.bottomButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(Lu) || 0 !== u.button || (tu('play'), g(iu.Prev));
                                },
                                onMouseUp: f,
                                ref: i,
                                onMouseEnter: p,
                    ...
                    Uu = ({
                        ...
                        const E = (0, o.useMemo)(() => {
                                const u = n || {};
                                return Object.assign({}, u, { base: X()(ju.base, u.base) });
                            }, [n]),
                            A = (0, o.useMemo)(() => Object.assign({}, e, { handleMouseWheel: () => {} }), [e]);
                        return s().createElement(
                            'div',
                            { className: X()(ju.defaultScroll, t), onWheel: e.handleMouseWheel },
                            s().createElement(
                                'div',
                                { className: X()(ju.area, r) },
                                s().createElement($u, { className: a, classNames: i, api: A }, u),
                            ),
                            s().createElement(Vu, { getStepByRailClick: l, api: e, onDrag: c, classNames: E }),
                        );
                    },
                    $u = ({ className: u, classNames: e, children: t, api: n }) => (
                        ...
                        s().createElement(
                            'div',
                            { className: X()(ju.base, u), ref: n.wrapperRef, onWheel: n.handleMouseWheel },
                            s().createElement(
                                'div',
                                { className: X()(ju.content, null == e ? void 0 : e.content), ref: n.contentRef },
                                t,
                            ),
                        )
                    );
                ...
                class Xu extends s().PureComponent {
                    constructor(...u) {
                        (super(...u),
                    ...
                    render() {
                        const u = this.props,
                            ...
                            F = X()(Yu.base, Yu[`base__${a}`], Yu[`base__${r}`], null == o ? void 0 : o.base),
                            m = X()(Yu.icon, Yu[`icon__${a}`], Yu[`icon__${r}`], null == o ? void 0 : o.icon),
                            d = X()(Yu.glow, null == o ? void 0 : o.glow),
                            D = X()(Yu.caption, Yu[`caption__${a}`], null == o ? void 0 : o.caption),
                            _ = X()(Yu.goto, null == o ? void 0 : o.goto);
                        return s().createElement(
                            'div',
                            Ku(
                                {
                            ...
                            'info' !== a && s().createElement('div', { className: Yu.shine }),
                ...
                function Ju(u = Zu.n.NONE, e = Qu, t = !1) {
                    (0, o.useEffect)(() => {
                        if (u !== Zu.n.NONE)
                            return (
                ...
                const ee = ue;
                const te = 'ProgressionHeader_base_d3',
                    ne = 'ProgressionHeader_base__large_26',
                    re = 'ProgressionHeader_line_60',
                    ae = 'ProgressionHeader_title_3f',
                    oe = ({ title: u, className: e }) => {
                        const t = (0, o.useContext)(W),
                            n = X()(te, (t.large || t.extraLarge) && ne, e);
                        return s().createElement(
                            'div',
                            { className: n },
                ...
                const le = (u, e, t = {}, n = 0) => {
                    ...
                    ce = (u) => {
                        ...
                        const h = (0, o.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            v = (0, o.useMemo)(() => B || c().resId, [B]),
                            w = (0, o.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (le(t, d, { isMouseEvent: !0, on: !0, arguments: ie(n) }, v),
                                    g && g(),
                ...
                const Fe = (u) => {
                    ...
                    _e = ({ className: u }) => {
                        ...
                        return s().createElement(
                            'span',
                            { className: X()(me, u) },
                            s().createElement('span', { className: de }),
                            s().createElement('span', { className: De }, e),
                        );
                    },
                    Ce = 'Icon_base_d5',
                    Be = 'Icon_base__placeholder_9c',
                        ...
                        return E
                            ? i
                                ? s().createElement(
                                      'div',
                                      { className: X()(r, Ce) },
                                      i && s().createElement('div', { className: Be }),
                                      m,
                                  )
                                : m
                            : null;
                    ...
                    we = 'Item_base__firstMedium_f5',
                    be = 'Item_base__firstLarge_53',
                    ye = 'Item_content_bb',
                    Se = 'Item_content__small_9a',
                    ke = 'Item_content__medium_66',
                    xe = 'Item_content__large_a3',
                    Ne = 'Item_image_f0',
                    Pe = 'Item_image__small_9c',
                    Te = 'Item_image__medium_fe',
                    Me = 'Item_image__large_38',
                    Oe = 'Item_image__locked_0f',
                    Le = 'Item_image__progress_21',
                    Re = 'Item_imageContainer_8f',
                    Ie = 'Item_imageContainer__small_6c',
                    He = 'Item_imageContainer__medium_9a',
                    ze = 'Item_imageContainer__large_17',
                    We = 'Item_hoverContent_51',
                    Ve = 'Item_itemProgression_d8',
                    je = 'Item_itemProgression__small_2e',
                    Ue = 'Item_itemProgression__large_34',
                    $e = 'Item_itemProgressionWithBar_f5',
                    Ge = 'Item_itemProgressionWithBar__small_20',
                    Ye = 'Item_itemProgressionWithBar__large_ab',
                    qe = 'Item_itemSeparator_1f',
                    Ke = 'Item_itemSeparator__small_94',
                    Xe = 'Item_itemSeparator__medium_d6',
                    Ze = 'Item_itemSeparator__large_ba',
                    Qe = 'ItemBlockDone_base_b5',
                    Je = 'ItemBlockDone_base__large_69',
                    ut = 'ItemBlockDone_contentContainer_04',
                    et = 'ItemBlockDone_contentContainer__small_61',
                    tt = 'ItemBlockDone_contentContainer__large_b2',
                    nt = ({ levelText: u }) => {
                        const e = (0, o.useContext)(W),
                            t = e.small,
                ...
                const st = ({ size: u = at.Default, classMix: e }) =>
                        s().createElement('div', { className: X()(rt.background, rt[`background__${u}`], e) }),
                    it = {
                    ...
                    Et = (0, o.memo)(
                        ({ size: u, lineRef: e, disabled: t, baseStyles: n, isComplete: r, withoutBounce: a }) => {
                            ...
                            return s().createElement(
                                ...
                                i && s().createElement(lt, { size: u }),
                            );
                        },
                    ),
                    At = ({ size: u, value: e, lineRef: t, disabled: n, onComplete: r }) => {
                        ...
                        return (
                            ...
                            s().createElement(Et, { size: u, disabled: n, baseStyles: a, isComplete: i, lineRef: t })
                        );
                    },
                    Ft = (u, e) => {
                        let t;
                ...
                const Dt = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    ft = 'ProgressBarDeltaGrow_base__withoutBounce_b5',
                    pt = 'ProgressBarDeltaGrow_glow_68',
                    ht = (u) => (u ? { left: 0 } : { right: 0 }),
                    vt = (u, e) => (u ? { right: 100 - e + '%' } : { left: `${e}%` }),
                    wt = (u) => ({ transitionDuration: `${u}ms` }),
                    bt = (0, o.memo)(
                        ({
                            transitionDuration: u,
                            transitionDelay: e,
                            ...
                            const f = (0, o.useMemo)(() => Object.assign({ width: '100%' }, wt(u), ht(E)), [E, u]),
                                p = (0, o.useMemo)(() => Object.assign({ width: '0%' }, wt(u), ht(E)), [E, u]),
                                h = (0, o.useMemo)(() => Object.assign({ width: '0%' }, vt(E, n), wt(u)), [n, E, u]),
                                v = (0, o.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(a - n)}%` }, vt(E, n), wt(u)),
                                    [n, E, a, u],
                                );
                            if (d) return null;
                            const w = X()(gt, c, E && 0 === a && ft);
                            return s().createElement(
                                'div',
                                { style: D ? h : v, className: w },
                                s().createElement(
                                    'div',
                                    { style: C ? p : f, className: pt },
                                    s().createElement(lt, { size: r }),
                                ),
                            );
                        },
                ...
                const xt = (0, o.memo)((u) => {
                        ...
                        switch (n.animationSettings.type) {
                            case ot.Simple:
                                return s().createElement(Bt, kt({}, n, { onEndAnimation: l, isComplete: a }));
                            case ot.Growing:
                                return s().createElement(yt, kt({}, n, { onEndAnimation: l, isComplete: a }));
                            default:
                                return null;
                        }
                    }),
                ...
                const Tt = (0, o.memo)((u) => {
                    ...
                    return (
                        (n.current.from = a),
                        s().createElement(xt, Pt({}, t, { onEndAnimation: r, key: `${a}-${t.to}`, from: a }))
                    );
                });
                function Mt() {
                    return (
                ...
                const Ot = (0, o.memo)(
                        ({
                            ...
                            return a.withStack
                                ...
                                : s().createElement(xt, Mt({ key: `${r}-${e}` }, c));
                        },
                    ),
                    Lt = (u) => ({
                    ...
                    zt = (0, o.memo)(
                        ({
                            ...
                            const d = ((u, e, t) =>
                                (0, o.useMemo)(() => {
                                    const n = (Q(0, e, u) / e) * 100;
                                    return { value: n, deltaFrom: Rt(n, e, t) };
                                }, [t, e, u]))(l, u, c);
                            return s().createElement(
                                'div',
                                { className: X()(rt.base, rt[`base__${t}`]), style: Lt(e) },
                                !a && s().createElement(st, { size: t, classMix: i }),
                                s().createElement(Ot, {
                                    size: t,
                                    lineRef: E,
                                    disabled: r,
                    ...
                    Wt = 'ItemBlockProgression_base_19',
                    Vt = 'ItemBlockProgression_base__small_02',
                    jt = 'ItemBlockProgression_text_d9',
                    Ut = 'ItemBlockProgression_text__large_7e',
                    $t = 'ItemBlockProgression_text__score_9d',
                    Gt = 'ItemBlockProgression_count_b1',
                    Yt = 'ItemBlockProgression_description_b2',
                    qt = ({
                        unlockCondition: u,
                        progressionVal: e,
                        maxProgressionVal: t,
                        ...
                        const a = (0, o.useMemo)(() => `/ ${t}`, [t]),
                            i = (0, o.useContext)(W),
                            l = X()(Wt, (i.small || i.medium || i.large || i.extraLarge) && Vt, r),
                            c = X()(jt, (i.large || i.extraLarge) && Ut);
                        return s().createElement(
                            'div',
                            { className: l },
                            !n &&
                                s().createElement(
                                    ...
                                    s().createElement(zt, { value: e, size: at.Small, maxValue: t }),
                                ),
                            s().createElement('span', { className: X()(Yt, c) }, u),
                        );
                    },
                    Kt = 'Separator_base_44',
                    Xt = 'Separator_lock_98',
                    Zt = 'Separator_lockImage_6c',
                    Qt = 'Separator_arrow_12',
                    Jt = ({ unlocked: u, className: e }) =>
                        s().createElement(
                            'span',
                            { className: X()(Kt, e) },
                            s().createElement('span', { className: Qt }),
                            !u &&
                                s().createElement(
                                    'span',
                                    { className: Xt },
                ...
                const en = N('model', void 0, (u) => ({
                        onSelectItem: (e, t) => e && u.onSelectItem({ intCD: e, level: t }),
                    }))(
                        ({
                            itemId: u,
                            onSelectItem: e,
                            ...
                            const E = (0, o.useContext)(W),
                                A = E.small,
                                F = E.medium,
                                m = E.large || E.extraLarge,
                                d = (0, o.useMemo)(
                                    () => X()(pe, c && he, c && A && ve, c && F && we, c && m && be),
                                    [c, A, F, m],
                                ),
                                D = (0, o.useMemo)(
                                    () => X()(Ne, (t || !n) && Oe, t && Le, A && Pe, F && Te, m && Me),
                                    [t, n, A, F, m],
                                ),
                                _ = X()(ye, A && Se, F && ke, m && xe),
                                C = X()(Re, A && Ie, F && He, m && ze),
                                B = X()(qe, A && Ke, F && Xe, m && Ze);
                            let g;
                            g = r.hideProgressBarAndString ? X()(Ve, A && je, m && Ue) : X()($e, A && Ge, m && Ye);
                            const f = (0, o.useCallback)(() => {
                                    (nu.playClick(), tu(R.sounds.cust_progress_exiting()), u && e(u, i));
                                }, [u, i, e]),
                                p = (0, o.useCallback)(() => {
                                    n && nu.playHighlight();
                                }, [n]),
                            ...
                            return s().createElement(
                                'div',
                                { className: d },
                                !c && s().createElement(Jt, { unlocked: n || t, className: B }),
                                s().createElement(
                                    'div',
                                    { className: _ },
                                    s().createElement(
                                        ...
                                        s().createElement(
                                            'div',
                                            { className: C, onMouseEnter: p },
                                            s().createElement(fe, { className: D, src: a || '', onClick: f }),
                                            n && s().createElement(_e, { className: We }),
                                        ),
                                    ),
                                    t && s().createElement(qt, un({}, r, { className: g })),
                                    n && s().createElement(nt, { levelText: l }),
                                ),
                            );
                        },
                    ),
                ...
                const rn = ({ eachLevelInfo: u, itemId: e, scaleFactor: t }) =>
                        s().createElement(
                            'div',
                            { className: tn },
                            s().createElement(
                            ...
                            s().createElement(
                                ...
                                u.items.map(
                                    ({ value: u }, n) =>
                                        0 !== n &&
                                        s().createElement(en, nn({ key: u.level, itemId: e, scaleFactor: t }, u)),
                                ),
                            ),
                        ),
                    an = 'ProgressionSequence_base_d9',
                    on = 'ProgressionSequence_base__small_c3',
                    sn = 'ProgressionSequence_base__large_44',
                    ln = 'ProgressionSequence_header_30',
                    cn = ['itemUserString'];
                const En = (u) => {
                        ...
                        const n = (0, o.useContext)(W),
                            r = X()(an, n.small && on, (n.medium || n.large || n.extraLarge) && sn);
                        return s().createElement(
                            'div',
                            { className: r },
                            s().createElement(oe, { title: e, className: ln }),
                            s().createElement(rn, t),
                        );
                    },
                    An = 'Grid_base_d1',
                    Fn = 'Grid_content_ec',
                    mn = 'Grid_content__small_a4',
                    dn = 'Grid_content__medium_02',
                    Dn = 'Grid_content__large_c3';
                function _n() {
                    return (
                        (_n =
                            Object.assign ||
                ...
                const Cn = ({ items: u }) => {
                        const e = (0, o.useContext)(W),
                            t = X()(Fn, e.small && mn, e.medium && dn, (e.large || e.extraLarge) && Dn);
                        return s().createElement(
                            'div',
                            { className: An },
                            s().createElement(
                                'div',
                                { className: t },
                                u.map(({ value: u }) => s().createElement(En, _n({ key: u.itemId }, u))),
                            ),
                        );
                    },
                    Bn = 'Header_base_0d',
                    gn = 'Header_tankTypeIcon_d6',
                    fn = 'Header_contentContainer_85',
                    pn = 'Header_spaceAtTheEnd_c0',
                    hn = ({ name: u, level: e, extraText: t, type: n, className: r }) => {
                        const a = (0, o.useMemo)(() => (t ? t.replace('{tankLevel}', e) : `${e} {tankName}`), [t, e]),
                            ...
                            l = a
                                ...
                                .map((e, t) =>
                                    1 === t
                                        ? [
                                              s().createElement('span', { key: 'icon', className: gn, style: i }),
                                              s().createElement('span', { key: 'name', className: pn }, u),
                        ...
                        return s().createElement(
                            'div',
                            { className: X()(Bn, r) },
                            s().createElement('div', { className: fn }, l),
                        );
                    };
                hn.defaultProps = { extraText: '' };
                const vn = N('model', (u) => ({ name: u.tankName, level: u.tankLevel, type: u.tankType }))(hn),
                    wn = {
                    ...
                    bn = R.strings.vehicle_customization.progression.about(),
                    yn = R.strings.menu.viewHeader.closeBtn.label(),
                    Sn = R.strings.vehicle_customization.progression.tankHeader(),
                    kn = () => {
                        (tu(R.sounds.cust_progress_exiting()), (0, g.Sy)());
                    },
                    xn = (function (u, e, t) {
                        if (!e && !t) throw new Error('You should define at least one helper function');
                        return function (n) {
                            ...
                            return (
                                (a = r =
                                    class extends s().Component {
                                        ...
                                        render() {
                                            return s().createElement(n, Y({}, this.props, this.state));
                                        }
                                    }),
                                (r.displayName = `WithModel(${k(n)})`),
                                a
                            );
                        };
                    })('model', (u) => ({ progressiveItems: u.progressiveItems }))(
                        ({ progressiveItems: u, scrollPositionRef: e, onAboutClick: t }) => {
                            const n = S('model', y.None),
                            ...
                            return (
                                (0, o.useEffect)(() => {
                                    tu(R.sounds.cust_progress_entering());
                                }, []),
                                (E = kn),
                                Ju(Zu.n.ESCAPE, E),
                                (0, o.useEffect)(
                                    () =>
                                        Z(() => {
                                            ...
                                            const r = (function (u, e) {
                                                for (let t = 0; t < u.length; t++) if (e(ee(u, t), t, u)) return t;
                                        ...
                                        t = (u) => {
                                            l.current &&
                                                (0 === u.value.scrollPosition
                                                    ? l.current.classList.remove(wn.lip__show)
                                                    : l.current.classList.add(wn.lip__show));
                                        };
                                    return (
                                ...
                                s().createElement(
                                    ...
                                    null,
                                    s().createElement('div', {
                                        className: X()(wn.overlay, !r && wn.overlay__lowSettings),
                                    }),
                                    s().createElement(
                                        'div',
                                        { className: wn.base },
                                        s().createElement(
                                            'div',
                                            { className: wn.header },
                                            s().createElement(vn, { extraText: Sn }),
                                        ),
                                        s().createElement('div', { ref: l, className: X()(wn.lip, wn.lip__hidden) }),
                                        s().createElement(
                                            Gu.Vertical.Default,
                                            { className: wn.scroll, api: c },
                                            s().createElement(
                                                'div',
                                                { ref: i, className: wn.grid },
                                                s().createElement(Cn, { items: u.items }),
                                            ),
                                        ),
                                        s().createElement(
                                            'div',
                                            { className: wn.infoBtn },
                                            s().createElement(Xu, { caption: bn, type: 'info', onClick: t }),
                                        ),
                                        s().createElement(
                                            'div',
                                            { className: wn.closeBtn },
                                            s().createElement(Xu, {
                                                caption: yn,
                                                type: 'close',
                                                side: 'right',
                    ...
                    Nn = ({ withDescription: u, onClick: e }) =>
                        s().createElement(Xu, {
                    ...
                    Pn = 'Tutorial_base_56',
                    Tn = 'Tutorial_overlay_5e',
                    Mn = 'Tutorial_overlay__lowSettings_b4',
                    On = 'Tutorial_scroll_fc',
                    Ln = 'Tutorial_goBackContainer_3d',
                    Rn = 'FormatText_base_d0',
                    In = ({ binding: u, text: e = '', classMix: t, alignment: n = A.left }) =>
                        null === e
                            ...
                            : s().createElement(
                                  ...
                                  e.split('\n').map((e, r) =>
                                      s().createElement(
                                          'div',
                                          { className: X()(Rn, t), key: `${e}-${r}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : C(u, e))))(e, n, u).map((u, e) =>
                                              s().createElement(o.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              ),
                    Hn = 'TutorialElement_base__small_19',
                    zn = 'TutorialElement_base__medium_e2',
                    Wn = 'TutorialElement_icon__small_2e',
                    Vn = 'TutorialElement_icon__medium_3d',
                    jn = 'TutorialElement_elementTitle_15',
                    Un = 'TutorialElement_elementTitle_container_66',
                    $n = 'TutorialElement_elementDescription_82',
                    Gn = ({ elementType: u, isSmall: e = !1 }) => {
                        const t = e ? Hn : zn,
                            n = e ? Wn : Vn,
                            r = (0, o.useMemo)(
                                () => ({
                    ...
                    Yn = 'TutorialContent_base_cf',
                    qn = 'TutorialContent_main_03',
                    Kn = 'TutorialContent_mainTitle_38',
                    Xn = 'TutorialContent_mainTitleContainer_ef',
                    Zn = 'TutorialContent_mainDescription_8b',
                    Qn = 'TutorialContent_mainDescriptionContainer_f5',
                    Jn = 'TutorialContent_image_97',
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        ...
                                        s().createElement(
                                            'div',
                                            { className: sr },
                                            s().createElement(Gn, { elementType: 'improvement' }),
                                        ),
                                        s().createElement(
                                            'div',
                                            { className: sr },
                                            s().createElement(Gn, { elementType: 'interaction' }),
                                        ),
                                    ),
                                ),
                                s().createElement(
                                    ...
                                    s().createElement(
                                        ...
                                        s().createElement(
                                            'div',
                                            { className: or },
                                            s().createElement(Gn, { isSmall: !0, elementType: 'vehicles' }),
                                        ),
                                        s().createElement(
                                            'div',
                                            { className: or },
                                            s().createElement(Gn, { isSmall: !0, elementType: 'quests' }),
                                        ),
                                        s().createElement(
                                            'div',
                                            { className: or },
                                            s().createElement(Gn, { isSmall: !0, elementType: 'modes' }),
                                        ),
                                    ),
                                ),
                            ),
                    ...
                    lr = ({ onBackClick: u }) => {
                        const e = !(0, o.useContext)(W).extraSmall,
                            t = S('model', y.None).isRendererPipelineDeferred,
                            n = Su();
                        return (
                            Ju(Zu.n.ESCAPE, u),
                            s().createElement(
                                'div',
                                { className: Pn },
                                s().createElement('div', { className: X()(Tn, !t && Mn) }),
                                s().createElement(
                                    Gu.Vertical.Default,
                                    { className: On, api: n },
                                ...
                                s().createElement(
                                    'div',
                                    { className: Ln },
                                    s().createElement(Nn, { onClick: u, withDescription: e }),
                                ),
                            )
                        );
                    },
                    cr = ({ isTutorialShown: u, onBackClick: e, onAboutClick: t }) => {
                        ...
                        return u
                            ...
                            : s().createElement(xn, { scrollPositionRef: n, onAboutClick: t });
                    },
                    Er = N('model', void 0, (u) => ({ playSounds: (e) => u.playSounds({ isTutorialPageOpened: e }) }))(
                        ({ playSounds: u }) => {
                            ...
                            return s().createElement(
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        'div',
                                        { className: G },
                                        s().createElement(cr, { onBackClick: r, onAboutClick: a, isTutorialShown: t }),
                                    ),
                                ),
                            );
                        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [858], () => __webpack_require__(817));
