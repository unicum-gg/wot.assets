(() => {
    var __webpack_modules__ = {
            ...
            7218: (u, e, t) => {
                ...
                const T = {
                    ...
                    L = (u) => {
                        ...
                        const r = w(),
                            ...
                            s = r.mediaHeight,
                            o = r.mediaSize;
                        return n().createElement('div', f({ className: C()(t, T[i], M[s], y[o]) }, a), e);
                    },
                    O = ['children'],
                    P = (u) => {
                        let e = u.children,
                ...
                class W extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            m = C()(H.base, H[`base__${i}`], H[`base__${r}`], null == s ? void 0 : s.base),
                            A = C()(H.icon, H[`icon__${i}`], H[`icon__${r}`], null == s ? void 0 : s.icon),
                            F = C()(H.glow, null == s ? void 0 : s.glow),
                            D = C()(H.caption, H[`caption__${i}`], null == s ? void 0 : s.caption),
                            d = C()(H.goto, null == s ? void 0 : s.goto);
                ...
                const au = 200,
                    nu = 400,
                    ru = (u) => Math.sqrt(1 - Math.pow(u - 1, 2)),
                    iu = [z.Vehicles];
                let su, ou;
                function lu() {
                    return !1;
                ...
                const du = [
                    ...
                    Bu = [z.Gold, z.Credits, z.Crystal, z.FreeXp],
                    Cu = [z.BattlePassPoints],
                    gu = [z.PremiumPlus, z.Premium],
                ...
                const Su = (u, e, t) => {
                    ...
                    Ru = (u, e, t = xu.left) => u.split(e).reduce(t === xu.left ? Su : fu, []),
                    Tu = (() => {
                        const u = new RegExp(
                    ...
                    yu = (u) => {
                        return {
                            ...
                            tooltipArgs: bu({ tooltipId: u.tooltipId }, Number(u.tooltipContentId)),
                            type: u.type,
                                        ...
                                        const r = (function ({
                                            ...
                                            c = (({ observableModel: u }) => {
                                                const e = {
                                                    ...
                                                    t = (0, Au.Om)(() => mu(e.mainRewards.get(), (u) => yu(u)), {
                                                        equals: lu,
                                                    }),
                                                    a = (0, Au.Om)(() => mu(e.rewards.get(), (u) => yu(u)), {
                                                        equals: lu,
                                                    }),
                                                    n = (0, Au.Om)(() => t().some((u) => iu.includes(u.name)), {
                                                        equals: lu,
                                                    }),
                                                    r = (0, Au.Om)(() => Boolean(t().length), { equals: lu }),
                                                    i = (0, Au.Om)(() => t().some((u) => u.name === z.GoldenTicket), {
                                                        equals: lu,
                                                    }),
                                                    s = (0, Au.Om)(() => t().some((u) => u.name === z.LootBoxToken), {
                                                        equals: lu,
                                                    }),
                                                    o = (0, Au.Om)(() => Boolean(a().length), { equals: lu }),
                                                    l = (0, Au.Om)(() => o() && !r(), { equals: lu }),
                                                    E = (0, Au.Om)(() => (l() ? 0 : au * t().length + nu), {
                                                        equals: lu,
                                                    }),
                                                    c = (0, Au.Om)(() => Math.min(a().length, 10), { equals: lu }),
                                                    _ = (0, Au.Om)(() => Boolean(t().length % 2), { equals: lu }),
                                                    m = (0, Au.Om)(
                                                        () => {
                                                            const u = c() > 0 ? nu : 0;
                                                            return E() + au * c() + u;
                ...
                const Wu = (0, a.memo)(function (u) {
                        ...
                        return (
                            ...
                            n().createElement('canvas', Gu({}, h, { width: e, height: t, ref: p }))
                        );
                    }),
                    $u = (u, e) => {
                        let t = u;
                        ...
                        const p = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, a.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Yu(t, A, { isMouseEvent: !0, on: !0, arguments: Vu(n) }, b),
                                    C && C(),
                ...
                const ne = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return n().createElement(te, e, a);
                        const r = e.contentId,
                            i = e.args,
                            s = null == i ? void 0 : i.contentId;
                        return r || s
                            ? n().createElement(zu, ae({}, e, { contentId: r || s }), a)
                    ...
                    ie = ({
                        ...
                        return n().createElement(
                            'div',
                            { className: C()(re.base, re[`base__${a}`], l), style: o },
                            n().createElement(
                                ne,
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: C()(re.image, null == E ? void 0 : E.image) },
                                        m &&
                                            n().createElement('div', {
                                                className: C()(re.highlight, null == E ? void 0 : E.highlight),
                                                style: {
                                        ...
                                        e &&
                                            n().createElement('div', {
                                                className: C()(re.icon, null == E ? void 0 : E.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        A &&
                                            n().createElement('div', {
                                                className: C()(re.overlay, null == E ? void 0 : E.overlay),
                                                style: {
                            ...
                            t &&
                                n().createElement(
                                    ...
                                    { tooltipArgs: _ },
                                    n().createElement('div', {
                                        className: C()(re.timer, null == E ? void 0 : E.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const de = {
                    ...
                    ge = me((u) => {
                        ...
                        const U = (0, a.useMemo)(() => {
                            ...
                            }, [t, r, o, E, _, A, k, N, R, B, y, w, f]),
                            G = U.computedStyle,
                            W = U.computedClassNames;
                        return n().createElement('div', De({ className: C()(Ae.base, ...W, e), style: G }, H), I);
                    }),
                    he = ({ binding: u, text: e = '', classMix: t, alignment: r = xu.left }) =>
                        null === e
                ...
                const Se = Object.keys(be()),
                    ...
                    Le = me((u) => {
                        ...
                        return n().createElement(
                            ...
                            we(
                                {
                                    className: C()(ve.base, t && ve[t], p, r),
                                    style: h,
                    ...
                    Ne = ({ compensatedBonusType: u, compensatedItem: e, value: t, valueType: a }) => {
                        const r = vu(t, a);
                        return n().createElement(
                            'div',
                            { className: Pe.base },
                            n().createElement('div', { className: C()(Pe.icon, Pe[`icon__${e}`]) }),
                            n().createElement(Le, { className: C()(Pe.value, Pe[`value__${u}`]), text: r }),
                        );
                    },
                    ...
                    We = (0, a.memo)(
                        ({
                            ...
                            vehicleLvl: i,
                            size: s = su.Small,
                            type: o = ou.WhiteSpanish,
                            classNames: l,
                        }) => {
                            const E = C()(Ge.base, Ge[`base__${s}`], Ge[`base__${o}`], l),
                                c = C()(Ge.nation, Ge[`nation__${a}`]),
                                _ = C()(Ge.type, u && Ge.type__elite, Ge[`type__${wu(r || '')}`]);
                            return n().createElement(
                                'div',
                                { className: E },
                                n().createElement('div', { className: c }),
                                n().createElement(Le, { className: Ge.level, text: Ue(i) }),
                                n().createElement('div', { className: _ }),
                                n().createElement(Le, { className: Ge.name, text: t }),
                            );
                        },
                    ),
                    $e = R.strings.gui_lootboxes.rewards.rent,
                    Xe = ({ rentBattles: u = 0, rentDays: e = 0 }) => {
                        const t =
                            u > 0
                                ? { text: $e.battles(u), binding: { battles: u } }
                                : { text: $e.days(e), binding: { days: e } };
                        return n().createElement(
                            'div',
                ...
                const qe = ({ reward: u, index: e, size: t }) => {
                        const r = u.image(t),
                            i = (0, a.useState)(!0),
                            s = i[0],
                            o = i[1],
                        ...
                        const E =
                            ...
                            n().createElement(Le, { text: u.label, className: 'MainReward_labelText_b5' });
                        return n().createElement(
                            'div',
                            { className: C()('MainReward_base_8c', s && 'MainReward_base__disabled_0e') },
                            n().createElement(
                                Oe,
                                { index: e },
                                ...
                                n().createElement(
                                    ...
                                    n().createElement('div', { className: 'MainReward_label_d5' }, E),
                                    u.isRent &&
                                        n().createElement(
                                            'div',
                                            { className: 'MainReward_tip_50' },
                                            n().createElement(Xe, { rentDays: u.rentDays, rentBattles: u.rentBattles }),
                                        ),
                                ),
                            ),
                        );
                    },
                    Ve = 'RewardList_reward_d8';
                function Ye() {
                    return (
                        (Ye =
                            Object.assign ||
                ...
                const ze = ({ data: u, maxRewards: e, showDelay: t }) => {
                        const r = w().mediaSize < p.Medium ? Q.Small : Q.Big,
                            i = e < u.length,
                            s = i ? u.slice(0, e) : u,
                            ...
                            E = (0, a.useMemo)(
                                () => bu({}, R.views.lobby.tooltips.AdditionalRewardsTooltip('resId')),
                                [],
                            );
                        return n().createElement(
                            'div',
                            ...
                            s.map((u, e) =>
                                n().createElement(
                                    ...
                                    n().createElement(ie, Ye({}, u, { image: u.image(r), size: r, className: Ve })),
                                ),
                            ),
                            i &&
                                n().createElement(
                ...
                const Qe = {
                        ...
                        2: {
                            ...
                            [p.Medium]: [Q.S400x300, Q.S400x300],
                            [p.Large]: [Q.S400x300, Q.S400x300],
                            [p.ExtraLarge]: [Q.S600x450, Q.S600x450],
                        },
                        3: {
                            [p.ExtraSmall]: [Q.S232x174, Q.S296x222, Q.S232x174],
                            [p.Small]: [Q.S232x174, Q.S296x222, Q.S232x174],
                            [p.Medium]: [Q.S296x222, Q.S400x300, Q.S296x222],
                            [p.Large]: [Q.S296x222, Q.S400x300, Q.S296x222],
                        ...
                        return n().createElement(
                            ...
                            o &&
                                n().createElement(
                                    ...
                                    n().createElement(Wu, {
                                        ...
                                        getImageSource: Fu(Ke),
                                        frameTime: 50,
                                        className: 'Content_sunShineCanvas_8a',
                                    }),
                                ),
                            n().createElement('div', {
                                className: C()('Content_ribbon_be', s && 'Content_ribbon__gold_f5'),
                            }),
                            ...
                            r &&
                                n().createElement(
                                    ...
                                    n().createElement(ze, { data: a, maxRewards: 10, showDelay: i }),
                                ),
                        );
                    }),
                    Je = {
                ...
                const tt = ({
                    ...
                    const D = (0, a.useRef)(null),
                        ...
                        k = C()(Je.state, Je.state__default);
                    return (
                        (0, a.useEffect)(
                            () => (
                        ...
                        n().createElement(
                            ...
                            r !== ut.ghost &&
                                n().createElement(
                                    n().Fragment,
                                    null,
                                    n().createElement('div', { className: Je.back }),
                                    n().createElement('span', { className: Je.texture }),
                                ),
                            n().createElement(
                                'span',
                                { className: k },
                                n().createElement('span', { className: Je.stateDisabled }),
                                n().createElement('span', { className: Je.stateHighlightHover }),
                                n().createElement('span', { className: Je.stateHighlightActive }),
                            ),
                            n().createElement(
                                'span',
                ...
                const at = (0, a.memo)(tt),
                    nt = 'Footer_button_e9',
                    rt = 'Footer_button__secondary_cd',
                    it = R.strings.mt_birthday.rewards,
                    st = (0, V.Pi)(() => {
                        const u = Hu(),
                            e = u.controls,
                            t = u.model,
                            ...
                            r = a.isFinalReward,
                            i = a.isRewardSeen,
                            s = t.computes.hasGoldenTicket(),
                            o = t.computes.hasLootBoxToken();
                        return n().createElement(
                            'div',
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    at,
                                    { mixClass: nt, type: ut.primary, size: et.medium, onClick: e.close },
                                    n().createElement(Le, { text: it.buttons.accept() }),
                                ),
                                i &&
                                    ((s &&
                                        n().createElement(
                                            at,
                                            {
                                                ...
                                                type: ut.secondary,
                                                size: et.medium,
                                                onClick: e.toGoldCarriage,
                                            },
                                            n().createElement(Le, { text: it.buttons.toGoldCarriage() }),
                                        )) ||
                                        (o &&
                                            n().createElement(
                                                at,
                                                ...
                                                n().createElement(Le, { text: it.buttons.toContainers() }),
                                            ))),
                            ),
                        );
                    });
                var ot = t(6893);
                const lt = 'Header_subTitle_0c',
                    Et = R.strings.mt_birthday.rewards.header,
                    ct = R.strings.player_phrases.blogger,
                    _t = (0, V.Pi)(() => {
                        ...
                        return n().createElement(
                            ...
                            l
                                ? n().createElement(
                                      ...
                                      n().createElement(Le, { className: 'Header_titleBlogger_58', text: ct.$num(a) }),
                                  )
                                : n().createElement(
                                      n().Fragment,
                                      null,
                                      n().createElement(Le, { className: 'Header_title_be', text: Et.title() }),
                                      !r && n().createElement(Le, { className: lt, text: Et.subTitleFirst() }),
                                      i && n().createElement(Le, { className: lt, text: Et.subTitleFinal() }),
                                      Boolean(o) &&
                                          n().createElement(Le, {
                                              className: lt,
                                              text: Et.subTitleStage(),
                                              format: { binding: { stage: Ue(s) } },
                                          }),
                                  ),
                        );
                    }),
                    mt = (0, V.Pi)(() => {
                        ...
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement('div', { className: 'App_header_81' }, n().createElement(_t, null)),
                                n().createElement('div', { className: 'App_content_00' }, n().createElement(Ze, null)),
                                n().createElement(W, {
                ...
                engine.whenReady.then(() => {
                    k().render(
                        n().createElement(Iu, null, n().createElement(P, null, n().createElement(mt, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(7218));
