            ...
            5025: (u, e, t) => {
                ...
                const G = ({ size: u = N.Default, classMix: e }) =>
                    ...
                    X = ({ size: u, value: e, lineRef: t, disabled: a, onComplete: i }) => {
                        ...
                        return (
                            ...
                            n().createElement($, { size: u, disabled: a, baseStyles: o, isComplete: s, lineRef: t })
                        );
                    },
                    V = (u, e) => {
                        let t;
                ...
                const Mu = {
                    ...
                    Ru = wu((u) => {
                        ...
                        return n().createElement('div', Lu({ className: C()(xu.base, ...j, e), style: G }, N), H);
                    });
                let Tu;
                !(function (u) {
                                        ...
                                        const a = (function ({
                                            ...
                                            A = (({ observableModel: u }) => {
                                                const e = {
                                                    ...
                                                    a = (0, be.Om)(
                                                        () => e.progression.get().infinityLevelCompleteCount + 1,
                                                        { equals: Ce },
                                                    );
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            'div',
                                            {
                                                className: C()(
                                                    'App_progression_a5',
                                                    z && 'App_progression__infinity_28',
                                                ),
                                            },
                                            z
                                                ? n().createElement(
                                ...
                                !h &&
                                    n().createElement(
                                        Fe,
                                        {
                                            tooltipArgs: {
                                                contentId:
                                                    R.views.mt_birthday.lobby.tooltips.EconomyBonusTooltip('resId'),
                                            },
                                        },
                                        n().createElement(
                                            'div',
