(() => {
    ...
    var __webpack_modules__ = {
            ...
            8067: (u, e, t) => {
                ...
                const N = { [S.NBSP]: L.NoBreakSymbol, [S.ZWNBSP]: L.NoBreakSymbol, [S.NEW_LINE]: L.LineBreak },
                    ...
                    V = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? I[n]
                                ? a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: r()(j, I[n]) },
                                      u,
                                  )
                                : a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: j, style: W(n) },
                                      u,
                                  )
                            : a().createElement('span', { key: t, 'data-block-type': e.blockType, className: j }, u);
                    },
                    U = {
                        [L.Word]: V,
                        [L.NoBreakSymbol]: V,
                    ...
                    H = (u, e = '', t) => {
                        ...
                        return (
                            q(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    n.push({ blockType: L.Word, colorTag: e, childList: K(u, t) });
                                },
                                (u) => {
                                    const t = u[0],
                                        r = N[t.charAt(0)];
                    ...
                    uu = (u, e, t, n, r, o) => {
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            if (l === L.LineBreak || l === L.NewLine || l === L.Binding) continue;
                    ...
                    eu = a().memo(
                        ({
                            ...
                            const d = (0, i.useRef)(null),
                                ...
                                _ = B[0],
                                C = B[1],
                                p = (0, i.useMemo)(() => Z(u, n, { justifyContent: c }), [n, c, u]),
                                f = (0, i.useMemo)(() => {
                                    if (
                                        o &&
                                        _.isTruncated &&
                ...
                const ou = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    au = iu[0],
                    su = iu[1],
                    Eu = 'DifficultyTooltipApp_subTitle_64',
                    lu = 'DifficultyTooltipApp_status_10',
                    cu = 'DifficultyTooltipApp_dots_30',
                    Au = 'DifficultyTooltipApp_bg_52',
                    Fu = R.strings.sm_lobby.tooltips.difficulty,
                    du = (0, d.Pi)(() => {
                        const u = su().model.get(),
                            e = u.difficulty,
                            t = u.isAutoCompleteCondition,
                            n = u.isSelected,
                            o = u.isLocked,
                            i = Fu.$dyn(e),
                            s = i.$dyn('info'),
                        ...
                        return a().createElement(
                            ...
                            a().createElement('div', { className: 'DifficultyTooltipApp_title_52' }, i.$dyn('title')),
                            a().createElement('div', {
                            ...
                            a().createElement('div', { className: Eu }, i.$dyn('description')),
                            a().createElement('div', { className: cu }),
                            t &&
                                a().createElement(
                                    'div',
                                    { className: 'DifficultyTooltipApp_info_9d' },
                                    a().createElement('div', { className: Au }),
                                    a().createElement(
                                        'div',
                                        { className: 'DifficultyTooltipApp_infoTitle_48' },
                                        s.$dyn('title'),
                                    ),
                                    a().createElement(eu, {
                                        classMix: 'DifficultyTooltipApp_infoBody_48',
                                        text: s.$dyn('body'),
                                    }),
                                    a().createElement('div', { className: cu }),
                                    a().createElement('div', { className: Au }),
                            ...
                            !o &&
                                a().createElement(
                                    'div',
                                    { className: r()(lu, n && 'DifficultyTooltipApp_status__selected_20') },
                                    n ? Fu.selected() : Fu.available(),
                                ),
                            o &&
                                a().createElement(
                                    'div',
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: 'DifficultyTooltipApp_lock_ed' },
                                        a().createElement('div', { className: 'DifficultyTooltipApp_iconLock_6a' }),
                                        a().createElement('div', { className: lu }, E.title()),
                                    ),
                                    a().createElement(
                                        'div',
                                        { className: r()(Eu, 'DifficultyTooltipApp_subTitle__opacity_42') },
                                        E.body(),
                                    ),
                                ),
                        );
                ...
                engine.whenReady.then(() => {
                    F().render(
                        a().createElement(au, null, a().createElement(c, null, a().createElement(du, null))),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/DifficultyTooltip/DifficultyTooltip'),
        (() => {
            var u = { 'lobby/DifficultyTooltip/DifficultyTooltip': 0 };
