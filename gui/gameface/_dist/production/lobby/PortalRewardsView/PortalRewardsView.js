(() => {
    var __webpack_modules__ = {
            ...
            1745: (u, e, t) => {
                ...
                const S = [
                        ...
                        d.GoldenTicket,
                        d.PostStamp,
                        d.BlankPersonalMissions_1,
                        d.BlankPersonalMissions_2,
                        d.SACoin,
                    ],
                    x = [d.Gold, d.Credits, d.Crystal, d.FreeXp],
                    f = [d.BattlePassPoints],
                    T = [d.PremiumPlus, d.Premium],
                        ...
                        const h = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, r.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (N(t, F, { isMouseEvent: !0, on: !0, arguments: I(a) }, b),
                                    C && C(),
                ...
                const q = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return a().createElement(j, e, r);
                        const n = e.contentId,
                            i = e.args,
                            s = null == i ? void 0 : i.contentId;
                        return n || s
                            ? a().createElement(k, Y({}, e, { contentId: n || s }), r)
                            : a().createElement(G, e, r);
                    },
                    V = {
                        base: 'Reward_base_ea',
                    ...
                    z = ({
                        ...
                        const c = ((u) => {
                            ...
                            D = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case g.CURRENCY:
                                    case g.NUMBER:
                                        return a().createElement(w, { format: 'integral', value: Number(u) });
                                    case g.PREMIUM_PLUS: {
                                        const e = Number(u);
                        ...
                        return a().createElement(
                            'div',
                            { className: m()(V.base, V[`base__${r}`], E), style: o },
                            a().createElement(
                                q,
                                { tooltipArgs: A, className: V.tooltipWrapper },
                                a().createElement(
                                    a().Fragment,
                                    null,
                                    a().createElement(
                                        'div',
                                        { className: m()(V.image, null == l ? void 0 : l.image) },
                                        c &&
                                            a().createElement('div', {
                                                className: m()(V.highlight, null == l ? void 0 : l.highlight),
                                                style: {
                                        ...
                                        e &&
                                            a().createElement('div', {
                                                className: m()(V.icon, null == l ? void 0 : l.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        F &&
                                            a().createElement('div', {
                                                className: m()(V.overlay, null == l ? void 0 : l.overlay),
                                                style: {
                            ...
                            t &&
                                a().createElement(
                                    ...
                                    { tooltipArgs: _ },
                                    a().createElement('div', {
                                        className: m()(V.timer, null == l ? void 0 : l.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const tu = s.O.client.getSize('rem'),
                    ru = tu.width,
                    au = tu.height,
                    nu = Object.assign({ width: ru, height: au }, eu(ru, au, J)),
                    iu = (0, r.createContext)(nu),
                    su = ['children'],
                    ou = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        const a = (0, r.useContext)(iu),
                            ...
                            g = { extraLarge: D, large: m, medium: d, small: B, extraSmall: C };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.mediumWidth && _) return Z(e, t, g);
                            if (t.smallWidth && c) return Z(e, t, g);
                            if (t.extraSmallWidth && F) return Z(e, t, g);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                ...
                ((ou.defaultProps = {
                    ...
                    (0, r.memo)(ou));
                const Eu = (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(iu),
                        t = (0, r.useState)(e),
                        n = t[0],
                        i = t[1],
                        o = (0, r.useCallback)((u, e) => {
                            ...
                            i(Object.assign({ width: t, height: r }, eu(t, r, J)));
                        }, []);
                    (((u) => {
                    ...
                    return a().createElement(iu.Provider, { value: E }, u);
                });
                let lu, Au, _u;
                var cu;
                (((cu = lu || (lu = {}))[(cu.ExtraSmall = J.extraSmall.width)] = 'ExtraSmall'),
                    (cu[(cu.Small = J.small.width)] = 'Small'),
                    (cu[(cu.Medium = J.medium.width)] = 'Medium'),
                    (cu[(cu.Large = J.large.width)] = 'Large'),
                    (cu[(cu.ExtraLarge = J.extraLarge.width)] = 'ExtraLarge'),
                    (function (u) {
                ...
                const Fu = () => {
                    ...
                    Du = ['xl', 'lg', 'md', 'sm', 'xs'],
                    mu = (u) => u.includes('_') && ((u) => Du.includes(u))(u.split('_').at(-1)),
                    du = [lu.ExtraLarge, lu.Large, lu.Medium, lu.Small, lu.ExtraSmall],
                    Bu = (u, e) =>
                ...
                const bu = {
                    ...
                    Su = Cu((u) => {
                        let e = u.className,
                            ...
                            P = u.shrink,
                            y = u.flex,
                            I = void 0 === y ? (O || P ? `${O ? 1 : 0} ${P ? 1 : 0} auto` : void 0) : y,
                            N = u.style,
                            k = u.children,
                            H = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const U = (0, r.useMemo)(() => {
                                const u = { mt: o, mr: l, mb: _, ml: F },
                                    e = ((u) =>
                                        vu.reduce((e, t) => {
                                            const r = u[t];
                                            return r && 'number' != typeof r ? e.concat(bu[!0 === r ? 'MD' : r][t]) : e;
                                        }, []))(u),
                                    r = ((u) =>
                                        vu.reduce((e, t) => {
                                            const r = u[t];
                            ...
                            }, [t, n, o, l, _, F, N, I, T, C, M, S, f]),
                            G = U.computedStyle,
                            W = U.computedClassNames;
                        return a().createElement('div', hu({ className: m()(gu.base, ...W, e), style: G }, H), k);
                    });
                let xu;
                !(function (u) {
                ...
                const fu = (u, e, t) => {
                    ...
                    Ru = (u, e, t = xu.left) => u.split(e).reduce(t === xu.left ? fu : Tu, []),
                    Lu = (() => {
                        const u = new RegExp(
                    ...
                    Ou = ({ binding: u, text: e = '', classMix: t, alignment: n = xu.left }) =>
                        null === e
                ...
                const Hu = Object.keys(yu()),
                    ...
                    ju = Cu((u) => {
                        ...
                        return a().createElement(
                            ...
                            ku(
                                {
                                    className: m()(Iu.base, t && Iu[t], h, n),
                                    style: p,
                                    mt: !0 === E ? Xu[t || 'paragraph-P16'].mt : E,
                                    mr: !0 === A ? Xu[t || 'paragraph-P16'].mr : A,
                                    mb: !0 === c ? Xu[t || 'paragraph-P16'].mb : c,
                                    ml: !0 === D ? Xu[t || 'paragraph-P16'].ml : D,
                                },
                                C,
                            ),
                            void 0 !== B ? a().createElement(Ou, ku({}, B, { text: e })) : e,
                        );
                    });
                function Yu(u, e) {
                ...
                const Vu = [d.TmanToken, d.PortalEventDiscount25, d.BattlaPassFinalAchievement, d.BattleBadge];
                function zu() {
                    return !1;
                }
                console.log;
                    ...
                    ue = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: n, children: i, mocks: o }) {
                                        ...
                                        const n = (function ({
                                            ...
                                            A = (({ observableModel: u }) => {
                                                const e = { root: u.object(), rewards: u.array('rewards') },
                                                    t = ((r = e.rewards.get()), Ju(r));
                                                var r;
                                                return Object.assign({}, e, { computed: { rewardsList: t } });
                                            })({
                                                mode: u,
                                                readByPath: o,
                                                externalModel: i,
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : o(e),
                                                            a = Ku.observable.box(r, { equals: zu });
                                                        return (
                                                            'real' === u &&
                                                                i.subscribe(
                                            ...
                                            _ = { mode: u, model: A, externalModel: i, cleanup: l };
                                        return {
                                            model: A,
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        A.current ? d(l(c, n, o)) : (A.current = !0);
                                    }, [o, c, n]),
                                    (0, r.useEffect)(() => {
                                        F(u);
                                    }, [u]),
                ...
                const ne = (u) => {
                        switch (u) {
                            case d.Credits:
                                return { info: m()(re, 'RewardsList_value__credits_07') };
                            case d.Crystal:
                                return { info: m()(re, 'RewardsList_value__crystal_29') };
                            default:
                                return { info: re };
                        }
                    },
                    ie = (0, F.observer)(() => {
                        const u = (function (u, e = !1) {
                            const t = Fu(),
                                r = ((u, e = !1) =>
                                    u <= lu.Small
                                        ? C.S296x222
                                        : (e ? u >= lu.Medium : u >= lu.Small) && u < lu.Large
                                          ? C.S400x300
                                          : C.S600x450)(t.remScreenWidth),
                                a =
                                    (n = t.remScreenWidth) <= lu.Small
                                        ? C.S232x174
                                        : n >= lu.Medium && n < lu.Large
                                          ? C.S296x222
                                          : C.S400x300;
                            var n;
                            const i = 3 === u.length,
                                s = u.findIndex((u) => Vu.includes(u.name));
                            if (-1 !== s) {
                                const e = u.splice(s, 1)[0],
                                    t = Math.floor(u.length / 2);
                                u.splice(t, 0, e);
                            }
                            return {
                                parsedRewards: Yu(u, (u, t) => {
                                    let n = qu({}, u);
                                    return Object.assign({}, n, {
                                        special: ((o = n), 'overlayType' in o ? o.overlayType : void 0),
                                        image: O(n, e && 1 === t && i ? r : a),
                                        size: e && 1 === t && i ? r : a,
                                        valueType:
                                            ((s = n.name),
                                            ((u) =>
                        ...
                        })(te().model.computed.rewardsList, !0).parsedRewards;
                        return a().createElement(
                            'div',
                            { className: 'RewardsList_base_c2' },
                            a().createElement(
                                'div',
                                { className: 'RewardsList_container_9d' },
                                u.map((u, e) =>
                                    a().createElement(
                                        'div',
                                        { key: e, className: 'RewardsList_reward_b6' },
                                        a().createElement(
                                            z,
                                            ae({}, u, {
                                                size: u.size,
                                                classNames: Object.assign({}, ne(u.name)),
                                                tooltipArgs: P({ tooltipId: u.tooltipId }, Number(u.tooltipContentId)),
                                            }),
                                        ),
                                        a().createElement(ju, {
                                            className: 'RewardsList_label_92',
                                            text: u.label || u.userName,
                                        }),
                                    ),
                                ),
                            ),
                    ...
                    se = (0, F.observer)(() => {
                        const u = te().model.root.get().isSpecial,
                            e = s.O.client.graphicsQuality.isLow();
                        return a().createElement(
                            'div',
                            { className: m()('BackGround_base_c6', { BackGround_base__special_5e: u }) },
                            a().createElement(
                                'div',
                                { className: 'BackGround_bgContainer_71' },
                                a().createElement('div', { className: 'BackGround_bg_70' }),
                            ),
                            a().createElement(
                                'div',
                                { className: 'BackGround_awardsContainer_d5' },
                                a().createElement(
                                    'div',
                                    { className: 'BackGround_glowContainer_6b' },
                                    a().createElement('div', {
                                        className: m()(
                                            'BackGround_gradientLine_2d',
                                            !e && 'BackGround_gradientLine__animated_65',
                                        ),
                                    }),
                                    a().createElement('div', { className: 'BackGround_glow_ea' }),
                                    a().createElement('div', { className: 'BackGround_splash_a9' }),
                                    a().createElement('div', { className: 'BackGround_bloodSequence_c7' }),
                                ),
                                a().createElement('div', { className: 'BackGround_ribbon_f7' }),
                            ),
                        );
                    });
                let oe;
                !(function (u) {
                    ((u.PROGRESSION = 'progression'),
                        (u.LAST_LEVEL_VICTORY = 'lastLevelVictory'),
                        (u.ALL_VEHICLES_UPGRADED = 'allVehiclesUpgraded'));
                })(oe || (oe = {}));
                const Ee = R.strings.portal_rewards.header.title(),
                    le = {
                        [oe.PROGRESSION]: R.strings.portal_rewards.header.subtitle.regular(),
                        [oe.LAST_LEVEL_VICTORY]: R.strings.portal_rewards.header.subtitle.maxComplexityLvl(),
                        [oe.ALL_VEHICLES_UPGRADED]: R.strings.portal_rewards.header.subtitle.maxVehicleLvl(),
                    },
                    Ae = (0, F.observer)(() => {
                        ...
                        return a().createElement(
                            'div',
                            { className: 'Header_base_44' },
                            a().createElement(
                                'div',
                                { className: 'Header_subTitleContainer_d4' },
                                a().createElement(ju, { text: Ee, className: 'Header_subTitle_a3' }),
                            ),
                            a().createElement(Ou, { text: r, classMix: 'Header_title_99', binding: { level: e } }),
                        );
                    }),
                    _e = {
                        base: 'Button_base_8d',
                ...
                const De = (0, r.memo)(
                        ({
                            ...
                            const _ = (0, r.useState)(!1),
                                ...
                                p = m()(_e.bgOverlay, _e[`bgOverlay__${l}`], {
                                    [_e.bgOverlay__hover]: B,
                                    [_e.bgOverlay__active]: F,
                                    [_e.bgOverlay__disabled]: e,
                                }),
                                h = m()(_e.bgImage, _e[`bgImage__${l}`], {
                                    [_e.bgImage__hover]: B,
                                    [_e.bgImage__active]: F,
                                    [_e.bgImage__disabled]: e,
                                }),
                                b = m()(_e.content, _e[`content__${l}`], null == A ? void 0 : A.content),
                                v = m()(_e.bgLines, _e[`bgLines__${l}`], { [_e.bgLines__disabled]: e });
                            return a().createElement(
                                'div',
                                { className: n },
                                a().createElement(
                                    ...
                                    s &&
                                        a().createElement(
                                            a().Fragment,
                                            null,
                                            a().createElement('div', { className: _e.pulseAnimatedBoxOne }),
                                            a().createElement('div', { className: _e.pulseAnimatedBoxTwo }),
                                            a().createElement('div', { className: _e.pulseAnimatedBoxThree }),
                                        ),
                                    a().createElement(
                                        'div',
                                        { className: b },
                                        o &&
                                            a().createElement('div', {
                                                className: m()(_e.btnIcon, _e.btnIcon__left),
                                                style: { backgroundImage: `url(${o})` },
                                            }),
                                        a().createElement(ju, { text: u }),
                                        i &&
                                            a().createElement('div', {
                                                className: m()(_e.btnIcon, _e.btnIcon__right),
                    ...
                    me = ({ onClick: u, text: e, classes: t }) => {
                        ...
                        return a().createElement(
                            'div',
                            { onClick: u, onMouseEnter: o, onMouseLeave: o, className: 'DefaultCloseButton_base_bf' },
                            a().createElement('div', { className: 'DefaultCloseButton_shine_e1' }),
                            a().createElement(ju, {
                                className: m()('DefaultCloseButton_text_1d', null == t ? void 0 : t.text),
                                text: e,
                            }),
                            a().createElement(
                                'div',
                                { className: m()('DefaultCloseButton_icon_28', null == t ? void 0 : t.icon) },
                    ...
                    de = (0, F.observer)(() => {
                        const u = (function ({
                            ...
                            e = te().controls,
                            t = Fu().mediaSize === lu.ExtraLarge ? ce.ExtraLarge : ce.Medium;
                        var n;
                        return (
                            (0, r.useEffect)(() => {
                                _('pr_reward_screen');
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { className: 'App_content_3c' },
                                    a().createElement(
                                        'div',
                                        { className: 'App_buttonClose_30' },
                                        a().createElement(me, {
                                            onClick: u,
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: 'App_header_eb' },
                                        a().createElement(Ae, null),
                                    ),
                                    a().createElement(
                                        'div',
                                        { className: 'App_awards_61' },
                                        a().createElement(ie, null),
                                    ),
                                    a().createElement(De, {
                                        className: 'App_button_ff',
                                        onClick: e.approve,
                                        title: R.strings.portal_rewards.button.approve(),
                                        size: t,
                                        classes: { content: 'App_buttonContent_c4' },
                                    }),
                                ),
                            )
                        );
                ...
                const he = {
                        [Au.ExtraSmall]: '',
                        [Au.Small]: Ce().SMALL_WIDTH,
                        [Au.Medium]: `${Ce().SMALL_WIDTH} ${Ce().MEDIUM_WIDTH}`,
                        [Au.Large]: `${Ce().SMALL_WIDTH} ${Ce().MEDIUM_WIDTH} ${Ce().LARGE_WIDTH}`,
                        [Au.ExtraLarge]: `${Ce().SMALL_WIDTH} ${Ce().MEDIUM_WIDTH} ${Ce().LARGE_WIDTH} ${Ce().EXTRA_LARGE_WIDTH}`,
                    },
                    be = {
                        [_u.ExtraSmall]: '',
                        [_u.Small]: Ce().SMALL_HEIGHT,
                        [_u.Medium]: `${Ce().SMALL_HEIGHT} ${Ce().MEDIUM_HEIGHT}`,
                        [_u.Large]: `${Ce().SMALL_HEIGHT} ${Ce().MEDIUM_HEIGHT} ${Ce().LARGE_HEIGHT}`,
                        [_u.ExtraLarge]: `${Ce().SMALL_HEIGHT} ${Ce().MEDIUM_HEIGHT} ${Ce().LARGE_HEIGHT} ${Ce().EXTRA_LARGE_HEIGHT}`,
                    },
                    ve = {
                        [lu.ExtraSmall]: '',
                        [lu.Small]: Ce().SMALL,
                        [lu.Medium]: `${Ce().SMALL} ${Ce().MEDIUM}`,
                        [lu.Large]: `${Ce().SMALL} ${Ce().MEDIUM} ${Ce().LARGE}`,
                        [lu.ExtraLarge]: `${Ce().SMALL} ${Ce().MEDIUM} ${Ce().LARGE} ${Ce().EXTRA_LARGE}`,
                    },
                    we = (u) => {
                        let e = u.children,
                            t = u.className,
                        ...
                        const n = Fu(),
                            ...
                            s = n.mediaHeight,
                            o = n.mediaSize;
                        return a().createElement('div', pe({ className: m()(t, he[i], be[s], ve[o]) }, r), e);
                    },
                    Se = ['children'],
                    xe = (u) => {
                        let e = u.children,
                        ...
                        return a().createElement(Eu, null, a().createElement(we, t, e));
                    };
                engine.whenReady.then(() => {
                    i().render(
                        a().createElement(ee, null, a().createElement(xe, null, a().createElement(de, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1745));
