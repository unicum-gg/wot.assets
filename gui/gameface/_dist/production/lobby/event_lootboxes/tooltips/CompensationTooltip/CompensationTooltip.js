(() => {
    ...
    var __webpack_modules__ = {
            ...
            491: (u, e, t) => {
                t.d(e, { Sw: () => F.Z, B3: () => r.B3, Z5: () => A.Z5, ry: () => i.ry });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            72: (u, e, t) => {
                ...
                const i = (u) => ({ __Type: 'GFBoundingBox', x: u.x, y: u.y, width: u.width, height: u.height }),
                    ...
                    d = () => viewEnv.isWindowShownByViewEvent(F.B0.TOOLTIP),
                    _ = () => viewEnv.isWindowShownByViewEvent(F.B0.CONTEXT_MENU),
            ...
            286: (u, e, t) => {
                                                ...
                                                const e = c(),
                                                    ...
                                                    E =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: E, modelPath: _(E, ''), resId: n };
                                            })(),
                                            t = e.modelPrefix,
                                            n = u.split('.');
                                        if (n.length > 0) {
                ...
                const b = ['', 'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X'],
                    f = (u) => {
                        switch (u) {
                            case g.Heavy:
                    ...
                    y = 'Content_border_d3',
                    T = R.strings.event_lootboxes.compensationTooltip,
                    O = () => {
                        const u = w('model'),
                            e = u.vehicleType,
                            t = u.compensationValue,
                            F = u.iconBefore,
                            A = u.vehicleLevel,
                            r = u.vehicleName,
                            o = i()(y, 'Content_border__top_76'),
                            a = i()(y, 'Content_border__bot_5e'),
                            s = (0, n.useMemo)(() => ({ backgroundImage: `url(${f(e)})` }), [e]),
                            D = (0, n.useMemo)(() => ({ backgroundImage: `url(${F})` }), [F]);
                        return E().createElement(
                            'div',
                            { className: 'Content_base_2d' },
                            E().createElement(
                                'div',
                                { className: 'Content_vehicle_c8' },
                                E().createElement('div', { className: 'Content_vehicleTitle_21' }, T.contentTitle()),
                                F && E().createElement('div', { className: 'Content_vehicleIcon_2f', style: D }),
                                E().createElement(
                                    'div',
                                    { className: 'Content_vehicleName_da' },
                                    E().createElement('div', { className: 'Content_vehicleNameLevel_1d' }, b[A] || ''),
                                    E().createElement('div', { className: 'Content_vehicleNameType_05', style: s }),
                                    E().createElement('div', { className: 'Content_vehicleNameText_a5' }, r),
                                ),
                            ),
                            E().createElement(
                                'div',
                                { className: 'Content_compensation_07' },
                                E().createElement(
                                    'div',
                                    { className: 'Content_compensationTitle_2a' },
                                    T.contentDescription(),
                                ),
                                E().createElement('div', { className: 'Content_compensationIcon_d7' }),
                                E().createElement(
                                    'div',
                                    { className: 'Content_compensationCount_b8' },
                                    E().createElement(p, { value: t }),
                                ),
                            ),
                            E().createElement('div', { className: 'Content_baseBackground_1b' }),
                            E().createElement('div', { className: 'Content_compensationArrow_ae' }),
                            E().createElement('div', { className: o }),
                            E().createElement('div', { className: a }),
                        );
                    },
                    P = R.strings.event_lootboxes.compensationTooltip,
                    k = () =>
                        E().createElement(
                            'div',
                            { className: 'Header_base_5b' },
                            E().createElement('div', { className: 'Header_title_50' }, P.title.gold()),
                            E().createElement('div', { className: 'Header_description_2a' }, P.description()),
                        ),
                    S = () =>
                        E().createElement(
                            'div',
                            { className: 'Footer_base_a0' },
                            E().createElement('div', { className: 'Footer_icon_4c' }),
                            E().createElement(
                                'div',
                                { className: 'Footer_text_6b' },
                                R.strings.event_lootboxes.compensationTooltip.footerDetails(),
                            ),
                        ),
                    x = () =>
                        E().createElement(
                            'div',
                            { className: 'App_base_54' },
                            E().createElement(k, null),
                            E().createElement(O, null),
                            E().createElement(S, null),
                        );
                engine.whenReady.then(() => {
                    A().render(E().createElement(B, null, E().createElement(x, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(286));
