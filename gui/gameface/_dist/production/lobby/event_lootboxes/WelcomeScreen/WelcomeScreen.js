    ...
    var __webpack_modules__ = {
            ...
            649: (u, e, t) => {
                ...
                const i = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    A = (u, e, t = r.left) => u.split(e).reduce(t === r.left ? E : o, []),
                    s = (() => {
                        const u = new RegExp(
                                          ...
                                          : 'ja' === t
                                            ...
                                            : ((u, e = r.left) => {
                                                  ...
                                                  const n =
                                                      ...
                                                      a = i(u);
                                                  return (
                                                      A(a, /( )/, e).forEach((u) => (t = t.concat(A(u, n, r.left)))), t
                                                  );
                                              })(u, e);
                                  })(u, e),
                        );
            ...
            491: (u, e, t) => {
                'use strict';
                t.d(e, { Sw: () => a.Z, B0: () => E.B0, ry: () => o.ry, Sy: () => o.Sy });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            251: (u, e, t) => {
                'use strict';
                let n;
                t.d(e, { B0: () => n, B3: () => r, Gr: () => a, kH: () => E, lf: () => i }),
                    (function (u) {
            ...
            72: (u, e, t) => {
                ...
                const o = (u) => ({ __Type: 'GFBoundingBox', x: u.x, y: u.y, width: u.width, height: u.height }),
                    ...
                    D = () => F(a.B0.CLOSE),
                    c = () => F(a.B0.POP_OVER, { on: !1 }),
                    B = (u, e, t = 0) => {
                        F(a.B0.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                    },
                    C = (u, e, t, n, i = R.invalid('resId'), E) => {
                        const A = r.O.view.getViewGlobalPosition(),
                            ...
                            B = s.height,
                            C = {
                                x: r.O.view.pxToRem(l) + A.x,
                                y: r.O.view.pxToRem(D) + A.y,
                    ...
                    _ = () => viewEnv.isWindowShownByViewEvent(a.B0.CONTEXT_MENU),
            ...
            584: (u, e, t) => {
                    ...
                    h = ({ children: u }) => {
                        const e = (0, n.useContext)(C),
                            ...
                            E = (0, n.useCallback)((u, e) => {
                                ...
                                i(Object.assign({ width: t, height: n }, F(t, n, A)));
                            }, []),
                            s = (0, n.useCallback)(() => {
                        ...
                        m(() => {
                            o.O.client.events.on('clientResized', E), o.O.client.events.on('self.onScaleUpdated', s);
                        }),
                            (0, n.useEffect)(
                                () => () => {
                                    o.O.client.events.off('clientResized', E),
                                        o.O.client.events.off('self.onScaleUpdated', s);
                                },
                                [E, s],
                            );
                ...
                const S = {
                    ...
                    O = (u) => {
                        ...
                        const i = (() => {
                            ...
                            o = i.mediaHeight,
                            A = i.mediaSize;
                        return r().createElement('div', T({ className: v()(t, S[E], y[o], M[A]) }, a), e);
                    },
                    k = ['children'],
                    H = (u) => {
                        let e = u.children,
                        ...
                        return r().createElement(h, null, r().createElement(O, t, e));
                    },
                    P = (u = 1) => {
                    ...
                    return (
                        m(() => {
                            if (
                                ...
                                l.current = U.addCallback(n, t, E, e === $.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== $.None)
                                return () => {
                                    U.removeCallback(l.current, E);
                                };
                        }, [E, e]),
                        s
                    );
                ...
                var j = t(649),
                    z = t(613);
                Date.now();
                const K = z.Ew.getRegionalDateTime,
                    q = z.Ew.getFormattedDateTime;
                var Y = t(776),
                    Z = t(865),
                    X = t(727);
                const Q = {
                        ...
                        r().createElement(
                            'div',
                            {
                                ...
                                className: v()(
                                    ...
                                    e && Q[`base__${e}`],
                                    _ && Q.base__focus,
                                    g && Q.base__highlightActive,
                                    E,
                                ),
                                onMouseEnter: function (u) {
                                    i || (null !== o && (0, X.G)(o), s && s(u));
                                },
                            ...
                            r().createElement(
                                'span',
                                { className: v()(Q.state, Q.state__default) },
                        ...
                        const v = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, n.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (au(t, c, { isMouseEvent: !0, on: !0, arguments: ru(r) }, w),
                                    m && m(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((v.current.timeoutId = window.setTimeout(f, s ? 100 : 400)),
                                                          a && a(u),
                                                          x && x(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                ...
                const Au = R.views.common.tooltip_window.simple_tooltip_content,
                    ...
                    Fu = R.strings.event_lootboxes.welcomeScreen,
                    lu = ({ isBuyAvailable: u, onBuy: e, useExternalShop: t }) => {
                        const a = (0, n.useState)(!1),
                            i = a[0],
                            E = a[1],
                            o = (0, n.useCallback)(() => E(!0), [E]),
                            A = (0, n.useCallback)(() => E(!1), [E]),
                            s = v()('Footer_shine_26', i && 'Footer_shine__focused_0c');
                        return r().createElement(
                            'div',
                            { className: 'Footer_base_1b' },
                            r().createElement('div', { className: s }),
                            r().createElement(
                                su,
                                { isEnabled: !u, body: Fu.button.tooltip.alert() },
                                r().createElement(
                                    'div',
                                    null,
                                    r().createElement(
                                        tu,
                                        {
                                            type: J.main,
                                            size: uu.medium,
                                            mixClass: 'Footer_button_09',
                                            disabled: !u,
                                            onClick: e,
                                            onMouseEnter: o,
                                            onMouseLeave: A,
                                        },
                                        R.strings.event_lootboxes.welcomeScreen.footer.buttonText(),
                                        t && r().createElement('div', { className: 'Footer_buttonIcon_15' }),
                                    ),
                                ),
                            ),
                        );
                ...
                const cu = (0, n.memo)(({ datetime: u, format: e = Du.ShortDate, isConvertedToLocal: t = !0 }) =>
                        Object.values(Du).includes(e) ? K(u, e, t) : q(u, e, t),
                    ),
                    Bu = ({
                        binding: u,
                        text: e = '',
                        classMix: t,
                        alignment: a = j.v2.left,
                        formatWithBrackets: i,
                    }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const E = i && u ? (0, j.WU)(e, u) : e;
                        return r().createElement(
                            n.Fragment,
                            null,
                            E.split('\n').map((e, i) =>
                                r().createElement(
                                    'div',
                                    { className: v()('FormatText_base_d0', t), key: `${e}-${i}` },
                    ...
                    Cu = {
                        base: 'ContentItem_base_f0',
                        image: 'ContentItem_image_0d',
                        base__guaranteedReward: 'ContentItem_base__guaranteedReward_88',
                        base__stuff: 'ContentItem_base__stuff_53',
                        base__limit: 'ContentItem_base__limit_f2',
                        title: 'ContentItem_title_5f',
                        description: 'ContentItem_description_9a',
                    },
                    du = (0, n.memo)(({ name: u, title: e, description: t, descriptionBinding: n }) => {
                        const a = v()(Cu.base, Cu[`base__${u}`]);
                        return r().createElement(
                            'div',
                            { className: a },
                            r().createElement('div', { className: Cu.image }),
                            r().createElement('span', { className: Cu.title }, e),
                            n
                                ? r().createElement(Bu, { classMix: Cu.description, text: t, binding: n })
                                : r().createElement('span', { className: Cu.description }, t),
                        );
                    });
                function _u() {
                    return (
                ...
                const mu = R.strings.event_lootboxes.welcomeScreen.content,
                    hu = ({ dailyBoxesCount: u, endDate: e, guaranteedText: t }) => {
                        const a = (0, n.useMemo)(
                            () => [
                                { name: 'guaranteedReward', title: mu.guaranteedTitle(), description: t },
                                {
                                    name: 'stuff',
                                    title: mu.stuffTitle(),
                                    description: mu.stuffText(),
                                    descriptionBinding: {
                                        preview: r().createElement(
                                            iu,
                                            {
                                                contentId:
                                            ...
                                            r().createElement(
                                                'div',
                                                { className: 'Content_preview_ce' },
                                                R.strings.event_lootboxes.welcomeScreen.content.stuffPreview(),
                                                r().createElement('div', { className: 'Content_previewIcon_6e' }),
                                            ),
                                        ),
                                    },
                                },
                                {
                                    name: 'limit',
                                    title: mu.limitTitle(),
                                    description: mu.limitText(),
                                    descriptionBinding: {
                                        date: r().createElement(
                                            'span',
                                            null,
                                            r().createElement(Bu, {
                                                text: mu.limitTextDate(),
                                                binding: {
                                                    date: r().createElement(cu, { datetime: e, format: Du.FullDate }),
                                                },
                                            }),
                                        ),
                                        count: r().createElement('span', null, u),
                                    },
                                },
                            ],
                            [u, e, t],
                        ...
                        return r().createElement(
                            'div',
                            { className: 'Content_base_e6' },
                            a.map((u) => r().createElement(du, _u({ key: u.name }, u))),
                        );
                    },
                    gu = () => {
                        const u = V('model'),
                            ...
                            A = u.onClose,
                            s = u.useExternalShop,
                            F = (0, n.useCallback)(() => o(), [o]),
                            l = (0, n.useCallback)(() => A(), [A]);
                        return r().createElement(
                            'div',
                            { className: 'App_base_b2' },
                            r().createElement(Z.d, { onCloseCallback: l }),
                            r().createElement(Y.h, { timeLeftMs: 1e3 * t }),
                            r().createElement(hu, { dailyBoxesCount: e, endDate: a, guaranteedText: E }),
                            r().createElement(lu, { isBuyAvailable: i, onBuy: F, useExternalShop: s }),
                        );
                    };
                engine.whenReady.then(() => {
                    i().render(
                        r().createElement(H, null, r().createElement(gu, null)),
            ...
            865: (u, e, t) => {
                ...
                class l extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            d = E()(A.base, A[`base__${i}`], A[`base__${a}`], null == o ? void 0 : o.base),
                            _ = E()(A.icon, A[`icon__${i}`], A[`icon__${a}`], null == o ? void 0 : o.icon),
                            m = E()(A.glow, null == o ? void 0 : o.glow),
                            h = E()(A.caption, A[`caption__${i}`], null == o ? void 0 : o.caption),
                            g = E()(A.goto, null == o ? void 0 : o.goto);
                        return r().createElement(
                            'div',
                            F(
                                {
                            ...
                            r().createElement('div', { className: _ }, r().createElement('div', { className: m })),
                ...
                function C(u = c.n.NONE, e = B, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== c.n.NONE)
                            return (
                        ...
                        function n(n) {
                            if (n.keyCode === u) {
                                if (!r && D.O.view.isEventHandled()) return;
            ...
            776: (u, e, t) => {
                ...
                const o = 36e5,
                    ...
                    s =
                        ...
                        'Header_base_16'),
                    F = R.strings.event_lootboxes.welcomeScreen.header,
                    l = ({ timeLeftMs: u }) => {
                        const e = ((
                            u,
                            {
                                daysLeftText: e = R.strings.event_lootboxes.welcomeScreen.header.daysLeftText(),
                                hoursLeftText: t = R.strings.event_lootboxes.welcomeScreen.header.hoursLeftText(),
                                lessHourLeftText: n = R.strings.event_lootboxes.welcomeScreen.header.lessHourLeftText(),
                            } = {},
                        ) => {
                            if (u >= A) {
                                const t = Math.trunc(u / A);
                                return (0, a.WU)(e, { daysLeft: t });
                            }
                            if (u > o) {
                                const e = Math.trunc(u / o);
                                return (0, a.WU)(t, { hoursLeft: e });
                            }
                            return n;
                        })(u);
                        return r().createElement(
                            'div',
                            { className: s },
                            r().createElement('span', { className: 'Header_title_18' }, F.title()),
                            r().createElement(
                                'span',
                                { className: 'Header_timer_99' },
                                r().createElement('span', { className: 'Header_timerIcon_78' }),
                                r().createElement('span', { className: 'Header_timerText_ad' }, e),
                            ),
                        );
                    };
            },
