    ...
    var __webpack_modules__ = {
            ...
            6029: (e, u, t) => {
                ...
                const ln = {
                    ...
                    cn = ({
                        ...
                        return (l = {}) => {
                            ...
                            return (0, a.useMemo)(
                                ...
                                [D.scrollPosition, h, B, b, d.off, d.on, v, p, C, E.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    En = cn({
                                        ...
                                        if (i.current && s.current && l.current && c.current) {
                                            if (0 === e)
                                                return (
                                                    ...
                                                    void s.current.classList.remove(gn)
                                                );
                                            if (
                                                ((u = l.current),
                                                (t = c.current),
                                                ...
                                                return (
                                                    ...
                                                    void s.current.classList.add(gn)
                                                );
                                            var u, t;
                    ...
                    wn = ({ api: e, className: u, classNames: t, children: n, style: r }) => (
                        (0, a.useEffect)(() => Qt(e.recalculateContent)),
                        o().createElement(
                            'div',
                            { className: p()(bn.base, u), style: r },
                            o().createElement(
                                'div',
                                {
                                        ...
                                        if (i.current && s.current && l.current && c.current) {
                                            if (0 === e)
                                                return (
                                                    ...
                                                    void s.current.classList.remove(Nn)
                                                );
                                            if (
                                                ((u = l.current),
                                                (t = c.current),
                                                ...
                                                return (
                                                    ...
                                                    void s.current.classList.add(Nn)
                                                );
                                            var u, t;
                            ...
                            (0, a.useEffect)(() => {
                                if (n.index >= 0 && i) {
                                    ...
                                    return Pe(() => {
                                        ...
                                        return Pe(() => {
                                            (n.end === u ? (F(!1), m(!0)) : g(!0),
                                                W(R.sounds.comp_7_progressbar_stop()));
                                        }, t);
                                    }, e);
                                }
                            }, [n, i, u]);
