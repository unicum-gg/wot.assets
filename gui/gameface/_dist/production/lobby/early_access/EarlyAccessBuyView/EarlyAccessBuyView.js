    ...
    var __webpack_modules__ = {
            ...
            6026: (e, u, t) => {
                ...
                const L = {
                    ...
                    P = (e) => {
                        ...
                        const n = x(),
                            ...
                            i = n.mediaHeight,
                            s = n.mediaSize;
                        return o().createElement('div', T({ className: p()(t, L[a], k[i], M[s]) }, r), u);
                    },
                    N = ['children'];
                const O = (e) => {
                    let u = e.children,
                ...
                const ke = (e, u, t) => {
                    ...
                    Pe = (e, u, t = Te.left) => e.split(u).reduce(t === Te.left ? ke : Me, []),
                    Ne = (() => {
                        const e = new RegExp(
                        ...
                        return Re.includes(t)
                            ...
                            : ((e, u = Te.left) => {
                                  ...
                                  const r =
                                      ...
                                      n = e.replace(/&nbsp;/g, ' ');
                                  return (Pe(n, /( )/, u).forEach((e) => (t = t.concat(Pe(e, r, Te.left)))), t);
                              })(e, u);
                    },
                ...
                const pt = nt({
                    ...
                    Rt = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Mt, onDrag: r = Lt }) => {
                        const n = (0, a.useRef)(null),
                            i = (0, a.useRef)(null),
                            s = (0, a.useRef)(null),
                            l = (0, a.useRef)(null),
                                ...
                                ((t.style.transform = `translateY(${0 | _}px)`),
                                    ((e) => {
                                        if (i.current && s.current && l.current && c.current) {
                                            if (0 === e)
                                                return (
                                                    i.current.classList.add(Tt),
                                                    void s.current.classList.remove(Tt)
                                                );
                                            if (
                                                ((u = l.current),
                                                (t = c.current),
                                                ...
                                                return (
                                                    i.current.classList.remove(Tt),
                                                    void s.current.classList.add(Tt)
                                                );
                                            var u, t;
                ...
                const $r = 150,
                    ...
                    Zr = ({
                        ...
                        return o().createElement(
                            ...
                            o().createElement('div', { className: p()(lr, !T && cr), style: { width: `${k}rem` } }),
                        );
                    };
                t(3368);
