    ...
    var __webpack_modules__ = {
            ...
            6026: (e, u, t) => {
                ...
                const T = {
                    ...
                    M = (e) => {
                        ...
                        const n = x(),
                            ...
                            i = n.mediaHeight,
                            s = n.mediaSize;
                        return o().createElement('div', L({ className: p()(t, T[a], k[i], P[s]) }, r), u);
                    },
                    N = ['children'];
                const O = (e) => {
                    let u = e.children,
                ...
                const ke = (e, u, t) => {
                    ...
                    Me = (e, u, t = Le.left) => e.split(u).reduce(t === Le.left ? ke : Pe, []),
                    Ne = (() => {
                        const e = new RegExp(
                        ...
                        return Re.includes(t)
                            ...
                            : ((e, u = Le.left) => {
                                  ...
                                  const r =
                                      ...
                                      n = e.replace(/&nbsp;/g, ' ');
                                  return (Me(n, /( )/, u).forEach((e) => (t = t.concat(Me(e, r, Le.left)))), t);
                              })(e, u);
                    },
                                        ...
                                        if (i.current && s.current && l.current && c.current) {
                                            if (0 === e)
                                                return (
                                                    ...
                                                    void s.current.classList.remove(dt)
                                                );
                                            if (
                                                ((u = l.current),
                                                (t = c.current),
                                                ...
                                                return (
                                                    ...
                                                    void s.current.classList.add(dt)
                                                );
                                            var u, t;
                ...
                const pt = nt({
                    ...
                    Rt = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Pt, onDrag: r = Tt }) => {
                        const n = (0, a.useRef)(null),
                            i = (0, a.useRef)(null),
                            s = (0, a.useRef)(null),
                            l = (0, a.useRef)(null),
                                ...
                                ((t.style.transform = `translateY(${0 | _}px)`),
                                    ((e) => {
                                        if (i.current && s.current && l.current && c.current) {
                                            if (0 === e)
                                                return (
                                                    i.current.classList.add(Lt),
                                                    void s.current.classList.remove(Lt)
                                                );
                                            if (
                                                ((u = l.current),
                                                (t = c.current),
                                                ...
                                                return (
                                                    i.current.classList.remove(Lt),
                                                    void s.current.classList.add(Lt)
                                                );
                                            var u, t;
