(() => {
    var __webpack_modules__ = {
            ...
            6026: (e, u, t) => {
                ...
                var n = {};
                t.r(n), t.d(n, { Area: () => It, Bar: () => Rt, Default: () => Ht, useVerticalScrollApi: () => pt });
                var a = t(6179),
                    o = t.n(a);
                const i = (e, u, t) =>
                ...
                const T = {
                    ...
                    P = (e) => {
                        ...
                        const n = x(),
                            ...
                            i = n.mediaHeight,
                            s = n.mediaSize;
                        return o().createElement('div', L({ className: p()(t, T[a], k[i], M[s]) }, r), u);
                    },
                    N = ['children'];
                const O = (e) => {
                    let u = e.children,
                ...
                ie.defaultProps = { type: ae.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                ...
                const we = {
                    ...
                    ye = pe((e) => {
                        let u = e.className,
                            ...
                            L = e.wrap,
                            T = e.flexWrap,
                            k = void 0 === T ? (L ? 'wrap' : void 0) : T,
                            M = e.grow,
                            P = e.shrink,
                            N = e.flex,
                            R = void 0 === N ? (M || P ? `${M ? 1 : 0} ${P ? 1 : 0} auto` : void 0) : N,
                            O = e.style,
                            H = e.children,
                            I = (function (e, u) {
                                if (null == e) return {};
                        ...
                        return o().createElement('div', be({ className: p()(ve.base, ...G, u), style: V }, I), H);
                    });
                let Le;
                function Te(e) {
                ...
                const ke = (e, u, t) => {
                    ...
                    Pe = (e, u, t = Le.left) => e.split(u).reduce(t === Le.left ? ke : Me, []),
                    Ne = (() => {
                        const e = new RegExp(
                        ...
                        return Re.includes(t)
                            ...
                            : ((e, u = Le.left) => {
                                  ...
                                  const r =
                                      ...
                                      n = e.replace(/&nbsp;/g, ' ');
                                  return Pe(n, /( )/, u).forEach((e) => (t = t.concat(Pe(e, r, Le.left)))), t;
                              })(e, u);
                    },
                    He = 'FormatText_base_d0',
                    Ie = ({ binding: e, text: u = '', classMix: t, alignment: r = Le.left }) =>
                        null === u
                ...
                const fu = ({ onClose: e }) => {
                    ...
                    Lu = 'InfoLinkWithBackButton_base_1e',
                    Tu = 'InfoLinkWithBackButton_backButton_f7',
                    ku = R.strings.early_access.header,
                    Mu = ({ nation: e, onAbout: u, onBack: t }) =>
                        o().createElement(
                            'div',
                            { className: Lu },
                    ...
                    Pu = (e) => e.split(' ').splice(0, 2).join(' ').toLocaleUpperCase(),
                    Nu = 'MainText_base_a4',
                    ...
                    Uu = ({ className: e, featureState: u, fromTimestamp: t, toTimestamp: r, titleText: n }) => {
                        const i = u !== pu.POST_PROGRESSION && u !== pu.BUY,
                            s = i ? Pu(U.Z5.getDateFormat(t, 1)) : void 0,
                            l = Pu(U.Z5.getDateFormat(r, 1)),
                            c = p()(e && e, Nu),
                            E = (0, a.useMemo)(
                                () =>
                                    o().createElement(Qe, {
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    'div',
                                    ju({ className: Su }, E),
                                    o().createElement(Mu, { nation: l, onAbout: i, onBack: s }),
                                ),
                                o().createElement(Uu, {
                                    className: xu,
                                    featureState: t,
                ...
                const rt = {
                    ...
                    Ct = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = At, onDrag: r = Ft }) => {
                    ...
                    ht = ({ api: e, className: u, classNames: t, children: r }) => (
                ...
                const pt = nt({
                    ...
                    Rt = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Mt, onDrag: r = Tt }) => {
                        const n = (0, a.useRef)(null),
                            i = (0, a.useRef)(null),
                            s = (0, a.useRef)(null),
                            l = (0, a.useRef)(null),
                            ...
                            D = Yu(() => {
                                ...
                                (t.style.transform = `translateY(${0 | _}px)`),
                                    ((e) => {
                                        if (i.current && s.current && l.current && c.current) {
                                            if (0 === e)
                                                return i.current.classList.add(Lt), void s.current.classList.remove(Lt);
                                            if (
                                                ((u = l.current),
                                                (t = c.current),
                                                e - (u.offsetHeight - t.offsetHeight) >= -0.5)
                                            )
                                                return i.current.classList.remove(Lt), void s.current.classList.add(Lt);
                                            var u, t;
                                            i.current.classList.remove(Lt), s.current.classList.remove(Lt);
                                        }
                                    })(_);
                            }),
                            C = Yu(() => {
                        ...
                        const v = (e) => {
                            e.target.classList.contains(Lt) || te('highlight');
                        };
                        return o().createElement(
                            'div',
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Lt) || 0 !== e.button || (te('play'), g(tt.Next));
                                },
                                ref: i,
                                onMouseEnter: v,
                            }),
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Lt) || 0 !== e.button || (te('play'), g(tt.Prev));
                                },
                                onMouseUp: h,
                                ref: s,
                                onMouseEnter: v,
                ...
                const gr = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    br = (0, a.memo)(({ vehicleData: e, isLast: u, isSelected: t }) => {
                        const r = e.state === Gt.Locked || e.state === Gt.InProgress,
                            ...
                            i = `${Te(e.type)}${e.isPremium ? '_elite' : ''}`,
                            ...
                            E = fr.shop.vehicles.c_180x135.$dyn(Te(e.techName)),
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement('div', { className: p()(pr.strokeBorder, pr.strokeBorder__left) }),
                                o().createElement('div', { className: pr.stroke }),
                                o().createElement('div', { className: p()(pr.strokeBorder, pr.strokeBorder__right) }),
                            ),
                        );
                    }),
                    ...
                    Lr = 'VehicleProgress_progress__done_27',
                    Tr = 'VehicleProgress_shadow_28',
                    kr = 'VehicleProgress_shadow__done_e9',
                    Mr = 'VehicleProgress_progressShadow_f3',
                    Pr = 'VehicleProgress_progressLine_f0',
                    ...
                    jr = (0, a.memo)(({ progressData: e, classNames: u, isSelected: t }) => {
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                'div',
                                { className: xr },
                                o().createElement('div', { className: p()(Tr, n && kr) }),
                                o().createElement('div', { className: p()(yr, n && Lr) }),
                                s && o().createElement('div', { className: Mr, style: { width: `${l}%` } }),
                                a > 0 &&
                                    o().createElement('div', {
                                        className: Pr,
                                ...
                                i > 0 &&
                                    o().createElement('div', { className: p()(Pr, Nr), style: { width: `${i}%` } }),
                            ),
                            o().createElement(
                                'div',
                                { className: Rr },
                    ...
                    Zr = ({
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                M && o().createElement('div', { className: Xt }),
                                o().createElement(Qe, {
                                    className: Kt,
                                    text: y,
                                    format: {
                                ...
                                M && o().createElement('div', { className: f }),
                            ),
                            o().createElement(
                                'div',
                                { className: tr },
                            ...
                            o().createElement('div', { className: p()(lr, !L && cr), style: { width: `${k}rem` } }),
                        );
                    };
                t(3368);
                ...
                const en = (0, a.memo)((e) => {
                    ...
                    Ln = 'VehicleContent_infoIcon_25',
                    Tn = 'VehicleContent_vehicleTokens_e7',
                    ...
                    Pn = { base: 'App_base_76', slideDown: 'App_slideDown_87' },
                    Nn = (0, V.Pi)(() => {
                        const e = ue(),
                            u = e.controls,
                            t = e.model.root.get(),
                        ...
                        return (
                            ...
                            o().createElement(
                                'div',
                                { className: p()(Pn.base, D && Pn.base__centered) },
                                r === W.Fail &&
                                    o().createElement(Mn, {
                                        tokenPreview: m,
                                        tokenNeed: F,
