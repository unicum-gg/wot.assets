    ...
    var u,
        e = {
            ...
            6586: (u, e, A) => {
                ...
                const uu = Object.keys(S).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === S[e]), u), {}),
                    eu = {
                        set: (u, e) => {
                ...
                const ru = Fu.client.getSize('rem'),
                    Bu = ru.width,
                    au = ru.height,
                ...
                (0, r.memo)(({ children: u }) => {
                    ...
                    return B().createElement(iu.Provider, { value: D }, u);
                });
                let ou, su, du;
                (!(function (u) {
                ...
                const gu = () => {
                    ...
                    hu = [ou.ExtraLarge, ou.Large, ou.Medium, ou.Small, ou.ExtraSmall],
                    xu = (u, e) =>
                ...
                const wu = {
                    ...
                    Mu = pu((u) => {
                        ...
                        const X = (0, r.useMemo)(() => {
                                const u = { mt: D, mr: n, mb: l, ml: o },
                                    e = ((u) =>
                                        bu.reduce((e, A) => {
                                            const F = u[A];
                                            return F && 'number' != typeof F ? e.concat(wu[!0 === F ? 'MD' : F][A]) : e;
                                        }, []))(u),
                                    E = ((u) =>
                                        bu.reduce((e, A) => {
                                            const F = u[A];
                                            return ('number' == typeof F && (e[Lu[A]] = F + 'rem'), e);
                                        }, {}))(u);
                                return {
                        ...
                        return B().createElement('div', Su({ className: C()(fu.base, ...z, e), style: j }, N), G);
                    });
                let Ru;
                !(function (u) {
                ...
                const Tu = (u, e, A) => {
                    ...
                    yu = (u, e, A = Ru.left) => u.split(e).reduce(A === Ru.left ? Tu : Hu, []),
                    Ou = (() => {
                        const u = new RegExp(
                        ...
                        return Pu.includes(A)
                            ...
                            : ((u, e = Ru.left) => {
                                  ...
                                  const F =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (yu(E, /( )/, e).forEach((u) => (A = A.concat(yu(u, F, Ru.left)))), A);
                              })(u, e);
                    },
                    Gu = 'FormatText_base_d0',
                    Nu = ({ binding: u, text: e = '', classMix: A, alignment: F = Ru.left }) =>
                        null === e
                            ...
                            : B().createElement(
                                  ...
                                  e.split('\n').map((e, E) =>
                                      B().createElement(
                                          'div',
                                          { className: C()(Gu, A), key: `${e}-${E}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : Wu(u, e))))(e, F, u).map((u, e) =>
                ...
                const Vu = Object.keys(ju()),
                    ...
                    Zu = pu((u) => {
                        ...
                        return B().createElement(
                            ...
                            ku(
                                {
                                    className: C()(zu.base, A && zu[A], x, F),
                                    style: h,
                            ...
                            void 0 !== g ? B().createElement(Nu, ku({}, g, { text: e })) : e,
                        );
                    }),
                    Ju = 'App_base_ec',
                    ue = 'App_baseBackground_64',
                    ee = 'App_title_06',
                    Ae = 'App_description_3b',
                    Fe = R.strings.early_access.entryPoint.postProgressionDisabledTooltip,
                    Ee = () =>
                        B().createElement(
                            'div',
                            { className: Ju },
                            B().createElement(
                                'div',
                                { className: ue },
                                B().createElement(Zu, { className: ee, text: Fe.title() }),
                                B().createElement(Zu, { className: Ae, text: Fe.description() }),
                            ),
                        );
                function te() {
                ...
                const ae = B().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        B().createElement(
                            'div',
                            Be({}, D, {
                                className: C()(De.base, De[`base__theme-${t}`], F),
                                ref: function (u) {
                                    ((n.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            B().createElement('div', { className: De.decorator }, A),
                        )
                    );
                });
                engine.whenReady.then(() => {
                    n().render(
                        B().createElement(ae, null, B().createElement(Ee, null)),
