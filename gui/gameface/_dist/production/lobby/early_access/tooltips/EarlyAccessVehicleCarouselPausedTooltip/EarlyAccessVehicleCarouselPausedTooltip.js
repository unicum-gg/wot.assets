    ...
    var u,
        e = {
            ...
            6586: (u, e, A) => {
                ...
                const Bu = Eu.client.getSize('rem'),
                    au = Bu.width,
                    nu = Bu.height,
                    iu = Object.assign({ width: au, height: nu }, ru(au, nu, tu)),
                    Cu = (0, r.createContext)(iu),
                    lu = ['children'];
                const mu = (u) => {
                    let e = u.children,
                        A = (function (u, e) {
                ...
                (0, r.memo)(({ children: u }) => {
                    ...
                    return B().createElement(Cu.Provider, { value: D }, u);
                });
                let su, du, gu;
                (!(function (u) {
                ...
                const _u = () => {
                    ...
                    cu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    hu = (u) => u.includes('_') && ((u) => cu.includes(u))(u.split('_').at(-1)),
                    xu = [su.ExtraLarge, su.Large, su.Medium, su.Small, su.ExtraSmall],
                    pu = (u, e) =>
                        Object.keys(u).reduce((A, F) => {
                            ...
                            return (
                                void 0 === E ||
                                    ((u, e) => cu.some((A) => void 0 !== e[`${u}_${A}`]))(F, u) ||
                                    (A[F] = E),
                                A
                            );
                        }, {}),
                ...
                const bu = {
                    ...
                    Ru = fu((u) => {
                        ...
                        const X = (0, r.useMemo)(() => {
                                const u = { mt: D, mr: n, mb: l, ml: o },
                                    e = ((u) =>
                                        Lu.reduce((e, A) => {
                                            const F = u[A];
                                            return F && 'number' != typeof F ? e.concat(bu[!0 === F ? 'MD' : F][A]) : e;
                                        }, []))(u),
                                    E = ((u) =>
                                        Lu.reduce((e, A) => {
                                            const F = u[A];
                                            return ('number' == typeof F && (e[Mu[A]] = F + 'rem'), e);
                                        }, {}))(u);
                                return {
                        ...
                        return B().createElement('div', wu({ className: C()(vu.base, ...z, e), style: j }, N), G);
                    });
                let Tu;
                !(function (u) {
                ...
                const Hu = (u, e, A) => {
                    ...
                    Ou = (u, e, A = Tu.left) => u.split(e).reduce(A === Tu.left ? Hu : yu, []),
                    Pu = (() => {
                        const u = new RegExp(
                        ...
                        return Wu.includes(A)
                            ...
                            : ((u, e = Tu.left) => {
                                  ...
                                  const F =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (Ou(E, /( )/, e).forEach((u) => (A = A.concat(Ou(u, F, Tu.left)))), A);
                              })(u, e);
                    },
                    Nu = 'FormatText_base_d0',
                    Xu = ({ binding: u, text: e = '', classMix: A, alignment: F = Tu.left }) =>
                        null === e
                            ...
                            : B().createElement(
                                  ...
                                  e.split('\n').map((e, E) =>
                                      B().createElement(
                                          'div',
                                          { className: C()(Nu, A), key: `${e}-${E}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : Gu(u, e))))(e, F, u).map((u, e) =>
                ...
                const Uu = Object.keys(zu()),
                    ...
                    Ju = fu((u) => {
                        ...
                        return B().createElement(
                            ...
                            Vu(
                                {
                                    className: C()(Iu.base, A && Iu[A], x, F),
                                    style: h,
                                    mt: !0 === a ? Qu[A || 'paragraph-P16'].mt : a,
                                    mr: !0 === i ? Qu[A || 'paragraph-P16'].mr : i,
                                    mb: !0 === m ? Qu[A || 'paragraph-P16'].mb : m,
                                    ml: !0 === s ? Qu[A || 'paragraph-P16'].ml : s,
                                },
                                _,
                            ),
                            void 0 !== g ? B().createElement(Xu, Vu({}, g, { text: e })) : e,
                        );
                    }),
                    ue = 'App_base_ec',
                    ee = 'App_baseBackground_64',
                    Ae = 'App_title_06',
                    Fe = 'App_description_3b',
                    Ee = R.strings.early_access.entryPoint.postProgressionDisabledTooltip,
                    te = () =>
                        B().createElement(
                            'div',
                            { className: ue },
                            B().createElement(
                                'div',
                                { className: ee },
                                B().createElement(Ju, { className: Ae, text: Ee.title() }),
                                B().createElement(Ju, { className: Fe, text: Ee.description() }),
                            ),
                        );
                function De() {
                ...
                const ne = B().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        B().createElement(
                            'div',
                            ae({}, D, {
                                className: C()(re.base, re[`base__theme-${t}`], F),
                                ref: function (u) {
                                    ((n.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            B().createElement('div', { className: re.decorator }, A),
                        )
                    );
                });
                engine.whenReady.then(() => {
                    n().render(
                        B().createElement(ne, null, B().createElement(te, null)),
