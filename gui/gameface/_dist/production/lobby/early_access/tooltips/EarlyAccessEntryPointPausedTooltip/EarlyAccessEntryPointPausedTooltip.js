            ...
            536: (u, e, A) => {
                ...
                const Hu = {
                    ...
                    Pu = Lu((u) => {
                        ...
                        return J().createElement('div', Tu({ className: B()(Mu.base, ...X, e), style: N }, W), P);
                    });
                let Wu;
                !(function (u) {
                ...
                var te = A(3403);
                const De = 'App_base_4c',
                    re = 'App_baseBackground_61',
                    Be = 'App_title_fb',
                    ae = 'App_description_64',
                    ne = 'App_divider_95',
                    ie = 'App_footer_2e',
                    Ce = 'App_footerIcon_77',
                    le = 'App_footerText_bd',
                    me = R.strings.early_access.entryPoint.disabledTooltip,
                    oe = (0, te.Pi)(() =>
                        J().createElement(
                            'div',
                            { className: De },
                            J().createElement(
                                'div',
                                { className: re },
                                J().createElement(Ee, { className: Be, text: me.title() }),
                                J().createElement(Ee, { className: ae, text: me.description() }),
                                J().createElement('div', { className: ne }),
                                J().createElement(
                                    'div',
                                    { className: ie },
                                    J().createElement('div', { className: Ce }),
                                    J().createElement(Ee, { className: le, text: me.iconLabel() }),
                                ),
                            ),
                        ),
                    );
                engine.whenReady.then(() => {
                    Du().render(
                        J().createElement(Eu, null, J().createElement(oe, null)),
