    ...
    var u,
        e = {
            ...
            536: (u, e, A) => {
                ...
                var Ee = A(3403);
                const te = 'App_base_4c',
                    De = 'App_baseBackground_61',
                    re = 'App_title_fb',
                    Be = 'App_description_64',
                    ae = 'App_divider_95',
                    ne = 'App_footer_2e',
                    ie = 'App_footerIcon_77',
                    Ce = 'App_footerText_bd',
                    le = R.strings.early_access.entryPoint.disabledTooltip,
                    me = (0, Ee.Pi)(() =>
                        Z().createElement(
                            'div',
                            { className: te },
                            Z().createElement(
                                'div',
                                { className: De },
                                Z().createElement(Fe, { className: re, text: le.title() }),
                                Z().createElement(Fe, { className: Be, text: le.description() }),
                                Z().createElement('div', { className: ae }),
                                Z().createElement(
                                    'div',
                                    { className: ne },
                                    Z().createElement('div', { className: ie }),
                                    Z().createElement(Fe, { className: Ce, text: le.iconLabel() }),
                                ),
                            ),
                        ),
                    );
