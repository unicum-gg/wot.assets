(() => {
                    ...
                    x = {
                        ...
                        sendShowPopOverEvent: (u, e, t, r, a = R.invalid('resId'), E) => {
                            const n = s.O.view.getViewGlobalPosition(),
                                ...
                                _ = A.height,
                                l = {
                                    x: s.O.view.pxToRem(F) + n.x,
                                    y: s.O.view.pxToRem(D) + n.y,
            ...
            4547: (u, e, t) => {
                ...
                const g = {
                    ...
                    h = ({
                        ...
                        discountValue: i,
                        showPlus: F,
                        stockBackgroundName: D = C.Red,
                    }) => {
                        const o = a()(g.value, g[`value__${r}`], !E && g.value__notEnough),
                            _ = a()(g.icon, g[`icon__${r}-${t}`]),
                            l = a()(g.stock, i && g.stock__indent, e && g.stock__interactive),
                            s = F && n > 0 && '+',
                            B = a()(g.base, g[`base__${t}`]);
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                { className: o },
                                s,
                                A().createElement(d, { value: n, format: r === c.gold ? 'gold' : 'integral' }),
                            ),
                ...
                const L = E.O.client.getSize('rem'),
                    y = L.width,
                    M = L.height,
                    O = Object.assign({ width: y, height: M }, S(y, M, f)),
                    T = (0, n.createContext)(O),
                    P = ['children'];
                const N = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && D) return b(e, t, g);
                        if (t.largeWidth && o) return b(e, t, g);
                        if (t.mediumWidth && _) return b(e, t, g);
                        if (t.smallWidth && l) return b(e, t, g);
                        if (t.extraSmallWidth && s) return b(e, t, g);
                        if (
                ...
                (0, n.memo)(({ children: u }) => {
                    ...
                    return A().createElement(T.Provider, { value: F }, u);
                });
                let H, W, I;
                !(function (u) {
                ...
                const G = () => {
                    ...
                    U = ['xl', 'lg', 'md', 'sm', 'xs'],
                    X = (u) => u.includes('_') && ((u) => U.includes(u))(u.split('_').at(-1)),
                ...
                const $ = {
                    ...
                    J = K((u) => {
                        let e = u.className,
                            ...
                            y = u.wrap,
                            M = u.flexWrap,
                            O = void 0 === M ? (y ? 'wrap' : void 0) : M,
                            R = u.grow,
                            T = u.shrink,
                            P = u.flex,
                            N = void 0 === P ? (R || T ? `${R ? 1 : 0} ${T ? 1 : 0} auto` : void 0) : P,
                            k = u.style,
                            H = u.children,
                            W = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const I = (0, n.useMemo)(() => {
                            ...
                            }, [t, r, F, o, l, B, k, N, L, d, O, f, S]),
                            G = I.computedStyle,
                            U = I.computedClassNames;
                        return A().createElement('div', Y({ className: a()(V.base, ...U, e), style: G }, W), H);
                    });
                let uu;
                !(function (u) {
                        ...
                        return Eu.includes(t)
                            ...
                            : ((u, e = uu.left) => {
                                  ...
                                  const r =
                                      ...
                                      a = u.replace(/&nbsp;/g, ' ');
                                  return ru(a, /( )/, e).forEach((u) => (t = t.concat(ru(u, r, uu.left)))), t;
                              })(u, e);
                    },
                    Au = 'FormatText_base_d0',
                    iu = ({ binding: u, text: e = '', classMix: t, alignment: r = uu.left }) =>
                        null === e
                            ...
                            lu(
                                {
                                    ...
                                    style: h,
                                    mt: !0 === D ? du[t || 'paragraph-P16'].mt : D,
                                    mr: !0 === _ ? du[t || 'paragraph-P16'].mr : _,
                                    mb: !0 === s ? du[t || 'paragraph-P16'].mb : s,
                                    ml: !0 === c ? du[t || 'paragraph-P16'].ml : c,
                                },
                                d,
                            ),
                            void 0 !== m ? A().createElement(iu, lu({}, m, { text: e })) : e,
                        );
                    });
                var pu = t(3403);
                function vu() {
                ...
                const Su = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: a, children: i, mocks: F }) {
                                const D = (0, n.useRef)([]),
                                    o = (t, r, a) => {
                                        var n;
                                        const A = (function ({
                                            ...
                                            l = { mode: t, model: _, externalModel: i, cleanup: o };
                                        return {
                                            model: _,
                                    ...
                                    s = l[0],
                                    B = l[1],
                                    c = (0, n.useState)(() => o(r, a, F)),
                                    C = c[0],
                                    m = c[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        _.current ? m(o(s, a, F)) : (_.current = !0);
                                    }, [F, s, a]),
                                    (0, n.useEffect)(() => {
                                        B(r);
                                    }, [r]),
                    ...
                    Ou = 'App_title_32',
                    Ru = 'App_content_4e',
                    Tu = 'App_tooltipFooter_84',
                    Pu = 'App_dottedLine_0d',
                    Nu = 'App_compensationText_13',
                    ku = 'App_tokenCount_d9',
                    Hu = 'App_tokenIcon_59',
                    Wu = 'App_compensationValue_f8',
                    Iu = R.strings.early_access.compensationTooltip,
                    Gu = (0, pu.Pi)(() => {
                        const u = yu().model.root.get().tokenCreditsCompensation;
                        return A().createElement(
                            'div',
                            { className: Mu },
                            A().createElement(hu, { className: Ou, text: Iu.title() }),
                            A().createElement(hu, { className: Ru, text: Iu.content() }),
                            A().createElement(
                                'div',
                                { className: Tu },
                                ...
                                A().createElement(p, { type: 'credits', value: u, size: 'small' }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    s().render(
                        A().createElement(Lu, null, A().createElement(_, null, A().createElement(Gu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [617], () => __webpack_require__(4547));
