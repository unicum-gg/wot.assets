        ...
        e = {
            ...
            9197: (u, e, A) => {
                ...
                const Eu = J().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        J().createElement(
                            'div',
                            Fu({}, D, {
                                className: B()(eu.base, eu[`base__theme-${t}`], F),
                                ref: function (u) {
                ...
                const lu = Q.client.getSize('rem'),
                    mu = lu.width,
                    ou = lu.height,
                    su = Object.assign({ width: mu, height: ou }, Cu(mu, ou, nu)),
                ...
                const _u = (u) => {
                    ...
                    if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
                        ...
                        if (A.extraLargeWidth && a) return au(e, A, _);
                        if (A.largeWidth && n) return au(e, A, _);
                        if (A.mediumWidth && i) return au(e, A, _);
                        if (A.smallWidth && C) return au(e, A, _);
                        if (A.extraSmallWidth && l) return au(e, A, _);
                        if (!(
                            A.extraLargeWidth ||
                            A.largeWidth ||
                            A.mediumWidth ||
                ...
                (0, Z.memo)(({ children: u }) => {
                    const e = (0, Z.useContext)(du),
                        ...
                        F = A[0],
                        E = A[1],
                        t = (0, Z.useCallback)((u, e) => {
                            const A = Q.view.pxToRem(u),
                                F = Q.view.pxToRem(e);
                            E(Object.assign({ width: A, height: F }, Cu(A, F, nu)));
                        }, []);
                    (cu(() => {
                        engine.on('clientResized', t);
                    }),
                        (0, Z.useEffect)(() => () => engine.off('clientResized', t), [t]));
                ...
                const Tu = {
                    ...
                    Pu = Lu((u) => {
                        ...
                        return J().createElement('div', Hu({ className: B()(Mu.base, ...X, e), style: N }, W), P);
                    });
                let Wu;
                !(function (u) {
                ...
                const Gu = (u, e, A) => {
                    ...
                    Xu = (u, e, A = Wu.left) => u.split(e).reduce(A === Wu.left ? Gu : Nu, []),
                    ju = (() => {
                        const u = new RegExp(
                        ...
                        return Iu.includes(A)
                            ...
                            : ((u, e = Wu.left) => {
                                  ...
                                  const F =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (Xu(E, /( )/, e).forEach((u) => (A = A.concat(Xu(u, F, Wu.left)))), A);
                              })(u, e);
                    },
                ...
                const Qu = Object.keys(Ku()),
                    ...
                    Ee = Lu((u) => {
                        ...
                        return J().createElement(
                            ...
                            qu(
                                {
                                    className: B()($u.base, A && $u[A], c, F),
                                    style: _,
                                    mt: !0 === r ? Ae[A || 'paragraph-P16'].mt : r,
                                    mr: !0 === n ? Ae[A || 'paragraph-P16'].mr : n,
                    ...
                    te = 'App_base_54',
                    De = 'App_controlsImage_8f',
                    re = 'App_tokenImage_36',
                    Be = () =>
                        J().createElement(
                            'div',
                            { className: te },
                            J().createElement(Ee, {
                                ...
                                format: {
                                    binding: {
                                        controlsImage: J().createElement('div', { className: De }),
                                        tokenImage: J().createElement('div', { className: re }),
                                    },
                                },
                            }),
                        );
                engine.whenReady.then(() => {
                    Du().render(
                        J().createElement(Eu, null, J().createElement(Be, null)),
