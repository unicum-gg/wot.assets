(() => {
    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, A) => {
                A.d(e, { kH: () => i, Z5: () => D, lf: () => a, cy: () => r, ry: () => d });
                class F {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            1060: (u, e, A) => {
                ...
                const i = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            a({}, s, {
                                className: E()(o.base, o[`base__theme-${C}`], F),
                                ref: function (u) {
                                    ((l.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            r().createElement('div', { className: o.decorator }, A),
                        )
                    );
                });
                var C = A(493),
                ...
                const _ = (u, e, A) => {
                    ...
                    m = (u, e, A = l.left) => u.split(e).reduce(A === l.left ? _ : d, []),
                    v = (() => {
                        const u = new RegExp(
                        ...
                        return h.includes(A)
                            ...
                            : ((u, e = l.left) => {
                                  ...
                                  const F =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (m(E, /( )/, e).forEach((u) => (A = A.concat(m(u, F, l.left)))), A);
                              })(u, e);
                    },
                    w = 'FormatText_base_d0',
                    p = ({ binding: u, text: e = '', classMix: A, alignment: F = l.left }) =>
                        null === e
                            ...
                            : r().createElement(
                                  ...
                                  e.split('\n').map((e, t) =>
                                      r().createElement(
                                          'div',
                                          { className: E()(w, A), key: `${e}-${t}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : g(u, e))))(e, F, u).map((u, e) =>
                    ...
                    f = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    O = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    y = (0, D.memo)(({ text: u, binding: e, classMix: A }) => {
                                ...
                                ((n = n.replace(A, `%(${t})`)),
                                    (E[t] = T[u]
                                        ? r().createElement(
                                              'span',
                                              { className: T[u] },
                                              r().createElement(p, { text: a, binding: e }),
                                          )
                                        : r().createElement(
                                              'span',
                                              { style: F(u) },
                        ...
                        return r().createElement(p, { text: n, classMix: A, binding: E });
                    });
                let M;
                !(function (u) {
                ...
                function N(u, e) {
                    ...
                    if (
                        ...
                        (A = (function (u, e) {
                            ...
                            if ('Arguments' === A || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(A)) return U(u, e);
                        })(u)) ||
                ...
                const I = ((u, e) => {
                        ...
                        return [
                            function ({ mode: F = 'real', options: E, children: n, mocks: o }) {
                                const B = (0, D.useRef)([]),
                                    a = (A, F, E) => {
                                        var D;
                                        const r = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = N(E.keys()); !(u = A()).done;) D(u.value, e);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(F),
                                            ...
                                            i = u({
                                                ...
                                                observableModel: {
                                                    array: (u, e) => {
                                                        const F = null != e ? e : o(u),
                                                            E = L.LO.box(F, { equals: S });
                                                        return (
                                                            'real' === A &&
                                                                n.subscribe(
                                                                    (0, L.aD)((u) => E.set(u)),
                                            ...
                                            C = { mode: A, model: i, externalModel: n, cleanup: a };
                                        return {
                                            model: i,
                                    ...
                                    s = C[0],
                                    c = C[1],
                                    l = (0, D.useState)(() => a(F, E, o)),
                                    _ = l[0],
                                    d = l[1];
                                return (
                                    (0, D.useEffect)(() => {
                                        i.current ? d(a(s, E, o)) : (i.current = !0);
                                    }, [o, s, E]),
                                    (0, D.useEffect)(() => {
                                        c(F);
                                    }, [F]),
                                    ...
                                    r().createElement(A.Provider, { value: _ }, n)
                                );
                            },
                            () => (0, D.useContext)(A),
                        ];
                ...
                engine.whenReady.then(() => {
                    s().render(
                        r().createElement(H, null, r().createElement(i, null, r().createElement(j, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [617], () => __webpack_require__(1060));
