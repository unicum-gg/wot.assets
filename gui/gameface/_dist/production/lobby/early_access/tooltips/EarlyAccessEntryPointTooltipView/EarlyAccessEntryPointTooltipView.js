            ...
            5905: (u, e, t) => {
                ...
                const U = {
                    ...
                    $ = H((u) => {
                        ...
                        return o().createElement('div', G({ className: a()(I.base, ...Y, e), style: K }, $), H);
                    });
                let X;
                !(function (u) {
                ...
                const K = (u, e, t) => {
                    ...
                    V = (u, e, t = X.left) => u.split(e).reduce(t === X.left ? K : Y, []),
                    q = (() => {
                        const u = new RegExp(
                        ...
                        return Z.includes(t)
                            ...
                            : ((u, e = X.left) => {
                                  ...
                                  const r =
                                      ...
                                      a = u.replace(/&nbsp;/g, ' ');
                                  return (V(a, /( )/, e).forEach((u) => (t = t.concat(V(u, r, X.left)))), t);
                              })(u, e);
                    },
                ...
                const ju = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    Ju = (0, i.memo)(
                        ({
                            ...
                            if (_) return null;
                            const x = a()(Ku, l, F && 0 === s && Yu);
                            return o().createElement(
                                'div',
                                { style: d ? f : v, className: x },
                                o().createElement(
                                    'div',
                                    { style: C ? b : p, className: Vu },
                ...
                const be = (u) => {
                    ...
                    Ke = 'Header_base_07',
                    Ye = 'Header_headerText_bd',
                    Ve = 'Header_subTitleContainer_2f',
                    ...
                    nt = (0, mu.Pi)(({ isAllChaptersCompleted: u, isPostProgressionCompleted: e }) => {
                        ...
                        return o().createElement(
                            'div',
                            { className: Ke },
                            o().createElement(Du, { className: Ye, text: s }),
                            o().createElement(
                                'div',
                                { className: Ve },
