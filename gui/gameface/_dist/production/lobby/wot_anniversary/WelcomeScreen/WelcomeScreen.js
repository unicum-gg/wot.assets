(() => {
    var __webpack_modules__ = {
            ...
            768: (u, e, t) => {
                ...
                var a = {};
                (t.r(a),
                    t.d(a, { mouse: () => d, off: () => F, on: () => A, onResize: () => E, onScaleUpdated: () => l }));
                var n = {};
                (t.r(n),
                    t.d(n, {
                        events: () => a,
                ...
                const m = {
                    ...
                    v = { play: Object.assign({}, g, { sound: D }), setRTPC: _ };
                function w(u, e, t = 1) {
            ...
            514: (u, e, t) => {
                ...
                const L = {
                    ...
                    M = (u) => {
                        ...
                        const r = b(),
                            ...
                            o = r.mediaHeight,
                            s = r.mediaSize;
                        return n().createElement('div', y({ className: h()(t, L[i], S[o], T[s]) }, a), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                class q extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = h()($.base, $[`base__${i}`], $[`base__${r}`], null == o ? void 0 : o.base),
                            d = h()($.icon, $[`icon__${i}`], $[`icon__${r}`], null == o ? void 0 : o.icon),
                            D = h()($.glow, null == o ? void 0 : o.glow),
                            _ = h()($.caption, $[`caption__${i}`], null == o ? void 0 : o.caption),
                            B = h()($.goto, null == o ? void 0 : o.goto);
                ...
                const au = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: o, children: s, mocks: E }) {
                                const l = (0, a.useRef)([]),
                                    ...
                                    d = c[0],
                                    D = c[1],
                                    _ = (0, a.useState)(() => A(r, o, E)),
                                    B = _[0],
                                    C = _[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        F.current ? C(A(d, o, E)) : (F.current = !0);
                                    }, [E, d, o]),
                                    (0, a.useEffect)(() => {
                                        D(r);
                                    }, [r]),
                        ...
                        ({ observableModel: u }) => Object.assign({}, u.primitives(['startTime', 'endTime'])),
                        ({ externalModel: u }) => ({
                            close: u.createCallbackNoArgs('onClose'),
                            accept: u.createCallbackNoArgs('onAccept'),
                            play: u.createCallbackNoArgs('onPlay'),
                        }),
                    ),
                    nu = au[0],
                    ru = au[1];
                ...
                var su = t(613);
                Date.now();
                const Eu = su.Ew.getRegionalDateTime;
                su.Ew.getFormattedDateTime;
                const lu = 'InfoBlock_base_42',
                    Au = 'InfoBlock_date_44',
                    Fu = 'InfoBlock_title_4d',
                    cu = 'InfoBlock_subTitle_38',
                    du = (0, X.Pi)(() => {
                        const u = ru().model,
                            e = u.startTime.get(),
                            t = u.endTime.get(),
                            a = Eu(e, iu.DayMonthFull),
                            r = Eu(t, iu.DayMonthFull),
                            i =
                                ((o = R.strings.wot_anniversary.welcomeScreen.duration()),
                                (s = { startTimeStr: a, endTimeStr: r }),
                                o.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                        ...
                        return n().createElement(
                            'div',
                            { className: lu },
                            n().createElement('span', { className: Au }, i),
                            n().createElement(
                                'span',
                                { className: Fu },
                                R.strings.wot_anniversary.welcomeScreen.title(),
                            ),
                            n().createElement(
                                'span',
                                { className: cu },
                                R.strings.wot_anniversary.welcomeScreen.subTitle(),
                            ),
                        );
                    }),
                    Du = 'App_base_2b',
                    _u = 'App_close_ce',
                    Bu = 'App_buttonsBlockWrapper_38',
                    Cu = 'App_acceptButton_ec',
                    mu = 'App_acceptButtonText_d4',
                    hu = 'App_playVideoButtonWrapper_ed',
                    gu = 'App_playVideoButton_f2',
                    vu = 'App_infoBlock_42',
                    wu = (0, X.Pi)(() => {
                        const u = ru().controls;
                        var e;
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement('div', { className: vu }, n().createElement(du, null)),
                                n().createElement(
                                    'div',
                                    { className: Bu },
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            'span',
                                            { className: mu },
                                            R.strings.wot_anniversary.welcomeScreen.acceptBtn(),
                                        ),
                                    ),
                                ),
                                n().createElement(
                                    'div',
                                    { className: hu, onClick: u.play },
                ...
                engine.whenReady.then(() => {
                    P().render(
                        n().createElement(nu, null, n().createElement(k, null, n().createElement(wu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [46], () => __webpack_require__(514));
