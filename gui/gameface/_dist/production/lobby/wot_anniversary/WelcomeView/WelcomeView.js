(() => {
            ...
            717: (u, e, t) => {
                ...
                const _ = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.largeWidth && F) return r(e, t, w);
                        if (t.mediumWidth && c) return r(e, t, w);
                        if (t.smallWidth && _) return r(e, t, w);
                ...
                const y = {
                    ...
                    M = (u) => {
                        ...
                        const r = b(),
                            ...
                            o = r.mediaHeight,
                            s = r.mediaSize;
                        return a().createElement('div', L({ className: h()(t, y[i], S[o], T[s]) }, n), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                function I(u = N.n.NONE, e = W, t = !1, a = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== N.n.NONE)
                            return (
                ...
                const q = ((u, e) => {
                                    ...
                                    A = (t, n, a) => {
                                        ...
                                        const o = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = $(a.keys()); !(u = t()).done;) r(u.value, e);
                                                    },
                                                    unsubscribe: r,
                                                };
                                            })(n),
                    ...
                    J = 'App_vignette_ac',
                    uu = 'App_header_88',
                    eu = 'App_headerSubTitle_6e',
                    tu = 'App_headerTitle_ae',
                    nu = 'App_footer_2c',
                    au = 'App_sections_58',
                    ru = 'App_section_27',
                    iu = 'App_sectionImage_5e',
                    ou = 'App_sectionTitle_66',
                    su = 'App_sectionDescription_73',
                    Eu = 'App_close_b6',
                    lu = 'App_button_1b';
                function Au(u) {
                    engine.call('PlaySound', u).catch((e) => {
                ...
                class Du extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = h()(Fu.base, Fu[`base__${i}`], Fu[`base__${r}`], null == o ? void 0 : o.base),
                            d = h()(Fu.icon, Fu[`icon__${i}`], Fu[`icon__${r}`], null == o ? void 0 : o.icon),
                            D = h()(Fu.glow, null == o ? void 0 : o.glow),
                            _ = h()(Fu.caption, Fu[`caption__${i}`], null == o ? void 0 : o.caption),
                            B = h()(Fu.goto, null == o ? void 0 : o.goto);
                        return a().createElement(
                            ...
                            'info' !== i && a().createElement('div', { className: Fu.shine }),
                        ...
                        a().createElement(
                            ...
                            r !== Bu.ghost &&
                                a().createElement(
                                    a().Fragment,
                                    null,
                                    a().createElement('div', { className: _u.back }),
                                    a().createElement('span', { className: _u.texture }),
                                ),
                            a().createElement(
                                'span',
                                { className: h()(_u.state, _u.state__default) },
                                a().createElement('span', { className: _u.stateDisabled }),
                                a().createElement('span', { className: _u.stateHighlightHover }),
                                a().createElement('span', { className: _u.stateHighlightActive }),
                            ),
                            a().createElement(
                                'span',
                ...
                Cu.defaultProps = { type: Bu.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const hu = Cu;
                t(281);
                let gu;
                function vu(u, e) {
                ...
                var pu = t(613);
                Date.now();
                const fu = pu.Ew.getRegionalDateTime;
                pu.Ew.getFormattedDateTime;
                const bu = (u, e = !0) => fu(u, wu.DayMonthFull, e),
                    xu = R.strings.wot_anniversary.welcomeView,
                    Lu = R.images.gui.maps.icons.wot_anniversary.welcome,
                    yu = (0, G.Pi)(() => {
                        const u = Y(),
                            e = u.model,
                            t = u.controls,
                            ...
                            i = n.endDate;
                        var o;
                        ((o = t.close), I(N.n.ESCAPE, o));
                        const s = [
                            {
                                image: Lu.section_1(),
                                title: xu.section1.title(),
                                description: xu.section1.description(),
                            },
                            {
                                image: Lu.section_2(),
                                title: xu.section2.title(),
                                description: xu.section2.description(),
                            },
                            {
                                image: Lu.section_3(),
                                title: xu.section3.title(),
                                description: xu.section3.description(),
                            },
                            {
                                image: Lu.section_4(),
                                title: xu.section4.title(),
                                description: xu.section4.description(),
                            },
                        ];
                        return a().createElement(
                            'div',
                            { className: X, lang: R.strings.settings.LANGUAGE_CODE() },
                            a().createElement(
                                'div',
                                { className: Z },
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: eu },
                                        vu(xu.subTitle(), { startDate: bu(r), endDate: bu(i) }),
                                    ),
                                    a().createElement('div', { className: tu }, xu.title()),
                                ),
                                a().createElement(
                                    'div',
                                    { className: nu },
                                    a().createElement(
                                        ...
                                        s.map((u, e) =>
                                            a().createElement(
                                                ...
                                                a().createElement('div', { className: ou }, u.title),
                                                a().createElement('div', { className: su }, u.description),
                                            ),
                                        ),
                                    ),
                                    a().createElement(
                                        ...
                                        a().createElement(
                                            hu,
                                            { type: Bu.primary, size: mu.medium, mixClass: lu, onClick: t.close },
                                            xu.confirm(),
                                        ),
                                    ),
                                ),
                ...
                engine.whenReady.then(() => {
                    P().render(
                        a().createElement(k, null, a().createElement(K, null, a().createElement(yu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [46], () => __webpack_require__(717));
