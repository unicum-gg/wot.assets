(() => {
    var __webpack_modules__ = {
            ...
            768: (e, u, t) => {
                ...
                var r = {};
                (t.r(r),
                    t.d(r, { mouse: () => F, off: () => d, on: () => c, onResize: () => l, onScaleUpdated: () => E }));
                var n = {};
                (t.r(n),
                    t.d(n, {
                        events: () => r,
                ...
                const C = {
                    ...
                    g = Object.keys(h).reduce((e, u) => ((e[u] = () => _(h[u])), e), {}),
            ...
            605: (e, u, t) => {
                ...
                const E = i.O.client.getSize('rem'),
                    c = E.width,
                    d = E.height,
                    A = Object.assign({ width: c, height: d }, l(c, d, o)),
                ...
                const m = (e) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && c) return a(u, t, p);
                        if (t.largeWidth && d) return a(u, t, p);
                ...
                const y = {
                    ...
                    M = (e) => {
                        ...
                        const a = f(),
                            ...
                            o = a.mediaHeight,
                            s = a.mediaSize;
                        return n().createElement('div', x({ className: h()(t, y[i], T[o], L[s]) }, r), u);
                    },
                    O = ['children'];
                const k = (e) => {
                    let u = e.children,
                ...
                const W = ({
                    ...
                    return (
                        ...
                        n().createElement(
                            ...
                            n().createElement(
                                'span',
                                { className: h()(H.state, H.state__default) },
                ...
                class $ extends n().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            A = h()(V.base, V[`base__${i}`], V[`base__${a}`], null == o ? void 0 : o.base),
                            F = h()(V.icon, V[`icon__${i}`], V[`icon__${a}`], null == o ? void 0 : o.icon),
                            _ = h()(V.glow, null == o ? void 0 : o.glow),
                            m = h()(V.caption, V[`caption__${i}`], null == o ? void 0 : o.caption),
                            D = h()(V.goto, null == o ? void 0 : o.goto);
                ...
                function Z(e = X.n.NONE, u = K, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (e !== X.n.NONE)
                            return (
                ...
                const Fe = ((e, u) => {
                                ...
                                const E = (0, r.useRef)([]),
                                    c = (t, r, n) => {
                                        ...
                                        const o = (function ({
                                            ...
                                            A = { mode: t, model: d, externalModel: s, cleanup: c };
                                        return {
                                            model: d,
                                    ...
                                    F = A[0],
                                    _ = A[1],
                                    m = (0, r.useState)(() => c(a, o, l)),
                                    D = m[0],
                                    B = m[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        d.current ? B(c(F, o, l)) : (d.current = !0);
                                    }, [l, F, o]),
                                    (0, r.useEffect)(() => {
                                        _(a);
                                    }, [a]),
                        ...
                        ({ observableModel: e }) => {
                            const u = { root: e.object(), mainRewards: e.array('mainRewards') },
                                t = (0, Ae.Om)(() => 1 === u.mainRewards.get().length),
                                r = (0, Ae.Om)(() => {
                                    var e;
                                    return (
                                        t() &&
                                        (null == (e = de(u.mainRewards.get(), 0)) ? void 0 : e.name) === ee.Vehicles
                                    );
                                });
                            return Object.assign({}, u, { computes: { hasBigSizeReward: t, isMainRewardVehicle: r } });
                        },
                        ({ externalModel: e }) => ({ close: e.createCallbackNoArgs('onClosed') }),
                    ),
                    _e = Fe[0],
                    me = Fe[1],
                    De = 'Background_base_2c',
                    Be = 'Background_background_54',
                    Ce = () =>
                        n().createElement(
                            'div',
                            { className: De },
                            n().createElement('div', {
                                className: Be,
                                style: {
                                    backgroundImage: `url(${R.images.gui.maps.icons.wot_anniversary.rewards.bg()})`,
                                },
                            }),
                        ),
                    he = 'Glow_glow_e5',
                    ...
                    we = 'Header_base_15',
                    be = 'Header_title_54',
                    fe = 'Header_subTitleContainer_76',
                    Re = 'Header_subTitle_4d',
                    Se = R.strings.wot_anniversary.rewardScreen,
                    xe = () =>
                        n().createElement(
                            'div',
                            { className: we },
                            n().createElement('div', { className: be }, Se.title()),
                            n().createElement(
                                'div',
                                { className: fe },
                                n().createElement('div', { className: Re }, Se.subTitle()),
                            ),
                        );
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (Me(t, F, { isMouseEvent: !0, on: !0, arguments: Le(n) }, p),
                                    C && C(),
                ...
                const je = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    const a = u.contentId;
                    return a ? n().createElement(Oe, We({}, u, { contentId: a }), r) : n().createElement(Ie, u, r);
                };
                t(281);
                let Ve;
                function qe(e) {
                ...
                const Ye = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    Ze = 'TankName_base_f1',
                    Qe = 'TankName_typeContainer_18',
                    Je = 'TankName_type_db',
                    eu = ({ vehicleLevel: e, vehicleType: u, vehicleName: t }) => {
                        const a = Ke(e),
                            i = (0, r.useMemo)(
                                () => ({
                                    backgroundImage: `url(${`R.images.gui.maps.icons.vehicleTypes.big.${qe(u)}_elite`})`,
                                }),
                                [u],
                            );
                        return n().createElement(
                            ...
                            n().createElement(
                                'div',
                                { className: Qe },
                                n().createElement('div', { className: Je, style: i }),
                            ),
                            t,
                        );
                    },
                    uu = {
                        base: 'MainRewardResolver_base_37',
                        vehicleIcon: 'MainRewardResolver_vehicleIcon_bb',
                        mainRewardIconContainer: 'MainRewardResolver_mainRewardIconContainer_99',
                        mainRewardIcon: 'MainRewardResolver_mainRewardIcon_3a',
                        regularRewardIconContainer: 'MainRewardResolver_regularRewardIconContainer_21',
                        regularRewardIcon: 'MainRewardResolver_regularRewardIcon_9f',
                        itemRewardIcon: 'MainRewardResolver_itemRewardIcon_1e',
                        vehicleInfo: 'MainRewardResolver_vehicleInfo_21',
                        tankName: 'MainRewardResolver_tankName_8c',
                        mainRewardLabelContainer: 'MainRewardResolver_mainRewardLabelContainer_4c',
                        mainRewardLabel: 'MainRewardResolver_mainRewardLabel_06',
                        regularRewardLabelContainer: 'MainRewardResolver_regularRewardLabelContainer_bd',
                        regularRewardLabel: 'MainRewardResolver_regularRewardLabel_e9',
                        amount: 'MainRewardResolver_amount_b8',
                        amountContainer: 'MainRewardResolver_amountContainer_5b',
                        fadeIn: 'MainRewardResolver_fadeIn_f2',
                        fadeInThreeQuarters: 'MainRewardResolver_fadeInThreeQuarters_ec',
                        fadeInHalf: 'MainRewardResolver_fadeInHalf_09',
                        fadeOut: 'MainRewardResolver_fadeOut_83',
                        fadeInWithScale: 'MainRewardResolver_fadeInWithScale_5d',
                        slideUp: 'MainRewardResolver_slideUp_94',
                        scale: 'MainRewardResolver_scale_fa',
                        raysAppearance: 'MainRewardResolver_raysAppearance_54',
                        rotate: 'MainRewardResolver_rotate_37',
                        'reverse-rotate': 'MainRewardResolver_reverse-rotate_2c',
                        glowAppearance: 'MainRewardResolver_glowAppearance_b3',
                        highlightAppearance: 'MainRewardResolver_highlightAppearance_66',
                    },
                    ...
                    ru = (e, u) => {
                        switch (e) {
                            case ee.Vehicles:
                                return uu.vehicle;
                            case ee.Customizations:
                                return 'medium' === u ? uu.regularRewardIconContainer : uu.mainRewardIconContainer;
                            default:
                                return uu.regularRewardIconContainer;
                        }
                    },
                    nu = (e, u) => (e === ee.Vehicles ? uu.vehicleIcon : au(u)),
                    au = (e) => {
                        switch (e) {
                            case 'medium':
                                return uu.regularRewardIcon;
                            case 'big':
                                return uu.mainRewardIcon;
                            default:
                                return uu.itemRewardIcon;
                        }
                    },
                    iu = (e, u, t) => {
                        const r = t <= b.Small,
                        ...
                        switch (e.name) {
                            case ee.Vehicles:
                                return `R.images.gui.maps.icons.wot_anniversary.rewards.vehicles.${e.vehicleType}.${qe(e.bigIcon ? e.bigIcon : '')}${r ? '_medium' : '_big'}`;
                            case ee.Customizations:
                                return `R.images.gui.maps.icons.wot_anniversary.rewards.customizations.style_${e.value}_${r ? 'medium' : 'big'}`;
                            case ee.Items:
                                return `R.images.gui.maps.icons.quests.bonuses.${n}.${e.item}`;
                            case ee.Premium:
                            case ee.PremiumPlus:
                                return `R.images.gui.maps.icons.quests.bonuses.${n}.premium_plus_${e.value}`;
                        }
                    },
                    ou = (e) => {
                        switch (e) {
                    ...
                    su = (e) => {
                        switch (e) {
                            case 'medium':
                            default:
                                return uu.regularRewardLabel;
                            case 'big':
                                return uu.mainRewardLabel;
                        }
                    },
                    lu = (e) => {
                        switch (e) {
                            case 'medium':
                            default:
                                return uu.regularRewardLabelContainer;
                            case 'big':
                                return uu.mainRewardLabelContainer;
                        }
                    },
                    Eu = ({ reward: e, size: u = 'medium' }) => {
                        const t = f().mediaHeight,
                            a = e.name,
                            i = e.label,
                            o = e.tooltipId,
                            ...
                            m = (0, r.useMemo)(
                                () =>
                                    ...
                                    })({ tooltipId: o }, Number(s), { ignoreShowDelay: !0 }),
                                [s, o],
                            ),
                            D = (0, ze.useSpring)({
                                ...
                                delay: 550,
                                config: { duration: 600, easing: tu },
                            }),
                            B = ((e) => {
                                if (e.name === ee.Customizations || void 0 === e.value) return null;
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement('div', {
                                            className: nu(a, u),
                                            style: { backgroundImage: `url(${iu(e, u, t)})` },
                                        }),
                                    ),
                                    _
                                        ? n().createElement(
                                              'div',
                                              { className: uu.vehicleInfo },
                                              n().createElement(
                                                  'div',
                                                  { className: uu.tankName },
                                                  n().createElement(eu, {
                                                      vehicleLevel: E,
                                                      vehicleType: d,
                                                      vehicleName: F,
                                        ...
                                        : n().createElement(
                                              'div',
                                              { className: lu(u) },
                                              n().createElement('div', { className: su(u) }, i),
                                          ),
                                    B &&
                                        n().createElement(
                                            'div',
                                            { className: uu.amountContainer },
                                            n().createElement('div', { className: uu.amount }, B),
                                        ),
                                ),
                            ),
                        );
                    },
                    cu = 'MainRewards_base_15',
                    du = (0, Q.Pi)(() => {
                        const e = me().model,
                            u =
                                ((t = e.mainRewards.get()),
                                ...
                                Array.isArray(t)
                                    ? t.map(r)
                                    : t.map((e, u, t) => r(null == e ? void 0 : e.value, u, t)));
                        var t, r;
                        const a = e.computes.hasBigSizeReward(),
                            i = u.length > 4 ? 'small' : 'medium';
                        return n().createElement(
                            'div',
                            { className: cu },
                            a
                                ? n().createElement(Eu, { reward: u[0], size: 'big' })
                                : u.map((e, u) => n().createElement(Eu, { reward: e, key: u, size: i })),
                        );
                    }),
                    Au = 'App_base_a8',
                    Fu = 'App_close_18',
                    _u = 'App_header_b1',
                    mu = 'App_glow_f2',
                    Du = 'App_mainRewards_31',
                    Bu = 'App_ribbon_51',
                    Cu = 'App_ribbon__gold_b7',
                    hu = 'App_buttonWrapper_de',
                    gu = 'App_button_0b',
                    vu = (0, Q.Pi)(() => {
                        const e = me(),
                            u = e.model,
                            t = e.controls,
                            r = u.computes.isMainRewardVehicle();
                        var a;
                        return (
                            (a = t.close),
                            Z(X.n.ESCAPE, a),
                            n().createElement(
                                ...
                                n().createElement('div', { className: _u }, n().createElement(xe, null)),
                                n().createElement('div', { className: mu }, n().createElement(pe, { withLight: r })),
                                n().createElement('div', { className: h()(Bu, r && Cu) }),
                                n().createElement('div', { className: Du }, n().createElement(du, null)),
                                n().createElement(
                                    'div',
                                    { className: Fu },
                                    n().createElement($, {
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        R.strings.wot_anniversary.rewardScreen.button(),
                                    ),
                                ),
                            )
                        );
                ...
                engine.whenReady.then(() => {
                    I().render(
                        n().createElement(_e, null, n().createElement(k, null, n().createElement(vu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [46], () => __webpack_require__(605));
