(() => {
    var __webpack_modules__ = {
            ...
            390: (u, e, t) => {
                ...
                const S = {
                    ...
                    P = (u) => {
                        ...
                        const n = f(),
                            ...
                            o = n.mediaHeight,
                            s = n.mediaSize;
                        return r().createElement('div', x({ className: g()(t, S[i], y[o], O[s]) }, a), e);
                    },
                    M = ['children'];
                const L = (u) => {
                    let e = u.children,
                ...
                class W extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            F = g()(U.base, U[`base__${i}`], U[`base__${n}`], null == o ? void 0 : o.base),
                            d = g()(U.icon, U[`icon__${i}`], U[`icon__${n}`], null == o ? void 0 : o.icon),
                            D = g()(U.glow, null == o ? void 0 : o.glow),
                            _ = g()(U.caption, U[`caption__${i}`], null == o ? void 0 : o.caption),
                            m = g()(U.goto, null == o ? void 0 : o.goto);
                ...
                function q(u = $.n.NONE, e = j, t = !1, r = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== $.n.NONE)
                            return (
                ...
                const V = 200,
                    ...
                    K = (u, e = 300) => ({
                        from: { opacity: 0, y: '10rem' },
                        to: { opacity: 1, y: '0' },
                        delay: u,
                        config: { duration: e, easings: Q },
                    });
                function Z(u) {
                    return u;
                }
                ...
                const iu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: o, children: s, mocks: l }) {
                                const E = (0, a.useRef)([]),
                                    ...
                                    d = F[0],
                                    D = F[1],
                                    _ = (0, a.useState)(() => c(n, o, l)),
                                    m = _[0],
                                    B = _[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        A.current ? B(c(d, o, l)) : (A.current = !0);
                                    }, [l, d, o]),
                                    (0, a.useEffect)(() => {
                                        D(n);
                                    }, [n]),
                        ...
                        ({ observableModel: u }) => {
                            const e = {
                                ...
                                t = (0, nu.Om)(() => ru(e.mainRewards.get(), Z), { equals: J }),
                                a = (0, nu.Om)(() => {
                                    const u = t();
                                    if (1 === u.length) return u;
                                    const e = [...u],
                                        a = e[0];
                                    return ((e[0] = e[1]), (e[1] = a), e);
                                }),
                                r = (0, nu.Om)(() =>
                                    Boolean(
                                        (function (u, e) {
                                            ...
                                            for (let r = 0; r < u.length; r++) {
                                                var a;
                                                const n = null == (a = u[r]) ? void 0 : a.value;
                                                e(n, r, u) && t.push(n);
                                            }
                                            return t;
                                        })(e.mainRewards.get(), (u) => ['vehicles'].includes(u.name)).length,
                                    ),
                                ),
                                n = (0, nu.Om)(() => (r() ? a() : t())),
                                i = (0, nu.Om)(() => n().length),
                                o = (0, nu.Om)(() => 2 !== i() && r),
                                s = (0, nu.Om)(() => ru(e.additionalRewards.get(), Z), { equals: J }),
                                l = (0, nu.Om)(() => s().length),
                                E = (0, nu.Om)(() => l() > 0);
                            return Object.assign({}, e, {
                                computes: {
                                    ...
                                    getAdditionalRewardsLength: l,
                                    hasAdditionalRewards: E,
                                },
                            });
                        },
                    ...
                    su = iu[1],
                    lu = 'App_base_a5',
                    Eu = 'App_background_11',
                    cu = 'App_main_ae',
                    Au = 'App_close_ad',
                    Fu = 'App_content_4d',
                    du = 'App_rewards_25',
                    Du = 'App_base__withBigReward_50',
                    _u = 'App_mainRewards_b9';
                let mu, Bu, Cu, gu, hu, pu, wu, vu;
                (!(function (u) {
                    ((u.Items = 'items'),
                ...
                const Tu = [
                    ...
                    xu = [mu.BattlePassPoints, mu.EquipCoin],
                    Su = [mu.PremiumPlus, mu.Premium],
                    yu = (u) =>
                        Tu.includes(u)
                            ? gu.MULTI
                            : Ru.includes(u)
                        ...
                        const p = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, a.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Gu(t, d, { isMouseEvent: !0, on: !0, arguments: Uu(r) }, w),
                                    C && C(),
                ...
                const Qu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return r().createElement(Vu, e, a);
                        const n = e.contentId;
                        return n ? r().createElement(Hu, Xu({}, e, { contentId: n }), a) : r().createElement(zu, e, a);
                    },
                    Ku = {
                        base: 'Reward_base_ea',
                    ...
                    Zu = ({
                        ...
                        return r().createElement(
                            'div',
                            {
                                className: g()(Ku.base, Ku[`base__${a}`], bu.includes(u) && Ku.base__normalize, E),
                                style: l,
                            },
                            r().createElement(
                                Qu,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: g()(Ku.image, null == c ? void 0 : c.image) },
                                        d &&
                                            r().createElement('div', {
                                                className: g()(Ku.highlight, null == c ? void 0 : c.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: g()(Ku.icon, null == c ? void 0 : c.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        D &&
                                            r().createElement('div', {
                                                className: g()(Ku.overlay, null == c ? void 0 : c.overlay),
                                                style: {
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: g()(
                                                    Ku.info,
                                                    Ku[`info__${u}`],
                                                    o === gu.MULTI && Ku.info__multi,
                                                    null == c ? void 0 : c.info,
                                                ),
                                            },
                                            _,
                                        ),
                                    s && r().createElement('div', { className: Ku.title }, s),
                                ),
                            ),
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: F },
                                    r().createElement('div', {
                                        className: g()(Ku.timer, null == c ? void 0 : c.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const ue = {
                    ...
                    te =
                        (Math.max(...Object.keys(ue).map((u) => Number(u))),
                        Math.max(...Object.keys(ee).map((u) => Number(u))),
                        w.ExtraSmall,
                        w.Small,
                        w.Medium,
                        w.Large,
                        w.ExtraLarge,
                        'gui_random_reward_red_ribbon_appear'),
                    ae = 'gui_random_reward_appear',
                    re = 'gui_random_reward_icon',
                    ne = 'gui_random_reward_end',
                    ie = 'AdditionalRewards_base_58',
                    oe = 'AdditionalRewards_title_87',
                    se = 'AdditionalRewards_reward_61',
                    le = 'AdditionalRewards_rewardsList_f7';
                function Ee() {
                    return (
                        (Ee =
                            Object.assign ||
                ...
                const ce = (0, Y.Pi)(({ showDelay: u = 0, className: e }) => {
                        const t = su().model.computes.getAdditionalRewards(),
                            a = f().mediaSize >= w.Medium ? Cu.Big : Cu.Small;
                        return r().createElement(
                            'div',
                            { className: g()(ie, e) },
                            r().createElement(
                                Ju.animated.div,
                                { className: g()(oe), style: (0, Ju.useSpring)(K(u)) },
                                R.strings.wot_anniversary.progressionRewardView.additionalRewardsTitle(),
                            ),
                            r().createElement(
                                'div',
                                { className: le },
                                t.map((e, t) => {
                                    ...
                                    return r().createElement(
                                        ...
                                        {
                                            className: se,
                                            style: (0, Ju.useSpring)(
                                                Object.assign({}, K(n), {
                                                    onStart: () => {
                                                        i.O.sound.play.sound(re);
                                                    },
                                                }),
                                            ),
                                            key: t,
                    ...
                    Ce = (0, Y.Pi)(({ showDelay: u = 0 }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    _e,
                                    { size: de.medium, onClick: e.close, mixClass: Be },
                                    R.strings.wot_anniversary.progressionRewardView.affirmative(),
                                ),
                            ),
                        );
                    });
                ...
                const we = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    fe = (u, e, t = he.left) => u.split(e).reduce(t === he.left ? ve : be, []),
                    Te = (() => {
                        const u = new RegExp(
                    ...
                    xe = (u, e = he.left) => {
                        ...
                        return ((u, e = he.left) => {
                            ...
                            const a =
                                ...
                                r = we(u);
                            return (fe(r, /( )/, e).forEach((u) => (t = t.concat(fe(u, a, he.left)))), t);
                        })(u, e);
                    },
                    Se = 'FormatText_base_d0',
                    ye = ({ binding: u, text: e = '', classMix: t, alignment: n = he.left, formatWithBrackets: i }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const o = i && u ? pe(e, u) : e;
                        return r().createElement(
                            a.Fragment,
                            null,
                            o.split('\n').map((e, i) =>
                    ...
                    ke = (0, a.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((s = s.replace(t, `%(${o})`)),
                                    (i[o] = Oe[u]
                                        ? r().createElement(
                                              'span',
                                              { className: Oe[u] },
                                              r().createElement(ye, { text: c, binding: e }),
                                          )
                                        : r().createElement(
                                              'span',
                                              { style: n(u) },
                        ...
                        return r().createElement(ye, { text: s, classMix: t, binding: i });
                    }),
                    Ie = 'Header_base_ad',
                    Ne = 'Header_title_0d',
                    Ue = 'Header_subTitle_6a',
                    Ge = R.strings.wot_anniversary.progressionRewardView,
                    He = (0, Y.Pi)(({ showDelay: u = 0 }) => {
                        const e = su().model.root.get(),
                            t = e.isFirstStage,
                            a = e.openedSlotsCount,
                            n = (0, Ju.useSpring)(K(u)),
                            i = (0, Ju.useSpring)(K(u + X));
                        return r().createElement(
                            'div',
                            { className: Ie },
                            r().createElement(Ju.animated.div, { className: Ne, style: n }, Ge.title()),
                            r().createElement(
                                Ju.animated.div,
                                { style: i },
                                r().createElement(ke, {
                                    classMix: Ue,
                                    text: t ? Ge.subTitle.first() : Ge.subTitle.secondPlus(),
                                    binding: { count: a },
                                }),
                            ),
                        );
                ...
                const Ve = (0, a.memo)(function (u) {
                        ...
                        return (
                            ...
                            r().createElement('canvas', Ye({}, h, { width: e, height: t, ref: p }))
                        );
                    }),
                    Xe = (u, e) => {
                        let t = u;
                ...
                const nt = (u) => {
                    switch (u) {
                        case rt.Tman:
                        case rt.GiftMachineToken:
                        case rt.LootBox:
                        case rt.AddcEconomicBonuses:
                        case rt.RandomBooklet:
                        case rt.RandomGuide:
                        case rt.RandomDecoration:
                        case rt.RandomInstruction:
                        case rt.WdrCoin:
                        case rt.Toys:
                            return gu.MULTI;
                        default:
                ...
                var it = t(690);
                const ot = { base: 'VehicleName_base_79', type: 'VehicleName_type_4a', flag: 'VehicleName_flag_9a' },
                    st = (u, e) => ({
                        backgroundImage: `url(${`R.images.gui.maps.icons.vehicleTypes.big.${`${u.replace('-', '_')}${e ? '_elite' : ''}`}`})`,
                    }),
                    lt = ({ isElite: u, vehicleName: e, vehicleType: t, vehicleNation: a, vehicleLvl: n }) =>
                        r().createElement(
                            'div',
                            { className: ot.base },
                            r().createElement('div', {
                                className: ot.flag,
                                style: { backgroundImage: `url('${R.images.gui.maps.icons.flags.c_60x40.$dyn(a)}')` },
                            }),
                            r().createElement('div', { className: ot.level }, (0, it.HG)(n)),
                            r().createElement('div', { className: ot.type, style: st(t, u) }),
                            r().createElement('div', { className: ot.name }, e),
                        ),
                    Et = {
                        base: 'Reward_base_d8',
                        info: 'Reward_info_dd',
                        info__credits: 'Reward_info__credits_b0',
                        info__gold: 'Reward_info__gold_06',
                        info__crystal: 'Reward_info__crystal_b9',
                        info__vehicles: 'Reward_info__vehicles_a1',
                        counter: 'Reward_counter_b3',
                        label: 'Reward_label_b4',
                        base__s232x174: 'Reward_base__s232x174_6b',
                        info_gold: 'Reward_info_gold_a3',
                    },
                    ct = ({ reward: u, showDelay: e = 0, size: t, withBigReward: a, className: n }) => {
                        const o = u.tooltipContentId,
                            s = u.tooltipId,
                            l = u.name === Bu.Vehicles,
                            E = l ? `R.images.gui.maps.shop.vehicles.c_600x450.${u.icon}` : Mu(u, t),
                            c = (0, Ju.useSpring)(
                                Object.assign(
                                    {},
                                    a && !l
                                    ...
                                    {
                                        onStart: () => {
                                            i.O.sound.play.sound(ae);
                                        },
                                    },
                                ),
                            ),
                            A = (0, Ju.useSpring)(K(e + V));
                        return r().createElement(
                            'div',
                            { className: g()(Et.base, Et[`base__${t}`], n) },
                            r().createElement(
                                Ju.animated.div,
                                { style: c },
                                r().createElement(Zu, {
                                    ...
                                    size: t,
                                    tooltipArgs: Lu({ tooltipId: s }, Number(o), { ignoreShowDelay: !0 }),
                                }),
                            ),
                            r().createElement(
                                Ju.animated.div,
                                { className: g()(Et.info, Et[`info__${u.name}`]), style: A },
                                u.name === Bu.Vehicles
                                    ? r().createElement(lt, {
                                          vehicleName: u.label,
                                          vehicleType: u.vehicleType,
                                          vehicleLvl: u.vehicleLevel,
                                    ...
                                    : r().createElement(
                                          ...
                                          r().createElement(
                                              ...
                                              ((u) => {
                                                  const e = nt(u.name);
                                                  return [gu.MULTI, gu.PREMIUM_PLUS, gu.STRING].includes(e)
                                                      ? u.label
                                                      : Iu(u.value, e);
                                              })(u),
                                          ),
                                          r().createElement(
                                              ...
                                              ((u) => (nt(u.name) === gu.MULTI ? Iu(u.value, gu.MULTI) : null))(u),
                                          ),
                                      ),
                            ),
                        );
                    ...
                    At = 'Rewards_base_35',
                    Ft = 'Rewards_mainReward_58',
                    dt = (0, Y.Pi)(({ showDelay: u = 0 }) => {
                        const e = su().model,
                            t = e.computes.getRewards(),
                            a = e.computes.getRewardsLength(),
                            n = e.computes.hasBigSizeReward(),
                            i = f().mediaSize,
                            o = (u) =>
                                n
                                    ? 1 === a || 1 === u
                        ...
                        return r().createElement(
                            ...
                            t.map((e, t) => {
                                ...
                                return r().createElement(ct, {
                                    showDelay: n ? (i ? u : u + V * (0 === t ? t + 1 : t)) : u,
                                    reward: e,
                                    key: `reward-${t}`,
                                    size: o(t),
                                    withBigReward: n,
                    ...
                    Dt = 'MainRewards_base_50',
                    _t = 'MainRewards_glow_f2',
                    mt = 'MainRewards_ribbonWrapper_7c',
                    Bt = 'MainRewards_ribbonWrapper__wide_88',
                    Ct = 'MainRewards_ribbon_ac',
                    gt = 'MainRewards_rays_f7',
                    ht = (0, Y.Pi)(({ className: u, showDelay: e = 0 }) => {
                        const t = su().model,
                            a = t.computes.hasGlowAnimation(),
                        ...
                        return r().createElement(
                            ...
                            a &&
                                r().createElement(
                                    'div',
                                    { className: _t },
                                    r().createElement(Ju.animated.div, { style: o }, r().createElement(at, null)),
                                ),
                            ...
                            r().createElement(dt, { showDelay: e + V }),
                        );
                    }),
                    pt = (0, Y.Pi)(() => {
                        const u = su(),
                            e = u.model,
                            t = u.controls,
                            a = e.computes.hasAdditionalRewards(),
                            n = e.computes.hasBigSizeReward(),
                            i = e.computes.getRewardsLength(),
                            o = e.computes.getAdditionalRewardsLength();
                        var s;
                        ((s = t.close), q($.n.ESCAPE, s));
                        const l = n ? 600 + (i * X + 300) : 1200;
                        const E = a ? l + 200 * o : l;
                        return r().createElement(
                            'div',
                            { className: g()(lu, n && Du) },
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: du },
                                        r().createElement(ht, { className: _u, showDelay: 600 }),
                                        a && r().createElement(ce, { showDelay: l }),
                                    ),
                                ),
                                r().createElement(Ce, { showDelay: E }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    I().render(
                        r().createElement(L, null, r().createElement(ou, null, r().createElement(pt, null))),
        ...
        (__webpack_require__.O = (u, e, t, a) => {
            if (!e) {
                ...
                for (s = 0; s < deferred.length; s++) {
                    for (var [e, t, a] = deferred[s], n = !0, i = 0; i < e.length; i++)
                        (!1 & a || r >= a) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [46], () => __webpack_require__(390));
