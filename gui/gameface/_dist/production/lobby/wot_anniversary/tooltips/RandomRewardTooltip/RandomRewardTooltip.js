(() => {
    ...
    var __webpack_modules__ = {
            768: (u, e, t) => {
                ...
                var E = {};
                (t.r(E),
                    t.d(E, { mouse: () => C, off: () => s, on: () => o, onResize: () => D, onScaleUpdated: () => i }));
                var n = {};
                (t.r(n),
                    t.d(n, {
                        events: () => E,
            ...
            916: (u, e, t) => {
                ...
                function c(u, e, t, E, n, A, r) {
                    ...
                    F.done ? e(a) : Promise.resolve(a).then(E, n);
                }
                    ...
                    b = {
                        ...
                        sendShowPopOverEvent: (u, e, t, E, n = R.invalid('resId'), A) => {
                            const r = B.O.view.getViewGlobalPosition(),
                                ...
                                s = a.height,
                                C = {
                                    x: B.O.view.pxToRem(D) + r.x,
                                    y: B.O.view.pxToRem(i) + r.y,
            ...
            160: (u, e, t) => {
                ...
                const s = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            ...
                            F().createElement('div', { className: D.decorator }, t),
                        )
                    );
                });
                var B = t(493),
                ...
                (d.Items,
                    ...
                    d.PremiumPlus,
                    d.Premium);
                const w = ['engravings', 'backgrounds'],
                    ...
                    f = (u, e = m.Small) => {
                        ...
                        switch (t) {
                            case 'basic':
                            case 'plus':
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${E}_${n}`;
                            case 'premium':
                            case 'premium_plus':
                            ...
                            case 'dogTagComponents':
                                return ((u, e, t) => {
                                    const E = w[u];
                                    if (E) {
                                        const n = R.images.gui.maps.icons.dogtags.$dyn(e).$dyn(E),
                                            A = n.$dyn(t);
                            ...
                            case 'dossier_badge':
                                return `R.images.gui.maps.icons.quests.bonuses.badges.${a}.${A}`;
                            case 'dossier_achievement':
                                return `R.images.gui.maps.icons.achievement.${a}.${A}`;
                            case 'xp':
                            case 'xpFactor':
                            ...
                            case 'collectionItem':
                                return `R.images.gui.maps.icons.collectionItems.${a}.${A}`;
                            default:
                ...
                const N = ((u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: n, children: a, mocks: D }) {
                                const i = (0, r.useRef)([]),
                                    o = (t, E, n) => {
                                        var r;
                                        const F = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, r) => {
                                                        const a = 'string' == typeof r ? `${E}.${r}` : E,
                                                            D = A.O.view.addModelObserver(a, e, !0);
                                                        return (n.set(D, t), u && t(F(r)), D);
                                                    },
                                                    readByPath: F,
                                                    createCallback: (u, e) => {
                                                        const t = F(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = O(n.keys()); !(u = t()).done;) r(u.value, e);
                                                    },
                                                    unsubscribe: r,
                                                };
                                            })(E),
                                            ...
                                            B = { mode: t, model: s, externalModel: a, cleanup: o };
                                        return {
                                            model: s,
                                    ...
                                    C = B[0],
                                    c = B[1],
                                    l = (0, r.useState)(() => o(E, n, D)),
                                    d = l[0],
                                    _ = l[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        s.current ? _(o(C, n, D)) : (s.current = !0);
                                    }, [D, C, n]),
                                    (0, r.useEffect)(() => {
                                        c(E);
                                    }, [E]),
                        ...
                        ({ observableModel: u }) => {
                            const e = { rewards: u.array('rewards') };
                            return {
                                computes: {
                                    rewardList: (0, x.Om)(
                                        () => {
                    ...
                    I = 'App_header_96',
                    G = 'App_rewardList_8c',
                    q = 'App_rewardWrapper_89',
                    z = 'App_rewardWrapper__last_7f',
                    $ = 'App_reward_27',
                    V = 'App_decoration_28',
                    Y = 'Header_base_c0',
                    X = 'Header_base__large_fb',
                    j = 'Header_icon_4f',
                    W = 'Header_info_29',
                    H = 'Header_title_8b',
                    K = 'Header_description_95',
                    Z = ({ isLarge: u }) =>
                        F().createElement(
                            'div',
                            { className: n()(Y, u && X) },
                            ...
                            F().createElement(
                                ...
                                F().createElement(
                                    'div',
                                    { className: H },
                                    R.strings.wot_anniversary.tooltip.randomRewardTooltip.header.title(),
                                ),
                                F().createElement(
                                    'div',
                                    { className: K },
                                    R.strings.wot_anniversary.tooltip.randomRewardTooltip.header.description(),
                                ),
                            ),
                        );
                var Q = t(281);
                ...
                const eu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    nu = (u, e, t = J.left) => u.split(e).reduce(t === J.left ? tu : Eu, []),
                    Au = (() => {
                        const u = new RegExp(
                    ...
                    Fu = (u, e = J.left) => {
                        ...
                        return ((u, e = J.left) => {
                            ...
                            const E =
                                ...
                                n = eu(u);
                            return (nu(n, /( )/, e).forEach((u) => (t = t.concat(nu(u, E, J.left)))), t);
                        })(u, e);
                    },
                    au = 'FormatText_base_d0',
                    Du = ({ binding: u, text: e = '', classMix: t, alignment: E = J.left, formatWithBrackets: A }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const a = A && u ? uu(e, u) : e;
                    ...
                    Bu = 'Reward_title_c3',
                    Cu = 'Reward_value_6f',
                    cu = 'Reward_description_5f',
                    lu = ({ icon: u, label: e, value: t, probability: E }) => {
                        return F().createElement(
                            'div',
                            { className: iu },
                            F().createElement('div', { style: { backgroundImage: `url(${u})` }, className: su }),
                            F().createElement(
                                'div',
                                { className: ou },
                                F().createElement(
                                    ...
                                    { className: Bu },
                                    F().createElement(Du, {
                                        text: R.strings.wot_anniversary.tooltip.randomRewardTooltip.body.title(),
                                        binding: {
                                            label: Fu(e),
                                            value: F().createElement(
                                                'div',
                                                { className: Cu },
                                                F().createElement(l, { value: t }),
                                            ),
                                        },
                                    }),
                                ),
                                F().createElement(
                                    'div',
                                    { className: cu },
                                    ((n = R.strings.wot_anniversary.tooltip.randomRewardTooltip.body.description()),
                                    (A = { value: E }),
                                    n.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                    ...
                    du = (0, y.Pi)(() => {
                        const u = L()
                                .model.computes.rewardList()
                                .reduce(
                                    (u, e, t, E) =>
                                        t < E.length - 5
                                            ? (u.push([e, E[t + 5]]), u)
                                            : (u.some((u) => u.includes(e)) || u.push([e]), u),
                                    [],
                                ),
                            e = u.some((u) => u.length > 1);
                        return F().createElement(
                            'div',
                            { className: U },
                            F().createElement('div', { className: I }, F().createElement(Z, { isLarge: e })),
                            F().createElement(
                                'div',
                                { className: G },
                                u.map((e, t) => {
                                    const E = t + 1 === u.length;
                                    return F().createElement(
                                        'div',
                                        { key: t, className: n()(q, E && z) },
                                        e.map((u, e) => {
                                            const t =
                                                'eventCoin' === u.name
                                                    ? 'R.images.gui.maps.icons.wot_anniversary.mainView.eventCoin'
                                                    : f(u);
                                            return F().createElement(
                                                'div',
                                                { key: e, className: $ },
                                                ...
                                                !E && F().createElement('div', { className: V }),
                                            );
                                        }),
                                    );
                                }),
                ...
                engine.whenReady.then(() => {
                    C().render(
                        F().createElement(M, null, F().createElement(s, null, F().createElement(du, null))),
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (a = 0; a < deferred.length; a++) {
                    for (var [e, t, E] = deferred[a], A = !0, r = 0; r < e.length; r++)
                        (!1 & E || n >= E) &&
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    if (A.some((e) => 0 !== u[e])) {
                        ...
                        if (F) var D = F(__webpack_require__);
                    }
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [46], () => __webpack_require__(160));
