(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => A, off: () => s, on: () => o, onResize: () => E, onScaleUpdated: () => a }));
                var n = t(472),
                    r = t(176);
            ...
            172: (u, e, t) => {
                ...
                const p = [
                        ...
                        i.DeluxeGift,
                        i.ModernizedDevicesT1Gift,
                        i.ModernizedDevicesT2Gift,
                        i.ModernizedDevicesT3Gift,
                        i.BattleBoosterGift,
                        i.OptionalDevice,
                        i.Attachment,
                    ],
                    v = [i.Gold, i.Credits, i.Crystal, i.FreeXp],
                    g = [i.BattlePassPoints, i.EquipCoin],
                    b = [i.PremiumPlus, i.Premium],
                ...
                const N = r().forwardRef(function (u, e) {
                    let t = u.children,
                        E = u.className,
                        a = u.theme,
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            k({}, i, {
                                className: s()(O.base, O[`base__theme-${o}`], E),
                                ref: function (u) {
                ...
                let x;
                !(function (u) {
                    ((u.ACTIVE = 'active'), (u.RECEIVED = 'received'), (u.LOCKED = 'locked'));
                })(x || (x = {}));
                var M,
                    I = t(403);
                !(function (u) {
                ...
                const Y = ((u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: a, children: o, mocks: s }) {
                                const i = (0, n.useRef)([]),
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const o = 'string' == typeof E ? `${n}.${E}` : n,
                                                            s = y.O.view.addModelObserver(o, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = z(r.keys()); !(u = t()).done; ) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(n),
                                    ...
                                    l = D[0],
                                    c = D[1],
                                    B = (0, n.useState)(() => A(E, a, s)),
                                    C = B[0],
                                    _ = B[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        F.current ? _(A(l, a, s)) : (F.current = !0);
                                    }, [s, l, a]),
                                    (0, n.useEffect)(() => {
                                        c(E);
                                    }, [E]),
                    ...
                    })(({ observableModel: u }) => ({ root: u.object(), bonuses: u.array('bonuses') }), U),
                    j = Y[0],
                    H = Y[1],
                    X = [
                        'children',
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (K(t, c, { isMouseEvent: !0, on: !0, arguments: W(r) }, b),
                                    m && m(),
                ...
                const au = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        const E = e.contentId;
                        return E ? r().createElement(Q, Eu({}, e, { contentId: E }), n) : r().createElement(uu, e, n);
                    },
                    ou = {
                        base: 'Reward_base_ea',
                    ...
                    su = ({
                        ...
                        return r().createElement(
                            'div',
                            {
                                className: s()(ou.base, ou[`base__${n}`], _.includes(u) && ou.base__normalize, C),
                                style: A,
                            },
                            r().createElement(
                                au,
                                { tooltipArgs: p, className: ou.tooltipWrapper },
                                r().createElement(
                                    r().Fragment,
                                    null,
                                    r().createElement(
                                        'div',
                                        { className: s()(ou.image, null == d ? void 0 : d.image) },
                                        g &&
                                            r().createElement('div', {
                                                className: s()(ou.highlight, null == d ? void 0 : d.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: s()(ou.icon, null == d ? void 0 : d.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        b &&
                                            r().createElement('div', {
                                                className: s()(ou.overlay, null == d ? void 0 : d.overlay),
                                                style: {
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: s()(
                                                    ou.info,
                                                    ou[`info__${u}`],
                                                    o === D.MULTI && ou.info__multi,
                                                    null == d ? void 0 : d.info,
                                                ),
                                            },
                                            w,
                                        ),
                                    i && r().createElement('div', { className: ou.title }, i),
                                ),
                            ),
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: v },
                                    r().createElement('div', {
                                        className: s()(ou.timer, null == d ? void 0 : d.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const Du = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Bu = (u, e, t = Au.left) => u.split(e).reduce(t === Au.left ? lu : cu, []),
                    Cu = (() => {
                        const u = new RegExp(
                    ...
                    du = (u, e = Au.left) => {
                        ...
                        return ((u, e = Au.left) => {
                            ...
                            const n =
                                ...
                                r = Du(u);
                            return (Bu(r, /( )/, e).forEach((u) => (t = t.concat(Bu(u, n, Au.left)))), t);
                        })(u, e);
                    },
                    mu = 'FormatText_base_d0',
                    pu = ({ binding: u, text: e = '', classMix: t, alignment: E = Au.left, formatWithBrackets: a }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const o = a && u ? Fu(e, u) : e;
                        return r().createElement(
                            n.Fragment,
                            null,
                            o.split('\n').map((e, a) =>
                    ...
                    vu = 'CustomizationRewardLabel_base_78',
                    gu = 'CustomizationRewardLabel_count_e9',
                    bu = ({ icon: u, label: e, value: t }) => {
                        const n = Number(t) > 1,
                            E = n ? `${u}WithCount` : u,
                            a = R.strings.wot_anniversary.progressionBoxTooltip.rewards.customizations.$dyn(E);
                        return 'string' != typeof a
                            ? (console.error(
                                  `Add proper label to tooltips.po for msgid "progressionBoxTooltip/rewards/customizations/${E}"`,
                              ),
                              null)
                            : r().createElement(
                                  'div',
                                  ...
                                  r().createElement(pu, {
                                      ...
                                      binding: Object.assign(
                                          { value: e },
                                          n && { count: r().createElement('span', { className: gu }, t) },
                                      ),
                                  }),
                              );
                    },
                    wu = ({ label: u, value: e, bindingKey: t = 'value', bindingStyle: E }) => {
                        const a = (0, n.useMemo)(
                            () => ({ [t]: E ? r().createElement('span', { className: E }, e) : du(String(e)) }),
                            [e, t, E],
                        );
                        return r().createElement(pu, { text: u, binding: a });
                    },
                    Tu = {
                        value: 'LabelResolver_value_4a',
                        value__credits: 'LabelResolver_value__credits_13',
                        value__gold: 'LabelResolver_value__gold_be',
                        value__crystal: 'LabelResolver_value__crystal_e7',
                        value__premiumTank: 'LabelResolver_value__premiumTank_30',
                    },
                    fu = R.strings.wot_anniversary.progressionBoxTooltip.rewards,
                    hu = (u) => {
                        switch (u.name) {
                            case A.Crystal:
                                return r().createElement(wu, {
                                    label: fu.$dyn(u.name),
                                    value: u.value,
                                    bindingStyle: s()(Tu.value, Tu[`value__${u.name}`]),
                                });
                            case A.Customizations:
                                return r().createElement(bu, u);
                            case A.Vehicles:
                                return r().createElement('span', { className: Tu.value__premiumTank }, u.label);
                            case A.BattleAchievement:
                                return r().createElement(wu, { label: fu.$dyn(u.name), value: u.label });
                            case 'styleProgress':
                                return r().createElement(wu, {
                                    label: fu.styleProgress.$dyn(u.overlayType),
                                    value: u.label,
                                });
                            default:
                    ...
                    Ru = 'TooltipReward_base_29',
                    yu = 'TooltipReward_details_ad';
                function Pu() {
                    return (
                        (Pu =
                            Object.assign ||
                ...
                const Ou = (u) => {
                        ...
                        return r().createElement(
                            'div',
                            { className: Ru },
                            r().createElement(su, Pu({}, e, { size: F.Small })),
                            r().createElement('div', { className: yu }, r().createElement(hu, e)),
                        );
                    },
                    Su = {
                        base: 'App_base_d0',
                        title: 'App_title_6e',
                        subTitle: 'App_subTitle_d2',
                        rewardsLabel: 'App_rewardsLabel_b4',
                        rewards: 'App_rewards_fe',
                        reward: 'App_reward_d1',
                        overlay__epic: 'App_overlay__epic_c7',
                        overlay__legendary: 'App_overlay__legendary_ab',
                        overlay__rare: 'App_overlay__rare_2f',
                        overlay__styleProgress: 'App_overlay__styleProgress_ed',
                        info: 'App_info_39',
                        divider: 'App_divider_1e',
                        status: 'App_status_1a',
                        check: 'App_check_05',
                        received: 'App_received_de',
                        lock: 'App_lock_24',
                        locked: 'App_locked_6d',
                        envelopesLeft: 'App_envelopesLeft_70',
                    };
                function ku() {
                    return (
                        (ku =
                ...
                const Nu = R.strings.wot_anniversary.progressionBoxTooltip,
                    xu = (0, I.Pi)(() => {
                        const u = H().model,
                            e = u.root.get(),
                            t = e.state,
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: Su.base },
                                r().createElement('div', { className: Su.title }, Nu.title()),
                                r().createElement('div', { className: Su.subTitle }, Nu.description()),
                                r().createElement('div', { className: Su.rewardsLabel }, Nu.contains()),
                                r().createElement(
                                    'div',
                                                ...
                                                r().createElement(
                                                    ...
                                                    ku({}, u, {
                                                        ...
                                                        classNames: {
                                                            overlay: s()(
                                                                Su.overlay,
                                                                'styleProgress' === u.name
                                                                    ? Su.overlay__styleProgress
                                                                    : Su[`overlay__${u.overlayType}`],
                                                            ),
                                                            info: Su.info,
                                                        },
                                                    }),
                                    ...
                                    Array.isArray(E)
                                        ? E.map(a)
                                        : E.map((u, e, t) => a(null == u ? void 0 : u.value, e, t))),
                                ),
                                r().createElement(
                                    'div',
                                    { className: Su.status },
                                        ...
                                        switch (t) {
                                            case x.ACTIVE:
                                                return r().createElement(
                                                    r().Fragment,
                                                    null,
                                                    r().createElement('div', null, Nu.active()),
                                                    r().createElement('div', { className: Su.envelopesLeft }, n),
                                                );
                                            case x.LOCKED:
                                                return r().createElement(
                                                    r().Fragment,
                                                    null,
                                                    r().createElement('div', { className: Su.lock }),
                                                    r().createElement('div', { className: Su.locked }, Nu.locked()),
                                                );
                                            case x.RECEIVED:
                                                return r().createElement(
                                                    r().Fragment,
                                                    null,
                                                    r().createElement('div', { className: Su.check }),
                                                    r().createElement('div', { className: Su.received }, Nu.received()),
                                                );
                                            default:
                                                return null;
                                        }
                ...
                engine.whenReady.then(() => {
                    a().render(
                        r().createElement(j, null, r().createElement(xu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [46], () => __webpack_require__(172));
