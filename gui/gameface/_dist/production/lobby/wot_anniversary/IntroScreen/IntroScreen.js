(() => {
    var __webpack_modules__ = {
            ...
            768: (u, e, t) => {
                ...
                var r = {};
                (t.r(r),
                    t.d(r, { mouse: () => B, off: () => l, on: () => s, onResize: () => o, onScaleUpdated: () => F }));
                var a = {};
                (t.r(a),
                    t.d(a, {
                        events: () => r,
            ...
            889: (u, e, t) => {
                ...
                const C = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.largeWidth && l) return n(e, t, p);
                ...
                const d = (u) => {
                    ...
                    _ = ({ children: u }) => {
                        ...
                        return a().createElement(B.Provider, { value: l }, u);
                    };
                var m = t(483),
                    h = t.n(m),
                    g = t(926),
                ...
                const y = {
                    ...
                    M = (u) => {
                        ...
                        const n = f(),
                            ...
                            E = n.mediaHeight,
                            A = n.mediaSize;
                        return a().createElement('div', T({ className: h()(t, y[i], L[E], S[A]) }, r), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                    ...
                    return a().createElement(_, null, a().createElement(M, t, e));
                };
                var H = t(493),
                    W = t.n(H);
                function P(u) {
                ...
                const U = ({
                    ...
                    return (
                        ...
                        a().createElement(
                            ...
                            a().createElement(
                                'span',
                                { className: h()(N.state, N.state__default) },
                ...
                class q extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = h()(j.base, j[`base__${i}`], j[`base__${n}`], null == E ? void 0 : E.base),
                            B = h()(j.icon, j[`icon__${i}`], j[`icon__${n}`], null == E ? void 0 : E.icon),
                            c = h()(j.glow, null == E ? void 0 : E.glow),
                            C = h()(j.caption, j[`caption__${i}`], null == E ? void 0 : E.caption),
                            d = h()(j.goto, null == E ? void 0 : E.goto);
                    ...
                    au = (u, e = X.left) => {
                        ...
                        return ((u, e = X.left) => {
                            ...
                            const r =
                                ...
                                a = Q(u);
                            return (eu(a, /( )/, e).forEach((u) => (t = t.concat(eu(u, r, X.left)))), t);
                        })(u, e);
                    };
                t(916);
                var nu = t(613);
                Date.now();
                const iu = nu.Ew.getRegionalDateTime;
                nu.Ew.getFormattedDateTime;
                var Eu = t(521);
                const Au = (u) => {
                    console.error(u.type + ': useKeydownListener hook :: Callback is not defined');
                };
                function ou(u = Eu.n.NONE, e = Au, t = !1, a = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Eu.n.NONE)
                            return (
                ...
                const Cu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: E, children: A, mocks: o }) {
                                const F = (0, r.useRef)([]),
                                    ...
                                    B = D[0],
                                    c = D[1],
                                    C = (0, r.useState)(() => s(n, E, o)),
                                    d = C[0],
                                    _ = C[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? _(s(B, E, o)) : (l.current = !0);
                                    }, [o, B, E]),
                                    (0, r.useEffect)(() => {
                                        c(n);
                                    }, [n]),
                        ...
                        ({ observableModel: u }) =>
                            Object.assign({}, u.primitives(['startTime', 'endTime']), { vehicle: u.object('vehicle') }),
                        ({ externalModel: u }) => ({
                            close: u.createCallbackNoArgs('onClose'),
                            accept: u.createCallbackNoArgs('onAccept'),
                        }),
                    ),
                    du = Cu[0],
                    _u = Cu[1],
                    mu = 'FormatText_base_d0',
                    hu = ({ binding: u, text: e = '', classMix: t, alignment: n = X.left, formatWithBrackets: i }) => {
                ...
                const pu = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    yu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((A = A.replace(t, `%(${E})`)),
                                    (i[E] = bu[u]
                                        ? a().createElement(
                                              'span',
                                              { className: bu[u] },
                                              a().createElement(hu, { text: s, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: n(u) },
                        ...
                        return a().createElement(hu, { text: A, classMix: t, binding: i });
                    });
                let Lu;
                !(function (u) {
                    ((u.TEAM = 'team'), (u.MISSIONS = 'missions'), (u.REWARDS = 'rewards'));
                })(Lu || (Lu = {}));
                const Su = 'InfoBlock_base_07',
                    Mu = 'InfoBlock_typeContainer_da',
                    Ou = 'InfoBlock_type_9e',
                    ku = 'InfoBlock_subtitle_0b',
                    Ru = {
                        base: 'InfoBlockItem_base_76',
                        content: 'InfoBlockItem_content_55',
                        icon: 'InfoBlockItem_icon_de',
                        icon__team: 'InfoBlockItem_icon__team_1e',
                        icon__missions: 'InfoBlockItem_icon__missions_76',
                        icon__rewards: 'InfoBlockItem_icon__rewards_ac',
                        titleWrapper: 'InfoBlockItem_titleWrapper_18',
                        title: 'InfoBlockItem_title_4d',
                        subtitleWrapper: 'InfoBlockItem_subtitleWrapper_16',
                    },
                    Hu = ({ icon: u, title: e, subtitle: t }) => {
                        const r = h()(Ru.icon, Ru[`icon__${u}`]);
                        return a().createElement(
                            'div',
                            { className: Ru.base },
                            a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    a().createElement('div', { className: Ru.title }, e),
                                ),
                                a().createElement('div', { className: Ru.subtitleWrapper }, t),
                            ),
                        );
                    },
                    Wu = R.strings.wot_anniversary.introScreen.infoBlock,
                    Pu = (0, Fu.Pi)(() => {
                        const u = _u().model.vehicle.get(),
                            e = u.vehicleLvl,
                            t = u.vehicleName,
                            r = u.vehicleType,
                            n = u.isElite,
                            i = r.replace(/-/g, '_');
                        const E = R.images.gui.maps.icons.vehicleTypes.big.$dyn(`${i}${n ? '_elite' : ''}`);
                        return a().createElement(
                            'div',
                            { className: Su },
                            a().createElement(Hu, {
                                icon: Lu.TEAM,
                                title: a().createElement(hu, {
                                    text: Wu.first.title(),
                                    binding: {
                                        vehicleLvl: wu(e),
                                        rewardTankType: a().createElement(
                                            'div',
                                            { className: Mu },
                                            a().createElement('div', {
                                                className: Ou,
                                ...
                                subtitle: a().createElement(hu, {
                                    text: Wu.first.subtitle(),
                                    binding: {
                                        vehicleName: a().createElement(yu, {
                                            text: Wu.rewardTankName(),
                            ...
                            a().createElement(Hu, {
                                icon: Lu.MISSIONS,
                                title: Wu.second.title(),
                                subtitle: a().createElement(hu, {
                                    text: Wu.second.subtitle(),
                                    binding: { minTier: wu(4), maxTier: wu(10) },
                                    classMix: ku,
                                }),
                            }),
                            a().createElement(Hu, {
                                icon: Lu.REWARDS,
                                title: Wu.third.title(),
                                subtitle: Wu.third.subtitle(),
                            }),
                        );
                    }),
                    Nu = 'App_base_53',
                    Iu = 'App_close_4b',
                    Gu = 'App_buttonWrapper_cd',
                    Uu = 'App_button_07',
                    $u = 'App_headerWrapper_96',
                    ju = 'App_infoBlock_5a',
                    zu = 'App_title_64',
                    Vu = 'App_date_2a',
                    qu = R.strings.wot_anniversary,
                    Ku = (0, Fu.Pi)(() => {
                        const u = _u(),
                            e = u.model,
                            t = u.controls;
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'span',
                                        { className: Vu },
                                        ((n = R.strings.wot_anniversary.introScreen.duration()),
                                        (i = {
                                            startTime: iu(e.startTime.get(), K.DayMonthFull),
                                            endTime: iu(e.endTime.get(), K.DayMonthFull),
                                        }),
                                        n.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                                    ...
                                    a().createElement('span', { className: zu }, qu.introScreen.title()),
                                ),
                                a().createElement('div', { className: ju }, a().createElement(Pu, null)),
                                a().createElement(
                                    'div',
                                    { className: Gu },
                                    a().createElement(
                ...
                engine.whenReady.then(() => {
                    W().render(
                        a().createElement(k, null, a().createElement(du, null, a().createElement(Ku, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [46], () => __webpack_require__(889));
