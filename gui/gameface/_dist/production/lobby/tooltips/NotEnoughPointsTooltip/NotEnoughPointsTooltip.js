(() => {
    ...
    var __webpack_modules__ = {
            70: (u, e, t) => {
                ...
                var n = {};
                (t.r(n),
                    t.d(n, { mouse: () => d, off: () => F, on: () => A, onResize: () => E, onScaleUpdated: () => c }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        events: () => n,
                ...
                const p = {
                    ...
                    m = Object.keys(v).reduce((u, e) => ((u[e] = () => D(v[e])), u), {}),
                    f = { play: Object.assign({}, m, { sound: D }), setRTPC: B };
                var g = t(9690);
                function b(u, e, t = 1) {
                ...
                const ru = { view: i, client: r, sound: f, intl: h };
            },
            5521: (u, e, t) => {
                let n, r;
                (t.d(e, { n: () => n }),
            ...
            5664: (u, e, t) => {
                ...
                const l = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            F({}, l, {
                                className: a()(c.base, c[`base__theme-${s}`], o),
                                ref: function (u) {
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (_(t, d, { isMouseEvent: !0, on: !0, arguments: B(r) }, w),
                                    m && m(),
                ...
                const y = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const o = e.contentId;
                    return o ? r().createElement(C, w({}, e, { contentId: o }), n) : r().createElement(v, e, n);
                };
                var k = t(8045);
                const T = {
                    ...
                    V = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? M[n]
                                ? r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: a()(I, M[n]) },
                                      u,
                                  )
                                : r().createElement(
                                      'span',
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            }
                            {
                                const u = t.children,
                                    c = e[E],
                                    F = c.props.children,
                                    l = J(u, F, u.length - 1, n, o, i),
                                    d = l[0],
                                    D = l[1];
                                if (!(d < 0)) {
                                    const u = F.slice(0, d);
                                    ((a = r().cloneElement(c, c.props, u, D)), (s = E));
                                    break;
                                }
                                o -= A.length;
                            }
                    ...
                    uu = r().memo(
                        ({
                            ...
                            const d = (0, n.useRef)(null),
                                ...
                                _ = B[0],
                                C = B[1],
                                p = (0, n.useMemo)(() => $(u, o, { justifyContent: A }), [o, A, u]),
                                h = (0, n.useMemo)(() => {
                                    if (
                                        i &&
                                        _.isTruncated &&
                            ...
                            return (
                                ...
                                r().createElement(
                                    ...
                                    r().createElement('div', { className: T.unTruncated, ref: d }, p),
                                    r().createElement(
                                        y,
                                        {
                                            tooltipArgs: h,
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: a()(
                                                    T.truncated,
                                                    !_.isTruncateFinished && s && T.truncated__hide,
                                                ),
                                                style: m,
                                            },
                ...
                const ru = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const a = (0, n.useRef)([]),
                                    c = (u, t, n) => {
                                        ...
                                        const o = (function ({
                                            ...
                                            A = (({ observableModel: u }) => ({ points: u.object('points') }))({
                                                mode: u,
                                                readByPath: s,
                                                externalModel: i,
                                                observableModel: {
                                            ...
                                            F = { mode: u, model: A, externalModel: i, cleanup: c };
                                        return {
                                            model: A,
                                    ...
                                    l = F[0],
                                    d = F[1],
                                    D = (0, n.useState)(() => c(u, o, s)),
                                    B = D[0],
                                    _ = D[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        A.current ? _(c(l, o, s)) : (A.current = !0);
                                    }, [s, l, o]),
                                    (0, n.useEffect)(() => {
                                        d(u);
                                    }, [u]),
                    ...
                    su = ou[1],
                    au = () => {
                        const u = su().model.points.get(),
                            e = (0, n.useMemo)(
                                () => ({
                                    points: r().createElement('span', { className: 'NotEnoughPointsApp_points_9a' }, u),
                ...
                engine.whenReady.then(() => {
                    i().render(
                        r().createElement(iu, null, r().createElement(au, null)),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/tooltips/NotEnoughPointsTooltip/NotEnoughPointsTooltip'),
        (() => {
            var u = { 'lobby/tooltips/NotEnoughPointsTooltip/NotEnoughPointsTooltip': 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, ['lib/frontline.vendors'], () => __webpack_require__(5664));
