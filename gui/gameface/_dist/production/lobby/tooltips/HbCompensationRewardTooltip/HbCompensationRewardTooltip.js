        ...
        e = {
            ...
            410: (u, e, t) => {
                ...
                const Du = $.client.getSize('rem'),
                    ...
                    lu = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.smallWidth && C) return Au(e, t, g);
                            if (t.extraSmallWidth && l) return Au(e, t, g);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                ...
                const vu = {
                    ...
                    Su = hu((u) => {
                        let e = u.className,
                            ...
                            S = u.wrap,
                            L = u.flexWrap,
                            M = void 0 === L ? (S ? 'wrap' : void 0) : L,
                            R = u.grow,
                            y = u.shrink,
                            T = u.flex,
                            H = void 0 === T ? (R || y ? `${R ? 1 : 0} ${y ? 1 : 0} auto` : void 0) : T,
                            O = u.style,
                            P = u.children,
                            N = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const W = (0, U.useMemo)(() => {
                            ...
                            }, [t, A, r, n, i, l, O, H, w, c, M, f, b]),
                            G = W.computedStyle,
                            X = W.computedClassNames;
                        return K().createElement('div', fu({ className: a()(xu.base, ...X, e), style: G }, N), P);
                    });
                let Lu;
                !(function (u) {
                ...
                const Mu = (u, e, t) => {
                    ...
                    yu = (u, e, t = Lu.left) => u.split(e).reduce(t === Lu.left ? Mu : Ru, []),
                    Tu = (() => {
                        const u = new RegExp(
                            ...
                            Xu(
                                {
                                    ...
                                    ml: !0 === o ? Vu[t || 'paragraph-P16'].ml : o,
                                },
                                c,
                            ),
                            void 0 !== s ? K().createElement(Ou, Xu({}, s, { text: e })) : e,
                        );
                    }),
                ...
                const ee = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    Ae = te[0],
                    Ee = te[1],
                    Fe = 'App_description_aa',
                    re = 'App_highlight_13',
                    De = 'App_divider_75',
                    ae = R.strings.hb_tooltips.hbCompensationRewardTooltip,
                    ne = (0, Qu.observer)(() => {
                                        ...
                                        qu
                                            ...
                                            : (function (u) {
                                                  ...
                                                  for (let t = Yu.length - 1; t >= 0; t--)
                                                      for (; u >= Yu[t];) ((e += Ku[t]), (u -= Yu[t]));
                                                  return e;
                                              })(r)),
                                }),
                                vehicleName: K().createElement(Uu, { className: re, text: t }),
                            };
                        var r;
                        return K().createElement(
                            'div',
                            { className: 'App_base_a1' },
                            K().createElement(
                                'div',
                                { className: 'App_textContainer_68' },
                                K().createElement(Uu, {
                                    className: 'App_title_e5',
                                    text: R.strings.tooltips.$dyn(A).header(),
                                }),
                                K().createElement(Uu, { className: Fe, text: ae.subtitle(), format: { binding: F } }),
                            ),
                            K().createElement('div', { className: De }),
                            K().createElement(
                                'div',
                                { className: 'App_compensationContainer_00' },
                                K().createElement('div', { className: 'App_background_d2' }),
                                K().createElement(
                                    'div',
                                    { className: 'App_exchangeReward_83' },
                                    K().createElement(
                                        'div',
                                        { className: 'App_compensationBlock_8a' },
                                        K().createElement('div', { className: 'App_discountIcon_05' }),
                                        K().createElement(Uu, {
                                            className: Fe,
                                            text: R.strings.hb_lobby.hbMainDiscountTooltip.title(),
                                        }),
                                    ),
                                    K().createElement('div', { className: 'App_compensationArrow_d1' }),
                                    K().createElement(
                                        'div',
                                        { className: 'App_compensationReward_0f' },
                                        K().createElement('div', { className: 'App_rewardIcon_3f' }),
                                        K().createElement(Uu, { className: 'App_rewardAmount_16', text: String(E) }),
                                    ),
                                ),
                            ),
                            K().createElement('div', { className: De }),
                            K().createElement(
                                'div',
                                { className: 'App_footerContainer_0a' },
                                K().createElement('div', { className: 'App_compensationIcon_aa' }),
                                K().createElement(Uu, { className: Fe, text: ae.description() }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    uu().render(
                        K().createElement(Ae, null, K().createElement(Z, null, K().createElement(ne, null))),
