(() => {
    ...
    var __webpack_modules__ = {
            7405: (u, e, t) => {
                ...
                const i = ({
                    ...
                    const C = n()(o.Z.value, o.Z[`value__${r}`], !E && o.Z.value__notEnough),
                        B = n()(o.Z.icon, o.Z[`icon__${r}-${t}`]),
                        _ = n()(o.Z.stock, D && o.Z.stock__indent, e && o.Z.stock__interactive),
                        l = s && i > 0 && '+',
                        d = n()(o.Z.base, o.Z[`base__${t}`]);
                    return A().createElement(
                        ...
                        A().createElement(
                            ...
                            { className: C },
                            l,
                            A().createElement(a.A, { value: i, format: r === F.V2.gold ? 'gold' : 'integral' }),
                        ),
            ...
            280: (u, e, t) => {
                ...
                var r = t(6179),
                    ...
                    F = t(3649),
                    a = t(5287);
                const o = ({ binding: u, text: e = '', classMix: t, alignment: E = F.v2.left }) =>
                    null === e
                        ...
                        : n().createElement(
                              ...
                              e.split('\n').map((e, o) =>
                                  n().createElement(
                                      'div',
                                      { className: A()(a.Z.base, t), key: `${e}-${o}` },
            ...
            3649: (u, e, t) => {
                ...
                const n = (u, e, t) => {
                    ...
                    A = (u, e, t = r.left) => u.split(e).reduce(t === r.left ? n : E, []),
                    F = (() => {
                        const u = new RegExp(
                                      ...
                                      return a.includes(t)
                                          ...
                                          : ((u, e = r.left) => {
                                                ...
                                                const n =
                                                    ...
                                                    E = u.replace(/&nbsp;/g, ' ');
                                                return (
                                                    A(E, /( )/, e).forEach((u) => (t = t.concat(A(u, n, r.left)))), t
                                                );
                                            })(u, e);
                                  })(u, e),
                        );
            ...
            1596: (u, e, t) => {
                ...
                const D = ({
                    ...
                    const C = A()(i.Z.value, i.Z[`value__${t}`], !E && i.Z.value__notEnough),
                        B = A()(i.Z.icon, i.Z[`icon__${t}`]),
                        _ = A()(
                            i.Z.stock,
                            s && i.Z.stock__indent,
                            t === o.et.big && i.Z.stock__sizeBig,
                            t === o.et.large && i.Z.stock__sizeLarge,
                            e && i.Z.stock__interactive,
                        ),
                        l = c && D > 0 && '+';
                    return r in o.V2
                        ? n().createElement(a.F, {
                        ...
                        : n().createElement(
                              ...
                              u &&
                                  n().createElement(
                                      'span',
                                      { className: _ },
                                      n().createElement('span', { className: i.Z.stockBackground }),
                                      Boolean(s) && s,
                                  ),
                          );
                };
                ...
                const i = F().memo(
                    ({
                        ...
                        const c = !D && Boolean(e.length),
                            C = n()(o.Z.price, c && o.Z.price__discount);
                ...
                const c = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            s({}, c, {
                                className: a()(i.base, i[`base__theme-${F}`], E),
                                ref: function (u) {
                                    (B.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            n().createElement('div', { className: i.decorator }, t),
                        )
                    );
                });
                var C = t(3403),
                ...
                const p = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: A, mocks: F }) {
                                const a = (0, r.useRef)([]),
                                    i = (u, t, r) => {
                                        ...
                                        const E = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const F = 'string' == typeof E ? `${r}.${E}` : r,
                                                            a = o.O.view.addModelObserver(F, e, !0);
                                            ...
                                            D = (({ observableModel: u }) => {
                                                const e = {
                                                        root: u.object(),
                                                        labels: u.object('price'),
                                                        testDrive: {
                                                            priceID: u.object('price.testDrivePrice'),
                                                            price: u.array('price.testDrivePrice.price'),
                                                            defPrice: u.array('price.testDrivePrice.defPrice'),
                                                            discount: u.array('price.testDrivePrice.discount'),
                                                        },
                                                        rentDrive: {
                                                            priceID: u.object('price.rentPrice'),
                                                            price: u.array('price.rentPrice.price'),
                                                            defPrice: u.array('price.rentPrice.defPrice'),
                                                            discount: u.array('price.rentPrice.discount'),
                                                        },
                                                    },
                                                    t = (u) => () =>
                                            ...
                                            s = { mode: u, model: D, externalModel: A, cleanup: i };
                                        return {
                                            model: D,
                                    ...
                                    c = s[0],
                                    C = s[1],
                                    B = (0, r.useState)(() => i(u, E, F)),
                                    p = B[0],
                                    b = B[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        D.current ? b(i(c, E, F)) : (D.current = !0);
                                    }, [F, c, E]),
                                    (0, r.useEffect)(() => {
                                        C(u);
                                    }, [u]),
                                    ...
                                    n().createElement(t.Provider, { value: p }, A)
                                );
                            },
                            () => (0, r.useContext)(t),
                        ];
                    ...
                    w = (0, C.Pi)(() => {
                        const u = h().model,
                            ...
                            r = e.testDrivePrice,
                            E = e.showBrCoinInfo,
                            A = e.hasRentPriceBrCoin;
                        return n().createElement(
                            'div',
                            { className: 'Content_base_23' },
                            n().createElement(
                                'div',
                                { className: 'Content_title_89' },
                                R.strings.battle_royale.tooltips.testDriveInfo.title(),
                            ),
                            n().createElement(B.n, {
                                showBrCoinInfo: E(),
                                showTestDrivePrice: !0,
                                testDrivePrice: r(),
                                rentPrice: t(),
                                labels: u.labels.get(),
                                hasRentPriceBrCoin: A(),
                    ...
                    f = () => n().createElement(c, null, n().createElement(w, null));
                engine.whenReady.then(() => {
                    A().render(n().createElement(b, null, n().createElement(f, null)), document.getElementById('root'));
                });
            },
            1388: (u, e, t) => {
                t.d(e, { R: () => a });
            ...
            6247: (u, e, t) => {
                                ...
                                (c = c.replace(t, `%(${o})`)),
                                    (A[o] = a[u]
                                        ? E().createElement(
                                              'span',
                                              { className: a[u] },
                                              E().createElement(F.z, { text: B, binding: e }),
                                          )
                                        : E().createElement(
                                              'span',
                                              { style: r(u) },
                ...
                var c = t(1388);
                const C = 'RentPrice_separator_5a';
                function B() {
                    return (
                        (B =
                            Object.assign ||
                ...
                const _ = R.strings.battle_royale.tooltips.testDriveInfo,
                    l = ({
                        showBrCoinInfo: u,
                                    ...
                                    E().createElement(
                                        ...
                                        e
                                            ? E().createElement(
                                                  E().Fragment,
                                                  null,
                                                  E().createElement(c.R, { price: t, label: o }),
                                                  E().createElement('div', { className: 'RentPrice_arrowIcon_2c' }),
                                                  E().createElement(c.R, { price: n, label: i }),
                                              )
                                            : E().createElement(
                                                  E().Fragment,
                                                  null,
                                                  ...
                                                  E().createElement('div', { className: 'RentPrice_priceLabel_5a' }, i),
                                              ),
                                    ),
                                ),
                                a && E().createElement('div', { className: C }),
                            ),
                            u &&
                                a &&
                                E().createElement(
                                    ...
                                    E().createElement(s, { text: _.footer() }),
                                ),
                        );
                    };
            },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(9516));
