(() => {
    ...
    var __webpack_modules__ = {
            ...
            4158: (u, e, A) => {
                ...
                const h = (u, e, A) => {
                    ...
                    y = 'Content_textWrapper_11',
                    T = 'Content_subtitle_12',
                    x = 'Content_text_19',
                    M = R.strings.event.WtEventAmmunitionTooltipView,
                    k = B()(y, 'Content_textWrapper__hasGradient_ef'),
                    N = () => {
                        const u = m('model', w.None),
                            ...
                            n = u.subtitle,
                            C = u.text,
                            r = u.additionalInfoText,
                            i = (0, F.useMemo)(() => ({ backgroundImage: `url(${e})` }), [e]),
                            o = B()('Content_base_d2', t && 'Content_base__hasAnimation_13'),
                            a = (0, F.useState)(!1),
                            s = a[0],
                            c = a[1];
                        return (
                            (0, F.useEffect)(() => {
                                t && s && swfPlayer.play(t);
                            }, [t, s]),
                            E().createElement(
                                'div',
                                { className: o },
                                E().createElement('div', { className: 'Content_icon_89', style: i }),
                                E().createElement('div', { className: 'Content_title_20' }, A),
                                E().createElement('div', { className: 'Content_description_71' }, D),
                                t
                                    ? E().createElement(
                                          E().Fragment,
                                          null,
                                          E().createElement('img', {
                                              className: 'Content_animation_e0',
                                          ...
                                          E().createElement(
                                              'div',
                                              { className: y },
                                              E().createElement('div', { className: T }, n),
                                              E().createElement(P, { text: C, classMix: x }),
                                          ),
                                          E().createElement(
                                              'div',
                                              { className: 'Content_additionalTextWrapper_a3' },
                                              E().createElement('div', { className: T }, M.additionalInfoTitle()),
                                              E().createElement(P, { text: r, classMix: x }),
                                          ),
                                      )
                                    : E().createElement(
                                          'div',
                    ...
                    S = () => E().createElement(a, null, E().createElement(N, null));
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4158));
