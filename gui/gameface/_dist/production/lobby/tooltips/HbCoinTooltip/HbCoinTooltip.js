(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                'use strict';
                t.d(e, { Sw: () => i.Z, B3: () => A, Z5: () => a, B0: () => E, ry: () => m });
                class r {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            4531: (u, e, t) => {
                ...
                const _ = n().forwardRef(function (u, e) {
                    let t = u.children,
                        i = u.className,
                        a = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            F({}, _, {
                                className: E()(A.base, A[`base__theme-${o}`], i),
                                ref: function (u) {
                ...
                const c = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    C = (u, e, t = D.left) => u.split(e).reduce(t === D.left ? B : d, []),
                    m = (() => {
                        const u = new RegExp(
                ...
                let g;
                var p;
                (((p = g || (g = {})).SHORT_DATE = 'short-date'),
                    (p.SHORT_TIME = 'short-time'),
                    (p.SHORT_DATE_TIME = 'short-date-time'),
                    (p.FULL_DATE = 'full-date'),
                    (p.FULL_DATE_TIME = 'full-date-time'),
                    (p.MONTH = 'month'),
                    (p.MONTH_DATE = 'month-date'),
                    (p.DATE_MONTH = 'date-month'),
                    (p.MONTH_YEAR = 'month-year'),
                    (p.WEEK_DAY = 'week-day'),
                    (p.WEEK_DAY_TIME = 'week-day-time'),
                    (p.YEAR = 'year'),
                    ...
                    return (
                        w(() => {
                            if (
                                                ...
                                                const e = x(),
                                                    ...
                                                    n =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: n, modelPath: T(n, ''), resId: r };
                                            })(),
                                            t = e.modelPrefix,
                                            r = u.split('.');
                                        if (r.length > 0) {
                                ...
                                F.current = S.addCallback(r, t, o, e === L.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (e !== L.None)
                                return () => {
                                    S.removeCallback(F.current, o);
                                };
                        }, [o, e]),
                        A
                    );
                ...
                const W = l.O.client.getSize('rem'),
                    I = W.width,
                    z = W.height,
                    G = Object.assign({ width: I, height: z }, P(I, z, k)),
                    U = (0, r.createContext)(G),
                    j = ['children'],
                    V = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        const n = (0, r.useContext)(U),
                            ...
                            h = { extraLarge: c, large: B, medium: d, small: C, extraSmall: m };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && A) return O(e, t, h);
                            if (t.largeWidth && s) return O(e, t, h);
                    ...
                    (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(U),
                            ...
                            o = (0, r.useCallback)((u, e) => {
                                ...
                                a(Object.assign({ width: t, height: r }, P(t, r, k)));
                            }, []);
                        (w(() => {
                        ...
                        return n().createElement(U.Provider, { value: E }, u);
                    }),
                    (function (u) {
                ...
                const Y = ['xl', 'lg', 'md', 'sm', 'xs'],
                    q = (u) => u.includes('_') && ((u) => Y.includes(u))(u.split('_').at(-1)),
                    Z = [X.ExtraLarge, X.Large, X.Medium, X.Small, X.ExtraSmall],
                    Q = (u, e) =>
                    ...
                    J = (u, e = Q) => {
                        ...
                        return n().memo((e) =>
                            Object.keys(e).some((u) => q(u) && void 0 !== e[u])
                                ? n().createElement(t, e)
                                : n().createElement(u, e),
                        );
                    },
                ...
                const ru = {
                    ...
                    au = J((u) => {
                        let e = u.className,
                            ...
                            d = u.row,
                            C = u.flexDirection,
                            m = void 0 === C ? (B ? 'column' : d && 'row') || void 0 : C,
                            h = u.flexStart,
                            g = u.center,
                            p = u.flexEnd,
                            b = u.spaceBetween,
                            ...
                            O = u.shrink,
                            k = u.flex,
                            R = void 0 === k ? (H || O ? `${H ? 1 : 0} ${O ? 1 : 0} auto` : void 0) : k,
                            N = u.style,
                            P = u.children,
                            W = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const I = (0, r.useMemo)(() => {
                                const u = { mt: l, mr: s, mb: _, ml: c },
                                    e = ((u) =>
                                        nu.reduce((e, t) => {
                                            const r = u[t];
                                            return r && 'number' != typeof r ? e.concat(ru[!0 === r ? 'MD' : r][t]) : e;
                                        }, []))(u),
                                    r = ((u) =>
                                        nu.reduce((e, t) => {
                                            const r = u[t];
                                            return ('number' == typeof r && (e[iu[t]] = r + 'rem'), e);
                                        }, {}))(u);
                                return {
                            ...
                            }, [t, i, l, s, _, c, N, R, S, m, M, w, T]),
                            z = I.computedStyle,
                            G = I.computedClassNames;
                        return n().createElement('div', tu({ className: E()(uu.base, ...G, e), style: z }, W), P);
                    }),
                    ou = ({ binding: u, text: e = '', classMix: t, alignment: i = D.left }) =>
                        null === e
                ...
                const _u = Object.keys(lu()),
                    ...
                    mu = J((u) => {
                        ...
                        return n().createElement(
                            ...
                            Fu(
                                {
                                    className: E()(Au.base, t && Au[t], p, i),
                                    style: g,
                                    mt: !0 === A ? du[t || 'paragraph-P16'].mt : A,
                                    mr: !0 === F ? du[t || 'paragraph-P16'].mr : F,
                                    mb: !0 === D ? du[t || 'paragraph-P16'].mb : D,
                                    ml: !0 === B ? du[t || 'paragraph-P16'].ml : B,
                                },
                                m,
                            ),
                            void 0 !== C ? n().createElement(ou, Fu({}, C, { text: e })) : e,
                        );
                    }),
                    hu = {
                    ...
                    gu = /(?:%\(|{)\w*(?:_[Oo]pen|Start)(?:\)s|})?(.*?)(?:%\(|{)\w*(?:_[Cc]lose|End)(?:\)s|})?/g,
                    pu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    bu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    xu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((E = E.replace(t, `%(${o})`)),
                                    (a[o] = hu[u]
                                        ? n().createElement(
                                              'span',
                                              { className: hu[u] },
                                              n().createElement(ou, { text: s, binding: e }),
                                          )
                                        : n().createElement(
                                              'span',
                                              { style: i(u) },
                        ...
                        return n().createElement(ou, { text: E, classMix: t, binding: a });
                    }),
                    fu = [
                        'children',
                        'contentId',
                ...
                const vu = (u, e, t = {}, r = 0) => {
                    ...
                    Tu = (u) => {
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            b = (0, r.useMemo)(() => C || x().resId, [C]),
                            f = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (vu(t, D, { isMouseEvent: !0, on: !0, arguments: wu(n) }, b),
                                    m && m(),
                ...
                const Ou = R.views.common.tooltip_window.simple_tooltip_content,
                    ku = (u) => {
                        ...
                        const A = (0, r.useMemo)(() => {
                            const u = Object.assign({}, E, { body: t, header: i, note: a, alert: o });
                            ...
                            Hu(
                                {
                                    contentId:
                                        ...
                                        s ? Ou.SimpleTooltipHtmlContent('resId') : Ou.SimpleTooltipContent('resId')),
                ...
                const Nu = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return n().createElement(ku, e, r);
                    const i = e.contentId,
                        a = e.args,
                        o = null == a ? void 0 : a.contentId;
                    return i || o
                        ? n().createElement(Tu, Ru({}, e, { contentId: i || o }), r)
                ...
                const Uu = { [Gu.NBSP]: Iu.NoBreakSymbol, [Gu.ZWNBSP]: Iu.NoBreakSymbol, [Gu.NEW_LINE]: Iu.LineBreak },
                    ju = {
                    ...
                    Xu = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return r
                            ? ju[r]
                                ? n().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: ju[r] },
                                      u,
                                  )
                                : n().createElement('span', { key: t, 'data-block-type': e.blockType, style: Vu(r) }, u)
                            ...
                            u.childList.forEach((n, i) => {
                                ...
                                if (((u) => void 0 !== u.childList)(n)) {
                                    const u = n,
                                        ...
                                        t = $u(u, Ku[e], a);
                                    r.push(...t);
                                } else r.push(e({ elementList: [n], textBlock: u, key: a }));
                            }),
                            r
                        );
                    },
                    ...
                    Zu = (u, e = '') => {
                        ...
                        return (
                            Yu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: Iu.Word, colorTag: e, childList: qu(u) });
                                },
                                (u) => {
                                    const r = u[0],
                                        n = Uu[r.charAt(0)];
                    ...
                    Qu = (u, e, t = '') => {
                        ...
                        return (
                            Yu(
                                ...
                                (u) => {
                                    const n = u[1],
                                        i = void 0 === e[n] ? u[0] : e[n];
                                    'string' == typeof i || 'number' == typeof i
                                        ? r.push(...Zu(String(i), t))
                                        : r.push({ blockType: Iu.Binding, colorTag: t, childList: [i] });
                                },
                            ),
                            r
                        );
                                ...
                                u.forEach((u, t) => {
                                    e.push(
                                        ...((u, e) => {
                                            ...
                                            return (
                                                r === Iu.NoBreakWrapper
                                                    ? t.push(n({ elementList: i, textBlock: u, key: `${e}` }))
                                                    : t.push(...i),
                                                t
                                            );
                                        })(u, t),
                    ...
                    ee = (u, e) => !u || u.offsetTop + u.offsetHeight > e,
                    te = (u, e) => u.offsetLeft + u.offsetWidth - e,
                    re = (u, e, t) => {
                    ...
                    ne = (u, e, t, r, i, a) => {
                        ...
                        for (let l = t; l >= 0; l--) {
                            ...
                            if (A === Iu.LineBreak || A === Iu.NewLine || A === Iu.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const _ = s.slice(0, s.length - F) + a,
                                    D = e[l];
                                ((E = n().cloneElement(D, D.props, _)), (o = l));
                                break;
                            }
                            {
                                const u = t.children,
                                    A = e[l],
                                    F = A.props.children,
                                    _ = ne(u, F, u.length - 1, r, i, a),
                                    D = _[0],
                                    c = _[1];
                                if (!(D < 0)) {
                                    const u = F.slice(0, D);
                                    ((E = n().cloneElement(A, A.props, u, c)), (o = l));
                                    break;
                                }
                                i -= s.length;
                            }
                    ...
                    ie = n().memo(
                        ({
                            ...
                            targetId: l,
                            justifyContent: A = zu.FlexStart,
                            alignContent: s = zu.FlexStart,
                            truncateIdentify: F = '...',
                        }) => {
                                ...
                                h = (0, r.useCallback)(
                                    (u) => {
                                        ...
                                        const e = ((u, e, t, r = '...') => {
                                                ...
                                                if (A < 0) return [n, !1];
                                                const s = ne(l, n, A, o, r.length, r),
                                                    F = s[0],
                                                    _ = s[1];
                                                return (_ && (n.splice(F, 1, _), n.splice(F + 1)), [n, !0]);
                                            })(_, C, D.current, F),
                                            r = e[0],
                                            n = e[1];
                            ...
                            return (
                                ...
                                n().createElement(
                                    ...
                                    n().createElement('div', { className: 'ExtendedText_unTruncated_b8', ref: _ }, C),
                                    n().createElement(
                                        Nu,
                                        { tooltipArgs: m },
                                        n().createElement(
                ...
                const Fe = (0, r.memo)(
                        ({
                            ...
                            const B = b.Z5.getNumberFormat(u, b.B3.GOLD),
                                d = (0, r.useMemo)(
                                    () => ({
                                        backgroundImage: `url('${R.images.historical_battles.gui.maps.icons.hbCoin.$dyn(`c_${t}`).$dyn(oe.Offence)}')`,
                                    }),
                                    [t],
                                ),
                                C = E()(le.base, _),
                                m = E()(
                                    ...
                                    le[`label__size${i}`],
                                    o && le[`label__${e}Glow`],
                                    !a && le.label__notEnough,
                                    s && le.label__animated,
                                    F && le.label__progression,
                                    D ? le.label__booster : le.label__default,
                                ),
                                h = E()(le.icon, le[`icon__size${t}`], s && le.icon__animated),
                                g = E()(le.stockBg, le[`stockBg__size${i}`]);
                            return n().createElement(
                                'div',
                                { className: C },
                                l && n().createElement(mu, { text: B, className: m }),
                                c &&
                                    n().createElement(mu, {
                                        text: R.strings.historical_battles_progression.header.coinValue.maxAmount(),
                                        className: E()(m, le.maxAmount),
                                        format: { binding: { value: b.Z5.getNumberFormat(Number(c), b.B3.GOLD) } },
                                    }),
                                n().createElement('div', { className: h, style: d }),
                                A && n().createElement('div', { className: g }),
                            );
                        },
                    ),
                    _e = 'HbCoinTooltipApp_coins_divider_a5',
                    De = 'HbCoinTooltipApp_suggestion_text_78',
                    ce = 'HbCoinTooltipApp_suggestion_4c',
                    Be = R.strings.hb_lobby.hbCoinTooltip,
                    de = {
                        orderIcon: n().createElement('div', { className: 'HbCoinTooltipApp_orderIcon_84' }),
                        coinIcon: n().createElement('div', { className: 'HbCoinTooltipApp_icon_11' }),
                    },
                    Ce = () => {
                        const u = y('model', L.None),
                            e = u.frontName,
                            t = u.coin.amount,
                            r = E()('HbCoinTooltipApp_base_21', 'HbCoinTooltipApp_content_51');
                        return n().createElement(
                            _,
                            null,
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    { className: 'HbCoinTooltipApp_header_18' },
                                    n().createElement(mu, {
                                        text: Be.$dyn(e).$dyn('title'),
                                        className: 'HbCoinTooltipApp_title_7f',
                                    }),
                                    n().createElement(mu, {
                                        text: Be.subtitle(),
                                        className: 'HbCoinTooltipApp_subtitle_73',
                                    }),
                                ),
                                n().createElement('div', { className: 'HbCoinTooltipApp_base_image_12' }),
                                n().createElement('div', { className: 'HbCoinTooltipApp_divider_a2' }),
                                n().createElement(xu, {
                                    text: Be.description(),
                                    classMix: 'HbCoinTooltipApp_description_89',
                                }),
                                n().createElement(
                                    'div',
                                    { className: 'HbCoinTooltipApp_coins_85' },
                                    n().createElement('div', {
                                        className: E()(_e, 'HbCoinTooltipApp_coins_divider__top_5f'),
                                    }),
                                    n().createElement('div', {
                                        className: E()(_e, 'HbCoinTooltipApp_coins_divider__bottom_2e'),
                                    }),
                                    n().createElement(Fe, {
                                        isBooster: !0,
                                        amount: t,
                                    ...
                                    n().createElement(mu, {
                                        text: Be.$dyn(e).$dyn('score'),
                                        className: 'HbCoinTooltipApp_coins_text_1a',
                                    }),
                                ),
                                n().createElement(
                                    'div',
                                    { className: 'HbCoinTooltipApp_suggestions_01' },
                                    n().createElement(mu, {
                                        text: Be.suggestions.title(),
                                        className: 'HbCoinTooltipApp_suggestions_title_cb',
                                    }),
                                    n().createElement(
                                        'div',
                                        { className: ce },
                                        n().createElement(xu, {
                                            text: Be.suggestions.$dyn(e).$dyn('text'),
                                            classMix: De,
                                        }),
                                    ),
                                    n().createElement(
                                        'div',
                                        { className: ce },
                                        n().createElement(xu, { text: Be.suggestions.actions(), classMix: De }),
                                    ),
                                ),
                                n().createElement(
                                    'div',
                                    { className: 'HbCoinTooltipApp_orders_0c' },
                                    n().createElement(mu, {
                                        text: Be.orders.title(),
                                        className: 'HbCoinTooltipApp_orders_title_f0',
                                    }),
                                    n().createElement(ie, {
                                        text: Be.orders.text(),
                                        binding: de,
                                        classMix: 'HbCoinTooltipApp_orders_text_c8',
                                    }),
                                ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    a().render(n().createElement(Ce, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, t, r) => {
            if (!e) {
                ...
                for (E = 0; E < deferred.length; E++) {
                    for (var [e, t, r] = deferred[E], i = !0, a = 0; a < e.length; a++)
                        (!1 & r || n >= r) &&
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); E < i.length; E++)
                        ((n = i[E]), __webpack_require__.o(u, n) && u[n] && u[n][0](), (u[n] = 0));
                    return __webpack_require__.O(l);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
        })());
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4531));
