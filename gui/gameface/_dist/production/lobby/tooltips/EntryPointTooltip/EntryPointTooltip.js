    ...
    var __webpack_modules__ = {
            ...
            3860: (u, e, t) => {
                        ...
                        return (
                            ((u) => {
                                ...
                                if (
                                    ...
                                    c.current = v.addCallback(n, t, a, e === w.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== w.None)
                        ...
                        const w = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            T = (0, n.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (y(t, D, { isMouseEvent: !0, on: !0, arguments: g(r) }, f),
                                    p && p(),
                ...
                const K = { [H.NBSP]: V.NoBreakSymbol, [H.ZWNBSP]: V.NoBreakSymbol, [H.NEW_LINE]: V.LineBreak },
                    ...
                    iu = r().memo(
                        ({
                            ...
                            const l = (0, n.useRef)(null),
                                ...
                                h = (0, n.useMemo)(() => ({ justifyContent: A, alignContent: F }), [F, A]);
                            return (
                                ((u, e, t = !0) => {
                    ...
                    au = 'EntryPointTooltipApp_divider_37',
                    su = 'EntryPointTooltipApp_text_f2';
                let Eu;
                !(function (u) {
                    ((u.LowRisk = 'lowRisk'), (u.MediumRisk = 'mediumRisk'), (u.HighRisk = 'highRisk'));
                })(Eu || (Eu = {}));
                const Au = 'PerformanceRisk_base_39',
                    Fu = 'PerformanceRisk_header_34',
                    cu = 'PerformanceRisk_text_b8',
                    lu = 'PerformanceRisk_icon_77',
                    Du = ({ performanceRisk: u }) => {
                        const e = s()(Fu, 'PerformanceRisk_header__high_31'),
                            t = s()(Fu, 'PerformanceRisk_header__medium_41');
                        switch (u) {
                            case Eu.HighRisk:
                                return r().createElement(
                                    'div',
                    ...
                    du = (u) => ({
                        day: Number.parseInt(_.cy.getTimeFormat('%d', u, !0)),
                        month: Number.parseInt(_.cy.getTimeFormat('%m', u, !0)),
                        year: Number.parseInt(_.cy.getTimeFormat('%Y', u, !0)),
                    }),
                    Bu = () => {
                        const u = f('model', w.None),
                            e = u.isHardDisabled,
                            t = u.eventStartDate,
                            o = u.eventEndDate,
                            i = u.performanceRisk,
                            a = s()(su, 'EntryPointTooltipApp_description_59'),
                            E = s()(su, 'EntryPointTooltipApp_length_76'),
                            A = s()(su, 'EntryPointTooltipApp_disabled_ce'),
                            F = (0, n.useMemo)(() => {
                                const u = du(t),
                                    e = du(o);
                                return {
                                    startDate: `${u.day} ${R.strings.menu.dateTime.months.$num(u.month)}`,
                                    endDate: `${e.day} ${R.strings.menu.dateTime.months.$num(e.month)} ${e.year}`,
                                };
                            }, [t, o]);
                        return r().createElement(
                            l,
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        R.strings.hb_mode_selector.mode.historicalBattles.name(),
                                    ),
                                    r().createElement(
                                        'div',
                                        { className: a },
                                        R.strings.hb_lobby.entryPointTooltip.description(),
                                    ),
                                    e
                                        ? r().createElement(
                                              r().Fragment,
                                              ...
                                              r().createElement(
                                                  'div',
                                                  { className: A },
                                                  R.strings.hb_lobby.entryPointTooltip.disabled(),
                                              ),
                                          )
                                        : r().createElement(
                                              r().Fragment,
                                              null,
                                              r().createElement(Du, { performanceRisk: i }),
                                              r().createElement('div', { className: au }),
                                              r().createElement(iu, {
                                                  classMix: E,
                                                  text: R.strings.hb_lobby.entryPointTooltip.length(),
                                                  binding: F,
                                              }),
                                          ),
                                ),
                ...
                engine.whenReady.then(() => {
                    i().render(r().createElement(Bu, null), document.getElementById('root'));
                });
            },
        },
