(() => {
    var __webpack_modules__ = {
            ...
            9836: (u, e, t) => {
                ...
                const F = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    D = (u, e, t = A.left) => u.split(e).reduce(t === A.left ? l : s, []),
                    c = (() => {
                        const u = new RegExp(
                ...
                let _;
                var d;
                (((d = _ || (_ = {})).SHORT_DATE = 'short-date'),
                    (d.SHORT_TIME = 'short-time'),
                    (d.SHORT_DATE_TIME = 'short-date-time'),
                    (d.FULL_DATE = 'full-date'),
                    (d.FULL_DATE_TIME = 'full-date-time'),
                    (d.MONTH = 'month'),
                    (d.MONTH_DATE = 'month-date'),
                    (d.DATE_MONTH = 'date-month'),
                    (d.MONTH_YEAR = 'month-year'),
                    (d.WEEK_DAY = 'week-day'),
                    (d.WEEK_DAY_TIME = 'week-day-time'),
                    (d.YEAR = 'year'),
                    (d.DATE_YEAR = 'date-year'));
                var m = t(4179);
                Date.now();
                var C = t(3138);
                const h = (u = 1) => {
                    ...
                    return (
                        p(() => {
                            if (
                                                ...
                                                const e = h(),
                                                    ...
                                                    n =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: n, modelPath: w(n, ''), resId: r };
                                            })(),
                                            t = e.modelPrefix,
                                            r = u.split('.');
                                        if (r.length > 0) {
                                ...
                                s.current = b.addCallback(r, t, E, e === v.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (e !== v.None)
                                return () => {
                                    b.removeCallback(s.current, E);
                                };
                        }, [E, e]),
                        F
                    );
                ...
                const y = n().forwardRef(function (u, e) {
                    let t = u.children,
                        a = u.className,
                        i = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            L({}, A, {
                                className: o()(T.base, T[`base__theme-${E}`], a),
                                ref: function (u) {
                                    ((l.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            n().createElement('div', { className: T.decorator }, t),
                        )
                    );
                });
                let M;
                ...
                const P = (u, e, t = {}, r = 0) => {
                    ...
                    N = (u) => {
                        ...
                        const f = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            w = (0, r.useMemo)(() => m || h().resId, [m]),
                            b = (0, r.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (P(t, c, { isMouseEvent: !0, on: !0, arguments: k(n) }, w),
                                    C && C(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((f.current.timeoutId = window.setTimeout(b, F ? 100 : 400)),
                                                          a && a(u),
                                                          T && T(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                ...
                const K = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return n().createElement(V, e, r);
                    const a = e.contentId,
                        i = e.args,
                        E = null == i ? void 0 : i.contentId;
                    return a || E
                        ? n().createElement(N, X({}, e, { contentId: a || E }), r)
                        : n().createElement(W, e, r);
                };
                var z = t(9050),
                    Y = t.n(z);
                let $, q, Z;
                ...
                const Q = { [Z.NBSP]: $.NoBreakSymbol, [Z.ZWNBSP]: $.NoBreakSymbol, [Z.NEW_LINE]: $.LineBreak },
                    J = {
                    ...
                    uu = (u) => ({ color: `#${u}` }),
                    eu = ({ elementList: u, textBlock: e, key: t }) => {
                        const r = e.colorTag;
                        return r
                            ? J[r]
                                ? n().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: J[r] },
                                      u,
                                  )
                                : n().createElement('span', { key: t, 'data-block-type': e.blockType, style: uu(r) }, u)
                            : n().createElement('span', { key: t, 'data-block-type': e.blockType }, u);
                    },
                    tu = {
                        [$.Word]: eu,
                        [$.NoBreakSymbol]: eu,
                        [$.Binding]: ({ elementList: u, textBlock: e, key: t }) =>
                            n().createElement(
                                'span',
                        ...
                        [$.LineBreak]: ({ key: u }) =>
                            n().createElement('span', {
                                key: u,
                                'data-block-type': $.LineBreak,
                                className: 'renderers_lineBreak_b5',
                            }),
                        [$.NewLine]: ({ elementList: u, key: e }) =>
                            n().createElement(
                                'span',
                                { key: e, 'data-block-type': $.NewLine, className: 'renderers_newLine_bd' },
                                u,
                            ),
                        [$.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            n().createElement(
                                'span',
                                {
                                    key: e,
                                    'data-block-type': $.NoBreakWrapper,
                    ...
                    iu = (u, e = '') => {
                        ...
                        return (
                            nu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: $.Word, colorTag: e, childList: au(u) });
                                },
                                (u) => {
                                    const r = u[0],
                                        n = Q[r.charAt(0)];
                            ...
                            nu(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof a || 'number' == typeof a
                                        ? r.push(...iu(String(a), t))
                                        : r.push({ blockType: $.Binding, colorTag: t, childList: [a] });
                                },
                            ),
                            r
                        );
                    ...
                    ou = (u, e) => {
                        ...
                        if (u.blockType === $.NoBreakWrapper) (u.childList.push(r), t.push(u));
                        else {
                            const e = Object.assign({}, u, { childList: u.childList.splice(-1) });
                            (u.childList.length > 0 && t.push(u),
                                t.push({ blockType: $.NoBreakWrapper, colorTag: '', childList: [e, r] }));
                        }
                    ...
                    Du = (u, e, t, r, a, i) => {
                        ...
                        for (let A = t; A >= 0; A--) {
                            ...
                            if (F === $.LineBreak || F === $.NewLine || F === $.Binding) continue;
                    ...
                    cu = n().memo(
                        ({
                            ...
                            targetId: A,
                            justifyContent: F = q.FlexStart,
                            alignContent: l = q.FlexStart,
                            truncateIdentify: s = '...',
                        }) => {
                            ...
                            return (
                                ...
                                n().createElement(
                                    ...
                                    n().createElement('div', { className: 'ExtendedText_unTruncated_b8', ref: D }, m),
                                    n().createElement(
                                        K,
                                        { tooltipArgs: C },
                                        n().createElement(
                                            ...
                                            _.isTruncateFinished && E ? _.elementList : m,
                                        ),
                                    ),
                                )
                            );
                ...
                const gu = C.O.client.getSize('rem'),
                    pu = gu.width,
                    fu = gu.height,
                    wu = Object.assign({ width: pu, height: fu }, hu(pu, fu, mu)),
                    bu = (0, r.createContext)(wu),
                    vu = ['children'],
                    xu = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        const n = (0, r.useContext)(bu),
                            ...
                            h = { extraLarge: B, large: _, medium: d, small: m, extraSmall: C };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && F) return du(e, t, h);
                            if (t.largeWidth && l) return du(e, t, h);
                            if (t.mediumWidth && s) return du(e, t, h);
                            if (t.smallWidth && D) return du(e, t, h);
                            if (t.extraSmallWidth && c) return du(e, t, h);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                ...
                ((xu.defaultProps = {
                    ...
                    (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(bu),
                            ...
                            E = (0, r.useCallback)((u, e) => {
                                ...
                                i(Object.assign({ width: t, height: r }, hu(t, r, mu)));
                            }, []);
                        (p(() => {
                        ...
                        return n().createElement(bu.Provider, { value: o }, u);
                    }),
                    (function (u) {
                        ((u[(u.ExtraSmall = mu.extraSmall.width)] = 'ExtraSmall'),
                            (u[(u.Small = mu.small.width)] = 'Small'),
                            (u[(u.Medium = mu.medium.width)] = 'Medium'),
                            (u[(u.Large = mu.large.width)] = 'Large'),
                            (u[(u.ExtraLarge = mu.extraLarge.width)] = 'ExtraLarge'));
                    })(Tu || (Tu = {})),
                    (function (u) {
                        ((u[(u.ExtraSmall = mu.extraSmall.width)] = 'ExtraSmall'),
                            (u[(u.Small = mu.small.width)] = 'Small'),
                    ...
                    (function (u) {
                        ((u[(u.ExtraSmall = mu.extraSmall.height)] = 'ExtraSmall'),
                            (u[(u.Small = mu.small.height)] = 'Small'),
                            (u[(u.Medium = mu.medium.height)] = 'Medium'),
                            (u[(u.Large = mu.large.height)] = 'Large'),
                            (u[(u.ExtraLarge = mu.extraLarge.height)] = 'ExtraLarge'));
                    })(Lu || (Lu = {})));
                const yu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Mu = (u) => u.includes('_') && ((u) => yu.includes(u))(u.split('_').at(-1)),
                    Ru = [Tu.ExtraLarge, Tu.Large, Tu.Medium, Tu.Small, Tu.ExtraSmall],
                    Ou = (u, e) =>
                        Object.keys(u).reduce((t, r) => {
                            ...
                            return (
                                void 0 === n ||
                                    ((u, e) => yu.some((t) => void 0 !== e[`${u}_${t}`]))(r, u) ||
                                    (t[r] = n),
                                t
                            );
                        }, {}),
                ...
                const Iu = {
                    ...
                    Gu = ku((u) => {
                        let e = u.className,
                            ...
                            d = u.row,
                            m = u.flexDirection,
                            C = void 0 === m ? (_ ? 'column' : d && 'row') || void 0 : m,
                            h = u.flexStart,
                            g = u.center,
                            p = u.flexEnd,
                            f = u.spaceBetween,
                            ...
                            v =
                                void 0 === b
                                    ...
                                    : b,
                            x = u.alignItems,
                            T = void 0 === x ? (h ? 'flex-start' : g && 'center') || (p && 'flex-end') || void 0 : x,
                            S = u.alignSelf,
                            L = u.wrap,
                            y = u.flexWrap,
                            M = void 0 === y ? (L ? 'wrap' : void 0) : y,
                            R = u.grow,
                            O = u.shrink,
                            k = u.flex,
                            P = void 0 === k ? (R || O ? `${R ? 1 : 0} ${O ? 1 : 0} auto` : void 0) : k,
                            N = u.style,
                            H = u.children,
                            I = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, A, l, D, B, N, P, S, C, M, v, T]),
                            U = W.computedStyle,
                            G = W.computedClassNames;
                        return n().createElement('div', Hu({ className: o()(Pu.base, ...G, e), style: U }, I), H);
                    }),
                    ju = ({ binding: u, text: e = '', classMix: t, alignment: a = A.left }) =>
                        null === e
                ...
                const $u = Object.keys(Xu()),
                    ...
                    ee = ku((u) => {
                        ...
                        return n().createElement(
                            ...
                            Yu(
                                {
                                    className: o()(Ku.base, t && Ku[t], p, a),
                                    style: g,
                                    mt: !0 === F ? Ju[t || 'paragraph-P16'].mt : F,
                                    mr: !0 === s ? Ju[t || 'paragraph-P16'].mr : s,
                                    mb: !0 === c ? Ju[t || 'paragraph-P16'].mb : c,
                                    ml: !0 === _ ? Ju[t || 'paragraph-P16'].ml : _,
                                },
                                C,
                            ),
                            void 0 !== m ? n().createElement(ju, Yu({}, m, { text: e })) : e,
                        );
                    }),
                    te = 'PerformanceRisk_base_39',
                    re = 'PerformanceRisk_header_34',
                    ne = 'PerformanceRisk_text_b8',
                    ae = 'PerformanceRisk_icon_77',
                    ie = ({ performanceRisk: u }) => {
                        const e = o()(re, 'PerformanceRisk_header__high_31'),
                            t = o()(re, 'PerformanceRisk_header__medium_41');
                        switch (u) {
                            case M.HighRisk:
                                return n().createElement(
                                    'div',
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            'div',
                                            null,
                                            R.strings.hb_mode_selector.mode.historicalBattles.performance.highRisk(),
                                        ),
                                    ),
                                    n().createElement(
                                        'div',
                                        { className: ne },
                                        R.strings.hb_lobby.entryPointTooltip.performance.description.highRisk(),
                                    ),
                                );
                            case M.MediumRisk:
                                return n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            'div',
                                            null,
                                            R.strings.hb_mode_selector.mode.historicalBattles.performance.mediumRisk(),
                                        ),
                                    ),
                                    n().createElement(
                                        'div',
                                        { className: ne },
                                        R.strings.hb_lobby.entryPointTooltip.performance.description.mediumRisk(),
                                    ),
                                );
                            default:
                                return null;
                    ...
                    Ee = 'EntryPointTooltipApp_divider_37',
                    oe = 'EntryPointTooltipApp_mode_title_dc',
                    Ae = 'EntryPointTooltipApp_mode_descr_96',
                    Fe = 'EntryPointTooltipApp_text_f2',
                    le = (u) => ({
                        day: Number.parseInt(m.cy.getTimeFormat('%d', u, !0)),
                        month: Number.parseInt(m.cy.getTimeFormat('%m', u, !0)),
                        year: Number.parseInt(m.cy.getTimeFormat('%Y', u, !0)),
                    }),
                    se = R.strings.hb_lobby.entryPointTooltip,
                    De = () => {
                        const u = x('model', v.None),
                            e = u.eventStartDate,
                            t = u.eventEndDate,
                            a = u.performanceRisk,
                            i = o()(Fe, 'EntryPointTooltipApp_description_59'),
                            E = o()(Fe, 'EntryPointTooltipApp_length_76'),
                            A = (0, r.useMemo)(() => {
                                const u = le(e),
                                    r = le(t);
                                return {
                                    startDate: `${u.day} ${R.strings.menu.dateTime.months.$num(u.month)}`,
                                    endDate: `${r.day} ${R.strings.menu.dateTime.months.$num(r.month)} ${r.year}`,
                                };
                            }, [e, t]);
                        return n().createElement(
                            y,
                            ...
                            n().createElement(
                                'div',
                                { className: 'EntryPointTooltipApp_base_e8' },
                                n().createElement(
                                    'div',
                                    { className: 'EntryPointTooltipApp_content_15' },
                                    n().createElement(ee, {
                                        className: 'EntryPointTooltipApp_header_60',
                                        text: R.strings.hb_mode_selector.mode.historicalBattles.name(),
                                    }),
                                    n().createElement(ee, { className: i, text: se.description() }),
                                    n().createElement(
                                        'div',
                                        { className: 'EntryPointTooltipApp_mode_17' },
                                        n().createElement('div', { className: 'EntryPointTooltipApp_modeBg_69' }),
                                        n().createElement('div', { className: Ee }),
                                        n().createElement(ee, { className: oe, text: se.defence.title() }),
                                        n().createElement(ee, { className: Ae, text: se.defence.description() }),
                                        n().createElement('div', { className: Ee }),
                                        n().createElement(ee, { className: oe, text: se.offence.title() }),
                                        n().createElement(ee, { className: Ae, text: se.offence.description() }),
                                    ),
                                    a !== M.LowRisk &&
                                        n().createElement(
                                            n().Fragment,
                                            null,
                                            n().createElement('div', { className: Ee }),
                                            n().createElement(ie, { performanceRisk: a }),
                                        ),
                                    n().createElement('div', { className: Ee }),
                                    n().createElement(cu, { classMix: E, text: se.length(), binding: A }),
                                ),
                            ),
                        );
                    };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(9836));
