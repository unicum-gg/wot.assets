    ...
    var u,
        e = {
            ...
            349: (u, e, t) => {
                ...
                const Fu = n().forwardRef(function (u, e) {
                    let t = u.children,
                        A = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            Eu({}, r, {
                                className: o()(tu.base, tu[`base__theme-${F}`], A),
                                ref: function (u) {
                                    ((i.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            n().createElement('div', { className: tu.decorator }, t),
                        )
                    );
                });
                var ru = t(403),
                ...
                const lu = uu.client.getSize('rem'),
                    Cu = lu.width,
                    mu = lu.height,
                ...
                const gu = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && i) return au(e, t, _);
                        if (t.largeWidth && B) return au(e, t, _);
                        if (t.mediumWidth && o) return au(e, t, _);
                        if (t.smallWidth && l) return au(e, t, _);
                        if (t.extraSmallWidth && C) return au(e, t, _);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                ...
                (0, D.memo)(({ children: u }) => {
                    const e = (0, D.useContext)(cu),
                        ...
                        F = (0, D.useCallback)((u, e) => {
                            const t = uu.view.pxToRem(u),
                                A = uu.view.pxToRem(e);
                            E(Object.assign({ width: t, height: A }, ou(t, A, iu)));
                        }, []);
                    (_u(() => {
                    ...
                    return n().createElement(cu.Provider, { value: r }, u);
                });
                let hu, xu, pu;
                (!(function (u) {
                        ...
                        const j = (0, D.useMemo)(() => {
                                const u = { mt: r, mr: i, mb: l, ml: m },
                                    e = ((u) =>
                                        Hu.reduce((e, t) => {
                                            const A = u[t];
                                            return A && 'number' != typeof A ? e.concat(Tu[!0 === A ? 'MD' : A][t]) : e;
                                        }, []))(u),
                                    E = ((u) =>
                                        Hu.reduce((e, t) => {
                                            const A = u[t];
                            ...
                            }, [t, A, r, i, l, m, W, P, L, g, R, b, w]),
                            I = j.computedStyle,
                            X = j.computedClassNames;
                        return n().createElement('div', Ru({ className: o()(yu.base, ...X, e), style: I }, G), N);
                    });
                let Wu;
                !(function (u) {
                ...
                const Nu = (u, e, t) => {
                    ...
                    ju = (u, e, t = Wu.left) => u.split(e).reduce(t === Wu.left ? Nu : Gu, []),
                    Iu = (() => {
                        const u = new RegExp(
                        ...
                        return Xu.includes(t)
                            ...
                            : ((u, e = Wu.left) => {
                                  ...
                                  const A =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (ju(E, /( )/, e).forEach((u) => (t = t.concat(ju(u, A, Wu.left)))), t);
                              })(u, e);
                    },
                    zu = 'FormatText_base_d0',
                    Vu = ({ binding: u, text: e = '', classMix: t, alignment: A = Wu.left }) =>
                        null === e
                ...
                const Qu = Object.keys($u()),
                    ...
                    Ee = Lu((u) => {
                        ...
                        return n().createElement(
                            ...
                            qu(
                                {
                                    className: o()(Ku.base, t && Ku[t], x, A),
                                    style: h,
                            ...
                            void 0 !== d ? n().createElement(Vu, qu({}, d, { text: e })) : e,
                        );
                    }),
                    Fe = 'Condition_base_c0',
                    re = 'Condition_separatorDots_1b',
                    De = 'Condition_separatorDots__bottom_d6',
                    ne = 'Condition_contentBlock_00',
                    ae = 'Condition_content_8c',
                    ie = 'Condition_conditionIcon_51',
                    Be = 'Condition_text_36',
                    oe = ({ conditions: u }) =>
                        n().createElement(
                            'div',
                            { className: Fe },
                            ...
                            n().createElement('div', { className: o()(re, De) }),
                        ),
                    le = 'ConditionSeparator_base_81',
                    Ce = 'ConditionSeparator_text_34',
                    me = 'ConditionSeparator_arrow_41',
                    se = 'ConditionSeparator_arrow__toBottom_ea',
                    ce = () =>
                        n().createElement(
                            'div',
                            { className: le },
                            ...
                            n().createElement(Ee, {
                                text: R.strings.tooltips.limited_ui.unlock_info.condition.separator(),
                                color: 'CREAM',
                                variant: 'paragraph-P14',
                                className: Ce,
                            }),
                            n().createElement('div', { className: o()(me, se) }),
                        ),
                    de = 'Footer_base_7e',
                    ge = ({ title: u, subtitle: e }) =>
                        u || e
                            ? n().createElement(
                                  'div',
                                  { className: de },
                                  u && n().createElement(Ee, { text: u, color: 'PAR', variant: 'heading-H15' }),
                                  e &&
                                      n().createElement(Ee, {
                                          text: e,
                                          color: 'PAR_SECONDARY',
                            ...
                            : null,
                    _e = 'Header_base_b8',
                    he = ({ title: u, subtitle: e }) =>
                        n().createElement(
                            'div',
                            { className: _e },
                            n().createElement(Ee, { text: u, color: 'WHITE_SPANISH', variant: 'heading-H22' }),
                            e && n().createElement(Ee, { text: e, color: 'PAR', variant: 'paragraph-P14' }),
                        );
                function xe() {}
                function pe() {
                    return !1;
                ...
                const we = (u) => {
                    return null !== u && 'object' == typeof u
                        ? 'CoherentArrayProxy' === u.constructor.name
                            ? ((e = u),
                              (t = (u) => ('object' == typeof u ? we(u) : u)),
                              Array.isArray(e) ? e.map(t) : e.map((u, e, A) => t(null == u ? void 0 : u.value, e, A)))
                            : Array.isArray(u)
                              ? u.map((u) => ('object' == typeof u ? we(u) : u))
                              : Object.fromEntries(
                                    Object.entries(u).map(([u, e]) => [u, 'object' == typeof e ? we(e) : e]),
                                )
                        : u;
                    var e, t;
                };
                var Le = t(946);
                const ye = R.strings.tooltips.limited_ui.unlock_info.header.subtitle,
                    Me = ((u, e) => {
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const D = 'string' == typeof F ? `${A}.${F}` : A,
                                                            n = uu.view.addModelObserver(D, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = ve(E.keys()); !(u = t()).done;) F(u.value, e);
                                                    },
                                                    unsubscribe: F,
                                                };
                                            })(A),
                        ...
                        const e = { root: u.object(), conditionGroups: u.array('conditionGroups') },
                            t = (0, Le.Om)(
                                () => {
                                    return ((u = e.conditionGroups.get()), we(u));
                                    var u;
                                },
                                { equals: pe },
                            ),
                    ...
                    Oe = (0, ru.Pi)(() => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                null,
                                n().createElement(he, {
                                    title: R.strings.tooltips.limited_ui.unlock_info.header.title(),
                                    subtitle: F,
                                }),
                                E.map((u, e) =>
                                    n().createElement(
                                        D.Fragment,
                                        { key: e },
                                        n().createElement(oe, { conditions: u.conditions }),
                                        E[e + 1] && n().createElement(ce, null),
                                    ),
                                ),
                                n().createElement(ge, { title: A, subtitle: t }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    i().render(
                        n().createElement(Re, null, n().createElement(Oe, null)),
