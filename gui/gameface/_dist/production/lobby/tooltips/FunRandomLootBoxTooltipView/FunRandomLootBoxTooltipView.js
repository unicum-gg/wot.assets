(() => {
    ...
    var __webpack_modules__ = {
            ...
            9060: (u, e, t) => {
                ...
                var n = {};
                (t.r(n),
                    t.d(n, { mouse: () => D, off: () => A, on: () => s, onResize: () => a, onScaleUpdated: () => i }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        events: () => n,
                ...
                const d = {
                    ...
                    v = { view: t(2031), client: r, sound: g, intl: _ };
            },
            2031: (u, e, t) => {
                (t.r(e),
                    t.d(e, {
                ...
                var n = {};
                (t.r(n), t.d(n, { getBgUrl: () => o, getTextureUrl: () => E }));
                var r = t(9690);
                function E(u, e, t = 1) {
                ...
                const x = Object.keys(a).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === a[e]), u), {}),
                    N = {
                        set: (u, e) => {
            ...
            1118: (u, e, t) => {
                ...
                const F = a().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            A({}, c, {
                                className: r()(i.base, i[`base__theme-${D}`], n),
                                ref: function (u) {
                ...
                var D = t(1533),
                    c = t.n(D),
                    l = t(8515);
                const B = R.images.fun_random.gui.maps.icons.feature.asset_packs;
                function C() {
                    return !1;
                }
                console.log;
                ...
                const y = [v.Attachment],
                    ...
                    k = [v.Gold, v.Credits, v.Crystal, v.FreeXp],
                        ...
                        return [
                            function ({ mode: u = 'real', options: n, children: r, mocks: i }) {
                                const s = (0, o.useRef)([]),
                                    A = (u, t, n) => {
                                        ...
                                        const o = (function ({
                                            ...
                                            F = (({ observableModel: u }) => {
                                                const e = { root: u.object(), rewards: u.array('rewards') },
                                                    ...
                                                    n = (0, q.Om)(
                                                        (u) => {
                                                            ...
                                                            if (!t) throw Error(`No reward found with index: ${u}`);
                                                ...
                                                return Object.assign({}, e, { computes: { length: t, reward: n } });
                                            })({
                                                mode: u,
                                                readByPath: i,
                                                externalModel: a,
                                    ...
                                    c = D[0],
                                    l = D[1],
                                    B = (0, o.useState)(() => A(u, n, i)),
                                    p = B[0],
                                    g = B[1];
                                return (
                                    (0, o.useEffect)(() => {
                                        F.current ? g(A(c, n, i)) : (F.current = !0);
                                    }, [i, c, n]),
                                    (0, o.useEffect)(() => {
                                        l(u);
                                    }, [u]),
                                    (0, o.useEffect)(
                                        () => () => {
                                            (p.externalModel.dispose(), s.current.forEach((u) => u()));
                                        },
                                        [p],
                                    ),
                                    a().createElement(t.Provider, { value: p }, r)
                                );
                            },
                            () => (0, o.useContext)(t),
                        ];
                ...
                const H = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    K = (u, e, t = V.left) => u.split(e).reduce(t === V.left ? X : W, []),
                    Q = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Z = ['zh_cn', 'zh_sg', 'zh_tw'],
                    J = ({ binding: u, text: e = '', classMix: t, alignment: n = V.left, formatWithBrackets: E }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const i = E && u ? ((s = u), e.replace(/\{\w+\}/g, (u) => String(s[u.slice(1, -1)]))) : e;
                        var s;
                        ...
                        const v = (0, o.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, o.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (tu(t, l, { isMouseEvent: !0, on: !0, arguments: eu(n) }, b),
                                    m && m(),
                ...
                const su = R.views.common.tooltip_window.simple_tooltip_content,
                    Au = (u) => {
                        ...
                        const A = (0, o.useMemo)(() => {
                            const u = Object.assign({}, i, { body: t, header: n, note: r, alert: E });
                ...
                const Du = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        const r = e.contentId;
                        return r ? a().createElement(nu, Fu({}, e, { contentId: r }), n) : a().createElement(ou, e, n);
                    },
                    cu = {
                        base: 'Reward_base_ea',
                    ...
                    lu = ({
                        ...
                        const B = ((u, e) => {
                            ...
                            C = ((u) => {
                                ...
                                switch (u) {
                                    ...
                                    case h.PROGRESSION_STYLE_UPGRADED_5:
                                        return P.PROGRESSION_STYLE_UPGRADED_5;
                                    case h.PROGRESSION_STYLE_UPGRADED_6:
                                        return P.PROGRESSION_STYLE_UPGRADED_6;
                                    case h.ATTACHMENT_RARE:
                                        return P.ATTACHMENT_RARE;
                                    case h.ATTACHMENT_EPIC:
                                        return P.ATTACHMENT_EPIC;
                                    case h.ATTACHMENT_LEGENDARY:
                            ...
                            d = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case f.CURRENCY:
                                    case f.NUMBER:
                                        return a().createElement(g, { format: 'integral', value: Number(u) });
                                    case f.PREMIUM_PLUS: {
                                        const e = Number(u);
                        ...
                        return a().createElement(
                            'div',
                            {
                                className: r()(cu.base, cu[`base__${n}`], y.includes(u) && cu.base__normalize, F),
                                style: A,
                            },
                            a().createElement(
                                Du,
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: r()(cu.image, null == D ? void 0 : D.image) },
                                        B &&
                                            a().createElement('div', {
                                                className: r()(cu.highlight, null == D ? void 0 : D.highlight),
                                                style: {
                                        ...
                                        e &&
                                            a().createElement('div', {
                                                className: r()(cu.icon, null == D ? void 0 : D.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        C &&
                                            a().createElement('div', {
                                                className: r()(cu.overlay, null == D ? void 0 : D.overlay),
                                                style: {
                            ...
                            t &&
                                a().createElement(
                                    ...
                                    { tooltipArgs: l },
                                    a().createElement('div', {
                                        className: r()(cu.timer, null == D ? void 0 : D.periodicIcon),
                                    }),
                                ),
                        );
                    },
                    Bu = {
                        base: 'LootBoxReward_base_b1',
                        base__double: 'LootBoxReward_base__double_21',
                        item: 'LootBoxReward_item_98',
                        item__separator: 'LootBoxReward_item__separator_75',
                        rewardWrapper: 'LootBoxReward_rewardWrapper_31',
                        reward__withCurrency: 'LootBoxReward_reward__withCurrency_72',
                        label: 'LootBoxReward_label_4e',
                        percent: 'LootBoxReward_percent_52',
                        separator: 'LootBoxReward_separator_4e',
                    };
                function Cu() {
                    return (
                        (Cu =
                ...
                const du = (0, l.Pi)(({ index: u }) => {
                        const e = j().model,
                            t = e.computes.length(),
                            n = e.computes.reward(u),
                            E = n.probability,
                            o = n.label,
                            i = t > 5 ? u > 1 : u > 0,
                            s = n.valueType === f.CURRENCY;
                        return a().createElement(
                            'div',
                            { className: Bu.base },
                            i && a().createElement('div', { className: Bu.separator }),
                            a().createElement(
                                'div',
                                { className: r()(Bu.item, i && Bu.item__separator) },
                                a().createElement(
                                    'div',
                                    { className: Bu.rewardWrapper },
                                    a().createElement(
                                        lu,
                                        Cu({}, n, {
                                            className: r()(Bu.reward, s && Bu.reward__withCurrency),
                                            size: w.Small,
                                        }),
                                    ),
                                ),
                                a().createElement('div', { className: Bu.label }, o),
                                Boolean(E) &&
                                    a().createElement(
                                        'div',
                                        { className: Bu.percent },
                                        a().createElement(J, {
                                            text: R.strings.fun_random.lootboxTooltip.chance(),
                                            binding: {
                                                percent:
                                                    ((A = R.strings.common.percentValue()),
                                                    (F = { value: E }),
                                                    A.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                    ...
                    _u = (0, l.Pi)(() => {
                        const u = j().model,
                            ...
                            })(E).progression.bonuses.small;
                        return a().createElement(
                            'div',
                            { className: r()('App_base_8a', i && 'App_base__double_95') },
                            a().createElement(
                                'div',
                                { className: 'App_header_3c' },
                                a().createElement('div', {
                                    className: 'App_icon_10',
                                    style: { backgroundImage: `url(${s.$dyn(t)})` },
                                }),
                                a().createElement('div', { className: 'App_title_a8' }, n),
                                a().createElement(
                                    'div',
                                    { className: 'App_description_69' },
                                    R.strings.fun_random.lootboxTooltip.description(),
                                ),
                            ),
                            a().createElement(
                                'div',
                                { className: 'App_content_ef' },
                                o > 0 &&
                                    ((u, e) => {
                                        const t = [];
                                        for (let n = 0; n < u; n++) t.push(e(n));
                                        return t;
                                    })(o, (u) => a().createElement(du, { index: u, key: u })),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    c().render(
                        a().createElement(Y, null, a().createElement(F, null, a().createElement(_u, null))),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/tooltips/FunRandomLootBoxTooltipView/FunRandomLootBoxTooltipView'),
        (() => {
            var u = { 'lobby/tooltips/FunRandomLootBoxTooltipView/FunRandomLootBoxTooltipView': 0 };
