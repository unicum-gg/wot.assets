    ...
    var u,
        e = {
            ...
            974: (u, e, t) => {
                'use strict';
                var A = {};
                (t.r(A), t.d(A, { mouse: () => C, onResize: () => i }));
                var E = {};
                (t.r(E),
                    t.d(E, {
                        events: () => A,
                ...
                var F = {};
                (t.r(F), t.d(F, { getBgUrl: () => d, getTextureUrl: () => c }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        addModelObserver: () => w,
                ...
                const I = Object.keys(g).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === g[e]), u), {}),
                    z = {
                        set: (u, e) => {
                ...
                const Z = K().forwardRef(function (u, e) {
                    let t = u.children,
                        A = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        K().createElement(
                            'div',
                            Q({}, r, {
                                className: a()(Y.base, Y[`base__theme-${F}`], A),
                                ref: function (u) {
                                    ((n.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            K().createElement('div', { className: Y.decorator }, t),
                        )
                    );
                });
                var J = t(493),
                ...
                const Du = V.client.getSize('rem'),
                    au = Du.width,
                    nu = Du.height,
                    Bu = Object.assign({ width: au, height: nu }, ru(au, nu, Eu)),
                    iu = (0, U.createContext)(Bu),
                    lu = ['children'],
                    Cu = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        const A = (0, U.useContext)(iu),
                            ...
                            g = { extraLarge: o, large: m, medium: s, small: c, extraSmall: d };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && n) return Au(e, t, g);
                            if (t.largeWidth && B) return Au(e, t, g);
                            if (t.mediumWidth && i) return Au(e, t, g);
                            if (t.smallWidth && l) return Au(e, t, g);
                            if (t.extraSmallWidth && C) return Au(e, t, g);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                ...
                let ou, mu, su;
                ((0, U.memo)(({ children: u }) => {
                    const e = (0, U.useContext)(iu),
                        t = (0, U.useState)(e),
                        A = t[0],
                        E = t[1],
                        F = (0, U.useCallback)((u, e) => {
                            const t = V.view.pxToRem(u),
                                A = V.view.pxToRem(e);
                            E(Object.assign({ width: t, height: A }, ru(t, A, Eu)));
                        }, []);
                    (((u) => {
                        ...
                        (0, U.useEffect)(() => () => engine.off('clientResized', F), [F]));
                    const r = (0, U.useMemo)(() => Object.assign({}, A), [A]);
                    return K().createElement(iu.Provider, { value: r }, u);
                }),
                    (function (u) {
                ...
                const cu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    gu = [ou.ExtraLarge, ou.Large, ou.Medium, ou.Small, ou.ExtraSmall],
                    _u = (u, e) =>
                        ...
                        const t = (
                            ...
                            (t) => {
                                const A = (() => {
                                    ...
                                    E = (0, U.useMemo)(() => e(t, A), [t, A]);
                                return K().createElement(u, E);
                            }
                        )(u, e);
                        return K().memo((e) =>
                ...
                const vu = {
                    ...
                    Su = hu((u) => {
                        let e = u.className,
                            ...
                            m = u.row,
                            s = u.flexDirection,
                            c = void 0 === s ? (o ? 'column' : m && 'row') || void 0 : s,
                            d = u.flexStart,
                            g = u.center,
                            _ = u.flexEnd,
                            h = u.spaceBetween,
                        ...
                        const W = (0, U.useMemo)(() => {
                            ...
                            }, [t, A, r, n, i, C, O, H, w, c, y, f, b]),
                            G = W.computedStyle,
                            j = W.computedClassNames;
                        return K().createElement('div', fu({ className: a()(xu.base, ...j, e), style: G }, N), P);
                    });
                let Lu;
                !(function (u) {
                ...
                const yu = (u, e, t) => {
                    ...
                    Ru = (u, e, t = Lu.left) => u.split(e).reduce(t === Lu.left ? yu : Mu, []),
                    Tu = (() => {
                        const u = new RegExp(
                    ...
                    Ou = ({ binding: u, text: e = '', classMix: t, alignment: A = Lu.left }) =>
                        null === e
                                  ...
                                  e.split('\n').map((e, E) =>
                                      K().createElement(
                                          ...
                                          ((u, e, t) =>
                                              ...
                                              K().createElement(U.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              );
                ...
                const Xu = Object.keys(Nu()),
                    ...
                    Uu = hu((u) => {
                        ...
                        return K().createElement(
                            ...
                            ju(
                                {
                                    className: a()(Wu.base, t && Wu[t], _, A),
                                    style: g,
                                    mt: !0 === D ? $u[t || 'paragraph-P16'].mt : D,
                                    mr: !0 === B ? $u[t || 'paragraph-P16'].mr : B,
                                    mb: !0 === l ? $u[t || 'paragraph-P16'].mb : l,
                                    ml: !0 === o ? $u[t || 'paragraph-P16'].ml : o,
                                },
                                c,
                            ),
                ...
                const Zu = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: A, children: E, mocks: F }) {
                                const r = (0, U.useRef)([]),
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const D = 'string' == typeof F ? `${A}.${F}` : A,
                                                            a = V.view.addModelObserver(D, e, !0);
                                    ...
                                    B = n[0],
                                    i = n[1],
                                    l = (0, U.useState)(() => D(u, A, F)),
                                    C = l[0],
                                    o = l[1];
                                return (
                                    (0, U.useEffect)(() => {
                                        a.current ? o(D(B, A, F)) : (a.current = !0);
                                    }, [F, B, A]),
                                    (0, U.useEffect)(() => {
                                        i(u);
                                    }, [u]),
                                    ...
                                    K().createElement(t.Provider, { value: C }, E)
                                );
                            },
                            () => (0, U.useContext)(t),
                        ];
                    ...
                    ue = Ju[0],
                    ee = Ju[1],
                    te = R.strings.portal_tooltips.vehicle,
                    Ae = R.images.portal.gui.maps.icons.tooltips.vehicle,
                    Ee = Array.from(Array(4)),
                    Fe = (0, Ku.observer)(() => {
                        const u = ee().model.root.get(),
                            e = u.vehicleName,
                            t = u.vehicleType,
                            A = u.vehicleDescription,
                            E = u.vehicleTtx,
                            F = u.vehicleCrew,
                            r = Object.keys(E);
                        return K().createElement(
                            'div',
                            { className: 'App_base_0b' },
                            K().createElement('div', { className: 'App_headerBg_9f' }),
                            K().createElement(
                                'div',
                                { className: 'App_paddingContent_f1' },
                                K().createElement(
                                    'div',
                                    { className: 'App_header_49' },
                                    K().createElement('div', {
                                        className: 'App_vehicleType_28',
                                        style: {
                                            backgroundImage: `url(${Ae.vehicleTypes.$dyn(((D = t), D.replace(/-/g, '_')))})`,
                                        },
                                    }),
                                    K().createElement(
                                        'div',
                                        { className: 'App_headerText_b6' },
                                        K().createElement(Uu, { className: 'App_title_45', text: e }),
                                        K().createElement(Uu, { className: 'App_subTitle_9d', text: A }),
                                    ),
                                ),
                                K().createElement(
                                    'div',
                                    { className: 'App_ttx_c7' },
                                    r.map((u, e) =>
                                        K().createElement(
                                            'div',
                                            {
                                                ...
                                                className: a()(
                                                    'App_ttxLine_17',
                                                    e + 1 === r.length && 'App_ttxLine__last_69',
                                                ),
                                            },
                                            K().createElement(Uu, {
                                                className: 'App_ttxText_30',
                                                text: te.ttx.$dyn(u),
                                            }),
                                            K().createElement(
                                                'div',
                                                { className: 'App_ttxValues_f6' },
                                                Ee.map((e, t) =>
                                                    K().createElement('div', {
                                                        key: t,
                                                        className: a()(
                                                            'App_ttxBlock_ca',
                                                            t < E[u] && 'App_ttxBlock__colored_de',
                                                            t + 1 === Ee.length && 'App_ttxBlock__last_7c',
                                                        ),
                                                    }),
                                                ),
                                            ),
                            ...
                            K().createElement(
                                'div',
                                { className: 'App_footer_92' },
                                K().createElement('div', { className: 'App_footerBg_4a' }),
                                K().createElement('div', {
                                    className: 'App_crewIcon_d5',
                                    style: { backgroundImage: `url(${Ae.crew.$dyn(F.id)})` },
                                }),
                                K().createElement(
                                    'div',
                                    { className: 'App_footerText_3b' },
                                    K().createElement(Uu, { className: 'App_crewName_35', text: F.name }),
                                    K().createElement(Uu, { className: 'App_crewDescription_39', text: F.description }),
                                ),
                            ),
                        );
                        var D;
                    ...
                    re = {
                        getter:
                            ((De = {
                                ...
                                vehicleDescription:
                                    'Подойдет к тем, кто работает издалека. Может перемещаться между позициями и точно наносить урон большинству танков врага.',
                                vehicleTtx: { damage: 4, mobility: 1, armor: 4, reload: 3, hp: 2 },
                                vehicleCrew: {
                                    id: 'koshcheyev',
                                    name: 'Константин Кощеев',
                                    description:
                                        'Гений компьютерных технологий. Характер стойкий. Умна, самодостаточна, решительна. Всегда знает, что говорит.',
                                },
                            }),
                ...
                engine.whenReady.then(() => {
                    uu().render(
                        K().createElement(
                            ue,
                            { mode: 'real', mocks: re },
                            K().createElement(Z, null, K().createElement(Fe, null)),
                        ),
