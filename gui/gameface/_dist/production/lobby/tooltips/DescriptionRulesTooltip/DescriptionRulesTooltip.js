    ...
    var u,
        e = {
            ...
            7857: (u, e, t) => {
                ...
                var E = {};
                (t.r(E), t.d(E, { getBgUrl: () => b, getTextureUrl: () => f }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        addModelObserver: () => O,
                ...
                const Fu = uu.client.getSize('rem'),
                    Eu = Fu.width,
                    ru = Fu.height,
                    Du = Object.assign({ width: Eu, height: ru }, Au(Eu, ru, eu)),
                    au = (0, D.createContext)(Du),
                    nu = ['children'],
                    Bu = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                ...
                ((0, D.memo)(({ children: u }) => {
                    const e = (0, D.useContext)(au),
                        ...
                        E = (0, D.useCallback)((u, e) => {
                            const t = uu.view.pxToRem(u),
                                A = uu.view.pxToRem(e);
                            F(Object.assign({ width: t, height: A }, Au(t, A, eu)));
                        }, []);
                    (((u) => {
                    ...
                    return a().createElement(au.Provider, { value: r }, u);
                }),
                    (function (u) {
                ...
                const ou = ['xl', 'lg', 'md', 'sm', 'xs'],
                    mu = (u) => u.includes('_') && ((u) => ou.includes(u))(u.split('_').at(-1)),
                    su = [iu.ExtraLarge, iu.Large, iu.Medium, iu.Small, iu.ExtraSmall],
                    du = (u, e) =>
                        Object.keys(u).reduce((t, A) => {
                            ...
                            return (
                                void 0 === F ||
                                    ((u, e) => ou.some((t) => void 0 !== e[`${u}_${t}`]))(A, u) ||
                                    (t[A] = F),
                                t
                            );
                        }, {}),
                ...
                const xu = {
                    ...
                    bu = cu((u) => {
                        let e = u.className,
                            ...
                            H = u.shrink,
                            O = u.flex,
                            W = void 0 === O ? (R || H ? `${R ? 1 : 0} ${H ? 1 : 0} auto` : void 0) : O,
                            P = u.style,
                            G = u.children,
                            N = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const j = (0, D.useMemo)(() => {
                                const u = { mt: r, mr: B, mb: C, ml: m },
                                    ...
                                    F = ((u) =>
                                        pu.reduce((e, t) => {
                                            const A = u[t];
                                            return ('number' == typeof A && (e[fu[t]] = A + 'rem'), e);
                                        }, {}))(u);
                                return {
                            ...
                            }, [t, A, r, B, C, m, P, W, T, g, M, v, S]),
                            X = j.computedStyle,
                            k = j.computedClassNames;
                        return a().createElement('div', hu({ className: l()(gu.base, ...k, e), style: X }, N), G);
                    });
                let vu;
                !(function (u) {
                ...
                const wu = (u, e, t) => {
                    ...
                    Tu = (u, e, t = vu.left) => u.split(e).reduce(t === vu.left ? wu : Su, []),
                    Lu = (() => {
                        const u = new RegExp(
                        ...
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, F) =>
                                      a().createElement(
                                          'div',
                                          { className: l()('FormatText_base_d0', t), key: `${e}-${F}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                ...
                const Gu = Object.keys(Hu()),
                    ...
                    zu = cu((u) => {
                        ...
                        return a().createElement(
                            ...
                            Pu(
                                {
                                    className: l()(Ou.base, t && Ou[t], x, A),
                                    style: h,
                ...
                const Yu = {
                    ...
                    Zu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Ju = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    ue = (0, D.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((r = r.replace(t, `%(${E})`)),
                                    (F[E] = Yu[u]
                                        ? a().createElement(
                                              'span',
                                              { className: Yu[u] },
                                              a().createElement(Mu, { text: i, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: A(u) },
                        ...
                        return a().createElement(Mu, { text: r, classMix: t, binding: F });
                    });
                function ee(u) {
                    return u;
                }
                ...
                const De = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: A, children: F, mocks: E }) {
                                const r = (0, D.useRef)([]),
                                    n = (u, t, A) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            B = (({ observableModel: u }) => {
                                                const e = { root: u.object(), battleTypes: u.array('battleTypes') },
                                                    t = (0, re.Om)(
                                                        () => {
                                                            return (
                                                                (u = e.battleTypes.get()),
                                                ...
                                                return Object.assign({}, e, { computes: { getBattleTypes: t } });
                                            })({
                                                mode: u,
                                                readByPath: a,
                                                externalModel: D,
                                ...
                                return (
                                    (0, D.useEffect)(() => {
                                        B.current ? s(n(l, A, E)) : (B.current = !0);
                                    }, [E, l, A]),
                                    (0, D.useEffect)(() => {
                                        C(u);
                                    }, [u]),
                    ...
                    ae = De[0],
                    ne = De[1],
                    Be = R.strings.mt_birthday.quests.tooltip,
                    ie = /[«»]/g,
                    le = (0, qu.Pi)(() => {
                        const u = ne().model,
                            e = u.root.get(),
                            t = e.minLevel,
                            A = e.maxLevel,
                            F = u.computes.getBattleTypes();
                        return a().createElement(
                            'div',
                            { className: 'App_base_df' },
                            a().createElement(zu, { className: 'App_header_78', text: Be.title() }),
                            a().createElement(ue, {
                                text: Be.description(),
                                binding: { minLvl: Ku(t), maxLvl: Ku(A) },
                                classMix: 'App_subtitle_cd',
                            }),
                            F.map((u) => {
                                const e = `${R.strings.menu.bonusType.$num(u).replace(ie, '')}`;
                                return a().createElement(
                                    'div',
                                    { key: u, className: 'App_itemList_61' },
                                    a().createElement('div', {
                                        className: 'App_battleTypeIcon_d8',
                                        style: {
                                            backgroundImage: `url(${R.images.gui.maps.icons.quests.prebattleConditions.$num(u)})`,
                                        },
                                    }),
                                    a().createElement(zu, { text: e }),
                                );
                            }),
                        );
                    });
                ...
                const se = a().forwardRef(function (u, e) {
                    let t = u.children,
                        A = u.className,
                        F = u.theme,
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            me({}, r, {
                                className: l()(Ce.base, Ce[`base__theme-${E}`], A),
                                ref: function (u) {
                                    ((B.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            a().createElement('div', { className: Ce.decorator }, t),
                        )
                    );
                });
                engine.whenReady.then(() => {
                    B().render(
                        a().createElement(ae, null, a().createElement(se, null, a().createElement(le, null))),
