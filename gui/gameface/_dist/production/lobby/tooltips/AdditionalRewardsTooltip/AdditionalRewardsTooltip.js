(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                t.d(e, { O: () => j });
                var n = {};
                t.r(n), t.d(n, { mouse: () => F, onResize: () => i });
                var r = {};
                t.r(r),
                    t.d(r, {
                        events: () => n,
                ...
                var E = {};
                t.r(E), t.d(E, { getBgUrl: () => C, getTextureUrl: () => B });
                var a = {};
                function s(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            596: (u, e, t) => {
                t.d(e, { Sw: () => E.Z, B3: () => i, Z5: () => a, B0: () => o, ry: () => m });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            316: (u, e, t) => {
                                  ...
                                  e.split('\n').map((e, a) =>
                                      r().createElement(
                                          ...
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : B(u, e))))(e, E, u).map((u, e) =>
                ...
                const w = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            g({}, i, {
                                className: o()(p.base, p[`base__theme-${s}`], E),
                                ref: function (u) {
                            ...
                            P(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = k(u);
                                    D.current = N.addCallback(n, t, s, e === M.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== M.None)
                                    return () => {
                                        N.removeCallback(D.current, s);
                                    };
                            }, [s, e]),
                            A
                        );
                ...
                const z = [
                    ...
                    j = [L.Gold, L.Credits, L.Crystal, L.FreeXp, L.NewYearToyFragments],
                    X = [L.BattlePassPoints],
                    W = [L.PremiumPlus, L.Premium],
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (eu(t, c, { isMouseEvent: !0, on: !0, arguments: uu(r) }, w),
                                    m && m(),
                            ...
                            T = (0, n.useCallback)((u) => {
                                g.current.isVisible &&
                                    ...
                                    (g.current.hideTimerId = window.setTimeout(() => {
                                        ...
                                        e && !e.isSameNode(g.current.prevTarget) && h();
                                    }, 200)));
                            }, []);
                        (0, n.useEffect)(() => {
                ...
                const ou = R.views.common.tooltip_window.simple_tooltip_content,
                    iu = (u) => {
                        ...
                        const A = (0, n.useMemo)(() => {
                            const u = Object.assign({}, o, { body: t, header: E, note: a, alert: s });
                            ...
                            su(
                                {
                                    contentId:
                                        ...
                                        F ? ou.SimpleTooltipHtmlContent('resId') : ou.SimpleTooltipContent('resId')),
                ...
                const Fu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return r().createElement(iu, e, n);
                        const E = e.contentId,
                            a = e.args,
                            s = null == a ? void 0 : a.contentId;
                        return E || s
                            ? r().createElement(tu, Au({}, e, { contentId: E || s }), n)
                    ...
                    lu = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: o()(Du.base, Du[`base__${n}`], A), style: i },
                            r().createElement(
                                Fu,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: o()(Du.image, null == F ? void 0 : F.image) },
                                        c &&
                                            r().createElement('div', {
                                                className: o()(Du.highlight, null == F ? void 0 : F.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: o()(Du.icon, null == F ? void 0 : F.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        B &&
                                            r().createElement('div', {
                                                className: o()(Du.overlay, null == F ? void 0 : F.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: l },
                                    r().createElement('div', {
                                        className: o()(Du.timer, null == F ? void 0 : F.periodicIcon),
                                    }),
                                ),
                        );
                    },
                    cu = 'AdditionalReward_base_a7',
                    Bu = 'AdditionalReward_base__last_78',
                    Cu = 'AdditionalReward_details_21',
                    _u = ({ label: u, value: e, valueStyle: t }) => {
                        const n = { count: t ? r().createElement('span', { className: t }, e) : e };
                        return r().createElement(_, { text: `${u} %(count)`, binding: n });
                    },
                    du = ({ label: u, value: e, bindingKey: t = 'value', bindingStyle: E }) => {
                        const a = (0, n.useMemo)(
                    ...
                    mu = ({ icon: u, label: e }) => {
                        ...
                        return 'string' != typeof t
                            ? (console.error(
                              ...
                              null)
                            : r().createElement(du, { label: t, value: e });
                    },
                    pu = {
                ...
                const gu = R.strings.tooltips.additionalRewards,
                    wu = (u) => {
                        switch (u.name) {
                            case U.Credits:
                            case U.Gold:
                            case U.Crystal:
                                return r().createElement(du, {
                                    label: gu.$dyn(u.name),
                                    value: u.value,
                                    bindingStyle: o()(pu.value, pu[`value__${u.name}`]),
                                });
                            case U.Xp:
                            case U.FreeXp:
                            case U.TankmenXP:
                                return r().createElement(du, { label: gu.$dyn(u.name), value: u.value });
                            case U.Premium:
                            case U.PremiumPlus:
                                return r().createElement(du, {
                                    label: gu.$dyn(u.name),
                                    ...
                                    bindingStyle: pu.value,
                                });
                            case U.Blueprints:
                            case U.BlueprintsAny:
                            case U.BlueprintsFinal:
                                return r().createElement(_u, vu({}, u, { valueStyle: pu.value }));
                            case U.Customizations:
                                return r().createElement(mu, u);
                            case U.BattleAchievement:
                            case U.BattleBadge:
                                return r().createElement(du, { label: gu.$dyn(u.name), value: u.label });
                            default:
                ...
                const fu = (u) => {
                    ...
                    return r().createElement(
                        'div',
                        { className: o()(cu, e && Bu) },
                        r().createElement(lu, hu({}, t, { size: G.Small })),
                        r().createElement('div', { className: Cu }, r().createElement(wu, t)),
                    );
                };
                function Tu() {
                    return (
                ...
                const Ru = ({ rewards: u, rewardLimit: e }) => {
                    ...
                    Pu = 'App_base_06',
                    Ou = 'App_background_79',
                    yu = 'App_remaining_f8',
                    Su = 'RewardsTooltipHeader_header_f4',
                    ku = 'RewardsTooltipHeader_description_fe',
                    Nu = 'RewardsTooltipHeader_count_d1',
                    Mu = () => {
                        const u = I(),
                            e = u.headerText,
                            t = u.headerCount,
                            ...
                            a = e && t ? { count: r().createElement('span', { className: Nu }, t) } : void 0,
                            s = E ? { count: E } : void 0;
                        return r().createElement(
                            r().Fragment,
                            null,
                            ...
                            n &&
                                r().createElement(
                                    'div',
                                    { className: ku },
                                    r().createElement(_, { text: n, binding: s }),
                                ),
                        );
                    },
                    Iu = () => {
                        const u = I('model.bonus'),
                            e = (0, n.useRef)(null),
                            t = (0, n.useRef)(null),
                            E = (0, n.useState)(0),
                            a = E[0],
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            'div',
                                            { ref: t },
                                            r().createElement(Ru, { rewardLimit: a, rewards: u }),
                                        ),
                                        i &&
                                            r().createElement(
                                                'div',
                ...
                engine.whenReady.then(() => {
                    a().render(r().createElement(Iu, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [807], () => __webpack_require__(316));
