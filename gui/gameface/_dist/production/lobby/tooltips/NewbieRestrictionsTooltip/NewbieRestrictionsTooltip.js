    ...
    var u,
        e = {
            ...
            171: (u, e, t) => {
                ...
                const Cu = uu.client.getSize('rem'),
                    lu = Cu.width,
                    mu = Cu.height,
                    su = Object.assign({ width: lu, height: mu }, ou(lu, mu, iu)),
                ...
                const gu = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.smallWidth && C) return au(e, t, _);
                        if (t.extraSmallWidth && l) return au(e, t, _);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                ...
                const Qu = Object.keys($u()),
                    ...
                    Fe = 'Condition_base_a4',
                    re = 'Condition_separatorDots_0a',
                    De = 'Condition_separatorDots__bottom_07',
                    ne = 'Condition_contentBlock_62',
                    ae = 'Condition_content_75',
                    ie = 'Condition_conditionIcon_90',
                    Be = 'Condition_text_c6',
                    oe = ({ conditions: u }) =>
                        n().createElement(
                            'div',
                            { className: Fe },
                    ...
                    Ce = 'ConditionSeparator_base_22',
                    le = 'ConditionSeparator_text_3d',
                    me = 'ConditionSeparator_arrow_fe',
                    se = 'ConditionSeparator_arrow__toBottom_a2',
                    ce = () =>
                        n().createElement(
                            'div',
                            { className: Ce },
                ...
                var Le = t(946);
                const ye = R.strings.tooltips.newbie_restrictions.header.subtitle,
                    Me = ((u, e) => {
