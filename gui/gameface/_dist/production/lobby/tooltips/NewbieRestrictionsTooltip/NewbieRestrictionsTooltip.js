    ...
    var u,
        e = {
            ...
            906: (u, e, t) => {
                'use strict';
                var A = {};
                (t.r(A), t.d(A, { mouse: () => c, onResize: () => m }));
                var E = {};
                (t.r(E),
                    t.d(E, {
                        events: () => A,
                ...
                var F = {};
                (t.r(F), t.d(F, { getBgUrl: () => x, getTextureUrl: () => h }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        addModelObserver: () => P,
                ...
                const m = l('clientResized'),
                    s = { down: l('mousedown'), up: l('mouseup'), move: l('mousemove') };
                const c = (function () {
                ...
                const ru = n().forwardRef(function (u, e) {
                    let t = u.children,
                        A = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            Fu({}, r, {
                                className: o()(Au.base, Au[`base__theme-${F}`], A),
                                ref: function (u) {
                                    ((i.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            n().createElement('div', { className: Au.decorator }, t),
                        )
                    );
                });
                var Du = t(403),
                ...
                const Cu = eu.client.getSize('rem'),
                    mu = Cu.width,
                    su = Cu.height,
                    cu = Object.assign({ width: mu, height: su }, lu(mu, su, Bu)),
                    du = (0, D.createContext)(cu),
                    gu = ['children'];
                const _u = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    const A = (0, D.useContext)(du),
                        ...
                        _ = { extraLarge: m, large: s, medium: c, small: d, extraSmall: g };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && i) return iu(e, t, _);
                        if (t.largeWidth && B) return iu(e, t, _);
                        if (t.mediumWidth && o) return iu(e, t, _);
                        if (t.smallWidth && l) return iu(e, t, _);
                        if (t.extraSmallWidth && C) return iu(e, t, _);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                ...
                (0, D.memo)(({ children: u }) => {
                    const e = (0, D.useContext)(du),
                        ...
                        F = (0, D.useCallback)((u, e) => {
                            const t = eu.view.pxToRem(u),
                                A = eu.view.pxToRem(e);
                            E(Object.assign({ width: t, height: A }, lu(t, A, Bu)));
                        }, []);
                    (hu(() => {
                    ...
                    return n().createElement(du.Provider, { value: r }, u);
                });
                let xu, pu, fu;
                (!(function (u) {
                ...
                const vu = () => {
                    ...
                    bu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Su = (u) => u.includes('_') && ((u) => bu.includes(u))(u.split('_').at(-1)),
                    wu = [xu.ExtraLarge, xu.Large, xu.Medium, xu.Small, xu.ExtraSmall],
                    Lu = (u, e) =>
                        Object.keys(u).reduce((t, A) => {
                            ...
                            return (
                                void 0 === E ||
                                    ((u, e) => bu.some((t) => void 0 !== e[`${u}_${t}`]))(A, u) ||
                                    (t[A] = E),
                                t
                            );
                        }, {}),
                ...
                const Hu = {
                    ...
                    Nu = yu((u) => {
                        ...
                        const j = (0, D.useMemo)(() => {
                            ...
                            }, [t, A, r, i, l, m, N, P, L, g, R, b, w]),
                            I = j.computedStyle,
                            X = j.computedClassNames;
                        return n().createElement('div', Tu({ className: o()(Mu.base, ...X, e), style: I }, G), W);
                    });
                let Wu;
                !(function (u) {
                ...
                const Gu = (u, e, t) => {
                    ...
                    Iu = (u, e, t = Wu.left) => u.split(e).reduce(t === Wu.left ? Gu : ju, []),
                    Xu = (() => {
                        const u = new RegExp(
                        ...
                        return zu.includes(t)
                            ...
                            : ((u, e = Wu.left) => {
                                  ...
                                  const A =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (Iu(E, /( )/, e).forEach((u) => (t = t.concat(Iu(u, A, Wu.left)))), t);
                              })(u, e);
                    },
                    Vu = 'FormatText_base_d0',
                    Uu = ({ binding: u, text: e = '', classMix: t, alignment: A = Wu.left }) =>
                        null === e
                            ...
                            : n().createElement(
                                  ...
                                  e.split('\n').map((e, E) =>
                                      n().createElement(
                                          'div',
                                          { className: o()(Vu, t), key: `${e}-${E}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : ku(u, e))))(e, A, u).map((u, e) =>
                                              n().createElement(D.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              );
                ...
                const Zu = Object.keys(Ku()),
                    ...
                    Fe = yu((u) => {
                        ...
                        return n().createElement(
                            ...
                            Qu(
                                {
                                    className: o()(Yu.base, t && Yu[t], x, A),
                                    style: h,
                                    mt: !0 === a ? Ae[t || 'paragraph-P16'].mt : a,
                                    mr: !0 === B ? Ae[t || 'paragraph-P16'].mr : B,
                                    mb: !0 === C ? Ae[t || 'paragraph-P16'].mb : C,
                                    ml: !0 === s ? Ae[t || 'paragraph-P16'].ml : s,
                                },
                                g,
                            ),
                            void 0 !== d ? n().createElement(Uu, Qu({}, d, { text: e })) : e,
                        );
                    }),
                    re = 'Condition_base_a4',
                    De = 'Condition_base__withOverlap_6c',
                    ne = 'Condition_separatorDots_0a',
                    ae = 'Condition_contentBlock_62',
                    ie = 'Condition_content_75',
                    Be = 'Condition_conditionIcon_90',
                    oe = 'Condition_text_c6',
                    le = ({ condition: u, hasOverlap: e }) =>
                        n().createElement(
                            'div',
                            { className: o()(re, e && De) },
                    ...
                    Ce = 'ConditionAndSeparator_base_2f',
                    me = 'ConditionAndSeparator_plus_10',
                    se = 'ConditionAndSeparator_glow_94',
                    ce = () =>
                        n().createElement(
                            'div',
                            { className: Ce },
                            ...
                            ? n().createElement(
                                  ...
                                  u.map((e, t) =>
                                      n().createElement(
                                          D.Fragment,
                                          { key: t },
                                          n().createElement(le, { condition: e, hasOverlap: t < u.length - 1 }),
                                          u[t + 1] && n().createElement(ce, null),
                                      ),
                                  ),
                              )
                            : n().createElement(le, { condition: u[0] }),
                    _e = 'ConditionSeparator_base_22',
                    he = 'ConditionSeparator_text_3d',
                    xe = 'ConditionSeparator_arrow_fe',
                    pe = 'ConditionSeparator_arrow__toBottom_a2',
                    fe = () =>
                        n().createElement(
                            'div',
                            { className: _e },
                            ...
                            n().createElement(Fe, {
                                text: R.strings.tooltips.newbie_restrictions.condition.separator(),
                                color: 'CREAM',
                                variant: 'paragraph-P14',
                                className: he,
                            }),
                            n().createElement('div', { className: o()(xe, pe) }),
                        ),
                    ve = 'Footer_base_2b',
                    be = ({ title: u, subtitle: e }) =>
                        u || e
                            ? n().createElement(
                                  'div',
                                  { className: ve },
                                  u && n().createElement(Fe, { text: u, color: 'PAR', variant: 'heading-H15' }),
                                  e &&
                                      n().createElement(Fe, {
                                          text: e,
                                          color: 'PAR_SECONDARY',
                            ...
                            : null,
                    Se = 'Header_base_87',
                    we = ({ title: u, subtitle: e }) =>
                        n().createElement(
                            'div',
                            { className: Se },
                            n().createElement(Fe, { text: u, color: 'WHITE_SPANISH', variant: 'heading-H22' }),
                            e && n().createElement(Fe, { text: e, color: 'PAR', variant: 'paragraph-P14' }),
                        );
                function Le() {}
                function ye() {
                    return !1;
                ...
                function Re(u, e) {
                    ...
                    if (
                        ...
                        (t = (function (u, e) {
                            if (!u) return;
                            if ('string' == typeof u) return Te(u, e);
                ...
                const Oe = (u) => {
                    return null !== u && 'object' == typeof u
                        ? 'CoherentArrayProxy' === u.constructor.name
                            ? ((e = u),
                              (t = (u) => ('object' == typeof u ? Oe(u) : u)),
                              Array.isArray(e) ? e.map(t) : e.map((u, e, A) => t(null == u ? void 0 : u.value, e, A)))
                            : Array.isArray(u)
                              ? u.map((u) => ('object' == typeof u ? Oe(u) : u))
                              : Object.fromEntries(
                                    Object.entries(u).map(([u, e]) => [u, 'object' == typeof e ? Oe(e) : e]),
                                )
                        : u;
                    var e, t;
                };
                var Pe = t(946);
                const Ne = R.strings.tooltips.newbie_restrictions.header.subtitle,
                    We = ((u, e) => {
                                ...
                                const a = (0, D.useRef)([]),
                                    i = (t, A, E) => {
                                        ...
                                        const r = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const D = 'string' == typeof F ? `${A}.${F}` : A,
                                                            n = eu.view.addModelObserver(D, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Re(E.keys()); !(u = t()).done;) F(u.value, e);
                                                    },
                                                    unsubscribe: F,
                                                };
                                            })(A),
                                            ...
                                            n = (u) =>
                                                'mocks' === t ? (null == E ? void 0 : E.getter(u)) : D.readByPath(u),
                                        ...
                                        return {
                                            model: B,
                                            controls: 'mocks' === t && E ? E.controls(o) : e(o),
                                            externalModel: D,
                                            mode: t,
                                        };
                                    },
                                    ...
                                    l = o[0],
                                    C = o[1],
                                    m = (0, D.useState)(() => i(A, E, r)),
                                    s = m[0],
                                    c = m[1];
                                return (
                                    (0, D.useEffect)(() => {
                                        B.current ? c(i(l, E, r)) : (B.current = !0);
                                    }, [r, l, E]),
                                    (0, D.useEffect)(() => {
                                        C(A);
                                    }, [A]),
                                    (0, D.useEffect)(
                                        () => () => {
                                            (s.externalModel.dispose(), a.current.forEach((u) => u()));
                                        },
                                        [s],
                                    ),
                                    n().createElement(t.Provider, { value: s }, F)
                                );
                            },
                            () => (0, D.useContext)(t),
                        ];
                    })(({ observableModel: u }) => {
                        const e = { root: u.object(), conditionGroups: u.array('conditionGroups') },
                            t = (0, Pe.Om)(
                                () => {
                                    return ((u = e.conditionGroups.get()), Oe(u));
                                    var u;
                                },
                                { equals: ye },
                            ),
                            A = (0, Pe.Om)(() => {
                                ...
                                const A = t(),
                                    E = A.length,
                                    F = null != (u = null == (e = A[0]) ? void 0 : e.conditions.length) ? u : 0;
                                return E > 1
                                    ? Ne.one_of_conditions()
                                    : 1 === E && F > 1
                                      ? Ne.few_conditions()
                                      : 1 === E && 1 === F
                                        ? Ne.one_condition()
                        ...
                        return Object.assign({}, e, { computes: { getConditionGroups: t, getSubtitleText: A } });
                    }, Le),
                    Ge = We[0],
                    je = We[1],
                    Ie = 'App_base_bd',
                    Xe = (0, Du.Pi)(() => {
                        const u = je().model,
                            ...
                            t = e.footerText,
                            A = e.footerTitleText,
                            E = u.computes.getConditionGroups(),
                            F = u.computes.getSubtitleText();
                        return n().createElement(
                            'div',
                            { className: Ie },
                            n().createElement(
                                ...
                                null,
                                n().createElement(we, {
                                    title: R.strings.tooltips.newbie_restrictions.header.title(),
                                    subtitle: F,
                                }),
                                E.map((u, e) =>
                                    n().createElement(
                                        D.Fragment,
                                        { key: e },
                                        n().createElement(ge, { conditions: u.conditions }),
                                        E[e + 1] && n().createElement(fe, null),
                                    ),
                                ),
                                n().createElement(be, { title: A, subtitle: t }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    i().render(
                        n().createElement(Ge, null, n().createElement(Xe, null)),
    ...
    ((A.m = e),
        ...
        (A.O = (e, t, E, F) => {
            if (!t) {
                ...
                for (i = 0; i < u.length; i++) {
                    for (var [t, E, F] = u[i], D = !0, n = 0; n < t.length; n++)
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); a < r.length; a++) ((F = r[a]), A.o(u, F) && u[F] && u[F][0](), (u[F] = 0));
                    return A.O(i);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
        })());
    var E = A.O(void 0, [807], () => A(906));
    E = A.O(E);
})();
