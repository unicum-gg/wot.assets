        ...
        e = {
            ...
            171: (u, e, t) => {
                ...
                const m = C('clientResized'),
                    s = { down: C('mousedown'), up: C('mouseup'), move: C('mousemove') };
                const c = (function () {
                ...
                const lu = eu.client.getSize('rem'),
                    mu = lu.width,
                    su = lu.height,
                    cu = Object.assign({ width: mu, height: su }, Cu(mu, su, Bu)),
                ...
                const _u = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.smallWidth && C) return iu(e, t, _);
                        if (t.extraSmallWidth && l) return iu(e, t, _);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                    ...
                    const e = (0, D.useContext)(du),
                        ...
                        F = (0, D.useCallback)((u, e) => {
                            const t = eu.view.pxToRem(u),
                                A = eu.view.pxToRem(e);
                            E(Object.assign({ width: t, height: A }, Cu(t, A, Bu)));
                        }, []);
                    (hu(() => {
                ...
                const Hu = {
                    ...
                    Wu = yu((u) => {
                        ...
                        const j = (0, D.useMemo)(() => {
                            ...
                            }, [t, A, r, i, C, m, W, P, L, g, R, b, w]),
                            I = j.computedStyle,
                            X = j.computedClassNames;
                        return n().createElement('div', Tu({ className: o()(Mu.base, ...X, e), style: I }, G), N);
                    });
                let Nu;
                !(function (u) {
                ...
                const Gu = (u, e, t) => {
                    ...
                    Iu = (u, e, t = Nu.left) => u.split(e).reduce(t === Nu.left ? Gu : ju, []),
                    Xu = (() => {
                        const u = new RegExp(
                        ...
                        return zu.includes(t)
                            ...
                            : ((u, e = Nu.left) => {
                                  ...
                                  const A =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (Iu(E, /( )/, e).forEach((u) => (t = t.concat(Iu(u, A, Nu.left)))), t);
                              })(u, e);
                    },
                    Vu = 'FormatText_base_d0',
                    Uu = ({ binding: u, text: e = '', classMix: t, alignment: A = Nu.left }) =>
                        null === e
                ...
                const Zu = Object.keys(Ku()),
                            ...
                            Qu(
                                {
                                    ...
                                    mb: !0 === l ? Ae[t || 'paragraph-P16'].mb : l,
                    ...
                    De = 'Condition_separatorDots_0a',
                    ne = 'Condition_separatorDots__bottom_07',
                    ...
                    Ce = ({ conditions: u }) =>
                        n().createElement(
                            ...
                            n().createElement('div', { className: o()(De, ne) }),
                        ),
                    le = 'ConditionSeparator_base_22',
                    me = 'ConditionSeparator_text_3d',
                    se = 'ConditionSeparator_arrow_fe',
                    ce = 'ConditionSeparator_arrow__toBottom_a2',
                    de = () =>
                        n().createElement(
                            'div',
                            { className: le },
                            ...
                            n().createElement('div', { className: o()(se, ce) }),
                        ),
                    ge = 'Footer_base_2b',
                    _e = ({ title: u, subtitle: e }) =>
                        u || e
                            ? n().createElement(
                                  'div',
                                  { className: ge },
                ...
                const we = (u) => (0 === u ? window : window.subViews.get(u));
                const Le = (u) => {
                    return null !== u && 'object' == typeof u
                        ? 'CoherentArrayProxy' === u.constructor.name
                            ? ((e = u),
                              (t = (u) => ('object' == typeof u ? Le(u) : u)),
                ...
                var ye = t(946);
                const Me = R.strings.tooltips.newbie_restrictions.header.subtitle,
                    Re = ((u, e) => {
                        ...
                        return [
                            function ({ mode: A = 'real', options: E, children: F, mocks: r }) {
                                    ...
                                    i = (t, A, E) => {
                                        ...
                                        const r = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = be(E.keys()); !(u = t()).done;) F(u.value, e);
                                                    },
                                                    unsubscribe: F,
                                                };
                                            })(A),
                                ...
                                return (
                                    (0, D.useEffect)(() => {
                                        B.current ? c(i(C, E, r)) : (B.current = !0);
                                    }, [r, C, E]),
                                    (0, D.useEffect)(() => {
                                        l(A);
                                    }, [A]),
                        ...
                        const e = { root: u.object(), conditionGroups: u.array('conditionGroups') },
                            t = (0, ye.Om)(
                                () => {
                                    return ((u = e.conditionGroups.get()), Le(u));
                                    var u;
                                },
                                { equals: fe },
                            ),
                            ...
                            n().createElement(
                                ...
                                E.map((u, e) =>
                                    n().createElement(
                                        D.Fragment,
                                        { key: e },
                                        n().createElement(Ce, { conditions: u.conditions }),
                                        E[e + 1] && n().createElement(de, null),
                                    ),
                                ),
                                n().createElement(_e, { title: A, subtitle: t }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    i().render(
                        n().createElement(Te, null, n().createElement(Pe, null)),
