(() => {
    var __webpack_modules__ = {
            ...
            903: (u, e, t) => {
                ...
                const s = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            o({}, l, {
                                className: E()(i.base, i[`base__theme-${B}`], r),
                                ref: function (u) {
                ...
                const g = A.O.client.getSize('rem'),
                    p = g.width,
                    v = g.height,
                    x = Object.assign({ width: p, height: v }, h(p, v, m)),
                    w = (0, a.createContext)(x),
                    b = ['children'];
                const f = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    const r = (0, a.useContext)(w),
                        ...
                        g = { extraLarge: C, large: _, medium: m, small: d, extraSmall: h };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.smallWidth && B) return c(e, t, g);
                ...
                (0, a.memo)(({ children: u }) => {
                    const e = (0, a.useContext)(w),
                        ...
                        n = (0, a.useCallback)((u, e) => {
                            ...
                            E(Object.assign({ width: t, height: r }, h(t, r, m)));
                        }, []);
                    (S(() => {
                    ...
                    return F().createElement(w.Provider, { value: i }, u);
                });
                let M, L, O;
                (!(function (u) {
                ...
                const G = {
                    ...
                    K = k((u) => {
                        ...
                        const z = (0, a.useMemo)(() => {
                            ...
                            }, [t, r, i, o, B, C, H, N, M, d, T, b, S]),
                            V = z.computedStyle,
                            Y = z.computedClassNames;
                        return F().createElement('div', U({ className: E()(W.base, ...Y, e), style: V }, K), k);
                    });
                let z;
                function V(u, e) {
                        ...
                        return Q.includes(t)
                            ...
                            : ((u, e = z.left) => {
                                  ...
                                  const r =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return ($(E, /( )/, e).forEach((u) => (t = t.concat($(u, r, z.left)))), t);
                              })(u, e);
                    },
                    uu = 'FormatText_base_d0',
                    eu = ({ binding: u, text: e = '', classMix: t, alignment: r = z.left }) =>
                        null === e
                ...
                const Fu = Object.keys(ru()),
                    ...
                    lu = k((u) => {
                        ...
                        return F().createElement(
                            ...
                            au(
                                {
                                    className: E()(Eu.base, t && Eu[t], p, r),
                                    style: g,
                            ...
                            void 0 !== m ? F().createElement(eu, au({}, m, { text: e })) : e,
                        );
                    });
                var Cu = t(403);
                let _u;
                ...
                const hu = (u) =>
                        u.days > 0
                            ...
                            : u.hours > 0
                              ...
                              : u.minutes > 0
                                ? V(R.strings.common.duration.minutes(), { minutes: u.minutes })
                                : V(R.strings.common.duration.seconds(), { seconds: u.seconds }),
                    gu =
                        ((0, a.memo)(({ duration: u }) => {
                            const e = u >= 0 ? hu(du(u)) : R.strings.common.duration.unlimited();
                    ...
                    pu = (u) =>
                        hu(
                            ((u) => {
                                const e = du(Math.max(0, Math.ceil(u))),
                                    t = e.minutes > 0 || e.seconds > 0,
                                    r = e.hours > 0 || t;
                                return e.days > 0
                                    ? Object.assign({}, gu, { days: e.days + (r ? 1 : 0) })
                                    : e.hours > 0
                                      ? Object.assign({}, gu, { hours: e.hours + (t ? 1 : 0) })
                                      : e.minutes > 0
                                        ? Object.assign({}, gu, { minutes: e.minutes + (e.seconds > 0 ? 1 : 0) })
                                        : e.seconds > 0
                                          ? Object.assign({}, gu, { minutes: 1 })
                                          : gu;
                            })(u),
                        );
                function vu() {}
                ...
                const Mu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: E, children: n, mocks: i }) {
                                const D = (0, a.useRef)([]),
                                    o = (t, r, E) => {
                                        var a;
                                        const F = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = bu(E.keys()); !(u = t()).done;) a(u.value, e);
                                                    },
                                                    unsubscribe: a,
                                                };
                                            })(r),
                                            ...
                                            B = { mode: t, model: s, externalModel: n, cleanup: o };
                                        return {
                                            model: s,
                                    ...
                                    l = B[0],
                                    C = B[1],
                                    _ = (0, a.useState)(() => o(r, E, i)),
                                    c = _[0],
                                    m = _[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        s.current ? m(o(l, E, i)) : (s.current = !0);
                                    }, [i, l, E]),
                                    (0, a.useEffect)(() => {
                                        C(r);
                                    }, [r]),
                    ...
                    Pu = 'App_body_cb',
                    Nu = 'App_highlight_37',
                    Hu = 'App_timerContainer_2c',
                    ku = 'App_timerIcon_3a',
                    Wu = 'App_timerText_04',
                    Iu = 'App_timerDescription_0c',
                    Uu = R.strings.tooltips.awardItem.rewardsSlots,
                    Gu = (0, Cu.Pi)(() => {
                        const u = Ou().model.root.get(),
                            e = u.amountDay,
                            t = u.expire,
                            r = (0, a.useMemo)(() => {
                                const u = t - Date.now() / 1e3;
                                return pu(u);
                            }, [t]),
                            A = (0, a.useMemo)(
                                () => ((u) => u > Math.floor(Date.now() / 1e3) && Number.isFinite(u))(t),
                                [t],
                            );
                        return F().createElement(
                            'div',
                            { className: Tu },
                            F().createElement(lu, { className: Ru, text: Uu.header() }),
                            F().createElement(lu, {
                                className: yu,
                                text: Uu.subHeader(e),
                                format: {
                                    binding: { days: F().createElement(lu, { className: Nu, text: String(e) }) },
                                },
                            }),
                            F().createElement(lu, { className: Pu, text: Uu.body1() }),
                            F().createElement(lu, { className: E()(Pu, Nu), text: Uu.body2() }),
                            A &&
                                F().createElement(
                                    'div',
                                    { className: Hu },
                                    F().createElement(lu, { className: Iu, text: Uu.footer() }),
                                    F().createElement('div', { className: ku }),
                                    F().createElement(lu, { className: Wu, text: r }),
                                ),
                        );
                    });
                engine.whenReady.then(() => {
                    l().render(
                        F().createElement(Lu, null, F().createElement(s, null, F().createElement(Gu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [807], () => __webpack_require__(903));
