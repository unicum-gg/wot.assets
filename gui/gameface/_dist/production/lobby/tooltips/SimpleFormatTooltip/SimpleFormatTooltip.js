(() => {
                ...
                const ou = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const E = (0, i.useRef)([]),
                                    F = (u, t, n) => {
                                        ...
                                        const i = (function ({
                                            ...
                                            c = { mode: u, model: A, externalModel: a, cleanup: F };
                                        return {
                                            model: A,
                                    ...
                                    l = c[0],
                                    d = c[1],
                                    D = (0, i.useState)(() => F(u, n, s)),
                                    B = D[0],
                                    _ = D[1];
                                return (
                                    (0, i.useEffect)(() => {
                                        A.current ? _(F(l, n, s)) : (A.current = !0);
                                    }, [s, l, n]),
                                    (0, i.useEffect)(() => {
                                        d(u);
                                    }, [u]),
                    ...
                    Eu = (0, eu.Pi)(() => {
                        ...
                        return e || t
                            ? a().createElement(
                                  'div',
                                  { className: 'SimpleFormatTooltipApp_base_0d' },
                                  t &&
                                      a().createElement(uu, {
                                          text: t,
                                          classMix: r()(
                                              'SimpleFormatTooltipApp_header_32',
                                              e && 'SimpleFormatTooltipApp_header__withBody_b6',
                                          ),
                                      }),
                                  e && a().createElement(uu, { text: e, classMix: 'SimpleFormatTooltipApp_body_7d' }),
                              )
                            : (console.warn('Incorrect data! Body and header is null or empty'), null);
                    });
                engine.whenReady.then(() => {
                    l().render(
                        a().createElement(A, null, a().createElement(au, null, a().createElement(Eu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(3182));
