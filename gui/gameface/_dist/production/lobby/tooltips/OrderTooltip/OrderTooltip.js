    ...
    var __webpack_modules__ = {
            ...
            4483: (u, e, t) => {
                ...
                const _ = E().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        E().createElement(
                            'div',
                            l({}, _, {
                                className: i()(o.base, o[`base__theme-${F}`], A),
                                ref: function (u) {
                ...
                const B = (u, e, t) => {
                    ...
                    d = (u, e, t = s.left) => u.split(e).reduce(t === s.left ? B : C, []),
                    m = (() => {
                        const u = new RegExp(
                ...
                let h;
                var g;
                ((g = h || (h = {})).SHORT_DATE = 'short-date'),
                    (g.SHORT_TIME = 'short-time'),
                    (g.SHORT_DATE_TIME = 'short-date-time'),
                    (g.FULL_DATE = 'full-date'),
                    (g.FULL_DATE_TIME = 'full-date-time'),
                    (g.MONTH = 'month'),
                    (g.MONTH_DATE = 'month-date'),
                    (g.DATE_MONTH = 'date-month'),
                    (g.MONTH_YEAR = 'month-year'),
                    (g.WEEK_DAY = 'week-day'),
                    (g.WEEK_DAY_TIME = 'week-day-time'),
                    (g.YEAR = 'year'),
                    (g.DATE_YEAR = 'date-year');
                var p = t(4179);
                Date.now();
                const x = (u = 1) => {
                    ...
                    return (
                        v(() => {
                            if (
                                                ...
                                                const e = x(),
                                                    ...
                                                    E =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: E, modelPath: f(E, ''), resId: r };
                                            })(),
                                            t = e.modelPrefix,
                                            r = u.split('.');
                                        if (r.length > 0) {
                                ...
                                l.current = T.addCallback(r, t, F, e === S.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (e !== S.None)
                                return () => {
                                    T.removeCallback(l.current, F);
                                };
                        }, [F, e]),
                        o
                    );
                ...
                const k = n.O.client.getSize('rem'),
                    W = k.width,
                    I = k.height,
                    U = Object.assign({ width: W, height: I }, H(W, I, P)),
                    ...
                    X = (u) => {
                        ...
                        const E = (0, r.useContext)(G),
                            ...
                            h = { extraLarge: B, large: C, medium: d, small: m, extraSmall: c };
                    ...
                    (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(G),
                            ...
                            F = (0, r.useCallback)((u, e) => {
                                ...
                                a(Object.assign({ width: t, height: r }, H(t, r, P)));
                            }, []);
                        v(() => {
                        ...
                        return E().createElement(G.Provider, { value: i }, u);
                    }),
                    (function (u) {
                ...
                const Y = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    $ = [K.ExtraLarge, K.Large, K.Medium, K.Small, K.ExtraSmall],
                    Z = (u, e) =>
                ...
                const tu = {
                    ...
                    Au = Q((u) => {
                        let e = u.className,
                            ...
                            d = u.row,
                            m = u.flexDirection,
                            c = void 0 === m ? (C ? 'column' : d && 'row') || void 0 : m,
                            h = u.flexStart,
                            g = u.center,
                            p = u.flexEnd,
                            x = u.spaceBetween,
                        ...
                        const I = (0, r.useMemo)(() => {
                            ...
                            }, [t, A, n, D, _, B, H, N, S, c, L, b, T]),
                            U = I.computedStyle,
                            G = I.computedClassNames;
                        return E().createElement('div', eu({ className: i()(J.base, ...G, e), style: U }, W), k);
                    }),
                    au = ({ binding: u, text: e = '', classMix: t, alignment: A = s.left }) =>
                        null === e
                ...
                const lu = Object.keys(iu()),
                    ...
                    mu = Q((u) => {
                        ...
                        return E().createElement(
                            ...
                            Du(
                                {
                                    className: i()(nu.base, t && nu[t], p, A),
                                    style: g,
                            ...
                            void 0 !== m ? E().createElement(au, Du({}, m, { text: e })) : e,
                        );
                    }),
                    cu = {
                    ...
                    xu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                (i = i.replace(t, `%(${F})`)),
                                    (a[F] = cu[u]
                                        ? E().createElement(
                                              'span',
                                              { className: cu[u] },
                                              E().createElement(au, { text: D, binding: e }),
                                          )
                                        : E().createElement(
                                              'span',
                                              { style: A(u) },
                        ...
                        return E().createElement(au, { text: i, classMix: t, binding: a });
                    }),
                    wu = {
                        base: 'OrderTooltipApp_base_c3',
                        content: 'OrderTooltipApp_content_9a',
                        header: 'OrderTooltipApp_header_f3',
                        coin_icon: 'OrderTooltipApp_coin_icon_5f',
                        ...
                        divider: 'OrderTooltipApp_divider_e0',
                        dividerAmount: 'OrderTooltipApp_dividerAmount_a7',
                        dividerAmount__top: 'OrderTooltipApp_dividerAmount__top_95',
                        dividerAmount__bottom: 'OrderTooltipApp_dividerAmount__bottom_e7',
                        icon: 'OrderTooltipApp_icon_77',
                        subheader: 'OrderTooltipApp_subheader_75',
                        info: 'OrderTooltipApp_info_e8',
                        info_text: 'OrderTooltipApp_info_text_36',
                        infoContent: 'OrderTooltipApp_infoContent_19',
                        infoIcon: 'OrderTooltipApp_infoIcon_ee',
                        status: 'OrderTooltipApp_status_37',
                        status__green: 'OrderTooltipApp_status__green_c8',
                        status__yellow: 'OrderTooltipApp_status__yellow_44',
                        status__red: 'OrderTooltipApp_status__red_53',
                    };
                let vu;
                !(function (u) {
                        ...
                        E().createElement(
                            ...
                            E().createElement(
                                ...
                                E().createElement(
                                    ...
                                    E().createElement(
                                        'div',
                                        { className: wu.infoContent },
                                        E().createElement('div', { className: wu.infoIcon }),
                                        E().createElement(au, {
                                            text: R.strings.hb_lobby.orderTooltip.info(),
                                            classMix: wu.info_text,
                                        }),
                                    ),
                                    E().createElement('div', { className: wu.divider }),
                                ),
                ...
                engine.whenReady.then(() => {
                    a().render(E().createElement(bu, null), document.getElementById('root'));
                });
            },
        },
