    ...
    var u,
        e = {
            ...
            4969: (u, e, t) => {
                ...
                const Du = q.client.getSize('rem'),
                    au = Du.width,
                    nu = Du.height,
                    Bu = Object.assign({ width: au, height: nu }, ru(au, nu, Eu)),
                    iu = (0, D.createContext)(Bu),
                    Cu = ['children'],
                    lu = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.mediumWidth && C) return Au(e, t, _);
                ...
                (0, D.memo)(({ children: u }) => {
                    ...
                    return a().createElement(iu.Provider, { value: r }, u);
                }),
                    (function (u) {
                ...
                const vu = {
                    ...
                    Su = hu((u) => {
                        ...
                        return a().createElement('div', fu({ className: C()(xu.base, ...I, e), style: X }, G), N);
                    });
                let Lu;
                !(function (u) {
                ...
                const Mu = (u, e, t) => {
                    ...
                    Ru = (u, e, t = Lu.left) => u.split(e).reduce(t === Lu.left ? Mu : yu, []),
                    Tu = (() => {
                        const u = new RegExp(
                ...
                const Xu = Object.keys(Wu()),
                    ...
                    $u = hu((u) => {
                        ...
                        return a().createElement(
                            ...
                            ju(
                                {
                                    className: C()(Nu.base, t && Nu[t], x, A),
                                    style: h,
                                    mt: !0 === n ? Vu[t || 'paragraph-P16'].mt : n,
                                    mr: !0 === i ? Vu[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === o ? Vu[t || 'paragraph-P16'].mb : o,
                                    ml: !0 === s ? Vu[t || 'paragraph-P16'].ml : s,
                                },
                                g,
                            ),
                            void 0 !== c ? a().createElement(Ou, ju({}, c, { text: e })) : e,
                        );
                    }),
                    Ku = R.strings.cosmicEvent.rulesEntrypoint.tooltip,
                    Yu = () =>
                        a().createElement(
                            uu,
                            { theme: 'none' },
                            a().createElement(
                                ...
                                a().createElement($u, { className: 'App_header_dc', text: Ku.title() }),
                                a().createElement($u, { className: 'App_description_5d', text: Ku.description() }),
                                a().createElement(
                                    'div',
                                ...
                                a().createElement($u, { className: 'App_footerDesc_36', text: Ku.footerDesc() }),
                            ),
                        );
                function qu() {
                    return !1;
                ...
                ue[1],
                    engine.whenReady.then(() => {
                        B().render(
                            a().createElement(ee, null, a().createElement(Yu, null)),
