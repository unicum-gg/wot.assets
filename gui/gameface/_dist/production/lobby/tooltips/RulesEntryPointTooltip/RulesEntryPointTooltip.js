    ...
    var u,
        e = {
            ...
            4969: (u, e, t) => {
                ...
                const K = Object.keys(p).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === p[e]), u), {}),
                    Y = {
                        set: (u, e) => {
                ...
                const eu = a().forwardRef(function (u, e) {
                    let t = u.children,
                        A = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            uu({}, r, {
                                className: C()(Z.base, Z[`base__theme-${F}`], A),
                                ref: function (u) {
                                    ((B.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            a().createElement('div', { className: Z.decorator }, t),
                        )
                    );
                });
                var tu = t(9887),
                ...
                const au = Q.client.getSize('rem'),
                    nu = au.width,
                    Bu = au.height,
                    iu = Object.assign({ width: nu, height: Bu }, Du(nu, Bu, Fu)),
                    Cu = (0, D.createContext)(iu),
                    lu = ['children'],
                    ou = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && B) return Eu(e, t, _);
                            if (t.largeWidth && i) return Eu(e, t, _);
                            if (t.mediumWidth && C) return Eu(e, t, _);
                            if (t.smallWidth && l) return Eu(e, t, _);
                            if (t.extraSmallWidth && o) return Eu(e, t, _);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                    ...
                    const e = (0, D.useContext)(Cu),
                        ...
                        F = (0, D.useCallback)((u, e) => {
                            const t = Q.view.pxToRem(u),
                                A = Q.view.pxToRem(e);
                            E(Object.assign({ width: t, height: A }, Du(t, A, Fu)));
                        }, []);
                    (((u) => {
                ...
                const du = ['xl', 'lg', 'md', 'sm', 'xs'],
                    gu = (u) => u.includes('_') && ((u) => du.includes(u))(u.split('_').at(-1)),
                    _u = [mu.ExtraLarge, mu.Large, mu.Medium, mu.Small, mu.ExtraSmall],
                    hu = (u, e) =>
                ...
                const bu = {
                    ...
                    Lu = xu((u) => {
                        ...
                        const j = (0, D.useMemo)(() => {
                            ...
                            }, [t, A, r, B, l, m, W, P, L, g, R, b, S]),
                            X = j.computedStyle,
                            I = j.computedClassNames;
                        return a().createElement('div', vu({ className: C()(pu.base, ...I, e), style: X }, G), N);
                    });
                let Mu;
                !(function (u) {
                ...
                const yu = (u, e, t) => {
                    ...
                    Tu = (u, e, t = Mu.left) => u.split(e).reduce(t === Mu.left ? yu : Ru, []),
                    Hu = (() => {
                        const u = new RegExp(
                    ...
                    Pu = ({ binding: u, text: e = '', classMix: t, alignment: A = Mu.left }) =>
                        null === e
                ...
                const Iu = Object.keys(Nu()),
                    ...
                    Ku = xu((u) => {
                        ...
                        return a().createElement(
                            ...
                            Xu(
                                {
                                    className: C()(Gu.base, t && Gu[t], x, A),
                                    style: h,
                                    mt: !0 === n ? Uu[t || 'paragraph-P16'].mt : n,
                                    mr: !0 === i ? Uu[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === o ? Uu[t || 'paragraph-P16'].mb : o,
                                    ml: !0 === s ? Uu[t || 'paragraph-P16'].ml : s,
                                },
                                g,
                            ),
                            void 0 !== d ? a().createElement(Pu, Xu({}, d, { text: e })) : e,
                        );
                    }),
                    Yu = R.strings.cosmicEvent.rulesEntrypoint.tooltip,
                    qu = () =>
                        a().createElement(
                            eu,
                            { theme: 'none' },
                            a().createElement(
                                ...
                                a().createElement('div', { className: 'App_bg_cubes_72' }),
                                a().createElement('div', { className: 'App_bg_glow_b8' }),
                                a().createElement(Ku, { className: 'App_header_dc', text: Yu.title() }),
                                a().createElement(Ku, { className: 'App_description_5d', text: Yu.description() }),
                                a().createElement(
                                    'div',
                                    { className: 'App_divider_e9' },
                                    a().createElement('div', { className: 'App_separator_df' }),
                                    a().createElement('div', { className: 'App_infoIcon_91' }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: 'App_personBlock_b5' },
                                    a().createElement('div', { className: 'App_personImg_8a' }),
                                    a().createElement(
                                        'div',
                                        { className: 'App_textContainer_2d' },
                                        a().createElement(Ku, {
                                            className: 'App_personTitle_c3',
                                            text: Yu.personTitle(),
                                        }),
                                        a().createElement(Ku, {
                                            className: 'App_personDesc_ea',
                                            text: Yu.personDesc(),
                                        }),
                                    ),
                                ),
                                a().createElement(Ku, { className: 'App_footerDesc_36', text: Yu.footerDesc() }),
                            ),
                        );
                function Qu() {
                    return !1;
                ...
                (ee[1],
                    engine.whenReady.then(() => {
                        B().render(
                            a().createElement(te, null, a().createElement(qu, null)),
