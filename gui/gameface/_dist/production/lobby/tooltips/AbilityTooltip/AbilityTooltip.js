(() => {
    ...
    var __webpack_modules__ = {
            ...
            8098: (u, e, t) => {
                ...
                const y = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const r = e.contentId;
                    return r ? a().createElement(C, g({}, e, { contentId: r }), n) : a().createElement(v, e, n);
                };
                var T = t(8045);
                const k = {
                ...
                const S = { [P.NBSP]: x.NoBreakSymbol, [P.ZWNBSP]: x.NoBreakSymbol, [P.NEW_LINE]: x.LineBreak },
                    ...
                    J = (u, e, t, n, r, o) => {
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            if (A === x.LineBreak || A === x.NewLine || A === x.Binding) continue;
                    ...
                    uu = a().memo(
                        ({
                            ...
                            const d = (0, i.useRef)(null),
                                ...
                                _ = B[0],
                                C = B[1],
                                p = (0, i.useMemo)(() => Z(u, n, { justifyContent: F }), [n, F, u]),
                                h = (0, i.useMemo)(() => {
                                    if (
                                        o &&
                                        _.isTruncated &&
                                ...
                                f = (0, i.useMemo)(() => ({ justifyContent: F, alignContent: c }), [c, F]);
                            return (
                                ((u, e, t = !0) => {
                ...
                const ou = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const E = (0, i.useRef)([]),
                                    A = (u, t, n) => {
                                        ...
                                        const i = (function ({
                                            ...
                                            F = (({ observableModel: u }) => ({ root: u.object() }))({
                                                mode: u,
                                                readByPath: s,
                                                externalModel: a,
                                                observableModel: {
                                    ...
                                    l = c[0],
                                    d = c[1],
                                    D = (0, i.useState)(() => A(u, n, s)),
                                    B = D[0],
                                    _ = D[1];
                                return (
                                    (0, i.useEffect)(() => {
                                        F.current ? _(A(l, n, s)) : (F.current = !0);
                                    }, [s, l, n]),
                                    (0, i.useEffect)(() => {
                                        d(u);
                                    }, [u]),
                    ...
                    su = iu[1],
                    Eu = (0, eu.Pi)(() => {
                        const u = su().model.root.get().abilityName,
                            e = R.strings.halloween_tooltips.ability.$dyn(u);
                        return e
                            ? a().createElement(
                                  'div',
                                  { className: 'AbilityTooltipApp_base_13' },
                                  a().createElement('div', { className: 'AbilityTooltipApp_header_d6' }, e.header()),
                                  a().createElement(uu, {
                                      classMix: 'AbilityTooltipApp_subHeader_cb',
                                      text: e.subHeader(),
                                  }),
                                  a().createElement('div', {
                                      className: 'AbilityTooltipApp_icon_d3',
                                      style: {
                                          backgroundImage: `url('R.images.halloween.gui.maps.icons.hangar.${u}_180x135')`,
                                      },
                                  }),
                                  a().createElement(
                                      'div',
                                      { className: 'AbilityTooltipApp_label_25' },
                                      R.strings.halloween_tooltips.ability.use.label(),
                                  ),
                                  a().createElement('div', { className: 'AbilityTooltipApp_description_56' }, e.body()),
                              )
                            : (console.error(`Can't find localization for ${u}`), null);
                    });
                engine.whenReady.then(() => {
                    l().render(
                        a().createElement(F, null, a().createElement(au, null, a().createElement(Eu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(8098));
