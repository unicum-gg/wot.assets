(() => {
                ...
                const l = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            c({}, l, {
                                className: E()(s.base, s[`base__theme-${a}`], o),
                                ref: function (u) {
                        ...
                        for (let A = t; A >= 0; A--) {
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const l = F.slice(0, F.length - c) + i,
                                    D = e[A];
                                ((E = r().cloneElement(D, D.props, l)), (a = A));
                                break;
                            }
                            {
                                const u = t.children,
                                ...
                                if (!(D < 0)) {
                                    const u = c.slice(0, D);
                                    ((E = r().cloneElement(s, s.props, u, d)), (a = A));
                                    break;
                                }
                                o -= F.length;
                            }
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            ...
                                            r().createElement('div', { className: au }, A),
                                        ),
                                    ),
                                    r().createElement('img', {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(7955));
