(() => {
    ...
    var __webpack_modules__ = {
            ...
            3048: (u, e, t) => {
                ...
                const _ = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    p = (u, e, t = d.left) => u.split(e).reduce(t === d.left ? m : C, []),
                    g = (() => {
                        const u = new RegExp(
                            [
                ...
                const w = (0, o.memo)(({ duration: u }) => {
                        ...
                        var t;
                        return s().createElement('span', null, e);
                    }),
                    h = ({ binding: u, text: e = '', classMix: t, alignment: n = d.left, formatWithBrackets: a }) => {
                ...
                const S = ({ size: u = P.Default }) => {
                        const e = r()(T.background, T[`background__${u}`]);
                        return s().createElement('div', { className: e });
                    },
                    O = { base: 'ProgressBarBlink_base_24', base__small: 'ProgressBarBlink_base__small_0f' },
                    k = ({ size: u }) => {
                        const e = r()(O.base, O[`base__${u}`]);
                        return s().createElement('div', { className: e });
                    },
                    x = {
                    ...
                    I = (0, o.memo)(
                        ({ size: u, lineRef: e, disabled: t, baseStyles: n, isComplete: a, withoutBounce: o }) => {
                            ...
                            return s().createElement(
                                ...
                                s().createElement('div', { className: x.gradient }),
                                E && s().createElement(k, { size: u }),
                            );
                        },
                    ),
                    M = (u, e) => {
                ...
                const U = (u) => (u ? { left: 0 } : { right: 0 }),
                    G = (u, e) => (u ? { right: 100 - e + '%' } : { left: `${e}%` }),
                    $ = (u) => ({ transitionDuration: `${u}ms` }),
                    z = (0, o.memo)(
                        ({
                            ...
                            const b = (0, o.useMemo)(() => Object.assign({ width: '100%' }, $(u), U(F)), [F, u]),
                                v = (0, o.useMemo)(() => Object.assign({ width: '0%' }, $(u), U(F)), [F, u]),
                                f = (0, o.useMemo)(() => Object.assign({ width: '0%' }, G(F, n), $(u)), [n, F, u]),
                                w = (0, o.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(i - n)}%` }, G(F, n), $(u)),
                                    [n, F, i, u],
                                );
                            if (B) return null;
                            const h = r()(
                        ...
                        ({
                            ...
                            return d
                                ...
                                : s().createElement(
                                      ...
                                      s().createElement(
                                          'div',
                                          { style: B ? m : C, className: 'ProgressBarDeltaSimple_delta_99' },
                                          s().createElement(k, { size: r }),
                                      ),
                                  );
                        },
                    ),
                ...
                const H = (0, o.memo)((u) => {
                        ...
                        switch (n.animationSettings.type) {
                            case y.Simple:
                                return s().createElement(Y, W({}, n, { onEndAnimation: E, isComplete: a }));
                            case y.Growing:
                                return s().createElement(q, W({}, n, { onEndAnimation: E, isComplete: a }));
                            default:
                                return null;
                        }
                    }),
                    X = ({ size: u, value: e, lineRef: t, disabled: n, onComplete: r }) => {
                        ...
                        return (
                            ...
                            s().createElement(I, { size: u, disabled: n, baseStyles: a, isComplete: i, lineRef: t })
                        );
                    },
                    K = ['onEndAnimation'];
                function Q() {
                ...
                const uu = (0, o.memo)(
                        ({
                            ...
                            return o.withStack
                                ? s().createElement(Z, A)
                                : s().createElement(H, J({ key: `${r}-${e}-${a}` }, A));
                        },
                    ),
                    eu = (u) => {
                        var e, t, n, r, a, o, s, i, E, l, A, F, c, D, d, B, _, m, C, p;
                        return {
                            ...
                            '--progress-glow-small-height':
                                null != (_ = null == (m = u.glowSettings) ? void 0 : m.smallHeight) ? _ : '43rem',
                    ...
                    ru = (u, e, t) => ('number' == typeof t ? (nu(0, e, t) / e) * 100 : u),
                    au = {
                        bgImageBase: 'R.images.gui.maps.icons.components.progress_bar.pattern_grey',
                    ...
                    su = (0, o.memo)(
                        ({
                            ...
                            const _ = (function (u, e, t) {
                                return (0, o.useMemo)(() => {
                                    const n = (nu(0, e, u) / e) * 100;
                                    return { value: n, deltaFrom: ru(n, e, t) };
                                }, [t, e, u]);
                            })(E, u, l);
                            return s().createElement(
                                'div',
                                { className: r()(T.base, B, T[`base__${t}`]), style: eu(e) },
                                !i && s().createElement(S, { size: t }),
                                s().createElement(uu, {
                                    size: t,
                                    lineRef: F,
                                    disabled: a,
                        ...
                        const b = (0, o.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, o.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (lu(t, D, { isMouseEvent: !0, on: !0, arguments: Eu(n) }, v),
                                    C && C(),
                            ...
                            Bu(
                                {
                                    contentId:
                                        ...
                                        A ? _u.SimpleTooltipHtmlContent('resId') : _u.SimpleTooltipContent('resId')),
                ...
                const pu = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return s().createElement(mu, e, n);
                    const r = e.contentId;
                    return r ? s().createElement(Au, Cu({}, e, { contentId: r }), n) : s().createElement(Du, e, n);
                };
                let gu, bu, vu, fu, wu, hu, Ru, Tu;
                (!(function (u) {
                    ((u.Items = 'items'),
                ...
                const Pu = [gu.Attachment],
                    yu = ({ value: u, format: e = 'integral' }) => {
                        const t = (function (u) {
                                return 'gold' === u ? v.B3.GOLD : v.B3.INTEGRAL;
                            })(e),
                            n = v.Z5.getNumberFormat(u, t);
                    ...
                    Su = [
                        ...
                        gu.DeluxeGift,
                        gu.ModernizedDevicesT1Gift,
                        gu.ModernizedDevicesT2Gift,
                        gu.ModernizedDevicesT3Gift,
                    ...
                    Ou = [gu.Gold, gu.Credits, gu.Crystal, gu.FreeXp],
                    ku = [gu.BattlePassPoints, gu.EquipCoin],
                    xu = [gu.PremiumPlus, gu.Premium],
                    ...
                    $u = ({
                        ...
                        const d = ((u, e) => {
                            ...
                            B = ((u) => {
                                ...
                                switch (u) {
                                    ...
                                    case wu.ATTACHMENT_RARE:
                                        return Ru.ATTACHMENT_RARE;
                                    case wu.ATTACHMENT_EPIC:
                                        return Ru.ATTACHMENT_EPIC;
                                    case wu.ATTACHMENT_LEGENDARY:
                                        return Ru.ATTACHMENT_LEGENDARY;
                                }
                            })(a),
                            _ = ((u, e) => {
                                if (void 0 === u) return null;
                                switch (e) {
                                    ...
                                    case fu.CURRENCY:
                                    case fu.NUMBER:
                                        return s().createElement(yu, { format: 'integral', value: Number(u) });
                        ...
                        return s().createElement(
                            'div',
                            {
                                className: r()(Gu.base, Gu[`base__${n}`], Pu.includes(u) && Gu.base__normalize, A),
                                style: l,
                            },
                            s().createElement(
                                pu,
                                { tooltipArgs: c, className: Gu.tooltipWrapper },
                                s().createElement(
                                    s().Fragment,
                                    null,
                                    s().createElement(
                                        'div',
                                        { className: r()(Gu.image, null == F ? void 0 : F.image) },
                                        d &&
                                            s().createElement('div', {
                                                className: r()(Gu.highlight, null == F ? void 0 : F.highlight),
                                                style: {
                                        ...
                                        e &&
                                            s().createElement('div', {
                                                className: r()(Gu.icon, null == F ? void 0 : F.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        B &&
                                            s().createElement('div', {
                                                className: r()(Gu.overlay, null == F ? void 0 : F.overlay),
                                                style: {
                                        ...
                                        s().createElement(
                                            'div',
                                            {
                                                className: r()(
                                                    Gu.info,
                                                    Gu[`info__${u}`],
                                                    i === fu.MULTI && Gu.info__multi,
                                                    null == F ? void 0 : F.info,
                                                ),
                                            },
                                            _,
                                        ),
                                    E && s().createElement('div', { className: Gu.title }, E),
                                ),
                            ),
                            t &&
                                s().createElement(
                                    ...
                                    { tooltipArgs: D },
                                    s().createElement('div', {
                                        className: r()(Gu.timer, null == F ? void 0 : F.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const Xu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: n, children: r, mocks: i }) {
                                    ...
                                    l = (u, t, n) => {
                                        ...
                                        const o = (function ({
                                            ...
                                            A = (({ observableModel: u }) => {
                                                ...
                                                return Object.assign({}, e, { computes: { getRewardsArray: t } });
                                            })({
                                                mode: u,
                                                readByPath: i,
                                                externalModel: s,
                                                observableModel: {
                                                    dict: (e) => {
                                                        const t = i(e),
                                                            n = Yu.observable.box(t, { equals: ju });
                                                        return (
                                                            'real' === u &&
                                                                s.subscribe(
                                                                    (0, Yu.action)((u) => n.set(u)),
                                                                    e,
                                                                ),
                                                            n
                                                        );
                                                    ...
                                                    array: (e, t) => {
                                                        const n = null != t ? t : i(e),
                                                            r = Yu.observable.box(n, { equals: ju });
                                                        return (
                                                            'real' === u &&
                                                                s.subscribe(
                                                                    (0, Yu.action)((u) => r.set(u)),
                                                                    e,
                                                                ),
                                                            r
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const r = e.reduce(
                                                                (u, e) => ((u[e] = Yu.observable.box(n[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                                ...
                                return (
                                    (0, o.useEffect)(() => {
                                        A.current ? _(l(c, n, i)) : (A.current = !0);
                                    }, [i, c, n]),
                                    (0, o.useEffect)(() => {
                                        D(u);
                                    }, [u]),
                ...
                const Ju = 'PerformanceWarning_title_85',
                    ue = R.strings.white_tiger_lobby.tooltips,
                    ee = { titleClasses: Ju, title: ue.informative.title(), description: ue.informative.subtitle() },
                    te = {
                        [Zu.Low]: ee,
                        [Zu.Medium]: {
                            titleClasses: r()(Ju, 'PerformanceWarning_title__medium_a3'),
                            title: ue.medium_risk.title(),
                            description: ue.medium_risk.subtitle(),
                        },
                        [Zu.High]: {
                            titleClasses: r()(Ju, 'PerformanceWarning_title__high_5f'),
                            title: ue.high_risk.title(),
                            description: ue.high_risk.subtitle(),
                        },
                    },
                    ne = ({ performanceRisk: u }) => {
                        const e = te[u] || ee,
                            t = e.title,
                            n = e.titleClasses,
                            r = e.description;
                        return s().createElement(
                            'div',
                            { className: 'PerformanceWarning_base_48' },
                            s().createElement('div', { className: n }, t),
                            s().createElement('div', { className: 'PerformanceWarning_description_ff' }, r),
                        );
                    },
                    re = () =>
                        s().createElement(
                            'div',
                            { className: 'RewardInfo_base_48' },
                            s().createElement(
                                'div',
                                { className: 'RewardInfo_title_50' },
                                R.strings.white_tiger_lobby.tooltips.commander.title(),
                            ),
                            s().createElement(
                                'div',
                                { className: 'RewardInfo_content_d7' },
                                s().createElement('div', { className: 'RewardInfo_icon_12' }),
                                s().createElement(
                                    'div',
                                    { className: 'RewardInfo_description_e1' },
                                    R.strings.white_tiger_lobby.tooltips.commander.description(),
                                ),
                            ),
                        );
                function ae() {
                ...
                const oe = R.strings.white_tiger_lobby.tooltips,
                    se = (0, zu.observer)(() => {
                        const u = Qu().model,
                            e = u.root.get(),
                            t = e.isProgressionCompleted,
                            n = e.stageCurrent,
                            a = e.commonCurrent,
                            o = e.commonTotal,
                            i = e.stampsCurrent,
                            ...
                            A = e.performanceRisk,
                            F = u.rewards.get(),
                            c = u.computes.getRewardsArray(),
                            D = r()('App_base_8e', t && 'App_base__completed_70');
                        return s().createElement(
                            'div',
                            { className: D },
                            s().createElement('div', { className: 'App_heading_df' }, oe.title()),
                            t &&
                                s().createElement(
                                    s().Fragment,
                                    null,
                                    s().createElement('div', { className: 'App_completed_e0' }, oe.completed()),
                                    s().createElement('div', { className: 'App_image_47' }),
                                ),
                            l >= 0 &&
                                s().createElement(h, {
                                    classMix: classNames(
                                        'App_timeLeft_9b',
                                        !t && 'App_timeLeft__progressionFinished_fe',
                                    ),
                                    binding: {
                                        timeLeft: s().createElement(
                                            'span',
                                            { className: 'App_timeLeft_accent_57' },
                                            s().createElement(w, { duration: l }),
                                        ),
                                    },
                                    text: oe.subtitle(),
                                }),
                            !t &&
                                s().createElement(
                                    s().Fragment,
                                    null,
                                    s().createElement('div', { className: 'App_currentStage_8f' }, n),
                                    s().createElement(
                                        'div',
                                        { className: 'App_currentStage_description_f7' },
                                        oe.currentStage(),
                                    ),
                                    s().createElement(
                                        'div',
                                        { className: 'App_progress_cf' },
                                        s().createElement(su, { value: a, maxValue: o, theme: tu }),
                                    ),
                                    s().createElement(
                                        'div',
                                        { className: 'App_stamps_88' },
                                        s().createElement(h, {
                                            binding: {
                                                stampsCurrent: s().createElement(
                                                    'span',
                                                    { className: 'App_stamps_accent_03' },
                                                    i,
                                                ),
                                                stampsMax: E,
                                            },
                                            text: oe.stampsFormat(),
                                        }),
                                        s().createElement('img', {
                                            className: 'App_stamps_icon_d2',
                                            src: R.images.white_tiger.gui.maps.icons.tooltips.points_icon(),
                                        }),
                                    ),
                                    s().createElement(
                                        'div',
                                        { className: 'App_rewards_wrapper_db' },
                                        s().createElement(
                                            'div',
                                            { className: 'App_rewards_title_df' },
                                            oe.stageAwards(),
                                        ),
                                        F &&
                                            s().createElement(
                                                'div',
                                                { className: 'App_rewards_group_91' },
                                                c.map((u, e) =>
                                                    s().createElement(
                                                        $u,
                                                        ae({ key: e, className: 'App_reward_33' }, u),
                                                    ),
                                                ),
                                            ),
                                    ),
                                ),
                            t && s().createElement(re, null),
                            A && !t && s().createElement(ne, { performanceRisk: A }),
                        );
                    });
                engine.whenReady.then(() => {
                    c().render(
                        s().createElement(Ku, null, s().createElement(A, null, s().createElement(se, null))),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (() => {
            var u = { 'lobby/tooltips/WidgetTooltipView/WidgetTooltipView': 0 };
