(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => i, off: () => a, on: () => r, onResize: () => F, onScaleUpdated: () => n });
                var E = t(2472),
                    A = t(1176);
            ...
            9480: (u, e, t) => {
                ...
                function n(u, e, t) {
                    ...
                    let E = t;
                    for (let t = 0; t < u.length; t++) E = e(E, A(u, t), t, u);
                    return E;
                }
            },
            1358: (u, e, t) => {
            ...
            1688: (u, e, t) => {
                ...
                !(function (u) {
                    ...
                    (function (u) {
                        (u.COMPLETED = 'completed'), (u.IN_PROGRESS = 'inProgress'), (u.UNAVAILABLE = 'unavailable');
                    })(a || (a = {}));
                var D = t(6483),
                    i = t.n(D),
                    o = t(3138);
                ...
                const l = A().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        A().createElement(
                            'div',
                            C({}, a, {
                                className: i()(B.base, B[`base__theme-${r}`], F),
                                ref: function (u) {
                ...
                const f = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    O = (u, e, t = w.left) => u.split(e).reduce(t === w.left ? y : T, []),
                    x = (() => {
                        const u = new RegExp(
                ...
                const k = 3600,
                    M = 86400,
                    N = (Date.now(), S.Ew.getRegionalDateTime);
                S.Ew.getFormattedDateTime;
                var L = t(9480),
                    I = t(3946);
                const U = R.strings.battle_royale.tooltip.widget.hangar,
                    V = { 0: U.header.battleLeaveTime.today(), 1: U.header.battleLeaveTime.tomorrow() },
                    q = { 0: 'start', 1: 'end' },
                    j = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: F, children: n, mocks: r }) {
                                const a = (0, E.useRef)([]),
                                        ...
                                        const F = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const r = 'string' == typeof F ? `${E}.${F}` : E,
                                                            a = o.O.view.addModelObserver(r, e, !0);
                                            ...
                                            i = (({ observableModel: u }) => {
                                                const e = Object.assign(
                                                    ...
                                                    t = (0, I.Om)(
                                                        (u) => {
                                                            const t = L.U2(e.battleTypes.get(), u);
                                                    ...
                                                    E = (0, I.Om)(
                                                        () =>
                                                            L.UI(e.battleSchedule.get(), (u, e) =>
                                                                L.UI(u, (u, t) => ({
                                                                    period: L.u4(
                                                                        u,
                                                                        (u, e, t) => ((u[q[t]] = N(e, _.ShortTime)), u),
                                                                        {},
                                                                    ),
                                                                    description: 0 === t ? V[e] : '',
                                                                })),
                                                ...
                                                return Object.assign({}, e, {
                                                    computes: { battleType: t, battleSchedule: E, battleLeaveTime: A },
                                                });
                                            })({
                                                mode: u,
                                                readByPath: r,
                                    ...
                                    s = B[0],
                                    C = B[1],
                                    l = (0, E.useState)(() => D(u, F, r)),
                                    c = l[0],
                                    d = l[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        i.current ? d(D(s, F, r)) : (i.current = !0);
                                    }, [r, s, F]),
                                    (0, E.useEffect)(() => {
                                        C(u);
                                    }, [u]),
                    ...
                    W = j[0],
                    z = j[1],
                    G = ({ binding: u, text: e = '', classMix: t, alignment: F = w.left, formatWithBrackets: n }) => {
                    ...
                    H = {
                        base: 'Schedule_base_f8',
                        base__unavailable: 'Schedule_base__unavailable_f7',
                        container: 'Schedule_container_28',
                        title: 'Schedule_title_0b',
                        icon: 'Schedule_icon_b3',
                        text: 'Schedule_text_83',
                        scheduleContainer: 'Schedule_scheduleContainer_e8',
                        schedule: 'Schedule_schedule_b0',
                        period: 'Schedule_period_6e',
                        period__today: 'Schedule_period__today_17',
                        description: 'Schedule_description_83',
                    },
                    K = R.strings.battle_royale.tooltip.widget.hangar,
                    Y = (0, c.Pi)(() => {
                        const u = z().model,
                            e = u.progressionState.get();
                        return A().createElement(
                            'div',
                            { className: i()(H.base, H[`base__${e}`]) },
                            A().createElement(
                                'div',
                                ...
                                A().createElement(
                                    'div',
                                    { className: H.title },
                                    A().createElement('div', { className: H.icon }),
                                    A().createElement('div', { className: H.text }, K.timeTable.title()),
                                ),
                                A().createElement(
                                    'div',
                                    { className: H.scheduleContainer },
                                    L.UI(u.computes.battleSchedule(), (u, e) => {
                                        const t = 0 === e;
                                        return L.UI(u, ({ period: u, description: e }, E) =>
                                            A().createElement(
                                                'div',
                                                { className: H.schedule, key: E },
                                                A().createElement(
                                                    'div',
                                                    { className: i()(H.period, t && H.period__today) },
                                                    A().createElement(G, {
                                                        text: K.battleSchedule.schedule(),
                                                        binding: u,
                                                    }),
                                                ),
                                                A().createElement('div', { className: H.description }, e),
                                            ),
                                        );
                                    }),
                                ),
                    ...
                    X = (0, c.Pi)(() => {
                        const u = z().model.performance.get();
                        return A().createElement(
                            'div',
                            { className: i()($.base, $[`base__${u}`]) },
                            A().createElement(
                                'div',
                                { className: $.container },
                                A().createElement(
                                    'div',
                                    { className: $.title },
                                    A().createElement('div', { className: $.icon }),
                                    A().createElement('div', { className: $.text }, Z.header.$dyn(u)),
                                ),
                                A().createElement('div', { className: $.description }, Z.description.$dyn(u)),
                            ),
                        );
                    }),
                    Q = {
                        base: 'Header_base_82',
                        base__unavailable: 'Header_base__unavailable_e3',
                    ...
                    J = R.strings.battle_royale.tooltip.widget.hangar,
                    uu = (0, c.Pi)(() => {
                        const u = z().model,
                            e = u.progressionState.get(),
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                'div',
                                { className: Q.header },
                                A().createElement('div', { className: Q.completedIcon }),
                                A().createElement('div', { className: Q.title }, J.header.title()),
                                A().createElement(G, { text: F, binding: { value: E }, classMix: Q.text }),
                            ),
                            A().createElement(
                                'div',
                                { className: Q.description },
                                A().createElement('div', { className: Q.subtitle }, J.description.header()),
                                A().createElement('div', { className: Q.text }, J.description.text.$dyn(e)),
                            ),
                        );
                    }),
                    eu = (0, c.Pi)(() => {
                            ...
                            A().createElement(
                                ...
                                e === a.IN_PROGRESS &&
                                    A().createElement(d.i, {
                                        ...
                                        battleType: u.computes.battleType,
                                    }),
                ...
                engine.whenReady.then(() => {
                    n().render(
                        A().createElement(W, null, A().createElement(eu, null)),
            ...
            5801: (u, e, t) => {
                ...
                var E = t(6483),
                    ...
                    n = t(7363),
                    r = t.n(n);
                const a = 'Column_separator_99',
                    D = ({ battleType: u, mode: e, isNotFirstColumn: t }) =>
                        r().createElement(
                            'div',
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1688));
