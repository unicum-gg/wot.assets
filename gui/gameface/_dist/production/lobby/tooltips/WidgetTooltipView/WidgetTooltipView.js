(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => o, off: () => D, on: () => r, onResize: () => F, onScaleUpdated: () => n }));
                var E = t(2472),
                    A = t(1176);
            ...
            1688: (u, e, t) => {
                ...
                const f = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    O = (u, e, t = g.left) => u.split(e).reduce(t === g.left ? y : T, []),
                    x = (() => {
                        const u = new RegExp(
                ...
                const U = R.strings.battle_royale.tooltip.widget.hangar,
                                                    ...
                                                    A = (0, I.Om)(() => {
                                                        ...
                                                        return u >= M
                                                            ? {
                                                                  ...
                                                                  time: w(R.strings.common.duration.days(), {
                                                                      days: Math.trunc(u / M),
                                                                  }),
                                                              }
                                                            : u >= k
                                                              ? {
                                                                    text: U.header.subTitle.text(),
                                                                    time: w(R.strings.common.duration.hours(), {
                                                                        hours: Math.trunc(u / k),
                                                                    }),
                                                                }
                                                              : {
                                                                    text: U.header.subTitle.text(),
                                                                    time: w(R.strings.common.duration.minutes(), {
                    ...
                    q = W[0],
                    z = W[1],
                    G = ({ binding: u, text: e = '', classMix: t, alignment: F = g.left, formatWithBrackets: n }) => {
                                    ...
                                    L.UI(u.computes.battleSchedule(), (u, e) => {
                                        ...
                                        return L.UI(u, ({ period: u, description: e }, E) =>
                                            A().createElement(
                                                ...
                                                A().createElement(
                                                    'div',
                                                    { className: o()(H.period, t && H.period__today) },
                                                    A().createElement(G, {
                ...
                engine.whenReady.then(() => {
                    n().render(
                        A().createElement(q, null, A().createElement(eu, null)),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/tooltips/WidgetTooltipView/WidgetTooltipView'),
        (() => {
            var u = {
                'lobby/tooltips/WidgetTooltipView/WidgetTooltipView': 0,
