    ...
    var u,
        A = {
            174: (u, A, F) => {
                var e = {};
                (F.r(e),
                    F.d(e, { mouse: () => c, off: () => s, on: () => i, onResize: () => o, onScaleUpdated: () => a }));
                var E = {};
                (F.r(E),
                    F.d(E, {
                        events: () => e,
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => P, getTextureUrl: () => _ }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => $,
                ...
                const g = {
                    ...
                    b = Object.keys(p).reduce((u, A) => ((u[A] = () => d(p[A])), u), {}),
                    h = { play: Object.assign({}, b, { sound: d }), setRTPC: v },
                ...
                function W(u = 'rem') {
                    ...
                    return 'rem' === u ? A : { x: J(A.x), y: J(A.y) };
                }
                function Q() {
                ...
                const Eu = (() => {
                    ...
                    Du = x,
                    Bu = Object.keys(S).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === S[A]), u), {}),
                    tu = {
                        set: (u, A) => {
                    ...
                    nu = { view: B, client: E, sound: h };
                var ru = F(363),
                    ou = F.n(ru);
                function au() {
                    const u = (0, ru.useRef)(0);
                    var A;
                    return (
                        (A = () => {
                ...
                const cu = ou().forwardRef(function (u, A) {
                    let F = u.children,
                        e = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        ou().createElement(
                            'div',
                            lu({}, B, {
                                className: C()(iu.base, iu[`base__theme-${D}`], e),
                                ref: function (u) {
                                    ((n.current = u), 'function' == typeof A ? A(u) : A && (A.current = u));
                                },
                            }),
                            ou().createElement('div', { className: iu.decorator }, F),
                        )
                    );
                });
                var du = F(533),
                ...
                function bu(u, A) {
                    ...
                    if (
                        ...
                        (F = (function (u, A) {
                            if (!u) return;
                            if ('string' == typeof u) return hu(u, A);
                        ...
                        return [
                            function ({ mode: e = 'real', options: E, children: D, mocks: B }) {
                                const t = (0, ru.useRef)([]),
                                    C = (F, e, E) => {
                                        ...
                                        const B = (function ({
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const t = 'string' == typeof D ? `${e}.${D}` : e,
                                                            C = nu.view.addModelObserver(t, A, !0);
                                            ...
                                            n = (u) =>
                                                'mocks' === F ? (null == E ? void 0 : E.getter(u)) : C.readByPath(u),
                                            ...
                                            a = { mode: F, model: o, externalModel: C, cleanup: r };
                                        return {
                                            model: o,
                                            controls: 'mocks' === F && E ? E.controls(a) : A(a),
                                            externalModel: C,
                                            mode: F,
                                        };
                                    },
                                ...
                                return (
                                    ...
                                    ou().createElement(F.Provider, { value: s }, D)
                                );
                            },
                            () => (0, ru.useContext)(F),
                        ];
                ...
                const zu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Mu = (u, A, F = Ou.left) => u.split(A).reduce(F === Ou.left ? ju : ku, []),
                    Nu = (() => {
                        const u = new RegExp(
                    ...
                    Vu = (u, A = Ou.left) => {
                        ...
                        return ((u, A = Ou.left) => {
                            ...
                            const e =
                                ...
                                E = zu(u);
                            return (Mu(E, /( )/, A).forEach((u) => (F = F.concat(Mu(u, e, Ou.left)))), F);
                        })(u, A);
                    },
                    Iu = (u, A, F) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : Vu(u, A))),
                    Gu = 'FormatText_base_d0',
                    $u = ({ binding: u, text: A = '', classMix: F, alignment: e = Ou.left, formatWithBrackets: E }) => {
                        if (null === A) return (console.error("FormatText was supplied with 'null'"), null);
                        const D = E && u ? Tu(A, u) : A;
                        return ou().createElement(
                            ...
                            D.split('\n').map((A, E) =>
                                ou().createElement(
                                    'div',
                                    { className: C()(Gu, F), key: `${A}-${E}` },
                                    Iu(A, e, u).map((u, A) => ou().createElement(ru.Fragment, { key: `${A}-${u}` }, u)),
                                ),
                            ),
                        );
                    },
                    Hu = { base: 'Content_base_bd', paragraph__indent: 'Content_paragraph__indent_06' },
                    Uu = (0, mu.Pi)(() => {
                        const u = _u().model.root.get().description;
                        return ou().createElement(
                            'div',
                            { className: Hu.base },
                            null == u
                                ...
                                : u
                                      ...
                                      .map((u, A) =>
                                          ou().createElement($u, {
                                              key: A,
                                              text: u,
                                              classMix: C()(Hu.paragraph, A > 0 && Hu.paragraph__indent),
                                          }),
                                      ),
                        );
                    });
                function qu(u, A) {
                    return Array.isArray(u) ? u.map(A) : u.map((u, F, e) => A(null == u ? void 0 : u.value, F, e));
                }
                const Wu = 'Footer_base_30',
                    Qu = 'Footer_valuesColumn_82',
                    Xu = 'Footer_textColumn_27',
                    Zu = 'Footer_row_ea',
                    Ju = 'Footer_statusRow_dc',
                    Ku = 'Footer_type_31',
                    Yu = (0, mu.Pi)(() => {
                        const u = _u().model,
                            A = u.details.get(),
                        ...
                        return ou().createElement(
                            'div',
                            { className: Wu },
                            qu(F, (u, A) => ou().createElement('div', { key: A, className: Ju }, u)),
                            qu(A, (u, A) =>
                                ou().createElement(
                                    'div',
                                    { className: Zu, key: A },
                                    ou().createElement(
                                        'div',
                                        { className: Qu },
                                        Number.isInteger(u.value) ? u.value : u.value.toFixed(2),
                                    ),
                                    ou().createElement(
                                        'div',
                                        { className: Xu },
                                        ou().createElement($u, {
                                            ...
                                            binding: {
                                                label: Iu(String(u.label), Ou.left),
                                                type:
                                                    u.valueType &&
                                                    ou().createElement('span', { className: Ku }, u.valueType),
                                            },
                                        }),
                                    ),
                                ),
                    ...
                    uA = 'Header_base_96',
                    AA = 'Header_icon_66',
                    FA = 'Header_description_bb',
                    eA = (0, mu.Pi)(() => {
                        const u = _u().model.root.get(),
                            A = u.title,
                            F = u.icon;
                        return ou().createElement(
                            'div',
                            { className: uA },
                            ou().createElement('div', { className: AA, style: { backgroundImage: `url(${F})` } }),
                            ou().createElement('div', { className: FA }, A),
                        );
                    }),
                    EA = (0, mu.Pi)(() => {
                        const u = _u().model,
                        ...
                        return ou().createElement(
                            'div',
                            { className: Pu },
                            ou().createElement(eA, null),
                            ou().createElement('div', { className: Ru }),
                            ou().createElement(Uu, null),
                            (A.length > 0 || F.length > 0) &&
                                ou().createElement(
                                    ou().Fragment,
                                    null,
                                    ou().createElement('div', { className: Ru }),
                                    ou().createElement(Yu, null),
                                ),
                        );
                    });
                engine.whenReady.then(() => {
                    vu().render(
                        ou().createElement(xu, null, ou().createElement(cu, null, ou().createElement(EA, null))),
