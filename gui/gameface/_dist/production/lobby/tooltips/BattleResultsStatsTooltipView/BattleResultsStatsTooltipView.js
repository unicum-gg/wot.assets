    ...
    var u,
        A = {
            438: (u, A, F) => {
                ...
                var D = {};
                F.r(D), F.d(D, { getBgUrl: () => y, getTextureUrl: () => h });
                var B = {};
                F.r(B),
                    F.d(B, {
                        addModelObserver: () => $,
                ...
                function U(u = 'rem') {
                    ...
                    return 'rem' === u ? A : { x: Z(A.x), y: Z(A.y) };
                }
                function q() {
                ...
                const Fu = (() => {
                    ...
                    eu = Object.keys(x).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === x[A]), u), {}),
                    Eu = {
                        set: (u, A) => {
                ...
                const au = Cu().forwardRef(function (u, A) {
                    let F = u.children,
                        e = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        Cu().createElement(
                            ...
                            Cu().createElement('div', { className: ru.decorator }, F),
                        )
                    );
                });
                var su = F(533),
                        ...
                        return [
                            function ({ mode: e = 'real', options: E, children: D, mocks: B }) {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const t = 'string' == typeof D ? `${e}.${D}` : e,
                                                            C = Bu.view.addModelObserver(t, A, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = fu(E.keys()); !(u = F()).done; ) D(u.value, A);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(e),
                                ...
                                return (
                                    ...
                                    Cu().createElement(F.Provider, { value: s }, D)
                                );
                            },
                            () => (0, tu.useContext)(F),
                        ];
                ...
                const Su = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    zu = (u, A, F = Pu.left) => u.split(A).reduce(F === Pu.left ? Tu : Ou, []),
                    ju = (() => {
                        const u = new RegExp(
                    ...
                    Mu = (u, A = Pu.left) => {
                        ...
                        return ((u, A = Pu.left) => {
                            ...
                            const e =
                                ...
                                E = Su(u);
                            return zu(E, /( )/, A).forEach((u) => (F = F.concat(zu(u, e, Pu.left)))), F;
                        })(u, A);
                    },
                    Nu = (u, A, F) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : Mu(u, A))),
                    Lu = 'FormatText_base_d0',
                    Vu = ({ binding: u, text: A = '', classMix: F, alignment: e = Pu.left, formatWithBrackets: E }) => {
                        if (null === A) return console.error("FormatText was supplied with 'null'"), null;
                        const D = E && u ? Ru(A, u) : A;
                        return Cu().createElement(
                            ...
                            D.split('\n').map((A, E) =>
                                Cu().createElement(
                                    'div',
                                    { className: C()(Lu, F), key: `${A}-${E}` },
                                    Nu(A, e, u).map((u, A) => Cu().createElement(tu.Fragment, { key: `${A}-${u}` }, u)),
                                ),
                            ),
                        );
                    },
                    $u = 'Content_base_bd',
                    Gu = (0, cu.Pi)(() => {
                        const u = hu().model.root.get().description;
                        return Cu().createElement(
                            'div',
                            { className: $u },
                            Cu().createElement(Vu, { text: String(u) }),
                        );
                    });
                function Iu(u, A) {
                    return Array.isArray(u) ? u.map(A) : u.map((u, F, e) => A(null == u ? void 0 : u.value, F, e));
                }
                const Hu = 'Footer_base_30',
                    Uu = 'Footer_valuesColumn_82',
                    qu = 'Footer_textColumn_27',
                    Wu = 'Footer_row_ea',
                    Qu = 'Footer_statusRow_dc',
                    Zu = 'Footer_type_31',
                    Ju = (0, cu.Pi)(() => {
                        const u = hu().model,
                            A = u.details.get(),
                        ...
                        return Cu().createElement(
                            'div',
                            { className: Hu },
                            Iu(F, (u, A) => Cu().createElement('div', { key: A, className: Qu }, u)),
                            Iu(A, (u, A) =>
                                Cu().createElement(
                                    'div',
                                    { className: Wu, key: A },
                                    ...
                                    Cu().createElement(
                                        ...
                                        Cu().createElement(Vu, {
                                            ...
                                            binding: {
                                                label: Nu(String(u.label), Pu.left),
                                                type:
                                                    u.valueType &&
                                                    Cu().createElement('span', { className: Zu }, u.valueType),
                                            },
                                        }),
                                    ),
                                ),
                    ...
                    uA = (0, cu.Pi)(() => {
                        ...
                        return Cu().createElement(
                            'div',
                            { className: Ku },
                            Cu().createElement('div', { className: Xu, style: { backgroundImage: `url(${F})` } }),
                            Cu().createElement('div', { className: Yu }, A),
                        );
                    }),
                    AA = (0, cu.Pi)(() => {
                        const u = hu().model,
                        ...
                        return Cu().createElement(
                            'div',
                            { className: yu },
                            Cu().createElement(uA, null),
                            Cu().createElement('div', { className: xu }),
                            Cu().createElement(Gu, null),
                            (A.length > 0 || F.length > 0) &&
                                Cu().createElement(
                                    Cu().Fragment,
                                    null,
                                    Cu().createElement('div', { className: xu }),
                                    Cu().createElement(Ju, null),
                                ),
                        );
                    });
                engine.whenReady.then(() => {
                    lu().render(
                        Cu().createElement(wu, null, Cu().createElement(au, null, Cu().createElement(AA, null))),
