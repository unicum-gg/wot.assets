    ...
    var __webpack_modules__ = {
            ...
            2121: (u, e, t) => {
                ...
                const x = (u, e, t) => {
                    switch (e) {
                        case g.SHORT_DATE:
                            return t ? p.Z5.getDateFormat(u, p.kH.SHORT_FORMAT) : p.cy.getTimeFormat('%d.%m.%y', u, !0);
                        case g.SHORT_TIME:
                            return t ? p.Z5.getTimeFormat(u, p.lf.SHORT_FORMAT) : p.cy.getTimeFormat('%I:%M %p', u, !0);
                        ...
                        case g.FULL_DATE:
                            return t ? p.Z5.getDateFormat(u, p.kH.LONG_FORMAT) : p.cy.getTimeFormat('%B %d, %Y', u, !0);
                ...
                const hu = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    bu = (0, s.observer)(() => {
                        ...
                        return E().createElement(
                            ...
                            E().createElement(ou, { text: vu.description(), className: 'Content_description_b1' }),
