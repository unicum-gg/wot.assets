(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, A) => {
                (A.r(e),
                    A.d(e, { mouse: () => o, off: () => r, on: () => n, onResize: () => t, onScaleUpdated: () => D }));
                var E = A(2472),
                    F = A(1176);
            ...
            3138: (u, e, A) => {
                ...
                var E = A(5959),
                    F = A(514);
                const t = { view: A(7641), client: E, sound: F.ZP };
            },
            514: (u, e, A) => {
                A.d(e, { ZP: () => D });
                var E = A(5959);
            ...
            1361: (u, e, A) => {
                ...
                const C = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    c = (u, e, A = i.left) => u.split(e).reduce(A === i.left ? a : s, []),
                    l = (() => {
                        const u = new RegExp(
                ...
                const v = _.Ew.getRegionalDateTime,
                    ...
                    h = (0, E.memo)(({ datetime: u, format: e = B.ShortDate, isConvertedToLocal: A = !0 }) =>
                        Object.values(B).includes(e) ? v(u, e, A) : m(u, e, A),
                    ),
                    p = ({ binding: u, text: e = '', classMix: A, alignment: t = i.left, formatWithBrackets: D }) => {
                        ...
                        return F().createElement(
                            ...
                            n.split('\n').map((e, D) =>
                                F().createElement(
                                    'div',
                                    { className: r()('FormatText_base_d0', A), key: `${e}-${D}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                            A && u in A
                                                ? A[u]
                ...
                const y = F().forwardRef(function (u, e) {
                    let A = u.children,
                        t = u.className,
                        D = u.theme,
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            g({}, B, {
                                className: r()(b.base, b[`base__theme-${n}`], t),
                                ref: function (u) {
                        ...
                        return [
                            function ({ mode: u = 'real', options: t, children: D, mocks: n }) {
                                const r = (0, E.useRef)([]),
                                    ...
                                    C = i[0],
                                    a = i[1],
                                    s = (0, E.useState)(() => B(u, t, n)),
                                    c = s[0],
                                    l = s[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        o.current ? l(B(C, t, n)) : (o.current = !0);
                                    }, [n, C, t]),
                                    (0, E.useEffect)(() => {
                                        a(u);
                                    }, [u]),
                                    ...
                                    F().createElement(A.Provider, { value: c }, D)
                                );
                            },
                            () => (0, E.useContext)(A),
                        ];
                                ...
                                F().createElement(p, {
                                    ...
                                    binding: {
                                        date: F().createElement(
                                            ...
                                            F().createElement(h, { datetime: e, format: B.ShortTime }),
                                        ),
                                    },
                                    classMix: r()('tooltips_subHeading_de', 'App_formattedText_df'),
                                }),
                                F().createElement('div', { className: 'tooltips_divider_81' }),
                                F().createElement(
                                    'div',
                                    { className: 'tooltips_description_f6' },
                                    F().createElement(p, { text: A }),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    D().render(F().createElement(S, null, F().createElement(N, null)), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/tooltips/LastUpdateTooltip/LastUpdateTooltip'),
        (() => {
            var u = { 'lobby/tooltips/LastUpdateTooltip/LastUpdateTooltip': 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, ['lib/comp7.vendors'], () => __webpack_require__(1361));
