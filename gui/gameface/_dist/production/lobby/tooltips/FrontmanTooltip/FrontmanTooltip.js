(() => {
    ...
    var __webpack_modules__ = {
            5067: (u, e, t) => {
                t.d(e, { O: () => W });
                var A = {};
                (t.r(A), t.d(A, { mouse: () => D, onResize: () => o }));
                var F = {};
                (t.r(F),
                    t.d(F, {
                        events: () => A,
                ...
                const V = Object.keys(l).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === l[e]), u), {}),
                    H = {
                        set: (u, e) => {
                    ...
                    f = {
                        ...
                        sendShowPopOverEvent: (u, e, t, A, F = R.invalid('resId'), E) => {
                            const n = _.O.view.getViewGlobalPosition(),
                                ...
                                s = r.height,
                                B = {
                                    x: _.O.view.pxToRem(o) + n.x,
                                    y: _.O.view.pxToRem(a) + n.y,
                    ...
                    return (
                        ((u) => {
                            ...
                            if (
                                                ...
                                                const e = C(),
                                                    ...
                                                    F =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: F, modelPath: l(F, ''), resId: A };
                                            })(),
                                            t = e.modelPrefix,
                                            A = u.split('.');
                                        if (A.length > 0) {
                                            ...
                                            return (
                                                A.reduce((e, A) => {
                                                    const F = _(l(t, `${e}.${A}`), window);
                                                    return c(F)
                                                        ? (u.push(F.id), `${e}.${A}.value`)
                                                        : (u.push(A), `${e}.${A}`);
                                                }),
                                                u.reduce((u, e) => u + '.' + e)
                                            );
                                ...
                                s.current = d.addCallback(A, t, r, e === v.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== v.None)
                                return () => {
                                    d.removeCallback(s.current, r);
                                };
                        }, [r, e]),
                        a
                    );
                ...
                const b = F().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            F().createElement(
                                'div',
                                h({}, o, {
                                    className: i()(w.base, w[`base__theme-${r}`], E),
                                    ref: function (u) {
                                        ((D.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                    },
                                }),
                                F().createElement('div', { className: w.decorator }, t),
                            )
                        );
                    }),
                    f = ({ title: u, icon: e, descr: t }) => {
                        const E =
                            ((n = R.strings.hb_tooltips.frontmanTooltip.abilityTitle()),
                            (r = { name: u }),
                            n.replace(/\{\w+\}/g, (u) => String(r[u.slice(1, -1)])));
                        var n, r;
                        const i = (0, A.useMemo)(
                            () => ({
                                backgroundImage: `url(${R.images.historical_battles.gui.maps.icons.artefact.$dyn(e)})`,
                            }),
                            [e],
                        );
                        return F().createElement(
                            'div',
                            { className: 'Ability_base_01' },
                            F().createElement('div', { className: 'Ability_divider_c5' }),
                            F().createElement(
                                'div',
                                { className: 'Ability_content_39' },
                                F().createElement('div', { className: 'Ability_title_4f' }, E),
                                F().createElement(
                                    'div',
                                    { className: 'Ability_descr_d1' },
                                    F().createElement('div', { className: 'Ability_icon_fa', style: i }),
                                    F().createElement('div', { className: 'Ability_text_c2' }, t),
                                ),
                            ),
                        );
                    },
                    g = () => {
                        const u = m('model', v.None),
                            ...
                            r = (0, A.useMemo)(
                                () => ({
                                    backgroundImage: `url(${R.images.historical_battles.gui.maps.icons.roles.par.c_16x16.$dyn(t)})`,
                                }),
                                [t],
                            ),
                            o = (0, A.useMemo)(
                                () => ({
                                    backgroundImage: `url(${R.images.historical_battles.gui.maps.icons.frontman.$dyn(`c_${e}_normal`)})`,
                                }),
                                [e],
                            ),
                            a = i()('FrontmanTooltipApp_base_8f', E && 'FrontmanTooltipApp_base__roleAbility_bc');
                        return F().createElement(
                            b,
                            null,
                            F().createElement(
                                ...
                                F().createElement(
                                    'div',
                                    { className: 'FrontmanTooltipApp_content_de' },
                                    F().createElement(
                                        'div',
                                        { className: 'FrontmanTooltipApp_header_6b' },
                                        F().createElement(
                                            'div',
                                            { className: 'FrontmanTooltipApp_title_04' },
                                            R.strings.hb_lobby.$dyn(`frontman_${e}`).name(),
                                        ),
                                        F().createElement(
                                            'div',
                                            { className: 'FrontmanTooltipApp_role_6d' },
                                            F().createElement('div', {
                                                className: 'FrontmanTooltipApp_roleIcon_f9',
                                                style: r,
                                            }),
                                            F().createElement(
                                                'span',
                                                { className: 'FrontmanTooltipApp_roleName_a7' },
                                                R.strings.hb_lobby.roleRegular.$dyn(t),
                                            ),
                                        ),
                                        F().createElement('div', { className: 'FrontmanTooltipApp_face_0a', style: o }),
                                        F().createElement('div', { className: 'FrontmanTooltipApp_line_b4' }),
                                    ),
                                    F().createElement(
                                        'div',
                                        { className: 'FrontmanTooltipApp_descr_76' },
                                        R.strings.hb_lobby.$dyn(`frontman_${e}`).descr(),
                                    ),
                                    E && F().createElement(f, n),
                                ),
                            ),
                        );
                    };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(873));
