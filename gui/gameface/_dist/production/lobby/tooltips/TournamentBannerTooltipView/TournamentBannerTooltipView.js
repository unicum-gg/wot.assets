(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, E) => {
                E.r(e),
                    E.d(e, { mouse: () => B, off: () => r, on: () => D, onResize: () => F, onScaleUpdated: () => n });
                var t = E(2472),
                    A = E(1176);
                const F = (0, t.E)('clientResized'),
                    n = (0, t.E)('self.onScaleUpdated'),
                    D = (u, e) => engine.on(u, e),
                    r = (u, e) => engine.off(u, e),
                    a = { down: (0, t.E)('mousedown'), up: (0, t.E)('mouseup'), move: (0, t.E)('mousemove') },
                    B = (function () {
            ...
            3138: (u, e, E) => {
                ...
                var t = E(5959),
                    A = E(514);
                const F = { view: E(7641), client: t, sound: A.ZP };
            },
            514: (u, e, E) => {
                E.d(e, { ZP: () => n });
                var t = E(5959);
                const A = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    F = Object.keys(A).reduce((u, e) => ((u[e] = () => (0, t.playSound)(A[e])), u), {}),
                    n = { play: Object.assign({}, F, { sound: t.playSound }), setRTPC: t.setRTPC };
            },
            3722: (u, e, E) => {
                function t(u, e, E = 1) {
                ...
                E.r(e), E.d(e, { getBgUrl: () => A, getTextureUrl: () => t });
            },
            6112: (u, e, E) => {
                E.d(e, { W: () => t });
            ...
            7641: (u, e, E) => {
                ...
                function B(u, e, E, t = 1) {
                    return viewEnv.getWebBrowserTexturePath(u, e, E, t);
                }
                function o(u, e, E) {
                        ...
                        if (void 0 !== e) {
                            ...
                            return void 0 !== F
                                ? viewEnv.handleViewEvent(
                                      Object.assign({ __Type: E, type: u }, n, {
                                          arguments:
                                              ((A = F),
                                ...
                                : viewEnv.handleViewEvent(Object.assign({ __Type: E, type: u }, n));
                        }
            ...
            1358: (u, e, E) => {
                ...
                class A {
                    ...
                    addCallback(u, e, E = 0, A = !0) {
                        ...
                        const F = t.O.view.addModelObserver(u, E, A);
                        return (
                            F > 0
                                ? ((this._callbacks[F] = e),
                                  E > 0 && (this._views[E] ? this._views[E].push(F) : (this._views[E] = [F])))
            ...
            9916: (u, e, E) => {
                ...
                class t {
                    ...
                    unregister(u, e) {
                        const E = u,
                            t = e;
                        (this.entries = this.entries.filter(({ container: u, callback: e }) => u !== E || e !== t)),
                ...
                function l(u, e, E, t, A, F, n) {
                    ...
                    D.done ? e(r) : Promise.resolve(r).then(t, A);
                }
                const d = (u) => ({ __Type: 'GFBoundingBox', x: u.x, y: u.y, width: u.width, height: u.height }),
                    ...
                    m = (u, e) => {
                        ...
                        if (void 0 !== e) {
                            ...
                            void 0 !== A
                                ? viewEnv.handleViewEvent(
                                      Object.assign({ __Type: E, type: u }, F, {
                                          arguments:
                                              ((t = A),
                                ...
                                : viewEnv.handleViewEvent(Object.assign({ __Type: E, type: u }, F));
                ...
                const w = A.instance,
                    f = {
                        ...
                        sendShowContextMenuEvent: (u, e, E = 0) => {
                            m(D.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: E, args: e });
                        },
                        sendShowPopOverEvent: (u, e, E, t, A = R.invalid('resId'), F) => {
                            const n = s.O.view.getViewGlobalPosition(),
                                ...
                                i = r.height,
                                C = {
                                    x: s.O.view.pxToRem(a) + n.x,
                                    y: s.O.view.pxToRem(B) + n.y,
                                    width: s.O.view.pxToRem(o),
                                    height: s.O.view.pxToRem(i),
                                };
                            m(D.POP_OVER, {
                                isMouseEvent: !0,
                                contentID: u,
                        ...
                        dumpViewModel: function u(e) {
                            ...
                            for (const t in e)
                                if (Object.prototype.hasOwnProperty.call(e, t)) {
                                    const A = Object.prototype.toString.call(e[t]);
                                    if (A.startsWith('[object CoherentArrayProxy]')) {
                                        const A = e[t];
                                        E[t] = [];
                                        for (let e = 0; e < A.length; e++) E[t].push({ value: u(A[e].value) });
                                    } else
            ...
            1008: (u, e, E) => {
                        ...
                        (B = Object.assign
                            ...
                            : function (u) {
                                  for (var e = 1; e < arguments.length; e++) {
                                      var E = arguments[e];
                                      for (var t in E) ({}).hasOwnProperty.call(E, t) && (u[t] = E[t]);
                                  }
                                  return u;
                              }),
                ...
                const o = D().forwardRef(function (u, e) {
                    let E = u.children,
                        t = u.className,
                        o = u.theme,
                    ...
                    return (
                        ...
                        D().createElement(
                            'div',
                            B({}, C, {
                                className: A()(r.base, r[`base__theme-${i}`], t),
                                ref: function (u) {
                                    (c.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            D().createElement('div', { className: r.decorator }, E),
                        )
                    );
                });
                var i = E(493),
                ...
                const d = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    v = (u, e, E = l.left) => u.split(e).reduce(E === l.left ? _ : m, []),
                    p = (() => {
                        const u = new RegExp(
                ...
                var w = E(8613);
                Date.now();
                const f = w.Ew.getRegionalDateTime,
                    b = w.Ew.getFormattedDateTime,
                    g = (0, n.memo)(({ datetime: u, format: e = s.ShortDate, isConvertedToLocal: E = !0 }) =>
                        Object.values(s).includes(e) ? f(u, e, E) : b(u, e, E),
                    ),
                    y = ({ binding: u, text: e = '', classMix: E, alignment: t = l.left, formatWithBrackets: F }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const r = F && u ? ((a = u), e.replace(/\{\w+\}/g, (u) => String(a[u.slice(1, -1)]))) : e;
                        var a;
                        return D().createElement(
                            ...
                            r.split('\n').map((e, F) =>
                                D().createElement(
                                    'div',
                                    { className: A()('FormatText_base_d0', E), key: `${e}-${F}` },
                                    ((u, e, E) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                            E && u in E
                                                ? E[u]
                ...
                let T;
                !(function (u) {
                    (u.BeforeTournament = 'beforeTournament'),
                        (u.ActiveTournament = 'activeTournament'),
                        (u.AfterTournament = 'afterTournament'),
                        (u.AnnouncementStream = 'announcementStream'),
                        (u.ActiveStream = 'activeStream');
                })(T || (T = {}));
                var O = E(3403);
                function x() {
                    return !1;
                ...
                function k(u, e) {
                    ...
                    for (var E = 0, t = Array(e); E < e; E++) t[E] = u[E];
                    return t;
                }
                const S = (u) => (0 === u ? window : window.subViews.get(u)),
                    M = ((u, e) => {
                        const E = (0, n.createContext)({});
                        return [
                            function ({ mode: u = 'real', options: t, children: A, mocks: r }) {
                                const a = (0, n.useRef)([]),
                                    B = (u, E, t) => {
                                        var A;
                                        const n = (function ({
                                                ...
                                                engine.whenReady.then(() => {
                                                    engine.on('viewEnv.onDataChanged', (u, e, E) => {
                                                        E.forEach((e) => {
                                                            const E = A.get(e);
                                                            void 0 !== E && E(u);
                                                        });
                                                ...
                                                return {
                                                    subscribe: (E, n) => {
                                                        const r = 'string' == typeof n ? `${t}.${n}` : t,
                                                            a = F.O.view.addModelObserver(r, e, !0);
                                                        return A.set(a, E), u && E(D(n)), a;
                                                    },
                                                    readByPath: D,
                                                    createCallback: (u, e) => {
                                                        const E = D(e);
                                            ...
                                            r = (e) =>
                                                'mocks' === u ? (null == t ? void 0 : t.getter(e)) : D.readByPath(e),
                                            B = (u) => a.current.push(u),
                                            o = (({ observableModel: u }) => ({ root: u.object() }))({
                                                ...
                                                observableModel: {
                                                    array: (e, E) => {
                                                        const t = null != E ? E : r(e),
                                                            A = P.LO.box(t, { equals: x });
                                                        return (
                                                            'real' === u &&
                                                                D.subscribe(
                                                                    (0, P.aD)((u) => A.set(u)),
                                            ...
                                            i = { mode: u, model: o, externalModel: D, cleanup: B };
                                        return {
                                            model: o,
                                    ...
                                    C = i[0],
                                    s = i[1],
                                    c = (0, n.useState)(() => B(u, t, r)),
                                    l = c[0],
                                    d = c[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        o.current ? d(B(C, t, r)) : (o.current = !0);
                                    }, [r, C, t]),
                                    (0, n.useEffect)(() => {
                                        s(u);
                                    }, [u]),
                                    ...
                                    D().createElement(E.Provider, { value: l }, A)
                                );
                            },
                            () => (0, n.useContext)(E),
                        ];
                    ...
                    W = 'App_subtitle_ac',
                    z = 'App_icon_f4',
                    G = R.strings.battle_royale_tournament,
                    K = (0, O.Pi)(() => {
                        const u = L().model.root.get(),
                            e = u.state,
                            E = u.dateEnd;
                        return D().createElement(
                            'div',
                            { className: 'App_base_aa' },
                            (() => {
                                switch (e) {
                                    case T.BeforeTournament:
                                        return D().createElement(
                                            'div',
                                            { className: U },
                                            D().createElement('div', { className: I }, G.tooltip.title()),
                                            D().createElement(
                                                'div',
                                                { className: V },
                                                D().createElement('span', { className: z }),
                                                D().createElement(
                                                    'span',
                                                    { className: j },
                                                    D().createElement(y, {
                                                        text: G.tooltip.start(),
                                                        binding: {
                                                            startDate: D().createElement(
                                                                'span',
                                                                { className: q },
                                                                D().createElement(g, {
                                                                    datetime: E,
                                                                    format: s.DayMonthFullTime,
                                                                }),
                                                            ),
                                                        },
                                                    }),
                                            ...
                                            D().createElement('div', { className: W }, G.tooltip.text()),
                                        );
                                    case T.ActiveTournament:
                                        return D().createElement(
                                            'div',
                                            { className: U },
                                            D().createElement('div', { className: I }, G.tooltip.title()),
                                            ...
                                            D().createElement('div', { className: W }, G.tooltip.description()),
                                        );
                                    case T.AfterTournament:
                                        return D().createElement(
                                            'div',
                                            { className: U },
                                            D().createElement('div', { className: I }, G.tooltip.over()),
                                            D().createElement('div', { className: W }, G.tooltip.link()),
                                        );
                                    case T.AnnouncementStream:
                                        return D().createElement(
                                            'div',
                                            { className: U },
                                            D().createElement('div', { className: I }, G.broadcast.title()),
                                            D().createElement(
                                                'div',
                                                { className: V },
                                                D().createElement('span', { className: z }),
                                            ...
                                            D().createElement('div', { className: W }, G.tooltip.broadcastText()),
                                        );
                                    case T.ActiveStream:
                                        return D().createElement(
                                            'div',
                                    ...
                                    default:
                                        return console.warn('Unknown TournamentBannerTooltip state'), null;
                                }
                            })(),
                        );
                    });
                engine.whenReady.then(() => {
                    C().render(
                        D().createElement(N, null, D().createElement(o, null, D().createElement(K, null))),
    ...
    (__webpack_require__.m = __webpack_modules__),
        (deferred = []),
        (__webpack_require__.O = (u, e, E, t) => {
            if (!e) {
                var A = 1 / 0;
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, E, t] = deferred[r], F = !0, n = 0; n < e.length; n++)
                        (!1 & t || A >= t) &&
            ...
            t = t || 0;
            for (var r = deferred.length; r > 0 && deferred[r - 1][2] > t; r--) deferred[r] = deferred[r - 1];
            deferred[r] = [e, E, t];
        }),
        ...
        (() => {
            ...
            var e = (e, E) => {
                    ...
                    if (F.some((e) => 0 !== u[e])) {
                        ...
                        if (D) var a = D(__webpack_require__);
                    }
                    for (e && e(E); r < F.length; r++)
                        (A = F[r]), __webpack_require__.o(u, A) && u[A] && u[A][0](), (u[A] = 0);
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1008));
