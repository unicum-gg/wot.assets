        ...
        e = {
            ...
            4827: (u, e, t) => {
                ...
                const Z = U().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        U().createElement(
                            'div',
                            Q({}, F, {
                                className: a()(Y.base, Y[`base__theme-${E}`], r),
                                ref: function (u) {
                ...
                const nu = $.client.getSize('rem'),
                    au = nu.width,
                    Du = nu.height,
                    iu = Object.assign({ width: au, height: Du }, Fu(au, Du, Au)),
                    ...
                    ou = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && D) return ru(e, t, g);
                            if (t.largeWidth && i) return ru(e, t, g);
                ...
                ((0, V.memo)(({ children: u }) => {
                    const e = (0, V.useContext)(Bu),
                        ...
                        r = t[0],
                        A = t[1],
                        E = (0, V.useCallback)((u, e) => {
                            const t = $.view.pxToRem(u),
                                r = $.view.pxToRem(e);
                            A(Object.assign({ width: t, height: r }, Fu(t, r, Au)));
                        }, []);
                    (((u) => {
                        ...
                        (0, V.useEffect)(() => () => engine.off('clientResized', E), [E]));
                    const F = (0, V.useMemo)(() => Object.assign({}, r), [r]);
                    return U().createElement(Bu.Provider, { value: F }, u);
                }),
                    (function (u) {
                ...
                const vu = {
                    ...
                    Su = _u((u) => {
                        let e = u.className,
                            ...
                            x =
                                void 0 === p
                                    ...
                                    : p,
                            v = u.alignItems,
                            b = void 0 === v ? (d ? 'flex-start' : g && 'center') || (h && 'flex-end') || void 0 : v,
                            w = u.alignSelf,
                            S = u.wrap,
                            L = u.flexWrap,
                            ...
                            T = u.shrink,
                            R = u.flex,
                            H = void 0 === R ? (M || T ? `${M ? 1 : 0} ${T ? 1 : 0} auto` : void 0) : R,
                            O = u.style,
                            P = u.children,
                            N = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const W = (0, V.useMemo)(() => {
                            ...
                            }, [t, r, F, D, B, o, O, H, w, c, y, x, b]),
                            G = W.computedStyle,
                            j = W.computedClassNames;
                        return U().createElement('div', xu({ className: a()(fu.base, ...j, e), style: G }, N), P);
                    });
                let Lu;
                !(function (u) {
                ...
                const yu = (u, e, t) => {
                    ...
                    Tu = (u, e, t = Lu.left) => u.split(e).reduce(t === Lu.left ? yu : Mu, []),
                    Ru = (() => {
                        const u = new RegExp(
                    ...
                    Ou = ({ binding: u, text: e = '', classMix: t, alignment: r = Lu.left }) =>
                        null === e
                                  ...
                                  e.split('\n').map((e, A) =>
                                      U().createElement(
                                          ...
                                          ((u, e, t) =>
                                              ...
                                              U().createElement(V.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              );
                ...
                const Xu = Object.keys(Nu()),
                    ...
                    Vu = _u((u) => {
                        ...
                        return U().createElement(
                            ...
                            ju(
                                {
                                    className: a()(Wu.base, t && Wu[t], h, r),
                                    style: g,
                                    mt: !0 === n ? Ku[t || 'paragraph-P16'].mt : n,
                                    mr: !0 === i ? Ku[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === l ? Ku[t || 'paragraph-P16'].mb : l,
                                    ml: !0 === C ? Ku[t || 'paragraph-P16'].ml : C,
                                },
                                c,
                            ),
                            void 0 !== s ? U().createElement(Ou, ju({}, s, { text: e })) : e,
                        );
                    }),
                        ...
                        (0, V.useEffect)(() => {
                            if (a && B.current) {
                                const u = () => {
                                    ...
                                    e = { changeTimeHandlers: [], changeKeyframeHandlers: [], changeTimeLoop: u() },
                                    t = (u) => (
                                    ...
                                    c = (u, e) => {
                                        ...
                                        return (
                                            ...
                                            () => {
                                                var t;
                                                return null == (t = B.current) ? void 0 : t.removeEventListener(u, e);
                                            }
                                        );
                                    },
                                    d = (u, e) => {
                ...
                const Ae = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: r, children: A, mocks: E }) {
                                const F = (0, V.useRef)([]),
                                    ...
                                    i = D[0],
                                    B = D[1],
                                    l = (0, V.useState)(() => n(u, r, E)),
                                    o = l[0],
                                    C = l[1];
                                return (
                                    (0, V.useEffect)(() => {
                                        a.current ? C(n(i, r, E)) : (a.current = !0);
                                    }, [E, i, r]),
                                    (0, V.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                    ...
                    Fe = Ee[0],
                    ne = Ee[1],
                    ae = 'App_abilityDuration_85',
                    De = 'App_subTitle_03',
                    ie = R.strings.portal_tooltips.ability,
                    Be = (0, Qu.observer)(() => {
                        const u = ne().model.root.get(),
                            e = u.name,
                            t = u.duration,
                            r = u.reload,
                            A = u.level,
                        ...
                        return U().createElement(
                            ...
                            U().createElement('div', { className: 'App_bg_13' }),
                            U().createElement(
                                'div',
                                { className: 'App_info_00' },
                                U().createElement(Vu, { text: ie.name.$dyn(e), className: 'App_name_92' }),
                                t > 0 &&
                                    U().createElement(Vu, {
                                        text: ie.duration(),
                                        className: ae,
                                        format: {
                                            binding: {
                                                duration: U().createElement(Vu, {
                                                    text: String(t),
                                                    className: 'App_duration_f9',
                                                }),
                                            },
                                        },
                                    }),
                                ...
                                A > 0 &&
                                    ...
                                    U().createElement(Vu, {
                                        className: De,
                                        text: R.strings.portal_tooltips.modules.nextLevel(),
                                        format: {
                                            binding: {
                                                nextLevel: U().createElement(Vu, {
                                                    className: a()(De, 'App_subTitle__highlited_bf'),
                                                    text: qu(A),
                                                }),
                                            },
                                        },
                            ...
                            U().createElement(ue, {
                                className: 'App_video_49',
                                src: R.videos.portal.abilities.$dyn(e),
                                autoplay: !0,
                                loop: !0,
                            }),
                            U().createElement(
                                'div',
                                { className: 'App_description_f3' },
                                U().createElement('div', { className: 'App_descriptionBg_d2' }),
                                U().createElement(Vu, { text: ie.whenUse(), className: 'App_descriptionTitle_fb' }),
                                U().createElement(Vu, {
                                    className: 'App_descriptionSubTitle_c1',
                                    text: ie.description.$dyn(e),
                                }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    uu().render(
                        U().createElement(Fe, null, U().createElement(Z, null, U().createElement(Be, null))),
