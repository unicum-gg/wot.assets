    ...
    var u,
        e = {
            ...
            9980: (u, e, t) => {
                ...
                var F = {};
                (t.r(F), t.d(F, { getBgUrl: () => c, getTextureUrl: () => d }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        addModelObserver: () => w,
                ...
                const Du = V.client.getSize('rem'),
                    ...
                    lu = (u) => {
                        ...
                        const A = (0, U.useContext)(iu),
                            ...
                            _ = { extraLarge: o, large: m, medium: s, small: d, extraSmall: c };
                ...
                const du = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    _u = [ou.ExtraLarge, ou.Large, ou.Medium, ou.Small, ou.ExtraSmall],
                    gu = (u, e) =>
                ...
                const vu = {
                    ...
                    Su = hu((u) => {
                        ...
                        const N = (0, U.useMemo)(() => {
                            ...
                            }, [t, A, r, n, i, l, O, H, w, d, y, f, b]),
                            j = N.computedStyle,
                            G = N.computedClassNames;
                        return K().createElement('div', fu({ className: a()(xu.base, ...G, e), style: j }, W), P);
                    });
                let Lu;
                !(function (u) {
                ...
                const Xu = Object.keys(Wu()),
                    ...
                    Uu = hu((u) => {
                        ...
                        return K().createElement(
                            ...
                            Gu(
                                {
                                    className: a()(Nu.base, t && Nu[t], g, A),
                                    style: _,
                                    mt: !0 === D ? $u[t || 'paragraph-P16'].mt : D,
                                    mr: !0 === B ? $u[t || 'paragraph-P16'].mr : B,
                                    mb: !0 === C ? $u[t || 'paragraph-P16'].mb : C,
                                    ml: !0 === o ? $u[t || 'paragraph-P16'].ml : o,
                                },
                                d,
                            ),
                            void 0 !== s ? K().createElement(Ou, Gu({}, s, { text: e })) : e,
                        );
                    });
                var Ku = t(3403);
                function Yu() {
                ...
                const ee = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: A, children: E, mocks: F }) {
                                ...
                                return (
                                    ...
                                    K().createElement(t.Provider, { value: l }, E)
                                );
                            },
                            () => (0, U.useContext)(t),
                        ];
                    ...
                    Fe = R.strings.mt_birthday.birthdayPEBtooltip,
                    re = ['credits', 'xp_tank', 'crew_exp', 'free_xp'],
                    De = (0, Ku.Pi)(() => {
                        ...
                        return K().createElement(
                            'div',
                            { className: Ee.base },
                            K().createElement(Uu, { text: Fe.header(), className: Ee.header }),
                            K().createElement(Uu, {
                                text: Fe.description(),
                                className: Ee.description,
                                format: {
                                    binding: {
                                        bonusText: K().createElement(Uu, {
                                            text: Fe.bonusText(),
                                            className: Ee.bonus,
                            ...
                            K().createElement(
                                'div',
                                { className: Ee.resourcesList },
                                re.map((u) =>
                                    K().createElement(Uu, {
                                        key: u,
                                        className: a()(Ee.resource, Ee[`resource__${u}`]),
                                        text: Fe.$dyn(u),
                                    }),
                                ),
                            ),
                            K().createElement('div', { className: Ee.divider }),
                            K().createElement(Uu, { text: Fe.subheader(), className: Ee.subHeader }),
                            K().createElement(
                                'div',
                                { className: Ee.modesList },
                                t.map((u) =>
                                    K().createElement(Uu, {
                                        key: u,
                                        className: Ee.mode,
                                        ...
                                        text: R.strings.menu.bonusType.$dyn(`c_${u}`),
                                    }),
                                ),
                            ),
                            K().createElement('div', { className: Ee.divider }),
                            K().createElement(Uu, { text: Fe.addition(), className: Ee.addition }),
                        );
                    });
                engine.whenReady.then(() => {
                    uu().render(
                        K().createElement(te, null, K().createElement(Z, null, K().createElement(De, null))),
