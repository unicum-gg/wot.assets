(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, A) => {
                A.r(e),
                    A.d(e, { mouse: () => C, off: () => r, on: () => n, onResize: () => t, onScaleUpdated: () => D });
                var E = A(472),
                    F = A(176);
            ...
            138: (u, e, A) => {
                ...
                var E = A(959),
                    F = A(514);
                const t = { view: A(641), client: E, sound: F.ZP };
            },
            514: (u, e, A) => {
                A.d(e, { ZP: () => D });
                var E = A(959);
                const F = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    t = Object.keys(F).reduce((u, e) => ((u[e] = () => (0, E.playSound)(F[e])), u), {}),
            ...
            851: (u, e, A) => {
                ...
                const d = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    m = (u, e, A = l.left) => u.split(e).reduce(A === l.left ? _ : v, []),
                    p = (() => {
                        const u = new RegExp(
                    ...
                    h = ['zh_cn', 'zh_sg', 'zh_tw'],
                    w = ({ binding: u, text: e = '', classMix: A, alignment: t = l.left, formatWithBrackets: D }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const n = D && u ? ((r = u), e.replace(/\{\w+\}/g, (u) => String(r[u.slice(1, -1)]))) : e;
                        var r;
                        return F().createElement(
                            ...
                            n.split('\n').map((e, D) =>
                                F().createElement(
                                    'div',
                                    { className: B()('FormatText_base_d0', A), key: `${e}-${D}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                            A && u in A
                                                ? A[u]
                ...
                A(916);
                var f = A(613);
                Date.now(), f.Ew.getRegionalDateTime;
                const g = f.Ew.getFormattedDateTime;
                function b() {
                    return !1;
                }
                console.log;
                ...
                const T = (u) => (0 === u ? window : window.subViews.get(u)),
                    P = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: t, children: D, mocks: n }) {
                                const r = (0, E.useRef)([]),
                                    B = (u, A, E) => {
                                        var F;
                                        const t = (function ({
                                                ...
                                                return {
                                                    subscribe: (A, t) => {
                                                        const n = 'string' == typeof t ? `${E}.${t}` : E,
                                                            r = C.O.view.addModelObserver(n, e, !0);
                                            ...
                                            o = (({ observableModel: u }) => ({ chapters: u.object('chapters') }))({
                                                mode: u,
                                                readByPath: n,
                                                externalModel: D,
                                                observableModel: {
                                                    array: (e, A) => {
                                                        const E = null != A ? A : n(e),
                                                            F = y.LO.box(E, { equals: b });
                                                        return (
                                                            'real' === u &&
                                                                D.subscribe(
                                                                    (0, y.aD)((u) => F.set(u)),
                                    ...
                                    a = i[0],
                                    s = i[1],
                                    c = (0, E.useState)(() => B(u, t, n)),
                                    l = c[0],
                                    d = c[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        o.current ? d(B(a, t, n)) : (o.current = !0);
                                    }, [n, a, t]),
                                    (0, E.useEffect)(() => {
                                        s(u);
                                    }, [u]),
                                    ...
                                    F().createElement(A.Provider, { value: l }, D)
                                );
                            },
                            () => (0, E.useContext)(A),
                        ];
                    ...
                    x = P[0],
                    k = P[1],
                    M = R.strings.grinch_progression.chapterHeaderTooltip,
                    S = R.strings.datetime_formats.regionalDate.dayMonthFullTime(),
                    L = (0, n.Pi)(() => {
                        const u = k().model.chapters.get();
                        return F().createElement(
                            s,
                            null,
                            F().createElement(
                                ...
                                F().createElement('div', { className: 'App_title_d2' }, M.title()),
                                u.map(({ value: { startDate: u, endDate: e } }, A) =>
                                    F().createElement(
                                        'div',
                                        { className: 'App_chapter_14', key: A },
                                        F().createElement(
                                            'div',
                                            { className: 'App_subtitle_c3' },
                                            M.subtitle.$num(A + 1),
                                        ),
                                        F().createElement(w, {
                                            text: M.dates(),
                                            binding: { start: g(u, S), end: g(e, S) },
                                            classMix: 'App_dates_0e',
                                        }),
                                    ),
                                ),
                                F().createElement('div', { className: 'App_description_fe' }, M.description()),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    D().render(F().createElement(x, null, F().createElement(L, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(851));
