(() => {
    ...
    var u,
        A = {
            4392: (u, A, F) => {
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => _, getTextureUrl: () => x }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => L,
                ...
                const ru = Bu().forwardRef(function (u, A) {
                    ...
                    return (
                        ...
                        Bu().createElement(
                            'div',
                            nu({}, B, {
                                className: t()(Cu.base, Cu[`base__theme-${D}`], E),
                                ref: function (u) {
                                    ((n.current = u), 'function' == typeof A ? A(u) : A && (A.current = u));
                                },
                            }),
                            Bu().createElement('div', { className: Cu.decorator }, F),
                        )
                    );
                });
                var ou = F(1533),
                ...
                const lu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    vu = (u, A, F = su.left) => u.split(A).reduce(F === su.left ? cu : du, []),
                    mu = (() => {
                        const u = new RegExp(
                    ...
                    pu = ({ binding: u, text: A = '', classMix: F, alignment: E = su.left, formatWithBrackets: e }) => {
                ...
                const yu = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    Tu = 'App_subtitle_3e',
                    Pu = 'App_paragraph_96',
                    Ou = R.strings.comp7_ext.style3dTooltip,
                    ...
                    ju = (0, gu.Pi)(() => {
                        ...
                        return Bu().createElement(
                            'div',
                            { className: 'App_base_58' },
                            Bu().createElement(
                                'div',
                                { className: Su },
                                Bu().createElement(pu, { text: String(Ou.$num(A)), classMix: 'App_title_d0' }),
                            ),
                            Bu().createElement('div', {
                                className: 'App_image_9f',
                                style: { backgroundImage: `url(${zu.$dyn(`style3d_${A}`)})` },
                            }),
                            Bu().createElement(
                                'div',
                                { className: Su },
                                Bu().createElement('div', { className: Pu }, Ou.description()),
                                Bu().createElement(
                                    'div',
                                    { className: t()(Tu, 'App_howToReceive_66') },
                                    Ou.howToReceive(),
                                ),
                                Bu().createElement('div', { className: Pu }, Ou.secondaryDescription.$num(A)),
                            ),
                            Bu().createElement(
                                'div',
                                { className: t()(Su, 'App_section__bg_dc', 'App_section__bottom_7e') },
                                Bu().createElement('div', {
                                    className: t()('tooltips_divider_81', 'App_divider_54', 'App_divider__top_90'),
                                }),
                                Bu().createElement('div', { className: Tu }, Ou.suitableVehicles()),
                                Bu().createElement('div', { className: 'App_text_06' }, F),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    iu().render(
                        Bu().createElement(_u, null, Bu().createElement(ru, null, Bu().createElement(ju, null))),
    ...
    ((E.m = A),
        ...
        (E.j = 'lobby/tooltips/Style3dTooltip/Style3dTooltip'),
        (() => {
            var u = { 'lobby/tooltips/Style3dTooltip/Style3dTooltip': 0 };
            E.O.j = (A) => 0 === u[A];
            var A = (A, F) => {
                    var e,
                        D,
    ...
    var e = E.O(void 0, ['lib/comp7.vendors'], () => E(4392));
    e = E.O(e);
})();
