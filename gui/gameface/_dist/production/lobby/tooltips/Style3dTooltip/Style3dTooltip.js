        ...
        A = {
            9138: (u, A, F) => {
                ...
                function V(u = 'rem') {
                    ...
                    return 'rem' === u ? A : { x: U(A.x), y: U(A.y) };
                }
                function G() {
                ...
                const X = (() => {
                    ...
                    Y = Object.keys(x).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === x[A]), u), {}),
                    uu = {
                        set: (u, A) => {
                ...
                const tu = eu().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        eu().createElement(
                            'div',
                            Cu({}, B, {
                                className: t()(Du.base, Du[`base__theme-${D}`], E),
                                ref: function (u) {
                                    ((n.current = u), 'function' == typeof A ? A(u) : A && (A.current = u));
                                },
                            }),
                            eu().createElement('div', { className: Du.decorator }, F),
                        )
                    );
                });
                var nu = F(1533),
                ...
                const au = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    mu = ({ binding: u, text: A = '', classMix: F, alignment: E = iu.left, formatWithBrackets: e }) => {
                            ...
                            D.split('\n').map((A, e) =>
                                eu().createElement(
                                    ...
                                    ((u, A, F) =>
                                        ...
                                        eu().createElement(Eu.Fragment, { key: `${A}-${u}` }, u),
                                    ),
                                ),
                            ),
                        );
                ...
                const wu = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: e, mocks: D }) {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            t = Fu.view.addModelObserver(C, A, !0);
                                ...
                                return (
                                    ...
                                    eu().createElement(F.Provider, { value: a }, e)
                                );
                            },
                            () => (0, Eu.useContext)(F),
                        ];
                    ...
                    Pu = 'App_subtitle_3e',
                    Ru = 'App_paragraph_96',
                    Su = R.strings.comp7_ext.style3dTooltip,
                    Tu = R.images.comp7.gui.maps.icons.rewards,
                    Ou = (0, fu.Pi)(() => {
                        ...
                        return eu().createElement(
                            ...
                            eu().createElement(
                                'div',
                                { className: _u },
                                eu().createElement(mu, { text: String(Su.$num(A)), classMix: 'App_title_d0' }),
                            ),
                            eu().createElement('div', {
                                className: 'App_image_9f',
                                style: { backgroundImage: `url(${Tu.$dyn(`style3d_${A}`)})` },
                            }),
                            eu().createElement(
                                'div',
                                { className: _u },
                                eu().createElement('div', { className: Ru }, Su.description()),
                                eu().createElement(
                                    'div',
                                    { className: t()(Pu, 'App_howToReceive_66') },
                                    Su.howToReceive(),
                                ),
                                eu().createElement('div', { className: Ru }, Su.secondaryDescription.$num(A)),
                            ),
                            eu().createElement(
                                'div',
                                { className: t()(_u, 'App_section__bg_dc', 'App_section__bottom_7e') },
                                eu().createElement('div', {
                                    className: t()('tooltips_divider_81', 'App_divider_54', 'App_divider__top_90'),
                                }),
                                eu().createElement('div', { className: Pu }, Su.suitableVehicles()),
                                eu().createElement('div', { className: 'App_text_06' }, F),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    ru().render(
                        eu().createElement(yu, null, eu().createElement(tu, null, eu().createElement(Ou, null))),
