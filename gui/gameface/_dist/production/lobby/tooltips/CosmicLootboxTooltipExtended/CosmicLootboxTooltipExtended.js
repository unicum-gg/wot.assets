    ...
    var __webpack_modules__ = {
            ...
            1179: (u, e, t) => {
                        ...
                        const w = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, r.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (C(t, c, { isMouseEvent: !0, on: !0, arguments: d(a) }, x),
                                    h && h(),
                            ...
                            w(
                                {
                                    contentId:
                                        ...
                                        A ? x.SimpleTooltipHtmlContent('resId') : x.SimpleTooltipContent('resId')),
                ...
                const T = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return a().createElement(f, e, r);
                    const n = e.contentId,
                        i = e.args,
                        s = null == i ? void 0 : i.contentId;
                    return n || s
                        ? a().createElement(g, S({}, e, { contentId: n || s }), r)
                        : a().createElement(b, e, r);
                };
                ...
                const O = [
                    ...
                    y = [s.Gold, s.Credits, s.Crystal, s.FreeXp],
                    M = [s.BattlePassPoints],
                    L = [s.PremiumPlus, s.Premium];
                let N;
                !(function (u) {
                    ((u.s16 = '16'),
                        (u.s32 = '32'),
                ...
                const k = ['engravings', 'backgrounds'],
                    ...
                    G = ({
                        ...
                        const C = ((u) => {
                            ...
                            p = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case l.CURRENCY:
                                    case l.NUMBER:
                                        return a().createElement(P, { format: 'integral', value: Number(u) });
                                    case l.PREMIUM_PLUS: {
                                        const e = Number(u);
                        ...
                        return a().createElement(
                            'div',
                            { className: _()(H.base, H[`base__${r}`], c), style: o },
                            a().createElement(
                                T,
                                { tooltipArgs: B, className: H.tooltipWrapper },
                                a().createElement(
                                    a().Fragment,
                                    null,
                                    a().createElement(
                                        'div',
                                        { className: _()(H.image, null == m ? void 0 : m.image) },
                                        C &&
                                            a().createElement('div', {
                                                className: _()(H.highlight, null == m ? void 0 : m.highlight),
                                                style: {
                                        ...
                                        e &&
                                            a().createElement('div', {
                                                className: _()(H.icon, null == m ? void 0 : m.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        g &&
                                            a().createElement('div', {
                                                className: _()(H.overlay, null == m ? void 0 : m.overlay),
                                                style: {
                            ...
                            t &&
                                a().createElement(
                                    ...
                                    { tooltipArgs: d },
                                    a().createElement('div', {
                                        className: _()(H.timer, null == m ? void 0 : m.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const z = q.O.client.getSize('rem'),
                    ...
                    eu = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && l) return j(e, t, g);
                            if (t.largeWidth && A) return j(e, t, g);
                            if (t.mediumWidth && F) return j(e, t, g);
                            if (t.smallWidth && D) return j(e, t, g);
                            if (t.extraSmallWidth && c) return j(e, t, g);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                ((0, r.memo)(({ children: u }) => {
                    ...
                    return a().createElement(J.Provider, { value: o }, u);
                }),
                    (function (u) {
                ...
                const nu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    iu = (u) => u.includes('_') && ((u) => nu.includes(u))(u.split('_').at(-1)),
                    su = [tu.ExtraLarge, tu.Large, tu.Medium, tu.Small, tu.ExtraSmall],
                    ou = (u, e) =>
                        Object.keys(u).reduce((t, r) => {
                            ...
                            return (
                                void 0 === a ||
                                    ((u, e) => nu.some((t) => void 0 !== e[`${u}_${t}`]))(r, u) ||
                                    (t[r] = a),
                                t
                            );
                        }, {}),
                ...
                const Du = {
                    ...
                    mu = Eu((u) => {
                        let e = u.className,
                            ...
                            B = u.row,
                            d = u.flexDirection,
                            C = void 0 === d ? (m ? 'column' : B && 'row') || void 0 : d,
                            g = u.flexStart,
                            p = u.center,
                            h = u.flexEnd,
                            b = u.spaceBetween,
                        ...
                        const H = (0, r.useMemo)(() => {
                                const u = { mt: o, mr: l, mb: F, ml: c },
                                    ...
                                    r = ((u) =>
                                        cu.reduce((e, t) => {
                                            const r = u[t];
                                            return ('number' == typeof r && (e[_u[t]] = r + 'rem'), e);
                                        }, {}))(u);
                                return {
                        ...
                        return a().createElement('div', Fu({ className: _()(lu.base, ...W, e), style: G }, U), I);
                    });
                let Bu;
                !(function (u) {
                ...
                const du = (u, e, t) => {
                    ...
                    gu = (u, e, t = Bu.left) => u.split(e).reduce(t === Bu.left ? du : Cu, []),
                    pu = (() => {
                        const u = new RegExp(
                    ...
                    bu = ({ binding: u, text: e = '', classMix: t, alignment: n = Bu.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, i) =>
                                      a().createElement(
                                          'div',
                                          { className: _()('FormatText_base_d0', t), key: `${e}-${i}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                ...
                const Tu = Object.keys(wu()),
                    ...
                    Lu = Eu((u) => {
                        ...
                        return a().createElement(
                            ...
                            Su(
                                {
                                    className: _()(xu.base, t && xu[t], h, n),
                                    style: p,
                                    mt: !0 === E ? yu[t || 'paragraph-P16'].mt : E,
                                    mr: !0 === A ? yu[t || 'paragraph-P16'].mr : A,
                                    mb: !0 === D ? yu[t || 'paragraph-P16'].mb : D,
                                    ml: !0 === m ? yu[t || 'paragraph-P16'].ml : m,
                                },
                                C,
                            ),
                            void 0 !== d ? a().createElement(bu, Su({}, d, { text: e })) : e,
                        );
                    });
                var Nu = t(3282);
                function ku() {
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : s(e),
                                                            a = Iu.observable.box(r, { equals: ku });
                                                        return (
                                                            'real' === u &&
                                                                i.subscribe(
                ...
                const zu = R.strings.cosmicEvent.cosmicLootboxTooltipExtended,
                    Ku = (0, Nu.observer)(() => {
                        ...
                        return a().createElement(
                            'div',
                            { className: Yu.base },
                            a().createElement(Lu, { text: R.strings.lootboxes.userName.$dyn(t), className: Yu.title }),
                            a().createElement(Lu, { text: zu.slotTitle(), className: Yu.slotTitle }),
                            e.map(({ description: u, bonuses: t, probability: r, vehicleNames: n, slotType: i }, s) => {
                                ...
                                return a().createElement(
                                    'div',
                                    { className: Yu.slotWrapper, key: s },
                                    c && a().createElement('div', { className: Yu.separator }),
                                    a().createElement(
                                        'div',
                                        { key: s, className: Yu.row },
                                        a().createElement(
                                            'div',
                                            { className: Yu.probabilityTitleWrapper },
                                            a().createElement(Lu, { text: u, className: Yu.probabilityTitle }),
                                            a().createElement(Lu, {
                                                text: zu.percentage(),
                                                format: { binding: { percent: r } },
                                                className: Yu.probabilityValue,
                                            }),
                                        ),
                                        Boolean(n.length) &&
                                            a().createElement(
                                                'div',
                                                { className: Yu.specialSlotWrapper },
                                                a().createElement('div', { className: Yu.vehicleImg }),
                                                a().createElement('div', { className: Yu.glow }),
                                                a().createElement(Lu, {
                                                    text: n.join(', '),
                                                    className: Yu.vehicleNames,
                                                }),
                                            ),
                                        a().createElement(
                                            'div',
                                            { className: _()(Yu.rewardsWrapper, D && Yu.lastElementWrapper) },
                                            A.map((u, e) => {
                                                const t = e === A.length - 1;
                                                return a().createElement(
                                                    'div',
                                                    { className: Yu.rewardItemWrapper, key: e },
                                                    t && !D && a().createElement('div', { className: Yu.rewardGlow }),
                                                    a().createElement(
                                                        G,
                                                        Vu({ size: E.Small, className: Yu.reward }, u),
                                                    ),
                                                );
                                            }),
                                            i === $u.LootBox &&
                ...
                const ue = a().forwardRef(function (u, e) {
                    let t = u.children,
                        n = u.className,
                        i = u.theme,
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            Ju({}, o, {
                                className: _()(Qu.base, Qu[`base__theme-${s}`], n),
                                ref: function (u) {
                                    ((l.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            a().createElement('div', { className: Qu.decorator }, t),
                        )
                    );
                });
                engine.whenReady.then(() => {
                    i().render(
                        a().createElement(ju, null, a().createElement(ue, null, a().createElement(Ku, null))),
