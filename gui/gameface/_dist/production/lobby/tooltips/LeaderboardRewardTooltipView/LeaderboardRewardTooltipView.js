(() => {
    ...
    var u,
        A = {
            9480: (u, A, F) => {
                function e(u, A) {
                    var F;
                    if (!(A >= u.length)) return Array.isArray(u) ? u[A] : null == (F = u[A]) ? void 0 : F.value;
                }
                function E(u, A) {
            ...
            5912: (u, A, F) => {
                var e = {};
                F.r(e),
                    F.d(e, { mouse: () => T, off: () => x, on: () => h, onResize: () => w, onScaleUpdated: () => y });
                var E = {};
                F.r(E),
                    F.d(E, {
                        events: () => e,
                ...
                const au = (() => {
                    ...
                    su = Object.keys(U).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === U[A]), u), {}),
                    lu = {
                        set: (u, A) => {
                ...
                const Pu = ((u, A) => {
                            ...
                            function ({ mode: u = 'real', options: A, children: e, mocks: E }) {
                                const D = (0, t.useRef)([]),
                                    B = (u, A, F) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            n = (({ observableModel: u }) => {
                                                const A = {
                                                    ...
                                                    F = (0, Ru.Om)(
                                                        (u) => {
                                                            const F = Tu.U2(A.battleTypes.get(), u);
                                        ...
                                        return {
                                            model: n,
                                            controls: 'mocks' === u && F ? F.controls(r) : wu,
                                            externalModel: B,
                                            mode: u,
                                        };
                                    },
                    ...
                    Ou = Pu[0],
                    Su = Pu[1],
                    zu = R.strings.battle_royale.tooltip.progression.leaderboardReward,
                    Mu = (0, pu.Pi)(() => {
                        const u = Su().model;
                        return C().createElement(
                            gu,
                            ...
                            C().createElement(
                                ...
                                C().createElement(
                                    ...
                                    C().createElement(g, { text: zu.header(), classMix: 'App_text_82' }),
                                ),
                                C().createElement(bu.i, {
                ...
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(Ou, null, C().createElement(Mu, null)),
                ...
                const C = 'Column_separator_99',
                    n = ({ battleType: u, mode: A, isNotFirstColumn: F }) =>
                        t().createElement(
                            ...
                            t().createElement('div', { className: C }),
                                    ...
                                    t().createElement(
                                        ...
                                        F
                                            ? t().createElement(
                                                  ...
                                                  t().createElement('div', { className: 'Column_point_1b' }, F),
    ...
    (e.m = A),
        ...
        (e.j = 'lobby/tooltips/LeaderboardRewardTooltipView/LeaderboardRewardTooltipView'),
        (() => {
            var u = {
    ...
    var E = e.O(void 0, ['lib/battle_royale.vendors'], () => e(5912));
    E = e.O(E);
})();
