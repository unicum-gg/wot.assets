        ...
        A = {
            ...
            7296: (u, A, F) => {
                ...
                const ou = (() => {
                    ...
                    au = Object.keys(I).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === I[A]), u), {}),
                    iu = {
                        set: (u, A) => {
                            ...
                            function ({ mode: u = 'real', options: A, children: e, mocks: E }) {
                                const D = (0, t.useRef)([]),
                                    B = (u, A, F) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            n = (({ observableModel: u }) => {
                                                const A = {
                                                    ...
                                                    F = (0, _u.Om)(
                                                        (u) => {
                                                            const F = xu.U2(A.battleTypes.get(), u);
                                        ...
                                        return {
                                            model: n,
                                            controls: 'mocks' === u && F ? F.controls(r) : pu,
                                            externalModel: B,
                                            mode: u,
                                        };
                                    },
