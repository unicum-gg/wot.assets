(() => {
    ...
    var u,
        e = {
            ...
            7676: (u, e, A) => {
                ...
                var D = {};
                (A.r(D), A.d(D, { getBgUrl: () => U, getTextureUrl: () => $ }));
                var B = {};
                (A.r(B),
                    A.d(B, {
                        addModelObserver: () => K,
                ...
                const l = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    m = (u, e, A = s.left) => u.split(e).reduce(A === s.left ? c : d, []),
                    v = (() => {
                        const u = new RegExp(
                            [
                    ...
                    p = ['zh_cn', 'zh_sg', 'zh_tw'],
                    f = ({ binding: u, text: e = '', classMix: A, alignment: F = s.left, formatWithBrackets: E }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const D = E && u ? ((B = u), e.replace(/\{\w+\}/g, (u) => String(B[u.slice(1, -1)]))) : e;
                        var B;
                        return n().createElement(
                            ...
                            D.split('\n').map((e, E) =>
                                n().createElement(
                                    'div',
                                    { className: a()('FormatText_base_d0', A), key: `${e}-${E}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                            A && u in A
                                                ? A[u]
                ...
                const w = g('clientResized'),
                    y = g('self.onScaleUpdated'),
                    h = (u, e) => engine.on(u, e),
                    x = (u, e) => engine.off(u, e),
                ...
                const z = {
                    ...
                    k = Object.keys(j).reduce((u, e) => ((u[e] = () => P(j[e])), u), {}),
                    N = { play: Object.assign({}, k, { sound: P }), setRTPC: O },
                ...
                const fu = { view: B, client: E, sound: N, intl: L };
                const gu = {
                ...
                const yu = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            wu({}, B, {
                                className: a()(gu.base, gu[`base__theme-${D}`], F),
                                ref: function (u) {
                                    ((r.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            n().createElement('div', { className: gu.decorator }, A),
                        )
                    );
                });
                var hu = A(3403),
                ...
                const zu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: e, children: F, mocks: E }) {
                                const D = (0, t.useRef)([]),
                                    B = (u, e, A) => {
                                        var F;
                                        const E = (function ({
                                            ...
                                            C = (({ observableModel: u }) => {
                                                const e = {
                                                    ...
                                                    A = (0, Mu.Om)(
                                                        (u) => {
                                                            const A = Su.U2(e.battleTypes.get(), u);
                                                            if (!A) throw Error('battleType is undefined');
                                                            return A;
                                                        },
                                                        { equals: Tu },
                                                    );
                                                return Object.assign({}, e, { computes: { battleType: A } });
                                            })({
                                                mode: u,
                                                readByPath: t,
                                                externalModel: B,
                                                observableModel: {
                                                    ...
                                                    array: (e, A) => {
                                                        const F = null != A ? A : t(e),
                                                            E = Pu.LO.box(F, { equals: Tu });
                                                        return (
                                                            'real' === u &&
                                                                B.subscribe(
                                                                    (0, Pu.aD)((u) => E.set(u)),
                                            ...
                                            r = { mode: u, model: C, externalModel: B, cleanup: n };
                                        return {
                                            model: C,
                                            controls: 'mocks' === u && A ? A.controls(r) : _u,
                                            externalModel: B,
                                            mode: u,
                                        };
                                    },
                                    ...
                                    o = r[0],
                                    a = r[1],
                                    i = (0, t.useState)(() => B(u, e, E)),
                                    s = i[0],
                                    l = i[1];
                                return (
                                    (0, t.useEffect)(() => {
                                        C.current ? l(B(o, e, E)) : (C.current = !0);
                                    }, [E, o, e]),
                                    (0, t.useEffect)(() => {
                                        a(u);
                                    }, [u]),
                                    ...
                                    n().createElement(A.Provider, { value: s }, F)
                                );
                            },
                            () => (0, t.useContext)(A),
                        ];
                    ...
                    Lu = zu[0],
                    ju = zu[1],
                    ku = R.strings.battle_royale.tooltip.progression.leaderboardReward,
                    Nu = (0, hu.Pi)(() => {
                        const u = ju().model;
                        return n().createElement(
                            yu,
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(f, { text: ku.header(), classMix: 'App_text_82' }),
                                ),
                                n().createElement(xu.i, {
                ...
                engine.whenReady.then(() => {
                    r().render(
                        n().createElement(Lu, null, n().createElement(Nu, null)),
            ...
            5801: (u, e, A) => {
                ...
                const n = 'Column_separator_99',
                    C = ({ battleType: u, mode: e, isNotFirstColumn: A }) =>
                        t().createElement(
                            'div',
                            { className: E()('Column_base_a8', A && 'Column_base__notFirstColumn_74') },
                            t().createElement('div', { className: n }),
                            t().createElement('div', { className: 'Column_battleType_38' }, u),
                            D.UI(e, ({ place: u, points: A }, F) => {
                                const D = e.length - 1 === F;
                                return t().createElement(
                                    'div',
                                    { key: F, className: 'Column_cell_73' },
                                    t().createElement('div', { className: n }),
                                    t().createElement(
                                        'div',
                                        { className: E()('Column_row_97', D && 'Column_row__last_4d') },
                                        t().createElement('div', { className: 'Column_place_90' }, u),
                                        A
                                            ? t().createElement(
                                                  'div',
                                                  { className: 'Column_pointContainer_30' },
                                                  t().createElement('div', { className: 'Column_point_1b' }, A),
                                                  t().createElement('div', { className: 'Column_reward_c1' }),
                                              )
                                            : t().createElement(
                                                  'div',
    ...
    ((F.m = e),
        ...
        (F.j = 'lobby/tooltips/LeaderboardRewardTooltipView/LeaderboardRewardTooltipView'),
        (() => {
            var u = {
                'lobby/tooltips/LeaderboardRewardTooltipView/LeaderboardRewardTooltipView': 0,
