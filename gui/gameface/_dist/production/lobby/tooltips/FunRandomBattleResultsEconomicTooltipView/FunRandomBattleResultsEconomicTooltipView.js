(() => {
    ...
    var __webpack_modules__ = {
            ...
            9060: (u, e, t) => {
                ...
                var E = {};
                (t.r(E),
                    t.d(E, { mouse: () => B, off: () => i, on: () => o, onResize: () => r, onScaleUpdated: () => D }));
                var A = {};
                (t.r(A),
                    t.d(A, {
                        events: () => E,
                ...
                const r = (0, F.E)('clientResized'),
                    ...
                    a = { down: (0, F.E)('mousedown'), up: (0, F.E)('mouseup'), move: (0, F.E)('mousemove') },
                    B = (function () {
                ...
                const _ = {
                    ...
                    v = Object.keys(m).reduce((u, e) => ((u[e] = () => s(m[e])), u), {}),
                    p = { play: Object.assign({}, v, { sound: s }), setRTPC: C },
                    f = { view: t(2031), client: A, sound: p, intl: d };
            },
            2031: (u, e, t) => {
                (t.r(e),
                    t.d(e, {
                ...
                var E = {};
                (t.r(E), t.d(E, { getBgUrl: () => n, getTextureUrl: () => F }));
                var A = t(9690);
                function F(u, e, t = 1) {
                ...
                var D = t(2472);
                const o = {
                        onTextureFrozen: (0, D.E)('self.onTextureFrozen'),
                        onTextureReady: (0, D.E)('self.onTextureReady'),
                        onDomBuilt: (0, D.E)('self.onDomBuilt'),
                        onLoaded: (0, D.E)('self.onLoaded'),
                        onDisplayChanged: (0, D.E)('self.onShowingStatusChanged'),
                        onFocusUpdated: (0, D.E)('self.onFocusChanged'),
                        children: {
                            onAdded: (0, D.E)('children.onAdded'),
                            onLoaded: (0, D.E)('children.onLoaded'),
                            onRemoved: (0, D.E)('children.onRemoved'),
                            onAttached: (0, D.E)('children.onAttached'),
                            onTextureReady: (0, D.E)('children.onTextureReady'),
                            onRequestPosition: (0, D.E)('children.requestPosition'),
                        },
                    },
                    i = ['args'],
                    a = (u, e) => {
                ...
                const L = Object.keys(r).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === r[e]), u), {}),
                    N = {
                        set: (u, e) => {
            ...
            4455: (u, e, t) => {
                                ...
                                const o = (0, n.useRef)([]),
                                    i = (u, t, E) => {
                                        ...
                                        const n = (function ({
                                            ...
                                            a = (({ observableModel: u, readByPath: e }) => {
                                                const t = {
                                                        root: u.object(),
                                                        results: [
                                                            e('earned'),
                                            ...
                                            B = { mode: u, model: a, externalModel: r, cleanup: i };
                                        return {
                                            model: a,
                                    ...
                                    s = B[0],
                                    C = B[1],
                                    m = (0, n.useState)(() => i(u, E, D)),
                                    f = m[0],
                                    g = m[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        a.current ? g(i(s, E, D)) : (a.current = !0);
                                    }, [D, s, E]),
                                    (0, n.useEffect)(() => {
                                        C(u);
                                    }, [u]),
                ...
                const P = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    x = (u, e, t = y.left) => u.split(e).reduce(t === y.left ? O : T, []),
                    k = (() => {
                        const u = new RegExp(
                            [
                    ...
                    L = ['zh_cn', 'zh_sg', 'zh_tw'],
                    N = ({ binding: u, text: e = '', classMix: t, alignment: E = y.left, formatWithBrackets: F }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const D = F && u ? ((o = u), e.replace(/\{\w+\}/g, (u) => String(o[u.slice(1, -1)]))) : e;
                        var o;
                ...
                const $ = (0, C.Pi)(() => {
                    ...
                    Y = (0, C.Pi)(() => {
                        const u = b().model.root.get().premiumAdvertising;
                        return r().createElement(
                            'div',
                    ...
                    Z = (0, C.Pi)(() => {
                        const u = b().model.root.get().currencyType;
                        return r().createElement(
                            'div',
                    ...
                    Q = (0, C.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement('div', { className: h.header }, r().createElement($, null)),
                            u && r().createElement('div', { className: h.footer }, r().createElement(Y, null)),
                        );
                    });
                engine.whenReady.then(() => {
                    s().render(
                        r().createElement(g, null, r().createElement(a, null, r().createElement(Q, null))),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j =
            'lobby/tooltips/FunRandomBattleResultsEconomicTooltipView/FunRandomBattleResultsEconomicTooltipView'),
        (() => {
            var u = {
                'lobby/tooltips/FunRandomBattleResultsEconomicTooltipView/FunRandomBattleResultsEconomicTooltipView': 0,
            };
