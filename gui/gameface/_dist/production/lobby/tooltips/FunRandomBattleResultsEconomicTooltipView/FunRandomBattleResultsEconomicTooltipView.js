    ...
    var __webpack_modules__ = {
            ...
            2031: (u, e, t) => {
                ...
                const k = (() => {
                    ...
                    x = A.cg,
                    R = Object.keys(r).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === r[e]), u), {}),
                    N = {
                        set: (u, e) => {
            ...
            4455: (u, e, t) => {
                ...
                const p = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: A, mocks: D }) {
                                ...
                                return (
                                    (0, n.useEffect)(() => {
                                        a.current ? b(i(s, E, D)) : (a.current = !0);
                                    }, [D, s, E]),
                                    (0, n.useEffect)(() => {
                                        C(u);
                                    }, [u]),
                ...
                const O = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    k = (u, e, t = y.left) => u.split(e).reduce(t === y.left ? P : T, []),
                    x = (() => {
                        const u = new RegExp(
                            ...
                            r().createElement(
                                'span',
                                {
                                    className: A()(
                                        V.value,
                                        V[`value__${u}`],
                                        (e < 0 || U(I.SHOW_NEGATIVE_IMPACT, F)) && V.value__notEnough,
                                    ),
                                },
                                (t || U(I.ADD, F)) && e > 0 && '+',
                                U(I.MUL, F) && R.strings.common.multiplier(),
                                Number.isInteger(e) ? r().createElement(M, { value: e }) : e,
                                U(I.PROCENT, F) && R.strings.common.common.percent(),
                            ),
                ...
                const Y = (0, C.Pi)(() => {
                    ...
                    Q = (0, C.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement('div', { className: h.header }, r().createElement(Y, null)),
                            u && r().createElement('div', { className: h.footer }, r().createElement($, null)),
                        );
                    });
                engine.whenReady.then(() => {
                    s().render(
                        r().createElement(b, null, r().createElement(a, null, r().createElement(Q, null))),
