(() => {
    ...
    var __webpack_modules__ = {
            ...
            6177: (u, e, A) => {
                ...
                const p = (u, e, A) => {
                    ...
                    b = (u, e, A = h.left) => u.split(e).reduce(A === h.left ? p : f, []),
                    g = (() => {
                        const u = new RegExp(
                    ...
                    O = ['zh_cn', 'zh_sg', 'zh_tw'],
                    P = ({ binding: u, text: e = '', classMix: A, alignment: D = h.left }) =>
                        null === e
                    ...
                    T = 'Content_subtitle_91',
                    y = 'Content_description_ba',
                    M = R.strings.event.lootBoxTooltip,
                    x = (u, e) => (e ? u.hunter() : u.boss()),
                    k = () => {
                        const u = m('model').isHunterLootBox,
                            e = n()('Content_icon_f4', u && 'Content_icon__hunter_fe');
                        return E().createElement(
                            'div',
                            { className: 'Content_base_7e' },
                            E().createElement('div', { className: 'Content_title_7d' }, x(M.title, u)),
                            E().createElement('div', { className: e }),
                            E().createElement(
                                'div',
                                { className: 'Content_howItWorksWrapper_69' },
                                E().createElement('div', { className: T }, M.howItWorks.title()),
                                E().createElement('div', { className: y }, x(M.howItWorks.description, u)),
                            ),
                            E().createElement(P, { classMix: T, text: x(M.howToGet.title, u) }),
                            E().createElement(P, { classMix: y, text: x(M.howToGet.description, u) }),
                        );
                    },
                    S = () => E().createElement(a, null, E().createElement(k, null));
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(6177));
