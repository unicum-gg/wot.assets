    ...
    var u,
        e = {
            ...
            884: (u, e, t) => {
                ...
                var E = {};
                t.r(E), t.d(E, { getBgUrl: () => f, getTextureUrl: () => p });
                var r = {};
                t.r(r),
                    t.d(r, {
                        addModelObserver: () => H,
                ...
                const c = m('clientResized'),
                    d = { down: m('mousedown'), up: m('mouseup'), move: m('mousemove') },
                    _ = (function () {
                ...
                const Y = Object.keys(v).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === v[e]), u), {}),
                    q = {
                        set: (u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: A, children: F, mocks: E }) {
                                const r = (0, D.useRef)([]),
                                    n = (u, t, A) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            B = (({ observableModel: u }) => {
                                                ...
                                                return Object.assign({}, e, { computes: { getVehicleItems: t } });
                                            })({
                                                mode: u,
                                                readByPath: a,
                                                externalModel: D,
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const A = null != t ? t : a(e),
                                                            F = o.observable.box(A, { equals: C });
                                                        return (
                                                            'real' === u &&
                                                                D.subscribe(
                                                                    (0, o.action)((u) => F.set(u)),
                                                                    e,
                                                                ),
                                                            F
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const F = e.reduce(
                                                                (u, e) => ((u[e] = o.observable.box(A[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                                            ...
                                            m = { mode: u, model: B, externalModel: D, cleanup: n };
                                        return {
                                            model: B,
                                            controls: 'mocks' === u && A ? A.controls(m) : e(m),
                                            externalModel: D,
                                            mode: u,
                                        };
                                    },
                                    ...
                                    s = m[0],
                                    c = m[1],
                                    d = (0, D.useState)(() => n(u, A, E)),
                                    _ = d[0],
                                    g = d[1];
                                return (
                                    (0, D.useEffect)(() => {
                                        B.current ? g(n(s, A, E)) : (B.current = !0);
                                    }, [E, s, A]),
                                    (0, D.useEffect)(() => {
                                        c(u);
                                    }, [u]),
                                    (0, D.useEffect)(
                                        () => () => {
                                            _.externalModel.dispose(), r.current.forEach((u) => u());
                                        },
                                        [_],
                                    ),
                                    a().createElement(t.Provider, { value: _ }, F)
                                );
                            },
                            () => (0, D.useContext)(t),
                        ];
                ...
                const Bu = a().forwardRef(function (u, e) {
                    let t = u.children,
                        A = u.className,
                        F = u.theme,
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            nu({}, r, {
                                className: Eu()(Du.base, Du[`base__theme-${E}`], A),
                                ref: function (u) {
                                    (B.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            a().createElement('div', { className: Du.decorator }, t),
                        )
                    );
                });
                var iu = t(9887),
                ...
                const cu = Z.client.getSize('rem'),
                    du = cu.width,
                    _u = cu.height,
                    gu = Object.assign({ width: du, height: _u }, su(du, _u, ou)),
                    hu = (0, D.createContext)(gu),
                    xu = ['children'],
                    pu = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && B) return Cu(e, t, g);
                            if (t.largeWidth && i) return Cu(e, t, g);
                            if (t.mediumWidth && l) return Cu(e, t, g);
                            if (t.smallWidth && C) return Cu(e, t, g);
                            if (t.extraSmallWidth && o) return Cu(e, t, g);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                (0, D.memo)(({ children: u }) => {
                    const e = (0, D.useContext)(hu),
                        ...
                        E = (0, D.useCallback)((u, e) => {
                            const t = Z.view.pxToRem(u),
                                A = Z.view.pxToRem(e);
                            F(Object.assign({ width: t, height: A }, su(t, A, ou)));
                        }, []);
                    ((u) => {
                    ...
                    return a().createElement(hu.Provider, { value: r }, u);
                }),
                    (function (u) {
                ...
                const Su = ['xl', 'lg', 'md', 'sm', 'xs'],
                    wu = (u) => u.includes('_') && ((u) => Su.includes(u))(u.split('_').at(-1)),
                    yu = [fu.ExtraLarge, fu.Large, fu.Medium, fu.Small, fu.ExtraSmall],
                    Lu = (u, e) =>
                ...
                const Ou = {
                    ...
                    Nu = Mu((u) => {
                        let e = u.className,
                            ...
                            T = u.shrink,
                            H = u.flex,
                            O = void 0 === H ? (R || T ? `${R ? 1 : 0} ${T ? 1 : 0} auto` : void 0) : H,
                            P = u.style,
                            W = u.children,
                            N = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const G = (0, D.useMemo)(() => {
                                ...
                                return {
                                    computedStyle: Object.assign({}, P, F, {
                            ...
                            }, [t, A, r, B, l, o, P, O, w, d, M, v, S]),
                            j = G.computedStyle,
                            X = G.computedClassNames;
                        return a().createElement('div', Hu({ className: Eu()(Ru.base, ...X, e), style: j }, N), W);
                    });
                let Gu;
                !(function (u) {
                ...
                const ju = (u, e, t) => {
                    ...
                    Iu = (u, e, t = Gu.left) => u.split(e).reduce(t === Gu.left ? ju : Xu, []),
                    zu = (() => {
                        const u = new RegExp(
                    ...
                    Vu = ({ binding: u, text: e = '', classMix: t, alignment: A = Gu.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, F) =>
                                      a().createElement(
                                          'div',
                                          { className: Eu()('FormatText_base_d0', t), key: `${e}-${F}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                ...
                const Qu = Object.keys(Uu()),
                    ...
                    Ae = Mu((u) => {
                        ...
                        return a().createElement(
                            ...
                            qu(
                                {
                                    className: Eu()(Ku.base, t && Ku[t], h, A),
                                    style: g,
                                    mt: !0 === n ? ee[t || 'paragraph-P16'].mt : n,
                                    mr: !0 === i ? ee[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === C ? ee[t || 'paragraph-P16'].mb : C,
                                    ml: !0 === m ? ee[t || 'paragraph-P16'].ml : m,
                                },
                                d,
                            ),
                            void 0 !== c ? a().createElement(Vu, qu({}, c, { text: e })) : e,
                        );
                    }),
                    Fe = {
                ...
                const De = (0, D.memo)(({ type: u, color: e, classMix: t, size: A = Ee.C24x24 }) => {
                        const F = Eu()(Fe.base, Fe[`base__${A}`], t),
                            E = (0, D.useMemo)(() => {
                                return {
                        ...
                        return a().createElement('div', { className: F, style: E });
                    }),
                    ae = R.strings.hb_tooltips,
                    ne = (0, ru.observer)(() => {
                        const u = Au().model.computes.getVehicleItems(),
                            e = u.length - 1,
                            t = Eu()('App_base_6c', 'App_content_3f');
                        return a().createElement(
                            Bu,
                            null,
                            a().createElement(
                                ...
                                { className: t },
                                a().createElement(Ae, {
                                    text: ae.newVehiclesAvailableTooltip.header(),
                                    className: 'App_header_7a',
                                }),
                                a().createElement(Ae, {
                                    text: ae.newVehiclesAvailableTooltip.body(),
                                    className: 'App_body_63',
                                }),
                                u.map((u, t) =>
                                    a().createElement(
                                        'div',
                                        { key: t, className: 'App_vehicle_e0' },
                                        a().createElement('div', {
                                            className: 'App_vehicle_icon_3f',
                                            style: { backgroundImage: `url(${u.icon})` },
                                        }),
                                        a().createElement(De, {
                                            classMix: 'App_vehicle_type_20',
                                            color: re.Silver,
                                            type: u.vehicleType,
                                            size: Ee.C24x24,
                                        }),
                                        a().createElement(Ae, { text: u.name, className: 'App_vehicle_name_07' }),
                                        e !== t && a().createElement('div', { className: 'App_divider_cf' }),
                                    ),
                                ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    B().render(
                        a().createElement(tu, null, a().createElement(ne, null)),
