    ...
    var __webpack_modules__ = {
            ...
            2031: (u, e, t) => {
                ...
                const S = (() => {
                    ...
                    O = r.cg,
                    I = Object.keys(s).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === s[e]), u), {}),
                    x = {
                        set: (u, e) => {
            ...
            7088: (u, e, t) => {
                ...
                const C = [
                    ...
                    p = [c.BattlePassPoints, c.EquipCoin],
                    b = [c.PremiumPlus, c.Premium],
                                                ...
                                                return {
                                                    subscribe: (t, o) => {
                                                        const s = 'string' == typeof o ? `${n}.${o}` : n,
                                                            i = P.O.view.addModelObserver(s, e, !0);
                ...
                const q = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            z({}, i, {
                                className: U()(G.base, G[`base__theme-${s}`], o),
                                ref: function (u) {
                ...
                const Y = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    K = (u, e, t = j.left) => u.split(e).reduce(t === j.left ? X : H, []),
                    Q = (() => {
                        const u = new RegExp(
                    ...
                    Z = ['zh_cn', 'zh_sg', 'zh_tw'],
                    J = ({ binding: u, text: e = '', classMix: t, alignment: o = j.left, formatWithBrackets: a }) => {
                        ...
                        return r().createElement(
                            ...
                            s.split('\n').map((e, a) =>
                                r().createElement(
                                    'div',
                                    { className: U()('FormatText_base_d0', t), key: `${e}-${a}` },
                                    ((u, e, t) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                            t && u in t
                                                ? t[u]
                    ...
                    ru = (0, n.memo)(({ text: u, binding: e, classMix: t }) => {
                        ...
                        return r().createElement(J, { text: i, classMix: t, binding: a });
                    }),
                    ou = (R.images.fun_random.gui.maps.icons.feature.asset_packs, 'undefined');
                function au(u, e) {
                    return u
                        ? 'string' == typeof e
                            ? u.$dyn(e)
                ...
                function su(u, { poFileName: e, assetsPointer: t, isSubMode: n = !1 } = {}) {
                    ...
                    const o = n ? 'sub_modes' : 'modes',
                        a = r.$dyn(o),
                        s = (t ? (null == a ? void 0 : a.$dyn(t)) : r) || (null == a ? void 0 : a.$dyn(ou));
                    return u ? { staticTexts: au(r, u), dynamicTexts: au(s, u) } : { staticTexts: r, dynamicTexts: s };
                }
                const iu = {
                ...
                const cu = ({ size: u = Eu.Default }) => {
                        const e = U()(iu.background, iu[`background__${u}`]);
                ...
                const du = { base: 'ProgressBarBlink_base_24', base__small: 'ProgressBarBlink_base__small_0f' },
                    ...
                    fu = (0, n.memo)(
                        ({
                            ...
                            const p = (0, n.useMemo)(() => Object.assign({ width: '100%' }, vu(u), pu(c)), [c, u]),
                                b = (0, n.useMemo)(() => Object.assign({ width: '0%' }, vu(u), pu(c)), [c, u]),
                                v = (0, n.useMemo)(() => Object.assign({ width: '0%' }, bu(c, o), vu(u)), [o, c, u]),
                                f = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(s - o)}%` }, bu(c, o), vu(u)),
                                    [o, c, s, u],
                                );
                            if (d) return null;
                            const w = U()(
                ...
                const Ru = (0, n.memo)((u) => {
                        ...
                        switch (o.animationSettings.type) {
                            case lu.Simple:
                                return r().createElement(gu, Tu({}, o, { onEndAnimation: E, isComplete: s }));
                            case lu.Growing:
                                return r().createElement(wu, Tu({}, o, { onEndAnimation: E, isComplete: s }));
                            default:
                                return null;
                        }
                    }),
                    yu = ({ size: u, value: e, lineRef: t, disabled: o, onComplete: a }) => {
                        ...
                        return (
                            ...
                            r().createElement(Cu, { size: u, disabled: o, baseStyles: s, isComplete: i, lineRef: t })
                        );
                    },
                    Pu = ['onEndAnimation'];
                function Su() {
                ...
                const xu = (0, n.memo)(
                        ({
                            ...
                            return s.withStack
                                ? r().createElement(Ou, c)
                                : r().createElement(Ru, Iu({ key: `${o}-${e}-${a}` }, c));
                        },
                    ),
                    ku = (u) => ({
                    ...
                    Mu = (u, e, t) => ('number' == typeof t ? (Nu(0, e, t) / e) * 100 : u),
                    Lu = {
                    ...
                    Gu = (0, n.memo)(
                        ({
                            ...
                            return r().createElement(
                                'div',
                                { className: U()(iu.base, iu[`base__${t}`]), style: ku(e) },
                                !s && r().createElement(cu, { size: t }),
                                r().createElement(xu, {
                                    size: t,
                                    lineRef: c,
                                    disabled: a,
                    ...
                    zu = R.images.gui.maps.icons.quests.battleCondition.c_128_decor,
                    qu = R.images.gui.maps.icons.quests.battleCondition.c_128,
                    Vu = (u) => {
                        var e;
                        const t = `icon_battle_condition_${u}_128x128`;
                        return { backgroundImage: `url(${null != (e = zu.$dyn(t)) ? e : qu.$dyn(t)})` };
                    },
                    ju = (0, i.Pi)(() => {
                        const u = M().model,
                            ...
                            a = $u.progression.$dyn(t > 0 ? 'stepsCurrent' : 'stepsNoProgress'),
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(ru, { text: a, binding: { done: t, total: n } }),
                                ),
                                r().createElement(Gu, { size: Eu.Small, value: t, maxValue: n }),
                            ),
                        );
                    }),
                    Wu = [
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (Xu(t, D, { isMouseEvent: !0, on: !0, arguments: Yu(r) }, v),
                                    C && C(),
                ...
                const re = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return r().createElement(te, e, n);
                        const o = e.contentId;
                        return o ? r().createElement(Hu, ne({}, e, { contentId: o }), n) : r().createElement(Zu, e, n);
                    },
                    oe = {
                        base: 'Reward_base_ea',
                    ...
                    ae = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: U()(oe.base, oe[`base__${n}`], c), style: E },
                            r().createElement(
                                re,
                                { tooltipArgs: m, className: oe.tooltipWrapper },
                                r().createElement(
                                    r().Fragment,
                                    null,
                                    r().createElement(
                                        'div',
                                        { className: U()(oe.image, null == A ? void 0 : A.image) },
                                        g &&
                                            r().createElement('div', {
                                                className: U()(oe.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: U()(oe.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        p &&
                                            r().createElement('div', {
                                                className: U()(oe.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: U()(
                                                    oe.info,
                                                    oe[`info__${u}`],
                                                    s === D.MULTI && oe.info__multi,
                                                    null == A ? void 0 : A.info,
                                                ),
                                            },
                                            b,
                                        ),
                                    i && r().createElement('div', { className: oe.title }, i),
                                ),
                            ),
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: C },
                                    r().createElement('div', {
                                        className: U()(oe.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const ie = ({ reward: u, size: e }) => {
                        const t = u.RewardWrapper || null;
                        return t
                            ? r().createElement(t, u.rewardWrapperProps, r().createElement(ae, se({ size: e }, u)))
                            : r().createElement(ae, se({ size: e }, u));
                    },
                    Ee = ({
                        data: u,
                        size: e = F.Big,
                        ...
                        const c = n && n < u.length,
                            A = U()('Rewards_reward_7b', t && 'Rewards_reward__vertical_c6', a),
                            D = c ? n : u.length;
                        return r().createElement(
                            'div',
                            { className: U()('Rewards_base_26', t && 'Rewards_base__vertical_9f', o) },
                            u
                                .slice(0, D)
                                .map((u, t) =>
                                    r().createElement(
                                        'div',
                                        { key: t, className: A },
                                        r().createElement(ie, { reward: u, size: e }),
                                    ),
                                ),
                            c &&
                                r().createElement(
                    ...
                    le = R.strings.fun_random.metaProgressionTooltip.reward.header,
                    ce = (0, i.Pi)(() => {
                        const u = M().model,
                ...
                const Be = (u = 0, e, t = 0, r = de) => {
                    ...
                    pe = (0, n.memo)(
                        ({
                            ...
                            const E = null != a ? a : t !== Fe.Description ? 1 : void 0,
                                l = Be(u, E),
                                c = (() => {
                            ...
                            const A = ((u, e) => {
                                switch (e) {
                                    ...
                                    case Fe.Short:
                                        return `${me(u.minutes)}:${me(u.seconds)}`;
                                    case Fe.Long:
                                        return `${me(u.hours)}:${me(u.minutes)}:${me(u.seconds)}`;
                                    case Fe.Extended:
                                        return `${W(R.strings.common.duration.days(), { days: u.days })} | ${me(u.hours)}:${me(u.minutes)}:${me(u.seconds)}`;
                                }
                            })(
                                (function (u = 0) {
                                    let e = u;
                            ...
                            return r().createElement(
                                'div',
                                { className: U()('Countdown_base_fe', s) },
                                e !== Ae.None &&
                                    r().createElement('div', {
                                        className: U()('Countdown_icon_8b', i.icon),
                                        style: { backgroundImage: `url('${ge(e, c)}')` },
                                    }),
                                r().createElement('div', { className: U()('Countdown_description_8d', i.text) }, A),
                            );
                        },
                    ),
                    be = {
                    ...
                    ve = (0, i.Pi)(({ fullMode: u }) => {
                        ...
                        return r().createElement(
                            ...
                            a && r().createElement('div', { className: U()(be.separator, be.separator__top) }),
                            r().createElement(
                                'div',
                                ...
                                r().createElement(J, {
                                    ...
                                    binding: {
                                        time: r().createElement(
                                            ...
                                            r().createElement(pe, { duration: n, style: Fe.Description }),
                                        ),
                                    },
                                }),
                            ),
                    ...
                    we = (0, i.Pi)(() => {
                        ...
                        const e = M().model,
                            ...
                            a = n.maximumStage,
                            i = n.status,
                            E = su('metaProgressionTooltip', { assetsPointer: e.assetsPointer.get() }).dynamicTexts,
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: U()(fe.base, fe[`base__${i}`]) },
                                r().createElement(
                                    'div',
                                    { className: fe.title },
                                    r().createElement(ru, {
                    ...
                    Te = (0, i.Pi)(() => {
                        const u = M().model,
                            e = u.progressionState.get().status,
                            t = su('metaProgressionTooltip', { assetsPointer: u.assetsPointer.get() }),
                            n = t.staticTexts,
                            o = t.dynamicTexts;
                        return r().createElement(
                            q,
                            ...
                            r().createElement(
                                'div',
                                { className: U()(he.base, he[`base__${e}`]) },
                                r().createElement('div', { className: he.noRewardSubTitle }, o.subheader()),
                                r().createElement('div', { className: he.noRewardTitle }, n.header.$dyn(e)),
                    ...
                    Re = (0, i.Pi)(() => {
                        ...
                        switch (u) {
                            ...
                            case s.ACTIVE_INFINITE_FINAL:
                                return r().createElement(we, null);
                ...
                engine.whenReady.then(() => {
                    a().render(
                        r().createElement(N, null, r().createElement(Re, null)),
