        ...
        e = {
            ...
            449: (u, e, t) => {
                ...
                const Zu = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    ue = Ju[0],
                    ee = Ju[1],
                    te = 'App_damageBlockText_f2',
                    Ae = 'App_damageBlockText__param_db',
                    Fe = 'App_damageBlockText__light_4e',
                    Ee = R.strings.fl_supply_objects.page.object.damageZones,
                    re = (0, Ku.Pi)(() => {
                        const u = ee().model.root.get(),
                            e = u.supplyHullDamageFactor,
                            t = u.supplyTurretDamageFactor;
                        return K().createElement(
                            'div',
                            { className: 'App_base_1c' },
                            K().createElement($u, {
                                className: a()(te, 'App_damageBlockText__big_90'),
                                text: Ee.title(),
                            }),
                            K().createElement($u, {
                                className: a()(te, Ae),
                                ...
                                format: {
                                    binding: {
                                        value: K().createElement($u, {
                                            className: Fe,
                                            text: Ee.percents(),
                                            format: { binding: { number: String(Math.round(100 * e)) } },
                                        }),
                                    },
                                },
                            }),
                                ...
                                format: {
                                    binding: {
                                        value: K().createElement($u, {
                                            className: Fe,
                                            text: Ee.percents(),
                                            format: { binding: { number: String(Math.round(100 * t)) } },
                                        }),
                                    },
                                },
                            }),
                ...
                engine.whenReady.then(() => {
                    uu().render(
                        K().createElement(ue, null, K().createElement(Z, null, K().createElement(re, null))),
