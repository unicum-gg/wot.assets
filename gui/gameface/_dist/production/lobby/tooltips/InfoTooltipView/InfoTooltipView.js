(() => {
    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, A) => {
                ...
                function d(u, e, A, F, E, D, t) {
                    ...
                    B.done ? e(n) : Promise.resolve(n).then(F, E);
                }
                ...
                const f = E.instance,
                    b = {
                        ...
                        sendMoveEvent: (u) => w(n.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: m,
                        sendClosePopOverEvent: () => w(n.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            w(n.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
                ...
                const a = E().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            E().createElement(
                                'div',
                                o({}, a, {
                                    className: n()(r.base, r[`base__theme-${B}`], D),
                                    ref: function (u) {
                    ...
                    return (
                        ((u) => {
                            ...
                            if (
                                ...
                                o.current = v.addCallback(F, A, B, e === w.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== w.None)
                                return () => {
                                    v.removeCallback(o.current, B);
                                };
                        }, [B, e]),
                        r
                    );
                ...
                const h = (u, e, A) => {
                        ...
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, t) =>
                                      E().createElement(
                                          'div',
                                          { className: n()('FormatText_base_d0', A), key: `${e}-${t}` },
                                          ((u, e, A) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  A && u in A
                                                      ? A[u]
                    ...
                    y = () => {
                        ...
                        return E().createElement(
                            ...
                            E().createElement(P, { text: e || '', classMix: 'Content_title_15' }),
                            A && E().createElement('div', { className: 'Content_description_4a' }, A),
                            F &&
                                E().createElement(
                                    'div',
                                    { className: 'Content_infoWrapper_46' },
                                    E().createElement('div', { className: 'Content_divider_72' }),
                                    E().createElement('div', { className: 'Content_icon_3c' }),
                                    E().createElement('div', { className: 'Content_text_19' }, F),
                                ),
                        );
                    },
                    T = () => E().createElement(a, null, E().createElement(y, null));
        ...
        (__webpack_require__.O = (u, e, A, F) => {
            if (!e) {
                ...
                for (n = 0; n < deferred.length; n++) {
                    for (var [e, A, F] = deferred[n], D = !0, t = 0; t < e.length; t++)
                        (!1 & F || E >= F) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(2258));
