(() => {
    var __webpack_modules__ = {
            ...
            4674: (u, e, t) => {
                        ...
                        return (
                            d(() => {
                                if (
                                    ...
                                    F.current = p.addCallback(r, t, s, e === h.Deep);
                                }
                            }),
                            (0, r.useEffect)(() => {
                                if (e !== h.None)
                        ...
                        const b = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            x = (0, r.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (v(t, m, { isMouseEvent: !0, on: !0, arguments: f(n) }, S),
                                    g && g(),
                                      ...
                                      Object.assign(
                                          {
                                              ...
                                              onClick: ((u) => (e) => {
                                                  (!1 === F && R(), null == o || o(e), null == u || u(e));
                                              })(e.props.onClick),
                                              onMouseDown: ((u) => (e) => {
                                                  (!1 === F && R(), null == s || s(e), null == u || u(e));
                                              })(e.props.onMouseDown),
                                          },
                                          h,
                                      ),
                ...
                (((z = I || (I = {})).Items = 'items'),
                    ...
                    (z.Xp = 'xp'),
                    (z.XpFactor = 'xpFactor'),
                    (z.Blueprints = 'blueprints'),
                    (z.BlueprintsAny = 'blueprintsAny'),
                    (z.Goodies = 'goodies'),
                    (z.Berths = 'berths'),
                    (z.Slots = 'slots'),
                    (z.Tokens = 'tokens'),
                    (z.CrewSkins = 'crewSkins'),
                    (z.CrewBooks = 'crewBooks'),
                    (z.Customizations = 'customizations'),
                    (z.CreditsFactor = 'creditsFactor'),
                    (z.Currency = 'currency'),
                    (z.TankmenXp = 'tankmenXP'),
                    (z.TankmenXpFactor = 'tankmenXPFactor'),
                    (z.FreeXpFactor = 'freeXPFactor'),
                    (z.BattleToken = 'battleToken'),
                    (z.PremiumUniversal = 'premium_universal'),
                    (z.Gold = 'gold'),
                    (z.Credits = 'credits'),
                    (z.Crystal = 'crystal'),
                    (z.FreeXp = 'freeXP'),
                    (z.Premium = 'premium'),
                    (z.PremiumPlus = 'premium_plus'),
                    (z.BattlePassPoints = 'battlePassPoints'),
                    (z.BattlePassSelectToken = 'battlePassSelectToken'),
                    (z.SelectableBonus = 'selectableBonus'),
                    (z.StyleProgressToken = 'styleProgressToken'),
                    (z.TmanToken = 'tmanToken'),
                    (z.NaturalCover = 'naturalCover'),
                    (z.BpCoin = 'bpcoin'),
                    (z.BattlaPassFinalAchievement = 'dossier_achievement'),
                    (z.BattleBadge = 'dossier_badge'),
                    (z.NewYearAlbumsAccess = 'newYearAlbumsAccess'),
                    (z.NewYearFillers = 'ny22Fillers'),
                    (z.NewYearInvoice = 'newYearInvoice'),
                    (z.NewYearToyFragments = 'ny22ToyFragments'),
                    (z.NewYearSlot = 'newYearSlot'),
                    (z.BonusX5 = 'battle_bonus_x5'),
                    (z.CrewBonusX3 = 'crew_bonus_x3'),
                    (z.Vehicles = 'vehicles'),
                    (z.EpicSelectToken = 'epicSelectToken'),
                    (z.CollectionItem = 'collectionItem'),
                    (z.Comp7TokenWeeklyReward = 'comp7TokenWeeklyReward'),
                    (z.Comp7TokenCouponReward = 'comp7TokenCouponReward'),
                    (z.BattleBoosterGift = 'battleBooster_gift'),
                    (z.CosmicLootboxSilver = 'lootBoxToken'),
                    (z.CosmicLootboxCommon = 'cosmic_2024_2'),
                    (z.Branch = 'branch'),
                    (z.VehicleSelect = 'vehicleSelect'),
                    (z.StyleProgress = 'styleProgress'),
                    (z.ParagonsUnlocks = 'paragonsUnlocks'),
                    (z.LootBoxToken = 'lootBoxToken'),
                    (z.GoldenTicket = 'birthday2025_golden_ticket'),
                    (z.PostStamp = 'giftsystem_4_stamp'),
                    (z.Quests = 'quests'),
                    (z.WtStamp = 'stamp'),
                    (z.WtHunter = 'wt_hunter'),
                    (z.WtHunterCollection = 'hunter_collection'),
                    (z.WtTicket = 'wtevent_ticket'),
                    (z.WtMainPrizeDiscount = 'main_prize_discount'),
                    (z.WtTicket25 = 'wtevent_ticket25'),
                    (function (u) {
                        ((u.Gold = 'gold'),
                            (u.Credits = 'credits'),
                            (u.Crystal = 'crystal'),
                ...
                const j = ({ format: u, value: e }) => {
                    ...
                    q = [I.Gold, I.Credits, I.Crystal, I.FreeXp],
                    V = [I.BattlePassPoints],
                    K = [I.PremiumPlus, I.Premium],
                    ...
                    uu = ({
                        ...
                        return n().createElement(
                            'div',
                            { className: o()(J.base, J[`base__${r}`], l), style: E },
                            n().createElement(
                                k,
                                { tooltipArgs: F, className: J.tooltipWrapper },
                                n().createElement(
                                    n().Fragment,
                                    null,
                                    n().createElement(
                                        'div',
                                        { className: o()(J.image, null == A ? void 0 : A.image) },
                                        m &&
                                            n().createElement('div', {
                                                className: o()(J.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            n().createElement('div', {
                                                className: o()(J.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        _ &&
                                            n().createElement('div', {
                                                className: o()(J.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                            ...
                            t &&
                                n().createElement(
                                    ...
                                    { tooltipArgs: c },
                                    n().createElement('div', {
                                        className: o()(J.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const ru = (u, e, t) => {
                    ...
                    au = (u, e, t = eu.left) => u.split(e).reduce(t === eu.left ? ru : nu, []),
                    iu = (() => {
                        const u = new RegExp(
                    ...
                    ou = ({ binding: u, text: e = '', classMix: t, alignment: a = eu.left }) =>
                        null === e
                ...
                const Fu = ({ size: u = lu.Default, classMix: e }) =>
                        n().createElement('div', { className: o()(Eu.background, Eu[`background__${u}`], e) }),
                    cu = {
                    ...
                    Du = (0, r.memo)(
                        ({ size: u, lineRef: e, disabled: t, baseStyles: r, isComplete: a, withoutBounce: i }) => {
                            const s = o()(
                                    ...
                                    t && _u.base__disabled,
                                    a && _u.base__finished,
                                    i && _u.base__withoutBounce,
                                ),
                                E = !t && !a;
                            return n().createElement(
                                'div',
                                { className: s, style: r, ref: e },
                                n().createElement('div', { className: _u.pattern }),
                                n().createElement('div', { className: _u.gradient }),
                                E && n().createElement(mu, { size: u }),
                            );
                        },
                    ),
                    du = ({ size: u, value: e, lineRef: t, disabled: a, onComplete: i }) => {
                        ...
                        return (
                            ...
                            n().createElement(Du, { size: u, disabled: a, baseStyles: s, isComplete: o, lineRef: t })
                        );
                    },
                    Bu = (u, e) => {
                        let t;
                ...
                const pu = (0, r.memo)(
                    ...
                    vu = (0, r.memo)(
                        ({
                            ...
                            const h = (0, r.useMemo)(() => Object.assign({ width: '100%' }, fu(u), bu(F)), [F, u]),
                                b = (0, r.useMemo)(() => Object.assign({ width: '0%' }, fu(u), bu(F)), [F, u]),
                                w = (0, r.useMemo)(() => Object.assign({ width: '0%' }, wu(F, a), fu(u)), [a, F, u]),
                                f = (0, r.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(s - a)}%` }, wu(F, a), fu(u)),
                                    [a, F, s, u],
                                );
                            if (D) return null;
                            const v = o()(
                ...
                const Tu = (0, r.memo)((u) => {
                        ...
                        switch (a.animationSettings.type) {
                            case Au.Simple:
                                return n().createElement(hu, Ru({}, a, { onEndAnimation: E, isComplete: s }));
                            case Au.Growing:
                                return n().createElement(Su, Ru({}, a, { onEndAnimation: E, isComplete: s }));
                            default:
                                return null;
                        }
                    }),
                ...
                const Ou = (0, r.memo)((u) => {
                    ...
                    return (
                        (a.current.from = s),
                        n().createElement(Tu, Mu({}, t, { onEndAnimation: i, key: `${s}-${t.to}`, from: s }))
                    );
                });
                function yu() {
                    return (
                ...
                const Lu = (0, r.memo)(
                        ({
                            ...
                            return i.withStack
                                ? n().createElement(Ou, l)
                                : n().createElement(Tu, yu({ key: `${a}-${e}` }, l));
                        },
                    ),
                    Nu = (u) => ({
                    ...
                    Uu = (u, e, t) => ('number' == typeof t ? (Iu(0, e, t) / e) * 100 : u),
                    Hu = {
                        bgImageBase: 'R.images.gui.maps.icons.components.progress_bar.pattern_grey',
                    ...
                    Wu = (0, r.memo)(
                        ({
                            ...
                            const D = ((u, e, t) =>
                                (0, r.useMemo)(() => {
                                    const r = (Iu(0, e, u) / e) * 100;
                                    return { value: r, deltaFrom: Uu(r, e, t) };
                                }, [t, e, u]))(l, u, A);
                            return n().createElement(
                                'div',
                                { className: o()(Eu.base, Eu[`base__${t}`]), style: Nu(e) },
                                !s && n().createElement(Fu, { size: t, classMix: E }),
                                n().createElement(Lu, {
                                    size: t,
                                    lineRef: F,
                                    disabled: i,
                ...
                const Vu = E.O.client.getSize('rem'),
                    Ku = Vu.width,
                    Qu = Vu.height,
                    Zu = Object.assign({ width: Ku, height: Qu }, qu(Ku, Qu, ju)),
                    Ju = (0, r.createContext)(Zu),
                    ue = ['children'],
                    ee = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && l) return zu(e, t, g);
                            if (t.largeWidth && A) return zu(e, t, g);
                            if (t.mediumWidth && F) return zu(e, t, g);
                            if (t.smallWidth && c) return zu(e, t, g);
                            if (t.extraSmallWidth && m) return zu(e, t, g);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                    ...
                    (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(Ju),
                            ...
                            s = (0, r.useCallback)((u, e) => {
                                ...
                                i(Object.assign({ width: t, height: r }, qu(t, r, ju)));
                            }, []);
                        (d(() => {
                        ...
                        return n().createElement(Ju.Provider, { value: o }, u);
                    }),
                    (function (u) {
                ...
                const ae = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ie = (u) => u.includes('_') && ((u) => ae.includes(u))(u.split('_').at(-1)),
                    se = [te.ExtraLarge, te.Large, te.Medium, te.Small, te.ExtraSmall],
                    oe = (u, e) =>
                    ...
                    Ee = (u, e = oe) => {
                        ...
                        return n().memo((e) =>
                            Object.keys(e).some((u) => ie(u) && void 0 !== e[u])
                                ? n().createElement(t, e)
                                : n().createElement(u, e),
                        );
                    },
                ...
                const ce = {
                    ...
                    De = Ee((u) => {
                        let e = u.className,
                            ...
                            y = u.shrink,
                            L = u.flex,
                            N = void 0 === L ? (O || y ? `${O ? 1 : 0} ${y ? 1 : 0} auto` : void 0) : L,
                            k = u.style,
                            I = u.children,
                            U = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const H = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, E, A, c, _, k, N, R, C, M, v, x]),
                            G = H.computedStyle,
                            W = H.computedClassNames;
                        return n().createElement('div', Fe({ className: o()(le.base, ...W, e), style: G }, U), I);
                    });
                var de = t(3532),
                    Be = t.n(de);
                const Ce = {
                ...
                const he = Object.keys(Be()),
                    ...
                    xe = Ee((u) => {
                        ...
                        return n().createElement(
                            ...
                            pe(
                                {
                                    className: o()(Ce.base, t && Ce[t], h, a),
                                    style: p,
                                    mt: !0 === l ? ve[t || 'paragraph-P16'].mt : l,
                                    mr: !0 === F ? ve[t || 'paragraph-P16'].mr : F,
                                    mb: !0 === m ? ve[t || 'paragraph-P16'].mb : m,
                                    ml: !0 === D ? ve[t || 'paragraph-P16'].ml : D,
                                },
                                C,
                            ),
                            void 0 !== B ? n().createElement(ou, pe({}, B, { text: e })) : e,
                        );
                    });
                let Re;
                var Te;
                (((Te = Re || (Re = {})).SHORT_DATE = 'short-date'),
                    (Te.SHORT_TIME = 'short-time'),
                    (Te.SHORT_DATE_TIME = 'short-date-time'),
                    (Te.FULL_DATE = 'full-date'),
                    (Te.FULL_DATE_TIME = 'full-date-time'),
                    (Te.MONTH = 'month'),
                    (Te.MONTH_DATE = 'month-date'),
                    (Te.DATE_MONTH = 'date-month'),
                    (Te.MONTH_YEAR = 'month-year'),
                    (Te.WEEK_DAY = 'week-day'),
                    (Te.WEEK_DAY_TIME = 'week-day-time'),
                    (Te.YEAR = 'year'),
                    (Te.DATE_YEAR = 'date-year'));
                let Pe;
                var Me;
                (Date.now(),
                    ((Me = Pe || (Pe = {})).UNDEFINED = 'undefined'),
                    (Me.BOSS = 'boss'),
                    (Me.BOSS_2025 = 'boss2025'),
                    (Me.BOSS_SPECIAL = 'bossSpecial'),
                    (Me.HUNTER = 'hunter'));
                const Oe = 1.6,
                    ye = (u) => (e, t) =>
                    ...
                    Le =
                        (ye((u, e, t, r) => {
                            const n = { width: viewEnv.remToPx(900) * Oe, height: viewEnv.remToPx(900) },
                                a = { width: viewEnv.remToPx(1200) * Oe, height: viewEnv.remToPx(1200) };
                            return u < n.width
                                ? n
                                : t > ju.medium.width && r > ju.medium.height && u < a.width
                                  ? a
                                  : { width: u, height: e };
                        }),
                        ye((u, e) => {
                            const t = { width: viewEnv.remToPx(700) * Oe, height: viewEnv.remToPx(700) };
                        ...
                        (u, e) => {
                            const t = (function (u = 0) {
                                ...
                                a = t.minutes;
                            return r >= 1
                                ? tu(e.days(), { days: r, hours: n })
                                : n >= 1
                                  ? tu(e.hours(), { hours: n, minutes: a })
                                  : a >= 1
                                    ? tu(e.minutes(), { minutes: a })
                                    : e.lessMinute();
                        });
                var Ne;
                !(function (u) {
                    ((u.Tankmen = 'tankmen_WT2024'), (u.RentalTank = 'wt_rental_tank'));
                })(Ne || (Ne = {}));
                const ke = (u, e) =>
                ...
                const Ue = 'PerformanceWarning_title_f1',
                    He = ({ performanceRisk: u }) => {
                        const e = {
                                titleClasses: Ue,
                ...
                const We = R.strings.tooltips.WtProgressionEntryPointTooltip,
                    $e = (u) => {
                    ...
                    Xe = () => {
                        const u = b(),
                            ...
                            A = ((u) =>
                                ...
                                Array.isArray(F)
                                    ? F.map(c)
                                    : F.map((u, e, t) => c(null == u ? void 0 : u.value, e, t))),
                            );
                        var F, c;
                        return n().createElement(
                            'div',
                            { className: 'Content_base_43' },
                            n().createElement('div', { className: 'Content_heading_5b' }, We.title()),
                            o >= 0 &&
                                n().createElement(ou, {
                                    classMix: 'Content_timeLeft_64',
                                    binding: {
                                        timeLeft: n().createElement(xe, {
                                            text: Le(o, We.duration),
                            ...
                            e &&
                                n().createElement(
                                    ...
                                    n().createElement('div', { className: 'Content_completed_8a' }, We.completed()),
                                ),
                            !e &&
                                n().createElement(
                                    n().Fragment,
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(Wu, { value: r, maxValue: a, theme: ku }),
                                    ),
                                    n().createElement(
                                        'div',
                                        ...
                                        l &&
                                            n().createElement(
                                                ...
                                                A.map((u, e) =>
                                                    n().createElement(
                                                        uu,
                                                        Ge({ key: e, className: 'Content_reward_32' }, u),
                                                    ),
                                                ),
                                            ),
                                    ),
                                ),
                            E && !e && n().createElement(He, { performanceRisk: E }),
                        );
                    },
                    ze = () => n().createElement(c, null, n().createElement(Xe, null));
                engine.whenReady.then(() => {
                    i().render(n().createElement(ze, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4674));
