(() => {
    var __webpack_modules__ = {
            ...
            6943: (u, e, t) => {
                        ...
                        const b = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            R = (0, r.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (v(t, c, { isMouseEvent: !0, on: !0, arguments: f(n) }, S),
                                    g && g(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((b.current.timeoutId = window.setTimeout(R, l ? 100 : 400)),
                                                          a && a(u),
                                                          P && P(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                ...
                const z = ({ format: u, value: e }) => {
                    ...
                    Y = [I.Gold, I.Credits, I.Crystal, I.FreeXp],
                    q = [I.BattlePassPoints],
                    V = [I.PremiumPlus, I.Premium],
                    ...
                    eu = ({
                        ...
                        const c = ((u) => {
                            ...
                            D = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case G.CURRENCY:
                                    case G.NUMBER:
                                        return n().createElement(z, { format: 'integral', value: Number(u) });
                                    case G.PREMIUM_PLUS: {
                                        const e = Number(u);
                        ...
                        return n().createElement(
                            'div',
                            { className: o()(uu.base, uu[`base__${r}`], l), style: E },
                            n().createElement(
                                k,
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: o()(uu.image, null == A ? void 0 : A.image) },
                                        c &&
                                            n().createElement('div', {
                                                className: o()(uu.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            n().createElement('div', {
                                                className: o()(uu.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        _ &&
                                            n().createElement('div', {
                                                className: o()(uu.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                            ...
                            t &&
                                n().createElement(
                                    ...
                                    { tooltipArgs: m },
                                    n().createElement('div', {
                                        className: o()(uu.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const nu = (u, e, t) => {
                    ...
                    Eu = ({ binding: u, text: e = '', classMix: t, alignment: a = tu.left }) =>
                        null === e
                ...
                const hu = (0, r.memo)(
                    ...
                    Su = (0, r.memo)(
                        ({
                            ...
                            const h = (0, r.useMemo)(() => Object.assign({ width: '100%' }, vu(u), wu(F)), [F, u]),
                                b = (0, r.useMemo)(() => Object.assign({ width: '0%' }, vu(u), wu(F)), [F, u]),
                                w = (0, r.useMemo)(() => Object.assign({ width: '0%' }, fu(F, a), vu(u)), [a, F, u]),
                                f = (0, r.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(s - a)}%` }, fu(F, a), vu(u)),
                                    [a, F, s, u],
                                );
                            if (D) return null;
                            const v = o()(
                ...
                const Pu = (0, r.memo)((u) => {
                        ...
                        switch (a.animationSettings.type) {
                            case Fu.Simple:
                                return n().createElement(bu, Tu({}, a, { onEndAnimation: E, isComplete: s }));
                            case Fu.Growing:
                                return n().createElement(Ru, Tu({}, a, { onEndAnimation: E, isComplete: s }));
                            default:
                                return null;
                        }
                    }),
                ...
                const yu = (0, r.memo)((u) => {
                    ...
                    return (
                        (a.current.from = s),
                        n().createElement(Pu, Mu({}, t, { onEndAnimation: i, key: `${s}-${t.to}`, from: s }))
                    );
                });
                function Lu() {
                    return (
                ...
                const Nu = (0, r.memo)(
                        ({
                            ...
                            return i.withStack
                                ? n().createElement(yu, l)
                                : n().createElement(Pu, Lu({ key: `${a}-${e}` }, l));
                        },
                    ),
                    ku = (u) => ({
                    ...
                    Hu = (u, e, t) => ('number' == typeof t ? (Uu(0, e, t) / e) * 100 : u),
                    Gu = {
                        bgImageBase: 'R.images.gui.maps.icons.components.progress_bar.pattern_grey',
                    ...
                    $u = (0, r.memo)(
                        ({
                            ...
                            const _ = ((u, e, t) =>
                                (0, r.useMemo)(() => {
                                    const r = (Uu(0, e, u) / e) * 100;
                                    return { value: r, deltaFrom: Hu(r, e, t) };
                                }, [t, e, u]))(E, u, l);
                            return n().createElement(
                                'div',
                                { className: o()(lu.base, lu[`base__${t}`]), style: ku(e) },
                                !s && n().createElement(mu, { size: t }),
                                n().createElement(Nu, {
                                    size: t,
                                    lineRef: A,
                                    disabled: i,
                ...
                const Ku = E.O.client.getSize('rem'),
                    Qu = Ku.width,
                    Zu = Ku.height,
                    Ju = Object.assign({ width: Qu, height: Zu }, Vu(Qu, Zu, Yu)),
                    ue = (0, r.createContext)(Ju),
                    ee = ['children'],
                    te = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && l) return ju(e, t, g);
                            if (t.largeWidth && A) return ju(e, t, g);
                            if (t.mediumWidth && F) return ju(e, t, g);
                            if (t.smallWidth && m) return ju(e, t, g);
                            if (t.extraSmallWidth && c) return ju(e, t, g);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                (te.defaultProps = {
                    ...
                    (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(ue),
                            ...
                            s = (0, r.useCallback)((u, e) => {
                                ...
                                i(Object.assign({ width: t, height: r }, Vu(t, r, Yu)));
                            }, []);
                        d(() => {
                        ...
                        return n().createElement(ue.Provider, { value: o }, u);
                    }),
                    (function (u) {
                        (u[(u.ExtraSmall = Yu.extraSmall.width)] = 'ExtraSmall'),
                            (u[(u.Small = Yu.small.width)] = 'Small'),
                            (u[(u.Medium = Yu.medium.width)] = 'Medium'),
                            (u[(u.Large = Yu.large.width)] = 'Large'),
                            (u[(u.ExtraLarge = Yu.extraLarge.width)] = 'ExtraLarge');
                    })(re || (re = {})),
                    (function (u) {
                        (u[(u.ExtraSmall = Yu.extraSmall.width)] = 'ExtraSmall'),
                            (u[(u.Small = Yu.small.width)] = 'Small'),
                    ...
                    (function (u) {
                        (u[(u.ExtraSmall = Yu.extraSmall.height)] = 'ExtraSmall'),
                            (u[(u.Small = Yu.small.height)] = 'Small'),
                            (u[(u.Medium = Yu.medium.height)] = 'Medium'),
                            (u[(u.Large = Yu.large.height)] = 'Large'),
                            (u[(u.ExtraLarge = Yu.extraLarge.height)] = 'ExtraLarge');
                    })(ae || (ae = {}));
                const ie = ['xl', 'lg', 'md', 'sm', 'xs'],
                    se = (u) => u.includes('_') && ((u) => ie.includes(u))(u.split('_').at(-1)),
                    oe = [re.ExtraLarge, re.Large, re.Medium, re.Small, re.ExtraSmall],
                    Ee = (u, e) =>
                    ...
                    le = (u, e = Ee) => {
                        ...
                        return n().memo((e) =>
                            Object.keys(e).some((u) => se(u) && void 0 !== e[u])
                                ? n().createElement(t, e)
                                : n().createElement(u, e),
                        );
                    },
                ...
                const ce = {
                    ...
                    de = le((u) => {
                        ...
                        const H = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, E, A, m, _, k, N, x, C, O, v, R]),
                            G = H.computedStyle,
                            W = H.computedClassNames;
                        return n().createElement('div', me({ className: o()(Ae.base, ...W, e), style: G }, U), I);
                    });
                var Be = t(3532),
                    Ce = t.n(Be);
                const ge = {
                ...
                const be = Object.keys(Ce()),
                    ...
                    xe = le((u) => {
                        ...
                        return n().createElement(
                            ...
                            he(
                                {
                                    className: o()(ge.base, t && ge[t], h, a),
                                    style: p,
                                    mt: !0 === l ? Se[t || 'paragraph-P16'].mt : l,
                                    mr: !0 === F ? Se[t || 'paragraph-P16'].mr : F,
                                    mb: !0 === c ? Se[t || 'paragraph-P16'].mb : c,
                                    ml: !0 === D ? Se[t || 'paragraph-P16'].ml : D,
                                },
                                C,
                            ),
                            void 0 !== B ? n().createElement(Eu, he({}, B, { text: e })) : e,
                        );
                    });
                let Te;
                var Pe;
                ((Pe = Te || (Te = {})).SHORT_DATE = 'short-date'),
                    (Pe.SHORT_TIME = 'short-time'),
                    (Pe.SHORT_DATE_TIME = 'short-date-time'),
                    (Pe.FULL_DATE = 'full-date'),
                    (Pe.FULL_DATE_TIME = 'full-date-time'),
                    (Pe.MONTH = 'month'),
                    (Pe.MONTH_DATE = 'month-date'),
                    (Pe.DATE_MONTH = 'date-month'),
                    (Pe.MONTH_YEAR = 'month-year'),
                    (Pe.WEEK_DAY = 'week-day'),
                    (Pe.WEEK_DAY_TIME = 'week-day-time'),
                    (Pe.YEAR = 'year'),
                    (Pe.DATE_YEAR = 'date-year');
                Date.now();
                const Oe = 1.6,
                    Me = (u) => (e, t) =>
                    ...
                    ye =
                        (Me((u, e, t, r) => {
                            ...
                            return u < n.width
                                ? n
                                : t > Yu.medium.width && r > Yu.medium.height && u < a.width
                                  ? a
                                  : { width: u, height: e };
                        }),
                        Me((u, e) => {
                        ...
                        (u, e) => {
                            const t = (function (u = 0) {
                                ...
                                a = t.minutes;
                            return r >= 1
                                ? ru(e.days(), { days: r, hours: n })
                                : n >= 1
                                  ? ru(e.hours(), { hours: n, minutes: a })
                                  : a >= 1
                                    ? ru(e.minutes(), { minutes: a })
                                    : e.lessMinute();
                        });
                let Le;
                !(function (u) {
                ...
                const Ne = 'PerformanceWarning_title_f1',
                    ke = ({ performanceRisk: u }) => {
                        const e = {
                                titleClasses: Ne,
                ...
                const Ue = R.strings.tooltips.WtProgressionEntryPointTooltip,
                    He = () => {
                        const u = b(),
                            ...
                            A = ((u) =>
                                ...
                                Array.isArray(F)
                                    ? F.map(m)
                                    : F.map((u, e, t) => m(null == u ? void 0 : u.value, e, t))),
                            );
                        var F, m;
                        return n().createElement(
                            'div',
                            { className: 'Content_base_43' },
                            n().createElement('div', { className: 'Content_heading_5b' }, Ue.title()),
                            o >= 0 &&
                                n().createElement(Eu, {
                                    classMix: 'Content_timeLeft_64',
                                    binding: {
                                        timeLeft: n().createElement(xe, {
                                            text: ye(o, Ue.duration),
                            ...
                            e &&
                                n().createElement(
                                    ...
                                    n().createElement('div', { className: 'Content_completed_8a' }, Ue.completed()),
                                ),
                            !e &&
                                n().createElement(
                                    n().Fragment,
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement($u, { value: r, maxValue: a, theme: Iu }),
                                    ),
                                    n().createElement(
                                        'div',
                                        ...
                                        l &&
                                            n().createElement(
                                                ...
                                                A.map((u, e) =>
                                                    n().createElement(
                                                        eu,
                                                        Ie({ key: e, className: 'Content_reward_32' }, u),
                                                    ),
                                                ),
                                            ),
                                    ),
                                ),
                            E && !e && n().createElement(ke, { performanceRisk: E }),
                        );
                    },
                    Ge = () => n().createElement(m, null, n().createElement(He, null));
                engine.whenReady.then(() => {
                    i().render(n().createElement(Ge, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(6943));
