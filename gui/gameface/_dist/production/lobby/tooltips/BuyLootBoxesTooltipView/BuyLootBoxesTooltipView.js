(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, A) => {
                A.r(e), A.d(e, { mouse: () => n, onResize: () => D });
                var F = A(2472),
                    E = A(1176);
            ...
            1358: (u, e, A) => {
                ...
                class E {
                    ...
                    addCallback(u, e, A = 0, E = !0) {
                        ...
                        const D = F.O.view.addModelObserver(u, A, E);
                        return (
                            D > 0
                                ? ((this._callbacks[D] = e),
            ...
            4179: (u, e, A) => {
                ...
                function d(u, e, A, F, E, D, t) {
                    ...
                    n.done ? e(B) : Promise.resolve(B).then(F, E);
                }
                ...
                const f = E.instance,
                    b = {
                        ...
                        sendMoveEvent: (u) => w(B.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: m,
                        sendClosePopOverEvent: () => w(B.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            w(B.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
                        sendShowPopOverEvent: (u, e, A, F, E = R.invalid('resId'), D) => {
                            const t = c.O.view.getViewGlobalPosition(),
                                ...
                                o = n.height,
                                a = {
                                    x: c.O.view.pxToRem(C) + t.x,
                                    y: c.O.view.pxToRem(r) + t.y,
            ...
            503: (u, e, A) => {
                ...
                const a = E().forwardRef(function (u, e) {
                        let A = u.children,
                            D = u.className,
                            t = u.theme,
                        ...
                        return (
                            ...
                            E().createElement(
                                'div',
                                o({}, a, {
                                    className: B()(r.base, r[`base__theme-${n}`], D),
                                    ref: function (u) {
                                        (c.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                    },
                                }),
                                E().createElement('div', { className: r.decorator }, A),
                            )
                        );
                    }),
                    s = (u = 1) => {
                                ...
                                ((u) =>
                                    ((u, e) =>
                                        u.split('.').reduce((u, e) => {
                                            ...
                                            return d(A) ? ((u, e) => `${u}.${e}.value`)(u, e) : `${u}.${e}`;
                                        }))(u))(B),
                            ),
                        ),
                        r = C[0],
                    ...
                    return (
                        ((u) => {
                            ...
                            if (
                                                ...
                                                const e = s(),
                                                    ...
                                                    E =
                                                        window.__feature && window.__feature !== A && A
                                                            ? `subViews.${A}`
                                                            : '';
                                                return { modelPrefix: E, modelPath: l(E, ''), resId: F };
                                            })(),
                                            A = e.modelPrefix,
                                            F = u.split('.');
                                        if (F.length > 0) {
                                            ...
                                            return (
                                                F.reduce((e, F) => {
                                                    const E = c(l(A, `${e}.${F}`), window);
                                                    return d(E)
                                                        ? (u.push(E.id), `${e}.${F}.value`)
                                                        : (u.push(F), `${e}.${F}`);
                                                }),
                                                u.reduce((u, e) => u + '.' + e)
                                            );
                                ...
                                o.current = v.addCallback(F, A, n, e === w.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== w.None)
                                return () => {
                                    v.removeCallback(o.current, n);
                                };
                        }, [n, e]),
                        r
                    );
                ...
                const h = (u, e, A) => {
                    ...
                    b = (u, e, A = p.left) => u.split(e).reduce(A === p.left ? h : f, []),
                    g = (() => {
                        const u = new RegExp(
                    ...
                    O = ['zh_cn', 'zh_sg', 'zh_tw'],
                    P = ({ binding: u, text: e = '', classMix: A, alignment: D = p.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, t) =>
                                      E().createElement(
                                          'div',
                                          { className: B()('FormatText_base_d0', A), key: `${e}-${t}` },
                                          ((u, e, A) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  A && u in A
                                                      ? A[u]
                    ...
                    y = 'Content_description_56',
                    T = R.strings.event.WtEventBuyLootBoxesTooltipView,
                    M = () => {
                        const u = m('model'),
                            e = u.amountLeft,
                            A = u.amountMax,
                            D = (0, F.useMemo)(() => ({ amountMax: A }), [A]);
                        return E().createElement(
                            'div',
                            { className: 'Content_base_e0' },
                            E().createElement('div', { className: y }, T.description()),
                            E().createElement(
                                'div',
                                { className: 'Content_amountLeftWrapper_72' },
                                E().createElement('div', { className: 'Content_amountLeft_d8' }, e),
                                E().createElement('div', { className: y }, T.amountLeft()),
                            ),
                            E().createElement(
                                'div',
                                { className: 'Content_infoWrapper_6f' },
                                E().createElement('div', { className: 'Content_divider_2a' }),
                                E().createElement('div', { className: 'Content_icon_0b' }),
                                E().createElement(P, { binding: D, text: T.info() }),
                                E().createElement('div', { className: 'Content_dividerBottom_dc' }),
                            ),
                            E().createElement('div', { className: y }, T.additionalInfo()),
                        );
                    },
                    x = () => E().createElement(a, null, E().createElement(M, null));
                engine.whenReady.then(() => {
                    t().render(E().createElement(x, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, A, F) => {
            if (!e) {
                ...
                for (B = 0; B < deferred.length; B++) {
                    for (var [e, A, F] = deferred[B], D = !0, t = 0; t < e.length; t++)
                        (!1 & F || E >= F) &&
            ...
            F = F || 0;
            for (var B = deferred.length; B > 0 && deferred[B - 1][2] > F; B--) deferred[B] = deferred[B - 1];
            deferred[B] = [e, A, F];
        }),
        ...
        (() => {
            ...
            var e = (e, A) => {
                    var F,
                        ...
                        B = 0;
                    if (D.some((e) => 0 !== u[e])) {
                        for (F in t) __webpack_require__.o(t, F) && (__webpack_require__.m[F] = t[F]);
                        if (n) var C = n(__webpack_require__);
                    }
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(503));
