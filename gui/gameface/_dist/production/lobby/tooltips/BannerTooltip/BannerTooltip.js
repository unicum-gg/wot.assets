(() => {
    var __webpack_modules__ = {
            ...
            3565: (u, e, t) => {
                ...
                const l = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const n = (0, r.useRef)([]),
                                    B = (u, e, t) => {
                                        ...
                                        const E = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, a) => {
                                                        const n = 'string' == typeof a ? `${r}.${a}` : r,
                                                            F = D.O.view.addModelObserver(n, e, !0);
                                            ...
                                            _ = { mode: u, model: s, externalModel: a, cleanup: B };
                                        return {
                                            model: s,
                                            controls: 'mocks' === u && t ? t.controls(_) : {},
                                            externalModel: a,
                                            mode: u,
                                        };
                                    },
                                    ...
                                    C = _[0],
                                    c = _[1],
                                    m = (0, r.useState)(() => B(u, e, A)),
                                    d = m[0],
                                    h = m[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        s.current ? h(B(C, e, A)) : (s.current = !0);
                                    }, [A, C, e]),
                                    (0, r.useEffect)(() => {
                                        c(u);
                                    }, [u]),
                                    (0, r.useEffect)(
                                        () => () => {
                                            (d.externalModel.dispose(), n.current.forEach((u) => u()));
                                        },
                                        [d],
                                    ),
                                    E().createElement(t.Provider, { value: d }, a)
                                );
                            },
                            () => (0, r.useContext)(t),
                        ];
                    ...
                    C = {
                        base: 'App_base_4a',
                        textWrapper: 'App_textWrapper_15',
                        title: 'App_title_57',
                        description: 'App_description_6b',
                        durationWrapper: 'App_durationWrapper_10',
                        durationTitle: 'App_durationTitle_2f',
                        durationInfo: 'App_durationInfo_2c',
                        performanceWrapper: 'App_performanceWrapper_a6',
                        performanceTitleWrapper: 'App_performanceTitleWrapper_cf',
                        performanceIcon: 'App_performanceIcon_b5',
                        performanceIcon__low: 'App_performanceIcon__low_bf',
                        performanceIcon__reduced: 'App_performanceIcon__reduced_64',
                        performanceTitle: 'App_performanceTitle_c3',
                        performanceTitle__low: 'App_performanceTitle__low_5c',
                        performanceTitle__reduced: 'App_performanceTitle__reduced_d7',
                        reducedPerformanceWrapper: 'App_reducedPerformanceWrapper_f5',
                        reducedPerformanceTitleWrapper: 'App_reducedPerformanceTitleWrapper_99',
                        reducedPerformanceIcon: 'App_reducedPerformanceIcon_1d',
                        reducedPerformanceTitle: 'App_reducedPerformanceTitle_7e',
                        divider: 'App_divider_99',
                    };
                var c = t(6483),
                    m = t.n(c),
                    d = t(9887),
                ...
                const b = D.O.client.getSize('rem'),
                    w = b.width,
                    x = b.height,
                    S = Object.assign({ width: w, height: x }, v(w, x, p)),
                    T = (0, r.createContext)(S),
                    M = ['children'],
                    L = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        const E = (0, r.useContext)(T),
                            ...
                            h = { extraLarge: _, large: C, medium: c, small: m, extraSmall: d };
                ...
                ((0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(T),
                        ...
                        n = (0, r.useCallback)((u, e) => {
                            ...
                            A(Object.assign({ width: t, height: r }, v(t, r, p)));
                        }, []);
                    (((u) => {
                    ...
                    return E().createElement(T.Provider, { value: F }, u);
                }),
                    (function (u) {
                ...
                const X = {
                    ...
                    V = I((u) => {
                        ...
                        const I = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, F, D, l, s, H, N, T, d, O, w, S]),
                            V = I.computedStyle,
                            q = I.computedClassNames;
                        return E().createElement('div', j({ className: m()(U.base, ...q, e), style: V }, W), k);
                    });
                let q;
                !(function (u) {
                ...
                const Y = (u, e, t) => {
                    ...
                    J = ['zh_cn', 'zh_sg', 'zh_tw'],
                    uu = ({ binding: u, text: e = '', classMix: t, alignment: a = q.left }) =>
                        null === e
                ...
                const Au = Object.keys(tu()),
                    ...
                    lu = I((u) => {
                        ...
                        return E().createElement(
                            ...
                            au(
                                {
                                    className: m()(ru.base, t && ru[t], p, a),
                                    style: g,
                            ...
                            void 0 !== c ? E().createElement(uu, au({}, c, { text: e })) : e,
                        );
                    });
                let Bu;
                var su;
                let _u;
                (((su = Bu || (Bu = {})).SHORT_DATE = 'short-date'),
                    (su.SHORT_TIME = 'short-time'),
                    (su.SHORT_DATE_TIME = 'short-date-time'),
                    (su.FULL_DATE = 'full-date'),
                    (su.FULL_DATE_TIME = 'full-date-time'),
                    (su.MONTH = 'month'),
                    (su.MONTH_DATE = 'month-date'),
                    (su.DATE_MONTH = 'date-month'),
                    (su.MONTH_YEAR = 'month-year'),
                    (su.WEEK_DAY = 'week-day'),
                    (su.WEEK_DAY_TIME = 'week-day-time'),
                    (su.YEAR = 'year'),
                    (su.DATE_YEAR = 'date-year'),
                    t(4179),
                    Date.now(),
                    (function (u) {
                        ((u[(u.Low = 0)] = 'Low'), (u[(u.Reduced = 1)] = 'Reduced'), (u[(u.Normal = 2)] = 'Normal'));
                    })(_u || (_u = {})));
                const Cu = { 0: 'low', 1: 'reduced', 2: 'normal' },
                    cu = {
                        low: {
                            title: R.strings.portal_banner_tooltip.banner.tooltip.lowPerformanceTitle(),
                            description: R.strings.portal_banner_tooltip.banner.tooltip.lowPerformanceDescription(),
                        },
                        reduced: {
                            title: R.strings.portal_banner_tooltip.banner.tooltip.reducedPerformanceTitle(),
                            description: R.strings.portal_banner_tooltip.banner.tooltip.reducedPerformanceDescription(),
                        },
                    },
                    mu = (0, n.observer)(() => {
                        const u = _().model.root.get(),
                            e = u.performance,
                            t = u.startDate,
                            r = u.endDate,
                            a = Cu[e],
                            ...
                            n = new Date(1e3 * r),
                            F =
                                ((i = R.strings.portal_banner_tooltip.banner.tooltip.eventDurationInfo()),
                                (D = {
                                    dateStart: `${A.getDate()} ${R.strings.menu.dateTime.months.$num(A.getMonth() + 1)}`,
                                    dateEnd: `${n.getDate()} ${R.strings.menu.dateTime.months.$num(n.getMonth() + 1)} ${n.getFullYear()}`,
                                }),
                                i.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                        ...
                        var i, D;
                        const o = m()(C.performanceIcon, C[`performanceIcon__${a}`]),
                            l = m()(C.performanceTitle, C[`performanceTitle__${a}`]);
                        return E().createElement(
                            'div',
                            { className: C.base },
                            E().createElement(
                                ...
                                E().createElement(lu, {
                                    text: R.strings.portal_banner_tooltip.banner.tooltip.title(),
                                    className: C.title,
                                }),
                                E().createElement(lu, {
                                    text: R.strings.portal_banner_tooltip.banner.tooltip.description(),
                                    className: C.description,
                                }),
                                e !== _u.Normal &&
                                    E().createElement(
                                        'div',
                                        { className: C.performanceWrapper },
                                        E().createElement(
                                            'div',
                                            { className: C.performanceTitleWrapper },
                                            E().createElement('div', { className: o }),
                                            E().createElement(lu, { text: cu[a].title, className: l }),
                                        ),
                                        E().createElement(lu, { text: cu[a].description, className: C.description }),
                                    ),
                                E().createElement('div', { className: C.divider }),
                                E().createElement(
                                    'div',
                                    { className: C.durationWrapper },
                                    E().createElement(lu, {
                                        text: R.strings.portal_banner_tooltip.banner.tooltip.eventDurationTitle(),
                                        className: C.durationTitle,
                                    }),
                                    E().createElement(lu, { text: F, className: C.durationInfo }),
                                ),
                            ),
                        );
                    });
                ...
                const pu = E().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        E().createElement(
                            'div',
                            gu({}, F, {
                                className: m()(du.base, du[`base__theme-${n}`], a),
                                ref: function (u) {
                ...
                engine.whenReady.then(() => {
                    A().render(
                        E().createElement(s, null, E().createElement(pu, null, E().createElement(mu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(3565));
