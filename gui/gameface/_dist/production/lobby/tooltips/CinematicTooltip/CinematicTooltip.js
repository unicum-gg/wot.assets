        ...
        e = {
            ...
            2760: (u, e, t) => {
                ...
                const uu = a().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            J({}, r, {
                                className: C()(Q.base, Q[`base__theme-${E}`], A),
                                ref: function (u) {
                                    ...
                                    n = (u, t, A) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            B = (({ observableModel: u }) => {
                                                const e = {
                                                    root: u.object(),
                                                    params: u.primitives(['isOutroTooltip', 'isProgressionCompleted']),
                                                };
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const A = null != t ? t : a(e),
                                                            F = tu.observable.box(A, { equals: eu });
                                                        return (
                                                            'real' === u &&
                                                                D.subscribe(
                                                                    (0, tu.action)((u) => F.set(u)),
                                                                    e,
                                                                ),
                                                            F
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const F = e.reduce(
                                                                (u, e) => ((u[e] = tu.observable.box(A[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                ...
                const mu = q.client.getSize('rem'),
                    su = mu.width,
                    du = mu.height,
                    cu = Object.assign({ width: su, height: du }, ou(su, du, Cu)),
                    gu = (0, D.createContext)(cu),
                    _u = ['children'],
                    hu = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && B) return iu(e, t, _);
                            if (t.largeWidth && i) return iu(e, t, _);
                ...
                ((0, D.memo)(({ children: u }) => {
                    const e = (0, D.useContext)(gu),
                        ...
                        E = (0, D.useCallback)((u, e) => {
                            const t = q.view.pxToRem(u),
                                A = q.view.pxToRem(e);
                            F(Object.assign({ width: t, height: A }, ou(t, A, Cu)));
                        }, []);
                    (((u) => {
                    ...
                    return a().createElement(gu.Provider, { value: r }, u);
                }),
                    (function (u) {
                ...
                const Tu = {
                    ...
                    Pu = Lu((u) => {
                        ...
                        return a().createElement('div', Ru({ className: C()(Mu.base, ...I, e), style: X }, G), N);
                    });
                let Wu;
                !(function (u) {
                ...
                const Yu = Object.keys(Vu()),
                    ...
                    ee = Lu((u) => {
                        ...
                        return a().createElement(
                            ...
                            void 0 !== c ? a().createElement(ku, Ku({}, c, { text: e })) : e,
                        );
                    }),
                    te = R.strings.tooltips.cinematicTooltip,
                    Ae = (0, au.observer)(() => {
                        const u = Du().model.params,
                            e = u.isOutroTooltip.get(),
                            t = u.isProgressionCompleted.get(),
                            A = C()('App_base_0c', e && 'App_base__outro_60', !t && e && 'App_base__locked_7a');
                        return a().createElement(
                            'div',
                            { className: A },
                            a().createElement(ee, {
                                text: e ? te.title_outro() : te.title(),
                                className: 'App_title_69',
                            }),
                            a().createElement(ee, {
                                text: e ? te.subTitle_outro() : te.subTitle(),
                                className: 'App_subTitle_92',
                            }),
                            a().createElement('div', { className: 'App_bg_a4' }),
                            t || !e
                                ? a().createElement(ee, {
                                      text: e ? te.description_outro() : te.description(),
                                      className: 'App_description_fc',
                                  })
                                : a().createElement(
                                      'div',
                                      { className: 'App_notAvailable_a3' },
                                      a().createElement('div', { className: 'App_lockIcon_bc' }),
                                      a().createElement(ee, { text: te.locked(), className: 'App_lockedDesc_a4' }),
                                  ),
                        );
                    });
                engine.whenReady.then(() => {
                    B().render(
                        a().createElement(ru, null, a().createElement(uu, null, a().createElement(Ae, null))),
