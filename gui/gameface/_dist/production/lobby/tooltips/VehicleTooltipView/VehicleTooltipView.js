    ...
    var u,
        A = {
            777: (u, A, F) => {
                var E = {};
                F.r(E),
                    F.d(E, { mouse: () => m, off: () => v, on: () => d, onResize: () => l, onScaleUpdated: () => c });
                var e = {};
                F.r(e),
                    F.d(e, {
                        events: () => E,
                ...
                const Fu = (() => {
                    ...
                    Eu = Object.keys(T).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === T[A]), u), {}),
                    eu = {
                        set: (u, A) => {
                ...
                const ru = C().forwardRef(function (u, A) {
                    ...
                    return (
                        ...
                        C().createElement(
                            ...
                            C().createElement('div', { className: tu.decorator }, F),
                        )
                    );
                });
                var ou = F(1281);
                ...
                const au = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    cu = (u, A, F = iu.left) => u.split(A).reduce(F === iu.left ? su : lu, []),
                    du = (() => {
                        const u = new RegExp(
                    ...
                    fu = ({ binding: u, text: A = '', classMix: F, alignment: E = iu.left, formatWithBrackets: e }) => {
                ...
                const wu = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: e, mocks: D }) {
                                ...
                                return (
                                    ...
                                    C().createElement(F.Provider, { value: l }, e)
                                );
                            },
                            () => (0, t.useContext)(F),
                        ];
                    ...
                    Pu = {
                        ...
                        shamrockBlock: 'Content_shamrockBlock_98',
                        shamrockIcon: 'Content_shamrockIcon_b5',
                    ...
                    Ru = (0, gu.Pi)(() => {
                        const u = _u().model.get(),
                            A = u.vehicleName,
                            F = u.vehicleNation,
                            E = u.statusLevel,
                            e = u.statusText,
                            D = u.hasSTPDailyFactor;
                        return C().createElement(
                            'div',
                            { className: Pu.base },
                            C().createElement('div', {
                                className: Pu.flag,
                                style: { backgroundImage: `url('${mu(R.images.gui.maps.icons.flags.c_160x100, F)}')` },
                            }),
                            C().createElement('div', { className: Pu.title }, A),
                            C().createElement(
                                'div',
                            ...
                            D &&
                                C().createElement(
                                    'div',
                                    { className: Pu.shamrockBlock },
                                    C().createElement(fu, {
                                        text: R.strings.tooltips.battle_royale.hangar.vehicle.shamrock(),
                                        binding: { shamrock: C().createElement('div', { className: Pu.shamrockIcon }) },
                                    }),
                                ),
                            C().createElement(
                                'div',
                                { className: Pu.description },
                                mu(R.strings.tooltips.battle_royale.hangar.vehicle.description, F),
                            ),
                            C().createElement('div', { className: i()(Pu.status, Pu && Pu[`status__${E}`]) }, e),
                        );
                    }),
                    Su = () => C().createElement(ru, null, C().createElement(Ru, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(xu, null, C().createElement(Su, null)),
