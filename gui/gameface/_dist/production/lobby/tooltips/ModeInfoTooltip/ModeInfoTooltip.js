        ...
        n = {
            119: (e, n, t) => {
                ...
                const ee = u().forwardRef(function (e, n) {
                    ...
                    ne = 'App_description_91',
                    te = R.strings.winback.modeInfoTooltip,
                    re = () =>
                        u().createElement(
                            ee,
                            null,
                            u().createElement(
                                'div',
                                { className: 'App_base_25' },
                                u().createElement('div', { className: 'App_title_f7' }, te.title()),
                                u().createElement(
                                    'div',
                                    { className: v()(ne, 'App_description__indent_30') },
                                    te.description(),
                                ),
                                u().createElement('div', { className: 'App_subtitle_c0' }, te.subtitle()),
                                u().createElement('div', { className: ne }, te.maps()),
                            ),
                        );
                engine.whenReady.then(() => {
                    l().render(u().createElement(re, null), document.getElementById('root'));
                });
            },
        },
        t = {};
