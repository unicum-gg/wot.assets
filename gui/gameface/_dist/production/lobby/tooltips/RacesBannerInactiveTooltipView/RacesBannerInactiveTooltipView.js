        ...
        e = {
            ...
            2839: (u, e, A) => {
                ...
                const ju = Object.keys(Wu()),
                    ...
                    $u = R.strings.races.banner.tooltips.disabled,
                    Yu = () =>
                        $().createElement(
                            'div',
                            { className: 'App_base_fd' },
                            $().createElement(Ku, { text: $u.header(), className: 'App_header_e5' }),
                            $().createElement(Ku, { text: $u.body(), className: 'App_body_e7' }),
                            $().createElement('div', { className: 'App_separator_56' }),
                            $().createElement(
                                'div',
                                { className: 'App_warningWrapper_1f' },
                                $().createElement('div', { className: 'App_warningIcon_03' }),
                                $().createElement(Ku, { text: $u.caption(), className: 'App_warning_fc' }),
                            ),
                        );
