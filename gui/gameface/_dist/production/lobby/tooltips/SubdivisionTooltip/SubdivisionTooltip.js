    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                ...
                function c(u, e, t, r, a, E, i) {
                    ...
                    A.done ? e(n) : Promise.resolve(n).then(r, a);
                }
                ...
                const v = a.instance,
                    b = {
                        ...
                        sendShowContextMenuEvent: (u, e, t = 0) => {
                            h(n.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                        },
            ...
            786: (u, e, t) => {
                ...
                const D = (u, e, t) => {
                    ...
                    l = (u, e, t = F.left) => u.split(e).reduce(t === F.left ? D : o, []),
                    _ = (() => {
                        const u = new RegExp(
                    ...
                    return (
                        g(() => {
                            if (
                                                ...
                                                const e = d(),
                                                    ...
                                                    a =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: a, modelPath: x(a, ''), resId: r };
                                            })(),
                                            t = e.modelPrefix,
                                            r = u.split('.');
                                        if (r.length > 0) {
                                ...
                                l.current = v.addCallback(r, t, A, e === b.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (e !== b.None)
                                return () => {
                                    v.removeCallback(l.current, A);
                                };
                        }, [A, e]),
                        D
                    );
                ...
                const L = a().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            S({}, F, {
                                className: n()(f.base, f[`base__theme-${A}`], E),
                                ref: function (u) {
                ...
                const H = m.O.client.getSize('rem'),
                    W = H.width,
                    I = H.height,
                    G = Object.assign({ width: W, height: I }, k(W, I, P)),
                    ...
                    X = (u) => {
                        ...
                        const a = (0, r.useContext)(U),
                            ...
                            h = { extraLarge: B, large: C, medium: c, small: m, extraSmall: d };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.smallWidth && _) return y(e, t, h);
                            if (t.extraSmallWidth && s) return y(e, t, h);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                    ...
                    (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(U),
                            ...
                            A = (0, r.useCallback)((u, e) => {
                                ...
                                i(Object.assign({ width: t, height: r }, k(t, r, P)));
                            }, []);
                        (g(() => {
                            engine.on('clientResized', A);
                        }),
                            (0, r.useEffect)(() => () => engine.off('clientResized', A), [A]));
                        const n = (0, r.useMemo)(() => Object.assign({}, E), [E]);
                        return a().createElement(U.Provider, { value: n }, u);
                    }),
                    (function (u) {
                ...
                const tu = {
                    ...
                    Eu = Q((u) => {
                        let e = u.className,
                            ...
                            w =
                                void 0 === b
                                    ...
                                    : b,
                            f = u.alignItems,
                            T = void 0 === f ? (h ? 'flex-start' : g && 'center') || (p && 'flex-end') || void 0 : f,
                            S = u.alignSelf,
                            L = u.wrap,
                            M = u.flexWrap,
                        ...
                        const I = (0, r.useMemo)(() => {
                            ...
                            }, [t, E, F, o, _, B, k, N, S, d, O, w, T]),
                            G = I.computedStyle,
                            U = I.computedClassNames;
                        return a().createElement('div', eu({ className: n()(J.base, ...U, e), style: G }, W), H);
                    }),
                    iu = ({ binding: u, text: e = '', classMix: t, alignment: E = F.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, i) =>
                                      a().createElement(
                                          'div',
                                          { className: n()('FormatText_base_d0', t), key: `${e}-${i}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                ...
                const lu = Object.keys(nu()),
                    ...
                    mu = Q((u) => {
                        ...
                        return a().createElement(
                            ...
                            ou(
                                {
                                    className: n()(Fu.base, t && Fu[t], p, E),
                                    style: g,
                                    mt: !0 === D ? Cu[t || 'paragraph-P16'].mt : D,
                                    mr: !0 === l ? Cu[t || 'paragraph-P16'].mr : l,
                                    mb: !0 === s ? Cu[t || 'paragraph-P16'].mb : s,
                                    ml: !0 === C ? Cu[t || 'paragraph-P16'].ml : C,
                                },
                                d,
                            ),
                            void 0 !== m ? a().createElement(iu, ou({}, m, { text: e })) : e,
                        );
                    }),
                    du = {
                    ...
                    xu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((n = n.replace(t, `%(${A})`)),
                                    (i[A] = du[u]
                                        ? a().createElement(
                                              'span',
                                              { className: du[u] },
                                              a().createElement(iu, { text: o, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: E(u) },
                        ...
                        return a().createElement(iu, { text: n, classMix: t, binding: i });
                    }),
                ...
                const Lu = (0, r.memo)(({ level: u, size: e, isYellow: t, isLocked: r = !1, mixClass: E }) => {
                        const i = n()(Tu.base, t && Tu.base__yellow, Tu[`base__${e}`], E);
                        return a().createElement(
                            'div',
                            { className: i },
                            ...
                            a().createElement(mu, { text: fu(u), className: Tu.text }),
                        );
                    }),
                    Mu = {
                ...
                const yu = (0, r.memo)(({ type: u, color: e, classMix: t, size: E = Ou.C24x24 }) => {
                        const i = n()(Mu.base, Mu[`base__${E}`], t),
                            A = (0, r.useMemo)(() => {
                                return {
                        ...
                        return a().createElement('div', { className: i, style: A });
                    }),
                    Pu = {
                        base: 'SubdivisionTooltipApp_base_61',
                        content: 'SubdivisionTooltipApp_content_5c',
                        header: 'SubdivisionTooltipApp_header_c0',
                        header_icons: 'SubdivisionTooltipApp_header_icons_30',
                        header_text: 'SubdivisionTooltipApp_header_text_8d',
                        title: 'SubdivisionTooltipApp_title_20',
                        description: 'SubdivisionTooltipApp_description_7a',
                        level_icon: 'SubdivisionTooltipApp_level_icon_3d',
                        tank: 'SubdivisionTooltipApp_tank_f5',
                        tank_divider: 'SubdivisionTooltipApp_tank_divider_2e',
                        tank_content: 'SubdivisionTooltipApp_tank_content_4d',
                        tank_icon: 'SubdivisionTooltipApp_tank_icon_b1',
                        tank_name: 'SubdivisionTooltipApp_tank_name_0b',
                        vehicles_title: 'SubdivisionTooltipApp_vehicles_title_44',
                        vehicle_type: 'SubdivisionTooltipApp_vehicle_type_c9',
                        iconExp: 'SubdivisionTooltipApp_iconExp_3f',
                        level: 'SubdivisionTooltipApp_level_08',
                        experience: 'SubdivisionTooltipApp_experience_35',
                        level__max: 'SubdivisionTooltipApp_level__max_f3',
                    },
                    Nu = R.strings.hb_lobby,
                    ku = () => {
                        const u = w('model', b.None),
                            e = u.subdivisionID,
                            t = u.experience,
                            E = u.maxExperience,
                            i = u.level,
                            ...
                            F = u.frontName,
                            D = 3 === i,
                            o = n()(Pu.base, Pu.content),
                            l = (0, r.useMemo)(
                                () => ({
                                    backgroundImage: `url('${R.images.historical_battles.gui.maps.icons.division.c_80x80.$num(e)}')`,
                                }),
                                [e],
                            ),
                            _ = (0, r.useMemo)(
                                () => Nu.$dyn(`division_${e}`).$dyn('subdivisionTooltip').$dyn('description'),
                                [e],
                            );
                        return a().createElement(
                            L,
                            ...
                            a().createElement(
                                'div',
                                {
                                    className: o,
                                    style: (() => {
                                        const u = R.images.historical_battles.gui.maps.icons.hangar.subdivisionTooltip,
                                            e = `${F}_background`;
                                        return { backgroundImage: `url(${u.$dyn(e)})` };
                                    })(),
                                },
                                a().createElement(
                                    'div',
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: Pu.header_icons, style: l },
                                        a().createElement(Lu, { level: i, size: Su.Tiny, mixClass: Pu.level_icon }),
                                    ),
                                    a().createElement(
                                        'div',
                                        { className: Pu.header_text },
                                        a().createElement(mu, {
                                            text: Nu.$dyn(`division_capitalAll_${e}`).$dyn('name'),
                                            className: Pu.title,
                                        }),
                                        a().createElement(xu, {
                                            text: Nu.subdivisionTooltip.currentLevel(),
                                            binding: { level: fu(i) },
                                            classMix: Pu.level,
                                        }),
                                        D
                                            ? a().createElement(mu, {
                                                  text: Nu.subdivisionTooltip.isMaxLevel(),
                                                  className: n()(Pu.experience, Pu.level__max),
                                              })
                                            : a().createElement(xu, {
                                                  text: Nu.subdivisionTooltip.currentExperience(),
                                                  binding: {
                                                      exp: t,
                                                      toExp: E,
                                                      icon: a().createElement('div', { className: Pu.iconExp }),
                                                  },
                                                  classMix: Pu.experience,
                                              }),
                                    ),
                                ),
                                a().createElement(
                                    'div',
                                    { className: Pu.desciption },
                                    a().createElement(mu, { text: _, className: Pu.description }),
                                ),
                                a().createElement(mu, {
                                    text: Nu.subdivisionTooltip.vehicles(),
                                    className: Pu.vehicles_title,
                                }),
                                Array.from(A).map((u) =>
                                    a().createElement(
                                        'div',
                                        { key: u.id, className: Pu.tank },
                                        a().createElement('div', { className: Pu.tank_divider }),
                                        a().createElement(
                                            'div',
                                            { className: Pu.tank_content },
                                            a().createElement('div', {
                                                className: Pu.tank_icon,
                                                style: { backgroundImage: `url(${u.value.icon})` },
                                            }),
                                            a().createElement(yu, {
                                                classMix: Pu.vehicle_type,
                                                color: Ru.Silver,
                                                type: u.value.vehicleType,
                                                size: Ou.C24x24,
                                            }),
                                            a().createElement(mu, { text: u.value.name, className: Pu.tank_name }),
                                        ),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    i().render(a().createElement(ku, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, t, r) => {
            if (!e) {
                ...
                for (n = 0; n < deferred.length; n++) {
                    for (var [e, t, r] = deferred[n], E = !0, i = 0; i < e.length; i++)
                        (!1 & r || a >= r) &&
