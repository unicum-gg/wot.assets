(() => {
    ...
    var __webpack_modules__ = {
            ...
            6901: (u, e, t) => {
                ...
                const l = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            c({}, l, {
                                className: a()(F.base, F[`base__theme-${E}`], o),
                                ref: function (u) {
                        ...
                        return (
                            ((u) => {
                                ...
                                if (
                                    ...
                                    c.current = w.addCallback(n, t, E, e === v.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== v.None)
                                    return () => {
                                        w.removeCallback(c.current, E);
                                    };
                            }, [E, e]),
                            F
                        );
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((v.current.timeoutId = window.setTimeout(T, F ? 100 : 400)),
                                                          o && o(u),
                                                          P && P(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                            ...
                            M(
                                {
                                    contentId:
                                        ...
                                        s ? N.SimpleTooltipHtmlContent('resId') : N.SimpleTooltipContent('resId')),
                ...
                const I = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return o || E
                        ? r().createElement(T, S({}, e, { contentId: o || E }), n)
                ...
                const K = { [H.NBSP]: W.NoBreakSymbol, [H.ZWNBSP]: W.NoBreakSymbol, [H.NEW_LINE]: W.LineBreak },
                    q = {
                    ...
                    Y = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? q[n]
                                ...
                                : r().createElement('span', { key: t, 'data-block-type': e.blockType, style: z(n) }, u)
                            ...
                            Z(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof o || 'number' == typeof o
                                        ? n.push(...Q(String(o), t))
                                        : n.push({ blockType: W.Binding, colorTag: t, childList: [o] });
                                },
                            ),
                            n
                        );
                    ...
                    ou = (u, e, t, n, o, i) => {
                        ...
                        for (let A = t; A >= 0; A--) {
                            ...
                            if (F === W.LineBreak || F === W.NewLine || F === W.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const l = s.slice(0, s.length - c) + i,
                                    D = e[A];
                                ((a = r().cloneElement(D, D.props, l)), (E = A));
                                break;
                            }
                            {
                                const u = t.children,
                                ...
                                if (!(D < 0)) {
                                    const u = c.slice(0, D);
                                    ((a = r().cloneElement(F, F.props, u, d)), (E = A));
                                    break;
                                }
                                o -= s.length;
                            }
                    ...
                    iu = r().memo(
                        ({
                            ...
                            const l = (0, n.useRef)(null),
                                ...
                                m = (0, n.useMemo)(() => ({ justifyContent: F, alignContent: s }), [s, F]);
                            return (
                                ((u, e, t = !0) => {
                    ...
                    Eu = 'NotProfiledVehicleView_subText_2b',
                    au = () => {
                        const u = f(),
                            e = u.roleName,
                            t = u.roleAbilityName,
                            ...
                            E = (0, n.useMemo)(
                                () => ({
                                    vehicle: r().createElement('div', { className: Eu }, o),
                                    roleName: r().createElement('div', { className: Eu }, t),
                                    name: r().createElement(
                                        'div',
                                        { className: Eu },
                                        R.strings.hb_lobby.$dyn(`frontman_${i}`).name(),
                                    ),
                                }),
                                [i, t, o],
                            );
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: 'NotProfiledVehicleView_base_04' },
                                r().createElement(
                                    'div',
                                    { className: 'NotProfiledVehicleView_header_a8' },
                                    R.strings.hb_lobby.hangar.tooltip.noProfiled.$dyn(e),
                                ),
                                r().createElement(
                                    'div',
                                    { className: 'NotProfiledVehicleView_body_f9' },
                                    r().createElement(iu, {
                                        text: R.strings.hb_lobby.hangar.tooltip.noProfiled.body(),
                                        binding: E,
                                    }),
                                ),
                            ),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(6901));
