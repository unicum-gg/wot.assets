(() => {
    ...
    var __webpack_modules__ = {
            5067: (u, e, t) => {
                ...
                var o = {};
                (t.r(o), t.d(o, { getBgUrl: () => d, getTextureUrl: () => B }));
                var i = {};
                function F(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const E = F('clientResized'),
                    a = { down: F('mousedown'), up: F('mouseup'), move: F('mousemove') },
                    s = (function () {
            ...
            2197: (u, e, t) => {
                ...
                const l = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            c({}, l, {
                                className: A()(a.base, a[`base__theme-${F}`], o),
                                ref: function (u) {
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (C(t, D, { isMouseEvent: !0, on: !0, arguments: d(r) }, g),
                                    m && m(),
                ...
                const b = R.views.common.tooltip_window.simple_tooltip_content,
                    f = (u) => {
                        ...
                        const a = (0, n.useMemo)(() => {
                            const u = Object.assign({}, A, { body: t, header: o, note: i, alert: F });
                ...
                const y = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const o = e.contentId,
                        i = e.args,
                        F = null == i ? void 0 : i.contentId;
                    return o || F
                        ? r().createElement(_, g({}, e, { contentId: o || F }), n)
                ...
                const P = { [M.NBSP]: L.NoBreakSymbol, [M.ZWNBSP]: L.NoBreakSymbol, [M.NEW_LINE]: L.LineBreak },
                    N = {
                    ...
                    j = (u, e = '') => {
                        ...
                        return (
                            V(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: L.Word, colorTag: e, childList: H(u) });
                                },
                                (u) => {
                                    const n = u[0],
                                        r = P[n.charAt(0)];
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const l = s.slice(0, s.length - c) + i,
                                    D = e[E];
                                ((A = r().cloneElement(D, D.props, l)), (F = E));
                                break;
                            }
                            {
                                const u = t.children,
                                ...
                                if (!(D < 0)) {
                                    const u = c.slice(0, D);
                                    ((A = r().cloneElement(a, a.props, u, B)), (F = E));
                                    break;
                                }
                                o -= s.length;
                            }
                    ...
                    $ = r().memo(
                        ({
                            ...
                            const l = (0, n.useRef)(null),
                                ...
                                v = (0, n.useMemo)(() => ({ justifyContent: a, alignContent: s }), [s, a]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                r().createElement(
                                    'div',
                                    {
                                        className: A()(
                                            ...
                                            F && 'ExtendedText_base__isTruncationAvailable_5b',
                                        ),
                                        style: v,
                                    },
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: A()(
                                                    ...
                                                    !d.isTruncateFinished && F && 'ExtendedText_truncated__hide_31',
                                                ),
                                                style: v,
                                            },
                    ...
                    Q = 'GeneralHbCoinTooltipApp_divider_7f',
                    J = 'GeneralHbCoinTooltipApp_text_90',
                    uu = (0, n.memo)(() => {
                        const u = (0, n.useMemo)(
                                () => ({
                                    orderIcon: r().createElement('div', {
                                        className: 'GeneralHbCoinTooltipApp_orderIcon_3e',
                                    }),
                                }),
                                [],
                            ),
                            e = A()(Q, 'GeneralHbCoinTooltipApp_divider__bottom_35');
                        return r().createElement(
                            l,
                            null,
                            r().createElement(
                                'div',
                                { className: 'GeneralHbCoinTooltipApp_base_46' },
                                r().createElement(
                                    'div',
                                    { className: 'GeneralHbCoinTooltipApp_content_c1' },
                                    r().createElement(
                                        'div',
                                        { className: 'GeneralHbCoinTooltipApp_header_93' },
                                        R.strings.hb_lobby.generalHbCoinTooltip.header(),
                                    ),
                                    r().createElement('div', { className: Q }),
                                    r().createElement($, {
                                        text: R.strings.hb_lobby.generalHbCoinTooltip.description(),
                                        classMix: J,
                                    }),
                                    r().createElement('div', { className: e }),
                                    r().createElement(
                                        'div',
                                        { className: 'GeneralHbCoinTooltipApp_subheader_f9' },
                                        r().createElement($, {
                                            text: R.strings.hb_lobby.generalHbCoinTooltip.subheader(),
                                        }),
                                    ),
                                    r().createElement($, {
                                        text: R.strings.hb_lobby.generalHbCoinTooltip.info(),
                                        binding: u,
                                        classMix: J,
                                    }),
                                ),
                ...
                engine.whenReady.then(() => {
                    i().render(r().createElement(uu, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(2197));
