(() => {
    var __webpack_modules__ = {
            ...
            4695: (u, e, t) => {
                ...
                const D = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            s({}, D, {
                                className: o()(F.base, F[`base__theme-${E}`], i),
                                ref: function (u) {
                ...
                const h = A.O.client.getSize('rem'),
                    g = h.width,
                    p = h.height,
                    f = Object.assign({ width: g, height: p }, C(g, p, _)),
                    ...
                    v = (u) => {
                        ...
                        const n = (0, r.useContext)(w),
                            ...
                            g = { extraLarge: d, large: _, medium: m, small: C, extraSmall: h };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.largeWidth && l) return B(e, t, g);
                            if (t.mediumWidth && s) return B(e, t, g);
                            if (t.smallWidth && D) return B(e, t, g);
                            if (t.extraSmallWidth && c) return B(e, t, g);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(w),
                        ...
                        E = (0, r.useCallback)((u, e) => {
                            ...
                            a(Object.assign({ width: t, height: r }, C(t, r, _)));
                        }, []);
                    x(() => {
                ...
                const I = {
                    ...
                    j = N((u) => {
                        let e = u.className,
                            ...
                            _ = u.row,
                            m = u.flexDirection,
                            C = void 0 === m ? (B ? 'column' : _ && 'row') || void 0 : m,
                            h = u.flexStart,
                            g = u.center,
                            p = u.flexEnd,
                            f = u.spaceBetween,
                            ...
                            k = u.shrink,
                            R = u.flex,
                            N = void 0 === R ? (M || k ? `${M ? 1 : 0} ${k ? 1 : 0} auto` : void 0) : R,
                            j = u.style,
                            V = u.children,
                            X = (function (u, e) {
                                if (null == u) return {};
                ...
                const X = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    $ = ['zh_cn', 'zh_sg', 'zh_tw'],
                    Z = ({ binding: u, text: e = '', classMix: t, alignment: i = V.left }) =>
                        null === e
                            ...
                            : n().createElement(
                                  ...
                                  e.split('\n').map((e, a) =>
                                      n().createElement(
                                          'div',
                                          { className: o()('FormatText_base_d0', t), key: `${e}-${a}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                ...
                const ru = Object.keys(J()),
                    ...
                    Au = N((u) => {
                        ...
                        return n().createElement(
                            ...
                            tu(
                                {
                                    className: o()(uu.base, t && uu[t], p, i),
                                    style: g,
                            ...
                            void 0 !== m ? n().createElement(Z, tu({}, m, { text: e })) : e,
                        );
                    });
                let Fu;
                var lu;
                ((lu = Fu || (Fu = {})).SHORT_DATE = 'short-date'),
                    (lu.SHORT_TIME = 'short-time'),
                    (lu.SHORT_DATE_TIME = 'short-date-time'),
                    (lu.FULL_DATE = 'full-date'),
                    (lu.FULL_DATE_TIME = 'full-date-time'),
                    (lu.MONTH = 'month'),
                    (lu.MONTH_DATE = 'month-date'),
                    (lu.DATE_MONTH = 'date-month'),
                    (lu.MONTH_YEAR = 'month-year'),
                    (lu.WEEK_DAY = 'week-day'),
                    (lu.WEEK_DAY_TIME = 'week-day-time'),
                    (lu.YEAR = 'year'),
                    (lu.DATE_YEAR = 'date-year');
                var su = t(4179);
                Date.now();
                const Du = (u = 1) => {
                            ...
                            A = (0, r.useState)(() =>
                                ((u) => {
                                    ...
                                    ((u) =>
                                        ((u, e) =>
                                            u.split('.').reduce((u, e) => {
                                                const t = cu(`${u}.${e}`, window);
                                                return du(t) ? ((u, e) => `${u}.${e}.value`)(u, e) : `${u}.${e}`;
                                            }))(u))(o),
                                ),
                            ),
                            F = A[0],
                        ...
                        return (
                            x(() => {
                                if (
                                                    ...
                                                    const e = Du(),
                                                        ...
                                                        n =
                                                            window.__feature && window.__feature !== t && t
                                                                ? `subViews.${t}`
                                                                : '';
                                                    return { modelPrefix: n, modelPath: Bu(n, ''), resId: r };
                                                })(),
                                                t = e.modelPrefix,
                                                r = u.split('.');
                                            if (r.length > 0) {
                                    ...
                                    s.current = _u.addCallback(r, t, E, e === mu.Deep);
                                }
                            }),
                            (0, r.useEffect)(() => {
                                if (e !== mu.None)
                                    return () => {
                                        _u.removeCallback(s.current, E);
                                    };
                            }, [E, e]),
                            F
                        );
                ...
                const pu = (u, e, t = {}, r = 0) => {
                    ...
                    fu = (u) => {
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            f = (0, r.useMemo)(() => m || Du().resId, [m]),
                            w = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (pu(t, c, { isMouseEvent: !0, on: !0, arguments: gu(n) }, f),
                                    C && C(),
                                      ...
                                      Object.assign(
                                          {
                                              ...
                                              onClick: ((u) => (e) => {
                                                  !1 === s && b(), null == o || o(e), null == u || u(e);
                                              })(e.props.onClick),
                                              onMouseDown: ((u) => (e) => {
                                                  !1 === s && b(), null == E || E(e), null == u || u(e);
                                              })(e.props.onMouseDown),
                                          },
                                          g,
                                      ),
                ...
                const Su = R.views.common.tooltip_window.simple_tooltip_content,
                    Lu = (u) => {
                        ...
                        const F = (0, r.useMemo)(() => {
                            const u = Object.assign({}, o, { body: t, header: i, note: a, alert: E });
                            ...
                            Tu(
                                {
                                    contentId:
                                        ...
                                        l ? Su.SimpleTooltipHtmlContent('resId') : Su.SimpleTooltipContent('resId')),
                ...
                const yu = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return i || E
                        ? n().createElement(fu, Ou({}, e, { contentId: i || E }), r)
                        : n().createElement(vu, e, r);
                };
                var Mu = t(9050),
                    ku = t.n(Mu);
                let Ru, Nu, Pu;
                ...
                const Hu = { [Pu.NBSP]: Ru.NoBreakSymbol, [Pu.ZWNBSP]: Ru.NoBreakSymbol, [Pu.NEW_LINE]: Ru.LineBreak },
                    Wu = {
                    ...
                    Iu = (u) => ({ color: `#${u}` }),
                    Uu = ({ elementList: u, textBlock: e, key: t }) => {
                        const r = e.colorTag;
                        return r
                            ? Wu[r]
                                ? n().createElement(
                                ...
                                : n().createElement('span', { key: t, 'data-block-type': e.blockType, style: Iu(r) }, u)
                    ...
                    Gu = {
                        ...
                        [Ru.LineBreak]: ({ key: u }) =>
                            n().createElement('span', {
                                key: u,
                                'data-block-type': Ru.LineBreak,
                                className: 'renderers_lineBreak_b5',
                            }),
                        [Ru.NewLine]: ({ elementList: u, key: e }) =>
                            n().createElement(
                                'span',
                                { key: e, 'data-block-type': Ru.NewLine, className: 'renderers_newLine_bd' },
                                u,
                            ),
                        [Ru.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            n().createElement(
                                ...
                                {
                                    key: e,
                                    'data-block-type': Ru.NoBreakWrapper,
                    ...
                    Ku = (u, e = '') => {
                        ...
                        return (
                            Vu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: Ru.Word, colorTag: e, childList: Xu(u) });
                                },
                                (u) => {
                                    const r = u[0],
                                        n = Hu[r.charAt(0)];
                    ...
                    Yu = (u, e) => {
                        ...
                        if (u.blockType === Ru.NoBreakWrapper) u.childList.push(r), t.push(u);
                        else {
                            const e = Object.assign({}, u, { childList: u.childList.splice(-1) });
                            u.childList.length > 0 && t.push(u),
                                t.push({ blockType: Ru.NoBreakWrapper, colorTag: '', childList: [e, r] });
                        }
                    ...
                    $u = (u, e) => !u || u.offsetTop + u.offsetHeight > e,
                    ...
                    Ju = (u, e, t, r, i, a) => {
                        ...
                        for (let A = t; A >= 0; A--) {
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const D = l.slice(0, l.length - s) + a,
                                    c = e[A];
                            ...
                            }
                            {
                                const u = t.children,
                                    F = e[A],
                                    s = F.props.children,
                                    D = Ju(u, s, u.length - 1, r, i, a),
                                    c = D[0],
                                    d = D[1];
                                if (!(c < 0)) {
                                    const u = s.slice(0, c);
                                    (o = n().cloneElement(F, F.props, u, d)), (E = A);
                                    break;
                                }
                                i -= l.length;
                            }
                    ...
                    ue = n().memo(
                        ({
                            ...
                            targetId: A,
                            justifyContent: F = Nu.FlexStart,
                            alignContent: l = Nu.FlexStart,
                            truncateIdentify: s = '...',
                        }) => {
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            ...
                                            B.isTruncateFinished && E ? B.elementList : m,
                                        ),
                                    ),
                                )
                            );
                    ...
                    ee = {
                        base: 'OrderWidgetTooltipApp_base_97',
                        content: 'OrderWidgetTooltipApp_content_bf',
                        header: 'OrderWidgetTooltipApp_header_23',
                        order: 'OrderWidgetTooltipApp_order_43',
                        description: 'OrderWidgetTooltipApp_description_cd',
                        text: 'OrderWidgetTooltipApp_text_b0',
                        bg: 'OrderWidgetTooltipApp_bg_13',
                        amount: 'OrderWidgetTooltipApp_amount_d0',
                        orders: 'OrderWidgetTooltipApp_orders_9d',
                        amount_title: 'OrderWidgetTooltipApp_amount_title_42',
                        dividerAmount: 'OrderWidgetTooltipApp_dividerAmount_f9',
                        dividerAmount__top: 'OrderWidgetTooltipApp_dividerAmount__top_b7',
                        dividerAmount__bottom: 'OrderWidgetTooltipApp_dividerAmount__bottom_b4',
                        icon: 'OrderWidgetTooltipApp_icon_2d',
                        info_content: 'OrderWidgetTooltipApp_info_content_4d',
                        info_icon: 'OrderWidgetTooltipApp_info_icon_f5',
                        info_text: 'OrderWidgetTooltipApp_info_text_c3',
                    },
                    te = R.strings.hb_lobby.orderWidgetTooltip,
                    re = () => {
                        const u = Cu('model', mu.None).orders,
                            e = (0, r.useCallback)(
                                (u) => ({
                                    backgroundImage: `url(${R.images.historical_battles.gui.maps.icons.order.c_36x36.$dyn(u)})`,
                                }),
                                [],
                            ),
                            t = (0, r.useCallback)(
                                (u) => ({
                                    amount: n().createElement('div', null, u.count),
                                    icon: n().createElement('div', { className: ee.icon, style: e(u.type) }),
                                }),
                                [e],
                            ),
                            i = o()(ee.divider, ee.dividerAmount, ee.dividerAmount__top),
                            a = o()(ee.divider, ee.dividerAmount, ee.dividerAmount__bottom);
                        return n().createElement(
                            D,
                            null,
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(Au, { className: ee.header, text: te.title() }),
                                    n().createElement(Au, {
                                        className: o()(ee.description, ee.text),
                                        text: te.description(),
                                    }),
                                    n().createElement(
                                        'div',
                                        ...
                                        n().createElement('div', { className: ee.bg }),
                                        n().createElement(Au, { className: ee.amount_title, text: te.inStock.title() }),
                                        n().createElement(
                                            'div',
                                            { className: ee.orders },
                                            u.map(({ value: u }) =>
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: ee.info_content },
                                        n().createElement('div', { className: ee.info_icon }),
                                        n().createElement(Au, {
                                            className: o()(ee.info_text, ee.text),
                                            text: te.infoText(),
                                        }),
                                    ),
                                    n().createElement('div', { className: ee.divider }),
                                ),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    a().render(n().createElement(re, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4695));
