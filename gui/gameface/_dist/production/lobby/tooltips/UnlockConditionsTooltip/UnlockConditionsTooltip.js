            ...
            4716: (u, e, t) => {
                ...
                const vu = {
                    ...
                    wu = hu((u) => {
                        ...
                        return K().createElement('div', pu({ className: a()(xu.base, ...N, e), style: j }, W), P);
                    });
                let Lu;
                !(function (u) {
                ...
                const Xu = Object.keys(Wu()),
                    ...
                    Uu = hu((u) => {
                        ...
                        return K().createElement(
                            ...
                            void 0 !== s ? K().createElement(Ou, Nu({}, s, { text: e })) : e,
                        );
                    });
                var Ku = t(3403);
                function Yu() {
                ...
                const Zu = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: e, children: A, mocks: F }) {
                                const E = (0, U.useRef)([]),
                                    ...
                                    n = a[0],
                                    B = a[1],
                                    i = (0, U.useState)(() => r(u, e, F)),
                                    C = i[0],
                                    l = i[1];
                                return (
                                    (0, U.useEffect)(() => {
                                        D.current ? l(r(n, e, F)) : (D.current = !0);
                                    }, [F, n, e]),
                                    (0, U.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                                    ...
                                    K().createElement(t.Provider, { value: C }, A)
                                );
                            },
                            () => (0, U.useContext)(t),
                        ];
                    ...
                    ue = Ju[0],
                    ee = Ju[1],
                    te = R.strings.fl_supply_objects.tooltip,
                    Ae = (0, Ku.Pi)(() => {
                        const u = ee().model.root.get().object;
                        return K().createElement(
                            'div',
                            { className: 'App_base_49' },
                            K().createElement(Uu, { className: 'App_title_8f', text: te.title() }),
                            K().createElement('div', {
                                className: 'App_image_37',
                                style: {
                                    backgroundImage: `url(${R.images.frontline.gui.maps.icons.supplyObjects.progressIcons.$dyn(u)})`,
                                },
                            }),
                            K().createElement(Uu, { className: 'App_description_d5', text: te.description.$dyn(u) }),
                        );
                    });
                engine.whenReady.then(() => {
                    uu().render(
