        ...
        e = {
            ...
            4716: (u, e, t) => {
                ...
                const J = Y().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        Y().createElement(
                            'div',
                            Z({}, r, {
                                className: n()(q.base, q[`base__theme-${E}`], A),
                                ref: function (u) {
                ...
                const nu = U.client.getSize('rem'),
                    au = nu.width,
                    Bu = nu.height,
                    iu = Object.assign({ width: au, height: Bu }, Du(au, Bu, Eu)),
                ...
                const bu = {
                    ...
                    Lu = xu((u) => {
                        ...
                        return Y().createElement('div', vu({ className: n()(fu.base, ...N, e), style: j }, W), P);
                    });
                let Mu;
                !(function (u) {
                ...
                const Ju = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const E = (0, K.useRef)([]),
                                    r = (u, e, t) => {
                                        ...
                                        const F = (function ({
                                            ...
                                            B = { mode: u, model: a, externalModel: r, cleanup: n };
                                        return {
                                            model: a,
                                    ...
                                    a = n[0],
                                    B = n[1],
                                    i = (0, K.useState)(() => r(u, e, F)),
                                    C = i[0],
                                    l = i[1];
                                return (
                                    (0, K.useEffect)(() => {
                                        D.current ? l(r(a, e, F)) : (D.current = !0);
                                    }, [F, a, e]),
                                    (0, K.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                                    ...
                                    Y().createElement(t.Provider, { value: C }, A)
                                );
                            },
                            () => (0, K.useContext)(t),
                        ];
                    ...
                    Fe = (0, Yu.Pi)(() => {
                        ...
                        return Y().createElement(
                            ...
                            Y().createElement(Ku, { className: 'App_title_8f', text: Ae.title() }),
                            Y().createElement('div', {
                            ...
                            Y().createElement(Ku, { className: 'App_description_d5', text: Ae.description.$dyn(u) }),
                        );
                    });
                engine.whenReady.then(() => {
                    eu().render(
