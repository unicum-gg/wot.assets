        ...
        e = {
            ...
            6711: (u, e, t) => {
                ...
                var A = t(6483),
                    ...
                    r = t(6179),
                    D = t.n(r);
                const n = ['children', 'className', 'isSimple'];
                function a() {
                    return (
                        (a =
                            Object.assign ||
            ...
            5701: (u, e, t) => {
                ...
                const c = l.O.client.getSize('rem'),
                    d = c.width,
                    g = c.height,
                    _ = Object.assign({ width: d, height: g }, s(d, g, o)),
                    h = (0, A.createContext)(_),
                    x = ['children'],
                    f = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        const E = (0, A.useContext)(h),
                            ...
                            f = { extraLarge: s, large: c, medium: d, small: g, extraSmall: _ };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && B) return C(e, t, f);
                            if (t.largeWidth && i) return C(e, t, f);
                            if (t.mediumWidth && l) return C(e, t, f);
                            if (t.smallWidth && o) return C(e, t, f);
                            if (t.extraSmallWidth && m) return C(e, t, f);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                ((0, A.memo)(({ children: u }) => {
                    const e = (0, A.useContext)(h),
                        ...
                        D = (0, A.useCallback)((u, e) => {
                            const t = l.O.view.pxToRem(u),
                                A = l.O.view.pxToRem(e);
                            r(Object.assign({ width: t, height: A }, s(t, A, o)));
                        }, []);
                    (((u) => {
                    ...
                    const n = (0, A.useMemo)(() => Object.assign({}, F), [F]);
                    return E().createElement(h.Provider, { value: n }, u);
                }),
                    (function (u) {
                ...
                const S = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    L = [p.ExtraLarge, p.Large, p.Medium, p.Small, p.ExtraSmall],
                    M = (u, e) =>
                        ...
                        const t = (
                            ...
                            (t) => {
                                const F = (() => {
                                    ...
                                    r = (0, A.useMemo)(() => e(t, F), [t, F]);
                                return E().createElement(u, r);
                            }
                        )(u, e);
                        return E().memo((e) =>
                ...
                const P = {
                    ...
                    N = y((u) => {
                        let e = u.className,
                            ...
                            j = u.shrink,
                            X = u.flex,
                            I = void 0 === X ? (N || j ? `${N ? 1 : 0} ${j ? 1 : 0} auto` : void 0) : X,
                            z = u.style,
                            k = u.children,
                            U = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const V = (0, A.useMemo)(() => {
                                const u = { mt: n, mr: i, mb: l, ml: m },
                                    e = ((u) =>
                                        W.reduce((e, t) => {
                                            const A = u[t];
                                            return A && 'number' != typeof A ? e.concat(P[!0 === A ? 'MD' : A][t]) : e;
                                        }, []))(u),
                                    A = ((u) =>
                                        W.reduce((e, t) => {
                                            const A = u[t];
                                            return ('number' == typeof A && (e[G[t]] = A + 'rem'), e);
                                        }, {}))(u);
                                return {
                            ...
                            }, [t, F, n, i, l, m, z, I, L, g, y, b, w]),
                            $ = V.computedStyle,
                            K = V.computedClassNames;
                        return E().createElement('div', O({ className: a()(T.base, ...K, e), style: $ }, U), k);
                    });
                let j;
                !(function (u) {
                ...
                const X = (u, e, t) => {
                    ...
                    z = (u, e, t = j.left) => u.split(e).reduce(t === j.left ? X : I, []),
                    k = (() => {
                        const u = new RegExp(
                    ...
                    U = ['zh_cn', 'zh_sg', 'zh_tw'],
                    V = ({ binding: u, text: e = '', classMix: t, alignment: F = j.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, r) =>
                                      E().createElement(
                                          'div',
                                          { className: a()('FormatText_base_d0', t), key: `${e}-${r}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                ...
                const Z = Object.keys(K()),
                    ...
                    Eu = y((u) => {
                        ...
                        return E().createElement(
                            ...
                            Q(
                                {
                                    className: a()(Y.base, t && Y[t], x, F),
                                    style: h,
                                    mt: !0 === B ? tu[t || 'paragraph-P16'].mt : B,
                                    mr: !0 === C ? tu[t || 'paragraph-P16'].mr : C,
                                    mb: !0 === o ? tu[t || 'paragraph-P16'].mb : o,
                                    ml: !0 === s ? tu[t || 'paragraph-P16'].ml : s,
                                },
                                g,
                            ),
                            void 0 !== d ? E().createElement(V, Q({}, d, { text: e })) : e,
                        );
                    }),
                    Fu = R.strings.cosmicEvent.tooltip.dailyQuestsTimer,
                    ru = (0, D.observer)(() =>
                        E().createElement(
                            'div',
                            { className: 'App_base_f5' },
                            E().createElement(Eu, { text: Fu.title(), className: 'App_title_06' }),
                            E().createElement(Eu, { text: Fu.description(), className: 'App_description_9b' }),
                        ),
                    );
                function Du() {
                    return !1;
                                ...
                                const D = (0, A.useRef)([]),
                                    n = (u, e, t) => {
                                        ...
                                        const E = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const D = 'string' == typeof F ? `${A}.${F}` : A,
                                                            n = l.O.view.addModelObserver(D, e, !0);
                                            ...
                                            r = (e) =>
                                                'mocks' === u ? (null == t ? void 0 : t.getter(e)) : F.readByPath(e),
                                            n = (u) => D.current.push(u),
                                            a = (({ observableModel: u }) => {
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const A = null != t ? t : r(e),
                                                            E = nu.observable.box(A, { equals: Du });
                                                        return (
                                                            'real' === u &&
                                                                F.subscribe(
                                            ...
                                            B = { mode: u, model: a, externalModel: F, cleanup: n };
                                        return {
                                            model: a,
                                    ...
                                    i = B[0],
                                    C = B[1],
                                    o = (0, A.useState)(() => n(u, e, r)),
                                    m = o[0],
                                    s = o[1];
                                return (
                                    (0, A.useEffect)(() => {
                                        a.current ? s(n(i, e, r)) : (a.current = !0);
                                    }, [r, i, e]),
                                    (0, A.useEffect)(() => {
                                        C(u);
                                    }, [u]),
                ...
                engine.whenReady.then(() => {
                    r().render(
                        E().createElement(
                            Cu,
                            null,
                            E().createElement(lu.c, { isSimple: !0 }, E().createElement(ru, null)),
                        ),
