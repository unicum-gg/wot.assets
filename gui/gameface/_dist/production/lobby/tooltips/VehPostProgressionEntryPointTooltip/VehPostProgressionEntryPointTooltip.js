(() => {
    ...
    var __webpack_modules__ = {
            85: (u, e, E) => {
                ...
                const p = {
                    ...
                    h = Object.keys(m).reduce((u, e) => ((u[e] = () => l(m[e])), u), {}),
                    f = { play: Object.assign({}, h, { sound: l }), setRTPC: d },
                    g = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    b = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function y(u) {
                    let e = '';
                    for (let E = b.length - 1; E >= 0; E--) for (; u >= b[E];) ((e += g[E]), (u -= b[E]));
                    return e;
                }
                ...
                const Bu = Object.keys(T).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === T[e]), u), {}),
                    ru = {
                        set: (u, e) => {
                ...
                const au = { view: D, client: F, sound: f, intl: w };
            },
            973: (u, e, E) => {
                E.d(e, { Z: () => t });
                var A = E(85);
            ...
            950: (u, e, E) => {
                ...
                const a = F().forwardRef(function (u, e) {
                        let E = u.children,
                            t = u.className,
                            D = u.theme,
                        ...
                        return (
                            ...
                            F().createElement(
                                'div',
                                i({}, a, {
                                    className: B()(o.base, o[`base__theme-${n}`], t),
                                    ref: function (u) {
                                        ((s.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                    },
                                }),
                                F().createElement('div', { className: o.decorator }, E),
                            )
                        );
                    }),
                    s = (u = 1) => {
                ...
                const _ = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    p = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, E) => {
                                const A = c(`${u}.${E}`, window);
                                return _(A) ? e(u, E, A) : `${u}.${E}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    w = (u) => {
                        const e = ((u) => {
                                const e = s(),
                                ...
                                return { modelPrefix: F, modelPath: v(F, u || ''), resId: A };
                            })(),
                            E = e.modelPrefix,
                            A = u.split('.');
                        if (A.length > 0) {
                            ...
                            return (
                                A.reduce((e, A) => {
                                    const F = c(v(E, `${e}.${A}`), window);
                                    return _(F) ? (u.push(F.id), `${e}.${A}.value`) : (u.push(A), `${e}.${A}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        l(() => {
                            if (
                                ...
                                const E = (u) => {
                                    ...
                                    A = w(u);
                                a.current = h.addCallback(A, E, B, e === f.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== f.None)
                                return () => {
                                    h.removeCallback(a.current, B);
                                };
                        }, [B, e]),
                        C
                    );
                ...
                const x = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    k = (u, e, E = y.left) => u.split(e).reduce(E === y.left ? T : P, []),
                    M = (() => {
                        const u = new RegExp(
                            [
                    ...
                    V = ({ binding: u, text: e = '', classMix: E, alignment: t = y.left, formatWithBrackets: D }) => {
                        ...
                        return F().createElement(
                            ...
                            n.split('\n').map((e, D) =>
                                F().createElement(
                                    'div',
                                    { className: B()(L, E), key: `${e}-${D}` },
                                    ((u, e, E) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (E && u in E ? E[u] : N(u, e))))(
                                        e,
                                        t,
                                        u,
                    ...
                    I = 'Footer_base_ae7ed',
                    U = 'Footer_label_b3aca',
                    j = 'Footer_explored_e5c5e',
                    z = 'Footer_separatorContainer_af5cb',
                    W = 'Footer_separator_ce163',
                    q = 'Footer_container_cc17c',
                    G = 'Footer_lock_ec6fa',
                    $ = ({ modulesExplored: u, modulesTotal: e, hasVehiclesToUnlock: E }) => {
                        const t = (0, A.useMemo)(
                                () => ({
                                    explored: F().createElement('span', { className: j }, u),
                                    total: F().createElement('span', { className: U }, e),
                                }),
                                [u, e],
                            ),
                            D = (0, A.useMemo)(
                                () =>
                                    E
                                        ? R.strings.veh_post_progression.tooltips.entry_point.footerModulesAndVehicles()
                                        : R.strings.veh_post_progression.tooltips.entry_point.footerOnlyModules(),
                                [E],
                            );
                        return F().createElement(
                            'div',
                            { className: I },
                            F().createElement('div', { className: z }, F().createElement('div', { className: W })),
                            F().createElement(
                                'div',
                                { className: q },
                                F().createElement('div', { className: G }),
                                F().createElement(V, { text: D, binding: t, classMix: U }),
                            ),
                        );
                    },
                    ...
                    H = 'Content_base_c7c4d',
                    Y = 'Content_title_e01fe',
                    Z = 'Content_content_ec918',
                    X = 'Content_description_afc9f',
                    Q = 'Content_status_bb708',
                    J = () => {
                        const u = g('model'),
                            e = u.header,
                            E = u.description,
                        ...
                        return F().createElement(
                            'div',
                            { className: H },
                            F().createElement('div', { className: Y }, e),
                            F().createElement(
                                'div',
                                { className: Z },
                                F().createElement(K, { text: E, className: X }),
                                A &&
                                    F().createElement(
                                        F().Fragment,
                                        null,
                                        ' ',
                                        F().createElement(K, { text: A, className: Q }),
                                    ),
                            ),
                            model.modulesExplored < model.modulesTotal && F().createElement($, model),
                        );
                    },
                    uu = () => F().createElement(a, null, F().createElement(J, null));
                engine.whenReady.then(() => {
                    D().render(F().createElement(uu, null), document.getElementById('root'));
                });
            },
            363: (u) => {
                u.exports = React;
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [807], () => __webpack_require__(950));
