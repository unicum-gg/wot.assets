(() => {
    ...
    var __webpack_modules__ = {
            ...
            640: (u, e, E) => {
                        ...
                        d(() => {
                            if (
                                ...
                                const E = (u) => {
                                    ...
                                    A = p(u);
                                i.current = h.addCallback(A, E, n, e === f.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== f.None)
                                return () => {
                                    h.removeCallback(i.current, n);
                                };
                        }, [n, e]),
                        C
                    );
                ...
                const T = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    k = (u, e, E = O.left) => u.split(e).reduce(E === O.left ? P : x, []),
                    S = (() => {
                        const u = new RegExp(
                    ...
                    L = (u, e = O.left) => {
                        ...
                        return ((u, e = O.left) => {
                            ...
                            const A =
                                ...
                                F = T(u);
                            return k(F, /( )/, e).forEach((u) => (E = E.concat(k(u, A, O.left)))), E;
                        })(u, e);
                    },
                    N = 'FormatText_base_d0',
                    V = ({ binding: u, text: e = '', classMix: E, alignment: t = O.left, formatWithBrackets: D }) => {
                    ...
                    j = 'Footer_container_fa',
                    G = 'Footer_lock_46',
                    K = ({ modulesExplored: u, modulesTotal: e, hasVehiclesToUnlock: E }) => {
                        const t = (0, A.useMemo)(
                                () => ({
                    ...
                    H = 'Content_base_d9',
                    Y = 'Content_title_a6',
                    Z = 'Content_content_ec',
                    X = 'Content_description_8a',
                    Q = 'Content_status_a5',
                    J = () => {
                        const u = g('model'),
                            e = u.header,
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                'div',
                                { className: Z },
                                F().createElement($, { text: E, className: X }),
                                A &&
                                    F().createElement(
                                        F().Fragment,
                                        null,
                                        ' ',
                                        F().createElement($, { text: A, className: Q }),
                                    ),
                            ),
                            model.modulesExplored < model.modulesTotal && F().createElement(K, model),
                        );
                    },
                    uu = () => F().createElement(s, null, F().createElement(J, null));
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [807], () => __webpack_require__(640));
