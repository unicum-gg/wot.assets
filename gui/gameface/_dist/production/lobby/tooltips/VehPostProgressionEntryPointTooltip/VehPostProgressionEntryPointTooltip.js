    ...
    var __webpack_modules__ = {
            ...
            640: (u, e, A) => {
                ...
                const O = (u, e, A) => {
                    ...
                    P = (u, e, A = g.left) => u.split(e).reduce(A === g.left ? O : y, []),
                    T = (() => {
                        const u = new RegExp(
                        ...
                        return M.includes(A)
                            ...
                            : ((u, e = g.left) => {
                                  ...
                                  const F =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (P(E, /( )/, e).forEach((u) => (A = A.concat(P(u, F, g.left)))), A);
                              })(u, e);
                    },
                    k = 'FormatText_base_d0',
                    N = ({ binding: u, text: e = '', classMix: A, alignment: D = g.left }) =>
                        null === e
