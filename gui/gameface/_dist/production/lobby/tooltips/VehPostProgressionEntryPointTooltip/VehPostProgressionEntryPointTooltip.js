(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, A) => {
                A.d(e, { O: () => G });
                var F = {};
                A.r(F), A.d(F, { mouse: () => o, onResize: () => r });
                var E = {};
                A.r(E),
                    A.d(E, {
                        events: () => F,
                ...
                var D = {};
                A.r(D), A.d(D, { getBgUrl: () => l, getTextureUrl: () => c });
                var t = {};
                function n(u) {
                    return (e) => (
                        engine.on(u, e),
                    ...
                    g = {
                        ...
                        sendShowPopOverEvent: (u, e, A, F, E = R.invalid('resId'), D) => {
                            const t = c.O.view.getViewGlobalPosition(),
                                ...
                                i = n.height,
                                a = {
                                    x: c.O.view.pxToRem(r) + t.x,
                                    y: c.O.view.pxToRem(C) + t.y,
            ...
            640: (u, e, A) => {
                ...
                const s = E().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            E().createElement(
                                ...
                                E().createElement('div', { className: o.decorator }, A),
                            )
                        );
                    }),
                    c = (u = 1) => {
                        ...
                        _(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    F = p(u);
                                i.current = h.addCallback(F, A, n, e === f.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== f.None)
                ...
                const O = (u, e, A) => {
                    ...
                    T = (u, e, A = b.left) => u.split(e).reduce(A === b.left ? O : y, []),
                    P = (() => {
                        const u = new RegExp(
                        ...
                        return M.includes(A)
                            ...
                            : ((u, e = b.left) => {
                                  ...
                                  const F =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return T(E, /( )/, e).forEach((u) => (A = A.concat(T(u, F, b.left)))), A;
                              })(u, e);
                    },
                    k = 'FormatText_base_d0',
                    N = ({ binding: u, text: e = '', classMix: A, alignment: D = b.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, t) =>
                                      E().createElement(
                                          'div',
                                          { className: B()(k, A), key: `${e}-${t}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : x(u, e))))(e, D, u).map((u, e) =>
                    ...
                    S = 'Footer_base_ee',
                    L = 'Footer_label_36',
                    U = 'Footer_explored_ae',
                    I = 'Footer_separatorContainer_57',
                    V = 'Footer_separator_a0',
                    z = 'Footer_container_fa',
                    K = 'Footer_lock_46',
                    W = ({ modulesExplored: u, modulesTotal: e, hasVehiclesToUnlock: A }) => {
                        const D = (0, F.useMemo)(
                                () => ({
                                    explored: E().createElement('span', { className: U }, u),
                                    total: E().createElement('span', { className: L }, e),
                                }),
                                [u, e],
                            ),
                            t = (0, F.useMemo)(
                        ...
                        return E().createElement(
                            'div',
                            { className: S },
                            E().createElement('div', { className: I }, E().createElement('div', { className: V })),
                            E().createElement(
                                'div',
                                { className: z },
                    ...
                    Z = () => {
                        ...
                        return E().createElement(
                            'div',
                            { className: j },
                            E().createElement('div', { className: H }, e),
                            E().createElement(
                                'div',
                                { className: G },
                                E().createElement(q, { text: A, className: $ }),
                                F &&
                                    E().createElement(
                                        E().Fragment,
                                        null,
                                        ' ',
                                        E().createElement(q, { text: F, className: Y }),
                                    ),
                            ),
                            !D && model.modulesExplored < model.modulesTotal && E().createElement(W, model),
                        );
                    },
