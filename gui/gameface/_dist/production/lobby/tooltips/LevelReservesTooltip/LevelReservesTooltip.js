(() => {
    ...
    var __webpack_modules__ = {
            ...
            2674: (u, e, t) => {
                ...
                const I = { [S.NBSP]: P.NoBreakSymbol, [S.ZWNBSP]: P.NoBreakSymbol, [S.NEW_LINE]: P.LineBreak },
                    U = {
                    ...
                    j = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? U[n]
                                ...
                                : r().createElement('span', { key: t, 'data-block-type': e.blockType, style: W(n) }, u)
                ...
                const ou = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    Au = (0, eu.Pi)(() => {
                        const u = au().model.levels.get(),
                            e = (u) => R.strings.fl_common.levelReservesTooltip.$dyn(u ? 'level' : 'levelAvailable');
                        return r().createElement(
                            l,
                            null,
                            r().createElement(
