(() => {
    var __webpack_modules__ = {
            ...
            8980: (u, e, t) => {
                ...
                const g = i.O.client.getSize('rem'),
                    v = g.width,
                    p = g.height,
                    x = Object.assign({ width: v, height: p }, h(v, p, c)),
                    w = (0, r.createContext)(x),
                    b = ['children'],
                    f = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        const E = (0, r.useContext)(w),
                            ...
                            g = { extraLarge: C, large: _, medium: c, small: d, extraSmall: h };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.mediumWidth && B) return m(e, t, g);
                            if (t.smallWidth && l) return m(e, t, g);
                            if (t.extraSmallWidth && s) return m(e, t, g);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                ((0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(w),
                        ...
                        F = (0, r.useCallback)((u, e) => {
                            ...
                            a(Object.assign({ width: t, height: r }, h(t, r, c)));
                        }, []);
                    (((u) => {
                ...
                const L = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    y = [S.ExtraLarge, S.Large, S.Medium, S.Small, S.ExtraSmall],
                    P = (u, e) =>
                ...
                const I = {
                    ...
                    j = N((u) => {
                        let e = u.className,
                            ...
                            b =
                                void 0 === w
                                    ...
                                    : w,
                            f = u.alignItems,
                            S = void 0 === f ? (h ? 'flex-start' : g && 'center') || (v && 'flex-end') || void 0 : f,
                            M = u.alignSelf,
                            T = u.wrap,
                            L = u.flexWrap,
                            O = void 0 === L ? (T ? 'wrap' : void 0) : L,
                            R = u.grow,
                            y = u.shrink,
                            P = u.flex,
                        ...
                        const V = (0, r.useMemo)(() => {
                            ...
                            }, [t, A, i, o, l, C, j, N, M, d, O, b, S]),
                            q = V.computedStyle,
                            z = V.computedClassNames;
                        return E().createElement('div', W({ className: n()(H.base, ...z, e), style: q }, K), X);
                    });
                let X;
                !(function (u) {
                ...
                const K = (u, e, t) => {
                    ...
                    q = (u, e, t = X.left) => u.split(e).reduce(t === X.left ? K : V, []),
                    z = (() => {
                        const u = new RegExp(
                ...
                const tu = Object.keys(Q()),
                    ...
                    nu = N((u) => {
                        ...
                        return E().createElement(
                            ...
                            void 0 !== c ? E().createElement($, eu({}, c, { text: e })) : e,
                        );
                    });
                let iu;
                var Du;
                ...
                const Bu = 1.6,
                    lu = (u) => (e, t) =>
                        e / t >= 2.4000000000000004
                            ? u(viewEnv.remToPx(t) * Bu, viewEnv.remToPx(t), e, t)
                            : u(viewEnv.remToPx(e), 0.625 * viewEnv.remToPx(e), e, t),
                    su =
                        (lu((u, e, t, r) => {
                            const E = { width: viewEnv.remToPx(900) * Bu, height: viewEnv.remToPx(900) },
                                A = { width: viewEnv.remToPx(1200) * Bu, height: viewEnv.remToPx(1200) };
                            return u < E.width
                                ? E
                                : t > c.medium.width && r > c.medium.height && u < A.width
                                  ? A
                                  : { width: u, height: e };
                        }),
                        lu((u, e) => {
                            const t = { width: viewEnv.remToPx(700) * Bu, height: viewEnv.remToPx(700) };
                            return u < t.width ? t : { width: u, height: e };
                        }),
                        (u, e) => {
                            const t = u === ou.BOSS_2025 ? 'ticket2025' : 'ticket';
                            return {
                ...
                const gu = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: A, children: a, mocks: F }) {
                                const n = (0, r.useRef)([]),
                                        ...
                                        const A = (function ({
                                            ...
                                            o = (({ observableModel: u }) => {
                                                const e = Object.assign(
                                                    {},
                                                    u.primitives(['quantity', 'wtVehicleType']),
                                                );
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : F(e),
                                                            E = du.observable.box(r, { equals: cu });
                                                        return (
                                                            'real' === u &&
                                                                a.subscribe(
                                                                    (0, du.action)((u) => E.set(u)),
                                                                    e,
                                                                ),
                                                            E
                                                        );
                                    ...
                                    l = B[0],
                                    s = B[1],
                                    C = (0, r.useState)(() => D(u, A, F)),
                                    _ = C[0],
                                    m = C[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        o.current ? m(D(l, A, F)) : (o.current = !0);
                                    }, [F, l, A]),
                                    (0, r.useEffect)(() => {
                                        s(u);
                                    }, [u]),
                                    (0, r.useEffect)(
                                        () => () => {
                                            (_.externalModel.dispose(), n.current.forEach((u) => u()));
                                        },
                                        [_],
                                    ),
                    ...
                    pu = vu[0],
                    xu = vu[1],
                    wu = 'Content_divider_29',
                    bu = R.strings.white_tiger.ticketTooltip,
                    fu = (0, s.observer)(() => {
                        const u = xu().model,
                            e = u.quantity.get(),
                            t = u.wtVehicleType.get(),
                            r = n()(wu, 'Content_divider__top_a9'),
                            A = n()(wu, 'Content_divider__bottom_33'),
                            a = R.strings.white_tiger.bossName.capital.$dyn(t);
                        return E().createElement(
                            'div',
                            { className: 'Content_base_d7' },
                            E().createElement(nu, {
                                className: 'Content_title_9e',
                                text: bu.title(),
                                format: { binding: { boss: bu.bossName.$dyn(t) } },
                            }),
                            E().createElement('div', { className: 'Content_iconBig_bb', style: su(t, mu.x124) }),
                            E().createElement(nu, {
                                className: 'Content_description_c2',
                                text: bu.description(),
                                format: { binding: { boss: a } },
                            }),
                            ...
                            E().createElement(nu, { className: 'Content_receiveTitle_64', text: bu.receiveTitle() }),
                            E().createElement($, {
                                classMix: 'Content_receiveText_27',
                                text: String(bu.receiveText.$dyn(t)),
                            }),
                            E().createElement(nu, {
                                className: 'Content_receiveAdditionalText_d8',
                                text: bu.receiveAdditionalText(),
                                format: { binding: { boss: a } },
                            }),
                        );
                    }),
                    Su = () => E().createElement(l, null, E().createElement(fu, null));
                engine.whenReady.then(() => {
                    a().render(
                        E().createElement(pu, null, E().createElement(Su, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(8980));
