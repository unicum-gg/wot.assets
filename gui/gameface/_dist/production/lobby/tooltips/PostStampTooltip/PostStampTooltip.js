            ...
            7493: (u, e, t) => {
                ...
                ((0, $.memo)(({ children: u }) => {
                    ...
                    (((u) => {
                        ...
                        (0, $.useEffect)(() => () => engine.off('clientResized', F), [F]));
                    const r = (0, $.useMemo)(() => Object.assign({}, A), [A]);
                ...
                const vu = {
                    ...
                    wu = hu((u) => {
                        let e = u.className,
                            ...
                            w = u.wrap,
                            L = u.flexWrap,
                            M = void 0 === L ? (w ? 'wrap' : void 0) : L,
                            y = u.grow,
                            R = u.shrink,
                            T = u.flex,
                            H = void 0 === T ? (y || R ? `${y ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : T,
                            O = u.style,
                            P = u.children,
                            W = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const N = (0, $.useMemo)(() => {
                            ...
                            }, [t, A, r, n, i, l, O, H, S, c, M, f, b]),
                            G = N.computedStyle,
                            j = N.computedClassNames;
                        return K().createElement('div', fu({ className: a()(xu.base, ...j, e), style: G }, W), P);
                    });
                let Lu;
                !(function (u) {
                                  ...
                                  e.split('\n').map((e, E) =>
                                      K().createElement(
                                          ...
                                          ((u, e, t) =>
                                              ...
                                              K().createElement($.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              );
                ...
                const Zu = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    Ee = (0, Ku.Pi)(() => {
                        ...
                        const u = ee().model.root.get().currencyCount;
                        return K().createElement(
                            'div',
                            { className: 'App_base_3e' },
                            K().createElement($u, {
                                text: Ae.tooltip.postStamp.title(),
                                format: { classMix: 'App_title_b1' },
                            }),
                            K().createElement(
                                'div',
                                { className: 'App_postStampContainer_60' },
                                K().createElement('div', { className: 'App_postStampIcon_ba' }),
                            ),
                            K().createElement($u, {
                                text: Ae.tooltip.postStamp.description(),
                                format: { classMix: 'App_description_89' },
                            }),
                            K().createElement('div', { className: te }),
                            K().createElement(
                                'div',
                                { className: 'App_currencyContainer_f2' },
                                K().createElement($u, {
                                    text: Ae.currencyCount(),
                                    format: {
                                        classMix: 'App_currencyText_55',
                                        binding: {
                                            currencyCount: K().createElement($u, {
                                                text: String(u),
                                                className: 'App_currencyCountText_d1',
                                            }),
                                        },
                                    },
                                }),
                                K().createElement('div', { className: 'App_currencyPostStampIcon_c8' }),
                            ),
                            K().createElement('div', { className: te }),
                            K().createElement($u, {
                                text: Ae.tooltip.postStamp.howToEarnTitle(),
                                format: { classMix: 'App_howToEarnTitle_d7' },
                            }),
                            K().createElement($u, {
                                text: Ae.tooltip.postStamp.howToEarnDescription(),
                                format: { classMix: 'App_howToEarnTitleDescription_f5' },
                            }),
                        );
                    });
                engine.whenReady.then(() => {
                    uu().render(
                        K().createElement(ue, null, K().createElement(Z, null, K().createElement(Ee, null))),
