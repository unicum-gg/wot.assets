            ...
            7493: (u, e, t) => {
                ...
                const bu = {
                    ...
                    Lu = xu((u) => {
                        ...
                        return Y().createElement('div', vu({ className: n()(fu.base, ...j, e), style: N }, W), P);
                    });
                let Mu;
                !(function (u) {
                            ...
                            Xu(
                                {
                                    ...
                                    style: g,
                                    mt: !0 === D ? Uu[t || 'paragraph-P16'].mt : D,
                                    mr: !0 === B ? Uu[t || 'paragraph-P16'].mr : B,
                                    mb: !0 === C ? Uu[t || 'paragraph-P16'].mb : C,
                ...
                const Ju = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    te = ue[1],
                    Ae = 'App_divider_0a',
                    Ee = R.strings.mt_birthday.mail.tooltip.postStamp,
                    Fe = (0, Yu.Pi)(() => {
                        viewEnv.clearInternalCacheAfterFinalize();
                        const u = te().model.root.get().currencyCount;
                        return Y().createElement(
                            'div',
                            { className: 'App_base_3e' },
                            Y().createElement(Ku, { text: Ee.title(), format: { classMix: 'App_title_b1' } }),
                            Y().createElement(Ku, {
                                text: Ee.description(),
                            ...
                            Y().createElement(
                                ...
                                Y().createElement(Ku, {
                                    text: Ee.currencyCount(),
                                    format: {
                                        classMix: 'App_currencyText_55',
                                        binding: {
                                            currencyCount: Y().createElement(Ku, {
                                                text: String(u),
                            ...
                            Y().createElement('div', { className: Ae }),
                            Y().createElement(Ku, {
                                text: Ee.howToEarnTitle(),
                                format: { classMix: 'App_howToEarnTitle_d7' },
                            }),
                            Y().createElement(Ku, {
                                text: Ee.howToEarnDescription(),
                ...
                engine.whenReady.then(() => {
                    eu().render(
                        Y().createElement(ee, null, Y().createElement(J, null, Y().createElement(Fe, null))),
