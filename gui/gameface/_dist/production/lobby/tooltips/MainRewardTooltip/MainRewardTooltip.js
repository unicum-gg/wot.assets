(() => {
    ...
    var __webpack_modules__ = {
                    ...
                    h = {
                        ...
                        sendShowPopOverEvent: (u, e, t, n, r = R.invalid('resId'), E) => {
                            const A = l.O.view.getViewGlobalPosition(),
                                ...
                                D = o.height,
                                B = {
                                    x: l.O.view.pxToRem(i) + A.x,
                                    y: l.O.view.pxToRem(F) + A.y,
            ...
            647: (u, e, t) => {
                ...
                const F = (u, e, t) => {
                    ...
                    D = (u, e, t = i.left) => u.split(e).reduce(t === i.left ? F : a, []),
                    B = (() => {
                        const u = new RegExp(
                    ...
                    c = ['zh_cn', 'zh_sg', 'zh_tw'],
                    l = ({ binding: u, text: e = '', classMix: t, alignment: E = i.left }) =>
                        null === e
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            T = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (f(t, c, { isMouseEvent: !0, on: !0, arguments: h(r) }, w),
                                    m && m(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((g.current.timeoutId = window.setTimeout(T, F ? 100 : 400)),
                                                          E && E(u),
                                                          y && y(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                ...
                const k = R.views.common.tooltip_window.simple_tooltip_content,
                    M = (u) => {
                        ...
                        const F = (0, n.useMemo)(() => {
                            const u = Object.assign({}, s, { body: t, header: E, note: A, alert: o });
                ...
                const L = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return E || o
                        ? r().createElement(T, I({}, e, { contentId: E || o }), n)
                        : r().createElement(y, e, n);
                };
                ...
                const U = [
                    ...
                    G = [C.Gold, C.Credits, C.Crystal, C.FreeXp, C.NewYearToyFragments],
                    Y = [C.BattlePassPoints],
                    q = [C.PremiumPlus, C.Premium],
                    ...
                    H = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: s()(z.base, z[`base__${n}`], F), style: i },
                            r().createElement(
                                L,
                                { tooltipArgs: D, className: z.tooltipWrapper },
                                r().createElement(
                                    r().Fragment,
                                    null,
                                    r().createElement(
                                        'div',
                                        { className: s()(z.image, null == a ? void 0 : a.image) },
                                        c &&
                                            r().createElement('div', {
                                                className: s()(z.highlight, null == a ? void 0 : a.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: s()(z.icon, null == a ? void 0 : a.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        l &&
                                            r().createElement('div', {
                                                className: s()(z.overlay, null == a ? void 0 : a.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: B },
                                    r().createElement('div', {
                                        className: s()(z.timer, null == a ? void 0 : a.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const Z = r().forwardRef(function (u, e) {
                    let t = u.children,
                        E = u.className,
                        A = u.theme,
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            Q({}, i, {
                                className: s()(W.base, W[`base__theme-${o}`], E),
                                ref: function (u) {
                ...
                const tu = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                                ...
                                const s = (0, n.useRef)([]),
                                    i = (u, t, n) => {
                                        ...
                                        const E = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const o = 'string' == typeof E ? `${n}.${E}` : n,
                                                            s = X.O.view.addModelObserver(o, e, !0);
                                                        return r.set(s, t), u && t(A(E)), s;
                                                    },
                                                    readByPath: A,
                                                    createCallback: (u, e) => {
                                                        const t = A(e);
                                            ...
                                            F = (({ observableModel: u }) => ({ rewards: u.array('rewards') }))({
                                                mode: u,
                                                readByPath: o,
                                                externalModel: A,
                                                observableModel: {
                                            ...
                                            a = { mode: u, model: F, externalModel: A, cleanup: i };
                                        return {
                                            model: F,
                                    ...
                                    D = a[0],
                                    B = a[1],
                                    c = (0, n.useState)(() => i(u, E, o)),
                                    l = c[0],
                                    C = c[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        F.current ? C(i(D, E, o)) : (F.current = !0);
                                    }, [o, D, E]),
                                    (0, n.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                                    (0, n.useEffect)(
                                        () => () => {
                                            l.externalModel.dispose(), s.current.forEach((u) => u());
                                        },
                                        [l],
                                    ),
                                    r().createElement(t.Provider, { value: l }, A)
                                );
                            },
                            () => (0, n.useContext)(t),
                        ];
                ...
                const lu = R.strings.winback.mainRewardTooltip,
                    Cu = (0, Au.Pi)(() => {
                        const u = eu(Bu().model.rewards.get(), (u) => {
                            return {
                                name: u.name,
                                image: j(u, d.Small),
                                value: u.value,
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement('div', { className: 'App_title_27' }, lu.title()),
                                r().createElement('div', { className: 'App_description_e1' }, lu.description()),
                                r().createElement(
                                    'div',
                                    { className: 'App_rewards_d5' },
                                    r().createElement('div', { className: 'App_separator_a3' }),
                                    eu(u, (u, e) =>
                                        r().createElement(
                                            'div',
                                            { key: e, className: 'App_reward_49' },
                                            u.name === uu.SELECTABLE_VEHICLE_DISCOUNT && u.vehicleLvl
                                                ? r().createElement(
                                                      'div',
                                                      { className: 'App_vehicle_d5' },
                                                      r().createElement(
                                                          'div',
                                                          { className: 'App_vehicleLevel_fc' },
                                                          Eu(u.vehicleLvl),
                                                      ),
                                                      r().createElement('div', { className: 'App_discount_6b' }),
                                                  )
                                                : r().createElement(H, cu({}, u, { size: d.S48x48 })),
                                            r().createElement(
                                                'div',
                                                { className: 'App_label_a9' },
                                                u.name === uu.SELECTABLE_VEHICLE_DISCOUNT && u.vehicleLvl
                                                    ? r().createElement(l, {
                                                          text: lu.vehicleRewardLabel(),
                                                          binding: { level: Eu(u.vehicleLvl) },
                                                      })
                                                    : r().createElement(l, { text: u.label }),
                                            ),
                                        ),
                                    ),
                                ),
                ...
                engine.whenReady.then(() => {
                    A().render(
                        r().createElement(Du, null, r().createElement(Cu, null)),
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (s = 0; s < deferred.length; s++) {
                    for (var [e, t, n] = deferred[s], E = !0, A = 0; A < e.length; A++)
                        (!1 & n || r >= n) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(647));
