    ...
    var u,
        e = {
            ...
            7176: (u, e, t) => {
                'use strict';
                var A = {};
                (t.r(A), t.d(A, { mouse: () => h, onResize: () => g }));
                var F = {};
                (t.r(F),
                    t.d(F, {
                        events: () => A,
                ...
                var E = {};
                (t.r(E), t.d(E, { getBgUrl: () => b, getTextureUrl: () => v }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        addModelObserver: () => P,
                ...
                const g = d('clientResized'),
                    _ = { down: d('mousedown'), up: d('mouseup'), move: d('mousemove') },
                    h = (function () {
                ...
                const Fu = uu.client.getSize('rem'),
                    ...
                    Bu = (u) => {
                        ...
                        const A = (0, D.useContext)(au),
                            ...
                            h = { extraLarge: m, large: d, medium: c, small: g, extraSmall: _ };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && B) return s(e, t, h);
                            if (t.largeWidth && i) return s(e, t, h);
                            if (t.mediumWidth && C) return s(e, t, h);
                            if (t.smallWidth && l) return s(e, t, h);
                            if (t.extraSmallWidth && o) return s(e, t, h);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                const xu = {
                    ...
                    vu = cu((u) => {
                        ...
                        return a().createElement('div', hu({ className: l()(gu.base, ...I, e), style: X }, N), G);
                    });
                let bu;
                !(function (u) {
                ...
                const Su = (u, e, t) => {
                    ...
                    Lu = (u, e, t = bu.left) => u.split(e).reduce(t === bu.left ? Su : wu, []),
                    Mu = (() => {
                        const u = new RegExp(
                    ...
                    Ru = ({ binding: u, text: e = '', classMix: t, alignment: A = bu.left }) =>
                        null === e
                            ...
                            Wu(
                                {
                                    ...
                                    style: h,
                                    mt: !0 === n ? Iu[t || 'paragraph-P16'].mt : n,
                                    mr: !0 === i ? Iu[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === o ? Iu[t || 'paragraph-P16'].mb : o,
                                    ml: !0 === s ? Iu[t || 'paragraph-P16'].ml : s,
                                },
                                g,
                            ),
                        ...
                        return [
                            function ({ mode: u = 'real', options: e, children: A, mocks: F }) {
                                const E = (0, D.useRef)([]),
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const A = null != t ? t : D(e),
                                                            F = Uu.observable.box(A, { equals: Vu });
                                                        return (
                                                            'real' === u &&
                                                                r.subscribe(
                                                                    (0, Uu.action)((u) => F.set(u)),
                                                                    e,
                                                                ),
                                                            F
                                                        );
                                    ...
                                    i = B[0],
                                    C = B[1],
                                    l = (0, D.useState)(() => r(u, e, F)),
                                    o = l[0],
                                    m = l[1];
                                return (
                                    (0, D.useEffect)(() => {
                                        n.current ? m(r(i, e, F)) : (n.current = !0);
                                    }, [F, i, e]),
                                    (0, D.useEffect)(() => {
                                        C(u);
                                    }, [u]),
                ...
                const ee = a().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                ue({}, r, {
                                    className: l()(Zu.base, Zu[`base__theme-${E}`], A),
                                    ref: function (u) {
                    ...
                    te = (0, i.observer)(() => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { className: 'App_titleWrap_6b' },
                                    a().createElement(ku, { className: 'App_title_cd', text: e }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: 'App_textWrap_8b' },
                                    a().createElement(ku, { className: 'App_description_3d', text: t }),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    B().render(
                        a().createElement(qu, null, a().createElement(te, null)),
