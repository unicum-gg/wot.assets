        ...
        e = {
            ...
            7778: (u, e, t) => {
                ...
                const g = (u, e, t) => {
                    ...
                    h = (u, e, t = d.left) => u.split(e).reduce(t === d.left ? g : _, []),
                    x = (() => {
                        const u = new RegExp(
                    ...
                    p = ['zh_cn', 'zh_sg', 'zh_tw'],
                    f = ({ binding: u, text: e = '', classMix: t, alignment: F = d.left }) =>
                        null === e
                ...
                const y = B.O.client.getSize('rem'),
                    T = y.width,
                    H = y.height,
                    O = Object.assign({ width: T, height: H }, M(T, H, S)),
                    P = (0, A.createContext)(O),
                    W = ['children'],
                    N = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && B) return w(e, t, _);
                            if (t.largeWidth && i) return w(e, t, _);
                            if (t.mediumWidth && C) return w(e, t, _);
                            if (t.smallWidth && l) return w(e, t, _);
                            if (t.extraSmallWidth && o) return w(e, t, _);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                (0, A.memo)(({ children: u }) => {
                    const e = (0, A.useContext)(P),
                        ...
                        D = (0, A.useCallback)((u, e) => {
                            ...
                            r(Object.assign({ width: t, height: A }, M(t, A, S)));
                        }, []);
                    ((u) => {
                    ...
                    return E().createElement(P.Provider, { value: a }, u);
                }),
                    (function (u) {
                ...
                const I = ['xl', 'lg', 'md', 'sm', 'xs'],
                    z = (u) => u.includes('_') && ((u) => I.includes(u))(u.split('_').at(-1)),
                ...
                const Y = {
                    ...
                    J = V((u) => {
                        ...
                        const j = (0, A.useMemo)(() => {
                                const u = { mt: a, mr: B, mb: C, ml: o },
                                    e = ((u) =>
                                        Q.reduce((e, t) => {
                                            const A = u[t];
                                            return A && 'number' != typeof A ? e.concat(Y[!0 === A ? 'MD' : A][t]) : e;
                                        }, []))(u),
                                    A = ((u) =>
                                        Q.reduce((e, t) => {
                                            const A = u[t];
                                            return 'number' == typeof A && (e[Z[t]] = A + 'rem'), e;
                                        }, {}))(u);
                                return {
                        ...
                        return E().createElement('div', q({ className: c()($.base, ...I, e), style: X }, G), N);
                    });
                var uu = t(3532),
                    eu = t.n(uu);
                const tu = {
                ...
                const Fu = Object.keys(eu()),
                    ...
                    iu = V((u) => {
                        ...
                        return E().createElement(
                            ...
                            void 0 !== d ? E().createElement(f, Eu({}, d, { text: e })) : e,
                        );
                    }),
                    Cu = 'App_subTitle_b5',
                    lu = (0, D.observer)(() => {
                        const u = m().model.root.get(),
                            ...
                            A = u.description,
                            F = u.icon,
                            r = { cooldownSeconds: E().createElement(iu, { text: t, className: 'App_highlight_8b' }) };
                        return E().createElement(
                            'div',
                            ...
                            E().createElement(
                                ...
                                E().createElement(iu, {
                                    text: R.strings.cosmicEvent.abilities.tooltip.activationEffect(),
                                    className: 'App_infoTitle_77',
                                }),
                                E().createElement(iu, { text: A, className: Cu }),
                            ),
                        );
                    });
                var ou = t(6711);
