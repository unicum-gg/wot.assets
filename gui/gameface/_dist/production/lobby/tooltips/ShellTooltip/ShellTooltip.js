        ...
        e = {
            ...
            7239: (u, e, t) => {
                ...
                const ee = ((u, e) => {
                                ...
                                const r = (0, U.useRef)([]),
                                    D = (u, t, A) => {
                                        ...
                                        const F = (function ({
                                            ...
                                            B = (({ observableModel: u }) => {
                                                const e = { root: u.object(), stats: u.array('stats') },
                                                    t = (0, ue.computedFn)(
                                                        () => {
                                                            return ((u = e.stats.get()), Ju(u));
                                                            var u;
                                                        },
                                                        { equals: Yu },
                                                    );
                                                return Object.assign({}, e, { computes: { getStats: t } });
                                            })({
                                                mode: u,
                                                readByPath: a,
                                                externalModel: D,
                    ...
                    te = ee[0],
                    Ae = ee[1],
                    Ee = R.strings.portal_tooltips.shell,
                    Fe = (0, Ku.observer)(() => {
                        const u = Ae().model,
                            e = u.root.get(),
                            t = e.name,
                            A = e.type,
                            E = e.caliber,
                            F = u.computes.getStats();
                        return K().createElement(
                            'div',
                            { className: 'App_base_f0' },
                            K().createElement('div', { className: 'App_bg_3a' }),
                            K().createElement(
                                'div',
                                { className: 'App_info_12' },
                                K().createElement(Uu, {
                                    text: Ee.name(),
                                    format: { binding: { name: t } },
                                    className: 'App_title_d9',
                                }),
                                K().createElement(Uu, {
                                    text: Ee.type.$dyn(A),
                                    format: { binding: { name: t } },
                                    className: 'App_type_f6',
                                }),
                                K().createElement(Uu, {
                                    text: Ee.caliber(),
                                    format: { binding: { caliber: E } },
                                    className: 'App_caliber_ee',
                                }),
                            ),
                            K().createElement(
                                'div',
                                { className: 'App_imageWrapper_64' },
                                K().createElement('div', {
                                    className: 'App_shellImage_8d',
                                    style: {
                                        backgroundImage: `url(R.images.portal.gui.maps.icons.tooltips.shell.${A.toLowerCase()})`,
                                    },
                                }),
                            ),
                            K().createElement('div', { className: 'App_divider_6a' }),
                            K().createElement(
                                'div',
                                { className: 'App_description_34' },
                                K().createElement('div', { className: 'App_descriptionBg_43' }),
                                K().createElement(Uu, {
                                    text: Ee.baseCharacters(),
                                    className: 'App_baseCharacters_b5',
                                }),
                                K().createElement(
                                    'div',
                                    { className: 'App_stats_15' },
                                    F.map((u, e) =>
                                        K().createElement(
                                            'div',
                                            { className: 'App_stat_5e', key: e },
                                            K().createElement(Uu, {
                                                text: u.to > 0 ? Ee.stat.values() : Ee.stat.value(),
                                                format: { binding: { to: u.to, from: u.from } },
                                                className: 'App_value_6f',
                                            }),
                                            K().createElement(Uu, {
                                                text: Ee.stat.name.$dyn(u.name),
                                                className: 'App_name_54',
                                            }),
                                        ),
                                    ),
                                ),
                ...
                engine.whenReady.then(() => {
                    uu().render(
                        K().createElement(te, null, K().createElement(Z, null, K().createElement(Fe, null))),
