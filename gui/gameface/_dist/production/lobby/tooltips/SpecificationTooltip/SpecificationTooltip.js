            ...
            8056: (u, e, t) => {
                ...
                const C = (u) => (0 === u ? window : window.subViews.get(u)),
                    l = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: F, children: r, mocks: D }) {
                                const l = (0, A.useRef)([]),
                                    o = (u, t, A) => {
                                        var E;
                                        const F = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const D = 'string' == typeof F ? `${A}.${F}` : A,
                                                            n = B.O.view.addModelObserver(D, e, !0);
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const A = null != t ? t : D(e),
                                                            E = a.observable.box(A, { equals: n });
                                                        return (
                                                            'real' === u &&
                                                                r.subscribe(
                                                                    (0, a.action)((u) => E.set(u)),
                                                                    e,
                                                                ),
                                                            E
                                                        );
                                                    ...
                                                    primitives: (e, t) => {
                                                        ...
                                                        if (Array.isArray(e)) {
                                                            const E = e.reduce(
                                                                (u, e) => ((u[e] = a.observable.box(A[e], {})), u),
                                                                {},
                                                            );
                                                            return (
                                                                'real' === u &&
                                            ...
                                            s = { mode: u, model: m, externalModel: r, cleanup: o };
                                        return {
                                            model: m,
                                            controls: 'mocks' === u && A ? A.controls(s) : e(s),
                                            externalModel: r,
                                            mode: u,
                                        };
                                    },
                                    ...
                                    c = s[0],
                                    d = s[1],
                                    g = (0, A.useState)(() => o(u, F, D)),
                                    _ = g[0],
                                    h = g[1];
                                return (
                                    (0, A.useEffect)(() => {
                                        m.current ? h(o(c, F, D)) : (m.current = !0);
                                    }, [D, c, F]),
                                    (0, A.useEffect)(() => {
                                        d(u);
                                    }, [u]),
                                    ...
                                    E().createElement(t.Provider, { value: _ }, r)
                                );
                            },
                            () => (0, A.useContext)(t),
                        ];
                ...
                const f = B.O.client.getSize('rem'),
                    ...
                    M = (u) => {
                        ...
                        const E = (0, A.useContext)(w),
                            ...
                            c = E.mediumHeight,
                            d = E.smallHeight,
                            g = E.extraSmallHeight,
                            h = { extraLarge: m, large: s, medium: c, small: d, extraSmall: g };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && B) return _(e, t, h);
                            if (t.largeWidth && i) return _(e, t, h);
                            if (t.mediumWidth && C) return _(e, t, h);
                            if (t.smallWidth && l) return _(e, t, h);
                            if (t.extraSmallWidth && o) return _(e, t, h);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                ...
                ((0, A.memo)(({ children: u }) => {
                    const e = (0, A.useContext)(w),
                        ...
                        D = (0, A.useCallback)((u, e) => {
                            ...
                            r(Object.assign({ width: t, height: A }, p(t, A, h)));
                        }, []);
                    (((u) => {
                    ...
                    return E().createElement(w.Provider, { value: n }, u);
                }),
                    (function (u) {
                ...
                const O = ['xl', 'lg', 'md', 'sm', 'xs'],
                    P = (u) => u.includes('_') && ((u) => O.includes(u))(u.split('_').at(-1)),
                    ...
                    N = (u, e) =>
                        Object.keys(u).reduce((t, A) => {
                            ...
                            return (
                                void 0 === E ||
                                    ((u, e) => O.some((t) => void 0 !== e[`${u}_${t}`]))(A, u) ||
                                    (t[A] = E),
                                t
                            );
                        }, {}),
                ...
                const z = {
                    ...
                    V = G((u) => {
                        let e = u.className,
                            ...
                            s = u.row,
                            d = u.flexDirection,
                            g = void 0 === d ? (m ? 'column' : s && 'row') || void 0 : d,
                            _ = u.flexStart,
                            h = u.center,
                            x = u.flexEnd,
                            p = u.spaceBetween,
                        ...
                        const V = (0, A.useMemo)(() => {
                                const u = { mt: n, mr: B, mb: C, ml: o },
                                    e = ((u) =>
                                        k.reduce((e, t) => {
                                            const A = u[t];
                                            return A && 'number' != typeof A ? e.concat(z[!0 === A ? 'MD' : A][t]) : e;
                                        }, []))(u),
                                    A = ((u) =>
                                        k.reduce((e, t) => {
                                            const A = u[t];
                ...
                const K = (u, e, t) => {
                    ...
                    q = (u, e, t = $.left) => u.split(e).reduce(t === $.left ? K : Y, []),
                    Q = (() => {
                        const u = new RegExp(
                    ...
                    Z = ['zh_cn', 'zh_sg', 'zh_tw'],
                    J = ({ binding: u, text: e = '', classMix: t, alignment: F = $.left }) =>
                        null === e
                ...
                const Fu = Object.keys(eu()),
                    ...
                    iu = G((u) => {
                        ...
                        return E().createElement(
                            ...
                            Eu(
                                {
                                    className: c()(tu.base, t && tu[t], x, F),
                                    style: h,
                                    mt: !0 === a ? au[t || 'paragraph-P16'].mt : a,
                                    mr: !0 === i ? au[t || 'paragraph-P16'].mr : i,
                                    mb: !0 === l ? au[t || 'paragraph-P16'].mb : l,
                                    ml: !0 === m ? au[t || 'paragraph-P16'].ml : m,
                                },
                                g,
                            ),
                    ...
                    Cu = (0, D.observer)(() => {
                        ...
                        return E().createElement(
                            'div',
                            { className: 'App_base_f1' },
                            E().createElement(
                                'div',
                                { className: 'App_iconWrapper_a2' },
                                E().createElement('img', { src: A, className: 'App_img_1d', alt: ' ' }),
                            ),
                            E().createElement(
                                'div',
                                { className: 'App_textWrapper_ed' },
                                E().createElement(iu, { text: e, className: 'App_title_e1' }),
                                E().createElement(iu, { text: t, className: 'App_description_88' }),
                            ),
                        );
                    });
                var lu = t(6711);
                engine.whenReady.then(() => {
                    r().render(
                        E().createElement(o, null, E().createElement(lu.c, null, E().createElement(Cu, null))),
