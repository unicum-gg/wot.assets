        ...
        e = {
            ...
            2557: (u, e, t) => {
                ...
                const au = U.client.getSize('rem'),
                    Bu = au.width,
                    nu = au.height,
                    iu = Object.assign({ width: Bu, height: nu }, Du(Bu, nu, Eu)),
                    ...
                    ou = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && B) return Fu(e, t, g);
                            if (t.largeWidth && n) return Fu(e, t, g);
                ...
                (0, $.memo)(({ children: u }) => {
                    ...
                    return K().createElement(Cu.Provider, { value: r }, u);
                }),
                    (function (u) {
                ...
                const bu = {
                    ...
                    Lu = xu((u) => {
                        ...
                        const G = (0, $.useMemo)(() => {
                            ...
                            }, [t, A, r, B, i, l, O, H, S, d, M, p, b]),
                            N = G.computedStyle,
                            j = G.computedClassNames;
                        return K().createElement('div', vu({ className: a()(fu.base, ...j, e), style: N }, W), P);
                    });
                let Mu;
                !(function (u) {
                            ...
                            Xu(
                                {
                                    ...
                                    mr: !0 === n ? Uu[t || 'paragraph-P16'].mr : n,
                                    mb: !0 === C ? Uu[t || 'paragraph-P16'].mb : C,
                                    ml: !0 === o ? Uu[t || 'paragraph-P16'].ml : o,
                                },
                                d,
                            ),
                            void 0 !== s ? K().createElement(Pu, Xu({}, s, { text: e })) : e,
                        );
                    });
                function Yu() {
                    return !1;
                ...
                const Zu = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const r = (0, $.useRef)([]),
                                    D = (u, t, A) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            n = (({ observableModel: u }) => ({ root: u.object() }))({
                                                mode: u,
                                                readByPath: a,
                                                externalModel: D,
                                                observableModel: {
                                            ...
                                            i = { mode: u, model: n, externalModel: D, cleanup: B };
                                        return {
                                            model: n,
                                    ...
                                    n = B[0],
                                    i = B[1],
                                    C = (0, $.useState)(() => D(u, A, E)),
                                    l = C[0],
                                    o = C[1];
                                return (
                                    (0, $.useEffect)(() => {
                                        a.current ? o(D(n, A, E)) : (a.current = !0);
                                    }, [E, n, A]),
                                    (0, $.useEffect)(() => {
                                        i(u);
                                    }, [u]),
                    ...
                    te = (0, eu.observer)(() => {
                        ...
                        return K().createElement(
                            'div',
                            { className: 'App_base_52' },
                            K().createElement('div', { className: 'App_bg_ba' }),
                            K().createElement(Ku, { text: e, className: 'App_header_b0' }),
                            t && K().createElement(Ku, { text: t, className: 'App_body_b3' }),
                        );
                    });
                engine.whenReady.then(() => {
                    uu().render(
                        K().createElement(ue, null, K().createElement(Z, null, K().createElement(te, null))),
    ...
    (A.m = e),
        ...
        (A.O = (e, t, F, E) => {
            if (!t) {
                ...
                for (n = 0; n < u.length; n++) {
                    for (var [t, F, E] = u[n], D = !0, a = 0; a < t.length; a++)
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); B < r.length; B++) (E = r[B]), A.o(u, E) && u[E] && u[E][0](), (u[E] = 0);
                    return A.O(n);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t)));
        })();
    var F = A.O(void 0, [503], () => A(2557));
    F = A.O(F);
})();
