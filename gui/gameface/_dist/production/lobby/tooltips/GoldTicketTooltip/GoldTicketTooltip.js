        ...
        e = {
            ...
            751: (u, e, A) => {
                ...
                const ru = U.client.getSize('rem'),
                    ...
                    lu = (u) => {
                        ...
                        if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
                            ...
                            if (A.extraLargeWidth && a) return Fu(e, A, _);
                            if (A.largeWidth && n) return Fu(e, A, _);
                            if (A.mediumWidth && i) return Fu(e, A, _);
                            if (A.smallWidth && C) return Fu(e, A, _);
                ...
                const vu = {
                    ...
                    bu = hu((u) => {
                        let e = u.className,
                            ...
                            T = u.shrink,
                            H = u.flex,
                            y = void 0 === H ? (R || T ? `${R ? 1 : 0} ${T ? 1 : 0} auto` : void 0) : H,
                            O = u.style,
                            P = u.children,
                            W = (function (u, e) {
                                if (null == u) return {};
                        ...
                        return $().createElement('div', fu({ className: B()(xu.base, ...X, e), style: N }, W), P);
                    });
                let Lu;
                !(function (u) {
                ...
                const Mu = (u, e, A) => {
                    ...
                    Tu = (u, e, A = Lu.left) => u.split(e).reduce(A === Lu.left ? Mu : Ru, []),
                    Hu = (() => {
                        const u = new RegExp(
                ...
                const ju = Object.keys(Wu()),
                    ...
                    Ku = hu((u) => {
                        ...
                        return $().createElement(
                            ...
                            Xu(
                                {
                                    className: B()(Gu.base, A && Gu[A], c, F),
                                    style: _,
                    ...
                    $u = 'App_description_2b',
                    Yu = R.strings.mt_birthday.allRewards.tooltip.goldTicket,
                    qu = () =>
                        $().createElement(
                            'div',
                            { className: 'App_base_86' },
                            $().createElement(Ku, { text: Yu.header(), className: 'App_header_22' }),
                            $().createElement('div', { className: 'App_icon_8c' }),
                            $().createElement(Ku, { text: Yu.description(), className: $u }),
                            $().createElement('div', { className: 'App_divider_35' }),
                            $().createElement(Ku, { text: Yu.howToEarn.header(), className: 'App_subHeader_f7' }),
                            $().createElement(Ku, { text: Yu.howToEarn.description(), className: $u }),
                        );
