        ...
        e = {
            ...
            4885: (u, e, t) => {
                ...
                const J = Y().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        Y().createElement(
                            'div',
                            Z({}, r, {
                                className: a()(q.base, q[`base__theme-${F}`], A),
                                ref: function (u) {
                ...
                const au = $.client.getSize('rem'),
                    ...
                    ou = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && n) return Eu(e, t, g);
                ...
                const bu = {
                    ...
                    Lu = xu((u) => {
                        ...
                        const N = (0, K.useMemo)(() => {
                            ...
                            }, [t, A, r, n, i, l, O, H, w, d, M, p, b]),
                            G = N.computedStyle,
                            j = N.computedClassNames;
                        return Y().createElement('div', vu({ className: a()(fu.base, ...j, e), style: G }, W), P);
                    });
                let Mu;
                !(function (u) {
                ...
                const Ju = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    te = ue[1],
                    Ae = 'App_divider_35',
                    Ee = R.strings.mt_birthday.allRewards.tooltip.goldTicket,
                    Fe = (0, Yu.Pi)(() => {
                        ...
                        return Y().createElement(
                            ...
                            Y().createElement(
                                'div',
                                { className: 'App_headerContainer_c7' },
                                Y().createElement(Ku, { text: Ee.header(), className: 'App_header_22' }),
                            ),
                            Y().createElement(Ku, { text: Ee.description(), className: 'App_description_2b' }),
                            Y().createElement('div', { className: Ae }),
                            Y().createElement(
                                'div',
                                { className: 'App_currencyCountContainer_68' },
                                Y().createElement(Ku, {
                                    text: Ee.count(),
                                    format: {
                                        binding: {
                                            count: Y().createElement(Ku, {
                                                text: String(u),
                                                className: 'App_currencyCount_73',
                                            }),
                                        },
                                    },
                                }),
                            ...
                            Y().createElement('div', { className: Ae }),
                            Y().createElement(Ku, { text: Ee.howToEarn.header(), className: 'App_subHeader_f7' }),
                            Y().createElement(Ku, {
                                text: Ee.howToEarn.description(),
                                className: 'App_howToEarnDescription_fe',
                            }),
                        );
                    });
                engine.whenReady.then(() => {
