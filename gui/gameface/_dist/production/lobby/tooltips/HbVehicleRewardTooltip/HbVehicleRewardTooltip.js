    ...
    var __webpack_modules__ = {
            ...
            5950: (u, e, t) => {
                ...
                const l = r().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            r().createElement(
                                'div',
                                c({}, l, {
                                    className: E()(A.base, A[`base__theme-${a}`], o),
                                    ref: function (u) {
                ...
                const C = (u, e, t = {}, n = 0) => {
                    ...
                    p = (u) => {
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            T = (0, n.useMemo)(() => m || D().resId, [m]),
                            y = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (C(t, d, { isMouseEvent: !0, on: !0, arguments: _(r) }, T),
                                    v && v(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((g.current.timeoutId = window.setTimeout(y, A ? 100 : 400)),
                                                          o && o(u),
                                                          M && M(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                            ...
                            f(
                                {
                                    contentId:
                                        ...
                                        F ? b.SimpleTooltipHtmlContent('resId') : b.SimpleTooltipContent('resId')),
                ...
                const y = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return o || a
                        ? r().createElement(p, T({}, e, { contentId: o || a }), n)
                ...
                const x = { [P.NBSP]: L.NoBreakSymbol, [P.ZWNBSP]: L.NoBreakSymbol, [P.NEW_LINE]: L.LineBreak },
                    S = {
                    ...
                    U = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? S[n]
                                ? r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: S[n] },
                                      u,
                                  )
                                : r().createElement('span', { key: t, 'data-block-type': e.blockType, style: I(n) }, u)
                    ...
                    V = {
                        ...
                        [L.LineBreak]: ({ key: u }) =>
                            r().createElement('span', {
                                key: u,
                                'data-block-type': L.LineBreak,
                                className: 'renderers_lineBreak_b5',
                            }),
                        [L.NewLine]: ({ elementList: u, key: e }) =>
                            r().createElement(
                                'span',
                                { key: e, 'data-block-type': L.NewLine, className: 'renderers_newLine_bd' },
                                u,
                            ),
                        [L.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            r().createElement(
                                ...
                                {
                                    key: e,
                                    'data-block-type': L.NoBreakWrapper,
                    ...
                    K = (u, e = '') => {
                        ...
                        return (
                            H(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: L.Word, colorTag: e, childList: j(u) });
                                },
                                (u) => {
                                    const n = u[0],
                                        r = x[n.charAt(0)];
                            ...
                            H(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof o || 'number' == typeof o
                                        ? n.push(...K(String(o), t))
                                        : n.push({ blockType: L.Binding, colorTag: t, childList: [o] });
                                },
                            ),
                            n
                        );
                            ...
                            return (
                                u.forEach((u) => {
                                    u.blockType === L.NoBreakSymbol
                                        ? ((t = !0), e.push(...z(e.pop(), u)))
                                        : (t ? e.push(...z(e.pop(), u)) : e.push(u), (t = !1));
                                }),
                                e
                            );
                        })(
                    ...
                    X = (u, e, t, n, o, i) => {
                        ...
                        for (let s = t; s >= 0; s--) {
                            const t = u[s],
                                A = Number(u[s].getAttribute('data-block-type'));
                            if (A === L.LineBreak || A === L.NewLine || A === L.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const l = F.slice(0, F.length - c) + i,
                                    D = e[s];
                                (E = r().cloneElement(D, D.props, l)), (a = s);
                                break;
                            }
                            {
                                const u = t.children,
                                    A = e[s],
                                    c = A.props.children,
                                    l = X(u, c, u.length - 1, n, o, i),
                                    D = l[0],
                                    d = l[1];
                                if (!(D < 0)) {
                                    const u = c.slice(0, D);
                                    (E = r().cloneElement(A, A.props, u, d)), (a = s);
                                    break;
                                }
                                o -= F.length;
                            }
                    ...
                    Q = r().memo(
                        ({
                            ...
                            targetId: s,
                            justifyContent: A = N.FlexStart,
                            alignContent: F = N.FlexStart,
                            truncateIdentify: c = '...',
                        }) => {
                            const l = (0, n.useRef)(null),
                                ...
                                w = (0, n.useMemo)(() => ({ justifyContent: A, alignContent: F }), [F, A]);
                            return (
                                ((u, e, t = !0) => {
                ...
                ((uu = J || (J = {})).SHORT_DATE = 'short-date'),
                    ...
                    Date.now();
                const eu = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                            ...
                            s = (0, n.useState)(() =>
                                ((u) => {
                                    ...
                                    ((u) =>
                                        ((u, e) =>
                                            u.split('.').reduce((u, e) => {
                                                const t = eu(`${u}.${e}`, window);
                                                return tu(t) ? ((u, e) => `${u}.${e}.value`)(u, e) : `${u}.${e}`;
                                            }))(u))(E),
                                ),
                            ),
                            A = s[0],
                        ...
                        return (
                            ((u) => {
                                ...
                                if (
                                                    ...
                                                    const e = D(),
                                                        ...
                                                        r =
                                                            window.__feature && window.__feature !== t && t
                                                                ? `subViews.${t}`
                                                                : '';
                                                    return { modelPrefix: r, modelPath: nu(r, ''), resId: n };
                                                })(),
                                                t = e.modelPrefix,
                                                n = u.split('.');
                                            if (n.length > 0) {
                                    ...
                                    c.current = ru.addCallback(n, t, a, e === ou.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== ou.None)
                                    return () => {
                                        ru.removeCallback(c.current, a);
                                    };
                            }, [a, e]),
                            A
                        );
                    },
                    au = (d.Sw.instance, 'HbVehicleRewardTooltipApp_base_ae'),
                    Eu = 'HbVehicleRewardTooltipApp_description_7a',
                    su = 'HbVehicleRewardTooltipApp_highlightedSilver_66',
                    Au = 'HbVehicleRewardTooltipApp_highlightedGold_59',
                    Fu = R.strings.historical_battles_progression.progressionView,
                    cu = () => {
                        const u = iu('model').discount,
                            e = Fu.rewardBuyDesc(),
                            t = Fu.rewardPersonalDiscountInfo(),
                            o = u ? Fu.rewardNoPersonalDiscountExist() : Fu.rewardNoPersonalDiscount(),
                            i = (0, n.useMemo)(
                                () => ({
                                    free: r().createElement('div', { className: su }, Fu.rewardForFree()),
                                    vehicleLevel: r().createElement('div', { className: Au }, Fu.rewardLevel()),
                                    vehicleName: r().createElement('div', { className: Au }, Fu.rewardTankName()),
                                }),
                                [],
                            ),
                            a = (0, n.useMemo)(
                                () => ({
                                    icon: r().createElement('div', {
                                        className: E()(
                                            'HbVehicleRewardTooltipApp_attentionIcon_4e',
                                            Boolean(u) && 'HbVehicleRewardTooltipApp_discountIcon_f2',
                                        ),
                                    }),
                                    discount: r().createElement(
                                        'div',
                                        { className: 'HbVehicleRewardTooltipApp_discountText_27' },
                                        `${u}%`,
                                    ),
                                }),
                                [u],
                            ...
                            s = (0, n.useMemo)(
                                () => ({
                                    discount: r().createElement('div', { className: su }, Fu.rewardWithDiscount()),
                                    discountPercent: r().createElement('div', { className: su }, Fu.discountPercent()),
                                    discountFull: r().createElement('div', { className: su }, Fu.discountFull()),
                                }),
                                [],
                            );
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: 'HbVehicleRewardTooltipApp_content_b3' },
                                    r().createElement(
                                        'div',
                                        { className: 'HbVehicleRewardTooltipApp_header_b1' },
                                        Fu.rewardBuyLabel(),
                                    ),
                                    r().createElement(Q, { text: e, binding: i, classMix: Eu }),
                                    r().createElement('div', { className: 'HbVehicleRewardTooltipApp_divider_13' }),
                                    r().createElement(Q, {
                                        text: o,
                                        binding: a,
                                        classMix: 'HbVehicleRewardTooltipApp_discount_4d',
                                    }),
                                    r().createElement(Q, { text: t, binding: s, classMix: Eu }),
                                ),
                            ),
                        );
                    };
