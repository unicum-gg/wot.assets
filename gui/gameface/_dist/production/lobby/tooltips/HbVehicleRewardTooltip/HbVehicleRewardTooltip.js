(() => {
    ...
    var __webpack_modules__ = {
            ...
            5950: (u, e, t) => {
                ...
                const l = r().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            r().createElement(
                                'div',
                                c({}, l, {
                                    className: s()(A.base, A[`base__theme-${a}`], o),
                                    ref: function (u) {
                ...
                const P = { [x.NBSP]: L.NoBreakSymbol, [x.ZWNBSP]: L.NoBreakSymbol, [x.NEW_LINE]: L.LineBreak },
                    S = {
                            ...
                            return (
                                u.forEach((u) => {
                                    u.blockType === L.NoBreakSymbol
                                        ? ((t = !0), e.push(...q(e.pop(), u)))
                                        : (t ? e.push(...q(e.pop(), u)) : e.push(u), (t = !1));
                                }),
                                e
                            );
                        })(
                ...
                const iu = (u = 'model', e = ou.Deep) => {
                    ...
                    su = 'HbVehicleRewardTooltipApp_description_7a',
                    Eu = 'HbVehicleRewardTooltipApp_highlightedSilver_66',
                    ...
                    cu = () => {
                        const u = iu('model').discount,
                            ...
                            i = (0, n.useMemo)(
                                () => ({
                                    free: r().createElement('div', { className: Eu }, Fu.rewardForFree()),
                            ...
                            E = (0, n.useMemo)(
                                () => ({
                                    discount: r().createElement('div', { className: Eu }, Fu.rewardWithDiscount()),
                                    discountPercent: r().createElement('div', { className: Eu }, Fu.discountPercent()),
                                    discountFull: r().createElement('div', { className: Eu }, Fu.discountFull()),
                                }),
                                [],
                            );
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(Q, { text: e, binding: i, classMix: su }),
                                    ...
                                    r().createElement(Q, { text: t, binding: E, classMix: su }),
                                ),
                            ),
                        );
                    };
