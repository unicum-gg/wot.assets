            ...
            3463: (u, e, t) => {
                ...
                const eu = {
                    ...
                    ru = Z((u) => {
                        ...
                        return r().createElement('div', uu({ className: n()(Q.base, ...U, e), style: G }, W), k);
                    });
                var Au = t(3532),
                    Fu = t.n(Au);
                const au = {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    e.items.map(({ value: { name: u } }, t) =>
                                        r().createElement(
                                            'div',
                                            { key: t, className: 'Content_tank_c1' },
                                            `${u}${t < e.items.length - 1 ? ',' : ''}`,
                                        ),
                                    ),
                                ),
                            ),
                            r().createElement(_u, { className: 'Content_footerTitle_45', text: cu.footerTitle() }),
