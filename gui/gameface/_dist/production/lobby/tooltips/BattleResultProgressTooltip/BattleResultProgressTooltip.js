(() => {
            ...
            4179: (u, e, t) => {
                ...
                const b = F.instance,
                    f = {
                        ...
                        sendMoveEvent: (u) => w(o.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: p,
                        sendClosePopOverEvent: () => w(o.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, t = 0) => {
                            w(o.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                        },
            ...
            2255: (u, e, t) => {
                ...
                const B = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            s({}, B, {
                                className: o()(D.base, D[`base__theme-${r}`], E),
                                ref: function (u) {
                ...
                const b = (u = 'model', e = h.Deep) => {
                        ...
                        return (
                            ((u) => {
                                ...
                                if (
                                                    ...
                                                    const e = d(),
                                                        ...
                                                        F =
                                                            window.__feature && window.__feature !== t && t
                                                                ? `subViews.${t}`
                                                                : '';
                                                    return { modelPrefix: F, modelPath: p(F, ''), resId: A };
                                                })(),
                                                t = e.modelPrefix,
                                                A = u.split('.');
                                            if (A.length > 0) {
                                    ...
                                    s.current = m.addCallback(A, t, r, e === h.Deep);
                                }
                            }),
                            (0, A.useEffect)(() => {
                                if (e !== h.None)
                                    return () => {
                                        m.removeCallback(s.current, r);
                                    };
                            }, [r, e]),
                            D
                        );
                    ...
                    f =
                        (l.Sw.instance,
                        {
                            base: 'BattleResultProgressTooltipApp_base_7f',
                            base__defence: 'BattleResultProgressTooltipApp_base__defence_02',
                            content: 'BattleResultProgressTooltipApp_content_9e',
                            contentInner: 'BattleResultProgressTooltipApp_contentInner_97',
                            iconWrapper: 'BattleResultProgressTooltipApp_iconWrapper_93',
                            icon: 'BattleResultProgressTooltipApp_icon_97',
                            title: 'BattleResultProgressTooltipApp_title_b9',
                            description: 'BattleResultProgressTooltipApp_description_9f',
                        }),
                    g = {
                        backgroundImage: `url('${R.images.historical_battles.gui.maps.icons.common.stats.c_48x48.flag()}')`,
                    },
                    O = () => {
                        const u = b('model').frontName,
                            e = o()(f.base, f[`base__${u}`]);
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                F().createElement(
                                    'div',
                                    { className: f.contentInner },
                                    F().createElement(
                                        'div',
                                        { className: f.iconWrapper },
                                        F().createElement('div', { className: f.icon, style: g }),
                                    ),
                                    F().createElement(
                                        'div',
                                        { className: f.content },
                                        F().createElement(
                                            'span',
                                            { className: f.title },
                                            R.strings.hb_lobby.battleResults.tooltip.title.$dyn(u),
                                        ),
                                        F().createElement(
                                            'span',
                                            { className: f.description },
                                            R.strings.hb_lobby.battleResults.tooltip.description.$dyn(u),
                                        ),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    n().render(F().createElement(O, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(2255));
