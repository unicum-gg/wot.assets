(() => {
    var __webpack_modules__ = {
            ...
            3694: (u, e, t) => {
                ...
                const l = A().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            A().createElement(
                                'div',
                                o({}, l, {
                                    className: n()(i.base, i[`base__theme-${a}`], r),
                                    ref: function (u) {
                                ...
                                ((u) =>
                                    ((u, e) =>
                                        u.split('.').reduce((u, e) => {
                                            ...
                                            return d(t) ? ((u, e) => `${u}.${e}.value`)(u, e) : `${u}.${e}`;
                                        }))(u))(n),
                            ),
                        ),
                        i = D[0],
                    ...
                    return (
                        _(() => {
                            if (
                                                ...
                                                const e = s(),
                                                    ...
                                                    A =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: A, modelPath: c(A, ''), resId: E };
                                            })(),
                                            t = e.modelPrefix,
                                            E = u.split('.');
                                        if (E.length > 0) {
                                            ...
                                            return (
                                                E.reduce((e, E) => {
                                                    const A = C(c(t, `${e}.${E}`), window);
                                                    return d(A)
                                                        ? (u.push(A.id), `${e}.${E}.value`)
                                                        : (u.push(E), `${e}.${E}`);
                                                }),
                                                u.reduce((u, e) => u + '.' + e)
                                            );
                                ...
                                o.current = h.addCallback(E, t, a, e === g.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== g.None)
                                return () => {
                                    h.removeCallback(o.current, a);
                                };
                        }, [a, e]),
                        i
                    );
                ...
                const L = D.O.client.getSize('rem'),
                    M = L.width,
                    O = L.height,
                    T = Object.assign({ width: M, height: O }, S(M, O, f)),
                    P = (0, E.createContext)(T),
                    y = ['children'],
                    N = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && i) return v(e, t, h);
                            if (t.largeWidth && B) return v(e, t, h);
                            if (t.mediumWidth && o) return v(e, t, h);
                            if (t.smallWidth && l) return v(e, t, h);
                            if (t.extraSmallWidth && s) return v(e, t, h);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                    ...
                    (0, E.memo)(({ children: u }) => {
                        const e = (0, E.useContext)(P),
                            ...
                            a = (0, E.useCallback)((u, e) => {
                                ...
                                F(Object.assign({ width: t, height: E }, S(t, E, f)));
                            }, []);
                        (_(() => {
                        ...
                        return A().createElement(P.Provider, { value: n }, u);
                    }),
                    (function (u) {
                ...
                const I = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    G = [H.ExtraLarge, H.Large, H.Medium, H.Small, H.ExtraSmall],
                    j = (u, e) =>
                        Object.keys(u).reduce((t, E) => {
                            ...
                            return (
                                void 0 === A ||
                                    ((u, e) => I.some((t) => void 0 !== e[`${u}_${t}`]))(E, u) ||
                                    (t[E] = A),
                                t
                            );
                        }, {}),
                ...
                const q = {
                    ...
                    Z = X((u) => {
                        let e = u.className,
                            ...
                            f =
                                void 0 === v
                                    ...
                                    : v,
                            b = u.alignItems,
                            S = void 0 === b ? (h ? 'flex-start' : g && 'center') || (p && 'flex-end') || void 0 : b,
                            L = u.alignSelf,
                            M = u.wrap,
                            O = u.flexWrap,
                        ...
                        const I = (0, E.useMemo)(() => {
                                const u = { mt: D, mr: B, mb: l, ml: C },
                                    e = ((u) =>
                                        Y.reduce((e, t) => {
                                            const E = u[t];
                                            return E && 'number' != typeof E ? e.concat(q[!0 === E ? 'MD' : E][t]) : e;
                                        }, []))(u),
                                    E = ((u) =>
                                        Y.reduce((e, t) => {
                                            const E = u[t];
                                            return ('number' == typeof E && (e[$[t]] = E + 'rem'), e);
                                        }, {}))(u);
                                return {
                            ...
                            }, [t, r, D, B, l, C, H, N, L, c, T, f, S]),
                            U = I.computedStyle,
                            G = I.computedClassNames;
                        return A().createElement('div', z({ className: n()(K.base, ...G, e), style: U }, W), k);
                    });
                let Q;
                !(function (u) {
                    ...
                    _u = X((u) => {
                        ...
                        const h = (0, E.useMemo)(() => {
                                const u = Cu(F),
                                    ...
                                    t = u.colorStyle,
                                    E = void 0 === t ? {} : t;
                                return { computedStyle: Object.assign({}, m, E), colorClassName: e };
                            }, [m, F]),
                            g = h.computedStyle,
                            p = h.colorClassName;
                        return A().createElement(
                            ...
                            Du(
                                {
                                    className: n()(au.base, t && au[t], p, r),
                                    style: g,
                                    mt: !0 === i ? su[t || 'paragraph-P16'].mt : i,
                            ...
                            void 0 !== d ? A().createElement(Au, Du({}, d, { text: e })) : e,
                        );
                    }),
                    mu = {
                        base: 'Content_base_22',
                        content: 'Content_content_ba',
                        base__boss2025: 'Content_base__boss2025_19',
                        base__bossSpecial: 'Content_base__bossSpecial_e3',
                        title: 'Content_title_7f',
                        descriptionTitle: 'Content_descriptionTitle_6a',
                        description: 'Content_description_e6',
                        titleIcon: 'Content_titleIcon_2d',
                    },
                    du = () => {
                        const u = p('model', g.None),
                            e = u.title,
                            t = u.subtitle,
                            E = u.description,
                            r = u.icon,
                            F = u.wtVehicleType,
                            a = { backgroundImage: `url(${r})` },
                            D = n()(mu.base, mu[`base__${F}`]);
                        return A().createElement(
                            'div',
                            { className: D },
                            A().createElement(
                                ...
                                A().createElement('div', { className: mu.titleIcon, style: a }),
                                A().createElement(_u, { className: mu.title, text: e }),
                                A().createElement(_u, { className: mu.descriptionTitle, text: t }),
                                A().createElement(Au, { text: E, classMix: mu.description }),
                            ),
                        );
                    },
                    cu = () => A().createElement(l, null, A().createElement(du, null));
                engine.whenReady.then(() => {
                    F().render(A().createElement(cu, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(3694));
