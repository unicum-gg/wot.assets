(() => {
    ...
    var __webpack_modules__ = {
            ...
            921: (u, e, A) => {
                                ...
                                ((u) =>
                                    ((u, e) =>
                                        u.split('.').reduce((u, e) => {
                                            ...
                                            return l(A) ? ((u, e) => `${u}.${e}.value`)(u, e) : `${u}.${e}`;
                                        }))(u))(B),
                            ),
                        ),
                        r = C[0],
                                                ...
                                                const e = s(),
                                                    ...
                                                    E =
                                                        window.__feature && window.__feature !== A && A
                                                            ? `subViews.${A}`
                                                            : '';
                                                return { modelPrefix: E, modelPath: d(E, ''), resId: F };
                                            })(),
                                            A = e.modelPrefix,
                                            F = u.split('.');
                                        if (F.length > 0) {
                ...
                const h = (u, e, A) => {
                    ...
                    O = ['zh_cn', 'zh_sg', 'zh_tw'],
                    y = ({ binding: u, text: e = '', classMix: A, alignment: D = p.left }) =>
                        null === e
                    ...
                    P = R.images.white_tiger.gui.maps.icons.carousel,
                    T = () => {
                        const u = m('model', w.None),
                            e = u.title,
                            A = u.subtitle,
                            D = u.description,
                            t = u.icon,
                            ...
                            B = (0, F.useMemo)(
                                () => ({
                                    backgroundImage: `url(${P.$dyn(n ? 'tank_corner_special' : 'tank_corner')})`,
                                }),
                                [n],
                            ),
                            C = (0, F.useMemo)(() => ({ backgroundImage: `url(${t})` }), [t]);
                        return E().createElement(
                            'div',
                            { className: 'Content_base_22' },
                            E().createElement(
                                'div',
                                { className: 'Content_content_ba', style: B },
                                E().createElement('div', { className: 'Content_titleIcon_2d', style: C }),
                                E().createElement('div', { className: 'Content_title_7f' }, e),
                                E().createElement('div', { className: 'Content_descriptionTitle_6a' }, A),
                                E().createElement(
                                    'div',
                                    { className: 'Content_description_e6' },
                                    E().createElement(y, { text: D }),
                                ),
                            ),
                        );
                    },
                    M = () => E().createElement(a, null, E().createElement(T, null));
                engine.whenReady.then(() => {
                    t().render(E().createElement(M, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(921));
