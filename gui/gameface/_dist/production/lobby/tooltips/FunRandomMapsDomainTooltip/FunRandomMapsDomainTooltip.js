    ...
    var u,
        e = {
            ...
            6993: (u, e, t) => {
                ...
                const uu = Object.keys(L).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === L[e]), u), {}),
                    eu = {
                        set: (u, e) => {
                ...
                const vu = {
                    ...
                    wu = hu((u) => {
                        ...
                        return a().createElement('div', fu({ className: m()(xu.base, ...z, e), style: X }, G), W);
                    });
                let Lu;
                !(function (u) {
                ...
                const Ee = {
                        ...
                        [Ae.POINTS_PER_SECOND]: R.strings.fun_random.domainTooltip.modifier.format.points_per_second(),
                    },
                    ...
                    re = (0, i.Pi)(() => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(Uu, { className: 'App_mainText_86', text: Fe.description.repair_zone() }),
                            u.length > 0 &&
                                a().createElement(
                                    a().Fragment,
                                    null,
