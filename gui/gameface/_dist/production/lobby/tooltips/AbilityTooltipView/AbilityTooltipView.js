(() => {
    ...
    var u,
        e = {
            2221: (u, e, F) => {
                var A = {};
                (F.r(A),
                    F.d(A, { mouse: () => p, off: () => g, on: () => d, onResize: () => l, onScaleUpdated: () => c }));
                var E = {};
                (F.r(E),
                    F.d(E, {
                        events: () => A,
                ...
                const w = {
                    ...
                    T = { play: Object.assign({}, _, { sound: v }), setRTPC: f },
                ...
                const iu = { view: t, client: E, sound: T, intl: x };
                const au = {
                ...
                const pu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    hu = (u, e, F = mu.left) => u.split(e).reduce(F === mu.left ? vu : fu, []),
                    bu = (() => {
                        const u = new RegExp(
                            [
                    ...
                    xu = ({ binding: u, text: e = '', classMix: F, alignment: A = mu.left, formatWithBrackets: E }) => {
                        ...
                        return n().createElement(
                            ...
                            D.split('\n').map((e, E) =>
                                n().createElement(
                                    'div',
                                    { className: i()('FormatText_base_d0', F), key: `${e}-${E}` },
                                    ((u, e, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                            F && u in F
                                                ? F[u]
                    ...
                    Tu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Pu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Su = (0, B.memo)(({ text: u, binding: e, classMix: F }) => {
                ...
                const Mu = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    Wu = zu[0],
                    ju = zu[1],
                    Lu = R.images.gui.maps.icons.battleRoyale.artefact.c_80x80,
                    Vu = R.strings.tooltips.battle_royale.hangar.tankSetupPanel,
                    Nu = (0, du.Pi)(() => {
                        const u = ju().model,
                            e = u.iconName.get();
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    { className: 'App_container_52' },
                                    n().createElement(
                                        'div',
                                        { className: 'App_header_57' },
                                        n().createElement('div', {
                                            className: 'App_icon_ca',
                                            style: { backgroundImage: `url(${Lu.$dyn(e)})` },
                                        }),
                                        n().createElement(
                                            'div',
                                            { className: 'App_headerContainer_79' },
                                            n().createElement('div', { className: 'App_title_8f' }, u.title.get()),
                                            n().createElement(Su, {
                                                text: Vu.ability.cooldownTime(),
                                                binding: { cooldown: u.cooldownSeconds.get() },
                                                classMix: 'App_cooldown_7e',
                                            }),
                                        ),
                                    ),
                                    n().createElement(
                ...
                engine.whenReady.then(() => {
                    r().render(
                        n().createElement(Wu, null, n().createElement(Nu, null)),
    ...
    ((A.m = e),
        ...
        (A.j = 'lobby/tooltips/AbilityTooltipView/AbilityTooltipView'),
        (() => {
            var u = { 'lobby/tooltips/AbilityTooltipView/AbilityTooltipView': 0 };
            A.O.j = (e) => 0 === u[e];
            var e = (e, F) => {
                    var E,
                        D,
    ...
    var E = A.O(void 0, ['lib/battle_royale.vendors'], () => A(2221));
    E = A.O(E);
})();
