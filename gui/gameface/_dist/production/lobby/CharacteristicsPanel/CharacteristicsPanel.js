    ...
    var __webpack_modules__ = {
            ...
            6117: (u, e, t) => {
                ...
                const s = A.O.client.getSize('rem'),
                    l = s.width,
                    B = s.height,
                    _ = Object.assign({ width: l, height: B }, D(l, B, F)),
                    ...
                    m = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && D) return i(e, t, p);
                            if (t.largeWidth && s) return i(e, t, p);
                            if (t.mediumWidth && l) return i(e, t, p);
                ...
                const d = (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(c),
                        ...
                        i = (0, r.useCallback)((u, e) => {
                            ...
                            a(Object.assign({ width: t, height: r }, D(t, r, F)));
                        }, []);
                    ((u) => {
                ...
                const S = {
                    ...
                    y = (u) => {
                        ...
                        const E = f(),
                            ...
                            i = E.mediaHeight,
                            A = E.mediaSize;
                        return n().createElement('div', L({ className: g()(t, S[a], T[i], O[A]) }, r), e);
                    },
                    H = ['children'],
                    P = (u) => {
                        let e = u.children,
                ...
                class U extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = g()(I.base, I[`base__${a}`], I[`base__${E}`], null == i ? void 0 : i.base),
                            B = g()(I.icon, I[`icon__${a}`], I[`icon__${E}`], null == i ? void 0 : i.icon),
                            _ = g()(I.glow, null == i ? void 0 : i.glow),
                            c = g()(I.caption, I[`caption__${a}`], null == i ? void 0 : i.caption),
                            C = g()(I.goto, null == i ? void 0 : i.goto);
                        return n().createElement(
                            ...
                            'info' !== a && n().createElement('div', { className: I.shine }),
                            n().createElement('div', { className: B }, n().createElement('div', { className: _ })),
                ...
                const K = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: a, mocks: i }) {
                                const F = (0, r.useRef)([]),
                                    ...
                                    l = s[0],
                                    B = s[1],
                                    _ = (0, r.useState)(() => o(u, E, i)),
                                    c = _[0],
                                    C = _[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        D.current ? C(o(l, E, i)) : (D.current = !0);
                                    }, [i, l, E]),
                                    (0, r.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                    ...
                    })(0, ({ externalModel: u }) => ({ onLeaveClicked: u.createCallbackNoArgs('onLeaveClicked') })),
                    z = $[0],
                    q = $[1];
                var Y = t(9887),
                    Z = t.n(Y);
                const Q = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    uu = [b.ExtraLarge, b.Large, b.Medium, b.Small, b.ExtraSmall],
                    eu = (u, e) =>
                ...
                const au = {
                    ...
                    Fu = tu((u) => {
                        let e = u.className,
                            ...
                            x =
                                void 0 === w
                                    ...
                                    : w,
                            f = u.alignItems,
                            M = void 0 === f ? (d ? 'flex-start' : h && 'center') || (v && 'flex-end') || void 0 : f,
                            L = u.alignSelf,
                            S = u.wrap,
                            T = u.flexWrap,
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, E, A, o, s, B, k, P, L, m, O, x, M]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return n().createElement('div', Eu({ className: g()(ru.base, ...U, e), style: G }, I), N);
                    });
                let ou;
                !(function (u) {
                ...
                const Du = (u, e, t) => {
                    ...
                    lu = (u, e, t = ou.left) => u.split(e).reduce(t === ou.left ? Du : su, []),
                    Bu = (() => {
                        const u = new RegExp(
                    ...
                    cu = ({ binding: u, text: e = '', classMix: t, alignment: E = ou.left }) =>
                        null === e
                ...
                const vu = Object.keys(mu()),
                    ...
                    Mu = tu((u) => {
                        ...
                        return n().createElement(
                            ...
                            gu(
                                {
                                    className: g()(du.base, t && du[t], v, E),
                                    style: h,
                            ...
                            void 0 !== C ? n().createElement(cu, gu({}, C, { text: e })) : e,
                        );
                    }),
                    Lu = ({ text: u }) => n().createElement('div', { className: 'Features_base_c8' }, u);
                var Su = t(4179);
                const Tu = [
                    'children',
                    'contentId',
                ...
                const Ru = (u, e, t = {}, r = 0) => {
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (Ru(t, B, { isMouseEvent: !0, on: !0, arguments: Ou(n) }, p),
                                    d && d(),
                    ...
                    Hu = (0, r.memo)(({ parameter: u, icon: e }) => {
                        const t = (0, r.useMemo)(() => ({ backgroundImage: `url('${e}')` }), [e]),
                            E = R.strings.event.ttx.$dyn(u),
                            a = (0, r.useMemo)(() => ({ parameter: u }), [u]);
                        return n().createElement(
                            yu,
                            {
                                contentId: R.views.white_tiger.lobby.tooltips.VehicleParamsTooltipView('resId'),
                                args: a,
                            },
                            n().createElement(
                                'div',
                                { className: 'Advantage_item_c5' },
                                n().createElement('span', { className: 'Advantage_icon_55', style: t }),
                                n().createElement('span', { className: 'Advantage_text_53' }, E),
                            ),
                        );
                    });
                function Pu() {
                ...
                const ku = ({ items: u }) =>
                        n().createElement(
                            n().Fragment,
                            null,
                            u.map(({ value: u }, e) => n().createElement(Hu, Pu({ key: e }, u))),
                        ),
                    Nu = 'Panel_title_ef',
                    Iu = 'Panel_separator_f2',
                    Wu = 'Panel_itemList_cf',
                    Gu = R.strings.event.characteristicsPanel,
                    Uu = (0, k.observer)(() => {
                        const u = q().model.root.get(),
                            e = u.pros,
                            t = u.cons,
                            r = u.specialInfo;
                        return n().createElement(
                            'div',
                            { className: 'Panel_base_15' },
                            n().createElement(Mu, { className: Nu, text: Gu.pros() }),
                            n().createElement('div', { className: Wu }, n().createElement(ku, { items: e.items })),
                            n().createElement('div', { className: Iu }),
                            n().createElement(Mu, { className: Nu, text: Gu.cons() }),
                            n().createElement('div', { className: Wu }, n().createElement(ku, { items: t.items })),
                            n().createElement('div', { className: Iu }),
                            n().createElement(Mu, { className: Nu, text: Gu.features() }),
                            n().createElement('div', { className: Wu }, n().createElement(Lu, { text: r })),
                        );
                    }),
                    ju = (0, k.observer)(() => {
                        const u = q(),
                            e = u.model,
                            t = u.controls,
                            E = e.root.get().specialInfo,
                            a = t.onLeaveClicked,
                            i = (0, r.useRef)(null),
                            F = f().mediaSize < b.Medium;
                        return (
                            (0, r.useEffect)(
                                () =>
                                    ((u) => {
                            ...
                            n().createElement(
                                'div',
                                { className: 'App_base_e4', ref: i },
                                n().createElement(
                                    'div',
                                    { className: 'App_closeButton_27' },
                                    n().createElement(U, {
                                        caption: R.strings.white_tiger.hangar.close(),
                                        onClick: a,
                                        side: 'right',
                                        type: 'close',
                                    }),
                ...
                engine.whenReady.then(() => {
                    a().render(
                        n().createElement(z, null, n().createElement(P, null, n().createElement(ju, null))),
