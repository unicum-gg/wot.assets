(() => {
    var __webpack_modules__ = {
            ...
            70: (u, e, t) => {
                ...
                var r = {};
                (t.r(r),
                    t.d(r, { mouse: () => B, off: () => s, on: () => D, onResize: () => F, onScaleUpdated: () => o }));
                var a = {};
                (t.r(a),
                    t.d(a, {
                        events: () => r,
                ...
                var n = {};
                (t.r(n), t.d(n, { getBgUrl: () => b, getTextureUrl: () => f }));
                var E = {};
                function i(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const m = {
                    ...
                    p = { play: Object.assign({}, v, { sound: C }), setRTPC: c };
                var w = t(690);
                function f(u, e, t = 1) {
                ...
                const Au = { view: E, client: a, sound: p, intl: h };
            },
            521: (u, e, t) => {
                'use strict';
                let r, a;
            ...
            559: (u, e, t) => {
                ...
                (0, r.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.largeWidth && B) return n(e, t, p);
                ...
                const l = ({ children: u }) => {
                    ...
                    return (
                        ...
                        a().createElement(D.Provider, { value: t }, A && u)
                    );
                };
                var B = t(483),
                    C = t.n(B),
                ...
                const w = {
                    ...
                    x = (u) => {
                        ...
                        const n = g(),
                            ...
                            i = n.mediaHeight,
                            A = n.mediaSize;
                        return a().createElement('div', p({ className: C()(t, w[E], f[i], b[A]) }, r), e);
                    },
                    T = ['children'];
                const L = (u) => {
                    let e = u.children,
                    ...
                    return a().createElement(l, null, a().createElement(x, t, e));
                };
                var y = t(533),
                    S = t.n(y);
                function O(u) {
                ...
                const U = (u) => {
                    ...
                    return a().createElement(
                        ...
                        I(
                            {
                                className: C()(W.base, W[`base__${c}`], W[`base__${l}`], null == i ? void 0 : i.base),
                                onMouseEnter: v,
                                onMouseLeave: p,
                                onMouseDown: w,
                                onMouseUp: f,
                        ...
                        'info' !== c && a().createElement('div', { className: W.shine }),
                        a().createElement(
                            'div',
                            { className: C()(W.icon, W[`icon__${c}`], W[`icon__${l}`], null == i ? void 0 : i.icon) },
                            a().createElement('div', { className: C()(W.glow, null == i ? void 0 : i.glow) }),
                        ),
                        a().createElement(
                            'div',
                            { className: C()(W.caption, W[`caption__${c}`], null == i ? void 0 : i.caption) },
                            e,
                        ),
                        n && a().createElement('div', { className: C()(W.goto, null == i ? void 0 : i.goto) }, n),
                    );
                };
                var G = t(521);
                t(916);
                    ...
                    uu = (u, e = V.left) => {
                        ...
                        return ((u, e = V.left) => {
                            ...
                            const r =
                                ...
                                a = q(u);
                            return (Z(a, /( )/, e).forEach((u) => (t = t.concat(Z(u, r, V.left)))), t);
                        })(u, e);
                    };
                var eu = t(403);
                const tu = 'FormatText_base_d0',
                    ru = ({ binding: u, text: e = '', classMix: t, alignment: n = V.left, formatWithBrackets: E }) => {
                    ...
                    Au = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((A = A.replace(t, `%(${i})`)),
                                    (E[i] = au[u]
                                        ? a().createElement(
                                              'span',
                                              { className: au[u] },
                                              a().createElement(ru, { text: D, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: n(u) },
                        ...
                        return a().createElement(ru, { text: A, classMix: t, binding: E });
                    });
                function Fu() {
                    return !1;
                }
                ...
                const Bu = ((u, e) => {
                    ...
                    pu = 'App_arrow_ec',
                    wu = 'App_target_64',
                    fu = 'App_description_7c',
                    bu = 'App_divider_0f',
                    xu = 'App_actions_a2',
                    Tu = 'App_button_15',
                    Lu = R.strings.battle_matters.bonusDelayed.dialog;
                let yu;
                !(function (u) {
                ...
                engine.whenReady.then(() => {
                    S().render(
                        a().createElement(Cu, null, a().createElement(L, null, a().createElement(Su, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [965], () => __webpack_require__(559));
