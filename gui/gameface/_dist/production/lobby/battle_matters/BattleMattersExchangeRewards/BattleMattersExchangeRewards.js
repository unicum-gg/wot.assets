(() => {
    var __webpack_modules__ = {
            ...
            959: (u, e, t) => {
                ...
                const L = {
                    ...
                    y = (u) => {
                        ...
                        const E = f(),
                            ...
                            A = E.mediaHeight,
                            i = E.mediaSize;
                        return a().createElement('div', T({ className: h()(t, L[n], M[A], S[i]) }, r), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                class V extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()(j.base, j[`base__${n}`], j[`base__${E}`], null == A ? void 0 : A.base),
                            B = h()(j.icon, j[`icon__${n}`], j[`icon__${E}`], null == A ? void 0 : A.icon),
                            C = h()(j.glow, null == A ? void 0 : A.glow),
                            c = h()(j.caption, j[`caption__${n}`], null == A ? void 0 : A.caption),
                            _ = h()(j.goto, null == A ? void 0 : A.goto);
                        return a().createElement(
                            ...
                            'info' !== n && a().createElement('div', { className: j.shine }),
                        ...
                        return tu.includes(t)
                            ...
                            : ((u, e = Z.left) => {
                                  ...
                                  const r =
                                      ...
                                      a = u.replace(/&nbsp;/g, ' ');
                                  return (uu(a, /( )/, e).forEach((u) => (t = t.concat(uu(u, r, Z.left)))), t);
                              })(u, e);
                    };
                var au = t(403);
                const Eu = 'FormatText_base_d0',
                    nu = ({ binding: u, text: e = '', classMix: t, alignment: E = Z.left }) =>
                        null === e
                                  ...
                                  e.split('\n').map((e, n) =>
                                      a().createElement(
                                          ...
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : ru(u, e))))(e, E, u).map((u, e) =>
                    ...
                    Du = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((i = i.replace(t, `%(${A})`)),
                                    (n[A] = Au[u]
                                        ? a().createElement(
                                              'span',
                                              { className: Au[u] },
                                              a().createElement(nu, { text: D, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: E(u) },
                        ...
                        return a().createElement(nu, { text: i, classMix: t, binding: n });
                    });
                function su() {
                    return !1;
                }
                ...
                const _u = ((u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: A, children: i, mocks: F }) {
                                    ...
                                    D = (t, r, a) => {
                                        ...
                                        const A = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Bu(a.keys()); !(u = t()).done;) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(r),
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        s.current ? d(D(B, A, F)) : (s.current = !0);
                                    }, [F, B, A]),
                                    (0, r.useEffect)(() => {
                                        C(E);
                                    }, [E]),
                ...
                engine.whenReady.then(() => {
                    P().render(
                        a().createElement(du, null, a().createElement(k, null, a().createElement(ku, null))),
