(() => {
    var __webpack_modules__ = {
            ...
            959: (u, e, t) => {
                ...
                const L = {
                    ...
                    M = (u) => {
                        ...
                        const n = b(),
                            ...
                            i = n.mediaHeight,
                            A = n.mediaSize;
                        return a().createElement('div', T({ className: h()(t, L[E], y[i], S[A]) }, r), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                class K extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()($.base, $[`base__${E}`], $[`base__${n}`], null == i ? void 0 : i.base),
                            B = h()($.icon, $[`icon__${E}`], $[`icon__${n}`], null == i ? void 0 : i.icon),
                        ...
                        return a().createElement(
                            ...
                            'info' !== E && a().createElement('div', { className: $.shine }),
                ...
                function X(u = q.n.NONE, e = Y, t = !1, a = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== q.n.NONE)
                            return (
                ...
                const Au = 'FormatText_base_d0',
                    Fu = ({ binding: u, text: e = '', classMix: t, alignment: n = Q.left, formatWithBrackets: E }) => {
                    ...
                    Bu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                (A = A.replace(t, `%(${i})`)),
                                    (E[i] = ou[u]
                                        ? a().createElement(
                                              'span',
                                              { className: ou[u] },
                                              a().createElement(Fu, { text: s, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: n(u) },
                        ...
                        return a().createElement(Fu, { text: A, classMix: t, binding: E });
                    });
                function Cu() {
                    return !1;
                }
                ...
                const hu = ((u, e) => {
                    ...
                    Lu = 'App_arrow_ec',
                    yu = 'App_target_64',
                    Su = 'App_description_7c',
                    Mu = 'App_divider_0f',
                    Ou = 'App_actions_a2',
                    ku = 'App_button_15',
                    Ru = R.strings.battle_matters.bonusDelayed.dialog;
                let Hu;
                !(function (u) {
                ...
                engine.whenReady.then(() => {
                    W().render(
                        a().createElement(gu, null, a().createElement(k, null, a().createElement(Wu, null))),
