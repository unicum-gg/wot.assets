(() => {
    ...
    var __webpack_modules__ = {
            768: (u, e, t) => {
                ...
                var E = {};
                (t.r(E), t.d(E, { getBgUrl: () => f, getTextureUrl: () => g }));
                var D = {};
                function n(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const m = {
                    ...
                    v = { play: Object.assign({}, w, { sound: c }), setRTPC: l };
                var p = t(690);
                function g(u, e, t = 1) {
            ...
            690: (u, e, t) => {
                ...
                function E(u) {
                    let e = '';
                    for (let t = A.length - 1; t >= 0; t--) for (; u >= A[t]; ) ((e += F[t]), (u -= A[t]));
                    return e;
                }
            ...
            634: (u, e, t) => {
                ...
                const _ = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    w = (u, e, t = l.left) => u.split(e).reduce(t === l.left ? m : h, []),
                    v = (() => {
                        const u = new RegExp(
                    ...
                    g = (u, e = l.left) => {
                        ...
                        return ((u, e = l.left) => {
                            ...
                            const F =
                                ...
                                A = _(u);
                            return (w(A, /( )/, e).forEach((u) => (t = t.concat(w(u, F, l.left)))), t);
                        })(u, e);
                    };
                var f = t(916),
                    b = t(613);
                const T = 1e3,
                    ...
                    O = 3600,
                    x = 86400,
                    k = (Date.now(), b.Ew.getRegionalDateTime);
                ...
                const P = () => {},
                            ...
                            (0, F.useEffect)(() => {
                                if (u > 0) {
                                    ...
                                    const F = Date.now(),
                                        E = setInterval(
                                            () => {
                                                const e = u - Math.floor((Date.now() - F) / T);
                    ...
                    U = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: A, modelPath: I(A, u || ''), resId: F };
                            })(),
                            t = e.modelPrefix,
                            F = u.split('.');
                        if (F.length > 0) {
                            ...
                            return (
                                F.reduce((e, F) => {
                                    const A = N(I(t, `${e}.${F}`), window);
                                    return W(A) ? (u.push(A.id), `${e}.${F}.value`) : (u.push(F), `${e}.${F}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const z = f.Sw.instance;
                let q;
                !(function (u) {
                    ((u.None = 'None'), (u.Shallow = 'Shallow'), (u.Deep = 'Deep'));
                })(q || (q = {}));
                const G = (u = 'model', e = q.Deep) => {
                            ...
                            L(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        F = U(u);
                                    C.current = z.addCallback(F, t, r, e === q.Deep);
                                }
                            }),
                            (0, F.useEffect)(() => {
                                if (e !== q.None)
                                    return () => {
                                        z.removeCallback(C.current, r);
                                    };
                            }, [r, e]),
                            i
                        );
                ...
                const H = 'FormatText_base_d0',
                    Y = ({ binding: u, text: e = '', classMix: t, alignment: E = l.left, formatWithBrackets: D }) => {
                    ...
                    Q = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    J = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    uu = (0, F.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((r = r.replace(t, `%(${n})`)),
                                    (D[n] = Z[u]
                                        ? A().createElement(
                                              'span',
                                              { className: Z[u] },
                                              A().createElement(Y, { text: i, binding: e }),
                                          )
                                        : A().createElement(
                                              'span',
                                              { style: E(u) },
                        ...
                        return A().createElement(Y, { text: r, classMix: t, binding: D });
                    }),
                    eu = 'Timer_base_41',
                    tu = 'Timer_icon_26',
                    Fu = (0, F.memo)(({ endDate: u, className: e }) => {
                        const t = Math.floor(Date.now() / T),
                            F = (function (u = 0) {
                                let e = u;
                                const t = Math.trunc(e / x);
                                e -= t * x;
                                const F = Math.trunc(e / O);
                                e -= F * O;
                                const A = Math.trunc(e / y);
                                return ((e -= A * y), { days: t, hours: F, minutes: A, seconds: e });
                            })(K(u - t, 1));
                        return A().createElement(
                            'div',
                            { className: r()(eu, e) },
                    ...
                    nu = 'App_image_5f',
                    ru = 'App_title_41',
                    ou = 'App_description_55',
                    au = 'App_condition_2d',
                    iu = 'App_condition__withTimer_f8',
                    Bu = 'App_timer_76',
                    Cu = R.strings.battle_matters.tokenTooltip,
                    su = () => {
                        const u = G().endDate,
                            e = u > 0;
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                A().createElement(
                                    ...
                                    A().createElement('div', { className: ru }, Cu.title()),
                                    A().createElement('div', { className: ou }, Cu.description()),
                                    A().createElement('div', { className: Au }),
                                ),
                                A().createElement('div', { className: r()(au, e && iu) }, Cu.condition()),
                                e &&
                                    A().createElement(
                                        A().Fragment,
                                        null,
                                        A().createElement('div', { className: Au }),
                                        A().createElement(Fu, { endDate: u, className: Bu }),
                                    ),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    D().render(A().createElement(su, null), document.getElementById('root'));
                });
            },
            363: (u) => {
                u.exports = React;
