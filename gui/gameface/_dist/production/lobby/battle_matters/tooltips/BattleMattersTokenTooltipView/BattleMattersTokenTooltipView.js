(() => {
    ...
    var __webpack_modules__ = {
            768: (u, e, t) => {
                ...
                var E = {};
                t.r(E), t.d(E, { getBgUrl: () => g, getTextureUrl: () => p });
                var D = {};
                function n(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const m = {
                    ...
                    w = Object.keys(h).reduce((u, e) => ((u[e] = () => l(h[e])), u), {}),
            ...
            634: (u, e, t) => {
                ...
                const s = A().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        A().createElement(
                            'div',
                            C({}, s, {
                                className: r()(i.base, i[`base__theme-${n}`], E),
                                ref: function (u) {
                ...
                const _ = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    w = (u, e, t = c.left) => u.split(e).reduce(t === c.left ? m : h, []),
                    v = (() => {
                        const u = new RegExp(
                    ...
                    g = (u, e = c.left) => {
                        ...
                        return ((u, e = c.left) => {
                            ...
                            const F =
                                ...
                                A = _(u);
                            return w(A, /( )/, e).forEach((u) => (t = t.concat(w(u, F, c.left)))), t;
                        })(u, e);
                    };
                var f = t(916),
                    b = t(613);
                const T = 24,
                    ...
                    x = 60 * O,
                    k = T * x,
                    P = (Date.now(), b.Ew.getRegionalDateTime);
                b.Ew.getFormattedDateTime;
                const M = () => {},
                    S = (u = 0, e, t = 0, A = M) => {
                        const E = (0, F.useState)(u),
                            D = E[0],
                            n = E[1];
                        return (
                            (0, F.useEffect)(() => {
                                if (u > 0) {
                                    ...
                                    const F = Date.now(),
                                        E = setInterval(
                                            () => {
                                                const e = u - Math.floor((Date.now() - F) / y);
                                                null !== t && e <= t ? (n(t), A && A(), clearInterval(E)) : n(e);
                                            },
                                            (e || (u > 2 * O ? O : 1)) * y,
                                        );
                                    return () => {
                    ...
                    N = (u = 1) => {
                        ...
                        return { callerUrl: A, caller: t, stack: e, resId: F };
                    },
                    ...
                    U = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const F = L(`${u}.${t}`, window);
                                return I(F) ? e(u, t, F) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    j = (u) => {
                        const e = ((u) => {
                                const e = N(),
                                ...
                                return { modelPrefix: A, modelPath: V(A, u || ''), resId: F };
                            })(),
                            t = e.modelPrefix,
                            F = u.split('.');
                        if (F.length > 0) {
                            ...
                            return (
                                F.reduce((e, F) => {
                                    const A = L(V(t, `${e}.${F}`), window);
                                    return I(A) ? (u.push(A.id), `${e}.${F}.value`) : (u.push(F), `${e}.${F}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const q = f.Sw.instance;
                let K;
                !(function (u) {
                    (u.None = 'None'), (u.Shallow = 'Shallow'), (u.Deep = 'Deep');
                })(K || (K = {}));
                const G = (u = 'model', e = K.Deep) => {
                            ...
                            W(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        F = j(u);
                                    C.current = q.addCallback(F, t, r, e === K.Deep);
                                }
                            }),
                            (0, F.useEffect)(() => {
                                if (e !== K.None)
                                    return () => {
                                        q.removeCallback(C.current, r);
                                    };
                            }, [r, e]),
                            i
                        );
                ...
                const Y = 'FormatText_base_d0',
                    Z = ({ binding: u, text: e = '', classMix: t, alignment: E = c.left, formatWithBrackets: D }) => {
                    ...
                    J = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    uu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    eu = (0, F.memo)(({ text: u, binding: e, classMix: t }) => {
                        const E = (0, F.useCallback)((u) => ({ color: `#${u}` }), []),
                            D = (0, F.useMemo)(() => e || {}, [e]);
                        let n = Q.exec(u),
                            r = u,
                            o = 0;
                                ...
                                (r = r.replace(t, `%(${n})`)),
                                    (D[n] = X[u]
                                        ? A().createElement(
                                              'span',
                                              { className: X[u] },
                                              A().createElement(Z, { text: i, binding: e }),
                                          )
                                        : A().createElement(
                                              'span',
                                              { style: E(u) },
                        ...
                        return A().createElement(Z, { text: r, classMix: t, binding: D });
                    }),
                    tu = 'Timer_base_41',
                    Fu = 'Timer_icon_26',
                    Au = (0, F.memo)(({ endDate: u, className: e }) => {
                        const t = Math.floor(Date.now() / y),
                            F = (function (u = 0) {
                                let e = u;
                                const t = Math.trunc(e / k);
                                e -= t * k;
                                const F = Math.trunc(e / x);
                                e -= F * x;
                                const A = Math.trunc(e / O);
                                return (e -= A * O), { days: t, hours: F, minutes: A, seconds: e };
                            })($(u - t, 1));
                        return A().createElement(
                            'div',
                            { className: r()(tu, e) },
                            ...
                            (() => {
                                if (F.days > 30)
                                    return A().createElement(eu, {
                                        ...
                                        binding: { fullDate: P(u, H.FullDate) },
                                    });
                                if (F.days)
                                    return A().createElement(eu, {
                                ...
                                if (F.hours)
                                    return A().createElement(eu, {
                                        ...
                                        binding: { hours: F.hours },
                                    });
                                if (F.minutes) {
                                    const u = F.seconds >= 30;
                                    return 59 === F.minutes && u
                                        ? A().createElement(eu, {
                                              text: R.strings.battle_matters.tokenTooltip.timer.hours(),
                                              binding: { hours: 1 },
                                          })
                                        : A().createElement(eu, {
                                              ...
                                              binding: { minutes: u ? F.minutes + 1 : F.minutes },
                                          });
                                }
                                return A().createElement(eu, {
                                    text: R.strings.battle_matters.tokenTooltip.timer.minutes(),
                    ...
                    ru = 'App_image_5f',
                    ou = 'App_title_41',
                    au = 'App_description_55',
                    iu = 'App_condition_2d',
                    Bu = 'App_condition__withTimer_f8',
                    Cu = 'App_timer_76',
                    su = R.strings.battle_matters.tokenTooltip,
                    lu = () => {
                        const u = G().endDate,
                            e = u > 0;
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                A().createElement(
                                    ...
                                    A().createElement('div', { className: ou }, su.title()),
                                    A().createElement('div', { className: au }, su.description()),
                                    A().createElement('div', { className: Eu }),
                                ),
                                A().createElement('div', { className: r()(iu, e && Bu) }, su.condition()),
                                e &&
                                    A().createElement(
                                        A().Fragment,
                                        null,
                                        A().createElement('div', { className: Eu }),
                                        A().createElement(Au, { endDate: u, className: Cu }),
                                    ),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    D().render(A().createElement(lu, null), document.getElementById('root'));
                });
            },
            363: (u) => {
                u.exports = React;
        ...
        (__webpack_require__.O = (u, e, t, F) => {
            if (!e) {
                ...
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, t, F] = deferred[r], E = !0, D = 0; D < e.length; D++)
                        (!1 & F || A >= F) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [965], () => __webpack_require__(634));
