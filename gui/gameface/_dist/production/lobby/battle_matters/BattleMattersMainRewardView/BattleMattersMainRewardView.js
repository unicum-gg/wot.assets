(() => {
    var __webpack_modules__ = {
            ...
            67: (u, e, t) => {
                ...
                t.d(e, { O: () => q });
                var r = {};
                (t.r(r), t.d(r, { mouse: () => s, onResize: () => F }));
                var a = {};
                (t.r(a),
                    t.d(a, {
                        events: () => r,
                ...
                var n = {};
                (t.r(n), t.d(n, { getBgUrl: () => C, getTextureUrl: () => c }));
                var E = {};
                function i(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            289: (u, e, t) => {
                ...
                const T = {
                    ...
                    k = (u) => {
                        ...
                        const n = f(),
                            ...
                            i = n.mediaHeight,
                            A = n.mediaSize;
                        return a().createElement('div', L({ className: h()(t, T[E], M[i], S[A]) }, r), e);
                    },
                    y = ['children'];
                const O = (u) => {
                    let e = u.children,
                    ...
                    return a().createElement(_, null, a().createElement(k, t, e));
                };
                var P = t(493),
                    N = t.n(P);
                function H(u) {
                ...
                class $ extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()(I.base, I[`base__${E}`], I[`base__${n}`], null == i ? void 0 : i.base),
                            B = h()(I.icon, I[`icon__${E}`], I[`icon__${n}`], null == i ? void 0 : i.icon),
                            c = h()(I.glow, null == i ? void 0 : i.glow),
                            C = h()(I.caption, I[`caption__${E}`], null == i ? void 0 : i.caption),
                            d = h()(I.goto, null == i ? void 0 : i.goto);
                        return a().createElement(
                            ...
                            'info' !== E && a().createElement('div', { className: I.shine }),
                ...
                const Y = (u, e, t) => {
                    ...
                    Z = (u, e, t = q.left) => u.split(e).reduce(t === q.left ? Y : X, []),
                    Q = (() => {
                        const u = new RegExp(
                    ...
                    tu = ({ binding: u, text: e = '', classMix: t, alignment: n = q.left }) =>
                        null === e
                    ...
                    nu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Eu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    iu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((A = A.replace(t, `%(${i})`)),
                                    (E[i] = ru[u]
                                        ? a().createElement(
                                              'span',
                                              { className: ru[u] },
                                              a().createElement(tu, { text: s, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: n(u) },
                        ...
                        return a().createElement(tu, { text: A, classMix: t, binding: E });
                    }),
                    Au = (u, e) => {
                        (0, r.useEffect)(() => {
                            if (!e) return;
                    ...
                    Fu = 'Background_base_1b',
                    ou = 'Background_image_71',
                    su = ({ isBlurred: u, children: e, onLoaded: t }) => {
                        const r = u
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: Fu },
                                a().createElement('div', { className: ou, style: { backgroundImage: `url(${r})` } }, e),
                            )
                        );
                    };
                function Du(u) {
                ...
                const mu = ((u, e) => {
                        ...
                        ({ externalModel: u, model: e }) => ({
                            ...
                            increaseLoadedAssetsCount: (0, Bu.aD)(() =>
                ...
                const Mu = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    ku = 'TankName_base_eb',
                    yu = 'TankName_nation_8c',
                    Ou = 'TankName_class_56',
                    Ru = ({ vehicleName: u, nation: e, level: t, vehicleClass: r, className: n }) => {
                        ...
                        return a().createElement(
                            'div',
                            { className: h()(ku, n) },
                            a().createElement('div', { className: yu, style: { backgroundImage: `url(${E})` } }),
                            Su(t),
                            a().createElement('div', { className: Ou, style: { backgroundImage: `url(${i})` } }),
                            u,
                        );
                    },
                    Pu = {
                    ...
                    Nu = R.strings.battle_matters.mainRewardsScreen,
                    Hu = R.images.gui.maps.icons.battleMatters.mainReward,
                    Wu = { 0: 'left', 1: 'center', 2: 'right' },
                    Iu = ({
                        isInHangar: u,
                        vehCD: e,
                        rentLength: t,
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    {
                                        ...
                                        onMouseEnter: () => {
                                            H('bm_reward_highlight');
                                        },
                                        className: h()(Pu.hoverArea, Pu[`hoverArea__${Wu[o]}`]),
                                    },
                                    a().createElement(
                                        'div',
                                        { className: Pu.preview },
                                        a().createElement(xu, {
                                            label: a().createElement(tu, {
                                                classMix: Pu.previewLabel,
                                                text: Nu.preview(),
                                            }),
                                            soundClick: '',
                                        }),
                                ...
                                a().createElement('div', {
                                    className: h()(Pu.reward, Pu.reward__hover),
                                    style: { backgroundImage: `url('${D}')` },
                                }),
                                a().createElement(Ru, { vehicleName: E, nation: i, level: r, vehicleClass: n }),
                                a().createElement(
                                    'div',
                                    { className: Pu.status },
                                    a().createElement('div', { className: Pu.statusShadow }),
                                    u
                                        ? a().createElement(
                                              'div',
                                              { className: Pu.inStock },
                                              a().createElement('div', { className: Pu.done }),
                                              Nu.done(),
                                          )
                                        : a().createElement(
                                              'div',
                                              { className: Pu.period },
                                              a().createElement('div', { className: Pu.timer }),
                                              a().createElement(tu, { text: Nu.rentDays(), binding: { value: t } }),
                                          ),
                                ),
                            )
                        );
                ...
                const Gu = R.strings.battle_matters.mainRewardsScreen,
                    $u = (0, K.Pi)(() => {
                        const u = f().mediaSize,
                            e = gu(),
                            t = e.model,
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: h()(vu.base, E && vu.base__visible) },
                                a().createElement(
                                    su,
                                ...
                                a().createElement(iu, { text: Gu.subtitle(), classMix: vu.subtitle }),
                                a().createElement(
                                    'div',
                                    { className: vu.backButtonWrapper },
                                    a().createElement($, {
                                        caption: Gu.buttons.back(),
                                        goto: u > w.ExtraSmall ? Gu.buttons.backTo() : '',
                                        onClick: n.back,
                                    }),
                                ),
                            )
                ...
                engine.whenReady.then(() => {
                    N().render(
                        a().createElement(hu, null, a().createElement(O, null, a().createElement($u, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [965], () => __webpack_require__(289));
