(() => {
    var __webpack_modules__ = {
            ...
            528: (u, e, t) => {
                ...
                var n = {};
                (t.r(n), t.d(n, { getBgUrl: () => x, getTextureUrl: () => p }));
                var i = {};
                function E(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const h = {
                    ...
                    b = { play: Object.assign({}, w, { sound: d }), setRTPC: C };
                var f = t(308);
                function p(u, e, t = 1) {
                ...
                const Fu = { view: i, client: a, sound: b, intl: g };
            },
            20: (u, e, t) => {
                'use strict';
                t.d(e, { n: () => r });
            ...
            709: (u, e, t) => {
                ...
                const w = {
                        [_.ExtraSmall]: '',
                        [_.Small]: d().SMALL_WIDTH,
                        [_.Medium]: `${d().SMALL_WIDTH} ${d().MEDIUM_WIDTH}`,
                        [_.Large]: `${d().SMALL_WIDTH} ${d().MEDIUM_WIDTH} ${d().LARGE_WIDTH}`,
                        [_.ExtraLarge]: `${d().SMALL_WIDTH} ${d().MEDIUM_WIDTH} ${d().LARGE_WIDTH} ${d().EXTRA_LARGE_WIDTH}`,
                    },
                    b = {
                        [m.ExtraSmall]: '',
                    ...
                    p = (u) => {
                        ...
                        const n = h(),
                            ...
                            E = n.mediaHeight,
                            A = n.mediaSize;
                        return a().createElement('div', v({ className: c()(t, w[i], b[E], f[A]) }, r), e);
                    },
                    x = ['children'];
                const T = (u) => {
                    let e = u.children,
                    ...
                    return a().createElement(l, null, a().createElement(p, t, e));
                };
                var L = t(533),
                    y = t.n(L);
                const S = {
                ...
                const k = (u) => {
                    ...
                    const v = (0, r.useCallback)(
                            (u) => {
                                (null == A || A(u), i.O.sound.play.sound(_));
                            },
                            [A, _],
                        ),
                        w = (0, r.useCallback)(
                        ...
                        b = (0, r.useCallback)(
                            (u) => {
                                (null == F || F(u), i.O.sound.play.sound(h));
                            },
                            [F, h],
                        ),
                        f = (0, r.useCallback)(
                    ...
                    return a().createElement(
                        ...
                        M(
                            {
                                className: c()(S.base, S[`base__${d}`], S[`base__${D}`], null == E ? void 0 : E.base),
                                onMouseEnter: v,
                                onMouseLeave: w,
                                onMouseDown: b,
                                onMouseUp: f,
                        ...
                        'info' !== d && a().createElement('div', { className: S.shine }),
                        a().createElement(
                            'div',
                            { className: c()(S.icon, S[`icon__${d}`], S[`icon__${D}`], null == E ? void 0 : E.icon) },
                            a().createElement('div', { className: c()(S.glow, null == E ? void 0 : E.glow) }),
                        ),
                        a().createElement(
                            'div',
                            { className: c()(S.caption, S[`caption__${d}`], null == E ? void 0 : E.caption) },
                            e,
                        ),
                        n && a().createElement('div', { className: c()(S.goto, null == E ? void 0 : E.goto) }, n),
                    );
                };
                var P = t(20);
                t(828);
                ...
                function N(u = P.n.NONE, e = H, t = !1, a = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== P.n.NONE)
                            return (
                ...
                const G = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    j = (u, e, t = U.left) => u.split(e).reduce(t === U.left ? z : V, []),
                    q = (() => {
                        const u = new RegExp(
                            [
                    ...
                    X = 'FormatText_base_f27a4',
                    Z = ({ binding: u, text: e = '', classMix: t, alignment: n = U.left, formatWithBrackets: i }) => {
                    ...
                    uu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    eu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    tu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((A = A.replace(t, `%(${E})`)),
                                    (i[E] = Q[u]
                                        ? a().createElement(
                                              'span',
                                              { className: Q[u] },
                                              a().createElement(Z, { text: s, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: n(u) },
                        ...
                        return a().createElement(Z, { text: A, classMix: t, binding: i });
                    }),
                    ru = (u, e) => {
                        (0, r.useEffect)(() => {
                            if (!e) return;
                            ...
                            return (
                                ...
                                (t.src = u),
                                () => {
                                    (t.removeEventListener('load', e), t.removeEventListener('error', e));
                                }
                            );
                        }, [e, u]);
                    },
                    au = 'Background_base_eea46',
                    nu = 'Background_image_b1c9e',
                    iu = ({ isBlurred: u, children: e, onLoaded: t }) => {
                        const r = u
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: au },
                                a().createElement('div', { className: nu, style: { backgroundImage: `url(${r})` } }, e),
                            )
                        );
                    };
                function Eu(u) {
                ...
                const cu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: E, children: A, mocks: o }) {
                                const F = (0, r.useRef)([]),
                                    ...
                                    c = D[0],
                                    B = D[1],
                                    d = (0, r.useState)(() => s(n, E, o)),
                                    C = d[0],
                                    _ = d[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? _(s(c, E, o)) : (l.current = !0);
                                    }, [o, c, E]),
                                    (0, r.useEffect)(() => {
                                        B(n);
                                    }, [n]),
                        ...
                        ({ observableModel: u }) => {
                            const e = { vehicles: u.array('vehicles', []) },
                                ...
                                a = (0, Du.Om)(() => t.get() === r().length + 1);
                            return { computes: { getVehicles: r, areAssetsLoaded: a }, loadedAssetsCount: t };
                        },
                        ({ externalModel: u, model: e }) => ({
                            showView: u.createCallbackNoArgs('onShowView'),
                            back: u.createCallbackNoArgs('onBack'),
                            close: u.createCallbackNoArgs('onClose'),
                            increaseLoadedAssetsCount: (0, ou.aD)(() =>
                                e.loadedAssetsCount.set(e.loadedAssetsCount.get() + 1),
                            ),
                            preview: u.createCallback((u) => ({ vehCD: u }), 'onPreview'),
                        }),
                    ),
                    Bu = cu[0],
                    du = cu[1],
                    Cu = {
                        base: 'App_base_d4718',
                        base__visible: 'App_base__visible_d45ea',
                        backButtonWrapper: 'App_backButtonWrapper_bbe36',
                        shadow: 'App_shadow_cb64e',
                        title: 'App_title_d96cd',
                        subtitle: 'App_subtitle_caa56',
                        reward: 'App_reward_b2234',
                        reward__1: 'App_reward__1_e08e6',
                        reward__2: 'App_reward__2_ab2ea',
                        reward__3: 'App_reward__3_e4480',
                    },
                    _u =
                        (u, e) =>
                        (...t) => {
                ...
                const fu = (u) => {
                    let e = u.type,
                        ...
                        F = void 0 !== o && o,
                        s = u.soundHover,
                        l = void 0 === s ? R.sounds.highlight() : s,
                        D = u.soundClick,
                        B = void 0 === D ? R.sounds.play() : D,
                        d = u.size,
                        C = void 0 === d ? 'normal' : d,
                        _ = u.onClick,
                        m = u.onMouseEnter,
                    ...
                    const p = (0, r.useState)(!1),
                        ...
                        O = (0, r.useRef)(null),
                        M = () => !1 === A,
                        k = (u) => M() && ((u) => u.button === mu.LEFT)(u),
                        P = _u(M, (u) => {
                            null == _ || _(u);
                        }),
                        H = _u(k, (u) => {
                            (T(!0), null == g || g(u), B && hu(B));
                        }),
                        N = _u(k, (u) => {
                            (T(!1), null == v || v(u));
                        }),
                        W = _u(M, (u) => {
                            (S(!0), null == m || m(u), l && hu(l));
                        }),
                        I = _u(M, (u) => {
                            null == w || w(u);
                        }),
                    ...
                    return a().createElement(
                        ...
                        bu(
                            {
                                ...
                                className: c()(
                                    vu.base,
                                    A && vu.base__disabled,
                                    F && vu.base__visibleLabel,
                                    !A && x && vu.base__mouseDown,
                                    !A && y && vu.base__hovered,
                                    n,
                                ),
                                onClick: P,
                                onMouseEnter: W,
                        ...
                        a().createElement('div', {
                            className: c()(vu.icon, vu[`icon__${C}`], vu[`icon__${e}`], null == i ? void 0 : i.icon),
                        }),
                        t &&
                            a().createElement(
                                'div',
                                { className: c()(vu.label, vu[`label__${C}`], null == i ? void 0 : i.label) },
                                t,
                            ),
                    );
                };
                var pu = t(308);
                const xu = 'TankName_base_d9f35',
                    Tu = 'TankName_nation_ef1fc',
                    Lu = 'TankName_class_a0d7f',
                    yu = ({ vehicleName: u, nation: e, level: t, vehicleClass: r, className: n }) => {
                        const i = R.images.gui.maps.icons.filters.nations.$dyn(e),
                            E = R.images.gui.maps.icons.vehicleTypes.big.$dyn(
                                `${((A = r), A.replace(/-/g, '_'))}_elite`,
                            );
                        var A;
                        return a().createElement(
                            'div',
                            { className: c()(xu, n) },
                            a().createElement('div', { className: Tu, style: { backgroundImage: `url(${i})` } }),
                            (0, pu.HG)(t),
                            a().createElement('div', { className: Lu, style: { backgroundImage: `url(${E})` } }),
                            u,
                        );
                    },
                    Su = {
                        base: 'Reward_base_aad36',
                        hoverArea: 'Reward_hoverArea_e6a77',
                        hoverArea__left: 'Reward_hoverArea__left_d72d1',
                        hoverArea__right: 'Reward_hoverArea__right_e9eb9',
                        hoverArea__center: 'Reward_hoverArea__center_b908b',
                        reward: 'Reward_reward_db071',
                        reward__hover: 'Reward_reward__hover_e36e5',
                        preview: 'Reward_preview_c7dcf',
                        previewLabel: 'Reward_previewLabel_eba69',
                        status: 'Reward_status_fa646',
                        statusShadow: 'Reward_statusShadow_d21ef',
                        inStock: 'Reward_inStock_a3d20',
                        done: 'Reward_done_f7c2f',
                        period: 'Reward_period_a3d37',
                        timer: 'Reward_timer_bab5b',
                    },
                    Ou = R.strings.battle_matters.mainRewardsScreen,
                    Mu = R.images.gui.maps.icons.battleMatters.mainReward,
                    ku = { 0: 'left', 1: 'center', 2: 'right' },
                    Ru = ({
                        isInHangar: u,
                        vehCD: e,
                        rentLength: t,
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    {
                                        ...
                                        onMouseEnter: () => {
                                            hu('bm_reward_highlight');
                                        },
                                        className: c()(Su.hoverArea, Su[`hoverArea__${ku[F]}`]),
                                    },
                                    a().createElement(
                                        'div',
                                        ...
                                        a().createElement(
                                            fu,
                                            { type: 'preview', soundClick: '' },
                                            a().createElement(Z, { classMix: Su.previewLabel, text: Ou.preview() }),
                                        ),
                                    ),
                                ),
                                a().createElement('div', {
                                ...
                                a().createElement('div', {
                                    className: c()(Su.reward, Su.reward__hover),
                                    style: { backgroundImage: `url('${l}')` },
                                }),
                                a().createElement(yu, { vehicleName: i, nation: E, level: r, vehicleClass: n }),
                                a().createElement(
                                    'div',
                                    { className: Su.status },
                                    a().createElement('div', { className: Su.statusShadow }),
                                    u
                                        ? a().createElement(
                                              'div',
                                              { className: Su.inStock },
                                              a().createElement('div', { className: Su.done }),
                                              Ou.done(),
                                          )
                                        : a().createElement(
                                              'div',
                                              { className: Su.period },
                                              a().createElement('div', { className: Su.timer }),
                                              a().createElement(Z, { text: Ou.rentDays(), binding: { value: t } }),
                                          ),
                                ),
                            )
                        );
                ...
                const Hu = R.strings.battle_matters.mainRewardsScreen,
                    Nu = (0, W.Pi)(() => {
                        const u = h().mediaSize,
                            e = du(),
                            t = e.model,
                            n = e.controls,
                            i = t.computes.areAssetsLoaded();
                        var E;
                        return (
                            (0, r.useEffect)(() => {
                                i && n.showView();
                            ...
                            a().createElement(
                                'div',
                                { className: c()(Cu.base, i && Cu.base__visible) },
                                a().createElement(
                                    iu,
                                    ...
                                    t.computes
                                        ...
                                        .map((u, e) =>
                                            a().createElement(
                                                'div',
                                                { key: u.vehCD, className: c()(Cu.reward, Cu[`reward__${e + 1}`]) },
                                                a().createElement(
                                                    Ru,
                                                    Pu({}, u, {
                                                        index: e,
                                ...
                                a().createElement('div', { className: Cu.title }, Hu.title()),
                                a().createElement(tu, { text: Hu.subtitle(), classMix: Cu.subtitle }),
                                a().createElement(
                                    'div',
                                    { className: Cu.backButtonWrapper },
                                    a().createElement(k, {
                                        caption: Hu.buttons.back(),
                                        goto: u > C.ExtraSmall ? Hu.buttons.backTo() : '',
                                        onClick: n.back,
                                    }),
                                ),
                            )
                ...
                engine.whenReady.then(() => {
                    y().render(
                        a().createElement(Bu, null, a().createElement(T, null, a().createElement(Nu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [965], () => __webpack_require__(709));
