(() => {
    var __webpack_modules__ = {
            ...
            70: (u, e, t) => {
                ...
                var r = {};
                (t.r(r),
                    t.d(r, { mouse: () => c, off: () => l, on: () => s, onResize: () => o, onScaleUpdated: () => F }));
                var a = {};
                (t.r(a),
                    t.d(a, {
                        events: () => r,
                ...
                const Au = { view: E, client: a, sound: w, intl: h };
            },
            521: (u, e, t) => {
                'use strict';
                let r, a;
            ...
            407: (u, e, t) => {
                ...
                var A;
                function o(u = E.O.client.getSize('rem')) {
                    const e = u.width,
                        t = u.height;
                ...
                const b = {
                    ...
                    x = (u) => {
                        ...
                        const n = g(),
                            ...
                            i = n.mediaHeight,
                            A = n.mediaSize;
                        return a().createElement('div', w({ className: B()(t, b[E], p[i], f[A]) }, r), e);
                    },
                    L = ['children'];
                const T = (u) => {
                    let e = u.children,
                ...
                const H = (u) => {
                    ...
                    const v = (0, r.useCallback)(
                        ...
                        b = (0, r.useCallback)(
                            (u) => {
                                (null == F || F(u), E.O.sound.play.sound(h));
                            },
                            [F, h],
                        ),
                        p = (0, r.useCallback)(
                    ...
                    return a().createElement(
                        ...
                        M(
                            {
                                className: B()(O.base, O[`base__${C}`], O[`base__${D}`], null == i ? void 0 : i.base),
                                onMouseEnter: v,
                                onMouseLeave: w,
                                onMouseDown: b,
                                onMouseUp: p,
                        ...
                        'info' !== C && a().createElement('div', { className: O.shine }),
                        a().createElement(
                            'div',
                            { className: B()(O.icon, O[`icon__${C}`], O[`icon__${D}`], null == i ? void 0 : i.icon) },
                            a().createElement('div', { className: B()(O.glow, null == i ? void 0 : i.glow) }),
                        ),
                        a().createElement(
                            'div',
                            { className: B()(O.caption, O[`caption__${C}`], null == i ? void 0 : i.caption) },
                            e,
                        ),
                        n && a().createElement('div', { className: B()(O.goto, null == i ? void 0 : i.goto) }, n),
                    );
                };
                var P = t(521);
                t(916);
                ...
                function N(u = P.n.NONE, e = W, t = !1, a = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== P.n.NONE)
                            return (
                ...
                const j = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    q = (u, e, t = $.left) => u.split(e).reduce(t === $.left ? V : z, []),
                    K = (() => {
                        const u = new RegExp(
                            [
                    ...
                    X = (u, e = $.left) => {
                        ...
                        return ((u, e = $.left) => {
                            ...
                            const r =
                                ...
                                a = j(u);
                            return (q(a, /( )/, e).forEach((u) => (t = t.concat(q(u, r, $.left)))), t);
                        })(u, e);
                    },
                    Z = 'FormatText_base_d0',
                    Q = ({ binding: u, text: e = '', classMix: t, alignment: n = $.left, formatWithBrackets: E }) => {
                    ...
                    ru = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                        ...
                        return a().createElement(Q, { text: A, classMix: t, binding: E });
                    }),
                    au = (u, e) => {
                        (0, r.useEffect)(() => {
                            if (!e) return;
                    ...
                    nu = 'Background_base_1b',
                    Eu = 'Background_image_71',
                    iu = ({ isBlurred: u, children: e, onLoaded: t }) => {
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: nu },
                                a().createElement('div', { className: Eu, style: { backgroundImage: `url(${r})` } }, e),
                            )
                        );
                    };
                function Au(u) {
                ...
                const Bu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: i, children: A, mocks: o }) {
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? _(s(c, i, o)) : (l.current = !0);
                                    }, [o, c, i]),
                                    (0, r.useEffect)(() => {
                                        B(n);
                                    }, [n]),
                        ...
                        ({ externalModel: u, model: e }) => ({
                            ...
                            increaseLoadedAssetsCount: (0, Fu.aD)(() =>
                    ...
                    _u = {
                        base: 'App_base_af',
                        base__visible: 'App_base__visible_75',
                        backButtonWrapper: 'App_backButtonWrapper_d9',
                        shadow: 'App_shadow_27',
                        title: 'App_title_3c',
                        subtitle: 'App_subtitle_53',
                        reward: 'App_reward_64',
                        reward__1: 'App_reward__1_e4',
                        reward__2: 'App_reward__2_ae',
                        reward__3: 'App_reward__3_32',
                    },
                    mu =
                        (u, e) =>
                        (...t) => {
                ...
                const fu = (u) => {
                    ...
                    const f = (0, r.useState)(!1),
                        ...
                        O = (0, r.useRef)(null),
                        k = () => !1 === A,
                        M = (u) => k() && ((u) => u.button === hu.LEFT)(u),
                        H = mu(k, (u) => {
                            null == _ || _(u);
                        }),
                        P = mu(M, (u) => {
                            (L(!0), null == g || g(u), c && gu(c));
                        }),
                        W = mu(M, (u) => {
                            (L(!1), null == v || v(u));
                        }),
                        N = mu(k, (u) => {
                            (S(!0), null == m || m(u), l && gu(l));
                        }),
                        I = mu(k, (u) => {
                            null == w || w(u);
                        }),
                    ...
                    return a().createElement(
                        ...
                        pu(
                            {
                                ...
                                className: B()(
                                    wu.base,
                                    A && wu.base__disabled,
                                    F && wu.base__visibleLabel,
                                    !A && x && wu.base__mouseDown,
                                    !A && y && wu.base__hovered,
                                    n,
                                ),
                                onClick: H,
                                onMouseEnter: N,
                        ...
                        a().createElement('div', {
                            className: B()(wu.icon, wu[`icon__${d}`], wu[`icon__${e}`], null == E ? void 0 : E.icon),
                        }),
                        t &&
                            a().createElement(
                                'div',
                                { className: B()(wu.label, wu[`label__${d}`], null == E ? void 0 : E.label) },
                                t,
                            ),
                    );
                };
                var xu = t(690);
                const Lu = 'TankName_base_eb',
                    Tu = 'TankName_nation_8c',
                    yu = 'TankName_class_56',
                    Su = ({ vehicleName: u, nation: e, level: t, vehicleClass: r, className: n }) => {
                        const E = R.images.gui.maps.icons.filters.nations.$dyn(e),
                            i = R.images.gui.maps.icons.vehicleTypes.big.$dyn(
                        ...
                        return a().createElement(
                            'div',
                            { className: B()(Lu, n) },
                            a().createElement('div', { className: Tu, style: { backgroundImage: `url(${E})` } }),
                            (0, xu.HG)(t),
                            a().createElement('div', { className: yu, style: { backgroundImage: `url(${i})` } }),
                            u,
                        );
                    },
                    Ou = {
                        base: 'Reward_base_05',
                        hoverArea: 'Reward_hoverArea_03',
                        hoverArea__left: 'Reward_hoverArea__left_d5',
                        hoverArea__right: 'Reward_hoverArea__right_59',
                        hoverArea__center: 'Reward_hoverArea__center_56',
                        reward: 'Reward_reward_29',
                        reward__hover: 'Reward_reward__hover_2e',
                        preview: 'Reward_preview_a5',
                        previewLabel: 'Reward_previewLabel_83',
                        status: 'Reward_status_10',
                        statusShadow: 'Reward_statusShadow_89',
                        inStock: 'Reward_inStock_f0',
                        done: 'Reward_done_43',
                        period: 'Reward_period_7e',
                        timer: 'Reward_timer_cd',
                    },
                    ku = R.strings.battle_matters.mainRewardsScreen,
                    Mu = R.images.gui.maps.icons.battleMatters.mainReward,
                    Ru = { 0: 'left', 1: 'center', 2: 'right' },
                    Hu = ({
                        isInHangar: u,
                        vehCD: e,
                        rentLength: t,
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    {
                                        ...
                                        onMouseEnter: () => {
                                            gu('bm_reward_highlight');
                                        },
                                        className: B()(Ou.hoverArea, Ou[`hoverArea__${Ru[F]}`]),
                                    },
                                    a().createElement(
                                        'div',
                                        { className: Ou.preview },
                                        a().createElement(
                                            fu,
                                            { type: 'preview', soundClick: '' },
                                            a().createElement(Q, { classMix: Ou.previewLabel, text: ku.preview() }),
                                        ),
                                    ),
                                ),
                                a().createElement('div', {
                                ...
                                a().createElement('div', {
                                    className: B()(Ou.reward, Ou.reward__hover),
                                    style: { backgroundImage: `url('${l}')` },
                                }),
                                a().createElement(Su, { vehicleName: E, nation: i, level: r, vehicleClass: n }),
                                a().createElement(
                                    'div',
                                    { className: Ou.status },
                                    a().createElement('div', { className: Ou.statusShadow }),
                                    u
                                        ? a().createElement(
                                              'div',
                                              { className: Ou.inStock },
                                              a().createElement('div', { className: Ou.done }),
                                              ku.done(),
                                          )
                                        : a().createElement(
                                              'div',
                                              { className: Ou.period },
                                              a().createElement('div', { className: Ou.timer }),
                                              a().createElement(Q, { text: ku.rentDays(), binding: { value: t } }),
                                          ),
                                ),
                            )
                        );
                ...
                const Wu = R.strings.battle_matters.mainRewardsScreen,
                    Nu = (0, I.Pi)(() => {
                        const u = g().mediaSize,
                            e = du(),
                            t = e.model,
                            n = e.controls,
                            E = t.computes.areAssetsLoaded();
                        var i;
                        return (
                            (0, r.useEffect)(() => {
                                E && n.showView();
                            ...
                            a().createElement(
                                'div',
                                { className: B()(_u.base, E && _u.base__visible) },
                                a().createElement(
                                    iu,
                                    ...
                                    t.computes
                                        ...
                                        .map((u, e) =>
                                            a().createElement(
                                                'div',
                                                { key: u.vehCD, className: B()(_u.reward, _u[`reward__${e + 1}`]) },
                                                a().createElement(
                                                    Hu,
                                                    Pu({}, u, {
                                                        index: e,
                                ...
                                a().createElement('div', { className: _u.shadow }),
                                a().createElement('div', { className: _u.title }, Wu.title()),
                                a().createElement(ru, { text: Wu.subtitle(), classMix: _u.subtitle }),
                                a().createElement(
                                    'div',
                                    { className: _u.backButtonWrapper },
                                    a().createElement(H, {
                                        caption: Wu.buttons.back(),
                                        goto: u > _.ExtraSmall ? Wu.buttons.backTo() : '',
                                        onClick: n.back,
                                    }),
                                ),
                            )
                ...
                engine.whenReady.then(() => {
                    S().render(
                        a().createElement(Cu, null, a().createElement(T, null, a().createElement(Nu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [965], () => __webpack_require__(407));
