(() => {
    var __webpack_modules__ = {
            ...
            525: (u, e, t) => {
                ...
                function Mu(u, e = 0, t = u.length - 1) {
                    return {
                        [Symbol.iterator]() {
                            let r = Math.max(e, 0);
                            const a = Math.min(
                ...
                const yu = (u, e) => ({
                        ...
                        tooltipArgs: Au({ [Du]: u.tooltipId, [du]: e }),
                    }),
                    Pu = (u) => ({ rewardToken: u }),
                    Ou = ((u, e) => {
                        ...
                        ({ observableModel: u }) => {
                            const e = {
                                ...
                                t = vu.LO.box(0),
                                r = (0, Lu.Om)(() => Su(e.vehicles.get(), pu), { equals: bu }),
                                a = (0, Lu.Om)(
                                    () => {
                                        const u = Su(e.regularBonusModels.get(), (u) => yu(u, gu.Regular));
                                        return e.primitives.state.get() === Bu.Final && s() ? n(u.length).concat(u) : u;
                                    },
                                    { equals: bu },
                                ),
                                n = (0, Lu.Om)((u) =>
                                    Su(e.vehicles.get(), (e, t) =>
                                        yu(
                                            ((u, e) => ({
                                                item: '',
                                                overlayType: '',
                                ...
                                i = (0, Lu.Om)(
                                    () => Su(e.intermediateBonusModels.get(), (u) => yu(u, gu.Intermediate)),
                                    { equals: bu },
                                ),
                                s = (0, Lu.Om)(
                                    () => Su(e.intermediateBonusModels.get(), (u) => yu(u, gu.Intermediate))[0],
                                    { equals: bu },
                                ),
                                o = (0, Lu.Om)(
                                    () =>
                                        Boolean(r().length) ||
                                        Boolean(i().length) ||
                                        e.primitives.state.get() === Bu.Token,
                                    { equals: bu },
                                ),
                                l = (0, Lu.Om)(() => (o() ? i() : Tu(a(), (u, e) => e < 5)), { equals: bu }),
                                E = (0, Lu.Om)(
                                    () => {
                                        const u = a();
                                        return o() ? u : Tu(u, (u, e) => e >= 5);
                                    },
                                    { equals: bu },
                                ),
                                c = (0, Lu.Om)(() => [...Mu(E(), 10 * t.get(), 10 * (t.get() + 1) - 1)]),
                                _ = (0, Lu.Om)(() => E().length > 10),
                                A = (0, Lu.Om)(() => {
                                    const u = E().length,
                                        e = t.get() + 1;
                            ...
                            return Object.assign({}, e.primitives, {
                                ...
                                computes: {
                                    ...
                                    hasMoreRewards: _,
                                    moreRewardsCount: A,
                                    isRibbonGold: (0, Lu.Om)(() =>
                                        [Bu.Final, Bu.TokenVehicle].includes(e.primitives.state.get()),
                                    ),
                                    isLightVisible: (0, Lu.Om)(() => ![Bu.Regular].includes(e.primitives.state.get())),
                                },
                            });
                        },
                        ({ externalModel: u, model: e }) => ({
                            ...
                            chooseVehicle: u.createCallback(Pu, 'onChooseVehicle'),
                    ...
                    const d = (0, r.useRef)(null),
                        ...
                        k = g()(
                            ...
                            Wu[`base__${n}`],
                            {
                                ...
                                [Wu.base__firstHover]: w,
                            },
                            s,
                        ),
                        N = g()(Wu.state, Wu.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                ...
                const Qu = (u, e, t) => {
                    ...
                    Ju = (u, e, t = ju.left) => u.split(e).reduce(t === ju.left ? Qu : Zu, []),
                    ue = (() => {
                        const u = new RegExp(
                        ...
                        return ee.includes(t)
                            ...
                            : ((u, e = ju.left) => {
                                  ...
                                  const r =
                                      ...
                                      a = u.replace(/&nbsp;/g, ' ');
                                  return (Ju(a, /( )/, e).forEach((u) => (t = t.concat(Ju(u, r, ju.left)))), t);
                              })(u, e);
                    },
                    re = 'FormatText_base_d0',
                    ae = ({ binding: u, text: e = '', classMix: t, alignment: n = ju.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, i) =>
                                      a().createElement(
                                          'div',
                                          { className: g()(re, t), key: `${e}-${i}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : te(u, e))))(e, n, u).map((u, e) =>
                    ...
                    ne = 'Action_base_fc',
                    ie = ({ type: u, text: e, binding: t, onClick: r }) =>
                        a().createElement(
                            zu,
                            { type: u, size: Vu.medium, mixClass: ne, onClick: r },
                            a().createElement(ae, { text: e, binding: t }),
                        ),
                    se = R.strings.battle_matters.rewards.footer,
                    oe = (0, z.Pi)(({ type: u }) => {
                        const e = Nu(),
                            t = e.controls,
                        ...
                        return r
                            ...
                            : a().createElement(ie, { type: u, text: se.confirm(), onClick: t.close });
                    }),
                    le = R.strings.battle_matters.rewards.footer,
                    Ee = [Cu.First, Cu.Middle],
                    ce = (0, z.Pi)(() => {
                        const u = Nu(),
                            e = u.controls,
                            t = u.model;
                        return Ee.includes(t.rewardViewsSequenceNumber.get())
                            ? a().createElement(oe, { type: Xu.primary })
                            : 1 === t.questNumber.get()
                              ? a().createElement(
                                    a().Fragment,
                                    null,
                                    ...
                                    t.computes.hasMoreRewards() && a().createElement(oe, { type: Xu.secondary }),
                                )
                              : 1 === t.computes.getVehicleRewards().length
                                ? a().createElement(
                                      ...
                                      a().createElement(oe, { type: Xu.secondary }),
                                  )
                                : t.state.get() === Bu.Final
                                  ? a().createElement(oe, { type: Xu.primary })
                                  : a().createElement(
                                        a().Fragment,
                                        null,
                    ...
                    _e = 'Footer_base_a6',
                    Ae = 'Footer_base__showed_e9',
                    me = ({ additionalRewardsShowed: u }) => {
                        const e = $u(`.${Wu.base}`)[0];
                        return a().createElement(
                            'div',
                            { className: g()(_e, u && Ae), ref: e },
                            a().createElement(ce, null),
                        );
                    },
                    Fe = 'Header_base_34',
                    de = 'Header_title_8c',
                    De = 'Header_subTitle_81',
                    Be = 'Header_completed_86',
                    Ce = 'Header_completedIcon_af',
                    ge = 'Header_completedText_a3',
                    he = R.strings.battle_matters.rewards,
                    pe = [Cu.Middle, Cu.Last],
                    be = (0, z.Pi)(() => {
                        const u = Nu().model,
                            e = u.state.get(),
                            t = pe.includes(u.rewardViewsSequenceNumber.get()),
                            r = (() => {
                                switch (e) {
                                    case Bu.Final:
                                        return he.subTitle.final();
                                    case Bu.TokenVehicle:
                                        return he.subTitle.tokenVehicle();
                                    default:
                                        return Yu(he.subTitle.regular(), { questNumber: u.questNumber.get() });
                                }
                            })();
                        return a().createElement(
                            'div',
                            { className: Fe },
                            a().createElement('div', { className: de }, he.title()),
                            a().createElement('div', { className: De }, r),
                            t &&
                                a().createElement(
                                    'div',
                                    { className: Be },
                                    a().createElement('div', { className: Ce }),
                                    a().createElement(ae, { text: he.previouslyCompleted(), classMix: ge }),
                                ),
                        );
                    }),
                    ve = [
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (fe(t, m, { isMouseEvent: !0, on: !0, arguments: we(a) }, b),
                                    C && C(),
                ...
                const ke = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return a().createElement(Pe, e, r);
                        const n = e.contentId,
                            i = e.args,
                            s = null == i ? void 0 : i.contentId;
                        return n || s
                            ? a().createElement(xe, Oe({}, e, { contentId: n || s }), r)
                            : a().createElement(Te, e, r);
                    },
                    Ne = {
                        base: 'Reward_base_ea',
                    ...
                    Ie = ({
                        ...
                        return a().createElement(
                            'div',
                            { className: g()(Ne.base, Ne[`base__${r}`], l), style: o },
                            a().createElement(
                                ke,
                                { tooltipArgs: c, className: Ne.tooltipWrapper },
                                a().createElement(
                                    a().Fragment,
                                    null,
                                    a().createElement(
                                        'div',
                                        { className: g()(Ne.image, null == E ? void 0 : E.image) },
                                        A &&
                                            a().createElement('div', {
                                                className: g()(Ne.highlight, null == E ? void 0 : E.highlight),
                                                style: {
                                        ...
                                        e &&
                                            a().createElement('div', {
                                                className: g()(Ne.icon, null == E ? void 0 : E.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        m &&
                                            a().createElement('div', {
                                                className: g()(Ne.overlay, null == E ? void 0 : E.overlay),
                                                style: {
                            ...
                            t &&
                                a().createElement(
                                    ...
                                    { tooltipArgs: _ },
                                    a().createElement('div', {
                                        className: g()(Ne.timer, null == E ? void 0 : E.periodicIcon),
                                    }),
                                ),
                        );
                    };
                var He = t(30);
                const Ue = 'AnimatedReward_base_a0',
                    Ge = (u) => Math.sqrt(1 - Math.pow(--u, 2)),
                    We = ({ index: u = 0, delay: e = 0, onEnd: t, children: r }) => {
                        const n = (0, He.useSpring)({
                            from: { transform: 'translateY(20rem)', opacity: 0 },
                            to: { transform: 'translateY(0rem)', opacity: 1 },
                            delay: e + 100 * u,
                            config: { duration: 400, easing: Ge },
                            onStart: () => {
                                I('gui_random_reward_appear');
                            },
                            onRest: t,
                        });
                        return a().createElement(He.animated.div, { className: Ue, style: n }, r);
                    },
                    $e = {
                    ...
                    Ve = ({ size: u, name: e, special: t, valueType: r, value: n, image: i, tooltipArgs: s }) => {
                        const o = Fu(n, r),
                            l = mu(t),
                            E = Xe[u],
                            c = i(E);
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: g()($e.base, $e[`base__size${u}`]) },
                                a().createElement('div', {
                                    className: $e.image,
                                ...
                                a().createElement(
                                    'div',
                                    { className: g()($e.value, $e[`value__${e}`], $e[`value__${r}`]) },
                                    o,
                                ),
                            ),
                        );
                ...
                var qe = t(887),
                    ze = t.n(qe);
                const je = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Ye = (u) => u.includes('_') && ((u) => je.includes(u))(u.split('_').at(-1)),
                    ...
                    Qe = (u, e) =>
                        Object.keys(u).reduce((t, r) => {
                            ...
                            return (
                                void 0 === a ||
                                    ((u, e) => je.some((t) => void 0 !== e[`${u}_${t}`]))(r, u) ||
                                    (t[r] = a),
                                t
                            );
                        }, {}),
                    Ze = (u, e = Qe) => {
                        ...
                        return a().memo((e) =>
                            Object.keys(e).some((u) => Ye(u) && void 0 !== e[u])
                                ? a().createElement(t, e)
                                : a().createElement(u, e),
                        );
                    },
                ...
                const tt = {
                    ...
                    rt = (Object.keys(tt), ['mt', 'mr', 'mb', 'ml']),
                    at = { mt: 'marginTop', mr: 'marginRight', mb: 'marginBottom', ml: 'marginLeft' },
                    nt = Ze((u) => {
                        let e = u.className,
                            t = u.width,
                            n = u.height,
                            ...
                            P = u.shrink,
                            O = u.flex,
                            k = void 0 === O ? (y || P ? `${y ? 1 : 0} ${P ? 1 : 0} auto` : void 0) : O,
                            N = u.style,
                            I = u.children,
                            H = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const U = (0, r.useMemo)(() => {
                                const u = { mt: o, mr: E, mb: _, ml: m },
                                    e = ((u) =>
                                        rt.reduce((e, t) => {
                                            const r = u[t];
                                            return r && 'number' != typeof r ? e.concat(tt[!0 === r ? 'MD' : r][t]) : e;
                                        }, []))(u),
                                    r = ((u) =>
                                        rt.reduce((e, t) => {
                                            const r = u[t];
                                            return ('number' == typeof r && (e[at[t]] = r + 'rem'), e);
                                        }, {}))(u);
                                return {
                        ...
                        return a().createElement('div', et({ className: g()(Je.base, ...W, e), style: G }, H), I);
                    });
                var it = t(532),
                    st = t.n(it);
                const ot = {
                    ...
                    lt = ['text', 'variant', 'className', 'color', 'm', 'mt', 'mr', 'mb', 'ml', 'style', 'format'];
                function Et() {
                    return (
                        (Et =
                            Object.assign ||
                ...
                Object.keys(ze());
                const ct = Object.keys(st()),
                    _t = { mt: 'MD', mr: 'SM', mb: 'SM', ml: 'SM' },
                    ...
                    Bt = Ze((u) => {
                        ...
                        return a().createElement(
                            ...
                            Et(
                                {
                                    className: g()(ot.base, t && ot[t], p, n),
                                    style: h,
                                    mt: !0 === l ? dt[t || 'paragraph-P16'].mt : l,
                                    mr: !0 === c ? dt[t || 'paragraph-P16'].mr : c,
                                    mb: !0 === A ? dt[t || 'paragraph-P16'].mb : A,
                                    ml: !0 === F ? dt[t || 'paragraph-P16'].ml : F,
                                },
                                B,
                            ),
                            void 0 !== D ? a().createElement(ae, Et({}, D, { text: e })) : e,
                        );
                    }),
                ...
                function ht(u) {
                    let e = '';
                    for (let t = gt.length - 1; t >= 0; t--) for (; u >= gt[t]; ) ((e += Ct[t]), (u -= gt[t]));
                    return e;
                }
                const pt = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    bt = 'TokenReward_base_9f',
                    vt = 'TokenReward_image_cb',
                    wt = 'TokenReward_title_72',
                    ft = 'TokenReward_description_b0',
                    xt = 'TokenReward_actionContainer_1c',
                    Rt = 'TokenReward_action_a9',
                    St = R.strings.battle_matters.rewards.token,
                    Tt = (0, z.Pi)(() => {
                        const u = Nu(),
                            e = u.controls,
                            t = u.model,
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement('div', { className: vt, style: { backgroundImage: o } }),
                            ),
                            a().createElement('div', { className: wt }, St.title()),
                            a().createElement(Bt, {
                                className: ft,
                    ...
                    Lt = R.strings.battle_matters.rewards,
                    yt = { 180: '180x135', 360: '360x270', 600: '600x450' },
                    Pt = ({
                        rentLength: u,
                        isElite: e,
                        level: t,
                        ...
                        const E = Boolean(u),
                            c = `R.images.gui.maps.shop.vehicles.c_${yt[o]}.${Ku(r)}`,
                        ...
                        return a().createElement(
                            Te,
                            { args: { [Du]: String(l), [du]: gu.Vehicle } },
                            a().createElement(
                                'div',
                                { className: g()(Mt.base, Mt[`base__size${o}`]) },
                                a().createElement(
                                    'div',
                                    { className: Mt.image, style: { backgroundImage: `url('${c}')` } },
                                    E && a().createElement('div', { className: Mt.rentMark }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: Mt.title },
                                ...
                                E &&
                                    a().createElement(
                                        'div',
                                        { className: Mt.rent },
                                        a().createElement('div', { className: Mt.rentIcon }),
                                        Yu(Lt.rent(), { rentLength: u }),
                                    ),
                            ),
                        );
                        var F;
                ...
                const kt = {
                    ...
                    It = 1100,
                    Ht = (0, z.Pi)(({ setMainRewardsShowed: u }) => {
                        const e = Nu().model,
                            t = f().mediaSize,
                            ...
                            i = kt[t][n.length - 1],
                            s = Nt[t][r.length - 1];
                        return e.state.get() === Bu.Token || (e.state.get() === Bu.Final && e.computes.getToken())
                            ? a().createElement(We, { delay: It, onEnd: () => u(!0) }, a().createElement(Tt, null))
                            : r.length
                              ? a().createElement(
                                    a().Fragment,
                                    null,
                                    r.map((e, t) =>
                                        a().createElement(
                                            ...
                                            a().createElement(Pt, Ot({}, e, { size: s })),
                                        ),
                                    ),
                                )
                              : a().createElement(
                                    ...
                                    n.map((e, t) =>
                                        a().createElement(
                                            ...
                                            a().createElement(Ve, Ot({}, e, { size: i })),
                                        ),
                                    ),
                                );
                    }),
                    Ut = 'RewardList_base_f2',
                    Gt = 'RewardList_base__additional_55',
                    Wt = 'RewardList_mainRewards_a0',
                    $t = 'RewardList_lines_b0',
                    Xt = 'RewardList_rays_e2',
                    Vt = 'RewardList_ribbonWrapper_b4',
                    qt = 'RewardList_ribbon_fc',
                    zt = 'RewardList_ribbon__gold_b5',
                    jt = 'RewardList_additional_8c',
                    Yt = 'RewardList_additionalWrapper_f1',
                    Kt = 'RewardList_additionalTitle_12',
                    Qt = 'RewardList_additionalReward_05';
                function Zt() {
                    return (
                        (Zt =
                            Object.assign ||
                ...
                const Jt = R.strings.battle_matters.rewards,
                    ur = (0, z.Pi)(({ setAdditionalRewardsShowed: u }) => {
                        const e = Nu().model,
                            t = f().mediaSize,
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: g()(Ut, n.length && Gt) },
                                a().createElement(
                                    'div',
                                    { className: Wt },
                                    s && a().createElement('div', { className: Xt }),
                                    a().createElement(
                                        'div',
                                        { className: Vt },
                                        a().createElement('div', {
                                            className: g()(qt, e.computes.isRibbonGold() && zt),
                                        }),
                                    ),
                                    s && a().createElement('div', { className: $t }),
                                    a().createElement(Ht, { setMainRewardsShowed: E }),
                                ),
                                Boolean(n.length) &&
                                    l &&
                                    a().createElement(
                                        'div',
                                        { className: jt },
                                        a().createElement('div', { className: Kt }, Jt.additionalTitle()),
                                        a().createElement(
                                            'div',
                                            { className: Yt },
                                            n.map((e, t) =>
                    ...
                    er = (0, z.Pi)(() => {
                        ...
                        return (
                            ...
                            a().createElement(
                                ...
                                a().createElement('div', { className: Hu }, a().createElement(be, null)),
                                a().createElement(ur, { setAdditionalRewardsShowed: n }),
                                a().createElement(
                                    'div',
                                    { className: Uu },
                                    a().createElement(W, {
                                ...
                                a().createElement(
                                    'div',
                                    { className: Gu },
                                    a().createElement(me, { additionalRewardsShowed: t }),
                                ),
                            )
                        );
                    });
                engine.whenReady.then(() => {
                    N().render(
                        a().createElement(ku, null, a().createElement(O, null, a().createElement(er, null))),
