(() => {
    ...
    var __webpack_modules__ = {
            768: (u, e, t) => {
                ...
                var n = {};
                (t.r(n),
                    t.d(n, { mouse: () => c, off: () => D, on: () => s, onResize: () => i, onScaleUpdated: () => a }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        events: () => n,
                ...
                var o = {};
                (t.r(o), t.d(o, { getBgUrl: () => b, getTextureUrl: () => p }));
                var A = {};
                function E(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const v = {
                    ...
                    w = Object.keys(m).reduce((u, e) => ((u[e] = () => l(m[e])), u), {}),
            ...
            165: (u, e, t) => {
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (D(t, d, { isMouseEvent: !0, on: !0, arguments: s(r) }, f),
                                    h && h(),
                                      ...
                                      Object.assign(
                                          {
                                              ...
                                              onClick: ((u) => (e) => {
                                                  (!1 === l && O(), null == F || F(e), null == u || u(e));
                                              })(e.props.onClick),
                                              onMouseDown: ((u) => (e) => {
                                                  (!1 === l && O(), null == E || E(e), null == u || u(e));
                                              })(e.props.onMouseDown),
                                          },
                                          b,
                                      ),
                                ...
                                const n = Date.now(),
                                    o = setInterval(
                                        () => {
                                            ...
                                            null !== t && e <= t ? (E(t), r && r(), clearInterval(o)) : E(e);
                                        },
                                        1e3 * (e || (u > 120 ? 60 : 1)),
                                    );
                                return () => {
                ...
                const f = (u) => (0 === u ? window : window.subViews.get(u)),
                    y = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: o, children: A, mocks: E }) {
                                const F = (0, n.useRef)([]),
                                    i = (u, t, n) => {
                                        var r;
                                        const o = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, o) => {
                                                        const E = 'string' == typeof o ? `${n}.${o}` : n,
                                                            F = _.O.view.addModelObserver(E, e, !0);
                                    ...
                                    D = s[0],
                                    B = s[1],
                                    c = (0, n.useState)(() => i(u, o, E)),
                                    l = c[0],
                                    C = c[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        a.current ? C(i(D, o, E)) : (a.current = !0);
                                    }, [E, D, o]),
                                    (0, n.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                    ...
                    })(0, ({ externalModel: u }) => ({ openBranchSelection: u.createCallbackNoArgs('onClick') })),
                    O = y[0],
                    T = y[1],
                    k = (0, h.Pi)(() => {
                        const u = T(),
                            ...
                            A = ((u, e = !0) =>
                                u.days > 7 && e
                                    ...
                                    : u.days >= 1
                                      ? 0 === u.hours
                                          ? l(R.strings.common.duration.days(), { days: u.days })
                                          : `${l(R.strings.common.duration.days(), { days: u.days })} ${l(R.strings.common.duration.hours(), { hours: u.hours })}`
                                      : u.hours >= 1
                                        ? 0 === u.minutes
                                            ? l(R.strings.common.duration.hours(), { hours: u.hours })
                                            : `${l(R.strings.common.duration.hours(), { hours: u.hours })} ${l(R.strings.common.duration.minutes(), { minutes: u.minutes })}`
                                        : l(R.strings.common.duration.minutes(), { minutes: u.minutes || 1 }))(
                                (function (u = 0) {
                                    let e = u;
                        ...
                        return r().createElement(
                            B,
                            { contentId: R.views.tech_tree_trade_in.lobby.tooltips.WidgetTooltipView('resId') },
                            r().createElement(
                                'div',
                                {
                                    className: F()('App_base_62', o && 'App_base__extended_94'),
                                    onMouseEnter: _.O.sound.play.highlight,
                                    onClick: function () {
                                        (e.openBranchSelection(), _.O.sound.play.click());
                                    },
                                },
                                r().createElement(
                                    'div',
                                    { className: 'App_bgContainer_88' },
                                    r().createElement('div', { className: 'App_bg_ca' }),
                                    r().createElement(
                                        'div',
                                        { className: 'App_arrowContainer_16' },
                                        r().createElement('div', { className: 'App_receiveArrow_47' }),
                                        r().createElement('div', { className: 'App_tradeArrow_11' }),
                                    ),
                                    r().createElement('div', { className: 'App_flash_4b' }),
                                ),
                                r().createElement(
                                    'div',
                                    { className: 'App_timer_c3' },
                                    r().createElement(
                                        'div',
                                        { className: 'App_text_b0' },
                                        R.strings.tech_tree_trade_in.entryPoint.text(),
                                    ),
                                    r().createElement(
                                        'div',
                                        { className: 'App_timeContainer_b6' },
                                        r().createElement(
                                            'div',
                                            { className: 'App_wrapper_b4' },
                                            r().createElement('div', { className: 'App_timerIcon_69' }),
                                        ),
                                        r().createElement('div', { className: 'App_timeDate_d5' }, A),
                                    ),
                                ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    A().render(r().createElement(O, null, r().createElement(k, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(165));
