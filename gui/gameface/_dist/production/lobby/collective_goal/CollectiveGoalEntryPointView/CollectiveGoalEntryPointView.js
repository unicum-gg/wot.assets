(() => {
    ...
    var __webpack_modules__ = {
            ...
            950: (u, e, t) => {
                ...
                const c = ((u, e) => {
                        ...
                        return [
                            function ({ mode: o = 'real', options: a, children: F, mocks: c }) {
                                ...
                                return (
                                    (0, n.useEffect)(() => {
                                        _.current ? p(D(C, a, c)) : (_.current = !0);
                                    }, [c, C, a]),
                                    (0, n.useEffect)(() => {
                                        m(o);
                                    }, [o]),
                        ...
                        ({ externalModel: u }) => ({ showProgression: u.createCallbackNoArgs('showProgression') }),
                    ),
                    d = c[0],
                    D = c[1];
                var _ = t(483),
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (h(t, d, { isMouseEvent: !0, on: !0, arguments: f(r) }, w),
                                    m && m(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((p.current.timeoutId = window.setTimeout(y, A ? 100 : 400)),
                                                      o && o(u),
                                                      M && M(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const x = ({ size: u = L.Default }) =>
                        r().createElement('div', { className: B()(N.background, N[`background__${u}`]) }),
                    U = {
                ...
                const W = 'ProgressBarDeltaGrow_base_7e',
                    ...
                    Q = (0, n.memo)(
                        ({
                            ...
                            const p = (0, n.useMemo)(() => Object.assign({ width: '100%' }, X(u), q(F)), [F, u]),
                                v = (0, n.useMemo)(() => Object.assign({ width: '0%' }, X(u), q(F)), [F, u]),
                                f = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Z(F, o), X(u)), [o, F, u]),
                                h = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(i - o)}%` }, Z(F, o), X(u)),
                                    [o, F, i, u],
                                );
                            if (D) return null;
                            const w = B()(W, A, F && 0 === i && Y);
                            return r().createElement(
                                'div',
                                { style: _ ? f : h, className: w },
                                r().createElement(
                                    'div',
                                    { style: m ? v : p, className: K },
                ...
                const au = (0, n.memo)((u) => {
                        ...
                        switch (o.animationSettings.type) {
                            case I.Simple:
                                return r().createElement(nu, ou({}, o, { onEndAnimation: E, isComplete: i }));
                            case I.Growing:
                                return r().createElement(J, ou({}, o, { onEndAnimation: E, isComplete: i }));
                            default:
                                return null;
                        }
                    }),
                    iu = ({ size: u, value: e, lineRef: t, disabled: o, onComplete: a }) => {
                        ...
                        return (
                            ...
                            r().createElement(j, { size: u, disabled: o, baseStyles: i, isComplete: s, lineRef: t })
                        );
                    },
                    su = ['onEndAnimation'];
                function Eu() {
                ...
                const Au = (0, n.memo)((u) => {
                    ...
                    return (
                        (o.current.from = i),
                        r().createElement(au, Eu({}, t, { onEndAnimation: a, key: `${i}-${t.to}`, from: i }))
                    );
                });
                function Fu() {
                    return (
                ...
                const lu = (0, n.memo)(
                        ({
                            ...
                            return a.withStack
                                ...
                                : r().createElement(au, Fu({ key: `${o}-${e}` }, A));
                        },
                    ),
                    cu = (u) => ({
                    ...
                    pu = ({ type: u, progress: e, goal: t, deltaFrom: n, className: o }) =>
                        r().createElement(
                            'div',
                            ...
                            switch (u) {
                                ...
                                default:
                                    return r().createElement(
                                        ...
                                        {
                                            contentId:
                                                R.views.lobby.collective_goal.tooltips.EntryPointTooltip('resId'),
                                            isEnabled: c,
                                        },
                                        e,
                                    );
                            ...
                            r().createElement(
                                ...
                                F &&
                                    r().createElement(pu, {
                                        ...
                                        goal: i,
                                        deltaFrom: o,
                                        className: B()(vu.flag, vu[`flag__${l}`]),
                                    }),
                            ),
                        );
                    });
