(() => {
    ...
    var __webpack_modules__ = {
            67: (e, t, n) => {
                ...
                const W = Object.keys(g).reduce((e, t) => ((e[t] = () => viewEnv.getShowingStatus() === g[t]), e), {}),
                    K = {
                        set: (e, t) => {
            ...
            164: (e, t, n) => {
                        ...
                        d(() => {
                            if (
                                ...
                                const n = (e) => {
                                    ...
                                    o = p(e);
                                h.current = b.addCallback(o, n, s, t === w.Deep);
                            }
                        }),
                        (0, o.useEffect)(() => {
                            if (t !== w.None)
                        ...
                        const C = (0, o.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            S = (0, o.useCallback)(() => {
                                (C.current.isVisible && C.current.timeoutId) ||
                                    (f(n, b, { isMouseEvent: !0, on: !0, arguments: h(r) }, M),
                                    O && O(),
                ...
                const ae = (0, o.memo)(
                    ...
                    be = 'BootcampQuestWidgetApp_base_07',
                    we = () => {
                        const e = g('model'),
                            t = e.current,
                            n = e.total,
                        ...
                        return i().createElement(
                            'div',
                            { className: be, onClick: s, onMouseEnter: l },
