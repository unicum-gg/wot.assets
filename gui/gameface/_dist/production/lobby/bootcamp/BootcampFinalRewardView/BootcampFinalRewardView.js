(() => {
            ...
            694: (u, e, t) => {
                ...
                const _ = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && o) return i(e, t, v);
                ...
                const S = {
                    ...
                    O = (u) => {
                        ...
                        const i = f(),
                            ...
                            E = i.mediaHeight,
                            A = i.mediaSize;
                        return r().createElement('div', L({ className: h()(t, S[n], M[E], T[A]) }, a), e);
                    },
                    y = ['children'];
                const H = (u) => {
                    let e = u.children,
                ...
                const G = ({
                    ...
                    const _ = (0, a.useRef)(null),
                        ...
                        f = p[1],
                        x = (0, a.useCallback)(() => {
                            n || (_.current && (_.current.focus(), m(!0)));
                        }, [n]),
                        L = (0, a.useCallback)(
                            (u) => {
                ...
                const z = (u = 1) => {
                    ...
                    Z = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const a = q(`${u}.${t}`, window);
                                return Y(a) ? e(u, t, a) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    Q = (u) => {
                        const e = ((u) => {
                                const e = z(),
                        ...
                        if (a.length > 0) {
                            ...
                            return (
                                a.reduce((e, a) => {
                                    const r = q(X(t, `${e}.${a}`), window);
                                    return Y(r) ? (u.push(r.id), `${e}.${a}.value`) : (u.push(a), `${e}.${a}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        B(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    a = Q(u);
                                l.current = J.addCallback(a, t, E, e === uu.Deep);
                            }
                        }),
                        (0, a.useEffect)(() => {
                            if (e !== uu.None)
                                return () => {
                                    J.removeCallback(l.current, E);
                                };
                        }, [E, e]),
                        s
                    );
                ...
                function ru(u = tu.n.NONE, e = au, t = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== tu.n.NONE)
                            return (
                ...
                const iu = 'Vehicle_base_88',
                    nu = 'Vehicle_icon_a4',
                    Eu = 'Vehicle_name_66',
                    Au = (0, a.memo)(({ icon: u, name: e }) => {
                        const t = (0, a.useMemo)(() => ({ backgroundImage: `url(${u})` }), [u]);
                        return r().createElement(
                            'div',
                            { className: iu },
                            r().createElement('div', { className: nu, style: t }),
                            r().createElement('div', { className: Eu }, e),
                        );
                    }),
                    Fu = 'BootcampFinalRewardViewApp_base_43',
                    su = 'BootcampFinalRewardViewApp_container_0d',
                    ou = 'BootcampFinalRewardViewApp_back_81',
                    lu = 'BootcampFinalRewardViewApp_header_31',
                    Du = 'BootcampFinalRewardViewApp_description_8f',
                    du = 'BootcampFinalRewardViewApp_icon_27',
                    cu = 'BootcampFinalRewardViewApp_ribbon_03',
                    _u = 'BootcampFinalRewardViewApp_vehicles_a9',
                    Bu = 'BootcampFinalRewardViewApp_button_72',
                    Cu = 'BootcampFinalRewardViewApp_button__blank_1f',
                    mu = R.strings.bootcamp.finalReward,
                    hu = () => {
                        const u = eu('model'),
                            e = u.isNeedAwarding,
                            t = u.vehicles,
                            i = u.onProceed,
                            n = (0, a.useCallback)(() => i(), [i]);
                        var E;
                        (E = n), ru(tu.n.ESCAPE, E);
                        const A = h()(Bu, !e && Cu),
                            F = e ? mu.title() : mu.received.title(),
                            s = e ? mu.description() : mu.received.description();
                        return r().createElement(
                            'div',
                            { className: Fu },
                            ...
                            r().createElement(
                                ...
                                r().createElement('div', { className: Du }, s),
                                ...
                                e &&
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            ...
                                            t.map(
                                                ({ value: u, id: e }) =>
                                                    u && r().createElement(Au, { key: e, icon: u.icon, name: u.name }),
                                            ),
                                        ),
                                    ),
                                r().createElement(
                                    V,
                                    { type: I.primary, size: U.medium, onClick: n, mixClass: A },
                                    mu.proceed(),
                                ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    P().render(
                        r().createElement(H, null, r().createElement(hu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [172], () => __webpack_require__(694));
