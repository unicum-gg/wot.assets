(() => {
            ...
            728: (u, e, t) => {
                ...
                const l = (u = 1) => {
                    ...
                    h = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const A = v(`${u}.${t}`, window);
                                return p(A) ? e(u, t, A) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    f = (u) => {
                        const e = ((u) => {
                                const e = l(),
                            ...
                            w(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        A = f(u);
                                    s.current = b.addCallback(A, t, r, e === g.Deep);
                                }
                            }),
                            (0, A.useEffect)(() => {
                                if (e !== g.None)
                                    return () => {
                                        b.removeCallback(s.current, r);
                                    };
                            }, [r, e]),
                            D
                        );
                    },
                    T = (d.Sw.instance, 'RewardsTooltipApp_base_e1'),
                    y = 'RewardsTooltipApp_title_06',
                    P = 'RewardsTooltipApp_icon_8c',
                    M = 'RewardsTooltipApp_header_dd',
                    k = 'RewardsTooltipApp_description_98',
                    N = 'RewardsTooltipApp_status_81',
                    S = 'RewardsTooltipApp_statusIcon_86',
                    L = R.strings.bootcamp.tooltip.progression.label,
                    x = () => {
                        const u = O().isNeedAwarding;
                        return F().createElement(
                            'div',
                            { className: T },
                            F().createElement('div', { className: y }, L.header()),
                            F().createElement('div', { className: P }),
                            F().createElement('div', { className: M }, L.gold()),
                            F().createElement('div', { className: k }, L.description1()),
                            F().createElement('div', { className: M }, L.subheader2()),
                            F().createElement('div', { className: k }, L.description2()),
                            F().createElement('div', { className: M }, L.subheader3()),
                            F().createElement('div', { className: k }, L.description3()),
                            !u &&
                                F().createElement(
                                    'div',
                                    { className: N },
                                    F().createElement('div', { className: S }),
                                    R.strings.bootcamp.tooltip.progression.status.got(),
                                ),
                        );
                    };
                engine.whenReady.then(() => {
                    n().render(F().createElement(C, null, F().createElement(x, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [172], () => __webpack_require__(728));
