(() => {
    var __webpack_modules__ = {
            ...
            669: (u, e, t) => {
                ...
                const l = i.O.client.getSize('rem'),
                    A = l.width,
                    F = l.height,
                    c = Object.assign({ width: A, height: F }, E(A, F, o)),
                    ...
                    m = (u) => {
                        ...
                        const n = (0, r.useContext)(d),
                            ...
                            w = { extraLarge: C, large: _, medium: h, small: g, extraSmall: v };
                ...
                const x = {
                    ...
                    y = (u) => {
                        ...
                        const i = (() => {
                            ...
                            s = i.mediaHeight,
                            E = i.mediaSize;
                        return n().createElement('div', p({ className: _()(t, x[o], S[s], L[E]) }, a), e);
                    },
                    O = ['children'],
                    T = (u) => {
                        let e = u.children,
                ...
                const H = (u, e) => {
                    ...
                    I = ({
                        ...
                        return n().createElement(
                            'div',
                            { className: _()('InfoDecorator_base_e3', e) },
                            n().createElement(
                                'svg',
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement('stop', { offset: '0%', stopColor: t, stopOpacity: '0%' }),
                            ...
                            u,
                            n().createElement('div', {
                                className: _()('InfoDecorator_arrow_36', null == o ? void 0 : o.arrow),
                            }),
                        );
                    };
                let W;
                !(function (u) {
                    ((u.Lock = 'lock'), (u.Active = 'active'), (u.Paused = 'paused'), (u.Done = 'done'));
                })(W || (W = {}));
                function N() {
                    return !1;
                }
                                ...
                                const E = (0, r.useRef)([]),
                                    l = (u, t, r) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            A = (({ observableModel: u }) => ({ root: u.object() }))({
                                                mode: u,
                                                readByPath: s,
                                                externalModel: o,
                                                observableModel: {
                                    ...
                                    c = F[0],
                                    d = F[1],
                                    D = (0, r.useState)(() => l(u, a, s)),
                                    m = D[0],
                                    B = D[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        A.current ? B(l(c, a, s)) : (A.current = !0);
                                    }, [s, c, a]),
                                    (0, r.useEffect)(() => {
                                        d(u);
                                    }, [u]),
                ...
                const nu = () => {},
                    au = {
                        base: 'Counter_base_89',
                        base__single: 'Counter_base__single_fa',
                        base__shake: 'Counter_base__shake_f3',
                        scale: 'Counter_scale_45',
                        icon: 'Counter_icon_05',
                        shake: 'Counter_shake_b6',
                        count: 'Counter_count_0d',
                    },
                    iu = {
                        initial: { state: 'initial', stop: !0 },
                        idle: { state: 'idle', nextState: 'shake', timeout: 400 },
                        shake: { state: 'shake', nextState: 'counting', timeout: 1100 },
                        counting: { state: 'counting', nextState: 'end', timeout: 1500 },
                        end: { state: 'end', stop: !0 },
                    },
                    ou = ({ points: u, isSingle: e, prevPointsFromModel: t }) => {
                        const a = ((u, e, t = !0) => {
                                const n = (0, r.useState)(u[e]),
                                    a = n[0],
                                    i = n[1],
                                    o = (0, r.useRef)(nu),
                                    s = (0, r.useCallback)(() => {
                                        a.stop ||
                                            (o.current(),
                                            (o.current = H(() => {
                                                i(u[null == a ? void 0 : a.nextState]);
                                            }, a.timeout)));
                                    }, [a, u]);
                                return (
                                    (0, r.useEffect)(() => (t && s(), () => o.current()), [t, s]),
                                    {
                                        step: a,
                            ...
                            A = (0, ru.useSpring)(() => ({
                                progress: t,
                                onChange: (u) => {
                                    l(Math.floor(u.value.progress));
                                },
                            }))[1];
                        return (
                            (0, r.useEffect)(() => {
                                'counting' === i &&
                                    A.start({ from: { progress: E }, to: { progress: u }, config: { duration: 500 } });
                            }, [E, i, A, u]),
                            (0, r.useEffect)(() => {
                                t === u || o === t || ('initial' !== i && 'end' !== i) || a.setStep('idle');
                            }, [a, i, u, t, o]),
                            n().createElement(
                                'div',
                                { className: _()(au.base, au[`base__${i}`], e && au.base__single) },
                                n().createElement('div', { className: au.icon }),
                                n().createElement('div', { className: au.count }, E > 99999 ? '9999+' : E),
                            )
                        );
                    },
                    su = [
                ...
                const lu = (0, r.memo)(function (u) {
                        ...
                        return (
                                                ...
                                                r = window.setInterval(() => {
                                                    ...
                                                    a
                                                        ? (null == o || o(n, a),
                                                          ...
                                                          n === c &&
                                                              (null == _ || _(),
                                                              D || (null == C || C(), window.clearInterval(r))))
                                                        : console.error(
                            ...
                            n().createElement('canvas', Eu({}, g, { width: e, height: t, ref: v }))
                        );
                    }),
                    Au = (u, e) => {
                        let t = u;
                    ...
                    du = R.strings.grinch_progression.duration,
                    Du = {
                        width: 16,
                        height: 16,
                        frameCount: 15,
                        chunk: { count: 0, rows: 1, columns: 15 },
                        getChunkPath: (u) =>
                            `R.images.grinch_progression.gui.maps.icons.game_board.markers.sequence.hourglass_${u}`,
                    };
                const mu = (function (u) {
                        const e = u.chunk,
                            t = e.rows * e.columns;
                    ...
                    Bu = ({ countdown: u, markerState: e = W.Lock, isSingle: t }) => {
                        const r = (function (u = 0) {
                                let e = u;
                                const t = Math.trunc(e / 86400);
                                e -= 86400 * t;
                                const r = Math.trunc(e / Q);
                                e -= r * Q;
                                const n = Math.trunc(e / X);
                                return ((e -= n * X), { days: t, hours: r, minutes: n, seconds: e });
                            })(tu(u, 1)),
                            a = ((u) =>
                                u.days
                                    ? K(du.$plural('days', u.days), { days: u.days })
                                    : u.hours
                                      ? K(du.hours(), { hours: u.hours })
                                      : K(du.minutes(), { minutes: u.minutes || 1 }))(r),
                            i = !(r.days || r.hours || r.minutes) && r.seconds < X;
                        return n().createElement(
                            'div',
                            { className: _()('Timer_base_63', t && 'Timer_base__single_11') },
                            i
                                ? n().createElement(lu, {
                                      width: Du.width,
                                      height: Du.height,
                                      ...
                                      getImageSource: mu,
                                      frameTime: 120,
                                      className: 'Timer_sequence_b7',
                                  })
                                : n().createElement('div', {
                                      className: _()('Timer_icon_98', e === W.Lock && 'Timer_icon__lock_18'),
                                  }),
                            n().createElement('div', { className: 'Timer_count_8f' }, a),
                        );
                    },
                    Cu = (0, P.Pi)(() => {
                        ...
                        switch (r) {
                            case W.Lock:
                                return n().createElement(Bu, { countdown: t, isSingle: !0 });
                            case W.Active:
                                return n().createElement(ou, { points: e, prevPointsFromModel: a, isSingle: !0 });
                            case W.Paused:
                                return n().createElement(
                                    'div',
                                    { className: 'Content_base_d0' },
                                    n().createElement(Bu, { countdown: t, markerState: r }),
                                    n().createElement('div', { className: 'Content_separator_01' }),
                                    n().createElement(ou, { points: e, prevPointsFromModel: a }),
                                );
                            default:
                            case W.Done:
                                return n().createElement('div', { className: 'Content_done_f7' });
                        }
                    }),
                    _u = {
                        base: 'AnimationContent_base_c0',
                        boxes: 'AnimationContent_boxes_5d',
                        box: 'AnimationContent_box_7e',
                        splash: 'AnimationContent_splash_80',
                        box__fill: 'AnimationContent_box__fill_1f',
                        box__1: 'AnimationContent_box__1_43',
                        box__2: 'AnimationContent_box__2_29',
                        box__3: 'AnimationContent_box__3_ea',
                        box__4: 'AnimationContent_box__4_3f',
                        box__5: 'AnimationContent_box__5_db',
                        box__6: 'AnimationContent_box__6_1d',
                        box__7: 'AnimationContent_box__7_cf',
                        item: 'AnimationContent_item_18',
                        marker: 'AnimationContent_marker_ed',
                        base__idle: 'AnimationContent_base__idle_63',
                        blink: 'AnimationContent_blink_e3',
                        base__shake: 'AnimationContent_base__shake_a4',
                        scale: 'AnimationContent_scale_e4',
                    };
                var hu;
                !(function (u) {
                    ((u.None = 'none'), (u.Idle = 'idle'), (u.Shake = 'shake'));
                })(hu || (hu = {}));
                const gu = (0, P.Pi)(({ className: u }) => {
                        const e = z().model.root.get(),
                            t = e.points,
                            a = e.markerState,
                            i = e.prevPoints,
                            o = e.enoughForClaimReward,
                            s = e.syncInitiator,
                            E = (0, r.useState)(hu.None),
                            l = E[0],
                            A = E[1];
                        return (
                            (0, r.useEffect)(() => {
                            ...
                            n().createElement(
                                'div',
                                { className: _()(_u.base, _u[`base__${l}`], u) },
                                l === hu.Shake &&
                                    n().createElement(
                                        'div',
                                        { className: _u.boxes },
                                        ((u, e) => {
                                            const t = [];
                                            for (let u = 0; u < 7; u++) t.push(e(u));
                                            return t;
                                        })(0, (u) => {
                                            const e = 2 === u || 5 === u;
                                            return n().createElement('div', {
                                                key: u,
                                                className: _()(_u.box, e && _u.box__fill, _u[`box__${u + 1}`]),
                                            });
                                        }),
                                    ),
                                n().createElement(
                                    I,
                                    { className: _u.marker },
                                    n().createElement('div', { className: _u.item }, n().createElement(Cu, null)),
                                ),
                            )
                        );
                    }),
                    vu = (0, P.Pi)(() => {
                        const u = z().model.root.get().isVisible;
                        return (
                            (0, r.useEffect)(() => {
                                i.O.view.resize(340, 150, 'rem');
                            }, []),
                            n().createElement(
                                'div',
                                { className: 'App_base_b3', lang: R.strings.settings.LANGUAGE_CODE() },
                                u &&
                                    n().createElement(
                                        'div',
                                        { className: 'App_inner_7a' },
                ...
                engine.whenReady.then(() => {
                    k().render(
                        n().createElement(T, null, n().createElement(q, null, n().createElement(vu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(669));
