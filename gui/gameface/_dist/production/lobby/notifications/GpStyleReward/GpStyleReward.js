(() => {
    ...
    var __webpack_modules__ = {
            ...
            394: (u, e, t) => {
                ...
                (((B = c || (c = {})).Items = 'items'),
                    ...
                    (B.NewYearGuestD = 'ny_dog'),
                    (B.EquipCoin = 'equipCoin'),
                    ...
                    (B.DeluxeGift = 'deluxe_gift'),
                    (B.BattleBoosterGift = 'battleBooster_gift'),
                    (B.OptionalDevice = 'optionalDevice'),
                    (B.LootBox = 'lootBox'),
                    (B.BrCoin = 'brcoin'),
                    (function (u) {
                        ((u.Gold = 'gold'),
                ...
                const C = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    g = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3],
                    p = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    b = (u) =>
                        p
                            ? `${u}`
                            : (function (u) {
                ...
                const y = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    S = (u, e, t = h.left) => u.split(e).reduce(t === h.left ? x : P, []),
                    T = (() => {
                        const u = new RegExp(
                ...
                const k = [
                    ...
                    L = [c.Gold, c.Credits, c.Crystal, c.FreeXp],
                    M = [c.BattlePassPoints, c.EquipCoin],
                    U = [c.PremiumPlus, c.Premium],
                            ...
                            s = (0, n.useCallback)(() => {
                                r.stop ||
                                    ...
                                    (o.current = ((e, t) => {
                                        let n;
                                        const a = setTimeout(() => {
                                            n = void i(u[null == r ? void 0 : r.nextState]);
                                        }, t);
                                        return () => {
                ...
                const Z = Q.O.client.getSize('rem'),
                    ...
                    au = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && c) return X(e, t, g);
                            if (t.largeWidth && E) return X(e, t, g);
                ...
                ((au.defaultProps = {
                    ...
                    (0, n.memo)(au),
                    ((ou = ru || (ru = {})).ExtraSmall = 'extraSmall'),
                    (ou.Small = 'small'),
                    (ou.Medium = 'medium'),
                    (ou.Large = 'large'),
                    (ou.ExtraLarge = 'extraLarge'),
                    (function (u) {
                        ((u.Ru = 'RU'),
                            (u.Eu = 'EU'),
                            (u.Na = 'NA'),
                ...
                const Du = {
                    ...
                    pu = ({
                        ...
                        initAnimationState: _ = 'idle',
                    }) => {
                        const A = j(o, _, d).step.state;
                        return (
                            (0, n.useEffect)(() => {
                                i(A);
                            }, [A, i]),
                            a().createElement(
                                'div',
                                {
                                    className: l()(du.base, du[`base__${A}`], t),
                                    style: {
                                ...
                                a().createElement(
                                    'div',
                                    { className: l()(du.bumpStars, r.bumpStars) },
                                    a().createElement('div', { className: l()(du.star, du.star__one, r.star) }),
                                    a().createElement('div', { className: l()(du.star, du.star__second, r.star) }),
                                    a().createElement('div', { className: l()(du.star, du.star__third, r.star) }),
                                ),
                                a().createElement('div', { className: l()(du.bump, r.bump) }),
                                a().createElement('div', { className: l()(du.bumpRays, r.bumpRays) }),
                                a().createElement(
                                    'div',
                                    { className: l()(du.reward, r.reward) },
                                    ('idle' === A || 'start' === A) &&
                                        a().createElement('div', { className: l()(du.rewardFrom, r.rewardFrom) }, u),
                                    ('end' === A || 'bump' === A) &&
                                        a().createElement('div', { className: l()(du.rewardTo, r.rewardTo) }, e),
                                ),
                                ('start' === A || 'bump' === A) &&
                                    a().createElement(
                                        Eu,
                                        mu({}, E, {
                                            className: l()(du.twirlyCanvas, r.twirlyCanvas),
                                            frameCount: 60,
                                            frameTime: 16,
                                            getSrcByFrame: s,
                                        }),
                                    ),
                                a().createElement('div', { className: l()(du.bumpParticles, r.bumpParticles) }),
                            )
                        );
                    },
                    bu =
                ...
                const Nu = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return a().createElement(Tu, e, n);
                    const r = e.contentId;
                ...
                const Gu = {
                    ...
                    $u = ({
                        ...
                        const F = ((u, e, t) => {
                            ...
                            })(Object.assign({ tooltipId: i, value: t }, A), Number(o), {
                                decoratorId: s,
                                ignoreMouseClick: !1,
                            }),
                            m = z(t, n);
                        return a().createElement(
                            Nu,
                            { tooltipArgs: F, className: l()(Gu.base, Gu[`base__${c}`], d && Gu.base__flex) },
                            a().createElement(
                                a().Fragment,
                                null,
                                a().createElement('div', {
                ...
                const Ku = ['ko', 'no'],
                    ...
                    ee =
                        ...
                        (u, e) => {
                            ...
                            return `${u === Mu.AddcEconomicBonuses || u === c.EquipCoin ? `${t}.newYear.rewards` : u === Mu.AchievementReward ? `${t}.achievement` : u === Mu.Vehicles ? 'R.images.gui.maps.shop.vehicles' : u === c.CrewBooks ? 'R.images.gui.maps.icons.crewBooks.books' : `${t}.quests.bonuses`}.${(() => {
                    ...
                    ne = (u, e, t) => {
                        ...
                        if (a) {
                            ...
                            return ('' === r && console.warn('empty icon'), `${a}.${r}${t ? '_pixelated' : ''}`);
                        }
                        return $(u, e.toString());
                    },
                    ae = (u) => {
                    ...
                    oe = (u, e) => ('vehicles' === u.name ? $(u, e.toString()) : ne(u, e)),
                    se = ({
                        className: u,
                        bonusModel: e,
                        size: t,
                        ...
                        const l = ((u, e = []) => {
                                ...
                                'start' === u && W('gui_gift_system_newyear_reward_transform');
                            }, []),
                            c = e.compensatedItem,
                            E = i ? 'idle' : 'end';
                        return a().createElement(
                        ...
                        ((0, n.forwardRef)(
                            ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: r = {} }, i) => {
                                const o = (0, n.useRef)(null),
                                    ...
                                    _ = E[1],
                                    A = (0, n.useCallback)(() => {
                                        (V.playClick(), Q.O.view.sendEvent.close());
                                    }, []),
                                    F = (0, n.useCallback)(() => {
                                        V.playHighlight();
                                    }, []),
                                    m = l()(ce.arrow, ce[`arrow${de[d]}`]);
                                le(
                                    () => (
                                            ...
                                            return (
                                                ...
                                                B.run(() => {
                                                    const e = u.scrollWidth,
                                                        t = u.scrollHeight;
                                                    (Q.O.view.resize(e, t), _(window.decorator.directionType));
                                                })
                                            );
                                    }, [B]);
                                return (
                ...
                const Fe = (u) => {
                        ...
                        const A = (0, n.useRef)(null),
                            F = (0, n.useCallback)(() => {
                                ...
                                A.current && (0, N.P3)(e, i, A.current, t, o, s);
                            }, [e, i, s, t, o]);
                        return a().createElement(
                            'div',
                            Ae(
                ...
                const Be = (u) => {
                    ...
                    ge = (0, n.memo)(
                        ({
                            ...
                            const c = u.level,
                                ...
                                B = Ku.includes(Qu) ? c : R.strings.roman_numerals.$dyn(`n_${c}`),
                                C = (0, n.useState)(!1),
                                g = C[0],
                                p = C[1],
                                b = (0, n.useState)(!1),
                                ...
                                P = {
                                    backgroundImage: `url('${d ? R.images.gui.maps.icons.vehicle.$dyn(((S = d), S.replace(/:|-/g, '_'))) : D}')`,
                                };
                            var S;
                            const T = (0, n.useCallback)(() => {
                                ...
                                O = (0, n.useCallback)(() => {
                                    f && i && !m && (W(R.sounds.hangar_newyear_slot_over()), p(!0));
                                }, [f, i, m]),
                                N = (0, n.useCallback)(() => {
                                    g && (W(R.sounds.hangar_newyear_slot_over_off()), p(!1));
                                }, [g]);
                            var I, k;
                            ((0, n.useEffect)(() => {
                                !f && g && (W(R.sounds.hangar_newyear_slot_over_off()), p(!1));
                            }, [f, g]),
                                (I = () => {
                                    !m && v && h(!1);
                                }),
                            ...
                            const L = l()(
                                    ...
                                    F && Ce.base__disabled,
                                    d && Ce.base__applied,
                                    i && Ce.base__currentProgressionCompleted,
                                    o && Ce.base__progressionReward,
                                    s && Ce.base__flex,
                                    r,
                                ),
                                M = a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: L, onMouseEnter: O, onMouseLeave: N, onClick: T },
                                        a().createElement(
                                            'div',
                                            { className: Ce.discountReward },
                                            a().createElement('div', { className: Ce.icon, style: P }),
                                            a().createElement('div', { className: Ce.vehicleLevel }, B),
                                            a().createElement(
                                                'div',
                                                { className: Ce.discountAmount },
                                                o
                                                    ? R.strings.common.common.percent()
                                                    : w(R.strings.ny.percentageValue.withMinus(), { value: E }),
                                            ),
                                        ),
                                    ),
                                );
                            return F || d || !i ? M : a().createElement(Be, { args: x }, M);
                        },
                    ),
                    pe = R.strings.ny.activityReward.tooltip,
                    be = ({ name: u, icon: e, isClickable: t, isNew: n, isFlexable: r }) => {
                        const i = ((u) => {
                            switch (u) {
                        ...
                        return a().createElement(
                            Tu,
                            { header: pe.header.$dyn(i), body: pe.body.$dyn(i) },
                            a().createElement(
                                'div',
                                {
                                    className: l()(
                                        'ActivityReward_base_50',
                                        t && 'ActivityReward_base__completed_02',
                                        t && n && 'ActivityReward_base__animated_b8',
                                        r && 'ActivityReward_base__flex_24',
                                    ),
                                },
                                a().createElement(
                                    'div',
                                    { className: 'ActivityReward_inner_39' },
                                    a().createElement('div', {
                                        className: 'ActivityReward_icon_21',
                                        style: {
                                            backgroundImage: `url(${R.images.gui.maps.icons.newYear.rewards.activity.$dyn(e)})`,
                                        },
                                    }),
                                    u === Uu.CelebrityAction &&
                                        a().createElement('div', { className: 'ActivityReward_iconPlay_02' }),
                                ),
                            ),
                        );
                    },
                    ve = { base: 'AttachmentReward_base_a0', glow: 'AttachmentReward_glow_5c' },
                    he = (u, e) =>
                    ...
                    we = ({
                        ...
                        a().createElement(
                            'div',
                            { className: l()(ve.base, ve[`base__${o}`]) },
                            a().createElement('div', {
                                className: ve.glow,
                                style: c
                                    ? {
                    ...
                    Re = ({
                        ...
                        const o = ((u, e) => {
                                if (void 0 === e || !q.includes(u)) return null;
                                switch (e) {
                        ...
                        return a().createElement(
                            'div',
                            { className: l()(fe.base, fe[`base__${e}`]) },
                            o &&
                                a().createElement('div', {
                    ...
                    xe = ({
                        ...
                        a().createElement(
                            'div',
                            { className: l()(ye.base, ye[`base__${o}`], s && ye.base__flex) },
                            a().createElement('div', {
                                className: ye.equipmentGlow,
                                style: {
                    ...
                    Se = R.strings.ny.lootBoxAutoOpen.reward.premiumPlus,
                    Te = Se.label(),
                    Oe = Se.tooltip.header(),
                    Ne = Se.tooltip.body(),
                    Ie = ({ value: u, size: e = Iu.Big, isFlexable: t = !1, classNames: n }) => {
                        const r = w(Te, { quantity: u }),
                            i = w(Oe, { quantity: u });
                        return a().createElement(
                            Tu,
                            { header: i, body: Ne },
                            a().createElement(
                                'div',
                                {
                                    className: l()(Pe.base, Pe[`base__${e}`], t && Pe.base__flex),
                                ...
                                Number(u) > 1 &&
                                    a().createElement(
                                        'div',
                                        { className: l()(Pe.info, null == n ? void 0 : n.info) },
                                        r,
                                    ),
                            ),
                        );
                ...
                const Me = R.views.lobby.new_year.tooltips,
                    Ue = ({
                        image: u,
                        bigImage: e,
                        value: t,
                        ...
                        return a().createElement(
                            wu,
                            { ignoreShowDelay: !0, contentId: Me.NyDecorationTooltip('resId'), args: { toyID: r } },
                            a().createElement(
                                'div',
                                {
                                    className: l()(ke.base, i && ke.base__flex, ke[`base__${n}`]),
                                    lang: R.strings.settings.LANGUAGE_CODE(),
                                },
                                a().createElement(
                                    'div',
                                    {
                                        className: ke.image,
                                        style: { backgroundImage: `url(${n === Le.Medium ? u : e})` },
                                    },
                                    s &&
                                        a().createElement(
                                            'div',
                                            { className: l()(ke.counter, null == o ? void 0 : o.counter) },
                                            s,
                                        ),
                                ),
                            ),
                    ...
                    Ge = ({ binding: u, text: e = '', classMix: t, alignment: r = h.left, formatWithBrackets: i }) => {
                        ...
                        return a().createElement(
                            ...
                            o.split('\n').map((e, i) =>
                                a().createElement(
                                    'div',
                                    { className: l()('FormatText_base_d0', t), key: `${e}-${i}` },
                                    ((u, e, t) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                            t && u in t
                                                ? t[u]
                    ...
                    $e = ['vehicleInfo', 'rentDays', 'rentBattles', 'size', 'theme', 'classNames'];
                function qe() {
                    return (
                        (qe = Object.assign
                            ? Object.assign.bind()
                ...
                const ze = R.strings.ny.giftMachine,
                    We = R.images.gui.maps.icons.newYear.tank_types;
                let Ve;
                !(function (u) {
                ...
                const Ye = (u) => {
                    ...
                    const A = e.vehicleLvl,
                        F = e.vehicleName,
                        m = e.vehicleType,
                        D = (E === Ve.Light ? We.white_elite : We.blue_elite).$dyn(`${f(m)}`),
                        B = n > 0 || i > 0;
                    return a().createElement(
                        'div',
                        {
                            className: l()(He.base, He[`base__${s}`], He[`base__${E}`], B && He.base__withRent),
                            lang: R.strings.settings.LANGUAGE_CODE(),
                        },
                        a().createElement($u, qe({ size: s, isLabelHidden: !0 }, _)),
                        n > 0 &&
                            a().createElement(Ge, {
                                text: ze.rentDays(),
                                binding: { clockIcon: a().createElement('span', { className: He.clockIcon }), days: n },
                                classMix: l()(He.rent, null == d ? void 0 : d.rent),
                            }),
                        i > 0 &&
                            a().createElement(Ge, {
                                text: ze.rentBattles(),
                                binding: {
                                    clockIcon: a().createElement('span', { className: He.clockIcon }),
                                    battles: i,
                                },
                                classMix: l()(He.rent, null == d ? void 0 : d.rent),
                            }),
                        a().createElement(
                            'div',
                            { className: l()(He.vehicleInfo, null == d ? void 0 : d.info) },
                            b(A),
                            a().createElement(
                                'div',
                                { className: He.typeContainer },
                                a().createElement('div', {
                                    className: He.type,
                ...
                const Xe = ({
                        ...
                        return ((u) => 'item' in u && u.item && u.item.startsWith('modernized'))(u)
                            ? a().createElement(
                                  xe,
                                  je({}, u, { image: ne(u, t, _), size: t, classNames: F, isFlexable: d }),
                              )
                            : 'ny25Toys' === u.name
                              ? a().createElement(
                                    Ue,
                              ...
                              : 'variadicDiscount' === u.name
                                ...
                                : ((u) => 'premium_plus' === u.name)(u)
                                  ? a().createElement(Ie, je({}, u, { size: t, isFlexable: d, classNames: F }))
                                  : u.isCompensation
                                    ? a().createElement(se, je({ bonusModel: u, size: t }, o))
                                    : ((D = u.name),
                                      Ju.includes(D)
                                          ? a().createElement(be, je({}, u, s, { isFlexable: d }))
                                          : ((u) => u === c.Vehicles)(u.name)
                                            ? a().createElement(Ye, je({ image: ne(u, t, _), size: t }, u, l))
                                            : ((u) => u === c.Items)(u.name)
                                              ? a().createElement(Re, {
                                                    bonusModel: u,
                                                    size: t,
                                              ...
                                              : ((u) => 'icon' in u && 'attachment' === u.icon)(u)
                                                ? a().createElement(
                                                      we,
                                                      je({}, u, { size: t, classNames: F, isFlexable: d }),
                                                  )
                                                : a().createElement($u, {
                                                      name: u.name,
                                                      image: ne(u, t, _),
                    ...
                    Ke = { isPopoverOpened: !1, disabled: !0, animation: ku.None },
                    Qe = {
                    ...
                    Ze = ({ rewardModel: u, withDescription: e = !1, hasLabel: t = !0 }) => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: l()(Qe.rewardWrapper, n && Qe.rewardWrapper__tman) },
                                a().createElement(Xe, {
                                    bonusModel: u,
                                    isFlexable: n,
                                    size: r ? Iu.S180x135 : Iu.S232x174,
                                    options: Object.assign({}, Ke, { isSelectable: Boolean(i) }),
                                    vehicleRewardOptions: r
                                        ...
                                        : {},
                                    classNames: { info: Qe.info },
                                }),
                            ),
                            t &&
                                a().createElement(
                                    'div',
                                    { className: l()(Qe.label, n && Qe.label__tman, e && Qe.label__withDescription) },
                                    ((u) => {
                                        if (u.rarity)
                                            return w(R.strings.ny.notifications.challenge.label.attachment(), {
                                        ...
                                        switch (u.name) {
                                            ...
                                            case Mu.VariadicDiscount:
                                                return w(R.strings.ny.notifications.challenge.label.discount(), {
                                                    level: b(u.level),
                                                });
                                            default:
                                                return u.label;
                ...
                const tt = ({
                    ...
                    return (
                        (0, n.useEffect)(() => {
                            function u(u) {
                                C && null !== D.current && !D.current.contains(u.target) && g(!1);
                            }
                            return (
                ...
                const nt = tt,
                    at = ({
                        ...
                        a().createElement(
                            'div',
                            {
                                className: l()(
                                    'Background_base_40',
                                    e && 'Background_base__popUp_48',
                                    Boolean(u) && 'Background_base__withoutBorder_11',
                                ),
                            },
                            a().createElement('div', {
                                className: 'Background_image_33',
                                style: {
                    ...
                    rt = ({ classNames: u }) =>
                        a().createElement('div', {
                            className: l()('CloseButton_base_9f', null == u ? void 0 : u.base),
                            onMouseEnter: V.playHighlight,
                            onClick: () => W(R.sounds.cancelcloseno()),
                        }),
                    it = ({
                        title: u,
                        buttonText: e,
                        ...
                        le(() => {
                            i && W(R.sounds.hangar_newyear_notification());
                        }),
                        a().createElement(
                            'div',
                            {
                                className: l()(
                                    'RewardNotificationDecorator_base_c8',
                                    i && 'RewardNotificationDecorator_base__popUp_c4',
                            ...
                            i &&
                                a().createElement(rt, {
                                    classNames: { base: 'RewardNotificationDecorator_closeButton_e2' },
                                }),
                            a().createElement(
                                'div',
                                { className: 'RewardNotificationDecorator_content_7a' },
                                a().createElement(
                                    'div',
                                    {
                                        className: l()(
                                            'RewardNotificationDecorator_header_56',
                                    ...
                                    a().createElement(
                                        ...
                                        {
                                            className: l()(
                                                'RewardNotificationDecorator_title_ec',
                                    ...
                                    d &&
                                        a().createElement(
                                            ...
                                            {
                                                className: l()(
                                                    'RewardNotificationDecorator_subtitle_fd',
                                                    null == _ ? void 0 : _.subtitle,
                                                ),
                                            },
                                            d,
                                        ),
                                ...
                                a().createElement(
                                    'div',
                                    { className: 'RewardNotificationDecorator_rewards_96' },
                                    a().createElement(
                                        'div',
                                        {
                                            className: l()(
                                                'RewardNotificationDecorator_rareReward_85',
                                                s && 'RewardNotificationDecorator_rareReward__tman_fb',
                                            ),
                                        },
                                        n,
                                    ),
                                    r
                                        ? a().createElement(
                                              'div',
                                              { className: 'RewardNotificationDecorator_additionalRewards_50' },
                                              i &&
                                                  a().createElement('div', {
                                                      className: 'RewardNotificationDecorator_shadow_2c',
                                                  }),
                                              r,
                                          )
                                        : E &&
                                              a().createElement(
                                                  'div',
                                                  { className: 'RewardNotificationDecorator_description_58' },
                                                  E,
                                              ),
                                ),
                                a().createElement(
                                    'div',
                                    { className: 'RewardNotificationDecorator_buttonWrapper_c2' },
                                    a().createElement(
                                        nt,
                                        {
                                            type: ut.ghost,
                                            ...
                                            size: et.medium,
                                            disabled: o,
                                            mixClass: null == _ ? void 0 : _.button,
                                        },
                                        e,
                                    ),
                                ),
                            ...
                            a().createElement(
                                'div',
                                { className: 'RewardNotificationDecorator_backgroundWrapper_8b' },
                                a().createElement(at, { customUrl: c, isPopUp: i }),
                            ),
                            !i &&
                                a().createElement(
                                    a().Fragment,
                                    null,
                                    a().createElement('div', { className: 'RewardNotificationDecorator_lipTop_f3' }),
                                    a().createElement('div', { className: 'RewardNotificationDecorator_lipBottom_0b' }),
                                ),
                        )
                    );
                function ot() {
                ...
                const At = ((u, e) => {
                                ...
                                const s = (0, n.useRef)([]),
                                    l = (u, t, n) => {
                                        ...
                                        const r = (function ({
                                            ...
                                            E = { mode: u, model: c, externalModel: i, cleanup: l };
                                        return {
                                            model: c,
                                            controls: 'mocks' === u && n ? n.controls(E) : e(E),
                                            externalModel: i,
                                            mode: u,
                                        };
                                    },
                                    ...
                                    d = E[0],
                                    _ = E[1],
                                    A = (0, n.useState)(() => l(u, r, o)),
                                    F = A[0],
                                    m = A[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        c.current ? m(l(d, r, o)) : (c.current = !0);
                                    }, [o, d, r]),
                                    (0, n.useEffect)(() => {
                                        _(u);
                                    }, [u]),
                                    (0, n.useEffect)(
                                        () => () => {
                                            (F.externalModel.dispose(), s.current.forEach((u) => u()));
                                        },
                                        [F],
                                    ),
                    ...
                    Ft = At[0],
                    mt = At[1],
                    Dt = R.strings.grinch_progression.notification,
                    Bt = (0, o.Pi)(() => {
                        const u = mt(),
                            e = u.model,
                            t = u.controls,
                            ...
                            o = e.computed.getHugeReward(),
                            s = o ? w(Dt.header.itemReceived(), { itemName: o.label }) : '';
                        return a().createElement(it, {
                            isPopUp: r,
                            buttonAction: () => {
                                o && t.stylePreview(o.intCD);
                            },
                            buttonText: Dt.button.toStyle(),
                            title: s,
                            rareReward: o && a().createElement(Ze, { rewardModel: o, hasLabel: !1 }),
                            isButtonDisabled: i,
                        });
                    });
                engine.whenReady.then(() => {
                    i().render(
                        a().createElement(Ft, null, a().createElement(Bt, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(394));
