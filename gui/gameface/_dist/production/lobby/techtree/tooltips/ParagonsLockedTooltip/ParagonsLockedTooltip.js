        ...
        e = {
            ...
            211: (u, e, t) => {
                ...
                const ie = ((u, e) => {
                    ...
                    se = 'App_body_7c',
                    de = 'App_levelText_c7',
                    ce = R.strings.techtree.vehicle_tree.paragonsLocked.tooltip,
                    ge = R.strings.paragons.chapterName,
                    _e = (0, Fe.Pi)(() => {
                        ...
                        return Z().createElement(
                            'div',
                            { className: oe },
                            Z().createElement(Ae, { text: ce.header(), className: me }),
                            Z().createElement(Ae, {
                                className: se,
                                text: ce.body(),
                                format: {
                                    binding: {
                                        level: Z().createElement(Ae, { className: de, text: String(t) }),
                                        stage: Z().createElement(Ae, {
                                            text: ge.short.$dyn(e ? `id_${e}` : 'default'),
                                        }),
                                    },
                                },
                            }),
                ...
                engine.whenReady.then(() => {
                    Eu().render(
                        Z().createElement(Au, null, Z().createElement(Ce, null, Z().createElement(_e, null))),
