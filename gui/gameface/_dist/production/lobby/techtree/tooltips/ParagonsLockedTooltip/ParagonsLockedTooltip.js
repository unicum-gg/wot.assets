            ...
            211: (u, e, t) => {
                ...
                const Tu = {
                    ...
                    Pu = Lu((u) => {
                        ...
                        return J().createElement('div', Ru({ className: n()(Mu.base, ...j, e), style: N }, W), P);
                    });
                let Wu;
                !(function (u) {
                ...
                const Ce = ((u, e) => {
                    ...
                    de = 'App_body_7c',
                    ce = 'App_levelText_c7',
                    ge = R.strings.techtree.vehicle_tree.paragonsLocked.tooltip,
                    _e = R.strings.paragons.chapterName,
                    he = (0, Ee.Pi)(() => {
                        ...
                        return J().createElement(
                            'div',
                            { className: me },
                            J().createElement(Fe, { text: ge.header(), className: se }),
                            J().createElement(Fe, {
                                className: de,
                                text: ge.body(),
                                format: {
                                    binding: {
                                        level: J().createElement(Fe, { className: ce, text: String(t) }),
                                        stage: J().createElement(Fe, {
                                            text: _e.short.$dyn(e ? `id_${e}` : 'default'),
                                        }),
                                    },
                                },
                            }),
                ...
                engine.whenReady.then(() => {
                    ru().render(
                        J().createElement(Fu, null, J().createElement(le, null, J().createElement(he, null))),
