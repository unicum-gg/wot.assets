    ...
    var u,
        e = {
            ...
            680: (u, e, A) => {
                'use strict';
                var F = {};
                (A.r(F), A.d(F, { mouse: () => l, onResize: () => i }));
                var t = {};
                (A.r(t),
                    A.d(t, {
                        events: () => F,
                ...
                var E = {};
                (A.r(E), A.d(E, { getBgUrl: () => c, getTextureUrl: () => d }));
                var D = {};
                (A.r(D),
                    A.d(D, {
                        addModelObserver: () => T,
                ...
                const tu = J().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        t = u.theme,
                    ...
                    return (
                        ...
                        J().createElement(
                            'div',
                            Fu({}, D, {
                                className: n()(eu.base, eu[`base__theme-${E}`], F),
                                ref: function (u) {
                                    ((B.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            J().createElement('div', { className: eu.decorator }, A),
                        )
                    );
                });
                var Eu = A(493),
                ...
                const lu = Q.client.getSize('rem'),
                    mu = lu.width,
                    ou = lu.height,
                    su = Object.assign({ width: mu, height: ou }, Cu(mu, ou, au)),
                ...
                const _u = (u) => {
                    ...
                    const F = (0, Z.useContext)(du),
                        ...
                        s = F.mediumHeight,
                        d = F.smallHeight,
                        c = F.extraSmallHeight,
                        _ = { extraLarge: m, large: o, medium: s, small: d, extraSmall: c };
                    if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
                        ...
                        if (A.extraLargeWidth && B) return Bu(e, A, _);
                        if (A.largeWidth && a) return Bu(e, A, _);
                        ...
                        if (!(
                            ...
                            if (A.extraSmallHeight && c) return e;
                        }
                    }
                    return null;
                };
                    ...
                    const e = (0, Z.useContext)(du),
                        ...
                        E = (0, Z.useCallback)((u, e) => {
                            const A = Q.view.pxToRem(u),
                                F = Q.view.pxToRem(e);
                            t(Object.assign({ width: A, height: F }, Cu(A, F, au)));
                        }, []);
                    (gu(() => {
                        engine.on('clientResized', E);
                    }),
                        (0, Z.useEffect)(() => () => engine.off('clientResized', E), [E]));
                    const D = (0, Z.useMemo)(() => Object.assign({}, F), [F]);
                    return J().createElement(du.Provider, { value: D }, u);
                });
                let hu, xu, fu;
                (!(function (u) {
                ...
                const pu = () => {
                        ...
                        return { mediaSize: F, mediaWidth: t, mediaHeight: E, remScreenWidth: e, remScreenHeight: A };
                    },
                    vu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Su = (u) => u.includes('_') && ((u) => vu.includes(u))(u.split('_').at(-1)),
                    wu = [hu.ExtraLarge, hu.Large, hu.Medium, hu.Small, hu.ExtraSmall],
                    bu = (u, e) =>
                        Object.keys(u).reduce((A, F) => {
                            if (F in A) return A;
                            if (Su(F)) {
                                const t = F.split('_').slice(0, -1).join('_');
                                if (t in A) return A;
                            ...
                            return (
                                void 0 === t ||
                                    ((u, e) => vu.some((A) => void 0 !== e[`${u}_${A}`]))(F, u) ||
                                    (A[F] = t),
                                A
                            );
                        }, {}),
                        ...
                        const A = (
                            ...
                            (A) => {
                                const F = pu().mediaSize,
                                    t = (0, Z.useMemo)(() => e(A, F), [A, F]);
                                return J().createElement(u, t);
                            }
                        )(u, e);
                        return J().memo((e) =>
                        ...
                        let e = u.className,
                            ...
                            p =
                                void 0 === f
                                    ...
                                    : f,
                            v = u.alignItems,
                            S = void 0 === v ? (c ? 'flex-start' : _ && 'center') || (g && 'flex-end') || void 0 : v,
                            w = u.alignSelf,
                            b = u.wrap,
                            L = u.flexWrap,
                            R = void 0 === L ? (b ? 'wrap' : void 0) : L,
                            M = u.grow,
                            T = u.shrink,
                            H = u.flex,
                            y = void 0 === H ? (M || T ? `${M ? 1 : 0} ${T ? 1 : 0} auto` : void 0) : H,
                            O = u.style,
                            P = u.children,
                            W = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const N = (0, Z.useMemo)(() => {
                                const u = { mt: D, mr: B, mb: i, ml: l },
                                    ...
                                    t = ((u) =>
                                        yu.reduce((e, A) => {
                                            const F = u[A];
                                            return ('number' == typeof F && (e[Ou[A]] = F + 'rem'), e);
                                        }, {}))(u);
                                return {
                                    computedStyle: Object.assign({}, O, t, {
                            ...
                            }, [A, F, D, B, i, l, O, y, w, d, R, p, S]),
                            G = N.computedStyle,
                            X = N.computedClassNames;
                        return J().createElement('div', Tu({ className: n()(Ru.base, ...X, e), style: G }, W), P);
                    });
                let Wu;
                !(function (u) {
                ...
                const Nu = (u, e, A) => {
                    ...
                    Xu = (u, e, A = Wu.left) => u.split(e).reduce(A === Wu.left ? Nu : Gu, []),
                    ju = (() => {
                        const u = new RegExp(
                        ...
                        return Iu.includes(A)
                            ...
                            : ((u, e = Wu.left) => {
                                  ...
                                  const F =
                                      ...
                                      t = u.replace(/&nbsp;/g, ' ');
                                  return (Xu(t, /( )/, e).forEach((u) => (A = A.concat(Xu(u, F, Wu.left)))), A);
                              })(u, e);
                    },
                    ku = 'FormatText_base_d0',
                    Vu = ({ binding: u, text: e = '', classMix: A, alignment: F = Wu.left }) =>
                        null === e
                            ...
                            : J().createElement(
                                  ...
                                  e.split('\n').map((e, t) =>
                                      J().createElement(
                                          'div',
                                          { className: n()(ku, A), key: `${e}-${t}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : zu(u, e))))(e, F, u).map((u, e) =>
                ...
                const Qu = Object.keys(Ku()),
                    ...
                    te = Lu((u) => {
                        ...
                        return J().createElement(
                            ...
                            qu(
                                {
                                    className: n()($u.base, A && $u[A], g, F),
                                    style: _,
                                    mt: !0 === r ? Ae[A || 'paragraph-P16'].mt : r,
                                    mr: !0 === a ? Ae[A || 'paragraph-P16'].mr : a,
                                    mb: !0 === C ? Ae[A || 'paragraph-P16'].mb : C,
                                    ml: !0 === m ? Ae[A || 'paragraph-P16'].ml : m,
                                },
                                d,
                            ),
                    ...
                    Ee = {
                        base: 'Announcement_base_c1',
                        header: 'Announcement_header_4c',
                        title: 'Announcement_title_da',
                        text: 'Announcement_text_91',
                        description: 'Announcement_description_7a',
                        conditionsTitle: 'Announcement_conditionsTitle_c2',
                        conditionsContainer: 'Announcement_conditionsContainer_37',
                        conditionRow: 'Announcement_conditionRow_24',
                        point: 'Announcement_point_c7',
                        divider: 'Announcement_divider_72',
                        footer: 'Announcement_footer_72',
                        footerContainer: 'Announcement_footerContainer_d7',
                        footerIcon: 'Announcement_footerIcon_99',
                        comingSoonText: 'Announcement_comingSoonText_02',
                    },
                    De = R.strings.techtree.entryPoint.tooltip,
                    re = [
                        De.announcement.condition_1(),
                        De.announcement.condition_2(),
                        De.announcement.condition_3(),
                        De.announcement.condition_4(),
                        De.announcement.condition_5(),
                    ],
                    ne = (0, Z.memo)(() =>
                        J().createElement(
                            'div',
                            { className: Ee.base },
                            J().createElement('div', { className: Ee.icon }),
                            J().createElement(
                                'div',
                                { className: Ee.header },
                                J().createElement(te, { className: Ee.title, text: De.title() }),
                            ),
                            J().createElement(te, {
                                className: n()(Ee.text, Ee.description),
                                text: De.announcement.description(),
                            }),
                            J().createElement(te, {
                                className: Ee.conditionsTitle,
                                text: De.announcement.conditionsTitle(),
                            }),
                            J().createElement(
                                'div',
                                { className: Ee.conditionsContainer },
                                re.map((u, e) =>
                                    J().createElement(
                                        'div',
                                        { className: Ee.conditionRow, key: e },
                                        J().createElement(te, { className: Ee.point, text: De.announcement.point() }),
                                        J().createElement(te, { text: u }),
                                    ),
                                ),
                            ),
                            J().createElement('div', { className: Ee.divider }),
                            J().createElement(
                                'div',
                                { className: Ee.footer },
                                J().createElement(
                                    'div',
                                    { className: Ee.footerContainer },
                                    J().createElement('div', { className: Ee.footerIcon }),
                                    J().createElement(te, {
                                        text: De.announcement.comingSoon(),
                                        className: Ee.comingSoonText,
                                    }),
                                ),
                            ),
                        ),
                ...
                engine.whenReady.then(() => {
                    Du().render(
                        J().createElement(tu, null, J().createElement(ne, null)),
    ...
    ((F.m = e),
        ...
        (F.O = (e, A, t, E) => {
            if (!A) {
                ...
                for (a = 0; a < u.length; a++) {
                    for (var [A, t, E] = u[a], r = !0, n = 0; n < A.length; n++)
                        (!1 & E || D >= E) && Object.keys(F.O).every((u) => F.O[u](A[n]))
                            ? A.splice(n--, 1)
                            : ((r = !1), E < D && (D = E));
                    if (r) {
                        u.splice(a--, 1);
            ...
            E = E || 0;
            for (var a = u.length; a > 0 && u[a - 1][2] > E; a--) u[a] = u[a - 1];
            u[a] = [A, t, E];
        }),
        (F.n = (u) => {
        ...
        (() => {
            ...
            var e = (e, A) => {
                    ...
                    for (e && e(A); B < D.length; B++) ((E = D[B]), F.o(u, E) && u[E] && u[E][0](), (u[E] = 0));
                    return F.O(a);
                },
                A = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (A.forEach(e.bind(null, 0)), (A.push = e.bind(null, A.push.bind(A))));
        })());
    var t = F.O(void 0, [904], () => F(680));
    t = F.O(t);
})();
