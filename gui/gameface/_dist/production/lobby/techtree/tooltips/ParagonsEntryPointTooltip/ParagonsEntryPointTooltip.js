    ...
    var u,
        e = {
            ...
            680: (u, e, A) => {
                ...
                const Fu = Z().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        Z().createElement(
                            'div',
                            Au({}, D, {
                                className: n()(uu.base, uu[`base__theme-${E}`], F),
                                ref: function (u) {
                ...
                const Cu = q.client.getSize('rem'),
                    lu = Cu.width,
                    mu = Cu.height,
                    ou = Object.assign({ width: lu, height: mu }, iu(lu, mu, Bu)),
                ...
                const cu = (u) => {
                    ...
                    if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
                        ...
                        if (A.extraLargeWidth && B) return nu(e, A, _);
                        if (A.largeWidth && a) return nu(e, A, _);
                        if (A.mediumWidth && i) return nu(e, A, _);
                        if (A.smallWidth && C) return nu(e, A, _);
                        if (A.extraSmallWidth && l) return nu(e, A, _);
                        if (
                    ...
                    const e = (0, Q.useContext)(su),
                        ...
                        E = (0, Q.useCallback)((u, e) => {
                            const A = q.view.pxToRem(u),
                                F = q.view.pxToRem(e);
                            t(Object.assign({ width: A, height: F }, iu(A, F, Bu)));
                        }, []);
                    _u(() => {
                ...
                const fu = () => {
                    ...
                    Su = [gu.ExtraLarge, gu.Large, gu.Medium, gu.Small, gu.ExtraSmall],
                    wu = (u, e) =>
                        Object.keys(u).reduce((A, F) => {
                            ...
                            return (
                                void 0 === t ||
                                    ((u, e) => pu.some((A) => void 0 !== e[`${u}_${A}`]))(F, u) ||
                                    (A[F] = t),
                                A
                            );
                        }, {}),
                    bu = (u, e = wu) => {
                        const A = (
                            (u, e = wu) =>
                            (A) => {
                                const F = fu().mediaSize,
                                    t = (0, Q.useMemo)(() => e(A, F), [A, F]);
                                return Z().createElement(u, t);
                            }
                        )(u, e);
                        return Z().memo((e) =>
                ...
                const Tu = {
                    ...
                    Ou = bu((u) => {
                        ...
                        const N = (0, Q.useMemo)(() => {
                                const u = { mt: D, mr: B, mb: i, ml: l },
                                    e = ((u) =>
                                        Hu.reduce((e, A) => {
                                            const F = u[A];
                                            return F && 'number' != typeof F ? e.concat(Tu[!0 === F ? 'MD' : F][A]) : e;
                                        }, []))(u),
                                    t = ((u) =>
                                        Hu.reduce((e, A) => {
                                            const F = u[A];
                        ...
                        return Z().createElement('div', Mu({ className: n()(Lu.base, ...X, e), style: G }, W), P);
                    });
                let Pu;
                !(function (u) {
                ...
                const Wu = (u, e, A) => {
                    ...
                    Gu = (u, e, A = Pu.left) => u.split(e).reduce(A === Pu.left ? Wu : Nu, []),
                    Xu = (() => {
                        const u = new RegExp(
                        ...
                        return ju.includes(A)
                            ...
                            : ((u, e = Pu.left) => {
                                  ...
                                  const F =
                                      ...
                                      t = u.replace(/&nbsp;/g, ' ');
                                  return Gu(t, /( )/, e).forEach((u) => (A = A.concat(Gu(u, F, Pu.left)))), A;
                              })(u, e);
                    },
                ...
                const qu = Object.keys(Uu()),
                    ...
                    Fe = bu((u) => {
                        ...
                        return Z().createElement(
                            ...
                            Yu(
                                {
                                    className: n()(Ku.base, A && Ku[A], g, F),
                                    style: _,
                                    mt: !0 === r ? ee[A || 'paragraph-P16'].mt : r,
                                    mr: !0 === a ? ee[A || 'paragraph-P16'].mr : a,
                                    mb: !0 === C ? ee[A || 'paragraph-P16'].mb : C,
                    ...
                    Ee = R.strings.techtree.entryPoint.tooltip,
                    De = [
                        Ee.announcement.condition_1(),
                        Ee.announcement.condition_2(),
                        Ee.announcement.condition_3(),
                        Ee.announcement.condition_4(),
                        Ee.announcement.condition_5(),
                    ],
                    re = (0, Q.memo)(() =>
                        Z().createElement(
                            'div',
                            { className: te.base },
                            Z().createElement('div', { className: te.icon }),
                            Z().createElement(
                                'div',
                                { className: te.header },
                                Z().createElement(Fe, { className: te.title, text: Ee.title() }),
                            ),
                            Z().createElement(Fe, {
                                className: n()(te.text, te.description),
                                text: Ee.announcement.description(),
                            }),
                            Z().createElement(Fe, {
                                className: te.conditionsTitle,
                                text: Ee.announcement.conditionsTitle(),
                            }),
                            Z().createElement(
                                'div',
                                { className: te.conditionsContainer },
                                De.map((u, e) =>
                                    Z().createElement(
                                        'div',
                                        { className: te.conditionRow, key: e },
                                        Z().createElement(Fe, { className: te.point, text: Ee.announcement.point() }),
                                        Z().createElement(Fe, { text: u }),
                                    ),
                                ),
                            ),
                            Z().createElement('div', { className: te.divider }),
                            Z().createElement(
                                'div',
                                { className: te.footer },
                                Z().createElement(
                                    'div',
                                    { className: te.footerContainer },
                                    Z().createElement('div', { className: te.footerIcon }),
                                    Z().createElement(Fe, {
                                        text: Ee.announcement.comingSoon(),
                                        className: te.comingSoonText,
                                    }),
                                ),
                            ),
                        ),
