(() => {
    var __webpack_modules__ = {
            ...
            815: (e, u, t) => {
                            ...
                            v(() => {
                                if (
                                    ...
                                    const t = (e) => {
                                        ...
                                        a = S(e);
                                    _.current = M.addCallback(a, t, o, u === T.Deep);
                                }
                            }),
                            (0, r.useEffect)(() => {
                                if (u !== T.None)
                ...
                const O = C.O.client.getSize('rem'),
                    L = O.width,
                    I = O.height,
                ...
                const W = (e) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.largeWidth && E) return x(u, t, C);
                        if (t.mediumWidth && _) return x(u, t, C);
                        if (t.smallWidth && m) return x(u, t, C);
                        if (t.extraSmallWidth && d) return x(u, t, C);
                        if (
                    ...
                    le = ({
                        ...
                        return (i = {}) => {
                            ...
                            return (0, r.useMemo)(
                                ...
                                [F.scrollPosition, B, g, f, m.off, m.on, b, h, D, c.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    ce = le({
                    ...
                    ve = (0, r.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Ce, onDrag: n = ge }) => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(pe) || 0 !== e.button || (K('play'), B(oe.Next));
                                },
                                onMouseUp: C,
                                ref: o,
                                onMouseEnter: g,
                            ...
                            s().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(pe) || 0 !== e.button || (K('play'), B(oe.Prev));
                                },
                                onMouseUp: C,
                                ref: i,
                                onMouseEnter: g,
                    ...
                    $e = (0, r.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Ie, onDrag: n = Oe }) => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Ne) || 0 !== e.button || (K('play'), C(oe.Next));
                                },
                                ref: o,
                                onMouseEnter: h,
                            }),
                            ...
                            s().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Ne) || 0 !== e.button || (K('play'), C(oe.Prev));
                                },
                                onMouseUp: g,
                                ref: i,
                                onMouseEnter: h,
                    ...
                    Pu = s().memo(
                        ({
                            ...
                            const R = (0, r.useCallback)(
                                ...
                                W = V()(ku.input, ku[`input__${t}`]),
                                G = V()(ku.icon, ku[`icon__${t}`]),
                                z = V()(ku.placeholder, ku[`placeholder__${t}`]);
                            return s().createElement(
                                'div',
                                {
                                    id: e,
                ...
                const pt = [
                        ...
                        ct.GoldenTicket,
                        ct.PostStamp,
                        ct.BlankPersonalMissions_1,
                        ct.BlankPersonalMissions_2,
                        ct.SACoin,
                    ],
                    ...
                    Mt = ({
                        ...
                        return s().createElement(
                            'div',
                            { className: V()(St.base, St[`base__${n}`], l), style: i },
                            s().createElement(
                                Du,
                ...
                const Pt = s().memo(
                                          ...
                                          e
                                              ...
                                              .map((e, t) =>
                                                  s().createElement(
                                                      'div',
                                                      { key: t, className: A },
                                                      s().createElement(Mt, Rt({ size: u }, e)),
                                                  ),
                                              ),
                                          s().createElement(
                                              'div',
                    ...
                    Gt = 'ScenarioCard_shine_00',
                    zt = 'ScenarioCard_title_70',
                            ...
                            return s().createElement(
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        ...
                                        s().createElement('div', { className: zt }, p),
                                        s().createElement(
                                            'div',
                                            { className: zt },
                    ...
                    tn = (0, r.memo)(
                        ({
                            ...
                            const l = (0, r.useCallback)(() => n(e, u), [n, u, e]),
                                ...
                                E = Y(['base'], un),
                                _ = V()(E.base, t && un.base__highlight);
                            return s().createElement(
                                'div',
                                { className: _ },
                                s().createElement(
                    ...
                    dn = (0, r.memo)(({ highlightedPoint: e, onKeywordEvent: u }) => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                ...
                                F && s().createElement(en, { text: v, binding: w }),
                            ),
