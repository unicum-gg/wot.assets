(() => {
    ...
    var __webpack_modules__ = {
            294: (u, e, t) => {
                ...
                function f(u) {
                    let e = '';
                    for (let t = v.length - 1; t >= 0; t--) for (; u >= v[t];) ((e += w[t]), (u -= v[t]));
                    return e;
                }
                ...
                const ru = Object.keys(y).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === y[e]), u), {}),
                    su = {
                        set: (u, e) => {
                ...
                const cu = { view: r, client: a, sound: b, intl: g };
            },
            521: (u, e, t) => {
                let n, a;
                (t.d(e, { n: () => n }),
            ...
            953: (u, e, t) => {
                ...
                var E;
                function c(u = o.O.client.getSize('rem')) {
                    const e = u.width,
                        t = u.height;
                ...
                (0, n.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.smallWidth && m) return s(e, t, b);
                        if (t.extraSmallWidth && D) return s(e, t, b);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                ...
                const F = ({ children: u }) => {
                        ...
                        return (
                            ...
                            a().createElement(d.Provider, { value: t }, s && u)
                        );
                    },
                    m = (u = 1) => {
                ...
                const g = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    b = (u) => {
                        ...
                        if (n.length > 0) {
                            ...
                            return (
                                n.reduce((e, n) => {
                                    const a = D(p(t, `${e}.${n}`), window);
                                    return g(a) ? (u.push(a.id), `${e}.${n}.value`) : (u.push(n), `${e}.${n}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        B(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = b(u);
                                d.current = v.addCallback(n, t, o, e === f.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== f.None)
                ...
                function N(u = O.n.NONE, e = M, t = !1, a = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== O.n.NONE)
                            return (
                ...
                const H = ({
                        ...
                        return (
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'span',
                                    { className: y()(I.state, I.state__default) },
                ...
                const V = (u) => {
                    ...
                    const p = (0, n.useCallback)(
                            (u) => {
                                (null == s || s(u), o.O.sound.play.sound(D));
                            },
                            [s, D],
                        ),
                        h = (0, n.useCallback)(
                        ...
                        b = (0, n.useCallback)(
                            (u) => {
                                (null == E || E(u), o.O.sound.play.sound(C));
                            },
                            [E, C],
                        ),
                        w = (0, n.useCallback)(
                    ...
                    return a().createElement(
                        ...
                        q(
                            {
                                className: y()($.base, $[`base__${F}`], $[`base__${d}`], null == r ? void 0 : r.base),
                                onMouseEnter: p,
                                onMouseLeave: h,
                                onMouseDown: b,
                                onMouseUp: w,
                        ...
                        a().createElement(
                            'div',
                            { className: y()($.icon, $[`icon__${F}`], $[`icon__${d}`], null == r ? void 0 : r.icon) },
                            a().createElement('div', { className: y()($.glow, null == r ? void 0 : r.glow) }),
                        ),
                        a().createElement(
                            'div',
                            { className: y()($.caption, $[`caption__${F}`], null == r ? void 0 : r.caption) },
                            e,
                        ),
                        i && a().createElement('div', { className: y()($.goto, null == r ? void 0 : r.goto) }, i),
                    );
                };
                let z;
                !(function (u) {
                ...
                const Y = (u, e, t) =>
                        y()(u, t >= X.TitleAndRewards && e.base__animTitleAndRewards, t >= X.Done && e.base__done),
                    K = {
                ...
                const Q = (0, n.memo)(({ value: u, label: e, icon: t, index: i, animState: r, all: s }) => {
                        const o = (0, n.useMemo)(() => ({ transitionDelay: 0.9 + 0.1 * i + 's' }), [i]),
                            l = Y(K.base, K, r),
                            E = y()(K.icon, K[`icon__${t}`]);
                        return a().createElement(
                            'div',
                            { className: l, style: o },
                            ...
                            a().createElement('div', { className: K.description }, e),
                        );
                    }),
                    J = {
                        base: 'Tank_base_c1',
                    ...
                    uu = (0, n.memo)(({ vehicleImage: u, isAnyNotDone: e }) => {
                        const t = (0, n.useMemo)(() => ({ backgroundImage: `url(${u})` }), [u]),
                            i = P(['base'], J),
                            r = y()(i.base, e && J.base__defeat),
                            s = y()(J.bg, J.bg__back),
                            o = y()(J.bg, J.bg__foreground);
                        return a().createElement(
                            'div',
                            { className: r },
                ...
                const nu = R.strings.maps_training.result,
                    au = (0, n.memo)(({ animState: u, hasReward: e }) => {
                        const t = T('model'),
                            i = t.vehicleImage,
                            r = t.kills,
                            s = t.time,
                            ...
                            E = (0, n.useMemo)(
                                () => [
                                    { label: nu.kills(), value: r, all: l, icon: Z.Destroy },
                                    { label: nu.time(), value: s, icon: Z.Timer },
                                ],
                                [r, s, l],
                            ),
                            c = o !== z.Done,
                            _ = P(['base'], eu),
                            d = y()(Y(_.base, eu, u), c && eu.base__defeat),
                            A = y()(eu.separator, c && eu.separator__failed);
                        return a().createElement(
                            'div',
                            { className: d },
                            a().createElement(uu, { vehicleImage: i, isAnyNotDone: c }),
                            a().createElement(
                                'div',
                                { className: eu.stats },
                                E.map((e, t) =>
                                    a().createElement(Q, tu({ key: `item_${t}`, index: t, animState: u }, e)),
                                ),
                            ),
                            !e && a().createElement('div', { className: A }),
                        );
                    });
                let iu, ru, su, ou, lu, Eu, cu, _u;
                (!(function (u) {
                    ((u.Items = 'items'),
                ...
                const du = ['engravings', 'backgrounds'],
                    ...
                    Fu = (u, e = su.Small) => {
                        ...
                        switch (t) {
                            ...
                            case 'attachment':
                                return `R.images.gui.maps.vehicles.attachments.${e}.${i}`;
                            case 'statTracker':
                                return `R.images.gui.maps.vehicles.statTrackers.${e}.${i}`;
                            default:
                ...
                const Bu = (u, e, t = {}, n = 0) => {
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (Bu(t, A, { isMouseEvent: !0, on: !0, arguments: Du(a) }, w),
                                    g && g(),
                    ...
                    pu = (0, n.memo)(
                        ({ image: u, value: e, tooltipId: t, animState: i, index: r, onAnimationCompete: s }) => {
                            ...
                            (0, n.useEffect)(() => {
                                if (c) {
                                    const u = setTimeout(() => L(R.sounds.gui_random_reward_appear()), 1e3 * E);
                            ...
                            return a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    a().createElement('div', { className: gu.icon, style: d }),
                                    Number(e) > 1 && a().createElement('div', { className: gu.info }, e),
                                ),
                            );
                        },
                    ),
                    ...
                    bu = R.strings.maps_training.result,
                    wu = {
                        [z.Undone]: bu.rewardNotGot(),
                        [z.PartialDone]: bu.rewardGot(),
                        [z.Done]: bu.allRewardGot(),
                    },
                    vu = (0, n.memo)(({ rewardGot: u, doneValue: e, wasDone: t, animState: n }) => {
                        const i = P(['base'], hu),
                            r = Y(i.base, hu, n),
                            s = y()(hu.item, (u || t) && hu.item__got);
                        return a().createElement(
                            'div',
                            { className: r },
                            a().createElement('div', { className: s }, t ? bu.allRewardGot() : wu[e]),
                        );
                    }),
                    fu = {
                    ...
                    Tu = (0, n.memo)(({ doneValue: u, wasDone: e, animState: t, onAnimationCompete: i }) => {
                            ...
                            a().createElement(
                                ...
                                s
                                    ? a().createElement(
                                          a().Fragment,
                                          null,
                                          a().createElement('div', { className: fu.ribbon }),
                                          a().createElement(
                                              'div',
                                    ...
                                    : a().createElement(vu, { animState: t, doneValue: u, rewardGot: o, wasDone: e }),
                            )
                        );
                    }),
                    Ru = {
                    ...
                    yu = { [z.Undone]: Su.title.lose(), [z.PartialDone]: Su.title.partial(), [z.Done]: Su.title.win() },
                    xu = () => {
                        const u = T('model'),
                            e = u.mapID,
                            t = u.mapName,
                        ...
                        const C = (0, n.useMemo)(
                            ...
                            g = k(Su.mapName(), { map: t, scenario: i, type: r }),
                            p = P(['base'], Ru),
                            h = Y(p.base, Ru, d);
                        return a().createElement(
                            'div',
                            ...
                            a().createElement(
                                'div',
                                { className: Ru.bg, style: C },
                                a().createElement('div', { className: Ru.bgFogging }),
                                F && a().createElement('div', { className: Ru.bgShape }),
                            ),
                            a().createElement(
                                'div',
                                { className: Ru.box },
                                a().createElement('div', { className: Ru.mapTitle }, g),
                                a().createElement(
                                    'div',
                                    { className: Ru.titleWrapper },
                                    F && a().createElement('div', { className: Ru.titleBG }),
                                    a().createElement('div', { className: Ru.title }, yu[s]),
                                ),
                                a().createElement(au, { hasReward: m, animState: d }),
                                a().createElement(Tu, {
                                    animState: d,
                                    doneValue: s,
                                    wasDone: o,
                            ...
                            a().createElement(
                                H,
                                { type: U.primary, size: G.small, mixClass: Ru.button, onClick: D },
                ...
                engine.whenReady.then(() => {
                    r().render(
                        a().createElement(F, null, a().createElement(xu, null)),
