(() => {
    ...
    var __webpack_modules__ = {
            ...
            364: (u, e, t) => {
                t.d(e, { Sw: () => s.Z, B3: () => l, Z5: () => r, B0: () => o, ry: () => B });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            633: (u, e, t) => {
                        ...
                        C(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = T(u);
                                _.current = S.addCallback(n, t, i, e === x.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== x.None)
                ...
                function O(u, e, t) {
                    const a = (0, n.useContext)(m);
                    let s = Object.entries(a).filter(([u, e]) => !0 === e && u in c);
                    return (
                ...
                const ru = R.strings.maps_training.result,
                    iu = (0, n.memo)(({ animState: u, hasReward: e }) => {
                        const t = k('model'),
                            ...
                            E = o !== j.Done,
                            _ = O(['base'], au),
                            A = y()(Q(_.base, au, u), E && au.base__defeat),
                            F = y()(au.separator, E && au.separator__failed);
                        return a().createElement(
                            'div',
                            { className: A },
                            a().createElement(nu, { vehicleImage: s, isAnyNotDone: E }),
                            a().createElement(
                                'div',
                                { className: au.stats },
                                c.map((e, t) =>
                ...
                const bu = (u, e, t = {}, n = 0) => {
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (bu(t, F, { isMouseEvent: !0, on: !0, arguments: hu(a) }, w),
                                    C && C(),
                    ...
                    fu = (0, n.memo)(
                        ({ image: u, value: e, tooltipId: t, animState: s, index: r, onAnimationCompete: i }) => {
                            ...
                            (0, n.useEffect)(() => {
                                if (E) {
                                    const u = setTimeout(() => U(R.sounds.gui_random_reward_appear()), 1e3 * c);
                            ...
                            return a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    a().createElement('div', { className: vu.icon, style: A }),
                                    Number(e) > 1 && a().createElement('div', { className: vu.info }, e),
                                ),
                            );
                        },
                    ),
                    ...
                    Ru = {
                        [j.Undone]: Su.rewardNotGot(),
                        [j.PartialDone]: Su.rewardGot(),
                        [j.Done]: Su.allRewardGot(),
                    },
                    xu = (0, n.memo)(({ rewardGot: u, doneValue: e, wasDone: t, animState: n }) => {
                        const s = O(['base'], Tu),
                            r = Q(s.base, Tu, n),
                            i = y()(Tu.item, (u || t) && Tu.item__got);
                        return a().createElement(
                            'div',
                            { className: r },
                            a().createElement('div', { className: i }, t ? Su.allRewardGot() : Ru[e]),
                        );
                    }),
                    ku = {
                    ...
                    Pu = (0, n.memo)(({ doneValue: u, wasDone: e, animState: t, onAnimationCompete: s }) => {
                            ...
                            a().createElement(
                                ...
                                i
                                    ? a().createElement(
                                          a().Fragment,
                                          null,
                                          a().createElement('div', { className: ku.ribbon }),
                                          a().createElement(
                                              'div',
                                              { className: ku.rewards },
                                              r.map(({ value: u }, e) =>
                                                  a().createElement(fu, {
                                    ...
                                    : a().createElement(xu, { animState: t, doneValue: u, rewardGot: o, wasDone: e }),
                            )
                        );
                    }),
                    yu = {
                    ...
                    Ou = { [j.Undone]: Mu.title.lose(), [j.PartialDone]: Mu.title.partial(), [j.Done]: Mu.title.win() },
                    Nu = () => {
                        const u = k('model'),
                            e = u.mapID,
                            t = u.mapName,
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                d && a().createElement('div', { className: yu.bgShape }),
                            ),
                            a().createElement(
                                'div',
                                { className: yu.box },
                                ...
                                a().createElement(
                                    ...
                                    d && a().createElement('div', { className: yu.titleBG }),
                                    a().createElement('div', { className: yu.title }, Ou[i]),
                                ),
                            ...
                            a().createElement(
                                q,
                                { type: G.primary, size: W.small, mixClass: yu.button, onClick: D },
