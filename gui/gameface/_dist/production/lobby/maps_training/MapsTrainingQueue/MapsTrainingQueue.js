(() => {
    ...
    var __webpack_modules__ = {
            ...
            165: (u, e, t) => {
                ...
                const s = a.O.client.getSize('rem'),
                    C = s.width,
                    o = s.height,
                    l = Object.assign({ width: C, height: o }, B(C, o, r)),
                ...
                const d = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && B) return D(e, t, v);
                        if (t.largeWidth && s) return D(e, t, v);
                        if (t.mediumWidth && C) return D(e, t, v);
                        if (t.smallWidth && o) return D(e, t, v);
                        if (t.extraSmallWidth && l) return D(e, t, v);
                        if (
                    ...
                    h = (0, A.memo)(({ children: u }) => {
                        const e = (0, A.useContext)(c),
                            ...
                            D = (0, A.useCallback)((u, e) => {
                                ...
                                n(Object.assign({ width: t, height: A }, B(t, A, r)));
                            }, []);
                        m(() => {
                            engine.on('clientResized', D);
                        }),
                            (0, A.useEffect)(() => () => engine.off('clientResized', D), [D]);
                        const i = (0, A.useMemo)(() => Object.assign({}, F), [F]);
                        return E().createElement(c.Provider, { value: i }, u);
                    });
                let g;
                !(function (u) {
                ...
                const w = (u, e, t) => {
                    ...
                    p = (u, e, t = g.left) => u.split(e).reduce(t === g.left ? w : v, []),
                    b = (() => {
                        const u = new RegExp(
                        ...
                        return f.includes(t)
                            ...
                            : ((u, e = g.left) => {
                                  ...
                                  const A =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return p(E, /( )/, e).forEach((u) => (t = t.concat(p(u, A, g.left)))), t;
                              })(u, e);
                    };
                let y;
                !(function (u) {
                ...
                const O = (u = 1) => {
                    ...
                    L = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const A = M(`${u}.${t}`, window);
                                return S(A) ? e(u, t, A) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    P = (u) => {
                        const e = ((u) => {
                                const e = O(),
                        ...
                        if (A.length > 0) {
                            ...
                            return (
                                A.reduce((e, A) => {
                                    const E = M(k(t, `${e}.${A}`), window);
                                    return S(E) ? (u.push(E.id), `${e}.${A}.value`) : (u.push(A), `${e}.${A}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        m(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    A = P(u);
                                s.current = N.addCallback(A, t, D, e === H.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== H.None)
                ...
                const z = 'FormatText_base_d0',
                    V = ({ binding: u, text: e = '', classMix: t, alignment: F = g.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, n) =>
                                      E().createElement(
                                          'div',
                                          { className: I()(z, t), key: `${e}-${n}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : x(u, e))))(e, F, u).map((u, e) =>
                        ...
                        E().createElement(
                            ...
                            F !== j.ghost &&
                                E().createElement(
                                    E().Fragment,
                                    null,
                                    E().createElement('div', { className: G.back }),
                                    E().createElement('span', { className: G.texture }),
                                ),
                            E().createElement(
                                'span',
                                { className: P },
                                E().createElement('span', { className: G.stateDisabled }),
                                E().createElement('span', { className: G.stateHighlightHover }),
                                E().createElement('span', { className: G.stateHighlightActive }),
                            ),
                            E().createElement(
                                'span',
                ...
                const uu = 'SceneWrapper_base_85',
                    eu = 'SceneWrapper_grab_cf',
                    tu = 'SceneWrapper_grab__down_50',
                    Au = ({ children: u, onMoveSpace: e }) => {
                        const t = (0, A.useState)(!1),
                            ...
                            B = (0, A.useCallback)(
                                (u) => {
                                    if ((u.preventDefault(), !F || !i(u))) return;
                                    const t = u.clientX,
                                        A = u.clientY,
                                        E = t !== D.current ? t - D.current : 0,
                                        n = A !== a.current ? A - a.current : 0;
                                    (0 === E && 0 === n) ||
                                        ((D.current = t), (a.current = A), e({ dx: E, dy: n, dz: 0 }));
                                },
                                [i, F, D, a, e],
                            ),
                            s = (0, A.useCallback)(
                                (u) => {
                                    if ((u.preventDefault(), !i(u))) return;
                                    const t = u.deltaY < 0;
                                    e({ dx: 0, dy: 0, dz: t ? -600 : 600 });
                                },
                                [i, e],
                            ),
                            C = (0, A.useCallback)(() => n(!1), [n]);
                        (0, A.useEffect)(
                            () => (
                        ...
                        const o = (0, A.useCallback)(
                                (u) => {
                                    u.preventDefault(),
                                        0 === u.button &&
                                            i(u) &&
                                            (n(!0), (D.current = u.clientX), (a.current = u.clientY));
                                },
                                [i, n],
                            ),
                            l = (0, A.useCallback)(() => n(!1), [n]),
                            c = I()(eu, F && tu);
                        return E().createElement(
                            ...
                            E().createElement('div', { onMouseMove: l }, u),
                        );
                    },
                    Eu = 'Tips_base_da',
                    Fu = 'Tips_title_bc',
                    nu = 'Tips_descr_40',
                    Du = 'Tips_arrow_d4',
                    au = 'Tips_arrow__prev_5b',
                    ru = 'Tips_arrow__next_e7',
                    iu = (0, A.memo)(({ descr: u, onShowPrevTip: e, onShowNextTip: t }) => {
                        ...
                        return E().createElement(
                            'div',
                            { className: Eu },
                            E().createElement('div', { className: Fu }, R.strings.maps_training.queue.titleTips()),
                            E().createElement(
                                'div',
                                { className: nu },
                                u,
                                E().createElement('div', { className: D, onClick: F, onMouseOver: K.playHighlight }),
                                E().createElement('div', { className: a, onClick: n, onMouseOver: K.playHighlight }),
                            ),
                        );
                    }),
                    Bu = 'MapsTrainingQueueApp_base_bf',
                    su = 'MapsTrainingQueueApp_sceneWrapper_7e',
                    Cu = 'MapsTrainingQueueApp_box_8e',
                    ou = 'MapsTrainingQueueApp_time_bb',
                    lu = 'MapsTrainingQueueApp_timeValue_21',
                    cu = 'MapsTrainingQueueApp_button_9f',
                    _u = 'MapsTrainingQueueApp_title_5c',
                    du = () => {
                        const u = W(),
                            e = u.time,
                            t = u.descrTip,
                            ...
                            i = u.onShowPrevTip,
                            B = u.onShowNextTip,
                            s = (0, A.useMemo)(() => ({ time: E().createElement('div', { className: lu }, e) }), [e]),
                            C = (0, A.useMemo)(
                                () =>
                                    'long' === n
                            ...
                            o = (0, A.useCallback)(() => a(), [a]),
                            l = (0, A.useCallback)(() => r(), [r]);
                        return (
                            J(Z.n.ESCAPE, l),
                            E().createElement(
                                'div',
                                { className: Bu },
                                E().createElement('div', { className: su }, E().createElement(Au, { onMoveSpace: D })),
                                E().createElement(
                                    'div',
                                    { className: Cu },
                                    E().createElement(V, {
                                ...
                                E().createElement(iu, { descr: t, onShowPrevTip: i, onShowNextTip: B, isDelay: F }),
                            )
                        );
                    };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [453], () => __webpack_require__(165));
