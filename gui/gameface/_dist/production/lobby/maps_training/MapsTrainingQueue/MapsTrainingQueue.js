(() => {
    ...
    var __webpack_modules__ = {
            294: (u, e, t) => {
                ...
                var E = {};
                (t.r(E),
                    t.d(E, { mouse: () => C, off: () => o, on: () => s, onResize: () => a, onScaleUpdated: () => D }));
                var A = {};
                (t.r(A),
                    t.d(A, {
                        events: () => E,
                ...
                var F = {};
                (t.r(F), t.d(F, { getBgUrl: () => y, getTextureUrl: () => x }));
                var n = {};
                function r(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const su = { view: n, client: A, sound: v, intl: h };
            },
            521: (u, e, t) => {
                let E, A;
                (t.d(e, { n: () => E }),
            ...
            988: (u, e, t) => {
                ...
                (0, E.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && l) return r(e, t, v);
                ...
                const l = ({ children: u }) => {
                    ...
                    return (
                        ...
                        A().createElement(B.Provider, { value: t }, r && u)
                    );
                };
                var c = t(281);
                let d;
                ...
                const m = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    w = (u, e, t = d.left) => u.split(e).reduce(t === d.left ? h : g, []),
                    v = (() => {
                        const u = new RegExp(
                            [
                    ...
                    f = (u, e = d.left) => {
                        ...
                        return ((u, e = d.left) => {
                            ...
                            const E =
                                ...
                                A = m(u);
                            return (w(A, /( )/, e).forEach((u) => (t = t.concat(w(u, E, d.left)))), t);
                        })(u, e);
                    };
                var b = t(916),
                    x = t(613);
                ...
                const y = (u = 1) => {
                    ...
                    M = (u) => {
                        ...
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const A = T(k(t, `${e}.${E}`), window);
                                    return S(A) ? (u.push(A.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        O(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = M(u);
                                B.current = N.addCallback(E, t, i, e === H.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== H.None)
                                return () => {
                                    N.removeCallback(B.current, i);
                                };
                        }, [i, e]),
                        s
                    );
                ...
                const V = 'FormatText_base_d0',
                    z = ({ binding: u, text: e = '', classMix: t, alignment: F = d.left, formatWithBrackets: n }) => {
                ...
                const Y = ({
                    ...
                    return (
                        ...
                        A().createElement(
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    t ||
                                        (null !== l && j(l),
                                        i && i(u),
                                        o && (t || (c.current && (c.current.focus(), m(!0)))),
                                        w(!0));
                                },
                            ...
                            A().createElement(
                                'span',
                                { className: I()(q.state, q.state__default) },
                ...
                function Q(u = X.n.NONE, e = Z, t = !1, A = !1) {
                    (0, E.useEffect)(() => {
                        if (u !== X.n.NONE)
                            return (
                ...
                const J = 'SceneWrapper_base_85',
                    uu = 'SceneWrapper_grab_cf',
                    eu = 'SceneWrapper_grab__down_50',
                    tu = ({ children: u, onMoveSpace: e }) => {
                        const t = (0, E.useState)(!1),
                            ...
                            C = (0, E.useCallback)(
                                (u) => {
                                    if ((u.preventDefault(), !F || !i || !B(u))) return;
                                    const t = u.clientX,
                                        E = u.clientY,
                                        A = t !== D.current ? t - D.current : 0,
                                        n = E !== s.current ? E - s.current : 0;
                                    (0 === A && 0 === n) ||
                                        ((D.current = t), (s.current = E), e({ dx: A, dy: n, dz: 0 }));
                                },
                                [B, F, i, D, s, e],
                            ),
                            l = (0, E.useCallback)(
                                (u) => {
                                    if ((u.preventDefault(), !B(u))) return;
                                    const t = u.deltaY < 0;
                        ...
                        const d = (0, E.useCallback)(
                                (u) => {
                                    (u.preventDefault(),
                                        0 === u.button &&
                                            B(u) &&
                                            (a(!0), n(!0), (D.current = u.clientX), (s.current = u.clientY)));
                                },
                                [B, a],
                            ),
                            _ = (0, E.useCallback)(() => a(!1), [a]);
                        const m = I()(uu, i && eu);
                        return A().createElement(
                            'div',
                            { className: J },
                            A().createElement('div', {
                                ...
                                onMouseOver: function (u) {
                                    B(u) && (a(!0), (D.current = u.clientX), (s.current = u.clientY));
                                },
                            }),
                            A().createElement('div', { onMouseMove: _ }, u),
                        );
                    },
                    Eu = 'Tips_base_da',
                    Au = 'Tips_title_bc',
                    Fu = 'Tips_descr_40',
                    nu = 'Tips_arrow_d4',
                    ru = 'Tips_arrow__prev_5b',
                    iu = 'Tips_arrow__next_e7',
                    au = 'Tips_arrow__focused_5e',
                    Du = (0, E.memo)(({ descr: u, onShowPrevTip: e, onShowNextTip: t, focusedIndex: F }) => {
                        const n = (0, E.useCallback)(() => {
                            ...
                            i = I()(nu, ru, F === _u.PrevTip && au),
                            a = I()(nu, iu, F === _u.NextTip && au);
                        return A().createElement(
                            'div',
                            { className: Eu },
                            ...
                            A().createElement(
                                ...
                                { className: Fu },
                                u,
                                A().createElement('div', { className: i, onClick: n, onMouseOver: G.playHighlight }),
                                A().createElement('div', { className: a, onClick: r, onMouseOver: G.playHighlight }),
                            ),
                        );
                    }),
                    su = 'MapsTrainingQueueApp_base_bf',
                    ou = 'MapsTrainingQueueApp_sceneWrapper_7e',
                    Bu = 'MapsTrainingQueueApp_box_8e',
                    Cu = 'MapsTrainingQueueApp_time_bb',
                    lu = 'MapsTrainingQueueApp_timeValue_21',
                    cu = 'MapsTrainingQueueApp_button_9f',
                    du = 'MapsTrainingQueueApp_title_5c';
                let _u;
                !(function (u) {
                ...
                const mu = () => {
                    const u = W(),
                        ...
                        D = u.onShowPrevTip,
                        s = u.onShowNextTip,
                        o = (0, E.useMemo)(() => ({ time: A().createElement('div', { className: lu }, e) }), [e]),
                        B = (0, E.useMemo)(
                            () =>
                                'long' === n
                    ...
                    return (
                        ...
                        Q(X.n.ENTER, () => {
                            d === _u.Exit ? C() : d === _u.PrevTip ? D() : d === _u.NextTip && s();
                        }),
                        A().createElement(
                            'div',
                            { className: su },
                            A().createElement('div', { className: ou }, A().createElement(tu, { onMoveSpace: r })),
                            A().createElement(
                                'div',
                                { className: Bu },
                                A().createElement(z, {
                                ...
                                B && A().createElement('div', { className: du }, B),
                            ),
                            A().createElement(Du, {
                                descr: t,
                                onShowPrevTip: D,
                ...
                engine.whenReady.then(() => {
                    n().render(
                        A().createElement(l, null, A().createElement(mu, null)),
