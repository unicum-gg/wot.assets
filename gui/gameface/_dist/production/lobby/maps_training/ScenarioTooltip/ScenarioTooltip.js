(() => {
    ...
    var __webpack_modules__ = {
            99: (u, e, t) => {
                ...
                var n = {};
                (t.r(n),
                    t.d(n, { mouse: () => l, off: () => D, on: () => F, onResize: () => o, onScaleUpdated: () => A }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        events: () => n,
                ...
                const m = {
                    ...
                    g = Object.keys(p).reduce((u, e) => ((u[e] = () => B(p[e])), u), {}),
                ...
                const tu = (() => {
                    ...
                    nu = h,
                    ru = Object.keys(P).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === P[e]), u), {}),
                    Eu = {
                        set: (u, e) => {
            ...
            916: (u, e, t) => {
                t.d(e, { Sw: () => E.Z, B3: () => s, Z5: () => i.Z5, B0: () => a, ry: () => _ });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            957: (u, e, t) => {
                ...
                const l = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            c({}, l, {
                                className: s()(F.base, F[`base__theme-${a}`], E),
                                ref: function (u) {
                ...
                const d = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    g = (u, e, t = C.left) => u.split(e).reduce(t === C.left ? m : p, []),
                    v = (() => {
                        const u = new RegExp(
                    ...
                    T = (u, e = C.left) => {
                        ...
                        return ((u, e = C.left) => {
                            ...
                            const n =
                                ...
                                r = d(u);
                            return (g(r, /( )/, e).forEach((u) => (t = t.concat(g(u, n, C.left)))), t);
                        })(u, e);
                    };
                var h = t(916),
                    b = t(613);
                            ...
                            O(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = N(u);
                                    c.current = M.addCallback(n, t, s, e === x.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== x.None)
                                    return () => {
                                        M.removeCallback(c.current, s);
                                    };
                            }, [s, e]),
                            F
                        );
                    },
                    U = (h.Sw.instance, 'FormatText_base_d0'),
                    G = ({ binding: u, text: e = '', classMix: t, alignment: E = C.left, formatWithBrackets: i }) => {
                ...
                const K = [q.Attachment],
                    ...
                    Z = [q.Gold, q.Credits, q.Crystal, q.FreeXp],
                    J = [q.BattlePassPoints, q.EquipCoin],
                    uu = [q.PremiumPlus, q.Premium],
                        ...
                        const v = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            T = (0, n.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (au(t, l, { isMouseEvent: !0, on: !0, arguments: iu(r) }, w),
                                    m && m(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((v.current.timeoutId = window.setTimeout(T, A ? 100 : 400)),
                                                      E && E(u),
                                                      R && R(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const lu = R.views.common.tooltip_window.simple_tooltip_content,
                    Bu = (u) => {
                        ...
                        const A = (0, n.useMemo)(() => {
                            const u = Object.assign({}, s, { body: t, header: E, note: i, alert: a });
                ...
                const _u = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        const E = e.contentId;
                        return E ? r().createElement(su, Cu({}, e, { contentId: E }), n) : r().createElement(Fu, e, n);
                    },
                    du = {
                        base: 'Reward_base_ea',
                    ...
                    mu = ({
                        ...
                        const B = ((u, e) => {
                                if (void 0 === e || !ru.includes(u)) return null;
                                switch (e) {
                            ...
                            C = ((u) => {
                                ...
                                switch (u) {
                                    ...
                                    case j.ATTACHMENT_RARE:
                                        return X.ATTACHMENT_RARE;
                                    case j.ATTACHMENT_EPIC:
                                        return X.ATTACHMENT_EPIC;
                                    case j.ATTACHMENT_LEGENDARY:
                                        return X.ATTACHMENT_LEGENDARY;
                                }
                            })(E),
                            _ = ((u, e) => {
                                if (void 0 === u) return null;
                                switch (e) {
                                    ...
                                    case V.CURRENCY:
                                    case V.NUMBER:
                                        return r().createElement($, { format: 'integral', value: Number(u) });
                                    case V.PREMIUM_PLUS: {
                                        const e = Number(u);
                        ...
                        return r().createElement(
                            'div',
                            {
                                className: s()(du.base, du[`base__${n}`], K.includes(u) && du.base__normalize, F),
                                style: A,
                            },
                            r().createElement(
                                _u,
                                { tooltipArgs: c, className: du.tooltipWrapper },
                                r().createElement(
                                    r().Fragment,
                                    null,
                                    r().createElement(
                                        'div',
                                        { className: s()(du.image, null == D ? void 0 : D.image) },
                                        B &&
                                            r().createElement('div', {
                                                className: s()(du.highlight, null == D ? void 0 : D.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: s()(du.icon, null == D ? void 0 : D.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        C &&
                                            r().createElement('div', {
                                                className: s()(du.overlay, null == D ? void 0 : D.overlay),
                                                style: {
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: s()(
                                                    du.info,
                                                    du[`info__${u}`],
                                                    a === V.MULTI && du.info__multi,
                                                    null == D ? void 0 : D.info,
                                                ),
                                            },
                                            _,
                                        ),
                                    o && r().createElement('div', { className: du.title }, o),
                                ),
                            ),
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: l },
                                    r().createElement('div', {
                                        className: s()(du.timer, null == D ? void 0 : D.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const gu = ({ reward: u, size: e }) => {
                        const t = u.RewardWrapper || null;
                        return t
                            ? r().createElement(t, u.rewardWrapperProps, r().createElement(mu, pu({ size: e }, u)))
                            : r().createElement(mu, pu({ size: e }, u));
                    },
                    vu = 'Rewards_base_26',
                    wu = 'Rewards_base__vertical_9f',
                    Tu = 'Rewards_reward_7b',
                    ...
                    bu = ({
                        ...
                        const D = n && n < u.length,
                            c = s()(Tu, t && hu, i),
                            l = D ? n : u.length;
                        return r().createElement(
                            'div',
                            { className: s()(vu, t && wu, E) },
                            u
                                .slice(0, l)
                                .map((u, t) =>
                                    r().createElement(
                                        'div',
                                        { key: t, className: c },
                                        r().createElement(gu, { reward: u, size: e }),
                                    ),
                                ),
                            D &&
                                r().createElement(
                    ...
                    Ou = () => {
                        const u = L(),
                            ...
                            D = _(R.strings.maps_training.baseNum(), { base: E }),
                            c = A.map(({ value: u }) => {
                                const e = u.name,
                                    t = u.value;
                                return {
                            ...
                            B = (0, n.useMemo)(
                                () => ({ count: r().createElement('div', { className: Pu.descrHighlight }, i.length) }),
                                [i.length],
                            ),
                            C = s()(Pu.base, o && Pu.base__complete),
                            m = s()(Pu.title, o && Pu.title__green),
                            p = s()(Pu.vehicle, Pu[`vehicle__${t}`]);
                        return r().createElement(
                            'div',
                            { className: C },
                            r().createElement('div', { className: Pu.scenarioTitle }, l),
                            r().createElement('div', { className: Pu.descr }, d(D)),
                            r().createElement('div', { className: Pu.title }, F.targets.title()),
                            r().createElement(
                                'div',
                                { className: Pu.descr },
                                r().createElement(G, { text: F.targets.body(), binding: B }),
                                r().createElement(
                                    'div',
                                    { className: Pu.targets },
                                    i.map((u, e) => r().createElement(fu, { key: e, vehicleType: String(u.value) })),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    i().render(
                        r().createElement(l, null, r().createElement(Ou, null)),
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (s = 0; s < deferred.length; s++) {
                    for (var [e, t, n] = deferred[s], E = !0, i = 0; i < e.length; i++)
                        (!1 & n || r >= n) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [453], () => __webpack_require__(957));
