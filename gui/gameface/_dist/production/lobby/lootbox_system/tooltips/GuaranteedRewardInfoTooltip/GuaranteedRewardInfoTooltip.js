    ...
    var u,
        e = {
            7287: (u, e, A) => {
                ...
                var t = {};
                (A.r(t), A.d(t, { getBgUrl: () => T, getTextureUrl: () => w }));
                var D = {};
                (A.r(D),
                    A.d(D, {
                        addModelObserver: () => V,
                ...
                const f = {
                    ...
                    _ = { play: Object.assign({}, y, { sound: d }), setRTPC: m },
                    b = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    h = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function P(u) {
                    let e = '';
                    for (let A = h.length - 1; A >= 0; A--) for (; u >= h[A]; ) ((e += b[A]), (u -= h[A]));
                    return e;
                }
                ...
                const Fu = (() => {
                    ...
                    tu = P,
                    Du = Object.keys(x).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === x[e]), u), {}),
                    nu = {
                        set: (u, e) => {
                ...
                const vu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    bu = (u, e, A = gu.left) => u.split(e).reduce(A === gu.left ? yu : _u, []),
                    hu = (() => {
                        const u = new RegExp(
                ...
                const Wu = (u, e) => {
                    ...
                    Ju = ({ type: u, filePath: e, eventName: A }, E = !1) => {
                        const F = ((u, e, A) => {
                            ...
                            n = F.defaultPath;
                        return t
                            ? { eventResource: E ? Wu(t, D) : Zu(t, D), defaultResource: E ? Wu(t, n) : Zu(t, n) }
                            : null;
                    },
                    Ku = ({ type: u, filePath: e, eventName: A }) => {
                        const E = Ju({ type: u, filePath: e, eventName: A });
                            ...
                            return F
                                ? ((A[E] = ((u, e, A) =>
                                      Object.keys(u).reduce(
                                          (E, F) => ((E[F] = Ku({ type: e, filePath: u[F], eventName: A })), E),
                                          {},
                                      ))(F, E, e)),
                                  A)
                                : A;
                            ...
                            return (
                                (E[F] = ((u, e, A) => {
                                    const E = `resource type: ${u}, path: ${e}`,
                                        F = Ju({ type: u, filePath: e, eventName: A }, !0);
                                    return ((u, e, A) => ({
                                        dynOpt: (E, F = 'default') => {
                                            const t =
                    ...
                    Ee = { dynamicTexts: { remainingCount: 'singleRewardView.tooltip.remainingCount' } },
                    Fe = {
                        texts: {
                    ...
                    te = ((u, e) => {
                        ...
                        const e = { root: u.object() },
                            A = (0, Uu.Om)(() => ue(Fe, e.root.get().eventName), { equals: Ou }),
                            E = (0, Uu.Om)(
                                () =>
                                    ((u, e) =>
                                        Object.keys(u).reduce((A, E) => {
                                            const F = u[E];
                                            return F ? ((A[E] = Ae(F, E, e)), A) : A;
                                        }, {}))(Ee, e.root.get().eventName),
                                { equals: Ou },
                            );
                    ...
                    ie = (0, xu.Pi)(() => {
                        ...
                        return Cu().createElement(
                            ...
                            Cu().createElement(Tu, {
                                ...
                                classMix: oe,
                                binding: {
                                    count: Cu().createElement(Tu, { text: F, binding: { count: E } }),
                                    remainingCount: Cu().createElement(Tu, {
