    ...
    var u,
        e = {
            3916: (u, e, A) => {
                ...
                var t = {};
                (A.r(t), A.d(t, { getBgUrl: () => x, getTextureUrl: () => T }));
                var n = {};
                (A.r(n),
                    A.d(n, {
                        addModelObserver: () => V,
                ...
                const su = { view: n, client: F, sound: _, intl: v };
                var au = A(7363),
                    lu = A.n(au);
                function cu() {
                ...
                const gu = lu().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        lu().createElement(
                            'div',
                            pu({}, n, {
                                className: r()(du.base, du[`base__theme-${t}`], E),
                                ref: function (u) {
                ...
                const Pu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Ru = (u, e, A = bu.left) => u.split(e).reduce(A === bu.left ? hu : wu, []),
                    Tu = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Su = (u, e = bu.left) => {
                        ...
                        return ((u, e = bu.left) => {
                            ...
                            const E =
                                ...
                                F = Pu(u);
                            return (Ru(F, /( )/, e).forEach((u) => (A = A.concat(Ru(u, E, bu.left)))), A);
                        })(u, e);
                    },
                    Ou = 'FormatText_base_d0',
                    ku = ({ binding: u, text: e = '', classMix: A, alignment: E = bu.left, formatWithBrackets: F }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const t = F && u ? _u(e, u) : e;
                ...
                const ee = (u, e) => {
                    ...
                    Ae = ({ type: u, filePath: e, eventName: A }, E = !1) => {
                        const F = ((u, e, A) => {
                            ...
                            D = F.defaultPath;
                        return t
                            ? { eventResource: E ? ee(t, n) : ju(t, n), defaultResource: E ? ee(t, D) : ju(t, D) }
                            : null;
                    },
                    Ee = ({ type: u, filePath: e, eventName: A }) => {
                        const E = Ae({ type: u, filePath: e, eventName: A });
                    ...
                    te = (u, e, A) => (u || e ? u || e : (console.warn(`Not found ${A}`), '')),
                    ne = (u, e, A) =>
                            ...
                            return (
                                (E[F] = ((u, e, A) => {
                                    const E = `resource type: ${u}, path: ${e}`,
                                        F = Ae({ type: u, filePath: e, eventName: A }, !0);
                                    return ((u, e, A) => ({
                                        dynOpt: (E, F = 'default') => {
                                            const t =
                    ...
                    De = { dynamicTexts: { remainingCount: 'singleRewardView.tooltip.remainingCount' } },
                    re = {
                        texts: {
                    ...
                    Be = ((u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: F, children: t, mocks: n }) {
                                const D = (0, au.useRef)([]),
                                    r = (A, E, F) => {
                                        ...
                                        const n = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = Gu(F.keys()); !(u = A()).done; ) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(E),
                                            ...
                                            i = { mode: A, model: C, externalModel: r, cleanup: o };
                                        return {
                                            model: C,
                                    ...
                                    C = o[0],
                                    i = o[1],
                                    s = (0, au.useState)(() => r(E, F, n)),
                                    a = s[0],
                                    l = s[1];
                                return (
                                    (0, au.useEffect)(() => {
                                        B.current ? l(r(C, F, n)) : (B.current = !0);
                                    }, [n, C, F]),
                                    (0, au.useEffect)(() => {
                                        i(E);
                                    }, [E]),
                        ...
                        const e = { root: u.object() },
                            A = (0, $u.Om)(() => Fe(re, e.root.get().eventName), { equals: Mu }),
                            E = (0, $u.Om)(
                                () =>
                                    ((u, e) =>
                                        Object.keys(u).reduce((A, E) => {
                                            const F = u[E];
                                            return F ? ((A[E] = ne(F, E, e)), A) : A;
                                        }, {}))(De, e.root.get().eventName),
                                { equals: Mu },
                            );
                    ...
                    ce = (0, Uu.Pi)(() => {
                        const u = Ce().model,
                            ...
                            A = u.computes.dynamicResources().dynamicTexts,
                            E = u.root.get().guaranteedFrequency,
                            F = (() => {
                                if (E > 10 && E < 14) return e.otherCount;
                                switch (E % 10) {
                                    case 1:
                                        return e.firstCount;
                                    case 2:
                        ...
                        return lu().createElement(
                            'div',
                            { className: ie },
                            lu().createElement('div', { className: se }, e.title),
                            lu().createElement(ku, {
                                text: e.subtitle,
                                classMix: ae,
                                binding: {
                                    count: lu().createElement(ku, { text: F, binding: { count: E } }),
                                    remainingCount: lu().createElement(ku, {
                                        text: A.remainingCount.plural(
                                            'remainingCount',
                                            u.root.get().guaranteedFrequency - 1,
                                        ),
                                        binding: { remainingCount: E - 1 },
                                    }),
                                },
                            }),
                            lu().createElement('div', { className: le }, e.label),
                            lu().createElement('div', { className: ae }, e.description),
                        );
                    });
                engine.whenReady.then(() => {
                    vu().render(
                        lu().createElement(oe, null, lu().createElement(gu, null, lu().createElement(ce, null))),
    ...
    ((E.m = e),
        ...
        (E.O = (e, A, F, t) => {
            if (!A) {
                ...
                for (o = 0; o < u.length; o++) {
                    for (var [A, F, t] = u[o], D = !0, r = 0; r < A.length; r++)
                        (!1 & t || n >= t) && Object.keys(E.O).every((u) => E.O[u](A[r]))
                            ? A.splice(r--, 1)
                            : ((D = !1), t < n && (n = t));
                    if (D) {
                        u.splice(o--, 1);
        ...
        (() => {
            ...
            var e = (e, A) => {
                    ...
                    for (e && e(A); B < n.length; B++) ((t = n[B]), E.o(u, t) && u[t] && u[t][0](), (u[t] = 0));
                    return E.O(o);
                },
                A = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (A.forEach(e.bind(null, 0)), (A.push = e.bind(null, A.push.bind(A))));
        })());
    var F = E.O(void 0, [866], () => E(3916));
    F = E.O(F);
})();
