        ...
        e = {
            3916: (u, e, A) => {
                ...
                const f = {
                    ...
                    _ = Object.keys(y).reduce((u, e) => ((u[e] = () => d(y[e])), u), {}),
                ...
                const Pu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Ru = (u, e, A = _u.left) => u.split(e).reduce(A === _u.left ? hu : wu, []),
                    Tu = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Su = (u, e = _u.left) => {
                        ...
                        return ((u, e = _u.left) => {
                            ...
                            const E =
                                ...
                                F = Pu(u);
                            return (Ru(F, /( )/, e).forEach((u) => (A = A.concat(Ru(u, E, _u.left)))), A);
                        })(u, e);
                    },
                    Ou = 'FormatText_base_d0',
                    ku = ({ binding: u, text: e = '', classMix: A, alignment: E = _u.left, formatWithBrackets: F }) => {
