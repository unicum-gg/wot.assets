        ...
        e = {
                ...
                const o = { base: 'TankName_base_14', type: 'TankName_type_49' },
                    ...
                    l = ({ reward: u, style: e, className: t = '', usagePlace: r }) => {
                        ...
                        return E().createElement(
                            ...
                            E().createElement('div', null, r === A.qA.InfoPage ? m : l),
                        );
                    };
            },
            2374: (u, e, t) => {
            ...
            6076: (u, e, t) => {
                ...
                const C = {
                        ...
                        [m.Style]: 'style',
                        [m.Style3D]: 'style_3d',
                        [m.CrewMember]: 'tankman',
                        [m.PremiumPlus]: 'premium_plus_universal',
                        [m.Gold]: 'gold',
                        [m.Crystal]: 'crystal',
                        [m.Credits]: 'credits',
                        [m.FreeXP]: 'freeXP',
                        [m.Customizations]: 'customizations',
                        [m.ExperimentalEquipment]: 'expequipments_gift',
                        [m.Components]: 'equipCoin',
                        [m.ImprovedEquipment]: 'deluxe_gift',
                        [m.BountyEquipment]: 'trophy_gift',
                        [m.StandardEquipment]: 'new_device_mi_gift',
                        [m.Directives]: 'battle_booster_gift',
                        [m.TrainingMaterials]: 'training_materials',
                        [m.Blueprints]: 'blueprint_tube',
                        [m.BattleBonusX5]: 'battle_bonus_x5',
                        [m.CrewBonusX3]: 'crew_bonus_x3',
                        [m.PersonalReserves]: 'personal_reserves',
                        [m.Consumables]: 'consumables',
                        [m.Rations]: 'rations',
                    },
                    d = [m.Vehicles, m.Style, m.Style3D, m.Attachment],
                    g =
                        (m.CrewMember,
                        m.Customizations,
                        m.ExperimentalEquipment,
                        m.ImprovedEquipment,
                        m.BountyEquipment,
                        m.StandardEquipment,
                        m.Directives,
                ...
                const w = (u, e) => {
                    ...
                    O = (u, e, t) => (u || e ? u || e : (console.warn(`Not found ${t}`), '')),
                    L = (u, e, t) =>
                    ...
                    M = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: n, children: E, mocks: A }) {
                                ...
                                return (
                                    ...
                                    s().createElement(t.Provider, { value: C }, E)
                                );
                            },
                            () => (0, i.useContext)(t),
                        ];
                        ...
                        ({ observableModel: u }) => {
                            const e = Object.assign(
                                ...
                                t = (0, y.Om)(() => k(N, e.eventName.get()), { equals: h }),
                                r = (0, y.Om)(
                                    () =>
                                        ((u, e) =>
                                            Object.keys(u).reduce((t, r) => {
                ...
                const H = 'FormatText_base_d0',
                    q = ({
                        ...
                        text: e = '',
                        classMix: t,
                        alignment: r = G.v2.left,
                        formatWithBrackets: a,
                    }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const E = a && u ? (0, G.WU)(e, u) : e;
                    ...
                    return s().createElement(
                        ...
                        Boolean(a) &&
                            s().createElement(q, {
                                ...
                                text: r === m.Vehicles ? e.vehicleCompensation : e.styleCompensation,
                                binding: {
                    ...
                    Cu = (0, B.Pi)(({ reward: u, className: e }) => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                ...
                                i > 1 &&
                                    s().createElement(
                                        'div',
                                        { className: mu.count },
                                        (0, G.uF)(a.multiplier, { count: i }),
                                    ),
                                Boolean(A) &&
                                    s().createElement('div', {
                                        className: n()(mu.overlay, mu[`overlay__${Fu.h2.Small}`]),
                                        style: {
                            ...
                            s().createElement(
                                ...
                                s().createElement('div', { className: mu.name }, (0, G.z4)(E)),
                                r === m.CrewMember &&
                                    s().createElement(Bu, { skills: X(l.skills, (u) => u), className: mu.skills }),
                            ),
                        );
                    }),
                    du = 'Rewards_base_fd',
