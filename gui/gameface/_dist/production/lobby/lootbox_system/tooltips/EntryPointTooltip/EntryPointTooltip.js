    ...
    var __webpack_modules__ = {
            ...
            3233: (u, e, t) => {
                ...
                const $ = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    X = (u, e, t = j.left) => u.split(e).reduce(t === j.left ? Y : K, []),
                    H = (() => {
                        const u = new RegExp(
                ...
                const iu = ou,
                    au = (u) => (u < 10 ? '0' + u : u),
                    su = 'Timer_base_cd',
                    Bu = 'Timer_timerText_33',
                    Cu = 'Timer_iconWrapper_de',
                    cu = 'Timer_icon_93',
                    lu = 'Timer_value_9b',
                    du = (0, c.Pi)(() => {
                        const u = z().model,
                            ...
                            F =
                                ((o = (function (u = 0) {
                                    ...
                                    e -= t * Fu;
                                    const E = Math.trunc(e / Au);
                                    e -= E * Au;
                                    const n = Math.trunc(e / nu);
                                    return (e -= n * nu), { days: t, hours: E, minutes: n, seconds: e };
                                })(A)),
                                (D = n.lessThanMinute),
                                o.minutes > 0
                                    ? `${o.days ? W(R.strings.common.duration.days(), { days: o.days }) : ''} ${au(o.hours)} : ${au(o.minutes)} : ${au(o.seconds)}`
                                    : D);
                        var o, D;
                        return r().createElement(
                            'div',
                            { className: su },
                            r().createElement('div', { className: Bu }, n.timerText),
                            r().createElement(
                                'div',
                                { className: Cu },
                                r().createElement('div', {
                            ...
                            r().createElement('div', { className: lu }, F),
                        );
                    }),
                    _u = {
                    ...
                    mu = (0, c.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement('div', { className: _u.title }, t.title),
                            r().createElement(uu, { classMix: _u.description, text: t.description }),
                            r().createElement(du, null),
                        );
                    });
                var pu = t(8515);
                const vu = 'ErrorTooltip_base_58',
                    gu = 'ErrorTooltip_shadow_06',
                    hu = 'ErrorTooltip_alertIcon_f6',
                    fu = 'ErrorTooltip_title_e7',
                    wu = 'ErrorTooltip_text_74',
                    bu = 'ErrorTooltip_description_f5',
                    Tu = (0, c.Pi)(() => {
                        const u = z().model.resources.get(),
                            e = u.images,
                            t = u.texts;
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: fu },
                                r().createElement(pu.z, { className: hu, icon: e.alert }),
                                r().createElement(
                                    'div',
                                    { className: wu },
                            ...
                            r().createElement('div', { className: bu }, t.warningDescription),
                        );
                    }),
                    Pu = 'App_base_b8',
                    yu = (0, c.Pi)(() => {
                        ...
                        return r().createElement(
                            'div',
                            { className: Pu },
                            u ? r().createElement(mu, null) : r().createElement(Tu, null),
                        );
                    });
                engine.whenReady.then(() => {
                    C().render(
