(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => i, off: () => o, on: () => r, onResize: () => A, onScaleUpdated: () => F }));
                var E = t(2472),
                    n = t(1176);
            ...
            3138: (u, e, t) => {
                ...
                var E = t(5959),
                    n = t(514);
                const A = { view: t(7641), client: E, sound: n.ZP };
            },
            514: (u, e, t) => {
                t.d(e, { ZP: () => F });
                var E = t(5959);
                const n = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    A = Object.keys(n).reduce((u, e) => ((u[e] = () => (0, E.playSound)(n[e])), u), {}),
                    F = { play: Object.assign({}, A, { sound: E.playSound }), setRTPC: E.setRTPC };
            },
            3722: (u, e, t) => {
                function E(u, e, t = 1) {
                            ...
                            const A = e.args,
                                F = (function (u, e) {
                                    ...
                                    var t,
                                        ...
                                        n = {},
                                        A = Object.keys(u);
                                    for (E = 0; E < A.length; E++) ((t = A[E]), e.indexOf(t) >= 0 || (n[t] = u[t]));
                                    return n;
                                })(e, E);
                            return void 0 !== A
            ...
            9916: (u, e, t) => {
                ...
                function c(u, e, t, E, n, A, F) {
                    ...
                    r.done ? e(o) : Promise.resolve(o).then(E, n);
                }
            ...
            8515: (u, e, t) => {
                ...
                var E = t(6483),
                    ...
                    A = t(7363),
                    F = t.n(A);
                const r = { shadow: 'AlertIcon_shadow_86', icon: 'AlertIcon_icon_56' },
                    o = ({ icon: u, hasShadow: e = !1, className: t }) =>
                        F().createElement(
                            'div',
                            { className: n()(r.base, t) },
                            e && F().createElement('div', { className: r.shadow }),
                            F().createElement('div', { className: r.icon, style: { backgroundImage: `url(${u})` } }),
                        );
            },
            3233: (u, e, t) => {
                var E = t(6483),
                ...
                const s = r().forwardRef(function (u, e) {
                    let t = u.children,
                        E = u.className,
                        s = u.theme,
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            a({}, C, {
                                className: n()(D.base, D[`base__theme-${B}`], E),
                                ref: function (u) {
                ...
                const k = (u, e) => {
                    ...
                    M = (u, e) => {
                        ...
                        return ((u, e) => {
                            ...
                            for (let u = 0; u < E.length; u++) {
                                if (!t) return '';
                                if (('string' != typeof t && (t = t.$dyn(E[u])), 'string' == typeof t)) return t;
                            }
                            return '';
                        })(u, e);
                    },
                    N = ({ type: u, filePath: e, eventName: t }, E = !1) => {
                        const n = ((u, e, t) => {
                            ...
                            r = n.defaultPath;
                        return A
                            ? { eventResource: E ? k(A, F) : M(A, F), defaultResource: E ? k(A, r) : M(A, r) }
                            : null;
                    },
                    L = ({ type: u, filePath: e, eventName: t }) => {
                        const E = N({ type: u, filePath: e, eventName: t });
                        if (!E || (!E.eventResource && !E.defaultResource))
                            return (console.info(`Unreachable code: unknown resource (${u} ${t} ${e})`), '');
                        const n = E.eventResource,
                            A = E.defaultResource;
                        return n || A;
                    },
                    I = (u, e) =>
                            ...
                            return n
                                ? ((t[E] = ((u, e, t) =>
                                      Object.keys(u).reduce(
                                          (E, n) => ((E[n] = L({ type: e, filePath: u[n], eventName: t })), E),
                                          {},
                                      ))(n, E, e)),
                                  t)
                                : t;
                    ...
                    U = {
                        images: {
                            ...
                            lootboxTooltip: 'entry_point.lootboxTooltip',
                            time: 'entry_point.time',
                        },
                        texts: {
                    ...
                    G = ((u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: n, children: o, mocks: D }) {
                                const i = (0, F.useRef)([]),
                                    a = (t, E, n) => {
                                        var F;
                                        const r = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const o = 'string' == typeof F ? `${E}.${F}` : E,
                                                            D = A.O.view.addModelObserver(o, e, !0);
                                                        return (n.set(D, t), u && t(r(F)), D);
                                                    },
                                                    readByPath: r,
                                                    createCallback: (u, e) => {
                                                        const t = r(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = m(n.keys()); !(u = t()).done; ) F(u.value, e);
                                                    },
                                                    unsubscribe: F,
                                                };
                                            })(E),
                                            ...
                                            s = u({
                                                ...
                                                observableModel: {
                                                    array: (u, e) => {
                                                        const E = null != e ? e : D(u),
                                                            n = _.LO.box(E, { equals: d });
                                                        return (
                                                            'real' === t &&
                                                                o.subscribe(
                                                                    (0, _.aD)((u) => n.set(u)),
                                            ...
                                            B = { mode: t, model: s, externalModel: o, cleanup: a };
                                        return {
                                            model: s,
                                            controls: 'mocks' === t && n ? n.controls(B) : e(B),
                                            externalModel: o,
                                            mode: t,
                                        };
                                    },
                                    ...
                                    C = B[0],
                                    c = B[1],
                                    l = (0, F.useState)(() => a(E, n, D)),
                                    p = l[0],
                                    g = l[1];
                                return (
                                    (0, F.useEffect)(() => {
                                        s.current ? g(a(C, n, D)) : (s.current = !0);
                                    }, [D, C, n]),
                                    (0, F.useEffect)(() => {
                                        c(E);
                                    }, [E]),
                        ...
                        const e = u.object().get().eventName,
                            t = { root: u.object(), resources: _.LO.box(I(U, e)) };
                ...
                const Y = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    X = (u, e, t = j.left) => u.split(e).reduce(t === j.left ? $ : H, []),
                    K = (() => {
                        const u = new RegExp(
                    ...
                    Q = (u, e = j.left) => {
                        ...
                        return ((u, e = j.left) => {
                            ...
                            const E =
                                ...
                                n = Y(u);
                            return (X(n, /( )/, e).forEach((u) => (t = t.concat(X(u, E, j.left)))), t);
                        })(u, e);
                    },
                    J = 'FormatText_base_d0',
                    uu = ({ binding: u, text: e = '', classMix: t, alignment: E = j.left, formatWithBrackets: A }) => {
                        ...
                        return r().createElement(
                            ...
                            o.split('\n').map((e, A) =>
                                r().createElement(
                                    'div',
                                    { className: n()(J, t), key: `${e}-${A}` },
                                    ((u, e, t) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : Q(u, e))))(
                                        e,
                                        E,
                                        u,
                                    ).map((u, e) => r().createElement(F.Fragment, { key: `${e}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                ...
                const Du = ru,
                    iu = (u) => (u < 10 ? '0' + u : u),
                    au = 'Timer_base_cd',
                    su = 'Timer_timerText_33',
                    Bu = 'Timer_iconWrapper_de',
                    Cu = 'Timer_icon_93',
                    cu = 'Timer_value_9b',
                    lu = (0, c.Pi)(() => {
                        const u = z().model,
                            e = u.root.get().eventExpireTime,
                            t = u.resources.get(),
                            E = t.images,
                            n = t.texts,
                            A = Du(e, 1),
                            F =
                                ((o = (function (u = 0) {
                                    ...
                                    e -= t * Au;
                                    const E = Math.trunc(e / nu);
                                    e -= E * nu;
                                    const n = Math.trunc(e / Eu);
                                    return ((e -= n * Eu), { days: t, hours: E, minutes: n, seconds: e });
                                })(A)),
                                (D = n.lessThanMinute),
                                o.minutes > 0
                                    ? `${o.days ? W(R.strings.common.duration.days(), { days: o.days }) : ''} ${iu(o.hours)} : ${iu(o.minutes)} : ${iu(o.seconds)}`
                                    : D);
                        var o, D;
                        return r().createElement(
                            'div',
                            { className: au },
                            r().createElement('div', { className: su }, n.timerText),
                            r().createElement(
                                'div',
                                { className: Bu },
                                r().createElement('div', {
                                    className: Cu,
                                    style: { backgroundImage: `url(${E.time})` },
                                }),
                            ),
                            r().createElement('div', { className: cu }, F),
                        );
                    }),
                    du = {
                        icon: 'BaseTooltip_icon_69',
                        title: 'BaseTooltip_title_2f',
                        description: 'BaseTooltip_description_21',
                    },
                    _u = (0, c.Pi)(() => {
                        const u = z().model.resources.get(),
                            e = u.images,
                            t = u.texts;
                        return r().createElement(
                            'div',
                            ...
                            r().createElement('div', {
                                className: du.icon,
                                style: { backgroundImage: `url(${e.lootboxTooltip})` },
                            }),
                            r().createElement('div', { className: du.title }, t.title),
                            r().createElement(uu, { classMix: du.description, text: t.description }),
                            r().createElement(lu, null),
                        );
                    });
                var mu = t(8515);
                const pu = 'ErrorTooltip_base_58',
                    vu = 'ErrorTooltip_shadow_06',
                    gu = 'ErrorTooltip_alertIcon_f6',
                    hu = 'ErrorTooltip_title_e7',
                    fu = 'ErrorTooltip_text_74',
                    wu = 'ErrorTooltip_description_f5',
                    bu = (0, c.Pi)(() => {
                        const u = z().model.resources.get(),
                            e = u.images,
                            t = u.texts;
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: hu },
                                r().createElement(mu.z, { className: gu, icon: e.alert }),
                                r().createElement(
                                    'div',
                                    { className: fu },
                                    r().createElement(uu, { text: t.warningTitle }),
                                ),
                            ),
                            r().createElement('div', { className: wu }, t.warningDescription),
                        );
                    }),
                    Tu = 'App_base_b8',
                    yu = (0, c.Pi)(() => {
                        const u = z().model.root.get().isEnabled;
                        return r().createElement(
                            'div',
                            { className: Tu },
                            u ? r().createElement(_u, null) : r().createElement(bu, null),
                        );
                    });
                engine.whenReady.then(() => {
                    C().render(
                        r().createElement(q, null, r().createElement(s, null, r().createElement(yu, null))),
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (o = 0; o < deferred.length; o++) {
                    for (var [e, t, E] = deferred[o], A = !0, F = 0; F < e.length; F++)
                        (!1 & E || n >= E) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [866], () => __webpack_require__(3233));
