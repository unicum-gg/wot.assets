(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => i, off: () => D, on: () => r, onResize: () => F, onScaleUpdated: () => n });
                var E = t(2472),
                    A = t(1176);
            ...
            8515: (u, e, t) => {
                ...
                const r = { shadow: 'AlertIcon_shadow_86', icon: 'AlertIcon_icon_56' },
                    D = ({ icon: u, hasShadow: e = !1, className: t }) =>
                        n().createElement(
                            'div',
                            { className: A()(r.base, t) },
                            e && n().createElement('div', { className: r.shadow }),
            ...
            8268: (u, e, t) => {
                ...
                const B = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            ...
                            r().createElement('div', { className: o.decorator }, t),
                        )
                    );
                });
                var s = t(493),
                ...
                const g = (u, e) => {
                    ...
                    y = ({ type: u, filePath: e, eventName: t }, E = !1) => {
                        const A = ((u, e, t) => {
                                const E = 'gui.maps.icons.lootBoxSystem.customizable',
                                    A = 'lootbox.customizable';
                                switch (u) {
                                    case w.Images:
                                    case w.DynamicImages:
                                        return {
                                            parent: R.images,
                                            path: `${E}.${t}.${e}`,
                                    ...
                                    case w.Videos:
                                    case w.DynamicVideos:
                                        return {
                                            parent: R.videos,
                                            path: `${A}.${t}.${e}`,
                                            defaultPath: `${A}.default.${e}`,
                                        };
                                    case w.Texts:
                                    case w.DynamicTexts:
                                        return {
                            ...
                            return A
                                ? ((t[E] = ((u, e, t) =>
                                      Object.keys(u).reduce(
                                          (E, A) => ((E[A] = T({ type: e, filePath: u[A], eventName: t })), E),
                                          {},
                                      ))(A, E, e)),
                                  t)
                                : t;
                    ...
                    P = ((u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: A, children: D, mocks: o }) {
                                const i = (0, n.useRef)([]),
                                    a = (t, E, A) => {
                                        var n;
                                        const r = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, n) => {
                                                        const D = 'string' == typeof n ? `${E}.${n}` : E,
                                                            o = F.O.view.addModelObserver(D, e, !0);
                                                        return A.set(o, t), u && t(r(n)), o;
                                                    },
                                                    readByPath: r,
                                                    createCallback: (u, e) => {
                                                        const t = r(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = m(A.keys()); !(u = t()).done; ) n(u.value, e);
                                                    },
                                                    unsubscribe: n,
                                                };
                                            })(E),
                                            ...
                                            s = { mode: t, model: B, externalModel: D, cleanup: a };
                                        return {
                                            model: B,
                                    ...
                                    C = s[0],
                                    c = s[1],
                                    l = (0, n.useState)(() => a(E, A, o)),
                                    v = l[0],
                                    h = l[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        B.current ? h(a(C, A, o)) : (B.current = !0);
                                    }, [o, C, A]),
                                    (0, n.useEffect)(() => {
                                        c(E);
                                    }, [E]),
                                    (0, n.useEffect)(
                                        () => () => {
                                            v.externalModel.dispose(), i.current.forEach((u) => u());
                                        },
                                        [v],
                                    ),
                                    r().createElement(t.Provider, { value: v }, D)
                                );
                            },
                            () => (0, n.useContext)(t),
                        ];
                        ...
                        const e = u.object().get().eventName,
                            t = { root: u.object(), resources: _.LO.box(O(x, e)) };
                ...
                const I = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    j = (u, e, t = N.left) => u.split(e).reduce(t === N.left ? V : U, []),
                    z = (() => {
                        const u = new RegExp(
                    ...
                    $ = (u, e = N.left) => {
                        ...
                        return ((u, e = N.left) => {
                            ...
                            const E =
                                ...
                                A = I(u);
                            return j(A, /( )/, e).forEach((u) => (t = t.concat(j(u, E, N.left)))), t;
                        })(u, e);
                    },
                    q = 'FormatText_base_d0',
                    G = ({ binding: u, text: e = '', classMix: t, alignment: E = N.left, formatWithBrackets: F }) => {
                                    ...
                                    const A = Date.now(),
                                        F = setInterval(
                                            () => {
                                                ...
                                                null !== t && e <= t ? (r(t), E && E(), clearInterval(F)) : r(e);
                                            },
                                            1e3 * (e || (u > 2 * Z ? Z : 1)),
                                        );
                                    return () => {
                ...
                const tu = uu,
                    Eu = (u) => (u < 10 ? '0' + u : u),
                    Au = 'Timer_base_cd',
                    Fu = 'Timer_timerText_33',
                    nu = 'Timer_iconWrapper_de',
                    ru = 'Timer_icon_93',
                    Du = 'Timer_value_9b',
                    ou = (0, c.Pi)(() => {
                        const u = S().model,
                            ...
                            n =
                                ((D = (function (u = 0) {
                                    let e = u;
                                    const t = Math.trunc(e / Q);
                                    e -= t * Q;
                                    const E = Math.trunc(e / X);
                                    e -= E * X;
                                    const A = Math.trunc(e / Z);
                                    return (e -= A * Z), { days: t, hours: E, minutes: A, seconds: e };
                                })(F)),
                                (o = A.lessThanMinute),
                                D.minutes > 0
                                    ? `${D.days ? L(R.strings.common.duration.days(), { days: D.days }) : ''} ${Eu(D.hours)} : ${Eu(D.minutes)} : ${Eu(D.seconds)}`
                                    : o);
                        var D, o;
                        return r().createElement(
                            'div',
                            { className: Au },
                            r().createElement('div', { className: Fu }, A.timerText),
                            r().createElement(
                                'div',
                                { className: nu },
                                r().createElement('div', {
                            ...
                            r().createElement('div', { className: Du }, n),
                        );
                    }),
                    iu = {
                    ...
                    au = (0, c.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement('div', { className: iu.title }, t.title),
                            r().createElement(G, { classMix: iu.description, text: t.description }),
                            r().createElement(ou, null),
                        );
                    });
                var Bu = t(8515);
                const su = 'ErrorTooltip_base_58',
                    Cu = 'ErrorTooltip_shadow_06',
                    cu = 'ErrorTooltip_alertIcon_f6',
                    lu = 'ErrorTooltip_title_e7',
                    du = 'ErrorTooltip_text_74',
                    _u = 'ErrorTooltip_description_f5',
                    mu = (0, c.Pi)(() => {
                        const u = S().model.resources.get(),
                            e = u.images,
                            t = u.texts;
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: lu },
                                r().createElement(Bu.z, { className: cu, icon: e.alert }),
                                r().createElement(
                                    'div',
                                    { className: du },
                                    r().createElement(G, { text: t.warningTitle }),
                                ),
                            ),
                            r().createElement('div', { className: _u }, t.warningDescription),
                        );
                    }),
                    vu = 'App_base_b8',
                    pu = (0, c.Pi)(() => {
                        const u = S().model.root.get().isEnabled;
                        return r().createElement(
                            'div',
                            { className: vu },
                            u ? r().createElement(au, null) : r().createElement(mu, null),
                        );
                    });
                engine.whenReady.then(() => {
                    C().render(
                        r().createElement(k, null, r().createElement(B, null, r().createElement(pu, null))),
