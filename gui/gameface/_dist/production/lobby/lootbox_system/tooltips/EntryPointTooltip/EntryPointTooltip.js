(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => D, off: () => o, on: () => F, onResize: () => A, onScaleUpdated: () => r }));
                var E = t(2472),
                    n = t(1176);
            ...
            3138: (u, e, t) => {
                ...
                var E = t(5959),
                    n = t(7698),
                    A = t(514);
                const r = { view: t(7641), client: E, sound: A.ZP, intl: n.N };
            },
            7698: (u, e, t) => {
                t.d(e, { N: () => E });
                const E = {
            ...
            514: (u, e, t) => {
                ...
                const n = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    ...
                    r = { play: Object.assign({}, A, { sound: E.playSound }), setRTPC: E.setRTPC };
            },
            3722: (u, e, t) => {
                function E(u, e, t = 1) {
            ...
            9916: (u, e, t) => {
                ...
                function c(u, e, t, E, n, A, r) {
                    ...
                    F.done ? e(o) : Promise.resolve(o).then(E, n);
                }
            ...
            8515: (u, e, t) => {
                ...
                var E = t(6483),
                    ...
                    A = t(7363),
                    r = t.n(A);
                const F = { shadow: 'AlertIcon_shadow_86', icon: 'AlertIcon_icon_56' },
                    o = ({ icon: u, hasShadow: e = !1, className: t }) =>
                        r().createElement(
                            'div',
                            { className: n()(F.base, t) },
                            e && r().createElement('div', { className: F.shadow }),
                            r().createElement('div', { className: F.icon, style: { backgroundImage: `url(${u})` } }),
                        );
            },
            3233: (u, e, t) => {
                var E = t(6483),
                ...
                const s = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            'div',
                            a({}, C, {
                                className: n()(i.base, i[`base__theme-${B}`], E),
                                ref: function (u) {
                ...
                const M = (u, e) => {
                    ...
                    N = ({ type: u, filePath: e, eventName: t }, E = !1) => {
                        const n = ((u, e, t) => {
                            ...
                            F = n.defaultPath;
                        return A
                            ? { eventResource: E ? M(A, r) : g(A, r), defaultResource: E ? M(A, F) : g(A, F) }
                            : null;
                    },
                        ...
                        return [
                            function ({ mode: E = 'real', options: n, children: o, mocks: i }) {
                                const D = (0, r.useRef)([]),
                                                ...
                                                return {
                                                    subscribe: (t, r) => {
                                                        const o = 'string' == typeof r ? `${E}.${r}` : E,
                                                            i = A.O.view.addModelObserver(o, e, !0);
                                                        return (n.set(i, t), u && t(F(r)), i);
                                                    },
                                                    readByPath: F,
                                                    createCallback: (u, e) => {
                                                        const t = F(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = m(n.keys()); !(u = t()).done; ) r(u.value, e);
                                                    },
                                                    unsubscribe: r,
                                                };
                                            })(E),
                                    ...
                                    C = B[0],
                                    c = B[1],
                                    l = (0, r.useState)(() => a(E, n, i)),
                                    p = l[0],
                                    g = l[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        s.current ? g(a(C, n, i)) : (s.current = !0);
                                    }, [i, C, n]),
                                    (0, r.useEffect)(() => {
                                        c(E);
                                    }, [E]),
                                    ...
                                    F().createElement(t.Provider, { value: p }, o)
                                );
                            },
                            () => (0, r.useContext)(t),
                        ];
                ...
                const W = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    X = (u, e, t = j.left) => u.split(e).reduce(t === j.left ? Y : H, []),
                    K = (() => {
                        const u = new RegExp(
                            [
                            ...
                            o.split('\n').map((e, A) =>
                                F().createElement(
                                    ...
                                    ((u, e, t) =>
                                        ...
                                        E,
                                        u,
                                    ).map((u, e) => F().createElement(r.Fragment, { key: `${e}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                                    ...
                                    const n = Date.now(),
                                        A = setInterval(
                                            () => {
                                                ...
                                                null !== t && e <= t ? (F(t), E && E(), clearInterval(A)) : F(e);
                                            },
                                            1e3 * (e || (u > 120 ? Eu : 1)),
                                        );
                                    return () => {
                ...
                const iu = Fu,
                    ...
                    lu = (0, c.Pi)(() => {
                        const u = z().model,
                            ...
                            r =
                                ...
                                (i = n.lessThanMinute),
                                o.minutes > 0
                                    ? `${o.days ? $(R.strings.common.duration.days(), { days: o.days }) : ''} ${Du(o.hours)} : ${Du(o.minutes)} : ${Du(o.seconds)}`
                                    : i);
                        var o, i;
                        return F().createElement(
                            'div',
                            { className: au },
                            F().createElement('div', { className: su }, n.timerText),
                            F().createElement(
                                'div',
                                { className: Bu },
                                F().createElement('div', {
                            ...
                            F().createElement('div', { className: cu }, r),
                        );
                    }),
                    du = {
                    ...
                    _u = (0, c.Pi)(() => {
                        ...
                        return F().createElement(
                            ...
                            F().createElement('div', { className: du.title }, t.title),
                            F().createElement(uu, { classMix: du.description, text: t.description }),
                    ...
                    bu = (0, c.Pi)(() => {
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                'div',
                                { className: hu },
                                F().createElement(mu.z, { className: gu, icon: e.alert }),
                                F().createElement(
                                    'div',
                                    { className: fu },
                                    F().createElement(uu, { text: t.warningTitle }),
                                ),
                            ),
                            F().createElement('div', { className: wu }, t.warningDescription),
                        );
                    }),
                    Tu = 'App_base_b8',
                    yu = (0, c.Pi)(() => {
                        ...
                        return F().createElement(
                            'div',
                            { className: Tu },
                            u ? F().createElement(_u, null) : F().createElement(bu, null),
                        );
                    });
                engine.whenReady.then(() => {
                    C().render(
                        F().createElement(q, null, F().createElement(s, null, F().createElement(yu, null))),
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (o = 0; o < deferred.length; o++) {
                    for (var [e, t, E] = deferred[o], A = !0, r = 0; r < e.length; r++)
                        (!1 & E || n >= E) &&
