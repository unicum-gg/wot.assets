    ...
    var u,
        e = {
            3404: (u, e, A) => {
                var F = {};
                (A.r(F),
                    A.d(F, { mouse: () => l, off: () => a, on: () => i, onResize: () => o, onScaleUpdated: () => C }));
                var E = {};
                (A.r(E),
                    A.d(E, {
                        events: () => F,
                ...
                var D = {};
                (A.r(D), A.d(D, { getBgUrl: () => w, getTextureUrl: () => T }));
                var t = {};
                (A.r(t),
                    A.d(t, {
                        addModelObserver: () => q,
                ...
                function y(u) {
                    let e = '';
                    for (let A = P.length - 1; A >= 0; A--) for (; u >= P[A]; ) ((e += h[A]), (u -= P[A]));
                    return e;
                }
                ...
                const Eu = (() => {
                    ...
                    Du = y,
                    tu = Object.keys(x).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === x[e]), u), {}),
                    nu = {
                        set: (u, e) => {
                ...
                const lu = ou().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        ou().createElement(
                            'div',
                            cu({}, t, {
                                className: B()(iu.base, iu[`base__theme-${D}`], F),
                                ref: function (u) {
                ...
                const vu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    hu = (u, e, A = gu.left) => u.split(e).reduce(A === gu.left ? _u : bu, []),
                    Pu = (() => {
                        const u = new RegExp(
                    ...
                    yu = (u, e = gu.left) => {
                        ...
                        return ((u, e = gu.left) => {
                            ...
                            const F =
                                ...
                                E = vu(u);
                            return (hu(E, /( )/, e).forEach((u) => (A = A.concat(hu(u, F, gu.left)))), A);
                        })(u, e);
                    },
                    Tu = 'FormatText_base_d0',
                    wu = ({ binding: u, text: e = '', classMix: A, alignment: F = gu.left, formatWithBrackets: E }) => {
                        ...
                        return ou().createElement(
                            ...
                            D.split('\n').map((e, E) =>
                                ou().createElement(
                                    'div',
                                    { className: B()(Tu, A), key: `${e}-${E}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : yu(u, e))))(
                                        e,
                                        F,
                                        u,
                                    ).map((u, e) => ou().createElement(su.Fragment, { key: `${e}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                let xu, Su, Ou, ku, Mu, Iu, Uu, Gu;
                (!(function (u) {
                    ((u.Items = 'items'),
                ...
                const zu = (u, e) => {
                    ...
                    Ju = 'blueprintsAny',
                    Ku = 'finalBlueprints',
                    ue = 'randomNationalBlueprint',
                    ee = 'tokens',
                    Ae = 'styleProgress',
                    Fe = 'crewBooks',
                    Ee = 'randomNationalBrochure',
                    De = 'randomNationalGuide',
                    te = 'randomNationalCrewBook',
                    ne = 'crewSkins',
                    Be = 'goodies',
                    re = 'groups',
                    se = 'dossier_badge',
                    oe = 'dossier_achievement',
                    Ce = 'xp',
                    ie = 'xpFactor',
                    ae = 'creditsFactor',
                    ce = 'crystal',
                    ...
                    Pe = (u, e = Ou.S180x135, A = !1) => {
                        const F = A ? u.compensation : u,
                            E = F.name,
                            D = F.icon,
                            t = F.value,
                            n = u.id,
                        ...
                        switch (E) {
                            case qu:
                                return B
                                    ...
                                    : D
                                      ? `R.images.gui.maps.shop.vehicles.${he(e)}.${D}`
                            ...
                            case Qu:
                            case Zu:
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${D}`;
                            case Wu:
                            case Ju:
                            case Ku:
                            case ue:
                                return `R.images.gui.maps.icons.blueprints.fragment.${e}.${D}`;
                            case ee:
                            case Ae:
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${D}`;
                            case Fe:
                            ...
                            case De:
                            case te:
                                return `R.images.gui.maps.icons.crewBooks.books.${e}.${D}`;
                            case ne:
                            case Be:
                            case re:
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${D}`;
                            case se:
                                return `R.images.gui.maps.icons.quests.bonuses.badges.${he(e)}.${D}`;
                            case oe:
                                return `R.images.gui.maps.icons.achievement.${he(e)}.${D}`;
                            case Ce:
                            case ie:
                            ...
                            case _e:
                                return ((u, e) => Lu(u, `lootBox_${e}`, 'lootBox_default'))(e, D);
                            case be:
                                return `R.images.gui.maps.icons.collectionItems.${he(e)}.${D}`;
                            default:
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${D}`;
                        }
                    };
                ...
                function we(u, e) {
                    ...
                    if (
                        ...
                        (A = (function (u, e) {
                            if (!u) return;
                            if ('string' == typeof u) return xe(u, e);
                        ...
                        return [
                            function ({ mode: F = 'real', options: E, children: D, mocks: t }) {
                                const n = (0, su.useRef)([]),
                                    B = (A, F, E) => {
                                        ...
                                        const t = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = we(E.keys()); !(u = A()).done; ) D(u.value, e);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(F),
                                            ...
                                            C = { mode: A, model: o, externalModel: B, cleanup: s };
                                        return {
                                            model: o,
                                    ...
                                    o = s[0],
                                    C = s[1],
                                    i = (0, su.useState)(() => B(F, E, t)),
                                    a = i[0],
                                    c = i[1];
                                return (
                                    (0, su.useEffect)(() => {
                                        r.current ? c(B(o, E, t)) : (r.current = !0);
                                    }, [t, o, E]),
                                    (0, su.useEffect)(() => {
                                        C(F);
                                    }, [F]),
                                    ...
                                    ou().createElement(A.Provider, { value: a }, D)
                                );
                            },
                            () => (0, su.useContext)(A),
                        ];
                    })(({ observableModel: u }) => ({ root: u.object() }), Re),
                    ke = Oe[0],
                    Me = Oe[1],
                    Ie = 'App_base_9f',
                    Ue = 'App_icon_2f',
                    Ge = 'App_title_f8',
                    Ne = 'App_highlighted_6b',
                    $e = 'App_description_f5',
                    ze = (0, $u.Pi)(() => {
                        ...
                        return ou().createElement(
                            ...
                            ou().createElement('div', {
                                className: Ue,
                                style: { backgroundImage: `url(${Pe(u, Ou.S600x450)})` },
                            }),
                            ou().createElement(
                                'div',
                                { className: Ge },
                                Nu(R.strings, `tooltips.awardItem.${u.name}.header`),
                            ),
                            ou().createElement(wu, {
                                classMix: $e,
                                text: Nu(R.strings, `tooltips.awardItem.${u.name}.body`),
                                binding: {
                                    highlighted: ou().createElement(wu, {
                                        classMix: Ne,
                                        text: Nu(R.strings, 'tooltips.awardItem.highlighted'),
                                        binding: { xp: u.value },
                                    }),
                                },
                            }),
                ...
                engine.whenReady.then(() => {
                    mu().render(
                        ou().createElement(ke, null, ou().createElement(lu, null, ou().createElement(ze, null))),
        ...
        (F.O = (e, A, E, D) => {
            if (!A) {
                ...
                for (s = 0; s < u.length; s++) {
                    for (var [A, E, D] = u[s], n = !0, B = 0; B < A.length; B++)
            ...
            D = D || 0;
            for (var s = u.length; s > 0 && u[s - 1][2] > D; s--) u[s] = u[s - 1];
            u[s] = [A, E, D];
        }),
        (F.n = (u) => {
