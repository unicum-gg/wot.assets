    ...
    var u,
        e = {
            8160: (u, e, A) => {
                var F = {};
                A.r(F),
                    A.d(F, { mouse: () => l, off: () => a, on: () => i, onResize: () => s, onScaleUpdated: () => C });
                var E = {};
                A.r(E),
                    A.d(E, {
                        events: () => F,
                ...
                var D = {};
                A.r(D), A.d(D, { getBgUrl: () => P, getTextureUrl: () => h });
                var t = {};
                A.r(t),
                    A.d(t, {
                        addModelObserver: () => z,
                ...
                const Au = (() => {
                    ...
                    Fu = Object.keys(w).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === w[e]), u), {}),
                    Eu = {
                        set: (u, e) => {
                ...
                const iu = Bu().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        Bu().createElement(
                            'div',
                            Cu({}, t, {
                                className: B()(ou.base, ou[`base__theme-${D}`], F),
                                ref: function (u) {
                ...
                const pu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    vu = (u, e, A = du.left) => u.split(e).reduce(A === du.left ? gu : fu, []),
                    bu = (() => {
                        const u = new RegExp(
                    ...
                    hu = (u, e = du.left) => {
                        ...
                        return ((u, e = du.left) => {
                            ...
                            const F =
                                ...
                                E = pu(u);
                            return vu(E, /( )/, e).forEach((u) => (A = A.concat(vu(u, F, du.left)))), A;
                        })(u, e);
                    },
                    Pu = 'FormatText_base_d0',
                    wu = ({ binding: u, text: e = '', classMix: A, alignment: F = du.left, formatWithBrackets: E }) => {
                        ...
                        switch (E) {
                            case 'vehicles':
                                return B
                                    ...
                                    : D
                                      ? `R.images.gui.maps.shop.vehicles.${Gu(e)}.${D}`
                                      : `R.images.gui.maps.icons.quests.bonuses.${e}.vehicles`;
                            case 'customizations': {
                                const u = Iu(
                                    R.images,
                                    `R.images.gui.maps.icons.quests.bonuses.${e}.${D}${n ? '_' + n : ''}`,
                                );
                                return u || `R.images.gui.maps.icons.quests.bonuses.${e}.${D}`;
                            }
                            case 'basic':
                            case 'plus':
                            case 'premium':
                            ...
                            case 'dossier_badge':
                                return `R.images.gui.maps.icons.quests.bonuses.badges.${Gu(e)}.${D}`;
                            case 'dossier_achievement':
                                return `R.images.gui.maps.icons.achievement.${Gu(e)}.${D}`;
                            case 'xp':
                            case 'xpFactor':
                            ...
                            case 'battlePassSelectToken': {
                                const u = Iu(R.images, `gui.maps.icons.quests.bonuses.${e}.${D}_${t}`);
                                return u || `R.images.gui.maps.icons.quests.bonuses.${e}.${D}`;
                            }
                            case 'premiumTank':
                            ...
                            case 'lootBox': {
                                const u = Iu(R.images, `gui.maps.icons.quests.bonuses.${e}.lootBox_${D}`);
                                return u || `R.images.gui.maps.icons.quests.bonuses.${e}.lootBox_default`;
                            }
                            case 'collectionItem':
                                return `R.images.gui.maps.icons.collectionItems.${Gu(e)}.${D}`;
                        }
                    };
                function $u() {}
                function zu() {
                ...
                const Yu = ((u, e) => {
                                ...
                                const n = (0, nu.useRef)([]),
                                    B = (A, F, E) => {
                                        ...
                                        const t = (function ({
                                                ...
                                                return {
                                                    subscribe: (A, D) => {
                                                        const n = 'string' == typeof D ? `${F}.${D}` : F,
                                                            B = tu.view.addModelObserver(n, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = Lu(E.keys()); !(u = A()).done; ) D(u.value, e);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(F),
                                            ...
                                            C = { mode: A, model: s, externalModel: B, cleanup: o };
                                        return {
                                            model: s,
                                    ...
                                    s = o[0],
                                    C = o[1],
                                    i = (0, nu.useState)(() => B(F, E, t)),
                                    a = i[0],
                                    c = i[1];
                                return (
                                    (0, nu.useEffect)(() => {
                                        r.current ? c(B(s, E, t)) : (r.current = !0);
                                    }, [t, s, E]),
                                    (0, nu.useEffect)(() => {
                                        C(F);
                                    }, [F]),
                                    ...
                                    Bu().createElement(A.Provider, { value: a }, D)
                                );
                            },
                            () => (0, nu.useContext)(A),
                        ];
                    ...
                    Zu = 'App_icon_2f',
                    Wu = 'App_title_f8',
                    Ju = 'App_highlighted_6b',
                    Ku = 'App_description_f5',
                    ue = (0, Mu.Pi)(() => {
                        ...
                        return Bu().createElement(
                            ...
                            Bu().createElement('div', {
                                className: Zu,
                                style: { backgroundImage: `url(${Nu(u, xu.S600x450)})` },
                            }),
                            Bu().createElement(
                                'div',
                                { className: Wu },
                                Iu(R.strings, `tooltips.awardItem.${u.name}.header`),
                            ),
                            Bu().createElement(wu, {
                                classMix: Ku,
                                text: Iu(R.strings, `tooltips.awardItem.${u.name}.body`),
                                binding: {
                                    highlighted: Bu().createElement(wu, {
                                        classMix: Ju,
                                        text: Iu(R.strings, 'tooltips.awardItem.highlighted'),
                                        binding: { xp: u.value },
                                    }),
                                },
                            }),
                ...
                engine.whenReady.then(() => {
                    cu().render(
                        Bu().createElement(Qu, null, Bu().createElement(iu, null, Bu().createElement(ue, null))),
        ...
        (F.O = (e, A, E, D) => {
            if (!A) {
                ...
                for (o = 0; o < u.length; o++) {
                    for (var [A, E, D] = u[o], n = !0, B = 0; B < A.length; B++)
