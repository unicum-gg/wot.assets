    ...
    var u,
        e = {
            3404: (u, e, A) => {
                ...
                var D = {};
                A.r(D), A.d(D, { getBgUrl: () => x, getTextureUrl: () => w });
                var t = {};
                A.r(t),
                    A.d(t, {
                        addModelObserver: () => q,
                ...
                const f = {
                    ...
                    _ = { play: Object.assign({}, b, { sound: d }), setRTPC: m },
                ...
                const vu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    hu = (u, e, A = gu.left) => u.split(e).reduce(A === gu.left ? bu : _u, []),
                    Pu = (() => {
                        const u = new RegExp(
                    ...
                    xu = ({ binding: u, text: e = '', classMix: A, alignment: F = gu.left, formatWithBrackets: E }) => {
                        ...
                        return ou().createElement(
                            ...
                            D.split('\n').map((e, E) =>
                                ou().createElement(
                                    'div',
                                    { className: B()(wu, A), key: `${e}-${E}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : Ru(u, e))))(
                                        e,
                                        F,
                                        u,
                ...
                const Oe = ((u, e) => {
                                    ...
                                    B = (A, F, E) => {
                                        ...
                                        const t = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = xe(E.keys()); !(u = A()).done; ) D(u.value, e);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(F),
                    ...
                    })(({ observableModel: u }) => ({ root: u.object() }), ye),
                    ke = Oe[0],
                    Ue = Oe[1],
                    Ie = 'App_base_9f',
                    Me = 'App_icon_2f',
                    Ge = 'App_title_f8',
                    $e = 'App_highlighted_6b',
                    Ne = 'App_description_f5',
                    ze = (0, Nu.Pi)(() => {
                        ...
                        return ou().createElement(
                            ...
                            ou().createElement(
                                'div',
                                { className: Ge },
                                $u(R.strings, `tooltips.awardItem.${u.name}.header`),
                            ),
                            ou().createElement(xu, {
                                classMix: Ne,
                                text: $u(R.strings, `tooltips.awardItem.${u.name}.body`),
                                binding: {
                                    highlighted: ou().createElement(xu, {
                                        classMix: $e,
                                        text: $u(R.strings, 'tooltips.awardItem.highlighted'),
                                        binding: { xp: u.value },
                                    }),
                                },
                            }),
