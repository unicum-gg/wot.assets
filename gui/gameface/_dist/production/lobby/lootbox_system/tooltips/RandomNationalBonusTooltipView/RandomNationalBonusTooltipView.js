    ...
    var u,
        e = {
            4615: (u, e, A) => {
                var E = {};
                (A.r(E),
                    A.d(E, { mouse: () => l, off: () => a, on: () => C, onResize: () => s, onScaleUpdated: () => i }));
                var F = {};
                (A.r(F),
                    A.d(F, {
                        events: () => E,
                ...
                var t = {};
                (A.r(t), A.d(t, { getBgUrl: () => T, getTextureUrl: () => x }));
                var D = {};
                (A.r(D),
                    A.d(D, {
                        addModelObserver: () => X,
                ...
                const f = {
                    ...
                    _ = Object.keys(b).reduce((u, e) => ((u[e] = () => d(b[e])), u), {}),
                    h = { play: Object.assign({}, _, { sound: d }), setRTPC: m },
                    P = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    y = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function w(u) {
                    let e = '';
                    for (let A = y.length - 1; A >= 0; A--) for (; u >= y[A]; ) ((e += P[A]), (u -= y[A]));
                    return e;
                }
                ...
                const Cu = { view: D, client: F, sound: h, intl: v };
                var au = A(7363),
                    cu = A.n(au);
                function lu() {
                ...
                const gu = cu().forwardRef(function (u, e) {
                    let A = u.children,
                        E = u.className,
                        F = u.theme,
                    ...
                    return (
                        ...
                        cu().createElement(
                            ...
                            cu().createElement('div', { className: du.decorator }, A),
                        )
                    );
                });
                var fu = A(1533),
                ...
                const Pu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    wu = (u, e, A = _u.left) => u.split(e).reduce(A === _u.left ? yu : Ru, []),
                    xu = (() => {
                        const u = new RegExp(
                            [
                            ...
                            t.split('\n').map((e, F) =>
                                cu().createElement(
                                    ...
                                    ((u, e, A) =>
                                        ...
                                        E,
                                        u,
                                    ).map((u, e) => cu().createElement(au.Fragment, { key: `${e}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                let Mu, Uu, Iu, Gu, $u, Nu, Lu, zu;
                (!(function (u) {
                    ((u.Items = 'items'),
                ...
                const ju = (u, e) => {
                    ...
                    Ae = 'blueprintsAny',
                    Ee = 'finalBlueprints',
                    Fe = 'randomNationalBlueprint',
                    te = 'tokens',
                    De = 'styleProgress',
                    ne = 'crewBooks',
                    Be = 'randomNationalBrochure',
                    re = 'randomNationalGuide',
                    oe = 'randomNationalCrewBook',
                    se = 'crewSkins',
                    ie = 'goodies',
                    Ce = 'groups',
                    ae = 'dossier_badge',
                    ce = 'dossier_achievement',
                    le = 'xp',
                    de = 'xpFactor',
                    me = 'creditsFactor',
                    pe = 'crystal',
                    ...
                    xe = (u, e = Iu.S180x135, A = !1) => {
                        const E = A ? u.compensation : u,
                            F = E.name,
                            t = E.icon,
                            D = E.value,
                            n = u.id,
                        ...
                        switch (F) {
                            case Yu:
                                return B
                                    ...
                                    : t
                                      ? `R.images.gui.maps.shop.vehicles.${we(e)}.${t}`
                            ...
                            case Ee:
                            case Fe:
                                return `R.images.gui.maps.icons.blueprints.fragment.${e}.${t}`;
                            case te:
                            case De:
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${t}`;
                            case ne:
                            ...
                            case re:
                            case oe:
                                return `R.images.gui.maps.icons.crewBooks.books.${e}.${t}`;
                            case se:
                            case ie:
                            case Ce:
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${t}`;
                            case ae:
                                return `R.images.gui.maps.icons.quests.bonuses.badges.${we(e)}.${t}`;
                            case ce:
                                return `R.images.gui.maps.icons.achievement.${we(e)}.${t}`;
                            case le:
                            case de:
                            ...
                            case ye:
                                return ((u, e) => Vu(u, `lootBox_${e}`, 'lootBox_default'))(e, t);
                            case Re:
                                return `R.images.gui.maps.icons.collectionItems.${we(e)}.${t}`;
                            default:
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${t}`;
                        }
                    };
                ...
                const Ie = ((u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: F, children: t, mocks: D }) {
                                const n = (0, au.useRef)([]),
                                    B = (A, E, F) => {
                                        ...
                                        const D = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = ke(F.keys()); !(u = A()).done; ) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(E),
                                            ...
                                            i = { mode: A, model: s, externalModel: B, cleanup: o };
                                        return {
                                            model: s,
                                    ...
                                    s = o[0],
                                    i = o[1],
                                    C = (0, au.useState)(() => B(E, F, D)),
                                    a = C[0],
                                    c = C[1];
                                return (
                                    (0, au.useEffect)(() => {
                                        r.current ? c(B(s, F, D)) : (r.current = !0);
                                    }, [D, s, F]),
                                    (0, au.useEffect)(() => {
                                        i(E);
                                    }, [E]),
                    ...
                    })(({ observableModel: u }) => ({ root: u.object() }), Te),
                    Ge = Ie[0],
                    $e = Ie[1],
                    Ne = 'App_base_9f',
                    Le = 'App_icon_2f',
                    ze = 'App_title_f8',
                    qe = 'App_highlighted_6b',
                    Xe = 'App_description_f5',
                    je = (0, Xu.Pi)(() => {
                        ...
                        return cu().createElement(
                            ...
                            cu().createElement('div', {
                                className: Le,
                                style: { backgroundImage: `url(${xe(u, Iu.S600x450)})` },
                            }),
                            cu().createElement(
                                'div',
                                { className: ze },
                                qu(R.strings, `tooltips.awardItem.${u.name}.header`),
                            ),
                            cu().createElement(ku, {
                                classMix: Xe,
                                text: qu(R.strings, `tooltips.awardItem.${u.name}.body`),
                                binding: {
                                    highlighted: cu().createElement(ku, {
                                        classMix: qe,
                                        text: qu(R.strings, 'tooltips.awardItem.highlighted'),
                                        binding: { xp: u.value },
                                    }),
                                },
                            }),
                ...
                engine.whenReady.then(() => {
                    vu().render(
                        cu().createElement(Ge, null, cu().createElement(gu, null, cu().createElement(je, null))),
