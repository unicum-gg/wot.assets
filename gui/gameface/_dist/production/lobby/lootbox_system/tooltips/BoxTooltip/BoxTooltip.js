    ...
    var u,
        e = {
            4111: (u, e, A) => {
                var F = {};
                A.r(F),
                    A.d(F, { mouse: () => c, off: () => a, on: () => s, onResize: () => C, onScaleUpdated: () => i });
                var E = {};
                A.r(E),
                    A.d(E, {
                        events: () => F,
                ...
                var t = {};
                A.r(t), A.d(t, { getBgUrl: () => x, getTextureUrl: () => b });
                var D = {};
                A.r(D),
                    A.d(D, {
                        addModelObserver: () => L,
                ...
                const v = {
                    ...
                    _ = Object.keys(f).reduce((u, e) => ((u[e] = () => d(f[e])), u), {}),
                ...
                const Au = (() => {
                    ...
                    Fu = Object.keys(h).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === h[e]), u), {}),
                    Eu = {
                        set: (u, e) => {
                ...
                const su = Bu().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        Bu().createElement(
                            'div',
                            iu({}, D, {
                                className: B()(ou.base, ou[`base__theme-${t}`], F),
                                ref: function (u) {
                                    (r.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            Bu().createElement('div', { className: ou.decorator }, A),
                        )
                    );
                });
                var au = A(1533),
                ...
                const pu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    fu = (u, e, A = du.left) => u.split(e).reduce(A === du.left ? gu : vu, []),
                    _u = (() => {
                        const u = new RegExp(
                    ...
                    bu = (u, e = du.left) => {
                        ...
                        return ((u, e = du.left) => {
                            ...
                            const F =
                                ...
                                E = pu(u);
                            return fu(E, /( )/, e).forEach((u) => (A = A.concat(fu(u, F, du.left)))), A;
                        })(u, e);
                    },
                    xu = 'FormatText_base_d0',
                    hu = ({ binding: u, text: e = '', classMix: A, alignment: F = du.left, formatWithBrackets: E }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const t = E && u ? mu(e, u) : e;
                        return Bu().createElement(
                            ...
                            t.split('\n').map((e, E) =>
                                Bu().createElement(
                                    'div',
                                    { className: B()(xu, A), key: `${e}-${E}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : bu(u, e))))(
                                        e,
                                        F,
                                        u,
                                    ).map((u, e) => Bu().createElement(nu.Fragment, { key: `${e}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                ...
                const Hu = (u, e) => {
                    ...
                    Zu = ({ type: u, filePath: e, eventName: A }, F = !1) => {
                        const E = ((u, e, A) => {
                            ...
                            n = E.defaultPath;
                        return t
                            ? { eventResource: F ? Hu(t, D) : Wu(t, D), defaultResource: F ? Hu(t, n) : Wu(t, n) }
                            : null;
                    },
                    Ju = ({ type: u, filePath: e, eventName: A }) => {
                        const F = Zu({ type: u, filePath: e, eventName: A });
                            ...
                            return E
                                ? ((A[F] = ((u, e, A) =>
                                      Object.keys(u).reduce(
                                          (F, E) => ((F[E] = Ju({ type: e, filePath: u[E], eventName: A })), F),
                                          {},
                                      ))(E, F, e)),
                                  A)
                                : A;
                        }, {}),
                    ue = (u, e, A) => (u || e ? u || e : (console.warn(`Not found ${A}`), '')),
                    ee = (u, e, A) =>
                            ...
                            return (
                                (F[E] = ((u, e, A) => {
                                    const F = `resource type: ${u}, path: ${e}`,
                                        E = Zu({ type: u, filePath: e, eventName: A }, !0);
                                    return ((u, e, A) => ({
                                        dynOpt: (F, E = 'default') => {
                                            const t =
                                                    (null == e ? void 0 : e.$dyn(F)) ||
                                                    (null == e ? void 0 : e.$dyn(E)),
                                                D = null == u ? void 0 : u.$dyn(E);
                                            return ue(t, D, A);
                                        },
                                        dyn: (F) => {
                                            const E = null == e ? void 0 : e.$dyn(F),
                                                t = null == u ? void 0 : u.$dyn(F);
                                            return ue(E, t, A);
                                        },
                                        plural: (F, E) => {
                                            const t = null == e ? void 0 : e.$plural(F, E),
                                                D = null == u ? void 0 : u.$plural(F, E);
                                            return ue(t, D, A);
                                        },
                                    }))(
                    ...
                    Ee = ((u, e) => {
                                ...
                                const n = (0, nu.useRef)([]),
                                    B = (A, F, E) => {
                                        ...
                                        const D = (function ({
                                                ...
                                                return {
                                                    subscribe: (A, t) => {
                                                        const n = 'string' == typeof t ? `${F}.${t}` : F,
                                                            B = Du.view.addModelObserver(n, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = ku(E.keys()); !(u = A()).done; ) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(F),
                                            ...
                                            r = (u) =>
                                                'mocks' === A ? (null == E ? void 0 : E.getter(u)) : B.readByPath(u),
                                            ...
                                            C = u({
                                                ...
                                                observableModel: {
                                                    array: (u, e) => {
                                                        const F = null != e ? e : r(u),
                                                            E = Ou.LO.box(F, { equals: Su });
                                                        return (
                                                            'real' === A &&
                                                                B.subscribe(
                                                                    (0, Ou.aD)((u) => E.set(u)),
                                    ...
                                    C = o[0],
                                    i = o[1],
                                    s = (0, nu.useState)(() => B(F, E, D)),
                                    a = s[0],
                                    l = s[1];
                                return (
                                    (0, nu.useEffect)(() => {
                                        r.current ? l(B(C, E, D)) : (r.current = !0);
                                    }, [D, C, E]),
                                    (0, nu.useEffect)(() => {
                                        i(F);
                                    }, [F]),
                                    ...
                                    Bu().createElement(A.Provider, { value: a }, t)
                                );
                            },
                            () => (0, nu.useContext)(A),
                        ];
                        ...
                        ({ observableModel: u }) => {
                            const e = u.object().get().eventName,
                                A = { root: u.object() },
                                F = (0, Gu.Om)(() => Ku(Ae, e), { equals: Su }),
                                E = (0, Gu.Om)(
                                    () =>
                                        ((u, e) =>
                                            Object.keys(u).reduce((A, F) => {
                                                const E = u[F];
                                                return E ? ((A[F] = ee(E, F, e)), A) : A;
                                            }, {}))(Fe, e),
                                    { equals: Su },
                                );
                    ...
                    ne = 'App_base_f2',
                    Be = 'App_icon_e4',
                    re = 'App_textsBlock_80',
                    oe = 'App_title_43',
                    Ce = 'App_howGetTitle_aa',
                    ie = 'App_howGetDescription_31',
                    se = 'App_description_2c',
                    ae = 'App_descriptionGuaranteed_45',
                    le = 'App_count_73',
                    ce = 'App_howGetBlock_20',
                    de = 'App_guarantyBlock_b2',
                    me = 'App_glow_65',
                    pe = 'Divider_base_c5',
                    ge = ({ image: u }) =>
                        Bu().createElement('div', { className: pe, style: { backgroundImage: `url(${u})` } }),
                    ve = (0, Pu.Pi)(() => {
                        const u = De().model,
                            e = u.root.get(),
                        ...
                        return Bu().createElement(
                            ...
                            Bu().createElement('div', {
                                className: Be,
                                style: { backgroundImage: `url(${Ru('s296x222', F)})` },
                            }),
                            Bu().createElement(
                                'div',
                                { className: re },
                                Bu().createElement('div', { className: oe }, n.boxTitle.dynOpt(F)),
                                Bu().createElement(hu, { classMix: se, text: n.boxDescription.dynOpt(F) }),
                                Bu().createElement(ge, { image: t.divider }),
                                Bu().createElement(
                                    'div',
                                    { className: ce },
                                    Bu().createElement('div', { className: Ce }, D.howGetTitle),
                                    Bu().createElement(hu, { classMix: ie, text: n.howGetBoxText.dynOpt(F) }),
                                ),
                                Bu().createElement(ge, { image: t.divider }),
                                A > 0 &&
                                    Bu().createElement(
                                        ...
                                        Bu().createElement(hu, {
                                            classMix: ae,
                                            text: n.guaranteedBoxText.dynOpt(F),
                                            binding: { count: Bu().createElement('span', { className: le }, A) },
                                        }),
                                    ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    lu().render(
                        Bu().createElement(te, null, Bu().createElement(su, null, Bu().createElement(ve, null))),
        ...
        (F.O = (e, A, E, t) => {
            if (!A) {
                ...
                for (o = 0; o < u.length; o++) {
                    for (var [A, E, t] = u[o], n = !0, B = 0; B < A.length; B++)
        ...
        (() => {
            ...
            var e = (e, A) => {
                    var E,
                        ...
                        r = 0;
                    if (D.some((e) => 0 !== u[e])) {
                        for (E in n) F.o(n, E) && (F.m[E] = n[E]);
                        if (B) var o = B(F);
                    }
                    for (e && e(A); r < D.length; r++) (t = D[r]), F.o(u, t) && u[t] && u[t][0](), (u[t] = 0);
                    return F.O(o);
                },
                A = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            A.forEach(e.bind(null, 0)), (A.push = e.bind(null, A.push.bind(A)));
        })();
    var E = F.O(void 0, [866], () => F(4111));
    E = F.O(E);
})();
