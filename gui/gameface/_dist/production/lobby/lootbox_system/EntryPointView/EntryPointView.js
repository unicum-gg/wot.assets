(() => {
    var __webpack_modules__ = {
            ...
            1915: (u, e, t) => {
                ...
                (0, n.memo)((u) => {
                    ...
                    const r = (0, n.useContext)(F),
                        ...
                        v = { extraLarge: m, large: _, medium: h, small: g, extraSmall: p };
                ...
                const w = {
                    ...
                    x = (u) => {
                        ...
                        const a = g(),
                            ...
                            E = a.mediaHeight,
                            o = a.mediaSize;
                        return r().createElement('div', v({ className: c()(t, w[i], b[E], f[o]) }, n), e);
                    },
                    S = ['children'];
                const T = (u) => {
                    let e = u.children,
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (k(t, B, { isMouseEvent: !0, on: !0, arguments: M(r) }, v),
                                    _ && _(),
                ...
                const Eu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    su = (u, e, t = au.left) => u.split(e).reduce(t === au.left ? ou : Au, []),
                    Fu = (() => {
                        const u = new RegExp(
                            [
                    ...
                    lu = (u, e = au.left) => {
                        ...
                        return ((u, e = au.left) => {
                            ...
                            const n =
                                ...
                                r = Eu(u);
                            return (su(r, /( )/, e).forEach((u) => (t = t.concat(su(u, n, au.left)))), t);
                        })(u, e);
                    },
                    Bu = {
                        ENTRY_POINT: {
                    ...
                    Cu = (u, e) => {
                        const t = cu[((n = u), n.replace(/_\w/g, (u) => u[1].toUpperCase()))];
                        var n;
                        return t
                            ? ((u, e) => {
                                  const t = (u, e) => {
                    ...
                    _u = ({ type: u, filePath: e, eventName: t }, n = !1) => {
                        const r = ((u, e, t) => {
                            ...
                            E = r.defaultPath;
                        return a
                            ? { eventResource: n ? mu(a, i) : du(a, i), defaultResource: n ? mu(a, E) : du(a, E) }
                            : null;
                    },
                    hu = ({ type: u, filePath: e, eventName: t }) => {
                        const n = _u({ type: u, filePath: e, eventName: t });
                            ...
                            return r
                                ? ((t[n] = ((u, e, t) =>
                                      Object.keys(u).reduce(
                                          (n, r) => ((n[r] = hu({ type: e, filePath: u[r], eventName: t })), n),
                                          {},
                                      ))(r, n, e)),
                                  t)
                                : t;
                ...
                const wu = ((u, e) => {
                                ...
                                const s = (0, n.useRef)([]),
                                    F = (t, n, r) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            l = { mode: t, model: D, externalModel: o, cleanup: F };
                                        return {
                                            model: D,
                                    ...
                                    B = l[0],
                                    c = l[1],
                                    C = (0, n.useState)(() => F(a, E, A)),
                                    d = C[0],
                                    m = C[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        D.current ? m(F(B, E, A)) : (D.current = !0);
                                    }, [A, B, E]),
                                    (0, n.useEffect)(() => {
                                        c(a);
                                    }, [a]),
                        ...
                        ({ observableModel: u }) => {
                            const e = u.object().get().eventName,
                                t = {
                                    root: u.object(),
                                    style: W.LO.box(Cu(e, eu.EntryPoint)),
                                    resources: W.LO.box(gu(pu, e)),
                                },
                                n = (0, j.Om)(() => (t.root.get().boxesCount ? vu.Boxes : vu.Empty));
                            return Object.assign({}, t, { computes: { getState: n } });
                        },
                        ({ externalModel: u }) => ({ showLanding: u.createCallbackNoArgs('onEntryClick') }),
                    ),
                    bu = wu[0],
                    fu = wu[1],
                    xu = 'FormatText_base_d0',
                    Su = ({ binding: u, text: e = '', classMix: t, alignment: a = au.left, formatWithBrackets: i }) => {
                    ...
                    Tu = 'Counter_base_aa',
                    yu = ({ count: u, text: e, maxText: t, className: n }) =>
                        r().createElement(
                            'div',
                            { className: c()(Tu, n) },
                            u < 1e3 ? r().createElement(Su, { text: e, binding: { count: u } }) : t,
                        ),
                    Lu = 'Icon_base_66',
                    Pu = ({ image: u, brightness: e, disabled: t, className: n }) =>
                        r().createElement('div', {
                            className: c()(Lu, n),
                            style: {
                                backgroundImage: `url(${u})`,
                                filter: t ? 'brightness(.8) saturate(.5)' : `brightness(${e})`,
                            },
                        }),
                    Ou = {
                        base: 'Shine_base_ec',
                        base__enhanced: 'Shine_base__enhanced_93',
                        shineAnimation: 'Shine_shineAnimation_b8',
                        'light-rotation': 'Shine_light-rotation_ef',
                        shineAnimation__reverse: 'Shine_shineAnimation__reverse_32',
                        'light-rotation-reverse': 'Shine_light-rotation-reverse_bf',
                    },
                    Ru = ({ hovered: u, enhanced: e, image: t, style: n }) =>
                        r().createElement(
                            'div',
                            {
                                className: c()(Ou.base, u && Ou.base__hover, e && Ou.base__enhanced),
                                style: { opacity: n.opacity },
                            },
                            r().createElement('div', {
                                className: Ou.shineAnimation,
                                style: { backgroundImage: `url(${t})`, animationDuration: n.animationDuration },
                            }),
                            r().createElement('div', {
                                className: c()(Ou.shineAnimation, Ou.shineAnimation__reverse),
                                style: { backgroundImage: `url(${t})`, animationDuration: n.animationDuration },
                            }),
                        ),
                    Mu = {
                        base: 'App_base_1b',
                        content: 'App_content_b8',
                        base__disabled: 'App_base__disabled_5d',
                        text: 'App_text_52',
                        count: 'App_count_8c',
                        icon: 'App_icon_e5',
                        alert: 'App_alert_95',
                        alert__empty: 'App_alert__empty_bb',
                        alert__boxes: 'App_alert__boxes_44',
                    },
                    ku = R.views.mono.lootbox,
                    Iu = (0, H.Pi)(() => {
                        const u = (0, n.useState)(!1),
                            ...
                            m = i.style.get(),
                            _ = m.shine,
                            h = _.opacityCustomNewBox,
                            g = _.opacityCustom,
                            p = _.opacityDiff,
                            v = _.animationDuration,
                            w = e ? 1 + m.icon[`${D}IconBrightness`] : 1,
                            b = { opacity: (F ? h : g) + (e ? p : 0), animationDuration: v },
                            f = D === vu.Empty ? B.iconEmpty : B.iconGold;
                        return r().createElement(
                            'div',
                            { className: c()(Mu.base, !A && Mu.base__disabled) },
                            r().createElement(
                                I,
                                { contentId: ku.tooltips.entry_point('resId') },
                                r().createElement(
                                    'div',
                                    null,
                                    r().createElement(
                                        'div',
                                        {
                                            ...
                                            onClick: () => {
                                                (N.hY.yes1(), E.showLanding());
                                            },
                                            onMouseEnter: () => {
                                                (N.hY.sound(d.entryHover), t(!0));
                                            },
                                            onMouseLeave: () => t(!1),
                                        },
                                        D === vu.Empty && r().createElement('div', { className: Mu.text }, C.boxes),
                                        D === vu.Boxes &&
                                            r().createElement(
                                                r().Fragment,
                                                null,
                                        ...
                                        !A &&
                                            r().createElement(U.z, {
                                                className: c()(Mu.alert, Mu[`alert__${D}`]),
                                                hasShadow: !0,
                                                icon: B.alert,
                                            }),
                                    ),
                ...
                engine.whenReady.then(() => {
                    L().render(
                        r().createElement(bu, null, r().createElement(T, null, r().createElement(Iu, null))),
            ...
            8515: (u, e, t) => {
                ...
                var n = t(6483),
                    ...
                    a = t(7363),
                    i = t.n(a);
                const E = { shadow: 'AlertIcon_shadow_86', icon: 'AlertIcon_icon_56' },
                    o = ({ icon: u, hasShadow: e = !1, className: t }) =>
                        i().createElement(
                            'div',
                            { className: r()(E.base, t) },
                            e && i().createElement('div', { className: E.shadow }),
                            i().createElement('div', { className: E.icon, style: { backgroundImage: `url(${u})` } }),
                        );
            },
            7363: (u) => {
                'use strict';
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [866], () => __webpack_require__(1915));
