(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => s, off: () => A, on: () => E, onResize: () => a, onScaleUpdated: () => i });
                var n = t(2472),
                    r = t(1176);
            ...
            4659: (u, e, t) => {
                ...
                const y = {
                    ...
                    O = (u) => {
                        ...
                        const a = f(),
                            ...
                            E = a.mediaHeight,
                            A = a.mediaSize;
                        return r().createElement('div', S({ className: h()(t, y[i], T[E], L[A]) }, n), e);
                    },
                    P = ['children'];
                const M = (u) => {
                    let e = u.children,
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (G(t, B, { isMouseEvent: !0, on: !0, arguments: U(r) }, v),
                                    _ && _(),
                ...
                const Du = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    cu = (u, e, t = su.left) => u.split(e).reduce(t === su.left ? lu : Bu, []),
                    Cu = (() => {
                        const u = new RegExp(
                    ...
                    mu = (u, e = su.left) => {
                        ...
                        return ((u, e = su.left) => {
                            ...
                            const n =
                                ...
                                r = Du(u);
                            return cu(r, /( )/, e).forEach((u) => (t = t.concat(cu(u, n, su.left)))), t;
                        })(u, e);
                    },
                    _u = {
                        ENTRY_POINT: {
                    ...
                    gu = (u, e) => {
                        const t = hu[((n = u), n.replace(/_\w/g, (u) => u[1].toUpperCase()))];
                        var n;
                        return t
                            ? ((u, e) => {
                                  const t = (u, e) => {
                    ...
                    wu = ({ type: u, filePath: e, eventName: t }, n = !1) => {
                        const r = ((u, e, t) => {
                            ...
                            E = r.defaultPath;
                        return a
                            ? { eventResource: n ? pu(a, i) : vu(a, i), defaultResource: n ? pu(a, E) : vu(a, E) }
                            : null;
                    },
                    bu = ({ type: u, filePath: e, eventName: t }) => {
                        const n = wu({ type: u, filePath: e, eventName: t });
                            ...
                            return r
                                ? ((t[n] = ((u, e, t) =>
                                      Object.keys(u).reduce(
                                          (n, r) => ((n[r] = bu({ type: e, filePath: u[r], eventName: t })), n),
                                          {},
                                      ))(r, n, e)),
                                  t)
                                : t;
                ...
                const yu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: E, children: A, mocks: o }) {
                                const s = (0, n.useRef)([]),
                                    ...
                                    B = l[0],
                                    c = l[1],
                                    C = (0, n.useState)(() => F(a, E, o)),
                                    d = C[0],
                                    m = C[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        D.current ? m(F(B, E, o)) : (D.current = !0);
                                    }, [o, B, E]),
                                    (0, n.useEffect)(() => {
                                        c(a);
                                    }, [a]),
                        ...
                        ({ observableModel: u }) => {
                            const e = u.object().get().eventName,
                                t = {
                                    root: u.object(),
                                    style: q.LO.box(gu(e, iu.EntryPoint)),
                                    resources: q.LO.box(fu(xu, e)),
                                },
                                n = (0, Z.Om)(() => (t.root.get().boxesCount ? Su.Boxes : Su.Empty));
                    ...
                    Pu = ({ binding: u, text: e = '', classMix: t, alignment: a = su.left, formatWithBrackets: i }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const E = i && u ? Fu(e, u) : e;
                    ...
                    Ru = 'Counter_base_aa',
                    Mu = ({ count: u, text: e, maxText: t, className: n }) =>
                        r().createElement(
                            'div',
                            { className: h()(Ru, n) },
                            u < 1e3 ? r().createElement(Pu, { text: e, binding: { count: u } }) : t,
                        ),
                    ku = 'Icon_base_66',
                    Iu = ({ image: u, brightness: e, disabled: t, className: n }) =>
                        r().createElement('div', {
                            className: h()(ku, n),
                            style: {
                    ...
                    Hu = ({ hovered: u, enhanced: e, image: t, style: n }) =>
                        r().createElement(
                            'div',
                            {
                                className: h()(Nu.base, u && Nu.base__hover, e && Nu.base__enhanced),
                                style: { opacity: n.opacity },
                            },
                            r().createElement('div', {
                                className: Nu.shineAnimation,
                                style: { backgroundImage: `url(${t})`, animationDuration: n.animationDuration },
                            }),
                            r().createElement('div', {
                                className: h()(Nu.shineAnimation, Nu.shineAnimation__reverse),
                                style: { backgroundImage: `url(${t})`, animationDuration: n.animationDuration },
                            }),
                        ),
                    Uu = {
                    ...
                    Gu = R.views.lobby.lootbox_system,
                    Wu = (0, z.Pi)(() => {
                        const u = (0, n.useState)(!1),
                            ...
                            d = i.style.get(),
                            m = d.shine,
                            _ = m.opacityCustomNewBox,
                            g = m.opacityCustom,
                            p = m.opacityDiff,
                            v = m.animationDuration,
                            w = e ? 1 + d.icon[`${D}IconBrightness`] : 1,
                            b = { opacity: (F ? _ : g) + (e ? p : 0), animationDuration: v },
                            f = D === Su.Empty ? B.iconEmpty : B.iconGold;
                        return r().createElement(
                            'div',
                            { className: h()(Uu.base, !o && Uu.base__disabled) },
                            r().createElement(
                                W,
                                { contentId: Gu.tooltips.EntryPointTooltip('resId') },
                                r().createElement(
                                    'div',
                                    null,
                                    r().createElement(
                                        'div',
                                        {
                                            ...
                                            onClick: () => {
                                                $.hY.yes1(), E.showLanding();
                                            },
                                            onMouseEnter: () => {
                                                $.hY.sound(C.entryHover), t(!0);
                                            },
                                            onMouseLeave: () => t(!1),
                                        },
                                        D === Su.Empty && r().createElement('div', { className: Uu.text }, c.boxes),
                                        D === Su.Boxes &&
                                            r().createElement(
                                                r().Fragment,
                                                null,
                                        ...
                                        !o &&
                                            r().createElement(V.z, {
                                                className: h()(Uu.alert, Uu[`alert__${D}`]),
                                                hasShadow: !0,
                                                icon: B.alert,
                                            }),
                                    ),
                ...
                engine.whenReady.then(() => {
                    I().render(
                        r().createElement(Tu, null, r().createElement(M, null, r().createElement(Wu, null))),
            ...
            8515: (u, e, t) => {
                ...
                const E = { shadow: 'AlertIcon_shadow_86', icon: 'AlertIcon_icon_56' },
                    A = ({ icon: u, hasShadow: e = !1, className: t }) =>
                        i().createElement(
                            'div',
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [866], () => __webpack_require__(4659));
