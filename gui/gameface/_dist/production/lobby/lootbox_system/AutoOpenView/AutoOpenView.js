    ...
    var __webpack_modules__ = {
                        ...
                        switch (r) {
                            case ou:
                                return i
                                    ...
                                    : a
                                      ? `R.images.gui.maps.shop.vehicles.${Wu(e)}.${a}`
                            ...
                            case yu:
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${a}`;
                            case Su:
                                return `R.images.gui.maps.icons.quests.bonuses.badges.${Wu(e)}.${a}`;
                            case xu:
                                return `R.images.gui.maps.icons.achievement.${Wu(e)}.${a}`;
                            case Ru:
                            case Tu:
                            ...
                            case Gu:
                                return `R.images.gui.maps.icons.collectionItems.${Wu(e)}.${a}`;
                            default:
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${a}`;
                        }
                    },
            ...
            3958: (u, e, t) => {
                ...
                const k = 'VerticalBar_base_f3',
                    ...
                    X = (0, i.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = V, onDrag: n = W }) => {
                        const r = (0, i.useRef)(null),
                            a = (0, i.useRef)(null),
                            D = (0, i.useRef)(null),
                            m = (0, i.useRef)(null),
                        ...
                        return l().createElement(
                            ...
                            l().createElement(
                                ...
                                l().createElement('div', { className: s()($, e.rail) }),
                            ),
                            l().createElement('div', {
