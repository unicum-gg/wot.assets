(() => {
    var __webpack_modules__ = {
                        ...
                        return (n = {}) => {
                            const m = n.settings,
                                ...
                                f = (0, c.useSpring)(() => ({
                                    ...
                                    onChange: (u) => {
                                        const e = C.current;
                                        e && (t(e, u), p.trigger('change', u), F && g.current && h());
                                    },
                            ...
                            return (0, l.useMemo)(
                                ...
                                [v.scrollPosition, S, y, p.off, p.on, T, x, b, B.step.clampedArrowStepTimeout],
                            );
                        };
                    };
            },
            ...
            8641: (u, e, t) => {
                ...
                const x = {
                    ...
                    L = (u) => {
                        ...
                        const a = w(),
                            ...
                            o = a.mediaHeight,
                            i = a.mediaSize;
                        return r().createElement('div', y({ className: g()(t, x[s], T[o], P[i]) }, n), e);
                    },
                    M = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                class U extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            d = g()(H.base, H[`base__${s}`], H[`base__${a}`], null == o ? void 0 : o.base),
                            F = g()(H.icon, H[`icon__${s}`], H[`icon__${a}`], null == o ? void 0 : o.icon),
                ...
                function K(u, e) {
                    ...
                    if (
                        ...
                        (t = (function (u, e) {
                            ...
                            'Object' === t && u.constructor && (t = u.constructor.name);
                            if ('Map' === t || 'Set' === t) return Array.from(u);
                            if ('Arguments' === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)) return Z(u, e);
                        })(u)) ||
                        (e && u && 'number' == typeof u.length)
                    ) {
                        t && (u = t);
                ...
                const Eu = (u, e) => {
                    ...
                    hu = 'blueprintsAny',
                    fu = 'finalBlueprints',
                    vu = 'randomNationalBlueprint',
                    bu = 'tokens',
                    wu = 'styleProgress',
                    Su = 'crewBooks',
                    yu = 'randomNationalBrochure',
                    xu = 'randomNationalGuide',
                    Ru = 'randomNationalCrewBook',
                    Tu = 'crewSkins',
                    Pu = 'goodies',
                    Lu = 'groups',
                    Mu = 'dossier_badge',
                    ku = 'dossier_achievement',
                    Ou = 'xp',
                    Nu = 'xpFactor',
                    Iu = 'creditsFactor',
                    Hu = 'crystal',
                        ...
                        switch (r) {
                            case du:
                                return i
                                    ...
                                    : a
                                      ? `R.images.gui.maps.shop.vehicles.${Yu(e)}.${a}`
                            ...
                            case Lu:
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${a}`;
                            case Mu:
                                return `R.images.gui.maps.icons.quests.bonuses.badges.${Yu(e)}.${a}`;
                            case ku:
                                return `R.images.gui.maps.icons.achievement.${Yu(e)}.${a}`;
                            case Ou:
                            case Nu:
                            ...
                            case ju:
                                return ((u, e) => Au(u, `lootBox_${e}`, 'lootBox_default'))(e, a);
                            case Xu:
                                return `R.images.gui.maps.icons.collectionItems.${Yu(e)}.${a}`;
                            default:
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${a}`;
                        }
                    },
                ...
                const he = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    be = (u, e, t = ge.left) => u.split(e).reduce(t === ge.left ? fe : ve, []),
                    we = (() => {
                        const u = new RegExp(
                    ...
                    ye = (u, e = ge.left) => {
                        ...
                        return ((u, e = ge.left) => {
                            ...
                            const n =
                                ...
                                r = he(u);
                            return (be(r, /( )/, e).forEach((u) => (t = t.concat(be(u, n, ge.left)))), t);
                        })(u, e);
                    },
                    xe = 'FormatText_base_d0',
                    Re = ({ binding: u, text: e = '', classMix: t, alignment: a = ge.left, formatWithBrackets: s }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const o = s && u ? pe(e, u) : e;
                        return r().createElement(
                            n.Fragment,
                            null,
                            o.split('\n').map((e, s) =>
                ...
                const ke = [
                        ...
                        nu.DeluxeGift,
                        nu.ModernizedDevicesT1Gift,
                        nu.ModernizedDevicesT2Gift,
                        nu.ModernizedDevicesT3Gift,
                        nu.BattleBoosterGift,
                        nu.OptionalDevice,
                        nu.Attachment,
                    ],
                    Oe = [nu.Gold, nu.Credits, nu.Crystal, nu.FreeXp],
                    Ne = [nu.BattlePassPoints, nu.EquipCoin],
                    Ie = [nu.PremiumPlus, nu.Premium],
                    He =
                        (au.Small,
                        au.Big,
                        [
                        ...
                        const h = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, n.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Ge(t, F, { isMouseEvent: !0, on: !0, arguments: We(r) }, f),
                                    _ && _(),
                ...
                const qe = {
                    ...
                    Xe = (0, j.Pi)(({ reward: u }) => {
                        const e = de(),
                            ...
                            _ = (() => {
                                switch (a) {
                                    case nu.Vehicles:
                                        return Ku(Object.assign({}, u, { id: 0, icon: '' }), je, E);
                                    case nu.PremiumPlus:
                                        return Ku(Object.assign({}, u, { id: 0, icon: 'premium_plus_universal' }), je);
                                    default:
                                        return Ku(Object.assign({}, u, { id: 0 }), je);
                                }
                            })(),
                            p = ((u) =>
                                ke.includes(u)
                                    ...
                                    : Oe.includes(u)
                                      ...
                                      : Ne.includes(u)
                                        ...
                                        : Ie.includes(u)
                                          ...
                                          : su.STRING)(a),
                            h = E ? c.label : u.label,
                            f = u.name === nu.Customizations,
                            v = u.name === nu.PremiumPlus,
                            b = u.name === nu.TmanToken,
                            w =
                                f || v || b
                                    ? null
                                    : ((u, e) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: qe.icon, style: { backgroundImage: `url(${_})` } },
                                        E &&
                                            r().createElement('div', {
                                                className: qe.iconCompensation,
                                                style: { backgroundImage: `url(${m.compensationIcon})` },
                                            }),
                                        F &&
                                            r().createElement('div', {
                                                className: g()(qe.overlay, ee.includes(a) && qe.overlay__normalize),
                                                style: { backgroundImage: `url(${Zu(je, a, F)})` },
                                            }),
                                        ((u) => {
                                            const e = u.name,
                                                t = u.icon;
                                    ...
                                    l > 1
                                        ...
                                        : r().createElement(
                                              ...
                                              w &&
                                                  r().createElement(
                                                      'div',
                                                      { className: g()(qe.label, qe[`label__${u.name}`]) },
                                                      w,
                                                  ),
                                              f &&
                                                  r().createElement(
                                                      'div',
                                                      { className: g()(qe.label, qe.label__customizations) },
                                                      u.label,
                                                  ),
                                              v &&
                                                  r().createElement(
                                                      'div',
                                                      { className: g()(qe.label, qe.label__premium) },
                                                      r().createElement('span', { className: qe.accentGold }, u.value),
                                                      ' ',
                    ...
                    Ye = 'RewardRow_base_ba',
                    Ke = 'RewardRow_heading_fc',
                    Ze = 'RewardRow_label_54',
                    Qe = 'RewardRow_count_9b',
                    Je = 'RewardRow_content_79',
                    ut = 'RewardRow_reward_05',
                    et = (0, j.Pi)(({ rowIndex: u, label: e, rewardsCount: t }) => {
                        const n = de().model.computes.getRewardsList(u);
                        return r().createElement(
                            'div',
                            { className: Ye },
                            r().createElement(
                                ...
                                r().createElement('div', { className: Qe }, t),
                            ),
                            r().createElement(
                                'div',
                                { className: Je },
                    ...
                    tt = 'Content_base_68',
                    nt = 'Content_header_a3',
                    rt = 'Content_base__top_1b',
                    at = 'Content_subTitle_94',
                    st = 'Content_scrollArea_af',
                    ot = 'Content_rewardsRows_64',
                    it = 'Content_footer_0a',
                    lt = (0, j.Pi)(() => {
                        const u = de(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return r().createElement(
                            'div',
                            { className: g()(tt, e.hasResources && rt) },
                            r().createElement(
                                'div',
                                { className: nt },
                                e.hasResources &&
                                ...
                                r().createElement(Le.D, { text: a.title }),
                            ),
                            r().createElement(
                                'div',
                                { className: st },
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    Ce,
                                    { type: De.primary, size: me.medium, onClick: t.close },
                                    a.submitButtonText,
                                ),
                            ),
                        );
                    ...
                    At = (0, j.Pi)(() => {
                        ...
                        return (
                            ...
                            r().createElement(
                                'div',
                                { className: ct, style: { backgroundImage: `url(${a.background})` } },
                                r().createElement(
                                    'div',
                                    { className: Et },
                                    r().createElement(U, {
                ...
                engine.whenReady.then(() => {
                    N().render(
                        r().createElement(Ae, null, r().createElement(k, null, r().createElement(At, null))),
            ...
            3958: (u, e, t) => {
                ...
                const m = {
                    ...
                    R = (0, i.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = S, onDrag: n = y }) => {
                        ...
                        return l().createElement(
                            ...
                            l().createElement(
                                ...
                                l().createElement('div', { ref: R, className: s()(f, e.thumb) }),
                ...
                const k = 'VerticalBar_base_f3',
                    ...
                    X = (0, i.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = V, onDrag: n = $ }) => {
                        const r = (0, i.useRef)(null),
                            a = (0, i.useRef)(null),
                            D = (0, i.useRef)(null),
                            m = (0, i.useRef)(null),
                                ...
                                ((t.style.transform = `translateY(${0 | l}px)`),
                                    ((u) => {
                                        if (a.current && D.current && m.current && B.current) {
                                            if (0 === Math.round(u))
                                                return (a.current.classList.add(U), void D.current.classList.remove(U));
                                            if (
                                                ((e = m.current),
                                                (t = B.current),
                                                u - (e.offsetHeight - t.offsetHeight) >= -0.5)
                                            )
                                                return (a.current.classList.remove(U), void D.current.classList.add(U));
                                            var e, t;
                                            (a.current.classList.remove(U), D.current.classList.remove(U));
                                        }
                                    })(l));
                            }),
                            b = (0, A.z)(() => {
                        ...
                        const x = (u) => {
                            u.target.classList.contains(U) || (0, F.G)('highlight');
                        };
                        return l().createElement(
                            'div',
                            ...
                            l().createElement('div', {
                                ...
                                onMouseDown: (u) => {
                                    u.target.classList.contains(U) ||
                                        0 !== u.button ||
                                        ((0, F.G)('play'), S(M.Nm.Next));
                                },
                                ref: a,
                                onMouseEnter: x,
                            }),
                            l().createElement(
                                ...
                                l().createElement('div', { ref: B, className: s()(W, e.thumb) }),
                                l().createElement('div', { className: s()(G, e.rail) }),
                            ),
                            l().createElement('div', {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [866], () => __webpack_require__(8641));
