(() => {
    var __webpack_modules__ = {
            ...
            3682: (u, e, t) => {
                    ...
                    _ = (0, E.memo)(({ children: u }) => {
                        const e = (0, E.useContext)(B),
                            ...
                            D = (0, E.useCallback)((u, e) => {
                                ...
                                F(Object.assign({ width: t, height: E }, i(t, E, n)));
                            }, []);
                        d(() => {
                            engine.on('clientResized', D);
                        }),
                            (0, E.useEffect)(() => () => engine.off('clientResized', D), [D]);
                        const o = (0, E.useMemo)(() => Object.assign({}, A), [A]);
                        return r().createElement(B.Provider, { value: o }, u);
                    });
                var m = t(6483),
                    h = t.n(m),
                    g = t(926),
                ...
                const M = {
                    ...
                    T = (u) => {
                        ...
                        const A = f(),
                            ...
                            n = A.mediaHeight,
                            F = A.mediaSize;
                        return r().createElement('div', L({ className: h()(t, M[a], S[n], y[F]) }, E), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                const z = (u, e, t) => {
                    ...
                    q = (u, e, t = $.left) => u.split(e).reduce(t === $.left ? z : V, []),
                    K = (() => {
                        const u = new RegExp(
                        ...
                        return Y.includes(t)
                            ...
                            : ((u, e = $.left) => {
                                  ...
                                  const E =
                                      ...
                                      r = u.replace(/&nbsp;/g, ' ');
                                  return q(r, /( )/, e).forEach((u) => (t = t.concat(q(u, E, $.left)))), t;
                              })(u, e);
                    },
                    Z = 'FormatText_base_d0',
                    Q = ({ binding: u, text: e = '', classMix: t, alignment: A = $.left }) =>
                        null === e
                ...
                class tu extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()(J.base, J[`base__${a}`], J[`base__${A}`], null == n ? void 0 : n.base),
                            B = h()(J.icon, J[`icon__${a}`], J[`icon__${A}`], null == n ? void 0 : n.icon),
                            C = h()(J.glow, null == n ? void 0 : n.glow),
                            c = h()(J.caption, J[`caption__${a}`], null == n ? void 0 : n.caption),
                            d = h()(J.goto, null == n ? void 0 : n.goto);
                        return r().createElement(
                            ...
                            E && r().createElement('div', { className: d }, E),
                        );
                    }
                }
                ...
                function Au(u = Eu.n.NONE, e = ru, t = !1) {
                    (0, E.useEffect)(() => {
                        if (u !== Eu.n.NONE)
                            return (
                        ...
                        function E(E) {
                            if (E.keyCode === u) {
                                ...
                                a.O.view.setEventHandled(), e(E), t && E.stopPropagation();
                            }
                        }
                    }, [e, u, t]);
                }
                ...
                const lu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: A = 'real', options: n, children: F, mocks: i }) {
                                const D = (0, E.useRef)([]),
                                    o = (t, E, r) => {
                                        var A;
                                        const n = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = iu(r.keys()); !(u = t()).done; ) A(u.value, e);
                                                    },
                                                    unsubscribe: A,
                                                };
                                            })(E),
                                    ...
                                    B = l[0],
                                    C = l[1],
                                    c = (0, E.useState)(() => o(A, n, i)),
                                    d = c[0],
                                    _ = c[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        s.current ? _(o(B, n, i)) : (s.current = !0);
                                    }, [i, B, n]),
                                    (0, E.useEffect)(() => {
                                        C(A);
                                    }, [A]),
                                    ...
                                    r().createElement(t.Provider, { value: d }, F)
                                );
                            },
                            () => (0, E.useContext)(t),
                        ];
                    ...
                    mu = 'App_content_58',
                    hu = 'App_cardTitle_d3',
                    gu = 'App_cardDescription_2f',
                    vu = 'App_applyButton_d9',
                    pu = 'App_blur_ba',
                    wu = 'App_closeButton_0d',
                    bu = 'App_title_6f',
                    fu = 'App_subTitle_1c',
                    xu = 'App_subTitleText_05',
                    Lu = 'App_card_d8',
                    Mu = 'App_card__last_4f',
                    Su = 'App_cardIcon_e8',
                    yu = R.strings.battle_pass,
                    Tu = (0, au.Pi)(() => {
                        const u = f().mediaSize,
                            e = Cu(),
                            t = e.model,
                        ...
                        return (
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: du },
                                    r().createElement(Q, { text: a, classMix: bu }),
                                    r().createElement(
                                        'div',
                                        { className: fu },
                                        r().createElement(Q, { text: n, classMix: xu }),
                                    ),
                                ),
                                r().createElement(
                                    'div',
                                    { className: mu },
                                    D.map(({ value: { icon: u, title: e, description: t } }, E) =>
                                        r().createElement(
                                            'div',
                                            { className: h()(Lu, E === D.length - 1 && Mu), key: `card_${E}` },
                                            r().createElement('div', {
                                                className: Su,
                                                style: {
                                                    backgroundImage: `url(${(null == u ? void 0 : u.split('.')[0]) + i}.png)`,
                                                },
                                            }),
                                            r().createElement(Q, { text: e, classMix: hu }),
                                            r().createElement(Q, { text: t, classMix: gu }),
                                        ),
                                    ),
                                ),
                                r().createElement(
                                    ...
                                    r().createElement(
                                        j,
                                        { type: U.primary, size: I.medium, mixClass: vu, onClick: E.close },
                                        r().createElement(Q, { text: F }),
                                    ),
                                ),
                            )
                        );
                ...
                engine.whenReady.then(() => {
                    P().render(
                        r().createElement(Bu, null, r().createElement(k, null, r().createElement(Tu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(3682));
