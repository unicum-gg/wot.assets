    ...
    var u,
        e = {
            ...
            3172: (u, e, A) => {
                ...
                var t = {};
                A.r(t), A.d(t, { getBgUrl: () => L, getTextureUrl: () => S });
                var D = {};
                A.r(D),
                    A.d(D, {
                        addModelObserver: () => j,
                ...
                const C = n('clientResized'),
                    l = n('self.onScaleUpdated'),
                    o = (u, e) => engine.on(u, e),
                ...
                const iu = ru.client.getSize('rem'),
                    Cu = iu.width,
                    lu = iu.height,
                    ou = Object.assign({ width: Cu, height: lu }, nu(Cu, lu, Bu)),
                    su = (0, r.createContext)(ou),
                    cu = ['children'];
                const du = (u) => {
                    let e = u.children,
                        A = (function (u, e) {
                ...
                const mu = (u) => {
                    ...
                    gu = ({ children: u }) => {
                        const e = (0, r.useContext)(su),
                            A = (0, r.useState)(e),
                            F = A[0],
                            E = A[1],
                            t = (0, r.useCallback)((u, e) => {
                                const A = ru.view.pxToRem(u),
                                    F = ru.view.pxToRem(e);
                                E(Object.assign({ width: A, height: F }, nu(A, F, Bu)));
                            }, []),
                            D = (0, r.useCallback)(() => {
                                const u = ru.client.getSize('px');
                                t(u.width, u.height);
                            }, [t]);
                        mu(() => {
                            ru.client.events.on('clientResized', t), ru.client.events.on('self.onScaleUpdated', D);
                        }),
                            (0, r.useEffect)(
                                () => () => {
                                    ru.client.events.off('clientResized', t),
                                        ru.client.events.off('self.onScaleUpdated', D);
                                },
                                [t, D],
                            );
                        const a = (0, r.useMemo)(() => Object.assign({}, F), [F]);
                        return B().createElement(su.Provider, { value: a }, u);
                    };
                var hu = A(6483),
                    fu = A.n(hu),
                    xu = A(926),
                ...
                const yu = {
                    ...
                    Mu = {
                        [wu.ExtraSmall]: '',
                        [wu.Small]: vu().SMALL,
                        [wu.Medium]: `${vu().SMALL} ${vu().MEDIUM}`,
                        [wu.Large]: `${vu().SMALL} ${vu().MEDIUM} ${vu().LARGE}`,
                        [wu.ExtraLarge]: `${vu().SMALL} ${vu().MEDIUM} ${vu().LARGE} ${vu().EXTRA_LARGE}`,
                    },
                    Tu = (u) => {
                        let e = u.children,
                            A = u.className,
                        ...
                        const E = Lu(),
                            ...
                            D = E.mediaHeight,
                            r = E.mediaSize;
                        return B().createElement('div', Hu({ className: fu()(A, yu[t], _u[D], Mu[r]) }, F), e);
                    },
                    Ru = ['children'];
                const Wu = (u) => {
                    let e = u.children,
                    ...
                    return B().createElement(gu, null, B().createElement(Tu, A, e));
                };
                var Iu = A(1533),
                    Ou = A.n(Iu),
                    Pu = A(1281);
                ...
                const ju = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Uu = (u, e, A = $u.left) => u.split(e).reduce(A === $u.left ? Nu : ku, []),
                    Vu = (() => {
                        const u = new RegExp(
                    ...
                    qu = (u, e = $u.left) => {
                        ...
                        return ((u, e = $u.left) => {
                            ...
                            const F =
                                ...
                                E = ju(u);
                            return Uu(E, /( )/, e).forEach((u) => (A = A.concat(Uu(u, F, $u.left)))), A;
                        })(u, e);
                    };
                var Qu = A(3403);
                function Zu() {}
                                ...
                                const a = (0, r.useRef)([]),
                                    n = (A, F, E) => {
                                        ...
                                        const D = (function ({
                                                ...
                                                return {
                                                    subscribe: (A, t) => {
                                                        const r = 'string' == typeof t ? `${F}.${t}` : F,
                                                            B = ru.view.addModelObserver(r, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = Yu(E.keys()); !(u = A()).done; ) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(F),
                                            ...
                                            C = { mode: A, model: i, externalModel: r, cleanup: n };
                                        return {
                                            model: i,
                                    ...
                                    l = C[0],
                                    o = C[1],
                                    s = (0, r.useState)(() => n(F, E, D)),
                                    c = s[0],
                                    d = s[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        i.current ? d(n(l, E, D)) : (i.current = !0);
                                    }, [D, l, E]),
                                    (0, r.useEffect)(() => {
                                        o(F);
                                    }, [F]),
                ...
                const ae = (u, e, A = '') => {
                    ...
                    ne = (u) => ({
                        backgroundImage: `url(${ae(R.images.gui.maps.icons.battlePass.chapter_choice.commander, u)})`,
                    }),
                    ie = (u) => ({
                        backgroundImage: `url(${ae(R.images.gui.maps.icons.battlePass.chapter_choice.tank, u)})`,
                    }),
                    Ce = 'Illustration_base_e1',
                    le = 'Illustration_chapter_6b',
                    oe = 'Illustration_tank_f9',
                    se = ({ chapterID: u }) =>
                        B().createElement(
                            'div',
                            { className: Ce },
                            B().createElement(
                                'div',
                                { className: le, style: ne(u) },
                                B().createElement('div', { className: oe, style: ie(u) }),
                            ),
                        ),
                    ce = 'ExtraChapterDescription_base_fe',
                    de = 'ExtraChapterDescription_description_8f',
                    me = 'ExtraChapterDescription_warningIcon_9e',
                    ge = 'ExtraChapterDescription_highlightText_7e',
                    he = 'FormatText_base_d0',
                    fe = ({ binding: u, text: e = '', classMix: A, alignment: F = $u.left, formatWithBrackets: E }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const t = E && u ? Gu(e, u) : e;
                    ...
                    xe = R.strings.battle_pass.chapterChoice.confirmation,
                    ve = () =>
                        B().createElement(
                            'div',
                            { className: ce },
                            B().createElement(fe, {
                                text: xe.extraChapterDescription.text(),
                                binding: {
                                    icon: B().createElement('span', { className: me }),
                                    highlightText: B().createElement(
                                        'span',
                                        { className: ge },
                                        xe.extraChapterDescription.highlightText(),
                                    ),
                                },
                                classMix: de,
                            }),
                    ...
                    pe = 'App_title_95',
                    Se = 'App_subTitle_5f',
                    Le = R.strings.battle_pass.chapterChoice.confirmation;
                let be;
                !(function (u) {
                    (u.Switch = 'switch'), (u.Select = 'select');
                })(be || (be = {}));
                const He = (u) => R.strings.battle_pass.chapter.fullName.$num(u),
                    ye = (0, Qu.Pi)(() => {
                        const u = Ee().model.root.get(),
                            e = u.prevChapter,
                            A = u.nextChapter,
                            F = u.isSwitchFromPostProgressionToExtraChapter,
                            E = 0 !== e ? be.Switch : be.Select;
                        return B().createElement(
                            'div',
                            { className: we },
                            B().createElement(se, { chapterID: A }),
                            B().createElement(
                                'div',
                                { className: pe },
                                ((u, e) => zu(Le.title.$dyn(u), { chName: He(e) }))(E, A),
                            ),
                            F
                                ...
                                : B().createElement(
                                      'div',
                                      { className: Se },
                                      ((u, e) => zu(Le.description.$dyn(u), { chName: He(e) }))(E, e),
                                  ),
                        );
                    });
                engine.whenReady.then(() => {
