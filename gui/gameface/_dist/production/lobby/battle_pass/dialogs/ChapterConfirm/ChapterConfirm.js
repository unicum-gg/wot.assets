    ...
    var u,
        e = {
            ...
            8129: (u, e, t) => {
                ...
                var A = {};
                t.r(A),
                    t.d(A, { mouse: () => c, off: () => s, on: () => C, onResize: () => B, onScaleUpdated: () => o });
                var r = {};
                t.r(r),
                    t.d(r, {
                        events: () => A,
                ...
                var F = {};
                t.r(F), t.d(F, { getBgUrl: () => p, getTextureUrl: () => L });
                var E = {};
                t.r(E),
                    t.d(E, {
                        addModelObserver: () => j,
                ...
                const B = D('clientResized'),
                    ...
                    d = { down: D('mousedown'), up: D('mouseup'), move: D('mousemove') };
                const c = (function () {
                ...
                const v = {
                    ...
                    w = Object.keys(x).reduce((u, e) => ((u[e] = () => m(x[e])), u), {}),
                    S = { play: Object.assign({}, w, { sound: m }), setRTPC: g };
                function L(u, e, t = 1) {
                ...
                const Au = (() => {
                    ...
                    ru = Object.keys(b).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === b[e]), u), {}),
                    Fu = {
                        set: (u, e) => {
                ...
                const lu = au.client.getSize('rem'),
                    Bu = lu.width,
                    ou = lu.height,
                    Cu = Object.assign({ width: Bu, height: ou }, Du(Bu, ou, nu)),
                    su = (0, a.createContext)(Cu),
                    du = ['children'];
                const cu = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    const A = (0, a.useContext)(su),
                        ...
                        f = { extraLarge: d, large: c, medium: m, small: g, extraSmall: h };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && l) return i(e, t, f);
                        if (t.largeWidth && B) return i(e, t, f);
                        if (t.mediumWidth && o) return i(e, t, f);
                        if (t.smallWidth && C) return i(e, t, f);
                        if (t.extraSmallWidth && s) return i(e, t, f);
                        if (
                ...
                const mu = (u) => {
                    ...
                    gu = ({ children: u }) => {
                        const e = (0, a.useContext)(su),
                            ...
                            F = (0, a.useCallback)((u, e) => {
                                const t = au.view.pxToRem(u),
                                    A = au.view.pxToRem(e);
                                r(Object.assign({ width: t, height: A }, Du(t, A, nu)));
                            }, []),
                            E = (0, a.useCallback)(() => {
                        ...
                        mu(() => {
                            au.client.events.on('clientResized', F), au.client.events.on('self.onScaleUpdated', E);
                        }),
                            (0, a.useEffect)(
                                () => () => {
                                    au.client.events.off('clientResized', F),
                                        au.client.events.off('self.onScaleUpdated', E);
                                },
                                [F, E],
                            );
                        const i = (0, a.useMemo)(() => Object.assign({}, A), [A]);
                        return n().createElement(su.Provider, { value: i }, u);
                    };
                var hu = t(6483),
                    fu = t.n(hu),
                    vu = t(926),
                ...
                const yu = {
                        [Su.ExtraSmall]: '',
                        [Su.Small]: xu().SMALL_WIDTH,
                        [Su.Medium]: `${xu().SMALL_WIDTH} ${xu().MEDIUM_WIDTH}`,
                        [Su.Large]: `${xu().SMALL_WIDTH} ${xu().MEDIUM_WIDTH} ${xu().LARGE_WIDTH}`,
                        [Su.ExtraLarge]: `${xu().SMALL_WIDTH} ${xu().MEDIUM_WIDTH} ${xu().LARGE_WIDTH} ${xu().EXTRA_LARGE_WIDTH}`,
                    },
                    Mu = {
                        [Lu.ExtraSmall]: '',
                        [Lu.Small]: xu().SMALL_HEIGHT,
                        [Lu.Medium]: `${xu().SMALL_HEIGHT} ${xu().MEDIUM_HEIGHT}`,
                        [Lu.Large]: `${xu().SMALL_HEIGHT} ${xu().MEDIUM_HEIGHT} ${xu().LARGE_HEIGHT}`,
                        [Lu.ExtraLarge]: `${xu().SMALL_HEIGHT} ${xu().MEDIUM_HEIGHT} ${xu().LARGE_HEIGHT} ${xu().EXTRA_LARGE_HEIGHT}`,
                    },
                    Tu = {
                        [wu.ExtraSmall]: '',
                        [wu.Small]: xu().SMALL,
                    ...
                    Ru = (u) => {
                        ...
                        const r = pu(),
                            ...
                            E = r.mediaHeight,
                            a = r.mediaSize;
                        return n().createElement('div', Hu({ className: fu()(t, yu[F], Mu[E], Tu[a]) }, A), e);
                    },
                    _u = ['children'];
                const Wu = (u) => {
                    let e = u.children,
                    ...
                    return n().createElement(gu, null, n().createElement(Ru, t, e));
                };
                var Iu = t(493),
                    Ou = t.n(Iu);
                t(1281);
                        ...
                        return [
                            function ({ mode: A = 'real', options: r, children: F, mocks: E }) {
                                const i = (0, a.useRef)([]),
                                    D = (t, A, r) => {
                                        ...
                                        const E = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Nu(r.keys()); !(u = t()).done; ) F(u.value, e);
                                                    },
                                                    unsubscribe: F,
                                                };
                                            })(A),
                                            ...
                                            B = { mode: t, model: l, externalModel: a, cleanup: D };
                                        return {
                                            model: l,
                                    ...
                                    o = B[0],
                                    C = B[1],
                                    s = (0, a.useState)(() => D(A, r, E)),
                                    d = s[0],
                                    c = s[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        l.current ? c(D(o, r, E)) : (l.current = !0);
                                    }, [E, o, r]),
                                    (0, a.useEffect)(() => {
                                        C(A);
                                    }, [A]),
                                    ...
                                    n().createElement(t.Provider, { value: d }, F)
                                );
                            },
                            () => (0, a.useContext)(t),
                        ];
                ...
                const ue = (u, e, t = '') => {
                        const A = t.length > 0 ? `_${t}` : t,
                            r = u.$dyn(`c_${e}${A}`),
                            F = String(e).slice(-1),
                            E = u.$dyn(`default_${F}${A}`);
                        return r || E;
                    },
                    ee = (u) => ({
                        backgroundImage: `url(${ue(R.images.gui.maps.icons.battlePass.chapter_choice.commander, u)})`,
                    }),
                    te = (u) => ({
                        backgroundImage: `url(${ue(R.images.gui.maps.icons.battlePass.chapter_choice.tank, u)})`,
                    }),
                    Ae = 'Illustration_base_e1',
                    re = 'Illustration_chapter_6b',
                    Fe = 'Illustration_tank_f9',
                    Ee = ({ chapterID: u }) =>
                        n().createElement(
                            'div',
                            { className: Ae },
                            n().createElement(
                                'div',
                                { className: re, style: ee(u) },
                                n().createElement('div', { className: Fe, style: te(u) }),
                            ),
                        ),
                    ae = 'App_base_92',
                    ne = 'App_title_95',
                    ie = 'App_subTitle_5f',
                    De = R.strings.battle_pass.chapterChoice.confirmation;
                let le;
                !(function (u) {
                    (u.Switch = 'switch'), (u.Select = 'select');
                })(le || (le = {}));
                const Be = (u) => R.strings.battle_pass.chapter.fullName.$num(u),
                    oe = (0, Gu.Pi)(() => {
                        const u = Qu().model.root.get(),
                            e = u.prevChapter,
                            t = u.nextChapter,
                            A = 0 !== e ? le.Switch : le.Select;
                        return n().createElement(
                            'div',
                            { className: ae },
                            n().createElement(Ee, { chapterID: t }),
                            n().createElement(
                                'div',
                                { className: ne },
                                ((u, e) => $u(De.title.$dyn(u), { chName: Be(e) }))(A, t),
                            ),
                            n().createElement(
                                'div',
                                { className: ie },
                                ((u, e) => $u(De.description.$dyn(u), { chName: Be(e) }))(A, e),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
    ...
    (A.m = e),
        ...
        (A.O = (e, t, r, F) => {
            if (!t) {
                ...
                for (D = 0; D < u.length; D++) {
                    for (var [t, r, F] = u[D], a = !0, n = 0; n < t.length; n++)
                        (!1 & F || E >= F) && Object.keys(A.O).every((u) => A.O[u](t[n]))
                            ? t.splice(n--, 1)
                            : ((a = !1), F < E && (E = F));
                    if (a) {
                        u.splice(D--, 1);
            ...
            F = F || 0;
            for (var D = u.length; D > 0 && u[D - 1][2] > F; D--) u[D] = u[D - 1];
            u[D] = [t, r, F];
        }),
        (A.n = (u) => {
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); i < E.length; i++) (F = E[i]), A.o(u, F) && u[F] && u[F][0](), (u[F] = 0);
                    return A.O(D);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t)));
        })();
    var r = A.O(void 0, [1519], () => A(8129));
    r = A.O(r);
})();
