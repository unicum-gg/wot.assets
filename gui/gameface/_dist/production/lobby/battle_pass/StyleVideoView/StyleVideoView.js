(() => {
    ...
    var __webpack_modules__ = {
            ...
            4129: (u, e, t) => {
                ...
                const h = ((u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: F, children: o, mocks: i }) {
                                const a = (0, n.useRef)([]),
                                    D = (t, n, A) => {
                                        var E;
                                        const F = (function ({
                                            ...
                                            B = { mode: t, model: s, externalModel: o, cleanup: D };
                                        return {
                                            model: s,
                                    ...
                                    l = B[0],
                                    v = B[1],
                                    h = (0, n.useState)(() => D(E, F, i)),
                                    w = h[0],
                                    m = h[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        s.current ? m(D(l, F, i)) : (s.current = !0);
                                    }, [i, l, F]),
                                    (0, n.useEffect)(() => {
                                        v(E);
                                    }, [E]),
                                    ...
                                    A().createElement(t.Provider, { value: w }, o)
                                );
                            },
                            () => (0, n.useContext)(t),
                        ];
                        ...
                        ({ observableModel: u }) => {
                            ...
                            return Object.assign({}, e, { computes: { fileName: t } });
                        },
                        ({ externalModel: u }) => ({
                            close: u.createCallbackNoArgs('onClose'),
                            error: u.createCallback((u) => ({ errorFilePath: u }), 'onError'),
                        }),
                    ),
                    w = h[0],
                    m = h[1],
                    b = 'StyleVideo_base_16',
                    f = 'StyleVideo_video_f0',
                    p = 1920,
                    g = 1080,
                    O = (0, s.Pi)(() => {
                        const u = (0, n.useState)(!1),
                            ...
                            F = E.model,
                            r = E.controls,
                            i = F.root.get().isWindowAccessible,
                            s = F.computes.fileName(),
                            C = R.videos.battle_pass.$dyn(`v_${s}`) || '',
                            c = (0, n.useCallback)(() => {
                                e || ((0, D.G)(`bp_style_${s}`), t(!0));
                            }, [s, e]),
                            d = (0, n.useCallback)(() => {
                                r.error(`gui.flash.videos.battle_pass.v_${s}`);
                            }, [r, s]);
                        var l;
                        return (
                            (l = r.close),
                ...
                const C = r,
                    ...
                    _ = F().memo(function ({
                        ...
                        const w = (0, E.useRef)(null),
                            m = ((u) => {
                                const e = (0, E.useState)(c(u ? u.current : null)),
                                    t = e[0],
                                    n = e[1];
                                return (
                                    (0, E.useEffect)(() => {
                            ...
                            T = (0, E.useCallback)(() => {
                                ...
                                u &&
                                    (r
                                        ? ((u.currentTime = u.duration - D), u.removeEventListener('play', y), u.play())
                                        : (u.pause(), _ && _()));
                            }, [u, y, r, D, _]);
                        return (
                            (0, E.useEffect)(() => {
                                const u = w.current;
                                return (
                                    u && (u.addEventListener('play', y), u.addEventListener('ended', T)),
                                    () => {
                                        u && (u.removeEventListener('play', y), u.removeEventListener('ended', T));
                                    }
                                );
                            }, [u, T, y]),
                            (0, E.useEffect)(() => {
                                ...
                                u && (i ? u.pause() : u.play());
                                const e = setInterval(() => {
                                    u && v && v(a ? Math.round(u.currentTime) : u.currentTime);
                                }, 100);
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(4129));
