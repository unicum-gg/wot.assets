(() => {
    var __webpack_modules__ = {
            ...
            5846: (u, e, t) => {
                ...
                const P = {
                    ...
                    x = (u) => {
                        ...
                        const n = f(),
                            ...
                            i = n.mediaHeight,
                            o = n.mediaSize;
                        return r().createElement('div', S({ className: g()(t, P[s], y[i], L[o]) }, a), e);
                    },
                    O = ['children'];
                const M = (u) => {
                    let e = u.children,
                ...
                const z = ((u, e) => {
                        ...
                        ({ observableModel: u }) => {
                            const e = {
                                    ...
                                    canToOpenAdditionView: H.LO.box(!1),
                                },
                                ...
                                o = (0, q.Om)(() => i().length),
                                l = (0, q.Om)(() => o() > 0),
                                E = (0, q.Om)(() => Y(e.mainRewards.get(), U), { equals: G }),
                                c = (0, q.Om)(() => {
                                    const u = E();
                                ...
                                D = [I.BUY_BATTLE_PASS_LEVELS, I.BUY_BATTLE_PASS_WITH_LEVELS, I.DEFAULT].includes(
                                    e.root.get().reason,
                                ),
                                m = (0, q.Om)(() => {
                                    const u = e.root.get(),
                        ...
                        ({ model: u, externalModel: e }) => ({
                            enableToOpenAdditionView: (0, H.aD)(() => {
                ...
                const Lu = [
                        ...
                        wu.NaturalCover,
                        wu.BpCoin,
                        wu.BattlePassSelectToken,
                        wu.BattlaPassFinalAchievement,
                        wu.BattleBadge,
                        wu.BattlePassTicket,
                        wu.BonusX5,
                        wu.CrewBonusX3,
                        wu.EpicSelectToken,
                        wu.Comp7TokenWeeklyReward,
                        wu.DeluxeGift,
                        wu.ModernizedDevicesT1Gift,
                        wu.ModernizedDevicesT2Gift,
                        wu.ModernizedDevicesT3Gift,
                        wu.BattleBoosterGift,
                        wu.OptionalDevice,
                    ],
                    xu = [wu.Gold, wu.Credits, wu.Crystal, wu.FreeXp],
                    Ou = [wu.BattlePassPoints, wu.EquipCoin],
                    Mu = [wu.PremiumPlus, wu.Premium],
                    ku = ['engravings', 'backgrounds'],
                    Nu = ['engraving', 'background'],
                    Iu = (u, e = vu.Small) => {
                        const t = u.name,
                            a = u.type,
                            r = u.value,
                        ...
                        const h = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                                ...
                                () =>
                                    ...
                                    ((u = 1) => {
                                        ...
                                        return (
                                            ...
                                            { callerUrl: r, caller: t, stack: e, resId: a }
                                        );
                                    })().resId,
                                [B],
                            ),
                            b = (0, a.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Wu(t, F, { isMouseEvent: !0, on: !0, arguments: Hu(r) }, w),
                                    C && C(),
                ...
                const Zu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return r().createElement(Ku, e, a);
                        const n = e.contentId;
                        return n ? r().createElement($u, Qu({}, e, { contentId: n }), a) : r().createElement(qu, e, a);
                    },
                    Ju = {
                        base: 'Reward_base_ea',
                    ...
                    ue = ({
                        ...
                        const F = ((u, e) => {
                                if (void 0 === e || !Uu.includes(u)) return null;
                                switch (e) {
                            ...
                            D = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case fu.CURRENCY:
                                    case fu.NUMBER:
                                        return r().createElement(yu, { format: 'integral', value: Number(u) });
                        ...
                        return r().createElement(
                            'div',
                            { className: g()(Ju.base, Ju[`base__${a}`], E), style: l },
                            r().createElement(
                                Zu,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: g()(Ju.image, null == c ? void 0 : c.image) },
                                        F &&
                                            r().createElement('div', {
                                                className: g()(Ju.highlight, null == c ? void 0 : c.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: g()(Ju.icon, null == c ? void 0 : c.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        _ &&
                                            r().createElement('div', {
                                                className: g()(Ju.overlay, null == c ? void 0 : c.overlay),
                                                style: {
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: g()(
                                                    Ju.info,
                                                    Ju[`info__${u}`],
                                                    i === fu.MULTI && Ju.info__multi,
                                                    null == c ? void 0 : c.info,
                                                ),
                                            },
                                            D,
                                        ),
                                    o && r().createElement('div', { className: Ju.title }, o),
                                ),
                            ),
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: d },
                                    r().createElement('div', {
                                        className: g()(Ju.timer, null == c ? void 0 : c.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const se = (u) => Math.sqrt(1 - Math.pow(u - 1, 2)),
                    ...
                    Fe = (0, Du.Pi)(({ rewards: u, pageNumber: e, className: t }) => {
                        const a = X().model.canToOpenAdditionView.get(),
                            n = f().mediaSize >= w.Large ? vu.Big : vu.Small,
                            s = 1 === e ? 1600 - (a ? 800 : 0) : 100,
                            i = (0, ee.useTransition)(u, {
                ...
                const Be = ({
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    s ||
                                        (null !== l && K(l),
                                        A && A(u),
                                        t && (s || (D.current && (D.current.focus(), C(!0)))),
                                        w(!0));
                                },
                            ...
                            r().createElement(
                                'span',
                                { className: g()(_e.state, _e.state__default) },
                ...
                const pe = (u = {}) => {
                    ...
                    Pe = 'Banner_buttonGlow_e9',
                    ye = R.strings.battle_pass.battlePassAwardsView.footer,
                    Le = (0, Du.Pi)(({ className: u, parentRef: e }) => {
                        const t = X(),
                            a = t.model,
                            n = t.controls,
                            s = a.root.get(),
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: ve },
                                    r().createElement('div', { className: fe }, ye.bpTitle()),
                                    r().createElement(
                                        'div',
                                        { className: Te },
                                        o >= 45 ? ye.bpLastStagesTitle() : ye.bpInProgressTitle(),
                                    ),
                                ),
                            ),
                            r().createElement(
                    ...
                    xe = 'Footer_base_a9',
                    Oe = 'Footer_base__withPostProgressionPath_86',
                    Me = 'Footer_postProgressionInfo_a1',
                    ke = 'Footer_lockImage_89',
                    Ne = 'Footer_title_79',
                    Ie = 'Footer_title__highlight_36',
                    Ue = 'Footer_buttonContainer_64',
                    Ge = 'Footer_postProgressionButton_a3',
                    He = R.strings.battle_pass.battlePassAwardsView,
                    We = (0, Du.Pi)(({ button: u, className: e }) => {
                            ...
                            F = ((u, e, t) => {
                                switch (u) {
                                    case I.BUY_BATTLE_PASS:
                                        return ou(He.mainReward.bpBuyAwardsCaption(), {
                                            chapter: R.strings.battle_pass.chapter.fullName.$num(e),
                                        });
                                    case I.BUY_BATTLE_PASS_WITH_LEVELS:
                                        return ou(He.mainReward.bpBuyWithLevels(), {
                                            chapter: R.strings.battle_pass.chapter.fullName.$num(e),
                                        });
                                    case I.BUY_MULTIPLE_BATTLE_PASS:
                                        return He.footer.allChaptersText();
                                    case I.STYLE_UPGRADE:
                                        return t ? He.footer.bpDescriptionGotStyle() : '';
                                    default:
                                        return '';
                                }
                            })(o, l, E),
                        ...
                        return r().createElement(
                            'div',
                            { className: g()(xe, e, c && Oe) },
                            A
                                ? r().createElement(
                                      'div',
                                      { className: Me },
                                      r().createElement('div', { className: ke }),
                                      r().createElement('div', null, He.footer.postProgressionText()),
                                  )
                                : Boolean(F.length) && r().createElement('div', { className: g()(Ne, d && Ie) }, F),
                            r().createElement(
                                'div',
                                { className: Ue },
                                r().createElement(
                                    Ce,
                                    { type: De.primary, size: _ ? me.medium : me.small, onClick: u.onClick },
                                    u.text,
                                ),
                                A &&
                                    ...
                                    r().createElement(
                                        ...
                                        {
                                            type: De.secondary,
                                            size: _ ? me.medium : me.small,
                                            onClick: n.onShowPostProgression,
                                            mixClass: Ge,
                                        },
                                        He.footer.postProgressionButton(),
                                    ),
                            ),
                        );
                    }),
                    ...
                    qe = (0, Du.Pi)(() => {
                        const u = X().model,
                            ...
                            t = (() => {
                                ...
                                return { backgroundImage: `url(${$e(t, { name: 'bp_icon' })})` };
                            })();
                        return r().createElement('div', { className: Ye, style: t });
                    }),
                    ze = 'Glow_base_92',
                    je = 'Glow_glow_02',
                    Xe = ({ className: u }) =>
                ...
                var Je = t(9690);
                const ut = { base: 'TankName_base_d5', base__wide: 'TankName_base__wide_c6', type: 'TankName_type_4d' },
                    et = (u, e) => ({
                        backgroundImage: `url(${`R.images.gui.maps.icons.vehicleTypes.big.${`${u.replace('-', '_')}${e ? '_elite' : ''}`}`})`,
                    }),
                    tt = ({ isElite: u, vehicleName: e, vehicleType: t, vehicleLvl: a, isWide: n }) =>
                        r().createElement(
                            'div',
                            { className: g()(ut.base, n && ut.base__wide) },
                            r().createElement('div', { className: ut.level }, (0, Je.HG)(a)),
                            r().createElement('div', { className: ut.type, style: et(t, u) }),
                            r().createElement('div', { className: ut.name }, e),
                        ),
                    at = 'FormatText_base_d0',
                    rt = ({ binding: u, text: e = '', classMix: t, alignment: n = su.left, formatWithBrackets: s }) => {
                    ...
                    nt = 'text_textCenter_78',
                    st = R.strings.battle_pass,
                    it = ({ type: u, value: e }) => {
                        switch (u) {
                            case wu.BattlaPassFinalAchievement:
                                return r().createElement(rt, {
                                    text: st.battlePassAwardsView.mainReward.reward(),
                                    binding: { name: e },
                                });
                            case wu.TmanToken:
                                return r().createElement(rt, {
                                    classMix: nt,
                                    text: st.battlePassAwardsView.mainReward.commander(),
                                    binding: { name: e },
                                });
                            case wu.Gold:
                            case wu.Credits:
                            case wu.Crystal:
                            case wu.EquipCoin:
                                return r().createElement(yu, { format: 'integral', value: Number(e) });
                            default:
                    ...
                    Et = ({ reward: u, size: e, className: t }) => {
                        const a = u.name,
                            n = u.userName,
                            s = u.vehicleLvl,
                            i = u.vehicleName,
                        ...
                        return r().createElement(
                            'div',
                            { className: g()(ot.base, ot[`base__${e}`], ot[`base__${a}`], t) },
                            r().createElement(
                                'div',
                                { className: ot.title },
                                c && s && i && o
                                    ...
                                    : r().createElement(it, { type: a, value: n }),
                            ),
                            E && r().createElement('div', { className: ot.subtitle }, lt.common.collectionText()),
                        );
                    },
                    ct = {
                        base: 'Reward_base_14',
                ...
                const Ft = [wu.BattlaPassFinalAchievement, wu.TmanToken, wu.Vehicles],
                    _t = [
                        Qe.credits,
                        Qe.gold,
                        Qe.crystal,
                    ...
                    Dt = (0, Du.Pi)(({ reward: u, rewardListIndex: e }) => {
                        const t = X().model,
                            ...
                            A = u.userName,
                            d = u.value,
                            F = ((_ = c), !_t.includes(_) && Number(d) > 1);
                        var _;
                        const D = ((u) => Ft.includes(u))(c) || (A && A.length > 0),
                            m = () => (n ? (1 === s || 1 === e ? dt.Wide : dt.Small) : dt.Normal);
                        return r().createElement(
                            'div',
                            { className: g()(ct.base, ct[`base__${m()}`], a && ct.base__updateAnimation) },
                            r().createElement(
                                $u,
                                { ignoreShowDelay: !0, contentId: Number(l), args: { tooltipId: E } },
                                r().createElement(
                                    'div',
                                    { className: ct.imageWrapper },
                                    r().createElement('div', { className: ct.image, style: ie(i, o) }),
                                    F &&
                                        r().createElement(
                                            'div',
                                            { className: ct.count },
                                            ou(At.common.multiplier(), { multiplier: d }),
                                        ),
                                ),
                            ),
                            D && r().createElement(Et, { reward: u, size: m(), className: ct.title }),
                        );
                    }),
                    mt = 'Rewards_base_05',
                    ...
                    ht = (0, Du.Pi)(() => {
                        const u = X().model,
                            ...
                            l = (() => {
                                ...
                                return {
                                    backgroundImage: `url(${$e(u, { name: 'ribbon', postfix: `${o}${t ? '_with_bp' : ''}` })})`,
                                };
                            })();
                        return r().createElement('div', { className: g()(gt, i && pt), style: l });
                    }),
                    wt = 'MainRewards_base_ad',
                    bt = 'MainRewards_glow_61',
                    vt = 'MainRewards_rays_20',
                    ft = (0, Du.Pi)(({ className: u }) => {
                        const e = X().model,
                        ...
                        return r().createElement(
                            'div',
                            { className: g()(wt, u) },
                            s && !t && r().createElement(Xe, { className: bt }),
                    ...
                    Tt = 'RewardsApp_base_94',
                    Rt = 'RewardsApp_overlay_88',
                    St = 'RewardsApp_overlay__common_ff',
                    Pt = 'RewardsApp_main_72',
                    yt = 'RewardsApp_close_c1',
                    Lt = 'RewardsApp_content_59',
                    xt = 'RewardsApp_header_6c',
                    Ot = 'RewardsApp_rewards_62',
                    Mt = 'RewardsApp_rewards__additionalCentring_f7',
                    kt = 'RewardsApp_additionalRewards_ba',
                    Nt = 'RewardsApp_additionalRewards__diffTop_ff',
                    It = 'RewardsApp_additionalRewards__slideTop_da',
                    Ut = 'RewardsApp_base__buyWithLevels_ae',
                    Gt = 'RewardsApp_additionalRewards__animateSlide_6c',
                    Ht = 'RewardsApp_additionalRewards__indentS_b4',
                    Wt = 'RewardsApp_mainRewards_18',
                    $t = 'RewardsApp_mainRewards__slideTop_ed',
                    Vt = 'RewardsApp_mainRewards__animateSlide_a7',
                    Yt = 'RewardsApp_footer_1f',
                    qt = 'RewardsApp_footer__hide_82',
                    zt = 'RewardsApp_footer__diffTop_1f',
                    jt = 'RewardsApp_banner_25',
                    Xt = 'RewardsApp_banner__showPreparation_5c',
                    Kt = R.strings.battle_pass,
                    Qt = (u) =>
                        u
                            ? ou(Kt.battlePassAwardsView.header.bpTitle(), {
                                  chapter: Kt.chapter.fullNameUppercased.$num(u),
                              })
                            : Kt.battlePassAwardsView.header.bpTitleWithoutChapter(),
                    Zt = (u, e) => {
                        switch (u) {
                            case I.BUY_BATTLE_PASS:
                            case I.BUY_MULTIPLE_BATTLE_PASS:
                        ...
                        return console.warn('Unknown title reason: ', u), Qt(e);
                    },
                    Jt = (u, e, t) => {
                        switch (u) {
                            case I.BUY_BATTLE_PASS:
                    ...
                    ua = (u, e, t, a, r, n) => {
                        const s = ((u, e, t) =>
                            t
                                ...
                                : u
                                  ? ou(Kt.battlePassAwardsView.additionalRewards.bpRemainLevelsAwardsText(), {
                        ...
                        return { onClick: n, text: s, hasPostProgressionButton: !u && !r };
                    },
                    ea = (0, Du.Pi)(() => {
                        const u = X(),
                            e = u.model,
                            ...
                            m = e.computes.isReasonBuyWithLevels(),
                            B = e.computes.isReasonStyleUpgrade(),
                            C = e.computes.hasPostProgressionBanner(),
                        ...
                        const k = { title: Zt(i, o), subtitle: Jt(i, l, E) },
                            N = d.slice(10 * (b - 1), 10 * b),
                            I = N.length,
                            U = Math.ceil(F / 10),
                            G = b < U,
                            H = U > 1,
                        ...
                        const z = ua(x, F, b, I, G, () => {
                                x ? t.enableToOpenAdditionView() : G ? v(b + 1) : t.close();
                            }),
                            j = p && _,
                            K = {
                                backgroundImage: o
                                    ? `url(${pu(R.images.gui.maps.icons.battlePass.backgrounds.chapter_general, o)})`
                                    : 'url(R.images.gui.maps.icons.battlePass.backgrounds.common)',
                                '--banner-height': O,
                            };
                        return r().createElement(
                            'div',
                            { className: g()(Tt, m && A && Ut), style: K },
                            r().createElement('div', { className: g()(Rt, !o && St) }),
                            r().createElement(
                                'div',
                                { className: Pt },
                                r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: xt },
                                        r().createElement(hu.h, { title: k.title, status: k.subtitle }),
                                    ),
                                    r().createElement(
                                        'div',
                                        { className: g()(Ot, j && Mt) },
                                        r().createElement(ft, { className: g()(Wt, $ && $t, $ && !y && Vt) }),
                                        _ &&
                                            r().createElement(Fe, {
                                                rewards: N,
                                                pageNumber: b,
                                                className: g()(kt, p && Ht, A && Nt, $ && It, $ && !y && Gt),
                                            }),
                                    ),
                                ),
                                V && r().createElement(We, { button: z, className: g()(Yt, $ && qt, !W && zt) }),
                                W && r().createElement(Le, { className: g()(jt, H && Xt), parentRef: Y }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    N().render(
                        r().createElement(j, null, r().createElement(M, null, r().createElement(ea, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(5846));
