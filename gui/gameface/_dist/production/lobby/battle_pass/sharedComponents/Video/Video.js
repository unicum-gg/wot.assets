(() => {
            ...
            6123: (u, e, A) => {
                ...
                n().memo(function ({
                    ...
                    const w = (0, t.useRef)(null),
                        m = ((u) => {
                            const e = (0, t.useState)(_(u ? u.current : null)),
                                A = e[0],
                                F = e[1];
                            return (
                                (0, t.useEffect)(() => {
                        ...
                        O = (0, t.useMemo)(() => {
                            const u = ((u, e, A, F) => {
                                const E = u / e;
                                return A / F > E
                                    ? { width: A, height: Math.round(A / E) }
                                    : { width: Math.round(F * E), height: F };
                            })(A, F, f, g);
                        ...
                        P = (0, t.useCallback)(() => {
                            ...
                            u &&
                                (D
                                    ? ((u.currentTime = u.duration - B), u.removeEventListener('play', T), u.play())
                                    : (u.pause(), l && l()));
                        }, [u, T, D, B, l]);
                    return (
                        (0, t.useEffect)(() => {
                            const u = w.current;
                            return (
                                u && (u.addEventListener('play', T), u.addEventListener('ended', P)),
                                () => {
                                    u && (u.removeEventListener('play', T), u.removeEventListener('ended', P));
                                }
                            );
                        }, [u, P, T]),
                        (0, t.useEffect)(() => {
                            ...
                            u && (r ? u.pause() : u.play());
                            const e = setInterval(() => {
                                u && v && v(o ? Math.round(u.currentTime) : u.currentTime);
                            }, 100);
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(6123));
