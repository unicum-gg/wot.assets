(() => {
    var __webpack_modules__ = {
            ...
            6616: (u, e, t) => {
                ...
                const s = n.O.client.getSize('rem'),
                    D = s.width,
                    o = s.height,
                    l = Object.assign({ width: D, height: o }, F(D, o, A)),
                ...
                const c = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.largeWidth && o) return r(e, t, w);
                ...
                const _ = (u) => {
                    ...
                    d = (0, a.memo)(({ children: u }) => {
                        ...
                        return E().createElement(B.Provider, { value: D }, u);
                    });
                var m = t(6483),
                    h = t.n(m),
                    g = t(926),
                ...
                const b = () => {
                        ...
                        return { mediaSize: E, mediaWidth: r, mediaHeight: n, remScreenWidth: e, remScreenHeight: t };
                    },
                ...
                const S = {
                    ...
                    y = (u) => {
                        ...
                        const r = b(),
                            ...
                            A = r.mediaHeight,
                            i = r.mediaSize;
                        return E().createElement('div', L({ className: h()(t, S[n], M[A], T[i]) }, a), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                    ...
                    const c = (0, a.useRef)(null),
                        ...
                        H = h()(
                            ...
                            I[`base__${r}`],
                            {
                                ...
                                [I[`base__${e}`]]: e,
                                [I.base__focus]: d,
                                [I.base__highlightActive]: v,
                                [I.base__firstHover]: f,
                            },
                            A,
                        ),
                        N = h()(I.state, I.state__default);
                    return (
                        (0, a.useEffect)(
                            () => (
                        ...
                        E().createElement(
                            ...
                            r !== W.ghost &&
                                E().createElement(
                                    E().Fragment,
                                    null,
                                    E().createElement('div', { className: I.back }),
                                    E().createElement('span', { className: I.texture }),
                                ),
                            E().createElement(
                                'span',
                                { className: N },
                                E().createElement('span', { className: I.stateDisabled }),
                                E().createElement('span', { className: I.stateHighlightHover }),
                                E().createElement('span', { className: I.stateHighlightActive }),
                            ),
                            E().createElement(
                                'span',
                ...
                const K = (u, e, t) => {
                    ...
                    Y = (u, e, t = z.left) => u.split(e).reduce(t === z.left ? K : q, []),
                    X = (() => {
                        const u = new RegExp(
                        ...
                        return Z.includes(t)
                            ...
                            : ((u, e = z.left) => {
                                  ...
                                  const a =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (Y(E, /( )/, e).forEach((u) => (t = t.concat(Y(u, a, z.left)))), t);
                              })(u, e);
                    },
                    J = 'FormatText_base_d0',
                    uu = ({ binding: u, text: e = '', classMix: t, alignment: r = z.left }) =>
                        null === e
                ...
                class Eu extends E().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()(eu.base, eu[`base__${n}`], eu[`base__${r}`], null == A ? void 0 : A.base),
                            B = h()(eu.icon, eu[`icon__${n}`], eu[`icon__${r}`], null == A ? void 0 : A.icon),
                            C = h()(eu.glow, null == A ? void 0 : A.glow),
                            c = h()(eu.caption, eu[`caption__${n}`], null == A ? void 0 : A.caption),
                            _ = h()(eu.goto, null == A ? void 0 : A.goto);
                ...
                const Au = (u = 1) => {
                    ...
                    iu = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    Fu = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    su = (u, e) => (u.length > 0 ? `${u}.${e}` : e),
                    Du = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const a = iu(`${u}.${t}`, window);
                    ...
                    ou = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: E, modelPath: su(E, u || ''), resId: a };
                            })(),
                            t = e.modelPrefix,
                            a = u.split('.');
                        if (a.length > 0) {
                            ...
                            return (
                                a.reduce((e, a) => {
                                    const E = iu(su(t, `${e}.${a}`), window);
                                    return Fu(E) ? (u.push(E.id), `${e}.${a}.value`) : (u.push(a), `${e}.${a}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        _(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    a = ou(u);
                                o.current = lu.addCallback(a, t, A, e === Bu.Deep);
                            }
                        }),
                        (0, a.useEffect)(() => {
                            if (e !== Bu.None)
                                return () => {
                                    lu.removeCallback(o.current, A);
                                };
                        }, [A, e]),
                        s
                    );
                ...
                function du(u = cu.n.NONE, e = _u, t = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== cu.n.NONE)
                            return (
                ...
                const hu = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                ...
                const xu = ({
                        ...
                        const l = `${((B = a), B.replace(/-/g, '_'))}${u ? '_elite' : ''}`;
                        var B;
                        const C = R.images.gui.maps.icons.vehicleTypes.big.$dyn(l);
                        return E().createElement(
                            'div',
                            {
                                className: h()(
                                    ...
                                    n &&
                                        ((c = n),
                                        (_ = (u) => pu[`base__tag${j(u)}`]),
                                        Array.isArray(c)
                                            ? c.map(_)
                                            : c.map((u, e, t) => _(null == u ? void 0 : u.value, e, t))),
                                    s,
                                ),
                            },
                            E().createElement('div', { className: h()(pu.level, null == D ? void 0 : D.level) }, wu(r)),
                            E().createElement('div', {
                                className: h()(pu.type, u && pu.type__elite, null == D ? void 0 : D.typeIcon),
                                style: { backgroundImage: `url(${C})` },
                            }),
                            A && E().createElement('div', { className: pu.premiumIGR }),
                            E().createElement(
                                'div',
                                { className: h()(pu.name, null == D ? void 0 : D.name) },
                                o ? t : e,
                            ),
                        );
                        var c, _;
                    ...
                    ku = 'Header_base_f4',
                    Hu = 'Header_title_0a',
                    Nu = 'Header_description_85',
                    Ru = ({ title: u, description: e }) =>
                        E().createElement(
                            'div',
                            { className: ku },
                            E().createElement('div', { className: Hu }, u),
                            E().createElement('div', { className: Nu }, e),
                        ),
                    Pu = 'Progression_base_20',
                    Iu = 'Progression_title_5c',
                    Wu = 'Progression_name_8e',
                    Uu = 'Progression_description_fc',
                    Gu = ({ title: u, name: e, description: t }) =>
                        E().createElement(
                            'div',
                            { className: Pu },
                            E().createElement('div', { className: Iu }, u),
                            E().createElement('div', { className: Wu }, e),
                            E().createElement('div', { className: Uu }, t),
                        );
                function $u() {
                    return (
                        ($u =
                ...
                const zu = R.strings.battle_pass.extraIntroView,
                    Vu = () => {
                        const u = Cu('model'),
                            e = u.vehicleInfo,
                            t = u.styleName,
                            ...
                            C = (0, a.useCallback)(() => {
                                (s(!1),
                                    n.O.view.setEventHandled(),
                                    B.run(() => {
                                        r();
                                    }, 500));
                            }, [r, B]);
                        var c;
                        ((c = () => C()), du(cu.n.ESCAPE, c));
                        ...
                        const d = V(zu.premium3dStyleVechicle(), { styleName: t }),
                            m = V(zu.premiumProgressionDescription(), { vehicleName: e.vehicleName, styleName: t }),
                            g = h()(Lu, F && Su);
                        return E().createElement(
                            'div',
                            { className: g },
                            ...
                            E().createElement(
                                ...
                                E().createElement(Ru, {
                                    title: zu.title(),
                                    description: E().createElement(uu, {
                                        text: zu.titleDescription(),
                                        binding: { vehicleName: E().createElement(xu, $u({}, e, { type: bu.white })) },
                                    }),
                                }),
                            ),
                            E().createElement(
                                ...
                                E().createElement(Gu, {
                                    ...
                                    name: e.vehicleName,
                                    description: zu.freeProgressionDescription(),
                                }),
                                E().createElement(Gu, { title: zu.premiumProgression(), name: d, description: m }),
                            ),
                            E().createElement(
                                $,
                                {
                ...
                engine.whenReady.then(() => {
                    N().render(
                        E().createElement(k, null, E().createElement(Vu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(6616));
