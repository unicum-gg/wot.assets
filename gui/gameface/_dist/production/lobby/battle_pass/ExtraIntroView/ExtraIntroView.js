(() => {
    var __webpack_modules__ = {
            ...
            6108: (u, e, t) => {
                ...
                const s = i.O.client.getSize('rem'),
                    o = s.width,
                    D = s.height,
                    l = Object.assign({ width: o, height: D }, F(o, D, E)),
                ...
                const C = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && o) return r(e, t, p);
                        if (t.largeWidth && D) return r(e, t, p);
                        if (t.mediumWidth && l) return r(e, t, p);
                ...
                const d = (u) => {
                    ...
                    _ = ({ children: u }) => {
                        ...
                        d(() => {
                            i.O.client.events.on('clientResized', s), i.O.client.events.on('self.onScaleUpdated', o);
                        }),
                            (0, a.useEffect)(
                                () => () => {
                    ...
                    eu = (u, e = z.left) => {
                        ...
                        return ((u, e = z.left) => {
                            ...
                            const a =
                                ...
                                n = Y(u);
                            return Q(n, /( )/, e).forEach((u) => (t = t.concat(Q(u, a, z.left)))), t;
                        })(u, e);
                    },
                    tu = 'FormatText_base_d0',
                    au = ({ binding: u, text: e = '', classMix: t, alignment: r = z.left, formatWithBrackets: i }) => {
                ...
                class Eu extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()(nu.base, nu[`base__${i}`], nu[`base__${r}`], null == E ? void 0 : E.base),
                            B = h()(nu.icon, nu[`icon__${i}`], nu[`icon__${r}`], null == E ? void 0 : E.icon),
                            c = h()(nu.glow, null == E ? void 0 : E.glow),
                            C = h()(nu.caption, nu[`caption__${i}`], null == E ? void 0 : E.caption),
                            d = h()(nu.goto, null == E ? void 0 : E.goto);
                        return n().createElement(
                            'div',
                            iu(
                                {
                            ...
                            'info' !== i && n().createElement('div', { className: nu.shine }),
                ...
                function su(u = Au.n.NONE, e = Fu, t = !1, n = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== Au.n.NONE)
                            return (
                ...
                var ou = t(3403);
                var Du = t(9690);
                const lu = (u, e) => u.split(',').includes(e),
                    Bu = {
                ...
                const du = ({
                    ...
                    vehicleLvl: r,
                    tags: i = '',
                    size: E = cu.extraSmall,
                    type: A = Cu.colored,
                    className: F,
                    classNames: s,
                    isShortName: o = !1,
                }) => {
                    const D = `${((l = a), l.replace(/-/g, '_'))}${u ? '_elite' : ''}`;
                    var l;
                    const B = R.images.gui.maps.icons.vehicleTypes.big.$dyn(D);
                    return n().createElement(
                        'div',
                        { className: h()(Bu.base, Bu[`base__size${K(E)}`], Bu[`base__type${K(A)}`], F) },
                        n().createElement(
                            'div',
                            { className: h()(Bu.level, null == s ? void 0 : s.level) },
                            (0, Du.HG)(r),
                        ),
                        n().createElement('div', {
                            className: h()(
                                Bu.type,
                                u && Bu[`type__elite${K(E)}`],
                                Bu[`type__${E}`],
                                null == s ? void 0 : s.typeIcon,
                            ),
                            style: a ? { backgroundImage: `url(${B})` } : void 0,
                        }),
                        lu(i, 'premiumIGR') && n().createElement('div', { className: Bu.premiumIGR }),
                        n().createElement('div', { className: h()(Bu.name, null == s ? void 0 : s.name) }, o ? t : e),
                    );
                };
                function _u() {
                    return !1;
                ...
                const pu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: E, children: A, mocks: F }) {
                                const s = (0, a.useRef)([]),
                                    o = (t, a, n) => {
                                        var r;
                                        const E = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = hu(n.keys()); !(u = t()).done; ) r(u.value, e);
                                                    },
                                                    unsubscribe: r,
                                                };
                                            })(a),
                                            ...
                                            l = { mode: t, model: D, externalModel: A, cleanup: o };
                                        return {
                                            model: D,
                                    ...
                                    B = l[0],
                                    c = l[1],
                                    C = (0, a.useState)(() => o(r, E, F)),
                                    d = C[0],
                                    _ = C[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        D.current ? _(o(B, E, F)) : (D.current = !0);
                                    }, [F, B, E]),
                                    (0, a.useEffect)(() => {
                                        c(r);
                                    }, [r]),
                    ...
                    Ou = 'Header_base_f4',
                    Mu = 'Header_title_0a',
                    ku = 'Header_description_85',
                    Ru = ({ title: u, description: e }) =>
                        n().createElement(
                            'div',
                            { className: Ou },
                            n().createElement('div', { className: Mu }, u),
                            n().createElement('div', { className: ku }, e),
                        ),
                    Hu = 'Progression_base_20',
                    Nu = 'Progression_title_5c',
                    Pu = 'Progression_name_8e',
                    Wu = 'Progression_description_fc',
                    Iu = ({ title: u, name: e, description: t }) =>
                        n().createElement(
                            'div',
                            { className: Hu },
                ...
                const Uu = R.strings.battle_pass.extraIntroView,
                    ju = (0, ou.Pi)(() => {
                        const u = bu(),
                            e = u.controls,
                            t = u.model,
                        ...
                        var B;
                        (B = () => l()), su(Au.n.ESCAPE, B);
                        const c = (0, a.useCallback)(() => {
                            o || (e.onViewLoaded(), F(!0), D(!0));
                        }, [o, e]);
                        (0, a.useEffect)(
                            () =>
                                ((u) => {
                        ...
                        const C = { vehicleName: n().createElement(du, Gu({}, i, { type: Cu.white })) },
                            d = q(Uu.premium3dStyleVechicle(), { styleName: r }),
                            _ = q(Uu.premiumProgressionDescription(), { vehicleName: i.vehicleName, styleName: r });
                        return n().createElement(
                            'div',
                            { className: h()(wu, A && xu) },
                            n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement(Ru, {
                                    title: Uu.title(),
                                    description: n().createElement(au, { text: Uu.titleDescription(), binding: C }),
                                }),
                            ),
                            n().createElement(
                                'div',
                                { className: Su },
                                n().createElement(Iu, {
                                    title: Uu.freeProgression(),
                                    name: i.vehicleName,
                                    description: Uu.freeProgressionDescription(),
                                }),
                                n().createElement(Iu, { title: Uu.premiumProgression(), name: d, description: _ }),
                            ),
                            n().createElement(
                                j,
                                {
                ...
                engine.whenReady.then(() => {
                    N().render(
                        n().createElement(fu, null, n().createElement(k, null, n().createElement(ju, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(6108));
