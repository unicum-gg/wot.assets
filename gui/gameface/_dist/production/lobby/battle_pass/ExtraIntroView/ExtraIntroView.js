(() => {
    var __webpack_modules__ = {
            ...
            7475: (u, e, t) => {
                ...
                var n = t(3157),
                    a = t(8133),
                    r = t(3925);
                const E = { view: t(7553), client: n, sound: r.ZP, intl: a.N };
            },
            8133: (u, e, t) => {
                'use strict';
                t.d(e, { N: () => n });
            ...
            198: (u, e, t) => {
                ...
                (0, n.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && l) return r(e, t, f);
                        if (t.largeWidth && c) return r(e, t, f);
                        if (t.mediumWidth && B) return r(e, t, f);
                        if (t.smallWidth && C) return r(e, t, f);
                        if (t.extraSmallWidth && d) return r(e, t, f);
                        if (
                ...
                const f = {
                    ...
                    w = (u) => {
                        ...
                        const r = h(),
                            ...
                            i = r.mediaHeight,
                            A = r.mediaSize;
                        return a().createElement('div', v({ className: c()(t, f[E], p[i], b[A]) }, n), e);
                    },
                    x = ['children'];
                const y = (u) => {
                    let e = u.children,
                    ...
                    return a().createElement(D, null, a().createElement(w, t, e));
                };
                var L = t(1533),
                    T = t.n(L);
                let S = (function (u) {
                ...
                const $ = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    V = (u, e, t = I.left) => u.split(e).reduce(t === I.left ? z : j, []),
                    q = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Z = ({ binding: u, text: e = '', classMix: t, alignment: r = I.left, formatWithBrackets: E }) => {
                ...
                const eu = (u) => {
                    ...
                    return a().createElement(
                        ...
                        uu(
                            {
                                className: c()(Q.base, Q[`base__${C}`], Q[`base__${l}`], null == i ? void 0 : i.base),
                                onMouseEnter: v,
                                onMouseLeave: f,
                                onMouseDown: p,
                                onMouseUp: b,
                        ...
                        'info' !== C && a().createElement('div', { className: Q.shine }),
                        a().createElement(
                            'div',
                            { className: c()(Q.icon, Q[`icon__${C}`], Q[`icon__${l}`], null == i ? void 0 : i.icon) },
                            a().createElement('div', { className: c()(Q.glow, null == i ? void 0 : i.glow) }),
                        ),
                        a().createElement(
                            'div',
                            { className: c()(Q.caption, Q[`caption__${C}`], null == i ? void 0 : i.caption) },
                            e,
                        ),
                        r && a().createElement('div', { className: c()(Q.goto, null == i ? void 0 : i.goto) }, r),
                    );
                };
                var tu = t(4020);
                t(828);
                ...
                function au(u = tu.n.NONE, e = nu, t = !1, a = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== tu.n.NONE)
                            return (
                ...
                var ru = t(2041);
                var Eu = t(1308);
                const iu = (u, e) => u.split(',').includes(e),
                    Au = {
                ...
                const su = ({
                    ...
                    const D = `${((l = n), l.replace(/-/g, '_'))}${u ? '_elite' : ''}`;
                    var l;
                    const B = R.images.gui.maps.icons.vehicleTypes.big.$dyn(D);
                    return a().createElement(
                        'div',
                        { className: c()(Au.base, Au[`base__size${U(i)}`], Au[`base__type${U(A)}`], F) },
                        a().createElement(
                            'div',
                            { className: c()(Au.level, null == o ? void 0 : o.level) },
                            (0, Eu.HG)(r),
                        ),
                        a().createElement('div', {
                            className: c()(
                                Au.type,
                                u && Au[`type__elite${U(i)}`],
                                Au[`type__${i}`],
                                null == o ? void 0 : o.typeIcon,
                            ),
                            style: n ? { backgroundImage: `url(${B})` } : void 0,
                        }),
                        iu(E, 'premiumIGR') && a().createElement('div', { className: Au.premiumIGR }),
                        a().createElement('div', { className: c()(Au.name, null == o ? void 0 : o.name) }, s ? t : e),
                    );
                };
                function Du() {
                    return !1;
                ...
                const du = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: i, children: A, mocks: F }) {
                                const o = (0, n.useRef)([]),
                                    s = (t, n, a) => {
                                        var r;
                                        const i = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = cu(a.keys()); !(u = t()).done; ) r(u.value, e);
                                                    },
                                                    unsubscribe: r,
                                                };
                                            })(n),
                                    ...
                                    c = l[0],
                                    B = l[1],
                                    C = (0, n.useState)(() => s(r, i, F)),
                                    d = C[0],
                                    _ = C[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        D.current ? _(s(c, i, F)) : (D.current = !0);
                                    }, [F, c, i]),
                                    (0, n.useEffect)(() => {
                                        B(r);
                                    }, [r]),
                    ...
                    mu = du[1],
                    hu = 'App_base_c725e',
                    gu = 'App_base__visible_e2f2c',
                    vu = 'App_close_e6643',
                    fu = 'App_header_afab9',
                    pu = 'App_content_db8d4',
                    bu = 'App_confirm_a229b',
                    wu = 'Header_base_f8cfc',
                    xu = 'Header_title_b3ddd',
                    yu = 'Header_description_c6566',
                    Lu = ({ title: u, description: e }) =>
                        a().createElement(
                            'div',
                            { className: wu },
                            a().createElement('div', { className: xu }, u),
                            a().createElement('div', { className: yu }, e),
                        ),
                    Tu = 'Progression_base_e71c4',
                    Su = 'Progression_title_e22c7',
                    Ou = 'Progression_name_fc974',
                    Mu = 'Progression_description_ba605',
                    ku = ({ title: u, name: e, description: t }) =>
                        a().createElement(
                            'div',
                            { className: Tu },
                ...
                const Pu = R.strings.battle_pass.extraIntroView,
                    Hu = (0, ru.Pi)(() => {
                        const u = mu(),
                            e = u.controls,
                            t = u.model,
                            r = t.root.get().styleName,
                            E = t.vehicleInfo.get(),
                            i = (0, n.useState)(!1),
                            A = i[0],
                            F = i[1],
                            ...
                            l = (0, n.useCallback)(() => {
                                F(!1);
                                const u = setTimeout(e.close, 500);
                                return () => clearTimeout(u);
                            }, [e]);
                        var B;
                        ((B = () => l()), au(tu.n.ESCAPE, B));
                        const C = (0, n.useCallback)(() => {
                            s || (e.onViewLoaded(), F(!0), D(!0));
                        }, [s, e]);
                        (0, n.useEffect)(
                            () =>
                                ((u) => {
                        ...
                        const d = { vehicleName: a().createElement(su, Ru({}, E, { type: ou.white })) },
                            _ = G(Pu.premium3dStyleVechicle(), { styleName: r }),
                            m = G(Pu.premiumProgressionDescription(), { vehicleName: E.vehicleName, styleName: r });
                        return a().createElement(
                            'div',
                            { className: c()(hu, A && gu) },
                            a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement(Lu, {
                                    title: Pu.title(),
                                    description: a().createElement(Z, { text: Pu.titleDescription(), binding: d }),
                                }),
                            ),
                            a().createElement(
                                'div',
                                { className: pu },
                                a().createElement(ku, {
                                    title: Pu.freeProgression(),
                                    name: E.vehicleName,
                                    description: Pu.freeProgressionDescription(),
                                }),
                                a().createElement(ku, { title: Pu.premiumProgression(), name: _, description: m }),
                            ),
                            a().createElement(
                                H,
                                {
                ...
                engine.whenReady.then(() => {
                    T().render(
                        a().createElement(_u, null, a().createElement(y, null, a().createElement(Hu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(198));
