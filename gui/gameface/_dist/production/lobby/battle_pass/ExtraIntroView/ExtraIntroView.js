(() => {
            ...
            2076: (u, e, t) => {
                ...
                const C = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && s) return r(e, t, p);
                    ...
                    eu = (u, e = j.left) => {
                        ...
                        return ((u, e = j.left) => {
                            ...
                            const a =
                                ...
                                n = Y(u);
                            return Q(n, /( )/, e).forEach((u) => (t = t.concat(Q(u, a, j.left)))), t;
                        })(u, e);
                    },
                    tu = 'FormatText_base_d0',
                    au = ({ binding: u, text: e = '', classMix: t, alignment: r = j.left, formatWithBrackets: i }) => {
                ...
                class Eu extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = h()(nu.base, nu[`base__${i}`], nu[`base__${r}`], null == E ? void 0 : E.base),
                ...
                function ou(u = Au.n.NONE, e = Fu, t = !1, n = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== Au.n.NONE)
                            return (
                        ...
                        Bu
                            ...
                            : (function (u) {
                                  ...
                                  for (let t = Du.length - 1; t >= 0; t--)
                                      for (; u >= Du[t]; ) (e += lu[t]), (u -= Du[t]);
                                  return e;
                              })(u),
                    Cu = (u, e) => u.split(',').includes(e),
                    du = {
                ...
                const hu = ({
                    ...
                    vehicleLvl: r,
                    tags: i = '',
                    size: E = _u.extraSmall,
                    type: A = mu.colored,
                    className: F,
                    classNames: o,
                    isShortName: s = !1,
                }) => {
                    const l = `${((D = a), D.replace(/-/g, '_'))}${u ? '_elite' : ''}`;
                    var D;
                    const B = R.images.gui.maps.icons.vehicleTypes.big.$dyn(l);
                    return n().createElement(
                        'div',
                        { className: h()(du.base, du[`base__size${K(E)}`], du[`base__type${K(A)}`], F) },
                        n().createElement('div', { className: h()(du.level, null == o ? void 0 : o.level) }, cu(r)),
                        n().createElement('div', {
                            className: h()(
                                du.type,
                                u && du[`type__elite${K(E)}`],
                                du[`type__${E}`],
                ...
                const bu = ((u, e) => {
                                    ...
                                    s = (t, a, n) => {
                                        ...
                                        const E = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = pu(n.keys()); !(u = t()).done; ) r(u.value, e);
                                                    },
                                                    unsubscribe: r,
                                                };
                                            })(a),
                    ...
                    Ru = 'Header_base_f4',
                    Hu = 'Header_title_0a',
                    Pu = 'Header_description_85',
                    Nu = ({ title: u, description: e }) =>
                        n().createElement(
                            'div',
                            { className: Ru },
                            n().createElement('div', { className: Hu }, u),
                            n().createElement('div', { className: Pu }, e),
                        ),
                    Wu = 'Progression_base_20',
                    Iu = 'Progression_title_5c',
                    Gu = 'Progression_name_8e',
                    Uu = 'Progression_description_fc',
                    $u = ({ title: u, name: e, description: t }) =>
                        n().createElement(
                            'div',
                            { className: Wu },
                            n().createElement('div', { className: Iu }, u),
                            n().createElement('div', { className: Gu }, e),
                            n().createElement('div', { className: Uu }, t),
                        );
                function zu() {
                    return (
                        (zu = Object.assign
                ...
                const ju = R.strings.battle_pass.extraIntroView,
                    Vu = (0, su.Pi)(() => {
                        const u = yu(),
                            e = u.controls,
                            t = u.model,
                        ...
                        const C = { vehicleName: n().createElement(hu, zu({}, i, { type: mu.white })) },
                            d = q(ju.premium3dStyleVechicle(), { styleName: r }),
                            _ = q(ju.premiumProgressionDescription(), { vehicleName: i.vehicleName, styleName: r });
                        return n().createElement(
                            'div',
                            { className: h()(Lu, A && Su) },
                            n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement(Nu, {
                                    title: ju.title(),
                                    description: n().createElement(au, { text: ju.titleDescription(), binding: C }),
                                }),
                            ),
                            n().createElement(
                                'div',
                                { className: Mu },
                                n().createElement($u, {
                                    title: ju.freeProgression(),
                                    name: i.vehicleName,
                                    description: ju.freeProgressionDescription(),
                                }),
                                n().createElement($u, { title: ju.premiumProgression(), name: d, description: _ }),
                            ),
                            n().createElement(
                                $,
                                {
                ...
                engine.whenReady.then(() => {
                    P().render(
                        n().createElement(xu, null, n().createElement(k, null, n().createElement(Vu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(2076));
