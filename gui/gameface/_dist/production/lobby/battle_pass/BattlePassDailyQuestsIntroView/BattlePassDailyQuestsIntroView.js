(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, E) => {
                E.r(e),
                    E.d(e, { mouse: () => a, off: () => r, on: () => D, onResize: () => t, onScaleUpdated: () => n });
                var A = E(2472),
                    F = E(1176);
                ...
                const h = F.instance,
                    p = {
                        ...
                        sendShowContextMenuEvent: (u, e, E = 0) => {
                            d(D.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: E, args: e });
                        },
            ...
            6253: (u, e, E) => {
                        ...
                        F().createElement(
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    n ||
                                        (null !== C && B(C),
                                        l && l(u),
                                        E && (n || (m.current && (m.current.focus(), p(!0)))),
                                        g(!0));
                                },
                            ...
                            t !== o.ghost &&
                                F().createElement(
                                    F().Fragment,
                                    null,
                                    F().createElement('div', { className: a.back }),
                                    F().createElement('span', { className: a.texture }),
                                ),
                            F().createElement(
                                'span',
                                { className: r()(a.state, a.state__default) },
                ...
                C.defaultProps = { type: o.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const s = C;
                var c = E(1281);
                let l;
                function _(u, e) {
                ...
                const d = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    b = (u, e, E = l.left) => u.split(e).reduce(E === l.left ? v : m, []),
                    h = (() => {
                        const u = new RegExp(
                    ...
                    w = (u, e = l.left) => {
                        ...
                        return ((u, e = l.left) => {
                            ...
                            const A =
                                ...
                                F = d(u);
                            return b(F, /( )/, e).forEach((u) => (E = E.concat(b(u, A, l.left)))), E;
                        })(u, e);
                    },
                    f = 'FormatText_base_d0',
                    g = ({ binding: u, text: e = '', classMix: E, alignment: t = l.left, formatWithBrackets: n }) => {
                        ...
                        return F().createElement(
                            ...
                            D.split('\n').map((e, n) =>
                                F().createElement(
                                    'div',
                                    { className: r()(f, E), key: `${e}-${n}` },
                                    ((u, e, E) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (E && u in E ? E[u] : w(u, e))))(
                                        e,
                                        t,
                                        u,
                ...
                function T(u = k.n.NONE, e = x, E = !1, F = !1) {
                    (0, A.useEffect)(() => {
                        if (u !== k.n.NONE)
                            return (
                                window.addEventListener('keydown', A, E),
                                () => {
                                    window.removeEventListener('keydown', A, E);
                                }
                            );
                        function A(A) {
                            if (A.keyCode === u) {
                                if (!F && O.O.view.isEventHandled()) return;
                                O.O.view.setEventHandled(), e(A), E && A.stopPropagation();
                            }
                        }
                    }, [e, u, E, F]);
                }
                ...
                const z = ((u, e) => {
                                ...
                                const B = (0, A.useRef)([]),
                                    a = (E, A, F) => {
                                        ...
                                        const n = (function ({
                                            ...
                                            i = { mode: E, model: o, externalModel: D, cleanup: a };
                                        return {
                                            model: o,
                                            controls: 'mocks' === E && F ? F.controls(i) : e(i),
                                            externalModel: D,
                                            mode: E,
                                        };
                                    },
                                    ...
                                    C = i[0],
                                    s = i[1],
                                    c = (0, A.useState)(() => a(t, n, r)),
                                    l = c[0],
                                    _ = c[1];
                                return (
                                    (0, A.useEffect)(() => {
                                        o.current ? _(a(C, n, r)) : (o.current = !0);
                                    }, [r, C, n]),
                                    (0, A.useEffect)(() => {
                                        s(t);
                                    }, [t]),
                    ...
                    })(({ observableModel: u }) => ({ root: u.object() }), S),
                    G = z[0],
                    H = z[1],
                    V = 'App_base_a2',
                    ...
                    Y = 'App_info_9a',
                    Z = 'App_title_ac',
                    Q = 'App_description_65',
                    $ = 'App_buttonHolder_3f',
                    X = 'App_button_98',
                    J = R.strings.battle_pass.dailyQuests,
                    uu = (0, P.Pi)(() => {
                        const u = H().model.root.get().questNumber,
                            e = (0, A.useState)(!1),
                            E = e[0],
                            t = e[1],
                            n = () => {
                        ...
                        return (
                            ...
                            F().createElement(
                                M.animated.div,
                                { style: { opacity: D }, className: r()(V, E && j) },
                                F().createElement(
                                    'div',
                                    { className: W },
                                    ...
                                    F().createElement(
                                        'div',
                                        { className: Y },
                                        F().createElement('div', { className: Z }, J.title()),
                                        F().createElement(g, {
                                            classMix: Q,
                                            text: J.description(),
                                            binding: { questNumber: u },
                                        }),
                                        F().createElement(
                                            'div',
                                            { className: $ },
                                            F().createElement(
                                                s,
                                                { size: i.medium, mixClass: X, onClick: n },
                                                J.button(),
                                            ),
                                        ),
                                    ),
                ...
                engine.whenReady.then(() => {
                    n().render(
                        F().createElement(G, null, F().createElement(uu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(6253));
