(() => {
    var __webpack_modules__ = {
                        ...
                        const f = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            x = (0, r.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (s(t, d, { isMouseEvent: !0, on: !0, arguments: E(a) }, k),
                                    w && w(),
                                  ...
                                  Object.assign(
                                      {
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((f.current.timeoutId = window.setTimeout(x, c ? 100 : 400)),
                                                      o && o(u),
                                                      T && T(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                                          ...
                                          onClick: ((u) => (e) => {
                                              (!1 === _ && S(), null == F || F(e), null == u || u(e));
                                          })(e.props.onClick),
                                          onMouseDown: ((u) => (e) => {
                                              (!1 === _ && S(), null == l || l(e), null == u || u(e));
                                          })(e.props.onMouseDown),
                                      },
                                      p,
                                  ),
            ...
            527: (u, e, t) => {
                'use strict';
                (t.r(e),
                    t.d(e, { mouse: () => A, off: () => s, on: () => E, onResize: () => r, onScaleUpdated: () => i }));
                var n = t(2472),
                    a = t(1176);
            ...
            9916: (u, e, t) => {
                ...
                function B(u, e, t, n, a, r, i) {
                    ...
                    E.done ? e(s) : Promise.resolve(s).then(n, a);
                }
            ...
            3491: (u, e, t) => {
                ...
                const A = i.O.client.getSize('rem'),
                    l = A.width,
                    F = A.height,
                    D = Object.assign({ width: l, height: F }, o(l, F, E)),
                    ...
                    d = ({ children: u }) => {
                        const e = (0, n.useContext)(c),
                            ...
                            A = (0, n.useCallback)((u, e) => {
                                ...
                                s(Object.assign({ width: t, height: n }, o(t, n, E)));
                            }, []),
                            l = (0, n.useCallback)(() => {
                ...
                const S = {
                    ...
                    y = (u) => {
                        ...
                        const r = f(),
                            ...
                            E = r.mediaHeight,
                            s = r.mediaSize;
                        return a().createElement('div', x({ className: h()(t, S[i], L[E], T[s]) }, n), e);
                    },
                    M = ['children'];
                const O = (u) => {
                    let e = u.children,
                ...
                class q extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = h()($.base, $[`base__${i}`], $[`base__${r}`], null == E ? void 0 : E.base),
                            c = h()($.icon, $[`icon__${i}`], $[`icon__${r}`], null == E ? void 0 : E.icon),
                            B = h()($.glow, null == E ? void 0 : E.glow),
                            _ = h()($.caption, $[`caption__${i}`], null == E ? void 0 : E.caption),
                            C = h()($.goto, null == E ? void 0 : E.goto);
                ...
                function Z(u = K.n.NONE, e = Y, t = !1, a = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== K.n.NONE)
                            return (
                ...
                const Eu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: E, children: s, mocks: o }) {
                                const A = (0, n.useRef)([]),
                                    l = (t, n, a) => {
                                        var r;
                                        const E = (function ({
                                    ...
                                    c = D[0],
                                    B = D[1],
                                    _ = (0, n.useState)(() => l(r, E, o)),
                                    C = _[0],
                                    d = _[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        F.current ? d(l(c, E, o)) : (F.current = !0);
                                    }, [o, c, E]),
                                    (0, n.useEffect)(() => {
                                        B(r);
                                    }, [r]),
                        ...
                        ({ observableModel: u }) => {
                            ...
                            return {
                                computes: {
                                    getTankmenList: (0, iu.Om)(() => ru.UI(e.tankmenList.get(), J), { equals: uu }),
                                },
                            };
                        },
                        ({ externalModel: u }) => ({
                ...
                const lu = {
                    ...
                    Fu = ({ className: u = '' }) =>
                        a().createElement(
                            'div',
                            { className: h()(lu.base, u) },
                            a().createElement(
                                'div',
                                { className: lu.emitter },
                                Array.from({ length: 10 }, (u, e) =>
                                    a().createElement('div', {
                                        key: `wave-${e}`,
                                        className: h()(lu.wave, lu[`wave__${e}`]),
                                    }),
                                ),
                            ),
                            a().createElement('div', { className: lu.back }),
                            a().createElement('div', { className: h()(lu.line, lu.line__top) }),
                            a().createElement('div', { className: h()(lu.line, lu.line__bottom) }),
                        ),
                    Du = 'Sound_base_68',
                    cu = 'Sound_content_25',
                    Bu = 'Sound_base__active_47',
                    _u = 'Sound_iconContainer_08',
                    Cu = 'Sound_icon_ee',
                    du = 'Sound_label_54',
                    mu = 'Sound_sonar_57',
                    hu = 'Sound_sonar__show_07',
                    gu = ({ className: u = '', isActive: e = !1, isSoundOn: t = !1 }) =>
                        a().createElement(
                            'div',
                            { className: h()(Du, (e || t) && Bu, u) },
                            a().createElement(
                                'div',
                                { className: cu },
                                a().createElement(
                            ...
                            a().createElement(Fu, { className: h()(mu, t && hu) }),
                        );
                var vu = t(1281);
                let wu;
                function bu(u, e) {
                ...
                const pu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    xu = (u, e, t = wu.left) => u.split(e).reduce(t === wu.left ? fu : ku, []),
                    Su = (() => {
                        const u = new RegExp(
                    ...
                    Tu = (u, e = wu.left) => {
                        ...
                        return ((u, e = wu.left) => {
                            ...
                            const n =
                                ...
                                a = pu(u);
                            return (xu(a, /( )/, e).forEach((u) => (t = t.concat(xu(u, n, wu.left)))), t);
                        })(u, e);
                    },
                    yu = 'FormatText_base_d0',
                    Mu = ({ binding: u, text: e = '', classMix: t, alignment: r = wu.left, formatWithBrackets: i }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const E = i && u ? bu(e, u) : e;
                        return a().createElement(
                            n.Fragment,
                            null,
                            E.split('\n').map((e, i) =>
                ...
                const Ru = {
                    ...
                    Hu = R.strings.battle_pass.tankmenVoiceover,
                    Nu = (0, X.Pi)(({ tankman: u }) => {
                        const e = ou().controls,
                            t = u.state,
                            ...
                            s = (() => {
                                switch (t) {
                                    ...
                                    case Ou.AVAILABLE_IN_QUEST_CHAIN:
                                    case Ou.RECEIVED:
                                        return a().createElement(
                                            a().Fragment,
                                            null,
                                            t === Ou.RECEIVED && a().createElement('div', { className: Ru.icon }),
                                            a().createElement('div', { className: Ru.checkGlow }),
                                            a().createElement('div', null, Hu.$dyn(t)),
                                        );
                                    case Ou.UNAVAILABLE:
                                        return Hu.unavailable();
                                }
                            })();
                        return a().createElement('div', { className: h()(Ru.base, Ru[`base__${t}`]) }, s);
                    }),
                    Iu = 'Tankman_base_79',
                    Pu = 'Tankman_content_fc',
                    Wu = 'Tankman_base__disabled_ef',
                    Uu = 'Tankman_content__muted_ef',
                    Gu = 'Tankman_img_36',
                    Vu = 'Tankman_img__hover_4c',
                    $u = 'Tankman_base__active_66',
                    ju = 'Tankman_description_f1',
                    zu = 'Tankman_name_3a',
                    qu = 'Tankman_sound_14',
                    Ku = 'Tankman_sound__disabled_87',
                    Yu = 'Tankman_skills_71',
                    Zu = ({ tankman: u, setActiveTankman: e, isDisabled: t }) => {
                        const r = u.groupName,
                            i = u.fullName,
                            E = u.hasVoiceover,
                            s = u.skills,
                        ...
                        return (
                            (0, n.useEffect)(() => {
                                D && !t && E && (l(!0), I(R.sounds.bp_highlight()));
                            }, [t, D, E]),
                            a().createElement(
                                'div',
                                { className: h()(Iu, t && Wu, _ && $u) },
                                a().createElement(
                                    'div',
                                    {
                                        className: h()(Pu, !E && Uu),
                                        ...
                                        onMouseEnter: () => {
                                            !t && E ? (l(!0), I(R.sounds.bp_highlight())) : c(!0);
                                        },
                                        onMouseLeave: () => {
                                            (l(!1), c(!1));
                                        },
                                ...
                                a().createElement(
                                    'div',
                                    { className: ju },
                                    a().createElement('div', { className: zu }, i),
                                    a().createElement(Au.C, { skills: s, className: Yu }),
                                    a().createElement(Nu, { tankman: u }),
                                ),
                            )
                        );
                    },
                    Xu = 'Content_base_1a',
                    Qu = (0, X.Pi)(({ className: u = '' }) => {
                        const e = ou().model.computes,
                            t = (0, n.useState)(''),
                            r = t[0],
                            i = t[1];
                        return a().createElement(
                    ...
                    ne = () =>
                        a().createElement(
                            'div',
                            { className: Ju },
                            a().createElement('div', { className: ue }, te.subtitle()),
                            a().createElement('div', { className: ee }, te.title()),
                        ),
                    ae = {
                    ...
                    ie = (0, X.Pi)(() => {
                        const u = ou(),
                            ...
                            t = u.model,
                            n =
                                R.images.gui.maps.icons.battlePass.backgrounds.$dyn(
                                    `tankmen_screen_${t.computes.getTankmenList()[0].chapterID}`,
                                ) || R.images.gui.maps.icons.battlePass.backgrounds.tankmen_screen();
                        var r;
                        return (
                            (r = e.close),
                            Z(K.n.ESCAPE, r),
                            a().createElement(
                                'div',
                                { className: ae.base, style: { backgroundImage: `url('${n}')` } },
                                a().createElement(ne, null),
                                a().createElement(Qu, { className: ae.content }),
                                a().createElement(
                                    V,
                                    {
                                        type: W.primary,
                ...
                engine.whenReady.then(() => {
                    N().render(
                        a().createElement(su, null, a().createElement(O, null, a().createElement(ie, null))),
            ...
            734: (u, e, t) => {
                ...
                const A = 'TankmanSkills_base_59',
                    ...
                    _ = 'TankmanSkills_skillIcon__specificPerk_23',
                    C = 'TankmanSkills_divider_38',
                    d = 'TankmanSkills_light_6b',
                        ...
                        return s().createElement(
                            ...
                            i.UI(u, (u, e) =>
                                s().createElement(
                                    ...
                                    t === e && s().createElement('div', { className: C }),
                                ),
                            ),
                            s().createElement('div', { className: d }),
                        );
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(3491));
