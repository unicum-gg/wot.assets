(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => o, off: () => A, on: () => E, onResize: () => r, onScaleUpdated: () => i });
                var a = t(2472),
                    n = t(1176);
            ...
            4717: (u, e, t) => {
                ...
                const C = (u) => {
                    ...
                    d = ({ children: u }) => {
                        ...
                        C(() => {
                            i.O.client.events.on('clientResized', o), i.O.client.events.on('self.onScaleUpdated', F);
                        }),
                            (0, a.useEffect)(
                                () => () => {
                ...
                const L = {
                    ...
                    y = (u) => {
                        ...
                        const r = f(),
                            ...
                            E = r.mediaHeight,
                            A = r.mediaSize;
                        return n().createElement('div', S({ className: h()(t, L[i], k[E], T[A]) }, a), e);
                    },
                    O = ['children'];
                const M = (u) => {
                    let e = u.children,
                ...
                const ru = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: E, children: A, mocks: s }) {
                                const o = (0, a.useRef)([]),
                                    ...
                                    c = D[0],
                                    B = D[1],
                                    _ = (0, a.useState)(() => F(r, E, s)),
                                    C = _[0],
                                    d = _[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        l.current ? d(F(c, E, s)) : (l.current = !0);
                                    }, [s, c, E]),
                                    (0, a.useEffect)(() => {
                                        B(r);
                                    }, [r]),
                    ...
                    su = ({ className: u = '' }) =>
                        n().createElement(
                            ...
                            n().createElement(
                                'div',
                                { className: Au.emitter },
                                Array.from({ length: 10 }, (u, e) =>
                                    n().createElement('div', {
                                        key: `wave-${e}`,
                                        className: h()(Au.wave, Au[`wave__${e}`]),
                                    }),
                                ),
                            ),
                            n().createElement('div', { className: Au.back }),
                            n().createElement('div', { className: h()(Au.line, Au.line__top) }),
                            n().createElement('div', { className: h()(Au.line, Au.line__bottom) }),
                        ),
                    ou = 'Sound_base_68',
                    Fu = 'Sound_content_25',
                    lu = 'Sound_base__active_47',
                    Du = 'Sound_iconContainer_08',
                    cu = 'Sound_icon_ee',
                    Bu = 'Sound_label_54',
                    _u = 'Sound_sonar_57',
                    ...
                    du = ({ className: u = '', isActive: e = !1, isSoundOn: t = !1 }) =>
                        n().createElement(
                            ...
                            n().createElement(su, { className: h()(_u, t && Cu) }),
                        );
                var mu = t(1281);
                let hu;
                function gu(u, e) {
                ...
                const vu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    pu = (u, e, t = hu.left) => u.split(e).reduce(t === hu.left ? wu : bu, []),
                    fu = (() => {
                        const u = new RegExp(
                    ...
                    Su = (u, e = hu.left) => {
                        ...
                        return ((u, e = hu.left) => {
                            ...
                            const a =
                                ...
                                n = vu(u);
                            return pu(n, /( )/, e).forEach((u) => (t = t.concat(pu(u, a, hu.left)))), t;
                        })(u, e);
                    },
                    Lu = 'FormatText_base_d0',
                    ku = ({ binding: u, text: e = '', classMix: t, alignment: r = hu.left, formatWithBrackets: i }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const E = i && u ? gu(e, u) : e;
                        return n().createElement(
                            a.Fragment,
                            null,
                            E.split('\n').map((e, i) =>
                ...
                const yu = {
                    ...
                    Mu = (0, X.Pi)(({ tankman: u }) => {
                        const e = Eu().controls,
                            ...
                            A = (() => {
                                switch (t) {
                                    ...
                                    case Tu.AVAILABLE_IN_QUEST_CHAIN:
                                    case Tu.RECEIVED:
                                        return n().createElement(
                                            n().Fragment,
                                            null,
                                            t === Tu.RECEIVED && n().createElement('div', { className: yu.icon }),
                                            n().createElement('div', { className: yu.checkGlow }),
                        ...
                        return n().createElement('div', { className: h()(yu.base, yu[`base__${t}`]) }, A);
                    }),
                    Ru = 'Tankman_base_79',
                    Hu = 'Tankman_content_fc',
                    Nu = 'Tankman_base__disabled_ef',
                    Pu = 'Tankman_content__muted_ef',
                    Iu = 'Tankman_img_36',
                    ...
                    Vu = 'Tankman_name_3a',
                    $u = 'Tankman_sound_14',
                    zu = 'Tankman_sound__disabled_87',
                    ju = ({ tankman: u, setActiveTankman: e, isDisabled: t }) => {
                        const r = u.groupName,
                            i = u.fullName,
                            E = u.hasVoiceover,
                            A = (0, a.useState)(!1),
                        ...
                        return (
                            (0, a.useEffect)(() => {
                                l && !t && E && (o(!0), P(R.sounds.bp_highlight()));
                            }, [t, l, E]),
                            n().createElement(
                                'div',
                                { className: h()(Ru, t && Nu, B && Uu) },
                                n().createElement(
                                    'div',
                                    {
                                        className: h()(Hu, !E && Pu),
                                        ...
                                        onMouseEnter: () => {
                                            !t && E ? (o(!0), P(R.sounds.bp_highlight())) : D(!0);
                                        },
                                        onMouseLeave: () => {
                                            o(!1), D(!1);
                                        },
                                ...
                                n().createElement(
                                    'div',
                                    { className: Gu },
                                    n().createElement('div', { className: Vu }, i),
                                    n().createElement(Mu, { tankman: u }),
                                ),
                            )
                        );
                    },
                    qu = 'Content_base_1a',
                    Ku = (0, X.Pi)(({ className: u = '' }) => {
                        const e = Eu().model.computes,
                            t = (0, a.useState)(''),
                            r = t[0],
                            i = t[1];
                        return n().createElement(
                    ...
                    Yu = 'TankmanSkills_base_f7',
                    Zu = 'TankmanSkills_skill_c5',
                    Xu = 'TankmanSkills_light_6e';
                let Qu;
                !(function (u) {
                ...
                const Ju = ({ skills: u, className: e = '' }) =>
                    ...
                    ue = 'Header_base_e3',
                    ee = 'Header_subtitle_73',
                    te = 'Header_title_83',
                    ae = 'Header_description_00',
                    ne = 'Header_descriptionText_1e',
                    re = 'Header_skills_dc',
                    ie = [Qu.Brotherhood, Qu.NewSkill, Qu.NewSkill],
                    Ee = R.strings.battle_pass.tankmenVoiceover,
                    Ae = () =>
                        n().createElement(
                            'div',
                            { className: ue },
                            n().createElement('div', { className: ee }, Ee.subtitle()),
                            n().createElement('div', { className: te }, Ee.title()),
                            n().createElement(
                                'div',
                                { className: ae },
                                n().createElement(ku, { classMix: ne, text: Ee.description() }),
                            ),
                            n().createElement(Ju, { skills: ie, className: re }),
                        ),
                    se = {
                    ...
                    oe = R.strings.battle_pass.tankmenVoiceover,
                    Fe = (0, X.Pi)(() => {
                        const u = Eu().controls;
                        var e;
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement(Ku, { className: se.content }),
                                n().createElement(
                                    V,
                                    {
                                        type: W.primary,
                ...
                engine.whenReady.then(() => {
                    N().render(
                        n().createElement(iu, null, n().createElement(M, null, n().createElement(Fe, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(4717));
