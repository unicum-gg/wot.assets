(() => {
    var __webpack_modules__ = {
            ...
            9830: (e, u, t) => {
                        ...
                        ({
                            ...
                            return o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    o().createElement('div', { className: h, style: { backgroundImage: m(t, a, _) } }),
                                ),
                            );
                        },
                    );
                                    ...
                                    : o().createElement(
                                          'div',
                                          {
                                              className: r()(
                                                  ...
                                                  n && A[`label__hasProgress${D}${F ? 'Progression' : ''}`],
                                              ),
                ...
                const D = ({ size: e = p.Default, classMix: u }) =>
                    ...
                    f = ({ size: e, value: u, lineRef: t, disabled: a, onComplete: r }) => {
                        ...
                        return (
                            ...
                            o().createElement(w, { size: e, disabled: a, baseStyles: i, isComplete: l, lineRef: t })
                        );
                    };
                var S = t(122);
                let x, L;
                ...
                const z = (0, n.memo)((e) => {
                        ...
                        switch (a.animationSettings.type) {
                            case F.Simple:
                                return o().createElement(k, j({}, a, { onEndAnimation: s, isComplete: i }));
                            case F.Growing:
                                return o().createElement(W, j({}, a, { onEndAnimation: s, isComplete: i }));
                            default:
                                return null;
                        }
                    }),
                ...
                const V = (0, n.memo)((e) => {
                    ...
                    return (
                        (a.current.from = i),
                        o().createElement(z, q({}, t, { onEndAnimation: r, key: `${i}-${t.to}`, from: i }))
                    );
                });
                function Y() {
                    return (
