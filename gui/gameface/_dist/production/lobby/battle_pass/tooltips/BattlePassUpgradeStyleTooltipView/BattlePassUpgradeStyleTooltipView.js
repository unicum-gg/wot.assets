    ...
    var u,
        A = {
            1240: (u, A, F) => {
                ...
                var D = {};
                F.r(D), F.d(D, { getBgUrl: () => z, getTextureUrl: () => S });
                var B = {};
                F.r(B),
                    F.d(B, {
                        addModelObserver: () => q,
                ...
                function T(u) {
                    let A = '';
                    for (let F = O.length - 1; F >= 0; F--) for (; u >= O[F]; ) (A += P[F]), (u -= O[F]);
                    return A;
                }
                ...
                const Cu = (() => {
                    ...
                    nu = T,
                    ru = Object.keys(j).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === j[A]), u), {}),
                    ou = {
                        set: (u, A) => {
                ...
                const pu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    wu = (u, A, F = fu.left) => u.split(A).reduce(F === fu.left ? bu : hu, []),
                    yu = (() => {
                        const u = new RegExp(
                    ...
                    _u = (u, A = fu.left) => {
                        ...
                        return ((u, A = fu.left) => {
                            ...
                            const e =
                                ...
                                E = pu(u);
                            return wu(E, /( )/, A).forEach((u) => (F = F.concat(wu(u, e, fu.left)))), F;
                        })(u, A);
                    },
                    Pu = 'FormatText_base_d0',
                    Ru = ({ binding: u, text: A = '', classMix: F, alignment: e = fu.left, formatWithBrackets: E }) => {
                        if (null === A) return console.error("FormatText was supplied with 'null'"), null;
                        const D = E && u ? gu(A, u) : A;
                        return C().createElement(
                            ...
                            D.split('\n').map((A, E) =>
                                C().createElement(
                                    'div',
                                    { className: i()(Pu, F), key: `${A}-${E}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : _u(u, A))))(
                                        A,
                                        e,
                                        u,
                ...
                const ku = ((u, A) => {
                    ...
                    Vu = ku[1],
                    $u = 'Content_base_d2',
                    Iu = 'Content_separator_b4',
                    Gu = 'Content_base__bottom_ab',
                    Uu = 'Content_image_90',
                    Hu = 'Content_section_83',
                    Wu = 'Content_sectionBottom_01',
                    qu = 'Content_title_c5',
                    Qu = 'Content_warning_d0',
                    Xu = 'Content_text_bf',
                    Zu = 'Content_highlightedText_e0',
                    Ju = 'Content_subtitle_55',
                    Ku = 'Content_paragraphs_c3',
                    Yu = 'Content_paragraphTop_18',
                    uA = R.strings.battle_pass.tooltips.styleUpgrade,
                    AA = (0, Ou.Pi)(() => {
                        const u = Vu().model.root.get(),
                            ...
                            E = u.vehicles,
                            D = {
                                level: C().createElement('div', { className: Zu }, T(A)),
                                levelWord: C().createElement('div', { className: Zu }, uA.chosen.levelWord()),
                            };
                        return C().createElement(
                            'div',
                            { className: i()($u, F && Gu) },
                            C().createElement('div', {
                                ...
                                style: F
                                    ? (() => {
                                          const u = `style_3d_${A}_${F}_small`;
                                          return {
                            ...
                            C().createElement(
                                ...
                                C().createElement(
                                    'div',
                                    { className: qu },
                                    F ? gu(uA.chosen.title(), { styleName: e }) : uA.notChosen.title(),
                                ),
                                !F && C().createElement('div', { className: Qu }, uA.notChosen.warning()),
                                C().createElement(
                                    'div',
                                    { className: Xu },
                                    F
                                        ? C().createElement(Ru, { text: uA.chosen.text(), binding: D })
                                        : uA.notChosen.text(),
                                ),
                                C().createElement('div', { className: Iu }),
                            ),
                            C().createElement(
                                'div',
                                { className: Ku },
                                C().createElement('div', { className: Yu }, uA.paragraphTop()),
                                uA.paragraphBottom(),
                            ),
                            F &&
                                C().createElement(
                                    ...
                                    { className: Wu },
                                    C().createElement('div', { className: Iu }),
                                    C().createElement('div', { className: Ju }, uA.chosen.subtitle()),
                                    C().createElement('div', { className: Xu }, E),
                                ),
                        );
                    }),
                    FA = () => C().createElement(vu, null, C().createElement(AA, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(Lu, null, C().createElement(FA, null)),
