(() => {
    ...
    var u,
        A = {
            8484: (u, A, F) => {
                var E = {};
                (F.r(E), F.d(E, { mouse: () => d, onResize: () => l }));
                var e = {};
                (F.r(e),
                    F.d(e, {
                        events: () => E,
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => p, getTextureUrl: () => g }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => M,
                ...
                function V(u = 'rem') {
                    ...
                    return 'rem' === u ? A : { x: H(A.x), y: H(A.y) };
                }
                function I() {
                ...
                const Cu = (u, A, F) => {
                    ...
                    ru = (u, A, F = tu.left) => u.split(A).reduce(F === tu.left ? Cu : nu, []),
                    ou = (() => {
                        const u = new RegExp(
                        ...
                        return iu.includes(F)
                            ...
                            : ((u, A = tu.left) => {
                                  ...
                                  const E =
                                      ...
                                      e = u.replace(/&nbsp;/g, ' ');
                                  return (ru(e, /( )/, A).forEach((u) => (F = F.concat(ru(u, E, tu.left)))), F);
                              })(u, A);
                    },
                    su = 'FormatText_base_d0',
                    lu = ({ binding: u, text: A = '', classMix: F, alignment: E = tu.left }) =>
                        null === A
                            ...
                            : C().createElement(
                                  ...
                                  A.split('\n').map((A, e) =>
                                      C().createElement(
                                          'div',
                                          { className: i()(su, F), key: `${A}-${e}` },
                                          ((u, A, F) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (F && u in F ? F[u] : au(u, A))))(A, E, u).map((u, A) =>
                ...
                function vu(u) {
                    let A = '';
                    for (let F = du.length - 1; F >= 0; F--) for (; u >= du[F];) ((A += cu[F]), (u -= du[F]));
                    return A;
                }
                ...
                const yu = ((u, A) => {
                    ...
                    _u = yu[1],
                    Pu = 'Content_base_d2',
                    Ou = 'Content_separator_b4',
                    Ru = 'Content_base__bottom_ab',
                    Tu = 'Content_image_90',
                    Su = 'Content_section_83',
                    zu = 'Content_sectionBottom_01',
                    ju = 'Content_title_c5',
                    Mu = 'Content_warning_d0',
                    Nu = 'Content_text_bf',
                    ku = 'Content_highlightedText_e0',
                    Lu = 'Content_subtitle_55',
                    Vu = 'Content_paragraphs_c3',
                    Iu = 'Content_paragraphTop_18',
                    Gu = R.strings.battle_pass.tooltips.styleUpgrade,
                    $u = (0, mu.Pi)(() => {
                        const u = _u().model.root.get(),
                            ...
                            e = u.vehicles,
                            D = {
                                level: C().createElement('div', { className: ku }, vu(A)),
                                levelWord: C().createElement('div', { className: ku }, Gu.chosen.levelWord()),
                            };
                        return C().createElement(
                            ...
                            C().createElement('div', {
                                ...
                                style: F
                                    ? (() => {
                                          const u = `style_3d_${A}_${F}`;
                                          return {
                                              backgroundImage: `url(${R.images.gui.maps.icons.battlePass.rewards.customizations.s232x174.$dyn(u)})`,
                                          };
                                      })()
                                    : void 0,
                            }),
                            C().createElement(
                                'div',
                                { className: Su },
                                C().createElement('div', { className: Ou }),
                                C().createElement(
                                    'div',
                                    { className: ju },
                                    F
                                        ? ((B = Gu.chosen.title()),
                                          (t = { styleName: E }),
                                          B.replace(/\{\w+\}/g, (u) => String(t[u.slice(1, -1)])))
                                        : Gu.notChosen.title(),
                                ),
                                !F && C().createElement('div', { className: Mu }, Gu.notChosen.warning()),
                                C().createElement(
                                    'div',
                                    { className: Nu },
                                    F
                                        ? C().createElement(lu, { text: Gu.chosen.text(), binding: D })
                                        : Gu.notChosen.text(),
                                ),
                                C().createElement('div', { className: Ou }),
                            ),
                            C().createElement(
                                'div',
                                { className: Vu },
                                C().createElement('div', { className: Iu }, Gu.paragraphTop()),
                                Gu.paragraphBottom(),
                            ),
                            F &&
                                C().createElement(
                                    ...
                                    { className: zu },
                                    C().createElement('div', { className: Ou }),
                                    C().createElement('div', { className: Lu }, Gu.chosen.subtitle()),
                                    C().createElement('div', { className: Nu }, e),
                                ),
                        );
                        var B, t;
                    }),
                    Hu = () => C().createElement(Bu, null, C().createElement($u, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(xu, null, C().createElement(Hu, null)),
