    ...
    var u,
        A = {
            1240: (u, A, F) => {
                ...
                var D = {};
                F.r(D), F.d(D, { getBgUrl: () => T, getTextureUrl: () => P });
                var B = {};
                F.r(B),
                    F.d(B, {
                        addModelObserver: () => H,
                    ...
                    xu = ({ binding: u, text: A = '', classMix: F, alignment: e = du.left, formatWithBrackets: E }) => {
                        ...
                        return C().createElement(
                            ...
                            D.split('\n').map((A, E) =>
                                C().createElement(
                                    'div',
                                    { className: i()(yu, F), key: `${A}-${E}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : wu(u, A))))(
                                        A,
                                        e,
                                        u,
                ...
                function Ru(u) {
                    let A = '';
                    for (let F = Pu.length - 1; F >= 0; F--) for (; u >= Pu[F]; ) (A += _u[F]), (u -= Pu[F]);
                    return A;
                }
                ...
                const ku = ((u, A) => {
                    ...
                    AA = (0, Tu.Pi)(() => {
                        const u = Vu().model.root.get(),
                            ...
                            E = u.vehicles,
                            D = {
                                level: C().createElement('div', { className: Zu }, Ru(A)),
                        ...
                        return C().createElement(
                            ...
                            C().createElement(
                                ...
                                C().createElement(
                                    'div',
                                    { className: qu },
                                    F ? vu(uA.chosen.title(), { styleName: e }) : uA.notChosen.title(),
                                ),
                                ...
                                C().createElement(
                                    ...
                                    { className: Xu },
                                    F
                                        ? C().createElement(xu, { text: uA.chosen.text(), binding: D })
                                        : uA.notChosen.text(),
                                ),
                                C().createElement('div', { className: Iu }),
                            ),
                    ...
                    FA = () => C().createElement(lu, null, C().createElement(AA, null));
                engine.whenReady.then(() => {
                    r().render(
