    ...
    var u,
        A = {
            8484: (u, A, F) => {
                ...
                const J = Object.keys(b).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === b[A]), u), {}),
                    K = {
                        set: (u, A) => {
                ...
                const tu = (u, A, F) => {
                    ...
                    nu = (u, A, F = Bu.left) => u.split(A).reduce(F === Bu.left ? tu : Cu, []),
                    ru = (() => {
                        const u = new RegExp(
                        ...
                        return ou.includes(F)
                            ...
                            : ((u, A = Bu.left) => {
                                  ...
                                  const E =
                                      ...
                                      e = u.replace(/&nbsp;/g, ' ');
                                  return (nu(e, /( )/, A).forEach((u) => (F = F.concat(nu(u, E, Bu.left)))), F);
                              })(u, A);
                    },
                    au = 'FormatText_base_d0',
                    su = ({ binding: u, text: A = '', classMix: F, alignment: E = Bu.left }) =>
                        null === A
                            ...
                            : C().createElement(
                                  ...
                                  A.split('\n').map((A, e) =>
                                      C().createElement(
                                          'div',
                                          { className: i()(au, F), key: `${A}-${e}` },
                                          ((u, A, F) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (F && u in F ? F[u] : iu(u, A))))(A, E, u).map((u, A) =>
                ...
                const wu = ((u, A) => {
                    ...
                    xu = wu[1],
                    _u = 'Content_base_d2',
                    Pu = 'Content_separator_b4',
                    Ou = 'Content_base__bottom_ab',
                    Ru = 'Content_image_90',
                    Tu = 'Content_section_83',
                    Su = 'Content_sectionBottom_01',
                    zu = 'Content_title_c5',
                    ju = 'Content_warning_d0',
                    Mu = 'Content_text_bf',
                    Nu = 'Content_highlightedText_e0',
                    ku = 'Content_subtitle_55',
                    Lu = 'Content_paragraphs_c3',
                    Vu = 'Content_paragraphTop_18',
                    Iu = R.strings.battle_pass.tooltips.styleUpgrade,
                    Gu = (0, vu.Pi)(() => {
                        const u = xu().model.root.get(),
                            ...
                            e = u.vehicles,
                            D = {
                                level: C().createElement('div', { className: Nu }, du(A)),
                                levelWord: C().createElement('div', { className: Nu }, Iu.chosen.levelWord()),
                            };
                        return C().createElement(
                            ...
                            C().createElement(
                                ...
                                !F && C().createElement('div', { className: ju }, Iu.notChosen.warning()),
                                C().createElement(
                                    'div',
                                    { className: Mu },
                                    F
                                        ? C().createElement(su, { text: Iu.chosen.text(), binding: D })
                                        : Iu.notChosen.text(),
                                ),
                                C().createElement('div', { className: Pu }),
                            ),
                            C().createElement(
                                'div',
                                { className: Lu },
                                C().createElement('div', { className: Vu }, Iu.paragraphTop()),
                                Iu.paragraphBottom(),
                            ),
                            F &&
                                C().createElement(
                                    ...
                                    { className: Su },
                                    C().createElement('div', { className: Pu }),
                                    C().createElement('div', { className: ku }, Iu.chosen.subtitle()),
                                    C().createElement('div', { className: Mu }, e),
                                ),
                        );
                        var B, t;
                    }),
                    $u = () => C().createElement(Du, null, C().createElement(Gu, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(yu, null, C().createElement($u, null)),
