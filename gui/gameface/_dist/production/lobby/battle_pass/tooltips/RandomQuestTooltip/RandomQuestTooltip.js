    ...
    var u,
        e = {
            1746: (u, e, F) => {
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => k, getTextureUrl: () => M }));
                var t = {};
                (F.r(t),
                    F.d(t, {
                        addModelObserver: () => Q,
                ...
                const w = {
                    ...
                    T = { play: Object.assign({}, _, { sound: f }), setRTPC: p },
                ...
                const au = Object.keys(z).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === z[e]), u), {}),
                    iu = {
                        set: (u, e) => {
                ...
                const du = { view: t, client: E, sound: T, intl: b };
                function mu() {
                ...
                const pu = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            fu({}, t, {
                                className: a()(gu.base, gu[`base__theme-${D}`], A),
                                ref: function (u) {
                ...
                const Mu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Wu = (u, e, F = Su.left) => u.split(e).reduce(F === Su.left ? ku : zu, []),
                    ju = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Vu = ({ binding: u, text: e = '', classMix: F, alignment: A = Su.left, formatWithBrackets: E }) => {
                        ...
                        return n().createElement(
                            ...
                            D.split('\n').map((e, E) =>
                                n().createElement(
                                    'div',
                                    { className: a()($u, F), key: `${e}-${E}` },
                                    ((u, e, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : Nu(u, e))))(
                                        e,
                                        A,
                                        u,
                ...
                const Iu = {
                    ...
                    ue = 'Content_image_d9',
                    ee = 'Content_title_33',
                    Fe = 'Content_subTitle_97',
                    Ae = 'Content_divider_52',
                    Ee = 'Content_rewardBase_31',
                    De = 'Content_reward_b0',
                    te = 'Content_expireTime_7c',
                    Be = R.strings.battle_pass.tooltips.RandomQuestTooltip,
                    ne = (0, Gu.Pi)(() => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(Vu, { text: Be.title(), binding: { vehicleName: e }, classMix: ee }),
                            A &&
                                n().createElement(Vu, {
                                    text: Be.condition(),
                                    binding: { condition: A },
                            ...
                            n().createElement('div', { className: Fe }, Be.rewardsTitle()),
                            n().createElement('div', { className: Ae }),
                            n().createElement(
                                Ku,
                                { className: Ee },
                                n().createElement(Qu, { text: Be.rewards.consumables(), classMix: De }),
                                n().createElement(Qu, { text: Be.rewards.directives(), classMix: De }),
                                n().createElement(Qu, { text: Be.rewards.personal_reserves(), classMix: De }),
                                n().createElement(Qu, { text: Be.rewards.premium(), classMix: De }),
                                n().createElement(Qu, { text: Be.rewards.money(), classMix: De }),
                                n().createElement(Qu, { text: Be.rewards.standardEquipment(), classMix: De }),
                            ),
                            n().createElement('div', { className: Ae }),
                            n().createElement(Qu, {
                                text: Be.expireTime(),
                    ...
                    Ce = () => n().createElement(Tu, null, n().createElement(pu, null, n().createElement(ne, null)));
                engine.whenReady.then(() => {
                    r().render(n().createElement(Ce, null), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
