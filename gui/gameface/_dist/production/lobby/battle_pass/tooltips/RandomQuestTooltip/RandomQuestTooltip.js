    ...
    var u,
        e = {
            6881: (u, e, F) => {
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => k, getTextureUrl: () => z }));
                var t = {};
                (F.r(t),
                    F.d(t, {
                        addModelObserver: () => Z,
                ...
                const bu = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            pu({}, t, {
                                className: a()(fu.base, fu[`base__theme-${D}`], A),
                                ref: function (u) {
                                    ((C.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            n().createElement('div', { className: fu.decorator }, F),
                        )
                    );
                });
                function hu() {
                ...
                const zu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Lu = (u, e, F = Ou.left) => u.split(e).reduce(F === Ou.left ? ku : Wu, []),
                    ju = (() => {
                        const u = new RegExp(
                            [
                    ...
                    $u = (u, e = Ou.left) => {
                        ...
                        return ((u, e = Ou.left) => {
                            ...
                            const A =
                                ...
                                E = zu(u);
                            return (Lu(E, /( )/, e).forEach((u) => (F = F.concat(Lu(u, A, Ou.left)))), F);
                        })(u, e);
                    },
                    Vu = 'FormatText_base_f27a4',
                    Gu = ({ binding: u, text: e = '', classMix: F, alignment: A = Ou.left, formatWithBrackets: E }) => {
                ...
                const Uu = {
                    ...
                    qu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Qu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Xu = (0, B.memo)(({ text: u, binding: e, classMix: F }) => {
                    ...
                    Zu = 'List_base_c5b5b',
                    Ju = 'List_item_c9813',
                    Ku = 'List_circle_ee54b',
                    Yu = ({ children: u, className: e }) => {
                    ...
                    ue = 'Content_base_f177b',
                    ee = 'Content_image_ac2bd',
                    Fe = 'Content_title_a517a',
                    Ae = 'Content_subTitle_ec3e1',
                    Ee = 'Content_divider_de0d9',
                    De = 'Content_rewardBase_da649',
                    te = 'Content_reward_cae77',
                    Be = 'Content_expireTime_b4bed',
                    ne = R.strings.battle_pass.tooltips.RandomQuestTooltip,
                    Ce = (0, Iu.Pi)(() => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(Gu, { text: ne.title(), binding: { vehicleName: e }, classMix: Fe }),
                            A &&
                                n().createElement(Gu, {
                                    text: ne.condition(),
                                    binding: { condition: A },
                            ...
                            n().createElement('div', { className: Ae }, ne.rewardsTitle()),
                            n().createElement('div', { className: Ee }),
                            n().createElement(
                                Yu,
                                { className: De },
                                n().createElement(Xu, { text: ne.rewards.consumables(), classMix: te }),
                                n().createElement(Xu, { text: ne.rewards.directives(), classMix: te }),
                                n().createElement(Xu, { text: ne.rewards.personal_reserves(), classMix: te }),
                                n().createElement(Xu, { text: ne.rewards.premium(), classMix: te }),
                                n().createElement(Xu, { text: ne.rewards.money(), classMix: te }),
                                n().createElement(Xu, { text: ne.rewards.standardEquipment(), classMix: te }),
                            ),
                            n().createElement('div', { className: Ee }),
                            n().createElement(Xu, {
                                text: ne.expireTime(),
                    ...
                    re = () => n().createElement(Pu, null, n().createElement(bu, null, n().createElement(Ce, null)));
                engine.whenReady.then(() => {
                    r().render(n().createElement(re, null), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
