    ...
    var u,
        e = {
            ...
            2807: (u, e, t) => {
                ...
                const Z = Object.keys(f).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === f[e]), u), {}),
                    J = {
                        set: (u, e) => {
                ...
                const ru = a().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            Fu({}, r, {
                                className: l()(Au.base, Au[`base__theme-${F}`], A),
                                ref: function (u) {
                                    ((B.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            a().createElement('div', { className: Au.decorator }, t),
                        )
                    );
                });
                var Du = t(9887),
                ...
                const Cu = eu.client.getSize('rem'),
                    ou = Cu.width,
                    mu = Cu.height,
                    su = Object.assign({ width: ou, height: mu }, lu(ou, mu, Bu)),
                ...
                const gu = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && B) return nu(e, t, _);
                        if (t.largeWidth && i) return nu(e, t, _);
                        if (t.mediumWidth && l) return nu(e, t, _);
                        if (t.smallWidth && C) return nu(e, t, _);
                ...
                const Tu = {
                    ...
                    Pu = Lu((u) => {
                        ...
                        const j = (0, D.useMemo)(() => {
                            ...
                            }, [t, A, r, B, C, m, W, P, L, g, y, b, S]),
                            X = j.computedStyle,
                            I = j.computedClassNames;
                        return a().createElement('div', yu({ className: l()(Mu.base, ...I, e), style: X }, G), N);
                    });
                let Wu;
                !(function (u) {
                ...
                const Qu = Object.keys(Uu()),
                    ...
                    Ee = Lu((u) => {
                        ...
                        return a().createElement(
                            ...
                            qu(
                                {
                                    className: l()(Ku.base, t && Ku[t], x, A),
                                    style: h,
                            ...
                            void 0 !== d ? a().createElement(Vu, qu({}, d, { text: e })) : e,
                        );
                    });
                var Fe = t(3403),
                    re = t(8487);
                ...
                const Ce = ((u, e) => {
                        ...
                        return [
                            function ({ mode: A = 'real', options: E, children: F, mocks: r }) {
                                const n = (0, D.useRef)([]),
                                    B = (t, A, E) => {
                                        ...
                                        const r = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const D = 'string' == typeof F ? `${A}.${F}` : A,
                                                            a = eu.view.addModelObserver(D, e, !0);
                                            ...
                                            l = { mode: t, model: i, externalModel: D, cleanup: B };
                                        return {
                                            model: i,
                                ...
                                return (
                                    (0, D.useEffect)(() => {
                                        i.current ? c(B(C, E, r)) : (i.current = !0);
                                    }, [r, C, E]),
                                    (0, D.useEffect)(() => {
                                        o(A);
                                    }, [A]),
                    ...
                    me = Ce[1],
                    se = 'Message_base_12',
                    ce = 'Message_separator_9c',
                    de = 'Message_content_6d',
                    ge = 'Message_text_03',
                    _e = ({ text: u }) =>
                        a().createElement(
                            'div',
                            ...
                            a().createElement('div', { className: de }, a().createElement('div', { className: ge }, u)),
                            a().createElement('div', { className: ce }),
                        ),
                    he = 'Content_base_c5',
                    xe = 'Content_separator_df',
                    fe = 'Content_base__noDescription_3f',
                    pe = 'Content_title_e5',
                    ve = 'Content_subTitle_bf',
                    be = 'Content_tank_95',
                    we = 'Content_footer_1a',
                    Se = 'Content_flare_50',
                    Le = 'Content_messageWrapper_e3',
                    Me = 'Content_info_f4',
                    Re = 'Content_separatorWrapper_b1',
                    ye = 'Content_unlock_f4',
                    Te = R.strings.battle_pass.tooltips,
                    He = (0, Fe.Pi)(() => {
                        const u = me().model.root.get(),
                            e = u.isBattlePassPurchased,
                            t = u.notChosenRewardCount,
                            A = u.isBpPointsShopEntryPointActive,
                            E = t > 0,
                            F = u.isSingleChapter ? Te.completed.subTitleSingle() : Te.completed.subTitle();
                        return a().createElement(
                            'div',
                            { className: l()(he, e && !E && fe) },
                            a().createElement(Ee, { className: pe, text: Te.completed.title() }),
                            a().createElement(Ee, { className: ve, text: F }),
                            ...
                            a().createElement(
                                ...
                                A &&
                                    a().createElement(
                                        'div',
                                        { className: Le },
                                        a().createElement(_e, { text: Te.completed.message() }),
                                    ),
                                a().createElement(
                                    'div',
                                    { className: Me },
                                    E &&
                                        a().createElement(re.l, {
                                            icon: R.images.gui.maps.icons.battlePass.tooltips.bow_small(),
                                            text: t > 1 ? Te.claimRewards.multiple() : Te.claimRewards.c_1(),
                                            mixClass: ye,
                                        }),
                                    E &&
                                        !e &&
                    ...
                    Oe = () => a().createElement(ru, null, a().createElement(He, null));
                engine.whenReady.then(() => {
                    B().render(
                        a().createElement(oe, null, a().createElement(Oe, null)),
            ...
            8487: (u, e, t) => {
                ...
                var A = t(6179),
                    ...
                    F = t(6483),
                    r = t.n(F);
                const D = 'IconTextBlock_base_46',
                    a = 'IconTextBlock_icon_c9',
                    n = 'IconTextBlock_text_89',
                    B = (0, A.memo)(({ icon: u, text: e, mixClass: t }) => {
                        const F = (0, A.useMemo)(() => ({ backgroundImage: `url(${u})` }), [u]),
                            B = r()(D, t);
                        return E().createElement(
                            'div',
                            { className: B },
                            E().createElement('div', { className: a, style: F }),
                            E().createElement('div', { className: n }, e),
                        );
                    });
            },
        },
