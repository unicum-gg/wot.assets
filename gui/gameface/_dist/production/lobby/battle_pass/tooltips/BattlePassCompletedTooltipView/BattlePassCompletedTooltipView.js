        ...
        e = {
            280: (u, e, F) => {
                ...
                const C = ({
                    ...
                    text: e = '',
                    classMix: F,
                    alignment: A = D.v2.left,
                    formatWithBrackets: C,
                }) => {
                    if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                    const r = C && u ? (0, D.WU)(e, u) : e;
                    return B().createElement(
                        ...
                        r.split('\n').map((e, C) =>
                            B().createElement(
                                ...
                                (0, D.Uw)(e, A, u).map((u, e) =>
                                    B().createElement(t.Fragment, { key: `${e}-${u}` }, u),
                                ),
                            ),
                        ),
                    );
                    ...
                    a = (u, e = E.left) => {
                        ...
                        return ((u, e = E.left) => {
                            ...
                            const A =
                                ...
                                D = t(u);
                            return C(D, /( )/, e).forEach((u) => (F = F.concat(C(u, A, E.left)))), F;
                        })(u, e);
                    },
            ...
            4634: (u, e, F) => {
                ...
                const tu = (() => {
                    ...
                    Bu = Object.keys(O).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === O[e]), u), {}),
                    nu = {
                        set: (u, e) => {
                ...
                const lu = n().forwardRef(function (u, e) {
                    let F = u.children,
                        A = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            su({}, t, {
                                className: a()(au.base, au[`base__theme-${D}`], A),
                                ref: function (u) {
                                    (r.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            n().createElement('div', { className: au.decorator }, F),
                        )
                    );
                });
                var cu = F(3403),
                ...
                const xu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: A = 'real', options: E, children: D, mocks: t }) {
                                    ...
                                    r = (F, A, E) => {
                                        ...
                                        const t = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = pu(E.keys()); !(u = F()).done; ) D(u.value, e);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(A),
                                ...
                                return (
                                    ...
                                    n().createElement(F.Provider, { value: c }, D)
                                );
                            },
                            () => (0, B.useContext)(F),
                        ];
                        ...
                        const e = { root: u.object() },
                            F = (0, _u.Om)(() => e.root.get().chapterType === mu.HOLIDAY);
                    ...
                    $u = 'Content_info_f4',
                    Vu = 'Content_unlock_f4',
                    Gu = 'CustomContent_background_f2',
                    Hu = 'CustomContent_tank_74',
                    Uu = 'CustomContent_footer_dd',
                    qu = 'CustomContent_messageWrapper_79',
                    Zu = 'CustomContent_textWrapper_33',
                    Qu = 'CustomContent_check_37',
                    Yu = 'CustomContent_text_e9',
                    Xu = R.strings.battle_pass.tooltips,
                    Ju = (0, cu.Pi)(() => {
                        const u = yu().model.root.get().isBattlePassPurchased;
                                    ...
                                    n().createElement(Su, {
                                        text: n().createElement(
                                            ...
                                            n().createElement(
                                                'div',
                                                { className: Yu },
                                                u ? Xu.completed.claimRewards() : Xu.completed.rewardsObtained(),
                                            ),
                                        ),
                                    }),
                                ),
                    ...
                    Ku = R.strings.battle_pass.tooltips,
                    ue = (0, cu.Pi)(() => {
                        const u = yu().model,
                            e = u.root.get(),
                            ...
                            D = A > 0,
                            t = u.computes.isHoliday();
                        return n().createElement(
                            'div',
                            { className: a()(ku, F && !D && !E && Nu) },
                                ...
                                : n().createElement(
                                      ...
                                      n().createElement(
                                          ...
                                          n().createElement(
                                              'div',
                                              { className: Iu },
                                              n().createElement(Su, { text: Ku.completed.message() }),
                                          ),
                                      ),
                                  ),
                            n().createElement(
                                ...
                                { className: $u },
                                D &&
                                    n().createElement(du.l, {
                                        icon: R.images.gui.maps.icons.battlePass.tooltips.bow_small(),
                                        text: A > 1 ? Ku.claimRewards.multiple() : Ku.claimRewards.c_1(),
                                        className: Vu,
                                    }),
                                !F &&
                                    n().createElement(du.l, {
                                        icon: R.images.gui.maps.icons.battlePass.progression.icon_lock_current_small(),
                                        text: Ku.unlockBattlePass(),
                                        className: Vu,
                                    }),
                                E &&
                                    n().createElement(du.l, {
                                        icon: R.images.gui.maps.icons.battlePass.icons.tankmen_small(),
                                        text: Ku.completed.tankmenNotRecieved(),
                                        className: a()(Vu),
                                    }),
                            ),
                        );
                    }),
                    ee = () => n().createElement(lu, null, n().createElement(ue, null));
                engine.whenReady.then(() => {
                    r().render(
                        n().createElement(wu, null, n().createElement(ee, null)),
            ...
            4981: (u, e, F) => {
                ...
                const n = {
                    ...
                    r = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    o = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    a = (0, D.memo)(({ text: u, binding: e, classMix: F }) => {
                                ...
                                (i = i.replace(F, `%(${C})`)),
                                    (E[C] = n[u]
                                        ? t().createElement(
                                              'span',
                                              { className: n[u] },
                                              t().createElement(B.z, { text: c, binding: e }),
                                          )
                                        : t().createElement(
                                              'span',
                                              { style: A(u) },
                        ...
                        return t().createElement(B.z, { text: i, classMix: F, binding: E });
                    }),
                    i = 'IconTextBlock_base_46',
                    s = 'IconTextBlock_icon_c9',
                    l = 'IconTextBlock_text_89',
                    c = (0, D.memo)(({ icon: u, text: e, className: F }) => {
                        const A = (0, D.useMemo)(() => ({ backgroundImage: `url(${u})` }), [u]),
                            B = E()(i, F);
                        return t().createElement(
                            'div',
                            { className: B },
                            t().createElement('div', { className: s, style: A }),
                            t().createElement(a, { classMix: l, text: e }),
                        );
                    });
            },
            5287: (u, e, F) => {
        ...
        (A.O = (e, F, E, D) => {
            if (!F) {
                ...
                for (r = 0; r < u.length; r++) {
                    for (var [F, E, D] = u[r], B = !0, n = 0; n < F.length; n++)
                        (!1 & D || t >= D) && Object.keys(A.O).every((u) => A.O[u](F[n]))
                            ? F.splice(n--, 1)
                            : ((B = !1), D < t && (t = D));
                    if (B) {
                        u.splice(r--, 1);
