        ...
        e = {
            ...
            1634: (u, e, t) => {
                ...
                const Ru = {
                    ...
                    Ou = wu((u) => {
                        ...
                        const G = (0, Q.useMemo)(() => {
                            ...
                            }, [t, A, r, a, i, l, O, H, S, d, M, p, b]),
                            N = G.computedStyle,
                            j = G.computedClassNames;
                        return Z().createElement('div', yu({ className: n()(Lu.base, ...j, e), style: N }, W), P);
                    });
                let Pu;
                !(function (u) {
                ...
                const ie = ((u, e) => {
                    ...
                    oe = 'App_base_ae',
                    me = 'App_goldIcon_c2',
                    se = R.strings.battle_pass.progression,
                    de = (0, Fe.Pi)(() => {
                        const u = le().model.root.get().isActive;
                        return Z().createElement(
                            'div',
                            { className: oe },
                            Z().createElement(Ae, {
                                text: u ? se.episodeBuyBtnTooltipActive() : se.episodeBuyBtnTooltipInactive(),
                                format: { binding: { goldIcon: Z().createElement('div', { className: me }) } },
                            }),
                        );
                    });
                engine.whenReady.then(() => {
                    Eu().render(
                        Z().createElement(Ce, null, Z().createElement(Au, null, Z().createElement(de, null))),
