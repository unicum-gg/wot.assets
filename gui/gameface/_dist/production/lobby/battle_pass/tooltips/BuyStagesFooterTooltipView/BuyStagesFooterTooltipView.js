        ...
        e = {
            ...
            1634: (u, e, t) => {
                ...
                const Ce = ((u, e) => {
                    ...
                    me = 'App_base_ae',
                    se = 'App_goldIcon_c2',
                    de = R.strings.battle_pass.progression,
                    ce = (0, Ee.Pi)(() => {
                        const u = oe().model.root.get().isActive;
                        return J().createElement(
                            'div',
                            { className: me },
                            J().createElement(Fe, {
                                text: u ? de.episodeBuyBtnTooltipActive() : de.episodeBuyBtnTooltipInactive(),
                                format: { binding: { goldIcon: J().createElement('div', { className: se }) } },
                            }),
                        );
                    });
                engine.whenReady.then(() => {
                    ru().render(
                        J().createElement(le, null, J().createElement(Fu, null, J().createElement(ce, null))),
