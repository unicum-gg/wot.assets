    ...
    var u,
        A = {
            1722: (u, A, F) => {
                ...
                var D = {};
                F.r(D), F.d(D, { getBgUrl: () => S, getTextureUrl: () => P });
                var B = {};
                F.r(B),
                    F.d(B, {
                        addModelObserver: () => H,
                ...
                function Z(u = 'rem') {
                    ...
                    return 'rem' === u ? A : { x: Y(A.x), y: Y(A.y) };
                }
                function J() {
                ...
                const Bu = (() => {
                    ...
                    tu = Object.keys(T).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === T[A]), u), {}),
                    Cu = {
                        set: (u, A) => {
                ...
                const lu = C().forwardRef(function (u, A) {
                    let F = u.children,
                        e = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        C().createElement(
                            ...
                            C().createElement('div', { className: iu.decorator }, F),
                        )
                    );
                });
                var cu = F(3403);
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const t = 'string' == typeof D ? `${e}.${D}` : e,
                                                            C = ru.view.addModelObserver(t, A, !0);
                ...
                const Pu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Tu = (u, A, F = xu.left) => u.split(A).reduce(F === xu.left ? Su : Ru, []),
                    Ou = (() => {
                        const u = new RegExp(
                    ...
                    Mu = (u, A = xu.left) => {
                        ...
                        return ((u, A = xu.left) => {
                            ...
                            const e =
                                ...
                                E = Pu(u);
                            return Tu(E, /( )/, A).forEach((u) => (F = F.concat(Tu(u, e, xu.left)))), F;
                        })(u, A);
                    },
                    ju = 'FormatText_base_d0',
                    Nu = ({ binding: u, text: A = '', classMix: F, alignment: e = xu.left, formatWithBrackets: E }) => {
                        if (null === A) return console.error("FormatText was supplied with 'null'"), null;
                        const D = E && u ? _u(A, u) : A;
                        return C().createElement(
                            ...
                            D.split('\n').map((A, E) =>
                                C().createElement(
                                    'div',
                                    { className: i()(ju, F), key: `${A}-${E}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : Mu(u, A))))(
                                        A,
                                        e,
                                        u,
                    ...
                    ku = 'Message_base_24',
                    Lu = 'Message_separator_51',
                    Vu = 'Message_content_ea',
                    Gu = 'Message_text_f3',
                    $u = 'Message_lightWrapper_d3',
                    Iu = 'Message_lightWrapper__x2_8f',
                    Wu = 'Message_light_a9',
                    Hu = 'Message_points_53',
                    Uu = 'Message_check_01',
                    qu = R.strings.battle_pass.tooltips.notChosen,
                    Qu = ({ points: u }) => {
                        const A = (() => {
                            const u = (0, t.useState)(ru.view.getScale()),
                                A = u[0],
                                F = u[1];
                            return (
                                (0, t.useEffect)(() => {
                        ...
                        return C().createElement(
                            'div',
                            { className: ku },
                            C().createElement('div', { className: Lu }),
                            C().createElement(
                                'div',
                                { className: Vu },
                                C().createElement(
                                    ...
                                    C().createElement(Nu, {
                                        ...
                                        binding: {
                                            points: C().createElement(
                                                ...
                                                C().createElement(
                                                    'div',
                                                    { className: i()($u, 2 === A && Iu) },
                                                    C().createElement('div', { className: Wu }),
                                                ),
                                                C().createElement('div', { className: Uu }, u),
                                            ),
                                        },
                                    }),
                                ),
                    ...
                    Zu = 'Content_base_d5',
                    Ju = 'Content_separator_b7',
                    Ku = 'Content_title_59',
                    Xu = 'Content_subtitle_b4',
                    Yu = 'Content_messageWrapper_5e',
                    uA = 'Content_description_cb',
                    AA = 'Content_separatorWrapper_0e',
                    FA = R.strings.battle_pass.tooltips.notChosen,
                    eA = (0, cu.Pi)(() => {
                        const u = hu().model.root.get().points;
                        return C().createElement(
                            'div',
                            { className: Zu },
                            C().createElement('div', { className: Ku }, FA.title()),
                            C().createElement('div', { className: Xu }, FA.subTitle()),
                            u > 0
                                ? C().createElement('div', { className: Yu }, C().createElement(Qu, { points: u }))
                                : C().createElement(
                                      'div',
                                      { className: AA },
                                      C().createElement('div', { className: Ju }),
                                  ),
                            C().createElement('div', { className: uA }, FA.description()),
                        );
                    }),
                    EA = () => C().createElement(lu, null, C().createElement(eA, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(wu, null, C().createElement(EA, null)),
