    ...
    var u,
        A = {
            6978: (u, A, F) => {
                ...
                const X = Object.keys(b).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === b[A]), u), {}),
                    Y = {
                        set: (u, A) => {
                ...
                const Bu = C().forwardRef(function (u, A) {
                    let F = u.children,
                        e = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        C().createElement(
                            ...
                            C().createElement('div', { className: eu.decorator }, F),
                        )
                    );
                });
                var tu = F(3403);
                ...
                function ou(u, A) {
                    ...
                    if (
                        ...
                        (F = (function (u, A) {
                            if (!u) return;
                            if ('string' == typeof u) return iu(u, A);
                ...
                const vu = (u, A, F) => {
                    ...
                    gu = (u, A, F = du.left) => u.split(A).reduce(F === du.left ? vu : mu, []),
                    fu = (() => {
                        const u = new RegExp(
                        ...
                        return pu.includes(F)
                            ...
                            : ((u, A = du.left) => {
                                  ...
                                  const e =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (gu(E, /( )/, A).forEach((u) => (F = F.concat(gu(u, e, du.left)))), F);
                              })(u, A);
                    },
                    hu = 'FormatText_base_d0',
                    wu = ({ binding: u, text: A = '', classMix: F, alignment: e = du.left }) =>
                        null === A
                            ...
                            : C().createElement(
                                  ...
                                  A.split('\n').map((A, E) =>
                                      C().createElement(
                                          'div',
                                          { className: i()(hu, F), key: `${A}-${E}` },
                                          ((u, A, F) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (F && u in F ? F[u] : bu(u, A))))(A, e, u).map((u, A) =>
                    ...
                    yu = ({ points: u, text: A, bindingValue: F, isChapterMessaage: e = !1 }) => {
                        const E = (() => {
                        ...
                        return C().createElement(
                            'div',
                            { className: xu.base },
                            C().createElement('div', { className: xu.separator }),
                            C().createElement(
                                'div',
                                { className: i()(xu.content, e && xu.content__chapter) },
                                C().createElement(
                                    'div',
                                    { className: i()(xu.text, e && xu.text__chapter) },
                                    C().createElement(wu, {
                                        text: A,
                                        binding:
                                            null != F
                                                      ...
                                                      points: C().createElement(
                                                          ...
                                                          C().createElement(
                                                              'div',
                                                              {
                                                                  className: i()(
                                                                      xu.lightWrapper,
                                                                      2 === E && xu.lightWrapper__x2,
                                                                  ),
                                                              },
                                                              C().createElement('div', { className: xu.light }),
                                                          ),
                                                          C().createElement('div', { className: xu.check }, u),
                                                      ),
                                                  },
                                    }),
                                ),
                    ...
                    _u = 'Content_base_d5',
                    Pu = 'Content_separator_b7',
                    Ou = 'Content_base__disabled_04',
                    Ru = 'Content_title_59',
                    Su = 'Content_subtitle_b4',
                    Tu = 'Content_messageWrapper_5e',
                    Mu = 'Content_description_cb',
                    zu = 'Content_separatorWrapper_0e',
                    ju = R.strings.battle_pass.tooltips.notChosen,
                    Nu = (0, tu.Pi)(() => {
                        ...
                        return C().createElement(
                            'div',
                            { className: i()(_u, !e && Ou) },
                            C().createElement('div', { className: Ru }, ju.title()),
                            C().createElement('div', { className: Su }, ju.subTitle()),
                            e &&
                                C().createElement(
                                    'div',
                                    { className: Tu },
                            ...
                            A > 0
                                ? C().createElement(
                                      'div',
                                      { className: Tu },
                                      C().createElement(yu, { points: A, text: ju.points() }),
                                  )
                                : !e &&
                                      C().createElement(
                                          'div',
                                          { className: zu },
                                          C().createElement('div', { className: Pu }),
                                      ),
                            C().createElement('div', { className: Mu }, ju.description()),
                        );
                    }),
                    ku = () => C().createElement(Bu, null, C().createElement(Nu, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(cu, null, C().createElement(ku, null)),
