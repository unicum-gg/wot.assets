    ...
    var u,
        e = {
            980: (u, e, A) => {
                ...
                const su = Object.keys(L).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === L[e]), u), {}),
                    lu = {
                        set: (u, e) => {
                ...
                const fu = { view: B, client: E, sound: S, intl: x };
                const mu = {
                ...
                const bu = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            pu({}, B, {
                                className: i()(mu.base, mu[`base__theme-${D}`], F),
                                ref: function (u) {
                                                ...
                                                return {
                                                    subscribe: (A, D) => {
                                                        const t = 'string' == typeof D ? `${F}.${D}` : F,
                                                            n = fu.view.addModelObserver(t, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = _u(E.keys()); !(u = A()).done; ) D(u.value, e);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(F),
                ...
                const Lu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Vu = (u, e, A = Mu.left) => u.split(e).reduce(A === Mu.left ? ku : Nu, []),
                    $u = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Iu = (u, e = Mu.left) => {
                        ...
                        return ((u, e = Mu.left) => {
                            ...
                            const F =
                                ...
                                E = Lu(u);
                            return (Vu(E, /( )/, e).forEach((u) => (A = A.concat(Vu(u, F, Mu.left)))), A);
                        })(u, e);
                    },
                    Uu = 'FormatText_base_f27a4',
                    Wu = ({ binding: u, text: e = '', classMix: A, alignment: F = Mu.left, formatWithBrackets: E }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const D = E && u ? ju(e, u) : e;
                        return n().createElement(
                            ...
                            D.split('\n').map((e, E) =>
                                n().createElement(
                                    'div',
                                    { className: i()(Uu, A), key: `${e}-${E}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : Iu(u, e))))(
                                        e,
                                        F,
                                        u,
                                    ).map((u, e) => n().createElement(t.Fragment, { key: `${e}-${u}` }, u)),
                                ),
                            ),
                        );
                    },
                    Hu = 'Message_base_d3696',
                    qu = 'Message_separator_f3816',
                    Qu = 'Message_content_cb86e',
                    Xu = 'Message_text_c33bc',
                    Zu = 'Message_lightWrapper_f1fc2',
                    Ju = 'Message_lightWrapper__x2_cab7b',
                    Ku = 'Message_light_bdd6f',
                    Yu = 'Message_points_f224f',
                    ue = 'Message_check_accbf',
                    ee = R.strings.battle_pass.tooltips.notChosen,
                    Ae = ({ points: u }) => {
                        const e = (() => {
                            const u = (0, t.useState)(fu.view.getScale()),
                                e = u[0],
                                A = u[1];
                            return (
                                (0, t.useEffect)(() => {
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(Wu, {
                                        text: ee.points(),
                                        binding: {
                                            points: n().createElement(
                                                'div',
                                                { className: Yu },
                                                n().createElement(
                                                    'div',
                                                    { className: i()(Zu, 2 === e && Ju) },
                    ...
                    Fe = 'Content_base_d9948',
                    Ee = 'Content_separator_e762b',
                    De = 'Content_title_a6602',
                    Be = 'Content_subtitle_d9391',
                    te = 'Content_messageWrapper_f05fa',
                    ne = 'Content_description_f0d8b',
                    Ce = 'Content_separatorWrapper_f120b',
                    re = R.strings.battle_pass.tooltips.notChosen,
                    oe = (0, wu.Pi)(() => {
                        const u = Tu().model.root.get().points;
                        return n().createElement(
                            'div',
                            { className: Fe },
                            n().createElement('div', { className: De }, re.title()),
                            n().createElement('div', { className: Be }, re.subTitle()),
                            u > 0
                                ? n().createElement('div', { className: te }, n().createElement(Ae, { points: u }))
                                : n().createElement(
                                      'div',
                                      { className: Ce },
                                      n().createElement('div', { className: Ee }),
                                  ),
                            n().createElement('div', { className: ne }, re.description()),
                        );
                    }),
                    ie = () => n().createElement(bu, null, n().createElement(oe, null));
                engine.whenReady.then(() => {
                    r().render(
                        n().createElement(Ou, null, n().createElement(ie, null)),
