    ...
    var u,
        e = {
            9237: (u, e, A) => {
                var F = {};
                (A.r(F),
                    A.d(F, { mouse: () => g, off: () => v, on: () => d, onResize: () => l, onScaleUpdated: () => c }));
                var E = {};
                (A.r(E),
                    A.d(E, {
                        events: () => F,
                ...
                var D = {};
                (A.r(D), A.d(D, { getBgUrl: () => z, getTextureUrl: () => M }));
                var B = {};
                (A.r(B),
                    A.d(B, {
                        addModelObserver: () => Q,
                ...
                const iu = Object.keys(j).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === j[e]), u), {}),
                    au = {
                        set: (u, e) => {
                ...
                const pu = n().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        E = u.theme,
                                                ...
                                                return {
                                                    subscribe: (A, D) => {
                                                        const t = 'string' == typeof D ? `${F}.${D}` : F,
                                                            n = du.view.addModelObserver(t, e, !0);
                ...
                const ju = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Nu = (u, e, A = Mu.left) => u.split(e).reduce(A === Mu.left ? Lu : ku, []),
                    Vu = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Gu = (u, e = Mu.left) => {
                        ...
                        return ((u, e = Mu.left) => {
                            ...
                            const F =
                                ...
                                E = ju(u);
                            return (Nu(E, /( )/, e).forEach((u) => (A = A.concat(Nu(u, F, Mu.left)))), A);
                        })(u, e);
                    },
                    Iu = 'FormatText_base_d0',
                    Uu = ({ binding: u, text: e = '', classMix: A, alignment: F = Mu.left, formatWithBrackets: E }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const D = E && u ? zu(e, u) : e;
                        return n().createElement(
                            ...
                            D.split('\n').map((e, E) =>
                                n().createElement(
                                    'div',
                                    { className: i()(Iu, A), key: `${e}-${E}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : Gu(u, e))))(
                                        e,
                                        F,
                                        u,
                    ...
                    Wu = 'Message_base_24',
                    Hu = 'Message_separator_51',
                    qu = 'Message_content_ea',
                    Qu = 'Message_text_f3',
                    Xu = 'Message_lightWrapper_d3',
                    Zu = 'Message_lightWrapper__x2_8f',
                    Ju = 'Message_light_a9',
                    Ku = 'Message_points_53',
                    Yu = 'Message_check_01',
                    ue = R.strings.battle_pass.tooltips.notChosen,
                    ee = ({ points: u }) => {
                        const e = (() => {
                            const u = (0, t.useState)(du.view.getScale()),
                                e = u[0],
                                A = u[1];
                            return (
                                (0, t.useEffect)(() => {
                                    ...
                                    n().createElement(Uu, {
                                        ...
                                        binding: {
                                            points: n().createElement(
                                                ...
                                                n().createElement(
                                                    'div',
                                                    { className: i()(Xu, 2 === e && Zu) },
                                                    n().createElement('div', { className: Ju }),
                                                ),
                                                n().createElement('div', { className: Yu }, u),
                                            ),
                                        },
                                    }),
                                ),
                    ...
                    Ae = 'Content_base_d5',
                    Fe = 'Content_separator_b7',
                    Ee = 'Content_title_59',
                    De = 'Content_subtitle_b4',
                    Be = 'Content_messageWrapper_5e',
                    te = 'Content_description_cb',
                    ne = 'Content_separatorWrapper_0e',
                    Ce = R.strings.battle_pass.tooltips.notChosen,
                    re = (0, bu.Pi)(() => {
                        const u = Ou().model.root.get().points;
                        return n().createElement(
                            'div',
                            { className: Ae },
                            n().createElement('div', { className: Ee }, Ce.title()),
                            n().createElement('div', { className: De }, Ce.subTitle()),
                            u > 0
                                ? n().createElement('div', { className: Be }, n().createElement(ee, { points: u }))
                                : n().createElement(
                                      'div',
                                      { className: ne },
                                      n().createElement('div', { className: Fe }),
                                  ),
                            n().createElement('div', { className: te }, Ce.description()),
                        );
                    }),
                    oe = () => n().createElement(pu, null, n().createElement(re, null));
                engine.whenReady.then(() => {
                    r().render(
                        n().createElement(Su, null, n().createElement(oe, null)),
