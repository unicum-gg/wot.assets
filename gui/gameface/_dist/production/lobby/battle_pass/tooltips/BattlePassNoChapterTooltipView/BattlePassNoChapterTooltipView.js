    ...
    var u,
        A = {
            8466: (u, A, F) => {
                var e = {};
                (F.r(e),
                    F.d(e, { mouse: () => f, off: () => v, on: () => d, onResize: () => l, onScaleUpdated: () => c }));
                var E = {};
                (F.r(E),
                    F.d(E, {
                        events: () => e,
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => M, getTextureUrl: () => T }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => q,
                ...
                const h = {
                    ...
                    x = Object.keys(y).reduce((u, A) => ((u[A] = () => g(y[A])), u), {}),
                    _ = { play: Object.assign({}, x, { sound: g }), setRTPC: p },
                    P = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    S = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function O(u) {
                    let A = '';
                    for (let F = S.length - 1; F >= 0; F--) for (; u >= S[F]; ) ((A += P[F]), (u -= S[F]));
                    return A;
                }
                ...
                const Cu = (() => {
                    ...
                    nu = O,
                    ru = Object.keys(z).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === z[A]), u), {}),
                    ou = {
                        set: (u, A) => {
                ...
                const vu = C().forwardRef(function (u, A) {
                    let F = u.children,
                        e = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        C().createElement(
                            ...
                            C().createElement('div', { className: lu.decorator }, F),
                        )
                    );
                });
                var mu = F(3403);
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const t = 'string' == typeof D ? `${e}.${D}` : e,
                                                            C = au.view.addModelObserver(t, A, !0);
                ...
                const Ou = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    zu = (u, A, F = Ru.left) => u.split(A).reduce(F === Ru.left ? Tu : Mu, []),
                    ju = (() => {
                        const u = new RegExp(
                    ...
                    Nu = (u, A = Ru.left) => {
                        ...
                        return ((u, A = Ru.left) => {
                            ...
                            const e =
                                ...
                                E = Ou(u);
                            return (zu(E, /( )/, A).forEach((u) => (F = F.concat(zu(u, e, Ru.left)))), F);
                        })(u, A);
                    },
                    Lu = 'FormatText_base_d0',
                    Vu = ({ binding: u, text: A = '', classMix: F, alignment: e = Ru.left, formatWithBrackets: E }) => {
                        ...
                        return C().createElement(
                            ...
                            D.split('\n').map((A, E) =>
                                C().createElement(
                                    'div',
                                    { className: i()(Lu, F), key: `${A}-${E}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : Nu(u, A))))(
                                        A,
                                        e,
                                        u,
                    ...
                    Gu = 'Message_base_24',
                    Iu = 'Message_separator_51',
                    $u = 'Message_content_ea',
                    Wu = 'Message_text_f3',
                    Hu = 'Message_lightWrapper_d3',
                    Uu = 'Message_lightWrapper__x2_8f',
                    qu = 'Message_light_a9',
                    Qu = 'Message_points_53',
                    Xu = 'Message_check_01',
                    Zu = R.strings.battle_pass.tooltips.notChosen,
                    Ju = ({ points: u }) => {
                        const A = (() => {
                            const u = (0, t.useState)(au.view.getScale()),
                                A = u[0],
                                F = u[1];
                            return (
                                (0, t.useEffect)(() => {
                        ...
                        return C().createElement(
                            'div',
                            { className: Gu },
                            C().createElement('div', { className: Iu }),
                            C().createElement(
                                'div',
                                { className: $u },
                                C().createElement(
                                    ...
                                    C().createElement(Vu, {
                                        ...
                                        binding: {
                                            points: C().createElement(
                                                ...
                                                C().createElement(
                                                    'div',
                                                    { className: i()(Hu, 2 === A && Uu) },
                                                    C().createElement('div', { className: qu }),
                                                ),
                                                C().createElement('div', { className: Xu }, u),
                                            ),
                                        },
                                    }),
                                ),
                    ...
                    Ku = 'Content_base_d5',
                    Yu = 'Content_separator_b7',
                    uA = 'Content_title_59',
                    AA = 'Content_subtitle_b4',
                    FA = 'Content_messageWrapper_5e',
                    eA = 'Content_description_cb',
                    EA = 'Content_separatorWrapper_0e',
                    DA = R.strings.battle_pass.tooltips.notChosen,
                    BA = (0, mu.Pi)(() => {
                        const u = _u().model.root.get().points;
                        return C().createElement(
                            'div',
                            { className: Ku },
                            C().createElement('div', { className: uA }, DA.title()),
                            C().createElement('div', { className: AA }, DA.subTitle()),
                            u > 0
                                ? C().createElement('div', { className: FA }, C().createElement(Ju, { points: u }))
                                : C().createElement(
                                      'div',
                                      { className: EA },
                                      C().createElement('div', { className: Yu }),
                                  ),
                            C().createElement('div', { className: eA }, DA.description()),
                        );
                    }),
                    tA = () => C().createElement(vu, null, C().createElement(BA, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(xu, null, C().createElement(tA, null)),
