        ...
        e = {
            ...
            3649: (u, e, t) => {
                ...
                const a = (u, e, t) => {
                    ...
                    s = (u, e, t) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : l(u, e)));
            },
            6583: (u, e, t) => {
                'use strict';
                t.d(e, { e: () => D });
                ...
                const i = 'VehicleList_base_b7',
                    ...
                    B = ({ vehiclesList: u }) => {
                        ...
                        return F().createElement(
                            ...
                            { className: i },
                            E.UI(u, (u, t) =>
                                F().createElement(r.z, { classMix: D, text: u.textResource, key: t, binding: e(u) }),
                            ),
                        );
                    };
            },
            ...
            9351: (u, e, t) => {
                ...
                const n = ({
                    ...
                    a().createElement(
                        'div',
                        { className: E()(A, F.Z.base), style: r ? { width: '100%', backgroundSize: '100% 100%' } : {} },
                        t &&
                            a().createElement(
                                'div',
