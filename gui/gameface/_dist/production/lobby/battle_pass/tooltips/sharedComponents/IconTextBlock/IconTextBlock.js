        ...
        F = {
                ...
                const r = ({
                    ...
                    return e().createElement(
                        ...
                        a.split('\n').map((F, r) =>
                            e().createElement(
                                'div',
                                { className: D()(t.Z.base, A), key: `${F}-${r}` },
            ...
            6758: (u, F, A) => {
                ...
                const C = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    r = (u, F, A = D.left) => u.split(F).reduce(A === D.left ? e : t, []),
                    a = (() => {
                        const u = new RegExp(
                            [
                    ...
                    n = (u, F = D.left) => {
                        ...
                        return ((u, F = D.left) => {
                            ...
                            const E =
                                ...
                                B = C(u);
                            return (r(B, /( )/, F).forEach((u) => (A = A.concat(r(u, E, D.left)))), A);
                        })(u, F);
                    },
            ...
            3073: (u, F, A) => {
                ...
                const t = {
                    ...
                    a = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    o = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    n = (0, B.memo)(({ text: u, binding: F, classMix: A }) => {
                                ...
                                ((l = l.replace(A, `%(${r})`)),
                                    (D[r] = t[u]
                                        ? C().createElement(
                                              'span',
                                              { className: t[u] },
                                              C().createElement(e.z, { text: c, binding: F }),
                                          )
                                        : C().createElement(
                                              'span',
                                              { style: E(u) },
                ...
                (0, B.memo)(({ icon: u, text: F, className: A }) => {
                    ...
                    return C().createElement(
                        'div',
                        { className: e },
                        C().createElement('div', { className: s, style: E }),
                        C().createElement(n, { classMix: i, text: F }),
                    );
                });
            },
            4880: (u, F, A) => {
