        ...
        A = {
            2441: (u, A, F) => {
                ...
                const y = {
                    ...
                    _ = Object.keys(P).reduce((u, A) => ((u[A] = () => p(P[A])), u), {}),
                    S = { play: Object.assign({}, _, { sound: p }), setRTPC: b },
                    O = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    T = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function z(u) {
                    let A = '';
                    for (let F = T.length - 1; F >= 0; F--) for (; u >= T[F];) ((A += O[F]), (u -= T[F]));
                    return A;
                }
                ...
                const su = Object.keys(L).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === L[A]), u), {}),
                    lu = {
                        set: (u, A) => {
                ...
                function xu(u, A) {
                    ...
                    if (
                        ...
                        (F = (function (u, A) {
                            if (u) {
                                if ('string' == typeof u) return Pu(u, A);
                                    ...
                                    r = (F, e, E) => {
                                        ...
                                        const B = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = xu(E.keys()); !(u = F()).done;) D(u.value, A);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(e),
                ...
                const ju = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Vu = (u, A, F = zu.left) => u.split(A).reduce(F === zu.left ? Lu : ku, []),
                    $u = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Nu = (u, A = zu.left) => {
                        ...
                        return ((u, A = zu.left) => {
                            ...
                            const e =
                                ...
                                E = ju(u);
                            return (Vu(E, /( )/, A).forEach((u) => (F = F.concat(Vu(u, e, zu.left)))), F);
                        })(u, A);
                    },
                    Iu = 'FormatText_base_f27a4',
                    Uu = ({ binding: u, text: A = '', classMix: F, alignment: e = zu.left, formatWithBrackets: E }) => {
                        if (null === A) return (console.error("FormatText was supplied with 'null'"), null);
                        const D = E && u ? Mu(A, u) : A;
                ...
                var Hu = F(2041);
                const qu = 'Content_base_b2efe',
                    Wu = 'Content_separator_d563b',
                    Qu = 'Content_title_c6830',
                    Xu = 'Content_text_ed90d',
                    Zu = 'Content_currency_a015a',
                    Ju = 'Content_icon_bbd27',
                    Ku = 'Content_duration_d499c',
                    Yu = 'Content_description_c6759',
                    uA = 'Content_highlight_fe069',
                    AA = R.strings.battle_pass.tooltips.goldMission,
                    FA = (0, Hu.Pi)(() => {
                        const u = Ou().model;
                        return n().createElement(
                            'div',
                            { className: qu },
                            n().createElement('div', { className: Qu }, AA.title()),
                            n().createElement(Uu, {
                                classMix: Xu,
                                text: AA.text(),
                                binding: {
                                    count: n().createElement('span', { className: Zu }, u.count.get()),
                                    icon: n().createElement('span', { className: Ju }),
                                    duration: n().createElement(Uu, {
                                        classMix: Ku,
                                        text: AA.textDuration(),
                            ...
                            n().createElement(Uu, {
                                ...
                                binding: {
                                    highlight: n().createElement(
                                        'span',
                                        { className: uA },
                                        AA.highlightedDescription(),
                                    ),
                                },
                            }),
                        );
                    }),
                    eA = () => n().createElement(bu, null, n().createElement(Su, null, n().createElement(FA, null)));
                engine.whenReady.then(() => {
                    r().render(n().createElement(eA, null), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
