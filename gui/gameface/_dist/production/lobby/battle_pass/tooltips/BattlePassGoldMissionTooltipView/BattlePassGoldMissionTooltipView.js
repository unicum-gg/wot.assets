    ...
    var u,
        A = {
            8119: (u, A, F) => {
                var e = {};
                (F.r(e),
                    F.d(e, { mouse: () => g, off: () => v, on: () => d, onResize: () => l, onScaleUpdated: () => c }));
                var E = {};
                (F.r(E),
                    F.d(E, {
                        events: () => e,
                ...
                var D = {};
                (F.r(D), F.d(D, { getBgUrl: () => M, getTextureUrl: () => z }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => Q,
                ...
                const w = {
                    ...
                    P = Object.keys(x).reduce((u, A) => ((u[A] = () => m(x[A])), u), {}),
                    _ = { play: Object.assign({}, P, { sound: m }), setRTPC: p },
                    S = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    O = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function T(u) {
                    let A = '';
                    for (let F = O.length - 1; F >= 0; F--) for (; u >= O[F]; ) ((A += S[F]), (u -= O[F]));
                    return A;
                }
                ...
                const iu = Object.keys(j).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === j[A]), u), {}),
                    au = {
                        set: (u, A) => {
                ...
                const du = { view: B, client: E, sound: _, intl: y };
                function vu() {
                ...
                const _u = ((u, A) => {
                        ...
                        const A = { root: u.primitives(['count', 'days']) };
                        return Object.assign({}, A.root);
                    }, bu),
                    Ru = _u[0],
                    Su = _u[1];
                var Ou = F(1281);
                ...
                const Mu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Lu = (u, A, F = Tu.left) => u.split(A).reduce(F === Tu.left ? ju : ku, []),
                    Vu = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Gu = (u, A = Tu.left) => {
                        ...
                        return ((u, A = Tu.left) => {
                            ...
                            const e =
                                ...
                                E = Mu(u);
                            return (Lu(E, /( )/, A).forEach((u) => (F = F.concat(Lu(u, e, Tu.left)))), F);
                        })(u, A);
                    },
                    Nu = 'FormatText_base_d0',
                    Iu = ({ binding: u, text: A = '', classMix: F, alignment: e = Tu.left, formatWithBrackets: E }) => {
                        if (null === A) return (console.error("FormatText was supplied with 'null'"), null);
                        const D = E && u ? zu(A, u) : A;
                        return n().createElement(
                            ...
                            D.split('\n').map((A, E) =>
                                n().createElement(
                                    'div',
                                    { className: i()(Nu, F), key: `${A}-${E}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : Gu(u, A))))(
                                        A,
                                        e,
                                        u,
                ...
                var Uu = F(3403);
                const Hu = 'Content_base_17',
                    qu = 'Content_separator_9c',
                    Wu = 'Content_title_01',
                    Qu = 'Content_text_bc',
                    Xu = 'Content_currency_1a',
                    Zu = 'Content_icon_eb',
                    Ju = 'Content_duration_9f',
                    Ku = 'Content_description_b6',
                    Yu = 'Content_highlight_bd',
                    uA = R.strings.battle_pass.tooltips.goldMission,
                    AA = (0, Uu.Pi)(() => {
                        const u = Su().model;
                        return n().createElement(
                            'div',
                            { className: Hu },
                            n().createElement('div', { className: Wu }, uA.title()),
                            n().createElement(Iu, {
                                classMix: Qu,
                                text: uA.text(),
                                binding: {
                                    count: n().createElement('span', { className: Xu }, u.count.get()),
                                    icon: n().createElement('span', { className: Zu }),
                                    duration: n().createElement(Iu, {
                                        classMix: Ju,
                                        text: uA.textDuration(),
                                        binding: { days: u.days.get() },
                                    }),
                                },
                            }),
                            ...
                            n().createElement(Iu, {
                                ...
                                text: uA.description(),
                                binding: {
                                    highlight: n().createElement(
                                        'span',
                                        { className: Yu },
                                        uA.highlightedDescription(),
                                    ),
                                },
                            }),
                        );
                    }),
                    FA = () => n().createElement(pu, null, n().createElement(Ru, null, n().createElement(AA, null)));
                engine.whenReady.then(() => {
                    r().render(n().createElement(FA, null), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
