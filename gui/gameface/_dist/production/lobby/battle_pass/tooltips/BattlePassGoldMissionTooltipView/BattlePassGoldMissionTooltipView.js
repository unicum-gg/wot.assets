    ...
    var u,
        A = {
            5825: (u, A, F) => {
                ...
                var D = {};
                F.r(D), F.d(D, { getBgUrl: () => z, getTextureUrl: () => T });
                var B = {};
                F.r(B),
                    F.d(B, {
                        addModelObserver: () => W,
                ...
                const Cu = (() => {
                    ...
                    nu = S,
                    ru = Object.keys(M).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === M[A]), u), {}),
                    ou = {
                        set: (u, A) => {
                ...
                const Ou = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    zu = (u, A, F = Pu.left) => u.split(A).reduce(F === Pu.left ? Su : Tu, []),
                    Mu = (() => {
                        const u = new RegExp(
                        ...
                        return C().createElement(
                            ...
                            D.split('\n').map((A, e) =>
                                C().createElement(
                                    ...
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : ku(u, A))))(
                                        A,
                                        E,
                                        u,
                ...
                var Gu = F(3403);
                const Nu = 'Content_base_17',
                    Iu = 'Content_separator_9c',
                    $u = 'Content_title_01',
                    Hu = 'Content_text_bc',
                    Uu = 'Content_currency_1a',
                    qu = 'Content_icon_eb',
                    Wu = 'Content_duration_9f',
                    Qu = 'Content_description_b6',
                    Xu = 'Content_highlight_bd',
                    Zu = R.strings.battle_pass.tooltips.goldMission,
                    Ju = (0, Gu.Pi)(() => {
                        const u = xu().model;
                        return C().createElement(
                            'div',
                            { className: Nu },
                            C().createElement('div', { className: $u }, Zu.title()),
                            C().createElement(Vu, {
                                classMix: Hu,
                                text: Zu.text(),
                                binding: {
                                    count: C().createElement('span', { className: Uu }, u.count.get()),
                                    icon: C().createElement('span', { className: qu }),
                                    duration: C().createElement(Vu, {
                                        classMix: Wu,
                                        text: Zu.textDuration(),
                            ...
                            C().createElement(Vu, {
                                ...
                                text: Zu.description(),
                                binding: {
                                    highlight: C().createElement(
                                        'span',
                                        { className: Xu },
                                        Zu.highlightedDescription(),
                                    ),
                                },
                            }),
                        );
                    }),
                    Ku = () => C().createElement(vu, null, C().createElement(yu, null, C().createElement(Ju, null)));
                engine.whenReady.then(() => {
                    r().render(C().createElement(Ku, null), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
