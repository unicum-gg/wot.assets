            ...
            5154: (u, A, F) => {
                ...
                function nu(u, A) {
                    ...
                    if (
                        ...
                        (F = (function (u, A) {
                            if (!u) return;
                            if ('string' == typeof u) return ru(u, A);
                ...
                const lu = (u, A, F) => {
                    ...
                    vu = (u, A, F = cu.left) => u.split(A).reduce(F === cu.left ? lu : du, []),
                    fu = (() => {
                        const u = new RegExp(
                        ...
                        return mu.includes(F)
                            ...
                            : ((u, A = cu.left) => {
                                  ...
                                  const E =
                                      ...
                                      e = u.replace(/&nbsp;/g, ' ');
                                  return (vu(e, /( )/, A).forEach((u) => (F = F.concat(vu(u, E, cu.left)))), F);
                              })(u, A);
                    },
                    pu = 'FormatText_base_d0',
                    bu = ({ binding: u, text: A = '', classMix: F, alignment: E = cu.left }) =>
                        null === A
                                  ...
                                  A.split('\n').map((A, e) =>
                                      t().createElement(
                                          ...
                                          ((u, A, F) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (F && u in F ? F[u] : gu(u, A))))(A, E, u).map((u, A) =>
                ...
                const hu = 'Content_base_17',
                    xu = 'Content_separator_9c',
                    yu = 'Content_title_01',
                    _u = 'Content_text_bc',
                    Pu = 'Content_currency_1a',
                    Ou = 'Content_icon_eb',
                    Ru = 'Content_duration_9f',
                    Tu = 'Content_description_b6',
                    Su = 'Content_highlight_bd',
                    ...
                    Mu = (0, wu.Pi)(() => {
                        ...
                        return t().createElement(
                            'div',
                            { className: hu },
                            t().createElement('div', { className: yu }, zu.title()),
                            t().createElement(bu, {
                                classMix: _u,
                                text: zu.text(),
                                binding: {
                                    count: t().createElement('span', { className: Pu }, u.count.get()),
                                    icon: t().createElement('span', { className: Ou }),
                                    duration: t().createElement(bu, {
                                        classMix: Ru,
                    ...
                    ju = () => t().createElement(Du, null, t().createElement(au, null, t().createElement(Mu, null)));
                engine.whenReady.then(() => {
                    r().render(t().createElement(ju, null), document.getElementById('root'));
                });
            },
        },
        F = {};
