    ...
    var u,
        A = {
            3963: (u, A, F) => {
                var E = {};
                F.r(E),
                    F.d(E, { mouse: () => g, off: () => v, on: () => d, onResize: () => c, onScaleUpdated: () => l });
                var e = {};
                F.r(e),
                    F.d(e, {
                        events: () => E,
                ...
                const _u = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Su = (u, A, F = yu.left) => u.split(A).reduce(F === yu.left ? Pu : Ru, []),
                    Ou = (() => {
                        const u = new RegExp(
                    ...
                    zu = (u, A = yu.left) => {
                        ...
                        return ((u, A = yu.left) => {
                            ...
                            const E =
                                ...
                                e = _u(u);
                            return Su(e, /( )/, A).forEach((u) => (F = F.concat(Su(u, E, yu.left)))), F;
                        })(u, A);
                    },
                ...
                const Lu = 'Content_base_17',
                    ...
                    Zu = () => t().createElement(cu, null, t().createElement(bu, null, t().createElement(Qu, null)));
                engine.whenReady.then(() => {
