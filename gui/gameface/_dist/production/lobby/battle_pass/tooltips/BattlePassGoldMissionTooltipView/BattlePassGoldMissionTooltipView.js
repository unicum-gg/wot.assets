    ...
    var u,
        A = {
            5154: (u, A, F) => {
                ...
                var hu = F(3403);
                const xu = 'Content_base_17',
                    yu = 'Content_separator_9c',
                    _u = 'Content_title_01',
                    Pu = 'Content_text_bc',
                    Ou = 'Content_currency_1a',
                    Ru = 'Content_icon_eb',
                    Tu = 'Content_duration_9f',
                    Su = 'Content_description_b6',
                    zu = 'Content_highlight_bd',
                    Mu = R.strings.battle_pass.tooltips.goldMission,
                    ju = (0, hu.Pi)(() => {
                        const u = cu().model;
                        return t().createElement(
                            'div',
                            { className: xu },
                            t().createElement('div', { className: _u }, Mu.title()),
                            t().createElement(wu, {
                                classMix: Pu,
                                text: Mu.text(),
                                binding: {
                                    count: t().createElement('span', { className: Ou }, u.count.get()),
                                    icon: t().createElement('span', { className: Ru }),
                                    duration: t().createElement(wu, {
                                        classMix: Tu,
                                        text: Mu.textDuration(),
                            ...
                            t().createElement(wu, {
                                ...
                                binding: {
                                    highlight: t().createElement(
                                        'span',
                                        { className: zu },
                                        Mu.highlightedDescription(),
                                    ),
                                },
                            }),
                        );
                    }),
                    ku = () => t().createElement(Bu, null, t().createElement(su, null, t().createElement(ju, null)));
                engine.whenReady.then(() => {
                    r().render(t().createElement(ku, null), document.getElementById('root'));
                });
            },
        },
        F = {};
