    ...
    var __webpack_modules__ = {
            ...
            4444: (u, e, t) => {
                ...
                const O = (0, n.memo)(({ header: u, points: e, columnClassMix: t }) =>
                    ...
                    k = 'BattleRoyaleTable_pointsColumn_f0',
                    N = 'BattleRoyaleTable_header_7e',
                    ...
                    I = ({ rewardPoints: u }) => {
                        const e = (0, n.useMemo)(
                                () =>
                                    u.soloMode.map(({ value: u }, e) =>
                                        _(e > 0 ? x.places() : x.place(), { place: u.place }),
                                    ),
                                [u],
                            ),
                        ...
                        return r().createElement(
                            ...
                            r().createElement(O, { points: t, columnClassMix: k }),
                            r().createElement(T, {
                                columnWidth: 140,
                                header: x.squad(),
                                headerClassMix: N,
                            ...
                            r().createElement(O, { points: s }),
                        );
                    },
                    L = R.strings.battle_pass.tooltips,
                    U = ({ win: u, points: e, hasDraw: t = !0, battleType: n = '' }) => {
                        const a = 'comp7' === n ? L.prestigePoints : L.pointsTable,
                ...
                const X = ((u, e) => {
                    ...
                    J = 'EndSoon_base_ad',
                    uu = 'EndSoon_content_2e',
                    eu = 'EndSoon_timerLight_c2',
                    tu = 'EndSoon_timer_a8',
                    nu = 'EndSoon_timerIcon_08',
                    ru = 'EndSoon_timerLabel_cb',
                    au = 'EndSoon_timerValue_65',
                    su = 'EndSoon_hurryUp_2e',
                    ou = R.strings.battle_pass.tooltips.inProgress,
                    iu = (0, f.Pi)(({ className: u }) => {
                        const e = Z().model.root.get().timeTillEnd;
                        return r().createElement(
                            'div',
                            { className: J },
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement('div', { className: ru }, ou.timeLeft()),
                                    r().createElement('div', { className: au }, e),
                                ),
                                r().createElement('div', { className: su }, ou.hurryUp()),
                            ),
                        );
                    });
                let Eu;
                ...
                (Fu.style, Fu.tankman);
                const du = 'ExpireTime_base_55',
                    _u = 'ExpireTime_light_64',
                    mu = 'ExpireTime_icon_56',
                    Bu = 'ExpireTime_value_1c',
                    Cu = (0, f.Pi)(() => {
                        const u = ((u, e = !0, t = !1) =>
                            u.days > 7 && e
                        ...
                        return r().createElement(
                            ...
                            r().createElement('div', { className: Bu }, u),
                        );
                    }),
                    pu = 'Level_level_18',
                    gu = 'Level_levelLabel_f3',
                    bu = R.strings.battle_pass.tooltips.inProgress,
                    vu = (0, f.Pi)(() => {
                        const u = Z().model.root.get().level;
                        return r().createElement(
                            r().Fragment,
                            null,
                            r().createElement('div', { className: pu }, u + 1),
                            r().createElement('div', { className: gu }, bu.level()),
                        );
                    }),
                    wu = {
                ...
                const Pu = ({ size: u = hu.Default, classMix: e }) =>
                        r().createElement('div', { className: i()(wu.background, wu[`background__${u}`], e) }),
                    Ru = {
                ...
                const Mu = 'ProgressBarDeltaGrow_base_7e',
                    ...
                    $u = (0, n.memo)(
                        ({
                            ...
                            const b = (0, n.useMemo)(() => Object.assign({ width: '100%' }, Gu(u), Lu(A)), [A, u]),
                                v = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Gu(u), Lu(A)), [A, u]),
                                w = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Uu(A, a), Gu(u)), [a, A, u]),
                                h = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - a)}%` }, Uu(A, a), Gu(u)),
                                    [a, A, o, u],
                                );
                            if (_) return null;
                            const f = i()(Mu, c, A && 0 === o && xu);
                            return r().createElement(
                                'div',
                                { style: m ? w : h, className: f },
                                r().createElement(
                                    'div',
                                    { style: C ? v : b, className: Iu },
                    ...
                    zu = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    Wu = (0, n.memo)(
                        ({
                            ...
                            return d
                                ...
                                : r().createElement(
                                      'div',
                                      { className: zu, style: p },
                                      r().createElement(
                                          'div',
                                          { style: _ ? B : C, className: qu },
                                          r().createElement(yu, { size: s }),
                                      ),
                                  );
                        },
                ...
                const Xu = (0, n.memo)((u) => {
                        ...
                        switch (a.animationSettings.type) {
                            case fu.Simple:
                                return r().createElement(ju, Hu({}, a, { onEndAnimation: E, isComplete: o }));
                            case fu.Growing:
                                return r().createElement(Yu, Hu({}, a, { onEndAnimation: E, isComplete: o }));
                            default:
                                return null;
                        }
                    }),
                    Ku = ({ size: u, value: e, lineRef: t, disabled: a, onComplete: s }) => {
                        ...
                        return (
                            ...
                            r().createElement(Su, { size: u, disabled: a, baseStyles: o, isComplete: i, lineRef: t })
                        );
                    },
                    Zu = ['onEndAnimation'];
                function Qu() {
                ...
                const Ju = (0, n.memo)((u) => {
                    ...
                    return (
                        (a.current.from = o),
                        r().createElement(Xu, Qu({}, t, { onEndAnimation: s, key: `${o}-${t.to}`, from: o }))
                    );
                });
                function ue() {
                    return (
                ...
                const ee = (0, n.memo)(
                        ({
                            ...
                            return s.withStack
                                ? r().createElement(Ju, l)
                                : r().createElement(Xu, ue({ key: `${a}-${e}` }, l));
                        },
                    ),
                    te = (u) => ({
                    ...
                    re = (u, e, t) => (t < u ? u : t > e ? e : t),
                    ae = (u, e, t) => {
                        if ('number' == typeof t) {
                            return (re(0, e, t) / e) * 100;
                        }
                        return u;
                    },
                    se = ne,
                    ...
                    ie = (0, n.memo)(
                        ({
                            ...
                            const _ = ((u, e, t) =>
                                (0, n.useMemo)(() => {
                                    const n = (re(0, e, u) / e) * 100;
                                    return { value: n, deltaFrom: ae(n, e, t) };
                                }, [t, e, u]))(l, u, c);
                            return r().createElement(
                                'div',
                                { className: i()(wu.base, wu[`base__${t}`]), style: te(e) },
                                !o && r().createElement(Pu, { size: t, classMix: E }),
                                r().createElement(ee, {
                                    size: t,
                                    lineRef: A,
                                    disabled: s,
                    ...
                    Ee = 'Progression_base_6c',
                    le = 'Progression_progressionBar_1f',
                    ce = 'Progression_points_21',
                    Ae = 'Progression_pointsCurrent_78',
                    Fe = 'Progression_pointsMax_bd',
                    De = 'Progression_pointsIcon_40',
                    de = (0, f.Pi)(({ isDisabled: u = !1 }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: le },
                                r().createElement(ie, { value: t, maxValue: n, theme: ne, disabled: u }),
                            ),
                            r().createElement(
                                'div',
                                { className: ce },
                                ...
                                '/',
                                r().createElement('div', { className: Fe }, n),
                                r().createElement('div', { className: De }),
                            ),
                        );
                    }),
                    _e = 'Header_base_bd',
                    me = 'Header_chapter_67',
                    Be = 'Header_name_9e',
                    Ce = (0, f.Pi)(() => {
                        const u = Z().model,
                            e = u.root.get(),
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: me },
                                r().createElement('div', { className: Be }, s),
                                o && r().createElement(Cu, null),
                            ),
                            r().createElement(vu, null),
                            r().createElement(de, null),
                        );
                    });
                let pe, ge, be, ve, we, he, fe;
                (!(function (u) {
                    ((u.Items = 'items'),
                ...
                const Re = [
                        ...
                        pe.GoldenTicket,
                        pe.PostStamp,
                        pe.BlankPersonalMissions_1,
                        pe.BlankPersonalMissions_2,
                        pe.SACoin,
                        pe.PremiumPlusUniversal,
                        pe.NyPetGoodies,
                        pe.HiddenVehicle,
                    ],
                    ye = [pe.Gold, pe.Credits, pe.Crystal, pe.FreeXp, pe.NewYearToyFragments],
                ...
                const ke = ['engravings', 'backgrounds'],
                    ...
                    Me = (u, e = be.Small, t) => {
                        ...
                        switch (n) {
                            ...
                            case 'premium':
                                return `R.images.gui.maps.icons.quests.bonuses.${e}.${n}_plus_${a}`;
                            case 'premium_plus':
                            ...
                            case 'dossier_badge':
                                return `R.images.gui.maps.icons.quests.bonuses.badges.${E}.${s}`;
                            ...
                            case 'collectionItem':
                                return `R.images.gui.maps.icons.collectionItems.${E}.${s}`;
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (Le(t, D, { isMouseEvent: !0, on: !0, arguments: Ie(r) }, v),
                                    C && C(),
                ...
                const He = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: i()(Xe.image, null == c ? void 0 : c.image) },
                                        D &&
                                            r().createElement('div', {
                                                className: i()(Xe.highlight, null == c ? void 0 : c.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: i()(Xe.icon, null == c ? void 0 : c.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        d &&
                                            r().createElement('div', {
                                                className: i()(Xe.overlay, null == c ? void 0 : c.overlay),
                                                style: {
                    ...
                    Je = 'RewardWrapper_base__styleUpgrade_ca',
                    ut = 'RewardWrapper_base__wide_5e',
                    et = 'RewardWrapper_base_dc',
                    tt = ({ reward: u, index: e, isCascadingLayout: t, isWide: n }) => {
                        const a =
                                u.special &&
                                [
                                    we.PROGRESSION_STYLE_UPGRADED_1,
                                    we.PROGRESSION_STYLE_UPGRADED_2,
                                    we.PROGRESSION_STYLE_UPGRADED_3,
                                    we.PROGRESSION_STYLE_UPGRADED_4,
                                ].includes(u.special),
                            s = e % 2 == 1 ? Ze : Qe;
                        return r().createElement(
                            'div',
                            { className: i()(et, t && s, a && Je, n && !t && ut) },
                            r().createElement(Ke, {
                                name: u.name,
                                image: u.image,
                                size: be.Small,
                    ...
                    nt = 'RewardsBlock_base_58',
                    rt = 'RewardsBlock_nextRewards_3d',
                    at = 'RewardsBlock_rewardsList_30',
                    st = 'RewardsBlock_rewardsList__locked_5d',
                    ot = 'RewardsBlock_lockIcon_31',
                    it = 'RewardsBlock_rareTrophyDeviceIcon_80',
                    Et = (u) => {
                        return {
                            name: u.item || u.name,
                            image: Me(u, be.Small),
                    ...
                    lt = ({ label: u, isLocked: e = !1, rewards: { items: t } }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: rt },
                                e && r().createElement('div', { className: ot }),
                                u,
                            ),
                            r().createElement(
                                'div',
                ...
                const At = R.strings.battle_pass.tooltips,
                    ...
                    Dt = R.strings.battle_pass.tooltips.pointsTable,
                        ...
                        const u = Z().model,
                            ...
                            D = {
                                battleType: r().createElement(
                                    'div',
                                    { className: Q.gameMode },
                                    At.inProgress.$dyn(m(a)),
                                ),
                            },
                            d = a === ct.BATTLE_ROYALE,
                            _ = a === ct.FRONTLINE;
                        return r().createElement(
                            'div',
                            { className: Q.base },
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: Q.rewards },
                                    r().createElement(lt, { label: At.inProgress.baseReward(), rewards: o }),
                                    r().createElement(lt, {
                                ...
                                !A &&
                                    ...
                                    r().createElement(P.l, {
                                        ...
                                        mixClass: Q.unlockBattlePass,
                                    }),
                                d || _
                                    ? r().createElement(
                                          'div',
                                          { className: Q.getPoints },
                                          r().createElement('div', {
                                              className: i()(Q.modeIcon, Q[`modeIcon__${m(a)}`]),
                                          }),
                                          r().createElement(h, { text: At.inProgress.getPointsFrom(), binding: D }),
                                      )
                                    : r().createElement(P.l, {
                                          icon: R.images.gui.maps.icons.battleTypes.$dyn(Ft[a]),
                                          text: At.inProgress.playGame.$dyn(a),
                                          mixClass: Q.playGame,
                                      }),
                            ),
                            d
                                ? r().createElement(
                                      $.c,
                                      { mixClass: Q.perBattlePointsTable, separatorRows: c.soloMode },
                                      r().createElement(I, { rewardPoints: c }),
                                  )
                                : r().createElement(
                                      $.c,
                                      ...
                                      r().createElement(G, {
                                          rewardPoints: l,
                                          hasDraw: !_,
                                          topPlace: (a === ct.COMP7 ? dt : Dt).topPlace(),
                                          battleType: a,
                                      }),
                                  ),
                            F &&
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: Q.separatorWrapper },
                                        r().createElement('div', { className: Q.separator }),
                                    ),
                                    r().createElement(
                                        'div',
                                        { className: Q.claimReward },
                                        r().createElement(P.l, {
                            ...
                            A && r().createElement(iu, null),
                        );
                    }),
                    mt = () => r().createElement(D, null, r().createElement(_t, null));
                engine.whenReady.then(() => {
                    s().render(
                        r().createElement(K, null, r().createElement(mt, null)),
