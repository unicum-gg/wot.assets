    ...
    var __webpack_modules__ = {
            ...
            4444: (u, e, t) => {
                ...
                const O = (0, n.memo)(({ header: u, points: e, columnClassMix: t }) =>
                    ...
                    x = 'BattleRoyaleTable_label_e2',
                    M = R.strings.battle_pass.tooltips.pointsTable,
                    I = ({ rewardPoints: u }) => {
                        const e = (0, n.useMemo)(
                                () =>
                                    u.soloMode.map(({ value: u }, e) =>
                                        _(e > 0 ? M.places() : M.place(), { place: u.place }),
                                    ),
                                [u],
                            ),
                ...
                const Pu = ({ size: u = hu.Default, classMix: e }) =>
                    ...
                    Ou = ({ size: u, value: e, lineRef: t, disabled: a, onComplete: s }) => {
                ...
                const Mu = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    ju = (0, n.memo)(
                        ({
                            ...
                            const b = (0, n.useMemo)(() => Object.assign({ width: '100%' }, Wu(u), qu(A)), [A, u]),
                                v = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Wu(u), qu(A)), [A, u]),
                                w = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Yu(A, a), Wu(u)), [a, A, u]),
                                h = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - a)}%` }, Yu(A, a), Wu(u)),
                                    [a, A, o, u],
                                );
                            if (_) return null;
                            const f = i()(Gu, c, A && 0 === o && $u);
                            return r().createElement(
                                'div',
                ...
                const Ju = (0, n.memo)((u) => {
                    ...
                    return (
                        (a.current.from = o),
                        r().createElement(Ku, Qu({}, t, { onEndAnimation: s, key: `${o}-${t.to}`, from: o }))
                    );
                });
                function ue() {
                    return (
                ...
                const ee = (0, n.memo)(
                        ({
                            ...
                            return s.withStack
                                ...
                                : r().createElement(Ku, ue({ key: `${a}-${e}` }, l));
                        },
                    ),
                    te = (u) => ({
                ...
                const ye = [
                    ...
                    Se = [pe.BattlePassPoints],
                    Oe = [pe.PremiumPlus, pe.Premium];
                let ke;
                !(function (u) {
                    ((u.s16 = '16'),
                        (u.s32 = '32'),
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (Ue(t, D, { isMouseEvent: !0, on: !0, arguments: Le(r) }, v),
                                    C && C(),
                ...
                const Xe = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return r().createElement(Ve, e, n);
                        const a = e.contentId,
                            s = e.args,
                            o = null == s ? void 0 : s.contentId;
                        return a || o
                            ? r().createElement(Ge, He({}, e, { contentId: a || o }), n)
                            : r().createElement(qe, e, n);
                    },
                    Ke = {
                        base: 'Reward_base_ea',
                    ...
                    Ze = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: i()(Ke.base, Ke[`base__${n}`], l), style: E },
                            r().createElement(
                                Xe,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: i()(Ke.image, null == c ? void 0 : c.image) },
                                        D &&
                                            r().createElement('div', {
                                                className: i()(Ke.highlight, null == c ? void 0 : c.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: i()(Ke.icon, null == c ? void 0 : c.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        d &&
                                            r().createElement('div', {
                                                className: i()(Ke.overlay, null == c ? void 0 : c.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: F },
                                    r().createElement('div', {
                                        className: i()(Ke.timer, null == c ? void 0 : c.periodicIcon),
                                    }),
                                ),
                        );
                    },
                    Qe = 'RewardWrapper_base__shiftUp_1e',
                    Je = 'RewardWrapper_base__shiftDown_46',
                    ut = 'RewardWrapper_base__styleUpgrade_ca',
                    et = 'RewardWrapper_base__wide_5e',
                    tt = 'RewardWrapper_base_dc',
                    nt = ({ reward: u, index: e, isCascadingLayout: t, isWide: n }) => {
                        const a =
                                u.special &&
                                [
                        ...
                        return r().createElement(
                            'div',
                            { className: i()(tt, t && s, a && ut, n && !t && et) },
                            r().createElement(Ze, {
                                name: u.name,
                                image: u.image,
                                size: be.Small,
                    ...
                    rt = 'RewardsBlock_base_58',
                    at = 'RewardsBlock_nextRewards_3d',
                    st = 'RewardsBlock_rewardsList_30',
                    ot = 'RewardsBlock_rewardsList__locked_5d',
                    it = 'RewardsBlock_lockIcon_31',
                    Et = 'RewardsBlock_rareTrophyDeviceIcon_80',
                    lt = (u) => {
                        return {
                            name: u.item || u.name,
                            image: Me(u, be.Small),
                    ...
                    ct = ({ label: u, isLocked: e = !1, rewards: { items: t } }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: at },
                                e && r().createElement('div', { className: it }),
                                u,
                            ),
                            r().createElement(
                                'div',
                ...
                const Ft = R.strings.battle_pass.tooltips,
                    Dt = {
                        randoms: 'c_1',
                        ranked: 'ranked',
                        mapbox: 'c_1',
                    ...
                    _t = R.strings.battle_pass.tooltips.prestigePoints,
                    mt = (0, f.Pi)(() => {
                        const u = Z().model,
                            e = u.root.get(),
                            t = e.timeTillEnd,
                            ...
                            D = {
                                battleType: r().createElement(
                                    ...
                                    Ft.inProgress.$dyn(m(a)),
                                ),
                            },
                            d = a === At.BATTLE_ROYALE,
                            _ = a === At.FRONTLINE;
                        return r().createElement(
                            'div',
                            { className: Q.base },
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: Q.rewards },
                                    r().createElement(ct, { label: Ft.inProgress.baseReward(), rewards: o }),
                                    r().createElement(ct, {
                                        label: Ft.inProgress.improvedReward(),
                                        rewards: E,
                                        isLocked: !n,
                                    }),
                                ),
                                ...
                                d || _
                                    ? r().createElement(
                                          ...
                                          r().createElement(h, { text: Ft.inProgress.getPointsFrom(), binding: D }),
                                      )
                                    : r().createElement(P.l, {
                                          icon: R.images.gui.maps.icons.battleTypes.$dyn(Dt[a]),
                                          text: Ft.inProgress.playGame.$dyn(a),
                                          mixClass: Q.playGame,
                                      }),
                            ),
                            d
                                ...
                                : r().createElement(
                                      ...
                                      r().createElement(G, {
                                          rewardPoints: l,
                                          hasDraw: !_,
                                          topPlace: (a === At.COMP7 ? _t : dt).topPlace(),
                                          battleType: a,
                                      }),
                                  ),
                            F &&
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(P.l, {
                                            ...
                                            text: Ft.claimRewards[s > 1 ? 'multiple' : 'c_1'](),
                                            mixClass: Q.unlock,
                                        }),
                                    ),
                                ),
                    ...
                    Bt = () => r().createElement(D, null, r().createElement(mt, null));
                engine.whenReady.then(() => {
                    s().render(
                        r().createElement(K, null, r().createElement(Bt, null)),
