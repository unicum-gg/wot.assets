(() => {
    ...
    var __webpack_modules__ = {
            ...
            4444: (u, e, t) => {
                ...
                const D = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            F({}, D, {
                                className: i()(A.base, A[`base__theme-${o}`], a),
                                ref: function (u) {
                                    (_.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            r().createElement('div', { className: A.decorator }, t),
                        )
                    );
                });
                let d;
                        ...
                        return [
                            function ({ mode: a = 'real', options: s, children: o, mocks: i }) {
                                const l = (0, n.useRef)([]),
                                    ...
                                    D = F[0],
                                    d = F[1],
                                    _ = (0, n.useState)(() => A(a, s, i)),
                                    m = _[0],
                                    B = _[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        c.current ? B(A(D, s, i)) : (c.current = !0);
                                    }, [i, D, s]),
                                    (0, n.useEffect)(() => {
                                        d(a);
                                    }, [a]),
                ...
                const Ru = ({ size: u = hu.Default }) =>
                        r().createElement('div', { className: i()(wu.background, wu[`background__${u}`]) }),
                    Pu = {
                ...
                const Mu = 'ProgressBarDeltaGrow_base_7e',
                    ...
                    $u = (0, n.memo)(
                        ({
                            ...
                            const b = (0, n.useMemo)(() => Object.assign({ width: '100%' }, Gu(u), Lu(c)), [c, u]),
                                v = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Gu(u), Lu(c)), [c, u]),
                                w = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Uu(c, a), Gu(u)), [a, c, u]),
                                h = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - a)}%` }, Uu(c, a), Gu(u)),
                                    [a, c, o, u],
                                );
                            if (_) return null;
                            const f = i()(Mu, A, c && 0 === o && Iu);
                            return r().createElement(
                                'div',
                                { style: m ? w : h, className: f },
                                r().createElement(
                                    'div',
                                    { style: C ? v : b, className: xu },
                ...
                const Xu = (0, n.memo)((u) => {
                        ...
                        switch (a.animationSettings.type) {
                            case fu.Simple:
                                return r().createElement(ju, Vu({}, a, { onEndAnimation: E, isComplete: o }));
                            case fu.Growing:
                                return r().createElement(Yu, Vu({}, a, { onEndAnimation: E, isComplete: o }));
                            default:
                                return null;
                        }
                    }),
                ...
                const ee = (0, n.memo)(
                    ...
                    ce = 'Progression_pointsCurrent_78',
                    ...
                    de = (0, f.Pi)(({ isDisabled: u = !1 }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: Ae },
                                r().createElement('div', { className: ce }, t),
                                '/',
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (xe(t, D, { isMouseEvent: !0, on: !0, arguments: Ie(r) }, v),
                                    C && C(),
                ...
                const He = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        return a || o
                            ? r().createElement(Le, je({}, e, { contentId: a || o }), n)
                            : r().createElement($e, e, n);
                    },
                    Ve = {
                        base: 'Reward_base_ea',
                    ...
                    Xe = ({
                        ...
                        const D = ((u) => {
                            ...
                            _ = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case ve.CURRENCY:
                                    case ve.NUMBER:
                                        return r().createElement(Re, { format: 'integral', value: Number(u) });
                        ...
                        return r().createElement(
                            'div',
                            { className: i()(Ve.base, Ve[`base__${n}`], l), style: E },
                            r().createElement(
                                He,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: i()(Ve.image, null == A ? void 0 : A.image) },
                                        D &&
                                            r().createElement('div', {
                                                className: i()(Ve.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: i()(Ve.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        d &&
                                            r().createElement('div', {
                                                className: i()(Ve.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: F },
                                    r().createElement('div', {
                                        className: i()(Ve.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    },
                    Ke = 'RewardWrapper_base__shiftUp_1e',
                    Ze = 'RewardWrapper_base__shiftDown_46',
                    Qe = 'RewardWrapper_base__styleUpgrade_ca',
                    Je = 'RewardWrapper_base__wide_5e',
                    ut = 'RewardWrapper_base_dc',
                    et = ({ reward: u, index: e, isCascadingLayout: t, isWide: n }) => {
                        const a =
                                u.special &&
                                [
                        ...
                        return r().createElement(
                            'div',
                            { className: i()(ut, t && s, a && Qe, n && !t && Je) },
                            r().createElement(Xe, {
                                name: u.name,
                                image: u.image,
                                size: be.Small,
                    ...
                    tt = 'RewardsBlock_base_58',
                    nt = 'RewardsBlock_nextRewards_3d',
                    rt = 'RewardsBlock_rewardsList_30',
                    at = 'RewardsBlock_rewardsList__locked_5d',
                    st = 'RewardsBlock_lockIcon_31',
                    ot = 'RewardsBlock_rareTrophyDeviceIcon_80',
                    it = (u) => {
                        return {
                            name: u.item || u.name,
                            image: ke(u, be.Small),
                    ...
                    Et = ({ label: u, isLocked: e = !1, rewards: { items: t } }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: nt },
                                e && r().createElement('div', { className: st }),
                                u,
                            ),
                            r().createElement(
                                'div',
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: Q.rewards },
                                    r().createElement(Et, { label: At.inProgress.baseReward(), rewards: o }),
                                    r().createElement(Et, {
                                ...
                                d || _
                                    ...
                                    : r().createElement(P.l, {
                                          icon: R.images.gui.maps.icons.battleTypes.$dyn(ct[a]),
                            ...
                            c && r().createElement(iu, null),
                        );
                    }),
                    _t = () => r().createElement(D, null, r().createElement(dt, null));
                engine.whenReady.then(() => {
                    s().render(
                        r().createElement(K, null, r().createElement(_t, null)),
