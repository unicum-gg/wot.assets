(() => {
            ...
            6481: (e, u, t) => {
                ...
                class j extends a().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            m = i()(V.base, V[`base__${s}`], V[`base__${n}`], null == o ? void 0 : o.base),
                            A = i()(V.icon, V[`icon__${s}`], V[`icon__${n}`], null == o ? void 0 : o.icon),
                            F = i()(V.glow, null == o ? void 0 : o.glow),
                            D = i()(V.caption, V[`caption__${s}`], null == o ? void 0 : o.caption),
                            C = i()(V.goto, null == o ? void 0 : o.goto);
                        return a().createElement(
                            'div',
                            q(
                                {
                            ...
                            'info' !== s && a().createElement('div', { className: V.shine }),
                ...
                const Se = we,
                    ...
                    qe = ({ currentLevel: e, isLevelShow: u, isHovered: t, isBought: r, isResource: n = !1 }) => {
                        const s = n ? ze.chapterResource() : ze.chapter(),
                            o = r ? ze.bought() : s;
                        return a().createElement(
                            'div',
                            { className: i()(We, r && Ge) },
                            u && a().createElement(Ue, { currentLevel: e, isHovered: t }),
                            a().createElement('div', { className: i()($e, !t && Ve) }, o),
                        );
                    },
                    je = (e, u) => {
                        let t;
                ...
                const Du = 'ShopOfferCard_base_3a',
                    ...
                    Vu = 'ExtraContent_card__extra_fe',
                    zu = (0, f.Pi)(() => {
                        ...
                        return a().createElement(
                            ...
                            O.DZ(
                                ...
                                (e) =>
                                    a().createElement(
                                        'div',
                                        { key: e.packageID, className: i()($u, Vu) },
                                        a().createElement(
                                            Iu,
                ...
                const At = (0, n.memo)((e) => {
                    ...
                    gt = { left: ru.gold, right: ru.freeXP },
                    pt = (0, f.Pi)(({ className: e }) => {
                        const u = G(),
                            t = u.model,
                            r = u.controls,
                            s = t.priceID.get();
                        t.computes.prices().find((e) => e.currencyType === gt.left);
                        return (
                            (0, n.useEffect)(() => {
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    a().Fragment,
                                    null,
                                    a().createElement('div', { className: Ct }, Bt.price()),
                                    a().createElement(ou, {
                                        type: ru.gold,
                                        size: tu.big,
                    ...
                    ht = 'Footer_base_9a',
                    ft = 'Footer_price_b6',
                    vt = 'Footer_warning_de',
                    bt = 'Footer_buttons_32',
                    wt = 'Footer_chapterWarning_c1',
                    yt = R.strings.battle_pass.battlePassBuyView,
                    St = (0, f.Pi)(({ onBackClick: e }) => {
                        const u = G(),
                            t = u.model,
                            r = u.controls,
                            n = t.confirm,
                        ...
                        return a().createElement(
                            'div',
                            { className: i()(ht) },
                            a().createElement(pt, { className: ft }),
                            m && a().createElement('div', { className: vt }, yt.confirm.shopOfferWarning()),
                            a().createElement(ut._, {
                                onAccept: r.buy,
                                onCancel: e,
                                isWalletAvailable: c.get(),
                                buttonAcceptText: yt.btnBuy(),
                                className: bt,
                            }),
                            !o.get() && a().createElement(ot, { className: i()(m && wt), isDisabled: _ }),
                        );
                    }),
                    Rt = {
                ...
                const Pt = (e) => ({
                    ...
                    Nt = (0, f.Pi)(({ onBack: e }) => {
                        const u = G(),
                            ...
                            _ = t.main,
                            m = _.isShopOfferAvailable,
                            A = _.isWalletAvailable,
                            F = (0, c.GS)(),
                            D = F.remScreenHeight,
                            C = F.mediaSize,
                            B = (0, Fu.useSpring)(Pt(E.length)),
                            g = A.get(),
                            p = {
                                backgroundImage: `url(${(0, ie.wD)(R.images.gui.maps.icons.battlePass.backgrounds.confirm, o.get())})`,
                            },
                            h = (0, n.useCallback)(() => ({ [Y.n.ENTER]: r.buy, [Y.n.SPACE]: r.buy }), [r.buy]);
                        Q({ callback: e, preventPropagation: !1 }), Qu(g ? h() : void 0);
                        const f = C < c.cJ.Medium ? Xu.h2.Small : Xu.h2.Big,
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement(j, {
                                    caption: R.strings.menu.viewHeader.backBtn.label(),
                                    onClick: e,
                                    goto: Tt.confirm.backBtnText(),
                                }),
                            ),
                            a().createElement('div', { className: Rt.background, style: p }),
                            a().createElement(
                                'div',
                                {
                                    className: i()(
                                        Rt.content,
                                        v && Rt.content__warning,
                                        !l && Rt.content__activeChapterWarning,
                                    ),
                                },
                                a().createElement(
                                    'div',
                                    { className: Rt.backgroundCommanderWrapper },
                                    a().createElement('div', {
                                        className: i()(
                                            Rt.backgroundCommander,
                                            D >= 1200 && D < 1440 && Rt.backgroundCommander__large,
                                        ),
                                        style: {
                                ...
                                a().createElement(et.D, { chapter: o.get(), buyBP: Tt.confirm.title() }),
                                a().createElement('div', { className: Rt.descriptionText }, Tt.confirm.description()),
                                a().createElement(
                                    'div',
                                    { className: Rt.priorityRewards },
                                    O.UI(E, (e, u) =>
                                        a().createElement(
                                            Ju.d,
                                            { animationConfig: Pt(u), key: `${e.item}_${u}` },
                                            a().createElement(Zu.Q, kt({}, (0, Fe.$n)(e, f), { className: Rt.reward })),
                                        ),
                                    ),
                                ),
                                d > 0
                                    ? a().createElement(
                                          ...
                                          a().createElement(
                                              mu.u5,
                                              {
                                                  type: mu.L$.ghost,
                                                  size: mu.qE.medium,
                                                  mixClass: Rt.rewardBtn,
                                                  onClick: r.showRewards,
                                              },
                                              a().createElement(Yu.z, {
                                                  text: Tt.confirmAnyNumber.moreRewards(),
                                                  binding: { count: d },
                                              }),
                                          ),
                                      )
                                    : a().createElement('div', { className: Rt.indentBlock }),
                                a().createElement(St, { onBackClick: e }),
                            ),
                        );
                    }),
                ...
                var Ot = t(3862),
                    It = t(9430),
                    Ht = t(9791);
                const Ut = 'Content_base_27',
                    Wt = 'Content_base__center_f5',
                    Gt = 'Content_mainContent_dd',
                    $t = R.strings.battle_pass.battlePassBuyView.reward,
                    Vt = ({ fromLevel: e, toLevel: u, nowRewards: t, futureRewards: r }) => {
                        const n = ((e, u) =>
                                e < u
                                    ? { title: $t.titleNowRewards(), completedSteps: `${e} - ${u}` }
                                    : { title: $t.titleNowRewardsSingle(), completedSteps: `${u}` })(e, u),
                            s = n.title,
                            o = n.completedSteps,
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                { className: Gt },
                                t.length > 0 &&
                                    a().createElement(It.r, { title: s, iconType: Ot.Q.now, rewards: t, steps: o }),
                                r.length > 0 &&
                                    a().createElement(It.r, {
                                        title: $t.titleFutureRewards(),
                                        iconType: Ot.Q.future,
                                        rewards: r,
                                    }),
                            ),
                        );
                    ...
                    qt = 'RewardsViewContent_background_89',
                    jt = 'RewardsViewContent_shadow_d6',
                    Yt = 'RewardsViewContent_back_05',
                    Xt = 'RewardsViewContent_content_9f',
                    Zt = 'RewardsViewContent_header_0b',
                    Kt = 'RewardsViewContent_title_8b',
                    Qt = 'RewardsViewContent_description_4e',
                    Jt = 'RewardsViewContent_footerButton_f4',
                    er = R.strings.battle_pass.battlePassBuyView.reward,
                    ur = (0, f.Pi)(({ onBack: e }) => {
                        const u = Mt().model,
                            t = u.levels,
                            r = t.fromLevel,
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement('div', { className: Qt }, er.titleBattlePass()),
                            ),
                            a().createElement(
                                'div',
                                { className: Xt },
                                ...
                                a().createElement(
                                    mu.u5,
                                    { type: mu.L$.secondary, size: mu.qE.medium, mixClass: Jt, onClick: e },
                                    er.backBtn(),
                                ),
                            ),
                        );
                    }),
                    tr = { context: 'model.rewards' },
                    rr = (0, f.Pi)(() => {
                        const e = G(),
                            u = e.model,
                            t = e.controls,
                        ...
                        switch (
                            ...
                            case 'rewardsState':
                                return a().createElement(
                                    Lt,
                                    { options: tr },
                                    a().createElement(ur, { onBack: t.showConfirm }),
                                );
                            default:
                                return a().createElement(ju, { onClose: t.back });
                        }
                ...
                engine.whenReady.then(() => {
                    g().render(
                        a().createElement(W, null, a().createElement(C, { className: p }, a().createElement(rr, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(6481));
