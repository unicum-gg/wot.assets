(() => {
    var __webpack_modules__ = {
            ...
            3730: (u, e, t) => {
                ...
                const L = {
                    ...
                    T = (u) => {
                        ...
                        const r = p(),
                            ...
                            a = r.mediaHeight,
                            n = r.mediaSize;
                        return A().createElement('div', b({ className: _()(t, L[F], y[a], S[n]) }, E), e);
                    },
                    O = ['children'],
                    M = (u) => {
                        let e = u.children,
                ...
                const N = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    $ = (u, e, t = I.left) => u.split(e).reduce(t === I.left ? G : U, []),
                    z = (() => {
                        const u = new RegExp(
                    ...
                    V = ({ binding: u, text: e = '', classMix: t, alignment: r = I.left, formatWithBrackets: F }) => {
                        ...
                        return A().createElement(
                            ...
                            a.split('\n').map((e, F) =>
                                A().createElement(
                                    'div',
                                    { className: _()('FormatText_base_d0', t), key: `${e}-${F}` },
                                    ((u, e, t) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                            t && u in t
                                                ? t[u]
                ...
                const uu = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    Du = (0, K.Pi)(() => {
                        ...
                        return A().createElement(
                            ...
                            {
                                style: o,
                                className: _()(Au.base, r === P.Live && Au.base__live, i && Au.base__large),
                                onClick: () => {
                            ...
                            A().createElement('div', {
                                className: _()(Au.layer, Au.layer__background),
                                style: { backgroundImage: `url(${Fu.$dyn(`background${D}`)})` },
                            }),
                            A().createElement('div', {
                                className: _()(Au.layer, Au.layer__logo),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(3730));
