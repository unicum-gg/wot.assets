(() => {
    var __webpack_modules__ = {
            ...
            3730: (u, e, t) => {
                ...
                const D = F.O.client.getSize('rem'),
                    ...
                    d = (u) => {
                        ...
                        const A = (0, E.useContext)(C),
                            ...
                            w = { extraLarge: m, large: g, medium: h, small: _, extraSmall: v };
                ...
                const L = {
                    ...
                    T = (u) => {
                        ...
                        const r = f(),
                            ...
                            a = r.mediaHeight,
                            n = r.mediaSize;
                        return A().createElement('div', b({ className: g()(t, L[F], y[a], S[n]) }, E), e);
                    },
                    O = ['children'],
                    M = (u) => {
                        let e = u.children,
                ...
                const G = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    $ = (u, e, t = I.left) => u.split(e).reduce(t === I.left ? N : U, []),
                    j = (() => {
                        const u = new RegExp(
                    ...
                    z = ['zh_cn', 'zh_sg', 'zh_tw'],
                    V = ({ binding: u, text: e = '', classMix: t, alignment: r = I.left, formatWithBrackets: F }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const a = F && u ? ((n = u), e.replace(/\{\w+\}/g, (u) => String(n[u.slice(1, -1)]))) : e;
                        var n;
                ...
                var K = t(3403),
                    Y = t(7030);
                const X = { from: { opacity: 0 }, to: { opacity: 1 }, delay: 100, config: { duration: 300 } };
                function Z() {
                    return !1;
                }
                console.log;
                ...
                const uu = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    Au = {
                        ...
                        base: 'App_base_58',
                        layer: 'App_layer_7a',
                        layer__logo: 'App_layer__logo_43',
                        base__large: 'App_base__large_97',
                        layer__background: 'App_layer__background_1c',
                        textWrapper: 'App_textWrapper_5d',
                        timerContainer: 'App_timerContainer_15',
                        timer: 'App_timer_03',
                        timerText: 'App_timerText_56',
                    },
                    ru = R.strings.comp7_ext.grandTournamentWidget,
                    Fu = R.images.comp7.gui.maps.icons.grandTournament,
                    au = [P.Countdown, P.DayIsOver],
                    nu = (u) => {
                        const e = ((u) => {
                        ...
                        return u >= 86400
                            ? A().createElement(V, {
                                  text: ru.counter.days(),
                                  binding: { days: e.totalDays, hours: e.hours },
                              })
                            : u >= 3600
                              ? A().createElement(V, { text: ru.counter.hours(), binding: e })
                              : u >= 60
                                ? A().createElement(V, { text: ru.counter.minutes(), binding: e })
                                : A().createElement(V, { text: ru.counter.lastMinute() });
                    },
                    iu = (u, e) => (u !== P.Countdown || e ? `${ru.$dyn(u)}` : ru.countdownShort()),
                    Du = (0, K.Pi)(() => {
                        const u = Eu(),
                            e = u.model,
                            t = u.controls,
                            ...
                            a = E.isExtended,
                            n = E.timeLeft,
                            i = f().mediaSize >= v.Medium && a,
                            D = `${r === P.Live ? '_live' : ''}${i ? '_big' : ''}`,
                            o = (0, Y.useSpring)(X);
                        return A().createElement(
                            Y.animated.div,
                            {
                                style: o,
                                className: g()(Au.base, r === P.Live && Au.base__live, i && Au.base__large),
                                onClick: () => {
                            ...
                            A().createElement('div', {
                                className: g()(Au.layer, Au.layer__background),
                                style: { backgroundImage: `url(${Fu.$dyn(`background${D}`)})` },
                            }),
                            A().createElement('div', {
                                className: g()(Au.layer, Au.layer__logo),
                                style: { backgroundImage: `url(${Fu.$dyn(`logo${D}`)})` },
                            }),
                            A().createElement(
                                'div',
                                { className: Au.textWrapper },
                                au.includes(r)
                                    ? A().createElement(V, {
                                          text: iu(r, i),
                                          binding: {
                                              timer: A().createElement(
                                                  'div',
                                                  { className: Au.timerContainer },
                                                  A().createElement('div', { className: Au.timer }),
                                              ),
                                              countdown: nu(n),
                                          },
                                          classMix: Au.timerText,
                                      })
                                    : A().createElement('div', null, ru.$dyn(r)),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    H().render(
                        A().createElement(M, null, A().createElement(tu, null, A().createElement(Du, null))),
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/GrandTournamentWidget/GrandTournamentWidget'),
        (() => {
            var u = { 'lobby/GrandTournamentWidget/GrandTournamentWidget': 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, ['lib/comp7.vendors'], () => __webpack_require__(3730));
