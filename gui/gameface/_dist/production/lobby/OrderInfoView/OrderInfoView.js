(() => {
            ...
            825: (u, e, t) => {
                ...
                const k = {
                    ...
                    M = (u) => {
                        ...
                        const a = x(),
                            ...
                            o = a.mediaHeight,
                            s = a.mediaSize;
                        return n().createElement('div', L({ className: g()(t, k[i], T[o], S[s]) }, r), e);
                    },
                    O = ['children'],
                    N = (u) => {
                        let e = u.children,
                        ...
                        return n().createElement(h, null, n().createElement(M, t, e));
                    };
                function H() {
                    return !1;
                }
                        ...
                        return [
                            function ({ mode: u = 'real', options: a, children: i, mocks: o }) {
                                const l = (0, r.useRef)([]),
                                        ...
                                        const a = (function ({
                                            ...
                                            E = (({ observableModel: u }) => {
                                                const e = { root: u.object() },
                                                    t = (0, U.computedFn)(() => e.root.get().frontName);
                                                return Object.assign({}, e, { computes: { getFrontName: t } });
                                            })({
                                                mode: u,
                                                readByPath: o,
                                                externalModel: i,
                                    ...
                                    d = A[0],
                                    F = A[1],
                                    _ = (0, r.useState)(() => c(u, a, o)),
                                    D = _[0],
                                    m = _[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        E.current ? m(c(d, a, o)) : (E.current = !0);
                                    }, [o, d, a]),
                                    (0, r.useEffect)(() => {
                                        F(u);
                                    }, [u]),
                ...
                class uu extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            d = g()(Z.base, Z[`base__${i}`], Z[`base__${a}`], null == o ? void 0 : o.base),
                            F = g()(Z.icon, Z[`icon__${i}`], Z[`icon__${a}`], null == o ? void 0 : o.icon),
                            _ = g()(Z.glow, null == o ? void 0 : o.glow),
                            D = g()(Z.caption, Z[`caption__${i}`], null == o ? void 0 : o.caption),
                            m = g()(Z.goto, null == o ? void 0 : o.goto);
                ...
                const nu = ({
                    ...
                    const D = (0, r.useRef)(null),
                        ...
                        H = g()(eu.state, eu.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                ...
                const lu = { [su.NBSP]: iu.NoBreakSymbol, [su.ZWNBSP]: iu.NoBreakSymbol, [su.NEW_LINE]: iu.LineBreak },
                    cu = [
                        'children',
                        'contentId',
                        'args',
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Au(t, F, { isMouseEvent: !0, on: !0, arguments: Eu(n) }, v),
                                    h && h(),
                ...
                const pu = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return a || o
                        ? n().createElement(du, gu({}, e, { contentId: a || o }), r)
                        : n().createElement(Du, e, r);
                };
                var vu = t(9050),
                    bu = t.n(vu);
                let fu;
                ...
                const wu =
                    ...
                    xu = (u) => ({ color: `#${u}` }),
                    yu = ({ elementList: u, textBlock: e, key: t }) => {
                        const r = e.colorTag;
                        return r
                            ? wu[r]
                                ? n().createElement(
                    ...
                    Mu = (u, e = '') => {
                        ...
                        return (
                            Tu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: iu.Word, colorTag: e, childList: Su(u) });
                                },
                                (u) => {
                                    const r = u[0],
                                        n = lu[r.charAt(0)];
                ...
                const Vu = { Small: Gu.Small, Medium: Gu.Medium, Big: Gu.Big };
                let $u;
                !(function (u) {
                    (u.SHOW_DETAILS = 'ev_secret_event_hangar_ui_icon_selection'),
                        (u.HIGHLIGHT = 'ev_secret_event_hangar_ui_highlight');
                })($u || ($u = {}));
                const zu = (0, r.memo)(({ mixClass: u }) => {
                        const e = g()('Flare_base_c2', u);
                        return n().createElement('div', { className: e });
                    }),
                    Ku = R.images.historical_battles.gui.maps.icons.order,
                    qu = R.strings.hb_lobby.orderInfo,
                    Yu = {
                        [b.ExtraSmall]: 'c_400x340',
                        [b.Small]: 'c_400x340',
                        [b.Medium]: 'c_280x280',
                        [b.Large]: 'c_280x280',
                        [b.ExtraLarge]: 'c_400x340',
                    },
                    Xu = (0, r.memo)(({ orderType: u }) => {
                        const e = x().mediaSize,
                            t = (0, r.useMemo)(() => ({ backgroundImage: `url(${Ku.$dyn(Yu[e]).$dyn(u)})` }), [u, e]),
                            a = (0, r.useMemo)(() => qu.$dyn(u).$dyn('label'), [u]),
                            i = (0, r.useMemo)(() => qu.$dyn(u).$dyn('description'), [u]);
                        return n().createElement(
                            'div',
                            { className: 'Order_base_cc' },
                            n().createElement('div', { className: 'Order_image_62', style: t }),
                            n().createElement(zu, { mixClass: 'Order_flare_97' }),
                            n().createElement('div', { className: 'Order_label_43' }, a),
                            n().createElement('div', { className: 'Order_description_07' }, i),
                        );
                    }),
                    Zu = (u, e) => {
                        let t = 'c_1366x768';
                    ...
                    Qu = R.strings.hb_lobby.orderInfo,
                    Ju = { contentId: R.views.historical_battles.lobby.tooltips.HbCoinTooltip('resId') },
                    ue = () => {
                        const u = V().model.computes.getFrontName(),
                            e = x().mediaSize;
                        Y(), Y({ key: $.n.ENTER });
                        const t = (0, r.useCallback)(() => {
                                s.O.view.sendEvent.close();
                            }, []),
                            a = { backgroundImage: `url(${Zu(e, u)})` };
                        return n().createElement(
                            'div',
                            { className: 'OrderInfoViewApp_base_24' },
                            n().createElement('div', { className: 'OrderInfoViewApp_bg_e8', style: a }),
                            n().createElement('div', { className: 'OrderInfoViewApp_vignette_df' }),
                            n().createElement(
                                'div',
                                { className: 'OrderInfoViewApp_closeButton_82' },
                                n().createElement(uu, {
                            ...
                            n().createElement('div', { className: 'OrderInfoViewApp_title_8f' }, Qu.title()),
                            n().createElement('div', { className: 'OrderInfoViewApp_subtitle_77' }, Qu.subtitle()),
                            n().createElement(
                                'div',
                                { className: 'OrderInfoViewApp_orders_9c' },
                                Object.entries(Vu).map(([u, e]) =>
                                    n().createElement(
                                        'div',
                                        { key: u, className: 'OrderInfoViewApp_order_56' },
                                        n().createElement(Xu, { orderType: e }),
                                    ),
                                ),
                            ),
                            n().createElement('div', { className: 'OrderInfoViewApp_line_97' }),
                            n().createElement(Uu, {
                                text: Qu.description(),
                                binding: {
                                    icon: n().createElement(
                                        du,
                                        Ju,
                                        n().createElement('div', { className: 'OrderInfoViewApp_description_icon_36' }),
                                    ),
                                },
                                classMix: 'OrderInfoViewApp_description_97',
                                justifyContent: ou.Center,
                            }),
                            n().createElement(
                                'div',
                                { className: 'OrderInfoViewApp_okButton_69' },
                                n().createElement(au, { size: ru.medium, type: tu.primary, onClick: t }, Qu.okButton()),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    i().render(
                        n().createElement(N, null, n().createElement(j, null, n().createElement(ue, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(825));
