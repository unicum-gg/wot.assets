(() => {
    var __webpack_modules__ = {
            373: (u, e, t) => {
                ...
                const s = R.views.common.tooltip_window.simple_tooltip_content,
                    o = (u) => {
                        ...
                        const c = (0, n.useMemo)(() => {
                            const u = Object.assign({}, l, { body: t, header: o, note: A, alert: F });
                            ...
                            E(
                                {
                                    contentId:
                                        ...
                                        B ? s.SimpleTooltipHtmlContent('resId') : s.SimpleTooltipContent('resId')),
                        ...
                        const f = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            L = (0, a.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (s(t, _, { isMouseEvent: !0, on: !0, arguments: E(n) }, x),
                                    b && b(),
            ...
            768: (u, e, t) => {
                ...
                var r = {};
                (t.r(r),
                    t.d(r, { mouse: () => c, off: () => l, on: () => F, onResize: () => o, onScaleUpdated: () => A }));
                var n = {};
                (t.r(n),
                    t.d(n, {
                        events: () => r,
                    ...
                    C = ({ emblem: u, size: e, showLevel: t = !0, isTooltipEnabled: r = !1 }) => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                ...
                                o && s().createElement(c, { label: u.level.toString(), type: u.type, size: e }),
                            ),
                        );
                    };
            },
            ...
            285: (u, e, t) => {
                ...
                const y = {
                    ...
                    O = (u) => {
                        ...
                        const a = f(),
                            ...
                            E = a.mediaHeight,
                            s = a.mediaSize;
                        return n().createElement('div', L({ className: g()(t, y[i], M[E], S[s]) }, r), e);
                    },
                    T = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                const Q = ((u, e) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: E, children: s, mocks: o }) {
                                const A = (0, r.useRef)([]),
                                    F = (t, r, n) => {
                                        var a;
                                        const E = (function ({
                                    ...
                                    c = D[0],
                                    B = D[1],
                                    d = (0, r.useState)(() => F(a, E, o)),
                                    C = d[0],
                                    _ = d[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? _(F(c, E, o)) : (l.current = !0);
                                    }, [o, c, E]),
                                    (0, r.useEffect)(() => {
                                        B(a);
                                    }, [a]),
                ...
                const Fu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    cu = (u, e, t = ou.left) => u.split(e).reduce(t === ou.left ? lu : Du, []),
                    Bu = (() => {
                        const u = new RegExp(
                    ...
                    Cu = (u, e = ou.left) => {
                        ...
                        return ((u, e = ou.left) => {
                            ...
                            const r =
                                ...
                                n = Fu(u);
                            return (cu(n, /( )/, e).forEach((u) => (t = t.concat(cu(u, r, ou.left)))), t);
                        })(u, e);
                    },
                    _u = 'FormatText_base_d0',
                    mu = ({ binding: u, text: e = '', classMix: t, alignment: a = ou.left, formatWithBrackets: i }) => {
                ...
                const bu = 'Main_base_19',
                    ...
                    Tu = 'Main_button_da';
                var ku = t(690);
                const Pu = 'VehicleName_base_c0',
                    Ru = 'VehicleName_typeIcon_97',
                    Hu = (0, z.Pi)(() => {
                        ...
                        return n().createElement(
                            ...
                            { className: Pu },
                            (0, ku.HG)(u.tier),
                            n().createElement('div', { className: Ru, style: { backgroundImage: `url(${e})` } }),
                            u.name,
                        );
                    }),
                    Iu = R.strings.prestige.prestigeRewardView,
                    Nu = (0, z.Pi)(() => {
                        const u = uu(),
                            e = u.controls,
                            t = u.model,
                            ...
                            s = E ? Iu.title.maxGradeReached() : Iu.title.default(),
                            o = E ? Iu.subtitle.maxGradeReached() : Iu.subtitle.default();
                        return n().createElement(
                            'div',
                            { className: bu },
                            n().createElement(
                                'div',
                                { className: wu },
                                n().createElement(mu, { classMix: pu, text: s }),
                                n().createElement(mu, {
                                    classMix: fu,
                                    text: o,
                                    binding: { vehicle: n().createElement(Hu, null) },
                                }),
                            ),
                            n().createElement(
                                'div',
                            ...
                            n().createElement(Eu, { mixClass: Tu, onClick: e.close }, Iu.button.confirm()),
                        );
                    }),
                    Wu = R.strings.prestige.prestigeRewardView,
                    Uu = (0, z.Pi)(() => {
                        const u = uu().controls;
                        var e;
                        return (
                ...
                engine.whenReady.then(() => {
                    H().render(
                        n().createElement(J, null, n().createElement(k, null, n().createElement(Uu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [812], () => __webpack_require__(285));
