(() => {
    var __webpack_modules__ = {
            ...
            768: (u, e, t) => {
                ...
                var n = {};
                (t.r(n), t.d(n, { getBgUrl: () => f, getTextureUrl: () => w }));
                var i = {};
                function o(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const J = (() => {
                    ...
                    uu = p.cg,
                    eu = Object.keys(v).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === v[e]), u), {}),
                    tu = {
                        set: (u, e) => {
            ...
            162: (u, e, t) => {
                ...
                const j = { base: 'ProgressBarBlink_base_24', base__small: 'ProgressBarBlink_base__small_0f' },
                    ...
                    Z = (0, r.memo)(
                        ({ size: u, lineRef: e, disabled: t, baseStyles: r, isComplete: n, withoutBounce: i }) => {
                            ...
                            return a().createElement(
                                ...
                                a().createElement('div', { className: X.gradient }),
                                s && a().createElement(V, { size: u }),
                            );
                        },
                    ),
                    Q = (0, r.memo)(
                    ...
                    nu = (0, r.memo)(
                        ({
                            ...
                            const b = (0, r.useMemo)(() => Object.assign({ width: '100%' }, au(u), tu(A)), [A, u]),
                                p = (0, r.useMemo)(() => Object.assign({ width: '0%' }, au(u), tu(A)), [A, u]),
                                w = (0, r.useMemo)(() => Object.assign({ width: '0%' }, ru(A, n), au(u)), [n, A, u]),
                                f = (0, r.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - n)}%` }, ru(A, n), au(u)),
                                    [n, A, o, u],
                                );
                            if (c) return null;
                            const v = g()(J, l, A && 0 === o && uu);
                            return a().createElement(
                                'div',
                                { style: B ? w : f, className: v },
                                a().createElement(
                                    'div',
                                    { style: m ? p : b, className: eu },
                                    a().createElement(V, { size: i }),
                                ),
                            );
                        },
                ...
                const Eu = (0, r.memo)((u) => {
                        ...
                        switch (n.animationSettings.type) {
                            case N.Simple:
                                return a().createElement(Q, su({}, n, { onEndAnimation: E, isComplete: o }));
                            case N.Growing:
                                return a().createElement(iu, su({}, n, { onEndAnimation: E, isComplete: o }));
                            default:
                                return null;
                        }
                    }),
                    lu = ({ size: u, value: e, lineRef: t, disabled: n, onComplete: i }) => {
                        ...
                        return (
                            ...
                            a().createElement(Z, { size: u, disabled: n, baseStyles: o, isComplete: s, lineRef: t })
                        );
                    },
                    Au = ['onEndAnimation'];
                function Fu() {
                ...
                const cu = (0, r.memo)(
                        ({
                            ...
                            return o.withStack
                                ? a().createElement(Du, A)
                                : a().createElement(Eu, du({ key: `${n}-${e}-${i}` }, A));
                        },
                    ),
                    Bu = (u) => ({
