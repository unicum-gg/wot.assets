(() => {
    var __webpack_modules__ = {
                        ...
                        const w = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            L = (0, n.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (s(t, C, { isMouseEvent: !0, on: !0, arguments: o(a) }, x),
                                    p && p(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((w.current.timeoutId = window.setTimeout(L, c ? 100 : 400)),
                                                      l && l(u),
                                                      T && T(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
            ...
            768: (u, e, t) => {
                ...
                var r = {};
                t.r(r),
                    t.d(r, { mouse: () => c, off: () => F, on: () => A, onResize: () => l, onScaleUpdated: () => E });
                var a = {};
                t.r(a),
                    t.d(a, {
                        events: () => r,
                    ...
                    B = ({ emblem: u, size: e, showLevel: t = !0, isTooltipEnabled: r = !1 }) => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                ...
                                l && s().createElement(c, { label: u.level.toString(), type: u.type, size: e }),
                            ),
                        );
                    };
            },
            ...
            178: (u, e, t) => {
                ...
                const m = (u) => {
                    ...
                    const a = (0, r.useContext)(c),
                        ...
                        p = { extraLarge: C, large: _, medium: g, small: h, extraSmall: b };
                ...
                const S = {
                    ...
                    M = (u) => {
                        ...
                        const n = w(),
                            ...
                            o = n.mediaHeight,
                            s = n.mediaSize;
                        return a().createElement('div', L({ className: g()(t, S[i], y[o], T[s]) }, r), e);
                    },
                    P = ['children'];
                const O = (u) => {
                    let e = u.children,
                        ...
                        return [
                            function ({ mode: n = 'real', options: o, children: s, mocks: l }) {
                                const E = (0, r.useRef)([]),
                                    ...
                                    c = D[0],
                                    d = D[1],
                                    m = (0, r.useState)(() => A(n, o, l)),
                                    B = m[0],
                                    C = m[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        F.current ? C(A(c, o, l)) : (F.current = !0);
                                    }, [l, c, o]),
                                    (0, r.useEffect)(() => {
                                        d(n);
                                    }, [n]),
                ...
                const uu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    iu = (u, e = Q.left) => {
                        ...
                        return ((u, e = Q.left) => {
                            ...
                            const r =
                                ...
                                a = uu(u);
                            return ru(a, /( )/, e).forEach((u) => (t = t.concat(ru(u, r, Q.left)))), t;
                        })(u, e);
                    },
                    ou = 'FormatText_base_d0',
                    su = ({ binding: u, text: e = '', classMix: t, alignment: n = Q.left, formatWithBrackets: i }) => {
                    ...
                    Au = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Fu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Du = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                (s = s.replace(t, `%(${o})`)),
                                    (i[o] = lu[u]
                                        ? a().createElement(
                                              'span',
                                              { className: lu[u] },
                                              a().createElement(su, { text: A, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: n(u) },
                        ...
                        return a().createElement(su, { text: s, classMix: t, binding: i });
                    });
                var cu = t(179),
                    du = t(370),
                    mu = t(375);
                const Bu = 'ProgressBottom_base_05',
                    Cu = 'ProgressBottom_progressPart_6b',
                    _u = 'ProgressBottom_progressBarWrapper_5f',
                    gu = 'ProgressBottom_progressBarWrapper__complex_95',
                    hu = 'ProgressBottom_complexBarPostfix_ca',
                    bu = 'ProgressBottom_complexBarPostfixMark_4e',
                    pu = 'ProgressBottom_complexBarPostfixMark__last_62',
                    vu = 'ProgressBottom_labels_8e',
                    fu = 'ProgressBottom_complexLabels_cc',
                    wu = 'ProgressBottom_currentLevel_90',
                    xu = 'ProgressBottom_nextLevel_c6',
                    Lu = {
                ...
                const Tu = ({ size: u = Su.Default }) => {
                        const e = g()(Lu.background, Lu[`background__${u}`]);
                ...
                const ku = { base: 'ProgressBarBlink_base_24', base__small: 'ProgressBarBlink_base__small_0f' },
                    Ru = ({ size: u }) => {
                        const e = g()(ku.base, ku[`base__${u}`]);
                        return a().createElement('div', { className: e });
                    },
                    Iu = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    Yu = (0, r.memo)(
                        ({
                            ...
                            const b = (0, r.useMemo)(() => Object.assign({ width: '100%' }, qu(u), Vu(A)), [A, u]),
                                p = (0, r.useMemo)(() => Object.assign({ width: '0%' }, qu(u), Vu(A)), [A, u]),
                                v = (0, r.useMemo)(() => Object.assign({ width: '0%' }, Ku(A, n), qu(u)), [n, A, u]),
                                f = (0, r.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - n)}%` }, Ku(A, n), qu(u)),
                                    [n, A, o, u],
                                );
                            if (d) return null;
                            const w = g()(Gu, E, A && 0 === o && zu);
                            return a().createElement(
                                'div',
                                { style: m ? v : f, className: w },
                                a().createElement(
                                    'div',
                                    { style: C ? p : b, className: ju },
                                    a().createElement(Ru, { size: i }),
                                ),
                            );
                        },
                ...
                const Ju = (0, r.memo)((u) => {
                        ...
                        switch (n.animationSettings.type) {
                            case yu.Simple:
                                return a().createElement($u, Qu({}, n, { onEndAnimation: l, isComplete: o }));
                            case yu.Growing:
                                return a().createElement(Xu, Qu({}, n, { onEndAnimation: l, isComplete: o }));
                            default:
                                return null;
                        }
                    }),
                    ue = ({ size: u, value: e, lineRef: t, disabled: n, onComplete: i }) => {
                        ...
                        return (
                            ...
                            a().createElement(Uu, { size: u, disabled: n, baseStyles: o, isComplete: s, lineRef: t })
                        );
                    },
                    ee = ['onEndAnimation'];
                function te() {
                ...
                const ne = (0, r.memo)(
                        ({
                            ...
                            return o.withStack
                                ...
                                : a().createElement(Ju, ae({ key: `${n}-${e}-${i}` }, A));
                        },
                    ),
                    ie = (u) => ({
                    ...
                    Ae = (0, r.memo)(
                        ({
                            ...
                            const d = ((u, e, t) =>
                                (0, r.useMemo)(() => {
                                    const r = (oe(0, e, u) / e) * 100;
                                    return { value: r, deltaFrom: se(r, e, t) };
                                }, [t, e, u]))(s, u, l);
                            return a().createElement(
                                'div',
                                { className: g()(Lu.base, Lu[`base__${t}`]), style: ie(e) },
                                !o && a().createElement(Tu, { size: t }),
                                a().createElement(ne, {
                                    size: t,
                                    lineRef: A,
                                    disabled: i,
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { className: g()(_u, r && gu) },
                                    a().createElement(Ae, { size: Su.Small, value: n, maxValue: i }),
                                ),
                                r &&
                                    a().createElement(
                                        'div',
                            ...
                            a().createElement(
                                ...
                                !r && a().createElement('div', { className: xu }, t),
                                r &&
                                    a().createElement(
                                        'div',
                                        { className: fu },
                                        a().createElement('div', { className: xu }, e + 1),
                                        a().createElement('div', { className: xu }, t),
                                    ),
                            ),
                        );
                    }),
                    De = 'ProgressMode_base_58',
                    ce = 'ProgressMode_topPart_35',
                    de = 'ProgressMode_bigEmblemHitArea_8e',
                    me = 'ProgressMode_infoBlock_ea',
                    Be = 'ProgressMode_title_8a',
                    Ce = 'ProgressMode_progress_fb',
                    _e = 'ProgressMode_star_9c',
                    ge = 'ProgressMode_steps_7d',
                    he = 'ProgressMode_smallEmblem_b2',
                    be = 'ProgressMode_smallEmblemHitArea_b2',
                    pe = R.strings.prestige.tooltip.eliteLevel,
                    ve = (0, X.Pi)(() => {
                        const u = V().model,
                            e = cu.Z5.getNumberFormat(u.currentProgress.get(), cu.B3.INTEGRAL),
                            t = cu.Z5.getNumberFormat(u.maxProgress.get(), cu.B3.INTEGRAL);
                        return a().createElement(
                            'div',
                            { className: De },
                            a().createElement(
                                ...
                                a().createElement(
                                    q.i,
                                    { header: pe.title(), body: pe.body() },
                                    a().createElement('div', { className: de }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: me },
                                    a().createElement('div', { className: Be }, R.strings.prestige.profile.header()),
                                    a().createElement(
                                        'div',
                                        { className: Ce },
                                ...
                                a().createElement(
                                    'div',
                                    { className: he },
                                    a().createElement(du.U, { emblem: u.nextEmblem.get(), size: mu.U.ExtraSmall }),
                                ),
                                a().createElement(
                                    Y.u,
                    ...
                    fe = 'MaxLevelMode_base_37',
                    we = 'MaxLevelMode_emblem_c5',
                    xe = 'MaxLevelMode_glow_9b',
                    Le = 'MaxLevelMode_infoBlock_4f',
                    Se = 'MaxLevelMode_title_f8',
                    ye = 'MaxLevelMode_description_a2',
                    Te = (0, X.Pi)(() => {
                        const u = V().model;
                        return a().createElement(
                            'div',
                            ...
                            a().createElement(
                                'div',
                                { className: Le },
                                a().createElement('div', { className: Se }, R.strings.prestige.profile.max.header()),
                                a().createElement(
                                    'div',
                                    { className: ye },
                ...
                const Pe = (0, X.Pi)(() => {
                    ...
                    return a().createElement(
                        'div',
                        { className: K },
                        u.emblem.get().type === Me.C.MAXIMUM
                ...
                engine.whenReady.then(() => {
                    I().render(
                        a().createElement(O, null, a().createElement(j, null, a().createElement(Pe, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [812], () => __webpack_require__(178));
