(() => {
    ...
    var __webpack_modules__ = {
                    ...
                    c = (e) => {
                        ...
                        return i().createElement(
                            ...
                            s(
                                {
                                    contentId:
                                        ((b = null == _ ? void 0 : _.hasHtmlContent),
            ...
            278: (e, t, n) => {
                ...
                const l = (e, t, n = {}, r = 0) => {
                    ...
                    c = (e) => {
                        ...
                        const T = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            M = (0, i.useMemo)(() => y || (0, r.F)().resId, [y]),
                            k = (0, i.useCallback)(() => {
                                (T.current.isVisible && T.current.timeoutId) ||
                                    (l(n, E, { isMouseEvent: !0, on: !0, arguments: s(o) }, M),
                                    P && P(),
                            ...
                            S = (0, i.useCallback)((e) => {
                                T.current.isVisible &&
                                    ...
                                    (T.current.hideTimerId = window.setTimeout(() => {
                                        ...
                                        t && !t.isSameNode(T.current.prevTarget) && L();
                                    }, 200)));
                            }, []);
                        ((0, i.useEffect)(() => {
                                  ...
                                  Object.assign(
                                      {
                                          onMouseEnter:
                                              ...
                                              (e) => {
                                                  (e.clientX === window.innerWidth &&
                                                      ...
                                                      (T.current.timeoutId = window.setTimeout(k, v ? 100 : 400)),
                                                      c && c(e),
                                                      R && R(e));
                                              }),
                                          onMouseLeave: ((e) => (t) => {
                                          ...
                                          onClick: ((e) => (t) => {
                                              (!1 === g && L(), null == _ || _(t), null == e || e(t));
                                          })(t.props.onClick),
                                          onMouseDown: ((e) => (t) => {
                                              (!1 === g && L(), null == u || u(t), null == e || e(t));
                                          })(t.props.onMouseDown),
                                      },
                                      x,
                                  ),
            ...
            528: (e, t, n) => {
                ...
                var i = {};
                (n.r(i), n.d(i, { getBgUrl: () => M, getTextureUrl: () => T }));
                var a = {};
                function s(e) {
                    return (t) => (
                        engine.on(e, t),
                ...
                const h = {
                    ...
                    P = Object.keys(y).reduce((e, t) => ((e[t] = () => g(y[t])), e), {}),
                    O = { play: Object.assign({}, P, { sound: g }), setRTPC: w };
                var x = n(308);
                function T(e, t, n = 1) {
                ...
                const ie = Object.keys(k).reduce((e, t) => ((e[t] = () => viewEnv.getShowingStatus() === k[t]), e), {}),
                    ae = {
                        set: (e, t) => {
                ...
                const de = { view: a, client: o, sound: O, intl: f };
            },
            764: (e, t, n) => {
                n.d(t, { F: () => r });
                const r = (e = 1) => {
                ...
                const d = {
                    ...
                    v = ({ label: e, type: t, size: n }) => {
                        const r = t === a.C.ENAMEL ? a.C.GOLD : t,
                            ...
                            s = `R.images.gui.maps.icons.prestige.emblemFont.${u[i]}.${r}`;
                    ...
                    g = R.strings.prestige.tooltip.eliteLevel,
                    w = ({ emblem: e, size: t, showLevel: n = !0, isTooltipEnabled: r = !1 }) => {
                        const s = ((e, t) => {
                            if (e.type === a.C.MAXIMUM) return _(t).$dyn(a.C.MAXIMUM);
                            if (e.type === a.C.UNDEFINED || e.grade < 1) return;
                            const n = e.grade <= 4 ? e.grade : 4;
                            return _(t).$dyn(e.type).$dyn(`c_${n}`);
                        })(e, t);
                        if (!s) return null;
                        const c = n && e.type !== a.C.MAXIMUM;
                        return l().createElement(
                            i.i,
                            { header: g.title(), body: g.body(), isEnabled: r },
                            l().createElement(
                                'div',
            ...
            972: (e, t, n) => {
                                ...
                                const v = (0, r.useRef)([]),
                                    b = (n, r, o) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            w = { mode: n, model: g, externalModel: s, cleanup: b };
                                        return {
                                            model: g,
                                            controls: 'mocks' === n && o ? o.controls(w) : t(w),
                                            externalModel: s,
                                            mode: n,
                                        };
                                    },
                                    ...
                                    E = w[0],
                                    p = w[1],
                                    h = (0, r.useState)(() => b(i, a, _)),
                                    f = h[0],
                                    y = h[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        g.current ? y(b(E, a, _)) : (g.current = !0);
                                    }, [_, E, a]),
                                    (0, r.useEffect)(() => {
                                        p(i);
                                    }, [i]),
                ...
                const f = (0, E.Pi)(() => {
                    ...
                    return o().createElement(
                        'div',
                        { className: w },
                        o().createElement(p.U, { emblem: e.emblem.get(), size: h.U.ExtraSmall, isTooltipEnabled: !0 }),
                    );
                });
                engine.whenReady.then(() => {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [812], () => __webpack_require__(972));
