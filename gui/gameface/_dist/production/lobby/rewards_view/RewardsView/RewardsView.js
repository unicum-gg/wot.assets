                        ...
                        return (
                            B(() => {
                                if (
                                                    ...
                                                    const e = ku(),
                                                        ...
                                                        n =
                                                            window.__feature && window.__feature !== t && t
                                                                ? `subViews.${t}`
                                                                : '';
                                                    return { modelPrefix: n, modelPath: Ae(n, ''), resId: r };
                                                })(),
                                                t = e.modelPrefix,
                                                r = u.split('.');
                                            if (r.length > 0) {
                                    ...
                                    F.current = le.addCallback(r, t, s, e === Fe.Deep);
                                }
                            }),
                            (0, r.useEffect)(() => {
                                if (e !== Fe.None)
                                    return () => {
                                        le.removeCallback(F.current, s);
                                    };
                            }, [s, e]),
                            A
                        );
