(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                'use strict';
                t.d(e, { Sw: () => a.Z, B3: () => A, Z5: () => i, B0: () => E, ry: () => m, Sy: () => h });
                class r {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            6704: (u, e, t) => {
                ...
                const A = i.O.client.getSize('rem'),
                    F = A.width,
                    l = A.height,
                    D = Object.assign({ width: F, height: l }, o(F, l, s)),
                    ...
                    d = (u) => {
                        ...
                        const n = (0, r.useContext)(c),
                            ...
                            w = { extraLarge: C, large: m, medium: g, small: h, extraSmall: p };
                    ...
                    C = (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(c),
                            ...
                            A = (0, r.useCallback)((u, e) => {
                                ...
                                E(Object.assign({ width: t, height: r }, o(t, r, s)));
                            }, []);
                        _(() => {
                ...
                const x = {
                    ...
                    M = (u) => {
                        ...
                        const a = f(),
                            ...
                            s = a.mediaHeight,
                            E = a.mediaSize;
                        return n().createElement('div', S({ className: g()(t, x[i], P[s], L[E]) }, r), e);
                    },
                    O = ['children'],
                    y = (u) => {
                        let e = u.children,
                ...
                const U = (u, e, t) => {
                    ...
                    G = (u, e, t = N.left) => u.split(e).reduce(t === N.left ? U : H, []),
                    W = (() => {
                        const u = new RegExp(
                    ...
                    $ = ['zh_cn', 'zh_sg', 'zh_tw'],
                    Y = ({ binding: u, text: e = '', classMix: t, alignment: a = N.left }) =>
                        null === e
                ...
                const uu = [
                    ...
                    eu = [V.Gold, V.Credits, V.Crystal, V.FreeXp, V.NewYearToyFragments],
                    tu = [V.BattlePassPoints],
                    ru = [V.PremiumPlus, V.Premium],
                ...
                const Fu = (u, e, t = {}, r = 0) => {
                    ...
                    lu = (u) => {
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            w = (0, r.useMemo)(() => C || Eu().resId, [C]),
                            v = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Fu(t, c, { isMouseEvent: !0, on: !0, arguments: Au(n) }, w),
                                    m && m(),
                                      ...
                                      Object.assign(
                                          {
                                              ...
                                              onClick: ((u) => (e) => {
                                                  !1 === l && T(), null == E || E(e), null == u || u(e);
                                              })(e.props.onClick),
                                              onMouseDown: ((u) => (e) => {
                                                  !1 === l && T(), null == s || s(e), null == u || u(e);
                                              })(e.props.onMouseDown),
                                          },
                                          h,
                                      ),
                ...
                const Cu = R.views.common.tooltip_window.simple_tooltip_content,
                    mu = (u) => {
                        ...
                        const A = (0, r.useMemo)(() => {
                            const u = Object.assign({}, E, { body: t, header: a, note: i, alert: s });
                ...
                const hu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        return a || s
                            ? n().createElement(lu, gu({}, e, { contentId: a || s }), r)
                            : n().createElement(Bu, e, r);
                    },
                    pu = {
                        base: 'Reward_base_ea',
                    ...
                    wu = ({
                        ...
                        const D = ((u) => {
                            ...
                            B = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case z.CURRENCY:
                                    case z.NUMBER:
                                        return n().createElement(J, { format: 'integral', value: Number(u) });
                                    case z.PREMIUM_PLUS: {
                                        const e = Number(u);
                        ...
                        return n().createElement(
                            'div',
                            { className: g()(pu.base, pu[`base__${r}`], o), style: E },
                            n().createElement(
                                hu,
                                { tooltipArgs: F, className: pu.tooltipWrapper },
                                n().createElement(
                                    n().Fragment,
                                    null,
                                    n().createElement(
                                        'div',
                                        { className: g()(pu.image, null == A ? void 0 : A.image) },
                                        D &&
                                            n().createElement('div', {
                                                className: g()(pu.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            n().createElement('div', {
                                                className: g()(pu.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        c &&
                                            n().createElement('div', {
                                                className: g()(pu.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                            ...
                            t &&
                                n().createElement(
                                    ...
                                    { tooltipArgs: l },
                                    n().createElement('div', {
                                        className: g()(pu.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                class Su extends n().PureComponent {
                        ...
                        super(...u),
                            ...
                            (this._onMouseEnter = (u) => (e) => {
                                u && u(e),
                                    ...
                                    this.props.soundHover && vu(this.props.soundHover);
                            }),
                            ...
                            (this._onMouseDown = (u) => (e) => {
                                u && u(e),
                                    ...
                                    this.props.soundClick && vu(this.props.soundClick);
                            }),
                            (this._onMouseUp = (u) => (e) => {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = g()(fu.base, fu[`base__${i}`], fu[`base__${a}`], null == s ? void 0 : s.base),
                            c = g()(fu.icon, fu[`icon__${i}`], fu[`icon__${a}`], null == s ? void 0 : s.icon),
                            B = g()(fu.glow, null == s ? void 0 : s.glow),
                            d = g()(fu.caption, fu[`caption__${i}`], null == s ? void 0 : s.caption),
                            _ = g()(fu.goto, null == s ? void 0 : s.goto);
                        return n().createElement(
                            'div',
                            Ru(
                                {
                            ...
                            'info' !== i && n().createElement('div', { className: fu.shine }),
                ...
                (Su.defaultProps = { side: 'left', type: 'back', soundHover: 'highlight', soundClick: 'play' }),
                    ((Pu = xu || (xu = {})).SHORT_DATE = 'short-date'),
                    (Pu.SHORT_TIME = 'short-time'),
                    (Pu.SHORT_DATE_TIME = 'short-date-time'),
                    (Pu.FULL_DATE = 'full-date'),
                    (Pu.FULL_DATE_TIME = 'full-date-time'),
                    (Pu.MONTH = 'month'),
                    (Pu.MONTH_DATE = 'month-date'),
                    (Pu.DATE_MONTH = 'date-month'),
                    (Pu.MONTH_YEAR = 'month-year'),
                    (Pu.WEEK_DAY = 'week-day'),
                    (Pu.WEEK_DAY_TIME = 'week-day-time'),
                    (Pu.YEAR = 'year'),
                    (Pu.DATE_YEAR = 'date-year'),
                    Date.now();
                const Lu = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    Mu = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    Ou = (u, e) => (u.length > 0 ? `${u}.${e}` : e),
                    yu = Z.Sw.instance;
                let ku;
                !(function (u) {
                    (u.None = 'None'), (u.Shallow = 'Shallow'), (u.Deep = 'Deep');
                })(ku || (ku = {}));
                const Iu = (u = 'model', e = ku.Deep) => {
                            ...
                            o = (0, r.useState)(() =>
                                ((u) => {
                                    ...
                                    ((u) =>
                                        ((u, e) =>
                                            u.split('.').reduce((u, e) => {
                                                const t = Lu(`${u}.${e}`, window);
                                                return Mu(t) ? ((u, e) => `${u}.${e}.value`)(u, e) : `${u}.${e}`;
                                            }))(u))(E),
                                ),
                            ),
                            A = o[0],
                        ...
                        return (
                            _(() => {
                                if (
                                                    ...
                                                    const e = Eu(),
                                                        ...
                                                        n =
                                                            window.__feature && window.__feature !== t && t
                                                                ? `subViews.${t}`
                                                                : '';
                                                    return { modelPrefix: n, modelPath: Ou(n, ''), resId: r };
                                                })(),
                                                t = e.modelPrefix,
                                                r = u.split('.');
                                            if (r.length > 0) {
                                    ...
                                    l.current = yu.addCallback(r, t, s, e === ku.Deep);
                                }
                            }),
                            (0, r.useEffect)(() => {
                                if (e !== ku.None)
                                    return () => {
                                        yu.removeCallback(l.current, s);
                                    };
                            }, [s, e]),
                            A
                        );
                ...
                function Gu(u = Uu.n.NONE, e = Hu, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Uu.n.NONE)
                            return (
                ...
                const qu = ['crystal', 'credits'],
                    ju = (function (u, e, t, r = ku.Deep) {
                        const a = (a) => {
                            const i = a.path || e || void 0,
                                s = Iu(i, i && Nu[i] ? ku.None : r),
                                E = Object.assign({}, t(s, a), a);
                        ...
                        ({
                                    ...
                                    ((u) => {
                                        ...
                                        return (
                                            (t = requestAnimationFrame(() => {
                                                t = requestAnimationFrame(() => {
                                                    (t = null), (e = void vu(R.sounds.gui_reward_screen_general()));
                                                });
                                            })),
                                            () => {
                            ...
                            const A = f().mediaSize <= w.Medium ? j.S296x222 : j.S400x300;
                            Wu(Uu.n.ESCAPE), Wu(Uu.n.ENTER);
                            const F = a ? { stepNumber: a } : {};
                            return n().createElement(
                                'div',
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(Su, {
                                        caption: R.strings.cosmicEvent.rewardsView.close(),
                                        onClick: () => s(),
                                        side: 'right',
                                        type: 'close',
                                    }),
                                ...
                                n().createElement(
                                    ...
                                    n().createElement('div', { className: 'RewardsViewApp_viewTitle_22' }, u),
                                    n().createElement(
                                        'div',
                                        { className: 'RewardsViewApp_title_1b' },
                                        n().createElement(Y, { text: e, binding: F }),
                                    ),
                                ),
                                n().createElement(
                                    'div',
                                    ...
                                    i.map((u, e) => {
                                        ...
                                        var r;
                                        const a = !(
                                                (t === z.MULTI && 1 === parseInt(u.value)) ||
                                                t === z.PREMIUM_PLUS ||
                                                qu.includes(u.name)
                                            ),
                                            i = qu.includes(u.name) ? u.value : '';
                                        return n().createElement(
                                            'div',
                                            { key: e, className: 'RewardsViewApp_heroImageBlock_70' },
                                            n().createElement(
                                                wu,
                                                Vu({}, u, {
                                                    image: iu(u, A),
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            ...
                                            R.strings.cosmicEvent.rewardsView.confirm(),
                                        ),
                                    ),
                                ),
                            );
                ...
                engine.whenReady.then(() => {
                    I().render(
                        n().createElement(y, null, n().createElement(ju, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(6704));
