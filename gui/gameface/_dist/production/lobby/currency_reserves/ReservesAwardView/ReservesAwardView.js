(() => {
    ...
    var __webpack_modules__ = {
            99: (u, e, t) => {
                ...
                var E = {};
                t.r(E), t.d(E, { getBgUrl: () => y, getTextureUrl: () => f });
                var F = {};
                function r(u) {
                    return (e) => (
                        engine.on(u, e),
                            ...
                            j(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = W(u);
                                    B.current = X.addCallback(n, t, o, e === Y.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== Y.None)
                                    return () => {
                                        X.removeCallback(B.current, o);
                                    };
                            }, [o, e]),
                            s
                        );
                                    ...
                                    u && e
                                        ...
                                        : u
                                          ...
                                          : e
                                            ? nu.goldSuspended
                                            : null)(e, F),
                                C = B ? A().createElement(M, { text: B, binding: s, classMix: tu.warning }) : null;
                            return A().createElement(
                                'div',
                                { className: tu.base },
                                A().createElement(
                                ...
                                A().createElement(
                                    ...
                                    A().createElement(
                                        ...
                                        C,
                                        A().createElement(_, { size: D.medium, onClick: () => o() }, nu.affirmative),
                                    ),
                                ),
                            );
                        },
