(() => {
    ...
    var __webpack_modules__ = {
            768: (u, e, t) => {
                ...
                var n = {};
                t.r(n),
                    t.d(n, { mouse: () => C, off: () => D, on: () => s, onResize: () => a, onScaleUpdated: () => i });
                var A = {};
                t.r(A),
                    t.d(A, {
                        events: () => n,
                ...
                var E = {};
                t.r(E), t.d(E, { getBgUrl: () => w, getTextureUrl: () => h });
                var F = {};
                function r(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const v = {
                    ...
                    p = Object.keys(m).reduce((u, e) => ((u[e] = () => _(m[e])), u), {}),
                    g = { play: Object.assign({}, p, { sound: _ }), setRTPC: c };
                function h(u, e, t = 1) {
            ...
            916: (u, e, t) => {
                t.d(e, { Sw: () => E.Z, B3: () => o, Z5: () => F.Z5, ry: () => l });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            56: (u, e, t) => {
                ...
                const B = ({
                    ...
                    return (
                        ...
                        A().createElement(
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    F ||
                                        (null !== B && a(B),
                                        c && c(u),
                                        t && (F || (m.current && (m.current.focus(), h(!0)))),
                                        f(!0));
                                },
                            ...
                            A().createElement(
                                'span',
                                { className: o()(i.state, i.state__default) },
                ...
                const p = (0, n.memo)(
                    ({
                        ...
                        A().createElement(
                            'span',
                            { className: o()(l.base, l[`base__${t}`], s) },
                            A().createElement(
                                'span',
                                {
                                    className: o()(
                                        l.value,
                                        l[`value__${n}`],
                                        !a && l.value__notEnough,
                                        null == D ? void 0 : D.value,
                                    ),
                                },
                                r && E > 0 && '+',
                                A().createElement(c, { value: E, format: n === v.gold ? 'gold' : 'integral' }),
                            ),
                            A().createElement('span', {
                                className: o()(l.icon, l[`icon__${n}-${t}`], null == D ? void 0 : D.icon),
                            }),
                            u &&
                                A().createElement(
                                    'span',
                ...
                const b = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    x = (u, e, t = h.left) => u.split(e).reduce(t === h.left ? f : y, []),
                    k = (() => {
                        const u = new RegExp(
                    ...
                    T = (u, e = h.left) => {
                        ...
                        return ((u, e = h.left) => {
                            ...
                            const n =
                                ...
                                A = b(u);
                            return x(A, /( )/, e).forEach((u) => (t = t.concat(x(u, n, h.left)))), t;
                        })(u, e);
                    },
                    P = 'FormatText_base_d0',
                    M = ({ binding: u, text: e = '', classMix: t, alignment: E = h.left, formatWithBrackets: F }) => {
                ...
                class U extends A().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            C = o()(L.base, L[`base__${F}`], L[`base__${E}`], null == r ? void 0 : r.base),
                            _ = o()(L.icon, L[`icon__${F}`], L[`icon__${E}`], null == r ? void 0 : r.icon),
                            c = o()(L.glow, null == r ? void 0 : r.glow),
                            l = o()(L.caption, L[`caption__${F}`], null == r ? void 0 : r.caption),
                            d = o()(L.goto, null == r ? void 0 : r.goto);
                        return A().createElement(
                            'div',
                            N(
                                {
                            ...
                            'info' !== F && A().createElement('div', { className: L.shine }),
                            ...
                            G(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = W(u);
                                    D.current = K.addCallback(n, t, r, e === Y.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== Y.None)
                                    return () => {
                                        K.removeCallback(D.current, r);
                                    };
                            }, [r, e]),
                            i
                        );
                    ...
                    (0, n.useEffect)(() => {
                        ...
                        function n(n) {
                            if (n.keyCode === u) {
                                ...
                                q.O.view.setEventHandled(), e(n), t && n.stopPropagation();
                            }
                        }
                    }, [e, u, t, A]);
                }
                const eu = {
                    ...
                    nu = (function (u, e, t, n = Y.Deep) {
                        const E = (E) => {
                            const F = E.path || e || void 0,
                                r = X(F, (F && Z[F]) || !1 ? Y.None : n),
                                o = Object.assign({}, t(r, E), E);
                                    ...
                                    u && e
                                        ...
                                        : u
                                          ...
                                          : e
                                            ? tu.goldSuspended
                                            : null)(e, F),
                                _ = B ? A().createElement(M, { text: B, binding: s, classMix: eu.warning }) : null;
                            return A().createElement(
                                'div',
                                { className: eu.base },
                                A().createElement(
                                ...
                                A().createElement(
                                    ...
                                    A().createElement(
                                        ...
                                        _,
                                        A().createElement(C, { size: D.medium, onClick: () => o() }, tu.affirmative),
                                    ),
                                ),
                            );
                        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [223], () => __webpack_require__(56));
