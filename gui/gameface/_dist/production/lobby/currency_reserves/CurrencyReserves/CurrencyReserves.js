(() => {
    ...
    var __webpack_modules__ = {
            85: (u, e, t) => {
                ...
                const g = {
                    ...
                    v = { play: Object.assign({}, b, { sound: D }), setRTPC: C },
                ...
                const Fu = { view: i, client: r, sound: v, intl: p };
            },
            20: (u, e, t) => {
                t.d(e, { n: () => n });
                let n = (function (u) {
            ...
            828: (u, e, t) => {
                t.d(e, { Sw: () => a.Z, B3: () => o, Z5: () => i.Z5, ry: () => C });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            368: (u, e, t) => {
                ...
                const k = (u = 1) => {
                    ...
                    L = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: r, modelPath: T(r, u || ''), resId: n };
                            })(),
                            t = e.modelPrefix,
                            n = u.split('.');
                        if (n.length > 0) {
                ...
                const z = (u = 'model', e = $.Deep) => {
                            ...
                            O(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = L(u);
                                    F.current = I.addCallback(n, t, o, e === $.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== $.None)
                    ...
                    H = (p.Sw.instance, y),
                    W = 'Countdown_base_d0c0c',
                    G = 'Countdown_icon_a453a',
                    U = 'Countdown_description_ee2e0',
                    ...
                    X = (0, n.memo)(
                        ({
                            ...
                            const A = null != i ? i : t !== o.Description ? 1 : void 0,
                                F = H(u, A),
                                _ = (() => {
                            ...
                            const d = V(
                                (function (u = 0) {
                                    ...
                                    e -= t * f;
                                    const n = Math.trunc(e / v);
                                    e -= n * v;
                                    const r = Math.trunc(e / b);
                                    return ((e -= r * b), { days: t, hours: n, minutes: r, seconds: e });
                                })(F),
                                t,
                            );
                            return r().createElement(
                                ...
                                e !== s.None &&
                                    r().createElement('div', {
                                        className: c()(G, E.icon),
                                        style: { backgroundImage: `url('${K(e, _)}')` },
                                    }),
                                r().createElement('div', { className: c()(U, E.text) }, d),
                            );
                        },
                    ),
                    Y = 'FormatText_base_f27a4',
                    Z = ({ binding: u, text: e = '', classMix: t, alignment: a = A.left, formatWithBrackets: i }) => {
                ...
                function eu(u = x.O.client.getSize('rem')) {
                    const e = u.width,
                        t = u.height;
                ...
                (0, n.memo)((u) => {
                    ...
                    const r = (0, n.useContext)(nu),
                        ...
                        g = { extraLarge: d, large: D, medium: C, small: m, extraSmall: B };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && c) return Q(e, t, g);
                        if (t.largeWidth && E) return Q(e, t, g);
                        if (t.mediumWidth && A) return Q(e, t, g);
                        if (t.smallWidth && F) return Q(e, t, g);
                        if (t.extraSmallWidth && _) return Q(e, t, g);
                        if (
                ...
                const au = ({ children: u }) => {
                        ...
                        return (
                            (0, n.useLayoutEffect)(() => {
                                function u() {
                                    a((u) => {
                                        const e = x.O.client.getSize('rem');
                                        return u.width === e.width && u.height === e.height ? u : eu(e);
                                    });
                                }
                                return (
                                    u(),
                                    o(!0),
                                    x.O.client.events.on('clientResized', u),
                                    x.O.client.events.on('self.onScaleUpdated', u),
                                    () => {
                                        (x.O.client.events.off('clientResized', u),
                                            x.O.client.events.off('self.onScaleUpdated', u));
                                    }
                                );
                            }, []),
                            r().createElement(nu.Provider, { value: t }, s && u)
                        );
                    },
                    iu = {};
                function su(u) {
                ...
                const ou = Object.keys(uu).reduce((u, e) => {
                        const t = `media__${uu[e]}`;
                        return ((u[t] = t), u);
                    }, {}),
                    lu = ({ children: u, className: e }) => {
                        const t = (function (u, e, t) {
                            const r = (0, n.useContext)(nu);
                            let a = Object.entries(r).filter(([u, e]) => !0 === e && u in uu);
                            return (
                        ...
                        return r().createElement('div', { className: c()(t.media, e) }, u);
                    },
                    cu = (u, e) => {
                        const t = (t) =>
                            r().createElement(
                                au,
                                null,
                                r().createElement(lu, { className: e }, r().createElement(u, t)),
                            );
                        return ((t.displayName = `WithModel(${su(u)})`), t);
                    },
                    Eu = {
                ...
                const _u = (u) => {
                    ...
                    const p = (0, n.useCallback)(
                            (u) => {
                                (null == s || s(u), x.O.sound.play.sound(C));
                            },
                            [s, C],
                        ),
                        h = (0, n.useCallback)(
                        ...
                        b = (0, n.useCallback)(
                            (u) => {
                                (null == l || l(u), x.O.sound.play.sound(B));
                            },
                            [l, B],
                        ),
                        v = (0, n.useCallback)(
                    ...
                    return r().createElement(
                        ...
                        'info' !== d && r().createElement('div', { className: Eu.shine }),
                        r().createElement(
                            'div',
                            {
                                className: c()(
                            ...
                            r().createElement('div', { className: c()(Eu.glow, null == i ? void 0 : i.glow) }),
                        ),
                        r().createElement(
                            'div',
                            { className: c()(Eu.caption, Eu[`caption__${d}`], null == i ? void 0 : i.caption) },
                            e,
                        ),
                        a && r().createElement('div', { className: c()(Eu.goto, null == i ? void 0 : i.goto) }, a),
                    );
                };
                var du = t(20);
                const Du = (u) => {
                ...
                function Cu(u = du.n.NONE, e = Du, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== du.n.NONE)
                            return (
                ...
                const bu = ({
                    ...
                    return (
                        (0, n.useEffect)(() => {
                            function u(u) {
                                B && null !== C.current && !C.current.contains(u.target) && g(!1);
                            }
                            return (
                        ...
                        r().createElement(
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    ...
                                    (null !== D && e && Bu(D),
                                        o && o(u),
                                        F && (t || (C.current && (C.current.focus(), g(!0)))),
                                        e && b(!0));
                                },
                            ...
                            r().createElement(
                                'span',
                                { className: c()(gu.state, gu.state__default) },
                ...
                const vu = ({ value: u, format: e = 'integral' }) => {
                        const t = (function (u) {
                ...
                const Ru = (0, n.memo)(
                        ({
                            ...
                            showPlus: s,
                            isEnough: o = !0,
                            stockBackgroundName: l = xu.Red,
                            className: E,
                            classNames: A,
                        }) =>
                            r().createElement(
                                'span',
                                { className: c()(fu.base, fu[`base__${t}`], E) },
                                r().createElement(
                                    'span',
                                    {
                                        className: c()(
                                            fu.value,
                                            fu[`value__${n}`],
                                            !o && fu.value__notEnough,
                                            null == A ? void 0 : A.value,
                                        ),
                                    },
                                    s && a > 0 && '+',
                                    r().createElement(vu, { value: a, format: n === yu.gold ? 'gold' : 'integral' }),
                                ),
                                r().createElement('span', {
                                    className: c()(fu.icon, fu[`icon__${n}-${t}`], null == A ? void 0 : A.icon),
                                }),
                                u &&
                                    r().createElement(
                                        'span',
                                        {
                                            className: c()(
                                                fu.stock,
                                                i && fu.stock__indent,
                                                e && fu.stock__interactive,
                                                null == A ? void 0 : A.stock,
                                            ),
                                        },
                                        r().createElement('span', {
                                            className: fu.stockBackground,
                ...
                const Pu = ({ size: u = Su.Default }) => {
                        const e = c()(ku.background, ku[`background__${u}`]);
                        return r().createElement('div', { className: e });
                    },
                    Tu = { base: 'ProgressBarBlink_base_d7125', base__small: 'ProgressBarBlink_base__small_b92f8' },
                    Nu = ({ size: u }) => {
                        const e = c()(Tu.base, Tu[`base__${u}`]);
                        return r().createElement('div', { className: e });
                    },
                    Lu = {
                    ...
                    Mu = (0, n.memo)(
                        ({ size: u, lineRef: e, disabled: t, baseStyles: n, isComplete: a, withoutBounce: i }) => {
                            ...
                            return r().createElement(
                                ...
                                r().createElement('div', { className: Lu.pattern }),
                                r().createElement('div', { className: Lu.gradient }),
                                o && r().createElement(Nu, { size: u }),
                            );
                        },
                    ),
                    Iu = (u, e) => {
                ...
                const Hu = 'ProgressBarDeltaGrow_base_f4d46',
                    Wu = 'ProgressBarDeltaGrow_base__withoutBounce_b1398',
                    Gu = 'ProgressBarDeltaGrow_glow_c912d',
                    ...
                    qu = (0, n.memo)(
                        ({
                            ...
                            const h = (0, n.useMemo)(() => Object.assign({ width: '100%' }, Vu(u), Uu(A)), [A, u]),
                                b = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Vu(u), Uu(A)), [A, u]),
                                v = (0, n.useMemo)(() => Object.assign({ width: '0%' }, ju(A, a), Vu(u)), [a, A, u]),
                                f = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(s - a)}%` }, ju(A, a), Vu(u)),
                                    [a, A, s, u],
                                );
                            if (D) return null;
                            const w = c()(Hu, E, A && 0 === s && Wu);
                            return r().createElement(
                                'div',
                                { style: C ? v : f, className: w },
                                r().createElement(
                                    'div',
                                    { style: B ? b : h, className: Gu },
                                    r().createElement(Nu, { size: i }),
                                ),
                            );
                        },
                    ),
                    ...
                    Xu = 'ProgressBarDeltaSimple_base_cfcd3',
                    Yu = 'ProgressBarDeltaSimple_delta_dc2b6',
                    Zu = (0, n.memo)(
                        ({
                            transitionDuration: u,
                            transitionDelay: e,
                            ...
                            return d
                                ...
                                : r().createElement(
                                      'div',
                                      { className: Xu, style: g },
                                      r().createElement(
                                          'div',
                                          { style: D ? m : B, className: Yu },
                                          r().createElement(Nu, { size: i }),
                                      ),
                                  );
                        },
                ...
                const ee = (0, n.memo)((u) => {
                        ...
                        switch (a.animationSettings.type) {
                            case Ou.Simple:
                                return r().createElement(Qu, ue({}, a, { onEndAnimation: l, isComplete: s }));
                            case Ou.Growing:
                                return r().createElement(Ku, ue({}, a, { onEndAnimation: l, isComplete: s }));
                            default:
                                return null;
                        }
                    }),
                    te = ({ size: u, value: e, lineRef: t, disabled: a, onComplete: i }) => {
                        ...
                        return (
                            ...
                            r().createElement(Mu, { size: u, disabled: a, baseStyles: s, isComplete: o, lineRef: t })
                        );
                    },
                    ne = ['onEndAnimation'];
                function re() {
                ...
                const se = (0, n.memo)(
                        ({
                            ...
                            return s.withStack
                                ...
                                : r().createElement(ee, ie({ key: `${a}-${e}-${i}` }, E));
                        },
                    ),
                    oe = (u) => {
                        var e, t, n, r, a, i, s, o, l, c, E, A, F, _, d, D, C, m, B, g;
                        return {
                            ...
                            '--progress-pattern-gradient-mixBlendMode':
                                null != (c = u.pattern.mixBlendMode) ? c : 'overlay',
                            '--progress-glow': `url('${u.glow}')`,
                            '--progress-glow-width':
                                null != (E = null == (A = u.glowSettings) ? void 0 : A.width) ? E : '60rem',
                            '--progress-glow-height':
                                null != (F = null == (_ = u.glowSettings) ? void 0 : _.height) ? F : '100rem',
                            '--progress-glow-small-width':
                                null != (d = null == (D = u.glowSettings) ? void 0 : D.smallWidth) ? d : '44rem',
                            '--progress-glow-small-height':
                                null != (C = null == (m = u.glowSettings) ? void 0 : m.smallHeight) ? C : '43rem',
                            '--progress-glow-mixBlendMode':
                                null != (B = null == (g = u.glowSettings) ? void 0 : g.mixBlendMode) ? B : 'lighten',
                    ...
                    ce =
                        (Object.assign({}, le, {
                            ...
                            line: Object.assign({}, le.line, {
                                bgColorBase: '#83C6A5',
                                bgColorFinished: 'rgba(10, 230, 72, 0.6)',
                            }),
                            pattern: Object.assign({}, le.pattern, {
                ...
                const Ae = {
                    ...
                    _e = (0, n.memo)(
                        ({
                            ...
                            return r().createElement(
                                'div',
                                { className: c()(ku.base, D, ku[`base__${t}`]), style: oe(e) },
                ...
                let de = (function (u) {
                    return ((u.Credits = 'Credits'), (u.Gold = 'Gold'), u);
                })({});
                const De = {
                        base: 'CurrencyReserve_base_ade47',
                        mainContainer: 'CurrencyReserve_mainContainer_dc8be',
                        headerBlock: 'CurrencyReserve_headerBlock_c2ac9',
                        heading: 'CurrencyReserve_heading_a0b89',
                        heading_glow: 'CurrencyReserve_heading_glow_cf680',
                        base__credits: 'CurrencyReserve_base__credits_d3a2a',
                        heading_text: 'CurrencyReserve_heading_text_fdc91',
                        subheader: 'CurrencyReserve_subheader_ff176',
                        subheader_icon: 'CurrencyReserve_subheader_icon_a3f00',
                        subheader_text: 'CurrencyReserve_subheader_text_ccc96',
                        infoButton: 'CurrencyReserve_infoButton_a4d20',
                        infoIcon: 'CurrencyReserve_infoIcon_d6ea9',
                        description: 'CurrencyReserve_description_ebdc3',
                        progress: 'CurrencyReserve_progress_d5423',
                        progress__locked: 'CurrencyReserve_progress__locked_b3c13',
                        progress_content: 'CurrencyReserve_progress_content_ab39b',
                        progress_label: 'CurrencyReserve_progress_label_faaea',
                        progress_highlight: 'CurrencyReserve_progress_highlight_b05d6',
                        progress_highlight_background: 'CurrencyReserve_progress_highlight_background_afefe',
                        progress_highlight__locked: 'CurrencyReserve_progress_highlight__locked_d7d44',
                        progress_highlight_icon: 'CurrencyReserve_progress_highlight_icon_a0752',
                        progress_highlight__cancelled: 'CurrencyReserve_progress_highlight__cancelled_d8f7b',
                        progress_highlight__full: 'CurrencyReserve_progress_highlight__full_d2c33',
                        amount: 'CurrencyReserve_amount_f43bf',
                        amount__inactive: 'CurrencyReserve_amount__inactive_c5786',
                        maxAmount: 'CurrencyReserve_maxAmount_b55fd',
                        disabled: 'CurrencyReserve_disabled_c1fe4',
                        suspended: 'CurrencyReserve_suspended_f7a4b',
                        suspended__accumulating: 'CurrencyReserve_suspended__accumulating_c5a1f',
                        suspended__full: 'CurrencyReserve_suspended__full_e371a',
                        actionButton: 'CurrencyReserve_actionButton_ec2c1',
                        footer: 'CurrencyReserve_footer_a2b7c',
                    },
                    Ce = {
                        [de.Credits]: {
                    ...
                    me = { [de.Credits]: yu.credits, [de.Gold]: yu.gold },
                    Be = {
                        [de.Credits]: R.images.gui.maps.icons.currency_reserves.premium_icon(),
                        [de.Gold]: R.images.gui.maps.icons.currency_reserves.wotplus_icon(),
                    },
                    ge = ({
                        className: u,
                        currency: e,
                        ...
                        const E = wu.extraLarge,
                            A = (0, n.useMemo)(
                                () => ({
                                    maxCapacity: r().createElement(Ru, { size: wu.small, value: s, type: me[e] }),
                                }),
                                [e, s],
                            ),
                            F = ((u) => {
                                if (u in Ce) return Ce[u];
                        ...
                        return r().createElement(
                            'div',
                            { className: c()(De.base, De[`base__${e.toLowerCase()}`], u) },
                            r().createElement(
                                'div',
                                { className: De.headerBlock },
                                r().createElement(
                                    'div',
                                    { className: De.heading },
                                    r().createElement('span', { className: De.heading_text }, F.title),
                                    r().createElement(
                                        bu,
                                        { type: 'ghost', mixClass: De.infoButton, onClick: () => l() },
                                        r().createElement('span', { className: De.infoIcon }),
                                    ),
                                    r().createElement('div', { className: De.heading_glow }),
                                ),
                                r().createElement(
                                    'div',
                                    { className: De.subheader },
                                    r().createElement('img', { src: Be[e], className: De.subheader_icon }),
                                    r().createElement('span', { className: De.subheader_text }, F.subheader),
                                ),
                            ),
                            r().createElement(
                                'div',
                                { className: De.mainContainer },
                                i
                                    ? r().createElement(
                                          r().Fragment,
                                          null,
                                          !D &&
                                              r().createElement(
                                                  ...
                                                  r().createElement(
                                                      'div',
                                                      { className: c()(De.amount, d && De.amount__inactive) },
                                                      r().createElement(Ru, { size: E, type: me[e], value: t }),
                                                  ),
                                                  r().createElement(
                                                      'div',
                                                      { className: c()(De.progress, D && De.progress__locked) },
                                                      r().createElement(
                                                          'div',
                                                          { className: De.progress_content },
                                                          r().createElement(_e, {
                                                              size: Su.Small,
                                                              value: t,
                                                              maxValue: s,
                                                          ...
                                                          r().createElement(
                                                              'div',
                                                              { className: De.progress_label },
                                                              r().createElement('div', null, '0'),
                                                              r().createElement(
                                                                  'div',
                                                                  { className: c()(m && De.maxAmount) },
                                                                  r().createElement(vu, { value: s }),
                                                              ),
                                                          ),
                                                          (D || C || _) &&
                                                              r().createElement(
                                                                  ...
                                                                  {
                                                                      className: c()(
                                                                          De.progress_highlight,
                                                                          D && De.progress_highlight__locked,
                                                                          C && De.progress_highlight__cancelled,
                                                                          _ && De.progress_highlight__full,
                                                                      ),
                                                                  },
                                                                  r().createElement('div', {
                                                                      className: De.progress_highlight_icon,
                                                                  }),
                                                                  r().createElement('div', {
                                                                      className: De.progress_highlight_background,
                                                                  }),
                                                              ),
                                                      ),
                                                  ),
                                          ...
                                          D &&
                                              r().createElement(Z, {
                                                  classMix: c()(De.description, D && De.description__locked),
                                                  binding: A,
                                                  text: F.descriptionActive,
                                              }),
                                      )
                                    : r().createElement('div', { className: De.disabled }, Ce.unavailable),
                            ),
                            r().createElement(
                                'div',
                                { className: De.footer },
                                i &&
                                    ...
                                    r().createElement(
                                        'div',
                                        {
                                            className: c()(
                                                De.suspended,
                                                C && De.suspended__accumulating,
                                                m && De.suspended__full,
                                            ),
                                        },
                                        m ? F.suspendedFull : F.suspended,
                                    ),
                                d &&
                                    r().createElement(
                                        bu,
                                        { size: hu.medium, mixClass: De.actionButton, onClick: () => o() },
                                        Ce.action,
                                    ),
                            ),
                        );
                    ...
                    pe =
                        ((function (u, e, t, n = $.Deep) {
                            const a = (a) => {
                                const i = a.path || e || void 0,
                                    s = z(i, (i && iu[i]) || !1 ? $.None : n),
                                    o = Object.assign({}, t(s, a), a);
                                return r().createElement(u, o);
                            };
                            a.displayName = `WithModel(${su(u)})`;
                        })(ge, null, (u, e) => Object.assign({}, e, u)),
                        {
                            base: 'CurrencyReservesApp_base_e1ebe',
                            mediaWrapper: 'CurrencyReservesApp_mediaWrapper_dd265',
                            close: 'CurrencyReservesApp_close_fbd23',
                            content: 'CurrencyReservesApp_content_fd7f4',
                            reserves: 'CurrencyReservesApp_reserves_fc49f',
                            openTime: 'CurrencyReservesApp_openTime_fa903',
                            openTime_text: 'CurrencyReservesApp_openTime_text_cf9d4',
                            openTime_countdown: 'CurrencyReservesApp_openTime_countdown_e5fe6',
                            openTime_highlight: 'CurrencyReservesApp_openTime_highlight_fd6ff',
                            countdownText: 'CurrencyReservesApp_countdownText_d9b95',
                            footer: 'CurrencyReservesApp_footer_bf83d',
                            footer_text: 'CurrencyReservesApp_footer_text_dcae8',
                            footer_interval: 'CurrencyReservesApp_footer_interval_e06b3',
                        }),
                    he = {
                    ...
                    be = { interval: r().createElement('div', { className: pe.footer_interval }, he.footerInterval) },
                    ve = { text: pe.countdownText };
                new Image().src = 'R.images.gui.maps.icons.currency_reserves.background';
                const fe = cu(({ path: u = 'model' }) => {
                        const e = z(u, 'model' === u ? $.Deep : $.None),
                            t = e.onClose,
                            a = e.timeToOpen,
                            i = `${u}.goldReserve`,
                            s = z(`${u}.creditReserve`, 'model' === u ? $.Deep : $.None),
                            o = z(i, 'model' === u ? $.Deep : $.None),
                            l = (function () {
                                ...
                                return (
                                    (0, n.useEffect)(() => {
                                        const u = () => {
                                            t(x.O.view.getExternalPaddingsRem());
                                        };
                                        return (
                                            u(),
                            ...
                            c = s.isActive && s.isEnabled,
                            E = o.isActive && o.isEnabled,
                            A = s.amount > 0,
                            F = o.amount > 0,
                            _ = ((c || A) && s.isEnabled) || ((E || F) && o.isEnabled),
                            d = (0, n.useCallback)(() => {
                                t();
                            }, [t]);
                        var D;
                        return (
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: pe.reserves },
                                        r().createElement(ge, {
                                            className: pe.creditReserve,
                                            currency: s.currency,
                                            amount: s.amount,
                                            isActive: s.isActive,
                                            isEnabled: s.isEnabled,
                                            maxCapacity: s.maxCapacity,
                                            onActionButtonClick: s.onActionButtonClick,
                                            onInfoButtonClick: s.onInfoButtonClick,
                                        }),
                                        r().createElement(ge, {
                                            className: pe.goldReserve,
                                            currency: o.currency,
                                            amount: o.amount,
                                            isActive: o.isActive,
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: pe.openTime },
                                        _ &&
                                            r().createElement(
                                                r().Fragment,
                                                null,
                                                r().createElement('div', { className: pe.openTime_text }, he.openTime),
                                                r().createElement(
                                                    'div',
                                                    { className: pe.openTime_countdown },
                                                    r().createElement(X, { duration: a, classNames: ve }),
                                                    r().createElement('div', { className: pe.openTime_highlight }),
                                                ),
                                            ),
                                    ),
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            ...
                                            r().createElement(Z, { binding: be, text: he.footer }),
                                        ),
                                    ),
                                ),
                            )
                ...
                ((window.onload = () => {
                    ...
                    engine.whenReady.then(() => {
                        i().render(r().createElement(fe, null), we);
                    }));
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [223], () => __webpack_require__(368));
