(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                ...
                function m(u, e, t, E, r, A, n) {
                    ...
                    i.done ? e(a) : Promise.resolve(a).then(E, r);
                }
            ...
            1972: (u, e, t) => {
                    ...
                    return (
                        l(() => {
                            if (
                                                ...
                                                const e = D(),
                                                    ...
                                                    r =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: r, modelPath: _(r, ''), resId: E };
                                            })(),
                                            t = e.modelPrefix,
                                            E = u.split('.');
                                        if (E.length > 0) {
                                ...
                                c.current = C.addCallback(E, t, i, e === m.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== m.None)
                                return () => {
                                    C.removeCallback(c.current, i);
                                };
                        }, [i, e]),
                        s
                    );
                ...
                const w = (u, e, t = {}, E = 0) => {
                    ...
                    v = (u) => {
                        ...
                        const b = (0, E.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            f = (0, E.useMemo)(() => c || D().resId, [c]),
                            S = (0, E.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (w(t, _, { isMouseEvent: !0, on: !0, arguments: p(r) }, f),
                                    h && h(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((b.current.timeoutId = window.setTimeout(S, o ? 100 : 400)),
                                                          A && A(u),
                                                          M && M(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                                                  (T(), null == n || n(e), null == u || u(e));
                                              })(e.props.onMouseLeave),
                                              onClick: ((u) => (e) => {
                                                  (!1 === s && T(), null == a || a(e), null == u || u(e));
                                              })(e.props.onClick),
                                              onMouseDown: ((u) => (e) => {
                                                  (!1 === s && T(), null == i || i(e), null == u || u(e));
                                              })(e.props.onMouseDown),
                                          },
                                          x,
                                      ),
                ...
                const M = F.O.client.getSize('rem'),
                    O = M.width,
                    P = M.height,
                    y = Object.assign({ width: O, height: P }, L(O, P, S)),
                    N = (0, E.createContext)(y),
                    k = ['children'],
                    H = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                        ...
                        const r = (0, E.useContext)(N),
                            ...
                            h = { extraLarge: _, large: C, medium: m, small: d, extraSmall: c };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && D) return f(e, t, h);
                            if (t.largeWidth && o) return f(e, t, h);
                            if (t.mediumWidth && l) return f(e, t, h);
                            if (t.smallWidth && s) return f(e, t, h);
                            if (t.extraSmallWidth && B) return f(e, t, h);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                ...
                ((H.defaultProps = {
                    ...
                    (0, E.memo)(H),
                    (0, E.memo)(({ children: u }) => {
                        const e = (0, E.useContext)(N),
                            t = (0, E.useState)(e),
                            A = t[0],
                            n = t[1],
                            i = (0, E.useCallback)((u, e) => {
                                const t = F.O.view.pxToRem(u),
                                    E = F.O.view.pxToRem(e);
                                n(Object.assign({ width: t, height: E }, L(t, E, S)));
                            }, []);
                        (l(() => {
                            engine.on('clientResized', i);
                        }),
                            (0, E.useEffect)(() => () => engine.off('clientResized', i), [i]));
                        const a = (0, E.useMemo)(() => Object.assign({}, A), [A]);
                        return r().createElement(N.Provider, { value: a }, u);
                    }),
                    (function (u) {
                ...
                const G = ['xl', 'lg', 'md', 'sm', 'xs'],
                    j = (u) => u.includes('_') && ((u) => G.includes(u))(u.split('_').at(-1)),
                    V = [I.ExtraLarge, I.Large, I.Medium, I.Small, I.ExtraSmall],
                    X = (u, e) =>
                        Object.keys(u).reduce((t, E) => {
                            ...
                            return (
                                void 0 === r ||
                                    ((u, e) => G.some((t) => void 0 !== e[`${u}_${t}`]))(E, u) ||
                                    (t[E] = r),
                                t
                            );
                        }, {}),
                ...
                const $ = {
                    ...
                    J = K((u) => {
                        let e = u.className,
                            ...
                            m = u.row,
                            d = u.flexDirection,
                            c = void 0 === d ? (C ? 'column' : m && 'row') || void 0 : d,
                            h = u.flexStart,
                            g = u.center,
                            p = u.flexEnd,
                            w = u.spaceBetween,
                        ...
                        const W = (0, E.useMemo)(() => {
                                const u = { mt: F, mr: o, mb: s, ml: _ },
                                    e = ((u) =>
                                        Z.reduce((e, t) => {
                                            const E = u[t];
                                            return E && 'number' != typeof E ? e.concat($[!0 === E ? 'MD' : E][t]) : e;
                                        }, []))(u),
                                    E = ((u) =>
                                        Z.reduce((e, t) => {
                                            const E = u[t];
                                            return ('number' == typeof E && (e[Q[t]] = E + 'rem'), e);
                                        }, {}))(u);
                                return {
                            ...
                            }, [t, A, F, o, s, _, k, N, T, c, O, b, S]),
                            U = W.computedStyle,
                            G = W.computedClassNames;
                        return r().createElement('div', q({ className: a()(z.base, ...G, e), style: U }, I), H);
                    });
                let uu;
                function eu(u, e) {
                ...
                const tu = (u, e, t) => {
                    ...
                    ru = (u, e, t = uu.left) => u.split(e).reduce(t === uu.left ? tu : Eu, []),
                    Au = (() => {
                        const u = new RegExp(
                    ...
                    iu = ({ binding: u, text: e = '', classMix: t, alignment: A = uu.left }) =>
                        null === e
                ...
                const su = Object.keys(Fu()),
                    ...
                    cu = K((u) => {
                        ...
                        return r().createElement(
                            ...
                            lu(
                                {
                                    className: a()(Du.base, t && Du[t], p, A),
                                    style: g,
                                    mt: !0 === D ? mu[t || 'paragraph-P16'].mt : D,
                            ...
                            void 0 !== d ? r().createElement(iu, lu({}, d, { text: e })) : e,
                        );
                    }),
                    hu = 1.6;
                let gu, pu, wu, vu, xu;
                ...
                (!(function (u) {
                    ...
                    ((bu = xu || (xu = {})).SHORT_DATE = 'short-date'),
                ...
                var Su;
                (Date.now(),
                    ((Su = fu || (fu = {})).UNDEFINED = 'undefined'),
                    (Su.BOSS = 'boss'),
                    (Su.BOSS_2025 = 'boss2025'),
                    (Su.BOSS_SPECIAL = 'bossSpecial'),
                    (Su.HUNTER = 'hunter'));
                const Tu = (u) => (e, t) =>
                        e / t >= 2.4000000000000004
                            ? u(viewEnv.remToPx(t) * hu, viewEnv.remToPx(t), e, t)
                            : u(viewEnv.remToPx(e), 0.625 * viewEnv.remToPx(e), e, t),
                    Lu =
                        (Tu((u, e, t, E) => {
                            const r = { width: viewEnv.remToPx(900) * hu, height: viewEnv.remToPx(900) },
                                A = { width: viewEnv.remToPx(1200) * hu, height: viewEnv.remToPx(1200) };
                            return u < r.width
                                ? r
                                : t > S.medium.width && E > S.medium.height && u < A.width
                                  ? A
                                  : { width: u, height: e };
                        }),
                        Tu((u, e) => {
                            const t = { width: viewEnv.remToPx(700) * hu, height: viewEnv.remToPx(700) };
                        ...
                        (u, e) => {
                            const t = (function (u = 0) {
                                ...
                                A = t.minutes;
                            return E >= 1
                                ? eu(e.days(), { days: E, hours: r })
                                : r >= 1
                                  ? eu(e.hours(), { hours: r, minutes: A })
                                  : A >= 1
                                    ? eu(e.minutes(), { minutes: A })
                                    : e.lessMinute();
                        }),
                    Mu = R.strings.white_tiger.entryPoint,
                    Ou = {
                        base: 'App_base_94',
                        bg: 'App_bg_e6',
                ...
                const Pu = {
                        '302*152': Ru.Big,
                        '302*114': Ru.WideSmall,
                        '222*114': Ru.ThinSmall,
                        '162*114': Ru.ThinExtraSmall,
                    },
                    yu = { type: pu.HUNTER },
                    Nu = { type: pu.BOSS },
                    ku = '999+',
                    Hu = R.strings.white_tiger.entryPoint,
                    Iu = () => {
                        const u = d(),
                            e = u.state,
                            t = u.timeLeft,
                            A = u.onClick,
                            n = u.hunterLootBoxesCount,
                            i = u.bossLootBoxesCount,
                            D = (0, E.useRef)(null),
                            o = e === vu.LOCKED || e === vu.BATTLES_END,
                            l = e === vu.BATTLES_END,
                            s = (0, E.useState)(Ru.Big),
                            B = s[0],
                            _ = s[1],
                            C = a()(Ou.base, Ou[`base__${B}`], o && Ou.base__locked),
                            m = l ? Hu.battlesEnd() : Hu.locked(),
                            g = (0, E.useMemo)(
                                () =>
                                    ((u, e) => {
                                        const t = Lu(u, Mu.timeLeft);
                                        return e
                                            ? ((E = Mu.eventEnd()),
                                              (r = { value: t }),
                                              E.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                        ...
                        (0, E.useEffect)(() => {
                            ...
                            return (
                                ...
                                () => {
                                    engine.off('screenResized', r);
                                }
                            );
                        }, []);
                        const p = a()(Ou.timerIcon, o && !l && Ou.timerIcon__locked);
                        return r().createElement(
                            v,
                            {
                            ...
                            r().createElement(
                                'div',
                                {
                                    ...
                                    onMouseOver: h.playHighlight,
                                },
                                r().createElement('div', { className: Ou.frame }),
                                r().createElement('div', { className: Ou.highlight }),
                                r().createElement(
                                    'div',
                                    { className: Ou.lootBoxCounts },
                                    r().createElement(
                                        v,
                                        {
                                        ...
                                        r().createElement(cu, {
                                            className: a()(Ou.value, Ou.value__hunter),
                                            text: String(n > 999 ? ku : n),
                                        }),
                                    ),
                                    r().createElement(
                                        v,
                                        ...
                                        r().createElement(cu, { className: Ou.value, text: String(i > 999 ? ku : i) }),
                                    ),
                                ),
                                r().createElement(
                                    'div',
                                    { className: Ou.effect },
                                    r().createElement('div', { className: Ou.light }),
                                ),
                                r().createElement('div', { className: Ou.bg }),
                                r().createElement('div', { className: Ou.shadow }),
                                r().createElement(
                                    'div',
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: Ou.head },
                                        r().createElement(cu, { className: Ou.title, text: Hu.title() }),
                                        o && r().createElement(cu, { className: Ou.subtitle, text: m }),
                                    ),
                                    r().createElement(
                                        'div',
                                        { className: Ou.timeLeft },
                                        r().createElement('div', { className: p }),
                                        r().createElement(cu, { text: g }),
                                    ),
                                ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    n().render(r().createElement(Iu, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1972));
