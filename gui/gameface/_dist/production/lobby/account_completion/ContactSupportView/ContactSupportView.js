(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var F = {};
                t.r(F), t.d(F, { getBgUrl: () => c, getTextureUrl: () => l });
                var n = {};
                function i(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            364: (u, e, t) => {
                ...
                function c(u, e, t, A, E, F, n) {
                    ...
                    i.done ? e(r) : Promise.resolve(r).then(A, E);
                }
            ...
            512: (u, e, t) => {
                ...
                const i = ({ name: u, children: e }) => {
                        ...
                        return (
                            E().useEffect(() => {
                                const e = ({ viewName: t }) => {
                                    t === u && (n(!1), engine.off('subView:destroy', e));
                                };
                ...
                const B = D.O.client.getSize('rem'),
                    C = B.width,
                    l = B.height,
                    c = Object.assign({ width: C, height: l }, s(C, l, a)),
                ...
                const m = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.largeWidth && s) return r(e, t, v);
                        if (t.mediumWidth && B) return r(e, t, v);
                        if (t.smallWidth && C) return r(e, t, v);
                        if (t.extraSmallWidth && l) return r(e, t, v);
                        if (
                        ...
                        const e = (0, A.useContext)(d),
                            ...
                            i = (0, A.useCallback)((u, e) => {
                                const t = D.O.view.pxToRem(u),
                                    A = D.O.view.pxToRem(e);
                                n(Object.assign({ width: t, height: A }, s(t, A, a)));
                            }, []);
                        h(() => {
                            engine.on('clientResized', i);
                        }),
                            (0, A.useEffect)(() => () => engine.off('clientResized', i), [i]);
                        const r = (0, A.useMemo)(() => Object.assign({}, F), [F]);
                        return E().createElement(d.Provider, { value: r }, u);
                    });
                let w;
                function v(u, e) {
                ...
                const p = (u, e, t) => {
                    ...
                    b = (u, e, t = w.left) => u.split(e).reduce(t === w.left ? p : f, []),
                    x = (() => {
                        const u = new RegExp(
                        ...
                        return O.includes(t)
                            ...
                            : ((u, e = w.left) => {
                                  ...
                                  const A =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return b(E, /( )/, e).forEach((u) => (t = t.concat(b(u, A, w.left)))), t;
                              })(u, e);
                    };
                let M;
                !(function (u) {
                ...
                function P(u = 0) {
                    ...
                    return (e -= E * y), { days: t, hours: A, minutes: E, seconds: e };
                }
                function N(u) {
                ...
                const H = (u = 1) => {
                    ...
                    j = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: E, modelPath: I(E, u || ''), resId: A };
                            })(),
                            t = e.modelPrefix,
                            A = u.split('.');
                        if (A.length > 0) {
                            ...
                            return (
                                A.reduce((e, A) => {
                                    const E = W(I(t, `${e}.${A}`), window);
                                    return U(E) ? (u.push(E.id), `${e}.${A}.value`) : (u.push(A), `${e}.${A}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        h(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    A = j(u);
                                s.current = z.addCallback(A, t, i, e === K.Deep);
                            }
                        }),
                        (0, A.useEffect)(() => {
                            if (e !== K.None)
                    ...
                    (0, A.useEffect)(() => {
                        ...
                        function A(A) {
                            if (A.keyCode === u) {
                                ...
                                D.O.view.setEventHandled(), e(A), t && A.stopPropagation();
                            }
                        }
                    }, [e, u, t]);
                }
                ...
                class eu extends E().PureComponent {
                    constructor(...u) {
                        super(...u),
                    ...
                    render() {
                        const u = this.props,
                            ...
                            B = X()(Q.base, Q[`base__${n}`], Q[`base__${F}`], null == i ? void 0 : i.base),
                            C = X()(Q.icon, Q[`icon__${n}`], Q[`icon__${F}`], null == i ? void 0 : i.icon),
                            l = X()(Q.glow, null == i ? void 0 : i.glow),
                            c = X()(Q.caption, Q[`caption__${n}`], null == i ? void 0 : i.caption),
                            d = X()(Q.goto, null == i ? void 0 : i.goto);
                        return E().createElement(
                            ...
                            'info' !== n && E().createElement('div', { className: Q.shine }),
                            E().createElement('div', { className: C }, E().createElement('div', { className: l })),
                ...
                const tu = {
                    ...
                    Au = (0, A.memo)(
                        ({
                            ...
                            const i = (0, A.useCallback)(() => e(), [e]),
                                r = (0, A.useCallback)(
                                    (u) => {
                                        (n && n()) || (t ? (u.stopImmediatePropagation(), i()) : F());
                                    },
                                    [t, i, F, n],
                                );
                            Y(q.n.ESCAPE, r);
                            const D = (function (u, e, t) {
                                const E = (0, A.useContext)(d);
                                let F = Object.entries(E).filter(([u, e]) => !0 === e && u in o);
                                return (
                                    t && (F = F.filter((u) => t.includes(u[0]))),
                                    u.reduce((u, t) => {
                                        const A = F.map((u) =>
                                            X()(
                                                e[((u, e) => u + '__' + e)(t, u[0])],
                    ...
                    Eu = 'WarningIcon_base_47',
                    Fu = (0, A.memo)(() => E().createElement('div', { className: Eu })),
                    nu = 'FormatText_base_d0',
                    iu = ({ binding: u, text: e = '', classMix: t, alignment: F = w.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, n) =>
                                      E().createElement(
                                          'div',
                                          { className: X()(nu, t), key: `${e}-${n}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : T(u, e))))(e, F, u).map((u, e) =>
                ...
                const Du = (u, e) => {
                        ...
                        return (
                            ...
                            (0, A.useEffect)(() => {
                                ...
                                return (
                                    E > 0 &&
                                        (u = setTimeout(() => {
                                            const u = Math.max(Math.trunc((performance.now() - ru) / 1e3), 1),
                                                e = Math.max(E - u, 0);
                                            (ru = performance.now()), F(e);
                                        }, 1e3 * n)),
                                    () => clearTimeout(u)
                                );
                            }, [E, F, n]),
                    ...
                    ou = (0, A.memo)(
                        ({ isLarge: u, text: e, classMix: t, countDown: F = 0, onCountDownComplete: n }) => {
                            const i = Du(F, 1),
                                r = (0, A.useMemo)(() => {
                                    return {
                                        icon: E().createElement('div', { className: au.icon }),
                                        br: E().createElement('div', { className: au.br }),
                                        time: E().createElement(
                                            'div',
                                            { className: au.inner },
                                            ((u = P(i)),
                                            u.days > 7
                                                ...
                                                : u.days >= 1
                                                  ...
                                                  : u.hours >= 1
                                                    ? 0 === u.minutes
                                                        ...
                                                        : `${v(R.strings.common.duration.hours(), { hours: u.hours })} ${v(R.strings.common.duration.minutes(), { minutes: u.minutes })} ${v(R.strings.common.duration.seconds(), { seconds: u.seconds })}`
                                                    : u.minutes >= 1
                                                      ? 0 === u.minutes
                                                          ? v(R.strings.common.duration.seconds(), {
                                                                seconds: u.seconds,
                                                            })
                                                          : 0 === u.seconds
                                                            ? `${v(R.strings.common.duration.minutes(), { minutes: u.minutes })}`
                                                            : `${v(R.strings.common.duration.minutes(), { minutes: u.minutes })} ${v(R.strings.common.duration.seconds(), { seconds: u.seconds })}`
                            ...
                            const D = X()(au.base, u && au.base__large);
                            return E().createElement(
                                'div',
                                { className: t },
                                E().createElement(iu, { classMix: D, text: e, binding: r }),
                            );
                        },
                    ),
                    su = 'ContactSupportViewApp_base_4c',
                    Bu = 'ContactSupportViewApp_warning_66',
                    Cu = 'ContactSupportViewApp_link_bf',
                    lu = 'ContactSupportViewApp_linkIcon_94',
                    cu = 'ContactSupportViewApp_linkText_6f',
                ...
                const mu = () => {
                    ...
                    return E().createElement(
                        ...
                        E().createElement(
                            ...
                            E().createElement(ou, { classMix: Bu, text: t }),
                            E().createElement(
                                'div',
                                { className: Cu, onClick: n },
                                E().createElement(
                                    'div',
                                    { className: cu },
                                    R.strings.dialogs.accountCompletion.contactSupport(),
                                    E().createElement('div', { className: du }),
                                ),
                                E().createElement('div', { className: lu }),
                            ),
                        ),
                    );
                };
                var hu;
                ((hu = 'ContactSupportView'),
                (u, e, t) => {
                    engine.whenReady.then(() => {
                        n().render(E().createElement(i, { name: hu }, u), e, t);
                    });
                })(E().createElement(g, null, E().createElement(mu, null)), document.getElementById('root'));
            },
        },
        ...
        (__webpack_require__.O = (u, e, t, A) => {
            if (!e) {
                ...
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, t, A] = deferred[r], F = !0, n = 0; n < e.length; n++)
                        (!1 & A || E >= A) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [235], () => __webpack_require__(512));
