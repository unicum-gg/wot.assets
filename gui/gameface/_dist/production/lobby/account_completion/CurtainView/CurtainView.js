(() => {
    ...
    var __webpack_modules__ = {
            ...
            383: (u, e, t) => {
                ...
                const l = F.O.client.getSize('rem'),
                    D = l.width,
                    d = l.height,
                    c = Object.assign({ width: D, height: d }, s(D, d, E)),
                ...
                const H = 'SceneWrapper_base_39',
                    ...
                    I = ({ children: u, moveSpace: e }) => {
                        ...
                        var s;
                        (s = () =>
                            F.O.client.events.mouse.move(([, u]) => {
                                'outside' === u && a(!1);
                            })),
                            (0, n.useEffect)(s, []);
                        const l = (u) => {
                        ...
                        return i().createElement(
                            ...
                            i().createElement('div', {
                                ...
                                onMouseMove: (u) => {
                                    ...
                                    (A.current = t), (E.current = n), e({ dx: i, dy: a, dz: 0 });
                                },
                                onMouseUp: () => a(!1),
                                onMouseDown: (u) => {
                                    u.preventDefault(),
                                        0 === u.button &&
                                            l(u) &&
                                            (a(!0), (A.current = u.clientX), (E.current = u.clientY));
                                },
                                onWheel: (u) => {
                    ...
                    z = ({ message: u, className: e, classNames: t }) =>
                        i().createElement(
                            'div',
                            { className: g()(U, e) },
                            u && i().createElement('div', { className: g()(j, null == t ? void 0 : t.caption) }, u),
                    ...
                    ou = {
                        [P.Closed]: Eu.base__hidden,
                        [P.Hidden]: Eu.base__hidden,
                        [P.Opening]: Eu.base__opening,
                        [P.Revealing]: Eu.base__opening,
                        [P.Opened]: Eu.base__opened,
                        [P.Hiding]: Eu.base__hiding,
                        [P.Closing]: Eu.base__hiding,
                    },
                    ...
                    lu = () => {
                        const u = k(),
                            ...
                            F = u.onMoveSpace,
                            E = (0, n.useMemo)(() => ({ animationDuration: '300ms' }), []),
                            s = (function (u, e, t) {
                                const i = (0, n.useContext)(B);
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [235], () => __webpack_require__(383));
