(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var A = {};
                t.r(A), t.d(A, { getBgUrl: () => c, getTextureUrl: () => l });
                var F = {};
                function a(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            364: (u, e, t) => {
                ...
                function c(u, e, t, n, E, A, F) {
                    ...
                    a.done ? e(r) : Promise.resolve(r).then(n, E);
                }
            ...
            815: (u, e, t) => {
                ...
                const a = ({ name: u, children: e }) => {
                        ...
                        return (
                            E().useEffect(() => {
                                const e = ({ viewName: t }) => {
                                    t === u && (F(!1), engine.off('subView:destroy', e));
                                };
                ...
                const B = i.O.client.getSize('rem'),
                    C = B.width,
                    l = B.height,
                    c = Object.assign({ width: C, height: l }, D(C, l, s)),
                    ...
                    g = (0, n.memo)(({ children: u }) => {
                        const e = (0, n.useContext)(_),
                            ...
                            a = (0, n.useCallback)((u, e) => {
                                ...
                                F(Object.assign({ width: t, height: n }, D(t, n, s)));
                            }, []);
                        h(() => {
                            engine.on('clientResized', a);
                        }),
                            (0, n.useEffect)(() => () => engine.off('clientResized', a), [a]);
                        const r = (0, n.useMemo)(() => Object.assign({}, A), [A]);
                        return E().createElement(_.Provider, { value: r }, u);
                    });
                var w = t(483),
                    v = t.n(w);
                let p;
                ...
                const f = (u, e, t) => {
                    ...
                    y = (u, e, t = p.left) => u.split(e).reduce(t === p.left ? f : x, []),
                    O = (() => {
                        const u = new RegExp(
                        ...
                        return M.includes(t)
                            ...
                            : ((u, e = p.left) => {
                                  ...
                                  const n =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return y(E, /( )/, e).forEach((u) => (t = t.concat(y(u, n, p.left)))), t;
                              })(u, e);
                    },
                    k = 'FormatText_base_d0',
                    S = ({ binding: u, text: e = '', classMix: t, alignment: A = p.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, F) =>
                                      E().createElement(
                                          'div',
                                          { className: v()(k, t), key: `${e}-${F}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : T(u, e))))(e, A, u).map((u, e) =>
                ...
                const z = (u = 1) => {
                    ...
                    q = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: E, modelPath: $(E, u || ''), resId: n };
                            })(),
                            t = e.modelPrefix,
                            n = u.split('.');
                        if (n.length > 0) {
                            ...
                            h(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = q(u);
                                    D.current = Y.addCallback(n, t, a, e === Z.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== Z.None)
                                    return () => {
                                        Y.removeCallback(D.current, a);
                                    };
                            }, [a, e]),
                            s
                        );
                                ...
                                : u.days >= 1
                                  ...
                                  : u.hours >= 1
                                    ...
                                    : u.minutes >= 1
                                      ...
                                      : b(R.strings.common.duration.seconds(), { seconds: u.seconds })),
                    J = 'WarningIcon_base_47',
                    uu = (0, n.memo)(() => E().createElement('div', { className: J })),
                    eu = {
                ...
                const nu = ({
                    ...
                    const c = (0, n.useRef)(null),
                        ...
                        w = h[1],
                        p = (0, n.useCallback)(() => {
                            F || (c.current && (c.current.focus(), l && l(!0)));
                        }, [F, l]),
                        b = (0, n.useCallback)(
                            (u) => {
                                t && null !== c.current && !c.current.contains(u.target) && l && l(!1);
                            },
                            [t, l],
                        ),
                        f = (0, n.useCallback)(
                        ...
                        T = v()(
                            ...
                            eu[`base__${A}`],
                            {
                                ...
                                [eu[`base__${e}`]]: e,
                                [eu.base__focus]: t,
                                [eu.base__highlightActive]: d,
                                [eu.base__firstHover]: g,
                            },
                            a,
                        ),
                        k = v()(eu.state, eu.state__default);
                    return (
                        (0, n.useEffect)(
                            () => (
                        ...
                        E().createElement(
                            ...
                            A !== L.ghost &&
                                E().createElement(
                                    E().Fragment,
                                    null,
                                    E().createElement('div', { className: eu.back }),
                                    E().createElement('span', { className: eu.texture }),
                                ),
                            E().createElement(
                                'span',
                                { className: k },
                                E().createElement('span', { className: eu.stateDisabled }),
                                E().createElement('span', { className: eu.stateHighlightHover }),
                                E().createElement('span', { className: eu.stateHighlightActive }),
                            ),
                            E().createElement(
                                'span',
                ...
                nu.defaultProps = { type: L.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Eu = (0, n.memo)(nu);
                let Au;
                const Fu = (u, e) => {
                        ...
                        return (
                            ...
                            (0, n.useEffect)(() => {
                                ...
                                return (
                                    E > 0 &&
                                        (u = setTimeout(() => {
                                            const u = Math.max(Math.trunc((performance.now() - Au) / 1e3), 1),
                                                e = Math.max(E - u, 0);
                                            (Au = performance.now()), A(e);
                                        }, 1e3 * F)),
                                    () => clearTimeout(u)
                                );
                            }, [E, A, F]),
                    ...
                    ru = (0, n.memo)(
                        ({ isLarge: u, text: e, classMix: t, countDown: A = 0, onCountDownComplete: F }) => {
                            const a = Fu(A, 1),
                                r = (0, n.useMemo)(
                                    () => ({
                                        icon: E().createElement('div', { className: au.icon }),
                                        br: E().createElement('div', { className: au.br }),
                                        time: E().createElement('div', { className: au.inner }, Q(V(a))),
                                    }),
                                    [a],
                                );
                            (0, n.useEffect)(() => {
                            ...
                            const i = v()(au.base, u && au.base__large);
                            return E().createElement(
                                'div',
                                { className: t },
                                E().createElement(S, { classMix: i, text: e, binding: r }),
                            );
                        },
                    );
                var iu = t(521);
                ...
                function ou(u = iu.n.NONE, e = su, t = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== iu.n.NONE)
                            return (
                ...
                class lu extends E().PureComponent {
                    constructor(...u) {
                        super(...u),
                    ...
                    render() {
                        const u = this.props,
                            ...
                            B = v()(Du.base, Du[`base__${F}`], Du[`base__${A}`], null == a ? void 0 : a.base),
                            C = v()(Du.icon, Du[`icon__${F}`], Du[`icon__${A}`], null == a ? void 0 : a.icon),
                            l = v()(Du.glow, null == a ? void 0 : a.glow),
                            c = v()(Du.caption, Du[`caption__${F}`], null == a ? void 0 : a.caption),
                            _ = v()(Du.goto, null == a ? void 0 : a.goto);
                        return E().createElement(
                            'div',
                            Cu(
                                {
                            ...
                            'info' !== F && E().createElement('div', { className: Du.shine }),
                ...
                const cu = {
                    ...
                    _u = (0, n.memo)(
                        ({
                            ...
                            const a = (0, n.useCallback)(() => e(), [e]),
                                r = (0, n.useCallback)(
                                    (u) => {
                                        (F && F()) || (t ? (u.stopImmediatePropagation(), a()) : A());
                                    },
                                    [t, a, A, F],
                                );
                            ou(iu.n.ESCAPE, r);
                            const i = (function (u, e, t) {
                                const E = (0, n.useContext)(_);
                    ...
                    du = 'ErrorViewApp_base_1e',
                    mu = 'ErrorViewApp_warning_9f',
                    hu = 'ErrorViewApp_timer_fc',
                    gu = 'ErrorViewApp_inner_ac',
                    wu = 'ErrorViewApp_button_5d',
                    vu = ['onButtonClicked', 'timer', 'message', 'buttonLabel'];
                const pu = () => {
                    const u = X(),
                        e = u.onButtonClicked,
                        t = u.timer,
                    ...
                    ((u) => {
                        ...
                        ou(iu.n.ENTER, e, !0);
                    })((0, n.useCallback)(() => !i && e(), [i, e]));
                    const o = (0, n.useMemo)(
                        () => ({ time: E().createElement('div', { className: gu }, Q(V(r))) }),
                        [r],
                    );
                    return E().createElement(
                        _u,
                        ...
                        E().createElement(
                            ...
                            E().createElement(ru, { classMix: mu, text: A }),
                            E().createElement(
                                Eu,
                                { mixClass: wu, onClick: s, size: P.medium, type: L.primary, disabled: i },
                                F,
                            ),
                            i &&
                                E().createElement(S, {
                                    classMix: hu,
                                    text: R.strings.dialogs.accountCompletion.error.tryAgainTimerMessage(),
                                    binding: o,
                                }),
                        ),
                    );
                ...
                (u, e, t) => {
                    engine.whenReady.then(() => {
                        F().render(E().createElement(a, { name: bu }, u), e, t);
                    });
                })(E().createElement(g, null, E().createElement(pu, null)), document.getElementById('root'));
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [235], () => __webpack_require__(815));
