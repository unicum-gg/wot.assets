(() => {
            ...
            450: (u, e, t) => {
                ...
                const l = (u = 1) => {
                    ...
                    f = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: F, modelPath: h(F, u || ''), resId: A };
                            })(),
                            t = e.modelPrefix,
                            A = u.split('.');
                        if (A.length > 0) {
                            ...
                            return (
                                A.reduce((e, A) => {
                                    const F = v(h(t, `${e}.${A}`), window);
                                    return m(F) ? (u.push(F.id), `${e}.${A}.value`) : (u.push(A), `${e}.${A}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const O = (u = 'model', e = g.Deep) => {
                            ...
                            w(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        A = f(u);
                                    B.current = b.addCallback(A, t, r, e === g.Deep);
                                }
                            }),
                            (0, A.useEffect)(() => {
                                if (e !== g.None)
                    ...
                    T =
                        (d.Sw.instance,
                        {
                            base: 'RenamingHangarTooltipApp_base_d6',
                            title: 'RenamingHangarTooltipApp_title_f2',
                            text: 'RenamingHangarTooltipApp_text_74',
                            separator: 'RenamingHangarTooltipApp_separator_3a',
                            textInner: 'RenamingHangarTooltipApp_textInner_9f',
                        }),
                    y = () => {
                        const u = O(),
                            e = u.title,
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                'div',
                                { className: T.base },
                                F().createElement('div', { className: T.title }, e),
                                F().createElement('div', { className: T.text }, t),
                                F().createElement('div', { className: T.separator }),
                                F().createElement(
                                    'div',
                                    { className: T.textInner },
                                    A,
                                    F().createElement('div', { className: T.bg }),
                                ),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    n().render(F().createElement(y, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [235], () => __webpack_require__(450));
