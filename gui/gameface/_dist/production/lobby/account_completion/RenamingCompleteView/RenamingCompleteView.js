(() => {
            ...
            513: (u, e, t) => {
                ...
                const F = ({ name: u, children: e }) => {
                        ...
                        return (
                            E().useEffect(() => {
                                const e = ({ viewName: t }) => {
                                    t === u && (i(!1), engine.off('subView:destroy', e));
                                };
                ...
                const l = r.O.client.getSize('rem'),
                    B = l.width,
                    C = l.height,
                    c = Object.assign({ width: B, height: C }, s(B, C, o)),
                    ...
                    g = (0, n.memo)(({ children: u }) => {
                        const e = (0, n.useContext)(_),
                            ...
                            F = (0, n.useCallback)((u, e) => {
                                ...
                                i(Object.assign({ width: t, height: n }, s(t, n, o)));
                            }, []);
                        h(() => {
                        ...
                        return E().createElement(_.Provider, { value: a }, u);
                    });
                var w = t(483),
                    v = t.n(w);
                let p;
                ...
                const b = (u, e, t) => {
                    ...
                    x = (u, e, t = p.left) => u.split(e).reduce(t === p.left ? b : f, []),
                    T = (() => {
                        const u = new RegExp(
                        ...
                        return O.includes(t)
                            ...
                            : ((u, e = p.left) => {
                                  ...
                                  const n =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return x(E, /( )/, e).forEach((u) => (t = t.concat(x(u, n, p.left)))), t;
                              })(u, e);
                    };
                let k;
                !(function (u) {
                ...
                const X = (u, e, t = {}, n = 0) => {
                        ...
                        const w = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            p = (0, n.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (X(t, B, { isMouseEvent: !0, on: !0, arguments: Z(E) }, v),
                                    m && m(),
                    ...
                    J = 'EmailIcon_base_57',
                    uu = { tooltipId: 'TOOLTIP_SUBTITLE_ID' },
                    eu = () =>
                        E().createElement(
                            Q,
                            {
                    ...
                    nu = (0, n.memo)(({ title: u, subTitle: e, iconOverlay: t }) => {
                        const A = (0, n.useMemo)(
                                () => ({
                                    emailIcon: E().createElement(eu, null),
                                    br: E().createElement('div', { className: tu.br }),
                                }),
                                [],
                            ),
                            i = z(['base'], tu);
                        return E().createElement(
                            'div',
                            { className: i.base },
                            E().createElement('div', { className: tu.icon }, t),
                            E().createElement('div', { className: tu.title }, u),
                            Boolean(e) && E().createElement(Y, { classMix: tu.subTitle, text: e || '', binding: A }),
                        );
                    });
                var Eu = t(521);
                const Au = (u) => {
                ...
                function iu(u = Eu.n.NONE, e = Au, t = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== Eu.n.NONE)
                            return (
                        ...
                        const c = (0, n.useRef)(null),
                            ...
                            k = v()(
                                ...
                                Fu[`base__${A}`],
                                {
                                    ...
                                    [Fu[`base__${e}`]]: e,
                                    [Fu.base__focus]: t,
                                    [Fu.base__highlightActive]: d,
                                    [Fu.base__firstHover]: g,
                                },
                                F,
                            ),
                            M = v()(Fu.state, Fu.state__default);
                        return (
                            (0, n.useEffect)(
                                () => (
                            ...
                            E().createElement(
                                ...
                                A !== K.ghost &&
                                    E().createElement(
                                        E().Fragment,
                                        null,
                                        E().createElement('div', { className: Fu.back }),
                                        E().createElement('span', { className: Fu.texture }),
                                    ),
                                E().createElement(
                                    'span',
                                    { className: M },
                                    E().createElement('span', { className: Fu.stateDisabled }),
                                    E().createElement('span', { className: Fu.stateHighlightHover }),
                                    E().createElement('span', { className: Fu.stateHighlightActive }),
                                ),
                                E().createElement(
                                    'span',
                ...
                class lu extends E().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = v()(ou.base, ou[`base__${i}`], ou[`base__${A}`], null == F ? void 0 : F.base),
                            B = v()(ou.icon, ou[`icon__${i}`], ou[`icon__${A}`], null == F ? void 0 : F.icon),
                            C = v()(ou.glow, null == F ? void 0 : F.glow),
                            c = v()(ou.caption, ou[`caption__${i}`], null == F ? void 0 : F.caption),
                            _ = v()(ou.goto, null == F ? void 0 : F.goto);
                        return E().createElement(
                            'div',
                            su(
                                {
                            ...
                            'info' !== i && E().createElement('div', { className: ou.shine }),
                ...
                const Bu = {
                    ...
                    cu = {
                        base: 'RenamingCompleteViewApp_base_ae',
                        base__small: 'RenamingCompleteViewApp_base__small_7f',
                        base__extraSmall: 'RenamingCompleteViewApp_base__extraSmall_4e',
                        container: 'RenamingCompleteViewApp_container_b7',
                        name: 'RenamingCompleteViewApp_name_15',
                        name__small: 'RenamingCompleteViewApp_name__small_8f',
                        divider: 'RenamingCompleteViewApp_divider_f3',
                        button: 'RenamingCompleteViewApp_button_22',
                        showIn: 'RenamingCompleteViewApp_showIn_2c',
                        showOut: 'RenamingCompleteViewApp_showOut_bb',
                        fadeIn: 'RenamingCompleteViewApp_fadeIn_c9',
                        fadeOut: 'RenamingCompleteViewApp_fadeOut_c2',
                        windowIn: 'RenamingCompleteViewApp_windowIn_0e',
                    },
                    _u = ['title', 'subTitle', 'name', 'onCloseClicked'];
                function du() {
                    return (
                        (du =
                            Object.assign ||
                ...
                const mu = () => {
                    ...
                    const r = (0, n.useContext)(_),
                        ...
                        D = v()(cu.name, o && cu.name__small),
                        s = z(['base', 'container'], cu);
                    return E().createElement(
                        Cu,
                        du({}, F, { onCloseClicked: a }),
                        E().createElement(
                            'div',
                            { className: s.base },
                            E().createElement(nu, { title: e, subTitle: t }),
                            E().createElement(
                                'div',
                                { className: s.container },
                                E().createElement('div', { className: D }, A),
                            ),
                            E().createElement('div', { className: cu.divider }),
                            E().createElement(
                                ru,
                                { mixClass: cu.button, onClick: a, size: G.medium, type: K.main },
                ...
                var hu;
                ((hu = 'RenamingCompleteView'),
                (u, e, t) => {
                    engine.whenReady.then(() => {
                        i().render(E().createElement(F, { name: hu }, u), e, t);
                    });
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [235], () => __webpack_require__(513));
