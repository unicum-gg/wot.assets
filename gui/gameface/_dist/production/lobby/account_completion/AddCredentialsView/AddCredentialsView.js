                    ...
                    Bu = a().memo(
                        ({
                            ...
                            const f = (0, n.useState)(c),
                                ...
                                P = (0, n.useCallback)(
                                    (u) => {
                                        M && !S.current.mouseOver && (x(!1), v && v(u));
                                    },
                                    [M, v],
                                );
                            (0, n.useEffect)(() => {
                                M && T && E && R.current && R.current.select(), T && R.current && R.current.focus();
                            }, [E, T, M]);
                            const k = (0, n.useCallback)(
                                ...
                                U = (0, n.useCallback)(
                                    (u) => {
                                        M &&
                                            R.current &&
                                            (S.current.mouseDown && R.current.focus(),
                                ...
                                H = (0, n.useCallback)(
                                    (u) => {
                                        M && ((S.current.mouseDown = !0), m && m(u));
                                    },
                                    [M, m],
                                ),
                                G = (0, n.useCallback)(
                                    (u) => {
                                        M && ((S.current.mouseDown = !1), C && C(u));
                                    },
                                    [M, C],
                                ),
                                $ = (0, n.useCallback)(
                ...
                const Uu = (u, e) => {
                    ...
                    Gu = (0, n.memo)(({ errorMessage: u, errorTime: e, onCleanError: t }) => {
                        const s = Uu(e, 1),
                            r = s > 0,
                            o = (0, n.useMemo)(
                                () => ({ timer: a().createElement('div', { className: Hu }, Ou(Mu(s))) }),
                                [s],
                            );
                ...
                const Me = {
                            ...
                            const o = Uu(s, 1),
                                i = (0, n.useMemo)(
                                    () => ({
                                        ...
                                        time: a().createElement('div', { className: Le.inner }, Ou(Mu(o))),
                                    }),
                                    [o],
                                );
                            (0, n.useEffect)(() => {
                    ...
                    Ge = ({
                        ...
                        const D = (0, n.useRef)(null),
                            ...
                            O = y()(He.state, He.state__default);
                        return (
                            (0, n.useEffect)(
                                () => (
