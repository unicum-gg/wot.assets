(() => {
    var __webpack_modules__ = {
            ...
            294: (u, e, t) => {
                ...
                var n = {};
                (t.r(n),
                    t.d(n, { mouse: () => F, off: () => A, on: () => c, onResize: () => l, onScaleUpdated: () => E }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        events: () => n,
                ...
                var a = {};
                (t.r(a), t.d(a, { getBgUrl: () => x, getTextureUrl: () => T }));
                var s = {};
                function o(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const B = {
                    ...
                    b = { play: Object.assign({}, h, { sound: _ }), setRTPC: D },
                ...
                const su = Object.keys(S).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === S[e]), u), {}),
                    ou = {
                        set: (u, e) => {
                ...
                const cu = { view: s, client: r, sound: b, intl: g };
            },
            521: (u, e, t) => {
                'use strict';
                let n, r;
            ...
            474: (u, e, t) => {
                ...
                const T = {
                    ...
                    y = (u) => {
                        ...
                        const a = v(),
                            ...
                            o = a.mediaHeight,
                            i = a.mediaSize;
                        return r().createElement('div', f({ className: C()(t, T[s], x[o], S[i]) }, n), e);
                    },
                    M = ['children'];
                const O = (u) => {
                    let e = u.children,
                ...
                const J = (u) => {
                        ...
                        return r().createElement(
                            ...
                            'info' !== _ && r().createElement('div', { className: K.shine }),
                            r().createElement(
                                'div',
                                {
                                    className: C()(
                                ...
                                r().createElement('div', { className: C()(K.glow, null == s ? void 0 : s.glow) }),
                            ),
                            r().createElement(
                                'div',
                            ...
                            a && r().createElement('div', { className: C()(K.goto, null == s ? void 0 : s.goto) }, a),
                        );
                    },
                    uu = {
                        ...
                        const h = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, n.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (au(t, F, { isMouseEvent: !0, on: !0, arguments: ru(r) }, b),
                                    B && B(),
                            ...
                            cu(
                                {
                                    contentId:
                                        ...
                                        c ? Au.SimpleTooltipHtmlContent('resId') : Au.SimpleTooltipContent('resId')),
                ...
                const _u = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        const a = e.contentId;
                        return a ? r().createElement(su, Fu({}, e, { contentId: a }), n) : r().createElement(lu, e, n);
                    },
                    Du = 'default',
                    mu = 'search',
                    Cu = 'email',
                ...
                const yu = {
                    ...
                    Mu = r().memo(
                        ({
                            ...
                            const T = (0, n.useState)(c),
                                ...
                                P = (0, n.useCallback)(
                                    (u) => {
                                        M && !y.current.mouseOver && (R(!1), f && f(u));
                                    },
                                    [M, f],
                                );
                            (0, n.useEffect)(() => {
                                (M && x && E && S.current && S.current.select(), x && S.current && S.current.focus());
                            }, [E, x, M]);
                            const L = (0, n.useCallback)(
                                    (u) => {
                                        M && p && p(u.target.value);
                                    },
                                    [M, p],
                                ),
                                I = (0, n.useCallback)(
                                ...
                                H = (0, n.useCallback)(
                                    (u) => {
                                        M && ((y.current.mouseDown = !0), m && m(u));
                                    },
                                    [M, m],
                                ),
                                G = (0, n.useCallback)(
                                    (u) => {
                                        M && ((y.current.mouseDown = !1), B && B(u));
                                    },
                                    [M, B],
                                ),
                                $ = (0, n.useCallback)(
                                    (u) => {
                                        if (M && S.current) {
                                            ((!x || (x && u.target !== S.current)) && S.current.focus(), g && g(u));
                                        }
                                    },
                                    [x, M, g],
                                ),
                                ...
                                V = (0, n.useMemo)(() => (A ? { backgroundImage: `url(${A})` } : null), [A]),
                                j = C()(yu.input, yu[`input__${t}`], F),
                                q = C()(yu.icon, yu[`icon__${t}`]),
                                Y = C()(yu.placeholder, yu[`placeholder__${t}`]);
                            return r().createElement(
                                'div',
                                {
                                    id: u,
                                ...
                                !M && r().createElement('div', { className: yu.disabled }),
                                V && r().createElement('div', { style: V, className: q }),
                                ...
                                l && r().createElement('div', { className: yu.clear, onClick: v }),
                            );
                        },
                    ),
                    Ou = {
                    ...
                    Pu = ({ variant: u, show: e = !0, helperText: t, helperIcon: a, classMix: s }) => {
                        const o = (0, n.useMemo)(() => {
                                const e =
                                    a ||
                                    (function (u) {
                            ...
                            E = C()(Ou.message, Ou[`message__${u}`], s);
                        return r().createElement(
                            'div',
                            { className: l },
                            o && r().createElement('div', { className: Ou.icon, style: o }),
                ...
                const Nu = {
                    ...
                    Uu = (u) => {
                        ...
                        const V = (0, n.useCallback)((u) => b && b(u), [b]),
                            ...
                            tu = C()(Lu.base, Lu[`base__${l}`], Lu[`base__${o}`], x);
                        return r().createElement(
                            'div',
                            { id: e, className: tu, onMouseEnter: V, onMouseDown: Y, onMouseUp: q, onMouseLeave: X },
                            r().createElement(
                                _u,
                                { tooltipArgs: c },
                                r().createElement(
                ...
                function zu(u = 0) {
                    ...
                    e -= n * $u;
                    const r = Math.trunc(e / Gu);
                    return ((e -= r * Gu), { days: t, hours: n, minutes: r, seconds: e });
                }
                const Vu = (u) =>
                        u.days > 7
                    ...
                    qu = ({ binding: u, text: e = '', classMix: t, alignment: a = H.left, formatWithBrackets: s }) => {
                    ...
                    Yu = 'FieldError_base_02',
                    Xu = 'FieldError_base__show_46',
                    Ku = ({ isShow: u, text: e, binding: t, className: n }) =>
                        r().createElement(qu, { classMix: C()(Yu, n, u && Xu), text: e || '', binding: t });
                let Zu;
                const Qu = (u, e) => {
                    ...
                    Ju = 'ErrorTimer_inner_57',
                    ue = (0, n.memo)(({ errorMessage: u, errorTime: e, onCleanError: t }) => {
                        const a = Qu(e, 1),
                            s = a > 0,
                            o = (0, n.useMemo)(
                                () => ({ timer: r().createElement('div', { className: Ju }, Vu(zu(a))) }),
                                [a],
                            );
                        return (s || t(), r().createElement(Ku, { isShow: s, text: u, binding: o }));
                    }),
                    ee = 'EmailField_base_7b',
                    te = 'EmailField_name_3d';
                function ne() {
                    return !1;
                }
                console.log;
                ...
                const ie = () => (u, e) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: s, children: o, mocks: i }) {
                                ...
                                return (
                                    (0, n.useEffect)(() => {
                                        A.current ? C(c(F, s, i)) : (A.current = !0);
                                    }, [i, F, s]),
                                    (0, n.useEffect)(() => {
                                        _(a);
                                    }, [a]),
                ...
                const de = { debounceTime: 0 },
                    Fe = (0, P.Pi)(({ isErrorVisible: u = !0, isFocused: e = !0, className: t, onFocusChange: a }) => {
                        const s = ce(),
                            o = s.model,
                            i = s.controls,
                            l = o.root.get(),
                        ...
                        return r().createElement(
                            'div',
                            { className: C()(ee, t) },
                            E && r().createElement('div', { className: te }, E),
                            r().createElement(
                                Uu,
                                Ae(
                                    {
                                        key: `field_${e}`,
                                        size: _ < p.Medium ? wu : fu,
                                        value: D.current,
                                        isValidated: !1,
                                        placeholder: F || '',
                                        onChange: g,
                    ...
                    me = 'Title_title_9f',
                    Ce = 'Title_br_3d',
                    Be = 'Title_subTitle_af',
                    ge = 'Title_subTitleText_a7',
                    pe = 'Title_subTitleIcon_57',
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            ...
                                            r().createElement(qu, {
                                                ...
                                                text: e || '',
                                                binding: {
                                                    emailIcon: r().createElement('div', { className: pe }),
                                                    br: r().createElement('div', { className: Ce }),
                                                },
                                            }),
                                        ),
                                    ),
                    ...
                    ve = (0, n.memo)(({ text: u, className: e, countDown: t = 0, onCountDownComplete: a }) => {
                        const s = Qu(t, 1);
                        return (
                            (0, n.useEffect)(() => {
                                t > 0 && 0 === s && a && a();
                            ...
                            r().createElement(
                                ...
                                r().createElement(qu, {
                                    ...
                                    text: u,
                                    binding: {
                                        icon: r().createElement('div', { className: be.icon }),
                                        time: r().createElement('div', { className: be.inner }, Vu(zu(s))),
                                    },
                                }),
                            )
                        );
                ...
                const Ze = {
                    ...
                    Qe = ({
                        ...
                        const F = ((u, e) => {
                                if (void 0 === e || !ze.includes(u)) return null;
                                switch (e) {
                        ...
                        return r().createElement(
                            'div',
                            {
                                className: C()(Ze.base, Ze[`base__${n}`], Pe.includes(u) && Ze.base__normalize, E),
                                style: l,
                            },
                            r().createElement(
                                _u,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: C()(Ze.image, null == c ? void 0 : c.image) },
                                        F &&
                                            r().createElement('div', {
                                                className: C()(Ze.highlight, null == c ? void 0 : c.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: C()(Ze.icon, null == c ? void 0 : c.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        _ &&
                                            r().createElement('div', {
                                                className: C()(Ze.overlay, null == c ? void 0 : c.overlay),
                                                style: {
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: C()(
                                                    Ze.info,
                                                    Ze[`info__${u}`],
                                                    o === Re.MULTI && Ze.info__multi,
                                                    null == c ? void 0 : c.info,
                                                ),
                                            },
                                            D,
                                        ),
                                    i && r().createElement('div', { className: Ze.title }, i),
                                ),
                            ),
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: d },
                                    r().createElement('div', {
                                        className: C()(Ze.timer, null == c ? void 0 : c.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const ut = ({ reward: u, size: e }) => {
                        const t = u.RewardWrapper || null;
                        return t
                            ? r().createElement(t, u.rewardWrapperProps, r().createElement(Qe, Je({ size: e }, u)))
                            : r().createElement(Qe, Je({ size: e }, u));
                    },
                    et = 'Rewards_base_26',
                            ...
                            u
                                ...
                                .map((u, t) =>
                                    r().createElement(
                                        'div',
                                        { key: t, className: A },
                                        r().createElement(ut, { reward: u, size: e }),
                                    ),
                                ),
                            c &&
                                r().createElement(
                    ...
                    const D = (0, n.useRef)(null),
                        ...
                        M = C()(
                            ...
                            st[`base__${a}`],
                            {
                                ...
                                [st[`base__${e}`]]: e,
                                [st.base__focus]: t,
                                [st.base__highlightActive]: B,
                                [st.base__firstHover]: h,
                            },
                            o,
                        ),
                        O = C()(st.state, st.state__default);
                    return (
                        (0, n.useEffect)(
                            () => (
                ...
                it.defaultProps = { type: Xe.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const lt = (0, n.memo)(it),
                    Et = 'Footer_base_b5',
                    ct = 'Footer_rewards_de',
                    At = 'Footer_rewardsTitle_88',
                    dt = 'Footer_reward_7c',
                    Ft = 'Footer_button_ac',
                    _t = (0, P.Pi)(({ onConfirm: u, focusingItems: e }) => {
                        const t = Ye(),
                            n = t.model,
                            a = t.controls,
                            s = n.root.get(),
                        ...
                        return (
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: ct },
                                    r().createElement('div', { className: At }, o),
                                    r().createElement(at, { data: d, rewardItemClassMix: dt }),
                                ),
                                r().createElement(
                                    lt,
                                    {
                    ...
                    Dt = 'AddCredentialsViewApp_base_06',
                    mt = 'AddCredentialsViewApp_spacer_fa',
                    Ct = 'AddCredentialsViewApp_content_d1',
                    Bt = 'AddCredentialsViewApp_field_a4',
                    gt = 'AddCredentialsViewApp_warningBox_bb',
                    pt = 'AddCredentialsViewApp_warning_06';
                function ht() {
                    return (
                        (ht =
                            Object.assign ||
                    ...
                    vt = (0, P.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(he, { title: s, subTitle: o }),
                                !i &&
                                    r().createElement(
                                        r().Fragment,
                                        null,
                                        r().createElement(
                                            ...
                                            r().createElement(
                                                ...
                                                r().createElement(
                                                    Fe,
                                                    ht({}, _[D], { className: Bt, isErrorVisible: !B }),
                                                ),
                                            ),
                                            r().createElement(
                                                'div',
                                        ...
                                        r().createElement(_t, { focusingItems: _, onConfirm: C }),
                                    ),
                            ),
                        );
                    });
                var wt;
                ((wt = 'AddCredentialsView'),
                (u, e, t) => {
                    engine.whenReady.then(() => {
                        s().render(r().createElement(o, { name: wt }, u), e, t);
                    });
                })(
                    r().createElement(
                        qe,
                        { options: { rootId: R.views.lobby.account_completion.AddCredentialsView('resId') } },
                        r().createElement(O, null, r().createElement(vt, null)),
                    ),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [235], () => __webpack_require__(474));
