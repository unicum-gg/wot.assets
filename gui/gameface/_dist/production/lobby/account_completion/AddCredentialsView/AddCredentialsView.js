    ...
    var __webpack_modules__ = {
            ...
            631: (u, e, t) => {
                ...
                const Y = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    K = (u, e, t = q.left) => u.split(e).reduce(t === q.left ? j : X, []),
                    Z = (() => {
                        const u = new RegExp(
                    ...
                    J = (u, e = q.left) => {
                        ...
                        return ((u, e = q.left) => {
                            ...
                            const n =
                                ...
                                a = Y(u);
                            return K(a, /( )/, e).forEach((u) => (t = t.concat(K(u, n, q.left)))), t;
                        })(u, e);
                    };
                function uu(u, e, t) {
                    const a = (0, n.useContext)(m);
                    ...
                    Nu = a().memo(
                        ({
                            ...
                            const L = (0, n.useCallback)(
                                ...
                                z = b()(ku.input, ku[`input__${t}`], F),
                                Y = b()(ku.icon, ku[`icon__${t}`]),
                                j = b()(ku.placeholder, ku[`placeholder__${t}`]);
                            return a().createElement(
                                'div',
                                {
                                    id: u,
                ...
                const Vu = {
                    ...
                    qu = (u) => {
                        ...
                        const q = (0, n.useCallback)((u) => p && p(u), [p]),
                            z = (0, n.useCallback)(
                                (u) => {
                        ...
                        return a().createElement(
                            'div',
                            { id: e, className: tu, onMouseEnter: q, onMouseDown: j, onMouseUp: Y, onMouseLeave: X },
                            a().createElement(
                                hu,
                                { tooltipArgs: E },
                                a().createElement(
                ...
                function Zu(u = 0) {
                    ...
                    return (e -= a * ju), { days: t, hours: n, minutes: a, seconds: e };
                }
                const Qu = (u) =>
                        u.days > 7
                    ...
                    ue = ({ binding: u, text: e = '', classMix: t, alignment: r = q.left, formatWithBrackets: s }) => {
