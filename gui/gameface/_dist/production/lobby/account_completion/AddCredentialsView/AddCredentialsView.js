(() => {
            ...
            349: (u, e, t) => {
                ...
                const B = (u) => {
                    ...
                    const r = (0, n.useContext)(m),
                        ...
                        b = { extraLarge: D, large: B, medium: g, small: h, extraSmall: p };
                ...
                const O = {
                    ...
                    k = (u) => {
                        ...
                        const a = S(),
                            ...
                            o = a.mediaHeight,
                            i = a.mediaSize;
                        return r().createElement('div', y({ className: b()(t, O[s], P[o], L[i]) }, n), e);
                    },
                    I = ['children'];
                const N = (u) => {
                    let e = u.children,
                ...
                function W(u = U.n.NONE, e = $, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== U.n.NONE)
                            return (
                ...
                const q = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    K = (u, e, t = V.left) => u.split(e).reduce(t === V.left ? Y : X, []),
                    Z = (() => {
                        const u = new RegExp(
                    ...
                    J = (u, e = V.left) => {
                        ...
                        return ((u, e = V.left) => {
                            ...
                            const n =
                                ...
                                r = q(u);
                            return (K(r, /( )/, e).forEach((u) => (t = t.concat(K(u, n, V.left)))), t);
                        })(u, e);
                    };
                function uu(u, e, t) {
                    const r = (0, n.useContext)(m);
                ...
                class au extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            d = b()(tu.base, tu[`base__${s}`], tu[`base__${a}`], null == o ? void 0 : o.base),
                            F = b()(tu.icon, tu[`icon__${s}`], tu[`icon__${a}`], null == o ? void 0 : o.icon),
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (cu(t, F, { isMouseEvent: !0, on: !0, arguments: Eu(r) }, b),
                                    B && B(),
                    ...
                    Nu = r().memo(
                        ({
                            ...
                            const T = (0, n.useState)(c),
                                ...
                                P = (0, n.useCallback)(
                                    (u) => {
                                        y && !M.current.mouseOver && (R(!1), f && f(u));
                                    },
                                    [y, f],
                                );
                            (0, n.useEffect)(() => {
                                (y && x && E && S.current && S.current.select(), x && S.current && S.current.focus());
                            }, [E, x, y]);
                            const L = (0, n.useCallback)(
                                ...
                                $ = (0, n.useCallback)(
                                    (u) => {
                                        if (y && S.current) {
                                            ((!x || (x && u.target !== S.current)) && S.current.focus(), B && B(u));
                                        }
                                    },
                                    [x, y, B],
                                ),
                                ...
                                j = b()(Iu.input, Iu[`input__${t}`], F),
                                q = b()(Iu.icon, Iu[`icon__${t}`]),
                                Y = b()(Iu.placeholder, Iu[`placeholder__${t}`]);
                            return r().createElement(
                                'div',
                                {
                                    id: u,
                                ...
                                !y && r().createElement('div', { className: Iu.disabled }),
                                ...
                                l && r().createElement('div', { className: Iu.clear, onClick: v }),
                            );
                        },
                    ),
                    Hu = {
                ...
                const zu = {
                    ...
                    Vu = (u) => {
                        ...
                        const y = (0, n.useState)(E),
                            ...
                            k = L[0],
                            I = L[1],
                            N = (0, n.useMemo)(() => Object.assign({}, zu, g), [g]),
                            H = (0, n.useRef)({ debounceTimeout: 0, isChangeHandled: !0, value: E, type: a }),
                            U = (0, n.useCallback)((u) => {
                                u !== H.current.value &&
                                    ((H.current.value = u), (H.current.isChangeHandled = !1), P(u));
                            }, []),
                            G = (0, n.useCallback)(
                                (u) => {
                                    let e = !0;
                                    (N.performChangeValidation &&
                                        (e = N.changesValidator ? N.changesValidator(u) : ku(u, H.current.type)),
                                        T && T(u, e));
                                },
                                [T, N],
                            ),
                        ...
                        ((0, n.useEffect)(() => {
                            ...
                            (0, n.useEffect)(() => {
                                (H.current.isChangeHandled && E !== H.current.value && ((H.current.value = E), P(E)),
                                    (H.current.type = a));
                            }, [E, a]),
                            (0, n.useEffect)(() => {
                                I(_);
                            }, [_, o]));
                        const V = (0, n.useCallback)((u) => p && p(u), [p]),
                            j = (0, n.useCallback)(
                                (u) => {
                            ...
                            : u.days >= 1
                              ...
                              : u.hours >= 1
                                ? 0 === u.minutes
                                    ...
                                    : `${j(R.strings.common.duration.hours(), { hours: u.hours })} ${j(R.strings.common.duration.minutes(), { minutes: u.minutes })} ${j(R.strings.common.duration.seconds(), { seconds: u.seconds })}`
                                : u.minutes >= 1
                                  ? 0 === u.minutes
                                      ? j(R.strings.common.duration.seconds(), { seconds: u.seconds })
                                      : 0 === u.seconds
                                        ? `${j(R.strings.common.duration.minutes(), { minutes: u.minutes })}`
                                        : `${j(R.strings.common.duration.minutes(), { minutes: u.minutes })} ${j(R.strings.common.duration.seconds(), { seconds: u.seconds })}`
                                  : j(R.strings.common.duration.seconds(), { seconds: u.seconds }),
                    Qu = 'FormatText_base_d0',
                    Ju = ({ binding: u, text: e = '', classMix: t, alignment: a = V.left, formatWithBrackets: s }) => {
                ...
                const Be = { debounceTime: 0 },
                    ...
                    Se = (0, n.memo)(({ text: u, className: e, countDown: t = 0, onCountDownComplete: a }) => {
                        const s = re(t, 1);
                        return (
                            (0, n.useEffect)(() => {
                                t > 0 && 0 === s && a && a();
                            ...
                            r().createElement(
                                ...
                                r().createElement(Ju, {
                                    ...
                                    text: u,
                                    binding: {
                                        icon: r().createElement('div', { className: Re.icon }),
                                        time: r().createElement('div', { className: Re.inner }, Zu(Ku(s))),
                                    },
                                }),
                            )
                        );
                ...
                const $e = [
                    ...
                    We = [ye.Gold, ye.Credits, ye.Crystal, ye.FreeXp],
                    ze = [ye.BattlePassPoints, ye.EquipCoin],
                    Ve = [ye.PremiumPlus, ye.Premium],
                ...
                const nt = {
                    ...
                    rt = ({
                        ...
                        return r().createElement(
                            'div',
                            {
                                className: b()(nt.base, nt[`base__${n}`], Ue.includes(u) && nt.base__normalize, E),
                                style: l,
                            },
                            r().createElement(
                                hu,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: b()(nt.image, null == c ? void 0 : c.image) },
                                        F &&
                                            r().createElement('div', {
                                                className: b()(nt.highlight, null == c ? void 0 : c.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: b()(nt.icon, null == c ? void 0 : c.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        _ &&
                                            r().createElement('div', {
                                                className: b()(nt.overlay, null == c ? void 0 : c.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: d },
                                    r().createElement('div', {
                                        className: b()(nt.timer, null == c ? void 0 : c.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const st = ({ reward: u, size: e }) => {
                        const t = u.RewardWrapper || null;
                        return t
                            ? r().createElement(t, u.rewardWrapperProps, r().createElement(rt, at({ size: e }, u)))
                            : r().createElement(rt, at({ size: e }, u));
                    },
                    ot = 'Rewards_base_26',
                    it = 'Rewards_base__vertical_9f',
                    lt = 'Rewards_reward_7b',
                    Et = 'Rewards_reward__vertical_c6',
                    ct = ({
                        data: u,
                        size: e = Pe.Big,
                        isVertical: t = !1,
                            ...
                            u
                                ...
                                .map((u, t) =>
                                    r().createElement(
                                        'div',
                                        { key: t, className: A },
                                        r().createElement(st, { reward: u, size: e }),
                                    ),
                                ),
                            c &&
                                r().createElement(
                        ...
                        const D = (0, n.useRef)(null),
                            ...
                            y = b()(
                                ...
                                At[`base__${a}`],
                                {
                                    ...
                                    [At[`base__${e}`]]: e,
                                    [At.base__focus]: t,
                                    [At.base__highlightActive]: C,
                                    [At.base__firstHover]: h,
                                },
                                o,
                            ),
                            O = b()(At.state, At.state__default);
                        return (
                            (0, n.useEffect)(
                                () => (
                ...
                dt.defaultProps = { type: et.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Ft = (0, n.memo)(dt),
                    _t = 'Footer_base_b5',
                    Dt = 'Footer_rewards_de',
                    mt = 'Footer_rewardsTitle_88',
                    Ct = 'Footer_reward_7c',
                    Bt = 'Footer_button_ac',
                    gt = (0, H.Pi)(({ onConfirm: u, focusingItems: e }) => {
                        const t = ut(),
                            n = t.model,
                            a = t.controls,
                            s = n.root.get(),
                        ...
                        return (
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: Dt },
                                    r().createElement('div', { className: mt }, o),
                                    r().createElement(ct, { data: d, rewardItemClassMix: Ct }),
                                ),
                                r().createElement(
                                    Ft,
                                    {
                    ...
                    ht = 'AddCredentialsViewApp_base_06',
                    pt = 'AddCredentialsViewApp_spacer_fa',
                    bt = 'AddCredentialsViewApp_content_d1',
                    vt = 'AddCredentialsViewApp_field_a4',
                    wt = 'AddCredentialsViewApp_warningBox_bb',
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            ...
                                            r().createElement(
                                                ...
                                                r().createElement(
                                                    ge,
                                                    Tt({}, _[D], { className: vt, isErrorVisible: !B }),
                                                ),
                                            ),
                                            r().createElement(
                                                'div',
                                        ...
                                        r().createElement(gt, { focusingItems: _, onConfirm: C }),
                                    ),
                            ),
                        );
                    });
                ...
                (u, e, t) => {
                    engine.whenReady.then(() => {
                        s().render(r().createElement(o, { name: St }, u), e, t);
                    });
                })(
                    r().createElement(
                        Je,
                        { options: { rootId: R.views.lobby.account_completion.AddCredentialsView('resId') } },
                        r().createElement(N, null, r().createElement(Rt, null)),
                    ),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [235], () => __webpack_require__(349));
