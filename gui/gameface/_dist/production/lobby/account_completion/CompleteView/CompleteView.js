(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var A = {};
                t.r(A), t.d(A, { getBgUrl: () => c, getTextureUrl: () => C });
                var i = {};
                function F(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            665: (u, e, t) => {
                ...
                const s = a.O.client.getSize('rem'),
                    l = s.width,
                    B = s.height,
                    C = Object.assign({ width: l, height: B }, D(l, B, r)),
                ...
                const d = (u) => {
                    ...
                    const E = (0, n.useContext)(c),
                        ...
                        h = E.mediumHeight,
                        g = E.smallHeight,
                        w = E.extraSmallHeight,
                        v = { extraLarge: d, large: m, medium: h, small: g, extraSmall: w };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && D) return F(e, t, v);
                        if (t.largeWidth && s) return F(e, t, v);
                        if (t.mediumWidth && l) return F(e, t, v);
                        if (t.smallWidth && B) return F(e, t, v);
                ...
                const m = (u) => {
                    ...
                    h = (0, n.memo)(({ children: u }) => {
                        ...
                        return E().createElement(c.Provider, { value: o }, u);
                    });
                var g = t(483),
                    w = t.n(g);
                let v;
                ...
                const p = (u, e, t) => {
                    ...
                    f = (u, e, t = v.left) => u.split(e).reduce(t === v.left ? p : b, []),
                    x = (() => {
                        const u = new RegExp(
                        ...
                        return T.includes(t)
                            ...
                            : ((u, e = v.left) => {
                                  ...
                                  const n =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return f(E, /( )/, e).forEach((u) => (t = t.concat(f(u, n, v.left)))), t;
                              })(u, e);
                    };
                function y(u, e, t) {
                    const E = (0, n.useContext)(c);
                    let A = Object.entries(E).filter(([u, e]) => !0 === e && u in o);
                    return (
                ...
                const L = (u = 1) => {
                    ...
                    U = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: E, modelPath: H(E, u || ''), resId: n };
                            })(),
                            t = e.modelPrefix,
                            n = u.split('.');
                        if (n.length > 0) {
                            ...
                            return (
                                n.reduce((e, n) => {
                                    const E = P(H(t, `${e}.${n}`), window);
                                    return N(E) ? (u.push(E.id), `${e}.${n}.value`) : (u.push(n), `${e}.${n}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        m(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = U(u);
                                s.current = W.addCallback(n, t, F, e === V.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== V.None)
                                return () => {
                                    W.removeCallback(s.current, F);
                                };
                        }, [F, e]),
                        o
                    );
                ...
                const G = 'FormatText_base_d0',
                    q = ({ binding: u, text: e = '', classMix: t, alignment: A = v.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, i) =>
                                      E().createElement(
                                          'div',
                                          { className: w()(G, t), key: `${e}-${i}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : O(u, e))))(e, A, u).map((u, e) =>
                ...
                const Z = (u, e, t = {}, n = 0) => {
                    ...
                    X = (u) => {
                        ...
                        const w = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            v = (0, n.useMemo)(() => d || L().resId, [d]),
                            p = (0, n.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (Z(t, B, { isMouseEvent: !0, on: !0, arguments: $(E) }, v),
                                    m && m(),
                                  ...
                                  Object.assign(
                                      {
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((w.current.timeoutId = window.setTimeout(p, o ? 100 : 400)),
                                                      A && A(u),
                                                      x && x(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                                          ...
                                          onClick: ((u) => (e) => {
                                              !1 === s && b(), null == a || a(e), null == u || u(e);
                                          })(e.props.onClick),
                                          onMouseDown: ((u) => (e) => {
                                              !1 === s && b(), null == F || F(e), null == u || u(e);
                                          })(e.props.onMouseDown),
                                      },
                                      g,
                                  ),
                    ...
                    Q = 'EmailIcon_base_57',
                    J = { tooltipId: 'TOOLTIP_SUBTITLE_ID' },
                    uu = () =>
                        E().createElement(
                            X,
                            {
                    ...
                    tu = (0, n.memo)(({ title: u, subTitle: e, iconOverlay: t }) => {
                        const A = (0, n.useMemo)(
                                () => ({
                                    emailIcon: E().createElement(uu, null),
                                    br: E().createElement('div', { className: eu.br }),
                                }),
                                [],
                            ),
                            i = y(['base'], eu);
                    ...
                    Eu = ({
                        ...
                        const c = (0, n.useRef)(null),
                            ...
                            v = h[1],
                            p = (0, n.useCallback)(() => {
                                i || (c.current && (c.current.focus(), C && C(!0)));
                            }, [i, C]),
                            b = (0, n.useCallback)(
                                (u) => {
                                    t && null !== c.current && !c.current.contains(u.target) && C && C(!1);
                                },
                                [t, C],
                            ),
                            f = (0, n.useCallback)(
                            ...
                            k = w()(
                                ...
                                nu[`base__${A}`],
                                {
                                    ...
                                    [nu[`base__${e}`]]: e,
                                    [nu.base__focus]: t,
                                    [nu.base__highlightActive]: d,
                                    [nu.base__firstHover]: g,
                                },
                                F,
                            ),
                            M = w()(nu.state, nu.state__default);
                        return (
                            (0, n.useEffect)(
                                () => (
                ...
                Eu.defaultProps = { type: z.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Au = (0, n.memo)(Eu);
                var iu = t(521);
                const Fu = (u) => {
                    console.error(u.type + ': useKeydownListener hook :: Callback is not defined');
                };
                function au(u = iu.n.NONE, e = Fu, t = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== iu.n.NONE)
                            return (
                ...
                class su extends E().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = w()(ru.base, ru[`base__${i}`], ru[`base__${A}`], null == F ? void 0 : F.base),
                            B = w()(ru.icon, ru[`icon__${i}`], ru[`icon__${A}`], null == F ? void 0 : F.icon),
                            C = w()(ru.glow, null == F ? void 0 : F.glow),
                            c = w()(ru.caption, ru[`caption__${i}`], null == F ? void 0 : F.caption),
                            _ = w()(ru.goto, null == F ? void 0 : F.goto);
                        return E().createElement(
                            'div',
                            Du(
                                {
                            ...
                            'info' !== i && E().createElement('div', { className: ru.shine }),
                ...
                const lu = {
                    ...
                    Bu = (0, n.memo)(
                        ({
                            ...
                            const F = (0, n.useCallback)(() => e(), [e]),
                                a = (0, n.useCallback)(
                                    (u) => {
                                        (i && i()) || (t ? (u.stopImmediatePropagation(), F()) : A());
                                    },
                                    [t, F, A, i],
                                );
                            au(iu.n.ESCAPE, a);
                    ...
                    Cu = {
                        base: 'CompleteViewApp_base_05',
                        base__small: 'CompleteViewApp_base__small_d9',
                        base__extraSmall: 'CompleteViewApp_base__extraSmall_9e',
                        divider: 'CompleteViewApp_divider_56',
                        button: 'CompleteViewApp_button_a7',
                        iconOverlay: 'CompleteViewApp_iconOverlay_91',
                        showIn: 'CompleteViewApp_showIn_54',
                        showOut: 'CompleteViewApp_showOut_52',
                        fadeIn: 'CompleteViewApp_fadeIn_13',
                        fadeOut: 'CompleteViewApp_fadeOut_6c',
                        windowIn: 'CompleteViewApp_windowIn_1d',
                    },
                    cu = ['title', 'subTitle', 'onCloseClicked'];
                function _u() {
                    return (
                        (_u =
                            Object.assign ||
                    ...
                    return E().createElement(
                        ...
                        E().createElement(
                            ...
                            E().createElement(tu, {
                                title: e,
                                subTitle: t,
                                iconOverlay: E().createElement('div', { className: Cu.iconOverlay }),
                            }),
                            E().createElement('div', { className: Cu.divider }),
                            E().createElement(
                                Au,
                                { mixClass: Cu.button, onClick: F, size: K.medium, type: z.secondary },
                ...
                engine.whenReady.then(() => {
                    i().render(
                        E().createElement(h, null, E().createElement(du, null)),
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (a = 0; a < deferred.length; a++) {
                    for (var [e, t, n] = deferred[a], A = !0, i = 0; i < e.length; i++)
                        (!1 & n || E >= n) &&
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    if (A.some((e) => 0 !== u[e])) {
                        ...
                        if (F) var r = F(__webpack_require__);
                    }
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [235], () => __webpack_require__(665));
