(() => {
    var __webpack_modules__ = {
            ...
            26: (u, e, t) => {
                ...
                const L = {
                    ...
                    y = (u) => {
                        ...
                        const a = f(),
                            ...
                            A = a.mediaHeight,
                            i = a.mediaSize;
                        return E().createElement('div', x({ className: m()(t, L[n], M[A], S[i]) }, r), e);
                    },
                    O = ['children'],
                    T = (u) => {
                        let e = u.children,
                    ...
                    const c = (0, r.useRef)(null),
                        ...
                        P = m()(
                            ...
                            N[`base__${a}`],
                            {
                                ...
                                [N.base__firstHover]: f,
                            },
                            A,
                        ),
                        I = m()(N.state, N.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                        ...
                        E().createElement(
                            ...
                            a !== W.ghost &&
                                E().createElement(
                                    E().Fragment,
                                    null,
                                    E().createElement('div', { className: N.back }),
                                    E().createElement('span', { className: N.texture }),
                                ),
                            E().createElement(
                                'span',
                                { className: I },
                                E().createElement('span', { className: N.stateDisabled }),
                                E().createElement('span', { className: N.stateHighlightHover }),
                                E().createElement('span', { className: N.stateHighlightActive }),
                            ),
                            E().createElement(
                                'span',
                ...
                const $ = (u, e, t) => {
                    ...
                    q = (u, e, t = j.left) => u.split(e).reduce(t === j.left ? $ : z, []),
                    V = (() => {
                        const u = new RegExp(
                    ...
                    K = ['zh_cn', 'zh_sg', 'zh_tw'],
                    Y = ({ binding: u, text: e = '', classMix: t, alignment: a = j.left }) =>
                        null === e
                ...
                class J extends E().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = m()(X.base, X[`base__${n}`], X[`base__${a}`], null == A ? void 0 : A.base),
                            B = m()(X.icon, X[`icon__${n}`], X[`icon__${a}`], null == A ? void 0 : A.icon),
                            C = m()(X.glow, null == A ? void 0 : A.glow),
                            c = m()(X.caption, X[`caption__${n}`], null == A ? void 0 : A.caption),
                            d = m()(X.goto, null == A ? void 0 : A.goto);
                        return E().createElement(
                            ...
                            'info' !== n && E().createElement('div', { className: X.shine }),
                ...
                const au = (u) => {
                    const e = (0, r.useState)(Eu.Pending),
                        t = e[0],
                        E = e[1];
                    return (
                        (0, r.useEffect)(() => {
                            const e = { errors: 0, loaded: 0 },
                                t = () => {
                                    e.errors + e.loaded === u.length
                                        ? E(e.errors ? Eu.Failure : Eu.Success)
                                        : E(Eu.Pending);
                                };
                            return ((r) => {
                                let E,
                                ...
                                const F = (0, r.useRef)([]),
                                    s = (u, t, r) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            o = (({ observableModel: u }) =>
                                                Object.assign({}, u.primitives(['hasBattlePass'])))({
                                                mode: u,
                                                readByPath: i,
                                                externalModel: A,
                                                observableModel: {
                                    ...
                                    l = D[0],
                                    B = D[1],
                                    C = (0, r.useState)(() => s(u, a, i)),
                                    c = C[0],
                                    d = C[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        o.current ? d(s(l, a, i)) : (o.current = !0);
                                    }, [i, l, a]),
                                    (0, r.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                ...
                const Cu = (u) => {
                    ...
                    cu = ({ title: u, description: e, imageName: t }) => {
                        const r = f().mediaSize;
                        return E().createElement(
                            'div',
                            { className: 'InfoBlock_base_a9' },
                            E().createElement('div', {
                                className: 'InfoBlock_image_fd',
                                style: {
                                    backgroundImage:
                                        ((a = t),
                                        (n = Cu(r)),
                                        `url(R.images.winback.gui.maps.icons.dailyQuestsIntro.${a}_${n})`),
                                },
                            }),
                            E().createElement(Y, { text: u, classMix: 'InfoBlock_title_6f' }),
                            E().createElement(Y, { text: e, classMix: 'InfoBlock_description_ae' }),
                        );
                        var a, n;
                    };
                var du;
                ...
                const _u = R.strings.winback.dailyQuestsIntroView,
                    mu = [R.images.winback.gui.maps.icons.dailyQuestsIntro.background()],
                    hu = (0, ru.Pi)(() => {
                        const u = Du(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return (
                            ...
                            E().createElement(
                                'div',
                                { className: m()('App_base_30', !a && 'App_base__hidden_99') },
                                E().createElement(
                                    'div',
                                    { className: 'App_background_ce' },
                                    E().createElement('div', { className: 'App_bgFoggingAndBlurring_d8' }),
                                ),
                                a &&
                                    E().createElement(
                                        'div',
                                        { className: 'App_container_03' },
                                        E().createElement(
                                            'div',
                                            { className: 'App_closeButtonWrapper_f8' },
                                            E().createElement(J, {
                                                caption: _u.buttons.close(),
                                                type: 'close',
                                                side: 'right',
                                                onClick: t.close,
                                            }),
                                        ),
                                        E().createElement('div', { className: 'App_title_66' }, _u.title()),
                                        E().createElement(
                                            'div',
                                            { className: 'App_content_dc' },
                                            E().createElement(cu, {
                                                title: _u.info.mode.title(),
                                                description: _u.info.mode.description(),
                                                imageName: du.Mode,
                                            }),
                                            E().createElement('div', { className: lu }),
                                            E().createElement(cu, {
                                                title: _u.info.quests.title(),
                                                description: r
                                                    ? _u.info.quests.descriptionBP()
                                                    : _u.info.quests.description(),
                                                imageName: r ? du.QuestsBP : du.Quests,
                                            }),
                                            E().createElement('div', { className: lu }),
                                            E().createElement(cu, {
                                                title: _u.info.rewards.title(),
                                                description: _u.info.rewards.description(),
                                                imageName: du.Rewards,
                                            }),
                                        ),
                                        E().createElement(
                                            'div',
                                            { className: 'App_confirmButtonWrapper_9e' },
                                            E().createElement(
                                                G,
                                                { size: I.medium, mixClass: 'App_confirmButton_58', onClick: t.close },
                                                E().createElement(Y, { text: _u.buttons.confirm() }),
                                            ),
                                        ),
                                    ),
                            )
                ...
                engine.whenReady.then(() => {
                    P().render(
                        E().createElement(ou, null, E().createElement(T, null, E().createElement(hu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(26));
