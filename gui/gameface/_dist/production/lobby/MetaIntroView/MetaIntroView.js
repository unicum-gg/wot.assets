(() => {
    var __webpack_modules__ = {
            ...
            5099: (e, u, t) => {
                ...
                const c = i.O.client.getSize('rem'),
                    ...
                    h = (e) => {
                        ...
                        const r = (0, n.useContext)(F),
                            ...
                            f = { extraLarge: D, large: B, medium: C, small: g, extraSmall: p };
                ...
                const y = {
                    ...
                    T = (e) => {
                        ...
                        const i = (() => {
                            ...
                            s = i.mediaHeight,
                            l = i.mediaSize;
                        return r().createElement('div', w({ className: B()(t, y[o], x[s], L[l]) }, a), u);
                    },
                    O = ['children'],
                    k = (e) => {
                        let u = e.children,
                        ...
                        return r().createElement(m, null, r().createElement(T, t, u));
                    };
                var M = t(493),
                    S = t.n(M);
                const I = {
                ...
                const j = {
                        [W.Linear]: I.linear,
                        [W.EaseIn]: I.easeInCubic,
                        [W.EaseOut]: I.easeOutCubic,
                        [W.EaseInOut]: I.easeInOutCubic,
                        [W.EaseOutBack]: I.easeOutBack,
                        [W.EaseOutQuint]: (e) => 1 - Math.pow(1 - e, 5),
                        [W.EaseOutExpo]: (e) => (1 === e ? 1 : 1 - Math.pow(2, -10 * e)),
                    },
                    G = ({
                        children: e,
                        from: u = N,
                        ...
                        const m = j[E],
                            ...
                            B = D[0],
                            C = D[1],
                            g = i && !o ? t : Object.assign({}, B, { transformOrigin: c });
                        return (
                            (0, n.useEffect)(() => {
                                C.start({
                                    from: u,
                                    ...
                                    delay: l,
                                    immediate: i,
                                    config: a ? Object.assign({}, a) : { duration: s, easing: m },
                                    cancel: i || o,
                                    reverse: h,
                                    onRest: (e) => {
                                        !0 === e.finished && d && d();
                            ...
                            }, [C, l, s, m, u, i, d, t, F, o, h, A, a]),
                            r().createElement(H.animated.div, { className: _, style: g }, e)
                        );
                    };
                var U = t(9916);
                const V = [
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (z(t, F, { isMouseEvent: !0, on: !0, arguments: $(r) }, f),
                                    B && B(),
                ...
                const te = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    const a = u.contentId;
                    return a ? r().createElement(K, ue({}, u, { contentId: a }), n) : r().createElement(X, u, n);
                };
                var ne = t(8045);
                const re = {
                ...
                const le = { [se.NBSP]: ie.NoBreakSymbol, [se.ZWNBSP]: ie.NoBreakSymbol, [se.NEW_LINE]: ie.LineBreak },
                    ...
                    Fe = ({ elementList: e, textBlock: u, key: t }) => {
                        ...
                        return n
                            ? Ee[n]
                                ? r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': u.blockType, className: B()(de, Ee[n]) },
                                      e,
                                  )
                                : r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': u.blockType, className: de, style: Ae(n) },
                                      e,
                                  )
                            : r().createElement('span', { key: t, 'data-block-type': u.blockType, className: de }, e);
                    },
                    _e = {
                        [ie.Word]: Fe,
                        [ie.NoBreakSymbol]: Fe,
                        [ie.Binding]: ({ elementList: e, textBlock: u, key: t }) =>
                            r().createElement(
                                'span',
                        ...
                        [ie.LineBreak]: ({ key: e }) =>
                            r().createElement('span', {
                                key: e,
                                'data-block-type': ie.LineBreak,
                                className: 'renderers_lineBreak_b5',
                            }),
                        [ie.NewLine]: ({ elementList: e, key: u }) =>
                            r().createElement(
                                'span',
                                { key: u, 'data-block-type': ie.NewLine, className: 'renderers_newLine_bd' },
                                e,
                            ),
                        [ie.NoBreakWrapper]: ({ elementList: e, key: u }) =>
                            r().createElement(
                                'span',
                                {
                                    key: u,
                                    'data-block-type': ie.NoBreakWrapper,
                    ...
                    Ce = (e, u = '', t) => {
                        ...
                        return (
                            me(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (e) => {
                                    n.push({ blockType: ie.Word, colorTag: u, childList: Be(e, t) });
                                },
                                (e) => {
                                    const t = e[0],
                                        r = le[t.charAt(0)];
                            ...
                            me(
                                ...
                                (e) => {
                                    ...
                                    'string' == typeof i || 'number' == typeof i
                                        ...
                                        : r.push({ blockType: ie.Binding, colorTag: t, childList: [i] });
                                },
                            ),
                            r
                        );
                    ...
                    pe = (e, u) => {
                        ...
                        if (e.blockType === ie.NoBreakWrapper) (e.childList.push(n), t.push(e));
                        else {
                            const u = Object.assign({}, e, { childList: e.childList.splice(-1) });
                            (e.childList.length > 0 && t.push(e),
                                t.push({ blockType: ie.NoBreakWrapper, colorTag: '', childList: [u, n] }));
                        }
                    ...
                    be = (e, u) => !e || e.offsetTop + e.offsetHeight > u,
                    ...
                    ye = (e, u, t, n, a, i) => {
                        ...
                        for (let l = t; l >= 0; l--) {
                            ...
                            if (c === ie.LineBreak || c === ie.NewLine || c === ie.Binding) continue;
                            ...
                            }
                            {
                                const e = t.children,
                                    c = u[l],
                                    d = c.props.children,
                                    A = ye(e, d, e.length - 1, n, a, i),
                                    F = A[0],
                                    _ = A[1];
                                if (!(F < 0)) {
                                    const e = d.slice(0, F);
                                    ((s = r().cloneElement(c, c.props, e, _)), (o = l));
                                    break;
                                }
                                a -= E.length;
                            }
                    ...
                    xe = r().memo(
                        ({
                            ...
                            const A = (0, n.useRef)(null),
                                ...
                                h = _[0],
                                m = _[1],
                                D = (0, n.useMemo)(() => fe(e, a, { justifyContent: c }), [a, c, e]),
                                C = (0, n.useMemo)(() => {
                                    if (
                                        i &&
                                        h.isTruncated &&
                                ...
                                r().createElement(
                                    'div',
                                    {
                                        className: B()(
                                            ...
                                            o && re.base__isTruncationAvailable,
                                        ),
                                        style: p,
                                    },
                                    r().createElement('div', { className: re.unTruncated, ref: A }, D),
                                    r().createElement(
                                        te,
                                        {
                                            tooltipArgs: C,
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: B()(
                                                    re.truncated,
                                                    !h.isTruncateFinished && o && re.truncated__hide,
                                                ),
                                                style: p,
                                            },
                                            h.isTruncateFinished && o ? h.elementList : D,
                                        ),
                                    ),
                                )
                            );
                ...
                const Me = (e) => {
                    ...
                    return r().createElement(
                        'div',
                        { className: B()(Le.base, Le[`base__${u}`], o), lang: R.strings.settings.LANGUAGE_CODE() },
                        r().createElement(xe, ke({ classMix: B()(Le.layer0, n && Le.layer0__shadow) }, s)),
                        (u === Te.Heading || u === Te.MetaHeading) &&
                            r().createElement(
                                r().Fragment,
                                null,
                                r().createElement(xe, ke({ classMix: Le.layer1 }, s)),
                                r().createElement(xe, ke({ classMix: Le.layer2 }, s)),
                            ),
                        r().createElement(xe, ke({ classMix: Le.layer3 }, s)),
                        i && r().createElement(xe, ke({ classMix: Le.layer4 }, s)),
                    );
                };
                function Se(e) {
                    engine.call('PlaySound', e).catch((u) => {
                ...
                const Ne = ({
                    ...
                    return (
                        (0, n.useEffect)(() => {
                            function e(e) {
                                D && null !== h.current && !h.current.contains(e.target) && C(!1);
                            }
                            return (
                            ...
                            'div',
                            {
                                ...
                                onMouseDown: function (e) {
                                    i ||
                                        (null !== l && Se(l),
                                        d && d(e),
                                        t && (i || (h.current && (h.current.focus(), C(!0)))),
                                        f(!0));
                                },
                ...
                Ne.defaultProps = { type: Ie.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Pe = Ne,
                    We = {
                ...
                class Ue extends r().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            A = B()(We.base, We[`base__${i}`], We[`base__${a}`], null == o ? void 0 : o.base),
                            F = B()(We.icon, We[`icon__${i}`], We[`icon__${a}`], null == o ? void 0 : o.icon),
                            _ = B()(We.glow, null == o ? void 0 : o.glow),
                            h = B()(We.caption, We[`caption__${i}`], null == o ? void 0 : o.caption),
                            m = B()(We.goto, null == o ? void 0 : o.goto);
                        return r().createElement(
                            'div',
                            Ge(
                                {
                ...
                function ze(e = Ve.n.NONE, u = $e, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (e !== Ve.n.NONE)
                            return (
                ...
                var Xe = t(3403);
                const Ze = 'ev_hw_hangar_ui_info_missions_item';
                function Qe() {
                    return !1;
                }
                console.log;
                                ...
                                const l = (0, n.useRef)([]),
                                    c = (e, t, n) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            E = (({ observableModel: e }) => ({ root: e.object() }))({
                                                mode: e,
                                                readByPath: s,
                                                externalModel: o,
                                                observableModel: {
                                    ...
                                    A = d[0],
                                    F = d[1],
                                    _ = (0, n.useState)(() => c(e, a, s)),
                                    h = _[0],
                                    m = _[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        E.current ? m(c(A, a, s)) : (E.current = !0);
                                    }, [s, A, a]),
                                    (0, n.useEffect)(() => {
                                        F(e);
                                    }, [e]),
                ...
                const ou = 500,
                    su = {
                        [iu.HEADER]: { from: { y: -10, opacity: 0 }, to: au, delay: 0, duration: ou },
                        [iu.BLOCK_1]: { from: { y: 5, opacity: 0 }, to: au, delay: 400, duration: ou },
                        [iu.TITLE_1]: { from: { y: -15, opacity: 0 }, to: au, delay: 400, duration: ou },
                        [iu.BLOCK_2]: { from: { y: 5, opacity: 0 }, to: au, delay: 600, duration: ou },
                        [iu.TITLE_2]: { from: { y: -15, opacity: 0 }, to: au, delay: 600, duration: ou },
                        [iu.BLOCK_3]: { from: { y: 5, opacity: 0 }, to: au, delay: 800, duration: ou },
                        [iu.TITLE_3]: { from: { y: -15, opacity: 0 }, to: au, delay: 800, duration: ou },
                        [iu.BUTTON]: { from: { y: -10, opacity: 0 }, to: au, delay: 1200, duration: ou },
                    },
                    lu = 'MetaIntroApp_infoBlock_37',
                    cu = 'MetaIntroApp_title_8c',
                    Eu = 'MetaIntroApp_subTitle_08';
                function du() {
                    return (
                        (du = Object.assign
                            ? Object.assign.bind()
                ...
                const Au = (0, Xe.Pi)(() => {
                    ...
                    return (
                        (d = t.onClose),
                        ze(Ve.n.ESCAPE, d),
                        ze(Ve.n.ENTER, t.onClose),
                        ze(Ve.n.SPACE, t.onClose),
                        r().createElement(
                            'div',
                            { className: 'MetaIntroApp_base_4b', onClick: () => E(!0) },
                            r().createElement(Ue, {
                                classNames: { base: 'MetaIntroApp_closeBtn_5f' },
                            ...
                            r().createElement(
                                'div',
                                { className: 'MetaIntroApp_container_8c' },
                                r().createElement(
                                    G,
                                    du({ className: 'MetaIntroApp_topContainer_82', isCanceled: c }, su[iu.HEADER]),
                                    r().createElement(Me, {
                                        text: R.strings.halloween_lobby.metaIntro.title(),
                                        className: 'MetaIntroApp_header_c8',
                                        type: Te.MetaHeading,
                                        alignContent: oe.Center,
                                ...
                                r().createElement(
                                    'div',
                                    { className: 'MetaIntroApp_content_1e' },
                                    r().createElement(
                                        G,
                                        du({ isCanceled: c }, su[iu.BLOCK_1], {
                                            onStart: () => i.O.sound.play.sound(Ze),
                                        }),
                                        r().createElement(
                                            'div',
                                            { className: lu },
                                            r().createElement('div', { className: 'MetaIntroApp_fight_2f' }),
                                            r().createElement(
                                                G,
                                                du({ isCanceled: c }, su[iu.TITLE_1]),
                                                r().createElement(
                                                    'div',
                                                    { className: cu },
                                                    R.strings.halloween_lobby.metaIntro.header.fight(),
                                                ),
                                                r().createElement(xe, {
                                                    classMix: Eu,
                                    ...
                                    r().createElement(
                                        G,
                                        du({ isCanceled: c }, su[iu.BLOCK_2], {
                                            onStart: () => i.O.sound.play.sound(Ze),
                                        }),
                                        r().createElement(
                                            'div',
                                            { className: lu },
                                            r().createElement('div', { className: 'MetaIntroApp_progress_50' }),
                                            r().createElement(
                                                G,
                                                du({ isCanceled: c }, su[iu.TITLE_2]),
                                                r().createElement(
                                                    'div',
                                                    { className: cu },
                                                    R.strings.halloween_lobby.metaIntro.header.progress(),
                                                ),
                                                r().createElement(xe, {
                                                    classMix: Eu,
                                    ...
                                    r().createElement(
                                        G,
                                        du({ isCanceled: c }, su[iu.BLOCK_3], {
                                            onStart: () => i.O.sound.play.sound(Ze),
                                        }),
                                        r().createElement(
                                            'div',
                                            { className: lu },
                                            r().createElement('div', { className: 'MetaIntroApp_reward_74' }),
                                            r().createElement(
                                                G,
                                                du({ isCanceled: c }, su[iu.TITLE_3]),
                                                r().createElement(
                                                    'div',
                                                    { className: cu },
                                                    R.strings.halloween_lobby.metaIntro.header.reward(),
                                                ),
                                                r().createElement(xe, {
                                                    classMix: Eu,
                                ...
                                r().createElement(
                                    G,
                                    du({ isCanceled: c, className: 'MetaIntroApp_bottomContainer_a9' }, su[iu.BUTTON]),
                                    r().createElement(
                                        'div',
                                        { className: 'MetaIntroApp_btn_4a' },
                                        r().createElement(
                                            Pe,
                                            { type: Ie.primary, size: He.medium, onClick: t.onClose },
                ...
                engine.whenReady.then(() => {
                    S().render(
                        r().createElement(k, null, r().createElement(nu, null, r().createElement(Au, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(5099));
