(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => o, off: () => A, on: () => E, onResize: () => a, onScaleUpdated: () => n });
                var r = t(472),
                    i = t(176);
            ...
            816: (u, e, t) => {
                ...
                const o = n.O.client.getSize('rem'),
                    ...
                    B = (u) => {
                        ...
                        const i = (0, r.useContext)(d),
                            ...
                            w = { extraLarge: h, large: m, medium: _, small: g, extraSmall: v };
                ...
                const C = ({ children: u }) => {
                    ...
                    ((u) => {
                        ...
                        n.O.client.events.on('clientResized', o), n.O.client.events.on('self.onScaleUpdated', s);
                    }),
                        (0, r.useEffect)(
                            () => () => {
                                n.O.client.events.off('clientResized', o),
                                    n.O.client.events.off('self.onScaleUpdated', s);
                            },
                            [o, s],
                        );
                ...
                let v, w, f;
                var p;
                ((p = v || (v = {}))[(p.ExtraSmall = E.extraSmall.width)] = 'ExtraSmall'),
                    (p[(p.Small = E.small.width)] = 'Small'),
                    (p[(p.Medium = E.medium.width)] = 'Medium'),
                    (p[(p.Large = E.large.width)] = 'Large'),
                    (p[(p.ExtraLarge = E.extraLarge.width)] = 'ExtraLarge'),
                    (function (u) {
                ...
                const S = {
                    ...
                    y = (u) => {
                        ...
                        const a = x(),
                            ...
                            E = a.mediaHeight,
                            A = a.mediaSize;
                        return i().createElement('div', b({ className: m()(t, S[n], T[E], O[A]) }, r), e);
                    },
                    M = ['children'],
                    P = (u) => {
                        let e = u.children,
                        ...
                        return i().createElement(C, null, i().createElement(y, t, e));
                    };
                var H = t(986),
                    k = t.n(H);
                let W, I, N;
                ...
                const U = () => {},
                    ...
                    V = 'Video_video_e6',
                    K = 'Video_video__visible_c9';
                let z;
                !(function (u) {
                    (u[(u.Initial = 0)] = 'Initial'), (u[(u.Ended = 1)] = 'Ended');
                })(z || (z = {}));
                const q = i().memo(function ({
                        src: u,
                        api: e,
                        className: t,
                        onVideoPlay: a,
                        ...
                        const d = (0, r.useRef)(null),
                            c = (0, r.useRef)(0),
                            B = (0, r.useState)(z.Initial),
                            C = B[0],
                            h = B[1],
                            _ = ((u) => {
                                const e = (0, r.useState)(G(u ? u.current : null)),
                                    t = e[0],
                                    i = e[1];
                                return (
                                    (0, r.useEffect)(() => {
                                ...
                                cancelAnimationFrame(c.current),
                                    d.current &&
                                        (s
                                            ...
                                            : (d.current.pause(), h(z.Ended))),
                                    !s && E && E();
                            }, [s, E]),
                            p = (0, r.useCallback)(() => {
                                const u = d.current;
                                return u && A && A(u.currentTime);
                            }, [A]),
                            L = (0, r.useCallback)(() => {
                                cancelAnimationFrame(c.current);
                                const u = () => {
                            ...
                            S = (0, r.useCallback)(() => {
                                cancelAnimationFrame(c.current), n && n();
                            }, [n]),
                            T = (0, r.useCallback)(
                                (u) => {
                                    d.current && F && !d.current.ended && (u ? d.current.pause() : d.current.play());
                                },
                                [F],
                            );
                        (0, r.useEffect)(() => {
                            ...
                            return (
                                u &&
                                    ...
                                    u.addEventListener('playing', b),
                                    u.addEventListener('pause', S),
                                    engine.on('clientMinimized', T)),
                                () => {
                                    u &&
                                        (u.removeEventListener('ended', f),
                                        u.removeEventListener('playing', b),
                                        u.removeEventListener('pause', S),
                                        engine.off('clientMinimized', T));
                                }
                            );
                        }, [T, f, S, b, p]),
                            (0, r.useEffect)(() => {
                            ...
                            (0, r.useEffect)(() => {
                                const u = d.current;
                                u && l && ((u.currentTime = u.duration), u.pause(), h(z.Ended));
                            }, [l]),
                            (0, r.useEffect)(() => {
                                const u = d.current;
                                _ && u && !u.ended && (D ? u.pause() : u.paused && u.play());
                            }, [D, _]),
                            (0, r.useEffect)(() => () => cancelAnimationFrame(c.current), []);
                        const O = (0, r.useRef)({ width: 0, height: 0, inited: !1 });
                        (0, r.useEffect)(() => {
                            const u = d.current,
                                e = O.current;
                        ...
                        return i().createElement(
                            ...
                            o &&
                                i().createElement('div', {
                                    className: m()(V, C === z.Ended && K),
                                    style: Object.assign({}, y, { backgroundImage: `url(${o})` }),
                                }),
                        );
                    }),
                    $ = {
                        base: 'App_base_0c',
                        base__ended: 'App_base__ended_cb',
                        video: 'App_video_8f',
                        cover: 'App_cover_49',
                        base__playing: 'App_base__playing_73',
                    };
                var j = t(521);
                t(916);
                const Y = (u) => {
                ...
                function Z(u = j.n.NONE, e = Y, t = !1, i = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== j.n.NONE)
                            return (
                ...
                var Q,
                    J = t(514);
                !(function (u) {
                    (u.Initial = 'initial'), (u.Playing = 'playing'), (u.Ended = 'ended');
                })(Q || (Q = {}));
                const uu = () => {
                    const u = (0, r.useRef)({ duration: void 0, onReady: U }).current,
                        e = (0, r.useState)(Q.Initial),
                        t = e[0],
                        a = e[1],
                        E = (0, r.useCallback)(() => {
                            J.hY.sound(R.sounds.hangar_newyear_gamemode_video_start()), a(Q.Playing);
                        }, []),
                        A = (0, r.useCallback)(() => {
                            J.hY.sound(R.sounds.hangar_newyear_gamemode_video_stop()), a(Q.Ended);
                            const u = setTimeout(n.O.view.sendEvent.close, 500);
                    ...
                    return (
                        ...
                        i().createElement(
                            'div',
                            { className: m()($.base, $[`base__${t}`]) },
                            i().createElement(q, {
                                api: u,
                                src: R.videos.grinch_progression.GMPIntro(),
                                className: $.video,
                                autoPlay: !0,
                                onVideoPlay: E,
                                onVideoEnd: A,
                            }),
                            i().createElement('div', { className: $.cover }),
                        )
                    );
                };
                engine.whenReady.then(() => {
                    k().render(
                        i().createElement(P, null, i().createElement(uu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(816));
