(() => {
    var __webpack_modules__ = {
            ...
            5067: (u, e, t) => {
                ...
                t.d(e, { O: () => $ });
                var a = {};
                (t.r(a), t.d(a, { mouse: () => l, onResize: () => E }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        events: () => a,
                ...
                const W = Object.keys(B).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === B[e]), u), {}),
                    U = {
                        set: (u, e) => {
            ...
            9072: (u, e, t) => {
                ...
                const F = s.O.client.getSize('rem'),
                    ...
                    C = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && l) return o(e, t, v);
                            if (t.largeWidth && F) return o(e, t, v);
                            if (t.mediumWidth && c) return o(e, t, v);
                            if (t.smallWidth && _) return o(e, t, v);
                    ...
                    h = (0, a.memo)(({ children: u }) => {
                        const e = (0, a.useContext)(d),
                            ...
                            o = (0, a.useCallback)((u, e) => {
                                ...
                                i(Object.assign({ width: t, height: a }, l(t, a, E)));
                            }, []);
                        (m(() => {
                ...
                const S = {
                    ...
                    T = (u) => {
                        ...
                        const i = (() => {
                            ...
                            s = i.mediaHeight,
                            E = i.mediaSize;
                        return r().createElement('div', M({ className: w()(t, S[o], k[s], y[E]) }, n), e);
                    },
                    O = ['children'],
                    H = (u) => {
                        let e = u.children,
                        ...
                        return r().createElement(h, null, r().createElement(T, t, e));
                    };
                function P(u) {
                    ...
                    const d = (0, a.useRef)(null),
                        ...
                        H = w()(
                            ...
                            N[`base__${n}`],
                            {
                                ...
                                [N[`base__${e}`]]: e,
                                [N.base__focus]: C,
                                [N.base__highlightActive]: g,
                                [N.base__firstHover]: p,
                            },
                            o,
                        ),
                        W = w()(N.state, N.state__default);
                    return (
                        (0, a.useEffect)(
                            () => (
                ...
                class z extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = w()($.base, $[`base__${i}`], $[`base__${n}`], null == o ? void 0 : o.base),
                            _ = w()($.icon, $[`icon__${i}`], $[`icon__${n}`], null == o ? void 0 : o.icon),
                            D = w()($.glow, null == o ? void 0 : o.glow),
                            d = w()($.caption, $[`caption__${i}`], null == o ? void 0 : o.caption),
                            B = w()($.goto, null == o ? void 0 : o.goto);
                    ...
                    return (
                        m(() => {
                            if (
                                                ...
                                                const e = Z(),
                                                    ...
                                                    r =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: r, modelPath: uu(r, ''), resId: a };
                                            })(),
                                            t = e.modelPrefix,
                                            a = u.split('.');
                                        if (a.length > 0) {
                                ...
                                F.current = eu.addCallback(a, t, o, e === tu.Deep);
                            }
                        }),
                        (0, a.useEffect)(() => {
                            if (e !== tu.None)
                                return () => {
                                    eu.removeCallback(F.current, o);
                                };
                        }, [o, e]),
                        A
                    );
                ...
                var ou = t(8552);
                const su = ({ x: u, y: e, path: t, koeffX: n, koeffY: i }) => {
                        const o = (0, ou.useSpring)(() => ({
                                xy: [0, 0],
                                config: { mass: 0.2, tension: 500, friction: 150 },
                            })),
                            s = o[0],
                            E = o[1],
                            A = (0, a.useCallback)((u, e) => `translate3d(${u * n}rem,${e * i}rem,0)`, [n, i]);
                        E.start({ xy: ((u, e) => [u, e])(u, e) });
                        const l = (0, a.useMemo)(
                            () => ({ transform: s.xy.to(A), backgroundImage: `url(${t})` }),
                            [t, s.xy, A],
                        );
                        return r().createElement(ou.animated.div, { className: 'LayerItem_base_7d', style: l });
                    },
                    Eu = [
                        {
                        ...
                        return (
                            (0, a.useEffect)(() => {
                                const u = (u) => {
                                    ...
                                    n({ x: e / 2 - u.clientX, y: t - u.clientY });
                                };
                                return (
                            ...
                            r().createElement(
                                ...
                                Eu.map((u, e) => r().createElement(su, Au({ key: e, x: t.x, y: t.y }, u))),
                            )
                        );
                    },
                    Fu = ({ backgroundPath: u, classMix: e }) => {
                        const t = (0, a.useMemo)(() => {
                                const e = s.O.client.getSize('rem').height,
                                    t = s.O.view.getViewGlobalPosition('rem').y,
                                    a = s.O.view.getSize('rem').height;
                                return { backgroundImage: `url(${u})`, top: `-${t}rem`, bottom: `-${e - a - t}rem` };
                            }, [u]),
                            n = w()('LobbySubViewBackground_base_53', e);
                        return r().createElement('div', { className: n, style: t });
                    },
                    cu = (0, a.memo)(({ classMix: u }) => {
                        const e = w()('Flare_base_c1', u);
                        return r().createElement('div', { className: e });
                    }),
                    _u = 'OrderInfoX15ViewApp_button_1b',
                    Du = () => {
                        const u = au('model', tu.None),
                            e = u.onClose,
                            t = u.onQuestButtonClick,
                            n = !s.O.client.graphicsQuality.isLow(),
                            i = (0, a.useCallback)(() => e(), [e]);
                        var o;
                        ((o = i), iu(ru.n.ESCAPE, o));
                        const E = (0, a.useState)(0),
                            A = E[0],
                            l = E[1],
                            F = (0, a.useCallback)(() => t(), [t]),
                            c = (0, a.useCallback)(
                                (u) => {
                        ...
                        return (
                            ...
                            r().createElement(
                                'div',
                                { className: 'OrderInfoX15ViewApp_base_af' },
                                r().createElement(Fu, {
                                    backgroundPath: R.images.historical_battles.gui.maps.icons.backgrounds.buyBundle(),
                                }),
                                r().createElement('div', { className: 'OrderInfoX15ViewApp_vignette_9d' }),
                                n && r().createElement(lu, null),
                                r().createElement(
                                    'div',
                                    { className: 'OrderInfoX15ViewApp_closeButton_24' },
                                    r().createElement(z, {
                                ...
                                r().createElement(
                                    'div',
                                    { className: 'OrderInfoX15ViewApp_title_30' },
                                    R.strings.hb_lobby.orderInfo.titleGetX15().replace(/&nbsp;/g, ' '),
                                ),
                                r().createElement(
                                    'div',
                                    { className: 'OrderInfoX15ViewApp_ordersX15Image_5d' },
                                    r().createElement(cu, { classMix: 'OrderInfoX15ViewApp_flare_c5' }),
                                ),
                                r().createElement(
                                    'div',
                                    { className: 'OrderInfoX15ViewApp_buttons_f6' },
                                    r().createElement(
                                        G,
                                        {
                                            size: W.medium,
                                    ...
                                    r().createElement(
                                        ...
                                        R.strings.hb_lobby.orderInfo.goQuestButton.label(),
                                    ),
                                ),
                            )
                        );
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(9072));
