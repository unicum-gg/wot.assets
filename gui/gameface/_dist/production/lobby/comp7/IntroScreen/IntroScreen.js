(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                'use strict';
                t.d(e, { Sw: () => a.Z, kH: () => l, Z5: () => i, lf: () => F, cy: () => o, B0: () => E, ry: () => m });
                class n {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            2608: (u, e, t) => {
                ...
                const S = {
                    ...
                    y = (u) => {
                        ...
                        const a = b(),
                            ...
                            o = a.mediaHeight,
                            E = a.mediaSize;
                        return r().createElement('div', T({ className: h()(t, S[i], M[o], L[E]) }, n), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                    ...
                    return r().createElement(m, null, r().createElement(y, t, e));
                };
                var H = t(493),
                    N = t.n(H);
                function P(u) {
                ...
                const $ = ({
                    ...
                    const B = (0, n.useRef)(null),
                        ...
                        b = p[1],
                        x = (0, n.useCallback)(() => {
                            i || (B.current && (B.current.focus(), _(!0)));
                        }, [i]),
                        T = (0, n.useCallback)(
                            (u) => {
                ...
                class K extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = h()(z.base, z[`base__${i}`], z[`base__${a}`], null == o ? void 0 : o.base),
                            c = h()(z.icon, z[`icon__${i}`], z[`icon__${a}`], null == o ? void 0 : o.icon),
                            d = h()(z.glow, null == o ? void 0 : o.glow),
                            B = h()(z.caption, z[`caption__${i}`], null == o ? void 0 : o.caption),
                            C = h()(z.goto, null == o ? void 0 : o.goto);
                        return r().createElement(
                            ...
                            'info' !== i && r().createElement('div', { className: z.shine }),
                            r().createElement('div', { className: c }, r().createElement('div', { className: d })),
                ...
                const uu = 'page_heading_05',
                    eu = 'page_close_a4',
                    tu = ({ onClose: u, className: e }) => {
                        var t;
                        return (
                            (t = u),
                            J(Z.n.ESCAPE, t),
                    ...
                    nu = 'Heading_base_74',
                    ru = ({ children: u, className: e }) => r().createElement('div', { className: h()(nu, e) }, u);
                function au() {
                    return !1;
                }
                console.log;
                        ...
                        return [
                            function ({ mode: a = 'real', options: o, children: E, mocks: s }) {
                                const A = (0, n.useRef)([]),
                                    F = (t, n, r) => {
                                        ...
                                        const o = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = ou(r.keys()); !(u = t()).done; ) a(u.value, e);
                                                    },
                                                    unsubscribe: a,
                                                };
                                            })(n),
                                    ...
                                    c = D[0],
                                    d = D[1],
                                    B = (0, n.useState)(() => F(a, o, s)),
                                    C = B[0],
                                    m = B[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        l.current ? m(F(c, o, s)) : (l.current = !0);
                                    }, [s, c, o]),
                                    (0, n.useEffect)(() => {
                                        d(a);
                                    }, [a]),
                ...
                const gu = (u, e, t) => {
                    ...
                    wu = (u, e, t = _u.left) => u.split(e).reduce(t === _u.left ? gu : vu, []),
                    pu = (() => {
                        const u = new RegExp(
                        ...
                        return fu.includes(t)
                            ...
                            : ((u, e = _u.left) => {
                                  ...
                                  const n =
                                      ...
                                      r = u.replace(/&nbsp;/g, ' ');
                                  return (wu(r, /( )/, e).forEach((u) => (t = t.concat(wu(u, n, _u.left)))), t);
                              })(u, e);
                    };
                let xu;
                !(function (u) {
                ...
                const Tu = 60,
                    ...
                    Mu = 86400;
                Date.now();
                const Lu = (0, n.memo)(({ datetime: u, format: e = xu.SHORT_DATE, localize: t = !0 }) =>
                        ((u, e, t) => {
                            switch (e) {
                                case xu.SHORT_DATE:
                                    return t
                                        ? X.Z5.getDateFormat(u, X.kH.SHORT_FORMAT)
                                        : X.cy.getTimeFormat('%d.%m.%y', u, !0);
                                case xu.SHORT_TIME:
                                    return t
                                        ? X.Z5.getTimeFormat(u, X.lf.SHORT_FORMAT)
                                        : X.cy.getTimeFormat('%I:%M %p', u, !0);
                                case xu.SHORT_DATE_TIME:
                                    return t
                                        ? `${X.Z5.getDateFormat(u, X.kH.SHORT_FORMAT)}, ${X.Z5.getTimeFormat(u, X.lf.SHORT_FORMAT)}`
                                        : X.cy.getTimeFormat('%d.%m.%y, %I:%M %p', u, !0);
                                case xu.FULL_DATE:
                                    return t
                                        ? X.Z5.getDateFormat(u, X.kH.LONG_FORMAT)
                                        : X.cy.getTimeFormat('%B %d, %Y', u, !0);
                                case xu.FULL_DATE_TIME:
                                    return t
                                        ? `${X.Z5.getDateFormat(u, X.kH.LONG_FORMAT)}, ${X.Z5.getTimeFormat(u, X.lf.SHORT_FORMAT)}`
                                        : X.cy.getTimeFormat('%B %d, %Y, %I:%M %p', u, !0);
                                case xu.MONTH:
                                    return X.cy.getTimeFormat('%B', u, !0);
                                case xu.MONTH_DATE:
                                    return X.cy.getTimeFormat('%B %e', u, !0);
                                case xu.DATE_MONTH:
                                    return X.cy.getTimeFormat('%e %B', u, !0);
                                case xu.MONTH_YEAR:
                                    return X.cy.getTimeFormat('%B %Y', u, !0);
                                case xu.WEEK_DAY:
                                    return X.cy.getTimeFormat('%A', u, !0);
                                case xu.WEEK_DAY_TIME:
                                    return t
                                        ? `${X.cy.getTimeFormat('%A', u, !0)} ${X.Z5.getTimeFormat(u, X.lf.SHORT_FORMAT)}`
                                        : X.cy.getTimeFormat('%A, %I:%M %p', u, !0);
                                case xu.YEAR:
                                    return X.cy.getTimeFormat('%Y', u, !0);
                                case xu.DATE_YEAR:
                                    return X.cy.getTimeFormat('%d, %Y', u, !0);
                            }
                        })(u, e, t),
                    ),
                    yu = 'FormatText_base_d0',
                    Ou = ({ binding: u, text: e = '', classMix: t, alignment: a = _u.left }) =>
                        null === e
                            ...
                            : r().createElement(
                                  ...
                                  e.split('\n').map((e, i) =>
                                      r().createElement(
                                          'div',
                                          { className: h()(yu, t), key: `${e}-${i}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : bu(u, e))))(e, a, u).map((u, e) =>
                        ...
                        const v = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            p = (0, n.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (Hu(t, c, { isMouseEvent: !0, on: !0, arguments: ku(r) }, w),
                                    _ && _(),
                ...
                const Wu = (u) => {
                    ...
                    Gu = 'ActiveSeasonState_base_55',
                    $u = 'ActiveSeasonState_calendarIcon_df',
                    ju = 'ActiveSeasonState_divider_5b',
                    Vu = R.strings.comp7.season,
                    zu = (u, e) => ({
                        startDate: r().createElement(Lu, { datetime: u, format: xu.SHORT_DATE }),
                        endDate: r().createElement(Lu, { datetime: e, format: xu.SHORT_DATE }),
                    }),
                    Yu = (u, e, t) => {
                        const n = e - t,
                            a = ((u, e) => Uu(u - e))(e, t);
                        return n >= 604800
                            ? r().createElement(Ou, { text: Vu.range(), binding: zu(u, e) })
                            : n >= Mu
                              ? r().createElement(Ou, { text: Vu.daysLeft(), binding: a })
                              : n >= Su
                                ? r().createElement(Ou, { text: Vu.hoursLeft(), binding: a })
                                : n >= Tu
                                  ? r().createElement(Ou, { text: Vu.minutesLeft(), binding: a })
                                  : n >= 1
                                    ? r().createElement(Ou, { text: Vu.secondsLeft(), binding: a })
                                    : void 0;
                    },
                    qu = ({
                        startTimestamp: u,
                    ...
                    Ku = 'ScheduleSubheading_base_f7',
                    Zu = (0, V.Pi)(({ className: u, hasSeasonName: e = !0 }) => {
                        const t = Du(),
                            n = t.model,
                            a = t.controls,
                            i = n.season.startTimestamp.get(),
                            o = n.season.endTimestamp.get(),
                            E = n.season.serverTimestamp.get();
                        return (
                            mu(E, o, a.pollServerTime),
                            r().createElement(
                                'div',
                                { className: h()(Ku, u) },
                                E < o
                ...
                const te = ue,
                    ...
                    ie = (u) => u.toString().padStart(2, '0'),
                    oe = (u, e) => {
                        switch (e) {
                            case Qu.Description:
                                return ((u, e = !0) =>
                                    u.days > 7 && e
                                        ? hu(R.strings.common.duration.days(), { days: u.days })
                                        : u.days >= 1
                                          ? 0 === u.hours
                                              ? hu(R.strings.common.duration.days(), { days: u.days })
                                              : `${hu(R.strings.common.duration.days(), { days: u.days })} ${hu(R.strings.common.duration.hours(), { hours: u.hours })}`
                                          : u.hours >= 1
                                            ? 0 === u.minutes
                                                ? hu(R.strings.common.duration.hours(), { hours: u.hours })
                                                : `${hu(R.strings.common.duration.hours(), { hours: u.hours })} ${hu(R.strings.common.duration.minutes(), { minutes: u.minutes })}`
                                            : hu(R.strings.common.duration.minutes(), { minutes: u.minutes || 1 }))(u);
                            case Qu.Short:
                                return `${ie(u.minutes)}:${ie(u.seconds)}`;
                            case Qu.Long:
                                return `${ie(u.hours)}:${ie(u.minutes)}:${ie(u.seconds)}`;
                            case Qu.Extended:
                                return `${hu(R.strings.common.duration.days(), { days: u.days })} | ${ie(u.hours)}:${ie(u.minutes)}:${ie(u.seconds)}`;
                        }
                    },
                    Ee = R.images.gui.maps.icons.components.countdown,
                    se = (u, e) => {
                        const t = 2 === e ? Ee.big : Ee;
                        switch (u) {
                            case Xu.Timer:
                                return t.clock();
                            case Xu.Countdown:
                    ...
                    Ae = (0, n.memo)(
                        ({
                            ...
                            const A = t !== Qu.Description ? 1 : void 0,
                                F = te(u, A),
                                l = (() => {
                            ...
                            const D = oe(
                                (function (u = 0) {
                                    ...
                                    return ((e -= r * Tu), { days: t, hours: n, minutes: r, seconds: e });
                                })(F),
                                t,
                            );
                            return r().createElement(
                                ...
                                e !== Xu.None &&
                                    r().createElement('div', {
                                        className: h()(re, E.icon),
                                        style: { backgroundImage: `url('${se(e, l)}')` },
                                    }),
                                s
                                    ? r().createElement(
                                          'div',
                                          { className: h()(ae, E.text) },
                                          r().createElement(Ou, { text: s, binding: { timerText: D } }),
                                      )
                                    : r().createElement('div', { className: h()(ae, E.text) }, D),
                            );
                        },
                    ),
                    Fe = 'CountDownSubheading_base_f7',
                    le = 'CountDownSubheading_highlight_7d',
                    De = 'CountDownSubheading_timeLeftText_2b',
                    ce = 'CountDownSubheading_countDownContainer_93',
                    de = 'CountDownSubheading_countDownText_87',
                    Be = 'CountDownSubheading_timer_49',
                    Ce = ({ timeLeft: u, className: e }) =>
                        r().createElement(
                            'div',
                            { className: h()(Fe, e) },
                            r().createElement(Ou, {
                                text: R.strings.comp7.countDown.text(),
                                binding: {
                                    timeLeft: r().createElement(
                                        ...
                                        r().createElement(Ae, { duration: u, icon: Xu.None, classNames: { text: de } }),
                                    ),
                                },
                                classMix: De,
                            }),
                        ),
                    me = { countDown: 'IntroSubheading_countDown_1e' },
                    _e = (0, V.Pi)(() => {
                        const u = Du(),
                            e = u.model,
                            t = u.controls,
                            n = e.season.startTimestamp.get(),
                            a = e.season.endTimestamp.get(),
                            i = e.season.serverTimestamp.get();
                        return (
                            mu(i, a, t.pollServerTime),
                            r().createElement(
                                'div',
                                { className: me.base },
                                i < n
                                    ? r().createElement(Ce, { timeLeft: n - i, className: me.countDown })
                    ...
                    pe = R.strings.comp7.intro;
                var fe;
                !(function (u) {
                    ((u.Small = 'small'), (u.Large = 'large'), (u.ExtraLarge = 'extraLarge'));
                })(fe || (fe = {}));
                const be = (0, V.Pi)(({ id: u }) => {
                        const e = Bu().model.root.get().qualificationBattlesCount,
                            t = b().mediaSize,
                            n = R.images.gui.maps.icons.comp7.metaIntro.$dyn(
                                ((u) => {
                                    switch (!0) {
                                        case u >= w.ExtraLarge:
                        ...
                        return r().createElement(
                            'div',
                            { className: he },
                            r().createElement(Ou, { text: String(pe.title.$dyn(u)), classMix: ge }),
                            r().createElement('div', {
                                className: ve,
                                style: { backgroundImage: `url(${n.$dyn(u)})` },
                            }),
                            r().createElement(Ou, {
                                text: `${pe.description.$plural(u, e)}`,
                                binding: { count: e },
                                classMix: we,
                            }),
                        );
                    ...
                    xe = 'Slider_base_e2',
                    Te = 'Slider_trackWrapper_77',
                    Se = 'Slider_track_1c',
                    Me = 'Slider_track__withoutTransition_1f',
                    Le = 'Slider_slide_3c',
                    ye = 'Slider_slide__active_b7',
                    Oe = 'Slider_prev_c8',
                    Re = 'Slider_next_79',
                    ke = 'Slider_prev__disabled_2b',
                    He = 'Slider_next__disabled_fc',
                    Ne = 'Slider_counter_ff',
                    Pe = 'Slider_counterDivider_90',
                    Ie = ['crimsonSeason', 'vehiclesOnMap', 'pointsOfInterest', 'roleSkills', 'qualification', 'ranks'],
                    We = Ie.length,
                    Ue = (u, e) => () => {
                    ...
                    Ge = () => {
                        ...
                        return (
                            ...
                            r().createElement(
                                'div',
                                { className: xe, style: { '--currentSlideIndex': e, '--transitionDuration': '500ms' } },
                                r().createElement('div', {
                                    className: h()(Oe, E && ke),
                                    onClick: F,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        Ie.map((u, t) =>
                                            r().createElement(
                                                'div',
                                                { className: h()(Le, t === e && ye), key: `slide-${t}` },
                                                r().createElement(be, { id: u }),
                                            ),
                                        ),
                                    ),
                                ),
                    ...
                    qe = (0, V.Pi)(() => {
                        ...
                        return r().createElement(
                            'div',
                            { className: $e },
                            r().createElement(ru, { className: uu }, R.strings.comp7.featureName()),
                            r().createElement(lu, { options: Ye }, r().createElement(_e, null)),
                            r().createElement('div', { className: je }, r().createElement(Ge, null)),
                            r().createElement(
                                'div',
                                { className: Ve },
                                r().createElement(
                                    j,
                                    { type: U.primary, size: G.medium, mixClass: ze, onClick: u.close },
                                    R.strings.comp7.intro.confirmButton(),
                                ),
                            ),
                            r().createElement(tu, { onClose: u.close }),
                        );
                    });
                (window.viewEnv.addPreloadTexture('gui/maps/icons/comp7/backgrounds/comp7_bg.png'),
                    engine.whenReady.then(() => {
                        N().render(
                            r().createElement(k, null, r().createElement(du, null, r().createElement(qe, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [926], () => __webpack_require__(2608));
