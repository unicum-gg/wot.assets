                                ...
                                ((a.style.transform = `translateY(${0 | m}px)`),
                                    ((e) => {
                                        if (u.current && l.current && c.current && d.current) {
                                            if (0 === Math.round(e))
                                                return (
                                                    u.current.classList.add(ta),
                                                    void l.current.classList.remove(ta)
                                                );
                                            if (
                                                ((t = c.current),
                                                (a = d.current),
                                                ...
                                                return (
                                                    u.current.classList.remove(ta),
                                                    void l.current.classList.add(ta)
                                                );
                                            var t, a;
                                ...
                                ((a.style.transform = `translateX(${0 | m}px)`),
                                    ((e) => {
                                        if (u.current && l.current && c.current && d.current) {
                                            if (0 === e)
                                                return (
                                                    u.current.classList.add(eo),
                                                    void l.current.classList.remove(eo)
                                                );
                                            if (
                                                ((t = c.current),
                                                (a = d.current),
                                                ...
                                                return (
                                                    u.current.classList.remove(eo),
                                                    void l.current.classList.add(eo)
                                                );
                                            var t, a;
