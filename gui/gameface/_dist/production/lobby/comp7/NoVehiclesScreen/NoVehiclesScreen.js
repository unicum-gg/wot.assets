(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                'use strict';
                t.d(e, { kH: () => D, Z5: () => a, lf: () => s, cy: () => i, B0: () => A, ry: () => m });
                class r {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            5339: (u, e, t) => {
                ...
                const C = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.largeWidth && D) return E(e, t, w);
                ...
                const L = {
                    ...
                    O = (u) => {
                        ...
                        const E = b(),
                            ...
                            i = E.mediaHeight,
                            A = E.mediaSize;
                        return n().createElement('div', x({ className: h()(t, L[a], M[i], S[A]) }, r), e);
                    },
                    y = ['children'];
                const H = (u) => {
                    let e = u.children,
                ...
                const W = (u, e, t) => {
                    ...
                    G = (u, e, t = N.left) => u.split(e).reduce(t === N.left ? W : U, []),
                    V = (() => {
                        const u = new RegExp(
                ...
                class X extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()(K.base, K[`base__${a}`], K[`base__${E}`], null == i ? void 0 : i.base),
                            c = h()(K.icon, K[`icon__${a}`], K[`icon__${E}`], null == i ? void 0 : i.icon),
                            B = h()(K.glow, null == i ? void 0 : i.glow),
                            C = h()(K.caption, K[`caption__${a}`], null == i ? void 0 : i.caption),
                ...
                function eu(u = Q.n.NONE, e = uu, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Q.n.NONE)
                            return (
                ...
                const tu = 'page_heading_05',
                    ru = 'page_close_a4',
                    nu = ({ onClose: u, className: e }) => {
                        var t;
                        return (
                            (t = u),
                            eu(Q.n.ESCAPE, t),
                    ...
                    Eu = 'Heading_base_74',
                    au = ({ children: u, className: e }) => n().createElement('div', { className: h()(Eu, e) }, u);
                function iu(u, e, t) {
                    (0, r.useEffect)(() => {
                        if (!(u >= e))
                            return ((u, e) => {
                ...
                const lu = () => (u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: i, children: A, mocks: F }) {
                                const o = (0, r.useRef)([]),
                                    s = (t, r, n) => {
                                        var E;
                                        const i = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = ou(n.keys()); !(u = t()).done;) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(r),
                                    ...
                                    c = l[0],
                                    B = l[1],
                                    C = (0, r.useState)(() => s(E, i, F)),
                                    d = C[0],
                                    m = C[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        D.current ? m(s(c, i, F)) : (D.current = !0);
                                    }, [F, c, i]),
                                    (0, r.useEffect)(() => {
                                        B(E);
                                    }, [E]),
                ...
                const mu = 60,
                    ...
                    hu = 86400;
                Date.now();
                const gu = (0, r.memo)(({ datetime: u, format: e = du.SHORT_DATE, localize: t = !0 }) =>
                        ((u, e, t) => {
                            switch (e) {
                                case du.SHORT_DATE:
                                    return t
                    ...
                    wu = ({ binding: u, text: e = '', classMix: t, alignment: E = N.left }) =>
                        null === e
                            ...
                            : n().createElement(
                                  ...
                                  e.split('\n').map((e, a) =>
                                      n().createElement(
                                          'div',
                                          { className: h()(vu, t), key: `${e}-${a}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : $(u, e))))(e, E, u).map((u, e) =>
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            p = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (bu(t, c, { isMouseEvent: !0, on: !0, arguments: fu(n) }, w),
                                    _ && _(),
                ...
                const Mu = (u) => {
                    ...
                    Ou = 'ActiveSeasonState_base_55',
                    yu = 'ActiveSeasonState_calendarIcon_df',
                    Ru = 'ActiveSeasonState_divider_5b',
                    Hu = R.strings.comp7.season,
                    ku = (u, e) => ({
                        startDate: n().createElement(gu, { datetime: u, format: du.SHORT_DATE }),
                        endDate: n().createElement(gu, { datetime: e, format: du.SHORT_DATE }),
                    }),
                    Pu = (u, e, t) => {
                        const r = e - t,
                            E = ((u, e) => Su(u - e))(e, t);
                        return r >= 604800
                            ? n().createElement(wu, { text: Hu.range(), binding: ku(u, e) })
                            : r >= hu
                              ? n().createElement(wu, { text: Hu.daysLeft(), binding: E })
                              : r >= _u
                                ? n().createElement(wu, { text: Hu.hoursLeft(), binding: E })
                                : r >= mu
                                  ? n().createElement(wu, { text: Hu.minutesLeft(), binding: E })
                                  : r >= 1
                                    ? n().createElement(wu, { text: Hu.secondsLeft(), binding: E })
                                    : void 0;
                    },
                    Nu = ({
                        startTimestamp: u,
                    ...
                    Wu = (0, Y.Pi)(({ className: u, hasSeasonName: e = !0 }) => {
                        const t = Cu(),
                            r = t.model,
                            E = t.controls,
                            a = r.season.startTimestamp.get(),
                            i = r.season.endTimestamp.get(),
                            A = r.season.serverTimestamp.get();
                        return (
                            iu(A, i, E.pollServerTime),
                            n().createElement(
                                'div',
                                { className: h()(Iu, u) },
                                A < i
                ...
                const ju = lu()(
                    ...
                    Qu = 'App_text_78',
                    Ju = 'App_footer_d1',
                    ue = 'HowToGetVehicles_base_a6',
                    ee = 'HowToGetVehicles_heading_b0',
                    te = 'HowToGetVehicles_items_b6',
                    re = 'HowToGetVehicles_item_1b',
                    ...
                    Fe = ({ levelsStr: u }) =>
                        n().createElement(
                            'div',
                            { className: ue },
                            n().createElement('div', { className: ee }, I(ae.title(), { levels: u })),
                            n().createElement(
                                'div',
                                { className: te },
                                Ae.map((u) =>
                                    n().createElement(
                                        ...
                                        n().createElement('div', {
                                            className: Ee,
                                            style: { backgroundImage: `url(${ie.$dyn(u)})` },
                                        }),
                                        n().createElement('div', { className: ne }, ae.$dyn(u)),
                                    ),
                                ),
                            ),
                        ),
                    ...
                    De = (0, Y.Pi)(() => {
                        const u = Yu(),
                            ...
                            E =
                                ((a = e.vehicleLevels.get()),
                                (i = R.strings.comp7.listSeparator()),
                                a.map((u) => Vu(u.value)).join(i));
                        var a, i;
                        return n().createElement(
                            'div',
                            { className: zu },
                            ...
                            n().createElement(
                                'div',
                                { className: Ku },
                                n().createElement(au, { className: tu }, R.strings.comp7.featureName()),
                                n().createElement(Bu, { options: se }, n().createElement(Wu, null)),
                            ),
                            n().createElement(
                                'div',
                                { className: qu },
                                ...
                                n().createElement('div', { className: Qu }, I(String(oe.text.$dyn(r)), { levels: E })),
                            ),
                            n().createElement('div', { className: Ju }, n().createElement(Fe, { levelsStr: E })),
                        );
                    });
                engine.whenReady.then(() => {
                    P().render(
                        n().createElement(H, null, n().createElement($u, null, n().createElement(De, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [926], () => __webpack_require__(5339));
