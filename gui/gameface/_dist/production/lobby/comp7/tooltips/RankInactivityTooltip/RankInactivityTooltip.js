(() => {
    ...
    var u,
        A = {
            7137: (u, A, F) => {
                ...
                var e = {};
                (F.r(e), F.d(e, { getBgUrl: () => T, getTextureUrl: () => O }));
                var B = {};
                (F.r(B),
                    F.d(B, {
                        addModelObserver: () => q,
                        ...
                        return v.includes(F)
                            ...
                            : ((u, A = a.left) => {
                                  ...
                                  const E =
                                      ...
                                      D = u.replace(/&nbsp;/g, ' ');
                                  return (l(D, /( )/, A).forEach((u) => (F = F.concat(l(u, E, a.left)))), F);
                              })(u, A);
                    },
                        ...
                        null === A
                            ...
                            : t().createElement(
                                  ...
                                  A.split('\n').map((A, D) =>
                                      t().createElement(
                                          'div',
                                          { className: i()(m, F), key: `${A}-${D}` },
                                          ((u, A, F) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (F && u in F ? F[u] : f(u, A))))(A, E, u).map((u, A) =>
                            ...
                            const D = A.args,
                                e = (function (u, A) {
                                    ...
                                    var F,
                                        ...
                                        D = {},
                                        e = Object.keys(u);
                                    for (E = 0; E < e.length; E++) ((F = e[E]), A.indexOf(F) >= 0 || (D[F] = u[F]));
                                    return D;
                                })(A, j);
                            return void 0 !== D
                ...
                const cu = t().forwardRef(function (u, A) {
                    ...
                    return (
                        ...
                        t().createElement(
                            'div',
                            su({}, B, {
                                className: i()(iu.base, iu[`base__theme-${e}`], E),
                                ref: function (u) {
                ...
                var lu = F(3403);
                const du = 'tooltips_base_6b',
                    vu = 'tooltips_heading_ac',
                    fu = 'tooltips_description_85',
                    mu = 'tooltips_description__topIndent_ba',
                    gu = 'tooltips_highlight_87';
                function pu() {}
                function bu() {
                    return !1;
                }
                ...
                function hu(u, A) {
                    ...
                    if (
                        ...
                        (F = (function (u, A) {
                            if (!u) return;
                            if ('string' == typeof u) return yu(u, A);
                ...
                const _u = ((u, A) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: D, children: e, mocks: B }) {
                                const n = (0, C.useRef)([]),
                                    r = (F, E, D) => {
                                        var e;
                                        const B = (function ({
                                                ...
                                                return {
                                                    subscribe: (F, e) => {
                                                        const C = 'string' == typeof e ? `${E}.${e}` : E,
                                                            t = ru.view.addModelObserver(C, A, !0);
                                                        return (D.set(t, F), u && F(B(e)), t);
                                                    },
                                                    readByPath: B,
                                                    createCallback: (u, A) => {
                                                        const F = B(A);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = hu(D.keys()); !(u = F()).done;) e(u.value, A);
                                                    },
                                                    unsubscribe: e,
                                                };
                                            })(E),
                                            C =
                                                'real' === F
                                                    ...
                                                    : Object.assign({}, B, {
                                                          readByPath:
                                                              null != (e = null == D ? void 0 : D.getter)
                                                                  ? e
                                                                  : () => {},
                                                      }),
                                            t = (u) =>
                                                'mocks' === F ? (null == D ? void 0 : D.getter(u)) : C.readByPath(u),
                                        ...
                                        return {
                                            model: o,
                                            controls: 'mocks' === F && D ? D.controls(i) : A(i),
                                            externalModel: C,
                                            mode: F,
                                        };
                                    },
                                    ...
                                    a = i[0],
                                    s = i[1],
                                    c = (0, C.useState)(() => r(E, D, B)),
                                    l = c[0],
                                    d = c[1];
                                return (
                                    (0, C.useEffect)(() => {
                                        o.current ? d(r(a, D, B)) : (o.current = !0);
                                    }, [B, a, D]),
                                    (0, C.useEffect)(() => {
                                        s(E);
                                    }, [E]),
                                    ...
                                    t().createElement(F.Provider, { value: l }, e)
                                );
                            },
                            () => (0, C.useContext)(F),
                        ];
                    ...
                    Pu = _u[0],
                    Ou = _u[1],
                    Ru = R.strings.comp7.rankInactivityTooltip,
                    Tu = (0, lu.Pi)(() => {
                        const u = Ou().model.root.get().rankInactivityCount;
                        return t().createElement(
                            ...
                            t().createElement(
                                'div',
                                { className: du },
                                t().createElement('div', { className: vu }, Ru.heading()),
                                t().createElement('div', { className: i()(fu, mu) }, Ru.description()),
                                t().createElement(
                                    'div',
                                    { className: i()(fu, mu) },
                                    t().createElement(g, {
                                        text: Ru.timeLeft(),
                                        binding: { count: t().createElement('span', { className: gu }, u) },
                                    }),
                                ),
                            ),
                        );
    ...
    function E(u) {
        ...
        var e = (F[u] = { exports: {} });
        return (A[u](e, e.exports, E), e.exports);
    }
    ((E.m = A),
        (u = []),
        (E.O = (A, F, D, e) => {
            if (!F) {
                ...
                for (r = 0; r < u.length; r++) {
                    for (var [F, D, e] = u[r], C = !0, t = 0; t < F.length; t++)
                        (!1 & e || B >= e) && Object.keys(E.O).every((u) => E.O[u](F[t]))
                            ? F.splice(t--, 1)
                            : ((C = !1), e < B && (B = e));
                    if (C) {
                        u.splice(r--, 1);
        ...
        (() => {
            ...
            var A = (A, F) => {
                    ...
                    for (A && A(F); n < B.length; n++) ((e = B[n]), E.o(u, e) && u[e] && u[e][0](), (u[e] = 0));
                    return E.O(r);
                },
                F = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (F.forEach(A.bind(null, 0)), (F.push = A.bind(null, F.push.bind(F))));
        })());
    var D = E.O(void 0, [926], () => E(7137));
    D = E.O(D);
})();
