(() => {
    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, A) => {
                A.d(e, { kH: () => i, Z5: () => D, lf: () => o, cy: () => n, ry: () => d });
                class E {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            9801: (u, e, A) => {
                ...
                const C = (u, e, A) => {
                    ...
                    i = (u, e, A = B.left) => u.split(e).reduce(A === B.left ? C : o, []),
                    a = (() => {
                        const u = new RegExp(
                ...
                const d = (0, E.memo)(({ datetime: u, format: e = l.SHORT_DATE, localize: A = !0 }) =>
                    ...
                    v = ({ binding: u, text: e = '', classMix: A, alignment: t = B.left }) =>
                        null === e
                ...
                const g = F().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        F().createElement(
                            ...
                            F().createElement('div', { className: p.decorator }, A),
                        )
                    );
                });
                var T = A(3403);
                const O = 'tooltips_base_6b',
                    y = 'tooltips_subHeading_2c',
                    M = 'tooltips_divider_26',
                    P = 'tooltips_description_85',
                    x = 'tooltips_highlight_87';
                function k() {}
                function S() {
                    return !1;
                }
                ...
                const H = ((u, e) => {
                                    ...
                                    C = (A, E, F) => {
                                        ...
                                        const D = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = N(F.keys()); !(u = A()).done;) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(E),
                                            ...
                                            i = { mode: A, model: o, externalModel: n, cleanup: C };
                                        return {
                                            model: o,
                    ...
                    })(({ observableModel: u }) => ({ root: u.object() }), k),
                    W = H[0],
                    V = H[1],
                    ...
                    Y = (0, T.Pi)(() => {
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                F().createElement('div', { className: P }, F().createElement(v, { text: A })),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [926], () => __webpack_require__(9801));
