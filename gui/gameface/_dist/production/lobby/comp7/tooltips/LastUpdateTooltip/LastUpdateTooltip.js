(() => {
    ...
    var __webpack_modules__ = {
            ...
            8005: (u, e, A) => {
                ...
                const a = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    l = (u, e, A = i.left) => u.split(e).reduce(A === i.left ? s : c, []),
                    d = (() => {
                        const u = new RegExp(
                    ...
                    v = (u, e = i.left) => {
                        ...
                        return ((u, e = i.left) => {
                            ...
                            const E =
                                ...
                                F = a(u);
                            return l(F, /( )/, e).forEach((u) => (A = A.concat(l(u, E, i.left)))), A;
                        })(u, e);
                    };
                A(9916);
                var m = A(8613);
                Date.now();
                const h = m.Ew.getRegionalDateTime,
                    w = m.Ew.getFormattedDateTime;
                const p = (0, E.memo)(({ datetime: u, format: e = B.ShortDate, isConvertedToLocal: A = !0 }) =>
                        Object.values(B).includes(e) ? h(u, e, A) : w(u, e, A),
                    ),
                    f = 'FormatText_base_d0',
                    b = ({ binding: u, text: e = '', classMix: A, alignment: t = i.left, formatWithBrackets: D }) => {
                ...
                var k = A(3403);
                const M = 'tooltips_base_6b',
                    S = 'tooltips_subHeading_2c',
                    L = 'tooltips_divider_26',
                    N = 'tooltips_description_85',
                    U = 'tooltips_highlight_87';
                function I() {}
                function V() {
                    return !1;
                }
                ...
                const G = ((u, e) => {
                                    ...
                                    o = (A, E, F) => {
                                        ...
                                        const D = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = q(F.keys()); !(u = A()).done; ) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(E),
                    ...
                    })(({ observableModel: u }) => ({ root: u.object() }), I),
                    K = G[0],
                    H = G[1],
                    Y = 'App_formattedText_81',
                    Z = (0, k.Pi)(() => {
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                { className: M },
                                F().createElement(b, {
                                    text: R.strings.comp7.lastUpdateNote.tooltip.info(),
                                    binding: {
                                        date: F().createElement(
                                            'span',
                                            { className: U },
                                            F().createElement(p, { datetime: e, format: B.ShortTime }),
                                        ),
                                    },
                                    classMix: r()(S, Y),
                                }),
                                F().createElement('div', { className: L }),
                                F().createElement('div', { className: N }, F().createElement(b, { text: A })),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    D().render(F().createElement(K, null, F().createElement(Z, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [926], () => __webpack_require__(8005));
