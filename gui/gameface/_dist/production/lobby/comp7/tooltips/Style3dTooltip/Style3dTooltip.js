    ...
    var u,
        A = {
            8340: (u, A, F) => {
                ...
                const au = tu().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        tu().createElement(
                            'div',
                            iu({}, B, {
                                className: t()(ru.base, ru[`base__theme-${D}`], E),
                                ref: function (u) {
                                    (n.current = u), 'function' == typeof A ? A(u) : A && (A.current = u);
                                },
                            }),
                            tu().createElement('div', { className: ru.decorator }, F),
                        )
                    );
                });
                var su = F(493),
                ...
                const mu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    pu = (u, A, F = du.left) => u.split(A).reduce(F === du.left ? fu : gu, []),
                    bu = (() => {
                        const u = new RegExp(
                    ...
                    hu = (u, A = du.left) => {
                        ...
                        return ((u, A = du.left) => {
                            ...
                            const E =
                                ...
                                e = mu(u);
                            return pu(e, /( )/, A).forEach((u) => (F = F.concat(pu(u, E, du.left)))), F;
                        })(u, A);
                    },
                    yu = 'FormatText_base_d0',
                    xu = ({ binding: u, text: A = '', classMix: F, alignment: E = du.left, formatWithBrackets: e }) => {
                        if (null === A) return console.error("FormatText was supplied with 'null'"), null;
                        const D = e && u ? vu(A, u) : A;
                        return tu().createElement(
                            ...
                            D.split('\n').map((A, e) =>
                                tu().createElement(
                                    'div',
                                    { className: t()(yu, F), key: `${A}-${e}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : hu(u, A))))(
                                        A,
                                        E,
                                        u,
                                    ).map((u, A) => tu().createElement(Cu.Fragment, { key: `${A}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                var _u = F(3403);
                const Pu = 'tooltips_divider_26';
                function Ru() {}
                function Su() {
                    return !1;
                }
                ...
                function Ou(u, A) {
                    ...
                    if (
                        ...
                        (F = (function (u, A) {
                            if (u) {
                                if ('string' == typeof u) return zu(u, A);
                ...
                const Mu = ((u, A) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: e, children: D, mocks: B }) {
                                const C = (0, Cu.useRef)([]),
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            t = Bu.view.addModelObserver(C, A, !0);
                                    ...
                                    o = r[0],
                                    i = r[1],
                                    a = (0, Cu.useState)(() => t(E, e, B)),
                                    s = a[0],
                                    l = a[1];
                                return (
                                    (0, Cu.useEffect)(() => {
                                        n.current ? l(t(o, e, B)) : (n.current = !0);
                                    }, [B, o, e]),
                                    (0, Cu.useEffect)(() => {
                                        i(E);
                                    }, [E]),
                                    (0, Cu.useEffect)(
                                        () => () => {
                                            s.externalModel.dispose(), C.current.forEach((u) => u());
                                        },
                                        [s],
                                    ),
                                    tu().createElement(F.Provider, { value: s }, D)
                                );
                            },
                            () => (0, Cu.useContext)(F),
                        ];
                    ...
                    Lu = 'App_image_a5',
                    Vu = 'App_section_73',
                    Gu = 'App_section__bg_09',
                    Iu = 'App_section__bottom_45',
                    Hu = 'App_divider_15',
                    Uu = 'App_divider__top_36',
                    qu = 'App_title_e8',
                    Wu = 'App_text_94',
                    Qu = 'App_subtitle_ba',
                    Zu = 'App_howToReceive_05',
                    Ju = 'App_paragraph_f4',
                    Ku = R.strings.comp7.style3dTooltip,
                    Xu = R.images.gui.maps.icons.comp7.rewards,
                    Yu = (0, _u.Pi)(() => {
                        const u = Nu().model.root.get(),
                            A = u.styleId,
                            F = u.vehicles;
                        return tu().createElement(
                            'div',
                            ...
                            tu().createElement(
                                'div',
                                { className: Vu },
                                tu().createElement(xu, { text: String(Ku.$num(A)), classMix: qu }),
                            ),
                            tu().createElement('div', {
                                className: Lu,
                                style: { backgroundImage: `url(${Xu.$dyn(`style3d_${A}`)})` },
                            }),
                            tu().createElement(
                                'div',
                                { className: Vu },
                                tu().createElement('div', { className: Ju }, Ku.description()),
                                tu().createElement('div', { className: t()(Qu, Zu) }, Ku.howToReceive()),
                                tu().createElement('div', { className: Ju }, Ku.secondaryDescription.$num(A)),
                            ),
                            tu().createElement(
                                'div',
                                { className: t()(Vu, Gu, Iu) },
                                tu().createElement('div', { className: t()(Pu, Hu, Uu) }),
                                tu().createElement('div', { className: Qu }, Ku.suitableVehicles()),
                                tu().createElement('div', { className: Wu }, F),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    lu().render(
                        tu().createElement(ku, null, tu().createElement(au, null, tu().createElement(Yu, null))),
