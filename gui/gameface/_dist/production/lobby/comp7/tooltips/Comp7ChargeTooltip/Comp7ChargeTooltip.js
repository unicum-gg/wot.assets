        ...
        e = {
            ...
            2452: (u, e, t) => {
                ...
                const yu = (u, e, t) => {
                    ...
                    Tu = (u, e, t = Ru.left) => u.split(e).reduce(t === Ru.left ? yu : Hu, []),
                    Ou = (() => {
                        const u = new RegExp(
                        ...
                        return Pu.includes(t)
                            ...
                            : ((u, e = Ru.left) => {
                                  ...
                                  const A =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (Tu(E, /( )/, e).forEach((u) => (t = t.concat(Tu(u, A, Ru.left)))), t);
                              })(u, e);
                    },
                ...
                var Ee = t(3403);
                const Fe = 'App_base_92',
                    re = 'App_list_b8',
                    De = 'App_dot_15',
                    ae = 'App_imageWrapper_cd',
                    ne = 'App_divider_14',
                    Be = 'App_description_6c',
                    ie = R.strings.comp7.skillCharge,
                    Ce = R.images.comp7.gui.maps.icons.comp7.icons.charge_tooltip(),
                    le = (0, Ee.Pi)(() =>
                        a().createElement(
                            Ae,
                            null,
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { className: ae },
                                    a().createElement('img', { src: Ce, alt: '' }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: Be },
                                    a().createElement('div', { className: ne }),
                                    a().createElement(Zu, { text: ie.description() }),
                                    a().createElement('div', { className: ne }),
                                ),
                                a().createElement(
                                    'div',
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(Zu, { text: ie.condition.level() }),
                                    ),
                                    a().createElement(
                                        'div',
                                        null,
                                        a().createElement('div', { className: De }),
                                        a().createElement(Zu, { text: ie.condition.activation() }),
                                    ),
                                    a().createElement(
                                        'div',
                                        null,
                                        a().createElement('div', { className: De }),
                                        a().createElement(Zu, { text: ie.condition.charge() }),
                                    ),
                                ),
                            ),
                        ),
                ...
                engine.whenReady.then(() => {
                    B().render(
                        a().createElement(_e, null, a().createElement(le, null)),
