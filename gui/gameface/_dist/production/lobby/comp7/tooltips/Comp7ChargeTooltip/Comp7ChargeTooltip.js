        ...
        e = {
            ...
            2452: (u, e, t) => {
                ...
                const gu = () => {
                    ...
                    _u = ['xl', 'lg', 'md', 'sm', 'xs'],
                    hu = (u) => u.includes('_') && ((u) => _u.includes(u))(u.split('_').at(-1)),
                    ...
                    pu = (u, e) =>
                        Object.keys(u).reduce((t, A) => {
                            ...
                            return (
                                void 0 === E ||
                                    ((u, e) => _u.some((t) => void 0 !== e[`${u}_${t}`]))(A, u) ||
                                    (t[A] = E),
                                t
                            );
                        }, {}),
                ...
                const wu = {
                    ...
                    Ru = fu((u) => {
                        ...
                        return a().createElement('div', Su({ className: C()(vu.base, ...I, e), style: X }, G), N);
                    });
                let yu;
                !(function (u) {
                ...
                const Hu = (u, e, t) => {
                    ...
                    Ou = (u, e, t = yu.left) => u.split(e).reduce(t === yu.left ? Hu : Tu, []),
                    Pu = (() => {
                        const u = new RegExp(
                        ...
                        return Wu.includes(t)
                            ...
                            : ((u, e = yu.left) => {
                                  ...
                                  const A =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (Ou(E, /( )/, e).forEach((u) => (t = t.concat(Ou(u, A, yu.left)))), t);
                              })(u, e);
                    },
                    Gu = 'FormatText_base_d0',
                    ju = ({ binding: u, text: e = '', classMix: t, alignment: A = yu.left }) =>
                        null === e
                ...
                const Uu = Object.keys(Iu()),
                    ...
                    Ju = fu((u) => {
                        ...
                        return a().createElement(
                            ...
                            Vu(
                                {
                                    className: C()(zu.base, t && zu[t], x, A),
                                    style: h,
                            ...
                            void 0 !== d ? a().createElement(ju, Vu({}, d, { text: e })) : e,
                        );
                    });
                function ue() {
                ...
                const Ee = a().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            Ae({}, r, {
                                className: C()(ee.base, ee[`base__theme-${F}`], A),
                                ref: function (u) {
                ...
                var Fe = t(3403);
                const re = 'App_base_92',
                    De = 'App_list_b8',
                    ae = 'App_dot_15',
                    ne = 'App_imageWrapper_cd',
                    Be = 'App_divider_14',
                    ie = 'App_description_6c',
                    Ce = R.strings.comp7.skillCharge,
                    le = R.images.comp7.gui.maps.icons.comp7.icons.charge_tooltip(),
                    oe = (0, Fe.Pi)(() =>
                        a().createElement(
                            Ee,
                            null,
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { className: ne },
                                    a().createElement('img', { src: le, alt: '' }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: ie },
                                    a().createElement('div', { className: Be }),
                                    a().createElement(Ju, { text: Ce.description() }),
                                    a().createElement('div', { className: Be }),
                                ),
                                a().createElement(
                                    'div',
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(Ju, { text: Ce.condition.level() }),
                                    ),
                                    a().createElement(
                                        'div',
                                        null,
                                        a().createElement('div', { className: ae }),
                                        a().createElement(Ju, { text: Ce.condition.activation() }),
                                    ),
                                    a().createElement(
                                        'div',
                                        null,
                                        a().createElement('div', { className: ae }),
                                        a().createElement(Ju, { text: Ce.condition.charge() }),
                                    ),
                                ),
                            ),
                        ),
                ...
                engine.whenReady.then(() => {
                    B().render(
                        a().createElement(he, null, a().createElement(oe, null)),
