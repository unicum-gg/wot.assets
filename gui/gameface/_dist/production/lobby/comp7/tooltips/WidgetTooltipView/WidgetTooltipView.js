(() => {
    ...
    var __webpack_modules__ = {
            ...
            3866: (u, e, E) => {
                ...
                const i = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    c = (u, e, E = a.left) => u.split(e).reduce(E === a.left ? C : s, []),
                    l = (() => {
                        const u = new RegExp(
                    ...
                    _ = (u, e = a.left) => {
                        ...
                        return ((u, e = a.left) => {
                            ...
                            const A =
                                ...
                                F = i(u);
                            return (c(F, /( )/, e).forEach((u) => (E = E.concat(c(u, A, a.left)))), E);
                        })(u, e);
                    },
                    m = 'FormatText_base_d0',
                    v = ({ binding: u, text: e = '', classMix: E, alignment: t = a.left, formatWithBrackets: n }) => {
                ...
                const f = F().forwardRef(function (u, e) {
                    let E = u.children,
                        t = u.className,
                        n = u.theme,
                ...
                let y;
                !(function (u) {
                    ((u.COMPLETED = 'completed'), (u.IN_PROGRESS = 'inProgress'));
                })(y || (y = {}));
                var O = E(3403);
                function T() {}
                function x() {
                ...
                function k(u, e) {
                    ...
                    if (
                        ...
                        (E = (function (u, e) {
                            ...
                            if ('Arguments' === E || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(E)) return S(u, e);
                        })(u)) ||
                ...
                var j = E(3946);
                const V = R.strings.comp7.mainWidgetTooltip,
                    W = ((u, e) => {
                        ...
                        return [
                            function ({ mode: t = 'real', options: n, children: D, mocks: r }) {
                                                ...
                                                return {
                                                    subscribe: (E, t) => {
                                                        const D = 'string' == typeof t ? `${A}.${t}` : A,
                                                            r = p.O.view.addModelObserver(D, e, !0);
                                ...
                                return (
                                    (0, A.useEffect)(() => {
                                        o.current ? d(a(C, n, r)) : (o.current = !0);
                                    }, [r, C, n]),
                                    (0, A.useEffect)(() => {
                                        s(t);
                                    }, [t]),
                        ...
                        const e = Object.assign({}, u.primitives(['progressionState', 'time'])),
                            E = (0, j.Om)(() => {
                                const u = e.time.get();
                                return u >= U
                                    ? {
                                          text: V.eventEnds(),
                                          time: o(R.strings.common.duration.days(), { days: Math.trunc(u / U) }),
                                      }
                                    : u >= I
                                      ? {
                                            text: V.eventEnds(),
                                            time: o(R.strings.common.duration.hours(), { hours: Math.trunc(u / I) }),
                                        }
                                      : {
                                            text: V.eventEnds(),
                                            time: o(R.strings.common.duration.minutes(), {
                                                minutes: Math.trunc(u / N) || 1,
                                            }),
                                        };
                            });
                        return Object.assign({}, e, { computes: { battleLeaveTime: E } });
                    }, T),
                    q = W[0],
                    z = W[1],
                    G = {
                        base: 'App_base_d6',
                        heading: 'App_heading_03',
                        header: 'App_header_dd',
                        base__completed: 'App_base__completed_6f',
                        completedIcon: 'App_completedIcon_80',
                        description: 'App_description_19',
                        subtitle: 'App_subtitle_b4',
                        title: 'App_title_53',
                        text: 'App_text_ea',
                    },
                    K = R.strings.comp7.mainWidgetTooltip,
                    H = [
                        [
                            { points: 5, place: K.top.c_0() },
                            { points: 3, place: K.top.c_1() },
                            { points: 1, place: K.top.c_2() },
                        ],
                        [
                            { place: K.top.c_0(), points: 3 },
                            { place: K.top.c_1(), points: 1 },
                            { place: K.top.c_2(), points: 0 },
                        ],
                    ],
                    Y = [{ name: K.column.c_1() }, { name: K.column.c_2() }],
                    Z = 'Column_base_0a',
                    $ = 'Column_base__first_77',
                    X = 'Column_battleType_fd',
                    Q = 'Column_cell_15',
                    J = 'Column_separator_9f',
                    uu = 'Column_row_a1',
                    eu = 'Column_pointContainer_ac',
                    Eu = 'Column_point_2a',
                    Au = 'Column_place_70',
                    Fu = 'Column_reward_9c',
                    tu = ({ index: u, battleMode: e }) => {
                        const E = 0 === u;
                        return F().createElement(
                            'div',
                            { className: r()(Z, E && $) },
                            F().createElement('div', { className: J }),
                            F().createElement('div', { className: X }, Y[u].name),
                            e.map(({ place: u, points: e }, A) =>
                                F().createElement(
                                    'div',
                                    { key: A, className: Q },
                                    F().createElement('div', { className: J }),
                                    F().createElement(
                                        'div',
                                        { className: uu },
                                        E && F().createElement('div', { className: Au }, u),
                                        e &&
                                            F().createElement(
                                                'div',
                                                { className: eu },
                                                F().createElement('div', { className: Eu }, e),
                                                F().createElement('div', { className: Fu }),
                                            ),
                                    ),
                                ),
                            ),
                    ...
                    Bu = () =>
                        F().createElement(
                            ...
                            F().createElement(
                                ...
                                ((u, e) => {
                                    const E = [];
                                    for (let A = 0; A < u; A++) E.push(e(A));
                                    return E;
                                })(H.length, (u) => F().createElement(tu, { key: u, battleMode: H[u], index: u })),
                            ),
                        ),
                    au = R.strings.comp7.mainWidgetTooltip,
                    ou = (0, O.Pi)(() => {
                        const u = z().model,
                            e = u.progressionState.get(),
                            E = u.computes.battleLeaveTime(),
                            A = E.time,
                            t = E.text;
                        return F().createElement(
                            f,
                            ...
                            F().createElement(
                                ...
                                F().createElement(
                                    ...
                                    F().createElement(
                                        'div',
                                        { className: G.header },
                                        F().createElement('div', { className: G.completedIcon }),
                                        F().createElement('div', { className: G.title }, au.featureName()),
                                        F().createElement(v, { text: t, binding: { value: A }, classMix: G.text }),
                                    ),
                                    F().createElement(
                                        'div',
                                        { className: G.description },
                                        F().createElement('div', { className: G.subtitle }, au.descriptionHeader()),
                                        F().createElement('div', { className: G.text }, au.description.$dyn(e)),
                                    ),
                                ),
                                e === y.IN_PROGRESS && F().createElement(Bu, null),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    n().render(
                        F().createElement(q, null, F().createElement(ou, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [926], () => __webpack_require__(3866));
