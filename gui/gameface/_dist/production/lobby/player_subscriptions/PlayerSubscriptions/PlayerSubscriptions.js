(() => {
    var __webpack_modules__ = {
                        ...
                        ((0, n.useEffect)(() => h(C)),
                            ...
                            (0, n.useEffect)(() => {
                                ...
                                const e = (e) => {
                                    ...
                                    t = () => {
                                        (window.removeEventListener('mousemove', e), u.handleIsThumbDragging(!1), D($));
                                    };
                                return (
            ...
            59: (u, e, t) => {
                ...
                g.defaultProps = { type: B.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const p = (0, i.memo)(g),
                    h = {
                ...
                const S = 'Countdown_base_fe',
                    ...
                    O = (0, i.memo)(
                        ({
                            ...
                            const m = r !== f.Description ? 1 : void 0,
                                D = (0, l.au)(u, m),
                                d = (() => {
                            ...
                            return a().createElement(
                                ...
                                t !== v.None &&
                                    a().createElement('div', {
                                        className: n()(T, A.icon),
                                        style: { backgroundImage: `url('${L(t, d)}')` },
                                    }),
                                _
                                    ? a().createElement(
                                          'div',
                                          { className: n()(x, A.text) },
                                          a().createElement(c, { text: _, binding: { timerText: B } }),
                                      )
                                    : a().createElement('div', { className: n()(x, A.text) }, B),
                            );
                        },
                    ),
                    H = ({ refreshTime: u }) => {
                        ...
                        let e = u.className,
                            ...
                            w =
                                void 0 === f
                                    ...
                                    : f,
                            S = u.alignItems,
                            T = void 0 === S ? (g ? 'flex-start' : p && 'center') || (h && 'flex-end') || void 0 : S,
                            x = u.alignSelf,
                            M = u.wrap,
                            y = u.flexWrap,
                                ...
                                C === A.WotSubscription &&
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(
                                            ...
                                            a().createElement(
                                                'span',
                                                { className: Au[g].accentClassName },
                                                _u[T].status,
                                            ),
                                            ' ',
                                            a().createElement(c, {
