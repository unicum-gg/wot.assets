(() => {
    ...
    var __webpack_modules__ = {
            ...
            1220: (u, e, t) => {
                ...
                const c = a().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            E({}, F, {
                                className: r()(s.base, s[`base__theme-${A}`], n),
                                ref: function (u) {
                        ...
                        const b = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, i.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (_(t, d, { isMouseEvent: !0, on: !0, arguments: B(n) }, w),
                                    v && v(),
                            ...
                            f(
                                {
                                    contentId:
                                        ...
                                        c ? g.SimpleTooltipHtmlContent('resId') : g.SimpleTooltipContent('resId')),
                ...
                const y = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const r = e.contentId;
                    return r ? a().createElement(C, w({}, e, { contentId: r }), n) : a().createElement(m, e, n);
                };
                var T = t(8045);
                const k = {
                ...
                const P = { [L.NBSP]: x.NoBreakSymbol, [L.ZWNBSP]: x.NoBreakSymbol, [L.NEW_LINE]: x.LineBreak },
                    ...
                    I = 'renderers_word_f3',
                    j = (u) => ({ color: `#${u}` }),
                    W = ({ elementList: u, textBlock: e, key: t }) => {
                        const n = e.colorTag;
                        return n
                            ? N[n]
                                ? a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: r()(I, N[n]) },
                                      u,
                                  )
                                : a().createElement(
                                      'span',
                            ...
                            : a().createElement('span', { key: t, 'data-block-type': e.blockType, className: I }, u);
                    },
                    V = {
                        [x.Word]: W,
                        [x.NoBreakSymbol]: W,
                    ...
                    J = (u, e, t, n, r, o) => {
                        ...
                        for (let l = t; l >= 0; l--) {
                            ...
                            if (E === x.LineBreak || E === x.NewLine || E === x.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const F = c.slice(0, c.length - A) + o,
                                    d = e[l];
                                ((s = a().cloneElement(d, d.props, F)), (i = l));
                                break;
                            }
                            {
                                const u = t.children,
                                    E = e[l],
                                    A = E.props.children,
                                    F = J(u, A, u.length - 1, n, r, o),
                                    d = F[0],
                                    D = F[1];
                                if (!(d < 0)) {
                                    const u = A.slice(0, d);
                                    ((s = a().cloneElement(E, E.props, u, D)), (i = l));
                                    break;
                                }
                                r -= c.length;
                            }
                    ...
                    uu = a().memo(
                        ({
                            ...
                            customTooltipArgs: l,
                            targetId: E,
                            justifyContent: c = S.FlexStart,
                            alignContent: A = S.FlexStart,
                            truncateIdentify: F = '...',
                        }) => {
                            const d = (0, i.useRef)(null),
                                ...
                                _ = B[0],
                                C = B[1],
                                p = (0, i.useMemo)(() => Y(u, n, { justifyContent: c }), [n, c, u]),
                                h = (0, i.useMemo)(() => {
                                    if (
                                        o &&
                                        _.isTruncated &&
                                ...
                                v = (0, i.useMemo)(() => ({ justifyContent: c, alignContent: A }), [A, c]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                a().createElement(
                                    'div',
                                    {
                                        className: r()(
                                            ...
                                            e,
                                            k.base__zeroPadding,
                                            s && k.base__isTruncationAvailable,
                                        ),
                                        style: v,
                                    },
                                    a().createElement('div', { className: k.unTruncated, ref: d }, p),
                                    a().createElement(
                                        y,
                                        {
                                            tooltipArgs: h,
                                        ...
                                        a().createElement(
                                            'div',
                                            {
                                                className: r()(
                                                    k.truncated,
                                                    !_.isTruncateFinished && s && k.truncated__hide,
                                                ),
                                                style: v,
                                            },
                ...
                const su = ((u, e) => {
                                ...
                                const l = (0, i.useRef)([]),
                                    E = (u, t, n) => {
                                        ...
                                        const i = (function ({
                                            ...
                                            c = (({ observableModel: u }) => {
                                                const e = {
                                                        root: u.primitives(['stat']),
                                                        detailedStats: u.array('detailedStats', []),
                                                    },
                                                    t = (0, au.Om)(() => e.detailedStats.get(), { equals: nu }),
                                                    n = (0, au.Om)(() => t().length);
                                                return Object.assign({}, e, {
                                                    computes: { getDetailedStats: t, getDetailedStatsLength: n },
                                                });
                                            })({
                                                mode: u,
                                                readByPath: s,
                                            ...
                                            A = { mode: u, model: c, externalModel: a, cleanup: E };
                                        return {
                                            model: c,
                                    ...
                                    F = A[0],
                                    d = A[1],
                                    D = (0, i.useState)(() => E(u, n, s)),
                                    B = D[0],
                                    _ = D[1];
                                return (
                                    (0, i.useEffect)(() => {
                                        c.current ? _(E(F, n, s)) : (c.current = !0);
                                    }, [s, F, n]),
                                    (0, i.useEffect)(() => {
                                        d(u);
                                    }, [u]),
                                    ...
                                    a().createElement(t.Provider, { value: B }, r)
                                );
                            },
                            () => (0, i.useContext)(t),
                        ];
                    ...
                    Eu = su[1],
                    cu = {
                        base: 'BattleResultStatTooltipApp_base_11',
                        base__missions: 'BattleResultStatTooltipApp_base__missions_61',
                        header: 'BattleResultStatTooltipApp_header_03',
                        heading: 'BattleResultStatTooltipApp_heading_e8',
                        heading__missions: 'BattleResultStatTooltipApp_heading__missions_79',
                        icon: 'BattleResultStatTooltipApp_icon_d9',
                        icon__missions: 'BattleResultStatTooltipApp_icon__missions_51',
                        info: 'BattleResultStatTooltipApp_info_5a',
                        divider: 'BattleResultStatTooltipApp_divider_51',
                        detailedStat: 'BattleResultStatTooltipApp_detailedStat_2f',
                        detailed: 'BattleResultStatTooltipApp_detailed_a8',
                        value: 'BattleResultStatTooltipApp_value_1f',
                        values: 'BattleResultStatTooltipApp_values_4c',
                    },
                    Au = 'info',
                    Fu = (0, eu.Pi)(() => {
                        const u = Eu().model,
                            e = u.root.stat.get(),
                            t = u.computes.getDetailedStatsLength(),
                            n = u.computes.getDetailedStats(),
                            o = R.strings.sm_lobby.tooltips.battleResultStat.$dyn(e);
                        return a().createElement(
                            'div',
                            { className: r()(cu.base, cu[`base__${e}`]) },
                            a().createElement(
                                'div',
                                { className: cu.header },
                                a().createElement('div', {
                                    className: r()(cu.icon, cu[`icon__${e}`]),
                                    style: {
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: r()(cu.heading, cu[`heading__${e}`]) },
                                        o.$dyn('header'),
                                    ),
                                    e === tu.MISSIONS && a().createElement(uu, { text: o.$dyn(Au), classMix: cu.info }),
                                ),
                            ),
                            e !== tu.MISSIONS && a().createElement(uu, { classMix: cu.info, text: o.$dyn(Au) }),
                            Boolean(t) &&
                                a().createElement(
                                    'div',
                                    null,
                                    a().createElement('div', { className: cu.divider }),
                                    a().createElement(
                                        'div',
                                        { className: cu.detailed },
                                        ((i = n),
                                        (s = ({ value: u, text: e }, t) =>
                                            a().createElement(
                                                'div',
                                                { key: `${t}_${u}`, className: cu.values },
                                                a().createElement(
                                                    'div',
                                                    { className: cu.value },
                                                    ((u) => {
                                                        const e = Math.floor(u);
                                                        return d.Z5.getNumberFormat(e, d.B3.INTEGRAL);
                                                    })(u),
                                                ),
                                                a().createElement(uu, { text: e, classMix: cu.detailedStat }),
                                            )),
                                        Array.isArray(i)
                                            ? i.map(s)
                                            : i.map((u, e, t) => s(null == u ? void 0 : u.value, e))),
                                    ),
                                ),
                        );
                        var i, s;
                ...
                engine.whenReady.then(() => {
                    F().render(
                        a().createElement(lu, null, a().createElement(c, null, a().createElement(Fu, null))),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/BattleResultStatTooltip/BattleResultStatTooltip'),
        (() => {
            var u = { 'lobby/BattleResultStatTooltip/BattleResultStatTooltip': 0 };
