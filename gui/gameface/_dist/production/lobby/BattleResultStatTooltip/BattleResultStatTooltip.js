(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => l, off: () => s, on: () => a, onResize: () => o, onScaleUpdated: () => i });
                var n = t(2472),
                    r = t(1176);
            ...
            1220: (u, e, t) => {
                ...
                const y = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const r = e.contentId;
                    return r ? a().createElement(C, w({}, e, { contentId: r }), n) : a().createElement(v, e, n);
                };
                var T = t(8045);
                const k = {
                ...
                const P = { [L.NBSP]: x.NoBreakSymbol, [L.ZWNBSP]: x.NoBreakSymbol, [L.NEW_LINE]: x.LineBreak },
                    ...
                    K = (u, e = '', t) => {
                        ...
                        return (
                            z(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    n.push({ blockType: x.Word, colorTag: e, childList: G(u, t) });
                                },
                                (u) => {
                                    const t = u[0],
                                        r = P[t.charAt(0)];
                    ...
                    J = (u, e, t, n, r, o) => {
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            if (l === x.LineBreak || l === x.NewLine || l === x.Binding) continue;
                            ...
                            }
                            {
                                ...
                                if (!(d < 0)) {
                                    const u = A.slice(0, d);
                                    (s = a().cloneElement(l, l.props, u, D)), (i = E);
                                    break;
                                }
                                r -= c.length;
                            }
                    ...
                    uu = a().memo(
                        ({
                            ...
                            const d = (0, i.useRef)(null),
                                ...
                                _ = B[0],
                                C = B[1],
                                p = (0, i.useMemo)(() => $(u, n, { justifyContent: c }), [n, c, u]),
                                h = (0, i.useMemo)(() => {
                                    if (
                                        o &&
                                        _.isTruncated &&
                                ...
                                m = (0, i.useMemo)(() => ({ justifyContent: c, alignContent: A }), [A, c]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                const E = (0, i.useRef)([]),
                                    l = (u, t, n) => {
                                        ...
                                        const i = (function ({
                                            ...
                                            A = { mode: u, model: c, externalModel: a, cleanup: l };
                                        return {
                                            model: c,
                                    ...
                                    F = A[0],
                                    d = A[1],
                                    D = (0, i.useState)(() => l(u, n, s)),
                                    B = D[0],
                                    _ = D[1];
                                return (
                                    (0, i.useEffect)(() => {
                                        c.current ? _(l(F, n, s)) : (c.current = !0);
                                    }, [s, F, n]),
                                    (0, i.useEffect)(() => {
                                        d(u);
                                    }, [u]),
                ...
                engine.whenReady.then(() => {
                    F().render(
                        a().createElement(Eu, null, a().createElement(c, null, a().createElement(Fu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1220));
