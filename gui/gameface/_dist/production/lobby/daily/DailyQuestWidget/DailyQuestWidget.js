(() => {
                ...
                const ut = {
                    ...
                    lt = (0, r.memo)(
                        ({
                            ...
                            ((0, r.useEffect)(() => {
                                ...
                                (0, r.useEffect)(() => {
                                    M && j && V(R.sounds.dq_screen_quest_complete());
                                }, [M, j]));
                            const z = (u, e) => {
                                    O.run(() => {
                                        X(u);
                                ...
                                X = (r) => {
                                    ...
                                    switch (r) {
                                        ...
                                        case Y.Disappear:
                                            return (m(!1), p(!1), c((u) => u + 1), void X(Y.Appear));
                                    }
                                };
                    ...
                    _t = (0, K.Pi)(() => {
                        const u = du(),
                            ...
                            d = (0, r.useCallback)(() => {
                                (V(R.sounds.yes1()), t.onPlayStreakClick());
                            }, [t]),
                            F = (0, r.useCallback)(() => {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [272], () => __webpack_require__(2841));
