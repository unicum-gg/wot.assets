(() => {
    var __webpack_modules__ = {
            ...
            7066: (u, e, t) => {
                ...
                const F = E.O.client.getSize('rem'),
                    s = F.width,
                    l = F.height,
                    D = Object.assign({ width: s, height: l }, o(s, l, i)),
                ...
                const nu = (u, e, t) => {
                    ...
                    iu = (u, e, t = au.left) => u.split(e).reduce(t === au.left ? nu : Eu, []),
                    Au = (() => {
                        const u = new RegExp(
                        ...
                        return ou.includes(t)
                            ...
                            : ((u, e = au.left) => {
                                  ...
                                  const r =
                                      ...
                                      a = u.replace(/&nbsp;/g, ' ');
                                  return (iu(a, /( )/, e).forEach((u) => (t = t.concat(iu(u, r, au.left)))), t);
                              })(u, e);
                    },
                    su = 'FormatText_base_d0',
                    lu = ({ binding: u, text: e = '', classMix: t, alignment: n = au.left }) =>
                        null === e
                            ...
                            Cu(
                                {
                                    ...
                                    mr: !0 === s ? bu[t || 'paragraph-P16'].mr : s,
                                    mb: !0 === D ? bu[t || 'paragraph-P16'].mb : D,
                                    ml: !0 === B ? bu[t || 'paragraph-P16'].ml : B,
                                },
                                m,
                            ),
                            void 0 !== C ? a().createElement(lu, Cu({}, C, { text: e })) : e,
                        );
                    }),
                    fu = {
                ...
                class Su extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = h()(fu.base, fu[`base__${E}`], fu[`base__${n}`], null == i ? void 0 : i.base),
                            _ = h()(fu.icon, fu[`icon__${E}`], fu[`icon__${n}`], null == i ? void 0 : i.icon),
                            B = h()(fu.glow, null == i ? void 0 : i.glow),
                            c = h()(fu.caption, fu[`caption__${E}`], null == i ? void 0 : i.caption),
                            C = h()(fu.goto, null == i ? void 0 : i.goto);
                        return a().createElement(
                            'div',
                            Mu(
                                {
                ...
                function Ou(u = Lu.n.NONE, e = Tu, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Lu.n.NONE)
                            return (
                ...
                const yu = {
                    ...
                    ku = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Pu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Nu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((A = A.replace(t, `%(${i})`)),
                                    (E[i] = yu[u]
                                        ? a().createElement(
                                              'span',
                                              { className: yu[u] },
                                              a().createElement(lu, { text: s, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: n(u) },
                        ...
                        return a().createElement(lu, { text: A, classMix: t, binding: E });
                    });
                function Wu() {
                    return !1;
                }
                ...
                const Xu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: i, children: A, mocks: o }) {
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? m(s(_, i, o)) : (l.current = !0);
                                    }, [o, _, i]),
                                    (0, r.useEffect)(() => {
                                        B(n);
                                    }, [n]),
                        ...
                        return (
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { className: Yu },
                                    n && a().createElement('div', { className: Zu }),
                                    a().createElement(vu, { text: ae.title(), className: Qu }),
                                    a().createElement(
                                        'div',
                                        { className: ue },
                                        n
                                            ? a().createElement(Nu, { classMix: Ju, text: ae.subtitle_alert() })
                                            : a().createElement(vu, {
                                                  text: A ? ae.subtitlePremium() : ae.subtitle(),
                                                  className: Ju,
                                              }),
                                    ),
                                    a().createElement(vu, {
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(
                                            j,
                                            { mixClass: re, type: I.primary, size: G.medium, onClick: o },
                                            a().createElement(vu, { text: ae.replace() }),
                                        ),
                                        a().createElement(
                                            j,
                                            { mixClass: re, type: I.secondary, size: G.medium, onClick: e.onClose },
                                            a().createElement(vu, { text: ae.cancel() }),
                                        ),
                                    ),
                                ),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [272], () => __webpack_require__(7066));
