(() => {
    var __webpack_modules__ = {
            ...
            4422: (u, e, t) => {
                ...
                const M = {
                    ...
                    O = (u) => {
                        ...
                        const n = x(),
                            ...
                            A = n.mediaHeight,
                            i = n.mediaSize;
                        return a().createElement('div', S({ className: h()(t, M[E], L[A], T[i]) }, r), e);
                    },
                    y = ['children'];
                const H = (u) => {
                    let e = u.children,
                ...
                const uu = {
                    ...
                    ru = Y((u) => {
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, n, i, o, D, _, P, k, M, m, O, x, S]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return a().createElement('div', J({ className: h()(Q.base, ...U, e), style: G }, I), N);
                    });
                let au;
                !(function (u) {
                ...
                class Mu extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()(xu.base, xu[`base__${E}`], xu[`base__${n}`], null == A ? void 0 : A.base),
                            _ = h()(xu.icon, xu[`icon__${E}`], xu[`icon__${n}`], null == A ? void 0 : A.icon),
                            B = h()(xu.glow, null == A ? void 0 : A.glow),
                            c = h()(xu.caption, xu[`caption__${E}`], null == A ? void 0 : A.caption),
                            C = h()(xu.goto, null == A ? void 0 : A.goto);
                        return a().createElement(
                            'div',
                            Su(
                                {
                            ...
                            'info' !== E && a().createElement('div', { className: xu.shine }),
                ...
                const Iu = ((u, e) => {
                                    ...
                                    s = (t, r, a) => {
                                        ...
                                        const A = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = ku(a.keys()); !(u = t()).done; ) n(u.value, e);
                                                    },
                                                    unsubscribe: n,
                                                };
                                            })(r),
                    ...
                    Uu = {
                        base: 'App_base_6c',
                        fadeIn: 'App_fadeIn_41',
                        base__hide: 'App_base__hide_ad',
                        fadeOut: 'App_fadeOut_cb',
                        background: 'App_background_54',
                        wrapper: 'App_wrapper_7e',
                        container: 'App_container_5f',
                        close: 'App_close_dc',
                        header: 'App_header_08',
                        title: 'App_title_06',
                        subtitle: 'App_subtitle_9f',
                        content: 'App_content_77',
                        contentContainer: 'App_contentContainer_ba',
                        blockImage: 'App_blockImage_07',
                        blockImage__inputSeries: 'App_blockImage__inputSeries_52',
                        blockImage__dailyQuests: 'App_blockImage__dailyQuests_83',
                        blockHeader: 'App_blockHeader_f5',
                        blockDescription: 'App_blockDescription_25',
                        footer: 'App_footer_68',
                        button: 'App_button_26',
                    },
                    ju = R.strings.quests.introScreen;
                var Xu;
                !(function (u) {
                    ((u.INPUT_SERIES = 'inputSeries'), (u.DAILY_QUESTS = 'dailyQuests'));
                })(Xu || (Xu = {}));
                const $u = (0, yu.Pi)(() => {
                    const u = Gu(),
                        e = u.model,
                        t = u.controls,
                        n = e.root.get(),
                        A = n.isPlayStreakEnabled,
                        i = n.isDailyQuestsEnabled,
                        F = (0, r.useState)(!1),
                        o = F[0],
                        s = F[1],
                        D = (0, r.useCallback)(() => {
                            if ((E.O.view.setEventHandled(), o)) return;
                            s(!0);
                            const u = setTimeout(t.close, 400);
                    ...
                    const _ = (0, r.useMemo)(
                        () => [
                            { block: Xu.INPUT_SERIES, isEnabled: A },
                            { block: Xu.DAILY_QUESTS, isEnabled: i },
                        ],
                        [A, i],
                    );
                    return a().createElement(
                        'div',
                        { className: h()(Uu.base, o && Uu.base__hide) },
                        a().createElement('div', { className: Uu.background }),
                        a().createElement(
                            'div',
                            { className: Uu.close },
                            a().createElement(Mu, { caption: ju.close(), type: 'close', side: 'right', onClick: D }),
                        ),
                        a().createElement(
                            'div',
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { className: Uu.header },
                                    a().createElement(fu, { text: ju.title(), className: Uu.title }),
                                    a().createElement(fu, {
                                        text: A ? ju.subtitle() : ju.subtitleDailyQuestsOnly(),
                                ...
                                a().createElement(
                                    ...
                                    _.map(({ block: u, isEnabled: e }) => {
                                        if (!e) return null;
                                        const t = ju.$dyn(u);
                                        return a().createElement(
                                            'div',
                                            { className: Uu.contentContainer, key: u },
                                            a().createElement('div', {
                                                className: h()(Uu.blockImage, Uu[`blockImage__${u}`]),
                                            }),
                                            a().createElement(fu, {
                                                text: t.$dyn('header'),
                                                className: Uu.blockHeader,
                                            }),
                                            a().createElement(fu, {
                                                text: t.$dyn('description'),
                                                className: Uu.blockDescription,
                                            }),
                                        );
                                    }),
                                ),
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    j,
                                    { type: W.primary, onClick: D, mixClass: Uu.button },
                                    a().createElement(fu, { text: ju.confirm() }),
                                ),
                            ),
                        ),
                    );
                ...
                engine.whenReady.then(() => {
                    P().render(
                        a().createElement(Wu, null, a().createElement(H, null, a().createElement($u, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [272], () => __webpack_require__(4422));
