(() => {
    var __webpack_modules__ = {
            ...
            648: (u, e, t) => {
                ...
                const c = R.strings.quests.dailyQuests.tab,
                    m = (0, B.Pi)(({ isSelected: u, onClick: e }) => {
                        const t = l().model,
                            r = t.root.get(),
                            a = r.isEnabled,
                            A = r.unseenCount,
                            n = t.computes.getAllQuestsCompleted(),
                            i = a ? c.label() : c.disabled.title(),
                            F = ((u, e, t) => (u ? (e ? c.completed() : t) : c.disabled.reason()))(
                                a,
                                n,
                                t.computes.getConditionDescr(),
                            ),
                            D = t.computes.getCurrentQuest();
                        return E().createElement(C.q, {
                            tabIdx: _.g.DailyQuests,
                            isEnabled: a,
                            isCompleted: n,
                            isSelected: u,
                            title: i,
                ...
                (0, r.memo)(function (u) {
                    ...
                    return E().createElement(o, { options: e }, E().createElement(m, u));
                });
            },
            8975: (u, e, t) => {
                'use strict';
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [272], () => __webpack_require__(648));
