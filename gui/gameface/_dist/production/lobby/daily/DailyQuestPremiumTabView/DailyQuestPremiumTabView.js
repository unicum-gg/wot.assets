(() => {
    var __webpack_modules__ = {
                        ...
                        let e = u.className,
                            ...
                            y =
                                void 0 === M
                                    ...
                                    : M,
                            O = u.alignItems,
                            R = void 0 === O ? (f ? 'flex-start' : w && 'center') || (S && 'flex-end') || void 0 : O,
                            P = u.alignSelf,
                            N = u.wrap,
                            k = u.flexWrap,
                        ...
                        const K = (0, i.useMemo)(() => {
                                const u = { mt: n, mr: c, mb: d, ml: g },
                                    ...
                                    E = ((u) =>
                                        B.reduce((e, t) => {
                                            const r = u[t];
                                            return ('number' == typeof r && (e[_[t]] = r + 'rem'), e);
                                        }, {}))(u);
                                return {
            ...
            6010: (u, e, t) => {
                ...
                const n = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && _) return (0, E.H)(e, t, p);
                ...
                const c = Object.keys(i()),
                    ...
                    v = (0, s.ZP)((u) => {
                        ...
                        return l().createElement(
                            ...
                            void 0 !== x ? l().createElement(A.z, C({}, x, { text: e })) : e,
                        );
                    });
            },
            3532: (u) => {
            ...
            8246: (u, e, t) => {
                ...
                function n({ initializer: u = !0, rootId: e = 0, getRoot: t = A, context: a = 'model' } = {}) {
                    const n = new Map();
                    function i(u, e = 0) {
                ...
                const i = () => (u, e) => {
                    ...
                    return [
                        function ({ mode: i = 'real', options: F, children: D, mocks: s }) {
                            const o = (0, a.useRef)([]),
                                l = (t, a, A) => {
                                    ...
                                    const F = n.U(a),
                                        ...
                                        _ = { mode: t, model: B, externalModel: D, cleanup: l };
                                    return {
                                        model: B,
                            ...
                            return (
                                (0, a.useEffect)(() => {
                                    B.current ? h(l(C, F, s)) : (B.current = !0);
                                }, [s, C, F]),
                                (0, a.useEffect)(() => {
                                    c(i);
                                }, [i]),
            ...
            5415: (u, e, t) => {
                ...
                const F = () => {
                    ...
                    return { mediaSize: a, mediaWidth: F, mediaHeight: D, remScreenWidth: e, remScreenHeight: t };
                };
            },
            5360: (u, e, t) => {
                'use strict';
            ...
            8975: (u, e, t) => {
                ...
                const n = 'DailyQuestsTab_base_fd',
                    ...
                    _ = 'DailyQuestsTab_base__completed_3f',
                    C = 'DailyQuestsTab_base__notEnabled_eb',
                ...
                const W = ({
                    ...
                    return A().createElement(
                        'div',
                        {
                            className: E()(n, V && B, t && i, e && r && _, !e && C, uu && m),
                            onMouseEnter: iu,
                            onMouseLeave: Fu,
                            onClick: Du,
                        },
