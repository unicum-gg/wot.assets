(() => {
    var __webpack_modules__ = {
                ...
                const s = {
                    ...
                    _ = (0, i.ZP)((u) => {
                        let e = u.className,
                            ...
                            w = u.row,
                            p = u.flexDirection,
                            x = void 0 === p ? (v ? 'column' : w && 'row') || void 0 : p,
                            b = u.flexStart,
                            f = u.center,
                            S = u.flexEnd,
                            M = u.spaceBetween,
            ...
            280: (u, e, t) => {
                ...
                var E = t(6179),
                    ...
                    i = t(3649),
                    a = t(5287);
                const n = ({ binding: u, text: e = '', classMix: t, alignment: r = i.v2.left }) =>
                    null === e
                        ...
                        : A().createElement(
                              ...
                              e.split('\n').map((e, n) =>
                                  A().createElement(
                                      'div',
                                      { className: F()(a.Z.base, t), key: `${e}-${n}` },
            ...
            3495: (u, e, t) => {
                ...
                const i = E.O.client.getSize('rem'),
                    a = i.width,
                    n = i.height,
                    D = Object.assign({ width: a, height: n }, (0, F.T)(a, n, r.j)),
                ...
                (0, E.memo)(({ children: u }) => {
                    const e = (0, E.useContext)(F.Y),
                        ...
                        o = (0, E.useCallback)((u, e) => {
                            ...
                            B(Object.assign({ width: t, height: E }, (0, a.T)(t, E, i.j)));
                        }, []);
                    ((0, r.Z)(() => {
            ...
            6010: (u, e, t) => {
                ...
                const i = (u) => {
                    ...
                    const i = (0, E.useContext)(r.Y),
                        ...
                        w = { extraLarge: c, large: d, medium: h, small: g, extraSmall: v };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraSmallWidth && m) return (0, A.H)(e, t, w);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                ...
                const m = Object.keys(a()),
                    ...
                    p = (0, B.ZP)((u) => {
                        ...
                        return s().createElement(
                            ...
                            _(
                                {
                                    className: A()(l.Z.base, t && l.Z[t], M, E),
                                    style: S,
                ...
                const a = (u, e, t = {}, E = 0) => {
                    ...
                    n = (u) => {
                        ...
                        const b = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            f = (0, r.useMemo)(() => v || (0, E.F)().resId, [v]),
                            S = (0, r.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (a(t, c, { isMouseEvent: !0, on: !0, arguments: i(A) }, f),
                                    w && w(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((b.current.timeoutId = window.setTimeout(S, l ? 100 : 400)),
                                                      n && n(u),
                                                      T && T(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                                              (M(), null == D || D(e), null == u || u(e));
                                          })(e.props.onMouseLeave),
                                          onClick: ((u) => (e) => {
                                              (!1 === _ && M(), null == o || o(e), null == u || u(e));
                                          })(e.props.onClick),
                                          onMouseDown: ((u) => (e) => {
            ...
            3377: (u, e, t) => {
                ...
                const F = ['xl', 'lg', 'md', 'sm', 'xs'],
                    i = (u) => u.includes('_') && ((u) => F.includes(u))(u.split('_').at(-1)),
            ...
            9922: (u, e, t) => {
                ...
                const B = 'RerollButton_base_7a',
                    o = 'RerollButton_base__disabled_2e',
                    s = 'RerollButton_iconWrapper_19',
                    l = 'RerollButton_icon_62',
                    C = 'RerollButton_iconHover_e2',
                    _ = 'RerollButton_iconDisabled_8f',
                    m = 'RerollButton_text_0b',
                    c = 'RerollButton_shine_75';
                (0, a.Pi)(({ canReroll: u, onReroll: e, rerollPremium: t, className: E }) =>
                    D().createElement(
                        F.u,
                        {
                            ignoreMouseClick: !u,
                        ...
                        D().createElement(
                            'div',
                            {
                                className: A()(B, E, !u && o),
                                onClick: u ? e : void 0,
                                onMouseEnter: u ? () => (0, i.G)(R.sounds.highlight()) : void 0,
                            },
                            D().createElement(
                                'div',
                                { className: s },
                                u
                                    ? D().createElement(
                                          D().Fragment,
                                          null,
                                          D().createElement('div', { className: l }),
                                          D().createElement('div', { className: C }),
                                          D().createElement('div', { className: c }),
                                      )
                                    : D().createElement('div', { className: _ }),
                            ),
                            D().createElement(r.ZP, { className: m, text: R.strings.quests.dailyQuests.body.reroll() }),
                        ),
                    ),
                );
            },
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (a = 0; a < deferred.length; a++) {
                    for (var [e, t, E] = deferred[a], r = !0, F = 0; F < e.length; F++)
                        (!1 & E || A >= E) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [272], () => __webpack_require__(9922));
