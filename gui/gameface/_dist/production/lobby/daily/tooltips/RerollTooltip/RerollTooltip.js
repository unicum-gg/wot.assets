(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                ...
                function c(u, e, t, r, E, n, a) {
                    ...
                    A.done ? e(i) : Promise.resolve(i).then(r, E);
                }
            ...
            2625: (u, e, t) => {
                ...
                const h = (u, e, t) => {
                    ...
                    p = (u, e, t = m.left) => u.split(e).reduce(t === m.left ? h : g, []),
                    v = (() => {
                        const u = new RegExp(
                ...
                const N = O,
                    ...
                    j = (u, e) => {
                        switch (e) {
                            ...
                            case c.Extended:
                                return `${_(R.strings.common.duration.days(), { days: u.days })} | ${G(u.hours)}:${G(u.minutes)}:${G(u.seconds)}`;
                        }
                    },
                    X = R.images.gui.maps.icons.components.countdown,
                    K = (u, e) => {
                        const t = 2 === e ? X.big : X;
                        switch (u) {
                            case C.Timer:
                ...
                const J = n.O.client.getSize('rem'),
                    uu = J.width,
                    eu = J.height,
                    tu = Object.assign({ width: uu, height: eu }, Q(uu, eu, $)),
                    ru = (0, a.createContext)(tu),
                    Eu = ['children'];
                const nu = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    const r = (0, a.useContext)(ru),
                        ...
                        h = { extraLarge: C, large: c, medium: m, small: _, extraSmall: d };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && o) return Y(e, t, h);
                        if (t.largeWidth && D) return Y(e, t, h);
                ...
                (0, a.memo)(nu),
                    (0, a.memo)(({ children: u }) => {
                        ...
                        return A().createElement(ru.Provider, { value: F }, u);
                    });
                let au, Au, iu;
                !(function (u) {
                ...
                const Fu = () => {
                        ...
                        return { mediaSize: r, mediaWidth: E, mediaHeight: n, remScreenWidth: e, remScreenHeight: t };
                    },
                    ou = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Du = (u) => u.includes('_') && ((u) => ou.includes(u))(u.split('_').at(-1)),
                    su = [au.ExtraLarge, au.Large, au.Medium, au.Small, au.ExtraSmall],
                    lu = (u, e) =>
                ...
                const _u = {
                    ...
                    gu = Bu((u) => {
                        let e = u.className,
                            ...
                            m = u.row,
                            _ = u.flexDirection,
                            d = void 0 === _ ? (c ? 'column' : m && 'row') || void 0 : _,
                            h = u.flexStart,
                            g = u.center,
                            p = u.flexEnd,
                            v = u.spaceBetween,
                        ...
                        const I = (0, a.useMemo)(() => {
                                ...
                                return {
                                    computedStyle: Object.assign({}, H, E, {
                            ...
                            }, [t, r, F, D, l, C, H, N, M, d, O, b, S]),
                            U = I.computedStyle,
                            G = I.computedClassNames;
                        return A().createElement('div', mu({ className: E()(Cu.base, ...G, e), style: U }, W), k);
                    });
                var pu = t(3532),
                    vu = t.n(pu);
                const wu = {
                ...
                const fu = Object.keys(vu()),
                    ...
                    yu = Bu((u) => {
                        ...
                        return A().createElement(
                            ...
                            bu(
                                {
                                    className: E()(wu.base, t && wu[t], p, r),
                                    style: g,
                                    mt: !0 === o ? Ou[t || 'paragraph-P16'].mt : o,
                                    mr: !0 === s ? Ou[t || 'paragraph-P16'].mr : s,
                ...
                const Gu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: E, children: i, mocks: F }) {
                                const o = (0, a.useRef)([]),
                                    D = (t, r, E) => {
                                        var a;
                                        const A = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, a) => {
                                                        const i = 'string' == typeof a ? `${r}.${a}` : r,
                                                            F = n.O.view.addModelObserver(i, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Wu(E.keys()); !(u = t()).done; ) a(u.value, e);
                                                    },
                                                    unsubscribe: a,
                                                };
                                            })(r),
                                            ...
                                            F = (u) =>
                                                'mocks' === t ? (null == E ? void 0 : E.getter(u)) : i.readByPath(u),
                                        ...
                                        return {
                                            model: s,
                                            controls: 'mocks' === t && E ? E.controls(l) : e(l),
                                            externalModel: i,
                                            mode: t,
                                        };
                                    },
                                    ...
                                    B = l[0],
                                    C = l[1],
                                    c = (0, a.useState)(() => D(r, E, F)),
                                    m = c[0],
                                    _ = c[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        s.current ? _(D(B, E, F)) : (s.current = !0);
                                    }, [F, B, E]),
                                    (0, a.useEffect)(() => {
                                        C(r);
                                    }, [r]),
                        ...
                        const e = {
                            root: u.object(),
                            canReroll: u.object('canReroll'),
                            isCompleted: u.object('isCompleted'),
                            isBonusCompleted: u.object('isBonusCompleted'),
                            isPremium: u.object('isPremium'),
                            isPremiumActive: u.object('isPremiumActive'),
                            rerollCooldown: u.object('rerollCooldown'),
                            timeToUpdate: u.object('timeToUpdate'),
                        };
                        return Object.assign({}, e, { computes: {} });
                    }, Nu),
                    ju = Gu[0],
                    Xu = Gu[1],
                    Ku = 'BodyTextTooltip_base_7b',
                    zu = 'BodyTextTooltip_timeLeft_24',
                    Vu = R.strings.quests.dailyReroll.tooltip,
                    qu = ({
                        canReroll: u,
                        isCompleted: e,
                        isBonusCompleted: t,
                        ...
                        e && (t || r)
                            ? A().createElement(yu, {
                                  className: Ku,
                                  text: r ? Vu.body.afterUpdatePremium() : Vu.body.afterUpdate(),
                              })
                            : e && !t
                              ? A().createElement(yu, { className: Ku, text: Vu.body.cantReroll() })
                              : u && r && !E
                                ? A().createElement(yu, { className: Ku, text: Vu.header.noAccess() })
                                : u || (n > 0 && (!r || E))
                                  ? A().createElement(yu, {
                                        className: Ku,
                                        text: Vu.body.timeUpdate(),
                                        format: {
                                            binding: {
                                                timeText: A().createElement(yu, {
                                                    className: zu,
                                                    text: d(Vu.body.timeText(), { time: a }),
                                                }),
                                                name: r ? Vu.premium() : Vu.usual(),
                                            },
                                        },
                                    })
                                  : A().createElement(yu, { className: Ku, text: Vu.body.isEnabledReroll() }),
                    Yu = 'App_base_96',
                    $u = 'App_header_f5',
                    Zu = 'App_available_49',
                    Qu = 'App_availableIcon_02',
                    Ju = 'App_timer_51',
                    ue = R.strings.quests.dailyReroll.tooltip,
                    ee = (0, Pu.Pi)(() => {
                        const u = Xu().model.root.get(),
                            e = u.canReroll,
                            t = u.isCompleted,
                            r = u.isBonusCompleted,
                            E = u.isPremium,
                            n = u.isPremiumActive,
                            a = u.timeToUpdate,
                            i = u.rerollCooldown,
                        ...
                        return A().createElement(
                            ...
                            e
                                ? A().createElement(yu, {
                                      className: $u,
                                      text: d(ue.header.title(), { name: E ? ue.premium() : ue.usual() }),
                                  })
                                : A().createElement(yu, { className: $u, text: ue.header.noAccess() }),
                            F &&
                                A().createElement(
                                    'div',
                                    { className: Zu },
                                    A().createElement('div', { className: Qu }),
                                    A().createElement(yu, { className: Ju, text: ue.body.available() }),
                                    A().createElement(z, { duration: a, icon: C.None }),
                                ),
                            A().createElement(qu, {
                                canReroll: e,
                                isCompleted: t,
                ...
                engine.whenReady.then(() => {
                    B().render(
                        A().createElement(ju, null, A().createElement(s, null, A().createElement(ee, null))),
        ...
        (__webpack_require__.O = (u, e, t, r) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, t, r] = deferred[i], n = !0, a = 0; a < e.length; a++)
                        (!1 & r || E >= r) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [272], () => __webpack_require__(2625));
