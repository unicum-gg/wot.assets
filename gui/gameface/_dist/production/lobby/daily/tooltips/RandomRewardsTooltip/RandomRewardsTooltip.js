    ...
    var __webpack_modules__ = {
            ...
            3655: (u, e, t) => {
                ...
                const L = a.O.client.getSize('rem'),
                    y = L.width,
                    N = L.height,
                    k = Object.assign({ width: y, height: N }, M(y, N, P)),
                    U = (0, n.createContext)(k),
                    I = ['children'];
                const H = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && o) return T(e, t, g);
                        if (t.largeWidth && D) return T(e, t, g);
                        if (t.mediumWidth && s) return T(e, t, g);
                        if (t.smallWidth && l) return T(e, t, g);
                        if (t.extraSmallWidth && B) return T(e, t, g);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                ...
                (0, n.memo)(({ children: u }) => {
                    const e = (0, n.useContext)(U),
                        ...
                        i = (0, n.useCallback)((u, e) => {
                            ...
                            E(Object.assign({ width: t, height: r }, M(t, r, P)));
                        }, []);
                    (G(() => {
                    ...
                    return A().createElement(U.Provider, { value: F }, u);
                });
                let W, X, j;
                (!(function (u) {
                ...
                const uu = {
                    ...
                    ru = Q((u) => {
                        ...
                        return A().createElement('div', J({ className: E()(Z.base, ...W, e), style: G }, I), U);
                    });
                let Eu;
                !(function (u) {
                ...
                const au = (u, e, t) => {
                    ...
                    Au = (u, e, t = Eu.left) => u.split(e).reduce(t === Eu.left ? au : nu, []),
                    iu = (() => {
                        const u = new RegExp(
                        ...
                        return Fu.includes(t)
                            ...
                            : ((u, e = Eu.left) => {
                                  ...
                                  const r =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (Au(E, /( )/, e).forEach((u) => (t = t.concat(Au(u, r, Eu.left)))), t);
                              })(u, e);
                    },
                    Du = 'FormatText_base_d0',
                    su = ({ binding: u, text: e = '', classMix: t, alignment: r = Eu.left }) =>
                        null === e
                ...
                const mu = Object.keys(Bu()),
                    ...
                    Su = Q((u) => {
                        ...
                        return A().createElement(
                            ...
                            cu(
                                {
                                    className: E()(_u.base, t && _u[t], p, r),
                                    style: h,
                                    mt: !0 === o ? vu[t || 'paragraph-P16'].mt : o,
                                    mr: !0 === s ? vu[t || 'paragraph-P16'].mr : s,
                                    mb: !0 === B ? vu[t || 'paragraph-P16'].mb : B,
                                    ml: !0 === C ? vu[t || 'paragraph-P16'].ml : C,
                                },
                                d,
                            ),
                            void 0 !== m ? A().createElement(su, cu({}, m, { text: e })) : e,
                        );
                    });
                var wu = t(3403);
                const xu = 'App_base_5b',
                    fu = 'App_header_1c',
                    Tu = 'App_rewards_ba',
                    Pu = 'App_reward_6b',
                    Ru = 'App_image_1e',
                ...
                const Wu = ((u, e) => {
                                    ...
                                    D = (t, r, E) => {
                                        ...
                                        const A = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = ku(E.keys()); !(u = t()).done;) n(u.value, e);
                                                    },
                                                    unsubscribe: n,
                                                };
                                            })(r),
                        ...
                        const e = { root: u.object() },
                            t = (0, Gu.Om)(
                                () => {
                                    return ((u = JSON.parse(e.root.get().rewards)), Hu(u));
                                    var u;
                                },
                                { equals: yu },
                            );
                    ...
                    qu = (0, wu.Pi)(() => {
                        const u = ju().model.computes.getRewards();
                        return A().createElement(
                            'div',
                            { className: xu },
                            A().createElement(Su, { className: fu, text: Yu.rewards.head() }),
                            A().createElement(
                                'div',
                                { className: Tu },
                                u.map((u, e) =>
                                    A().createElement(
                                        ...
                                        w(u.overlayType) &&
                                            A().createElement('div', {
                                                className: Mu,
                                                style: {
                                                    backgroundImage: `url(R.images.gui.maps.icons.quests.bonuses.big.${w(u.overlayType)}_overlay)`,
                                                },
                                            }),
                                        A().createElement(Su, { className: Ou, text: u.label }),
                                    ),
                                ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    B().render(
                        A().createElement(Xu, null, A().createElement(s, null, A().createElement(qu, null))),
