            ...
            1628: (u, e, t) => {
                ...
                const S = (u) => {
                    ...
                    const r = (0, s.useContext)(w),
                        ...
                        p = { extraLarge: d, large: _, medium: B, small: C, extraSmall: g };
                ...
                const W = {
                    ...
                    X = k((u) => {
                        ...
                        const j = (0, s.useMemo)(() => {
                            ...
                            }, [t, r, l, c, m, d, I, N, R, C, y, v, x]),
                            z = j.computedStyle,
                            Y = j.computedClassNames;
                        return i().createElement('div', G({ className: n()(U.base, ...Y, e), style: z }, X), k);
                    });
                let j;
                function z(u, e) {
                ...
                const vu = fu,
                    ...
                    Iu = 'DailyCountdown_countdownText_65',
                    ku = ({ timeToUpdate: u }) =>
                        i().createElement(
                            'div',
                            { className: Lu },
                            i().createElement(Mu, { duration: u, className: Iu, classNames: { icon: Nu } }),
                        );
                let Uu;
                !(function (u) {
                    ((u.Done = 'done'),
                ...
                const Ae = (u, e) => {
                            ...
                            t = (0, Yu.Om)(() =>
                                zu(e.quests.get(), (u) =>
                                    Object.assign({}, u, {
                                        allRewards: [
                                            ...zu(u.bonuses, (u) => Ae(u)),
                                            ...zu(u.subscriptionBonuses, (u) => Ae(u, !0)),
                                        ],
                    ...
                    we = (0, s.memo)(({ state: u, bonusQuestsLength: e }) => {
                        switch (u) {
                            case ce.HIDE_QUESTS:
                            ...
                            case ce.ALL_COMPLETE:
                                return i().createElement(
                                    ...
                                    i().createElement(Fu, { text: fe.completed(), className: Ce }),
                                );
                            case ce.NOT_AVALIABLE:
                                return i().createElement(
                                    ...
                                    i().createElement(
                                        ...
                                        i().createElement(Fu, { text: fe.notAvailable.header(), className: he }),
                                    ),
                                    i().createElement(Fu, {
                ...
                const ke = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    Xe = (u) => (u ? { left: 0 } : { right: 0 }),
                    je = (u, e) => (u ? { right: 100 - e + '%' } : { left: `${e}%` }),
                    ...
                    Ye = (0, s.memo)(
                        ({
                            ...
                            const h = (0, s.useMemo)(() => Object.assign({ width: '100%' }, ze(u), Xe(A)), [A, u]),
                                b = (0, s.useMemo)(() => Object.assign({ width: '0%' }, ze(u), Xe(A)), [A, u]),
                                f = (0, s.useMemo)(() => Object.assign({ width: '0%' }, je(A, r), ze(u)), [r, A, u]),
                                w = (0, s.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - r)}%` }, je(A, r), ze(u)),
                                    [r, A, o, u],
                                );
                            if (_) return null;
                    ...
                    zt = (0, du.Pi)(() => {
                        ...
                        return i().createElement(
                            ...
                            i().createElement(
                                'div',
                                { className: n()(Nt, a && It) },
                                i().createElement(Fu, { text: jt.header.$dyn(A), className: kt }),
                                o &&
                                    i().createElement(
                                        'div',
                                        { className: qt },
                                            ...
                                            format: {
                                                binding: {
                                                    timer: i().createElement(
                                                        'div',
                                                        { className: Xt },
                                                        i().createElement(ku, { timeToUpdate: t }),
                                                    ),
                                                },
                                            },
                                        }),
                            ...
                            m &&
                                i().createElement(
                                    'div',
                                    { className: $t },
                                    i().createElement(we, { state: E, bonusQuestsLength: l }),
                                ),
                        );
                    });
                engine.whenReady.then(() => {
                    F().render(
                        i().createElement(Fe, null, i().createElement(A, null, i().createElement(zt, null))),
