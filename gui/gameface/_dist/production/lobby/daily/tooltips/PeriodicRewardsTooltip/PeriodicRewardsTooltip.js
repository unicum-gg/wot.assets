(() => {
    var __webpack_modules__ = {
            ...
            5467: (u, e, t) => {
                ...
                const c = s().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        s().createElement(
                            'div',
                            A({}, m, {
                                className: a()(E.base, E[`base__theme-${F}`], r),
                                ref: function (u) {
                        ...
                        const h = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            S = (0, i.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (b(t, m, { isMouseEvent: !0, on: !0, arguments: w(r) }, f),
                                    C && C(),
                ...
                const N = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return s().createElement(M, e, r);
                    const a = e.contentId,
                        n = e.args,
                        i = null == n ? void 0 : n.contentId;
                    return a || i
                        ? s().createElement(f, L({}, e, { contentId: a || i }), r)
                        : s().createElement(T, e, r);
                };
                ...
                const I = [
                    ...
                    U = [D.Gold, D.Credits, D.Crystal, D.FreeXp, D.NewYearToyFragments],
                    G = [D.BattlePassPoints],
                    H = [D.PremiumPlus, D.Premium];
                let W;
                !(function (u) {
                    ((u.s16 = '16'),
                        (u.s32 = '32'),
                ...
                const X = ['engravings', 'backgrounds'],
                    ...
                    z = ({
                        ...
                        return s().createElement(
                            'div',
                            { className: a()($.base, $[`base__${r}`], l), style: E },
                            s().createElement(
                                N,
                                { tooltipArgs: c, className: $.tooltipWrapper },
                                s().createElement(
                                    s().Fragment,
                                    null,
                                    s().createElement(
                                        'div',
                                        { className: a()($.image, null == A ? void 0 : A.image) },
                                        m &&
                                            s().createElement('div', {
                                                className: a()($.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            s().createElement('div', {
                                                className: a()($.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        D &&
                                            s().createElement('div', {
                                                className: a()($.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                            ...
                            t &&
                                s().createElement(
                                    ...
                                    { tooltipArgs: F },
                                    s().createElement('div', {
                                        className: a()($.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const eu = n.O.client.getSize('rem'),
                    tu = eu.width,
                    ru = eu.height,
                    au = Object.assign({ width: tu, height: ru }, uu(tu, ru, Z)),
                ...
                const su = (u) => {
                    ...
                    const r = (0, i.useContext)(nu),
                        ...
                        g = { extraLarge: D, large: _, medium: d, small: B, extraSmall: C };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraSmallWidth && m) return Q(e, t, g);
                        if (
                ...
                (0, i.memo)(({ children: u }) => {
                    const e = (0, i.useContext)(nu),
                        ...
                        o = (0, i.useCallback)((u, e) => {
                            ...
                            a(Object.assign({ width: t, height: r }, uu(t, r, Z)));
                        }, []);
                    (ou(() => {
                    ...
                    return s().createElement(nu.Provider, { value: E }, u);
                });
                let Eu, lu, Au;
                (!(function (u) {
                ...
                const cu = () => {
                    ...
                    Fu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    mu = (u) => u.includes('_') && ((u) => Fu.includes(u))(u.split('_').at(-1)),
                ...
                const pu = {
                    ...
                    wu = du((u) => {
                        let e = u.className,
                            ...
                            f =
                                void 0 === b
                                    ...
                                    : b,
                            R = u.alignItems,
                            S = void 0 === R ? (g ? 'flex-start' : p && 'center') || (h && 'flex-end') || void 0 : R,
                            x = u.alignSelf,
                            T = u.wrap,
                            P = u.flexWrap,
                        ...
                        const G = (0, i.useMemo)(() => {
                            ...
                            }, [t, r, E, A, F, D, k, N, x, C, y, f, S]),
                            H = G.computedStyle,
                            W = G.computedClassNames;
                        return s().createElement('div', gu({ className: a()(Bu.base, ...W, e), style: H }, U), I);
                    });
                let bu;
                !(function (u) {
                ...
                const fu = (u, e, t) => {
                    ...
                    Su = (u, e, t = bu.left) => u.split(e).reduce(t === bu.left ? fu : Ru, []),
                    xu = (() => {
                        const u = new RegExp(
                        ...
                        return Tu.includes(t)
                            ...
                            : ((u, e = bu.left) => {
                                  ...
                                  const r =
                                      ...
                                      a = u.replace(/&nbsp;/g, ' ');
                                  return (Su(a, /( )/, e).forEach((u) => (t = t.concat(Su(u, r, bu.left)))), t);
                              })(u, e);
                    },
                    yu = 'FormatText_base_d0',
                    Ou = ({ binding: u, text: e = '', classMix: t, alignment: r = bu.left }) =>
                        null === e
                ...
                const Uu = Object.keys(Lu()),
                    ...
                    Yu = du((u) => {
                        ...
                        return s().createElement(
                            ...
                            Iu(
                                {
                                    className: a()(Nu.base, t && Nu[t], h, r),
                                    style: p,
                            ...
                            void 0 !== B ? s().createElement(Ou, Iu({}, B, { text: e })) : e,
                        );
                    });
                var $u = t(3403);
                let zu, Vu;
                ...
                const Ku = Object.assign({}, D, {
                    ...
                    Qu = 'largeRepairkit',
                    Zu = 'largeMedkit',
                    Ju = 'autoExtinguishers',
                    ue = 'rammer',
                    ee = 'improvedVentilation',
                    te = 'coatedOptics',
                    re = 'enhancedAimDrives',
                    ae = 'improvedConfiguration',
                    ne = 'aimingStabilizer',
                    ie = [
                        Ku.LootBoxToken,
                        Ku.RandomEquipment,
                ...
                (R.strings.play_streak.window.playStreakRewards.calendar.card.tooltip,
                    ...
                    Vu.Growing);
                let oe, Ee, le, Ae, ce, Fe;
                (!(function (u) {
                    ((u.left = 'left'), (u.right = 'right'));
                })(oe || (oe = {})),
                    (function (u) {
                        u[(u.mediaMedium = 860)] = 'mediaMedium';
                    })(Ee || (Ee = {})),
                    (function (u) {
                        ((u[(u.small = 1280)] = 'small'),
                            (u[(u.mediaSmall = 1366)] = 'mediaSmall'),
                            (u[(u.mediaMedium = 1600)] = 'mediaMedium'),
                            (u[(u.mediaLarge = 1920)] = 'mediaLarge'));
                    })(le || (le = {})),
                    (function (u) {
                        ((u[(u.small = 15)] = 'small'),
                            (u[(u.mediaSmall = 15)] = 'mediaSmall'),
                            (u[(u.mediaMedium = 24)] = 'mediaMedium'),
                            (u[(u.mediaLarge = 32)] = 'mediaLarge'));
                    })(Ae || (Ae = {})),
                    (function (u) {
                        ((u.rare = 'streak_periodic_rent'),
                            (u.weekly = 'weekly'),
                            (u.monthly = 'monthly'),
                            (u.final_rewards = 'streak_final_rewards'));
                    })(ce || (ce = {})),
                    (function (u) {
                        ((u.Init = 'INIT'),
                            (u.Start = 'START'),
                ...
                const me = (u) => {
                    ...
                    De = (u) =>
                        u
                            .map((u) => {
                                var e, t, r;
                                return u.name === Ku.RandomEquipment || u.name === Ku.RandomGoodie
                                    ? {
                                          name: Ku.Items,
                                          item: u.name,
                                          label: u.label,
                                                  ...
                                                  : U.includes(r)
                                                    ...
                                                    : G.includes(r)
                                                      ...
                                                      : H.includes(r)
                                                        ? B.PREMIUM_PLUS
                                                        : B.STRING),
                                          tooltipArgs: Y({ tooltipId: u.tooltipId }),
                                          vehCD: null != (t = null == u ? void 0 : u.vehCD) ? t : null,
                    ...
                    _e = (u, e, t) => {
                        ...
                        (u.forEach((u) => {
                            u.tags &&
                                (u.tags.includes(ce.weekly) || u.tags.includes(ce.monthly)) &&
                                (u.day < e || (u.day <= e && t)) &&
                                u.rewards.forEach((u) => {
                                    const e = u.name === _.Items ? u.item || '' : u.name || '',
                                        t = u.value ? u.value.toString() : '0';
                                    e &&
                                        (r[e]
                                            ? (r[e].value = (parseInt(r[e].value, 10) + parseInt(t, 10)).toString())
                                            : (r[e] = Object.assign({}, u, {
                                                  item: u.item || '',
                                                  overlayType: u.overlayType || '',
                                                  value: t,
                                              })));
                                });
                        }),
                            Object.values(r).forEach((u) => {
                                (u.name === _.PremiumPlus &&
                                    parseInt(u.value, 10) > 3 &&
                                    ((u.name = _.Items), (u.item = _.PremiumUniversal)),
                                    u.name === Ku.RandomGoodie && ((u.name = _.Items), (u.item = Ku.RandomGoodie)),
                                    u.name === Ku.RandomEquipment &&
                                        ((u.name = _.Items), (u.item = Ku.RandomEquipment)));
                            }));
                        const a = (u) =>
                            u.name === D.Items
                                ? u.item === _.PremiumUniversal
                                    ? ie.indexOf(D.PremiumUniversal)
                                    : u.item === Ku.RandomEquipment
                                      ? ie.indexOf(Ku.RandomEquipment)
                                      : u.item === Ku.RandomGoodie
                                        ? ie.indexOf(Ku.RandomGoodie)
                                        : ie.indexOf(D.Items)
                                : ie.indexOf(u.name);
                        return Object.values(r).sort((u, e) => {
                            const t = a(u),
                                r = a(e);
                            return t !== r
                                ? t - r
                                : u.name === D.Items && e.name === D.Items
                                  ? se.indexOf(u.item) - se.indexOf(e.item)
                                  : 0;
                        });
                    },
                    de = 'LootboxTransition_base_9c',
                    Be = 'LootboxTransition_lootbox_62',
                    Ce = 'LootboxTransition_smoke_43',
                    ge = (0, i.memo)(({ delay: u, isEnabled: e = !0, children: t }) =>
                        e
                            ? s().createElement(
                                  'div',
                                  { className: de },
                                  ...
                                  s().createElement(
                                      'div',
                                      { className: Be, style: { animationDelay: `${u}ms, ${u + 500}ms` } },
                                      t,
                                  ),
                              )
                            : t,
                    ...
                    pe = 'Rewards_base_26',
                    he = 'Rewards_base__vertical_9f',
                    ve = 'Rewards_reward_7b',
                    we = 'Rewards_reward__vertical_c6';
                function be() {
                    return (
                        (be =
                            Object.assign ||
                ...
                const fe = [D.BattleToken],
                    ...
                    Se = 'PeriodicRewards_base_16',
                    xe = 'PeriodicRewards_base__blocked_57',
                    Te = 'PeriodicRewards_baseInner_55',
                    Pe = 'PeriodicRewards_head_22',
                    ye = 'PeriodicRewards_headInner_41',
                    Oe = 'PeriodicRewards_body_bb',
                    Me = 'PeriodicRewards_glow_2a',
                    Le = 'PeriodicRewards_line_79',
                    Ne = 'PeriodicRewards_lineInner_27',
                    ke = 'PeriodicRewards_blur_27',
                    Ie = 'PeriodicRewards_blur__active_06',
                    Ue = 'PeriodicRewards_info_30';
                s().memo(
                    ({ dailyWin: u, hasPeriodicTag: e, periodicRewardsIsHovered: t, rewards: r, isShowBlocked: n }) => {
                        const o = R.strings.play_streak.window.playStreakRewards.periodicRewards,
                            E = n ? o.tooltip.blocked : o.tooltip,
                            l = a()(Se, { [xe]: n }),
                            A = (0, i.useMemo)(
                                () =>
                                    7 < r.length
                                        ? Y({}, R.views.lobby.daily.tooltips.PeriodicRewardsTooltip('resId'))
                                        : void 0,
                                [r],
                            );
                        return s().createElement(
                            'div',
                            { className: l },
                            u && e && !n && s().createElement('div', { className: Me }),
                            s().createElement('div', { className: Le }, s().createElement('div', { className: Ne })),
                            s().createElement('div', { className: a()(ke, t && Ie) }),
                            s().createElement(
                                'div',
                                { className: Te },
                                s().createElement(
                ...
                const Ye = (u) => {
                    return null !== u && 'object' == typeof u
                        ? 'CoherentArrayProxy' === u.constructor.name
                            ? ((e = u),
                              (t = (u) => ('object' == typeof u ? Ye(u) : u)),
                              Array.isArray(e) ? e.map(t) : e.map((u, e, r) => t(null == u ? void 0 : u.value, e, r)))
                            : Array.isArray(u)
                              ? u.map((u) => ('object' == typeof u ? Ye(u) : u))
                              : Object.fromEntries(
                                    Object.entries(u).map(([u, e]) => [u, 'object' == typeof e ? Ye(e) : e]),
                                )
                        : u;
                    var e, t;
                };
                ...
                const ze = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: a, children: o, mocks: E }) {
                                const l = (0, i.useRef)([]),
                                    A = (t, r, a) => {
                                        var i;
                                        const s = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Xe(a.keys()); !(u = t()).done; ) i(u.value, e);
                                                    },
                                                    unsubscribe: i,
                                                };
                                            })(r),
                                    ...
                                    m = F[0],
                                    D = F[1],
                                    _ = (0, i.useState)(() => A(r, a, E)),
                                    d = _[0],
                                    B = _[1];
                                return (
                                    (0, i.useEffect)(() => {
                                        c.current ? B(A(m, a, E)) : (c.current = !0);
                                    }, [E, m, a]),
                                    (0, i.useEffect)(() => {
                                        D(r);
                                    }, [r]),
                        ...
                        const e = { root: u.object(), rewardsCalendar: u.array('rewardsCalendar') };
                        return Object.assign({}, e, {
                            computes: {
                                getRewards: (0, $e.Om)(
                                    () => {
                                        return ((u = e.rewardsCalendar.get()), Ye(u));
                                        var u;
                                    },
                                    { equals: He },
                                ),
                ...
                const tt = (0, $u.Pi)(() => {
                    const u = Ke().model,
                        e = ((u, e, t) => {
                            const r = me(u),
                                a = u.filter((u) => u.tags && u.tags.includes(ce.rare)),
                                n = u
                                    .filter((u) => u.tags && u.tags.includes(ce.final_rewards))
                                    .map((u) =>
                                        u.rewards.map((u) => {
                                            var e;
                                            return {
                                                vehicleName: u.label ? u.label : '',
                                                vehicleNation: u.nation ? u.nation : '',
                                                vehicleLvl: u.level ? u.level : 0,
                                                vehCD: u.vehCD ? u.vehCD : 0,
                                                vehicleType: u.vehType ? u.vehType : '',
                                                isElite: !!u.isElite && u.isElite,
                                                icon: u.icon ? u.icon : '',
                                                techName: u.vehName ? u.vehName : '',
                                                tooltipArgs: Y({ tooltipId: u.tooltipId }),
                                                name: u.name ? u.name : '',
                                                label: u.label ? u.label : '',
                                                styleCD: null != (e = u.styleCD) ? e : null,
                                            };
                                        }),
                                    )
                                    .flat();
                            return (
                                n.sort((u, e) =>
                                    u.name === D.StyleProgress ? -1 : e.name === D.StyleProgress ? 1 : 0,
                                ),
                                {
                                    countDays: r,
                                    progressionRewards: a,
                                    periodicRewards: _e(u, e, t),
                                    postProgressionRewards: n,
                                }
                            );
                        })(u.computes.getRewards(), u.root.get().streakLength, u.root.get().dailyWin),
                        t = e.periodicRewards,
                        r = De(t).slice(7);
                    return s().createElement(
                        'div',
                        ...
                        s().createElement(
                            ...
                            r.map((u, e) =>
                                s().createElement(
                                    'div',
                                    { className: Je, key: `${u.name}_${e}` },
                                    s().createElement(z, et({}, u, { size: d.Small })),
                                    s().createElement(Yu, {
                                        text: u.label,
                                        className: ut,
                                        variant: 'paragraph-P12',
                ...
                engine.whenReady.then(() => {
                    m().render(
                        s().createElement(Ve, null, s().createElement(c, null, s().createElement(tt, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [272], () => __webpack_require__(5467));
