    ...
    var __webpack_modules__ = {
            ...
            6832: (u, e, t) => {
                        ...
                        const h = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            S = (0, i.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (f(t, D, { isMouseEvent: !0, on: !0, arguments: w(r) }, v),
                                    C && C(),
                ...
                const k = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return s().createElement(L, e, r);
                    const a = e.contentId,
                        n = e.args,
                        i = null == n ? void 0 : n.contentId;
                    return a || i
                        ? s().createElement(S, N({}, e, { contentId: a || i }), r)
                        : s().createElement(P, e, r);
                };
                ...
                const U = [
                    ...
                    G = [m.Gold, m.Credits, m.Crystal, m.FreeXp],
                    H = [m.BattlePassPoints],
                ...
                const j = ['engravings', 'backgrounds'],
                    ...
                    V = ({
                        ...
                        const D = ((u) => {
                            ...
                            _ = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case B.CURRENCY:
                                    case B.NUMBER:
                                        return s().createElement(I, { format: 'integral', value: Number(u) });
                                    case B.PREMIUM_PLUS: {
                                        const e = Number(u);
                        ...
                        return s().createElement(
                            'div',
                            { className: a()(z.base, z[`base__${r}`], l), style: E },
                            s().createElement(
                                k,
                                ...
                                s().createElement(
                                    ...
                                    s().createElement(
                                        'div',
                                        { className: a()(z.image, null == A ? void 0 : A.image) },
                                        D &&
                                            s().createElement('div', {
                                                className: a()(z.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            s().createElement('div', {
                                                className: a()(z.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        m &&
                                            s().createElement('div', {
                                                className: a()(z.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                            ...
                            t &&
                                s().createElement(
                                    ...
                                    { tooltipArgs: c },
                                    s().createElement('div', {
                                        className: a()(z.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const cu = () => {
                    ...
                    _u = [lu.ExtraLarge, lu.Large, lu.Medium, lu.Small, lu.ExtraSmall],
                    du = (u, e) =>
                ...
                const hu = {
                    ...
                    wu = Bu((u) => {
                        ...
                        return s().createElement('div', pu({ className: a()(Cu.base, ...W, e), style: H }, U), I);
                    });
                let fu;
                !(function (u) {
                ...
                const Ru = (u, e, t) => {
                    ...
                    xu = (u, e, t = fu.left) => u.split(e).reduce(t === fu.left ? Ru : Su, []),
                    Tu = (() => {
                        const u = new RegExp(
                        ...
                        return Pu.includes(t)
                            ...
                            : ((u, e = fu.left) => {
                                  ...
                                  const r =
                                      ...
                                      a = u.replace(/&nbsp;/g, ' ');
                                  return (xu(a, /( )/, e).forEach((u) => (t = t.concat(xu(u, r, fu.left)))), t);
                              })(u, e);
                    },
                    Ou = 'FormatText_base_d0',
                    Mu = ({ binding: u, text: e = '', classMix: t, alignment: r = fu.left }) =>
                        null === e
                ...
                const Gu = Object.keys(Nu()),
                    ...
                    $u = Bu((u) => {
                        ...
                        return s().createElement(
                            ...
                            Uu(
                                {
                                    className: a()(ku.base, t && ku[t], h, r),
                                    style: p,
                                    mt: !0 === l ? qu[t || 'paragraph-P16'].mt : l,
                                    mr: !0 === F ? qu[t || 'paragraph-P16'].mr : F,
                                    mb: !0 === D ? qu[t || 'paragraph-P16'].mb : D,
                                    ml: !0 === _ ? qu[t || 'paragraph-P16'].ml : _,
                                },
                                C,
                            ),
                            void 0 !== B ? s().createElement(Mu, Uu({}, B, { text: e })) : e,
                        );
                    });
                var zu = t(3403);
                let Vu, Ku;
                ...
                const Qu = Object.assign({}, m, {
                    ...
                    Zu = 'largeRepairkit',
                    Ju = 'largeMedkit',
                    ue = 'autoExtinguishers',
                    ee = 'rammer',
                    te = 'improvedVentilation',
                    re = 'coatedOptics',
                    ae = 'enhancedAimDrives',
                    ne = 'improvedConfiguration',
                    ie = 'aimingStabilizer',
                    se = [
                        Qu.LootBoxToken,
                        Qu.RandomEquipment,
                ...
                const me = (u) => {
                    ...
                    _e = (u) =>
                        u
                            .map((u) => {
                                var e, t, r;
                                return u.name === Qu.RandomEquipment || u.name === Qu.RandomGoodie
                                    ? {
                                          name: Qu.Items,
                                          item: u.name,
                                          label: u.label,
                                                  ...
                                                  : G.includes(r)
                                                    ...
                                                    : H.includes(r)
                                                      ...
                                                      : W.includes(r)
                                                        ? B.PREMIUM_PLUS
                                                        : B.STRING),
                                          tooltipArgs: $({ tooltipId: u.tooltipId }),
                        ...
                        (u.forEach((u) => {
                            ...
                            Object.values(r).forEach((u) => {
                                (u.name === _.PremiumPlus &&
                                    ...
                                    u.name === Qu.RandomGoodie && ((u.name = _.Items), (u.item = Qu.RandomGoodie)),
                                    u.name === Qu.RandomEquipment &&
                                        ((u.name = _.Items), (u.item = Qu.RandomEquipment)));
                            }));
                        const a = (u) =>
                            u.name === m.Items
                                ? u.item === _.PremiumUniversal
                                    ? se.indexOf(m.PremiumUniversal)
                                    : u.item === Qu.RandomEquipment
                                      ? se.indexOf(Qu.RandomEquipment)
                                      : u.item === Qu.RandomGoodie
                                        ? se.indexOf(Qu.RandomGoodie)
                                        : se.indexOf(m.Items)
                                : se.indexOf(u.name);
                        return Object.values(r).sort((u, e) => {
                            ...
                            return t !== r
                                ...
                                : u.name === m.Items && e.name === m.Items
                                  ? oe.indexOf(u.item) - oe.indexOf(e.item)
                                  : 0;
                        });
                    },
                    Be = 'Rewards_base_26',
                    Ce = 'Rewards_base__vertical_9f',
                    ge = 'Rewards_reward_7b',
                ...
                const ve = s().memo(
                    ...
                    be = 'PeriodicRewards_base_16',
                    we = 'PeriodicRewards_base__blocked_57',
                    fe = 'PeriodicRewards_baseInner_55',
                    Re = 'PeriodicRewards_head_22',
                    Se = 'PeriodicRewards_headInner_41',
                    xe = 'PeriodicRewards_body_bb',
                    Te = 'PeriodicRewards_glow_2a',
                    Pe = 'PeriodicRewards_line_79',
                    ye = 'PeriodicRewards_lineInner_27',
                    Oe = 'PeriodicRewards_blur_27',
                    Me = 'PeriodicRewards_blur__active_06',
                    Le = 'PeriodicRewards_info_30';
                s().memo(
                    ({ dailyWin: u, hasPeriodicTag: e, periodicRewardsIsHovered: t, rewards: r, isShowBlocked: n }) => {
                        ...
                        return s().createElement(
                            'div',
                            { className: l },
                            u && e && !n && s().createElement('div', { className: Te }),
                            s().createElement('div', { className: Pe }, s().createElement('div', { className: ye })),
                            s().createElement('div', { className: a()(Oe, t && Me) }),
                            s().createElement(
                                'div',
                                { className: fe },
                                s().createElement(
                ...
                const je = ((u, e) => {
                                    ...
                                    A = (t, r, a) => {
                                        ...
                                        const s = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Ue(a.keys()); !(u = t()).done;) i(u.value, e);
                                                    },
                                                    unsubscribe: i,
                                                };
                                            })(r),
                        ...
                        return Object.assign({}, e, {
                            computes: {
                                getRewards: (0, Xe.Om)(
                                    () => {
                                        return ((u = e.rewardsCalendar.get()), We(u));
                                        var u;
                                    },
                                    { equals: ke },
                                ),
                    ...
                    return s().createElement(
                        ...
                        s().createElement(
                            ...
                            r.map((u, e) =>
                                s().createElement(
                                    'div',
                                    { className: Ve, key: `${u.name}_${e}` },
                                    s().createElement(V, Qe({}, u, { size: d.Small })),
                                    s().createElement($u, {
                                        text: u.label,
                                        className: Ke,
                                        variant: 'paragraph-P12',
                ...
                engine.whenReady.then(() => {
                    D().render(
                        s().createElement(qe, null, s().createElement(F, null, s().createElement(Ze, null))),
