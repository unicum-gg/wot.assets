            ...
            1218: (u, e, t) => {
                ...
                const Ru = {
                    ...
                    Ou = wu((u) => {
                        ...
                        return Z().createElement('div', yu({ className: a()(Lu.base, ...j, e), style: N }, W), P);
                    });
                let Pu;
                !(function (u) {
                ...
                const ie = ((u, e) => {
                    ...
                    de = 'App_flagIcon_ad',
                    ce = 'App_modeList_fa',
                    ge = 'App_selectorWrapper_64',
                    _e = 'App_modeIcon_d9',
                    he = R.strings.quests.modeSelector.tooltip,
                    xe = (0, Fe.Pi)(() => {
                        const u = le().model.root.get().battleTypes;
                        return Z().createElement(
                            'div',
                            { className: oe },
                            Z().createElement(Ae, { text: he.title(), className: me }),
                            Z().createElement(
                                'div',
                                { className: se },
                                Z().createElement('div', { className: de }),
                                Z().createElement(Ae, { text: he.text() }),
                                Z().createElement(
                                    'div',
                                    { className: ce },
                                    u.map(({ value: u, id: e }) =>
                                        Z().createElement(
                                            ...
                                            Z().createElement('div', {
                                                style: {
                                                    backgroundImage: `url(R.images.gui.maps.icons.quests.prebattleConditions.c_${u})`,
                                                },
                                                className: _e,
                                            }),
                                            Z().createElement(Ae, { text: R.strings.menu.bonusType.$dyn(`c_${u}`) }),
                                        ),
                                    ),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    Eu().render(
                        Z().createElement(Ce, null, Z().createElement(Au, null, Z().createElement(xe, null))),
