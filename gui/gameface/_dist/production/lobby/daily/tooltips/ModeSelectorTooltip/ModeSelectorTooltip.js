            ...
            1218: (u, e, t) => {
                ...
                const Tu = {
                    ...
                    Pu = Lu((u) => {
                        ...
                        return J().createElement('div', Ru({ className: a()(Mu.base, ...j, e), style: N }, W), P);
                    });
                let Wu;
                !(function (u) {
                ...
                const Ce = ((u, e) => {
                    ...
                    ce = 'App_flagIcon_ad',
                    ge = 'App_modeList_fa',
                    _e = 'App_selectorWrapper_64',
                    he = 'App_modeIcon_d9',
                    xe = R.strings.quests.modeSelector.tooltip,
                    fe = (0, Fe.Pi)(() => {
                        const u = oe().model.root.get().battleTypes;
                        return J().createElement(
                            'div',
                            { className: me },
                            J().createElement(Ee, { text: xe.title(), className: se }),
                            J().createElement(
                                'div',
                                { className: de },
                                J().createElement('div', { className: ce }),
                                J().createElement(Ee, { text: xe.text() }),
                                J().createElement(
                                    'div',
                                    { className: ge },
                                    u.map(({ value: u, id: e }) =>
                ...
                engine.whenReady.then(() => {
                    ru().render(
                        J().createElement(le, null, J().createElement(Eu, null, J().createElement(fe, null))),
