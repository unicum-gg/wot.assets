        ...
        e = {
            ...
            2200: (u, e, A) => {
                    ...
                    const e = (0, Q.useContext)(su),
                        ...
                        t = (0, Q.useCallback)((u, e) => {
                            const A = q.view.pxToRem(u),
                                F = q.view.pxToRem(e);
                            E(Object.assign({ width: A, height: F }, iu(A, F, au)));
                        }, []);
                    (_u(() => {
                ...
                const Hu = {
                    ...
                    Ou = bu((u) => {
                        let e = u.className,
                            ...
                            H = u.shrink,
                            T = u.flex,
                            y = void 0 === T ? (M || H ? `${M ? 1 : 0} ${H ? 1 : 0} auto` : void 0) : T,
                            O = u.style,
                            P = u.children,
                            W = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const G = (0, Q.useMemo)(() => {
                            ...
                            }, [A, F, D, a, i, l, O, y, w, d, R, f, S]),
                            N = G.computedStyle,
                            X = G.computedClassNames;
                        return Z().createElement('div', Mu({ className: B()(Lu.base, ...X, e), style: N }, W), P);
                    });
                let Pu;
                !(function (u) {
                ...
                const qu = Object.keys(Uu()),
                    ...
                    Ee = 'App_base_5b',
                    te = 'App_base__extended_bc',
                    De = 'App_header_1c',
                    re = 'App_description_8a',
                    Be = 'App_rewards_ba',
                    ae = 'App_reward_6b',
                    ne = 'App_image_1e',
                    ie = 'App_text_6b',
                    Ce = R.strings.play_streak.window.playStreakRewards.calendar.card.tooltip,
                    le = [
                        { icon: 'R.images.gui.maps.icons.quests.bonuses.big.booster_xp', label: Ce.random.item1() },
                        {
                            icon: 'R.images.gui.maps.icons.quests.bonuses.big.booster_credits',
                            label: Ce.random.item2(),
                        },
                        {
                            icon: 'R.images.gui.maps.icons.quests.bonuses.big.booster_crew_xp',
                            label: Ce.random.item3(),
                        },
                    ],
                    me = () =>
                        Z().createElement(
                            'div',
                            { className: B()(Ee, te) },
                            Z().createElement(Fe, { className: De, text: Ce.random.head() }),
                            Z().createElement(Fe, { className: re, text: Ce.random.body() }),
                            Z().createElement(
                                'div',
                                { className: Be },
                                le.map((u, e) =>
                                    Z().createElement(
                                        'div',
                                        { className: ae, key: `item_${e}` },
                                        Z().createElement('div', {
                                            className: ne,
                                            style: { backgroundImage: `url(${u.icon})` },
                                        }),
                                        Z().createElement(Fe, { className: ie, text: u.label }),
                                    ),
                                ),
                            ),
                        );
                engine.whenReady.then(() => {
                    tu().render(
                        Z().createElement(Fu, null, Z().createElement(me, null)),
