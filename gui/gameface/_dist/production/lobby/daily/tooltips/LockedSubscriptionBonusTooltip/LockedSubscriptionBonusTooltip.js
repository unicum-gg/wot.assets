            ...
            9314: (u, e, t) => {
                ...
                const mu = (u) => {
                    ...
                    su = (0, Q.memo)(({ children: u }) => {
                        ...
                        return Z().createElement(Cu.Provider, { value: r }, u);
                    });
                var du = t(926),
                    cu = t.n(du);
                let gu, _u, hu;
                ...
                const vu = {
                        [_u.ExtraSmall]: '',
                        [_u.Small]: cu().SMALL_WIDTH,
                        [_u.Medium]: `${cu().SMALL_WIDTH} ${cu().MEDIUM_WIDTH}`,
                        [_u.Large]: `${cu().SMALL_WIDTH} ${cu().MEDIUM_WIDTH} ${cu().LARGE_WIDTH}`,
                        [_u.ExtraLarge]: `${cu().SMALL_WIDTH} ${cu().MEDIUM_WIDTH} ${cu().LARGE_WIDTH} ${cu().EXTRA_LARGE_WIDTH}`,
                    },
                    Su = {
                        [hu.ExtraSmall]: '',
                        [hu.Small]: cu().SMALL_HEIGHT,
                        [hu.Medium]: `${cu().SMALL_HEIGHT} ${cu().MEDIUM_HEIGHT}`,
                        [hu.Large]: `${cu().SMALL_HEIGHT} ${cu().MEDIUM_HEIGHT} ${cu().LARGE_HEIGHT}`,
                        [hu.ExtraLarge]: `${cu().SMALL_HEIGHT} ${cu().MEDIUM_HEIGHT} ${cu().LARGE_HEIGHT} ${cu().EXTRA_LARGE_HEIGHT}`,
                    },
                    bu = {
                        [gu.ExtraSmall]: '',
                        [gu.Small]: cu().SMALL,
                        [gu.Medium]: `${cu().SMALL} ${cu().MEDIUM}`,
                        [gu.Large]: `${cu().SMALL} ${cu().MEDIUM} ${cu().LARGE}`,
                        [gu.ExtraLarge]: `${cu().SMALL} ${cu().MEDIUM} ${cu().LARGE} ${cu().EXTRA_LARGE}`,
                    },
                    Lu = (u) => {
                        let e = u.children,
                            t = u.className,
                        ...
                        const E = xu(),
                            ...
                            r = E.mediaHeight,
                            D = E.mediaSize;
                        return Z().createElement('div', pu({ className: a()(t, vu[F], Su[r], bu[D]) }, A), e);
                    },
                    wu = ['children'];
                const Mu = (u) => {
                    let e = u.children,
                    ...
                    return Z().createElement(su, null, Z().createElement(Lu, t, e));
                };
                var Hu = t(493),
                    Ru = t.n(Hu),
                    Tu = t(9887),
                ...
                const Ou = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    Gu = [gu.ExtraLarge, gu.Large, gu.Medium, gu.Small, gu.ExtraSmall],
                    Pu = (u, e) =>
                ...
                const $u = {
                    ...
                    Uu = Iu((u) => {
                        ...
                        const P = (0, Q.useMemo)(() => {
                                const u = { mt: r, mr: n, mb: i, ml: l },
                                    e = ((u) =>
                                        zu.reduce((e, t) => {
                                            const A = u[t];
                                            return A && 'number' != typeof A ? e.concat($u[!0 === A ? 'MD' : A][t]) : e;
                                        }, []))(u),
                                    E = ((u) =>
                                        zu.reduce((e, t) => {
                                            const A = u[t];
                        ...
                        return Z().createElement('div', Xu({ className: a()(Nu.base, ...N, e), style: I }, G), W);
                    });
                let Vu;
                !(function (u) {
                ...
                const Ku = (u, e, t) => {
                    ...
                    qu = (u, e, t = Vu.left) => u.split(e).reduce(t === Vu.left ? Ku : Yu, []),
                    Qu = (() => {
                        const u = new RegExp(
                        ...
                        return Zu.includes(t)
                            ...
                            : ((u, e = Vu.left) => {
                                  ...
                                  const A =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (qu(E, /( )/, e).forEach((u) => (t = t.concat(qu(u, A, Vu.left)))), t);
                              })(u, e);
                    },
                    ue = 'FormatText_base_d0',
                    ee = ({ binding: u, text: e = '', classMix: t, alignment: A = Vu.left }) =>
                        null === e
                ...
                const De = Object.keys(Ae()),
                    ...
                    oe = Iu((u) => {
                        ...
                        return Z().createElement(
                            ...
                            re(
                                {
                                    className: a()(Ee.base, t && Ee[t], _, A),
                                    style: g,
                                    mt: !0 === D ? Ce[t || 'paragraph-P16'].mt : D,
                                    mr: !0 === B ? Ce[t || 'paragraph-P16'].mr : B,
                                    mb: !0 === C ? Ce[t || 'paragraph-P16'].mb : C,
                                    ml: !0 === o ? Ce[t || 'paragraph-P16'].ml : o,
                                },
                                d,
                            ),
                ...
                const xe = ((u, e) => {
                    ...
                    Le = 'App_subheader_9d',
                    we = 'App_icon_36',
                    Me = 'App_description_dd',
                    He = R.strings.quests.reward.tooltip,
                    Re = (0, me.Pi)(() => {
                        ...
                        return Z().createElement(
                            ...
                            Z().createElement(
                                ...
                                { className: Se },
                                Z().createElement(oe, {
                                    text: e || t ? He.additionReward() : He.noAdditionReward(),
                                    className: be,
                                }),
                                Z().createElement(
                                    'div',
                                    ...
                                    Z().createElement(oe, { text: He.title() }),
                                ),
                                Z().createElement(oe, { text: He.customBody(), className: Me }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    Ru().render(
                        Z().createElement(
                            fe,
                            null,
                            Z().createElement(Mu, null, Z().createElement(Au, null, Z().createElement(Re, null))),
                        ),
