        ...
        e = {
            ...
            9314: (u, e, t) => {
                ...
                const su = (u) => {
                    ...
                    du = (0, Z.memo)(({ children: u }) => {
                        const e = (0, Z.useContext)(lu),
                            t = (0, Z.useState)(e),
                            A = t[0],
                            E = t[1],
                        ...
                        return J().createElement(lu.Provider, { value: r }, u);
                    });
                var cu = t(926),
                    gu = t.n(cu);
                let _u, hu, xu;
                ...
                const Su = {
                        [hu.ExtraSmall]: '',
                        [hu.Small]: gu().SMALL_WIDTH,
                        [hu.Medium]: `${gu().SMALL_WIDTH} ${gu().MEDIUM_WIDTH}`,
                        [hu.Large]: `${gu().SMALL_WIDTH} ${gu().MEDIUM_WIDTH} ${gu().LARGE_WIDTH}`,
                        [hu.ExtraLarge]: `${gu().SMALL_WIDTH} ${gu().MEDIUM_WIDTH} ${gu().LARGE_WIDTH} ${gu().EXTRA_LARGE_WIDTH}`,
                    },
                    bu = {
                        [xu.ExtraSmall]: '',
                        [xu.Small]: gu().SMALL_HEIGHT,
                        [xu.Medium]: `${gu().SMALL_HEIGHT} ${gu().MEDIUM_HEIGHT}`,
                        [xu.Large]: `${gu().SMALL_HEIGHT} ${gu().MEDIUM_HEIGHT} ${gu().LARGE_HEIGHT}`,
                        [xu.ExtraLarge]: `${gu().SMALL_HEIGHT} ${gu().MEDIUM_HEIGHT} ${gu().LARGE_HEIGHT} ${gu().EXTRA_LARGE_HEIGHT}`,
                    },
                    Lu = {
                        [_u.ExtraSmall]: '',
                        [_u.Small]: gu().SMALL,
                        [_u.Medium]: `${gu().SMALL} ${gu().MEDIUM}`,
                        [_u.Large]: `${gu().SMALL} ${gu().MEDIUM} ${gu().LARGE}`,
                        [_u.ExtraLarge]: `${gu().SMALL} ${gu().MEDIUM} ${gu().LARGE} ${gu().EXTRA_LARGE}`,
                    },
                    wu = (u) => {
                        let e = u.children,
                            t = u.className,
                        ...
                        const E = fu(),
                            ...
                            r = E.mediaHeight,
                            D = E.mediaSize;
                        return J().createElement('div', vu({ className: a()(t, Su[F], bu[r], Lu[D]) }, A), e);
                    },
                    Mu = ['children'];
                const Hu = (u) => {
                    let e = u.children,
                    ...
                    return J().createElement(du, null, J().createElement(wu, t, e));
                };
                var Ru = t(493),
                    Tu = t.n(Ru),
                    yu = t(9887),
                ...
                const Wu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Gu = (u) => u.includes('_') && ((u) => Wu.includes(u))(u.split('_').at(-1)),
                    Pu = [_u.ExtraLarge, _u.Large, _u.Medium, _u.Small, _u.ExtraSmall],
                    Iu = (u, e) =>
                ...
                const zu = {
                    ...
                    Vu = Nu((u) => {
                        let e = u.className,
                            ...
                            p =
                                void 0 === f
                                    ...
                                    : f,
                            v = u.alignItems,
                            S = void 0 === v ? (c ? 'flex-start' : g && 'center') || (_ && 'flex-end') || void 0 : v,
                            b = u.alignSelf,
                            L = u.wrap,
                            w = u.flexWrap,
                            M = void 0 === w ? (L ? 'wrap' : void 0) : w,
                            H = u.grow,
                            R = u.shrink,
                            T = u.flex,
                            y = void 0 === T ? (H || R ? `${H ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : T,
                            O = u.style,
                            W = u.children,
                            G = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const P = (0, Z.useMemo)(() => {
                            ...
                            }, [t, A, r, n, i, l, O, y, b, d, M, p, S]),
                            I = P.computedStyle,
                            N = P.computedClassNames;
                        return J().createElement('div', $u({ className: a()(ju.base, ...N, e), style: I }, G), W);
                    });
                let Ku;
                !(function (u) {
                        ...
                        return Ju.includes(t)
                            ...
                            : ((u, e = Ku.left) => {
                                  ...
                                  const A =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (Qu(E, /( )/, e).forEach((u) => (t = t.concat(Qu(u, A, Ku.left)))), t);
                              })(u, e);
                    },
                    ee = 'FormatText_base_d0',
                    te = ({ binding: u, text: e = '', classMix: t, alignment: A = Ku.left }) =>
                        null === e
                ...
                const ae = Object.keys(Ee()),
                    ...
                    me = Nu((u) => {
                        ...
                        return J().createElement(
                            ...
                            De(
                                {
                                    className: a()(Fe.base, t && Fe[t], _, A),
                                    style: g,
                            ...
                            void 0 !== s ? J().createElement(te, De({}, s, { text: e })) : e,
                        );
                    });
                var se = t(8515);
                function de() {}
                ...
                const fe = ((u, e) => {
                                    ...
                                    a = (t, A, E) => {
                                        ...
                                        const r = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = _e(E.keys()); !(u = t()).done;) F(u.value, e);
                                                    },
                                                    unsubscribe: F,
                                                };
                                            })(A),
                    ...
                    we = 'App_subheader_9d',
                    Me = 'App_icon_36',
                    He = 'App_description_dd',
                    Re = R.strings.quests.reward.tooltip,
                    Te = (0, se.Pi)(() => {
                        const u = ve().model.root.get(),
                            e = u.isActiveSubscription,
                            t = u.isQuestDone;
                        return J().createElement(
                            'div',
                            { className: Se },
                            J().createElement(
                                ...
                                { className: be },
                                J().createElement(me, {
                                    text: e || t ? Re.additionReward() : Re.noAdditionReward(),
                                    className: Le,
                                }),
                                J().createElement(
                                    'div',
                                    { className: we },
                                    J().createElement('div', { className: Me }),
                                    J().createElement(me, { text: Re.title() }),
                                ),
                                J().createElement(me, { text: Re.customBody(), className: He }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    Tu().render(
                        J().createElement(
                            pe,
                            null,
                            J().createElement(Hu, null, J().createElement(Eu, null, J().createElement(Te, null))),
                        ),
