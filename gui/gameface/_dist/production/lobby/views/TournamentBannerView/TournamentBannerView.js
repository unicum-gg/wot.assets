(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => A, off: () => s, on: () => i, onResize: () => o, onScaleUpdated: () => a }));
                var n = t(2472),
                    r = t(1176);
            ...
            4881: (u, e, t) => {
                                                ...
                                                n = window.setInterval(() => {
                                                    ...
                                                    o
                                                        ? (null == i || i(r, o),
                                                          ...
                                                          r === m &&
                                                              (null == g || g(),
                                                              p || (null == h || h(), window.clearInterval(n))))
                                                        : console.error(
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (h(t, D, { isMouseEvent: !0, on: !0, arguments: w(r) }, f),
                                    m && m(),
                        ...
                        return [
                            function ({ mode: u = 'real', options: o, children: a, mocks: i }) {
                                const s = (0, n.useRef)([]),
                                    ...
                                    c = F[0],
                                    l = F[1],
                                    D = (0, n.useState)(() => E(u, o, i)),
                                    d = D[0],
                                    B = D[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        A.current ? B(E(c, o, i)) : (A.current = !0);
                                    }, [i, c, o]),
                                    (0, n.useEffect)(() => {
                                        l(u);
                                    }, [u]),
                ...
                const V = [f.ActiveStream, f.AnnouncementStream, f.AfterTournament],
                    U = R.strings.battle_royale_tournament,
                    j = {
                        width: 280,
                        height: 170,
                        frameCount: 136,
                    ...
                    G = (0, y.Pi)(() => {
                        const u = L(),
                            ...
                            a = t.dateEnd,
                            i = t.isExtended,
                            A = t.improvedGraphics,
                            F = V.includes(o),
                            l = (function (u = {}, e = []) {
                                var t, r, o, a;
                                const i = (0, n.useState)(null != (t = u.state) ? t : E),
                                    s = i[0],
                                    A = i[1],
                                    ...
                                    h = (0, n.useCallback)(() => A('play'), []),
                                    g = (0, n.useCallback)(() => {
                                        (l(v.current + 1), A('stop'));
                                    }, []);
                                return {
                                    props: {
                                        state: s,
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                {
                                    ...
                                    className: s()(I.base, i && I.base__extended, F && I.base__external),
                                },
                                r().createElement('div', { className: s()(I.background, I.background__first) }),
                                r().createElement('div', { className: s()(I.background, I.background__second) }),
                                r().createElement('div', { className: s()(I.background, I.background__third) }),
                                    ...
                                    switch (o) {
                                        case f.BeforeTournament:
                                            return r().createElement(
                                                'div',
                                                { className: I.content },
                                                r().createElement('div', { className: I.title }, U.title()),
                                                r().createElement('div', { className: I.subtitle }, U.subtitle()),
                                                r().createElement(
                                                    'div',
                                                    { className: I.timer },
                                        ...
                                        case f.ActiveTournament:
                                            return r().createElement(
                                                ...
                                                r().createElement(
                                                    'div',
                                                    { className: s()(I.subtitle, I.subtitle__light) },
                                                    U.activeTournament(),
                                                ),
                                            );
                                        case f.AfterTournament:
                                            return r().createElement(
                                                'div',
                                                { className: I.content },
                                                r().createElement('div', { className: I.title }, U.over()),
                                            );
                                        case f.AnnouncementStream:
                                            return r().createElement(
                                                'div',
                                                { className: I.content },
                                                r().createElement('div', { className: I.title }, U.finals()),
                                                r().createElement('div', { className: I.subtitle }, U.after()),
                                                r().createElement(
                                                    'div',
                                                    { className: I.timer },
                                                    r().createElement('div', { className: I.timerIcon }),
                                        ...
                                        case f.ActiveStream:
                                            return r().createElement(
                                                'div',
                                                { className: I.content },
                                                r().createElement('div', { className: I.title }, U.broadcast.title()),
                                                r().createElement(
                                                    'div',
                                                    { className: s()(I.subtitle, I.subtitle__broadcast) },
                                                    U.broadcast.subtitle(),
                                                ),
                                            );
                                        default:
                ...
                engine.whenReady.then(() => {
                    a().render(r().createElement(M, null, r().createElement(G, null)), document.getElementById('root'));
                });
            },
            7363: (u) => {
                u.exports = React;
