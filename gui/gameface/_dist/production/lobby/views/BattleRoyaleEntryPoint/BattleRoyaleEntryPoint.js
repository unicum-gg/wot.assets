            ...
            5439: (u, e, t) => {
                ...
                const w = {
                    ...
                    b = (u) => {
                        ...
                        const i = (() => {
                            ...
                            E = i.mediaHeight,
                            s = i.mediaSize;
                        return n().createElement('div', v({ className: d()(t, w[o], p[E], f[s]) }, a), e);
                    },
                    x = ['children'],
                    y = (u) => {
                        let e = u.children,
                        ...
                        return n().createElement(c, null, n().createElement(b, t, e));
                    };
                var L = t(1533),
                    S = t.n(L);
                let O;
                ...
                const P = (0, r.memo)(function (u) {
                        ...
                        return (
                            ...
                            n().createElement('canvas', k({}, _, { width: e, height: t, ref: v }))
                        );
                    }),
                    H = (u, e) => {
                        let t = u;
                ...
                const V = R.strings.battle_royale.banner,
                    z = (u, e) => {
                        switch (u) {
                            case O.Active:
                            case O.PostEvent:
                                return ((u, e) => {
                                    const t = ((u) => {
                                        ...
                                        r = t.day,
                                        n = t.month;
                                    return $(u, { day: r, month: R.strings.menu.dateTime.months.$num(n + 1) });
                                })(V.seasonDate.seasonLasts(), e);
                            case O.Disabled:
                                return (({ hours: u, minutes: e }) =>
                                    u >= 1
                                        ? 0 === e
                                            ? $(V.timeLeft.hour(), { hour: u })
                                            : $(V.timeLeft.hours(), { hours: u, minutes: e })
                                        : $(V.timeLeft.minutes(), { minutes: e || V.timer.lessOneMin() }))(
                                    (function (u = 0) {
                                        let e = u;
                ...
                const ru = {
                    ...
                    au = (0, G.Pi)(() => {
                        const u = n().useState(!1),
                            ...
                            E = (function (u = {}, e = []) {
                                var t, n, a, i;
                                const o = (0, r.useState)(null != (t = u.state) ? t : T),
                                    E = o[0],
                                    s = o[1],
                                    l = (0, r.useState)(null != (n = u.initialFrameIndex) ? n : 0),
                                    A = l[0],
                                    F = l[1],
                        ...
                        return n().createElement(
                            'div',
                            {
                                className: d()(eu.base, eu[`base__${F}`], A && eu.base__single),
                                onClick: () => {
                                    (U.playYes(), o.switchMode());
                                },
                                onMouseEnter: () => {
                                    (U.playHighlight(), t(!0), E.play());
                                },
                                onMouseLeave: () => {
                                    (t(!1), E.stop());
                                },
                            },
                            n().createElement('div', { className: eu.bg }),
                            F === O.Active
                                ? n().createElement(
                                      n().Fragment,
                                      null,
                                      n().createElement('div', { className: eu.highlight }),
                                      e &&
                                          n().createElement(
                                              P,
                                              tu({}, E.props, {
                                ...
                                : n().createElement('div', { className: eu.overlay }),
                            n().createElement(
                                'div',
                                ...
                                n().createElement(
                                    'div',
                                    { className: eu.seasonDate },
                                    F === O.Disabled && n().createElement('div', { className: eu.seasonDateIcon }),
                                    n().createElement('div', { className: eu.seasonDateText }, z(F, l)),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    S().render(
                        n().createElement(y, null, n().createElement(J, null, n().createElement(au, null))),
