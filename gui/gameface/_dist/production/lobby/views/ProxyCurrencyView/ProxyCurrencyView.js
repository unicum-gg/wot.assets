(() => {
    ...
    var __webpack_modules__ = {
            ...
            3266: (e, t, n) => {
                var r = n(7363),
                    ...
                    a = n.n(i),
                    s = n(9916);
                const c = ({ value: e, format: t = 'integral' }) => {
                        const n = (function (e) {
                                return 'gold' === e ? s.B3.GOLD : s.B3.INTEGRAL;
                            })(t),
                            r = s.Z5.getNumberFormat(e, n);
                        ...
                        const k = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            C = (0, r.useCallback)(() => {
                                (k.current.isVisible && k.current.timeoutId) ||
                                    (u(n, p, { isMouseEvent: !0, on: !0, arguments: d(o) }, P),
                                    y && y(),
                                      ...
                                      Object.assign(
                                          {
                                              ...
                                              onClick: ((e) => (t) => {
                                                  (!1 === E && M(), null == c || c(t), null == e || e(t));
                                              })(t.props.onClick),
                                              onMouseDown: ((e) => (t) => {
                                                  (!1 === E && M(), null == s || s(t), null == e || e(t));
                                              })(t.props.onMouseDown),
                                          },
                                          T,
                                      ),
                        ...
                        return [
                            function ({ mode: e = 'real', options: i, children: a, mocks: s }) {
                                const c = (0, r.useRef)([]),
                                    ...
                                    _ = u[0],
                                    v = u[1],
                                    h = (0, r.useState)(() => l(e, i, s)),
                                    g = h[0],
                                    f = h[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        d.current ? f(l(_, i, s)) : (d.current = !0);
                                    }, [s, _, i]),
                                    (0, r.useEffect)(() => {
                                        v(e);
                                    }, [e]),
                ...
                engine.whenReady.then(() => {
                    a().render(o().createElement(g, null, o().createElement(y, null)), document.getElementById('root'));
                });
            },
            7363: (e) => {
                e.exports = React;
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/views/ProxyCurrencyView/ProxyCurrencyView'),
        (() => {
            var e = { 'lobby/views/ProxyCurrencyView/ProxyCurrencyView': 0 };
