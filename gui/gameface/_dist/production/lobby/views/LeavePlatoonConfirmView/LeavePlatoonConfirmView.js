(() => {
    ...
    var __webpack_modules__ = {
            ...
            3935: (u, e, t) => {
                    ...
                    return (
                        ((u) => {
                            ...
                            if (
                                ...
                                F.current = p.addCallback(n, t, a, e === w.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== w.None)
                                return () => {
                                    p.removeCallback(F.current, a);
                                };
                        }, [a, e]),
                        E
                    );
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (H(t, d, { isMouseEvent: !0, on: !0, arguments: P(r) }, w),
                                    h && h(),
                    ...
                    V = ({ content: u, classMix: e }) => {
                        ...
                        return (
                            ...
                            r().createElement(
                                j,
                                { isEnabled: i, body: u },
                                r().createElement('div', { ref: t, className: y()('TextOverflow_base_3b', e) }, u),
                            )
                        );
                    };
                let q;
                ...
                const K = (0, n.memo)(
                    ({ onClick: u, isFocused: e, buttonID: t, isDisabled: o, label: i, tooltip: a, type: s }) => {
                        ...
                        const F = (0, n.useMemo)(() => {
                            ...
                            c = y()(
                                ...
                                a.type !== q.absent && 'DialogTemplateButton_label__noTooltip_14',
                            );
                        return r().createElement(
                            N,
                            F,
                            r().createElement(
                                ...
                                r().createElement(
                                    S,
                                    { size: O.medium, type: s, disabled: o, onClick: l, isFocused: e },
                                    r().createElement(V, { classMix: c, content: i || '' }),
                                ),
                            ),
                        );
                    },
                ...
                const z = (0, n.memo)(() => {
                        ...
                        return (
                            ...
                            r().createElement(
                                ...
                                i.map(({ value: e }, n) =>
                                    r().createElement(K, G({ key: e.buttonID, isFocused: n === t, onClick: u }, e)),
                                ),
                            )
                        );
                    }),
                ...
                class X extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = y()(Y.base, Y[`base__${i}`], Y[`base__${o}`], null == a ? void 0 : a.base),
                            d = y()(Y.icon, Y[`icon__${i}`], Y[`icon__${o}`], null == a ? void 0 : a.icon),
                            _ = y()(Y.glow, null == a ? void 0 : a.glow),
                            D = y()(Y.caption, Y[`caption__${i}`], null == a ? void 0 : a.caption),
                            B = y()(Y.goto, null == a ? void 0 : a.goto);
                        return r().createElement(
                            'div',
                            Z(
                                {
                ...
                const eu = E.O.client.getSize('rem'),
                    tu = eu.width,
                    nu = eu.height,
                    ru = Object.assign(
                        { width: tu, height: nu },
                    ...
                    au = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && E) return J(e, t, h);
                            if (t.largeWidth && A) return J(e, t, h);
                            if (t.mediumWidth && F) return J(e, t, h);
                            if (t.smallWidth && c) return J(e, t, h);
                            if (t.extraSmallWidth && d) return J(e, t, h);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
                    ...
                    lu = (0, n.memo)(
                        ({
                            ...
                            const c = ((u, e) => Object.keys(e).reduce((e, t) => ((e[t] = u.includes(t)), e), {}))(
                                ...
                                g = y()(su.icon, d && su.icon__responsive),
                                v = y()(su.title, d && su.title__responsive),
                                p = y()(su.closeBtn, _ && su.closeBtn__responsive),
                                w = y()(
                                    su.divider,
                ...
                const Fu = (u) => (0 === u ? window : window.subViews.get(u)),
                    cu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: o, children: i, mocks: a }) {
                                const s = (0, n.useRef)([]),
                                    A = (u, t, n) => {
                                        var r;
                                        const o = (function ({
                                            ...
                                            F = (({ observableModel: u }) =>
                                                Object.assign({}, u.primitives(['reason']), {
                                    ...
                                    d = c[0],
                                    _ = c[1],
                                    D = (0, n.useState)(() => A(u, o, a)),
                                    B = D[0],
                                    C = D[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        F.current ? C(A(d, o, a)) : (F.current = !0);
                                    }, [a, d, o]),
                                    (0, n.useEffect)(() => {
                                        _(u);
                                    }, [u]),
                    ...
                    })(0, ({ externalModel: u }) => ({ close: u.createCallbackNoArgs('onCloseClicked') })),
                    du = cu[0],
                    _u = cu[1],
                    Du = R.strings.battle_royale.leavePlatoonConfirm,
                    Bu = (0, _.Pi)(() => {
                        const u = _u(),
                            e = u.controls,
                            t = u.model,
                            n =
                                ((o = t.displayFlags.get()),
                                (i = s),
                                Array.isArray(o)
                                    ? o.map(i)
                                    : o.map((u, e, t) => i(null == u ? void 0 : u.value, e, t)));
                        var o, i, l;
                        return (
                            (l = e.close),
                            d(A.n.ESCAPE, l),
                            r().createElement(lu, {
                                ...
                                title: r().createElement(
                                    'div',
                                    { className: 'App_title_3e' },
                                    a(Du.header, t.reason.get()),
                                ),
                                content: r().createElement(
                                    'div',
                                    { className: 'App_content_81' },
                                    a(Du.description, t.reason.get()),
                                ),
                                buttons: r().createElement(z, null),
                                displayFlags: n,
                            })
                        );
                    });
                engine.whenReady.then(() => {
                    i().render(
                        r().createElement(du, null, r().createElement(Bu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(3935));
