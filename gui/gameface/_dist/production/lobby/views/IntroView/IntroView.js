(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                (t.r(e),
                    t.d(e, { mouse: () => E, off: () => o, on: () => s, onResize: () => a, onScaleUpdated: () => n }));
                var r = t(2472),
                    i = t(1176);
            ...
            3138: (u, e, t) => {
                ...
                var r = t(5959),
                    i = t(7698),
                    a = t(514);
                const n = { view: t(7641), client: r, sound: a.ZP, intl: i.N };
            },
            7698: (u, e, t) => {
                'use strict';
                t.d(e, { N: () => r });
            ...
            514: (u, e, t) => {
                ...
                const i = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    a = Object.keys(i).reduce((u, e) => ((u[e] = () => (0, r.playSound)(i[e])), u), {}),
                    n = { play: Object.assign({}, a, { sound: r.playSound }), setRTPC: r.setRTPC };
            },
            3722: (u, e, t) => {
                'use strict';
                function r(u, e, t = 1) {
            ...
            7087: (u, e, t) => {
                ...
                var l = t(9916);
                const E = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                                ...
                                ((u) =>
                                    ((u, e) =>
                                        u.split('.').reduce((u, e) => {
                                            ...
                                            return E(t) ? ((u, e) => `${u}.${e}.value`)(u, e) : `${u}.${e}`;
                                        }))(u))(_),
                            ),
                        ),
                        B = D[0],
                    ...
                    return (
                        ((u) => {
                            ...
                            if (
                                                ...
                                                const e = s(),
                                                    ...
                                                    i =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: i, modelPath: A(i, ''), resId: r };
                                            })(),
                                            t = e.modelPrefix,
                                            r = u.split('.');
                                        if (r.length > 0) {
                                ...
                                C.current = F.addCallback(r, t, c, e === d.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (e !== d.None)
                                return () => {
                                    F.removeCallback(C.current, c);
                                };
                        }, [c, e]),
                        B
                    );
                ...
                const v = ({
                        ...
                        return (
                            ...
                            i().createElement(
                                'div',
                                {
                                    ...
                                    onMouseDown: function (u) {
                                        t ||
                                            (null !== _ && B(_),
                                            o && o(u),
                                            F && (t || (m.current && (m.current.focus(), w(!0)))),
                                            p(!0));
                                    },
                                ...
                                i().createElement(
                                    'span',
                                    { className: D()(C.state, C.state__default) },
                ...
                var p;
                function L(u = f.O.client.getSize('rem')) {
                    const e = u.width,
                        t = u.height;
                ...
                (0, r.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && E) return w(e, t, h);
                        if (t.largeWidth && A) return w(e, t, h);
                        if (t.mediumWidth && F) return w(e, t, h);
                        if (t.smallWidth && d) return w(e, t, h);
                        if (t.extraSmallWidth && c) return w(e, t, h);
                        if (
                ...
                const M = ({ children: u }) => {
                    ...
                    return (
                        ...
                        i().createElement(S.Provider, { value: t }, s && u)
                    );
                };
                let T, O, k;
                (!(function (u) {
                ...
                const P = () => {
                    ...
                    return { mediaSize: i, mediaWidth: a, mediaHeight: n, remScreenWidth: e, remScreenHeight: t };
                };
                let H;
                (t(1281),
                    (function (u) {
                ...
                const I =
                    ...
                    N = ({ icon: u, title: e, descr: t }) => {
                        ...
                        return i().createElement(
                            ...
                            i().createElement('div', { className: 'DescriptionBlock_title_41' }, e),
                            i().createElement('div', {
                ...
                function U(u = W.n.NONE, e = G, t = !1, i = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== W.n.NONE)
                            return (
                        ...
                        function r(r) {
                            if (r.keyCode === u) {
                                if (!i && f.O.view.isEventHandled()) return;
                ...
                const z = (0, r.createContext)({}),
                    q = (0, r.memo)(
                        ({
                            ...
                            const E = (0, r.useRef)(null),
                                ...
                                P = b === k && !t,
                                H = 1 !== k,
                                I = (0, r.useMemo)(() => ({ isAnimationDisabled: x }), [x]),
                                N = (function () {
                                    var u = j(function* () {
                                        if (E && E.current) {
                                            (y(!0), yield (0, l.Eu)());
                                            ...
                                            (h(E.current.offsetWidth / u),
                                                w(E.current.querySelector(`.${V.slide__active}`).offsetWidth / u),
                                                setTimeout(() => {
                                                    y(!1);
                                                }, 100));
                                        }
                            ...
                            const G = (0, r.useCallback)(
                                ...
                                q = () => B('highlight');
                            (U(W.n.ARROW_LEFT, G), U(W.n.ARROW_RIGHT, $));
                            const K = (0, r.useMemo)(() => (t ? { width: 'auto' } : { width: `${C}rem` }), [C, t]),
                                Y = (0, r.useMemo)(
                                    () =>
                                        t
                                ...
                                X = (0, r.useMemo)(() => (e ? { top: e } : {}), [e]),
                                Z = D()(
                                    V.base,
                                    F && V.base__large,
                                    t && V.base__carousel,
                                    t && F && V.base__carouselLarge,
                                    x && V.base__withoutAnimation,
                                    T && V.base__withoutPointer,
                                ),
                                Q = D()(V.prev, R && V.prev__disabled),
                                J = D()(V.next, P && V.next__disabled),
                                uu = D()(V.counter, !H && V.counter__disabled);
                            return i().createElement(
                                'div',
                                { className: Z },
                                H && i().createElement('div', { className: Q, onClick: G, onMouseEnter: q, style: X }),
                                H && i().createElement('div', { className: J, onClick: $, onMouseEnter: q, style: X }),
                                n &&
                                    i().createElement(
                                        'div',
                                        { className: uu },
                                        b,
                                        i().createElement('div', { className: V.counterDivider }, '/'),
                                        k,
                                    ),
                                i().createElement(
                                    'div',
                                    { className: V.trackWrapper, ref: E },
                                    i().createElement(
                                        'div',
                                        { className: V.track, style: Y },
                                        c.map((u, e) => {
                                            const r = e + 2 === b,
                                                a = e === b;
                                            let n;
                                            a ? (n = $) : r && (n = G);
                                            let s = D()(V.slide, F && V.slide__large, e + 1 === b && V.slide__active);
                                            return (
                                                t &&
                                                    (s = D()(
                                                        V.slide,
                                                        V.slide__carousel,
                                                        F && V.slide__large,
                                                        e + 1 === b && V.slide__active,
                                                        r && V.slide__beforeActive,
                                                        r && F && V.slide__beforeActiveLarge,
                                                        a && V.slide__afterActive,
                                                        a && F && V.slide__afterActiveLarge,
                                                        e + 2 < b && V.slide__leftEdge,
                                                        e + 2 < b && F && V.slide__leftEdgeLarge,
                                                        e > b && V.slide__rightEdge,
                                                        e > b && F && V.slide__rightEdgeLarge,
                                                    )),
                                                i().createElement(
                                                    'div',
                                                    { className: s, key: `slide-${e}`, style: K, onClick: n },
                                                    i().createElement(z.Provider, { value: I }, u),
                                                )
                                            );
                                        }),
                                    ),
                    ...
                    K = '220rem',
                    Y = '300rem',
                    X = { [T.ExtraSmall]: K, [T.Small]: K, [T.Medium]: '250rem', [T.Large]: Y, [T.ExtraLarge]: Y },
                    Z = ({
                        title: u,
                        about: e,
                        buttonLabel: t,
                        ...
                        const F = (0, r.useState)(!1),
                            ...
                            L = f.mediaHeight,
                            x = X[b],
                            S = L >= k.Medium && p <= O.Small,
                            y = L <= k.Small ? g.small : g.medium,
                            M = D()(
                                'IntroView_base_b9',
                                S && 'IntroView_base__high_98',
                        ...
                        return (
                            ...
                            i().createElement(
                                'div',
                                { className: M, style: { backgroundImage: `url(${l})` } },
                                E &&
                                    i().createElement(
                                        i().Fragment,
                                        null,
                                        ...
                                        i().createElement('div', {
                                            className: D()('IntroView_shadow_d5', null == A ? void 0 : A.shadow),
                                        }),
                                    ),
                                i().createElement('span', { className: 'IntroView_title_6a' }, u),
                                i().createElement(
                                    'div',
                                    {
                                    ...
                                    i().createElement('div', { className: 'IntroView_videoIcon_b2' }),
                                    i().createElement('div', { className: 'IntroView_videoText_0b' }, e),
                                ),
                                i().createElement(
                                    'div',
                                ...
                                i().createElement(
                                    ...
                                    i().createElement(
                                        ...
                                        i().createElement(
                                            v,
                                            { type: h.primary, size: y, mixClass: 'IntroView_close_2d', onClick: T },
                                            t,
                                        ),
                                    ),
                                ),
                    ...
                    Q = { shadow: 'App_shadow_33' },
                    J = () => {
                        const u = c('model', d.None),
                            e = u.title,
                            t = u.about,
                            r = u.buttonLabel,
                            a = u.slides,
                ...
                const iu = {
                        [O.ExtraSmall]: '',
                        [O.Small]: eu().SMALL_WIDTH,
                        [O.Medium]: `${eu().SMALL_WIDTH} ${eu().MEDIUM_WIDTH}`,
                        [O.Large]: `${eu().SMALL_WIDTH} ${eu().MEDIUM_WIDTH} ${eu().LARGE_WIDTH}`,
                        [O.ExtraLarge]: `${eu().SMALL_WIDTH} ${eu().MEDIUM_WIDTH} ${eu().LARGE_WIDTH} ${eu().EXTRA_LARGE_WIDTH}`,
                    },
                    au = {
                        [k.ExtraSmall]: '',
                        [k.Small]: eu().SMALL_HEIGHT,
                        [k.Medium]: `${eu().SMALL_HEIGHT} ${eu().MEDIUM_HEIGHT}`,
                        [k.Large]: `${eu().SMALL_HEIGHT} ${eu().MEDIUM_HEIGHT} ${eu().LARGE_HEIGHT}`,
                        [k.ExtraLarge]: `${eu().SMALL_HEIGHT} ${eu().MEDIUM_HEIGHT} ${eu().LARGE_HEIGHT} ${eu().EXTRA_LARGE_HEIGHT}`,
                    },
                    nu = {
                        [T.ExtraSmall]: '',
                        [T.Small]: eu().SMALL,
                        [T.Medium]: `${eu().SMALL} ${eu().MEDIUM}`,
                        [T.Large]: `${eu().SMALL} ${eu().MEDIUM} ${eu().LARGE}`,
                        [T.ExtraLarge]: `${eu().SMALL} ${eu().MEDIUM} ${eu().LARGE} ${eu().EXTRA_LARGE}`,
                    },
                    su = (u) => {
                        let e = u.children,
                            t = u.className,
                        ...
                        const a = P(),
                            ...
                            s = a.mediaHeight,
                            o = a.mediaSize;
                        return i().createElement('div', ru({ className: D()(t, iu[n], au[s], nu[o]) }, r), e);
                    },
                    ou = ['children'],
                    lu = (u) => {
                        let e = u.children,
                        ...
                        return i().createElement(M, null, i().createElement(su, t, e));
                    };
                engine.whenReady.then(() => {
                    n().render(
                        i().createElement(lu, null, i().createElement(J, null)),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/views/IntroView/IntroView'),
        (() => {
            var u = { 'lobby/views/IntroView/IntroView': 0 };
