    ...
    var __webpack_modules__ = {
            ...
            7087: (u, e, t) => {
                    ...
                    return (
                        o(() => {
                            if (
                                ...
                                h.current = d.addCallback(r, t, _, e === c.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (e !== c.None)
                                return () => {
                                    d.removeCallback(h.current, _);
                                };
                        }, [_, e]),
                        m
                    );
                ...
                const G = ({ children: u }) => {
                    ...
                    return a().createElement(I.Provider, { value: E }, u);
                };
                let U, V, $;
                (!(function (u) {
                    ...
                    J = (0, r.memo)(
                        ({
                            ...
                            const o = (0, r.useRef)(null),
                                ...
                                P = b === R && !t,
                                W = 1 !== R,
                                N = (0, r.useMemo)(() => ({ isAnimationDisabled: y }), [y]),
                                G = (function () {
                                    var u = Z(function* () {
                                        if (o && o.current) {
                                            (T(!0), yield (0, E.Eu)());
                            ...
                            const j = (0, r.useMemo)(() => (t ? { width: 'auto' } : { width: `${C}rem` }), [C, t]),
                                z = (0, r.useMemo)(
                                    () =>
                                        t
                            ...
                            return a().createElement(
                                'div',
                                { className: K },
                                W && a().createElement('div', { className: X, onClick: U, onMouseEnter: $, style: q }),
                                W && a().createElement('div', { className: J, onClick: V, onMouseEnter: $, style: q }),
                                n &&
                                    a().createElement(
                                        'div',
                                        { className: uu },
                                    ...
                                    a().createElement(
                                        ...
                                        c.map((u, e) => {
                                            ...
                                            return (
                                                ...
                                                a().createElement(
                                                    'div',
                                                    { className: s, key: `slide-${e}`, style: j, onClick: n },
                                                    a().createElement(Q.Provider, { value: N }, u),
                                                )
                                            );
                                        }),
                                    ),
