(() => {
    var __webpack_modules__ = {
            280: (u, e, t) => {
                ...
                const F = ({
                    ...
                    text: e = '',
                    classMix: t,
                    alignment: a = E.v2.left,
                    formatWithBrackets: F,
                }) => {
                    if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                    const D = F && u ? (0, E.WU)(e, u) : e;
            ...
            7044: (u, e, t) => {
                'use strict';
                t.d(e, { UI: () => r, e1: () => E }), t(3649), t(9916);
                var a = t(8613);
                Date.now();
                const r = a.Ew.getRegionalDateTime,
                    E = a.Ew.getFormattedDateTime;
            },
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => D, off: () => i, on: () => A, onResize: () => E, onScaleUpdated: () => n });
                var a = t(2472),
                    r = t(1176);
                const E = (0, a.E)('clientResized'),
                    ...
                    F = { down: (0, a.E)('mousedown'), up: (0, a.E)('mouseup'), move: (0, a.E)('mousemove') },
                    D = (function () {
            ...
            3138: (u, e, t) => {
                ...
                var a = t(5959),
                    r = t(514);
                const E = { view: t(7641), client: a, sound: r.ZP };
            },
            514: (u, e, t) => {
                'use strict';
                t.d(e, { ZP: () => n });
                ...
                const r = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    E = Object.keys(r).reduce((u, e) => ((u[e] = () => (0, a.playSound)(r[e])), u), {}),
            ...
            3649: (u, e, t) => {
                ...
                const n = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    F = (u, e, t = r.left) => u.split(e).reduce(t === r.left ? A : i, []),
                    D = (() => {
                        const u = new RegExp(
                                          ...
                                          : 'ja' === t
                                            ...
                                            : ((u, e = r.left) => {
                                                  ...
                                                  const a =
                                                      ...
                                                      E = n(u);
                                                  return (
                                                      F(E, /( )/, e).forEach((u) => (t = t.concat(F(u, a, r.left)))), t
                                                  );
                                              })(u, e);
                                  })(u, e),
                        );
            ...
            9916: (u, e, t) => {
                ...
                function c(u, e, t, a, r, E, n) {
                    ...
                    A.done ? e(i) : Promise.resolve(i).then(a, r);
                }
            ...
            6970: (u, e, t) => {
                ...
                const D = n.O.client.getSize('rem'),
                    l = D.width,
                    o = D.height,
                    s = Object.assign({ width: l, height: o }, F(l, o, A)),
                    ...
                    c = (u) => {
                        ...
                        const r = (0, a.useContext)(B),
                            ...
                            f = { extraLarge: m, large: _, medium: h, small: g, extraSmall: v };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && l) return E(e, t, f);
                            if (t.largeWidth && o) return E(e, t, f);
                            if (t.mediumWidth && s) return E(e, t, f);
                            if (t.smallWidth && c) return E(e, t, f);
                ...
                const d = ({ children: u }) => {
                    ...
                    ((u) => {
                        ...
                        n.O.client.events.on('clientResized', D), n.O.client.events.on('self.onScaleUpdated', l);
                    }),
                        (0, a.useEffect)(
                            () => () => {
                ...
                const L = {
                    ...
                    T = (u) => {
                        ...
                        const E = b(),
                            ...
                            A = E.mediaHeight,
                            i = E.mediaSize;
                        return r().createElement('div', x({ className: _()(t, L[n], y[A], S[i]) }, a), e);
                    },
                    O = ['children'],
                    M = (u) => {
                        let e = u.children,
                ...
                const G = ({
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    n ||
                                        (null !== F && P(F),
                                        o && o(u),
                                        t && (n || (c.current && (c.current.focus(), h(!0)))),
                                        f(!0));
                                },
                            ...
                            r().createElement(
                                'span',
                                { className: _()(N.state, N.state__default) },
                ...
                function V(u = j.n.NONE, e = $, t = !1, r = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== j.n.NONE)
                            return (
                ...
                const Q = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const F = (0, a.useRef)([]),
                                    D = (u, t, a) => {
                                        ...
                                        const E = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const i = 'string' == typeof E ? `${a}.${E}` : a,
                                                            F = n.O.view.addModelObserver(i, e, !0);
                                                        return r.set(F, t), u && t(A(E)), F;
                                                    },
                                                    readByPath: A,
                                                    createCallback: (u, e) => {
                                                        const t = A(e);
                                    ...
                                    s = o[0],
                                    B = o[1],
                                    C = (0, a.useState)(() => D(u, E, i)),
                                    c = C[0],
                                    d = C[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        l.current ? d(D(s, E, i)) : (l.current = !0);
                                    }, [i, s, E]),
                                    (0, a.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                    ...
                    uu = J[0],
                    eu = J[1],
                    tu = R.strings.battle_royale.intro,
                    au = (0, q.Pi)(() => {
                        const u = eu(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return (
                            ...
                            r().createElement(
                                'div',
                                { className: _()('App_base_2f', i && 'App_base__video_38') },
                                r().createElement(
                                    'div',
                                    {
                                        className: 'App_buttonContainer_e4',
                                        onClick: () => {
                                            P('play'), F(!0);
                                        },
                                        onMouseEnter: W.playHighlight,
                                    },
                                    r().createElement('div', { className: 'App_icon_16' }),
                                    r().createElement('div', { className: 'App_label_77' }, tu.aboutButton()),
                                ),
                                r().createElement(
                                    'div',
                                    { className: 'App_content_b7' },
                                    r().createElement(K.U, {
                                        startDate: E,
                                        endDate: n,
                                        classNames: {
                                            ...
                                            cardsContainer: 'App_cardsContainer_9b',
                                            img: 'App_img_92',
                                        },
                                    }),
                                    r().createElement(
                                        z,
                                        {
                                            size: s <= w.Small ? U.small : U.medium,
                                            mixClass: 'App_button_e4',
                                            onClick: t.close,
                                        },
                                        tu.button(),
                                    ),
                ...
                engine.whenReady.then(() => {
                    H().render(
                        r().createElement(M, null, r().createElement(uu, null, r().createElement(au, null))),
            ...
            2864: (u, e, t) => {
                ...
                var n = t(7044),
                    A = t(7363),
                    i = t.n(A);
                const F = (0, A.memo)(({ datetime: u, format: e = E.ShortDate, isConvertedToLocal: t = !0 }) =>
                    Object.values(E).includes(e) ? (0, n.UI)(u, e, t) : (0, n.e1)(u, e, t),
                );
                var D = t(280);
                t(3649);
                const l = {
                    ...
                    o = R.strings.battle_royale_infopage,
                    s = R.strings.battle_royale_infopage.infoBlock.card,
                    B = R.images.battle_royale.gui.maps.infopage,
                    C = [
                        {
                            img: B.specialAwards(),
                            title: s.specialAwards.title(),
                            subtitle: s.specialAwards.subtitle(),
                        },
                        { img: B.sealsLuck(), title: s.sealsLuck.title(), subtitle: s.sealsLuck.subtitle() },
                        { img: B.moreGreen(), title: s.moreGreen.title(), subtitle: s.moreGreen.subtitle() },
                    ],
                    c = ({ startDate: u, endDate: e, className: t, classNames: a }) =>
                        i().createElement(
                            'div',
                            { className: r()(l.base, t) },
                            i().createElement(
                                'div',
                                ...
                                i().createElement(
                                    'div',
                                    { className: r()(l.subtitle, null == a ? void 0 : a.subtitle) },
                                    o.infoBlock.subtitle(),
                                ),
                                i().createElement(D.z, {
                                    text: o.subtitle(),
                                    binding: {
                                        startDate: i().createElement(F, { datetime: u, format: E.ShortDate }),
                                        endDate: i().createElement(F, { datetime: e, format: E.ShortDate }),
                                    },
                                    classMix: l.eventTime,
                                }),
                            ),
                            i().createElement(
                                'div',
                                { className: r()(l.cardsContainer, null == a ? void 0 : a.cardsContainer) },
                                C.map(({ img: u, title: e, subtitle: t }, E) =>
                                    i().createElement(
                                        'div',
                                        { className: l.card, key: E },
                                        i().createElement('div', {
                                            className: r()(l.img, null == a ? void 0 : a.img),
                                            style: { backgroundImage: `url(${u})` },
                                        }),
                                        i().createElement('div', { className: l.cardTitle }, e),
                                        i().createElement('div', { className: l.cardSubtitle }, t),
                                    ),
                                ),
                            ),
                        );
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(6970));
