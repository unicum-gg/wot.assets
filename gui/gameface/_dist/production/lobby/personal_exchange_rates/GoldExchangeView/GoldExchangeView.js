            ...
            441: (u, e, t) => {
                ...
                const S = {
                    ...
                    M = (u) => {
                        ...
                        const i = y(),
                            ...
                            s = i.mediaHeight,
                            o = i.mediaSize;
                        return r().createElement('div', w({ className: p()(t, S[a], L[s], N[o]) }, n), e);
                    },
                    I = ['children'];
                const O = (u) => {
                    let e = u.children,
                    ...
                    return r().createElement(h, null, r().createElement(M, t, e));
                };
                var T = t(493),
                    P = t.n(T);
                let k, H, U;
                ...
                const oe = ae,
                    ...
                    Be = ({
                        ...
                        let c;
                        return (
                            t && (c = t.type === Nu.Limited ? (a <= 5 ? pe : void 0) : Ce),
                            r().createElement(
                                Au,
                                { tooltipArgs: c },
                                r().createElement(
                                            ...
                                            r().createElement(
                                                ...
                                                r().createElement(Ee, {
                                                    discount: Object.assign({}, t, {
                                                        format: s ? Mu.Coefficient : t.format,
                                                    }),
                                                    type: u,
                                                }),
                                            ),
                ...
                const ye = fe,
                    ...
                    Ne = 'Footer_currencyWrapper_44',
                    Me = 'Footer_alert_6c',
                    Ie = 'Footer_buttons_5b',
                    Oe = 'Footer_button_2d',
                    Te = R.strings.personal_exchange_rates.common,
                    Pe = ({ onExchange: u, onClose: e, disabled: t, currenciesAfterExchange: n }) =>
                        r().createElement(
                            'div',
                            { className: xe },
                            r().createElement('div', { className: we }),
                            r().createElement('div', { className: Se }, Te.afterExchange()),
                            r().createElement(
                                'div',
                                { className: Le },
                                n.map((u) =>
                                    r().createElement(
                                        'div',
                                        { key: u.currencyType, className: Ne },
                                        r().createElement(Lu, {
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ye,
                                    { size: be.medium, type: 'secondary', mixClass: Oe, onClick: e, soundClick: 'yes' },
                                    Te.cancel(),
                                ),
                            ),
                        ),
                ...
                const Ze = je()(({ observableModel: u, externalModel: e, readByPath: t }) => {
                ...
                const ct = je()(
                    ...
                    Dt = ({ binding: u, text: e = '', classMix: t, alignment: i = Ou.left, formatWithBrackets: a }) => {
                            ...
                            a &&
                                r().createElement(
                                    ...
                                    r().createElement(eu, {
                                        ...
                                        side: 'left',
                                        onClick: a,
                                        classNames: { base: Mt, icon: It, glow: Ot },
                                    }),
                                ),
                        );
                    },
                ...
                engine.whenReady.then(() => {
                    P().render(
                        r().createElement(O, null, r().createElement(lt, null, r().createElement(Xt, null))),
