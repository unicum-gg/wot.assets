(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var i = {};
                (t.r(i), t.d(i, { getBgUrl: () => C, getTextureUrl: () => c }));
                var a = {};
                function A(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            124: (u, e, t) => {
                ...
                const B = n().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            n().createElement(
                                'div',
                                l({}, B, {
                                    className: F()(s.base, s[`base__theme-${A}`], i),
                                    ref: function (u) {
                            ...
                            d(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        r = w(u);
                                    D.current = v.addCallback(r, t, A, e === p.Deep);
                                }
                            }),
                            (0, r.useEffect)(() => {
                                if (e !== p.None)
                                    return () => {
                                        v.removeCallback(D.current, A);
                                    };
                            }, [A, e]),
                            o
                        );
                ...
                const M = E.O.client.getSize('rem'),
                    k = M.width,
                    N = M.height,
                    H = Object.assign({ width: k, height: N }, P(k, N, S)),
                ...
                const I = (u) => {
                    ...
                    const n = (0, r.useContext)(W),
                        ...
                        h = { extraLarge: c, large: C, medium: d, small: _, extraSmall: m };
                    ...
                    (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(W),
                            ...
                            A = (0, r.useCallback)((u, e) => {
                                ...
                                a(Object.assign({ width: t, height: r }, P(t, r, S)));
                            }, []);
                        (d(() => {
                        ...
                        return n().createElement(W.Provider, { value: F }, u);
                    }));
                let V;
                !(function (u) {
                ...
                const z = {
                    ...
                    j = ({ vehicleLevel: u, vehicleType: e, vehicleName: t, size: i, smallIcon: a }) => {
                        const A = y(u),
                            ...
                            o = F()(E.base, z[`base__size${i}`], a && z.base__smallIcon),
                            s = (0, r.useMemo)(
                                () => ({
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                'div',
                                { className: z.typeContainer },
                                n().createElement('div', { className: z.type, style: s }),
                            ),
                            t,
                        );
                    };
                ...
                const G = 'Content_base_98',
                    $ = 'Content_title_48',
                    Y = 'Content_description_86',
                    Z = 'Content_content_16',
                    X = 'Content_caption_e2',
                    Q = 'Content_captionIcon_15',
                    J = 'Content_captionBackground_0d',
                    uu = 'Content_vehicle_bb',
                    eu = 'Content_vehicleMarker_bf',
                    tu = R.strings.awards.multipleAwards.rent.tooltip,
                    ru = () => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                'div',
                                { className: Z },
                                n().createElement('div', { className: $ }, tu.title()),
                                n().createElement('div', { className: Y }, tu.description()),
                                u.map(({ value: u }, e) =>
                                    n().createElement(
                                        'div',
                                        { className: uu, key: `reward-${e}` },
                    ...
                    nu = () => n().createElement(B, null, n().createElement(ru, null));
                engine.whenReady.then(() => {
                    a().render(n().createElement(nu, null), document.getElementById('root'));
                });
            },
        },
