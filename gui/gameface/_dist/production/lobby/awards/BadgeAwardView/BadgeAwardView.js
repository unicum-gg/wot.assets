(() => {
    ...
    var __webpack_modules__ = {
            ...
            858: (u, e, t) => {
                ...
                const l = s.O.client.getSize('rem'),
                    _ = l.width,
                    D = l.height,
                    d = Object.assign({ width: _, height: D }, F(_, D, A)),
                ...
                const C = (u) => {
                    ...
                    const a = (0, n.useContext)(c),
                        ...
                        w = { extraLarge: C, large: m, medium: h, small: g, extraSmall: b };
                ...
                const T = {
                    ...
                    M = ({
                        ...
                        const c = (0, n.useRef)(null),
                            ...
                            M = (0, n.useCallback)(
                                (u) => {
                                    C && null !== c.current && !c.current.contains(u.target) && m(!1);
                                },
                                [C],
                            ),
                            S = (0, n.useCallback)(
                            ...
                            U = b()(
                                ...
                                T[`base__${i}`],
                                {
                                    ...
                                    [T.base__firstHover]: p,
                                },
                                o,
                            ),
                            W = b()(T.state, T.state__default);
                        return (
                            (0, n.useEffect)(
                                () => (
                ...
                M.defaultProps = { type: x.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const S = (0, n.memo)(M);
                let k;
                !(function (u) {
                ...
                const j = (u = 'model', e = K.Deep) => {
                            ...
                            m(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = I(u);
                                    l.current = V.addCallback(n, t, o, e === K.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== K.None)
                                    return () => {
                                        V.removeCallback(l.current, o);
                                    };
                            }, [o, e]),
                            E
                        );
                    },
                    z = (w.Sw.instance, 'Badge_base_18'),
                    G = ({ mixClass: u }) => {
                        const e = j('model', K.None).badgeId,
                            t = (0, n.useMemo)(
                                () => ({
                    ...
                    $ = 'Ribbon_base_95',
                    q = 'Ribbon_ribbon_55',
                    Y = 'Ribbon_ribbon__medium_97',
                    Z = 'Ribbon_ribbon__large_93',
                    X = 'Ribbon_ribbon__extraLarge_21',
                    Q = 'Ribbon_glow_28',
                    J = 'Ribbon_glow__medium_40',
                    uu = 'Ribbon_glow__large_dd',
                    eu = 'Ribbon_lines_16',
                    tu = 'Ribbon_lines__medium_14',
                    nu = 'Ribbon_lines__large_57',
                    au = 'Ribbon_badge_bf',
                    iu = 'Ribbon_badge__small_36',
                    ru = 'Ribbon_badge__large_b9',
                    ou = 'Ribbon_name_4a',
                    su = 'Ribbon_name__small_38',
                    Au = 'Ribbon_name__medium_65',
                    Eu = 'Ribbon_name__large_16',
                    Fu = 'Ribbon_shortDescription_94',
                    lu = 'Ribbon_description_4f',
                    _u = 'Ribbon_description__medium_a8',
                    Du = ({ mixClass: u }) => {
                        const e = j('model', K.None).badgeId,
                            t = (0, n.useContext)(c),
                            i = t.small || t.medium,
                            ...
                            o = b()($, u),
                            s = b()(q, i && Y, r && Z, t.extraLarge && X),
                            A = b()(Q, t.medium && J, r && uu),
                            E = b()(eu, t.medium && tu, r && nu),
                            F = b()(au, t.small && iu, r && ru),
                            l = b()(ou, t.small && su, t.medium && Au, r && Eu),
                            _ = b()(lu, t.medium && _u, r && _u);
                        return a().createElement(
                            ...
                            a().createElement(G, { mixClass: F }),
                            a().createElement('div', { className: l }, R.strings.badge.$dyn(`badge_${e}`)),
                            a().createElement('div', { className: Fu }, R.strings.badge.$dyn(`badge_${e}_descr`)),
                ...
                class Cu extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            _ = b()(du.base, du[`base__${r}`], du[`base__${i}`], null == o ? void 0 : o.base),
                            D = b()(du.icon, du[`icon__${r}`], du[`icon__${i}`], null == o ? void 0 : o.icon),
                            d = b()(du.glow, null == o ? void 0 : o.glow),
                            c = b()(du.caption, du[`caption__${r}`], null == o ? void 0 : o.caption),
                            B = b()(du.goto, null == o ? void 0 : o.goto);
                        return a().createElement(
                            'div',
                            Bu(
                                {
                            ...
                            'info' !== r && a().createElement('div', { className: du.shine }),
                ...
                const mu = 'Header_base_3f',
                    hu = 'Header_label_06',
                    gu = 'Header_label__big_d8',
                    bu = 'Header_label__large_fb',
                    wu = 'Header_close_e6',
                    vu = 'Header_close__large_19',
                    pu = ({ label: u, mixClass: e }) => {
                    ...
                    Mu = () => {
                        ...
                        return a().createElement(
                            'div',
                            { className: fu },
                            a().createElement(pu, { mixClass: Ou, label: R.strings.menu.badge.new() }),
                            a().createElement(Du, { mixClass: Tu }),
                            a().createElement(
                                S,
                                { mixClass: t, type: x.primary, size: y.medium, onClick: w.Sy },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [379], () => __webpack_require__(858));
