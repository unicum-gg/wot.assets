(() => {
    ...
    var __webpack_modules__ = {
            ...
            494: (e, u, t) => {
                ...
                const Y = {
                    ...
                    q = () => {
                        const e = W('model'),
                            ...
                            a = e.mainItemsCount,
                            r = M(['base'], Y),
                            i = h()(r.base, a && Y.base__additional),
                ...
                const Ce = [
                    ...
                    ge = [ce.Gold, ce.Credits, ce.Crystal, ce.FreeXp, ce.NewYearToyFragments],
                ...
                const Ue = ({ children: e, tooltipArgs: u, className: t }) => {
                        ...
                        return r || s
                            ? n().createElement(ye, Le({}, u, { contentId: r || s }), a)
                ...
                const Ye = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    Xe = ({ vehicleLevel: e, vehicleType: u, vehicleName: t, size: r, smallIcon: i }) => {
                        const s = qe(e),
                            o = M(['base'], je),
                            l = h()(o.base, je[`base__size${r}`], i && je.base__smallIcon),
                            _ = (0, a.useMemo)(
                                () => ({
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [379], () => __webpack_require__(494));
