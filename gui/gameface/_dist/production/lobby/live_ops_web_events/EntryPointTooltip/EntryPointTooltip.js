(() => {
    ...
    var __webpack_modules__ = {
            294: (u, e, A) => {
                ...
                var E = {};
                (A.r(E),
                    A.d(E, { mouse: () => s, off: () => a, on: () => i, onResize: () => o, onScaleUpdated: () => B }));
                var t = {};
                (A.r(t),
                    A.d(t, {
                        events: () => E,
                ...
                var F = {};
                (A.r(F), A.d(F, { getBgUrl: () => O, getTextureUrl: () => y }));
                var D = {};
                function n(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const o = n('clientResized'),
                    B = n('self.onScaleUpdated'),
                    i = (u, e) => engine.on(u, e),
                ...
                const v = {
                    ...
                    h = Object.keys(p).reduce((u, e) => ((u[e] = () => c(p[e])), u), {}),
                    w = { play: Object.assign({}, h, { sound: c }), setRTPC: l },
                    b = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    g = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function f(u) {
                    let e = '';
                    for (let A = g.length - 1; A >= 0; A--) for (; u >= g[A]; ) ((e += b[A]), (u -= g[A]));
                    return e;
                }
                ...
                const Du = Object.keys(T).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === T[e]), u), {}),
                    nu = {
                        set: (u, e) => {
                ...
                const iu = { view: D, client: t, sound: w, intl: m };
            },
            358: (u, e, A) => {
                A.d(e, { Z: () => F });
                var E = A(294);
                class t {
                    ...
                    static get instance() {
                        return (window.__dataTracker || (window.__dataTracker = new t()), window.__dataTracker);
                    }
                    clear() {
                    ...
                    addCallback(u, e, A = 0, t = !0) {
                        void 0 === this._updateHandler &&
                            (this._updateHandler = engine.on('viewEnv.onDataChanged', this._emmitDataChanged, this));
                        const F = E.O.view.addModelObserver(u, A, t);
                        return (
                            F > 0
                                ? ((this._callbacks[F] = e),
                                  A > 0 && (this._views[A] ? this._views[A].push(F) : (this._views[A] = [F])))
            ...
            976: (u, e, A) => {
                ...
                function l(u, e, A, E, t, F, D) {
                    ...
                    n.done ? e(r) : Promise.resolve(r).then(E, t);
                }
                ...
                const w = t.instance,
                    b = {
                        ...
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            v(n.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
                        sendShowPopOverEvent: (u, e, A, E, t = R.invalid('resId'), F) => {
                            const D = s.O.view.getViewGlobalPosition(),
                                ...
                                a = r.height,
                                C = {
                                    x: s.O.view.pxToRem(o) + D.x,
                                    y: s.O.view.pxToRem(B) + D.y,
                                    width: s.O.view.pxToRem(i),
                                    height: s.O.view.pxToRem(a),
                                };
                            v(n.POP_OVER, {
                                isMouseEvent: !0,
                                contentID: u,
                        ...
                        dumpViewModel: function u(e) {
                            ...
                            for (const E in e)
                                if (Object.prototype.hasOwnProperty.call(e, E)) {
                                    const t = Object.prototype.toString.call(e[E]);
                                    if (t.startsWith('[object CoherentArrayProxy]')) {
                                        const t = e[E];
                                        A[E] = [];
                                        for (let e = 0; e < t.length; e++) A[E].push({ value: u(t[e].value) });
                                    } else
                                        t.startsWith('[object class BW::WULF::ViewModel')
                                            ? (A[E] = u(e[E]))
                                            : (A[E] = e[E]);
                                }
                            return A;
            ...
            613: (u, e, A) => {
                A.d(e, { Ew: () => F, Z5: () => E, cy: () => t });
                const E = {
                        getNumberFormat: (u, e) => systemLocale.getNumberFormat(u, e),
                        getRealFormat: (u, e, A = 2) => systemLocale.getRealFormat(u, e, A),
            ...
            700: (u, e, A) => {
                ...
                const i = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    s = (u, e, A = o.left) => u.split(e).reduce(A === o.left ? a : C, []),
                    c = (() => {
                        const u = new RegExp(
                            [
                    ...
                    d = (u, e = o.left) => {
                        ...
                        return ((u, e = o.left) => {
                            ...
                            const E =
                                ...
                                t = i(u);
                            return (s(t, /( )/, e).forEach((u) => (A = A.concat(s(u, E, o.left)))), A);
                        })(u, e);
                    };
                A(976);
                var _ = A(613);
                Date.now();
                const v = _.Ew.getRegionalDateTime,
                    m = _.Ew.getFormattedDateTime;
                const p = (0, E.memo)(({ datetime: u, format: e = n.ShortDate, isConvertedToLocal: A = !0 }) =>
                    Object.values(n).includes(e) ? v(u, e, A) : m(u, e, A),
                );
                var h = A(483),
                    w = A.n(h);
                const b = 'FormatText_base_d0',
                    g = ({ binding: u, text: e = '', classMix: A, alignment: F = o.left, formatWithBrackets: D }) => {
                        ...
                        return t().createElement(
                            ...
                            n.split('\n').map((e, D) =>
                                t().createElement(
                                    'div',
                                    { className: w()(b, A), key: `${e}-${D}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : d(u, e))))(
                                        e,
                                        F,
                                        u,
                                    ).map((u, e) => t().createElement(E.Fragment, { key: `${e}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                ...
                const P = t().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        D = u.theme,
                        n = void 0 === D ? 'default' : D,
                        r = (function (u, e) {
                            if (null == u) return {};
                            var A,
                                E,
                    ...
                    return (
                        ...
                        t().createElement(
                            'div',
                            x({}, r, {
                                className: w()(O.base, O[`base__theme-${n}`], F),
                                ref: function (u) {
                                    ((B.current = u), 'function' == typeof e ? e(u) : e && (e.current = u));
                                },
                            }),
                            t().createElement('div', { className: O.decorator }, A),
                        )
                    );
                });
                var k = A(515);
                ...
                function M() {}
                !(function (u) {
                    ((u.PRE_EVENT = 'preEvent'), (u.EVENT_ACTIVE = 'eventActive'), (u.POST_EVENT = 'postEvent'));
                })(S || (S = {}));
                function L() {
                    return !1;
                }
                ...
                function V(u, e) {
                    ...
                    if (
                        ...
                        (A = (function (u, e) {
                            ...
                            if ('Arguments' === A || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(A)) return I(u, e);
                        })(u)) ||
                ...
                var U = A(946);
                const q = R.strings.tooltips.liveOps.entryPointTooltip,
                    z = ((u, e) => {
                        const A = (0, E.createContext)({});
                        return [
                            function ({ mode: F = 'real', options: D, children: n, mocks: r }) {
                                const o = (0, E.useRef)([]),
                                    B = (A, E, t) => {
                                        var F;
                                        const D = (function ({
                                                ...
                                                return {
                                                    subscribe: (A, F) => {
                                                        const n = 'string' == typeof F ? `${E}.${F}` : E,
                                                            r = f.O.view.addModelObserver(n, e, !0);
                                                        return (t.set(r, A), u && A(D(F)), r);
                                                    },
                                                    readByPath: D,
                                                    createCallback: (u, e) => {
                                                        const A = D(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = V(t.keys()); !(u = A()).done; ) F(u.value, e);
                                                    },
                                                    unsubscribe: F,
                                                };
                                            })(E),
                                            ...
                                            a = { mode: A, model: i, externalModel: n, cleanup: B };
                                        return {
                                            model: i,
                                            controls: 'mocks' === A && t ? t.controls(a) : e(a),
                                            externalModel: n,
                                            mode: A,
                                        };
                                    },
                                    ...
                                    C = a[0],
                                    s = a[1],
                                    c = (0, E.useState)(() => B(F, D, r)),
                                    l = c[0],
                                    d = c[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        i.current ? d(B(C, D, r)) : (i.current = !0);
                                    }, [r, C, D]),
                                    (0, E.useEffect)(() => {
                                        s(F);
                                    }, [F]),
                                    (0, E.useEffect)(
                                        () => () => {
                                            (l.externalModel.dispose(), o.current.forEach((u) => u()));
                                        },
                                        [l],
                                    ),
                                    t().createElement(A.Provider, { value: l }, n)
                                );
                            },
                            () => (0, E.useContext)(A),
                        ];
                        ...
                        const e = { root: u.object() },
                            A = (0, U.Om)(() =>
                                e.root.get().state === S.PRE_EVENT
                                    ? { value: e.root.get().eventStartDate, label: q.date.start() }
                                    : e.root.get().state === S.EVENT_ACTIVE
                                      ? { value: e.root.get().eventEndDate, label: q.date.end() }
                                      : null,
                            ),
                            E = (0, U.Om)(() => (e.root.get().state === S.POST_EVENT ? q.results() : q.body())),
                            t = (0, U.Om)(() => e.root.get().state === S.POST_EVENT && q.finished());
                        return Object.assign({}, e, { computes: { date: A, subTitleString: t, bodyString: E } });
                    }, M),
                    W = z[0],
                    G = z[1],
                    K = 'App_base_f3',
                    ...
                    Q = 'App_subTitle_3e',
                    J = (u) => ({
                        icon: t().createElement('div', { className: H }),
                        date: t().createElement(
                            'div',
                            { className: Z },
                            t().createElement(p, { datetime: u, format: n.DayMonthAbbreviatedTime }),
                        ),
                    }),
                    uu = (0, k.Pi)(() => {
                        const u = G().model,
                        ...
                        return t().createElement(
                            ...
                            t().createElement(
                                ...
                                t().createElement(
                                    'div',
                                    { className: Y },
                                    R.strings.tooltips.liveOps.entryPointTooltip.title(),
                                ),
                                t().createElement(
                                    'div',
                                    { className: $ },
                                    e && t().createElement(g, { text: e.label, binding: J(e.value) }),
                                ),
                                t().createElement('div', { className: Q }, u.computes.subTitleString()),
                                t().createElement('div', { className: X }, u.computes.bodyString()),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    D().render(
                        t().createElement(W, null, t().createElement(uu, null)),
        ...
        (__webpack_require__.O = (u, e, A, E) => {
            if (!e) {
                ...
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, A, E] = deferred[r], F = !0, D = 0; D < e.length; D++)
                        (!1 & E || t >= E) &&
        ...
        (() => {
            ...
            var e = (e, A) => {
                    var E,
                        ...
                        r = 0;
                    if (F.some((e) => 0 !== u[e])) {
                        for (E in D) __webpack_require__.o(D, E) && (__webpack_require__.m[E] = D[E]);
                        if (n) var o = n(__webpack_require__);
                    }
                    for (e && e(A); r < F.length; r++)
                        ((t = F[r]), __webpack_require__.o(u, t) && u[t] && u[t][0](), (u[t] = 0));
                    return __webpack_require__.O(o);
                },
                A = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            (A.forEach(e.bind(null, 0)), (A.push = e.bind(null, A.push.bind(A))));
        })());
    var __webpack_exports__ = __webpack_require__.O(void 0, [233], () => __webpack_require__(700));
