(() => {
    ...
    var __webpack_modules__ = {
            99: (u, e, A) => {
                ...
                var E = {};
                A.r(E),
                    A.d(E, { mouse: () => s, off: () => C, on: () => i, onResize: () => B, onScaleUpdated: () => o });
                var F = {};
                A.r(F),
                    A.d(F, {
                        events: () => E,
                ...
                var t = {};
                A.r(t), A.d(t, { getBgUrl: () => y, getTextureUrl: () => g });
                var D = {};
                function n(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const v = {
                    ...
                    p = { play: Object.assign({}, h, { sound: c }), setRTPC: l },
                ...
                const Au = (() => {
                    ...
                    Eu = f,
                    Fu = Object.keys(O).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === O[e]), u), {}),
                    tu = {
                        set: (u, e) => {
            ...
            700: (u, e, A) => {
                ...
                const i = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    s = (u, e, A = B.left) => u.split(e).reduce(A === B.left ? C : a, []),
                    c = (() => {
                        const u = new RegExp(
                    ...
                    d = (u, e = B.left) => {
                        ...
                        return ((u, e = B.left) => {
                            ...
                            const E =
                                ...
                                F = i(u);
                            return s(F, /( )/, e).forEach((u) => (A = A.concat(s(u, E, B.left)))), A;
                        })(u, e);
                    };
                A(976);
                var _ = A(613);
                ...
                const h = (0, E.memo)(({ datetime: u, format: e = n.ShortDate, isConvertedToLocal: A = !0 }) =>
                    Object.values(n).includes(e) ? v(u, e, A) : m(u, e, A),
                );
                var p = A(483),
                    b = A.n(p);
                const w = 'FormatText_base_d0',
                    f = ({ binding: u, text: e = '', classMix: A, alignment: t = B.left, formatWithBrackets: D }) => {
                ...
                const P = F().forwardRef(function (u, e) {
                    let A = u.children,
                        t = u.className,
                        D = u.theme,
                ...
                var U = A(946);
                const z = R.strings.tooltips.liveOps.entryPointTooltip,
                    q = ((u, e) => {
                        const A = (0, E.createContext)({});
                        return [
                            function ({ mode: t = 'real', options: D, children: n, mocks: r }) {
                                const B = (0, E.useRef)([]),
                                    o = (A, E, F) => {
                                        var t;
                                        const D = (function ({
                                                ...
                                                return {
                                                    subscribe: (A, t) => {
                                                        const n = 'string' == typeof t ? `${E}.${t}` : E,
                                                            r = g.O.view.addModelObserver(n, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = V(F.keys()); !(u = A()).done; ) t(u.value, e);
                                                    },
                                                    unsubscribe: t,
                                                };
                                            })(E),
                                            ...
                                            r = (u) =>
                                                'mocks' === A ? (null == F ? void 0 : F.getter(u)) : n.readByPath(u),
                                            ...
                                            C = { mode: A, model: i, externalModel: n, cleanup: o };
                                        return {
                                            model: i,
                                    ...
                                    a = C[0],
                                    s = C[1],
                                    c = (0, E.useState)(() => o(t, D, r)),
                                    l = c[0],
                                    d = c[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        i.current ? d(o(a, D, r)) : (i.current = !0);
                                    }, [r, a, D]),
                                    (0, E.useEffect)(() => {
                                        s(t);
                                    }, [t]),
                        ...
                        const e = { root: u.object() },
                            A = (0, U.Om)(() =>
                                e.root.get().state === S.PRE_EVENT
                                    ? { value: e.root.get().eventStartDate, label: z.date.start() }
                                    : e.root.get().state === S.EVENT_ACTIVE
                                      ? { value: e.root.get().eventEndDate, label: z.date.end() }
                                      : null,
                            ),
                            E = (0, U.Om)(() => (e.root.get().state === S.POST_EVENT ? z.results() : z.body())),
                            F = (0, U.Om)(() => e.root.get().state === S.POST_EVENT && z.finished());
                        return Object.assign({}, e, { computes: { date: A, subTitleString: F, bodyString: E } });
                    }, M),
                    W = q[0],
                    G = q[1],
                    K = 'App_base_f3',
                    H = 'App_icon_51',
                    Y = 'App_title_96',
                    Z = 'App_dateSubtitle_93',
                    $ = 'App_date_30',
                    X = 'App_body_fd',
                    Q = 'App_subTitle_3e',
                    J = (u) => ({
                        icon: F().createElement('div', { className: H }),
                        date: F().createElement(
                            'div',
                            { className: $ },
                            F().createElement(h, { datetime: u, format: n.DayMonthAbbreviatedTime }),
                        ),
                    }),
                    uu = (0, k.Pi)(() => {
                        const u = G().model,
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                F().createElement(
                                    'div',
                                    { className: Z },
                                    e && F().createElement(f, { text: e.label, binding: J(e.value) }),
                                ),
                                F().createElement('div', { className: Q }, u.computes.subTitleString()),
                                F().createElement('div', { className: X }, u.computes.bodyString()),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    D().render(
                        F().createElement(W, null, F().createElement(uu, null)),
        ...
        (__webpack_require__.O = (u, e, A, E) => {
            if (!e) {
                ...
                for (r = 0; r < deferred.length; r++) {
                    for (var [e, A, E] = deferred[r], t = !0, D = 0; D < e.length; D++)
                        (!1 & E || F >= E) &&
