            ...
            877: (u, e, t) => {
                ...
                const D = (u) => {
                    ...
                    const a = (0, r.useContext)(F),
                        ...
                        p = { extraLarge: C, large: B, medium: g, small: h, extraSmall: w };
                ...
                const x = {
                    ...
                    y = (u) => {
                        ...
                        const n = f(),
                            ...
                            i = n.mediaHeight,
                            o = n.mediaSize;
                        return a().createElement('div', S({ className: g()(t, x[s], O[i], L[o]) }, r), e);
                    },
                    P = ['children'];
                const M = (u) => {
                    let e = u.children,
                ...
                class W extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            _ = g()(U.base, U[`base__${s}`], U[`base__${n}`], null == i ? void 0 : i.base),
                            F = g()(U.icon, U[`icon__${s}`], U[`icon__${n}`], null == i ? void 0 : i.icon),
                            d = g()(U.glow, null == i ? void 0 : i.glow),
                            D = g()(U.caption, U[`caption__${s}`], null == i ? void 0 : i.caption),
                            m = g()(U.goto, null == i ? void 0 : i.goto);
                ...
                var nu = t(946);
                const su = [K.SELECTABLE_VEHICLE_FOR_GIFT, K.SELECTABLE_VEHICLE_DISCOUNT],
                    iu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: i, children: o, mocks: l }) {
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        A.current ? C(c(F, i, l)) : (A.current = !0);
                                    }, [l, F, i]),
                                    (0, r.useEffect)(() => {
                                        d(n);
                                    }, [n]),
                        ...
                        ({ observableModel: u }) => {
                            const e = {
                                ...
                                t = (0, nu.Om)(() =>
                                    e.primitives.state.get() === X.WINBACK_PROGRESSION_COMPLETED
                                        ? a()
                                ...
                                i = (0, nu.Om)(() => {
                                    const u = [K.VEHICLE_FOR_GIFT, K.VEHICLE_FOR_RENT, K.VEHICLE_DISCOUNT];
                                    return Boolean(au(e.rewards.get(), (e) => u.includes(e.name)).length);
                                }),
                                o = (0, nu.Om)(() => Boolean(a().length));
                ...
                const _u = ({
                    ...
                    const D = (0, r.useRef)(null),
                        ...
                        f = b[1],
                        T = (0, r.useCallback)(() => {
                            s || (D.current && (D.current.focus(), B(!0)));
                        }, [s]),
                        S = (0, r.useCallback)(
                            (u) => {
                        ...
                        I = g()(
                            ...
                            Eu[`base__${n}`],
                            {
                                ...
                                [Eu[`base__${e}`]]: e,
                                [Eu.base__focus]: C,
                                [Eu.base__highlightActive]: w,
                                [Eu.base__firstHover]: v,
                            },
                            i,
                        ),
                        N = g()(Eu.state, Eu.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                ...
                _u.defaultProps = { type: cu.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Fu = (0, r.memo)(_u),
                    du = (u) => {
                        const e = (0, r.useRef)(null),
                            ...
                            a = (0, r.useCallback)(() => {
                                t.current = ((u) => {
                                    ...
                                    r.forEach((u) => (u.style.minWidth = `${s.O.view.pxToRem(a)}rem`));
                                });
                            }, [u]);
                        return (
                            (0, r.useEffect)(
                ...
                const Bu = R.strings.winback.winbackRewardView.buttons,
                    gu = (0, j.Pi)(() => {
                        const u = lu(),
                            e = u.model,
                            t = u.controls,
                            n = (0, r.useContext)(at).secondRowRewardsShowed,
                            s = du(`.${Eu.base}`)[0],
                            i = { size: Au.medium, mixClass: mu, disabled: !n };
                        return e.isFirstProgressionStep.get()
                            ? a().createElement(
                                  ...
                                  a().createElement(
                                      Fu,
                                      Cu({ onClick: t.showQuests, type: cu.primary }, i),
                                      Bu.showQuests(),
                                  ),
                              )
                            : e.computes.hasSelectableRewards() && e.isSelectableAwardAvailable.get()
                              ? a().createElement(
                                    ...
                                    a().createElement(
                                        Fu,
                                        Cu({ onClick: t.selectReward, type: cu.primary }, i),
                                        Bu.selectReward(),
                                    ),
                                    a().createElement(
                                        Fu,
                                        Cu({ onClick: t.close, type: cu.secondary }, i),
                                        Bu.confirm(),
                                    ),
                                )
                              : e.computes.hasOnlyVehicleForGiftReward()
                                ? a().createElement(
                                      ...
                                      a().createElement(
                                          Fu,
                                          Cu({ onClick: t.showVehicle, type: cu.primary }, i),
                                          Bu.showVehicle(),
                                      ),
                                      a().createElement(
                                          Fu,
                                ...
                                : a().createElement(
                                      ...
                                      a().createElement(
                                          Fu,
                                          Cu({ type: cu.primary, onClick: t.close }, i),
                                          Bu.confirm(),
                                      ),
                                  );
                    }),
                    hu = 'App_base_88',
                    wu = 'App_closeButton_eb',
                    pu = 'App_header_c5',
                    bu = 'App_rewards_3b',
                    vu = 'App_rewards__twoRows_d7',
                    Ru = 'App_actions_af',
                    fu = 'App_actions__appear_a0',
                    Tu = {
                        base: 'Header_base_b7',
                    ...
                    Su = R.strings.winback.winbackRewardView,
                    xu = [X.SELECTED_REWARDS, X.PROGRESSION_STEP, X.WINBACK_PROGRESSION_COMPLETED],
                    Ou = [X.REGULAR_PROGRESSION_COMPLETED],
                    Lu = (0, j.Pi)(() => {
                        const u = lu().model.state.get();
                        return a().createElement(
                            'div',
                            { className: Tu.base },
                            xu.includes(u) &&
                                a().createElement(
                                    'div',
                                    { className: g()(Tu.subTitle, Tu.subTitle__top) },
                                    Su.subtitle.winback(),
                                ),
                            a().createElement('div', { className: g()(Tu.title, Tu[`title__${u}`]) }, Su.title.$dyn(u)),
                            Ou.includes(u) &&
                                a().createElement(
                                    'div',
                                    { className: g()(Tu.subTitle, Tu.subTitle__bottom) },
                                    Su.subtitle.regularProgressionCompleted(),
                                ),
                        );
                    });
                var yu = t(30);
                ...
                const Wu = [
                    ...
                    Vu = [Mu.Gold, Mu.Credits, Mu.Crystal, Mu.FreeXp],
                    $u = [Mu.BattlePassPoints, Mu.RacesPoint],
                    zu = [Mu.PremiumPlus, Mu.Premium],
                    ...
                    Qu = (u, e) => {
                        ...
                        switch (e) {
                            ...
                            case ku.CURRENCY:
                            case ku.NUMBER:
                                return a().createElement(Pu, { format: 'integral', value: Number(u) });
                    ...
                    Zu = (u, e) => {
                        return {
                            ...
                            tooltipArgs: Xu({ [Y]: u.tooltipId }, Number(u.tooltipContentId), { ignoreShowDelay: !0 }),
                        };
                        var t;
                    },
                    Ju = (u) => Math.sqrt(1 - Math.pow(u - 1, 2)),
                    ue = 'AnimatedReward_base_89',
                    ee = ({ index: u = 0, delay: e = 0, onEnd: t, children: r }) => {
                        const n = (0, yu.useSpring)({
                            from: { transform: 'translateY(20rem)', opacity: 0 },
                            to: { transform: 'translateY(0rem)', opacity: 1 },
                            delay: e + 100 * u,
                            config: { duration: 400, easing: Ju },
                            onStart: () => {
                                k('gui_random_reward_appear');
                            },
                            onRest: t,
                        });
                        return a().createElement(yu.animated.div, { className: ue, style: n }, r);
                    },
                    te = {
                ...
                const ne = (u, e, t) => {
                    ...
                    ie = (u, e, t = re.left) => u.split(e).reduce(t === re.left ? ne : se, []),
                    oe = (() => {
                        const u = new RegExp(
                        ...
                        return le.includes(t)
                            ...
                            : ((u, e = re.left) => {
                                  ...
                                  const r =
                                      ...
                                      a = u.replace(/&nbsp;/g, ' ');
                                  return (ie(a, /( )/, e).forEach((u) => (t = t.concat(ie(u, r, re.left)))), t);
                              })(u, e);
                    },
                    ce = 'FormatText_base_d0',
                    Ae = ({ binding: u, text: e = '', classMix: t, alignment: n = re.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, s) =>
                                      a().createElement(
                                          'div',
                                          { className: g()(ce, t), key: `${e}-${s}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : Ee(u, e))))(e, n, u).map((u, e) =>
                        ...
                        const w = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, r.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (de(t, F, { isMouseEvent: !0, on: !0, arguments: Fe(a) }, p),
                                    B && B(),
                            ...
                            he(
                                {
                                    contentId:
                                        ...
                                        c ? we.SimpleTooltipHtmlContent('resId') : we.SimpleTooltipContent('resId')),
                ...
                const ve = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        return n || i
                            ? a().createElement(De, be({}, e, { contentId: n || i }), r)
                            : a().createElement(Be, e, r);
                    },
                    Re = {
                    ...
                    Te = ({ size: u, bonus: e, className: t }) => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: g()(Re.base, Re[`base__size${u}`], t) },
                                a().createElement('div', {
                                    className: Re.image,
                                ...
                                a().createElement(
                                    'div',
                                    { className: g()(Re.value, Re[`value__${s}`], Re[`value__${l}`]) },
                                    A,
                                    s === Iu.PremiumPlus &&
                                        '14' === o &&
                                        a().createElement(Ae, {
                ...
                const Oe = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    Me = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Ie = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Ne = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                        ...
                        return a().createElement(Ae, { text: o, classMix: t, binding: s });
                    }),
                    ke = {
                    ...
                    Ue = R.strings.winback.winbackRewardView.selectableReward,
                    He = ({
                        tooltipId: u,
                        tooltipContentId: e,
                        vehicleLvl: t,
                        ...
                        return a().createElement(
                            ve,
                            { tooltipArgs: Xu({ [Y]: u }, Number(e), { ignoreShowDelay: !0 }) },
                            a().createElement(
                                'div',
                                { className: g()(ke.base, ke[`base__size${n}`], s) },
                                a().createElement(
                                    'div',
                                    { className: ke.image },
                                    a().createElement('div', { className: ke.levelMark }, E),
                                    l && a().createElement('div', { className: ke.discountMark }),
                                ),
                                l && 0 !== o && 0 !== i
                                    ? a().createElement(Ae, {
                                          text: Ue.discount(),
                                          binding: {
                                              level: E,
                                              expDiscount: a().createElement(Ne, {
                                                  text: Ue.expDiscount(),
                                                  binding: { expDiscount: o },
                                                  classMix: ke.title__bold,
                                              }),
                                              priceDiscount: a().createElement(Ne, {
                                    ...
                                    : a().createElement(Ae, {
                                          text: l ? Ue.reserveDiscount() : Ue.gift(),
                                          binding: { level: E },
                                          classMix: ke.title,
                                      }),
                            ),
                    ...
                    Ve = R.strings.winback.winbackRewardView.vehicleReward,
                    $e = ({
                        name: u,
                        tooltipId: e,
                        tooltipContentId: t,
                        ...
                        const d = u === K.VEHICLE_FOR_RENT,
                            D = u === K.VEHICLE_DISCOUNT,
                            m = `R.images.gui.maps.shop.vehicles.c_${We[E]}.${ae(n)}`,
                            C = `R.images.gui.maps.icons.filters.nations.${l}`,
                            B = ae(i),
                            h = `R.images.gui.maps.icons.vehicleTypes.${r ? (180 === E ? `elite.${B}` : `big.${B}_elite`) : 180 === E ? `c_24x24.${B}` : `big.${B}`}`;
                        return a().createElement(
                            ve,
                            { tooltipArgs: Xu({ [Y]: e }, Number(t), { ignoreShowDelay: !0 }) },
                            a().createElement(
                                'div',
                                { className: g()(Ge.base, Ge[`base__size${E}`], A) },
                                a().createElement(
                                    'div',
                                    ...
                                    d && a().createElement('div', { className: Ge.rentImage }),
                                    D && a().createElement('div', { className: Ge.discountMark }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: Ge.title },
                                ...
                                a().createElement(
                                    ...
                                    d &&
                                        a().createElement(
                                            'div',
                                            { className: Ge.rent },
                                            a().createElement('div', { className: Ge.rentIcon }),
                                            a().createElement(Ae, { text: Ve.rent(), binding: { days: c } }),
                                        ),
                                    D &&
                                        (0 !== F && 0 !== _
                                            ? a().createElement(Ae, {
                                                  ...
                                                  binding: {
                                                      expDiscount: a().createElement(Ne, {
                                                          ...
                                                          classMix: Ge.discountText__bold,
                                                      }),
                                                      priceDiscount: a().createElement(Ne, {
                                                          text: Ve.priceDiscount(),
                                                          binding: { priceDiscount: _ },
                                                          classMix: Ge.discountText__bold,
                                                      }),
                                                  },
                                                  classMix: Ge.discountText,
                                              })
                                            : a().createElement(Ae, {
                                                  text: Ve.reserveDiscount(),
                                                  classMix: g()(Ge.discountText, Ge.discountText__reserveDiscount),
                                              })),
                                ),
                            ),
                        );
                ...
                const qe = {
                    ...
                    Ye = (0, j.Pi)(({ reward: u }) => {
                        const e = lu().model,
                            ...
                            n = e.computes.hasVehicleRewards() || e.computes.hasSelectableRewards(),
                            s = je[t][r],
                            i = n ? s : qe[t][r];
                        switch (u.name) {
                            ...
                            case K.VEHICLE_FOR_RENT:
                                return a().createElement($e, ze({}, u, { size: s }));
                            case K.SELECTABLE_VEHICLE_FOR_GIFT:
                            case K.SELECTABLE_VEHICLE_DISCOUNT:
                                return a().createElement(He, ze({}, u, { size: s }));
                            default:
                                return a().createElement(Te, {
                                    bonus: u,
                                    size: i,
                                    className: g()(te.reward, n && te[`reward__offset${i}`]),
                                });
                        }
                    }),
                    Xe = {
                    ...
                    Qe = ({
                        ...
                        return a().createElement(
                            'div',
                            { className: g()(Ke.base, Ke[`base__${r}`], l), style: o },
                            a().createElement(
                                ve,
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: g()(Ke.image, null == E ? void 0 : E.image) },
                                        _ &&
                                            a().createElement('div', {
                                                className: g()(Ke.highlight, null == E ? void 0 : E.highlight),
                                                style: {
                                        ...
                                        e &&
                                            a().createElement('div', {
                                                className: g()(Ke.icon, null == E ? void 0 : E.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        F &&
                                            a().createElement('div', {
                                                className: g()(Ke.overlay, null == E ? void 0 : E.overlay),
                                                style: {
                            ...
                            t &&
                                a().createElement(
                                    ...
                                    { tooltipArgs: A },
                                    a().createElement('div', {
                                        className: g()(Ke.timer, null == E ? void 0 : E.periodicIcon),
                                    }),
                                ),
                        );
                    },
                    Ze = 'SecondRowRewardsResolver_reward_be',
                    Je = {
                    ...
                    ut = ({
                        ...
                        return a().createElement(
                            ve,
                            { tooltipArgs: Xu({ [Y]: t }, Number(r), { ignoreShowDelay: !0 }) },
                            a().createElement(
                                'div',
                                { className: g()(Je.base, Je[`base__${i}`], o) },
                                a().createElement(
                                    'div',
                                    ...
                                    l && a().createElement('div', { className: Je.discountIcon }),
                                    a().createElement('div', { className: Je.levelMark }, Le(n)),
                                ),
                                a().createElement('div', { className: Je.name }, s),
                            ),
                        );
                    };
                function et() {
                ...
                const tt = ({ reward: u }) => {
                        ...
                        switch (u.name) {
                            ...
                            case K.VEHICLE_FOR_GIFT:
                            case K.VEHICLE_DISCOUNT:
                                return a().createElement(ut, et({}, u, { size: e, className: Ze }));
                            default:
                                return a().createElement(Qe, et({}, Zu(u, e), { size: e, className: Ze }));
                        }
                    },
                    rt = (0, j.Pi)(() => {
                        const u = lu().model,
                            ...
                            s = u.computes.getFirstRowRewards(),
                            i = u.computes.getSecondRowRewards(),
                            o = (0, r.useContext)(at),
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: g()(Xe.base, i.length && Xe.base__withSecondRow) },
                                a().createElement(
                                    'div',
                                    { className: Xe.firstRow },
                                    n && a().createElement('div', { className: Xe.glow }),
                                    a().createElement(
                                        'div',
                                        { className: Xe.ribbonWrapper },
                                        a().createElement('div', { className: g()(Xe.ribbon, e && Xe.ribbon__gold) }),
                                    ),
                                    t && a().createElement('div', { className: Xe.lines }),
                                    s.map((u, e) =>
                                        a().createElement(
                                            ee,
                                            {
                                                ...
                                                index: e,
                                                delay: 900,
                                                onEnd: e === s.length - 1 ? A : void 0,
                                            },
                                            a().createElement(Ye, { reward: u }),
                                        ),
                                    ),
                                ),
                                Boolean(i.length) &&
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: Xe.secondRow },
                                        a().createElement(
                                            'div',
                                            { className: Xe.secondRowTitle },
                                            R.strings.winback.winbackRewardView.secondRowTitle(),
                                        ),
                                        a().createElement(
                                            'div',
                                            { className: Xe.secondRowRewards },
                                            i.map((u, e) =>
                                                a().createElement(
                                                    ee,
                                                    {
                                                        ...
                                                        index: e,
                                                        delay: 200,
                                                        onEnd: e === i.length - 1 ? _ : void 0,
                                                    },
                                                    a().createElement(tt, { reward: u }),
                                                ),
                                            ),
                                        ),
                                    ),
                    ...
                    nt = (0, j.Pi)(() => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement('div', { className: pu }, a().createElement(Lu, null)),
                                a().createElement('div', { className: g()(bu, F && vu) }, a().createElement(rt, null)),
                                a().createElement('div', { className: g()(Ru, E && fu) }, a().createElement(gu, null)),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    N().render(
                        a().createElement(ou, null, a().createElement(M, null, a().createElement(nt, null))),
