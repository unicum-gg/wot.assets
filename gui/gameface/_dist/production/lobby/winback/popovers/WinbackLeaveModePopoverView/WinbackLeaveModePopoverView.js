(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => D, off: () => o, on: () => r, onResize: () => A, onScaleUpdated: () => F });
                var n = t(472),
                    E = t(176);
            ...
            138: (u, e, t) => {
                ...
                var n = t(959),
                    E = t(514);
                const A = { view: t(641), client: n, sound: E.ZP };
            },
            514: (u, e, t) => {
                t.d(e, { ZP: () => F });
                var n = t(959);
            ...
            875: (u, e, t) => {
                ...
                const v = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    p = (u, e, t = d.left) => u.split(e).reduce(t === d.left ? m : w, []),
                    b = (() => {
                        const u = new RegExp(
                    ...
                    f = (u, e = d.left) => {
                        ...
                        return ((u, e = d.left) => {
                            ...
                            const n =
                                ...
                                E = v(u);
                            return p(E, /( )/, e).forEach((u) => (t = t.concat(p(u, n, d.left)))), t;
                        })(u, e);
                    },
                    g = 'FormatText_base_d0',
                    y = ({ binding: u, text: e = '', classMix: t, alignment: A = d.left, formatWithBrackets: F }) => {
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((p.current.timeoutId = window.setTimeout(h, D ? 100 : 400)),
                                                      A && A(u),
                                                      y && y(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const z = ['__left', '__right', '__top', '__bottom'],
                    G = (0, n.forwardRef)(
                        ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: A = {} }, F) => {
                            ...
                            return (
                                (0, n.useImperativeHandle)(F, () => ({ updateSize: m })),
                                V(() => {
                                ...
                                E().createElement(
                                    ...
                                    E().createElement(
                                        ...
                                        E().createElement('div', { className: d, style: A.arrow }),
                                    ),
                                )
                            );
                        },
                ...
                function K(u = W.n.NONE, e = q, t = !1, E = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== W.n.NONE)
                            return (
                                ...
                                const i = (0, n.useRef)([]),
                                    D = (t, n, E) => {
                                        ...
                                        const F = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, A) => {
                                                        const r = 'string' == typeof A ? `${n}.${A}` : n,
                                                            o = I.O.view.addModelObserver(r, e, !0);
                                            ...
                                            s = { mode: t, model: a, externalModel: r, cleanup: D };
                                        return {
                                            model: a,
                                    ...
                                    B = s[0],
                                    C = s[1],
                                    c = (0, n.useState)(() => D(A, F, o)),
                                    l = c[0],
                                    d = c[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        a.current ? d(D(B, F, o)) : (a.current = !0);
                                    }, [o, B, F]),
                                    (0, n.useEffect)(() => {
                                        C(A);
                                    }, [A]),
                            ...
                            E().createElement(
                                ...
                                E().createElement(
                                    ...
                                    E().createElement(
                                        'div',
                                        { className: Au },
                                        E().createElement(y, { classMix: Fu, text: su.title() }),
                                        E().createElement(
                                            P,
