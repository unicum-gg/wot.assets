(() => {
    ...
    var __webpack_modules__ = {
            ...
            487: (u, e, t) => {
                        ...
                        return b.includes(t)
                            ...
                            : ((u, e = l.left) => {
                                  ...
                                  const E =
                                      ...
                                      A = u.replace(/&nbsp;/g, ' ');
                                  return (v(A, /( )/, e).forEach((u) => (t = t.concat(v(u, E, l.left)))), t);
                              })(u, e);
                    },
                    p = 'FormatText_base_d0',
                    h = ({ binding: u, text: e = '', classMix: t, alignment: n = l.left }) =>
                        null === e
                        ...
                        const w = (0, E.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            h = (0, E.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (O(t, C, { isMouseEvent: !0, on: !0, arguments: y(A) }, p),
                                    v && v(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((w.current.timeoutId = window.setTimeout(h, i ? 100 : 400)),
                                                      n && n(u),
                                                      M && M(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                            ...
                            P(
                                {
                                    contentId:
                                        ...
                                        a ? T.SimpleTooltipHtmlContent('resId') : T.SimpleTooltipContent('resId')),
                    ...
                    H = (0, E.forwardRef)(
                        ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: n = {} }, F) => {
                            const r = (0, E.useRef)(null),
                                ...
                                C = s[1],
                                c = (0, E.useCallback)(() => {
                                    (i.playClick(), S.O.view.sendEvent.close());
                                }, []),
                                l = (0, E.useCallback)(() => {
                                    i.playHighlight();
                                }, []),
                                d = o()(N.arrow, N[`arrow${U[B]}`]);
                            L(
                                () => (
                                    ...
                                    () => (
                                        ...
                                        ((u) => {
                                            ...
                                            if (D.current) {
                                                ...
                                                (S.O.view.resize(u, e), C(window.decorator.directionType));
                                            }
                                        })
                                    ),
                                    [],
                            ...
                            return (
                                ...
                                A().createElement(
                                    'div',
                                    { className: N.base, ref: D },
                                    A().createElement(
                                        'div',
                                        { className: N.decorator },
                                        A().createElement(
                                            'div',
                                            { className: N.content, ref: r },
                                            u,
                                            window.decorator &&
                ...
                const K = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: F, children: r, mocks: o }) {
                                const D = (0, E.useRef)([]),
                                    i = (t, E, A) => {
                                        var n;
                                        const F = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, n) => {
                                                        const r = 'string' == typeof n ? `${E}.${n}` : E,
                                                            o = S.O.view.addModelObserver(r, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = z(A.keys()); !(u = t()).done; ) n(u.value, e);
                                                    },
                                                    unsubscribe: n,
                                                };
                                            })(E),
                    ...
                    Q = 'App_title_43',
                    J = 'App_info_99',
                    uu = 'App_description_a7',
                    eu = 'App_battlesLeft_d8',
                    tu = 'App_battlesCount_11',
                    Eu = 'App_button_c9',
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                A().createElement(
                                    'div',
                                    { className: Z },
                                    A().createElement(h, { classMix: Q, text: Au.title() }),
                                    A().createElement(
                                        k,
                                ...
                                A().createElement(h, { classMix: uu, text: Au.description() }),
                                A().createElement(h, {
                                    classMix: eu,
                                ...
                                A().createElement(
                                    c,
                                    { mixClass: Eu, onClick: t.close },
                                    A().createElement(h, { text: Au.turnOff() }),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    F().render(
                        A().createElement(Y, null, A().createElement(nu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [241], () => __webpack_require__(487));
