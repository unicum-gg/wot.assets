(() => {
    ...
    var __webpack_modules__ = {
            ...
            138: (u, e, t) => {
                ...
                var n = t(959),
                    E = t(698),
                    A = t(514);
                const r = { view: t(641), client: n, sound: A.ZP, intl: E.N };
            },
            698: (u, e, t) => {
                t.d(e, { N: () => n });
                const n = {
            ...
            875: (u, e, t) => {
                            ...
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    t ||
                                        (null !== v && i(v),
                                        D && D(u),
                                        l && (t || (m.current && (m.current.focus(), b(!0)))),
                                        g(!0));
                                },
                    ...
                    h = (u, e = l.left) => {
                        ...
                        return ((u, e = l.left) => {
                            ...
                            const n =
                                ...
                                E = _(u);
                            return (p(E, /( )/, e).forEach((u) => (t = t.concat(p(u, n, l.left)))), t);
                        })(u, e);
                    },
                        ...
                        const w = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            h = (0, n.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (x(t, C, { isMouseEvent: !0, on: !0, arguments: k(E) }, b),
                                    v && v(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      (w.current.timeoutId = window.setTimeout(h, D ? 100 : 400)),
                                                      A && A(u),
                                                      y && y(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                function q(u = z.n.NONE, e = W, t = !1, E = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== z.n.NONE)
                            return (
                ...
                const uu = ((u, e) => {
                                ...
                                const i = (0, n.useRef)([]),
                                    D = (t, n, E) => {
                                        ...
                                        const r = (function ({
                                            ...
                                            s = { mode: t, model: a, externalModel: F, cleanup: D };
                                        return {
                                            model: a,
                                    ...
                                    B = s[0],
                                    C = s[1],
                                    c = (0, n.useState)(() => D(A, r, o)),
                                    l = c[0],
                                    d = c[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        a.current ? d(D(B, r, o)) : (a.current = !0);
                                    }, [o, B, r]),
                                    (0, n.useEffect)(() => {
                                        C(A);
                                    }, [A]),
                    ...
                    Au = 'App_title_43',
                    ru = 'App_info_99',
                    Fu = 'App_description_a7',
                    ou = 'App_battlesLeft_d8',
                    iu = 'App_battlesCount_11',
                    Du = 'App_button_c9',
                            ...
                            E().createElement(
                                ...
                                E().createElement(
                                    ...
                                    E().createElement(
                                        'div',
                                        { className: Eu },
                                        E().createElement(g, { classMix: Au, text: au.title() }),
                                        E().createElement(
                                            T,
                                    ...
                                    E().createElement(g, { classMix: Fu, text: au.description() }),
                                    E().createElement(g, {
                                        classMix: ou,
                ...
                engine.whenReady.then(() => {
                    r().render(
                        E().createElement(eu, null, E().createElement(su, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [241], () => __webpack_require__(875));
