    ...
    var __webpack_modules__ = {
            ...
            379: (u, e, t) => {
                ...
                const V = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    X = (u, e, t = z.left) => u.split(e).reduce(t === z.left ? K : Y, []),
                    Z = (() => {
                        const u = new RegExp(
                    ...
                    J = (u, e = z.left) => {
                        ...
                        return ((u, e = z.left) => {
                            ...
                            const n =
                                ...
                                r = V(u);
                            return X(r, /( )/, e).forEach((u) => (t = t.concat(X(u, n, z.left)))), t;
                        })(u, e);
                    },
                    uu = 'FormatText_base_d0',
                    eu = ({ binding: u, text: e = '', classMix: t, alignment: a = z.left, formatWithBrackets: E }) => {
                ...
                const Wu = R.strings.winback.dailyQuestsIntroView,
                                ...
                                a &&
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            ...
                                            { className: wu },
                                            r().createElement(au, {
                                                caption: Wu.buttons.close(),
                                                type: 'close',
                                                side: 'right',
                                                onClick: t.close,
                                            }),
                                        ),
                                        r().createElement('div', { className: bu }, Wu.title()),
                                        r().createElement(
                                            'div',
                                            { className: xu },
                                            r().createElement(Pu, {
                                                title: Wu.info.mode.title(),
                                                description: Wu.info.mode.description(),
                                                imageName: Nu.Mode,
                                            }),
                                            r().createElement('div', { className: Lu }),
                                            r().createElement(Pu, {
                                                title: Wu.info.quests.title(),
                                                description: n
                                                    ? Wu.info.quests.descriptionBP()
                                                    : Wu.info.quests.description(),
                                                imageName: n ? Nu.QuestsBP : Nu.Quests,
                                            }),
                                            r().createElement('div', { className: Lu }),
                                            r().createElement(Pu, {
                                                title: Wu.info.rewards.title(),
                                                description: Wu.info.rewards.description(),
                                                imageName: Nu.Rewards,
                                            }),
                                        ),
                                        r().createElement(
                                            'div',
                                            ...
                                            r().createElement(
                                                j,
                                                { size: G.medium, mixClass: yu, onClick: t.close },
                                                r().createElement(eu, { text: Wu.buttons.confirm() }),
                                            ),
                                        ),
                                    ),
                            )
                ...
                engine.whenReady.then(() => {
                    P().render(
                        r().createElement(_u, null, r().createElement(k, null, r().createElement(Gu, null))),
