(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                (t.r(e),
                    t.d(e, { mouse: () => o, off: () => A, on: () => i, onResize: () => a, onScaleUpdated: () => E }));
                var n = t(472),
                    r = t(176);
            ...
            138: (u, e, t) => {
                ...
                var n = t(959),
                    r = t(698),
                    a = t(514);
                const E = { view: t(641), client: n, sound: a.ZP, intl: r.N };
            },
            698: (u, e, t) => {
                'use strict';
                t.d(e, { N: () => n });
            ...
            928: (u, e, t) => {
                ...
                var A;
                function F(u = E.O.client.getSize('rem')) {
                    const e = u.width,
                        t = u.height;
                ...
                const l = ({ children: u }) => {
                    ...
                    return (
                        ...
                        r().createElement(s.Provider, { value: t }, A && u)
                    );
                };
                var B = t(483),
                    c = t.n(B),
                ...
                const w = {
                    ...
                    x = (u) => {
                        ...
                        const a = h(),
                            ...
                            i = a.mediaHeight,
                            A = a.mediaSize;
                        return r().createElement('div', f({ className: c()(t, w[E], p[i], b[A]) }, n), e);
                    },
                    L = ['children'];
                const y = (u) => {
                    let e = u.children,
                    ...
                    return r().createElement(l, null, r().createElement(x, t, e));
                };
                var S = t(533),
                    M = t.n(S);
                function O(u) {
                ...
                const H = ({
                    ...
                    return (
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                'span',
                                { className: c()(T.state, T.state__default) },
                ...
                const U = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    j = (u, e, t = W.left) => u.split(e).reduce(t === W.left ? G : $, []),
                    z = (() => {
                        const u = new RegExp(
                            [
                    ...
                    V = (u, e = W.left) => {
                        ...
                        return ((u, e = W.left) => {
                            ...
                            const n =
                                ...
                                r = U(u);
                            return (j(r, /( )/, e).forEach((u) => (t = t.concat(j(u, n, W.left)))), t);
                        })(u, e);
                    },
                    K = 'FormatText_base_d0',
                    Y = ({ binding: u, text: e = '', classMix: t, alignment: a = W.left, formatWithBrackets: E }) => {
                ...
                const J = (u) => {
                    ...
                    return r().createElement(
                        ...
                        Q(
                            {
                                className: c()(X.base, X[`base__${C}`], X[`base__${l}`], null == i ? void 0 : i.base),
                                onMouseEnter: v,
                                onMouseLeave: f,
                                onMouseDown: w,
                                onMouseUp: p,
                        ...
                        r().createElement(
                            'div',
                            { className: c()(X.icon, X[`icon__${C}`], X[`icon__${l}`], null == i ? void 0 : i.icon) },
                            r().createElement('div', { className: c()(X.glow, null == i ? void 0 : i.glow) }),
                        ),
                        r().createElement(
                            'div',
                            { className: c()(X.caption, X[`caption__${C}`], null == i ? void 0 : i.caption) },
                            e,
                        ),
                        a && r().createElement('div', { className: c()(X.goto, null == i ? void 0 : i.goto) }, a),
                    );
                };
                var uu = t(521);
                t(179);
                ...
                const su = ((u, e) => {
                    ...
                    lu = su[1],
                    Bu = 'App_base_b3',
                    cu = 'App_base__hidden_ec',
                    Cu = 'App_background_7b',
                    du = 'App_bgFoggingAndBlurring_bd',
                    _u = 'App_container_c0',
                    mu = 'App_closeButtonWrapper_5c',
                    gu = 'App_title_cf',
                    hu = 'App_content_52',
                    vu = 'App_spacer_57',
                    fu = 'App_confirmButtonWrapper_6e',
                    wu = 'App_confirmButton_81',
                    pu = 'InfoBlock_base_99',
                    bu = 'InfoBlock_image_5d',
                    xu = 'InfoBlock_title_45',
                    Lu = 'InfoBlock_description_38';
                var yu;
                !(function (u) {
                ...
                const Tu = R.strings.winback.dailyQuestsIntroView,
                                ...
                                a &&
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            ...
                                            { className: mu },
                                            r().createElement(J, {
                                                caption: Tu.buttons.close(),
                                                type: 'close',
                                                side: 'right',
                                                onClick: t.close,
                                            }),
                                        ),
                                        r().createElement('div', { className: gu }, Tu.title()),
                                        r().createElement(
                                            'div',
                                            { className: hu },
                                            r().createElement(Mu, {
                                                title: Tu.info.mode.title(),
                                                description: Tu.info.mode.description(),
                                                imageName: Ou.Mode,
                                            }),
                                            r().createElement('div', { className: vu }),
                                            r().createElement(Mu, {
                                                title: Tu.info.quests.title(),
                                                description: n
                                                    ? Tu.info.quests.descriptionBP()
                                                    : Tu.info.quests.description(),
                                                imageName: n ? Ou.QuestsBP : Ou.Quests,
                                            }),
                                            r().createElement('div', { className: vu }),
                                            r().createElement(Mu, {
                                                title: Tu.info.rewards.title(),
                                                description: Tu.info.rewards.description(),
                                                imageName: Ou.Rewards,
                                            }),
                                        ),
                                        r().createElement(
                                            'div',
                                            ...
                                            r().createElement(
                                                ...
                                                r().createElement(Y, { text: Tu.buttons.confirm() }),
                                            ),
                                        ),
                                    ),
                            )
                ...
                engine.whenReady.then(() => {
                    M().render(
                        r().createElement(Du, null, r().createElement(y, null, r().createElement(Ru, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [241], () => __webpack_require__(928));
