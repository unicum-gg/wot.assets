    ...
    var e,
        n = {
            136: (e, n, t) => {
                ...
                var r = {};
                (t.r(r), t.d(r, { getBgUrl: () => k, getTextureUrl: () => A }));
                var a = {};
                (t.r(a),
                    t.d(a, {
                        addModelObserver: () => J,
                ...
                const S = {
                    ...
                    C = Object.keys(z).reduce((e, n) => ((e[n] = () => P(z[n])), e), {}),
                    M = { play: Object.assign({}, C, { sound: P }), setRTPC: x },
                ...
                const ge = Object.keys(D).reduce((e, n) => ((e[n] = () => viewEnv.getShowingStatus() === D[n]), e), {}),
                    pe = {
                        set: (e, n) => {
                ...
                const xe = d().forwardRef(function (e, n) {
                        let t = e.children,
                            i = e.className,
                            o = e.theme,
                        ...
                        return (
                            ...
                            d().createElement(
                                'div',
                                Pe({}, a, {
                                    className: v()(ye.base, ye[`base__theme-${r}`], i),
                                    ref: function (e) {
                    ...
                    Re = 'App_base_bc87b',
                    _e = 'App_title_d7154',
                    Te = 'App_subtitle_b4546',
                    Se = 'App_description_f7a4e',
                    Oe = 'App_description__indent_ab46b',
                    ze = R.strings.winback.modeInfoTooltip,
                    Ce = () =>
                        d().createElement(
                            xe,
                            null,
                            d().createElement(
                                'div',
                                { className: Re },
                                d().createElement('div', { className: _e }, ze.title()),
                                d().createElement('div', { className: v()(Se, Oe) }, ze.description()),
                                d().createElement('div', { className: Te }, ze.subtitle()),
                                d().createElement('div', { className: Se }, ze.maps()),
                            ),
                        );
                engine.whenReady.then(() => {
                    u().render(d().createElement(Ce, null), document.getElementById('root'));
                });
            },
            363: (e) => {
                e.exports = React;
        ...
        (i.O = (n, t, o, r) => {
            if (!t) {
                ...
                for (u = 0; u < e.length; u++) {
                    for (var [t, o, r] = e[u], s = !0, d = 0; d < t.length; d++)
                        (!1 & r || a >= r) && Object.keys(i.O).every((e) => i.O[e](t[d]))
                            ? t.splice(d--, 1)
                            : ((s = !1), r < a && (a = r));
                    if (s) {
                        e.splice(u--, 1);
