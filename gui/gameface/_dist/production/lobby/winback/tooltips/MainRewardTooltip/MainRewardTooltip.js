    ...
    var __webpack_modules__ = {
            ...
            192: (u, e, t) => {
                        ...
                        null === e
                            ...
                            : r().createElement(
                                  ...
                                  e.split('\n').map((e, A) =>
                                      r().createElement(
                                          'div',
                                          { className: s()(C, t), key: `${e}-${A}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : l(u, e))))(e, E, u).map((u, e) =>
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (P(t, c, { isMouseEvent: !0, on: !0, arguments: T(r) }, w),
                                    m && m(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((g.current.timeoutId = window.setTimeout(b, F ? 100 : 400)),
                                                      E && E(u),
                                                      S && S(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const U = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return E || o
                        ? r().createElement(O, x({}, e, { contentId: E || o }), n)
                        : r().createElement(N, e, n);
                };
                ...
                const q = [
                        ...
                        d.Comp7TokenCouponReward,
                        d.BattleBoosterGift,
                        d.CosmicLootboxCommon,
                        d.CosmicLootboxSilver,
                    ],
                    V = [d.Gold, d.Credits, d.Crystal, d.FreeXp],
                    Y = [d.BattlePassPoints, d.RacesPoint],
                    $ = [d.PremiumPlus, d.Premium],
                    ...
                    X = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: s()(W.base, W[`base__${n}`], F), style: i },
                            r().createElement(
                                U,
                                { tooltipArgs: D, className: W.tooltipWrapper },
                                r().createElement(
                                    r().Fragment,
                                    null,
                                    r().createElement(
                                        'div',
                                        { className: s()(W.image, null == a ? void 0 : a.image) },
                                        c &&
                                            r().createElement('div', {
                                                className: s()(W.highlight, null == a ? void 0 : a.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: s()(W.icon, null == a ? void 0 : a.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        l &&
                                            r().createElement('div', {
                                                className: s()(W.overlay, null == a ? void 0 : a.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: B },
                                    r().createElement('div', {
                                        className: s()(W.timer, null == a ? void 0 : a.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const eu = r().forwardRef(function (u, e) {
                    let t = u.children,
                        E = u.className,
                        A = u.theme,
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            uu({}, i, {
                                className: s()(Z.base, Z[`base__theme-${o}`], E),
                                ref: function (u) {
                ...
                const Cu = ((u, e) => {
                                ...
                                const i = (0, n.useRef)([]),
                                    F = (t, n, r) => {
                                        ...
                                        const A = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const o = 'string' == typeof E ? `${n}.${E}` : n,
                                                            s = K.O.view.addModelObserver(o, e, !0);
                                            ...
                                            D = { mode: t, model: a, externalModel: o, cleanup: F };
                                        return {
                                            model: a,
                                    ...
                                    B = D[0],
                                    c = D[1],
                                    l = (0, n.useState)(() => F(E, A, s)),
                                    C = l[0],
                                    _ = l[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        a.current ? _(F(B, A, s)) : (a.current = !0);
                                    }, [s, B, A]),
                                    (0, n.useEffect)(() => {
                                        c(E);
                                    }, [E]),
                    ...
                    })(({ observableModel: u }) => ({ rewards: u.array('rewards') }), Fu),
                    _u = Cu[0],
                    du = Cu[1],
                    mu = 'App_base_7e',
                    pu = 'App_title_bd',
                    vu = 'App_separator_4e',
                    gu = 'App_description_b9',
                    wu = 'App_rewards_7b',
                    bu = 'App_reward_d4',
                    hu = 'App_label_32',
                    fu = 'App_vehicle_ff',
                    Ru = 'App_vehicleLevel_2e',
                    Tu = 'App_discount_15';
                function Pu() {
                    return (
                        (Pu =
                ...
                const Ou = R.strings.winback.mainRewardTooltip,
                    Su = (0, iu.Pi)(() => {
                        const u = ((u) =>
                            ru(u, (u) => {
                                return {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: mu },
                                r().createElement('div', { className: pu }, Ou.title()),
                                r().createElement('div', { className: gu }, Ou.description()),
                                r().createElement(
                                    'div',
                                    { className: wu },
                                    ...
                                    ru(u, (u, e) =>
                                        r().createElement(
                                            'div',
                                            { key: e, className: bu },
                                            u.name === nu.SELECTABLE_VEHICLE_DISCOUNT && u.vehicleLvl
                                                ? r().createElement(
                                                      'div',
                                                      { className: fu },
                                                      r().createElement('div', { className: Ru }, su(u.vehicleLvl)),
                                                      r().createElement('div', { className: Tu }),
                                                  )
                                                : r().createElement(X, Pu({}, u, { size: p.S48x48 })),
                                            r().createElement(
                                                'div',
                                                { className: hu },
                                                u.name === nu.SELECTABLE_VEHICLE_DISCOUNT && u.vehicleLvl
                                                    ? r().createElement(_, {
                                                          text: Ou.vehicleRewardLabel(),
                                                          binding: { level: su(u.vehicleLvl) },
                                                      })
                                                    : r().createElement(_, { text: u.label }),
                                            ),
                                        ),
                                    ),
                                ),
                ...
                engine.whenReady.then(() => {
                    A().render(
                        r().createElement(_u, null, r().createElement(Su, null)),
