(() => {
    ...
    var __webpack_modules__ = {
            ...
            475: (u, e, t) => {
                ...
                var n = t(157),
                    r = t(133),
                    E = t(925);
                const i = { view: t(553), client: n, sound: E.ZP, intl: r.N };
            },
            133: (u, e, t) => {
                t.d(e, { N: () => n });
                const n = {
            ...
            925: (u, e, t) => {
                ...
                const r = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    ...
                    i = { play: Object.assign({}, E, { sound: n.playSound }), setRTPC: n.setRTPC };
            },
            544: (u, e, t) => {
                function n(u, e, t = 1) {
                    ...
                    f = {
                        ...
                        sendShowPopOverEvent: (u, e, t, n, r = R.invalid('resId'), E) => {
                            const i = l.O.view.getViewGlobalPosition(),
                                ...
                                D = o.height,
                                c = {
                                    x: l.O.view.pxToRem(a) + i.x,
                                    y: l.O.view.pxToRem(s) + i.y,
            ...
            293: (u, e, t) => {
                ...
                const D = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    p = ({ binding: u, text: e = '', classMix: t, alignment: E = s.left, formatWithBrackets: i }) => {
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (S(t, l, { isMouseEvent: !0, on: !0, arguments: y(r) }, b),
                                    m && m(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      (g.current.timeoutId = window.setTimeout(f, s ? 100 : 400)),
                                                      E && E(u),
                                                      h && h(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                            ...
                            L(
                                {
                                    contentId:
                                        ...
                                        F ? U.SimpleTooltipHtmlContent('resId') : U.SimpleTooltipContent('resId')),
                ...
                const V = ({ children: u, tooltipArgs: e, className: t }) => {
                    if (!e) return u;
                    const n = r().createElement('div', { className: t }, u);
                    if (e.header || e.body) return r().createElement(G, e, n);
                    const E = e.contentId;
                    return E ? r().createElement(x, q({}, e, { contentId: E }), n) : r().createElement(k, e, n);
                };
                const z = ({ value: u, format: e = 'integral' }) => {
                    ...
                    Y = [v.Gold, v.Credits, v.Crystal, v.FreeXp],
                    H = [v.BattlePassPoints, v.EquipCoin],
                    j = [v.PremiumPlus, v.Premium],
                    ...
                    J = ({
                        ...
                        const B = ((u, e) => {
                            ...
                            C = ((u) => {
                                ...
                                switch (u) {
                                    ...
                                    case f.ATTACHMENT_RARE:
                                        return T.ATTACHMENT_RARE;
                                    case f.ATTACHMENT_EPIC:
                                        return T.ATTACHMENT_EPIC;
                                    case f.ATTACHMENT_LEGENDARY:
                        ...
                        return r().createElement(
                            'div',
                            {
                                className: A()(Z.base, Z[`base__${n}`], h.includes(u) && Z.base__normalize, F),
                                style: s,
                            },
                            r().createElement(
                                V,
                                { tooltipArgs: c, className: Z.tooltipWrapper },
                                r().createElement(
                                    r().Fragment,
                                    null,
                                    r().createElement(
                                        'div',
                                        { className: A()(Z.image, null == D ? void 0 : D.image) },
                                        B &&
                                            r().createElement('div', {
                                                className: A()(Z.highlight, null == D ? void 0 : D.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: A()(Z.icon, null == D ? void 0 : D.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        C &&
                                            r().createElement('div', {
                                                className: A()(Z.overlay, null == D ? void 0 : D.overlay),
                                                style: {
                                        ...
                                        r().createElement(
                                            'div',
                                            {
                                                className: A()(
                                                    Z.info,
                                                    Z[`info__${u}`],
                                                    o === b.MULTI && Z.info__multi,
                                                    null == D ? void 0 : D.info,
                                                ),
                                            },
                                            d,
                                        ),
                                    a && r().createElement('div', { className: Z.title }, a),
                                ),
                            ),
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: l },
                                    r().createElement('div', {
                                        className: A()(Z.timer, null == D ? void 0 : D.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const ru = r().forwardRef(function (u, e) {
                    let t = u.children,
                        E = u.className,
                        i = u.theme,
                    ...
                    return (
                        (F = () => {
                            ...
                            const e = new ResizeObserver(() => {
                                const e = u.scrollWidth,
                                    t = u.scrollHeight;
                                uu.O.view.resize(e, t);
                                const n = window.getComputedStyle(u);
                                uu.O.view.setSidePaddingsRem({
                        ...
                        r().createElement(
                            'div',
                            nu({}, a, {
                                className: A()(eu.base, eu[`base__theme-${o}`], E),
                                ref: function (u) {
                ...
                const Bu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: i, children: o, mocks: A }) {
                                const a = (0, n.useRef)([]),
                                    s = (t, n, r) => {
                                        var E;
                                        const i = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const o = 'string' == typeof E ? `${n}.${E}` : n,
                                                            A = uu.O.view.addModelObserver(o, e, !0);
                                                        return (r.set(A, t), u && t(i(E)), A);
                                                    },
                                                    readByPath: i,
                                                    createCallback: (u, e) => {
                                                        const t = i(e);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Du(r.keys()); !(u = t()).done;) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(n),
                                            ...
                                            D = { mode: t, model: F, externalModel: o, cleanup: s };
                                        return {
                                            model: F,
                                    ...
                                    c = D[0],
                                    l = D[1],
                                    B = (0, n.useState)(() => s(E, i, A)),
                                    C = B[0],
                                    d = B[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        F.current ? d(s(c, i, A)) : (F.current = !0);
                                    }, [A, c, i]),
                                    (0, n.useEffect)(() => {
                                        l(E);
                                    }, [E]),
                    ...
                    })(({ observableModel: u }) => ({ rewards: u.array('rewards') }), au),
                    Cu = Bu[0],
                    du = Bu[1],
                    _u = 'App_base_e781c',
                    mu = 'App_title_e18bb',
                    pu = 'App_separator_d72cb',
                    vu = 'App_description_dd09c',
                    gu = 'App_rewards_b4592',
                    bu = 'App_reward_e2e33',
                    fu = 'App_label_ff332',
                    wu = 'App_vehicle_c061f',
                    Tu = 'App_vehicleLevel_d62de',
                    hu = 'App_discount_dc027';
                function Ru() {
                    return (
                        (Ru = Object.assign
                            ? Object.assign.bind()
                ...
                const Pu = R.strings.winback.mainRewardTooltip,
                    Ou = (0, Au.Pi)(() => {
                        const u = ((u) =>
                            iu(u, (u) => {
                                return {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: _u },
                                r().createElement('div', { className: mu }, Pu.title()),
                                r().createElement('div', { className: vu }, Pu.description()),
                                r().createElement(
                                    'div',
                                    { className: gu },
                                    ...
                                    iu(u, (u, e) =>
                                        r().createElement(
                                            'div',
                                            { key: e, className: bu },
                                            u.name === Eu.SELECTABLE_VEHICLE_DISCOUNT && u.vehicleLvl
                                                ? r().createElement(
                                                      'div',
                                                      { className: wu },
                                                      r().createElement(
                                                          'div',
                                                          { className: Tu },
                                                          (0, ou.HG)(u.vehicleLvl),
                                                      ),
                                                      r().createElement('div', { className: hu }),
                                                  )
                                                : r().createElement(J, Ru({}, u, { size: g.S48x48 })),
                                            r().createElement(
                                                'div',
                                                { className: fu },
                                                u.name === Eu.SELECTABLE_VEHICLE_DISCOUNT && u.vehicleLvl
                                                    ? r().createElement(p, {
                                                          text: Pu.vehicleRewardLabel(),
                                                          binding: { level: (0, ou.HG)(u.vehicleLvl) },
                                                      })
                ...
                engine.whenReady.then(() => {
                    i().render(
                        r().createElement(Cu, null, r().createElement(Ou, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [241], () => __webpack_require__(293));
