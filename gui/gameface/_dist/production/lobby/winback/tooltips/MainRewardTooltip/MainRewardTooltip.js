(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => a, off: () => A, on: () => i, onResize: () => E, onScaleUpdated: () => o }));
                var n = t(472),
                    r = t(176);
            ...
            138: (u, e, t) => {
                ...
                var n = t(959),
                    r = t(514);
                const E = { view: t(641), client: n, sound: r.ZP };
            },
            514: (u, e, t) => {
                t.d(e, { ZP: () => o });
                var n = t(959);
            ...
            552: (u, e, t) => {
                ...
                const D = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    l = (u, e, t = a.left) => u.split(e).reduce(t === a.left ? c : B, []),
                    C = (() => {
                        const u = new RegExp(
                    ...
                    p = ({ binding: u, text: e = '', classMix: t, alignment: E = a.left, formatWithBrackets: o }) => {
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (I(t, B, { isMouseEvent: !0, on: !0, arguments: k(r) }, b),
                                    m && m(),
                ...
                const z = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const E = e.contentId;
                    return E ? r().createElement(N, Y({}, e, { contentId: E }), n) : r().createElement(x, e, n);
                };
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    s && r().createElement('div', { className: uu.title }, s),
                                ),
                            ),
                            t &&
                                r().createElement(
                                ...
                                const s = (0, n.useRef)([]),
                                    a = (t, n, r) => {
                                        ...
                                        const o = (function ({
                                            ...
                                            D = { mode: t, model: F, externalModel: i, cleanup: a };
                                        return {
                                            model: F,
                                    ...
                                    c = D[0],
                                    B = D[1],
                                    l = (0, n.useState)(() => a(E, o, A)),
                                    C = l[0],
                                    _ = l[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        F.current ? _(a(c, o, A)) : (F.current = !0);
                                    }, [A, c, o]),
                                    (0, n.useEffect)(() => {
                                        B(E);
                                    }, [E]),
                                ...
                                r().createElement(
                                    ...
                                    au(u, (u, e) =>
                                        r().createElement(
                                            'div',
                                            { key: e, className: fu },
                                            u.name === su.SELECTABLE_VEHICLE_DISCOUNT && u.vehicleLvl
                                                ? r().createElement(
                                                      'div',
                                                      { className: Pu },
                                                      r().createElement(
