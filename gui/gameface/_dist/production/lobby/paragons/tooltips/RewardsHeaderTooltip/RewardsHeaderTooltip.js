        ...
        e = {
            ...
            8953: (u, e, t) => {
                ...
                const Hu = {
                    ...
                    Pu = Lu((u) => {
                        let e = u.className,
                            ...
                            y = u.shrink,
                            H = u.flex,
                            T = void 0 === H ? (R || y ? `${R ? 1 : 0} ${y ? 1 : 0} auto` : void 0) : H,
                            O = u.style,
                            P = u.children,
                            W = (function (u, e) {
                                if (null == u) return {};
                        ...
                        return J().createElement('div', yu({ className: a()(Mu.base, ...j, e), style: G }, W), P);
                    });
                let Wu;
                !(function (u) {
                ...
                const Ce = ((u, e) => {
                    ...
                    me = 'App_base_ef',
                    se = 'App_topHeader_27',
                    de = 'App_description_77',
                    ce = 'App_additionalDescription_f3',
                    ge = 'App_divider_a8',
                    _e = R.strings.paragons.allRewards.tooltip;
                var he;
                !(function (u) {
                    ((u.ParagonsPoints = 'paragonsPoints'),
                        (u.HasSelectableRewards = 'hasSelectableRewards'),
                        (u.Finished = 'finished'),
                        (u.Current = 'current'),
                        (u.Next = 'next'));
                })(he || (he = {}));
                const xe = (0, Ee.Pi)(() => {
                    var u, e;
                    const t = oe().model.root.get(),
                        A = t.isLevelAchieved,
                        F = t.isCurrentLevel,
                        E = t.isParagonsPoints,
                        r = t.hasSelectableRewards,
                        D =
                            null !=
                            (u =
                                null ==
                                ...
                                : he.Next,
                        a = _e[D],
                        n = a.$dyn('additionalText');
                    return J().createElement(
                        'div',
                        { className: me },
                        J().createElement('div', { className: se }, J().createElement(Fe, { text: a.title() })),
                        J().createElement('div', { className: de }, J().createElement(Fe, { text: a.text() })),
                        n &&
                            J().createElement(
                                J().Fragment,
                                null,
                                J().createElement('div', { className: ge }),
                                J().createElement('div', { className: ce }, J().createElement(Fe, { text: n })),
                            ),
                    );
                });
                engine.whenReady.then(() => {
