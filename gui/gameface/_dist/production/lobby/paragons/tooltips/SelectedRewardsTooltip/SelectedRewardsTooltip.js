    ...
    var u,
        e = {
            ...
            676: (u, e, t) => {
                ...
                const Eu = J().forwardRef(function (u, e) {
                    let t = u.children,
                        A = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        J().createElement(
                            'div',
                            Au({}, r, {
                                className: a()(eu.base, eu[`base__theme-${F}`], A),
                                ref: function (u) {
                ...
                (0, Z.memo)(({ children: u }) => {
                    ...
                    return J().createElement(cu.Provider, { value: r }, u);
                });
                let hu, xu, pu;
                (!(function (u) {
                        ...
                        const t = (
                            ...
                            (t) => {
                                const A = fu().mediaSize,
                                    E = (0, Z.useMemo)(() => e(t, A), [t, A]);
                                return J().createElement(u, E);
                            }
                        )(u, e);
                        return J().memo((e) =>
                ...
                const Tu = {
                    ...
                    Pu = Lu((u) => {
                        ...
                        const N = (0, Z.useMemo)(() => {
                            ...
                            }, [t, A, r, n, i, l, O, H, w, c, y, f, b]),
                            G = N.computedStyle,
                            j = N.computedClassNames;
                        return J().createElement('div', Ru({ className: a()(yu.base, ...j, e), style: G }, W), P);
                    });
                let Wu;
                !(function (u) {
                ...
                const De = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ae = (u) =>
                        De
                            ? `${u}`
                            : (function (u) {
                ...
                const de = ((u, e) => {
                        ...
                        return [
                            function ({ mode: A = 'real', options: E, children: F, mocks: r }) {
                                    ...
                                    a = (t, A, E) => {
                                        ...
                                        const r = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = le(E.keys()); !(u = t()).done;) F(u.value, e);
                                                    },
                                                    unsubscribe: F,
                                                };
                                            })(A),
                                ...
                                return (
                                    ...
                                    J().createElement(t.Provider, { value: o }, F)
                                );
                            },
                            () => (0, Z.useContext)(t),
                        ];
                        ...
                        const e = { selectedRewards: u.array('selectedRewards') },
                            t = (0, ce.Om)(
                                () => {
                                    return ((u = e.selectedRewards.get()), se(u));
                                    var u;
                                },
                                { equals: ie },
                            );
                    ...
                    xe = 'App_header_31',
                    pe = 'App_title_be',
                    fe = 'App_titleNumber_16',
                    ve = 'App_description_3a',
                    be = 'App_divider_88',
                    we = 'App_vehicle_5d',
                    Se = 'App_vehicleImage_19',
                    Le = 'App_vehicleImageLevel_01',
                    ye = 'App_vehicleText_e3',
                    Me = 'App_vehicleDescription_65',
                    Re = 'App_vehicleName_dd',
                    Te = R.strings.paragons.claimRewards.footer.text.tooltip,
                    He = (0, ne.Pi)(() => {
                        const u = _e().model.computes.getSelectedRewards();
                        return J().createElement(
                            'div',
                            { className: he },
                            J().createElement(
                                ...
                                J().createElement(Ee, {
                                    ...
                                    format: {
                                        binding: {
                                            number: J().createElement(Ee, { className: fe, text: String(u.length) }),
                                        },
                                    },
                                }),
                                J().createElement(Ee, { className: ve, text: Te.description() }),
                            ),
                            J().createElement('div', { className: be }),
                            u.map((u) =>
                                J().createElement(
                                    'div',
                                    { key: u, className: we },
                                    J().createElement(
                                        'div',
                                        { className: Se },
                                        J().createElement(Ee, { className: Le, text: ae(11) }),
                                    ),
                                    J().createElement(
                                        'div',
                                        { className: ye },
                                        J().createElement(Ee, { className: Me, text: Te.vehicleDescription() }),
                                        J().createElement(Ee, { className: Re, text: u }),
                                    ),
                                ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    ru().render(
                        J().createElement(ge, null, J().createElement(Eu, null, J().createElement(He, null))),
