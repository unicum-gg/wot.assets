                    ...
                    ae = (0, Q.memo)(() =>
                        Z().createElement(
                            ...
                            Z().createElement(
                                'div',
                                { className: te },
                                Z().createElement(Fe, { text: Be.tooltip.activeStoragePointsHeader_1() }),
                            ),
                            Z().createElement(
                                'div',
                                { className: De },
                                Z().createElement(Fe, { text: Be.tooltip.activeStoragePointsBody_1() }),
                            ),
                            Z().createElement(
                                'div',
                                { className: re },
                                Z().createElement(Fe, { text: Be.tooltip.activeStoragePointsHeader_2() }),
                            ),
                            Z().createElement(
                                'div',
                                { className: De },
