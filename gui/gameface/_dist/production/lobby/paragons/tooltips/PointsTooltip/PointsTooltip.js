        ...
        e = {
            ...
            4270: (u, e, A) => {
                ...
                const Qu = Object.keys(Ku()),
                    ...
                    te = 'App_base_17',
                    De = 'App_topHeader_9d',
                    re = 'App_description_49',
                    Be = 'App_secondHeader_00',
                    ae = R.strings.paragons.navigation.progression,
                    ne = (0, Z.memo)(() =>
                        J().createElement(
                            'div',
                            { className: te },
                            J().createElement(
                                'div',
                                { className: De },
                                J().createElement(Ee, { text: ae.tooltip.activeStoragePointsHeader_1() }),
                            ),
                            J().createElement(
                                'div',
                                { className: re },
                                J().createElement(Ee, { text: ae.tooltip.activeStoragePointsBody_1() }),
                            ),
                            J().createElement(
                                'div',
                                { className: Be },
                                J().createElement(Ee, { text: ae.tooltip.activeStoragePointsHeader_2() }),
                            ),
                            J().createElement(
                                'div',
                                { className: re },
                                J().createElement(Ee, { text: ae.tooltip.activeStoragePointsBody_2() }),
                            ),
                        ),
                    );
                engine.whenReady.then(() => {
                    Du().render(
                        J().createElement(Eu, null, J().createElement(ne, null)),
