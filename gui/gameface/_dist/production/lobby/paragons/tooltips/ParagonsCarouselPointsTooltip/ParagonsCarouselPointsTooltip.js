            ...
            8976: (u, e, t) => {
                ...
                const Ru = {
                    ...
                    Ou = Su((u) => {
                        ...
                        return Z().createElement('div', yu({ className: a()(Lu.base, ...j, e), style: G }, W), P);
                    });
                let Pu;
                !(function (u) {
                ...
                const ie = ((u, e) => {
                    ...
                    me = 'App_header_1a',
                    se = 'App_divider_12',
                    de = 'App_description_43',
                    ce = 'App_description__withoutAdditional_37',
                    ge = 'App_additionalDescription_17',
                    _e = R.strings.paragons.carousel.tooltips.points,
                    he = (0, Fe.Pi)(() => {
                        const u = le().model.root.get(),
                            e = u.isNeedWin,
                            t = u.isNextVehUnlocked;
                        return Z().createElement(
                            'div',
                            { className: oe },
                            Z().createElement(Ae, { text: _e.header(), className: me }),
                            e &&
                                Z().createElement(
                                    Z().Fragment,
                                    null,
                                    Z().createElement('div', { className: se }),
                                    Z().createElement(Ae, { text: _e.additionalDescription(), className: ge }),
                                    !t && Z().createElement('div', { className: se }),
                                ),
                            !t && Z().createElement(Ae, { text: _e.description(), className: a()(de, !e && ce) }),
                        );
                    });
                engine.whenReady.then(() => {
                    Eu().render(
                        Z().createElement(Ce, null, Z().createElement(Au, null, Z().createElement(he, null))),
