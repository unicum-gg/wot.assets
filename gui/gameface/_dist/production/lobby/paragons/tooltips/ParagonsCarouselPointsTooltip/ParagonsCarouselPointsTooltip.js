            ...
            8976: (u, e, t) => {
                ...
                const Fu = J().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        J().createElement(
                            'div',
                            Au({}, r, {
                                className: n()(eu.base, eu[`base__theme-${E}`], A),
                                ref: function (u) {
                ...
                const Tu = {
                    ...
                    Pu = Lu((u) => {
                        ...
                        return J().createElement('div', Ru({ className: n()(Mu.base, ...j, e), style: G }, W), P);
                    });
                let Wu;
                !(function (u) {
                ...
                const Qu = Object.keys($u()),
                    ...
                    Fe = Lu((u) => {
                        ...
                        return J().createElement(
                            ...
                            qu(
                                {
                                    className: n()(Ku.base, t && Ku[t], _, A),
                                    style: g,
                ...
                const Ce = ((u, e) => {
                                ...
                                const D = (0, Z.useRef)([]),
                                    n = (t, A, F) => {
                                        ...
                                        const r = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const D = 'string' == typeof E ? `${A}.${E}` : A,
                                                            n = Q.view.addModelObserver(D, e, !0);
                                            ...
                                            C = { mode: t, model: i, externalModel: n, cleanup: B };
                                        return {
                                            model: i,
                                    ...
                                    i = B[0],
                                    C = B[1],
                                    l = (0, Z.useState)(() => n(A, F, r)),
                                    o = l[0],
                                    m = l[1];
                                return (
                                    (0, Z.useEffect)(() => {
                                        a.current ? m(n(i, F, r)) : (a.current = !0);
                                    }, [r, i, F]),
                                    (0, Z.useEffect)(() => {
                                        C(A);
                                    }, [A]),
                    ...
                    se = 'App_header_1a',
                    de = 'App_divider_12',
                    ce = 'App_description_43',
                    ge = 'App_description__withoutAdditional_37',
                    _e = 'App_additionalDescription_17',
                    he = R.strings.paragons.carousel.tooltips.points,
                    xe = (0, Ee.Pi)(() => {
                        ...
                        return J().createElement(
                            'div',
                            { className: me },
                            J().createElement(Fe, { text: he.header(), className: se }),
                            e &&
                                J().createElement(
                                    J().Fragment,
                                    null,
                                    J().createElement('div', { className: de }),
                                    J().createElement(Fe, { text: he.additionalDescription(), className: _e }),
                                    !t && J().createElement('div', { className: de }),
                                ),
                            !t && J().createElement(Fe, { text: he.description(), className: n()(ce, !e && ge) }),
                        );
                    });
                engine.whenReady.then(() => {
                    ru().render(
                        J().createElement(le, null, J().createElement(Fu, null, J().createElement(xe, null))),
