        ...
        e = {
            ...
            1264: (u, e, t) => {
                ...
                const Cu = Q.client.getSize('rem'),
                    ou = Cu.width,
                    mu = Cu.height,
                    su = Object.assign({ width: ou, height: mu }, lu(ou, mu, iu)),
                ...
                const gu = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraSmallWidth && C) return nu(e, t, g);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                ...
                const de = ((u, e) => {
                    ...
                    xe = 'App_header_75',
                    pe = 'App_topHeader_45',
                    fe = 'App_description_b4',
                    ve = 'App_secondHeader_8c',
                    be = 'App_availableEquipment_02',
                    we = 'App_availableEquipmentInner_d0',
                    Se = 'App_divider_cc',
                ...
                const ye = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    Re = {
                        base: 'VehicleName_base_0c',
                        nation: 'VehicleName_nation_71',
                        class: 'VehicleName_class_23',
                    },
                    He = ({ vehicleShortName: u, nation: e, level: t, vehicleClass: A, className: r }) => {
                        ...
                        return J().createElement(
                            ...
                            J().createElement('div', { className: Re.nation, style: { backgroundImage: `url(${F})` } }),
                            J().createElement(re, { text: Me(t), className: Re.level }),
                            J().createElement('div', { className: Re.class, style: { backgroundImage: `url(${E})` } }),
                            J().createElement(re, { text: u, className: Re.name }),
                        );
                    },
                    Oe = R.strings.paragons.allRewards.tooltip,
                    We = (0, Fe.Pi)(() => {
                        const u = _e().model.computes.getVehicles();
                        return J().createElement(
                            'div',
                            { className: he },
                            J().createElement(
                                ...
                                J().createElement(
                                    'div',
                                    { className: pe },
                                    J().createElement(re, { text: Oe.branchSelectHeader_1() }),
                                ),
                                J().createElement(
                                    'div',
                                    { className: fe },
                                    J().createElement(re, { text: Oe.branchSelectBody_1() }),
                                ),
                            ),
                            J().createElement('div', { className: Se }),
                            J().createElement(
                                'div',
                                { className: be },
                                J().createElement(
                                    'div',
                                    { className: ve },
                                    J().createElement(re, { text: Oe.branchSelectHeader_2() }),
                                ),
                                J().createElement(
                                    'div',
                                    { className: we },
                ...
                engine.whenReady.then(() => {
                    Eu().render(
                        J().createElement(ge, null, J().createElement(ru, null, J().createElement(We, null))),
