        ...
        e = {
            ...
            4547: (u, e, t) => {
                ...
                const de = ((u, e) => {
                    ...
                    _e = 'App_base_cf',
                    he = 'App_header_c1',
                    xe = 'App_description_c1',
                    pe = 'App_additionalDescription_dc',
                    fe = 'App_divider_3a',
                    ve = (0, Ee.Pi)(() => {
                        ...
                        return J().createElement(
                            'div',
                            { className: _e },
                            e && J().createElement('div', { className: he }, J().createElement(Fe, { text: e })),
                            t && J().createElement('div', { className: xe }, J().createElement(Be, { text: t })),
                            A &&
                                J().createElement(
                                    J().Fragment,
                                    null,
                                    J().createElement('div', { className: fe }),
                                    J().createElement('div', { className: pe }, J().createElement(Fe, { text: A })),
                                ),
                        );
                    });
                engine.whenReady.then(() => {
                    ru().render(
                        J().createElement(ce, null, J().createElement(Fu, null, J().createElement(ve, null))),
