        ...
        e = {
                ...
                const l = {
                    ...
                    o = (0, B.ZP)((u) => {
                        let e = u.className,
                            ...
                            j = u.shrink,
                            X = u.flex,
                            Z = void 0 === X ? (G || j ? `${G ? 1 : 0} ${j ? 1 : 0} auto` : void 0) : X,
                            z = u.style,
                            I = u.children,
                            k = (function (u, e) {
                                if (null == u) return {};
            ...
            3495: (u, e, A) => {
                ...
                const B = E.O.client.getSize('rem'),
                    r = B.width,
                    a = B.height,
                    i = Object.assign({ width: r, height: a }, (0, D.T)(r, a, t.j)),
                    C = (0, F.createContext)(i);
            },
            1039: (u, e, A) => {
                'use strict';
                var E = A(6179),
                ...
                (0, E.memo)(({ children: u }) => {
                    const e = (0, E.useContext)(D.Y),
                        ...
                        n = (0, E.useCallback)((u, e) => {
                            ...
                            C(Object.assign({ width: A, height: E }, (0, r.T)(A, E, B.j)));
                        }, []);
                    ((0, t.Z)(() => {
                        engine.on('clientResized', n);
                    }),
                        (0, E.useEffect)(() => () => engine.off('clientResized', n), [n]));
                    const l = (0, E.useMemo)(() => Object.assign({}, i), [i]);
                            ...
                            o(
                                {
                                    ...
                                    style: w,
                                    mt: !0 === i ? x[A || 'paragraph-P16'].mt : i,
                                    mr: !0 === _ ? x[A || 'paragraph-P16'].mr : _,
                                    mb: !0 === c ? x[A || 'paragraph-P16'].mb : c,
            ...
            5415: (u, e, A) => {
                ...
                const a = () => {
                    ...
                    return { mediaSize: t, mediaWidth: a, mediaHeight: i, remScreenWidth: e, remScreenHeight: A };
                };
            },
            3649: (u, e, A) => {
                'use strict';
                ...
                const t = (u, e, A) => {
                    ...
                    B = (u, e, A = E.left) => u.split(e).reduce(A === E.left ? t : D, []),
                    r = (() => {
                        const u = new RegExp(
                        ...
                        return a.includes(A)
                            ...
                            : ((u, e = E.left) => {
                                  ...
                                  const F =
                                      ...
                                      t = u.replace(/&nbsp;/g, ' ');
                                  return (B(t, /( )/, e).forEach((u) => (A = A.concat(B(u, F, E.left)))), A);
                              })(u, e);
                    },
                    C = (u, e, A) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : i(u, e)));
            },
            5190: (u, e, A) => {
                'use strict';
                var E = A(6483),
        ...
        (E.O = (e, A, F, t) => {
            if (!A) {
                ...
                for (i = 0; i < u.length; i++) {
                    for (var [A, F, t] = u[i], B = !0, r = 0; r < A.length; r++)
            ...
            t = t || 0;
            for (var i = u.length; i > 0 && u[i - 1][2] > t; i--) u[i] = u[i - 1];
            u[i] = [A, F, t];
        }),
        (E.n = (u) => {
