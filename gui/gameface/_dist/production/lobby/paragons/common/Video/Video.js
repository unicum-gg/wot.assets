(() => {
    ...
    var __webpack_modules__ = {
            ...
            1039: (u, e, t) => {
                ...
                (0, r.memo)(({ children: u }) => {
                    ...
                    return E().createElement(i.Y.Provider, { value: l }, u);
                });
            },
            6010: (u, e, t) => {
                var r = t(6179),
                ...
                (0, A.memo)(
                    ({
                        ...
                        const g = (0, A.useRef)(null),
                            w = ((u) => {
                                const e = (0, A.useState)(l(u ? u.current : null)),
                                    t = e[0],
                                    r = e[1];
                                return (
                                    (0, A.useEffect)(() => {
                            ...
                            L = (0, A.useCallback)(() => {
                                ...
                                u &&
                                    (n
                                        ? ((u.currentTime = u.duration - D), u.removeEventListener('play', S), u.play())
                                        : u.pause());
                            }, [S, n, D]);
                        return (
                            (0, A.useEffect)(() => {
                                const u = g.current;
                                return (
                                    u && (u.addEventListener('play', S), u.addEventListener('ended', L)),
                                    () => {
                                        u && (u.removeEventListener('play', S), u.removeEventListener('ended', L));
                                    }
                                );
                            }, [L, S]),
                            (0, A.useEffect)(() => {
                                ...
                                u &&
                                    ...
                                    (a ? (u.pause(), h && h()) : (u.play(), m && v && m()));
                                const e = setInterval(() => {
                                    u && c && c(Math.round(u.currentTime), Math.round(u.duration));
                                }, 500);
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [454], () => __webpack_require__(7115));
