(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                ...
                function C(u, e, t, r, a, E, A) {
                    ...
                    n.done ? e(i) : Promise.resolve(i).then(r, a);
                }
            ...
            2829: (u, e, t) => {
                ...
                const D = A.O.client.getSize('rem'),
                    o = D.width,
                    l = D.height,
                    s = Object.assign({ width: o, height: l }, F(o, l, n)),
                ...
                const C = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && o) return E(e, t, v);
                        if (t.largeWidth && l) return E(e, t, v);
                        if (t.mediumWidth && s) return E(e, t, v);
                ...
                const L = {
                    ...
                    O = (u) => {
                        ...
                        const E = f(),
                            ...
                            n = E.mediaHeight,
                            i = E.mediaSize;
                        return a().createElement('div', S({ className: h()(t, L[A], M[n], T[i]) }, r), e);
                    },
                    y = ['children'];
                const H = (u) => {
                    let e = u.children,
                ...
                const q = {
                    ...
                    Z = X((u) => {
                        let e = u.className,
                            ...
                            C = u.row,
                            c = u.flexDirection,
                            m = void 0 === c ? (_ ? 'column' : C && 'row') || void 0 : c,
                            d = u.flexStart,
                            g = u.center,
                            p = u.flexEnd,
                            v = u.spaceBetween,
                ...
                const J = (u, e, t) => {
                    ...
                    Au = ({ binding: u, text: e = '', classMix: t, alignment: E = Q.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, A) =>
                                      a().createElement(
                                          'div',
                                          { className: h()(Eu, t), key: `${e}-${A}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : au(u, e))))(e, E, u).map((u, e) =>
                ...
                const lu = Object.keys(iu()),
                    ...
                    du = X((u) => {
                        ...
                        return a().createElement(
                            ...
                            ou(
                                {
                                    className: h()(Fu.base, t && Fu[t], p, E),
                                    style: g,
                                    mt: !0 === F ? cu[t || 'paragraph-P16'].mt : F,
                                    mr: !0 === o ? cu[t || 'paragraph-P16'].mr : o,
                                    mb: !0 === s ? cu[t || 'paragraph-P16'].mb : s,
                                    ml: !0 === _ ? cu[t || 'paragraph-P16'].ml : _,
                                },
                                m,
                            ),
                            void 0 !== c ? a().createElement(Au, ou({}, c, { text: e })) : e,
                        );
                    });
                let hu;
                !(function (u) {
                ...
                const Ru = ((u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: n, children: i, mocks: F }) {
                                const D = (0, r.useRef)([]),
                                    o = (t, r, a) => {
                                        var E;
                                        const n = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Mu(a.keys()); !(u = t()).done; ) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(r),
                                    ...
                                    B = s[0],
                                    _ = s[1],
                                    C = (0, r.useState)(() => o(E, n, F)),
                                    c = C[0],
                                    m = C[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? m(o(B, n, F)) : (l.current = !0);
                                    }, [F, B, n]),
                                    (0, r.useEffect)(() => {
                                        _(E);
                                    }, [E]),
                    ...
                    Pu = {
                        base: 'App_base_b1',
                        bg: 'App_bg_5c',
                        base__hover: 'App_base__hover_e8',
                        base__big: 'App_base__big_28',
                        base__wideSmall: 'App_base__wideSmall_b4',
                        base__thinSmall: 'App_base__thinSmall_be',
                        base__thinExtraSmall: 'App_base__thinExtraSmall_55',
                        sequence: 'App_sequence_97',
                        stroke: 'App_stroke_f0',
                        highlight: 'App_highlight_1c',
                        hoverEffect: 'App_hoverEffect_87',
                        titleContainer: 'App_titleContainer_c3',
                        title: 'App_title_61',
                        subtitleContainer: 'App_subtitleContainer_7c',
                        subtitle: 'App_subtitle_73',
                    },
                    ku = 33,
                    Nu = 0,
                    Iu = !0,
                ...
                const ju = (0, r.memo)(function (u) {
                        ...
                        return (
                                                ...
                                                r = window.setInterval(() => {
                                                    ...
                                                    E
                                                        ? (null == n || n(a, E),
                                                          ...
                                                          a === s &&
                                                              (null == d || d(),
                                                              _ || (null == m || m(), window.clearInterval(r))))
                                                        : console.error(
                            ...
                            a().createElement('canvas', Uu({}, g, { width: e, height: t, ref: p }))
                        );
                    }),
                    Xu = (u, e) => {
                        let t = u;
                ...
                const zu = (u) => (u < 0.5 ? 4 * u * u * u : (u - 1) * (2 * u - 2) * (2 * u - 2) + 1);
                let qu;
                !(function (u) {
                    ((u.Big = 'big'),
                ...
                const Vu = {
                    '302*152': qu.Big,
                    '302*114': qu.WideSmall,
                    '222*114': qu.ThinSmall,
                    '162*114': qu.ThinExtraSmall,
                };
                let Yu;
                !(function (u) {
                ...
                const Zu = {
                        base: 'BannerSequence_base_11',
                        sparks: 'BannerSequence_sparks_69',
                        base__thinSmall: 'BannerSequence_base__thinSmall_1d',
                        base__thinExtraSmall: 'BannerSequence_base__thinExtraSmall_17',
                    },
                    Qu = (0, r.memo)(({ type: u = Yu.Normal, cardSize: e = qu.Big, isPerformanceRisk: t = !1 }) => {
                        const r = {
                            width: 300,
                            height: 150,
                            frameCount: 67,
                            ...
                            getChunkPath:
                                ((E = `R.images.gui.maps.icons.paragons.banner.sequence.sparks_${u}_`),
                                (u) => `${E}${u}`),
                        };
                        var E;
                        const A = (function (u) {
                        ...
                        return a().createElement(
                            'div',
                            { className: h()(Zu.base, Zu[`base__${e}`]) },
                            a().createElement(ju, {
                                state: t ? 'stop' : 'play',
                                className: Zu.sparks,
                                width: r.width,
                    ...
                    Ju = (0, r.memo)(
                        ({
                            ...
                            (0, wu.useTransition)(e, {
                                key: e,
                                from: { opacity: E },
                                enter: { opacity: A },
                                leave: { opacity: n },
                                delay: t,
                                config: { duration: r, easing: zu },
                            })((e, t) => t && a().createElement(wu.animated.div, { className: i, style: e }, u)),
                    ),
                    ue = (0, fu.Pi)(() => {
                        const u = (0, r.useState)(!1),
                            ...
                            i = A.height,
                            F = Vu[`${n}*${i}`] || qu.Big,
                            D = h()(Pu.base, Pu[`base__${F}`], e && Pu.base__hover),
                            o = (0, r.useCallback)(() => {
                                (xu.playHighlight(), t(!0));
                            }, []),
                            l = (0, r.useCallback)(() => {
                                t(!1);
                            }, []),
                            s = (0, r.useCallback)(() => {
                                (xu.playClick(), E.onClick());
                            }, [E]),
                            B = (0, wu.useSpring)({
                                from: { x: 10, opacity: 0 },
                                to: { x: 0, opacity: 1 },
                                delay: 0,
                                config: { duration: 800, easing: zu },
                            });
                        return a().createElement(
                            wu.animated.div,
                            { className: D, onClick: s, onMouseLeave: l, onMouseEnter: o, style: B },
                            a().createElement('div', { className: Pu.bg }),
                            a().createElement('div', { className: Pu.stroke }),
                            a().createElement(
                                Ju,
                                { classMix: Pu.sequence, isVisible: e },
                                a().createElement(Qu, { type: Yu.Hover, cardSize: F }),
                            ),
                            a().createElement(Ju, { classMix: Pu.hoverEffect, isVisible: e }),
                            a().createElement(
                                Ju,
                                { classMix: Pu.sequence, isVisible: !e },
                                a().createElement(Qu, { type: Yu.Normal, cardSize: F }),
                            ),
                            a().createElement(du, {
                                format: { classMix: Pu.title },
                                text: R.strings.paragons.banner.title(),
                                className: Pu.titleContainer,
                            }),
                            a().createElement(du, {
                                format: { classMix: Pu.subtitle },
                                text: R.strings.paragons.banner.subTitle(),
                                className: Pu.subtitleContainer,
                            }),
                        );
                    });
                engine.whenReady.then(() => {
                    k().render(
                        a().createElement(yu, null, a().createElement(H, null, a().createElement(ue, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [454], () => __webpack_require__(2829));
