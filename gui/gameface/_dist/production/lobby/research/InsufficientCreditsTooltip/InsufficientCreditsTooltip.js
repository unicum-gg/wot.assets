(() => {
    ...
    var __webpack_modules__ = {
            99: (u, e, t) => {
                ...
                var n = {};
                t.r(n),
                    t.d(n, { mouse: () => D, off: () => _, on: () => s, onResize: () => o, onScaleUpdated: () => a });
                var r = {};
                t.r(r),
                    t.d(r, {
                        events: () => n,
                ...
                var i = {};
                t.r(i), t.d(i, { getBgUrl: () => y, getTextureUrl: () => f });
                var F = {};
                function A(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            916: (u, e, t) => {
                t.d(e, { Sw: () => i.Z, B3: () => E, Z5: () => F.Z5, ry: () => C });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            307: (u, e, t) => {
                ...
                const B = (0, n.memo)(
                    ({
                        ...
                        r().createElement(
                            'span',
                            { className: E()(s.base, s[`base__${t}`], B) },
                            r().createElement(
                                'span',
                                {
                                    className: E()(
                            ...
                            r().createElement('span', {
                                className: E()(s.icon, s[`icon__${n}-${t}`], null == l ? void 0 : l.icon),
                            }),
                            u &&
                                r().createElement(
                                    'span',
                            ...
                            k(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = M(u);
                                    c.current = I.addCallback(n, t, E, e === V.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== V.None)
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (E = 0; E < deferred.length; E++) {
                    for (var [e, t, n] = deferred[E], i = !0, F = 0; F < e.length; F++)
                        (!1 & n || r >= n) &&
