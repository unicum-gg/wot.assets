(() => {
            ...
            257: (u, e, t) => {
                ...
                const c = {
                    ...
                    B = ({
                        ...
                        discountValue: E,
                        showPlus: o,
                        stockBackgroundName: s = _.Red,
                    }) => {
                        const B = i()(c.value, c[`value__${n}`], !A && c.value__notEnough),
                            C = i()(c.icon, c[`icon__${n}-${t}`]),
                            l = i()(c.stock, E && c.stock__indent, e && c.stock__interactive),
                            d = o && F > 0 && '+',
                            v = i()(c.base, c[`base__${t}`]);
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                { className: B },
                                d,
                                r().createElement(D, { value: F, format: n === a.gold ? 'gold' : 'integral' }),
                            ),
                ...
                const p = r().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            r().createElement(
                                'div',
                                w({}, o, {
                                    className: i()(v.base, v[`base__theme-${E}`], A),
                                    ref: function (u) {
                            ...
                            M(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = S(u);
                                    s.current = U.addCallback(n, t, E, e === I.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== I.None)
                                    return () => {
                                        U.removeCallback(s.current, E);
                                    };
                            }, [E, e]),
                            a
                        );
                            ...
                            return r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(C, { value: u, size: 'small', type: 'credits' }),
                                    ),
                                ),
                            );
                        });
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [845], () => __webpack_require__(257));
