(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, A) => {
                ...
                var E = {};
                A.r(E), A.d(E, { getBgUrl: () => c, getTextureUrl: () => _ });
                var n = {};
                function r(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            364: (u, e, A) => {
                ...
                function c(u, e, A, F, t, E, n) {
                    ...
                    r.done ? e(i) : Promise.resolve(i).then(F, t);
                }
                ...
                const p = t.instance,
                    f = {
                        ...
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            v(i.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
                ...
                const C = t().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            t().createElement(
                                'div',
                                s({}, C, {
                                    className: i()(a.base, a[`base__theme-${r}`], E),
                                    ref: function (u) {
                    ...
                    _ = 'Tooltip_base_fc',
                    c = 'Tooltip_compatibleTanksTitle_37';
                let d;
                !(function (u) {
                    ...
                    g = (u) => {
                        const e = ((u) => {
                                const e = w(),
                                    A = e.caller,
                                    F = e.resId,
                                    t = window.__feature && window.__feature !== A && A ? `subViews.${A}` : '';
                                return { modelPrefix: t, modelPath: f(t, u || ''), resId: F };
                            })(),
                            A = e.modelPrefix,
                            F = u.split('.');
                        if (F.length > 0) {
                            ...
                            return (
                                F.reduce((e, F) => {
                                    const t = h(f(A, `${e}.${F}`), window);
                                    return p(t) ? (u.push(t.id), `${e}.${F}.value`) : (u.push(F), `${e}.${F}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                            ...
                            m(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        F = g(u);
                                    B.current = O.addCallback(F, A, r, e === T.Deep);
                                }
                            }),
                            (0, F.useEffect)(() => {
                                if (e !== T.None)
                                    return () => {
                                        O.removeCallback(B.current, r);
                                    };
                            }, [r, e]),
                            D
                        );
                            ...
                            return t().createElement(
                                ...
                                t().createElement(
                                    ...
                                    t().createElement(
                                        'div',
                                        null,
                                        R.strings.dialogs.confirmBuyAndInstall.soldModuleInfo.description(),
                                    ),
                                    t().createElement(
                                        'div',
                                        { className: c },
                                        R.strings.dialogs.confirmBuyAndInstall.soldModuleInfo.compatibleTanks(),
                                    ),
                                    t().createElement('div', null, u.map(({ value: u }) => u).join(', ')),
                                ),
                            );
                        });
                engine.whenReady.then(() => {
                    n().render(t().createElement(P, null), document.getElementById('root'));
                });
            },
        },
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.O = (u, e, A, F) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, A, F] = deferred[i], E = !0, n = 0; n < e.length; n++)
                        (!1 & F || t >= F) &&
            ...
            F = F || 0;
            for (var i = deferred.length; i > 0 && deferred[i - 1][2] > F; i--) deferred[i] = deferred[i - 1];
            deferred[i] = [e, A, F];
        }),
        ...
        (() => {
            ...
            var e = (e, A) => {
                    ...
                    for (e && e(A); i < E.length; i++)
                        (t = E[i]), __webpack_require__.o(u, t) && u[t] && u[t][0](), (u[t] = 0);
                    return __webpack_require__.O(o);
                },
                A = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            A.forEach(e.bind(null, 0)), (A.push = e.bind(null, A.push.bind(A)));
        })();
    var __webpack_exports__ = __webpack_require__.O(void 0, [845], () => __webpack_require__(200));
