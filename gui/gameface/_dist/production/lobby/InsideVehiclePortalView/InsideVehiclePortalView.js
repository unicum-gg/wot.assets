(() => {
    var __webpack_modules__ = {
            ...
            5263: (u, e, t) => {
                ...
                const _ = s.O.client.getSize('rem'),
                    F = _.width,
                    c = _.height,
                    D = Object.assign({ width: F, height: c }, A(F, c, E)),
                ...
                const T = {
                    ...
                    O = (u) => {
                        ...
                        const r = M(),
                            ...
                            o = r.mediaHeight,
                            s = r.mediaSize;
                        return a().createElement('div', S({ className: p()(t, T[i], y[o], k[s]) }, n), e);
                    },
                    N = ['children'],
                    H = (u) => {
                        let e = u.children,
                ...
                const V = (u, e, t) => {
                    ...
                    $ = (u, e, t = U.left) => u.split(e).reduce(t === U.left ? V : j, []),
                    X = (() => {
                        const u = new RegExp(
                    ...
                    return (
                        C(() => {
                            if (
                                ...
                                _.current = uu.addCallback(n, t, o, e === eu.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== eu.None)
                                return () => {
                                    uu.removeCallback(_.current, o);
                                };
                        }, [o, e]),
                        l
                    );
                ...
                const ru = ['xl', 'lg', 'md', 'sm', 'xs'],
                    iu = (u) => u.includes('_') && ((u) => ru.includes(u))(u.split('_').at(-1)),
                    ou = [w.ExtraLarge, w.Large, w.Medium, w.Small, w.ExtraSmall],
                    su = (u, e) =>
                        Object.keys(u).reduce((t, n) => {
                            ...
                            return (
                                void 0 === a ||
                                    ((u, e) => ru.some((t) => void 0 !== e[`${u}_${t}`]))(n, u) ||
                                    (t[n] = a),
                                t
                            );
                        }, {}),
                    Eu = (u, e = su) => {
                        ...
                        return a().memo((e) =>
                            Object.keys(e).some((u) => iu(u) && void 0 !== e[u])
                                ? a().createElement(t, e)
                                : a().createElement(u, e),
                        );
                    },
                ...
                const Fu = {
                    ...
                    mu = Eu((u) => {
                        let e = u.className,
                            ...
                            f =
                                void 0 === w
                                    ...
                                    : w,
                            x = u.alignItems,
                            M = void 0 === x ? (C ? 'flex-start' : h && 'center') || (g && 'flex-end') || void 0 : x,
                            L = u.alignSelf,
                            S = u.wrap,
                            T = u.flexWrap,
                        ...
                        const W = (0, n.useMemo)(() => {
                                const u = { mt: s, mr: l, mb: _, ml: c },
                                    e = ((u) =>
                                        cu.reduce((e, t) => {
                                            const n = u[t];
                                            return n && 'number' != typeof n ? e.concat(Fu[!0 === n ? 'MD' : n][t]) : e;
                                        }, []))(u),
                                    n = ((u) =>
                                        cu.reduce((e, t) => {
                                            const n = u[t];
                                            return ('number' == typeof n && (e[Du[t]] = n + 'rem'), e);
                                        }, {}))(u);
                                return {
                            ...
                            }, [t, r, s, l, _, c, H, N, L, B, y, f, M]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return a().createElement('div', _u({ className: p()(lu.base, ...U, e), style: G }, I), P);
                    }),
                    du = ({ binding: u, text: e = '', classMix: t, alignment: r = U.left }) =>
                        null === e
                ...
                const vu = Object.keys(Cu()),
                    ...
                    Lu = Eu((u) => {
                        ...
                        return a().createElement(
                            ...
                            pu(
                                {
                                    className: p()(hu.base, t && hu[t], g, r),
                                    style: h,
                                    mt: !0 === E ? xu[t || 'paragraph-P16'].mt : E,
                                    mr: !0 === A ? xu[t || 'paragraph-P16'].mr : A,
                                    mb: !0 === F ? xu[t || 'paragraph-P16'].mb : F,
                                    ml: !0 === D ? xu[t || 'paragraph-P16'].ml : D,
                                },
                                B,
                            ),
                            void 0 !== d ? a().createElement(du, pu({}, d, { text: e })) : e,
                        );
                    });
                function Su(u) {
                ...
                const Ou = (0, n.memo)((u) => {
                        let e = u.label,
                            ...
                            o = void 0 !== i && i,
                            s = u.soundHover,
                            E = void 0 === s ? 'highlight' : s,
                            l = u.soundClick,
                            A = void 0 === l ? 'play' : l,
                            _ = u.size,
                            F = void 0 === _ ? Ru.NORMAL : _,
                            c = u.classNames,
                            D = u.onClick,
                            m = u.onMouseEnter,
                            d = u.onMouseLeave,
                        ...
                        const b = (0, n.useState)(!1),
                            ...
                            O = (0, n.useCallback)(
                                (u) => {
                                    T && null !== k.current && !k.current.contains(u.target) && y(!1);
                                },
                                [T],
                            );
                        ((0, n.useEffect)(
                        ...
                        const N = (0, n.useCallback)(
                            ...
                            V = p()(
                                Tu.base,
                                r && Tu.base__visibleLabel,
                                w && Tu.base__mouseDown,
                                M && Tu.base__hovered,
                                T && Tu.base__focused,
                                null == c ? void 0 : c.base,
                            ),
                            j = p()(Tu.icon, Tu[`icon__${F}`], null == c ? void 0 : c.icon),
                            $ = p()(Tu.label, null == c ? void 0 : c.label);
                        return a().createElement(
                            'div',
                            ku(
                                {
                ...
                const Pu = (u, e, t = {}, n = 0) => {
                    ...
                    Iu = (u) => {
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            v = (0, n.useMemo)(() => B || q().resId, [B]),
                            b = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Pu(t, c, { isMouseEvent: !0, on: !0, arguments: Hu(a) }, v),
                                    C && C(),
                            ...
                            Gu(
                                {
                                    contentId:
                                        ...
                                        A ? Uu.SimpleTooltipHtmlContent('resId') : Uu.SimpleTooltipContent('resId')),
                ...
                const Zu = (u) => (u.tooltipType, Yu(u, zu)),
                    Qu = (u) => {
                        let e = u.children,
                            t = u.wrap,
                            n = Yu(u, Ku);
                        const r = t ? a().createElement('div', null, e) : e;
                        return n.tooltipType === qu.Simple
                            ? a().createElement(Vu, Zu(n), r)
                            : n.tooltipType === qu.Backport
                              ? a().createElement(Xu, Zu(n), r)
                              : ((u) => u.tooltipType === qu.Base)(n)
                                ? a().createElement(Iu, Zu(n), r)
                                : e;
                    },
                    Ju = R.strings.event.WtEventPortals,
                    ue = ({ onBuyButtonClick: u }) => {
                        const e = (0, n.useState)(0),
                            t = e[0],
                            r = e[1],
                            i = M().mediaSize >= w.Medium,
                            o = (0, n.useCallback)(() => {
                                (u(), Su('play'));
                            }, [u]),
                            s = (0, n.useCallback)(() => {
                        ...
                        const _ = { tooltipType: qu.Simple, body: Ju.buyButtonTooltip() },
                            F = (0, n.useMemo)(() => ({ width: `${t}px` }), [t]);
                        return a().createElement(
                            Qu,
                            _,
                            a().createElement(
                                'div',
                                { className: 'BuyButton_base_33', style: F, onMouseEnter: s, onClick: o },
                                a().createElement('div', { className: 'BuyButton_image_9e', ref: E }),
                                a().createElement('div', { className: 'BuyButton_imageClickArea_81' }),
                                a().createElement('div', { className: 'BuyButton_text_da', ref: l }, Ju.buyButton()),
                                a().createElement(
                                    'div',
                                    {
                ...
                class ae extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            F = p()(ee.base, ee[`base__${i}`], ee[`base__${r}`], null == o ? void 0 : o.base),
                            c = p()(ee.icon, ee[`icon__${i}`], ee[`icon__${r}`], null == o ? void 0 : o.icon),
                            D = p()(ee.glow, null == o ? void 0 : o.glow),
                            m = p()(ee.caption, ee[`caption__${i}`], null == o ? void 0 : o.caption),
                ...
                const re = ({ onClose: u }) =>
                    ...
                    oe = ({ animationDelayStepsCount: u = 1, children: e }) =>
                        a().createElement(
                            'div',
                            { className: 'DelayedAnimationWrapper_base_af', style: { animationDelay: 100 * u + 'ms' } },
                            e,
                        ),
                    se = R.strings.wt_portals.disabled,
                    Ee = ({ animationDelayStepsCount: u = 1 }) => {
                        const e = (0, n.useMemo)(() => ({ animationDelay: 100 * u + 'ms' }), [u]);
                        return a().createElement(
                            'div',
                    ...
                    const m = (0, n.useRef)(null),
                        ...
                        N = p()(
                            ...
                            le[`base__${r}`],
                            {
                                ...
                                [le[`base__${e}`]]: e,
                                [le.base__focus]: B,
                                [le.base__highlightActive]: g,
                                [le.base__firstHover]: w,
                            },
                            o,
                        ),
                        H = p()(le.state, le.state__default);
                    return (
                        (0, n.useEffect)(
                            () => (
                ...
                const Be = R.strings.event.WtEventPortals,
                    Ce = ({ type: u, lootBoxesCount: e, animationDelayStepsCount: t = 0 }) => {
                        const r = u === me.HUNTER,
                            i = (0, n.useMemo)(() => ({ isHunterLootBox: r }), [r]),
                            o = (0, n.useMemo)(
                                () => ({
                            ...
                            s = (0, n.useMemo)(() => ({ animationDelay: 100 * t + 'ms' }), [t]);
                        return a().createElement(
                            'div',
                            { className: 'LootBoxesCount_base_37', style: s },
                            0 === e
                                ? Be.inside.currentKeysAmountIs0[u]()
                                : a().createElement(du, { text: Be.inside.currentKeysAmount[u](), binding: o }),
                        );
                    },
                    he = 'Footer_vehiclePrice_19',
                    ge = R.strings.wt_portals.insideVehiclePortal,
                    pe = ({ vehiclePrice: u, discount: e, lootBoxesCount: t, onGetVehicleClick: n }) => {
                        const r = Math.round(u * (1 - e / 100)),
                            i = r > t;
                        return a().createElement(
                            'div',
                            { className: 'Footer_base_b5' },
                            a().createElement('div', { className: 'Footer_gradient_3e' }),
                            a().createElement(
                                'div',
                                { className: 'Footer_controlsSection_9d', style: { animationDelay: '600ms' } },
                                a().createElement(
                                    Iu,
                                    {
                                        contentId: R.views.white_tiger.lobby.tooltips.LootBoxTooltipView('resId'),
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: 'Footer_priceContainer_45' },
                                        e
                                            ? a().createElement(
                                                  'div',
                                                  { className: 'Footer_priceWrapper_c0' },
                                                  a().createElement(Lu, {
                                                      className: 'Footer_oldPrice_70',
                                                      text: u.toString(),
                                                  }),
                                                  a().createElement(Lu, { className: he, text: r.toString() }),
                                              )
                                            : a().createElement(Lu, { className: he, text: u.toString() }),
                                        a().createElement('div', { className: 'Footer_priceValue_9a' }),
                                    ),
                                ),
                                a().createElement(
                                    ce,
                                    {
                                        ...
                                        size: _e.medium,
                                        onClick: n,
                                        mixClass: 'Footer_getVehicleButton_9d',
                                        disabled: i,
                            ...
                            a().createElement(Ce, { type: me.BOSS, lootBoxesCount: t, animationDelayStepsCount: 6 }),
                        );
                    },
                    ve = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    be = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3],
                    we = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    fe = R.strings.menu.roleExp,
                    xe = ({ name: u, level: e, type: t, role: n, nation: r }) => {
                        const i = { backgroundImage: `url(${R.images.gui.maps.icons.flags.c_600x450.$dyn(r)})` },
                            o = {
                                backgroundImage: `url(${R.images.gui.maps.icons.vehicleTypes.large.$dyn(((s = t), s.replace(/-/g, '_') + '_elite'))})`,
                            };
                        var s;
                        const E = { backgroundImage: `url(${R.images.gui.maps.icons.roleExp.roles.c_24x24.$dyn(n)})` };
                        return a().createElement(
                            'div',
                            { className: 'Vehicle_base_4d' },
                            a().createElement('div', { className: 'Vehicle_flag_58', style: i }),
                            a().createElement(
                                'div',
                                { className: 'Vehicle_vehicle_a5' },
                                a().createElement(Lu, {
                                    className: 'Vehicle_level_39',
                                    text:
                                        ((l = e),
                                        we
                                            ? `${l}`
                                            : (function (u) {
                                                  ...
                                                  for (let t = be.length - 1; t >= 0; t--)
                                                      for (; u >= be[t]; ) ((e += ve[t]), (u -= be[t]));
                                                  return e;
                                              })(l)),
                                }),
                                a().createElement('div', { className: 'Vehicle_type_14', style: o }),
                                a().createElement(Lu, { className: 'Vehicle_name_97', text: u }),
                            ),
                            a().createElement(
                                Iu,
                                ...
                                a().createElement(
                                    'div',
                                    { className: 'Vehicle_role_ff' },
                                    a().createElement('div', { className: 'Vehicle_roleIcon_28', style: E }),
                                    a().createElement(Lu, {
                                        className: 'Vehicle_roleText_88',
                                        text: fe.roleName.$dyn(n),
                                        format: { binding: { groupName: fe.roleGroupName.$dyn(n) } },
                                    }),
                                ),
                            ),
                        );
                ...
                const Se = {
                    ...
                    Te = ({ discount: u, size: e = Le.x48, className: t }) => {
                        const n = p()(Se.base, Se['base__' + e], t);
                        return a().createElement(
                            'div',
                            { className: n },
                            Me.map((e) =>
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: Se.discountContainer },
                                        a().createElement('div', {
                                            className: p()(
                                                Se.discount,
                                                Se['discount__' + e],
                                                u < e && Se.discount__disabled,
                                                u === e && Se.discount__active,
                                            ),
                                        }),
                                    ),
                                ),
                    ...
                    ye = R.strings.wt_portals.insideVehiclePortal.discount,
                    ke = {
                        [w.ExtraSmall]: Le.x48,
                        [w.Small]: Le.x48,
                        [w.Medium]: Le.x64,
                    ...
                    Re = ({ discount: u }) => {
                        ...
                        return a().createElement(
                            'div',
                            { className: 'Discount_base_61' },
                            a().createElement(
                                'div',
                                { className: 'Discount_titleContainer_7d' },
                                a().createElement(Lu, { text: ye.title(), className: 'Discount_discountTitle_1f' }),
                                a().createElement(
                                    Vu,
                                    { body: ye.tooltip() },
                                    a().createElement('div', { className: 'Discount_info_f1' }),
                                ),
                            ),
                            a().createElement(Te, {
                                discount: u,
                                size: ke[e],
                                className: 'Discount_discountTickets_f3',
                            }),
                        );
                    },
                    Oe = R.strings.wt_portals.insideVehiclePortal,
                    Ne = ({ discount: u, tankNation: e, tankLevel: t, tankType: n, shortTankName: r, roleName: i }) =>
                        a().createElement(
                            'div',
                            { className: 'TankPortal_base_23' },
                            a().createElement(xe, { name: r, level: t, type: n, role: i, nation: e }),
                            Boolean(u) &&
                                a().createElement(
                                    'div',
                                    { className: 'TankPortal_discountContainer_43' },
                                    a().createElement('div', { className: 'TankPortal_discountBg_d6' }),
                                    a().createElement(Lu, {
                                        text: Oe.redDiscount(),
                                        className: 'TankPortal_discount_c7',
                                        format: { binding: { discount: u } },
                                    }),
                                ),
                            a().createElement(
                                'div',
                                { className: 'TankPortal_footer_de' },
                                a().createElement(Lu, {
                                    text: Oe.description(),
                                    className: 'TankPortal_description_d4',
                                }),
                                a().createElement(Re, { discount: u }),
                            ),
                        ),
                    He = R.strings.wt_portals,
                    Pe = () => {
                        const u = tu('model'),
                            e = u.isBoxesEnabled,
                            t = u.backButtonText,
                            r = u.discount,
                            i = u.mainVehiclePrize,
                            o = u.onBackButtonClick,
                            E = u.onBuyButtonClick,
                            l = u.onClose,
                            A = u.onPreviewTankClick,
                            _ = u.onRunPortalClick,
                            F = tu('model.portalAvailability'),
                            c = F.attemptPrice,
                            D = F.lootBoxesCount;
                        !(function ({
                            key: u = P.n.ESCAPE,
                        ...
                        const m = (0, n.useCallback)(() => o({ isEsc: !1 }), [o]),
                            d = (0, n.useCallback)(() => A(), [A]);
                        return a().createElement(
                            'div',
                            { className: 'App_base_01' },
                            a().createElement('div', { className: 'App_bg_20' }),
                            a().createElement(
                                'div',
                                { className: 'App_preview_61' },
                                a().createElement(Ou, { onClick: d }),
                            ),
                            a().createElement(Lu, { text: He.title.tank(), className: 'App_title_24' }),
                            a().createElement(
                                oe,
                                { animationDelayStepsCount: 5 },
                                a().createElement(
                                    'div',
                                    { className: 'App_tankPortal_f1' },
                                    a().createElement(Ne, {
                                        discount: r,
                                        tankNation: i.tankNation,
                                        tankLevel: i.tankLevel,
                                        tankType: i.tankType,
                                        shortTankName: i.shortTankName,
                                        roleName: i.roleName,
                                    }),
                                ),
                                a().createElement(ie, { onClick: m, goto: t }),
                                a().createElement(re, {
                                    onClose: () => {
                                        (l(), s.O.view.sendEvent.close());
                                    },
                                }),
                                e && a().createElement(ue, { onBuyButtonClick: E }),
                            ),
                            e
                                ? a().createElement(pe, {
                                      vehiclePrice: c,
                ...
                engine.whenReady.then(() => {
                    i().render(
                        a().createElement(H, null, a().createElement(Pe, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(5263));
