(() => {
    ...
    var __webpack_modules__ = {
            67: (e, u, t) => {
                ...
                const H = Object.keys(B).reduce((e, u) => ((e[u] = () => viewEnv.getShowingStatus() === B[u]), e), {}),
                    G = {
                        set: (e, u) => {
            ...
            800: (e, u, t) => {
                ...
                const g = {
                        ...
                        return (l = {}) => {
                            const c = l.settings,
                                ...
                                k = (0, s.useCallback)(
                                    (e) => {
                                        (0 !== e.deltaY && y(n(e)),
                                            A.current && D.trigger('mouseWheel', e, v.scrollPosition, u(A.current)));
                                    },
                                    [v.scrollPosition, y, D],
                                ),
                                S = ((e, u = []) => {
                                    const t = (0, s.useRef)(),
                                        n = (0, s.useCallback)((...u) => {
                            ...
                            const N = (0, s.useCallback)((e) => D.trigger('isThumbDraggingChanged', e), [D]);
                            return (0, s.useMemo)(
                                () => ({
                                ...
                                [v.scrollPosition, w, y, N, D.off, D.on, T, k, h, E.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    h = v({
                    ...
                    I = (0, s.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = O, onDrag: n = M }) => {
                        const r = (0, s.useRef)(null),
                            ...
                            v = () => {
                                ...
                                ((t.style.transform = `translateX(${0 | l}px)`),
                                    ((e) => {
                                        if (o.current && E.current && D.current && _.current) {
                                            if (0 === e)
                        ...
                        ((0, s.useEffect)(() => i(h)),
                            ...
                            (0, s.useEffect)(() => {
                                ...
                                const u = (u) => {
                                    ...
                                    t = () => {
                                        (window.removeEventListener('mousemove', u), g(L));
                                    };
                                return (
                            ...
                            }, [e, C.offset, C.pending, n, g]));
                        const R = A((u) => e.applyStepTo(u), B, [e]),
                            I = R[0],
                            W = R[1];
                        (0, s.useEffect)(
                            () => (
                        ...
                        return l().createElement(
                            ...
                            l().createElement(
                                ...
                                l().createElement('div', { ref: _, className: a()(T, u.thumb) }),
                                l().createElement('div', { className: a()(N, u.rail) }),
                            ),
                            l().createElement('div', {
                    ...
                    V = ({ api: e, className: u, classNames: t, children: n, style: r }) => (
                        (0, s.useEffect)(() => i(e.recalculateContent)),
                        l().createElement(
                            'div',
                            { className: a()(W.base, u), style: r },
                            l().createElement(
                                'div',
                                {
                ...
                const U = v({
                    ...
                    te = (0, s.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = J, onDrag: n = Z }) => {
                        ...
                        ((0, s.useEffect)(() => i(b)),
                            ...
                            (0, s.useEffect)(() => {
                                ...
                                const u = (u) => {
                                    ...
                                    t = () => {
                                        (window.removeEventListener('mousemove', u), e.handleIsThumbDragging(!1), g(Q));
                                    };
                                return (
                                    window.addEventListener('mousemove', u),
                                    window.addEventListener('mouseup', t),
                        ...
                        const w = A((u) => e.applyStepTo(u), B, [e]),
                            y = w[0],
                            k = w[1];
                        (0, s.useEffect)(
                            () => (
                        ...
                        return l().createElement(
                            ...
                            l().createElement(
                                ...
                                l().createElement('div', { ref: _, className: u.thumb }),
                ...
                const ge = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    return r || a
                        ? l().createElement(Ae, pe({}, u, { contentId: r || a }), n)
                        : l().createElement(_e, u, n);
                };
                var ve = t(45);
                        ...
                        ({
                            ...
                            return (
                                ...
                                l().createElement(
                                    ...
                                    l().createElement('div', { className: Se, ref: A }, m),
                                    l().createElement(
                                        ge,
                                        { tooltipArgs: C },
                                        l().createElement(
                                            'div',
                                            { className: a()(ye, !_.isTruncateFinished && o && ke), style: p },
                ...
                const ou = {
                    ...
                    Au = 'Indicator_progressMarker_b4',
                    ...
                    fu = l().memo(function ({
                        ...
                        const i = n === e ? 2 : (n / u) * 254,
                            ...
                            c = (r / u) * 254,
                            E = r > 0,
                            d = { config: { duration: Cu }, immediate: !o },
                            A = (0, f.useSpring)(Object.assign({ from: { left: 2 }, to: { left: i }, delay: Cu }, d)),
                            F = (0, f.useSpring)(Object.assign({ from: { width: e }, to: { width: s }, delay: Cu }, d));
                        return l().createElement(
                            'div',
                            { className: Eu },
                            l().createElement(
                                ...
                                l().createElement('div', { className: a()(Fu, _u) }),
                            ),
                        );
                    });
                let pu;
                    ...
                    vu = l().memo(function ({
                        ...
                        return l().createElement(
                            ...
                            l().createElement(
                                'div',
                                { className: gu.base },
                                l().createElement(tu, { justifyContent: Le.FlexEnd, classMix: gu.value, text: u }),
                                l().createElement('div', {
                                    className: gu.icon,
                                ...
                                r !== pu.None &&
                                    l().createElement('div', { className: a()(gu.highlight, gu[`highlight__${r}`]) }),
                            ),
                        );
                    }),
                    hu = 'Group_base_66',
                        ...
                        ({
                            ...
                            return l().createElement(
                                ...
                                l().createElement(
                                    ...
                                    l().createElement(
                                        ...
                                        l().createElement(
                                            'div',
                                            { className: ku },
                                            l().createElement('div', { className: a()(Tu, u && Nu) }),
                                            l().createElement(
                                                'div',
                                                { className: Su },
                                ...
                                l().createElement(
                                    'div',
                                    { className: a()(Pu, u && Lu) },
                                    ie(t, (e) => l().createElement(vu, Wu({ key: e.id }, e))),
                                    F && l().createElement('div', { className: Ou }),
                                    ie(n, (e) => l().createElement(vu, Wu({ key: e.id }, e))),
                                ),
                            );
                        },
                    ),
                                ...
                                const F = (0, o.useRef)([]),
                                    D = (t, o, a) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            B = { mode: t, model: _, externalModel: d, cleanup: D };
                                        return {
                                            model: _,
                                    ...
                                    m = B[0],
                                    C = B[1],
                                    f = (0, o.useState)(() => D(l, E, A)),
                                    p = f[0],
                                    g = f[1];
                                return (
                                    (0, o.useEffect)(() => {
                                        _.current ? g(D(m, E, A)) : (_.current = !0);
                                    }, [A, m, E]),
                                    (0, o.useEffect)(() => {
                                        C(l);
                                    }, [l]),
