            ...
            800: (e, u, t) => {
                ...
                const g = {
                    ...
                    I = (0, s.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = O, onDrag: n = M }) => {
                        ...
                        const R = A((u) => e.applyStepTo(u), _, [e]),
                            I = R[0],
                            W = R[1];
                        (0, s.useEffect)(
                            () => (
                        ...
                        return l().createElement(
                            ...
                            l().createElement(
                                ...
                                l().createElement('div', { ref: B, className: a()(T, u.thumb) }),
                ...
                const U = v({
                    ...
                    te = (0, s.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = J, onDrag: n = Z }) => {
                        ...
                        const w = A((u) => e.applyStepTo(u), _, [e]),
                            y = w[0],
                            k = w[1];
                        (0, s.useEffect)(
                            () => (
                ...
                const D = ((e, u) => {
                        ...
                        return [
                            function ({ mode: l = 'real', options: E, children: d, mocks: A }) {
                                const F = (0, o.useRef)([]),
                                    D = (t, o, a) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            _ = { mode: t, model: B, externalModel: d, cleanup: D };
                                        return {
                                            model: B,
                                ...
                                return (
                                    (0, o.useEffect)(() => {
                                        B.current ? g(D(m, E, A)) : (B.current = !0);
                                    }, [A, m, E]),
                                    (0, o.useEffect)(() => {
                                        C(l);
                                    }, [l]),
