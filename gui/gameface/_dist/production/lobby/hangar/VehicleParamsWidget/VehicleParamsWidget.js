(() => {
    ...
    var __webpack_modules__ = {
            ...
            359: (e, u, t) => {
                ...
                const l = (0, n.memo)(function (e) {
                    ...
                    c = 'VehicleParamsWidgetApp_base_20',
                    E = () =>
                        r().createElement(
                            'div',
                            { className: c },
                ...
                engine.whenReady.then(() => {
                    a().render(r().createElement(E, null), document.getElementById('root'));
                });
            },
            800: (e, u, t) => {
                t.d(u, { Z: () => Hu });
                ...
                const U = g({
                    ...
                    te = (0, s.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = J, onDrag: n = X }) => {
                            ...
                            h = d(() => {
                                ...
                                ((t.style.transform = `translateY(${0 | l}px)`),
                                    ((e) => {
                                        if (o.current && E.current && D.current && B.current) {
                                            if (0 === e)
                                                return (o.current.classList.add(Z), void E.current.classList.remove(Z));
                                            if (
                                                ((u = D.current),
                                                (t = B.current),
                                                e - (u.offsetHeight - t.offsetHeight) >= -0.5)
                                            )
                                                return (o.current.classList.remove(Z), void E.current.classList.add(Z));
                                            var u, t;
                                            (o.current.classList.remove(Z), E.current.classList.remove(Z));
                                        }
                                    })(l));
                            }),
                            b = d(() => {
                        ...
                        const S = (e) => {
                            e.target.classList.contains(Z) || F('highlight');
                        };
                        return l().createElement(
                            'div',
                            ...
                            l().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Z) || 0 !== e.button || (F('play'), y(p.Next));
                                },
                                ref: o,
                                onMouseEnter: S,
                            }),
                            ...
                            l().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Z) || 0 !== e.button || (F('play'), y(p.Prev));
                                },
                                onMouseUp: k,
                                ref: E,
                                onMouseEnter: S,
                ...
                const ju = {
                    ...
                    Hu = (0, se.Pi)(({ showBackground: e = !0, className: u }) => {
                ...
                const D = ((e, u) => {
                        ...
                        return [
                            function ({ mode: l = 'real', options: E, children: d, mocks: A }) {
                                ...
                                return (
                                    (0, o.useEffect)(() => {
                                        B.current ? v(D(m, E, A)) : (B.current = !0);
                                    }, [A, m, E]),
                                    (0, o.useEffect)(() => {
                                        C(l);
                                    }, [l]),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [76], () => __webpack_require__(359));
