(() => {
    ...
    var __webpack_modules__ = {
            67: (e, t, n) => {
                n.d(t, { O: () => z });
                var r = {};
                (n.r(r), n.d(r, { mouse: () => u, onResize: () => l }));
                var o = {};
                (n.r(o),
                    n.d(o, {
                        events: () => r,
                ...
                var i = {};
                (n.r(i), n.d(i, { getBgUrl: () => E, getTextureUrl: () => b }));
                var a = {};
                function s(e) {
                    return (t) => (
                        engine.on(e, t),
                ...
                const W = Object.keys(h).reduce((e, t) => ((e[t] = () => viewEnv.getShowingStatus() === h[t]), e), {}),
                    G = {
                        set: (e, t) => {
            ...
            493: (e, t, n) => {
                        ...
                        const T = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            k = (0, r.useCallback)(() => {
                                (T.current.isVisible && T.current.timeoutId) ||
                                    (d(n, h, { isMouseEvent: !0, on: !0, arguments: l(o) }, P),
                                    O && O(),
                            ...
                            S = (0, r.useCallback)((e) => {
                                T.current.isVisible &&
                                    ...
                                    (T.current.hideTimerId = window.setTimeout(() => {
                                        ...
                                        t && !t.isSameNode(T.current.prevTarget) && A();
                                    }, 200)));
                            }, []);
                        ((0, r.useEffect)(() => {
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onClick: ((e) => (t) => {
                                              (!1 === b && A(), null == u || u(t), null == e || e(t));
                                          })(t.props.onClick),
                                          onMouseDown: ((e) => (t) => {
                                              (!1 === b && A(), null == s || s(t), null == e || e(t));
                                          })(t.props.onMouseDown),
                                      },
                                      M,
                                  ),
                ...
                let h;
                !(function (e) {
                    ((e[(e.Stronghold = 0)] = 'Stronghold'), (e[(e.GlobalMap = 1)] = 'GlobalMap'));
                })(h || (h = {}));
                const m = { from: { opacity: 0 }, to: { opacity: 1 }, delay: 100, config: { duration: 300 } },
                    p = { [h.Stronghold]: 'battleModifiers', [h.GlobalMap]: 'battleModifiersGM' };
                function f() {
                    return !1;
                }
                console.log;
                ...
                const P = ((e, t) => {
                        ...
                        return [
                            function ({ mode: i = 'real', options: a, children: s, mocks: c }) {
                                ...
                                return (
                                    ...
                                    (0, r.useEffect)(
                                        () => () => {
                                            (E.externalModel.dispose(), l.current.forEach((e) => e()));
                                        },
                                        [E],
                                    ),
                    ...
                    S = {
                        base: 'App_base_f6',
                        content: 'App_content_a9',
                        description: 'App_description_ba',
                        title: 'App_title_16',
                        icon_0: 'App_icon_0_5f',
                        icon_1: 'App_icon_1_1a',
                    },
                    L = R.strings.fortifications,
                    C = (0, b.Pi)(() => {
                        const e = (0, E.useSpring)(m),
                            t = A().model.root.get().queue,
                            n = p[t],
                            r = L.$dyn(n);
                        return o().createElement(
                            E.animated.div,
                            { className: S.base, style: e },
                            o().createElement(
                                w,
                                null,
                                o().createElement(
                                    ...
                                    o().createElement(
                                        ...
                                        o().createElement('div', { className: S.title }, r.$dyn('title')),
                                    ),
                                    o().createElement('div', { className: S[`icon_${t}`] }),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    a().render(o().createElement(k, null, o().createElement(C, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [76], () => __webpack_require__(493));
