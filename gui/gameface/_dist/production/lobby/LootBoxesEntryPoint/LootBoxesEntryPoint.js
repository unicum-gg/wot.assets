(() => {
    ...
    var __webpack_modules__ = {
            ...
            5496: (u, e, t) => {
                ...
                const D = a.O.client.getSize('rem'),
                    l = D.width,
                    B = D.height,
                    d = Object.assign({ width: l, height: B }, s(l, B, F)),
                    ...
                    return (
                        m(() => {
                            if (
                                                ...
                                                const e = O(),
                                                    ...
                                                    r =
                                                        window.__feature && window.__feature !== t && t
                                                            ? `subViews.${t}`
                                                            : '';
                                                return { modelPrefix: r, modelPath: S(r, ''), resId: n };
                                            })(),
                                            t = e.modelPrefix,
                                            n = u.split('.');
                                        if (n.length > 0) {
                                ...
                                D.current = M.addCallback(n, t, E, e === L.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== L.None)
                ...
                const I = (u, e, t = {}, n = 0) => {
                    ...
                    W = (u) => {
                        ...
                        const w = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            v = (0, n.useMemo)(() => _ || O().resId, [_]),
                            p = (0, n.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (I(t, B, { isMouseEvent: !0, on: !0, arguments: H(r) }, v),
                                    m && m(),
                ...
                const K = 'R.images.white_tiger.gui.maps.icons.entryBoxPoint',
                    j = (u, e) => (e > 0 ? `${K}.${u}` : `${K}.${u}_empty`),
                    q = ({ name: u, value: e, isSecond: t = !1, hasNew: i }) => {
                        const A = u === V.Boss,
                            E = (0, n.useMemo)(() => ({ backgroundImage: `url(${j(u, e)})` }), [u, e]),
                            a = (0, n.useMemo)(() => ({ maskImage: `url(${j(u, e)})` }), [u, e]),
                            F = f(R.strings.event.award.value(), { count: e }),
                            o = f(R.strings.event.award.value(), { count: '999+' }),
                            s = w()('Key_base_3b', t && 'Key_base__second_97'),
                            D = w()('Key_newItem_c3', A && 'Key_newItem__boss_af');
                        return r().createElement(
                            ...
                            i &&
                                r().createElement('img', {
                                    ...
                                    src:
                                        'swf://gui/flash/' +
                                        (A ? R.animations.wt_event.key_w() : R.animations.wt_event.key_h()),
                                }),
                            r().createElement(
                                'div',
                                { className: 'Key_keyImage_c9', style: E },
                                (() => {
                                    if (e > 0)
                                        return r().createElement(
                                            'span',
                                            { className: 'Key_count_17' },
                                            e > 999 ? o : F,
                                        );
                                })(),
                            ),
                            i &&
                                r().createElement(
                                    'div',
                                    { className: 'Key_flareWrapper_c2', style: a },
                                    r().createElement('div', { className: 'Key_flare_7a' }),
                                ),
                        );
                    },
                    z = () => {
                        const u = k('model'),
                            ...
                            F = i || A,
                            o = (0, n.useCallback)(() => {
                                P('ev_white_tiger_hangar_lootbox_rollover');
                            }, []),
                            s = (0, n.useCallback)(() => {
                                P('ev_white_tiger_hangar_lootbox_rollout');
                            }, []),
                            D = (0, n.useCallback)(() => {
                                E();
                            }, [E]),
                            l = w()('App_keys_e1', F && 'App_keys__hasNew_f7');
                        return (
                            (0, n.useEffect)(
                                () =>
                                    ((u) => {
                            ...
                            r().createElement(
                                ...
                                F &&
                                    r().createElement('img', {
                                        className: 'App_backgroundAnimation_db',
                                        src: 'swf://gui/flash/' + R.animations.wt_event.keys_bg(),
                                    }),
                                r().createElement(
                                    'div',
                                    { className: l },
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            ...
                                            r().createElement('div', { className: 'App_hoverImage_4c' }),
                                        ),
                                    ),
                                    r().createElement(q, { name: V.Hunter, value: e, hasNew: i }),
                                    r().createElement(q, { name: V.Boss, value: t, isSecond: !0, hasNew: A }),
                                ),
                            )
                        );
                    };
                engine.whenReady.then(() => {
                    A().render(r().createElement(h, null, r().createElement(z, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(5496));
