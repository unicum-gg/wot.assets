(() => {
    ...
    var __webpack_modules__ = {
            70: (u, e, n) => {
                ...
                var a = {};
                (n.r(a), n.d(a, { getBgUrl: () => b, getTextureUrl: () => f }));
                var i = {};
                function o(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const m = {
                    ...
                    w = Object.keys(v).reduce((u, e) => ((u[e] = () => B(v[e])), u), {}),
                    p = { play: Object.assign({}, w, { sound: B }), setRTPC: d };
                var g = n(9690);
                function f(u, e, n = 1) {
                ...
                const J = Object.keys(y).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === y[e]), u), {}),
                    uu = {
                        set: (u, e) => {
                ...
                const ru = { view: i, client: r, sound: p, intl: h };
            },
            5521: (u, e, n) => {
                let t, r;
                (n.d(e, { n: () => t }),
            ...
            9125: (u, e, n) => {
                ...
                const S = {
                    ...
                    x = { [O.Big]: 240, [O.WideSmall]: 240, [O.ThinSmall]: 180, [O.ThinExtraSmall]: 120 };
                let P;
                !(function (u) {
                ...
                const M = (u) => (u < 0.5 ? 4 * u * u * u : (u - 1) * (2 * u - 2) * (2 * u - 2) + 1),
                    ...
                    N = (0, t.memo)(({ frontlineState: u, endDate: e, currentSize: n, isInactive: a }) => {
                        ...
                        return (
                            (0, t.useEffect)(() => {
                                B.current && B.current.offsetWidth > x[n] && C(!0);
                            }, [B, n]),
                            r().createElement(
                                'div',
                ...
                const z = (u, e, n = {}, t = 0) => {
                    ...
                    U = (u) => {
                        ...
                        const p = (0, t.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            g = (0, t.useMemo)(() => m || _().resId, [m]),
                            f = (0, t.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (z(n, D, { isMouseEvent: !0, on: !0, arguments: j(r) }, g),
                                    h && h(),
                ...
                const X = (0, t.memo)(function (u) {
                    ...
                    nu = (0, t.memo)(
                        ({ type: u = P.Normal, cardSize: e = O.Big, isGray: n = !1, isPerformanceRisk: t = !1 }) => {
                            const a = {
                                width: 300,
                                height: 150,
                                frameCount: 67,
