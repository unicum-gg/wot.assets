(() => {
    var __webpack_modules__ = {
            ...
            67: (e, t, r) => {
                ...
                r.d(t, { O: () => z });
                var n = {};
                (r.r(n), r.d(n, { mouse: () => u, onResize: () => d }));
                var i = {};
                (r.r(i),
                    r.d(i, {
                        events: () => n,
                ...
                var a = {};
                (r.r(a), r.d(a, { getBgUrl: () => E, getTextureUrl: () => g }));
                var o = {};
                function l(e) {
                    return (t) => (
                        engine.on(e, t),
                ...
                const B = Object.keys(w).reduce((e, t) => ((e[t] = () => viewEnv.getShowingStatus() === w[t]), e), {}),
                    $ = {
                        set: (e, t) => {
            ...
            533: (e, t, r) => {
                ...
                const E = (e) => {
                    ...
                    const i = (0, n.useContext)(h),
                        ...
                        x = { extraLarge: v, large: b, medium: f, small: p, extraSmall: L };
                ...
                const A = {
                    ...
                    H = (e) => {
                        ...
                        const a = O(),
                            ...
                            l = a.mediaHeight,
                            s = a.mediaSize;
                        return i().createElement('div', y({ className: f()(r, A[o], P[l], k[s]) }, n), t);
                    },
                    D = ['children'];
                const I = (e) => {
                    let t = e.children,
                    ...
                    return i().createElement(v, null, i().createElement(H, r, t));
                };
                var C = r(493),
                    W = r.n(C),
                    N = r(515);
                        ...
                        const L = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            S = (0, n.useCallback)(() => {
                                (L.current.isVisible && L.current.timeoutId) ||
                                    (j(r, h, { isMouseEvent: !0, on: !0, arguments: V(i) }, x),
                                    b && b(),
                ...
                const Q = ((e, t) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: l, children: s, mocks: d }) {
                                const c = (0, n.useRef)([]),
                                    u = (r, n, i) => {
                                        var a;
                                        const l = (function ({
                                            ...
                                            _ = { mode: r, model: m, externalModel: s, cleanup: u };
                                        return {
                                            model: m,
                                            controls: 'mocks' === r && i ? i.controls(_) : t(_),
                                            externalModel: s,
                                            mode: r,
                                        };
                                    },
                                    ...
                                    h = _[0],
                                    g = _[1],
                                    E = (0, n.useState)(() => u(a, l, d)),
                                    w = E[0],
                                    v = E[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        m.current ? v(u(h, l, d)) : (m.current = !0);
                                    }, [d, h, l]),
                                    (0, n.useEffect)(() => {
                                        g(a);
                                    }, [a]),
                                    ...
                                    i().createElement(r.Provider, { value: w }, s)
                                );
                            },
                            () => (0, n.useContext)(r),
                        ];
                        ...
                        ({ externalModel: e }) => ({
                            onOpenProgression: e.createCallbackNoArgs('onOpenStrongholdEventProgression'),
                        }),
                    ),
                    J = Q[0],
                    ee = Q[1];
                ...
                const re = { [te.Large]: '150x150', [te.Small]: '110x110' },
                    ne = 'ProgressionRank_base_46',
                    ie = 'ProgressionRank_inactive_fb',
                    ae = 'ProgressionRank_icon_8d',
                    oe = 'ProgressionRank_icon__small_e9',
                    le = R.images.gui.maps.icons.stronghold.ranks,
                    se = (0, N.Pi)(() => {
                        const e = ee(),
                            t = e.controls,
                            r = e.model.root.get(),
                            ...
                            o = r.isInClan,
                            l = r.isActive,
                            s = O().mediaSize <= x.Small,
                            d = (0, n.useMemo)(() => (s ? re[te.Small] : re[te.Large]), [s]),
                            c = f()(ne, { [ie]: !o || !l }),
                            u = f()(ae, { [oe]: s }),
                            m = (0, n.useCallback)(() => {
                                (t.onOpenProgression(), K.playClick());
                            }, [t]),
                            _ = (0, n.useMemo)(() => {
                                const e = le.$dyn(`c_${d}`).$dyn('default');
                                return le.$dyn(`c_${d}`).$dyn(`rank_${a}`) || e;
                            }, [d, a]);
                        return i().createElement(
                            B,
                            { contentId: R.views.lobby.stronghold.tooltips.StrongholdMainWidgetTooltip('resId') },
                            i().createElement(
                                'div',
                                {
                                    className: c,
                                ...
                                i().createElement('img', { className: u, src: _, alt: 'widget' }),
                            ),
                        );
                    }),
                    de = (0, n.memo)(se),
                    ce = (0, N.Pi)(() => i().createElement('div', { className: F }, i().createElement(de, null)));
                engine.whenReady.then(() => {
                    W().render(
                        i().createElement(I, null, i().createElement(J, null, i().createElement(ce, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [276], () => __webpack_require__(533));
