(() => {
    var __webpack_modules__ = {
            ...
            294: (u, e, t) => {
                ...
                var E = {};
                (t.r(E),
                    t.d(E, { mouse: () => s, off: () => l, on: () => o, onResize: () => i, onScaleUpdated: () => D }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        events: () => E,
                ...
                const h = {
                    ...
                    w = Object.keys(_).reduce((u, e) => ((u[e] = () => C(_[e])), u), {}),
                    v = { play: Object.assign({}, w, { sound: C }), setRTPC: d },
                ...
                const ou = { view: a, client: r, sound: v, intl: g };
            },
            358: (u, e, t) => {
                'use strict';
                t.d(e, { Z: () => A });
            ...
            180: (u, e, t) => {
                ...
                var n;
                function i(u = a.O.client.getSize('rem')) {
                    const e = u.width,
                        t = u.height;
                ...
                (0, E.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && B) return A(e, t, v);
                ...
                const B = ({ children: u }) => {
                    ...
                    return (
                        ...
                        r().createElement(o.Provider, { value: t }, n && u)
                    );
                };
                var s = t(483),
                    C = t.n(s),
                ...
                const f = {
                        [h.ExtraSmall]: '',
                        [h.Small]: c().SMALL_WIDTH,
                        [h.Medium]: `${c().SMALL_WIDTH} ${c().MEDIUM_WIDTH}`,
                        [h.Large]: `${c().SMALL_WIDTH} ${c().MEDIUM_WIDTH} ${c().LARGE_WIDTH}`,
                        [h.ExtraLarge]: `${c().SMALL_WIDTH} ${c().MEDIUM_WIDTH} ${c().LARGE_WIDTH} ${c().EXTRA_LARGE_WIDTH}`,
                    },
                    p = {
                        [g.ExtraSmall]: '',
                    ...
                    x = (u) => {
                        ...
                        const A = _(),
                            ...
                            F = A.mediaHeight,
                            n = A.mediaSize;
                        return r().createElement('div', v({ className: C()(t, f[a], p[F], b[n]) }, E), e);
                    },
                    T = ['children'];
                const L = (u) => {
                    let e = u.children,
                ...
                const G = ((u, e) => {
                                ...
                                const D = (0, E.useRef)([]),
                                    o = (t, E, r) => {
                                        ...
                                        const F = (function ({
                                            ...
                                            B = { mode: t, model: l, externalModel: n, cleanup: o };
                                        return {
                                            model: l,
                                    ...
                                    s = B[0],
                                    C = B[1],
                                    d = (0, E.useState)(() => o(A, F, i)),
                                    c = d[0],
                                    m = d[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        l.current ? m(o(s, F, i)) : (l.current = !0);
                                    }, [i, s, F]),
                                    (0, E.useEffect)(() => {
                                        C(A);
                                    }, [A]),
                    ...
                    J = 'App_title_a4',
                    uu = 'App_info_0a',
                    eu = 'App_seasonDate_44',
                    tu = 'App_seasonDateIcon_89',
                    Eu = 'App_seasonDateText_e5';
                var ru = t(797);
                let Au;
                function au(u, e) {
                ...
                const Fu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Du = (u, e, t = Au.left) => u.split(e).reduce(t === Au.left ? nu : iu, []),
                    ou = (() => {
                        const u = new RegExp(
                            [
                    ...
                    Bu = (u, e = Au.left) => {
                        ...
                        return ((u, e = Au.left) => {
                            ...
                            const E =
                                ...
                                r = Fu(u);
                            return (Du(r, /( )/, e).forEach((u) => (t = t.concat(Du(u, E, Au.left)))), t);
                        })(u, e);
                    },
                    su = 'FormatText_base_d0',
                    Cu = ({ binding: u, text: e = '', classMix: t, alignment: A = Au.left, formatWithBrackets: a }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const F = a && u ? au(e, u) : e;
                    ...
                    du = R.strings.clans.banner,
                    cu = ({ state: u }) => {
                        switch (u) {
                            case O.PrimeTimeToday:
                                return r().createElement(Cu, { text: du.info.battlesToday() });
                            case O.PrimeTimeTomorrow:
                                return r().createElement(Cu, { text: du.info.battlesTomorrow() });
                            case O.Ended:
                                return r().createElement(Cu, { text: du.info.battlesEnd() });
                            default:
                                return (
                ...
                var hu = t(613);
                Date.now();
                const gu = hu.Ew.getRegionalDateTime;
                hu.Ew.getFormattedDateTime;
                const _u = ({ text: u, timestamp: e }) => {
                        const t = ((u) => {
                    ...
                    wu = R.strings.clans.banner,
                    vu = ({ state: u, startTimestamp: e, endTimestamp: t }) => {
                        switch (u) {
                            case O.NotStarted:
                                return r().createElement(_u, { text: wu.seasonDate.seasonNotStarted(), timestamp: e });
                            case O.Started:
                                return r().createElement(_u, { text: wu.seasonDate.seasonLasts(), timestamp: t });
                            case O.PrimeTimeNotChosen:
                                return r().createElement(Cu, { text: wu.chooseTime() });
                            case O.PrimeTimeNow:
                            case O.PrimeTimeToday:
                            case O.PrimeTimeTomorrow:
                                return r().createElement(Cu, {
                                    text: wu.primeTime(),
                                    binding: { start: gu(e, mu.ShortTime), end: gu(t, mu.ShortTime) },
                                });
                            default:
                                return (
                                    console.error(`Unreachable code for state '${u}' in StrongholdEntryPointView.`),
                    ...
                    pu = {
                        highlighted: [O.NotStarted, O.PrimeTimeNow, O.PrimeTimeNotChosen, O.Started],
                        withInfo: [O.Ended, O.PrimeTimeToday, O.PrimeTimeTomorrow],
                        withoutDate: [O.Ended, O.DataError],
                        disabled: [O.Ended, O.PrimeTimeToday, O.PrimeTimeTomorrow],
                    },
                    bu = (0, k.Pi)(() => {
                        const u = $(),
                            e = u.controls,
                        ...
                        return r().createElement(
                            'div',
                            {
                                className: C()(z, pu.disabled.includes(E) && q, A && K),
                                onClick: () => {
                                    (M(R.sounds.yes()), e.open());
                                },
                                onMouseEnter: () => {
                                    P.playHighlight();
                                },
                            ...
                            pu.disabled.includes(E) && r().createElement('div', { className: Z }),
                            r().createElement('div', { className: Y }),
                            pu.highlighted.includes(E) && r().createElement('div', { className: X }),
                            r().createElement(
                                'div',
                                { className: Q },
                                r().createElement('div', { className: J }, fu.title()),
                                pu.withInfo.includes(E) &&
                                    r().createElement('div', { className: uu }, r().createElement(cu, { state: E })),
                                !pu.withoutDate.includes(E) &&
                                    r().createElement(
                                        'div',
                                        { className: eu },
                                        ...
                                        r().createElement(
                                            'div',
                                            { className: Eu },
                                            r().createElement(vu, { state: E, startTimestamp: a, endTimestamp: F }),
                                        ),
                                    ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    y().render(
                        r().createElement(j, null, r().createElement(L, null, r().createElement(bu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [276], () => __webpack_require__(180));
