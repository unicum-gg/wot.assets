    ...
    var __webpack_modules__ = {
            ...
            99: (u, e, t) => {
                ...
                const tu = (() => {
                    ...
                    Eu = p,
                    ru = Object.keys(T).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === T[e]), u), {}),
                    Au = {
                        set: (u, e) => {
            ...
            338: (u, e, t) => {
                ...
                const D = a.O.client.getSize('rem'),
                    o = D.width,
                    l = D.height,
                    B = Object.assign({ width: o, height: l }, i(o, l, F)),
                ...
                const L = {
                    ...
                    O = (u) => {
                        ...
                        const A = b(),
                            ...
                            F = A.mediaHeight,
                            n = A.mediaSize;
                        return r().createElement('div', T({ className: g()(t, L[a], S[F], y[n]) }, E), e);
                    },
                    M = ['children'];
                const P = (u) => {
                    let e = u.children,
                ...
                const q = ((u, e) => {
                    ...
                    ru = 'App_title_a4',
                    Au = 'App_info_0a',
                    au = 'App_seasonDate_44',
                    Fu = 'App_seasonDateIcon_89',
                ...
                const lu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Cu = (u, e, t = Du.left) => u.split(e).reduce(t === Du.left ? Bu : su, []),
                    du = (() => {
                        const u = new RegExp(
                    ...
                    gu = ({ binding: u, text: e = '', classMix: t, alignment: A = Du.left, formatWithBrackets: a }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const F = a && u ? ou(e, u) : e;
                ...
                const bu = ({ text: u, timestamp: e }) => {
                    ...
                    yu = (0, G.Pi)(() => {
                        ...
                        return r().createElement(
                            'div',
                            {
                                className: g()(X, Su.disabled.includes(E) && Q, A && J),
                                onClick: () => {
                                ...
                                !Su.withoutDate.includes(E) &&
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            'div',
                                            { className: nu },
                                            r().createElement(Tu, { state: E, startTimestamp: a, endTimestamp: F }),
                                        ),
                                    ),
                            ),
                        );
