    ...
    var __webpack_modules__ = {
            ...
            291: (u, e, t) => {
                ...
                const C = l.O.client.getSize('rem'),
                    m = C.width,
                    c = C.height,
                    d = Object.assign({ width: m, height: c }, _(m, c, s)),
                ...
                const p = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && s) return o(e, t, v);
                ...
                (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(g),
                        ...
                        F = (0, r.useCallback)((u, e) => {
                            ...
                            a(Object.assign({ width: t, height: r }, _(t, r, s)));
                        }, []);
                    (v(() => {
                ...
                const su = E().forwardRef(function (u, e) {
                    let t = u.children,
                        A = u.className,
                        a = u.theme,
                ...
                const vu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: A = 'real', options: a, children: F, mocks: n }) {
                                const i = (0, r.useRef)([]),
                                    D = (t, r, E) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            s = { mode: t, model: o, externalModel: F, cleanup: D };
                                        return {
                                            model: o,
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        o.current ? c(D(B, a, n)) : (o.current = !0);
                                    }, [n, B, a]),
                                    (0, r.useEffect)(() => {
                                        _(A);
                                    }, [A]),
