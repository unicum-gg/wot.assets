(() => {
    var __webpack_modules__ = {
            ...
            291: (u, e, t) => {
                ...
                const C = l.O.client.getSize('rem'),
                    m = C.width,
                    c = C.height,
                    d = Object.assign({ width: m, height: c }, _(m, c, B)),
                ...
                const p = (u) => {
                    ...
                    const E = (0, r.useContext)(g),
                        ...
                        v = { extraLarge: C, large: m, medium: c, small: d, extraSmall: p };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && D) return o(e, t, v);
                        if (t.largeWidth && l) return o(e, t, v);
                        if (t.mediumWidth && B) return o(e, t, v);
                        if (t.smallWidth && s) return o(e, t, v);
                ...
                (0, r.memo)(({ children: u }) => {
                    const e = (0, r.useContext)(g),
                        ...
                        F = (0, r.useCallback)((u, e) => {
                            ...
                            a(Object.assign({ width: t, height: r }, _(t, r, B)));
                        }, []);
                    (v(() => {
                    ...
                    return E().createElement(g.Provider, { value: n }, u);
                });
                let f, x, w;
                (!(function (u) {
                ...
                const b = () => {
                    ...
                    S = ['xl', 'lg', 'md', 'sm', 'xs'],
                    T = (u) => u.includes('_') && ((u) => S.includes(u))(u.split('_').at(-1)),
                    M = [f.ExtraLarge, f.Large, f.Medium, f.Small, f.ExtraSmall],
                    O = (u, e) =>
                ...
                const N = {
                    ...
                    I = L((u) => {
                        let e = u.className,
                            ...
                            w =
                                void 0 === x
                                    ...
                                    : x,
                            b = u.alignItems,
                            S = void 0 === b ? (g ? 'flex-start' : h && 'center') || (p && 'flex-end') || void 0 : b,
                            T = u.alignSelf,
                            M = u.wrap,
                            O = u.flexWrap,
                            ...
                            I = u.shrink,
                            U = u.flex,
                            G = void 0 === U ? (R || I ? `${R ? 1 : 0} ${I ? 1 : 0} auto` : void 0) : U,
                            j = u.style,
                            X = u.children,
                            K = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const Y = (0, r.useMemo)(() => {
                            ...
                            }, [t, A, i, o, B, _, j, G, T, d, L, w, S]),
                            V = Y.computedStyle,
                            z = Y.computedClassNames;
                        return E().createElement('div', H({ className: n()(y.base, ...z, e), style: V }, K), X);
                    });
                let U;
                !(function (u) {
                ...
                const G = (u, e, t) => {
                    ...
                    X = (u, e, t = U.left) => u.split(e).reduce(t === U.left ? G : j, []),
                    K = (() => {
                        const u = new RegExp(
                        ...
                        return Y.includes(t)
                            ...
                            : ((u, e = U.left) => {
                                  ...
                                  const r =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return (X(E, /( )/, e).forEach((u) => (t = t.concat(X(u, r, U.left)))), t);
                              })(u, e);
                    },
                    z = 'FormatText_base_d0',
                    q = ({ binding: u, text: e = '', classMix: t, alignment: A = U.left }) =>
                        null === e
                ...
                const eu = Object.keys(Z()),
                    ...
                    nu = L((u) => {
                        ...
                        return E().createElement(
                            ...
                            void 0 !== c ? E().createElement(q, uu({}, c, { text: e })) : e,
                        );
                    });
                function iu() {
                ...
                const Bu = E().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        E().createElement(
                            'div',
                            lu({}, i, {
                                className: n()(Du.base, Du[`base__theme-${F}`], A),
                                ref: function (u) {
                ...
                const Cu = (u, e, t) => {
                    switch (e) {
                        case su.SHORT_DATE:
                            return t
                                ? _u.Z5.getDateFormat(u, _u.kH.SHORT_FORMAT)
                                : _u.cy.getTimeFormat('%d.%m.%y', u, !0);
                        case su.SHORT_TIME:
                            return t
                                ? _u.Z5.getTimeFormat(u, _u.lf.SHORT_FORMAT)
                                : _u.cy.getTimeFormat('%I:%M %p', u, !0);
                        case su.SHORT_DATE_TIME:
                            if (t) {
                                return `${_u.Z5.getDateFormat(u, _u.kH.SHORT_FORMAT)}, ${_u.Z5.getTimeFormat(u, _u.lf.SHORT_FORMAT)}`;
                            }
                            return _u.cy.getTimeFormat('%d.%m.%y, %I:%M %p', u, !0);
                        case su.FULL_DATE:
                            return t
                                ? _u.Z5.getDateFormat(u, _u.kH.LONG_FORMAT)
                                : _u.cy.getTimeFormat('%B %d, %Y', u, !0);
                        case su.FULL_DATE_TIME:
                            if (t) {
                                return `${_u.Z5.getDateFormat(u, _u.kH.LONG_FORMAT)}, ${_u.Z5.getTimeFormat(u, _u.lf.SHORT_FORMAT)}`;
                            }
                            return _u.cy.getTimeFormat('%B %d, %Y, %I:%M %p', u, !0);
                        case su.MONTH:
                            return _u.cy.getTimeFormat('%B', u, !0);
                        case su.MONTH_DATE:
                            return _u.cy.getTimeFormat('%B %e', u, !0);
                        case su.DATE_MONTH:
                            return _u.cy.getTimeFormat('%e %B', u, !0);
                        case su.MONTH_YEAR:
                            return _u.cy.getTimeFormat('%B %Y', u, !0);
                        case su.WEEK_DAY:
                            return _u.cy.getTimeFormat('%A', u, !0);
                        case su.WEEK_DAY_TIME:
                            if (t) {
                                return `${_u.cy.getTimeFormat('%A', u, !0)} ${_u.Z5.getTimeFormat(u, _u.lf.SHORT_FORMAT)}`;
                            }
                            return _u.cy.getTimeFormat('%A, %I:%M %p', u, !0);
                        case su.YEAR:
                            return _u.cy.getTimeFormat('%Y', u, !0);
                        case su.DATE_YEAR:
                            return _u.cy.getTimeFormat('%d, %Y', u, !0);
                    }
                };
                var mu = t(515);
                function cu() {
                ...
                const vu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: A = 'real', options: a, children: F, mocks: n }) {
                                const i = (0, r.useRef)([]),
                                    D = (t, r, E) => {
                                        var A;
                                        const a = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, A) => {
                                                        const F = 'string' == typeof A ? `${r}.${A}` : r,
                                                            n = l.O.view.addModelObserver(F, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = gu(E.keys()); !(u = t()).done; ) A(u.value, e);
                                                    },
                                                    unsubscribe: A,
                                                };
                                            })(r),
                                            ...
                                            B = { mode: t, model: o, externalModel: F, cleanup: D };
                                        return {
                                            model: o,
                    ...
                    wu = {
                        base: 'App_base_b0',
                        inactive: 'App_inactive_1f',
                        seasonInfo: 'App_seasonInfo_06',
                        title: 'App_title_8a',
                        description: 'App_description_e0',
                        date: 'App_date_c9',
                        loading: 'App_loading_07',
                        progressionInfo: 'App_progressionInfo_d6',
                        clanAlert: 'App_clanAlert_58',
                    },
                    ...
                    Tu = (0, mu.Pi)(() => {
                        const u = xu().model.root.get(),
                            ...
                            o = u.isInClan,
                            l = (0, r.useMemo)(
                                () => `${Cu(Number(t), su.SHORT_DATE, !0)} – ${Cu(Number(A), su.SHORT_DATE, !0)}`,
                                [t, A],
                            ),
                            B = n()(wu.base, { [wu.inactive]: !a }),
                            s = (0, r.useMemo)(() => {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [276], () => __webpack_require__(291));
