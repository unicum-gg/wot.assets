(() => {
    var __webpack_modules__ = {
            ...
            1495: (u, e, t) => {
                ...
                const A = o.O.client.getSize('rem'),
                    c = A.width,
                    F = A.height,
                    _ = Object.assign({ width: c, height: F }, E(c, F, l)),
                ...
                const S = {
                    ...
                    y = (u) => {
                        ...
                        const n = w(),
                            ...
                            o = n.mediaHeight,
                            l = n.mediaSize;
                        return a().createElement('div', L({ className: h()(t, S[i], M[o], T[l]) }, r), e);
                    },
                    k = ['children'],
                    O = (u) => {
                        let e = u.children,
                ...
                class K extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            F = h()(X.base, X[`base__${i}`], X[`base__${n}`], null == o ? void 0 : o.base),
                            _ = h()(X.icon, X[`icon__${i}`], X[`icon__${n}`], null == o ? void 0 : o.icon),
                            D = h()(X.glow, null == o ? void 0 : o.glow),
                            d = h()(X.caption, X[`caption__${i}`], null == o ? void 0 : o.caption),
                            m = h()(X.goto, null == o ? void 0 : o.goto);
                ...
                const Z = (0, n.memo)(({ text: u, children: e, classMix: t }) =>
                        a().createElement(
                            'div',
                ...
                const uu = (u, e, t = {}, n = 0) => {
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (uu(t, _, { isMouseEvent: !0, on: !0, arguments: J(r) }, b),
                                    C && C(),
                    ...
                    tu = ({ tooltipArgs: u, children: e }) => (u ? a().createElement(eu, u, e) : e),
                    ru = ({
                        className: u,
                        index: e,
                        onClick: t,
                ...
                const au = ({ className: u, selectedStep: e, data: t, onChange: r }) => {
                        const i = t.length - 1,
                    ...
                    iu = 'WelcomeSlider_sliderArrow_b1',
                    ou = 'WelcomeSlider_sliderArrowIcon_cc',
                    lu = 'WelcomeSlider_sliderArrowIcon__disabled_57',
                    su = ({ slides: u, slideIndex: e, onSlideChange: t }) => {
                        const r = u[e].content,
                            n = 0 !== e,
                            i = e + 1 !== u.length;
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                { className: iu },
                                a().createElement('div', {
                                    className: h()(ou, 'WelcomeSlider_sliderArrowIcon__right_c4', !i && lu),
                                    onClick: () => i && t((u) => u + 1),
                                }),
                            ),
                        );
                ...
                const Bu = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return a().createElement(du, e, r);
                    const n = e.contentId,
                        i = e.args,
                        o = null == i ? void 0 : i.contentId;
                    return n || o
                        ? a().createElement(eu, mu({}, e, { contentId: n || o }), r)
                        : a().createElement(cu, e, r);
                };
                var Cu = t(8045);
                let hu;
                !(function (u) {
                ...
                const gu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    vu = (u, e, t = hu.left) => u.split(e).reduce(t === hu.left ? pu : bu, []),
                    fu = (() => {
                        const u = new RegExp(
                ...
                const Mu = { [Su.NBSP]: xu.NoBreakSymbol, [Su.ZWNBSP]: xu.NoBreakSymbol, [Su.NEW_LINE]: xu.LineBreak },
                    Tu = {
                    ...
                    ku = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return r
                            ? Tu[r]
                                ...
                                : a().createElement('span', { key: t, 'data-block-type': e.blockType, style: yu(r) }, u)
                    ...
                    Pu = (u, e = '') => {
                        ...
                        return (
                            Nu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: xu.Word, colorTag: e, childList: Hu(u) });
                                },
                                (u) => {
                                    const r = u[0],
                                        n = Mu[r.charAt(0)];
                    ...
                    Vu = (u, e, t, r, n, i) => {
                        ...
                        for (let s = t; s >= 0; s--) {
                            const t = u[s],
                                E = Number(u[s].getAttribute('data-block-type'));
                            if (E === xu.LineBreak || E === xu.NewLine || E === xu.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const F = A.slice(0, A.length - c) + i,
                                    _ = e[s];
                                (l = a().cloneElement(_, _.props, F)), (o = s);
                                break;
                            }
                            {
                                const u = t.children,
                                    E = e[s],
                                    c = E.props.children,
                                    F = Vu(u, c, u.length - 1, r, n, i),
                                    _ = F[0],
                                    D = F[1];
                                if (!(_ < 0)) {
                                    const u = c.slice(0, _);
                                    (l = a().cloneElement(E, E.props, u, D)), (o = s);
                                    break;
                                }
                                n -= A.length;
                            }
                    ...
                    $u = a().memo(
                        ({
                            ...
                            const c = (0, n.useRef)(null),
                                                ...
                                                const s = a.children,
                                                    E = ((u, e) => {
                                                        ...
                                                        for (; r - t >= 0; ) {
                                                            ...
                                                            Uu(u[n], e) ? (r = n - 1) : (t = n + 1);
                                                        }
                                                        return t - 1;
                                                    })(s, i);
                                                if (E < 0) return [n, !1];
                                                const A = Vu(s, n, E, o, r.length, r),
                                                    c = A[0],
                                                    F = A[1];
                                ...
                                g = (0, n.useMemo)(() => ({ justifyContent: s, alignContent: E }), [E, s]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                a().createElement(
                                    ...
                                    a().createElement('div', { className: 'ExtendedText_unTruncated_b8', ref: c }, m),
                                    a().createElement(
                                        Bu,
                                        { tooltipArgs: B },
                                        a().createElement(
                    ...
                    Ku = {
                        ...
                        img__level: 'BasicSlide_img__level_5b',
                        img__general: 'BasicSlide_img__general_b9',
                        img__map: 'BasicSlide_img__map_c3',
                    },
                    zu = ({ img: u, title: e, description: t }) =>
                        a().createElement(
                            a().Fragment,
                            null,
                            a().createElement('div', { className: h()(Ku.img, Ku[`img__${u}`]) }),
                            a().createElement('div', { className: Ku.title }, e),
                            a().createElement($u, { text: t, classMix: Ku.description, justifyContent: Lu.Center }),
                        );
                var qu = t(9887),
                    Yu = t.n(qu);
                const Zu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Qu = (u) => u.includes('_') && ((u) => Zu.includes(u))(u.split('_').at(-1)),
                    Ju = [b.ExtraLarge, b.Large, b.Medium, b.Small, b.ExtraSmall],
                    ue = (u, e) =>
                ...
                const ae = {
                    ...
                    le = ee((u) => {
                        let e = u.className,
                            ...
                            w =
                                void 0 === f
                                    ...
                                    : f,
                            x = u.alignItems,
                            L = void 0 === x ? (C ? 'flex-start' : g && 'center') || (p && 'flex-end') || void 0 : x,
                            S = u.alignSelf,
                            M = u.wrap,
                            T = u.flexWrap,
                        ...
                        const W = (0, n.useMemo)(() => {
                            ...
                            }, [t, r, l, E, c, _, H, N, S, B, y, w, L]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return a().createElement('div', ne({ className: h()(te.base, ...U, e), style: G }, I), P);
                    }),
                    se = ({ binding: u, text: e = '', classMix: t, alignment: r = hu.left }) =>
                        null === e
                            ...
                            _e(
                                {
                                    ...
                                    style: g,
                                    mt: !0 === s ? Ce[t || 'paragraph-P16'].mt : s,
                                    mr: !0 === A ? Ce[t || 'paragraph-P16'].mr : A,
                                    mb: !0 === F ? Ce[t || 'paragraph-P16'].mb : F,
                                    ml: !0 === D ? Ce[t || 'paragraph-P16'].ml : D,
                                },
                                B,
                            ),
                            void 0 !== m ? a().createElement(se, _e({}, m, { text: e })) : e,
                        );
                    }),
                    pe = 'VehiclesSlide_level_91',
                ...
                const Me = (u) => (0 === u ? window : window.subViews.get(u)),
                    Te = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: r, children: i, mocks: l }) {
                                const s = (0, n.useRef)([]),
                                    E = (u, t, r) => {
                                        var n;
                                        const a = (function ({
                                            ...
                                            A = (({ observableModel: u }) => {
                                                const e = {
                                                    root: u.object(),
                                                    vehiclesSlide: u.object('vehiclesSlide'),
                                                };
                                    ...
                                    F = c[0],
                                    _ = c[1],
                                    D = (0, n.useState)(() => E(u, r, l)),
                                    d = D[0],
                                    m = D[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        A.current ? m(E(F, r, l)) : (A.current = !0);
                                    }, [l, F, r]),
                                    (0, n.useEffect)(() => {
                                        _(u);
                                    }, [u]),
                    ...
                    ke = Te[1],
                    Oe = (u, e) => ({
                        backgroundImage: `url(R.images.frontline.gui.maps.icons.levelChange.level_${u}${e >= b.Small ? '_big' : ''})`,
                    }),
                    Re = () => {
                        const u = w().mediaSize,
                            e = ke().model.vehiclesSlide.get(),
                            t = e.fromLevel,
                            r = e.toLevel;
                        return a().createElement(
                            a().Fragment,
                            ...
                            a().createElement(
                                'div',
                                { className: 'VehiclesSlide_img_c1' },
                                a().createElement('div', {
                                    className: h()(pe, 'VehiclesSlide_level__left_6f'),
                                    style: Oe(t, u),
                                }),
                                a().createElement('div', {
                                    className: h()(pe, 'VehiclesSlide_level__right_ec'),
                                    style: Oe(r, u),
                                }),
                            ),
                            a().createElement(
                                'div',
                                { className: 'VehiclesSlide_title_a4' },
                                R.strings.fl_welcome.slide.vehicles.title(),
                            ),
                            a().createElement(ge, {
                                text: R.strings.fl_welcome.slide.vehicles.description(),
                                format: {
                                    binding: {
                                        vehiclesLevelFrom: a().createElement(ge, {
                                            text: we(t),
                                            color: 'WHITE_SPANISH',
                                        }),
                                        vehiclesLevelTo: a().createElement(ge, { text: we(r), color: 'WHITE_SPANISH' }),
                                    },
                                },
                                className: 'VehiclesSlide_description_65',
                            }),
                        );
                    },
                    Ne = [
                        {
                            header: R.strings.fl_welcome.slide.vehicles.headerUpper(),
                            frontlineLevel: 2,
                            content: [a().createElement(Re, { key: 1 })],
                        },
                        {
                            header: R.strings.fl_welcome.slide.progression.headerUpper(),
                            frontlineLevel: 3,
                            content: [
                                a().createElement(zu, {
                                    key: 2,
                                    img: 'level',
                                    title: R.strings.fl_welcome.slide.progression.reserves.title(),
                                    description: R.strings.fl_welcome.slide.progression.reserves.description(),
                                }),
                            ],
                        },
                        {
                            header: R.strings.fl_welcome.slide.map.headerUpper(),
                            frontlineLevel: 3,
                            content: [
                                a().createElement(zu, {
                                    key: 3,
                                    img: 'map',
                                    title: R.strings.arenas.c_210_bf_epic_desert.name(),
                                    description: R.strings.fl_welcome.slide.map.description(),
                                }),
                            ],
                        },
                    ],
                    He = () => {
                        const u = (0, n.useState)(0),
                            ...
                            r = ke(),
                            i = r.controls,
                            l = r.model.vehiclesSlide.get(),
                            s = l.fromLevel,
                            E = l.toLevel,
                            A = (0, n.useCallback)(() => {
                                o.O.view.setEventHandled(), i.close();
                            }, [i]);
                        var c;
                        (c = A), Y(z.n.ESCAPE, c);
                        const F = Ne.filter((u) => {
                                const e = Number(s !== E) + 1;
                                return Boolean(u.frontlineLevel & e);
                            }),
                            _ = F[e].header;
                        return a().createElement(
                            'div',
                            ...
                            a().createElement(
                                ...
                                a().createElement(Z, { text: _, classMix: 'WelcomeViewApp_pageTitle_3e' }),
                                a().createElement(su, { slides: F, slideIndex: e, onSlideChange: t }),
                                a().createElement(
                                    'div',
                ...
                engine.whenReady.then(() => {
                    H().render(
                        a().createElement(O, null, a().createElement(ye, null, a().createElement(He, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1495));
