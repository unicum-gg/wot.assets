    ...
    var __webpack_modules__ = {
            ...
            9826: (u, e, t) => {
                ...
                const s = i.O.client.getSize('rem'),
                    ...
                    d = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.largeWidth && s) return r(e, t, p);
                    ...
                    h = (0, E.memo)(({ children: u }) => {
                        const e = (0, E.useContext)(c),
                            ...
                            r = (0, E.useCallback)((u, e) => {
                                ...
                                n(Object.assign({ width: t, height: E }, o(t, E, F)));
                            }, []);
                        (m(() => {
                ...
                const M = {
                    ...
                    y = (u) => {
                        ...
                        const n = (() => {
                            ...
                            i = n.mediaHeight,
                            F = n.mediaSize;
                        return a().createElement('div', S({ className: w()(t, M[r], T[i], O[F]) }, A), e);
                    },
                    k = ['children'],
                    H = (u) => {
                        let e = u.children,
                        ...
                        return a().createElement(h, null, a().createElement(y, t, e));
                    };
                var P = t(5521),
                    N = t(4179);
                const W = (u) => {
                        ...
                        return (
                            m(() => {
                                if (
                                    ...
                                    s.current = j.addCallback(E, t, r, e === K.Deep);
                                }
                            }),
                            (0, E.useEffect)(() => {
                                if (e !== K.None)
                ...
                class Eu extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = w()(uu.base, uu[`base__${n}`], uu[`base__${A}`], null == r ? void 0 : r.base),
                            B = w()(uu.icon, uu[`icon__${n}`], uu[`icon__${A}`], null == r ? void 0 : r.icon),
                            C = w()(uu.glow, null == r ? void 0 : r.glow),
                            c = w()(uu.caption, uu[`caption__${n}`], null == r ? void 0 : r.caption),
                            _ = w()(uu.goto, null == r ? void 0 : r.goto);
                        return a().createElement(
                            ...
                            'info' !== n && a().createElement('div', { className: uu.shine }),
                ...
                const Au = (u, e, t) => {
                    ...
                    ru = (u, e, t = au.left) => u.split(e).reduce(t === au.left ? Au : nu, []),
                    iu = (() => {
                        const u = new RegExp(
                    ...
                    _u = () => {
                        const u = q('model'),
                            ...
                            _ = w()(Cu.base, D && Cu.base__out, r && Cu[`base__${r}`]),
