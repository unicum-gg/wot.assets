(() => {
    var __webpack_modules__ = {
            ...
            9826: (u, e, t) => {
                ...
                const s = i.O.client.getSize('rem'),
                    ...
                    d = (u) => {
                        ...
                        const a = (0, E.useContext)(c),
                            ...
                            p = { extraLarge: d, large: m, medium: h, small: g, extraSmall: w };
                    ...
                    h = (0, E.memo)(({ children: u }) => {
                        const e = (0, E.useContext)(c),
                            ...
                            n = (0, E.useCallback)((u, e) => {
                                ...
                                r(Object.assign({ width: t, height: E }, o(t, E, F)));
                            }, []);
                        m(() => {
                ...
                const M = {
                    ...
                    O = (u) => {
                        ...
                        const r = (() => {
                            ...
                            i = r.mediaHeight,
                            F = r.mediaSize;
                        return a().createElement('div', S({ className: w()(t, M[n], T[i], y[F]) }, A), e);
                    },
                    k = ['children'],
                    H = (u) => {
                        let e = u.children,
                        ...
                        return (
                            m(() => {
                                if (
                                                    ...
                                                    const e = G(),
                                                        ...
                                                        a =
                                                            window.__feature && window.__feature !== t && t
                                                                ? `subViews.${t}`
                                                                : '';
                                                    return { modelPrefix: a, modelPath: z(a, ''), resId: E };
                                                })(),
                                                t = e.modelPrefix,
                                                E = u.split('.');
                                            if (E.length > 0) {
                                    ...
                                    s.current = j.addCallback(E, t, n, e === K.Deep);
                                }
                            }),
                            (0, E.useEffect)(() => {
                                if (e !== K.None)
                                    return () => {
                                        j.removeCallback(s.current, n);
                                    };
                            }, [n, e]),
                            D
                        );
                    ...
                    const c = (0, E.useRef)(null),
                        ...
                        H = w()(
                            ...
                            Y[`base__${A}`],
                            {
                                ...
                                [Y.base__firstHover]: f,
                            },
                            n,
                        ),
                        P = w()(Y.state, Y.state__default);
                    return (
                        (0, E.useEffect)(
                            () => (
                ...
                class Eu extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = w()(uu.base, uu[`base__${r}`], uu[`base__${A}`], null == n ? void 0 : n.base),
                            B = w()(uu.icon, uu[`icon__${r}`], uu[`icon__${A}`], null == n ? void 0 : n.icon),
                            C = w()(uu.glow, null == n ? void 0 : n.glow),
                            c = w()(uu.caption, uu[`caption__${r}`], null == n ? void 0 : n.caption),
                            _ = w()(uu.goto, null == n ? void 0 : n.goto);
                        return a().createElement(
                            ...
                            'info' !== r && a().createElement('div', { className: uu.shine }),
                ...
                const Au = (u, e, t) => {
                    ...
                    nu = (u, e, t = au.left) => u.split(e).reduce(t === au.left ? Au : ru, []),
                    iu = (() => {
                        const u = new RegExp(
                        ...
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, r) =>
                                      a().createElement(
                                          'div',
                                          { className: w()('FormatText_base_d0', t), key: `${e}-${r}` },
                                          ((u, e, t) =>
                                              u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                                  t && u in t
                                                      ? t[u]
                    ...
                    ou = 'DescriptionBlock_description_58',
                    su = (u) => ({ __html: u.replace(/{newlineStart}/g, '<div>').replace(/{newlineEnd}/g, '</div>') }),
                    lu = ({ title: u, description: e }) => {
                        const t = e.includes('\n');
                        return a().createElement(
                            'div',
                            { className: 'DescriptionBlock_base_28' },
                            a().createElement('span', { className: 'DescriptionBlock_title_61' }, u),
                            t
                                ? a().createElement('div', { className: ou }, a().createElement(Du, { text: e }))
                                : a().createElement('div', { className: ou, dangerouslySetInnerHTML: su(e) }),
                        );
                    },
                    Bu = (u) =>
                        new Promise((e, t) => {
                            const E = new Image();
                            (E.src = u), E.addEventListener('load', e), E.addEventListener('error', t);
                        }),
                    Cu = {
                        base: 'App_base_12',
                        ...
                        bottomBackgroundLayer: 'App_bottomBackgroundLayer_e4',
                    ...
                    cu = R.strings.event.WTEventWelcomeView.welcome,
                    _u = () => {
                        const u = q('model'),
                            e = u.onVideo,
                            t = u.onClose,
                            ...
                            o = F[1],
                            s = (0, E.useRef)(!1),
                            l = (0, E.useRef)({ animationDirection: 0, videoClick: 0 }),
                            B = ((u) => {
                                const e = (0, E.useState)('pending'),
                                    t = e[0],
                                    a = e[1];
                                return (
                                    (0, E.useEffect)(() => {
                                ...
                                'R.images.white_tiger.gui.maps.icons.welcome.background__gp4',
                            ...
                            C = w()(Cu.topContainer, Cu.fadeTop),
                            c = w()(Cu.bottomContainer, Cu.fadeBot),
                            _ = w()(Cu.base, D && Cu.base__out, n && Cu[`base__${n}`]),
                            d = w()(Cu.close, Cu.fadeBot),
                            m = (0, E.useCallback)(() => {
                                U('play'),
                                    i('forward'),
                                    (l.current.videoClick = window.setTimeout(() => {
                                        e(), (l.current.animationDirection = window.setTimeout(() => i(null), 500));
                                    }, 500));
                            }, [e]),
                            h = (0, E.useCallback)(() => U('highlight'), []),
                            g = (0, E.useCallback)(() => {
                                t(), o(!0);
                            }, [t]);
                        var p;
                        return (
                            ...
                            (0, E.useEffect)(() => {
                                !A &&
                                    s.current &&
                                    (i('backward'),
                                    (l.current.animationDirection = window.setTimeout(() => i(null), 500))),
                                    (s.current = A);
                            }, [A]),
                            'done' === B
                                ? a().createElement(
                                      ...
                                      a().createElement(
                                          'div',
                                          { className: C },
                                          a().createElement('span', { className: Cu.title }, cu.title()),
                                      ),
                                      a().createElement(
                                          'div',
                                          { onClick: m, onMouseEnter: h, className: Cu.videoContainer },
                                          a().createElement('div', { className: Cu.video }),
                                      ),
                                      a().createElement(
                                          'div',
                                          { className: c },
                                      ...
                                      a().createElement(
                                          ...
                                          a().createElement(
                                              J,
                                              { type: X.primary, size: Z.medium, mixClass: Cu.cButton, onClick: g },
                                              cu.confirm_btn(),
                                          ),
                                      ),
                                      a().createElement('div', { className: Cu.bottomBackgroundLayer }),
                                  )
                ...
                engine.whenReady.then(() => {
                    r().render(
                        a().createElement(H, null, a().createElement(_u, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(9826));
