(() => {
    var __webpack_modules__ = {
            ...
            364: (u, e, t) => {
                ...
                function _(u, e, t, r, E, A, F) {
                    ...
                    a.done ? e(n) : Promise.resolve(n).then(r, E);
                }
            ...
            767: (u, e, t) => {
                ...
                const o = (u, e, t = {}, r = 0) => {
                    ...
                    B = (u) => {
                        ...
                        const b = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            f = (0, r.useMemo)(() => p || a().resId, [p]),
                            S = (0, r.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (o(t, d, { isMouseEvent: !0, on: !0, arguments: D(E) }, f),
                                    w && w(),
                            ...
                            L = (0, r.useCallback)((u) => {
                                b.current.isVisible &&
                                    ...
                                    (b.current.hideTimerId = window.setTimeout(() => {
                                        ...
                                        e && !e.isSameNode(b.current.prevTarget) && M();
                                    }, 200)));
                            }, []);
                        (0, r.useEffect)(() => {
                                  ...
                                  Object.assign(
                                      {
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((b.current.timeoutId = window.setTimeout(S, s ? 100 : 400)),
                                                      A && A(u),
                                                      O && O(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                                          ...
                                          onClick: ((u) => (e) => {
                                              !1 === _ && M(), null == B || B(e), null == u || u(e);
                                          })(e.props.onClick),
                                          onMouseDown: ((u) => (e) => {
                                              !1 === _ && M(), null == n || n(e), null == u || u(e);
                                          })(e.props.onMouseDown),
                                      },
                                      x,
                                  ),
                ...
                const C = (u) => {
                    ...
                    _ = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    m = (u) => {
                    ...
                    h = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const r = _(`${u}.${t}`, window);
                                return d(r) ? e(u, t, r) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    g = (u) => {
                        const e = ((u) => {
                                const e = a(),
                                ...
                                return { modelPrefix: E, modelPath: c(E, u || ''), resId: r };
                            })(),
                            t = e.modelPrefix,
                            r = u.split('.');
                        if (r.length > 0) {
                            ...
                            return (
                                r.reduce((e, r) => {
                                    const E = _(c(t, `${e}.${r}`), window);
                                    return d(E) ? (u.push(E.id), `${e}.${r}.value`) : (u.push(r), `${e}.${r}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const v = (u = 'model', e = w.Deep) => {
                            ...
                            m(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        r = g(u);
                                    l.current = p.addCallback(r, t, n, e === w.Deep);
                                }
                            }),
                            (0, r.useEffect)(() => {
                                if (e !== w.None)
                                    return () => {
                                        p.removeCallback(l.current, n);
                                    };
                            }, [n, e]),
                            o
                        );
                    ...
                    x = 'Perk_base_43',
                    b = ({ tooltipID: u, icon: e }) => {
                        const t = (0, r.useMemo)(() => ({ backgroundImage: e ? `url(${e})` : '' }), [e]),
                            A = (0, r.useMemo)(() => ({ tooltipId: u }), [u]);
                        return E().createElement(
                            C,
                            { args: A, key: u },
                            E().createElement('div', { className: x, style: t }),
                        );
                    },
                    f = 'App_base_87',
                    S = 'App_commander_9b',
                ...
                const K = U.O.client.getSize('rem'),
                    z = K.width,
                    Y = K.height,
                    $ = Object.assign({ width: z, height: Y }, V(z, Y, j)),
                    q = (0, r.createContext)($),
                    Z = ['children'];
                const Q = (u) => {
                    let e = u.children,
                    ...
                    const E = (0, r.useContext)(q),
                        ...
                        m = E.mediumHeight,
                        d = E.smallHeight,
                        c = E.extraSmallHeight,
                        h = { extraLarge: C, large: _, medium: m, small: d, extraSmall: c };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && D) return G(e, t, h);
                        if (t.largeWidth && o) return G(e, t, h);
                        if (t.mediumWidth && B) return G(e, t, h);
                        if (t.smallWidth && l) return G(e, t, h);
                        if (t.extraSmallWidth && s) return G(e, t, h);
                        if (
                        ...
                        const e = (0, r.useContext)(q),
                            ...
                            a = (0, r.useCallback)((u, e) => {
                                const t = U.O.view.pxToRem(u),
                                    r = U.O.view.pxToRem(e);
                                F(Object.assign({ width: t, height: r }, V(t, r, j)));
                            }, []);
                        m(() => {
                            engine.on('clientResized', a);
                        }),
                            (0, r.useEffect)(() => () => engine.off('clientResized', a), [a]);
                        const n = (0, r.useMemo)(() => Object.assign({}, A), [A]);
                        return E().createElement(q.Provider, { value: n }, u);
                    });
                let J, uu, eu;
                !(function (u) {
                ...
                const tu = () => {
                        const u = (0, r.useContext)(q),
                            ...
                            A = ((u) => {
                                switch (!0) {
                                    ...
                                    default:
                                        return console.error('Unreachable media context resolution'), uu.ExtraSmall;
                                }
                            })(u),
                            F = ((u) => {
                                switch (!0) {
                        ...
                        return { mediaSize: E, mediaWidth: A, mediaHeight: F, remScreenWidth: e, remScreenHeight: t };
                    },
                    ru = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Eu = (u) => u.includes('_') && ((u) => ru.includes(u))(u.split('_').at(-1)),
                    Au = [J.ExtraLarge, J.Large, J.Medium, J.Small, J.ExtraSmall],
                    Fu = (u, e) =>
                    ...
                    au = (u, e = Fu) => {
                        const t = (
                            (u, e = Fu) =>
                            (t) => {
                                const A = tu().mediaSize,
                                    F = (0, r.useMemo)(() => e(t, A), [t, A]);
                ...
                const ou = {
                    ...
                    su = au((u) => {
                        let e = u.className,
                            ...
                            _ = u.row,
                            m = u.flexDirection,
                            d = void 0 === m ? (C ? 'column' : _ && 'row') || void 0 : m,
                            c = u.flexStart,
                            h = u.center,
                            g = u.flexEnd,
                            p = u.spaceBetween,
                            ...
                            x =
                                void 0 === v
                                    ...
                                    : v,
                            b = u.alignItems,
                            f = void 0 === b ? (c ? 'flex-start' : h && 'center') || (g && 'flex-end') || void 0 : b,
                            S = u.alignSelf,
                            M = u.wrap,
                            L = u.flexWrap,
                            ...
                            R = u.shrink,
                            y = u.flex,
                            P = void 0 === y ? (T || R ? `${T ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : y,
                            k = u.style,
                            N = u.children,
                            I = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, A, n, D, B, s, k, P, S, d, O, x, f]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return E().createElement('div', Du({ className: H()(nu.base, ...U, e), style: G }, I), N);
                    });
                let Cu;
                !(function (u) {
                ...
                const _u = (u, e, t) => {
                    ...
                    du = (u, e, t = Cu.left) => u.split(e).reduce(t === Cu.left ? _u : mu, []),
                    cu = (() => {
                        const u = new RegExp(
                        ...
                        return hu.includes(t)
                            ...
                            : ((u, e = Cu.left) => {
                                  ...
                                  const r =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return du(E, /( )/, e).forEach((u) => (t = t.concat(du(u, r, Cu.left)))), t;
                              })(u, e);
                    },
                    pu = 'FormatText_base_d0',
                    wu = ({ binding: u, text: e = '', classMix: t, alignment: A = Cu.left }) =>
                        null === e
                            ...
                            : E().createElement(
                                  ...
                                  e.split('\n').map((e, F) =>
                                      E().createElement(
                                          'div',
                                          { className: H()(pu, t), key: `${e}-${F}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : gu(u, e))))(e, A, u).map((u, e) =>
                ...
                const Mu = Object.keys(xu()),
                    ...
                    ku = au((u) => {
                        ...
                        return E().createElement(
                            ...
                            Su(
                                {
                                    className: H()(bu.base, t && bu[t], g, A),
                                    style: h,
                                    mt: !0 === i ? yu[t || 'paragraph-P16'].mt : i,
                                    mr: !0 === o ? yu[t || 'paragraph-P16'].mr : o,
                                    mb: !0 === l ? yu[t || 'paragraph-P16'].mb : l,
                                    ml: !0 === C ? yu[t || 'paragraph-P16'].ml : C,
                                },
                                d,
                            ),
                            void 0 !== m ? E().createElement(wu, Su({}, m, { text: e })) : e,
                        );
                    }),
                    Nu = () => {
                        const u = v(),
                            e = u.nation,
                            t = u.perkList,
                            A = (0, r.useMemo)(() => ({ tooltipId: 'battleRoyaleTankman' }), []),
                            F = (0, r.useMemo)(
                                () => ({
                                    backgroundImage: e
                                        ? `url('R.images.gui.maps.icons.battleRoyale.hangar.flags.commander.flag_${e}')`
                                        : '',
                                }),
                                [e],
                            ),
                            a = (0, r.useMemo)(
                                () => ({
                                    backgroundImage: e
                                        ? `url('R.images.gui.maps.icons.battleRoyale.hangar.commanders.commander_large_${e}')`
                                        : '',
                                }),
                                [e],
                            );
                        return E().createElement(
                            ...
                            E().createElement(
                                ...
                                E().createElement(
                                    'div',
                                    { className: S },
                                    E().createElement('div', { className: P, style: F }),
                                    E().createElement('div', { className: L, style: a }),
                                    E().createElement(
                                        'div',
                                        { className: M },
                                        E().createElement(ku, {
                                        ...
                                        e &&
                                            E().createElement(
                                                ...
                                                null,
                                                E().createElement(ku, {
                                                    text: R.strings.battle_royale.commanderInfo.fullName.$dyn(e),
                                                    className: T,
                                                }),
                                                E().createElement(ku, {
                                                    text: R.strings.battle_royale.commanderInfo.description.$dyn(e),
                                                    className: y,
                                                }),
                                            ),
                                    ),
                            ...
                            E().createElement(
                                ...
                                t.map(
                                    (u) =>
                                        u.value &&
                                        E().createElement(b, {
                                            key: u.value.tooltipID,
                                            tooltipID: u.value.tooltipID,
                                            icon: u.value.icon,
                                        }),
                                ),
                            ),
                ...
                engine.whenReady.then(() => {
                    F().render(E().createElement(Nu, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, t, r) => {
            if (!e) {
                ...
                for (n = 0; n < deferred.length; n++) {
                    for (var [e, t, r] = deferred[n], A = !0, F = 0; F < e.length; F++)
                        (!1 & r || E >= r) &&
        ...
        (() => {
            ...
            var e = (e, t) => {
                    var r,
                        ...
                        n = 0;
                    if (A.some((e) => 0 !== u[e])) {
                        for (r in F) __webpack_require__.o(F, r) && (__webpack_require__.m[r] = F[r]);
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [881], () => __webpack_require__(767));
