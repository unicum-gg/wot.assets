                ...
                const x = 'FormatText_base_d0',
                    ...
                    z = () => {
                        const u = b(),
                            ...
                            t = (0, F.useMemo)(
                                () => ({
                                    marginTop: `${D.marginTop}rem`,
                                    marginRight: `${D.marginRight}rem`,
                                    marginBottom: `${D.marginBottom}rem`,
                                    marginLeft: `${D.marginLeft}rem`,
                                }),
                                [D],
                            ),
                            B = (0, F.useMemo)(() => {
                                const u = {};
                                return (
                                    D.path && (u[D.placeholder] = E().createElement(U, { src: D.path, style: t })), u
                                );
                            }, [D, t]);
                        return E().createElement(
                            'div',
                            { className: W },
                            A && E().createElement(L, { classMix: I, text: A, binding: B }),
