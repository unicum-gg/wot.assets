            ...
            851: (u, e, t) => {
                ...
                const D = (u = 1) => {
                    ...
                    _ = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: A, modelPath: c(A, u || ''), resId: n };
                            })(),
                            t = e.modelPrefix,
                            n = u.split('.');
                        if (n.length > 0) {
                        ...
                        B(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = _(u);
                                w.current = l.addCallback(n, t, o, e === v.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== v.None)
                                return () => {
                                    l.removeCallback(w.current, o);
                                };
                        }, [o, e]),
                        s
                    );
                ...
                const g = (u, e, t = {}, n = 0) => {
                    ...
                    f = (u) => {
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            O = (0, n.useMemo)(() => v || D().resId, [v]),
                            T = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (g(t, c, { isMouseEvent: !0, on: !0, arguments: b(A) }, O),
                                    w && w(),
                ...
                const T = (u, e) => ({
                    ...
                    P = (0, n.memo)(({ iconName: u, amount: e, tooltip: t, classMix: F }) => {
                        const E = (0, n.useMemo)(
                            ...
                            o = (0, n.useMemo)(
                                () =>
                                    t
                                        ? ((u, e) => T(u.type, Object.assign({ id: u.id }, e || {})))(t, {
                                              tooltipID: 'TOOLTIP_BONUS',
                                          })
                                        : T(O.absent, {}),
                                [t],
                            ),
                            i = p()(M, F),
                            s = (0, n.useMemo)(() => r(R.strings.hb_shop.common.pieces(), { number: e }), [e]),
                            D = e > 1;
                        return A().createElement(
                            ...
                            A().createElement(
                                'div',
                                { className: i, style: E },
                                D && A().createElement('div', { className: y }, s),
                            ),
                        );
                    }),
                    k = 'Order_base_76',
                    ...
                    L = (0, n.memo)(({ type: u, amount: e, classMix: t }) => {
                        const F = (0, n.useMemo)(
                                () => ({
                                    backgroundImage: `url(${R.images.historical_battles.gui.maps.icons.order.c_192x192.$dyn(u)})`,
                                }),
                                [u],
                            ),
                            E = p()(k, t),
                        ...
                        return A().createElement(
                            f,
                            T(O.backport, { tooltipID: 'TOOLTIP_ORDER' }),
                            A().createElement(
                                'div',
                                { className: E, style: F },
                                i && A().createElement('div', { className: S }, o),
                            ),
                        );
                    }),
                    N = 'OrderWithBonusesContentApp_base_5f',
                    x = 'OrderWithBonusesContentApp_bonus_83',
                    I = 'OrderWithBonusesContentApp_bonusList_22',
                    U = 'OrderWithBonusesContentApp_composition_f2',
                ...
                const q = () => {
                    ...
                    return A().createElement(
                        ...
                        A().createElement(
                            'div',
                            { className: V },
                            A().createElement(L, { type: t.type, amount: t.count, classMix: x }),
                            A().createElement(
                                'div',
                                { className: W },
                                R.strings.hb_shop.booster_buy_dialog.present(),
