        ...
        A = {
            603: (u, A, F) => {
                ...
                const g = {
                    ...
                    b = Object.keys(w).reduce((u, A) => ((u[A] = () => d(w[A])), u), {}),
                ...
                const nu = Object.keys(_).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === _[A]), u), {}),
                    Cu = {
                        set: (u, A) => {
                ...
                const fu = lu().forwardRef(function (u, A) {
                    let F = u.children,
                        e = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        lu().createElement(
                            ...
                            lu().createElement('div', { className: du.decorator }, F),
                        )
                    );
                });
                var gu = F(533),
                ...
                const yu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Ru = (u, A, F = bu.left) => u.split(A).reduce(F === bu.left ? xu : Pu, []),
                    Tu = (() => {
                        const u = new RegExp(
                            [
                    ...
                    _u = (u, A = bu.left) => {
                        ...
                        return ((u, A = bu.left) => {
                            ...
                            const e =
                                ...
                                E = yu(u);
                            return (Ru(E, /( )/, A).forEach((u) => (F = F.concat(Ru(u, e, bu.left)))), F);
                        })(u, A);
                    },
                    Ou = 'FormatText_base_d0',
                    zu = ({ binding: u, text: A = '', classMix: F, alignment: e = bu.left, formatWithBrackets: E }) => {
                        if (null === A) return (console.error("FormatText was supplied with 'null'"), null);
                        const D = E && u ? hu(A, u) : A;
                        return lu().createElement(
                            ...
                            D.split('\n').map((A, E) =>
                                lu().createElement(
                                    'div',
                                    { className: n()(Ou, F), key: `${A}-${E}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : _u(u, A))))(
                                        A,
                                        e,
                                        u,
                                    ).map((u, A) => lu().createElement(su.Fragment, { key: `${A}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                ...
                const $u = ((u, A) => {
                        ...
                        return [
                            function ({ mode: e = 'real', options: E, children: D, mocks: B }) {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const t = 'string' == typeof D ? `${e}.${D}` : e,
                                                            n = au.view.addModelObserver(t, A, !0);
                                ...
                                return (
                                    ...
                                    lu().createElement(F.Provider, { value: s }, D)
                                );
                            },
                            () => (0, su.useContext)(F),
                        ];
                        ...
                        ({ observableModel: u }) => {
                            const A = {
                                root: u.object(),
                                primitives: u.primitives(['mapCount', 'maxCooldownTimeStr']),
                            };
                    ...
                    Uu = 'App_base_67',
                    Hu = 'App_header_65',
                    qu = 'App_description_0e',
                    Wu = 'App_highlightDesc_f3',
                    Qu = 'App_rule_38',
                    Xu = 'App_dot_e1',
                    Zu = (0, ju.Pi)(() => {
                        const u = Iu().model;
                        return lu().createElement(
                            ...
                            lu().createElement(
                                'div',
                                { className: Hu },
                                R.strings.premacc.mapsBlacklist.infoTooltip.header(),
                            ),
                            lu().createElement(
                                'div',
                                { className: qu },
                                lu().createElement(zu, {
                                    text: R.strings.premacc.mapsBlacklist.infoTooltip.desc(),
                                    binding: { mapCount: u.primitives.mapCount.get() },
                                }),
                            ),
                            lu().createElement(
                                'div',
                                { className: Wu },
                                lu().createElement('div', { className: Xu }),
                                R.strings.premacc.mapsBlacklist.infoTooltip.highlightDesc(),
                            ),
                            lu().createElement(
                                'div',
                                { className: Qu },
                                lu().createElement('div', { className: Xu }),
                                R.strings.premacc.mapsBlacklist.infoTooltip.rule2(),
                            ),
                            lu().createElement(
                                'div',
                                { className: Qu },
                                lu().createElement('div', { className: Xu }),
                                lu().createElement(zu, {
                                    text: R.strings.premacc.mapsBlacklist.infoTooltip.rule1(),
                                    binding: { maxCooldownTimeStr: u.primitives.maxCooldownTimeStr.get() },
                                }),
                            ),
                            lu().createElement(
                                'div',
                                { className: Qu },
                                lu().createElement('div', { className: Xu }),
                                R.strings.premacc.mapsBlacklist.infoTooltip.rule3(),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    pu().render(
                        lu().createElement(fu, null, lu().createElement(Gu, null, lu().createElement(Zu, null))),
