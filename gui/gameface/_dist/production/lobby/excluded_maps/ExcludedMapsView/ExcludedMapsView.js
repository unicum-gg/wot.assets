                    ...
                    q = (({
                        ...
                        return (l = {}) => {
                            ...
                            return (0, a.useMemo)(
                                ...
                                [_.scrollPosition, p, g, F.off, F.on, b, h, B, E.step.clampedArrowStepTimeout],
                            );
                        };
                    })({
                        ...
                        (0, a.useEffect)(() => H(B)),
                            ...
                            (0, a.useEffect)(() => {
                                ...
                                const e = (e) => {
                                    ...
                                    t = () => {
                                        window.removeEventListener('mousemove', e), m(ru);
                                    };
                                return (
                                    ...
                                    onMouseDown: (e) => {
                                        ...
                                        if (a && 0 === e.button)
                                            if ((Y('play'), e.target === a))
                                                m({ pending: !0, offset: e.screenY - a.getBoundingClientRect().y });
                                            else {
                                                ((e) => {
                                                    c.current &&
                                                        su(u, (a) => {
