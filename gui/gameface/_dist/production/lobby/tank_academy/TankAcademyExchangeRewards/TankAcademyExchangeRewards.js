(() => {
            ...
            763: (u, e, t) => {
                ...
                const o = n.O.client.getSize('rem'),
                    ...
                    c = (u) => {
                        ...
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && D) return E(e, t, w);
                            if (t.largeWidth && s) return E(e, t, w);
                            if (t.mediumWidth && l) return E(e, t, w);
                            if (t.smallWidth && c) return E(e, t, w);
                            if (t.extraSmallWidth && _) return E(e, t, w);
                            if (!(
                                t.extraLargeWidth ||
                                t.largeWidth ||
                                t.mediumWidth ||
                ...
                const x = {
                    ...
                    M = (u) => {
                        ...
                        const n = (() => {
                            ...
                            i = n.mediaHeight,
                            F = n.mediaSize;
                        return a().createElement('div', f({ className: m()(t, x[A], T[i], L[F]) }, E), e);
                    },
                    S = ['children'],
                    y = (u) => {
                        let e = u.children,
                ...
                const I = ({
                    ...
                    const c = (0, r.useRef)(null),
                        ...
                        T = (0, r.useCallback)(
                            (u) => {
                                d && null !== c.current && !c.current.contains(u.target) && h(!1);
                            },
                            [d],
                        ),
                        L = (0, r.useCallback)(
                        ...
                        W = m()(
                            ...
                            P[`base__${E}`],
                            {
                                ...
                                [P.base__firstHover]: p,
                            },
                            A,
                        ),
                        I = m()(P.state, P.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                ...
                class z extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = m()(G.base, G[`base__${n}`], G[`base__${E}`], null == A ? void 0 : A.base),
                            B = m()(G.icon, G[`icon__${n}`], G[`icon__${E}`], null == A ? void 0 : A.icon),
                            C = m()(G.glow, null == A ? void 0 : A.glow),
                            c = m()(G.caption, G[`caption__${n}`], null == A ? void 0 : A.caption),
                            _ = m()(G.goto, null == A ? void 0 : A.goto);
                ...
                const X = (u, e, t) => {
                    ...
                    Q = (u, e, t = Y.left) => u.split(e).reduce(t === Y.left ? X : Z, []),
                    J = (() => {
                        const u = new RegExp(
                ...
                var eu = t(282);
                const tu = ({ binding: u, text: e = '', classMix: t, alignment: E = Y.left }) =>
                        null === e
                    ...
                    Au = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((i = i.replace(t, `%(${A})`)),
                                    (n[A] = ru[u]
                                        ? a().createElement(
                                              'span',
                                              { className: ru[u] },
                                              a().createElement(tu, { text: D, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: E(u) },
                        ...
                        return a().createElement(tu, { text: i, classMix: t, binding: n });
                    });
                function iu() {
                    return !1;
                }
                ...
                const Du = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: A, mocks: i }) {
                                const F = (0, r.useRef)([]),
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : i(e),
                                                            a = Fu.observable.box(r, { equals: iu });
                                                        return (
                                                            'real' === u &&
                                                                A.subscribe(
                                                                    (0, Fu.action)((u) => a.set(u)),
                                                                    e,
                                                                ),
                                                            a
                                                        );
                                    ...
                                    l = s[0],
                                    B = s[1],
                                    C = (0, r.useState)(() => o(u, E, i)),
                                    c = C[0],
                                    _ = C[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        D.current ? _(o(l, E, i)) : (D.current = !0);
                                    }, [i, l, E]),
                                    (0, r.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                    ...
                    Bu = su[1],
                    Cu = 'App_button_92',
                    cu = R.strings.tank_academy.bonusDelayed.dialog;
                let _u;
                !(function (u) {
                    ((u[(u.Confirm = 0)] = 'Confirm'), (u[(u.Cancel = 1)] = 'Cancel'));
                })(_u || (_u = {}));
                const du = (0, eu.observer)(() => {
                    const u = Bu(),
                        e = u.model,
                        t = u.controls,
                        E = e.get(),
                        n = E.vehicleName,
                        A = E.vehicleUserName,
                        i = (0, r.useState)(_u.Confirm),
                        F = i[0],
                        o = i[1],
                        D = R.images.gui.maps.shop.vehicles.c_360x270.$dyn(n.replace(/-/g, '_'));
                    return (
                        q(K.n.ESCAPE, t.close),
                        q(K.n.TAB, (u) => {
                        ...
                        a().createElement(
                            'div',
                            { className: 'App_base_f8' },
                            a().createElement(
                                'div',
                                { className: 'App_closeButton_a1' },
                                a().createElement(z, {
                                    caption: cu.closeBtn(),
                                    type: 'close',
                                    side: 'right',
                            ...
                            a().createElement(
                                'div',
                                { className: 'App_dialog_e4' },
                                a().createElement(
                                    'div',
                                    { className: 'App_title_e9' },
                                    a().createElement(Au, { text: cu.title(), binding: { vehicleName: A } }),
                                ),
                                a().createElement('div', {
                                    className: 'App_vehicle_53',
                                    style: { backgroundImage: `url(${D})` },
                                }),
                                a().createElement(
                                    'div',
                                    { className: 'App_description_21' },
                                    a().createElement(Au, { text: cu.description(), binding: { vehicleName: A } }),
                                ),
                                a().createElement('div', { className: 'App_divider_23' }),
                                a().createElement(
                                    'div',
                                    { className: 'App_actions_80' },
                                    a().createElement(
                                        U,
                                        {
                                            size: W.medium,
                ...
                engine.whenReady.then(() => {
                    k().render(
                        a().createElement(lu, null, a().createElement(y, null, a().createElement(du, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(763));
