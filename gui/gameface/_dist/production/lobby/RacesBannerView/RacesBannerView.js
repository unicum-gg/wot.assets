(() => {
    var __webpack_modules__ = {
            ...
            2735: (u, e, t) => {
                ...
                const s = i.O.client.getSize('rem'),
                    l = s.width,
                    B = s.height,
                    C = Object.assign({ width: l, height: B }, o(l, B, F)),
                    c = (0, r.createContext)(C),
                    d = ['children'],
                    m = (u) => {
                        let e = u.children,
                            t = (function (u, e) {
                ...
                const S = {
                    ...
                    y = (u) => {
                        ...
                        const A = (() => {
                            ...
                            i = A.mediaHeight,
                            F = A.mediaSize;
                        return n().createElement('div', L({ className: g()(t, S[a], M[i], T[F]) }, E), e);
                    },
                    O = ['children'],
                    k = (u) => {
                        let e = u.children,
                        ...
                        return n().createElement(h, null, n().createElement(y, t, e));
                    };
                function P() {
                    return !1;
                }
                ...
                const N = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const F = (0, r.useRef)([]),
                                    D = (u, t, r) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            s = { mode: u, model: o, externalModel: A, cleanup: D };
                                        return {
                                            model: o,
                                    ...
                                    l = s[0],
                                    B = s[1],
                                    C = (0, r.useState)(() => D(u, E, a)),
                                    c = C[0],
                                    d = C[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        o.current ? d(D(l, E, a)) : (o.current = !0);
                                    }, [a, l, E]),
                                    (0, r.useEffect)(() => {
                                        B(u);
                                    }, [u]),
                    ...
                    })(0, ({ externalModel: u }) => ({ onOpenRacesLobby: u.createCallbackNoArgs('onOpenRacesLobby') })),
                    U = W[0],
                    G = W[1];
                var j = t(3403);
                function V(u) {
                ...
                const q = (u, e, t) => {
                    ...
                    Y = (u, e, t = z.left) => u.split(e).reduce(t === z.left ? q : K, []),
                    X = (() => {
                        const u = new RegExp(
                        ...
                        return (
                            (0, r.useEffect)(() => {
                                ...
                                switch (d) {
                                    ...
                                    case 'stop':
                                        return (function () {
                                            const u = 0 === o && _ ? { path: _, x: 0, y: 0 } : E(o),
                                                e = new Image();
                                            e.src = u.path;
                                            const r = () => t(au(u, e));
                                            return (
                            ...
                            n().createElement('canvas', nu({}, g, { width: e, height: t, ref: v }))
                        );
                    }),
                    Au = (u, e) => {
                        let t = u;
                ...
                const ou = (u, e, t = {}, r = 0) => {
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            p = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (ou(t, B, { isMouseEvent: !0, on: !0, arguments: Du(n) }, w),
                                    h && h(),
                    ...
                    lu = ({ binding: u, text: e = '', classMix: t, alignment: E = z.left }) =>
                        null === e
                ...
                const Cu = R.strings.menu.dateTime.months,
                    cu = R.strings.races.banner,
                    du = {
                        base: 'App_base_79',
                        base__disabled: 'App_base__disabled_56',
                        bg: 'App_bg_35',
                        shadow: 'App_shadow_61',
                        highlight: 'App_highlight_b2',
                        overlay: 'App_overlay_80',
                        particles: 'App_particles_c4',
                        content: 'App_content_4d',
                        title: 'App_title_8b',
                        disabled: 'App_disabled_a9',
                        finishSoon: 'App_finishSoon_76',
                        date: 'App_date_58',
                        base__finishSoon: 'App_base__finishSoon_43',
                        clockIcon: 'App_clockIcon_0e',
                    };
                function mu() {
                    return (
                        (mu =
                ...
                const hu = { [Bu.Disabled]: du.base__disabled, [Bu.Active]: du.base__active },
                    _u = R.strings.races.banner,
                    gu = {
                        width: 280,
                        height: 170,
                        frameCount: 136,
                        chunk: { count: 1, rows: 20, columns: 7 },
                        getChunkPath: () => 'R.images.races.gui.maps.icons.races_banner.particles_sequence',
                    },
                    vu = (function (u) {
                        const e = u.chunk,
                            t = e.rows * e.columns;
                    ...
                    wu = (0, j.Pi)(() => {
                        const u = G(),
                            ...
                            o = F
                                ? ((u, e) => {
                                      const t = eu(e);
                                      if (0 === t.minutes) return { text: cu.time.lessThanMinute(), time: null };
                                      if (0 === t.days) {
                                          const u = (function (u) {
                                              return u.days > 0
                                          ...
                                          return {
                                              text: cu.time.timeLeft(),
                                              time:
                                                  ((r = u),
                                                  (n = { day: t.days, hour: t.hours, min: t.minutes }),
                                                  r.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                                      ...
                                      return {
                                          text: cu.time.endTime(),
                                          time: `${E.getDate()} ${Cu.$num(E.getMonth() + 1)}`,
                                      };
                                  })(a, i)
                                : null,
                            s = (function (u = {}, e = []) {
                                var t, n, E, A;
                                const a = (0, r.useState)(null != (t = u.state) ? t : tu),
                                    i = a[0],
                                    F = a[1],
                                    D = (0, r.useState)(null != (n = u.initialFrameIndex) ? n : 0),
                                    o = D[0],
                                    s = D[1],
                                    l = (0, r.useState)(null != (E = u.frameTime) ? E : 33),
                                    B = l[0],
                                    C = l[1],
                                    c = (0, r.useState)(null == (A = u.loop) || A),
                                    d = c[0],
                                    m = c[1],
                                    h = (0, r.useRef)(o),
                                    _ = (0, r.useCallback)((u) => {
                                    ...
                                    w = (0, r.useCallback)(() => F('play'), []),
                                    p = (0, r.useCallback)(() => {
                                        (s(h.current + 1), F('stop'));
                                    }, []);
                                return {
                                    props: {
                                        state: i,
                        ...
                        return n().createElement(
                            su,
                            {
                                contentId: R.views.races.lobby.tooltips.RacesBannerInactiveTooltipView('resId'),
                                isEnabled: A === Bu.Disabled,
                                ignoreShowDelay: !0,
                            },
                            n().createElement(
                                'div',
                                {
                                    className: g()(du.base, hu[A]),
                                    onClick: () => {
                                        A !== Bu.Disabled && (V(R.sounds.yes()), t.onOpenRacesLobby());
                                    },
                                    onMouseEnter: () => {
                                        A !== Bu.Disabled && ($.playHighlight(), s.play());
                                    },
                                    onMouseLeave: () => {
                                        s.stop();
                                    },
                                ...
                                A === Bu.Disabled && n().createElement('div', { className: du.overlay }),
                                n().createElement('div', { className: du.shadow }),
                                F &&
                                    n().createElement(
                                        n().Fragment,
                                        null,
                                        n().createElement('div', { className: du.highlight }),
                                        n().createElement(
                                            Eu,
                                            mu({}, s.props, {
                                                width: gu.width,
                                                ...
                                                frameTime: 50,
                                                loop: !1,
                                                className: du.particles,
                                            }),
                                        ),
                                        D && n().createElement('div', { className: du.finishSoon }),
                                    ),
                                n().createElement(
                                    'div',
                                    { className: du.content },
                                    n().createElement('div', { className: du.title }, _u.title()),
                                    F
                                        ? n().createElement(
                                              'div',
                                              { className: du.date },
                                              n().createElement('div', { className: du.clockIcon }),
                                              n().createElement(lu, { text: o.text, binding: { time: o.time } }),
                                          )
                                        : n().createElement('div', { className: du.disabled }, _u.disabled()),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    A().render(
                        n().createElement(U, null, n().createElement(k, null, n().createElement(wu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(2735));
