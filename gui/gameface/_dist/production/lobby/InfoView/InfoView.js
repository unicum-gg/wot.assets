(() => {
    var __webpack_modules__ = {
            ...
            842: (u, e, t) => {
                ...
                const x = {
                    ...
                    S = (u) => {
                        ...
                        const i = (() => {
                            ...
                            A = i.mediaHeight,
                            o = i.mediaSize;
                        return n().createElement('div', b({ className: m()(t, x[E], y[A], L[o]) }, a), e);
                    },
                    T = ['children'],
                    O = (u) => {
                        let e = u.children,
                        ...
                        return n().createElement(d, null, n().createElement(S, t, e));
                    };
                var M = t(986),
                    k = t.n(M);
                function H(u) {
                ...
                class G extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = m()(N.base, N[`base__${i}`], N[`base__${a}`], null == E ? void 0 : E.base),
                            B = m()(N.icon, N[`icon__${i}`], N[`icon__${a}`], null == E ? void 0 : E.icon),
                            c = m()(N.glow, null == E ? void 0 : E.glow),
                            C = m()(N.caption, N[`caption__${i}`], null == E ? void 0 : E.caption),
                            d = m()(N.goto, null == E ? void 0 : E.goto);
                ...
                const Z = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    tu = ({ binding: u, text: e = '', classMix: t, alignment: a = Y.left, formatWithBrackets: i }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const E = i && u ? ((A = u), e.replace(/\{\w+\}/g, (u) => String(A[u.slice(1, -1)]))) : e;
                        var A;
                        return n().createElement(
                            r.Fragment,
                            null,
                ...
                const iu = (0, r.memo)((u) => {
                    ...
                    const i = ((u, e) => {
                                    ...
                                    (A = A.replace(s, `%(${t})`)),
                                        (i[t] = ru[u]
                                            ? n().createElement(
                                                  'span',
                                                  { className: ru[u] },
                                                  n().createElement(tu, { text: B, binding: e }),
                                              )
                                            : n().createElement(
                                                  'span',
                                                  { style: ((F = u), { color: `#${F}` }) },
                        ...
                        E = i[0],
                        A = i[1];
                    return n().createElement(tu, au({ text: E, classMix: r, binding: A }, a));
                });
                let Eu;
                !(function (u) {
                    (u.China = 'CN'), (u.Ru = 'RU');
                })(Eu || (Eu = {}));
                const Au = R.images.grinch_progression.gui.maps.icons.info_view.video_cover,
                    ou = (u, e) =>
                        Au.$dyn(u.replace(/-/g, '_')) ||
                        ((u) => {
                            switch (u) {
                                case Eu.China:
                                    return Au.cn();
                    ...
                    Fu = (0, r.memo)(({ realm: u, language: e, onVideoClicked: t, className: r, onMouseEnter: a }) =>
                        n().createElement(
                            'div',
                            {
                                className: m()('VideoCover_base_a0', r),
                                onClick: t,
                                onMouseEnter: () => {
                                    P.playHighlight(), null == a || a();
                                },
                            },
                            n().createElement('div', {
                                className: 'VideoCover_cover_a4',
                                style: e || u ? { backgroundImage: `url('${ou(e, u)}')` } : void 0,
                            }),
                            n().createElement('div', { className: 'VideoCover_playButton_d6' }),
                        ),
                    );
                var su = t(521);
                const lu = (u) => {
                ...
                function Du(u = su.n.NONE, e = lu, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== su.n.NONE)
                            return (
                ...
                const _u = (u) => (0 === u ? window : window.subViews.get(u)),
                    mu = ((u, e) => {
                                ...
                                const o = (0, r.useRef)([]),
                                    F = (u, t, r) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            s = (({ observableModel: u }) => {
                                                const e = { root: u.object(), region: u.object('region') };
                        ...
                        playVideo: u.createCallbackNoArgs('onVideoClick'),
                        close: u.createCallbackNoArgs('onClose'),
                        showAboutEvent: u.createCallbackNoArgs('onShowAboutEvent'),
                    })),
                    hu = mu[0],
                    gu = mu[1],
                    vu = R.strings.grinch_progression.infoView.sources,
                    pu = ({ type: u, classNames: e }) =>
                        n().createElement(
                            'div',
                            { className: m()('DescriptionBlock_base_50', null == e ? void 0 : e.base) },
                            n().createElement('div', {
                                className: 'DescriptionBlock_icon_81',
                                style: {
                                    backgroundImage: `url('R.images.grinch_progression.gui.maps.icons.info_view.sources.${u}')`,
                                },
                            }),
                            n().createElement(
                                'div',
                                { className: 'DescriptionBlock_infoBlock_ff' },
                                n().createElement(
                                    'div',
                                    { className: 'DescriptionBlock_title_f9' },
                                    n().createElement(tu, { text: vu.title.$dyn(u) }),
                                ),
                                n().createElement(
                                    'div',
                                    { className: 'DescriptionBlock_description_f9' },
                                    n().createElement(tu, { text: vu.description.$dyn(u) }),
                                ),
                            ),
                        );
                let fu;
                !(function (u) {
                    (u.EventProgress = 'eventProgress'), (u.GiftCoins = 'giftCoins'), (u.MoreCoins = 'moreCoins');
                })(fu || (fu = {}));
                const wu = [fu.GiftCoins, fu.EventProgress, fu.MoreCoins],
                    bu = R.strings.grinch_progression.infoView,
                    xu = (0, Bu.Pi)(() => {
                        const u = gu(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    { className: 'App_backButton_51' },
                                    n().createElement(G, {
                                        caption: bu.backButton(),
                                        goto: bu.toWinterRaid(),
                                        type: 'back',
                                        side: 'left',
                                        onClick: t.close,
                                    }),
                                ...
                                n().createElement(
                                    'div',
                                    { className: 'App_content_58' },
                                    n().createElement(
                                        'div',
                                        { className: 'App_videoContent_a6' },
                                        n().createElement(Fu, { realm: o, language: F, onVideoClicked: t.playVideo }),
                                        n().createElement(
                                            'div',
                                            { className: 'App_description_4d' },
                                            n().createElement(iu, {
                                                text: bu.description(),
                                                className: 'App_descriptionInner_3e',
                                                binding: {
                                                    startDate: q.Z5.getDateFormat(a, q.kH.LONG_FORMAT),
                                                    endDate: q.Z5.getDateFormat(E, q.kH.LONG_FORMAT),
                                                    progressDate: q.Z5.getDateFormat(i, q.kH.LONG_FORMAT),
                                                },
                                            }),
                                        ),
                                        n().createElement(
                                            'div',
                                            { className: 'App_portalButton_76' },
                                            n().createElement(
                                                z,
                                                {
                                                    type: $.primary,
                                                    size: j.medium,
                                                    mixClass: 'App_button_2d',
                                                    onClick: t.showAboutEvent,
                                                },
                                                bu.toPortal(),
                                                n().createElement('div', { className: 'App_linkIcon_ad' }),
                                            ),
                                        ),
                                    ),
                                    n().createElement(
                                        'div',
                                        { className: 'App_descriptionContent_ea' },
                                        wu.map((u, e) =>
                                            n().createElement(pu, {
                                                key: e,
                                                type: u,
                                                classNames: {
                                                    base: m()(
                                                        'App_descriptionBlockInner_6f',
                                                        1 === e && 'App_descriptionBlockInner__stretch_a2',
                                                    ),
                                                },
                                            }),
                                        ),
                ...
                engine.whenReady.then(() => {
                    k().render(
                        n().createElement(hu, null, n().createElement(O, null, n().createElement(xu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(842));
