(() => {
    ...
    var __webpack_modules__ = {
            ...
            2530: (u, e, t) => {
                ...
                const C = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: n, children: r, mocks: a }) {
                                const E = (0, i.useRef)([]),
                                    ...
                                    F = A[0],
                                    d = A[1],
                                    p = (0, i.useState)(() => c(u, n, a)),
                                    m = p[0],
                                    h = p[1];
                                return (
                                    (0, i.useEffect)(() => {
                                        l.current ? h(c(F, n, a)) : (l.current = !0);
                                    }, [a, F, n]),
                                    (0, i.useEffect)(() => {
                                        d(u);
                                    }, [u]),
                                    ...
                                    s().createElement(t.Provider, { value: m }, r)
                                );
                            },
                            () => (0, i.useContext)(t),
                        ];
                    ...
                    m = p[0],
                    h = p[1],
                    v = 'EventBannerTooltipApp_line_7b';
                let b;
                function g(u, e) {
                ...
                const x = (u = 0, e, t = 0, n = T) => {
                    ...
                    O = (u, e, t) => {
                        ...
                        return n >= 1
                            ? 0 === r
                                ? g(R.strings.sm_lobby.countdown.days(), { days: n })
                                : g(R.strings.sm_lobby.countdown.daysHours(), { days: n, hours: r })
                            : e && r < 1 && o < 5
                              ? g(R.strings.sm_lobby.countdown.endsSoon(), { minutes: 5 })
                              : 0 === r
                                ? o < 1
                                ...
                                : 0 === o
                                  ? g(R.strings.sm_lobby.countdown.hours(), { hours: r })
                                  : g(
                                        t
                    ...
                    L = ({ seconds: u }) => {
                        const e = ((u, e = !1, t = !1) => {
                                const n = x(u, 1);
                                return { timeString: O(y(n), e, t), secondsLeft: n, isEndingSoon: n < 300 };
                            })(Math.max(0, u), !1, !0),
                            t = e.timeString;
                        return s().createElement(
                            'div',
                            { className: 'Countdown_base_f3', lang: R.strings.settings.LANGUAGE_CODE() },
                            s().createElement('div', { className: 'Countdown_icon_73' }),
                            s().createElement('div', { className: 'Countdown_text_81' }, t),
                        );
                    },
                    P = [
                        'children',
                        ...
                        const v = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            g = (0, i.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (M(t, d, { isMouseEvent: !0, on: !0, arguments: S(n) }, b),
                                    p && p(),
                ...
                const K = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return s().createElement(z, e, n);
                    const r = e.contentId;
                    return r ? s().createElement(N, q({}, e, { contentId: r }), n) : s().createElement(W, e, n);
                };
                var H = t(8045);
                const Y = {
                ...
                const Q = { [X.NBSP]: Z.NoBreakSymbol, [X.ZWNBSP]: Z.NoBreakSymbol, [X.NEW_LINE]: Z.LineBreak },
                    ...
                    nu = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? uu[n]
                                ? s().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: r()(eu, uu[n]) },
                                      u,
                                  )
                                : s().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: eu, style: tu(n) },
                                      u,
                                  )
                            : s().createElement('span', { key: t, 'data-block-type': e.blockType, className: eu }, u);
                    },
                    ru = {
                        [Z.Word]: nu,
                        [Z.NoBreakSymbol]: nu,
                    ...
                    au = J
                        ...
                        : (u, e) => {
                              ...
                              let o = 0;
                              for (; n;) {
                                  const i = e.justifyContent === $.FlexEnd ? n.index : t.lastIndex;
                    ...
                    Eu = (u, e = '', t) => {
                        ...
                        return (
                            iu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    n.push({ blockType: Z.Word, colorTag: e, childList: au(u, t) });
                                },
                                (u) => {
                                    const t = u[0],
                                        r = Q[t.charAt(0)];
                            ...
                            iu(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof i || 'number' == typeof i
                                        ...
                                        : r.push({ blockType: Z.Binding, colorTag: t, childList: [i] });
                                },
                            ),
                            r
                        );
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const F = l.slice(0, l.length - A) + o,
                                    d = e[E];
                                ((a = s().cloneElement(d, d.props, F)), (i = E));
                                break;
                            }
                            {
                                const u = t.children,
                    ...
                    _u = s().memo(
                        ({
                            ...
                            customTooltipArgs: E,
                            targetId: c,
                            justifyContent: l = $.FlexStart,
                            alignContent: A = $.FlexStart,
                            truncateIdentify: F = '...',
                        }) => {
                            ...
                            return (
                                ...
                                s().createElement(
                                    ...
                                    s().createElement('div', { className: Y.unTruncated, ref: d }, p),
                                    s().createElement(
                                        K,
                                        {
                                            tooltipArgs: m,
                                        ...
                                        s().createElement(
                                            'div',
                                            {
                                                className: r()(
                                                    Y.truncated,
                                                    !_.isTruncateFinished && a && Y.truncated__hide,
                                                ),
                                                style: v,
                                            },
                    ...
                    Cu = R.strings.sm_lobby.tooltips.eventBannerTooltip,
                    pu = (0, d.Pi)(() => {
                        const u = h().model.get().timerValue,
                            e = { timer: s().createElement(L, { seconds: u }) };
                        return s().createElement(
                            'div',
                            { className: 'EventBannerTooltipApp_base_c8', lang: R.strings.settings.LANGUAGE_CODE() },
                            s().createElement(
                                'div',
                                { className: 'EventBannerTooltipApp_banner_31' },
                                s().createElement('div', { className: 'EventBannerTooltipApp_title_cb' }, Cu.title()),
                            ),
                            s().createElement('div', { className: 'EventBannerTooltipApp_text_3e' }, Cu.text()),
                            s().createElement(
                                'div',
                                { className: 'EventBannerTooltipApp_modeWrapper_48' },
                                s().createElement('div', { className: 'EventBannerTooltipApp_mode_d8' }, Cu.mode()),
                                s().createElement(
                                    'div',
                                    { className: 'EventBannerTooltipApp_modeText_9c' },
                                    Cu.modeText(),
                                ),
                            ),
                            ...
                            s().createElement(
                                'div',
                                { className: 'EventBannerTooltipApp_eventTitle_6f' },
                                Cu.eventTitle(),
                            ),
                            s().createElement(
                                'div',
                                { className: 'EventBannerTooltipApp_eventText_57' },
                                Cu.eventText(),
                            ),
                            s().createElement('div', { className: v }),
                            s().createElement(_u, {
                                classMix: 'EventBannerTooltipApp_timerText_38',
                                text: Cu.timerText(),
                                binding: e,
                ...
                engine.whenReady.then(() => {
                    F().render(
                        s().createElement(m, null, s().createElement(l, null, s().createElement(pu, null))),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'lobby/EventBannerTooltip/EventBannerTooltip'),
        (() => {
            var u = { 'lobby/EventBannerTooltip/EventBannerTooltip': 0 };
