            ...
            2530: (u, e, t) => {
                ...
                const x = (u = 0, e, t = 0, n = T) => {
                    ...
                    O = (u, e, t) => {
                        ...
                        return n >= 1
                            ? 0 === r
                                ? b(R.strings.sm_lobby.countdown.days(), { days: n })
                                : b(R.strings.sm_lobby.countdown.daysHours(), { days: n, hours: r })
                            : e && r < 1 && o < 5
                              ? b(R.strings.sm_lobby.countdown.endsSoon(), { minutes: 5 })
                              : 0 === r
                                ? o < 1
                                ...
                                : 0 === o
                                  ? b(R.strings.sm_lobby.countdown.hours(), { hours: r })
                                  : b(
                                        t
                        ...
                        const v = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, i.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (M(t, d, { isMouseEvent: !0, on: !0, arguments: S(n) }, g),
                                    p && p(),
                    ...
                    Eu = (u, e = '', t) => {
                        ...
                        return (
                            iu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    n.push({ blockType: $.Word, colorTag: e, childList: au(u, t) });
                                },
                                (u) => {
                                    const t = u[0],
                                        r = Q[t.charAt(0)];
