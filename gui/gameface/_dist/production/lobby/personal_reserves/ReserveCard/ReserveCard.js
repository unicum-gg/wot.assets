(() => {
    ...
    var __webpack_modules__ = {
            ...
            9294: (u, e, n) => {
                ...
                var t = {};
                (n.r(t),
                    n.d(t, { mouse: () => D, off: () => _, on: () => s, onResize: () => A, onScaleUpdated: () => a }));
                var r = {};
                (n.r(r),
                    n.d(r, {
                        events: () => t,
                ...
                const v = {
                    ...
                    w = Object.keys(m).reduce((u, e) => ((u[e] = () => B(m[e])), u), {}),
                    p = { play: Object.assign({}, w, { sound: B }), setRTPC: C },
                ...
                const su = { view: i, client: r, sound: p, intl: g };
            },
            2344: (u, e, n) => {
                n.d(e, { au: () => r });
                var t = n(3469);
                                ...
                                if (u > 0) {
                                    ...
                                    const r = Date.now(),
                                        ...
                                        F = setInterval(() => {
                                            ...
                                            null !== n && e <= n ? (A(n), i && i(), clearInterval(F)) : A(e);
                                        }, o * t.s_);
                                    return () => {
                                        clearInterval(F);
                                    };
            ...
            9916: (u, e, n) => {
                n.d(e, { Sw: () => o.Z, B3: () => E, Z5: () => i.Z5, ry: () => l });
                class t {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
                ...
                function B(u, e, n, t, r, o, i) {
                    ...
                    F.done ? e(E) : Promise.resolve(E).then(t, r);
                }
                    ...
                    ({
                        ...
                        i().createElement(
                            ...
                            i().createElement(
                                ...
                                a && o > 0 && '+',
                                i().createElement(E, { value: o, format: t === s.gold ? 'gold' : 'integral' }),
                            ),
