(() => {
    ...
    var __webpack_modules__ = {
            280: (u, e, A) => {
                ...
                var E = A(179),
                    ...
                    D = A(649),
                    r = A(287);
                const a = ({ binding: u, text: e = '', classMix: A, alignment: t = D.v2.left }) =>
                    null === e
                        ...
                        : F().createElement(
                              ...
                              e.split('\n').map((e, a) =>
                                  F().createElement(
                                      'div',
                                      { className: n()(r.Z.base, A), key: `${e}-${a}` },
                                      (0, D.Uw)(e, t, u).map((u, e) =>
                ...
                const a = (u, e = !0) =>
                    u.days > 7 && e
                        ...
                        : u.days >= 1
                          ? 0 === u.hours
                              ? (0, E.WU)(R.strings.common.duration.days(), { days: u.days })
                              : `${(0, E.WU)(R.strings.common.duration.days(), { days: u.days })} ${(0, E.WU)(R.strings.common.duration.hours(), { hours: u.hours })}`
                          : u.hours >= 1
                            ? 0 === u.minutes
            ...
            67: (u, e, A) => {
                ...
                var t = {};
                A.r(t), A.d(t, { getBgUrl: () => c, getTextureUrl: () => _ });
                var n = {};
                function D(u) {
                    return (e) => (
                        engine.on(u, e),
                            ...
                            (0, F.useEffect)(() => {
                                if (u > 0) {
                                    ...
                                    const F = Date.now(),
                                        t = e || (u > 2 * E.yR ? E.yR : 1),
                                        D = setInterval(() => {
                                            const e = u - Math.floor((Date.now() - F) / E.s_);
                                            null !== A && e <= A ? (a(A), n && n(), clearInterval(D)) : a(e);
                                        }, t * E.s_);
                                    return () => {
                                        clearInterval(D);
                                    };
            ...
            649: (u, e, A) => {
                ...
                const t = (u, e, A) => {
                    ...
                    D = (u, e, A = E.left) => u.split(e).reduce(A === E.left ? t : n, []),
                    r = (() => {
                        const u = new RegExp(
                        ...
                        return a.includes(A)
                            ...
                            : ((u, e = E.left) => {
                                  ...
                                  const F =
                                      ...
                                      t = u.replace(/&nbsp;/g, ' ');
                                  return D(t, /( )/, e).forEach((u) => (A = A.concat(D(u, F, E.left)))), A;
                              })(u, e);
                    },
                    i = (u, e, A) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : o(u, e)));
            },
            728: (u, e, A) => {
                let E;
                !(function (u) {
            ...
            627: (u, e, A) => {
                ...
                const i = ({
                    ...
                    const m = (0, n.useRef)(null),
                        ...
                        T = f[1],
                        x = (0, n.useCallback)(() => {
                            o || (m.current && (m.current.focus(), h(!0)));
                        }, [o]),
                        k = (0, n.useCallback)(
                            (u) => {
                                b && null !== m.current && !m.current.contains(u.target) && h(!1);
                            },
                            [b],
                        ),
                        P = (0, n.useCallback)(
                        ...
                        N = (0, n.useCallback)(
                            (u) => {
                                o || (null !== s && (0, t.G)(s), c && c(u), A && x(), y(!0));
                            },
                            [o, s, c, x, A],
                        ),
                        U = (0, n.useCallback)(
                        ...
                        I = F()(
                            ...
                            r[`base__${E}`],
                            {
                                ...
                                [r[`base__${e}`]]: e,
                                [r.base__focus]: b,
                                [r.base__highlightActive]: w,
                                [r.base__firstHover]: O,
                            },
                            i,
                        ),
                        H = F()(r.state, r.state__default);
                    return (
                        (0, n.useEffect)(
                            () => (
                        ...
                        D().createElement(
                            ...
                            E !== a.ghost &&
                                D().createElement(
                                    D().Fragment,
                                    null,
                                    D().createElement('div', { className: r.back }),
                                    D().createElement('span', { className: r.texture }),
                                ),
                            D().createElement(
                                'span',
                                { className: H },
                                D().createElement('span', { className: r.stateDisabled }),
                                D().createElement('span', { className: r.stateHighlightHover }),
                                D().createElement('span', { className: r.stateHighlightActive }),
                            ),
                            D().createElement(
                                'span',
                ...
                i.defaultProps = { type: a.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                (0, n.memo)(i);
                let B, s;
                !(function (u) {
                ...
                var g = A(280);
                const b = (u) => u.toString().padStart(2, '0'),
                ...
                (0, n.memo)(
                    ({
                        duration: u,
                        icon: e = B.Timer,
                        style: A = s.Description,
                        onTimeReached: E,
                        className: t = '',
                        classNames: r = {},
                        labelFormat: a = '',
                    }) => {
                        const o = A !== s.Description ? 1 : void 0,
                            i = (0, _.au)(u, o),
                            h = (() => {
                        ...
                        const w = ((u, e) => {
                            switch (e) {
                                ...
                                case s.Extended:
                                    return `${(0, l.WU)(R.strings.common.duration.days(), { days: u.days })} | ${b(u.hours)}:${b(u.minutes)}:${b(u.seconds)}`;
                            }
                        })((0, C.f8)(i), A);
                ...
                A(161);
                w.z.Personal, y.Personal, w.z.Event, y.Event, w.z.Clan, y.Clan;
                let f, O, T;
                !(function (u) {
                ...
                const k = ({ format: u, value: e }) => {
                        const A = ((u, e = 'integral') => {
                            let A;
                            A = 'gold' === e ? x.B3.GOLD : x.B3.INTEGRAL;
                            return void 0 === u ? '' : x.Z5.getNumberFormat(u, A);
                        })(e, u);
                        return A ? D().createElement('span', null, A) : null;
                    },
                    P = {
                    ...
                    M = ({
                        ...
                        discountValue: r,
                        showPlus: a,
                        stockBackgroundName: o = T.Red,
                    }) => {
                        const i = F()(P.value, P[`value__${E}`], !t && P.value__notEnough),
                            B = F()(P.icon, P[`icon__${E}-${A}`]),
                            s = F()(P.stock, r && P.stock__indent, e && P.stock__interactive),
                            C = a && n > 0 && '+',
                            _ = F()(P.base, P[`base__${A}`]);
                        return D().createElement(
                            'span',
                            { className: _ },
                            D().createElement(
                                ...
                                { className: i },
                                C,
                                D().createElement(k, { value: n, format: E === O.gold ? 'gold' : 'integral' }),
                            ),
                            D().createElement('span', { className: B }),
                            u &&
                                D().createElement(
                                    'span',
                                    { className: s },
                ...
                D().memo(M);
                R.strings.personal_reserves.activation.bonus(),
                    R.strings.personal_reserves.activation.activateBonus(),
                    R.strings.personal_reserves.activation.activateButton(),
                    R.strings.personal_reserves.activation.activateButtonClan(),
                    R.strings.personal_reserves.activation.clanMemberViewBonus(),
                    R.strings.personal_reserves.activation.clanLeaderActivateBonus();
            },
            260: (u, e, A) => {
                A(483), A(932), A(226), A(179), A(627), A(886);
                let E;
                !(function (u) {
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [242], () => __webpack_require__(886));
