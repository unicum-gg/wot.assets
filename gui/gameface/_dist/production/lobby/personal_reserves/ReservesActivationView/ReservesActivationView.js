(() => {
    var __webpack_modules__ = {
            ...
            44: (u, e, t) => {
                'use strict';
                t.d(e, { f8: () => o, s2: () => s, s_: () => n, wB: () => l, yR: () => a });
                var r = t(649);
                (t(728), t(364));
                const n = 1e3,
                    a = 60,
                                ...
                                if (u > 0) {
                                    ...
                                    const n = Date.now(),
                                        ...
                                        s = setInterval(() => {
                                            ...
                                            null !== t && e <= t ? (l(t), i && i(), clearInterval(s)) : l(e);
                                        }, a * r.s_);
                                    return () => {
                                        clearInterval(s);
                                    };
                        ...
                        (0, a.Z)(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    r = (0, s.U0)(u);
                                C.current = l.addCallback(r, t, d, e === c.Deep);
                            }
                        }),
                        (0, o.useEffect)(() => {
                            if (e !== c.None)
                ...
                const a = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    l = (u) => {
                        ...
                        if (i.length > 0) {
                            ...
                            return (
                                i.reduce((e, r) => {
                                    const i = (0, n.M)(s(t, `${e}.${r}`), window);
                                    return a(i) ? (u.push(i.id), `${e}.${r}.value`) : (u.push(r), `${e}.${r}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
            ...
            886: (u, e, t) => {
                ...
                const l = (u, e, t = {}, r = 0) => {
                    ...
                    c = (u) => {
                        ...
                        const w = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            y = (0, r.useMemo)(() => h || (0, a.F)().resId, [h]),
                            x = (0, r.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (l(t, C, { isMouseEvent: !0, on: !0, arguments: o(n) }, y),
                                    p && p(),
                            ...
                            _(
                                {
                                    contentId:
                                        ...
                                        A ? D.SimpleTooltipHtmlContent('resId') : D.SimpleTooltipContent('resId')),
                ...
                const v = ({
                    ...
                    if (u === g.E.LOBBY) {
                        if (!t.isPremium && t.state !== C.m.Active && i)
                            return n().createElement(
                                m,
                                { body: R.strings.personal_reserves.disabledReserveTooltip.text() },
                                e,
                            );
                        if (0 === t.inDepot && !t.isPremium && t.reserveType !== C.z.Clan)
                            return n().createElement(
                                c,
                                { contentId: R.views.common.personal_reserves.ReservesDisabledTooltip('resId') },
                                e,
                            );
                        const u = t.reserveType === C.z.Clan,
                            a = t.boosterID > 0 ? t.boosterID : B.py[r];
                        return n().createElement(d, { args: { specialAlias: u ? B.w0 : B.yD, boosterId: a } }, e);
                    }
                    if (u === g.E.BATTLE) {
                        if (t.state !== C.m.Active && i)
                            return n().createElement(
                                m,
                                { body: R.strings.personal_reserves.disabledReserveTooltip.text() },
                                e,
                            );
                        if (t.state === C.m.Active && a <= 0)
                            return n().createElement(
                                m,
            ...
            627: (u, e, t) => {
                ...
                const E = ({
                    ...
                    const g = (0, i.useRef)(null),
                        ...
                        T = y[1],
                        L = (0, i.useCallback)(() => {
                            c || (g.current && (g.current.focus(), p(!0)));
                        }, [c]),
                        S = (0, i.useCallback)(
                            (u) => {
                                h && null !== g.current && !g.current.contains(u.target) && p(!1);
                            },
                            [h],
                        ),
                        M = (0, i.useCallback)(
                        ...
                        O = (0, i.useCallback)(
                            (u) => {
                                c || (null !== d && (0, a.G)(d), D && D(u), t && L(), w(!0));
                            },
                            [c, d, D, L, t],
                        ),
                        H = (0, i.useCallback)(
                        ...
                        I = n()(
                            ...
                            o[`base__${r}`],
                            {
                                ...
                                [o.base__firstHover]: x,
                            },
                            E,
                        ),
                        W = n()(o.state, o.state__default);
                    return (
                        (0, i.useEffect)(
                            () => (
                        ...
                        s().createElement(
                            ...
                            r !== l.ghost &&
                                s().createElement(
                                    s().Fragment,
                                    null,
                                    s().createElement('div', { className: o.back }),
                                    s().createElement('span', { className: o.texture }),
                                ),
                            s().createElement(
                                'span',
                                { className: W },
                                s().createElement('span', { className: o.stateDisabled }),
                                s().createElement('span', { className: o.stateHighlightHover }),
                                s().createElement('span', { className: o.stateHighlightActive }),
                            ),
                            s().createElement(
                                'span',
                ...
                E.defaultProps = { type: l.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const A = (0, i.memo)(E);
                let d, F;
                (!(function (u) {
                ...
                var L = t(161);
                (y.z.Personal, T.Personal, y.z.Event, T.Event, y.z.Clan, T.Clan);
                let S, M, k;
                (!(function (u) {
                ...
                const O = {
                    ...
                    H = ({
                        ...
                        const E = n()(O.value, O[`value__${r}`], !a && O.value__notEnough),
                            A = n()(O.icon, O[`icon__${r}-${t}`]),
                            d = n()(O.stock, o && O.stock__indent, e && O.stock__interactive),
                            F = l && i > 0 && '+',
                            _ = n()(O.base, O[`base__${t}`]);
                        return s().createElement(
                            'span',
                            { className: _ },
                            s().createElement(
                                ...
                                { className: E },
                                F,
                                s().createElement(N, { value: i, format: r === M.gold ? 'gold' : 'integral' }),
                            ),
                ...
                const I = s().memo(H),
                    W = 'Quantity_base_e7',
                    U = 'Quantity_base__premium_7e',
                    z = 'Quantity_icon_e5',
                    G = ({ isPurchasable: u, goldPrice: e = 0, playerGold: t, inDepot: r, isPremium: a }) =>
                        u && e
                            ? s().createElement(I, { size: 'small', type: 'gold', value: e, isEnough: t >= e })
                            : s().createElement(
                                  'div',
                                  { className: n()(W, { [U]: a }) },
                ...
                const q = {
                    ...
                    X = (u) => Math.max(u, 0).toString().padStart(2, '0'),
                    Y = (u) => {
                        let e = u.reserve,
                            t = u.playerGold,
                            r = u.groupDescription,
                            o = u.activeSecondsLeft,
                            l = u.isDisabled,
                            c = u.isPurchasable,
                            E = u.isClanLeader,
                            d = u.isDoubleSize,
                        ...
                        const K = h === y.z.Clan,
                            Z = n()($.base, {
                                ...
                                [$.base__disabled]: !I && l,
                                [$.base__inactive]: !I && !l,
                                [$.base__activatedAnimation]: Y,
                                [$.base__zeroTime]: I && O <= 0,
                            }),
                            Q = (0, i.useCallback)(() => {
                        ...
                        const tu = (function (u, e, t) {
                                const r = u > -1 ? u : L.Q9[t];
                                let n = `${r}`;
                                return (u >= 0 && u < e && (n = `${u}% - ${e}`), [r > 0, n]);
                            })(k, P, S),
                            ru = tu[0],
                            nu = tu[1],
                            au = new x.Zg(R).getValue(0);
                        return s().createElement(
                            'div',
                            { className: Z, style: { '--fillPercentage': `${H}%` }, onMouseEnter: Q },
                            I &&
                                s().createElement(
                                    s().Fragment,
                                    null,
                                    s().createElement(
                                        'div',
                                        { className: $.cardFill },
                                        s().createElement('div', { className: $.cardFill_patternGradient }),
                                        s().createElement('div', { className: $.cardFill_pattern }),
                                        s().createElement('div', { className: $.cardFill_innerBorder }),
                                        s().createElement('div', { className: $.cardFill_border }),
                                        s().createElement('div', { className: $.cardFill_borderGradient }),
                                        s().createElement('div', { className: $.cardFill_borderTop }),
                                    ),
                                    s().createElement(
                                        'div',
                                        { className: $.activeLight },
                                        s().createElement('div', { className: $.activeLight_border }),
                                    ),
                                    s().createElement('div', { className: $.checkmark }),
                                ),
                            l && s().createElement('div', { className: $.disabledPattern }),
                            T && s().createElement('div', { className: $.premiumLight }),
                            U &&
                                s().createElement(
                                    s().Fragment,
                                    null,
                                    s().createElement('div', { className: $.limitedOfferLight }),
                                    s().createElement(
                                        'div',
                                        { className: $.limitedOfferTimer },
                                        s().createElement(w, { duration: W, style: z }),
                                    ),
                                ),
                            s().createElement(
                                'div',
                            ...
                            s().createElement(
                                ...
                                !K &&
                                    s().createElement(
                                        'div',
                                        { className: $.cardContent_quantity },
                                        s().createElement(G, {
                                            isPurchasable: c,
                                            goldPrice: au,
                                            playerGold: t,
                                ...
                                s().createElement(
                                    'div',
                                    { className: $.timer },
                                    s().createElement('div', { className: $.timerIcon }),
                                    eu,
                                ),
                                s().createElement('div', {
                                    style: {
                                        backgroundImage: `url(R.images.gui.maps.icons.quests.bonuses.s180x135.${S})`,
                                    },
            ...
            260: (u, e, t) => {
                ...
                var r = t(483),
                    ...
                    l = t(627),
                    c = t(886);
                const E = 'ReserveGroup_base_86',
                    A = 'ReserveGroup_base_activated_c7',
                    d = 'ReserveGroup_header_58',
                    F = 'ReserveGroup_header_title_e4',
                    _ = 'ReserveGroup_header_description_03';
                let D;
                !(function (u) {
                ...
                const m = ({
                    ...
                    gold: C,
                    onActivate: B,
                    canActivateClanReserves: g,
                }) => {
                    const v = (0, s.useReducer)((u) => !u, !1)[1],
                        h = (0, s.useCallback)(
                            (u) => {
                                B(u);
                            },
                        ...
                        p = m[0].inactivationTime > 0 || (m[1] && m[1].inactivationTime > 0),
                        f = n()(E, p && A),
                        b = 1 === m.length;
                    return o().createElement(
                        ...
                        o().createElement(
                            ...
                            o().createElement('div', { className: _ }, t),
                        ),
                        m.map((e, n) => {
                            const s = Math.max(-1, Math.floor((1e3 * e.inactivationTime - Date.now()) / 1e3)),
                                E = C || 0;
                            let A = !1;
                            r === i.d.Clan
                                ? (A = s <= 0 && p)
                                : u === D.BATTLE
                                  ...
                                  : e.isPremium ||
                                    e.state === a.m.Active ||
                                    (A = 0 === e.inDepot || (p && e.inactivationTime <= 0));
                            const d = u !== D.BATTLE && e.isPremium && e.state !== a.m.Active && 0 === e.inDepot;
                            return o().createElement(
                                c.Z,
                                {
                                    key: n,
                                    ...
                                    category: r,
                                    activeSecondsLeft: s,
                                    hasActiveGroupItems: m.length > 1 && p,
                                },
                                o().createElement(l.Z, {
                                    reserve: e,
                                    groupDescription: t,
            ...
            476: (u, e, t) => {
                ...
                var n = {};
                (t.r(n), t.d(n, { Area: () => Ru, Bar: () => Lu, Default: () => Mu, useVerticalScrollApi: () => Du }));
                var a = t(179),
                    i = t.n(a);
                const s = (u, e, t) =>
                ...
                const C = (u) => {
                    ...
                    const r = (0, a.useContext)(D),
                        ...
                        p = { extraLarge: C, large: B, medium: g, small: v, extraSmall: h };
                ...
                const S = {
                    ...
                    P = (u) => {
                        ...
                        const n = x(),
                            ...
                            s = n.mediaHeight,
                            o = n.mediaSize;
                        return i().createElement('div', L({ className: h()(t, S[a], M[s], k[o]) }, r), e);
                    },
                    N = ['children'];
                const O = (u) => {
                    let e = u.children,
                ...
                function G(u) {
                    ...
                    return (
                        ...
                        (0, a.useCallback)((...u) => (0, e.current)(...u), z)
                    );
                }
                function $(u, e, t = []) {
                ...
                const Z = {
                        ...
                        return (l = {}) => {
                            const c = l.settings,
                                ...
                                D = (0, Y.useSpring)(() => ({
                                    ...
                                    onChange: (u) => {
                                        const e = A.current;
                                        e && (t(e, u), F.trigger('change', u), i && _());
                                    },
                                    ...
                                    (u, { immediate: e = !1, reset: t = !0 } = {}) => {
                                        ...
                                        r &&
                                            C.start({
                                                ...
                                                from: { scrollPosition: s(r, m.scrollPosition.get()) },
                                            });
                                    },
                                ...
                                h = (0, a.useCallback)(
                                    (u) => {
                                        (0 !== u.deltaY && v(r(u)),
                                            A.current && F.trigger('mouseWheel', u, m.scrollPosition, e(A.current)));
                                    },
                            ...
                            return (0, a.useMemo)(
                                ...
                                [m.scrollPosition, g, v, b, F.off, F.on, f, h, C, E.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    J = Q({
                        ...
                        getDirection: (u) => (u.deltaY > 1 ? K.Next : K.Prev),
                    ...
                    Au = (0, a.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = lu, onDrag: r = cu }) => {
                                ...
                                ((t.style.transform = `translateX(${0 | A}px)`),
                                    ((u) => {
                                        if (s.current && o.current && l.current && c.current) {
                                            ...
                                            var e, t;
                                            (s.current.classList.remove(su), o.current.classList.remove(su));
                                        }
                                    })(A));
                            },
                            m = G(() => {
                        ...
                        ((0, a.useEffect)(() => W(m)),
                            ...
                            (0, a.useEffect)(() => {
                                ...
                                const e = (e) => {
                                        ...
                                        const a = l.current,
                                            i = c.current;
                                        if (!n || !a || !i) return;
                                        const s = e.screenX - d.offset - a.getBoundingClientRect().x,
                                            o = (s / a.offsetWidth) * (null != (t = u.getContainerSize()) ? t : 0);
                                        (u.scrollPosition.start({
                                            scrollPosition: u.clampPosition(n, o),
                                            reset: !0,
                                            immediate: !0,
                                    ...
                                    t = () => {
                                        (window.removeEventListener('mousemove', e), _(ou));
                                    };
                                return (
                            ...
                            }, [u, d.offset, d.pending, r, _]));
                        const C = $((e) => u.applyStepTo(e), E, [u]),
                            B = C[0],
                            g = C[1];
                        (0, a.useEffect)(
                            () => (
                        ...
                        const v = (u) => {
                            u.target.classList.contains(su) || (0, V.G)('highlight');
                        };
                        return i().createElement(
                            'div',
                            { className: h()(uu, e.base), ref: n, onWheel: u.handleMouseWheel },
                            i().createElement('div', {
                                className: h()(tu, e.leftButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(su) || 0 !== u.button || ((0, V.G)('play'), B(K.Next));
                                },
                                onMouseUp: g,
                                ref: s,
                                onMouseEnter: v,
                            ...
                            i().createElement(
                                'div',
                                {
                                    ...
                                    onMouseDown: (e) => {
                                        const r = c.current;
                                        if (r && 0 === e.button)
                                            if (((0, V.G)('play'), e.target === r))
                                                _({ pending: !0, offset: e.screenX - r.getBoundingClientRect().x });
                                            else {
                                                ((e) => {
                                                    const r = c.current,
                                                ...
                                                })(e.screenX > r.getBoundingClientRect().x ? K.Prev : K.Next);
                                            }
                                    },
                                    ref: l,
                                    onMouseEnter: v,
                                },
                                i().createElement('div', { ref: c, className: h()(au, e.thumb) }),
                                i().createElement('div', { className: h()(iu, e.rail) }),
                            ),
                            i().createElement('div', {
                                className: h()(ru, e.rightButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(su) || 0 !== u.button || ((0, V.G)('play'), B(K.Prev));
                                },
                                onMouseUp: g,
                                ref: o,
                                onMouseEnter: v,
                    ...
                    Fu = ({
                        ...
                        const E = (0, a.useMemo)(() => {
                                const u = r || {};
                                return Object.assign({}, u, { base: h()(du.base, u.base) });
                            }, [r]),
                            A = (0, a.useMemo)(() => Object.assign({}, e, { handleMouseWheel: () => {} }), [e]);
                        return i().createElement(
                            'div',
                            { className: h()(du.defaultScroll, t), onWheel: e.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: h()(du.defaultScrollArea, n) },
                                i().createElement(_u, { className: o, api: A, classNames: s }, u),
                            ),
                    ...
                    _u = ({ api: u, className: e, classNames: t, children: r, style: n }) => (
                        ...
                        i().createElement(
                            ...
                            i().createElement(
                                'div',
                                {
                                    className: h()(du.wrapper, null == t ? void 0 : t.wrapper),
                                    onWheel: u.handleMouseWheel,
                                    ref: u.wrapperRef,
                                },
                                i().createElement(
                                    'div',
                                    { className: h()(du.content, null == t ? void 0 : t.content), ref: u.contentRef },
                                    r,
                                ),
                            ),
                        )
                ...
                ((_u.Bar = Au),
                    (_u.Default = Fu),
                    (_u.SeniorityAwards = ({ api: u, className: e, classNames: t, children: r }) => (
                        (0, a.useEffect)(() => W(u.recalculateContent)),
                        i().createElement(
                            'div',
                            ...
                            i().createElement(
                                'div',
                                { className: h()(du.wrapper, null == t ? void 0 : t.wrapper), ref: u.wrapperRef },
                                i().createElement(
                                    'div',
                                    { className: h()(du.content, null == t ? void 0 : t.content), ref: u.contentRef },
                                    r,
                ...
                const Du = Q({
                    ...
                    Lu = (0, a.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = yu, onDrag: r = bu }) => {
                        const n = (0, a.useRef)(null),
                            s = (0, a.useRef)(null),
                            o = (0, a.useRef)(null),
                            l = (0, a.useRef)(null),
                            ...
                            D = G(() => {
                                ...
                                return (
                                    ...
                                    e.classList.add(hu),
                                    n.current &&
                                        (1 === i ? n.current.classList.add(Cu) : n.current.classList.remove(Cu)),
                                    i
                                );
                            }),
                            m = G(() => {
                                        ...
                                        if (s.current && o.current && l.current && c.current) {
                                            if (0 === u)
                                                return (
                                                    ...
                                                    void o.current.classList.remove(fu)
                                                );
                                            if (
                                                ((e = l.current),
                                                (t = c.current),
                                                ...
                                                return (
                                                    ...
                                                    void o.current.classList.add(fu)
                                                );
                                            var e, t;
                                            (s.current.classList.remove(fu), o.current.classList.remove(fu));
                                        }
                                    })(A));
                            }),
                            C = G(() => {
                        ...
                        const p = (u) => {
                            u.target.classList.contains(fu) || (0, V.G)('highlight');
                        };
                        return i().createElement(
                            'div',
                            { className: h()(mu, e.base), ref: n, onWheel: u.handleMouseWheel },
                            i().createElement('div', {
                                className: h()(Bu, e.topButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(fu) || 0 !== u.button || ((0, V.G)('play'), g(K.Next));
                                },
                                ref: s,
                                onMouseEnter: p,
                            }),
                            i().createElement(
                                    ...
                                    onMouseDown: (e) => {
                                        ...
                                        if (r && 0 === e.button)
                                            if (((0, V.G)('play'), e.target === r))
                                                ...
                                                })(e.screenY > r.getBoundingClientRect().y ? K.Prev : K.Next);
                                            }
                                    },
                                    ref: l,
                                    onMouseEnter: p,
                                ...
                                i().createElement('div', { className: h()(pu, e.rail) }),
                            ),
                            i().createElement('div', {
                                className: h()(gu, e.bottomButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(fu) || 0 !== u.button || ((0, V.G)('play'), g(K.Prev));
                                },
                                onMouseUp: v,
                                ref: o,
                                onMouseEnter: p,
                    ...
                    Mu = ({
                        ...
                        const E = (0, a.useMemo)(() => {
                                const u = r || {};
                                return Object.assign({}, u, { base: h()(Su.base, u.base) });
                            }, [r]),
                            A = (0, a.useMemo)(() => Object.assign({}, e, { handleMouseWheel: () => {} }), [e]);
                        return i().createElement(
                            'div',
                            { className: h()(Su.defaultScroll, t), onWheel: e.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: h()(Su.area, n) },
                                i().createElement(Ru, { className: s, classNames: o, api: A }, u),
                            ),
                            i().createElement(Lu, { getStepByRailClick: l, api: e, onDrag: c, classNames: E }),
                        );
                    },
                    Ru = ({ className: u, classNames: e, children: t, api: r }) => (
                        (0, a.useEffect)(() => W(r.recalculateContent)),
                        i().createElement(
                            'div',
                            { className: h()(Su.base, u), ref: r.wrapperRef, onWheel: r.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: h()(Su.content, null == e ? void 0 : e.content), ref: r.contentRef },
                                t,
                            ),
                        )
                    );
                ...
                class Hu extends i().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            d = h()(Pu.base, Pu[`base__${a}`], Pu[`base__${n}`], null == s ? void 0 : s.base),
                            F = h()(Pu.icon, Pu[`icon__${a}`], Pu[`icon__${n}`], null == s ? void 0 : s.icon),
                            _ = h()(Pu.glow, null == s ? void 0 : s.glow),
                            D = h()(Pu.caption, Pu[`caption__${a}`], null == s ? void 0 : s.caption),
                            m = h()(Pu.goto, null == s ? void 0 : s.goto);
                        return i().createElement(
                            'div',
                            Ou(
                                {
                ...
                function Gu(u = Uu.n.NONE, e = zu, t = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== Uu.n.NONE)
                            return (
                ...
                const Vu = {
                    ...
                    qu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Xu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Yu = (0, a.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                ((o = o.replace(t, `%(${s})`)),
                                    (n[s] = Vu[u]
                                        ? i().createElement(
                                              'span',
                                              { className: Vu[u] },
                                              i().createElement($u.z, { text: E, binding: e }),
                                          )
                                        : i().createElement(
                                              'span',
                                              { style: r(u) },
                        ...
                        return i().createElement($u.z, { text: o, classMix: t, binding: n });
                    });
                var Ku = t(360);
                const Zu = 'display',
                    Qu = 'visible_change',
                    Ju = Qu,
                    ue = {
                        [Iu.d.XP]: R.strings.personal_reserves.activation.battleXPTitle(),
                        [Iu.d.Credits]: R.strings.personal_reserves.activation.creditsTitle(),
                        [Iu.d.Combined_XP]: R.strings.personal_reserves.activation.comboXPTitle(),
                        [Iu.d.Event]: R.strings.personal_reserves.activation.frontLineXPTitle(),
                        [Iu.d.Clan]: R.strings.personal_reserves.activation.clanBoostersTitle(),
                    },
                    ee = {
                        [Iu.d.XP]: R.strings.personal_reserves.activation.battleXPDescription(),
                        [Iu.d.Credits]: R.strings.personal_reserves.activation.creditsDescription(),
                        [Iu.d.Combined_XP]: R.strings.personal_reserves.activation.comboXPDescription(),
                        [Iu.d.Event]: R.strings.personal_reserves.activation.frontLineXPDescription(),
                        [Iu.d.Clan]: R.strings.personal_reserves.activation.clanBoostersDescriptionCrewAndFree(),
                    },
                    te = [
                ...
                var re = t(260);
                const ne = 'App_base_d1',
                    ae = 'App_infoButton_59',
                    ie = 'App_closeButton_fa',
                    se = 'App_title_23',
                    oe = 'App_title_icon_72',
                    le = 'App_subTitle_1f',
                    ce = 'App_subTitle_store_21',
                    Ee = 'App_pageContent_b8',
                    Ae = 'App_groupWrapper_e9',
                    de = 'App_groupWrapper_clan_bc',
                    Fe = 'App_scrollWrapper_5c',
                    _e = () => {
                        const u = (0, Wu.tT)(),
                            e = u.gold,
                            t = u.onClose,
                            r = u.onInformationClicked,
                            n = u.onBoosterActivate,
                            s = u.onNavigateToStore,
                            o = u.canActivateClanReserves,
                            l = (0, Wu.tT)('model.reserveGroups', Wu.DA.Shallow),
                            c = (0, a.useCallback)(() => {
                                r();
                            }, [r]),
                            E = (0, a.useCallback)(() => {
                            ...
                            F = ((u, e) => {
                                const t = (0, Ku.t)('tutorialModel.effects.items').filter((t) => {
                                    if (!t) return !1;
                                    const r = t.value,
                                        n = window.__featureId.toString();
                                    return r.componentId === u && r.type === e && r.viewId === n;
                                });
                                if (0 === t.length) return null;
                                const r = Object.assign({}, t[0].value);
                                return {
                                    effect: r,
                                    completeEffect: () => {
                                        (tutorialModel.onEffectCompleted({
                                            ...
                                            effectType: e,
                                            effectBuilder: r.builder,
                                        }),
                                            e === Zu && window.tutorialApi && window.tutorialApi.updateComponents());
                                    },
                                };
                            })('PersonalReservesGroup', Zu);
                        (0, a.useEffect)(
                            () =>
                                W(() => {
                        ...
                        const _ = ((u, e) => {
                            const t = (0, Ku.t)('tutorialModel.triggers.items').filter((t) => {
                                if (!t) return !1;
                                const r = t.value,
                                    n = r.triggers.filter((u) => u.value === e);
                                return r.componentId === u && n.length > 0;
                            });
                            return 0 === t.length
                                ? null
                                : window.tutorialModel.foundComponents.items.some((e) => e.value.componentId === u)
                                  ? {
                                        trigger: t[0].value,
                                        runTrigger: (t) => {
                                ...
                                i().createElement(
                                    ...
                                    i().createElement(
                                        ...
                                        i().createElement(
                                            ...
                                            l.map((u) => {
                                                const t = u.value,
                                                    r = u.value.reserves.map((u) => u.value),
                                                    n = t.category,
                                                    a = [];
                                                return (
                                                    r.forEach((u, e) => {
                                                        e % 2 == 0 ? a.push([u]) : a[a.length - 1].push(u);
                                                    }),
                                                    a.map((u, t) => {
                                                        const r = n === Iu.d.Clan,
                                                            a = r ? te[t] : ee[n];
                                                        return i().createElement(
                                                            'div',
                                                            {
                                                                id: `block-${n}`,
                                                                key: `${n}-${t}`,
                                                                className: h()(Ae, r && 0 === t && de),
                                                            },
                                                            i().createElement(re.Z, {
                                                                behaviour: re.E.LOBBY,
                                                                title: ue[n],
                                                                description: a,
                                                                category: n,
                                                                items: u,
                ...
                engine.whenReady.then(() => {
                    I().render(
                        i().createElement(O, null, i().createElement(_e, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [242], () => __webpack_require__(476));
