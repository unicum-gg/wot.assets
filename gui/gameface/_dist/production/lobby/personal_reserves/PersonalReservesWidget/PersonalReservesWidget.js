(() => {
    var __webpack_modules__ = {
            ...
            7085: (u, e, t) => {
                ...
                var A = {};
                (t.r(A), t.d(A, { getBgUrl: () => S, getTextureUrl: () => L }));
                var n = {};
                function a(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const h = {
                    ...
                    f = { play: Object.assign({}, w, { sound: c }), setRTPC: d },
                ...
                const Fu = Object.keys(y).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === y[e]), u), {}),
                    iu = {
                        set: (u, e) => {
                ...
                const lu = { view: n, client: r, sound: f, intl: g };
            },
            4020: (u, e, t) => {
                'use strict';
                t.d(e, { n: () => E });
            ...
            828: (u, e, t) => {
                ...
                function C(u, e, t, E, r, A, n) {
                    ...
                    a.done ? e(F) : Promise.resolve(F).then(E, r);
                }
                ...
                const v = r.instance,
                    w = {
                        ...
                        sendShowPopOverEvent: (u, e, t, E, r = R.invalid('resId'), A) => {
                            const n = l.O.view.getViewGlobalPosition(),
                                ...
                                o = F.height,
                                B = {
                                    x: l.O.view.pxToRem(i) + n.x,
                                    y: l.O.view.pxToRem(D) + n.y,
            ...
            578: (u, e, t) => {
                ...
                function F(u = n.O.client.getSize('rem')) {
                    const e = u.width,
                        t = u.height;
                ...
                (0, E.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.largeWidth && B) return A(e, t, w);
                    ...
                    return (
                        (0, E.useLayoutEffect)(() => {
                            ...
                            return (
                                u(),
                                s(!0),
                                n.O.client.events.on('clientResized', u),
                                n.O.client.events.on('self.onScaleUpdated', u),
                                () => {
                                    (n.O.client.events.off('clientResized', u),
                                        n.O.client.events.off('self.onScaleUpdated', u));
                                }
                            );
                        }, []),
                        r().createElement(D.Provider, { value: t }, i && u)
                    );
                };
                var l = t(9849),
                    B = t.n(l),
                ...
                const w = {
                    ...
                    b = (u) => {
                        ...
                        const A = h(),
                            ...
                            a = A.mediaHeight,
                            F = A.mediaSize;
                        return r().createElement('div', v({ className: B()(t, w[n], f[a], p[F]) }, E), e);
                    },
                    x = ['children'];
                const L = (u) => {
                    let e = u.children,
                    ...
                    return r().createElement(o, null, r().createElement(b, t, e));
                };
                var S = t(1533),
                    y = t.n(S);
                let T = (function (u) {
                ...
                const I = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    W = (u, e, t = O.left) => u.split(e).reduce(t === O.left ? k : H, []),
                    N = (() => {
                        const u = new RegExp(
                            [
                    ...
                    G = (u, e = O.left) => {
                        ...
                        return ((u, e = O.left) => {
                            ...
                            const E =
                                ...
                                r = I(u);
                            return (W(r, /( )/, e).forEach((u) => (t = t.concat(W(u, E, O.left)))), t);
                        })(u, e);
                    };
                var $ = t(828),
                    z = t(6609);
                ...
                function Y(u = 0) {
                    let e = u;
                    const t = Math.trunc(e / K);
                    e -= t * K;
                    const E = Math.trunc(e / q);
                    e -= E * q;
                    const r = Math.trunc(e / j);
                    return ((e -= r * j), { days: t, hours: E, minutes: r, seconds: e });
                }
                const X = () => {},
                    Z = (u = 0, e, t = 0, r = X) => {
                        const A = (0, E.useState)(u),
                            n = A[0],
                            a = A[1];
                        return (
                            (0, E.useEffect)(() => {
                                if (u > 0) {
                                    ...
                                    const E = Date.now(),
                                        A = setInterval(
                                            () => {
                                                const e = u - Math.floor((Date.now() - E) / V);
                                                null !== t && e <= t ? (a(t), r && r(), clearInterval(A)) : a(e);
                                            },
                                            (e || (u > 120 ? j : 1)) * V,
                                        );
                                    return () => {
                    ...
                    Q = (u = 1) => {
                        ...
                        return { callerUrl: r, caller: t, stack: e, resId: E };
                    },
                    ...
                    ru = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: r, modelPath: tu(r, u || ''), resId: E };
                            })(),
                            t = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const r = J(tu(t, `${e}.${E}`), window);
                                    return eu(r) ? (u.push(r.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const Au = () => (window.injected || (window.injected = new Map()), window.injected);
                const nu = $.Sw.instance;
                let au = (function (u) {
                    return ((u.None = 'None'), (u.Shallow = 'Shallow'), (u.Deep = 'Deep'), u);
                })({});
                const Fu = (u = 'model', e = au.Deep) => {
                            ...
                            uu(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        E = ru(u);
                                    l.current = nu.addCallback(E, t, F, e === au.Deep);
                                }
                            }),
                            (0, E.useEffect)(() => {
                                if (e !== au.None)
                                    return () => {
                                        nu.removeCallback(l.current, F);
                                    };
                            }, [F, e]),
                            s
                        );
                ...
                const lu = { [T.Personal]: ou.Personal, [T.Event]: ou.Event, [T.Clan]: ou.Clan };
                function Bu(u, e) {
                    const t = lu[e];
                    return u.some((u) => u.categoryType === t && u.isDisabled);
                }
                const Cu = 'App_base_d370f',
                    cu = 'App_entryIcon_fc428',
                    du = 'App_counter_d5fa5',
                    _u = 'App_counter_content_f678e',
                    mu = 'App_entryIcon__hasNonExpiringBoosters_b2d70',
                    hu = 'App_entryIcon__hasExpiringBoostersAfterToday_c11b6',
                    gu = 'App_entryIcon__hasExpiringBoostersToday_a8f88',
                    vu = 'App_entryIcon__disabled_c2a7a',
                    wu = 'App_reserveBlocksContainer_a5d55',
                    fu = 'App_reserveBlock_cd7e4',
                    pu = 'App_reserveBlock__disabled_f15f5',
                    bu = 'App_reserveButton_b1146',
                    xu = 'FormatText_base_f27a4',
                    Lu = ({ binding: u, text: e = '', classMix: t, alignment: A = O.left, formatWithBrackets: n }) => {
                    ...
                    Su = (u = 0, e = 1, t, r, A = !1) => {
                        ...
                        return (
                            ...
                            (0, E.useEffect)(() => {
                                const E = Date.now(),
                                    n = setInterval(() => {
                                        const e = u + (A ? 1 : -1) * Math.floor((Date.now() - E) / V);
                                        void 0 !== t && (A ? e >= t : e <= t)
                                            ? (F(t), r && r(), clearInterval(n))
                                            : F(e);
                                    }, e * V);
                                return () => {
                                    clearInterval(n);
                    ...
                    yu = {
                        base: 'ReserveIcon_base_cda7b',
                        base__disabled: 'ReserveIcon_base__disabled_d2078',
                        base__active: 'ReserveIcon_base__active_f8459',
                        base__clan: 'ReserveIcon_base__clan_feb8c',
                        fill: 'ReserveIcon_fill_ffe44',
                        fill_pattern: 'ReserveIcon_fill_pattern_e1dfa',
                        fill_border: 'ReserveIcon_fill_border_c3373',
                        minutesLeft: 'ReserveIcon_minutesLeft_db643',
                        base__event: 'ReserveIcon_base__event_ecce7',
                        base__medium: 'ReserveIcon_base__medium_eade9',
                        fadeIn: 'ReserveIcon_fadeIn_d9a9e',
                        minutesLeft__smallMinutes: 'ReserveIcon_minutesLeft__smallMinutes_ecd3d',
                        icon: 'ReserveIcon_icon_b96c2',
                        icon__active: 'ReserveIcon_icon__active_ce2b0',
                        moveUp: 'ReserveIcon_moveUp_b548a',
                        fillIn: 'ReserveIcon_fillIn_ace6c',
                        fill_wrapper: 'ReserveIcon_fill_wrapper_baae6',
                        fill_wrapper__medium: 'ReserveIcon_fill_wrapper__medium_e1050',
                    },
                    Tu = R.strings.personal_reserves.hangarEntry.minute();
                let Mu = (function (u) {
                    return ((u.Small = 'Small'), (u.Large = 'Large'), u);
                })({});
                const Ru = ({
                        activeIcon: u,
                        inactiveIcon: e,
                        secondsLeft: t,
                        className: A,
                        reserveType: n = T.Personal,
                        isDisabled: a = !1,
                        totalDuration: F = 3600,
                        fontSize: i = Mu.Large,
                    }) => {
                        const s = (0, E.useContext)(D).width <= 1600,
                            o = Su(t, 1, 0),
                            l = Y(o),
                            C = Math.ceil((o / F) * 100),
                            c = o > 0,
                            d = B()(
                                s ? yu.base : yu.base__medium,
                                n === T.Clan && yu.base__clan,
                                n === T.Event && yu.base__event,
                                c && a && yu.base__disabled,
                                c && yu.base__active,
                                A,
                            ),
                            _ = B()(yu.icon, c && yu.icon__active),
                            m = l.minutes + 60 * l.hours,
                            h = B()(yu.minutesLeft, (m > 99 || i === Mu.Small) && yu.minutesLeft__smallMinutes);
                        return r().createElement(
                            'div',
                            { className: d, style: { '--height': `${C}%` } },
                            !s && r().createElement('img', { src: c ? u : e, alt: '', className: _ }),
                            c &&
                                r().createElement(
                                    r().Fragment,
                                    null,
                                    !s && r().createElement(Lu, { binding: { minutesLeft: m }, text: Tu, classMix: h }),
                                    r().createElement(
                                        'div',
                                        { className: B()(s ? yu.fill_wrapper : yu.fill_wrapper__medium) },
                                        r().createElement(
                                            'div',
                                            { className: yu.fill },
                                            s && r().createElement('div', { className: yu.fill_border }),
                                            r().createElement('div', { className: yu.fill_pattern }),
                                        ),
                                    ),
                                ),
                        );
                    },
                    Ou = R.images.gui.maps.icons.personal_reserves.booster_clan_inactive(),
                    Pu = (u, e) => u.some((u) => u.reserveType === e && u.inactivationTime > 0),
                    Iu = () => {
                        su.playHighlight();
                    },
                    ku = () => {
                        const u = Fu('model', au.Shallow),
                            e = u.totalReserves,
                            t = u.totalLimitedReserves,
                            E = u.expiringReserveWillExpireSoon,
                            A = Fu('model.disabledCategories', au.Shallow).map((u) => u.value),
                            n = Fu('model.reserves', au.Shallow).map((u) => u.value),
                            a = Pu(n, T.Personal),
                            F = Pu(n, T.Clan),
                            i = Pu(n, T.Event),
                            D = Math.max(...n.map((u) => Math.floor((1e3 * u.inactivationTime - Date.now()) / 1e3))),
                            s = Y(iu(D, 1)),
                            o = s.minutes + 60 * s.hours > 99 ? Mu.Small : Mu.Large,
                            l = a || F || i,
                            C = (u, e, t = !1) => {
                                ...
                                return r().createElement(
                                    ...
                                    e.map((e, E) => {
                                        const A = Math.max(
                                            ...
                                            n = e.iconId.replace('_premium', ''),
                                            a = R.images.gui.maps.icons.personal_reserves.$dyn(n + '_active'),
                                            F = R.images.gui.maps.icons.personal_reserves.$dyn(n + '_inactive'),
                                            i = u === T.Clan && A <= 0;
                                        return r().createElement(
                                            'div',
                                            { key: E },
                            ...
                            c = e && !t,
                            d = t && !E,
                            _ = B()(cu, c && mu, d && hu, E && gu, A.every((u) => u.isDisabled) && vu);
                        return r().createElement(
                            'div',
                            { className: Cu, onMouseOver: Iu },
                            !l &&
                                r().createElement(
                                    'div',
                                    { className: _ },
                                    e > 0 &&
                                        r().createElement(
                                            'div',
                                            { className: du },
                                            r().createElement('span', { className: _u }, e),
                                        ),
                                ),
                            r().createElement(
                                'div',
                                ...
                                (a || F) &&
                                    C(
                                        T.Personal,
                                        n.filter((u) => u.reserveType === T.Personal),
                                        Bu(A, T.Personal),
                                    ),
                                i &&
                                    C(
                                        T.Event,
                                        n.filter((u) => u.reserveType === T.Event),
                                        Bu(A, T.Event),
                                    ),
                                F &&
                                    C(
                                        T.Clan,
                                        n.filter((u) => u.reserveType === T.Clan),
                                        Bu(A, T.Clan),
                                    ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    y().render(
                        r().createElement(L, null, r().createElement(ku, null)),
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (F = 0; F < deferred.length; F++) {
                    for (var [e, t, E] = deferred[F], A = !0, n = 0; n < e.length; n++)
                        (!1 & E || r >= E) &&
            ...
            E = E || 0;
            for (var F = deferred.length; F > 0 && deferred[F - 1][2] > E; F--) deferred[F] = deferred[F - 1];
            deferred[F] = [e, t, E];
        }),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [242], () => __webpack_require__(578));
