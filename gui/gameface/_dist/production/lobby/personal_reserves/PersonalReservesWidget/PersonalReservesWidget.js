(() => {
    var __webpack_modules__ = {
            ...
            9294: (u, e, t) => {
                ...
                var E = {};
                (t.r(E),
                    t.d(E, { mouse: () => B, off: () => o, on: () => s, onResize: () => i, onScaleUpdated: () => D }));
                var r = {};
                (t.r(r),
                    t.d(r, {
                        events: () => E,
                ...
                var A = {};
                (t.r(A), t.d(A, { getBgUrl: () => L, getTextureUrl: () => b }));
                var n = {};
                function a(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const m = {
                    ...
                    v = Object.keys(g).reduce((u, e) => ((u[e] = () => C(g[e])), u), {}),
                    w = { play: Object.assign({}, v, { sound: C }), setRTPC: c },
                ...
                const nu = Object.keys(S).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === S[e]), u), {}),
                    au = {
                        set: (u, e) => {
                ...
                const su = { view: n, client: r, sound: w, intl: h };
            },
            5521: (u, e, t) => {
                'use strict';
                let E, r;
            ...
            2933: (u, e, t) => {
                ...
                var F;
                function i(u = n.O.client.getSize('rem')) {
                    const e = u.width,
                        t = u.height;
                ...
                const l = ({ children: u }) => {
                    ...
                    return (
                        ...
                        r().createElement(s.Provider, { value: t }, F && u)
                    );
                };
                var B = t(6483),
                    C = t.n(B),
                ...
                const p = {
                    ...
                    b = (u) => {
                        ...
                        const A = g(),
                            ...
                            a = A.mediaHeight,
                            F = A.mediaSize;
                        return r().createElement('div', w({ className: C()(t, p[n], f[a], x[F]) }, E), e);
                    },
                    L = ['children'];
                const S = (u) => {
                    let e = u.children,
                    ...
                    return r().createElement(l, null, r().createElement(b, t, e));
                };
                var y = t(1533),
                    T = t.n(y);
                let M, O, P;
                ...
                const W = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    G = (u, e, t = k.left) => u.split(e).reduce(t === k.left ? N : U, []),
                    $ = (() => {
                        const u = new RegExp(
                            [
                    ...
                    z = (u, e = k.left) => {
                        ...
                        return ((u, e = k.left) => {
                            ...
                            const E =
                                ...
                                r = W(u);
                            return (G(r, /( )/, e).forEach((u) => (t = t.concat(G(u, E, k.left)))), t);
                        })(u, e);
                    };
                var V = t(9916),
                    K = t(8613);
                ...
                function Q(u = 0) {
                    let e = u;
                    const t = Math.trunc(e / Z);
                    e -= t * Z;
                    const E = Math.trunc(e / Y);
                    e -= E * Y;
                    const r = Math.trunc(e / X);
                    return ((e -= r * X), { days: t, hours: E, minutes: r, seconds: e });
                }
                const J = () => {},
                    uu = (u = 0, e, t = 0, r = J) => {
                            ...
                            (0, E.useEffect)(() => {
                                if (u > 0) {
                                    ...
                                    const E = Date.now(),
                                        A = setInterval(
                                            () => {
                                                const e = u - Math.floor((Date.now() - E) / q);
                    ...
                    ru = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    Au = (u, e) => (u.length > 0 ? `${u}.${e}` : e),
                    nu = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const E = tu(`${u}.${t}`, window);
                                return ru(E) ? e(u, t, E) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    au = (u) => {
                        const e = ((u) => {
                                const e = eu(),
                                ...
                                return { modelPrefix: r, modelPath: Au(r, u || ''), resId: E };
                            })(),
                            t = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const r = tu(Au(t, `${e}.${E}`), window);
                                    return ru(r) ? (u.push(r.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const Fu = () => (window.injected || (window.injected = new Map()), window.injected);
                const iu = V.Sw.instance;
                let Du;
                !(function (u) {
                    ((u.None = 'None'), (u.Shallow = 'Shallow'), (u.Deep = 'Deep'));
                })(Du || (Du = {}));
                const su = (u = 'model', e = Du.Deep) => {
                            ...
                            Eu(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        E = au(u);
                                    l.current = iu.addCallback(E, t, F, e === Du.Deep);
                                }
                            }),
                            (0, E.useEffect)(() => {
                                if (e !== Du.None)
                                    return () => {
                                        iu.removeCallback(l.current, F);
                                    };
                            }, [F, e]),
                            s
                        );
                ...
                const cu = { [M.Personal]: Cu.Personal, [M.Event]: Cu.Event, [M.Clan]: Cu.Clan };
                function du(u, e) {
                    const t = cu[e];
                    return u.some((u) => u.categoryType === t && u.isDisabled);
                }
                const _u = 'App_base_82',
                    mu = 'App_entryIcon_d6',
                    hu = 'App_counter_3a',
                    gu = 'App_counter_content_32',
                    vu = 'App_entryIcon__hasNonExpiringBoosters_76',
                    wu = 'App_entryIcon__hasExpiringBoostersAfterToday_fa',
                    pu = 'App_entryIcon__hasExpiringBoostersToday_82',
                    fu = 'App_entryIcon__disabled_e9',
                    xu = 'App_reserveBlocksContainer_46',
                    bu = 'App_reserveBlock_c0',
                    Lu = 'App_reserveBlock__disabled_79',
                    Su = 'App_reserveButton_89',
                    yu = 'FormatText_base_d0',
                    Tu = ({ binding: u, text: e = '', classMix: t, alignment: A = k.left, formatWithBrackets: n }) => {
                    ...
                    Mu = (u = 0, e = 1, t, r, A = !1) => {
                        ...
                        return (
                            ...
                            (0, E.useEffect)(() => {
                                const E = Date.now(),
                                    n = setInterval(() => {
                                        const e = u + (A ? 1 : -1) * Math.floor((Date.now() - E) / q);
                                        void 0 !== t && (A ? e >= t : e <= t)
                    ...
                    Ru = R.strings.personal_reserves.hangarEntry.minute();
                let Pu;
                !(function (u) {
                ...
                const Iu = ({
                        ...
                        secondsLeft: t,
                        className: A,
                        reserveType: n = M.Personal,
                        isDisabled: a = !1,
                        totalDuration: F = 3600,
                        fontSize: i = Pu.Large,
                    }) => {
                        const D = (0, E.useContext)(s).width <= 1600,
                            o = Mu(t, 1, 0),
                            l = Q(o),
                            B = Math.ceil((o / F) * 100),
                            c = o > 0,
                            d = C()(
                                D ? Ou.base : Ou.base__medium,
                                n === M.Clan && Ou.base__clan,
                                n === M.Event && Ou.base__event,
                                c && a && Ou.base__disabled,
                                c && Ou.base__active,
                                A,
                            ),
                            _ = C()(Ou.icon, c && Ou.icon__active),
                            m = l.minutes + 60 * l.hours,
                            h = C()(Ou.minutesLeft, (m > 99 || i === Pu.Small) && Ou.minutesLeft__smallMinutes);
                        return r().createElement(
                            'div',
                            { className: d, style: { '--height': `${B}%` } },
                            !D && r().createElement('img', { src: c ? u : e, alt: '', className: _ }),
                            c &&
                                r().createElement(
                                    r().Fragment,
                                    null,
                                    !D && r().createElement(Tu, { binding: { minutesLeft: m }, text: Ru, classMix: h }),
                                    r().createElement(
                                        'div',
                                        { className: C()(D ? Ou.fill_wrapper : Ou.fill_wrapper__medium) },
                                        r().createElement(
                                            'div',
                                            { className: Ou.fill },
                                            D && r().createElement('div', { className: Ou.fill_border }),
                                            r().createElement('div', { className: Ou.fill_pattern }),
                                        ),
                                    ),
                                ),
                        );
                    },
                    ku = R.images.gui.maps.icons.personal_reserves.booster_clan_inactive(),
                    Hu = (u, e) => u.some((u) => u.reserveType === e && u.inactivationTime > 0),
                    Wu = () => {
                        Bu.playHighlight();
                    },
                    Nu = () => {
                        const u = su('model', Du.Shallow),
                            e = u.totalReserves,
                            t = u.totalLimitedReserves,
                            E = u.expiringReserveWillExpireSoon,
                            A = su('model.disabledCategories', Du.Shallow).map((u) => u.value),
                            n = su('model.reserves', Du.Shallow).map((u) => u.value),
                            a = Hu(n, M.Personal),
                            F = Hu(n, M.Clan),
                            i = Hu(n, M.Event),
                            D = Math.max(...n.map((u) => Math.floor((1e3 * u.inactivationTime - Date.now()) / 1e3))),
                            s = Q(ou(D, 1)),
                            o = s.minutes + 60 * s.hours > 99 ? Pu.Small : Pu.Large,
                            l = a || F || i,
                            B = (u, e, t = !1) => {
                            ...
                            c = e && !t,
                            d = t && !E,
                            _ = C()(mu, c && vu, d && wu, E && pu, A.every((u) => u.isDisabled) && fu);
                        return r().createElement(
                            'div',
                            { className: _u, onMouseOver: Wu },
                            !l &&
                                r().createElement(
                                    'div',
                                    { className: _ },
                                    e > 0 &&
                                        r().createElement(
                                            'div',
                                            { className: hu },
                                            r().createElement('span', { className: gu }, e),
                                        ),
                                ),
                            r().createElement(
                                'div',
                                ...
                                (a || F) &&
                                    B(
                                        M.Personal,
                                        n.filter((u) => u.reserveType === M.Personal),
                                        du(A, M.Personal),
                                    ),
                                i &&
                                    B(
                                        M.Event,
                                        n.filter((u) => u.reserveType === M.Event),
                                        du(A, M.Event),
                                    ),
                                F &&
                                    B(
                                        M.Clan,
                                        n.filter((u) => u.reserveType === M.Clan),
                                        du(A, M.Clan),
                                    ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    T().render(
                        r().createElement(S, null, r().createElement(Nu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [242], () => __webpack_require__(2933));
