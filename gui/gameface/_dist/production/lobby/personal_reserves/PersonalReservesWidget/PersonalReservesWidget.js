(() => {
    var __webpack_modules__ = {
            ...
            67: (u, e, t) => {
                ...
                var F = {};
                (t.r(F), t.d(F, { getBgUrl: () => c, getTextureUrl: () => o }));
                var r = {};
                function a(u) {
                    return (e) => (
                        engine.on(u, e),
                    ...
                    f = {
                        ...
                        sendShowPopOverEvent: (u, e, t, E, A = R.invalid('resId'), F) => {
                            const r = C.O.view.getViewGlobalPosition(),
                                ...
                                l = a.height,
                                s = {
                                    x: C.O.view.pxToRem(n) + r.x,
                                    y: C.O.view.pxToRem(D) + r.y,
            ...
            322: (u, e, t) => {
                ...
                const D = r.O.client.getSize('rem'),
                    B = D.width,
                    l = D.height,
                    s = Object.assign({ width: B, height: l }, n(B, l, a)),
                ...
                const c = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && B) return F(e, t, w);
                        if (t.largeWidth && l) return F(e, t, w);
                        if (t.mediumWidth && s) return F(e, t, w);
                        if (t.smallWidth && c) return F(e, t, w);
                        if (t.extraSmallWidth && _) return F(e, t, w);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                ...
                const _ = (u) => {
                    ...
                    d = (0, E.memo)(({ children: u }) => {
                        ...
                        const B = (0, E.useMemo)(() => Object.assign({}, F), [F]);
                ...
                const S = {
                    ...
                    O = (u) => {
                        ...
                        const F = x(),
                            ...
                            a = F.mediaHeight,
                            i = F.mediaSize;
                        return A().createElement('div', b({ className: h()(t, S[r], M[a], T[i]) }, E), e);
                    },
                    y = ['children'];
                const P = (u) => {
                    let e = u.children,
                ...
                const U = (u, e, t) => {
                    ...
                    $ = (u, e, t = W.left) => u.split(e).reduce(t === W.left ? U : G, []),
                    z = (() => {
                        const u = new RegExp(
                ...
                function Q(u = 0) {
                    ...
                    e -= E * X;
                    const A = Math.trunc(e / Y);
                    return ((e -= A * Y), { days: t, hours: E, minutes: A, seconds: e });
                }
                const J = () => {},
                    uu = (u = 0, e, t = 0, A = J) => {
                                    ...
                                    const E = Date.now(),
                                        F = setInterval(
                                            () => {
                                                ...
                                                null !== t && e <= t ? (a(t), A && A(), clearInterval(F)) : a(e);
                                            },
                                            1e3 * (e || (u > 120 ? Y : 1)),
                                        );
                                    return () => {
                            ...
                            _(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        E = ru(u);
                                    l.current = au.addCallback(E, t, a, e === iu.Deep);
                                }
                            }),
                            (0, E.useEffect)(() => {
                                if (e !== iu.None)
                ...
                const Cu = { [k.Personal]: su.Personal, [k.Event]: su.Event, [k.Clan]: su.Clan };
                function ou(u, e) {
                    const t = Cu[e];
                    return u.some((u) => u.categoryType === t && u.isDisabled);
                }
                const cu = 'App_base_82',
                    _u = 'App_entryIcon_d6',
                    du = 'App_counter_3a',
                    mu = 'App_entryIcon__limited_14',
                    hu = 'App_entryIcon__disabled_e9',
                    gu = 'App_reserveBlocksContainer_46',
                    vu = 'App_reserveBlock_c0',
                    wu = 'App_reserveBlock__disabled_79',
                    fu = 'App_reserveButton_89',
                    pu = 'FormatText_base_d0',
                    xu = ({ binding: u, text: e = '', classMix: t, alignment: F = W.left }) =>
                        null === e
                    ...
                    bu = R.strings.personal_reserves.hangarEntry.minute();
                let Su;
                !(function (u) {
                ...
                const Mu = ({
                        ...
                        secondsLeft: t,
                        className: F,
                        reserveType: r = k.Personal,
                        isDisabled: a = !1,
                        totalDuration: i = 3600,
                        fontSize: n = Su.Large,
                    }) => {
                        const D = (0, E.useContext)(C).width <= 1600,
                            B = Du(t, 1),
                            l = Q(B),
                            s = Math.ceil((B / i) * 100),
                            o = B > 0,
                            c = h()(
                                D ? Lu.base : Lu.base__medium,
                                r === k.Clan && Lu.base__clan,
                                r === k.Event && Lu.base__event,
                                o && a && Lu.base__disabled,
                                o && Lu.base__active,
                                F,
                            ),
                            _ = h()(Lu.icon, o && Lu.icon__active),
                            d = l.minutes + 60 * l.hours,
                            m = h()(Lu.minutesLeft, (d > 99 || n === Su.Small) && Lu.minutesLeft__smallMinutes);
                        return A().createElement(
                            'div',
                            { className: c, style: { '--height': `${s}%` } },
                            !D && A().createElement('img', { src: o ? u : e, alt: '', className: _ }),
                            o &&
                                A().createElement(
                                    A().Fragment,
                                    null,
                                    !D && A().createElement(xu, { binding: { minutesLeft: d }, text: bu, classMix: m }),
                                    A().createElement(
                                        'div',
                                        { className: h()(D ? Lu.fill_wrapper : Lu.fill_wrapper__medium) },
                                        A().createElement(
                                            'div',
                                            { className: Lu.fill },
                                            D && A().createElement('div', { className: Lu.fill_border }),
                                            A().createElement('div', { className: Lu.fill_pattern }),
                                        ),
                                    ),
                                ),
                        );
                    ...
                    yu = () => {
                        const u = nu('model', iu.Shallow),
                            e = u.totalReserves,
                            t = u.totalLimitedReserves,
                            E = nu('model.disabledCategories', iu.Shallow).map((u) => u.value),
                            F = nu('model.reserves', iu.Shallow).map((u) => u.value),
                            r = Ou(F, k.Personal),
                            a = Ou(F, k.Clan),
                            i = Ou(F, k.Event),
                            n = Math.max(...F.map((u) => Math.floor((1e3 * u.inactivationTime - Date.now()) / 1e3))),
                            D = Q(Du(n, 1)),
                            ...
                            s = (u, e, t = !1) => {
                                ...
                                return A().createElement(
                                    ...
                                    { className: E },
                                    e.map((e, E) => {
                                        const F = Math.floor((1e3 * e.inactivationTime - Date.now()) / 1e3),
                                            r = e.iconId.replace('_premium', ''),
                                            a = `R.images.gui.maps.icons.personal_reserves.${r}_active`,
                                            i = `R.images.gui.maps.icons.personal_reserves.${r}_inactive`,
                                            n = u === k.Clan && F < 0;
                                        return A().createElement(
                                            'div',
                                            { key: E },
                            ...
                            C = h()(_u, E.every((u) => u.isDisabled) && hu, t && mu);
                        return A().createElement(
                            'div',
                            { className: cu, onMouseOver: Ru },
                            !l &&
                                A().createElement(
                                    'div',
                                    { className: C },
                                    e > 0 && A().createElement('div', { className: du }, e),
                                ),
                            A().createElement(
                                'div',
                                { className: gu },
                                (r || a) &&
                                    s(
                                        k.Personal,
                                        F.filter((u) => u.reserveType === k.Personal),
                                        ou(E, k.Personal),
                                    ),
                                i &&
                                    s(
                                        k.Event,
                                        F.filter((u) => u.reserveType === k.Event),
                                        ou(E, k.Event),
                                    ),
                                a &&
                                    s(
                                        k.Clan,
                                        F.filter((u) => u.reserveType === k.Clan),
                                        ou(E, k.Clan),
                                    ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    I().render(
                        A().createElement(P, null, A().createElement(yu, null)),
