(() => {
    var __webpack_modules__ = {
            ...
            9294: (u, e, t) => {
                ...
                var n = {};
                (t.r(n), t.d(n, { getBgUrl: () => L, getTextureUrl: () => x }));
                var E = {};
                function i(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const d = {
                    ...
                    p = Object.keys(h).reduce((u, e) => ((u[e] = () => B(h[e])), u), {}),
                    v = { play: Object.assign({}, p, { sound: B }), setRTPC: C },
                ...
                const Eu = Object.keys(S).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === S[e]), u), {}),
                    iu = {
                        set: (u, e) => {
                ...
                const Du = { view: E, client: r, sound: v, intl: g };
            },
            5521: (u, e, t) => {
                'use strict';
                let a, r;
            ...
            6575: (u, e, t) => {
                ...
                var o;
                function D(u = A.O.client.getSize('rem')) {
                    const e = u.width,
                        t = u.height;
                ...
                (0, a.memo)((u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && B) return i(e, t, v);
                        if (t.smallWidth && C) return i(e, t, v);
                ...
                const B = ({ children: u }) => {
                    ...
                    return (
                        (0, a.useLayoutEffect)(() => {
                            function u() {
                                n((u) => {
                                    ...
                                    return u.width === e.width && u.height === e.height ? u : D(e);
                                });
                            }
                            return (
                                u(),
                        ...
                        r().createElement(l.Provider, { value: t }, i && u)
                    );
                };
                var C = t(6483),
                    c = t.n(C),
                ...
                const f = {
                    ...
                    S = (u) => {
                        ...
                        const n = v(),
                            ...
                            i = n.mediaHeight,
                            A = n.mediaSize;
                        return r().createElement('div', b({ className: c()(t, f[E], x[i], L[A]) }, a), e);
                    },
                    M = ['children'];
                const T = (u) => {
                    let e = u.children,
                    ...
                    return r().createElement(B, null, r().createElement(S, t, e));
                };
                var y = t(9887),
                    O = t.n(y);
                const H = ['xl', 'lg', 'md', 'sm', 'xs'],
                    k = (u) => u.includes('_') && ((u) => H.includes(u))(u.split('_').at(-1)),
                    P = [g.ExtraLarge, g.Large, g.Medium, g.Small, g.ExtraSmall],
                    N = (u, e) =>
                        Object.keys(u).reduce((t, a) => {
                            ...
                            return (
                                void 0 === r ||
                                    ((u, e) => H.some((t) => void 0 !== e[`${u}_${t}`]))(a, u) ||
                                    (t[a] = r),
                                t
                            );
                        }, {}),
                ...
                const j = {
                    ...
                    K = I((u) => {
                        let e = u.className,
                            ...
                            C = u.row,
                            m = u.flexDirection,
                            d = void 0 === m ? (B ? 'column' : C && 'row') || void 0 : m,
                            g = u.flexStart,
                            h = u.center,
                            p = u.flexEnd,
                            v = u.spaceBetween,
                            ...
                            O = u.shrink,
                            H = u.flex,
                            k = void 0 === H ? (y || O ? `${y ? 1 : 0} ${O ? 1 : 0} auto` : void 0) : H,
                            P = u.style,
                            N = u.children,
                            I = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const K = (0, a.useMemo)(() => {
                                const u = { mt: A, mr: o, mb: s, ml: _ },
                                    e = ((u) =>
                                        $.reduce((e, t) => {
                                            const a = u[t];
                                            return a && 'number' != typeof a ? e.concat(j[!0 === a ? 'MD' : a][t]) : e;
                                        }, []))(u),
                                    a = ((u) =>
                                        $.reduce((e, t) => {
                                            const a = u[t];
                                            return ('number' == typeof a && (e[X[t]] = a + 'rem'), e);
                                        }, {}))(u);
                                return {
                            ...
                            }, [t, n, A, o, s, _, P, k, S, d, R, f, L]),
                            z = K.computedStyle,
                            V = K.computedClassNames;
                        return r().createElement('div', U({ className: c()(G.base, ...V, e), style: z }, I), N);
                    });
                function z(u) {
                    engine.call('PlaySound', u).catch((e) => {
                ...
                const Z = ({
                        ...
                        return (
                            (0, a.useEffect)(() => {
                                function u(u) {
                                    d && null !== C.current && !C.current.contains(u.target) && g(!1);
                                }
                                return (
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'span',
                                    { className: c()(V.state, V.state__default) },
                    ...
                    Q = 'Page_base_64',
                    J = 'Page_navigation_68',
                    uu = 'Page_navigation_fill_b7',
                    eu = 'Page_header_d5',
                    tu = 'Page_body_d7',
                    au = 'Page_footer_db',
                    ru = ({
                        ...
                        return r().createElement(
                            ...
                            (n || E) &&
                                r().createElement(
                                    ...
                                    { className: J },
                                    n,
                                    E && r().createElement('div', { className: uu }),
                                    E,
                                ),
                            e && r().createElement('div', { className: c()(eu, F) }, e),
                            t && r().createElement('div', { className: c()(tu, A) }, t),
                            a && r().createElement('div', { className: c()(au, o) }, a),
                        );
                    };
                var nu = t(1281);
                let Eu;
                    ...
                    _u = (u, e = Eu.left) => {
                        ...
                        return ((u, e = Eu.left) => {
                            ...
                            const a =
                                ...
                                r = Au(u);
                            return (Du(r, /( )/, e).forEach((u) => (t = t.concat(Du(u, a, Eu.left)))), t);
                        })(u, e);
                    },
                    Bu = 'FormatText_base_d0',
                    Cu = ({ binding: u, text: e = '', classMix: t, alignment: n = Eu.left, formatWithBrackets: E }) => {
                ...
                const pu = Object.keys(mu()),
                    ...
                    Su = I((u) => {
                        ...
                        return r().createElement(
                            ...
                            hu(
                                {
                                    className: c()(du.base, t && du[t], p, n),
                                    style: h,
                            ...
                            void 0 !== m ? r().createElement(Cu, hu({}, m, { text: e })) : e,
                        );
                    }),
                    Mu = {
                ...
                const yu = (u) => {
                    ...
                    const p = (0, a.useCallback)(
                            (u) => {
                                (null == i || i(u), A.O.sound.play.sound(m));
                            },
                            [i, m],
                        ),
                        v = (0, a.useCallback)(
                    ...
                    return r().createElement(
                        ...
                        'info' !== B && r().createElement('div', { className: Mu.shine }),
                        r().createElement(
                            'div',
                            {
                                className: c()(
                            ...
                            r().createElement('div', { className: c()(Mu.glow, null == E ? void 0 : E.glow) }),
                        ),
                        r().createElement(
                            'div',
                        ...
                        n && r().createElement('div', { className: c()(Mu.goto, null == E ? void 0 : E.goto) }, n),
                    );
                };
                var Ou = t(9916),
                    Hu = t(8613);
                ...
                const ku = (u = 1) => {
                    ...
                    Pu = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    Nu = (u) => {
                    ...
                    Wu = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const a = Pu(`${u}.${t}`, window);
                                return Iu(a) ? e(u, t, a) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    Uu = (u) => {
                        const e = ((u) => {
                                const e = ku(),
                                ...
                                return { modelPrefix: r, modelPath: Gu(r, u || ''), resId: a };
                            })(),
                            t = e.modelPrefix,
                            a = u.split('.');
                        if (a.length > 0) {
                            ...
                            return (
                                a.reduce((e, a) => {
                                    const r = Pu(Gu(t, `${e}.${a}`), window);
                                    return Iu(r) ? (u.push(r.id), `${e}.${a}.value`) : (u.push(a), `${e}.${a}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const ju = () => (window.injected || (window.injected = new Map()), window.injected);
                const $u = Ou.Sw.instance;
                let Xu;
                !(function (u) {
                    ((u.None = 'None'), (u.Shallow = 'Shallow'), (u.Deep = 'Deep'));
                })(Xu || (Xu = {}));
                const Ku = (u = 'model', e = Xu.Deep) => {
                        ...
                        Nu(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    a = Uu(u);
                                l.current = $u.addCallback(a, t, A, e === Xu.Deep);
                            }
                        }),
                        (0, a.useEffect)(() => {
                            if (e !== Xu.None)
                                return () => {
                                    $u.removeCallback(l.current, A);
                                };
                        }, [A, e]),
                        D
                    );
                ...
                function qu(u = zu.n.NONE, e = Vu, t = !1, r = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== zu.n.NONE)
                            return (
                    ...
                    ue = () => {
                        ...
                        return (
                            ...
                            r().createElement(
                                ...
                                { className: Yu },
                                r().createElement(ru, {
                                    navigationRightContent: r().createElement(yu, {
                                    ...
                                    body: r().createElement(
                                        ...
                                        r().createElement(
                                            ...
                                            r().createElement(
                                                Z,
                                                { type: q.primary, size: Y.medium, mixClass: Qu, onClick: n },
                ...
                engine.whenReady.then(() => {
                    E().render(
                        r().createElement(T, null, r().createElement(ue, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [242], () => __webpack_require__(6575));
