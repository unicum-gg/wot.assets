(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, A) => {
                A.d(e, { O: () => $ });
                var E = {};
                A.r(E), A.d(E, { mouse: () => i, onResize: () => B });
                var F = {};
                A.r(F),
                    A.d(F, {
                        events: () => E,
            ...
            750: (u, e, A) => {
                ...
                const C = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            i({}, s, {
                                className: F()(B.base, B[`base__theme-${a}`], E),
                                ref: function (u) {
                                    (c.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            n().createElement('div', { className: B.decorator }, A),
                        )
                    );
                });
                var a = A(493),
                ...
                const d = (u, e, A) => {
                    ...
                    m = (u, e, A = _.left) => u.split(e).reduce(A === _.left ? d : v, []),
                    p = (() => {
                        const u = new RegExp(
                        ...
                        return w.includes(A)
                            ...
                            : ((u, e = _.left) => {
                                  ...
                                  const E =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return m(F, /( )/, e).forEach((u) => (A = A.concat(m(u, E, _.left)))), A;
                              })(u, e);
                    };
                let f;
                !(function (u) {
                ...
                const y = () => {},
                            ...
                            (0, D.useEffect)(() => {
                                if (u > 0) {
                                    ...
                                    const F = Date.now(),
                                        t = setInterval(
                                            () => {
                                                const e = u - Math.floor((Date.now() - F) / 1e3);
                                                null !== A && e <= A ? (n(A), E && E(), clearInterval(t)) : n(e);
                                            },
                                            1e3 * (e || (u > 120 ? g : 1)),
                                        );
                                    return () => {
                    ...
                    U = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: F, modelPath: x(F, u || ''), resId: E };
                            })(),
                            A = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                ...
                const H = (u = 'model', e = V.Deep) => {
                        const A = (0, D.useState)(0),
                            E = (A[0], A[1]),
                            F = (0, D.useMemo)(() => M(), []),
                            t = F.caller,
                            n = F.resId,
                            ...
                            N(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        F = U(u);
                                    C.current = I.addCallback(F, A, n, e === V.Deep);
                                }
                            }),
                            (0, D.useEffect)(() => {
                                if (e !== V.None)
                                    return () => {
                                        I.removeCallback(C.current, n);
                                    };
                            }, [n, e]),
                            o
                        );
                ...
                const z = {
                    ...
                    q = { [l.Personal]: W.Personal, [l.Event]: W.Event, [l.Clan]: W.Clan };
                function j(u, e) {
                    const A = q[e];
                    return u.some((u) => u.categoryType === A && u.isDisabled);
                }
                const $ = 'App_base_7b',
                    G = 'App_base__disabled_e1',
                    Y = 'App_reserveBlock_dc',
                    Z = 'App_reserveBlock_clan_31',
                    X = 'App_reserveBlock__disabled_f3',
                    Q = 'App_tooltipSlot_cd',
                    J = 'FormatText_base_d0',
                    uu = ({ binding: u, text: e = '', classMix: A, alignment: E = _.left }) =>
                        null === e
                            ...
                            : n().createElement(
                                  ...
                                  e.split('\n').map((e, t) =>
                                      n().createElement(
                                          'div',
                                          { className: F()(J, A), key: `${e}-${t}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : h(u, e))))(e, E, u).map((u, e) =>
                                              n().createElement(D.Fragment, { key: `${e}-${u}` }, u),
                                          ),
                                      ),
                                  ),
                              ),
                    eu = 'TooltipSlot_base_f8',
                    Au = 'TooltipSlot_base__clan_3e',
                    Eu = 'TooltipSlot_fillPattern_9d',
                    Fu = 'TooltipSlot_cardFill_3b',
                    tu = 'TooltipSlot_activeLight_85',
                    Du = 'TooltipSlot_timerIcon_ac',
                    nu = 'TooltipSlot_base__event_80',
                    ru = 'TooltipSlot_base__inactive_24',
                    Bu = 'TooltipSlot_boosterIcon_b0',
                    ou = 'TooltipSlot_cardContent_2d',
                    iu = 'TooltipSlot_boosterCount_fb',
                    Cu = 'TooltipSlot_cardFill_borderGradient_7e',
                    au = 'TooltipSlot_timer_9b',
                    su = 'TooltipSlot_multiplier_7f',
                    lu = 'TooltipSlot_activeLight_border_19',
                    cu = 'TooltipSlot_paidHighlight_07',
                    _u = R.strings.personal_reserves.hangarEntryTooltip.bonus(),
                    du = ({
                        className: u,
                        icon: e,
                        inDepot: A,
                        ...
                        const o = K(E, 1),
                            i = (function (u = 0) {
                                let e = u;
                                const A = Math.trunc(e / O);
                                e -= A * O;
                                const E = Math.trunc(e / T);
                                e -= E * T;
                                const F = Math.trunc(e / g);
                                return (e -= F * g), { days: A, hours: E, minutes: F, seconds: e };
                            })(o),
                            C = Math.ceil((o / B) * 100),
                            a = o > 0,
                            s = t === l.Clan,
                            c = F()(eu, s && Au, t === l.Event && nu, !a && ru, u),
                            _ = (u) => u.toString().padStart(2, '0'),
                            d = `${_(i.minutes + 60 * i.hours)}:${_(i.seconds)}`;
                        return a
                            ? n().createElement(
                                  'div',
                                  { className: c, style: { '--fillPercentage': `${C}%` } },
                                  n().createElement(
                                      'div',
                                      { className: Fu },
                                  ...
                                  D && n().createElement('div', { className: cu }),
                                  n().createElement(
                                      'div',
                                      { className: ou },
                                      n().createElement(
                                      ...
                                      n().createElement('img', { src: e, alt: '', className: Bu }),
                                      n().createElement(
                                          'div',
                                          { className: su },
                                          n().createElement(uu, { text: _u, binding: { bonus: r } }),
                                      ),
                                  ),
                              )
                            : n().createElement(
                                  ...
                                  n().createElement(
                                      'div',
                                      { className: ou },
                                      !s && n().createElement('div', { className: iu }, A),
                                      !s && n().createElement('img', { src: e, alt: '', className: Bu }),
                                  ),
                              );
                    },
                    vu = { disabled: R.strings.personal_reserves.hangarEntryTooltip.tooltipDisabled() },
                    mu = (u, e, A) => {
                        const E = F()(Y, u === l.Clan && Z, A && X);
                        return n().createElement(
                            'div',
                            { className: E },
                            e.map((e, A) => {
                                const E = Math.floor(e.inactivationTime - Date.now() / 1e3),
                                    F = Math.max(e.inDepot, 0),
                                    t = (function (u, e, A) {
                                        const E = u > -1 ? u : z[A];
                                        let F = `${E}`;
                                        return u >= 0 && u < e && (F = `${u}% - ${e}`), [E > 0, F];
                                    })(e.minBonus, e.maxBonus, e.iconId)[1];
                                return n().createElement(
                                    'div',
                                    { key: A },
                                    n().createElement(du, {
                                        ...
                                        icon: `R.images.gui.maps.icons.quests.bonuses.big.${e.iconId}`,
                                        bonus: t,
                    ...
                    pu = () => {
                        const u = H('model', V.Shallow).isClanMember,
                            e = H('model.disabledCategories', V.Shallow).map((u) => u.value),
                            A = H('model.reserves', V.Shallow).map((u) => u.value);
                        if (A.every((u) => j(e, u.reserveType)))
                            return n().createElement(
                                'div',
                                { className: G },
                                n().createElement('div', null, vu.disabled),
                            );
                        const E = A.filter((u) => u.reserveType === l.Personal),
                            F = A.filter((u) => u.reserveType === l.Clan),
                            t = A.filter((u) => u.reserveType === l.Event),
                            D = t.some((u) => u.inactivationTime > 0);
                        return n().createElement(
                            'div',
                            { className: $ },
                            mu(l.Personal, E, j(e, l.Personal)),
                            D && mu(l.Event, t, j(e, l.Event)),
                            u && mu(l.Clan, F, j(e, l.Clan)),
                        );
                    };
                engine.whenReady.then(() => {
                    s().render(
                        n().createElement(C, null, n().createElement(pu, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [242], () => __webpack_require__(750));
