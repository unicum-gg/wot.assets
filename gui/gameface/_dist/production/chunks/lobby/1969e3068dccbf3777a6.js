...
(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
    [935],
    {
        5621: (e, t, a) => {
            ...
            var r = {};
            (a.r(r), a.d(r, { Area: () => re, Bar: () => te, Default: () => ne, useVerticalScrollApi: () => W }));
            var s = a(7363),
                o = a.n(s),
                i = a(9849),
                l = a.n(i),
            ...
            const y = {
                ...
                L = (0, s.memo)(({ api: e, classNames: t = {}, getStepByRailClick: a = D, onDrag: n = O }) => {
                    ...
                    const r = (0, s.useRef)(null),
                        ...
                        C = _(() => {
                            ...
                            return (
                                ...
                                (t.style.display = 'flex'),
                                r.current && (1 !== o ? r.current.classList.add(U) : r.current.classList.remove(U)),
                                o
                            );
                        }),
                        I = _(() => {
            ...
            const ce = (e) => {
                ...
                return o().createElement(
                    ...
                    le(
                        {
                            className: l()(oe.base, oe[`base__${v}`], oe[`base__${g}`], null == r ? void 0 : r.base),
                            onMouseEnter: N,
                            onMouseLeave: S,
                            onMouseDown: C,
                            onMouseUp: I,
                    ...
                    o().createElement(
                        'div',
                        { className: l()(oe.icon, oe[`icon__${v}`], oe[`icon__${g}`], null == r ? void 0 : r.icon) },
                    ...
                    n && o().createElement('div', { className: l()(oe.goto, null == r ? void 0 : r.goto) }, n),
                );
            };
            var me = a(6758),
                ue = a(5037),
            ...
            let Pe = (function (e) {
                ...
                we = (function (e) {
                    return ((e.None = 'none'), (e.Simple = 'simple'), (e.Series = 'series'), (e.Stages = 'stages'), e);
                })({}),
                Me = (function (e) {
                    return (
            ...
            const Le = ({ value: e, type: t = we.Simple, size: a = Be.Medium, className: n }) =>
                ...
                He =
                    ...
                    ({ name: e, resourceName: t, type: a, rareIconId: n, rareBigIconId: r, value: s, size: o }) => {
                                ...
                                o().createElement(
                                    ...
                                    _ &&
                                        o().createElement(
                                            ...
                                            {
                                                isEnabled: b,
                                                header: R.strings.achievements_page.summary.achievements.customization.tooltips.title(),
            ...
            const Qt = ({ background: e, engraving: t, size: a = Zt.Big, grade: n = 0, className: r }) => {
            ...
            const ia = { duration: 500, easing: ta.Z.easeOutBack },
                ...
                ca = { [oa.ExtraSmall]: 'small', [oa.Small]: 'big', [oa.Medium]: 'big', [oa.Large]: 's500x300' },
                ma = {
                ...
                ya = (0, de.Pi)(() => {
                    ...
                    return o().createElement(
                        ...
                        o().createElement(
                            'div',
                            { className: ga },
                            r && o().createElement('div', { className: ba, style: { backgroundImage: `url(${r})` } }),
                                            ...
                                            r = window.setInterval(() => {
                                                ...
                                                s
                                                    ? (null == i || i(n, s),
                                                      ...
                                                      n === g &&
                                                          (null == h || h(),
                                                          v || (null == E || E(), window.clearInterval(r))))
            ...
            const Fa = 'DowngradeAnimation_base_cbede',
                ...
                Ja = ({ oldElement: e, newElement: t, delay: a = 0 }) => (
                    (0, s.useEffect)(() => (0, ja.F)(() => (0, b.G)(R.sounds.achievements_leveldown()), a), [a]),
                    o().createElement(
                        'div',
                        { className: Fa },
                        o().createElement(
                        ...
                        o().createElement(
                            'div',
                            { className: qa, style: { animationDelay: `${a + 300}ms`, animationDuration: '300ms' } },
                            t,
                        ),
                    )
                ),
                    ...
                    t
                        ...
                        : e >= Ie.cJ.Large
                          ...
                          : e >= Ie.cJ.Medium
                            ...
                            : nn.c_180x180,
                sn = (e, t, a, n = !0, r = !1) => ({
                    backgroundImage: n ? `url(${rn(a, r).$dyn(`rating_${e}_${t}`)})` : `url(${rn(a, r).wotpr()})`,
                }),
                on = (0, de.Pi)(() => {
                    const e = Ce().model,
                        t = e.root.get(),
            ...
            const Sn = (0, de.Pi)(() => {
                ...
                pr = () =>
                    o().createElement(Se, { options: { context: 'model.summaryModel' } }, o().createElement(fr, null));
        },
    },
]);
