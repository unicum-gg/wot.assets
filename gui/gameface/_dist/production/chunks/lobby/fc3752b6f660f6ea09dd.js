    ...
    [154],
    {
        7910: (e, t, a) => {
            ...
            const y = {
                ...
                O = (0, s.memo)(({ api: e, classNames: t = {}, getStepByRailClick: a = x, onDrag: n = B }) => {
                    ...
                    return l().createElement(
                        ...
                        l().createElement(
                            ...
                            l().createElement(
                                ...
                                r !== Se.None &&
                                    l().createElement(Le, { type: r, size: ke[s], value: i, className: Ce.counter }),
                            ),
                        ),
                    );
                };
                                                    ...
                                                    ? (m++,
                                                      l().createElement(
                                                          ...
                                                          l().createElement(
                                                              ...
                                                              l().createElement(xe, ht({}, e, { size: u })),
                                                          ),
                                                          l().createElement(
                                                              'div',
                                                              {
            ...
            const Bt = ({ background: e, engraving: t, size: a = xt.Big, grade: n = 0, className: r }) => {
                    const s = kt.includes(Tt) ? `_${Tt}` : '';
                    return l().createElement(
                        'div',
                        { className: o()(wt, r) },
                        l().createElement('div', {
            ...
            const Ia = 'DowngradeAnimation_base_1c',
                ...
                ka = 'LevelUpAnimation_particlesAnim_e9',
                xa = 'LevelUpAnimation_oldElement_08',
                ...
                Oa = ({ oldElement: e, newElement: t, delay: a = 0 }) => {
                    ...
                    return (
                        ...
                        l().createElement(
                            ...
                            l().createElement('div', { className: xa, ref: n }, e),
            ...
            const rn = (0, ie.Pi)(() => {
                ...
                kn = 'Error_caption_74',
                xn = R.strings.achievements_page.summary.disabled,
                Bn = (0, ie.Pi)(() => {
                    ...
                    return l().createElement(
                        ...
                        e
                            ? l().createElement('div', { className: kn }, xn.otherPlayer.caption())
                            : l().createElement(
                                  l().Fragment,
                                  null,
                                  l().createElement('div', { className: Mn }, xn.title()),
                                  l().createElement('div', { className: Tn }, xn.description()),
                              ),
                    );
                }),
                Dn = 'App_base_bb',
