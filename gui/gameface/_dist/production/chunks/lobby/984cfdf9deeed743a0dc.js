                ...
                U = (0, O.q3)()(
                    ({ observableModel: e }) => {
                        const t = {
                            ...
                            o = (0, M.Om)(() =>
                                I.sE(t.boxesInfo.get(), (e) => e.boxCategory === t.root.get().selectedBoxOption),
                            ),
                            a = (0, M.Om)(() => (0, $.jh)(D, t.root.get().eventName)),
                            n = (0, M.Om)(() => (0, $.kC)(R, t.root.get().eventName)),
                            ...
                            i = (0, M.Om)(() => I.U2(t.openingOptions.get(), t.root.get().selectedOpeningOption) || 1);
            ...
            const X = ({ layer: e, onLoaded: t, sound: o, onVideoEnded: s, playVideo: r, onVideoPlay: c }) => (
                ...
                me = (0, p.Pi)(({ onClick: e, className: t, onLoaded: o }) => {
                    const s = Y(),
                        ...
                        w = r.computes.sublayersNames(z.box),
                        N = r.computes.sublayersNames(z.hover),
                        ...
                        })(f.length + w.length + N.length + Number(A) * T.length, () => {
                            H(!0), o();
                        }),
                        ...
                        n().createElement(
                            ...
                            f.map((e) => {
                                ...
                                return n().createElement(W.z, {
                                    ...
                                    loop: !0,
                                    onLoaded: M,
                                    playVideo: I && a.type === Z.U.video && o,
                                });
                            }),
                            w.map((e) => {
                                const t = P(z.box, e),
            ...
            const we = 'Content_base_45',
                ...
                Se = (0, p.Pi)(({ openClick: e, className: t }) => {
                    const o = Y(),
                        ...
                        O = { glow: d.glowIcon, info: d.infoIcon, strongGlow: d.guaranteedGlowIcon },
                        H = () => {
                                    ...
                                    I.UI(B, (e, t) =>
                                        n().createElement(
                                            ke,
                                            {
                                                ...
                                                active: e === f,
                                                disabled: e > y,
                                                className: c()(Oe, t > 0 && He, e === f && Me, e <= y && Ie),
                                                onClick: () =>
                                                    ((e) => {
                ...
                Ue = (0, p.Pi)(() => {
                    ...
                    const t = Y(),
                        ...
                        r = (0, k.t)().model,
                        p = o.root.get(),
                        O = p.isAnimationActive,
                        I = p.isError,
                        H = p.eventName,
                        M = p.useStats,
                        S = p.selectedBoxOption,
                        G = p.isShopVisible,
                        V = r.overlayClosed.get(),
                        $ = r.computes.awardViewOpened(),
                        ...
                        ue = le[1],
                        de = () => {
                            o.isBoxHovered.get() && _.hY.sound(z.boxMouseLeave), J || s.close();
                        };
                    (0, m.I9)(de);
                    const _e = () => {
                            K(!0), s.setShowAdditionalLayers(!1), ce.start(A()), ue.start(A()), oe(Re);
                        },
                        be = () => {
                    ...
                    return (
                        ...
                        (0, a.useEffect)(() => {
                            I && (K(!1), oe(De), be(), s.resetError());
                        }, [I]),
                        (0, a.useEffect)(() => {
                            V && (oe(De), be(), s.setShowAdditionalLayers(!0));
                        }, [V]),
                        (0, a.useEffect)(() => {
                            $ && J && K(!1);
                        }, [$]),
                        ...
                        n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement(C.h, { title: U.boxCategory.dynOpt(S) }),
                            ),
                            n().createElement(
                                'div',
                                { className: Ge.footer },
                                ...
                                J && n().createElement(y.a, { className: Ge.loader, text: D.loader, img: R.loader }),
                            ),
