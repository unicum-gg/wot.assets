    ...
    [154],
    {
        7910: (e, t, a) => {
                ...
                O = (0, s.memo)(({ api: e, classNames: t = {}, getStepByRailClick: a = T, onDrag: n = B }) => {
                            ...
                            ((a.style.transform = `translateX(${0 | c}px)`),
                                ((e) => {
                                    if (i.current && d.current && f.current && p.current) {
                                        if (0 === e)
                                            return (i.current.classList.add(k), void d.current.classList.remove(k));
                                        if (
                                            ((t = f.current),
                                            (a = p.current),
                                            e - (t.offsetWidth - a.offsetWidth) >= -0.5)
                                        )
                                            return (i.current.classList.remove(k), void d.current.classList.add(k));
                                        var t, a;
                                        (i.current.classList.remove(k), d.current.classList.remove(k));
                                    }
                                })(c));
                        },
                        O = g(() => {
                    ...
                    return l().createElement(
                        ...
                        l().createElement('div', {
                            ...
                            onMouseDown: (e) => {
                                e.target.classList.contains(k) || 0 !== e.button || ((0, v.G)('play'), z(h.Next));
                            },
                            onMouseUp: $,
                            ref: i,
                            onMouseEnter: H,
                        ...
                        l().createElement('div', {
                            ...
                            onMouseDown: (e) => {
                                e.target.classList.contains(k) || 0 !== e.button || ((0, v.G)('play'), z(h.Prev));
                            },
                            onMouseUp: $,
                            ref: d,
                            onMouseEnter: H,
            ...
            const wt = 'DogTag_base_2b',
                ...
                kt = R.strings.settings.LANGUAGE_CODE(),
                    ...
                    return l().createElement(
                        ...
                        e
                            ...
                            : l().createElement(
                                  l().Fragment,
                                  null,
                                  l().createElement('div', { className: Mn }, Tn.title()),
                                  l().createElement('div', { className: kn }, Tn.description()),
                              ),
                    );
                }),
                Dn = 'App_base_bb',
