...
(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
    [935],
    {
        5621: (e, t, a) => {
            ...
            var s = {};
            (a.r(s), a.d(s, { Area: () => se, Bar: () => te, Default: () => ne, useVerticalScrollApi: () => W }));
            var r = a(7363),
                o = a.n(r),
                i = a(9849),
                l = a.n(i),
            ...
            const y = {
                    ...
                    return (l = {}) => {
                        const m = l.settings,
                            ...
                            N = (0, E.useSpring)(() => ({
                                ...
                                onChange: (e) => {
                                    const t = d.current;
                                    t && (a(t, e), v.trigger('change', e), o && b.current && h());
                                },
                            ...
                            k = (0, r.useCallback)(
                                (e, t, a) => {
                                    var n;
                                    const s = S.scrollPosition.get(),
                                        r = (null != (n = S.scrollPosition.goal) ? n : 0) - s;
                                    return i(e, t * a + r + s);
                                },
                                [S.scrollPosition],
                            ),
                            ...
                            R = (0, r.useCallback)(
                                (e) => {
                                    (0 !== e.deltaY && A(n(e)),
                                        d.current && v.trigger('mouseWheel', e, S.scrollPosition, t(d.current)));
                                },
                                [S.scrollPosition, A, v],
                            ),
                            P = ((e, t = []) => {
                                const a = (0, r.useRef)(),
                                    n = (0, r.useCallback)((...t) => {
                                ...
                                () =>
                                    (0, c.v)(() => {
                                        const e = d.current;
                                        e &&
                                            (I(i(e, S.scrollPosition.goal), { immediate: !0 }),
                                            v.trigger('resizeHandled'));
                                    }),
                                [I, S.scrollPosition.goal],
                            ),
                            w = _(() => {
                                const e = d.current;
                                if (!e) return;
                                const t = i(e, S.scrollPosition.goal);
                                (t !== S.scrollPosition.goal && I(t, { immediate: !0 }),
                        ...
                        return (0, r.useMemo)(
                            () => ({
                                getWrapperSize: () => (g.current ? s(g.current) : void 0),
                            ...
                            [S.scrollPosition, I, A, v.off, v.on, w, R, C, u.step.clampedArrowStepTimeout],
                        );
                    };
                },
                S = N({
                ...
                k = 'HorizontalBar_base__active_ad89b',
                I = 'HorizontalBar_leftButton_eb8c3',
                ...
                L = (0, r.memo)(({ api: e, classNames: t = {}, getStepByRailClick: a = D, onDrag: n = O }) => {
                    const s = (0, r.useRef)(null),
                        ...
                        S = (0, r.useCallback)(
                            (e) => {
                                (N(e), v.current && n({ type: e.pending ? 'dragStart' : 'dragEnd', thumb: v.current }));
                            },
                            [n],
                        ),
                        R = () => {
                            ...
                            ((a.style.transform = `translateX(${0 | c}px)`),
                                ((e) => {
                                    if (i.current && d.current && f.current && v.current) {
                                        if (0 === e)
                        ...
                        L = _(() => {
                            ((() => {
                                ...
                                ((t.style.width = `${B(a, o)}px`),
                                    ...
                                    s.current &&
                                        (1 !== o ? s.current.classList.add(k) : s.current.classList.remove(k)));
                            })(),
                                R());
                        });
                    ((0, r.useEffect)(() => (0, c.v)(L)),
                        (0, r.useEffect)(
                            () =>
                                (0, c.v)(() => {
                                    const t = () => {
                        ...
                        (0, r.useEffect)(() => {
                            ...
                            const t = u.O.client.events.mouse.move(([t, a]) => {
                                    ...
                                    const c = t.clientX - y.offset - i.getBoundingClientRect().x,
                                        m = (c / i.offsetWidth) * (null != (s = e.getContainerSize()) ? s : 0);
                    ...
                    const W = (e) => {
                        e.target.classList.contains(T) || (0, b.G)('highlight');
                    };
                    return o().createElement(
                        'div',
                        { className: l()(C, t.base), ref: s, onWheel: e.handleMouseWheel },
                        o().createElement('div', {
                            className: l()(I, t.leftButton),
                            onMouseDown: (e) => {
                                e.target.classList.contains(T) || 0 !== e.button || ((0, b.G)('play'), H(h.Next));
                            },
                            onMouseUp: $,
                            ref: i,
                            onMouseEnter: W,
                        ...
                        o().createElement(
                            ...
                            o().createElement('div', { ref: v, className: l()(w, t.thumb) }),
                            o().createElement('div', { className: l()(M, t.rail) }),
                        ),
                        o().createElement('div', {
                            className: l()(A, t.rightButton),
                            onMouseDown: (e) => {
                                e.target.classList.contains(T) || 0 !== e.button || ((0, b.G)('play'), H(h.Prev));
                            },
                            onMouseUp: $,
                            ref: d,
                            onMouseEnter: W,
                ...
                H = ({
                    ...
                    return o().createElement(
                        ...
                        o().createElement(
                            'div',
                            { className: l()(z.defaultScrollArea, s) },
            ...
            const W = N({
                ...
                te = (0, r.memo)(({ api: e, classNames: t = {}, getStepByRailClick: a = Z, onDrag: n = X }) => {
                    const s = (0, r.useRef)(null),
                        i = (0, r.useRef)(null),
                        d = (0, r.useRef)(null),
                        f = (0, r.useRef)(null),
                        ...
                        C = _(() => {
                            ...
                            return (
                                ...
                                (t.style.display = 'flex'),
                                s.current && (1 !== o ? s.current.classList.add(U) : s.current.classList.remove(U)),
                                o
                            );
                        }),
                        k = _(() => {
                            ...
                            const t = u.O.client.events.mouse.up(() => {
                                ...
                                a = u.O.client.events.mouse.move(([t]) => {
                                    Q(e, (a) => {
                                        ...
                                        if (!s || !r || !o) return;
                                        const i = t.screenY - y.offset - s.getBoundingClientRect().y,
                                        ...
                                        (e.scrollPosition.start({
                                            ...
                                            n({ type: 'dragging', thumb: r, thumbOffset: i, contentOffset: l }));
                                    });
                                });
                            return () => {
                                (t(), a());
                    ...
                    const A = g((t) => e.applyStepTo(t), p, [e]),
                        R = A[0],
                        P = A[1];
                    (0, r.useEffect)(
                        () => (
                    ...
                    return o().createElement(
                        'div',
                        { className: l()(V, t.base), ref: s, onWheel: e.handleMouseWheel },
                        o().createElement('div', {
                            className: l()(G, t.topButton),
                            onMouseDown: (e) => {
                                e.target.classList.contains(J) || 0 !== e.button || ((0, b.G)('play'), R(h.Next));
                            },
                            ref: i,
                            onMouseEnter: w,
                        }),
                        o().createElement(
                            ...
                            o().createElement('div', { ref: v, className: l()(Y, t.thumb) }),
                            o().createElement('div', { className: l()(q, t.rail) }),
                        ),
                        o().createElement('div', {
                            className: l()(j, t.bottomButton),
                            onMouseDown: (e) => {
                                e.target.classList.contains(J) || 0 !== e.button || ((0, b.G)('play'), R(h.Prev));
                            },
                            onMouseUp: P,
                            ref: d,
                            onMouseEnter: w,
                ...
                ne = ({
                    ...
                    return o().createElement(
                        ...
                        o().createElement(
                            'div',
                            { className: l()(ae.area, s) },
                            o().createElement(se, { className: i, classNames: c, api: _ }, e),
                        ),
                        o().createElement(te, { getStepByRailClick: m, api: t, onDrag: u, classNames: d }),
                    );
                },
                se = ({ className: e, classNames: t, children: a, api: n }) => (
                    (0, r.useEffect)(() => (0, c.v)(n.recalculateContent)),
                    o().createElement(
                        'div',
            ...
            se.Default = ne;
            const re = { Vertical: s, Horizontal: n },
                oe = {
            ...
            const ce = (e) => {
                ...
                return o().createElement(
                    ...
                    le(
                        {
                            className: l()(oe.base, oe[`base__${f}`], oe[`base__${g}`], null == s ? void 0 : s.base),
                            onMouseEnter: N,
                            onMouseLeave: S,
                            onMouseDown: C,
                            onMouseUp: k,
                    ...
                    'info' !== f && o().createElement('div', { className: oe.shine }),
                    o().createElement(
                        'div',
                        { className: l()(oe.icon, oe[`icon__${f}`], oe[`icon__${g}`], null == s ? void 0 : s.icon) },
                        o().createElement('div', { className: l()(oe.glow, null == s ? void 0 : s.glow) }),
                    ),
                    o().createElement(
                        'div',
                        { className: l()(oe.caption, oe[`caption__${f}`], null == s ? void 0 : s.caption) },
                        t,
                    ),
                    n && o().createElement('div', { className: l()(oe.goto, null == s ? void 0 : s.goto) }, n),
                );
            };
            var me = a(6758),
                ue = a(5037),
            ...
            const Ne = (0, fe.q3)()(
                    ({ observableModel: e }) => {
                        const t = Object.assign(
                            ...
                            o = (0, he.Om)(() => {
                                const e = t.root.get(),
                                    ...
                                    s = e.currentRatingSubRank,
                                    r = e.prevCurrentRatingSubRank,
                                    o = e.isWTREnabled,
                                    i = e.isOtherPlayer,
                                    l = e.battlesLeftCount;
                                if (!o || i || l > 0) return ye.Static;
                                if (a === n) {
                                    if (s > r) return ye.LevelUp;
                                    if (s < r) return ye.Downgrade;
                                }
                        ...
                        return Object.assign({}, t, {
                            computes: {
                                getStatisticList: s,
                                getSignificantAchievementsList: r,
                    ...
                    ({ externalModel: e, model: t }) => {
                        const a = e.createCallback((e) => ({ isInCustomizationMode: e }), 'onSetIsInCustomizationMode'),
                            ...
                            s = e.createCallback((e) => ({ ribbonDraftSlug: e }), 'onSetRibbonDraft'),
                            r = e.createCallback(() => {
                                var e, n;
                                return (
                                    a(!0),
                        ...
                        return {
                            ...
                            setBackgroundDraft: (0, Ee.aD)((e) => n(e.slug)),
                            setRibbon: (0, Ee.aD)((e) => t.ribbon.set(e)),
                            setRibbonDraft: (0, Ee.aD)((e) => s(e.slug)),
                            setIsInCustomizationMode: (0, Ee.aD)((e) => {
                                (a(e), e && (n(t.background.get().slug), s(t.ribbon.get().slug)));
                            }),
            ...
            var ke = a(8925),
                Ie = a(1672);
            const Ae = 'AchievementTooltip_base_a134e',
                Re = ({ children: e, name: t, block: a, isEnabled: n = !0 }) =>
                    o().createElement(
                        Ie.l,
                        { tooltipArgs: { args: { name: t, block: a }, isEnabled: n }, className: Ae },
                        e,
                    );
            let Pe = (function (e) {
                    return (
            ...
            const Le = ({ value: e, type: t = we.Simple, size: a = Be.Medium, className: n }) =>
                    o().createElement(
                        ...
                        o().createElement(
                            ...
                            o().createElement(
                                ...
                                t === we.Stages
                                    ? (0, De.HG)(e)
                                    : o().createElement(xe.A, { value: e, format: 'integral' }),
                            ),
                            t === we.Series &&
                                o().createElement(
                                    o().Fragment,
                ...
                He =
                    ...
                    ({ name: e, resourceName: t, type: a, rareIconId: n, rareBigIconId: s, value: r, size: o }) => {
                        if (n && s) return o === Me.ExtraSmall ? n : s;
                        ...
                        (0, r.useEffect)(() => {
                            if (g) {
                                if ((v(g), n === Pe.Rare)) {
                                    const e = new Image();
                                    ((e.onerror = () => {
                                        v(R.images.gui.maps.icons.achievement.noImage());
                                    }),
                                        (e.src = g.toString()));
                                }
                            } else v(R.images.gui.maps.icons.achievement.noImage());
                        }, [n, g]),
                        o().createElement(
                            Re,
                            ...
                            o().createElement(
                                'div',
                                { className: l()(Te.base, Te[`base__${i}`], _) },
                                o().createElement(
                                    'div',
                                    { className: Te.image, style: { backgroundImage: `url(${f})` } },
                                    s !== we.None &&
                                        o().createElement(Le, {
                                            type: s,
                                            size: $e[i],
            ...
            const Ge = {
                ...
                Fe = {
                    [ke.cJ.ExtraSmall]: Me.Small,
                    [ke.cJ.Small]: Me.Small,
                    [ke.cJ.Medium]: Me.Large,
                    [ke.cJ.Large]: Me.Large,
                    [ke.cJ.ExtraLarge]: Me.ExtraLarge,
                };
            let Ye = (function (e) {
                return (
                    (e[(e.LEFT = 0)] = 'LEFT'),
            ...
            const et = {
                ...
                st = 'ValueSelector_label_b6fe4',
                rt = ({ className: e, value: t, options: a, onChange: n }) =>
                    o().createElement(
                        'div',
                        { className: l()(tt, e) },
                        o().createElement('div', {
                        ...
                        o().createElement('div', { className: st }, t),
                    ),
                ot = (0, de.Pi)(({ className: e }) => {
                    ...
                    const i = Ce(),
                        ...
                        f = c.background.get(),
                        v = c.computes.getBackgroundOptions(),
                        p = (null == b ? void 0 : b.slug) === f.slug && (null == d ? void 0 : d.slug) === _.slug,
                        E = (0, _e.t)().controls;
                                ...
                                o().createElement(rt, {
                                    ...
                                    value:
                                        ...
                                        (t =
                                            null !=
                                            (a =
                                                null == (n = v.find((e) => e.image === (null == b ? void 0 : b.image)))
                                                    ? void 0
                                                    : n.label)
                                                ? a
                                                : null == (s = v[0])
                ...
                ft = 'Achievements_item__fixedIndent_c29d5',
                vt = 'Achievements_achievement_af389',
                pt = 'Achievements_achievementPlaceholder_a1395',
                Et = 'Achievements_customization_c621e';
            var ht = a(5603);
            const yt = 'AchievementsStatistic_base_ee30f',
                Nt = 'AchievementsStatistic_counter_d8a56',
                St = 'AchievementsStatistic_base__otherPlayer_fcc68',
                Ct = 'AchievementsStatistic_infoItem_cc388',
                kt = 'AchievementsStatistic_accent_a060c',
                It = 'AchievementsStatistic_medalIcon_b837e',
                At = 'AchievementsStatistic_medalIcon__received_f2be9',
                Rt = R.strings.achievements_page.summary.achievements,
                Pt = ({ isOtherPlayer: e, unique: t, total: a }) =>
                    o().createElement(
                        'div',
                        { className: l()(yt, e && St) },
                        o().createElement('div', { className: l()(It, a && At) }),
                        o().createElement(
                            'div',
                            { className: Nt },
            ...
            var wt = a(6485);
            const Mt = 'Mastery_base_fdc0c',
                Tt = 'Mastery_masteryIcon_a0075',
                xt = 'Mastery_masteryIcon__recieved_ab603',
                Dt = ({ totalMastery: e, currentMastery: t }) =>
                    o().createElement(
                        ...
                        o().createElement(
                            'div',
                            { className: Mt },
                            o().createElement('div', { className: l()(Tt, t && xt) }),
                            o().createElement(ht.z, {
                                text: R.strings.achievements_page.summary.achievements.mastery.counter(),
                                binding: {
                                    current: o().createElement(xe.A, { value: t }),
                                    total: o().createElement(xe.A, { value: e }),
                                },
                            }),
                        ),
                    ),
                ...
                Lt = (0, de.Pi)(() => {
                    ...
                    return o().createElement(
                        'div',
                        { className: l()(Ot.base, Ot[`base__${s}`], c && Ot.base__otherPlayer) },
                                ...
                                o().createElement(
                                    ...
                                    o().createElement(
                                        Ve.u,
                                        {
                                            contentId: R.views.lobby.achievements.tooltips.EditingTooltip('resId'),
                                            args: Bt(s),
                                            isEnabled: !g && s !== be.AVAILABLE,
                                        },
                                        o().createElement(
                                            'div',
                                            { id: g || s !== be.AVAILABLE ? void 0 : 'summary-customization-button' },
                                            o().createElement(
                                                Ke,
                                                {
                                                    type: Je.ghost,
                                                    size: Xe.medium,
                                                    disabled: s !== be.AVAILABLE || g,
                        ...
                        o().createElement(Pt, { total: i, unique: r, isOtherPlayer: c }),
                    );
                });
            function zt() {
                return (
                                ...
                                pe.UI(t.getSignificantAchievementsList(), (e, t) =>
                                    o().createElement(
                                        'div',
                                        {
                                            className: l()(bt, r && ft),
                                            key: t,
                                            style: g && !r ? { animationDelay: 150 * (t + 1) + 'ms' } : void 0,
                                            onAnimationStart: Ht,
                                        },
                                        (() => {
                                            const t = !g && !r;
                                                    ...
                                                    ? (d++,
                                                      o().createElement(
                                                          ...
                                                          o().createElement(
                                                              ...
                                                              o().createElement(je, { size: _, isOtherPlayer: r }),
                                                          ),
                                                      ))
                                                    : o().createElement(We, zt({}, e, { size: _ }))
                                                : o().createElement(je, { size: _, isOtherPlayer: r });
            ...
            const Qt = ({ background: e, engraving: t, size: a = Zt.Big, grade: n = 0, className: s }) => {
                    const r = Kt.includes(Xt) ? `_${Xt}` : '';
                    return o().createElement(
                        'div',
                        { className: l()(Yt, s) },
                        o().createElement('div', {
                        ...
                        o().createElement('div', {
                            className: qt,
                            style: {
                                backgroundImage: `url(R.images.gui.maps.icons.dogtags.${a}.engravings.engraving_${t}_${n}${r})`,
                            },
                        }),
                    );
                },
            ...
            const sa = ({ engraving: e, count: t, size: a }) => {
            ...
            const ia = { duration: 500, easing: ta.Z.easeOutBack },
                ...
                ua = ({
                    ...
                    const w = () => {
                        f.current && (f.current.goToAndPlay(5), (0, b.G)(R.sounds.ach_dog_tag_idle()));
                    };
                    return o().createElement(
                        E.animated.div,
                        ...
                        u &&
                            o().createElement(
                                E.animated.div,
                                { className: ea.backplateBox, style: I },
                                o().createElement(
                                    'div',
                                    {
                                    ...
                                    o().createElement(sa, { engraving: t, count: a, size: la[d] }),
                                ),
                            ),
                ...
                ya = (0, de.Pi)(() => {
                    ...
                    return o().createElement(
                        ...
                        o().createElement(
                            'div',
                            { className: ga },
                            s && o().createElement('div', { className: ba, style: { backgroundImage: `url(${s})` } }),
                            o().createElement(da.l, { content: r }),
                        ),
                        o().createElement(
                            'div',
                            null,
                            o().createElement(
                                'div',
                                { className: fa },
                                o().createElement('div', { className: va }, ha.post()),
                                o().createElement('div', null, i),
                            ),
                            o().createElement(
                                'div',
                                { className: fa },
                                o().createElement('div', { className: va }, ha.date()),
            ...
            const Ra = (0, r.memo)(function (e) {
                    ...
                    return (
                                            ...
                                            s = window.setInterval(() => {
                                                ...
                                                r
                                                    ? (null == i || i(n, r),
                                                      ...
                                                      n === g &&
                                                          (null == h || h(),
                                                          f || (null == E || E(), window.clearInterval(s))))
                        ...
                        }, [m, n, d, g, f, i, h, E, y, p, k]),
                        o().createElement('canvas', Aa({}, N, { width: t, height: a, ref: S }))
                    );
                }),
                Pa = (e, t) => {
                    let a = e;
                ...
                Ta = 'DogTag_base_b72a4',
                xa = 'DogTag_glow_d1b7d',
            ...
            const Ha = (function (e) {
                    ...
                    return (n) => {
                        const s = n % a,
                            r = (s % t.columns) * e.width,
                            o = Math.trunc(s / t.columns) * e.height;
                        return { path: e.getChunkPath(Math.trunc(n / a)), x: r, y: o };
                    };
                })(La),
                $a = (0, de.Pi)(() => {
                                        ...
                                        return o().createElement(
                                            Ie.l,
                                            {
                                                tooltipArgs: {
                                                    ...
                                                    args: { backgroundId: s, engravingId: r },
                                                },
            ...
            const Fa = 'DowngradeAnimation_base_cbede',
                ...
                Ja = ({ oldElement: e, newElement: t, delay: a = 0 }) => (
                    (0, r.useEffect)(() => (0, ja.F)(() => (0, b.G)(R.sounds.achievements_leveldown()), a), [a]),
                    o().createElement(
                        'div',
                        { className: Fa },
                        o().createElement(
                        ...
                        u = (0, E.useSpring)(() => ({
                            ...
                            onChange: (e) => {
                                ...
                                ((n.current.style.maskImage = `linear-gradient(55deg, transparent ${t}%, #000 ${t}%)`),
                                    (s.current.style.maskImage = `linear-gradient(55deg, #000 ${t}%, transparent ${t}%)`));
                            },
                        }))[1];
                    return (
                        (0, r.useEffect)(
                        ...
                        o().createElement(
                            ...
                            o().createElement('div', { className: Qa, ref: s }, t),
                        )
                    );
                },
                    ...
                    t
                        ...
                        : e >= ke.cJ.Large
                          ...
                          : e >= ke.cJ.Medium
                            ...
                            : nn.c_180x180,
                rn = (e, t, a, n = !0, s = !1) => ({
                    backgroundImage: n ? `url(${sn(a, s).$dyn(`rating_${e}_${t}`)})` : `url(${sn(a, s).wotpr()})`,
                }),
                on = (0, de.Pi)(() => {
                    const e = Ce().model,
                        t = e.root.get(),
                        ...
                        o().createElement(
                            ...
                            (() => {
                                switch (b) {
                                    ...
                                    case ye.Static:
                                        return o().createElement('div', { className: an, style: rn(p, E, _, l, u) });
                                    default:
                                        return null;
                                }
                            })(),
            ...
            const mn = (0, de.Pi)(() => {
                    ...
                    return (
                        ...
                        o().createElement(
                            'div',
                            { className: l()(ln.base, ln[`base__${m}`], !s && ln.base__wotpr) },
                            d
                                ? o().createElement(
                                      o().Fragment,
                                      null,
                ...
                fn = 'RatingWidget_particles_b5ff1',
                vn = 'RatingWidget_footer_ade68',
            ...
            const Sn = (0, de.Pi)(() => {
                    ...
                    return o().createElement(
                        ...
                        (() => {
                            switch (
                                    ...
                                    n
                                        ...
                                        : a
                                          ? e === t
                                              ? Nn.Initial
                                              : Nn.Progress
                                          : Nn.WTRDisabled)(t, a, n, s)
                            ) {
                                case Nn.Initial:
                                    return o().createElement(ht.z, {
                                        classMix: En,
                                        text: yn.initial(),
                                ...
                                case Nn.WTRDisabled:
                                    return o().createElement(ht.z, { classMix: En, text: yn.withoutWTR() });
                                case Nn.OtherPlayer:
                                    return o().createElement(ht.z, { classMix: En, text: yn.otherPlayer() });
                    ...
                    return o().createElement(
                        ...
                        o().createElement(
                            ...
                            o().createElement(
                                'div',
                                { className: dn },
                                o().createElement('div', { className: l()(_n, s && gn) }),
                                r &&
                                    o().createElement(
                                        'div',
                            ...
                            o().createElement(
                                'div',
                                { className: vn },
                                r ? o().createElement(mn, null) : o().createElement(Sn, null),
                            ),
                        ),
                    );
                }),
                kn = 'Statistic_base_abfff',
                In = 'Statistic_list_eb395',
                An = 'Statistic_part_b7f5a',
                Rn = 'Statistic_item_d6631',
                Pn = 'Statistic_ratingWidget_cfd9c',
                wn = 'StatisticItem_base_fa91e',
                Mn = 'StatisticItem_icon_be918',
                Tn = 'StatisticItem_amount_f5250',
                xn = 'StatisticItem_title_d3109',
                ...
                Hn = (0, r.memo)(({ type: e, mainValue: t, additionalValue: a, isOtherPlayer: n }) => {
                    const s = (0, ke.GS)().mediaSize;
                    return o().createElement(
                        Ve.u,
                        ...
                        o().createElement(
                            'div',
                            { className: wn },
                            o().createElement('div', { className: Mn, style: zn(e, s, n) }),
                            o().createElement('div', { className: Tn }, t),
                            o().createElement('div', { className: xn }, Ln.main.$dyn(e)),
                            o().createElement(
                                'div',
                                { className: On },
                                o().createElement(ht.z, {
                    ...
                    return o().createElement(
                        ...
                        o().createElement(
                            ...
                            o().createElement(
                                'div',
                                { className: An },
                                n.map(({ type: t, mainValue: a, additionalValue: n }, s) =>
                                    o().createElement(
                                        'div',
                                        { className: Rn, key: s },
                                        o().createElement(Hn, {
                            ...
                            o().createElement(
                                'div',
                                { className: An },
                                s.map(({ type: t, mainValue: a, additionalValue: n }, s) =>
                                    o().createElement(
                                        'div',
                                        { className: Rn, key: s },
                                        o().createElement(Hn, {
                ...
                ts = 'App_base_e6991',
                as = 'App_base__withScroll_b9a37',
                ns = 'App_close_f14db',
                ss = 'App_summary_cb69c',
                rs = 'App_scroll_c8db0',
                os = 'App_scrollContent_f8948',
                is = 'App_bar_d0f1e',
                ls = 'App_content_bcfdd',
                cs = 'App_footer_c858e',
                ms = 'App_footer__externalPaddings_a58d9',
                us = 'App_base__customizationMode_b778f',
                ds = 'App_errorWrapper_cf241',
                _s = 'App_error_bb53c',
                gs = 'App_customizationModeOverlay_ae45c',
                bs = R.strings.achievements_page.summary.accountInfo,
                fs = (e) => (e < 0.5 ? 4 * e * e * e : 1 - Math.pow(-2 * e + 2, 3) / 2),
                vs = (0, de.Pi)(() => {
                    const e = Ce().model,
                        t = e.root.get(),
                        ...
                        b = (0, E.useSpring)({
                            from: { opacity: 0 },
                            to: { opacity: 1 },
                            config: { duration: 200, easing: fs },
                        }),
                        f = (0, me.uF)(bs.registrationDate(), { registrationDate: a }),
                        v = (0, me.uF)(bs.lastVisit(), { lastVisitDate: n, lastVisitTime: s }),
                        p = (0, _e.t)().controls,
                        h = { '--external-paddings-bottom': `${d.bottom}rem` },
                        y = m ? { backgroundImage: `url(${m.image})` } : {};
                    return o().createElement(
                        E.animated.div,
                        { className: l()(ts, i && r && as, c && us), style: Object.assign({}, b, h, y) },
                        c &&
                            o().createElement(
                                'div',
                                { className: ns },
                        ...
                        o().createElement('div', { className: gs }),
                        r
                            ? o().createElement(
                                  'div',
                                  { className: ss },
                                  i
                                      ? o().createElement(
                                            ...
                                            o().createElement(
                                                re.Vertical.Area,
                                                { api: g, className: rs, classNames: { content: os } },
                                                o().createElement(
                                                    'div',
                                                    { className: ls },
                                            ...
                                            o().createElement(re.Vertical.Bar, { api: g, classNames: { base: is } }),
                                        )
                                      : o().createElement(Yn, null),
                                  o().createElement(
                                      'div',
                                      { className: l()(cs, _ && ms) },
                                      `${(0, ge.PI)(f)}${n && s ? (0, ge.PI)(v) : ''}`,
                                  ),
                              )
                            : o().createElement(
                                  'div',
                                  { className: ds },
                                  o().createElement('div', { className: _s }, o().createElement(es, null)),
                              ),
                    );
                }),
                ps = () =>
                    o().createElement(Se, { options: { context: 'model.summaryModel' } }, o().createElement(vs, null));
        },
    },
]);
