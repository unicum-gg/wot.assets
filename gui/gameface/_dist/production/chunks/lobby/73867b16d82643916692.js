    ...
    [596],
    {
            ...
            const u = (e, t, n = {}, s = 0) => {
                ...
                c = (e) => {
                    ...
                    const B = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                        S = (0, r.useMemo)(() => T || (0, s.F)().resId, [T]),
                        R = (0, r.useCallback)(() => {
                            (B.current.isVisible && B.current.timeoutId) ||
                                (u(n, b, { isMouseEvent: !0, on: !0, arguments: i(o) }, S),
                                P && P(),
        ...
        7366: (e, t, n) => {
            ...
            const r = 'default',
                ...
                u = ({ type: e, filePath: t, eventName: n }, s = !1) => {
                    const r = ((e, t, n) => {
                        ...
                        c = r.path,
                        l = r.defaultPath;
                    return u ? { eventResource: s ? a(u, c) : i(u, c), defaultResource: s ? a(u, l) : i(u, l) } : null;
                },
                c = ({ type: e, filePath: t, eventName: n }) => {
                    const s = u({ type: e, filePath: t, eventName: n });
                        ...
                        return o
                            ? ((n[s] = ((e, t, n) =>
                                  Object.keys(e).reduce(
                                      (s, o) => ((s[o] = c({ type: t, filePath: e[o], eventName: n })), s),
                                      {},
                                  ))(o, s, t)),
                              n)
                            : n;
                    }, {}),
                d = (e, t, n) => (e || t ? e || t : (console.warn(`Not found ${n}`), '')),
                m = (e, t, n) =>
                        ...
                        return (
                            (s[o] = ((e, t, n) => {
                                const s = `resource type: ${e}, path: ${t}`,
                                    o = u({ type: e, filePath: t, eventName: n }, !0);
                                return ((e, t, n) => ({
                                    dynOpt: (s, o = r) => {
                                        const a = (null == t ? void 0 : t.$dyn(s)) || (null == t ? void 0 : t.$dyn(o)),
                                            i = null == e ? void 0 : e.$dyn(o);
                                        return d(a, i, n);
                                    },
                                    dyn: (s) => {
