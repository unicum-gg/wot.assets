    ...
    [596],
    {
                        ...
                        'div',
                        {
                            ...
                            onMouseDown: function (e) {
                                n ||
                                    (null !== h && (0, r.G)(h),
                                    m && m(e),
                                    f && (n || (E.current && (E.current.focus(), P(!0)))),
                                    B(!0));
                            },
        ...
        8089: (e, t, n) => {
            ...
            const d = (e) => {
                ...
                const R = (0, a.useCallback)(
                        (e) => {
                            (null == m || m(e), r.O.sound.play.sound(y));
                        },
                        [m, y],
                    ),
                    w = (0, a.useCallback)(
                    ...
                    B = (0, a.useCallback)(
                        (e) => {
                            (null == p || p(e), r.O.sound.play.sound(P));
                        },
                        [p, P],
                    ),
                    S = (0, a.useCallback)(
                ...
                return i().createElement(
                    ...
                    l(
                        {
                            className: o()(u.Z.base, u.Z[`base__${h}`], u.Z[`base__${b}`], null == d ? void 0 : d.base),
                            onMouseEnter: R,
                            onMouseLeave: w,
                            onMouseDown: B,
                            onMouseUp: S,
                    ...
                    i().createElement(
                        'div',
                        { className: o()(u.Z.icon, u.Z[`icon__${h}`], u.Z[`icon__${b}`], null == d ? void 0 : d.icon) },
                        i().createElement('div', { className: o()(u.Z.glow, null == d ? void 0 : d.glow) }),
                    ),
                    i().createElement(
                        'div',
                        { className: o()(u.Z.caption, u.Z[`caption__${h}`], null == d ? void 0 : d.caption) },
                        t,
                    ),
                    s && i().createElement('div', { className: o()(u.Z.goto, null == d ? void 0 : d.goto) }, s),
                );
            };
        },
        2056: (e, t, n) => {
                    ...
                    const w = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                        ...
                        S = (0, r.useCallback)(() => {
                            (w.current.isVisible && w.current.timeoutId) ||
                                (u(n, v, { isMouseEvent: !0, on: !0, arguments: i(o) }, B),
                                P && P(),
        ...
        7412: (e, t, n) => {
            ...
            const _ = (0, u.forwardRef)(function (e, t) {
                    ...
                    return (
                        ...
                        c().createElement(
                            'video',
                            m({ src: n, className: _, style: f, loop: v, ref: k, onClick: y }, T),
                        )
                    );
                }),
                p = (0, u.memo)(_);
        ...
        7366: (e, t, n) => {
            ...
            const r = (e, t) => {
                ...
                a = ({ type: e, filePath: t, eventName: n }, a = !1) => {
                    const i = ((e, t, n) => {
                        ...
                        l = i.defaultPath;
                    return u
                        ? { eventResource: a ? r(u, c) : (0, s.R)(u, c), defaultResource: a ? r(u, l) : (0, s.R)(u, l) }
                        : null;
                },
                i = ({ type: e, filePath: t, eventName: n }) => {
                    const s = a({ type: e, filePath: t, eventName: n });
                        ...
                        return o
                            ? ((n[s] = ((e, t, n) =>
                                  Object.keys(e).reduce(
                                      (s, o) => ((s[o] = i({ type: t, filePath: e[o], eventName: n })), s),
                                      {},
                                  ))(o, s, t)),
                              n)
                            : n;
                    }, {}),
                c = (e, t, n) => (e || t ? e || t : (console.warn(`Not found ${n}`), '')),
                l = (e, t, n) =>
                        ...
                        return (
                            (s[o] = ((e, t, n) => {
                                const s = `resource type: ${e}, path: ${t}`,
                                    o = a({ type: e, filePath: t, eventName: n }, !0);
                                return ((e, t, n) => ({
                                    dynOpt: (s, o = 'default') => {
