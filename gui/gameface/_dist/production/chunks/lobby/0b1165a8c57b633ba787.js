        ...
        7745: (e, a, t) => {
            ...
            const U = R.images.gui.maps.icons.advanced_achievements,
                ...
                J = ({
                    ...
                    switch (a) {
                        ...
                        default:
                            return (console.warn(`Unreachable code for type '${a}' in AchievementResolver.`), null);
                    }
                },
                ...
                ie = ({ vignetteConfig: e = te }) =>
                    r().createElement(
                        'div',
                        { className: K },
                        r().createElement('div', { className: o()(Q, Y), style: { backgroundSize: `100% ${e.top}%` } }),
                        r().createElement('div', {
                            className: o()(Q, Z),
            ...
            const be = (0, ce.q3)()(
                    ({ observableModel: e }) => {
                        const a = {
                            ...
                            t = (0, _e.Om)(() => de.v(a.upcomingAchievements.get(), (e) => Object.assign({}, e)), {
                                equals: me.jv,
                            }),
                            n = (0, _e.Om)(
                                (e) => {
                            ...
                            o = (0, _e.Om)(() => {
                                var e;
                                return null !=
                                    (e = (0, de.kd)(r(), ({ achievementScore: e, prevAchievementScore: a }) => e !== a))
                                    ? e
                                    : 0;
                            });
                ...
                Ce = (0, p.Pi)(({ className: e }) => {
                    const a = he(),
                        ...
                        y = (0, ye.useSpring)(() => ({
                            ...
                            onRest: () => {
                                (p(!1), s.setAnimationState(ue.Init), s.animationInProgress(!1), s.allAnimationEnd());
                            },
                        }))[1];
                    return (
                        (0, n.useEffect)(() => {
                ...
                Ie = (0, p.Pi)(({ className: e }) => {
                    ...
                    return (
                        ...
                        r().createElement(
                            ...
                            r().createElement('div', { className: o()($e, Pe) }, R.strings.common.common.percent()),
                        )
                    );
                }),
                Re = {
            ...
            const da = (0, n.forwardRef)(function (e, a) {
                ...
                const b = (0, n.useRef)(null),
                    ...
                    k = (0, n.useCallback)(() => (p.current ? p.current.getBoundingClientRect().height : 0), []),
                    $ = (0, n.useCallback)(
                        (e) => {
                            const a = k();
                ...
                return (
                    ...
                    (O = [I]),
                    (0, n.useEffect)(
                        () => (window.addEventListener('resize', z), () => window.removeEventListener('resize', z)),
                        O,
                    ),
                    (0, n.useEffect)(() => {
                        null == c || c(v);
            ...
            const ya = ({ size: e = va.Default }) => {
                ...
                Sa = { base: 'ProgressBarBlink_base_d7125', base__small: 'ProgressBarBlink_base__small_b92f8' },
                Ea = ({ size: e }) => {
                ...
                wa = (0, n.memo)(
                    ({ size: e, lineRef: a, disabled: t, baseStyles: n, isComplete: s, withoutBounce: i }) => {
                        const l = o()(
                                xa.base,
                                xa[`base__${e}`],
                                t && xa.base__disabled,
                ...
                Da = (0, n.memo)(
                    ({
                        ...
                        return r().createElement(
                            r().Fragment,
                            null,
                            r().createElement(wa, { size: a, lineRef: s, disabled: o, isComplete: i, baseStyles: d }),
                            t >= 0 &&
                                r().createElement(La, {
                                    transitionDuration: l.delta.duration,
                                    transitionDelay: l.delta.delay,
            ...
            const ja = (0, n.memo)((e) => {
                ...
                qa = ({ size: e, value: a, lineRef: t, disabled: s, onComplete: o }) => {
                    ...
                    return (
                        ...
                        r().createElement(wa, { size: e, disabled: s, baseStyles: i, isComplete: l, lineRef: t })
                    );
                },
                Va = ['onEndAnimation'];
            function Ua() {
            ...
            Object.assign({}, Ka, {
                ...
                line: Object.assign({}, Ka.line, { bgColorBase: '#83C6A5', bgColorFinished: 'rgba(10, 230, 72, 0.6)' }),
            ...
            const Za = {
                ...
                mt = (0, p.Pi)(({ index: e, size: a, className: t }) => {
                    const n = he(),
                        ...
                        N = x
                            ...
                            : (0, u.uF)((0, u.z4)(ct.description.$plural(m, d)), { maxValue: d, level: (0, pa.HG)(w) }),
                        A = (0, le.Ai)(m);
                    return r().createElement(
                        'div',
                        {
                ...
                xt = (0, p.Pi)(({ className: e }) => {
                    ...
                    return r().createElement(
                        ...
                        Boolean(n()) &&
                            r().createElement('div', { className: o()(Et, t && St) }, r().createElement(ht, null)),
                    );
                }),
                ...
                kt = ({ oldElement: e, newElement: a, isStart: t, index: s, onAnimationEnd: o, onPlaySound: i }) => {
                    ...
                    return (
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement('div', { className: o()(It, Rt) }, R.strings.common.common.percent()),
                            ),
                            r().createElement(
                                'div',
                                { className: zt },
