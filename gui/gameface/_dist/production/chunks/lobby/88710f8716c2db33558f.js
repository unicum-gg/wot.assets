        ...
        9390: (e, t, a) => {
            ...
            const dt = (0, n.forwardRef)(function (e, t) {
                ...
                const _ = (0, n.useRef)(null),
                    ...
                    N = (0, n.useMemo)(() => document.createElement('canvas'), []),
                    w = (0, n.useCallback)(() => (d.current ? d.current.getBoundingClientRect().height : 0), []),
                    A = (0, n.useCallback)(
                        (e) => {
                            const t = w();
                    ...
                    C = (0, n.useCallback)(() => {
                        ...
                        const e = a.split(' '),
                            t = Array.from(new Array(s)).reduce((t, a, n) => {
                                ...
                                const i = rt({ start: 0, end: o.length, words: o, element: _.current, canvas: N });
                ...
                return (
                    ...
                    r().createElement(
                        'div',
                        ut({}, m, { ref: t, className: o()(st, i, p && ot) }),
                        r().createElement('div', { ref: _, className: it, style: { maxHeight: `${S}rem` } }, a),
                        r().createElement(
                            'div',
                            { className: lt },
                            v.map((e, t) =>
                        ...
                        r().createElement('div', { ref: d, className: ct }, R.strings.common.common.dot()),
                    )
                );
            });
            function gt() {
