        ...
        7910: (e, t, a) => {
            ...
            const y = {
                    ...
                    return (o = {}) => {
                        const m = o.settings,
                            ...
                            N = (0, E.useSpring)(() => ({
                                ...
                                onChange: (e) => {
                                    const t = d.current;
                                    t && (a(t, e), p.trigger('change', e), l && v.current && h());
                                },
                            ...
                            P = (0, s.useCallback)(
                                ...
                                [A, u.animationConfig, S.scrollPosition],
                            ),
                            R = (0, s.useCallback)(
                                (e) => {
                                    const t = d.current,
                            ...
                            I = (0, s.useCallback)(
                                (e) => {
                                    (0 !== e.deltaY && R(n(e)),
                                        d.current && p.trigger('mouseWheel', e, S.scrollPosition, t(d.current)));
                                },
                        ...
                        return (0, s.useMemo)(
                            ...
                            [S.scrollPosition, P, R, p.off, p.on, L, I, A, u.step.clampedArrowStepTimeout],
                        );
                    };
                },
                S = N({
                ...
                O = (0, s.memo)(({ api: e, classNames: t = {}, getStepByRailClick: a = k, onDrag: n = B }) => {
                            ...
                            ((a.style.transform = `translateX(${0 | c}px)`),
                                ((e) => {
                                    if (i.current && d.current && f.current && p.current) {
                                        if (0 === e)
                                            return (i.current.classList.add(T), void d.current.classList.remove(T));
                                        if (
                                            ((t = f.current),
                                            (a = p.current),
                                            e - (t.offsetWidth - a.offsetWidth) >= -0.5)
                                        )
                                            return (i.current.classList.remove(T), void d.current.classList.add(T));
                                        var t, a;
                                        (i.current.classList.remove(T), d.current.classList.remove(T));
                                    }
                                })(c));
                        },
                        O = g(() => {
                            ((() => {
                                ...
                                ((t.style.width = `${D(a, l)}px`),
                                    ...
                                    r.current &&
                                        (1 === l ? r.current.classList.add(C) : r.current.classList.remove(C)));
                            })(),
                                R());
                        });
                    ...
                    const H = (e) => {
                        e.target.classList.contains(T) || (0, v.G)('highlight');
                    };
                    return l().createElement(
                        ...
                        l().createElement('div', {
                            ...
                            onMouseDown: (e) => {
                                e.target.classList.contains(T) || 0 !== e.button || ((0, v.G)('play'), z(h.Next));
                            },
                            onMouseUp: $,
                            ref: i,
                            onMouseEnter: H,
                        ...
                        l().createElement('div', {
                            ...
                            onMouseDown: (e) => {
                                e.target.classList.contains(T) || 0 !== e.button || ((0, v.G)('play'), z(h.Prev));
                            },
                            onMouseUp: $,
                            ref: d,
                            onMouseEnter: H,
                    ...
                    return l().createElement(
                        ...
                        l().createElement(
                            ...
                            l().createElement(
                                ...
                                r !== Se.None &&
                                    l().createElement(Le, { type: r, size: xe[s], value: i, className: Ce.counter }),
                            ),
                        ),
                    );
                };
            ...
            const rn = (0, ie.Pi)(() => {
                ...
                Bn = (0, ie.Pi)(() => {
                    ...
                    return l().createElement(
                        ...
                        e
                            ? l().createElement('div', { className: xn }, kn.otherPlayer.caption())
                            : l().createElement(
                                  l().Fragment,
                                  null,
                                  l().createElement('div', { className: Mn }, kn.title()),
                                  l().createElement('div', { className: Tn }, kn.description()),
                              ),
                    );
                }),
                Dn = 'App_base_bb',
