    ...
    [312],
    {
        8312: (u, e, t) => {
            ...
            const f = {
                    ...
                    return (l = {}) => {
                        const c = l.settings,
                            ...
                            P = A(() => {
                                ...
                                (e !== p.scrollPosition.goal && y(e, { immediate: !0 }),
                        ...
                        const I = (0, r.useCallback)((u) => C.trigger('isThumbDraggingChanged', u), [C]);
                        return (0, r.useMemo)(
                            () => ({
                                ...
                                handleIsThumbDragging: I,
                                events: { on: C.on, off: C.off },
                            }),
                            [p.scrollPosition, y, w, I, C.off, C.on, P, N, h, E.step.clampedArrowStepTimeout],
                        );
                    };
                },
                p = v({
                ...
                M = (0, r.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = T, onDrag: n = x }) => {
                ...
                W = ({ api: u, className: e, classNames: t, children: n, style: a }) => (
                    (0, r.useEffect)(() => i(u.recalculateContent)),
                    s().createElement(
                        'div',
                        { className: l()(O.base, e), style: a },
                        s().createElement(
                            'div',
                            {
                    ...
                    ((0, r.useEffect)(() => i(b)),
                        ...
                        (0, r.useEffect)(() => {
                            ...
                            const e = (e) => {
                                ...
                                t = () => {
                                    (window.removeEventListener('mousemove', e), u.handleIsThumbDragging(!1), v(J));
                                };
                            return (
                                window.addEventListener('mousemove', e),
                                window.addEventListener('mouseup', t),
            ...
            const Re = (u) => {
                ...
                Me = ({ isWTREnabled: u }) =>
                    u
                        ...
                        : s().createElement('div', { className: Te }, ke.withoutWTR.statistic.title()),
            ...
            const bt = (0, r.forwardRef)(function (u, e) {
                ...
                Lt = 'Content_icon_bd',
                Tt = R.images.gui.maps.icons.achievements.rating,
                xt = (u, e = !1) =>
                    e
                        ? Tt.c_180x180
                        : u >= yu.cJ.Large
                          ...
                          : u >= yu.cJ.Medium
                            ...
                            : Tt.c_180x180,
                kt = (u, e, t, n = !0, a = !1) => ({
                    backgroundImage: n ? `url(${xt(t, a).$dyn(`rating_${u}_${e}`)})` : `url(${xt(t, a).wotpr()})`,
                }),
                Mt = (0, mu.Pi)(() => {
                    const u = bu(),
                        e = u.model,
                            ...
                            ? s().createElement(
                                  ...
                                  r
                                      ? s().createElement(
                                            ...
                                            s().createElement(
                                                ru.Vertical.Area,
                                                { api: o, className: Ln, classNames: { content: Tn } },
                                                s().createElement(
                                                    'div',
                                                    { className: kn },
                                            ...
                                            s().createElement(ru.Vertical.Bar, { api: o, classNames: { base: xn } }),
                                        )
                                      : s().createElement(pn, null),
