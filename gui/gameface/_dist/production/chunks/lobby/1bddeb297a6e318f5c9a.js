    ...
    [154],
    {
        7910: (e, t, a) => {
                ...
                N = ({
                    ...
                    return (o = {}) => {
                            ...
                            w = ((e, t = []) => {
                                ...
                                () =>
                                    (0, c.v)(() => {
                                        const e = d.current;
                                        e &&
                                            (C(i(e, S.scrollPosition.goal), { immediate: !0 }),
                                            p.trigger('resizeHandled'));
                                    }),
                                [C, S.scrollPosition.goal],
                            ),
                            L = g(() => {
                                const e = d.current;
                                if (!e) return;
                                const t = i(e, S.scrollPosition.goal);
                                (t !== S.scrollPosition.goal && C(t, { immediate: !0 }),
                        ...
                        return (0, s.useMemo)(
                            ...
                            [S.scrollPosition, C, R, p.off, p.on, L, I, A, u.step.clampedArrowStepTimeout],
                        );
                    };
                },
                S = N({
                ...
                O = (0, s.memo)(({ api: e, classNames: t = {}, getStepByRailClick: a = k, onDrag: n = B }) => {
                        ...
                        O = g(() => {
                            ((() => {
                                ...
                                ((t.style.width = `${D(a, l)}px`),
                                    ...
                                    r.current &&
                                        (1 !== l ? r.current.classList.add(P) : r.current.classList.remove(P)));
                            })(),
                                R());
                        });
                    ...
                    return l().createElement(
                        ...
                        l().createElement(
                            ...
                            l().createElement('div', { className: o()(x, t.rail) }),
                        ),
                        l().createElement('div', {
            ...
            const ye = 'AchievementTooltip_base_4d',
                Ne = ({ children: e, name: t, block: a, isEnabled: n = !0 }) =>
                    l().createElement(
                        he.l,
            ...
            const xe = ({ value: e, type: t = Ae.Simple, size: a = Le.Medium, className: n }) =>
                    l().createElement(
                        ...
                        l().createElement(
                            ...
                            l().createElement(
                                ...
                                t === Ae.Stages
                                    ? (0, Ie.HG)(e)
                                    : l().createElement(Re.A, { value: e, format: 'integral' }),
                            ),
                            t === Ae.Series &&
                                l().createElement(
                                    l().Fragment,
                                    null,
                                    l().createElement('div', { className: o()(we.arrow, we.arrow__left) }),
                                    l().createElement('div', { className: o()(we.arrow, we.arrow__right) }),
                                ),
                        ),
                    ),
                ...
                Te =
                    ...
                    ({ name: e, resourceName: t, type: a, rareIconId: n, rareBigIconId: r, value: s, size: l }) => {
                        if (n && r) return l === Pe.ExtraSmall ? n : r;
                        ...
                        return l === Pe.ExtraSmall && i < 2 ? Me.$dyn(o) : Me.big.$dyn(o);
                    }),
                ke = {
                    ...
                    return l().createElement(
                        ...
                        l().createElement(
                            ...
                            l().createElement(
                                ...
                                r !== Ae.None &&
                                    l().createElement(xe, { type: r, size: ke[s], value: i, className: Ce.counter }),
                            ),
                        ),
                    );
                };
                ...
                ze = ({ size: e, isOtherPlayer: t = !1 }) =>
                    l().createElement(
                        ...
                        l().createElement(
                            ...
                            l().createElement('div', { className: We.image }),
                        ),
                    ),
                $e = {
                    ...
                    l().createElement(
                        ...
                        _ !== Qe.ghost &&
                            l().createElement(
                                l().Fragment,
                                null,
                                l().createElement('div', { className: Ze.back }),
                                l().createElement('span', { className: Ze.texture }),
                            ),
                        l().createElement(
                            'span',
                            { className: o()(Ze.state, Ze.state__default) },
                            l().createElement('span', { className: Ze.stateDisabled }),
                            l().createElement('span', { className: Ze.stateHighlightHover }),
                            l().createElement('span', { className: Ze.stateHighlightActive }),
                        ),
                        l().createElement(
                            'span',
                    ...
                    l().createElement(
                        ...
                        l().createElement(
                            ...
                            l().createElement(at.z, {
                                ...
                                binding: {
                                    current: l().createElement(Re.A, { value: t }),
                                    total: l().createElement(Re.A, { value: e }),
                                },
                            }),
                        ),
                    ),
            ...
            const yt = (e) => {
                ...
                Nt = (0, ie.Pi)(() => {
                    ...
                    return l().createElement(
                        'div',
                        { className: o()(He, d && Fe, !i && d && Ve, i && Ge) },
                        l().createElement('div', { className: Ue }, l().createElement(Et, null)),
                        l().createElement(
                            'div',
                            { className: je },
                            l().createElement(
                                                    ...
                                                    ? (m++,
                                                      l().createElement(
                                                          ...
                                                          l().createElement(
                                                              ...
                                                              l().createElement(Be, ht({}, e, { size: u })),
                                                          ),
                                                          l().createElement(
                                                              'div',
                                                              {
                                                              ...
                                                              l().createElement(ze, { size: u, isOtherPlayer: s }),
                                                          ),
                                                      ))
                                                    : l().createElement(Be, ht({}, e, { size: u }))
                                                : l().createElement(ze, { size: u, isOtherPlayer: s });
                ...
                Ct = ({ isWTREnabled: e }) =>
                    e
                        ...
                        : l().createElement('div', { className: St }, Pt.withoutWTR.statistic.title());
            var Rt = a(5959),
                It = a(8432);
            ...
            const rn = (0, ie.Pi)(() => {
                ...
                sn = (0, ie.Pi)(() => {
                    const e = be().model,
                        ...
                        r = t.isOtherPlayer,
                        s = 0 === a,
                        i = (0, e.computes.getRatingWidgetState)() === ve.Downgrade;
                    return l().createElement(
                        De.u,
                        {
                            contentId: n
                ...
                In = (0, ie.Pi)(() => {
                    ...
                    return l().createElement(
                        'div',
                        { className: o()(Sn, a && An) },
                        l().createElement('div', { className: Pn }, l().createElement(Ct, { isWTREnabled: t })),
                        l().createElement('div', { className: Cn }, l().createElement(Nn, null)),
                        l().createElement(Nt, null),
                        a && l().createElement('div', { className: Rn }, l().createElement(Pa, null)),
                    );
                }),
                wn = 'Error_base_e9',
                Ln = 'Error_icon_51',
                    ...
                    return l().createElement(
                        ...
                        e
                            ...
                            : l().createElement(
                                  l().Fragment,
                                  null,
                                  l().createElement('div', { className: xn }, kn.title()),
                                  l().createElement('div', { className: Mn }, kn.description()),
                              ),
                    );
                }),
                Dn = 'App_base_bb',
                ...
                qn = (0, ie.Pi)(() => {
                    const e = be().model.root.get(),
                        ...
                        g = (0, le.uF)(Fn.registrationDate(), { registrationDate: t }),
                        _ = (0, le.uF)(Fn.lastVisit(), { lastVisitDate: a, lastVisitTime: n }),
                    ...
                    return l().createElement(
                        ...
                        r
                            ? l().createElement(
                                  ...
                                  s
                                      ? l().createElement(
                                            ...
                                            l().createElement(se.Vertical.Bar, { api: u, classNames: { base: $n } }),
                                        )
                                      : l().createElement(In, null),
                                  l().createElement(
                                      'div',
                            ...
                            : l().createElement(
                                  'div',
                                  { className: Un },
                                  l().createElement('div', { className: jn }, l().createElement(Bn, null)),
                              ),
                    );
                }),
                Jn = () =>
                    l().createElement(pe, { options: { context: 'model.summaryModel' } }, l().createElement(qn, null));
        },
    },
]);
