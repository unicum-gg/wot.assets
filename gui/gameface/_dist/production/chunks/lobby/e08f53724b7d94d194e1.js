    ...
    [154],
    {
        7910: (e, t, a) => {
            ...
            const y = {
                ...
                O = (0, s.memo)(
                    ({ api: e, classNames: t = {}, getStepByRailClick: a = T, onDrag: n = B, onClick: r = B }) => {
                        const i = (0, s.useRef)(null),
                            ...
                            O = () => {
                                ...
                                const s = e.animationScroll.scrollPosition.get(),
                                    l = Math.min(1, n / r),
                                    i = (0, m.u)(0, 1, s / (r - n)),
                                    o = (t.offsetWidth - D(t, l)) * i;
                                ((a.style.transform = `translateX(${0 | o}px)`),
                                    ((e) => {
                                        if (d.current && f.current && p.current && b.current) {
                                            if (0 === e)
                                                return (d.current.classList.add(k), void f.current.classList.remove(k));
                                            if (
                                                ((t = p.current),
                                                (a = b.current),
                                                e - (t.offsetWidth - a.offsetWidth) >= -0.5)
                                            )
                                                return (d.current.classList.remove(k), void f.current.classList.add(k));
                                            var t, a;
                                            (d.current.classList.remove(k), f.current.classList.remove(k));
                                        }
                                    })(o));
                            },
                            W = g(() => {
                                ((() => {
                                    ...
                                    ((t.style.width = `${D(a, s)}px`),
                                        (t.style.display = 'flex'),
                                        i.current &&
                                            (1 === s ? i.current.classList.add(C) : i.current.classList.remove(C)));
                                })(),
                                    O());
                            });
                        ((0, s.useEffect)(() => (0, c.v)(W)),
                            (0, s.useEffect)(
                                () =>
                                    (0, c.v)(() => {
                                        const t = () => {
                            ...
                            (0, s.useEffect)(() => {
                                ...
                                const t = u.O.client.events.mouse.move(([t, a]) => {
                                        ...
                                        const c = t.clientX - N.offset - i.getBoundingClientRect().x,
                        ...
                        return l().createElement(
                            'div',
                            { className: o()(A, t.base), ref: i, onWheel: e.handleMouseWheel },
                            l().createElement('div', {
                                className: o()(P, t.leftButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(k) || 0 !== e.button || ((0, v.G)('play'), $(h.Next));
                                },
                                onMouseUp: H,
                                ref: d,
                                onMouseEnter: V,
                            ...
                            l().createElement(
                                    ...
                                    onMouseDown: (t) => {
                                        ...
                                        if (n && 0 === t.button)
                                            if (((0, v.G)('play'), t.target === n))
                                                R({ pending: !0, offset: t.screenX - n.getBoundingClientRect().x });
                                            else {
                                                ((t) => {
                                                    const n = b.current,
                                ...
                                l().createElement('div', { ref: b, className: o()(L, t.thumb) }),
                                l().createElement('div', { className: o()(M, t.rail) }),
                            ),
                            l().createElement('div', {
                                className: o()(I, t.rightButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(k) || 0 !== e.button || ((0, v.G)('play'), $(h.Prev));
                                },
                                onMouseUp: H,
                                ref: f,
                                onMouseEnter: V,
