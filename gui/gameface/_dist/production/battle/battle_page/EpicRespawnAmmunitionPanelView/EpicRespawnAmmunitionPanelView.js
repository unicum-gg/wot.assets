            ...
            9376: (e, t, u) => {
                ...
                const Be = {
                    ...
                    fe = De((e) => {
                        ...
                        return a().createElement('div', Ce({ className: h()(pe.base, ...W, t), style: $ }, H), P);
                    }),
                                  ...
                                  t.split('\n').map((t, r) =>
                                      a().createElement(
                                          ...
                                          ((e, t, u) =>
                                              e
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((e) => (u && e in u ? u[e] : L(e, t))))(t, i, e).map((e, t) =>
                ...
                const mt = 'SwitchButton_base_23',
                    ...
                    wt = ({ onClick: e, totalCount: t, currentIndex: u, states: i, isDisabled: r, groupId: s }) => {
                ...
                const nu = (e) => `panel-${e}-section`,
                    ...
                    iu = ({ baseId: e, slotsLength: t, handleSwap: u, setIsExitBlocked: a, syncInitiator: i }) => {
                        const r = ((e, t, u) => {
                                const a = (0, n.useRef)([]),
                    ...
                    su = ['size', 'value', 'isEmpty', 'fadeInAnimation', 'hide', 'maximumNumber', 'className'];
                function ou() {
                    return (
                        (ou =
                            Object.assign ||
                ...
                const cu = 'display',
                    ...
                    gu = (0, n.memo)(({ panelType: e, text: t, parentRef: u, isTruncated: i = !1, show: r = !1 }) => {
                                            ...
                                            t = D.O.client.events.mouse.move(([e]) => {
                                                ...
                                                (!n && y(),
                                                    u !== t.actualX &&
                                                        ...
                                                        x(u),
                                                        n &&
                                                            l(uu.Drag, { dragId: t.id, currentCenterX: t.dropCenterX }),
                ...
                const dn = 'KeyLabel_base_ec',
                    ...
                    bn = ({ children: e, slotType: t, slotId: u, isEnabled: i = !0 }) => {
                        ...
                        return a().createElement(Ve, { isEnabled: i, args: r }, a().createElement('div', null, e));
                    },
                    Fn = 'Close_base_f3',
                ...
                const Wn = { [Nn]: 200, [Mn]: 250, [On]: 250, [Hn]: 1400, [Ln]: Gn, [Pn]: Gn, demount_from_setup: Gn },
                ...
                Ea.defaultProps = { type: da.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                    ...
                    Fa = ({
                        ...
                        return a().createElement(
                            ...
                            s && u
                                ? a().createElement(
                                      Aa,
                                      { size: ma.small, type: da.ghost, mixClass: ba.specializationButton, onClick: _ },
                                      F,
                                  )
                ...
                const xa = (e) => {
                    ...
                    Ia = ({
                        ...
                        const P =
                            ...
                            G = ((A && A.length > 0) || (b && b.length > 0)) && r !== Rt.Battle && r !== Rt.Respawn,
                            $ = (0, n.useMemo)(
                                () => ({
                                    backgroundImage: b
                            ...
                            W = (0, n.useMemo)(
                                () => ({ icon: a().createElement('span', { className: yu, style: $ }), vehicle: A }),
                                [$, A],
                            ),
                            z = t.length > 0 && r !== Rt.Compare && r !== Rt.Battle && r !== Rt.Respawn && t.length > 0,
                ...
                const ui = ({
                    ...
                    ii = a().memo(({ text: e }) =>
                        a().createElement('div', { className: ni }, a().createElement('div', { className: ai }, e)),
                    ),
                ...
                const Ai = (e) => e.setupSelector.hotKeys,
                    ...
                    Di = ({ sectionProps: e, isSetupSwitching: t, isReady: u, setSetupSwitching: i, children: r }) => {
                        const s = J(['switch'], mi),
                            o = F('model'),
                            l = o.isDisabled,
                            c = o.vehicleInfo,
                ...
                const Ci = ['__left', '__right', '__top', '__bottom'],
                    Bi =
                        ((0, n.forwardRef)(
                            ({ children: e, disableAutoSizeUpdate: t, onOutsideClick: u, customStyles: i = {} }, r) => {
                ...
                const Si = (e) => {
                    ...
                    Ni = (0, n.memo)(({ slotOffset: e, slotWidth: t, isAnimationRunning: u }) => {
                        ...
                        const l = (0, n.useMemo)(() => {
                                ...
                                return { left: r.offset, width: e, backgroundSize: `${D.O.view.pxToRem(e)}rem 100%` };
                    ...
                    Pi = R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent('resId'),
                ...
                const Yi = ({
                        ...
                        return a().createElement(
                            ...
                            a().createElement('div', { className: h()(Vi.level, null == _ ? void 0 : _.level) }, ji(i)),
                            a().createElement('div', {
