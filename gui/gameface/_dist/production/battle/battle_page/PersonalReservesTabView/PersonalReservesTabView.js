(() => {
    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                t.d(e, { Sw: () => a.Z, B3: () => E, Z5: () => s, B0: () => o, ry: () => d });
                class r {
                    constructor() {
                        ((this.entries = []),
                            (this._listenMouse = !1),
            ...
            1439: (u, e, t) => {
                ...
                const T = (u = 1) => {
                    ...
                    M = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: n, modelPath: O(n, u || ''), resId: r };
                            })(),
                            t = e.modelPrefix,
                            r = u.split('.');
                        if (r.length > 0) {
                            ...
                            return (
                                r.reduce((e, r) => {
                                    const n = x(O(t, `${e}.${r}`), window);
                                    return k(n) ? (u.push(n.id), `${e}.${r}.value`) : (u.push(r), `${e}.${r}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                            ...
                            P(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        r = M(u);
                                    c.current = N.addCallback(r, t, i, e === S.Deep);
                                }
                            }),
                            (0, r.useEffect)(() => {
                                if (e !== S.None)
                                    return () => {
                                        N.removeCallback(c.current, i);
                                    };
                            }, [i, e]),
                            A
                        );
                    ...
                    su = (0, r.memo)(
                        ({
                            ...
                            return n().createElement(
                                ...
                                e !== Z.None &&
                                    n().createElement('div', {
                                        className: o()(uu, i.icon),
                                        style: { backgroundImage: `url('${au(e, c)}')` },
                                    }),
                                E
                                    ? n().createElement(
                                          'div',
                                          { className: o()(eu, i.text) },
                                          n().createElement(d, { text: E, binding: { timerText: l } }),
                                      )
                                    : n().createElement('div', { className: o()(eu, i.text) }, l),
                            );
                        },
                    );
                class iu {
                ...
                const _u = {
                    ...
                    Cu = ({
                        ...
                        const F = o()(_u.value, _u[`value__${r}`], !a && _u.value__notEnough),
                            ...
                            l = o()(_u.stock, i && _u.stock__indent, e && _u.stock__interactive),
                            D = E && s > 0 && '+',
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                { className: F },
                                D,
                                n().createElement(Du, { value: s, format: r === cu.gold ? 'gold' : 'integral' }),
                            ),
                    ...
                    yu = (u) => {
                        ...
                        const S = C === $.Clan,
                            I = o()(bu.base, {
                                ...
                                [bu.base__disabled]: !k && i,
                                [bu.base__inactive]: !k && !i,
                                [bu.base__activatedAnimation]: N,
                                [bu.base__zeroTime]: k && x <= 0,
                            }),
                            V = (0, r.useCallback)(() => {
                                k || i || z('personal_reserves_hover');
                            }, [k, i]),
                            G = (0, r.useCallback)(() => {
                                k || i || c({ boosterId: _ });
                            }, [_, c, k, i]),
                        ...
                        return n().createElement(
                            ...
                            i && n().createElement('div', { className: bu.disabledPattern }),
                            ...
                            L &&
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(su, { duration: O, style: M }),
                                    ),
                                ),
                            n().createElement(
                                'div',
                            ...
                            n().createElement(
                                ...
                                S && !k && n().createElement('div', { className: bu.plusIcon }),
                            ),
                        );
                    },
                    Ru = [
                ...
                const Su = R.views.common.tooltip_window.simple_tooltip_content,
                    ...
                    Uu = ({
                        ...
                        category: r,
                        activeSecondsLeft: a,
                        hasActiveGroupItems: s,
                    }) => {
                        if (u === zu.LOBBY) {
                            if (!t.isPremium && t.state !== q.Active && s)
                                return n().createElement(
                                    Iu,
                ...
                const ju = ({
                        ...
                        const F = (0, r.useReducer)((u) => !u, !1)[1],
                            ...
                            l = s[0].inactivationTime > 0 || (s[1] && s[1].inactivationTime > 0),
                            D = o()(Vu, l && Gu),
                            _ = 1 === s.length;
                        return n().createElement(
                            'div',
                            ...
                            n().createElement(
                                ...
                                n().createElement('div', { className: qu }, t),
                            ),
                            s.map((e, r) => {
                                ...
                                return n().createElement(
                                    Uu,
                                    {
                                        ...
                                        category: a,
                                        activeSecondsLeft: o,
                                        hasActiveGroupItems: s.length > 1 && l,
                                    },
                                    n().createElement(yu, {
                                        reserve: e,
                                        groupDescription: t,
                ...
                engine.whenReady.then(() => {
                    s().render(n().createElement(ne, null), document.getElementById('root'));
                });
            },
        },
