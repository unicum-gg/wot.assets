(() => {
    ...
    var __webpack_modules__ = {
            ...
            500: (u, e, t) => {
                        ...
                        return _.includes(t)
                            ...
                            : ((u, e = E.left) => {
                                  ...
                                  const r =
                                      ...
                                      n = u.replace(/&nbsp;/g, ' ');
                                  return l(n, /( )/, e).forEach((u) => (t = t.concat(l(u, r, E.left)))), t;
                              })(u, e);
                    },
                                  ...
                                  e.split('\n').map((e, i) =>
                                      n().createElement(
                                          ...
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : C(u, e))))(e, a, u).map((u, e) =>
                ...
                function h(u = 0) {
                    ...
                    return (e -= n * p), { days: t, hours: r, minutes: n, seconds: e };
                }
                const w = () => {},
                    f = (u = 0, e, t = 0, n = w) => {
                ...
                const x = (u = 1) => {
                    ...
                    M = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, t) => {
                                const r = P(`${u}.${t}`, window);
                                return O(r) ? e(u, t, r) : `${u}.${t}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    N = (u) => {
                        const e = ((u) => {
                                const e = x(),
                                ...
                                return { modelPrefix: n, modelPath: L(n, u || ''), resId: r };
                            })(),
                            t = e.modelPrefix,
                            r = u.split('.');
                        if (r.length > 0) {
                            ...
                            return (
                                r.reduce((e, r) => {
                                    const n = P(L(t, `${e}.${r}`), window);
                                    return O(n) ? (u.push(n.id), `${e}.${r}.value`) : (u.push(r), `${e}.${r}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                            ...
                            k(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        r = N(u);
                                    c.current = S.addCallback(r, t, s, e === I.Deep);
                                }
                            }),
                            (0, r.useEffect)(() => {
                                if (e !== I.None)
                                    return () => {
                                        S.removeCallback(c.current, s);
                                    };
                            }, [s, e]),
                            A
                        );
                ...
                const H = {
                        [G.XP]: R.strings.personal_reserves.activation.battleXPTitle(),
                        [G.Credits]: R.strings.personal_reserves.activation.creditsTitle(),
                        [G.Combined_XP]: R.strings.personal_reserves.activation.comboXPTitle(),
                        [G.Event]: R.strings.personal_reserves.activation.frontLineXPTitle(),
                        [G.Clan]: R.strings.personal_reserves.activation.clanBoostersTitle(),
                    },
                    $ = {
                        [G.XP]: R.strings.personal_reserves.activation.battleXPDescription(),
                        [G.Credits]: R.strings.personal_reserves.activation.creditsDescription(),
                        [G.Combined_XP]: R.strings.personal_reserves.activation.comboXPDescription(),
                        [G.Event]: R.strings.personal_reserves.activation.frontLineXPDescription(),
                        [G.Clan]: R.strings.personal_reserves.activation.clanBoostersDescriptionCrewAndFree(),
                    };
                ...
                const Y = ({
                    ...
                    const B = (0, r.useRef)(null),
                        ...
                        f = h[1],
                        T = (0, r.useCallback)(() => {
                            i || (B.current && (B.current.focus(), v(!0)));
                        }, [i]),
                        x = (0, r.useCallback)(
                            (u) => {
                ...
                Y.defaultProps = { type: W.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const X = (0, r.memo)(Y);
                let Z, Q;
                !(function (u) {
                    ...
                    iu = (0, r.memo)(
                        ({
                            ...
                            const A = t !== Q.Description ? 1 : void 0,
                                F = V(u, A),
                                c = (() => {
                                    const u = (0, r.useState)(T.O.view.getScale()),
                                        e = u[0],
                                        t = u[1];
                                    return (
                                        (0, r.useEffect)(() => {
                ...
                z.Personal, ou.Personal, z.Event, ou.Event, z.Clan, ou.Clan;
                let Fu, cu, lu;
                !(function (u) {
                ...
                const _u = {
                    ...
                    Cu = ({
                        ...
                        const F = o()(_u.value, _u[`value__${r}`], !a && _u.value__notEnough),
                            c = o()(_u.icon, _u[`icon__${r}-${t}`]),
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                { className: F },
                                D,
                                n().createElement(Du, { value: i, format: r === cu.gold ? 'gold' : 'integral' }),
                            ),
                ...
                const Bu = n().memo(Cu),
                    du = 'Quantity_base_e7',
                    mu = 'Quantity_base__premium_7e',
                    vu = 'Quantity_icon_e5',
                    pu = ({ isPurchasable: u, goldPrice: e = 0, playerGold: t, inDepot: r, isPremium: a }) =>
                        u && e
                            ? n().createElement(Bu, { size: 'small', type: 'gold', value: e, isEnough: t >= e })
                            : n().createElement(
                                  'div',
                                  { className: o()(du, { [mu]: a }) },
                ...
                const wu = {
                    ...
                    yu = (u) => {
                        ...
                        const L = Math.floor((1e3 * w - Date.now()) / 1e3),
                            M = Boolean(!O && L && L > 0),
                            N = L > g ? Q.Extended : Q.Long,
                            S = O && v - i < 5;
                        (0, r.useEffect)(() => {
                            S && y('personal_reserves_activation');
                        }, [S]);
                        const I = C === z.Clan,
                            U = o()(bu.base, {
                                [bu.base__clan]: I,
                                [bu.base__event]: C === z.Event,
                                [bu.base__premium]: p,
                                [bu.base__doubleSize]: F,
                                [bu.base__disabled]: !O && s,
                                [bu.base__inactive]: !O && !s,
                                [bu.base__activatedAnimation]: S,
                                [bu.base__zeroTime]: O && P <= 0,
                            }),
                            G = (0, r.useCallback)(() => {
                                O || s || y('personal_reserves_hover');
                            }, [O, s]),
                            H = (0, r.useCallback)(() => {
                                O || s || c({ boosterId: _ });
                            }, [_, c, O, s]),
                            $ = h(P);
                        let j = $.hours ? `${fu($.hours)}:` : '';
                        j += `${fu($.minutes)}:${fu($.seconds)}`;
                        ...
                        return n().createElement(
                            'div',
                            { className: U, style: { '--fillPercentage': `${k}%` }, onMouseEnter: G },
                            O &&
                                n().createElement(
                                    n().Fragment,
                                    null,
                                    n().createElement(
                                        ...
                                        n().createElement('div', { className: bu.cardFill_patternGradient }),
                                        n().createElement('div', { className: bu.cardFill_pattern }),
                                        n().createElement('div', { className: bu.cardFill_innerBorder }),
                                        n().createElement('div', { className: bu.cardFill_border }),
                                        n().createElement('div', { className: bu.cardFill_borderGradient }),
                                        n().createElement('div', { className: bu.cardFill_borderTop }),
                                    ),
                                    n().createElement(
                                        'div',
                                        { className: bu.activeLight },
                                        n().createElement('div', { className: bu.activeLight_border }),
                                    ),
                                    n().createElement('div', { className: bu.checkmark }),
                                ),
                            s && n().createElement('div', { className: bu.disabledPattern }),
                            p && n().createElement('div', { className: bu.premiumLight }),
                            M &&
                                n().createElement(
                                    n().Fragment,
                                    null,
                                    n().createElement('div', { className: bu.limitedOfferLight }),
                                    n().createElement(
                                        'div',
                                        { className: bu.limitedOfferTimer },
                                        n().createElement(iu, { duration: L, style: N }),
                                    ),
                                ),
                            n().createElement(
                                'div',
                                hu({ className: bu.overlay }, D),
                                n().createElement('div', { className: bu.overlayUpper }),
                                n().createElement(
                                    'div',
                                    ...
                                    ((u, e, t) =>
                                        u === z.Clan
                                            ...
                                            : n().createElement(d, {
                                                  ...
                                                  binding: {
                                                      bonusDescription: n().createElement(
                                                          'span',
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        X,
                                        { type: 'primary', size: 'medium', mixClass: bu.overlayButton, onClick: H },
                                        n().createElement(d, {
                                            text: I ? wu.activateButtonLabelClan : wu.activateButtonLabel,
                                        }),
                                    ),
                                ),
                            ),
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    { className: bu.timer },
                                    n().createElement('div', { className: bu.timerIcon }),
                                    j,
                                ),
                                n().createElement('div', {
                                    style: {
                                ...
                                n().createElement(
                                    'div',
                                    { className: bu.bonus },
                                    K && n().createElement(d, { text: wu.bonus, binding: { bonus: Y } }),
                                ),
                                I && !O && n().createElement('div', { className: bu.plusIcon }),
                            ),
                        );
                    },
                    Ru = [
                ...
                const xu = (u, e, t = {}, r = 0) => {
                    ...
                    Pu = (u) => {
                        ...
                        const b = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            g = (0, r.useMemo)(() => d || x().resId, [d]),
                            h = (0, r.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (xu(t, D, { isMouseEvent: !0, on: !0, arguments: Tu(n) }, g),
                                    m && m(),
                ...
                const Su = R.views.common.tooltip_window.simple_tooltip_content,
                    ...
                    Uu = ({
                        ...
                        if (u === qu.LOBBY) {
                            ...
                            if (0 === t.inDepot && !t.isPremium && t.reserveType !== z.Clan)
                                return n().createElement(
                                    Pu,
                                    { contentId: R.views.common.personal_reserves.ReservesDisabledTooltip('resId') },
                                    e,
                                );
                            const u = t.reserveType === z.Clan,
                                a = t.boosterID > 0 ? t.boosterID : Eu[r];
                            return n().createElement(
                                Lu,
                                { args: { specialAlias: u ? 'clanReserveInfo' : 'boostersBoosterInfo', boosterId: a } },
                                e,
                            );
                        }
                        if (u === qu.BATTLE) {
                    ...
                    zu = 'ReserveGroup_header_description_03';
                let qu;
                !(function (u) {
                ...
                const ju = ({
                        ...
                        const F = (0, r.useReducer)((u) => !u, !1)[1],
                            c = (0, r.useCallback)(
                                (u) => {
                                    E(u);
                                },
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement('div', { className: zu }, t),
                            ),
                            i.map((e, r) => {
                                ...
                                const C = u !== qu.BATTLE && e.isPremium && e.state !== q.Active && 0 === e.inDepot;
                                return n().createElement(
                                    Uu,
                                    {
                                        key: r,
                    ...
                    re = 'App_notice_background_fd',
                    ne = () => {
                        const u = U().onBoosterActivate,
                            e = U('model.reserveGroups', I.Shallow),
                            t = (0, r.useCallback)(
                                (e) => {
                                    u(e);
                                },
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement('div', { className: o()(Xu, Zu) }),
                                ),
                                n().createElement(
                                    'div',
                                    { className: Ju },
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    { className: te },
                                    n().createElement(d, { text: R.strings.personal_reserves.battleView.notice() }),
                                ),
                ...
                engine.whenReady.then(() => {
                    i().render(n().createElement(ne, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [532], () => __webpack_require__(500));
