    ...
    var u,
        e = {
            ...
            239: (u, e, A) => {
                'use strict';
                var t = {};
                (A.r(t), A.d(t, { mouse: () => d, onResize: () => o }));
                var F = {};
                (A.r(F),
                    A.d(F, {
                        events: () => t,
                ...
                var E = {};
                (A.r(E), A.d(E, { getBgUrl: () => x, getTextureUrl: () => h }));
                var D = {};
                (A.r(D),
                    A.d(D, {
                        addModelObserver: () => M,
                ...
                const Fu = uu.client.getSize('rem'),
                    Eu = Fu.width,
                    Du = Fu.height,
                    ru = Object.assign({ width: Eu, height: Du }, tu(Eu, Du, eu)),
                ...
                const nu = (u) => {
                    ...
                    const t = (0, r.useContext)(au),
                        ...
                        o = t.smallWidth,
                        s = t.extraSmallWidth,
                        d = t.extraLargeHeight,
                        m = t.largeHeight,
                        g = t.mediumHeight,
                        c = t.smallHeight,
                        h = t.extraSmallHeight,
                        x = { extraLarge: d, large: m, medium: g, small: c, extraSmall: h };
                    if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
                        ...
                        if (A.extraLargeWidth && n) return i(e, A, x);
                        if (A.largeWidth && C) return i(e, A, x);
                        if (A.mediumWidth && l) return i(e, A, x);
                        if (A.smallWidth && o) return i(e, A, x);
                        if (A.extraSmallWidth && s) return i(e, A, x);
                        if (!(
                            A.extraLargeWidth ||
                            A.largeWidth ||
                            A.mediumWidth ||
                        ...
                        const e = (0, r.useContext)(au),
                            ...
                            E = (0, r.useCallback)((u, e) => {
                                const A = uu.view.pxToRem(u),
                                    t = uu.view.pxToRem(e);
                                F(Object.assign({ width: A, height: t }, tu(A, t, eu)));
                            }, []);
                        (iu(() => {
                            engine.on('clientResized', E);
                        }),
                            (0, r.useEffect)(() => () => engine.off('clientResized', E), [E]));
                        const D = (0, r.useMemo)(() => Object.assign({}, t), [t]);
                ...
                const vu = {
                        [gu.ExtraSmall]: '',
                        [gu.Small]: du().SMALL_WIDTH,
                        [gu.Medium]: `${du().SMALL_WIDTH} ${du().MEDIUM_WIDTH}`,
                        [gu.Large]: `${du().SMALL_WIDTH} ${du().MEDIUM_WIDTH} ${du().LARGE_WIDTH}`,
                        [gu.ExtraLarge]: `${du().SMALL_WIDTH} ${du().MEDIUM_WIDTH} ${du().LARGE_WIDTH} ${du().EXTRA_LARGE_WIDTH}`,
                    },
                    wu = {
                        [cu.ExtraSmall]: '',
                    ...
                    bu = {
                        [mu.ExtraSmall]: '',
                        [mu.Small]: du().SMALL,
                        [mu.Medium]: `${du().SMALL} ${du().MEDIUM}`,
                        [mu.Large]: `${du().SMALL} ${du().MEDIUM} ${du().LARGE}`,
                        [mu.ExtraLarge]: `${du().SMALL} ${du().MEDIUM} ${du().LARGE} ${du().EXTRA_LARGE}`,
                    },
                    pu = (u) => {
                        let e = u.children,
                            A = u.className,
                        ...
                        const F = hu(),
                            ...
                            D = F.mediaHeight,
                            r = F.mediaSize;
                        return a().createElement('div', fu({ className: ou()(A, vu[E], wu[D], bu[r]) }, t), e);
                    },
                    Lu = ['children'];
                const Su = (u) => {
                    let e = u.children,
                    ...
                    return a().createElement(Cu, null, a().createElement(pu, A, e));
                };
                function _u() {
                    return !1;
                }
                ...
                const Mu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: t = 'real', options: F, children: E, mocks: D }) {
                                const B = (0, r.useRef)([]),
                                    n = (A, t, F) => {
                                        ...
                                        const D = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = Hu(F.keys()); !(u = A()).done;) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(t),
                                            ...
                                            i = u({
                                                ...
                                                observableModel: {
                                                    array: (u, e) => {
                                                        const t = null != e ? e : a(u),
                                                            F = Tu.LO.box(t, { equals: _u });
                                                        return (
                                                            'real' === A &&
                                                                r.subscribe(
                                                                    (0, Tu.aD)((u) => F.set(u)),
                                    ...
                                    l = C[0],
                                    o = C[1],
                                    s = (0, r.useState)(() => n(t, F, D)),
                                    d = s[0],
                                    m = s[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        i.current ? m(n(l, F, D)) : (i.current = !0);
                                    }, [D, l, F]),
                                    (0, r.useEffect)(() => {
                                        o(t);
                                    }, [t]),
                                    (0, r.useEffect)(
                                        () => () => {
                                            (d.externalModel.dispose(), B.current.forEach((u) => u()));
                                        },
                                        [d],
                                    ),
                                    a().createElement(A.Provider, { value: d }, E)
                                );
                            },
                            () => (0, r.useContext)(A),
                        ];
                        ...
                        ({ observableModel: u }) => {
                            const e = Object.assign(
                                { root: u.object() },
                                u.primitives(['isVisible', 'hintId', 'duration']),
                            );
                ...
                const Gu = {
                    ModuleDamage: {
                        text: R.strings.battle_hints.infoBattleContextHint.ModuleDamage(),
                        video: R.videos.battleContextHints.ModuleDamage(),
                    },
                    AmmunitionCrit: {
                        text: R.strings.battle_hints.infoBattleContextHint.AmmunitionCrit(),
                        video: R.videos.battleContextHints.AmmunitionCrit(),
                    },
                    KilledWhileObserved: {
                        text: R.strings.battle_hints.infoBattleContextHint.KilledWhileObserved(),
                        video: R.videos.battleContextHints.KilledWhileObserved(),
                    },
                    FueltankCrit: {
                        text: R.strings.battle_hints.infoBattleContextHint.FueltankCrit(),
                        video: R.videos.battleContextHints.FueltankCrit(),
                    },
                    InSafetyWhileNotObserved: {
                        text: R.strings.battle_hints.infoBattleContextHint.InSafetyWhileNotObserved(),
                        video: R.videos.battleContextHints.InSafetyWhileNotObserved(),
                    },
                };
                let Pu;
                !(function (u) {
                ...
                const $u = (u, e, A) => {
                    ...
                    ku = (u, e, A = Pu.left) => u.split(e).reduce(A === Pu.left ? $u : zu, []),
                    ju = (() => {
                        const u = new RegExp(
                        ...
                        return Uu.includes(A)
                            ...
                            : ((u, e = Pu.left) => {
                                  ...
                                  const t =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return (ku(F, /( )/, e).forEach((u) => (A = A.concat(ku(u, t, Pu.left)))), A);
                              })(u, e);
                    },
                    Vu = 'FormatText_base_d0',
                    Xu = ({ binding: u, text: e = '', classMix: A, alignment: t = Pu.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, F) =>
                                      a().createElement(
                                          'div',
                                          { className: ou()(Vu, A), key: `${e}-${F}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : Nu(u, e))))(e, t, u).map((u, e) =>
                    ...
                    Ku = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Zu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Ju = (0, r.memo)(({ text: u, binding: e, classMix: A }) => {
                        const t = (0, r.useCallback)((u) => ({ color: `#${u}` }), []),
                            F = (0, r.useMemo)(() => e || {}, [e]);
                        let E = Qu.exec(u),
                            D = u,
                            B = 0;
                                ...
                                ((D = D.replace(A, `%(${E})`)),
                                    (F[E] = qu[u]
                                        ? a().createElement(
                                              'span',
                                              { className: qu[u] },
                                              a().createElement(Xu, { text: i, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: t(u) },
                        ...
                        return a().createElement(Xu, { text: D, classMix: A, binding: F });
                    }),
                    Yu = 'App_base_4e',
                    ue = 'App_video_ef',
                    ee = 'App_contentInner_e8',
                    Ae = 'App_contentInnerClosing_30',
                    te = 'App_content_f5',
                    Fe = 'App_textContainer_a5',
                    Ee = 'App_text_d7',
                    De = 'App_shineLineAnimation_77',
                    re = 'App_lightRedAnimation_2d';
                var ae;
                !(function (u) {
                ...
                const Be = (0, Ou.Pi)(() => {
                    ...
                    return (
                        ...
                        (0, r.useEffect)(() => {
                            if (F !== ae.Closing) return;
                            const u = setTimeout(() => {
                                const u = l.current;
                                (u && (u.removeAttribute('src'), u.load()), E(ae.Idle), A.onHintClosed());
                            }, 200);
                            return () => clearTimeout(u);
                        }, [F]),
                        F === ae.Idle
                            ...
                            : a().createElement(
                                  ...
                                  a().createElement(
                                      ...
                                      a().createElement(
                                          'div',
                                          { className: ou()(ee, { [Ae]: F === ae.Closing }) },
                                          C.video &&
                                          ...
                                          C.text &&
                                              a().createElement(
                                                  'div',
                                                  { className: Fe },
                                                  a().createElement(Ju, { classMix: Ee, text: C.text }),
                                              ),
                                      ),
                                  ),
                              )
                ...
                engine.whenReady.then(() => {
                    n().render(
                        a().createElement(Ru, null, a().createElement(Su, null, a().createElement(Be, null))),
