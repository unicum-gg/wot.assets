        ...
        e = {
            ...
            239: (u, e, A) => {
                ...
                const tu = Y.client.getSize('rem'),
                    Fu = tu.width,
                    Eu = tu.height,
                    Du = Object.assign({ width: Fu, height: Eu }, Au(Fu, Eu, uu)),
                ...
                const nu = (u) => {
                    ...
                    iu = (0, r.memo)(({ children: u }) => {
                        const e = (0, r.useContext)(ru),
                            A = (0, r.useState)(e),
                            t = A[0],
                            F = A[1],
                            E = (0, r.useCallback)((u, e) => {
                                const A = Y.view.pxToRem(u),
                                    t = Y.view.pxToRem(e);
                                F(Object.assign({ width: A, height: t }, Au(A, t, uu)));
                            }, []);
                        (nu(() => {
                        ...
                        return a().createElement(ru.Provider, { value: D }, u);
                    });
                var Cu = A(6483),
                    lu = A.n(Cu),
                    ou = A(926),
                ...
                const fu = {
                        [mu.ExtraSmall]: '',
                        [mu.Small]: su().SMALL_WIDTH,
                        [mu.Medium]: `${su().SMALL_WIDTH} ${su().MEDIUM_WIDTH}`,
                        [mu.Large]: `${su().SMALL_WIDTH} ${su().MEDIUM_WIDTH} ${su().LARGE_WIDTH}`,
                        [mu.ExtraLarge]: `${su().SMALL_WIDTH} ${su().MEDIUM_WIDTH} ${su().LARGE_WIDTH} ${su().EXTRA_LARGE_WIDTH}`,
                    },
                    vu = {
                        [gu.ExtraSmall]: '',
                    ...
                    bu = (u) => {
                        ...
                        const F = cu(),
                            ...
                            D = F.mediaHeight,
                            r = F.mediaSize;
                        return a().createElement('div', xu({ className: lu()(A, fu[E], vu[D], wu[r]) }, t), e);
                    },
                    pu = ['children'];
                const Lu = (u) => {
                    let e = u.children,
                    ...
                    return a().createElement(iu, null, a().createElement(bu, A, e));
                };
                function Su() {
                    return !1;
                }
                                                ...
                                                return {
                                                    subscribe: (A, E) => {
                                                        const r = 'string' == typeof E ? `${t}.${E}` : t,
                                                            a = Y.view.addModelObserver(r, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, A = Tu(F.keys()); !(u = A()).done;) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(t),
                ...
                const Pu = (u, e, A) => {
                    ...
                    zu = (u, e, A = Gu.left) => u.split(e).reduce(A === Gu.left ? Pu : $u, []),
                    ku = (() => {
                        const u = new RegExp(
                        ...
                        return ju.includes(A)
                            ...
                            : ((u, e = Gu.left) => {
                                  ...
                                  const t =
                                      ...
                                      F = u.replace(/&nbsp;/g, ' ');
                                  return (zu(F, /( )/, e).forEach((u) => (A = A.concat(zu(u, t, Gu.left)))), A);
                              })(u, e);
                    },
                    Nu = 'FormatText_base_d0',
                    Vu = ({ binding: u, text: e = '', classMix: A, alignment: t = Gu.left }) =>
                        null === e
                            ...
                            : a().createElement(
                                  ...
                                  e.split('\n').map((e, F) =>
                                      a().createElement(
                                          'div',
                                          { className: lu()(Nu, A), key: `${e}-${F}` },
                                          ((u, e, A) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (A && u in A ? A[u] : Uu(u, e))))(e, t, u).map((u, e) =>
                    ...
                    Qu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Ku = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Zu = (0, r.memo)(({ text: u, binding: e, classMix: A }) => {
                                ...
                                ((D = D.replace(A, `%(${E})`)),
                                    (F[E] = Xu[u]
                                        ? a().createElement(
                                              'span',
                                              { className: Xu[u] },
                                              a().createElement(Vu, { text: i, binding: e }),
                                          )
                                        : a().createElement(
                                              'span',
                                              { style: t(u) },
                        ...
                        return a().createElement(Vu, { text: D, classMix: A, binding: F });
                    }),
                    Ju = 'App_base_4e',
                    Yu = 'App_video_ef',
                    ue = 'App_contentInner_e8',
                    ee = 'App_contentInnerClosing_30',
                    Ae = 'App_content_f5',
                    te = 'App_textContainer_a5',
                    Fe = 'App_text_d7',
                    Ee = 'App_shineLineAnimation_77',
                    De = 'App_lightRedAnimation_2d';
                var re;
                !(function (u) {
                ...
                const ae = (0, Iu.Pi)(() => {
                    ...
                    return (
                        ...
                        (0, r.useEffect)(() => {
                            if (F !== re.Closing) return;
                            const u = setTimeout(() => {
                                const u = l.current;
                                (u && (u.removeAttribute('src'), u.load()), E(re.Idle), A.onHintClosed());
                            }, 200);
                            return () => clearTimeout(u);
                        }, [F]),
                        F === re.Idle
                            ...
                            : a().createElement(
                                  ...
                                  a().createElement(
                                      ...
                                      a().createElement(
                                          'div',
                                          { className: lu()(ue, { [ee]: F === re.Closing }) },
                                          C.video &&
                                          ...
                                          C.text &&
                                              a().createElement(
                                                  'div',
                                                  { className: te },
                                                  a().createElement(Zu, { classMix: Fe, text: C.text }),
                                              ),
                                      ),
                                  ),
                              )
                ...
                engine.whenReady.then(() => {
                    n().render(
                        a().createElement(Mu, null, a().createElement(Lu, null, a().createElement(ae, null))),
