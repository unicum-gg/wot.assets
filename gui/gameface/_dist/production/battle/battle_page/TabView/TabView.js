    ...
    var __webpack_modules__ = {
            ...
            5705: (e, u, t) => {
                ...
                const de = {
                    ...
                    ye = (0, r.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = fe, onDrag: a = be }) => {
                                ...
                                ((t.style.transform = `translateY(${0 | m}px)`),
                                    ((e) => {
                                        if (s.current && l.current && c.current && d.current) {
                                            if (0 === Math.round(e))
                                                return (
                                                    s.current.classList.add(Ie),
                                                    void l.current.classList.remove(Ie)
                                                );
                                            if (
                                                ((u = c.current),
                                                (t = d.current),
                                                ...
                                                return (
                                                    s.current.classList.remove(Ie),
                                                    void l.current.classList.add(Ie)
                                                );
                                            var u, t;
                        ...
                        return i().createElement(
                            ...
                            i().createElement(
                                ...
                                'right' === u &&
                                    i().createElement(
                                        'div',
                                        { className: hu.suffixBanner, 'data-bind-if': `{{${e}.userName}} !== ''` },
                                        i().createElement('div', {
                    ...
                    Vt = (e) => {
                        ...
                        return i().createElement(
                            ...
                            i().createElement(
                                ...
                                'left' === n && i().createElement(bu, { path: u }),
                                i().createElement('div', {
