(() => {
    var __webpack_modules__ = {
            ...
            1621: (u, e, t) => {
                ...
                const F = E.O.client.getSize('rem'),
                    l = F.width,
                    D = F.height,
                    s = Object.assign({ width: l, height: D }, o(l, D, i)),
                ...
                const L = {
                    ...
                    T = (u) => {
                        ...
                        const a = f(),
                            ...
                            i = a.mediaHeight,
                            A = a.mediaSize;
                        return n().createElement('div', S({ className: h()(t, L[E], M[i], O[A]) }, r), e);
                    },
                    y = ['children'];
                const k = (u) => {
                    let e = u.children,
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (G(t, c, { isMouseEvent: !0, on: !0, arguments: W(n) }, v),
                                    m && m(),
                ...
                const V = R.views.common.tooltip_window.simple_tooltip_content,
                    q = (u) => {
                        ...
                        const F = (0, r.useMemo)(() => {
                            const u = Object.assign({}, A, { body: t, header: a, note: E, alert: i });
                            ...
                            X(
                                {
                                    contentId:
                                        ...
                                        l ? V.SimpleTooltipHtmlContent('resId') : V.SimpleTooltipContent('resId')),
                ...
                const Q = ['__left', '__right', '__top', '__bottom'],
                    J = (0, r.forwardRef)(
                        ({ children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: a = {} }, i) => {
                            const A = (0, r.useRef)(null),
                                o = (0, r.useRef)(null),
                                F = (0, r.useRef)(null),
                                l = (0, r.useState)(window.decorator && window.decorator.directionType),
                                D = l[0],
                                s = l[1],
                                c = (0, r.useCallback)(() => {
                                    ($.playClick(), E.O.view.sendEvent.close());
                                }, []),
                                B = (0, r.useCallback)(() => {
                                    $.playHighlight();
                                }, []),
                                _ = h()(Y.arrow, Y[`arrow${Q[D]}`]);
                            K(
                                () => (
                                    ...
                                    () => (
                                        ...
                                        ((u) => {
                                            ...
                                            if (o.current) {
                                                ...
                                                (E.O.view.resize(u, e), s(window.decorator.directionType));
                                            }
                                        })
                                    ),
                                    [],
                            ...
                            return (
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement('div', { className: _, style: a.arrow }),
                                    ),
                                )
                            );
                        },
                ...
                const tu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    ...
                    nu = [v.ExtraLarge, v.Large, v.Medium, v.Small, v.ExtraSmall],
                    au = (u, e) =>
                ...
                const Fu = {
                    ...
                    su = Eu((u) => {
                        let e = u.className,
                            ...
                            _ = u.row,
                            d = u.flexDirection,
                            C = void 0 === d ? (B ? 'column' : _ && 'row') || void 0 : d,
                            m = u.flexStart,
                            g = u.center,
                            p = u.flexEnd,
                            v = u.spaceBetween,
                            ...
                            f =
                                void 0 === b
                                    ...
                                    : b,
                            x = u.alignItems,
                            S = void 0 === x ? (m ? 'flex-start' : g && 'center') || (p && 'flex-end') || void 0 : x,
                            L = u.alignSelf,
                            M = u.wrap,
                            O = u.flexWrap,
                            ...
                            y = u.shrink,
                            k = u.flex,
                            H = void 0 === k ? (R || y ? `${R ? 1 : 0} ${y ? 1 : 0} auto` : void 0) : k,
                            P = u.style,
                            N = u.children,
                            I = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const W = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, A, F, D, c, P, H, L, C, T, f, S]),
                            G = W.computedStyle,
                            U = W.computedClassNames;
                        return n().createElement('div', ou({ className: h()(iu.base, ...U, e), style: G }, I), N);
                    });
                let cu;
                !(function (u) {
                ...
                const Bu = (u, e, t) => {
                    ...
                    du = (u, e, t = cu.left) => u.split(e).reduce(t === cu.left ? Bu : _u, []),
                    Cu = (() => {
                        const u = new RegExp(
                        ...
                        return mu.includes(t)
                            ...
                            : ((u, e = cu.left) => {
                                  ...
                                  const r =
                                      ...
                                      n = u.replace(/&nbsp;/g, ' ');
                                  return (du(n, /( )/, e).forEach((u) => (t = t.concat(du(u, r, cu.left)))), t);
                              })(u, e);
                    },
                    gu = 'FormatText_base_d0',
                    pu = ({ binding: u, text: e = '', classMix: t, alignment: a = cu.left }) =>
                        null === e
                            ...
                            : n().createElement(
                                  ...
                                  e.split('\n').map((e, E) =>
                                      n().createElement(
                                          'div',
                                          { className: h()(gu, t), key: `${e}-${E}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : hu(u, e))))(e, a, u).map((u, e) =>
                ...
                const Su = Object.keys(wu()),
                    ...
                    ku = Eu((u) => {
                        ...
                        return n().createElement(
                            ...
                            void 0 !== d ? n().createElement(pu, xu({}, d, { text: e })) : e,
                        );
                    });
                var Hu = t(5521);
                const Pu = (u) => {
                ...
                function Nu(u = Hu.n.NONE, e = Pu, t = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Hu.n.NONE)
                            return (
                ...
                const Ku = ((u, e) => {
                        ...
                        return [
                            function ({ mode: a = 'real', options: i, children: A, mocks: o }) {
                                const F = (0, r.useRef)([]),
                                    l = (t, r, n) => {
                                        ...
                                        const i = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Uu(n.keys()); !(u = t()).done;) a(u.value, e);
                                                    },
                                                    unsubscribe: a,
                                                };
                                            })(r),
                                    ...
                                    c = s[0],
                                    B = s[1],
                                    _ = (0, r.useState)(() => l(a, i, o)),
                                    d = _[0],
                                    C = _[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        D.current ? C(l(c, i, o)) : (D.current = !0);
                                    }, [o, c, i]),
                                    (0, r.useEffect)(() => {
                                        B(a);
                                    }, [a]),
                        ...
                        ({ observableModel: u }) => {
                            const e = { skills: u.object('skills') },
                                t = u.array('skills.items'),
                                r = (0, qu.Om)(() => t.get().length),
                                n = (0, qu.Om)(
                                    () => {
                                        return ((u = t.get()), Vu(u));
                                        var u;
                                ...
                                a = (0, qu.Om)(() => n().find((u) => u.isEquipped), { equals: Wu }),
                                E = (0, qu.Om)(
                                    (u) => {
                                        const e = n().at(u);
                                        if (!e) throw new Error(`skill with index ${u} was not found`);
                                        return e;
                                    },
                                    { equals: Wu },
                                );
                            return Object.assign({}, e, {
                                computes: { skillsItem: E, skillsItemsLength: r, equippedSkillsItem: a },
                            });
                        },
                        ({ externalModel: u }) => ({
                            onClose: u.createCallbackNoArgs('onClose'),
                            onEquip: u.createCallback((u) => ({ intCD: u }), 'onEquip'),
                        }),
                    ),
                    zu = Ku[0],
                    $u = Ku[1],
                    Yu = 'App_base_fd',
                    Zu = 'App_header_2d',
                    Qu = 'App_headerText_43',
                    Ju = 'App_skills_05',
                    ue = 'App_skillsItems_8e',
                    ee = 'App_skillsShadow_68',
                    te = 'App_skillsShadow__top_e0',
                    re = 'App_skillsShadow__bottom_40',
                    ne = ['children'];
                function ae() {
                    return (
                        (ae =
                ...
                const Ae = 'RoleSkill_base_f9',
                    oe = 'RoleSkill_dividerWrapper_23',
                    Fe = 'RoleSkill_bg_84',
                    le = 'RoleSkill_bg__hover_ed',
                    De = 'RoleSkill_bg__selected_62',
                    se = 'RoleSkill_bg__selected__hover_6e',
                    ce = 'RoleSkill_bgEquipped_81',
                    Be = 'RoleSkill_dividerTop_cc',
                    _e = 'RoleSkill_dividerBottom_be',
                    de = 'RoleSkill_wrapper_7b',
                    Ce = 'RoleSkill_imageWrapper_04',
                    me = 'RoleSkill_imageWrapper__equipped_30',
                    he = 'RoleSkill_image_28',
                    ge = 'RoleSkill_text_85',
                    pe = 'RoleSkill_text__equipped_6c',
                    ve = R.strings.artefacts,
                    we = (0, Iu.Pi)(({ index: u, classNames: e }) => {
                        const t = $u(),
                            a = t.model,
                            E = t.controls,
                            i = a.computes.skillsItem(u),
                            A = i.name,
                            o = i.intCD,
                            F = i.isEquipped,
                            l = (0, r.useState)(!1),
                            D = l[0],
                            s = l[1],
                            c = String(ve.$dyn(A).$dyn('name')),
                            B = R.images.gui.maps.icons.roleSkills.c_80x80.$dyn(A),
                            _ = ie(),
                            d = h()(Ae, e),
                            C = h()(Fe, { [le]: D, [De]: F, [se]: D && F }),
                            m = h()(Ce, { [me]: F }),
                            g = h()(ge, { [pe]: F });
                        return (
                            (0, r.useEffect)(() => {
                                if (_.isRunning) return () => _.clear();
                            }, [_]),
                            n().createElement(
                                Ee,
                                { args: { intCD: o } },
                                n().createElement(
                                    ...
                                    F && n().createElement('div', { className: ce }),
                                    n().createElement(
                                        'div',
                                        { className: de },
                                        ...
                                        n().createElement(ku, { text: c, className: g }),
                                    ),
                                    n().createElement(
                                        'div',
                                        { className: oe },
                    ...
                    be = R.strings.comp7.skillSelectPopover,
                    fe = (0, Iu.Pi)(() => {
                        const u = $u(),
                            e = u.model,
                            t = u.controls.onClose,
                            r = e.computes.skillsItemsLength();
                        return (
                            Nu(Hu.n.ESCAPE, t),
                            n().createElement(
                                J,
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: Zu },
                                        n().createElement(ku, { text: be.title(), className: Qu }),
                                    ),
                                    n().createElement(
                                        'div',
                                        { className: Ju },
                                        n().createElement('div', { className: h()(ee, te) }),
                                        n().createElement(
                                            'div',
                                            { className: ue },
                                            ((u, e) => {
                                                ...
                                                return t;
                                            })(r, (u) => n().createElement(we, { key: u, index: u })),
                                        ),
                                        n().createElement('div', { className: h()(ee, re) }),
                                    ),
                                ),
                            )
                        );
                ...
                engine.whenReady.then(() => {
                    P().render(
                        n().createElement(k, null, n().createElement(zu, null, n().createElement(fe, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [532], () => __webpack_require__(1621));
