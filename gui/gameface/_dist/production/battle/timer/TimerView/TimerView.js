(() => {
    ...
    class l extends HTMLElement {
        ...
        addEventListener(e, t = '_', i = () => {}) {
            e && (e.addEventListener(t, i), this.__eventListeners.push({ el: e, eventName: t, callback: i }));
        }
        __render() {
            const e = this.render(this.__data() || {});
            if (!e || !e.isWGFE) return void console.warn('WGFE: WGFE template should be returned from render method');
        ...
        __cleanup() {
            this.children.length && Array.prototype.slice.apply(this.children).forEach((e) => this.removeChild(e));
        }
        render() {
            console.warn('WGFE: render method required');
        }
        data() {
            return {};
        }
    ...
    const a = 'long',
        ...
        d = (e, t, i) => {
            const s = Math.trunc(e / 1e3),
                l = Math.trunc(e / 100) / 10,
                a = Math.floor(s / 3600),
                n = Math.floor((s - 3600 * a) / 60);
            return {
                minutes: n,
                seconds: s - 3600 * a - 60 * n,
                secondsLeft: s,
                milliseconds: i ? '.' + 10 * (l % 1).toFixed(1) : '',
            };
        };
    function m(e, t, i, s) {
        let l = Date.now();
        ...
        class {
            init(e, [t, i, s]) {
                m(t, 0, s, (t) => {
                    ...
                    })(t.minutes, t.seconds, t.secondsLeft, t.milliseconds, i);
                });
            }
        },
    );
    const o = {
        base: 'Timer_base_de1c9',
        mask: 'Timer_mask_b001f',
        inner: 'Timer_inner_de7d3',
        newDigits: 'Timer_newDigits_e0c44',
        currentDigits: 'Timer_currentDigits_d62de',
        newValue: 'Timer_newValue_db36c',
        newValue__animated: 'Timer_newValue__animated_c57ba',
        'flip-new-value': 'Timer_flip-new-value_c899c',
        currentValue__animated: 'Timer_currentValue__animated_d196f',
        'flip-current-value': 'Timer_flip-current-value_ed26a',
    };
    const v = (e, t) => {
            let i = String(e);
                    ...
                    ((l = a),
                        ...
                        (e.innerHTML = ((e, t, i, s, l) => {
                            switch (s) {
                                case n:
                                    return l
                                        ? p(v(e.secondsLeft, i), v(t.secondsLeft, i))
                                        : p(e.secondsLeft, t.secondsLeft);
                                case r:
                                    return p(c(e.seconds), c(t.seconds));
                                default:
    ...
    const _ = {
        boxWrapper: 'TimerExamples_boxWrapper_b1be5',
        inner: 'TimerExamples_inner_bbd2d',
        row: 'TimerExamples_row_e6de5',
        holder: 'TimerExamples_holder_ba55f',
        caption: 'TimerExamples_caption_f4874',
        example1: 'TimerExamples_example1_c3658',
        example1_timer: 'TimerExamples_example1_timer_f619c',
        example2_timer: 'TimerExamples_example2_timer_b2824',
        example3_timer: 'TimerExamples_example3_timer_cc855',
        example4: 'TimerExamples_example4_c4822',
        example4_timer: 'TimerExamples_example4_timer_c92a3',
        example4_text: 'TimerExamples_example4_text_f364c',
        example5: 'TimerExamples_example5_aec01',
        example5_timer: 'TimerExamples_example5_timer_a6619',
        example5_text: 'TimerExamples_example5_text_c3e87',
        example5_glow: 'TimerExamples_example5_glow_ce732',
        example6: 'TimerExamples_example6_e3e2f',
        example6_circle: 'TimerExamples_example6_circle_b407c',
        example6_text: 'TimerExamples_example6_text_c1417',
        example6_timer: 'TimerExamples_example6_timer_eb03f',
    };
    (customElements.define(
        ...
        class extends l {
            ...
            render() {
                const e = this.getAttribute('model'),
                    t = this.getAttribute('type') || a,
                    i = null !== this.getAttribute('hasMilliseconds'),
                    l = this.getAttribute('mixClass');
                return null === e
                    ? s``
                    : s`
            <div
                class="${o.base} ${l}"
                data-bind-timer="[{{${e}.seconds}}, '${t}', '${i}']"></div>`;
            }
        },
    ),
        customElements.define(
            ...
            class extends l {
                ...
                render() {
                    const e = this.getAttribute('model');
                    if (null === e) return s``;
                    const t = this.getAttribute('type') || a,
                        i = this.getAttribute('mixClass'),
                        l = null !== this.getAttribute('hasZerosInShort');
                    return s`
            <div class="${o.base} ${i}">
                <div class="${o.mask}"
        ...
        customElements.define(
            ...
            class extends l {
                ...
                render() {
                    const e = this.getAttribute('view-state-model');
                    return null === e
                        ? s``
                        : s`
