(() => {
    ...
    const o = {
        base: 'Timer_base_8d',
        mask: 'Timer_mask_ed',
        inner: 'Timer_inner_ef',
        newDigits: 'Timer_newDigits_c9',
        currentDigits: 'Timer_currentDigits_a8',
        newValue: 'Timer_newValue_64',
        newValue__animated: 'Timer_newValue__animated_24',
        'flip-new-value': 'Timer_flip-new-value_3d',
        currentValue__animated: 'Timer_currentValue__animated_4d',
        'flip-current-value': 'Timer_flip-current-value_ef',
    };
    const v = (e, t) => {
            let i = String(e);
    ...
    const _ = {
        boxWrapper: 'TimerExamples_boxWrapper_a1',
        inner: 'TimerExamples_inner_8d',
        row: 'TimerExamples_row_f7',
        holder: 'TimerExamples_holder_31',
        caption: 'TimerExamples_caption_a2',
        example1: 'TimerExamples_example1_0c',
        example1_timer: 'TimerExamples_example1_timer_ae',
        example2_timer: 'TimerExamples_example2_timer_f6',
        example3_timer: 'TimerExamples_example3_timer_d2',
        example4: 'TimerExamples_example4_2f',
        example4_timer: 'TimerExamples_example4_timer_6d',
        example4_text: 'TimerExamples_example4_text_76',
        example5: 'TimerExamples_example5_df',
        example5_timer: 'TimerExamples_example5_timer_72',
        example5_text: 'TimerExamples_example5_text_cc',
        example5_glow: 'TimerExamples_example5_glow_be',
        example6: 'TimerExamples_example6_c0',
        example6_circle: 'TimerExamples_example6_circle_cd',
