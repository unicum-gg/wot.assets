(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => a, off: () => i, on: () => o, onResize: () => n, onScaleUpdated: () => F }));
                var E = t(2472),
                    A = t(1176);
            ...
            1119: (u, e, t) => {
                ...
                const B = (u, e, t = {}, E = 0) => {
                        ...
                        const b = (0, E.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            k = (0, E.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (B(t, _, { isMouseEvent: !0, on: !0, arguments: s(A) }, f),
                                    w && w(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((b.current.timeoutId = window.setTimeout(k, a ? 100 : 400)),
                                                          n && n(u),
                                                          T && T(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                                                  (y(), null == F || F(e), null == u || u(e));
                    ...
                    l = ({
                        ...
                        const r = i()(
                                ...
                                F && 'PaginationRender_base__completed_69',
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                'div',
                                { className: r, onClick: s, onMouseEnter: B },
                ...
                const d = ({ className: u, selectedStep: e, data: t, onChange: n }) => {
                        const F = t.length - 1,
                                    ...
                                    _(
                                        {
                                            ...
                                            className: i()(
                                                ...
                                                t === F && 'PaginationList_item__last_ec',
                                            ),
                                            isSelected: e === t,
                                            key: t,
                                        },
                ...
                const m = ({ onClick: u, direction: e, isLocked: t, tooltipArgs: n, className: F }) => {
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                'div',
                                { className: s },
                                A().createElement('div', { className: o, onClick: a, onMouseEnter: r }),
                            ),
                        );
                    },
                    w = ({ className: u, hasArrow: e, arrowOffset: t, selectedIndex: n, children: F }) => {
                        t = t || 0;
                        const o = (0, E.useMemo)(
                                () =>
                                    F.map((u) => ({
                            ...
                            w = 0 === s,
                            h = s === D,
                            g = (0, E.useMemo)(() => (w ? void 0 : F[s - 1].tooltipArgs), [F, w, s]),
                            b = (0, E.useMemo)(() => (h ? void 0 : F[s + 1].tooltipArgs), [F, h, s]);
                        return A().createElement(
                            'div',
                            { className: _ },
                            A().createElement(
                                ...
                                A().createElement('div', { style: v }, F[s].render()),
                                e &&
                                    A().createElement(m, {
                                        onClick: l,
                                        direction: p.Forward,
                ...
                class f extends A().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            C = i()(h.base, h[`base__${F}`], h[`base__${n}`], null == o ? void 0 : o.base),
                            c = i()(h.icon, h[`icon__${F}`], h[`icon__${n}`], null == o ? void 0 : o.icon),
                            l = i()(h.glow, null == o ? void 0 : o.glow),
                            _ = i()(h.caption, h[`caption__${F}`], null == o ? void 0 : o.caption),
                        ...
                        return A().createElement(
                            ...
                            'info' !== F && A().createElement('div', { className: h.shine }),
                ...
                const L = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    I = (u, e, t = M.left) => u.split(e).reduce(t === M.left ? S : N, []),
                    V = (() => {
                        const u = new RegExp(
                    ...
                    H = ['zh_cn', 'zh_sg', 'zh_tw'],
                    U = ({ binding: u, text: e = '', classMix: t, alignment: n = M.left, formatWithBrackets: F }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const o = F && u ? ((D = u), e.replace(/\{\w+\}/g, (u) => String(D[u.slice(1, -1)]))) : e;
                        var D;
                        return A().createElement(
                            E.Fragment,
                            null,
                            o.split('\n').map((e, F) =>
                                A().createElement(
                                    'div',
                                    { className: i()('FormatText_base_d0', t), key: `${e}-${F}` },
                                    ((u, e, t) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                            t && u in t
                                                ? t[u]
                    ...
                    G = ({
                        ...
                        var n;
                        ((n = () => k.O.view.sendEvent.close()), T(y.n.ESCAPE, n));
                    ...
                    q = R.strings.halloween_battle.helpDefence,
                    K = R.strings.halloween_battle.helpDefence.title();
                engine.whenReady.then(() => {
                    F().render(
                        A().createElement(G, {
                            hintsNum: 2,
                            localePath: q,
                            bgPath: 'R.images.halloween.gui.maps.icons.battle.eventLoading.tipsDefence.c_1024x600.tipBg_',
                            title: K,
                        }),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1119));
