(() => {
            ...
            6332: (u, e, t) => {
                ...
                (0, E.memo)((u) => {
                    ...
                    const r = (0, E.useContext)(o),
                        ...
                        w = { extraLarge: _, large: m, medium: g, small: h, extraSmall: v };
                ...
                const p = {
                    ...
                    x = (u) => {
                        ...
                        const a = h(),
                            ...
                            n = a.mediaHeight,
                            F = a.mediaSize;
                        return r().createElement('div', w({ className: C()(t, p[A], b[n], f[F]) }, E), e);
                    },
                    L = ['children'],
                    y = (u) => {
                        let e = u.children,
                            ...
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    t ||
                                        (null !== c && M(c),
                                        F && F(u),
                                        s && (t || (d.current && (d.current.focus(), g(!0)))),
                                        w(!0));
                                },
                ...
                function I(u = W.n.NONE, e = N, t = !1, r = !1) {
                    (0, E.useEffect)(() => {
                        if (u !== W.n.NONE)
                            return (
                    ...
                    ({
                        ...
                        r().createElement(
                            'div',
                            {
                                className: C()(
                                    'Background_base_94',
                                    a && 'Background_base__blur_69',
                                    A && 'Background_base__grayscale_1b',
                                    u,
                                ),
                                style: { backgroundImage: `url(${e})` },
                            },
                            E && r().createElement('div', { className: 'Background_vignette_79' }),
                            t &&
                                r().createElement('img', {
                ...
                const $ = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    K = (u, e, t = z.left) => u.split(e).reduce(t === z.left ? V : q, []),
                    Y = (() => {
                        const u = new RegExp(
                            [
                    ...
                    X = ['zh_cn', 'zh_sg', 'zh_tw'],
                    Z = 'Lore_glow_68',
                    Q = (0, E.memo)(({ className: u, folder: e, text: t }) => {
                        const a = ((u) => {
                                const e = h().mediaSize;
                                return u
                                    ? e >= _.ExtraLarge
                            ...
                            A = a ? { backgroundImage: `url(${a})` } : void 0;
                        return r().createElement(
                            'div',
                            { className: C()('Lore_base_eb', u) },
                            r().createElement(
                                'div',
                                { className: 'Lore_content_63' },
                                r().createElement('div', { className: C()(Z, 'Lore_glow__top_b7') }),
                                r().createElement('div', { className: C()(Z, 'Lore_glow__bottom_f7') }),
                                r().createElement('div', { className: 'Lore_line_43' }),
                                r().createElement('div', { className: 'Lore_photos_ba', style: A }),
                                r().createElement(
                                    'div',
                                            ...
                                            (u, e) => (
                                                ...
                                                r().createElement(
                                                    ...
                                                    ((u, e, t) =>
                                                        ...
                                                        r().createElement(E.Fragment, { key: e }, u),
                                                    ),
                                                )
                                            ),
                                        ),
                ...
                const tu = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    ru = Eu[0],
                    au = Eu[1],
                    Au = R.images.story_mode.gui.maps.icons.epilogue,
                    nu = R.strings.sm_battle.epilogue.text(),
                    Fu = (0, G.Pi)(() => {
                        const u = au().controls;
                        return (
                            ((u) => {
                            ...
                            r().createElement(
                                ...
                                r().createElement('div', { className: 'EpilogueWindowApp_shining_f3' }),
                                r().createElement(
                                    'div',
                                    { className: 'EpilogueWindowApp_title_aa' },
                                    R.strings.sm_battle.epilogue.title(),
                                ),
                                r().createElement(Q, { className: 'EpilogueWindowApp_lore_ce', folder: Au, text: nu }),
                                r().createElement(
                                    'div',
                                    { className: 'EpilogueWindowApp_continueButton_57' },
                                    r().createElement(
                                        P,
                                        { size: H.medium, type: k.primary, onClick: u.close },
                ...
                engine.whenReady.then(() => {
                    O().render(
                        r().createElement(ru, null, r().createElement(y, null, r().createElement(Fu, null))),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'battle/EpilogueWindow/EpilogueWindow'),
        (() => {
            var u = { 'battle/EpilogueWindow/EpilogueWindow': 0 };
