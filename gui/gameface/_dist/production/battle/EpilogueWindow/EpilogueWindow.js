    ...
    var __webpack_modules__ = {
            ...
            5558: (u, e, t) => {
                ...
                const L = {
                    ...
                    O = (u) => {
                        ...
                        const a = f(),
                            ...
                            n = a.mediaHeight,
                            F = a.mediaSize;
                        return r().createElement('div', x({ className: m()(t, L[A], y[n], S[F]) }, E), e);
                    },
                    M = ['children'],
                    T = (u) => {
                        let e = u.children,
                            ...
                            'div',
                            {
                                ...
                                onMouseDown: function (u) {
                                    A ||
                                        (null !== i && P(i),
                                        s && s(u),
                                        t && (A || (c.current && (c.current.focus(), g(!0)))),
                                        w(!0));
                                },
                ...
                const X = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    J = (u, e, t = Y.left) => u.split(e).reduce(t === Y.left ? Z : Q, []),
                    uu = (() => {
                        const u = new RegExp(
                    ...
                    tu = 'Lore_glow_68',
                    Eu = (0, E.memo)(({ className: u, folder: e, text: t }) => {
                        const a = ((u) => {
                                const e = f().mediaSize;
                                return u
                                    ? e >= v.ExtraLarge
                        ...
                        return r().createElement(
                            'div',
                            { className: m()('Lore_base_eb', u) },
                            r().createElement(
                                'div',
                                { className: 'Lore_content_63' },
                                r().createElement('div', { className: m()(tu, 'Lore_glow__top_b7') }),
                                r().createElement('div', { className: m()(tu, 'Lore_glow__bottom_f7') }),
                    ...
                    lu = (0, $.Pi)(() => {
                        ...
                        return (
                            ...
                            r().createElement(
                                ...
                                r().createElement(Eu, { className: 'EpilogueWindowApp_lore_ce', folder: ou, text: su }),
                                r().createElement(
                                    'div',
                                    { className: 'EpilogueWindowApp_continueButton_57' },
                                    r().createElement(
                                        U,
                                        { size: I.medium, type: N.primary, onClick: u.close },
                ...
                engine.whenReady.then(() => {
                    H().render(
                        r().createElement(iu, null, r().createElement(T, null, r().createElement(lu, null))),
