(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => r, off: () => i, on: () => o, onResize: () => F, onScaleUpdated: () => n }));
                var E = t(2472),
                    A = t(1176);
            ...
            9916: (u, e, t) => {
                ...
                function l(u, e, t, E, A, F, n) {
                    ...
                    o.done ? e(i) : Promise.resolve(i).then(E, A);
                }
                ...
                const h = A.instance,
                    g = {
                        ...
                        sendShowContextMenuEvent: (u, e, t = 0) => {
                            v(o.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                        },
            ...
            120: (u, e, t) => {
                ...
                const s = (u, e, t = {}, E = 0) => {
                        ...
                        const b = (0, E.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            k = (0, E.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (s(t, _, { isMouseEvent: !0, on: !0, arguments: B(A) }, f),
                                    w && w(),
                                      ...
                                      Object.assign(
                                          {
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((b.current.timeoutId = window.setTimeout(k, r ? 100 : 400)),
                                                          F && F(u),
                                                          T && T(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                                              ...
                                              onClick: ((u) => (e) => {
                                                  (!1 === c && y(), null == i || i(e), null == u || u(e));
                                              })(e.props.onClick),
                                              onMouseDown: ((u) => (e) => {
                                                  (!1 === c && y(), null == o || o(e), null == u || u(e));
                                              })(e.props.onMouseDown),
                                          },
                                          g,
                                      ),
                    ...
                    c = ({ tooltipArgs: u, children: e }) => (u ? A().createElement(C, u, e) : e),
                    l = ({
                        className: u,
                        index: e,
                        onClick: t,
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                'div',
                                { className: a, onClick: B, onMouseEnter: s },
                                F && A().createElement('span', { className: 'PaginationRender_selectedImage_58' }),
                                e + 1,
                            ),
                        );
                    };
                ...
                const d = ({ className: u, selectedStep: e, data: t, onChange: F }) => {
                        const n = t.length - 1,
                            o = i()('PaginationList_base_94', u),
                            D = (0, E.useCallback)(
                                (u) => {
                                    F(u);
                                },
                ...
                const m = ({ onClick: u, direction: e, isLocked: t, tooltipArgs: F, className: n }) => {
                        const o = i()(v.icon, v[`icon__${e}`]),
                            r = (0, E.useCallback)(() => {
                                t || (u(), D('play'));
                            }, [u, t]),
                            a = (0, E.useCallback)(() => {
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                'div',
                                { className: B },
                                A().createElement('div', { className: o, onClick: r, onMouseEnter: a }),
                            ),
                        );
                    },
                    w = ({ className: u, hasArrow: e, arrowOffset: t, selectedIndex: F, children: n }) => {
                        t = t || 0;
                        const o = (0, E.useMemo)(
                                () =>
                                    n.map((u) => ({
                            ...
                            _ = i()('Pagination_base_50', u),
                            v = (0, E.useMemo)(() => ({ marginLeft: t, marginRight: t }), [t]),
                            w = 0 === B,
                            h = B === D,
                            g = (0, E.useMemo)(() => (w ? void 0 : n[B - 1].tooltipArgs), [n, w, B]),
                            b = (0, E.useMemo)(() => (h ? void 0 : n[B + 1].tooltipArgs), [n, h, B]);
                        return A().createElement(
                            'div',
                            { className: _ },
                            A().createElement(
                                ...
                                A().createElement('div', { style: v }, n[B].render()),
                                e &&
                                    A().createElement(m, {
                                        onClick: l,
                                        direction: p.Forward,
                ...
                class f extends A().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            C = i()(h.base, h[`base__${n}`], h[`base__${F}`], null == o ? void 0 : o.base),
                            c = i()(h.icon, h[`icon__${n}`], h[`icon__${F}`], null == o ? void 0 : o.icon),
                            l = i()(h.glow, null == o ? void 0 : o.glow),
                            _ = i()(h.caption, h[`caption__${n}`], null == o ? void 0 : o.caption),
                            d = i()(h.goto, null == o ? void 0 : o.goto);
                        return A().createElement(
                            'div',
                            b(
                                {
                            ...
                            'info' !== n && A().createElement('div', { className: h.shine }),
                            A().createElement('div', { className: c }, A().createElement('div', { className: l })),
                            A().createElement('div', { className: _ }, e),
                            E && A().createElement('div', { className: d }, E),
                        );
                    }
                }
                ...
                function T(u = y.n.NONE, e = O, t = !1, A = !1) {
                    (0, E.useEffect)(() => {
                        ...
                        function E(E) {
                            if (E.keyCode === u) {
                                if (!A && k.O.view.isEventHandled()) return;
                                (k.O.view.setEventHandled(), e(E), t && E.stopPropagation());
                            }
                        }
                    }, [e, u, t, A]);
                }
                ...
                const S = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    I = (u, e, t = M.left) => u.split(e).reduce(t === M.left ? L : N, []),
                    V = (() => {
                        const u = new RegExp(
                    ...
                    H = ['zh_cn', 'zh_sg', 'zh_tw'],
                    U = ({ binding: u, text: e = '', classMix: t, alignment: F = M.left, formatWithBrackets: n }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const o = n && u ? ((D = u), e.replace(/\{\w+\}/g, (u) => String(D[u.slice(1, -1)]))) : e;
                        var D;
                        return A().createElement(
                            E.Fragment,
                            null,
                    ...
                    j = (0, E.memo)(function ({ sourceCount: u, className: e, bgPath: t, localePath: E }) {
                        return A().createElement(
                            'div',
                            { className: i()('HintSlide_base_38', e) },
                            A().createElement('div', {
                                className: 'HintSlide_hintIcon_1a',
                                style: { backgroundImage: `url(${t}${u})` },
                            }),
                            A().createElement(
                                'div',
                                { className: 'HintSlide_text_b8' },
                                A().createElement(U, { classMix: 'HintSlide_title_9f', text: E.$dyn(`title_${u}`) }),
                                A().createElement(U, {
                                    classMix: 'HintSlide_description_0d',
                                    text: E.$dyn(`description_${u}`),
                                }),
                            ),
                        );
                    }),
                    W = R.strings.halloween_battle.help,
                    z = R.strings.halloween_battle.help.title(),
                    G = ({
                        hintsNum: u = 4,
                        bgPath: e = 'R.images.halloween.gui.maps.icons.battle.eventLoading.tips.c_1024x600.tipBg_',
                        localePath: t = W,
                        title: E = z,
                    }) => {
                        var F;
                        ((F = () => k.O.view.sendEvent.close()), T(y.n.ESCAPE, F));
                        const n = new Array(u).fill(0),
                            o = (0, P.useSpring)({
                                from: { opacity: 0 },
                                to: { opacity: 1 },
                                delay: 300,
                        ...
                        return A().createElement(
                            P.animated.div,
                            { className: 'HelpViewApp_base_21', style: o },
                            A().createElement(
                                'div',
                                { className: 'HelpViewApp_content_3e' },
                                A().createElement(
                                    'div',
                                    { className: 'HelpViewApp_header_ae' },
                                    A().createElement('span', { className: 'HelpViewApp_title_e6' }, E),
                                    A().createElement(
                                        'div',
                                        { className: 'HelpViewApp_close_44' },
                                        A().createElement(f, {
                                            caption: R.strings.halloween_battle.common.close(),
                                            type: 'close',
                                            side: 'right',
                                            onClick: () => k.O.view.sendEvent.close(),
                                        }),
                                    ),
                                ),
                                A().createElement(
                                    w,
                                    { hasArrow: !0, selectedIndex: 0, className: 'HelpViewApp_pagination_4e' },
                                    n.map((u, E) => ({
                                        render: function () {
                                            return A().createElement(
                                                A().Fragment,
                                                ...
                                                A().createElement(j, {
                                                    sourceCount: E,
                                                    className: 'HelpViewApp_slide_a1',
                                                    bgPath: e,
                                                    localePath: t,
                                                }),
                                                A().createElement('div', { className: 'HelpViewApp_sizer_91' }),
                                            );
                                        },
                                    })),
                                ),
                                A().createElement('div', { className: 'HelpViewApp_bottomBg_31' }),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    n().render(A().createElement(G, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (i = 0; i < deferred.length; i++) {
                    for (var [e, t, E] = deferred[i], F = !0, n = 0; n < e.length; n++)
                        (!1 & E || A >= E) &&
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(120));
