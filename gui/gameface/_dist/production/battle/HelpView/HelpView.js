(() => {
    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                ...
                const b = o.instance,
                    g = {
                        ...
                        sendMoveEvent: (u) => w(A.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: m,
                        sendClosePopOverEvent: () => w(A.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, t = 0) => {
                            w(A.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                        },
            ...
            4686: (u, e, t) => {
                ...
                const l = (u, e, t = {}, n = 0) => {
                    ...
                    _ = (u) => {
                        ...
                        const f = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            k = (0, n.useMemo)(() => p || a().resId, [p]),
                            O = (0, n.useCallback)(() => {
                                (f.current.isVisible && f.current.timeoutId) ||
                                    (l(t, C, { isMouseEvent: !0, on: !0, arguments: D(o) }, k),
                                    h && h(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((f.current.timeoutId = window.setTimeout(O, s ? 100 : 400)),
                                                          i && i(u),
                                                          y && y(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                    ...
                    B = ({ tooltipArgs: u, children: e }) => (u ? o().createElement(_, u, e) : e),
                    d = ({
                        className: u,
                        index: e,
                        onClick: t,
                        ...
                        const s = A()(
                                ...
                                i && 'PaginationRender_base__selected_e1',
                                E && 'PaginationRender_base__completed_69',
                                r && 'PaginationRender_base__inaccessible_55',
                                u,
                            ),
                            c = (0, n.useCallback)(() => {
                                t(e), F('yes1');
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                'div',
                                { className: s, onClick: c, onMouseEnter: D },
                                i && o().createElement('span', { className: 'PaginationRender_selectedImage_58' }),
                                e + 1,
                            ),
                        );
                    };
                ...
                const v = ({ className: u, selectedStep: e, data: t, onChange: i }) => {
                        const E = t.length - 1,
                            r = A()('PaginationList_base_94', u),
                            F = (0, n.useCallback)(
                                (u) => {
                                    i(u);
                                },
                                    ...
                                    C(
                                        {
                                            ...
                                            className: A()(
                                                ...
                                                t === E && 'PaginationList_item__last_ec',
                                            ),
                                            isSelected: e === t,
                                            key: t,
                                        },
                ...
                const p = ({ onClick: u, direction: e, isLocked: t, tooltipArgs: i, className: E }) => {
                        const r = A()(w.icon, w[`icon__${e}`]),
                            a = (0, n.useCallback)(() => {
                                t || (u(), F('play'));
                            }, [u, t]),
                            s = (0, n.useCallback)(() => {
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                'div',
                                { className: c },
                                o().createElement('div', { className: r, onClick: a, onMouseEnter: s }),
                            ),
                        );
                    },
                    h = ({ className: u, hasArrow: e, arrowOffset: t, selectedIndex: i, children: E }) => {
                        t = t || 0;
                        const r = (0, n.useMemo)(
                                () =>
                                    E.map((u) => ({
                            ...
                            F = E.length - 1,
                            a = (0, n.useMemo)(() => {
                                const u = r.findIndex((u) => void 0 === u.isInaccessible && void 0 === u.isCompleted);
                                return -1 === u ? 0 : u;
                            }, [r]),
                            s = (0, n.useState)(i || a),
                            c = s[0],
                            ...
                            d = A()('Pagination_base_50', u),
                            C = (0, n.useMemo)(() => ({ marginLeft: t, marginRight: t }), [t]),
                            w = 0 === c,
                            h = c === F,
                            b = (0, n.useMemo)(() => (w ? void 0 : E[c - 1].tooltipArgs), [E, w, c]),
                            g = (0, n.useMemo)(() => (h ? void 0 : E[c + 1].tooltipArgs), [E, h, c]);
                        return o().createElement(
                            'div',
                            { className: d },
                            o().createElement(
                                ...
                                o().createElement('div', { style: C }, E[c].render()),
                                e &&
                                    o().createElement(p, {
                                        onClick: B,
                                        direction: m.Forward,
                ...
                class k extends o().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = A()(b.base, b[`base__${E}`], b[`base__${i}`], null == r ? void 0 : r.base),
                            _ = A()(b.icon, b[`icon__${E}`], b[`icon__${i}`], null == r ? void 0 : r.icon),
                            B = A()(b.glow, null == r ? void 0 : r.glow),
                            d = A()(b.caption, b[`caption__${E}`], null == r ? void 0 : r.caption),
                            C = A()(b.goto, null == r ? void 0 : r.goto);
                        return o().createElement(
                            'div',
                            f(
                                {
                            ...
                            'info' !== E && o().createElement('div', { className: b.shine }),
                            o().createElement('div', { className: _ }, o().createElement('div', { className: B })),
                ...
                (k.defaultProps = { side: 'left', type: 'back', soundHover: 'highlight', soundClick: 'play' }),
                    ...
                    ((M = T || (T = {})).SHORT_DATE = 'short-date'),
                    (M.SHORT_TIME = 'short-time'),
                    (M.SHORT_DATE_TIME = 'short-date-time'),
                    (M.FULL_DATE = 'full-date'),
                    (M.FULL_DATE_TIME = 'full-date-time'),
                    (M.MONTH = 'month'),
                    (M.MONTH_DATE = 'month-date'),
                    (M.DATE_MONTH = 'date-month'),
                    (M.MONTH_YEAR = 'month-year'),
                    (M.WEEK_DAY = 'week-day'),
                    (M.WEEK_DAY_TIME = 'week-day-time'),
                    (M.YEAR = 'year'),
                    (M.DATE_YEAR = 'date-year'),
                    Date.now();
                var y = t(3138);
                const P = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    ...
                    return (
                        ((u) => {
                            ...
                            if (
                                ...
                                D.current = x.addCallback(n, t, r, e === L.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== L.None)
                                return () => {
                                    x.removeCallback(D.current, r);
                                };
                        }, [r, e]),
                        s
                    );
                ...
                const W = (0, n.memo)(({ title: u, description: e, background: t, classMix: i }) => {
                    const E = (0, n.useMemo)(() => ({ backgroundImage: `url(${t})` }), [t]),
                        r = A()('HintSlide_base_31', i);
                    return o().createElement(
                        'div',
                        { className: r },
                        o().createElement('div', { className: 'HintSlide_hintIcon_e0', style: E }),
                        o().createElement(
                            'div',
                            { className: 'HintSlide_text_4b' },
                            o().createElement('span', { className: 'HintSlide_title_eb' }, u),
                            o().createElement('span', { className: 'HintSlide_description_e7' }, e),
                        ),
                    );
                });
                function j() {
                ...
                const K = (0, n.memo)(() => {
                    const u = I('model', L.None),
                        e = u.title,
                        t = u.hints,
                        i = (0, n.useCallback)(() => (0, s.Sy)(), []);
                    var E;
                    return (
                        (E = i),
                        V(U.n.ESCAPE, E),
                        o().createElement(
                            'div',
                            { className: 'HelpViewApp_base_c1' },
                            o().createElement(
                                'div',
                                { className: 'HelpViewApp_content_c0' },
                                o().createElement(
                                    'div',
                                    { className: 'HelpViewApp_header_c7' },
                                    o().createElement('span', { className: 'HelpViewApp_title_e2' }, e),
                                    o().createElement(
                                        'div',
                                        { className: 'HelpViewApp_close_a9' },
                                        o().createElement(k, {
                                ...
                                t.length &&
                                    o().createElement(
                                        h,
                                        { hasArrow: !0, selectedIndex: 0, className: 'HelpViewApp_pagination_de' },
                                        t.map(({ value: u }, e) => ({
                                            render: function () {
                                                return o().createElement(
                                                    o().Fragment,
                                                    ...
                                                    o().createElement(
                                                        W,
                                                        j({}, u, { classMix: 'HelpViewApp_slide_14' }),
                                                    ),
                                                    o().createElement('div', { className: 'HelpViewApp_sizer_35' }),
                                                );
                                            },
                                        })),
                                    ),
                                o().createElement('div', { className: 'HelpViewApp_bottomBg_d3' }),
                            ),
                        )
                    );
                });
                engine.whenReady.then(() => {
                    E().render(o().createElement(K, null), document.getElementById('root'));
                });
            },
        },
        ...
        (() => {
            ...
            var e = (e, t) => {
                    ...
                    for (e && e(t); A < i.length; A++)
                        (o = i[A]), __webpack_require__.o(u, o) && u[o] && u[o][0](), (u[o] = 0);
                    return __webpack_require__.O(F);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t)));
        })();
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4686));
