(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => s, off: () => E, on: () => o, onResize: () => a, onScaleUpdated: () => i });
                var r = t(2472),
                    n = t(1176);
            ...
            5936: (u, e, t) => {
                ...
                const C = ({ children: u }) => {
                    ...
                    ((u) => {
                        ...
                        i.O.client.events.on('clientResized', s), i.O.client.events.on('self.onScaleUpdated', A);
                    }),
                        (0, r.useEffect)(
                            () => () => {
                ...
                const L = {
                    ...
                    T = (u) => {
                        ...
                        const a = f(),
                            ...
                            o = a.mediaHeight,
                            E = a.mediaSize;
                        return n().createElement('div', x({ className: m()(t, L[i], y[o], k[E]) }, r), e);
                    },
                    S = ['children'],
                    O = (u) => {
                        let e = u.children,
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (W(t, D, { isMouseEvent: !0, on: !0, arguments: I(n) }, b),
                                    m && m(),
                ...
                const Z = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const a = e.contentId;
                    return a ? n().createElement(j, Y({}, e, { contentId: a }), r) : n().createElement(z, e, r);
                };
                var X = t(8045);
                const Q = {
                ...
                const eu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    nu = (u, e, t = uu.left) => u.split(e).reduce(t === uu.left ? tu : ru, []),
                    au = (() => {
                        const u = new RegExp(
                ...
                const su = { [lu.NBSP]: ou.NoBreakSymbol, [lu.ZWNBSP]: ou.NoBreakSymbol, [lu.NEW_LINE]: ou.LineBreak },
                    ...
                    du = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return r
                            ? Fu[r]
                                ? n().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: m()(cu, Fu[r]) },
                                      u,
                                  )
                                : n().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: cu, style: Du(r) },
                                      u,
                                  )
                            : n().createElement('span', { key: t, 'data-block-type': e.blockType, className: cu }, u);
                    },
                    Bu = {
                        [ou.Word]: du,
                        [ou.NoBreakSymbol]: du,
                    ...
                    hu = Au
                        ...
                        : (u, e) => {
                              ...
                              let a = 0;
                              for (; r; ) {
                                  const i = e.justifyContent === Eu.FlexEnd ? r.index : t.lastIndex;
                    ...
                    gu = (u, e = '', t) => {
                        ...
                        return (
                            _u(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    r.push({ blockType: ou.Word, colorTag: e, childList: hu(u, t) });
                                },
                                (u) => {
                                    const t = u[0],
                                        n = su[t.charAt(0)];
                            ...
                            _u(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof i || 'number' == typeof i
                                        ? n.push(...gu(String(i), t, r))
                                        : n.push({ blockType: ou.Binding, colorTag: t, childList: [i] });
                                },
                            ),
                            n
                        );
                            ...
                            ((u, e, t) => {
                                ...
                                return (
                                    _u(
                                        ...
                                        (u) => {
                                            r.push(...pu(u[2] + u[3], e, u[1], t));
                                        },
                                    ),
                                    r
                                );
                            })(eu(u).replace(/&zwnbsp;/g, '\ufeff'), e, t),
                        );
                        return ((u) => {
                            const e = [];
                            return (
                    ...
                    wu = (u, e) => u.offsetLeft + u.offsetWidth - e,
                    xu = (u, e, t) => {
                    ...
                    Lu = (u, e, t, r, a, i) => {
                        ...
                        for (let l = t; l >= 0; l--) {
                            ...
                            if (s === ou.LineBreak || s === ou.NewLine || s === ou.Binding) continue;
                            ...
                            }
                            {
                                const u = t.children,
                                    s = e[l],
                                    F = s.props.children,
                                    c = Lu(u, F, u.length - 1, r, a, i),
                                    D = c[0],
                                    d = c[1];
                                if (!(D < 0)) {
                                    const u = F.slice(0, D);
                                    (E = n().cloneElement(s, s.props, u, d)), (o = l);
                                    break;
                                }
                                a -= A.length;
                            }
                    ...
                    yu = n().memo(
                        ({
                            ...
                            const c = (0, r.useRef)(null),
                                ...
                                B = d[0],
                                C = d[1],
                                _ = (0, r.useMemo)(() => vu(u, a, { justifyContent: s }), [a, s, u]),
                                h = (0, r.useMemo)(() => {
                                    if (
                                        i &&
                                        B.isTruncated &&
                                ...
                                g = (0, r.useCallback)(
                                    (u) => {
                                        ...
                                        const e = ((u, e, t, r = '...') => {
                                            ...
                                            r = e[0],
                                            n = e[1];
                                        C({ elementList: r, isTruncated: n, isTruncateFinished: !0 }), t && t(n);
                                    },
                                    [t, F, _],
                                ),
                                p = (0, r.useMemo)(() => ({ justifyContent: s, alignContent: A }), [A, s]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                n().createElement(
                                    'div',
                                    {
                                        className: m()(
                                            ...
                                            e,
                                            Q.base__zeroPadding,
                                            o && Q.base__isTruncationAvailable,
                                        ),
                                        style: p,
                                    },
                                    n().createElement('div', { className: Q.unTruncated, ref: c }, _),
                                    n().createElement(
                                        Z,
                                        {
                                            tooltipArgs: h,
                                        ...
                                        n().createElement(
                                            'div',
                                            {
                                                className: m()(
                                                    Q.truncated,
                                                    !B.isTruncateFinished && o && Q.truncated__hide,
                                                ),
                                                style: p,
                                            },
                                            B.isTruncateFinished && o ? B.elementList : _,
                                        ),
                                    ),
                                )
                            );
                ...
                function Su(u = ku.n.NONE, e = Tu, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== ku.n.NONE)
                            return (
                ...
                const Hu = (0, r.memo)(({ className: u, children: e, onClick: t, enabled: a = !0 }) => {
                        ...
                        return n().createElement(
                            'div',
                            {
                                className: m()(Pu.base, Pu[`base__${o}`], !a && Pu.base__disabled, u),
                                onMouseEnter: () => {
                                    a && (Ru('highlight'), E(Nu.Hovered));
                                },
                                onMouseLeave: () => {
                                    a && E(Nu.Normal);
                                },
                                ...
                                onMouseDown: () => {
                                    a && (Ru('play'), E(Nu.Pressed));
                                },
                                onClick: () => {
                                    a && t && t();
                                },
                            },
                            n().createElement('div', { className: m()(Pu.bg, Pu.bg__base) }),
                            n().createElement('div', { className: m()(Pu.bg, Pu.bg__hovered) }),
                            n().createElement('div', { className: m()(Pu.bg, Pu.bg__pressed) }),
                            n().createElement('div', { className: Pu.label }, e),
                        );
                    }),
                    Iu = (0, r.memo)(({ className: u }) =>
                        n().createElement(
                            'div',
                            { className: u },
                            n().createElement(
                                'div',
                                { className: m()('Loading_container_76', u) },
                    ...
                    Wu = 'Lore_glow_68',
                    ju = (0, r.memo)(({ className: u, folder: e, text: t }) => {
                        const a = ((u) => {
                                const e = f().mediaSize;
                                return u
                                    ? e >= p.ExtraLarge
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement('div', { className: m()(Wu, 'Lore_glow__top_b7') }),
                                n().createElement('div', { className: m()(Wu, 'Lore_glow__bottom_f7') }),
                ...
                const Vu = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const l = (0, r.useRef)([]),
                                    s = (u, t, r) => {
                                        ...
                                        const a = (function ({
                                            ...
                                            F = { mode: u, model: A, externalModel: o, cleanup: s };
                                        return {
                                            model: A,
                                    ...
                                    c = F[0],
                                    D = F[1],
                                    d = (0, r.useState)(() => s(u, a, E)),
                                    B = d[0],
                                    C = d[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        A.current ? C(s(c, a, E)) : (A.current = !0);
                                    }, [E, c, a]),
                                    (0, r.useEffect)(() => {
                                        D(u);
                                    }, [u]),
                    ...
                    Xu = 'attackIcon',
                    Qu = { [Xu]: [1, 2], flagIcon: [3, 4, 5, 1e3, 1001] },
                    Ju = (u) => {
                        for (var e = 0, t = Object.entries(Qu); e < t.length; e++) {
                            const r = t[e],
                                n = r[0];
                    ...
                    ue = (0, Ou.Pi)(() => {
                        ...
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement(ju, { className: Yu.lore, folder: E, text: Zu.text.$num(i) }),
                                n().createElement('div', { className: Yu.vignette }),
                                n().createElement(
                                    'div',
                                    { className: Yu.header },
                                    n().createElement('div', { className: Yu.stage }, Zu.stage.$num(i)),
                                    n().createElement('div', { className: Yu.title }, Zu.title.$num(i)),
                                    n().createElement(
                                        'div',
                                        { className: Yu.task },
                                        n().createElement('div', { className: Yu[Ju(i)] }),
                                        n().createElement(yu, { text: Zu.task.$num(i) }),
                                    ),
                                ),
                                o
                                    ? n().createElement(Iu, { className: Yu.loading })
                                    : n().createElement(
                                          Hu,
                                          { className: Yu.battleButton, onClick: t.gotoBattle },
                ...
                engine.whenReady.then(() => {
                    P().render(
                        n().createElement(qu, null, n().createElement(O, null, n().createElement(ue, null))),
