(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                (t.r(e),
                    t.d(e, { mouse: () => l, off: () => E, on: () => o, onResize: () => a, onScaleUpdated: () => i }));
                var r = t(2472),
                    n = t(1176);
            ...
            212: (u, e, t) => {
                ...
                const w = {
                    ...
                    x = (u) => {
                        ...
                        const a = g(),
                            ...
                            o = a.mediaHeight,
                            E = a.mediaSize;
                        return n().createElement('div', b({ className: d()(t, w[i], f[o], v[E]) }, r), e);
                    },
                    L = ['children'],
                    y = (u) => {
                        let e = u.children,
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (P(t, D, { isMouseEvent: !0, on: !0, arguments: M(n) }, b),
                                    m && m(),
                ...
                const z = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const a = e.contentId;
                    return a ? n().createElement(N, V({}, e, { contentId: a }), r) : n().createElement(H, e, r);
                };
                var q = t(8045);
                const K = {
                ...
                const Z = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    uu = (u, e, t = X.left) => u.split(e).reduce(t === X.left ? Q : J, []),
                    eu = (() => {
                        const u = new RegExp(
                            [
                ...
                const iu = { [au.NBSP]: ru.NoBreakSymbol, [au.ZWNBSP]: ru.NoBreakSymbol, [au.NEW_LINE]: ru.LineBreak },
                    ...
                    Au = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return r
                            ? Eu[r]
                                ? n().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: d()(su, Eu[r]) },
                                      u,
                                  )
                                : n().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: su, style: lu(r) },
                                      u,
                                  )
                            : n().createElement('span', { key: t, 'data-block-type': e.blockType, className: su }, u);
                    },
                    Fu = {
                        [ru.Word]: Au,
                        [ru.NoBreakSymbol]: Au,
                    ...
                    Cu = (u, e = '', t) => {
                        ...
                        return (
                            Du(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    r.push({ blockType: ru.Word, colorTag: e, childList: Bu(u, t) });
                                },
                                (u) => {
                                    const t = u[0],
                                        n = iu[t.charAt(0)];
                            ...
                            Du(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof i || 'number' == typeof i
                                        ? n.push(...Cu(String(i), t, r))
                                        : n.push({ blockType: ru.Binding, colorTag: t, childList: [i] });
                                },
                            ),
                            n
                        );
                            ...
                            ((u, e, t) => {
                                ...
                                return (
                                    Du(
                                        ...
                                        (u) => {
                                            r.push(..._u(u[2] + u[3], e, u[1], t));
                                        },
                                    ),
                                    r
                                );
                            })(Z(u).replace(/&zwnbsp;/g, '\ufeff'), e, t),
                        );
                        return ((u) => {
                            const e = [];
                            return (
                    ...
                    wu = (u, e, t, r, a, i) => {
                        ...
                        for (let s = t; s >= 0; s--) {
                            const t = u[s],
                                l = Number(u[s].getAttribute('data-block-type'));
                            if (l === ru.LineBreak || l === ru.NewLine || l === ru.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const c = A.slice(0, A.length - F) + i,
                                    D = e[s];
                                ((E = n().cloneElement(D, D.props, c)), (o = s));
                                break;
                            }
                            {
                                const u = t.children,
                                    l = e[s],
                                    F = l.props.children,
                                    c = wu(u, F, u.length - 1, r, a, i),
                                    D = c[0],
                                    d = c[1];
                                if (!(D < 0)) {
                                    const u = F.slice(0, D);
                                    ((E = n().cloneElement(l, l.props, u, d)), (o = s));
                                    break;
                                }
                                a -= A.length;
                            }
                    ...
                    fu = n().memo(
                        ({
                            ...
                            customTooltipArgs: E,
                            targetId: s,
                            justifyContent: l = nu.FlexStart,
                            alignContent: A = nu.FlexStart,
                            truncateIdentify: F = '...',
                        }) => {
                            const c = (0, r.useRef)(null),
                                ...
                                C = B[0],
                                _ = B[1],
                                m = (0, r.useMemo)(() => hu(u, a, { justifyContent: l }), [a, l, u]),
                                h = (0, r.useMemo)(() => {
                                    if (
                                        i &&
                                        C.isTruncated &&
                                ...
                                p = (0, r.useMemo)(() => ({ justifyContent: l, alignContent: A }), [A, l]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                n().createElement(
                                    'div',
                                    {
                                        className: d()(
                                            ...
                                            e,
                                            K.base__zeroPadding,
                                            o && K.base__isTruncationAvailable,
                                        ),
                                        style: p,
                                    },
                                    n().createElement('div', { className: K.unTruncated, ref: c }, m),
                                    n().createElement(
                                        z,
                                        {
                                            tooltipArgs: h,
                                        ...
                                        n().createElement(
                                            'div',
                                            {
                                                className: d()(
                                                    K.truncated,
                                                    !C.isTruncateFinished && o && K.truncated__hide,
                                                ),
                                                style: p,
                                            },
                ...
                function Lu(u = vu.n.NONE, e = xu, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== vu.n.NONE)
                            return (
                ...
                const Mu = (0, r.memo)(({ className: u, children: e, onClick: t, enabled: a = !0 }) => {
                        const i = (0, r.useState)(Ou.Normal),
                            o = i[0],
                            E = i[1];
                        return n().createElement(
                            'div',
                            {
                                className: d()(Su.base, Su[`base__${o}`], !a && Su.base__disabled, u),
                                onMouseEnter: () => {
                                    a && (Tu('highlight'), E(Ou.Hovered));
                                },
                                onMouseLeave: () => {
                                    a && E(Ou.Normal);
                                },
                                ...
                                onMouseDown: () => {
                                    a && (Tu('play'), E(Ou.Pressed));
                                },
                                onClick: () => {
                                    a && t && t();
                                },
                            },
                            n().createElement('div', { className: d()(Su.bg, Su.bg__base) }),
                            n().createElement('div', { className: d()(Su.bg, Su.bg__hovered) }),
                            n().createElement('div', { className: d()(Su.bg, Su.bg__pressed) }),
                            n().createElement('div', { className: Su.label }, e),
                        );
                    }),
                    Pu = (0, r.memo)(({ className: u }) =>
                        n().createElement(
                            'div',
                            { className: u },
                            n().createElement(
                                'div',
                                { className: d()('Loading_container_76', u) },
                    ...
                    Ru = 'Lore_glow_68',
                    Nu = (0, r.memo)(({ className: u, folder: e, text: t }) => {
                        const a = ((u) => {
                                const e = g().mediaSize;
                                return u
                                    ? e >= _.ExtraLarge
                        ...
                        return n().createElement(
                            'div',
                            { className: d()('Lore_base_eb', u) },
                            n().createElement(
                                'div',
                                { className: 'Lore_content_63' },
                                n().createElement('div', { className: d()(Ru, 'Lore_glow__top_b7') }),
                                n().createElement('div', { className: d()(Ru, 'Lore_glow__bottom_f7') }),
                ...
                const ju = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: a, children: o, mocks: E }) {
                                const s = (0, r.useRef)([]),
                                    ...
                                    c = F[0],
                                    D = F[1],
                                    d = (0, r.useState)(() => l(u, a, E)),
                                    B = d[0],
                                    C = d[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        A.current ? C(l(c, a, E)) : (A.current = !0);
                                    }, [E, c, a]),
                                    (0, r.useEffect)(() => {
                                        D(u);
                                    }, [u]),
                    ...
                    zu = R.strings.sm_battle.prebattle.mission,
                    qu = 'attackIcon',
                    Ku = { [qu]: [1, 2], flagIcon: [3, 4, 5, 1e3, 1001] },
                    Yu = (u) => {
                        for (var e = 0, t = Object.entries(Ku); e < t.length; e++) {
                            const r = t[e],
                                n = r[0];
                    ...
                    Xu = (0, yu.Pi)(() => {
                        const u = $u(),
                            ...
                            i = a.missionNumber,
                            o = a.isLoading,
                            E = R.images.story_mode.gui.maps.icons.prebattle.$num(i);
                        return (
                            ((u) => {
                            ...
                            n().createElement(
                                ...
                                { className: Vu.base },
                                n().createElement(ku, {
                                    backgroundPath: null == E ? void 0 : E.background(),
                                    onLoaded: t.loaded,
                                }),
                                n().createElement(Nu, { className: Vu.lore, folder: E, text: zu.text.$num(i) }),
                                n().createElement('div', { className: Vu.vignette }),
                                n().createElement(
                                    'div',
                                    { className: Vu.header },
                                    n().createElement('div', { className: Vu.stage }, zu.stage.$num(i)),
                                    n().createElement('div', { className: Vu.title }, zu.title.$num(i)),
                                    n().createElement(
                                        'div',
                                        { className: Vu.task },
                                        n().createElement('div', { className: Vu[Yu(i)] }),
                                        n().createElement(fu, { text: zu.task.$num(i) }),
                                    ),
                                ),
                                o
                                    ? n().createElement(Pu, { className: Vu.loading })
                                    : n().createElement(
                                          Mu,
                                          { className: Vu.battleButton, onClick: t.gotoBattle },
                ...
                engine.whenReady.then(() => {
                    T().render(
                        n().createElement(Uu, null, n().createElement(y, null, n().createElement(Xu, null))),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'battle/PrebattleWindow/PrebattleWindow'),
        (() => {
            var u = { 'battle/PrebattleWindow/PrebattleWindow': 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, ['lib/story_mode.vendors'], () => __webpack_require__(212));
