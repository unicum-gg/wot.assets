    ...
    var __webpack_modules__ = {
            ...
            212: (u, e, t) => {
                ...
                const w = {
                    ...
                    x = (u) => {
                        ...
                        const a = g(),
                            ...
                            o = a.mediaHeight,
                            E = a.mediaSize;
                        return n().createElement('div', b({ className: d()(t, w[i], v[o], f[E]) }, r), e);
                    },
                    L = ['children'],
                    y = (u) => {
                        let e = u.children,
                ...
                const z = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const a = e.contentId;
                    return a ? n().createElement(N, $({}, e, { contentId: a }), r) : n().createElement(H, e, r);
                };
                var q = t(8045);
                const K = {
                ...
                function Lu(u = fu.n.NONE, e = xu, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== fu.n.NONE)
                            return (
                    ...
                    Xu = (0, yu.Pi)(() => {
                        ...
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement(Nu, { className: $u.lore, folder: E, text: zu.text.$num(i) }),
                                n().createElement('div', { className: $u.vignette }),
                                n().createElement(
                                    'div',
                                    { className: $u.header },
                                    n().createElement('div', { className: $u.stage }, zu.stage.$num(i)),
                                    n().createElement('div', { className: $u.title }, zu.title.$num(i)),
                                    n().createElement(
                                        'div',
                                        { className: $u.task },
                                        n().createElement('div', { className: $u[Yu(i)] }),
                                        n().createElement(vu, { text: zu.task.$num(i) }),
                                    ),
                                ),
                                o
                                    ? n().createElement(Pu, { className: $u.loading })
                                    : n().createElement(
                                          Mu,
                                          { className: $u.battleButton, onClick: t.gotoBattle },
