(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                (t.r(e),
                    t.d(e, { mouse: () => D, off: () => a, on: () => A, onResize: () => r, onScaleUpdated: () => i }));
                var E = t(472),
                    n = t(176);
            ...
            138: (u, e, t) => {
                ...
                var E = t(959),
                    n = t(698),
                    r = t(514);
                const i = { view: t(641), client: E, sound: r.ZP, intl: n.N };
            },
            698: (u, e, t) => {
                'use strict';
                t.d(e, { N: () => E });
            ...
            514: (u, e, t) => {
                ...
                const n = { highlight: 'highlight', click: 'play', yes1: 'yes1' },
                    r = Object.keys(n).reduce((u, e) => ((u[e] = () => (0, E.playSound)(n[e])), u), {}),
                    i = { play: Object.assign({}, r, { sound: E.playSound }), setRTPC: E.setRTPC };
            },
            722: (u, e, t) => {
                'use strict';
                function E(u, e, t = 1) {
                ...
                function M(u) {
                    function e() {
                        ...
                        (u.style.setProperty('--external-padding-top', `${t}rem`),
                            u.style.setProperty('--external-padding-right', `${E}rem`),
                            ...
                            const r = e.args,
                                i = (function (u, e) {
                                    ...
                                    var t,
                                        ...
                                        n = {},
                                        r = Object.keys(u);
                                    for (E = 0; E < r.length; E++) ((t = r[E]), e.indexOf(t) >= 0 || (n[t] = u[t]));
                                    return n;
                                })(e, E);
                            return void 0 !== r
            ...
            690: (u, e, t) => {
                ...
                function r(u) {
                    let e = '';
                    for (let t = n.length - 1; t >= 0; t--) for (; u >= n[t];) ((e += E[t]), (u -= n[t]));
                    return e;
                }
            ...
            358: (u, e, t) => {
                ...
                class n {
                    ...
                    addCallback(u, e, t = 0, n = !0) {
                        ...
                        const r = E.O.view.addModelObserver(u, t, n);
                        return (
                            r > 0
                                ? ((this._callbacks[r] = e),
            ...
            976: (u, e, t) => {
                ...
                function d(u, e, t, E, n, r, i) {
                    ...
                    A.done ? e(a) : Promise.resolve(a).then(E, n);
                }
                ...
                const w = n.instance,
                    f = {
                        ...
                        sendShowPopOverEvent: (u, e, t, E, n = R.invalid('resId'), r) => {
            ...
            320: (u, e, t) => {
                                ...
                                const l = (0, E.useRef)([]),
                                    B = (u, t, E) => {
                                        ...
                                        const r = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, r) => {
                                                        const A = 'string' == typeof r ? `${E}.${r}` : E,
                                                            a = F.O.view.addModelObserver(A, e, !0);
                                                        return (n.set(a, t), u && t(i(r)), a);
                                                    },
                                                    readByPath: i,
                                                    createCallback: (u, e) => {
                                                        const t = i(e);
                                    ...
                                    d = c[0],
                                    _ = c[1],
                                    h = (0, E.useState)(() => B(u, r, s)),
                                    m = h[0],
                                    g = h[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        C.current ? g(B(d, r, s)) : (C.current = !0);
                                    }, [s, d, r]),
                                    (0, E.useEffect)(() => {
                                        _(u);
                                    }, [u]),
                ...
                var d;
                function _(u = F.O.client.getSize('rem')) {
                    const e = u.width,
                        t = u.height;
                ...
                (0, E.memo)((u) => {
                    ...
                    const n = (0, E.useContext)(m),
                        ...
                        v = { extraLarge: c, large: d, medium: _, small: h, extraSmall: p };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && D) return C(e, t, v);
                        if (t.largeWidth && o) return C(e, t, v);
                        if (t.mediumWidth && s) return C(e, t, v);
                        if (t.smallWidth && l) return C(e, t, v);
                        if (t.extraSmallWidth && B) return C(e, t, v);
                        if (!(
                            t.extraLargeWidth ||
                            t.largeWidth ||
                            t.mediumWidth ||
                ...
                const p = ({ children: u }) => {
                    ...
                    return (
                        (0, E.useLayoutEffect)(() => {
                            function u() {
                                r((u) => {
                                    const e = F.O.client.getSize('rem');
                                    return u.width === e.width && u.height === e.height ? u : _(e);
                                });
                            }
                            return (
                                u(),
                                a(!0),
                                F.O.client.events.on('clientResized', u),
                                F.O.client.events.on('self.onScaleUpdated', u),
                                () => {
                                    (F.O.client.events.off('clientResized', u),
                                        F.O.client.events.off('self.onScaleUpdated', u));
                                }
                            );
                        }, []),
                        n().createElement(m.Provider, { value: t }, A && u)
                    );
                };
                var v = t(483),
                    w = t.n(v),
                ...
                const O = {
                    ...
                    P = (u) => {
                        ...
                        const i = (() => {
                            ...
                            a = i.mediaHeight,
                            F = i.mediaSize;
                        return n().createElement('div', y({ className: w()(t, O[A], M[a], k[F]) }, r), e);
                    },
                    H = ['children'],
                    W = (u) => {
                        let e = u.children,
                        ...
                        return n().createElement(p, null, n().createElement(P, t, e));
                    };
                var I = t(515);
                var N = t(30);
                let G;
                ...
                const q = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    X = (u, e, t = V.left) => u.split(e).reduce(t === V.left ? K : Y, []),
                    Z = (() => {
                        const u = new RegExp(
                            [
                ...
                const Eu = (u, e) => {
                    ...
                    ru = 'hide',
                    iu = 'none',
                    Au = R.strings.fall_tanks.battleWidget,
                    au = ({ checkpoint: u, position: e, observable: t = !1 }) => {
                        var r, i;
                        const A = (0, E.useState)(!1),
                            a = A[0],
                            D = A[1],
                            o = (0, E.useState)(iu),
                            s = o[0],
                            ...
                            c = (0, N.useTransition)(e, {
                                ...
                                trail: 100,
                                config: { duration: a ? 500 : 0, easing: j.easeInOutCubic },
                                immediate: B === e,
                                onRest() {
                                    !a && D(!0);
                                },
                        ...
                        return (
                            (0, E.useEffect)(() => {
                                !t &&
                                    ...
                                    u > C &&
                                    s === iu &&
                                    (l(nu), F.O.sound.play.sound('ev_fep_fall_checkpoint'));
                            }, [u, C, s, l, t]),
                            n().createElement(
                                'div',
                                { className: U.base },
                                n().createElement(
                                    'div',
                                    { className: U.label },
                                    t ? Au.enemyPosition() : Au.position(),
                                ),
                                n().createElement(
                                    'div',
                                    { className: U.positionWrapper },
                                    c((u, e) =>
                                        n().createElement(N.animated.div, { style: u, className: U.position }, e),
                                    ),
                                ),
                                n().createElement(
                                    'div',
                                    {
                                        className: w()(U.checkpoint, U[`checkpoint__${s}`]),
                                        onAnimationEnd: (u) => {
                                            u.target === u.currentTarget && (s === nu ? l(ru) : s === ru && l(iu));
                                        },
                                    },
                                    n().createElement(
                                        'div',
                                        { className: w()(U.checkpointText, U[`checkpointText__${s}`]) },
                                        Au.checkpoint(),
                                    ),
                                ),
                            )
                    ...
                    Fu = (u) => u.toString().padStart(2, '0'),
                    Du = R.strings.fall_tanks.battleWidget,
                    ou = ({ position: u, spentTime: e }) => {
                        const t = u > 0 && u <= 3;
                        return (
                            (0, E.useEffect)(() => {
                                t
                            ...
                            n().createElement(
                                ...
                                t && n().createElement('div', { className: 'Finish_top_ec' }),
                                n().createElement('div', { className: 'Finish_position_6e' }, u),
                                n().createElement('div', { className: 'Finish_placeText_94' }, Du.place()),
                                n().createElement(
                                    'div',
                                    { className: 'Finish_spentTime_b4' },
                                    (function (u, e = '{minutes}:{seconds}.{milliseconds}', t = 0, E = '-') {
                                        if (u <= t) return E;
                                        let n = 10 * Math.round((u * eu) / 10);
                                        const r = Math.trunc(n / 6e4);
                                        n -= 6e4 * r;
                                        const i = Math.trunc(n / eu);
                                        n -= i * eu;
                                        const A = Math.round(n / 10);
                                        return z(e, { minutes: Fu(r), seconds: Fu(i), milliseconds: Fu(A) });
                                    })(e, Du.timeFormat(), 0, ''),
                                ),
                            )
                        );
                    },
                    su = ({ binding: u, text: e = '', classMix: t, alignment: r = V.left, formatWithBrackets: i }) => {
                        ...
                        return n().createElement(
                            ...
                            A.split('\n').map((e, i) =>
                                n().createElement(
                                    'div',
                                    { className: w()('FormatText_base_d0', t), key: `${e}-${i}` },
                                    ((u, e, t) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                                            t && u in t
                                                ? t[u]
                                        ...
                                        n().createElement(E.Fragment, { key: `${e}-${u}` }, u),
                                    ),
                                ),
                            ),
                        );
                    ...
                    Bu = (0, I.Pi)(({ state: u, checkpoint: e, position: t, spentTime: E, observable: r }) => {
                        if (r && u !== G.InRace) return null;
                        switch (u) {
                            case G.InRace:
                                return n().createElement(au, { checkpoint: e, position: t, observable: r });
                            case G.Finished:
                                return n().createElement(ou, { position: t, spentTime: E });
                            case G.NotFinished:
                                return n().createElement(lu, null);
                            case G.Disabled:
                                return null;
                            default:
                    ...
                    cu = (0, I.Pi)(() => {
                        const u = B().model,
                            ...
                            r = (0, N.useTransition)(E, {
                                keys: (u) => u.state,
                                from: { opacity: 0 },
                                enter: { opacity: 1, easing: j.easeOutCubic },
                                leave: { opacity: 0, easing: j.easeInCubic },
                                trail: 300,
                                config: { duration: 300 },
                            });
                        return n().createElement(
                            ...
                            Cu.includes(e) &&
                                n().createElement('div', {
                                    className: w()(
                                        'App_bgGradient_b7',
                                        e === G.Finished && t > 0 && t <= 3 && 'App_bgGradient__top_4b',
                                    ),
                                }),
                            r((u, e) =>
                                n().createElement(
                ...
                engine.whenReady.then(() => {
                    i().render(
                        n().createElement(l, null, n().createElement(W, null, n().createElement(cu, null))),
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (a = 0; a < deferred.length; a++) {
                    for (var [e, t, E] = deferred[a], r = !0, i = 0; i < e.length; i++)
                        (!1 & E || n >= E) &&
