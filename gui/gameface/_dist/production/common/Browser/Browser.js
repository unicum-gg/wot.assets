            ...
            73: (e, t, n) => {
                ...
                const T = 'BrowserView_base_6b',
                    ...
                    U = ({ message: e, className: t, classNames: n }) =>
                        a().createElement(
                            ...
                            a().createElement('div', { className: S()(D, null == n ? void 0 : n.gear) }),
                            a().createElement('div', { className: S()(B, null == n ? void 0 : n.logo) }),
                        );
                function I(e) {
                    ...
                    const w = (0, r.useRef)(null),
                        ...
                        D = S()(
                            ...
                            z[`base__${o}`],
                            {
                                ...
                                [z.base__firstHover]: M,
                            },
                            s,
                        ),
                        B = S()(z.state, z.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                ...
                const V = (0, r.memo)(j),
                    ...
                    Z = ({ errorBtnLabel: e, errorBtnClickHandler: t, errorMessage: n }) =>
                        a().createElement(
                            ...
                            a().createElement(V, { size: H.medium, mixClass: Y, onClick: t }, e),
                        );
                ...
                const J = 'DisplayBrowserState_base_e7',
                    ...
                    re = ({ waitingText: e, className: t }) =>
                        a().createElement(
                            'div',
                            { className: S()(J, t) },
                            a().createElement(Q, { errorBtnClickHandler: w, message: e }),
                        ),
                    ae = () =>
                        a().createElement(
                            'div',
                ...
                const _e = a().memo(function (e) {
                        ...
                        return a().createElement(
                            ...
                            'function' == typeof _
                                ? _({ viewState: v, statusCode: m, waitingText: E, waitingClassName: o })
                                : a().createElement(ce, {
                                      viewState: v,
                                      statusCode: m,
                                      waitingText: E,
                ...
                const be = a().memo(function (e) {
                    const t = we(),
                        n = t[0],
                        r = t[1];
                    return a().createElement('div', { ref: n, className: T }, a().createElement(_e, ge({}, e, E(r))));
                });
                function fe() {
                    return (
                        (fe =
                ...
                const ye = (0, r.memo)(function (e) {
                    ...
                    return a().createElement(M, { options: t, mocks: n, mode: r }, a().createElement(he, o));
                });
                var Oe = n(521),
                    Me = n(364);
                const Le = (e) => {
                ...
                const Te = () => {
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            { className: Pe, ref: t },
                            a().createElement(ye, Ne({}, E(n), { displayContentWhenLoading: !1, mocks: Se })),
                        )
                    );
                };
                engine.whenReady.then(() => {
                    i().render(a().createElement(Te, null), document.getElementById('root'));
                });
            },
        },
