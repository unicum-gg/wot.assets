(() => {
    ...
    var e,
        t = {
            4219: (e, t, n) => {
                var r = {};
                (n.r(r),
                    n.d(r, { mouse: () => p, off: () => f, on: () => m, onResize: () => d, onScaleUpdated: () => v }));
                var o = {};
                (n.r(o),
                    n.d(o, {
                        events: () => r,
                ...
                engine.whenReady.then(() => {
                    pe().render(
                        ue().createElement(xe, null, ue().createElement(fe, null, ue().createElement(Re, null))),
    ...
    var o = r.O(void 0, ['lib/story_mode.vendors'], () => r(4219));
    o = r.O(o);
})();
