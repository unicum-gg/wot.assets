(() => {
    ...
    var u,
        A = {
            9535: (u, A, F) => {
                ...
                const eu = Object.keys(_).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === _[A]), u), {}),
                    Eu = {
                        set: (u, A) => {
                ...
                const Cu = { view: B, client: E, sound: h, intl: p };
                var nu = F(7363),
                    ru = F.n(nu);
                const ou = {
                ...
                const su = ru().forwardRef(function (u, A) {
                    let F = u.children,
                        e = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        ru().createElement(
                            'div',
                            au({}, B, {
                                className: C()(ou.base, ou[`base__theme-${D}`], e),
                                ref: function (u) {
                ...
                const mu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    pu = (u, A, F = vu.left) => u.split(A).reduce(F === vu.left ? fu : gu, []),
                    bu = (() => {
                        const u = new RegExp(
                            [
                    ...
                    hu = ({ binding: u, text: A = '', classMix: F, alignment: e = vu.left, formatWithBrackets: E }) => {
                            ...
                            D.split('\n').map((A, E) =>
                                ru().createElement(
                                    ...
                                    ((u, A, F) =>
                                        ...
                                        ru().createElement(nu.Fragment, { key: `${A}-${u}` }, u),
                                    ),
                                ),
                            ),
                        );
                ...
                const Tu = (u) => (0 === u ? window : window.subViews.get(u)),
                        ...
                        return [
                            function ({ mode: u = 'real', options: e, children: E, mocks: D }) {
                                const B = (0, nu.useRef)([]),
                                    t = (u, F, e) => {
                                        ...
                                        const D = (function ({
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const t = 'string' == typeof D ? `${e}.${D}` : e,
                                                            C = Cu.view.addModelObserver(t, A, !0);
                                            ...
                                            r = (({ observableModel: u }) =>
                                                u.primitives(['name', 'image', 'conditions', 'description']))({
                                                mode: u,
                                                readByPath: C,
                                                externalModel: t,
                                                observableModel: {
                                ...
                                return (
                                    ...
                                    ru().createElement(F.Provider, { value: a }, E)
                                );
                            },
                            () => (0, nu.useContext)(F),
                        ];
                    ...
                    Mu = () => {
                        ...
                        return ru().createElement(
                            ...
                            ru().createElement('div', { className: 'MedalTooltipApp_name_55' }, u.name.get()),
                            ru().createElement('div', {
                                className: 'MedalTooltipApp_image_5d',
                                style: { backgroundImage: `url(${u.image.get()})` },
                            }),
                            ru().createElement('div', { className: Ou }),
                            ru().createElement(
                                'div',
                            ...
                            ru().createElement('div', { className: Ou }),
                            A && ru().createElement(hu, { text: A, classMix: 'MedalTooltipApp_conditions_08' }),
                        );
                    };
                engine.whenReady.then(() => {
                    cu().render(
                        ru().createElement(_u, null, ru().createElement(su, null, ru().createElement(Mu, null))),
    ...
    ((e.m = A),
        ...
        (e.j = 'common/MedalTooltip/MedalTooltip'),
        (() => {
            var u = { 'common/MedalTooltip/MedalTooltip': 0 };
            e.O.j = (A) => 0 === u[A];
            var A = (A, F) => {
                    var E,
                        D,
    ...
    var E = e.O(void 0, ['lib/story_mode.vendors'], () => e(9535));
    E = e.O(E);
})();
