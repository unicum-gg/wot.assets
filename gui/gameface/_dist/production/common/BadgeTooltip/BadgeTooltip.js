(() => {
    ...
    var __webpack_modules__ = {
            ...
            4055: (u, e, t) => {
                ...
                const A = a().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        a().createElement(
                            'div',
                            c({}, F, {
                                className: r()(s.base, s[`base__theme-${l}`], n),
                                ref: function (u) {
                    ...
                    uu = a().memo(
                        ({
                            ...
                            const d = (0, i.useRef)(null),
                                ...
                                _ = B[0],
                                C = B[1],
                                p = (0, i.useMemo)(() => Z(u, n, { justifyContent: A }), [n, A, u]),
                                h = (0, i.useMemo)(() => {
                                    if (
                                        o &&
                                        _.isTruncated &&
                                ...
                                m = (0, i.useMemo)(() => ({ justifyContent: A, alignContent: l }), [l, A]);
                            return (
                                ((u, e, t = !0) => {
                    ...
                    ou = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: n, children: r, mocks: s }) {
                                const E = (0, i.useRef)([]),
                                    c = (u, t, n) => {
                                        ...
                                        const i = (function ({
                                            ...
                                            l = { mode: u, model: A, externalModel: a, cleanup: c };
                                        return {
                                            model: A,
                                ...
                                return (
                                    (0, i.useEffect)(() => {
                                        A.current ? _(c(F, n, s)) : (A.current = !0);
                                    }, [s, F, n]),
                                    (0, i.useEffect)(() => {
                                        d(u);
                                    }, [u]),
                ...
                engine.whenReady.then(() => {
                    F().render(
                        a().createElement(iu, null, a().createElement(A, null, a().createElement(su, null))),
