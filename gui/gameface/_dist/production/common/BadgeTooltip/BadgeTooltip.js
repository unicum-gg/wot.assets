(() => {
    ...
    var __webpack_modules__ = {
            ...
            4055: (u, e, t) => {
                            ...
                            g(
                                {
                                    contentId:
                                        ...
                                        l ? f.SimpleTooltipHtmlContent('resId') : f.SimpleTooltipContent('resId')),
                ...
                const S = { [P.NBSP]: x.NoBreakSymbol, [P.ZWNBSP]: x.NoBreakSymbol, [P.NEW_LINE]: x.LineBreak },
                    ...
                    W = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? M[n]
                                ? a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: r()(I, M[n]) },
                                      u,
                                  )
                                : a().createElement(
                                      'span',
                    ...
                    J = (u, e, t, n, r, o) => {
                        ...
                        for (let E = t; E >= 0; E--) {
                            ...
                            if (c === x.LineBreak || c === x.NewLine || c === x.Binding) continue;
                    ...
                    uu = a().memo(
                        ({
                            ...
                            const d = (0, i.useRef)(null),
                                ...
                                _ = B[0],
                                C = B[1],
                                p = (0, i.useMemo)(() => $(u, n, { justifyContent: l }), [n, l, u]),
                                h = (0, i.useMemo)(() => {
                                    if (
                                        o &&
                                        _.isTruncated &&
                ...
                const ru = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const E = (0, i.useRef)([]),
                                    c = (u, t, n) => {
                                        ...
                                        const i = (function ({
                                            ...
                                            A = { mode: u, model: l, externalModel: a, cleanup: c };
                                        return {
                                            model: l,
                                    ...
                                    F = A[0],
                                    d = A[1],
                                    D = (0, i.useState)(() => c(u, n, s)),
                                    B = D[0],
                                    _ = D[1];
                                return (
                                    (0, i.useEffect)(() => {
                                        l.current ? _(c(F, n, s)) : (l.current = !0);
                                    }, [s, F, n]),
                                    (0, i.useEffect)(() => {
                                        d(u);
                                    }, [u]),
                    ...
                    su = () => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                { className: 'BadgeTooltipApp_conditions_0a' },
                                u.description.get(),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    F().render(
                        a().createElement(iu, null, a().createElement(l, null, a().createElement(su, null))),
