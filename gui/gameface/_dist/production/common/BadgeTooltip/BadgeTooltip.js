(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                (t.r(e),
                    t.d(e, { mouse: () => a, off: () => F, on: () => A, onResize: () => o, onScaleUpdated: () => E }));
                var n = t(2472),
                    r = t(1176);
            ...
            3138: (u, e, t) => {
                ...
                var n = t(5959),
                    r = t(7698),
                    o = t(514);
                const E = { view: t(7641), client: n, sound: o.ZP, intl: r.N };
            },
            7698: (u, e, t) => {
                t.d(e, { N: () => n });
                const n = {
            ...
            8411: (u, e, t) => {
                ...
                const s = A().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        A().createElement(
                            'div',
                            a({}, c, {
                                className: r()(F.base, F[`base__theme-${D}`], n),
                                ref: function (u) {
                        ...
                        const b = (0, E.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, E.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (d(t, l, { isMouseEvent: !0, on: !0, arguments: C(n) }, w),
                                    g && g(),
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          (b.current.timeoutId = window.setTimeout(y, a ? 100 : 400)),
                                                          r && r(u),
                                                          x && x(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                ...
                const f = R.views.common.tooltip_window.simple_tooltip_content,
                    b = (u) => {
                        ...
                        const a = (0, E.useMemo)(() => {
                            const u = Object.assign({}, F, { body: t, header: n, note: r, alert: o });
                            ...
                            v(
                                {
                                    contentId:
                                        ...
                                        s ? f.SimpleTooltipHtmlContent('resId') : f.SimpleTooltipContent('resId')),
                ...
                const y = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return A().createElement(b, e, n);
                    const r = e.contentId;
                    return r ? A().createElement(_, w({}, e, { contentId: r }), n) : A().createElement(m, e, n);
                };
                var T = t(8045);
                const k = {
                ...
                const L = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    N = (u, e, t = O.left) => u.split(e).reduce(t === O.left ? P : S, []),
                    M = (() => {
                        const u = new RegExp(
                            [
                ...
                const U = { [V.NBSP]: j.NoBreakSymbol, [V.ZWNBSP]: j.NoBreakSymbol, [V.NEW_LINE]: j.LineBreak },
                    ...
                    H = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? G[n]
                                ? A().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: r()(q, G[n]) },
                                      u,
                                  )
                                : A().createElement(
                                      'span',
                    ...
                    Q = z
                        ...
                        : (u, e) => {
                              ...
                              let o = 0;
                              for (; n; ) {
                                  const E = e.justifyContent === W.FlexEnd ? n.index : t.lastIndex;
                    ...
                    J = (u, e = '', t) => {
                        ...
                        return (
                            Z(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    n.push({ blockType: j.Word, colorTag: e, childList: Q(u, t) });
                                },
                                (u) => {
                                    const t = u[0],
                                        r = U[t.charAt(0)];
                    ...
                    uu = (u, e, t = '', n) => {
                        ...
                        return (
                            Z(
                                ...
                                (u) => {
                                    const o = u[1],
                                        E = void 0 === e[o] ? u[0] : e[o];
                                    'string' == typeof E || 'number' == typeof E
                                        ? r.push(...J(String(E), t, n))
                                        : r.push({ blockType: j.Binding, colorTag: t, childList: [E] });
                                },
                            ),
                            r
                        );
                    ...
                    eu = (u, e) => {
                        ...
                        if (u.blockType === j.NoBreakWrapper) (u.childList.push(n), t.push(u));
                        else {
                            const e = Object.assign({}, u, { childList: u.childList.splice(-1) });
                            (u.childList.length > 0 && t.push(u),
                                t.push({ blockType: j.NoBreakWrapper, colorTag: '', childList: [e, n] }));
                        }
                    ...
                    Eu = (u, e, t, n, r, o) => {
                        ...
                        for (let i = t; i >= 0; i--) {
                            ...
                            if (a === j.LineBreak || a === j.NewLine || a === j.Binding) continue;
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const c = s.slice(0, s.length - D) + o,
                                    l = e[i];
                                ((F = A().cloneElement(l, l.props, c)), (E = i));
                                break;
                            }
                            {
                                const u = t.children,
                                    a = e[i],
                                    D = a.props.children,
                                    c = Eu(u, D, u.length - 1, n, r, o),
                                    l = c[0],
                                    B = c[1];
                                if (!(l < 0)) {
                                    const u = D.slice(0, l);
                                    ((F = A().cloneElement(a, a.props, u, B)), (E = i));
                                    break;
                                }
                                r -= s.length;
                            }
                    ...
                    Au = A().memo(
                        ({
                            ...
                            customTooltipArgs: i,
                            targetId: a,
                            justifyContent: s = W.FlexStart,
                            alignContent: D = W.FlexStart,
                            truncateIdentify: c = '...',
                        }) => {
                            const l = (0, E.useRef)(null),
                                B = (0, E.useRef)({ height: 0, width: 0 }),
                                C = (0, E.useState)({ elementList: [], isTruncated: !1, isTruncateFinished: !1 }),
                                d = C[0],
                                _ = C[1],
                                p = (0, E.useMemo)(() => tu(u, n, { justifyContent: s }), [n, s, u]),
                                h = (0, E.useMemo)(() => {
                                    if (
                                        o &&
                                        d.isTruncated &&
                                        ...
                                        return {
                                            args: Object.assign({ text: u }, i, {
                                                stringifyKwargs: n ? JSON.stringify(n) : '',
                                            }),
                                            contentId: R.views.lobby.common.tooltips.ExtendedTextTooltip('resId'),
                                            targetId: a,
                                        };
                                }, [n, o, a, u, i, d.isTruncated]),
                                m = (0, E.useCallback)(
                                    (u) => {
                                        ...
                                        const e = ((u, e, t, n = '...') => {
                                                ...
                                                const E = t.height,
                                                    A = t.width,
                                                    F = o.lastElementChild;
                                                if (!nu(F, E) && ru(F, A) <= 0) return [r, !1];
                                                const i = o.children,
                                                    a = ((u, e) => {
                                                        let t = 0,
                                                            n = u.length - 1;
                                ...
                                g = (0, E.useMemo)(() => ({ justifyContent: s, alignContent: D }), [D, s]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                A().createElement(
                                    'div',
                                    {
                                        className: r()(
                                            ...
                                            e,
                                            k.base__zeroPadding,
                                            F && k.base__isTruncationAvailable,
                                        ),
                                        style: g,
                                    },
                                    A().createElement('div', { className: k.unTruncated, ref: l }, p),
                                    A().createElement(
                                        y,
                                        {
                                            tooltipArgs: h,
                                        ...
                                        A().createElement(
                                            'div',
                                            {
                                                className: r()(
                                                    k.truncated,
                                                    !d.isTruncateFinished && F && k.truncated__hide,
                                                ),
                                                style: g,
                                            },
                                            d.isTruncateFinished && F ? d.elementList : p,
                                        ),
                                    ),
                                )
                            );
                    ...
                    Fu = ({ binding: u, text: e = '', classMix: t, alignment: n = O.left, formatWithBrackets: o }) => {
                        if (null === e) return (console.error("FormatText was supplied with 'null'"), null);
                        const F = o && u ? ((i = u), e.replace(/\{\w+\}/g, (u) => String(i[u.slice(1, -1)]))) : e;
                        var i;
                        return A().createElement(
                            E.Fragment,
                            null,
                ...
                const Du = (u) => (0 === u ? window : window.subViews.get(u)),
                    cu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: n, children: r, mocks: F }) {
                                const i = (0, E.useRef)([]),
                                    a = (u, t, n) => {
                                        var r;
                                        const E = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const F = 'string' == typeof E ? `${n}.${E}` : n,
                                                            i = o.O.view.addModelObserver(F, e, !0);
                                                        return (r.set(i, t), u && t(A(E)), i);
                                                    },
                                                    readByPath: A,
                                                    createCallback: (u, e) => {
                                                        const t = A(e);
                                    ...
                                    c = D[0],
                                    l = D[1],
                                    B = (0, E.useState)(() => a(u, n, F)),
                                    C = B[0],
                                    d = B[1];
                                return (
                                    (0, E.useEffect)(() => {
                                        s.current ? d(a(c, n, F)) : (s.current = !0);
                                    }, [F, c, n]),
                                    (0, E.useEffect)(() => {
                                        l(u);
                                    }, [u]),
                                    ...
                                    A().createElement(t.Provider, { value: C }, r)
                                );
                            },
                            () => (0, E.useContext)(t),
                        ];
                    ...
                    Cu = () => {
                        ...
                        return A().createElement(
                            'div',
                            { className: 'BadgeTooltipApp_base_c9' },
                            A().createElement('div', { className: 'BadgeTooltipApp_name_b8' }, u.name.get()),
                            A().createElement('div', {
                                className: 'BadgeTooltipApp_image_43',
                                style: { backgroundImage: `url(${u.image.get()})` },
                            }),
                            A().createElement(
                                'div',
                                { className: 'BadgeTooltipApp_preview_66' },
                                A().createElement('div', {
                                    className: 'BadgeTooltipApp_badgePreview_4e',
                                    style: { backgroundImage: `url(${u.smallBadgeIcon.get()})` },
                                }),
                                A().createElement(Au, {
                                    classMix: 'BadgeTooltipApp_playerName_5e',
                                    text: u.playerName.get(),
                                    isTruncationAvailable: !0,
                                }),
                                A().createElement(
                                    'div',
                                    { className: 'BadgeTooltipApp_vehiclePreview_14' },
                                    A().createElement('div', {
                                        className: 'BadgeTooltipApp_vehicleIcon_ef',
                                        style: { backgroundImage: `url(${u.vehicleIcon.get()})` },
                                    }),
                                    A().createElement(
                                        'div',
                                        { className: 'BadgeTooltipApp_vehicleLevel_4d' },
                                        u.vehicleLevel.get(),
                                    ),
                                ),
                            ),
                            A().createElement('div', { className: 'BadgeTooltipApp_dots_b9' }),
                            A().createElement(Fu, {
                                text: u.description.get(),
                                classMix: 'BadgeTooltipApp_conditions_0a',
                            }),
                        );
                    };
                engine.whenReady.then(() => {
                    c().render(
                        A().createElement(lu, null, A().createElement(s, null, A().createElement(Cu, null))),
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 'common/BadgeTooltip/BadgeTooltip'),
        (() => {
            var u = { 'common/BadgeTooltip/BadgeTooltip': 0 };
