    ...
    var e,
        t = {
            399: (e, t, n) => {
                ...
                var a = {};
                (n.r(a), n.d(a, { getBgUrl: () => M, getTextureUrl: () => A }));
                var i = {};
                (n.r(i),
                    n.d(i, {
                        addModelObserver: () => G,
                ...
                const ne = Object.keys(T).reduce((e, t) => ((e[t] = () => viewEnv.getShowingStatus() === T[t]), e), {}),
                    re = {
                        set: (e, t) => {
                ...
                engine.whenReady.then(() => {
                    c().render(
                        u().createElement(le, null, u().createElement(de, null)),
