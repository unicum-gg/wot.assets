/*! For license information please see resource_well.vendors.js.LICENSE.txt */
(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
    ['lib/resource_well.vendors'],
    {
        1686: (e, t, n) => {
            'use strict';
            n.d(t, {
            ...
            class c extends ('lobby/feature/ResourcesLoadingView/ResourcesLoadingView' == n.j ? l : null) {
                constructor(e) {
                    (super(),
                        (this.done = !0),
            ...
            class d extends ('lobby/feature/ResourcesLoadingView/ResourcesLoadingView' == n.j ? c : null) {
                constructor(e) {
                    (super(0),
                        (this._string = null),
            ...
            class f extends ('lobby/feature/ResourcesLoadingView/ResourcesLoadingView' == n.j ? l : null) {
                constructor(e) {
            ...
            class p extends ('lobby/feature/ResourcesLoadingView/ResourcesLoadingView' == n.j ? f : null) {
                constructor(e) {
                    super(e);
                }
                static create(e) {
        ...
        9738: (e, t, n) => {
            ...
            const h = (e, t) => !0 === e || !!(t && e && (r.is.fun(e) ? e(t) : (0, r.qo)(e).includes(t))),
                ...
                b =
                    'lobby/feature/ResourcesLoadingView/ResourcesLoadingView' == n.j
            ...
            const A = 'lobby/feature/ResourcesLoadingView/ResourcesLoadingView' == n.j ? [] : null;
            class T {
                constructor() {
                    ((this.changed = !1),
                        (this.values = A),
            ...
            const Q = Symbol.for('SpringPhase'),
                ...
                G = (e, t) => (t ? (e[Q] |= 3) : (e[Q] &= -3)),
                z = (e, t) => (t ? (e[Q] |= 4) : (e[Q] &= -5));
            class K extends ('lobby/feature/ResourcesLoadingView/ResourcesLoadingView' == n.j ? M : null) {
                constructor(e, t) {
                    if (
                        (super(),
                        (this.key = void 0),
                ...
                _merge(e, t, n) {
                    ...
                    if (!M) {
                        const e = E || (!F(this) && w);
                        ((U || e) && ((Q = (0, r.Xy)(y(R), N)), (M = !Q)),
                            (((0, r.Xy)(l.immediate, L) || L) && (0, r.Xy)(B.decay, A) && (0, r.Xy)(B.velocity, T)) ||
                                (M = !0));
                    }
                    if (
                        (Q && q(this) && (l.changed && !E ? (M = !0) : M || this._stop(f)),
                        !W &&
                            ((M || (0, r.j$)(f)) &&
                                ((l.values = P.getPayload()),
                                (l.toValues = (0, r.j$)(g) ? null : D == o.eC ? [1] : (0, r.qo)(N))),
                            l.immediate != L && ((l.immediate = L), L || E || this._set(f)),
                            M))
                    ) {
                        const e = l.onRest;
                ...
                _start() {
                    ...
                    ((0, o.ys)(this).reset((0, r.je)(e.to)),
                        ...
                        q(this) || (G(this, !0), $(this) || this._resume()));
                }
                _resume() {
            ...
            const pe = ['children'],
                ...
                ge =
                    ...
                    be);
            var be, _e;
            ((ve.Provider = ge.Provider), (ve.Consumer = ge.Consumer));
            const me = () => {
                const e = [],
                    t = function (t) {
                        (0, r.ZR)();
            ...
            class Ue extends M {
                ...
                advance(e) {
                    ...
                    ((0, r.Xy)(t, n) || ((0, o.ys)(this).setValue(t), this._onChange(t, this.idle)),
                        !this.idle && Se(this._active) && Be(this));
                }
                _get() {
                ...
                _start() {
                    this.idle &&
                        ...
                        r.OH.skipAnimation ? (r.Wn.batchedUpdates(() => this.advance()), Be(this)) : r.fT.start(this));
                }
                _attach() {
                    let e = 1;
        ...
        2810: (e, t, n) => {
            ...
            const M = {
                ...
                start(e) {
                    D > e.priority ? (N.add(e), i.onStart(Q)) : (F(e), i($));
                },
                advance: $,
                sort(e) {
            ...
            function $(e) {
                ...
                for (let n = 0; n < I.length; n++) {
                    const r = I[n];
                    ((D = r.priority), r.idle || (V(r), r.advance(e), r.idle || t.push(r)));
                }
            ...
            const de = (e, t, n) => {
                ...
                if (W.str(e.output[0])) return E(e);
                const r = e,
                    i = r.output,
                    o = r.range || [0, 1],
        ...
        9769: (e, t, n) => {
            ...
            n.d(t, { A: () => r });
            const r =
                /^lobby\/feature\/(sharedComponents\/(Vehicle(Count\/VehicleCount|Info\/VehicleInfo)|award\/((AdditionalReward\/Additional|Reward\/)Reward|(Footer\/Foot|Header\/Head)er)|Counter\/Counter|NoVehiclesState\/NoVehiclesState|Resource\/Resource)|tooltips\/(ProgressTooltip\/Progress|SerialNumberTooltip\/SerialNumber)Tooltip|EntryPoint\/EntryPoint)$/.test(
                    n.j,
                )
                    ? null
                    : [
        ...
        1281: (e, t, n) => {
            ...
            if (
                (n.d(t, { D4: () => b }),
                !/^lobby\/feature\/sharedComponents\/(Vehicle(Count\/VehicleCount|Info\/VehicleInfo)|award\/Reward\/Reward)$/.test(
                    n.j,
                ))
            )
                var r = n(9769);
        ...
        5013: (e, t, n) => {
            ...
            if (
                (n.d(t, { e: () => i }),
                /^lobby\/feature\/(ResourcesLoading(Confirm\/ResourcesLoadingConfirm|View\/ResourcesLoadingView)|tooltips\/(EntryPointTooltip\/EntryPoint|ProgressTooltip\/Progress)Tooltip|((CompletedProgressionView\/Completed|ProgressionView\/)Progression|AwardView\/Award)View|EntryPoint\/EntryPoint|NoSerialVehiclesConfirm\/NoSerialVehiclesConfirm|WellPanel\/WellPanel)$/.test(
                    n.j,
                ))
            )
                var r = n(9174);
        ...
        9174: (e, t, n) => {
            ...
            function $(e, t, n) {
                ...
                var r = new F(e);
                return (t !== g && Vt(kt, r, t, undefined), n !== g && Ct(r, n), r);
            }
            var G = {
            ...
            var ge = ae('observable'),
                ...
                _e = ae('observable.shallow', {
                    enhancer: function (e, t, n) {
                        return null == e || Qn(e) || Sn(e) || jn(e) || Vn(e)
                            ? e
                            : Array.isArray(e)
            ...
            var Ue,
                ...
                Te = function (e, t) {
                    ...
                    if (y(e)) return D(ie(Be, e));
                    var n = y(t) ? t : {};
                    return ((n.get = e), n.name || (n.name = e.name || ''), new Fe(n));
                };
            (Object.assign(Te, xe), (Te.struct = D(Ae)));
            var Pe,
                Ee = 0,
                je = 1,
            ...
            (Object.assign(xt, Ut), (Bt.bound = D(Ot)), (xt.bound = D(Wt)));
            var Pt = function (e) {
                return e();
            };
            function Et(e) {
            ...
            function Zt(e) {
                return (function (e, t) {
                    return (
                        !!e &&
                        (void 0 !== t ? !!Qn(e) && e[Q].values_.has(t) : Qn(e) || !!e[Q] || q(e) || _t(e) || qe(e))
                    );
                })(e);
            }
            function Jt(e) {
                ...
                En = (function () {
                    ...
                    return (
                        ...
                        (t.has = function (e) {
                            ...
                            if (!n) {
                                var r = (n = new De(this.has_(e), K, 'ObservableMap.key?', !1));
                ...
                In = (function () {
                    ...
                    return (
                        ...
                        (t.has_ = function (e) {
                            ...
                            return (
                                t ||
                                    ((t = new De(e in this.target_, K, 'ObservableObject.key?', !1)),
            ...
            var Dn = W('ObservableObjectAdministration', In);
            function Mn(e) {
                return (
                    Rn[e] ||
                    (Rn[e] = {
            ...
            function ir(e) {
                return Sn(e) ? e.slice() : S(e) || jn(e) || B(e) || Vn(e) ? Array.from(e.entries()) : e;
            }
            function or(e) {
        ...
        9953: (e, t, n) => {
                ...
                f =
                    ...
                    (r[d] = function (e) {
                        ...
                        return [
                            ...
                            a().cloneElement(r, {
                                in: !0,
                                onEntered: h(r, 'onEntered', function () {
                                    n(u.d0);
                                }),
                            }),
                        ];
                    ...
                    return (
                        ...
                        (n.render = function () {
                            var e,
                                ...
                                o = i.status,
                                s = i.current,
                                c = { children: n, current: s, changeState: this.changeState, status: o };
                            switch (o) {
                                case u.d0:
                                    e = p[r](c);
                                    break;
                            ...
                            return a().createElement(l.Z.Provider, { value: { isMounting: !this.appeared } }, e);
                        }),
                        t
                    );
                })(a().Component);
            ...
            const g =
                /^lobby\/feature\/(No(SerialVehiclesConfirm\/NoSerial|VehiclesConfirm\/No)VehiclesConfirm|ResourcesLoading(Confirm\/ResourcesLoadingConfirm|View\/ResourcesLoadingView))$/.test(
                    n.j,
                )
                    ? v
                    : null;
                        ...
                        return (
                            ...
                            t.in
                                ? o
                                    ...
                                    : (i = f)
                                : (i = t.unmountOnExit || t.mountOnEnter ? c : d),
                            (r.state = { status: i }),
                            (r.nextCallback = null),
                            r
                        );
                    ...
                    return (
                        ...
                        (n.componentDidUpdate = function (e) {
                            ...
                            if (e !== this.props) {
                                ...
                                this.props.in ? n !== h && n !== f && (t = h) : (n !== h && n !== f) || (t = p);
                            }
                        ...
                        (n.render = function () {
                            ...
                            if (
                                ...
                                return s().createElement(l.Z.Provider, { value: null }, n(e, i));
                            var o = s().Children.only(n);
                            return s().createElement(l.Z.Provider, { value: null }, s().cloneElement(o, i));
                        }),
                        t
                    );
                })(s().Component);
