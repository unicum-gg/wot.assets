/*! For license information please see battle_royale_progression.vendors.js.LICENSE.txt */
(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
    ['lib/battle_royale_progression.vendors'],
    {
        686: (e, t, n) => {
            'use strict';
            n.d(t, {
            ...
            class c extends ('ProgressionMainView/ProgressionMainView' == n.j ? l : null) {
                constructor(e) {
                    (super(),
                        (this.done = !0),
            ...
            class h extends ('ProgressionMainView/ProgressionMainView' == n.j ? c : null) {
                constructor(e) {
                    (super(0),
                        (this._string = null),
            ...
            class f extends ('ProgressionMainView/ProgressionMainView' == n.j ? l : null) {
                constructor(e) {
            ...
            class p extends ('ProgressionMainView/ProgressionMainView' == n.j ? f : null) {
                constructor(e) {
                    super(e);
                }
                static create(e) {
        ...
        738: (e, t, n) => {
            ...
            const d = (e, t) => !0 === e || !!(t && e && (r.is.fun(e) ? e(t) : (0, r.qo)(e).includes(t))),
                ...
                g =
                    'ProgressionMainView/ProgressionMainView' == n.j
            ...
            const P = 'ProgressionMainView/ProgressionMainView' == n.j ? [] : null;
            class T {
                constructor() {
                    ((this.changed = !1),
                        (this.values = P),
                ...
                return s || e !== h || t.reset
                    ? (n.promise = a(function* () {
                          ...
                          const g = new Promise((e, t) => ((p = e), (v = t))),
                              b = (e) => {
                                  const t = (o <= (n.cancelId || 0) && V(i)) || (o !== n.asyncId && E(i, !1));
                              ...
                              y = (e, t) => {
                                  const s = new I(),
                                      u = new N();
                                  return a(function* () {
                                      if (r.OH.skipAnimation) throw (R(n), (u.result = E(i, !1)), v(u), u);
                                      b(s);
                          ...
                          let m;
                          if (r.OH.skipAnimation) return (R(n), E(i, !1));
                          try {
                              let t;
                              ((t = r.is.arr(e)
                                  ? ((w = a(function* (e) {
            ...
            const q = Symbol.for('SpringPhase'),
                ...
                z = (e, t) => (t ? (e[q] |= 3) : (e[q] &= -3)),
                $ = (e, t) => (t ? (e[q] |= 4) : (e[q] &= -5));
            class K extends ('ProgressionMainView/ProgressionMainView' == n.j ? L : null) {
                constructor(e, t) {
                    if (
                        (super(),
                        (this.key = void 0),
                ...
                _merge(e, t, n) {
                    ...
                    if (!L) {
                        const e = x || (!Q(this) && w);
                        ((U || e) && ((q = (0, r.Xy)(m(R), I)), (L = !q)),
                            (((0, r.Xy)(l.immediate, D) || D) && (0, r.Xy)(S.decay, P) && (0, r.Xy)(S.velocity, T)) ||
                                (L = !0));
                    }
                    if (
                ...
                _stop(e, t) {
                    if (F(this)) {
                        ...
                        const i = t ? V(this.get()) : E(this.get(), H(this, null != e ? e : n.to));
                        ((0, r.bl)(this._pendingCalls, i),
            ...
            const re = 'ProgressionMainView/ProgressionMainView' == n.j ? ['onStart', 'onChange', 'onRest'] : null;
            let ie = 1;
            class oe {
                constructor(e, t) {
                    ((this.id = ie++),
                            ...
                            f.push(
                                j(++e._lastAsyncId, {
                                    ...
                                    actions: {
                                        ...
                                        resume: r.ZT,
                                        start(t, n) {
                                            v ? (R(d, e._lastAsyncId), n(V(e))) : ((t.onRest = u), n(C(h, t, d, e)));
                                        },
                                    },
                                }),
                            ),
        ...
        810: (e, t, n) => {
            ...
            const L = {
                ...
                start(e) {
                    M > e.priority ? (I.add(e), i.onStart(q)) : (Q(e), i(G));
                },
                advance: G,
                sort(e) {
            ...
            function G(e) {
                ...
                for (let n = 0; n < N.length; n++) {
                    const r = N[n];
                    ((M = r.priority), r.idle || (C(r), r.advance(e), r.idle || t.push(r)));
                }
                return ((M = 0), (D = N), (D.length = 0), (N = t), N.length > 0);
            }
            const z = {
                    transparent: 0,
            ...
            const Pe = /rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,
                ...
                je = (e) => {
                    ...
                    return (e) => {
                        ...
                        let o = 0;
                        return t[0].replace(We, () => `${r[o++](e)}${i || ''}`).replace(Pe, Te);
                    };
                },
                xe = 'react-spring: ',
                ke = (e) => {
        ...
        797: (e, t, n) => {
            ...
            class h {
                ...
                applyToElement(e) {
                    for (var t, n = o(this.getBlocks(e)); !(t = n()).done;) {
                        const e = t.value;
                        (a(e.hasText()), this.applyToParagraph(e));
                    }
                }
                *getBlocks(e, t) {
                    if ((a(1 === e.nodeType), this.className && e.classList.contains(this.className))) return;
                    const n = (function (e) {
                        const t = e.nodeName,
                            n = u[t];
                    ...
                    if (2 === n) return;
                    if (3 === n) return (t && t.hasText() && (yield t, (t.textNodes = [])), void a(!e.firstChild));
                    a(1 === n || 0 === n);
                    const r = !t || 1 === n,
                        i = r ? new c(e) : t;
                    a(i);
                    for (var s, h = o(e.childNodes); !(s = h()).done;) {
                        const e = s.value;
                        switch (e.nodeType) {
                            case 1:
                                for (var d, f = o(this.getBlocks(e, i)); !(d = f()).done;) {
                                    const e = d.value;
                                    yield e;
                                }
                                break;
                ...
                applyToParagraph(e) {
                    ...
                    if ((a(r.length > 0), a(r.reduce((e, t) => e + t.length, 0) === n.length), r.length <= 1)) return;
                    const i = [];
                    let s = 0;
                    for (var u, l = o(r); !(u = l()).done;) {
                        const e = u.value;
                        (a(e.length > 0), (s += e.length), i.push(s));
                    }
                    (a(i[0] > 0),
                        a(i[i.length - 1] === n.length),
                        ++i[i.length - 1],
                        a(i.length > 1),
                ...
                splitTextNodes(e, t) {
                    ...
                    for (var u, l = o(e); !(u = l()).done;) {
                        ...
                        for (; i < o;) {
                            const e = i - s;
                            (a(e >= c), l.push(n.substring(c, e)), (c = e), ++r, a(t[r] > i), (i = t[r]));
                        }
                        (a(l.length > 0), c < n.length && l.push(n.substring(c)), this.splitTextNode(e, l), (s = o));
                    }
                    (a(s === n), a(r < t.length), a(t[r] >= n));
                }
                splitTextNode(e, t) {
                    (a(t.length > 1), a(e.nodeValue === t.join('')));
                    const n = this.separator;
                    if ('string' == typeof n) return void (e.nodeValue = t.join(n));
                    const r = e.ownerDocument;
                    let i = [];
                    for (var s, u = o(t); !(s = u()).done;) {
                        const e = s.value;
            ...
            class _ {
                ...
                static getUnicodeBlockFeature(e) {
                    ...
                    return void 0 === t ? f : `${d(r, t)}`.padStart(3, '0');
                }
        ...
        174: (e, t, n) => {
            ...
            function G(e, t, n) {
                ...
                var r = new Q(e);
                return (t !== _ && Ct(Et, r, t, undefined), n !== _ && Vt(r, n), r);
            }
            var z = {
            ...
            var _e = ae('observable'),
                ...
                be = ae('observable.shallow', {
                    enhancer: function (e, t, n) {
                        return null == e || qn(e) || Bn(e) || kn(e) || Cn(e)
                            ? e
                            : Array.isArray(e)
            ...
            function Ce(e, t, n, r) {
                ...
                return (
                    void 0 === n && (n = !1),
                    (i.isMobxAction = !0),
                    Ee && ((Ve.value = e), Object.defineProperty(i, 'name', Ve)),
                    i
                );
            }
            ...
            function Jt(e) {
                return (function (e, t) {
                    return (
                        !!e &&
                        (void 0 !== t ? !!qn(e) && e[q].values_.has(t) : qn(e) || !!e[q] || F(e) || bt(e) || Fe(e))
                    );
                })(e);
            }
            function Yt(e) {
            ...
            var Tn,
                ...
                xn = (function () {
                    ...
                    return (
                        ...
                        (t.delete = function (e) {
                            var t = this;
                            if ((this.keysAtom_, on(this) && !an(this, { type: Pn, object: this, name: e }))) return !1;
                            if (this.has_(e)) {
                                var n = un(this),
                                    r = n
                                        ? {
            ...
            var Vn = (function () {
                    ...
                    return (
                        ...
                        (t.delete = function (e) {
                            var t = this;
                            if (on(this) && !an(this, { type: Pn, object: this, oldValue: e })) return !1;
                            if (this.has(e)) {
                                var n = un(this),
                                    r = n
                                        ? {
            ...
            var Mn = W('ObservableObjectAdministration', Nn);
            function Ln(e) {
                return (
                    Rn[e] ||
                    (Rn[e] = {
            ...
            ((Fn = $n),
                (Gn = Array.prototype),
                Object.setPrototypeOf
                    ? Object.setPrototypeOf(Fn.prototype, Gn)
                    : void 0 !== Fn.prototype.__proto__
                      ? (Fn.prototype.__proto__ = Gn)
                      : (Fn.prototype = Gn));
            var Kn = (function (e) {
                function t(t, n, r, i) {
                    var o;
            ...
            function ir(e) {
                return Bn(e) ? e.slice() : B(e) || kn(e) || S(e) || Cn(e) ? Array.from(e.entries()) : e;
            }
            function or(e) {
