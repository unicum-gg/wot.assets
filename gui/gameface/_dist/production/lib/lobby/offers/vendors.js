(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
    [809],
    {
        686: (t, e, n) => {
            ...
            class c extends (917 == n.j ? l : null) {
                constructor(t) {
                    super(),
                        (this.done = !0),
            ...
            class p extends (917 == n.j ? l : null) {
                constructor(t) {
            ...
            class f extends (917 == n.j ? p : null) {
                constructor(t) {
                    super(t);
                }
                static create(t) {
            ...
            const U = (t, e) => {
                ...
                return (0, r.forwardRef)((i, o) => {
                    const a = (0, r.useRef)(null),
                        ...
                        l = (function (t, e) {
                            const n = new Set();
                            (h.dependencies = n), t.style && (t = W({}, t, { style: e.createAnimatedStyle(t.style) }));
                ...
                B = (
                    ...
                    const i = { applyAnimatedValues: e, createAnimatedStyle: n, getComponentProps: r },
                        o = (t) => {
                            ...
                            return (
                                ((t = s.is.str(t) ? o[t] || (o[t] = U(t, i)) : t[v] || (t[v] = U(t, i))).displayName =
                                    `Animated(${e})`),
                                t
                            );
                        };
        ...
        738: (t, e, n) => {
            ...
            const h = (t, e) => !0 === t || !!(e && t && (s.is.fun(t) ? t(e) : (0, s.qo)(t).includes(e))),
                ...
                W = 917 == n.j ? ['config', 'onProps', 'onStart', 'onChange', 'onPause', 'onResume', 'onRest'] : null,
                U = {
                    config: 1,
                    from: 1,
                    to: 1,
            ...
            const w = c({}, { tension: 170, friction: 26 }, { mass: 1, damping: 1, easing: (t) => t, clamp: !1 });
            class S {
                constructor() {
                    (this.tension = void 0),
            ...
            function A(t, { key: e, props: n, defaultProps: r, state: i, actions: o }) {
                return new Promise((a, u) => {
                    ...
                    function W() {
                        p > 0 ? ((f = s.Wn.setTimeout(U, p)), i.pauseQueue.add(g), i.timeouts.add(f)) : U();
                    }
                    function U() {
            ...
            const j = (t, e) =>
                ...
                I = (t) => ({ value: t, noop: !0, finished: !0, cancelled: !1 }),
            ...
            const q = Symbol.for('SpringPhase'),
                ...
                z = (t, e) => (e ? (t[q] |= 3) : (t[q] &= -3)),
                H = (t, e) => (e ? (t[q] |= 4) : (t[q] &= -5));
            class G extends (917 == n.j ? L : null) {
                constructor(t, e) {
                    if (
                        (super(),
                        (this.key = void 0),
                ...
                start(t, e) {
                    ...
                    return (
                        ...
                        Promise.all(n.map((t) => this._update(t))).then((t) => j(this, t))
                    );
                }
                stop(t) {
                ...
                _merge(t, e, n) {
                    ...
                    let A = (0, i.ys)(this);
                    if (!A || s.is.und(g)) return n(x(this, !0));
                    const j = s.is.und(e.reset) ? o && !e.default : !s.is.und(U) && h(e.reset, a),
                        Q = j ? U : this.get(),
                        R = v(g),
                    ...
                    if (T) {
                        ...
                        if (t !== A.constructor) {
                            if (!V)
                                throw Error(
                                    `Cannot animate between ${A.constructor.name} and ${t.name}, as the "to" prop suggests`,
                                );
                            A = this._set(R);
                        }
                    }
                    ...
                    if (!L) {
                        ...
                        (T || t) && ((q = (0, s.Xy)(v(Q), R)), (L = !q)),
                            (((0, s.Xy)(l.immediate, V) || V) && (0, s.Xy)(S.decay, k) && (0, s.Xy)(S.velocity, P)) ||
                                (L = !0);
                    }
                    if (
                        (q && F(this) && (l.changed && !j ? (L = !0) : L || this._stop(p)),
                        !_ &&
                            ((L || (0, s.j$)(p)) &&
                        ...
                        (0, s.bl)(this._pendingCalls, r),
                            ...
                            l.changed &&
                                s.Wn.batchedUpdates(() => {
                                    (l.changed = !j),
                                        null == t || t(r, this),
                                        j ? d(u.onRest, r) : null == l.onStart || l.onStart(r, this);
                                });
                    }
                    j && this._set(Q),
                        _
                ...
                _start() {
                    ...
                    (0, i.ys)(this).reset((0, s.je)(t.to)),
                        ...
                        F(this) || (z(this, !0), D(this) || this._resume());
                }
                _resume() {
                ...
                _stop(t, e) {
                    if (F(this)) {
                        ...
                        (0, s.bl)(this._pendingCalls, r), n.changed && ((n.changed = !1), nt(this, 'onRest', r, this));
                    }
                }
            }
            function X(t, e) {
            ...
            const tt = 917 == n.j ? ['onStart', 'onRest', 'onChange', 'onPause', 'onResume'] : null;
            function et(t, e, n) {
            ...
            const st = 917 == n.j ? ['onStart', 'onChange', 'onRest'] : null;
            let rt = 1;
            class it {
                constructor(t, e) {
                    (this.id = rt++),
            ...
            function ot(t, e) {
                return Promise.all(e.map((e) => at(t, e))).then((e) => j(t, e));
            }
            function at(t, e, n) {
            ...
            function ut() {
                return (
                    (ut = a(function* (t, e, n) {
                        ...
                        const g = j(t, yield Promise.all(p));
        ...
        810: (t, e, n) => {
            ...
            const v = {
                count: 0,
                clear() {
                    (h = -1), (l = []), (o = U()), (s = U()), (a = U()), (i = U()), (u = U()), (v.count = 0);
                },
            };
            var B = n(363);
            function b() {}
            const T = (t, e, n) => Object.defineProperty(t, e, { value: n, writable: !0, configurable: !0 }),
                _ = {
                    arr: Array.isArray,
            ...
            const dt = (t, e, n) => {
                ...
                if (_.str(t.output[0])) return j(t);
                const s = t,
                    r = s.output,
                    i = s.range || [0, 1],
            ...
            const Tt = (t, e, n) => Object.defineProperty(t, e, { value: n, writable: !0, configurable: !0 }),
                _t = /[+\-]?(?:0|[1-9]\d*)(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
                wt = /(#(?:[0-9a-f]{2}){2,4}|(#[0-9a-f]{3})|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d\.]+%?\))/gi,
                St = new RegExp(`(${_t.source})(%|[a-z]+)`, 'i');
            let Ot;
            const kt = /rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,
                Pt = (t, e, n, s, r) => `rgba(${Math.round(e)}, ${Math.round(n)}, ${Math.round(s)}, ${r})`,
                At = (t) => {
                    ...
                    return (t) => {
                        var n;
                        const r =
                            !St.test(e[0]) && (null == (n = e.find((t) => St.test(t))) ? void 0 : n.replace(_t, ''));
                        let i = 0;
                        return e[0].replace(_t, () => `${s[i++](t)}${r || ''}`).replace(kt, Pt);
                    };
                },
                jt = 'react-spring: ',
                It = (t) => {
                    const e = t;
                    let n = !1;
                    if ('function' != typeof e) throw new TypeError(`${jt}once requires a function parameter`);
                    return (...t) => {
                        n || (e(...t), (n = !0));
                    };
                },
                xt = It(console.warn);
            function Et() {
                xt(`${jt}The "interpolate" function is deprecated in v9 (use "to" instead)`);
            }
        ...
        6: (t, e, n) => {
            ...
            const f = ['x', 'y', 'z'],
                ...
                y = (t, e) => (i.is.arr(t) ? t.every((t) => y(t, e)) : i.is.num(t) ? t === e : parseFloat(t) === e);
        ...
        281: (t, e, n) => {
            'use strict';
            if ((n.d(e, { D4: () => w }), 917 == n.j)) var s = n(769);
            const r = {
                'BB2:108120': 1817,
                'BP2:OO': 790,
                'UB3:107': 714,
            ...
            class U {
                ...
                *getBlocks(t, e) {
                    ...
                    if (n === p) return;
                    if (n === f) return e && e.hasText() && (yield e, (e.textNodes = [])), void u(!t.firstChild);
                    u(n === h || n === d);
                    const s = !e || n === h,
                        r = s ? new W(t) : e;
                    u(r);
                ...
                splitTextNodes(t, e) {
                    ...
                    for (var a, l = o(t); !(a = l()).done; ) {
                        ...
                        u(l.length > 0), c < n.length && l.push(n.substring(c)), this.splitTextNode(t, l), (i = o);
                    }
            ...
            class _ {
                ...
                applyElement(t, e = b) {
                    new U(this, { separator: t.ownerDocument.createElement('wbr'), threshold: e }).applyToElement(t);
                }
