(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
    [926],
    {
            ...
            function M(e, t, n, i) {
                ...
                return a || e !== f || t.reset
                    ? (n.promise = u(function* () {
                          ...
                          const y = new Promise((e, t) => ((h = e), (v = t))),
                              ...
                              b = (e, t) => {
                                  const a = new L(),
                                      l = new V();
                                  return u(function* () {
                                      if (r.OH.skipAnimation) throw (U(n), (l.result = I(i, !1)), v(l), l);
                                      g(a);
                          ...
                          let _;
                          if (r.OH.skipAnimation) return (U(n), I(i, !1));
                          try {
                              let t;
                              ((t = r.is.arr(e)
                                  ? ((w = u(function* (e) {
            ...
            class Q extends (/^(373|638|80|992)$/.test(n.j) ? B : null) {
                ...
                _merge(e, t, n) {
                    ...
                    ((i || a) && (T.velocity = 0),
                        t.config &&
                            ...
                            })(T, f(t.config, u), t.config !== l.config ? f(l.config, u) : void 0));
                    let A = (0, o.ys)(this);
                    if (!A || r.is.und(m)) return n(I(this, !0));
                    const j = r.is.und(t.reset) ? a && !t.default : !r.is.und(g) && d(t.reset, u),
                        N = j ? g : this.get(),
                        U = _(m),
                    ...
                    if (!F) {
                        const e = j || (!q(this) && w);
                        ((k || e) && ((B = (0, r.Xy)(_(N), U)), (F = !B)),
                            (((0, r.Xy)(s.immediate, V) || V) && (0, r.Xy)(T.decay, O) && (0, r.Xy)(T.velocity, C)) ||
                                (F = !0));
                    }
                    if (
                        ...
                        !S &&
                            ...
                            s.immediate != V && ((s.immediate = V), V || j || this._set(p)),
                            F))
                    ) {
                        const e = s.onRest;
                        ...
                        ((0, r.bl)(this._pendingCalls, i),
                            ...
                            s.changed &&
                                r.Wn.batchedUpdates(() => {
                                    ((s.changed = !j),
                                        null == e || e(i, this),
                                        j ? f(l.onRest, i) : null == s.onStart || s.onStart(i, this));
                                }));
                    }
                    (j && this._set(N),
                        S
                ...
                _start() {
                    ...
                    ((0, o.ys)(this).reset((0, r.je)(e.to)),
                        ...
                        $(this) || (K(this, !0), H(this) || this._resume()));
                }
                _resume() {
            ...
            class ae {
                ...
                start(e) {
                    ...
                    return (
                        ...
                        this._flush ? this._flush(this, t) : (he(this, t), ue(this, t))
                    );
                }
                stop(e, t) {
                    if ((e !== !!e && (t = e), t)) {
                            ...
                            p.push(
                                j(++e._lastAsyncId, {
                                    ...
                                    actions: {
                                        ...
                                        resume: r.ZT,
                                        start(t, n) {
                                            v ? (U(d, e._lastAsyncId), n(D(e))) : ((t.onRest = l), n(M(f, t, d, e)));
                                        },
                                    },
                                }),
                            ),
            ...
            function Te(e, t, n) {
                    ...
                    (O &&
                        (0, r.S6)(O, (e, t) => {
                            e.expired
                                ...
                                : ~(t = A[t] = P.indexOf(e.key)) && (T[t] = e);
                        }),
                    (0, r.S6)(x, (e, t) => {
                        T[t] ||
                            ((T[t] = { key: P[t], item: e, phase: Se.MOUNT, ctrl: new ae() }), (T[t].ctrl.item = e));
                    }),
                    A.length)
                ) {
                    let e = -1;
                ...
                (0, r.S6)(T, (e, n) => {
                    ...
                    let l,
                        s,
                        p = f(u.delay || 0, i);
                    if (a == Se.MOUNT) ((l = u.enter), (s = Se.ENTER));
                    else {
                        const e = P.indexOf(i) < 0;
                        if (a != Se.LEAVE)
                            if (e) ((l = u.leave), (s = Se.LEAVE));
                            else {
                    ...
                    j += d;
                    const v = c({}, R, { delay: p + j, ref: y, immediate: u.immediate, reset: !1 }, l);
                    ...
                    (0, r.bt)(
                        () => {
                            (0, r.S6)(I, ({ phase: e, payload: t }, n) => {
                                ...
                                ((n.phase = e),
                                    null == _ || _.add(r),
                                    U && e == Se.ENTER && r.start({ default: D }),
            ...
            const Pe = /rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,
                ...
                Ae = (e) => {
                    ...
                    return (e) => {
                        ...
                        let o = 0;
                        return t[0].replace(Se, () => `${r[o++](e)}${i || ''}`).replace(Pe, Ce);
                    };
                },
                je = 'react-spring: ',
                Ne = (e) => {
        ...
        1003: (e, t, n) => {
            ...
            function R(e) {
                if ((null !== e && (C = O(C, e)), (e = C), (C = null), e && (P(e, A), C && u('95'), f)))
            ...
            function Mt(e) {
                'value' === e.propertyName && Nt(At) && Le(jt, (e = Pt(At, e, Fe(e))));
            }
            function Ut(e, t, n) {
            ...
            function Fr(e, t, n) {
                (Ir.current !== Rr && u('168'), Nr(Ir, t), Nr(Dr, n));
            }
            function Br(e, t, n) {
                var r = e.stateNode;
            ...
            function di(e, t, n) {
                ...
                return (
                    'object' == typeof o && null !== o
                        ? (o = Lo(o))
                        : ((i = Lr(t) ? Mr : Ir.current), (o = (r = null != (r = t.contextTypes)) ? Ur(e, i) : Rr)),
                    (t = new t(n, o)),
            ...
            function hi(e, t, n, r) {
                ...
                ('object' == typeof o && null !== o
                    ? (i.context = Lo(o))
                    : ((o = Lr(t) ? Mr : Ir.current), (i.context = Ur(e, o))),
            ...
            function Qi() {
                if (null !== Ui) ((Ui = (Mi = Ui).next), (Ii = null !== (Ri = Ii) ? Ri.next : null));
                else {
                    null === Ii && u('310');
                    var e = {
            ...
            function eo(e, t, n, r) {
                ...
                if (null !== Ri) {
                    ...
                    if (((o = a.destroy), null !== r && $i(r, a.deps))) return void Ji(0, n, o, r);
                }
            ...
            function To(e, t, n, r, i) {
                ...
                if ((Uo(t, i), null === t.stateNode))
                    ...
                    var l = a.context,
                        s = n.contextType;
                    'object' == typeof s && null !== s ? (s = Lo(s)) : (s = Ur(t, (s = Lr(n) ? Mr : Ir.current)));
                ...
                switch (((t.expirationTime = 0), t.tag)) {
                    ...
                    case 0:
                        return (
                            (r = t.type),
                            (i = t.pendingProps),
                            So(e, t, r, (i = t.elementType === r ? i : ui(r, i)), n)
                        );
                    case 1:
                        return (
                            (r = t.type),
                            (i = t.pendingProps),
                            To(e, t, r, (i = t.elementType === r ? i : ui(r, i)), n)
                        );
                    case 3:
                        return (
                            Oo(t),
                            ...
                            (r = t.memoizedState.element) === i
                                ...
                                : ((i = t.stateNode),
                                  (i = (null === e || null === e.child) && i.hydrate) &&
                                      ((lo = Pr(t.stateNode.containerInfo)), (uo = t), (i = so = !0)),
                    ...
                    case 11:
                        return (
                            (r = t.type),
                            (i = t.pendingProps),
                            _o(e, t, r, (i = t.elementType === r ? i : ui(r, i)), n)
                        );
                    case 7:
            ...
            function Ma(e, t) {
                ...
                ((Za = n), 0 !== (n = e.expirationTime) && bu(e, n), ou || Za || Su(1073741823, !1));
            }
            function Ua() {
                (null !== Ca && Er(Ca), null !== Aa && Aa());
            }
            function La(e, t) {
                                    ...
                                    if (((a = t.type), null !== o && null != t.stateNode))
                                        ...
                                        if (vo(t)) {
                                            ...
                                            var f = l.type,
                                                d = l.memoizedProps,
                                                p = s;
                                            switch (((o[D] = l), (o[M] = d), (a = void 0), (s = f))) {
                                                case 'iframe':
                                                case 'object':
                                                    On('load', o);
                                                    break;
                                    ...
                                    o && null != t.stateNode
                                        ...
                                        : ('string' != typeof l && null === t.stateNode && u('166'),
                                          ...
                                          vo(t)
                                              ...
                                              : ((a = t),
                                                ((l = (9 === o.nodeType ? o : o.ownerDocument).createTextNode(l))[D] =
                                                    t),
                                                (a.stateNode = l)));
                                    break;
                                case 13:
            ...
            function Fa(e, t) {
                ...
                for (var i = !1; ; ) {
                    try {
                        ...
                        if (((Io = Ro = No = null), Ki(), null === wa)) ((i = !0), Pu(t));
                        else {
                            null === wa && u('271');
                            var o = wa,
                                a = o.return;
                ...
                if (((_a = !1), (ya.current = n), (Io = Ro = No = null), Ki(), i))
                    ...
                    if ((null === (n = e.current.alternate) && u('281'), (xa = null), Ta)) {
                        if (
            ...
            function Ka(e, t) {
                null !== (e = Ha(e, t)) &&
                    (!_a && 0 !== ka && t > ka && Na(),
                    ri(e, t),
                    (_a && !Oa && xa === e) || bu(e, e.expirationTime),
                    du > fu && ((du = 0), u('185')));
            }
            ...
            function Tu(e, t) {
                (Za && u('253'), (eu = e), (tu = t), Eu(e, t, !1), Su(1073741823, !1));
            }
            function Eu(e, t, n) {
                if ((Za && u('245'), (Za = !0), n)) {
            ...
            function zu(e, t, n, r, i) {
                ...
                return Iu(o._internalRoot);
            }
            function Fu(e, t) {
                var n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null;
                return (Vu(t) || u('200'), Du(e, t, null, n));
            }
            ((Pe = function (e, t, n) {
                switch (t) {
                    case 'input':
        ...
        8362: (e, t, n) => {
            ...
            function M(e, t, n, r) {
                ...
                if (((u = 0), (t = '' === t ? '.' : t + ':'), Array.isArray(e)))
                    ...
                    for (e = s.call(e), l = 0; !(i = e.next()).done; ) u += M((i = i.value), (s = t + L(i, l++)), n, r);
                else
                    'object' === i &&
                        b(
                            '31',
            ...
            function F(e, t, n, r, i) {
                var o = '';
                (null != n && (o = ('' + n).replace(N, '$&/') + '/'), U(e, z, (t = I(t, o, r, i))), D(t));
            }
            function B() {
                var e = E.current;
        ...
        3403: (e, t, n) => {
            ...
            var S;
            ((S = a.unstable_batchedUpdates) || (S = u), (0, r.jQ)({ reactionScheduler: S }));
        },
        2286: (e, t, n) => {
            'use strict';
            n.d(t, { F: () => i });
        ...
        9174: (e, t, n) => {
            ...
            function $(e, t, n) {
                ...
                var r,
                    i = new W(e);
                return (t !== m && Vt(Ut, i, t, r), n !== m && Lt(i, n), i);
            }
            var H = {
            ...
            var me = ue('observable'),
                ...
                ge = ue('observable.shallow', {
                    enhancer: function (e, t, n) {
                        return null == e || Kn(e) || An(e) || Un(e) || zn(e)
                            ? e
                            : Array.isArray(e)
            ...
            var ke,
                ...
                Ee = 'computed',
                Oe = ie(Ee),
                Pe = ie('computed.struct', { equals: H.structural }),
                Ce = function (e, t) {
            ...
            (Object.assign(Ce, Oe), (Ce.struct = z(Pe)));
            var Ae,
                je = 0,
                Ne = 1,
                Re = null != (ke = null == (Se = u(function () {}, 'name')) ? void 0 : Se.configurable) && ke,
            ...
            (Object.assign(At, Et), (Ct.bound = z(Tt)), (At.bound = z(Ot)));
            var It = function (e) {
                return e();
            };
            function Dt(e) {
                ...
                Qt = Object.assign(function (e, t) {
                    ...
                    var n = e,
                        ...
                        i = function () {
                            ...
                            return (
                                (l.cancel = Ct(r + ' - runid: ' + o + ' - cancel', function () {
                                    try {
                                        u && Xt(u);
            ...
            function tn(e, t) {
                return (
                    !!e && (void 0 !== t ? !!Kn(e) && e[B].values_.has(t) : Kn(e) || !!e[B] || q(e) || _t(e) || $e(e))
                );
            }
            function nn(e) {
                return tn(e);
            ...
            var $n = S('ObservableObjectAdministration', Wn);
            function Hn(e) {
                return (
                    Fn[e] ||
                    (Fn[e] = {
            ...
            function cr(e) {
                return An(e) ? e.slice() : T(e) || Un(e) || E(e) || zn(e) ? Array.from(e.entries()) : e;
            }
            function fr(e) {
        ...
        6298: (e, t, n) => {
            ...
            if (('undefined' != typeof window ? (E = window) : void 0 !== n.g && (E = n.g), E && E._schedMock)) {
                ...
                ((k = function (e, t) {
                    ((A = e), (N = t), I || 0 > t ? V.postMessage(void 0) : R || ((R = !0), w(z)));
                }),
                    (S = function () {
                        ((A = null), (j = !1), (N = -1));
                    }));
