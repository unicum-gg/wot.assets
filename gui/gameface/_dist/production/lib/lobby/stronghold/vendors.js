    ...
    [276],
    {
        797: (e, t, n) => {
            ...
            class b {
                ...
                *getBlocks(e, t) {
                    if ((s(e.nodeType === u), this.className && e.classList.contains(this.className))) return;
                    const n = (function (e) {
                        const t = e.nodeName,
                            n = v[t];
                        ...
                        if ('function' == typeof getComputedStyle) {
                            ...
                            const n = t.display;
                            if (n) return 'inline' === n ? l : h;
                        }
                        return _.has(t) ? h : l;
                    })(e);
                    if (n === f) return;
                    if (n === d) return t && t.hasText() && (yield t, (t.textNodes = [])), void s(!e.firstChild);
                    s(n === h || n === l);
                    const r = !t || n === h,
                        i = r ? new p(e) : t;
                    s(i);
                    for (var a, b = o(e.childNodes); !(a = b()).done; ) {
                        const e = a.value;
                        switch (e.nodeType) {
                            case u:
                                for (var g, y = o(this.getBlocks(e, i)); !(g = y()).done; ) {
                                    const e = g.value;
                                    yield e;
                                }
                                break;
                ...
                applyToParagraph(e) {
                    ...
                    if ((s(r.length > 0), s(r.reduce((e, t) => e + t.length, 0) === n.length), r.length <= 1)) return;
                    const i = [];
                    let a = 0;
                    for (var u, c = o(r); !(u = c()).done; ) {
                        const e = u.value;
                        s(e.length > 0), (a += e.length), i.push(a);
                    }
                    s(i[0] > 0),
                ...
                splitTextNodes(e, t) {
                    ...
                    for (var u, c = o(e); !(u = c()).done; ) {
                        ...
                        for (; i < o; ) {
                            const e = i - a;
                            s(e >= l), c.push(n.substring(l, e)), (l = e), ++r, s(t[r] > i), (i = t[r]);
                        }
                        s(c.length > 0), l < n.length && c.push(n.substring(l)), this.splitTextNode(e, c), (a = o);
                    }
                    s(a === n), s(r < t.length), s(t[r] >= n);
                }
                splitTextNode(e, t) {
            ...
            class O {
                ...
                static getFeature(e, t, n, r, i, o, a, s, u) {
                    const c = O.getUnicodeBlockFeature(e),
                        l = O.getUnicodeBlockFeature(t),
                        h = O.getUnicodeBlockFeature(n),
                        f = O.getUnicodeBlockFeature(r),
                        d = O.getUnicodeBlockFeature(i),
                        v = O.getUnicodeBlockFeature(o),
                        _ = {
                            UP1: a,
                            UP2: s,
                            UP3: u,
            ...
            const T = () => new O(new Map(Object.entries(i)));
        },
        483: (e, t) => {
            var n;
            !(function () {
        ...
        515: (e, t, n) => {
            ...
            var A;
            (A = a.unstable_batchedUpdates) || (A = s), (0, r.jQ)({ reactionScheduler: A });
        },
        174: (e, t, n) => {
            'use strict';
            ...
            function F(e, t, n) {
                ...
                var r,
                    i = new G(e);
                return t !== p && Rt(Nt, i, t, r), n !== p && Pt(i, n), i;
            }
            var H = {
            ...
            function Z(e, t, n, r, i) {
                var o, a, s, u, c, l, h, f;
                void 0 === i && (i = at.safeDescriptors), (f = r), t.annotationType_, f.value;
                var d,
                    v = r.value;
                (null == (o = t.options_) ? void 0 : o.bound) && (v = v.bind(null != (d = e.proxy_) ? d : e.target_));
                return {
                    value: Re(
            ...
            function ae(e, t, n, r) {
                return (
                    ...
                    e.defineComputedProperty_(t, P({}, this.options_, { get: n.get, set: n.set }), r)
                );
            }
            function se(e, t) {
            ...
            var le = he();
            function he(e) {
                return { annotationType_: 'true', options_: e, make_: fe, extend_: de };
            }
            function fe(e, t, n, r) {
                var i, o, a, s;
                ...
                if (r !== e.target_ && 'function' == typeof n.value)
                    return U(n.value)
                        ? ((null == (s = this.options_) ? void 0 : s.autoBind) ? Ft.bound : Ft).make_(e, t, n, r)
                        : ((null == (a = this.options_) ? void 0 : a.autoBind) ? St.bound : St).make_(e, t, n, r);
                var l,
                    h = !1 === (null == (i = this.options_) ? void 0 : i.deep) ? Te.ref : Te;
            ...
            var pe = se('observable'),
                be = se('observable.ref', { enhancer: z }),
                ge = se('observable.shallow', {
                    enhancer: function (e, t, n) {
                        return null == e || Vn(e) || Un(e) || Sn(e) || jn(e)
                            ? e
                            : Array.isArray(e)
            ...
            var Be,
                ...
                Te = a(We, {
                    box: function (e, t) {
                        var n = _e(t);
                        return new Ie(e, Ue(n), n.name, !0, n.equals);
                    },
                    array: function (e, t) {
                        var n = _e(t);
                        return (!1 === at.useProxies || !1 === n.proxy ? zn : fn)(e, Ue(n), n.name);
                    },
                    map: function (e, t) {
                        var n = _e(t);
                        return new wn(e, Ue(n), n.name);
                    },
                    set: function (e, t) {
                        var n = _e(t);
                        return new En(e, Ue(n), n.name);
                    },
                            ...
                            !1 === at.useProxies || !1 === (null == n ? void 0 : n.proxy)
                                ...
                                : (function (e, t) {
                                      ...
                                      return (
                                          v(),
                                          (e = Rn(e, t)),
                                          null != (r = (n = e[Q]).proxy_) ? r : (n.proxy_ = new Proxy(e, Zt))
                                      );
                                  })({}, n),
                            e,
                            t,
                ...
                Ae = 'computed',
                we = ie(Ae),
                Se = ie('computed.struct', { equals: H.structural }),
                xe = function (e, t) {
                    if (g(t)) return M(e, t, we);
                    if (m(e)) return I(ie(Ae, e));
                    var n = m(t) ? t : {};
                    return (n.get = e), n.name || (n.name = e.name || ''), new Ge(n);
                };
            Object.assign(xe, we), (xe.struct = I(Se));
            var Ee,
                je = 0,
                ke = 1,
                Ne = null != (Be = null == (Oe = s(function () {}, 'name')) ? void 0 : Oe.configurable) && Be,
                Pe = { value: 'action', configurable: !0, writable: !1, enumerable: !1 };
            function Re(e, t, n, r) {
                function i() {
                    return Ce(e, n, t, r || this, arguments);
                }
                return (
                    void 0 === n && (n = !1),
                    (i.isMobxAction = !0),
                    Ne && ((Pe.value = e), Object.defineProperty(i, 'name', Pe)),
                    i
                );
            }
                ...
                Ie = (function (e) {
                    ...
                    return (
                        ...
                        (n.prepareNewValue_ = function (e) {
                            if ((ze(this), en(this))) {
                                var t = nn(this, { object: this, type: cn, newValue: e });
                        ...
                        (n.setNewValue_ = function (e) {
                            ...
                            (this.value_ = e),
                                this.reportChanged(),
                                rn(this) && an(this, { type: cn, object: this, newValue: e, oldValue: t });
                        }),
                        (n.get = function () {
                ...
                Ge = (function () {
                    ...
                    return (
                        (t.onBecomeStale_ = function () {
                            !(function (e) {
                                if (e.lowestObserverState_ !== Me.UP_TO_DATE_) return;
                                ...
                                if ((ft(this), qe(this))) {
                                    ...
                                    this.keepAlive_ && !e && (at.trackingContext = this),
                                        this.trackAndCompute() &&
                                            (function (e) {
                                                if (e.lowestObserverState_ === Me.STALE_) return;
            ...
            var vt = (function () {
                ...
                return (
                    ...
                    (t.schedule_ = function () {
                        this.isScheduled_ || ((this.isScheduled_ = !0), at.pendingReactions.push(this), pt());
                    }),
                    ...
                    (t.dispose = function () {
                        this.isDisposed_ || ((this.isDisposed_ = !0), this.isRunning_ || (lt(), $e(this), ht()));
                    }),
            ...
            function pt() {
                at.inBatch > 0 || at.isRunningReactions || _t(bt);
            }
            function bt() {
            ...
            var gt = O('Reaction', vt);
            var yt = 'action',
                mt = 'autoAction',
                Ut = '<unnamed action>',
                Wt = $(yt),
                Bt = $('action.bound', { bound: !0 }),
                Ot = $(mt, { autoAction: !0 }),
                Tt = $('autoAction.bound', { autoAction: !0, bound: !0 });
            function At(e) {
                return function (t, n) {
                    return b(t)
                        ? Re(t.name || Ut, t, e)
            ...
            Object.assign(St, Ot), (wt.bound = I(Bt)), (St.bound = I(Tt));
            var jt = function (e) {
                return e();
            };
            function kt(e) {
            ...
            function Rt(e, t, n, r) {
                var i = 'function' == typeof r ? Xn(t, n) : Xn(t),
                    o = b(r) ? r : n,
                    a = e + 'L';
                return (
            ...
            function Dt(e) {
                ...
                var t,
                    ...
                    a = e.enforceActions;
                if (
                    (void 0 !== i && (at.useProxies = i === Ct || ('never' !== i && 'undefined' != typeof Proxy)),
                    'ifavailable' === i && (at.verifyProxies = !0),
                    void 0 !== a)
                ) {
                    var s = a === Ct ? Ct : 'observed' === a;
                    (at.enforceActions = s), (at.allowStateChanges = !0 !== s && s !== Ct);
                }
                [
                    ...
                    var n = e,
                        ...
                        i = function () {
                            var e,
                                ...
                                i = arguments,
                                o = ++Mt,
                                a = wt(r + ' - runid: ' + o + ' - init', n).apply(t, i),
                                s = void 0,
                                u = new Promise(function (t, n) {
                                    ...
                                    function u(e) {
                                        ...
                                        s = void 0;
                                        try {
                                            t = wt(r + ' - runid: ' + o + ' - yield ' + i++, a.next).call(a, e);
                                        } catch (e) {
                                            return n(e);
                                        }
                                        l(t);
                                    ...
                                    function c(e) {
                                        ...
                                        s = void 0;
                                        try {
                                            t = wt(r + ' - runid: ' + o + ' - yield ' + i++, a.throw).call(a, e);
                                        } catch (e) {
                                            return n(e);
                                        }
                                        l(t);
                            ...
                            return (
                                (u.cancel = wt(r + ' - runid: ' + o + ' - cancel', function () {
                                    try {
                                        s && Ht(s);
                                        var t = a.return(void 0),
                                            n = Promise.resolve(t.value);
                                        n.then(p, p), Ht(n), e(new Qt());
                                    } catch (t) {
                                        e(t);
                                    }
                                })),
            ...
            function zt(e, t) {
                return (
                    !!e && (void 0 !== t ? !!Vn(e) && e[Q].values_.has(t) : Vn(e) || !!e[Q] || K(e) || gt(e) || Ke(e))
                );
            }
            function Xt(e) {
                return zt(e);
                    ...
                    return (
                        ...
                        (t.set_ = function (e, t) {
                            ...
                            if (e < n.length) {
                                ...
                                var i = n[e];
                                if (en(this)) {
                                    var o = nn(this, { type: cn, object: this.proxy_, index: e, newValue: t });
                                    if (!o) return;
                                    t = o.newValue;
                                }
            ...
            function vn(e, t) {
                'function' == typeof Array.prototype[e] && (dn[e] = t(e));
            }
            function _n(e) {
                return function () {
                    var t = this[Q];
            ...
            var gn,
                yn,
                mn = O('ObservableArrayAdministration', hn);
            function Un(e) {
                return y(e) && mn(e[Q]);
            }
            var Wn = {},
                Bn = 'add',
                On = 'delete';
            (gn = Symbol.iterator), (yn = Symbol.toStringTag);
            var Tn,
                An,
                wn = (function () {
                    function e(e, t, n) {
                    ...
                    return (
                        ...
                        (t.has = function (e) {
                            ...
                            if (!n) {
                                var r = (n = new Ie(this.has_(e), z, 'ObservableMap.key?', !1));
                        ...
                        (t.set = function (e, t) {
                            var n = this.has_(e);
                            if (en(this)) {
                                var r = nn(this, { type: n ? cn : Bn, object: this, newValue: t, name: e });
                                if (!r) return this;
                                t = r.newValue;
                            }
                        ...
                        (t.delete = function (e) {
                            var t = this;
                            if ((this.keysAtom_, en(this)) && !nn(this, { type: On, object: this, name: e })) return !1;
                            if (this.has_(e)) {
                                var n = rn(this),
                                    r = n
                                        ? {
                                ...
                                Yt(function () {
                                    ...
                                    if (!a)
                                        if (t.data_.size !== o.size) t.keysAtom_.reportChanged();
                                            ...
                                            for (
                                                var b = t.data_.keys(), g = o.keys(), y = b.next(), U = g.next();
                                                !y.done;
            ...
            var En = (function () {
                    ...
                    return (
                        ...
                        (t.add = function (e) {
                            var t = this;
                            if ((this.atom_, en(this)) && !nn(this, { type: Bn, object: this, newValue: e }))
                                return this;
                            if (!this.has(e)) {
                                Yt(function () {
                        ...
                        (t.delete = function (e) {
                            var t = this;
                            if (en(this) && !nn(this, { type: On, object: this, oldValue: e })) return !1;
                            if (this.has(e)) {
                                var n = rn(this),
                                    r = n
                                        ? {
                ...
                Pn = (function () {
                    ...
                    return (
                        ...
                        (t.get_ = function (e) {
                            return at.trackingDerivation && !E(this.target_, e) && this.has_(e), this.target_[e];
                        }),
                        ...
                        (t.has_ = function (e) {
                            ...
                            return (
                                t ||
                                    ((t = new Ie(e in this.target_, z, 'ObservableObject.key?', !1)),
                        ...
                        (t.defineObservableProperty_ = function (e, t, n, r) {
                            ...
                            try {
                                ...
                                var c = new Ie(t, n, 'ObservableObject.key', !1);
                        ...
                        (t.delete_ = function (e, t) {
                            ...
                            if (en(this) && !nn(this, { object: this.proxy_ || this.target_, name: e, type: Nn }))
                                return null;
                            try {
                                var n, r;
                                lt();
                                ...
                                if (
                                    (a && (this.values_.delete(e), a instanceof Ie && (u = a.value_), dt(a)),
                        ...
                        (t.ownKeys_ = function () {
                            return this.keysAtom_.reportObserved(), S(this.target_);
                        }),
                        (t.keys_ = function () {
            ...
            var Cn = O('ObservableObjectAdministration', Pn);
            function Dn(e) {
                return (
                    kn[e] ||
                    (kn[e] = {
            ...
            (Mn = Kn),
                ...
                Object.setPrototypeOf
                    ? Object.setPrototypeOf(Mn.prototype, Qn)
                    : void 0 !== Mn.prototype.__proto__
                      ? (Mn.prototype.__proto__ = Qn)
                      : (Mn.prototype = Qn);
            var Fn = (function (e) {
                function t(t, n, r, i) {
                    var o;
                    ...
                    if (((a.proxy_ = C(o)), B(C(o), Q, a), t && t.length)) {
                        var s = De(!0);
                        o.spliceWithArray(0, 0, t), Ve(s);
                    }
                    return o;
                }
                R(t, e);
            ...
            function Yn(e, t) {
                var n;
                if (void 0 !== t) n = Xn(e, t);
                else {
                    if (xt(e)) return e.name;
                    n = Vn(e) || Sn(e) || jn(e) ? $n(e) : Xn(e);
                }
                return n.name_;
            }
            ...
            function er(e, t, n, r, i) {
                ...
                if ((r.push(e), i.push(t), s)) {
                    ...
                    for (; l--; ) if (!E(t, (h = f[l])) || !er(e[h], t[h], n - 1, r, i)) return !1;
                }
                return r.pop(), i.pop(), !0;
            }
            function tr(e) {
                return Un(e) ? e.slice() : T(e) || Sn(e) || A(e) || jn(e) ? Array.from(e.entries()) : e;
            }
            function nr(e) {
