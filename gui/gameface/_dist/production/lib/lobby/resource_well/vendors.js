(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
    [52],
    {
        1686: (t, e, n) => {
            ...
            class c extends (498 == n.j ? l : null) {
                constructor(t) {
                    (super(),
                        (this.done = !0),
            ...
            class p extends (498 == n.j ? l : null) {
                constructor(t) {
            ...
            class f extends (498 == n.j ? p : null) {
                constructor(t) {
                    super(t);
                }
                static create(t) {
            ...
            const v = (t, e) => {
                ...
                return (0, r.forwardRef)((i, o) => {
                    ...
                    const U = e.getComponentProps(c.getValue());
        ...
        9738: (t, e, n) => {
            ...
            const S = c({}, { tension: 170, friction: 26 }, { mass: 1, damping: 1, easing: (t) => t, clamp: !1 });
            class _ {
                constructor() {
                    ((this.tension = void 0),
            ...
            const P = (t, e) =>
                ...
                C = (t) => ({ value: t, noop: !0, finished: !0, cancelled: !1 }),
                ...
                return o || t !== d || e.reset
                    ? (n.promise = a(function* () {
                          ...
                          const y = new Promise((t, e) => ((f = t), (m = e))),
                              v = (t) => {
                                  const e = (i <= (n.cancelId || 0) && I(r)) || (i !== n.asyncId && A(r, !1));
                              ...
                              W = (t, e) => {
                                  const o = new Q(),
                                      u = new R();
                                  return a(function* () {
                                      if (s.OH.skipAnimation) throw (N(n), (u.result = A(r, !1)), m(u), u);
                                      v(o);
            ...
            class Z extends (498 == n.j ? V : null) {
                        ...
                        actions: {
                            pause: () => {
                                F(this) ||
                                    (H(this, !0),
                                    (0, s.bl)(a.pauseQueue),
                                    nt(this, 'onPause', A(this, G(this, this.animation.to)), this));
                            },
                            resume: () => {
                                F(this) &&
                                    (H(this, !1),
                                    ...
                                    nt(this, 'onResume', A(this, G(this, this.animation.to)), this));
                            },
                ...
                _merge(t, e, n) {
                    ...
                    ((r || o) && (_.velocity = 0),
                        e.config &&
                            ...
                            })(_, d(e.config, a), e.config !== u.config ? d(u.config, a) : void 0));
                    let k = (0, i.ys)(this);
                    ...
                    const P = s.is.und(e.reset) ? o && !e.default : !s.is.und(v) && h(e.reset, a),
                        ...
                        L = !E && (!R || h(u.immediate || e.immediate, a));
                    if (T) {
                        const t = (0, i.sb)(g);
                        if (t !== k.constructor) {
                            if (!L)
                    ...
                    if (!V) {
                        const t = P || (!D(this) && B);
                        ((T || t) && (($ = (0, s.Xy)(U(N), Q)), (V = !$)),
                            (((0, s.Xy)(l.immediate, L) || L) && (0, s.Xy)(_.decay, x) && (0, s.Xy)(_.velocity, O)) ||
                                (V = !0));
                    }
                    if (
                        ($ && q(this) && (l.changed && !P ? (V = !0) : V || this._stop(p)),
                        !E &&
                            ((V || (0, s.j$)(p)) &&
                                ((l.values = k.getPayload()),
                                (l.toValues = (0, s.j$)(g) ? null : M == i.eC ? [1] : (0, s.qo)(Q))),
                            l.immediate != L && ((l.immediate = L), L || P || this._set(p)),
                            V))
                    ) {
                        const t = l.onRest;
                        (0, s.S6)(tt, (t) => et(this, e, t));
                        const r = A(this, G(this, p));
                        ((0, s.bl)(this._pendingCalls, r),
                            ...
                            l.changed &&
                                s.Wn.batchedUpdates(() => {
                                    ((l.changed = !P),
                                        null == t || t(r, this),
                                        P ? d(u.onRest, r) : null == l.onStart || l.onStart(r, this));
                                }));
                    }
                    (P && this._set(N),
                        E
                            ? n(j(e.to, e, this._state, this))
                            : V
                              ? this._start()
                              : q(this) && !T
                                ? this._pendingCalls.add(n)
                ...
                _onStart() {
                    const t = this.animation;
                    t.changed || ((t.changed = !0), nt(this, 'onStart', A(this, G(this, t.to)), this));
                }
                _onChange(t, e) {
                ...
                _start() {
                    ...
                    ((0, i.ys)(this).reset((0, s.je)(t.to)),
                        ...
                        q(this) || (z(this, !0), F(this) || this._resume()));
                }
                _resume() {
                ...
                _stop(t, e) {
                    if (q(this)) {
                        ...
                        const r = e ? I(this.get()) : A(this.get(), G(this, null != t ? t : n.to));
                        ((0, s.bl)(this._pendingCalls, r),
            ...
            const tt = 498 == n.j ? ['onStart', 'onRest', 'onChange', 'onPause', 'onResume'] : null;
            function et(t, e, n) {
            ...
            const st = 498 == n.j ? ['onStart', 'onChange', 'onRest'] : null;
            let rt = 1;
            class it {
                constructor(t, e) {
                    ((this.id = rt++),
                            ...
                            p.push(
                                k(++t._lastAsyncId, {
                                    ...
                                    actions: {
                                        ...
                                        resume: s.ZT,
                                        start(e, n) {
                                            m ? (N(h, t._lastAsyncId), n(I(t))) : ((e.onRest = u), n(j(d, e, h, t)));
                                        },
                                    },
                                }),
                            ),
            ...
            const mt = ['children'],
                ...
                yt =
                    ((vt = gt),
                    (Wt = {}),
                    Object.assign(vt, r.createContext(Wt)),
            ...
            function Bt(t, e, n) {
                ...
                i && !n && (n = []);
                const o = (0, r.useMemo)(() => (i || 3 == arguments.length ? Ut() : void 0), []),
                    a = (0, r.useRef)(0),
                    u = (0, s.NW)(),
                    l = (0, r.useMemo)(
                        () => ({
                ...
                ((0, s.bt)(() => {
                    ...
                    (t.length && ((l.queue = []), (0, s.S6)(t, (t) => t())),
                        (0, s.S6)(d.current, (t, e) => {
                            ...
                            const n = h[e];
                            n && (E(t, n.ref), t.ref ? t.queue.push(n) : t.start(n));
                        }));
                }),
                    (0, s.tf)(() => () => {
            ...
            class Et extends V {
                ...
                advance(t) {
                    ...
                    ((0, s.Xy)(e, n) || ((0, i.ys)(this).setValue(e), this._onChange(e, this.idle)),
                        !this.idle && _t(this._active) && wt(this));
                }
                _get() {
                ...
                _start() {
                    this.idle &&
                        ...
                        s.OH.skipAnimation ? (s.Wn.batchedUpdates(() => this.advance()), wt(this)) : s.fT.start(this));
                }
                _attach() {
                    let t = 1;
            ...
            s.OH.assign({ createStringInterpolator: s.qS, to: (t, e) => new Et(t, e) });
            s.fT.advance;
        },
        2810: (t, e, n) => {
            'use strict';
            ...
            r.setTimeout = (t, e) => {
                let n = r.now() + e,
                    s = () => {
                        ...
                        (~t && l.splice(t, 1), (U.count -= ~t ? 1 : 0));
                    },
                    i = { time: n, handler: t, cancel: s };
                return (l.splice(c(n), 0, i), (U.count += 1), m(), i);
            };
            ...
            function y() {
                ...
                h = r.now();
                let e = c(h);
                (e && (W(l.splice(0, e), (t) => t.handler()), (U.count -= e)),
                    o.flush(),
            ...
            const U = {
                count: 0,
                clear() {
                    ((h = -1), (l = []), (o = v()), (s = v()), (a = v()), (i = v()), (u = v()), (U.count = 0));
                },
            };
            var B = n(7363);
            function b() {}
            ...
            const _ = (t, e) => t.forEach(e);
            function w(t, e, n) {
                if (E.arr(t)) for (let s = 0; s < t.length; s++) e.call(n, t[s], `${s}`);
                else for (const s in t) t.hasOwnProperty(s) && e.call(n, t[s], s);
            }
            const x = (t) => (E.und(t) ? [] : E.arr(t) ? t : [t]);
            function O(t, e) {
                if (t.size) {
            ...
            const V = {
                ...
                start(t) {
                    M > t.priority ? (Q.add(t), r.onStart($)) : (D(t), r(F));
                },
                advance: F,
                sort(t) {
            ...
            function F(t) {
                ...
                for (let n = 0; n < R.length; n++) {
                    const s = R[n];
                    ((M = s.priority), s.idle || (j(s), s.advance(t), s.idle || e.push(s)));
                }
            ...
            const X = new RegExp('rgb' + G(H, H, H)),
                ...
                K = new RegExp('hsl' + G(H, Z, Z)),
                J = new RegExp('hsla' + G(H, Z, Z, H)),
            ...
            const dt = (t, e, n) => {
                if (E.fun(t)) return t;
                if (E.arr(t)) return dt({ range: t, output: e, extrapolate: n });
                if (E.str(t.output[0])) return P(t);
                const s = t,
                    r = s.output,
                    i = s.range || [0, 1],
            ...
            const xt = /rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,
                ...
                kt = (t) => {
                    ...
                    return (t) => {
                        var n;
                        const r =
                            !_t.test(e[0]) && (null == (n = e.find((t) => _t.test(t))) ? void 0 : n.replace(Et, ''));
                        let i = 0;
                        return e[0].replace(Et, () => `${s[i++](t)}${r || ''}`).replace(xt, Ot);
                    };
                },
                Pt = 'react-spring: ',
                Ct = (t) => {
                ...
                At = Ct(console.warn);
            function It() {
                At(`${Pt}The "interpolate" function is deprecated in v9 (use "to" instead)`);
            }
            const jt = Ct(console.warn);
            function Nt() {
                jt(
            ...
            function Qt(t) {
                return E.str(t) && ('#' == t[0] || /\d/.test(t) || t in (A || {}));
            }
        ...
        9769: (t, e, n) => {
            'use strict';
            n.d(e, { A: () => s });
            const s = /^([16]69|[26]74|(32|49|77)8|110|730|813|965)$/.test(n.j)
                ? [
        ...
        1281: (t, e, n) => {
            'use strict';
            if ((n.d(e, { D4: () => S }), !/^(167|418|434|924)$/.test(n.j))) var s = n(9769);
            const r = {
                'BB2:108120': 1817,
                'BP2:OO': 790,
                'UB3:107': 714,
            ...
            if (!/^(167|418|434|924)$/.test(n.j)) var i = n(6906);
            function o(t, e) {
                var n = ('undefined' != typeof Symbol && t[Symbol.iterator]) || t['@@iterator'];
                if (n) return (n = n.call(t)).next.bind(n);
                if (
            ...
            if (!/^(167|418|434|924)$/.test(n.j)) var W = n(3759);
            function U(t, e) {
                var n = ('undefined' != typeof Symbol && t[Symbol.iterator]) || t['@@iterator'];
                if (n) return (n = n.call(t)).next.bind(n);
                if (
            ...
            class E {
                ...
                static getUnicodeBlockFeature(t) {
                    ...
                    return `${(0, W.ml)(s.A, e)}`.padStart(3, '0');
                }
                static getFeature(t, e, n, s, r, i, o, a, u) {
                    const l = E.getUnicodeBlockFeature(t),
                        c = E.getUnicodeBlockFeature(e),
                        d = E.getUnicodeBlockFeature(n),
                        h = E.getUnicodeBlockFeature(s),
                        p = E.getUnicodeBlockFeature(r),
                        f = E.getUnicodeBlockFeature(i),
                        m = {
                            UP1: o,
                            UP2: a,
                            UP3: u,
                ...
                applyElement(t, e = b) {
                    new v(this, { separator: t.ownerDocument.createElement('wbr'), threshold: e }).applyToElement(t);
                }
                translateHTMLString(t, e = b) {
                    if ('' === t) return t;
                    const n = (0, i.X)(t);
                    if (E.hasChildTextNode(n.body)) {
            ...
            const S = () => new E(new Map(Object.entries(r)));
        },
        3759: (t, e, n) => {
            'use strict';
            n.d(e, { UI: () => r, ml: () => s });
                        ...
                        e.split(' ').forEach(function (e) {
                            return (
                                ...
                                void ((n = t).classList
                                    ...
                                    : 'string' == typeof n.className
                                      ? (n.className = a(n.className, s))
                                      : n.setAttribute('class', a((n.className && n.className.baseVal) || '', s)))
                            );
                            var n, s;
                        })
                    );
                ...
                p = (function (t) {
                    ...
                    return (
                        (n.addClass = function (t, e, n) {
                            ...
                            ('appear' === e && 'done' === n && (s += ' ' + this.getClassNames('enter').doneClassName),
                        ...
                        (n.removeClasses = function (t, e) {
                            var n = this.appliedClasses[e],
                                ...
                                r = n.active,
                                i = n.done;
                            ((this.appliedClasses[e] = {}), s && h(t, s), r && h(t, r), i && h(t, i));
                        }),
                        (n.render = function () {
                            var t = this.props,
        ...
        9953: (t, e, n) => {
            ...
            var c = 'out-in',
                ...
                h = function (t, e, n) {
                    return function () {
                        var s;
                        (t.props[e] && (s = t.props)[e].apply(s, arguments), n());
                    };
                },
                p =
                    (((s = {})[c] = function (t) {
                        ...
                        return a().cloneElement(e, {
                            in: !1,
                            onExited: h(e, 'onExited', function () {
                                n(u.d0, null);
                            }),
                        });
                    }),
                    (s[d] = function (t) {
                        ...
                        return [
                            ...
                            a().cloneElement(s, {
                                in: !0,
                                onEntered: h(s, 'onEntered', function () {
                                    n(u.d0);
                                }),
                            }),
                        ];
                ...
                f =
                    (((r = {})[c] = function (t) {
                        ...
                        return a().cloneElement(e, {
                            in: !0,
                            onEntered: h(e, 'onEntered', function () {
                                n(u.cn, a().cloneElement(e, { in: !0 }));
                            }),
                        });
                    }),
                    (r[d] = function (t) {
                ...
                m = (function (t) {
                    function e() {
                        for (var e, n = arguments.length, s = new Array(n), r = 0; r < n; r++) s[r] = arguments[r];
                        return (
                            ((e = t.call.apply(t, [this].concat(s)) || this).state = { status: u.cn, current: null }),
                            (e.appeared = !1),
                            (e.changeState = function (t, n) {
                                (void 0 === n && (n = e.state.current), e.setState({ status: t, current: n }));
                            }),
                            e
                        );
                    }
                                  ...
                                  : !e.current ||
                                      ...
                                      n === s ||
                                          (a().isValidElement(n) &&
                                              ...
                                              null != n.key &&
                                              n.key === s.key))
                                    ? { current: a().cloneElement(t.children, { in: !0 }) }
                                    : { status: u.Ix };
                            var n, s;
                        }),
                        (n.render = function () {
                            ...
                            return a().createElement(l.Z.Provider, { value: { isMounting: !this.appeared } }, t);
                        }),
                        e
                    );
                })(a().Component);
            ((m.propTypes = {}), (m.defaultProps = { mode: c }));
            const g = /^(274|498|669|813)$/.test(n.j) ? m : null;
        },
        7029: (t, e, n) => {
            'use strict';
            n.d(e, { cn: () => f, d0: () => p, Ix: () => m, ZP: () => v });
            var s = n(4361),
                r = n(8846),
                i = n(7363),
                o = n.n(i),
                ...
                g = (function (t) {
                    function e(e, n) {
                        ...
                        return (
                            ...
                            e.in
                                ? i
                                    ? ((r = h), (s.appearStatus = p))
                                    : (r = f)
                                : (r = e.unmountOnExit || e.mountOnEnter ? d : h),
                            (s.state = { status: r }),
                            (s.nextCallback = null),
                            s
                        );
                    ...
                    return (
                        ...
                        (n.updateStatus = function (t, e) {
                            ...
                            } else this.props.unmountOnExit && this.state.status === h && this.setState({ status: d });
                        }),
                        ...
                        (n.render = function () {
                            ...
                            if (
                                ...
                                return o().createElement(c.Z.Provider, { value: null }, n(t, r));
                            var i = o().Children.only(n);
                            return o().createElement(c.Z.Provider, { value: null }, o().cloneElement(i, r));
                        }),
                        e
                    );
                })(o().Component);
        ...
        1507: (t, e, n) => {
            ...
            n.d(e, { Z: () => r });
            var s = n(7363);
            const r = n.n(s)().createContext(null);
        },
        8846: (t, e, n) => {
            'use strict';
            if ((n.d(e, { Z: () => r }), /^(274|498|669|813)$/.test(n.j))) var s = n(720);
            function r(t, e) {
