(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
    [674],
    {
        686: (e, t, n) => {
            ...
            class c extends (/^(126|364)$/.test(n.j) ? l : null) {
                constructor(e) {
                    super(),
                        (this.done = !0),
            ...
            class d extends (/^(126|364)$/.test(n.j) ? c : null) {
                constructor(e) {
                    super(0),
                        (this._string = null),
            ...
            class f extends (/^(126|364)$/.test(n.j) ? l : null) {
                constructor(e) {
            ...
            class p extends (/^(126|364)$/.test(n.j) ? f : null) {
                constructor(e) {
                    super(e);
                }
                static create(e) {
            ...
            const _ = (e, t) => {
                ...
                return (0, i.forwardRef)((o, s) => {
                    const a = (0, i.useRef)(null),
                        ...
                        l = (function (e, t) {
                            const n = new Set();
                            (h.dependencies = n), e.style && (e = b({}, e, { style: t.createAnimatedStyle(e.style) }));
        ...
        738: (e, t, n) => {
            ...
            const q = Symbol.for('SpringPhase'),
                ...
                G = (e, t) => (t ? (e[q] |= 3) : (e[q] &= -3)),
                z = (e, t) => (t ? (e[q] |= 4) : (e[q] &= -5));
            class K extends (/^(126|364)$/.test(n.j) ? M : null) {
                constructor(e, t) {
                    if (
                        (super(),
                        (this.key = void 0),
                                ...
                                if (r.is.und(s.duration))
                                    if (s.decay) {
                                        ...
                                        for (
                                            ...
                                            (a +=
                                                ((1e-6 * -s.tension * (f - d) + 0.001 * -s.friction * a) / s.mass) * b),
                                                (f += a * b);
                                        }
                                    }
                                else {
                ...
                _merge(e, t, n) {
                    ...
                    if (!M) {
                        ...
                        (U || e) && ((q = (0, r.Xy)(y(R), I)), (M = !q)),
                            (((0, r.Xy)(l.immediate, D) || D) && (0, r.Xy)(S.decay, A) && (0, r.Xy)(S.velocity, T)) ||
                                (M = !0);
                    }
                    if (
            ...
            const ee = /^(126|364)$/.test(n.j) ? ['onStart', 'onRest', 'onChange', 'onPause', 'onResume'] : null;
            function te(e, t, n) {
            ...
            const re = /^(126|364)$/.test(n.j) ? ['onStart', 'onChange', 'onRest'] : null;
            let ie = 1;
            class oe {
                constructor(e, t) {
                    (this.id = ie++),
            ...
            class We extends M {
                ...
                advance(e) {
                    ...
                    (0, r.Xy)(t, n) || ((0, o.ys)(this).setValue(t), this._onChange(t, this.idle)),
                        !this.idle && Se(this._active) && xe(this);
                }
                _get() {
        ...
        810: (e, t, n) => {
            ...
            const X = new RegExp('rgb' + H(z, z, z)),
                Z = new RegExp('rgba' + H(z, z, z, z)),
                J = new RegExp('hsl' + H(z, K, K)),
            ...
            const Ae = /rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,
                Te = (e, t, n, r, i) => `rgba(${Math.round(t)}, ${Math.round(n)}, ${Math.round(r)}, ${i})`,
                Ee = (e) => {
                    xe || (xe = k ? new RegExp(`(${Object.keys(k).join('|')})(?!\\w)`, 'g') : /^\b$/);
                    const t = e.output.map((e) => ge(e).replace(Be, ce).replace(xe, ce)),
                    ...
                    return (e) => {
                        ...
                        let o = 0;
                        return t[0].replace(We, () => `${r[o++](e)}${i || ''}`).replace(Ae, Te);
                    };
                },
                je = 'react-spring: ',
                Pe = (e) => {
        ...
        281: (e, t, n) => {
            ...
            class _ {
                ...
                *getBlocks(e, t) {
                    ...
                    for (var o, a = s(e.childNodes); !(o = a()).done; ) {
                        ...
                        switch (e.nodeType) {
                            case l:
                                for (var _, m = s(this.getBlocks(e, i)); !(_ = m()).done; ) {
                                    const e = _.value;
                                    yield e;
                                }
                                break;
            ...
            class W {
                ...
                applyElement(e, t = w) {
                    new _(this, { separator: e.ownerDocument.createElement('wbr'), threshold: t }).applyToElement(e);
                }
        ...
        515: (e, t, n) => {
            ...
            var f = l
                ...
                v = f.recordReactionAsCommitted,
                g = (f.resetCleanupScheduleForTests, f.forceCleanupTimerToRunNowForTests, !1);
            function b() {
                return g;
            }
            var _ = function (e, t) {
            ...
            function W(e, t) {
                ...
                return (
                    ...
                    Object.keys(r).forEach(function (e) {
                        B[e] || Object.defineProperty(o, e, Object.getOwnPropertyDescriptor(r, e));
                    }),
                    (n.displayName = a),
                    n
                );
            ...
            var S;
            (S = s.unstable_batchedUpdates) || (S = a), (0, r.jQ)({ reactionScheduler: S });
        },
        946: (e, t, n) => {
            'use strict';
            n.d(t, { Om: () => O });
        ...
        174: (e, t, n) => {
            ...
            var be = ae('observable'),
                ...
                me = ae('observable.shallow', {
                    enhancer: function (e, t, n) {
                        return null == e || Zn(e) || Cn(e) || Mn(e) || Fn(e)
                            ? e
                            : Array.isArray(e)
                ...
                qe = (function (e) {
                    ...
                    return (
                        ...
                        (n.setNewValue_ = function (e) {
                            ...
                            (this.value_ = e),
                                this.reportChanged(),
                                bn(this) && mn(this, { type: wn, object: this, newValue: e, oldValue: t });
                        }),
                        (n.get = function () {
            ...
            var wt = W('Reaction', bt);
            var Ut = 'action',
                Wt = 'autoAction',
                Bt = '<unnamed action>',
                St = X(Ut),
                xt = X('action.bound', { bound: !0 }),
                At = X(Wt, { autoAction: !0 }),
            ...
            Object.assign(Pt, At), (jt.bound = L(xt)), (Pt.bound = L(Tt));
            var Rt = function (e) {
                return e();
            };
            function It(e) {
            ...
            function an(e, t) {
                return (
                    !!e && (void 0 !== t ? !!Zn(e) && e[q].values_.has(t) : Zn(e) || !!e[q] || F(e) || wt(e) || Ge(e))
                );
            }
            function un(e) {
                return an(e);
            ...
            var fn = {
                ...
                set: function (e, t, n) {
                    var r;
                    return !!_(t) && (null == (r = hn(e).set_(t, n, !0)) || r);
                },
                deleteProperty: function (e, t) {
                    var n;
                    return !!_(t) && (null == (n = hn(e).delete_(t, !0)) || n);
                },
                                ...
                                dn(function () {
                                    ...
                                    if (!s)
                                        if (t.data_.size !== o.size) t.keysAtom_.reportChanged();
                                            ...
                                            for (
                                                var b = t.data_.keys(), _ = o.keys(), m = b.next(), O = _.next();
                                                !m.done;
            ...
            function pr(e) {
                return Cn(e) ? e.slice() : B(e) || Mn(e) || S(e) || Fn(e) ? Array.from(e.entries()) : e;
            }
            function vr(e) {
                    ...
                    return (
                        ...
                        (n.componentDidUpdate = function (e) {
                            ...
                            if (e !== this.props) {
                                ...
                                this.props.in ? n !== g && n !== b && (t = g) : (n !== g && n !== b) || (t = _);
                            }
                        ...
                        (n.render = function () {
                            ...
                            if (
                                ...
                                return l().createElement(f.Z.Provider, { value: null }, n(e, r));
                            var o = l().Children.only(n);
                            return l().createElement(f.Z.Provider, { value: null }, l().cloneElement(o, r));
                        }),
                        t
                    );
                })(l().Component);
                    ...
                    return (
                        ...
                        (n.removeClasses = function (e, t) {
                            var n = this.appliedClasses[t],
                                ...
                                i = n.active,
                                o = n.done;
                            (this.appliedClasses[t] = {}), r && U(e, r), i && U(e, i), o && U(e, o);
                        }),
                        (n.render = function () {
                            var e = this.props,
                    ...
                    Object.keys(i).forEach(function (o) {
                        ...
                        if ((0, a.isValidElement)(s)) {
                            var u = o in t,
                                l = o in r,
                                c = t[o],
                                h = (0, a.isValidElement)(c) && !c.props.in;
                            !l || (u && !h)
                                ? l || !u || h
                                    ? l &&
                                      u &&
                    ...
                    return (
                        ...
                        (n.render = function () {
                            ...
                            return (
                                ...
                                delete i.exit,
                                null === t
                                    ? u().createElement(l.Z.Provider, { value: o }, s)
                                    : u().createElement(l.Z.Provider, { value: o }, u().createElement(t, i, s))
                            );
                        }),
                        t
                    );
        ...
        846: (e, t, n) => {
            'use strict';
            if ((n.d(t, { Z: () => i }), /^1(07|26)$/.test(n.j))) var r = n(720);
            function i(e, t) {
