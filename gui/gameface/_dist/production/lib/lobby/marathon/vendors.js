    ...
    [639],
    {
        ...
        354: (e, t, W) => {
            ...
            class f {
                ...
                *getBlocks(e, t) {
                    if ((s(e.nodeType === a), this.className && e.classList.contains(this.className))) return;
                    const W = (function (e) {
                        const t = e.nodeName,
                            W = d[t];
                        ...
                        if ('function' == typeof getComputedStyle) {
                            ...
                            const W = t.display;
                            if (W) return 'inline' === W ? i : c;
                        }
                        return h.has(t) ? c : i;
                    })(e);
                    if (W === T) return;
                    if (W === u) return (t && t.hasText() && (yield t, (t.textNodes = [])), void s(!e.firstChild));
                    s(W === c || W === i);
                    const U = !t || W === c,
                        r = U ? new p(e) : t;
                    s(r);
                ...
                splitTextNodes(e, t) {
                    ...
                    for (var o, a = B(e); !(o = a()).done;) {
                        ...
                        (s(a.length > 0), l < W.length && a.push(W.substring(l)), this.splitTextNode(e, a), (n = B));
                    }
                    (s(n === W), s(U < t.length), s(t[U] >= W));
                }
                splitTextNode(e, t) {
            ...
            class v {
                ...
                static getUnicodeBlockFeature(e) {
                    ...
                    return `${(0, g.ml)(U.A, t)}`.padStart(3, '0');
                }
                static getFeature(e, t, W, U, r, n, B, o, s) {
                    const a = v.getUnicodeBlockFeature(e),
                        l = v.getUnicodeBlockFeature(t),
                        i = v.getUnicodeBlockFeature(W),
                        c = v.getUnicodeBlockFeature(U),
                        T = v.getUnicodeBlockFeature(r),
                        u = v.getUnicodeBlockFeature(n),
                        d = {
                            UP1: B,
                            UP2: o,
                            UP3: s,
