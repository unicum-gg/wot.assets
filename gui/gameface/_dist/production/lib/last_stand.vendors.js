...
(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
    ['lib/last_stand.vendors'],
    {
                ...
                b = (
                    ...
                    const i = { applyAnimatedValues: e, createAnimatedStyle: n, getComponentProps: r },
                        o = (t) => {
                            ...
                            return (
                                ((t = s.is.str(t) ? o[t] || (o[t] = v(t, i)) : t[U] || (t[U] = v(t, i))).displayName =
                                    `Animated(${e})`),
                                t
                            );
                        };
        ...
        738: (t, e, n) => {
            ...
            const T = l({}, { tension: 170, friction: 26 }, { mass: 1, damping: 1, easing: (t) => t, clamp: !1 });
            class O {
                constructor() {
                    ((this.tension = void 0),
            ...
            function k(t, { key: e, props: n, defaultProps: r, state: i, actions: o }) {
                return new Promise((a, u) => {
                    ...
                    function y() {
                        p > 0 ? ((f = s.Wn.setTimeout(v, p)), i.pauseQueue.add(g), i.timeouts.add(f)) : v();
                    }
                    function v() {
            ...
            const P = (t, e) =>
                ...
                x = (t) => ({ value: t, noop: !0, finished: !0, cancelled: !1 }),
                j = (t, e, n = !1) => ({ value: t, finished: e, cancelled: n }),
                ...
                return o || t !== d || e.reset
                    ? (n.promise = a(function* () {
                          ...
                          const y = new Promise((t, e) => ((f = t), (m = e))),
                              v = (t) => {
                                  const e = (i <= (n.cancelId || 0) && I(r)) || (i !== n.asyncId && j(r, !1));
                              ...
                              W = (t, e) => {
                                  const o = new M(),
                                      u = new Q();
                                  return a(function* () {
                                      if (s.OH.skipAnimation) throw (C(n), (u.result = j(r, !1)), m(u), u);
                                      v(o);
                          ...
                          let U;
                          if (s.OH.skipAnimation) return (C(n), j(r, !1));
                          try {
                              let e;
                              ((e = s.is.arr(t)
                                  ? ((b = a(function* (t) {
            ...
            class G extends V {
                                    ...
                                    if (o.decay) {
                                        ...
                                        for (
                                            ...
                                            (l && ((g = p == d || p > d == f), g && ((a = -a * u), (p = d))),
                                                (a +=
                                                    ((1e-6 * -o.tension * (p - d) + 0.001 * -o.friction * a) / o.mass) *
                                                    y),
                                                (p += a * y));
                                    }
                                else {
                        ...
                        actions: {
                            pause: () => {
                                F(this) ||
                                    (H(this, !0),
                                    (0, s.bl)(a.pauseQueue),
                                    nt(this, 'onPause', j(this, X(this, this.animation.to)), this));
                            },
                            resume: () => {
                                F(this) &&
                                    (H(this, !1),
                                    ...
                                    nt(this, 'onResume', j(this, X(this, this.animation.to)), this));
                            },
                ...
                _merge(t, e, n) {
                    ...
                    ((r || o) && (O.velocity = 0),
                        e.config &&
                            !w &&
                            (function (t, e, n) {
                                (n && (S((n = l({}, n)), e), (e = l({}, n, e))), S(t, e), Object.assign(t, e));
                                for (const e in T) null == t[e] && (t[e] = T[e]);
                                let r = t.mass,
                                    i = t.frequency,
                                    o = t.damping;
                                s.is.und(i) ||
                    ...
                    let k = (0, i.ys)(this);
                    if (!k || s.is.und(g)) return n(j(this, !0));
                    const P = s.is.und(e.reset) ? o && !e.default : !s.is.und(v) && h(e.reset, a),
                        C = P ? v : this.get(),
                        M = U(g),
                        Q = s.is.num(M) || s.is.arr(M) || (0, s.Df)(M),
                        N = !w && (!Q || h(u.immediate || e.immediate, a));
                    if (_) {
                        const t = (0, i.sb)(g);
                        if (t !== k.constructor) {
                            if (!N)
                    ...
                    const L = k.constructor;
                    let V = (0, s.j$)(g),
                        q = !1;
                    if (!V) {
                        const t = P || (!D(this) && b);
                        ((_ || t) && ((q = (0, s.Xy)(U(C), M)), (V = !q)),
                            (((0, s.Xy)(c.immediate, N) || N) && (0, s.Xy)(O.decay, A) && (0, s.Xy)(O.velocity, E)) ||
                                (V = !0));
                    }
                    if (
                        (q && $(this) && (c.changed && !P ? (V = !0) : V || this._stop(p)),
                        !w &&
                            ((V || (0, s.j$)(p)) &&
                                ((c.values = k.getPayload()),
                                (c.toValues = (0, s.j$)(g) ? null : L == i.eC ? [1] : (0, s.qo)(M))),
                            c.immediate != N && ((c.immediate = N), N || P || this._set(p)),
                            V))
                    ) {
                        const t = c.onRest;
                        (0, s.S6)(tt, (t) => et(this, e, t));
                        const r = j(this, X(this, p));
                        ((0, s.bl)(this._pendingCalls, r),
                            ...
                            c.changed &&
                                s.Wn.batchedUpdates(() => {
                                    ((c.changed = !P),
                                        null == t || t(r, this),
                                        P ? d(u.onRest, r) : null == c.onStart || c.onStart(r, this));
                                }));
                    }
                    (P && this._set(C),
                        w
                ...
                _attach() {
                    let t = 0;
                    const e = this.animation.to;
                    ((0, s.j$)(e) && ((0, s.UI)(e, this), N(e) && (t = e.priority + 1)), (this.priority = t));
                }
                _detach() {
                ...
                _onStart() {
                    const t = this.animation;
                    t.changed || ((t.changed = !0), nt(this, 'onStart', j(this, X(this, t.to)), this));
                }
                _onChange(t, e) {
                ...
                _stop(t, e) {
                    if ($(this)) {
                        ...
                        const r = e ? I(this.get()) : j(this.get(), X(this, null != t ? t : n.to));
                        ((0, s.bl)(this._pendingCalls, r),
            ...
            function Y(t) {
                const e = (t = W(t)),
                    ...
                    r = e.from,
                    i = new Set();
                return (s.is.obj(n) && J(n, i), s.is.obj(r) && J(r, i), (t.keys = i.size ? Array.from(i) : null), t);
            }
            function K(t) {
                const e = Y(t);
            ...
            const tt = ['onStart', 'onRest', 'onChange', 'onPause', 'onResume'];
            function et(t, e, n) {
            ...
            const st = ['onStart', 'onChange', 'onRest'];
            let rt = 1;
            class it {
                constructor(t, e) {
                    ((this.id = rt++),
            ...
            function ut() {
                return (
                    (ut = a(function* (t, e, n) {
                            ...
                            p.push(
                                k(++t._lastAsyncId, {
                                    ...
                                    actions: {
                                        ...
                                        resume: s.ZT,
                                        start(e, n) {
                                            m ? (C(h, t._lastAsyncId), n(I(t))) : ((e.onRest = u), n(R(d, e, h, t)));
                                        },
                                    },
                                }),
                            ),
                        ...
                        const g = P(t, yield Promise.all(p));
            ...
            const ft = ['children'],
                ...
                gt =
                    ((yt = mt),
                    (vt = {}),
                    Object.assign(yt, r.createContext(vt)),
            ...
            function Ut(t, e, n) {
                ...
                i && !n && (n = []);
                const o = (0, r.useMemo)(() => (i || 3 == arguments.length ? Wt() : void 0), []),
                    a = (0, r.useRef)(0),
                    u = (0, s.NW)(),
                    c = (0, r.useMemo)(
                        () => ({
                ...
                function f(t, n) {
                    for (let s = t; s < n; s++) {
                        const t = d.current[s] || (d.current[s] = new it(null, c.flush)),
                            n = i ? i(s, t) : e[s];
                        n && (h[s] = K(n));
                    }
                }
            ...
            class _t extends V {
                ...
                advance(t) {
                    ...
                    ((0, s.Xy)(e, n) || ((0, i.ys)(this).setValue(e), this._onChange(e, this.idle)),
                        !this.idle && Tt(this._active) && Ot(this));
                }
                _get() {
            ...
            (s.OH.assign({ createStringInterpolator: s.qS, to: (t, e) => new _t(t, e) }), s.fT.advance);
        },
        810: (t, e, n) => {
            'use strict';
            n.d(e, {
            ...
            const U = {
                count: 0,
                clear() {
                    ((h = -1), (c = []), (o = v()), (s = v()), (a = v()), (i = v()), (u = v()), (U.count = 0));
                },
            };
            var b = n(363);
            function B() {}
            const _ = (t, e, n) => Object.defineProperty(t, e, { value: n, writable: !0, configurable: !0 }),
                w = {
                    arr: Array.isArray,
            ...
            const _t = (t, e, n) => Object.defineProperty(t, e, { value: n, writable: !0, configurable: !0 }),
                wt = /[+\-]?(?:0|[1-9]\d*)(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
                Tt = /(#(?:[0-9a-f]{2}){2,4}|(#[0-9a-f]{3})|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d\.]+%?\))/gi,
            ...
            const At = /rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,
                ...
                kt = (t) => {
                    ...
                    return (t) => {
                        var n;
                        const r =
                            !Ot.test(e[0]) && (null == (n = e.find((t) => Ot.test(t))) ? void 0 : n.replace(wt, ''));
                        let i = 0;
        ...
        6: (t, e, n) => {
            ...
            h = Object.keys(h).reduce(
                (t, e) => (
                    p.forEach((n) => (t[((t, e) => t + e.charAt(0).toUpperCase() + e.substring(1))(n, e)] = t[e])),
                    t
                ),
                h,
            );
            const f = ['x', 'y', 'z'],
                ...
                W = (t, e) => (i.is.arr(t) ? t.every((t) => W(t, e)) : i.is.num(t) ? t === e : parseFloat(t) === e);
                ...
                W = function (t, e) {
                    var n,
                        ...
                        c =
                            ...
                            l(u, { x: s, y: r, width: i, height: o, top: r, right: s + i, bottom: o + r, left: s }),
                            u);
        ...
        797: (t, e, n) => {
            ...
            class d {
                ...
                *getBlocks(t, e) {
                    ...
                    if (2 === n) return;
                    if (3 === n) return (e && e.hasText() && (yield e, (e.textNodes = [])), void a(!t.firstChild));
                    a(1 === n || 0 === n);
                    const s = !e || 1 === n,
                        r = s ? new l(t) : e;
                    a(r);
                ...
                applyToParagraph(t) {
                    ...
                    if ((a(s.length > 0), a(s.reduce((t, e) => t + e.length, 0) === n.length), s.length <= 1)) return;
                    const r = [];
                    let o = 0;
                ...
                splitTextNodes(t, e) {
                    ...
                    for (var u, c = i(t); !(u = c()).done; ) {
                        ...
                        (a(c.length > 0), l < n.length && c.push(n.substring(l)), this.splitTextNode(t, c), (o = i));
                    }
            ...
            class g {
                ...
                applyElement(t, e = m) {
                    new d(this, { separator: t.ownerDocument.createElement('wbr'), threshold: e }).applyToElement(t);
                }
