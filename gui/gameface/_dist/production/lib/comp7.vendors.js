...
(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
    ['lib/comp7.vendors'],
    {
        348: (e, t, n) => {
            ...
            class c extends (/^lobby\/(Comp7BattleCard\/Comp7BattleCard|PlatoonDropdown\/PlatoonDropdown)$/.test(n.j)
                ? null
                : l) {
                constructor(e) {
                    (super(),
            ...
            class h extends (/^lobby\/(Comp7BattleCard\/Comp7BattleCard|PlatoonDropdown\/PlatoonDropdown)$/.test(n.j)
                ? null
                : c) {
                constructor(e) {
                    (super(0),
            ...
            class f extends (/^lobby\/(Comp7BattleCard\/Comp7BattleCard|PlatoonDropdown\/PlatoonDropdown)$/.test(n.j)
                ? null
                : l) {
                constructor(e) {
            ...
            class p extends (/^lobby\/(Comp7BattleCard\/Comp7BattleCard|PlatoonDropdown\/PlatoonDropdown)$/.test(n.j)
                ? null
                : f) {
                constructor(e) {
                    super(e);
        ...
        216: (e, t, n) => {
            ...
            const d = (e, t) => !0 === e || !!(t && e && (r.is.fun(e) ? e(t) : (0, r.qo)(e).includes(t))),
                ...
                b = /^lobby\/(Comp7BattleCard\/Comp7BattleCard|PlatoonDropdown\/PlatoonDropdown)$/.test(n.j)
                    ? null
            ...
            const B = /^lobby\/(Comp7BattleCard\/Comp7BattleCard|PlatoonDropdown\/PlatoonDropdown)$/.test(n.j)
                ? null
                : [];
            class S {
                constructor() {
            ...
            const N = Symbol.for('SpringPhase'),
                ...
                Q = (e, t) => (t ? (e[N] |= 3) : (e[N] &= -3)),
                F = (e, t) => (t ? (e[N] |= 4) : (e[N] &= -5));
            class z extends (/^lobby\/(Comp7BattleCard\/Comp7BattleCard|PlatoonDropdown\/PlatoonDropdown)$/.test(n.j)
                ? null
                : V) {
                constructor(e, t) {
                    if (
                ...
                _merge(e, t, n) {
                    ...
                    const q = C.constructor;
                    let Q = (0, r.j$)(_),
                        F = !1;
                    if (!Q) {
                        const e = R || (!M(this) && U);
                        ((B || e) && ((F = (0, r.Xy)(m(D), I)), (Q = !F)),
                            (((0, r.Xy)(l.immediate, N) || N) && (0, r.Xy)(A.decay, T) && (0, r.Xy)(A.velocity, E)) ||
                                (Q = !0));
                    }
                    if (
                        (F && L(this) && (l.changed && !R ? (Q = !0) : Q || this._stop(f)),
                        !S &&
                            ((Q || (0, r.j$)(f)) &&
                                ((l.values = C.getPayload()),
                                (l.toValues = (0, r.j$)(_) ? null : q == o.eC ? [1] : (0, r.qo)(I))),
                            l.immediate != N && ((l.immediate = N), N || R || this._set(f)),
                            Q))
                    ) {
                        const e = l.onRest;
                        ...
                        ((0, r.bl)(this._pendingCalls, i),
                            ...
                            l.changed &&
                                r.Wn.batchedUpdates(() => {
                                    ((l.changed = !R),
                                        null == e || e(i, this),
                                        R ? h(u.onRest, i) : null == l.onStart || l.onStart(i, this));
                                }));
                    }
                    (R && this._set(D),
                        S
            ...
            const J = /^lobby\/(Comp7BattleCard\/Comp7BattleCard|PlatoonDropdown\/PlatoonDropdown)$/.test(n.j)
                ? null
            ...
            const ee = /^lobby\/(Comp7BattleCard\/Comp7BattleCard|PlatoonDropdown\/PlatoonDropdown)$/.test(n.j)
                ? null
        ...
        398: (e, t, n) => {
            ...
            const L = {
                ...
                start(e) {
                    M > e.priority ? (I.add(e), i.onStart(q)) : (Q(e), i(z));
                },
                advance: z,
                sort(e) {
                    if (M) i.onFrame(() => L.sort(e));
                    else {
                        const t = V.indexOf(e);
                        ~t && (V.splice(t, 1), F(e));
                    }
            ...
            function z(e) {
                ...
                for (let n = 0; n < V.length; n++) {
                    const r = V[n];
                    ((M = r.priority), r.idle || (R(r), r.advance(e), r.idle || t.push(r)));
                }
                return ((M = 0), (N = V), (N.length = 0), (V = t), V.length > 0);
            }
            const G = {
                    transparent: 0,
            ...
            const Te = /rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,
                ...
                je = (e) => {
                    ...
                    return (e) => {
                        ...
                        let o = 0;
                        return t[0].replace(We, () => `${r[o++](e)}${i || ''}`).replace(Te, Pe);
                    };
                },
                xe = 'react-spring: ',
                ke = (e) => {
        ...
        311: (e, t, n) => {
            ...
            const W = 'lobby/Comp7BattleCard/Comp7BattleCard' == n.j ? U : null;
        },
        187: (e, t, n) => {
            'use strict';
            n.d(t, { A: () => r });
            const r = /^lobby\/(Comp7BattleCard\/Comp7BattleCard|MembersWindow\/MembersWindow)$/.test(n.j)
                ? [
        ...
        354: (e, t, n) => {
            'use strict';
            if ((n.d(t, { D4: () => b }), 'lobby/RewardsSelectionScreen/RewardsSelectionScreen' != n.j)) var r = n(187);
            const i = {
                'BB2:108120': 1817,
                'BP2:OO': 790,
                'UB3:107': 714,
            ...
            if ('lobby/RewardsSelectionScreen/RewardsSelectionScreen' != n.j) var o = n(657);
            function s(e, t) {
                var n = ('undefined' != typeof Symbol && e[Symbol.iterator]) || e['@@iterator'];
                if (n) return (n = n.call(e)).next.bind(n);
                if (
            ...
            if ('lobby/RewardsSelectionScreen/RewardsSelectionScreen' != n.j) var f = n(422);
            function p(e, t) {
                (null == t || t > e.length) && (t = e.length);
                for (var n = 0, r = Array(t); n < t; n++) r[n] = e[n];
                return r;
        ...
        870: (e, t, n) => {
            'use strict';
            if ((n.d(t, { e: () => i }), 'lobby/Comp7BattleCard/Comp7BattleCard' != n.j)) var r = n(305);
            function i(e) {
                return (0, r.Gf)(e);
            }
        },
        ...
        305: (e, t, n) => {
            ...
            function z(e, t, n) {
                ...
                var r = new Q(e);
                return (t !== _ && Vt(Rt, r, t, undefined), n !== _ && It(r, n), r);
            }
            var G = {
                ...
                return n.get
                    ...
                    : n.set
                      ...
                      : ('function' == typeof n.value &&
                        ...
                        (!1 === (null == (o = this.options_) ? void 0 : o.deep) ? Se.ref : Se).extend_(e, t, n, r));
            }
            ...
            var be = ae('observable'),
                ...
                ye = ae('observable.shallow', {
                    enhancer: function (e, t, n) {
                        return null == e || Gn(e) || Pn(e) || Dn(e) || Nn(e)
                            ? e
                            : Array.isArray(e)
            ...
            var We,
                ...
                Se = s(Ue, {
                    box: function (e, t) {
                        var n = _e(t);
                        return new Le(e, Oe(n), n.name, !0, n.equals);
                    },
                    array: function (e, t) {
                        var n = _e(t);
                ...
                je = function (e, t) {
                    if (g(t)) return L(e, t, Te);
                    if (m(e)) return M(ie(Ae, e));
                    var n = m(t) ? t : {};
                    return ((n.get = e), n.name || (n.name = e.name || ''), new Fe(n));
                };
            (Object.assign(je, Te), (je.struct = M(Pe)));
            var xe,
                ke = 0,
                Ee = 1,
                Ce = null != (We = null == (Be = a(function () {}, 'name')) ? void 0 : Be.configurable) && We,
            ...
            var mt = W('Reaction', vt),
                wt = 'action',
                Ot = 'autoAction',
                Ut = X(wt),
                Wt = X('action.bound', { bound: !0 }),
                Bt = X(Ot, { autoAction: !0 }),
                    ...
                    return b(t)
                        ...
                        : b(n)
                          ...
                          : g(n)
                            ? L(t, n, e ? Bt : Ut)
                            : g(t)
                              ? M(X(e ? Ot : wt, { name: t, autoAction: e }))
                              : void 0;
                };
            }
            var Tt = At(!1);
            ...
            (Object.assign(Pt, Bt), (Tt.bound = M(Wt)), (Pt.bound = M(St)));
            var kt = function (e) {
                return e();
            };
            function Et(e) {
            ...
            function qt(e) {
                ...
                var t,
                    ...
                    s = e.enforceActions;
                if (
                    (void 0 !== i && (at.useProxies = i === Mt || (i !== Nt && 'undefined' != typeof Proxy)),
                    'ifavailable' === i && (at.verifyProxies = !0),
                    void 0 !== s)
                ) {
                    var a = s === Mt ? Mt : s === Lt;
                    ((at.enforceActions = a), (at.allowStateChanges = !0 !== a && a !== Mt));
                }
                ([
            ...
            var Sn,
                An,
                Tn = W('ObservableArrayAdministration', yn);
            function Pn(e) {
                return y(e) && Tn(e[q]);
            }
            var jn = {},
                xn = 'add',
                kn = 'delete';
            ((Sn = Symbol.iterator), (An = Symbol.toStringTag));
            var En,
                Cn,
                Rn = (function () {
                    function e(e, t, n) {
                ...
                Dn = W('ObservableMap', Rn),
                In = {};
            ((En = Symbol.iterator), (Cn = Symbol.toStringTag));
            var Vn = (function () {
                    function e(e, t, n) {
                        (void 0 === t && (t = $),
                ...
                qn = (function () {
                    ...
                    return (
                        ...
                        (t.delete_ = function (e, t) {
                            ...
                            if (ln(this) && !hn(this, { object: this.proxy_ || this.target_, name: e, type: Ln }))
                                return null;
                            try {
                                var n, r;
                                ht();
                                ...
                                if (
                                    (s && (this.values_.delete(e), s instanceof Le && (u = s.value_), pt(s)),
            ...
            var Fn = W('ObservableObjectAdministration', qn);
            function zn(e) {
                return (
                    Mn[e] ||
                    (Mn[e] = {
            ...
            var Yn = (function (e) {
                function t(t, n, r, i) {
                    ...
                    if (((s.proxy_ = D(o)), U(D(o), q, s), t && t.length)) {
                        var a = Ve(!0);
            ...
            function ur(e) {
                return Pn(e) ? e.slice() : B(e) || Dn(e) || S(e) || Nn(e) ? Array.from(e.entries()) : e;
            }
            function lr(e) {
